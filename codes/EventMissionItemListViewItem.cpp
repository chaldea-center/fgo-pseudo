        ...
        const MethodInfo *method)
{
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.progTxt, v15, v16, v17);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A238D4 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataManager_GetMasterData_EventMissionConditionMaster___, method);
    sub_1B715CC(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v3);
    byte_4A238D4 = 1;
  }
  Instance = (EventMissionConditionEntity_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_15;
...
LABEL_10:
    ...
    return CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_46344112(v8, 0LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A238D2 & 1) == 0 )
  {
    sub_1B715CC(&MissionInfoMaker_TypeInfo, method);
    byte_4A238D2 = 1;
  }
  giftEnts = this->fields.giftEnts;
  if ( giftEnts )
