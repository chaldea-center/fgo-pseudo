        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6DDEE & 1) == 0 )
  {
    sub_1B90010(&WarBoardMapCameraPerformance__Execute_d__9_TypeInfo, method);
    byte_4A6DDEE = 1;
  }
  v3 = sub_1B9025C(WarBoardMapCameraPerformance__Execute_d__9_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  const MethodInfo_3631B98 *v25; // x2
  char *v26; // x22
  int v27; // s0
  float ZoomSize; // s0
  float v31; // s8
  ...
  if ( (byte_4A6DDF0 & 1) == 0 )
  {
    ...
    sub_1B90010(&MapCameraViewAdjusterUtil_TypeInfo, v4);
    sub_1B90010(&Method_System_Nullable_Vector2__GetValueOrDefault__, v5);
    sub_1B90010(&Method_System_Nullable_Vector3___ctor__, v6);
    sub_1B90010(&Method_System_Nullable_float___ctor__, v7);
    sub_1B90010(&Method_System_Nullable_Vector2__get_HasValue__, v8);
    sub_1B90010(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__, v9);
    sub_1B90010(&Method_WarBoardMapCameraPerformance___c__DisplayClass9_0__Execute_b__0__, v10);
    sub_1B90010(&Method_WarBoardMapCameraPerformance___c__DisplayClass9_0__Execute_b__1__, v11);
    sub_1B90010(&WarBoardMapCameraPerformance___c__DisplayClass9_0_TypeInfo, v12);
    sub_1B90010(&UnityEngine_WaitUntil_TypeInfo, v13);
    byte_4A6DDF0 = 1;
  }
  ...
  v16 = sub_1B9025C(WarBoardMapCameraPerformance___c__DisplayClass9_0_TypeInfo);
  ...
  *(_QWORD *)&v49.fields.value.fields.y = v21;
  ...
  if ( !BYTE1(_4__this->fields.second) )
  {
    ...
    v42 = 0LL;
    System_Nullable_float____ctor(v44, ZoomSize, (const MethodInfo_362FB34 *)Method_System_Nullable_float___ctor__);
...
LABEL_29:
  ...
  *(_QWORD *)&v50.fields.value.fields.y = v32;
  ...
  v37 = (System_Func_bool__o *)sub_1B9025C(System_Func_bool__TypeInfo);
  System_Func_bool____ctor(
    v37,
    (Il2CppObject *)v16,
    Method_WarBoardMapCameraPerformance___c__DisplayClass9_0__Execute_b__1__,
    0LL);
  v38 = (UnityEngine_WaitUntil_o *)sub_1B9025C(UnityEngine_WaitUntil_TypeInfo);
  UnityEngine_WaitUntil___ctor(v38, v37, 0LL);
  this->fields.__2__current = (Il2CppObject *)v38;
  p__2__current = &this->fields.__2__current;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)p__2__current, (int32_t)v38, v40, v41);
  result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B90024(&Method_WarBoardMapCameraPerformance__Execute_d__9_System_Collections_IEnumerator_Reset__);
  sub_1B90138(v3, v4);
}
