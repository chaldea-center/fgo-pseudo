void WarBoardWallComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CB3BE4 & 1) == 0 )
  {
    sub_1C6BA08(&WarBoardWallComponent_TypeInfo);
    sub_1C6BA08(&StringLiteral_20796/*"img_wall_{0}"*/);
    sub_1C6BA08(&StringLiteral_3214/*"BreakWall_{0:00}"*/);
    byte_4CB3BE4 = 1;
  }
  WarBoardWallComponent_TypeInfo->static_fields->WALL_ICON_NAME = (struct System_String_o *)StringLiteral_20796/*"img_wall_{0}"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)WarBoardWallComponent_TypeInfo->static_fields, StringLiteral_20796/*"img_wall_{0}"*/, v1, v2);
  v3 = StringLiteral_3214/*"BreakWall_{0:00}"*/;
  static_fields = WarBoardWallComponent_TypeInfo->static_fields;
  static_fields->BREAK_ANIMATION_NAME = (struct System_String_o *)StringLiteral_3214/*"BreakWall_{0:00}"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)&static_fields->BREAK_ANIMATION_NAME, v3, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB3BE2 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&WarBoardPopTextEffectPerformance_TypeInfo);
    byte_4CB3BE2 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)CommonEffectAsset_object, 0, 0) )
  {
    ...
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    v18 = UnityEngine_Object__Instantiate_object__52199488(
    ...
    v19 = (WarBoardPopTextEffectPerformance_o *)sub_1C6BC54(WarBoardPopTextEffectPerformance_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  struct WarBoardWallData_o *v19; // x8
  __int64 breakPointMax_k__BackingField; // x21
  struct WarBoardBreakPointComponent_array *v21; // x0
  ...
  float maxSpacing; // s0
  UnityEngine_Transform_array *v41; // x20
  int32_t v42; // w2
  const MethodInfo *v43; // x3
  UnityEngine_Transform_o *v44; // x21
  const MethodInfo *v45; // x2
  struct WarBoardWallData_o *v46; // x8
  __int64 v47; // x0
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.wallData, (int32_t)data, (int32_t)wallIconAtlas, method);
  wallData = (char *)this->fields.wallData;
  if ( !wallData )
    goto LABEL_34;
  *((_QWORD *)wallData + 7) = this;
  sub_1C6B9AC((CGThumbnailListItem_o *)(wallData + 56), (int32_t)this, v9, v10);
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.simpleAnimation, (int32_t)Component_object, v13, v14);
  ...
  v17 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &wallImageId);
  wallData = (char *)System_String__Format(WALL_ICON_NAME, v17, 0);
  if ( !iconSp )
    goto LABEL_34;
  UISprite__set_spriteName(iconSp, (System_String_o *)wallData, 0);
  transform = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0);
  wallData = (char *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A4F3B4 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  v19 = this->fields.wallData;
  if ( !v19 )
    goto LABEL_34;
  if ( !wallData )
    goto LABEL_34;
  ...
  v21 = (struct WarBoardBreakPointComponent_array *)sub_1C6BAB0(
                                                      WarBoardBreakPointComponent___TypeInfo,
                                                      (unsigned int)breakPointMax_k__BackingField);
  this->fields.breakPoints = v21;
  p_breakPoints = &this->fields.breakPoints;
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.breakPoints, (int32_t)v21, v23, v24);
  ...
  if ( (int)breakPointMax_k__BackingField >= 1 )
  {
    ...
    v26 = 0.0;
    v27 = 1;
    v28 = 2 * breakPointMax_k__BackingField - 2;
    v29 = (float)*((int *)wallData + 42) / (float)(int)breakPointMax_k__BackingField;
    v30 = 8;
    do
    {
      breakPointPrefab = (Il2CppObject *)this->fields.breakPointPrefab;
      v32 = UnityEngine_Component__get_transform((UnityEngine_Component_o *)wallData, 0);
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      wallData = (char *)UnityEngine_Object__Instantiate_object__52199488(
                           breakPointPrefab,
                           v32,
                           (const MethodInfo_31C8040 *)Method_UnityEngine_Object_Instantiate_GameObject____78656176);
      if ( !wallData )
        break;
      v33 = (UnityEngine_GameObject_o *)wallData;
      ...
      wallData = (char *)UnityEngine_GameObject__get_transform(v33, 0);
      if ( !wallData )
        break;
      v50.fields.y = 0.0;
      v50.fields.z = 0.0;
      v50.fields.x = v26;
      UnityEngine_Transform__set_localPosition((UnityEngine_Transform_o *)wallData, v50, 0);
      breakPointParent = this->fields.breakPointParent;
      if ( !breakPointParent )
        break;
      if ( !v34 )
        break;
      WarBoardBreakPointComponent__Initialize(v34, v28 + breakPointParent->fields.mDepth, v27, 0, 0, 1, 0);
      v36 = (unsigned int *)*p_breakPoints;
      if ( !*p_breakPoints )
        break;
      wallData = (char *)sub_1C6BB44(v34, *(_QWORD *)(*(_QWORD *)v36 + 64LL));
      if ( !wallData )
        goto LABEL_43;
      if ( v25 >= v36[6] )
        goto LABEL_42;
      *(_QWORD *)&v36[v30] = v34;
      sub_1C6B9AC((CGThumbnailListItem_o *)&v36[v30], (int32_t)v34, v37, v38);
      v39 = *p_breakPoints;
      if ( !*p_breakPoints )
        goto LABEL_34;
      if ( v25 >= LODWORD(v39->max_length) )
        goto LABEL_42;
      if ( !*p_wallData )
        break;
      wallData = *(char **)((char *)&v39->obj.klass + v30 * 4);
      if ( !wallData )
        break;
      WarBoardBreakPointComponent__SetActive(
        (WarBoardBreakPointComponent_o *)wallData,
        (__int64)v25 < (*p_wallData)->fields._breakPoint_k__BackingField,
        0,
        0);
      if ( breakPointMax_k__BackingField == v27 )
        goto LABEL_35;
...
LABEL_35:
  v41 = (UnityEngine_Transform_array *)sub_1C6BAB0(UnityEngine_Transform___TypeInfo, 1);
  wallData = (char *)UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0);
  if ( !v41 )
    goto LABEL_34;
  v44 = (UnityEngine_Transform_o *)wallData;
  if ( wallData )
  {
    wallData = (char *)sub_1C6BB44(wallData, v41->obj.klass->_1.element_class);
    if ( !wallData )
    {
LABEL_43:
      v47 = sub_1C6BC84();
...
LABEL_42:
    sub_1C6BC68(wallData);
  v41->m_Items[0] = v44;
  sub_1C6B9AC((CGThumbnailListItem_o *)v41->m_Items, (int32_t)v44, v42, v43);
  WarBoardWallComponent__SetButtonTweenTarget(this, v41, v45);
  wallData = (char *)UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0);
  v46 = this->fields.wallData;
  if ( !v46 || !wallData )
LABEL_34:
    sub_1C6BC60(wallData, v8);
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)wallData, !v46->fields._isDestroy_k__BackingField, 0);
...
void WarBoardWallComponent__OnClick(WarBoardWallComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C6BA08(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    this = (WarBoardWallComponent_o *)sub_1C6BA08(&Method_WarBoardWallComponent_OnClick__);
    byte_4CB3BDE = 1;
  }
  ...
  if ( wallData->fields._isDestroy_k__BackingField )
    return;
  this = (WarBoardWallComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A4F3B4 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !this )
    goto LABEL_22;
  if ( WarBoardManager__get_isSelectedPiece((WarBoardManager_o *)this, 0) && v2->fields.isSelectable )
  {
    ...
    if ( (*((_BYTE *)Method_WarBoardWallComponent_OnClick__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1C6BA20(Method_WarBoardWallComponent_OnClick__);
...
LABEL_22:
  ...
  if ( (*((_BYTE *)Method_WarBoardWallComponent_OnClick__ + 83) & 2) != 0 )
    v8 = (_QWORD *)sub_1C6BA20(Method_WarBoardWallComponent_OnClick__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB3BE1 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_WarBoardWallComponent__OnDead_b__22_0__);
    sub_1C6BA08(&WarBoardWallComponent_TypeInfo);
    byte_4CB3BE1 = 1;
  }
  if ( !WarBoardWallComponent_TypeInfo->_2.cctor_finished )
  ...
  v11 = (CGThumbnailListItem_o *)(wallData + 40);
  v12 = (System_Delegate_o *)*((_QWORD *)wallData + 5);
  v13 = (WarBoardTaskBase_TaskCallback_o *)sub_1C6BC54(WarBoardTaskBase_TaskCallback_TypeInfo);
  ...
  if ( (WarBoardTaskBase_TaskCallback_c *)v14->klass != WarBoardTaskBase_TaskCallback_TypeInfo
    || (v11->klass = (CGThumbnailListItem_c *)v14, (WarBoardTaskBase_TaskCallback_c *)v14->klass != v18) )
  {
    sub_1C6BFFC(v14);
LABEL_11:
    v11->klass = (CGThumbnailListItem_c *)v17;
  }
  sub_1C6B9AC(v11, (int32_t)v17, v15, v16);
  wallData = (char *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A4F3B4 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !wallData )
    goto LABEL_24;
  *((_QWORD *)wallData + 127) = v10;
  sub_1C6B9AC((CGThumbnailListItem_o *)(wallData + 1016), (int32_t)v10, v19, v20);
  if ( !taskList )
  {
    Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A4F3B4 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    wallData = (char *)sub_1C6BAB0(WarBoardTaskBase___TypeInfo, 1);
    if ( wallData )
    {
      v28 = wallData;
      v29 = sub_1C6BB44(v10, *(_QWORD *)(*(_QWORD *)wallData + 64LL));
      if ( !v29 )
      {
        v32 = sub_1C6BC84();
        sub_1C6BB30(v32, 0);
      ...
      if ( !*((_DWORD *)v28 + 6) )
        sub_1C6BC68(v29);
      *((_QWORD *)v28 + 4) = v10;
      sub_1C6B9AC((CGThumbnailListItem_o *)(v28 + 32), (int32_t)v10, v30, v31);
      if ( Instance )
      {
        WarBoardManager__InsertTask((WarBoardManager_o *)Instance, 0, (WarBoardTaskBase_array *)v28, 0);
        return;
      }
    }
LABEL_24:
    sub_1C6BC60(wallData, taskList);
  }
  ...
  else
  {
    ...
    sub_1C6B9AC((CGThumbnailListItem_o *)(v26 + 4), (int32_t)v10, v21, v22);
  }
}
...
void WarBoardWallComponent__OnLongClick(WarBoardWallComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C6BA08(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    this = (WarBoardWallComponent_o *)sub_1C6BA08(&Method_WarBoardWallComponent_OnLongClick__);
    byte_4CB3BDF = 1;
  }
  klass = v2[3].klass;
  if ( !klass )
  ...
  if ( (*((_BYTE *)Method_WarBoardWallComponent_OnLongClick__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1C6BA20(Method_WarBoardWallComponent_OnLongClick__);
  v5 = (System_Reflection_MethodBase_o *)sub_1C6B9EC(v4, v4[4]);
  this = (WarBoardWallComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A4F3B4 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !this
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_GameObject__get_activeSelf((UnityEngine_GameObject_o *)gameObject, 0) )
  {
    ...
    gameObject = (WarBoardManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A4F3B4 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    if ( gameObject )
    {
      WarBoardManager__AddTask_38295060(gameObject, 0, (System_Collections_Generic_List_WarBoardTaskBase__o *)v11, 0);
      return;
    }
LABEL_12:
