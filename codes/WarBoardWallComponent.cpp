void __fastcall WarBoardWallComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_42B0BF8 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_19901/*"img_wall_{0}"*/);
    sub_B52984(&StringLiteral_2896/*"BreakWall_{0:00}"*/);
    byte_42B0BF8 = 1;
  }
  static_fields = (BattleServantConfConponent_o *)WarBoardWallComponent_TypeInfo->static_fields;
  v8 = (System_Int32_array **)StringLiteral_19901/*"img_wall_{0}"*/;
  static_fields->klass = (BattleServantConfConponent_c *)StringLiteral_19901/*"img_wall_{0}"*/;
  sub_B52920(static_fields, v8, v1, v2, v3, v4, v5, v6);
  v9 = WarBoardWallComponent_TypeInfo->static_fields;
  v10 = (System_Int32_array **)StringLiteral_2896/*"BreakWall_{0:00}"*/;
  v9->BREAK_ANIMATION_NAME = (struct System_String_o *)StringLiteral_2896/*"BreakWall_{0:00}"*/;
  sub_B52920((BattleServantConfConponent_o *)&v9->BREAK_ANIMATION_NAME, v10, v11, v12, v13, v14, v15, v16);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0BF6 & 1) == 0 )
  {
    ...
    sub_B52984(&WarBoardPopTextEffectPerformance_TypeInfo);
    byte_42B0BF6 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)CommonEffectAsset_object, 0LL, 0LL) )
  {
    ...
    v19 = (WarBoardPopTextEffectPerformance_o *)sub_B52A54(WarBoardPopTextEffectPerformance_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  struct WarBoardBreakPointComponent_array *v37; // x0
  ...
  WarBoardBreakPointComponent_o *v51; // x23
  struct UIWidget_o *breakPointParent; // x8
  struct WarBoardBreakPointComponent_array *v53; // x25
  ...
  int32_t v60; // w24
  Il2CppClass **v61; // x0
  struct WarBoardBreakPointComponent_array *v62; // x8
  float maxSpacing; // s0
  UnityEngine_Transform_array *v64; // x20
  ...
  struct WarBoardWallData_o *v73; // x8
  __int64 v74; // x0
  __int64 v75; // x0
  ...
  *(_QWORD *)&wallData->fields.objectColorNumber = this;
  ...
  v29 = **(System_String_o ***)&wallData[2].fields.objectColorNumber;
  if ( wallEntity )
    LODWORD(wallEntity) = wallEntity->fields.imageId;
  v76 = (int)wallEntity;
  v30 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v76);
  wallData = (WarBoardBreakPointComponent_o *)System_String__Format(v29, v30, 0LL);
  if ( !iconSp )
    goto LABEL_38;
  UISprite__set_spriteName(iconSp, (System_String_o *)wallData, 0LL);
  transform = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0LL);
  wallData = (WarBoardBreakPointComponent_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  ...
  *(UnityEngine_Vector3_o *)&v33 = WarBoardManager__GetSquarePosition(
  ...
  v37 = (struct WarBoardBreakPointComponent_array *)sub_B5299C(
                                                      WarBoardBreakPointComponent___TypeInfo,
                                                      (unsigned int)breakPointMax_k__BackingField);
  this->fields.breakPoints = v37;
  ...
  if ( breakPointMax_k__BackingField >= 1 )
  {
    v45 = 0;
    v46 = 0.0;
    v47 = (float)SLODWORD(wallData[2].fields.deactiveObject) / (float)breakPointMax_k__BackingField;
    do
    {
      breakPointPrefab = this->fields.breakPointPrefab;
      v49 = UnityEngine_Component__get_transform((UnityEngine_Component_o *)wallData, 0LL);
      if ( (BYTE3(UnityEngine_Object_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
        && !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      {
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      ...
      if ( !wallData )
        break;
      v50 = (UnityEngine_GameObject_o *)wallData;
      v51 = (WarBoardBreakPointComponent_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                               (UnityEngine_GameObject_o *)wallData,
                                               (const MethodInfo_1B7B1B8 *)Method_UnityEngine_GameObject_GetComponent_WarBoardBreakPointComponent___);
      wallData = (WarBoardBreakPointComponent_o *)UnityEngine_GameObject__get_transform(v50, 0LL);
      if ( !wallData )
        break;
      v77.fields.y = 0.0;
      v77.fields.z = 0.0;
      v77.fields.x = v46;
      UnityEngine_Transform__set_localPosition((UnityEngine_Transform_o *)wallData, v77, 0LL);
      ...
      WarBoardBreakPointComponent__Initialize(
        v51,
        breakPointParent->fields.mDepth + 2 * (~v45 + breakPointMax_k__BackingField),
        v45 + 1,
        0,
        0,
        1,
      ...
      if ( !*p_breakPoints )
        break;
      wallData = (WarBoardBreakPointComponent_o *)sub_B52A44(v51, v53->obj.klass->_1.element_class);
      if ( !wallData )
        goto LABEL_47;
      v60 = v45;
      if ( v45 >= v53->max_length )
        goto LABEL_46;
      v61 = &v53->obj.klass + v45;
      v61[4] = (Il2CppClass *)v51;
      sub_B52920((BattleServantConfConponent_o *)(v61 + 4), (System_Int32_array **)v51, v54, v55, v56, v57, v58, v59);
      v62 = *p_breakPoints;
      if ( !*p_breakPoints )
        goto LABEL_38;
      ...
      if ( !*p_wallData )
        break;
      wallData = v62->m_Items[v45];
      if ( !wallData )
        break;
      WarBoardBreakPointComponent__SetActive(
        wallData,
        (*p_wallData)->fields._breakPoint_k__BackingField > v45++,
        0,
        0LL);
      if ( breakPointMax_k__BackingField <= v60 + 1 )
        goto LABEL_39;
      maxSpacing = v51->fields.maxSpacing;
      wallData = (WarBoardBreakPointComponent_o *)this->fields.breakPointParent;
      if ( maxSpacing >= v47 )
        maxSpacing = v47;
      v46 = v46 + maxSpacing;
...
LABEL_39:
  v64 = (UnityEngine_Transform_array *)sub_B5299C(UnityEngine_Transform___TypeInfo, 1LL);
  wallData = (WarBoardBreakPointComponent_o *)UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0LL);
  if ( !v64 )
    goto LABEL_38;
  v71 = (System_Int32_array **)wallData;
  if ( wallData )
  {
    wallData = (WarBoardBreakPointComponent_o *)sub_B52A44(wallData, v64->obj.klass->_1.element_class);
    if ( !wallData )
    {
LABEL_47:
      v75 = sub_B52A7C(wallData);
      sub_B52A28(v75, 0LL);
    }
  }
  if ( !v64->max_length )
  {
LABEL_46:
    v74 = sub_B52A88(wallData);
    sub_B52A28(v74, 0LL);
  }
  v64->m_Items[0] = (UnityEngine_Transform_o *)v71;
  sub_B52920((BattleServantConfConponent_o *)v64->m_Items, v71, v65, v66, v67, v68, v69, v70);
  WarBoardWallComponent__SetButtonTweenTarget(this, v64, v72);
  wallData = (WarBoardBreakPointComponent_o *)UnityEngine_Component__get_gameObject(
                                                (UnityEngine_Component_o *)this,
                                                0LL);
  v73 = this->fields.wallData;
  if ( !v73 || !wallData )
LABEL_38:
    sub_B52A5C(wallData, v12);
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)wallData, !v73->fields._isDestroy_k__BackingField, 0LL);
...
void __fastcall WarBoardWallComponent__OnClick(WarBoardWallComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_B52984(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    this = (WarBoardWallComponent_o *)sub_B52984(&Method_WarBoardWallComponent_OnClick__);
    byte_42B0BF2 = 1;
  }
  ...
  if ( wallData->fields._isDestroy_k__BackingField )
    return;
  this = (WarBoardWallComponent_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !this )
    goto LABEL_22;
  if ( WarBoardManager__get_isSelectedPiece((WarBoardManager_o *)this, 0LL) && v2->fields.isSelectable )
  {
    ...
    if ( (*((_BYTE *)Method_WarBoardWallComponent_OnClick__ + 75) & 2) != 0 )
      v4 = (_QWORD *)sub_B5298C(Method_WarBoardWallComponent_OnClick__);
...
LABEL_22:
  ...
  if ( (*((_BYTE *)Method_WarBoardWallComponent_OnClick__ + 75) & 2) != 0 )
    v8 = (_QWORD *)sub_B5298C(Method_WarBoardWallComponent_OnClick__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0BF5 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_WarBoardWallComponent__OnDead_b__22_0__);
    sub_B52984(&WarBoardWallComponent_TypeInfo);
    byte_42B0BF5 = 1;
  }
  ...
  v40 = (int)wallEntity;
  v9 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v40);
...
LABEL_22:
  ...
  sub_B52920(v13, v16, v17, v18, v19, v20, v21, v22);
  SimpleAnimationPerformance = (char *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !SimpleAnimationPerformance )
    goto LABEL_20;
  *((_QWORD *)SimpleAnimationPerformance + 128) = v12;
  sub_B52920((BattleServantConfConponent_o *)(SimpleAnimationPerformance + 1024), v12, v23, v24, v25, v26, v27, v28);
  if ( taskList )
  {
    System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData___Add(
  ...
  Instance = SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  SimpleAnimationPerformance = (char *)sub_B5299C(WarBoardTaskBase___TypeInfo, 1LL);
  if ( !SimpleAnimationPerformance )
LABEL_20:
    sub_B52A5C(SimpleAnimationPerformance, taskList);
  v30 = SimpleAnimationPerformance;
  v31 = sub_B52A44(v12, *(_QWORD *)(*(_QWORD *)SimpleAnimationPerformance + 64LL));
  if ( !v31 )
    goto LABEL_22;
  if ( !*((_DWORD *)v30 + 6) )
  {
  ...
  *((_QWORD *)v30 + 4) = v12;
  sub_B52920((BattleServantConfConponent_o *)(v30 + 32), v12, v32, v33, v34, v35, v36, v37);
  if ( !Instance )
    goto LABEL_20;
...
void __fastcall WarBoardWallComponent__OnLongClick(WarBoardWallComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_B52984(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    this = (WarBoardWallComponent_o *)sub_B52984(&Method_WarBoardWallComponent_OnLongClick__);
    byte_42B0BF3 = 1;
  }
  wallData = v2->fields.wallData;
  if ( !wallData )
  ...
  if ( (*((_BYTE *)Method_WarBoardWallComponent_OnLongClick__ + 75) & 2) != 0 )
    v4 = (_QWORD *)sub_B5298C(Method_WarBoardWallComponent_OnLongClick__);
  v5 = (System_Reflection_MethodBase_o *)sub_B52968(v4, v4[3]);
  this = (WarBoardWallComponent_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !this
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_GameObject__get_activeSelf((UnityEngine_GameObject_o *)gameObject, 0LL) )
  {
    ...
    gameObject = (WarBoardManager_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    if ( gameObject )
    {
      WarBoardManager__AddTask_18580124(gameObject, 0, (System_Collections_Generic_List_WarBoardTaskBase__o *)v11, 0LL);
      return;
    }
LABEL_12:
