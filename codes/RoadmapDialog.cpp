void RoadmapDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4DFEEC8 & 1) == 0 )
  {
    sub_1CE6700(&RoadmapDialog_TypeInfo);
    sub_1CE6700(&StringLiteral_20534/*"icon_summon_arrow2"*/);
    sub_1CE6700(&StringLiteral_11535/*"Roadmap_bg"*/);
    byte_4DFEEC8 = 1;
  }
  RoadmapDialog_TypeInfo->static_fields->SPRITE_NAME_BG = (struct System_String_o *)StringLiteral_11535/*"Roadmap_bg"*/;
  sub_1CE66A4(RoadmapDialog_TypeInfo->static_fields, StringLiteral_11535/*"Roadmap_bg"*/);
  v1 = StringLiteral_20534/*"icon_summon_arrow2"*/;
  static_fields = RoadmapDialog_TypeInfo->static_fields;
  static_fields->SPRITE_NAME_ARROW = (struct System_String_o *)StringLiteral_20534/*"icon_summon_arrow2"*/;
  sub_1CE66A4(&static_fields->SPRITE_NAME_ARROW, v1);
}
...
void RoadmapDialog__Close(RoadmapDialog_o *this, System_Action_o *onClosedCallback, const MethodInfo *method)
{
  ...
  if ( (byte_4DFEEC3 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_RoadmapDialog___c__DisplayClass26_0__Close_b__0__);
    sub_1CE6700(&RoadmapDialog___c__DisplayClass26_0_TypeInfo);
    byte_4DFEEC3 = 1;
  }
  v5 = (Il2CppObject *)sub_1CE694C(RoadmapDialog___c__DisplayClass26_0_TypeInfo);
  ...
  sub_1CE66A4(&v5[1].monitor, onClosedCallback);
  this->fields.state = 3;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFEEBE & 1) == 0 )
  {
    sub_1CE6700(&RoadmapDialog__CoOpen_d__20_TypeInfo);
    byte_4DFEEBE = 1;
  }
  v5 = sub_1CE694C(RoadmapDialog__CoOpen_d__20_TypeInfo);
  System_Object___ctor((Il2CppObject *)v5, 0);
  *(_DWORD *)(v5 + 16) = 0;
  *(_QWORD *)(v5 + 32) = this;
  sub_1CE66A4(v5 + 32, this);
  *(_QWORD *)(v5 + 40) = onOpenedCallback;
  sub_1CE66A4(v5 + 40, onOpenedCallback);
...
void RoadmapDialog__EndClose(RoadmapDialog_o *this, System_Action_o *onClosedCallback, const MethodInfo *method)
{
  if ( (byte_4DFEEC4 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_11534/*"RoadMap"*/);
    byte_4DFEEC4 = 1;
  }
  this->fields.state = 0;
  ...
  AssetManager__releaseAssetStorage((System_String_o *)StringLiteral_11534/*"RoadMap"*/, 0);
...
void RoadmapDialog__OnClickClose(RoadmapDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFEEC5 & 1) == 0 )
  {
    sub_1CE6700(&Method_RoadmapDialog_OnClickClose__);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_RoadmapDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_RoadmapDialog_OnClickClose__);
...
void RoadmapDialog__OnClickLeftButton(RoadmapDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFEEC1 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_RoadmapDialog_OnClickLeftButton__);
    byte_4DFEEC1 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_RoadmapDialog_OnClickLeftButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_RoadmapDialog_OnClickLeftButton__);
    v4 = (System_Reflection_MethodBase_o *)sub_1CE66E4(v3, v3[4]);
    ...
    v9 = System_Math__Max_66644648(CenterIndex - 1, 0, 0);
...
void RoadmapDialog__OnClickRightButton(RoadmapDialog_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&System_Math_TypeInfo);
    sub_1CE6700(&Method_RoadmapDialog_OnClickRightButton__);
    byte_4DFEEC2 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_RoadmapDialog_OnClickRightButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_RoadmapDialog_OnClickRightButton__);
    v4 = (System_Reflection_MethodBase_o *)sub_1CE66E4(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 7, 0, 0);
    listViewManager = (ListViewManager_o *)this->fields.listViewManager;
    if ( !listViewManager
    ...
    {
      sub_1CE6958(CenterIndex, v6);
    }
    v9 = CenterIndex;
    ItemSum = ListViewManager__get_ItemSum(v8, 0);
    if ( !System_Math_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
    v11 = System_Math__Min_66644976(v9 + 1, ItemSum - 1, 0);
...
void RoadmapDialog__Open(RoadmapDialog_o *this, System_Action_o *onOpenedCallback, const MethodInfo *method)
{
  ...
  if ( (byte_4DFEEBC & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1CE6700(&Method_RoadmapDialog___c__DisplayClass18_0__Open_b__0__);
    sub_1CE6700(&RoadmapDialog___c__DisplayClass18_0_TypeInfo);
    sub_1CE6700(&StringLiteral_11534/*"RoadMap"*/);
    byte_4DFEEBC = 1;
  }
  v5 = (Il2CppObject *)sub_1CE694C(RoadmapDialog___c__DisplayClass18_0_TypeInfo);
  System_Object___ctor(v5, 0);
  if ( !v5 )
    goto LABEL_9;
  v5[1].klass = (Il2CppClass *)this;
  ...
  sub_1CE66A4(&v5[1].monitor, onOpenedCallback);
  ...
  if ( !basePanel
    || (((void (__fastcall *)(CommonUI_o *, Il2CppClass *, float))basePanel->klass[1]._1.element_class)(
          ...
          0.0),
        (basePanel = (CommonUI_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__)) == 0) )
  {
LABEL_9:
    sub_1CE6958(basePanel, v7);
  }
  CommonUI__SetLoadMode(basePanel, 1, 0);
  if ( !AssetManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
  AssetManager__SetAssetBundleUnload((System_String_o *)StringLiteral_11534/*"RoadMap"*/, 0);
  ...
  AssetManager__loadAssetStorage((System_String_o *)StringLiteral_11534/*"RoadMap"*/, v8, 1, 0, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFEEC0 & 1) == 0 )
  {
    ...
    this = (RoadmapDialog_o *)sub_1CE6700(&Method_System_Collections_Generic_List_UIAtlas__GetEnumerator__);
    byte_4DFEEC0 = 1;
  }
  memset(&v13, 0, sizeof(v13));
  if ( !roadmapAtlasList )
    sub_1CE6958(this, roadmapAtlasList);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFEEBD & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_BasicHelper_ExcludeNull_UIAtlas___);
    sub_1CE6700(&Method_System_Linq_Enumerable_Select_GameObject__UIAtlas___);
    sub_1CE6700(&Method_System_Linq_Enumerable_ToList_UIAtlas___);
    sub_1CE6700(&System_Func_GameObject__UIAtlas__TypeInfo);
    sub_1CE6700(&LocalizationManager_TypeInfo);
    sub_1CE6700(&Method_RoadmapDialog___c__Setup_b__19_0__);
    sub_1CE6700(&RoadmapDialog___c_TypeInfo);
  ...
  closeButton = LocalizationManager__Get((System_String_o *)StringLiteral_3714/*"COMMON_CONFIRM_CLOSE"*/, 0);
  if ( !closeLabel )
    goto LABEL_16;
  ...
  if ( !_9__19_0 )
  {
    ...
    _9__19_0 = (System_Func_object__object__o *)sub_1CE694C(System_Func_GameObject__UIAtlas__TypeInfo);
  ...
  v17 = (System_Collections_Generic_IEnumerable_T__o *)System_Linq_Enumerable__Select_object__object_(
                                                         ...
                                                         (const MethodInfo_323A63C *)Method_System_Linq_Enumerable_Select_GameObject__UIAtlas___);
  v18 = BasicHelper__ExcludeNull_object_(v17, (const MethodInfo_31EDE30 *)Method_BasicHelper_ExcludeNull_UIAtlas___);
  closeButton = (System_String_o *)System_Linq_Enumerable__ToList_object_(
                                     (System_Collections_Generic_IEnumerable_TSource__o *)v18,
                                     (const MethodInfo_3248A54 *)Method_System_Linq_Enumerable_ToList_UIAtlas___);
  if ( !this->fields.listViewManager )
LABEL_16:
    sub_1CE6958(closeButton, v9);
...
void RoadmapDialog__UpdateLeftAndRightButton(RoadmapDialog_o *this, const MethodInfo *method)
{
  ...
  {
LABEL_8:
    sub_1CE6958(leftScrollArrowComponent, method);
  }
...
bool RoadmapDialog__CoOpen_d__20__MoveNext(RoadmapDialog__CoOpen_d__20_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&System_Action_TypeInfo);
    sub_1CE6700(&Method_RoadmapDialog__CoOpen_b__20_0__);
    sub_1CE6700(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4DFEECB = 1;
  }
...
LABEL_16:
    sub_1CE66A4(p_onOpenedCallback, v13);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1CE6714(&Method_RoadmapDialog__CoOpen_d__20_System_Collections_IEnumerator_Reset__);
  sub_1CE6828(v3, v4);
}
...
void RoadmapDialog___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1CE694C(RoadmapDialog___c_TypeInfo);
  System_Object___ctor(v1, 0);
  RoadmapDialog___c_TypeInfo->static_fields->__9 = (struct RoadmapDialog___c_o *)v1;
  sub_1CE66A4(RoadmapDialog___c_TypeInfo->static_fields, v1);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4DFEECA & 1) == 0 )
  {
    this = (RoadmapDialog___c_o *)sub_1CE6700(&Method_UnityEngine_GameObject_GetComponent_UIAtlas___);
    byte_4DFEECA = 1;
  }
  if ( !assetObject )
    sub_1CE6958(this, assetObject);
