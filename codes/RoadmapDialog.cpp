void __fastcall RoadmapDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C1CB75 & 1) == 0 )
  {
    sub_1C3B764(&RoadmapDialog_TypeInfo, v1);
    sub_1C3B764(&StringLiteral_20590/*"java.lang.String"*/, v2);
    sub_1C3B764(&StringLiteral_11619/*"SERVANT_STATUS_EXPLANATION_FACE2"*/, v3);
    byte_4C1CB75 = 1;
  }
  RoadmapDialog_TypeInfo->static_fields->SPRITE_NAME_BG = (struct System_String_o *)StringLiteral_11619/*"SERVANT_STATUS_EXPLANATION_FACE2"*/;
  sub_1C3B708(RoadmapDialog_TypeInfo->static_fields);
  static_fields = RoadmapDialog_TypeInfo->static_fields;
  static_fields->SPRITE_NAME_ARROW = (struct System_String_o *)StringLiteral_20590/*"java.lang.String"*/;
  sub_1C3B708(&static_fields->SPRITE_NAME_ARROW);
}
...
void __fastcall RoadmapDialog___ctor(RoadmapDialog_o *this, const MethodInfo *method)
{
  ...
  sub_1C3B708(&this->fields.roadmapAtlasList);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1CB71 & 1) == 0 )
  {
    sub_1C3B764(&System_Action_TypeInfo, onClosedCallback);
    sub_1C3B764(&Method_RoadmapDialog___c__DisplayClass25_0__Close_b__0__, v5);
    sub_1C3B764(&RoadmapDialog___c__DisplayClass25_0_TypeInfo, v6);
    byte_4C1CB71 = 1;
  }
  v7 = (Il2CppObject *)sub_1C3B9B0(RoadmapDialog___c__DisplayClass25_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1CB6C & 1) == 0 )
  {
    sub_1C3B764(&RoadmapDialog__CoOpen_d__19_TypeInfo, onOpenedCallback);
    byte_4C1CB6C = 1;
  }
  v5 = sub_1C3B9B0(RoadmapDialog__CoOpen_d__19_TypeInfo);
...
void __fastcall RoadmapDialog__OnClickClose(RoadmapDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1CB72 & 1) == 0 )
  {
    sub_1C3B764(&Method_RoadmapDialog_OnClickClose__, method);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_RoadmapDialog_OnClickClose__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1C3B77C(Method_RoadmapDialog_OnClickClose__);
...
void __fastcall RoadmapDialog__OnClickLeftButton(RoadmapDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1CB6F & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_RoadmapDialog_OnClickLeftButton__, v3);
    byte_4C1CB6F = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_RoadmapDialog_OnClickLeftButton__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1C3B77C(Method_RoadmapDialog_OnClickLeftButton__);
    v5 = (System_Reflection_MethodBase_o *)sub_1C3B748(v4, v4[4]);
    ...
    v10 = System_Math__Max_64187756(CenterIndex - 1, 0, 0LL);
...
void __fastcall RoadmapDialog__OnClickRightButton(RoadmapDialog_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C3B764(&System_Math_TypeInfo, method);
    sub_1C3B764(&Method_RoadmapDialog_OnClickRightButton__, v3);
    byte_4C1CB70 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_RoadmapDialog_OnClickRightButton__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1C3B77C(Method_RoadmapDialog_OnClickRightButton__);
    v5 = (System_Reflection_MethodBase_o *)sub_1C3B748(v4, v4[4]);
    OverwriteAssetSoundName__PlaySystemSe(v5, 7, 0, 0LL);
    listViewManager = (ListViewManager_o *)this->fields.listViewManager;
    if ( !listViewManager
    ...
    {
      sub_1C3B9C0(CenterIndex, v7);
    }
    v10 = CenterIndex;
    ItemSum = ListViewManager__get_ItemSum(v9, 0LL);
    if ( !System_Math_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
    v12 = System_Math__Min_64188084(v10 + 1, ItemSum - 1, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1CB6B & 1) == 0 )
  {
    sub_1C3B764(&LocalizationManager_TypeInfo, roadmapAssetData);
  ...
  basePanel = LocalizationManager__Get((System_String_o *)StringLiteral_3799/*"COSTUME_SELECT_SERVANT_EVENT_END_ITEM_COSTUME_MSG"*/, 0LL);
  if ( !closeLabel
  ...
  {
LABEL_10:
    sub_1C3B9C0(basePanel, roadmapAssetData);
  }
  ...
  UnityEngine_MonoBehaviour__StartCoroutine_71108020((UnityEngine_MonoBehaviour_o *)this, v17, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1CB6E & 1) == 0 )
  {
    sub_1C3B764(&Method_System_Collections_Generic_List_Enumerator_UIAtlas__Dispose__, targetSprite);
    ...
    sub_1C3B764(&Method_System_Collections_Generic_List_UIAtlas__GetEnumerator__, v9);
    byte_4C1CB6E = 1;
  }
  memset(&v16, 0, sizeof(v16));
  roadmapAtlasList = this->fields.roadmapAtlasList;
  if ( !roadmapAtlasList )
    sub_1C3B9C0(0LL, targetSprite);
...
void __fastcall RoadmapDialog__SetUpUiSprites(RoadmapDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1CB6D & 1) == 0 )
  {
    sub_1C3B764(&RoadmapDialog_TypeInfo, method);
    byte_4C1CB6D = 1;
  }
...
void __fastcall RoadmapDialog__UpdateLeftAndRightButton(RoadmapDialog_o *this, const MethodInfo *method)
{
  ...
  {
LABEL_8:
    sub_1C3B9C0(leftScrollArrowComponent, method);
  }
...
bool __fastcall RoadmapDialog__CoOpen_d__19__MoveNext(RoadmapDialog__CoOpen_d__19_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1CB76 & 1) == 0 )
  {
    ...
    this = (RoadmapDialog__CoOpen_d__19_o *)sub_1C3B764(&Method_RoadmapDialog__CoOpen_b__19_0__, v3);
    byte_4C1CB76 = 1;
  }
...
LABEL_14:
    sub_1C3B708(p_onOpenedCallback);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C3B778(&Method_RoadmapDialog__CoOpen_d__19_System_Collections_IEnumerator_Reset__);
  sub_1C3B88C(v3, v4);
}
