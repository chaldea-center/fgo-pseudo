void __fastcall RoadmapDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A5EC87 & 1) == 0 )
  {
    sub_1B885B0(&RoadmapDialog_TypeInfo);
    sub_1B885B0(&StringLiteral_20189/*"icon_summon_arrow2"*/);
    sub_1B885B0(&StringLiteral_11385/*"Roadmap_bg"*/);
    byte_4A5EC87 = 1;
  }
  RoadmapDialog_TypeInfo->static_fields->SPRITE_NAME_BG = (struct System_String_o *)StringLiteral_11385/*"Roadmap_bg"*/;
  sub_1B88554((ServantStatusBattleListViewItem_o *)RoadmapDialog_TypeInfo->static_fields, StringLiteral_11385/*"Roadmap_bg"*/, v1, v2);
  v3 = StringLiteral_20189/*"icon_summon_arrow2"*/;
  static_fields = RoadmapDialog_TypeInfo->static_fields;
  static_fields->SPRITE_NAME_ARROW = (struct System_String_o *)StringLiteral_20189/*"icon_summon_arrow2"*/;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&static_fields->SPRITE_NAME_ARROW, v3, v5, v6);
}
...
void __fastcall RoadmapDialog___ctor(RoadmapDialog_o *this, const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.roadmapAtlasList, (int32_t)v3, v4, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5EC83 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_RoadmapDialog___c__DisplayClass25_0__Close_b__0__);
    sub_1B885B0(&RoadmapDialog___c__DisplayClass25_0_TypeInfo);
    byte_4A5EC83 = 1;
  }
  v5 = sub_1B887FC(RoadmapDialog___c__DisplayClass25_0_TypeInfo);
  ...
  *(_QWORD *)(v5 + 24) = onClosedCallback;
  sub_1B88554((ServantStatusBattleListViewItem_o *)(v5 + 24), (int32_t)onClosedCallback, v10, v11);
  this->fields.state = 3;
  v12 = (System_Action_o *)sub_1B887FC(System_Action_TypeInfo);
  System_Action___ctor(v12, (Il2CppObject *)v5, Method_RoadmapDialog___c__DisplayClass25_0__Close_b__0__, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5EC7E & 1) == 0 )
  {
    sub_1B885B0(&RoadmapDialog__CoOpen_d__19_TypeInfo);
    byte_4A5EC7E = 1;
  }
  v5 = sub_1B887FC(RoadmapDialog__CoOpen_d__19_TypeInfo);
  System_Object___ctor((Il2CppObject *)v5, 0LL);
  *(_DWORD *)(v5 + 16) = 0;
  *(_QWORD *)(v5 + 32) = this;
  sub_1B88554((ServantStatusBattleListViewItem_o *)(v5 + 32), (int32_t)this, v6, v7);
  *(_QWORD *)(v5 + 40) = onOpenedCallback;
  sub_1B88554((ServantStatusBattleListViewItem_o *)(v5 + 40), (int32_t)onOpenedCallback, v8, v9);
...
void __fastcall RoadmapDialog__OnClickClose(RoadmapDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5EC84 & 1) == 0 )
  {
    sub_1B885B0(&Method_RoadmapDialog_OnClickClose__);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_RoadmapDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B885C8(Method_RoadmapDialog_OnClickClose__);
...
void __fastcall RoadmapDialog__OnClickLeftButton(RoadmapDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5EC81 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_RoadmapDialog_OnClickLeftButton__);
    byte_4A5EC81 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_RoadmapDialog_OnClickLeftButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B885C8(Method_RoadmapDialog_OnClickLeftButton__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B88594(v3, v3[4]);
    ...
    v9 = System_Math__Max_62525680(CenterIndex - 1, 0, 0LL);
...
void __fastcall RoadmapDialog__OnClickRightButton(RoadmapDialog_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B885B0(&System_Math_TypeInfo);
    sub_1B885B0(&Method_RoadmapDialog_OnClickRightButton__);
    byte_4A5EC82 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_RoadmapDialog_OnClickRightButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B885C8(Method_RoadmapDialog_OnClickRightButton__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B88594(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 7, 0LL);
    listViewManager = (ListViewManager_o *)this->fields.listViewManager;
    if ( !listViewManager
    ...
    {
      sub_1B8880C(CenterIndex, v6);
    }
    v9 = CenterIndex;
    ItemSum = ListViewManager__get_ItemSum(v8, 0LL);
    if ( !System_Math_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
    v11 = System_Math__Min_62526008(v9 + 1, ItemSum - 1, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  basePanel = LocalizationManager__Get((System_String_o *)StringLiteral_3756/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
  if ( !closeLabel
  ...
  {
LABEL_10:
    sub_1B8880C(basePanel, roadmapAssetData);
  }
  this->fields.centerBoardIndex = RoadmapBoardListViewManager__CreateList(
                                    ...
                                    roadmapAtlasList,
                                    v14);
  RoadmapDialog__UpdateLeftAndRightButton(this, v15);
  RoadmapDialog__SetUpUiSprites(this, v16);
  v18 = RoadmapDialog__CoOpen(this, onOpenedCallback, v17);
  UnityEngine_MonoBehaviour__StartCoroutine_69444652((UnityEngine_MonoBehaviour_o *)this, v18, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  while ( 1 )
  {
    ...
    if ( !v13.fields._current )
      sub_1B8880C(v8, v9);
    Sprite = UIAtlas__GetSprite((UIAtlas_o *)v13.fields._current, spriteName, 0LL);
    if ( Sprite )
    {
      if ( !targetSprite )
        sub_1B8880C(Sprite, v12);
...
void __fastcall RoadmapDialog__UpdateLeftAndRightButton(RoadmapDialog_o *this, const MethodInfo *method)
{
  ...
  {
LABEL_8:
    sub_1B8880C(leftScrollArrowComponent, method);
  }
...
bool __fastcall RoadmapDialog__CoOpen_d__19__MoveNext(RoadmapDialog__CoOpen_d__19_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B885B0(&System_Action_TypeInfo);
    this = (RoadmapDialog__CoOpen_d__19_o *)sub_1B885B0(&Method_RoadmapDialog__CoOpen_b__19_0__);
    byte_4A5EC88 = 1;
  }
  ...
  if ( _1__state == 1 )
  {
    ...
    System_Action___ctor(v11, (Il2CppObject *)_4__this, Method_RoadmapDialog__CoOpen_b__19_0__, 0LL);
    v12 = System_Delegate__Combine(onOpenedCallback, (System_Delegate_o *)v11, 0LL);
    v15 = v12;
    if ( v12 )
    {
      ...
      {
        p_onOpenedCallback->klass = (ServantStatusBattleListViewItem_c *)v12;
...
LABEL_14:
    sub_1B88554(p_onOpenedCallback, (int32_t)v15, v13, v14);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B885C4(&Method_RoadmapDialog__CoOpen_d__19_System_Collections_IEnumerator_Reset__);
  sub_1B886D8(v3, v4);
}
