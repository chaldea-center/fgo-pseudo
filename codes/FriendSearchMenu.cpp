...
void __fastcall FriendSearchMenu__BlockInput(FriendSearchMenu_o *this, const MethodInfo *method)
{
  ...
  if ( !searchDataInput
    || (searchDataInput = (UnityEngine_Component_o *)UnityEngine_Component__GetComponent_object_(
                                                       searchDataInput,
                                                       (const MethodInfo_2E32784 *)Method_UnityEngine_Component_GetComponent_UIInput___)) == 0LL
    || (searchDataInput = (UnityEngine_Component_o *)UnityEngine_Component__GetComponent_object_(
                                                       searchDataInput,
                                                       (const MethodInfo_2E32784 *)Method_UnityEngine_Component_GetComponent_Collider___)) == 0LL )
  {
    sub_1B64C5C(searchDataInput, method);
  }
...
void __fastcall FriendSearchMenu__Close(FriendSearchMenu_o *this, const MethodInfo *method)
{
  ...
  FriendSearchMenu__Close_30673316(this, 0LL, v2);
}


void __fastcall FriendSearchMenu__Close_30673316(
        ...
        const MethodInfo *method)
{
  ...
  if ( (qword_49FA000 & 0x10000) == 0 )
  {
    ...
    sub_1B64A00(&Method_FriendSearchMenu_EndClose__, v7);
    BYTE2(qword_49FA000) = 1;
  }
  ...
  if ( !searchDataInput
    ...
    || (searchDataInput = (UnityEngine_Component_o *)UnityEngine_Component__GetComponent_object_(
                                                       ...
                                                       (const MethodInfo_2E32784 *)Method_UnityEngine_Component_GetComponent_Collider___)) == 0LL )
  {
    sub_1B64C5C(searchDataInput, v8);
  }
  UnityEngine_Collider__set_enabled((UnityEngine_Collider_o *)searchDataInput, 0, 0LL);
...
void __fastcall FriendSearchMenu__EndOpen(FriendSearchMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (qword_49FA000 & 1) == 0 )
  {
    sub_1B64A00(&Method_UnityEngine_Component_GetComponent_Collider___, method);
    sub_1B64A00(&Method_UnityEngine_Component_GetComponent_UIInput___, v3);
    LOBYTE(qword_49FA000) = 1;
  }
  searchDataInput = (UnityEngine_Component_o *)this->fields.searchDataInput;
  this->fields.state = 2;
  if ( !searchDataInput
...
void __fastcall FriendSearchMenu__Init(FriendSearchMenu_o *this, const MethodInfo *method)
{
  ...
  {
LABEL_11:
    sub_1B64C5C(title1Label, method);
  }
...
void __fastcall FriendSearchMenu__OnChangeServerInput(FriendSearchMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (qword_49FA000 & 0x1000000) == 0 )
  {
    sub_1B64A00(&char_TypeInfo, method);
    sub_1B64A00(&Method_UnityEngine_Component_GetComponent_UIInput___, v3);
    sub_1B64A00(&StringLiteral_1/*""*/, v4);
    BYTE3(qword_49FA000) = 1;
  }
  Chars = 0;
  searchDataInput = this->fields.searchDataInput;
  if ( !searchDataInput )
  ...
  if ( searchDataInput->fields.m_CachedPtr >= 1 )
  {
    ...
    do
    {
      ...
      if ( (unsigned __int16)(Chars - 48) <= 9u )
      {
        ...
        v7 = System_String__Concat_61385136(v7, v9, 0LL);
      }
      ++v8;
    }
...
void __fastcall FriendSearchMenu__OnClickCancel(FriendSearchMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (qword_49FA000 & 0x100000000000000LL) == 0 )
  {
    sub_1B64A00(&Method_FriendSearchMenu_OnClickCancel__, method);
    HIBYTE(qword_49FA000) = 1;
  }
  if ( this->fields.state == 2 )
  {
    this->fields.state = 3;
...
void __fastcall FriendSearchMenu__OnClickCopy(FriendSearchMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (qword_49FA000 & 0x100000000LL) == 0 )
  {
    sub_1B64A00(&NotificationDialog_ClickDelegate_TypeInfo, method);
    sub_1B64A00(&Method_FriendSearchMenu_EndCopyDialog__, v3);
    sub_1B64A00(&Method_FriendSearchMenu_OnClickCopy__, v4);
    ...
    sub_1B64A00(&StringLiteral_3868/*"COPY_MY_ID"*/, v8);
    BYTE4(qword_49FA000) = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    v16 = LocalizationManager__Get((System_String_o *)StringLiteral_3868/*"COPY_MY_ID"*/, 0LL);
    v17 = (NotificationDialog_ClickDelegate_o *)sub_1B64C4C(NotificationDialog_ClickDelegate_TypeInfo);
...
void __fastcall FriendSearchMenu__OnClickDecide(FriendSearchMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (qword_49FA000 & 0x1000000000000LL) == 0 )
  {
    sub_1B64A00(&Method_FriendSearchMenu_OnClickDecide__, method);
    BYTE6(qword_49FA000) = 1;
  }
  if ( this->fields.state == 2 )
  {
    searchDataInput = this->fields.searchDataInput;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F9FFF & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_UnityEngine_Component_GetComponent_UIInput___, v8);
    sub_1B64A00(&Method_FriendSearchMenu_EndOpen__, v9);
    sub_1B64A00(&LocalizationManager_TypeInfo, v10);
    sub_1B64A00(&StringLiteral_6504/*"FRIEND_SEARCH_EXPLANATION"*/, v11);
    sub_1B64A00(&StringLiteral_6506/*"FRIEND_SEARCH_TITLE1"*/, v12);
    sub_1B64A00(&StringLiteral_6507/*"FRIEND_SEARCH_TITLE2"*/, v13);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v17 = LocalizationManager__Get((System_String_o *)StringLiteral_6504/*"FRIEND_SEARCH_EXPLANATION"*/, 0LL);
  ...
  else if ( !state )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    searchDataInput = LocalizationManager__Get((System_String_o *)StringLiteral_6506/*"FRIEND_SEARCH_TITLE1"*/, 0LL);
    if ( title1Label )
    {
      UILabel__set_text(title1Label, (System_String_o *)searchDataInput, 0LL);
      title2Label = this->fields.title2Label;
      searchDataInput = LocalizationManager__Get((System_String_o *)StringLiteral_6507/*"FRIEND_SEARCH_TITLE2"*/, 0LL);
      if ( title2Label )
      {
        ...
        {
          myAddressLabel = this->fields.myAddressLabel;
          searchDataInput = LocalizationManager__GetNumberFormat_38085136(
...
LABEL_24:
    sub_1B64C5C(searchDataInput, callback);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F9FFC & 1) == 0 )
  {
    sub_1B64A00(&FriendSearchMenu_CallbackFunc_TypeInfo, value);
    byte_49F9FFC = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (FriendSearchMenu_o *)sub_1B64F1C(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19A5498;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19A5440;
}
