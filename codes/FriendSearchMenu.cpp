...
void __fastcall FriendSearchMenu__BlockInput(FriendSearchMenu_o *this, const MethodInfo *method)
{
  ...
  if ( !searchDataInput
    || (searchDataInput = (UnityEngine_Component_o *)UnityEngine_Component__GetComponent_object_(
                                                       searchDataInput,
                                                       (const MethodInfo_2EBAE18 *)Method_UnityEngine_Component_GetComponent_UIInput___)) == 0LL
    || (searchDataInput = (UnityEngine_Component_o *)UnityEngine_Component__GetComponent_object_(
                                                       searchDataInput,
                                                       (const MethodInfo_2EBAE18 *)Method_UnityEngine_Component_GetComponent_Collider___)) == 0LL )
  {
    sub_1BAB678(searchDataInput, method);
  }
...
void __fastcall FriendSearchMenu__Close(FriendSearchMenu_o *this, const MethodInfo *method)
{
  ...
  FriendSearchMenu__Close_31265380(this, 0LL, v2);
}


void __fastcall FriendSearchMenu__Close_31265380(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB10E3 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_FriendSearchMenu_EndClose__, v7);
    byte_4AB10E3 = 1;
  }
  ...
  if ( !searchDataInput
    ...
    || (searchDataInput = (UnityEngine_Component_o *)UnityEngine_Component__GetComponent_object_(
                                                       ...
                                                       (const MethodInfo_2EBAE18 *)Method_UnityEngine_Component_GetComponent_Collider___)) == 0LL )
  {
    sub_1BAB678(searchDataInput, v8);
  }
  UnityEngine_Collider__set_enabled((UnityEngine_Collider_o *)searchDataInput, 0, 0LL);
...
void __fastcall FriendSearchMenu__Init(FriendSearchMenu_o *this, const MethodInfo *method)
{
  ...
  {
LABEL_11:
    sub_1BAB678(title1Label, method);
  }
  ...
  if ( searchDataInput->fields.m_CachedPtr >= 1 )
  {
    ...
    do
    {
      ...
      if ( (unsigned __int16)(Chars - 48) <= 9u )
      {
        ...
        v7 = System_String__Concat_62048128(v7, v9, 0LL);
      }
      ++v8;
    }
...
void __fastcall FriendSearchMenu__OnClickCancel(FriendSearchMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB10E8 & 1) == 0 )
  {
    sub_1BAB41C(&Method_FriendSearchMenu_OnClickCancel__, method);
    byte_4AB10E8 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_FriendSearchMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BAB434(Method_FriendSearchMenu_OnClickCancel__);
...
void __fastcall FriendSearchMenu__OnClickCopy(FriendSearchMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB10E5 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_FriendSearchMenu_EndCopyDialog__, v3);
    sub_1BAB41C(&Method_FriendSearchMenu_OnClickCopy__, v4);
    ...
    sub_1BAB41C(&StringLiteral_3888/*"COPY_MY_ID"*/, v8);
    byte_4AB10E5 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_FriendSearchMenu_OnClickCopy__ + 83) & 2) != 0 )
      v9 = (_QWORD *)sub_1BAB434(Method_FriendSearchMenu_OnClickCopy__);
    ...
    v16 = LocalizationManager__Get((System_String_o *)StringLiteral_3888/*"COPY_MY_ID"*/, 0LL);
    v17 = (NotificationDialog_ClickDelegate_o *)sub_1BAB668(NotificationDialog_ClickDelegate_TypeInfo);
...
void __fastcall FriendSearchMenu__OnClickDecide(FriendSearchMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB10E7 & 1) == 0 )
  {
    sub_1BAB41C(&Method_FriendSearchMenu_OnClickDecide__, method);
    byte_4AB10E7 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_FriendSearchMenu_OnClickDecide__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1BAB434(Method_FriendSearchMenu_OnClickDecide__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB10E0 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_UnityEngine_Component_GetComponent_UIInput___, v8);
    sub_1BAB41C(&Method_FriendSearchMenu_EndOpen__, v9);
    sub_1BAB41C(&LocalizationManager_TypeInfo, v10);
    sub_1BAB41C(&StringLiteral_6531/*"FRIEND_SEARCH_EXPLANATION"*/, v11);
    sub_1BAB41C(&StringLiteral_6533/*"FRIEND_SEARCH_TITLE1"*/, v12);
    sub_1BAB41C(&StringLiteral_6534/*"FRIEND_SEARCH_TITLE2"*/, v13);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v17 = LocalizationManager__Get((System_String_o *)StringLiteral_6531/*"FRIEND_SEARCH_EXPLANATION"*/, 0LL);
  ...
  else if ( !state )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    searchDataInput = LocalizationManager__Get((System_String_o *)StringLiteral_6533/*"FRIEND_SEARCH_TITLE1"*/, 0LL);
    if ( title1Label )
    {
      UILabel__set_text(title1Label, (System_String_o *)searchDataInput, 0LL);
      title2Label = this->fields.title2Label;
      searchDataInput = LocalizationManager__Get((System_String_o *)StringLiteral_6534/*"FRIEND_SEARCH_TITLE2"*/, 0LL);
      if ( title2Label )
      {
        ...
        {
          myAddressLabel = this->fields.myAddressLabel;
          searchDataInput = LocalizationManager__GetNumberFormat_38777148(
...
LABEL_24:
    sub_1BAB678(searchDataInput, callback);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB10DD & 1) == 0 )
  {
    sub_1BAB41C(&FriendSearchMenu_CallbackFunc_TypeInfo, value);
    byte_4AB10DD = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (FriendSearchMenu_o *)sub_1BAB938(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19E7890;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19E7838;
}
