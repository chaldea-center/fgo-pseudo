...
void __fastcall FriendSearchMenu__BlockInput(FriendSearchMenu_o *this, const MethodInfo *method)
{
  ...
  if ( !searchDataInput
    || (searchDataInput = (UnityEngine_Component_o *)UnityEngine_Component__GetComponent_WebViewObject_(
                                                       searchDataInput,
                                                       (const MethodInfo_1A491D8 *)Method_UnityEngine_Component_GetComponent_UIInput___)) == 0LL
    || (searchDataInput = (UnityEngine_Component_o *)UnityEngine_Component__GetComponent_WebViewObject_(
                                                       searchDataInput,
                                                       (const MethodInfo_1A491D8 *)Method_UnityEngine_Component_GetComponent_Collider___)) == 0LL )
  {
    sub_B52A5C(searchDataInput, method);
  }
...
void __fastcall FriendSearchMenu__Callback(FriendSearchMenu_o *this, bool result, const MethodInfo *method)
{
  ...
  if ( callbackFunc )
  {
    ...
    sub_B52920(p_callbackFunc, 0LL, v8, v9, v10, v11, v12, v13);
...
void __fastcall FriendSearchMenu__Close(FriendSearchMenu_o *this, const MethodInfo *method)
{
  ...
  FriendSearchMenu__Close_30008000(this, 0LL, v2);
}


void __fastcall FriendSearchMenu__Close_30008000(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B2B68 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_UnityEngine_Component_GetComponent_Collider___);
    sub_B52984(&Method_UnityEngine_Component_GetComponent_UIInput___);
    sub_B52984(&Method_FriendSearchMenu_EndClose__);
    byte_42B2B68 = 1;
  }
  ...
  if ( !searchDataInput
    ...
    || (searchDataInput = (UnityEngine_Component_o *)UnityEngine_Component__GetComponent_WebViewObject_(
                                                       ...
                                                       (const MethodInfo_1A491D8 *)Method_UnityEngine_Component_GetComponent_Collider___)) == 0LL )
  {
    sub_B52A5C(searchDataInput, v10);
  }
  UnityEngine_Collider__set_enabled((UnityEngine_Collider_o *)searchDataInput, 0, 0LL);
  ...
  if ( searchDataInput->fields.m_CachedPtr >= 1 )
  {
    ...
    do
    {
      ...
      if ( (unsigned __int16)(Chars - 48) <= 9u )
      {
        ...
        v5 = System_String__Concat_44568316(v5, v7, 0LL);
      }
      ++v6;
    }
...
void __fastcall FriendSearchMenu__OnClickCopy(FriendSearchMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B2B6A & 1) == 0 )
  {
    ...
    sub_B52984(&Method_FriendSearchMenu_EndCopyDialog__);
    sub_B52984(&UnityEngine_GUIUtility_TypeInfo);
    sub_B52984(&LocalizationManager_TypeInfo);
    sub_B52984(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_B52984(&SoundManager_TypeInfo);
    sub_B52984(&StringLiteral_3426/*"COPY_MY_ID"*/);
    byte_42B2B6A = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    v8 = LocalizationManager__Get((System_String_o *)StringLiteral_3426/*"COPY_MY_ID"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B2B65 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_UnityEngine_Component_GetComponent_Collider___);
    sub_B52984(&Method_UnityEngine_Component_GetComponent_UIInput___);
    sub_B52984(&Method_FriendSearchMenu_EndOpen__);
    sub_B52984(&LocalizationManager_TypeInfo);
    sub_B52984(&StringLiteral_6540/*"FRIEND_SEARCH_EXPLANATION"*/);
    sub_B52984(&StringLiteral_6542/*"FRIEND_SEARCH_TITLE1"*/);
    sub_B52984(&StringLiteral_6543/*"FRIEND_SEARCH_TITLE2"*/);
    sub_B52984(&StringLiteral_1/*""*/);
    byte_42B2B65 = 1;
  }
  ...
  if ( isCodeClear || !p_searchId->klass )
  {
    ...
    sub_B52920(p_searchId, v12, (System_String_array **)isCodeClear, (System_String_array **)method, v4, v5, v6, v7);
  }
  searchDataInput = this->fields.searchDataInput;
  if ( !searchDataInput )
    goto LABEL_26;
  ...
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_6540/*"FRIEND_SEARCH_EXPLANATION"*/, 0LL);
  ...
  else if ( !state )
  {
    ...
    searchDataInput = LocalizationManager__Get((System_String_o *)StringLiteral_6542/*"FRIEND_SEARCH_TITLE1"*/, 0LL);
    if ( title1Label )
    {
      UILabel__set_text(title1Label, (System_String_o *)searchDataInput, 0LL);
      title2Label = this->fields.title2Label;
      searchDataInput = LocalizationManager__Get((System_String_o *)StringLiteral_6543/*"FRIEND_SEARCH_TITLE2"*/, 0LL);
      if ( title2Label )
      {
        ...
        {
          myAddressLabel = this->fields.myAddressLabel;
          searchDataInput = LocalizationManager__GetNumberFormat_34073440(
...
LABEL_26:
    sub_B52A5C(searchDataInput, callback);
  }
}
...
LABEL_5:
    ...
    while ( 1 )
    {
      ...
      if ( *(__int16 *)(v23 + 72) == -1 )
        sub_B52A40(*(_QWORD *)&v21->fields.extra_arg, result, friendCode, method);
