...
void __fastcall FriendSearchMenu__BlockInput(FriendSearchMenu_o *this, const MethodInfo *method)
{
  ...
  if ( !searchDataInput
    || (searchDataInput = (UnityEngine_Component_o *)UnityEngine_Component__GetComponent_object_(
                                                       searchDataInput,
                                                       (const MethodInfo_2E84CC0 *)Method_UnityEngine_Component_GetComponent_UIInput___)) == 0LL
    || (searchDataInput = (UnityEngine_Component_o *)UnityEngine_Component__GetComponent_object_(
                                                       searchDataInput,
                                                       (const MethodInfo_2E84CC0 *)Method_UnityEngine_Component_GetComponent_Collider___)) == 0LL )
  {
    sub_1B9026C(searchDataInput, method);
  }
...
void __fastcall FriendSearchMenu__Close(FriendSearchMenu_o *this, const MethodInfo *method)
{
  ...
  FriendSearchMenu__Close_30984964(this, 0LL, v2);
}


void __fastcall FriendSearchMenu__Close_30984964(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B28F & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_FriendSearchMenu_EndClose__, v7);
    byte_4A6B28F = 1;
  }
  ...
  if ( !searchDataInput
    ...
    || (searchDataInput = (UnityEngine_Component_o *)UnityEngine_Component__GetComponent_object_(
                                                       ...
                                                       (const MethodInfo_2E84CC0 *)Method_UnityEngine_Component_GetComponent_Collider___)) == 0LL )
  {
    sub_1B9026C(searchDataInput, v8);
  }
  UnityEngine_Collider__set_enabled((UnityEngine_Collider_o *)searchDataInput, 0, 0LL);
...
void __fastcall FriendSearchMenu__Init(FriendSearchMenu_o *this, const MethodInfo *method)
{
  ...
  {
LABEL_11:
    sub_1B9026C(title1Label, method);
  }
  ...
  if ( searchDataInput->fields.m_CachedPtr >= 1 )
  {
    ...
    do
    {
      ...
      if ( (unsigned __int16)(Chars - 48) <= 9u )
      {
        ...
        v7 = System_String__Concat_61787092(v7, v9, 0LL);
      }
      ++v8;
    }
...
void __fastcall FriendSearchMenu__OnClickCancel(FriendSearchMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B294 & 1) == 0 )
  {
    sub_1B90010(&Method_FriendSearchMenu_OnClickCancel__, method);
    byte_4A6B294 = 1;
  }
  if ( this->fields.state == 2 )
  {
...
void __fastcall FriendSearchMenu__OnClickCopy(FriendSearchMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B291 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_FriendSearchMenu_EndCopyDialog__, v3);
    sub_1B90010(&Method_FriendSearchMenu_OnClickCopy__, v4);
    ...
    sub_1B90010(&StringLiteral_3891/*"COPY_MY_ID"*/, v8);
    byte_4A6B291 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    v16 = LocalizationManager__Get((System_String_o *)StringLiteral_3891/*"COPY_MY_ID"*/, 0LL);
    v17 = (NotificationDialog_ClickDelegate_o *)sub_1B9025C(NotificationDialog_ClickDelegate_TypeInfo);
...
void __fastcall FriendSearchMenu__OnClickDecide(FriendSearchMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B293 & 1) == 0 )
  {
    sub_1B90010(&Method_FriendSearchMenu_OnClickDecide__, method);
    byte_4A6B293 = 1;
  }
  if ( this->fields.state == 2 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B28C & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_UnityEngine_Component_GetComponent_UIInput___, v8);
    sub_1B90010(&Method_FriendSearchMenu_EndOpen__, v9);
    sub_1B90010(&LocalizationManager_TypeInfo, v10);
    sub_1B90010(&StringLiteral_6533/*"FRIEND_SEARCH_EXPLANATION"*/, v11);
    sub_1B90010(&StringLiteral_6535/*"FRIEND_SEARCH_TITLE1"*/, v12);
    sub_1B90010(&StringLiteral_6536/*"FRIEND_SEARCH_TITLE2"*/, v13);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v17 = LocalizationManager__Get((System_String_o *)StringLiteral_6533/*"FRIEND_SEARCH_EXPLANATION"*/, 0LL);
  ...
  else if ( !state )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    searchDataInput = LocalizationManager__Get((System_String_o *)StringLiteral_6535/*"FRIEND_SEARCH_TITLE1"*/, 0LL);
    if ( title1Label )
    {
      UILabel__set_text(title1Label, (System_String_o *)searchDataInput, 0LL);
      title2Label = this->fields.title2Label;
      searchDataInput = LocalizationManager__Get((System_String_o *)StringLiteral_6536/*"FRIEND_SEARCH_TITLE2"*/, 0LL);
      if ( title2Label )
      {
        ...
        {
          myAddressLabel = this->fields.myAddressLabel;
          searchDataInput = LocalizationManager__GetNumberFormat_38446956(
...
LABEL_24:
    sub_1B9026C(searchDataInput, callback);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B289 & 1) == 0 )
  {
    sub_1B90010(&FriendSearchMenu_CallbackFunc_TypeInfo, value);
    byte_4A6B289 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (FriendSearchMenu_o *)sub_1B9052C(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19CE70C;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19CE6B4;
}
