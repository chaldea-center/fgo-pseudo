void AssetStorageLoadWrapper___ctor(AssetStorageLoadWrapper_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C55D74 & 1) == 0 )
  {
    sub_1C3E564(&AssetLoadWrapper_TypeInfo);
    sub_1C3E564(&SoundLoadWrapper_TypeInfo);
    byte_4C55D74 = 1;
  }
  v3 = (AssetLoadWrapperBase_o *)sub_1C3E7B0(AssetLoadWrapper_TypeInfo);
  ...
  v7 = (AssetLoadWrapperBase_o *)sub_1C3E7B0(SoundLoadWrapper_TypeInfo);
  AssetLoadWrapperBase___ctor(v7, v8);
  this->fields.soundManagerWrapper = (struct SoundLoadWrapper_o *)v7;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.soundManagerWrapper, (int32_t)v7, v9, v10);
...
void AssetStorageLoadWrapper__ReleaseAll(AssetStorageLoadWrapper_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C3E7C0(assetManagerWrapper, method);
  }
  AssetLoadWrapperBase__ReleaseAll(assetManagerWrapper, method);
}
