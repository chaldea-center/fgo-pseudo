void __fastcall AssetStorageLoadWrapper___ctor(AssetStorageLoadWrapper_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6EF8C & 1) == 0 )
  {
    sub_1B90010(&AssetLoadWrapper_TypeInfo, method);
    sub_1B90010(&SoundLoadWrapper_TypeInfo, v3);
    byte_4A6EF8C = 1;
  }
  v4 = (AssetLoadWrapper_o *)sub_1B9025C(AssetLoadWrapper_TypeInfo);
  ...
  v7 = (AssetLoadWrapperBase_o *)sub_1B9025C(SoundLoadWrapper_TypeInfo);
  AssetLoadWrapperBase___ctor(v7, 0LL);
  this->fields.soundManagerWrapper = (struct SoundLoadWrapper_o *)v7;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.soundManagerWrapper, (int32_t)v7, v8, v9);
...
void __fastcall AssetStorageLoadWrapper__ReleaseAll(AssetStorageLoadWrapper_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B9026C(assetManagerWrapper, method);
  }
  AssetLoadWrapperBase__ReleaseAll(assetManagerWrapper, 0LL);
}
