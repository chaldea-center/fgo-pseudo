void __fastcall AssetStorageLoadWrapper___ctor(AssetStorageLoadWrapper_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB37C1 & 1) == 0 )
  {
    sub_1C13D24(&AssetLoadWrapper_TypeInfo, method);
    sub_1C13D24(&SoundLoadWrapper_TypeInfo, v3);
    byte_4BB37C1 = 1;
  }
  v4 = (AssetLoadWrapperBase_o *)sub_1C13F70(AssetLoadWrapper_TypeInfo);
  AssetLoadWrapperBase___ctor(v4, v5);
  this->fields.assetManagerWrapper = (struct AssetLoadWrapper_o *)v4;
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields, (int64_t)v4, v6, v7, v8, v9, v10, v11);
  v12 = (AssetLoadWrapperBase_o *)sub_1C13F70(SoundLoadWrapper_TypeInfo);
...
void __fastcall AssetStorageLoadWrapper__ReleaseAll(AssetStorageLoadWrapper_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C13F80(assetManagerWrapper, method);
  }
  AssetLoadWrapperBase__ReleaseAll(assetManagerWrapper, method);
}
