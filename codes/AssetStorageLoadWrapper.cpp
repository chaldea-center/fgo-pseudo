void AssetStorageLoadWrapper___ctor(AssetStorageLoadWrapper_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2B85A & 1) == 0 )
  {
    sub_1C94098(&AssetLoadWrapper_TypeInfo);
    sub_1C94098(&SoundLoadWrapper_TypeInfo);
    byte_4D2B85A = 1;
  }
  v3 = (AssetLoadWrapperBase_o *)sub_1C942E4(AssetLoadWrapper_TypeInfo);
  ...
  v11 = (AssetLoadWrapperBase_o *)sub_1C942E4(SoundLoadWrapper_TypeInfo);
...
void AssetStorageLoadWrapper__ReleaseAll(AssetStorageLoadWrapper_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C942F0(assetManagerWrapper, method);
  }
  AssetLoadWrapperBase__ReleaseAll(assetManagerWrapper, method);
}
