void __fastcall CombineMenuControl___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C258E5 & 1) == 0 )
  {
    sub_1C3B764(&CombineMenuControl_TypeInfo, v1);
    sub_1C3B764(&StringLiteral_20697/*"l4"*/, v8);
    byte_4C258E5 = 1;
  }
  CombineMenuControl_TypeInfo->static_fields->DefaultBgName = (struct System_String_o *)StringLiteral_20697/*"l4"*/;
  sub_1C3B708(
    (PartyOrganizationUtility_o *)CombineMenuControl_TypeInfo->static_fields,
    StringLiteral_20697/*"l4"*/,
    v2,
    v3,
    v4,
    v5,
...
void __fastcall CombineMenuControl___ctor(CombineMenuControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C258E4 & 1) == 0 )
  {
    sub_1C3B764(&Method_System_Collections_Generic_List_CombineMenuControl_CombineItemInfo___ctor__, method);
    sub_1C3B764(&System_Collections_Generic_List_CombineMenuControl_CombineItemInfo__TypeInfo, v3);
    byte_4C258E4 = 1;
  }
  this->fields.scaleOffset = 1.0;
  this->fields.transformTotal = 1;
  v4 = (System_Collections_Generic_List_object__o *)sub_1C3B9B0(System_Collections_Generic_List_CombineMenuControl_CombineItemInfo__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v4,
    (const MethodInfo_368B438 *)Method_System_Collections_Generic_List_CombineMenuControl_CombineItemInfo___ctor__);
  this->fields.combineItemInfoList = (struct System_Collections_Generic_List_CombineMenuControl_CombineItemInfo__o *)v4;
  sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.combineItemInfoList, (int64_t)v4, v5, v6, v7, v8, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C258DC & 1) == 0 )
  {
    sub_1C3B764(&Method_BasicHelper_Any_CombineMenuControl_CombineItemInfo___, *(_QWORD *)&itemId);
    sub_1C3B764(&CombineMenuControl_CombineItemInfo_TypeInfo, v7);
    sub_1C3B764(&System_Func_CombineMenuControl_CombineItemInfo__bool__TypeInfo, v8);
    sub_1C3B764(&Method_System_Collections_Generic_List_CombineMenuControl_CombineItemInfo__Add__, v9);
    sub_1C3B764(&Method_CombineMenuControl___c__DisplayClass40_0__AddCombineItemInfo_b__0__, v10);
    sub_1C3B764(&CombineMenuControl___c__DisplayClass40_0_TypeInfo, v11);
    byte_4C258DC = 1;
  }
  v12 = sub_1C3B9B0(CombineMenuControl___c__DisplayClass40_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v12, 0LL);
  if ( !v12 )
    goto LABEL_10;
  *(_DWORD *)(v12 + 16) = itemId;
  combineItemInfoList = (System_Collections_Generic_List_T__o *)this->fields.combineItemInfoList;
  v16 = (System_Func_object__bool__o *)sub_1C3B9B0(System_Func_CombineMenuControl_CombineItemInfo__bool__TypeInfo);
  ...
  if ( BasicHelper__Any_object_(
         ...
         (const MethodInfo_2FDAB74 *)Method_BasicHelper_Any_CombineMenuControl_CombineItemInfo___) )
  {
    return;
  }
  v17 = (System_Collections_Generic_List_object__o *)this->fields.combineItemInfoList;
  v18 = *(_DWORD *)(v12 + 16);
  v19 = (CombineMenuControl_CombineItemInfo_o *)sub_1C3B9B0(CombineMenuControl_CombineItemInfo_TypeInfo);
...
void __fastcall CombineMenuControl__ClearCombineItemInfo(CombineMenuControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C258DB & 1) == 0 )
  {
    this = (CombineMenuControl_o *)sub_1C3B764(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C258E1 & 1) == 0 )
  {
    sub_1C3B764(&Method_CombineMenuControl_CloaseCombineItemLinkInfoListWindow__, decide);
  ...
  if ( (*((_BYTE *)Method_CombineMenuControl_CloaseCombineItemLinkInfoListWindow__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1C3B77C(Method_CombineMenuControl_CloaseCombineItemLinkInfoListWindow__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C258DD & 1) == 0 )
  {
    sub_1C3B764(&Method_System_Array_Empty_int___, itemIds);
    sub_1C3B764(&Method_System_Linq_Enumerable_Any_CombineMenuControl_CombineItemInfo___, v7);
    sub_1C3B764(&int___TypeInfo, v8);
    sub_1C3B764(&Method_System_Collections_Generic_List_CombineMenuControl_CombineItemInfo__get_Count__, v9);
    sub_1C3B764(&Method_System_Collections_Generic_List_CombineMenuControl_CombineItemInfo__get_Item__, v10);
    byte_4C258DD = 1;
  }
  ...
  if ( ((unsigned __int8)Item & 1) != 0 )
  {
    ...
    v22 = (System_Int32_array *)sub_1C3B80C(int___TypeInfo, (unsigned int)size);
    *itemIds = v22;
    sub_1C3B708((PartyOrganizationUtility_o *)itemIds, (int64_t)v22, v23, v24, v25, v26, v27, v28);
    v29 = (System_Int32_array *)sub_1C3B80C(int___TypeInfo, (unsigned int)size);
    *needNums = v29;
    sub_1C3B708((PartyOrganizationUtility_o *)needNums, (int64_t)v29, v30, v31, v32, v33, v34, v35);
    if ( (int)size >= 1 )
    {
      v36 = 0LL;
      while ( 1 )
      {
        ...
        Item = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___get_Item(
                                                              Item,
                                                              v36,
                                                              (const MethodInfo_368B99C *)Method_System_Collections_Generic_List_CombineMenuControl_CombineItemInfo__get_Item__);
        if ( !Item )
          break;
...
LABEL_35:
  ...
  else
  {
    ...
    v46 = *v45;
    *itemIds = *v45;
    sub_1C3B708((PartyOrganizationUtility_o *)itemIds, (int64_t)v46, v13, v14, v15, v16, v17, v18);
    ...
    v59 = *v58;
    *needNums = *v58;
    sub_1C3B708((PartyOrganizationUtility_o *)needNums, (int64_t)v59, v47, v48, v49, v50, v51, v52);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C258D8 & 1) == 0 )
  {
    ...
    this = (CombineMenuControl_o *)sub_1C3B764(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v5);
    byte_4C258D8 = 1;
  }
  ...
  *(_OWORD *)&v20.fields.fakeValue = v9;
  ...
  this = (CombineMenuControl_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this
...
LABEL_9:
  ...
  sub_1C3B708(p_selectMaterialUsrSvtEntity, (int64_t)Entity, v12, v13, v14, v15, v16, v17);
...
void __fastcall CombineMenuControl__InitMenuControl(CombineMenuControl_o *this, const MethodInfo *method)
{
  ...
  EventDelegate__Set_48207248(monitor, v17, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C258DF & 1) == 0 )
  {
    sub_1C3B764(&Method_BasicHelper_Find_ShopEntity___, *(_QWORD *)&itemId);
    ...
    sub_1C3B764(&Method_CombineMenuControl___c__DisplayClass43_0__IsPurePrismExchangeItem_b__0__, v8);
    sub_1C3B764(&CombineMenuControl___c__DisplayClass43_0_TypeInfo, v9);
    byte_4C258DF = 1;
  }
  v10 = sub_1C3B9B0(CombineMenuControl___c__DisplayClass43_0_TypeInfo);
  ...
  *(_DWORD *)(v10 + 16) = itemId;
  ...
  if ( !itemExchangeShopEntList )
  {
    ...
    if ( Master_object )
    {
      ...
      sub_1C3B708(p_itemExchangeShopEntList, (int64_t)EnableEntitiyList, v17, v18, v19, v20, v21, v22);
...
LABEL_9:
  v23 = (System_Func_object__bool__o *)sub_1C3B9B0(System_Func_ShopEntity__bool__TypeInfo);
  System_Func_object__bool____ctor(
    v23,
    (Il2CppObject *)v10,
  ...
  return BasicHelper__Find_object_(
           ...
           (const MethodInfo_2FDB740 *)Method_BasicHelper_Find_ShopEntity___) != 0LL;
}
...
void __fastcall CombineMenuControl__OnClickBase(CombineMenuControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C258D5 & 1) == 0 )
  {
    sub_1C3B764(&Method_CombineMenuControl_OnClickBase__, method);
  ...
  if ( (*((_BYTE *)Method_CombineMenuControl_OnClickBase__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1C3B77C(Method_CombineMenuControl_OnClickBase__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C258E0 & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_CombineMenuControl_CloaseCombineItemLinkInfoListWindow__, v4);
    sub_1C3B764(&Method_CombineMenuControl_OnClickCombineItemLinkInfoListWindow__, v5);
  ...
  if ( (*((_BYTE *)Method_CombineMenuControl_OnClickCombineItemLinkInfoListWindow__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1C3B77C(Method_CombineMenuControl_OnClickCombineItemLinkInfoListWindow__);
...
void __fastcall CombineMenuControl__OnClickHelp(CombineMenuControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C258DA & 1) == 0 )
  {
    sub_1C3B764(&Method_CombineMenuControl_OnClickHelp__, method);
    byte_4C258DA = 1;
  }
  v3 = Method_CombineMenuControl_OnClickHelp__;
  if ( (*((_BYTE *)Method_CombineMenuControl_OnClickHelp__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C3B77C(Method_CombineMenuControl_OnClickHelp__);
...
void __fastcall CombineMenuControl__OnClickLvExceedConductionWire(CombineMenuControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C258D9 & 1) == 0 )
  {
    sub_1C3B764(&Method_CombineMenuControl_OnClickLvExceedConductionWire__, method);
    byte_4C258D9 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_CombineMenuControl_OnClickLvExceedConductionWire__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C3B77C(Method_CombineMenuControl_OnClickLvExceedConductionWire__);
  v4 = (System_Reflection_MethodBase_o *)sub_1C3B748(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C258D7 & 1) == 0 )
  {
    sub_1C3B764(&Method_CombineMenuControl_OnClickMaterial__, *(_QWORD *)&type);
  ...
  if ( (*((_BYTE *)Method_CombineMenuControl_OnClickMaterial__ + 83) & 2) != 0 )
    v10 = (_QWORD *)sub_1C3B77C(Method_CombineMenuControl_OnClickMaterial__);
...
void __fastcall CombineMenuControl__OnLongPushListView(CombineMenuControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C258D6 & 1) == 0 )
  {
    sub_1C3B764(&Method_CombineMenuControl_OnLongPushListView__, method);
    byte_4C258D6 = 1;
  }
  if ( this->fields.baseUserServantEntity )
  {
    ...
    if ( (*((_BYTE *)Method_CombineMenuControl_OnLongPushListView__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3B77C(Method_CombineMenuControl_OnLongPushListView__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C3B748(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
    combineRootComponent = this->fields.combineRootComponent;
...
void __fastcall CombineMenuControl__Quit(CombineMenuControl_o *this, const MethodInfo *method)
{
  ...
  if ( assetList )
  {
    ...
    sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.assetList, 0LL, v4, v5, v6, v7, v8, v9);
  }
...
void __fastcall CombineMenuControl__SetInfoBgSprite(CombineMenuControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C258E3 & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_16446/*"anotherPayFlag"*/, v4);
    byte_4C258E3 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(infoBack, 0LL, 0LL) )
  {
    ...
    if ( transformTotal >= 2 )
    {
      v9 = System_String__Concat_63368612(**((System_String_o ***)v9 + 23), (System_String_o *)StringLiteral_16446/*"anotherPayFlag"*/, 0LL);
      if ( !v8 )
        goto LABEL_14;
