void CombineMenuControl___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CCB334 & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_20441/*"img_combinebg_03"*/);
    byte_4CCB334 = 1;
  }
  CombineMenuControl_TypeInfo->static_fields->DefaultBgName = (struct System_String_o *)StringLiteral_20441/*"img_combinebg_03"*/;
  sub_1C71354(
    (GrandQuestFolderBoardItem_o *)CombineMenuControl_TypeInfo->static_fields,
    StringLiteral_20441/*"img_combinebg_03"*/,
    v1,
    v2,
    v3,
    v4,
...
void CombineMenuControl___ctor(CombineMenuControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CCB333 & 1) == 0 )
  {
    sub_1C713B0(&Method_System_Collections_Generic_List_CombineMenuControl_CombineItemInfo___ctor__);
    sub_1C713B0(&System_Collections_Generic_List_CombineMenuControl_CombineItemInfo__TypeInfo);
    byte_4CCB333 = 1;
  }
  this->fields.scaleOffset = 1.0;
  this->fields.transformTotal = 1;
  v3 = (System_Collections_Generic_List_object__o *)sub_1C715FC(System_Collections_Generic_List_CombineMenuControl_CombineItemInfo__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v3,
    (const MethodInfo_380FEE4 *)Method_System_Collections_Generic_List_CombineMenuControl_CombineItemInfo___ctor__);
  this->fields.combineItemInfoList = (struct System_Collections_Generic_List_CombineMenuControl_CombineItemInfo__o *)v3;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.combineItemInfoList, (int32_t)v3, v4, v5, v6, v7, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CCB32A & 1) == 0 )
  {
    sub_1C713B0(&Method_BasicHelper_Any_CombineMenuControl_CombineItemInfo___);
    sub_1C713B0(&CombineMenuControl_CombineItemInfo_TypeInfo);
    sub_1C713B0(&System_Func_CombineMenuControl_CombineItemInfo__bool__TypeInfo);
    sub_1C713B0(&Method_System_Collections_Generic_List_CombineMenuControl_CombineItemInfo__Add__);
    sub_1C713B0(&Method_CombineMenuControl___c__DisplayClass40_0__AddCombineItemInfo_b__0__);
    sub_1C713B0(&CombineMenuControl___c__DisplayClass40_0_TypeInfo);
    byte_4CCB32A = 1;
  }
  v7 = sub_1C715FC(CombineMenuControl___c__DisplayClass40_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v7, 0);
  if ( !v7 )
    goto LABEL_10;
  *(_DWORD *)(v7 + 16) = itemId;
  combineItemInfoList = (System_Collections_Generic_List_T__o *)this->fields.combineItemInfoList;
  v11 = (System_Func_object__bool__o *)sub_1C715FC(System_Func_CombineMenuControl_CombineItemInfo__bool__TypeInfo);
  ...
  if ( BasicHelper__Any_object_(
         ...
         (const MethodInfo_31341D4 *)Method_BasicHelper_Any_CombineMenuControl_CombineItemInfo___) )
  {
    return;
  }
  v12 = (System_Collections_Generic_List_object__o *)this->fields.combineItemInfoList;
  v13 = *(_DWORD *)(v7 + 16);
  v14 = (CombineMenuControl_CombineItemInfo_o *)sub_1C715FC(CombineMenuControl_CombineItemInfo_TypeInfo);
...
void CombineMenuControl__ClearCombineItemInfo(CombineMenuControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CCB329 & 1) == 0 )
  {
    this = (CombineMenuControl_o *)sub_1C713B0(&Method_System_Collections_Generic_List_CombineMenuControl_CombineItemInfo__Clear__);
    byte_4CCB329 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CCB32F & 1) == 0 )
  {
    sub_1C713B0(&Method_CombineMenuControl_CloaseCombineItemLinkInfoListWindow__);
  ...
  if ( (*((_BYTE *)Method_CombineMenuControl_CloaseCombineItemLinkInfoListWindow__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C713C8(Method_CombineMenuControl_CloaseCombineItemLinkInfoListWindow__);
        ...
        const MethodInfo *method)
{
  ...
  if ( ((unsigned __int8)Item & 1) != 0 )
  {
    ...
    v18 = (System_Int32_array *)sub_1C71458(int___TypeInfo, (unsigned int)size);
    *itemIds = v18;
    sub_1C71354((GrandQuestFolderBoardItem_o *)itemIds, (int32_t)v18, v19, v20, v21, v22, v23, v24);
    v25 = (System_Int32_array *)sub_1C71458(int___TypeInfo, (unsigned int)size);
    *needNums = v25;
    sub_1C71354((GrandQuestFolderBoardItem_o *)needNums, (int32_t)v25, v26, v27, v28, v29, v30, v31);
    if ( (int)size >= 1 )
    {
      v32 = 0;
      while ( 1 )
...
LABEL_35:
  ...
  else
  {
    ...
    v42 = *v41;
    *itemIds = *v41;
    sub_1C71354((GrandQuestFolderBoardItem_o *)itemIds, (int32_t)v42, v9, v10, v11, v12, v13, v14);
    ...
    v55 = *v54;
    *needNums = *v54;
    sub_1C71354((GrandQuestFolderBoardItem_o *)needNums, (int32_t)v55, v43, v44, v45, v46, v47, v48);
  }
}
...
UserServantEntity_o *CombineMenuControl__GetMaterialUsrSvtData(CombineMenuControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CCB326 & 1) == 0 )
  {
    ...
    this = (CombineMenuControl_o *)sub_1C713B0(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4CCB326 = 1;
  }
  ...
  *(_OWORD *)&v17.fields.fakeValue = v6;
  ...
  this = (CombineMenuControl_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A5F158 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this
...
LABEL_9:
  ...
  sub_1C71354(p_selectMaterialUsrSvtEntity, (int32_t)Entity, v9, v10, v11, v12, v13, v14);
...
void CombineMenuControl__InitMenuControl(CombineMenuControl_o *this, const MethodInfo *method)
{
  ...
  EventDelegate__Set_49625676(monitor, v15, 0);
}
...
bool CombineMenuControl__IsPurePrismExchangeItem(CombineMenuControl_o *this, int32_t itemId, const MethodInfo *method)
{
  ...
  if ( (byte_4CCB32D & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_CombineMenuControl___c__DisplayClass43_0__IsPurePrismExchangeItem_b__0__);
    sub_1C713B0(&CombineMenuControl___c__DisplayClass43_0_TypeInfo);
    byte_4CCB32D = 1;
  }
  v5 = sub_1C715FC(CombineMenuControl___c__DisplayClass43_0_TypeInfo);
  ...
  *(_DWORD *)(v5 + 16) = itemId;
  ...
  if ( !itemExchangeShopEntList )
  {
    ...
    if ( Master_object )
    {
      ...
      sub_1C71354(p_itemExchangeShopEntList, (int32_t)EnableEntitiyList, v12, v13, v14, v15, v16, v17);
...
LABEL_9:
  v18 = (System_Func_object__bool__o *)sub_1C715FC(System_Func_ShopEntity__bool__TypeInfo);
  System_Func_object__bool____ctor(
    v18,
    (Il2CppObject *)v5,
  ...
  return BasicHelper__Find_object_(
           ...
           (const MethodInfo_3134DA0 *)Method_BasicHelper_Find_ShopEntity___) != 0;
}
...
void CombineMenuControl__OnClickBase(CombineMenuControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CCB323 & 1) == 0 )
  {
    sub_1C713B0(&Method_CombineMenuControl_OnClickBase__);
  ...
  if ( (*((_BYTE *)Method_CombineMenuControl_OnClickBase__ + 83) & 2) != 0 )
    v6 = (_QWORD *)sub_1C713C8(Method_CombineMenuControl_OnClickBase__);
...
void CombineMenuControl__OnClickCombineItemLinkInfoListWindow(CombineMenuControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CCB32E & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_CombineMenuControl_CloaseCombineItemLinkInfoListWindow__);
    sub_1C713B0(&Method_CombineMenuControl_OnClickCombineItemLinkInfoListWindow__);
    sub_1C713B0(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4CCB32E = 1;
  }
  v13 = 0;
  ...
  if ( (*((_BYTE *)Method_CombineMenuControl_OnClickCombineItemLinkInfoListWindow__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1C713C8(Method_CombineMenuControl_OnClickCombineItemLinkInfoListWindow__);
...
void CombineMenuControl__OnClickHelp(CombineMenuControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CCB328 & 1) == 0 )
  {
    sub_1C713B0(&Method_CombineMenuControl_OnClickHelp__);
    byte_4CCB328 = 1;
  }
  v3 = Method_CombineMenuControl_OnClickHelp__;
  if ( (*((_BYTE *)Method_CombineMenuControl_OnClickHelp__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C713C8(Method_CombineMenuControl_OnClickHelp__);
  v4 = (System_Reflection_MethodBase_o *)sub_1C71394(v3, v3[4]);
...
void CombineMenuControl__OnClickLvExceedConductionWire(CombineMenuControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CCB327 & 1) == 0 )
  {
    sub_1C713B0(&Method_CombineMenuControl_OnClickLvExceedConductionWire__);
    byte_4CCB327 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_CombineMenuControl_OnClickLvExceedConductionWire__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C713C8(Method_CombineMenuControl_OnClickLvExceedConductionWire__);
  v4 = (System_Reflection_MethodBase_o *)sub_1C71394(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (*((_BYTE *)Method_CombineMenuControl_OnClickMaterial__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1C713C8(Method_CombineMenuControl_OnClickMaterial__);
...
void CombineMenuControl__OnLongPushListView(CombineMenuControl_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.baseUserServantEntity )
  {
    ...
    if ( (*((_BYTE *)Method_CombineMenuControl_OnLongPushListView__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C713C8(Method_CombineMenuControl_OnLongPushListView__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C71394(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
    combineRootComponent = this->fields.combineRootComponent;
...
void CombineMenuControl__Quit(CombineMenuControl_o *this, const MethodInfo *method)
{
  ...
  if ( assetList )
  {
    ...
    sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.assetList, 0, v4, v5, v6, v7, v8, v9);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CCB332 & 1) == 0 )
  {
    ...
    this = (CombineMenuControl_o *)sub_1C713B0(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    byte_4CCB332 = 1;
  }
  if ( !usrSvtData )
    goto LABEL_15;
  ...
  *(_QWORD *)&v21.fields.fakeValue = v9;
  this = (CombineMenuControl_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49297952(v21, 0);
  if ( !v11 )
    goto LABEL_15;
  ...
  if ( ((unsigned __int8)this & 1) != 0 )
    return CharaGraphManager__CreateTexturePrefab_40933228(
...
LABEL_15:
  ...
  sub_1C71354(
    ...
    v18,
    v19);
  UICharaGraphTexture__SetCharacter_44217140(charaGraph, usrSvtData, ServantImageLimitSealAfter, 0, 0, 0, 0, 0);
  return charaGraph;
}
...
void CombineMenuControl__SetInfoBgSprite(CombineMenuControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CCB331 & 1) == 0 )
  {
    sub_1C713B0(&CombineMenuControl_TypeInfo);
    sub_1C713B0(&UnityEngine_Object_TypeInfo);
    sub_1C713B0(&StringLiteral_16117/*"_2"*/);
    byte_4CCB331 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(infoBack, 0, 0) )
  {
    ...
    if ( transformTotal >= 2 )
    {
      v7 = System_String__Concat_64031724(**((System_String_o ***)v7 + 23), (System_String_o *)StringLiteral_16117/*"_2"*/, 0);
      if ( !v6 )
        goto LABEL_14;
