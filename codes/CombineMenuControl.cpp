        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B2C4D & 1) == 0 )
  {
    ...
    this = (CombineMenuControl_o *)sub_B52984(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_42B2C4D = 1;
  }
  ...
  *(_OWORD *)&v17.fields.fakeValue = v6;
  ...
  this = (CombineMenuControl_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this
...
LABEL_10:
  ...
  sub_B52920(p_selectMaterialUsrSvtEntity, Entity, v9, v10, v11, v12, v13, v14);
...
void __fastcall CombineMenuControl__InitMenuControl(CombineMenuControl_o *this, const MethodInfo *method)
{
  ...
  EventDelegate__Set_29653788(klass, v13, 0LL);
}
...
void __fastcall CombineMenuControl__OnClickBase(CombineMenuControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B2C4A & 1) == 0 )
  {
    sub_B52984(&Method_CombineMenuControl_OnClickBase__);
...
LABEL_16:
  ...
  if ( (*((_BYTE *)Method_CombineMenuControl_OnClickBase__ + 75) & 2) != 0 )
    v5 = (_QWORD *)sub_B5298C(Method_CombineMenuControl_OnClickBase__);
