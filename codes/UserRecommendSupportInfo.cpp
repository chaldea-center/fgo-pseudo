...
void __fastcall UserRecommendSupportInfo__Finalize(UserRecommendSupportInfo_o *this, const MethodInfo *method)
{
  ...
  if ( userSvtLeaderInfo )
  {
    ...
    sub_1B8635C((CGThumbnailListItem_o *)&userSvtLeaderInfo->fields.equipTarget1, 0, v2, v3);
  }
        ...
        const MethodInfo *method)
{
  ...
  v5 = (TreasureDvcInfo_o *)sub_1B86604(TreasureDvcInfo_TypeInfo);
  TreasureDvcInfo___ctor(v5, v6);
  *tdInfo = v5;
  sub_1B8635C((CGThumbnailListItem_o *)tdInfo, (int32_t)v5, v7, v8);
  userSvtLeaderInfo = this->fields.userSvtLeaderInfo;
  if ( userSvtLeaderInfo )
...
bool __fastcall UserRecommendSupportInfo__GetTreasureDeviceInfo_41612652(
        UserRecommendSupportInfo_o *this,
        int32_t *tdLv,
        int32_t *tdMaxLv,
        const MethodInfo *method)
{
  ...
  *tdMaxLv = 1;
  userSvtLeaderInfo = this->fields.userSvtLeaderInfo;
  if ( userSvtLeaderInfo )
    LOBYTE(userSvtLeaderInfo) = ServantLeaderInfo__getTreasureDeviceInfo_41550136(
                                  userSvtLeaderInfo,
                                  tdLv,
                                  tdMaxLv,
                                  method);
