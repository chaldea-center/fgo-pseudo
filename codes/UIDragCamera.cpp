...
void UIDragCamera__Awake(UIDragCamera_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_5974FAD & 1) == 0 )
  {
    sub_2213A60(&Method_NGUITools_FindInParents_UIDraggableCamera___);
  ...
  if ( UnityEngine_Object__op_Equality(draggableCamera, 0, 0) )
  {
    ...
    v7 = NGUITools__FindInParents_object_(
           gameObject,
           (const MethodInfo_38F0B48 *)Method_NGUITools_FindInParents_UIDraggableCamera___);
    p_draggableCamera->klass = (MissionNaviTransitionBoardItem_c *)v7;
    sub_2213A04(p_draggableCamera, (int32_t)v7, v8, v9, v10, v11, v12, v13);
  }
}
