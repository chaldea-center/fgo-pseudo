...
void UIDragCamera__Awake(UIDragCamera_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E7BD83 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_NGUITools_FindInParents_UIDraggableCamera___);
  ...
  if ( UnityEngine_Object__op_Equality(draggableCamera, 0, 0) )
  {
    ...
    v6 = NGUITools__FindInParents_object_(
           gameObject,
           (const MethodInfo_32DB22C *)Method_NGUITools_FindInParents_UIDraggableCamera___);
    p_draggableCamera->klass = (GrandQuestFolderBoardItem_c *)v6;
    sub_1D0F058(p_draggableCamera, (int32_t)v6, v7, v8, v9, v10, v11, v12);
  }
}
