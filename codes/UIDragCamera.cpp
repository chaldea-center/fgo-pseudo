...
void UIDragCamera__Awake(UIDragCamera_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C5B368 & 1) == 0 )
  {
    sub_1C3E564(&Method_NGUITools_FindInParents_UIDraggableCamera___);
  ...
  if ( UnityEngine_Object__op_Equality(draggableCamera, 0, 0) )
  {
    ...
    v6 = NGUITools__FindInParents_object_(
           gameObject,
           (const MethodInfo_3183E10 *)Method_NGUITools_FindInParents_UIDraggableCamera___);
    p_draggableCamera->klass = (CGThumbnailListItem_c *)v6;
    sub_1C3E508(p_draggableCamera, (int32_t)v6, v7, v8);
  }
}
