void __fastcall BattleSyncTransformComponent___ctor(BattleSyncTransformComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A22B57 & 1) == 0 )
  {
    sub_1B715CC(&BattleSyncTransformComponent_SyncData_TypeInfo, method);
    byte_4A22B57 = 1;
  }
  v3 = (Il2CppObject *)sub_1B71818(BattleSyncTransformComponent_SyncData_TypeInfo);
  System_Object___ctor(v3, 0LL);
  this->fields.syncData = (struct BattleSyncTransformComponent_SyncData_o *)v3;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.syncData, (int32_t)v3, v4, v5);
        ...
        const MethodInfo *method)
{
  ...
  y = posDiff.fields.y;
  x = posDiff.fields.x;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.targetObj, 0, v3, v4);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.syncData, (int32_t)syncData, v8, v9);
  return this;
}


BattleSyncTransformComponent_o *__fastcall BattleSyncTransformComponent__SetTarget_43847504(
        BattleSyncTransformComponent_o *this,
        UnityEngine_Transform_o *target,
        ...
        const MethodInfo *method)
{
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.syncData, (int32_t)syncSettingData, v6, v7);
  return this;
}
        ...
        const MethodInfo *method)
{
  ...
  this->fields.targetObj = target;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.targetObj, (int32_t)target, (int32_t)method, v3);
}
