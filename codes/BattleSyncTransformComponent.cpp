void __fastcall BattleSyncTransformComponent___ctor(BattleSyncTransformComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C00AFF & 1) == 0 )
  {
    sub_1C2E12C(&BattleSyncTransformComponent_SyncData_TypeInfo, method);
    byte_4C00AFF = 1;
  }
  v3 = (Il2CppObject *)sub_1C2E378(BattleSyncTransformComponent_SyncData_TypeInfo);
  System_Object___ctor(v3, 0LL);
  this->fields.syncData = (struct BattleSyncTransformComponent_SyncData_o *)v3;
  sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.syncData, (int64_t)v3, v4, v5, v6, v7, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  y = posDiff.fields.y;
  x = posDiff.fields.x;
  sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.targetObj, 0LL, v3, v4, v5, v6, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.syncData, (int64_t)syncData, v12, v13, v14, v15, v16, v17);
  return this;
}


BattleSyncTransformComponent_o *__fastcall BattleSyncTransformComponent__SetTarget_45675712(
        BattleSyncTransformComponent_o *this,
        UnityEngine_Transform_o *target,
