void BattleSyncTransformComponent___ctor(BattleSyncTransformComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E082DE & 1) == 0 )
  {
    sub_1CE6700(&BattleSyncTransformComponent_SyncData_TypeInfo);
    byte_4E082DE = 1;
  }
  v3 = (Il2CppObject *)sub_1CE694C(BattleSyncTransformComponent_SyncData_TypeInfo);
  System_Object___ctor(v3, 0);
  this->fields.syncData = (struct BattleSyncTransformComponent_SyncData_o *)v3;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.syncData, (int32_t)v3, v4, v5, v6, v7, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  y = posDiff.fields.y;
  x = posDiff.fields.x;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.targetObj, 0, v3, v4, v5, v6, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.syncData, (int32_t)syncData, v12, v13, v14, v15, v16, v17);
  return this;
}


BattleSyncTransformComponent_o *BattleSyncTransformComponent__SetTarget_48881232(
        BattleSyncTransformComponent_o *this,
        UnityEngine_Transform_o *target,
