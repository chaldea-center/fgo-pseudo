        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2AC02 & 1) == 0 )
  {
    sub_1B761C0(&Method_UnityEngine_GameObject_GetComponent_SubmarineSelectScannerListViewItemDraw___, method);
    byte_4A2AC02 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2EB19B8 *)Method_UnityEngine_GameObject_GetComponent_SubmarineSelectScannerListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2AC03 & 1) == 0 )
  {
    sub_1B761C0(&SubmarineSelectScannerListViewItem_TypeInfo, item);
    byte_4A2AC03 = 1;
  }
