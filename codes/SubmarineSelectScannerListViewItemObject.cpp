        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB1299 & 1) == 0 )
  {
    sub_1C13D24(&Method_UnityEngine_GameObject_GetComponent_SubmarineSelectScannerListViewItemDraw___, method);
    byte_4BB1299 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2FDF9FC *)Method_UnityEngine_GameObject_GetComponent_SubmarineSelectScannerListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB129A & 1) == 0 )
  {
    sub_1C13D24(&SubmarineSelectScannerListViewItem_TypeInfo, item);
    byte_4BB129A = 1;
  }
