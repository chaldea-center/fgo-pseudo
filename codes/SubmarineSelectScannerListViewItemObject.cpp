        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFA2CA & 1) == 0 )
  {
    sub_1C2E12C(&Method_UnityEngine_GameObject_GetComponent_SubmarineSelectScannerListViewItemDraw___, method);
    byte_4BFA2CA = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_3022B0C *)Method_UnityEngine_GameObject_GetComponent_SubmarineSelectScannerListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFA2CB & 1) == 0 )
  {
    sub_1C2E12C(&SubmarineSelectScannerListViewItem_TypeInfo, item);
    byte_4BFA2CB = 1;
  }
