        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B63784 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_UnityEngine_GameObject_GetComponent_SubmarineSelectScannerListViewItemDraw___, method);
    byte_4B63784 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2FA979C *)Method_UnityEngine_GameObject_GetComponent_SubmarineSelectScannerListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B63785 & 1) == 0 )
  {
    sub_1BE4ACC(&SubmarineSelectScannerListViewItem_TypeInfo, item);
    byte_4B63785 = 1;
  }
