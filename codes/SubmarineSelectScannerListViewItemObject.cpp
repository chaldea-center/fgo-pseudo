        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB29A4 & 1) == 0 )
  {
    sub_1BAB41C(&Method_UnityEngine_GameObject_GetComponent_SubmarineSelectScannerListViewItemDraw___, method);
    byte_4AB29A4 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2F13970 *)Method_UnityEngine_GameObject_GetComponent_SubmarineSelectScannerListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB29A5 & 1) == 0 )
  {
    sub_1BAB41C(&SubmarineSelectScannerListViewItem_TypeInfo, item);
    byte_4AB29A5 = 1;
  }
