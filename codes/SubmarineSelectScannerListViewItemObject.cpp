        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B33D9A & 1) == 0 )
  {
    sub_1BD3458(&Method_UnityEngine_GameObject_GetComponent_SubmarineSelectScannerListViewItemDraw___, method);
    byte_4B33D9A = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2F81A7C *)Method_UnityEngine_GameObject_GetComponent_SubmarineSelectScannerListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B33D9B & 1) == 0 )
  {
    sub_1BD3458(&SubmarineSelectScannerListViewItem_TypeInfo, item);
    byte_4B33D9B = 1;
  }
