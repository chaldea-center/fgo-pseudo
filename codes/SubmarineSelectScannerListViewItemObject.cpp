        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C799 & 1) == 0 )
  {
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponent_SubmarineSelectScannerListViewItemDraw___, method);
    byte_4A1C799 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2EAA998 *)Method_UnityEngine_GameObject_GetComponent_SubmarineSelectScannerListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C79A & 1) == 0 )
  {
    sub_1B715CC(&SubmarineSelectScannerListViewItem_TypeInfo, item);
    byte_4A1C79A = 1;
  }
