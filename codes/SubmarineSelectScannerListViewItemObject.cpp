        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC4653 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_UnityEngine_GameObject_GetComponent_SubmarineSelectScannerListViewItemDraw___, method);
    byte_4BC4653 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2FEFBC0 *)Method_UnityEngine_GameObject_GetComponent_SubmarineSelectScannerListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC4654 & 1) == 0 )
  {
    sub_1C1ABD4(&SubmarineSelectScannerListViewItem_TypeInfo, item);
    byte_4BC4654 = 1;
  }
