void __fastcall AgeVerificationMenu___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AFFBE1 & 1) == 0 )
  {
    sub_1BC3008(&AgeVerificationMenu_TypeInfo, v1);
    sub_1BC3008(&string___TypeInfo, v4);
    sub_1BC3008(&StringLiteral_1931/*"AGE_VEIFICATION_TYPE3"*/, v5);
    sub_1BC3008(&StringLiteral_1927/*"AGE_VEIFICATION_NONE"*/, v6);
    sub_1BC3008(&StringLiteral_2167/*"AgeVerificationType"*/, v7);
    sub_1BC3008(&StringLiteral_2166/*"AgeVerificationExpirationDate"*/, v8);
    sub_1BC3008(&StringLiteral_1929/*"AGE_VEIFICATION_TYPE1"*/, v9);
    sub_1BC3008(&StringLiteral_1930/*"AGE_VEIFICATION_TYPE2"*/, v10);
    sub_1BC3008(&StringLiteral_2165/*"AgeVerificationCumulativeAmount"*/, v11);
    byte_4AFFBE1 = 1;
  }
  AgeVerificationMenu_TypeInfo->static_fields->SAVE_KEY_TYPE = (struct System_String_o *)StringLiteral_2167/*"AgeVerificationType"*/;
  sub_1BC2FAC((CGThumbnailListItem_o *)AgeVerificationMenu_TypeInfo->static_fields, StringLiteral_2167/*"AgeVerificationType"*/, v2, v3);
  v12 = StringLiteral_2166/*"AgeVerificationExpirationDate"*/;
  static_fields = AgeVerificationMenu_TypeInfo->static_fields;
  static_fields->SAVE_KEY_EXPIRATION_DATE = (struct System_String_o *)StringLiteral_2166/*"AgeVerificationExpirationDate"*/;
  sub_1BC2FAC((CGThumbnailListItem_o *)&static_fields->SAVE_KEY_EXPIRATION_DATE, v12, v14, v15);
  v16 = StringLiteral_2165/*"AgeVerificationCumulativeAmount"*/;
  v17 = AgeVerificationMenu_TypeInfo->static_fields;
  v17->SAVE_KEY_CUMULATIVE_AMOUNT = (struct System_String_o *)StringLiteral_2165/*"AgeVerificationCumulativeAmount"*/;
  sub_1BC2FAC((CGThumbnailListItem_o *)&v17->SAVE_KEY_CUMULATIVE_AMOUNT, v16, v18, v19);
  v20 = sub_1BC30B0(string___TypeInfo, 4LL);
  if ( !v20 )
    sub_1BC3264(0LL, v21);
  v24 = v20;
  if ( !*(_DWORD *)(v20 + 24) )
    goto LABEL_9;
  v25 = StringLiteral_1927/*"AGE_VEIFICATION_NONE"*/;
  *(_QWORD *)(v20 + 32) = StringLiteral_1927/*"AGE_VEIFICATION_NONE"*/;
  sub_1BC2FAC((CGThumbnailListItem_o *)(v20 + 32), v25, v22, v23);
  if ( *(_DWORD *)(v24 + 24) <= 1u
    || (v27 = StringLiteral_1929/*"AGE_VEIFICATION_TYPE1"*/,
        *(_QWORD *)(v24 + 40) = StringLiteral_1929/*"AGE_VEIFICATION_TYPE1"*/,
        sub_1BC2FAC((CGThumbnailListItem_o *)(v24 + 40), v27, v22, v26),
        *(_DWORD *)(v24 + 24) <= 2u)
    || (v29 = StringLiteral_1930/*"AGE_VEIFICATION_TYPE2"*/,
        *(_QWORD *)(v24 + 48) = StringLiteral_1930/*"AGE_VEIFICATION_TYPE2"*/,
        sub_1BC2FAC((CGThumbnailListItem_o *)(v24 + 48), v29, v22, v28),
        *(_DWORD *)(v24 + 24) <= 3u) )
  {
LABEL_9:
    sub_1BC326C(v20, v21, v22);
  }
  v31 = StringLiteral_1931/*"AGE_VEIFICATION_TYPE3"*/;
  *(_QWORD *)(v24 + 56) = StringLiteral_1931/*"AGE_VEIFICATION_TYPE3"*/;
  sub_1BC2FAC((CGThumbnailListItem_o *)(v24 + 56), v31, v22, v30);
  v32 = AgeVerificationMenu_TypeInfo->static_fields;
  v32->typeTextList = (struct System_String_array *)v24;
  sub_1BC2FAC((CGThumbnailListItem_o *)&v32->typeTextList, v24, v33, v34);
}
...
void __fastcall AgeVerificationMenu__Close(AgeVerificationMenu_o *this, const MethodInfo *method)
{
  ...
  AgeVerificationMenu__Close_37170144(this, 0LL, v2);
}


void __fastcall AgeVerificationMenu__Close_37170144(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFFBD8 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_AgeVerificationMenu_EndClose__, v6);
    byte_4AFFBD8 = 1;
  }
...
void __fastcall AgeVerificationMenu__Concent(int32_t type, const MethodInfo *method)
{
  ...
  if ( (byte_4AFFBD0 & 1) == 0 )
  {
    sub_1BC3008(&AgeVerificationMenu_TypeInfo, method);
...
void __fastcall AgeVerificationMenu__ConfirmType(AgeVerificationMenu_o *this, int32_t type, const MethodInfo *method)
{
  ...
  if ( (byte_4AFFBD9 & 1) == 0 )
  {
    sub_1BC3008(&Method_AgeVerificationMenu_OnEndConfirm__, *(_QWORD *)&type);
    sub_1BC3008(&AgeVerificationMenu_TypeInfo, v5);
    ...
    sub_1BC3008(&StringLiteral_1925/*"AGE_VEIFICATION_CONFIRM_TITLE"*/, v10);
    sub_1BC3008(&StringLiteral_1924/*"AGE_VEIFICATION_CONFIRM_MESSAGE"*/, v11);
    sub_1BC3008(&StringLiteral_1922/*"AGE_VEIFICATION_CONFIRM_CANCEL"*/, v12);
    sub_1BC3008(&StringLiteral_1923/*"AGE_VEIFICATION_CONFIRM_DECIDE"*/, v13);
    byte_4AFFBD9 = 1;
  }
  this->fields.state = 3;
  ...
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_1925/*"AGE_VEIFICATION_CONFIRM_TITLE"*/, 0LL);
  v16 = LocalizationManager__Get((System_String_o *)StringLiteral_1924/*"AGE_VEIFICATION_CONFIRM_MESSAGE"*/, 0LL);
  ...
  v25 = LocalizationManager__Get((System_String_o *)StringLiteral_1923/*"AGE_VEIFICATION_CONFIRM_DECIDE"*/, 0LL);
  v26 = LocalizationManager__Get((System_String_o *)StringLiteral_1922/*"AGE_VEIFICATION_CONFIRM_CANCEL"*/, 0LL);
  v27 = (CommonConfirmDialog_ClickDelegate_o *)sub_1BC3254(CommonConfirmDialog_ClickDelegate_TypeInfo);
...
bool __fastcall AgeVerificationMenu__IsConcent(const MethodInfo *method)
{
  ...
  {
    sub_1BC3008(&AgeVerificationMenu_TypeInfo, v1);
    sub_1BC3008(&System_DateTime_TypeInfo, v2);
    sub_1BC3008(&ManagerConfig_TypeInfo, v3);
    sub_1BC3008(&NetworkManager_TypeInfo, v4);
    sub_1BC3008(&StringLiteral_1113/*"0"*/, v5);
    byte_4AFFBCE = 1;
  }
  ...
  if ( Int )
  {
    ...
    v17 = NetworkManager__getDateTime_40293048(v12, 0LL).fields._dateData;
...
void __fastcall AgeVerificationMenu__OnClickCancel(AgeVerificationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFFBDE & 1) == 0 )
  {
    sub_1BC3008(&Method_AgeVerificationMenu_OnClickCancel__, method);
    byte_4AFFBDE = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_AgeVerificationMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BC3020(Method_AgeVerificationMenu_OnClickCancel__);
...
void __fastcall AgeVerificationMenu__OnClickType1(AgeVerificationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFFBDB & 1) == 0 )
  {
    sub_1BC3008(&Method_AgeVerificationMenu_OnClickType1__, method);
    byte_4AFFBDB = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_AgeVerificationMenu_OnClickType1__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BC3020(Method_AgeVerificationMenu_OnClickType1__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BC2FEC(v3, v3[4]);
...
void __fastcall AgeVerificationMenu__OnClickType2(AgeVerificationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFFBDC & 1) == 0 )
  {
    sub_1BC3008(&Method_AgeVerificationMenu_OnClickType2__, method);
    byte_4AFFBDC = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_AgeVerificationMenu_OnClickType2__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BC3020(Method_AgeVerificationMenu_OnClickType2__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BC2FEC(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
...
void __fastcall AgeVerificationMenu__OnClickType3(AgeVerificationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFFBDD & 1) == 0 )
  {
    sub_1BC3008(&Method_AgeVerificationMenu_OnClickType3__, method);
    byte_4AFFBDD = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_AgeVerificationMenu_OnClickType3__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BC3020(Method_AgeVerificationMenu_OnClickType3__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BC2FEC(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
...
void __fastcall AgeVerificationMenu__OnEndConfirm(AgeVerificationMenu_o *this, bool result, const MethodInfo *method)
{
  ...
  if ( (byte_4AFFBDA & 1) == 0 )
  {
    sub_1BC3008(&AgeVerificationMenu_TypeInfo, result);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BC3008(&System_Action_TypeInfo, callback);
    sub_1BC3008(&Method_AgeVerificationMenu_EndOpen__, v6);
    sub_1BC3008(&AgeVerificationMenu_TypeInfo, v7);
    sub_1BC3008(&LocalizationManager_TypeInfo, v8);
    sub_1BC3008(&StringLiteral_1928/*"AGE_VEIFICATION_TITLE"*/, v9);
    sub_1BC3008(&StringLiteral_1926/*"AGE_VEIFICATION_MESSAGE"*/, v10);
    byte_4AFFBD7 = 1;
  }
  ...
  if ( state == 4 )
  {
    ...
    sub_1BC2FAC((CGThumbnailListItem_o *)p_callbackFunc, (int32_t)callback, (int32_t)method, v3);
  ...
  else if ( !state )
  {
    ...
    if ( gameObject )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_1928/*"AGE_VEIFICATION_TITLE"*/, 0LL);
      if ( titleLabel )
      {
        UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL);
        messageLabel = this->fields.messageLabel;
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_1926/*"AGE_VEIFICATION_MESSAGE"*/, 0LL);
        if ( messageLabel )
        {
          ...
          if ( v18 )
          {
            ...
            if ( v21->max_length <= 3 )
LABEL_25:
              sub_1BC326C(gameObject, v13, v16);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFFBCC & 1) == 0 )
  {
    sub_1BC3008(&AgeVerificationMenu_CallbackFunc_TypeInfo, value);
    byte_4AFFBCC = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A0B404;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A0B3BC;
}
