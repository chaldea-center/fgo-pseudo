void __fastcall AgeVerificationMenu___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B6469F & 1) == 0 )
  {
    sub_1BE4ACC(&AgeVerificationMenu_TypeInfo, v1);
    sub_1BE4ACC(&string___TypeInfo, v8);
    sub_1BE4ACC(&StringLiteral_2068/*"AGE_VEIFICATION_TYPE3"*/, v9);
    sub_1BE4ACC(&StringLiteral_2064/*"AGE_VEIFICATION_NONE"*/, v10);
    sub_1BE4ACC(&StringLiteral_2299/*"AgeVerificationType"*/, v11);
    sub_1BE4ACC(&StringLiteral_2298/*"AgeVerificationExpirationDate"*/, v12);
    sub_1BE4ACC(&StringLiteral_2066/*"AGE_VEIFICATION_TYPE1"*/, v13);
    sub_1BE4ACC(&StringLiteral_2067/*"AGE_VEIFICATION_TYPE2"*/, v14);
    sub_1BE4ACC(&StringLiteral_2297/*"AgeVerificationCumulativeAmount"*/, v15);
    byte_4B6469F = 1;
  }
  AgeVerificationMenu_TypeInfo->static_fields->SAVE_KEY_TYPE = (struct System_String_o *)StringLiteral_2299/*"AgeVerificationType"*/;
  sub_1BE4A70(
    (PartyOrganizationUtility_o *)AgeVerificationMenu_TypeInfo->static_fields,
    StringLiteral_2299/*"AgeVerificationType"*/,
    v2,
    v3,
    v4,
    v5,
    v6,
    v7);
  v16 = StringLiteral_2298/*"AgeVerificationExpirationDate"*/;
  static_fields = AgeVerificationMenu_TypeInfo->static_fields;
  static_fields->SAVE_KEY_EXPIRATION_DATE = (struct System_String_o *)StringLiteral_2298/*"AgeVerificationExpirationDate"*/;
  sub_1BE4A70((PartyOrganizationUtility_o *)&static_fields->SAVE_KEY_EXPIRATION_DATE, v16, v18, v19, v20, v21, v22, v23);
  v24 = StringLiteral_2297/*"AgeVerificationCumulativeAmount"*/;
  v25 = AgeVerificationMenu_TypeInfo->static_fields;
  v25->SAVE_KEY_CUMULATIVE_AMOUNT = (struct System_String_o *)StringLiteral_2297/*"AgeVerificationCumulativeAmount"*/;
  sub_1BE4A70((PartyOrganizationUtility_o *)&v25->SAVE_KEY_CUMULATIVE_AMOUNT, v24, v26, v27, v28, v29, v30, v31);
  v32 = sub_1BE4B74(string___TypeInfo, 4LL);
  if ( !v32 )
    sub_1BE4D28(0LL, v33);
  v40 = v32;
  if ( !*(_DWORD *)(v32 + 24) )
    goto LABEL_9;
  v41 = StringLiteral_2064/*"AGE_VEIFICATION_NONE"*/;
  *(_QWORD *)(v32 + 32) = StringLiteral_2064/*"AGE_VEIFICATION_NONE"*/;
  sub_1BE4A70((PartyOrganizationUtility_o *)(v32 + 32), v41, v34, v35, v36, v37, v38, v39);
  if ( *(_DWORD *)(v40 + 24) <= 1u
    || (v48 = StringLiteral_2066/*"AGE_VEIFICATION_TYPE1"*/,
        *(_QWORD *)(v40 + 40) = StringLiteral_2066/*"AGE_VEIFICATION_TYPE1"*/,
        sub_1BE4A70((PartyOrganizationUtility_o *)(v40 + 40), v48, v42, v43, v44, v45, v46, v47),
        *(_DWORD *)(v40 + 24) <= 2u)
    || (v55 = StringLiteral_2067/*"AGE_VEIFICATION_TYPE2"*/,
        *(_QWORD *)(v40 + 48) = StringLiteral_2067/*"AGE_VEIFICATION_TYPE2"*/,
        sub_1BE4A70((PartyOrganizationUtility_o *)(v40 + 48), v55, v49, v50, v51, v52, v53, v54),
        *(_DWORD *)(v40 + 24) <= 3u) )
  {
LABEL_9:
    sub_1BE4D30(v32, v33);
  }
  v62 = StringLiteral_2068/*"AGE_VEIFICATION_TYPE3"*/;
  *(_QWORD *)(v40 + 56) = StringLiteral_2068/*"AGE_VEIFICATION_TYPE3"*/;
  sub_1BE4A70((PartyOrganizationUtility_o *)(v40 + 56), v62, v56, v57, v58, v59, v60, v61);
  v63 = AgeVerificationMenu_TypeInfo->static_fields;
  v63->typeTextList = (struct System_String_array *)v40;
  sub_1BE4A70((PartyOrganizationUtility_o *)&v63->typeTextList, v40, v64, v65, v66, v67, v68, v69);
}
...
void __fastcall AgeVerificationMenu__Close(AgeVerificationMenu_o *this, const MethodInfo *method)
{
  ...
  AgeVerificationMenu__Close_36095276(this, 0LL, v2);
}


void __fastcall AgeVerificationMenu__Close_36095276(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B64696 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_AgeVerificationMenu_EndClose__, v10);
    byte_4B64696 = 1;
  }
...
void __fastcall AgeVerificationMenu__Concent(int32_t type, const MethodInfo *method)
{
  ...
  if ( (byte_4B6468E & 1) == 0 )
  {
    sub_1BE4ACC(&AgeVerificationMenu_TypeInfo, method);
...
void __fastcall AgeVerificationMenu__ConfirmType(AgeVerificationMenu_o *this, int32_t type, const MethodInfo *method)
{
  ...
  if ( (byte_4B64697 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_AgeVerificationMenu_OnEndConfirm__, *(_QWORD *)&type);
    sub_1BE4ACC(&AgeVerificationMenu_TypeInfo, v5);
    ...
    sub_1BE4ACC(&StringLiteral_2062/*"AGE_VEIFICATION_CONFIRM_TITLE"*/, v10);
    sub_1BE4ACC(&StringLiteral_2061/*"AGE_VEIFICATION_CONFIRM_MESSAGE"*/, v11);
    sub_1BE4ACC(&StringLiteral_2059/*"AGE_VEIFICATION_CONFIRM_CANCEL"*/, v12);
    sub_1BE4ACC(&StringLiteral_2060/*"AGE_VEIFICATION_CONFIRM_DECIDE"*/, v13);
    byte_4B64697 = 1;
  }
  this->fields.state = 3;
  ...
  v26 = (CommonConfirmDialog_ClickDelegate_o *)sub_1BE4D18(CommonConfirmDialog_ClickDelegate_TypeInfo);
...
bool __fastcall AgeVerificationMenu__IsConcent(const MethodInfo *method)
{
  ...
  if ( (byte_4B6468C & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&ManagerConfig_TypeInfo, v3);
    sub_1BE4ACC(&NetworkManager_TypeInfo, v4);
    sub_1BE4ACC(&StringLiteral_1209/*"0"*/, v5);
    byte_4B6468C = 1;
  }
  ...
  if ( Int )
  {
    ...
    v17 = NetworkManager__getDateTime_39465728(v12, 0LL).fields._dateData;
...
void __fastcall AgeVerificationMenu__OnClickCancel(AgeVerificationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6469C & 1) == 0 )
  {
    sub_1BE4ACC(&Method_AgeVerificationMenu_OnClickCancel__, method);
    byte_4B6469C = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_AgeVerificationMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BE4AE4(Method_AgeVerificationMenu_OnClickCancel__);
...
void __fastcall AgeVerificationMenu__OnClickType1(AgeVerificationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B64699 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_AgeVerificationMenu_OnClickType1__, method);
    byte_4B64699 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_AgeVerificationMenu_OnClickType1__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BE4AE4(Method_AgeVerificationMenu_OnClickType1__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BE4AB0(v3, v3[4]);
...
void __fastcall AgeVerificationMenu__OnClickType2(AgeVerificationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6469A & 1) == 0 )
  {
    sub_1BE4ACC(&Method_AgeVerificationMenu_OnClickType2__, method);
    byte_4B6469A = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_AgeVerificationMenu_OnClickType2__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BE4AE4(Method_AgeVerificationMenu_OnClickType2__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BE4AB0(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
...
void __fastcall AgeVerificationMenu__OnClickType3(AgeVerificationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6469B & 1) == 0 )
  {
    sub_1BE4ACC(&Method_AgeVerificationMenu_OnClickType3__, method);
    byte_4B6469B = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_AgeVerificationMenu_OnClickType3__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BE4AE4(Method_AgeVerificationMenu_OnClickType3__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BE4AB0(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
...
void __fastcall AgeVerificationMenu__OnEndConfirm(AgeVerificationMenu_o *this, bool result, const MethodInfo *method)
{
  ...
  if ( (byte_4B64698 & 1) == 0 )
  {
    sub_1BE4ACC(&AgeVerificationMenu_TypeInfo, result);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BE4ACC(&System_Action_TypeInfo, callback);
    sub_1BE4ACC(&Method_AgeVerificationMenu_EndOpen__, v10);
    sub_1BE4ACC(&AgeVerificationMenu_TypeInfo, v11);
    sub_1BE4ACC(&LocalizationManager_TypeInfo, v12);
    sub_1BE4ACC(&StringLiteral_2065/*"AGE_VEIFICATION_TITLE"*/, v13);
    sub_1BE4ACC(&StringLiteral_2063/*"AGE_VEIFICATION_MESSAGE"*/, v14);
    byte_4B64695 = 1;
  }
  ...
  if ( state == 4 )
  {
    ...
    sub_1BE4A70((PartyOrganizationUtility_o *)p_callbackFunc, (int64_t)callback, (int64_t)method, v3, v4, v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6468A & 1) == 0 )
  {
    sub_1BE4ACC(&AgeVerificationMenu_CallbackFunc_TypeInfo, value);
    byte_4B6468A = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A248F0;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A248A8;
}
