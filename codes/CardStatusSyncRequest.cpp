        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C58822 & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_20980/*"isStorage"*/);
    sub_1C3E564(&StringLiteral_17834/*"changeUserSvtIds"*/);
    sub_1C3E564(&StringLiteral_20949/*"isLock"*/);
    sub_1C3E564(&StringLiteral_20927/*"isChoice"*/);
    sub_1C3E564(&StringLiteral_23124/*"revokeUserSvtIds"*/);
    byte_4C58822 = 1;
  }
  if ( changeUserSvtIds && changeUserSvtIds->max_length )
  {
    ...
    RequestBase__addField_44302832((RequestBase_o *)this, (System_String_o *)StringLiteral_17834/*"changeUserSvtIds"*/, v13, 0);
  }
  if ( revokeUserSvtIds && revokeUserSvtIds->max_length )
  {
    ...
    RequestBase__addField_44302832((RequestBase_o *)this, (System_String_o *)StringLiteral_23124/*"revokeUserSvtIds"*/, v14, 0);
  }
  if ( !isStorage )
  {
    if ( !isLock )
      goto LABEL_15;
LABEL_19:
    RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_20949/*"isLock"*/, 1, 0);
    if ( !isChoice )
      goto LABEL_17;
    goto LABEL_16;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_20980/*"isStorage"*/, 1, 0);
  if ( isLock )
    goto LABEL_19;
LABEL_15:
  if ( isChoice )
LABEL_16:
    RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_20927/*"isChoice"*/, 1, 0);
LABEL_17:
...
System_String_o *CardStatusSyncRequest__getURL(CardStatusSyncRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C3E564(&NetworkManager_TypeInfo);
    sub_1C3E564(&StringLiteral_17772/*"card/statusSync"*/);
    byte_4C58820 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63636468(BaseUrl, (System_String_o *)StringLiteral_17772/*"card/statusSync"*/, 0);
}
