        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2E366 & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_17910/*"changeUserSvtIds"*/);
    sub_1C94098(&StringLiteral_21113/*"isLock"*/);
    sub_1C94098(&StringLiteral_21088/*"isChoice"*/);
    sub_1C94098(&StringLiteral_23334/*"revokeUserSvtIds"*/);
    byte_4D2E366 = 1;
  }
  if ( changeUserSvtIds && changeUserSvtIds->max_length )
  {
    ...
    RequestBase__addField_45016480((RequestBase_o *)this, (System_String_o *)StringLiteral_17910/*"changeUserSvtIds"*/, v13, 0);
  }
  if ( revokeUserSvtIds && revokeUserSvtIds->max_length )
  {
    ...
    RequestBase__addField_45016480((RequestBase_o *)this, (System_String_o *)StringLiteral_23334/*"revokeUserSvtIds"*/, v14, 0);
  }
  if ( !isStorage )
  {
    if ( !isLock )
      goto LABEL_15;
LABEL_19:
    RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21113/*"isLock"*/, 1, 0);
    if ( !isChoice )
      goto LABEL_17;
    goto LABEL_16;
  }
...
LABEL_15:
  if ( isChoice )
LABEL_16:
    RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21088/*"isChoice"*/, 1, 0);
LABEL_17:
...
System_String_o *CardStatusSyncRequest__getURL(CardStatusSyncRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C94098(&NetworkManager_TypeInfo);
    sub_1C94098(&StringLiteral_17848/*"card/statusSync"*/);
    byte_4D2E364 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64417744(BaseUrl, (System_String_o *)StringLiteral_17848/*"card/statusSync"*/, 0);
}
