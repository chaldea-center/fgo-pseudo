        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E79152 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_18093/*"changeUserSvtIds"*/);
    sub_1D0F0B4(&StringLiteral_21330/*"isLock"*/);
    sub_1D0F0B4(&StringLiteral_21303/*"isChoice"*/);
    sub_1D0F0B4(&StringLiteral_23577/*"revokeUserSvtIds"*/);
    byte_4E79152 = 1;
  }
  if ( changeUserSvtIds && changeUserSvtIds->max_length )
  {
    ...
    RequestBase__addField_45601604((RequestBase_o *)this, (System_String_o *)StringLiteral_18093/*"changeUserSvtIds"*/, v13, 0);
  }
  if ( revokeUserSvtIds && revokeUserSvtIds->max_length )
  {
    ...
    RequestBase__addField_45601604((RequestBase_o *)this, (System_String_o *)StringLiteral_23577/*"revokeUserSvtIds"*/, v14, 0);
  }
  if ( !isStorage )
  {
    if ( !isLock )
      goto LABEL_15;
LABEL_19:
    RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21330/*"isLock"*/, 1, 0);
    if ( !isChoice )
      goto LABEL_17;
    goto LABEL_16;
  }
...
LABEL_15:
  if ( isChoice )
LABEL_16:
    RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21303/*"isChoice"*/, 1, 0);
LABEL_17:
...
System_String_o *CardStatusSyncRequest__getURL(CardStatusSyncRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1D0F0B4(&NetworkManager_TypeInfo);
    sub_1D0F0B4(&StringLiteral_18030/*"card/statusSync"*/);
    byte_4E79150 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_65562772(BaseUrl, (System_String_o *)StringLiteral_18030/*"card/statusSync"*/, 0);
}
