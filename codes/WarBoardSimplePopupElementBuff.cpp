        ...
        const MethodInfo *method)
{
  ...
  if ( WarBoardSimplePopupElementBuff__IsSerializeFieldNotNull(this, (const MethodInfo *)itemData) )
  {
    ...
    ItemIconParts = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3ABA574 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    if ( !ItemIconParts
      || !itemIcon
...
void WarBoardSimplePopupElementBuff__SetUp_38954248(
        WarBoardSimplePopupElementBuff_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( WarBoardSimplePopupElementBuff__IsSerializeFieldNotNull(this, (const MethodInfo *)wallData) )
  {
    ...
    if ( wallData )
    {
      ...
      ItemIconParts = (char *)sub_1C94140(
      ...
      if ( (int)breakPointMax_k__BackingField >= 1 )
      {
        ...
        do
        {
          ...
          if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
          ItemIconParts = (char *)UnityEngine_Object__Instantiate_object__52598436(
                                    breakPointPrefab,
                                    transform,
          ...
          if ( !v9 )
            break;
          v22 = sub_1C941D4(Component_object, *(_QWORD *)(*(_QWORD *)v9 + 64LL));
          if ( !v22 )
          {
            v38 = sub_1C94314();
            sub_1C941C0(v38, 0);
...
LABEL_27:
      ...
      ItemIconParts = (char *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3ABA574 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
...
void WarBoardSimplePopupElementBuff__SetUp_38955180(
        WarBoardSimplePopupElementBuff_o *this,
                          ...
                          if ( effectIconBase )
                          {
                            ...
                            if ( v14 )
                            {
                              ...
                              if ( v14->fields._imageId_k__BackingField < 1 )
                              {
                                if ( v15 )
                                {
                                  v17 = (System_String_o *)StringLiteral_23860/*"squares"*/;
                                  goto LABEL_23;
                                }
                              }
                              else
                              {
                                ...
                                ItemIconParts = System_String__Format((System_String_o *)StringLiteral_23862/*"square{0:D3}"*/, v16, 0);
                                if ( v15 )
                                {
