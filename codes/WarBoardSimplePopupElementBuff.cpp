        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A06BCA & 1) == 0 )
  {
    sub_1B686D4(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__, itemData);
    byte_4A06BCA = 1;
  }
  if ( WarBoardSimplePopupElementBuff__IsSerializeFieldNotNull(this, (const MethodInfo *)itemData) )
  {
    ...
    ItemIconParts = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36F769C *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    if ( !ItemIconParts
      || !itemIcon
...
void __fastcall WarBoardSimplePopupElementBuff__SetUp_35477748(
        WarBoardSimplePopupElementBuff_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A06BCB & 1) == 0 )
  {
    sub_1B686D4(&Method_UnityEngine_GameObject_GetComponent_WarBoardBreakPointComponent___, wallData);
    ...
    sub_1B686D4(&WarBoardBreakPointComponent___TypeInfo, v9);
  ...
  if ( WarBoardSimplePopupElementBuff__IsSerializeFieldNotNull(this, (const MethodInfo *)wallData) )
  {
    ...
    if ( wallData )
    {
      ...
      ItemIconParts = (char *)sub_1B6877C(
      ...
      if ( (int)breakPointMax_k__BackingField >= 1 )
      {
        ...
        do
        {
          ...
          if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
          ItemIconParts = (char *)UnityEngine_Object__Instantiate_object__49072196(
                                    breakPointPrefab,
                                    transform,
          ...
          if ( !v15 )
            break;
          v28 = sub_1B68810(Component_object, *(_QWORD *)(*(_QWORD *)v15 + 64LL));
          if ( !v28 )
          {
            v43 = sub_1B68954(0LL);
            sub_1B687FC(v43, 0LL);
          ...
          if ( v17 >= v15[6]
            || (*(_QWORD *)&v19[8 * v17] = Component_object,
                sub_1B68678((ServantStatusBattleListViewItem_o *)&v19[v16], (int32_t)Component_object, v29, v30),
                v17 >= v15[6]) )
          {
            sub_1B68938(v28, v11);
          }
...
LABEL_27:
      ...
      ItemIconParts = (char *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36F769C *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
...
void __fastcall WarBoardSimplePopupElementBuff__SetUp_35478680(
        WarBoardSimplePopupElementBuff_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A06BCC & 1) == 0 )
  {
    sub_1B686D4(&int_TypeInfo, effectData);
    sub_1B686D4(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__, v5);
    sub_1B686D4(&StringLiteral_23380/*"square{0:D3}"*/, v6);
    sub_1B686D4(&StringLiteral_23378/*"squares"*/, v7);
    byte_4A06BCC = 1;
  }
                          ...
                          if ( effectIconBase )
                          {
                            ...
                            if ( v17 )
                            {
                              ...
                              if ( v17->fields._imageId_k__BackingField < 1 )
                              {
                                if ( v21 )
                                {
                                  v23 = (System_String_o *)StringLiteral_23378/*"squares"*/;
                                  goto LABEL_23;
                                }
                              }
                              else
                              {
                                ...
                                v22 = (Il2CppObject *)j_il2cpp_value_box_0(
                                                        ...
                                                        v19,
                                                        v20);
                                ItemIconParts = System_String__Format((System_String_o *)StringLiteral_23380/*"square{0:D3}"*/, v22, 0LL);
                                if ( v21 )
                                {
