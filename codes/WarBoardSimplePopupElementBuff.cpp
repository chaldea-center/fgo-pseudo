        ...
        const MethodInfo *method)
{
  ...
  if ( WarBoardSimplePopupElementBuff__IsSerializeFieldNotNull(this, (const MethodInfo *)itemData) )
  {
    ...
    ItemIconParts = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_388D058 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    if ( !ItemIconParts
      || !itemIcon
...
void __fastcall WarBoardSimplePopupElementBuff__SetUp_36902828(
        WarBoardSimplePopupElementBuff_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( WarBoardSimplePopupElementBuff__IsSerializeFieldNotNull(this, (const MethodInfo *)wallData) )
  {
    ...
    if ( wallData )
    {
      ...
      ItemIconParts = (char *)sub_1C21EE0(
      ...
      if ( (int)breakPointMax_k__BackingField >= 1 )
      {
        ...
        do
        {
          ...
          if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
          ItemIconParts = (char *)UnityEngine_Object__Instantiate_object__50551272(
                                    breakPointPrefab,
                                    transform,
          ...
          v43.fields.z = 0.0;
          v43.fields.x = v14;
          UnityEngine_Transform__set_localPosition((UnityEngine_Transform_o *)ItemIconParts, v43, 0LL);
          ...
          if ( !v9 )
            break;
          v22 = sub_1C21F74(Component_object, *(_QWORD *)(*(_QWORD *)v9 + 64LL));
          if ( !v22 )
          {
            v41 = sub_1C220B8();
            sub_1C21F60(v41, 0LL);
          ...
          if ( v11 >= v9[6]
            || (*(_QWORD *)&v13[8 * v11] = Component_object,
                sub_1C21DDC(
                  (PartyOrganizationUtility_o *)&v13[v10],
...
LABEL_27:
      ...
      ItemIconParts = (char *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_388D058 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
      ...
      ItemIconParts = (char *)System_String__Format(WALL_ICON_NAME, v40, 0LL);
      if ( !v34 )
        goto LABEL_26;
      UISprite__set_spriteName(v34, (System_String_o *)ItemIconParts, 0LL);
    }
  }
}


void __fastcall WarBoardSimplePopupElementBuff__SetUp_36903760(
        WarBoardSimplePopupElementBuff_o *this,
                          ...
                          if ( effectIconBase )
                          {
                            ...
                            if ( v14 )
                            {
                              ...
                              if ( v14->fields._imageId_k__BackingField < 1 )
                              {
                                if ( v18 )
                                {
                                  v20 = (System_String_o *)StringLiteral_23887/*"squares"*/;
                                  goto LABEL_23;
                                }
                              }
                              else
                              {
                                ...
                                v19 = (Il2CppObject *)j_il2cpp_value_box_0(
                                                        ...
                                                        v16,
                                                        v17);
                                ItemIconParts = System_String__Format((System_String_o *)StringLiteral_23889/*"square{0:D3}"*/, v19, 0LL);
                                if ( v18 )
                                {
