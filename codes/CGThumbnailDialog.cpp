...
void __fastcall CGThumbnailDialog__CloseFullScreen(CGThumbnailDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A495A2 & 1) == 0 )
  {
    sub_1B863B8(&Method_CGThumbnailDialog_OpenFullScreen__, method);
    sub_1B863B8(&CGThumbnailListViewManager_CallbackFunc_TypeInfo, v3);
    byte_4A495A2 = 1;
  }
  cgThumbnailListViewManager = this->fields.cgThumbnailListViewManager;
  v5 = (CGThumbnailListViewManager_CallbackFunc_o *)sub_1B86604(CGThumbnailListViewManager_CallbackFunc_TypeInfo);
  ...
  if ( !cgThumbnailListViewManager
    || (cgThumbnailListViewManager->fields.callbackFunc = v5,
        sub_1B8635C(&cgThumbnailListViewManager->fields.callbackFunc),
    ...
    || (galleryFullScreenPanel = (CGThumbnailListViewManager_o *)UnityEngine_Component__get_gameObject(
                                                                   ...
                                                                   0LL)) == 0LL )
  {
    sub_1B86614(galleryFullScreenPanel, v8);
  }
...
void __fastcall CGThumbnailDialog__DestryGalleryFullScreenPanel(CGThumbnailDialog_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(v4, 0LL, 0LL) )
  {
    ...
    *p_galleryFullScreenPanel = 0LL;
    sub_1B8635C(p_galleryFullScreenPanel);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A495A1 & 1) == 0 )
  {
    sub_1B863B8(&System_Action_int__TypeInfo, *(_QWORD *)&index);
    sub_1B863B8(&System_Action_TypeInfo, v5);
    sub_1B863B8(&Method_CGThumbnailDialog_CloseFullScreen__, v6);
    sub_1B863B8(&Method_CGThumbnailDialog__FullScreenPanelSetup_b__23_0__, v7);
    sub_1B863B8(&Method_CGThumbnailListViewManager_JumpItemForID__, v8);
...
LABEL_8:
    sub_1B86614(cgThumbnailListViewManager, *(_QWORD *)&index);
...
void __fastcall CGThumbnailDialog__OnClickBackToGalleryTop(CGThumbnailDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A495A4 & 1) == 0 )
  {
    sub_1B863B8(&Method_CGThumbnailDialog_OnClickBackToGalleryTop__, method);
    byte_4A495A4 = 1;
  }
  if ( this->fields.baseState == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CGThumbnailDialog_OnClickBackToGalleryTop__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B863D0(Method_CGThumbnailDialog_OnClickBackToGalleryTop__);
...
void __fastcall CGThumbnailDialog__OnClickClose(CGThumbnailDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A495A5 & 1) == 0 )
  {
    sub_1B863B8(&Method_CGThumbnailDialog_OnClickClose__, method);
    byte_4A495A5 = 1;
  }
  if ( this->fields.baseState == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CGThumbnailDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B863D0(Method_CGThumbnailDialog_OnClickClose__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B8639C(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0, 0LL);
    cgThumbnailListViewManager = this->fields.cgThumbnailListViewManager;
    if ( !cgThumbnailListViewManager
...
void __fastcall CGThumbnailDialog__OnClickIsCG(CGThumbnailDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4959E & 1) == 0 )
  {
    sub_1B863B8(&Method_CGThumbnailDialog_OnClickIsCG__, method);
    byte_4A4959E = 1;
  }
  if ( this->fields.baseState == 2 )
  {
    ...
    {
      sub_1B86614(cgFilterCheckBoxSprite, method);
    }
    ...
    if ( (*((_BYTE *)Method_CGThumbnailDialog_OnClickIsCG__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B863D0(Method_CGThumbnailDialog_OnClickIsCG__);
...
void __fastcall CGThumbnailDialog__OnClickIsMovie(CGThumbnailDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4959F & 1) == 0 )
  {
    sub_1B863B8(&Method_CGThumbnailDialog_OnClickIsMovie__, method);
    byte_4A4959F = 1;
  }
  if ( this->fields.baseState == 2 )
  {
    ...
    {
      sub_1B86614(movieFilterCheckBoxSprite, method);
    }
    CGThumbnailListViewManager__SetFilter(
    ...
    if ( (*((_BYTE *)Method_CGThumbnailDialog_OnClickIsMovie__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B863D0(Method_CGThumbnailDialog_OnClickIsMovie__);
    v6 = (System_Reflection_MethodBase_o *)sub_1B8639C(v5, v5[4]);
    OverwriteAssetSoundName__PlaySystemSe(v6, 0, 0, 0LL);
  }
}
...
void __fastcall CGThumbnailDialog__OnClickScaleChange(CGThumbnailDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A495A3 & 1) == 0 )
  {
    sub_1B863B8(&Method_CGThumbnailDialog_OnClickScaleChange__, method);
    byte_4A495A3 = 1;
  }
  if ( this->fields.baseState == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CGThumbnailDialog_OnClickScaleChange__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B863D0(Method_CGThumbnailDialog_OnClickScaleChange__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B8639C(v3, v3[4]);
    ...
    {
      sub_1B86614(cgThumbnailListViewManager, v5);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4959D & 1) == 0 )
  {
    sub_1B863B8(&System_Action_TypeInfo, galleryEntities);
    sub_1B863B8(&Method_CGThumbnailDialog_OpenFullScreen__, v13);
    sub_1B863B8(&Method_CGThumbnailDialog__Open_b__19_0__, v14);
    sub_1B863B8(&CGThumbnailListViewManager_CallbackFunc_TypeInfo, v15);
    sub_1B863B8(&int_TypeInfo, v16);
    sub_1B863B8(&LocalizationManager_TypeInfo, v17);
    sub_1B863B8(&StringLiteral_6840/*"GALLERY_CHECKBOX_CG"*/, v18);
    sub_1B863B8(&StringLiteral_7856/*"IsGalleryCGFilter"*/, v19);
    sub_1B863B8(&StringLiteral_20358/*"img_txt_gallery_{0}"*/, v20);
    sub_1B863B8(&StringLiteral_6841/*"GALLERY_CHECKBOX_MOVIE"*/, v21);
    sub_1B863B8(&StringLiteral_7857/*"IsGalleryMovieFilter"*/, v22);
    sub_1B863B8(&StringLiteral_6843/*"GALLERY_EXPLANATION"*/, v23);
    byte_4A4959D = 1;
  }
  ...
  this->fields.isCG = UnityEngine_PlayerPrefs__GetInt((System_String_o *)StringLiteral_7856/*"IsGalleryCGFilter"*/, 0, 0LL) == 1;
  titleInfoControl = (TitleInfoControl_o *)UnityEngine_PlayerPrefs__GetInt(
                                             (System_String_o *)StringLiteral_7857/*"IsGalleryMovieFilter"*/,
                                             0,
                                             0LL);
  cgFilterCheckBoxSprite = (UnityEngine_Component_o *)this->fields.cgFilterCheckBoxSprite;
  ...
  v31 = (CGThumbnailListViewManager_CallbackFunc_o *)sub_1B86604(CGThumbnailListViewManager_CallbackFunc_TypeInfo);
  CGThumbnailListViewManager_CallbackFunc___ctor(
    v31,
    (Il2CppObject *)this,
    Method_CGThumbnailDialog_OpenFullScreen__,
  ...
  titleInfoControl = (TitleInfoControl_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6843/*"GALLERY_EXPLANATION"*/, 0LL);
  ...
  titleInfoControl = (TitleInfoControl_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6840/*"GALLERY_CHECKBOX_CG"*/, 0LL);
  ...
  titleInfoControl = (TitleInfoControl_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6841/*"GALLERY_CHECKBOX_MOVIE"*/, 0LL);
  ...
  sub_1B8635C(&this->fields.backToGalleryTop);
  this->fields.closeAction = close;
  sub_1B8635C(&this->fields.closeAction);
  warTitleSprite = this->fields.warTitleSprite;
  v44 = warId;
  v42 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v44, v39, v40, v41);
  titleInfoControl = (TitleInfoControl_o *)System_String__Format((System_String_o *)StringLiteral_20358/*"img_txt_gallery_{0}"*/, v42, 0LL);
  if ( !warTitleSprite
  ...
  {
LABEL_23:
    sub_1B86614(titleInfoControl, galleryEntities);
  }
...
void __fastcall CGThumbnailDialog__OpenFullScreen(CGThumbnailDialog_o *this, int32_t index, const MethodInfo *method)
{
  ...
  if ( (byte_4A495A0 & 1) == 0 )
  {
    sub_1B863B8(&AssetManager_TypeInfo, *(_QWORD *)&index);
    sub_1B863B8(&AssetLoader_LoadEndDataHandler_TypeInfo, v5);
    sub_1B863B8(&UnityEngine_Object_TypeInfo, v6);
    sub_1B863B8(&Method_CGThumbnailDialog___c__DisplayClass22_0__OpenFullScreen_b__0__, v7);
    sub_1B863B8(&CGThumbnailDialog___c__DisplayClass22_0_TypeInfo, v8);
    sub_1B863B8(&StringLiteral_9071/*"MyRoom/Gallery/Prefab"*/, v9);
    byte_4A495A0 = 1;
  }
  v10 = sub_1B86604(CGThumbnailDialog___c__DisplayClass22_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v10, 0LL);
  if ( !v10
    || (*(_QWORD *)(v10 + 16) = this,
        v11 = sub_1B8635C(v10 + 16),
        *(_DWORD *)(v10 + 24) = index,
        (cgThumbnailListViewManager = this->fields.cgThumbnailListViewManager) == 0LL) )
  {
    sub_1B86614(v11, v12);
  ...
  if ( UnityEngine_Object__op_Equality(galleryFullScreenPanel, 0LL, 0LL) )
  {
    ...
    AssetManager__loadAssetStorage((System_String_o *)StringLiteral_9071/*"MyRoom/Gallery/Prefab"*/, v17, 1, 0LL);
  }
  else
  {
...
void __fastcall CGThumbnailDialog__SaveFilter(CGThumbnailDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A495A6 & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_7856/*"IsGalleryCGFilter"*/, method);
    sub_1B863B8(&StringLiteral_7857/*"IsGalleryMovieFilter"*/, v3);
    byte_4A495A6 = 1;
  }
  UnityEngine_PlayerPrefs__SetInt((System_String_o *)StringLiteral_7856/*"IsGalleryCGFilter"*/, this->fields.isCG, 0LL);
  UnityEngine_PlayerPrefs__SetInt((System_String_o *)StringLiteral_7857/*"IsGalleryMovieFilter"*/, this->fields.isMovie, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_10:
    sub_1B86614(cgFullScreenBgSprite, isShow);
  }
  LODWORD(v6) = 0;
  if ( isShow )
    *(float *)&v6 = 1.0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A495A9 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_UnityEngine_GameObject_GetComponent_GalleryFullScreenPanel___, v5);
    sub_1B863B8(&Method_UnityEngine_Object_Instantiate_GameObject____76169360, v6);
    sub_1B863B8(&UnityEngine_Object_TypeInfo, v7);
    this = (CGThumbnailDialog___c__DisplayClass22_0_o *)sub_1B863B8(&StringLiteral_6922/*"GalleryFullScreenListViewPanel"*/, v8);
    byte_4A495A9 = 1;
  }
  if ( !assetData )
    goto LABEL_11;
  _4__this = v4->fields.__4__this;
  this = (CGThumbnailDialog___c__DisplayClass22_0_o *)AssetData__GetObject_object__49610244(
                                                        assetData,
                                                        (System_String_o *)StringLiteral_6922/*"GalleryFullScreenListViewPanel"*/,
  ...
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  this = (CGThumbnailDialog___c__DisplayClass22_0_o *)UnityEngine_Object__Instantiate_object__50290416(
                                                        v10,
                                                        transform,
  ...
  if ( !this
    || (this = (CGThumbnailDialog___c__DisplayClass22_0_o *)UnityEngine_GameObject__GetComponent_object_(
                                                              ...
                                                              (const MethodInfo_2FC0DF0 *)Method_UnityEngine_GameObject_GetComponent_GalleryFullScreenPanel___),
        !_4__this)
    || (_4__this->fields.galleryFullScreenPanel = (struct GalleryFullScreenPanel_o *)this,
        sub_1B8635C(&_4__this->fields.galleryFullScreenPanel),
