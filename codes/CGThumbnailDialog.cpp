...
void CGThumbnailDialog__CloseFullScreen(CGThumbnailDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2229A & 1) == 0 )
  {
    sub_1C2D490(&Method_CGThumbnailDialog_OpenFullScreen__);
    sub_1C2D490(&CGThumbnailListViewManager_CallbackFunc_TypeInfo);
    byte_4C2229A = 1;
  }
  cgThumbnailListViewManager = this->fields.cgThumbnailListViewManager;
  v4 = (CGThumbnailListViewManager_CallbackFunc_o *)sub_1C2D6DC(CGThumbnailListViewManager_CallbackFunc_TypeInfo);
  ...
  if ( !cgThumbnailListViewManager
    || (cgThumbnailListViewManager->fields.callbackFunc = v4,
        sub_1C2D434(&cgThumbnailListViewManager->fields.callbackFunc),
    ...
    || (galleryFullScreenPanel = (CGThumbnailListViewManager_o *)UnityEngine_Component__get_gameObject(
                                                                   ...
                                                                   0)) == 0 )
  {
    sub_1C2D6EC(galleryFullScreenPanel, v7);
  }
...
void CGThumbnailDialog__DestryGalleryFullScreenPanel(CGThumbnailDialog_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(v4, 0, 0) )
  {
    ...
    *p_galleryFullScreenPanel = 0;
    sub_1C2D434(p_galleryFullScreenPanel);
  }
}
...
void CGThumbnailDialog__FullScreenPanelSetup(CGThumbnailDialog_o *this, int32_t index, const MethodInfo *method)
{
  ...
  if ( (byte_4C22299 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_CGThumbnailDialog_CloseFullScreen__);
    sub_1C2D490(&Method_CGThumbnailDialog__FullScreenPanelSetup_b__23_0__);
    sub_1C2D490(&Method_CGThumbnailListViewManager_JumpItemForID__);
...
LABEL_8:
    sub_1C2D6EC(cgThumbnailListViewManager, *(_QWORD *)&index);
...
void CGThumbnailDialog__OnClickBackToGalleryTop(CGThumbnailDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2229C & 1) == 0 )
  {
    sub_1C2D490(&Method_CGThumbnailDialog_OnClickBackToGalleryTop__);
    byte_4C2229C = 1;
  }
  if ( this->fields.baseState == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CGThumbnailDialog_OnClickBackToGalleryTop__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2D4A8(Method_CGThumbnailDialog_OnClickBackToGalleryTop__);
...
void CGThumbnailDialog__OnClickClose(CGThumbnailDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2229D & 1) == 0 )
  {
    sub_1C2D490(&Method_CGThumbnailDialog_OnClickClose__);
    byte_4C2229D = 1;
  }
  if ( this->fields.baseState == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CGThumbnailDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2D4A8(Method_CGThumbnailDialog_OnClickClose__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C2D474(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0, 0);
    cgThumbnailListViewManager = this->fields.cgThumbnailListViewManager;
    if ( !cgThumbnailListViewManager
...
void CGThumbnailDialog__OnClickIsCG(CGThumbnailDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C22296 & 1) == 0 )
  {
    sub_1C2D490(&Method_CGThumbnailDialog_OnClickIsCG__);
    byte_4C22296 = 1;
  }
  if ( this->fields.baseState == 2 )
  {
    ...
    {
      sub_1C2D6EC(cgFilterCheckBoxSprite, method);
    }
    ...
    if ( (*((_BYTE *)Method_CGThumbnailDialog_OnClickIsCG__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1C2D4A8(Method_CGThumbnailDialog_OnClickIsCG__);
...
void CGThumbnailDialog__OnClickIsMovie(CGThumbnailDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C22297 & 1) == 0 )
  {
    sub_1C2D490(&Method_CGThumbnailDialog_OnClickIsMovie__);
    byte_4C22297 = 1;
  }
  if ( this->fields.baseState == 2 )
  {
    ...
    {
      sub_1C2D6EC(movieFilterCheckBoxSprite, method);
    }
    CGThumbnailListViewManager__SetFilter(
    ...
    if ( (*((_BYTE *)Method_CGThumbnailDialog_OnClickIsMovie__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1C2D4A8(Method_CGThumbnailDialog_OnClickIsMovie__);
    v6 = (System_Reflection_MethodBase_o *)sub_1C2D474(v5, v5[4]);
    OverwriteAssetSoundName__PlaySystemSe(v6, 0, 0, 0);
  }
}
...
void CGThumbnailDialog__OnClickScaleChange(CGThumbnailDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2229B & 1) == 0 )
  {
    sub_1C2D490(&Method_CGThumbnailDialog_OnClickScaleChange__);
    byte_4C2229B = 1;
  }
  if ( this->fields.baseState == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CGThumbnailDialog_OnClickScaleChange__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2D4A8(Method_CGThumbnailDialog_OnClickScaleChange__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C2D474(v3, v3[4]);
    ...
    {
      sub_1C2D6EC(cgThumbnailListViewManager, v5);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C22295 & 1) == 0 )
  {
    sub_1C2D490(&System_Action_TypeInfo);
    sub_1C2D490(&Method_CGThumbnailDialog_OpenFullScreen__);
    sub_1C2D490(&Method_CGThumbnailDialog__Open_b__19_0__);
    sub_1C2D490(&CGThumbnailListViewManager_CallbackFunc_TypeInfo);
    sub_1C2D490(&int_TypeInfo);
    sub_1C2D490(&LocalizationManager_TypeInfo);
    sub_1C2D490(&StringLiteral_6909/*"GALLERY_CHECKBOX_CG"*/);
    sub_1C2D490(&StringLiteral_7998/*"IsGalleryCGFilter"*/);
    sub_1C2D490(&StringLiteral_20652/*"img_txt_gallery_{0}"*/);
    sub_1C2D490(&StringLiteral_6910/*"GALLERY_CHECKBOX_MOVIE"*/);
    sub_1C2D490(&StringLiteral_7999/*"IsGalleryMovieFilter"*/);
    sub_1C2D490(&StringLiteral_6912/*"GALLERY_EXPLANATION"*/);
    byte_4C22295 = 1;
  }
  ...
  this->fields.isCG = UnityEngine_PlayerPrefs__GetInt((System_String_o *)StringLiteral_7998/*"IsGalleryCGFilter"*/, 0, 0) == 1;
  titleInfoControl = (TitleInfoControl_o *)UnityEngine_PlayerPrefs__GetInt((System_String_o *)StringLiteral_7999/*"IsGalleryMovieFilter"*/, 0, 0);
  cgFilterCheckBoxSprite = (UnityEngine_Component_o *)this->fields.cgFilterCheckBoxSprite;
  ...
  v20 = (CGThumbnailListViewManager_CallbackFunc_o *)sub_1C2D6DC(CGThumbnailListViewManager_CallbackFunc_TypeInfo);
  CGThumbnailListViewManager_CallbackFunc___ctor(
    v20,
    (Il2CppObject *)this,
    Method_CGThumbnailDialog_OpenFullScreen__,
  ...
  titleInfoControl = (TitleInfoControl_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6912/*"GALLERY_EXPLANATION"*/, 0);
  ...
  titleInfoControl = (TitleInfoControl_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6909/*"GALLERY_CHECKBOX_CG"*/, 0);
  ...
  titleInfoControl = (TitleInfoControl_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6910/*"GALLERY_CHECKBOX_MOVIE"*/, 0);
  ...
  sub_1C2D434(&this->fields.backToGalleryTop);
  this->fields.closeAction = close;
  sub_1C2D434(&this->fields.closeAction);
  warTitleSprite = this->fields.warTitleSprite;
  v33 = warId;
  v31 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v33, v28, v29, v30);
  titleInfoControl = (TitleInfoControl_o *)System_String__Format((System_String_o *)StringLiteral_20652/*"img_txt_gallery_{0}"*/, v31, 0);
  if ( !warTitleSprite
  ...
  {
LABEL_23:
    sub_1C2D6EC(titleInfoControl, galleryEntities);
  }
  ...
  System_Action___ctor(v32, (Il2CppObject *)this, Method_CGThumbnailDialog__Open_b__19_0__, 0);
  BaseDialog__SafeOpen((BaseDialog_o *)this, v32, 0, 0);
...
void CGThumbnailDialog__OpenFullScreen(CGThumbnailDialog_o *this, int32_t index, const MethodInfo *method)
{
  ...
  if ( (byte_4C22298 & 1) == 0 )
  {
    ...
    sub_1C2D490(&UnityEngine_Object_TypeInfo);
    sub_1C2D490(&Method_CGThumbnailDialog___c__DisplayClass22_0__OpenFullScreen_b__0__);
    sub_1C2D490(&CGThumbnailDialog___c__DisplayClass22_0_TypeInfo);
    sub_1C2D490(&StringLiteral_9212/*"MyRoom/Gallery/Prefab"*/);
    byte_4C22298 = 1;
  }
  v5 = sub_1C2D6DC(CGThumbnailDialog___c__DisplayClass22_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v5, 0);
  if ( !v5
    || (*(_QWORD *)(v5 + 16) = this,
        v6 = sub_1C2D434(v5 + 16),
        *(_DWORD *)(v5 + 24) = index,
        (cgThumbnailListViewManager = this->fields.cgThumbnailListViewManager) == 0) )
  {
    sub_1C2D6EC(v6, v7);
  ...
  if ( UnityEngine_Object__op_Equality(galleryFullScreenPanel, 0, 0) )
  {
    ...
    AssetManager__loadAssetStorage((System_String_o *)StringLiteral_9212/*"MyRoom/Gallery/Prefab"*/, v12, 1, 0);
  }
  else
  {
...
void CGThumbnailDialog__SaveFilter(CGThumbnailDialog_o *this, const MethodInfo *method)
{
  ...
  UnityEngine_PlayerPrefs__SetInt((System_String_o *)StringLiteral_7998/*"IsGalleryCGFilter"*/, this->fields.isCG, 0);
  UnityEngine_PlayerPrefs__SetInt((System_String_o *)StringLiteral_7999/*"IsGalleryMovieFilter"*/, this->fields.isMovie, 0);
...
void CGThumbnailDialog__ShowCGThumbnailObjects(CGThumbnailDialog_o *this, bool isShow, const MethodInfo *method)
{
  ...
  {
LABEL_10:
    sub_1C2D6EC(cgFullScreenBgSprite, isShow);
  }
  LODWORD(v6) = 0;
  if ( isShow )
    *(float *)&v6 = 1.0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C222A1 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_UnityEngine_GameObject_GetComponent_GalleryFullScreenPanel___);
    sub_1C2D490(&Method_UnityEngine_Object_Instantiate_GameObject____78081576);
    sub_1C2D490(&UnityEngine_Object_TypeInfo);
    this = (CGThumbnailDialog___c__DisplayClass22_0_o *)sub_1C2D490(&StringLiteral_7026/*"GalleryFullScreenListViewPanel"*/);
    byte_4C222A1 = 1;
  }
  if ( !assetData )
    goto LABEL_11;
  _4__this = v4->fields.__4__this;
  this = (CGThumbnailDialog___c__DisplayClass22_0_o *)AssetData__GetObject_object__51051712(
                                                        assetData,
                                                        (System_String_o *)StringLiteral_7026/*"GalleryFullScreenListViewPanel"*/,
  ...
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  this = (CGThumbnailDialog___c__DisplayClass22_0_o *)UnityEngine_Object__Instantiate_object__51752420(
                                                        v6,
                                                        transform,
  ...
  if ( !this
    || (this = (CGThumbnailDialog___c__DisplayClass22_0_o *)UnityEngine_GameObject__GetComponent_object_(
                                                              ...
                                                              (const MethodInfo_3125ED0 *)Method_UnityEngine_GameObject_GetComponent_GalleryFullScreenPanel___),
        !_4__this)
    || (_4__this->fields.galleryFullScreenPanel = (struct GalleryFullScreenPanel_o *)this,
        sub_1C2D434(&_4__this->fields.galleryFullScreenPanel),
