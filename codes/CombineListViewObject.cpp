...
void __fastcall CombineListViewObject__Awake(CombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B05C71 & 1) == 0 )
  {
    sub_1BC3008(&Method_UnityEngine_GameObject_GetComponent_CombineListViewItemDraw___, method);
    byte_4B05C71 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_3055998 *)Method_UnityEngine_GameObject_GetComponent_CombineListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05C74 & 1) == 0 )
  {
    sub_1BC3008(&Method_UnityEngine_GameObject_GetComponent_CombineListViewObject___, method);
    byte_4B05C74 = 1;
  }
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_3055998 *)Method_UnityEngine_GameObject_GetComponent_CombineListViewObject___)) == 0LL) )
  {
    sub_1BC3264(DragObject, v4);
  }
  CombineListViewObject__Init_47155036((CombineListViewObject_o *)DragObject, 2, v6);
  return v5;
}
        ...
        const MethodInfo *method)
{
  ...
  CombineListViewObject__Init_47155036((CombineListViewObject_o *)dragObject, 2, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( !dragObject
    || (dragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                   dragObject,
                                                   (const MethodInfo_3055998 *)Method_UnityEngine_GameObject_GetComponent_CombineListViewObject___)) == 0LL
    || (CombineListViewObject__Init_47155036((CombineListViewObject_o *)dragObject, 2, v12),
...
void __fastcall CombineListViewObject__EventRetryMove(CombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B05C7E & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_6190/*"EventRetryMove2"*/, method);
    byte_4B05C7E = 1;
  }
  dragObject = this->fields.dragObject;
  if ( !dragObject )
...
LABEL_9:
  ...
  v11[3].monitor = gameObject;
  sub_1BC2FAC((CGThumbnailListItem_o *)&v11[3].monitor, (int32_t)gameObject, v13, v14);
  v15 = StringLiteral_6190/*"EventRetryMove2"*/;
  *(_QWORD *)&v11[3].fields.m_CachedPtr = StringLiteral_6190/*"EventRetryMove2"*/;
  sub_1BC2FAC((CGThumbnailListItem_o *)&v11[3].fields, v15, v16, v17);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05C73 & 1) == 0 )
  {
    sub_1BC3008(&CombineListViewItem_TypeInfo, method);
    byte_4B05C73 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05C75 & 1) == 0 )
  {
    sub_1BC3008(&CombineListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4B05C75 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineListViewObject__Init_47155036(
        CombineListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineListViewObject__Init_47157180(
        CombineListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineListViewObject__Init_47157280(
        CombineListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall CombineListViewObject__SetItem_47155428(
        CombineListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall CombineListViewObject__Start(CombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    CombineListViewObject__Init_47155036(this, 2, v2);
}
...
System_String_o *__fastcall CombineListViewObject__ToString(CombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B05C80 & 1) == 0 )
  {
    sub_1BC3008(&CombineListViewItemDraw_DispMode_TypeInfo, method);
