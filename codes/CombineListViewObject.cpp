...
void __fastcall CombineListViewObject__Awake(CombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDFDF6 & 1) == 0 )
  {
    sub_1C21E38(&Method_UnityEngine_GameObject_GetComponent_CombineListViewItemDraw___);
    byte_4BDFDF6 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_3000534 *)Method_UnityEngine_GameObject_GetComponent_CombineListViewItemDraw___);
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_3000534 *)Method_UnityEngine_GameObject_GetComponent_CombineListViewObject___)) == 0LL) )
  {
    sub_1C22094(DragObject, v4);
  }
  CombineListViewObject__Init_46158436((CombineListViewObject_o *)DragObject, 2, v6);
  return v5;
}
        ...
        const MethodInfo *method)
{
  ...
  CombineListViewObject__Init_46158436((CombineListViewObject_o *)dragObject, 2, v14);
        ...
        const MethodInfo *method)
{
  ...
  if ( !dragObject
    || (dragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                   dragObject,
                                                   (const MethodInfo_3000534 *)Method_UnityEngine_GameObject_GetComponent_CombineListViewObject___)) == 0LL
    || (CombineListViewObject__Init_46158436((CombineListViewObject_o *)dragObject, 2, v15),
...
void __fastcall CombineListViewObject__EventRetryMove(CombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDFE03 & 1) == 0 )
  {
    sub_1C21E38(&StringLiteral_6374/*"EventRetryMove2"*/);
    byte_4BDFE03 = 1;
  }
  dragObject = this->fields.dragObject;
  if ( !dragObject )
...
LABEL_9:
  ...
  v11[3].monitor = gameObject;
  sub_1C21DDC((PartyOrganizationUtility_o *)&v11[3].monitor, (int64_t)gameObject, v13, v14, v15, v16, v17, v18);
  v19 = StringLiteral_6374/*"EventRetryMove2"*/;
  *(_QWORD *)&v11[3].fields.m_CachedPtr = StringLiteral_6374/*"EventRetryMove2"*/;
  sub_1C21DDC((PartyOrganizationUtility_o *)&v11[3].fields, v19, v20, v21, v22, v23, v24, v25);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C21E38(&Method_UnityEngine_GameObject_GetComponent_CombineListViewObject___);
    sub_1C21E38(&StringLiteral_6373/*"EventRetryMove"*/);
    byte_4BDFE02 = 1;
  }
  this->fields.isBusy = 1;
  this->fields.dispMode = 0;
  ...
  UnityEngine_MonoBehaviour__Invoke(
    (UnityEngine_MonoBehaviour_o *)this,
    (System_String_o *)StringLiteral_6373/*"EventRetryMove"*/,
    delay,
    0LL);
}
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineListViewObject__Init_46158436(
        CombineListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineListViewObject__Init_46159736(
        CombineListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineListViewObject__Init_46159836(
        CombineListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall CombineListViewObject__SetItem_46161828(
        CombineListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall CombineListViewObject__Start(CombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    CombineListViewObject__Init_46158436(this, 2, v2);
}
...
System_String_o *__fastcall CombineListViewObject__ToString(CombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDFE05 & 1) == 0 )
  {
    sub_1C21E38(&CombineListViewItemDraw_DispMode_TypeInfo);
