...
void __fastcall CombineListViewObject__Awake(CombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6A41E & 1) == 0 )
  {
    sub_1BE4ACC(&Method_UnityEngine_GameObject_GetComponent_CombineListViewItemDraw___, method);
    byte_4B6A41E = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2FA979C *)Method_UnityEngine_GameObject_GetComponent_CombineListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A421 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_UnityEngine_GameObject_GetComponent_CombineListViewObject___, method);
    byte_4B6A421 = 1;
  }
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_2FA979C *)Method_UnityEngine_GameObject_GetComponent_CombineListViewObject___)) == 0LL) )
  {
    sub_1BE4D28(DragObject, v4);
  }
  CombineListViewObject__Init_45832948((CombineListViewObject_o *)DragObject, 2, v6);
  return v5;
}
...
void __fastcall CombineListViewObject__EventEnterMove(CombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6A428 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_6309/*"EventEnterMove2"*/, method);
    byte_4B6A428 = 1;
  }
...
LABEL_9:
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&v10[3].monitor, (int64_t)gameObject, v12, v13, v14, v15, v16, v17);
  v18 = StringLiteral_6309/*"EventEnterMove2"*/;
  *(_QWORD *)&v10[3].fields.m_CachedPtr = StringLiteral_6309/*"EventEnterMove2"*/;
  sub_1BE4A70((PartyOrganizationUtility_o *)&v10[3].fields, v18, v19, v20, v21, v22, v23, v24);
}
...
void __fastcall CombineListViewObject__EventEnterMove2(CombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.dragObject, 0LL, v4, v5, v6, v7, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.dragObject, (int64_t)v6, v7, v8, v9, v10, v11, v12);
  dragObject = this->fields.dragObject;
  if ( !dragObject
    || (dragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                   dragObject,
                                                   (const MethodInfo_2FA979C *)Method_UnityEngine_GameObject_GetComponent_CombineListViewObject___)) == 0LL )
  {
    sub_1BE4D28(dragObject, v13);
  }
  CombineListViewObject__Init_45832948((CombineListViewObject_o *)dragObject, 2, v15);
...
void __fastcall CombineListViewObject__EventIntoMove(CombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6A425 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_6322/*"EventIntoMove2"*/, method);
    byte_4B6A425 = 1;
  }
  dragObject = this->fields.dragObject;
  if ( !dragObject )
...
LABEL_9:
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&v11[3].monitor, (int64_t)gameObject, v13, v14, v15, v16, v17, v18);
  v19 = StringLiteral_6322/*"EventIntoMove2"*/;
  *(_QWORD *)&v11[3].fields.m_CachedPtr = StringLiteral_6322/*"EventIntoMove2"*/;
  sub_1BE4A70((PartyOrganizationUtility_o *)&v11[3].fields, v19, v20, v21, v22, v23, v24, v25);
}
...
void __fastcall CombineListViewObject__EventIntoMove2(CombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  NGUITools__Destroy(dragObject, 0LL);
  this->fields.dragObject = 0LL;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.dragObject, 0LL, v5, v6, v7, v8, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.dragObject, (int64_t)v6, v8, v9, v10, v11, v12, v13);
  dragObject = this->fields.dragObject;
  if ( !dragObject
    || (dragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                   dragObject,
                                                   (const MethodInfo_2FA979C *)Method_UnityEngine_GameObject_GetComponent_CombineListViewObject___)) == 0LL
    || (CombineListViewObject__Init_45832948((CombineListViewObject_o *)dragObject, 2, v16),
        (dragObject = *p_dragObject) == 0LL)
    || (transform = UnityEngine_GameObject__get_transform(dragObject, 0LL),
        (dragObject = (UnityEngine_GameObject_o *)UnityEngine_Component__get_transform(
                                                    (UnityEngine_Component_o *)this,
                                                    0LL)) == 0LL)
    || (*(UnityEngine_Vector3_o *)&v18 = UnityEngine_Transform__TransformPoint_70476588(
...
void __fastcall CombineListViewObject__EventRetryMove(CombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6A42B & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_6341/*"EventRetryMove2"*/, method);
    byte_4B6A42B = 1;
  }
  dragObject = this->fields.dragObject;
  if ( !dragObject )
...
LABEL_9:
  ...
  v11[3].monitor = gameObject;
  sub_1BE4A70((PartyOrganizationUtility_o *)&v11[3].monitor, (int64_t)gameObject, v13, v14, v15, v16, v17, v18);
  v19 = StringLiteral_6341/*"EventRetryMove2"*/;
  *(_QWORD *)&v11[3].fields.m_CachedPtr = StringLiteral_6341/*"EventRetryMove2"*/;
  sub_1BE4A70((PartyOrganizationUtility_o *)&v11[3].fields, v19, v20, v21, v22, v23, v24, v25);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BE4ACC(&Method_UnityEngine_GameObject_GetComponent_CombineListViewObject___, method);
    sub_1BE4ACC(&StringLiteral_6340/*"EventRetryMove"*/, v5);
    byte_4B6A42A = 1;
  }
  this->fields.isBusy = 1;
  this->fields.dispMode = 0;
  ...
  UnityEngine_MonoBehaviour__Invoke(
    (UnityEngine_MonoBehaviour_o *)this,
    (System_String_o *)StringLiteral_6340/*"EventRetryMove"*/,
    delay,
    0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A420 & 1) == 0 )
  {
    sub_1BE4ACC(&CombineListViewItem_TypeInfo, method);
    byte_4B6A420 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A422 & 1) == 0 )
  {
    sub_1BE4ACC(&CombineListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4B6A422 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
LABEL_14:
      ...
      {
        p_callbackFunc->klass = 0LL;
        sub_1BE4A70(p_callbackFunc, 0LL, v25, v26, v27, v28, v29, v30);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineListViewObject__Init_45832948(
        CombineListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineListViewObject__Init_45834248(
        CombineListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineListViewObject__Init_45834348(
        CombineListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall CombineListViewObject__SetItem_45836340(
        CombineListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall CombineListViewObject__Start(CombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    CombineListViewObject__Init_45832948(this, 2, v2);
}
...
System_String_o *__fastcall CombineListViewObject__ToString(CombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6A42D & 1) == 0 )
  {
    sub_1BE4ACC(&CombineListViewItemDraw_DispMode_TypeInfo, method);
