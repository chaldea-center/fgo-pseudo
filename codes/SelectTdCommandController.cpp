        ...
        const MethodInfo *method)
{
  ...
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields, (int32_t)inputSvtData, v7, v8, v9, v10, v11, v12);
        ...
        const MethodInfo *method)
{
  if ( (byte_4CF20E9 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_2751/*"BATTLE_DIALOG_TREASURE_DEVICE_CHANGE_NOW"*/);
    byte_4CF20E9 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C7BAE8(&LocalizationManager_TypeInfo);
    sub_1C7BAE8(&StringLiteral_2752/*"BATTLE_DIALOG_TREASURE_DEVICE_CHANGE_TITLE"*/);
    byte_4CF20E8 = 1;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF20E7 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_System_Linq_Enumerable_Select_SelectTreasureDeviceInfo_TdChangeParam__int___);
    sub_1C7BAE8(&Method_System_Linq_Enumerable_ToArray_int___);
    sub_1C7BAE8(&System_Func_SelectTreasureDeviceInfo_TdChangeParam__int__TypeInfo);
    sub_1C7BAE8(&Method_SelectTdCommandController___c__GetNowSelectingCommandIndex_b__8_0__);
    sub_1C7BAE8(&SelectTdCommandController___c_TypeInfo);
    byte_4CF20E7 = 1;
  }
  svtData = this->fields.svtData;
  if ( !svtData
  ...
  if ( !_9__8_0 )
  {
    ...
    _9__8_0 = (System_Func_object__int__o *)sub_1C7BD34(System_Func_SelectTreasureDeviceInfo_TdChangeParam__int__TypeInfo);
  ...
  v17 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_object__int_(
                                                               ...
                                                               (const MethodInfo_31A5664 *)Method_System_Linq_Enumerable_Select_SelectTreasureDeviceInfo_TdChangeParam__int___);
  v18 = System_Linq_Enumerable__ToArray_int_(
          v17,
          (const MethodInfo_31AF04C *)Method_System_Linq_Enumerable_ToArray_int___);
  return System_Array__IndexOf_int_(v18, v5, (const MethodInfo_3275200 *)Method_System_Array_IndexOf_int___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF20EB & 1) == 0 )
  {
    sub_1C7BAE8(&SelectTdCommandController_TypeInfo);
    ...
    && (SelectTreasureDeviceInfo = SkillLvEntity__GetSelectTreasureDeviceInfo(SelfSkillLvEntity, 0)) != 0 )
  {
    ...
    v8 = (SelectTdCommandController_o *)sub_1C7BD34(SelectTdCommandController_TypeInfo);
    SelectTdCommandController___ctor(v8, svtData, v7, v9);
    return v8;
  }
  else
  {
    v11 = (SelectTdCommandTypeController_o *)sub_1C7BD34(SelectTdCommandTypeController_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF20EA & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_16092/*"\\[\\s*servantName\\s*\\]"*/);
    byte_4CF20EA = 1;
  }
  v5 = (System_Text_RegularExpressions_Regex_o *)sub_1C7BD34(System_Text_RegularExpressions_Regex_TypeInfo);
  System_Text_RegularExpressions_Regex___ctor_70697572(v5, (System_String_o *)StringLiteral_16092/*"\\[\\s*servantName\\s*\\]"*/, 0);
  svtData = this->fields.svtData;
  if ( !svtData || (svtData = (BattleServantData_o *)BattleServantData__getServantShortName(svtData, 0), !v5) )
    sub_1C7BD40(svtData, v6);
  v8 = System_Text_RegularExpressions_Regex__Replace_70694248(v5, text, (System_String_o *)svtData, 0);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
...
void SelectTdCommandController___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C7BD34(SelectTdCommandController___c_TypeInfo);
