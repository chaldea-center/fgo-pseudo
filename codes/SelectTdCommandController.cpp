        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields, (int32_t)inputSvtData, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4817F & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_2781/*"BATTLE_DIALOG_TREASURE_DEVICE_CHANGE_NOW"*/, v2);
    byte_4B4817F = 1;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  return LocalizationManager__Get((System_String_o *)StringLiteral_2781/*"BATTLE_DIALOG_TREASURE_DEVICE_CHANGE_NOW"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&LocalizationManager_TypeInfo, method);
    sub_1BDB878(&StringLiteral_2782/*"BATTLE_DIALOG_TREASURE_DEVICE_CHANGE_TITLE"*/, v3);
    byte_4B4817E = 1;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_2782/*"BATTLE_DIALOG_TREASURE_DEVICE_CHANGE_TITLE"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4817D & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_System_Linq_Enumerable_Select_SelectTreasureDeviceInfo_TdChangeParam__int___, v3);
    sub_1BDB878(&Method_System_Linq_Enumerable_ToArray_int___, v4);
    sub_1BDB878(&System_Func_SelectTreasureDeviceInfo_TdChangeParam__int__TypeInfo, v5);
    sub_1BDB878(&Method_SelectTdCommandController___c__GetNowSelectingCommandIndex_b__8_0__, v6);
    sub_1BDB878(&SelectTdCommandController___c_TypeInfo, v7);
    byte_4B4817D = 1;
  }
  svtData = this->fields.svtData;
  if ( !svtData
  ...
  if ( !_9__8_0 )
  {
    ...
    _9__8_0 = (System_Func_object__int__o *)sub_1BDBAC4(System_Func_SelectTreasureDeviceInfo_TdChangeParam__int__TypeInfo);
  ...
  v18 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_object__int_(
                                                               ...
                                                               (const MethodInfo_3067BA8 *)Method_System_Linq_Enumerable_Select_SelectTreasureDeviceInfo_TdChangeParam__int___);
  v19 = System_Linq_Enumerable__ToArray_int_(
          v18,
          (const MethodInfo_3070610 *)Method_System_Linq_Enumerable_ToArray_int___);
  return System_Array__IndexOf_int_(v19, v10, (const MethodInfo_3132F28 *)Method_System_Array_IndexOf_int___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48181 & 1) == 0 )
  {
    sub_1BDB878(&SelectTdCommandController_TypeInfo, skillInfo);
    sub_1BDB878(&SelectTdCommandTypeController_TypeInfo, v5);
    byte_4B48181 = 1;
  }
  if ( skillInfo
    ...
    && (SelectTreasureDeviceInfo = SkillLvEntity__GetSelectTreasureDeviceInfo(SelfSkillLvEntity, 0LL)) != 0LL )
  {
    ...
    v9 = (SelectTdCommandController_o *)sub_1BDBAC4(SelectTdCommandController_TypeInfo);
    SelectTdCommandController___ctor(v9, svtData, v8, v10);
    return v9;
  }
  else
  {
    v12 = (SelectTdCommandTypeController_o *)sub_1BDBAC4(SelectTdCommandTypeController_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48180 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_16015/*"\\[\\s*servantName\\s*\\]"*/, v6);
    byte_4B48180 = 1;
  }
  v7 = (System_Text_RegularExpressions_Regex_o *)sub_1BDBAC4(System_Text_RegularExpressions_Regex_TypeInfo);
  System_Text_RegularExpressions_Regex___ctor(v7, (System_String_o *)StringLiteral_16015/*"\\[\\s*servantName\\s*\\]"*/, 0LL);
  svtData = this->fields.svtData;
  if ( !svtData || (svtData = (BattleServantData_o *)BattleServantData__getServantShortName(svtData, 0LL), !v7) )
    sub_1BDBAD4(svtData, v8);
  v10 = System_Text_RegularExpressions_Regex__Replace_69109184(v7, text, (System_String_o *)svtData, 0LL);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
...
void __fastcall SelectTdCommandController___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B48182 & 1) == 0 )
  {
    sub_1BDB878(&SelectTdCommandController___c_TypeInfo, v1);
    byte_4B48182 = 1;
  }
  v2 = (Il2CppObject *)sub_1BDBAC4(SelectTdCommandController___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  SelectTdCommandController___c_TypeInfo->static_fields->__9 = (struct SelectTdCommandController___c_o *)v2;
  sub_1BDB81C((CGThumbnailListItem_o *)SelectTdCommandController___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
