        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDAC1 & 1) == 0 )
  {
    ...
    sub_1B640C8(&StringLiteral_16569/*"accountLinkageAnx/unlink"*/, v2);
    byte_49FDAC1 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61375396(BaseUrl, (System_String_o *)StringLiteral_16569/*"accountLinkageAnx/unlink"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDAC3 & 1) == 0 )
  {
    ...
    this = (AccountLinkageUnlinkRequest_o *)sub_1B640C8(&StringLiteral_21968/*"ng"*/, v5);
    byte_49FDAC3 = 1;
  }
  if ( !responseList )
    goto LABEL_10;
