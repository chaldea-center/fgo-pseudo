...
System_String_o *AccountLinkageUnlinkRequest__getURL(AccountLinkageUnlinkRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C713B0(&NetworkManager_TypeInfo);
    sub_1C713B0(&StringLiteral_16648/*"accountLinkageAnx/unlink"*/);
    byte_4CC8E55 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64031724(BaseUrl, (System_String_o *)StringLiteral_16648/*"accountLinkageAnx/unlink"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC8E57 & 1) == 0 )
  {
    ...
    this = (AccountLinkageUnlinkRequest_o *)sub_1C713B0(&StringLiteral_22316/*"ng"*/);
    byte_4CC8E57 = 1;
  }
  if ( !responseList )
    goto LABEL_10;
