        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1DED2 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_16510/*"accountLinkageAnx/unlink"*/, v2);
    byte_4B1DED2 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62450424(BaseUrl, (System_String_o *)StringLiteral_16510/*"accountLinkageAnx/unlink"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1DED4 & 1) == 0 )
  {
    ...
    this = (AccountLinkageUnlinkRequest_o *)sub_1BCAFF8(&StringLiteral_22015/*"ng"*/, v5);
    byte_4B1DED4 = 1;
  }
  if ( !responseList )
    goto LABEL_10;
