...
System_String_o *AccountLinkageUnlinkRequest__getURL(AccountLinkageUnlinkRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1D0F0B4(&NetworkManager_TypeInfo);
    sub_1D0F0B4(&StringLiteral_16873/*"accountLinkageAnx/unlink"*/);
    byte_4E790DC = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_65562772(BaseUrl, (System_String_o *)StringLiteral_16873/*"accountLinkageAnx/unlink"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E790DE & 1) == 0 )
  {
    ...
    this = (AccountLinkageUnlinkRequest_o *)sub_1D0F0B4(&StringLiteral_22648/*"ng"*/);
    byte_4E790DE = 1;
  }
  if ( !responseList )
    goto LABEL_10;
