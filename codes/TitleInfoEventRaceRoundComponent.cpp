        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1DB0E & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_DataManager_GetMasterData_MapCondMaster___, v11);
    sub_1B715CC(&Method_DataManager_GetMasterData_MapMaster___, v12);
    sub_1B715CC(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v13);
    sub_1B715CC(&StringLiteral_22693/*"race_mapname_round_"*/, v14);
    sub_1B715CC(&StringLiteral_16073/*"_"*/, v15);
    sub_1B715CC(&StringLiteral_22692/*"race_mapname_bg_"*/, v16);
    byte_4A1DB0E = 1;
  }
  ...
  if ( !Instance
    ...
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_2E5B3E8 *)Method_DataManager_GetMasterData_MapMaster___)) == 0LL
  ...
  v23 = System_String__Concat_61505504((System_String_o *)StringLiteral_22692/*"race_mapname_bg_"*/, v22, 0LL);
  ...
  v28 = System_String__Concat_61518768(
          (System_String_o *)StringLiteral_22693/*"race_mapname_round_"*/,
          v26,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1DB0F & 1) == 0 )
  {
    sub_1B715CC(&AtlasManager_TypeInfo, *(_QWORD *)&headerId);
    sub_1B715CC(&StringLiteral_22691/*"race_mapname_"*/, v4);
    byte_4A1DB0F = 1;
  }
  mapNameSpr = this->fields.mapNameSpr;
  v6 = System_Int32__ToString((int32_t)&v8, 0LL);
  v7 = System_String__Concat_61505504((System_String_o *)StringLiteral_22691/*"race_mapname_"*/, v6, 0LL);
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1DB10 & 1) == 0 )
  {
    sub_1B715CC(&System_Action_TypeInfo, *(_QWORD *)&event_id);
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponent_TitleInfoEventOpenHeaderEffect___, v6);
    ...
    sub_1B715CC(&Method_TitleInfoEventRaceRoundComponent__setupNameChangeEffect_b__13_0__, v10);
    sub_1B715CC(&StringLiteral_18789/*"ef_mapnamechange_"*/, v11);
    byte_4A1DB10 = 1;
  }
  ...
  if ( effectAssetData )
  {
    ...
    v14 = System_String__Concat_61505504((System_String_o *)StringLiteral_18789/*"ef_mapnamechange_"*/, v13, 0LL);
    Object_37565280 = AssetData__GetObject_37565280(effectAssetData, v14, 0LL);
    if ( Object_37565280 )
    {
      if ( (UnityEngine_GameObject_c *)Object_37565280->klass == UnityEngine_GameObject_TypeInfo )
        v16 = (Il2CppObject *)Object_37565280;
      else
        v16 = 0LL;
    }
    else
    ...
    else
    {
      ...
      GameObjectExtensions__SafeSetParent_33535352(gameObject, this->fields.effectAttachRoot, 0LL);
      Component_object = UnityEngine_GameObject__GetComponent_object_(
                           v20,
                           (const MethodInfo_2EAA998 *)Method_UnityEngine_GameObject_GetComponent_TitleInfoEventOpenHeaderEffect___);
      v23 = v27;
