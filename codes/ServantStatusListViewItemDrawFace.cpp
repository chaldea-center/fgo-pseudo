        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57DEA & 1) == 0 )
  {
    ...
    this = (ServantStatusListViewItemDrawFace_o *)sub_1B885B0(&StringLiteral_1/*""*/);
    byte_4A57DEA = 1;
  }
  ...
  if ( ((unsigned __int8)this & 1) != 0 )
  {
    ...
    if ( svtCostumeEntity )
    {
      ...
      if ( iconId >= 1 )
      {
        ...
        v16 = System_String__Concat_61707032((System_String_o *)StringLiteral_23715/*"svt_costume_icon_"*/, v15, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  float v51; // s10
  float v52; // s9
  const MethodInfo_3739718 **v53; // x29
  ...
  const MethodInfo_3739718 **v82; // x22
  int32_t *v83; // x29
  ...
  if ( (byte_4A57DE9 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_11865/*"SERVANT_STATUS_EXPLANATION_FACE"*/);
    sub_1B885B0(&StringLiteral_11867/*"SERVANT_STATUS_EXPLANATION_FACE3"*/);
    sub_1B885B0(&StringLiteral_11866/*"SERVANT_STATUS_EXPLANATION_FACE2"*/);
    sub_1B885B0(&StringLiteral_11868/*"SERVANT_STATUS_EXPLANATION_FACE_LIMIT_COUNT_SEALED_MSG"*/);
    byte_4A57DE9 = 1;
  }
  entity = 0LL;
  ...
  if ( item->fields.userSvtEntity )
  {
    ...
    ServantStatusExplanationText = (UISprite_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11865/*"SERVANT_STATUS_EXPLANATION_FACE"*/, 0LL);
    if ( !explanationLabel )
      goto LABEL_142;
  ...
  else if ( item->fields.userSvtCollectionEntity )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    ServantStatusExplanationText = (UISprite_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11866/*"SERVANT_STATUS_EXPLANATION_FACE2"*/, 0LL);
    if ( !v14 )
      goto LABEL_142;
  ...
  else
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    ServantStatusExplanationText = (UISprite_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11867/*"SERVANT_STATUS_EXPLANATION_FACE3"*/, 0LL);
    if ( !v17 )
      goto LABEL_142;
  ...
  *(_QWORD *)&v95.fields.fakeValue = v12;
  ServantStatusExplanationText = (UISprite_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46449800(
                                                 v95,
                                                 0LL);
         ...
         0LL) )
  {
    ServantStatusExplanationText = (UISprite_o *)ServantLimitImageMaster__GetServantStatusExplanationText(
                                                   (ServantLimitImageMaster_o *)Master_object,
                                                   (System_String_o *)StringLiteral_11868/*"SERVANT_STATUS_EXPLANATION_FACE_LIMIT_COUNT_SEALED_MSG"*/,
                                                   v19,
                                                   0LL);
...
LABEL_33:
  ...
  v53 = (const MethodInfo_3739718 **)&Method_SingletonMonoBehaviour_DataManager__get_Instance__;
  ServantStatusExplanationText = (UISprite_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !ServantStatusExplanationText
    || (MasterData_object = (ServantLimitSpoilerProtectionMaster_o *)DataManager__GetMasterData_object_(
        ...
        (ServantStatusExplanationText = (UISprite_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0LL) )
  {
LABEL_142:
    sub_1B8880C(ServantStatusExplanationText, v10);
  }
  v54 = 0LL;
...
LABEL_98:
        ...
        if ( !AtlasManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
        AtlasManager__SetFaceImage(v69, v71, v70, 0LL);
        ServantStatusExplanationText = (UISprite_o *)ServantStatusListViewItem__get_SvtId(item, 0LL);
        if ( v54 >= iconSelectList->max_length )
LABEL_145:
          sub_1B88814(ServantStatusExplanationText, v10);
...
LABEL_118:
  ...
  while ( v78 < (signed int)v77->max_length )
  {
    ...
    else
    {
      ...
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
      AtlasManager__SetFaceImage(v85, v87, v86, 0LL);
      ServantStatusExplanationText = (UISprite_o *)ServantStatusListViewItem__get_SvtId(item, 0LL);
      if ( v78 >= iconSelectList->max_length )
        goto LABEL_145;
        ...
        const MethodInfo *method)
{
  ...
  v74 = 0;
  Instance = (UICommonButton_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_146;
...
LABEL_146:
  ...
  do
  {
    ...
    else
    {
      ...
      v29 = System_String__Concat_61707032((System_String_o *)StringLiteral_11885/*"SERVANT_STATUS_IMAGE_LIMIT_COUNT_LEVEL_"*/, v34, 0LL);
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    }
...
LABEL_148:
    ...
    if ( !Instance )
      goto LABEL_146;
    v37 = &StringLiteral_17479/*"btn_bg_20"*/;
    if ( v25 )
      v37 = &StringLiteral_17480/*"btn_bg_21"*/;
    ...
    if ( IsServantLimitCountSeal )
    {
      ...
      if ( ((unsigned __int8)Instance & 1) != 0 )
      {
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        Instance = (UICommonButton_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8248/*"LIMIT_COUNT_SELECT_SEALED"*/, 0LL);
        if ( !v43 )
          goto LABEL_146;
...
LABEL_90:
  ...
  while ( v50 < (signed int)v49->max_length )
  {
    ...
    if ( !Instance )
      goto LABEL_146;
    v63 = &StringLiteral_17479/*"btn_bg_20"*/;
    if ( v52 )
      v63 = &StringLiteral_17480/*"btn_bg_21"*/;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57DEC & 1) == 0 )
  {
    ...
    this = (ServantStatusListViewItemDrawFace_o *)sub_1B885B0(&StringLiteral_11907/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_INFO_OWN_SETTING_FACE"*/);
    byte_4A57DEC = 1;
  }
  if ( !item )
LABEL_24:
...
LABEL_18:
  ...
  if ( item->fields.isEnableOwnRandomSetting )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    Empty = LocalizationManager__Get((System_String_o *)StringLiteral_11907/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_INFO_OWN_SETTING_FACE"*/, 0LL);
  }
  else
  {
