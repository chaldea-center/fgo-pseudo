...
LABEL_19:
    sub_1C7BD40(material, v12);
  UnityEngine_Material__SetFloat((UnityEngine_Material_o *)material, (System_String_o *)StringLiteral_16294/*"_Gradation"*/, 0.2, 0);
LABEL_17:
...
void FlashEffectComponent__FlashStart(FlashEffectComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C7BAE8(&AssetManager_TypeInfo);
    sub_1C7BAE8(&Method_FlashEffectComponent_EndLoadWipe__);
  ...
  {
    v5 = System_String__Concat_64176912((System_String_o *)StringLiteral_15717/*"Wipe/"*/, this->fields.wipeName, 0);
...
void FlashEffectComponent__OnDestroy(FlashEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.wipeData )
  {
    ...
    p_wipeData->klass = 0;
    sub_1C7BA8C(p_wipeData, 0, v7, v8, v9, v10, v11, v12);
  }
}
