        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4353D14 & 1) == 0 )
  {
    ...
    this = (TopMyRoomRequest_o *)sub_B70694(&StringLiteral_16092/*"]"*/);
    byte_4353D14 = 1;
  }
  if ( !voicePlayedList )
LABEL_68:
    sub_B7076C(this, voicePlayedList);
  ...
  if ( (int)v5 >= 1 )
  {
    ...
    while ( v7 < (unsigned int)v5 )
    {
      ...
      if ( v8 && v8->max_length == 2 )
      {
        ...
        {
          this = (TopMyRoomRequest_o *)sub_B706AC(string___TypeInfo, 5LL);
          if ( !this )
            goto LABEL_68;
          v15 = this;
          this = (TopMyRoomRequest_o *)StringLiteral_15855/*"["*/;
          if ( StringLiteral_15855/*"["*/ )
          {
            this = (TopMyRoomRequest_o *)sub_B70754(StringLiteral_15855/*"["*/, v15->klass->_1.element_class);
            if ( !this )
              goto LABEL_67;
            v16 = (System_Int32_array **)StringLiteral_15855/*"["*/;
          }
          else
          {
            v16 = 0LL;
          ...
          sub_B70630((BattleServantConfConponent_o *)&v15->fields.paramString, v16, v9, v10, v11, v12, v13, v14);
          if ( !v8->max_length )
            break;
          ...
          if ( this )
          {
            this = (TopMyRoomRequest_o *)sub_B70754(this, v15->klass->_1.element_class);
            if ( !this )
              goto LABEL_67;
          }
          ...
          sub_B70630((BattleServantConfConponent_o *)&v15[1], v36, v30, v31, v32, v33, v34, v35);
          this = (TopMyRoomRequest_o *)StringLiteral_712/*","*/;
          if ( StringLiteral_712/*","*/ )
          {
            this = (TopMyRoomRequest_o *)sub_B70754(StringLiteral_712/*","*/, v15->klass->_1.element_class);
            if ( !this )
              goto LABEL_67;
          ...
          if ( LODWORD(v15->fields.paramInteger) <= 2 )
            break;
          v15[1].monitor = v43;
          sub_B70630((BattleServantConfConponent_o *)&v15[1].monitor, v43, v37, v38, v39, v40, v41, v42);
          if ( v8->max_length <= 1 )
            break;
          ...
          sub_B70630((BattleServantConfConponent_o *)&v15[1].fields, v64, v58, v59, v60, v61, v62, v63);
          this = (TopMyRoomRequest_o *)StringLiteral_16092/*"]"*/;
          if ( StringLiteral_16092/*"]"*/ )
          {
            this = (TopMyRoomRequest_o *)sub_B70754(StringLiteral_16092/*"]"*/, v15->klass->_1.element_class);
            if ( !this )
              goto LABEL_67;
            v71 = (System_Int32_array **)StringLiteral_16092/*"]"*/;
          }
          else
          {
            v71 = 0LL;
        ...
        {
          this = (TopMyRoomRequest_o *)sub_B706AC(string___TypeInfo, 6LL);
          if ( !this )
            goto LABEL_68;
          v15 = this;
          if ( v6 )
          {
            this = (TopMyRoomRequest_o *)sub_B70754(v6, this->klass->_1.element_class);
            if ( !this )
            {
LABEL_67:
              v82 = sub_B7078C(this);
          ...
          sub_B70630((BattleServantConfConponent_o *)&v15->fields.paramString, v6, v17, v18, v19, v20, v21, v22);
          this = (TopMyRoomRequest_o *)StringLiteral_759/*",["*/;
          if ( StringLiteral_759/*",["*/ )
          {
            this = (TopMyRoomRequest_o *)sub_B70754(StringLiteral_759/*",["*/, v15->klass->_1.element_class);
            if ( !this )
              goto LABEL_67;
            v29 = (System_Int32_array **)StringLiteral_759/*",["*/;
          }
          else
          {
            v29 = 0LL;
          ...
          sub_B70630((BattleServantConfConponent_o *)&v15[1], v29, v23, v24, v25, v26, v27, v28);
          if ( !v8->max_length )
            break;
          this = (TopMyRoomRequest_o *)System_Int32__ToString((int)v8 + 32, 0LL);
          ...
          if ( LODWORD(v15->fields.paramInteger) <= 2 )
            break;
          v15[1].monitor = v50;
          sub_B70630((BattleServantConfConponent_o *)&v15[1].monitor, v50, v44, v45, v46, v47, v48, v49);
          this = (TopMyRoomRequest_o *)StringLiteral_712/*","*/;
          if ( StringLiteral_712/*","*/ )
          {
            this = (TopMyRoomRequest_o *)sub_B70754(StringLiteral_712/*","*/, v15->klass->_1.element_class);
            if ( !this )
              goto LABEL_67;
            v57 = (System_Int32_array **)StringLiteral_712/*","*/;
          }
          else
          {
            v57 = 0LL;
          ...
          sub_B70630((BattleServantConfConponent_o *)&v15[1].fields, v57, v51, v52, v53, v54, v55, v56);
          if ( v8->max_length <= 1 )
            break;
          this = (TopMyRoomRequest_o *)System_Int32__ToString((int)v8 + 36, 0LL);
          ...
          sub_B70630((BattleServantConfConponent_o *)&v15[1].fields.paramInteger, v78, v72, v73, v74, v75, v76, v77);
          this = (TopMyRoomRequest_o *)StringLiteral_16092/*"]"*/;
          if ( StringLiteral_16092/*"]"*/ )
          {
            this = (TopMyRoomRequest_o *)sub_B70754(StringLiteral_16092/*"]"*/, v15->klass->_1.element_class);
        ...
        sub_B70630(p_paramInteger, v71, v65, v66, v67, v68, v69, v70);
        this = (TopMyRoomRequest_o *)System_String__Concat_44838292((System_String_array *)v15, 0LL);
...
LABEL_65:
  v80 = System_String__Concat_44760452(
          ...
          0LL);
  RequestBase__addField_32336576(v83, (System_String_o *)StringLiteral_23562/*"voicePlayedList"*/, v80, 0LL);
...
System_String_o *__fastcall TopMyRoomRequest__getURL(TopMyRoomRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4353D13 & 1) == 0 )
  {
    ...
    sub_B70694(&StringLiteral_17488/*"card/voice"*/);
    byte_4353D13 = 1;
  }
  ...
  return System_String__Concat_44758168(BaseUrl, (System_String_o *)StringLiteral_17488/*"card/voice"*/, 0LL);
}
