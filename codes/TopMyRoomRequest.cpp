        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A717FE & 1) == 0 )
  {
    sub_1B90010(&string___TypeInfo, voicePlayedList);
    sub_1B90010(&StringLiteral_918/*",["*/, v5);
    sub_1B90010(&StringLiteral_868/*","*/, v6);
    sub_1B90010(&StringLiteral_24630/*"voicePlayedList"*/, v7);
    sub_1B90010(&StringLiteral_15837/*"["*/, v8);
    sub_1B90010(&StringLiteral_1/*""*/, v9);
    this = (TopMyRoomRequest_o *)sub_1B90010(&StringLiteral_16094/*"]"*/, v10);
    byte_4A717FE = 1;
  }
  if ( !voicePlayedList )
LABEL_33:
    sub_1B9026C(this, voicePlayedList);
  ...
  if ( (int)v11 >= 1 )
  {
    ...
    while ( v13 < (unsigned int)v11 )
    {
      ...
      if ( v14 && v14->max_length == 2 )
      {
        ...
        {
          this = (TopMyRoomRequest_o *)sub_1B900B8(string___TypeInfo, 5LL);
          if ( !this )
            goto LABEL_33;
          v17 = this;
          if ( !LODWORD(this->fields.paramInteger) )
            break;
          v18 = StringLiteral_15837/*"["*/;
          this->fields.paramString = (struct System_Collections_Generic_Dictionary_string__string__o *)StringLiteral_15837/*"["*/;
          sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.paramString, v18, v15, v16);
          if ( !v14->max_length )
            break;
          ...
          sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&v17[1], (int32_t)this, v19, v20);
          if ( LODWORD(v17->fields.paramInteger) <= 2 )
            break;
          v23 = (int)StringLiteral_868/*","*/;
          v17[1].monitor = StringLiteral_868/*","*/;
          sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&v17[1].monitor, v23, v21, v22);
          if ( v14->max_length <= 1 )
            break;
          ...
          sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&v17[1].fields, (int32_t)this, v24, v25);
          if ( LODWORD(v17->fields.paramInteger) <= 4 )
            break;
          v28 = StringLiteral_16094/*"]"*/;
          v17[1].fields.paramInteger = (struct System_Collections_Generic_Dictionary_string__int__o *)StringLiteral_16094/*"]"*/;
          p_paramInteger = (ServantStatusBattleListViewItem_o *)&v17[1].fields.paramInteger;
        }
        else
        {
          this = (TopMyRoomRequest_o *)sub_1B900B8(string___TypeInfo, 6LL);
          if ( !this )
            goto LABEL_33;
          v17 = this;
          if ( !LODWORD(this->fields.paramInteger) )
          ...
          sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.paramString, (int32_t)v12, v30, v31);
          if ( LODWORD(v17->fields.paramInteger) <= 1 )
            break;
          v34 = StringLiteral_918/*",["*/;
          v17[1].klass = (TopMyRoomRequest_c *)StringLiteral_918/*",["*/;
          sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&v17[1], v34, v32, v33);
          if ( !v14->max_length )
            break;
          this = (TopMyRoomRequest_o *)System_Int32__ToString((int)v14 + 32, 0LL);
          if ( LODWORD(v17->fields.paramInteger) <= 2 )
            break;
          v17[1].monitor = this;
          sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&v17[1].monitor, (int32_t)this, v35, v36);
          if ( LODWORD(v17->fields.paramInteger) <= 3 )
            break;
          v39 = (int)StringLiteral_868/*","*/;
          v17[1].fields.CallBack = (struct NetworkManager_ResultCallbackFunc_o *)StringLiteral_868/*","*/;
          sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&v17[1].fields, v39, v37, v38);
          if ( v14->max_length <= 1 )
            break;
          this = (TopMyRoomRequest_o *)System_Int32__ToString((int)v14 + 36, 0LL);
          if ( LODWORD(v17->fields.paramInteger) <= 4 )
          ...
          sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&v17[1].fields.paramInteger, (int32_t)this, v40, v41);
          if ( LODWORD(v17->fields.paramInteger) <= 5 )
            break;
          v28 = StringLiteral_16094/*"]"*/;
          v17[1].fields.paramString = (struct System_Collections_Generic_Dictionary_string__string__o *)StringLiteral_16094/*"]"*/;
          p_paramInteger = (ServantStatusBattleListViewItem_o *)&v17[1].fields.paramString;
        }
        sub_1B8FFB4(p_paramInteger, v28, v26, v27);
        this = (TopMyRoomRequest_o *)System_String__Concat_61800620((System_String_array *)v17, 0LL);
        v12 = this;
      }
    ...
    sub_1B90274(this, voicePlayedList);
  }
LABEL_31:
  v42 = System_String__Concat_61798352(
          (System_String_o *)StringLiteral_15837/*"["*/,
          (System_String_o *)v12,
          (System_String_o *)StringLiteral_16094/*"]"*/,
          0LL);
  RequestBase__addField_41181164(v43, (System_String_o *)StringLiteral_24630/*"voicePlayedList"*/, v42, 0LL);
...
System_String_o *__fastcall TopMyRoomRequest__getURL(TopMyRoomRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A717FD & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_17785/*"card/voice"*/, v2);
    byte_4A717FD = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61787092(BaseUrl, (System_String_o *)StringLiteral_17785/*"card/voice"*/, 0LL);
}
