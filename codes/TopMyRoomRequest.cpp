        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2E4E2 & 1) == 0 )
  {
    ...
    this = (TopMyRoomRequest_o *)sub_1C94098(&StringLiteral_16112/*"]"*/);
    byte_4D2E4E2 = 1;
  }
  if ( !voicePlayedList )
LABEL_33:
    sub_1C942F0(this, voicePlayedList);
  ...
  if ( (int)max_length >= 1 )
  {
    ...
    while ( v7 < (unsigned int)max_length )
    {
      ...
      if ( v8 && LODWORD(v8->max_length) == 2 )
      {
        ...
        {
          this = (TopMyRoomRequest_o *)sub_1C94140(string___TypeInfo, 5);
          if ( !this )
            goto LABEL_33;
          v15 = this;
          if ( !LODWORD(this->fields.paramInteger) )
            break;
          v16 = StringLiteral_15861/*"["*/;
          this->fields.paramString = (struct System_Collections_Generic_Dictionary_string__string__o *)StringLiteral_15861/*"["*/;
          sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.paramString, v16, v9, v10, v11, v12, v13, v14);
          ...
          sub_1C9403C((GrandQuestFolderBoardItem_o *)&v15[1], (int32_t)this, v17, v18, v19, v20, v21, v22);
          if ( LODWORD(v15->fields.paramInteger) <= 2 )
            break;
          v29 = StringLiteral_808/*","*/;
          v15[1].monitor = (void *)StringLiteral_808/*","*/;
          sub_1C9403C((GrandQuestFolderBoardItem_o *)&v15[1].monitor, v29, v23, v24, v25, v26, v27, v28);
          ...
          sub_1C9403C((GrandQuestFolderBoardItem_o *)&v15[1].fields, (int32_t)this, v30, v31, v32, v33, v34, v35);
          if ( LODWORD(v15->fields.paramInteger) <= 4 )
            break;
          v42 = StringLiteral_16112/*"]"*/;
          v15[1].fields.paramInteger = (struct System_Collections_Generic_Dictionary_string__int__o *)StringLiteral_16112/*"]"*/;
          p_paramInteger = (GrandQuestFolderBoardItem_o *)&v15[1].fields.paramInteger;
        }
        else
        {
          this = (TopMyRoomRequest_o *)sub_1C94140(string___TypeInfo, 6);
          if ( !this )
            goto LABEL_33;
          v15 = this;
          if ( !LODWORD(this->fields.paramInteger) )
          ...
          sub_1C9403C((GrandQuestFolderBoardItem_o *)&v15[1], v56, v50, v51, v52, v53, v54, v55);
          if ( !LODWORD(v8->max_length) )
            break;
          this = (TopMyRoomRequest_o *)System_Int32__ToString((int)v8 + 32, 0);
          if ( LODWORD(v15->fields.paramInteger) <= 2 )
            break;
          v15[1].monitor = this;
          sub_1C9403C((GrandQuestFolderBoardItem_o *)&v15[1].monitor, (int32_t)this, v57, v58, v59, v60, v61, v62);
          if ( LODWORD(v15->fields.paramInteger) <= 3 )
            break;
          v69 = StringLiteral_808/*","*/;
          v15[1].fields.CallBack = (struct NetworkManager_ResultCallbackFunc_o *)StringLiteral_808/*","*/;
          sub_1C9403C((GrandQuestFolderBoardItem_o *)&v15[1].fields, v69, v63, v64, v65, v66, v67, v68);
          if ( LODWORD(v8->max_length) <= 1 )
            break;
          this = (TopMyRoomRequest_o *)System_Int32__ToString((int)v8 + 36, 0);
          if ( LODWORD(v15->fields.paramInteger) <= 4 )
          ...
          if ( LODWORD(v15->fields.paramInteger) <= 5 )
            break;
          v42 = StringLiteral_16112/*"]"*/;
          v15[1].fields.paramString = (struct System_Collections_Generic_Dictionary_string__string__o *)StringLiteral_16112/*"]"*/;
          p_paramInteger = (GrandQuestFolderBoardItem_o *)&v15[1].fields.paramString;
        }
        sub_1C9403C(p_paramInteger, v42, v36, v37, v38, v39, v40, v41);
        this = (TopMyRoomRequest_o *)System_String__Concat_64458276((System_String_array *)v15, 0);
        v6 = this;
      }
...
LABEL_31:
  v76 = System_String__Concat_64456008(
          (System_String_o *)StringLiteral_15861/*"["*/,
          (System_String_o *)v6,
          (System_String_o *)StringLiteral_16112/*"]"*/,
          0);
  RequestBase__addField_45016480(v79, (System_String_o *)StringLiteral_24962/*"voicePlayedList"*/, v76, v77);
...
System_String_o *TopMyRoomRequest__getURL(TopMyRoomRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2E4E1 & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_17850/*"card/voice"*/);
    byte_4D2E4E1 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64417744(BaseUrl, (System_String_o *)StringLiteral_17850/*"card/voice"*/, 0);
}
