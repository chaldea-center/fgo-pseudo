        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B06288 & 1) == 0 )
  {
    ...
    sub_1BC3008(&EventCraftWithdrawConfirmDialogComponent_WithdrawnItemUiInfo___TypeInfo, v3);
    byte_4B06288 = 1;
  }
  v4 = (struct EventCraftWithdrawConfirmDialogComponent_WithdrawnItemUiInfo_array *)sub_1BC30B0(
                                                                                      EventCraftWithdrawConfirmDialogComponent_WithdrawnItemUiInfo___TypeInfo,
                                                                                      2LL);
  this->fields.withdrawnItemUiBefore = v4;
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.withdrawnItemUiBefore, (int32_t)v4, v5, v6);
  v7 = (struct EventCraftWithdrawConfirmDialogComponent_WithdrawnItemUiInfo_array *)sub_1BC30B0(
                                                                                      EventCraftWithdrawConfirmDialogComponent_WithdrawnItemUiInfo___TypeInfo,
                                                                                      2LL);
  this->fields.withdrawnItemUiAfter = v7;
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.withdrawnItemUiAfter, (int32_t)v7, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B06286 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_EventCraftWithdrawConfirmDialogComponent_Init__, v3);
    byte_4B06286 = 1;
  }
  this->fields.state = 4;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B06285 & 1) == 0 )
  {
    sub_1BC3008(&Method_EventCraftWithdrawConfirmDialogComponent_OnClickCancel__, method);
    byte_4B06285 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_EventCraftWithdrawConfirmDialogComponent_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BC3020(Method_EventCraftWithdrawConfirmDialogComponent_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B06284 & 1) == 0 )
  {
    sub_1BC3008(&Method_EventCraftWithdrawConfirmDialogComponent_OnClickDecide__, method);
    byte_4B06284 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_EventCraftWithdrawConfirmDialogComponent_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BC3020(Method_EventCraftWithdrawConfirmDialogComponent_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BC2FEC(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B06281 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_EventCraftWithdrawConfirmDialogComponent__Open_b__24_0__, v7);
    byte_4B06281 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B06282 & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_3877/*"CRAFT_EVENT_WITHDRAWAL_DIALOG_TITLE"*/, v10);
    sub_1BC3008(&StringLiteral_13378/*"TRADE_EVENT_WITHDRAWAL_DIALOG_RETURN_ITEMS_NONE"*/, v11);
    sub_1BC3008(&StringLiteral_3647/*"COMMON_CONFIRM_CANCEL"*/, v12);
    sub_1BC3008(&StringLiteral_13372/*"TRADE_EVENT_WITHDRAWAL_DIALOG_AFTER_LABEL"*/, v13);
    sub_1BC3008(&StringLiteral_13375/*"TRADE_EVENT_WITHDRAWAL_DIALOG_EXECUTE"*/, v14);
    sub_1BC3008(&StringLiteral_3876/*"CRAFT_EVENT_WITHDRAWAL_DIALOG_MESSAGE"*/, v15);
    this = (EventCraftWithdrawConfirmDialogComponent_o *)sub_1BC3008(&StringLiteral_13377/*"TRADE_EVENT_WITHDRAWAL_DIALOG_RETURN_ITEMS"*/, v16);
    byte_4B06282 = 1;
  }
  if ( !item )
    goto LABEL_28;
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&v6->fields.onDecide, (int32_t)decideCallback, v19, v20);
  ...
  this = (EventCraftWithdrawConfirmDialogComponent_o *)LocalizationManager__Get(
                                                         (System_String_o *)StringLiteral_3877/*"CRAFT_EVENT_WITHDRAWAL_DIALOG_TITLE"*/,
                                                         0LL);
  if ( !titleLabel )
    goto LABEL_28;
  ...
  this = (EventCraftWithdrawConfirmDialogComponent_o *)LocalizationManager__Get(
                                                         (System_String_o *)StringLiteral_3876/*"CRAFT_EVENT_WITHDRAWAL_DIALOG_MESSAGE"*/,
                                                         0LL);
  if ( !detailLabel )
    goto LABEL_28;
  ...
  this = (EventCraftWithdrawConfirmDialogComponent_o *)DataManager__GetMaster_object_((const MethodInfo_3001E10 *)Method_DataManager_GetMaster_CommonConsumeMaster___);
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&v6->fields.consumeItemList, (int32_t)SortedEntityList, v30, v31);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B06283 & 1) == 0 )
  {
    sub_1BC3008(&AtlasManager_TypeInfo, *(_QWORD *)&nowTradeNum);
    ...
    this = (EventCraftWithdrawConfirmDialogComponent_o *)sub_1BC3008(&StringLiteral_3662/*"COMMON_COUNT_OPERATOR_CROSS"*/, v8);
    byte_4B06283 = 1;
  }
...
LABEL_89:
    sub_1BC326C(this, *(_QWORD *)&nowTradeNum, method);
  }
  if ( !v12 )
    goto LABEL_89;
...
LABEL_14:
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  this = (EventCraftWithdrawConfirmDialogComponent_o *)DataManager__GetMaster_object_((const MethodInfo_3001E10 *)Method_DataManager_GetMaster_UserItemMaster___);
  ...
  while ( 1 )
  {
    ...
    if ( !byte_4AFC1F1 )
    {
      sub_1BC3008(&NetworkManager_TypeInfo, *(_QWORD *)&nowTradeNum);
      byte_4AFC1F1 = 1;
    }
      ...
      if ( (signed int)v21 < (signed int)countOperatorLb->max_length )
      {
        ...
        if ( (signed int)v21 < (signed int)countLb->max_length )
        {
          ...
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          this = (EventCraftWithdrawConfirmDialogComponent_o *)LocalizationManager__Get(
                                                                 (System_String_o *)StringLiteral_3662/*"COMMON_COUNT_OPERATOR_CROSS"*/,
                                                                 0LL);
          if ( !v34 )
            goto LABEL_88;
  ...
  {
LABEL_88:
    sub_1BC3264(this, *(_QWORD *)&nowTradeNum);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)this, v55 != 2, 0LL);
}
