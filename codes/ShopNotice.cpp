        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF9BF2 & 1) == 0 )
  {
    sub_1C2E12C(&System_Func_bool__bool__bool__bool__ShopListNotice_ShopLimitedType__TypeInfo, listNotice);
    sub_1C2E12C(&Method_ShopListNotice_GetShopLimitedType__, v5);
    byte_4BF9BF2 = 1;
  }
  if ( listNotice )
  {
    ...
    v7 = (System_Func_T1__T2__T3__T4__TResult__o *)sub_1C2E378(System_Func_bool__bool__bool__bool__ShopListNotice_ShopLimitedType__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF9BF5 & 1) == 0 )
  {
    sub_1C2E12C(&NetworkManager_TypeInfo, timeLimit);
    byte_4BF9BF5 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    if ( (unsigned int)(type - 1) <= 3 )
      *(_QWORD *)&type = dword_C07250[type - 1];
