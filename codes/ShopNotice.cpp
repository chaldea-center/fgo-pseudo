...
void ShopNotice__CompareShopListNotice(ShopNotice_o *this, ShopListNotice_o *listNotice, const MethodInfo *method)
{
  ...
  if ( (byte_4D28A14 & 1) == 0 )
  {
    sub_1C94098(&System_Func_bool__bool__bool__bool__ShopListNotice_ShopLimitedType__TypeInfo);
    sub_1C94098(&Method_ShopListNotice_GetShopLimitedType__);
    byte_4D28A14 = 1;
  }
  if ( listNotice )
  {
    ...
    v6 = (System_Func_T1__T2__T3__T4__TResult__o *)sub_1C942E4(System_Func_bool__bool__bool__bool__ShopListNotice_ShopLimitedType__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  {
    if ( (unsigned int)(type - 1) <= 3 )
      *(_QWORD *)&type = dword_CFFD00[type - 1];
