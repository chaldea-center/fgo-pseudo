        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C15F & 1) == 0 )
  {
    sub_1B715CC(&System_Func_bool__bool__bool__bool__ShopListNotice_ShopLimitedType__TypeInfo, listNotice);
    sub_1B715CC(&Method_ShopListNotice_GetShopLimitedType__, v5);
    byte_4A1C15F = 1;
  }
  if ( listNotice )
  {
    ...
    v7 = (System_Func_T1__T2__T3__T4__TResult__o *)sub_1B71818(System_Func_bool__bool__bool__bool__ShopListNotice_ShopLimitedType__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C162 & 1) == 0 )
  {
    sub_1B715CC(&NetworkManager_TypeInfo, timeLimit);
    byte_4A1C162 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    if ( (unsigned int)(type - 1) <= 3 )
      *(_QWORD *)&type = dword_BABBA0[type - 1];
