        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B72E7 & 1) == 0 )
  {
    sub_1B4CF90(&System_Func_bool__bool__bool__bool__ShopListNotice_ShopLimitedType__TypeInfo, listNotice);
    sub_1B4CF90(&Method_ShopListNotice_GetShopLimitedType__, v5);
    byte_49B72E7 = 1;
  }
  if ( listNotice )
  {
    ...
    v7 = (System_Func_T1__T2__T3__T4__TResult__o *)sub_1B4D1DC(System_Func_bool__bool__bool__bool__ShopListNotice_ShopLimitedType__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B72EA & 1) == 0 )
  {
    sub_1B4CF90(&NetworkManager_TypeInfo, timeLimit);
    byte_49B72EA = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    if ( (unsigned int)(type - 1) <= 3 )
      *(_QWORD *)&type = dword_BAB030[type - 1];
