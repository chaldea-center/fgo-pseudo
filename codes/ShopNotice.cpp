        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B630A9 & 1) == 0 )
  {
    sub_1BE4ACC(&System_Func_bool__bool__bool__bool__ShopListNotice_ShopLimitedType__TypeInfo, listNotice);
    sub_1BE4ACC(&Method_ShopListNotice_GetShopLimitedType__, v5);
    byte_4B630A9 = 1;
  }
  if ( listNotice )
  {
    ...
    v7 = (System_Func_T1__T2__T3__T4__TResult__o *)sub_1BE4D18(System_Func_bool__bool__bool__bool__ShopListNotice_ShopLimitedType__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B630AC & 1) == 0 )
  {
    sub_1BE4ACC(&NetworkManager_TypeInfo, timeLimit);
    byte_4B630AC = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    if ( (unsigned int)(type - 1) <= 3 )
      *(_QWORD *)&type = dword_BE2E00[type - 1];
