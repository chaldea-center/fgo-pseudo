        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD8A0C & 1) == 0 )
  {
    sub_1C21E38(&System_Func_bool__bool__bool__bool__ShopListNotice_ShopLimitedType__TypeInfo);
    sub_1C21E38(&Method_ShopListNotice_GetShopLimitedType__);
    byte_4BD8A0C = 1;
  }
  if ( listNotice )
  {
    ...
    v6 = (System_Func_T1__T2__T3__T4__TResult__o *)sub_1C22084(System_Func_bool__bool__bool__bool__ShopListNotice_ShopLimitedType__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  {
    if ( (unsigned int)(type - 1) <= 3 )
      *(_QWORD *)&type = dword_BFF1D0[type - 1];
