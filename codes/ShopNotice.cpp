        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E3F5 & 1) == 0 )
  {
    sub_1C3B764(&System_Func_bool__bool__bool__bool__ShopListNotice_ShopLimitedType__TypeInfo, listNotice);
    sub_1C3B764(&Method_ShopListNotice_GetShopLimitedType__, v5);
    byte_4C1E3F5 = 1;
  }
  if ( listNotice )
  {
    ...
    v7 = (System_Func_T1__T2__T3__T4__TResult__o *)sub_1C3B9B0(System_Func_bool__bool__bool__bool__ShopListNotice_ShopLimitedType__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E3F8 & 1) == 0 )
  {
    sub_1C3B764(&NetworkManager_TypeInfo, timeLimit);
    byte_4C1E3F8 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    if ( (unsigned int)(type - 1) <= 3 )
      *(_QWORD *)&type = dword_C0E5E0[type - 1];
