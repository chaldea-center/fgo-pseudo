...
void ShopNotice__CompareShopListNotice(ShopNotice_o *this, ShopListNotice_o *listNotice, const MethodInfo *method)
{
  ...
  if ( (byte_4C2359A & 1) == 0 )
  {
    sub_1C2D490(&System_Func_bool__bool__bool__bool__ShopListNotice_ShopLimitedType__TypeInfo);
    sub_1C2D490(&Method_ShopListNotice_GetShopLimitedType__);
    byte_4C2359A = 1;
  }
  if ( listNotice )
  {
    ...
    v6 = (System_Func_T1__T2__T3__T4__TResult__o *)sub_1C2D6DC(System_Func_bool__bool__bool__bool__ShopListNotice_ShopLimitedType__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  {
    if ( (unsigned int)(type - 1) <= 3 )
      *(_QWORD *)&type = dword_C0A7D0[type - 1];
