        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B336D6 & 1) == 0 )
  {
    sub_1BD3458(&System_Func_bool__bool__bool__bool__ShopListNotice_ShopLimitedType__TypeInfo, listNotice);
    sub_1BD3458(&Method_ShopListNotice_GetShopLimitedType__, v5);
    byte_4B336D6 = 1;
  }
  if ( listNotice )
  {
    ...
    v7 = (System_Func_T1__T2__T3__T4__TResult__o *)sub_1BD36A4(System_Func_bool__bool__bool__bool__ShopListNotice_ShopLimitedType__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B336D9 & 1) == 0 )
  {
    sub_1BD3458(&NetworkManager_TypeInfo, timeLimit);
    byte_4B336D9 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    if ( (unsigned int)(type - 1) <= 3 )
      *(_QWORD *)&type = dword_BD8CD0[type - 1];
