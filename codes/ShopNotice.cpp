        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC3F7D & 1) == 0 )
  {
    sub_1C1ABD4(&System_Func_bool__bool__bool__bool__ShopListNotice_ShopLimitedType__TypeInfo, listNotice);
    sub_1C1ABD4(&Method_ShopListNotice_GetShopLimitedType__, v5);
    byte_4BC3F7D = 1;
  }
  if ( listNotice )
  {
    ...
    v7 = (System_Func_T1__T2__T3__T4__TResult__o *)sub_1C1AE20(System_Func_bool__bool__bool__bool__ShopListNotice_ShopLimitedType__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC3F80 & 1) == 0 )
  {
    sub_1C1ABD4(&NetworkManager_TypeInfo, timeLimit);
    byte_4BC3F80 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    if ( (unsigned int)(type - 1) <= 3 )
      *(_QWORD *)&type = dword_BFB2B0[type - 1];
