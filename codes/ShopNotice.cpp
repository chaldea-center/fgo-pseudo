        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FABF1 & 1) == 0 )
  {
    sub_1B64870(&System_Func_bool__bool__bool__bool__ShopListNotice_ShopLimitedType__TypeInfo, listNotice);
    sub_1B64870(&Method_ShopListNotice_GetShopLimitedType__, v5);
    byte_49FABF1 = 1;
  }
  if ( listNotice )
  {
    ...
    v7 = (System_Func_T1__T2__T3__T4__TResult__o *)sub_1B64ABC(System_Func_bool__bool__bool__bool__ShopListNotice_ShopLimitedType__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FABF4 & 1) == 0 )
  {
    sub_1B64870(&NetworkManager_TypeInfo, timeLimit);
    byte_49FABF4 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    if ( (unsigned int)(type - 1) <= 3 )
      *(_QWORD *)&type = dword_BA4250[type - 1];
