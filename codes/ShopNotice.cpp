        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F8B02 & 1) == 0 )
  {
    sub_1B640C8(&System_Func_bool__bool__bool__bool__ShopListNotice_ShopLimitedType__TypeInfo, listNotice);
    sub_1B640C8(&Method_ShopListNotice_GetShopLimitedType__, v5);
    byte_49F8B02 = 1;
  }
  if ( listNotice )
  {
    ...
    v7 = (System_Func_T1__T2__T3__T4__TResult__o *)sub_1B64314(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F8B05 & 1) == 0 )
  {
    sub_1B640C8(&NetworkManager_TypeInfo, timeLimit);
    byte_49F8B05 = 1;
  }
