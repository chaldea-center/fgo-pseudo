        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B40DEA & 1) == 0 )
  {
    sub_1BDB878(&System_Func_bool__bool__bool__bool__ShopListNotice_ShopLimitedType__TypeInfo, listNotice);
    sub_1BDB878(&Method_ShopListNotice_GetShopLimitedType__, v5);
    byte_4B40DEA = 1;
  }
  if ( listNotice )
  {
    ...
    v7 = (System_Func_T1__T2__T3__T4__TResult__o *)sub_1BDBAC4(System_Func_bool__bool__bool__bool__ShopListNotice_ShopLimitedType__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B40DED & 1) == 0 )
  {
    sub_1BDB878(&NetworkManager_TypeInfo, timeLimit);
    byte_4B40DED = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    if ( (unsigned int)(type - 1) <= 3 )
      *(_QWORD *)&type = dword_BEBCB0[type - 1];
