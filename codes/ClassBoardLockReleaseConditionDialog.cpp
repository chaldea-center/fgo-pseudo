        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4189510 & 1) == 0 )
  {
    ...
    sub_B2C35C(&Method_ClassBoardLockReleaseConditionDialog_EndClose__, v3);
    sub_B2C35C(&Method_ClassBoardLockReleaseConditionDialog_OnClickClose__, v4);
    byte_4189510 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_ClassBoardLockReleaseConditionDialog_OnClickClose__ + 75) & 2) != 0 )
      v5 = (_QWORD *)sub_B2C364(Method_ClassBoardLockReleaseConditionDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_418950E & 1) == 0 )
  {
    ...
    sub_B2C35C(&ClassBoardLockModel_TypeInfo, v12);
    sub_B2C35C(&Method_ClassBoardLockReleaseConditionDialog_EndOpen__, v13);
    sub_B2C35C(&IClassBoardSquareModel_TypeInfo, v14);
    sub_B2C35C(&LocalizationManager_TypeInfo, v15);
    sub_B2C35C(&StringLiteral_3023/*"CLASS_BOARD_LOCK_RELEASE_CONDITION_DIALOG_TITLE"*/, v16);
    sub_B2C35C(&StringLiteral_3022/*"CLASS_BOARD_LOCK_RELEASE_CONDITION_DIALOG_EXPLANATION_BEFORE"*/, v17);
    sub_B2C35C(&StringLiteral_3020/*"CLASS_BOARD_LOCK_RELEASE_CONDITION_DIALOG_DECIDE"*/, v18);
    sub_B2C35C(&StringLiteral_3021/*"CLASS_BOARD_LOCK_RELEASE_CONDITION_DIALOG_EXPLANATION_AFTER"*/, v19);
    byte_418950E = 1;
  }
  ...
  if ( SquareModel_k__BackingField
    && (v29 = *(&ClassBoardLockModel_TypeInfo->_2.bitflags2 + 1),
        *(&SquareModel_k__BackingField->klass->_2.bitflags2 + 1) >= (unsigned int)v29) )
  {
    if ( (ClassBoardLockModel_c *)SquareModel_k__BackingField->klass->_2.typeHierarchy[v29 - 1] == ClassBoardLockModel_TypeInfo )
  ...
  v20 = LocalizationManager__Get((System_String_o *)StringLiteral_3023/*"CLASS_BOARD_LOCK_RELEASE_CONDITION_DIALOG_TITLE"*/, 0LL);
  if ( !titleLabel )
    goto LABEL_37;
  ...
  *((_QWORD *)&v32 + 1) = v32;
  ...
  if ( *(_WORD *)&SquareModel_k__BackingField->klass->_2.bitflags1 )
  {
    ...
    while ( *(p_offset - 1) != IClassBoardSquareModel_TypeInfo )
    {
      ++v36;
      p_offset += 2;
      if ( v36 >= *(unsigned __int16 *)&SquareModel_k__BackingField->klass->_2.bitflags1 )
        goto LABEL_20;
    }
  ...
  {
LABEL_20:
    p_method = sub_AC5258(SquareModel_k__BackingField, IClassBoardSquareModel_TypeInfo, 6LL, v34);
  }
  ...
  if ( isOpened )
  {
    ...
    v41 = &StringLiteral_3021/*"CLASS_BOARD_LOCK_RELEASE_CONDITION_DIALOG_EXPLANATION_AFTER"*/;
  }
  else
  {
    if ( (WORD1(LocalizationManager_TypeInfo->vtable._0_Equals.methodPtr) & 0x400) != 0
    ...
    v41 = &StringLiteral_3022/*"CLASS_BOARD_LOCK_RELEASE_CONDITION_DIALOG_EXPLANATION_BEFORE"*/;
  }
  ...
  v20 = LocalizationManager__Get((System_String_o *)StringLiteral_3020/*"CLASS_BOARD_LOCK_RELEASE_CONDITION_DIALOG_DECIDE"*/, 0LL);
  if ( !closeBtnLabel )
LABEL_37:
    sub_B2C434(v20, v21);
