        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_593C4A0 & 1) == 0 )
  {
    ...
    sub_21FFC50(&Method_ClassBoardLockReleaseConditionDialog_EndClose__);
    sub_21FFC50(&Method_ClassBoardLockReleaseConditionDialog_OnClickClose__);
    byte_593C4A0 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_ClassBoardLockReleaseConditionDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_21FFC68(Method_ClassBoardLockReleaseConditionDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_21FFC50(&System_Action_TypeInfo);
    sub_21FFC50(&Method_ClassBoardLockReleaseConditionDialog__OnClickItemInfoListWindow_b__11_0__);
    byte_593C4A1 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_593C49E & 1) == 0 )
  {
    ...
    sub_21FFC50(&Method_ClassBoardLockReleaseConditionDialog_EndOpen__);
    sub_21FFC50(&IClassBoardSquareModel_TypeInfo);
    sub_21FFC50(&LocalizationManager_TypeInfo);
    sub_21FFC50(&StringLiteral_3542/*"CLASS_BOARD_LOCK_RELEASE_CONDITION_DIALOG_TITLE"*/);
    sub_21FFC50(&StringLiteral_3541/*"CLASS_BOARD_LOCK_RELEASE_CONDITION_DIALOG_EXPLANATION_BEFORE"*/);
    sub_21FFC50(&StringLiteral_3539/*"CLASS_BOARD_LOCK_RELEASE_CONDITION_DIALOG_DECIDE"*/);
    sub_21FFC50(&StringLiteral_3540/*"CLASS_BOARD_LOCK_RELEASE_CONDITION_DIALOG_EXPLANATION_AFTER"*/);
    byte_593C49E = 1;
  }
  ...
  v12 = LocalizationManager__Get((System_String_o *)StringLiteral_3542/*"CLASS_BOARD_LOCK_RELEASE_CONDITION_DIALOG_TITLE"*/, 0);
  if ( !titleLabel )
    goto LABEL_33;
  ...
  *((_QWORD *)&v25 + 1) = v25;
  ...
  {
LABEL_19:
    v30 = sub_2237E2C(SquareModel_k__BackingField, IClassBoardSquareModel_TypeInfo, 6);
  }
  ...
  if ( isOpened )
  {
    ...
    v35 = &StringLiteral_3540/*"CLASS_BOARD_LOCK_RELEASE_CONDITION_DIALOG_EXPLANATION_AFTER"*/;
  }
  else
  {
    if ( !v34 )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, v32);
    v35 = &StringLiteral_3541/*"CLASS_BOARD_LOCK_RELEASE_CONDITION_DIALOG_EXPLANATION_BEFORE"*/;
  }
  ...
  v12 = LocalizationManager__Get((System_String_o *)StringLiteral_3539/*"CLASS_BOARD_LOCK_RELEASE_CONDITION_DIALOG_DECIDE"*/, 0);
  if ( !closeBtnLabel )
LABEL_33:
    sub_21FFECC(v12, v13);
