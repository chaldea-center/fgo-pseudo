        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C5ACCB & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_CommandCardExceedResultWindowComponent_SetCommandCardExceedInfo__);
  ...
  if ( (*((_BYTE *)Method_CommandCardExceedResultWindowComponent_SetCommandCardExceedInfo__ + 83) & 2) != 0 )
    v13 = (_QWORD *)sub_1C3E57C(Method_CommandCardExceedResultWindowComponent_SetCommandCardExceedInfo__);
  ...
  if ( useServantId <= 0 )
  {
    ...
    *(_QWORD *)&v50.fields.fakeValue = v17;
    useServantId = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49004136(v50, 0);
  }
  ...
  *(_QWORD *)&v51.fields.fakeValue = v26;
  ...
  UserServantCommandCardMaster__TryGetEntity(
    ...
    (int)Instance,
    0);
  v28 = (CommandCardExceedResultWindowComponent_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49004136(
...
LABEL_58:
  ...
  v36 = (BattleCommandData_o *)sub_1C3E7B0(BattleCommandData_TypeInfo);
  BattleCommandData___ctor_46651164(v36, v35, useServantId, ServantImageLimitSealAfter, 0, cardIndex, 0);
  v37 = (BattleCommandData_o *)sub_1C3E7B0(BattleCommandData_TypeInfo);
  BattleCommandData___ctor_46651164(v37, v35, useServantId, ServantImageLimitSealAfter, 0, cardIndex, 0);
  if ( !v36 )
    goto LABEL_57;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C5ACCC & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_3624/*"COMMAND_CARD_EXCEED_CONFIRM_DIALOG_EXCEED_PREVIOUS"*/);
    byte_4C5ACCC = 1;
  }
  ...
  v13 = System_String__Format_63677760(v10, NumberFormat, v12, 0);
  if ( !previousStatusLabel
    || (UILabel__set_text(previousStatusLabel, v13, 0),
        afterStatusLabel = this->fields.afterStatusLabel,
        v16 = LocalizationManager__Get((System_String_o *)StringLiteral_3623/*"COMMAND_CARD_EXCEED_CONFIRM_DIALOG_EXCEED_AFTER"*/, 0),
        ...
        v13 = System_String__Format_63677760(v16, v17, v18, 0),
        !afterStatusLabel) )
  {
    sub_1C3E7C0(v13, v14);
  }
