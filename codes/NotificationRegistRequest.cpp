        ...
        const MethodInfo *method)
{
  if ( (byte_40F937C & 1) == 0 )
  {
    sub_B16FFC(&StringLiteral_21655, key);
    byte_40F937C = 1;
  }
  RequestBase__addField_30957164((RequestBase_o *)this, (System_String_o *)StringLiteral_21655, key, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40F937A & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_21060, v2);
    byte_40F937A = 1;
  }
  ...
  return System_String__Concat_43743732(BaseUrl, (System_String_o *)StringLiteral_21060, 0LL);
}