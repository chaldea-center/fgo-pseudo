void __fastcall ServantStatusListViewItemDrawClassSkill___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BC4A36 & 1) == 0 )
  {
    sub_1C1ABD4(&ServantStatusListViewItemDrawClassSkill_TypeInfo, v1);
    byte_4BC4A36 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC4A34 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&ServantStatusListViewItemDrawClassSkill_TypeInfo, v8);
  ...
  transformNameSprite = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                      (System_String_o *)StringLiteral_12088/*"SERVANT_STATUS_EXPLANATION_SKILL_PASSIVE"*/,
                                                      0LL);
  if ( !explanationLabel )
    goto LABEL_95;
  ...
  else
  {
    ...
    do
    {
      ...
      else
      {
        if ( v16 >= max_length )
LABEL_97:
          sub_1C1AE38(transformNameSprite, v12);
  ...
  {
LABEL_95:
    sub_1C1AE30(transformNameSprite, v12);
  }
