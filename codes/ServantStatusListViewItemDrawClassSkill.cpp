void ServantStatusListViewItemDrawClassSkill___cctor(const MethodInfo *method)
{
  if ( (byte_4E01A8F & 1) == 0 )
  {
    sub_1CE6700(&ServantStatusListViewItemDrawClassSkill_TypeInfo);
    byte_4E01A8F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12056/*"SERVANT_STATUS_EXPLANATION_SKILL_PASSIVE"*/, 0);
  if ( !explanationLabel )
    goto LABEL_100;
...
LABEL_102:
    ...
    && !ServantStatusListViewItem__get_TransformIsNotClassSkillChange(item, 0) )
  {
    ...
    v20 = this->fields.transformNameLabel;
  ...
  if ( UnityEngine_Object__op_Inequality(baseCollider, 0, 0) )
  {
    ...
    v63.fields.y = v39;
    v63.fields.z = z;
    UnityEngine_BoxCollider__set_size((UnityEngine_BoxCollider_o *)gameObject, v63, 0);
  }
  gameObject = (UnityEngine_GameObject_o *)this->fields.baseSprite;
  if ( !gameObject )
    goto LABEL_100;
  v40 = x == INFINITY ? 0x80000000 : (int)x;
  UIWidget__set_width((UIWidget_o *)gameObject, v40, 0);
  gameObject = (UnityEngine_GameObject_o *)this->fields.baseSprite;
  if ( !gameObject )
    goto LABEL_100;
  v41 = v39 == INFINITY ? 0x80000000 : (int)v39;
  UIWidget__set_height((UIWidget_o *)gameObject, v41, 0);
  ...
  if ( !gameObject
    || (v46 = v42 >> 1,
        ...
        v64.fields.x = v43,
        v64.fields.z = v45,
        UnityEngine_Transform__set_localPosition((UnityEngine_Transform_o *)gameObject, v64, 0),
...
LABEL_100:
  ...
  v50 = 0;
  v51 = this->fields.skillBasePosition.fields.y + (float)(v46 + v16);
  while ( 1 )
  {
    v52 = v47->max_length;
    if ( (int)v50 >= (int)v52 )
    ...
    else
    {
      ...
      if ( v50 >= LODWORD(idList->max_length) )
        goto LABEL_102;
      gameObject = (UnityEngine_GameObject_o *)v54->m_Items[v50];
      if ( !gameObject )
        goto LABEL_100;
      SkillIconComponent__Set((SkillIconComponent_o *)gameObject, idList->m_Items[v50], 0);
      ...
      if ( v50 >= LODWORD(titleList->max_length) )
        goto LABEL_102;
      gameObject = (UnityEngine_GameObject_o *)skillTitleRangeLabelList->m_Items[v50];
      if ( !gameObject )
        goto LABEL_100;
      UIRangeLabel__Set((UIRangeLabel_o *)gameObject, titleList->m_Items[v50], 0, 1, 0, 0, 0);
    }
    ...
    if ( v57 )
    {
      ...
      v59 = *(_DWORD *)(gameObject[7].fields.m_CachedPtr + 4) + mHeight;
