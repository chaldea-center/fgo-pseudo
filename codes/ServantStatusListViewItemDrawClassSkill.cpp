void __fastcall ServantStatusListViewItemDrawClassSkill___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49B7C2E & 1) == 0 )
  {
    sub_1B4CF90(&ServantStatusListViewItemDrawClassSkill_TypeInfo, v1);
    byte_49B7C2E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B7C2C & 1) == 0 )
  {
    ...
    sub_1B4CF90(&ServantStatusListViewItemDrawClassSkill_TypeInfo, v8);
  ...
  transformNameSprite = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                      (System_String_o *)StringLiteral_11663/*"SERVANT_STATUS_EXPLANATION_SKILL_PASSIVE"*/,
                                                      0LL);
  if ( !explanationLabel )
    goto LABEL_95;
  ...
  else
  {
    ...
    do
    {
      ...
      else
      {
        if ( v16 >= max_length )
LABEL_97:
          sub_1B4D1F4(transformNameSprite, v12);
  ...
  {
LABEL_95:
    sub_1B4D1EC(transformNameSprite, v12);
  }
