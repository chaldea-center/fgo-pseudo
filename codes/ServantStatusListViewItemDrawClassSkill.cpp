void ServantStatusListViewItemDrawClassSkill___cctor(const MethodInfo *method)
{
  if ( (byte_4E745FD & 1) == 0 )
  {
    sub_1D0F0B4(&ServantStatusListViewItemDrawClassSkill_TypeInfo);
    byte_4E745FD = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12105/*"SERVANT_STATUS_EXPLANATION_SKILL_PASSIVE"*/, 0);
  if ( !explanationLabel )
    goto LABEL_100;
