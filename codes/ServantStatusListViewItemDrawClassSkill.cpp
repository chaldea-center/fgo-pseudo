void __fastcall ServantStatusListViewItemDrawClassSkill___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49F9268 & 1) == 0 )
  {
    sub_1B640C8(&ServantStatusListViewItemDrawClassSkill_TypeInfo, v1);
    byte_49F9268 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F9266 & 1) == 0 )
  {
    ...
    sub_1B640C8(&ServantStatusListViewItemDrawClassSkill_TypeInfo, v8);
  ...
  transformNameSprite = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                      (System_String_o *)StringLiteral_11824/*"SERVANT_STATUS_EXPLANATION_SKILL_PASSIVE"*/,
                                                      0LL);
  if ( !explanationLabel )
    goto LABEL_95;
  ...
  else
  {
    ...
    do
    {
      ...
      else
      {
        if ( v16 >= max_length )
LABEL_97:
          sub_1B6432C(transformNameSprite, v12);
