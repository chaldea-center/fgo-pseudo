void __fastcall ServantStatusListViewItemDrawClassSkill___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48DF99A & 1) == 0 )
  {
    sub_1B00CCC(&ServantStatusListViewItemDrawClassSkill_TypeInfo, v1);
    byte_48DF99A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DF998 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&ServantStatusListViewItemDrawClassSkill_TypeInfo, v8);
  ...
  transformNameSprite = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                      (System_String_o *)StringLiteral_11688/*"SERVANT_STATUS_EXPLANATION_SKILL_PASSIVE"*/,
                                                      0LL);
  if ( !explanationLabel )
    goto LABEL_95;
  ...
  else
  {
    ...
    do
    {
      ...
      else
      {
        if ( v16 >= max_length )
LABEL_97:
          sub_1B00F30(transformNameSprite, v12);
  ...
  {
LABEL_95:
    sub_1B00F28(transformNameSprite, v12);
  }
