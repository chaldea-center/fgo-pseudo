void __fastcall ServantStatusListViewItemDrawClassSkill___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A059F3 & 1) == 0 )
  {
    sub_1B686D4(&ServantStatusListViewItemDrawClassSkill_TypeInfo, v1);
    byte_4A059F3 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A059F1 & 1) == 0 )
  {
    ...
    sub_1B686D4(&ServantStatusListViewItemDrawClassSkill_TypeInfo, v8);
  ...
  else
  {
    ...
    do
    {
      ...
      else
      {
        if ( v16 >= max_length )
LABEL_97:
          sub_1B68938(transformNameSprite, v12);
  ...
  {
LABEL_95:
    sub_1B68930(transformNameSprite, v12);
  }
