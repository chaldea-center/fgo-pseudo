void __fastcall ServantStatusListViewItemDrawClassSkill___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A1C851 & 1) == 0 )
  {
    sub_1B715CC(&ServantStatusListViewItemDrawClassSkill_TypeInfo, v1);
    byte_4A1C851 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C84F & 1) == 0 )
  {
    ...
    sub_1B715CC(&ServantStatusListViewItemDrawClassSkill_TypeInfo, v8);
  ...
  transformNameSprite = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                      (System_String_o *)StringLiteral_11838/*"SERVANT_STATUS_EXPLANATION_SKILL_PASSIVE"*/,
                                                      0LL);
  if ( !explanationLabel )
    goto LABEL_95;
  ...
  else
  {
    ...
    do
    {
      ...
      else
      {
        if ( v16 >= max_length )
LABEL_97:
          sub_1B71830(transformNameSprite, v12);
  ...
  {
LABEL_95:
    sub_1B71828(transformNameSprite, v12);
  }
