void __fastcall ServantStatusListViewItemDrawClassSkill___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FB977 & 1) == 0 )
  {
    sub_1B64A00(&ServantStatusListViewItemDrawClassSkill_TypeInfo, v1);
    byte_49FB977 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB975 & 1) == 0 )
  {
    ...
    sub_1B64A00(&ServantStatusListViewItemDrawClassSkill_TypeInfo, v8);
  ...
  transformNameSprite = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                      (System_String_o *)StringLiteral_11828/*"SERVANT_STATUS_EXPLANATION_SKILL_PASSIVE"*/,
                                                      0LL);
  if ( !explanationLabel )
    goto LABEL_95;
  ...
  else
  {
    ...
    do
    {
      ...
      else
      {
        if ( v16 >= max_length )
LABEL_97:
          sub_1B64C64(transformNameSprite, v12);
  ...
  {
LABEL_95:
    sub_1B64C5C(transformNameSprite, v12);
  }
