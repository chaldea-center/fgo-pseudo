void __fastcall ServantStatusListViewItemDrawClassSkill___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BB167B & 1) == 0 )
  {
    sub_1C13D24(&ServantStatusListViewItemDrawClassSkill_TypeInfo, v1);
    byte_4BB167B = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB1679 & 1) == 0 )
  {
    ...
    sub_1C13D24(&ServantStatusListViewItemDrawClassSkill_TypeInfo, v8);
  ...
  transformNameSprite = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                      (System_String_o *)StringLiteral_12076/*"SERVANT_STATUS_EXPLANATION_FACE3"*/,
                                                      0LL);
  if ( !explanationLabel )
    goto LABEL_95;
  ...
  else
  {
    ...
    do
    {
      ...
      else
      {
        if ( v16 >= max_length )
LABEL_97:
          sub_1C13F88(transformNameSprite, v12);
  ...
  {
LABEL_95:
    sub_1C13F80(transformNameSprite, v12);
  }
