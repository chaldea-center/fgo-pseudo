void __fastcall ServantStatusListViewItemDrawClassSkill___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BFA6AF & 1) == 0 )
  {
    sub_1C2E12C(&ServantStatusListViewItemDrawClassSkill_TypeInfo, v1);
    byte_4BFA6AF = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFA6AD & 1) == 0 )
  {
    ...
    sub_1C2E12C(&ServantStatusListViewItemDrawClassSkill_TypeInfo, v8);
  ...
  transformNameSprite = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                      (System_String_o *)StringLiteral_12107/*"SERVANT_STATUS_EXPLANATION_SKILL_PASSIVE"*/,
                                                      0LL);
  if ( !explanationLabel )
    goto LABEL_95;
  ...
  else
  {
    ...
    do
    {
      ...
      else
      {
        if ( v16 >= max_length )
LABEL_97:
          sub_1C2E390(transformNameSprite, v12);
  ...
  {
LABEL_95:
    sub_1C2E388(transformNameSprite, v12);
  }
