void __fastcall ServantStatusListViewItemDrawClassSkill___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C1EE04 & 1) == 0 )
  {
    sub_1C3B764(&ServantStatusListViewItemDrawClassSkill_TypeInfo, v1);
    byte_4C1EE04 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1EE02 & 1) == 0 )
  {
    ...
    sub_1C3B764(&ServantStatusListViewItemDrawClassSkill_TypeInfo, v8);
  ...
  transformNameSprite = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                      (System_String_o *)StringLiteral_12130/*"SUMMON_LIST_DIALOG_SUMMONED_TEXT"*/,
                                                      0LL);
  if ( !explanationLabel )
    goto LABEL_95;
  ...
  else
  {
    ...
    do
    {
      ...
      else
      {
        if ( v16 >= max_length )
LABEL_97:
          sub_1C3B9C8(transformNameSprite, v12);
  ...
  {
LABEL_95:
    sub_1C3B9C0(transformNameSprite, v12);
  }
