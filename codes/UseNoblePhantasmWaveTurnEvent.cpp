void __fastcall UseNoblePhantasmWaveTurnEvent___ctor_44956180(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5150A & 1) == 0 )
  {
    saveData = (ServantWaveTurnEvent_SaveData_o *)sub_1B863B8(&UseNoblePhantasmWaveTurnEvent_TypeInfo, method);
    byte_4A5150A = 1;
  }
  if ( !v2 )
    sub_1B86614(saveData, method);
  v3 = *(Il2CppClass **)&v2->fields.Wave;
  v4 = (Il2CppObject *)sub_1B86604(UseNoblePhantasmWaveTurnEvent_TypeInfo);
