void __fastcall UseNoblePhantasmWaveTurnEvent___ctor_45857468(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47B69 & 1) == 0 )
  {
    saveData = (ServantWaveTurnEvent_SaveData_o *)sub_1BDB878(&UseNoblePhantasmWaveTurnEvent_TypeInfo, method);
    byte_4B47B69 = 1;
  }
  if ( !v2 )
    sub_1BDBAD4(saveData, method);
  v3 = *(Il2CppClass **)&v2->fields.Wave;
  v4 = (Il2CppObject *)sub_1BDBAC4(UseNoblePhantasmWaveTurnEvent_TypeInfo);
