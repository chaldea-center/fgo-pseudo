void __fastcall UseNoblePhantasmWaveTurnEvent___ctor_44465084(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BDE12 & 1) == 0 )
  {
    saveData = (ServantWaveTurnEvent_SaveData_o *)sub_1B4CF90(&UseNoblePhantasmWaveTurnEvent_TypeInfo, method);
    byte_49BDE12 = 1;
  }
  if ( !v2 )
    sub_1B4D1EC(saveData, method);
  v3 = *(Il2CppClass **)&v2->fields.Wave;
  v4 = (Il2CppObject *)sub_1B4D1DC(UseNoblePhantasmWaveTurnEvent_TypeInfo);
