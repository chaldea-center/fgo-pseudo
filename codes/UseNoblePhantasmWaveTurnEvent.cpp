void UseNoblePhantasmWaveTurnEvent___ctor_47795068(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF1A82 & 1) == 0 )
  {
    saveData = (ServantWaveTurnEvent_SaveData_o *)sub_1C7BAE8(&UseNoblePhantasmWaveTurnEvent_TypeInfo);
    byte_4CF1A82 = 1;
  }
  if ( !v2 )
    sub_1C7BD40(saveData, method);
  v3 = *(Il2CppClass **)&v2->fields.Wave;
  v4 = (Il2CppObject *)sub_1C7BD34(UseNoblePhantasmWaveTurnEvent_TypeInfo);
