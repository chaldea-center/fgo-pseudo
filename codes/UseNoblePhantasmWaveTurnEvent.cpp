void __fastcall UseNoblePhantasmWaveTurnEvent___ctor_44877284(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB74D0 & 1) == 0 )
  {
    saveData = (ServantWaveTurnEvent_SaveData_o *)sub_1C13D24(&UseNoblePhantasmWaveTurnEvent_TypeInfo, method);
    byte_4BB74D0 = 1;
  }
  if ( !v2 )
    sub_1C13F80(saveData, method);
  v3 = *(Il2CppClass **)&v2->fields.Wave;
  v4 = (Il2CppObject *)sub_1C13F70(UseNoblePhantasmWaveTurnEvent_TypeInfo);
