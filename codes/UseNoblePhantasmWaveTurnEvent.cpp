void __fastcall UseNoblePhantasmWaveTurnEvent___ctor_46007824(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1F5BB & 1) == 0 )
  {
    saveData = (ServantWaveTurnEvent_SaveData_o *)sub_1BCAFF8(&UseNoblePhantasmWaveTurnEvent_TypeInfo, method);
    byte_4B1F5BB = 1;
  }
  if ( !v2 )
    sub_1BCB254(saveData, method);
  v3 = *(Il2CppClass **)&v2->fields.Wave;
  v4 = (Il2CppObject *)sub_1BCB244(UseNoblePhantasmWaveTurnEvent_TypeInfo);
