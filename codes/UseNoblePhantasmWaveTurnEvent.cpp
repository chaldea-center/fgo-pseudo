void __fastcall UseNoblePhantasmWaveTurnEvent___ctor_45820012(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B0507D & 1) == 0 )
  {
    saveData = (ServantWaveTurnEvent_SaveData_o *)sub_1BC3008(&UseNoblePhantasmWaveTurnEvent_TypeInfo, method);
    byte_4B0507D = 1;
  }
  if ( !v2 )
    sub_1BC3264(saveData, method);
  v3 = *(Il2CppClass **)&v2->fields.Wave;
  v4 = (Il2CppObject *)sub_1BC3254(UseNoblePhantasmWaveTurnEvent_TypeInfo);
