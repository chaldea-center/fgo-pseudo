        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E65DE & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_22264/*"portrait_unknown"*/, v6);
    this = (EventHeelPortraitListViewItemDraw_o *)sub_1B00CCC(&StringLiteral_19858/*"icon_common_new01"*/, v7);
    byte_48E65DE = 1;
  }
  if ( !item )
    goto LABEL_21;
  if ( item->fields._isHavePortrait_k__BackingField )
  {
    ...
    this = (EventHeelPortraitListViewItemDraw_o *)System_Convert__ToString_60991188(imageId, 0LL);
    v10 = this;
  }
  else
  {
    v10 = (EventHeelPortraitListViewItemDraw_o *)StringLiteral_22264/*"portrait_unknown"*/;
  }
...
LABEL_21:
  ...
  AtlasManager__SetEventUI_36656832(eventId, heelPortraitSprite, (System_String_o *)v10, 0LL);
  ...
  if ( !this )
    goto LABEL_21;
  ShiningIconComponent__Set_37018564((ShiningIconComponent_o *)this, (System_String_o *)StringLiteral_19858/*"icon_common_new01"*/, 0LL);
  this = (EventHeelPortraitListViewItemDraw_o *)v4->fields.newImgSprite;
  if ( !this )
    goto LABEL_21;
