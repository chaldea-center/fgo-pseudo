        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F158 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_22756/*"portrait_unknown"*/, v6);
    this = (EventHeelPortraitListViewItemDraw_o *)sub_1BDB878(&StringLiteral_20192/*"icon_common_new01"*/, v7);
    byte_4B3F158 = 1;
  }
  if ( !item )
    goto LABEL_21;
  if ( item->fields._isHavePortrait_k__BackingField )
  {
    ...
    this = (EventHeelPortraitListViewItemDraw_o *)System_Convert__ToString_63654128(imageId, 0LL);
    v10 = this;
  }
  else
  {
    v10 = (EventHeelPortraitListViewItemDraw_o *)StringLiteral_22756/*"portrait_unknown"*/;
  }
...
LABEL_21:
  ...
  AtlasManager__SetEventUI_39626228(eventId, heelPortraitSprite, (System_String_o *)v10, 0LL);
  ...
  if ( !this )
    goto LABEL_21;
  ShiningIconComponent__Set_40030004((ShiningIconComponent_o *)this, (System_String_o *)StringLiteral_20192/*"icon_common_new01"*/, 0LL);
  this = (EventHeelPortraitListViewItemDraw_o *)v4->fields.newImgSprite;
  if ( !this )
    goto LABEL_21;
