        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C512B0 & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_22757/*"portrait_unknown"*/);
    this = (EventHeelPortraitListViewItemDraw_o *)sub_1C3E564(&StringLiteral_20192/*"icon_common_new01"*/);
    byte_4C512B0 = 1;
  }
  if ( !item )
    goto LABEL_21;
  if ( item->fields._isHavePortrait_k__BackingField )
  {
    ...
    this = (EventHeelPortraitListViewItemDraw_o *)System_Convert__ToString_64732376(imageId, 0);
    v7 = this;
  }
  else
  {
    v7 = (EventHeelPortraitListViewItemDraw_o *)StringLiteral_22757/*"portrait_unknown"*/;
  }
...
LABEL_21:
  ...
  AtlasManager__SetEventUI_40653244(eventId, heelPortraitSprite, (System_String_o *)v7, 0);
  ...
  if ( !this )
    goto LABEL_21;
  ShiningIconComponent__Set_41065492((ShiningIconComponent_o *)this, (System_String_o *)StringLiteral_20192/*"icon_common_new01"*/, 0);
  this = (EventHeelPortraitListViewItemDraw_o *)v4->fields.newImgSprite;
  if ( !this )
    goto LABEL_21;
