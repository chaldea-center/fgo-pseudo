        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFEDB5 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_23097/*"portrait_unknown"*/);
    this = (EventHeelPortraitListViewItemDraw_o *)sub_1CE6700(&StringLiteral_20465/*"icon_common_new01"*/);
    byte_4DFEDB5 = 1;
  }
  if ( !item )
    goto LABEL_21;
  if ( item->fields._isHavePortrait_k__BackingField )
  {
    ...
    this = (EventHeelPortraitListViewItemDraw_o *)System_Convert__ToString_66216792(imageId, 0);
    v7 = this;
  }
  else
  {
    v7 = (EventHeelPortraitListViewItemDraw_o *)StringLiteral_23097/*"portrait_unknown"*/;
  }
...
LABEL_21:
  ...
  AtlasManager__SetEventUI_41749752(eventId, heelPortraitSprite, (System_String_o *)v7, 0);
  ...
  if ( !this )
    goto LABEL_21;
  ShiningIconComponent__Set_42247452((ShiningIconComponent_o *)this, (System_String_o *)StringLiteral_20465/*"icon_common_new01"*/, 0);
  this = (EventHeelPortraitListViewItemDraw_o *)v4->fields.newImgSprite;
  if ( !this )
    goto LABEL_21;
