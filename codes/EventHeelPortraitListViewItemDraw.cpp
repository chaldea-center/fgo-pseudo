        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC18FB & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_22845/*"portrait_unknown"*/);
    this = (EventHeelPortraitListViewItemDraw_o *)sub_1C713B0(&StringLiteral_20250/*"icon_common_new01"*/);
    byte_4CC18FB = 1;
  }
  if ( !item )
    goto LABEL_21;
  if ( item->fields._isHavePortrait_k__BackingField )
  {
    ...
    this = (EventHeelPortraitListViewItemDraw_o *)System_Convert__ToString_65125688(imageId, 0);
    v7 = this;
  }
  else
  {
    v7 = (EventHeelPortraitListViewItemDraw_o *)StringLiteral_22845/*"portrait_unknown"*/;
  }
...
LABEL_21:
  ...
  AtlasManager__SetEventUI_40880344(eventId, heelPortraitSprite, (System_String_o *)v7, 0);
  ...
  if ( !this )
    goto LABEL_21;
  ShiningIconComponent__Set_41293588((ShiningIconComponent_o *)this, (System_String_o *)StringLiteral_20250/*"icon_common_new01"*/, 0);
  this = (EventHeelPortraitListViewItemDraw_o *)v4->fields.newImgSprite;
  if ( !this )
    goto LABEL_21;
