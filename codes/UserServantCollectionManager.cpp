void __fastcall UserServantCollectionManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B174B2 & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&UserServantCollectionManager_TypeInfo, v10, v11);
    sub_1BCA7E0(&StringLiteral_6754/*"Fgo_20150511_1"*/, v12, v13);
    byte_4B174B2 = 1;
  }
  UserServantCollectionManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6754/*"Fgo_20150511_1"*/;
  sub_1BCA784(
...
void __fastcall UserServantCollectionManager__ClearSaveDataList(const MethodInfo *method)
{
  ...
  if ( (byte_4B174AB & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&UserServantCollectionManager_TypeInfo, v5, v6);
    byte_4B174AB = 1;
  }
...
void __fastcall UserServantCollectionManager__CreateContinueDeviceSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4B174A9 & 1) == 0 )
  {
    sub_1BCA7E0(&UserServantCollectionManager_TypeInfo, v1, v2);
    byte_4B174A9 = 1;
  }
  ...
  UserServantCollectionManager__ClearSaveDataList(v4);
...
void __fastcall UserServantCollectionManager__DeleteSaveData(const MethodInfo *method)
{
  ...
  if ( !UserServantCollectionManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UserServantCollectionManager_TypeInfo, v1);
  SaveFileName = UserServantCollectionManager__getSaveFileName((const MethodInfo *)v3);
...
void __fastcall UserServantCollectionManager__Initialize(const MethodInfo *method)
{
  ...
  if ( !UserServantCollectionManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UserServantCollectionManager_TypeInfo, v1);
  UserServantCollectionManager__ReadData((const MethodInfo *)v3);
}
...
bool __fastcall UserServantCollectionManager__IsNew(int32_t svtId, const MethodInfo *method)
{
  ...
  if ( (byte_4B174AD & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&UserServantCollectionManager_TypeInfo, v6, v7);
    byte_4B174AD = 1;
  }
  ...
  if ( size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      v8 = (UserServantCollectionManager_c *)v8->static_fields->oldList;
      if ( !v8 )
        break;
...
void __fastcall UserServantCollectionManager__LoginProcess(const MethodInfo *method)
{
  ...
  if ( v7->static_fields->isContinueDevice )
  {
    ...
    v11 = (const MethodInfo *)UserServantCollectionManager_TypeInfo;
    if ( !UserServantCollectionManager_TypeInfo->_2.cctor_finished )
    {
      j_il2cpp_runtime_class_init_0(UserServantCollectionManager_TypeInfo, v10);
      v11 = (const MethodInfo *)UserServantCollectionManager_TypeInfo;
    }
    *((_WORD *)v11[2].virtualMethodPointer + 4) = 1;
    UserServantCollectionManager__WriteData(v11);
  }
}
...
bool __fastcall UserServantCollectionManager__ReadData(const MethodInfo *method)
{
  ...
  __int64 v43; // x0
  UserServantCollectionManager_c *v44; // x0
  ...
  if ( (byte_4B174B0 & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&UserServantCollectionManager_TypeInfo, v9, v10);
    byte_4B174B0 = 1;
  }
  ...
  if ( !v12->static_fields->UseMock )
  {
    ...
    if ( !UserServantCollectionManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UserServantCollectionManager_TypeInfo, v1);
    SaveFileName = UserServantCollectionManager__getSaveFileName((const MethodInfo *)v14);
    if ( System_IO_File__Exists(SaveFileName, 0LL) )
    {
      v17 = UserServantCollectionManager_TypeInfo;
      if ( !UserServantCollectionManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UserServantCollectionManager_TypeInfo, v16);
      UserServantCollectionManager__ClearSaveDataList((const MethodInfo *)v17);
      ...
      else
      {
        ...
        if ( !UserServantCollectionManager_TypeInfo->_2.cctor_finished )
        {
          j_il2cpp_runtime_class_init_0(UserServantCollectionManager_TypeInfo, v29);
          v31 = UserServantCollectionManager_TypeInfo;
        }
        ...
        if ( v32 >= 1 )
        {
          do
          {
            ...
            if ( !UserServantCollectionManager_TypeInfo->_2.cctor_finished )
            {
              j_il2cpp_runtime_class_init_0(UserServantCollectionManager_TypeInfo, v33);
              v35 = UserServantCollectionManager_TypeInfo;
            }
...
LABEL_35:
    ...
    {
      v44 = UserServantCollectionManager_TypeInfo;
      if ( !UserServantCollectionManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UserServantCollectionManager_TypeInfo, v16);
      UserServantCollectionManager__ClearSaveDataList((const MethodInfo *)v44);
    }
    return 0;
  }
  return 1;
...
void __fastcall UserServantCollectionManager__SetOld(int32_t svtId, const MethodInfo *method)
{
  ...
  if ( (byte_4B174AE & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&UserServantCollectionManager_TypeInfo, v8, v9);
    byte_4B174AE = 1;
  }
  ...
  while ( 1 )
  {
    ...
    v10 = (UserServantCollectionManager_c *)static_fields->oldList;
    if ( !v10 )
      goto LABEL_19;
    if ( v13 == v12 )
      break;
...
void __fastcall UserServantCollectionManager__SetOld_41301344(System_Int32_array *svtIdList, const MethodInfo *method)
{
  __int64 v2; // x2
  __int64 v4; // x1
  __int64 v5; // x2
...
bool __fastcall UserServantCollectionManager__WriteData(const MethodInfo *method)
{
  ...
  struct UserServantCollectionManager_StaticFields *v25; // x8
  ...
  if ( (byte_4B174B1 & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&UserServantCollectionManager_TypeInfo, v11, v12);
    byte_4B174B1 = 1;
  }
  ...
  if ( !v15->static_fields->UseMock )
  {
    ...
    if ( !UserServantCollectionManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UserServantCollectionManager_TypeInfo, v1);
    SaveFileName = UserServantCollectionManager__getSaveFileName((const MethodInfo *)v16);
    ...
    if ( !UserServantCollectionManager_TypeInfo->_2.cctor_finished )
    {
      j_il2cpp_runtime_class_init_0(UserServantCollectionManager_TypeInfo, v23);
      v24 = UserServantCollectionManager_TypeInfo;
    }
    ...
    if ( size >= 1 )
    {
      for ( i = 0; i != size; ++i )
      {
        ...
        if ( !UserServantCollectionManager_TypeInfo->_2.cctor_finished )
        {
          j_il2cpp_runtime_class_init_0(UserServantCollectionManager_TypeInfo, v28);
          v30 = UserServantCollectionManager_TypeInfo;
        }
