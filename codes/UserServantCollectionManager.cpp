void UserServantCollectionManager___cctor(const MethodInfo *method)
{
  ...
  UserServantCollectionManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6678/*"Fgo_20150511_1"*/;
  sub_1C7BA8C(
    (GrandQuestFolderBoardItem_o *)UserServantCollectionManager_TypeInfo->static_fields,
...
void UserServantCollectionManager__SetOld_44166632(System_Int32_array *svtIdList, const MethodInfo *method)
{
