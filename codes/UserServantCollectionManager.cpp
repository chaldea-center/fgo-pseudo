void __fastcall UserServantCollectionManager___cctor(const MethodInfo *method)
{
  ...
  UserServantCollectionManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6634/*"Fgo_20150511_1"*/;
  sub_1B88554(
...
void __fastcall UserServantCollectionManager__SetOld_40562940(System_Int32_array *svtIdList, const MethodInfo *method)
{
  __int64 v3; // x22
  System_Collections_Generic_List_int__o *oldList; // x0
