void __fastcall UserServantCollectionManager___cctor(const MethodInfo *method)
{
  ...
  UserServantCollectionManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6795/*"Fgo_20150511_1"*/;
  sub_1C2E0D0(
...
void __fastcall UserServantCollectionManager__ClearSaveDataList(const MethodInfo *method)
{
  ...
  if ( (byte_4BFEAA8 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&UserServantCollectionManager_TypeInfo, v3);
    byte_4BFEAA8 = 1;
  }
...
void __fastcall UserServantCollectionManager__CreateContinueDeviceSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4BFEAA6 & 1) == 0 )
  {
    sub_1C2E12C(&UserServantCollectionManager_TypeInfo, v1);
    byte_4BFEAA6 = 1;
  }
...
bool __fastcall UserServantCollectionManager__IsNew(int32_t svtId, const MethodInfo *method)
{
  ...
  if ( (byte_4BFEAAA & 1) == 0 )
  {
    ...
    sub_1C2E12C(&UserServantCollectionManager_TypeInfo, v4);
    byte_4BFEAAA = 1;
  }
...
bool __fastcall UserServantCollectionManager__ReadData(const MethodInfo *method)
{
  ...
  if ( (byte_4BFEAAD & 1) == 0 )
  {
    ...
    sub_1C2E12C(&UserServantCollectionManager_TypeInfo, v5);
    byte_4BFEAAD = 1;
  }
...
void __fastcall UserServantCollectionManager__SetOld_41931804(System_Int32_array *svtIdList, const MethodInfo *method)
{
  __int64 v3; // x1
  __int64 v4; // x1
  __int64 v5; // x1
...
bool __fastcall UserServantCollectionManager__WriteData(const MethodInfo *method)
{
  ...
  if ( (byte_4BFEAAE & 1) == 0 )
  {
    ...
    sub_1C2E12C(&UserServantCollectionManager_TypeInfo, v6);
    byte_4BFEAAE = 1;
  }
