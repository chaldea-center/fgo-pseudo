void __fastcall UserServantCollectionManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A20D42 & 1) == 0 )
  {
    ...
    sub_1B715CC(&UserServantCollectionManager_TypeInfo, v5);
...
void __fastcall UserServantCollectionManager__ClearSaveDataList(const MethodInfo *method)
{
  ...
  if ( (byte_4A20D3B & 1) == 0 )
  {
    ...
    sub_1B715CC(&UserServantCollectionManager_TypeInfo, v3);
    byte_4A20D3B = 1;
  }
...
void __fastcall UserServantCollectionManager__CreateContinueDeviceSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4A20D39 & 1) == 0 )
  {
    sub_1B715CC(&UserServantCollectionManager_TypeInfo, v1);
    byte_4A20D39 = 1;
  }
...
bool __fastcall UserServantCollectionManager__IsNew(int32_t svtId, const MethodInfo *method)
{
  ...
  if ( (byte_4A20D3D & 1) == 0 )
  {
    ...
    sub_1B715CC(&UserServantCollectionManager_TypeInfo, v4);
    byte_4A20D3D = 1;
  }
...
void __fastcall UserServantCollectionManager__SetOld_40350100(System_Int32_array *svtIdList, const MethodInfo *method)
{
  __int64 v3; // x1
  __int64 v4; // x1
  __int64 v5; // x1
...
bool __fastcall UserServantCollectionManager__WriteData(const MethodInfo *method)
{
  ...
  if ( (byte_4A20D41 & 1) == 0 )
  {
    ...
    sub_1B715CC(&UserServantCollectionManager_TypeInfo, v6);
    byte_4A20D41 = 1;
  }
