void __fastcall UserServantLockManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A5C3F0 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_6633/*"Fgo_20150511"*/);
    byte_4A5C3F0 = 1;
  }
  UserServantLockManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6633/*"Fgo_20150511"*/;
  sub_1B88554(
    (ServantStatusBattleListViewItem_o *)UserServantLockManager_TypeInfo->static_fields,
    StringLiteral_6633/*"Fgo_20150511"*/,
    v1,
    v2);
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&static_fields->lockList, (int32_t)v3, v5, v6);
}
...
bool __fastcall UserServantLockManager__ReadData(const MethodInfo *method)
{
  ...
  if ( !v2->static_fields->UseMock )
  {
    ...
    if ( System_IO_File__Exists(SaveFileName, 0LL) )
    {
          ...
          do
          {
            ...
            if ( (unsigned int)size >= items->max_length )
            {
              System_Collections_Generic_List_long___AddWithResize(
                lockList,
                v16,
                *(const MethodInfo_34E5868 **)(*(_QWORD *)(v20[4] + 192LL) + 112LL));
            }
            else
            {
      ...
      klass = v8->klass;
      v23 = *(unsigned __int16 *)(&v8->klass->_2.bitflags2 + 3);
      ...
      {
LABEL_33:
        v25 = sub_1BDA590(v8, System_IDisposable_TypeInfo, 0LL);
      }
