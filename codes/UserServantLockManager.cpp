void __fastcall UserServantLockManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_43911FE & 1) == 0 )
  {
    ...
    sub_B775C4(&StringLiteral_6760/*"Fgo_20150511"*/);
    byte_43911FE = 1;
  }
  static_fields = (BattleServantConfConponent_o *)UserServantLockManager_TypeInfo->static_fields;
  v8 = (System_Int32_array **)StringLiteral_6760/*"Fgo_20150511"*/;
  static_fields->klass = (BattleServantConfConponent_c *)StringLiteral_6760/*"Fgo_20150511"*/;
  ...
  v10->lockList = v9;
  sub_B77560((BattleServantConfConponent_o *)&v10->lockList, (System_Int32_array **)v9, v11, v12, v13, v14, v15, v16);
}
...
bool __fastcall UserServantLockManager__ReadData(const MethodInfo *method)
{
  ...
  if ( System_IO_File__Exists(SaveFileName, 0LL) )
  {
    ...
    {
LABEL_36:
      v22 = sub_B0F4C0(v8, System_IDisposable_TypeInfo, 0LL);
    }
