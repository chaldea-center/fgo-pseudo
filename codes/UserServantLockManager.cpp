void UserServantLockManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4D2DE41 & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_6676/*"Fgo_20150511"*/);
    byte_4D2DE41 = 1;
  }
  UserServantLockManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6676/*"Fgo_20150511"*/;
  sub_1C9403C(
    (GrandQuestFolderBoardItem_o *)UserServantLockManager_TypeInfo->static_fields,
    StringLiteral_6676/*"Fgo_20150511"*/,
    v1,
    v2,
    v3,
    v4,
  ...
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&static_fields->lockList, (int32_t)v7, v9, v10, v11, v12, v13, v14);
}
      ...
      if ( Instance )
      {
        ...
        if ( (unsigned int)size >= LODWORD(items->max_length) )
        {
          System_Collections_Generic_List_long___AddWithResize(
            v4,
            v9,
            *(const MethodInfo_3852E68 **)(*(_QWORD *)(v11[4] + 192LL) + 112LL));
        }
        else
        {
...
bool UserServantLockManager__ReadData(const MethodInfo *method)
{
  ...
  if ( !v2->static_fields->UseMock )
  {
    ...
    if ( System_IO_File__Exists(SaveFileName, 0) )
    {
      ...
      {
LABEL_33:
        v25 = sub_1C6A420(v8, System_IDisposable_TypeInfo, 0);
      }
