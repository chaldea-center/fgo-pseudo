...
void __fastcall MyRoomFrontObjectManager__ReleaseAll(MyRoomFrontObjectManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFD07E & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_9136/*"MyRoom/FrontObject/{0}"*/, v5);
    byte_4AFD07E = 1;
  }
  ...
  if ( ((unsigned __int8)v9 & 1) != 0 )
  {
    if ( !*p_dispObject
      || (klass = (int)(*p_dispObject)[2].klass,
          ...
          v9 = System_String__Format((System_String_o *)StringLiteral_9136/*"MyRoom/FrontObject/{0}"*/, v14, 0LL),
          !*p_dispObject) )
    {
      sub_1BC3264(v9, v10);
    }
...
void __fastcall MyRoomFrontObjectManager__Setup(MyRoomFrontObjectManager_o *this, int32_t id, const MethodInfo *method)
{
  ...
  if ( (byte_4AFD07D & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_MyRoomFrontObjectManager___c__DisplayClass6_0__Setup_b__0__, v7);
    sub_1BC3008(&MyRoomFrontObjectManager___c__DisplayClass6_0_TypeInfo, v8);
    sub_1BC3008(&StringLiteral_9136/*"MyRoom/FrontObject/{0}"*/, v9);
    byte_4AFD07D = 1;
  }
  v10 = sub_1BC3254(MyRoomFrontObjectManager___c__DisplayClass6_0_TypeInfo);
  ...
  *(_DWORD *)(v10 + 24) = id;
  if ( !MyRoomFrontObjectManager__IsSameObjectAlreadyDisplayed(this, id, v13) )
  {
    ...
    v20 = System_String__Format((System_String_o *)StringLiteral_9136/*"MyRoom/FrontObject/{0}"*/, v19, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFD085 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_UnityEngine_GameObject_GetComponent_MyRoomFrontObject___, v5);
    sub_1BC3008(&Method_UnityEngine_Object_Instantiate_GameObject____76895672, v6);
    sub_1BC3008(&UnityEngine_Object_TypeInfo, v7);
    sub_1BC3008(&StringLiteral_9144/*"MyRoomFrontObj"*/, v8);
    byte_4AFD085 = 1;
  }
  if ( assetData )
  {
    Object_object__50213776 = AssetData__GetObject_object__50213776(
                                assetData,
                                (System_String_o *)StringLiteral_9144/*"MyRoomFrontObj"*/,
    ...
    if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)Object_object__50213776, 0LL, 0LL) )
    {
      ...
      _4__this = (UnityEngine_Component_o *)UnityEngine_GameObject__GetComponent_object_(
                                              ...
                                              (const MethodInfo_3055998 *)Method_UnityEngine_GameObject_GetComponent_MyRoomFrontObject___);
      if ( !v13 )
        goto LABEL_18;
      v13->fields.dispObject = (struct MyRoomFrontObject_o *)_4__this;
      _4__this = (UnityEngine_Component_o *)sub_1BC2FAC(&v13->fields.dispObject);
