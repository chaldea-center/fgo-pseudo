...
void MyRoomFrontObjectManager__ReleaseAll(MyRoomFrontObjectManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D27668 & 1) == 0 )
  {
    ...
    sub_1C94098(&UnityEngine_Object_TypeInfo);
    sub_1C94098(&StringLiteral_9239/*"MyRoom/FrontObject/{0}"*/);
    byte_4D27668 = 1;
  }
  ...
  if ( ((unsigned __int8)v6 & 1) != 0 )
  {
    if ( !*p_dispObject
      || (klass = (int)(*p_dispObject)[2].klass,
          ...
          v6 = System_String__Format((System_String_o *)StringLiteral_9239/*"MyRoom/FrontObject/{0}"*/, v8, 0),
          !*p_dispObject) )
    {
      sub_1C942F0(v6, v7);
    }
    ...
    *p_dispObject = 0;
    sub_1C9403C((GrandQuestFolderBoardItem_o *)p_dispObject, 0, v11, v12, v13, v14, v15, v16);
...
void MyRoomFrontObjectManager__Setup(MyRoomFrontObjectManager_o *this, int32_t id, const MethodInfo *method)
{
  ...
  if ( (byte_4D27667 & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_MyRoomFrontObjectManager___c__DisplayClass6_0__Setup_b__0__);
    sub_1C94098(&MyRoomFrontObjectManager___c__DisplayClass6_0_TypeInfo);
    sub_1C94098(&StringLiteral_9239/*"MyRoom/FrontObject/{0}"*/);
    byte_4D27667 = 1;
  }
  v5 = sub_1C942E4(MyRoomFrontObjectManager___c__DisplayClass6_0_TypeInfo);
  ...
  *(_DWORD *)(v5 + 24) = id;
  if ( !MyRoomFrontObjectManager__IsSameObjectAlreadyDisplayed(this, id, v14) )
  {
    ...
    v18 = System_String__Format((System_String_o *)StringLiteral_9239/*"MyRoom/FrontObject/{0}"*/, v17, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2766F & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_UnityEngine_GameObject_GetComponent_MyRoomFrontObject___);
    sub_1C94098(&Method_UnityEngine_Object_Instantiate_GameObject____79133288);
    sub_1C94098(&UnityEngine_Object_TypeInfo);
    sub_1C94098(&StringLiteral_9247/*"MyRoomFrontObj"*/);
    byte_4D2766F = 1;
  }
  if ( assetData )
  {
    Object_object__51893132 = AssetData__GetObject_object__51893132(
                                assetData,
                                (System_String_o *)StringLiteral_9247/*"MyRoomFrontObj"*/,
    ...
    if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)Object_object__51893132, 0, 0) )
    {
      ...
      _4__this = (UnityEngine_Component_o *)UnityEngine_GameObject__GetComponent_object_(
                                              ...
                                              (const MethodInfo_31F4790 *)Method_UnityEngine_GameObject_GetComponent_MyRoomFrontObject___);
      if ( !v9 )
        goto LABEL_18;
