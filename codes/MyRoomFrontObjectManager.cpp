...
void __fastcall MyRoomFrontObjectManager__ReleaseAll(MyRoomFrontObjectManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42AFA95 & 1) == 0 )
  {
    ...
    sub_B52984(&UnityEngine_Object_TypeInfo);
    sub_B52984(&StringLiteral_9314/*"MyRoom/FrontObject/{0}"*/);
    byte_42AFA95 = 1;
  }
  klass = this[1].klass;
  v3 = (UnityEngine_Component_o **)&this[1];
  v4 = (UnityEngine_Object_o *)klass;
  if ( (BYTE3(UnityEngine_Object_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  {
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  ...
  if ( ((unsigned __int8)v6 & 1) != 0 )
  {
    if ( !*v3
      || (m_CachedPtr = (*v3)[1].fields.m_CachedPtr,
          v8 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &m_CachedPtr),
          v6 = System_String__Format((System_String_o *)StringLiteral_9314/*"MyRoom/FrontObject/{0}"*/, v8, 0LL),
          !*v3) )
    {
      sub_B52A5C(v6, v7);
    }
    ...
    *v3 = 0LL;
    sub_B52920((BattleServantConfConponent_o *)v3, 0LL, v11, v12, v13, v14, v15, v16);
...
void __fastcall MyRoomFrontObjectManager__Setup(MyRoomFrontObjectManager_o *this, int32_t id, const MethodInfo *method)
{
  ...
  if ( (byte_42AFA94 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_MyRoomFrontObjectManager___c__DisplayClass6_0__Setup_b__0__);
    sub_B52984(&MyRoomFrontObjectManager___c__DisplayClass6_0_TypeInfo);
    sub_B52984(&StringLiteral_9314/*"MyRoom/FrontObject/{0}"*/);
    byte_42AFA94 = 1;
  }
  v5 = sub_B52A54(MyRoomFrontObjectManager___c__DisplayClass6_0_TypeInfo);
  ...
  *(_DWORD *)(v5 + 24) = id;
  if ( !MyRoomFrontObjectManager__IsSameObjectAlreadyDisplayed(this, id, v14) )
  {
    ...
    v18 = System_String__Format((System_String_o *)StringLiteral_9314/*"MyRoom/FrontObject/{0}"*/, v17, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B3391 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_UnityEngine_GameObject_GetComponent_MyRoomFrontObject___);
    sub_B52984(&Method_UnityEngine_Object_Instantiate_GameObject____68654656);
    sub_B52984(&UnityEngine_Object_TypeInfo);
    sub_B52984(&StringLiteral_9317/*"MyRoomFrontObj"*/);
    byte_42B3391 = 1;
  }
  if ( assetData )
  {
    Object_WarBoardWaitTimeSetting = (UILabel_o *)AssetData__GetObject_WarBoardWaitTimeSetting_(
                                                    assetData,
                                                    (System_String_o *)StringLiteral_9317/*"MyRoomFrontObj"*/,
    ...
    if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)Object_WarBoardWaitTimeSetting, 0LL, 0LL) )
    {
      ...
      _4__this = (UnityEngine_Component_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                              ...
                                              (const MethodInfo_1B7B1B8 *)Method_UnityEngine_GameObject_GetComponent_MyRoomFrontObject___);
      if ( !v9 )
        goto LABEL_20;
      v9[1].klass = (MyRoomFrontObjectManager_c *)_4__this;
      sub_B52920((BattleServantConfConponent_o *)&v9[1], (System_Int32_array **)_4__this, v10, v11, v12, v13, v14, v15);
      v16 = this->fields.__4__this;
      if ( !v16 )
        goto LABEL_20;
      _4__this = (UnityEngine_Component_o *)UnityEngine_Object__op_Inequality(
                                              (UnityEngine_Object_o *)v16[1].klass,
                                              0LL,
                                              0LL);
      if ( ((unsigned __int8)_4__this & 1) != 0 )
      {
        ...
        if ( v17 )
        {
          _4__this = (UnityEngine_Component_o *)v17[1].klass;
          if ( _4__this )
          {
            MyRoomFrontObject__Setup(
              (MyRoomFrontObject_o *)_4__this,
              this->fields.id,
              *(UnityEngine_Vector3_o *)&v17->fields.BasePosition.fields.y,
              0LL);
            return;
          }
        }
