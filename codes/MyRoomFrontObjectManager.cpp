...
void __fastcall MyRoomFrontObjectManager__ReleaseAll(MyRoomFrontObjectManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A566D1 & 1) == 0 )
  {
    ...
    sub_1B885B0(&UnityEngine_Object_TypeInfo);
    sub_1B885B0(&StringLiteral_9197/*"MyRoom/FrontObject/{0}"*/);
    byte_4A566D1 = 1;
  }
  ...
  if ( ((unsigned __int8)v6 & 1) != 0 )
  {
    if ( !*p_dispObject
      || (klass = (int)(*p_dispObject)[2].klass,
          ...
          v6 = System_String__Format((System_String_o *)StringLiteral_9197/*"MyRoom/FrontObject/{0}"*/, v11, 0LL),
          !*p_dispObject) )
    {
      sub_1B8880C(v6, v7);
    }
...
void __fastcall MyRoomFrontObjectManager__Setup(MyRoomFrontObjectManager_o *this, int32_t id, const MethodInfo *method)
{
  ...
  if ( (byte_4A566D0 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_MyRoomFrontObjectManager___c__DisplayClass6_0__Setup_b__0__);
    sub_1B885B0(&MyRoomFrontObjectManager___c__DisplayClass6_0_TypeInfo);
    sub_1B885B0(&StringLiteral_9197/*"MyRoom/FrontObject/{0}"*/);
    byte_4A566D0 = 1;
  }
  v5 = sub_1B887FC(MyRoomFrontObjectManager___c__DisplayClass6_0_TypeInfo);
  ...
  *(_DWORD *)(v5 + 24) = id;
  if ( !MyRoomFrontObjectManager__IsSameObjectAlreadyDisplayed(this, id, v8) )
  {
    ...
    v15 = System_String__Format((System_String_o *)StringLiteral_9197/*"MyRoom/FrontObject/{0}"*/, v14, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A566D8 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_UnityEngine_GameObject_GetComponent_MyRoomFrontObject___);
    sub_1B885B0(&Method_UnityEngine_Object_Instantiate_GameObject____76171952);
    sub_1B885B0(&UnityEngine_Object_TypeInfo);
    sub_1B885B0(&StringLiteral_9200/*"MyRoomFrontObj"*/);
    byte_4A566D8 = 1;
  }
  if ( assetData )
  {
    Object_object__48635516 = AssetData__GetObject_object__48635516(
                                assetData,
                                (System_String_o *)StringLiteral_9200/*"MyRoomFrontObj"*/,
    ...
    if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)Object_object__48635516, 0LL, 0LL) )
    {
      ...
      _4__this = (UnityEngine_Component_o *)UnityEngine_GameObject__GetComponent_object_(
                                              ...
                                              (const MethodInfo_2ECEEB8 *)Method_UnityEngine_GameObject_GetComponent_MyRoomFrontObject___);
      if ( !v9 )
        goto LABEL_18;
      v9->fields.dispObject = (struct MyRoomFrontObject_o *)_4__this;
      _4__this = (UnityEngine_Component_o *)sub_1B88554(&v9->fields.dispObject, _4__this);
