...
void __fastcall SummonInfoLayout__Awake(SummonInfoLayout_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A05571 & 1) == 0 )
  {
    sub_1B686D4(&Method_UnityEngine_Component_GetComponent_FSOffset___, method);
    byte_4A05571 = 1;
  }
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.fsOffset, (int32_t)Component_object, v7, v8);
