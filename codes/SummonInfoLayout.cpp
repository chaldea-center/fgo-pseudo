...
void __fastcall SummonInfoLayout__Awake(SummonInfoLayout_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FB480 & 1) == 0 )
  {
    sub_1B64A00(&Method_UnityEngine_Component_GetComponent_FSOffset___, method);
    byte_49FB480 = 1;
  }
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.fsOffset, (int32_t)Component_object, v7, v8);
