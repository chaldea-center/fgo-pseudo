...
void __fastcall SummonInfoLayout__Awake(SummonInfoLayout_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B4107B & 1) == 0 )
  {
    sub_1BDB878(&Method_UnityEngine_Component_GetComponent_FSOffset___, method);
    byte_4B4107B = 1;
  }
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.fsOffset, (int32_t)Component_object, v7, v8);
