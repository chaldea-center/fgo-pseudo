...
void __fastcall SummonInfoLayout__Awake(SummonInfoLayout_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFE5ED & 1) == 0 )
  {
    sub_1BC3008(&Method_UnityEngine_Component_GetComponent_FSOffset___, method);
    byte_4AFE5ED = 1;
  }
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.fsOffset, (int32_t)Component_object, v7, v8);
