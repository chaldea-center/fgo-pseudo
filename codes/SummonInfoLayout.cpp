...
void __fastcall SummonInfoLayout__Awake(SummonInfoLayout_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4AB5C & 1) == 0 )
  {
    sub_1B863B8(&Method_UnityEngine_Component_GetComponent_FSOffset___, method);
    byte_4A4AB5C = 1;
  }
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.fsOffset, (int32_t)Component_object, v7, v8);
