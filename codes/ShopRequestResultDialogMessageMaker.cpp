        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB23F & 1) == 0 )
  {
    sub_1B64A00(&Method_DataManager_GetMasterData_UserItemMaster___, itemEntity);
    ...
    sub_1B64A00(&StringLiteral_3093/*"BUY_AFTER_QP_NUM"*/, v10);
    sub_1B64A00(&StringLiteral_3094/*"BUY_AFTER_USER_ITEM_NUM"*/, v11);
    entity = (ShopEntity_o *)sub_1B64A00(&StringLiteral_1/*""*/, v12);
    byte_49FB23F = 1;
  }
  if ( !v6 )
    goto LABEL_35;
...
LABEL_35:
      sub_1B64C5C(entity, itemEntity);
    }
LABEL_25:
    entity = (ShopEntity_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE930 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( entity )
    {
...
LABEL_34:
  ...
  return System_String__Format_61399508(v17, NumberFormat, v22, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB241 & 1) == 0 )
  {
    sub_1B64A00(&Method_DataManager_GetMasterData_ItemMaster___, *(_QWORD *)&buyCount);
    sub_1B64A00(&Method_DataManager_GetMasterData_ServantMaster___, v5);
    sub_1B64A00(&Method_DataManager_GetMasterData_SetItemMaster___, v6);
    sub_1B64A00(&Method_DataManager_GetMasterData_ShopDetailMaster___, v7);
    sub_1B64A00(&LocalizationManager_TypeInfo, v8);
    sub_1B64A00(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v9);
    sub_1B64A00(&string___TypeInfo, v10);
    sub_1B64A00(&StringLiteral_11914/*"SET_ITEM_GET_SERVANT_MSG"*/, v11);
    sub_1B64A00(&StringLiteral_44/*"\n\n"*/, v12);
    sub_1B64A00(&StringLiteral_1/*""*/, v13);
    sub_1B64A00(&StringLiteral_11913/*"SET_ITEM_GET_ITEM_MSG"*/, v14);
    byte_49FB241 = 1;
  }
  ...
  if ( (int)v26 >= 1 )
  {
    ...
    while ( v27 < (unsigned int)v26 )
    {
      ...
      RequestResultPresentBoxMessage = ShopRequestResultDialogMessageMaker__GetRequestResultPresentBoxMessage(
                                         ...
                                         buyCount,
                                         v24);
      v28 = System_String__Concat_61385136(v28, RequestResultPresentBoxMessage, 0LL);
      UserItemMessage = ShopRequestResultDialogMessageMaker__GetRequestResultGetUserItemMessage(
                          ...
                          buyCount,
                          v31);
      Instance = (__int64)System_String__Concat_61385136(v19, UserItemMessage, 0LL);
...
LABEL_20:
  ...
  {
    Instance = sub_1B64AA8(string___TypeInfo, 5LL);
    if ( Instance )
    {
      v38 = Instance;
      ...
      *(_QWORD *)(Instance + 32) = v28;
      sub_1B649A4((ServantStatusBattleListViewItem_o *)(Instance + 32), (int32_t)v28, v36, v37);
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      Instance = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_11914/*"SET_ITEM_GET_SERVANT_MSG"*/, 0LL);
      if ( *(_DWORD *)(v38 + 24) <= 1u )
        goto LABEL_41;
      *(_QWORD *)(v38 + 40) = Instance;
      sub_1B649A4((ServantStatusBattleListViewItem_o *)(v38 + 40), Instance, v39, v40);
      if ( *(_DWORD *)(v38 + 24) <= 2u )
        goto LABEL_41;
      v43 = StringLiteral_44/*"\n\n"*/;
      *(_QWORD *)(v38 + 48) = StringLiteral_44/*"\n\n"*/;
      sub_1B649A4((ServantStatusBattleListViewItem_o *)(v38 + 48), v43, v41, v42);
      if ( *(_DWORD *)(v38 + 24) <= 3u )
        goto LABEL_41;
      *(_QWORD *)(v38 + 56) = v19;
      sub_1B649A4((ServantStatusBattleListViewItem_o *)(v38 + 56), (int32_t)v19, v44, v45);
      Instance = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_11913/*"SET_ITEM_GET_ITEM_MSG"*/, 0LL);
      if ( *(_DWORD *)(v38 + 24) <= 4u )
        goto LABEL_41;
      *(_QWORD *)(v38 + 64) = Instance;
      sub_1B649A4((ServantStatusBattleListViewItem_o *)(v38 + 64), Instance, v46, v47);
      return System_String__Concat_61398664((System_String_array *)v38, 0LL);
    }
LABEL_42:
  ...
  if ( System_String__IsNullOrEmpty(v28, 0LL) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v34 = LocalizationManager__Get((System_String_o *)StringLiteral_11913/*"SET_ITEM_GET_ITEM_MSG"*/, 0LL);
    v35 = v19;
  }
  else
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v34 = LocalizationManager__Get((System_String_o *)StringLiteral_11914/*"SET_ITEM_GET_SERVANT_MSG"*/, 0LL);
    v35 = v28;
  }
  return System_String__Concat_61385136(v35, v34, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB23D & 1) == 0 )
  {
    sub_1B64A00(&Method_DataManager_GetMasterData_ShopDetailMaster___, entity);
    sub_1B64A00(&LocalizationManager_TypeInfo, v7);
    sub_1B64A00(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v8);
    sub_1B64A00(&StringLiteral_11979/*"SHOP_BUY_SUCCESS_SEND_PRESENT_BOX"*/, v9);
    sub_1B64A00(&StringLiteral_11976/*"SHOP_BUY_SUCCESS"*/, v10);
    sub_1B64A00(&StringLiteral_11978/*"SHOP_BUY_SUCCESS_SEND_MIX"*/, v11);
    item = (ShopBuyItemListViewItem_o *)sub_1B64A00(&StringLiteral_11977/*"SHOP_BUY_SUCCESS_MULTIPLE"*/, v12);
    byte_49FB23D = 1;
  }
  isTake = 0;
  isSend = 0;
  ...
  if ( !entity
    || (v14 = item,
        ...
        (item = (ShopBuyItemListViewItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE930 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0LL)
    || (item = (ShopBuyItemListViewItem_o *)DataManager__GetMasterData_object_(
                                              (DataManager_o *)item,
                                              (const MethodInfo_2E3BCE0 *)Method_DataManager_GetMasterData_ShopDetailMaster___)) == 0LL )
  {
LABEL_31:
    sub_1B64C5C(item, entity);
  }
...
LABEL_18:
  ...
  if ( NumberFormat && entity->fields.setNum * buyCount >= 1 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v19 = LocalizationManager__Get((System_String_o *)StringLiteral_11977/*"SHOP_BUY_SUCCESS_MULTIPLE"*/, 0LL);
    v20 = System_String__Format(v19, NumberFormat, 0LL);
    v18 = System_String__Concat_61385136((System_String_o *)v14, v20, 0LL);
    goto LABEL_18;
  }
LABEL_19:
  v21 = isSend;
  if ( isSend && isTake )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v22 = &StringLiteral_11978/*"SHOP_BUY_SUCCESS_SEND_MIX"*/;
    goto LABEL_29;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
  {
    ...
    if ( v21 )
      goto LABEL_26;
LABEL_28:
    v22 = &StringLiteral_11976/*"SHOP_BUY_SUCCESS"*/;
    goto LABEL_29;
  }
  if ( !isSend )
    goto LABEL_28;
LABEL_26:
  v22 = &StringLiteral_11979/*"SHOP_BUY_SUCCESS_SEND_PRESENT_BOX"*/;
LABEL_29:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB23E & 1) == 0 )
  {
    sub_1B64A00(&Method_DataManager_GetMaster_ShopDetailMaster___, *(_QWORD *)&buyCount);
    sub_1B64A00(&DataManager_TypeInfo, v5);
    sub_1B64A00(&Method_DataMasterBase_ShopDetailMaster__ShopDetailEntity__int__TryGetEntity__, v6);
    sub_1B64A00(&LocalizationManager_TypeInfo, v7);
    sub_1B64A00(&StringLiteral_11976/*"SHOP_BUY_SUCCESS"*/, v8);
    entity = (ShopEntity_o *)sub_1B64A00(&StringLiteral_11977/*"SHOP_BUY_SUCCESS_MULTIPLE"*/, v9);
    byte_49FB23E = 1;
  }
  entitya = 0LL;
  if ( !v4 )
  ...
  entity = (ShopEntity_o *)DataManager__GetMaster_object_((const MethodInfo_2E3BC8C *)Method_DataManager_GetMaster_ShopDetailMaster___);
  if ( !entity )
    goto LABEL_21;
  entity = (ShopEntity_o *)DataMasterBase_object__object__int___TryGetEntity(
                             ...
                             &entitya,
                             v4->fields.id,
                             (const MethodInfo_30D67EC *)Method_DataMasterBase_ShopDetailMaster__ShopDetailEntity__int__TryGetEntity__);
...
LABEL_21:
    sub_1B64C5C(entity, *(_QWORD *)&buyCount);
  }
LABEL_12:
  if ( v4->fields.setNum * buyCount >= 1 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v13 = LocalizationManager__Get((System_String_o *)StringLiteral_11977/*"SHOP_BUY_SUCCESS_MULTIPLE"*/, 0LL);
    v14 = System_String__Format(v13, NumberFormat, 0LL);
    v11 = System_String__Concat_61385136(v11, v14, 0LL);
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_11976/*"SHOP_BUY_SUCCESS"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB240 & 1) == 0 )
  {
    sub_1B64A00(&LocalizationManager_TypeInfo, itemEntity);
    sub_1B64A00(&StringLiteral_2050/*"ADD_USER_ITEM_MSG"*/, v5);
    sub_1B64A00(&StringLiteral_2051/*"ADD_USER_QP_MSG"*/, v6);
    sub_1B64A00(&StringLiteral_2052/*"ADD_USER_SVT_COIN_MSG"*/, v7);
    shopEntity = (ShopEntity_o *)sub_1B64A00(&StringLiteral_1/*""*/, v8);
    byte_49FB240 = 1;
  }
  if ( !v4 )
    goto LABEL_19;
  ...
  if ( !itemEntity )
LABEL_19:
    sub_1B64C5C(shopEntity, itemEntity);
  type = itemEntity->fields.type;
  if ( type == 1 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB242 & 1) == 0 )
  {
    sub_1B64A00(&Method_DataMasterBase_ItemMaster__ItemEntity__int__GetEntity__, entity);
    sub_1B64A00(&int_TypeInfo, v11);
    sub_1B64A00(&LocalizationManager_TypeInfo, v12);
    sub_1B64A00(&StringLiteral_11977/*"SHOP_BUY_SUCCESS_MULTIPLE"*/, v13);
    sub_1B64A00(&StringLiteral_11915/*"SET_ITEM_INDIVIDUAL"*/, v14);
    itemMaster = (ItemMaster_o *)sub_1B64A00(&StringLiteral_1/*""*/, v15);
    byte_49FB242 = 1;
  }
  if ( !setItemEntity )
    goto LABEL_23;
  ...
  if ( purchaseType == 1 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v30 = LocalizationManager__Get((System_String_o *)StringLiteral_11977/*"SHOP_BUY_SUCCESS_MULTIPLE"*/, 0LL);
    ...
    v38 = System_String__Concat_61385136(v17, AddNewLine, 0LL);
    itemMaster = (ItemMaster_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11915/*"SET_ITEM_INDIVIDUAL"*/, 0LL);
    if ( v10 )
    {
      v39 = itemMaster;
      ...
      if ( itemMaster )
      {
        v40 = (Il2CppObject *)System_String__Concat_61385136(itemMaster->fields._MasterName_k__BackingField, v35, 0LL);
        v41 = System_String__Format((System_String_o *)v39, v40, 0LL);
        return System_String__Concat_61385136(v38, v41, 0LL);
      }
    }
LABEL_23:
    sub_1B64C5C(itemMaster, entity);
  }
  if ( purchaseType != 7 )
    return v17;
  if ( !entity )
  ...
  if ( NumberFormat && entity->fields.setNum * buyCount >= 1 )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v23 = LocalizationManager__Get((System_String_o *)StringLiteral_11977/*"SHOP_BUY_SUCCESS_MULTIPLE"*/, 0LL);
    v24 = System_String__Format(v23, v22, 0LL);
    v19 = System_String__Concat_61385136(v19, v24, 0LL);
  }
  v25 = ShopRequestResultDialogMessageMaker__GetAddNewLine(getUserItemMessage, v21);
  v26 = System_String__Concat_61385136(v17, v25, 0LL);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v27 = LocalizationManager__Get((System_String_o *)StringLiteral_11915/*"SET_ITEM_INDIVIDUAL"*/, 0LL);
  v28 = System_String__Format(v27, (Il2CppObject *)v19, 0LL);
  return System_String__Concat_61385136(v26, v28, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB243 & 1) == 0 )
  {
    sub_1B64A00(&Method_DataMasterBase_ItemMaster__ItemEntity__int__GetEntity__, itemMaster);
    ...
    sub_1B64A00(&StringLiteral_11977/*"SHOP_BUY_SUCCESS_MULTIPLE"*/, v15);
    sub_1B64A00(&StringLiteral_11915/*"SET_ITEM_INDIVIDUAL"*/, v16);
  ...
  if ( purchaseType == 18 )
  {
    ...
    v38 = System_String__Concat_61385136(v18, AddNewLine, 0LL);
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v19 = LocalizationManager__Get((System_String_o *)StringLiteral_11915/*"SET_ITEM_INDIVIDUAL"*/, 0LL);
    if ( itemMaster )
    {
      ...
      if ( v19 )
      {
        v40 = (Il2CppObject *)System_String__Concat_61385136(*((System_String_o **)v19 + 3), v29, 0LL);
        v35 = System_String__Format(v39, v40, 0LL);
        v36 = v38;
        return System_String__Concat_61385136(v36, v35, 0LL);
      }
    }
LABEL_21:
    sub_1B64C5C(v19, v20);
  ...
  if ( purchaseType == 4 )
  {
    ...
    v31 = System_String__Concat_61385136(v18, v30, 0LL);
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v19 = LocalizationManager__Get((System_String_o *)StringLiteral_11915/*"SET_ITEM_INDIVIDUAL"*/, 0LL);
    if ( servantMaster )
    {
      ...
      if ( v19 )
      {
        ...
        v34 = (Il2CppObject *)System_String__Concat_61385136(Name, v29, 0LL);
