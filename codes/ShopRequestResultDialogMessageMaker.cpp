        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFE386 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMasterData_UserItemMaster___, itemEntity);
    ...
    sub_1BC3008(&StringLiteral_2990/*"BUY_AFTER_QP_NUM"*/, v10);
    sub_1BC3008(&StringLiteral_2991/*"BUY_AFTER_USER_ITEM_NUM"*/, v11);
    entity = (ShopEntity_o *)sub_1BC3008(&StringLiteral_1/*""*/, v12);
    byte_4AFE386 = 1;
  }
  if ( !v6 )
    goto LABEL_39;
...
LABEL_35:
          ...
          v17 = LocalizationManager__Get((System_String_o *)StringLiteral_2991/*"BUY_AFTER_USER_ITEM_NUM"*/, 0LL);
          ...
          return System_String__Format_62389940(v17, NumberFormat, NumberFormatLong, 0LL);
        }
        goto LABEL_39;
    }
    goto LABEL_25;
...
LABEL_39:
      sub_1BC3264(entity, itemEntity);
    }
LABEL_25:
    entity = (ShopEntity_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38DFD48 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( entity )
    {
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  entity = (ShopEntity_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2990/*"BUY_AFTER_QP_NUM"*/, 0LL);
  if ( !SelfUserGame )
    goto LABEL_39;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFE388 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMasterData_ItemMaster___, *(_QWORD *)&buyCount);
    sub_1BC3008(&Method_DataManager_GetMasterData_ServantMaster___, v5);
    sub_1BC3008(&Method_DataManager_GetMasterData_SetItemMaster___, v6);
    sub_1BC3008(&Method_DataManager_GetMasterData_ShopDetailMaster___, v7);
    sub_1BC3008(&LocalizationManager_TypeInfo, v8);
    sub_1BC3008(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v9);
    sub_1BC3008(&string___TypeInfo, v10);
    sub_1BC3008(&StringLiteral_11906/*"SET_ITEM_GET_SERVANT_MSG"*/, v11);
    sub_1BC3008(&StringLiteral_44/*"\n\n"*/, v12);
    sub_1BC3008(&StringLiteral_1/*""*/, v13);
    sub_1BC3008(&StringLiteral_11905/*"SET_ITEM_GET_ITEM_MSG"*/, v14);
    byte_4AFE388 = 1;
  }
  ...
  if ( (int)v26 >= 1 )
  {
    ...
    while ( v27 < (unsigned int)v26 )
    {
      ...
      RequestResultPresentBoxMessage = ShopRequestResultDialogMessageMaker__GetRequestResultPresentBoxMessage(
                                         ...
                                         buyCount,
                                         v24);
      v28 = System_String__Concat_62348648(v28, RequestResultPresentBoxMessage, 0LL);
      UserItemMessage = ShopRequestResultDialogMessageMaker__GetRequestResultGetUserItemMessage(
                          ...
                          buyCount,
                          v31);
      Instance = (__int64)System_String__Concat_62348648(v19, UserItemMessage, 0LL);
  ...
  if ( !System_String__IsNullOrEmpty(v28, 0LL) && !System_String__IsNullOrEmpty(v19, 0LL) )
  {
    ...
    if ( Instance )
    {
      ...
      *(_QWORD *)(Instance + 32) = v28;
      sub_1BC2FAC((CGThumbnailListItem_o *)(Instance + 32), (int32_t)v28, (int32_t)v23, v36);
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      Instance = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_11906/*"SET_ITEM_GET_SERVANT_MSG"*/, 0LL);
      if ( *(_DWORD *)(v37 + 24) <= 1u )
        goto LABEL_41;
      *(_QWORD *)(v37 + 40) = Instance;
      sub_1BC2FAC((CGThumbnailListItem_o *)(v37 + 40), Instance, (int32_t)v23, v38);
      if ( *(_DWORD *)(v37 + 24) <= 2u )
        goto LABEL_41;
      v40 = StringLiteral_44/*"\n\n"*/;
      *(_QWORD *)(v37 + 48) = StringLiteral_44/*"\n\n"*/;
      sub_1BC2FAC((CGThumbnailListItem_o *)(v37 + 48), v40, (int32_t)v23, v39);
      if ( *(_DWORD *)(v37 + 24) <= 3u )
        goto LABEL_41;
      *(_QWORD *)(v37 + 56) = v19;
      sub_1BC2FAC((CGThumbnailListItem_o *)(v37 + 56), (int32_t)v19, (int32_t)v23, v41);
      Instance = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_11905/*"SET_ITEM_GET_ITEM_MSG"*/, 0LL);
      if ( *(_DWORD *)(v37 + 24) <= 4u )
        goto LABEL_41;
      *(_QWORD *)(v37 + 64) = Instance;
      sub_1BC2FAC((CGThumbnailListItem_o *)(v37 + 64), Instance, (int32_t)v23, v42);
      return System_String__Concat_62389164((System_String_array *)v37, 0LL);
    }
LABEL_42:
  ...
  if ( System_String__IsNullOrEmpty(v28, 0LL) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v34 = LocalizationManager__Get((System_String_o *)StringLiteral_11905/*"SET_ITEM_GET_ITEM_MSG"*/, 0LL);
    v35 = v19;
  }
  else
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v34 = LocalizationManager__Get((System_String_o *)StringLiteral_11906/*"SET_ITEM_GET_SERVANT_MSG"*/, 0LL);
    v35 = v28;
  }
  return System_String__Concat_62348648(v35, v34, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFE384 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMasterData_ShopDetailMaster___, entity);
    sub_1BC3008(&LocalizationManager_TypeInfo, v7);
    sub_1BC3008(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v8);
    sub_1BC3008(&StringLiteral_11980/*"SHOP_BUY_SUCCESS_SEND_PRESENT_BOX"*/, v9);
    sub_1BC3008(&StringLiteral_11977/*"SHOP_BUY_SUCCESS"*/, v10);
    sub_1BC3008(&StringLiteral_11979/*"SHOP_BUY_SUCCESS_SEND_MIX"*/, v11);
    item = (ShopBuyItemListViewItem_o *)sub_1BC3008(&StringLiteral_11978/*"SHOP_BUY_SUCCESS_MULTIPLE"*/, v12);
    byte_4AFE384 = 1;
  }
  isTake = 0;
  isSend = 0;
  ...
  if ( !entity
    || (v14 = item,
        ...
        (item = (ShopBuyItemListViewItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38DFD48 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0LL)
    || (item = (ShopBuyItemListViewItem_o *)DataManager__GetMasterData_object_(
                                              (DataManager_o *)item,
                                              (const MethodInfo_3001E64 *)Method_DataManager_GetMasterData_ShopDetailMaster___)) == 0LL )
  {
LABEL_31:
    sub_1BC3264(item, entity);
  }
...
LABEL_18:
  ...
  if ( NumberFormat && entity->fields.setNum * buyCount >= 1 )
  {
    ...
    v18 = System_String__Concat_62348648((System_String_o *)v14, v20, 0LL);
    goto LABEL_18;
  }
LABEL_19:
  v21 = isSend;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFE385 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMaster_ShopDetailMaster___, *(_QWORD *)&buyCount);
    sub_1BC3008(&DataManager_TypeInfo, v5);
    sub_1BC3008(&Method_DataMasterBase_ShopDetailMaster__ShopDetailEntity__int__TryGetEntity__, v6);
    sub_1BC3008(&LocalizationManager_TypeInfo, v7);
    sub_1BC3008(&StringLiteral_11977/*"SHOP_BUY_SUCCESS"*/, v8);
    entity = (ShopEntity_o *)sub_1BC3008(&StringLiteral_11978/*"SHOP_BUY_SUCCESS_MULTIPLE"*/, v9);
    byte_4AFE385 = 1;
  }
  entitya = 0LL;
  if ( !v4 )
  ...
  entity = (ShopEntity_o *)DataManager__GetMaster_object_((const MethodInfo_3001E10 *)Method_DataManager_GetMaster_ShopDetailMaster___);
  if ( !entity )
    goto LABEL_21;
  entity = (ShopEntity_o *)DataMasterBase_object__object__int___TryGetEntity(
                             ...
                             &entitya,
                             v4->fields.id,
                             (const MethodInfo_32AF0BC *)Method_DataMasterBase_ShopDetailMaster__ShopDetailEntity__int__TryGetEntity__);
...
LABEL_21:
    sub_1BC3264(entity, *(_QWORD *)&buyCount);
  }
LABEL_12:
  if ( v4->fields.setNum * buyCount >= 1 )
  {
    ...
    v11 = System_String__Concat_62348648(v11, v14, 0LL);
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFE387 & 1) == 0 )
  {
    sub_1BC3008(&LocalizationManager_TypeInfo, itemEntity);
    sub_1BC3008(&StringLiteral_1911/*"ADD_USER_ITEM_MSG"*/, v5);
    sub_1BC3008(&StringLiteral_1912/*"ADD_USER_QP_MSG"*/, v6);
    sub_1BC3008(&StringLiteral_1913/*"ADD_USER_SVT_COIN_MSG"*/, v7);
    shopEntity = (ShopEntity_o *)sub_1BC3008(&StringLiteral_1/*""*/, v8);
    byte_4AFE387 = 1;
  }
  if ( !v4 )
    goto LABEL_19;
  ...
  if ( !itemEntity )
LABEL_19:
    sub_1BC3264(shopEntity, itemEntity);
  type = itemEntity->fields.type;
  if ( type == 1 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v10 = &StringLiteral_1912/*"ADD_USER_QP_MSG"*/;
  }
  else if ( type == 29 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v10 = &StringLiteral_1913/*"ADD_USER_SVT_COIN_MSG"*/;
  }
  else
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v10 = &StringLiteral_1911/*"ADD_USER_ITEM_MSG"*/;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFE389 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataMasterBase_ItemMaster__ItemEntity__int__GetEntity__, entity);
    sub_1BC3008(&int_TypeInfo, v11);
    sub_1BC3008(&LocalizationManager_TypeInfo, v12);
    sub_1BC3008(&StringLiteral_11978/*"SHOP_BUY_SUCCESS_MULTIPLE"*/, v13);
    sub_1BC3008(&StringLiteral_11907/*"SET_ITEM_INDIVIDUAL"*/, v14);
    itemMaster = (ItemMaster_o *)sub_1BC3008(&StringLiteral_1/*""*/, v15);
    byte_4AFE389 = 1;
  }
  if ( !setItemEntity )
    goto LABEL_23;
  ...
  if ( purchaseType == 1 )
  {
    ...
    v38 = System_String__Concat_62348648(v17, AddNewLine, 0LL);
    itemMaster = (ItemMaster_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11907/*"SET_ITEM_INDIVIDUAL"*/, 0LL);
    if ( v10 )
    {
      v39 = itemMaster;
      ...
      if ( itemMaster )
      {
        v40 = (Il2CppObject *)System_String__Concat_62348648(itemMaster->fields._MasterName_k__BackingField, v35, 0LL);
        v41 = System_String__Format((System_String_o *)v39, v40, 0LL);
        return System_String__Concat_62348648(v38, v41, 0LL);
      }
    }
LABEL_23:
    sub_1BC3264(itemMaster, entity);
  }
  if ( purchaseType != 7 )
    return v17;
  if ( !entity )
  ...
  if ( NumberFormat && entity->fields.setNum * buyCount >= 1 )
  {
    ...
    v19 = System_String__Concat_62348648(v19, v24, 0LL);
  }
  v25 = ShopRequestResultDialogMessageMaker__GetAddNewLine(getUserItemMessage, v21);
  v26 = System_String__Concat_62348648(v17, v25, 0LL);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v27 = LocalizationManager__Get((System_String_o *)StringLiteral_11907/*"SET_ITEM_INDIVIDUAL"*/, 0LL);
  v28 = System_String__Format(v27, (Il2CppObject *)v19, 0LL);
  return System_String__Concat_62348648(v26, v28, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFE38A & 1) == 0 )
  {
    sub_1BC3008(&Method_DataMasterBase_ItemMaster__ItemEntity__int__GetEntity__, itemMaster);
    ...
    sub_1BC3008(&StringLiteral_11978/*"SHOP_BUY_SUCCESS_MULTIPLE"*/, v15);
    sub_1BC3008(&StringLiteral_11907/*"SET_ITEM_INDIVIDUAL"*/, v16);
  ...
  if ( purchaseType == 18 )
  {
    ...
    v38 = System_String__Concat_62348648(v18, AddNewLine, 0LL);
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v19 = LocalizationManager__Get((System_String_o *)StringLiteral_11907/*"SET_ITEM_INDIVIDUAL"*/, 0LL);
    if ( itemMaster )
    {
      ...
      if ( v19 )
      {
        v40 = (Il2CppObject *)System_String__Concat_62348648(*((System_String_o **)v19 + 3), v29, 0LL);
        v35 = System_String__Format(v39, v40, 0LL);
        v36 = v38;
        return System_String__Concat_62348648(v36, v35, 0LL);
      }
    }
LABEL_21:
    sub_1BC3264(v19, v20);
  ...
  if ( purchaseType == 4 )
  {
    ...
    v31 = System_String__Concat_62348648(v18, v30, 0LL);
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v19 = LocalizationManager__Get((System_String_o *)StringLiteral_11907/*"SET_ITEM_INDIVIDUAL"*/, 0LL);
    if ( servantMaster )
    {
      ...
      if ( v19 )
      {
        ...
        v34 = (Il2CppObject *)System_String__Concat_62348648(Name, v29, 0LL);
