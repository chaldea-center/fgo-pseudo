void __fastcall BattleServantConfSkillComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A0BC2A & 1) == 0 )
  {
    sub_1B686D4(&BattleServantConfSkillComponent_TypeInfo, v1);
    sub_1B686D4(&StringLiteral_20395/*"img_skillclass_0"*/, v4);
    byte_4A0BC2A = 1;
  }
  static_fields = BattleServantConfSkillComponent_TypeInfo->static_fields;
  static_fields->MAX_HEIGHT = 500;
  v6 = StringLiteral_20395/*"img_skillclass_0"*/;
  static_fields->SKILL_NO_FILE_PREFIX = (struct System_String_o *)StringLiteral_20395/*"img_skillclass_0"*/;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&static_fields->SKILL_NO_FILE_PREFIX, v6, v2, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0BC29 & 1) == 0 )
  {
    sub_1B686D4(&BattleServantConfSkillComponent_TypeInfo, *(_QWORD *)&num);
  ...
  if ( num <= 9 )
  {
    ...
    titleNumSecondSprite = System_String__Concat_61419468(SKILL_NO_FILE_PREFIX, v28, 0LL);
...
LABEL_30:
    sub_1B68930(titleNumSecondSprite, v20);
  }
  ...
  titleNumSecondSprite = System_String__Concat_61419468(v17, v18, 0LL);
  if ( !v16 )
    goto LABEL_30;
  ...
  titleNumSecondSprite = System_String__Concat_61419468(v22, v23, 0LL);
  if ( !v21 )
    goto LABEL_30;
