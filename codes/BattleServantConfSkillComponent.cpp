void __fastcall BattleServantConfSkillComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BB783F & 1) == 0 )
  {
    sub_1C13D24(&BattleServantConfSkillComponent_TypeInfo, v1);
    sub_1C13D24(&StringLiteral_20803/*"img_shop_17"*/, v8);
    byte_4BB783F = 1;
  }
  BattleServantConfSkillComponent_TypeInfo->static_fields->SKILL_NO_FILE_PREFIX = (struct System_String_o *)StringLiteral_20803/*"img_shop_17"*/;
  sub_1C13CC8(
    (PartyOrganizationUtility_o *)BattleServantConfSkillComponent_TypeInfo->static_fields,
    StringLiteral_20803/*"img_shop_17"*/,
    v2,
    v3,
    v4,
    v5,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB783E & 1) == 0 )
  {
    sub_1C13D24(&BattleServantConfSkillComponent_TypeInfo, *(_QWORD *)&num);
  ...
  if ( num > 9 )
  {
    ...
    titleNumSecondSprite = System_String__Concat_62967944(SKILL_NO_FILE_PREFIX, v18, 0LL);
    if ( titleNumFirstSprite )
    {
      ...
      if ( titleNumSecondSprite )
      {
        ...
        if ( titleNumSecondSprite )
        {
          ...
          titleNumSecondSprite = System_String__Concat_62967944(v22, v23, 0LL);
          if ( v21 )
          {
...
LABEL_28:
    sub_1C13F80(titleNumSecondSprite, v20);
  }
  ...
  titleNumSecondSprite = System_String__Concat_62967944(v27, v28, 0LL);
  if ( !v26 )
    goto LABEL_28;
