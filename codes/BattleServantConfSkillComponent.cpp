void BattleServantConfSkillComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E081F1 & 1) == 0 )
  {
    sub_1CE6700(&BattleServantConfSkillComponent_TypeInfo);
    sub_1CE6700(&StringLiteral_20878/*"img_skillclass_0"*/);
    byte_4E081F1 = 1;
  }
  BattleServantConfSkillComponent_TypeInfo->static_fields->SKILL_NO_FILE_PREFIX = (struct System_String_o *)StringLiteral_20878/*"img_skillclass_0"*/;
  sub_1CE66A4(
    (GrandQuestFolderBoardItem_o *)BattleServantConfSkillComponent_TypeInfo->static_fields,
    StringLiteral_20878/*"img_skillclass_0"*/,
    v1,
    v2,
    v3,
    v4,
        ...
        const MethodInfo *method)
{
  ...
  if ( num > 9 )
  {
    ...
    titleNumSecondSprite = System_String__Concat_65122828(SKILL_NO_FILE_PREFIX, v17, 0);
    if ( titleNumFirstSprite )
    {
      ...
      if ( titleNumSecondSprite )
      {
        ...
        if ( titleNumSecondSprite )
        {
          ...
          titleNumSecondSprite = System_String__Concat_65122828(v21, v22, 0);
          if ( v20 )
          {
...
LABEL_28:
    sub_1CE6958(titleNumSecondSprite, v19);
  }
  ...
  titleNumSecondSprite = System_String__Concat_65122828(v26, v27, 0);
  if ( !v25 )
    goto LABEL_28;
