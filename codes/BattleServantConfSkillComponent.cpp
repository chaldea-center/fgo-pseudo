void __fastcall BattleServantConfSkillComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A014AF & 1) == 0 )
  {
    sub_1B64870(&BattleServantConfSkillComponent_TypeInfo, v1);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A014AE & 1) == 0 )
  {
    sub_1B64870(&BattleServantConfSkillComponent_TypeInfo, *(_QWORD *)&num);
  ...
  if ( num <= 9 )
  {
    ...
    titleNumSecondSprite = System_String__Concat_61383576(SKILL_NO_FILE_PREFIX, v28, 0LL);
...
LABEL_30:
  ...
  titleNumSecondSprite = System_String__Concat_61383576(v17, v18, 0LL);
  if ( !v16 )
    goto LABEL_30;
