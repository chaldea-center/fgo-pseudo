void __fastcall BattleServantConfSkillComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B47F26 & 1) == 0 )
  {
    sub_1BDB878(&BattleServantConfSkillComponent_TypeInfo, v1);
    sub_1BDB878(&StringLiteral_20585/*"img_skillclass_0"*/, v4);
    byte_4B47F26 = 1;
  }
  BattleServantConfSkillComponent_TypeInfo->static_fields->SKILL_NO_FILE_PREFIX = (struct System_String_o *)StringLiteral_20585/*"img_skillclass_0"*/;
  sub_1BDB81C(
    (CGThumbnailListItem_o *)BattleServantConfSkillComponent_TypeInfo->static_fields,
    StringLiteral_20585/*"img_skillclass_0"*/,
    v2,
    v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47F25 & 1) == 0 )
  {
    sub_1BDB878(&BattleServantConfSkillComponent_TypeInfo, *(_QWORD *)&num);
  ...
  if ( num > 9 )
  {
    ...
    titleNumSecondSprite = System_String__Concat_62572260(SKILL_NO_FILE_PREFIX, v18, 0LL);
    if ( titleNumFirstSprite )
    {
      ...
      if ( titleNumSecondSprite )
      {
        ...
        if ( titleNumSecondSprite )
        {
          ...
          titleNumSecondSprite = System_String__Concat_62572260(v22, v23, 0LL);
          if ( v21 )
          {
...
LABEL_28:
    sub_1BDBAD4(titleNumSecondSprite, v20);
  }
  ...
  titleNumSecondSprite = System_String__Concat_62572260(v27, v28, 0LL);
  if ( !v26 )
    goto LABEL_28;
...
LABEL_18:
  ...
  if ( !titleNumSecondSprite )
    goto LABEL_28;
  UIRangeLabel__Set((UIRangeLabel_o *)titleNumSecondSprite, titleMessage, 0LL, 1, 0, 0, 0LL);
  titleNumSecondSprite = (System_String_o *)this->fields.skillIcon;
  if ( !titleNumSecondSprite )
    goto LABEL_28;
