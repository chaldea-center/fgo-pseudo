void BattleServantConfSkillComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E7AF24 & 1) == 0 )
  {
    sub_1D0F0B4(&BattleServantConfSkillComponent_TypeInfo);
    sub_1D0F0B4(&StringLiteral_20969/*"img_skillclass_0"*/);
    byte_4E7AF24 = 1;
  }
  BattleServantConfSkillComponent_TypeInfo->static_fields->SKILL_NO_FILE_PREFIX = (struct System_String_o *)StringLiteral_20969/*"img_skillclass_0"*/;
  sub_1D0F058(
    (GrandQuestFolderBoardItem_o *)BattleServantConfSkillComponent_TypeInfo->static_fields,
    StringLiteral_20969/*"img_skillclass_0"*/,
    v1,
    v2,
    v3,
    v4,
        ...
        const MethodInfo *method)
{
  ...
  if ( num > 9 )
  {
    ...
    titleNumSecondSprite = System_String__Concat_65562772(SKILL_NO_FILE_PREFIX, v17, 0);
    if ( titleNumFirstSprite )
    {
      ...
      if ( titleNumSecondSprite )
      {
        ...
        if ( titleNumSecondSprite )
        {
          ...
          titleNumSecondSprite = System_String__Concat_65562772(v21, v22, 0);
          if ( v20 )
          {
...
LABEL_28:
    sub_1D0F30C(titleNumSecondSprite, v19);
  }
  ...
  titleNumSecondSprite = System_String__Concat_65562772(v26, v27, 0);
  if ( !v25 )
    goto LABEL_28;
