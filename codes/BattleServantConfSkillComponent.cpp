void __fastcall BattleServantConfSkillComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C2519F & 1) == 0 )
  {
    sub_1C3B764(&BattleServantConfSkillComponent_TypeInfo, v1);
    sub_1C3B764(&StringLiteral_20880/*"looptype"*/, v8);
    byte_4C2519F = 1;
  }
  BattleServantConfSkillComponent_TypeInfo->static_fields->SKILL_NO_FILE_PREFIX = (struct System_String_o *)StringLiteral_20880/*"looptype"*/;
  sub_1C3B708(
    (PartyOrganizationUtility_o *)BattleServantConfSkillComponent_TypeInfo->static_fields,
    StringLiteral_20880/*"looptype"*/,
    v2,
    v3,
    v4,
    v5,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2519E & 1) == 0 )
  {
    sub_1C3B764(&BattleServantConfSkillComponent_TypeInfo, *(_QWORD *)&num);
  ...
  if ( num > 9 )
  {
    ...
    titleNumSecondSprite = System_String__Concat_63368612(SKILL_NO_FILE_PREFIX, v18, 0LL);
    if ( titleNumFirstSprite )
    {
      ...
      if ( titleNumSecondSprite )
      {
        ...
        if ( titleNumSecondSprite )
        {
          ...
          titleNumSecondSprite = System_String__Concat_63368612(v22, v23, 0LL);
          if ( v21 )
          {
...
LABEL_28:
    sub_1C3B9C0(titleNumSecondSprite, v20);
  }
  ...
  titleNumSecondSprite = System_String__Concat_63368612(v27, v28, 0LL);
  if ( !v26 )
    goto LABEL_28;
