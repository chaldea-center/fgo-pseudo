void __fastcall BattleServantConfSkillComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A5E178 & 1) == 0 )
  {
    sub_1B885B0(&BattleServantConfSkillComponent_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( num <= 9 )
  {
    ...
    titleNumSecondSprite = System_String__Concat_61707032(SKILL_NO_FILE_PREFIX, v27, 0LL);
...
LABEL_30:
  ...
  titleNumSecondSprite = System_String__Concat_61707032(v16, v17, 0LL);
  if ( !v15 )
    goto LABEL_30;
