        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57D79 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_DataManager_GetMaster_EventPanelMapMaster___);
    sub_1B885B0(&DataManager_TypeInfo);
    sub_1B885B0(&Method_DataMasterBase_EventDetailMaster__EventDetailEntity__int__TryGetEntity__);
    sub_1B885B0(&Method_DataMasterBase_EventPanelMapMaster__EventPanelMapEntity__int__TryGetEntity__);
    sub_1B885B0(&EventMapManagerIdle_TypeInfo);
    termialMap = (ScrTerminalMap_o *)sub_1B885B0(&Method_UnityEngine_GameObject_AddComponent_SubmarineMapManager___);
    byte_4A57D79 = 1;
  }
  v11 = 0LL;
  entity = 0LL;
  ...
  termialMap = (ScrTerminalMap_o *)DataManager__GetMaster_object_((const MethodInfo_2E7F8B4 *)Method_DataManager_GetMaster_EventDetailMaster___);
  if ( !termialMap )
    goto LABEL_22;
  ...
  {
LABEL_20:
    v9 = (Il2CppObject *)sub_1B887FC(EventMapManagerIdle_TypeInfo);
    System_Object___ctor(v9, 0LL);
    return (EventMapManagerInterface_o *)v9;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  termialMap = (ScrTerminalMap_o *)DataManager__GetMaster_object_((const MethodInfo_2E7F8B4 *)Method_DataManager_GetMaster_EventPanelMapMaster___);
  if ( !mapInfo || !termialMap )
LABEL_22:
    sub_1B8880C(termialMap, mapInfo);
  termialMap = (ScrTerminalMap_o *)DataMasterBase_object__object__int___TryGetEntity(
                                     (DataMasterBase_TMaster__TEntity__PKType__o *)termialMap,
                                     &v11,
                                     mapInfo->fields.mapId,
                                     (const MethodInfo_311D988 *)Method_DataMasterBase_EventPanelMapMaster__EventPanelMapEntity__int__TryGetEntity__);
  ...
  return (EventMapManagerInterface_o *)UnityEngine_GameObject__AddComponent_object_(
                                         ...
                                         (const MethodInfo_2ECEDD0 *)Method_UnityEngine_GameObject_AddComponent_SubmarineMapManager___);
}
...
void __fastcall EventMapManagerFactory__DetachFromTerminalMap(ScrTerminalMap_o *termialMap, const MethodInfo *method)
{
  ...
  if ( (byte_4A57D7A & 1) == 0 )
  {
    termialMap = (ScrTerminalMap_o *)sub_1B885B0(&Method_GameObjectExtensions_RemoveComponents_EventMapManagerBase___);
    byte_4A57D7A = 1;
  }
  if ( !v2 )
    sub_1B8880C(termialMap, method);
  gameObject = UnityEngine_Component__get_gameObject(v2, 0LL);
  GameObjectExtensions__RemoveComponents_object_(
    gameObject,
    (const MethodInfo_2ED08DC *)Method_GameObjectExtensions_RemoveComponents_EventMapManagerBase___);
}