        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596CEFC & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_DataManager_GetMaster_EventPanelMapMaster___);
    sub_2213A60(&DataManager_TypeInfo);
    sub_2213A60(&Method_DataMasterBase_EventDetailMaster__EventDetailEntity__int__TryGetEntity__);
    sub_2213A60(&Method_DataMasterBase_EventPanelMapMaster__EventPanelMapEntity__int__TryGetEntity__);
    sub_2213A60(&EventMapManagerIdle_TypeInfo);
    termialMap = (ScrTerminalMap_o *)sub_2213A60(&Method_UnityEngine_GameObject_AddComponent_SubmarineMapManager___);
    byte_596CEFC = 1;
  }
  v15 = 0;
  entity = 0;
  ...
  termialMap = (ScrTerminalMap_o *)DataManager__GetMaster_object_((const MethodInfo_3856318 *)Method_DataManager_GetMaster_EventDetailMaster___);
  if ( !termialMap )
    goto LABEL_22;
  ...
  {
LABEL_20:
    v13 = (Il2CppObject *)sub_2213CCC(EventMapManagerIdle_TypeInfo);
    System_Object___ctor(v13, 0);
    return (EventMapManagerInterface_o *)v13;
  }
  if ( !*(&DataManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo, v11, v12);
  termialMap = (ScrTerminalMap_o *)DataManager__GetMaster_object_((const MethodInfo_3856318 *)Method_DataManager_GetMaster_EventPanelMapMaster___);
  if ( !mapInfo || !termialMap )
LABEL_22:
    sub_2213CDC(termialMap, mapInfo);
  termialMap = (ScrTerminalMap_o *)DataMasterBase_object__object__int___TryGetEntity(
                                     (DataMasterBase_TMaster__TEntity__PKType__o *)termialMap,
                                     &v15,
                                     mapInfo->fields.mapId,
                                     (const MethodInfo_3F10B80 *)Method_DataMasterBase_EventPanelMapMaster__EventPanelMapEntity__int__TryGetEntity__);
  ...
  return (EventMapManagerInterface_o *)UnityEngine_GameObject__AddComponent_object_(
                                         ...
                                         (const MethodInfo_38B6EB0 *)Method_UnityEngine_GameObject_AddComponent_SubmarineMapManager___);
}
...
void EventMapManagerFactory__DetachFromTerminalMap(ScrTerminalMap_o *termialMap, const MethodInfo *method)
{
  ...
  if ( (byte_596CEFD & 1) == 0 )
  {
    termialMap = (ScrTerminalMap_o *)sub_2213A60(&Method_GameObjectExtensions_RemoveComponents_EventMapManagerBase___);
    byte_596CEFD = 1;
  }
  if ( !v2 )
    sub_2213CDC(termialMap, method);
  gameObject = UnityEngine_Component__get_gameObject(v2, 0);
  GameObjectExtensions__RemoveComponents_object_(
    gameObject,
    (const MethodInfo_38B86AC *)Method_GameObjectExtensions_RemoveComponents_EventMapManagerBase___);
}