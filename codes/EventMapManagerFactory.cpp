        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B1160 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_DataManager_GetMaster_EventPanelMapMaster___);
    sub_B52984(&DataManager_TypeInfo);
    sub_B52984(&Method_DataMasterBase_EventDetailMaster__EventDetailEntity__int__TryGetEntity__);
    sub_B52984(&Method_DataMasterBase_EventPanelMapMaster__EventPanelMapEntity__int__TryGetEntity__);
    sub_B52984(&EventMapManagerIdle_TypeInfo);
    termialMap = (ScrTerminalMap_o *)sub_B52984(&Method_UnityEngine_GameObject_AddComponent_SubmarineMapManager___);
    byte_42B1160 = 1;
  }
  v11 = 0LL;
  entity = 0LL;
  ...
  termialMap = (ScrTerminalMap_o *)DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1A4F124 *)Method_DataManager_GetMaster_EventDetailMaster___);
  if ( !termialMap )
    goto LABEL_24;
  ...
  {
LABEL_22:
    v9 = (Il2CppObject *)sub_B52A54(EventMapManagerIdle_TypeInfo);
    System_Object___ctor(v9, 0LL);
    return (EventMapManagerInterface_o *)v9;
  }
  if ( (BYTE3(DataManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0 && !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  termialMap = (ScrTerminalMap_o *)DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1A4F124 *)Method_DataManager_GetMaster_EventPanelMapMaster___);
  if ( !mapInfo || !termialMap )
LABEL_24:
    sub_B52A5C(termialMap, mapInfo);
  termialMap = (ScrTerminalMap_o *)DataMasterBase_WarMaster__WarEntity__int___TryGetEntity(
                                     (DataMasterBase_WarMaster__WarEntity__int__o *)termialMap,
                                     &v11,
                                     mapInfo->fields.mapId,
                                     (const MethodInfo_23E2334 *)Method_DataMasterBase_EventPanelMapMaster__EventPanelMapEntity__int__TryGetEntity__);
  ...
  return (EventMapManagerInterface_o *)UnityEngine_GameObject__AddComponent_UnitySynchronizationContext_SynchronizationContextBehavoir_(
                                         ...
                                         (const MethodInfo_1B7B0BC *)Method_UnityEngine_GameObject_AddComponent_SubmarineMapManager___);
}
...
void __fastcall EventMapManagerFactory__DetachFromTerminalMap(ScrTerminalMap_o *termialMap, const MethodInfo *method)
{
  ...
  if ( (byte_42B1161 & 1) == 0 )
  {
    termialMap = (ScrTerminalMap_o *)sub_B52984(&Method_GameObjectExtensions_RemoveComponents_EventMapManagerBase___);
    byte_42B1161 = 1;
  }
  if ( !v2 )
    sub_B52A5C(termialMap, method);
  gameObject = UnityEngine_Component__get_gameObject(v2, 0LL);
  GameObjectExtensions__RemoveComponents_object_(
    gameObject,
    (const MethodInfo_1B7BE5C *)Method_GameObjectExtensions_RemoveComponents_EventMapManagerBase___);
}