        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A08692 & 1) == 0 )
  {
    sub_1B686D4(&IconLabelInfo_TypeInfo, baseItem);
    byte_4A08692 = 1;
  }
  v5 = (IconLabelInfo_o *)sub_1B68920(IconLabelInfo_TypeInfo);
  IconLabelInfo___ctor(v5, 0LL);
  this->fields.iconLabelInfo = v5;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.iconLabelInfo, (int32_t)v5, v6, v7);
  System_Object___ctor((Il2CppObject *)this, 0LL);
  this->fields.baseItem = baseItem;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)baseItem, v8, v9);
  if ( !baseItem )
    goto LABEL_6;
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.servantEntity, (int32_t)servantEntity, v16, v17);
  ...
  *(_QWORD *)&this->fields.classId = *(_QWORD *)&baseItem->fields.classId;
  ...
  if ( !iconLabelInfo )
LABEL_6:
    sub_1B68930(MaxLevel, v11);
  IconLabelInfo__Set_37887348(iconLabelInfo, 2, Level, MaxLevel, 0, 0, 0, 0, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A08693 & 1) == 0 )
  {
    sub_1B686D4(&Method_DataManager_GetMasterData_ServantMaster___, equipUserSvtId);
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.equipUserSvtEntity, 0, (int32_t)method, v3);
  this->fields.equipServantEntity = 0LL;
  p_equipServantEntity = &this->fields.equipServantEntity;
  sub_1B68678((ServantStatusBattleListViewItem_o *)p_equipServantEntity, 0, v13, v14);
  if ( equipUserSvtId >= 1 )
  {
    ...
    sub_1B68678(p_equipUserSvtEntity, (int32_t)Entity, v18, v19);
      ...
      if ( Instance )
      {
        ...
        if ( p_equipUserSvtEntity->klass )
        {
          ...
          *(_QWORD *)&v31.fields.fakeValue = v25;
          Instance = (Il2CppObject *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46239416(v31, 0LL);
          if ( v24 )
          {
            ...
            *p_equipServantEntity = (struct ServantEntity_o *)v27;
            sub_1B68678((ServantStatusBattleListViewItem_o *)p_equipServantEntity, (int32_t)v27, v28, v29);
            return;
          }
        }
      }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A08694 & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_18984/*"error"*/, v7);
    byte_4A08694 = 1;
  }
  entity = 0LL;
  ...
  if ( userServantEntity )
  {
    ...
    *(_QWORD *)&v26.fields.fakeValue = v9;
    maxLimitCount = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46239416(v26, 0LL);
    goto LABEL_20;
  }
  ...
  *(_QWORD *)&v27.fields.fakeValue = v18;
  UserId = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46239416(v27, 0LL);
  if ( !Master_object )
LABEL_32:
    sub_1B68930(UserId, v15);
...
LABEL_20:
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  UserId = (int64_t)DataManager__GetMaster_object_((const MethodInfo_2E49CFC *)Method_DataManager_GetMaster_ServantLimitImageMaster___);
  ...
  *(_QWORD *)&v28.fields.fakeValue = v22;
  UserId = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46239416(v28, 0LL);
  if ( !v21 )
    goto LABEL_32;
