        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B36982 & 1) == 0 )
  {
    sub_1BD3458(&IconLabelInfo_TypeInfo, baseItem);
    byte_4B36982 = 1;
  }
  v5 = (IconLabelInfo_o *)sub_1BD36A4(IconLabelInfo_TypeInfo);
  IconLabelInfo___ctor(v5, 0LL);
  this->fields.iconLabelInfo = v5;
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.iconLabelInfo, (int64_t)v5, v6, v7, v8, v9, v10, v11);
  System_Object___ctor((Il2CppObject *)this, 0LL);
  this->fields.baseItem = baseItem;
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields, (int64_t)baseItem, v12, v13, v14, v15, v16, v17);
  if ( !baseItem )
    goto LABEL_6;
  ...
  *(_QWORD *)&this->fields.classId = *(_QWORD *)&baseItem->fields.classId;
  ...
  if ( !iconLabelInfo )
LABEL_6:
    sub_1BD36B4(MaxLevel, v19);
  IconLabelInfo__Set_38919304(iconLabelInfo, 2, Level, MaxLevel, 0, 0, 0, 0, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B36983 & 1) == 0 )
  {
    sub_1BD3458(&Method_DataManager_GetMasterData_ServantMaster___, equipUserSvtId);
  ...
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.equipUserSvtEntity, 0LL, (int64_t)method, v3, v4, v5, v6, v7);
  this->fields.equipServantEntity = 0LL;
  p_equipServantEntity = &this->fields.equipServantEntity;
  sub_1BD33FC((PartyOrganizationUtility_o *)p_equipServantEntity, 0LL, v17, v18, v19, v20, v21, v22);
  if ( equipUserSvtId >= 1 )
  {
    ...
    sub_1BD33FC(p_equipUserSvtEntity, (int64_t)Entity, v26, v27, v28, v29, v30, v31);
    ...
    *(_QWORD *)&v46.fields.fakeValue = parent;
    if ( CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47136620(v46, 0LL) >= 1 )
    {
      Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37FDC48 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( Instance )
      {
        ...
        if ( p_equipUserSvtEntity->klass )
        {
          ...
          *(_QWORD *)&v47.fields.fakeValue = v37;
          Instance = (Il2CppObject *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47136620(v47, 0LL);
          if ( v36 )
          {
            ...
            *p_equipServantEntity = (struct ServantEntity_o *)v39;
            sub_1BD33FC((PartyOrganizationUtility_o *)p_equipServantEntity, (int64_t)v39, v40, v41, v42, v43, v44, v45);
            return;
          }
        }
      }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B36984 & 1) == 0 )
  {
    ...
    sub_1BD3458(&Method_DataManager_GetMaster_UserServantCollectionMaster___, v3);
    ...
    sub_1BD3458(&StringLiteral_19278/*"error"*/, v7);
    byte_4B36984 = 1;
  }
  entity = 0LL;
  ...
  if ( userServantEntity )
  {
    ...
    *(_QWORD *)&v25.fields.fakeValue = v9;
    maxLimitCount = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47136620(v25, 0LL);
    goto LABEL_24;
  }
  ...
  *(_QWORD *)&v26.fields.fakeValue = v17;
  v15 = (ServantEntity_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47136620(v26, 0LL);
  if ( !Master_object )
LABEL_34:
    sub_1BD36B4(v15, v13);
  ...
  if ( ((unsigned __int8)v15 & 1) == 0 )
  {
    ...
    if ( v15 )
      return ServantEntity__getName(v15, -1, -1, 0LL);
    goto LABEL_34;
  }
  if ( !entity )
    goto LABEL_34;
...
LABEL_24:
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  v15 = (ServantEntity_o *)DataManager__GetMaster_object_((const MethodInfo_2F31630 *)Method_DataManager_GetMaster_ServantLimitImageMaster___);
  ...
  *(_QWORD *)&v27.fields.fakeValue = v22;
  v15 = (ServantEntity_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47136620(v27, 0LL);
  if ( !v21 )
    goto LABEL_34;
  return ServantLimitImageMaster__GetLimitCountSealedServantName(v21, (int32_t)v15, maxLimitCount, 0LL);
}
