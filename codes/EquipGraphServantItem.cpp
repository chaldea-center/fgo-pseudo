        ...
        const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields, (int32_t)baseItem, v12, v13);
  if ( !baseItem )
    goto LABEL_6;
  userServantEntity = baseItem->fields.userServantEntity;
  v19 = isTempGrand;
  this->fields.userServantEntity = userServantEntity;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.userServantEntity, (int32_t)userServantEntity, v16, v17);
  servantEntity = baseItem->fields.servantEntity;
  this->fields.servantEntity = servantEntity;
  p_servantEntity = &this->fields.servantEntity;
  sub_1C2D434((CGThumbnailListItem_o *)p_servantEntity, (int32_t)servantEntity, v22, v23);
  ...
  *((_BYTE *)p_servantEntity + 72) = v19;
  ...
  if ( !v25 )
LABEL_6:
    sub_1C2D6EC(MaxLevel, v15);
  IconLabelInfo__Set_40696284(v25, 2, Level, MaxLevel, 0, 0, 0, 0, 0, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.equipUserSvtEntity, 0, (int32_t)method, v3);
  this->fields.equipServantEntity = 0;
  p_equipServantEntity = &this->fields.equipServantEntity;
  sub_1C2D434((CGThumbnailListItem_o *)p_equipServantEntity, 0, v8, v9);
  if ( equipUserSvtId >= 1 )
  {
    ...
    sub_1C2D434(p_equipUserSvtEntity, (int32_t)Entity, v13, v14);
    ...
    *(_QWORD *)&v25.fields.fakeValue = parent;
    if ( CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v25, 0) >= 1 )
    {
      Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39D3CCC *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( Instance )
      {
        ...
        if ( p_equipUserSvtEntity->klass )
        {
          ...
          *(_QWORD *)&v26.fields.fakeValue = v20;
          Instance = (Il2CppObject *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v26, 0);
          if ( v19 )
          {
            ...
            *p_equipServantEntity = (struct ServantEntity_o *)v22;
            sub_1C2D434((CGThumbnailListItem_o *)p_equipServantEntity, (int32_t)v22, v23, v24);
            return;
          }
        }
      }
...
System_String_o *EquipGraphServantItem__get_NameText(EquipGraphServantItem_o *this, const MethodInfo *method)
{
  ...
  if ( userServantEntity )
  {
    ...
    *(_QWORD *)&v20.fields.fakeValue = v4;
    maxLimitCount = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v20, 0);
    goto LABEL_24;
  }
  ...
  *(_QWORD *)&v21.fields.fakeValue = v12;
  v10 = (ServantEntity_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v21, 0);
  if ( !Master_object )
LABEL_34:
    sub_1C2D6EC(v10, v8);
...
LABEL_24:
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  v10 = (ServantEntity_o *)DataManager__GetMaster_object_((const MethodInfo_30CE8FC *)Method_DataManager_GetMaster_ServantLimitImageMaster___);
  ...
  *(_QWORD *)&v22.fields.fakeValue = v17;
  v10 = (ServantEntity_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v22, 0);
  if ( !v16 )
    goto LABEL_34;
