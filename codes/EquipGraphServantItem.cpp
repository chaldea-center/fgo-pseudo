        ...
        const MethodInfo *method)
{
  ...
  sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields, (int32_t)baseItem, v16, v17, v18, v19, v20, v21);
  if ( !baseItem )
    goto LABEL_6;
  ...
  sub_1C71354((GrandQuestFolderBoardItem_o *)p_servantEntity, (int32_t)servantEntity, v34, v35, v36, v37, v38, v39);
  ...
  *((_BYTE *)p_servantEntity + 72) = v31;
  ...
  if ( !v41 )
LABEL_6:
    sub_1C71608(MaxLevel, v23);
  IconLabelInfo__Set_41192248(v41, 2, Level, MaxLevel, 0, 0, 0, 0, 0, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.equipUserSvtEntity, 0, (int32_t)method, v3, v4, v5, v6, v7);
  this->fields.equipServantEntity = 0;
  p_equipServantEntity = &this->fields.equipServantEntity;
  sub_1C71354((GrandQuestFolderBoardItem_o *)p_equipServantEntity, 0, v12, v13, v14, v15, v16, v17);
  if ( equipUserSvtId >= 1 )
  {
    ...
    sub_1C71354(p_equipUserSvtEntity, (int32_t)Entity, v21, v22, v23, v24, v25, v26);
      ...
      if ( Instance )
      {
        ...
        if ( p_equipUserSvtEntity->klass )
        {
          ...
          *(_QWORD *)&v42.fields.fakeValue = v32;
          Instance = (Il2CppObject *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49297952(v42, 0);
          if ( v31 )
          {
            ...
            *p_equipServantEntity = (struct ServantEntity_o *)v34;
            sub_1C71354((GrandQuestFolderBoardItem_o *)p_equipServantEntity, (int32_t)v34, v35, v36, v37, v38, v39, v40);
            return;
          }
        }
      }
...
System_String_o *EquipGraphServantItem__get_NameText(EquipGraphServantItem_o *this, const MethodInfo *method)
{
  ...
  if ( userServantEntity )
  {
    ...
    *(_QWORD *)&v20.fields.fakeValue = v4;
    maxLimitCount = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49297952(v20, 0);
    goto LABEL_24;
  }
  ...
  *(_QWORD *)&v21.fields.fakeValue = v12;
  v10 = (ServantEntity_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49297952(v21, 0);
  if ( !Master_object )
LABEL_34:
    sub_1C71608(v10, v8);
...
LABEL_24:
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  v10 = (ServantEntity_o *)DataManager__GetMaster_object_((const MethodInfo_314B0B8 *)Method_DataManager_GetMaster_ServantLimitImageMaster___);
  ...
  *(_QWORD *)&v22.fields.fakeValue = v17;
  v10 = (ServantEntity_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49297952(v22, 0);
  if ( !v16 )
    goto LABEL_34;
