        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A495AB & 1) == 0 )
  {
    this = (CGThumbnailListItemDraw_o *)sub_1B863B8(&Method_AssetData_GetObject_Texture2D___, item);
    byte_4A495AB = 1;
  }
  if ( !item )
    goto LABEL_9;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A495AA & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_CGThumbnailListItemDraw___c__DisplayClass12_0__SetItem_b__0__, v9);
    sub_1B863B8(&Method_CGThumbnailListItemDraw___c__DisplayClass12_0__SetItem_b__1__, v10);
    sub_1B863B8(&CGThumbnailListItemDraw___c__DisplayClass12_0_TypeInfo, v11);
    byte_4A495AA = 1;
  }
  v12 = sub_1B86604(CGThumbnailListItemDraw___c__DisplayClass12_0_TypeInfo);
  ...
  *(_QWORD *)(v12 + 24) = item;
  v17 = v12 + 24;
  sub_1B8635C((CGThumbnailListItem_o *)(v12 + 24), (int32_t)item, v18, v19);
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields._LoadedTexturePath_k__BackingField, (int32_t)v22, v20, v21);
  if ( !*(_QWORD *)v17 )
    goto LABEL_36;
  ...
  cgThumbnailTexture = (UnityEngine_GameObject_o *)AssetManager__getAssetStorage_38753424(v23, v24, 0LL);
  ...
  if ( max_length >= scaleType )
  {
    ...
    if ( !cgThumbnailTexture )
      goto LABEL_36;
    v30 = v29;
    v31 = notifyObjectSize->m_Items[v29 + 1];
    ...
    v34.fields.x = v31;
    v34.fields.y = v31;
    UnityEngine_Transform__set_localScale((UnityEngine_Transform_o *)cgThumbnailTexture, v34, 0LL);
    cgThumbnailTexture = this->fields.movieNotifyObject;
    if ( !cgThumbnailTexture )
      goto LABEL_36;
    cgThumbnailTexture = (UnityEngine_GameObject_o *)UnityEngine_GameObject__get_transform(cgThumbnailTexture, 0LL);
    ...
    if ( !cgDiffNotifyPos )
      goto LABEL_36;
    if ( (unsigned int)v30 >= cgDiffNotifyPos->max_length )
      goto LABEL_37;
    if ( !cgThumbnailTexture )
      goto LABEL_36;
    UnityEngine_Transform__set_localPosition(
      (UnityEngine_Transform_o *)cgThumbnailTexture,
      *(UnityEngine_Vector3_o *)&cgDiffNotifyPos->m_Items[v30].fields.y,
      0LL);
    cgThumbnailTexture = this->fields.movieNotifyObject;
    if ( !cgThumbnailTexture )
      goto LABEL_36;
    ...
    if ( !movieDiffNotifyPos )
      goto LABEL_36;
    if ( (unsigned int)v30 >= movieDiffNotifyPos->max_length )
LABEL_37:
      sub_1B8661C(cgThumbnailTexture, v14);
    if ( cgThumbnailTexture )
    {
      UnityEngine_Transform__set_localPosition(
        (UnityEngine_Transform_o *)cgThumbnailTexture,
        *(UnityEngine_Vector3_o *)&movieDiffNotifyPos->m_Items[v30].fields.y,
        0LL);
      return;
    }
LABEL_36:
    sub_1B86614(cgThumbnailTexture, v14);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !this->fields.__4__this )
    sub_1B86614(this, loadedAssetData);
