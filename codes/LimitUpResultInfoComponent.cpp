        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42E7D6C & 1) == 0 )
  {
    sub_B5D5C4(&AtlasManager_TypeInfo, (_DWORD)title, (_DWORD)detail, method);
    sub_B5D5C4(&StringLiteral_20490/*"line_whiteAlpha"*/, v7, v8, v9);
    byte_42E7D6C = 1;
  }
  ...
  AtlasManager__SetEventUI(lineSprite, (System_String_o *)StringLiteral_20490/*"line_whiteAlpha"*/, 0LL);
}