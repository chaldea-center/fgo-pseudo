        ...
        const MethodInfo *method)
{
  ...
  if ( !byte_4B31941 )
  {
    transform = (UnityEngine_GameObject_o *)sub_1BD3458(&UnityEngine_Vector3_TypeInfo, v7);
    byte_4B31941 = 1;
  }
  if ( !v8 )
    goto LABEL_15;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3ABBA & 1) == 0 )
  {
    sub_1BD3458(&AtlasManager_TypeInfo, title);
    sub_1BD3458(&StringLiteral_21374/*"line_whiteAlpha"*/, v7);
    byte_4B3ABBA = 1;
  }
  ...
  AtlasManager__SetEventUI(lineSprite, (System_String_o *)StringLiteral_21374/*"line_whiteAlpha"*/, 0LL);
}