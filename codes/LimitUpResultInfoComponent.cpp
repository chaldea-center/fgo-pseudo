        ...
        const MethodInfo *method)
{
  ...
  if ( !byte_4B612E1 )
  {
    transform = (UnityEngine_GameObject_o *)sub_1BE4ACC(&UnityEngine_Vector3_TypeInfo, v7);
    byte_4B612E1 = 1;
  }
  if ( !v8 )
    goto LABEL_15;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A652 & 1) == 0 )
  {
    sub_1BE4ACC(&AtlasManager_TypeInfo, title);
    sub_1BE4ACC(&StringLiteral_21414/*"line_whiteAlpha"*/, v7);
    byte_4B6A652 = 1;
  }
  ...
  AtlasManager__SetEventUI(lineSprite, (System_String_o *)StringLiteral_21414/*"line_whiteAlpha"*/, 0LL);
}