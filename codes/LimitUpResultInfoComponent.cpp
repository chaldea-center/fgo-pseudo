        ...
        const MethodInfo *method)
{
  ...
  if ( !byte_4A6A9C1 )
  {
    transform = (UnityEngine_GameObject_o *)sub_1B90010(&UnityEngine_Vector3_TypeInfo, v7);
    byte_4A6A9C1 = 1;
  }
  if ( !v8 )
    goto LABEL_15;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73792 & 1) == 0 )
  {
    sub_1B90010(&AtlasManager_TypeInfo, title);
    sub_1B90010(&StringLiteral_21146/*"line_whiteAlpha"*/, v7);
    byte_4A73792 = 1;
  }
  ...
  AtlasManager__SetEventUI(lineSprite, (System_String_o *)StringLiteral_21146/*"line_whiteAlpha"*/, 0LL);
}