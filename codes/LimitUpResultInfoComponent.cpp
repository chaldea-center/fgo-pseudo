        ...
        const MethodInfo *method)
{
  ...
  if ( !byte_4BF7D91 )
  {
    transform = (UnityEngine_GameObject_o *)sub_1C2E12C(&UnityEngine_Vector3_TypeInfo, v7);
    byte_4BF7D91 = 1;
  }
  if ( !v8 )
    goto LABEL_15;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C012C9 & 1) == 0 )
  {
    sub_1C2E12C(&AtlasManager_TypeInfo, title);
    sub_1C2E12C(&StringLiteral_21506/*"line_whiteAlpha"*/, v7);
    byte_4C012C9 = 1;
  }
  ...
  AtlasManager__SetEventUI(lineSprite, (System_String_o *)StringLiteral_21506/*"line_whiteAlpha"*/, 0LL);
}