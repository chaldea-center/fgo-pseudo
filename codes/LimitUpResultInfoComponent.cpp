        ...
        const MethodInfo *method)
{
  ...
  if ( !byte_4AFBDB1 )
  {
    transform = (UnityEngine_GameObject_o *)sub_1BC3008(&UnityEngine_Vector3_TypeInfo, v7);
    byte_4AFBDB1 = 1;
  }
  if ( !v8 )
    goto LABEL_15;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05EDE & 1) == 0 )
  {
    sub_1BC3008(&AtlasManager_TypeInfo, title);
    sub_1BC3008(&StringLiteral_21039/*"line_whiteAlpha"*/, v7);
    byte_4B05EDE = 1;
  }
  ...
  AtlasManager__SetEventUI(lineSprite, (System_String_o *)StringLiteral_21039/*"line_whiteAlpha"*/, 0LL);
}