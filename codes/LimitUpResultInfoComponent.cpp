        ...
        const MethodInfo *method)
{
  ...
  if ( !byte_4BAEDA1 )
  {
    transform = (UnityEngine_GameObject_o *)sub_1C13D24(&UnityEngine_Vector3_TypeInfo, v7);
    byte_4BAEDA1 = 1;
  }
  if ( !v8 )
    goto LABEL_15;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB8174 & 1) == 0 )
  {
    sub_1C13D24(&AtlasManager_TypeInfo, title);
    sub_1C13D24(&StringLiteral_21463/*"limitCountGiftIdDic"*/, v7);
    byte_4BB8174 = 1;
  }
  titleLabel = this->fields.titleLabel;
  if ( !titleLabel
    || (UILabel__set_text(titleLabel, title, 0LL), (titleLabel = this->fields.detailLabel) == 0LL)
    || (WrapControlText__textAdjust(titleLabel, detail, titleLabel->fields.mFontSize, 0, 0LL),
  ...
  AtlasManager__SetEventUI(lineSprite, (System_String_o *)StringLiteral_21463/*"limitCountGiftIdDic"*/, 0LL);
}