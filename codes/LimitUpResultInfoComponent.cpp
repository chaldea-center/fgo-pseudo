        ...
        const MethodInfo *method)
{
  ...
  if ( !byte_4A03901 )
  {
    transform = (UnityEngine_GameObject_o *)sub_1B686D4(&UnityEngine_Vector3_TypeInfo, v7);
    byte_4A03901 = 1;
  }
  if ( !v8 )
    goto LABEL_15;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0C50B & 1) == 0 )
  {
    sub_1B686D4(&AtlasManager_TypeInfo, title);
    sub_1B686D4(&StringLiteral_21046/*"line_whiteAlpha"*/, v7);
    byte_4A0C50B = 1;
  }
  ...
  AtlasManager__SetEventUI(lineSprite, (System_String_o *)StringLiteral_21046/*"line_whiteAlpha"*/, 0LL);
}