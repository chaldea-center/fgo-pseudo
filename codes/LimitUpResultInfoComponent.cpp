        ...
        const MethodInfo *method)
{
  ...
  if ( !byte_49F9821 )
  {
    transform = (UnityEngine_GameObject_o *)sub_1B64A00(&UnityEngine_Vector3_TypeInfo, v7);
    byte_49F9821 = 1;
  }
  if ( !v8 )
    goto LABEL_15;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A023B3 & 1) == 0 )
  {
    sub_1B64A00(&AtlasManager_TypeInfo, title);
    sub_1B64A00(&StringLiteral_21038/*"line_whiteAlpha"*/, v7);
    byte_4A023B3 = 1;
  }
  ...
  AtlasManager__SetEventUI(lineSprite, (System_String_o *)StringLiteral_21038/*"line_whiteAlpha"*/, 0LL);
}