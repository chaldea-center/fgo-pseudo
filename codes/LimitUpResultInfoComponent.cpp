        ...
        const MethodInfo *method)
{
  ...
  if ( !byte_4B3E911 )
  {
    transform = (UnityEngine_GameObject_o *)sub_1BDB878(&UnityEngine_Vector3_TypeInfo, v7);
    byte_4B3E911 = 1;
  }
  if ( !v8 )
    goto LABEL_15;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48905 & 1) == 0 )
  {
    sub_1BDB878(&AtlasManager_TypeInfo, title);
    sub_1BDB878(&StringLiteral_21262/*"line_whiteAlpha"*/, v7);
    byte_4B48905 = 1;
  }
  ...
  AtlasManager__SetEventUI(lineSprite, (System_String_o *)StringLiteral_21262/*"line_whiteAlpha"*/, 0LL);
}