        ...
        const MethodInfo *method)
{
  ...
  if ( !byte_4A487E1 )
  {
    transform = (UnityEngine_GameObject_o *)sub_1B863B8(&UnityEngine_Vector3_TypeInfo, v7);
    byte_4A487E1 = 1;
  }
  if ( !v8 )
    goto LABEL_15;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A52220 & 1) == 0 )
  {
    sub_1B863B8(&AtlasManager_TypeInfo, title);
    sub_1B863B8(&StringLiteral_20934/*"line_whiteAlpha"*/, v7);
    byte_4A52220 = 1;
  }
  ...
  AtlasManager__SetEventUI(lineSprite, (System_String_o *)StringLiteral_20934/*"line_whiteAlpha"*/, 0LL);
}