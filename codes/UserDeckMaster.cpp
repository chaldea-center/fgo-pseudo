void __fastcall UserDeckMaster___ctor(UserDeckMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A4F19A & 1) == 0 )
  {
    sub_1B863B8(&Method_DataMasterBase_UserDeckMaster__UserDeckEntity__long___ctor__, method);
    byte_4A4F19A = 1;
  }
  DataMasterBase_object__object__long____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    29,
    (const MethodInfo_32144B8 *)Method_DataMasterBase_UserDeckMaster__UserDeckEntity__long___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4F1A1 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataMasterBase_UserDeckMaster__UserDeckEntity__long__GetEntity__, method);
    byte_4A4F1A1 = 1;
  }
  ...
  if ( !result
    || (v5 = result,
        (result = (UserServantEntity_array *)DataMasterBase_object__object__long___GetEntity(
                                               ...
                                               (const MethodInfo_32167DC *)Method_DataMasterBase_UserDeckMaster__UserDeckEntity__long__GetEntity__)) == 0LL)
        ...
        const MethodInfo *method)
{
  ...
  if ( result )
  {
    ...
    result = (UserServantEntity_array *)DataMasterBase_object__object__long___GetEntity(
                                          (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                          (int64_t)result->m_Items[20],
                                          (const MethodInfo_32167DC *)Method_DataMasterBase_UserDeckMaster__UserDeckEntity__long__GetEntity__);
    if ( result )
    {
...
bool __fastcall UserDeckMaster__IsEquip(UserDeckMaster_o *this, int64_t userSvtId, const MethodInfo *method)
{
  ...
  if ( (byte_4A4F19F & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_System_Collections_ObjectModel_Collection_UserDeckEntity__get_Count__, v5);
    sub_1B863B8(&Method_System_Collections_ObjectModel_Collection_UserDeckEntity__get_Item__, v6);
    byte_4A4F19F = 1;
  }
  ...
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            list,
            (const MethodInfo_31B0908 *)Method_System_Collections_ObjectModel_Collection_UserDeckEntity__get_Count__);
  if ( Count >= 1 )
  {
    v9 = Count;
    v10 = 0;
    ...
    while ( 1 )
    {
      ...
      Item = System_Collections_ObjectModel_Collection_object___get_Item(
               list,
               v10,
               (const MethodInfo_31B0998 *)Method_System_Collections_ObjectModel_Collection_UserDeckEntity__get_Item__);
      if ( !Item )
        goto LABEL_20;
      v13 = Item;
...
LABEL_17:
    sub_1B86614(list, userSvtId);
  }
  return 0;
}


bool __fastcall UserDeckMaster__IsEquip_41089732(
        UserDeckMaster_o *this,
        int64_t userSvtId,
        int32_t *partyIndex,
        const MethodInfo *method)
{
  ...
  {
    sub_1B863B8(&BalanceConfig_TypeInfo, userSvtId);
    sub_1B863B8(&Method_System_Collections_ObjectModel_Collection_UserDeckEntity__get_Count__, v7);
    sub_1B863B8(&Method_System_Collections_ObjectModel_Collection_UserDeckEntity__get_Item__, v8);
    byte_4A4F1A0 = 1;
  }
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4F1A4 & 1) == 0 )
  {
    this = (UserDeckMaster_o *)sub_1B863B8(&UserServantEntity___TypeInfo, deck);
    byte_4A4F1A4 = 1;
  }
  if ( !deck )
    goto LABEL_24;
  this = (UserDeckMaster_o *)sub_1B86460(UserServantEntity___TypeInfo, deck->max_length);
  *cnt = 0;
      ...
      if ( v13 )
      {
              ...
              ((unsigned __int8)this & 1) == 0) )
        {
          if ( !v11 )
            goto LABEL_24;
          v14 = *cnt;
          this = (UserDeckMaster_o *)sub_1B864F4(v13, v11->obj.klass->_1.element_class);
          if ( !this )
          {
            v22 = sub_1B86638(0LL);
            sub_1B864E0(v22, 0LL);
          ...
          sub_1B8635C((CGThumbnailListItem_o *)(v17 + 4), (int32_t)v13, v15, v16);
          ++*cnt;
        }
      }
  ...
  if ( v18 < (int)v10 )
  {
    if ( v11 )
    {
      ...
      while ( (unsigned int)v19 < v11->max_length )
      {
        ...
        sub_1B8635C((CGThumbnailListItem_o *)this, 0, v8, v9);
        ++v19;
        this = p_monitor;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4F19B & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Collections_ObjectModel_Collection_UserDeckEntity__get_Count__, userId);
    sub_1B863B8(&Method_System_Collections_ObjectModel_Collection_UserDeckEntity__get_Item__, v7);
    byte_4A4F19B = 1;
  }
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4F19C & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_System_Collections_ObjectModel_Collection_UserDeckEntity__get_Count__, v5);
    sub_1B863B8(&Method_System_Collections_ObjectModel_Collection_UserDeckEntity__get_Item__, v6);
    sub_1B863B8(&Method_System_Collections_Generic_List_UserDeckEntity__Add__, v7);
    sub_1B863B8(&Method_System_Collections_Generic_List_UserDeckEntity___ctor__, v8);
    sub_1B863B8(&Method_System_Collections_Generic_List_UserDeckEntity__get_Count__, v9);
    sub_1B863B8(&Method_System_Collections_Generic_List_UserDeckEntity__get_Item__, v10);
    sub_1B863B8(&System_Collections_Generic_List_UserDeckEntity__TypeInfo, v11);
    sub_1B863B8(&UserDeckEntity___TypeInfo, v12);
    byte_4A4F19C = 1;
  }
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
  ...
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            list,
            (const MethodInfo_31B0908 *)Method_System_Collections_ObjectModel_Collection_UserDeckEntity__get_Count__);
  v15 = (System_Collections_Generic_List_object__o *)sub_1B86604(System_Collections_Generic_List_UserDeckEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v15,
    (const MethodInfo_35FC124 *)Method_System_Collections_Generic_List_UserDeckEntity___ctor__);
  if ( Count >= 1 )
  {
    v16 = 0;
    while ( 1 )
        ...
        if ( list[1].klass == (System_Collections_ObjectModel_Collection_T__c *)userId )
        {
          ...
          if ( monitor <= SHIDWORD(list[7].fields.items[9].klass) )
          {
            ...
            else
            {
              ...
              sub_1B8635C((CGThumbnailListItem_o *)(v24 + 4), (int32_t)v19, v17, v18);
            }
          }
        }
      }
...
LABEL_18:
  ...
  v30 = (UserDeckEntity_array *)sub_1B86460(UserDeckEntity___TypeInfo, (unsigned int)*p_DeckMax);
  if ( *p_size >= 1 )
  {
    v31 = 0;
    while ( 1 )
    {
      list = (System_Collections_ObjectModel_Collection_T__o *)System_Collections_Generic_List_object___get_Item(
                                                                 v15,
                                                                 v31,
                                                                 (const MethodInfo_35FC688 *)Method_System_Collections_Generic_List_UserDeckEntity__get_Item__);
      if ( !list || !v30 )
        break;
      ...
      {
        v34 = sub_1B864F4(list, v30->obj.klass->_1.element_class);
        if ( !v34 )
        {
          v40 = sub_1B86638(0LL);
          sub_1B864E0(v40, 0LL);
        ...
        *((_QWORD *)v38 + 4) = v33;
        sub_1B8635C((CGThumbnailListItem_o *)(v38 + 32), (int32_t)v33, v36, v37);
      }
      if ( ++v31 >= *p_size )
        return v30;
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4F19E & 1) == 0 )
  {
    sub_1B863B8(&BalanceConfig_TypeInfo, svtIdList);
    sub_1B863B8(&Method_System_Collections_ObjectModel_Collection_UserDeckEntity__get_Count__, v8);
    sub_1B863B8(&Method_System_Collections_ObjectModel_Collection_UserDeckEntity__get_Item__, v9);
    sub_1B863B8(&Method_DataManager_GetMasterData_UserEventDeckMaster___, v10);
    sub_1B863B8(&Method_System_Collections_Generic_List_long__ToArray__, v11);
    sub_1B863B8(&Method_System_Collections_Generic_List_long___ctor__, v12);
...
LABEL_15:
  ...
  if ( !byte_4A48C25 )
  {
    sub_1B863B8(&NetworkManager_TypeInfo, svtIdList);
    byte_4A48C25 = 1;
  }
  ...
  if ( !MasterData_object )
    goto LABEL_26;
  UserEventDeckMaster__getEventPartyList_41088952(
  ...
  *svtIdList = v27;
  sub_1B8635C((CGThumbnailListItem_o *)svtIdList, (int32_t)v27, v28, v29);
  if ( !v19 )
    goto LABEL_26;
  v30 = System_Collections_Generic_List_long___ToArray(
          ...
          (const MethodInfo_35E6444 *)Method_System_Collections_Generic_List_long__ToArray__);
  *equipIdList = v30;
  sub_1B8635C((CGThumbnailListItem_o *)equipIdList, (int32_t)v30, v31, v32);
}
...
LABEL_15:
  ...
  v20 = System_Collections_Generic_List_long___ToArray(
          ...
          (const MethodInfo_35E6444 *)Method_System_Collections_Generic_List_long__ToArray__);
  *svtIdList = v20;
  sub_1B8635C((CGThumbnailListItem_o *)svtIdList, (int32_t)v20, v21, v22);
  if ( !v16 )
    goto LABEL_18;
  v23 = System_Collections_Generic_List_long___ToArray(
          ...
          (const MethodInfo_35E6444 *)Method_System_Collections_Generic_List_long__ToArray__);
  *equipIdList = v23;
  sub_1B8635C((CGThumbnailListItem_o *)equipIdList, (int32_t)v23, v24, v25);
}