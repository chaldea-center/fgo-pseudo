void __fastcall UserDeckMaster___ctor(UserDeckMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A206AD & 1) == 0 )
  {
    sub_1B715CC(&Method_DataMasterBase_UserDeckMaster__UserDeckEntity__long___ctor__, method);
    byte_4A206AD = 1;
  }
  DataMasterBase_object__object__long____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    29,
    (const MethodInfo_30F88CC *)Method_DataMasterBase_UserDeckMaster__UserDeckEntity__long___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A206B4 & 1) == 0 )
  {
    this = (UserDeckMaster_o *)sub_1B715CC(
  ...
  if ( !result
    || (v5 = result,
        (result = (UserServantEntity_array *)DataMasterBase_object__object__long___GetEntity(
                                               ...
                                               (const MethodInfo_30F890C *)Method_DataMasterBase_UserDeckMaster__UserDeckEntity__long__GetEntity__)) == 0LL)
        ...
        const MethodInfo *method)
{
  ...
  if ( result )
  {
    ...
    result = (UserServantEntity_array *)DataMasterBase_object__object__long___GetEntity(
                                          v2,
                                          (int64_t)result->m_Items[20],
                                          (const MethodInfo_30F890C *)Method_DataMasterBase_UserDeckMaster__UserDeckEntity__long__GetEntity__);
    if ( result )
    {
...
LABEL_19:
    sub_1B71828(list, userSvtId);
  }
  return 0;
}


bool __fastcall UserDeckMaster__IsEquip_39844268(
        UserDeckMaster_o *this,
        int64_t userSvtId,
        int32_t *partyIndex,
        const MethodInfo *method)
{
  ...
  if ( (byte_4A206B3 & 1) == 0 )
  {
    ...
    sub_1B715CC(&UserDeckEntity_TypeInfo, v9);
    byte_4A206B3 = 1;
  }
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A206B7 & 1) == 0 )
  {
    this = (UserDeckMaster_o *)sub_1B715CC(&UserServantEntity___TypeInfo, deck);
    byte_4A206B7 = 1;
  }
  if ( !deck )
    goto LABEL_24;
  this = (UserDeckMaster_o *)sub_1B71674(UserServantEntity___TypeInfo, deck->max_length);
  *cnt = 0;
      ...
      if ( v13 )
      {
              ...
              ((unsigned __int8)this & 1) == 0) )
        {
          if ( !v11 )
            goto LABEL_24;
          v14 = *cnt;
          this = (UserDeckMaster_o *)sub_1B71708(v13, v11->obj.klass->_1.element_class);
          if ( !this )
          {
            v22 = sub_1B7184C(0LL);
            sub_1B716F4(v22, 0LL);
          ...
          sub_1B71570((ServantStatusBattleListViewItem_o *)(v17 + 4), (int32_t)v13, v15, v16);
          ++*cnt;
        }
      }
  ...
  if ( v18 < (int)v10 )
  {
    if ( v11 )
    {
      ...
      while ( (unsigned int)v19 < v11->max_length )
      {
        ...
        sub_1B71570((ServantStatusBattleListViewItem_o *)this, 0, v8, v9);
        ++v19;
        this = p_monitor;
...
LABEL_23:
      sub_1B71830(this, deck);
    }
LABEL_24:
    sub_1B71828(this, deck);
  }
  return v11;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A206AE & 1) == 0 )
  {
    ...
    sub_1B715CC(&UserDeckEntity_TypeInfo, v8);
    byte_4A206AE = 1;
  }
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A206AF & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__, v5);
    sub_1B715CC(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Item__, v6);
    sub_1B715CC(&Method_System_Collections_Generic_List_UserDeckEntity__Add__, v7);
    sub_1B715CC(&Method_System_Collections_Generic_List_UserDeckEntity___ctor__, v8);
    sub_1B715CC(&Method_System_Collections_Generic_List_UserDeckEntity__get_Count__, v9);
    sub_1B715CC(&Method_System_Collections_Generic_List_UserDeckEntity__get_Item__, v10);
    sub_1B715CC(&System_Collections_Generic_List_UserDeckEntity__TypeInfo, v11);
    sub_1B715CC(&UserDeckEntity___TypeInfo, v12);
    sub_1B715CC(&UserDeckEntity_TypeInfo, v13);
    byte_4A206AF = 1;
  }
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
  ...
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            list,
            (const MethodInfo_3095AA8 *)Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__);
  v16 = (System_Collections_Generic_List_object__o *)sub_1B71818(System_Collections_Generic_List_UserDeckEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v16,
    (const MethodInfo_34CFA2C *)Method_System_Collections_Generic_List_UserDeckEntity___ctor__);
  if ( Count >= 1 )
  {
    v17 = 0;
    while ( 1 )
          ...
          && list[1].klass == (System_Collections_ObjectModel_Collection_T__c *)userId )
        {
          ...
          if ( monitor <= SHIDWORD(list[7].fields.items[9].klass) )
          {
            ...
            else
            {
              ...
              sub_1B71570((ServantStatusBattleListViewItem_o *)(v26 + 4), (int32_t)v20, v18, v19);
            }
          }
        }
      }
...
LABEL_20:
  ...
  v32 = (UserDeckEntity_array *)sub_1B71674(UserDeckEntity___TypeInfo, (unsigned int)*p_DeckMax);
  if ( *p_size >= 1 )
  {
    v33 = 0;
    while ( 1 )
    {
      list = (System_Collections_ObjectModel_Collection_T__o *)System_Collections_Generic_List_object___get_Item(
                                                                 v16,
                                                                 v33,
                                                                 (const MethodInfo_34CFF90 *)Method_System_Collections_Generic_List_UserDeckEntity__get_Item__);
      if ( !list || !v32 )
        break;
      ...
      {
        v36 = sub_1B71708(list, v32->obj.klass->_1.element_class);
        if ( !v36 )
        {
          v42 = sub_1B7184C(0LL);
          sub_1B716F4(v42, 0LL);
        ...
        *((_QWORD *)v40 + 4) = v35;
        sub_1B71570((ServantStatusBattleListViewItem_o *)(v40 + 32), (int32_t)v35, v38, v39);
      }
      if ( ++v33 >= *p_size )
        return v32;
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A206B1 & 1) == 0 )
  {
    sub_1B715CC(&BalanceConfig_TypeInfo, svtIdList);
    sub_1B715CC(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__, v7);
    sub_1B715CC(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Item__, v8);
    sub_1B715CC(&Method_DataManager_GetMasterData_UserEventDeckMaster___, v9);
    ...
    sub_1B715CC(&UserDeckEntity_TypeInfo, v15);
    byte_4A206B1 = 1;
  }
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
...
LABEL_17:
  ...
  MasterData_object = DataManager__GetMasterData_object_(
                        (DataManager_o *)list,
                        (const MethodInfo_2E5B3E8 *)Method_DataManager_GetMasterData_UserEventDeckMaster___);
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  list = (System_Collections_ObjectModel_Collection_T__o *)NetworkManager__get_UserId(0LL);
  if ( !MasterData_object )
    goto LABEL_24;
  UserEventDeckMaster__getEventPartyList_39843348(
  ...
  *svtIdList = v28;
  sub_1B71570((ServantStatusBattleListViewItem_o *)svtIdList, (int32_t)v28, v29, v30);
  if ( !v19 )
    goto LABEL_24;
  v31 = System_Collections_Generic_List_long___ToArray(
          ...
          (const MethodInfo_34B9D4C *)Method_System_Collections_Generic_List_long__ToArray__);
  *equipIdList = v31;
  sub_1B71570((ServantStatusBattleListViewItem_o *)equipIdList, (int32_t)v31, v32, v33);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A206B0 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__, v7);
    sub_1B715CC(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Item__, v8);
    sub_1B715CC(&Method_System_Collections_Generic_List_long__ToArray__, v9);
    sub_1B715CC(&Method_System_Collections_Generic_List_long___ctor__, v10);
    sub_1B715CC(&System_Collections_Generic_List_long__TypeInfo, v11);
    sub_1B715CC(&UserDeckEntity_TypeInfo, v12);
    byte_4A206B0 = 1;
  }
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
...
LABEL_17:
  ...
  v21 = System_Collections_Generic_List_long___ToArray(
          ...
          (const MethodInfo_34B9D4C *)Method_System_Collections_Generic_List_long__ToArray__);
  *svtIdList = v21;
  sub_1B71570((ServantStatusBattleListViewItem_o *)svtIdList, (int32_t)v21, v22, v23);
  if ( !v16 )
    goto LABEL_20;
  v24 = System_Collections_Generic_List_long___ToArray(
          ...
          (const MethodInfo_34B9D4C *)Method_System_Collections_Generic_List_long__ToArray__);
  *equipIdList = v24;
  sub_1B71570((ServantStatusBattleListViewItem_o *)equipIdList, (int32_t)v24, v25, v26);
}