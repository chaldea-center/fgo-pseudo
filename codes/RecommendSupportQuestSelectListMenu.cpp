        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF9889 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&StringLiteral_11233/*"RECOMMEND_SUPPORT_QUEST_SELECT_MENU_EXPLANATION"*/, v5);
    byte_4BF9889 = 1;
  }
  listViewManager = this->fields.listViewManager;
  if ( !listViewManager )
  ...
  v8 = LocalizationManager__Get((System_String_o *)StringLiteral_11233/*"RECOMMEND_SUPPORT_QUEST_SELECT_MENU_EXPLANATION"*/, 0LL);
  listViewManager = (RecommendSupportQuestBoardListViewManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38A7F90 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__);
  if ( !listViewManager
        ...
        const MethodInfo *method)
{
  ...
  sub_1C2E0D0((PartyOrganizationUtility_o *)v6, (int64_t)warEnt, v7, v8, v9, v10, v11, v12);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C2E0D0((PartyOrganizationUtility_o *)&v12->fields, (int64_t)questEnt, v13, v14, v15, v16, v17, v18);
  v12->fields.warEntity = warEnt;
  sub_1C2E0D0((PartyOrganizationUtility_o *)&v12->fields.warEntity, (int64_t)warEnt, v19, v20, v21, v22, v23, v24);
  v12->fields.message = questMessage;
  v12 = (RecommendSupportQuestSelectListMenu_RecommendQuestInfo_o *)((char *)v12 + 32);
  sub_1C2E0D0((PartyOrganizationUtility_o *)v12, (int64_t)questMessage, v25, v26, v27, v28, v29, v30);
