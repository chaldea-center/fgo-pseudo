...
void RecommendSupportQuestSelectListMenu__Open(RecommendSupportQuestSelectListMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB21B6 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_11047/*"RECOMMEND_SUPPORT_QUEST_SELECT_MENU_EXPLANATION"*/);
    byte_4CB21B6 = 1;
  }
  listViewManager = this->fields.listViewManager;
  if ( !listViewManager )
  ...
  v5 = LocalizationManager__Get((System_String_o *)StringLiteral_11047/*"RECOMMEND_SUPPORT_QUEST_SELECT_MENU_EXPLANATION"*/, 0);
  listViewManager = (RecommendSupportQuestBoardListViewManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A4F3B4 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__);
  if ( !listViewManager
        ...
        const MethodInfo *method)
{
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)v6, (int32_t)warEnt, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&v12->fields, (int32_t)questEnt, v13, v14);
  v12->fields.warEntity = warEnt;
  sub_1C6B9AC((CGThumbnailListItem_o *)&v12->fields.warEntity, (int32_t)warEnt, v15, v16);
  v12->fields.message = questMessage;
  v12 = (RecommendSupportQuestSelectListMenu_RecommendQuestInfo_o *)((char *)v12 + 32);
  sub_1C6B9AC((CGThumbnailListItem_o *)v12, (int32_t)questMessage, v17, v18);
