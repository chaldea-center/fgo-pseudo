        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A491BC & 1) == 0 )
  {
    sub_1B863B8(&Method_DataManager_GetMasterData_GiftMaster___, targetEntity);
  ...
  sub_1B8635C(&this->fields.itemInfo);
  ...
  sub_1B8635C(&this->fields.clearReward);
...
LABEL_24:
  ...
  switch ( clearReward->fields.type )
  {
    ...
    case 9:
      ...
      v22 = System_String__Substring_61691100((System_String_o *)Instance, 0, Instance->fields.m_CachedPtr - 2, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A491BD & 1) == 0 )
  {
    ...
    this = (EventTowerListViewItem_o *)sub_1B863B8(&StringLiteral_24817/*"{0}"*/, v3);
    byte_4A491BD = 1;
  }
