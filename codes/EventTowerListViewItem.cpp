        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC2A0E & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataManager_GetMasterData_GiftMaster___, targetEntity);
    sub_1C1ABD4(&Method_DataManager_GetMasterData_ItemMaster___, v9);
    sub_1C1ABD4(&Method_DataManager_GetMasterData_ServantCostumeMaster___, v10);
  ...
  sub_1C1AB78(&this->fields.itemInfo);
  ...
  sub_1C1AB78(&this->fields.clearReward);
...
LABEL_24:
  ...
  switch ( clearReward->fields.type )
  {
    ...
    case 9:
      ...
      v22 = System_String__Substring_63059372((System_String_o *)Instance, 0, Instance->fields.m_CachedPtr - 2, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC2A0F & 1) == 0 )
  {
    ...
    this = (EventTowerListViewItem_o *)sub_1C1ABD4(&StringLiteral_25405/*"{0}"*/, v3);
    byte_4BC2A0F = 1;
  }
