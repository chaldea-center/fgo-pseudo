        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B5C58 & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataManager_GetMasterData_GiftMaster___, targetEntity);
  ...
  sub_1B4CF34(&this->fields.itemInfo);
  ...
  sub_1B4CF34(&this->fields.clearReward);
...
LABEL_24:
  ...
  switch ( clearReward->fields.type )
  {
    ...
    case 9:
      ...
      v22 = System_String__Substring_61139392((System_String_o *)Instance, 0, Instance->fields.m_CachedPtr - 2, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B5C59 & 1) == 0 )
  {
    ...
    this = (EventTowerListViewItem_o *)sub_1B4CF90(&StringLiteral_24692/*"{0}"*/, v3);
    byte_49B5C59 = 1;
  }
