        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B321D5 & 1) == 0 )
  {
    sub_1BD3458(&Method_DataManager_GetMasterData_GiftMaster___, targetEntity);
    sub_1BD3458(&Method_DataManager_GetMasterData_ItemMaster___, v9);
    sub_1BD3458(&Method_DataManager_GetMasterData_ServantCostumeMaster___, v10);
  ...
  sub_1BD33FC(&this->fields.itemInfo);
  ...
  sub_1BD33FC(&this->fields.clearReward);
...
LABEL_24:
  ...
  switch ( clearReward->fields.type )
  {
    ...
    case 9:
      ...
      v22 = System_String__Substring_62544252((System_String_o *)Instance, 0, Instance->fields.m_CachedPtr - 2, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B321D6 & 1) == 0 )
  {
    ...
    this = (EventTowerListViewItem_o *)sub_1BD3458(&StringLiteral_25273/*"{0}"*/, v3);
    byte_4B321D6 = 1;
  }
