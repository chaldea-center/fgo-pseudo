        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF866F & 1) == 0 )
  {
    sub_1C2E12C(&Method_DataManager_GetMasterData_GiftMaster___, targetEntity);
    sub_1C2E12C(&Method_DataManager_GetMasterData_ItemMaster___, v9);
    sub_1C2E12C(&Method_DataManager_GetMasterData_ServantCostumeMaster___, v10);
  ...
  sub_1C2E0D0(&this->fields.itemInfo);
  ...
  sub_1C2E0D0(&this->fields.clearReward);
...
LABEL_24:
  ...
  switch ( clearReward->fields.type )
  {
    ...
    case 9:
      ...
      v22 = System_String__Substring_63254588((System_String_o *)Instance, 0, Instance->fields.m_CachedPtr - 2, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF8670 & 1) == 0 )
  {
    ...
    this = (EventTowerListViewItem_o *)sub_1C2E12C(&StringLiteral_25453/*"{0}"*/, v3);
    byte_4BF8670 = 1;
  }
