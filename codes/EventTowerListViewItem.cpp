        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B11251 & 1) == 0 )
  {
    sub_1BCA7E0(&Method_DataManager_GetMasterData_GiftMaster___, targetEntity, isClearFloor);
  ...
  sub_1BCA784(&this->fields.itemInfo, targetEntity);
  ...
  sub_1BCA784(&this->fields.clearReward, DataById);
  ...
  switch ( clearReward->fields.type )
  {
    ...
    case 7:
      ...
      if ( !*p_clearReward || !Instance )
        goto LABEL_24;
      v27 = (struct ServantEntity_o *)DataMasterBase_object__object__int___GetEntity(
                                        (DataMasterBase_TMaster__TEntity__PKType__o *)Instance,
                                        (*p_clearReward)->fields.objectId,
                                        (const MethodInfo_31B2E40 *)Method_DataMasterBase_ServantMaster__ServantEntity__int__GetEntity__);
      this->fields.servantEntity = v27;
    ...
    case 2:
      ...
      this->fields.itemEntity = (struct ItemEntity_o *)v27;
    ...
    case 9:
      ...
      v30 = System_String__Substring_62420224((System_String_o *)Instance, 0, Instance->fields.m_CachedPtr - 2, 0LL);
      ...
      if ( !Instance )
        goto LABEL_24;
      if ( !ServantCostumeMaster__TryGetEntity((ServantCostumeMaster_o *)Instance, &entity, v31, v33, 0LL) )
        return;
      v27 = (struct ServantEntity_o *)entity;
      this->fields.servantCostumeEntity = entity;
      p_servantEntity = &this->fields.servantCostumeEntity;
LABEL_22:
      sub_1BCA784(p_servantEntity, v27);
      break;
    default:
      return;
  }
...
{
  __int64 v2; // x2
  EventTowerListViewItem_o *v3; // x19
  __int64 v4; // x1
  __int64 v5; // x2
  struct EventTowerRewardEntity_o *itemInfo; // x8
  ...
  if ( (byte_4B11252 & 1) == 0 )
  {
    ...
    this = (EventTowerListViewItem_o *)sub_1BCA7E0(&StringLiteral_25238/*"{0}"*/, v4, v5);
    byte_4B11252 = 1;
  }
  itemInfo = v3->fields.itemInfo;
  if ( !itemInfo
