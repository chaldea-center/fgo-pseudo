        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0276A & 1) == 0 )
  {
    sub_1B64870(&Method_DataManager_GetMasterData_GiftMaster___, targetEntity);
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.itemInfo, (int32_t)targetEntity, v16, v17);
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.clearReward, (int32_t)DataById, v22, v23);
...
LABEL_24:
  ...
  switch ( clearReward->fields.type )
  {
    ...
    case 9:
      ...
      v32 = System_String__Substring_61402572((System_String_o *)Instance, 0, Instance->fields.m_CachedPtr - 2, 0LL);
...
LABEL_22:
      sub_1B64814(p_servantEntity, v28, v26, v27);
      break;
    default:
      return;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0276B & 1) == 0 )
  {
    ...
    this = (EventTowerListViewItem_o *)sub_1B64870(&StringLiteral_24887/*"{0}"*/, v3);
    byte_4A0276B = 1;
  }
