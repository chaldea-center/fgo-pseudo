        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F4F5 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMasterData_GiftMaster___, targetEntity);
  ...
  sub_1BDB81C(&this->fields.itemInfo);
  ...
  sub_1BDB81C(&this->fields.clearReward);
...
LABEL_24:
  ...
  switch ( clearReward->fields.type )
  {
    ...
    case 9:
      ...
      v22 = System_String__Substring_62618184((System_String_o *)Instance, 0, Instance->fields.m_CachedPtr - 2, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F4F6 & 1) == 0 )
  {
    ...
    this = (EventTowerListViewItem_o *)sub_1BDB878(&StringLiteral_25175/*"{0}"*/, v3);
    byte_4B3F4F6 = 1;
  }
