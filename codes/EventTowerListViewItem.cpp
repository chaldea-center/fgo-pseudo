        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B61B75 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_DataManager_GetMasterData_GiftMaster___, targetEntity);
  ...
  sub_1BE4A70(&this->fields.itemInfo);
  ...
  sub_1BE4A70(&this->fields.clearReward);
...
LABEL_24:
  ...
  switch ( clearReward->fields.type )
  {
    ...
    case 9:
      ...
      v22 = System_String__Substring_62717812((System_String_o *)Instance, 0, Instance->fields.m_CachedPtr - 2, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B61B76 & 1) == 0 )
  {
    ...
    this = (EventTowerListViewItem_o *)sub_1BE4ACC(&StringLiteral_25327/*"{0}"*/, v3);
    byte_4B61B76 = 1;
  }
