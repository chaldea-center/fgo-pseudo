        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDD6B & 1) == 0 )
  {
    ...
    sub_1B640C8(&StringLiteral_23931/*"tradeGoodsNum"*/, v11);
    sub_1B640C8(&StringLiteral_23932/*"tradeStoreIdx"*/, v12);
    sub_1B640C8(&StringLiteral_23930/*"tradeGoodsId"*/, v13);
    byte_49FDD6B = 1;
  }
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23932/*"tradeStoreIdx"*/, tradeStoreIdx, v14);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23930/*"tradeGoodsId"*/, tradeGoodsId, v15);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23931/*"tradeGoodsNum"*/, tradeGoodsNum, v16);
...
System_String_o *__fastcall TradeStartRequest__getURL(TradeStartRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FDD6A & 1) == 0 )
  {
    ...
    sub_1B640C8(&StringLiteral_19053/*"event/tradeStart"*/, v2);
    byte_49FDD6A = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61375396(BaseUrl, (System_String_o *)StringLiteral_19053/*"event/tradeStart"*/, 0LL);
}
