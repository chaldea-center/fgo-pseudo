        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB76ED & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_24070/*"tradeGoodsNum"*/, v11);
    sub_1BAB41C(&StringLiteral_24071/*"tradeStoreIdx"*/, v12);
    sub_1BAB41C(&StringLiteral_24069/*"tradeGoodsId"*/, v13);
    byte_4AB76ED = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19162/*"eventId"*/, eventId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_24071/*"tradeStoreIdx"*/, tradeStoreIdx, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_24069/*"tradeGoodsId"*/, tradeGoodsId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_24070/*"tradeGoodsNum"*/, tradeGoodsNum, 0LL);
...
System_String_o *__fastcall TradeStartRequest__getURL(TradeStartRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB76EC & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_19156/*"event/tradeStart"*/, v2);
    byte_4AB76EC = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62048128(BaseUrl, (System_String_o *)StringLiteral_19156/*"event/tradeStart"*/, 0LL);
}
