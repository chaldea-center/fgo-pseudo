        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E40BE & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_23675/*"tradeGoodsNum"*/, v11);
    sub_1B00CCC(&StringLiteral_23676/*"tradeStoreIdx"*/, v12);
    sub_1B00CCC(&StringLiteral_23674/*"tradeGoodsId"*/, v13);
    byte_48E40BE = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18880/*"eventId"*/, eventId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23676/*"tradeStoreIdx"*/, tradeStoreIdx, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23674/*"tradeGoodsId"*/, tradeGoodsId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23675/*"tradeGoodsNum"*/, tradeGoodsNum, 0LL);
...
System_String_o *__fastcall TradeStartRequest__getURL(TradeStartRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E40BD & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_18874/*"event/tradeStart"*/, v2);
    byte_48E40BD = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_60325748(BaseUrl, (System_String_o *)StringLiteral_18874/*"event/tradeStart"*/, 0LL);
}
