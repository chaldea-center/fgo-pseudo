        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D29120 & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_11994/*"SERVANT_STATUS_PROFILE_ILLUST_TITLE"*/);
    sub_1C94098(&StringLiteral_11993/*"SERVANT_STATUS_PROFILE_CV_TITLE"*/);
    byte_4D29120 = 1;
  }
  illust = 0;
  voice = 0;
  ...
  if ( item && mode )
  {
    ...
    illustRangeLabel = LocalizationManager__Get((System_String_o *)StringLiteral_11994/*"SERVANT_STATUS_PROFILE_ILLUST_TITLE"*/, 0);
    if ( !illustTitleLabel )
      goto LABEL_13;
    UILabel__set_text(illustTitleLabel, illustRangeLabel, 0);
    cvTitleLabel = this->fields.cvTitleLabel;
    illustRangeLabel = LocalizationManager__Get((System_String_o *)StringLiteral_11993/*"SERVANT_STATUS_PROFILE_CV_TITLE"*/, 0);
    if ( !cvTitleLabel
    ...
    {
LABEL_13:
      sub_1C942F0(illustRangeLabel, v13);
    }
