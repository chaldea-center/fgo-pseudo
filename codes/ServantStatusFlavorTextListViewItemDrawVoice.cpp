        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57542 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_11891/*"SERVANT_STATUS_PROFILE_ILLUST_TITLE"*/);
    sub_1B885B0(&StringLiteral_11890/*"SERVANT_STATUS_PROFILE_CV_TITLE"*/);
    byte_4A57542 = 1;
  }
  illust = 0LL;
  voice = 0LL;
  ...
  if ( item && mode )
  {
    ...
    illustRangeLabel = LocalizationManager__Get((System_String_o *)StringLiteral_11891/*"SERVANT_STATUS_PROFILE_ILLUST_TITLE"*/, 0LL);
    if ( !illustTitleLabel )
      goto LABEL_13;
    UILabel__set_text(illustTitleLabel, illustRangeLabel, 0LL);
    cvTitleLabel = this->fields.cvTitleLabel;
    illustRangeLabel = LocalizationManager__Get((System_String_o *)StringLiteral_11890/*"SERVANT_STATUS_PROFILE_CV_TITLE"*/, 0LL);
    if ( !cvTitleLabel
    ...
    {
LABEL_13:
      sub_1B8880C(illustRangeLabel, v13);
    }
