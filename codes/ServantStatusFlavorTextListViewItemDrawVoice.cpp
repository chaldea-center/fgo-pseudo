        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B33A04 & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_12048/*"SERVANT_STATUS_PROFILE_ILLUST_TITLE"*/, v11);
    sub_1BD3458(&StringLiteral_12047/*"SERVANT_STATUS_PROFILE_CV_TITLE"*/, v12);
    byte_4B33A04 = 1;
  }
  illust = 0LL;
  voice = 0LL;
  ...
  if ( item && mode )
  {
    ...
    illustRangeLabel = LocalizationManager__Get((System_String_o *)StringLiteral_12048/*"SERVANT_STATUS_PROFILE_ILLUST_TITLE"*/, 0LL);
    if ( !illustTitleLabel )
      goto LABEL_13;
    UILabel__set_text(illustTitleLabel, illustRangeLabel, 0LL);
    cvTitleLabel = this->fields.cvTitleLabel;
    illustRangeLabel = LocalizationManager__Get((System_String_o *)StringLiteral_12047/*"SERVANT_STATUS_PROFILE_CV_TITLE"*/, 0LL);
    if ( !cvTitleLabel
    ...
    {
LABEL_13:
      sub_1BD36B4(illustRangeLabel, v15);
    }
