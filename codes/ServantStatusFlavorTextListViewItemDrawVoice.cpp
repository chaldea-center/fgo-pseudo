        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FAA3B & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_11839/*"SERVANT_STATUS_PROFILE_ILLUST_TITLE"*/, v11);
    sub_1B64870(&StringLiteral_11838/*"SERVANT_STATUS_PROFILE_CV_TITLE"*/, v12);
    byte_49FAA3B = 1;
  }
  illust = 0LL;
  voice = 0LL;
  ...
  if ( item && mode )
  {
    ...
    illustRangeLabel = LocalizationManager__Get((System_String_o *)StringLiteral_11839/*"SERVANT_STATUS_PROFILE_ILLUST_TITLE"*/, 0LL);
    if ( !illustTitleLabel )
      goto LABEL_13;
    UILabel__set_text(illustTitleLabel, illustRangeLabel, 0LL);
    cvTitleLabel = this->fields.cvTitleLabel;
    illustRangeLabel = LocalizationManager__Get((System_String_o *)StringLiteral_11838/*"SERVANT_STATUS_PROFILE_CV_TITLE"*/, 0LL);
    if ( !cvTitleLabel
    ...
    {
LABEL_13:
      sub_1B64ACC(illustRangeLabel, v15);
    }
