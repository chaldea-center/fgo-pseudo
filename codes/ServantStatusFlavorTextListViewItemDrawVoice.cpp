        ...
        const MethodInfo *method)
{
  ...
  if ( !cvRangeLabel )
    sub_1BCB254(0LL, cvName);
  UIRangeLabel__Set(cvRangeLabel, cvName, 0LL, 1, 0, 0, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18C19 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_11842/*"SERVANT_STATUS_PROFILE_ILLUST_TITLE"*/, v11);
    sub_1BCAFF8(&StringLiteral_11841/*"SERVANT_STATUS_PROFILE_CV_TITLE"*/, v12);
    byte_4B18C19 = 1;
  }
  illust = 0LL;
  voice = 0LL;
  ...
  if ( item && mode )
  {
    ...
    illustRangeLabel = LocalizationManager__Get((System_String_o *)StringLiteral_11842/*"SERVANT_STATUS_PROFILE_ILLUST_TITLE"*/, 0LL);
    if ( !illustTitleLabel )
      goto LABEL_13;
    UILabel__set_text(illustTitleLabel, illustRangeLabel, 0LL);
    cvTitleLabel = this->fields.cvTitleLabel;
    illustRangeLabel = LocalizationManager__Get((System_String_o *)StringLiteral_11841/*"SERVANT_STATUS_PROFILE_CV_TITLE"*/, 0LL);
    if ( !cvTitleLabel
      ...
      || (UIRangeLabel__Set((UIRangeLabel_o *)illustRangeLabel, illust, 0LL, 1, 0, 0, 0LL),
          (illustRangeLabel = (System_String_o *)this->fields.cvRangeLabel) == 0LL) )
    {
LABEL_13:
      sub_1BCB254(illustRangeLabel, v15);
    }
    UIRangeLabel__Set((UIRangeLabel_o *)illustRangeLabel, voice, 0LL, 1, 0, 0, 0LL);
  }
}