        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42ED301 & 1) == 0 )
  {
    sub_B5D5C4(&LocalizationManager_TypeInfo, (_DWORD)item, isOpen, isNew);
    sub_B5D5C4(&StringLiteral_12143/*"SERVANT_STATUS_PROFILE_ILLUST_TITLE"*/, v11, v12, v13);
    sub_B5D5C4(&StringLiteral_12142/*"SERVANT_STATUS_PROFILE_CV_TITLE"*/, v14, v15, v16);
    byte_42ED301 = 1;
  }
  voice = 0LL;
  illust = 0LL;
  ...
  if ( item && mode )
  {
    ...
    cvTitleLabel = LocalizationManager__Get((System_String_o *)StringLiteral_12143/*"SERVANT_STATUS_PROFILE_ILLUST_TITLE"*/, 0LL);
    if ( !illustRangeLabel )
      goto LABEL_14;
    UILabel__set_text((UILabel_o *)illustRangeLabel, cvTitleLabel, 0LL);
    cvRangeLabel = this->fields.cvRangeLabel;
    cvTitleLabel = LocalizationManager__Get((System_String_o *)StringLiteral_12142/*"SERVANT_STATUS_PROFILE_CV_TITLE"*/, 0LL);
    if ( !cvRangeLabel
      || (UILabel__set_text((UILabel_o *)cvRangeLabel, cvTitleLabel, 0LL),
          ServantStatusListViewItem__GetVoiceInfo(item, &illust, &voice, &isPlayVoice, v21),
