        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_418D139 & 1) == 0 )
  {
    ...
    sub_B2C35C(&StringLiteral_11993/*"SERVANT_STATUS_PROFILE_ILLUST_TITLE"*/, v11);
    sub_B2C35C(&StringLiteral_11992/*"SERVANT_STATUS_PROFILE_CV_TITLE"*/, v12);
    byte_418D139 = 1;
  }
  voice = 0LL;
  illust = 0LL;
  ...
  if ( item && mode )
  {
    ...
    cvTitleLabel = LocalizationManager__Get((System_String_o *)StringLiteral_11993/*"SERVANT_STATUS_PROFILE_ILLUST_TITLE"*/, 0LL);
    if ( !illustRangeLabel )
      goto LABEL_14;
    UILabel__set_text((UILabel_o *)illustRangeLabel, cvTitleLabel, 0LL);
    cvRangeLabel = this->fields.cvRangeLabel;
    cvTitleLabel = LocalizationManager__Get((System_String_o *)StringLiteral_11992/*"SERVANT_STATUS_PROFILE_CV_TITLE"*/, 0LL);
    if ( !cvRangeLabel
