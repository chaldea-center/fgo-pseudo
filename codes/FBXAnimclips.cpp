void __fastcall FBXAnimclips___cctor(const MethodInfo *method)
{
  if ( (byte_4350904 & 1) == 0 )
  {
    sub_B70694(&FBXAnimclips_TypeInfo);
    byte_4350904 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4350903 & 1) == 0 )
  {
    ...
    sub_B70694(&UnityEngine_TextAsset_var);
    sub_B70694(&UnityEngine_TextAsset_TypeInfo);
    sub_B70694(&System_Type_TypeInfo);
    sub_B70694(&StringLiteral_946/*"/fbxevent"*/);
    sub_B70694(&StringLiteral_12909/*"Servants/"*/);
    sub_B70694(&StringLiteral_939/*"/chr"*/);
    byte_4350903 = 1;
  }
  ...
  v7 = System_String__Concat_44760452(
         ...
         v6,
         (System_String_o *)StringLiteral_939/*"/chr"*/,
         0LL);
  UnityEngine_Resources__Load_UIAtlas_(v7, (const MethodInfo_1D5BAD8 *)Method_UnityEngine_Resources_Load_GameObject___);
  v8 = System_Int32__ToString((int32_t)&v12, 0LL);
  v9 = System_String__Concat_44760452(
         (System_String_o *)StringLiteral_12909/*"Servants/"*/,
         v8,
         (System_String_o *)StringLiteral_946/*"/fbxevent"*/,
         0LL);
  ...
  UnityEngine_Resources__Load_36130748(v9, TypeFromHandle, 0LL);
}