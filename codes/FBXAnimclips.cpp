void FBXAnimclips___cctor(const MethodInfo *method)
{
  if ( (byte_4C266E7 & 1) == 0 )
  {
    sub_1C2D490(&FBXAnimclips_TypeInfo);
    byte_4C266E7 = 1;
  }
...
void FBXAnimclips__loadAnimationEvents(FBXAnimclips_o *this, int32_t svtId, int32_t level, const MethodInfo *method)
{
  ...
  if ( (byte_4C266E6 & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_1101/*"/fbxevent"*/);
    sub_1C2D490(&StringLiteral_12749/*"Servants/"*/);
    sub_1C2D490(&StringLiteral_1095/*"/chr"*/);
    byte_4C266E6 = 1;
  }
  ...
  v7 = System_String__Concat_63496112(
         (System_String_o *)StringLiteral_12749/*"Servants/"*/,
         v6,
         (System_String_o *)StringLiteral_1095/*"/chr"*/,
         0);
  UnityEngine_Resources__Load_object_(v7, (const MethodInfo_316AF08 *)Method_UnityEngine_Resources_Load_GameObject___);
  ...
  UnityEngine_Resources__Load_71124112(v11, TypeFromHandle, 0);
}