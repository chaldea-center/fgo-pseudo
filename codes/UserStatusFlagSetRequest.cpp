        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B685FB & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_22524/*"offFlagNumbers"*/, onFlagNumbers);
    sub_1BE4ACC(&StringLiteral_22577/*"onFlagNumbers"*/, v7);
    byte_4B685FB = 1;
  }
  if ( onFlagNumbers && *(_QWORD *)&onFlagNumbers->max_length )
    RequestBase__addField_42112900(
      (RequestBase_o *)this,
      (System_String_o *)StringLiteral_22577/*"onFlagNumbers"*/,
      &onFlagNumbers->obj,
      0LL);
  if ( offFlagNumbers && *(_QWORD *)&offFlagNumbers->max_length )
    RequestBase__addField_42112900(
      (RequestBase_o *)this,
      (System_String_o *)StringLiteral_22524/*"offFlagNumbers"*/,
      &offFlagNumbers->obj,
      0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B685F9 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_24784/*"userStatus/flagSet"*/, v2);
    byte_4B685F9 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62698808(BaseUrl, (System_String_o *)StringLiteral_24784/*"userStatus/flagSet"*/, 0LL);
}
