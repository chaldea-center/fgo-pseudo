        ...
        const MethodInfo *method)
{
  if ( (byte_4CF0281 & 1) == 0 )
  {
    sub_1C7BAE8(&StringLiteral_22574/*"offFlagNumbers"*/);
    sub_1C7BAE8(&StringLiteral_22623/*"onFlagNumbers"*/);
    byte_4CF0281 = 1;
  }
  if ( onFlagNumbers && onFlagNumbers->max_length )
    RequestBase__addField_44746712(
      (RequestBase_o *)this,
      (System_String_o *)StringLiteral_22623/*"onFlagNumbers"*/,
      &onFlagNumbers->obj,
      method);
  if ( offFlagNumbers && offFlagNumbers->max_length )
    RequestBase__addField_44746712(
      (RequestBase_o *)this,
      (System_String_o *)StringLiteral_22574/*"offFlagNumbers"*/,
      &offFlagNumbers->obj,
      method);
...
System_String_o *UserStatusFlagSetRequest__getURL(UserStatusFlagSetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CF027F & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_24819/*"userStatus/flagSet"*/);
    byte_4CF027F = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64176912(BaseUrl, (System_String_o *)StringLiteral_24819/*"userStatus/flagSet"*/, 0);
}
