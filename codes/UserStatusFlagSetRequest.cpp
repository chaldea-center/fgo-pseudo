        ...
        const MethodInfo *method)
{
  if ( (byte_4E79301 & 1) == 0 )
  {
    sub_1D0F0B4(&StringLiteral_22805/*"offFlagNumbers"*/);
    sub_1D0F0B4(&StringLiteral_22854/*"onFlagNumbers"*/);
    byte_4E79301 = 1;
  }
  if ( onFlagNumbers && onFlagNumbers->max_length )
    RequestBase__addField_45601344(
      (RequestBase_o *)this,
      (System_String_o *)StringLiteral_22854/*"onFlagNumbers"*/,
      &onFlagNumbers->obj,
      method);
  if ( offFlagNumbers && offFlagNumbers->max_length )
    RequestBase__addField_45601344(
      (RequestBase_o *)this,
      (System_String_o *)StringLiteral_22805/*"offFlagNumbers"*/,
      &offFlagNumbers->obj,
      method);
...
System_String_o *UserStatusFlagSetRequest__getURL(UserStatusFlagSetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E792FF & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_25085/*"userStatus/flagSet"*/);
    byte_4E792FF = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_65562772(BaseUrl, (System_String_o *)StringLiteral_25085/*"userStatus/flagSet"*/, 0);
}
