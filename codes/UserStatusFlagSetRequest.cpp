        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BC95D & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_21931/*"offFlagNumbers"*/, onFlagNumbers);
    sub_1B4CF90(&StringLiteral_21981/*"onFlagNumbers"*/, v7);
    byte_49BC95D = 1;
  }
  if ( onFlagNumbers && *(_QWORD *)&onFlagNumbers->max_length )
    RequestBase__addField_41756888(
      (RequestBase_o *)this,
      (System_String_o *)StringLiteral_21981/*"onFlagNumbers"*/,
      &onFlagNumbers->obj,
      0LL);
  if ( offFlagNumbers && *(_QWORD *)&offFlagNumbers->max_length )
    RequestBase__addField_41756888(
      (RequestBase_o *)this,
      (System_String_o *)StringLiteral_21931/*"offFlagNumbers"*/,
      &offFlagNumbers->obj,
      0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BC95B & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_24156/*"userStatus/flagSet"*/, v2);
    byte_49BC95B = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61093468(BaseUrl, (System_String_o *)StringLiteral_24156/*"userStatus/flagSet"*/, 0LL);
}
