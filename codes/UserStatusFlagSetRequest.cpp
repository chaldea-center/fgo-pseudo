        ...
        const MethodInfo *method)
{
  if ( (byte_4C28EFD & 1) == 0 )
  {
    sub_1C2D490(&StringLiteral_22346/*"offFlagNumbers"*/);
    sub_1C2D490(&StringLiteral_22396/*"onFlagNumbers"*/);
    byte_4C28EFD = 1;
  }
  if ( onFlagNumbers && onFlagNumbers->max_length )
    RequestBase__addField_44009168(
      (RequestBase_o *)this,
      (System_String_o *)StringLiteral_22396/*"onFlagNumbers"*/,
      &onFlagNumbers->obj,
      method);
  if ( offFlagNumbers && offFlagNumbers->max_length )
    RequestBase__addField_44009168(
      (RequestBase_o *)this,
      (System_String_o *)StringLiteral_22346/*"offFlagNumbers"*/,
      &offFlagNumbers->obj,
      method);
...
System_String_o *UserStatusFlagSetRequest__getURL(UserStatusFlagSetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C28EFB & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_24550/*"userStatus/flagSet"*/);
    byte_4C28EFB = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63457864(BaseUrl, (System_String_o *)StringLiteral_24550/*"userStatus/flagSet"*/, 0);
}
