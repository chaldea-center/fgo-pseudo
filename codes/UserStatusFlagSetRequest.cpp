        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F8E3 & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_22197/*"offFlagNumbers"*/, onFlagNumbers);
    sub_1B761C0(&StringLiteral_22250/*"onFlagNumbers"*/, v7);
    byte_4A2F8E3 = 1;
  }
  if ( onFlagNumbers && *(_QWORD *)&onFlagNumbers->max_length )
    RequestBase__addField_40950188(
      (RequestBase_o *)this,
      (System_String_o *)StringLiteral_22250/*"onFlagNumbers"*/,
      &onFlagNumbers->obj,
      0LL);
  if ( offFlagNumbers && *(_QWORD *)&offFlagNumbers->max_length )
    RequestBase__addField_40950188(
      (RequestBase_o *)this,
      (System_String_o *)StringLiteral_22197/*"offFlagNumbers"*/,
      &offFlagNumbers->obj,
      0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F8E1 & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_24429/*"userStatus/flagSet"*/, v2);
    byte_4A2F8E1 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61535060(BaseUrl, (System_String_o *)StringLiteral_24429/*"userStatus/flagSet"*/, 0LL);
}
