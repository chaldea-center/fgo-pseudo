        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC9516 & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_22594/*"offFlagNumbers"*/, onFlagNumbers);
    sub_1C1ABD4(&StringLiteral_22647/*"onFlagNumbers"*/, v7);
    byte_4BC9516 = 1;
  }
  if ( onFlagNumbers && *(_QWORD *)&onFlagNumbers->max_length )
    RequestBase__addField_42370648(
      (RequestBase_o *)this,
      (System_String_o *)StringLiteral_22647/*"onFlagNumbers"*/,
      &onFlagNumbers->obj,
      0LL);
  if ( offFlagNumbers && *(_QWORD *)&offFlagNumbers->max_length )
    RequestBase__addField_42370648(
      (RequestBase_o *)this,
      (System_String_o *)StringLiteral_22594/*"offFlagNumbers"*/,
      &offFlagNumbers->obj,
      0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC9514 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_24862/*"userStatus/flagSet"*/, v2);
    byte_4BC9514 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63040368(BaseUrl, (System_String_o *)StringLiteral_24862/*"userStatus/flagSet"*/, 0LL);
}
