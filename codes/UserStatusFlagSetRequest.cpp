        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFE8A & 1) == 0 )
  {
    sub_1B64870(&StringLiteral_22121/*"offFlagNumbers"*/, onFlagNumbers);
    sub_1B64870(&StringLiteral_22174/*"onFlagNumbers"*/, v7);
    byte_49FFE8A = 1;
  }
  if ( onFlagNumbers && *(_QWORD *)&onFlagNumbers->max_length )
    RequestBase__addField_40853908(
      (RequestBase_o *)this,
      (System_String_o *)StringLiteral_22174/*"onFlagNumbers"*/,
      &onFlagNumbers->obj,
      method);
  if ( offFlagNumbers && *(_QWORD *)&offFlagNumbers->max_length )
    RequestBase__addField_40853908(
      (RequestBase_o *)this,
      (System_String_o *)StringLiteral_22121/*"offFlagNumbers"*/,
      &offFlagNumbers->obj,
      method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFE88 & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_24347/*"userStatus/flagSet"*/, v2);
    byte_49FFE88 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61383576(BaseUrl, (System_String_o *)StringLiteral_24347/*"userStatus/flagSet"*/, 0LL);
}
