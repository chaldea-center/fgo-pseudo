        ...
        const MethodInfo *method)
{
  if ( (byte_4C39606 & 1) == 0 )
  {
    sub_1C32C20(&StringLiteral_22363/*"offFlagNumbers"*/);
    sub_1C32C20(&StringLiteral_22413/*"onFlagNumbers"*/);
    byte_4C39606 = 1;
  }
  if ( onFlagNumbers && onFlagNumbers->max_length )
    RequestBase__addField_44145300(
      (RequestBase_o *)this,
      (System_String_o *)StringLiteral_22413/*"onFlagNumbers"*/,
      &onFlagNumbers->obj,
      method);
  if ( offFlagNumbers && offFlagNumbers->max_length )
    RequestBase__addField_44145300(
      (RequestBase_o *)this,
      (System_String_o *)StringLiteral_22363/*"offFlagNumbers"*/,
      &offFlagNumbers->obj,
      method);
...
System_String_o *UserStatusFlagSetRequest__getURL(UserStatusFlagSetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C39604 & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_24568/*"userStatus/flagSet"*/);
    byte_4C39604 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63518544(BaseUrl, (System_String_o *)StringLiteral_24568/*"userStatus/flagSet"*/, 0);
}
