        ...
        const MethodInfo *method)
{
  if ( (byte_4D2E512 & 1) == 0 )
  {
    sub_1C94098(&StringLiteral_22578/*"offFlagNumbers"*/);
    sub_1C94098(&StringLiteral_22627/*"onFlagNumbers"*/);
    byte_4D2E512 = 1;
  }
  if ( onFlagNumbers && onFlagNumbers->max_length )
    RequestBase__addField_45014472(
      (RequestBase_o *)this,
      (System_String_o *)StringLiteral_22627/*"onFlagNumbers"*/,
      &onFlagNumbers->obj,
      method);
  if ( offFlagNumbers && offFlagNumbers->max_length )
    RequestBase__addField_45014472(
      (RequestBase_o *)this,
      (System_String_o *)StringLiteral_22578/*"offFlagNumbers"*/,
      &offFlagNumbers->obj,
      method);
...
System_String_o *UserStatusFlagSetRequest__getURL(UserStatusFlagSetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2E510 & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_24818/*"userStatus/flagSet"*/);
    byte_4D2E510 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64417744(BaseUrl, (System_String_o *)StringLiteral_24818/*"userStatus/flagSet"*/, 0);
}
