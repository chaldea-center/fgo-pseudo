        ...
        const MethodInfo *method)
{
  if ( (byte_4C44C00 & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_22366/*"offFlagNumbers"*/);
    sub_1C37058(&StringLiteral_22416/*"onFlagNumbers"*/);
    byte_4C44C00 = 1;
  }
  if ( onFlagNumbers && onFlagNumbers->max_length )
    RequestBase__addField_44247404(
      (RequestBase_o *)this,
      (System_String_o *)StringLiteral_22416/*"onFlagNumbers"*/,
      &onFlagNumbers->obj,
      method);
  if ( offFlagNumbers && offFlagNumbers->max_length )
    RequestBase__addField_44247404(
      (RequestBase_o *)this,
      (System_String_o *)StringLiteral_22366/*"offFlagNumbers"*/,
      &offFlagNumbers->obj,
      method);
...
System_String_o *UserStatusFlagSetRequest__getURL(UserStatusFlagSetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C44BFE & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_24573/*"userStatus/flagSet"*/);
    byte_4C44BFE = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63561656(BaseUrl, (System_String_o *)StringLiteral_24573/*"userStatus/flagSet"*/, 0);
}
