void __fastcall FuncParamValueUpInfoBase___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48E50A2 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&FuncParamValueUpInfoBase_TypeInfo, v2);
    byte_48E50A2 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E50A1 & 1) == 0 )
  {
    sub_1B00CCC(&Method_System_Linq_Enumerable_Contains_DataVals_TYPE___, *(_QWORD *)&type);
    sub_1B00CCC(&FuncParamValueUpInfoBase_TypeInfo, v7);
    byte_48E50A1 = 1;
  }
  if ( this->fields._ValueEnhanceRate_k__BackingField )
  {
    ...
    if ( v8 )
    {
      if ( System_Linq_Enumerable__Contains_Int32Enum_(
             v8,
             type,
             (const MethodInfo_2D7A718 *)Method_System_Linq_Enumerable_Contains_DataVals_TYPE___) )
      {
