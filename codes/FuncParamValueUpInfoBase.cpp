void __fastcall FuncParamValueUpInfoBase___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B04E26 & 1) == 0 )
  {
    ...
    sub_1BC3008(&FuncParamValueUpInfoBase_TypeInfo, v2);
    byte_4B04E26 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B04E25 & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Linq_Enumerable_Contains_DataVals_TYPE___, *(_QWORD *)&type);
    sub_1BC3008(&FuncParamValueUpInfoBase_TypeInfo, v7);
    byte_4B04E25 = 1;
  }
  if ( this->fields._ValueEnhanceRate_k__BackingField )
  {
    ...
    if ( v8 )
    {
      if ( System_Linq_Enumerable__Contains_Int32Enum_(
             v8,
             type,
             (const MethodInfo_301AF38 *)Method_System_Linq_Enumerable_Contains_DataVals_TYPE___) )
      {
