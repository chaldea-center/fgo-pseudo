void __fastcall FuncParamValueUpInfoBase___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FED82 & 1) == 0 )
  {
    ...
    sub_1B640C8(&FuncParamValueUpInfoBase_TypeInfo, v2);
    byte_49FED82 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FED81 & 1) == 0 )
  {
    sub_1B640C8(&Method_System_Linq_Enumerable_Contains_DataVals_TYPE___, *(_QWORD *)&type);
    sub_1B640C8(&FuncParamValueUpInfoBase_TypeInfo, v7);
    byte_49FED81 = 1;
  }
  if ( this->fields._ValueEnhanceRate_k__BackingField )
  {
    ...
    if ( v8 )
    {
      if ( System_Linq_Enumerable__Contains_Int32Enum_(
             v8,
             type,
             (const MethodInfo_2E52DA4 *)Method_System_Linq_Enumerable_Contains_DataVals_TYPE___) )
      {
