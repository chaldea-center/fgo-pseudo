        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0E6C & 1) == 0 )
  {
    sub_B52984(&CoinRoomControlEffect__AddValue_d__10_TypeInfo);
    byte_42B0E6C = 1;
  }
  v3 = sub_B52A54(CoinRoomControlEffect__AddValue_d__10_TypeInfo);
  ...
  if ( _1__state != 1 )
  {
    ...
    if ( _4__this )
    {
      ...
      if ( this )
      {
        ...
        sub_B52920(&v4->fields._mainModule_5__5);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_B52988(&Method_CoinRoomControlEffect__AddValue_d__10_System_Collections_IEnumerator_Reset__);
  sub_B52A28(v3, v4);
}
