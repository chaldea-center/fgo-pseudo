...
void CriAudioReadStream___ctor_31089096(
        CriAudioReadStream_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CE78E0 & 1) == 0 )
  {
    sub_1C7BAE8(&CriAudioReadStream_InternalDelegate_TypeInfo);
    sub_1C7BAE8(&Method_System_Runtime_InteropServices_Marshal_GetFunctionPointerForDelegate_CriAudioReadStream_InternalDelegate___);
    sub_1C7BAE8(&System_Runtime_InteropServices_Marshal_TypeInfo);
    sub_1C7BAE8(&float_____TypeInfo);
    sub_1C7BAE8(&float___TypeInfo);
    sub_1C7BAE8(&Method_CriAudioReadStream___c__DisplayClass12_0___ctor_b__0__);
    sub_1C7BAE8(&CriAudioReadStream___c__DisplayClass12_0_TypeInfo);
    byte_4CE78E0 = 1;
  }
  v9 = sub_1C7BD34(CriAudioReadStream___c__DisplayClass12_0_TypeInfo);
  ...
  *(_DWORD *)(v9 + 32) = numChannels;
  System_Object___ctor((Il2CppObject *)this, 0);
  v12 = sub_1C7BB90(float_____TypeInfo, *(unsigned int *)(v9 + 32));
  *(_QWORD *)(v9 + 40) = v12;
  sub_1C7BA8C(v9 + 40, v12);
  if ( *(int *)(v9 + 32) >= 1 )
  {
    v13 = 0;
    v14 = 32;
...
LABEL_9:
  v16 = (CriAudioReadStream_InternalDelegate_o *)sub_1C7BD34(CriAudioReadStream_InternalDelegate_TypeInfo);
  ...
  this->fields._callbackFunction_k__BackingField = System_Runtime_InteropServices_Marshal__GetFunctionPointerForDelegate_object_(
                                                     internalDelegate,
                                                     (const MethodInfo_31F1670 *)Method_System_Runtime_InteropServices_Marshal_GetFunctionPointerForDelegate_CriAudioReadStream_InternalDelegate___);
}
...
LABEL_9:
  this->fields.extra_arg = (intptr_t)sub_1AA58DC;
}
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1AA58B0;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1AA5848;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CE78E3 & 1) == 0 )
  {
    this = (CriAudioReadStream___c__DisplayClass12_0_o *)sub_1C7BAE8(&System_Runtime_InteropServices_Marshal_TypeInfo);
    byte_4CE78E3 = 1;
  }
  ...
  if ( v7->fields.numChannels >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      System_Runtime_InteropServices_Marshal__Copy_64858036(v14, 0, IntPtr, v11, 0);
