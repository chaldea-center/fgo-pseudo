...
void CriAudioReadStream___ctor_31187380(
        CriAudioReadStream_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D29BC0 & 1) == 0 )
  {
    sub_1C93AD4(&CriAudioReadStream_InternalDelegate_TypeInfo);
    sub_1C93AD4(&Method_System_Runtime_InteropServices_Marshal_GetFunctionPointerForDelegate_CriAudioReadStream_InternalDelegate___);
    sub_1C93AD4(&System_Runtime_InteropServices_Marshal_TypeInfo);
    sub_1C93AD4(&float_____TypeInfo);
    sub_1C93AD4(&float___TypeInfo);
    sub_1C93AD4(&Method_CriAudioReadStream___c__DisplayClass12_0___ctor_b__0__);
    sub_1C93AD4(&CriAudioReadStream___c__DisplayClass12_0_TypeInfo);
    byte_4D29BC0 = 1;
  }
  v9 = sub_1C93D20(CriAudioReadStream___c__DisplayClass12_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v9, 0);
  if ( !v9 )
    goto LABEL_12;
  *(_DWORD *)(v9 + 16) = bufferSize;
  *(_QWORD *)(v9 + 24) = callback;
  sub_1C93A78(v9 + 24, callback);
  *(_DWORD *)(v9 + 32) = numChannels;
  System_Object___ctor((Il2CppObject *)this, 0);
  v12 = sub_1C93B7C(float_____TypeInfo, *(unsigned int *)(v9 + 32));
  *(_QWORD *)(v9 + 40) = v12;
  sub_1C93A78(v9 + 40, v12);
  if ( *(int *)(v9 + 32) >= 1 )
  {
    v13 = 0;
    v14 = 32;
    ...
    {
      v15 = *(_QWORD *)(v9 + 40);
      v10 = sub_1C93B7C(float___TypeInfo, *(unsigned int *)(v9 + 16));
      if ( !v15 )
        break;
      if ( v13 >= *(unsigned int *)(v15 + 24) )
        sub_1C93D34(v10);
      *(_QWORD *)(v15 + v14) = v10;
      sub_1C93A78(v15 + v14, v10);
      ++v13;
      v14 += 8;
...
LABEL_9:
  v16 = (CriAudioReadStream_InternalDelegate_o *)sub_1C93D20(CriAudioReadStream_InternalDelegate_TypeInfo);
  ...
  this->fields._callbackFunction_k__BackingField = System_Runtime_InteropServices_Marshal__GetFunctionPointerForDelegate_object_(
                                                     internalDelegate,
                                                     (const MethodInfo_322662C *)Method_System_Runtime_InteropServices_Marshal_GetFunctionPointerForDelegate_CriAudioReadStream_InternalDelegate___);
}
...
LABEL_9:
  this->fields.extra_arg = (intptr_t)sub_1ABCCA4;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !sub_1C93A8C(result, 0, method) )
    sub_1C93D2C(0, v3);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1ABCC78;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1ABCC10;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D29BC3 & 1) == 0 )
  {
    this = (CriAudioReadStream___c__DisplayClass12_0_o *)sub_1C93AD4(&System_Runtime_InteropServices_Marshal_TypeInfo);
    byte_4D29BC3 = 1;
  }
  ...
  if ( v7->fields.numChannels >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      System_Runtime_InteropServices_Marshal__Copy_65106848(v14, 0, IntPtr, v11, 0);
      if ( (__int64)++v12 >= v7->fields.numChannels )
        return v11;
    }
LABEL_15:
    sub_1C93D2C(this, cbobj);
  }
  return v11;
}