void __fastcall DeckListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A29CBB & 1) == 0 )
  {
    sub_1B761C0(&DeckListViewItemDraw_TypeInfo, v1);
    sub_1B761C0(&PartyOrganizationListViewItem_TypeInfo, v2);
    byte_4A29CBB = 1;
  }
  v3 = (PartyOrganizationListViewItem_o *)sub_1B7640C(PartyOrganizationListViewItem_TypeInfo);
  PartyOrganizationListViewItem___ctor_31896972(v3, 0, 1, 0LL, 0LL, 1, 0, 0LL);
  DeckListViewItemDraw_TypeInfo->static_fields->emptyFollowerListViewItem = v3;
  sub_1B76164((ServantStatusBattleListViewItem_o *)DeckListViewItemDraw_TypeInfo->static_fields, (int32_t)v3, v4, v5);
}
...
void __fastcall DeckListViewItemDraw___ctor(DeckListViewItemDraw_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A29CBA & 1) == 0 )
  {
    ...
    sub_1B761C0(&PartyOrganizationConfirmItemDraw___TypeInfo, v3);
    byte_4A29CBA = 1;
  }
  ...
  v5 = (struct PartyOrganizationConfirmItemDraw_array *)sub_1B76268(
                                                          PartyOrganizationConfirmItemDraw___TypeInfo,
                                                          (unsigned int)v4->static_fields->DeckMemberMax);
  this->fields.memberObjectList = v5;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.memberObjectList, (int32_t)v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  DeckListViewItemDraw__SetItem_31680564(this, item->fields.partyItem, mode, method);
}


void __fastcall DeckListViewItemDraw__SetItem_31680564(
        DeckListViewItemDraw_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A29CB9 & 1) == 0 )
  {
    sub_1B761C0(&DeckListViewItemDraw_TypeInfo, item);
    sub_1B761C0(&LocalizationManager_TypeInfo, v7);
    sub_1B761C0(&StringLiteral_10247/*"PARTY_ORGANIZATION_DECK_SELECT_NUMBER"*/, v8);
    this = (DeckListViewItemDraw_o *)sub_1B761C0(&StringLiteral_10246/*"PARTY_ORGANIZATION_DECK_SELECT_NAME"*/, v9);
    byte_4A29CB9 = 1;
  }
  if ( mode )
  {
    ...
    this = (DeckListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10247/*"PARTY_ORGANIZATION_DECK_SELECT_NUMBER"*/, 0LL);
    if ( !v5 )
      goto LABEL_18;
    v15 = this;
    ...
    if ( !deckNumLabel
      || (UILabel__set_text(deckNumLabel, (System_String_o *)this, 0LL),
          ...
          v19 = LocalizationManager__Get((System_String_o *)StringLiteral_10246/*"PARTY_ORGANIZATION_DECK_SELECT_NAME"*/, 0LL),
