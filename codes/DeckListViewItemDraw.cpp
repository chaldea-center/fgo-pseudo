void __fastcall DeckListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A04A01 & 1) == 0 )
  {
    sub_1B686D4(&DeckListViewItemDraw_TypeInfo, v1);
    sub_1B686D4(&PartyOrganizationListViewItem_TypeInfo, v2);
    byte_4A04A01 = 1;
  }
  v3 = (PartyOrganizationListViewItem_o *)sub_1B68920(PartyOrganizationListViewItem_TypeInfo);
  PartyOrganizationListViewItem___ctor_31835548(v3, 0, 1, 0LL, 0LL, 1, 0, 0LL);
  DeckListViewItemDraw_TypeInfo->static_fields->emptyFollowerListViewItem = v3;
  sub_1B68678((ServantStatusBattleListViewItem_o *)DeckListViewItemDraw_TypeInfo->static_fields, (int32_t)v3, v4, v5);
}
...
void __fastcall DeckListViewItemDraw___ctor(DeckListViewItemDraw_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A04A00 & 1) == 0 )
  {
    ...
    sub_1B686D4(&PartyOrganizationConfirmItemDraw___TypeInfo, v3);
    byte_4A04A00 = 1;
  }
  ...
  v5 = (struct PartyOrganizationConfirmItemDraw_array *)sub_1B6877C(
                                                          PartyOrganizationConfirmItemDraw___TypeInfo,
                                                          (unsigned int)v4->static_fields->DeckMemberMax);
  this->fields.memberObjectList = v5;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.memberObjectList, (int32_t)v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  DeckListViewItemDraw__SetItem_31620016(this, item->fields.partyItem, mode, method);
}


void __fastcall DeckListViewItemDraw__SetItem_31620016(
        DeckListViewItemDraw_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A049FF & 1) == 0 )
  {
    sub_1B686D4(&DeckListViewItemDraw_TypeInfo, item);
    sub_1B686D4(&LocalizationManager_TypeInfo, v7);
    sub_1B686D4(&StringLiteral_10205/*"PARTY_ORGANIZATION_DECK_SELECT_NUMBER"*/, v8);
    this = (DeckListViewItemDraw_o *)sub_1B686D4(&StringLiteral_10204/*"PARTY_ORGANIZATION_DECK_SELECT_NAME"*/, v9);
    byte_4A049FF = 1;
  }
  if ( mode )
  {
    ...
    this = (DeckListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10205/*"PARTY_ORGANIZATION_DECK_SELECT_NUMBER"*/, 0LL);
    if ( !v5 )
      goto LABEL_18;
    v15 = this;
    ...
    if ( !deckNumLabel
      || (UILabel__set_text(deckNumLabel, (System_String_o *)this, 0LL),
          ...
          v19 = LocalizationManager__Get((System_String_o *)StringLiteral_10204/*"PARTY_ORGANIZATION_DECK_SELECT_NAME"*/, 0LL),
