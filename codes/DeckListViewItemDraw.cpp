void __fastcall DeckListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A1B858 & 1) == 0 )
  {
    sub_1B715CC(&DeckListViewItemDraw_TypeInfo, v1);
    sub_1B715CC(&PartyOrganizationListViewItem_TypeInfo, v2);
    byte_4A1B858 = 1;
  }
  v3 = (PartyOrganizationListViewItem_o *)sub_1B71818(PartyOrganizationListViewItem_TypeInfo);
  PartyOrganizationListViewItem___ctor_31876040(v3, 0, 1, 0LL, 0LL, 1, 0, 0LL);
  DeckListViewItemDraw_TypeInfo->static_fields->emptyFollowerListViewItem = v3;
  sub_1B71570((ServantStatusBattleListViewItem_o *)DeckListViewItemDraw_TypeInfo->static_fields, (int32_t)v3, v4, v5);
}
...
void __fastcall DeckListViewItemDraw___ctor(DeckListViewItemDraw_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1B857 & 1) == 0 )
  {
    ...
    sub_1B715CC(&PartyOrganizationConfirmItemDraw___TypeInfo, v3);
    byte_4A1B857 = 1;
  }
  ...
  v5 = (struct PartyOrganizationConfirmItemDraw_array *)sub_1B71674(
        ...
        const MethodInfo *method)
{
  ...
  DeckListViewItemDraw__SetItem_31659644(this, item->fields.partyItem, mode, method);
}


void __fastcall DeckListViewItemDraw__SetItem_31659644(
        DeckListViewItemDraw_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1B856 & 1) == 0 )
  {
    sub_1B715CC(&DeckListViewItemDraw_TypeInfo, item);
    sub_1B715CC(&LocalizationManager_TypeInfo, v7);
    sub_1B715CC(&StringLiteral_10213/*"PARTY_ORGANIZATION_DECK_SELECT_NUMBER"*/, v8);
    this = (DeckListViewItemDraw_o *)sub_1B715CC(&StringLiteral_10212/*"PARTY_ORGANIZATION_DECK_SELECT_NAME"*/, v9);
    byte_4A1B856 = 1;
  }
  if ( mode )
  {
    ...
    this = (DeckListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10213/*"PARTY_ORGANIZATION_DECK_SELECT_NUMBER"*/, 0LL);
    if ( !v5 )
      goto LABEL_18;
    v15 = this;
    ...
    if ( !deckNumLabel
      || (UILabel__set_text(deckNumLabel, (System_String_o *)this, 0LL),
          ...
          v19 = LocalizationManager__Get((System_String_o *)StringLiteral_10212/*"PARTY_ORGANIZATION_DECK_SELECT_NAME"*/, 0LL),
