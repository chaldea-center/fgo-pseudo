void __fastcall DeckListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_42ABC44 & 1) == 0 )
  {
    sub_B52984(&DeckListViewItemDraw_TypeInfo);
    sub_B52984(&PartyOrganizationListViewItem_TypeInfo);
    byte_42ABC44 = 1;
  }
  v1 = (PartyOrganizationListViewItem_o *)sub_B52A54(PartyOrganizationListViewItem_TypeInfo);
  PartyOrganizationListViewItem___ctor_31272016(v1, 0, 1, 0LL, 0LL, 1, 0, 0LL);
        ...
        const MethodInfo *method)
{
  if ( !item )
    sub_B52A5C(this, 0LL);
  DeckListViewItemDraw__SetItem_16897324(this, item->fields.partyItem, mode, method);
}


void __fastcall DeckListViewItemDraw__SetItem_16897324(
        DeckListViewItemDraw_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42ABC42 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_10397/*"PARTY_ORGANIZATION_DECK_SELECT_NUMBER"*/);
    this = (DeckListViewItemDraw_o *)sub_B52984(&StringLiteral_10396/*"PARTY_ORGANIZATION_DECK_SELECT_NAME"*/);
    byte_42ABC42 = 1;
  }
  if ( mode )
  {
    ...
    this = (DeckListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10397/*"PARTY_ORGANIZATION_DECK_SELECT_NUMBER"*/, 0LL);
    if ( !v5 )
      goto LABEL_19;
    ...
    if ( !deckNumLabel
      || (UILabel__set_text(deckNumLabel, (System_String_o *)this, 0LL),
          ...
          v16 = LocalizationManager__Get((System_String_o *)StringLiteral_10396/*"PARTY_ORGANIZATION_DECK_SELECT_NAME"*/, 0LL),
