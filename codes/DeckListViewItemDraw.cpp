void __fastcall DeckListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A56EC7 & 1) == 0 )
  {
    sub_1B885B0(&DeckListViewItemDraw_TypeInfo);
    sub_1B885B0(&PartyOrganizationListViewItem_TypeInfo);
    byte_4A56EC7 = 1;
  }
  v1 = (PartyOrganizationListViewItem_o *)sub_1B887FC(PartyOrganizationListViewItem_TypeInfo);
  PartyOrganizationListViewItem___ctor_32066372(v1, 0, 1, 0LL, 0LL, 1, 0, 0LL);
  DeckListViewItemDraw_TypeInfo->static_fields->emptyFollowerListViewItem = v1;
  sub_1B88554((ServantStatusBattleListViewItem_o *)DeckListViewItemDraw_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  DeckListViewItemDraw__SetItem_31850080(this, item->fields.partyItem, mode, method);
}


void __fastcall DeckListViewItemDraw__SetItem_31850080(
        DeckListViewItemDraw_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A56EC5 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_10250/*"PARTY_ORGANIZATION_DECK_SELECT_NUMBER"*/);
    this = (DeckListViewItemDraw_o *)sub_1B885B0(&StringLiteral_10249/*"PARTY_ORGANIZATION_DECK_SELECT_NAME"*/);
    byte_4A56EC5 = 1;
  }
  if ( mode )
  {
    ...
    this = (DeckListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10250/*"PARTY_ORGANIZATION_DECK_SELECT_NUMBER"*/, 0LL);
    if ( !v5 )
      goto LABEL_18;
    v12 = this;
    ...
    if ( !deckNumLabel
      || (UILabel__set_text(deckNumLabel, (System_String_o *)this, 0LL),
          ...
          v16 = LocalizationManager__Get((System_String_o *)StringLiteral_10249/*"PARTY_ORGANIZATION_DECK_SELECT_NAME"*/, 0LL),
