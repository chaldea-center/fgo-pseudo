void __fastcall DeckListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AFD917 & 1) == 0 )
  {
    sub_1BC3008(&DeckListViewItemDraw_TypeInfo, v1);
    sub_1BC3008(&PartyOrganizationListViewItem_TypeInfo, v2);
    byte_4AFD917 = 1;
  }
  v3 = (PartyOrganizationListViewItem_o *)sub_1BC3254(PartyOrganizationListViewItem_TypeInfo);
  PartyOrganizationListViewItem___ctor_33380072(v3, 0, 1, 0LL, 0LL, 1, 0, 0LL);
  DeckListViewItemDraw_TypeInfo->static_fields->emptyFollowerListViewItem = v3;
  sub_1BC2FAC((CGThumbnailListItem_o *)DeckListViewItemDraw_TypeInfo->static_fields, (int32_t)v3, v4, v5);
}
...
void __fastcall DeckListViewItemDraw___ctor(DeckListViewItemDraw_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFD916 & 1) == 0 )
  {
    ...
    sub_1BC3008(&PartyOrganizationConfirmItemDraw___TypeInfo, v3);
    byte_4AFD916 = 1;
  }
  ...
  v5 = (struct PartyOrganizationConfirmItemDraw_array *)sub_1BC30B0(
        ...
        const MethodInfo *method)
{
  ...
  DeckListViewItemDraw__SetItem_33120356(this, item->fields.partyItem, mode, method);
}


void __fastcall DeckListViewItemDraw__SetItem_33120356(
        DeckListViewItemDraw_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFD915 & 1) == 0 )
  {
    sub_1BC3008(&DeckListViewItemDraw_TypeInfo, item);
    sub_1BC3008(&LocalizationManager_TypeInfo, v7);
    sub_1BC3008(&StringLiteral_10138/*"PARTY_ORGANIZATION_DECK_SELECT_NUMBER"*/, v8);
    this = (DeckListViewItemDraw_o *)sub_1BC3008(&StringLiteral_10137/*"PARTY_ORGANIZATION_DECK_SELECT_NAME"*/, v9);
    byte_4AFD915 = 1;
  }
  if ( mode )
  {
    ...
    this = (DeckListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10138/*"PARTY_ORGANIZATION_DECK_SELECT_NUMBER"*/, 0LL);
    if ( !v5 )
      goto LABEL_18;
    v16 = this;
    ...
    if ( !deckNumLabel
      || (UILabel__set_text(deckNumLabel, (System_String_o *)this, 0LL),
          ...
          v20 = LocalizationManager__Get((System_String_o *)StringLiteral_10137/*"PARTY_ORGANIZATION_DECK_SELECT_NAME"*/, 0LL),
