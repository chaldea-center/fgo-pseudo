void DeckListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CC2BC9 & 1) == 0 )
  {
    sub_1C713B0(&DeckListViewItemDraw_TypeInfo);
    sub_1C713B0(&PartyOrganizationListViewItem_TypeInfo);
    byte_4CC2BC9 = 1;
  }
  v1 = (PartyOrganizationListViewItem_o *)sub_1C715FC(PartyOrganizationListViewItem_TypeInfo);
  PartyOrganizationListViewItem___ctor_34482464(v1, 0, 1, 0, 0, 1, 0, 0, 0);
        ...
        const MethodInfo *method)
{
  if ( !item )
    sub_1C71608(this, 0);
  DeckListViewItemDraw__SetItem_34234264(this, item->fields.partyItem, mode, method);
}


void DeckListViewItemDraw__SetItem_34234264(
        DeckListViewItemDraw_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC2BC7 & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_10229/*"PARTY_ORGANIZATION_DECK_SELECT_NUMBER"*/);
    this = (DeckListViewItemDraw_o *)sub_1C713B0(&StringLiteral_10228/*"PARTY_ORGANIZATION_DECK_SELECT_NAME"*/);
    byte_4CC2BC7 = 1;
  }
  if ( mode )
  {
    ...
    this = (DeckListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10229/*"PARTY_ORGANIZATION_DECK_SELECT_NUMBER"*/, 0);
    if ( !v5 )
      goto LABEL_18;
    v12 = this;
    ...
    if ( !deckNumLabel
      || (UILabel__set_text(deckNumLabel, (System_String_o *)this, 0),
          ...
          v16 = LocalizationManager__Get((System_String_o *)StringLiteral_10228/*"PARTY_ORGANIZATION_DECK_SELECT_NAME"*/, 0),
