void __fastcall DeckListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B403A7 & 1) == 0 )
  {
    sub_1BDB878(&DeckListViewItemDraw_TypeInfo, v1);
    sub_1BDB878(&PartyOrganizationListViewItem_TypeInfo, v2);
    byte_4B403A7 = 1;
  }
  v3 = (PartyOrganizationListViewItem_o *)sub_1BDBAC4(PartyOrganizationListViewItem_TypeInfo);
  PartyOrganizationListViewItem___ctor_33386572(v3, 0, 1, 0LL, 0LL, 1, 0, 0LL);
  DeckListViewItemDraw_TypeInfo->static_fields->emptyFollowerListViewItem = v3;
  sub_1BDB81C((CGThumbnailListItem_o *)DeckListViewItemDraw_TypeInfo->static_fields, (int32_t)v3, v4, v5);
}
...
void __fastcall DeckListViewItemDraw___ctor(DeckListViewItemDraw_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B403A6 & 1) == 0 )
  {
    ...
    sub_1BDB878(&PartyOrganizationConfirmItemDraw___TypeInfo, v3);
    byte_4B403A6 = 1;
  }
  ...
  v5 = (struct PartyOrganizationConfirmItemDraw_array *)sub_1BDB920(
        ...
        const MethodInfo *method)
{
  ...
  DeckListViewItemDraw__SetItem_33126856(this, item->fields.partyItem, mode, method);
}


void __fastcall DeckListViewItemDraw__SetItem_33126856(
        DeckListViewItemDraw_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B403A5 & 1) == 0 )
  {
    sub_1BDB878(&DeckListViewItemDraw_TypeInfo, item);
    sub_1BDB878(&LocalizationManager_TypeInfo, v7);
    sub_1BDB878(&StringLiteral_10225/*"PARTY_ORGANIZATION_DECK_SELECT_NUMBER"*/, v8);
    this = (DeckListViewItemDraw_o *)sub_1BDB878(&StringLiteral_10224/*"PARTY_ORGANIZATION_DECK_SELECT_NAME"*/, v9);
    byte_4B403A5 = 1;
  }
  if ( mode )
  {
    ...
    this = (DeckListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10225/*"PARTY_ORGANIZATION_DECK_SELECT_NUMBER"*/, 0LL);
    if ( !v5 )
      goto LABEL_18;
    v16 = this;
    ...
    if ( !deckNumLabel
      || (UILabel__set_text(deckNumLabel, (System_String_o *)this, 0LL),
          ...
          v20 = LocalizationManager__Get((System_String_o *)StringLiteral_10224/*"PARTY_ORGANIZATION_DECK_SELECT_NAME"*/, 0LL),
