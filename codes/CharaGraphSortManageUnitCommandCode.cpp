        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDB902 & 1) == 0 )
  {
    sub_1C21E38(&CommandCodeCharaGraphFilterLogic_TypeInfo);
    byte_4BDB902 = 1;
  }
  v2 = (Il2CppObject *)sub_1C22084(CommandCodeCharaGraphFilterLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDB901 & 1) == 0 )
  {
    sub_1C21E38(&CommandCodeCharaGraphSortLogic_TypeInfo);
    byte_4BDB901 = 1;
  }
  v2 = (CommandCodeCharaGraphSortLogic_o *)sub_1C22084(CommandCodeCharaGraphSortLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  return (System_String_o *)StringLiteral_1492/*"4"*/;
}