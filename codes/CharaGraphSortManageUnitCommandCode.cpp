        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2D341 & 1) == 0 )
  {
    sub_1B761C0(&CommandCodeCharaGraphFilterLogic_TypeInfo, method);
    byte_4A2D341 = 1;
  }
  v2 = (CharaGraphFilterLogicBase_o *)sub_1B7640C(CommandCodeCharaGraphFilterLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2D340 & 1) == 0 )
  {
    sub_1B761C0(&CommandCodeCharaGraphSortLogic_TypeInfo, method);
    byte_4A2D340 = 1;
  }
  v2 = (CharaGraphSortLogicBase_o *)sub_1B7640C(CommandCodeCharaGraphSortLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  if ( (byte_4A2D33F & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_1493/*"4"*/, method);
    byte_4A2D33F = 1;
  }
