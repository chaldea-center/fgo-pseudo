        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596FAE7 & 1) == 0 )
  {
    sub_2213A60(&CommandCodeCharaGraphFilterLogic_TypeInfo);
    byte_596FAE7 = 1;
  }
  v2 = (Il2CppObject *)sub_2213CCC(CommandCodeCharaGraphFilterLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596FAE6 & 1) == 0 )
  {
    sub_2213A60(&CommandCodeCharaGraphSortLogic_TypeInfo);
    byte_596FAE6 = 1;
  }
  v2 = (CharaGraphSortLogicBase_o *)sub_2213CCC(CommandCodeCharaGraphSortLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  return (System_String_o *)StringLiteral_1480/*"4"*/;
}