        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5937984 & 1) == 0 )
  {
    sub_21FFC50(&CommandCodeCharaGraphFilterLogic_TypeInfo);
    byte_5937984 = 1;
  }
  v2 = (Il2CppObject *)sub_21FFEBC(CommandCodeCharaGraphFilterLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5937983 & 1) == 0 )
  {
    sub_21FFC50(&CommandCodeCharaGraphSortLogic_TypeInfo);
    byte_5937983 = 1;
  }
  v2 = (CharaGraphSortLogicBase_o *)sub_21FFEBC(CommandCodeCharaGraphSortLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  return (System_String_o *)StringLiteral_1479/*"4"*/;
}