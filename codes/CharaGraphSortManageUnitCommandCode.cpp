        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6E6C & 1) == 0 )
  {
    sub_1C1ABD4(&CommandCodeCharaGraphFilterLogic_TypeInfo, method);
    byte_4BC6E6C = 1;
  }
  v2 = (Il2CppObject *)sub_1C1AE20(CommandCodeCharaGraphFilterLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6E6B & 1) == 0 )
  {
    sub_1C1ABD4(&CommandCodeCharaGraphSortLogic_TypeInfo, method);
    byte_4BC6E6B = 1;
  }
  v2 = (CommandCodeCharaGraphSortLogic_o *)sub_1C1AE20(CommandCodeCharaGraphSortLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  if ( (byte_4BC6E6A & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_1493/*"4"*/, method);
    byte_4BC6E6A = 1;
  }
