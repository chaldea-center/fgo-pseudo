        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A55C & 1) == 0 )
  {
    sub_1B885B0(&CommandCodeCharaGraphFilterLogic_TypeInfo);
    byte_4A5A55C = 1;
  }
  v2 = (Il2CppObject *)sub_1B887FC(CommandCodeCharaGraphFilterLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A55B & 1) == 0 )
  {
    sub_1B885B0(&CommandCodeCharaGraphSortLogic_TypeInfo);
    byte_4A5A55B = 1;
  }
  v2 = (CommandCodeCharaGraphSortLogic_o *)sub_1B887FC(CommandCodeCharaGraphSortLogic_TypeInfo);
