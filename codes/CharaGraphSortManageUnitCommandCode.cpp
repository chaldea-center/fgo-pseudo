        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B65F7B & 1) == 0 )
  {
    sub_1BE4ACC(&CommandCodeCharaGraphFilterLogic_TypeInfo, method);
    byte_4B65F7B = 1;
  }
  v2 = (Il2CppObject *)sub_1BE4D18(CommandCodeCharaGraphFilterLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B65F7A & 1) == 0 )
  {
    sub_1BE4ACC(&CommandCodeCharaGraphSortLogic_TypeInfo, method);
    byte_4B65F7A = 1;
  }
  v2 = (CommandCodeCharaGraphSortLogic_o *)sub_1BE4D18(CommandCodeCharaGraphSortLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  if ( (byte_4B65F79 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_1490/*"4"*/, method);
    byte_4B65F79 = 1;
  }
