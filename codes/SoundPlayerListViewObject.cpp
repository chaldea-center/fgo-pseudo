...
void __fastcall SoundPlayerListViewObject__Awake(SoundPlayerListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB00E1 & 1) == 0 )
  {
    sub_1C13D24(&Method_UnityEngine_GameObject_GetComponent_SoundPlayerListViewItemDraw___, method);
    byte_4BB00E1 = 1;
  }
  ...
  this->fields.itemDraw = (struct SoundPlayerListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_object_(
                                                                    dispObject,
                                                                    (const MethodInfo_2FDF9FC *)Method_UnityEngine_GameObject_GetComponent_SoundPlayerListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB00E2 & 1) == 0 )
  {
    sub_1C13D24(&SoundPlayerListViewItem_TypeInfo, method);
    byte_4BB00E2 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB00E4 & 1) == 0 )
  {
    sub_1C13D24(&SoundPlayerListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4BB00E4 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall SoundPlayerListViewObject__Init_32636928(
        SoundPlayerListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall SoundPlayerListViewObject__Init_32638416(
        SoundPlayerListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall SoundPlayerListViewObject__Init_32638500(
        SoundPlayerListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB00E3 & 1) == 0 )
  {
    ...
    sub_1C13D24(&SoundPlayerListViewItem_TypeInfo, v5);
    byte_4BB00E3 = 1;
  }
...
void __fastcall SoundPlayerListViewObject__SetItem_32639988(
        SoundPlayerListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall SoundPlayerListViewObject__SetupDisp(SoundPlayerListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB00E5 & 1) == 0 )
  {
    ...
    sub_1C13D24(&SoundPlayerListViewItem_TypeInfo, v3);
    byte_4BB00E5 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
        ...
        const MethodInfo *method)
{
  ...
  v11 = (SoundPlayerListViewObject_o *)sub_1C14240(v8);
...
void __fastcall SoundPlayerListViewObject__onClickSelect(SoundPlayerListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C13D24(&SoundPlayerListViewItem_TypeInfo, method);
    sub_1C13D24(&Method_SoundPlayerListViewObject_onClickSelect__, v3);
    sub_1C13D24(&StringLiteral_22616/*"old_sku_period_string"*/, v4);
    this = (SoundPlayerListViewObject_o *)sub_1C13D24(&StringLiteral_22612/*"oidValue"*/, v5);
    byte_4BB00E6 = 1;
  }
    ...
    switch ( sortIndex )
    {
      case 2:
        ...
        if ( (*((_BYTE *)Method_SoundPlayerListViewObject_onClickSelect__ + 83) & 2) != 0 )
          v10 = (_QWORD *)sub_1C13D3C(Method_SoundPlayerListViewObject_onClickSelect__);
      ...
      case 1:
        ...
        if ( this )
        {
          v9 = &StringLiteral_22612/*"oidValue"*/;
          goto LABEL_17;
        }
LABEL_18:
      ...
      case 0:
        ...
        if ( this )
        {
          v9 = &StringLiteral_22616/*"old_sku_period_string"*/;
LABEL_17:
