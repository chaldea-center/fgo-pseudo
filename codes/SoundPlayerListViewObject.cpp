...
void __fastcall SoundPlayerListViewObject__Awake(SoundPlayerListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B401E0 & 1) == 0 )
  {
    sub_1BDB878(&Method_UnityEngine_GameObject_GetComponent_SoundPlayerListViewItemDraw___, method);
    byte_4B401E0 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_3088520 *)Method_UnityEngine_GameObject_GetComponent_SoundPlayerListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B401E1 & 1) == 0 )
  {
    sub_1BDB878(&SoundPlayerListViewItem_TypeInfo, method);
    byte_4B401E1 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B401E3 & 1) == 0 )
  {
    sub_1BDB878(&SoundPlayerListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4B401E3 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall SoundPlayerListViewObject__Init_32953924(
        SoundPlayerListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall SoundPlayerListViewObject__Init_32955412(
        SoundPlayerListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall SoundPlayerListViewObject__Init_32955496(
        SoundPlayerListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B401E2 & 1) == 0 )
  {
    ...
    sub_1BDB878(&SoundPlayerListViewItem_TypeInfo, v5);
    byte_4B401E2 = 1;
  }
...
void __fastcall SoundPlayerListViewObject__SetItem_32956984(
        SoundPlayerListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall SoundPlayerListViewObject__SetupDisp(SoundPlayerListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B401E4 & 1) == 0 )
  {
    ...
    sub_1BDB878(&SoundPlayerListViewItem_TypeInfo, v3);
    byte_4B401E4 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
        ...
        const MethodInfo *method)
{
  ...
  v11 = (SoundPlayerListViewObject_o *)sub_1BDBD94(v8);
...
void __fastcall SoundPlayerListViewObject__onClickSelect(SoundPlayerListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&SoundPlayerListViewItem_TypeInfo, method);
    sub_1BDB878(&Method_SoundPlayerListViewObject_onClickSelect__, v3);
    sub_1BDB878(&StringLiteral_22422/*"onClickSelectListView"*/, v4);
    this = (SoundPlayerListViewObject_o *)sub_1BDB878(&StringLiteral_22418/*"onClickCheckListView"*/, v5);
    byte_4B401E5 = 1;
  }
    ...
    switch ( sortIndex )
    {
      case 2:
        ...
        if ( (*((_BYTE *)Method_SoundPlayerListViewObject_onClickSelect__ + 83) & 2) != 0 )
          v10 = (_QWORD *)sub_1BDB890(Method_SoundPlayerListViewObject_onClickSelect__);
      ...
      case 1:
        ...
        if ( this )
        {
          v9 = &StringLiteral_22418/*"onClickCheckListView"*/;
          goto LABEL_17;
        }
LABEL_18:
      ...
      case 0:
        ...
        if ( this )
        {
          v9 = &StringLiteral_22422/*"onClickSelectListView"*/;
LABEL_17:
