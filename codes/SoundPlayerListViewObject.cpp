...
void __fastcall SoundPlayerListViewObject__Awake(SoundPlayerListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A29A7F & 1) == 0 )
  {
    sub_1B761C0(&Method_UnityEngine_GameObject_GetComponent_SoundPlayerListViewItemDraw___, method);
    byte_4A29A7F = 1;
  }
  ...
  this->fields.itemDraw = (struct SoundPlayerListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_object_(
                                                                    dispObject,
                                                                    (const MethodInfo_2EB19B8 *)Method_UnityEngine_GameObject_GetComponent_SoundPlayerListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A29A80 & 1) == 0 )
  {
    sub_1B761C0(&SoundPlayerListViewItem_TypeInfo, method);
    byte_4A29A80 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A29A82 & 1) == 0 )
  {
    sub_1B761C0(&SoundPlayerListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4A29A82 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall SoundPlayerListViewObject__Init_31453504(
        SoundPlayerListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall SoundPlayerListViewObject__Init_31454992(
        SoundPlayerListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall SoundPlayerListViewObject__Init_31455076(
        SoundPlayerListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A29A81 & 1) == 0 )
  {
    ...
    sub_1B761C0(&SoundPlayerListViewItem_TypeInfo, v5);
    byte_4A29A81 = 1;
  }
...
void __fastcall SoundPlayerListViewObject__SetItem_31456564(
        SoundPlayerListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall SoundPlayerListViewObject__SetupDisp(SoundPlayerListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A29A83 & 1) == 0 )
  {
    ...
    sub_1B761C0(&SoundPlayerListViewItem_TypeInfo, v3);
    byte_4A29A83 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
        ...
        const MethodInfo *method)
{
  ...
  v11 = (SoundPlayerListViewObject_o *)sub_1B766DC(v8);
...
void __fastcall SoundPlayerListViewObject__onClickSelect(SoundPlayerListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B761C0(&SoundPlayerListViewItem_TypeInfo, method);
    sub_1B761C0(&Method_SoundPlayerListViewObject_onClickSelect__, v3);
    sub_1B761C0(&StringLiteral_22237/*"onClickSelectListView"*/, v4);
    this = (SoundPlayerListViewObject_o *)sub_1B761C0(&StringLiteral_22233/*"onClickCheckListView"*/, v5);
    byte_4A29A84 = 1;
  }
    ...
    switch ( sortIndex )
    {
      case 2:
        ...
        if ( (*((_BYTE *)Method_SoundPlayerListViewObject_onClickSelect__ + 83) & 2) != 0 )
          v10 = (_QWORD *)sub_1B761D8(Method_SoundPlayerListViewObject_onClickSelect__);
      ...
      case 1:
        ...
        if ( this )
        {
          v9 = &StringLiteral_22233/*"onClickCheckListView"*/;
          goto LABEL_17;
        }
LABEL_18:
      ...
      case 0:
        ...
        if ( this )
        {
          v9 = &StringLiteral_22237/*"onClickSelectListView"*/;
LABEL_17:
