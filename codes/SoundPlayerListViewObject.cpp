...
void __fastcall SoundPlayerListViewObject__Awake(SoundPlayerListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA0B8 & 1) == 0 )
  {
    sub_1B64870(&Method_UnityEngine_GameObject_GetComponent_SoundPlayerListViewItemDraw___, method);
    byte_49FA0B8 = 1;
  }
  ...
  this->fields.itemDraw = (struct SoundPlayerListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_object_(
                                                                    dispObject,
                                                                    (const MethodInfo_2E8A1B4 *)Method_UnityEngine_GameObject_GetComponent_SoundPlayerListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA0B9 & 1) == 0 )
  {
    sub_1B64870(&SoundPlayerListViewItem_TypeInfo, method);
    byte_49FA0B9 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA0BB & 1) == 0 )
  {
    sub_1B64870(&SoundPlayerListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_49FA0BB = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall SoundPlayerListViewObject__Init_31366660(
        SoundPlayerListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall SoundPlayerListViewObject__Init_31368148(
        SoundPlayerListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall SoundPlayerListViewObject__Init_31368232(
        SoundPlayerListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA0BA & 1) == 0 )
  {
    ...
    sub_1B64870(&SoundPlayerListViewItem_TypeInfo, v5);
    byte_49FA0BA = 1;
  }
...
void __fastcall SoundPlayerListViewObject__SetItem_31369720(
        SoundPlayerListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall SoundPlayerListViewObject__SetupDisp(SoundPlayerListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA0BC & 1) == 0 )
  {
    ...
    sub_1B64870(&SoundPlayerListViewItem_TypeInfo, v3);
    byte_49FA0BC = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
        ...
        const MethodInfo *method)
{
  ...
  v11 = (SoundPlayerListViewObject_o *)sub_1B64D8C(v8);
...
void __fastcall SoundPlayerListViewObject__onClickSelect(SoundPlayerListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B64870(&SoundPlayerListViewItem_TypeInfo, method);
    sub_1B64870(&Method_SoundPlayerListViewObject_onClickSelect__, v3);
    sub_1B64870(&StringLiteral_22161/*"onClickSelectListView"*/, v4);
    this = (SoundPlayerListViewObject_o *)sub_1B64870(&StringLiteral_22157/*"onClickCheckListView"*/, v5);
    byte_49FA0BD = 1;
  }
    ...
    switch ( sortIndex )
    {
      case 2:
        ...
        if ( (*((_BYTE *)Method_SoundPlayerListViewObject_onClickSelect__ + 83) & 2) != 0 )
          v10 = (_QWORD *)sub_1B64888(Method_SoundPlayerListViewObject_onClickSelect__);
