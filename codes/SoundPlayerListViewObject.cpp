...
void __fastcall SoundPlayerListViewObject__Awake(SoundPlayerListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC3497 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_UnityEngine_GameObject_GetComponent_SoundPlayerListViewItemDraw___, method);
    byte_4BC3497 = 1;
  }
  ...
  this->fields.itemDraw = (struct SoundPlayerListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_object_(
                                                                    dispObject,
                                                                    (const MethodInfo_2FEFBC0 *)Method_UnityEngine_GameObject_GetComponent_SoundPlayerListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC3498 & 1) == 0 )
  {
    sub_1C1ABD4(&SoundPlayerListViewItem_TypeInfo, method);
    byte_4BC3498 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC349A & 1) == 0 )
  {
    sub_1C1ABD4(&SoundPlayerListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4BC349A = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall SoundPlayerListViewObject__Init_32672456(
        SoundPlayerListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall SoundPlayerListViewObject__Init_32673944(
        SoundPlayerListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall SoundPlayerListViewObject__Init_32674028(
        SoundPlayerListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC3499 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&SoundPlayerListViewItem_TypeInfo, v5);
    byte_4BC3499 = 1;
  }
...
void __fastcall SoundPlayerListViewObject__SetItem_32675516(
        SoundPlayerListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall SoundPlayerListViewObject__SetupDisp(SoundPlayerListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC349B & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&SoundPlayerListViewItem_TypeInfo, v3);
    byte_4BC349B = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
        ...
        const MethodInfo *method)
{
  ...
  v11 = (SoundPlayerListViewObject_o *)sub_1C1B0F0(v8);
...
void __fastcall SoundPlayerListViewObject__onClickSelect(SoundPlayerListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C1ABD4(&SoundPlayerListViewItem_TypeInfo, method);
    sub_1C1ABD4(&Method_SoundPlayerListViewObject_onClickSelect__, v3);
    sub_1C1ABD4(&StringLiteral_22634/*"onClickSelectListView"*/, v4);
    this = (SoundPlayerListViewObject_o *)sub_1C1ABD4(&StringLiteral_22630/*"onClickCheckListView"*/, v5);
    byte_4BC349C = 1;
  }
    ...
    switch ( sortIndex )
    {
      case 2:
        ...
        if ( (*((_BYTE *)Method_SoundPlayerListViewObject_onClickSelect__ + 83) & 2) != 0 )
          v10 = (_QWORD *)sub_1C1ABEC(Method_SoundPlayerListViewObject_onClickSelect__);
      ...
      case 1:
        ...
        if ( this )
        {
          v9 = &StringLiteral_22630/*"onClickCheckListView"*/;
          goto LABEL_17;
        }
LABEL_18:
      ...
      case 0:
        ...
        if ( this )
        {
          v9 = &StringLiteral_22634/*"onClickSelectListView"*/;
LABEL_17:
