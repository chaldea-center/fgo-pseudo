        ...
        const MethodInfo *method)
{
  if ( (byte_4A2E9B2 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataEntityBase_CreateMultiplePK_int__int__int___, *(_QWORD *)&limitCount);
    byte_4A2E9B2 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E9B1 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_System_Tuple_int__int___ctor__, v4);
    sub_1B761C0(&System_Tuple_int__int__TypeInfo, v5);
    sub_1B761C0(&Method_WeightRate_int___ctor__, v6);
    sub_1B761C0(&Method_WeightRate_int__getData__, v7);
    sub_1B761C0(&Method_WeightRate_int__getTotalWeight__, v8);
    sub_1B761C0(&Method_WeightRate_int__setWeight__, v9);
    sub_1B761C0(&WeightRate_int__TypeInfo, v10);
    byte_4A2E9B1 = 1;
  }
  v11 = (WeightRate_int__o *)sub_1B7640C(WeightRate_int__TypeInfo);
  WeightRate_int____ctor(v11, (const MethodInfo_38B2814 *)Method_WeightRate_int___ctor__);
  ...
  if ( !v11
    || (v19 = UnityEngine_Random__Range_69247148(0, v11->fields.totalweight, 0LL),
        Data = WeightRate_int___getData(v11, v19, (const MethodInfo_38B21A4 *)Method_WeightRate_int__getData__),
...
LABEL_18:
  ...
  v24 = (System_Tuple_int__int__o *)sub_1B7640C(System_Tuple_int__int__TypeInfo);
  System_Tuple_int__int____ctor(v24, v21, v23, (const MethodInfo_37A2FB0 *)Method_System_Tuple_int__int___ctor__);
  return v24;
}