        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D316CD & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_System_Tuple_int__int___ctor__);
    sub_1C93AD4(&System_Tuple_int__int__TypeInfo);
  ...
  v3 = (WeightRate_int__o *)sub_1C93D20(WeightRate_int__TypeInfo);
  WeightRate_int____ctor(v3, (const MethodInfo_3C8EB14 *)Method_WeightRate_int___ctor__);
  ...
  if ( !v3
    || (v11 = UnityEngine_Random__Range_72079620(0, v3->fields.totalweight, 0),
        Data = WeightRate_int___getData(v3, v11, (const MethodInfo_3C8E4A4 *)Method_WeightRate_int__getData__),
...
LABEL_18:
  ...
  v16 = (System_Tuple_int__int__o *)sub_1C93D20(System_Tuple_int__int__TypeInfo);
  System_Tuple_int__int____ctor(v16, v13, v15, (const MethodInfo_3B78DE4 *)Method_System_Tuple_int__int___ctor__);
  return v16;
}