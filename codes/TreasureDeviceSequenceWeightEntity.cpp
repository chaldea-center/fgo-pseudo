        ...
        const MethodInfo *method)
{
  if ( (byte_48E320D & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataEntityBase_CreateMultiplePK_int__int__int___, *(_QWORD *)&limitCount);
    byte_48E320D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E320C & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_System_Tuple_int__int___ctor__, v4);
    sub_1B00CCC(&System_Tuple_int__int__TypeInfo, v5);
    sub_1B00CCC(&Method_WeightRate_int___ctor__, v6);
    sub_1B00CCC(&Method_WeightRate_int__getData__, v7);
    sub_1B00CCC(&Method_WeightRate_int__getTotalWeight__, v8);
    sub_1B00CCC(&Method_WeightRate_int__setWeight__, v9);
    sub_1B00CCC(&WeightRate_int__TypeInfo, v10);
    byte_48E320C = 1;
  }
  v11 = (WeightRate_int__o *)sub_1B00F18(WeightRate_int__TypeInfo);
  WeightRate_int____ctor(v11, (const MethodInfo_379B874 *)Method_WeightRate_int___ctor__);
  ...
  if ( !v11
    || (v19 = UnityEngine_Random__Range_68037396(0, v11->fields.totalweight, 0LL),
        Data = WeightRate_int___getData(v11, v19, (const MethodInfo_379B204 *)Method_WeightRate_int__getData__),
...
LABEL_18:
  ...
  v24 = (System_Tuple_int__int__o *)sub_1B00F18(System_Tuple_int__int__TypeInfo);
  System_Tuple_int__int____ctor(v24, v21, v23, (const MethodInfo_368CDB4 *)Method_System_Tuple_int__int___ctor__);
  return v24;
}