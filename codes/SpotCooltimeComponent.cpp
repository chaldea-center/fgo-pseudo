        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A52887 & 1) == 0 )
  {
    sub_1B863B8(&LocalizationManager_TypeInfo, *(_QWORD *)&remainTime);
    sub_1B863B8(&StringLiteral_4921/*"D2"*/, v4);
    sub_1B863B8(&StringLiteral_5537/*"EVENT_COOLTIME_REMAIN"*/, v5);
    byte_4A52887 = 1;
  }
  v13 = remainTime / 3600;
  v11 = remainTime % 60;
  ...
  v6 = LocalizationManager__Get((System_String_o *)StringLiteral_5537/*"EVENT_COOLTIME_REMAIN"*/, 0LL);
  v7 = (Il2CppObject *)System_Int32__ToString_63159428((int32_t)&v13, (System_String_o *)StringLiteral_4921/*"D2"*/, 0LL);
  v8 = (Il2CppObject *)System_Int32__ToString_63159428((int32_t)&v12, (System_String_o *)StringLiteral_4921/*"D2"*/, 0LL);
  v9 = (Il2CppObject *)System_Int32__ToString_63159428((int32_t)&v11, (System_String_o *)StringLiteral_4921/*"D2"*/, 0LL);
  return System_String__Format_61686536(v6, v7, v8, v9, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  *(SpotCooltimeComponent_c **)((char *)&this->klass + v4) = (SpotCooltimeComponent_c *)mapGimmick;
  sub_1B8635C((CGThumbnailListItem_o *)p_spotActiveGimmick, (int32_t)mapGimmick, isActiveCooltimeGimmick, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A52889 & 1) == 0 )
  {
    sub_1B863B8(&AtlasManager_TypeInfo, userCooltimeEntity);
    sub_1B863B8(&StringLiteral_18035/*"cooltime_base"*/, v7);
    byte_4A52889 = 1;
  }
  this->fields.userCooltimeEntity = userCooltimeEntity;
  sub_1B8635C(
    (CGThumbnailListItem_o *)&this->fields.userCooltimeEntity,
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.cooltimeEntity, (int32_t)MasterEntity, v11, v12);
  this->fields.targetSpot = targetSpot;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.targetSpot, (int32_t)targetSpot, v13, v14);
  bgSprite = this->fields.bgSprite;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetEventUI(bgSprite, (System_String_o *)StringLiteral_18035/*"cooltime_base"*/, 0LL);
...
void __fastcall SpotCooltimeComponent__UpdateDisp(SpotCooltimeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A52886 & 1) == 0 )
  {
    ...
    this = (SpotCooltimeComponent_o *)sub_1B863B8(&Method_SingletonMonoBehaviour_QuestAfterAction__get_Instance__, v4);
    byte_4A52886 = 1;
  }
  ...
  this = (SpotCooltimeComponent_o *)NetworkManager__getTime_39521860(v30, 0LL);
  ...
  *((_DWORD *)&cooltimeLb->fields.UnityEngine_Behaviour_Fields + 1) = v19;
  ...
  if ( !this
    ...
    || (UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)this, v16, 0LL),
        (this = (SpotCooltimeComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3839680 *)Method_SingletonMonoBehaviour_QuestAfterAction__get_Instance__)) == 0LL) )
  {
LABEL_54:
...
void __fastcall SpotCooltimeComponent__UpdateQuestCount(SpotCooltimeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A52888 & 1) == 0 )
  {
    ...
    this = (SpotCooltimeComponent_o *)sub_1B863B8(&TerminalSceneComponent_TypeInfo, v3);
    byte_4A52888 = 1;
  }
  targetSpot = v2->fields.targetSpot;
  if ( !targetSpot )
  ...
  {
    this = (SpotCooltimeComponent_o *)SingletonTemplate_object___get_Instance((const MethodInfo_3839AA0 *)Method_SingletonTemplate_QuestTree__get_Instance__);
    cooltimeEntity = v2->fields.cooltimeEntity;
