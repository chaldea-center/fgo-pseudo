        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB0814 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_5572/*"EVENT_COOLTIME_REMAIN"*/);
    byte_4CB0814 = 1;
  }
  v11 = remainTime / 3600;
  v9 = remainTime % 60;
  ...
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_5572/*"EVENT_COOLTIME_REMAIN"*/, 0);
  v5 = (Il2CppObject *)System_Int32__ToString_65475288((int32_t)&v11, (System_String_o *)StringLiteral_4942/*"D2"*/, 0);
  v6 = (Il2CppObject *)System_Int32__ToString_65475288((int32_t)&v10, (System_String_o *)StringLiteral_4942/*"D2"*/, 0);
  v7 = (Il2CppObject *)System_Int32__ToString_65475288((int32_t)&v9, (System_String_o *)StringLiteral_4942/*"D2"*/, 0);
  return System_String__Format_64008168(v4, v5, v6, v7, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  *(SpotCooltimeComponent_c **)((char *)&this->klass + v4) = (SpotCooltimeComponent_c *)mapGimmick;
  sub_1C6B9AC(p_spotActiveGimmick, mapGimmick);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB0816 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_18294/*"cooltime_base"*/);
    byte_4CB0816 = 1;
  }
  this->fields.userCooltimeEntity = userCooltimeEntity;
  v7 = sub_1C6B9AC(&this->fields.userCooltimeEntity, userCooltimeEntity);
  ...
  sub_1C6B9AC(&this->fields.cooltimeEntity, MasterEntity);
  this->fields.targetSpot = targetSpot;
  sub_1C6B9AC(&this->fields.targetSpot, targetSpot);
  bgSprite = this->fields.bgSprite;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetEventUI(bgSprite, (System_String_o *)StringLiteral_18294/*"cooltime_base"*/, 0);
...
void SpotCooltimeComponent__UpdateDisp(SpotCooltimeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB0813 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&UnityEngine_Object_TypeInfo);
    this = (SpotCooltimeComponent_o *)sub_1C6BA08(&Method_SingletonMonoBehaviour_QuestAfterAction__get_Instance__);
    byte_4CB0813 = 1;
  }
  ...
  this = (SpotCooltimeComponent_o *)NetworkManager__getTime_41599764(v7, 0);
  ...
  if ( !this
    ...
    || (UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)this, v15, 0),
        (this = (SpotCooltimeComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A4F3B4 *)Method_SingletonMonoBehaviour_QuestAfterAction__get_Instance__)) == 0) )
  {
LABEL_54:
...
void SpotCooltimeComponent__UpdateQuestCount(SpotCooltimeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB0815 & 1) == 0 )
  {
    ...
    this = (SpotCooltimeComponent_o *)sub_1C6BA08(&TerminalSceneComponent_TypeInfo);
    byte_4CB0815 = 1;
  }
  targetSpot = v2->fields.targetSpot;
  if ( !targetSpot )
  ...
  {
    this = (SpotCooltimeComponent_o *)SingletonTemplate_object___get_Instance((const MethodInfo_3A4F8A4 *)Method_SingletonTemplate_QuestTree__get_Instance__);
    cooltimeEntity = v2->fields.cooltimeEntity;
