        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5F0ED & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_5599/*"EVENT_COOLTIME_REMAIN"*/);
    byte_4A5F0ED = 1;
  }
  v11 = remainTime / 3600;
  v9 = remainTime % 60;
  ...
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_5599/*"EVENT_COOLTIME_REMAIN"*/, 0LL);
  v5 = (Il2CppObject *)System_Int32__ToString_62512312((int32_t)&v11, (System_String_o *)StringLiteral_4987/*"D2"*/, 0LL);
  v6 = (Il2CppObject *)System_Int32__ToString_62512312((int32_t)&v10, (System_String_o *)StringLiteral_4987/*"D2"*/, 0LL);
  v7 = (Il2CppObject *)System_Int32__ToString_62512312((int32_t)&v9, (System_String_o *)StringLiteral_4987/*"D2"*/, 0LL);
  return System_String__Format_61721472(v4, v5, v6, v7, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  *(SpotCooltimeComponent_c **)((char *)&this->klass + v4) = (SpotCooltimeComponent_c *)mapGimmick;
  sub_1B88554(
    (ServantStatusBattleListViewItem_o *)p_spotActiveGimmick,
    (int32_t)mapGimmick,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5F0EF & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_18264/*"cooltime_base"*/);
    byte_4A5F0EF = 1;
  }
  this->fields.userCooltimeEntity = userCooltimeEntity;
  sub_1B88554(
    (ServantStatusBattleListViewItem_o *)&this->fields.userCooltimeEntity,
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.cooltimeEntity, (int32_t)MasterEntity, v10, v11);
  this->fields.targetSpot = targetSpot;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.targetSpot, (int32_t)targetSpot, v12, v13);
  bgSprite = this->fields.bgSprite;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetEventUI(bgSprite, (System_String_o *)StringLiteral_18264/*"cooltime_base"*/, 0LL);
  SpotCooltimeComponent__UpdateDisp(this, v15);
}
...
void __fastcall SpotCooltimeComponent__UpdateDisp(SpotCooltimeComponent_o *this, const MethodInfo *method)
{
  ...
  _BOOL4 v16; // w22
  int v17; // w8
  SpotCooltimeComponent_o *v18; // x0
  ...
  if ( (byte_4A5F0EC & 1) == 0 )
  {
    ...
    sub_1B885B0(&UnityEngine_Object_TypeInfo);
    this = (SpotCooltimeComponent_o *)sub_1B885B0(&Method_SingletonMonoBehaviour_QuestAfterAction__get_Instance__);
    byte_4A5F0EC = 1;
  }
  ...
  v28.fields._dateData = NetworkManager__getDateTime(0LL).fields._dateData;
  this = (SpotCooltimeComponent_o *)NetworkManager__getTime_38478060(v28, 0LL);
  ...
  if ( v14 )
    v15 = 0.5;
  *((_DWORD *)&cooltimeLb->fields.UnityEngine_Behaviour_Fields + 1) = v17;
  LODWORD(cooltimeLb->fields.m_CancellationTokenSource) = v16;
  SrcSpotBasePrefab__SetContrast((SrcSpotBasePrefab_o *)this, v15, 0LL);
  if ( v16 )
  {
    SpotCooltimeComponent__UpdateQuestCount(v2, v19);
  }
  else
  {
    v21 = v2->fields.cooltimeLb;
    this = (SpotCooltimeComponent_o *)SpotCooltimeComponent__GetCooltimeText(v18, v10, v20);
    if ( !v21 )
      goto LABEL_54;
  ...
  if ( !this
    ...
    || (UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)this, v14, 0LL),
        (this = (SpotCooltimeComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_QuestAfterAction__get_Instance__)) == 0LL) )
  {
LABEL_54:
  ...
  if ( !QuestAfterAction__IsPlaying((QuestAfterAction_o *)this, 0LL) )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(spotActiveGimmick, 0LL, 0LL) )
    {
      ...
      if ( v14 )
      {
        if ( !this )
          goto LABEL_54;
        v23 = *(_QWORD *)&this[1].fields.m_CachedPtr;
        if ( !v23 )
          goto LABEL_54;
        v24 = *(_DWORD *)(v23 + 16) == 1;
      }
      ...
      MapGimmickComponent__SetDispAnimQuick((MapGimmickComponent_o *)this, v24, 0LL);
      this = (SpotCooltimeComponent_o *)v2->fields.spotActiveGimmick;
      if ( !this )
        goto LABEL_54;
...
void __fastcall SpotCooltimeComponent__UpdateQuestCount(SpotCooltimeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5F0EE & 1) == 0 )
  {
    ...
    this = (SpotCooltimeComponent_o *)sub_1B885B0(&TerminalSceneComponent_TypeInfo);
    byte_4A5F0EE = 1;
  }
  targetSpot = v2->fields.targetSpot;
  if ( !targetSpot )
  ...
  {
    this = (SpotCooltimeComponent_o *)SingletonTemplate_object___get_Instance((const MethodInfo_3739B38 *)Method_SingletonTemplate_QuestTree__get_Instance__);
    cooltimeEntity = v2->fields.cooltimeEntity;
