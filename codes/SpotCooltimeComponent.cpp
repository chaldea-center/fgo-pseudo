        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFC6D7 & 1) == 0 )
  {
    sub_1BC3008(&LocalizationManager_TypeInfo, *(_QWORD *)&remainTime);
    sub_1BC3008(&StringLiteral_4910/*"D2"*/, v4);
    sub_1BC3008(&StringLiteral_5533/*"EVENT_COOLTIME_REMAIN"*/, v5);
    byte_4AFC6D7 = 1;
  }
  v13 = remainTime / 3600;
  v11 = remainTime % 60;
  ...
  v6 = LocalizationManager__Get((System_String_o *)StringLiteral_5533/*"EVENT_COOLTIME_REMAIN"*/, 0LL);
  v7 = (Il2CppObject *)System_Int32__ToString_63857360((int32_t)&v13, (System_String_o *)StringLiteral_4910/*"D2"*/, 0LL);
  v8 = (Il2CppObject *)System_Int32__ToString_63857360((int32_t)&v12, (System_String_o *)StringLiteral_4910/*"D2"*/, 0LL);
  v9 = (Il2CppObject *)System_Int32__ToString_63857360((int32_t)&v11, (System_String_o *)StringLiteral_4910/*"D2"*/, 0LL);
  return System_String__Format_62390008(v6, v7, v8, v9, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  *(SpotCooltimeComponent_c **)((char *)&this->klass + v4) = (SpotCooltimeComponent_c *)mapGimmick;
  sub_1BC2FAC(p_spotActiveGimmick);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFC6D9 & 1) == 0 )
  {
    sub_1BC3008(&AtlasManager_TypeInfo, userCooltimeEntity);
    sub_1BC3008(&StringLiteral_18103/*"cooltime_base"*/, v7);
    byte_4AFC6D9 = 1;
  }
  this->fields.userCooltimeEntity = userCooltimeEntity;
  v8 = sub_1BC2FAC(&this->fields.userCooltimeEntity);
  if ( !userCooltimeEntity )
    sub_1BC3264(v8, v9);
  this->fields.cooltimeEntity = UserEventQuestCooltimeEntity__GetMasterEntity(userCooltimeEntity, 0LL);
  sub_1BC2FAC(&this->fields.cooltimeEntity);
  this->fields.targetSpot = targetSpot;
  sub_1BC2FAC(&this->fields.targetSpot);
  bgSprite = this->fields.bgSprite;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetEventUI(bgSprite, (System_String_o *)StringLiteral_18103/*"cooltime_base"*/, 0LL);
...
void __fastcall SpotCooltimeComponent__UpdateDisp(SpotCooltimeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFC6D6 & 1) == 0 )
  {
    ...
    this = (SpotCooltimeComponent_o *)sub_1BC3008(&Method_SingletonMonoBehaviour_QuestAfterAction__get_Instance__, v4);
    byte_4AFC6D6 = 1;
  }
  ...
  this = (SpotCooltimeComponent_o *)NetworkManager__getTime_40386056(v30, 0LL);
  ...
  *((_DWORD *)&cooltimeLb->fields.UnityEngine_Behaviour_Fields + 1) = v19;
  ...
  if ( !this
    ...
    || (UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)this, v16, 0LL),
        (this = (SpotCooltimeComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38DFD48 *)Method_SingletonMonoBehaviour_QuestAfterAction__get_Instance__)) == 0LL) )
  {
LABEL_54:
...
void __fastcall SpotCooltimeComponent__UpdateQuestCount(SpotCooltimeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFC6D8 & 1) == 0 )
  {
    ...
    this = (SpotCooltimeComponent_o *)sub_1BC3008(&TerminalSceneComponent_TypeInfo, v3);
    byte_4AFC6D8 = 1;
  }
  targetSpot = v2->fields.targetSpot;
  if ( !targetSpot )
  ...
  {
    this = (SpotCooltimeComponent_o *)SingletonTemplate_object___get_Instance((const MethodInfo_38E0168 *)Method_SingletonTemplate_QuestTree__get_Instance__);
    cooltimeEntity = v2->fields.cooltimeEntity;
