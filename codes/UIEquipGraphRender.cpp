...
void UIEquipGraphRender__SetCharacterRender(UIEquipGraphRender_o *this, const MethodInfo *method)
{
  ...
  if ( System_String__op_Equality(filterName, (System_String_o *)StringLiteral_23789/*"silhouette"*/, 0) )
  {
    v7 = (System_String_o *)StringLiteral_4938/*"Custom/Sprite-ScriptActionEquipSilhouette"*/;
  }
  else
  {
    System_String__op_Equality(filterName, (System_String_o *)StringLiteral_22549/*"normal"*/, 0);
    v7 = (System_String_o *)StringLiteral_4937/*"Custom/Sprite-ScriptActionEquipNormal"*/;
  }
...
LABEL_45:
  ...
  *(_QWORD *)(bodyRenderer + 56) = v55;
  ...
  v56 = (System_Array_o *)sub_1C93B7C(int___TypeInfo, 6);
  System_Runtime_CompilerServices_RuntimeHelpers__InitializeArray_65124948(
    ...
    0);
  UnityEngine_Mesh__set_triangles(v14, (System_Int32_array *)v56, 0);
  ...
  if ( !v59 )
    *(float *)&v61 = 0.1;
  if ( isTalkMask )
    *(float *)&v61 = *(float *)&v61 * 0.5;
  *(float *)&v57 = this->fields.mColor.fields.a;
  ((void (__fastcall *)(UIEquipGraphRender_o *, const MethodInfo *, long double, long double, long double, long double))klass->vtable._39_SetTweenColor.methodPtr)(
    ...
    v61,
    v57);
  UIEquipGraphRender__SetFilterColor(this, this->fields.filterColor, v62);
  UIEquipGraphRender__SetActive(this, 1, v63);
}
...
void UIEquipGraphRender__SetLayer(UIEquipGraphRender_o *this, int32_t layer, const MethodInfo *method)
{
  ...
  {
    transform = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0);
    UIEquipGraphRender__SetLayer_44636608(this, transform, layer, v8);
  }
}


void UIEquipGraphRender__SetLayer_44636608(
        UIEquipGraphRender_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D321F0 & 1) == 0 )
  {
    ...
    this = (UIEquipGraphRender_o *)sub_1C93AD4(&UnityEngine_Transform_TypeInfo);
    byte_4D321F0 = 1;
  }
  if ( !tf
...
LABEL_17:
    ...
    UIEquipGraphRender__SetLayer_44636608(v6, v17, layer, v18);
  }
