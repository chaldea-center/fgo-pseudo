...
void UIEquipGraphRender__SetCharacterRender(UIEquipGraphRender_o *this, const MethodInfo *method)
{
  ...
  if ( System_String__op_Equality(filterName, (System_String_o *)StringLiteral_23728/*"silhouette"*/, 0) )
  {
    v7 = (System_String_o *)StringLiteral_4921/*"Custom/Sprite-ScriptActionEquipSilhouette"*/;
  }
  else
  {
    System_String__op_Equality(filterName, (System_String_o *)StringLiteral_22489/*"normal"*/, 0);
    v7 = (System_String_o *)StringLiteral_4920/*"Custom/Sprite-ScriptActionEquipNormal"*/;
  }
  ...
  *((_DWORD *)v16 + 10) = 0;
  *((float *)v16 + 8) = (float)LEFT_X;
  *((float *)v16 + 9) = (float)v20;
  if ( v17 == 1 )
    goto LABEL_45;
  ...
  *(float32x2_t *)(v16 + 44) = vcvt_f32_s32(v21);
  ...
  v24 = v22->LEFT_X;
  *((_DWORD *)v16 + 16) = 0;
  *((float *)v16 + 14) = (float)v24;
  *((float *)v16 + 15) = (float)BOTTOM_Y;
  if ( v17 == 3 )
    goto LABEL_45;
  ...
  RIGHT_X = v25->RIGHT_X;
  *((_DWORD *)v16 + 19) = 0;
  *((float *)v16 + 17) = (float)RIGHT_X;
  *((float *)v16 + 18) = (float)v26;
  if ( !v14 )
    goto LABEL_46;
...
LABEL_46:
  ...
  *((float32x2_t *)v28 + 7) = vneg_f32(v34[9]);
  *((float *)v28 + 16) = v35;
  if ( v29 == 3 )
    goto LABEL_45;
  ...
  *((_QWORD *)bodyRenderer + 4) = *(_QWORD *)&UIEquipGraphRender_TypeInfo->static_fields->BODY_U;
  ...
  BODY_V = v39->BODY_V;
  *((float *)bodyRenderer + 10) = v39->BODY_U + v39->BODY_W;
  *((float *)bodyRenderer + 11) = BODY_V;
  if ( v38 <= 2 )
    goto LABEL_45;
  v41 = UIEquipGraphRender_TypeInfo->static_fields;
  v42 = v41->BODY_V - v41->BODY_H;
  *((_DWORD *)bodyRenderer + 12) = LODWORD(v41->BODY_U);
  *((float *)bodyRenderer + 13) = v42;
  if ( v38 == 3 )
    goto LABEL_45;
  ...
  *((_QWORD *)bodyRenderer + 4) = *(_QWORD *)&UIEquipGraphRender_TypeInfo->static_fields->BODY_U;
  ...
  v49 = v48->BODY_V;
  *((float *)bodyRenderer + 10) = v48->BODY_U + v48->BODY_W;
  *((float *)bodyRenderer + 11) = v49;
  if ( v47 <= 2
    || (v50 = UIEquipGraphRender_TypeInfo->static_fields,
        v51 = v50->BODY_V - v50->BODY_H,
        *((_DWORD *)bodyRenderer + 12) = LODWORD(v50->BODY_U),
        *((float *)bodyRenderer + 13) = v51,
        v47 == 3) )
  {
LABEL_45:
  ...
  *((_QWORD *)bodyRenderer + 7) = v55;
  UnityEngine_Mesh__set_uv2(v14, (UnityEngine_Vector2_array *)bodyRenderer, 0);
  v56 = (System_Array_o *)sub_1C94140(int___TypeInfo, 6);
...
void UIEquipGraphRender__SetLayer(UIEquipGraphRender_o *this, int32_t layer, const MethodInfo *method)
{
  ...
  {
    transform = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0);
    UIEquipGraphRender__SetLayer_44743756(this, transform, layer, v8);
  }
}


void UIEquipGraphRender__SetLayer_44743756(
        UIEquipGraphRender_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2E0FF & 1) == 0 )
  {
    ...
    this = (UIEquipGraphRender_o *)sub_1C94098(&UnityEngine_Transform_TypeInfo);
    byte_4D2E0FF = 1;
  }
  if ( !tf
...
LABEL_17:
    ...
    UIEquipGraphRender__SetLayer_44743756(v6, v17, layer, v18);
  }
