        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6854E & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_23893/*"storeError"*/, v13);
    sub_1BE4ACC(&StringLiteral_22972/*"purchaseData"*/, v14);
    sub_1BE4ACC(&StringLiteral_22973/*"purchaseDataBase64"*/, v15);
    sub_1BE4ACC(&StringLiteral_23656/*"signatureData"*/, v16);
    byte_4B6854E = 1;
  }
  ...
  if ( !System_String__IsNullOrEmpty(purchaseBaseData, 0LL) )
    RequestBase__addField_42104408((RequestBase_o *)this, (System_String_o *)StringLiteral_22973/*"purchaseDataBase64"*/, purchaseBaseData, v17);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23893/*"storeError"*/, storeError, v17);
  if ( !System_String__IsNullOrEmpty(extraToken, 0LL) )
    RequestBase__addField_42104408((RequestBase_o *)this, (System_String_o *)StringLiteral_23656/*"signatureData"*/, extraToken, v19);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6854F & 1) == 0 )
  {
    sub_1BE4ACC(&Method_ActionExtensions_Call_PurchaseByBank_UnityIap_Request_PurchaseResult_____, responseList);
    ...
    sub_1BE4ACC(&Method_JsonManager_DeserializeArray_PurchaseByBank_UnityIap_Request_PurchaseResult___, v7);
...
LABEL_11:
                 ...
                 (const MethodInfo_32B0418 *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
          {
            ...
            v22 = JsonManager__DeserializeArray_object_(
                    v21,
                    (const MethodInfo_2FC092C *)Method_JsonManager_DeserializeArray_PurchaseByBank_UnityIap_Request_PurchaseResult___);
            ActionExtensions__Call_object_(
              (System_Action_T__o *)this->fields.passPurchaseResultCallBack,
              &v22->obj,
              (const MethodInfo_2EAB91C *)Method_ActionExtensions_Call_PurchaseByBank_UnityIap_Request_PurchaseResult_____);
          }
LABEL_19:
