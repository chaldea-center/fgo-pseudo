        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A71783 & 1) == 0 )
  {
    sub_1B90010(&NetworkManager_TypeInfo, purchaseBaseData);
    sub_1B90010(&StringLiteral_23595/*"storeError"*/, v13);
    sub_1B90010(&StringLiteral_22683/*"purchaseData"*/, v14);
    sub_1B90010(&StringLiteral_22684/*"purchaseDataBase64"*/, v15);
    sub_1B90010(&StringLiteral_23358/*"signatureData"*/, v16);
    byte_4A71783 = 1;
  }
  RequestBase__addField_41181164(
    (RequestBase_o *)this,
    (System_String_o *)StringLiteral_22683/*"purchaseData"*/,
    purchaseData,
    *(const MethodInfo **)&storeError);
  if ( !System_String__IsNullOrEmpty(purchaseBaseData, 0LL) )
    RequestBase__addField_41181164((RequestBase_o *)this, (System_String_o *)StringLiteral_22684/*"purchaseDataBase64"*/, purchaseBaseData, v17);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23595/*"storeError"*/, storeError, v17);
  if ( !System_String__IsNullOrEmpty(extraToken, 0LL) )
    RequestBase__addField_41181164((RequestBase_o *)this, (System_String_o *)StringLiteral_23358/*"signatureData"*/, extraToken, v19);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A71782 & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_23304/*"shop/purchaseByBank"*/, v2);
    byte_4A71782 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61787092(BaseUrl, (System_String_o *)StringLiteral_23304/*"shop/purchaseByBank"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A71784 & 1) == 0 )
  {
    sub_1B90010(&Method_ActionExtensions_Call_PurchaseByBank_UnityIap_Request_PurchaseResult_____, responseList);
    ...
    sub_1B90010(&Method_JsonManager_DeserializeArray_PurchaseByBank_UnityIap_Request_PurchaseResult___, v7);
    sub_1B90010(&JsonManager_TypeInfo, v8);
    sub_1B90010(&ResponseCommandKind_TypeInfo, v9);
    sub_1B90010(&StringLiteral_22938/*"result"*/, v10);
    sub_1B90010(&StringLiteral_22088/*"ng"*/, v11);
    sub_1B90010(&StringLiteral_22687/*"purchaseResults"*/, v12);
...
LABEL_11:
          if ( System_Collections_Generic_Dictionary_object__object___ContainsKey(
                 success,
                 (Il2CppObject *)StringLiteral_22687/*"purchaseResults"*/,
                 (const MethodInfo_31D8FA8 *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
          {
            ...
            v23 = JsonManager__DeserializeArray_object_(
                    v22,
                    (const MethodInfo_2EF48C0 *)Method_JsonManager_DeserializeArray_PurchaseByBank_UnityIap_Request_PurchaseResult___);
            ActionExtensions__Call_object_(
              (System_Action_T__o *)this->fields.passPurchaseResultCallBack,
              &v23->obj,
              (const MethodInfo_2DE3558 *)Method_ActionExtensions_Call_PurchaseByBank_UnityIap_Request_PurchaseResult_____);
          }
LABEL_19:
...
LABEL_25:
    ...
    else
    {
      ...
      if ( fail )
      {
        ...
        v19 = (void *)StringLiteral_22088/*"ng"*/;
        if ( !System_Collections_Generic_Dictionary_object__object___ContainsKey(
                v25,
                (Il2CppObject *)StringLiteral_22938/*"result"*/,
                (const MethodInfo_31D8FA8 *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
