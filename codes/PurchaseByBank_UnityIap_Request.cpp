        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC8FBE & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_23834/*"storeError"*/);
    sub_1C713B0(&StringLiteral_22933/*"purchaseData"*/);
    sub_1C713B0(&StringLiteral_22934/*"purchaseDataBase64"*/);
    sub_1C713B0(&StringLiteral_23608/*"signatureData"*/);
    byte_4CC8FBE = 1;
  }
  RequestBase__addField_44518324(
    (RequestBase_o *)this,
    (System_String_o *)StringLiteral_22933/*"purchaseData"*/,
    purchaseData,
    *(const MethodInfo **)&storeError);
  if ( !System_String__IsNullOrEmpty(purchaseBaseData, 0) )
    RequestBase__addField_44518324((RequestBase_o *)this, (System_String_o *)StringLiteral_22934/*"purchaseDataBase64"*/, purchaseBaseData, v13);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23834/*"storeError"*/, storeError, v13);
  if ( !System_String__IsNullOrEmpty(extraToken, 0) )
    RequestBase__addField_44518324((RequestBase_o *)this, (System_String_o *)StringLiteral_23608/*"signatureData"*/, extraToken, v15);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C713B0(&NetworkManager_TypeInfo);
    sub_1C713B0(&StringLiteral_23550/*"shop/purchaseByBank"*/);
    byte_4CC8FBD = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64031724(BaseUrl, (System_String_o *)StringLiteral_23550/*"shop/purchaseByBank"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC8FBF & 1) == 0 )
  {
    sub_1C713B0(&Method_ActionExtensions_Call_PurchaseByBank_UnityIap_Request_PurchaseResult_____);
    ...
    sub_1C713B0(&Method_JsonManager_DeserializeArray_PurchaseByBank_UnityIap_Request_PurchaseResult___);
    sub_1C713B0(&JsonManager_TypeInfo);
    sub_1C713B0(&ResponseCommandKind_TypeInfo);
    sub_1C713B0(&StringLiteral_23191/*"result"*/);
    sub_1C713B0(&StringLiteral_22316/*"ng"*/);
    sub_1C713B0(&StringLiteral_22937/*"purchaseResults"*/);
    ...
    if ( ResponseData__checkError(v5, v5->fields.resCode, v6) )
    {
      ...
      if ( success )
      {
        ...
        if ( !System_Collections_Generic_Dictionary_object__object___ContainsKey(
                v9,
                (Il2CppObject *)StringLiteral_23191/*"result"*/,
...
LABEL_11:
          if ( System_Collections_Generic_Dictionary_object__object___ContainsKey(
                 success,
                 (Il2CppObject *)StringLiteral_22937/*"purchaseResults"*/,
                 (const MethodInfo_34CB8D4 *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
          {
            ...
            v14 = JsonManager__DeserializeArray_object_(
                    v13,
                    (const MethodInfo_31BADBC *)Method_JsonManager_DeserializeArray_PurchaseByBank_UnityIap_Request_PurchaseResult___);
            ActionExtensions__Call_object_(
              (System_Action_T__o *)this->fields.passPurchaseResultCallBack,
              &v14->obj,
              (const MethodInfo_3095D08 *)Method_ActionExtensions_Call_PurchaseByBank_UnityIap_Request_PurchaseResult_____);
          }
LABEL_19:
