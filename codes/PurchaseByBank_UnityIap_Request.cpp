        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB7665 & 1) == 0 )
  {
    sub_1BAB41C(&NetworkManager_TypeInfo, purchaseBaseData);
    sub_1BAB41C(&StringLiteral_23597/*"storeError"*/, v13);
    sub_1BAB41C(&StringLiteral_22688/*"purchaseData"*/, v14);
    sub_1BAB41C(&StringLiteral_22689/*"purchaseDataBase64"*/, v15);
    sub_1BAB41C(&StringLiteral_23360/*"signatureData"*/, v16);
    byte_4AB7665 = 1;
  }
  RequestBase__addField_41516464(
    (RequestBase_o *)this,
    (System_String_o *)StringLiteral_22688/*"purchaseData"*/,
    purchaseData,
    *(const MethodInfo **)&storeError);
  if ( !System_String__IsNullOrEmpty(purchaseBaseData, 0LL) )
    RequestBase__addField_41516464((RequestBase_o *)this, (System_String_o *)StringLiteral_22689/*"purchaseDataBase64"*/, purchaseBaseData, v17);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23597/*"storeError"*/, storeError, v17);
  if ( !System_String__IsNullOrEmpty(extraToken, 0LL) )
    RequestBase__addField_41516464((RequestBase_o *)this, (System_String_o *)StringLiteral_23360/*"signatureData"*/, extraToken, v19);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB7664 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_23306/*"shop/purchaseByBank"*/, v2);
    byte_4AB7664 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62048128(BaseUrl, (System_String_o *)StringLiteral_23306/*"shop/purchaseByBank"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB7666 & 1) == 0 )
  {
    sub_1BAB41C(&Method_ActionExtensions_Call_PurchaseByBank_UnityIap_Request_PurchaseResult_____, responseList);
    ...
    sub_1BAB41C(&Method_JsonManager_DeserializeArray_PurchaseByBank_UnityIap_Request_PurchaseResult___, v7);
    sub_1BAB41C(&JsonManager_TypeInfo, v8);
    sub_1BAB41C(&ResponseCommandKind_TypeInfo, v9);
    sub_1BAB41C(&StringLiteral_22943/*"result"*/, v10);
    sub_1BAB41C(&StringLiteral_22090/*"ng"*/, v11);
    sub_1BAB41C(&StringLiteral_22692/*"purchaseResults"*/, v12);
  ...
  {
    v15 = v14;
    if ( ResponseData__checkError_41605928(v14, 0LL) )
    {
...
LABEL_11:
          if ( System_Collections_Generic_Dictionary_object__object___ContainsKey(
                 success,
                 (Il2CppObject *)StringLiteral_22692/*"purchaseResults"*/,
                 (const MethodInfo_3213740 *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
          {
            ...
            v22 = JsonManager__DeserializeArray_object_(
                    v21,
                    (const MethodInfo_2F2AABC *)Method_JsonManager_DeserializeArray_PurchaseByBank_UnityIap_Request_PurchaseResult___);
            ActionExtensions__Call_object_(
              (System_Action_T__o *)this->fields.passPurchaseResultCallBack,
              &v22->obj,
              (const MethodInfo_2E184C8 *)Method_ActionExtensions_Call_PurchaseByBank_UnityIap_Request_PurchaseResult_____);
          }
LABEL_19:
...
LABEL_25:
    ...
    else
    {
      ...
      if ( fail )
      {
        ...
        v18 = (void *)StringLiteral_22090/*"ng"*/;
        if ( !System_Collections_Generic_Dictionary_object__object___ContainsKey(
                v24,
                (Il2CppObject *)StringLiteral_22943/*"result"*/,
                (const MethodInfo_3213740 *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
