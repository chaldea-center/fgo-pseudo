        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A213C8 & 1) == 0 )
  {
    sub_1B715CC(&NetworkManager_TypeInfo, purchaseBaseData);
    sub_1B715CC(&StringLiteral_23500/*"storeError"*/, v13);
    sub_1B715CC(&StringLiteral_22594/*"purchaseData"*/, v14);
    sub_1B715CC(&StringLiteral_22595/*"purchaseDataBase64"*/, v15);
    sub_1B715CC(&StringLiteral_23263/*"signatureData"*/, v16);
    byte_4A213C8 = 1;
  }
  RequestBase__addField_40916388(
    (RequestBase_o *)this,
    (System_String_o *)StringLiteral_22594/*"purchaseData"*/,
    purchaseData,
    *(const MethodInfo **)&storeError);
  if ( !System_String__IsNullOrEmpty(purchaseBaseData, 0LL) )
    RequestBase__addField_40916388((RequestBase_o *)this, (System_String_o *)StringLiteral_22595/*"purchaseDataBase64"*/, purchaseBaseData, v17);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23500/*"storeError"*/, storeError, v17);
  if ( !System_String__IsNullOrEmpty(extraToken, 0LL) )
    RequestBase__addField_40916388((RequestBase_o *)this, (System_String_o *)StringLiteral_23263/*"signatureData"*/, extraToken, v19);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A213C7 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_23212/*"shop/purchaseByBank"*/, v2);
    byte_4A213C7 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61505504(BaseUrl, (System_String_o *)StringLiteral_23212/*"shop/purchaseByBank"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A213C9 & 1) == 0 )
  {
    sub_1B715CC(&Method_ActionExtensions_Call_PurchaseByBank_UnityIap_Request_PurchaseResult_____, responseList);
    ...
    sub_1B715CC(&Method_JsonManager_DeserializeArray_PurchaseByBank_UnityIap_Request_PurchaseResult___, v7);
    sub_1B715CC(&JsonManager_TypeInfo, v8);
    sub_1B715CC(&ResponseCommandKind_TypeInfo, v9);
    sub_1B715CC(&StringLiteral_22847/*"result"*/, v10);
    sub_1B715CC(&StringLiteral_22000/*"ng"*/, v11);
    sub_1B715CC(&StringLiteral_22598/*"purchaseResults"*/, v12);
...
LABEL_11:
          if ( System_Collections_Generic_Dictionary_object__object___ContainsKey(
                 success,
                 (Il2CppObject *)StringLiteral_22598/*"purchaseResults"*/,
                 (const MethodInfo_319EF04 *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
          {
            ...
            v23 = JsonManager__DeserializeArray_object_(
                    v22,
                    (const MethodInfo_2EC1990 *)Method_JsonManager_DeserializeArray_PurchaseByBank_UnityIap_Request_PurchaseResult___);
            ActionExtensions__Call_object_(
              (System_Action_T__o *)this->fields.passPurchaseResultCallBack,
              &v23->obj,
              (const MethodInfo_2DB2DD8 *)Method_ActionExtensions_Call_PurchaseByBank_UnityIap_Request_PurchaseResult_____);
          }
LABEL_19:
...
LABEL_25:
    ...
    else
    {
      ...
      if ( fail )
      {
        ...
        v19 = (void *)StringLiteral_22000/*"ng"*/;
        if ( !System_Collections_Generic_Dictionary_object__object___ContainsKey(
                v25,
                (Il2CppObject *)StringLiteral_22847/*"result"*/,
                (const MethodInfo_319EF04 *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
