        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2E45F & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_23950/*"storeError"*/);
    sub_1C94098(&StringLiteral_23047/*"purchaseData"*/);
    sub_1C94098(&StringLiteral_23048/*"purchaseDataBase64"*/);
    sub_1C94098(&StringLiteral_23723/*"signatureData"*/);
    byte_4D2E45F = 1;
  }
  RequestBase__addField_45016480(
    (RequestBase_o *)this,
    (System_String_o *)StringLiteral_23047/*"purchaseData"*/,
    purchaseData,
    *(const MethodInfo **)&storeError);
  if ( !System_String__IsNullOrEmpty(purchaseBaseData, 0) )
    RequestBase__addField_45016480((RequestBase_o *)this, (System_String_o *)StringLiteral_23048/*"purchaseDataBase64"*/, purchaseBaseData, v13);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23950/*"storeError"*/, storeError, v13);
  if ( !System_String__IsNullOrEmpty(extraToken, 0) )
    RequestBase__addField_45016480((RequestBase_o *)this, (System_String_o *)StringLiteral_23723/*"signatureData"*/, extraToken, v15);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C94098(&NetworkManager_TypeInfo);
    sub_1C94098(&StringLiteral_23665/*"shop/purchaseByBank"*/);
    byte_4D2E45E = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64417744(BaseUrl, (System_String_o *)StringLiteral_23665/*"shop/purchaseByBank"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2E460 & 1) == 0 )
  {
    sub_1C94098(&Method_ActionExtensions_Call_PurchaseByBank_UnityIap_Request_PurchaseResult_____);
    ...
    sub_1C94098(&Method_JsonManager_DeserializeArray_PurchaseByBank_UnityIap_Request_PurchaseResult___);
    sub_1C94098(&JsonManager_TypeInfo);
    sub_1C94098(&ResponseCommandKind_TypeInfo);
    sub_1C94098(&StringLiteral_23305/*"result"*/);
    sub_1C94098(&StringLiteral_22424/*"ng"*/);
    sub_1C94098(&StringLiteral_23051/*"purchaseResults"*/);
...
LABEL_11:
          if ( System_Collections_Generic_Dictionary_object__object___ContainsKey(
                 success,
                 (Il2CppObject *)StringLiteral_23051/*"purchaseResults"*/,
                 (const MethodInfo_3520DE8 *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
          {
            ...
            v14 = JsonManager__DeserializeArray_object_(
                    v13,
                    (const MethodInfo_320C67C *)Method_JsonManager_DeserializeArray_PurchaseByBank_UnityIap_Request_PurchaseResult___);
            ActionExtensions__Call_object_(
              (System_Action_T__o *)this->fields.passPurchaseResultCallBack,
              &v14->obj,
              (const MethodInfo_30E5920 *)Method_ActionExtensions_Call_PurchaseByBank_UnityIap_Request_PurchaseResult_____);
          }
LABEL_19:
