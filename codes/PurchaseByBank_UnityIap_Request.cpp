        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFF157 & 1) == 0 )
  {
    sub_1C2E12C(&NetworkManager_TypeInfo, purchaseBaseData);
    sub_1C2E12C(&StringLiteral_24008/*"storeError"*/, v13);
    sub_1C2E12C(&StringLiteral_23079/*"purchaseData"*/, v14);
    sub_1C2E12C(&StringLiteral_23080/*"purchaseDataBase64"*/, v15);
    sub_1C2E12C(&StringLiteral_23770/*"signatureData"*/, v16);
    byte_4BFF157 = 1;
  }
  RequestBase__addField_42503872(
    (RequestBase_o *)this,
    (System_String_o *)StringLiteral_23079/*"purchaseData"*/,
    purchaseData,
    *(const MethodInfo **)&storeError);
  if ( !System_String__IsNullOrEmpty(purchaseBaseData, 0LL) )
    RequestBase__addField_42503872((RequestBase_o *)this, (System_String_o *)StringLiteral_23080/*"purchaseDataBase64"*/, purchaseBaseData, v17);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_24008/*"storeError"*/, storeError, v17);
  if ( !System_String__IsNullOrEmpty(extraToken, 0LL) )
    RequestBase__addField_42503872((RequestBase_o *)this, (System_String_o *)StringLiteral_23770/*"signatureData"*/, extraToken, v19);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFF156 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&StringLiteral_23715/*"shop/purchaseByBank"*/, v2);
    byte_4BFF156 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63235584(BaseUrl, (System_String_o *)StringLiteral_23715/*"shop/purchaseByBank"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFF158 & 1) == 0 )
  {
    sub_1C2E12C(&Method_ActionExtensions_Call_PurchaseByBank_UnityIap_Request_PurchaseResult_____, responseList);
    ...
    sub_1C2E12C(&Method_JsonManager_DeserializeArray_PurchaseByBank_UnityIap_Request_PurchaseResult___, v7);
    sub_1C2E12C(&JsonManager_TypeInfo, v8);
    sub_1C2E12C(&ResponseCommandKind_TypeInfo, v9);
    sub_1C2E12C(&StringLiteral_23340/*"result"*/, v10);
    sub_1C2E12C(&StringLiteral_22468/*"ng"*/, v11);
    sub_1C2E12C(&StringLiteral_23083/*"purchaseResults"*/, v12);
  ...
  {
    v15 = v14;
    if ( ResponseData__checkError_42594652(v14, 0LL) )
    {
...
LABEL_11:
          if ( System_Collections_Generic_Dictionary_object__object___ContainsKey(
                 success,
                 (Il2CppObject *)StringLiteral_23083/*"purchaseResults"*/,
                 (const MethodInfo_3335D68 *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
          {
            ...
            v22 = JsonManager__DeserializeArray_object_(
                    v21,
                    (const MethodInfo_3039DDC *)Method_JsonManager_DeserializeArray_PurchaseByBank_UnityIap_Request_PurchaseResult___);
            ActionExtensions__Call_object_(
              (System_Action_T__o *)this->fields.passPurchaseResultCallBack,
              &v22->obj,
              (const MethodInfo_2F23FA0 *)Method_ActionExtensions_Call_PurchaseByBank_UnityIap_Request_PurchaseResult_____);
          }
LABEL_19:
...
LABEL_25:
    ...
    else
    {
      ...
      if ( fail )
      {
        ...
        v18 = (void *)StringLiteral_22468/*"ng"*/;
        if ( !System_Collections_Generic_Dictionary_object__object___ContainsKey(
                v24,
                (Il2CppObject *)StringLiteral_23340/*"result"*/,
                (const MethodInfo_3335D68 *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
