        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDA350 & 1) == 0 )
  {
    sub_1C21E38(&Method_NetworkManager_getRequest_WarBoardContinueRequest___);
  ...
  Instance = NetworkManager__getRequest_object_(
               0LL,
               (const MethodInfo_30345EC *)Method_NetworkManager_getRequest_WarBoardContinueRequest___);
  if ( !Instance )
    goto LABEL_11;
