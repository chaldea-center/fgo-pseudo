        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6DDD7 & 1) == 0 )
  {
    sub_1B90010(&Method_NetworkManager_getRequest_WarBoardContinueRequest___, method);
  ...
  Instance = NetworkManager__getRequest_object_(
               0LL,
               (const MethodInfo_2F10358 *)Method_NetworkManager_getRequest_WarBoardContinueRequest___);
  if ( !Instance )
    goto LABEL_11;
