...
LABEL_18:
      ...
      if ( resultColors )
      {
        while ( v22 < resultColors->max_length )
        {
          ...
          v23[2] = (Il2CppObject)xmmword_BEBDD0;
          if ( !v21 )
            goto LABEL_18;
        }
LABEL_20:
        sub_1BDBADC(resultColors, *(_QWORD *)&resultTextureWidth, baseColors);
      }
LABEL_21:
      sub_1BDBAD4(resultColors, resultTextureWidth);
    }
  }
        ...
        const MethodInfo *method)
{
  ...
  UnityEngine_Color_array *Pixels_70174808; // x27
  ...
  if ( (byte_4B414EB & 1) == 0 )
  {
    sub_1BDB878(&UnityEngine_Color___TypeInfo, positionCalculator);
    excludePanelUniqueIds = (System_Int32_array *)sub_1BDB878(&UnityEngine_Texture2D_TypeInfo, v7);
    byte_4B414EB = 1;
  }
  ...
  v14 = (UnityEngine_Texture2D_o *)sub_1BDBAC4(UnityEngine_Texture2D_TypeInfo);
  UnityEngine_Texture2D___ctor_70172420(v14, v12, v13, 0LL);
  if ( !gridTexture )
    goto LABEL_23;
  ...
  {
    v15 = (UnityEngine_Color_array *)sub_1BDB920(UnityEngine_Color___TypeInfo, (unsigned int)(v13 * v12));
    Pixels_70174808 = UnityEngine_Texture2D__GetPixels_70174808(gridTexture, 0LL);
      ...
      do
      {
        if ( VerticalPanelNum_k__BackingField + 1 >= 1 )
        {
          ...
          do
          {
            ...
            GridLineTextureUtil__ApplyTextureColor(v15, v12, Pixels_70174808, v20, v21, v22, v10, v11, sliceIndex, v25);
            VerticalPanelNum_k__BackingField = positionCalculator->fields._VerticalPanelNum_k__BackingField;
            ++v22;
          }
    ...
    if ( v14 )
    {
      UnityEngine_Texture2D__SetPixels_70173312(v14, v15, 0LL);
      UnityEngine_Texture2D__Apply_70174084(v14, 0LL);
      return v14;
    }
LABEL_23:
    sub_1BDBAD4(excludePanelUniqueIds, positionCalculator);
  }
  return v14;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B414EC & 1) == 0 )
  {
    *(_QWORD *)&hIndex = sub_1BDB878(&PanelUniqueIDUtil_TypeInfo, *(_QWORD *)&vIndex);
    byte_4B414EC = 1;
  }
  if ( !positionCalculator )
    sub_1BDBAD4(*(_QWORD *)&hIndex, *(_QWORD *)&vIndex);
