...
LABEL_18:
      ...
      if ( resultColors )
      {
        while ( v22 < resultColors->max_length )
        {
          ...
          v23[2] = (Il2CppObject)xmmword_BD8E30;
          if ( !v21 )
            goto LABEL_18;
        }
LABEL_20:
        sub_1BD36BC(resultColors, *(_QWORD *)&resultTextureWidth);
      }
LABEL_21:
      sub_1BD36B4(resultColors, resultTextureWidth);
    }
  }
        ...
        const MethodInfo *method)
{
  ...
  UnityEngine_Color_array *Pixels_70169024; // x27
  ...
  if ( (byte_4B33D9F & 1) == 0 )
  {
    sub_1BD3458(&UnityEngine_Color___TypeInfo, positionCalculator);
    excludePanelUniqueIds = (System_Int32_array *)sub_1BD3458(&UnityEngine_Texture2D_TypeInfo, v7);
    byte_4B33D9F = 1;
  }
  ...
  v14 = (UnityEngine_Texture2D_o *)sub_1BD36A4(UnityEngine_Texture2D_TypeInfo);
  UnityEngine_Texture2D___ctor_70166636(v14, v12, v13, 0LL);
  if ( !gridTexture )
    goto LABEL_23;
  ...
  {
    v15 = (UnityEngine_Color_array *)sub_1BD3500(UnityEngine_Color___TypeInfo, (unsigned int)(v13 * v12));
    Pixels_70169024 = UnityEngine_Texture2D__GetPixels_70169024(gridTexture, 0LL);
      ...
      do
      {
        if ( VerticalPanelNum_k__BackingField + 1 >= 1 )
        {
          ...
          do
          {
            ...
            GridLineTextureUtil__ApplyTextureColor(v15, v12, Pixels_70169024, v20, v21, v22, v10, v11, sliceIndex, v25);
            VerticalPanelNum_k__BackingField = positionCalculator->fields._VerticalPanelNum_k__BackingField;
            ++v22;
          }
    ...
    if ( v14 )
    {
      UnityEngine_Texture2D__SetPixels_70167528(v14, v15, 0LL);
      UnityEngine_Texture2D__Apply_70168300(v14, 0LL);
      return v14;
    }
LABEL_23:
    sub_1BD36B4(excludePanelUniqueIds, positionCalculator);
  }
  return v14;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B33DA0 & 1) == 0 )
  {
    *(_QWORD *)&hIndex = sub_1BD3458(&PanelUniqueIDUtil_TypeInfo, *(_QWORD *)&vIndex);
    byte_4B33DA0 = 1;
  }
  if ( !positionCalculator )
    sub_1BD36B4(*(_QWORD *)&hIndex, *(_QWORD *)&vIndex);
