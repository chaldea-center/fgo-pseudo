...
LABEL_18:
      ...
      if ( resultColors )
      {
        while ( v22 < resultColors->max_length )
        {
          ...
          v23[2] = (Il2CppObject)xmmword_BFF330;
          if ( !v21 )
            goto LABEL_18;
        }
LABEL_20:
        sub_1C2209C(resultColors, resultTextureWidth);
      }
LABEL_21:
      sub_1C22094(resultColors, resultTextureWidth);
    }
  }
        ...
        const MethodInfo *method)
{
  ...
  UnityEngine_Color_array *Pixels_70760364; // x27
  ...
  if ( (byte_4BD90E7 & 1) == 0 )
  {
    ...
    excludePanelUniqueIds = (System_Int32_array *)sub_1C21E38(&UnityEngine_Texture2D_TypeInfo);
    byte_4BD90E7 = 1;
  }
  ...
  v13 = (UnityEngine_Texture2D_o *)sub_1C22084(UnityEngine_Texture2D_TypeInfo);
  UnityEngine_Texture2D___ctor_70757976(v13, v11, v12, 0LL);
  if ( !gridTexture )
    goto LABEL_23;
  ...
  {
    v14 = (UnityEngine_Color_array *)sub_1C21EE0(UnityEngine_Color___TypeInfo, (unsigned int)(v12 * v11));
    Pixels_70760364 = UnityEngine_Texture2D__GetPixels_70760364(gridTexture, 0LL);
      ...
      do
      {
        if ( VerticalPanelNum_k__BackingField + 1 >= 1 )
        {
          ...
          do
          {
            ...
            GridLineTextureUtil__ApplyTextureColor(v14, v11, Pixels_70760364, v19, v20, v21, v9, v10, sliceIndex, v24);
            VerticalPanelNum_k__BackingField = positionCalculator->fields._VerticalPanelNum_k__BackingField;
            ++v21;
          }
    ...
    if ( v13 )
    {
      UnityEngine_Texture2D__SetPixels_70758868(v13, v14, 0LL);
      UnityEngine_Texture2D__Apply_70759640(v13, 0LL);
      return v13;
    }
LABEL_23:
    sub_1C22094(excludePanelUniqueIds, positionCalculator);
  }
  return v13;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD90E8 & 1) == 0 )
  {
    *(_QWORD *)&hIndex = sub_1C21E38(&PanelUniqueIDUtil_TypeInfo);
    byte_4BD90E8 = 1;
  }
  if ( !positionCalculator )
