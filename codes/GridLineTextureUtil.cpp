...
LABEL_18:
      ...
      if ( resultColors )
      {
        while ( v22 < resultColors->max_length )
        {
          ...
          v23[2] = (Il2CppObject)xmmword_BA4010;
          if ( !v21 )
            goto LABEL_18;
        }
LABEL_20:
        sub_1B6432C(resultColors, *(_QWORD *)&resultTextureWidth);
      }
LABEL_21:
      sub_1B64324(resultColors);
    }
  }
        ...
        const MethodInfo *method)
{
  ...
  UnityEngine_Color_array *Pixels_69018576; // x27
  ...
  if ( (byte_49F9124 & 1) == 0 )
  {
    sub_1B640C8(&UnityEngine_Color___TypeInfo, positionCalculator);
    excludePanelUniqueIds = (System_Int32_array *)sub_1B640C8(&UnityEngine_Texture2D_TypeInfo, v7);
    byte_49F9124 = 1;
  }
  ...
  v14 = (UnityEngine_Texture2D_o *)sub_1B64314(UnityEngine_Texture2D_TypeInfo, positionCalculator, gridTexture);
  UnityEngine_Texture2D___ctor_69016188(v14, v12, v13, 0LL);
  if ( !gridTexture )
    goto LABEL_23;
  ...
  {
    v15 = (UnityEngine_Color_array *)sub_1B64170(UnityEngine_Color___TypeInfo, (unsigned int)(v13 * v12));
    Pixels_69018576 = UnityEngine_Texture2D__GetPixels_69018576(gridTexture, 0LL);
      ...
      do
      {
        if ( VerticalPanelNum_k__BackingField + 1 >= 1 )
        {
          ...
          do
          {
            ...
            GridLineTextureUtil__ApplyTextureColor(v15, v12, Pixels_69018576, v20, v21, v22, v10, v11, sliceIndex, v25);
            VerticalPanelNum_k__BackingField = positionCalculator->fields._VerticalPanelNum_k__BackingField;
            ++v22;
          }
    ...
    if ( v14 )
    {
      UnityEngine_Texture2D__SetPixels_69017080(v14, v15, 0LL);
      UnityEngine_Texture2D__Apply_69017852(v14, 0LL);
      return v14;
    }
LABEL_23:
    sub_1B64324(excludePanelUniqueIds);
  }
  return v14;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F9125 & 1) == 0 )
  {
    *(_QWORD *)&hIndex = sub_1B640C8(&PanelUniqueIDUtil_TypeInfo, *(_QWORD *)&vIndex);
    byte_49F9125 = 1;
  }
  if ( !positionCalculator )
