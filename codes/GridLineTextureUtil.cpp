...
LABEL_18:
      ...
      if ( resultColors )
      {
        while ( v22 < resultColors->max_length )
        {
          ...
          v23[2] = (Il2CppObject)xmmword_BB5820;
          if ( !v21 )
            goto LABEL_18;
        }
LABEL_20:
        sub_1B88814(resultColors, resultTextureWidth);
      }
LABEL_21:
      sub_1B8880C(resultColors, resultTextureWidth);
    }
  }
        ...
        const MethodInfo *method)
{
  ...
  UnityEngine_Color_array *Pixels_69350220; // x27
  ...
  if ( (byte_4A57E64 & 1) == 0 )
  {
    ...
    excludePanelUniqueIds = (System_Int32_array *)sub_1B885B0(&UnityEngine_Texture2D_TypeInfo);
    byte_4A57E64 = 1;
  }
  ...
  v13 = (UnityEngine_Texture2D_o *)sub_1B887FC(UnityEngine_Texture2D_TypeInfo);
  UnityEngine_Texture2D___ctor_69347832(v13, v11, v12, 0LL);
  if ( !gridTexture )
    goto LABEL_23;
  if ( ((__int64 (__fastcall *)(UnityEngine_Texture2D_o *, Il2CppMethodPointer))gridTexture->klass->vtable._4_get_width.method)(
         gridTexture,
         gridTexture->klass->vtable._5_set_width.methodPtr) >= 3 * v9
    && ((__int64 (__fastcall *)(UnityEngine_Texture2D_o *, Il2CppMethodPointer))gridTexture->klass->vtable._6_get_height.method)(
         gridTexture,
         gridTexture->klass->vtable._7_set_height.methodPtr) >= 3 * v10 )
  {
    v14 = (UnityEngine_Color_array *)sub_1B88658(UnityEngine_Color___TypeInfo, (unsigned int)(v12 * v11));
    Pixels_69350220 = UnityEngine_Texture2D__GetPixels_69350220(gridTexture, 0LL);
      ...
      do
      {
        if ( VerticalPanelNum_k__BackingField + 1 >= 1 )
        {
          ...
          do
          {
            ...
            GridLineTextureUtil__ApplyTextureColor(v14, v11, Pixels_69350220, v19, v20, v21, v9, v10, sliceIndex, v24);
            VerticalPanelNum_k__BackingField = positionCalculator->fields._VerticalPanelNum_k__BackingField;
            ++v21;
          }
    ...
    if ( v13 )
    {
      UnityEngine_Texture2D__SetPixels_69348724(v13, v14, 0LL);
      UnityEngine_Texture2D__Apply_69349496(v13, 0LL);
      return v13;
    }
LABEL_23:
    sub_1B8880C(excludePanelUniqueIds, positionCalculator);
  }
  return v13;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57E65 & 1) == 0 )
  {
    *(_QWORD *)&hIndex = sub_1B885B0(&PanelUniqueIDUtil_TypeInfo);
    byte_4A57E65 = 1;
  }
  if ( !positionCalculator )
