...
LABEL_23:
      sub_B5D69C(resultColors, *(_QWORD *)&resultTextureWidth);
    }
  }
        ...
        const MethodInfo *method)
{
  ...
  UnityEngine_Color_array *Pixels_35725256; // x27
  ...
  if ( (byte_42EA482 & 1) == 0 )
  {
    sub_B5D5C4(&UnityEngine_Color___TypeInfo, (_DWORD)positionCalculator, (_DWORD)gridTexture, method);
    excludePanelUniqueIds = (System_Int32_array *)sub_B5D5C4(&UnityEngine_Texture2D_TypeInfo, v7, v8, v9);
    byte_42EA482 = 1;
  }
  ...
  v12 = (positionCalculator->fields._HorizontalPanelNum_k__BackingField + 1) * PanelUnitSizeX;
  v13 = (positionCalculator->fields._VerticalPanelNum_k__BackingField + 1) * PanelUnitSizeY;
  v14 = (UnityEngine_Texture2D_o *)sub_B5D694(UnityEngine_Texture2D_TypeInfo);
  UnityEngine_Texture2D___ctor_35723000(v14, v12, v13, 0LL);
  if ( !gridTexture )
    goto LABEL_17;
  ...
  {
    v26 = v14;
    v15 = (UnityEngine_Color_array *)sub_B5D5DC(UnityEngine_Color___TypeInfo, (unsigned int)(v13 * v12));
    Pixels_35725256 = UnityEngine_Texture2D__GetPixels_35725256(gridTexture, 0LL);
    ...
    if ( v26 )
    {
      UnityEngine_Texture2D__SetPixels_35723912(v26, v15, 0LL);
      UnityEngine_Texture2D__Apply_35724740(v26, 0LL);
      return v14;
    }
LABEL_17:
    sub_B5D69C(excludePanelUniqueIds, positionCalculator);
  }
  return v14;
}
