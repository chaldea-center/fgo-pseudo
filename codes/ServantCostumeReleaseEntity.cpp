        ...
        const MethodInfo *method)
{
  if ( (byte_4C2269D & 1) == 0 )
  {
    sub_1C3B764(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int__int___, *(_QWORD *)&releaseType);
    byte_4C2269D = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__int__int__int_(
           ...
           condType,
           condTargetId,
           (const MethodInfo_2FEF220 *)Method_DataEntityBase_CreateMultiplePK_int__int__int__int__int___);
}
