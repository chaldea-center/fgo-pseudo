        ...
        const MethodInfo *method)
{
  if ( (byte_49BB5C7 & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int__int___, *(_QWORD *)&releaseType);
    byte_49BB5C7 = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__int__int__int_(
           ...
           condType,
           condTargetId,
           (const MethodInfo_2F00B40 *)Method_DataEntityBase_CreateMultiplePK_int__int__int__int__int___);
}
