        ...
        const MethodInfo *method)
{
  if ( (byte_4CB6B9B & 1) == 0 )
  {
    sub_1C6BA08(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int__int___);
    byte_4CB6B9B = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__int__int__int_(
           ...
           condType,
           condTargetId,
           (const MethodInfo_313A384 *)Method_DataEntityBase_CreateMultiplePK_int__int__int__int__int___);
}
