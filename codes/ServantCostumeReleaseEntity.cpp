        ...
        const MethodInfo *method)
{
  if ( (byte_4C57632 & 1) == 0 )
  {
    sub_1C3E564(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int__int___);
    byte_4C57632 = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__int__int__int_(
           ...
           condType,
           condTargetId,
           (const MethodInfo_30F8A8C *)Method_DataEntityBase_CreateMultiplePK_int__int__int__int__int___);
}
