        ...
        const MethodInfo *method)
{
  if ( (byte_4A20184 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int__int___, *(_QWORD *)&releaseType);
    byte_4A20184 = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__int__int__int_(
           ...
           condType,
           condTargetId,
           (const MethodInfo_2E5A404 *)Method_DataEntityBase_CreateMultiplePK_int__int__int__int__int___);
}
