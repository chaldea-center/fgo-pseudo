        ...
        const MethodInfo *method)
{
  if ( (byte_4B3788C & 1) == 0 )
  {
    sub_1BD3458(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int__int___, *(_QWORD *)&releaseType);
    byte_4B3788C = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__int__int__int_(
           ...
           condType,
           condTargetId,
           (const MethodInfo_2F306A0 *)Method_DataEntityBase_CreateMultiplePK_int__int__int__int__int___);
}
