        ...
        const MethodInfo *method)
{
  if ( (byte_49FCAB5 & 1) == 0 )
  {
    sub_1B640C8(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int__int___, *(_QWORD *)&releaseType);
    byte_49FCAB5 = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__int__int__int_(
           ...
           condType,
           condTargetId,
           (const MethodInfo_2E38408 *)Method_DataEntityBase_CreateMultiplePK_int__int__int__int__int___);
}
