        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD912 & 1) == 0 )
  {
    sub_1B64870(&Method_CharaGraphListViewPatternServantCollection__GenerateListViewItem_b__0_0__, method);
    sub_1B64870(
      &Method_System_Linq_Enumerable_Select_UserServantCollectionEntity__CharaGraphServantCollectionListViewItem___,
      v3);
    sub_1B64870(&System_Func_UserServantCollectionEntity__int__CharaGraphServantCollectionListViewItem__TypeInfo, v4);
    byte_49FD912 = 1;
  }
  ...
  v6 = (System_Func_T1__T2__TResult__o *)sub_1B64ABC(System_Func_UserServantCollectionEntity__int__CharaGraphServantCollectionListViewItem__TypeInfo);
  ...
  return (System_Collections_Generic_IEnumerable_CharaGraphListViewItemBase__o *)System_Linq_Enumerable__Select_object__object__48675196(
                                                                                   ...
                                                                                   (const MethodInfo_2E6B97C *)Method_System_Linq_Enumerable_Select_UserServantCollectionEntity__CharaGraphServantCollectionListViewItem___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD913 & 1) == 0 )
  {
    sub_1B64870(&CharaGraphListViewItemDrawPatternServantCollection_TypeInfo, method);
    byte_49FD913 = 1;
  }
  v2 = (Il2CppObject *)sub_1B64ABC(CharaGraphListViewItemDrawPatternServantCollection_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD915 & 1) == 0 )
  {
    sub_1B64870(&CharaGraphServantCollectionListViewItem_TypeInfo, elem);
    byte_49FD915 = 1;
  }
  v7 = (CharaGraphServantCollectionListViewItem_o *)sub_1B64ABC(CharaGraphServantCollectionListViewItem_TypeInfo);
