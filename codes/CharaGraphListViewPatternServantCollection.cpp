        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1EEC9 & 1) == 0 )
  {
    sub_1B715CC(&Method_CharaGraphListViewPatternServantCollection__GenerateListViewItem_b__0_0__, method);
    sub_1B715CC(
      &Method_System_Linq_Enumerable_Select_UserServantCollectionEntity__CharaGraphServantCollectionListViewItem___,
      v3);
    sub_1B715CC(&System_Func_UserServantCollectionEntity__int__CharaGraphServantCollectionListViewItem__TypeInfo, v4);
    byte_4A1EEC9 = 1;
  }
  ...
  v6 = (System_Func_T1__T2__TResult__o *)sub_1B71818(System_Func_UserServantCollectionEntity__int__CharaGraphServantCollectionListViewItem__TypeInfo);
  ...
  return (System_Collections_Generic_IEnumerable_CharaGraphListViewItemBase__o *)System_Linq_Enumerable__Select_object__object__48808416(
                                                                                   ...
                                                                                   (const MethodInfo_2E8C1E0 *)Method_System_Linq_Enumerable_Select_UserServantCollectionEntity__CharaGraphServantCollectionListViewItem___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1EECA & 1) == 0 )
  {
    sub_1B715CC(&CharaGraphListViewItemDrawPatternServantCollection_TypeInfo, method);
    byte_4A1EECA = 1;
  }
  v2 = (Il2CppObject *)sub_1B71818(CharaGraphListViewItemDrawPatternServantCollection_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1EECC & 1) == 0 )
  {
    sub_1B715CC(&CharaGraphServantCollectionListViewItem_TypeInfo, elem);
    byte_4A1EECC = 1;
  }
  v7 = (CharaGraphServantCollectionListViewItem_o *)sub_1B71818(CharaGraphServantCollectionListViewItem_TypeInfo);
