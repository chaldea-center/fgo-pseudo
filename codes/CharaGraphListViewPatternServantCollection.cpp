        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2D334 & 1) == 0 )
  {
    sub_1B761C0(&Method_CharaGraphListViewPatternServantCollection__GenerateListViewItem_b__0_0__, method);
    sub_1B761C0(
      &Method_System_Linq_Enumerable_Select_UserServantCollectionEntity__CharaGraphServantCollectionListViewItem___,
      v3);
    sub_1B761C0(&System_Func_UserServantCollectionEntity__int__CharaGraphServantCollectionListViewItem__TypeInfo, v4);
    byte_4A2D334 = 1;
  }
  ...
  v6 = (System_Func_T1__T2__TResult__o *)sub_1B7640C(System_Func_UserServantCollectionEntity__int__CharaGraphServantCollectionListViewItem__TypeInfo);
  ...
  return (System_Collections_Generic_IEnumerable_CharaGraphListViewItemBase__o *)System_Linq_Enumerable__Select_object__object__48837120(
                                                                                   ...
                                                                                   (const MethodInfo_2E93200 *)Method_System_Linq_Enumerable_Select_UserServantCollectionEntity__CharaGraphServantCollectionListViewItem___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2D335 & 1) == 0 )
  {
    sub_1B761C0(&CharaGraphListViewItemDrawPatternServantCollection_TypeInfo, method);
    byte_4A2D335 = 1;
  }
  v2 = (Il2CppObject *)sub_1B7640C(CharaGraphListViewItemDrawPatternServantCollection_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2D337 & 1) == 0 )
  {
    sub_1B761C0(&CharaGraphServantCollectionListViewItem_TypeInfo, elem);
    byte_4A2D337 = 1;
  }
  v7 = (CharaGraphServantCollectionListViewItem_o *)sub_1B7640C(CharaGraphServantCollectionListViewItem_TypeInfo);
