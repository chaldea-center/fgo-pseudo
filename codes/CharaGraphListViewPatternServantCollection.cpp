        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B65F6E & 1) == 0 )
  {
    sub_1BE4ACC(&Method_CharaGraphListViewPatternServantCollection__GenerateListViewItem_b__0_0__, method);
    sub_1BE4ACC(
      &Method_System_Linq_Enumerable_Select_UserServantCollectionEntity__CharaGraphServantCollectionListViewItem___,
      v3);
    sub_1BE4ACC(&System_Func_UserServantCollectionEntity__int__CharaGraphServantCollectionListViewItem__TypeInfo, v4);
    byte_4B65F6E = 1;
  }
  ...
  v6 = (System_Func_T1__T2__TResult__o *)sub_1BE4D18(System_Func_UserServantCollectionEntity__int__CharaGraphServantCollectionListViewItem__TypeInfo);
  ...
  return (System_Collections_Generic_IEnumerable_CharaGraphListViewItemBase__o *)System_Linq_Enumerable__Select_object__object__49851292(
                                                                                   ...
                                                                                   (const MethodInfo_2F8AB9C *)Method_System_Linq_Enumerable_Select_UserServantCollectionEntity__CharaGraphServantCollectionListViewItem___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B65F6F & 1) == 0 )
  {
    sub_1BE4ACC(&CharaGraphListViewItemDrawPatternServantCollection_TypeInfo, method);
    byte_4B65F6F = 1;
  }
  v2 = (Il2CppObject *)sub_1BE4D18(CharaGraphListViewItemDrawPatternServantCollection_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B65F71 & 1) == 0 )
  {
    sub_1BE4ACC(&CharaGraphServantCollectionListViewItem_TypeInfo, elem);
    byte_4B65F71 = 1;
  }
  v7 = (CharaGraphServantCollectionListViewItem_o *)sub_1BE4D18(CharaGraphServantCollectionListViewItem_TypeInfo);
