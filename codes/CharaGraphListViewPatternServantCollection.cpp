        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6F257 & 1) == 0 )
  {
    sub_1B90010(&Method_CharaGraphListViewPatternServantCollection__GenerateListViewItem_b__0_0__, method);
    sub_1B90010(
      &Method_System_Linq_Enumerable_Select_UserServantCollectionEntity__CharaGraphServantCollectionListViewItem___,
      v3);
    sub_1B90010(&System_Func_UserServantCollectionEntity__int__CharaGraphServantCollectionListViewItem__TypeInfo, v4);
    byte_4A6F257 = 1;
  }
  ...
  v6 = (System_Func_T1__T2__TResult__o *)sub_1B9025C(System_Func_UserServantCollectionEntity__int__CharaGraphServantCollectionListViewItem__TypeInfo);
  ...
  return (System_Collections_Generic_IEnumerable_CharaGraphListViewItemBase__o *)System_Linq_Enumerable__Select_object__object__49016960(
                                                                                   ...
                                                                                   (const MethodInfo_2EBF080 *)Method_System_Linq_Enumerable_Select_UserServantCollectionEntity__CharaGraphServantCollectionListViewItem___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6F258 & 1) == 0 )
  {
    sub_1B90010(&CharaGraphListViewItemDrawPatternServantCollection_TypeInfo, method);
    byte_4A6F258 = 1;
  }
  v2 = (Il2CppObject *)sub_1B9025C(CharaGraphListViewItemDrawPatternServantCollection_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6F25A & 1) == 0 )
  {
    sub_1B90010(&CharaGraphServantCollectionListViewItem_TypeInfo, elem);
    byte_4A6F25A = 1;
  }
  v7 = (CharaGraphServantCollectionListViewItem_o *)sub_1B9025C(CharaGraphServantCollectionListViewItem_TypeInfo);
