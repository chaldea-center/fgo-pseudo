        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596FADA & 1) == 0 )
  {
    sub_2213A60(&Method_CharaGraphListViewPatternServantCollection__GenerateListViewItem_b__0_0__);
    sub_2213A60(&Method_System_Linq_Enumerable_Select_UserServantCollectionEntity__CharaGraphServantCollectionListViewItem___);
    sub_2213A60(&System_Func_UserServantCollectionEntity__int__CharaGraphServantCollectionListViewItem__TypeInfo);
    byte_596FADA = 1;
  }
  ...
  v4 = (System_Func_T1__T2__TResult__o *)sub_2213CCC(System_Func_UserServantCollectionEntity__int__CharaGraphServantCollectionListViewItem__TypeInfo);
  ...
  return (System_Collections_Generic_IEnumerable_CharaGraphListViewItemBase__o *)System_Linq_Enumerable__Select_object__object__59315436(
                                                                                   ...
                                                                                   (const MethodInfo_38914EC *)Method_System_Linq_Enumerable_Select_UserServantCollectionEntity__CharaGraphServantCollectionListViewItem___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596FADB & 1) == 0 )
  {
    sub_2213A60(&CharaGraphListViewItemDrawPatternServantCollection_TypeInfo);
    byte_596FADB = 1;
  }
  v2 = (Il2CppObject *)sub_2213CCC(CharaGraphListViewItemDrawPatternServantCollection_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v7 = (CharaGraphServantCollectionListViewItem_o *)sub_2213CCC(CharaGraphServantCollectionListViewItem_TypeInfo);
