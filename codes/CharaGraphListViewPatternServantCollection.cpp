        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B871 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_CharaGraphListViewPatternServantCollection__GenerateListViewItem_b__0_0__, method);
    sub_1BCAFF8(
      &Method_System_Linq_Enumerable_Select_UserServantCollectionEntity__CharaGraphServantCollectionListViewItem___,
      v3);
    sub_1BCAFF8(&System_Func_UserServantCollectionEntity__int__CharaGraphServantCollectionListViewItem__TypeInfo, v4);
    byte_4B1B871 = 1;
  }
  ...
  v6 = (System_Func_T1__T2__TResult__o *)sub_1BCB244(System_Func_UserServantCollectionEntity__int__CharaGraphServantCollectionListViewItem__TypeInfo);
  ...
  return (System_Collections_Generic_IEnumerable_CharaGraphListViewItemBase__o *)System_Linq_Enumerable__Select_object__object__50655936(
                                                                                   ...
                                                                                   (const MethodInfo_304F2C0 *)Method_System_Linq_Enumerable_Select_UserServantCollectionEntity__CharaGraphServantCollectionListViewItem___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B872 & 1) == 0 )
  {
    sub_1BCAFF8(&CharaGraphListViewItemDrawPatternServantCollection_TypeInfo, method);
    byte_4B1B872 = 1;
  }
  v2 = (Il2CppObject *)sub_1BCB244(CharaGraphListViewItemDrawPatternServantCollection_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B874 & 1) == 0 )
  {
    sub_1BCAFF8(&CharaGraphServantCollectionListViewItem_TypeInfo, elem);
    byte_4B1B874 = 1;
  }
  v7 = (CharaGraphServantCollectionListViewItem_o *)sub_1BCB244(CharaGraphServantCollectionListViewItem_TypeInfo);
