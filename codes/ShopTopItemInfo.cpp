        ...
        const MethodInfo *method)
{
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&v12->fields._TextCode_k__BackingField, (int32_t)textCode, v13, v14);
  v12->fields._ImageName_k__BackingField = imageName;
  v12 = (ShopTopItemInfo_o *)((char *)v12 + 32);
  sub_1BC2FAC((CGThumbnailListItem_o *)v12, (int32_t)imageName, v15, v16);
        ...
        const MethodInfo *method)
{
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields._ImageName_k__BackingField, (int32_t)value, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields._TextCode_k__BackingField, (int32_t)value, (int32_t)method, v3);
}