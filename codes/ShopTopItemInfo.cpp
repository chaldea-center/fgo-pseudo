        ...
        const MethodInfo *method)
{
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&v12->fields._TextCode_k__BackingField, (int32_t)textCode, v13, v14);
  v12->fields._ImageName_k__BackingField = imageName;
  v12 = (ShopTopItemInfo_o *)((char *)v12 + 32);
  sub_1C6B9AC((CGThumbnailListItem_o *)v12, (int32_t)imageName, v15, v16);
...
void ShopTopItemInfo__set_TextCode(ShopTopItemInfo_o *this, System_String_o *value, const MethodInfo *method)
{
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields._TextCode_k__BackingField, (int32_t)value, (int32_t)method, v3);
}