...
Il2CppObject *__fastcall BaseCore__CreateEarthPoint_object_(
        ...
        float y,
        float z,
        const MethodInfo_1725564 *method)
{
  __int64 v11; // x1
  __int64 v12; // x1
  ...
  if ( (byte_4187245 & 1) == 0 )
  {
    sub_B2C35C(&Method_UnityEngine_Object_Instantiate_GameObject___, *(_QWORD *)&warId);
    sub_B2C35C(&UnityEngine_Object_TypeInfo, v11);
    sub_B2C35C(&StringLiteral_5803/*"EarthPoint_"*/, v12);
    byte_4187245 = 1;
  }
  ...
  v16 = v14;
  GameObjectExtensions__SetParent_31331816(v14, mEarthPointRoot, 0LL);
  if ( !v16
    || (transform = (UnityEngine_Object_o *)UnityEngine_GameObject__get_transform(v16, 0LL),
        v20 = System_Int32__ToString((int32_t)&v22, 0LL),
        v17 = System_String__Concat_44305532((System_String_o *)StringLiteral_5803/*"EarthPoint_"*/, v20, 0LL),
        !transform) )
  {
    sub_B2C434(v17, v18);
  }
  UnityEngine_Object__set_name(transform, v17, 0LL);
  GameObjectExtensions__SetLocalPosition_31326032(v16, x, y, z, 0LL);
...
BaseEarthPoint_o *__fastcall BaseCore__GetEarthPoint(BaseCore_o *this, int32_t warId, const MethodInfo *method)
{
  ...
  if ( (byte_41849F9 & 1) == 0 )
  {
    sub_B2C35C(&Method_UnityEngine_GameObject_GetComponent_BaseEarthPoint___, *(_QWORD *)&warId);
    sub_B2C35C(&UnityEngine_Object_TypeInfo, v4);
    sub_B2C35C(&StringLiteral_5803/*"EarthPoint_"*/, v5);
    byte_41849F9 = 1;
  }
  ...
  result = (BaseEarthPoint_o *)System_String__Concat_44305532((System_String_o *)StringLiteral_5803/*"EarthPoint_"*/, v8, 0LL);
  if ( !transform )
    goto LABEL_13;
    ...
    if ( v9 )
    {
      ...
      if ( result )
        return (BaseEarthPoint_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                     ...
                                     (const MethodInfo_1AA78DC *)Method_UnityEngine_GameObject_GetComponent_BaseEarthPoint___);
    }
LABEL_13:
    sub_B2C434(result, *(_QWORD *)&warId);
  }
  return result;
}
...
void __fastcall BaseCore__HideEarthPoint(BaseCore_o *this, int32_t warId, const MethodInfo *method)
{
  ...
  if ( (byte_41849FB & 1) == 0 )
  {
    sub_B2C35C(&UnityEngine_Object_TypeInfo, *(_QWORD *)&warId);
    byte_41849FB = 1;
  }
...
bool __fastcall BaseCore__IsWarOpen(BaseCore_o *this, MapControl_WarInfo_o *warInfo, const MethodInfo *method)
{
  ...
  if ( (byte_41849FA & 1) == 0 )
  {
    sub_B2C35C(&Method_SingletonTemplate_QuestTree__get_Instance__, warInfo);
    this = (BaseCore_o *)sub_B2C35C(&SingletonTemplate_QuestTree__TypeInfo, v4);
    byte_41849FA = 1;
  }
  if ( !warInfo )
    goto LABEL_12;
  ...
  if ( WarEntity__IsEvent((WarEntity_o *)this, 0LL) )
  {
    ...
    this = (BaseCore_o *)MapControl_WarInfo__GetMine(warInfo, 0LL);
    if ( v5 )
      return QuestTree__IsActiveEventWar_21870556(v5, (WarEntity_o *)this, 0LL);
LABEL_12:
    sub_B2C434(this, warInfo);
  }
...
void __fastcall BaseCore__SetFocusEarthPoint(BaseCore_o *this, int32_t warId, const MethodInfo *method)
{
  ...
  sub_B2C2F8(&this->fields.mFocusEarthPoint, EarthPoint);
}
...
void __fastcall BaseCore__SetTerminalData(BaseCore_o *this, const MethodInfo *method)
{
  ...
  sub_B2C2F8(&this->fields.mTerminalScene, v5);
  mTerminalScene = this->fields.mTerminalScene;
  if ( !mTerminalScene
    ...
    || (gameObject = UnityEngine_Component__get_gameObject(mTerminalMap, 0LL),
        ...
        sub_B2C2F8(&this->fields.mTerminalMap, gameObject),
        (v10 = this->fields.mTerminalScene) == 0LL) )
  {
    sub_B2C434(mTerminalMap, v7);
  }
  mEarthEffCamera = v10->fields.mEarthEffCamera;
  this->fields.mEarthEffCamera = mEarthEffCamera;
  sub_B2C2F8(&this->fields.mEarthEffCamera, mEarthEffCamera);
}
