...
void DebugQuestRequest__beginRequest(DebugQuestRequest_o *this, bool is_enable, const MethodInfo *method)
{
  ...
  if ( (byte_4C394A5 & 1) == 0 )
  {
    this = (DebugQuestRequest_o *)sub_1C32C20(&StringLiteral_19474/*"flag"*/);
    byte_4C394A5 = 1;
  }
  if ( !v4 )
    sub_1C32E7C(this);
  RequestBase__addField(v4, (System_String_o *)StringLiteral_19474/*"flag"*/, is_enable, 0);
...
System_String_o *DebugQuestRequest__getURL(DebugQuestRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C394A3 & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_4502/*"ClientDebug/QuestThrough"*/);
    byte_4C394A3 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63518544(BaseUrl, (System_String_o *)StringLiteral_4502/*"ClientDebug/QuestThrough"*/, 0);
}
