...
void DebugQuestRequest__beginRequest(DebugQuestRequest_o *this, bool is_enable, const MethodInfo *method)
{
  ...
  if ( (byte_4CB7DE4 & 1) == 0 )
  {
    this = (DebugQuestRequest_o *)sub_1C6BA08(&StringLiteral_19539/*"flag"*/);
    byte_4CB7DE4 = 1;
  }
  if ( !v4 )
    sub_1C6BC60(this, is_enable);
  RequestBase__addField(v4, (System_String_o *)StringLiteral_19539/*"flag"*/, is_enable, 0);
...
System_String_o *DebugQuestRequest__getURL(DebugQuestRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB7DE2 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_4492/*"ClientDebug/QuestThrough"*/);
    byte_4CB7DE2 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63966792(BaseUrl, (System_String_o *)StringLiteral_4492/*"ClientDebug/QuestThrough"*/, 0);
}
