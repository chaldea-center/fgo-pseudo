...
void DebugQuestRequest__beginRequest(DebugQuestRequest_o *this, bool is_enable, const MethodInfo *method)
{
  ...
  if ( (byte_4C44A9F & 1) == 0 )
  {
    this = (DebugQuestRequest_o *)sub_1C37058(&StringLiteral_19477/*"flag"*/);
    byte_4C44A9F = 1;
  }
  if ( !v4 )
    sub_1C372B4(this);
  RequestBase__addField(v4, (System_String_o *)StringLiteral_19477/*"flag"*/, is_enable, 0);
...
System_String_o *DebugQuestRequest__getURL(DebugQuestRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C44A9D & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_4502/*"ClientDebug/QuestThrough"*/);
    byte_4C44A9D = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63561656(BaseUrl, (System_String_o *)StringLiteral_4502/*"ClientDebug/QuestThrough"*/, 0);
}
