        ...
        const MethodInfo *method)
{
  ...
  if ( ((unsigned __int8)RestTimeInFormat & 1) != 0 )
  {
    if ( !eventTradeGoodsEntity )
      goto LABEL_34;
    v8 = this->fields.timeRequiredCraft;
...
LABEL_34:
  ...
  if ( (int)max_length >= 1 )
  {
    ...
    for ( i = 0; (__int64)i < (int)max_length; ++i )
    {
      ...
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      RestTimeInFormat = (UILabel_o *)UnityEngine_Object__op_Equality(v15, 0, 0);
      if ( ((unsigned __int8)RestTimeInFormat & 1) == 0 )
      {
        if ( !v15 )
          goto LABEL_34;
        gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)v15, 0);
        RestTimeInFormat = (UILabel_o *)EventTradePriceInfo__get_DisplayCount((EventTradePriceInfo_o *)v15, 0);
        if ( !v13 || !gameObject )
          goto LABEL_34;
        UnityEngine_GameObject__SetActive(
          gameObject,
          (_DWORD)RestTimeInFormat == LODWORD(v13->fields.m_CancellationTokenSource),
          0);
        EventTradePriceInfo__SetPriceInfo((EventTradePriceInfo_o *)v15, (CommonConsumeEntity_array *)v13, 0, 0);
      }
