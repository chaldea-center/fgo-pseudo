        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_435118B & 1) == 0 )
  {
    ...
    sub_B70694(&StringLiteral_5772/*"EVENT_RACE_RESULT_TIME_NONE"*/);
    byte_435118B = 1;
  }
  if ( param
  ...
  {
    v9 = *((_QWORD *)v8 + 7);
    Value = (System_String_o *)ConstantMaster__getValue((System_String_o *)StringLiteral_11156/*"RACE_TARGET_GOAL_RANK"*/, 0LL);
    if ( v9 <= (int)Value )
    {
