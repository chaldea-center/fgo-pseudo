        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB5B26 & 1) == 0 )
  {
    sub_1C13D24(&LocalizationManager_TypeInfo, param);
    sub_1C13D24(&RaceResultEffectParam_TypeInfo, v5);
    sub_1C13D24(&StringLiteral_11133/*"Queue grow factor must be between {0} and {1}."*/, v6);
    sub_1C13D24(&StringLiteral_1/*""*/, v7);
    sub_1C13D24(&StringLiteral_5789/*"EVENT_RACE_RESULT_PATH_LENGTH"*/, v8);
    byte_4BB5B26 = 1;
  }
  if ( param
  ...
  {
    v13 = *((_QWORD *)v12 + 7);
    Value = (System_String_o *)ConstantMaster__getValue((System_String_o *)StringLiteral_11133/*"Queue grow factor must be between {0} and {1}."*/, 0LL);
    if ( v13 <= (int)Value )
    {
...
LABEL_22:
    ...
    else
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      Value = LocalizationManager__Get((System_String_o *)StringLiteral_5789/*"EVENT_RACE_RESULT_PATH_LENGTH"*/, 0LL);
      if ( !label )
        goto LABEL_22;
    }
    v11 = Value;
