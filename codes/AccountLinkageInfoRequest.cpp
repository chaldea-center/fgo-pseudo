...
System_String_o *AccountLinkageInfoRequest__getURL(AccountLinkageInfoRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C2D490(&NetworkManager_TypeInfo);
    sub_1C2D490(&StringLiteral_16640/*"accountLinkageAnx/info"*/);
    byte_4C28CDB = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63457864(BaseUrl, (System_String_o *)StringLiteral_16640/*"accountLinkageAnx/info"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C28CDD & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_16782/*"aniplexPlusServerError"*/);
    sub_1C2D490(&StringLiteral_22295/*"notificationType"*/);
    this = (AccountLinkageInfoRequest_o *)sub_1C2D490(&StringLiteral_22195/*"ng"*/);
    byte_4C28CDD = 1;
  }
  if ( !responseList )
    goto LABEL_15;
  ...
  if ( !v5 )
    goto LABEL_15;
  this = (AccountLinkageInfoRequest_o *)ResponseData__checkError_44004292(v5, 0);
  ...
  this = (AccountLinkageInfoRequest_o *)System_Collections_Generic_Dictionary_object__object___get_Item(
                                          success,
                                          (Il2CppObject *)StringLiteral_22295/*"notificationType"*/,
  ...
  this = (AccountLinkageInfoRequest_o *)System_Collections_Generic_Dictionary_object__object___get_Item(
                                          success,
                                          (Il2CppObject *)StringLiteral_16782/*"aniplexPlusServerError"*/,
                                          (const MethodInfo_344A2A8 *)Method_System_Collections_Generic_Dictionary_string__object__get_Item__);
