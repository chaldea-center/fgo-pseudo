        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B4CF90(&NetworkManager_TypeInfo, method);
    sub_1B4CF90(&StringLiteral_16330/*"accountLinkageAnx/info"*/, v2);
    byte_49BC743 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61093468(BaseUrl, (System_String_o *)StringLiteral_16330/*"accountLinkageAnx/info"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BC745 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_16477/*"aniplexPlusServerError"*/, v9);
    sub_1B4CF90(&StringLiteral_21879/*"notificationType"*/, v10);
    this = (AccountLinkageInfoRequest_o *)sub_1B4CF90(&StringLiteral_21779/*"ng"*/, v11);
    byte_49BC745 = 1;
  }
  if ( !responseList )
    goto LABEL_18;
  ...
  if ( !v12 )
    goto LABEL_18;
  this = (AccountLinkageInfoRequest_o *)ResponseData__checkError_41839176(v12, 0LL);
  if ( ((unsigned __int8)this & 1) != 0 )
  {
    ...
    if ( success )
    {
      this = (AccountLinkageInfoRequest_o *)System_Collections_Generic_Dictionary_object__object___get_Item(
                                              success,
                                              (Il2CppObject *)StringLiteral_21879/*"notificationType"*/,
      ...
      if ( this )
      {
        ...
        this = (AccountLinkageInfoRequest_o *)System_Collections_Generic_Dictionary_object__object___get_Item(
                                                success,
                                                (Il2CppObject *)StringLiteral_16477/*"aniplexPlusServerError"*/,
                                                (const MethodInfo_3257A98 *)Method_System_Collections_Generic_Dictionary_string__object__get_Item__);
