...
System_String_o *AccountLinkageInfoRequest__getURL(AccountLinkageInfoRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&NetworkManager_TypeInfo);
    sub_1CE6700(&StringLiteral_16799/*"accountLinkageAnx/info"*/);
    byte_4E0642C = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_65122828(BaseUrl, (System_String_o *)StringLiteral_16799/*"accountLinkageAnx/info"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E0642E & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_16961/*"aniplexPlusServerError"*/);
    sub_1CE6700(&StringLiteral_22658/*"notificationType"*/);
    this = (AccountLinkageInfoRequest_o *)sub_1CE6700(&StringLiteral_22555/*"ng"*/);
    byte_4E0642E = 1;
  }
  if ( !responseList )
    goto LABEL_15;
  ...
  if ( !v5 )
    goto LABEL_15;
  this = (AccountLinkageInfoRequest_o *)ResponseData__checkError_45365352(v5, 0);
  ...
  this = (AccountLinkageInfoRequest_o *)System_Collections_Generic_Dictionary_object__object___get_Item(
                                          success,
                                          (Il2CppObject *)StringLiteral_22658/*"notificationType"*/,
  ...
  this = (AccountLinkageInfoRequest_o *)System_Collections_Generic_Dictionary_object__object___get_Item(
                                          success,
                                          (Il2CppObject *)StringLiteral_16961/*"aniplexPlusServerError"*/,
                                          (const MethodInfo_35B4910 *)Method_System_Collections_Generic_Dictionary_string__object__get_Item__);
