void ResponseData___ctor(ResponseData_o *this, const MethodInfo *method)
{
  if ( (byte_4E065D7 & 1) == 0 )
  {
    sub_1CE6700(&ResponseData___TypeInfo);
    sub_1CE6700(&ResponseData_TypeInfo);
    byte_4E065D7 = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0);
  if ( ResponseData_TypeInfo->static_fields->_never )
    sub_1CE67A8(ResponseData___TypeInfo, 1);
}
...
bool ResponseData__checkError(ResponseData_o *this, System_String_o *resCode, const MethodInfo *method)
{
  ...
  if ( (byte_4E065D8 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_1442/*"89"*/);
    sub_1CE6700(&StringLiteral_1131/*"01"*/);
    sub_1CE6700(&StringLiteral_1138/*"03"*/);
    sub_1CE6700(&StringLiteral_1448/*"99"*/);
    sub_1CE6700(&StringLiteral_1137/*"02"*/);
    sub_1CE6700(&StringLiteral_1441/*"88"*/);
    sub_1CE6700(&StringLiteral_1446/*"98"*/);
    sub_1CE6700(&StringLiteral_1303/*"11"*/);
    sub_1CE6700(&StringLiteral_1436/*"71"*/);
    sub_1CE6700(&StringLiteral_1139/*"04"*/);
  ...
  if ( v4 > 0x1EED6D94 )
  {
    if ( v4 > 0x21ED724D )
    {
      ...
      {
        case 0x90E5D245:
          v5 = &StringLiteral_1436/*"71"*/;
          goto LABEL_30;
        case 0x9901B55A:
          v5 = &StringLiteral_1442/*"89"*/;
          goto LABEL_30;
        case 0x9A01B6ED:
          v5 = &StringLiteral_1441/*"88"*/;
          goto LABEL_30;
      }
    }
    else
    {
      if ( v4 == 535654183 )
      {
        v5 = &StringLiteral_1137/*"02"*/;
        goto LABEL_30;
      }
      if ( v4 == 552431802 )
      {
        v5 = &StringLiteral_1131/*"01"*/;
        goto LABEL_30;
      }
      if ( v4 == 569209421 && System_String__op_Equality(resCode, (System_String_o *)StringLiteral_1124/*"00"*/, 0) )
        return 1;
    }
  }
  else if ( v4 > 0x14FEA6F7 )
  {
    ...
    {
      case 0x1CEB2BD7u:
        v5 = &StringLiteral_1303/*"11"*/;
        goto LABEL_30;
      case 0x1DED6C01u:
        v5 = &StringLiteral_1139/*"04"*/;
        goto LABEL_30;
      case 0x1EED6D94u:
        v5 = &StringLiteral_1138/*"03"*/;
        goto LABEL_30;
    }
  }
  else
  {
    if ( v4 == 335455588 )
    {
      v5 = &StringLiteral_1446/*"98"*/;
      goto LABEL_30;
    }
    if ( v4 == 352233207 )
    {
      v5 = &StringLiteral_1448/*"99"*/;
LABEL_30:
...
bool ResponseData__checkError_45365352(ResponseData_o *this, const MethodInfo *method)
{
...
System_String_o *ResponseData__getErrorMessage(ResponseData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E065D9 & 1) == 0 )
  {
    ...
    this = (ResponseData_o *)sub_1CE6700(&StringLiteral_18816/*"detail"*/);
    byte_4E065D9 = 1;
  }
