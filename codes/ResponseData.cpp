void ResponseData___ctor(ResponseData_o *this, const MethodInfo *method)
{
  if ( (byte_4C28E7A & 1) == 0 )
  {
    sub_1C2D490(&ResponseData___TypeInfo);
    sub_1C2D490(&ResponseData_TypeInfo);
    byte_4C28E7A = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0);
  if ( ResponseData_TypeInfo->static_fields->_never )
    sub_1C2D538(ResponseData___TypeInfo, 1);
}
...
bool ResponseData__checkError(ResponseData_o *this, System_String_o *resCode, const MethodInfo *method)
{
  ...
  if ( (byte_4C28E7B & 1) == 0 )
  {
    sub_1C2D490(&StringLiteral_1446/*"89"*/);
    sub_1C2D490(&StringLiteral_1136/*"01"*/);
    sub_1C2D490(&StringLiteral_1143/*"03"*/);
    sub_1C2D490(&StringLiteral_1452/*"99"*/);
    sub_1C2D490(&StringLiteral_1142/*"02"*/);
    sub_1C2D490(&StringLiteral_1445/*"88"*/);
    sub_1C2D490(&StringLiteral_1450/*"98"*/);
    sub_1C2D490(&StringLiteral_1308/*"11"*/);
    sub_1C2D490(&StringLiteral_1440/*"71"*/);
    sub_1C2D490(&StringLiteral_1144/*"04"*/);
  ...
  if ( v4 > 0x1EED6D94 )
  {
    if ( v4 > 0x21ED724D )
    {
      ...
      {
        case 0x90E5D245:
          v5 = &StringLiteral_1440/*"71"*/;
          goto LABEL_30;
        case 0x9901B55A:
          v5 = &StringLiteral_1446/*"89"*/;
          goto LABEL_30;
        case 0x9A01B6ED:
          v5 = &StringLiteral_1445/*"88"*/;
          goto LABEL_30;
      }
    }
    else
  ...
  else
  {
    if ( v4 == 335455588 )
    {
      v5 = &StringLiteral_1450/*"98"*/;
      goto LABEL_30;
    }
    if ( v4 == 352233207 )
    {
      v5 = &StringLiteral_1452/*"99"*/;
LABEL_30:
...
bool ResponseData__checkError_44004292(ResponseData_o *this, const MethodInfo *method)
{
...
System_String_o *ResponseData__getErrorMessage(ResponseData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C28E7C & 1) == 0 )
  {
    ...
    this = (ResponseData_o *)sub_1C2D490(&StringLiteral_18590/*"detail"*/);
    byte_4C28E7C = 1;
  }
