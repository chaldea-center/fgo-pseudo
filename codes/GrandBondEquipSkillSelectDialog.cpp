        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4743D & 1) == 0 )
  {
    sub_1BDB878(&Method_GrandBondEquipSkillSelectDialog_OnClickAnotherSKillBtn__, method);
  ...
  if ( this->fields.baseState == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_GrandBondEquipSkillSelectDialog_OnClickAnotherSKillBtn__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1BDB890(Method_GrandBondEquipSkillSelectDialog_OnClickAnotherSKillBtn__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4743E & 1) == 0 )
  {
    sub_1BDB878(&Method_GrandBondEquipSkillSelectDialog_OnClickCancelBtn__, method);
    sub_1BDB878(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v3);
    byte_4B4743E = 1;
  }
  if ( this->fields.baseState == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_GrandBondEquipSkillSelectDialog_OnClickCancelBtn__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1BDB890(Method_GrandBondEquipSkillSelectDialog_OnClickCancelBtn__);
    v5 = (System_Reflection_MethodBase_o *)sub_1BDB85C(v4, v4[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4743C & 1) == 0 )
  {
    sub_1BDB878(&Method_GrandBondEquipSkillSelectDialog_OnClickNormalSKillBtn__, method);
    sub_1BDB878(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v3);
    byte_4B4743C = 1;
  }
  if ( this->fields.baseState == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_GrandBondEquipSkillSelectDialog_OnClickNormalSKillBtn__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1BDB890(Method_GrandBondEquipSkillSelectDialog_OnClickNormalSKillBtn__);
    v5 = (System_Reflection_MethodBase_o *)sub_1BDB85C(v4, v4[4]);
    OverwriteAssetSoundName__PlaySystemSe(v5, 8, 0, 0LL);
    Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    if ( !Instance )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4743A & 1) == 0 )
  {
    sub_1BDB878(&LocalizationManager_TypeInfo, equipUserSvtId);
    sub_1BDB878(&StringLiteral_6998/*"GRAND_BOND_EQUIP_FUNC_SELECT_DIALOG_TITLE"*/, v7);
    sub_1BDB878(&StringLiteral_6997/*"GRAND_BOND_EQUIP_FUNC_SELECT_DIALOG_NORMAL_SKILL_HEADER"*/, v8);
    sub_1BDB878(&StringLiteral_6995/*"GRAND_BOND_EQUIP_FUNC_SELECT_DIALOG_MESSAGE"*/, v9);
    sub_1BDB878(&StringLiteral_3716/*"COMMON_CONFIRM_CANCEL"*/, v10);
    sub_1BDB878(&StringLiteral_6993/*"GRAND_BOND_EQUIP_FUNC_SELECT_DIALOG_ANOTHER_SKILL_BUTTON"*/, v11);
    sub_1BDB878(&StringLiteral_6994/*"GRAND_BOND_EQUIP_FUNC_SELECT_DIALOG_ANOTHER_SKILL_HEADER"*/, v12);
    sub_1BDB878(&StringLiteral_6996/*"GRAND_BOND_EQUIP_FUNC_SELECT_DIALOG_NORMAL_SKILL_BUTTON"*/, v13);
    byte_4B4743A = 1;
  }
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_6998/*"GRAND_BOND_EQUIP_FUNC_SELECT_DIALOG_TITLE"*/, 0LL);
  if ( !titleLabel )
    goto LABEL_13;
  UILabel__set_text(titleLabel, v15, 0LL);
  messageLabel = this->fields.messageLabel;
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_6995/*"GRAND_BOND_EQUIP_FUNC_SELECT_DIALOG_MESSAGE"*/, 0LL);
  if ( !messageLabel )
    goto LABEL_13;
  UILabel__set_text(messageLabel, v15, 0LL);
  normalSkillHeader = this->fields.normalSkillHeader;
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_6997/*"GRAND_BOND_EQUIP_FUNC_SELECT_DIALOG_NORMAL_SKILL_HEADER"*/, 0LL);
  if ( !normalSkillHeader )
    goto LABEL_13;
  UILabel__set_text(normalSkillHeader, v15, 0LL);
  anotherSkillHeader = this->fields.anotherSkillHeader;
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_6994/*"GRAND_BOND_EQUIP_FUNC_SELECT_DIALOG_ANOTHER_SKILL_HEADER"*/, 0LL);
  if ( !anotherSkillHeader )
    goto LABEL_13;
  UILabel__set_text(anotherSkillHeader, v15, 0LL);
  normalSkillBtnLabel = this->fields.normalSkillBtnLabel;
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_6996/*"GRAND_BOND_EQUIP_FUNC_SELECT_DIALOG_NORMAL_SKILL_BUTTON"*/, 0LL);
  if ( !normalSkillBtnLabel
    || (UILabel__set_text(normalSkillBtnLabel, v15, 0LL),
        anotherSkillBtnLabel = this->fields.anotherSkillBtnLabel,
        v15 = LocalizationManager__Get((System_String_o *)StringLiteral_6993/*"GRAND_BOND_EQUIP_FUNC_SELECT_DIALOG_ANOTHER_SKILL_BUTTON"*/, 0LL),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4743B & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMaster_ServantSkillMaster___, equipUserSvtId);
  ...
  EffectTitle = DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_UserServantMaster___);
  if ( !EffectTitle )
    goto LABEL_24;
  ...
  v19 = DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_ServantSkillMaster___);
  if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
  *(_QWORD *)&v27.fields.currentCryptoKey = v17;
  *(_QWORD *)&v27.fields.fakeValue = v18;
  EffectTitle = (void *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48227716(v27, 0LL);
  if ( !v19 )
    goto LABEL_24;
