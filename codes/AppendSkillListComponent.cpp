void AppendSkillListComponent___cctor(const MethodInfo *method)
{
  if ( (byte_59379B2 & 1) == 0 )
  {
    sub_21FFC50(&AppendSkillListComponent_TypeInfo);
    byte_59379B2 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    AtlasManager__SetEventSprite(skillIconSprite, (System_String_o *)StringLiteral_21055/*"icon_append_mini"*/, 0);
    skillLevelListLabel = (UILabel_o *)this->fields.skillIconSprite;
    if ( !skillLevelListLabel )
LABEL_13:
      sub_21FFECC(skillLevelListLabel, v5);
