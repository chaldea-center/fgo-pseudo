void __fastcall AppendSkillListComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BC6E9C & 1) == 0 )
  {
    sub_1C1ABD4(&AppendSkillListComponent_TypeInfo, v1);
    byte_4BC6E9C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6E9B & 1) == 0 )
  {
    sub_1C1ABD4(&AppendSkillListComponent_TypeInfo, skillLevelListText);
    sub_1C1ABD4(&AtlasManager_TypeInfo, v5);
    sub_1C1ABD4(&StringLiteral_20417/*"icon_append_mini"*/, v6);
    byte_4BC6E9B = 1;
  }
  ...
  else
  {
    ...
    AtlasManager__SetEventSprite(skillIconSprite, (System_String_o *)StringLiteral_20417/*"icon_append_mini"*/, 0LL);
    skillLevelListLabel = (UILabel_o *)this->fields.skillIconSprite;
    if ( !skillLevelListLabel )
LABEL_13:
      sub_1C1AE30(skillLevelListLabel, v7);
