void AppendSkillListComponent___cctor(const MethodInfo *method)
{
  if ( (byte_4E76A05 & 1) == 0 )
  {
    sub_1D0F0B4(&AppendSkillListComponent_TypeInfo);
    byte_4E76A05 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    AtlasManager__SetEventSprite(skillIconSprite, (System_String_o *)StringLiteral_20505/*"icon_append_mini"*/, 0);
    skillLevelListLabel = (UILabel_o *)this->fields.skillIconSprite;
    if ( !skillLevelListLabel )
LABEL_13:
      sub_1D0F30C(skillLevelListLabel, v5);
