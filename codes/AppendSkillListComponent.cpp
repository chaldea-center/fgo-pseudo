void __fastcall AppendSkillListComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BB3ACE & 1) == 0 )
  {
    sub_1C13D24(&AppendSkillListComponent_TypeInfo, v1);
    byte_4BB3ACE = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB3ACD & 1) == 0 )
  {
    sub_1C13D24(&AppendSkillListComponent_TypeInfo, skillLevelListText);
    sub_1C13D24(&AtlasManager_TypeInfo, v5);
    sub_1C13D24(&StringLiteral_20403/*"iTweenOnComplete"*/, v6);
    byte_4BB3ACD = 1;
  }
  ...
  else
  {
    ...
    AtlasManager__SetEventSprite(skillIconSprite, (System_String_o *)StringLiteral_20403/*"iTweenOnComplete"*/, 0LL);
    skillLevelListLabel = (UILabel_o *)this->fields.skillIconSprite;
    if ( !skillLevelListLabel )
LABEL_13:
      sub_1C13F80(skillLevelListLabel, v7);
