void __fastcall AppendSkillListComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A1EF05 & 1) == 0 )
  {
    sub_1B715CC(&AppendSkillListComponent_TypeInfo, v1);
    byte_4A1EF05 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1EF04 & 1) == 0 )
  {
    sub_1B715CC(&AppendSkillListComponent_TypeInfo, skillLevelListText);
    sub_1B715CC(&AtlasManager_TypeInfo, v5);
    sub_1B715CC(&StringLiteral_20032/*"icon_append_mini"*/, v6);
    byte_4A1EF04 = 1;
  }
  ...
  else
  {
    ...
    AtlasManager__SetEventSprite(skillIconSprite, (System_String_o *)StringLiteral_20032/*"icon_append_mini"*/, 0LL);
    skillLevelListLabel = (UILabel_o *)this->fields.skillIconSprite;
    if ( !skillLevelListLabel )
LABEL_13:
      sub_1B71828(skillLevelListLabel, v7);
