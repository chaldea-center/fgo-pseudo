void __fastcall AppendSkillListComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A2D370 & 1) == 0 )
  {
    sub_1B761C0(&AppendSkillListComponent_TypeInfo, v1);
    byte_4A2D370 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2D36F & 1) == 0 )
  {
    sub_1B761C0(&AppendSkillListComponent_TypeInfo, skillLevelListText);
    sub_1B761C0(&AtlasManager_TypeInfo, v5);
    sub_1B761C0(&StringLiteral_20077/*"icon_append_mini"*/, v6);
    byte_4A2D36F = 1;
  }
  ...
  else
  {
    ...
    AtlasManager__SetEventSprite(skillIconSprite, (System_String_o *)StringLiteral_20077/*"icon_append_mini"*/, 0LL);
    skillLevelListLabel = (UILabel_o *)this->fields.skillIconSprite;
    if ( !skillLevelListLabel )
LABEL_13:
      sub_1B7641C(skillLevelListLabel, v7);
