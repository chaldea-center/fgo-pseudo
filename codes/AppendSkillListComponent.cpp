void __fastcall AppendSkillListComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B013B9 & 1) == 0 )
  {
    sub_1BC3008(&AppendSkillListComponent_TypeInfo, v1);
    byte_4B013B9 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B013B8 & 1) == 0 )
  {
    sub_1BC3008(&AppendSkillListComponent_TypeInfo, skillLevelListText);
    sub_1BC3008(&AtlasManager_TypeInfo, v5);
    sub_1BC3008(&StringLiteral_19932/*"icon_append_mini"*/, v6);
    byte_4B013B8 = 1;
  }
  ...
  else
  {
    ...
    AtlasManager__SetEventSprite(skillIconSprite, (System_String_o *)StringLiteral_19932/*"icon_append_mini"*/, 0LL);
    skillLevelListLabel = (UILabel_o *)this->fields.skillIconSprite;
    if ( !skillLevelListLabel )
LABEL_13:
      sub_1BC3264(skillLevelListLabel, v7);
