void __fastcall AppendSkillListComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B43E2A & 1) == 0 )
  {
    sub_1BDB878(&AppendSkillListComponent_TypeInfo, v1);
    byte_4B43E2A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43E29 & 1) == 0 )
  {
    sub_1BDB878(&AppendSkillListComponent_TypeInfo, skillLevelListText);
    sub_1BDB878(&AtlasManager_TypeInfo, v5);
    sub_1BDB878(&StringLiteral_20144/*"icon_append_mini"*/, v6);
    byte_4B43E29 = 1;
  }
  ...
  else
  {
    ...
    AtlasManager__SetEventSprite(skillIconSprite, (System_String_o *)StringLiteral_20144/*"icon_append_mini"*/, 0LL);
    skillLevelListLabel = (UILabel_o *)this->fields.skillIconSprite;
    if ( !skillLevelListLabel )
LABEL_13:
      sub_1BDBAD4(skillLevelListLabel, v7);
