void __fastcall AppendSkillListComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A4D880 & 1) == 0 )
  {
    sub_1B863B8(&AppendSkillListComponent_TypeInfo, v1);
    byte_4A4D880 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4D87F & 1) == 0 )
  {
    sub_1B863B8(&AppendSkillListComponent_TypeInfo, skillLevelListText);
    sub_1B863B8(&AtlasManager_TypeInfo, v5);
    sub_1B863B8(&StringLiteral_19864/*"icon_append_mini"*/, v6);
    byte_4A4D87F = 1;
  }
  ...
  else
  {
    ...
    AtlasManager__SetEventSprite(skillIconSprite, (System_String_o *)StringLiteral_19864/*"icon_append_mini"*/, 0LL);
    skillLevelListLabel = (UILabel_o *)this->fields.skillIconSprite;
    if ( !skillLevelListLabel )
LABEL_13:
      sub_1B86614(skillLevelListLabel, v7);
