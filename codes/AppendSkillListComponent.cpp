void AppendSkillListComponent___cctor(const MethodInfo *method)
{
  if ( (byte_4D2FD52 & 1) == 0 )
  {
    sub_1C93AD4(&AppendSkillListComponent_TypeInfo);
    byte_4D2FD52 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    AtlasManager__SetEventSprite(skillIconSprite, (System_String_o *)StringLiteral_20349/*"icon_append_mini"*/, 0);
    skillLevelListLabel = (UILabel_o *)this->fields.skillIconSprite;
    if ( !skillLevelListLabel )
LABEL_13:
      sub_1C93D2C(skillLevelListLabel, v5);
