void AppendSkillListComponent___cctor(const MethodInfo *method)
{
  if ( (byte_4E03D8D & 1) == 0 )
  {
    sub_1CE6700(&AppendSkillListComponent_TypeInfo);
    byte_4E03D8D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    AtlasManager__SetEventSprite(skillIconSprite, (System_String_o *)StringLiteral_20417/*"icon_append_mini"*/, 0);
    skillLevelListLabel = (UILabel_o *)this->fields.skillIconSprite;
    if ( !skillLevelListLabel )
LABEL_13:
      sub_1CE6958(skillLevelListLabel, v5);
