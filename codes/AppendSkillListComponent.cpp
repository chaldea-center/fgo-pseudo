void __fastcall AppendSkillListComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB515C & 1) == 0 )
  {
    sub_1BAB41C(&AppendSkillListComponent_TypeInfo, v1);
    byte_4AB515C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB515B & 1) == 0 )
  {
    sub_1BAB41C(&AppendSkillListComponent_TypeInfo, skillLevelListText);
    sub_1BAB41C(&AtlasManager_TypeInfo, v5);
    sub_1BAB41C(&StringLiteral_20113/*"icon_append_mini"*/, v6);
    byte_4AB515B = 1;
  }
  ...
  else
  {
    ...
    AtlasManager__SetEventSprite(skillIconSprite, (System_String_o *)StringLiteral_20113/*"icon_append_mini"*/, 0LL);
    skillLevelListLabel = (UILabel_o *)this->fields.skillIconSprite;
    if ( !skillLevelListLabel )
LABEL_13:
      sub_1BAB678(skillLevelListLabel, v7);
