void __fastcall AppendSkillListComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A0809D & 1) == 0 )
  {
    sub_1B686D4(&AppendSkillListComponent_TypeInfo, v1);
    byte_4A0809D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0809C & 1) == 0 )
  {
    sub_1B686D4(&AppendSkillListComponent_TypeInfo, skillLevelListText);
    sub_1B686D4(&AtlasManager_TypeInfo, v5);
    sub_1B686D4(&StringLiteral_20014/*"icon_append_mini"*/, v6);
    byte_4A0809C = 1;
  }
  ...
  else
  {
    ...
    AtlasManager__SetEventSprite(skillIconSprite, (System_String_o *)StringLiteral_20014/*"icon_append_mini"*/, 0LL);
    skillLevelListLabel = (UILabel_o *)this->fields.skillIconSprite;
    if ( !skillLevelListLabel )
LABEL_13:
      sub_1B68930(skillLevelListLabel, v7);
