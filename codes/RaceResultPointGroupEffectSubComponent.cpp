void __fastcall RaceResultPointGroupEffectSubComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BDD9CF & 1) == 0 )
  {
    sub_1C21E38(&RaceResultPointGroupEffectSubComponent_TypeInfo);
    sub_1C21E38(&StringLiteral_19566/*"event_ranking_group_name_"*/);
    sub_1C21E38(&StringLiteral_19565/*"event_ranking_group_"*/);
    byte_4BDD9CF = 1;
  }
  RaceResultPointGroupEffectSubComponent_TypeInfo->static_fields->GROUP_IMAGE_NAME = (struct System_String_o *)StringLiteral_19565/*"event_ranking_group_"*/;
  sub_1C21DDC(
        ...
        const MethodInfo *method)
{
  ...
  if ( !Instance
    || (Instance = (__int64)DataManager__GetMasterData_object_(
                              ...
                              (const MethodInfo_2FAFE04 *)Method_DataManager_GetMasterData_EventScriptMaster___)) == 0 )
  {
LABEL_109:
    sub_1C22094(Instance, v6);
  }
  Instance = (__int64)EventScriptMaster__getRaceResultEntity_40505148((EventScriptMaster_o *)Instance, 2, v8, 0LL);
  if ( !Instance )
  {
LABEL_85:
    if ( max_length >= 1 )
      ...
      if ( (Instance & 1) != 0 )
      {
        ...
        if ( v24 )
        {
          ...
          if ( (__int64)v20 < (int)v25 )
          {
            ...
            Instance = (__int64)System_String__Concat_63128740(
