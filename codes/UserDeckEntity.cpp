void __fastcall UserDeckEntity___ctor(UserDeckEntity_o *this, const MethodInfo *method)
{
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.name, v6, v2, v3);
...
void __fastcall UserDeckEntity___ctor_38693884(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3294 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_DataEntityBase_long___ctor__, v11);
    sub_1B00CCC(&DeckServant_TypeInfo, v12);
    sub_1B00CCC(&StringLiteral_1/*""*/, v13);
    byte_48E3294 = 1;
  }
  v14 = (int)StringLiteral_1/*""*/;
  this->fields.name = (struct System_String_o *)StringLiteral_1/*""*/;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.name, v14, deckId, deckNo);
  DataEntityBase_long____ctor(
    (DataEntityBase_long__o *)this,
    (const MethodInfo_2FE6894 *)Method_DataEntityBase_long___ctor__);
...
System_Int64_array *__fastcall UserDeckEntity__GetEquipList_38694328(
        UserDeckEntity_o *this,
        int64_t userSvtId,
        const MethodInfo *method)
{
  ...
  deckInfo = this->fields.deckInfo;
  if ( deckInfo )
    return DeckServant__GetEquipList_37648760(deckInfo, userSvtId, 0, 0LL);
  v8 = BalanceConfig_TypeInfo;
  if ( !BalanceConfig_TypeInfo->_2.cctor_finished )
  {
    j_il2cpp_runtime_class_init_0(BalanceConfig_TypeInfo);
...
int32_t __fastcall UserDeckEntity__GetFollowerIndex(UserDeckEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E3298 & 1) == 0 )
  {
    this = (UserDeckEntity_o *)sub_1B00CCC(&BalanceConfig_TypeInfo, method);
    byte_48E3298 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3297 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&UserServantEntity___TypeInfo, v6);
    byte_48E3297 = 1;
  }
  ...
  Instance = sub_1B00D74(UserServantEntity___TypeInfo, (unsigned int)v10->static_fields->DeckMemberMax);
  deckInfo = this->fields.deckInfo;
  if ( !deckInfo )
LABEL_23:
