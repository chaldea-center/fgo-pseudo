void __fastcall UserDeckEntity___ctor(UserDeckEntity_o *this, const MethodInfo *method)
{
  ...
  sub_B52920((BattleServantConfConponent_o *)&this->fields.name, v9, v2, v3, v4, v5, v6, v7);
...
void __fastcall UserDeckEntity___ctor_27427888(
        ...
        const MethodInfo *method)
{
  ...
  v16 = (DeckServant_o *)sub_B52A54(DeckServant_TypeInfo);
  DeckServant___ctor_16909640(v16, DeckMemberMax, userEquipId, 0LL);
...
System_Int64_array *__fastcall UserDeckEntity__GetEquipList_27428360(
        UserDeckEntity_o *this,
        int64_t userSvtId,
        const MethodInfo *method)
{
...
int32_t __fastcall UserDeckEntity__GetFollowerIndex(UserDeckEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B14D4 & 1) == 0 )
  {
    this = (UserDeckEntity_o *)sub_B52984(&BalanceConfig_TypeInfo);
    byte_42B14D4 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  Instance = (DataManager_o *)sub_B5299C(UserServantEntity___TypeInfo, (unsigned int)v6->static_fields->DeckMemberMax);
  deckInfo = this->fields.deckInfo;
  if ( !deckInfo )
LABEL_25:
