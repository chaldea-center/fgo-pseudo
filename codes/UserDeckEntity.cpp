void __fastcall UserDeckEntity___ctor(UserDeckEntity_o *this, const MethodInfo *method)
{
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.name, (int64_t)v9, v2, v3, v4, v5, v6, v7);
...
void __fastcall UserDeckEntity___ctor_41322236(
        ...
        const MethodInfo *method)
{
  ...
  v16 = (DeckServant_o *)sub_1C22084(DeckServant_TypeInfo);
  DeckServant___ctor_40129440(v16, DeckMemberMax, userEquipId, 0LL);
  this->fields.deckInfo = v16;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.deckInfo, (int64_t)v16, v17, v18, v19, v20, v21, v22);
}
...
System_Int64_array *__fastcall UserDeckEntity__GetEquipList_41322680(
        UserDeckEntity_o *this,
        int64_t userSvtId,
        const MethodInfo *method)
{
  ...
  deckInfo = this->fields.deckInfo;
  if ( deckInfo )
    return DeckServant__GetEquipList_40132212(deckInfo, userSvtId, 0, 0LL);
  v7 = BalanceConfig_TypeInfo;
  if ( !BalanceConfig_TypeInfo->_2.cctor_finished )
  {
    j_il2cpp_runtime_class_init_0(BalanceConfig_TypeInfo);
...
int32_t __fastcall UserDeckEntity__GetFollowerIndex(UserDeckEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDD1A1 & 1) == 0 )
  {
    this = (UserDeckEntity_o *)sub_1C21E38(&BalanceConfig_TypeInfo);
    byte_4BDD1A1 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  Instance = sub_1C21EE0(UserServantEntity___TypeInfo, (unsigned int)v6->static_fields->DeckMemberMax);
  deckInfo = this->fields.deckInfo;
  if ( !deckInfo )
LABEL_23:
