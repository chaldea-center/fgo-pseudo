...
LABEL_12:
        ...
        v47 = LocalizationManager__Get((System_String_o *)StringLiteral_11891/*"SERVANT_SORT_TITLE"*/, 0LL);
        if ( titleLabel )
        {
          UILabel__set_text(titleLabel, v47, 0LL);
          title2Label = this->fields.title2Label;
          v49 = LocalizationManager__Get((System_String_o *)StringLiteral_11892/*"SERVANT_SORT_TITLE2"*/, 0LL);
          if ( title2Label )
          {
            UILabel__set_text(title2Label, v49, 0LL);
            explanationLabel = this->fields.explanationLabel;
            v51 = LocalizationManager__Get((System_String_o *)StringLiteral_11764/*"SERVANT_SORT_EXPLANATION"*/, 0LL);
            if ( explanationLabel )
            {
              UILabel__set_text(explanationLabel, v51, 0LL);
              explanationLabel2 = this->fields.explanationLabel2;
              v53 = LocalizationManager__Get((System_String_o *)StringLiteral_11765/*"SERVANT_SORT_EXPLANATION2"*/, 0LL);
              if ( explanationLabel2 )
              {
                UILabel__set_text(explanationLabel2, v53, 0LL);
                decideLabel = this->fields.decideLabel;
                v55 = LocalizationManager__Get((System_String_o *)StringLiteral_11763/*"SERVANT_SORT_DECIDE"*/, 0LL);
                if ( decideLabel )
                {
                  UILabel__set_text(decideLabel, v55, 0LL);
                  cancelLabel = this->fields.cancelLabel;
                  v57 = LocalizationManager__Get((System_String_o *)StringLiteral_11759/*"SERVANT_SORT_CANCEL"*/, 0LL);
                  if ( cancelLabel )
                  {
                    UILabel__set_text(cancelLabel, v57, 0LL);
                    clearLabel = this->fields.clearLabel;
                    v59 = LocalizationManager__Get((System_String_o *)StringLiteral_11760/*"SERVANT_SORT_CLEAR"*/, 0LL);
                    if ( clearLabel )
                    {
                      UILabel__set_text(clearLabel, v59, 0LL);
                      resetLabel = this->fields.resetLabel;
                      v61 = LocalizationManager__Get((System_String_o *)StringLiteral_11890/*"SERVANT_SORT_RESET"*/, 0LL);
                      if ( resetLabel )
                      {
