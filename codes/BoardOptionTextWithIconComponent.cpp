    ...
    if ( data )
    {
      ...
      if ( rightAnchor )
      {
        if ( data->fields._Alignment_k__BackingField == 1 )
        {
          ...
          *((_DWORD *)v14 + 3) = 38;
          sub_1CE66A4((GrandQuestFolderBoardItem_o *)v14, 0, v7, v8, v9, v10, v11, v12);
              ...
              *((_QWORD *)rightAnchor + 2) = v33;
              ...
              if ( v40 )
              {
                ...
                if ( rightAnchor )
                {
                  ...
                  *((_DWORD *)v41 + 3) = -38;
                  sub_1CE66A4((GrandQuestFolderBoardItem_o *)v41, 0, v34, v35, v36, v37, v38, v39);
                  rightAnchor = this->fields.behindLabel;
                  if ( rightAnchor )
                  {
                    UIRect__ResetAnchors((UIRect_o *)rightAnchor, 0);
