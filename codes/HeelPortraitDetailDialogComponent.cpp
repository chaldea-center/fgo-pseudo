        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCBC6D & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_HeelPortraitDetailDialogComponent__Close_b__12_0__, v3);
    byte_4BCBC6D = 1;
  }
  this->fields.state = 4;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCBC6C & 1) == 0 )
  {
    sub_1C1ABD4(&Method_HeelPortraitDetailDialogComponent_OnClickClose__, method);
    byte_4BCBC6C = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_HeelPortraitDetailDialogComponent_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C1ABEC(Method_HeelPortraitDetailDialogComponent_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCBC6B & 1) == 0 )
  {
    sub_1C1ABD4(&System_Action_TypeInfo, heelPortraitEntity);
    sub_1C1ABD4(&AtlasManager_TypeInfo, v7);
    sub_1C1ABD4(&System_Convert_TypeInfo, v8);
    sub_1C1ABD4(&Method_HeelPortraitDetailDialogComponent_EndOpen__, v9);
  ...
  if ( !this->fields.state )
  {
    ...
    if ( heelPortraitEntity )
    {
      ...
      v24 = System_Convert__ToString_63706276(imageId, 0LL);
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
      AtlasManager__SetEventUI_39058000(eventId, heelPortraitSprite, v24, 0LL);
      if ( HeelPortraitEntity__IsSetOverwriteImageId(heelPortraitEntity, 0LL) )
      {
        ...
        if ( !System_Convert_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(System_Convert_TypeInfo);
        v26 = System_Convert__ToString_63706276(OverwriteImageId, 0LL);
        v27 = heelPortraitEntity->fields.eventId;
        v28 = this->fields.heelPortraitSprite;
        v29 = v26;
        if ( !AtlasManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
        AtlasManager__SetEventUI_39058000(v27, v28, v29, 0LL);
      }
    }
