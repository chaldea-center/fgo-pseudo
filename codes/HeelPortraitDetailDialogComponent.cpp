        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B16B89 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_HeelPortraitDetailDialogComponent__Close_b__12_0__, v3);
    byte_4B16B89 = 1;
  }
  this->fields.state = 4;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B16B88 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_HeelPortraitDetailDialogComponent_OnClickClose__, method);
    byte_4B16B88 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_HeelPortraitDetailDialogComponent_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BCB010(Method_HeelPortraitDetailDialogComponent_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B16B87 & 1) == 0 )
  {
    sub_1BCAFF8(&System_Action_TypeInfo, heelPortraitEntity);
    sub_1BCAFF8(&AtlasManager_TypeInfo, v7);
    sub_1BCAFF8(&System_Convert_TypeInfo, v8);
    sub_1BCAFF8(&Method_HeelPortraitDetailDialogComponent_EndOpen__, v9);
  ...
  if ( !this->fields.state )
  {
    ...
    if ( heelPortraitEntity )
    {
      ...
      v18 = System_Convert__ToString_63544936(imageId, 0LL);
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
      AtlasManager__SetEventUI_39794720(eventId, heelPortraitSprite, v18, 0LL);
      if ( HeelPortraitEntity__IsSetOverwriteImageId(heelPortraitEntity, 0LL) )
      {
        ...
        if ( !System_Convert_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(System_Convert_TypeInfo);
        v20 = System_Convert__ToString_63544936(OverwriteImageId, 0LL);
        v21 = heelPortraitEntity->fields.eventId;
        v22 = this->fields.heelPortraitSprite;
        v23 = v20;
        if ( !AtlasManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
        AtlasManager__SetEventUI_39794720(v21, v22, v23, 0LL);
      }
    }
