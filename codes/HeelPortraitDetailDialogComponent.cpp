...
void HeelPortraitDetailDialogComponent__Close(HeelPortraitDetailDialogComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C31F57 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_HeelPortraitDetailDialogComponent__Close_b__12_0__);
    byte_4C31F57 = 1;
  }
  this->fields.state = 4;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C31F56 & 1) == 0 )
  {
    sub_1C32C20(&Method_HeelPortraitDetailDialogComponent_OnClickClose__);
    byte_4C31F56 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_HeelPortraitDetailDialogComponent_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C32C38(Method_HeelPortraitDetailDialogComponent_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C31F55 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_HeelPortraitDetailDialogComponent_EndOpen__);
  ...
  if ( !this->fields.state )
  {
    ...
    sub_1C32BC4(&this->fields.openCallback, openCallback);
    if ( heelPortraitEntity )
    {
      ...
      v12 = System_Convert__ToString_64614452(imageId, 0);
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
      AtlasManager__SetEventUI_40507600(eventId, heelPortraitSprite, v12, 0);
      if ( HeelPortraitEntity__IsSetOverwriteImageId(heelPortraitEntity, 0) )
      {
        ...
        if ( !System_Convert_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(System_Convert_TypeInfo);
        v14 = System_Convert__ToString_64614452(OverwriteImageId, 0);
        v15 = heelPortraitEntity->fields.eventId;
        v16 = this->fields.heelPortraitSprite;
        v17 = v14;
        if ( !AtlasManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
        AtlasManager__SetEventUI_40507600(v15, v16, v17, 0);
      }
    }
