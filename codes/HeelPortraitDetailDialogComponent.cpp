        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B1B77 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_HeelPortraitDetailDialogComponent__Close_b__12_0__);
    byte_42B1B77 = 1;
  }
  this->fields.state = 4;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B1B76 & 1) == 0 )
  {
    sub_B52984(&Method_HeelPortraitDetailDialogComponent_OnClickClose__);
    byte_42B1B76 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_HeelPortraitDetailDialogComponent_OnClickClose__ + 75) & 2) != 0 )
      v3 = (_QWORD *)sub_B5298C(Method_HeelPortraitDetailDialogComponent_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B1B75 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_HeelPortraitDetailDialogComponent_EndOpen__);
  ...
  if ( !this->fields.state )
  {
    ...
    if ( heelPortraitEntity )
    {
      ...
      v21 = System_Convert__ToString_42700204(imageId, 0LL);
      if ( (BYTE3(AtlasManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
        && !AtlasManager_TypeInfo->_2.cctor_finished )
      {
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
      }
      AtlasManager__SetEventUI_28377220(eventId, heelPortraitSprite, v21, 0LL);
      if ( HeelPortraitEntity__IsSetOverwriteImageId(heelPortraitEntity, v22) )
      {
        ...
        v25 = System_Convert__ToString_42700204(OverwriteImageId, 0LL);
        ...
        AtlasManager__SetEventUI_28377220(v26, v27, v28, 0LL);
      }
    }
