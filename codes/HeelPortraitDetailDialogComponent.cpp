        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31E89 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_HeelPortraitDetailDialogComponent__Close_b__12_0__, v3);
    byte_4A31E89 = 1;
  }
  this->fields.state = 4;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31E88 & 1) == 0 )
  {
    sub_1B761C0(&Method_HeelPortraitDetailDialogComponent_OnClickClose__, method);
    byte_4A31E88 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_HeelPortraitDetailDialogComponent_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B761D8(Method_HeelPortraitDetailDialogComponent_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31E87 & 1) == 0 )
  {
    sub_1B761C0(&System_Action_TypeInfo, heelPortraitEntity);
    sub_1B761C0(&AtlasManager_TypeInfo, v7);
    sub_1B761C0(&System_Convert_TypeInfo, v8);
    sub_1B761C0(&Method_HeelPortraitDetailDialogComponent_EndOpen__, v9);
  ...
  if ( !this->fields.state )
  {
    ...
    sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.openCallback, (int32_t)openCallback, v14, v15);
    if ( heelPortraitEntity )
    {
      ...
      v20 = System_Convert__ToString_62200640(imageId, 0LL);
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
      AtlasManager__SetEventUI_37679488(eventId, heelPortraitSprite, v20, 0LL);
      if ( HeelPortraitEntity__IsSetOverwriteImageId(heelPortraitEntity, 0LL) )
      {
        ...
        if ( !System_Convert_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(System_Convert_TypeInfo);
        v22 = System_Convert__ToString_62200640(OverwriteImageId, 0LL);
        v23 = heelPortraitEntity->fields.eventId;
        v24 = this->fields.heelPortraitSprite;
        v25 = v22;
        if ( !AtlasManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
        AtlasManager__SetEventUI_37679488(v23, v24, v25, 0LL);
      }
    }
