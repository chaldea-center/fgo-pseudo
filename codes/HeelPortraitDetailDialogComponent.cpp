...
void HeelPortraitDetailDialogComponent__Close(HeelPortraitDetailDialogComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CE8ACF & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_HeelPortraitDetailDialogComponent__Close_b__12_0__);
    byte_4CE8ACF = 1;
  }
  this->fields.state = 4;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CE8ACE & 1) == 0 )
  {
    sub_1C7BAE8(&Method_HeelPortraitDetailDialogComponent_OnClickClose__);
    byte_4CE8ACE = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_HeelPortraitDetailDialogComponent_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C7BB00(Method_HeelPortraitDetailDialogComponent_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CE8ACD & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_HeelPortraitDetailDialogComponent_EndOpen__);
  ...
  if ( !this->fields.state )
  {
    ...
    sub_1C7BA8C(&this->fields.openCallback, openCallback);
    if ( heelPortraitEntity )
    {
      ...
      v13 = System_Convert__ToString_65270876(imageId, 0);
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
      AtlasManager__SetEventUI_41168628(eventId, heelPortraitSprite, v13, 0);
      if ( HeelPortraitEntity__IsSetOverwriteImageId(heelPortraitEntity, 0) )
      {
        ...
        if ( !System_Convert_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(System_Convert_TypeInfo);
        v15 = System_Convert__ToString_65270876(OverwriteImageId, 0);
        v16 = heelPortraitEntity->fields.eventId;
        v17 = this->fields.heelPortraitSprite;
        v18 = v15;
        if ( !AtlasManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
        AtlasManager__SetEventUI_41168628(v16, v17, v18, 0);
      }
    }
