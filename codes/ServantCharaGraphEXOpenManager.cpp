void ServantCharaGraphEXOpenManager___cctor(const MethodInfo *method)
{
  ...
  ServantCharaGraphEXOpenManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6963/*"Fgo_20210622"*/;
  sub_2213A04(
...
bool ServantCharaGraphEXOpenManager__IsCharaGraphEXOpen(int32_t svtId, int32_t limitCount, const MethodInfo *method)
{
  ...
  if ( (byte_5971D60 & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_System_Collections_Generic_Dictionary_int__List_int___get_Count__);
  ...
  if ( !System_Collections_Generic_Dictionary_int__object___get_Count(
          ...
          (const MethodInfo_3F9C148 *)Method_System_Collections_Generic_Dictionary_int__List_int___get_Count__) )
  {
  ...
  if ( !value )
LABEL_18:
    sub_2213CDC(svtCharaGraphEXOpenDict, *(_QWORD *)&limitCount);
            ...
            do
            {
              ...
              if ( !v20
                || (items = v20->fields._items,
                    ...
                    !items) )
              {
                sub_2213CDC(v22, (unsigned int)v22);
              }
  ...
  if ( !v2->static_fields->UseMock )
  {
    ...
    *(_QWORD *)&v29.fields._version = &v33;
    while ( 1 )
    {
      ...
      if ( monitor >= 1 )
      {
        for ( i = 0; i != monitor; ++i )
        {
          ...
          if ( !v21 )
            sub_2213CDC(Item, (unsigned int)Item);
    ...
    if ( *v31 )
    {
      ...
      {
LABEL_29:
        v27 = sub_224BC3C(*v31, System_IDisposable_TypeInfo, 0);
      }
