void ServantCharaGraphEXOpenManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CC87D0 & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_6674/*"Fgo_20210622"*/);
    byte_4CC87D0 = 1;
  }
  ...
  sub_1C71354(
    ...
    v5,
    v6);
  v7 = (System_Collections_Generic_Dictionary_int__object__o *)sub_1C715FC(System_Collections_Generic_Dictionary_int__List_int___TypeInfo);
...
bool ServantCharaGraphEXOpenManager__IsCharaGraphEXOpen(int32_t svtId, int32_t limitCount, const MethodInfo *method)
{
  ...
  if ( (byte_4CC87CE & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_System_Collections_Generic_Dictionary_int__List_int___get_Count__);
  ...
  if ( !System_Collections_Generic_Dictionary_int__object___get_Count(
          ...
          (const MethodInfo_3461F44 *)Method_System_Collections_Generic_Dictionary_int__List_int___get_Count__) )
  {
  ...
  if ( !value )
LABEL_18:
    sub_1C71608(svtCharaGraphEXOpenDict, *(_QWORD *)&limitCount);
...
bool ServantCharaGraphEXOpenManager__ReadData(const MethodInfo *method)
{
  ...
  if ( (byte_4CC87CC & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_System_Collections_Generic_Dictionary_int__List_int___Add__);
  ...
  if ( System_IO_File__Exists(SaveFileName, 0) )
  {
        ...
        for ( i = 0; i != v12; ++i )
        {
          ...
          if ( v15 >= 1 )
          {
            do
            {
              ...
              if ( !v16 )
                sub_1C71608(v18, (unsigned int)v18);
          ...
          System_Collections_Generic_Dictionary_int__object___Add(
            ...
            v14,
            (Il2CppObject *)v16,
            (const MethodInfo_3462294 *)Method_System_Collections_Generic_Dictionary_int__List_int___Add__);
        }
      }
      v2 = 1;
    }
    ...
    {
LABEL_35:
      v27 = sub_1C47738(v7, System_IDisposable_TypeInfo, 0);
    }
...
bool ServantCharaGraphEXOpenManager__WriteData(const MethodInfo *method)
{
  ...
  if ( (byte_4CC87CD & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_System_Collections_Generic_Dictionary_int__List_int___GetEnumerator__);
    sub_1C713B0(&Method_System_Collections_Generic_Dictionary_int__List_int___get_Count__);
    sub_1C713B0(&Method_System_Collections_Generic_Dictionary_Enumerator_int__List_int___Dispose__);
    sub_1C713B0(&Method_System_Collections_Generic_Dictionary_Enumerator_int__List_int___MoveNext__);
    sub_1C713B0(&Method_System_Collections_Generic_Dictionary_Enumerator_int__List_int___get_Current__);
    sub_1C713B0(&System_IDisposable_TypeInfo);
    sub_1C713B0(&Method_System_Collections_Generic_KeyValuePair_int__List_int___get_Key__);
    sub_1C713B0(&Method_System_Collections_Generic_KeyValuePair_int__List_int___get_Value__);
  ...
  if ( !v1->static_fields->UseMock )
  {
    ...
    v5 = (System_IO_BinaryWriter_o *)sub_1C715FC(System_IO_BinaryWriter_TypeInfo);
    System_IO_BinaryWriter___ctor_64941052(v5, v4, 0);
    v7 = ServantCharaGraphEXOpenManager_TypeInfo;
    if ( !ServantCharaGraphEXOpenManager_TypeInfo->_2.cctor_finished )
    {
      j_il2cpp_runtime_class_init_0(ServantCharaGraphEXOpenManager_TypeInfo);
    ...
    System_Collections_Generic_Dictionary_int__object___GetEnumerator(
      ...
      (const MethodInfo_34626CC *)Method_System_Collections_Generic_Dictionary_int__List_int___GetEnumerator__);
    v26 = v25;
    while ( 1 )
    {
      v14 = System_Collections_Generic_Dictionary_Enumerator_int__object___MoveNext(
              &v26,
              (const MethodInfo_35BA0B4 *)Method_System_Collections_Generic_Dictionary_Enumerator_int__List_int___MoveNext__);
      if ( !v14 )
        break;
    ...
    System_Collections_Generic_Dictionary_Enumerator_int__object___Dispose(
      &v26,
      (const MethodInfo_35BA1D8 *)Method_System_Collections_Generic_Dictionary_Enumerator_int__List_int___Dispose__);
    klass = v5->klass;
    ...
    {
LABEL_24:
      v23 = sub_1C47738(v5, System_IDisposable_TypeInfo, 0);
    }
