void __fastcall ServantCharaGraphEXOpenManager___cctor(const MethodInfo *method)
{
  ...
  ServantCharaGraphEXOpenManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6644/*"Fgo_20210622"*/;
  sub_1B88554(
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&static_fields->svtCharaGraphEXOpenDict, (int32_t)v3, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5C2F7 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_System_Collections_Generic_Dictionary_int__List_int___get_Count__);
  ...
  if ( !System_Collections_Generic_Dictionary_int__object___get_Count(
          ...
          (const MethodInfo_316D608 *)Method_System_Collections_Generic_Dictionary_int__List_int___get_Count__) )
  {
  ...
  if ( !value )
LABEL_18:
    sub_1B8880C(svtCharaGraphEXOpenDict, *(_QWORD *)&limitCount);
...
bool __fastcall ServantCharaGraphEXOpenManager__ReadData(const MethodInfo *method)
{
  ...
  if ( System_IO_File__Exists(SaveFileName, 0LL) )
  {
        ...
        for ( i = 0; i != v12; ++i )
        {
          ...
          if ( v15 >= 1 )
          {
            do
            {
              ...
              if ( !v16 )
                sub_1B8880C(v18, (unsigned int)v18);
    ...
    {
LABEL_35:
      v27 = sub_1BDA590(v7, System_IDisposable_TypeInfo, 0LL);
    }
...
bool __fastcall ServantCharaGraphEXOpenManager__WriteData(const MethodInfo *method)
{
  ...
  if ( !v1->static_fields->UseMock )
  {
    ...
    {
LABEL_24:
      v23 = sub_1BDA590(v5, System_IDisposable_TypeInfo, 0LL);
    }
