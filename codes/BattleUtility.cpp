bool __fastcall BattleUtility__Above(System_Int32_array *condArray, int32_t value, const MethodInfo *method)
{
  if ( (byte_4BDEEAB & 1) == 0 )
  {
    sub_1C21E38(&Method_System_Linq_Enumerable_First_int___);
    byte_4BDEEAB = 1;
  }
  return !BasicHelper__IsNullOrEmpty((System_Collections_ICollection_o *)condArray, 0LL)
      && System_Linq_Enumerable__First_int_(
           ...
           (const MethodInfo_2FD0434 *)Method_System_Linq_Enumerable_First_int___) <= value;
}
...
int32_t __fastcall BattleUtility__Abs_44373092(int32_t value, const MethodInfo *method)
{
  if ( (byte_4BDEEAA & 1) == 0 )
  {
    sub_1C21E38(&System_Math_TypeInfo);
...
bool __fastcall BattleUtility__Between(System_Int32_array *condArray, int32_t value, const MethodInfo *method)
{
  ...
  {
    sub_1C21E38(&Method_System_Linq_Enumerable_First_int___);
    sub_1C21E38(&Method_System_Linq_Enumerable_Last_int___);
    byte_4BDEEAD = 1;
  }
  ...
  return condArray->max_length == 2
      ...
      && System_Linq_Enumerable__Last_int_(
           (System_Collections_Generic_IEnumerable_TSource__o *)condArray,
           (const MethodInfo_2FD45EC *)Method_System_Linq_Enumerable_Last_int___) >= value;
}
...
int32_t __fastcall BattleUtility__FloorToInt_44372884(double d, const MethodInfo *method)
{
  int32_t v3; // w9
...
float __fastcall BattleUtility__Lerp(float a, float b, float t, const MethodInfo *method)
{
  ...
  if ( !System_Math_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
  v7 = System_Math__Max_63934660(0.0, t, 0LL);
  return (float)((float)(b - a) * System_Math__Min_63934988(v7, 1.0, 0LL)) + a;
}
...
double __fastcall BattleUtility__LerpDouble(double a, double b, float t, const MethodInfo *method)
{
  ...
  if ( !System_Math_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
  v7 = System_Math__Max_63934660(0.0, t, 0LL);
  return (b - a) * System_Math__Min_63934988(v7, 1.0, 0LL) + a;
}