...
int32_t __fastcall BattleUtility__Abs_42678648(int32_t value, const MethodInfo *method)
{
  if ( (byte_4A012FB & 1) == 0 )
  {
...
int32_t __fastcall BattleUtility__FloorToInt_42678440(double d, const MethodInfo *method)
{
  __int64 v2; // x1
  int32_t v4; // w9
...
float __fastcall BattleUtility__Lerp(float a, float b, float t, const MethodInfo *method)
{
  ...
  if ( !System_Math_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
  v8 = System_Math__Max_62203816(0.0, t, 0LL);
  return (float)((float)(b - a) * System_Math__Min_62204144(v8, 1.0, 0LL)) + a;
}
...
double __fastcall BattleUtility__LerpDouble(double a, double b, float t, const MethodInfo *method)
{
  ...
  if ( !System_Math_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
  v8 = System_Math__Max_62203816(0.0, t, 0LL);
  return (b - a) * System_Math__Min_62204144(v8, 1.0, 0LL) + a;
}