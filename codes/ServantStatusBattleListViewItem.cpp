        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC397D & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataManager_GetMasterData_ServantCostumeMaster___, *(_QWORD *)&index);
  ...
  if ( dispLimitCount >= 11 )
  {
    ...
    if ( !Instance
      || (Instance = DataManager__GetMasterData_object_(
                       ...
                       (const MethodInfo_2F9F490 *)Method_DataManager_GetMasterData_ServantCostumeMaster___)) == 0LL )
    {
    ...
    sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.name, (int64_t)ShortName, v24, v25, v26, v27, v28, v29);
  }
}
