        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A048DD & 1) == 0 )
  {
    sub_1B686D4(&Method_DataManager_GetMasterData_ServantCostumeMaster___, *(_QWORD *)&index);
  ...
  if ( dispLimitCount >= 11 )
  {
    ...
    if ( !Instance
      || (Instance = DataManager__GetMasterData_object_(
                       ...
                       (const MethodInfo_2E49D50 *)Method_DataManager_GetMasterData_ServantCostumeMaster___)) == 0LL )
    {
