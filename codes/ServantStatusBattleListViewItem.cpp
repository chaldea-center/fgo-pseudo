        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA1CE & 1) == 0 )
  {
    sub_1B64870(&Method_DataManager_GetMasterData_ServantCostumeMaster___, *(_QWORD *)&index);
  ...
  if ( dispLimitCount >= 11 )
  {
    ...
    if ( !Instance
      || (Instance = DataManager__GetMasterData_object_(
                       ...
                       (const MethodInfo_2E3B6C8 *)Method_DataManager_GetMasterData_ServantCostumeMaster___)) == 0LL )
    {
