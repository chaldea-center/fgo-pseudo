  ...
  if ( dispLimitCount >= 11 )
  {
    ...
    if ( !Instance
      || (Instance = DataManager__GetMasterData_object_(
                       ...
                       (const MethodInfo_2FAFE04 *)Method_DataManager_GetMasterData_ServantCostumeMaster___)) == 0LL )
    {
    ...
    sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.name, (int64_t)ShortName, v20, v21, v22, v23, v24, v25);
  }
}
