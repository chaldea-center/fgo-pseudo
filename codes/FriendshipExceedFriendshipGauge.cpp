...
{
  this->fields.DISABLE_COLOR = (struct UnityEngine_Color_o)xmmword_BB4640;
  this->fields.EXCEEDED_COLOR = (struct UnityEngine_Color_o)xmmword_BB5160;
        ...
        const MethodInfo *method)
{
  ...
  if ( !this->fields.isInitUISpriteAtlas )
  {
    ...
    AtlasManager__SetBondAtlasImage(exceededIconUISprite, (System_String_o *)StringLiteral_20271/*"img_bondsgage_11"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( !normalRoot
    || (normalRoot = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                   normalRoot,
                                                   (const MethodInfo_2ECEEB8 *)Method_UnityEngine_GameObject_GetComponent_UIGrid___)) == 0LL )
  {
LABEL_12:
    sub_1B8880C(normalRoot, v12);
  }
