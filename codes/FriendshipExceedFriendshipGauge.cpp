...
{
  this->fields.DISABLE_COLOR = (struct UnityEngine_Color_o)xmmword_C06220;
  this->fields.EXCEEDED_COLOR = (struct UnityEngine_Color_o)xmmword_C06CF0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C011B1 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&StringLiteral_20642/*"img_bondsgage_11"*/, v3);
    byte_4C011B1 = 1;
  }
  if ( !this->fields.isInitUISpriteAtlas )
  {
    ...
    AtlasManager__SetBondAtlasImage(exceededIconUISprite, (System_String_o *)StringLiteral_20642/*"img_bondsgage_11"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C011B0 & 1) == 0 )
  {
    sub_1C2E12C(&Method_UnityEngine_GameObject_GetComponent_UIGrid___, *(_QWORD *)&level);
    byte_4C011B0 = 1;
  }
  ...
  if ( !normalRoot
    || (normalRoot = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                   normalRoot,
                                                   (const MethodInfo_3022B0C *)Method_UnityEngine_GameObject_GetComponent_UIGrid___)) == 0LL )
  {
LABEL_12:
    sub_1C2E388(normalRoot, v12);
  }
