...
{
  this->fields.DISABLE_COLOR = (struct UnityEngine_Color_o)xmmword_BD7C50;
  this->fields.EXCEEDED_COLOR = (struct UnityEngine_Color_o)xmmword_BD8760;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3AAA2 & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_20516/*"img_bondsgage_11"*/, v3);
    byte_4B3AAA2 = 1;
  }
  if ( !this->fields.isInitUISpriteAtlas )
  {
    ...
    AtlasManager__SetBondAtlasImage(exceededIconUISprite, (System_String_o *)StringLiteral_20516/*"img_bondsgage_11"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3AAA1 & 1) == 0 )
  {
    sub_1BD3458(&Method_UnityEngine_GameObject_GetComponent_UIGrid___, *(_QWORD *)&level);
    byte_4B3AAA1 = 1;
  }
  ...
  if ( !normalRoot
    || (normalRoot = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                   normalRoot,
                                                   (const MethodInfo_2F81A7C *)Method_UnityEngine_GameObject_GetComponent_UIGrid___)) == 0LL )
  {
LABEL_12:
    sub_1BD36B4(normalRoot, v12);
  }
