        ...
        const MethodInfo *method)
{
  ...
  this->fields.EXCEEDED_COLOR = (struct UnityEngine_Color_o)xmmword_BD3330;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B19ABB & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&StringLiteral_20486/*"img_bondsgage_11"*/, v4, v5);
    byte_4B19ABB = 1;
  }
  if ( !this->fields.isInitUISpriteAtlas )
  {
    ...
    AtlasManager__SetBondAtlasImage(exceededIconUISprite, (System_String_o *)StringLiteral_20486/*"img_bondsgage_11"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B19ABA & 1) == 0 )
  {
    sub_1BCA7E0(&Method_UnityEngine_GameObject_GetComponent_UIGrid___, *(_QWORD *)&level, *(_QWORD *)&max);
    byte_4B19ABA = 1;
  }
  ...
  if ( !normalRoot
    || (normalRoot = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                   normalRoot,
                                                   (const MethodInfo_2F626D0 *)Method_UnityEngine_GameObject_GetComponent_UIGrid___)) == 0LL )
  {
LABEL_12:
    sub_1BCAA3C(normalRoot, v12);
  }
