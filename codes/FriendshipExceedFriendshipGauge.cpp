...
{
  this->fields.DISABLE_COLOR = (struct UnityEngine_Color_o)xmmword_BF65C0;
  this->fields.EXCEEDED_COLOR = (struct UnityEngine_Color_o)xmmword_BF70C0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB805C & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_20602/*"img_bg_mp"*/, v3);
    byte_4BB805C = 1;
  }
  if ( !this->fields.isInitUISpriteAtlas )
  {
    ...
    AtlasManager__SetBondAtlasImage(exceededIconUISprite, (System_String_o *)StringLiteral_20602/*"img_bg_mp"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB805B & 1) == 0 )
  {
    sub_1C13D24(&Method_UnityEngine_GameObject_GetComponent_UIGrid___, *(_QWORD *)&level);
    byte_4BB805B = 1;
  }
  ...
  if ( !normalRoot
    || (normalRoot = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                   normalRoot,
                                                   (const MethodInfo_2FDF9FC *)Method_UnityEngine_GameObject_GetComponent_UIGrid___)) == 0LL )
  {
LABEL_12:
    sub_1C13F80(normalRoot, v12);
  }
