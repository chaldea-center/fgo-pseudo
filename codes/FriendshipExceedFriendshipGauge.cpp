...
{
  this->fields.DISABLE_COLOR = (struct UnityEngine_Color_o)xmmword_BE1DA0;
  this->fields.EXCEEDED_COLOR = (struct UnityEngine_Color_o)xmmword_BE28A0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A53A & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_20556/*"img_bondsgage_11"*/, v3);
    byte_4B6A53A = 1;
  }
  if ( !this->fields.isInitUISpriteAtlas )
  {
    ...
    AtlasManager__SetBondAtlasImage(exceededIconUISprite, (System_String_o *)StringLiteral_20556/*"img_bondsgage_11"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A539 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_UnityEngine_GameObject_GetComponent_UIGrid___, *(_QWORD *)&level);
    byte_4B6A539 = 1;
  }
  ...
  if ( !normalRoot
    || (normalRoot = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                   normalRoot,
                                                   (const MethodInfo_2FA979C *)Method_UnityEngine_GameObject_GetComponent_UIGrid___)) == 0LL )
  {
LABEL_12:
    sub_1BE4D28(normalRoot, v12);
  }
