...
{
  this->fields.DISABLE_COLOR = (struct UnityEngine_Color_o)xmmword_B70A20;
  this->fields.EXCEEDED_COLOR = (struct UnityEngine_Color_o)xmmword_B71540;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E5E69 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_19997/*"img_bondsgage_11"*/, v3);
    byte_48E5E69 = 1;
  }
  if ( !this->fields.isInitUISpriteAtlas )
  {
    ...
    AtlasManager__SetBondAtlasImage(exceededIconUISprite, (System_String_o *)StringLiteral_19997/*"img_bondsgage_11"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E5E68 & 1) == 0 )
  {
    sub_1B00CCC(&Method_UnityEngine_GameObject_GetComponent_UIGrid___, *(_QWORD *)&level);
    byte_48E5E68 = 1;
  }
  ...
  if ( !normalRoot
    || (normalRoot = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                   normalRoot,
                                                   (const MethodInfo_2DADE08 *)Method_UnityEngine_GameObject_GetComponent_UIGrid___)) == 0LL )
  {
LABEL_12:
    sub_1B00F28(normalRoot, v12);
  }
