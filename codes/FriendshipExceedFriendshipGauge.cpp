...
{
  this->fields.DISABLE_COLOR = (struct UnityEngine_Color_o)xmmword_BE2030;
  this->fields.EXCEEDED_COLOR = (struct UnityEngine_Color_o)xmmword_BE2B60;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B202D6 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_UnityEngine_GameObject_GetComponent_UIFont___, path);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B202D5 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_20159/*"img_bondsgage_11"*/, v3);
    byte_4B202D5 = 1;
  }
  if ( !this->fields.isInitUISpriteAtlas )
  {
    ...
    AtlasManager__SetBondAtlasImage(exceededIconUISprite, (System_String_o *)StringLiteral_20159/*"img_bondsgage_11"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B202D3 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_UnityEngine_GameObject_GetComponent_UIGrid___, *(_QWORD *)&level);
    byte_4B202D3 = 1;
  }
  ...
  if ( !normalRoot
    || (normalRoot = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                   normalRoot,
                                                   (const MethodInfo_306E710 *)Method_UnityEngine_GameObject_GetComponent_UIGrid___)) == 0LL )
  {
LABEL_12:
    sub_1BCB254(normalRoot, v14);
  }
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      if ( v11 >= (unsigned int)max_length )
        sub_1BCB25C(this, sliderList, *(_QWORD *)&level);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B202D4 & 1) == 0 )
  {
    sub_1BCAFF8(&UnityEngine_Object_TypeInfo, *(_QWORD *)&level);
    this = (FriendshipExceedFriendshipGauge_o *)sub_1BCAFF8(&StringLiteral_6752/*"Fonts/FGO-NumberFont-02"*/, v9);
    byte_4B202D4 = 1;
  }
  if ( isSpecialEffect )
  {
