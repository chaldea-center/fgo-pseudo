        ...
        const MethodInfo *method)
{
  ...
  this->fields.EXCEEDED_COLOR = (struct UnityEngine_Color_o)xmmword_BA6E00;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0C3FC & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_20201/*"img_bondsgage_11"*/, v3);
    byte_4A0C3FC = 1;
  }
  if ( !this->fields.isInitUISpriteAtlas )
  {
    ...
    AtlasManager__SetBondAtlasImage(exceededIconUISprite, (System_String_o *)StringLiteral_20201/*"img_bondsgage_11"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0C3FB & 1) == 0 )
  {
    sub_1B686D4(&Method_UnityEngine_GameObject_GetComponent_UIGrid___, *(_QWORD *)&level);
    byte_4A0C3FB = 1;
  }
  ...
  if ( !normalRoot
    || (normalRoot = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                   normalRoot,
                                                   (const MethodInfo_2E98950 *)Method_UnityEngine_GameObject_GetComponent_UIGrid___)) == 0LL )
  {
LABEL_12:
    sub_1B68930(normalRoot, v12);
  }
