void FriendshipExceedFriendshipGauge___ctor(FriendshipExceedFriendshipGauge_o *this, const MethodInfo *method)
{
  ...
  this->fields.EXCEEDED_COLOR = (struct UnityEngine_Color_o)xmmword_D01640;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D34A88 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_20568/*"img_bondsgage_11"*/);
    byte_4D34A88 = 1;
  }
  if ( !this->fields.isInitUISpriteAtlas )
  {
    ...
    AtlasManager__SetBondAtlasImage(exceededIconUISprite, (System_String_o *)StringLiteral_20568/*"img_bondsgage_11"*/, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( !normalRoot
    || (normalRoot = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                   normalRoot,
                                                   (const MethodInfo_31FC084 *)Method_UnityEngine_GameObject_GetComponent_UIGrid___)) == 0 )
  {
LABEL_12:
    sub_1C93D2C(normalRoot, v12);
  }
