...
{
  this->fields.DISABLE_COLOR = (struct UnityEngine_Color_o)xmmword_C09690;
  this->fields.EXCEEDED_COLOR = (struct UnityEngine_Color_o)xmmword_C0A210;
        ...
        const MethodInfo *method)
{
  ...
  if ( !this->fields.isInitUISpriteAtlas )
  {
    ...
    AtlasManager__SetBondAtlasImage(exceededIconUISprite, (System_String_o *)StringLiteral_20326/*"img_bondsgage_11"*/, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( !normalRoot
    || (normalRoot = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                   normalRoot,
                                                   (const MethodInfo_3125ED0 *)Method_UnityEngine_GameObject_GetComponent_UIGrid___)) == 0 )
  {
LABEL_12:
    sub_1C2D6EC(normalRoot, v12);
  }
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      if ( v11 >= (unsigned int)max_length )
        sub_1C2D6F4(this, sliderList, *(_QWORD *)&level);
