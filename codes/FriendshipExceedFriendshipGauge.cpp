...
{
  this->fields.DISABLE_COLOR = (struct UnityEngine_Color_o)xmmword_C12050;
  this->fields.EXCEEDED_COLOR = (struct UnityEngine_Color_o)xmmword_C12BE0;
        ...
        const MethodInfo *method)
{
  ...
  if ( !this->fields.isInitUISpriteAtlas )
  {
    ...
    AtlasManager__SetBondAtlasImage(exceededIconUISprite, (System_String_o *)StringLiteral_20359/*"img_bondsgage_11"*/, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( !normalRoot
    || (normalRoot = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                   normalRoot,
                                                   (const MethodInfo_31510CC *)Method_UnityEngine_GameObject_GetComponent_UIGrid___)) == 0 )
  {
LABEL_12:
    sub_1C3E7C0(normalRoot, v12);
  }
