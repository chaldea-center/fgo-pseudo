void QuestUseItemInfo___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C2308B & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_6874/*"FriendshipUpItemUseState"*/);
    sub_1C2D490(&StringLiteral_25172/*"{0}_icon"*/);
    sub_1C2D490(&StringLiteral_6872/*"FriendshipUpItemEventUseState"*/);
    byte_4C2308B = 1;
  }
  QuestUseItemInfo_TypeInfo->static_fields->SAVE_KEY_FRIENDSHIP_ITEM_USE_STATE = (struct System_String_o *)StringLiteral_6874/*"FriendshipUpItemUseState"*/;
  sub_1C2D434((CGThumbnailListItem_o *)QuestUseItemInfo_TypeInfo->static_fields, StringLiteral_6874/*"FriendshipUpItemUseState"*/, v1, v2);
  v3 = StringLiteral_6872/*"FriendshipUpItemEventUseState"*/;
  static_fields = QuestUseItemInfo_TypeInfo->static_fields;
  static_fields->SAVE_KEY_FRIENDSHIP_EVENT_ITEM_USE_STATE = (struct System_String_o *)StringLiteral_6872/*"FriendshipUpItemEventUseState"*/;
  sub_1C2D434((CGThumbnailListItem_o *)&static_fields->SAVE_KEY_FRIENDSHIP_EVENT_ITEM_USE_STATE, v3, v5, v6);
  v7 = StringLiteral_25172/*"{0}_icon"*/;
  v8 = QuestUseItemInfo_TypeInfo->static_fields;
  v8->ITEM_ICON_SUFFIX = (struct System_String_o *)StringLiteral_25172/*"{0}_icon"*/;
  sub_1C2D434((CGThumbnailListItem_o *)&v8->ITEM_ICON_SUFFIX, v7, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C23086 & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_10246/*"PARTY_ORGANIZATION_FRIENDSHIP_UP_ITEM_SELECT_DIALOG_VALUE"*/);
    sub_1C2D490(&StringLiteral_10908/*"QUEST_USE_ITEM_SELECT_DIALOG_REWARD_ADD_ITEM_EXPLANATION"*/);
    byte_4C23086 = 1;
  }
  outEndedAt = 0;
  countText = 0;
  ...
  if ( this->fields._CampaignType_k__BackingField != 36 )
  {
    ...
    v22 = LocalizationManager__Get((System_String_o *)StringLiteral_10246/*"PARTY_ORGANIZATION_FRIENDSHIP_UP_ITEM_SELECT_DIALOG_VALUE"*/, 0);
    v31 = (float)this->fields._Value_k__BackingField / 1000.0;
    v26 = (Il2CppObject *)j_il2cpp_value_box_0(float_TypeInfo, &v31, v23, v24, v25);
    v27 = System_String__Format(v22, v26, 0);
    v20 = (int)v27;
    this->fields._Explanation_k__BackingField = v27;
    goto LABEL_19;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  IsNullOrEmpty = DataManager__GetMaster_object_((const MethodInfo_30CE8FC *)Method_DataManager_GetMaster_GiftMaster___);
  if ( !IsNullOrEmpty
...
LABEL_28:
  ...
  if ( *((int *)IsNullOrEmpty + 6) >= 1 )
  {
    ...
    if ( ((unsigned __int8)IsNullOrEmpty & 1) != 0 )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v16 = LocalizationManager__Get((System_String_o *)StringLiteral_10908/*"QUEST_USE_ITEM_SELECT_DIALOG_REWARD_ADD_ITEM_EXPLANATION"*/, 0);
      v17 = System_String__Format(v16, (Il2CppObject *)nameText, 0);
      v20 = (int)v17;
      p_Explanation_k__BackingField->klass = (CGThumbnailListItem_c *)v17;
LABEL_19:
      sub_1C2D434(p_Explanation_k__BackingField, v20, v18, v19);
    }
  }
LABEL_20:
  ...
  if ( CampaignType_k__BackingField == 30 )
  {
    ...
    if ( v30->static_fields->DefaultQuestUseFriendshipUpItemGroupId == this->fields._GroupId_k__BackingField )
...
void QuestUseItemInfo___ctor_34488768(
        QuestUseItemInfo_o *this,
...
void QuestUseItemInfo__OpenExpiredDialog(QuestUseItemInfo_o *this, System_Action_o *action, const MethodInfo *method)
{
  ...
  if ( (byte_4C23089 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_CommonUI_CloseNotificationDialog__);
    sub_1C2D490(&LocalizationManager_TypeInfo);
  ...
  if ( !v9 || (System_Action_c *)v9->klass == System_Action_TypeInfo )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v12 = LocalizationManager__Get((System_String_o *)StringLiteral_10238/*"PARTY_ORGANIZATION_FRIENDSHIP_UP_ITEM_EXPIRED"*/, 0);
...
LABEL_10:
  ...
  v13 = (QuestUseItemInfo_o *)sub_1C2D9AC(v9);
...
void QuestUseItemInfo__SetItemEntity(QuestUseItemInfo_o *this, ItemEntity_o *itemEntity, const MethodInfo *method)
{
  ...
  if ( (byte_4C23087 & 1) == 0 )
  {
    sub_1C2D490(&Method_DataManager_GetMaster_QuestUseItemGroupMaster___);
    sub_1C2D490(&Method_DataManager_GetMaster_QuestUseItemPickupMaster___);
    sub_1C2D490(&DataManager_TypeInfo);
    sub_1C2D490(&Method_DataMasterBase_QuestUseItemGroupMaster__QuestUseItemGroupEntity__int__TryGetEntity__);
    sub_1C2D490(&int_TypeInfo);
    this = (QuestUseItemInfo_o *)sub_1C2D490(&QuestUseItemInfo_TypeInfo);
    byte_4C23087 = 1;
  }
  entity = 0;
  if ( !itemEntity )
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  this = (QuestUseItemInfo_o *)DataManager__GetMaster_object_((const MethodInfo_30CE8FC *)Method_DataManager_GetMaster_QuestUseItemGroupMaster___);
  if ( !this )
LABEL_17:
    sub_1C2D6EC(this, itemEntity);
  this = (QuestUseItemInfo_o *)DataMasterBase_object__object__int___TryGetEntity(
                                 (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                 &entity,
                                 v4->fields._GroupId_k__BackingField,
                                 (const MethodInfo_3387DE4 *)Method_DataMasterBase_QuestUseItemGroupMaster__QuestUseItemGroupEntity__int__TryGetEntity__);
...
LABEL_11:
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  this = (QuestUseItemInfo_o *)DataManager__GetMaster_object_((const MethodInfo_30CE8FC *)Method_DataManager_GetMaster_QuestUseItemPickupMaster___);
  if ( !this )
    goto LABEL_17;
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&v4->fields._Name_k__BackingField, (int32_t)name, v7, v8);
  EffectExplanation = ItemEntity__GetEffectExplanation(itemEntity, 0);
  v4->fields._Explanation_k__BackingField = EffectExplanation;
  sub_1C2D434((CGThumbnailListItem_o *)&v4->fields._Explanation_k__BackingField, (int32_t)EffectExplanation, v10, v11);
  v15 = QuestUseItemInfo_TypeInfo;
  ...
  ITEM_ICON_SUFFIX = v15->static_fields->ITEM_ICON_SUFFIX;
  v22 = imageId;
  v18 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v22, v12, v13, v14);
  v19 = System_String__Format(ITEM_ICON_SUFFIX, v18, 0);
  v4->fields._SpriteName_k__BackingField = v19;
  sub_1C2D434((CGThumbnailListItem_o *)&v4->fields._SpriteName_k__BackingField, (int32_t)v19, v20, v21);
}
...
void QuestUseItemInfo__set_Explanation(QuestUseItemInfo_o *this, System_String_o *value, const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields._Explanation_k__BackingField, (int32_t)value, (int32_t)method, v3);
}
