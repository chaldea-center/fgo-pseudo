void QuestUseItemInfo___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CEA2B5 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_6891/*"FriendshipUpItemUseState"*/);
    sub_1C7BAE8(&StringLiteral_25451/*"{0}_icon"*/);
    sub_1C7BAE8(&StringLiteral_6889/*"FriendshipUpItemEventUseState"*/);
    byte_4CEA2B5 = 1;
  }
  QuestUseItemInfo_TypeInfo->static_fields->SAVE_KEY_FRIENDSHIP_ITEM_USE_STATE = (struct System_String_o *)StringLiteral_6891/*"FriendshipUpItemUseState"*/;
  sub_1C7BA8C(
    (GrandQuestFolderBoardItem_o *)QuestUseItemInfo_TypeInfo->static_fields,
    StringLiteral_6891/*"FriendshipUpItemUseState"*/,
    v1,
    v2,
    v3,
    v4,
    v5,
    v6);
  v7 = StringLiteral_6889/*"FriendshipUpItemEventUseState"*/;
  static_fields = QuestUseItemInfo_TypeInfo->static_fields;
  static_fields->SAVE_KEY_FRIENDSHIP_EVENT_ITEM_USE_STATE = (struct System_String_o *)StringLiteral_6889/*"FriendshipUpItemEventUseState"*/;
  sub_1C7BA8C(
    ...
    v13,
    v14);
  v15 = StringLiteral_25451/*"{0}_icon"*/;
  v16 = QuestUseItemInfo_TypeInfo->static_fields;
  v16->ITEM_ICON_SUFFIX = (struct System_String_o *)StringLiteral_25451/*"{0}_icon"*/;
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&v16->ITEM_ICON_SUFFIX, v15, v17, v18, v19, v20, v21, v22);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEA2B0 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_10283/*"PARTY_ORGANIZATION_FRIENDSHIP_UP_ITEM_SELECT_DIALOG_VALUE"*/);
    sub_1C7BAE8(&StringLiteral_10957/*"QUEST_USE_ITEM_SELECT_DIALOG_REWARD_ADD_ITEM_EXPLANATION"*/);
    byte_4CEA2B0 = 1;
  }
  outEndedAt = 0;
  countText = 0;
  ...
  if ( this->fields._CampaignType_k__BackingField != 36 )
  {
    ...
    v26 = LocalizationManager__Get((System_String_o *)StringLiteral_10283/*"PARTY_ORGANIZATION_FRIENDSHIP_UP_ITEM_SELECT_DIALOG_VALUE"*/, 0);
  ...
  IsNullOrEmpty = DataManager__GetMaster_object_((const MethodInfo_31703A0 *)Method_DataManager_GetMaster_GiftMaster___);
  if ( !IsNullOrEmpty
...
LABEL_28:
  ...
  if ( *((int *)IsNullOrEmpty + 6) >= 1 )
  {
    ...
    if ( ((unsigned __int8)IsNullOrEmpty & 1) != 0 )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v16 = LocalizationManager__Get((System_String_o *)StringLiteral_10957/*"QUEST_USE_ITEM_SELECT_DIALOG_REWARD_ADD_ITEM_EXPLANATION"*/, 0);
      v17 = System_String__Format(v16, (Il2CppObject *)nameText, 0);
      v24 = (int)v17;
      p_Explanation_k__BackingField->klass = (GrandQuestFolderBoardItem_c *)v17;
LABEL_19:
      sub_1C7BA8C(p_Explanation_k__BackingField, v24, v18, v19, v20, v21, v22, v23);
    }
  }
LABEL_20:
...
void QuestUseItemInfo___ctor_35094424(
        QuestUseItemInfo_o *this,
...
void QuestUseItemInfo__OpenExpiredDialog(QuestUseItemInfo_o *this, System_Action_o *action, const MethodInfo *method)
{
  ...
  if ( (byte_4CEA2B3 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_CommonUI_CloseNotificationDialog__);
    sub_1C7BAE8(&LocalizationManager_TypeInfo);
  ...
  if ( !v9 || (System_Action_c *)v9->klass == System_Action_TypeInfo )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v12 = LocalizationManager__Get((System_String_o *)StringLiteral_10275/*"PARTY_ORGANIZATION_FRIENDSHIP_UP_ITEM_EXPIRED"*/, 0);
...
LABEL_10:
  ...
  v13 = (QuestUseItemInfo_o *)sub_1C7C0DC(v9);
...
void QuestUseItemInfo__SetItemEntity(QuestUseItemInfo_o *this, ItemEntity_o *itemEntity, const MethodInfo *method)
{
  ...
  if ( (byte_4CEA2B1 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_DataManager_GetMaster_QuestUseItemGroupMaster___);
    sub_1C7BAE8(&Method_DataManager_GetMaster_QuestUseItemPickupMaster___);
    sub_1C7BAE8(&DataManager_TypeInfo);
    sub_1C7BAE8(&Method_DataMasterBase_QuestUseItemGroupMaster__QuestUseItemGroupEntity__int__TryGetEntity__);
    sub_1C7BAE8(&int_TypeInfo);
    this = (QuestUseItemInfo_o *)sub_1C7BAE8(&QuestUseItemInfo_TypeInfo);
    byte_4CEA2B1 = 1;
  }
  entity = 0;
  if ( !itemEntity )
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  this = (QuestUseItemInfo_o *)DataManager__GetMaster_object_((const MethodInfo_31703A0 *)Method_DataManager_GetMaster_QuestUseItemGroupMaster___);
  if ( !this )
LABEL_17:
    sub_1C7BD40(this, itemEntity);
  this = (QuestUseItemInfo_o *)DataMasterBase_object__object__int___TryGetEntity(
                                 (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                 &entity,
                                 v4->fields._GroupId_k__BackingField,
                                 (const MethodInfo_342E348 *)Method_DataMasterBase_QuestUseItemGroupMaster__QuestUseItemGroupEntity__int__TryGetEntity__);
...
LABEL_11:
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  this = (QuestUseItemInfo_o *)DataManager__GetMaster_object_((const MethodInfo_31703A0 *)Method_DataManager_GetMaster_QuestUseItemPickupMaster___);
  if ( !this )
    goto LABEL_17;
