void __fastcall QuestUseItemInfo___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B18262 & 1) == 0 )
  {
    sub_1BCAFF8(&QuestUseItemInfo_TypeInfo, v1);
    sub_1BCAFF8(&StringLiteral_6827/*"FriendshipUpItemUseState"*/, v4);
    sub_1BCAFF8(&StringLiteral_24976/*"{0}_icon"*/, v5);
    sub_1BCAFF8(&StringLiteral_6825/*"FriendshipUpItemEventUseState"*/, v6);
    byte_4B18262 = 1;
  }
  QuestUseItemInfo_TypeInfo->static_fields->SAVE_KEY_FRIENDSHIP_ITEM_USE_STATE = (struct System_String_o *)StringLiteral_6827/*"FriendshipUpItemUseState"*/;
  sub_1BCAF9C((CGThumbnailListItem_o *)QuestUseItemInfo_TypeInfo->static_fields, StringLiteral_6827/*"FriendshipUpItemUseState"*/, v2, v3);
  v7 = StringLiteral_6825/*"FriendshipUpItemEventUseState"*/;
  static_fields = QuestUseItemInfo_TypeInfo->static_fields;
  static_fields->SAVE_KEY_FRIENDSHIP_EVENT_ITEM_USE_STATE = (struct System_String_o *)StringLiteral_6825/*"FriendshipUpItemEventUseState"*/;
  sub_1BCAF9C((CGThumbnailListItem_o *)&static_fields->SAVE_KEY_FRIENDSHIP_EVENT_ITEM_USE_STATE, v7, v9, v10);
  v11 = StringLiteral_24976/*"{0}_icon"*/;
  v12 = QuestUseItemInfo_TypeInfo->static_fields;
  v12->ITEM_ICON_SUFFIX = (struct System_String_o *)StringLiteral_24976/*"{0}_icon"*/;
  sub_1BCAF9C((CGThumbnailListItem_o *)&v12->ITEM_ICON_SUFFIX, v11, v13, v14);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1825D & 1) == 0 )
  {
    sub_1BCAFF8(&BalanceConfig_TypeInfo, itemEntity);
    ...
    sub_1BCAFF8(&StringLiteral_10175/*"PARTY_ORGANIZATION_FRIENDSHIP_UP_ITEM_SELECT_DIALOG_VALUE"*/, v15);
    sub_1BCAFF8(&StringLiteral_10833/*"QUEST_USE_ITEM_SELECT_DIALOG_REWARD_ADD_ITEM_EXPLANATION"*/, v16);
    byte_4B1825D = 1;
  }
  outEndedAt = 0LL;
  countText = 0LL;
  ...
  if ( this->fields._CampaignType_k__BackingField != 36 )
  {
    ...
    v30 = LocalizationManager__Get((System_String_o *)StringLiteral_10175/*"PARTY_ORGANIZATION_FRIENDSHIP_UP_ITEM_SELECT_DIALOG_VALUE"*/, 0LL);
  ...
  IsNullOrEmpty = DataManager__GetMaster_object_((const MethodInfo_301AA50 *)Method_DataManager_GetMaster_GiftMaster___);
  if ( !IsNullOrEmpty
...
LABEL_28:
  ...
  if ( *((int *)IsNullOrEmpty + 6) >= 1 )
  {
    ...
    if ( ((unsigned __int8)IsNullOrEmpty & 1) != 0 )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v24 = LocalizationManager__Get((System_String_o *)StringLiteral_10833/*"QUEST_USE_ITEM_SELECT_DIALOG_REWARD_ADD_ITEM_EXPLANATION"*/, 0LL);
      v25 = System_String__Format(v24, (Il2CppObject *)nameText, 0LL);
      v28 = (int)v25;
      p_Explanation_k__BackingField->klass = (CGThumbnailListItem_c *)v25;
LABEL_19:
      sub_1BCAF9C(p_Explanation_k__BackingField, v28, v26, v27);
    }
  }
LABEL_20:
...
void __fastcall QuestUseItemInfo___ctor_33846416(
        QuestUseItemInfo_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18260 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_CommonUI_CloseNotificationDialog__, v5);
    ...
    sub_1BCAFF8(&StringLiteral_10167/*"PARTY_ORGANIZATION_FRIENDSHIP_UP_ITEM_EXPIRED"*/, v9);
  ...
  if ( !v15 || (System_Action_c *)v15->klass == System_Action_TypeInfo )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v18 = LocalizationManager__Get((System_String_o *)StringLiteral_10167/*"PARTY_ORGANIZATION_FRIENDSHIP_UP_ITEM_EXPIRED"*/, 0LL);
...
LABEL_10:
  ...
  v19 = (QuestUseItemInfo_o *)sub_1BCB514(v15);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1825E & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMaster_QuestUseItemGroupMaster___, itemEntity);
    sub_1BCAFF8(&Method_DataManager_GetMaster_QuestUseItemPickupMaster___, v5);
    sub_1BCAFF8(&DataManager_TypeInfo, v6);
    sub_1BCAFF8(&Method_DataMasterBase_QuestUseItemGroupMaster__QuestUseItemGroupEntity__int__TryGetEntity__, v7);
    sub_1BCAFF8(&int_TypeInfo, v8);
    this = (QuestUseItemInfo_o *)sub_1BCAFF8(&QuestUseItemInfo_TypeInfo, v9);
    byte_4B1825E = 1;
  }
  entity = 0LL;
  if ( !itemEntity )
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  this = (QuestUseItemInfo_o *)DataManager__GetMaster_object_((const MethodInfo_301AA50 *)Method_DataManager_GetMaster_QuestUseItemGroupMaster___);
  if ( !this )
LABEL_17:
    sub_1BCB254(this, itemEntity);
  this = (QuestUseItemInfo_o *)DataMasterBase_object__object__int___TryGetEntity(
                                 (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                 &entity,
                                 v4->fields._GroupId_k__BackingField,
                                 (const MethodInfo_32C7E4C *)Method_DataMasterBase_QuestUseItemGroupMaster__QuestUseItemGroupEntity__int__TryGetEntity__);
...
LABEL_11:
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  this = (QuestUseItemInfo_o *)DataManager__GetMaster_object_((const MethodInfo_301AA50 *)Method_DataManager_GetMaster_QuestUseItemPickupMaster___);
  if ( !this )
    goto LABEL_17;
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&v4->fields._Name_k__BackingField, (int32_t)name, v12, v13);
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&v4->fields._Explanation_k__BackingField, (int32_t)EffectExplanation, v15, v16);
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&v4->fields._SpriteName_k__BackingField, (int32_t)v24, v25, v26);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields._Explanation_k__BackingField, (int32_t)value, (int32_t)method, v3);
}
