        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB7ABB & 1) == 0 )
  {
    sub_1C13D24(&AtlasManager_TypeInfo, getSp);
    sub_1C13D24(&BalanceConfig_TypeInfo, v17);
    sub_1C13D24(&Method_DataManager_GetMasterData_EventPointGroupMaster___, v18);
    sub_1C13D24(&Method_DataManager_GetMasterData_UserEventPointMaster___, v19);
    ...
    sub_1C13D24(&StringLiteral_25332/*"zoom"*/, v23);
  ...
  v32 = System_Math__Min_63787428(value, UserPointEventMax, 0LL);
  Instance = (DataManager_o *)System_Math__Min_63787428(
                                v29,
  ...
  if ( !totalLabel
    || (UILabel__SetDefaultFont(totalLabel, 0LL),
        ...
        v43 = System_String__Format((System_String_o *)StringLiteral_25332/*"zoom"*/, v42, 0LL),
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C13F80(eventDamageRoot, *(_QWORD *)&eventId);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !eventDamageRoot )
    goto LABEL_14;
  UnityEngine_GameObject__SetActive(eventDamageRoot, 1, 0LL);
  eventDamageRoot = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3869BD8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !eventDamageRoot )
    goto LABEL_14;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB7AB8 & 1) == 0 )
  {
    sub_1C13D24(&int_TypeInfo, *(_QWORD *)&totalQp);
    sub_1C13D24(&StringLiteral_25332/*"zoom"*/, v8);
    sub_1C13D24(&StringLiteral_859/*"+ {0:#,0}"*/, v9);
    byte_4BB7AB8 = 1;
  }
  ...
  if ( !getQpLabel
    || (UILabel__set_text(getQpLabel, v12, 0LL),
        ...
        v12 = System_String__Format((System_String_o *)StringLiteral_25332/*"zoom"*/, v18, 0LL),
        !totalQpLabel) )
  {
    sub_1C13F80(v12, v13);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB7ABA & 1) == 0 )
  {
    this = (BattleResultEventItemGroupComponent_o *)sub_1C13D24(&long___TypeInfo, userId);
    byte_4BB7ABA = 1;
  }
  if ( !viewGroupIds )
    goto LABEL_150;
  ...
  if ( v16 == 2 )
  {
    ...
    if ( pointBgSps->max_length )
    {
      ...
      if ( v26->max_length > 1 )
      {
        ...
        this = (BattleResultEventItemGroupComponent_o *)sub_1C13DCC(long___TypeInfo, 2LL);
  ...
  if ( v16 != 1 )
  {
    ...
    if ( v44->max_length )
    {
      ...
      if ( v45->max_length > 1 )
      {
        ...
        this = (BattleResultEventItemGroupComponent_o *)sub_1C13DCC(long___TypeInfo, 3LL);
