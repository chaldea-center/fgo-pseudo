        ...
        const MethodInfo *method)
{
  ...
  v24 = System_Math__Min_65553884(value, UserPointEventMax, 0);
  Instance = (DataManager_o *)System_Math__Min_65553884(
                                v21,
  ...
  v27 = System_String__Format((System_String_o *)StringLiteral_801/*"+ {0:#,0}"*/, v26, 0);
  ...
  if ( !totalLabel
    || (UILabel__SetDefaultFont(totalLabel, 0),
        ...
        v29 = System_String__Format((System_String_o *)StringLiteral_25182/*"{0:#,0}"*/, v28, 0),
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C71608(eventDamageRoot, *(_QWORD *)&eventId);
  }
        ...
        const MethodInfo *method)
{
  ...
  eventDamageRoot = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A5F158 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !eventDamageRoot )
    goto LABEL_14;
        ...
        const MethodInfo *method)
{
  ...
  v9 = System_String__Format((System_String_o *)StringLiteral_801/*"+ {0:#,0}"*/, v8, 0);
  if ( !getQpLabel
    || (UILabel__set_text(getQpLabel, v9, 0),
        ...
        v9 = System_String__Format((System_String_o *)StringLiteral_25182/*"{0:#,0}"*/, v12, 0),
        !totalQpLabel) )
  {
    sub_1C71608(v9, v10);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CCAD32 & 1) == 0 )
  {
    this = (BattleResultEventItemGroupComponent_o *)sub_1C713B0(&long___TypeInfo);
    byte_4CCAD32 = 1;
  }
  if ( !viewGroupIds )
    goto LABEL_150;
  ...
  if ( v16 == 2 )
  {
    ...
    if ( LODWORD(pointBgSps->max_length) )
    {
      ...
      if ( LODWORD(v26->max_length) > 1 )
      {
        ...
        this = (BattleResultEventItemGroupComponent_o *)sub_1C71458(long___TypeInfo, 2);
  ...
  if ( v16 != 1 )
  {
    ...
    if ( LODWORD(v44->max_length) )
    {
      ...
      if ( LODWORD(v45->max_length) > 1 )
      {
        ...
        this = (BattleResultEventItemGroupComponent_o *)sub_1C71458(long___TypeInfo, 3);
