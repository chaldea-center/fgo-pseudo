        ...
        const MethodInfo *method)
{
  ...
  v24 = System_Math__Min_62526020(value, UserPointEventMax, 0LL);
  Instance = (DataManager_o *)System_Math__Min_62526020(
                                v21,
  ...
  v30 = System_String__Format((System_String_o *)StringLiteral_861/*"+ {0:#,0}"*/, v29, 0LL);
  UILabel__set_text(getLabel, v30, 0LL);
  if ( !totalLabel
    || (UILabel__SetDefaultFont(totalLabel, 0LL),
        v38 = v24,
        v34 = (Il2CppObject *)j_il2cpp_value_box_0(long_TypeInfo, &v38, v31, v32, v33),
        v35 = System_String__Format((System_String_o *)StringLiteral_24933/*"{0:#,0}"*/, v34, 0LL),
        UILabel__set_text(totalLabel, v35, 0LL),
...
LABEL_22:
  ...
  v36 = EventPointGroupMaster__GetEntity((EventPointGroupMaster_o *)Instance, eventId, groupId, 0LL);
  if ( v36 )
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B8880C(eventDamageRoot, *(_QWORD *)&eventId);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !eventDamageRoot )
    goto LABEL_14;
  UnityEngine_GameObject__SetActive(eventDamageRoot, 1, 0LL);
  eventDamageRoot = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !eventDamageRoot )
    goto LABEL_14;
        ...
        const MethodInfo *method)
{
  ...
  v10 = System_String__Format((System_String_o *)StringLiteral_861/*"+ {0:#,0}"*/, v9, 0LL);
  if ( !getQpLabel
    || (UILabel__set_text(getQpLabel, v10, 0LL),
        totalQpLabel = this->fields.totalQpLabel,
        v17 = totalQp,
        v16 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v17, v13, v14, v15),
        v10 = System_String__Format((System_String_o *)StringLiteral_24933/*"{0:#,0}"*/, v16, 0LL),
        !totalQpLabel) )
  {
    sub_1B8880C(v10, v11);
  }
  UILabel__set_text(totalQpLabel, v10, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5E318 & 1) == 0 )
  {
    this = (BattleResultEventItemGroupComponent_o *)sub_1B885B0(&long___TypeInfo);
    byte_4A5E318 = 1;
  }
  if ( !viewGroupIds )
    goto LABEL_150;
  ...
  if ( v16 == 2 )
  {
    ...
    if ( pointBgSps->max_length )
    {
      ...
      if ( v26->max_length > 1 )
      {
        ...
        this = (BattleResultEventItemGroupComponent_o *)sub_1B88658(long___TypeInfo, 2LL);
  ...
  if ( v16 != 1 )
  {
    ...
    if ( v44->max_length )
    {
      ...
      if ( v45->max_length > 1 )
      {
        ...
        this = (BattleResultEventItemGroupComponent_o *)sub_1B88658(long___TypeInfo, 3LL);
