        ...
        const MethodInfo *method)
{
  ...
  v24 = System_Math__Min_63934960(value, UserPointEventMax, 0LL);
  Instance = (DataManager_o *)System_Math__Min_63934960(
                                v21,
  ...
  v30 = System_String__Format((System_String_o *)StringLiteral_859/*"+ {0:#,0}"*/, v29, 0LL);
  ...
  if ( !totalLabel
    || (UILabel__SetDefaultFont(totalLabel, 0LL),
        ...
        v35 = System_String__Format((System_String_o *)StringLiteral_25376/*"{0:#,0}"*/, v34, 0LL),
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C22094(eventDamageRoot, *(_QWORD *)&eventId);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !eventDamageRoot )
    goto LABEL_14;
  UnityEngine_GameObject__SetActive(eventDamageRoot, 1, 0LL);
  eventDamageRoot = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_388D058 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !eventDamageRoot )
    goto LABEL_14;
        ...
        const MethodInfo *method)
{
  ...
  v10 = System_String__Format((System_String_o *)StringLiteral_859/*"+ {0:#,0}"*/, v9, 0LL);
  if ( !getQpLabel
    || (UILabel__set_text(getQpLabel, v10, 0LL),
        ...
        v10 = System_String__Format((System_String_o *)StringLiteral_25376/*"{0:#,0}"*/, v16, 0LL),
        !totalQpLabel) )
  {
    sub_1C22094(v10, v11);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDF961 & 1) == 0 )
  {
    this = (BattleResultEventItemGroupComponent_o *)sub_1C21E38(&long___TypeInfo);
    byte_4BDF961 = 1;
  }
  if ( !viewGroupIds )
    goto LABEL_150;
  ...
  if ( v16 == 2 )
  {
    ...
    if ( pointBgSps->max_length )
    {
      ...
      if ( v26->max_length > 1 )
      {
        ...
        this = (BattleResultEventItemGroupComponent_o *)sub_1C21EE0(long___TypeInfo, 2LL);
  ...
  if ( v16 != 1 )
  {
    ...
    if ( v44->max_length )
    {
      ...
      if ( v45->max_length > 1 )
      {
        ...
        this = (BattleResultEventItemGroupComponent_o *)sub_1C21EE0(long___TypeInfo, 3LL);
