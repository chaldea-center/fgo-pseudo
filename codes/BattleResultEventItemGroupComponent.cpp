        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22C49 & 1) == 0 )
  {
    sub_1B715CC(&AtlasManager_TypeInfo, getSp);
    sub_1B715CC(&BalanceConfig_TypeInfo, v17);
    sub_1B715CC(&Method_DataManager_GetMasterData_EventPointGroupMaster___, v18);
    sub_1B715CC(&Method_DataManager_GetMasterData_UserEventPointMaster___, v19);
  ...
  v32 = System_Math__Min_62324492(value, UserPointEventMax, 0LL);
  Instance = (DataManager_o *)System_Math__Min_62324492(
                                v29,
  ...
  v38 = System_String__Format((System_String_o *)StringLiteral_861/*"+ {0:#,0}"*/, v37, 0LL);
  ...
  if ( !totalLabel
    || (UILabel__SetDefaultFont(totalLabel, 0LL),
        ...
        v43 = System_String__Format((System_String_o *)StringLiteral_24874/*"{0:#,0}"*/, v42, 0LL),
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B71828(eventDamageRoot, *(_QWORD *)&eventId);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !eventDamageRoot )
    goto LABEL_14;
  UnityEngine_GameObject__SetActive(eventDamageRoot, 1, 0LL);
  eventDamageRoot = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !eventDamageRoot )
    goto LABEL_14;
        ...
        const MethodInfo *method)
{
  ...
  if ( !getQpLabel
    || (UILabel__set_text(getQpLabel, v12, 0LL),
        ...
        v12 = System_String__Format((System_String_o *)StringLiteral_24874/*"{0:#,0}"*/, v18, 0LL),
        !totalQpLabel) )
  {
    sub_1B71828(v12, v13);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22C48 & 1) == 0 )
  {
    this = (BattleResultEventItemGroupComponent_o *)sub_1B715CC(&long___TypeInfo, userId);
    byte_4A22C48 = 1;
  }
  if ( !viewGroupIds )
    goto LABEL_150;
  ...
  if ( v16 == 2 )
  {
    ...
    if ( pointBgSps->max_length )
    {
      ...
      if ( v26->max_length > 1 )
      {
        ...
        this = (BattleResultEventItemGroupComponent_o *)sub_1B71674(long___TypeInfo, 2LL);
  ...
  if ( v16 != 1 )
  {
    ...
    if ( v44->max_length )
    {
      ...
      if ( v45->max_length > 1 )
      {
        ...
        this = (BattleResultEventItemGroupComponent_o *)sub_1B71674(long___TypeInfo, 3LL);
