        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A716B7 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_18180/*"commandCodeId"*/, userCommandCodeId);
    sub_1B90010(&StringLiteral_20827/*"isLock"*/, v9);
    sub_1B90010(&StringLiteral_20811/*"isChoice"*/, v10);
    byte_4A716B7 = 1;
  }
  RequestBase__addField_41187492(
    (RequestBase_o *)this,
    (System_String_o *)StringLiteral_18180/*"commandCodeId"*/,
    userCommandCodeId,
    (const MethodInfo *)isChoice);
  if ( !this )
    sub_1B9026C(v11, v12);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_20827/*"isLock"*/, isLock, v13);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_20811/*"isChoice"*/, isChoice, v14);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B90010(&NetworkManager_TypeInfo, method);
    sub_1B90010(&StringLiteral_18177/*"commandCode/setStatus"*/, v2);
    byte_4A716B5 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61787092(BaseUrl, (System_String_o *)StringLiteral_18177/*"commandCode/setStatus"*/, 0LL);
}
