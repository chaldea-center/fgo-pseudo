        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC939A & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_18449/*"commandCodeId"*/, userCommandCodeId);
    sub_1C1ABD4(&StringLiteral_21158/*"isLock"*/, v9);
    sub_1C1ABD4(&StringLiteral_21141/*"isChoice"*/, v10);
    byte_4BC939A = 1;
  }
  RequestBase__addField_42368496(
    (RequestBase_o *)this,
    (System_String_o *)StringLiteral_18449/*"commandCodeId"*/,
    userCommandCodeId,
    (const MethodInfo *)isChoice);
  if ( !this )
    sub_1C1AE30(v11, v12);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21158/*"isLock"*/, isLock, v13);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21141/*"isChoice"*/, isChoice, v14);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C1ABD4(&NetworkManager_TypeInfo, method);
    sub_1C1ABD4(&StringLiteral_18446/*"commandCode/setStatus"*/, v2);
    byte_4BC9398 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63040368(BaseUrl, (System_String_o *)StringLiteral_18446/*"commandCode/setStatus"*/, 0LL);
}
