        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB7599 & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_18184/*"commandCodeId"*/, userCommandCodeId);
    sub_1BAB41C(&StringLiteral_20832/*"isLock"*/, v9);
    sub_1BAB41C(&StringLiteral_20816/*"isChoice"*/, v10);
    byte_4AB7599 = 1;
  }
  RequestBase__addField_41522804(
    (RequestBase_o *)this,
    (System_String_o *)StringLiteral_18184/*"commandCodeId"*/,
    userCommandCodeId,
    (const MethodInfo *)isChoice);
  if ( !this )
    sub_1BAB678(v11, v12);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_20832/*"isLock"*/, isLock, v13);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_20816/*"isChoice"*/, isChoice, v14);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BAB41C(&NetworkManager_TypeInfo, method);
    sub_1BAB41C(&StringLiteral_18181/*"commandCode/setStatus"*/, v2);
    byte_4AB7597 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62048128(BaseUrl, (System_String_o *)StringLiteral_18181/*"commandCode/setStatus"*/, 0LL);
}
