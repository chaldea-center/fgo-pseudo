        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3EAA & 1) == 0 )
  {
    sub_1B00CCC(&StringLiteral_17908/*"commandCodeId"*/, userCommandCodeId);
    sub_1B00CCC(&StringLiteral_20517/*"isLock"*/, v9);
    sub_1B00CCC(&StringLiteral_20502/*"isChoice"*/, v10);
    byte_48E3EAA = 1;
  }
  RequestBase__addField_39759196(
    (RequestBase_o *)this,
    (System_String_o *)StringLiteral_17908/*"commandCodeId"*/,
    userCommandCodeId,
    (const MethodInfo *)isChoice);
  if ( !this )
    sub_1B00F28(v11, v12);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_20517/*"isLock"*/, isLock, v13);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_20502/*"isChoice"*/, isChoice, v14);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B00CCC(&NetworkManager_TypeInfo, method);
    sub_1B00CCC(&StringLiteral_17905/*"commandCode/setStatus"*/, v2);
    byte_48E3EA8 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_60325748(BaseUrl, (System_String_o *)StringLiteral_17905/*"commandCode/setStatus"*/, 0LL);
}
