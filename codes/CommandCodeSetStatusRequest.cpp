        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6847F & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_18391/*"commandCodeId"*/, userCommandCodeId);
    sub_1BE4ACC(&StringLiteral_21096/*"isLock"*/, v9);
    sub_1BE4ACC(&StringLiteral_21079/*"isChoice"*/, v10);
    byte_4B6847F = 1;
  }
  RequestBase__addField_42110748(
    (RequestBase_o *)this,
    (System_String_o *)StringLiteral_18391/*"commandCodeId"*/,
    userCommandCodeId,
    (const MethodInfo *)isChoice);
  if ( !this )
    sub_1BE4D28(v11, v12);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21096/*"isLock"*/, isLock, v13);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21079/*"isChoice"*/, isChoice, v14);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BE4ACC(&NetworkManager_TypeInfo, method);
    sub_1BE4ACC(&StringLiteral_18388/*"commandCode/setStatus"*/, v2);
    byte_4B6847D = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62698808(BaseUrl, (System_String_o *)StringLiteral_18388/*"commandCode/setStatus"*/, 0LL);
}
