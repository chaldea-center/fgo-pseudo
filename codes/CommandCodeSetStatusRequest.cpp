        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_435469B & 1) == 0 )
  {
    sub_B70694(&StringLiteral_17865/*"commandCodeId"*/);
    sub_B70694(&StringLiteral_20251/*"isLock"*/);
    sub_B70694(&StringLiteral_20236/*"isChoice"*/);
    byte_435469B = 1;
  }
  RequestBase__addField_32336108((RequestBase_o *)this, (System_String_o *)StringLiteral_17865/*"commandCodeId"*/, userCommandCodeId, 0LL);
  if ( !this )
    sub_B7076C(v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B70694(&NetworkManager_TypeInfo);
    sub_B70694(&StringLiteral_17862/*"commandCode/setStatus"*/);
    byte_4354699 = 1;
  }
  if ( (BYTE3(NetworkManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !NetworkManager_TypeInfo->_2.cctor_finished )
  ...
  return System_String__Concat_44758168(BaseUrl, (System_String_o *)StringLiteral_17862/*"commandCode/setStatus"*/, 0LL);
}
