void __fastcall TitleInfoEventRaidDayComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_42ECC28 & 1) == 0 )
  {
    sub_B5D5C4(&TitleInfoEventRaidDayComponent_TypeInfo, v1, (_DWORD)v2, v3);
    sub_B5D5C4(&StringLiteral_18786/*"event_raid_num_"*/, v8, v9, v10);
    byte_42ECC28 = 1;
  }
  ...
  v12 = (System_Int32_array **)StringLiteral_18786/*"event_raid_num_"*/;
  static_fields->NUM_SPNAME_PREFIX = (struct System_String_o *)StringLiteral_18786/*"event_raid_num_"*/;
  sub_B5D560((BattleServantConfConponent_o *)&static_fields->NUM_SPNAME_PREFIX, v12, v2, v3, v4, v5, v6, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B5D69C(dayStrSp, *(_QWORD *)&depth);
  }
        ...
        const MethodInfo *method)
{
  ...
  TitleInfoEventRaidDayComponent_c *v26; // x0
  int32_t DEPTH_BACK; // w1
  TitleInfoEventRaidDayComponent_c *v28; // x0
  int32_t v29; // [xsp+Ch] [xbp-24h] BYREF

  v29 = dispDayNum;
  if ( (byte_42ECC27 & 1) == 0 )
  {
    sub_B5D5C4(&Method_DataManager_GetMasterData_EventRaidMaster___, eventId, dispDayNum, *(_QWORD *)&dispDayType);
    sub_B5D5C4(&EventRaidMaster_TypeInfo, v8, v9, v10);
    sub_B5D5C4(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v11, v12, v13);
    sub_B5D5C4(&TitleInfoEventRaidDayComponent_TypeInfo, v14, v15, v16);
    byte_42ECC27 = 1;
  }
  ...
  if ( dispDayNum < 1 || (OLD_RAID_DAY_COUNT = v19->static_fields->OLD_RAID_DAY_COUNT, OLD_RAID_DAY_COUNT < dispDayNum) )
  {
...
LABEL_44:
  ...
  NUM_SPNAME_PREFIX = v23->static_fields->NUM_SPNAME_PREFIX;
  v25 = System_Int32__ToString((int32_t)&v29, 0LL);
  Instance = (DataManager_o *)System_String__Concat_44577788(NUM_SPNAME_PREFIX, v25, 0LL);
  if ( !dayNumSp )
    goto LABEL_44;
  ...
  {
LABEL_38:
    v28 = TitleInfoEventRaidDayComponent_TypeInfo;
    if ( (BYTE3(TitleInfoEventRaidDayComponent_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
      && !TitleInfoEventRaidDayComponent_TypeInfo->_2.cctor_finished )
    {
      j_il2cpp_runtime_class_init_0(TitleInfoEventRaidDayComponent_TypeInfo);
    ...
    DEPTH_BACK = v28->static_fields->DEPTH_BACK;
    goto LABEL_42;
  }
LABEL_32:
  if ( dispDayType == 2 )
  ...
  if ( dispDayType != 1 )
    return;
  v26 = TitleInfoEventRaidDayComponent_TypeInfo;
  if ( (BYTE3(TitleInfoEventRaidDayComponent_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !TitleInfoEventRaidDayComponent_TypeInfo->_2.cctor_finished )
  {
    j_il2cpp_runtime_class_init_0(TitleInfoEventRaidDayComponent_TypeInfo);
  ...
  DEPTH_BACK = v26->static_fields->DEPTH_FRONT;
LABEL_42:
  TitleInfoEventRaidDayComponent__SetDepth(this, DEPTH_BACK, v21);
}