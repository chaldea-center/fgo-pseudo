void __fastcall TitleInfoEventRaidDayComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_42B445A & 1) == 0 )
  {
    sub_B52984(&TitleInfoEventRaidDayComponent_TypeInfo);
    sub_B52984(&StringLiteral_18691/*"event_raid_num_"*/);
    byte_42B445A = 1;
  }
  ...
  v8 = (System_Int32_array **)StringLiteral_18691/*"event_raid_num_"*/;
  static_fields->NUM_SPNAME_PREFIX = (struct System_String_o *)StringLiteral_18691/*"event_raid_num_"*/;
  sub_B52920((BattleServantConfConponent_o *)&static_fields->NUM_SPNAME_PREFIX, v8, v1, v2, v3, v4, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B52A5C(dayStrSp, *(_QWORD *)&depth);
  }
...
LABEL_44:
  ...
  Instance = (DataManager_o *)System_String__Concat_44568316(NUM_SPNAME_PREFIX, v16, 0LL);
  if ( !dayNumSp )
    goto LABEL_44;
