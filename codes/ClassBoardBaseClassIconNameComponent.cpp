void __fastcall ClassBoardBaseClassIconNameComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B48227 & 1) == 0 )
  {
    sub_1BDB878(&ClassBoardBaseClassIconNameComponent_TypeInfo, v1);
    sub_1BDB878(&StringLiteral_17543/*"btn_tab_{0}"*/, v4);
    sub_1BDB878(&StringLiteral_17989/*"class2_{0}"*/, v5);
    byte_4B48227 = 1;
  }
  ClassBoardBaseClassIconNameComponent_TypeInfo->static_fields->TabBtnNameFormat = (struct System_String_o *)StringLiteral_17543/*"btn_tab_{0}"*/;
  sub_1BDB81C(
    (CGThumbnailListItem_o *)ClassBoardBaseClassIconNameComponent_TypeInfo->static_fields,
    StringLiteral_17543/*"btn_tab_{0}"*/,
    v2,
    v3);
  v6 = StringLiteral_17989/*"class2_{0}"*/;
  static_fields = ClassBoardBaseClassIconNameComponent_TypeInfo->static_fields;
  static_fields->TabGrandBtnNameFormat = (struct System_String_o *)StringLiteral_17989/*"class2_{0}"*/;
  sub_1BDB81C((CGThumbnailListItem_o *)&static_fields->TabGrandBtnNameFormat, v6, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48226 & 1) == 0 )
  {
    sub_1BDB878(&AtlasManager_TypeInfo, *(_QWORD *)&classBaseId);
    sub_1BDB878(&ClassBoardBaseClassIconNameComponent_TypeInfo, v7);
    sub_1BDB878(&Method_DataManager_GetMaster_ClassBoardBaseMaster___, v8);
    sub_1BDB878(&DataManager_TypeInfo, v9);
    sub_1BDB878(&Method_DataMasterBase_ClassBoardBaseMaster__ClassBoardBaseEntity__int__TryGetEntity__, v10);
    sub_1BDB878(&int_TypeInfo, v11);
    sub_1BDB878(&LocalizationManager_TypeInfo, v12);
    sub_1BDB878(&StringLiteral_7002/*"GRAND_CLASS_BOARD_RELEASE_DIALOG_CLASS_TEXT"*/, v13);
    byte_4B48226 = 1;
  }
  ...
  Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)LocalizationManager__Get(
                                                                  (System_String_o *)StringLiteral_7002/*"GRAND_CLASS_BOARD_RELEASE_DIALOG_CLASS_TEXT"*/,
                                                                  0LL);
  if ( !v24
