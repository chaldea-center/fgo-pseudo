void __fastcall ClassBoardBaseClassIconNameComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A0BEE1 & 1) == 0 )
  {
    sub_1B686D4(&ClassBoardBaseClassIconNameComponent_TypeInfo, v1);
    sub_1B686D4(&StringLiteral_17482/*"btn_tab_{0}"*/, v4);
    byte_4A0BEE1 = 1;
  }
  ClassBoardBaseClassIconNameComponent_TypeInfo->static_fields->TAB_BTN_NAME_FORMAT = (struct System_String_o *)StringLiteral_17482/*"btn_tab_{0}"*/;
  sub_1B68678(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0BEE0 & 1) == 0 )
  {
    sub_1B686D4(&AtlasManager_TypeInfo, *(_QWORD *)&classBaseId);
    sub_1B686D4(&ClassBoardBaseClassIconNameComponent_TypeInfo, v7);
    sub_1B686D4(&Method_DataManager_GetMaster_ClassBoardBaseMaster___, v8);
    sub_1B686D4(&DataManager_TypeInfo, v9);
    sub_1B686D4(&Method_DataMasterBase_ClassBoardBaseMaster__ClassBoardBaseEntity__int__TryGetEntity__, v10);
