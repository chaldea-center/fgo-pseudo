void __fastcall ClassBoardBaseClassIconNameComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B3A637 & 1) == 0 )
  {
    sub_1BD3458(&ClassBoardBaseClassIconNameComponent_TypeInfo, v1);
    sub_1BD3458(&StringLiteral_17750/*"btn_tab_{0}"*/, v8);
    byte_4B3A637 = 1;
  }
  ClassBoardBaseClassIconNameComponent_TypeInfo->static_fields->TAB_BTN_NAME_FORMAT = (struct System_String_o *)StringLiteral_17750/*"btn_tab_{0}"*/;
  sub_1BD33FC(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3A636 & 1) == 0 )
  {
    sub_1BD3458(&AtlasManager_TypeInfo, *(_QWORD *)&classBaseId);
    sub_1BD3458(&ClassBoardBaseClassIconNameComponent_TypeInfo, v7);
    sub_1BD3458(&Method_DataManager_GetMaster_ClassBoardBaseMaster___, v8);
    sub_1BD3458(&DataManager_TypeInfo, v9);
    sub_1BD3458(&Method_DataMasterBase_ClassBoardBaseMaster__ClassBoardBaseEntity__int__TryGetEntity__, v10);
