void __fastcall ClassBoardBaseClassIconNameComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B6A0CF & 1) == 0 )
  {
    sub_1BE4ACC(&ClassBoardBaseClassIconNameComponent_TypeInfo, v1);
    sub_1BE4ACC(&StringLiteral_17772/*"btn_tab_{0}"*/, v8);
    byte_4B6A0CF = 1;
  }
  ClassBoardBaseClassIconNameComponent_TypeInfo->static_fields->TAB_BTN_NAME_FORMAT = (struct System_String_o *)StringLiteral_17772/*"btn_tab_{0}"*/;
  sub_1BE4A70(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A0CE & 1) == 0 )
  {
    sub_1BE4ACC(&AtlasManager_TypeInfo, *(_QWORD *)&classBaseId);
    sub_1BE4ACC(&ClassBoardBaseClassIconNameComponent_TypeInfo, v7);
    sub_1BE4ACC(&Method_DataManager_GetMaster_ClassBoardBaseMaster___, v8);
    sub_1BE4ACC(&DataManager_TypeInfo, v9);
    sub_1BE4ACC(&Method_DataMasterBase_ClassBoardBaseMaster__ClassBoardBaseEntity__int__TryGetEntity__, v10);
