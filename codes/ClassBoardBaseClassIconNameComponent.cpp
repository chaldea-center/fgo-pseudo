void __fastcall ClassBoardBaseClassIconNameComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB9160 & 1) == 0 )
  {
    sub_1BAB41C(&ClassBoardBaseClassIconNameComponent_TypeInfo, v1);
    sub_1BAB41C(&StringLiteral_17577/*"btn_tab_{0}"*/, v4);
    byte_4AB9160 = 1;
  }
  ClassBoardBaseClassIconNameComponent_TypeInfo->static_fields->TAB_BTN_NAME_FORMAT = (struct System_String_o *)StringLiteral_17577/*"btn_tab_{0}"*/;
  sub_1BAB3C0(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB915F & 1) == 0 )
  {
    sub_1BAB41C(&AtlasManager_TypeInfo, *(_QWORD *)&classBaseId);
    sub_1BAB41C(&ClassBoardBaseClassIconNameComponent_TypeInfo, v7);
    sub_1BAB41C(&Method_DataManager_GetMaster_ClassBoardBaseMaster___, v8);
    sub_1BAB41C(&DataManager_TypeInfo, v9);
    sub_1BAB41C(&Method_DataMasterBase_ClassBoardBaseMaster__ClassBoardBaseEntity__int__TryGetEntity__, v10);
