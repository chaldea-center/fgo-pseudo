        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3B110 & 1) == 0 )
  {
    sub_1BD3458(&JsonManager_TypeInfo, *(_QWORD *)&eventId);
    sub_1BD3458(&StringLiteral_19258/*"enterUserSvtInfo"*/, v7);
    sub_1BD3458(&StringLiteral_19358/*"eventId"*/, v8);
    byte_4B3B110 = 1;
  }
  ...
  RequestBase__addField_41965080((RequestBase_o *)this, (System_String_o *)StringLiteral_19258/*"enterUserSvtInfo"*/, v9, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3B10F & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_19343/*"event/fortification"*/, v2);
    byte_4B3B10F = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62525248(BaseUrl, (System_String_o *)StringLiteral_19343/*"event/fortification"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    v7 = v6;
    v8 = ResponseData__checkError_42055668(v6, 0LL);
    v9 = 0LL;
    if ( v8 )
    {
