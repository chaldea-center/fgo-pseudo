        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC172E & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_19105/*"enterUserSvtInfo"*/);
  ...
  RequestBase__addField_44518324((RequestBase_o *)this, (System_String_o *)StringLiteral_19105/*"enterUserSvtInfo"*/, v7, 0);
...
System_String_o *EventFortificationRequest__getURL(EventFortificationRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC172D & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_19190/*"event/fortification"*/);
    byte_4CC172D = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64031724(BaseUrl, (System_String_o *)StringLiteral_19190/*"event/fortification"*/, 0);
}
