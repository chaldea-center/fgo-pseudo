        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31CD3 & 1) == 0 )
  {
    sub_1B761C0(&JsonManager_TypeInfo, *(_QWORD *)&eventId);
    sub_1B761C0(&StringLiteral_19026/*"enterUserSvtInfo"*/, v7);
    sub_1B761C0(&StringLiteral_19126/*"eventId"*/, v8);
    byte_4A31CD3 = 1;
  }
  ...
  RequestBase__addField_40941128((RequestBase_o *)this, (System_String_o *)StringLiteral_19026/*"enterUserSvtInfo"*/, v9, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31CD2 & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_19111/*"event/fortification"*/, v2);
    byte_4A31CD2 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61535060(BaseUrl, (System_String_o *)StringLiteral_19111/*"event/fortification"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    v7 = v6;
    v8 = ResponseData__checkError_40940600(v6, 0LL);
    v9 = 0LL;
    if ( v8 )
    {
