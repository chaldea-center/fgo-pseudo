        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E717CF & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_19377/*"enterUserSvtInfo"*/);
  ...
  RequestBase__addField_45601604((RequestBase_o *)this, (System_String_o *)StringLiteral_19377/*"enterUserSvtInfo"*/, v7, 0);
...
System_String_o *EventFortificationRequest__getURL(EventFortificationRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E717CE & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_19464/*"event/fortification"*/);
    byte_4E717CE = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_65562772(BaseUrl, (System_String_o *)StringLiteral_19464/*"event/fortification"*/, 0);
}
