...
System_String_o *MasterMissionTab__GetButtonSpriteName(MasterMissionTab_o *this, bool isOn, const MethodInfo *method)
{
  ...
  if ( (byte_4C2A50F & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_17456/*"btn_bg_off_5"*/);
    sub_1C2D490(&StringLiteral_17461/*"btn_bg_on_5"*/);
    byte_4C2A50F = 1;
  }
  if ( isOn )
    v5 = (System_String_o **)&StringLiteral_17461/*"btn_bg_on_5"*/;
  else
    v5 = (System_String_o **)&StringLiteral_17456/*"btn_bg_off_5"*/;
  if ( isOn )
    v6 = &StringLiteral_17460/*"btn_bg_on_4"*/;
  else
    v6 = &StringLiteral_17455/*"btn_bg_off_4"*/;
