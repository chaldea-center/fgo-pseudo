        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1835C & 1) == 0 )
  {
    this = (ServantStatusCharaGraphViewer_o *)sub_1BCAFF8(&ServantStatusCharaGraphListViewItem_TypeInfo, method);
    byte_4B1835C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !viewerListViewManager )
LABEL_11:
    sub_1BCB254(viewerListViewManager, method);
...
LABEL_17:
      sub_1BCB254(viewerListViewManager, *(_QWORD *)&dispType);
    case 1:
      viewerListViewManager = (ServantStatusCharaGraphViewerListViewManager_o *)this->fields.dragObjRootPanel;
      if ( !viewerListViewManager )
        goto LABEL_17;
