        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B6C49 & 1) == 0 )
  {
    this = (ServantStatusCharaGraphViewer_o *)sub_1B4CF90(&ServantStatusCharaGraphListViewItem_TypeInfo, method);
    byte_49B6C49 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !viewerListViewManager )
LABEL_11:
    sub_1B4D1EC(viewerListViewManager, method);
...
LABEL_17:
      sub_1B4D1EC(viewerListViewManager, *(_QWORD *)&dispType);
    case 1:
      viewerListViewManager = (ServantStatusCharaGraphViewerListViewManager_o *)this->fields.dragObjRootPanel;
      if ( !viewerListViewManager )
        goto LABEL_17;
