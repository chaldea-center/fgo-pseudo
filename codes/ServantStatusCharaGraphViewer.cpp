        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B40ABD & 1) == 0 )
  {
    this = (ServantStatusCharaGraphViewer_o *)sub_1BDB878(&ServantStatusCharaGraphListViewItem_TypeInfo, method);
    byte_4B40ABD = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !viewerListViewManager )
LABEL_11:
    sub_1BDBAD4(viewerListViewManager, method);
...
LABEL_17:
      sub_1BDBAD4(viewerListViewManager, *(_QWORD *)&dispType);
    case 1:
      viewerListViewManager = (ServantStatusCharaGraphViewerListViewManager_o *)this->fields.dragObjRootPanel;
      if ( !viewerListViewManager )
        goto LABEL_17;
