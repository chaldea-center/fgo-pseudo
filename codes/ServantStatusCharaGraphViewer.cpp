...
{
  __int64 v2; // x2
  ServantStatusCharaGraphViewer_o *v3; // x19
  ...
  if ( (byte_4B121E2 & 1) == 0 )
  {
    this = (ServantStatusCharaGraphViewer_o *)sub_1BCA7E0(&ServantStatusCharaGraphListViewItem_TypeInfo, method, v2);
    byte_4B121E2 = 1;
  }
  viewerListViewManager = v3->fields.viewerListViewManager;
  if ( !viewerListViewManager )
  ...
  if ( LOBYTE(centerItem->klass->vtable._0_Equals.methodPtr) < (unsigned int)methodPtr_low )
    return 0LL;
  if ( (ServantStatusCharaGraphListViewItem_c *)centerItem->klass->_2.typeHierarchy[methodPtr_low - 1] == ServantStatusCharaGraphListViewItem_TypeInfo )
    return centerItem;
  return 0LL;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !viewerListViewManager )
LABEL_11:
    sub_1BCAA3C(viewerListViewManager, method);
  ...
  switch ( dispType )
  {
    case 2:
      ...
      if ( viewerListViewManager )
      {
        ...
        if ( viewerListViewManager )
        {
          ((void (__fastcall *)(ServantStatusCharaGraphViewerListViewManager_o *, Il2CppMethodPointer, float))viewerListViewManager->klass->vtable._8_ItemDragStart.method)(
            viewerListViewManager,
            viewerListViewManager->klass->vtable._9_ItemDragEnd.methodPtr,
            0.0);
...
LABEL_17:
      sub_1BCAA3C(viewerListViewManager, *(_QWORD *)&dispType);
    case 1:
      viewerListViewManager = (ServantStatusCharaGraphViewerListViewManager_o *)this->fields.dragObjRootPanel;
      if ( !viewerListViewManager )
        goto LABEL_17;
      ((void (__fastcall *)(ServantStatusCharaGraphViewerListViewManager_o *, Il2CppMethodPointer, const MethodInfo *, float))viewerListViewManager->klass->vtable._8_ItemDragStart.method)(
        viewerListViewManager,
        viewerListViewManager->klass->vtable._9_ItemDragEnd.methodPtr,
        method,
        1.0);
    ...
    case 0:
      ...
      if ( viewerListViewManager )
      {
        ...
        if ( viewerListViewManager )
        {
          ...
          LODWORD(v5) = 0;
LABEL_11:
          ((void (__fastcall *)(long double))klass->vtable._8_ItemDragStart.method)(v5);
          return;
        }
      }
      goto LABEL_17;
        ...
        const MethodInfo *method)
{
  ...
  viewerListViewManager = this->fields.viewerListViewManager;
  if ( !viewerListViewManager )
    sub_1BCAA3C(0LL, *(_QWORD *)&dispType);
