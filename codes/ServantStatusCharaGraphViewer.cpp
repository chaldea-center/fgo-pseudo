        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A56D12 & 1) == 0 )
  {
    this = (ServantStatusCharaGraphViewer_o *)sub_1B885B0(&ServantStatusCharaGraphListViewItem_TypeInfo);
    byte_4A56D12 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !viewerListViewManager )
LABEL_11:
    sub_1B8880C(viewerListViewManager, method);
...
LABEL_17:
      sub_1B8880C(viewerListViewManager, *(_QWORD *)&dispType);
    case 1:
      viewerListViewManager = (ServantStatusCharaGraphViewerListViewManager_o *)this->fields.dragObjRootPanel;
      if ( !viewerListViewManager )
        goto LABEL_17;
