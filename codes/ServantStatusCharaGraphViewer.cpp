        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA238 & 1) == 0 )
  {
    this = (ServantStatusCharaGraphViewer_o *)sub_1B64870(&ServantStatusCharaGraphListViewItem_TypeInfo, method);
    byte_49FA238 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !viewerListViewManager )
LABEL_11:
    sub_1B64ACC(viewerListViewManager, method);
...
LABEL_17:
      sub_1B64ACC(viewerListViewManager, *(_QWORD *)&dispType);
    case 1:
      viewerListViewManager = (ServantStatusCharaGraphViewerListViewManager_o *)this->fields.dragObjRootPanel;
      if ( !viewerListViewManager )
        goto LABEL_17;
