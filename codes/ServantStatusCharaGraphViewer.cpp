        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD8468 & 1) == 0 )
  {
    this = (ServantStatusCharaGraphViewer_o *)sub_1C21E38(&ServantStatusCharaGraphListViewItem_TypeInfo);
    byte_4BD8468 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !viewerListViewManager )
LABEL_11:
    sub_1C22094(viewerListViewManager, method);
...
LABEL_17:
      sub_1C22094(viewerListViewManager, *(_QWORD *)&dispType);
    case 1:
      viewerListViewManager = (ServantStatusCharaGraphViewerListViewManager_o *)this->fields.dragObjRootPanel;
      if ( !viewerListViewManager )
        goto LABEL_17;
