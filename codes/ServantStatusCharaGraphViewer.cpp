        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B9F2 & 1) == 0 )
  {
    this = (ServantStatusCharaGraphViewer_o *)sub_1B90010(&ServantStatusCharaGraphListViewItem_TypeInfo, method);
    byte_4A6B9F2 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !viewerListViewManager )
LABEL_11:
    sub_1B9026C(viewerListViewManager, method);
...
LABEL_17:
      sub_1B9026C(viewerListViewManager, *(_QWORD *)&dispType);
    case 1:
      viewerListViewManager = (ServantStatusCharaGraphViewerListViewManager_o *)this->fields.dragObjRootPanel;
      if ( !viewerListViewManager )
        goto LABEL_17;
