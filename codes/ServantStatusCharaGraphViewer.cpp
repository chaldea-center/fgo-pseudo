        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB1E61 & 1) == 0 )
  {
    this = (ServantStatusCharaGraphViewer_o *)sub_1BAB41C(&ServantStatusCharaGraphListViewItem_TypeInfo, method);
    byte_4AB1E61 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !viewerListViewManager )
LABEL_11:
    sub_1BAB678(viewerListViewManager, method);
...
LABEL_17:
      sub_1BAB678(viewerListViewManager, *(_QWORD *)&dispType);
    case 1:
      viewerListViewManager = (ServantStatusCharaGraphViewerListViewManager_o *)this->fields.dragObjRootPanel;
      if ( !viewerListViewManager )
        goto LABEL_17;
