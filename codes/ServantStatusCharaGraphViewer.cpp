        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2D155 & 1) == 0 )
  {
    this = (ServantStatusCharaGraphViewer_o *)sub_1C93AD4(&ServantStatusCharaGraphListViewItem_TypeInfo);
    byte_4D2D155 = 1;
  }
...
bool ServantStatusCharaGraphViewer__IsAbleToPinch(ServantStatusCharaGraphViewer_o *this, const MethodInfo *method)
{
  ...
  if ( !viewerListViewManager )
LABEL_11:
    sub_1C93D2C(viewerListViewManager, method);
...
LABEL_17:
      sub_1C93D2C(viewerListViewManager, *(_QWORD *)&dispType);
    case 1:
      viewerListViewManager = (ServantStatusCharaGraphViewerListViewManager_o *)this->fields.dragObjRootPanel;
      if ( !viewerListViewManager )
        goto LABEL_17;
