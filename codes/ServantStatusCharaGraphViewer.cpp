        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB0654 & 1) == 0 )
  {
    this = (ServantStatusCharaGraphViewer_o *)sub_1C13D24(&ServantStatusCharaGraphListViewItem_TypeInfo, method);
    byte_4BB0654 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !viewerListViewManager )
LABEL_11:
    sub_1C13F80(viewerListViewManager, method);
...
LABEL_17:
      sub_1C13F80(viewerListViewManager, *(_QWORD *)&dispType);
    case 1:
      viewerListViewManager = (ServantStatusCharaGraphViewerListViewManager_o *)this->fields.dragObjRootPanel;
      if ( !viewerListViewManager )
        goto LABEL_17;
