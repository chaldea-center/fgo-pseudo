void __fastcall SetItemMaster___ctor(SetItemMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A20365 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataMasterBase_SetItemMaster__SetItemEntity__string___ctor__, method);
    byte_4A20365 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    117,
    (const MethodInfo_30F8A78 *)Method_DataMasterBase_SetItemMaster__SetItemEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20363 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataMasterBase_SetItemMaster__SetItemEntity__string__GetEntity__, *(_QWORD *)&id);
    byte_4A20363 = 1;
  }
  ...
  return (SetItemEntity_o *)DataMasterBase_object__object__object___GetEntity(
                              (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                              PK,
                              (const MethodInfo_30F8AB8 *)Method_DataMasterBase_SetItemMaster__SetItemEntity__string__GetEntity__);
}
...
SetItemEntity_array *__fastcall SetItemMaster__GetList(SetItemMaster_o *this, int32_t id, const MethodInfo *method)
{
  ...
  if ( (byte_4A20367 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_System_Collections_Generic_List_SetItemEntity__Add__, v6);
    sub_1B715CC(&Method_System_Collections_Generic_List_SetItemEntity__ToArray__, v7);
    sub_1B715CC(&Method_System_Collections_Generic_List_SetItemEntity___ctor__, v8);
    sub_1B715CC(&System_Collections_Generic_List_SetItemEntity__TypeInfo, v9);
    sub_1B715CC(&SetItemEntity_TypeInfo, v10);
    byte_4A20367 = 1;
  }
  v11 = (System_Collections_Generic_List_object__o *)sub_1B71818(System_Collections_Generic_List_SetItemEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v11,
    (const MethodInfo_34CFA2C *)Method_System_Collections_Generic_List_SetItemEntity___ctor__);
...
LABEL_17:
  ...
  return (SetItemEntity_array *)System_Collections_Generic_List_object___ToArray(
                                  v11,
                                  (const MethodInfo_34D1DB8 *)Method_System_Collections_Generic_List_SetItemEntity__ToArray__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20366 & 1) == 0 )
  {
    sub_1B715CC(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__, itemNum);
    sub_1B715CC(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Item__, v15);
    sub_1B715CC(&Method_DataManager_GetMasterData_ServantMaster___, v16);
    sub_1B715CC(&Method_DataMasterBase_ServantMaster__ServantEntity__int__GetEntity__, v17);
    sub_1B715CC(&SetItemEntity_TypeInfo, v18);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20364 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataMasterBase_SetItemMaster__SetItemEntity__string__TryGetEntity__, entity);
    byte_4A20364 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_30F8B08 *)Method_DataMasterBase_SetItemMaster__SetItemEntity__string__TryGetEntity__);
}