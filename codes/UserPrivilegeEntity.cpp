        ...
        const MethodInfo *method)
{
  if ( (byte_4B45925 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataEntityBase_CreateMultiplePK_long__int___, *(_QWORD *)&privilegeId);
    byte_4B45925 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45924 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMaster_PrivilegeMaster___, startAt);
    sub_1BDB878(&DataManager_TypeInfo, v9);
    sub_1BDB878(&Method_DataMasterBase_PrivilegeMaster__PrivilegeEntity__int__TryGetEntity__, v10);
  ...
  *endAt = 0LL;
  ...
  Master_object = DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_PrivilegeMaster___);
  if ( !Master_object )
    goto LABEL_18;
  if ( !DataMasterBase_object__object__int___TryGetEntity(
          ...
          (const MethodInfo_32E1E88 *)Method_DataMasterBase_PrivilegeMaster__PrivilegeEntity__int__TryGetEntity__) )
    return 0;
