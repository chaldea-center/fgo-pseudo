        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C281D4 & 1) == 0 )
  {
    sub_1C2D490(&Method_DataManager_GetMaster_PrivilegeMaster___);
    sub_1C2D490(&DataManager_TypeInfo);
    sub_1C2D490(&Method_DataMasterBase_PrivilegeMaster__PrivilegeEntity__int__TryGetEntity__);
  ...
  *endAt = 0;
  ...
  Master_object = DataManager__GetMaster_object_((const MethodInfo_30CE8FC *)Method_DataManager_GetMaster_PrivilegeMaster___);
  if ( !Master_object )
    goto LABEL_18;
  if ( !DataMasterBase_object__object__int___TryGetEntity(
          ...
          (const MethodInfo_3387DE4 *)Method_DataMasterBase_PrivilegeMaster__PrivilegeEntity__int__TryGetEntity__) )
    return 0;
