        ...
        const MethodInfo *method)
{
  if ( (byte_4C22D86 & 1) == 0 )
  {
    sub_1C3B764(&Method_DataEntityBase_CreateMultiplePK_long__int___, *(_QWORD *)&privilegeId);
    byte_4C22D86 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C22D85 & 1) == 0 )
  {
    sub_1C3B764(&Method_DataManager_GetMaster_PrivilegeMaster___, startAt);
    sub_1C3B764(&DataManager_TypeInfo, v9);
    sub_1C3B764(&Method_DataMasterBase_PrivilegeMaster__PrivilegeEntity__int__TryGetEntity__, v10);
  ...
  *endAt = 0LL;
  ...
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2FF01B0 *)Method_DataManager_GetMaster_PrivilegeMaster___);
  if ( !Master_object )
    goto LABEL_18;
  if ( !DataMasterBase_object__object__int___TryGetEntity(
          ...
          (const MethodInfo_329AE94 *)Method_DataMasterBase_PrivilegeMaster__PrivilegeEntity__int__TryGetEntity__) )
    return 0;
