        ...
        const MethodInfo *method)
{
  ...
  if ( !BasicHelper__IsNullOrEmpty((System_Collections_ICollection_o *)ImageValue, 0) )
  {
    ...
    v8 = System_String__Concat_64463988(v6, (System_String_o *)StringLiteral_16207/*"_"*/, v7, 0);
    *defaultName = v8;
    sub_1C93A78((GrandQuestFolderBoardItem_o *)defaultName, (int32_t)v8, v9, v10, v11, v12, v13, v14);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D318AC & 1) == 0 )
  {
    sub_1C93AD4(&System_Comparison_ImagePartsGroupEntity__TypeInfo);
    sub_1C93AD4(&Method_DataManager_GetMaster_ImagePartsGroupMaster___);
    sub_1C93AD4(&DataManager_TypeInfo);
    sub_1C93AD4(&Method_System_Collections_Generic_List_Enumerator_ImagePartsGroupEntity__Dispose__);
    sub_1C93AD4(&Method_System_Collections_Generic_List_Enumerator_ImagePartsGroupEntity__MoveNext__);
    sub_1C93AD4(&Method_System_Collections_Generic_List_Enumerator_ImagePartsGroupEntity__get_Current__);
    sub_1C93AD4(&Method_System_Collections_Generic_List_int__Add__);
    sub_1C93AD4(&Method_System_Collections_Generic_List_ImagePartsGroupEntity__Add__);
    sub_1C93AD4(&Method_System_Collections_Generic_List_ImagePartsGroupEntity__GetEnumerator__);
    sub_1C93AD4(&Method_System_Collections_Generic_List_ImagePartsGroupEntity__Sort__);
    sub_1C93AD4(&Method_System_Collections_Generic_List_int___ctor__);
    sub_1C93AD4(&Method_System_Collections_Generic_List_ImagePartsGroupEntity___ctor__);
    sub_1C93AD4(&Method_System_Collections_Generic_List_ImagePartsGroupEntity__get_Count__);
    sub_1C93AD4(&System_Collections_Generic_List_int__TypeInfo);
    sub_1C93AD4(&System_Collections_Generic_List_ImagePartsGroupEntity__TypeInfo);
    sub_1C93AD4(&Method_UserImagePartsGroupEntity___c__GetImageValue_b__3_0__);
    sub_1C93AD4(&UserImagePartsGroupEntity___c_TypeInfo);
    byte_4D318AC = 1;
  }
  entity = 0;
  ...
  if ( !idxs->max_length )
    goto LABEL_37;
  v7 = (System_Collections_Generic_List_object__o *)sub_1C93D20(System_Collections_Generic_List_ImagePartsGroupEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v7,
    (const MethodInfo_3879168 *)Method_System_Collections_Generic_List_ImagePartsGroupEntity___ctor__);
  v8 = this->fields.idxs;
  if ( !v8 )
    goto LABEL_41;
...
LABEL_21:
  ...
  if ( v7->fields._size >= 1 )
  {
    ...
    if ( !_9__3_0 )
    {
      ...
      _9__3_0 = (System_Comparison_T__o *)sub_1C93D20(System_Comparison_ImagePartsGroupEntity__TypeInfo);
    ...
    System_Collections_Generic_List_object___Sort_59225184(
      v7,
      _9__3_0,
      (const MethodInfo_387B460 *)Method_System_Collections_Generic_List_ImagePartsGroupEntity__Sort__);
    System_Collections_Generic_List_object___GetEnumerator(
      (System_Collections_Generic_List_Enumerator_T__o *)&v39,
      v7,
      (const MethodInfo_387A494 *)Method_System_Collections_Generic_List_ImagePartsGroupEntity__GetEnumerator__);
    v40 = v39;
    while ( 1 )
    {
      v32 = System_Collections_Generic_List_Enumerator_object___MoveNext(
              &v40,
              (const MethodInfo_35FA018 *)Method_System_Collections_Generic_List_Enumerator_ImagePartsGroupEntity__MoveNext__);
      if ( !v32 )
        break;
      ...
      if ( (unsigned int)v37 >= LODWORD(v35->max_length) )
      {
        System_Collections_Generic_List_int___AddWithResize(
          v21,
          monitor_high,
          *(const MethodInfo_385C978 **)(*(_QWORD *)(v36[4] + 192LL) + 112LL));
      }
      else
      {
    ...
    System_Collections_Generic_List_Enumerator_object___Dispose(
      &v40,
      (const MethodInfo_35FA014 *)Method_System_Collections_Generic_List_Enumerator_ImagePartsGroupEntity__Dispose__);
  }
  else
  {
LABEL_37:
...
void UserImagePartsGroupEntity___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C93D20(UserImagePartsGroupEntity___c_TypeInfo);
