        ...
        const MethodInfo *method)
{
  ...
  int32_t v80; // [xsp+28h] [xbp-A8h]
  int32_t level; // [xsp+2Ch] [xbp-A4h]
  NpcFollowerMaster_o *Master_object; // [xsp+30h] [xbp-A0h]
  DataMasterBase_TMaster__TEntity__PKType__o *v83; // [xsp+38h] [xbp-98h]
  GrandQuestFolderBoardItem_o *p_focusMemberItem; // [xsp+40h] [xbp-90h]
  QuestGroupMaster_o *v85; // [xsp+48h] [xbp-88h]
  Il2CppObject *v86; // [xsp+50h] [xbp-80h]
  ...
  if ( (byte_4CEC20A & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_DataManager_GetMasterData_WarBoardMaster___);
    ...
    sub_1C7BAE8(&Method_DataMasterBase_WarBoardStageMaster__WarBoardStageEntity__int__GetEntity__);
    sub_1C7BAE8(&Method_DataMasterBase_WarBoardMaster__WarBoardEntity__int__GetEntity__);
    ...
    sub_1C7BAE8(&Method_System_Collections_Generic_List_PartyOrganizationListViewItem__ToArray__);
  ...
  if ( (*(_BYTE *)(MasterData_object + 309) & 1) == 0 )
    MasterData_object = sub_1C51B7C(v10);
  ...
  v19 = DataMasterBase_object__object__int___GetEntity(
          ...
          v16,
          (const MethodInfo_342E2FC *)Method_DataMasterBase_WarBoardStageMaster__WarBoardStageEntity__int__GetEntity__);
  if ( v19 )
  ...
  MasterData_object = (__int64)DataManager__GetMasterData_object_(
                                 (DataManager_o *)MasterData_object,
                                 (const MethodInfo_31703F4 *)Method_DataManager_GetMasterData_WarBoardMaster___);
  if ( !MasterData_object )
    goto LABEL_83;
  v24 = DataMasterBase_object__object__int___GetEntity(
          (DataMasterBase_TMaster__TEntity__PKType__o *)MasterData_object,
          klass_high,
          (const MethodInfo_342E2FC *)Method_DataMasterBase_WarBoardMaster__WarBoardEntity__int__GetEntity__);
  if ( !v24 )
  {
    monitor_high = 0;
    if ( v15 )
...
LABEL_32:
  ...
  v29 = (System_Collections_Generic_List_object__o *)sub_1C7BD34(System_Collections_Generic_List_PartyOrganizationListViewItem__TypeInfo);
  ...
  {
    v35 = 0;
    p_focusMemberItem = (GrandQuestFolderBoardItem_o *)&this->fields.focusMemberItem;
    while ( 1 )
    {
      if ( v35 >= max_length )
LABEL_84:
      ...
      RestrictionEntity = WarBoardPartyListViewItem__GetRestrictionEntity(
                            ...
                            v31);
      v38 = (QuestRestrictionInfo_o *)sub_1C7BD34(QuestRestrictionInfo_TypeInfo);
      QuestRestrictionInfo___ctor_43942540(v38, v32, v30, questPhase, RestrictionEntity, 0);
      if ( !v33 )
        goto LABEL_83;
      ...
      if ( WarBoardPieceData__get_IsNpc(v36, 0) )
      {
        ...
        if ( !Master_object )
          goto LABEL_83;
        MasterData_object = (__int64)NpcFollowerMaster__GetEntity_42984448(
                                       Master_object,
                                       v30,
                                       questPhase,
                                       v36->fields._npcId_k__BackingField,
        ...
        if ( MasterData_object )
        {
          ...
          MasterData_object = NpcFollowerEntity__GetImageSvtId(v50, 0);
        ...
        if ( v36->fields._npcEquipId_k__BackingField >= 1 )
        {
          ...
          if ( v55 )
          {
            ...
            v58 = (EquipTargetInfo_o *)sub_1C7BD34(EquipTargetInfo_TypeInfo);
            EquipTargetInfo___ctor_42285744(v58, monitor, klass, level, 0, 0);
            if ( !FollowerInfo )
              goto LABEL_83;
            FollowerInfo__SetEquipInfoForNpc(FollowerInfo, v58, 0);
            v32 = monitor_high;
            v53 = questId;
          }
        }
        EventId = v32;
        if ( v85 )
          EventId = QuestGroupMaster__GetEventId(v85, v53, 0);
        v60 = (EventUpValSetupInfo_o *)sub_1C7BD34(EventUpValSetupInfo_TypeInfo);
        EventUpValSetupInfo___ctor(v60, v53, questPhase, EventId, 0);
        v42 = (PartyOrganizationListViewItem_o *)sub_1C7BD34(PartyOrganizationListViewItem_TypeInfo);
        PartyOrganizationListViewItem___ctor_34616624(v42, v35, FollowerInfo, 1, 0, v60, v38, 0, 0, 0, 0, 0, 0);
LABEL_70:
        v32 = monitor_high;
        v33 = (DataMasterBase_TMaster__TEntity__PKType__o *)v86;
        goto LABEL_71;
      ...
      v42 = (PartyOrganizationListViewItem_o *)sub_1C7BD34(PartyOrganizationListViewItem_TypeInfo);
      PartyOrganizationListViewItem___ctor_34654812(v42, v35, 0, 0, v38, 1, 0, 0, 0);
LABEL_71:
      if ( !v42 )
        goto LABEL_83;
      ...
      {
        p_focusMemberItem->klass = (GrandQuestFolderBoardItem_c *)v42;
        sub_1C7BA8C(p_focusMemberItem, (int32_t)v42, v43, v44, v45, v46, v47, v48);
      }
      ...
      else
      {
        ...
        sub_1C7BA8C((GrandQuestFolderBoardItem_o *)(v72 + 4), (int32_t)v42, v63, v64, v65, v66, v67, v68);
      }
      max_length = pieces->max_length;
      v30 = questId;
    ...
    if ( v85 )
      v32 = QuestGroupMaster__GetEventId(v85, v30, 0);
    v39 = (EventUpValSetupInfo_o *)sub_1C7BD34(EventUpValSetupInfo_TypeInfo);
    EventUpValSetupInfo___ctor(v39, v30, questPhase, v32, 0);
    v40 = entity;
    MasterData_object = sub_1C7BB90(long___TypeInfo, 1);
    if ( !MasterData_object )
      goto LABEL_83;
...
LABEL_83:
  ...
  v73 = System_Collections_Generic_List_object___ToArray(
          v29,
          (const MethodInfo_3840954 *)Method_System_Collections_Generic_List_PartyOrganizationListViewItem__ToArray__);
  this->fields.memberItemList = (struct PartyOrganizationListViewItem_array *)v73;
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.memberItemList, (int32_t)v73, v74, v75, v76, v77, v78, v79);
}
        ...
        const MethodInfo *method)
{
  ...
  GrandQuestFolderBoardItem_o *p_focusMemberItem; // x20
    ...
    while ( 1 )
    {
      ...
      *(_QWORD *)&pieceIndex = memberItemList->m_Items[v11];
      if ( !*(_QWORD *)&pieceIndex )
        break;
      if ( *(_DWORD *)(*(_QWORD *)&pieceIndex + 384LL) == v10 )
      {
        p_focusMemberItem->klass = *(GrandQuestFolderBoardItem_c **)&pieceIndex;
        sub_1C7BA8C(p_focusMemberItem, pieceIndex, (int32_t)method, v3, v4, v5, v6, v7);
      }
      max_length = memberItemList->max_length;
...
LABEL_11:
    sub_1C7BD40(this, *(_QWORD *)&pieceIndex);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !MasterData_object
    || (MasterData_object = DataManager__GetMasterData_object_(
                              (DataManager_o *)MasterData_object,
                              (const MethodInfo_31703F4 *)Method_DataManager_GetMasterData_RestrictionMaster___)) == 0 )
  {
    sub_1C7BD40(MasterData_object, *(_QWORD *)&restrictionId);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( userSvtEquipId >= 1 )
  {
    ...
    if ( !memberItemList )
LABEL_9:
      sub_1C7BD40(this, userSvtEquipId);
    v6 = 0;
    while ( 1 )
    {
      max_length = memberItemList->max_length;
