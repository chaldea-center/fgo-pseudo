        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24F2F & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_DataManager_GetMasterData_WarBoardMaster___);
    ...
    sub_1C2D490(&Method_DataMasterBase_WarBoardMaster__WarBoardEntity__int__GetEntity__);
    ...
    sub_1C2D490(&Method_System_Collections_Generic_List_PartyOrganizationListViewItem__ToArray__);
  ...
  if ( (*(_BYTE *)(MasterData_object + 309) & 1) == 0 )
    MasterData_object = sub_1C7DBA4(v10);
  ...
  MasterData_object = (__int64)DataManager__GetMasterData_object_(
                                 (DataManager_o *)MasterData_object,
                                 (const MethodInfo_30CE950 *)Method_DataManager_GetMasterData_WarBoardMaster___);
  if ( !MasterData_object )
    goto LABEL_83;
  v24 = DataMasterBase_object__object__int___GetEntity(
          (DataMasterBase_TMaster__TEntity__PKType__o *)MasterData_object,
          klass_high,
          (const MethodInfo_3387D98 *)Method_DataMasterBase_WarBoardMaster__WarBoardEntity__int__GetEntity__);
  if ( !v24 )
  {
    monitor_high = 0;
    if ( v15 )
...
LABEL_32:
  ...
  v29 = (System_Collections_Generic_List_object__o *)sub_1C2D6DC(System_Collections_Generic_List_PartyOrganizationListViewItem__TypeInfo);
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      if ( v35 >= max_length )
LABEL_84:
        sub_1C2D6F4(MasterData_object, v9, v31);
      ...
      RestrictionEntity = WarBoardPartyListViewItem__GetRestrictionEntity(
                            ...
                            v31);
      v38 = (QuestRestrictionInfo_o *)sub_1C2D6DC(QuestRestrictionInfo_TypeInfo);
      QuestRestrictionInfo___ctor_43174808(v38, v32, v30, questPhase, RestrictionEntity, 0);
      if ( !v33 )
        goto LABEL_83;
      ...
      if ( WarBoardPieceData__get_IsNpc(v36, 0) )
      {
        ...
        if ( !Master_object )
          goto LABEL_83;
        MasterData_object = (__int64)NpcFollowerMaster__GetEntity_42187164(
                                       Master_object,
                                       v30,
                                       questPhase,
                                       v36->fields._npcId_k__BackingField,
        ...
        if ( v36->fields._npcEquipId_k__BackingField >= 1 )
        {
          ...
          if ( v51 )
          {
            ...
            v54 = (EquipTargetInfo_o *)sub_1C2D6DC(EquipTargetInfo_TypeInfo);
            EquipTargetInfo___ctor_41488412(v54, monitor, klass, level, 0, 0);
            if ( !FollowerInfo )
              goto LABEL_83;
        ...
        v56 = (EventUpValSetupInfo_o *)sub_1C2D6DC(EventUpValSetupInfo_TypeInfo);
        ...
        PartyOrganizationListViewItem___ctor_33993044(v42, v35, FollowerInfo, 1, 0, v56, v38, 0, 0, 0, 0, 0);
LABEL_70:
        v32 = monitor_high;
        v33 = (DataMasterBase_TMaster__TEntity__PKType__o *)v74;
        goto LABEL_71;
      ...
      v42 = (PartyOrganizationListViewItem_o *)sub_1C2D6DC(PartyOrganizationListViewItem_TypeInfo);
      PartyOrganizationListViewItem___ctor_34030324(v42, v35, 0, 0, v38, 1, 0, 0);
LABEL_71:
      if ( !v42 )
        goto LABEL_83;
      ...
      if ( focusPiece && index_k__BackingField == focusPiece->fields._index_k__BackingField )
      {
        ...
        sub_1C2D434(p_focusMemberItem, (int32_t)v42, v43, v44);
      }
      ...
      else
      {
        ...
        sub_1C2D434((CGThumbnailListItem_o *)(v64 + 4), (int32_t)v42, v59, v60);
      }
      max_length = pieces->max_length;
      v30 = questId;
    ...
    v39 = (EventUpValSetupInfo_o *)sub_1C2D6DC(EventUpValSetupInfo_TypeInfo);
    EventUpValSetupInfo___ctor(v39, v30, questPhase, v32, 0);
    v40 = entity;
    MasterData_object = sub_1C2D538(long___TypeInfo, 1);
    if ( !MasterData_object )
      goto LABEL_83;
    ...
    *(_QWORD *)(MasterData_object + 32) = v36->fields._UserServantEquipId_k__BackingField;
    v42 = (PartyOrganizationListViewItem_o *)sub_1C2D6DC(PartyOrganizationListViewItem_TypeInfo);
    PartyOrganizationListViewItem___ctor_34019620(v42, v35, (UserServantEntity_o *)v40, v41, v39, v38, 0, 0, 0, 0, 0, 0);
    goto LABEL_70;
  }
LABEL_81:
...
LABEL_83:
  ...
  v65 = System_Collections_Generic_List_object___ToArray(
          v29,
          (const MethodInfo_378B6DC *)Method_System_Collections_Generic_List_PartyOrganizationListViewItem__ToArray__);
  this->fields.memberItemList = (struct PartyOrganizationListViewItem_array *)v65;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.memberItemList, (int32_t)v65, v66, v67);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( max_length >= 1 )
  {
    ...
    {
      if ( v7 >= max_length )
        sub_1C2D6F4(this, *(_QWORD *)&pieceIndex, method);
      *(_QWORD *)&pieceIndex = memberItemList->m_Items[v7];
      ...
      if ( *(_DWORD *)(*(_QWORD *)&pieceIndex + 384LL) == v6 )
      {
        ...
        sub_1C2D434(p_focusMemberItem, pieceIndex, (int32_t)method, v3);
      }
      max_length = memberItemList->max_length;
...
LABEL_11:
    sub_1C2D6EC(this, *(_QWORD *)&pieceIndex);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !MasterData_object
    || (MasterData_object = DataManager__GetMasterData_object_(
                              (DataManager_o *)MasterData_object,
                              (const MethodInfo_30CE950 *)Method_DataManager_GetMasterData_RestrictionMaster___)) == 0 )
  {
    sub_1C2D6EC(MasterData_object, *(_QWORD *)&restrictionId);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( userSvtEquipId >= 1 )
  {
    ...
    if ( !memberItemList )
LABEL_9:
      sub_1C2D6EC(this, userSvtEquipId);
    v6 = 0;
    while ( 1 )
    {
      max_length = memberItemList->max_length;
      ...
      if ( (unsigned int)v6 >= max_length )
        sub_1C2D6F4(this, userSvtEquipId, method);
...
LABEL_10:
  ...
  while ( 1 )
  {
    ...
    if ( (unsigned int)v7 >= max_length )
      sub_1C2D6F4(this, *(_QWORD *)&index, userSvtEquipId);
        ...
        const MethodInfo *method)
{
  ...
  if ( max_length <= index1 || max_length <= index2 )
    sub_1C2D6F4(this, *(_QWORD *)&index1, *(_QWORD *)&index2);
  this = (WarBoardPartyListViewItem_o *)memberItemList->m_Items[index1];
  if ( !this )
LABEL_7:
    sub_1C2D6EC(this, index1);
