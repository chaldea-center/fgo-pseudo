        ...
        const MethodInfo *method)
{
  ...
  if ( System_String__IsNullOrEmpty(this->fields.createdAtString, 0) )
  {
    ...
    sub_1C36FFC(p_createdAtString, (int32_t)DateTime, v6, v7);
  }
...
System_String_o *UserGachaHistoryEntity__get_TitleToString(UserGachaHistoryEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C43E63 & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_12445/*"SUMMON_EXTRA_ITEM_GIFTS_TITLE"*/);
    byte_4C43E63 = 1;
  }
  ...
  if ( System_String__IsNullOrEmpty(this->fields.titleString, 0) )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v4 = LocalizationManager__Get((System_String_o *)StringLiteral_12431/*"SUMMON_BOUNS_ITEM_GIFTS_TITLE"*/, 0);
    gachaExtraGiftBonusType = this->fields.gachaExtraGiftBonusType;
    if ( gachaExtraGiftBonusType == 3 )
    {
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v9 = &StringLiteral_12420/*"SUMMON_BONUS_ITEM_GIFTS_FREE"*/;
    }
    else
    {
      v8 = v4;
...
LABEL_15:
        *p_titleString = v8;
        sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.titleString, (int32_t)v8, v5, v6);
        return *p_titleString;
      }
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v9 = &StringLiteral_12445/*"SUMMON_EXTRA_ITEM_GIFTS_TITLE"*/;
    }
