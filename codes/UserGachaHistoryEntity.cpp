        ...
        const MethodInfo *method)
{
  ...
  if ( System_String__IsNullOrEmpty(this->fields.createdAtString, 0LL) )
  {
    ...
    sub_1B88554(p_createdAtString, (int32_t)DateTime, v6, v7);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5BE6D & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_12348/*"SUMMON_EXTRA_ITEM_GIFTS_TITLE"*/);
    byte_4A5BE6D = 1;
  }
  ...
  if ( System_String__IsNullOrEmpty(this->fields.titleString, 0LL) )
  {
    ...
    if ( gachaExtraGiftBonusType == 2 )
      v5 = (System_String_o **)&StringLiteral_12348/*"SUMMON_EXTRA_ITEM_GIFTS_TITLE"*/;
    else
      v5 = (System_String_o **)&StringLiteral_12335/*"SUMMON_BOUNS_ITEM_GIFTS_TITLE"*/;
    v6 = LocalizationManager__Get(*v5, 0LL);
    p_titleString->klass = (ServantStatusBattleListViewItem_c *)v6;
    sub_1B88554(p_titleString, (int32_t)v6, v7, v8);
  }
