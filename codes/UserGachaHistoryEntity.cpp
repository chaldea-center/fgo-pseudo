        ...
        const MethodInfo *method)
{
  ...
  if ( System_String__IsNullOrEmpty(this->fields.createdAtString, 0) )
  {
    ...
    sub_1C3E508(p_createdAtString, (int32_t)DateTime, v6, v7);
  }
...
System_String_o *UserGachaHistoryEntity__get_TitleToString(UserGachaHistoryEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C57C1B & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_12453/*"SUMMON_EXTRA_ITEM_GIFTS_TITLE"*/);
    byte_4C57C1B = 1;
  }
  ...
  if ( System_String__IsNullOrEmpty(this->fields.titleString, 0) )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v4 = LocalizationManager__Get((System_String_o *)StringLiteral_12439/*"SUMMON_BOUNS_ITEM_GIFTS_TITLE"*/, 0);
    gachaExtraGiftBonusType = this->fields.gachaExtraGiftBonusType;
    if ( gachaExtraGiftBonusType == 3 )
    {
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v9 = &StringLiteral_12428/*"SUMMON_BONUS_ITEM_GIFTS_FREE"*/;
    }
    else
    {
      v8 = v4;
...
LABEL_15:
        *p_titleString = v8;
        sub_1C3E508((CGThumbnailListItem_o *)&this->fields.titleString, (int32_t)v8, v5, v6);
        return *p_titleString;
      }
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v9 = &StringLiteral_12453/*"SUMMON_EXTRA_ITEM_GIFTS_TITLE"*/;
    }
