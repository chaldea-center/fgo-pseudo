void __fastcall SkillListTreasureDeviceComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A1F068 & 1) == 0 )
  {
    sub_1B715CC(&SkillListTreasureDeviceComponent_TypeInfo, v1);
    byte_4A1F068 = 1;
  }
...
LABEL_15:
    sub_1B71828(skillLevelListLabel, method);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1F067 & 1) == 0 )
  {
    sub_1B715CC(&AtlasManager_TypeInfo, skillLevelListText);
    sub_1B715CC(&UnityEngine_Object_TypeInfo, v13);
    sub_1B715CC(&SkillListTreasureDeviceComponent_TypeInfo, v14);
    sub_1B715CC(&StringLiteral_20126/*"icon_skill_mini"*/, v15);
    byte_4A1F067 = 1;
  }
  ...
  *(UnityEngine_Vector3_o *)(&v19 - 1) = UnityEngine_Transform__get_localPosition(
  ...
  {
LABEL_41:
    sub_1B71828(skillLevelListLabel, v16);
  }
  v25 = v23;
  v26 = v24;
  ...
  if ( UnityEngine_Object__op_Inequality(skillIconSprite, 0LL, 0LL) )
  {
    ...
    AtlasManager__SetEventSprite(v33, (System_String_o *)StringLiteral_20126/*"icon_skill_mini"*/, 0LL);
    skillLevelListLabel = (UILabel_o *)this->fields.skillIconSprite;
    if ( !skillLevelListLabel )
      goto LABEL_41;
