void __fastcall SkillListTreasureDeviceComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A08200 & 1) == 0 )
  {
    sub_1B686D4(&SkillListTreasureDeviceComponent_TypeInfo, v1);
    byte_4A08200 = 1;
  }
...
LABEL_15:
    sub_1B68930(skillLevelListLabel, method);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A081FF & 1) == 0 )
  {
    sub_1B686D4(&AtlasManager_TypeInfo, skillLevelListText);
    sub_1B686D4(&UnityEngine_Object_TypeInfo, v13);
    sub_1B686D4(&SkillListTreasureDeviceComponent_TypeInfo, v14);
    sub_1B686D4(&StringLiteral_20108/*"icon_skill_mini"*/, v15);
    byte_4A081FF = 1;
  }
  ...
  *(UnityEngine_Vector3_o *)(&v19 - 1) = UnityEngine_Transform__get_localPosition(
  ...
  {
LABEL_41:
    sub_1B68930(skillLevelListLabel, v16);
  }
  v25 = v23;
  v26 = v24;
  ...
  if ( UnityEngine_Object__op_Inequality(skillIconSprite, 0LL, 0LL) )
  {
    ...
    AtlasManager__SetEventSprite(v33, (System_String_o *)StringLiteral_20108/*"icon_skill_mini"*/, 0LL);
    skillLevelListLabel = (UILabel_o *)this->fields.skillIconSprite;
    if ( !skillLevelListLabel )
      goto LABEL_41;
