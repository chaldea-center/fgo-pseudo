void __fastcall SkillListTreasureDeviceComponent___cctor(const MethodInfo *method)
{
  if ( (byte_4A5A6FF & 1) == 0 )
  {
    sub_1B885B0(&SkillListTreasureDeviceComponent_TypeInfo);
    byte_4A5A6FF = 1;
  }
...
LABEL_15:
    sub_1B8880C(skillLevelListLabel, method);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  *(UnityEngine_Vector3_o *)(&v16 - 1) = UnityEngine_Transform__get_localPosition(
  ...
  {
LABEL_41:
    sub_1B8880C(skillLevelListLabel, v13);
  }
  v22 = v20;
  v23 = v21;
  ...
  if ( UnityEngine_Object__op_Inequality(skillIconSprite, 0LL, 0LL) )
  {
    ...
    AtlasManager__SetEventSprite(v30, (System_String_o *)StringLiteral_20178/*"icon_skill_mini"*/, 0LL);
    skillLevelListLabel = (UILabel_o *)this->fields.skillIconSprite;
    if ( !skillLevelListLabel )
      goto LABEL_41;
