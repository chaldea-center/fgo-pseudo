        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A72AE5 & 1) == 0 )
  {
    sub_1B90010(&CheckEnemyShiftAfterTask_TypeInfo, logic);
    sub_1B90010(&Method_System_Collections_Generic_List_BattleLogicTask__AddRange__, v4);
  ...
  if ( !v9
    || (System_Collections_Generic_List_object___AddRange(
        ...
        v13 = (BattleLogicTask_o *)sub_1B9025C(CheckEnemyShiftAfterTask_TypeInfo),
