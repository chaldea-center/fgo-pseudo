        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCA854 & 1) == 0 )
  {
    sub_1C1ABD4(&CheckEnemyShiftAfterTask_TypeInfo, logic);
    sub_1C1ABD4(&Method_System_Collections_Generic_List_BattleLogicTask__AddRange__, v4);
  ...
  if ( !v9
    || (System_Collections_Generic_List_object___AddRange(
        ...
        v13 = (BattleLogicTask_o *)sub_1C1AE20(CheckEnemyShiftAfterTask_TypeInfo),
