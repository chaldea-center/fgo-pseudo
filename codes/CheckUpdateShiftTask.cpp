        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB8A01 & 1) == 0 )
  {
    sub_1BAB41C(&CheckEnemyShiftAfterTask_TypeInfo, logic);
    sub_1BAB41C(&Method_System_Collections_Generic_List_BattleLogicTask__AddRange__, v4);
  ...
  if ( !v9
    || (System_Collections_Generic_List_object___AddRange(
        ...
        v13 = (BattleLogicTask_o *)sub_1BAB668(CheckEnemyShiftAfterTask_TypeInfo),
