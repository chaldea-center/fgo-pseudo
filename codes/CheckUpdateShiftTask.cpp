        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BDCFB & 1) == 0 )
  {
    sub_1B4CF90(&CheckEnemyShiftAfterTask_TypeInfo, logic);
    sub_1B4CF90(&Method_System_Collections_Generic_List_BattleLogicTask__AddRange__, v4);
  ...
  if ( !v9
    || (System_Collections_Generic_List_object___AddRange(
        ...
        v13 = (BattleLogicTask_o *)sub_1B4D1DC(CheckEnemyShiftAfterTask_TypeInfo),
