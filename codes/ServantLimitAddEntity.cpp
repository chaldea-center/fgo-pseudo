        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6742A & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_17135/*"ascensionAfterDialogId"*/, *(_QWORD *)&defaultValue);
    byte_4B6742A = 1;
  }
  return ServantLimitAddEntity__getScript(this, (System_String_o *)StringLiteral_17135/*"ascensionAfterDialogId"*/, defaultValue, v3);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4B67431 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_22728/*"overwriteServantParameterTitle"*/, defaultValue);
    byte_4B67431 = 1;
  }
  return EntityScriptUtil__GetStringValue(
           this->fields.script,
           (System_String_o *)StringLiteral_22728/*"overwriteServantParameterTitle"*/,
           defaultValue,
           0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67420 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_21402/*"limitCountUpResultServantLimitCount"*/, method);
    byte_4B67420 = 1;
  }
  return ServantLimitAddEntity__getScript(this, (System_String_o *)StringLiteral_21402/*"limitCountUpResultServantLimitCount"*/, -1, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67427 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_22679/*"overWriteTDRank"*/, v4);
    sub_1BE4ACC(&StringLiteral_1/*""*/, v5);
    byte_4B67427 = 1;
  }
  result = (System_String_o *)ServantLimitAddEntity__getScriptObject(this, (System_String_o *)StringLiteral_22679/*"overWriteTDRank"*/, v2);
  if ( result )
  {
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BE4ACC(&string_TypeInfo, method);
    sub_1BE4ACC(&StringLiteral_22681/*"overWriteTDTypeText"*/, v4);
    sub_1BE4ACC(&StringLiteral_1/*""*/, v5);
    byte_4B67428 = 1;
  }
  result = (System_String_o *)ServantLimitAddEntity__getScriptObject(this, (System_String_o *)StringLiteral_22681/*"overWriteTDTypeText"*/, v2);
  if ( result )
  {
    if ( result->klass == string_TypeInfo )
      return result;
        ...
        const MethodInfo *method)
{
  if ( (byte_4B67430 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_22702/*"overwriteCv"*/, *(_QWORD *)&defaultCvId);
    byte_4B67430 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_22702/*"overwriteCv"*/, defaultCvId, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BE4ACC(&string_TypeInfo, method);
    sub_1BE4ACC(&StringLiteral_22674/*"overWriteServantBattleName"*/, v4);
    sub_1BE4ACC(&StringLiteral_1/*""*/, v5);
    byte_4B67426 = 1;
  }
  result = (System_String_o *)ServantLimitAddEntity__getScriptObject(this, (System_String_o *)StringLiteral_22674/*"overWriteServantBattleName"*/, v2);
  if ( result )
  {
    if ( result->klass == string_TypeInfo )
      return result;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BE4ACC(&string_TypeInfo, method);
    sub_1BE4ACC(&StringLiteral_22675/*"overWriteServantName"*/, v4);
    sub_1BE4ACC(&StringLiteral_1/*""*/, v5);
    byte_4B67424 = 1;
  }
  result = (System_String_o *)ServantLimitAddEntity__getScriptObject(this, (System_String_o *)StringLiteral_22675/*"overWriteServantName"*/, v2);
  if ( result )
  {
    if ( result->klass == string_TypeInfo )
      return result;
        ...
        const MethodInfo *method)
{
  if ( (byte_4B67433 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_22727/*"overwriteServantParameter"*/, method);
    byte_4B67433 = 1;
  }
  return EntityScriptUtil__GetIntArray(this->fields.script, (System_String_o *)StringLiteral_22727/*"overwriteServantParameter"*/, 0LL, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  result = (System_String_o *)ServantLimitAddEntity__getScriptObject(this, (System_String_o *)StringLiteral_22676/*"overWriteServantShortName"*/, v2);
  if ( result )
  {
    if ( result->klass == string_TypeInfo )
      return result;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6742C & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_19233/*"en_waist"*/, v4);
    sub_1BE4ACC(&StringLiteral_10268/*"OverwriteShadowServantEffectNodes"*/, v5);
    byte_4B6742C = 1;
  }
  ScriptStringArrayParam = ServantLimitAddEntity__GetScriptStringArrayParam(
                             this,
                             (System_String_o *)StringLiteral_10268/*"OverwriteShadowServantEffectNodes"*/,
                             v2);
  if ( !ScriptStringArrayParam || (v7 = ScriptStringArrayParam, !*(_QWORD *)&ScriptStringArrayParam->max_length) )
  {
    ...
    if ( !*(_DWORD *)(v8 + 24) )
      sub_1BE4D30(v8, v9);
    v16 = StringLiteral_19233/*"en_waist"*/;
    *(_QWORD *)(v8 + 32) = StringLiteral_19233/*"en_waist"*/;
    sub_1BE4A70((PartyOrganizationUtility_o *)(v8 + 32), v16, v10, v11, v12, v13, v14, v15);
  }
  return v7;
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4B6742E & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_22733/*"overwriteSvtDetailName"*/, method);
    byte_4B6742E = 1;
  }
  return EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_22733/*"overwriteSvtDetailName"*/, 0LL, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BE4ACC(&string_TypeInfo, method);
    sub_1BE4ACC(&StringLiteral_22677/*"overWriteTDFileName"*/, v4);
    sub_1BE4ACC(&StringLiteral_1/*""*/, v5);
    byte_4B67423 = 1;
  }
  result = (System_String_o *)ServantLimitAddEntity__getScriptObject(this, (System_String_o *)StringLiteral_22677/*"overWriteTDFileName"*/, v2);
  if ( result )
  {
    if ( result->klass == string_TypeInfo )
      return result;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BE4ACC(&string_TypeInfo, method);
    sub_1BE4ACC(&StringLiteral_22678/*"overWriteTDName"*/, v4);
    sub_1BE4ACC(&StringLiteral_1/*""*/, v5);
    byte_4B67421 = 1;
  }
  result = (System_String_o *)ServantLimitAddEntity__getScriptObject(this, (System_String_o *)StringLiteral_22678/*"overWriteTDName"*/, v2);
  if ( result )
  {
    if ( result->klass == string_TypeInfo )
      return result;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BE4ACC(&string_TypeInfo, method);
    sub_1BE4ACC(&StringLiteral_22680/*"overWriteTDRuby"*/, v4);
    sub_1BE4ACC(&StringLiteral_1/*""*/, v5);
    byte_4B67422 = 1;
  }
  result = (System_String_o *)ServantLimitAddEntity__getScriptObject(this, (System_String_o *)StringLiteral_22680/*"overWriteTDRuby"*/, v2);
  if ( result )
  {
    if ( result->klass == string_TypeInfo )
      return result;
...
int32_t __fastcall ServantLimitAddEntity__GetRandomGroupIndex(ServantLimitAddEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B67429 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_23097/*"randomGroupIndex"*/, v4);
    byte_4B67429 = 1;
  }
  ScriptObject = ServantLimitAddEntity__getScriptObject(this, (System_String_o *)StringLiteral_23097/*"randomGroupIndex"*/, v2);
  if ( ScriptObject )
  {
    v6 = ScriptObject;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6742B & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_ServantLimitAddEntity___c__GetScriptStringArrayParam_b__23_0__, v9);
    sub_1BE4ACC(&ServantLimitAddEntity___c_TypeInfo, v10);
    byte_4B6742B = 1;
  }
  ...
  if ( !_9__23_0 )
  {
    ...
    _9__23_0 = (System_Converter_TInput__TOutput__o *)sub_1BE4D18(System_Converter_object__string__TypeInfo);
        ...
        const MethodInfo *method)
{
  if ( (byte_4B67432 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_23446/*"servantParameterLimitCount"*/, *(_QWORD *)&defaultLimitCount);
    byte_4B67432 = 1;
  }
  return EntityScriptUtil__GetIntValue(
           this->fields.script,
           (System_String_o *)StringLiteral_23446/*"servantParameterLimitCount"*/,
           defaultLimitCount,
           0LL);
}
...
int32_t __fastcall ServantLimitAddEntity__GetWeaponEfect(ServantLimitAddEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6741F & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_25012/*"weaponEffect"*/, method);
    byte_4B6741F = 1;
  }
  return ServantLimitAddEntity__getScript(this, (System_String_o *)StringLiteral_25012/*"weaponEffect"*/, -1, v2);
}
...
int32_t __fastcall ServantLimitAddEntity__GetWeaponGroup(ServantLimitAddEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6741E & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_25013/*"weaponGroup"*/, method);
    byte_4B6741E = 1;
  }
  return ServantLimitAddEntity__getScript(this, (System_String_o *)StringLiteral_25013/*"weaponGroup"*/, -1, v2);
}
...
bool __fastcall ServantLimitAddEntity__IsOverwriteCv(ServantLimitAddEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4B6742F & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_22702/*"overwriteCv"*/, method);
    byte_4B6742F = 1;
  }
  return EntityScriptUtil__ScriptHasKey(this->fields.script, (System_String_o *)StringLiteral_22702/*"overwriteCv"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  return EntityScriptUtil__ScriptHasKey(this->fields.script, (System_String_o *)StringLiteral_22733/*"overwriteSvtDetailName"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6741C & 1) == 0 )
  {
    sub_1BE4ACC(&double_TypeInfo, key);
    byte_4B6741C = 1;
  }
  ScriptObject = ServantLimitAddEntity__getScriptObject(this, key, method);
  if ( !ScriptObject )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6741D & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_ServantLimitAddEntity___c__getScriptIntArrayParam_b__5_0__, v10);
    sub_1BE4ACC(&ServantLimitAddEntity___c_TypeInfo, v11);
    byte_4B6741D = 1;
  }
  ScriptObject = ServantLimitAddEntity__getScriptObject(this, key, (const MethodInfo *)defVal);
  if ( ScriptObject )
  {
      ...
      && (System_Collections_Generic_List_object__c *)v13->klass->_2.typeHierarchy[methodPtr_low - 1] == System_Collections_Generic_List_object__TypeInfo )
    {
      ...
      if ( !_9__5_0 )
      {
        ...
        _9__5_0 = (System_Converter_object__int__o *)sub_1BE4D18(System_Converter_object__int__TypeInfo);
...
void __fastcall ServantLimitAddEntity___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B67436 & 1) == 0 )
  {
    sub_1BE4ACC(&ServantLimitAddEntity___c_TypeInfo, v1);
    byte_4B67436 = 1;
  }
  v2 = (Il2CppObject *)sub_1BE4D18(ServantLimitAddEntity___c_TypeInfo);
