...
System_String_o *AssetStorageCache__GetOldEnvPath(const MethodInfo *method)
{
  ...
  v1 = sub_1C2D538(string___TypeInfo, 6);
  if ( !AndroidUtil_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AndroidUtil_TypeInfo);
  OldUnityPersistentDataPath = AndroidUtil__GetOldUnityPersistentDataPath(0);
  if ( !v1 )
    sub_1C2D6EC(OldUnityPersistentDataPath, v3);
  if ( !*(_DWORD *)(v1 + 24) )
    goto LABEL_17;
  *(_QWORD *)(v1 + 32) = OldUnityPersistentDataPath;
  sub_1C2D434((CGThumbnailListItem_o *)(v1 + 32), (int32_t)OldUnityPersistentDataPath, v4, v5);
  if ( *(_DWORD *)(v1 + 24) <= 1u )
    goto LABEL_17;
  v7 = StringLiteral_1048/*"/"*/;
  *(_QWORD *)(v1 + 40) = StringLiteral_1048/*"/"*/;
  sub_1C2D434((CGThumbnailListItem_o *)(v1 + 40), v7, v4, v6);
  ...
  *(_QWORD *)(v1 + 48) = OldUnityPersistentDataPath;
  sub_1C2D434((CGThumbnailListItem_o *)(v1 + 48), (int32_t)OldUnityPersistentDataPath, v4, v8);
  if ( *(_DWORD *)(v1 + 24) <= 3u )
    goto LABEL_17;
  v10 = StringLiteral_1048/*"/"*/;
  *(_QWORD *)(v1 + 56) = StringLiteral_1048/*"/"*/;
  sub_1C2D434((CGThumbnailListItem_o *)(v1 + 56), v10, v4, v9);
  ...
  if ( *(_DWORD *)(v1 + 24) <= 4u
    || (v12 = *(_QWORD *)(OldUnityPersistentDataPath[23] + 128LL),
        *(_QWORD *)(v1 + 64) = v12,
        sub_1C2D434((CGThumbnailListItem_o *)(v1 + 64), v12, v4, v11),
        *(_DWORD *)(v1 + 24) <= 5u) )
  {
LABEL_17:
    sub_1C2D6F4(OldUnityPersistentDataPath, v3, v4);
  }
  v14 = StringLiteral_1048/*"/"*/;
  *(_QWORD *)(v1 + 72) = StringLiteral_1048/*"/"*/;
  sub_1C2D434((CGThumbnailListItem_o *)(v1 + 72), v14, v4, v13);
  return System_String__Concat_63498380((System_String_array *)v1, 0);
}
