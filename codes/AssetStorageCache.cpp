        ...
        const MethodInfo *method)
{
  if ( (byte_4BFC815 & 1) == 0 )
  {
    sub_1C2E12C(&AssetManager_TypeInfo, isStandalone);
    byte_4BFC815 = 1;
  }
...
System_String_o *__fastcall AssetStorageCache__GetOldEnvPath(const MethodInfo *method)
{
  ...
  v6 = sub_1C2E1D4(string___TypeInfo, 6LL);
  if ( !AndroidUtil_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AndroidUtil_TypeInfo);
  OldUnityPersistentDataPath = AndroidUtil__GetOldUnityPersistentDataPath(0LL);
  if ( !v6 )
    sub_1C2E388(OldUnityPersistentDataPath, v8);
  if ( !*(_DWORD *)(v6 + 24) )
    goto LABEL_17;
  *(_QWORD *)(v6 + 32) = OldUnityPersistentDataPath;
  sub_1C2E0D0((PartyOrganizationUtility_o *)(v6 + 32), (int64_t)OldUnityPersistentDataPath, v9, v10, v11, v12, v13, v14);
  if ( *(_DWORD *)(v6 + 24) <= 1u )
    goto LABEL_17;
  v21 = StringLiteral_1102/*"/"*/;
  *(_QWORD *)(v6 + 40) = StringLiteral_1102/*"/"*/;
  ...
  *(_QWORD *)(v6 + 48) = OldUnityPersistentDataPath;
  ...
  if ( *(_DWORD *)(v6 + 24) <= 3u )
    goto LABEL_17;
  v34 = StringLiteral_1102/*"/"*/;
  *(_QWORD *)(v6 + 56) = StringLiteral_1102/*"/"*/;
  ...
  if ( *(_DWORD *)(v6 + 24) <= 4u
    || (v41 = *(_QWORD *)(OldUnityPersistentDataPath[23] + 128LL),
        *(_QWORD *)(v6 + 64) = v41,
        sub_1C2E0D0((PartyOrganizationUtility_o *)(v6 + 64), v41, v35, v36, v37, v38, v39, v40),
        *(_DWORD *)(v6 + 24) <= 5u) )
  {
LABEL_17:
    sub_1C2E390(OldUnityPersistentDataPath, v8);
  }
  v48 = StringLiteral_1102/*"/"*/;
  *(_QWORD *)(v6 + 72) = StringLiteral_1102/*"/"*/;
  sub_1C2E0D0((PartyOrganizationUtility_o *)(v6 + 72), v48, v42, v43, v44, v45, v46, v47);
