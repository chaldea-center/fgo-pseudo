        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD635 & 1) == 0 )
  {
    sub_1B64870(&AssetManager_TypeInfo, isStandalone);
    byte_49FD635 = 1;
  }
...
System_String_o *__fastcall AssetStorageCache__GetOldEnvPath(const MethodInfo *method)
{
  ...
  v6 = sub_1B64918(string___TypeInfo, 6LL);
  if ( !AndroidUtil_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AndroidUtil_TypeInfo);
  OldUnityPersistentDataPath = AndroidUtil__GetOldUnityPersistentDataPath(0LL);
  if ( !v6 )
    sub_1B64ACC(OldUnityPersistentDataPath, v8);
  if ( !*(_DWORD *)(v6 + 24) )
    goto LABEL_17;
  *(_QWORD *)(v6 + 32) = OldUnityPersistentDataPath;
  sub_1B64814((ServantStatusBattleListViewItem_o *)(v6 + 32), (int32_t)OldUnityPersistentDataPath, v9, v10);
  if ( *(_DWORD *)(v6 + 24) <= 1u )
    goto LABEL_17;
  ...
  *(_QWORD *)(v6 + 48) = OldUnityPersistentDataPath;
  sub_1B64814((ServantStatusBattleListViewItem_o *)(v6 + 48), (int32_t)OldUnityPersistentDataPath, v14, v15);
  if ( *(_DWORD *)(v6 + 24) <= 3u )
    goto LABEL_17;
  ...
  *(_QWORD *)(v6 + 56) = StringLiteral_1124/*"/"*/;
  ...
  if ( *(_DWORD *)(v6 + 24) <= 4u
    || (v21 = *(_QWORD *)(OldUnityPersistentDataPath[23] + 128LL),
        *(_QWORD *)(v6 + 64) = v21,
        sub_1B64814((ServantStatusBattleListViewItem_o *)(v6 + 64), v21, v19, v20),
        *(_DWORD *)(v6 + 24) <= 5u) )
  {
LABEL_17:
    sub_1B64AD4(OldUnityPersistentDataPath, v8);
  }
  v24 = StringLiteral_1124/*"/"*/;
  *(_QWORD *)(v6 + 72) = StringLiteral_1124/*"/"*/;
  sub_1B64814((ServantStatusBattleListViewItem_o *)(v6 + 72), v24, v22, v23);
