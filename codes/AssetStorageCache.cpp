        ...
        const MethodInfo *method)
{
  ...
  if ( System_IO_Directory__Exists(cachePath, 0LL) )
    System_IO_Directory__Delete_44503516(cachePath, 1, 0LL);
  if ( isStandalone )
  {
    if ( (BYTE3(AssetManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
      && !AssetManager_TypeInfo->_2.cctor_finished )
...
System_String_o *__fastcall AssetStorageCache__GetOldEnvPath(const MethodInfo *method)
{
  ...
  v1 = (System_String_array *)sub_B5299C(string___TypeInfo, 6LL);
  ...
  if ( !v1 )
    sub_B52A5C(OldUnityPersistentDataPath, v3);
  v10 = OldUnityPersistentDataPath;
  if ( OldUnityPersistentDataPath )
  {
    OldUnityPersistentDataPath = (System_Int32_array **)sub_B52A44(
  ...
  OldUnityPersistentDataPath = (System_Int32_array **)StringLiteral_886/*"/"*/;
  if ( StringLiteral_886/*"/"*/ )
  {
    OldUnityPersistentDataPath = (System_Int32_array **)sub_B52A44(StringLiteral_886/*"/"*/, v1->obj.klass->_1.element_class);
    if ( !OldUnityPersistentDataPath )
      goto LABEL_39;
    v17 = (System_Int32_array **)StringLiteral_886/*"/"*/;
  }
  else
  {
    v17 = 0LL;
  ...
  sub_B52920((BattleServantConfConponent_o *)&v1->m_Items[2], v24, v18, v19, v20, v21, v22, v23);
  OldUnityPersistentDataPath = (System_Int32_array **)StringLiteral_886/*"/"*/;
  if ( StringLiteral_886/*"/"*/ )
  {
    OldUnityPersistentDataPath = (System_Int32_array **)sub_B52A44(StringLiteral_886/*"/"*/, v1->obj.klass->_1.element_class);
    if ( !OldUnityPersistentDataPath )
      goto LABEL_39;
    v31 = (System_Int32_array **)StringLiteral_886/*"/"*/;
  }
  else
  {
    v31 = 0LL;
  ...
  sub_B52920((BattleServantConfConponent_o *)&v1->m_Items[3], v31, v25, v26, v27, v28, v29, v30);
  ...
  if ( v38 )
  {
    OldUnityPersistentDataPath = (System_Int32_array **)sub_B52A44(v38, v1->obj.klass->_1.element_class);
    if ( !OldUnityPersistentDataPath )
    {
LABEL_39:
      v48 = sub_B52A7C(OldUnityPersistentDataPath);
      sub_B52A28(v48, 0LL);
    }
  }
  if ( v1->max_length <= 4 )
  ...
  sub_B52920((BattleServantConfConponent_o *)&v1->m_Items[4], v38, v32, v33, v34, v35, v36, v37);
  OldUnityPersistentDataPath = (System_Int32_array **)StringLiteral_886/*"/"*/;
  if ( StringLiteral_886/*"/"*/ )
  {
    OldUnityPersistentDataPath = (System_Int32_array **)sub_B52A44(StringLiteral_886/*"/"*/, v1->obj.klass->_1.element_class);
    if ( OldUnityPersistentDataPath )
    {
      v45 = (System_Int32_array **)StringLiteral_886/*"/"*/;
      goto LABEL_36;
    }
    goto LABEL_39;
  }
...
LABEL_36:
  ...
  {
LABEL_38:
    v47 = sub_B52A88(OldUnityPersistentDataPath);
    sub_B52A28(v47, 0LL);
  }
  v1->m_Items[5] = (System_String_o *)v45;
  sub_B52920((BattleServantConfConponent_o *)&v1->m_Items[5], v45, v39, v40, v41, v42, v43, v44);
  return System_String__Concat_44648440(v1, 0LL);
}
