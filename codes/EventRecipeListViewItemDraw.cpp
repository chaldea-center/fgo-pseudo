        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFC741 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_DataManager_GetMaster_EventMaster___, v8);
    ...
    sub_1BC3008(&StringLiteral_20057/*"icon_{0}"*/, v15);
    sub_1BC3008(&StringLiteral_23219/*"shop_item_menu_{0}_2"*/, v16);
    sub_1BC3008(&StringLiteral_23218/*"shop_item_menu_mask"*/, v17);
    sub_1BC3008(&StringLiteral_13273/*"TIME_REST2_NONE"*/, v18);
    sub_1BC3008(&StringLiteral_10894/*"RECIPE_EVENT_BOARD_MESSAGE"*/, v19);
    sub_1BC3008(&StringLiteral_10895/*"RECIPE_EVENT_BOARD_UNRELEASED_NAME"*/, v20);
    byte_4AFC741 = 1;
  }
  entity = 0LL;
  if ( item && mode )
  {
    ...
    v23 = System_String__Format((System_String_o *)StringLiteral_23219/*"shop_item_menu_{0}_2"*/, v22, 0LL);
    ...
    AtlasManager__SetEventUI_39643540(v24, maskSprite, (System_String_o *)StringLiteral_23218/*"shop_item_menu_mask"*/, 0LL);
    ...
    if ( gameObject )
    {
      ...
      if ( gameObject )
      {
        ...
        if ( item->fields.isRelease )
        {
          ...
          v35 = System_String__Format((System_String_o *)StringLiteral_20057/*"icon_{0}"*/, v34, 0LL);
          if ( !AtlasManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
          gameObject = AtlasManager__SetEventUI_39643540(v32, itemIcon, v35, 0LL);
          ...
          gameObject = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_10894/*"RECIPE_EVENT_BOARD_MESSAGE"*/, 0LL);
        ...
        else
        {
          ...
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          gameObject = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_10895/*"RECIPE_EVENT_BOARD_UNRELEASED_NAME"*/, 0LL);
          if ( !nameTextLabel )
            goto LABEL_52;
        ...
        gameObject = (int64_t)DataManager__GetMaster_object_((const MethodInfo_3001E10 *)Method_DataManager_GetMaster_EventMaster___);
        if ( !gameObject )
          goto LABEL_52;
...
LABEL_47:
        ...
        if ( entity )
        {
          ...
          if ( gameObject >= (__int64)monitor )
          {
            if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
            gameObject = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_13273/*"TIME_REST2_NONE"*/, 0LL);
            if ( restTimeLabel )
              goto LABEL_46;
          }
          else
...
LABEL_54:
                                  sub_1BC326C(priceInfo1, item, v8);
                                }
                              }
                            }
                          }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFC742 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMasterData_GiftMaster___, item);
    ...
    sub_1BC3008(&StringLiteral_10897/*"RECIPE_EVENT_HAVE_NUM"*/, v9);
    sub_1BC3008(&StringLiteral_395/*"#,0"*/, v10);
    sub_1BC3008(&StringLiteral_10901/*"RECIPE_EVENT_PROBABILITY_MESSAGE"*/, v11);
    sub_1BC3008(&StringLiteral_1/*""*/, v12);
    sub_1BC3008(&StringLiteral_1113/*"0"*/, v13);
    byte_4AFC742 = 1;
  }
  entity = 0LL;
  ...
  if ( ((unsigned __int8)Instance & 1) != 0 )
  {
    if ( !entity )
      goto LABEL_42;
    Instance = (DataManager_o *)System_Int32__ToString_63857360(
                                  (int)entity + 28,
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10897/*"RECIPE_EVENT_HAVE_NUM"*/, 0LL);
...
LABEL_42:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10901/*"RECIPE_EVENT_PROBABILITY_MESSAGE"*/, 0LL);
