        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC1981 & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_10991/*"RECIPE_EVENT_BOARD_MESSAGE"*/);
    sub_1C713B0(&StringLiteral_10992/*"RECIPE_EVENT_BOARD_UNRELEASED_NAME"*/);
    byte_4CC1981 = 1;
  }
  entity = 0;
  if ( item && mode )
  {
    ...
    v9 = System_String__Format((System_String_o *)StringLiteral_23560/*"shop_item_menu_{0}_2"*/, v8, 0);
    ...
    AtlasManager__SetEventUI_40880344(v10, maskSprite, (System_String_o *)StringLiteral_23559/*"shop_item_menu_mask"*/, 0);
    ...
    if ( gameObject )
    {
      ...
      if ( gameObject )
      {
        ...
        if ( item->fields.isRelease )
        {
          ...
          v18 = System_String__Format((System_String_o *)StringLiteral_20328/*"icon_{0}"*/, v17, 0);
          if ( !AtlasManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
          gameObject = AtlasManager__SetEventUI_40880344(v15, itemIcon, v18, 0);
          ...
          gameObject = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_10991/*"RECIPE_EVENT_BOARD_MESSAGE"*/, 0);
        ...
        else
        {
          ...
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          gameObject = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_10992/*"RECIPE_EVENT_BOARD_UNRELEASED_NAME"*/, 0);
          if ( !nameTextLabel )
            goto LABEL_52;
        ...
        gameObject = (int64_t)DataManager__GetMaster_object_((const MethodInfo_314B0B8 *)Method_DataManager_GetMaster_EventMaster___);
        if ( !gameObject )
          goto LABEL_52;
...
LABEL_47:
        ...
        if ( entity )
        {
          ...
          if ( gameObject >= (__int64)monitor )
          {
            if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
            gameObject = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_13410/*"TIME_REST2_NONE"*/, 0);
            if ( restTimeLabel )
              goto LABEL_46;
          }
          else
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC1982 & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_10994/*"RECIPE_EVENT_HAVE_NUM"*/);
    sub_1C713B0(&StringLiteral_396/*"#,0"*/);
    sub_1C713B0(&StringLiteral_10998/*"RECIPE_EVENT_PROBABILITY_MESSAGE"*/);
  ...
  if ( ((unsigned __int8)Instance & 1) != 0 )
  {
    if ( !entity )
      goto LABEL_42;
    Instance = (DataManager_o *)System_Int32__ToString_65540220(
                                  (int)entity + 28,
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10994/*"RECIPE_EVENT_HAVE_NUM"*/, 0);
...
LABEL_42:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10998/*"RECIPE_EVENT_PROBABILITY_MESSAGE"*/, 0);
