        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB88ED & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_DataManager_GetMaster_EventMaster___, v8);
    ...
    sub_1C13D24(&StringLiteral_20524/*"icon_spot_next"*/, v15);
    sub_1C13D24(&StringLiteral_23664/*"shift_jis"*/, v16);
    sub_1C13D24(&StringLiteral_23663/*"shiftUpdateStatus"*/, v17);
    sub_1C13D24(&StringLiteral_13544/*"TIME_BEFORE_DAYS"*/, v18);
    sub_1C13D24(&StringLiteral_11171/*"RECIPE_CHECK_PRESEN_NUM_TXT"*/, v19);
    sub_1C13D24(&StringLiteral_11172/*"RECIPE_CONFIRM_DIALOG_DESTINATION_LABEL"*/, v20);
    byte_4BB88ED = 1;
  }
  entity = 0LL;
  if ( item && mode )
  {
    ...
    v23 = System_String__Format((System_String_o *)StringLiteral_23664/*"shift_jis"*/, v22, 0LL);
    ...
    AtlasManager__SetEventUI_39004844(v24, maskSprite, (System_String_o *)StringLiteral_23663/*"shiftUpdateStatus"*/, 0LL);
    ...
    if ( gameObject )
    {
      ...
      if ( gameObject )
      {
        ...
        if ( item->fields.isRelease )
        {
          ...
          v35 = System_String__Format((System_String_o *)StringLiteral_20524/*"icon_spot_next"*/, v34, 0LL);
          if ( !AtlasManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
          gameObject = AtlasManager__SetEventUI_39004844(v32, itemIcon, v35, 0LL);
          ...
          gameObject = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_11171/*"RECIPE_CHECK_PRESEN_NUM_TXT"*/, 0LL);
        ...
        else
        {
          ...
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          gameObject = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_11172/*"RECIPE_CONFIRM_DIALOG_DESTINATION_LABEL"*/, 0LL);
          if ( !nameTextLabel )
            goto LABEL_52;
        ...
        gameObject = (int64_t)DataManager__GetMaster_object_((const MethodInfo_2F8F418 *)Method_DataManager_GetMaster_EventMaster___);
        if ( !gameObject )
          goto LABEL_52;
...
LABEL_47:
        ...
        if ( entity )
        {
          ...
          if ( gameObject >= (__int64)monitor )
          {
            if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
            gameObject = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_13544/*"TIME_BEFORE_DAYS"*/, 0LL);
            if ( restTimeLabel )
              goto LABEL_46;
          }
          else
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB88EE & 1) == 0 )
  {
    sub_1C13D24(&Method_DataManager_GetMasterData_GiftMaster___, item);
    ...
    sub_1C13D24(&StringLiteral_11174/*"RECIPE_CONFIRM_DIALOG_KIND"*/, v9);
    sub_1C13D24(&StringLiteral_426/*"#,0"*/, v10);
    sub_1C13D24(&StringLiteral_11178/*"RECIPE_CONFIRM_DIALOG_TITLE"*/, v11);
    sub_1C13D24(&StringLiteral_1/*""*/, v12);
    sub_1C13D24(&StringLiteral_1212/*"0"*/, v13);
    byte_4BB88EE = 1;
  }
  entity = 0LL;
  ...
  if ( ((unsigned __int8)Instance & 1) != 0 )
  {
    if ( !entity )
      goto LABEL_42;
    Instance = (DataManager_o *)System_Int32__ToString_63773552(
                                  (int)entity + 28,
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11174/*"RECIPE_CONFIRM_DIALOG_KIND"*/, 0LL);
...
LABEL_42:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11178/*"RECIPE_CONFIRM_DIALOG_TITLE"*/, 0LL);
