        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C4224F & 1) == 0 )
  {
    this = (CharaGraphFilterLogicBase_o *)sub_1C37058(&Method_System_Collections_Generic_List_ListViewSort_FilterKind__ToArray__);
    byte_4C4224F = 1;
  }
  if ( !list
    || (sort = v4->fields.sort,
...
bool CharaGraphFilterLogicBase__IsMatchSelectedItemFilter(CharaGraphFilterLogicBase_o *this, const MethodInfo *method)
{
  ...
  sort = this->fields.sort;
  Filter = (struct ListViewSort_o *)sub_1C37100(ListViewSort_FilterKind___TypeInfo, 1);
  if ( !Filter )
    goto LABEL_13;
        ...
        const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.item, (int32_t)item, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields, (int32_t)sort, (int32_t)method, v3);
}