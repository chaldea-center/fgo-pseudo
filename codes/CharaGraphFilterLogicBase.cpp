        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6DD4 & 1) == 0 )
  {
    this = (CharaGraphFilterLogicBase_o *)sub_1C1ABD4(
        ...
        const MethodInfo *method)
{
  ...
  sort = this->fields.sort;
  Filter = (struct ListViewSort_o *)sub_1C1AC7C(ListViewSort_FilterKind___TypeInfo, 1LL);
  if ( !Filter )
    goto LABEL_13;
  v5 = Filter;
  if ( !*(_DWORD *)&Filter->fields.FILTER_DEFAULT_VALUE )
    sub_1C1AE38(Filter, Filter);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.item, (int64_t)item, (int64_t)method, v3, v4, v5, v6, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields, (int64_t)sort, (int64_t)method, v3, v4, v5, v6, v7);
}