        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDEA4 & 1) == 0 )
  {
    this = (CharaGraphFilterLogicBase_o *)sub_1B64A00(
        ...
        const MethodInfo *method)
{
  ...
  sort = this->fields.sort;
  item = (ListViewSort_FilterKind_array *)sub_1B64AA8(ListViewSort_FilterKind___TypeInfo, 1LL);
  if ( !item )
    goto LABEL_13;
  v5 = item;
  if ( !item->max_length )
    sub_1B64C64(item, item);
  item->m_Items[1] = 39;
  if ( !sort )
    goto LABEL_13;
        ...
        const MethodInfo *method)
{
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.item, (int32_t)item, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)sort, (int32_t)method, v3);
}