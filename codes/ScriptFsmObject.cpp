        ...
        const MethodInfo *method)
{
  ...
  if ( FsmString )
  {
    ...
    sub_1C2E0D0((PartyOrganizationUtility_o *)&FsmString->fields.value, (int64_t)value, v8, v9, v10, v11, v12, v13);
  }
}
...
void __fastcall ScriptFsmObject__Skip(ScriptFsmObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFF406 & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_12401/*"SKIP"*/, method);
    byte_4BFF406 = 1;
  }
  fsm = this->fields.fsm;
  if ( !fsm )
