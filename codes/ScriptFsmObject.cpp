        ...
        const MethodInfo *method)
{
  ...
  if ( FsmString )
  {
    ...
    sub_1C1AB78((PartyOrganizationUtility_o *)&FsmString->fields.value, (int64_t)value, v8, v9, v10, v11, v12, v13);
  }
}
...
void __fastcall ScriptFsmObject__Skip(ScriptFsmObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC9717 & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_12382/*"SKIP"*/, method);
    byte_4BC9717 = 1;
  }
  fsm = this->fields.fsm;
  if ( !fsm )
