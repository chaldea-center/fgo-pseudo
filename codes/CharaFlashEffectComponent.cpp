        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD706 & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_CharaFlashEffectComponent_EndCreateEffect__, v7);
    ...
    sub_1B640C8(&StringLiteral_4941/*"Custom/Sprite-ScriptActionFigureFlash"*/, v12);
    sub_1B640C8(&StringLiteral_16166/*"_Gradation"*/, v13);
    sub_1B640C8(&StringLiteral_13467/*"Talk/"*/, v14);
    sub_1B640C8(&StringLiteral_4924/*"Custom/BackFlashSheder"*/, v15);
    byte_49FD706 = 1;
  }
  ...
  v20 = (UnityEngine_Texture_o *)Object_object;
  v21 = UnityEngine_Shader__Find((System_String_o *)StringLiteral_4924/*"Custom/BackFlashSheder"*/, 0LL);
  v24 = (UnityEngine_Material_o *)sub_1B64314(UnityEngine_Material_TypeInfo, v22, v23);
  UnityEngine_Material___ctor(v24, v21, 0LL);
  if ( !backFlashMesh )
    goto LABEL_30;
  ExUIMeshRenderer__set_material(backFlashMesh, v24, 0LL);
  figure = (UIStandFigureRender_o *)this->fields.backFlashMesh;
  if ( !figure )
    goto LABEL_30;
  ExUIMeshRenderer__SetImage((ExUIMeshRenderer_o *)figure, v20, 0LL);
  figure = (UIStandFigureRender_o *)this->fields.backFlashMesh;
  if ( !figure )
    goto LABEL_30;
...
LABEL_18:
  ...
  if ( !figure )
    goto LABEL_30;
  UIStandFigureRender__SetWipeTexture(figure, v20, 0LL);
  figure = (UIStandFigureRender_o *)this->fields.figure;
  if ( !figure )
    goto LABEL_30;
    ...
    && !System_String__IsNullOrEmpty(this->fields.subEffectName, 0LL) )
  {
    ...
    v28 = System_String__Concat_61375396((System_String_o *)StringLiteral_13467/*"Talk/"*/, this->fields.subEffectName, 0LL);
    v31 = (CommonEffectLoadComponent_LoadEndHandler_o *)sub_1B64314(
    ...
    CommonEffectManager__Create_40285436(v27, v28, v31, 0, 0, 0, v33);
  }
  else
  {
    CharaFlashEffectComponent__EndCreateEffect(this, 0LL, v26);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD705 & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_CharaFlashEffectComponent_EndLoadWipe__, v6);
    sub_1B640C8(&AssetLoader_LoadEndDataHandler_TypeInfo, v7);
    sub_1B640C8(&UnityEngine_Object_TypeInfo, v8);
    sub_1B640C8(&ScriptManager_TypeInfo, v9);
    sub_1B640C8(&StringLiteral_15592/*"Wipe/"*/, v10);
    sub_1B640C8(&StringLiteral_24592/*"white"*/, v11);
    byte_49FD705 = 1;
  }
  ...
  if ( isSkip )
  {
    ...
    sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.figure, 0, v14, v15);
  ...
  {
    v17 = System_String__Concat_61375396((System_String_o *)StringLiteral_15592/*"Wipe/"*/, this->fields.wipeName, 0LL);
...
void __fastcall CharaFlashEffectComponent__OnDestroy(CharaFlashEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.wipeData )
  {
    ...
    *p_wipeData = 0LL;
    sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.wipeData, 0, v8, v9);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(figure, 0LL, 0LL) )
  {
    ...
    if ( p_figure->klass )
    {
      ...
      if ( p_figure->klass )
      {
        ...
        p_figure->klass = 0LL;
        sub_1B6406C(p_figure, 0, v12, v13);
        return;
      }
    }
LABEL_17:
    sub_1B64324(backFlashMesh);
  }
}
...
void __fastcall CharaFlashEffectComponent__OnEndEffect(CharaFlashEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FD708 & 1) == 0 )
  {
    ...
    sub_1B640C8(&StringLiteral_24592/*"white"*/, v5);
    byte_49FD708 = 1;
  }
