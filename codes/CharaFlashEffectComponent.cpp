void __fastcall CharaFlashEffectComponent___ctor(CharaFlashEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFEB5E & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_18286/*"circleIn"*/, method);
    byte_4BFEB5E = 1;
  }
  *(_QWORD *)&this->fields.flashColor.fields.r = 0LL;
  *(_QWORD *)&this->fields.flashColor.fields.b = 0LL;
  v9 = StringLiteral_18286/*"circleIn"*/;
  this->fields.wipeName = (struct System_String_o *)StringLiteral_18286/*"circleIn"*/;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFEB59 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_CharaFlashEffectComponent_EndCreateEffect__, v11);
    sub_1C2E12C(&CommonEffectManager_TypeInfo, v12);
    sub_1C2E12C(&CommonEffectLoadComponent_LoadEndHandler_TypeInfo, v13);
    sub_1C2E12C(&UnityEngine_Material_TypeInfo, v14);
    sub_1C2E12C(&UnityEngine_Object_TypeInfo, v15);
    sub_1C2E12C(&StringLiteral_5054/*"Custom/Sprite-ScriptActionFigureFlash"*/, v16);
    sub_1C2E12C(&StringLiteral_16524/*"_Gradation"*/, v17);
    sub_1C2E12C(&StringLiteral_13802/*"Talk/"*/, v18);
    sub_1C2E12C(&StringLiteral_5037/*"Custom/BackFlashSheder"*/, v19);
    byte_4BFEB59 = 1;
  }
  ...
  v26 = UnityEngine_Shader__Find((System_String_o *)StringLiteral_5037/*"Custom/BackFlashSheder"*/, 0LL);
  v27 = (UnityEngine_Material_o *)sub_1C2E378(UnityEngine_Material_TypeInfo);
  ...
  if ( UnityEngine_Material__HasProperty_70855900(
         ...
         (System_String_o *)StringLiteral_16524/*"_Gradation"*/,
         0LL) )
  {
    figure = (UIStandFigureRender_o *)this->fields.backFlashMesh;
    if ( figure )
...
LABEL_30:
    sub_1C2E388(figure, v21);
  }
LABEL_18:
  figure = (UIStandFigureRender_o *)this->fields.figure;
  if ( !figure )
    goto LABEL_30;
  UIStandFigureRender__SetSharder(figure, (System_String_o *)StringLiteral_5054/*"Custom/Sprite-ScriptActionFigureFlash"*/, 0LL);
  figure = (UIStandFigureRender_o *)this->fields.figure;
  if ( !figure )
    goto LABEL_30;
    ...
    && !System_String__IsNullOrEmpty(this->fields.subEffectName, 0LL) )
  {
    ...
    v31 = System_String__Concat_63235584((System_String_o *)StringLiteral_13802/*"Talk/"*/, this->fields.subEffectName, 0LL);
    v32 = (CommonEffectLoadComponent_LoadEndHandler_o *)sub_1C2E378(CommonEffectLoadComponent_LoadEndHandler_TypeInfo);
    ...
    CommonEffectManager__Create_41991656(v30, v31, v32, 0, 0, 0, v34);
  }
  else
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFEB58 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_CharaFlashEffectComponent_EndLoadWipe__, v10);
    ...
    sub_1C2E12C(&StringLiteral_15941/*"Wipe/"*/, v14);
    sub_1C2E12C(&StringLiteral_25159/*"white"*/, v15);
    byte_4BFEB58 = 1;
  }
  ...
  if ( isSkip )
  {
    ...
    ScriptManager__Fade((System_String_o *)StringLiteral_25159/*"white"*/, 0, 0.0, 0LL);
    if ( !*p_figure )
      sub_1C2E388(0LL, v18);
    UIStandFigureRender__SetAlpha(*p_figure, 0.0, 0LL);
    this->fields.figure = 0LL;
    sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.figure, 0LL, v19, v20, v21, v22, v23, v24);
  ...
  {
    v26 = System_String__Concat_63235584((System_String_o *)StringLiteral_15941/*"Wipe/"*/, this->fields.wipeName, 0LL);
...
void __fastcall CharaFlashEffectComponent__OnDestroy(CharaFlashEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.wipeData )
  {
    ...
    if ( !AssetManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
    AssetManager__releaseAsset_39104116(v7, 0LL);
    *p_wipeData = 0LL;
    sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.wipeData, 0LL, v8, v9, v10, v11, v12, v13);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(figure, 0LL, 0LL) )
  {
    ...
    if ( p_figure->klass )
    {
      ...
      if ( p_figure->klass )
      {
        ...
        p_figure->klass = 0LL;
        sub_1C2E0D0(p_figure, 0LL, v16, v17, v18, v19, v20, v21);
        return;
      }
    }
LABEL_17:
    sub_1C2E388(backFlashMesh, method);
  }
}
...
void __fastcall CharaFlashEffectComponent__OnEndEffect(CharaFlashEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFEB5B & 1) == 0 )
  {
    ...
    sub_1C2E12C(&StringLiteral_25159/*"white"*/, v5);
    byte_4BFEB5B = 1;
  }
  ...
  if ( !ScriptManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(ScriptManager_TypeInfo);
  ScriptManager__Fade((System_String_o *)StringLiteral_25159/*"white"*/, 0, 1.0, 0LL);
