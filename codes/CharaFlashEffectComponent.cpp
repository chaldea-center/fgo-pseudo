void __fastcall CharaFlashEffectComponent___ctor(CharaFlashEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4F93F & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_17738/*"circleIn"*/, method);
    byte_4A4F93F = 1;
  }
  *(_QWORD *)&this->fields.flashColor.fields.r = 0LL;
  *(_QWORD *)&this->fields.flashColor.fields.b = 0LL;
  v5 = StringLiteral_17738/*"circleIn"*/;
  this->fields.wipeName = (struct System_String_o *)StringLiteral_17738/*"circleIn"*/;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4F93A & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_CharaFlashEffectComponent_EndCreateEffect__, v7);
    ...
    sub_1B863B8(&StringLiteral_4895/*"Custom/Sprite-ScriptActionFigureFlash"*/, v12);
    sub_1B863B8(&StringLiteral_16000/*"_Gradation"*/, v13);
    sub_1B863B8(&StringLiteral_13404/*"Talk/"*/, v14);
    sub_1B863B8(&StringLiteral_4878/*"Custom/BackFlashSheder"*/, v15);
    byte_4A4F93A = 1;
  }
  ...
  v22 = UnityEngine_Shader__Find((System_String_o *)StringLiteral_4878/*"Custom/BackFlashSheder"*/, 0LL);
  ...
  if ( UnityEngine_Material__HasProperty_69222264(
         ...
         (System_String_o *)StringLiteral_16000/*"_Gradation"*/,
         0LL) )
  {
    figure = (UIStandFigureRender_o *)this->fields.backFlashMesh;
    if ( figure )
...
LABEL_30:
    sub_1B86614(figure, v17);
  }
LABEL_18:
  figure = (UIStandFigureRender_o *)this->fields.figure;
  if ( !figure )
    goto LABEL_30;
  UIStandFigureRender__SetSharder(figure, (System_String_o *)StringLiteral_4895/*"Custom/Sprite-ScriptActionFigureFlash"*/, 0LL);
  figure = (UIStandFigureRender_o *)this->fields.figure;
  if ( !figure )
    goto LABEL_30;
    ...
    && !System_String__IsNullOrEmpty(this->fields.subEffectName, 0LL) )
  {
    ...
    v27 = System_String__Concat_61645176((System_String_o *)StringLiteral_13404/*"Talk/"*/, this->fields.subEffectName, 0LL);
    v28 = (CommonEffectLoadComponent_LoadEndHandler_o *)sub_1B86604(CommonEffectLoadComponent_LoadEndHandler_TypeInfo);
    ...
    CommonEffectManager__Create_41683104(v26, v27, v28, 0, 0, 0, v30);
  }
  else
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4F939 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_CharaFlashEffectComponent_EndLoadWipe__, v6);
    ...
    sub_1B863B8(&StringLiteral_15433/*"Wipe/"*/, v10);
    sub_1B863B8(&StringLiteral_24530/*"white"*/, v11);
    byte_4A4F939 = 1;
  }
  ...
  if ( isSkip )
  {
    ...
    ScriptManager__Fade((System_String_o *)StringLiteral_24530/*"white"*/, 0, 0.0, 0LL);
    if ( !*p_figure )
      sub_1B86614(0LL, v14);
    UIStandFigureRender__SetAlpha(*p_figure, 0.0, 0LL);
    this->fields.figure = 0LL;
    sub_1B8635C((CGThumbnailListItem_o *)&this->fields.figure, 0, v15, v16);
  ...
  {
    v18 = System_String__Concat_61645176((System_String_o *)StringLiteral_15433/*"Wipe/"*/, this->fields.wipeName, 0LL);
...
void __fastcall CharaFlashEffectComponent__OnDestroy(CharaFlashEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.wipeData )
  {
    ...
    if ( !AssetManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
    AssetManager__releaseAsset_38744968(v7, 0LL);
    *p_wipeData = 0LL;
    sub_1B8635C((CGThumbnailListItem_o *)&this->fields.wipeData, 0, v8, v9);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(figure, 0LL, 0LL) )
  {
    ...
    if ( p_figure->klass )
    {
      ...
      if ( p_figure->klass )
      {
        ...
        p_figure->klass = 0LL;
        sub_1B8635C(p_figure, 0, v12, v13);
        return;
      }
    }
LABEL_17:
    sub_1B86614(backFlashMesh, method);
  }
}
...
void __fastcall CharaFlashEffectComponent__OnEndEffect(CharaFlashEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4F93C & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_24530/*"white"*/, v5);
    byte_4A4F93C = 1;
  }
  ...
  if ( !ScriptManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(ScriptManager_TypeInfo);
  ScriptManager__Fade((System_String_o *)StringLiteral_24530/*"white"*/, 0, 1.0, 0LL);
