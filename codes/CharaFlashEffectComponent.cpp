        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDD91C & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_CharaFlashEffectComponent_EndCreateEffect__);
    ...
    sub_1C21E38(&StringLiteral_5066/*"Custom/Sprite-ScriptActionFigureFlash"*/);
...
LABEL_18:
  ...
  if ( !figure )
    goto LABEL_30;
  UIStandFigureRender__SetSharder(figure, (System_String_o *)StringLiteral_5066/*"Custom/Sprite-ScriptActionFigureFlash"*/, 0LL);
  figure = (UIStandFigureRender_o *)this->fields.figure;
  if ( !figure )
    goto LABEL_30;
    ...
    && !System_String__IsNullOrEmpty(this->fields.subEffectName, 0LL) )
  {
    ...
    v21 = System_String__Concat_63115476((System_String_o *)StringLiteral_13792/*"Talk/"*/, this->fields.subEffectName, 0LL);
    v22 = (CommonEffectLoadComponent_LoadEndHandler_o *)sub_1C22084(CommonEffectLoadComponent_LoadEndHandler_TypeInfo);
    ...
    CommonEffectManager__Create_41906916(v20, v21, v22, 0, 0, 0, v24);
  }
  else
  {
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C21E38(&AssetManager_TypeInfo);
    sub_1C21E38(&Method_CharaFlashEffectComponent_EndLoadWipe__);
...
void __fastcall CharaFlashEffectComponent__OnDestroy(CharaFlashEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.wipeData )
  {
    ...
    *p_wipeData = 0LL;
    sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.wipeData, 0LL, v7, v8, v9, v10, v11, v12);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(figure, 0LL, 0LL) )
  {
    ...
    if ( p_figure->klass )
    {
      ...
      if ( p_figure->klass )
      {
        ...
        p_figure->klass = 0LL;
        sub_1C21DDC(p_figure, 0LL, v15, v16, v17, v18, v19, v20);
        return;
      }
    }
LABEL_17:
    sub_1C22094(backFlashMesh, method);
  }
}
