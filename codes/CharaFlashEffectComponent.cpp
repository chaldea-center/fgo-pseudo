        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5971EDD & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_CharaFlashEffectComponent_EndCreateEffect__);
    ...
    sub_2213A60(&StringLiteral_5111/*"Custom/Sprite-ScriptActionFigureFlash"*/);
    ...
    sub_2213A60(&StringLiteral_5112/*"Custom/Sprite-ScriptActionFigureFlashWhenSilhouette"*/);
    byte_5971EDD = 1;
  }
         ...
         0) )
  {
    ...
    if ( !figure )
      goto LABEL_35;
    UnityEngine_Material__SetFloat((UnityEngine_Material_o *)figure, (System_String_o *)StringLiteral_16885/*"_Gradation"*/, 0.2, 0);
  }
  figure = (UIStandFigureRender_o *)this->fields.figure;
  if ( !this->fields.isContinueSilhouette )
  {
    if ( figure )
    {
      UIStandFigureRender__SetSharder(figure, (System_String_o *)StringLiteral_5111/*"Custom/Sprite-ScriptActionFigureFlash"*/, 0);
      figure = (UIStandFigureRender_o *)this->fields.figure;
      if ( figure )
      {
...
LABEL_35:
  ...
  if ( !figure )
    goto LABEL_35;
  UIStandFigureRender__SetSharder(figure, (System_String_o *)StringLiteral_5112/*"Custom/Sprite-ScriptActionFigureFlashWhenSilhouette"*/, 0);
  figure = (UIStandFigureRender_o *)this->fields.figure;
  if ( !figure )
    goto LABEL_35;
  UIStandFigureRender__SetFlashColor(figure, this->fields.flashColor, 0);
LABEL_25:
  figure = (UIStandFigureRender_o *)this->fields.figure;
  if ( !figure )
    goto LABEL_35;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_2213A60(&AssetManager_TypeInfo);
    sub_2213A60(&Method_CharaFlashEffectComponent_EndLoadWipe__);
  ...
  if ( isSkip )
  {
    ...
    sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields.figure, 0, v14, v15, v16, v17, v18, v19);
  ...
  {
    v22 = System_String__Concat_75651716((System_String_o *)StringLiteral_16277/*"Wipe/"*/, this->fields.wipeName, 0);
  ...
  if ( UnityEngine_Object__op_Inequality(figure, 0, 0) )
  {
    ...
    if ( backFlashMesh )
    {
      ...
      if ( backFlashMesh )
      {
        ...
        this->fields.figure = 0;
        sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields.figure, 0, v15, v16, v17, v18, v19, v20);
        return;
      }
    }
LABEL_17:
    sub_2213CDC(backFlashMesh, method);
  }
}
