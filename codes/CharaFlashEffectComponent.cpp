        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45F64 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_CharaFlashEffectComponent_EndCreateEffect__, v7);
    ...
    sub_1BDB878(&StringLiteral_4964/*"Custom/Sprite-ScriptActionFigureFlash"*/, v12);
    sub_1BDB878(&StringLiteral_16215/*"_Gradation"*/, v13);
    sub_1BDB878(&StringLiteral_13601/*"Talk/"*/, v14);
    sub_1BDB878(&StringLiteral_4947/*"Custom/BackFlashSheder"*/, v15);
    byte_4B45F64 = 1;
  }
  ...
  v22 = UnityEngine_Shader__Find((System_String_o *)StringLiteral_4947/*"Custom/BackFlashSheder"*/, 0LL);
...
LABEL_30:
    sub_1BDBAD4(figure, v17);
  }
LABEL_18:
  figure = (UIStandFigureRender_o *)this->fields.figure;
  if ( !figure )
    goto LABEL_30;
  UIStandFigureRender__SetSharder(figure, (System_String_o *)StringLiteral_4964/*"Custom/Sprite-ScriptActionFigureFlash"*/, 0LL);
  figure = (UIStandFigureRender_o *)this->fields.figure;
  if ( !figure )
    goto LABEL_30;
    ...
    && !System_String__IsNullOrEmpty(this->fields.subEffectName, 0LL) )
  {
    ...
    v27 = System_String__Concat_62572260((System_String_o *)StringLiteral_13601/*"Talk/"*/, this->fields.subEffectName, 0LL);
    v28 = (CommonEffectLoadComponent_LoadEndHandler_o *)sub_1BDBAC4(CommonEffectLoadComponent_LoadEndHandler_TypeInfo);
    ...
    CommonEffectManager__Create_42558416(v26, v27, v28, 0, 0, 0, v30);
  }
  else
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45F63 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_CharaFlashEffectComponent_EndLoadWipe__, v6);
    ...
    sub_1BDB878(&StringLiteral_15635/*"Wipe/"*/, v10);
    sub_1BDB878(&StringLiteral_24887/*"white"*/, v11);
    byte_4B45F63 = 1;
  }
  ...
  if ( isSkip )
  {
    ...
    sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.figure, 0, v15, v16);
  ...
  {
    v18 = System_String__Concat_62572260((System_String_o *)StringLiteral_15635/*"Wipe/"*/, this->fields.wipeName, 0LL);
...
void __fastcall CharaFlashEffectComponent__OnDestroy(CharaFlashEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.wipeData )
  {
    ...
    if ( !AssetManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
    AssetManager__releaseAsset_39554172(v7, 0LL);
    *p_wipeData = 0LL;
    sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.wipeData, 0, v8, v9);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(figure, 0LL, 0LL) )
  {
    ...
    if ( p_figure->klass )
    {
      ...
      if ( p_figure->klass )
      {
        ...
        p_figure->klass = 0LL;
        sub_1BDB81C(p_figure, 0, v12, v13);
        return;
      }
    }
LABEL_17:
    sub_1BDBAD4(backFlashMesh, method);
  }
}
...
void __fastcall CharaFlashEffectComponent__OnEndEffect(CharaFlashEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B45F66 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_24887/*"white"*/, v5);
    byte_4B45F66 = 1;
  }
