void __fastcall CharaFlashEffectComponent___ctor(CharaFlashEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A20DEA & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_17923/*"circleIn"*/, method);
    byte_4A20DEA = 1;
  }
  *(_QWORD *)&this->fields.flashColor.fields.r = 0LL;
  *(_QWORD *)&this->fields.flashColor.fields.b = 0LL;
  v5 = StringLiteral_17923/*"circleIn"*/;
  this->fields.wipeName = (struct System_String_o *)StringLiteral_17923/*"circleIn"*/;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20DE5 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_CharaFlashEffectComponent_EndCreateEffect__, v7);
    ...
    sub_1B715CC(&StringLiteral_4945/*"Custom/Sprite-ScriptActionFigureFlash"*/, v12);
    sub_1B715CC(&StringLiteral_16185/*"_Gradation"*/, v13);
    sub_1B715CC(&StringLiteral_13488/*"Talk/"*/, v14);
    sub_1B715CC(&StringLiteral_4928/*"Custom/BackFlashSheder"*/, v15);
    byte_4A20DE5 = 1;
  }
  ...
  v22 = UnityEngine_Shader__Find((System_String_o *)StringLiteral_4928/*"Custom/BackFlashSheder"*/, 0LL);
  ...
  if ( UnityEngine_Material__HasProperty_69124120(
         ...
         (System_String_o *)StringLiteral_16185/*"_Gradation"*/,
         0LL) )
  {
    figure = (UIStandFigureRender_o *)this->fields.backFlashMesh;
    if ( figure )
...
LABEL_30:
    sub_1B71828(figure, v17);
  }
LABEL_18:
  figure = (UIStandFigureRender_o *)this->fields.figure;
  if ( !figure )
    goto LABEL_30;
  UIStandFigureRender__SetSharder(figure, (System_String_o *)StringLiteral_4945/*"Custom/Sprite-ScriptActionFigureFlash"*/, 0LL);
  figure = (UIStandFigureRender_o *)this->fields.figure;
  if ( !figure )
    goto LABEL_30;
    ...
    && !System_String__IsNullOrEmpty(this->fields.subEffectName, 0LL) )
  {
    ...
    v27 = System_String__Concat_61505504((System_String_o *)StringLiteral_13488/*"Talk/"*/, this->fields.subEffectName, 0LL);
    v28 = (CommonEffectLoadComponent_LoadEndHandler_o *)sub_1B71818(CommonEffectLoadComponent_LoadEndHandler_TypeInfo);
    ...
    CommonEffectManager__Create_40407624(v26, v27, v28, 0, 0, 0, v30);
  }
  else
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20DE4 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_CharaFlashEffectComponent_EndLoadWipe__, v6);
    ...
    sub_1B715CC(&StringLiteral_15610/*"Wipe/"*/, v10);
    sub_1B715CC(&StringLiteral_24632/*"white"*/, v11);
    byte_4A20DE4 = 1;
  }
  ...
  if ( isSkip )
  {
    ...
    ScriptManager__Fade((System_String_o *)StringLiteral_24632/*"white"*/, 0, 0.0, 0LL);
    if ( !*p_figure )
      sub_1B71828(0LL, v14);
    UIStandFigureRender__SetAlpha(*p_figure, 0.0, 0LL);
    this->fields.figure = 0LL;
    sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.figure, 0, v15, v16);
  ...
  {
    v18 = System_String__Concat_61505504((System_String_o *)StringLiteral_15610/*"Wipe/"*/, this->fields.wipeName, 0LL);
...
void __fastcall CharaFlashEffectComponent__OnDestroy(CharaFlashEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.wipeData )
  {
    ...
    *p_wipeData = 0LL;
    sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.wipeData, 0, v8, v9);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(figure, 0LL, 0LL) )
  {
    ...
    if ( p_figure->klass )
    {
      ...
      if ( p_figure->klass )
      {
        ...
        p_figure->klass = 0LL;
        sub_1B71570(p_figure, 0, v12, v13);
        return;
      }
    }
LABEL_17:
    sub_1B71828(backFlashMesh, method);
  }
}
...
void __fastcall CharaFlashEffectComponent__OnEndEffect(CharaFlashEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A20DE7 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_24632/*"white"*/, v5);
    byte_4A20DE7 = 1;
  }
  ...
  if ( !ScriptManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(ScriptManager_TypeInfo);
  ScriptManager__Fade((System_String_o *)StringLiteral_24632/*"white"*/, 0, 1.0, 0LL);
