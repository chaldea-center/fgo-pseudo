...
void __fastcall UIForwardEvents__OnClick(UIForwardEvents_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BF821 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_9636/*"OnClick"*/, v3);
    byte_49BF821 = 1;
  }
  if ( this->fields.onClick )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(target, 0LL, 0LL) )
    {
      ...
      if ( !v6 )
        sub_1B4D1EC(0LL, v5);
      UnityEngine_GameObject__SendMessage(v6, (System_String_o *)StringLiteral_9636/*"OnClick"*/, 1, 0LL);
    }
  }
}
...
void __fastcall UIForwardEvents__OnDoubleClick(UIForwardEvents_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B4CF90(&UnityEngine_Object_TypeInfo, method);
    sub_1B4CF90(&StringLiteral_9684/*"OnDoubleClick"*/, v3);
    byte_49BF822 = 1;
  }
  if ( this->fields.onDoubleClick )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(target, 0LL, 0LL) )
    {
      ...
      if ( !v6 )
        sub_1B4D1EC(0LL, v5);
      UnityEngine_GameObject__SendMessage(v6, (System_String_o *)StringLiteral_9684/*"OnDoubleClick"*/, 1, 0LL);
    }
  }
}
...
void __fastcall UIForwardEvents__OnDrag(UIForwardEvents_o *this, UnityEngine_Vector2_o delta, const MethodInfo *method)
{
  ...
  {
    sub_1B4CF90(&UnityEngine_Object_TypeInfo, method);
    sub_1B4CF90(&UnityEngine_Vector2_TypeInfo, v6);
    sub_1B4CF90(&StringLiteral_9686/*"OnDrag"*/, v7);
    byte_49BF824 = 1;
  }
  if ( this->fields.onDrag )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(target, 0LL, 0LL) )
    {
      ...
      *(float *)&v15[1] = y;
      ...
      if ( !v12 )
        sub_1B4D1EC(v13, v14);
      UnityEngine_GameObject__SendMessage_68784772(v12, (System_String_o *)StringLiteral_9686/*"OnDrag"*/, v13, 1, 0LL);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BF825 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_9691/*"OnDrop"*/, v5);
    byte_49BF825 = 1;
  }
  if ( this->fields.onDrop )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(target, 0LL, 0LL) )
    {
      ...
      if ( !v8 )
        sub_1B4D1EC(0LL, v7);
      UnityEngine_GameObject__SendMessage_68784772(
        v8,
        (System_String_o *)StringLiteral_9691/*"OnDrop"*/,
        (Il2CppObject *)go,
        1,
        0LL);
    }
...
void __fastcall UIForwardEvents__OnHover(UIForwardEvents_o *this, bool isOver, const MethodInfo *method)
{
  ...
  if ( (byte_49BF81F & 1) == 0 )
  {
    sub_1B4CF90(&bool_TypeInfo, isOver);
  ...
  if ( this->fields.onHover )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(target, 0LL, 0LL) )
    {
      ...
      if ( !v11 )
        sub_1B4D1EC(v12, v13);
      UnityEngine_GameObject__SendMessage_68784772(v11, (System_String_o *)StringLiteral_9709/*"OnHover"*/, v12, 1, 0LL);
    }
  }
}
...
void __fastcall UIForwardEvents__OnPress(UIForwardEvents_o *this, bool pressed, const MethodInfo *method)
{
  ...
  if ( (byte_49BF820 & 1) == 0 )
  {
    sub_1B4CF90(&bool_TypeInfo, pressed);
    sub_1B4CF90(&UnityEngine_Object_TypeInfo, v5);
    sub_1B4CF90(&StringLiteral_9740/*"OnPress"*/, v6);
    byte_49BF820 = 1;
  }
  if ( this->fields.onPress )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(target, 0LL, 0LL) )
    {
      ...
      if ( !v11 )
        sub_1B4D1EC(v12, v13);
      UnityEngine_GameObject__SendMessage_68784772(v11, (System_String_o *)StringLiteral_9740/*"OnPress"*/, v12, 1, 0LL);
    }
  }
}
...
void __fastcall UIForwardEvents__OnScroll(UIForwardEvents_o *this, float delta, const MethodInfo *method)
{
  ...
  if ( (byte_49BF827 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_9748/*"OnScroll"*/, v6);
    byte_49BF827 = 1;
  }
  if ( this->fields.onScroll )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(target, 0LL, 0LL) )
    {
      ...
      if ( !v11 )
        sub_1B4D1EC(v12, v13);
      UnityEngine_GameObject__SendMessage_68784772(v11, (System_String_o *)StringLiteral_9748/*"OnScroll"*/, v12, 1, 0LL);
    }
  }
}
...
void __fastcall UIForwardEvents__OnSelect(UIForwardEvents_o *this, bool selected, const MethodInfo *method)
{
  ...
  if ( (byte_49BF823 & 1) == 0 )
  {
    sub_1B4CF90(&bool_TypeInfo, selected);
    sub_1B4CF90(&UnityEngine_Object_TypeInfo, v5);
    sub_1B4CF90(&StringLiteral_9751/*"OnSelect"*/, v6);
    byte_49BF823 = 1;
  }
  if ( this->fields.onSelect )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(target, 0LL, 0LL) )
    {
      ...
      if ( !v11 )
        sub_1B4D1EC(v12, v13);
      UnityEngine_GameObject__SendMessage_68784772(v11, (System_String_o *)StringLiteral_9751/*"OnSelect"*/, v12, 1, 0LL);
    }
  }
}
...
void __fastcall UIForwardEvents__OnSubmit(UIForwardEvents_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B4CF90(&UnityEngine_Object_TypeInfo, method);
    sub_1B4CF90(&StringLiteral_9761/*"OnSubmit"*/, v3);
    byte_49BF826 = 1;
  }
  if ( this->fields.onSubmit )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(target, 0LL, 0LL) )
    {
      ...
      if ( !v6 )
        sub_1B4D1EC(0LL, v5);
      UnityEngine_GameObject__SendMessage(v6, (System_String_o *)StringLiteral_9761/*"OnSubmit"*/, 1, 0LL);
    }
  }
}