...
void __fastcall UIForwardEvents__OnClick(UIForwardEvents_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5FA3D & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_9836/*"OnClick"*/);
    byte_4A5FA3D = 1;
  }
  if ( this->fields.onClick )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(target, 0LL, 0LL) )
    {
      ...
      if ( !v5 )
        sub_1B8880C(0LL, v4);
      UnityEngine_GameObject__SendMessage(v5, (System_String_o *)StringLiteral_9836/*"OnClick"*/, 1, 0LL);
    }
  }
}
...
void __fastcall UIForwardEvents__OnDoubleClick(UIForwardEvents_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B885B0(&UnityEngine_Object_TypeInfo);
    sub_1B885B0(&StringLiteral_9883/*"OnDoubleClick"*/);
    byte_4A5FA3E = 1;
  }
  if ( this->fields.onDoubleClick )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(target, 0LL, 0LL) )
    {
      ...
      if ( !v5 )
        sub_1B8880C(0LL, v4);
      UnityEngine_GameObject__SendMessage(v5, (System_String_o *)StringLiteral_9883/*"OnDoubleClick"*/, 1, 0LL);
    }
  }
}
...
void __fastcall UIForwardEvents__OnDrag(UIForwardEvents_o *this, UnityEngine_Vector2_o delta, const MethodInfo *method)
{
  ...
  if ( (byte_4A5FA40 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_9885/*"OnDrag"*/);
    byte_4A5FA40 = 1;
  }
  if ( this->fields.onDrag )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(target, 0LL, 0LL) )
    {
      ...
      *(float *)&v13[1] = y;
      ...
      if ( !v10 )
        sub_1B8880C(v11, v12);
      UnityEngine_GameObject__SendMessage_69439696(v10, (System_String_o *)StringLiteral_9885/*"OnDrag"*/, v11, 1, 0LL);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B885B0(&UnityEngine_Object_TypeInfo);
    sub_1B885B0(&StringLiteral_9890/*"OnDrop"*/);
    byte_4A5FA41 = 1;
  }
  if ( this->fields.onDrop )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(target, 0LL, 0LL) )
    {
      ...
      UnityEngine_GameObject__SendMessage_69439696(
        v7,
        (System_String_o *)StringLiteral_9890/*"OnDrop"*/,
        (Il2CppObject *)go,
        1,
        0LL);
    }
...
void __fastcall UIForwardEvents__OnHover(UIForwardEvents_o *this, bool isOver, const MethodInfo *method)
{
  ...
  if ( this->fields.onHover )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(target, 0LL, 0LL) )
    {
      ...
      if ( !v9 )
        sub_1B8880C(v10, v11);
      UnityEngine_GameObject__SendMessage_69439696(v9, (System_String_o *)StringLiteral_9907/*"OnHover"*/, v10, 1, 0LL);
    }
  }
}
...
void __fastcall UIForwardEvents__OnPress(UIForwardEvents_o *this, bool pressed, const MethodInfo *method)
{
  ...
  if ( this->fields.onPress )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(target, 0LL, 0LL) )
    {
      ...
      if ( !v9 )
        sub_1B8880C(v10, v11);
      UnityEngine_GameObject__SendMessage_69439696(v9, (System_String_o *)StringLiteral_9939/*"OnPress"*/, v10, 1, 0LL);
    }
  }
}
...
void __fastcall UIForwardEvents__OnScroll(UIForwardEvents_o *this, float delta, const MethodInfo *method)
{
  ...
  if ( (byte_4A5FA43 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_9947/*"OnScroll"*/);
    byte_4A5FA43 = 1;
  }
  if ( this->fields.onScroll )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(target, 0LL, 0LL) )
    {
      ...
      if ( !v9 )
        sub_1B8880C(v10, v11);
      UnityEngine_GameObject__SendMessage_69439696(v9, (System_String_o *)StringLiteral_9947/*"OnScroll"*/, v10, 1, 0LL);
    }
  }
}
...
void __fastcall UIForwardEvents__OnSelect(UIForwardEvents_o *this, bool selected, const MethodInfo *method)
{
  ...
  if ( (byte_4A5FA3F & 1) == 0 )
  {
    sub_1B885B0(&bool_TypeInfo);
    sub_1B885B0(&UnityEngine_Object_TypeInfo);
    sub_1B885B0(&StringLiteral_9950/*"OnSelect"*/);
    byte_4A5FA3F = 1;
  }
  if ( this->fields.onSelect )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(target, 0LL, 0LL) )
    {
      ...
      if ( !v9 )
        sub_1B8880C(v10, v11);
      UnityEngine_GameObject__SendMessage_69439696(v9, (System_String_o *)StringLiteral_9950/*"OnSelect"*/, v10, 1, 0LL);
    }
  }
}
...
void __fastcall UIForwardEvents__OnSubmit(UIForwardEvents_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B885B0(&UnityEngine_Object_TypeInfo);
    sub_1B885B0(&StringLiteral_9960/*"OnSubmit"*/);
    byte_4A5FA42 = 1;
  }
  if ( this->fields.onSubmit )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(target, 0LL, 0LL) )
    {
      ...
      if ( !v5 )
        sub_1B8880C(0LL, v4);
      UnityEngine_GameObject__SendMessage(v5, (System_String_o *)StringLiteral_9960/*"OnSubmit"*/, 1, 0LL);
    }
  }
}