...
void __fastcall UIForwardEvents__OnClick(UIForwardEvents_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4ABA4E6 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_9842/*"OnClick"*/, v3);
    byte_4ABA4E6 = 1;
  }
...
void __fastcall UIForwardEvents__OnDoubleClick(UIForwardEvents_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BAB41C(&UnityEngine_Object_TypeInfo, method);
    sub_1BAB41C(&StringLiteral_9889/*"OnDoubleClick"*/, v3);
    byte_4ABA4E7 = 1;
  }
...
void __fastcall UIForwardEvents__OnDrag(UIForwardEvents_o *this, UnityEngine_Vector2_o delta, const MethodInfo *method)
{
  ...
  {
    sub_1BAB41C(&UnityEngine_Object_TypeInfo, method);
    sub_1BAB41C(&UnityEngine_Vector2_TypeInfo, v6);
    sub_1BAB41C(&StringLiteral_9891/*"OnDrag"*/, v7);
    byte_4ABA4E9 = 1;
  }
  if ( this->fields.onDrag )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(target, 0LL, 0LL) )
    {
      ...
      *(float *)&v15[1] = y;
      ...
      if ( !v12 )
        sub_1BAB678(v13, v14);
      UnityEngine_GameObject__SendMessage_69780936(v12, (System_String_o *)StringLiteral_9891/*"OnDrag"*/, v13, 1, 0LL);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4ABA4EA & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_9896/*"OnDrop"*/, v5);
    byte_4ABA4EA = 1;
  }
  if ( this->fields.onDrop )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(target, 0LL, 0LL) )
    {
      ...
      if ( !v8 )
        sub_1BAB678(0LL, v7);
      UnityEngine_GameObject__SendMessage_69780936(
        v8,
...
void __fastcall UIForwardEvents__OnHover(UIForwardEvents_o *this, bool isOver, const MethodInfo *method)
{
  ...
  if ( (byte_4ABA4E4 & 1) == 0 )
  {
    sub_1BAB41C(&bool_TypeInfo, isOver);
  ...
  if ( this->fields.onHover )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(target, 0LL, 0LL) )
    {
      ...
      if ( !v11 )
        sub_1BAB678(v12, v13);
      UnityEngine_GameObject__SendMessage_69780936(v11, (System_String_o *)StringLiteral_9914/*"OnHover"*/, v12, 1, 0LL);
    }
  }
}
...
void __fastcall UIForwardEvents__OnPress(UIForwardEvents_o *this, bool pressed, const MethodInfo *method)
{
  ...
  if ( (byte_4ABA4E5 & 1) == 0 )
  {
    sub_1BAB41C(&bool_TypeInfo, pressed);
    sub_1BAB41C(&UnityEngine_Object_TypeInfo, v5);
    sub_1BAB41C(&StringLiteral_9945/*"OnPress"*/, v6);
    byte_4ABA4E5 = 1;
  }
  if ( this->fields.onPress )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(target, 0LL, 0LL) )
    {
      ...
      if ( !v11 )
        sub_1BAB678(v12, v13);
      UnityEngine_GameObject__SendMessage_69780936(v11, (System_String_o *)StringLiteral_9945/*"OnPress"*/, v12, 1, 0LL);
    }
  }
}
...
void __fastcall UIForwardEvents__OnScroll(UIForwardEvents_o *this, float delta, const MethodInfo *method)
{
  ...
  if ( (byte_4ABA4EC & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_9953/*"OnScroll"*/, v6);
    byte_4ABA4EC = 1;
  }
  if ( this->fields.onScroll )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(target, 0LL, 0LL) )
    {
      ...
      if ( !v11 )
        sub_1BAB678(v12, v13);
      UnityEngine_GameObject__SendMessage_69780936(v11, (System_String_o *)StringLiteral_9953/*"OnScroll"*/, v12, 1, 0LL);
    }
  }
}
...
void __fastcall UIForwardEvents__OnSelect(UIForwardEvents_o *this, bool selected, const MethodInfo *method)
{
  ...
  if ( (byte_4ABA4E8 & 1) == 0 )
  {
    sub_1BAB41C(&bool_TypeInfo, selected);
    sub_1BAB41C(&UnityEngine_Object_TypeInfo, v5);
    sub_1BAB41C(&StringLiteral_9956/*"OnSelect"*/, v6);
    byte_4ABA4E8 = 1;
  }
  if ( this->fields.onSelect )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(target, 0LL, 0LL) )
    {
      ...
      if ( !v11 )
        sub_1BAB678(v12, v13);
      UnityEngine_GameObject__SendMessage_69780936(v11, (System_String_o *)StringLiteral_9956/*"OnSelect"*/, v12, 1, 0LL);
    }
  }
}
...
void __fastcall UIForwardEvents__OnSubmit(UIForwardEvents_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BAB41C(&UnityEngine_Object_TypeInfo, method);
    sub_1BAB41C(&StringLiteral_9966/*"OnSubmit"*/, v3);
    byte_4ABA4EB = 1;
  }
