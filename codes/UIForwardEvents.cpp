...
void __fastcall UIForwardEvents__OnClick(UIForwardEvents_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B49372 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_9837/*"OnClick"*/, v3);
    byte_4B49372 = 1;
  }
  if ( this->fields.onClick )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(target, 0LL, 0LL) )
    {
      ...
      if ( !v6 )
        sub_1BDBAD4(0LL, v5);
      UnityEngine_GameObject__SendMessage(v6, (System_String_o *)StringLiteral_9837/*"OnClick"*/, 1, 0LL);
    }
  }
}
...
void __fastcall UIForwardEvents__OnDoubleClick(UIForwardEvents_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&UnityEngine_Object_TypeInfo, method);
    sub_1BDB878(&StringLiteral_9888/*"OnDoubleClick"*/, v3);
    byte_4B49373 = 1;
  }
  if ( this->fields.onDoubleClick )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(target, 0LL, 0LL) )
    {
      ...
      if ( !v6 )
        sub_1BDBAD4(0LL, v5);
      UnityEngine_GameObject__SendMessage(v6, (System_String_o *)StringLiteral_9888/*"OnDoubleClick"*/, 1, 0LL);
    }
  }
}
...
void __fastcall UIForwardEvents__OnDrag(UIForwardEvents_o *this, UnityEngine_Vector2_o delta, const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&UnityEngine_Object_TypeInfo, method);
    sub_1BDB878(&UnityEngine_Vector2_TypeInfo, v6);
    sub_1BDB878(&StringLiteral_9890/*"OnDrag"*/, v7);
    byte_4B49375 = 1;
  }
  if ( this->fields.onDrag )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(target, 0LL, 0LL) )
    {
      ...
      *(float *)&v15[1] = y;
      ...
      if ( !v12 )
        sub_1BDBAD4(v13, v14);
      UnityEngine_GameObject__SendMessage_70264932(v12, (System_String_o *)StringLiteral_9890/*"OnDrag"*/, v13, 1, 0LL);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B49376 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_9895/*"OnDrop"*/, v5);
    byte_4B49376 = 1;
  }
  if ( this->fields.onDrop )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(target, 0LL, 0LL) )
    {
      ...
      if ( !v8 )
        sub_1BDBAD4(0LL, v7);
      UnityEngine_GameObject__SendMessage_70264932(
        v8,
...
void __fastcall UIForwardEvents__OnHover(UIForwardEvents_o *this, bool isOver, const MethodInfo *method)
{
  ...
  if ( (byte_4B49370 & 1) == 0 )
  {
    sub_1BDB878(&bool_TypeInfo, isOver);
  ...
  if ( this->fields.onHover )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(target, 0LL, 0LL) )
    {
      ...
      if ( !v11 )
        sub_1BDBAD4(v12, v13);
      UnityEngine_GameObject__SendMessage_70264932(v11, (System_String_o *)StringLiteral_9913/*"OnHover"*/, v12, 1, 0LL);
    }
  }
}
...
void __fastcall UIForwardEvents__OnPress(UIForwardEvents_o *this, bool pressed, const MethodInfo *method)
{
  ...
  if ( (byte_4B49371 & 1) == 0 )
  {
    sub_1BDB878(&bool_TypeInfo, pressed);
    sub_1BDB878(&UnityEngine_Object_TypeInfo, v5);
    sub_1BDB878(&StringLiteral_9944/*"OnPress"*/, v6);
    byte_4B49371 = 1;
  }
  if ( this->fields.onPress )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(target, 0LL, 0LL) )
    {
      ...
      if ( !v11 )
        sub_1BDBAD4(v12, v13);
      UnityEngine_GameObject__SendMessage_70264932(v11, (System_String_o *)StringLiteral_9944/*"OnPress"*/, v12, 1, 0LL);
    }
  }
}
...
void __fastcall UIForwardEvents__OnScroll(UIForwardEvents_o *this, float delta, const MethodInfo *method)
{
  ...
  if ( (byte_4B49378 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_9952/*"OnScroll"*/, v6);
    byte_4B49378 = 1;
  }
  if ( this->fields.onScroll )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(target, 0LL, 0LL) )
    {
      ...
      if ( !v11 )
        sub_1BDBAD4(v12, v13);
      UnityEngine_GameObject__SendMessage_70264932(v11, (System_String_o *)StringLiteral_9952/*"OnScroll"*/, v12, 1, 0LL);
    }
  }
}
...
void __fastcall UIForwardEvents__OnSelect(UIForwardEvents_o *this, bool selected, const MethodInfo *method)
{
  ...
  if ( (byte_4B49374 & 1) == 0 )
  {
    sub_1BDB878(&bool_TypeInfo, selected);
    sub_1BDB878(&UnityEngine_Object_TypeInfo, v5);
    sub_1BDB878(&StringLiteral_9956/*"OnSelect"*/, v6);
    byte_4B49374 = 1;
  }
  if ( this->fields.onSelect )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(target, 0LL, 0LL) )
    {
      ...
      if ( !v11 )
        sub_1BDBAD4(v12, v13);
      UnityEngine_GameObject__SendMessage_70264932(v11, (System_String_o *)StringLiteral_9956/*"OnSelect"*/, v12, 1, 0LL);
    }
  }
}
...
void __fastcall UIForwardEvents__OnSubmit(UIForwardEvents_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&UnityEngine_Object_TypeInfo, method);
    sub_1BDB878(&StringLiteral_9966/*"OnSubmit"*/, v3);
    byte_4B49377 = 1;
  }
