void SpotPathMaster___ctor(SpotPathMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4CB6EF5 & 1) == 0 )
  {
    sub_1C6BA08(&Method_DataMasterBase_SpotPathMaster__SpotPathEntity__int___ctor__);
    byte_4CB6EF5 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    223,
    (const MethodInfo_33F6DB8 *)Method_DataMasterBase_SpotPathMaster__SpotPathEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB6EF6 & 1) == 0 )
  {
    sub_1C6BA08(&Method_System_Collections_ObjectModel_Collection_SpotPathEntity__get_Count__);
    sub_1C6BA08(&Method_System_Collections_ObjectModel_Collection_SpotPathEntity__get_Item__);
    byte_4CB6EF6 = 1;
  }
  ...
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            ...
            (const MethodInfo_3391E64 *)Method_System_Collections_ObjectModel_Collection_SpotPathEntity__get_Count__);
  if ( Count >= 1 )
  {
    v11 = Count;
    v12 = 0;
    ...
    while ( 1 )
    {
      ...
      result = (SpotPathEntity_o *)System_Collections_ObjectModel_Collection_object___get_Item(
                                     (System_Collections_ObjectModel_Collection_T__o *)result,
                                     v12,
                                     (const MethodInfo_3391EF4 *)Method_System_Collections_ObjectModel_Collection_SpotPathEntity__get_Item__);
      if ( !result )
        break;
