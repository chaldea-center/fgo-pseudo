void __fastcall SpotPathMaster___ctor(SpotPathMaster_o *this, const MethodInfo *method)
{
  if ( (byte_49FF4C6 & 1) == 0 )
  {
    sub_1B64A00(&Method_DataMasterBase_SpotPathMaster__SpotPathEntity__int___ctor__, method);
    byte_49FF4C6 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    217,
    (const MethodInfo_30D6758 *)Method_DataMasterBase_SpotPathMaster__SpotPathEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF4C7 & 1) == 0 )
  {
    ...
    sub_1B64A00(&SpotPathEntity_TypeInfo, v10);
    byte_49FF4C7 = 1;
  }
