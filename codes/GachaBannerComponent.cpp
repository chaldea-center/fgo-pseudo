...
void __fastcall GachaBannerComponent__OnClickDetail(GachaBannerComponent_o *this, const MethodInfo *method)
{
  ...
  v7 = LocalizationManager__Get((System_String_o *)StringLiteral_15474/*"WEB_VIEW_TITLE_SUMMON"*/, 0LL);
...
void __fastcall GachaBannerComponent__UpdateDisplay(GachaBannerComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B3AF1 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_6885/*"GACHA_PC_MESSAGE"*/);
    sub_B52984(&StringLiteral_6886/*"GACHA_PC_MESSAGE_END"*/);
    byte_42B3AF1 = 1;
  }
  entity = 0LL;
  ...
  info = (int64_t)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !info )
    goto LABEL_29;
...
LABEL_32:
    ...
    info = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_6885/*"GACHA_PC_MESSAGE"*/, 0LL);
    v8 = this->fields.info;
    if ( v8 )
    {
      ...
      if ( v10 )
      {
        ...
        v7 = System_String__Format_44563852(v9, v11, DateTimeDayOfWeek, 0LL);
        goto LABEL_27;
      }
    }
LABEL_29:
    sub_B52A5C(info, method);
  }
  if ( (BYTE3(LocalizationManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !LocalizationManager_TypeInfo->_2.cctor_finished )
  {
  ...
  v7 = LocalizationManager__Get((System_String_o *)StringLiteral_6886/*"GACHA_PC_MESSAGE_END"*/, 0LL);
LABEL_27:
