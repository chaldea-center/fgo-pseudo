...
void __fastcall GachaBannerComponent__OnClickDetail(GachaBannerComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD8B58 & 1) == 0 )
  {
    sub_1C21E38(&Method_GachaBannerComponent_OnClickDetail__);
  ...
  if ( (*((_BYTE *)Method_GachaBannerComponent_OnClickDetail__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C21E50(Method_GachaBannerComponent_OnClickDetail__);
  ...
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_15821/*"WEB_VIEW_TITLE_SUMMON"*/, 0LL);
...
void __fastcall GachaBannerComponent__UpdateDisplay(GachaBannerComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD8B56 & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_7056/*"GACHA_PC_MESSAGE_NO_MAX"*/);
    sub_1C21E38(&StringLiteral_7054/*"GACHA_PC_MESSAGE"*/);
    sub_1C21E38(&StringLiteral_7055/*"GACHA_PC_MESSAGE_END"*/);
    byte_4BD8B56 = 1;
  }
  entity = 0LL;
  v16 = 0LL;
  ...
  info = (VaildGachaInfo_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_388D058 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !info )
    goto LABEL_50;
  ...
  {
LABEL_23:
    v8 = (System_String_o *)StringLiteral_7054/*"GACHA_PC_MESSAGE"*/;
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    info = (VaildGachaInfo_o *)DataManager__GetMaster_object_((const MethodInfo_2FAFDB0 *)Method_DataManager_GetMaster_GachaPickupCollateralGroupMaster___);
    v9 = this->fields.info;
    if ( v9 && info )
    {
      ...
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      info = (VaildGachaInfo_o *)DataManager__GetMaster_object_((const MethodInfo_2FAFDB0 *)Method_DataManager_GetMaster_GachaPickupCollateralMaster___);
      ...
      if ( ((unsigned __int8)info & 1) != 0 )
      {
        ...
        if ( maxGetNum )
          ...
          v7 = 746;
        if ( !maxGetNum )
          v8 = (System_String_o *)StringLiteral_7056/*"GACHA_PC_MESSAGE_NO_MAX"*/;
      }
      else
      {
LABEL_40:
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      info = (VaildGachaInfo_o *)LocalizationManager__Get(v8, 0LL);
      v11 = this->fields.info;
      if ( v11 )
      {
        v12 = (System_String_o *)info;
        info = (VaildGachaInfo_o *)LocalizationManager__GetDateTimeDayOfWeek(v11->fields.openedAt, 0LL);
        ...
        if ( v13 )
        {
          ...
          method = (const MethodInfo *)System_String__Format_63129848(v12, v14, DateTimeDayOfWeek, 0LL);
          goto LABEL_46;
        }
      }
    }
LABEL_50:
    sub_1C22094(info, method);
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  method = (const MethodInfo *)LocalizationManager__Get((System_String_o *)StringLiteral_7055/*"GACHA_PC_MESSAGE_END"*/, 0LL);
  v7 = 785;
LABEL_46:
