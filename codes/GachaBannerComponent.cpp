...
void __fastcall GachaBannerComponent__OnClickDetail(GachaBannerComponent_o *this, const MethodInfo *method)
{
  ...
  v12 = LocalizationManager__Get((System_String_o *)StringLiteral_15810/*"WEB_VIEW_TITLE_SUMMON"*/, 0LL);
...
void __fastcall GachaBannerComponent__UpdateDisplay(GachaBannerComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC40C7 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataManager_GetMasterData_UserGachaMaster___, method);
    sub_1C1ABD4(&Method_DataManager_GetMaster_GachaPickupCollateralGroupMaster___, v3);
    sub_1C1ABD4(&Method_DataManager_GetMaster_GachaPickupCollateralMaster___, v4);
    ...
    sub_1C1ABD4(&StringLiteral_7046/*"GACHA_PC_MESSAGE_NO_MAX"*/, v9);
    sub_1C1ABD4(&StringLiteral_7044/*"GACHA_PC_MESSAGE"*/, v10);
    sub_1C1ABD4(&StringLiteral_7045/*"GACHA_PC_MESSAGE_END"*/, v11);
    byte_4BC40C7 = 1;
  }
  entity = 0LL;
  v25 = 0LL;
  ...
  info = (VaildGachaInfo_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_387A8A8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !info )
    goto LABEL_50;
  ...
  {
LABEL_23:
    v17 = (System_String_o *)StringLiteral_7044/*"GACHA_PC_MESSAGE"*/;
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    info = (VaildGachaInfo_o *)DataManager__GetMaster_object_((const MethodInfo_2F9F43C *)Method_DataManager_GetMaster_GachaPickupCollateralGroupMaster___);
    ...
    if ( v18 && info )
    {
      ...
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      info = (VaildGachaInfo_o *)DataManager__GetMaster_object_((const MethodInfo_2F9F43C *)Method_DataManager_GetMaster_GachaPickupCollateralMaster___);
      ...
      if ( ((unsigned __int8)info & 1) != 0 )
      {
        ...
        if ( maxGetNum )
          ...
          v16 = 746;
        if ( !maxGetNum )
          v17 = (System_String_o *)StringLiteral_7046/*"GACHA_PC_MESSAGE_NO_MAX"*/;
      }
      else
      {
LABEL_40:
      ...
      if ( v20 )
      {
        ...
        if ( v22 )
        {
          ...
          method = (const MethodInfo *)System_String__Format_63054740(v21, v23, DateTimeDayOfWeek, 0LL);
          goto LABEL_46;
        }
      }
    }
LABEL_50:
    sub_1C1AE30(info, method);
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  method = (const MethodInfo *)LocalizationManager__Get((System_String_o *)StringLiteral_7045/*"GACHA_PC_MESSAGE_END"*/, 0LL);
  v16 = 785;
LABEL_46:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC40C6 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_UnityEngine_GameObject_GetComponent_UIAtlas___, data);
