...
void GachaBannerComponent__OnClickDetail(GachaBannerComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C531CC & 1) == 0 )
  {
    sub_1C3E564(&Method_GachaBannerComponent_OnClickDetail__);
  ...
  if ( (*((_BYTE *)Method_GachaBannerComponent_OnClickDetail__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C3E57C(Method_GachaBannerComponent_OnClickDetail__);
  ...
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_15565/*"WEB_VIEW_TITLE_SUMMON"*/, 0);
...
void GachaBannerComponent__UpdateDisplay(GachaBannerComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C531CA & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_6914/*"GACHA_PC_MESSAGE_NO_MAX"*/);
    sub_1C3E564(&StringLiteral_6912/*"GACHA_PC_MESSAGE"*/);
    sub_1C3E564(&StringLiteral_6913/*"GACHA_PC_MESSAGE_END"*/);
    byte_4C531CA = 1;
  }
  entity = 0;
  v16 = 0;
  ...
  info = (VaildGachaInfo_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39FF5A8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !info )
    goto LABEL_50;
  ...
  {
LABEL_23:
    v8 = (System_String_o *)StringLiteral_6912/*"GACHA_PC_MESSAGE"*/;
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    info = (VaildGachaInfo_o *)DataManager__GetMaster_object_((const MethodInfo_30F9A1C *)Method_DataManager_GetMaster_GachaPickupCollateralGroupMaster___);
    v9 = this->fields.info;
    if ( v9 && info )
    {
      ...
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      info = (VaildGachaInfo_o *)DataManager__GetMaster_object_((const MethodInfo_30F9A1C *)Method_DataManager_GetMaster_GachaPickupCollateralMaster___);
      ...
      if ( ((unsigned __int8)info & 1) != 0 )
      {
        ...
        if ( maxGetNum )
          ...
          v7 = 746;
        if ( !maxGetNum )
          v8 = (System_String_o *)StringLiteral_6914/*"GACHA_PC_MESSAGE_NO_MAX"*/;
      }
      else
      {
LABEL_40:
      ...
      if ( v11 )
      {
        ...
        if ( v13 )
        {
          ...
          method = (const MethodInfo *)System_String__Format_63677760(v12, v14, DateTimeDayOfWeek, 0);
          goto LABEL_46;
        }
      }
    }
LABEL_50:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  method = (const MethodInfo *)LocalizationManager__Get((System_String_o *)StringLiteral_6913/*"GACHA_PC_MESSAGE_END"*/, 0);
  v7 = 785;
LABEL_46:
        ...
        const MethodInfo *method)
{
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.info, (int32_t)data, idx, *(const MethodInfo **)&moveIdx);
