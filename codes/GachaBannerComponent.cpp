...
void __fastcall GachaBannerComponent__OnClickDetail(GachaBannerComponent_o *this, const MethodInfo *method)
{
  ...
  v12 = LocalizationManager__Get((System_String_o *)StringLiteral_15255/*"WEB_VIEW_TITLE_SUMMON"*/, 0LL);
...
void __fastcall GachaBannerComponent__UpdateDisplay(GachaBannerComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49B7435 & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataManager_GetMasterData_UserGachaMaster___, method);
    sub_1B4CF90(&Method_DataManager_GetMaster_GachaPickupCollateralGroupMaster___, v3);
    sub_1B4CF90(&Method_DataManager_GetMaster_GachaPickupCollateralMaster___, v4);
    ...
    sub_1B4CF90(&StringLiteral_6797/*"GACHA_PC_MESSAGE_NO_MAX"*/, v9);
    sub_1B4CF90(&StringLiteral_6795/*"GACHA_PC_MESSAGE"*/, v10);
    sub_1B4CF90(&StringLiteral_6796/*"GACHA_PC_MESSAGE_END"*/, v11);
    byte_49B7435 = 1;
  }
  entity = 0LL;
  v25 = 0LL;
  ...
  info = (VaildGachaInfo_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37B4410 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !info )
    goto LABEL_50;
  ...
  {
LABEL_23:
    v17 = (System_String_o *)StringLiteral_6795/*"GACHA_PC_MESSAGE"*/;
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    info = (VaildGachaInfo_o *)DataManager__GetMaster_object_((const MethodInfo_2F01AD0 *)Method_DataManager_GetMaster_GachaPickupCollateralGroupMaster___);
    ...
    if ( v18 && info )
    {
      ...
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      info = (VaildGachaInfo_o *)DataManager__GetMaster_object_((const MethodInfo_2F01AD0 *)Method_DataManager_GetMaster_GachaPickupCollateralMaster___);
      ...
      if ( ((unsigned __int8)info & 1) != 0 )
      {
        ...
        if ( maxGetNum )
          ...
          v16 = 746;
        if ( !maxGetNum )
          v17 = (System_String_o *)StringLiteral_6797/*"GACHA_PC_MESSAGE_NO_MAX"*/;
      }
      else
      {
LABEL_40:
      ...
      if ( v20 )
      {
        ...
        if ( v22 )
        {
          ...
          method = (const MethodInfo *)System_String__Format_61134760(v21, v23, DateTimeDayOfWeek, 0LL);
          goto LABEL_46;
        }
      }
    }
LABEL_50:
    sub_1B4D1EC(info, method);
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  method = (const MethodInfo *)LocalizationManager__Get((System_String_o *)StringLiteral_6796/*"GACHA_PC_MESSAGE_END"*/, 0LL);
  v16 = 785;
LABEL_46:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B7434 & 1) == 0 )
  {
    sub_1B4CF90(&Method_UnityEngine_GameObject_GetComponent_UIAtlas___, data);
    sub_1B4CF90(&UnityEngine_Object_TypeInfo, v13);
    byte_49B7434 = 1;
  }
  this->fields.info = data;
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.info, (int32_t)data, idx, *(const MethodInfo **)&moveIdx);
  ...
  v24.fields.z = floorf(v20);
  v24.fields.x = clipPanel->fields.mClipRange.fields.x;
  v24.fields.y = clipPanel->fields.mClipRange.fields.y;
  v24.fields.w = clipPanel->fields.mClipRange.fields.w;
  UIPanel__set_baseClipRegion(this->fields.clipPanel, v24, 0LL);
  ...
  if ( privilegeClosedAt >= 1 )
  {
    ...
    if ( !height )
      goto LABEL_19;
    RemainTimeComponent__StartTimeUpdate((RemainTimeComponent_o *)height, data->fields.privilegeClosedAt, v23);
  }
