        ...
        const MethodInfo *method)
{
  ...
  if ( System_Collections_Generic_Dictionary_object__object___TryGetValue(
         Dictionary,
         (Il2CppObject *)StringLiteral_17022/*"ascensionAfterDialogId"*/,
         &value,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D3137E & 1) == 0 )
  {
    sub_1C93AD4(&Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__);
    sub_1C93AD4(&JsonManager_TypeInfo);
    sub_1C93AD4(&StringLiteral_17948/*"changeGraphCommonReleaseId"*/);
    byte_4D3137E = 1;
  }
  value = 0;
  strParam = this->fields.strParam;
  ...
  if ( System_Collections_Generic_Dictionary_object__object___TryGetValue(
         Dictionary,
         (Il2CppObject *)StringLiteral_17948/*"changeGraphCommonReleaseId"*/,
         &value,
         (const MethodInfo_35303B4 *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
  {
    Dictionary = (System_Collections_Generic_Dictionary_object__object__o *)value;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D3137F & 1) == 0 )
  {
    sub_1C93AD4(&Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__);
    sub_1C93AD4(&JsonManager_TypeInfo);
    sub_1C93AD4(&StringLiteral_17949/*"changeGraphSuffix"*/);
    byte_4D3137F = 1;
  }
  value = 0;
  strParam = this->fields.strParam;
  ...
  if ( System_Collections_Generic_Dictionary_object__object___TryGetValue(
         Dictionary,
         (Il2CppObject *)StringLiteral_17949/*"changeGraphSuffix"*/,
         &value,
         (const MethodInfo_35303B4 *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
  {
    Dictionary = (System_Collections_Generic_Dictionary_object__object__o *)value;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D31380 & 1) == 0 )
  {
    sub_1C93AD4(&Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__);
    sub_1C93AD4(&JsonManager_TypeInfo);
    sub_1C93AD4(&StringLiteral_17951/*"changeIconCommonReleaseId"*/);
    byte_4D31380 = 1;
  }
  value = 0;
  strParam = this->fields.strParam;
  ...
  if ( System_Collections_Generic_Dictionary_object__object___TryGetValue(
         Dictionary,
         (Il2CppObject *)StringLiteral_17951/*"changeIconCommonReleaseId"*/,
         &value,
         (const MethodInfo_35303B4 *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
  {
    Dictionary = (System_Collections_Generic_Dictionary_object__object__o *)value;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D31381 & 1) == 0 )
  {
    sub_1C93AD4(&Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__);
    sub_1C93AD4(&JsonManager_TypeInfo);
    sub_1C93AD4(&StringLiteral_17952/*"changeIconSuffix"*/);
    byte_4D31381 = 1;
  }
  value = 0;
  strParam = this->fields.strParam;
  ...
  if ( System_Collections_Generic_Dictionary_object__object___TryGetValue(
         Dictionary,
         (Il2CppObject *)StringLiteral_17952/*"changeIconSuffix"*/,
         &value,
         (const MethodInfo_35303B4 *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
  {
    Dictionary = (System_Collections_Generic_Dictionary_object__object__o *)value;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D3137C & 1) == 0 )
  {
    ...
    sub_1C93AD4(&JsonManager_TypeInfo);
    sub_1C93AD4(&StringLiteral_23472/*"saintGraphImageId"*/);
    byte_4D3137C = 1;
  }
  strParam = this->fields.strParam;
  if ( !JsonManager_TypeInfo->_2.cctor_finished )
  ...
  if ( Dictionary )
  {
    ...
    Item = System_Collections_Generic_Dictionary_object__object___get_Item(
             ...
             (Il2CppObject *)StringLiteral_23472/*"saintGraphImageId"*/,
...
UnityEngine_Color_o ServantLimitEntity__getWeaponColor(ServantLimitEntity_o *this, const MethodInfo *method)
{
  ...
  result.fields.r = (float)BYTE2(weaponColor) / 255.0;
  result.fields.g = (float)BYTE1(weaponColor) / 255.0;
  result.fields.b = (float)(unsigned __int8)weaponColor / 255.0;
  result.fields.a = 1.0;
  return result;
}