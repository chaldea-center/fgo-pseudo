        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC879F & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataManager_GetMasterData_EventQuestCooltimeMaster___, method);
    sub_1C1ABD4(
  ...
  *(_QWORD *)(v7 + 32) = Instance;
  sub_1C1AB78((PartyOrganizationUtility_o *)(v7 + 32), (int64_t)Instance, v10, v11, v12, v13, v14, v15);
  if ( *(_DWORD *)(v7 + 24) <= 1u )
    goto LABEL_12;
  v22 = StringLiteral_1546/*":"*/;
  *(_QWORD *)(v7 + 40) = StringLiteral_1546/*":"*/;
  sub_1C1AB78((PartyOrganizationUtility_o *)(v7 + 40), v22, v16, v17, v18, v19, v20, v21);
  Instance = (DataManager_o *)System_Int32__ToString(v2 + 28, 0LL);
  if ( *(_DWORD *)(v7 + 24) <= 2u
    || (*(_QWORD *)(v7 + 48) = Instance,
        sub_1C1AB78((PartyOrganizationUtility_o *)(v7 + 48), (int64_t)Instance, v23, v24, v25, v26, v27, v28),
        *(_DWORD *)(v7 + 24) <= 3u)
    || (v35 = StringLiteral_1546/*":"*/,
        *(_QWORD *)(v7 + 56) = StringLiteral_1546/*":"*/,
        sub_1C1AB78((PartyOrganizationUtility_o *)(v7 + 56), v35, v29, v30, v31, v32, v33, v34),
...
LABEL_12:
  ...
  *(_QWORD *)(v7 + 64) = Instance;
  sub_1C1AB78((PartyOrganizationUtility_o *)(v7 + 64), (int64_t)Instance, v36, v37, v38, v39, v40, v41);
  v42 = System_String__Concat_63053896((System_String_array *)v7, 0LL);
  ...
  if ( !Instance
    || (Instance = (DataManager_o *)DataManager__GetMasterData_object_(
                                      Instance,
                                      (const MethodInfo_2F9F490 *)Method_DataManager_GetMasterData_EventQuestCooltimeMaster___)) == 0LL )
  {
LABEL_13:
  ...
  return (EventQuestCooltimeEntity_o *)DataMasterBase_object__object__object___getEntityFromKey(
                                         ...
                                         v42,
                                         (const MethodInfo_324C4B8 *)Method_DataMasterBase_EventQuestCooltimeMaster__EventQuestCooltimeEntity__string__getEntityFromKey__);
}
