        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E0585D & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_DataMasterBase_EventQuestCooltimeMaster__EventQuestCooltimeEntity__string__getEntityFromKey__);
  ...
  *(_QWORD *)(v3 + 32) = Instance;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)(v3 + 32), (int32_t)Instance, v6, v7, v8, v9, v10, v11);
  if ( *(_DWORD *)(v3 + 24) <= 1u )
    goto LABEL_12;
  v18 = StringLiteral_1452/*":"*/;
  *(_QWORD *)(v3 + 40) = StringLiteral_1452/*":"*/;
  ...
  if ( *(_DWORD *)(v3 + 24) <= 2u
    || (*(_QWORD *)(v3 + 48) = Instance,
        sub_1CE66A4((GrandQuestFolderBoardItem_o *)(v3 + 48), (int32_t)Instance, v19, v20, v21, v22, v23, v24),
        *(_DWORD *)(v3 + 24) <= 3u)
    || (v31 = StringLiteral_1452/*":"*/,
        *(_QWORD *)(v3 + 56) = StringLiteral_1452/*":"*/,
...
LABEL_12:
  ...
  *(_QWORD *)(v3 + 64) = Instance;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)(v3 + 64), (int32_t)Instance, v32, v33, v34, v35, v36, v37);
  v38 = System_String__Concat_65163360((System_String_array *)v3, 0);
  ...
  if ( !Instance
    || (Instance = (DataManager_o *)DataManager__GetMasterData_object_(
                                      Instance,
                                      (const MethodInfo_32043A8 *)Method_DataManager_GetMasterData_EventQuestCooltimeMaster___)) == 0 )
  {
LABEL_13:
  ...
  return (EventQuestCooltimeEntity_o *)DataMasterBase_object__object__object___getEntityFromKey(
                                         ...
                                         v38,
                                         (const MethodInfo_34ED544 *)Method_DataMasterBase_EventQuestCooltimeMaster__EventQuestCooltimeEntity__string__getEntityFromKey__);
}
