        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EBBB & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMasterData_EventQuestCooltimeMaster___, method);
    sub_1B761C0(&Method_DataMasterBase_getEntityFromKey_EventQuestCooltimeEntity___, v3);
  ...
  *(_QWORD *)(v7 + 32) = Instance;
  sub_1B76164((ServantStatusBattleListViewItem_o *)(v7 + 32), (int32_t)Instance, v10, v11);
  if ( *(_DWORD *)(v7 + 24) <= 1u )
    goto LABEL_12;
  v14 = StringLiteral_1544/*":"*/;
  *(_QWORD *)(v7 + 40) = StringLiteral_1544/*":"*/;
  sub_1B76164((ServantStatusBattleListViewItem_o *)(v7 + 40), v14, v12, v13);
  Instance = (DataManager_o *)System_Int32__ToString(v2 + 28, 0LL);
  if ( *(_DWORD *)(v7 + 24) <= 2u
    || (*(_QWORD *)(v7 + 48) = Instance,
        sub_1B76164((ServantStatusBattleListViewItem_o *)(v7 + 48), (int32_t)Instance, v15, v16),
        *(_DWORD *)(v7 + 24) <= 3u)
    || (v19 = StringLiteral_1544/*":"*/,
        *(_QWORD *)(v7 + 56) = StringLiteral_1544/*":"*/,
        sub_1B76164((ServantStatusBattleListViewItem_o *)(v7 + 56), v19, v17, v18),
...
LABEL_12:
  ...
  *(_QWORD *)(v7 + 64) = Instance;
  sub_1B76164((ServantStatusBattleListViewItem_o *)(v7 + 64), (int32_t)Instance, v20, v21);
  v22 = System_String__Concat_61548588((System_String_array *)v7, 0LL);
  ...
  if ( !Instance
    || (Instance = (DataManager_o *)DataManager__GetMasterData_object_(
                                      Instance,
                                      (const MethodInfo_2E62408 *)Method_DataManager_GetMasterData_EventQuestCooltimeMaster___)) == 0LL )
  {
LABEL_13:
  ...
  return (EventQuestCooltimeEntity_o *)DataMasterBase__getEntityFromKey_object_(
                                         ...
                                         v22,
                                         (const MethodInfo_2E62B80 *)Method_DataMasterBase_getEntityFromKey_EventQuestCooltimeEntity___);
}
