        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E784FC & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_DataMasterBase_EventQuestCooltimeMaster__EventQuestCooltimeEntity__string__getEntityFromKey__);
  ...
  *(_QWORD *)(v3 + 32) = Instance;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)(v3 + 32), (int32_t)Instance, v6, v7, v8, v9, v10, v11);
  if ( *(_DWORD *)(v3 + 24) <= 1u )
    goto LABEL_12;
  v18 = StringLiteral_1453/*":"*/;
  *(_QWORD *)(v3 + 40) = StringLiteral_1453/*":"*/;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)(v3 + 40), v18, v12, v13, v14, v15, v16, v17);
  Instance = (DataManager_o *)System_Int32__ToString(v2 + 28, 0);
  if ( *(_DWORD *)(v3 + 24) <= 2u
    || (*(_QWORD *)(v3 + 48) = Instance,
        sub_1D0F058((GrandQuestFolderBoardItem_o *)(v3 + 48), (int32_t)Instance, v19, v20, v21, v22, v23, v24),
        *(_DWORD *)(v3 + 24) <= 3u)
    || (v31 = StringLiteral_1453/*":"*/,
        *(_QWORD *)(v3 + 56) = StringLiteral_1453/*":"*/,
        sub_1D0F058((GrandQuestFolderBoardItem_o *)(v3 + 56), v31, v25, v26, v27, v28, v29, v30),
...
LABEL_12:
  ...
  *(_QWORD *)(v3 + 64) = Instance;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)(v3 + 64), (int32_t)Instance, v32, v33, v34, v35, v36, v37);
  v38 = System_String__Concat_65603304((System_String_array *)v3, 0);
  ...
  if ( !Instance
    || (Instance = (DataManager_o *)DataManager__GetMasterData_object_(
                                      Instance,
                                      (const MethodInfo_324F1B8 *)Method_DataManager_GetMasterData_EventQuestCooltimeMaster___)) == 0 )
  {
LABEL_13:
  ...
  return (EventQuestCooltimeEntity_o *)DataMasterBase_object__object__object___getEntityFromKey(
                                         ...
                                         v38,
                                         (const MethodInfo_3539E64 *)Method_DataMasterBase_EventQuestCooltimeMaster__EventQuestCooltimeEntity__string__getEntityFromKey__);
}
