        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1E016 & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_19560/*"gachaId"*/, *(_QWORD *)&gachaId);
    byte_4B1E016 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19560/*"gachaId"*/, gachaId, v3);
...
System_String_o *__fastcall GachaHistoryRequest__getURL(GachaHistoryRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BCAFF8(&NetworkManager_TypeInfo, method);
    sub_1BCAFF8(&StringLiteral_19559/*"gacha/drawHistory"*/, v2);
    byte_4B1E014 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62450424(BaseUrl, (System_String_o *)StringLiteral_19559/*"gacha/drawHistory"*/, 0LL);
}
