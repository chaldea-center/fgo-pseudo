        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFF134 & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_20048/*"gachaId"*/, *(_QWORD *)&gachaId);
    byte_4BFF134 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_20048/*"gachaId"*/, gachaId, v3);
...
System_String_o *__fastcall GachaHistoryRequest__getURL(GachaHistoryRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C2E12C(&NetworkManager_TypeInfo, method);
    sub_1C2E12C(&StringLiteral_20047/*"gacha/drawHistory"*/, v2);
    byte_4BFF132 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63235584(BaseUrl, (System_String_o *)StringLiteral_20047/*"gacha/drawHistory"*/, 0LL);
}
