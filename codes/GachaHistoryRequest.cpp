        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B38ADC & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_19926/*"gachaId"*/, *(_QWORD *)&gachaId);
    byte_4B38ADC = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19926/*"gachaId"*/, gachaId, v3);
...
System_String_o *__fastcall GachaHistoryRequest__getURL(GachaHistoryRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BD3458(&NetworkManager_TypeInfo, method);
    sub_1BD3458(&StringLiteral_19925/*"gacha/drawHistory"*/, v2);
    byte_4B38ADA = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62525248(BaseUrl, (System_String_o *)StringLiteral_19925/*"gacha/drawHistory"*/, 0LL);
}
