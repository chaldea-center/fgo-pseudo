        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17B0D & 1) == 0 )
  {
    sub_1BCA7E0(&StringLiteral_19896/*"gachaId"*/, *(_QWORD *)&gachaId, method);
    byte_4B17B0D = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19896/*"gachaId"*/, gachaId, v3);
...
System_String_o *__fastcall GachaHistoryRequest__getURL(GachaHistoryRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BCA7E0(&NetworkManager_TypeInfo, method, v2);
    sub_1BCA7E0(&StringLiteral_19895/*"gacha/drawHistory"*/, v3, v4);
    byte_4B17B0B = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62401220(BaseUrl, (System_String_o *)StringLiteral_19895/*"gacha/drawHistory"*/, 0LL);
}
