        ...
        const MethodInfo *method)
{
  if ( (byte_40FB383 & 1) == 0 )
  {
    sub_B16FFC(&StringLiteral_18876/*"gachaId"*/, *(_QWORD *)&gachaId);
    byte_40FB383 = 1;
  }
...
System_String_o *__fastcall GachaHistoryRequest__getURL(GachaHistoryRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_B16FFC(&NetworkManager_TypeInfo, method);
    sub_B16FFC(&StringLiteral_18875/*"gacha/drawHistory"*/, v2);
    byte_40FB381 = 1;
  }
  if ( (BYTE3(NetworkManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !NetworkManager_TypeInfo->_2.cctor_finished )
  ...
  return System_String__Concat_43743732(BaseUrl, (System_String_o *)StringLiteral_18875/*"gacha/drawHistory"*/, 0LL);
}
