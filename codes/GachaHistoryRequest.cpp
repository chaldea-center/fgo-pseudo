        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B03B0B & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_19548/*"gachaId"*/, *(_QWORD *)&gachaId);
    byte_4B03B0B = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19548/*"gachaId"*/, gachaId, v3);
...
System_String_o *__fastcall GachaHistoryRequest__getURL(GachaHistoryRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BC3008(&NetworkManager_TypeInfo, method);
    sub_1BC3008(&StringLiteral_19547/*"gacha/drawHistory"*/, v2);
    byte_4B03B09 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62348648(BaseUrl, (System_String_o *)StringLiteral_19547/*"gacha/drawHistory"*/, 0LL);
}
