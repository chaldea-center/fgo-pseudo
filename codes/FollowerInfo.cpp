        ...
        const MethodInfo *method)
{
  ...
  if ( *(_DWORD *)(v7 + 24) <= (unsigned int)index )
    sub_1B90274(this, skillInfoList);
  this = *(FollowerInfo_o **)(v7 + 8LL * index + 32);
  if ( !this )
LABEL_7:
    sub_1B9026C(this, skillInfoList);
  ServantLeaderInfo__GetAppendPassiveSkillInfo_40560856((ServantLeaderInfo_o *)this, skillInfoList, isNpc, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FA55 & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMasterData_NpcServantFollowerIndividualityMaster___, *(_QWORD *)&index);
    sub_1B90010(&Method_DataManager_GetMasterData_ServantIndividualityMaster___, v7);
    sub_1B90010(&Method_DataManager_GetMasterData_ServantLimitAddMaster___, v8);
    sub_1B90010(&Method_DataManager_GetMaster_NpcServantFollowerMaster___, v9);
  ...
  v18 = DataManager__GetMasterData_object_(
          Instance,
          (const MethodInfo_2E8E21C *)Method_DataManager_GetMasterData_ServantIndividualityMaster___);
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  DataManager__GetMaster_object_((const MethodInfo_2E8E1C8 *)Method_DataManager_GetMaster_NpcServantFollowerMaster___);
  Instance = (DataManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_374C890 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_19;
  ...
  *(_QWORD *)&v39.fields.fakeValue = masterDataBytes;
  Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46506376(v39, 0LL);
  ...
  LimitAddIndividuality = ServantLimitAddMaster__GetLimitAddIndividuality(
                            ...
                            0LL);
  Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46506376(v21[3], 0LL);
  if ( !v18 )
    goto LABEL_19;
  Individuality = ServantIndividualityMaster__GetIndividuality(
                    ...
                    v21[4].fields.currentCryptoKey,
                    0LL);
  v26 = (FollowerInfo_o *)sub_1B900B8(int___TypeInfo, 0LL);
...
int32_t __fastcall FollowerInfo__GetReturnTypeByQuestId(int32_t questId, const MethodInfo *method)
{
  ...
  if ( (byte_4A6FA51 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_DataMasterBase_QuestMaster__QuestEntity__int__GetEntity__, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FA54 & 1) == 0 )
  {
    sub_1B90010(&Method_System_Linq_Enumerable_ToArray_int___, targetIndividualities);
    sub_1B90010(&Method_System_Linq_Enumerable_Union_int___, v6);
    byte_4A6FA54 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( *(_DWORD *)(v6 + 24) <= (unsigned int)index )
    sub_1B90274(this, questRestrictionInfo);
  this = *(FollowerInfo_o **)(v6 + 8LL * index + 32);
  if ( !this )
LABEL_7:
    sub_1B9026C(this, questRestrictionInfo);
...
bool __fastcall FollowerInfo__IsUniqueIndividualityRestriction_38973452(
        FollowerInfo_o *this,
        QuestRestrictionInfo_o *questRestrictionInfo,
        int32_t index,
...
LABEL_7:
    sub_1B9026C(this, questRestrictionInfo);
  return ServantLeaderInfo__IsUniqueIndividualityRestriction_40550800(
...
LABEL_9:
    sub_1B90274(this, equipTargetInfo);
  this = (FollowerInfo_o *)eventUserSvtLeaderHash->m_Items[0];
  if ( !this )
    goto LABEL_8;
  this[1].monitor = equipTargetInfo;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this[1].monitor, (int32_t)equipTargetInfo, v7, v8);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !v6 )
    goto LABEL_7;
  if ( *(_DWORD *)(v6 + 24) <= (unsigned int)index )
    sub_1B90274(this, setupInfo);
  this = *(FollowerInfo_o **)(v6 + 8LL * index + 32);
  if ( !this )
LABEL_7:
    sub_1B9026C(this, setupInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FA58 & 1) == 0 )
  {
    this = (FollowerInfo_o *)sub_1B90010(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, *(_QWORD *)&index);
    byte_4A6FA58 = 1;
  }
  if ( (index & 0x80000000) != 0 )
    return 0;
  ...
  *(_QWORD *)&v15.fields.fakeValue = v12;
  return CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46506376(v15, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FA57 & 1) == 0 )
  {
    this = (FollowerInfo_o *)sub_1B90010(&CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo, *(_QWORD *)&index);
    byte_4A6FA57 = 1;
  }
  if ( (index & 0x80000000) != 0 )
    return 0LL;
  ...
  *(_OWORD *)&v15.fields.fakeValue = v12;
  ...
  v14 = v15;
  return CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_46509900(&v14, 0LL);
}
...
bool __fastcall FollowerInfo__getEventUpVal_38972940(
        FollowerInfo_o *this,
...
LABEL_7:
  ...
  return ServantLeaderInfo__getEventUpVal_40548676((ServantLeaderInfo_o *)this, eventUpVallInfo, setupInfo, 0LL);
}


bool __fastcall FollowerInfo__getEventUpVal_38973012(
        FollowerInfo_o *this,
        EventUpValInfo_o **eventUpVallInfo,
...
LABEL_7:
    sub_1B9026C(this, eventUpVallInfo);
  return ServantLeaderInfo__getEventUpVal_40549664(
           (ServantLeaderInfo_o *)this,
           eventUpVallInfo,
           isServantEventUpVal,
           isEquipEventUpVal,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FA52 & 1) == 0 )
  {
    sub_1B90010(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, *(_QWORD *)&classId);
    byte_4A6FA52 = 1;
  }
  v9 = 48LL;
  if ( !returnSupportServantType )
        ...
        const MethodInfo *method)
{
  ...
  if ( *(_DWORD *)(v13 + 24) <= (unsigned int)index )
    sub_1B90274(IsNpc, v10);
  IsNpc = *(ServantLeaderInfo_o **)(v13 + 8LL * index + 32);
  if ( !IsNpc )
LABEL_9:
    sub_1B9026C(IsNpc, v10);
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v14.fields.fakeValue = v11;
  return CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46506376(v14, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !v6 )
    goto LABEL_7;
  if ( *(_DWORD *)(v6 + 24) <= (unsigned int)index )
    sub_1B90274(this, tdInfo);
  this = *(FollowerInfo_o **)(v6 + 8LL * index + 32);
  if ( !this )
LABEL_7:
    sub_1B9026C(this, tdInfo);
  return ServantLeaderInfo__getTreasureDeviceInfo((ServantLeaderInfo_o *)this, tdInfo, 0LL);
}


bool __fastcall FollowerInfo__getTreasureDeviceInfo_38973604(
        FollowerInfo_o *this,
        int32_t *tdLv,
        int32_t *tdMaxLv,
        int32_t index,
        ...
        const MethodInfo *method)
{
  ...
  if ( !v7 )
    goto LABEL_7;
  if ( *(_DWORD *)(v7 + 24) <= (unsigned int)index )
    sub_1B90274(this, tdLv);
  this = *(FollowerInfo_o **)(v7 + 8LL * index + 32);
  if ( !this )
LABEL_7:
    sub_1B9026C(this, tdLv);
  return ServantLeaderInfo__getTreasureDeviceInfo_40551496((ServantLeaderInfo_o *)this, tdLv, tdMaxLv, 0LL);
}
...
bool __fastcall FollowerInfo__getUniqueSvtRestriction_38973300(
        FollowerInfo_o *this,
        QuestRestrictionInfo_o *questRestrictionInfo,
        int32_t index,
        PartyListViewItem_o *partyItem,
...
LABEL_7:
    sub_1B9026C(this, questRestrictionInfo);
  return ServantLeaderInfo__getUniqueSvtRestriction_40550468(
           (ServantLeaderInfo_o *)this,
           questRestrictionInfo,
           partyItem,
           num,
