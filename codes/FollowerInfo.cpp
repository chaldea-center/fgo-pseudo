...
LABEL_7:
  ...
  ServantLeaderInfo__GetAppendPassiveSkillInfo_41790300((ServantLeaderInfo_o *)this, skillInfoList, isNpc, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDC11B & 1) == 0 )
  {
    sub_1C21E38(&Method_DataManager_GetMasterData_NpcServantFollowerIndividualityMaster___);
    sub_1C21E38(&Method_DataManager_GetMasterData_ServantIndividualityMaster___);
  ...
  v10 = DataManager__GetMasterData_object_(
          Instance,
          (const MethodInfo_2FAFE04 *)Method_DataManager_GetMasterData_ServantIndividualityMaster___);
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  DataManager__GetMaster_object_((const MethodInfo_2FAFDB0 *)Method_DataManager_GetMaster_NpcServantFollowerMaster___);
  Instance = (DataManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_388D058 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_21;
  v11 = DataManager__GetMasterData_object_(
          Instance,
          (const MethodInfo_2FAFE04 *)Method_DataManager_GetMasterData_NpcServantFollowerIndividualityMaster___);
  ...
  *(_QWORD *)&v35.fields.fakeValue = masterDataBytes;
  v16 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47621364(v35, 0LL);
  currentCryptoKey = v13[4].fields.currentCryptoKey;
  hiddenValue = v13[10].fields.hiddenValue;
  v19 = v16;
  ...
  LimitAddIndividuality = ServantLimitAddMaster__GetLimitAddIndividuality(
                            ...
                            (int32_t)Instance,
                            0LL);
  Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47621364(v13[3], 0LL);
  if ( !v10 )
    goto LABEL_21;
  Individuality = ServantIndividualityMaster__GetIndividuality(
                    ...
                    0LL);
  v22 = (FollowerInfo_o *)sub_1C21EE0(int___TypeInfo, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2FAFDB0 *)Method_DataManager_GetMaster_NpcServantFollowerIndividualityMaster___);
  if ( !Master_object )
    goto LABEL_27;
  if ( DataMasterBase_object__object__long___TryGetEntity(
...
LABEL_27:
  ...
  *(_QWORD *)&v22.fields.fakeValue = v14;
  Master_object = (Il2CppObject *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47621364(v22, 0LL);
  if ( !v13 )
    goto LABEL_27;
  ...
  if ( !v19 )
    goto LABEL_27;
  return ServantEntity__getIndividuality(v19, limitCount, (int32_t)Master_object, 0LL);
}
...
// local variable allocation has failed, the output may be wrong!
bool __fastcall FollowerInfo__GetQuestRestriction_40179908(
        FollowerInfo_o *this,
        QuestRestrictionInfo_o *questRestrictionInfo,
        int32_t index,
        int32_t returnSupportServantType,
...
LABEL_12:
    ...
    *(_QWORD *)&v26.fields.fakeValue = v20;
    v22 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47621364(v26, 0LL);
    limitCount = ServantLeaderInfo->fields.limitCount;
    v24 = v22;
    DispLimitCount = ServantLeaderInfo__getDispLimitCount(ServantLeaderInfo, 0LL);
    return QuestRestrictionInfo__IsRestriction_41718260(
             questRestrictionInfo,
             isWhole,
             v24,
             limitCount,
        ...
        const MethodInfo *method)
{
  ...
  if ( *(_DWORD *)(v6 + 24) <= (unsigned int)index )
    sub_1C2209C(this, questRestrictionInfo);
  this = *(FollowerInfo_o **)(v6 + 8LL * index + 32);
  if ( !this )
LABEL_7:
    sub_1C22094(this, questRestrictionInfo);
...
bool __fastcall FollowerInfo__IsUniqueIndividualityRestriction_40180504(
        FollowerInfo_o *this,
        QuestRestrictionInfo_o *questRestrictionInfo,
        int32_t index,
...
LABEL_7:
    sub_1C22094(this, questRestrictionInfo);
  return ServantLeaderInfo__IsUniqueIndividualityRestriction_41780124(
...
LABEL_9:
    sub_1C2209C(this, equipTargetInfo);
  this = (FollowerInfo_o *)eventUserSvtLeaderHash->m_Items[0];
  if ( !this )
    goto LABEL_8;
  this[1].monitor = equipTargetInfo;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this[1].monitor, (int64_t)equipTargetInfo, v11, v12, v13, v14, v15, v16);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDC11F & 1) == 0 )
  {
    this = (FollowerInfo_o *)sub_1C21E38(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    byte_4BDC11F = 1;
  }
  if ( (index & 0x80000000) != 0 )
    return 0;
  ...
  *(_QWORD *)&v15.fields.fakeValue = v12;
  return CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47621364(v15, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDC11E & 1) == 0 )
  {
    this = (FollowerInfo_o *)sub_1C21E38(&CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
    byte_4BDC11E = 1;
  }
  if ( (index & 0x80000000) != 0 )
    return 0LL;
  ...
  *(_OWORD *)&v15.fields.fakeValue = v12;
  ...
  v14 = v15;
  return CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_47624888(&v14, 0LL);
}
...
bool __fastcall FollowerInfo__getEventUpVal_40179560(
        FollowerInfo_o *this,
...
LABEL_7:
  ...
  return ServantLeaderInfo__getEventUpVal_41778036((ServantLeaderInfo_o *)this, eventUpVallInfo, setupInfo, 0LL);
}


bool __fastcall FollowerInfo__getEventUpVal_40179632(
        FollowerInfo_o *this,
        EventUpValInfo_o **eventUpVallInfo,
...
LABEL_7:
    sub_1C22094(this, eventUpVallInfo);
  return ServantLeaderInfo__getEventUpVal_41779024(
           (ServantLeaderInfo_o *)this,
           eventUpVallInfo,
           isServantEventUpVal,
           isEquipEventUpVal,
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v14.fields.fakeValue = v11;
  return CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47621364(v14, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !v6 )
    goto LABEL_7;
  if ( *(_DWORD *)(v6 + 24) <= (unsigned int)index )
    sub_1C2209C(this, tdInfo);
  this = *(FollowerInfo_o **)(v6 + 8LL * index + 32);
  if ( !this )
LABEL_7:
    sub_1C22094(this, tdInfo);
  return ServantLeaderInfo__getTreasureDeviceInfo((ServantLeaderInfo_o *)this, tdInfo, 0LL);
}


bool __fastcall FollowerInfo__getTreasureDeviceInfo_40180664(
        FollowerInfo_o *this,
        int32_t *tdLv,
        int32_t *tdMaxLv,
        int32_t index,
        ...
        const MethodInfo *method)
{
  ...
  if ( !v7 )
    goto LABEL_7;
  if ( *(_DWORD *)(v7 + 24) <= (unsigned int)index )
    sub_1C2209C(this, tdLv);
  this = *(FollowerInfo_o **)(v7 + 8LL * index + 32);
  if ( !this )
LABEL_7:
    sub_1C22094(this, tdLv);
  return ServantLeaderInfo__getTreasureDeviceInfo_41780952((ServantLeaderInfo_o *)this, tdLv, tdMaxLv, 0LL);
}
...
bool __fastcall FollowerInfo__getUniqueSvtRestriction_40180344(
        FollowerInfo_o *this,
        QuestRestrictionInfo_o *questRestrictionInfo,
        int32_t index,
        PartyListViewItem_o *partyItem,
...
LABEL_7:
    sub_1C22094(this, questRestrictionInfo);
  return ServantLeaderInfo__getUniqueSvtRestriction_41779776(
           (ServantLeaderInfo_o *)this,
           questRestrictionInfo,
           partyItem,
           num,
