        ...
        const MethodInfo *method)
{
  ...
  if ( *(_DWORD *)(v7 + 24) <= (unsigned int)index )
    sub_1B76424(this, skillInfoList);
  this = *(FollowerInfo_o **)(v7 + 8LL * index + 32);
  if ( !this )
LABEL_7:
    sub_1B7641C(this, skillInfoList);
  ServantLeaderInfo__GetAppendPassiveSkillInfo_40321236((ServantLeaderInfo_o *)this, skillInfoList, isNpc, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2DB2C & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMasterData_NpcServantFollowerIndividualityMaster___, *(_QWORD *)&index);
    sub_1B761C0(&Method_DataManager_GetMasterData_ServantIndividualityMaster___, v7);
    sub_1B761C0(&Method_DataManager_GetMasterData_ServantLimitAddMaster___, v8);
    sub_1B761C0(&Method_DataManager_GetMaster_NpcServantFollowerMaster___, v9);
  ...
  v18 = DataManager__GetMasterData_object_(
          Instance,
          (const MethodInfo_2E62408 *)Method_DataManager_GetMasterData_ServantIndividualityMaster___);
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  DataManager__GetMaster_object_((const MethodInfo_2E623B4 *)Method_DataManager_GetMaster_NpcServantFollowerMaster___);
  Instance = (DataManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_371257C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_19;
  ...
  *(_QWORD *)&v39.fields.fakeValue = masterDataBytes;
  Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(v39, 0LL);
  ...
  LimitAddIndividuality = ServantLimitAddMaster__GetLimitAddIndividuality(
                            ...
                            0LL);
  Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(v21[3], 0LL);
  if ( !v18 )
    goto LABEL_19;
  Individuality = ServantIndividualityMaster__GetIndividuality(
                    ...
                    v21[4].fields.currentCryptoKey,
                    0LL);
  v26 = (FollowerInfo_o *)sub_1B76268(int___TypeInfo, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2DB2B & 1) == 0 )
  {
    sub_1B761C0(&Method_System_Linq_Enumerable_ToArray_int___, targetIndividualities);
    sub_1B761C0(&Method_System_Linq_Enumerable_Union_int___, v6);
    byte_4A2DB2B = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( *(_DWORD *)(v6 + 24) <= (unsigned int)index )
    sub_1B76424(this, questRestrictionInfo);
  this = *(FollowerInfo_o **)(v6 + 8LL * index + 32);
  if ( !this )
LABEL_7:
    sub_1B7641C(this, questRestrictionInfo);
...
bool __fastcall FollowerInfo__IsUniqueIndividualityRestriction_38739724(
        FollowerInfo_o *this,
        QuestRestrictionInfo_o *questRestrictionInfo,
        int32_t index,
...
LABEL_7:
    sub_1B7641C(this, questRestrictionInfo);
  return ServantLeaderInfo__IsUniqueIndividualityRestriction_40311388(
...
LABEL_9:
    sub_1B76424(this, equipTargetInfo);
  this = (FollowerInfo_o *)eventUserSvtLeaderHash->m_Items[0];
  if ( !this )
    goto LABEL_8;
  this[1].monitor = equipTargetInfo;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this[1].monitor, (int32_t)equipTargetInfo, v7, v8);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !v6 )
    goto LABEL_7;
  if ( *(_DWORD *)(v6 + 24) <= (unsigned int)index )
    sub_1B76424(this, setupInfo);
  this = *(FollowerInfo_o **)(v6 + 8LL * index + 32);
  if ( !this )
LABEL_7:
    sub_1B7641C(this, setupInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2DB2F & 1) == 0 )
  {
    this = (FollowerInfo_o *)sub_1B761C0(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, *(_QWORD *)&index);
    byte_4A2DB2F = 1;
  }
  if ( (index & 0x80000000) != 0 )
    return 0;
  ...
  *(_QWORD *)&v15.fields.fakeValue = v12;
  return CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(v15, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2DB2E & 1) == 0 )
  {
    this = (FollowerInfo_o *)sub_1B761C0(&CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo, *(_QWORD *)&index);
    byte_4A2DB2E = 1;
  }
  if ( (index & 0x80000000) != 0 )
    return 0LL;
  ...
  *(_OWORD *)&v15.fields.fakeValue = v12;
  ...
  v14 = v15;
  return CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_46340496(&v14, 0LL);
}
...
bool __fastcall FollowerInfo__getEventUpVal_38739212(
        FollowerInfo_o *this,
...
LABEL_7:
  ...
  return ServantLeaderInfo__getEventUpVal_40309264((ServantLeaderInfo_o *)this, eventUpVallInfo, setupInfo, 0LL);
}


bool __fastcall FollowerInfo__getEventUpVal_38739284(
        FollowerInfo_o *this,
        EventUpValInfo_o **eventUpVallInfo,
...
LABEL_7:
    sub_1B7641C(this, eventUpVallInfo);
  return ServantLeaderInfo__getEventUpVal_40310252(
           (ServantLeaderInfo_o *)this,
           eventUpVallInfo,
           isServantEventUpVal,
           isEquipEventUpVal,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2DB29 & 1) == 0 )
  {
    sub_1B761C0(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, *(_QWORD *)&classId);
    byte_4A2DB29 = 1;
  }
  v9 = 48LL;
  if ( !returnSupportServantType )
...
LABEL_17:
  ...
  *(_QWORD *)&v19.fields.fakeValue = v17;
  if ( CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(v19, 0LL) < 1 )
    return -1;
  else
    return v15;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( *(_DWORD *)(v13 + 24) <= (unsigned int)index )
    sub_1B76424(IsNpc, v10);
  IsNpc = *(ServantLeaderInfo_o **)(v13 + 8LL * index + 32);
  if ( !IsNpc )
LABEL_9:
    sub_1B7641C(IsNpc, v10);
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v14.fields.fakeValue = v11;
  return CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(v14, 0LL);
}
...
bool __fastcall FollowerInfo__getTreasureDeviceInfo_38739876(
        FollowerInfo_o *this,
        int32_t *tdLv,
        int32_t *tdMaxLv,
        int32_t index,
...
bool __fastcall FollowerInfo__getUniqueSvtRestriction_38739572(
        FollowerInfo_o *this,
        QuestRestrictionInfo_o *questRestrictionInfo,
        int32_t index,
        PartyListViewItem_o *partyItem,
...
LABEL_7:
    sub_1B7641C(this, questRestrictionInfo);
  return ServantLeaderInfo__getUniqueSvtRestriction_40311056(
           (ServantLeaderInfo_o *)this,
           questRestrictionInfo,
           partyItem,
           num,
