        ...
        const MethodInfo *method)
{
  ...
  if ( LODWORD(ServantLeaderInfoByReturnType->max_length) <= index )
    sub_1C71610(ServantLeaderInfoByReturnType);
  ServantLeaderInfoByReturnType = (ServantLeaderInfo_array *)ServantLeaderInfoByReturnType->m_Items[index];
  if ( !ServantLeaderInfoByReturnType )
LABEL_5:
    sub_1C71608(ServantLeaderInfoByReturnType, v10);
  ServantLeaderInfo__GetAppendPassiveSkillInfo_43794080(
        ...
        const MethodInfo *method)
{
  ...
  if ( !ServantLeaderInfoByReturnType )
LABEL_5:
    sub_1C71608(ServantLeaderInfoByReturnType, v6);
        ...
        for ( i = 0; v16 != i; ++i )
        {
          ...
          if ( IsNullOrEmpty )
          {
            ...
            *(_QWORD *)&v29.fields.fakeValue = v18;
            IsNullOrEmpty = (ServantLeaderInfo_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49297952(
                                                     v29,
                                                     0);
            if ( !v7 )
              goto LABEL_31;
...
LABEL_28:
              System_Collections_Generic_List_int___AddWithResize(
                v27,
                v11,
                *(const MethodInfo_37F36F4 **)(*(_QWORD *)(v26 + 192) + 112LL));
              continue;
            }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC6F5A & 1) == 0 )
  {
    sub_1C713B0(&Method_BasicHelper_IndexValue_ServantLeaderInfo___);
  ...
  v8 = BasicHelper__IndexValue_object_(
         ...
         index,
         0,
         (const MethodInfo_31393D4 *)Method_BasicHelper_IndexValue_ServantLeaderInfo___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC6F57 & 1) == 0 )
  {
    sub_1C713B0(&Method_DataManager_GetMasterData_NpcServantFollowerIndividualityMaster___);
    sub_1C713B0(&Method_DataManager_GetMasterData_ServantIndividualityMaster___);
  ...
  v10 = DataManager__GetMasterData_object_(
          Instance,
          (const MethodInfo_314B10C *)Method_DataManager_GetMasterData_ServantIndividualityMaster___);
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  DataManager__GetMaster_object_((const MethodInfo_314B0B8 *)Method_DataManager_GetMaster_NpcServantFollowerMaster___);
  Instance = (DataManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A5F158 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_21;
  v11 = DataManager__GetMasterData_object_(
          Instance,
          (const MethodInfo_314B10C *)Method_DataManager_GetMasterData_NpcServantFollowerIndividualityMaster___);
  ...
  *(_QWORD *)&v35.fields.fakeValue = masterDataBytes;
  v16 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49297952(v35, 0);
  ...
  LimitAddIndividuality = ServantLimitAddMaster__GetLimitAddIndividuality(
                            ...
                            (int32_t)Instance,
                            0);
  Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49297952(v13[3], 0);
  if ( !v10 )
    goto LABEL_21;
  Individuality = ServantIndividualityMaster__GetIndividuality(
                    ...
                    0);
  v22 = (FollowerInfo_o *)sub_1C71458(int___TypeInfo, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_314B0B8 *)Method_DataManager_GetMaster_NpcServantFollowerIndividualityMaster___);
  if ( !Master_object )
    goto LABEL_27;
  if ( DataMasterBase_object__object__long___TryGetEntity(
...
LABEL_27:
  ...
  *(_QWORD *)&v22.fields.fakeValue = v14;
  Master_object = (Il2CppObject *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49297952(v22, 0);
  if ( !v13 )
    goto LABEL_27;
...
LABEL_10:
  ...
  if ( !IsNpc )
    goto LABEL_10;
  return QuestRestrictionInfo__IsRestriction_43713080(
...
// local variable allocation has failed, the output may be wrong!
bool FollowerInfo__GetQuestRestriction_42027604(
        FollowerInfo_o *this,
        QuestRestrictionInfo_o *questRestrictionInfo,
        int32_t index,
        int32_t returnSupportServantType,
...
LABEL_14:
    ...
    *(_QWORD *)&v25.fields.fakeValue = v19;
    ...
    if ( !IsNpc )
      goto LABEL_14;
    return QuestRestrictionInfo__IsRestriction_43714052(
             questRestrictionInfo,
             isWhole,
             v23,
             limitCount,
        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    {
      v5 = sub_1C713C4(&System_ArgumentOutOfRangeException_TypeInfo);
      v6 = (System_ArgumentOutOfRangeException_o *)sub_1C715FC(v5);
      v7 = (System_String_o *)sub_1C713C4(&StringLiteral_23207/*"returnSupportServantType"*/);
      v8 = (System_String_o *)sub_1C713C4(&StringLiteral_25585/*"予期されないReturnSupportServantTypeです。"*/);
      System_ArgumentOutOfRangeException___ctor_65056564(v6, v7, v8, 0);
      v9 = sub_1C713C4(&Method_FollowerInfo_GetServantLeaderInfoByReturnType__);
      sub_1C714D8(v6, v9);
    }
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v18.fields.fakeValue = v15;
  Master_object = (Il2CppObject *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49297952(v18, 0);
  if ( !v14
    || (Entity = DataMasterBase_object__object__int___GetEntity(
                   v14,
                   (int32_t)Master_object,
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v19.fields.fakeValue = v15;
  Master_object = (Il2CppObject *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49297952(v19, 0);
  if ( !v14
    || (Entity = DataMasterBase_object__object__int___GetEntity(
                   v14,
                   (int32_t)Master_object,
    ...
    || (v18 = DataMasterBase_object__object__int___GetEntity(
        ...
        (Master_object = SingletonTemplate_object___get_Instance((const MethodInfo_3A5F648 *)Method_SingletonTemplate_PartyOrganizationUtility__get_Instance__)) == 0)
    || !v18 )
  {
LABEL_17:
    sub_1C71608(Master_object, v13);
  ...
  return QuestRestrictionInfo__IsMySvtOrSupportSlotClassRestriction(
           questRestrictionInfo,
           HIDWORD(Master_object[3].monitor),
           (int32_t)v18[2].klass,
           0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !ServantLeaderInfoByReturnType )
LABEL_5:
    sub_1C71608(ServantLeaderInfoByReturnType, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( !ServantLeaderInfoByReturnType )
LABEL_5:
    sub_1C71608(ServantLeaderInfoByReturnType, v9);
...
// local variable allocation has failed, the output may be wrong!
bool FollowerInfo__IsUniqueIndividualityRestriction_42028272(
        FollowerInfo_o *this,
        QuestRestrictionInfo_o *questRestrictionInfo,
        int32_t index,
        ...
        const MethodInfo *method)
{
  ...
  if ( !ServantLeaderInfoByReturnType )
LABEL_5:
    sub_1C71608(ServantLeaderInfoByReturnType, v13);
  return ServantLeaderInfo__IsUniqueIndividualityRestriction_43782876(
           (ServantLeaderInfo_o *)ServantLeaderInfoByReturnType,
           questRestrictionInfo,
           partyItem,
           num,
        ...
        const MethodInfo *method)
{
  ...
  if ( !this
    || (this->fields.followerClassStatistics = (struct ClassStatisticsInfo_array *)equipTargetInfo,
        sub_1C71354(
          (GrandQuestFolderBoardItem_o *)&this->fields.followerClassStatistics,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC6F5F & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_FollowerInfo___c__getEquipAtk_b__57_0__);
    sub_1C713B0(&FollowerInfo___c_TypeInfo);
    byte_4CC6F5F = 1;
  }
  ServantLeaderInfo = FollowerInfo__getServantLeaderInfo(this, index, returnSupportServantType, method);
  if ( ServantLeaderInfo )
  {
    ...
    if ( !_9__57_0 )
    {
      ...
      _9__57_0 = (System_Func_object__int__o *)sub_1C715FC(System_Func_EquipTargetInfo__int__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC6F5E & 1) == 0 )
  {
    sub_1C713B0(&Method_System_Linq_Enumerable_Sum_EquipTargetInfo___);
    sub_1C713B0(&System_Func_EquipTargetInfo__int__TypeInfo);
    sub_1C713B0(&Method_FollowerInfo___c__getEquipHp_b__56_0__);
    sub_1C713B0(&FollowerInfo___c_TypeInfo);
    byte_4CC6F5E = 1;
  }
  ServantLeaderInfo = FollowerInfo__getServantLeaderInfo(this, index, returnSupportServantType, method);
  if ( ServantLeaderInfo )
  {
    ...
    if ( !_9__56_0 )
    {
      ...
      v12 = (Il2CppObject *)v9->static_fields->__9;
      _9__56_0 = (System_Func_object__int__o *)sub_1C715FC(System_Func_EquipTargetInfo__int__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v14.fields.fakeValue = v11;
  return CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49297952(v14, 0);
}
...
bool FollowerInfo__getEventUpVal_42027192(
        FollowerInfo_o *this,
...
LABEL_5:
    sub_1C71608(ServantLeaderInfoByReturnType, v10);
  return ServantLeaderInfo__getEventUpVal_43780460(
           (ServantLeaderInfo_o *)ServantLeaderInfoByReturnType,
           eventUpVallInfo,
           setupInfo,
           0,
...
bool FollowerInfo__getEventUpVal_42027284(
        FollowerInfo_o *this,
        EventUpValInfo_o **eventUpVallInfo,
        ...
        const MethodInfo *method)
{
  ...
  if ( !ServantLeaderInfoByReturnType )
LABEL_5:
    sub_1C71608(ServantLeaderInfoByReturnType, v14);
  return ServantLeaderInfo__getEventUpVal_43781748(
           (ServantLeaderInfo_o *)ServantLeaderInfoByReturnType,
           eventUpVallInfo,
           isServantEventUpVal,
           isEquipEventUpVal,
...
LABEL_26:
      ...
      else if ( v18->fields.classId == classId )
      {
        ...
        *(_QWORD *)&v22.fields.fakeValue = v19;
        IsNpc = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49297952(v22, 0);
        if ( (int)IsNpc > 0 )
          return v16;
      }
LABEL_21:
...
bool FollowerInfo__getTreasureDeviceInfo_42029292(
        FollowerInfo_o *this,
        int32_t *tdLv,
        int32_t *tdMaxLv,
        int32_t index,
...
LABEL_5:
    sub_1C71608(ServantLeaderInfoByReturnType, v10);
  return ServantLeaderInfo__getTreasureDeviceInfo_43783704(
           (ServantLeaderInfo_o *)ServantLeaderInfoByReturnType,
           tdLv,
           tdMaxLv,
           0);
...
// local variable allocation has failed, the output may be wrong!
bool FollowerInfo__getUniqueSvtRestriction_42028080(
        FollowerInfo_o *this,
        QuestRestrictionInfo_o *questRestrictionInfo,
        int32_t index,
        PartyListViewItem_o *partyItem,
        ...
        const MethodInfo *method)
{
  ...
  if ( !ServantLeaderInfoByReturnType )
LABEL_5:
    sub_1C71608(ServantLeaderInfoByReturnType, v12);
  return ServantLeaderInfo__getUniqueSvtRestriction_43782528(
           (ServantLeaderInfo_o *)ServantLeaderInfoByReturnType,
           questRestrictionInfo,
           partyItem,
           num,
...
void FollowerInfo___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C715FC(FollowerInfo___c_TypeInfo);
