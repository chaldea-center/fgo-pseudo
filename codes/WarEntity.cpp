...
void WarEntity___ctor_43106576(WarEntity_o *this, WarEntity_o *cSrc, const MethodInfo *method)
{
  __int64 v5; // x0
  __int64 v6; // x1
  int32_t v7; // w2
  ...
  age = cSrc->fields.age;
  this->fields.age = age;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.age, (int32_t)age, v7, v8);
  name = cSrc->fields.name;
  this->fields.name = name;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.name, (int32_t)name, v11, v12);
  longName = cSrc->fields.longName;
  this->fields.longName = longName;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.longName, (int32_t)longName, v14, v15);
  *(_QWORD *)&this->fields.bannerId = *(_QWORD *)&cSrc->fields.bannerId;
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.emptyMessage, (int32_t)emptyMessage, v17, v18);
  ...
  *(_QWORD *)&this->fields.eventId = *(_QWORD *)&cSrc->fields.eventId;
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.coordinate, (int32_t)coordinate, v20, v21);
  coordinates = cSrc->fields.coordinates;
  this->fields.coordinates = coordinates;
  p_coordinates = &this->fields.coordinates;
  sub_1C2D434((CGThumbnailListItem_o *)p_coordinates, (int32_t)coordinates, v24, v25);
...
int32_t WarEntity__GetBaseMap(WarEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_30CE950 *)Method_DataManager_GetMasterData_WarAddMaster___)) == 0 )
  {
...
System_Single_array_array *WarEntity__GetPrioredCoordinates(WarEntity_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C2D490(&Method_DataManager_GetMasterData_WarAddMaster___);
    sub_1C2D490(&Method_JsonManager_DeserializeMultiArray_float___);
  ...
  return JsonManager__DeserializeMultiArray_float_(
           overwriteStr,
           (const MethodInfo_313DEEC *)Method_JsonManager_DeserializeMultiArray_float___);
}
...
bool WarEntity__IsPurchasedByRarePrism(WarEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2850B & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_WarEntity___c__DisplayClass53_0__IsPurchasedByRarePrism_b__0__);
    sub_1C2D490(&WarEntity___c__DisplayClass53_0_TypeInfo);
    byte_4C2850B = 1;
  }
  v3 = sub_1C2D6DC(WarEntity___c__DisplayClass53_0_TypeInfo);
  ...
  if ( WarEntity__HasFlag(this, 0x2000, v8) )
  {
    ...
    if ( Instance )
    {
      ...
      *(_QWORD *)(v3 + 24) = MasterData_object;
      sub_1C2D434((CGThumbnailListItem_o *)(v3 + 24), (int32_t)MasterData_object, v10, v11);
      ...
      if ( Instance )
      {
        ...
        v13 = (System_Func_object__bool__o *)sub_1C2D6DC(System_Func_MapControl_QuestInfo__bool__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2850E & 1) == 0 )
  {
    this = (WarEntity___c__DisplayClass53_0_o *)sub_1C2D490(&NetworkManager_TypeInfo);
    byte_4C2850E = 1;
  }
  if ( !quest )
    goto LABEL_17;
