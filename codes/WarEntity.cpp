...
void __fastcall WarEntity___ctor_40180844(WarEntity_o *this, WarEntity_o *cSrc, const MethodInfo *method)
{
  __int64 v5; // x0
  __int64 v6; // x1
  int32_t v7; // w2
  ...
  age = cSrc->fields.age;
  this->fields.age = age;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.age, (int32_t)age, v7, v8);
  name = cSrc->fields.name;
  this->fields.name = name;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.name, (int32_t)name, v11, v12);
  longName = cSrc->fields.longName;
  this->fields.longName = longName;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.longName, (int32_t)longName, v14, v15);
  *(_QWORD *)&this->fields.bannerId = *(_QWORD *)&cSrc->fields.bannerId;
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.emptyMessage, (int32_t)emptyMessage, v17, v18);
  ...
  *(_QWORD *)&this->fields.eventId = *(_QWORD *)&cSrc->fields.eventId;
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.coordinate, (int32_t)coordinate, v20, v21);
  coordinates = cSrc->fields.coordinates;
  this->fields.coordinates = coordinates;
  p_coordinates = &this->fields.coordinates;
  sub_1B76164((ServantStatusBattleListViewItem_o *)p_coordinates, (int32_t)coordinates, v24, v25);
...
int32_t __fastcall WarEntity__GetBaseMap(WarEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2EF99 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMasterData_WarAddMaster___, method);
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_2E62408 *)Method_DataManager_GetMasterData_WarAddMaster___)) == 0LL )
  {
...
System_String_o *__fastcall WarEntity__GetNoticeText(WarEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2EF9B & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMaster_WarAddMaster___, method);
  ...
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2E623B4 *)Method_DataManager_GetMaster_WarAddMaster___);
  if ( !Master_object )
    sub_1B7641C(0LL, v6);
  id = this->fields.id;
...
System_Single_array_array *__fastcall WarEntity__GetPrioredCoordinates(WarEntity_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B761C0(&Method_DataManager_GetMasterData_WarAddMaster___, method);
    sub_1B761C0(&Method_JsonManager_DeserializeMultiArray_float___, v3);
  ...
  return JsonManager__DeserializeMultiArray_float_(
           overwriteStr,
           (const MethodInfo_2EC8AE0 *)Method_JsonManager_DeserializeMultiArray_float___);
}
...
bool __fastcall WarEntity__HasFlag(WarEntity_o *this, int32_t flag, const MethodInfo *method)
{
  ...
  if ( (byte_4A2EF91 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMasterData_WarAddMaster___, *(_QWORD *)&flag);
    sub_1B761C0(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v5);
    byte_4A2EF91 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_371257C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
...
bool __fastcall WarEntity__IsContainPrioredEntity(WarEntity_o *this, int32_t type, const MethodInfo *method)
{
  ...
  if ( (byte_4A2EF9D & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMaster_WarAddMaster___, *(_QWORD *)&type);
...
bool __fastcall WarEntity__IsPurchasedByRarePrism(WarEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2EF9C & 1) == 0 )
  {
    sub_1B761C0(&Method_BasicHelper_Any_MapControl_QuestInfo___, method);
    sub_1B761C0(&Method_DataManager_GetMasterData_UserQuestMaster___, v3);
    sub_1B761C0(&System_Func_MapControl_QuestInfo__bool__TypeInfo, v4);
    sub_1B761C0(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v5);
    sub_1B761C0(&Method_SingletonTemplate_QuestTree__get_Instance__, v6);
    sub_1B761C0(&Method_WarEntity___c__DisplayClass52_0__IsPurchasedByRarePrism_b__0__, v7);
    sub_1B761C0(&WarEntity___c__DisplayClass52_0_TypeInfo, v8);
    byte_4A2EF9C = 1;
  }
  v9 = sub_1B7640C(WarEntity___c__DisplayClass52_0_TypeInfo);
  ...
  if ( WarEntity__HasFlag(this, 0x2000, v14) )
  {
    ...
    if ( Instance )
    {
      ...
      *(_QWORD *)(v9 + 24) = MasterData_object;
      sub_1B76164((ServantStatusBattleListViewItem_o *)(v9 + 24), (int32_t)MasterData_object, v16, v17);
      ...
      if ( Instance )
      {
        ...
        v19 = (System_Func_object__bool__o *)sub_1B7640C(System_Func_MapControl_QuestInfo__bool__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EF9E & 1) == 0 )
  {
    this = (WarEntity___c__DisplayClass52_0_o *)sub_1B761C0(&NetworkManager_TypeInfo, quest);
    byte_4A2EF9E = 1;
  }
  if ( !quest )
    goto LABEL_13;
