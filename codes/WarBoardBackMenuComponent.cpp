...
void __fastcall WarBoardBackMenuComponent__EndClose(WarBoardBackMenuComponent_o *this, const MethodInfo *method)
{
  ...
  if ( cancelCallbackFunc )
  {
    ...
    sub_1B76164(p_cancelCallbackFunc, 0, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2BEB0 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_WarBoardBackMenuComponent_EndClose__, v3);
    sub_1B761C0(&Method_WarBoardBackMenuComponent_OnClickBackButton__, v4);
    byte_4A2BEB0 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_WarBoardBackMenuComponent_OnClickBackButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1B761D8(Method_WarBoardBackMenuComponent_OnClickBackButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2BEAA & 1) == 0 )
  {
    sub_1B761C0(&System_Action_TypeInfo, method);
    sub_1B761C0(&Method_WarBoardBackMenuComponent_EndClose__, v3);
    sub_1B761C0(&Method_WarBoardBackMenuComponent_OnClickCancelButton__, v4);
    byte_4A2BEAA = 1;
  }
  if ( this->fields.state == 1 )
    this->fields.state = 0;
  ...
  if ( (*((_BYTE *)Method_WarBoardBackMenuComponent_OnClickCancelButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1B761D8(Method_WarBoardBackMenuComponent_OnClickCancelButton__);
  v6 = (System_Reflection_MethodBase_o *)sub_1B761A4(v5, v5[4]);
  OverwriteAssetSoundName__PlaySystemSe(v6, 1, 0LL);
  v7 = (System_Action_o *)sub_1B7640C(System_Action_TypeInfo);
  System_Action___ctor(v7, (Il2CppObject *)this, Method_WarBoardBackMenuComponent_EndClose__, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2BEAD & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_WarBoardBackMenuComponent_OnClickRetireButton__, v5);
    sub_1B761C0(&Method_WarBoardBackMenuComponent_OnClickRetireConfirmDialogFinalCheck__, v6);
    sub_1B761C0(&StringLiteral_15403/*"WARBOARD_MENU_RETIRE_CONFIRMATION_NO"*/, v7);
    sub_1B761C0(&StringLiteral_15401/*"WARBOARD_MENU_RETIRE_CONFIRMATION_MESSAGE"*/, v8);
    sub_1B761C0(&StringLiteral_15405/*"WARBOARD_MENU_RETIRE_CONFIRMATION_YES"*/, v9);
    sub_1B761C0(&StringLiteral_15404/*"WARBOARD_MENU_RETIRE_CONFIRMATION_TITLE"*/, v10);
    byte_4A2BEAD = 1;
  }
  ...
  if ( (*((_BYTE *)Method_WarBoardBackMenuComponent_OnClickRetireButton__ + 83) & 2) != 0 )
    v11 = (_QWORD *)sub_1B761D8(Method_WarBoardBackMenuComponent_OnClickRetireButton__);
  ...
  v14 = LocalizationManager__Get((System_String_o *)StringLiteral_15404/*"WARBOARD_MENU_RETIRE_CONFIRMATION_TITLE"*/, 0LL);
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_15401/*"WARBOARD_MENU_RETIRE_CONFIRMATION_MESSAGE"*/, 0LL);
  v16 = LocalizationManager__Get((System_String_o *)StringLiteral_15405/*"WARBOARD_MENU_RETIRE_CONFIRMATION_YES"*/, 0LL);
  v17 = LocalizationManager__Get((System_String_o *)StringLiteral_15403/*"WARBOARD_MENU_RETIRE_CONFIRMATION_NO"*/, 0LL);
  v18 = (CommonConfirmDialog_ClickDelegate_o *)sub_1B7640C(CommonConfirmDialog_ClickDelegate_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2BEAF & 1) == 0 )
  {
    this = (WarBoardBackMenuComponent_o *)sub_1B761C0(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, isDecide);
    byte_4A2BEAF = 1;
  }
  if ( isDecide )
  {
  ...
  this = (WarBoardBackMenuComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_371257C *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !this )
LABEL_8:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2BEAE & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_WarBoardBackMenuComponent_OnClickRetireConfirmDialog__, v8);
    sub_1B761C0(&StringLiteral_15403/*"WARBOARD_MENU_RETIRE_CONFIRMATION_NO"*/, v9);
    sub_1B761C0(&StringLiteral_15402/*"WARBOARD_MENU_RETIRE_CONFIRMATION_MESSAGE_GET_TREASURE"*/, v10);
    sub_1B761C0(&StringLiteral_15405/*"WARBOARD_MENU_RETIRE_CONFIRMATION_YES"*/, v11);
    byte_4A2BEAE = 1;
  }
  ...
  if ( !isDecide )
    return;
  Instance = (CommonUI_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_371257C *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !Instance
...
LABEL_16:
  ...
  v14 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_371257C *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_15402/*"WARBOARD_MENU_RETIRE_CONFIRMATION_MESSAGE_GET_TREASURE"*/, 0LL);
  v16 = LocalizationManager__Get((System_String_o *)StringLiteral_15405/*"WARBOARD_MENU_RETIRE_CONFIRMATION_YES"*/, 0LL);
  v17 = LocalizationManager__Get((System_String_o *)StringLiteral_15403/*"WARBOARD_MENU_RETIRE_CONFIRMATION_NO"*/, 0LL);
  v18 = (CommonConfirmDialog_ClickDelegate_o *)sub_1B7640C(CommonConfirmDialog_ClickDelegate_TypeInfo);
  CommonConfirmDialog_ClickDelegate___ctor(
  ...
  if ( !v14 )
    goto LABEL_16;
  CommonUI__OpenConfirmDialog_30418988((CommonUI_o *)v14, 0LL, v15, v16, v17, 1, v18, 28, 28, 99.0, 15.0, 0, 0, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2BEAB & 1) == 0 )
  {
    ...
    sub_1B761C0(&LocalizationManager_TypeInfo, v3);
    sub_1B761C0(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v4);
    sub_1B761C0(&Method_WarBoardBackMenuComponent_OnClickSuspendButton__, v5);
    sub_1B761C0(&Method_WarBoardBackMenuComponent_OnClickSusupendConfirmDialog__, v6);
    sub_1B761C0(&StringLiteral_15408/*"WARBOARD_MENU_SUSPEND_CONFIRMATION_NO"*/, v7);
    sub_1B761C0(&StringLiteral_15410/*"WARBOARD_MENU_SUSPEND_CONFIRMATION_YES"*/, v8);
    sub_1B761C0(&StringLiteral_15409/*"WARBOARD_MENU_SUSPEND_CONFIRMATION_TITLE"*/, v9);
    sub_1B761C0(&StringLiteral_15407/*"WARBOARD_MENU_SUSPEND_CONFIRMATION_MESSAGE"*/, v10);
    byte_4A2BEAB = 1;
  }
  ...
  if ( (*((_BYTE *)Method_WarBoardBackMenuComponent_OnClickSuspendButton__ + 83) & 2) != 0 )
    v11 = (_QWORD *)sub_1B761D8(Method_WarBoardBackMenuComponent_OnClickSuspendButton__);
  v12 = (System_Reflection_MethodBase_o *)sub_1B761A4(v11, v11[4]);
  OverwriteAssetSoundName__PlaySystemSe(v12, 0, 0LL);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_371257C *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v14 = LocalizationManager__Get((System_String_o *)StringLiteral_15409/*"WARBOARD_MENU_SUSPEND_CONFIRMATION_TITLE"*/, 0LL);
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_15407/*"WARBOARD_MENU_SUSPEND_CONFIRMATION_MESSAGE"*/, 0LL);
  v16 = LocalizationManager__Get((System_String_o *)StringLiteral_15410/*"WARBOARD_MENU_SUSPEND_CONFIRMATION_YES"*/, 0LL);
  v17 = LocalizationManager__Get((System_String_o *)StringLiteral_15408/*"WARBOARD_MENU_SUSPEND_CONFIRMATION_NO"*/, 0LL);
  v18 = (CommonConfirmDialog_ClickDelegate_o *)sub_1B7640C(CommonConfirmDialog_ClickDelegate_TypeInfo);
  CommonConfirmDialog_ClickDelegate___ctor(
    v18,
    (Il2CppObject *)this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2BEA9 & 1) == 0 )
  {
    sub_1B761C0(&LocalizationManager_TypeInfo, suspendCallback);
    sub_1B761C0(&UnityEngine_Object_TypeInfo, v9);
    sub_1B761C0(&StringLiteral_15406/*"WARBOARD_MENU_SUSPEND_BUTTON_LABEL"*/, v10);
    sub_1B761C0(&StringLiteral_15399/*"WARBOARD_MENU_BACK_BUTTON_LABEL"*/, v11);
    sub_1B761C0(&StringLiteral_15400/*"WARBOARD_MENU_RETIRE_BUTTON_LABEL"*/, v12);
    sub_1B761C0(&StringLiteral_15411/*"WARBOARD_MENU_TITLE_LABEL"*/, v13);
    byte_4A2BEA9 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(menuTitleTxt, 0LL, 0LL) )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_15411/*"WARBOARD_MENU_TITLE_LABEL"*/, 0LL);
      if ( !v19 )
        goto LABEL_34;
    ...
    if ( UnityEngine_Object__op_Inequality(suspendButtonTxt, 0LL, 0LL) )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_15406/*"WARBOARD_MENU_SUSPEND_BUTTON_LABEL"*/, 0LL);
      if ( !v23 )
        goto LABEL_34;
    ...
    if ( UnityEngine_Object__op_Inequality(retireButtonTxt, 0LL, 0LL) )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_15400/*"WARBOARD_MENU_RETIRE_BUTTON_LABEL"*/, 0LL);
      if ( !v25 )
        goto LABEL_34;
    ...
    if ( UnityEngine_Object__op_Inequality(cancelButtonTxt, 0LL, 0LL) )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_15399/*"WARBOARD_MENU_BACK_BUTTON_LABEL"*/, 0LL);
      if ( !v27 )
        goto LABEL_34;
        ...
        const MethodInfo *method)
{
  if ( (byte_4A2BEB2 & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_3013/*"BG/BackButton"*/, method);
    byte_4A2BEB2 = 1;
  }
