...
void __fastcall WarBoardBackMenuComponent__EndClose(WarBoardBackMenuComponent_o *this, const MethodInfo *method)
{
  ...
  if ( cancelCallbackFunc )
  {
    ...
    sub_1C1AB78(p_cancelCallbackFunc, 0LL, v5, v6, v7, v8, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC5952 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_WarBoardBackMenuComponent_EndClose__, v3);
    sub_1C1ABD4(&Method_WarBoardBackMenuComponent_OnClickBackButton__, v4);
    byte_4BC5952 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_WarBoardBackMenuComponent_OnClickBackButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1C1ABEC(Method_WarBoardBackMenuComponent_OnClickBackButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC594C & 1) == 0 )
  {
    sub_1C1ABD4(&System_Action_TypeInfo, method);
    sub_1C1ABD4(&Method_WarBoardBackMenuComponent_EndClose__, v3);
    sub_1C1ABD4(&Method_WarBoardBackMenuComponent_OnClickCancelButton__, v4);
    byte_4BC594C = 1;
  }
  if ( this->fields.state == 1 )
    this->fields.state = 0;
  ...
  if ( (*((_BYTE *)Method_WarBoardBackMenuComponent_OnClickCancelButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1C1ABEC(Method_WarBoardBackMenuComponent_OnClickCancelButton__);
  v6 = (System_Reflection_MethodBase_o *)sub_1C1ABB8(v5, v5[4]);
  OverwriteAssetSoundName__PlaySystemSe(v6, 1, 0, 0LL);
  v7 = (System_Action_o *)sub_1C1AE20(System_Action_TypeInfo);
  System_Action___ctor(v7, (Il2CppObject *)this, Method_WarBoardBackMenuComponent_EndClose__, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC594F & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_WarBoardBackMenuComponent_OnClickRetireButton__, v5);
    sub_1C1ABD4(&Method_WarBoardBackMenuComponent_OnClickRetireConfirmDialogFinalCheck__, v6);
    sub_1C1ABD4(&StringLiteral_15664/*"WARBOARD_MENU_RETIRE_CONFIRMATION_NO"*/, v7);
    sub_1C1ABD4(&StringLiteral_15662/*"WARBOARD_MENU_RETIRE_CONFIRMATION_MESSAGE"*/, v8);
    sub_1C1ABD4(&StringLiteral_15666/*"WARBOARD_MENU_RETIRE_CONFIRMATION_YES"*/, v9);
    sub_1C1ABD4(&StringLiteral_15665/*"WARBOARD_MENU_RETIRE_CONFIRMATION_TITLE"*/, v10);
    byte_4BC594F = 1;
  }
  ...
  if ( (*((_BYTE *)Method_WarBoardBackMenuComponent_OnClickRetireButton__ + 83) & 2) != 0 )
    v11 = (_QWORD *)sub_1C1ABEC(Method_WarBoardBackMenuComponent_OnClickRetireButton__);
  ...
  v14 = LocalizationManager__Get((System_String_o *)StringLiteral_15665/*"WARBOARD_MENU_RETIRE_CONFIRMATION_TITLE"*/, 0LL);
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_15662/*"WARBOARD_MENU_RETIRE_CONFIRMATION_MESSAGE"*/, 0LL);
  v16 = LocalizationManager__Get((System_String_o *)StringLiteral_15666/*"WARBOARD_MENU_RETIRE_CONFIRMATION_YES"*/, 0LL);
  v17 = LocalizationManager__Get((System_String_o *)StringLiteral_15664/*"WARBOARD_MENU_RETIRE_CONFIRMATION_NO"*/, 0LL);
  v18 = (CommonConfirmDialog_ClickDelegate_o *)sub_1C1AE20(CommonConfirmDialog_ClickDelegate_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC5951 & 1) == 0 )
  {
    this = (WarBoardBackMenuComponent_o *)sub_1C1ABD4(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, isDecide);
    byte_4BC5951 = 1;
  }
  if ( isDecide )
  {
  ...
  this = (WarBoardBackMenuComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_387A8A8 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !this )
LABEL_8:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC5950 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_WarBoardBackMenuComponent_OnClickRetireConfirmDialog__, v8);
    sub_1C1ABD4(&StringLiteral_15664/*"WARBOARD_MENU_RETIRE_CONFIRMATION_NO"*/, v9);
    sub_1C1ABD4(&StringLiteral_15663/*"WARBOARD_MENU_RETIRE_CONFIRMATION_MESSAGE_GET_TREASURE"*/, v10);
    sub_1C1ABD4(&StringLiteral_15666/*"WARBOARD_MENU_RETIRE_CONFIRMATION_YES"*/, v11);
    byte_4BC5950 = 1;
  }
  ...
  if ( !isDecide )
    return;
  Instance = (CommonUI_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_387A8A8 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !Instance
...
LABEL_16:
  ...
  v14 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_387A8A8 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_15663/*"WARBOARD_MENU_RETIRE_CONFIRMATION_MESSAGE_GET_TREASURE"*/, 0LL);
  v16 = LocalizationManager__Get((System_String_o *)StringLiteral_15666/*"WARBOARD_MENU_RETIRE_CONFIRMATION_YES"*/, 0LL);
  v17 = LocalizationManager__Get((System_String_o *)StringLiteral_15664/*"WARBOARD_MENU_RETIRE_CONFIRMATION_NO"*/, 0LL);
  v18 = (CommonConfirmDialog_ClickDelegate_o *)sub_1C1AE20(CommonConfirmDialog_ClickDelegate_TypeInfo);
  CommonConfirmDialog_ClickDelegate___ctor(
  ...
  if ( !v14 )
    goto LABEL_16;
  CommonUI__OpenConfirmDialog_31098836((CommonUI_o *)v14, 0LL, v15, v16, v17, 1, v18, 28, 28, 99.0, 15.0, 0, 0, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC594D & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&LocalizationManager_TypeInfo, v3);
    sub_1C1ABD4(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v4);
    sub_1C1ABD4(&Method_WarBoardBackMenuComponent_OnClickSuspendButton__, v5);
    sub_1C1ABD4(&Method_WarBoardBackMenuComponent_OnClickSusupendConfirmDialog__, v6);
    sub_1C1ABD4(&StringLiteral_15669/*"WARBOARD_MENU_SUSPEND_CONFIRMATION_NO"*/, v7);
    sub_1C1ABD4(&StringLiteral_15671/*"WARBOARD_MENU_SUSPEND_CONFIRMATION_YES"*/, v8);
    sub_1C1ABD4(&StringLiteral_15670/*"WARBOARD_MENU_SUSPEND_CONFIRMATION_TITLE"*/, v9);
    sub_1C1ABD4(&StringLiteral_15668/*"WARBOARD_MENU_SUSPEND_CONFIRMATION_MESSAGE"*/, v10);
    byte_4BC594D = 1;
  }
  ...
  if ( (*((_BYTE *)Method_WarBoardBackMenuComponent_OnClickSuspendButton__ + 83) & 2) != 0 )
    v11 = (_QWORD *)sub_1C1ABEC(Method_WarBoardBackMenuComponent_OnClickSuspendButton__);
  v12 = (System_Reflection_MethodBase_o *)sub_1C1ABB8(v11, v11[4]);
  OverwriteAssetSoundName__PlaySystemSe(v12, 0, 0, 0LL);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_387A8A8 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v14 = LocalizationManager__Get((System_String_o *)StringLiteral_15670/*"WARBOARD_MENU_SUSPEND_CONFIRMATION_TITLE"*/, 0LL);
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_15668/*"WARBOARD_MENU_SUSPEND_CONFIRMATION_MESSAGE"*/, 0LL);
  v16 = LocalizationManager__Get((System_String_o *)StringLiteral_15671/*"WARBOARD_MENU_SUSPEND_CONFIRMATION_YES"*/, 0LL);
  v17 = LocalizationManager__Get((System_String_o *)StringLiteral_15669/*"WARBOARD_MENU_SUSPEND_CONFIRMATION_NO"*/, 0LL);
  v18 = (CommonConfirmDialog_ClickDelegate_o *)sub_1C1AE20(CommonConfirmDialog_ClickDelegate_TypeInfo);
  CommonConfirmDialog_ClickDelegate___ctor(
    v18,
    (Il2CppObject *)this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC594B & 1) == 0 )
  {
    sub_1C1ABD4(&LocalizationManager_TypeInfo, suspendCallback);
    sub_1C1ABD4(&UnityEngine_Object_TypeInfo, v12);
    sub_1C1ABD4(&StringLiteral_15667/*"WARBOARD_MENU_SUSPEND_BUTTON_LABEL"*/, v13);
    sub_1C1ABD4(&StringLiteral_15660/*"WARBOARD_MENU_BACK_BUTTON_LABEL"*/, v14);
    sub_1C1ABD4(&StringLiteral_15661/*"WARBOARD_MENU_RETIRE_BUTTON_LABEL"*/, v15);
    sub_1C1ABD4(&StringLiteral_15672/*"WARBOARD_MENU_TITLE_LABEL"*/, v16);
    byte_4BC594B = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(menuTitleTxt, 0LL, 0LL) )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_15672/*"WARBOARD_MENU_TITLE_LABEL"*/, 0LL);
      if ( !v30 )
        goto LABEL_34;
    ...
    if ( UnityEngine_Object__op_Inequality(suspendButtonTxt, 0LL, 0LL) )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_15667/*"WARBOARD_MENU_SUSPEND_BUTTON_LABEL"*/, 0LL);
      if ( !v34 )
        goto LABEL_34;
    ...
    if ( UnityEngine_Object__op_Inequality(retireButtonTxt, 0LL, 0LL) )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_15661/*"WARBOARD_MENU_RETIRE_BUTTON_LABEL"*/, 0LL);
      if ( !v36 )
        goto LABEL_34;
    ...
    if ( UnityEngine_Object__op_Inequality(cancelButtonTxt, 0LL, 0LL) )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_15660/*"WARBOARD_MENU_BACK_BUTTON_LABEL"*/, 0LL);
      if ( !v38 )
        goto LABEL_34;
        ...
        const MethodInfo *method)
{
  if ( (byte_4BC5954 & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_3049/*"BG/BackButton"*/, method);
    byte_4BC5954 = 1;
  }
  return (System_String_o *)StringLiteral_3049/*"BG/BackButton"*/;
}