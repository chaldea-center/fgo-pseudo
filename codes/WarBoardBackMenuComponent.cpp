...
void WarBoardBackMenuComponent__EndClose(WarBoardBackMenuComponent_o *this, const MethodInfo *method)
{
  ...
  if ( cancelCallbackFunc )
  {
    ...
    sub_1C2D434(p_cancelCallbackFunc, 0, v5, v6);
...
void WarBoardBackMenuComponent__OnClickBackButton(WarBoardBackMenuComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C24FF4 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_WarBoardBackMenuComponent_EndClose__);
    sub_1C2D490(&Method_WarBoardBackMenuComponent_OnClickBackButton__);
    byte_4C24FF4 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_WarBoardBackMenuComponent_OnClickBackButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C2D4A8(Method_WarBoardBackMenuComponent_OnClickBackButton__);
...
void WarBoardBackMenuComponent__OnClickCancelButton(WarBoardBackMenuComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C24FEE & 1) == 0 )
  {
    sub_1C2D490(&System_Action_TypeInfo);
    sub_1C2D490(&Method_WarBoardBackMenuComponent_EndClose__);
    sub_1C2D490(&Method_WarBoardBackMenuComponent_OnClickCancelButton__);
    byte_4C24FEE = 1;
  }
  if ( this->fields.state == 1 )
    this->fields.state = 0;
  ...
  if ( (*((_BYTE *)Method_WarBoardBackMenuComponent_OnClickCancelButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C2D4A8(Method_WarBoardBackMenuComponent_OnClickCancelButton__);
  v4 = (System_Reflection_MethodBase_o *)sub_1C2D474(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0, 0);
  v5 = (System_Action_o *)sub_1C2D6DC(System_Action_TypeInfo);
  System_Action___ctor(v5, (Il2CppObject *)this, Method_WarBoardBackMenuComponent_EndClose__, 0);
...
void WarBoardBackMenuComponent__OnClickRetireButton(WarBoardBackMenuComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C24FF1 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_WarBoardBackMenuComponent_OnClickRetireButton__);
    sub_1C2D490(&Method_WarBoardBackMenuComponent_OnClickRetireConfirmDialogFinalCheck__);
    sub_1C2D490(&StringLiteral_15394/*"WARBOARD_MENU_RETIRE_CONFIRMATION_NO"*/);
    sub_1C2D490(&StringLiteral_15392/*"WARBOARD_MENU_RETIRE_CONFIRMATION_MESSAGE"*/);
    sub_1C2D490(&StringLiteral_15396/*"WARBOARD_MENU_RETIRE_CONFIRMATION_YES"*/);
    sub_1C2D490(&StringLiteral_15395/*"WARBOARD_MENU_RETIRE_CONFIRMATION_TITLE"*/);
    byte_4C24FF1 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_WarBoardBackMenuComponent_OnClickRetireButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C2D4A8(Method_WarBoardBackMenuComponent_OnClickRetireButton__);
  v4 = (System_Reflection_MethodBase_o *)sub_1C2D474(v3, v3[4]);
  ...
  if ( !Instance )
    sub_1C2D6EC(v11, v12);
  CommonUI__OpenConfirmDialog_31167344((CommonUI_o *)Instance, v6, v7, v8, v9, 1, v10, 28, 28, 99.0, 15.0, 0, 0, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24FF3 & 1) == 0 )
  {
    this = (WarBoardBackMenuComponent_o *)sub_1C2D490(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4C24FF3 = 1;
  }
  if ( isDecide )
  {
  ...
  this = (WarBoardBackMenuComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39D3CCC *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !this )
LABEL_8:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24FF2 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_WarBoardBackMenuComponent_OnClickRetireConfirmDialog__);
    sub_1C2D490(&StringLiteral_15394/*"WARBOARD_MENU_RETIRE_CONFIRMATION_NO"*/);
    sub_1C2D490(&StringLiteral_15393/*"WARBOARD_MENU_RETIRE_CONFIRMATION_MESSAGE_GET_TREASURE"*/);
    sub_1C2D490(&StringLiteral_15396/*"WARBOARD_MENU_RETIRE_CONFIRMATION_YES"*/);
    byte_4C24FF2 = 1;
  }
  ...
  if ( !isDecide )
    return;
  Instance = (CommonUI_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39D3CCC *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !Instance
...
LABEL_16:
  ...
  if ( !v7 )
    goto LABEL_16;
  CommonUI__OpenConfirmDialog_31167344((CommonUI_o *)v7, 0, v8, v9, v10, 1, v11, 28, 28, 99.0, 15.0, 0, 0, 0);
}
...
void WarBoardBackMenuComponent__OnClickSuspendButton(WarBoardBackMenuComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C24FEF & 1) == 0 )
  {
    ...
    sub_1C2D490(&LocalizationManager_TypeInfo);
    sub_1C2D490(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1C2D490(&Method_WarBoardBackMenuComponent_OnClickSuspendButton__);
    sub_1C2D490(&Method_WarBoardBackMenuComponent_OnClickSusupendConfirmDialog__);
    sub_1C2D490(&StringLiteral_15399/*"WARBOARD_MENU_SUSPEND_CONFIRMATION_NO"*/);
    sub_1C2D490(&StringLiteral_15401/*"WARBOARD_MENU_SUSPEND_CONFIRMATION_YES"*/);
    sub_1C2D490(&StringLiteral_15400/*"WARBOARD_MENU_SUSPEND_CONFIRMATION_TITLE"*/);
    sub_1C2D490(&StringLiteral_15398/*"WARBOARD_MENU_SUSPEND_CONFIRMATION_MESSAGE"*/);
    byte_4C24FEF = 1;
  }
  ...
  if ( (*((_BYTE *)Method_WarBoardBackMenuComponent_OnClickSuspendButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C2D4A8(Method_WarBoardBackMenuComponent_OnClickSuspendButton__);
  v4 = (System_Reflection_MethodBase_o *)sub_1C2D474(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39D3CCC *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24FED & 1) == 0 )
  {
    sub_1C2D490(&LocalizationManager_TypeInfo);
    sub_1C2D490(&UnityEngine_Object_TypeInfo);
    sub_1C2D490(&StringLiteral_15397/*"WARBOARD_MENU_SUSPEND_BUTTON_LABEL"*/);
    sub_1C2D490(&StringLiteral_15390/*"WARBOARD_MENU_BACK_BUTTON_LABEL"*/);
    sub_1C2D490(&StringLiteral_15391/*"WARBOARD_MENU_RETIRE_BUTTON_LABEL"*/);
    sub_1C2D490(&StringLiteral_15402/*"WARBOARD_MENU_TITLE_LABEL"*/);
    byte_4C24FED = 1;
  }
  if ( !this->fields.state )
  {
    ...
    sub_1C2D434((CGThumbnailListItem_o *)&this->fields.retireCallbackFunc, (int32_t)retireCallback, v9, v10);
    this->fields.cancelCallbackFunc = cancelCallback;
    sub_1C2D434((CGThumbnailListItem_o *)&this->fields.cancelCallbackFunc, (int32_t)cancelCallback, v11, v12);
        ...
        const MethodInfo *method)
{
  if ( (byte_4C24FF6 & 1) == 0 )
  {
    sub_1C2D490(&StringLiteral_2907/*"BG/BackButton"*/);
    byte_4C24FF6 = 1;
  }
