...
void __fastcall WarBoardBackMenuComponent__EndClose(WarBoardBackMenuComponent_o *this, const MethodInfo *method)
{
  ...
  if ( cancelCallbackFunc )
  {
    ...
    sub_B52920(p_cancelCallbackFunc, 0LL, v5, v6, v7, v8, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AE0BD & 1) == 0 )
  {
    ...
    sub_B52984(&Method_WarBoardBackMenuComponent_EndClose__);
    byte_42AE0BD = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AE0BA & 1) == 0 )
  {
    ...
    sub_B52984(&SoundManager_TypeInfo);
    sub_B52984(&Method_WarBoardBackMenuComponent_OnClickRetireConfirmDialogFinalCheck__);
    sub_B52984(&StringLiteral_15357/*"WARBOARD_MENU_RETIRE_CONFIRMATION_NO"*/);
    sub_B52984(&StringLiteral_15355/*"WARBOARD_MENU_RETIRE_CONFIRMATION_MESSAGE"*/);
    sub_B52984(&StringLiteral_15359/*"WARBOARD_MENU_RETIRE_CONFIRMATION_YES"*/);
    sub_B52984(&StringLiteral_15358/*"WARBOARD_MENU_RETIRE_CONFIRMATION_TITLE"*/);
    byte_42AE0BA = 1;
  }
  if ( (BYTE3(SoundManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0 && !SoundManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(SoundManager_TypeInfo);
  ...
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_15358/*"WARBOARD_MENU_RETIRE_CONFIRMATION_TITLE"*/, 0LL);
  v5 = LocalizationManager__Get((System_String_o *)StringLiteral_15355/*"WARBOARD_MENU_RETIRE_CONFIRMATION_MESSAGE"*/, 0LL);
  v6 = LocalizationManager__Get((System_String_o *)StringLiteral_15359/*"WARBOARD_MENU_RETIRE_CONFIRMATION_YES"*/, 0LL);
  v7 = LocalizationManager__Get((System_String_o *)StringLiteral_15357/*"WARBOARD_MENU_RETIRE_CONFIRMATION_NO"*/, 0LL);
  ...
  if ( !Instance )
    sub_B52A5C(v9, v10);
  CommonUI__OpenConfirmDialog_18157484(Instance, v4, v5, v6, v7, 1, v8, 28, 28, 99.0, 15.0, 0, 0, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  retireCallbackFunc = (System_Action_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !retireCallbackFunc )
LABEL_8:
    sub_B52A5C(retireCallbackFunc, isDecide);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AE0BB & 1) == 0 )
  {
    ...
    sub_B52984(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_B52984(&Method_WarBoardBackMenuComponent_OnClickRetireConfirmDialog__);
    sub_B52984(&StringLiteral_15357/*"WARBOARD_MENU_RETIRE_CONFIRMATION_NO"*/);
    sub_B52984(&StringLiteral_15356/*"WARBOARD_MENU_RETIRE_CONFIRMATION_MESSAGE_GET_TREASURE"*/);
    sub_B52984(&StringLiteral_15359/*"WARBOARD_MENU_RETIRE_CONFIRMATION_YES"*/);
    byte_42AE0BB = 1;
  }
  Instance = (CommonUI_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  ...
  if ( !isDecide )
    return;
  Instance = (CommonUI_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !Instance
...
LABEL_17:
  ...
  v8 = LocalizationManager__Get((System_String_o *)StringLiteral_15356/*"WARBOARD_MENU_RETIRE_CONFIRMATION_MESSAGE_GET_TREASURE"*/, 0LL);
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_15359/*"WARBOARD_MENU_RETIRE_CONFIRMATION_YES"*/, 0LL);
  v10 = LocalizationManager__Get((System_String_o *)StringLiteral_15357/*"WARBOARD_MENU_RETIRE_CONFIRMATION_NO"*/, 0LL);
  v11 = (CommonConfirmDialog_ClickDelegate_o *)sub_B52A54(CommonConfirmDialog_ClickDelegate_TypeInfo);
  CommonConfirmDialog_ClickDelegate___ctor(
    v11,
    (Il2CppObject *)this,
  ...
  if ( !v7 )
    goto LABEL_17;
  CommonUI__OpenConfirmDialog_18157484(v7, 0LL, v8, v9, v10, 1, v11, 28, 28, 99.0, 15.0, 0, 0, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AE0B8 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_B52984(&SoundManager_TypeInfo);
    sub_B52984(&Method_WarBoardBackMenuComponent_OnClickSusupendConfirmDialog__);
    sub_B52984(&StringLiteral_15362/*"WARBOARD_MENU_SUSPEND_CONFIRMATION_NO"*/);
    sub_B52984(&StringLiteral_15364/*"WARBOARD_MENU_SUSPEND_CONFIRMATION_YES"*/);
    sub_B52984(&StringLiteral_15363/*"WARBOARD_MENU_SUSPEND_CONFIRMATION_TITLE"*/);
    sub_B52984(&StringLiteral_15361/*"WARBOARD_MENU_SUSPEND_CONFIRMATION_MESSAGE"*/);
    byte_42AE0B8 = 1;
  }
  if ( (BYTE3(SoundManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0 && !SoundManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(SoundManager_TypeInfo);
  ...
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_15363/*"WARBOARD_MENU_SUSPEND_CONFIRMATION_TITLE"*/, 0LL);
  v5 = LocalizationManager__Get((System_String_o *)StringLiteral_15361/*"WARBOARD_MENU_SUSPEND_CONFIRMATION_MESSAGE"*/, 0LL);
  v6 = LocalizationManager__Get((System_String_o *)StringLiteral_15364/*"WARBOARD_MENU_SUSPEND_CONFIRMATION_YES"*/, 0LL);
  v7 = LocalizationManager__Get((System_String_o *)StringLiteral_15362/*"WARBOARD_MENU_SUSPEND_CONFIRMATION_NO"*/, 0LL);
  v8 = (CommonConfirmDialog_ClickDelegate_o *)sub_B52A54(CommonConfirmDialog_ClickDelegate_TypeInfo);
  CommonConfirmDialog_ClickDelegate___ctor(
    v8,
    (Il2CppObject *)this,
        ...
        const MethodInfo *method)
{
  ...
  suspendCallbackFunc = (System_Action_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !suspendCallbackFunc )
LABEL_8:
    sub_B52A5C(suspendCallbackFunc, isDecide);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AE0B6 & 1) == 0 )
  {
    sub_B52984(&LocalizationManager_TypeInfo);
    sub_B52984(&UnityEngine_Object_TypeInfo);
    sub_B52984(&StringLiteral_15360/*"WARBOARD_MENU_SUSPEND_BUTTON_LABEL"*/);
    sub_B52984(&StringLiteral_15353/*"WARBOARD_MENU_BACK_BUTTON_LABEL"*/);
    sub_B52984(&StringLiteral_15354/*"WARBOARD_MENU_RETIRE_BUTTON_LABEL"*/);
    sub_B52984(&StringLiteral_15365/*"WARBOARD_MENU_TITLE_LABEL"*/);
    byte_42AE0B6 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(menuTitleTxt, 0LL, 0LL) )
    {
      ...
      gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_15365/*"WARBOARD_MENU_TITLE_LABEL"*/, 0LL);
      if ( !v25 )
        goto LABEL_42;
    ...
    if ( UnityEngine_Object__op_Inequality(suspendButtonTxt, 0LL, 0LL) )
    {
      ...
      gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_15360/*"WARBOARD_MENU_SUSPEND_BUTTON_LABEL"*/, 0LL);
      if ( !v29 )
        goto LABEL_42;
    ...
    if ( UnityEngine_Object__op_Inequality(retireButtonTxt, 0LL, 0LL) )
    {
      ...
      gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_15354/*"WARBOARD_MENU_RETIRE_BUTTON_LABEL"*/, 0LL);
      if ( !v31 )
        goto LABEL_42;
    ...
    if ( UnityEngine_Object__op_Inequality(cancelButtonTxt, 0LL, 0LL) )
    {
      ...
      gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_15353/*"WARBOARD_MENU_BACK_BUTTON_LABEL"*/, 0LL);
      if ( !v33 )
        goto LABEL_42;
        ...
        const MethodInfo *method)
{
  if ( (byte_42AE0BF & 1) == 0 )
  {
    sub_B52984(&StringLiteral_2579/*"BG/BackButton"*/);
    byte_42AE0BF = 1;
  }
  return (System_String_o *)StringLiteral_2579/*"BG/BackButton"*/;
}