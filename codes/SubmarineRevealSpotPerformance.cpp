        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD90F0 & 1) == 0 )
  {
    sub_1C21E38(&SubmarineRevealSpotPerformance__Execute_d__4_TypeInfo);
    byte_4BD90F0 = 1;
  }
  v3 = sub_1C22084(SubmarineRevealSpotPerformance__Execute_d__4_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD90EF & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_SubmarineRevealSpotPerformance__OnStart_b__3_0__);
    byte_4BD90EF = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD90F1 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_SubmarineRevealSpotPerformance__Execute_b__4_0__);
  ...
  else
  {
    ...
    System_Func_bool____ctor(v6, _4__this, Method_SubmarineRevealSpotPerformance__Execute_b__4_0__, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C21E4C(&Method_SubmarineRevealSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_1C21F60(v3, v4);
}
