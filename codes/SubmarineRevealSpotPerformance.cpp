        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2AC10 & 1) == 0 )
  {
    sub_1B761C0(&SubmarineRevealSpotPerformance__Execute_d__4_TypeInfo, method);
    byte_4A2AC10 = 1;
  }
  v3 = sub_1B7640C(SubmarineRevealSpotPerformance__Execute_d__4_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2AC0F & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_SubmarineRevealSpotPerformance__OnStart_b__3_0__, v3);
    byte_4A2AC0F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2AC11 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_SubmarineRevealSpotPerformance__Execute_b__4_0__, v3);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B761D4(&Method_SubmarineRevealSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_1B762E8(v3, v4);
}
