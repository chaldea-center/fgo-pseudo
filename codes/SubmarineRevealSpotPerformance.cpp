        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2D2CE & 1) == 0 )
  {
    sub_1C93AD4(&SubmarineRevealSpotPerformance__Execute_d__4_TypeInfo);
    byte_4D2D2CE = 1;
  }
  v3 = sub_1C93D20(SubmarineRevealSpotPerformance__Execute_d__4_TypeInfo);
...
void SubmarineRevealSpotPerformance__OnStart(SubmarineRevealSpotPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2D2CD & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_SubmarineRevealSpotPerformance__OnStart_b__3_0__);
    byte_4D2D2CD = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2D2CF & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_SubmarineRevealSpotPerformance__Execute_b__4_0__);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C93AE8(&Method_SubmarineRevealSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_1C93BFC(v3, v4);
}
