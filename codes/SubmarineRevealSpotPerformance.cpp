        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB29B2 & 1) == 0 )
  {
    sub_1BAB41C(&SubmarineRevealSpotPerformance__Execute_d__4_TypeInfo, method);
    byte_4AB29B2 = 1;
  }
  v3 = sub_1BAB668(SubmarineRevealSpotPerformance__Execute_d__4_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB29B1 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_SubmarineRevealSpotPerformance__OnStart_b__3_0__, v3);
    byte_4AB29B1 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB29B3 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_SubmarineRevealSpotPerformance__Execute_b__4_0__, v3);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BAB430(&Method_SubmarineRevealSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_1BAB544(v3, v4);
}
