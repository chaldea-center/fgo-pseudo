        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B414F4 & 1) == 0 )
  {
    sub_1BDB878(&SubmarineRevealSpotPerformance__Execute_d__4_TypeInfo, method);
    byte_4B414F4 = 1;
  }
  v3 = sub_1BDBAC4(SubmarineRevealSpotPerformance__Execute_d__4_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B414F3 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_SubmarineRevealSpotPerformance__OnStart_b__3_0__, v3);
    byte_4B414F3 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B414F5 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_SubmarineRevealSpotPerformance__Execute_b__4_0__, v3);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BDB88C(&Method_SubmarineRevealSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_1BDB9A0(v3, v4);
}
