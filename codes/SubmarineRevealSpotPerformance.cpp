        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42E7BA1 & 1) == 0 )
  {
    sub_B5D5C4(&SubmarineRevealSpotPerformance__Execute_d__4_TypeInfo, (_DWORD)method, v2, v3);
    byte_42E7BA1 = 1;
  }
  v5 = sub_B5D694(SubmarineRevealSpotPerformance__Execute_d__4_TypeInfo);
  SubmarineRevealSpotPerformance__Execute_d__4___ctor((SubmarineRevealSpotPerformance__Execute_d__4_o *)v5, 0, 0LL);
  if ( !v5 )
    sub_B5D69C(v6, v7);
  *(_QWORD *)(v5 + 32) = this;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42E7BA0 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&Method_SubmarineRevealSpotPerformance__OnStart_b__3_0__, v5, v6, v7);
    byte_42E7BA0 = 1;
  }
  ...
  System_Action___ctor(v9, (Il2CppObject *)this, Method_SubmarineRevealSpotPerformance__OnStart_b__3_0__, 0LL);
  if ( !spot )
    sub_B5D69C(v10, v11);
  SrcSpotBasePrefab__SetState(spot, 3, v9, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42E6462 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&Method_SubmarineRevealSpotPerformance__Execute_b__4_0__, v8, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_B5D5C8(&Method_SubmarineRevealSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_B5D668(v3, v4);
}
