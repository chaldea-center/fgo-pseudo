        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5934E5F & 1) == 0 )
  {
    sub_21FFC50(&SubmarineRevealSpotPerformance__Execute_d__4_TypeInfo);
    byte_5934E5F = 1;
  }
  v3 = sub_21FFEBC(SubmarineRevealSpotPerformance__Execute_d__4_TypeInfo);
...
void SubmarineRevealSpotPerformance__OnStart(SubmarineRevealSpotPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_5934E5E & 1) == 0 )
  {
    ...
    sub_21FFC50(&Method_SubmarineRevealSpotPerformance__OnStart_b__3_0__);
    byte_5934E5E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5934E60 & 1) == 0 )
  {
    ...
    sub_21FFC50(&Method_SubmarineRevealSpotPerformance__Execute_b__4_0__);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_21FFC64(&Method_SubmarineRevealSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_21FFD90(v3, v4);
}
