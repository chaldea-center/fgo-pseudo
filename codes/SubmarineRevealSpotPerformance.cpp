        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A05943 & 1) == 0 )
  {
    sub_1B686D4(&SubmarineRevealSpotPerformance__Execute_d__4_TypeInfo, method);
    byte_4A05943 = 1;
  }
  v3 = sub_1B68920(SubmarineRevealSpotPerformance__Execute_d__4_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A05942 & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_SubmarineRevealSpotPerformance__OnStart_b__3_0__, v3);
    byte_4A05942 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A05944 & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_SubmarineRevealSpotPerformance__Execute_b__4_0__, v3);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B686E8(&Method_SubmarineRevealSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_1B687FC(v3, v4);
}
