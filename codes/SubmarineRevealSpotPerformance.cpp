        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DF5EB & 1) == 0 )
  {
    sub_1B00CCC(&SubmarineRevealSpotPerformance__Execute_d__4_TypeInfo, method);
    byte_48DF5EB = 1;
  }
  v3 = sub_1B00F18(SubmarineRevealSpotPerformance__Execute_d__4_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DF5EA & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_SubmarineRevealSpotPerformance__OnStart_b__3_0__, v3);
    byte_48DF5EA = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DF5EC & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_SubmarineRevealSpotPerformance__Execute_b__4_0__, v3);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B00CE0(&Method_SubmarineRevealSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_1B00DF4(v3, v4);
}
