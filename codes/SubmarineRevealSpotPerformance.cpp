        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C34387 & 1) == 0 )
  {
    sub_1C32C20(&SubmarineRevealSpotPerformance__Execute_d__4_TypeInfo);
    byte_4C34387 = 1;
  }
  v3 = sub_1C32E6C(SubmarineRevealSpotPerformance__Execute_d__4_TypeInfo);
...
void SubmarineRevealSpotPerformance__OnStart(SubmarineRevealSpotPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C34386 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_SubmarineRevealSpotPerformance__OnStart_b__3_0__);
    byte_4C34386 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C34388 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_SubmarineRevealSpotPerformance__Execute_b__4_0__);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C32C34(&Method_SubmarineRevealSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_1C32D48(v3, v4);
}
