        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C5370C & 1) == 0 )
  {
    sub_1C3E564(&SubmarineRevealSpotPerformance__Execute_d__4_TypeInfo);
    byte_4C5370C = 1;
  }
  v3 = sub_1C3E7B0(SubmarineRevealSpotPerformance__Execute_d__4_TypeInfo);
...
void SubmarineRevealSpotPerformance__OnStart(SubmarineRevealSpotPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C5370B & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_SubmarineRevealSpotPerformance__OnStart_b__3_0__);
    byte_4C5370B = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C5370D & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_SubmarineRevealSpotPerformance__Execute_b__4_0__);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C3E578(&Method_SubmarineRevealSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_1C3E68C(v3, v4);
}
