        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AEE7A & 1) == 0 )
  {
    sub_B52984(&SubmarineRevealSpotPerformance__Execute_d__4_TypeInfo);
    byte_42AEE7A = 1;
  }
  v3 = sub_B52A54(SubmarineRevealSpotPerformance__Execute_d__4_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AEE79 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_SubmarineRevealSpotPerformance__OnStart_b__3_0__);
    byte_42AEE79 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42ADD88 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_SubmarineRevealSpotPerformance__Execute_b__4_0__);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_B52988(&Method_SubmarineRevealSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_B52A28(v3, v4);
}
