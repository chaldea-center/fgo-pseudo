        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFCEF & 1) == 0 )
  {
    ...
    this = (EventInfoPossessionItemCounter_o *)sub_1B64870(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFCF0 & 1) == 0 )
  {
    ...
    this = (EventInfoPossessionItemCounter_o *)sub_1B64870(&StringLiteral_5636/*"EVENT_POSSESSION_ITEM_TITLE"*/, v6);
    byte_49FFCF0 = 1;
  }
  if ( entity )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFCF1 & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_5637/*"EVENT_POSSESSION_ITEM_VALUE"*/, v7);
    byte_49FFCF1 = 1;
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v14 = LocalizationManager__Get((System_String_o *)StringLiteral_5637/*"EVENT_POSSESSION_ITEM_VALUE"*/, 0LL);
