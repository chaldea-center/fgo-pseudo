        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0E2B & 1) == 0 )
  {
    ...
    this = (EventInfoPossessionItemCounter_o *)sub_B52984(&Method_EventInfoPossessionItemCounter__Initialization_b__8_0__);
    byte_42B0E2B = 1;
  }
  if ( !entity )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0E2C & 1) == 0 )
  {
    ...
    this = (EventInfoPossessionItemCounter_o *)sub_B52984(&StringLiteral_5711/*"EVENT_POSSESSION_ITEM_TITLE"*/);
    byte_42B0E2C = 1;
  }
  if ( entity )
  {
    ...
    if ( v5 )
    {
      ...
      if ( System_Int32__TryParse(v6->fields.value, &v4->fields.itemId, 0LL) )
      {
        ...
        this = (EventInfoPossessionItemCounter_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5711/*"EVENT_POSSESSION_ITEM_TITLE"*/, 0LL);
        if ( v9 )
        {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0E2D & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_5712/*"EVENT_POSSESSION_ITEM_VALUE"*/);
    byte_42B0E2D = 1;
  }
  ...
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_5712/*"EVENT_POSSESSION_ITEM_VALUE"*/, 0LL);
