        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB5D0D & 1) == 0 )
  {
    ...
    this = (EventInfoPossessionItemCounter_o *)sub_1C13D24(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB5D0E & 1) == 0 )
  {
    ...
    this = (EventInfoPossessionItemCounter_o *)sub_1C13D24(&StringLiteral_5775/*"EVENT_POINT_TOTAL_TITLE"*/, v6);
    byte_4BB5D0E = 1;
  }
  if ( entity )
  {
    ...
    if ( v7 )
    {
      ...
      if ( System_Int32__TryParse(v8->fields.value, &v4->fields.itemId, 0LL) )
      {
        ...
        this = (EventInfoPossessionItemCounter_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5775/*"EVENT_POINT_TOTAL_TITLE"*/, 0LL);
        if ( v11 )
        {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB5D0F & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_5776/*"EVENT_POINT_VS_WIN_DIALOG_GET"*/, v7);
    byte_4BB5D0F = 1;
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v14 = LocalizationManager__Get((System_String_o *)StringLiteral_5776/*"EVENT_POINT_VS_WIN_DIALOG_GET"*/, 0LL);
