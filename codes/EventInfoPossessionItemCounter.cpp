        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D31E4F & 1) == 0 )
  {
    ...
    this = (EventInfoPossessionItemCounter_o *)sub_1C93AD4(&Method_EventInfoPossessionItemCounter__Initialization_b__8_0__);
    byte_4D31E4F = 1;
  }
  if ( !entity )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D31E50 & 1) == 0 )
  {
    ...
    this = (EventInfoPossessionItemCounter_o *)sub_1C93AD4(&StringLiteral_5683/*"EVENT_POSSESSION_ITEM_TITLE"*/);
    byte_4D31E50 = 1;
  }
  if ( entity )
  {
    ...
    if ( max_length )
    {
      ...
      if ( System_Int32__TryParse(v6->fields.value, &v4->fields.itemId, 0) )
      {
        ...
        this = (EventInfoPossessionItemCounter_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5683/*"EVENT_POSSESSION_ITEM_TITLE"*/, 0);
        if ( v9 )
        {
...
void EventInfoPossessionItemCounter__UpdateDisp(EventInfoPossessionItemCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D31E51 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_5684/*"EVENT_POSSESSION_ITEM_VALUE"*/);
    byte_4D31E51 = 1;
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_5684/*"EVENT_POSSESSION_ITEM_VALUE"*/, 0);
