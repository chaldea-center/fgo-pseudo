        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F628 & 1) == 0 )
  {
    ...
    this = (EventInfoPossessionItemCounter_o *)sub_1B761C0(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F629 & 1) == 0 )
  {
    ...
    this = (EventInfoPossessionItemCounter_o *)sub_1B761C0(&StringLiteral_5661/*"EVENT_POSSESSION_ITEM_TITLE"*/, v6);
    byte_4A2F629 = 1;
  }
  if ( entity )
  {
    ...
    if ( v7 )
    {
      ...
      if ( System_Int32__TryParse(v8->fields.value, &v4->fields.itemId, 0LL) )
      {
        ...
        this = (EventInfoPossessionItemCounter_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5661/*"EVENT_POSSESSION_ITEM_TITLE"*/, 0LL);
        if ( v11 )
        {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F62A & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_5662/*"EVENT_POSSESSION_ITEM_VALUE"*/, v7);
    byte_4A2F62A = 1;
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v14 = LocalizationManager__Get((System_String_o *)StringLiteral_5662/*"EVENT_POSSESSION_ITEM_VALUE"*/, 0LL);
