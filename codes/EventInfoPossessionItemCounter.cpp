        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C4451D & 1) == 0 )
  {
    ...
    this = (EventInfoPossessionItemCounter_o *)sub_1C37058(&Method_EventInfoPossessionItemCounter__Initialization_b__8_0__);
    byte_4C4451D = 1;
  }
  if ( !entity )
    sub_1C372B4(this);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C4451E & 1) == 0 )
  {
    ...
    this = (EventInfoPossessionItemCounter_o *)sub_1C37058(&StringLiteral_5657/*"EVENT_POSSESSION_ITEM_TITLE"*/);
    byte_4C4451E = 1;
  }
  if ( entity )
  {
...
void EventInfoPossessionItemCounter__UpdateDisp(EventInfoPossessionItemCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C4451F & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_5658/*"EVENT_POSSESSION_ITEM_VALUE"*/);
    byte_4C4451F = 1;
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v8 = LocalizationManager__Get((System_String_o *)StringLiteral_5658/*"EVENT_POSSESSION_ITEM_VALUE"*/, 0);
