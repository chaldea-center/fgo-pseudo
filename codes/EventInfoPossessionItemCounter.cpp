        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4609F & 1) == 0 )
  {
    ...
    this = (EventInfoPossessionItemCounter_o *)sub_1BDB878(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B460A0 & 1) == 0 )
  {
    ...
    this = (EventInfoPossessionItemCounter_o *)sub_1BDB878(&StringLiteral_5681/*"EVENT_POSSESSION_ITEM_TITLE"*/, v6);
    byte_4B460A0 = 1;
  }
  if ( entity )
  {
    ...
    {
      if ( !(_DWORD)v7 )
        sub_1BDBADC(this, entity, method);
      v8 = entity->m_Items[0];
      if ( !v8 )
        goto LABEL_17;
      if ( System_Int32__TryParse(v8->fields.value, &v4->fields.itemId, 0LL) )
      {
        ...
        this = (EventInfoPossessionItemCounter_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5681/*"EVENT_POSSESSION_ITEM_TITLE"*/, 0LL);
        if ( v11 )
        {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B460A1 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_5682/*"EVENT_POSSESSION_ITEM_VALUE"*/, v7);
    byte_4B460A1 = 1;
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v14 = LocalizationManager__Get((System_String_o *)StringLiteral_5682/*"EVENT_POSSESSION_ITEM_VALUE"*/, 0LL);
