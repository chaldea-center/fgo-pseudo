        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C23605 & 1) == 0 )
  {
    ...
    this = (EventInfoPossessionItemCounter_o *)sub_1C3B764(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C23606 & 1) == 0 )
  {
    ...
    this = (EventInfoPossessionItemCounter_o *)sub_1C3B764(&StringLiteral_5781/*"Effect/Talk/bit_heel_portrait_get"*/, v6);
    byte_4C23606 = 1;
  }
  if ( entity )
  {
    ...
    if ( v7 )
    {
      ...
      if ( System_Int32__TryParse(v8->fields.value, &v4->fields.itemId, 0LL) )
      {
        ...
        this = (EventInfoPossessionItemCounter_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5781/*"Effect/Talk/bit_heel_portrait_get"*/, 0LL);
        if ( v11 )
        {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C23607 & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_5782/*"Effect/Talk/bit_item_get_phase{0}"*/, v7);
    byte_4C23607 = 1;
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v14 = LocalizationManager__Get((System_String_o *)StringLiteral_5782/*"Effect/Talk/bit_item_get_phase{0}"*/, 0LL);
