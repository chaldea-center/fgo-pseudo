        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC8986 & 1) == 0 )
  {
    ...
    this = (EventInfoPossessionItemCounter_o *)sub_1C713B0(&Method_EventInfoPossessionItemCounter__Initialization_b__8_0__);
    byte_4CC8986 = 1;
  }
  if ( !entity )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC8987 & 1) == 0 )
  {
    ...
    this = (EventInfoPossessionItemCounter_o *)sub_1C713B0(&StringLiteral_5650/*"EVENT_POSSESSION_ITEM_TITLE"*/);
    byte_4CC8987 = 1;
  }
  if ( entity )
  {
    ...
    if ( max_length )
    {
      ...
      if ( System_Int32__TryParse(v6->fields.value, &v4->fields.itemId, 0) )
      {
        ...
        this = (EventInfoPossessionItemCounter_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5650/*"EVENT_POSSESSION_ITEM_TITLE"*/, 0);
        if ( v9 )
        {
...
void EventInfoPossessionItemCounter__UpdateDisp(EventInfoPossessionItemCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC8988 & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_5651/*"EVENT_POSSESSION_ITEM_VALUE"*/);
    byte_4CC8988 = 1;
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_5651/*"EVENT_POSSESSION_ITEM_VALUE"*/, 0);
