void __fastcall EventInfoUIProgressControl___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB7C9B & 1) == 0 )
  {
    sub_1BAB41C(&EventInfoUIProgressControl_TypeInfo, v1);
    sub_1BAB41C(&StringLiteral_5669/*"EVENT_PROGRESS_VALUE"*/, v4);
    byte_4AB7C9B = 1;
  }
  EventInfoUIProgressControl_TypeInfo->static_fields->SAVEKEY_EVENT_PROGRESS_VALUE = (struct System_String_o *)StringLiteral_5669/*"EVENT_PROGRESS_VALUE"*/;
  sub_1BAB3C0(
    (ServantStatusBattleListViewItem_o *)EventInfoUIProgressControl_TypeInfo->static_fields,
    StringLiteral_5669/*"EVENT_PROGRESS_VALUE"*/,
    v2,
    v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB7C96 & 1) == 0 )
  {
    sub_1BAB41C(&Method_System_Collections_Generic_List_EventProgressValueEntity__Find__, *(_QWORD *)&progressValue);
    sub_1BAB41C(&System_Predicate_EventProgressValueEntity__TypeInfo, v5);
    sub_1BAB41C(&Method_EventInfoUIProgressControl___c__DisplayClass9_0__GetEntityByProgressValue_b__0__, v6);
    sub_1BAB41C(&EventInfoUIProgressControl___c__DisplayClass9_0_TypeInfo, v7);
    byte_4AB7C96 = 1;
  }
  v8 = sub_1BAB668(EventInfoUIProgressControl___c__DisplayClass9_0_TypeInfo);
  ...
  *(_DWORD *)(v8 + 16) = progressValue;
  ...
  if ( !eventProgressValueEntityList )
    return 0LL;
  v12 = (System_Predicate_object__o *)sub_1BAB668(System_Predicate_EventProgressValueEntity__TypeInfo);
  ...
  return (EventProgressValueEntity_o *)System_Collections_Generic_List_object___Find(
                                         ...
                                         (const MethodInfo_354DF24 *)Method_System_Collections_Generic_List_EventProgressValueEntity__Find__);
}
...
// local variable allocation has failed, the output may be wrong!
int32_t __fastcall EventInfoUIProgressControl__GetEventProgressValueSaveData_42436076(
        int32_t eventId,
        int32_t defaultValue,
        const MethodInfo *method)
{
  System_String_o *EventProgressValueSaveKey_42435932; // x0

  if ( (byte_4AB7C9A & 1) == 0 )
  {
    sub_1BAB41C(&EventInfoUIProgressControl_TypeInfo, *(_QWORD *)&defaultValue);
    byte_4AB7C9A = 1;
  }
  ...
  EventProgressValueSaveKey_42435932 = EventInfoUIProgressControl__GetEventProgressValueSaveKey_42435932(
                                         eventId,
                                         *(const MethodInfo **)&defaultValue);
  return UnityEngine_PlayerPrefs__GetInt(EventProgressValueSaveKey_42435932, defaultValue, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB7C98 & 1) == 0 )
  {
    this = (EventInfoUIProgressControl_o *)sub_1BAB41C(&EventInfoUIProgressControl_TypeInfo, method);
    byte_4AB7C98 = 1;
  }
  ...
  if ( !EventInfoUIProgressControl_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(EventInfoUIProgressControl_TypeInfo);
  return EventInfoUIProgressControl__GetEventProgressValueSaveKey_42435932(eventId, method);
}


System_String_o *__fastcall EventInfoUIProgressControl__GetEventProgressValueSaveKey_42435932(
        int32_t eventId,
        const MethodInfo *method)
{
  __int64 v2; // x1
  ...
  if ( (byte_4AB7C99 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_16153/*"_"*/, v2);
    byte_4AB7C99 = 1;
  }
  ...
  return System_String__Concat_62059388(SAVEKEY_EVENT_PROGRESS_VALUE, (System_String_o *)StringLiteral_16153/*"_"*/, v5, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB7C95 & 1) == 0 )
  {
    sub_1BAB41C(&System_Comparison_EventProgressValueEntity__TypeInfo, *(_QWORD *)&eventId);
    sub_1BAB41C(&CondType_TypeInfo, v5);
    sub_1BAB41C(&Method_DataManager_GetMaster_EventProgressValueMaster___, v6);
    sub_1BAB41C(&DataManager_TypeInfo, v7);
    sub_1BAB41C(&Method_System_Linq_Enumerable_Any_EventProgressValueEntity___, v8);
    sub_1BAB41C(&Method_System_Collections_Generic_List_Enumerator_EventProgressValueEntity__Dispose__, v9);
    sub_1BAB41C(&Method_System_Collections_Generic_List_Enumerator_EventProgressValueEntity__MoveNext__, v10);
    sub_1BAB41C(&Method_System_Collections_Generic_List_Enumerator_EventProgressValueEntity__get_Current__, v11);
    sub_1BAB41C(&Method_System_Collections_Generic_List_EventProgressValueEntity__GetEnumerator__, v12);
    sub_1BAB41C(&Method_System_Collections_Generic_List_EventProgressValueEntity__Sort__, v13);
    sub_1BAB41C(&Method_EventInfoUIProgressControl___c__InitEventProgressParams_b__6_0__, v14);
    sub_1BAB41C(&EventInfoUIProgressControl___c_TypeInfo, v15);
    byte_4AB7C95 = 1;
  }
  memset(&v37, 0, sizeof(v37));
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2EC5574 *)Method_DataManager_GetMaster_EventProgressValueMaster___);
  if ( !Master_object )
    goto LABEL_27;
  ...
  if ( !eventProgressValueEntityList
    || !System_Linq_Enumerable__Any_object_(
          ...
          (const MethodInfo_2ED117C *)Method_System_Linq_Enumerable_Any_EventProgressValueEntity___) )
  {
    return;
  }
  ...
  if ( !v24 )
  {
    ...
    v24 = (System_Comparison_T__o *)sub_1BAB668(System_Comparison_EventProgressValueEntity__TypeInfo);
    ...
    sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&static_fields->__9__6_0, (int32_t)v24, v27, v28);
  }
  if ( !v23
    || (System_Collections_Generic_List_object___Sort_55899008(
          v23,
          v24,
          (const MethodInfo_354F380 *)Method_System_Collections_Generic_List_EventProgressValueEntity__Sort__),
...
LABEL_27:
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    (const MethodInfo_354E3B4 *)Method_System_Collections_Generic_List_EventProgressValueEntity__GetEnumerator__);
  while ( 1 )
  {
    v29 = System_Collections_Generic_List_Enumerator_object___MoveNext(
            &v37,
            (const MethodInfo_32C4C78 *)Method_System_Collections_Generic_List_Enumerator_EventProgressValueEntity__MoveNext__);
    if ( !v29 )
      break;
  ...
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v37,
    (const MethodInfo_32C4C74 *)Method_System_Collections_Generic_List_Enumerator_EventProgressValueEntity__Dispose__);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.eventUiEntity, (int32_t)entity, (int32_t)method, v3);
  if ( !*p_eventUiEntity )
    sub_1BAB678(v6, v7);
...
bool __fastcall EventInfoUIProgressControl__IsDispEventProgress(int32_t eventId, const MethodInfo *method)
{
  ...
  if ( (byte_4AB7C97 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMaster_EventProgressValueMaster___, method);
    sub_1BAB41C(&DataManager_TypeInfo, v3);
    sub_1BAB41C(&Method_System_Linq_Enumerable_Any_EventProgressValueEntity___, v4);
    byte_4AB7C97 = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
...
void __fastcall EventInfoUIProgressControl___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB7C9C & 1) == 0 )
  {
    sub_1BAB41C(&EventInfoUIProgressControl___c_TypeInfo, v1);
    byte_4AB7C9C = 1;
  }
  v2 = (Il2CppObject *)sub_1BAB668(EventInfoUIProgressControl___c_TypeInfo);
