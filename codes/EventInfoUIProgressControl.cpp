void EventInfoUIProgressControl___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E7946B & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_5721/*"EVENT_PROGRESS_VALUE"*/);
    byte_4E7946B = 1;
  }
  EventInfoUIProgressControl_TypeInfo->static_fields->SAVEKEY_EVENT_PROGRESS_VALUE = (struct System_String_o *)StringLiteral_5721/*"EVENT_PROGRESS_VALUE"*/;
  sub_1D0F058(
    (GrandQuestFolderBoardItem_o *)EventInfoUIProgressControl_TypeInfo->static_fields,
    StringLiteral_5721/*"EVENT_PROGRESS_VALUE"*/,
    v1,
    v2,
    v3,
    v4,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E79466 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_System_Collections_Generic_List_EventProgressValueEntity__Find__);
    sub_1D0F0B4(&System_Predicate_EventProgressValueEntity__TypeInfo);
    sub_1D0F0B4(&Method_EventInfoUIProgressControl___c__DisplayClass9_0__GetEntityByProgressValue_b__0__);
    sub_1D0F0B4(&EventInfoUIProgressControl___c__DisplayClass9_0_TypeInfo);
    byte_4E79466 = 1;
  }
  v5 = sub_1D0F300(EventInfoUIProgressControl___c__DisplayClass9_0_TypeInfo);
  ...
  *(_DWORD *)(v5 + 16) = progressValue;
  ...
  if ( !eventProgressValueEntityList )
    return 0;
  v9 = (System_Predicate_object__o *)sub_1D0F300(System_Predicate_EventProgressValueEntity__TypeInfo);
  ...
  return (EventProgressValueEntity_o *)System_Collections_Generic_List_object___Find(
                                         ...
                                         (const MethodInfo_395CA78 *)Method_System_Collections_Generic_List_EventProgressValueEntity__Find__);
}
...
// local variable allocation has failed, the output may be wrong!
int32_t EventInfoUIProgressControl__GetEventProgressValueSaveData_45898252(
        int32_t eventId,
        int32_t defaultValue,
        const MethodInfo *method)
{
  System_String_o *EventProgressValueSaveKey_45898108; // x0
  ...
  EventProgressValueSaveKey_45898108 = EventInfoUIProgressControl__GetEventProgressValueSaveKey_45898108(
                                         eventId,
                                         *(const MethodInfo **)&defaultValue);
  return UnityEngine_PlayerPrefs__GetInt(EventProgressValueSaveKey_45898108, defaultValue, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E79468 & 1) == 0 )
  {
    this = (EventInfoUIProgressControl_o *)sub_1D0F0B4(&EventInfoUIProgressControl_TypeInfo);
    byte_4E79468 = 1;
  }
  ...
  if ( !EventInfoUIProgressControl_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(EventInfoUIProgressControl_TypeInfo);
  return EventInfoUIProgressControl__GetEventProgressValueSaveKey_45898108(eventId, method);
}


System_String_o *EventInfoUIProgressControl__GetEventProgressValueSaveKey_45898108(
        int32_t eventId,
        const MethodInfo *method)
{
  ...
  return System_String__Concat_65601036(SAVEKEY_EVENT_PROGRESS_VALUE, (System_String_o *)StringLiteral_16314/*"_"*/, v4, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E79465 & 1) == 0 )
  {
    sub_1D0F0B4(&System_Comparison_EventProgressValueEntity__TypeInfo);
    sub_1D0F0B4(&CondType_TypeInfo);
    sub_1D0F0B4(&Method_DataManager_GetMaster_EventProgressValueMaster___);
    sub_1D0F0B4(&DataManager_TypeInfo);
    sub_1D0F0B4(&Method_System_Linq_Enumerable_Any_EventProgressValueEntity___);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_Enumerator_EventProgressValueEntity__Dispose__);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_Enumerator_EventProgressValueEntity__MoveNext__);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_Enumerator_EventProgressValueEntity__get_Current__);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_EventProgressValueEntity__GetEnumerator__);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_EventProgressValueEntity__Sort__);
    sub_1D0F0B4(&Method_EventInfoUIProgressControl___c__InitEventProgressParams_b__6_0__);
    sub_1D0F0B4(&EventInfoUIProgressControl___c_TypeInfo);
    byte_4E79465 = 1;
  }
  memset(&v38, 0, sizeof(v38));
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_324F164 *)Method_DataManager_GetMaster_EventProgressValueMaster___);
  if ( !Master_object )
    goto LABEL_27;
  ...
  if ( !eventProgressValueEntityList
    || !System_Linq_Enumerable__Any_object_(
          ...
          (const MethodInfo_325D0AC *)Method_System_Linq_Enumerable_Any_EventProgressValueEntity___) )
  {
    return;
  }
  ...
  if ( !v17 )
  {
    ...
    v17 = (System_Comparison_T__o *)sub_1D0F300(System_Comparison_EventProgressValueEntity__TypeInfo);
    ...
    sub_1D0F058((GrandQuestFolderBoardItem_o *)&static_fields->__9__6_0, (int32_t)v17, v20, v21, v22, v23, v24, v25);
  }
  if ( !v16
    || (System_Collections_Generic_List_object___Sort_60153556(
          v16,
          v17,
          (const MethodInfo_395DED4 *)Method_System_Collections_Generic_List_EventProgressValueEntity__Sort__),
...
LABEL_27:
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    (const MethodInfo_395CF08 *)Method_System_Collections_Generic_List_EventProgressValueEntity__GetEnumerator__);
  while ( 1 )
  {
    v26 = System_Collections_Generic_List_Enumerator_object___MoveNext(
            &v38,
            (const MethodInfo_36CDF88 *)Method_System_Collections_Generic_List_Enumerator_EventProgressValueEntity__MoveNext__);
    if ( !v26 )
      break;
  ...
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v38,
    (const MethodInfo_36CDF84 *)Method_System_Collections_Generic_List_Enumerator_EventProgressValueEntity__Dispose__);
}
...
void EventInfoUIProgressControl___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1D0F300(EventInfoUIProgressControl___c_TypeInfo);
