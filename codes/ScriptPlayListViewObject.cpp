...
void ScriptPlayListViewObject__Awake(ScriptPlayListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C34FF8 & 1) == 0 )
  {
    sub_1C32C20(&Method_UnityEngine_GameObject_GetComponent_ScriptPlayListViewItemDraw___);
    byte_4C34FF8 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_3134970 *)Method_UnityEngine_GameObject_GetComponent_ScriptPlayListViewItemDraw___);
  ...
  if ( !DragObject
    || (v4 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_3134970 *)Method_UnityEngine_GameObject_GetComponent_ScriptPlayListViewObject___)) == 0) )
  {
    sub_1C32E7C(DragObject);
  }
  ScriptPlayListViewObject__Init_37373808((ScriptPlayListViewObject_o *)DragObject, 2, v5);
  return v4;
}
...
void ScriptPlayListViewObject__Init_37373808(
        ScriptPlayListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void ScriptPlayListViewObject__Init_37375028(
        ScriptPlayListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void ScriptPlayListViewObject__Init_37375112(
        ScriptPlayListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void ScriptPlayListViewObject__Start(ScriptPlayListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    ScriptPlayListViewObject__Init_37373808(this, 2, v2);
}
