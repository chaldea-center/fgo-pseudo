...
void ScriptPlayListViewObject__Awake(ScriptPlayListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D29E3A & 1) == 0 )
  {
    sub_1C94098(&Method_UnityEngine_GameObject_GetComponent_ScriptPlayListViewItemDraw___);
    byte_4D29E3A = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_31F4790 *)Method_UnityEngine_GameObject_GetComponent_ScriptPlayListViewItemDraw___);
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_31F4790 *)Method_UnityEngine_GameObject_GetComponent_ScriptPlayListViewObject___)) == 0) )
  {
    sub_1C942F0(DragObject, v4);
  }
  ScriptPlayListViewObject__Init_38197212((ScriptPlayListViewObject_o *)DragObject, 2, v6);
  return v5;
}
...
void ScriptPlayListViewObject__Init_38197212(
        ScriptPlayListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void ScriptPlayListViewObject__Init_38198432(
        ScriptPlayListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void ScriptPlayListViewObject__Init_38198516(
        ScriptPlayListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void ScriptPlayListViewObject__Start(ScriptPlayListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    ScriptPlayListViewObject__Init_38197212(this, 2, v2);
}
