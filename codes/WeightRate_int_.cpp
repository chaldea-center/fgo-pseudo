void WeightRate_int____ctor(WeightRate_int__o *this, const MethodInfo_3C08A5C *method)
{
  System_Object___ctor((Il2CppObject *)this, 0);
}


bool WeightRate_int___HasWeight(WeightRate_int__o *this, int32_t t, const MethodInfo_3C0825C *method)
{
  ...
  if ( (*(_BYTE *)(_20_WeightRate___c__DisplayClass5_0_T___ctor + 309) & 1) == 0 )
    _20_WeightRate___c__DisplayClass5_0_T___ctor = sub_1C47444();
  v7 = sub_1C715FC(_20_WeightRate___c__DisplayClass5_0_T___ctor);
  WeightRate___c__DisplayClass5_0_int____ctor(
    (WeightRate___c__DisplayClass5_0_T__o *)v7,
    (const MethodInfo_3320138 *)method->klass->rgctx_data->_21_WeightRate___c__DisplayClass5_0_T___HasWeight_b__0);
  if ( !v7 )
    sub_1C71608(v8, v9);
  *(_DWORD *)(v7 + 16) = t;
  ...
  if ( (*(_BYTE *)(_23_System_Func_WeightRate_WeightSeed_T___bool___ctor + 309) & 1) == 0 )
    _23_System_Func_WeightRate_WeightSeed_T___bool___ctor = sub_1C47444();
  v12 = (System_Func_object__bool__o *)sub_1C715FC(_23_System_Func_WeightRate_WeightSeed_T___bool___ctor);
  System_Func_object__bool____ctor(
    v12,
    (Il2CppObject *)v7,
    (intptr_t)method->klass->rgctx_data->_22_System_Func_WeightRate_WeightSeed_T___bool_,
    (const MethodInfo_36A3EB4 *)method->klass->rgctx_data->_24_BasicHelper_Any_WeightRate_WeightSeed_T__);
  return BasicHelper__Any_object_(
           list,
           (System_Func_T__bool__o *)v12,
           (const MethodInfo_31341D4 *)method->klass->rgctx_data->_25_System_Collections_Generic_List_WeightRate_WeightSeed_T___get_Count);
}


void WeightRate_int___ReverseWeight(WeightRate_int__o *this, const MethodInfo_3C087D8 *method)
{
  ...
  if ( (*(_BYTE *)(_1_System_Collections_Generic_List_WeightRate_WeightSeed_T + 309) & 1) == 0 )
    _1_System_Collections_Generic_List_WeightRate_WeightSeed_T = sub_1C47444();
  v5 = (System_Collections_Generic_List_object__o *)sub_1C715FC(_1_System_Collections_Generic_List_WeightRate_WeightSeed_T);
  System_Collections_Generic_List_object____ctor(
    v5,
    (const MethodInfo_380FEE4 *)method->klass->rgctx_data->_2_System_Collections_Generic_List_WeightRate_WeightSeed_T____ctor);
  ...
  if ( !list
    || (list = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___ToArray(
                                                              list,
                                                              (const MethodInfo_3812270 *)method->klass->rgctx_data->_32_WeightRate_WeightSeed_T___),
        !v5) )
  {
LABEL_34:
    sub_1C71608(list, v6);
  ...
  System_Collections_Generic_List_object___AddRange(
    ...
    (const MethodInfo_3810924 *)method->klass->rgctx_data->_34_WeightRate___c_T_);
  ...
  if ( (*(_BYTE *)(_37_WeightRate___c_T___ReverseWeight_b__12_0 + 309) & 1) == 0 )
    _37_WeightRate___c_T___ReverseWeight_b__12_0 = sub_1C47444();
  ...
  if ( !v10 )
  {
    ...
    if ( (*(_BYTE *)(_36_WeightRate___c_T + 309) & 1) == 0 )
      _36_WeightRate___c_T = sub_1C47444();
    v10 = (System_Comparison_T__o *)sub_1C715FC(_36_WeightRate___c_T);
    System_Comparison_object____ctor(
      v10,
      v15,
      (intptr_t)method->klass->rgctx_data->_38_System_Comparison_WeightRate_WeightSeed_T____ctor,
      (const MethodInfo_33DF8F4 *)method->klass->rgctx_data->_39_System_Collections_Generic_List_WeightRate_WeightSeed_T___Sort);
  ...
  System_Collections_Generic_List_object___Sort_58794460(
    v5,
    v10,
    (const MethodInfo_38121DC *)method->klass->rgctx_data[1]._0_WeightRate_T_);
  ...
  if ( size >= 1 )
  {
    ...
    do
    {
      ...
      list = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___get_Item(
                                                            v5,
                                                            v26,
                                                            (const MethodInfo_3810448 *)method->klass->rgctx_data->_27_System_Activator_CreateInstance_T_);
      if ( !list )
        goto LABEL_34;
...
void WeightRate_int___SetAdjust(WeightRate_int__o *this, const MethodInfo_3C0834C *method)
{
  System_Collections_Generic_List_object__o *list; // x0
  int32_t v5; // w22
  int32_t v6; // w21
...
bool WeightRate_int___checkWeight(WeightRate_int__o *this, const MethodInfo_3C08324 *method)
{
  return this->fields.totalweight > 0;
}


int32_t WeightRate_int___getCount(WeightRate_int__o *this, const MethodInfo_3C08334 *method)
{
...
int32_t WeightRate_int___getData(WeightRate_int__o *this, int32_t keywieght, const MethodInfo_3C083EC *method)
{
  ...
  *(_QWORD *)&v14.fields._index = 0;
  ...
  Instance_int = System_Activator__CreateInstance_int_((const MethodInfo_3096B84 *)method->klass->rgctx_data->_28_System_Collections_Generic_List_WeightRate_WeightSeed_T____ctor);
  list = (System_Collections_Generic_List_object__o *)this->fields.list;
  if ( !list )
    sub_1C71608(Instance_int, v8);
  klass_high = Instance_int;
  System_Collections_Generic_List_object___GetEnumerator(
    (System_Collections_Generic_List_Enumerator_T__o *)&v14,
    list,
    (const MethodInfo_3811210 *)method->klass->rgctx_data->_13_System_Collections_Generic_List_WeightRate_WeightSeed_T___GetEnumerator);
  do
  {
    v11 = System_Collections_Generic_List_Enumerator_object___MoveNext(
            &v14,
            (const MethodInfo_35962C8 *)method->klass->rgctx_data->_17_System_Collections_Generic_List_Enumerator_WeightRate_WeightSeed_T___MoveNext);
    if ( !v11 )
      break;
  ...
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v14,
    (const MethodInfo_35962C4 *)method->klass->rgctx_data->_19_WeightRate___c__DisplayClass5_0_T_);
  return klass_high;
}


int32_t WeightRate_int___getData_62948628(
        WeightRate_int__o *this,
        int32_t keyWeight,
        int32_t skipValue,
        const MethodInfo_3C08514 *method)
{
  ...
  if ( (*(_BYTE *)(_1_System_Collections_Generic_List_WeightRate_WeightSeed_T + 309) & 1) == 0 )
    _1_System_Collections_Generic_List_WeightRate_WeightSeed_T = sub_1C47444();
  v13 = (System_Collections_Generic_List_object__o *)sub_1C715FC(_1_System_Collections_Generic_List_WeightRate_WeightSeed_T);
  System_Collections_Generic_List_object____ctor_58785804(
    v13,
    list,
    (const MethodInfo_381000C *)method->klass->rgctx_data->_29_System_Collections_Generic_IEnumerable_WeightRate_WeightSeed_T__);
  if ( !v13 )
    sub_1C71608(v14, v15);
  System_Collections_Generic_List_object___GetEnumerator(
  ...
  while ( 1 )
  {
    ...
    if ( System_Object__Equals_65880964(v21, v22, 0) )
    {
      System_Collections_Generic_List_object___Remove(
        v13,
        current,
        (const MethodInfo_3811C40 *)method->klass->rgctx_data->_31_System_Collections_Generic_List_WeightRate_WeightSeed_T___ToArray);
      break;
    }
  }
  System_Collections_Generic_List_Enumerator_object___Dispose(
...
int32_t WeightRate_int___getTotalWeight(WeightRate_int__o *this, const MethodInfo_3C0831C *method)
{
  return this->fields.totalweight;
}


void WeightRate_int___removeWeight(WeightRate_int__o *this, int32_t t, const MethodInfo_3C080B0 *method)
{
  ...
  if ( (*(_BYTE *)(_7_WeightRate___c__DisplayClass4_0_T + 309) & 1) == 0 )
    _7_WeightRate___c__DisplayClass4_0_T = sub_1C47444();
  v7 = sub_1C715FC(_7_WeightRate___c__DisplayClass4_0_T);
  WeightRate___c__DisplayClass4_0_int____ctor(
    (WeightRate___c__DisplayClass4_0_T__o *)v7,
    (const MethodInfo_331E64C *)method->klass->rgctx_data->_8_WeightRate___c__DisplayClass4_0_T___ctor);
  if ( !v7 )
    goto LABEL_14;
  *(_DWORD *)(v7 + 16) = t;
  list = (System_Collections_Generic_List_object__o *)this->fields.list;
  ...
  if ( (*(_BYTE *)(_10_System_Predicate_WeightRate_WeightSeed_T + 309) & 1) == 0 )
    _10_System_Predicate_WeightRate_WeightSeed_T = sub_1C47444();
  v12 = (System_Predicate_object__o *)sub_1C715FC(_10_System_Predicate_WeightRate_WeightSeed_T);
  System_Predicate_object____ctor(
    v12,
    (Il2CppObject *)v7,
    (intptr_t)method->klass->rgctx_data->_9_WeightRate___c__DisplayClass4_0_T___removeWeight_b__0,
    (const MethodInfo_39AE178 *)method->klass->rgctx_data->_11_System_Predicate_WeightRate_WeightSeed_T____ctor);
  if ( !list
    || (System_Collections_Generic_List_object___RemoveAll(
          list,
          (System_Predicate_T__o *)v12,
          (const MethodInfo_3811D74 *)method->klass->rgctx_data->_12_System_Collections_Generic_List_WeightRate_WeightSeed_T___RemoveAll),
...
void WeightRate_int___setWeight(WeightRate_int__o *this, int32_t weight, int32_t t, const MethodInfo_3C07F78 *method)
{
  ...
  else
  {
    ...
    if ( (*(_BYTE *)(_1_System_Collections_Generic_List_WeightRate_WeightSeed_T + 309) & 1) == 0 )
      _1_System_Collections_Generic_List_WeightRate_WeightSeed_T = sub_1C47444();
    v12 = (System_Collections_Generic_List_object__o *)sub_1C715FC(_1_System_Collections_Generic_List_WeightRate_WeightSeed_T);
    System_Collections_Generic_List_object____ctor(
      v12,
      (const MethodInfo_380FEE4 *)method->klass->rgctx_data->_2_System_Collections_Generic_List_WeightRate_WeightSeed_T____ctor);
    p_fields->klass = (GrandQuestFolderBoardItem_c *)v12;
    sub_1C71354(p_fields, (int32_t)v12, v13, v14, v15, v16, v17, v18);
  ...
  if ( (*(_BYTE *)(_4_WeightRate_WeightSeed_T + 309) & 1) == 0 )
    _4_WeightRate_WeightSeed_T = sub_1C47444();
  v20 = sub_1C715FC(_4_WeightRate_WeightSeed_T);
  ...
  *(_DWORD *)(v20 + 20) = t;
  ...
  if ( (unsigned int)size >= LODWORD(items->max_length) )
  {
    System_Collections_Generic_List_object___AddWithResize(
      list,
      (Il2CppObject *)v20,
      (const MethodInfo_3810718 *)_6_System_Collections_Generic_List_WeightRate_WeightSeed_T___Add->klass->rgctx_data[14].rgctxDataDummy);
  }
  else
  {
    ...
    sub_1C71354((GrandQuestFolderBoardItem_o *)(v32 + 4), v20, v23, v24, v25, v26, v27, v28);
  }
}