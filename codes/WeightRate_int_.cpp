void __fastcall WeightRate_int____ctor(WeightRate_int__o *this, const MethodInfo_3AB9154 *method)
{
  System_Object___ctor((Il2CppObject *)this, 0LL);
}


bool __fastcall WeightRate_int___HasWeight(WeightRate_int__o *this, int32_t t, const MethodInfo_3AB8954 *method)
{
  ...
  if ( (*(_BYTE *)(_20_WeightRate___c__DisplayClass5_0_T___ctor + 309) & 1) == 0 )
    _20_WeightRate___c__DisplayClass5_0_T___ctor = sub_1C2BF08();
  v7 = sub_1BDBAC4(_20_WeightRate___c__DisplayClass5_0_T___ctor);
  WeightRate___c__DisplayClass5_0_int____ctor(
    (WeightRate___c__DisplayClass5_0_T__o *)v7,
    (const MethodInfo_32035A0 *)method->klass->rgctx_data->_21_WeightRate___c__DisplayClass5_0_T___HasWeight_b__0);
  if ( !v7 )
    sub_1BDBAD4(v8, v9);
  *(_DWORD *)(v7 + 16) = t;
  ...
  if ( (*(_BYTE *)(_23_System_Func_WeightRate_WeightSeed_T___bool___ctor + 309) & 1) == 0 )
    _23_System_Func_WeightRate_WeightSeed_T___bool___ctor = sub_1C2BF08();
  v12 = (System_Func_object__bool__o *)sub_1BDBAC4(_23_System_Func_WeightRate_WeightSeed_T___bool___ctor);
  System_Func_object__bool____ctor(
    v12,
    (Il2CppObject *)v7,
    (intptr_t)method->klass->rgctx_data->_22_System_Func_WeightRate_WeightSeed_T___bool_,
    (const MethodInfo_35727BC *)method->klass->rgctx_data->_24_BasicHelper_Any_WeightRate_WeightSeed_T__);
  return BasicHelper__Any_object_(
           list,
           (System_Func_T__bool__o *)v12,
           (const MethodInfo_301CDFC *)method->klass->rgctx_data->_25_System_Collections_Generic_List_WeightRate_WeightSeed_T___get_Count);
}


void __fastcall WeightRate_int___ReverseWeight(WeightRate_int__o *this, const MethodInfo_3AB8ED0 *method)
{
  ...
  if ( (*(_BYTE *)(_1_System_Collections_Generic_List_WeightRate_WeightSeed_T + 309) & 1) == 0 )
    _1_System_Collections_Generic_List_WeightRate_WeightSeed_T = sub_1C2BF08();
  v5 = (System_Collections_Generic_List_object__o *)sub_1BDBAC4(_1_System_Collections_Generic_List_WeightRate_WeightSeed_T);
  System_Collections_Generic_List_object____ctor(
    v5,
    (const MethodInfo_36D5590 *)method->klass->rgctx_data->_2_System_Collections_Generic_List_WeightRate_WeightSeed_T____ctor);
  ...
  if ( !list
    || (list = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___ToArray(
                                                              list,
                                                              (const MethodInfo_36D791C *)method->klass->rgctx_data->_32_WeightRate_WeightSeed_T___),
        !v5) )
  {
LABEL_34:
    sub_1BDBAD4(list, v6);
  ...
  System_Collections_Generic_List_object___AddRange(
    ...
    (const MethodInfo_36D5FD0 *)method->klass->rgctx_data->_34_WeightRate___c_T_);
  ...
  if ( (*(_BYTE *)(_37_WeightRate___c_T___ReverseWeight_b__12_0 + 309) & 1) == 0 )
    _37_WeightRate___c_T___ReverseWeight_b__12_0 = sub_1C2BF08();
  ...
  if ( !v10 )
  {
    ...
    if ( (*(_BYTE *)(_36_WeightRate___c_T + 309) & 1) == 0 )
      _36_WeightRate___c_T = sub_1C2BF08();
    v10 = (System_Comparison_T__o *)sub_1BDBAC4(_36_WeightRate___c_T);
    System_Comparison_object____ctor(
      v10,
      v15,
      (intptr_t)method->klass->rgctx_data->_38_System_Comparison_WeightRate_WeightSeed_T____ctor,
      (const MethodInfo_32B8AF8 *)method->klass->rgctx_data->_39_System_Collections_Generic_List_WeightRate_WeightSeed_T___Sort);
    ...
    *(_QWORD *)(*(_QWORD *)(v19 + 184) + 8LL) = v10;
    ...
    if ( (*(_BYTE *)(v20 + 309) & 1) == 0 )
      v20 = sub_1C2BF08();
    sub_1BDB81C((CGThumbnailListItem_o *)(*(_QWORD *)(v20 + 184) + 8LL), (int32_t)v10, v16, v17);
  }
  System_Collections_Generic_List_object___Sort_57505928(
    v5,
    v10,
    (const MethodInfo_36D7888 *)method->klass->rgctx_data[1]._0_WeightRate_T_);
  ...
  if ( size >= 1 )
  {
    ...
    do
    {
      ...
      list = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___get_Item(
                                                            v5,
                                                            v22,
                                                            (const MethodInfo_36D5AF4 *)method->klass->rgctx_data->_27_System_Activator_CreateInstance_T_);
      if ( !list )
        goto LABEL_34;
...
void __fastcall WeightRate_int___SetAdjust(WeightRate_int__o *this, const MethodInfo_3AB8A44 *method)
{
  System_Collections_Generic_List_object__o *list; // x0
  int32_t v5; // w22
  int32_t v6; // w21
...
bool __fastcall WeightRate_int___checkWeight(WeightRate_int__o *this, const MethodInfo_3AB8A1C *method)
{
  return this->fields.totalweight > 0;
}


int32_t __fastcall WeightRate_int___getCount(WeightRate_int__o *this, const MethodInfo_3AB8A2C *method)
{
...
int32_t __fastcall WeightRate_int___getData(
        ...
        int32_t keywieght,
        const MethodInfo_3AB8AE4 *method)
{
  ...
  *(_QWORD *)&v14.fields._index = 0LL;
  ...
  Instance_int = System_Activator__CreateInstance_int_((const MethodInfo_2F83E48 *)method->klass->rgctx_data->_28_System_Collections_Generic_List_WeightRate_WeightSeed_T____ctor);
  list = (System_Collections_Generic_List_object__o *)this->fields.list;
  if ( !list )
    sub_1BDBAD4(Instance_int, v8);
  klass_high = Instance_int;
  System_Collections_Generic_List_object___GetEnumerator(
    (System_Collections_Generic_List_Enumerator_T__o *)&v14,
    list,
    (const MethodInfo_36D68BC *)method->klass->rgctx_data->_13_System_Collections_Generic_List_WeightRate_WeightSeed_T___GetEnumerator);
  do
  {
    v11 = System_Collections_Generic_List_Enumerator_object___MoveNext(
            &v14,
            (const MethodInfo_346A2A4 *)method->klass->rgctx_data->_17_System_Collections_Generic_List_Enumerator_WeightRate_WeightSeed_T___MoveNext);
    if ( !v11 )
      break;
  ...
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v14,
    (const MethodInfo_346A2A0 *)method->klass->rgctx_data->_19_WeightRate___c__DisplayClass5_0_T_);
  return klass_high;
}


int32_t __fastcall WeightRate_int___getData_61574156(
        WeightRate_int__o *this,
        int32_t keyWeight,
        int32_t skipValue,
        const MethodInfo_3AB8C0C *method)
{
  ...
  if ( (*(_BYTE *)(_1_System_Collections_Generic_List_WeightRate_WeightSeed_T + 309) & 1) == 0 )
    _1_System_Collections_Generic_List_WeightRate_WeightSeed_T = sub_1C2BF08();
  v13 = (System_Collections_Generic_List_object__o *)sub_1BDBAC4(_1_System_Collections_Generic_List_WeightRate_WeightSeed_T);
  System_Collections_Generic_List_object____ctor_57497272(
    v13,
    list,
    (const MethodInfo_36D56B8 *)method->klass->rgctx_data->_29_System_Collections_Generic_IEnumerable_WeightRate_WeightSeed_T__);
  if ( !v13 )
    sub_1BDBAD4(v14, v15);
  System_Collections_Generic_List_object___GetEnumerator(
  ...
  while ( 1 )
  {
    ...
    if ( System_Object__Equals_64428392(v21, v22, 0LL) )
    {
      System_Collections_Generic_List_object___Remove(
        v13,
        current,
        (const MethodInfo_36D72EC *)method->klass->rgctx_data->_31_System_Collections_Generic_List_WeightRate_WeightSeed_T___ToArray);
      break;
    }
  }
  System_Collections_Generic_List_Enumerator_object___Dispose(
...
int32_t __fastcall WeightRate_int___getTotalWeight(WeightRate_int__o *this, const MethodInfo_3AB8A14 *method)
{
  return this->fields.totalweight;
}


void __fastcall WeightRate_int___removeWeight(WeightRate_int__o *this, int32_t t, const MethodInfo_3AB87A8 *method)
{
  ...
  if ( (*(_BYTE *)(_7_WeightRate___c__DisplayClass4_0_T + 309) & 1) == 0 )
    _7_WeightRate___c__DisplayClass4_0_T = sub_1C2BF08();
  v7 = sub_1BDBAC4(_7_WeightRate___c__DisplayClass4_0_T);
  WeightRate___c__DisplayClass4_0_int____ctor(
    (WeightRate___c__DisplayClass4_0_T__o *)v7,
    (const MethodInfo_3201B3C *)method->klass->rgctx_data->_8_WeightRate___c__DisplayClass4_0_T___ctor);
  if ( !v7 )
    goto LABEL_14;
  *(_DWORD *)(v7 + 16) = t;
  list = (System_Collections_Generic_List_object__o *)this->fields.list;
  ...
  if ( (*(_BYTE *)(_10_System_Predicate_WeightRate_WeightSeed_T + 309) & 1) == 0 )
    _10_System_Predicate_WeightRate_WeightSeed_T = sub_1C2BF08();
  v12 = (System_Predicate_object__o *)sub_1BDBAC4(_10_System_Predicate_WeightRate_WeightSeed_T);
  System_Predicate_object____ctor(
    v12,
    (Il2CppObject *)v7,
    (intptr_t)method->klass->rgctx_data->_9_WeightRate___c__DisplayClass4_0_T___removeWeight_b__0,
    (const MethodInfo_383E3B8 *)method->klass->rgctx_data->_11_System_Predicate_WeightRate_WeightSeed_T____ctor);
  if ( !list
    || (System_Collections_Generic_List_object___RemoveAll(
          list,
          (System_Predicate_T__o *)v12,
          (const MethodInfo_36D7420 *)method->klass->rgctx_data->_12_System_Collections_Generic_List_WeightRate_WeightSeed_T___RemoveAll),
...
void __fastcall WeightRate_int___setWeight(
        ...
        int32_t weight,
        int32_t t,
        const MethodInfo_3AB8670 *method)
{
  ...
  else
  {
    ...
    if ( (*(_BYTE *)(_1_System_Collections_Generic_List_WeightRate_WeightSeed_T + 309) & 1) == 0 )
      _1_System_Collections_Generic_List_WeightRate_WeightSeed_T = sub_1C2BF08();
    v12 = (System_Collections_Generic_List_object__o *)sub_1BDBAC4(_1_System_Collections_Generic_List_WeightRate_WeightSeed_T);
    System_Collections_Generic_List_object____ctor(
      v12,
      (const MethodInfo_36D5590 *)method->klass->rgctx_data->_2_System_Collections_Generic_List_WeightRate_WeightSeed_T____ctor);
    p_fields->klass = (CGThumbnailListItem_c *)v12;
    sub_1BDB81C(p_fields, (int32_t)v12, v13, v14);
  ...
  if ( (*(_BYTE *)(_4_WeightRate_WeightSeed_T + 309) & 1) == 0 )
    _4_WeightRate_WeightSeed_T = sub_1C2BF08();
  v16 = sub_1BDBAC4(_4_WeightRate_WeightSeed_T);
  ...
  *(_DWORD *)(v16 + 20) = t;
  ...
  if ( (unsigned int)size >= items->max_length )
  {
    System_Collections_Generic_List_object___AddWithResize(
      list,
      (Il2CppObject *)v16,
      (const MethodInfo_36D5DC4 *)_6_System_Collections_Generic_List_WeightRate_WeightSeed_T___Add->klass->rgctx_data[14].rgctxDataDummy);
  }
  else
  {
    ...
    sub_1BDB81C((CGThumbnailListItem_o *)(v24 + 4), v16, v19, v20);
  }
}