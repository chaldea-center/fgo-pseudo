void __fastcall WeightRate_int____ctor(WeightRate_int__o *this, const MethodInfo_2BF9C18 *method)
{
  if ( !this )
...
void __fastcall WeightRate_int___ReverseWeight(WeightRate_int__o *this, const MethodInfo_2BF98AC *method)
{
...
void __fastcall WeightRate_int___SetAdjust(WeightRate_int__o *this, const MethodInfo_2BF91A0 *method)
{
  struct System_Collections_Generic_List_WeightRate_WeightSeed_T___o *list; // x0
  int32_t v5; // w22
  unsigned int v6; // w21
...
bool __fastcall WeightRate_int___checkWeight(WeightRate_int__o *this, const MethodInfo_2BF9170 *method)
{
  return this->fields.totalweight > 0;
}


int32_t __fastcall WeightRate_int___getCount(WeightRate_int__o *this, const MethodInfo_2BF9180 *method)
{
  struct System_Collections_Generic_List_WeightRate_WeightSeed_T___o *list; // x0
...
int32_t __fastcall WeightRate_int___getData(
        ...
        int32_t keywieght,
        const MethodInfo_2BF9264 *method)
{
  __int64 v3; // x3
...
int32_t __fastcall WeightRate_int___getData_46109808(
        WeightRate_int__o *this,
        int32_t keyWeight,
        int32_t skipValue,
        const MethodInfo_2BF9470 *method)
{
  ...
  if ( (byte_42F5716 & 1) == 0 )
  {
    sub_B5D5C4(&System_IDisposable_TypeInfo, keyWeight, skipValue, method);
    byte_42F5716 = 1;
  }
  ...
  while ( 1 )
  {
    ...
    if ( (BYTE2(v24->vtable[0].methodPtr) & 1) == 0 )
      sub_AF52C4(method->klass->rgctx_data->_19_T);
    v25 = (Il2CppObject *)j_il2cpp_value_box_0(v24, &v49);
    if ( System_Object__Equals_42368740(v23, v25, 0LL) )
    {
  ...
  {
LABEL_21:
    p_method = sub_AF54C0(&v44, System_IDisposable_TypeInfo, 0LL, v18);
  }
...
LABEL_31:
  ...
  {
LABEL_37:
    v41 = sub_AF54C0(&v44, System_IDisposable_TypeInfo, 0LL, v35);
  }
...
int32_t __fastcall WeightRate_int___getTotalWeight(WeightRate_int__o *this, const MethodInfo_2BF9168 *method)
{
  return this->fields.totalweight;
}


void __fastcall WeightRate_int___removeWeight(WeightRate_int__o *this, int32_t t, const MethodInfo_2BF8EFC *method)
{
  __int64 v3; // x3
  ...
  if ( (byte_42F5714 & 1) == 0 )
  {
    sub_B5D5C4(&System_IDisposable_TypeInfo, t, (_DWORD)method, v3);
    byte_42F5714 = 1;
  }
  memset(&i, 0, sizeof(i));
  HIDWORD(v24) = 0;
  ...
  *(_DWORD *)(v8 + 16) = t;
  ...
  v13 = sub_B5D694(_8_System_Predicate_WeightRate_WeightSeed_T);
...
LABEL_26:
  ...
  v14 = 0;
  for ( i = v22; ; v14 += LODWORD(i.fields.current[1].klass) )
  {
  ...
  {
LABEL_20:
    p_method = sub_AF54C0(&v22, System_IDisposable_TypeInfo, 0LL, v17);
  }
...
void __fastcall WeightRate_int___setWeight(
        ...
        int32_t weight,
        int32_t t,
        const MethodInfo_2BF8DE0 *method)
{
  ...
  else
  {
    ...
    sub_B5D560(p_fields, (System_Int32_array **)v13, v14, v15, v16, v17, v18, v19);
