void __fastcall WeightRate_int____ctor(WeightRate_int__o *this, const MethodInfo_388EB70 *method)
{
  System_Object___ctor((Il2CppObject *)this, 0LL);
}


void __fastcall WeightRate_int___ReverseWeight(WeightRate_int__o *this, const MethodInfo_388E8EC *method)
{
  ...
  if ( (BYTE5(_1_System_Collections_Generic_List_WeightRate_WeightSeed_T->vtable[0].methodPtr) & 1) == 0 )
    _1_System_Collections_Generic_List_WeightRate_WeightSeed_T = (Il2CppClass *)sub_1BB674C(method->klass->rgctx_data->_1_System_Collections_Generic_List_WeightRate_WeightSeed_T__);
  v5 = (System_Collections_Generic_List_object__o *)sub_1B64ABC(_1_System_Collections_Generic_List_WeightRate_WeightSeed_T);
  System_Collections_Generic_List_object____ctor(
    v5,
    (const MethodInfo_34AF17C *)method->klass->rgctx_data->_2_System_Collections_Generic_List_WeightRate_WeightSeed_T____ctor);
  ...
  if ( !list
    || (list = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___ToArray(
                                                              list,
                                                              (const MethodInfo_34B15A8 *)method->klass->rgctx_data->_26_WeightRate_WeightSeed_T___),
        !v5) )
  {
LABEL_34:
    sub_1B64ACC(list, v6);
  ...
  System_Collections_Generic_List_object___AddRange(
    ...
    (const MethodInfo_34AFBBC *)method->klass->rgctx_data->_28_WeightRate___c_T_);
  ...
  if ( (BYTE5(_31_WeightRate___c_T___ReverseWeight_b__11_0[3].return_type) & 1) == 0 )
    _31_WeightRate___c_T___ReverseWeight_b__11_0 = (MethodInfo *)sub_1BB674C(_31_WeightRate___c_T___ReverseWeight_b__11_0);
  ...
  if ( !v10 )
  {
    ...
    if ( (BYTE5(v11[3].return_type) & 1) == 0 )
      v11 = (MethodInfo *)sub_1BB674C(v11);
    ...
    if ( (*(_BYTE *)(_30_WeightRate___c_T + 309) & 1) == 0 )
      _30_WeightRate___c_T = sub_1BB674C(_30_WeightRate___c_T);
    v10 = (System_Comparison_T__o *)sub_1B64ABC(_30_WeightRate___c_T);
    System_Comparison_object____ctor(
      v10,
      v15,
      (intptr_t)method->klass->rgctx_data->_32_System_Comparison_WeightRate_WeightSeed_T____ctor,
      (const MethodInfo_30ADC2C *)method->klass->rgctx_data->_33_System_Collections_Generic_List_WeightRate_WeightSeed_T___Sort);
    ...
    *(_QWORD *)(*(_QWORD *)(v19 + 184) + 8LL) = v10;
    ...
    if ( (*(_BYTE *)(v20 + 309) & 1) == 0 )
      v20 = sub_1BB674C(v20);
    sub_1B64814((ServantStatusBattleListViewItem_o *)(*(_QWORD *)(v20 + 184) + 8LL), (int32_t)v10, v16, v17);
  }
  System_Collections_Generic_List_object___Sort_55252244(
    v5,
    v10,
    (const MethodInfo_34B1514 *)method->klass->rgctx_data[1]._0_WeightRate_T_);
  ...
  if ( size >= 1 )
  {
    ...
    do
    {
      ...
      list = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___get_Item(
                                                            v5,
                                                            v22,
                                                            (const MethodInfo_34AF6E0 *)method->klass->rgctx_data->_21_System_Activator_CreateInstance_T_);
      if ( !list )
        goto LABEL_34;
...
void __fastcall WeightRate_int___SetAdjust(WeightRate_int__o *this, const MethodInfo_388E460 *method)
{
  System_Collections_Generic_List_object__o *list; // x0
  int32_t v5; // w22
  int32_t v6; // w21
...
bool __fastcall WeightRate_int___checkWeight(WeightRate_int__o *this, const MethodInfo_388E438 *method)
{
  return this->fields.totalweight > 0;
}


int32_t __fastcall WeightRate_int___getCount(WeightRate_int__o *this, const MethodInfo_388E448 *method)
{
...
int32_t __fastcall WeightRate_int___getData(
        ...
        int32_t keywieght,
        const MethodInfo_388E500 *method)
{
  ...
  *(_QWORD *)&v14.fields._index = 0LL;
  ...
  Instance_int = System_Activator__CreateInstance_int_((const MethodInfo_2D93A48 *)method->klass->rgctx_data->_22_System_Collections_Generic_List_WeightRate_WeightSeed_T____ctor);
  list = (System_Collections_Generic_List_object__o *)this->fields.list;
  if ( !list )
    sub_1B64ACC(Instance_int, v8);
  klass_high = Instance_int;
  System_Collections_Generic_List_object___GetEnumerator(
    (System_Collections_Generic_List_Enumerator_T__o *)&v14,
    list,
    (const MethodInfo_34B0548 *)method->klass->rgctx_data->_13_System_Collections_Generic_List_WeightRate_WeightSeed_T___GetEnumerator);
  do
  {
    v11 = System_Collections_Generic_List_Enumerator_object___MoveNext(
            &v14,
            (const MethodInfo_322C38C *)method->klass->rgctx_data->_17_System_Collections_Generic_List_Enumerator_WeightRate_WeightSeed_T___MoveNext);
    if ( !v11 )
      break;
  ...
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v14,
    (const MethodInfo_322C388 *)method->klass->rgctx_data->_19_System_Collections_Generic_List_WeightRate_WeightSeed_T___get_Count);
  return klass_high;
}


int32_t __fastcall WeightRate_int___getData_59303464(
        WeightRate_int__o *this,
        int32_t keyWeight,
        int32_t skipValue,
        const MethodInfo_388E628 *method)
{
  ...
  if ( (BYTE5(_1_System_Collections_Generic_List_WeightRate_WeightSeed_T->vtable[0].methodPtr) & 1) == 0 )
    _1_System_Collections_Generic_List_WeightRate_WeightSeed_T = (Il2CppClass *)sub_1BB674C(method->klass->rgctx_data->_1_System_Collections_Generic_List_WeightRate_WeightSeed_T__);
  v13 = (System_Collections_Generic_List_object__o *)sub_1B64ABC(_1_System_Collections_Generic_List_WeightRate_WeightSeed_T);
  System_Collections_Generic_List_object____ctor_55243428(
    v13,
    list,
    (const MethodInfo_34AF2A4 *)method->klass->rgctx_data->_23_System_Collections_Generic_IEnumerable_WeightRate_WeightSeed_T__);
  if ( !v13 )
    sub_1B64ACC(v14, v15);
  System_Collections_Generic_List_object___GetEnumerator(
  ...
  while ( 1 )
  {
    ...
    if ( System_Object__Equals_62528260(v21, v22, 0LL) )
    {
      System_Collections_Generic_List_object___Remove(
        v13,
        current,
        (const MethodInfo_34B0F78 *)method->klass->rgctx_data->_25_System_Collections_Generic_List_WeightRate_WeightSeed_T___ToArray);
      break;
    }
  }
  System_Collections_Generic_List_Enumerator_object___Dispose(
...
int32_t __fastcall WeightRate_int___getTotalWeight(WeightRate_int__o *this, const MethodInfo_388E430 *method)
{
  return this->fields.totalweight;
}


void __fastcall WeightRate_int___removeWeight(WeightRate_int__o *this, int32_t t, const MethodInfo_388E284 *method)
{
  ...
  if ( (BYTE5(_7_WeightRate___c__DisplayClass4_0_T->vtable[0].methodPtr) & 1) == 0 )
    _7_WeightRate___c__DisplayClass4_0_T = (Il2CppClass *)sub_1BB674C(method->klass->rgctx_data->_7_WeightRate___c__DisplayClass4_0_T_);
  v7 = sub_1B64ABC(_7_WeightRate___c__DisplayClass4_0_T);
  WeightRate___c__DisplayClass4_0_int____ctor(
    (WeightRate___c__DisplayClass4_0_T__o *)v7,
    (const MethodInfo_3001180 *)method->klass->rgctx_data->_8_WeightRate___c__DisplayClass4_0_T___ctor);
  if ( !v7 )
    goto LABEL_14;
  *(_DWORD *)(v7 + 16) = t;
  list = (System_Collections_Generic_List_object__o *)this->fields.list;
  ...
  if ( (BYTE5(_10_System_Predicate_WeightRate_WeightSeed_T->vtable[0].methodPtr) & 1) == 0 )
    _10_System_Predicate_WeightRate_WeightSeed_T = (Il2CppClass *)sub_1BB674C(_10_System_Predicate_WeightRate_WeightSeed_T);
  v12 = (System_Predicate_object__o *)sub_1B64ABC(_10_System_Predicate_WeightRate_WeightSeed_T);
  System_Predicate_object____ctor(
    v12,
    (Il2CppObject *)v7,
    (intptr_t)method->klass->rgctx_data->_9_WeightRate___c__DisplayClass4_0_T___removeWeight_b__0,
    (const MethodInfo_361746C *)method->klass->rgctx_data->_11_System_Predicate_WeightRate_WeightSeed_T____ctor);
  if ( !list
    || (System_Collections_Generic_List_object___RemoveAll(
          list,
          (System_Predicate_T__o *)v12,
          (const MethodInfo_34B10AC *)method->klass->rgctx_data->_12_System_Collections_Generic_List_WeightRate_WeightSeed_T___RemoveAll),
...
void __fastcall WeightRate_int___setWeight(
        ...
        int32_t weight,
        int32_t t,
        const MethodInfo_388E14C *method)
{
  ...
  else
  {
    _1_System_Collections_Generic_List_WeightRate_WeightSeed_T = method->klass->rgctx_data->_1_System_Collections_Generic_List_WeightRate_WeightSeed_T__;
    if ( (BYTE5(_1_System_Collections_Generic_List_WeightRate_WeightSeed_T->vtable[0].methodPtr) & 1) == 0 )
      _1_System_Collections_Generic_List_WeightRate_WeightSeed_T = (Il2CppClass *)sub_1BB674C(_1_System_Collections_Generic_List_WeightRate_WeightSeed_T);
    v12 = (System_Collections_Generic_List_object__o *)sub_1B64ABC(_1_System_Collections_Generic_List_WeightRate_WeightSeed_T);
    System_Collections_Generic_List_object____ctor(
      v12,
      (const MethodInfo_34AF17C *)method->klass->rgctx_data->_2_System_Collections_Generic_List_WeightRate_WeightSeed_T____ctor);
    p_fields->klass = (ServantStatusBattleListViewItem_c *)v12;
    sub_1B64814(p_fields, (int32_t)v12, v13, v14);
  ...
  if ( (BYTE5(_4_WeightRate_WeightSeed_T->vtable[0].methodPtr) & 1) == 0 )
    _4_WeightRate_WeightSeed_T = (Il2CppClass *)sub_1BB674C(_4_WeightRate_WeightSeed_T);
  v16 = sub_1B64ABC(_4_WeightRate_WeightSeed_T);
  ...
  *(_DWORD *)(v16 + 20) = t;
  ...
  if ( (unsigned int)size >= items->max_length )
  {
    System_Collections_Generic_List_object___AddWithResize(
      list,
      (Il2CppObject *)v16,
      (const MethodInfo_34AF9B0 *)_6_System_Collections_Generic_List_WeightRate_WeightSeed_T___Add->klass->rgctx_data[14].rgctxDataDummy);
  }
  else
  {
