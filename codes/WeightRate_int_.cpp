void __fastcall WeightRate_int____ctor(WeightRate_int__o *this, const MethodInfo_2C1C5B0 *method)
{
  if ( !this )
...
void __fastcall WeightRate_int___ReverseWeight(WeightRate_int__o *this, const MethodInfo_2C1C244 *method)
{
...
void __fastcall WeightRate_int___SetAdjust(WeightRate_int__o *this, const MethodInfo_2C1BB38 *method)
{
  struct System_Collections_Generic_List_WeightRate_WeightSeed_T___o *list; // x0
  int32_t v5; // w22
  unsigned int v6; // w21
...
bool __fastcall WeightRate_int___checkWeight(WeightRate_int__o *this, const MethodInfo_2C1BB08 *method)
{
  return this->fields.totalweight > 0;
}


int32_t __fastcall WeightRate_int___getCount(WeightRate_int__o *this, const MethodInfo_2C1BB18 *method)
{
  struct System_Collections_Generic_List_WeightRate_WeightSeed_T___o *list; // x0
...
int32_t __fastcall WeightRate_int___getData(
        ...
        int32_t keywieght,
        const MethodInfo_2C1BBFC *method)
{
...
int32_t __fastcall WeightRate_int___getData_46251528(
        WeightRate_int__o *this,
        int32_t keyWeight,
        int32_t skipValue,
        const MethodInfo_2C1BE08 *method)
{
  ...
  while ( 1 )
  {
    ...
    if ( (BYTE2(v24->vtable[0].methodPtr) & 1) == 0 )
      sub_AEB684(method->klass->rgctx_data->_19_T);
    v25 = (Il2CppObject *)j_il2cpp_value_box_0(v24, &v49);
    if ( System_Object__Equals_42268688(v23, v25, 0LL) )
    {
  ...
  {
LABEL_21:
    p_method = sub_AEB880(&v44, System_IDisposable_TypeInfo, 0LL, v18);
  }
...
LABEL_31:
  ...
  {
LABEL_37:
    v41 = sub_AEB880(&v44, System_IDisposable_TypeInfo, 0LL, v35);
  }
...
int32_t __fastcall WeightRate_int___getTotalWeight(WeightRate_int__o *this, const MethodInfo_2C1BB00 *method)
{
  return this->fields.totalweight;
}


void __fastcall WeightRate_int___removeWeight(WeightRate_int__o *this, int32_t t, const MethodInfo_2C1B894 *method)
{
  ...
  *(_DWORD *)(v7 + 16) = t;
  ...
  v12 = sub_B52A54(_8_System_Predicate_WeightRate_WeightSeed_T);
...
LABEL_26:
  ...
  {
LABEL_20:
    p_method = sub_AEB880(&v21, System_IDisposable_TypeInfo, 0LL, v16);
  }
...
void __fastcall WeightRate_int___setWeight(
        ...
        int32_t weight,
        int32_t t,
        const MethodInfo_2C1B778 *method)
{
  ...
  else
  {
    ...
    sub_B52920(p_fields, (System_Int32_array **)v13, v14, v15, v16, v17, v18, v19);
