...
void UISnapshotPoint__Start(UISnapshotPoint_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3C20A & 1) == 0 )
  {
    sub_1C32C20(&StringLiteral_5843/*"EditorOnly"*/);
    byte_4C3C20A = 1;
  }
  tag = UnityEngine_Component__get_tag((UnityEngine_Component_o *)this, 0);
  if ( System_String__op_Inequality(tag, (System_String_o *)StringLiteral_5843/*"EditorOnly"*/, 0) )
    UnityEngine_Component__set_tag((UnityEngine_Component_o *)this, (System_String_o *)StringLiteral_5843/*"EditorOnly"*/, 0);
}