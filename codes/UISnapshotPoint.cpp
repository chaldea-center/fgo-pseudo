...
void UISnapshotPoint__Start(UISnapshotPoint_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E09266 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_5885/*"EditorOnly"*/);
    byte_4E09266 = 1;
  }
  tag = UnityEngine_Component__get_tag((UnityEngine_Component_o *)this, 0);
  if ( System_String__op_Inequality(tag, (System_String_o *)StringLiteral_5885/*"EditorOnly"*/, 0) )
    UnityEngine_Component__set_tag((UnityEngine_Component_o *)this, (System_String_o *)StringLiteral_5885/*"EditorOnly"*/, 0);
}