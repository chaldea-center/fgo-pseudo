        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A231E5 & 1) == 0 )
  {
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponent_CombineCommandCodeListViewItemDraw___, method);
    byte_4A231E5 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2EAA998 *)Method_UnityEngine_GameObject_GetComponent_CombineCommandCodeListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A231E6 & 1) == 0 )
  {
    sub_1B715CC(&CombineCommandCodeListViewItem_TypeInfo, method);
    byte_4A231E6 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A231E8 & 1) == 0 )
  {
    sub_1B715CC(&CombineCommandCodeListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4A231E8 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineCommandCodeListViewObject__Init_44557996(
        CombineCommandCodeListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineCommandCodeListViewObject__Init_44558744(
        CombineCommandCodeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineCommandCodeListViewObject__Init_44566764(
        CombineCommandCodeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B715CC(&CombineCommandCodeListViewItem_TypeInfo, method);
    sub_1B715CC(&CombineCommandCodeListViewManager_TypeInfo, v4);
    sub_1B715CC(&Method_CombineCommandCodeListViewObject_OnClickSelect__, v5);
    this = (CombineCommandCodeListViewObject_o *)sub_1B715CC(&StringLiteral_9813/*"OnClickListView"*/, v6);
    byte_4A231EA = 1;
  }
...
LABEL_27:
  ...
  if ( m_CachedPtr == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CombineCommandCodeListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v15 = (_QWORD *)sub_1B715E4(Method_CombineCommandCodeListViewObject_OnClickSelect__);
  ...
  if ( m_CachedPtr == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_CombineCommandCodeListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v12 = (_QWORD *)sub_1B715E4(Method_CombineCommandCodeListViewObject_OnClickSelect__);
...
LABEL_18:
  ...
  if ( BYTE4(linkItem[1].klass) || HIBYTE(linkItem[1].klass) )
  {
    ...
    if ( (*((_BYTE *)Method_CombineCommandCodeListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v17 = (_QWORD *)sub_1B715E4(Method_CombineCommandCodeListViewObject_OnClickSelect__);
  ...
  else
  {
    UnityEngine_Component__SendMessage(
      manager,
      (System_String_o *)StringLiteral_9813/*"OnClickListView"*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A231EB & 1) == 0 )
  {
    sub_1B715CC(&CombineCommandCodeListViewManager_TypeInfo, method);
  ...
  if ( linkItem )
  {
    ...
    if ( manager )
    {
      ...
      {
        UnityEngine_Component__SendMessage(manager, (System_String_o *)StringLiteral_9887/*"OnLongPushListView"*/, linkItem, 0LL);
        return;
      }
      sub_1B71AE8(manager);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A231E7 & 1) == 0 )
  {
    sub_1B715CC(&CombineCommandCodeListViewItem_TypeInfo, isInput);
...
void __fastcall CombineCommandCodeListViewObject__SetItem_44565852(
        CombineCommandCodeListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A231EC & 1) == 0 )
  {
    sub_1B715CC(&CombineCommandCodeListViewItemDraw_DispMode_TypeInfo, method);
