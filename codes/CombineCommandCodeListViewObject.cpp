        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C010FE & 1) == 0 )
  {
    sub_1C2E12C(&Method_UnityEngine_GameObject_GetComponent_CombineCommandCodeListViewItemDraw___, method);
    byte_4C010FE = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_3022B0C *)Method_UnityEngine_GameObject_GetComponent_CombineCommandCodeListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C010FF & 1) == 0 )
  {
    sub_1C2E12C(&CombineCommandCodeListViewItem_TypeInfo, method);
    byte_4C010FF = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C01101 & 1) == 0 )
  {
    sub_1C2E12C(&CombineCommandCodeListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4C01101 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineCommandCodeListViewObject__Init_46336028(
        CombineCommandCodeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineCommandCodeListViewObject__Init_46336112(
        CombineCommandCodeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineCommandCodeListViewObject__Init_46336196(
        CombineCommandCodeListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C2E12C(&CombineCommandCodeListViewItem_TypeInfo, method);
    sub_1C2E12C(&CombineCommandCodeListViewManager_TypeInfo, v4);
    sub_1C2E12C(&Method_CombineCommandCodeListViewObject_OnClickSelect__, v5);
    this = (CombineCommandCodeListViewObject_o *)sub_1C2E12C(&StringLiteral_10038/*"OnClickListView"*/, v6);
    byte_4C01103 = 1;
  }
...
LABEL_26:
  ...
  if ( m_CachedPtr == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CombineCommandCodeListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v15 = (_QWORD *)sub_1C2E144(Method_CombineCommandCodeListViewObject_OnClickSelect__);
  ...
  if ( m_CachedPtr == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_CombineCommandCodeListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v12 = (_QWORD *)sub_1C2E144(Method_CombineCommandCodeListViewObject_OnClickSelect__);
...
LABEL_18:
  ...
  if ( CombineCommandCodeListViewItem__get_CanNotSelect(linkItem, 0LL) )
  {
    ...
    if ( (*((_BYTE *)Method_CombineCommandCodeListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v17 = (_QWORD *)sub_1C2E144(Method_CombineCommandCodeListViewObject_OnClickSelect__);
  ...
  else
  {
    UnityEngine_Component__SendMessage(
      manager,
      (System_String_o *)StringLiteral_10038/*"OnClickListView"*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C01104 & 1) == 0 )
  {
    sub_1C2E12C(&CombineCommandCodeListViewManager_TypeInfo, method);
  ...
  if ( linkItem )
  {
    ...
    if ( manager )
    {
      ...
      {
        UnityEngine_Component__SendMessage(manager, (System_String_o *)StringLiteral_10113/*"OnLongPushListView"*/, linkItem, 0LL);
        return;
      }
      sub_1C2E648(manager);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C01100 & 1) == 0 )
  {
    sub_1C2E12C(&CombineCommandCodeListViewItem_TypeInfo, isInput);
...
void __fastcall CombineCommandCodeListViewObject__SetItem_46335108(
        CombineCommandCodeListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C01105 & 1) == 0 )
  {
    sub_1C2E12C(&CombineCommandCodeListViewItemDraw_DispMode_TypeInfo, method);
