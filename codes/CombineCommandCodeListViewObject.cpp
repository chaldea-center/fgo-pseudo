        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0C349 & 1) == 0 )
  {
    sub_1B686D4(&Method_UnityEngine_GameObject_GetComponent_CombineCommandCodeListViewItemDraw___, method);
    byte_4A0C349 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2E98950 *)Method_UnityEngine_GameObject_GetComponent_CombineCommandCodeListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0C34A & 1) == 0 )
  {
    sub_1B686D4(&CombineCommandCodeListViewItem_TypeInfo, method);
    byte_4A0C34A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0C34C & 1) == 0 )
  {
    sub_1B686D4(&CombineCommandCodeListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4A0C34C = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineCommandCodeListViewObject__Init_44488516(
        CombineCommandCodeListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineCommandCodeListViewObject__Init_44489264(
        CombineCommandCodeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineCommandCodeListViewObject__Init_44497284(
        CombineCommandCodeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B686D4(&CombineCommandCodeListViewItem_TypeInfo, method);
    sub_1B686D4(&CombineCommandCodeListViewManager_TypeInfo, v4);
    sub_1B686D4(&Method_CombineCommandCodeListViewObject_OnClickSelect__, v5);
    this = (CombineCommandCodeListViewObject_o *)sub_1B686D4(&StringLiteral_9806/*"OnClickListView"*/, v6);
    byte_4A0C34E = 1;
  }
...
LABEL_27:
  ...
  if ( m_CachedPtr == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CombineCommandCodeListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v15 = (_QWORD *)sub_1B686EC(Method_CombineCommandCodeListViewObject_OnClickSelect__);
  ...
  if ( m_CachedPtr == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_CombineCommandCodeListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v12 = (_QWORD *)sub_1B686EC(Method_CombineCommandCodeListViewObject_OnClickSelect__);
...
LABEL_18:
  ...
  if ( BYTE4(linkItem[1].klass) || HIBYTE(linkItem[1].klass) )
  {
    ...
    if ( (*((_BYTE *)Method_CombineCommandCodeListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v17 = (_QWORD *)sub_1B686EC(Method_CombineCommandCodeListViewObject_OnClickSelect__);
  ...
  else
  {
    UnityEngine_Component__SendMessage(
      manager,
      (System_String_o *)StringLiteral_9806/*"OnClickListView"*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0C34F & 1) == 0 )
  {
    sub_1B686D4(&CombineCommandCodeListViewManager_TypeInfo, method);
  ...
  if ( linkItem )
  {
    ...
    if ( manager )
    {
      ...
      {
        UnityEngine_Component__SendMessage(manager, (System_String_o *)StringLiteral_9880/*"OnLongPushListView"*/, linkItem, 0LL);
        return;
      }
      sub_1B68BF0(manager);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0C34B & 1) == 0 )
  {
    sub_1B686D4(&CombineCommandCodeListViewItem_TypeInfo, isInput);
...
void __fastcall CombineCommandCodeListViewObject__SetItem_44496372(
        CombineCommandCodeListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0C350 & 1) == 0 )
  {
    sub_1B686D4(&CombineCommandCodeListViewItemDraw_DispMode_TypeInfo, method);
