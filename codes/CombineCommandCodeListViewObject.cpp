        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05CDD & 1) == 0 )
  {
    sub_1BC3008(&Method_UnityEngine_GameObject_GetComponent_CombineCommandCodeListViewItemDraw___, method);
    byte_4B05CDD = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_3055998 *)Method_UnityEngine_GameObject_GetComponent_CombineCommandCodeListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05CDE & 1) == 0 )
  {
    sub_1BC3008(&CombineCommandCodeListViewItem_TypeInfo, method);
    byte_4B05CDE = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05CE0 & 1) == 0 )
  {
    sub_1BC3008(&CombineCommandCodeListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4B05CE0 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineCommandCodeListViewObject__Init_47185412(
        CombineCommandCodeListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineCommandCodeListViewObject__Init_47186160(
        CombineCommandCodeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineCommandCodeListViewObject__Init_47194468(
        CombineCommandCodeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BC3008(&CombineCommandCodeListViewItem_TypeInfo, method);
    sub_1BC3008(&CombineCommandCodeListViewManager_TypeInfo, v4);
    sub_1BC3008(&Method_CombineCommandCodeListViewObject_OnClickSelect__, v5);
    this = (CombineCommandCodeListViewObject_o *)sub_1BC3008(&StringLiteral_9761/*"OnClickListView"*/, v6);
    byte_4B05CE2 = 1;
  }
...
LABEL_27:
  ...
  if ( m_CachedPtr == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CombineCommandCodeListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v15 = (_QWORD *)sub_1BC3020(Method_CombineCommandCodeListViewObject_OnClickSelect__);
  ...
  if ( m_CachedPtr == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_CombineCommandCodeListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v12 = (_QWORD *)sub_1BC3020(Method_CombineCommandCodeListViewObject_OnClickSelect__);
...
LABEL_18:
  ...
  if ( BYTE4(linkItem[1].klass) || HIBYTE(linkItem[1].klass) )
  {
    ...
    if ( (*((_BYTE *)Method_CombineCommandCodeListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v17 = (_QWORD *)sub_1BC3020(Method_CombineCommandCodeListViewObject_OnClickSelect__);
  ...
  else
  {
    UnityEngine_Component__SendMessage(
      manager,
      (System_String_o *)StringLiteral_9761/*"OnClickListView"*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05CE3 & 1) == 0 )
  {
    sub_1BC3008(&CombineCommandCodeListViewManager_TypeInfo, method);
  ...
  if ( linkItem )
  {
    ...
    if ( manager )
    {
      ...
      {
        UnityEngine_Component__SendMessage(manager, (System_String_o *)StringLiteral_9840/*"OnLongPushListView"*/, linkItem, 0LL);
        return;
      }
      sub_1BC3524(manager);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05CDF & 1) == 0 )
  {
    sub_1BC3008(&CombineCommandCodeListViewItem_TypeInfo, isInput);
...
void __fastcall CombineCommandCodeListViewObject__SetItem_47193556(
        CombineCommandCodeListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05CE4 & 1) == 0 )
  {
    sub_1BC3008(&CombineCommandCodeListViewItemDraw_DispMode_TypeInfo, method);
