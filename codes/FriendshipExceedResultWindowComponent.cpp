        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF26A1 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_FriendshipExceedResultWindowComponent___c__DisplayClass10_0__CloseToNext_b__0__);
    sub_1C7BAE8(&FriendshipExceedResultWindowComponent___c__DisplayClass10_0_TypeInfo);
    byte_4CF26A1 = 1;
  }
  v5 = sub_1C7BD34(FriendshipExceedResultWindowComponent___c__DisplayClass10_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF269F & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_FriendshipExceedResultWindowComponent_OpenFriendshipExceedInfo__);
  ...
  *(_OWORD *)&v22.fields.fakeValue = v11;
  ...
  v21 = v22;
  v13 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_49453300(&v21, 0);
  ...
  *(_QWORD *)&v24.fields.fakeValue = v14;
  Master_object = (UserServantCollectionMaster_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49449776(
                                                     v24,
                                                     0);
  if ( !v12 )
    goto LABEL_19;
  if ( UserServantCollectionMaster__TryGetEntity(v12, &entity, v16, (int32_t)Master_object, 0) )
  {
    ...
    if ( (*((_BYTE *)Method_FriendshipExceedResultWindowComponent_OpenFriendshipExceedInfo__ + 83) & 2) != 0 )
      v17 = (_QWORD *)sub_1C7BB00(Method_FriendshipExceedResultWindowComponent_OpenFriendshipExceedInfo__);
        ...
        const MethodInfo *method)
{
  ...
  FriendshipExceedResultWindowComponent__SetFriendshipExceedInfo_49139476(this, userServantEntity, 0, v3);
}


void FriendshipExceedResultWindowComponent__SetFriendshipExceedInfo_49139476(
        FriendshipExceedResultWindowComponent_o *this,
        UserServantEntity_o *userServantEntity,
        int32_t currentMax,
        const MethodInfo *method)
{
  ...
  {
    sub_1C7BAE8(&System_Action_TypeInfo);
    sub_1C7BAE8(&Method_BaseDialog_EndOpenBaseDialog__);
    ...
    sub_1C7BAE8(&Method_FriendshipExceedResultWindowComponent_SetFriendshipExceedInfo__);
    sub_1C7BAE8(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    sub_1C7BAE8(&CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
  ...
  if ( (*((_BYTE *)Method_FriendshipExceedResultWindowComponent_SetFriendshipExceedInfo__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1C7BB00(Method_FriendshipExceedResultWindowComponent_SetFriendshipExceedInfo__);
  ...
  *(_OWORD *)&v21.fields.fakeValue = v15;
  if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
  v20 = v21;
  v17 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_49453300(&v20, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF26A0 & 1) == 0 )
  {
    sub_1C7BAE8(&System_Action_FriendshipExceedResultWindowComponent_SpecialimageInfo__TypeInfo);
    sub_1C7BAE8(&Method_BasicHelper_ForEach_FriendshipExceedResultWindowComponent_SpecialimageInfo___);
    sub_1C7BAE8(&LocalizationManager_TypeInfo);
    sub_1C7BAE8(&Method_FriendshipExceedResultWindowComponent___c__SetupSpecialEffectUI_b__9_0__);
    sub_1C7BAE8(&FriendshipExceedResultWindowComponent___c_TypeInfo);
    sub_1C7BAE8(&StringLiteral_3846/*"COSTUME_CHANGE_FRIENDSHIP_EXCEED_TITLE"*/);
    byte_4CF26A0 = 1;
  }
  if ( this->fields.isSpecialEffect )
  {
    ...
    v4 = LocalizationManager__Get((System_String_o *)StringLiteral_3846/*"COSTUME_CHANGE_FRIENDSHIP_EXCEED_TITLE"*/, 0);
    ...
    if ( !BasicHelper__IsNullOrEmpty((System_Collections_ICollection_o *)this->fields.specialImageInfos, 0) )
    {
      ...
      if ( !_9__9_0 )
      {
        ...
        _9__9_0 = (System_Action_FriendshipExceedResultWindowComponent_SpecialimageInfo__o *)sub_1C7BD34(System_Action_FriendshipExceedResultWindowComponent_SpecialimageInfo__TypeInfo);
      ...
      BasicHelper__ForEach_FriendshipExceedResultWindowComponent_SpecialimageInfo_(
        ...
        (const MethodInfo_315D780 *)Method_BasicHelper_ForEach_FriendshipExceedResultWindowComponent_SpecialimageInfo___);
    }
  }
}
...
void FriendshipExceedResultWindowComponent___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C7BD34(FriendshipExceedResultWindowComponent___c_TypeInfo);
