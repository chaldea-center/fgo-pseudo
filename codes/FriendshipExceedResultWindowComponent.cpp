        ...
        const MethodInfo *method)
{
  ...
  FriendshipExceedResultWindowComponent__SetFriendshipExceedInfo_44581172(this, userServantEntity, 0, v3);
}


void __fastcall FriendshipExceedResultWindowComponent__SetFriendshipExceedInfo_44581172(
        FriendshipExceedResultWindowComponent_o *this,
        UserServantEntity_o *userServantEntity,
        int32_t currentMax,
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0C3FF & 1) == 0 )
  {
    sub_1B686D4(&System_Action_TypeInfo, userServantEntity);
    sub_1B686D4(&Method_BaseDialog_EndOpenBaseDialog__, v7);
    ...
    sub_1B686D4(&Method_FriendshipExceedResultWindowComponent_SetFriendshipExceedInfo__, v11);
  ...
  if ( (*((_BYTE *)Method_FriendshipExceedResultWindowComponent_SetFriendshipExceedInfo__ + 83) & 2) != 0 )
    v15 = (_QWORD *)sub_1B686EC(Method_FriendshipExceedResultWindowComponent_SetFriendshipExceedInfo__);
  ...
  *(_QWORD *)&v30.fields.fakeValue = v20;
  Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46239416(v30, 0LL);
  if ( !v19 )
    goto LABEL_16;
  ...
  *(_OWORD *)&v29.fields.fakeValue = v23;
  ...
  v28 = v29;
  v25 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_46242940(&v28, 0LL);
