        ...
        const MethodInfo *method)
{
  ...
  FriendshipExceedResultWindowComponent__SetFriendshipExceedInfo_46544836(this, userServantEntity, 0, v3);
}


void __fastcall FriendshipExceedResultWindowComponent__SetFriendshipExceedInfo_46544836(
        FriendshipExceedResultWindowComponent_o *this,
        UserServantEntity_o *userServantEntity,
        int32_t currentMax,
        const MethodInfo *method)
{
  ...
  if ( (byte_4C259E2 & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_BaseDialog_EndOpenBaseDialog__, v7);
    ...
    sub_1C3B764(&Method_FriendshipExceedResultWindowComponent_SetFriendshipExceedInfo__, v11);
  ...
  if ( (*((_BYTE *)Method_FriendshipExceedResultWindowComponent_SetFriendshipExceedInfo__ + 83) & 2) != 0 )
    v15 = (_QWORD *)sub_1C3B77C(Method_FriendshipExceedResultWindowComponent_SetFriendshipExceedInfo__);
  ...
  *(_QWORD *)&v30.fields.fakeValue = v20;
  Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47882560(v30, 0LL);
  if ( !v19 )
    goto LABEL_16;
  ...
  *(_OWORD *)&v29.fields.fakeValue = v23;
  ...
  v28 = v29;
  v25 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_47886084(&v28, 0LL);
