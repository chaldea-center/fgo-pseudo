        ...
        const MethodInfo *method)
{
  if ( (byte_4A2E040 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataEntityBase_CreateMultiplePK_int__int__int__long___, *(_QWORD *)&slot);
    byte_4A2E040 = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__int__long_(
           ...
           groupId,
           point,
           (const MethodInfo_2E61018 *)Method_DataEntityBase_CreateMultiplePK_int__int__int__long___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E044 & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_1/*""*/, nameText);
    byte_4A2E044 = 1;
  }
  v23 = 0LL;
  nameTexta = 0LL;
  ...
  *countText = (System_String_o *)StringLiteral_1/*""*/;
  sub_1B76164((ServantStatusBattleListViewItem_o *)countText, (int32_t)StringLiteral_1/*""*/, v7, v8);
  ...
  if ( type == 1 )
  {
    ...
    if ( GiftData )
    {
      ...
      v12 = (int)nameTexta;
      *nameText = nameTexta;
      sub_1B76164((ServantStatusBattleListViewItem_o *)nameText, v12, v13, v14);
      v15 = (int)v23;
      *countText = v23;
      sub_1B76164((ServantStatusBattleListViewItem_o *)countText, v15, v16, v17);
    }
    type = this->fields.type;
  }
  if ( type == 3 )
  ...
  *nameText = name;
  sub_1B76164((ServantStatusBattleListViewItem_o *)nameText, (int32_t)name, v19, v20);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E043 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMasterData_EventRewardSetMaster___, method);
    sub_1B761C0(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v3);
    byte_4A2E043 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_371257C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E042 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_getEntitys_EventRewardExtraMaster__EventRewardExtraEntity___, method);
    sub_1B761C0(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v3);
    byte_4A2E042 = 1;
  }
  ...
  Instance = DataManager__getEntitys_object__object_(
               (DataManager_o *)Instance,
               (const MethodInfo_2E62668 *)Method_DataManager_getEntitys_EventRewardExtraMaster__EventRewardExtraEntity___);
  if ( !Instance )
    goto LABEL_14;
