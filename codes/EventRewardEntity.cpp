        ...
        const MethodInfo *method)
{
  if ( (byte_4B162ED & 1) == 0 )
  {
    sub_1BCA7E0(&Method_DataEntityBase_CreateMultiplePK_int__int__int__long___, *(_QWORD *)&slot, *(_QWORD *)&groupId);
    byte_4B162ED = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B162F1 & 1) == 0 )
  {
    sub_1BCA7E0(&StringLiteral_1/*""*/, nameText, countText);
    byte_4B162F1 = 1;
  }
  v43 = 0LL;
  nameTexta = 0LL;
  ...
  *countText = (System_String_o *)StringLiteral_1/*""*/;
  sub_1BCA784((PartyOrganizationUtility_o *)countText, (int64_t)StringLiteral_1/*""*/, v11, v12, v13, v14, v15, v16);
  ...
  if ( type == 1 )
  {
    ...
    if ( GiftData )
    {
      ...
      v20 = nameTexta;
      *nameText = nameTexta;
      sub_1BCA784((PartyOrganizationUtility_o *)nameText, (int64_t)v20, v21, v22, v23, v24, v25, v26);
      v27 = v43;
      *countText = v43;
      sub_1BCA784((PartyOrganizationUtility_o *)countText, (int64_t)v27, v28, v29, v30, v31, v32, v33);
    }
    type = this->fields.type;
  }
  if ( type == 3 )
  ...
  *nameText = name;
  sub_1BCA784((PartyOrganizationUtility_o *)nameText, (int64_t)name, v35, v36, v37, v38, v39, v40);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B162F0 & 1) == 0 )
  {
    sub_1BCA7E0(&Method_DataManager_GetMasterData_EventRewardSetMaster___, method, v2);
    sub_1BCA7E0(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v4, v5);
    byte_4B162F0 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37DEB14 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B162EF & 1) == 0 )
  {
    sub_1BCA7E0(&Method_DataManager_getEntitys_EventRewardExtraMaster__EventRewardExtraEntity___, method, v2);
    sub_1BCA7E0(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v4, v5);
    byte_4B162EF = 1;
  }
  ...
  Instance = DataManager__getEntitys_object__object_(
               (DataManager_o *)Instance,
               (const MethodInfo_2F12EF0 *)Method_DataManager_getEntitys_EventRewardExtraMaster__EventRewardExtraEntity___);
  if ( !Instance )
    goto LABEL_14;
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      v10 = (EventRewardExtraEntity_o *)Instance->m_Items[v9];
      if ( !v10 )
        break;
