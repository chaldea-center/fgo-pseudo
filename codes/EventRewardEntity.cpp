        ...
        const MethodInfo *method)
{
  if ( (byte_49BAF63 & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataEntityBase_CreateMultiplePK_int__int__int__long___, *(_QWORD *)&slot);
    byte_49BAF63 = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__int__long_(
           ...
           groupId,
           point,
           (const MethodInfo_2F00698 *)Method_DataEntityBase_CreateMultiplePK_int__int__int__long___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BAF67 & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_1/*""*/, nameText);
    byte_49BAF67 = 1;
  }
  v23 = 0LL;
  nameTexta = 0LL;
  ...
  *countText = (System_String_o *)StringLiteral_1/*""*/;
  sub_1B4CF34((CGThumbnailListItem_o *)countText, (int32_t)StringLiteral_1/*""*/, v7, v8);
  ...
  if ( type == 1 )
  {
    ...
    if ( GiftData )
    {
      ...
      v12 = (int)nameTexta;
      *nameText = nameTexta;
      sub_1B4CF34((CGThumbnailListItem_o *)nameText, v12, v13, v14);
      v15 = (int)v23;
      *countText = v23;
      sub_1B4CF34((CGThumbnailListItem_o *)countText, v15, v16, v17);
    }
    type = this->fields.type;
  }
  if ( type == 3 )
  ...
  *nameText = name;
  sub_1B4CF34((CGThumbnailListItem_o *)nameText, (int32_t)name, v19, v20);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BAF65 & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataManager_GetMaster_EventRewardExtraMaster___, method);
    sub_1B4CF90(&DataManager_TypeInfo, v3);
    sub_1B4CF90(&Method_DataMasterBase_EventRewardExtraMaster__EventRewardExtraEntity__string__getEntitys__, v4);
    byte_49BAF65 = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (System_Object_array *)DataManager__GetMaster_object_((const MethodInfo_2F01AD0 *)Method_DataManager_GetMaster_EventRewardExtraMaster___);
  if ( !Master_object )
    goto LABEL_16;
  Master_object = DataMasterBase_object__object__object___getEntitys(
                    (DataMasterBase_TMaster__TEntity__PKType__o *)Master_object,
                    (const MethodInfo_31A16D8 *)Method_DataMasterBase_EventRewardExtraMaster__EventRewardExtraEntity__string__getEntitys__);
  if ( !Master_object )
    goto LABEL_16;
