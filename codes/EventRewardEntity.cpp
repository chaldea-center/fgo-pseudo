        ...
        const MethodInfo *method)
{
  ...
  *countText = (System_String_o *)StringLiteral_1/*""*/;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)countText, StringLiteral_1/*""*/, v11, v12, v13, v14, v15, v16);
  ...
  if ( type == 1 )
  {
    ...
    if ( GiftData )
    {
      ...
      v20 = (int)nameTexta;
      *nameText = nameTexta;
      sub_1D0F058((GrandQuestFolderBoardItem_o *)nameText, v20, v21, v22, v23, v24, v25, v26);
      v27 = (int)v43;
      *countText = v43;
      sub_1D0F058((GrandQuestFolderBoardItem_o *)countText, v27, v28, v29, v30, v31, v32, v33);
    }
    type = this->fields.type;
  }
  if ( type == 3 )
  ...
  *nameText = name;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)nameText, (int32_t)name, v35, v36, v37, v38, v39, v40);
}
...
EventRewardExtraEntity_o *EventRewardEntity__getSetRewardData(EventRewardEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E777B0 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_DataManager_GetMaster_EventRewardExtraMaster___);
    sub_1D0F0B4(&DataManager_TypeInfo);
    sub_1D0F0B4(&Method_DataMasterBase_EventRewardExtraMaster__EventRewardExtraEntity__string__getEntitys__);
    byte_4E777B0 = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (System_Object_array *)DataManager__GetMaster_object_((const MethodInfo_324F164 *)Method_DataManager_GetMaster_EventRewardExtraMaster___);
  if ( !Master_object )
    goto LABEL_16;
  Master_object = DataMasterBase_object__object__object___getEntitys(
                    (DataMasterBase_TMaster__TEntity__PKType__o *)Master_object,
                    (const MethodInfo_3539D60 *)Method_DataMasterBase_EventRewardExtraMaster__EventRewardExtraEntity__string__getEntitys__);
  if ( !Master_object )
    goto LABEL_16;
