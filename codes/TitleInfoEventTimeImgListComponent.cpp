void __fastcall TitleInfoEventTimeImgListComponent___cctor(const MethodInfo *method)
{
  if ( (byte_4A59C2E & 1) == 0 )
  {
    sub_1B885B0(&TitleInfoEventTimeImgListComponent_TypeInfo);
    byte_4A59C2E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  int32_t v10; // w2
  int32_t v11; // w3
  TitleInfoEventTimeImgListComponent_o *v12; // x0
  ...
  if ( (byte_4A59C2C & 1) == 0 )
  {
    ...
    sub_1B885B0(&TitleInfoEventTimeImgListComponent_TypeInfo);
    sub_1B885B0(&Method_TitleInfoEventTimeImgListComponent___c__DisplayClass18_0__AddTimeAnime_b__0__);
    sub_1B885B0(&TitleInfoEventTimeImgListComponent___c__DisplayClass18_0_TypeInfo);
    byte_4A59C2C = 1;
  }
  v5 = sub_1B887FC(TitleInfoEventTimeImgListComponent___c__DisplayClass18_0_TypeInfo);
  ...
  *(_QWORD *)(v5 + 24) = changeDayCallback;
  sub_1B88554((ServantStatusBattleListViewItem_o *)(v5 + 24), (int32_t)changeDayCallback, v10, v11);
  ...
  if ( timeStep < this->fields.maxTimeStep )
  {
    ...
    if ( timeStep + 1 == TitleInfoEventTimeImgListComponent__GetChangeDayStep(v12, stateList, v13) )
    ...
    if ( grid )
    {
      ...
      v16 = (UnityEngine_GameObject_o *)grid;
      ...
      v17 = this->fields.grid;
      if ( v17 )
      {
        v22.fields.z = 0.0;
        v22.fields.y = v17->fields.cellHeight * (float)this->fields.timeStep;
        v22.fields.x = 0.0;
        ...
        if ( v18 )
        {
          v18->fields.animationCurve = (struct UnityEngine_AnimationCurve_o *)grid;
          sub_1B88554((ServantStatusBattleListViewItem_o *)&v18->fields.animationCurve, (int32_t)grid, v19, v20);
          v18->fields.ignoreTimeScale = 0;
          v21 = (EventDelegate_Callback_o *)sub_1B887FC(EventDelegate_Callback_TypeInfo);
          EventDelegate_Callback___ctor(
            v21,
            (Il2CppObject *)v5,
            Method_TitleInfoEventTimeImgListComponent___c__DisplayClass18_0__AddTimeAnime_b__0__,
            0LL);
          UITweener__SetOnFinished((UITweener_o *)v18, v21, 0LL);
          return;
        }
      }
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A59C2B & 1) == 0 )
  {
    sub_1B885B0(&Method_UnityEngine_GameObject_GetComponent_TitleInfoEventTimeImgListViewObject___);
  ...
  GameObjectExtensions__SafeSetParent((UnityEngine_GameObject_o *)v8, grid, 0LL);
  GameObjectExtensions__SetLocalPositionY(v10, y, 0LL);
  if ( !v10
    || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                             v10,
                             (const MethodInfo_2ECEEB8 *)Method_UnityEngine_GameObject_GetComponent_TitleInfoEventTimeImgListViewObject___)) == 0LL )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A59C2D & 1) == 0 )
  {
    sub_1B885B0(&TitleInfoEventTimeImgListComponent_TimeState___TypeInfo);
    sub_1B885B0(&Field__PrivateImplementationDetails__05DC715F8E536C7C410383B0D77EB649831DF1DFAD839486E54FFC948EA3E3B2);
    sub_1B885B0(&Field__PrivateImplementationDetails__08B06BA91C8EC8563FBA7CD4038FA9699D8AD7B3FD34E52E42FDBCBBDA783FFD);
    sub_1B885B0(&Field__PrivateImplementationDetails__7AA877887B42A89E842F39316984E430348FB949C60728DA491E02F952A0143D);
    sub_1B885B0(&Field__PrivateImplementationDetails__F68E148E70B6BFBDF5687AC243823CCFE66F0BA41CEBDBD9DC74421EEEF39CEE);
    byte_4A59C2D = 1;
  }
  if ( (unsigned int)start > 3 )
    return 0LL;
  v4 = (__int64 *)*(&off_44AEC00 + start);
  v5 = (System_Array_o *)sub_1B88658(TitleInfoEventTimeImgListComponent_TimeState___TypeInfo, 4LL);
  v6 = *v4;
  v7 = (TitleInfoEventTimeImgListComponent_TimeState_array *)v5;
  System_Runtime_CompilerServices_RuntimeHelpers__InitializeArray_61615112(v5, (System_RuntimeFieldHandle_o)v6, 0LL);
  return v7;
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.stateList, (int32_t)StateList, v6, v7);
