void __fastcall TitleInfoEventTimeImgListComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BB3149 & 1) == 0 )
  {
    sub_1C13D24(&TitleInfoEventTimeImgListComponent_TypeInfo, v1);
    byte_4BB3149 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB3147 & 1) == 0 )
  {
    sub_1C13D24(&EventDelegate_Callback_TypeInfo, changeDayCallback);
    sub_1C13D24(&TitleInfoEventTimeImgListComponent_TypeInfo, v5);
    sub_1C13D24(&Method_TitleInfoEventTimeImgListComponent___c__DisplayClass18_0__AddTimeAnime_b__0__, v6);
    sub_1C13D24(&TitleInfoEventTimeImgListComponent___c__DisplayClass18_0_TypeInfo, v7);
    byte_4BB3147 = 1;
  }
  v8 = sub_1C13F70(TitleInfoEventTimeImgListComponent___c__DisplayClass18_0_TypeInfo);
  ...
  *(_QWORD *)(v8 + 24) = changeDayCallback;
  sub_1C13CC8((PartyOrganizationUtility_o *)(v8 + 24), (int64_t)changeDayCallback, v17, v18, v19, v20, v21, v22);
    ...
    if ( grid )
    {
      ...
      if ( v28 )
      {
        ...
        if ( v29 )
        {
          ...
          v36 = (EventDelegate_Callback_o *)sub_1C13F70(EventDelegate_Callback_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB3146 & 1) == 0 )
  {
    sub_1C13D24(&Method_UnityEngine_GameObject_GetComponent_TitleInfoEventTimeImgListViewObject___, *(_QWORD *)&state);
  ...
  if ( !v12
    || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                             v12,
                             (const MethodInfo_2FDF9FC *)Method_UnityEngine_GameObject_GetComponent_TitleInfoEventTimeImgListViewObject___)) == 0LL )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB3148 & 1) == 0 )
  {
    sub_1C13D24(&TitleInfoEventTimeImgListComponent_TimeState___TypeInfo, *(_QWORD *)&start);
    sub_1C13D24(
  ...
  if ( (unsigned int)start > 3 )
    return 0LL;
  v8 = (__int64 *)*(&off_45E6078 + start);
  v9 = (System_Array_o *)sub_1C13DCC(TitleInfoEventTimeImgListComponent_TimeState___TypeInfo, 4LL);
  v10 = *v8;
  v11 = (TitleInfoEventTimeImgListComponent_TimeState_array *)v9;
  System_Runtime_CompilerServices_RuntimeHelpers__InitializeArray_62875280(v9, (System_RuntimeFieldHandle_o)v10, 0LL);
  return v11;
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.stateList, (int64_t)StateList, v6, v7, v8, v9, v10, v11);
