void __fastcall MainMenuBar___ctor(MainMenuBar_o *this, const MethodInfo *method)
{
  if ( (byte_4B4421E & 1) == 0 )
  {
    sub_1BDB878(&Method_SingletonMonoBehaviour_MainMenuBar___ctor__, method);
    byte_4B4421E = 1;
  }
  this->fields.panelDepth = -1;
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_39166A0 *)Method_SingletonMonoBehaviour_MainMenuBar___ctor__);
}
...
void __fastcall MainMenuBar__FrameIn(bool is_force, const MethodInfo *method)
{
  ...
  if ( (byte_4B4421C & 1) == 0 )
  {
    sub_1BDB878(&Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__, method);
    byte_4B4421C = 1;
  }
  Instance = (MainMenuBarBase_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4420D & 1) == 0 )
  {
    sub_1BDB878(&UnityEngine_Object_TypeInfo, scene);
    byte_4B4420D = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(barBase, 0LL, 0LL) )
  {
    ...
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    UnityEngine_Object__DestroyImmediate_70284388(obj, 0LL);
    this->fields.obj = 0LL;
    sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.obj, 0, v16, v17);
    *p_barBase = 0LL;
    sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.barBase, 0, v18, v19);
  }
  ...
  sub_1BDB81C(p_activeScene, (int32_t)scene, v13, v14);
...
void __fastcall MainMenuBar__SetAllBtnAct(System_Action_o *act, const MethodInfo *method)
{
  ...
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
  if ( !Instance || (klass = Instance[3].klass) == 0LL )
    sub_1BDBAD4(Instance, v4);
  klass->vtable[6].methodPtr = (Il2CppMethodPointer)act;
  sub_1BDB81C((CGThumbnailListItem_o *)&klass->vtable[6], (int32_t)act, v5, v6);
}
...
void __fastcall MainMenuBar__SetAlpha(float alpha, const MethodInfo *method)
{
  ...
  if ( (byte_4B44207 & 1) == 0 )
  {
    sub_1BDB878(&Method_UnityEngine_Component_GetComponent_UIPanel___, v2);
    sub_1BDB878(&UnityEngine_Object_TypeInfo, v4);
    sub_1BDB878(&Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__, v5);
    byte_4B44207 = 1;
  }
  Instance = (UnityEngine_Object_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
...
void __fastcall MainMenuBar__SetDispBtnAct(int32_t kind, System_Action_o *act, const MethodInfo *method)
{
  ...
  if ( (byte_4B4421A & 1) == 0 )
  {
    sub_1BDB878(&Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__, act);
    byte_4B4421A = 1;
  }
  Instance = (MainMenuBarBase_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
  if ( !Instance || (Instance = (MainMenuBarBase_o *)Instance->fields.partyBtn) == 0LL )
...
void __fastcall MainMenuBar__SetDispBtnColliderEnable(bool is_enable, int32_t kind, const MethodInfo *method)
{
  ...
  if ( (byte_4B44219 & 1) == 0 )
  {
    sub_1BDB878(&Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__, *(_QWORD *)&kind);
    byte_4B44219 = 1;
  }
  Instance = (MainMenuBarBase_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
  if ( !Instance || (Instance = (MainMenuBarBase_o *)Instance->fields.partyBtn) == 0LL )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B44210 & 1) == 0 )
  {
    sub_1BDB878(&Method_UnityEngine_Component_GetComponentInChildren_UICamera___, isActive);
    sub_1BDB878(&Method_UnityEngine_GameObject_GetComponent_MainMenuBarBase___, v7);
    sub_1BDB878(&Method_UnityEngine_GameObject_GetComponent_UICamera___, v8);
    ...
    sub_1BDB878(&StringLiteral_4649/*"CommonUI/MainMenuBarPrefab"*/, v12);
    byte_4B44210 = 1;
  }
  if ( isActive )
  {
    ...
    if ( UnityEngine_Object__op_Equality(obj, 0LL, 0LL) )
    {
      ...
      if ( UnityEngine_Object__op_Inequality(activeScene, 0LL, 0LL) )
      {
        ...
        v19 = (UnityEngine_Component_o *)ComponentInChildren_object__50504592;
        if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
        if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)v19, 0LL, 0LL) )
        {
          object = UnityEngine_Resources__Load_object_(
                     (System_String_o *)StringLiteral_4649/*"CommonUI/MainMenuBarPrefab"*/,
          ...
          *p_obj = (struct UnityEngine_GameObject_o *)v21;
          sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.obj, (int32_t)v21, v22, v23);
          ...
          if ( !byte_4B3E911 )
          {
            gameObject = sub_1BDB878(&UnityEngine_Vector3_TypeInfo, v17);
            byte_4B3E911 = 1;
          }
          if ( !v25 )
            goto LABEL_49;
          ...
          if ( !byte_4B3E917 )
          {
            gameObject = sub_1BDB878(&UnityEngine_Quaternion_TypeInfo, v17);
            byte_4B3E917 = 1;
          }
          if ( !v26 )
            goto LABEL_49;
          ...
          Component_object = UnityEngine_GameObject__GetComponent_object_(
                               (UnityEngine_GameObject_o *)gameObject,
                               (const MethodInfo_3088520 *)Method_UnityEngine_GameObject_GetComponent_MainMenuBarBase___);
          this->fields.barBase = (struct MainMenuBarBase_o *)Component_object;
          sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.barBase, (int32_t)Component_object, v30, v31);
...
void __fastcall MainMenuBar__SetMenuBtnAct(System_Action_o *act, const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&klass->vtable[5], (int32_t)act, v5, v6);
}
...
void __fastcall MainMenuBar__SetMenuBtnColliderEnable(bool isEnable, bool isGray, const MethodInfo *method)
{
  ...
  if ( (byte_4B44217 & 1) == 0 )
  {
    sub_1BDB878(&Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__, isGray);
    byte_4B44217 = 1;
  }
  Instance = (MainMenuBarBase_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
  if ( !Instance || (Instance = (MainMenuBarBase_o *)Instance->fields.partyBtn) == 0LL )
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(activeScene, (UnityEngine_Object_o *)scene, 0LL) )
  {
    ...
    this->fields.activeScene = scene;
    sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.activeScene, (int32_t)scene, v10, v11);
    obj = (UnityEngine_Object_o *)this->fields.obj;
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    if ( UnityEngine_Object__op_Inequality(obj, 0LL, 0LL) )
    {
      ...
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      UnityEngine_Object__DestroyImmediate_70284388(v13, 0LL);
      this->fields.obj = 0LL;
      sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.obj, 0, v14, v15);
      this->fields.barBase = 0LL;
      sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.barBase, 0, v16, v17);
...
void __fastcall MainMenuBar__UpdateNoticeNumber(const MethodInfo *method)
{
  ...
  if ( (byte_4B44216 & 1) == 0 )
  {
    sub_1BDB878(&Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__, v1);
    byte_4B44216 = 1;
  }
  Instance = (MainMenuBarBase_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
  if ( !Instance || (Instance = (MainMenuBarBase_o *)Instance->fields.partyBtn) == 0LL )
...
bool __fastcall MainMenuBar__get_IsEnableOutSideCollider(const MethodInfo *method)
{
  ...
  if ( (byte_4B441FF & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__, v2);
    byte_4B441FF = 1;
  }
  Instance = (UnityEngine_Object_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
...
void __fastcall MainMenuBar__requestSelectedSceneChange(const MethodInfo *method)
{
  ...
  {
    v4 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
    if ( !v4 )
      sub_1BDBAD4(0LL, v5);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&UnityEngine_Object_TypeInfo, *(_QWORD *)&kind);
    sub_1BDB878(&Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__, v7);
    byte_4B44201 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B44202 & 1) == 0 )
  {
    sub_1BDB878(&UnityEngine_Object_TypeInfo, cam);
    sub_1BDB878(&Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__, v5);
    byte_4B44202 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall MainMenuBar__setActiveScene_40293568(
        SceneRootComponent_o *scene,
        int32_t depth,
        UnityEngine_Camera_o *cam,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void __fastcall MainMenuBar__setActiveScene_40293776(
        SceneRootComponent_o *scene,
        int32_t kind,
        int32_t depth,
        UnityEngine_Camera_o *cam,
        const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&UnityEngine_Object_TypeInfo, *(_QWORD *)&kind);
    sub_1BDB878(&Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__, v9);
    byte_4B44204 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
...
void __fastcall MainMenuBar__setButtonActive(bool isActive, const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&UnityEngine_Object_TypeInfo, method);
    sub_1BDB878(&Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__, v3);
    byte_4B44209 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
