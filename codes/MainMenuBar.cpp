void __fastcall MainMenuBar___ctor(MainMenuBar_o *this, const MethodInfo *method)
{
  if ( (byte_4B662DB & 1) == 0 )
  {
    sub_1BE4ACC(&Method_SingletonMonoBehaviour_MainMenuBar___ctor__, method);
    byte_4B662DB = 1;
  }
  this->fields.panelDepth = -1;
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_38291E0 *)Method_SingletonMonoBehaviour_MainMenuBar___ctor__);
}
...
void __fastcall MainMenuBar__FrameIn(bool is_force, const MethodInfo *method)
{
  ...
  if ( (byte_4B662D9 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__, method);
    byte_4B662D9 = 1;
  }
  Instance = (MainMenuBarBase_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B662CA & 1) == 0 )
  {
    sub_1BE4ACC(&UnityEngine_Object_TypeInfo, scene);
    byte_4B662CA = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(barBase, 0LL, 0LL) )
  {
    ...
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    UnityEngine_Object__DestroyImmediate_70452188(obj, 0LL);
    this->fields.obj = 0LL;
    sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.obj, 0LL, v20, v21, v22, v23, v24, v25);
    *p_barBase = 0LL;
    sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.barBase, 0LL, v26, v27, v28, v29, v30, v31);
  }
  ...
  *(_DWORD *)(&p_activeScene[-1].fields._IsNormalFlowQuest_k__BackingField + 3) = panelDepth;
  sub_1BE4A70(p_activeScene, (int64_t)scene, v13, v14, v15, v16, v17, v18);
...
void __fastcall MainMenuBar__SetAllBtnAct(System_Action_o *act, const MethodInfo *method)
{
  ...
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
  if ( !Instance || (klass = Instance[3].klass) == 0LL )
    sub_1BE4D28(Instance, v4);
  klass->vtable[5].methodPtr = (Il2CppMethodPointer)act;
  sub_1BE4A70((PartyOrganizationUtility_o *)&klass->vtable[5], (int64_t)act, v5, v6, v7, v8, v9, v10);
}
...
void __fastcall MainMenuBar__SetAlpha(float alpha, const MethodInfo *method)
{
  ...
  if ( (byte_4B662C4 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_UnityEngine_Component_GetComponent_UIPanel___, v2);
    sub_1BE4ACC(&UnityEngine_Object_TypeInfo, v4);
    sub_1BE4ACC(&Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__, v5);
    byte_4B662C4 = 1;
  }
  Instance = (UnityEngine_Object_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
...
void __fastcall MainMenuBar__SetDispBtnAct(int32_t kind, System_Action_o *act, const MethodInfo *method)
{
  ...
  if ( (byte_4B662D7 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__, act);
    byte_4B662D7 = 1;
  }
  Instance = (MainMenuBarBase_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
  if ( !Instance || (Instance = (MainMenuBarBase_o *)Instance->fields.partyBtn) == 0LL )
...
void __fastcall MainMenuBar__SetDispBtnColliderEnable(bool is_enable, int32_t kind, const MethodInfo *method)
{
  ...
  if ( (byte_4B662D6 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__, *(_QWORD *)&kind);
    byte_4B662D6 = 1;
  }
  Instance = (MainMenuBarBase_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
  if ( !Instance || (Instance = (MainMenuBarBase_o *)Instance->fields.partyBtn) == 0LL )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B662CD & 1) == 0 )
  {
    sub_1BE4ACC(&Method_UnityEngine_Component_GetComponentInChildren_UICamera___, isActive);
    sub_1BE4ACC(&Method_UnityEngine_GameObject_GetComponent_MainMenuBarBase___, v7);
    sub_1BE4ACC(&Method_UnityEngine_GameObject_GetComponent_UICamera___, v8);
    sub_1BE4ACC(&Method_UnityEngine_Object_Instantiate_GameObject___, v9);
    sub_1BE4ACC(&UnityEngine_Object_TypeInfo, v10);
    sub_1BE4ACC(&Method_UnityEngine_Resources_Load_GameObject___, v11);
    sub_1BE4ACC(&StringLiteral_4719/*"CommonUI/MainMenuBarPrefab"*/, v12);
    byte_4B662CD = 1;
  }
  if ( isActive )
  {
    ...
    if ( UnityEngine_Object__op_Equality(obj, 0LL, 0LL) )
    {
      ...
      if ( UnityEngine_Object__op_Inequality(activeScene, 0LL, 0LL) )
      {
        ...
        v19 = (UnityEngine_Component_o *)ComponentInChildren_object__49610264;
        if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
        if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)v19, 0LL, 0LL) )
        {
          object = UnityEngine_Resources__Load_object_(
                     (System_String_o *)StringLiteral_4719/*"CommonUI/MainMenuBarPrefab"*/,
          ...
          *p_obj = (struct UnityEngine_GameObject_o *)v21;
          sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.obj, (int64_t)v21, v22, v23, v24, v25, v26, v27);
          ...
          if ( !byte_4B612E1 )
          {
            gameObject = sub_1BE4ACC(&UnityEngine_Vector3_TypeInfo, v17);
            byte_4B612E1 = 1;
          }
          if ( !v29 )
            goto LABEL_49;
          ...
          if ( !byte_4B612E7 )
          {
            gameObject = sub_1BE4ACC(&UnityEngine_Quaternion_TypeInfo, v17);
            byte_4B612E7 = 1;
          }
          if ( !v30 )
            goto LABEL_49;
          ...
          Component_object = UnityEngine_GameObject__GetComponent_object_(
                               (UnityEngine_GameObject_o *)gameObject,
                               (const MethodInfo_2FA979C *)Method_UnityEngine_GameObject_GetComponent_MainMenuBarBase___);
...
void __fastcall MainMenuBar__SetMenuBtnAct(System_Action_o *act, const MethodInfo *method)
{
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&klass->vtable[4], (int64_t)act, v5, v6, v7, v8, v9, v10);
}
...
void __fastcall MainMenuBar__SetMenuBtnColliderEnable(bool isEnable, bool isGray, const MethodInfo *method)
{
  ...
  if ( (byte_4B662D4 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__, isGray);
    byte_4B662D4 = 1;
  }
  Instance = (MainMenuBarBase_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
  if ( !Instance || (Instance = (MainMenuBarBase_o *)Instance->fields.partyBtn) == 0LL )
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(activeScene, (UnityEngine_Object_o *)scene, 0LL) )
  {
    ...
    this->fields.activeScene = scene;
    sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.activeScene, (int64_t)scene, v10, v11, v12, v13, v14, v15);
    obj = (UnityEngine_Object_o *)this->fields.obj;
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    if ( UnityEngine_Object__op_Inequality(obj, 0LL, 0LL) )
    {
      ...
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      UnityEngine_Object__DestroyImmediate_70452188(v17, 0LL);
      this->fields.obj = 0LL;
      sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.obj, 0LL, v18, v19, v20, v21, v22, v23);
      this->fields.barBase = 0LL;
      sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.barBase, 0LL, v24, v25, v26, v27, v28, v29);
...
void __fastcall MainMenuBar__UpdateNoticeNumber(const MethodInfo *method)
{
  ...
  if ( (byte_4B662D3 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__, v1);
    byte_4B662D3 = 1;
  }
  Instance = (MainMenuBarBase_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
  if ( !Instance || (Instance = (MainMenuBarBase_o *)Instance->fields.partyBtn) == 0LL )
...
bool __fastcall MainMenuBar__get_IsEnableOutSideCollider(const MethodInfo *method)
{
  ...
  if ( (byte_4B662BC & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__, v2);
    byte_4B662BC = 1;
  }
  Instance = (UnityEngine_Object_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
...
void __fastcall MainMenuBar__requestSelectedSceneChange(const MethodInfo *method)
{
  ...
  {
    v4 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
    if ( !v4 )
      sub_1BE4D28(0LL, v5);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BE4ACC(&UnityEngine_Object_TypeInfo, *(_QWORD *)&kind);
    sub_1BE4ACC(&Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__, v7);
    byte_4B662BE = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B662BF & 1) == 0 )
  {
    sub_1BE4ACC(&UnityEngine_Object_TypeInfo, cam);
    sub_1BE4ACC(&Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__, v5);
    byte_4B662BF = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall MainMenuBar__setActiveScene_39316120(
        SceneRootComponent_o *scene,
        int32_t depth,
        UnityEngine_Camera_o *cam,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void __fastcall MainMenuBar__setActiveScene_39316328(
        SceneRootComponent_o *scene,
        int32_t kind,
        int32_t depth,
        UnityEngine_Camera_o *cam,
        const MethodInfo *method)
{
  ...
  {
    sub_1BE4ACC(&UnityEngine_Object_TypeInfo, *(_QWORD *)&kind);
    sub_1BE4ACC(&Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__, v9);
    byte_4B662C1 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
...
void __fastcall MainMenuBar__setButtonActive(bool isActive, const MethodInfo *method)
{
  ...
  {
    sub_1BE4ACC(&UnityEngine_Object_TypeInfo, method);
    sub_1BE4ACC(&Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__, v3);
    byte_4B662C6 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
