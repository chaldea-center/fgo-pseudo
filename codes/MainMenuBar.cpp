void __fastcall MainMenuBar___ctor(MainMenuBar_o *this, const MethodInfo *method)
{
  if ( (byte_49BA58A & 1) == 0 )
  {
    sub_1B4CF90(&Method_SingletonMonoBehaviour_MainMenuBar___ctor__, method);
    byte_49BA58A = 1;
  }
  this->fields.panelDepth = -1;
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_37B4828 *)Method_SingletonMonoBehaviour_MainMenuBar___ctor__);
}
...
void __fastcall MainMenuBar__FrameIn(bool is_force, const MethodInfo *method)
{
  ...
  if ( (byte_49BA588 & 1) == 0 )
  {
    sub_1B4CF90(&Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__, method);
    byte_49BA588 = 1;
  }
  Instance = (MainMenuBarBase_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37B4410 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BA579 & 1) == 0 )
  {
    sub_1B4CF90(&UnityEngine_Object_TypeInfo, scene);
    byte_49BA579 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(barBase, 0LL, 0LL) )
  {
    ...
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    UnityEngine_Object__DestroyImmediate_68804644(obj, 0LL);
    this->fields.obj = 0LL;
    sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.obj, 0, v16, v17);
    *p_barBase = 0LL;
    sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.barBase, 0, v18, v19);
  }
  ...
  sub_1B4CF34(p_activeScene, (int32_t)scene, v13, v14);
...
void __fastcall MainMenuBar__SetAllBtnAct(System_Action_o *act, const MethodInfo *method)
{
  ...
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37B4410 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
  if ( !Instance || (klass = Instance[3].klass) == 0LL )
    sub_1B4D1EC(Instance, v4);
  klass->vtable[6].methodPtr = (Il2CppMethodPointer)act;
  sub_1B4CF34((CGThumbnailListItem_o *)&klass->vtable[6], (int32_t)act, v5, v6);
}
...
void __fastcall MainMenuBar__SetAlpha(float alpha, const MethodInfo *method)
{
  ...
  if ( (byte_49BA573 & 1) == 0 )
  {
    sub_1B4CF90(&Method_UnityEngine_Component_GetComponent_UIPanel___, v2);
    sub_1B4CF90(&UnityEngine_Object_TypeInfo, v4);
    sub_1B4CF90(&Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__, v5);
    byte_49BA573 = 1;
  }
  Instance = (UnityEngine_Object_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37B4410 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
...
void __fastcall MainMenuBar__SetDispBtnAct(int32_t kind, System_Action_o *act, const MethodInfo *method)
{
  ...
  if ( (byte_49BA586 & 1) == 0 )
  {
    sub_1B4CF90(&Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__, act);
    byte_49BA586 = 1;
  }
  Instance = (MainMenuBarBase_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37B4410 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
  if ( !Instance || (Instance = (MainMenuBarBase_o *)Instance->fields.partyBtn) == 0LL )
...
void __fastcall MainMenuBar__SetDispBtnColliderEnable(bool is_enable, int32_t kind, const MethodInfo *method)
{
  ...
  if ( (byte_49BA585 & 1) == 0 )
  {
    sub_1B4CF90(&Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__, *(_QWORD *)&kind);
    byte_49BA585 = 1;
  }
  Instance = (MainMenuBarBase_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37B4410 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
  if ( !Instance || (Instance = (MainMenuBarBase_o *)Instance->fields.partyBtn) == 0LL )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BA57C & 1) == 0 )
  {
    sub_1B4CF90(&Method_UnityEngine_Component_GetComponentInChildren_UICamera___, isActive);
    sub_1B4CF90(&Method_UnityEngine_GameObject_GetComponent_MainMenuBarBase___, v7);
    sub_1B4CF90(&Method_UnityEngine_GameObject_GetComponent_UICamera___, v8);
    sub_1B4CF90(&Method_UnityEngine_Object_Instantiate_GameObject___, v9);
    sub_1B4CF90(&UnityEngine_Object_TypeInfo, v10);
    sub_1B4CF90(&Method_UnityEngine_Resources_Load_GameObject___, v11);
    sub_1B4CF90(&StringLiteral_4553/*"CommonUI/MainMenuBarPrefab"*/, v12);
    byte_49BA57C = 1;
  }
  if ( isActive )
  {
    ...
    if ( UnityEngine_Object__op_Equality(obj, 0LL, 0LL) )
    {
      ...
      if ( UnityEngine_Object__op_Inequality(activeScene, 0LL, 0LL) )
      {
        ...
        v19 = (UnityEngine_Component_o *)ComponentInChildren_object__49252240;
        if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
        if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)v19, 0LL, 0LL) )
        {
          object = UnityEngine_Resources__Load_object_(
                     (System_String_o *)StringLiteral_4553/*"CommonUI/MainMenuBarPrefab"*/,
          ...
          *p_obj = (struct UnityEngine_GameObject_o *)v21;
          sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.obj, (int32_t)v21, v22, v23);
          ...
          if ( !byte_49B5361 )
          {
            gameObject = sub_1B4CF90(&UnityEngine_Vector3_TypeInfo, v17);
            byte_49B5361 = 1;
          }
          if ( !v25 )
            goto LABEL_49;
          ...
          if ( !byte_49B5367 )
          {
            gameObject = sub_1B4CF90(&UnityEngine_Quaternion_TypeInfo, v17);
            byte_49B5367 = 1;
          }
          if ( !v26 )
            goto LABEL_49;
          ...
          Component_object = UnityEngine_GameObject__GetComponent_object_(
                               (UnityEngine_GameObject_o *)gameObject,
                               (const MethodInfo_2F53444 *)Method_UnityEngine_GameObject_GetComponent_MainMenuBarBase___);
          this->fields.barBase = (struct MainMenuBarBase_o *)Component_object;
          sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.barBase, (int32_t)Component_object, v30, v31);
...
void __fastcall MainMenuBar__SetMenuBtnAct(System_Action_o *act, const MethodInfo *method)
{
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&klass->vtable[5], (int32_t)act, v5, v6);
}
...
void __fastcall MainMenuBar__SetMenuBtnColliderEnable(bool isEnable, bool isGray, const MethodInfo *method)
{
  ...
  if ( (byte_49BA583 & 1) == 0 )
  {
    sub_1B4CF90(&Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__, isGray);
    byte_49BA583 = 1;
  }
  Instance = (MainMenuBarBase_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37B4410 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
  if ( !Instance || (Instance = (MainMenuBarBase_o *)Instance->fields.partyBtn) == 0LL )
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(activeScene, (UnityEngine_Object_o *)scene, 0LL) )
  {
    ...
    this->fields.activeScene = scene;
    sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.activeScene, (int32_t)scene, v10, v11);
    obj = (UnityEngine_Object_o *)this->fields.obj;
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    if ( UnityEngine_Object__op_Inequality(obj, 0LL, 0LL) )
    {
      ...
      this->fields.obj = 0LL;
      sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.obj, 0, v14, v15);
      this->fields.barBase = 0LL;
      sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.barBase, 0, v16, v17);
...
void __fastcall MainMenuBar__UpdateNoticeNumber(const MethodInfo *method)
{
  ...
  if ( (byte_49BA582 & 1) == 0 )
  {
    sub_1B4CF90(&Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__, v1);
    byte_49BA582 = 1;
  }
  Instance = (MainMenuBarBase_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37B4410 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
  if ( !Instance || (Instance = (MainMenuBarBase_o *)Instance->fields.partyBtn) == 0LL )
...
bool __fastcall MainMenuBar__get_IsEnableOutSideCollider(const MethodInfo *method)
{
  ...
  if ( (byte_49BA56B & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__, v2);
    byte_49BA56B = 1;
  }
  Instance = (UnityEngine_Object_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37B4410 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
...
void __fastcall MainMenuBar__requestSelectedSceneChange(const MethodInfo *method)
{
  ...
  {
    v4 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37B4410 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
    if ( !v4 )
      sub_1B4D1EC(0LL, v5);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B4CF90(&UnityEngine_Object_TypeInfo, *(_QWORD *)&kind);
    sub_1B4CF90(&Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__, v7);
    byte_49BA56D = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37B4410 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BA56E & 1) == 0 )
  {
    sub_1B4CF90(&UnityEngine_Object_TypeInfo, cam);
    sub_1B4CF90(&Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__, v5);
    byte_49BA56E = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37B4410 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall MainMenuBar__setActiveScene_38951336(
        SceneRootComponent_o *scene,
        int32_t depth,
        UnityEngine_Camera_o *cam,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void __fastcall MainMenuBar__setActiveScene_38951544(
        SceneRootComponent_o *scene,
        int32_t kind,
        int32_t depth,
        UnityEngine_Camera_o *cam,
        const MethodInfo *method)
{
  ...
  {
    sub_1B4CF90(&UnityEngine_Object_TypeInfo, *(_QWORD *)&kind);
    sub_1B4CF90(&Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__, v9);
    byte_49BA570 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37B4410 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
...
void __fastcall MainMenuBar__setButtonActive(bool isActive, const MethodInfo *method)
{
  ...
  {
    sub_1B4CF90(&UnityEngine_Object_TypeInfo, method);
    sub_1B4CF90(&Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__, v3);
    byte_49BA575 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37B4410 *)Method_SingletonMonoBehaviour_MainMenuBar__get_Instance__);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
