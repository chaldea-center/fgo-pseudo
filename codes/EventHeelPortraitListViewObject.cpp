...
void EventHeelPortraitListViewObject__Awake(EventHeelPortraitListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC1905 & 1) == 0 )
  {
    sub_1C713B0(&Method_UnityEngine_GameObject_GetComponent_EventHeelPortraitListViewItemDraw___);
    byte_4CC1905 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_31A2ED0 *)Method_UnityEngine_GameObject_GetComponent_EventHeelPortraitListViewItemDraw___);
...
LABEL_9:
  ...
  if ( item )
  {
    ...
    {
      itemDraw = (EventHeelPortraitListViewItemDraw_o *)sub_1C719A4(item);
      goto LABEL_9;
    }
  }
