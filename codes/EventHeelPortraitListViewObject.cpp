        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9D1A & 1) == 0 )
  {
    sub_1BAB41C(&Method_UnityEngine_GameObject_GetComponent_EventHeelPortraitListViewItemDraw___, method);
    byte_4AB9D1A = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2F13970 *)Method_UnityEngine_GameObject_GetComponent_EventHeelPortraitListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9D1C & 1) == 0 )
  {
    sub_1BAB41C(&EventHeelPortraitListViewItem_TypeInfo, method);
    byte_4AB9D1C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9D1B & 1) == 0 )
  {
    sub_1BAB41C(&EventHeelPortraitListViewItem_TypeInfo, item);
    byte_4AB9D1B = 1;
  }
