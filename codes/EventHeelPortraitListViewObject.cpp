        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_41890E9 & 1) == 0 )
  {
    sub_B2C35C(&Method_UnityEngine_GameObject_GetComponent_EventHeelPortraitListViewItemDraw___, method);
    byte_41890E9 = 1;
  }
  ...
  Component_srcLineSprite = (struct EventHeelPortraitListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                                            dispObject,
                                                                            (const MethodInfo_1AA78DC *)Method_UnityEngine_GameObject_GetComponent_EventHeelPortraitListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_41890EB & 1) == 0 )
  {
    sub_B2C35C(&EventHeelPortraitListViewItem_TypeInfo, method);
    byte_41890EB = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_41890EA & 1) == 0 )
  {
    sub_B2C35C(&EventHeelPortraitListViewItem_TypeInfo, item);
    byte_41890EA = 1;
  }
...
LABEL_9:
  ...
  if ( item )
  {
    ...
    {
      itemDraw = (EventHeelPortraitListViewItemDraw_o *)sub_B2C728(item);
      goto LABEL_9;
    }
  }
