        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C019C7 & 1) == 0 )
  {
    sub_1C2E12C(&Method_UnityEngine_GameObject_GetComponent_EventHeelPortraitListViewItemDraw___, method);
    byte_4C019C7 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_3022B0C *)Method_UnityEngine_GameObject_GetComponent_EventHeelPortraitListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C019C9 & 1) == 0 )
  {
    sub_1C2E12C(&EventHeelPortraitListViewItem_TypeInfo, method);
    byte_4C019C9 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C019C8 & 1) == 0 )
  {
    sub_1C2E12C(&EventHeelPortraitListViewItem_TypeInfo, item);
    byte_4C019C8 = 1;
  }
