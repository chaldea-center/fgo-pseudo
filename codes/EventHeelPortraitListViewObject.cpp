...
void EventHeelPortraitListViewObject__Awake(EventHeelPortraitListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D26C3A & 1) == 0 )
  {
    sub_1C94098(&Method_UnityEngine_GameObject_GetComponent_EventHeelPortraitListViewItemDraw___);
    byte_4D26C3A = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_31F4790 *)Method_UnityEngine_GameObject_GetComponent_EventHeelPortraitListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D26C3C & 1) == 0 )
  {
    sub_1C94098(&EventHeelPortraitListViewItem_TypeInfo);
    byte_4D26C3C = 1;
  }
...
LABEL_9:
  ...
  if ( item )
  {
    ...
    {
      itemDraw = (EventHeelPortraitListViewItemDraw_o *)sub_1C9468C(item);
      goto LABEL_9;
    }
  }
