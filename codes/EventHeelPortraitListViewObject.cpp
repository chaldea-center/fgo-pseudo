...
void EventHeelPortraitListViewObject__Awake(EventHeelPortraitListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CE8AC8 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_UnityEngine_GameObject_GetComponent_EventHeelPortraitListViewItemDraw___);
    byte_4CE8AC8 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_31C70C8 *)Method_UnityEngine_GameObject_GetComponent_EventHeelPortraitListViewItemDraw___);
...
LABEL_9:
  ...
  if ( item )
  {
    ...
    {
      itemDraw = (EventHeelPortraitListViewItemDraw_o *)sub_1C7C0DC(item);
      goto LABEL_9;
    }
  }
