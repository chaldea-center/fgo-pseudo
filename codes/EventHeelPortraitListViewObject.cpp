        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B1DF6 & 1) == 0 )
  {
    sub_B52984(&Method_UnityEngine_GameObject_GetComponent_EventHeelPortraitListViewItemDraw___);
    byte_42B1DF6 = 1;
  }
  ...
  Component_srcLineSprite = (struct EventHeelPortraitListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                                            dispObject,
                                                                            (const MethodInfo_1B7B1B8 *)Method_UnityEngine_GameObject_GetComponent_EventHeelPortraitListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B1DF8 & 1) == 0 )
  {
    sub_B52984(&EventHeelPortraitListViewItem_TypeInfo);
    byte_42B1DF8 = 1;
  }
...
LABEL_9:
  ...
  if ( item )
  {
    ...
    {
      itemDraw = (EventHeelPortraitListViewItemDraw_o *)sub_B52D50(item);
      goto LABEL_9;
    }
  }
