        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5973E5B & 1) == 0 )
  {
    servantData = (BattleServantData_o *)sub_2213A60(&StringLiteral_12868/*"STAR_HIGHER"*/);
    byte_5973E5B = 1;
  }
  if ( !v4 )
    goto LABEL_11;
  ...
  if ( ChangeBattlePhaseNotify__get_Phase((ChangeBattlePhaseNotify_o *)servantData, (const MethodInfo *)data) != 3 )
  {
    ...
    if ( TDvcLv )
      return TreasureDeviceConditionUtil__HigherCondition(
               ...
               (System_String_o *)StringLiteral_12868/*"STAR_HIGHER"*/,
