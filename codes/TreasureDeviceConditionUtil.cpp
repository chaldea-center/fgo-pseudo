        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BDE2D & 1) == 0 )
  {
    servantData = (BattleServantData_o *)sub_1B4CF90(&StringLiteral_12059/*"STAR_HIGHER"*/, data);
    byte_49BDE2D = 1;
  }
  if ( !v4 )
    goto LABEL_11;
  ...
  if ( ChangeBattlePhaseNotify__get_Phase((ChangeBattlePhaseNotify_o *)servantData, (const MethodInfo *)data) != 3 )
  {
    ...
    if ( TDvcLv )
      return TreasureDeviceConditionUtil__HigherCondition(
               ...
               (System_String_o *)StringLiteral_12059/*"STAR_HIGHER"*/,
