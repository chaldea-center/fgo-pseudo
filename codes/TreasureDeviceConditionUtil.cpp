        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB8A73 & 1) == 0 )
  {
    servantData = (BattleServantData_o *)sub_1BAB41C(&StringLiteral_12283/*"STAR_HIGHER"*/, data);
    byte_4AB8A73 = 1;
  }
  if ( !v4 )
    goto LABEL_11;
  ...
  if ( ChangeBattlePhaseNotify__get_Phase((ChangeBattlePhaseNotify_o *)servantData, (const MethodInfo *)data) != 3 )
  {
    ...
    if ( TDvcLv )
      return TreasureDeviceConditionUtil__HigherCondition(
               ...
               (System_String_o *)StringLiteral_12283/*"STAR_HIGHER"*/,
