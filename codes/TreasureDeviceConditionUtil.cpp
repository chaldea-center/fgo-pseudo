        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CCA867 & 1) == 0 )
  {
    servantData = (BattleServantData_o *)sub_1C713B0(&StringLiteral_12355/*"STAR_HIGHER"*/);
    byte_4CCA867 = 1;
  }
  if ( !v4 )
    goto LABEL_11;
  ...
  if ( ChangeBattlePhaseNotify__get_Phase((ChangeBattlePhaseNotify_o *)servantData, (const MethodInfo *)data) != 3 )
  {
    ...
    if ( TDvcLv )
      return TreasureDeviceConditionUtil__HigherCondition(
               ...
               (System_String_o *)StringLiteral_12355/*"STAR_HIGHER"*/,
