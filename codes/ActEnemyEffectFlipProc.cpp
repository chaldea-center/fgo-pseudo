        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C59709 & 1) == 0 )
  {
    sub_1C3E564(&Method_System_Array_Empty_EffectFlipData___);
    byte_4C59709 = 1;
  }
  ...
  if ( !effectFlipDataArray )
  {
    ...
    if ( !v11 )
    {
      sub_1C8ECD4(Method_System_Array_Empty_EffectFlipData___);
      v11 = v10[7];
    }
    v12 = *(_QWORD *)(v11 + 16);
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields, (int32_t)effectFlipDataArray, v7, v8);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C5970A & 1) == 0 )
  {
    sub_1C3E564(&Method_System_Linq_Enumerable_FirstOrDefault_EffectFlipData___);
    sub_1C3E564(&System_Func_EffectFlipData__bool__TypeInfo);
    sub_1C3E564(&Method_ActEnemyEffectFlipProc___c__DisplayClass2_0__GetFlipData_b__0__);
    sub_1C3E564(&ActEnemyEffectFlipProc___c__DisplayClass2_0_TypeInfo);
    byte_4C5970A = 1;
  }
  v5 = sub_1C3E7B0(ActEnemyEffectFlipProc___c__DisplayClass2_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v5, 0);
  if ( !v5 )
    sub_1C3E7C0(v6, v7);
  *(_DWORD *)(v5 + 16) = effectId;
  flipDataArray = (System_Collections_Generic_IEnumerable_TSource__o *)this->fields.flipDataArray;
  v9 = (System_Func_object__bool__o *)sub_1C3E7B0(System_Func_EffectFlipData__bool__TypeInfo);
  System_Func_object__bool____ctor(
    v9,
    (Il2CppObject *)v5,
    Method_ActEnemyEffectFlipProc___c__DisplayClass2_0__GetFlipData_b__0__,
    0);
  return (EffectFlipData_o *)System_Linq_Enumerable__FirstOrDefault_object__51525108(
                               flipDataArray,
                               (System_Func_TSource__bool__o *)v9,
                               (const MethodInfo_31235F4 *)Method_System_Linq_Enumerable_FirstOrDefault_EffectFlipData___);
}
