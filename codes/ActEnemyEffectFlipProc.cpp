        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C4592C & 1) == 0 )
  {
    sub_1C37058(&Method_System_Array_Empty_EffectFlipData___);
    byte_4C4592C = 1;
  }
  ...
  if ( !effectFlipDataArray )
  {
    ...
    if ( !v10 )
    {
      sub_1C877C8(Method_System_Array_Empty_EffectFlipData___);
      v10 = v9[7];
    }
    v11 = *(_QWORD *)(v10 + 16);
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields, (int32_t)effectFlipDataArray, v6, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C4592D & 1) == 0 )
  {
    sub_1C37058(&Method_System_Linq_Enumerable_FirstOrDefault_EffectFlipData___);
    sub_1C37058(&System_Func_EffectFlipData__bool__TypeInfo);
    sub_1C37058(&Method_ActEnemyEffectFlipProc___c__DisplayClass2_0__GetFlipData_b__0__);
    sub_1C37058(&ActEnemyEffectFlipProc___c__DisplayClass2_0_TypeInfo);
    byte_4C4592D = 1;
  }
  v5 = sub_1C372A4(ActEnemyEffectFlipProc___c__DisplayClass2_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v5, 0);
  if ( !v5 )
    sub_1C372B4(v6);
  *(_DWORD *)(v5 + 16) = effectId;
  flipDataArray = (System_Collections_Generic_IEnumerable_TSource__o *)this->fields.flipDataArray;
  v8 = (System_Func_object__bool__o *)sub_1C372A4(System_Func_EffectFlipData__bool__TypeInfo);
  System_Func_object__bool____ctor(
    v8,
    (Il2CppObject *)v5,
    Method_ActEnemyEffectFlipProc___c__DisplayClass2_0__GetFlipData_b__0__,
    0);
  return (EffectFlipData_o *)System_Linq_Enumerable__FirstOrDefault_object__51451648(
                               flipDataArray,
                               (System_Func_TSource__bool__o *)v8,
                               (const MethodInfo_3111700 *)Method_System_Linq_Enumerable_FirstOrDefault_EffectFlipData___);
}
