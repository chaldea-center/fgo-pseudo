        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFFD74 & 1) == 0 )
  {
    sub_1C2E12C(&Method_System_Array_Empty_EffectFlipData___, effectFlipDataArray);
    byte_4BFFD74 = 1;
  }
  ...
  if ( !v3 )
  {
    ...
    if ( !v15 )
    {
      sub_1C80064(Method_System_Array_Empty_EffectFlipData___);
      v15 = v14[7];
    }
    v16 = *(_QWORD *)(v15 + 16);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFFD75 & 1) == 0 )
  {
    sub_1C2E12C(&Method_System_Linq_Enumerable_FirstOrDefault_EffectFlipData___, *(_QWORD *)&effectId);
    sub_1C2E12C(&System_Func_EffectFlipData__bool__TypeInfo, v5);
    sub_1C2E12C(&Method_ActEnemyEffectFlipProc___c__DisplayClass2_0__GetFlipData_b__0__, v6);
    sub_1C2E12C(&ActEnemyEffectFlipProc___c__DisplayClass2_0_TypeInfo, v7);
    byte_4BFFD75 = 1;
  }
  v8 = sub_1C2E378(ActEnemyEffectFlipProc___c__DisplayClass2_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v8, 0LL);
  if ( !v8 )
    sub_1C2E388(v9, v10);
  *(_DWORD *)(v8 + 16) = effectId;
  flipDataArray = (System_Collections_Generic_IEnumerable_TSource__o *)this->fields.flipDataArray;
  v12 = (System_Func_object__bool__o *)sub_1C2E378(System_Func_EffectFlipData__bool__TypeInfo);
  System_Func_object__bool____ctor(
    v12,
    (Il2CppObject *)v8,
    Method_ActEnemyEffectFlipProc___c__DisplayClass2_0__GetFlipData_b__0__,
    0LL);
  return (EffectFlipData_o *)System_Linq_Enumerable__FirstOrDefault_object__50289116(
                               flipDataArray,
                               (System_Func_TSource__bool__o *)v12,
                               (const MethodInfo_2FF59DC *)Method_System_Linq_Enumerable_FirstOrDefault_EffectFlipData___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFFD76 & 1) == 0 )
  {
    sub_1C2E12C(&Method_UnityEngine_GameObject_GetComponent_BattleActorControl___, actorObj);
