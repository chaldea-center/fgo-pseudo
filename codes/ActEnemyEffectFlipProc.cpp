        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC9DDD & 1) == 0 )
  {
    sub_1C713B0(&Method_System_Array_Empty_EffectFlipData___);
    byte_4CC9DDD = 1;
  }
  ...
  if ( !effectFlipDataArray )
  {
    ...
    if ( !v15 )
    {
      sub_1C474A0(Method_System_Array_Empty_EffectFlipData___);
      v15 = v14[7];
    }
    v16 = *(_QWORD *)(v15 + 16);
  ...
  sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields, (int32_t)effectFlipDataArray, v7, v8, v9, v10, v11, v12);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC9DDE & 1) == 0 )
  {
    sub_1C713B0(&Method_System_Linq_Enumerable_FirstOrDefault_EffectFlipData___);
    sub_1C713B0(&System_Func_EffectFlipData__bool__TypeInfo);
    sub_1C713B0(&Method_ActEnemyEffectFlipProc___c__DisplayClass2_0__GetFlipData_b__0__);
    sub_1C713B0(&ActEnemyEffectFlipProc___c__DisplayClass2_0_TypeInfo);
    byte_4CC9DDE = 1;
  }
  v5 = sub_1C715FC(ActEnemyEffectFlipProc___c__DisplayClass2_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v5, 0);
  if ( !v5 )
    sub_1C71608(v6, v7);
  *(_DWORD *)(v5 + 16) = effectId;
  flipDataArray = (System_Collections_Generic_IEnumerable_TSource__o *)this->fields.flipDataArray;
  v9 = (System_Func_object__bool__o *)sub_1C715FC(System_Func_EffectFlipData__bool__TypeInfo);
  System_Func_object__bool____ctor(
    v9,
    (Il2CppObject *)v5,
    Method_ActEnemyEffectFlipProc___c__DisplayClass2_0__GetFlipData_b__0__,
    0);
  return (EffectFlipData_o *)System_Linq_Enumerable__FirstOrDefault_object__51858576(
                               flipDataArray,
                               (System_Func_TSource__bool__o *)v9,
                               (const MethodInfo_3174C90 *)Method_System_Linq_Enumerable_FirstOrDefault_EffectFlipData___);
}
