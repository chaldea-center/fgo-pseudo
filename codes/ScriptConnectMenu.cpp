...
void ScriptConnectMenu__EndConnectScriptPlay(ScriptConnectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C248D5 & 1) == 0 )
  {
    sub_1C2D490(&ScriptConnectListViewMenu_CallbackFunc_TypeInfo);
    sub_1C2D490(&Method_ScriptConnectMenu_OnEndSelectObject__);
    byte_4C248D5 = 1;
  }
  ...
  if ( !jumpLineObjectInput
    || (scriptConnectListViewMenu = this->fields.scriptConnectListViewMenu,
        ...
        v7 = (ScriptConnectListViewMenu_CallbackFunc_o *)sub_1C2D6DC(ScriptConnectListViewMenu_CallbackFunc_TypeInfo),
...
void ScriptConnectMenu__EndInput(ScriptConnectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.state )
  {
    ...
    dataScriptPathInput = (UnityEngine_Component_o *)UnityEngine_Component__GetComponent_object_(
                                                       dataScriptPathInput,
                                                       (const MethodInfo_30C5120 *)Method_UnityEngine_Component_GetComponent_UIInput___);
    ...
    {
LABEL_19:
      sub_1C2D6EC(dataScriptPathInput, method);
    }
    UnityEngine_Behaviour__set_enabled((UnityEngine_Behaviour_o *)dataScriptPathInput, 0, 0);
...
void ScriptConnectMenu__OnClickDecide(ScriptConnectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C248D6 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_ScriptConnectMenu_EndPlayScript__);
    sub_1C2D490(&ScriptManager_TypeInfo);
  ...
  if ( this->fields.state == 1 )
  {
    ...
    if ( dataScriptPathInput )
    {
      ...
      sub_1C2D434((CGThumbnailListItem_o *)&this->fields.selectConnectPath, (int32_t)Text, v5, v6);
      ...
      if ( dataScriptPathInput )
      {
        ...
        sub_1C2D434((CGThumbnailListItem_o *)&this->fields.selectObjectPath, (int32_t)v7, v8, v9);
        ...
        if ( genderInput )
        {
          ...
          if ( startModeInput )
          {
            ...
            sub_1C2D434((CGThumbnailListItem_o *)&this->fields.selectStartModeName, (int32_t)v15, v12, v13);
            ...
            if ( dataScriptPathInput )
            {
              ...
              if ( ScriptManager__SetScriptServerSetting(
                     ...
                     0) )
              {
                dataScriptPathInput = (UILineInput_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39D3CCC *)Method_SingletonMonoBehaviour_ScriptManager__get_Instance__);
                if ( !dataScriptPathInput )
                  goto LABEL_21;
...
void ScriptConnectMenu__OnClickSelect(ScriptConnectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.state == 1 )
  {
    ...
    sub_1C2D434((CGThumbnailListItem_o *)&this->fields.selectStartModeName, (int32_t)v12, v9, v10);
    ...
    if ( !dataScriptPathInput
      || (scriptConnectListViewMenu = this->fields.scriptConnectListViewMenu,
          ...
          v16 = (ScriptConnectListViewMenu_CallbackFunc_o *)sub_1C2D6DC(ScriptConnectListViewMenu_CallbackFunc_TypeInfo),
          ScriptConnectListViewMenu_CallbackFunc___ctor(
            v16,
            (Il2CppObject *)this,
            Method_ScriptConnectMenu_OnEndSelectObject__,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C248D4 & 1) == 0 )
  {
    sub_1C2D490(&System_Action_TypeInfo);
    sub_1C2D490(&Method_UnityEngine_Component_GetComponent_UIInput___);
    sub_1C2D490(&Method_ScriptConnectMenu_EndConnectScriptPlay__);
    sub_1C2D490(&ScriptManager_TypeInfo);
    sub_1C2D490(&Method_SingletonMonoBehaviour_ScriptManager__get_Instance__);
    byte_4C248D4 = 1;
  }
  if ( this->fields.state == 2 )
  {
    if ( (result & 0xFFFFFFFE) == 2 )
    {
      ...
      sub_1C2D434((CGThumbnailListItem_o *)&this->fields.selectObjectPath, (int32_t)path, (int32_t)path, method);
              ...
              if ( dataScriptObjectInput )
              {
                ...
                if ( v9 )
                {
                  ...
                  if ( ScriptManager__SetScriptServerSetting(
                         ...
                         0) )
                  {
                    dataScriptObjectInput = (UnityEngine_Component_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39D3CCC *)Method_SingletonMonoBehaviour_ScriptManager__get_Instance__);
                    if ( !dataScriptObjectInput )
                      goto LABEL_24;
...
LABEL_24:
    sub_1C2D6EC(dataScriptObjectInput, *(_QWORD *)&result);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
  {
    ...
    sub_1C2D434((CGThumbnailListItem_o *)&this->fields.selectConnectPath, (int32_t)scriptServerSettingAddress, v8, v9);
    if ( !byte_4C24876 )
    {
      sub_1C2D490(&ScriptManager_TypeInfo);
      byte_4C24876 = 1;
    ...
    sub_1C2D434((CGThumbnailListItem_o *)&this->fields.selectObjectPath, (int32_t)scriptObjectSettingAddress, v12, v13);
    if ( !byte_4C2487A )
    {
      sub_1C2D490(&ScriptManager_TypeInfo);
      byte_4C2487A = 1;
...
void ScriptConnectMenu__StartMenu(ScriptConnectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C248CE & 1) == 0 )
  {
    sub_1C2D490(&ScriptConnectMenu_CallbackFunc_TypeInfo);
    sub_1C2D490(&Method_ScriptConnectMenu_CloseAction__);
    byte_4C248CE = 1;
  }
  TestScript_DebugTest_DebugItem_DebugItemMenuBase__StartMenu(
    (TestScript_DebugTest_DebugItem_DebugItemMenuBase_o *)this,
    0);
  v3 = (ScriptConnectMenu_CallbackFunc_o *)sub_1C2D6DC(ScriptConnectMenu_CallbackFunc_TypeInfo);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1A6F150;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A6F108;
}
