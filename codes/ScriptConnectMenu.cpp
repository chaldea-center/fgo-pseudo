...
void ScriptConnectMenu__EndConnectScriptPlay(ScriptConnectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C34FA9 & 1) == 0 )
  {
    sub_1C32C20(&ScriptConnectListViewMenu_CallbackFunc_TypeInfo);
    sub_1C32C20(&Method_ScriptConnectMenu_OnEndSelectObject__);
    byte_4C34FA9 = 1;
  }
  ...
  if ( !jumpLineObjectInput
    || (scriptConnectListViewMenu = this->fields.scriptConnectListViewMenu,
        ...
        v7 = (ScriptConnectListViewMenu_CallbackFunc_o *)sub_1C32E6C(ScriptConnectListViewMenu_CallbackFunc_TypeInfo),
...
void ScriptConnectMenu__OnClickDecide(ScriptConnectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C34FAA & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_ScriptConnectMenu_EndPlayScript__);
    sub_1C32C20(&ScriptManager_TypeInfo);
  ...
  if ( this->fields.state == 1 )
  {
    ...
    if ( dataScriptPathInput )
    {
      ...
      sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.selectConnectPath, (int32_t)Text, v5, v6);
  ...
  if ( this->fields.state == 1 )
  {
    ...
    if ( !dataScriptPathInput
      || (scriptConnectListViewMenu = this->fields.scriptConnectListViewMenu,
          ...
          v16 = (ScriptConnectListViewMenu_CallbackFunc_o *)sub_1C32E6C(ScriptConnectListViewMenu_CallbackFunc_TypeInfo),
          ScriptConnectListViewMenu_CallbackFunc___ctor(
            v16,
            (Il2CppObject *)this,
            Method_ScriptConnectMenu_OnEndSelectObject__,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C34FA8 & 1) == 0 )
  {
    sub_1C32C20(&System_Action_TypeInfo);
    sub_1C32C20(&Method_UnityEngine_Component_GetComponent_UIInput___);
    sub_1C32C20(&Method_ScriptConnectMenu_EndConnectScriptPlay__);
    sub_1C32C20(&ScriptManager_TypeInfo);
    sub_1C32C20(&Method_SingletonMonoBehaviour_ScriptManager__get_Instance__);
    byte_4C34FA8 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
  {
    ...
    sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.selectConnectPath, (int32_t)scriptServerSettingAddress, v7, v8);
    if ( !byte_4C34F4A )
    {
      sub_1C32C20(&ScriptManager_TypeInfo);
      byte_4C34F4A = 1;
    ...
    sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.selectObjectPath, (int32_t)scriptObjectSettingAddress, v11, v12);
    if ( !byte_4C34F4E )
    {
      sub_1C32C20(&ScriptManager_TypeInfo);
      byte_4C34F4E = 1;
...
void ScriptConnectMenu__StartMenu(ScriptConnectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C34FA2 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_ScriptConnectMenu_CloseAction__);
    byte_4C34FA2 = 1;
  }
  TestScript_DebugTest_DebugItem_DebugItemMenuBase__StartMenu(
    (TestScript_DebugTest_DebugItem_DebugItemMenuBase_o *)this,
    0);
  v3 = (ScriptConnectMenu_CallbackFunc_o *)sub_1C32E6C(ScriptConnectMenu_CallbackFunc_TypeInfo);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1A74878;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A74830;
}
