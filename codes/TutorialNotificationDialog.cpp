...
void __fastcall TutorialNotificationDialog__Close(TutorialNotificationDialog_o *this, const MethodInfo *method)
{
  ...
  TutorialNotificationDialog__Close_37178564(this, 0LL, v2);
}


void __fastcall TutorialNotificationDialog__Close_37178564(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2CC25 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_TutorialNotificationDialog_EndClose__, v6);
    byte_4A2CC25 = 1;
  }
...
void __fastcall TutorialNotificationDialog__EndTurorialRequest(
        ...
        const MethodInfo *method)
{
  TutorialNotificationDialog__Close_37178564(this, this->fields.closeCallbackFunc, method);
}
...
void __fastcall TutorialNotificationDialog__OnClickClose(TutorialNotificationDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2CC26 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_TutorialNotificationDialog_EndTurorialRequest__, v5);
    sub_1B761C0(&Method_TutorialNotificationDialog_OnClickClose__, v6);
    byte_4A2CC26 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_TutorialNotificationDialog_OnClickClose__ + 83) & 2) != 0 )
      v7 = (_QWORD *)sub_1B761D8(Method_TutorialNotificationDialog_OnClickClose__);
    ...
    {
      TutorialNotificationDialog__Close_37178564(this, this->fields.closeCallbackFunc, v9);
    }
    else
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2CC24 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_TutorialNotificationDialog_EndOpen__, v10);
