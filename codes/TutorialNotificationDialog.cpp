...
void __fastcall TutorialNotificationDialog__Close(TutorialNotificationDialog_o *this, const MethodInfo *method)
{
  ...
  TutorialNotificationDialog__Close_37155048(this, 0LL, v2);
}


void __fastcall TutorialNotificationDialog__Close_37155048(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1E7BA & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_TutorialNotificationDialog_EndClose__, v6);
    byte_4A1E7BA = 1;
  }
...
void __fastcall TutorialNotificationDialog__EndTurorialRequest(
        ...
        const MethodInfo *method)
{
  TutorialNotificationDialog__Close_37155048(this, this->fields.closeCallbackFunc, method);
}
...
void __fastcall TutorialNotificationDialog__OnClickClose(TutorialNotificationDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1E7BB & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_TutorialNotificationDialog_EndTurorialRequest__, v5);
    sub_1B715CC(&Method_TutorialNotificationDialog_OnClickClose__, v6);
    byte_4A1E7BB = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_TutorialNotificationDialog_OnClickClose__ + 83) & 2) != 0 )
      v7 = (_QWORD *)sub_1B715E4(Method_TutorialNotificationDialog_OnClickClose__);
    ...
    {
      TutorialNotificationDialog__Close_37155048(this, this->fields.closeCallbackFunc, v9);
    }
    else
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1E7B9 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_TutorialNotificationDialog_EndOpen__, v10);
