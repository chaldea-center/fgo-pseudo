...
void __fastcall TutorialNotificationDialog__Close(TutorialNotificationDialog_o *this, const MethodInfo *method)
{
  ...
  TutorialNotificationDialog__Close_39178352(this, 0LL, v2);
}


void __fastcall TutorialNotificationDialog__Close_39178352(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43753 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_TutorialNotificationDialog_EndClose__, v6);
    byte_4B43753 = 1;
  }
...
void __fastcall TutorialNotificationDialog__EndTurorialRequest(
        ...
        const MethodInfo *method)
{
  TutorialNotificationDialog__Close_39178352(this, this->fields.closeCallbackFunc, method);
}
...
void __fastcall TutorialNotificationDialog__OnClickClose(TutorialNotificationDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B43754 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_TutorialNotificationDialog_EndTurorialRequest__, v5);
    sub_1BDB878(&Method_TutorialNotificationDialog_OnClickClose__, v6);
    byte_4B43754 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_TutorialNotificationDialog_OnClickClose__ + 83) & 2) != 0 )
      v7 = (_QWORD *)sub_1BDB890(Method_TutorialNotificationDialog_OnClickClose__);
    ...
    {
      TutorialNotificationDialog__Close_39178352(this, this->fields.closeCallbackFunc, v9);
    }
    else
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43752 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_TutorialNotificationDialog_EndOpen__, v10);
    sub_1BDB878(&StringLiteral_1/*""*/, v11);
    byte_4B43752 = 1;
  }
  this->fields.closeCallbackFunc = func;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.closeCallbackFunc, (int32_t)func, flagId, (const MethodInfo *)func);
