...
void __fastcall TutorialNotificationDialog__Close(TutorialNotificationDialog_o *this, const MethodInfo *method)
{
  ...
  TutorialNotificationDialog__Close_38375716(this, 0LL, v2);
}


void __fastcall TutorialNotificationDialog__Close_38375716(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4D1DD & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_TutorialNotificationDialog_EndClose__, v6);
    byte_4A4D1DD = 1;
  }
...
void __fastcall TutorialNotificationDialog__EndTurorialRequest(
        ...
        const MethodInfo *method)
{
  TutorialNotificationDialog__Close_38375716(this, this->fields.closeCallbackFunc, method);
}
...
void __fastcall TutorialNotificationDialog__OnClickClose(TutorialNotificationDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4D1DE & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_TutorialNotificationDialog_EndTurorialRequest__, v5);
    sub_1B863B8(&Method_TutorialNotificationDialog_OnClickClose__, v6);
    byte_4A4D1DE = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_TutorialNotificationDialog_OnClickClose__ + 83) & 2) != 0 )
      v7 = (_QWORD *)sub_1B863D0(Method_TutorialNotificationDialog_OnClickClose__);
    ...
    {
      TutorialNotificationDialog__Close_38375716(this, this->fields.closeCallbackFunc, v9);
    }
    else
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4D1DC & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_TutorialNotificationDialog_EndOpen__, v10);
    sub_1B863B8(&StringLiteral_1/*""*/, v11);
    byte_4A4D1DC = 1;
  }
  this->fields.closeCallbackFunc = func;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.closeCallbackFunc, (int32_t)func, flagId, (const MethodInfo *)func);
