...
void __fastcall TutorialNotificationDialog__Close(TutorialNotificationDialog_o *this, const MethodInfo *method)
{
  ...
  TutorialNotificationDialog__Close_29222596(this, 0LL, v2);
}


void __fastcall TutorialNotificationDialog__Close_29222596(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B23F7 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_TutorialNotificationDialog_EndClose__);
    byte_42B23F7 = 1;
  }
...
void __fastcall TutorialNotificationDialog__EndTurorialRequest(
        ...
        const MethodInfo *method)
{
  TutorialNotificationDialog__Close_29222596(this, this->fields.closeCallbackFunc, method);
}
...
void __fastcall TutorialNotificationDialog__OnClickClose(TutorialNotificationDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B23F8 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_TutorialNotificationDialog_EndTurorialRequest__);
    byte_42B23F8 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    {
      TutorialNotificationDialog__Close_29222596(this, this->fields.closeCallbackFunc, v3);
    }
    else
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B23F6 & 1) == 0 )
  {
    sub_B52984(&System_Action_TypeInfo);
    sub_B52984(&UnityEngine_Object_TypeInfo);
    sub_B52984(&Method_TutorialNotificationDialog_EndOpen__);
    sub_B52984(&StringLiteral_1/*""*/);
    byte_42B23F6 = 1;
  }
