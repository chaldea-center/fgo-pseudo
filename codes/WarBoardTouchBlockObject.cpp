        ...
        const MethodInfo *method)
{
  ...
  if ( !isActiveAndEnabled )
  {
    ...
    sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.onClickCallback, (int64_t)callback, v5, v6, v7, v8, v9, v10);
...
void __fastcall WarBoardTouchBlockObject__Deactivate(WarBoardTouchBlockObject_o *this, const MethodInfo *method)
{
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.onClickCallback, 0LL, v5, v6, v7, v8, v9, v10);
}
