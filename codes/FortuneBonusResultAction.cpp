void FortuneBonusResultAction___cctor(const MethodInfo *method)
{
  if ( (byte_4C23D4E & 1) == 0 )
  {
    sub_1C2D490(&FortuneBonusResultAction_TypeInfo);
    byte_4C23D4E = 1;
  }
...
void FortuneBonusResultAction__Awake(FortuneBonusResultAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C23D46 & 1) == 0 )
  {
    sub_1C2D490(&Method_CStateManager_FortuneBonusResultAction___ctor__);
    sub_1C2D490(&Method_CStateManager_FortuneBonusResultAction__add__);
    sub_1C2D490(&CStateManager_FortuneBonusResultAction__TypeInfo);
    sub_1C2D490(&FortuneBonusResultAction_StateNone_TypeInfo);
    sub_1C2D490(&FortuneBonusResultAction_StatePlay_TypeInfo);
    sub_1C2D490(&FortuneBonusResultAction_StateTouchWait_TypeInfo);
    byte_4C23D46 = 1;
  }
  p_fsm = &this->fields.fsm;
  if ( !this->fields.fsm )
  {
    v4 = (CStateManager_T__o *)sub_1C2D6DC(CStateManager_FortuneBonusResultAction__TypeInfo);
    CStateManager_object____ctor(
      v4,
      (Il2CppObject *)this,
      3,
      (const MethodInfo_3313C68 *)Method_CStateManager_FortuneBonusResultAction___ctor__);
    ...
    v8 = (Il2CppObject *)sub_1C2D6DC(FortuneBonusResultAction_StateNone_TypeInfo);
    ...
    CStateManager_object___add(
      ...
      0,
      (IState_T__o *)v8,
      (const MethodInfo_3313D10 *)Method_CStateManager_FortuneBonusResultAction__add__);
    v11 = (CStateManager_T__o *)*p_fsm;
    v12 = (Il2CppObject *)sub_1C2D6DC(FortuneBonusResultAction_StatePlay_TypeInfo);
    ...
    if ( !v11
      || (CStateManager_object___add(
          ...
          v14 = (Il2CppObject *)sub_1C2D6DC(FortuneBonusResultAction_StateTouchWait_TypeInfo),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C23D49 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_FortuneBonusResultAction___c__DisplayClass16_0__GetFortuneBonusDetailData_b__0__);
    sub_1C2D490(&FortuneBonusResultAction___c__DisplayClass16_0_TypeInfo);
    byte_4C23D49 = 1;
  }
  v5 = sub_1C2D6DC(FortuneBonusResultAction___c__DisplayClass16_0_TypeInfo);
...
void FortuneBonusResultAction__SetState(FortuneBonusResultAction_o *this, int32_t state, const MethodInfo *method)
{
  ...
  if ( (byte_4C23D4D & 1) == 0 )
  {
    sub_1C2D490(&Method_CStateManager_FortuneBonusResultAction__setState__);
    byte_4C23D4D = 1;
  }
  fsm = (CStateManager_T__o *)this->fields.fsm;
  if ( !fsm )
  ...
  CStateManager_object___setState(
    fsm,
    state,
    (const MethodInfo_3313D9C *)Method_CStateManager_FortuneBonusResultAction__setState__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C23D48 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_FortuneBonusResultAction___c__Setup_b__14_0__);
    sub_1C2D490(&FortuneBonusResultAction___c_TypeInfo);
    sub_1C2D490(&StringLiteral_22371/*"omikuzi_{0}"*/);
    byte_4C23D48 = 1;
  }
  entity = 0;
  this->fields.fortuneBonusData = fortuneBonus;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.fortuneBonusData, (int32_t)fortuneBonus, (int32_t)method, v3);
  ...
  if ( FortuneBonusRewardData )
  {
    ...
    if ( FortuneBonusDetailData )
    {
      ...
      Master_object = System_String__Format((System_String_o *)StringLiteral_22371/*"omikuzi_{0}"*/, v18, 0);
      ...
      if ( ListById )
      {
        ...
        if ( size >= v22->static_fields->REWARD_ITEM_COUNT )
        {
          ...
          if ( !_9__14_0 )
          {
            ...
            _9__14_0 = (System_Comparison_T__o *)sub_1C2D6DC(System_Comparison_GiftEntity__TypeInfo);
            System_Comparison_object____ctor(_9__14_0, v34, Method_FortuneBonusResultAction___c__Setup_b__14_0__, 0);
            ...
            sub_1C2D434((CGThumbnailListItem_o *)&static_fields->__9__14_0, (int32_t)_9__14_0, v36, v37);
          }
          ...
          if ( !itemSpriteList )
            goto LABEL_48;
          v39 = 0;
          while ( (__int64)v39 < SLODWORD(itemSpriteList->max_length) )
          {
            if ( !DataManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
            v40 = DataManager__GetMaster_object_((const MethodInfo_30CE8FC *)Method_DataManager_GetMaster_ItemMaster___);
            ...
            {
              v42 = this->fields.itemSpriteList;
              if ( !v42 )
                goto LABEL_48;
              if ( v39 >= LODWORD(v42->max_length) )
                sub_1C2D6F4(Master_object, v8, v41);
              if ( !entity )
                goto LABEL_48;
              v43 = v42->m_Items[v39];
              ...
              Master_object = (void *)AtlasManager__SetItem(v43, monitor, 0);
            }
            itemSpriteList = this->fields.itemSpriteList;
            ++v39;
            if ( !itemSpriteList )
  ...
  if ( UnityEngine_Object__op_Equality(screenTouchInfo, 0, 0) )
  {
    ...
    if ( Instance )
    {
      ...
      if ( ScreeenTouchInfo )
      {
        ...
        sub_1C2D434(p_screenTouchInfo, (int32_t)Component_object, v30, v31);
        goto LABEL_24;
      }
    }
LABEL_48:
...
void FortuneBonusResultAction__Update(FortuneBonusResultAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C23D47 & 1) == 0 )
  {
    sub_1C2D490(&Method_CStateManager_FortuneBonusResultAction__update__);
  ...
  if ( fsm )
    CStateManager_object___update(
      fsm,
      (const MethodInfo_3313D78 *)Method_CStateManager_FortuneBonusResultAction__update__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C23D4F & 1) == 0 )
  {
    ...
    sub_1C2D490(&CTouch_TypeInfo);
    sub_1C2D490(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1C2D490(&Method_FortuneBonusResultAction_StateTouchWait_update__);
    sub_1C2D490(&TerminalSceneComponent_TypeInfo);
    sub_1C2D490(&Method_FortuneBonusResultAction_StateTouchWait___c__DisplayClass1_0__update_b__0__);
    sub_1C2D490(&FortuneBonusResultAction_StateTouchWait___c__DisplayClass1_0_TypeInfo);
    byte_4C23D4F = 1;
  }
  v4 = sub_1C2D6DC(FortuneBonusResultAction_StateTouchWait___c__DisplayClass1_0_TypeInfo);
      ...
      if ( isTouchPush )
      {
        ...
        if ( isTouchPush )
        {
          ...
          if ( (*((_BYTE *)Method_FortuneBonusResultAction_StateTouchWait_update__ + 83) & 2) != 0 )
            v10 = (_QWORD *)sub_1C2D4A8(Method_FortuneBonusResultAction_StateTouchWait_update__);
...
void FortuneBonusResultAction___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C2D6DC(FortuneBonusResultAction___c_TypeInfo);
  System_Object___ctor(v1, 0);
  FortuneBonusResultAction___c_TypeInfo->static_fields->__9 = (struct FortuneBonusResultAction___c_o *)v1;
  sub_1C2D434((CGThumbnailListItem_o *)FortuneBonusResultAction___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
