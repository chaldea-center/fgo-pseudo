void __fastcall FortuneBonusResultAction___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A1C83E & 1) == 0 )
  {
    sub_1B715CC(&FortuneBonusResultAction_TypeInfo, v1);
    byte_4A1C83E = 1;
  }
...
void __fastcall FortuneBonusResultAction__Awake(FortuneBonusResultAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1C836 & 1) == 0 )
  {
    sub_1B715CC(&Method_CStateManager_FortuneBonusResultAction___ctor__, method);
    sub_1B715CC(&Method_CStateManager_FortuneBonusResultAction__add__, v3);
    sub_1B715CC(&CStateManager_FortuneBonusResultAction__TypeInfo, v4);
    sub_1B715CC(&FortuneBonusResultAction_StateNone_TypeInfo, v5);
    sub_1B715CC(&FortuneBonusResultAction_StatePlay_TypeInfo, v6);
    sub_1B715CC(&FortuneBonusResultAction_StateTouchWait_TypeInfo, v7);
    byte_4A1C836 = 1;
  }
  p_fsm = &this->fields.fsm;
  if ( !this->fields.fsm )
  {
    v9 = (CStateManager_T__o *)sub_1B71818(CStateManager_FortuneBonusResultAction__TypeInfo);
    CStateManager_object____ctor(
      v9,
      (Il2CppObject *)this,
      3,
      (const MethodInfo_308625C *)Method_CStateManager_FortuneBonusResultAction___ctor__);
    ...
    v13 = (Il2CppObject *)sub_1B71818(FortuneBonusResultAction_StateNone_TypeInfo);
    ...
    CStateManager_object___add(
      ...
      0,
      (IState_T__o *)v13,
      (const MethodInfo_3086304 *)Method_CStateManager_FortuneBonusResultAction__add__);
    v16 = (CStateManager_T__o *)*p_fsm;
    v17 = (Il2CppObject *)sub_1B71818(FortuneBonusResultAction_StatePlay_TypeInfo);
    ...
    if ( !v16
      || (CStateManager_object___add(
          ...
          v19 = (Il2CppObject *)sub_1B71818(FortuneBonusResultAction_StateTouchWait_TypeInfo),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C839 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_FortuneBonusResultAction___c__DisplayClass16_0__GetFortuneBonusDetailData_b__0__, v6);
    sub_1B715CC(&FortuneBonusResultAction___c__DisplayClass16_0_TypeInfo, v7);
    byte_4A1C839 = 1;
  }
  v8 = sub_1B71818(FortuneBonusResultAction___c__DisplayClass16_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.endAction, (int32_t)endAct, (int32_t)method, v3);
...
void __fastcall FortuneBonusResultAction__PlayAnim(FortuneBonusResultAction_o *this, const MethodInfo *method)
{
  ...
  if ( !commonEffectComponent )
    sub_1B71828(0LL, v3);
  CommonEffectComponent__Init_40428156(commonEffectComponent, this->fields.animationName, 0, 0, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C83D & 1) == 0 )
  {
    sub_1B715CC(&Method_CStateManager_FortuneBonusResultAction__setState__, *(_QWORD *)&state);
    byte_4A1C83D = 1;
  }
  fsm = (CStateManager_T__o *)this->fields.fsm;
  if ( !fsm )
  ...
  CStateManager_object___setState(
    fsm,
    state,
    (const MethodInfo_3086390 *)Method_CStateManager_FortuneBonusResultAction__setState__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C838 & 1) == 0 )
  {
    sub_1B715CC(&AndroidBackKeyManager_TypeInfo, fortuneBonus);
    sub_1B715CC(&AtlasManager_TypeInfo, v6);
    sub_1B715CC(&System_Comparison_GiftEntity__TypeInfo, v7);
    sub_1B715CC(&Method_DataManager_GetMaster_GiftMaster___, v8);
    ...
    sub_1B715CC(&FortuneBonusResultAction_TypeInfo, v12);
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponent_ScreenTouchInformationComponent___, v13);
    sub_1B715CC(&int_TypeInfo, v14);
    sub_1B715CC(&Method_System_Collections_Generic_List_GiftEntity__Sort__, v15);
    sub_1B715CC(&Method_System_Collections_Generic_List_GiftEntity__get_Count__, v16);
    sub_1B715CC(&Method_System_Collections_Generic_List_GiftEntity__get_Item__, v17);
    sub_1B715CC(&NGUITools_TypeInfo, v18);
    sub_1B715CC(&UnityEngine_Object_TypeInfo, v19);
    sub_1B715CC(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v20);
    sub_1B715CC(&Method_FortuneBonusResultAction___c__Setup_b__14_0__, v21);
    sub_1B715CC(&FortuneBonusResultAction___c_TypeInfo, v22);
    sub_1B715CC(&StringLiteral_22179/*"omikuzi_{0}"*/, v23);
    byte_4A1C838 = 1;
  }
  entity = 0LL;
  ...
  if ( FortuneBonusRewardData )
  {
    ...
    if ( FortuneBonusDetailData )
    {
      ...
      Master_object = System_String__Format((System_String_o *)StringLiteral_22179/*"omikuzi_{0}"*/, v36, 0LL);
      ...
      if ( ListById )
      {
        ...
        if ( size >= v40->static_fields->REWARD_ITEM_COUNT )
        {
          ...
          if ( !_9__14_0 )
          {
            ...
            _9__14_0 = (System_Comparison_T__o *)sub_1B71818(System_Comparison_GiftEntity__TypeInfo);
            ...
            sub_1B71570((ServantStatusBattleListViewItem_o *)&static_fields->__9__14_0, (int32_t)_9__14_0, v54, v55);
          }
          ...
          while ( (__int64)v57 < (int)itemSpriteList->max_length )
          {
            if ( !DataManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
            v58 = DataManager__GetMaster_object_((const MethodInfo_2E5B394 *)Method_DataManager_GetMaster_ItemMaster___);
  ...
  if ( UnityEngine_Object__op_Equality(screenTouchInfo, 0LL, 0LL) )
  {
    ...
    if ( Instance )
    {
      ...
      if ( ScreeenTouchInfo )
      {
        ...
        sub_1B71570(p_screenTouchInfo, (int32_t)Component_object, v48, v49);
        goto LABEL_24;
      }
    }
LABEL_48:
    sub_1B71828(Master_object, v26);
  }
LABEL_24:
...
void __fastcall FortuneBonusResultAction__Update(FortuneBonusResultAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1C837 & 1) == 0 )
  {
    sub_1B715CC(&Method_CStateManager_FortuneBonusResultAction__update__, method);
  ...
  if ( fsm )
    CStateManager_object___update(
      fsm,
      (const MethodInfo_308636C *)Method_CStateManager_FortuneBonusResultAction__update__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C83F & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_FortuneBonusResultAction_StateTouchWait_update__, v8);
    sub_1B715CC(&TerminalSceneComponent_TypeInfo, v9);
    sub_1B715CC(&Method_FortuneBonusResultAction_StateTouchWait___c__DisplayClass1_0__update_b__0__, v10);
    sub_1B715CC(&FortuneBonusResultAction_StateTouchWait___c__DisplayClass1_0_TypeInfo, v11);
    byte_4A1C83F = 1;
  }
  v12 = sub_1B71818(FortuneBonusResultAction_StateTouchWait___c__DisplayClass1_0_TypeInfo);
      ...
      if ( isTouchPush )
      {
        ...
        if ( isTouchPush )
        {
          ...
          if ( (*((_BYTE *)Method_FortuneBonusResultAction_StateTouchWait_update__ + 83) & 2) != 0 )
            v18 = (_QWORD *)sub_1B715E4(Method_FortuneBonusResultAction_StateTouchWait_update__);
...
void __fastcall FortuneBonusResultAction___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A1C840 & 1) == 0 )
  {
    sub_1B715CC(&FortuneBonusResultAction___c_TypeInfo, v1);
    byte_4A1C840 = 1;
  }
  v2 = (Il2CppObject *)sub_1B71818(FortuneBonusResultAction___c_TypeInfo);
