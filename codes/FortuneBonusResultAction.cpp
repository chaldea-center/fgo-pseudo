void FortuneBonusResultAction___cctor(const MethodInfo *method)
{
  if ( (byte_4E0139A & 1) == 0 )
  {
    sub_1CE6700(&FortuneBonusResultAction_TypeInfo);
    byte_4E0139A = 1;
  }
...
void FortuneBonusResultAction__Awake(FortuneBonusResultAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E01392 & 1) == 0 )
  {
    sub_1CE6700(&Method_CStateManager_FortuneBonusResultAction___ctor__);
    sub_1CE6700(&Method_CStateManager_FortuneBonusResultAction__add__);
    sub_1CE6700(&CStateManager_FortuneBonusResultAction__TypeInfo);
    sub_1CE6700(&FortuneBonusResultAction_StateNone_TypeInfo);
    sub_1CE6700(&FortuneBonusResultAction_StatePlay_TypeInfo);
    sub_1CE6700(&FortuneBonusResultAction_StateTouchWait_TypeInfo);
    byte_4E01392 = 1;
  }
  p_fsm = &this->fields.fsm;
  if ( !this->fields.fsm )
  {
    v4 = (CStateManager_T__o *)sub_1CE694C(CStateManager_FortuneBonusResultAction__TypeInfo);
    CStateManager_object____ctor(
      v4,
      (Il2CppObject *)this,
      3,
      (const MethodInfo_3473510 *)Method_CStateManager_FortuneBonusResultAction___ctor__);
    ...
    v12 = (Il2CppObject *)sub_1CE694C(FortuneBonusResultAction_StateNone_TypeInfo);
    ...
    CStateManager_object___add(
      ...
      0,
      (IState_T__o *)v12,
      (const MethodInfo_34735B8 *)Method_CStateManager_FortuneBonusResultAction__add__);
    v15 = (CStateManager_T__o *)*p_fsm;
    v16 = (Il2CppObject *)sub_1CE694C(FortuneBonusResultAction_StatePlay_TypeInfo);
    ...
    if ( !v15
      || (CStateManager_object___add(
          ...
          v18 = (Il2CppObject *)sub_1CE694C(FortuneBonusResultAction_StateTouchWait_TypeInfo),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E01395 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_FortuneBonusResultAction___c__DisplayClass16_0__GetFortuneBonusDetailData_b__0__);
    sub_1CE6700(&FortuneBonusResultAction___c__DisplayClass16_0_TypeInfo);
    byte_4E01395 = 1;
  }
  v5 = sub_1CE694C(FortuneBonusResultAction___c__DisplayClass16_0_TypeInfo);
...
void FortuneBonusResultAction__PlayAnim(FortuneBonusResultAction_o *this, const MethodInfo *method)
{
  ...
  if ( !commonEffectComponent )
    sub_1CE6958(0, v3);
  CommonEffectComponent__Init_44847588(commonEffectComponent, this->fields.animationName, 0, 0, 0);
}
...
void FortuneBonusResultAction__SetState(FortuneBonusResultAction_o *this, int32_t state, const MethodInfo *method)
{
  ...
  if ( (byte_4E01399 & 1) == 0 )
  {
    sub_1CE6700(&Method_CStateManager_FortuneBonusResultAction__setState__);
    byte_4E01399 = 1;
  }
  fsm = (CStateManager_T__o *)this->fields.fsm;
  if ( !fsm )
  ...
  CStateManager_object___setState(
    fsm,
    state,
    (const MethodInfo_3473644 *)Method_CStateManager_FortuneBonusResultAction__setState__);
}
        ...
        const MethodInfo *method)
{
  ...
  GrandQuestFolderBoardItem_o *p_screenTouchInfo; // x20
  UnityEngine_Object_o *screenTouchInfo; // x21
  Il2CppObject *Instance; // x21
  UnityEngine_GameObject_o *ScreeenTouchInfo; // x19
  FortuneBonusResultAction_c *v28; // x8
  ...
  FortuneBonusResultAction___c_c *v37; // x0
  ...
  if ( (byte_4E01394 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_FortuneBonusResultAction___c__Setup_b__14_0__);
    sub_1CE6700(&FortuneBonusResultAction___c_TypeInfo);
    sub_1CE6700(&StringLiteral_22737/*"omikuzi_{0}"*/);
    byte_4E01394 = 1;
  }
  entity = 0;
  ...
  if ( FortuneBonusRewardData )
  {
    ...
    if ( FortuneBonusDetailData )
    {
      ...
      Master_object = System_String__Format((System_String_o *)StringLiteral_22737/*"omikuzi_{0}"*/, v19, 0);
      ...
      if ( ListById )
      {
        v21 = (System_Collections_Generic_List_object__o *)ListById;
        ...
        if ( size >= v23->static_fields->REWARD_ITEM_COUNT )
        {
          ...
          _9__14_0 = (System_Comparison_T__o *)v37->static_fields->__9__14_0;
          if ( !_9__14_0 )
          {
            ...
            _9__14_0 = (System_Comparison_T__o *)sub_1CE694C(System_Comparison_GiftEntity__TypeInfo);
          ...
          if ( !itemSpriteList )
            goto LABEL_48;
          v48 = 0;
          while ( (__int64)v48 < SLODWORD(itemSpriteList->max_length) )
          {
            if ( !DataManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
            v49 = DataManager__GetMaster_object_((const MethodInfo_3204354 *)Method_DataManager_GetMaster_ItemMaster___);
            ...
            if ( ((unsigned __int8)Master_object & 1) != 0 )
            {
              ...
              Master_object = (void *)AtlasManager__SetItem(v51, monitor, 0);
            }
            itemSpriteList = this->fields.itemSpriteList;
            ++v48;
            if ( !itemSpriteList )
  ...
  if ( UnityEngine_Object__op_Equality(screenTouchInfo, 0, 0) )
  {
    ...
    if ( Instance )
    {
      ScreeenTouchInfo = CommonUI__CreateScreeenTouchInfo(
                           ...
                           0,
                           0);
      v28 = FortuneBonusResultAction_TypeInfo;
      if ( !FortuneBonusResultAction_TypeInfo->_2.cctor_finished )
      {
        j_il2cpp_runtime_class_init_0(FortuneBonusResultAction_TypeInfo);
        v28 = FortuneBonusResultAction_TypeInfo;
      }
      SYSTEM_UI_LAYER_ID = v28->static_fields->SYSTEM_UI_LAYER_ID;
      ...
      if ( ScreeenTouchInfo )
      {
        ...
        sub_1CE66A4(p_screenTouchInfo, (int32_t)Component_object, v31, v32, v33, v34, v35, v36);
        goto LABEL_24;
      }
    }
LABEL_48:
...
void FortuneBonusResultAction__Update(FortuneBonusResultAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E01393 & 1) == 0 )
  {
    sub_1CE6700(&Method_CStateManager_FortuneBonusResultAction__update__);
  ...
  if ( fsm )
    CStateManager_object___update(
      fsm,
      (const MethodInfo_3473620 *)Method_CStateManager_FortuneBonusResultAction__update__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E0139B & 1) == 0 )
  {
    ...
    sub_1CE6700(&CTouch_TypeInfo);
    sub_1CE6700(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1CE6700(&Method_FortuneBonusResultAction_StateTouchWait_update__);
    sub_1CE6700(&TerminalSceneComponent_TypeInfo);
    sub_1CE6700(&Method_FortuneBonusResultAction_StateTouchWait___c__DisplayClass1_0__update_b__0__);
    sub_1CE6700(&FortuneBonusResultAction_StateTouchWait___c__DisplayClass1_0_TypeInfo);
    byte_4E0139B = 1;
  }
  v4 = sub_1CE694C(FortuneBonusResultAction_StateTouchWait___c__DisplayClass1_0_TypeInfo);
      ...
      if ( isTouchPush )
      {
        ...
        if ( isTouchPush )
        {
          ...
          if ( (*((_BYTE *)Method_FortuneBonusResultAction_StateTouchWait_update__ + 83) & 2) != 0 )
            v14 = (_QWORD *)sub_1CE6718(Method_FortuneBonusResultAction_StateTouchWait_update__);
...
void FortuneBonusResultAction___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1CE694C(FortuneBonusResultAction___c_TypeInfo);
