void FortuneBonusResultAction___cctor(const MethodInfo *method)
{
  if ( (byte_4C34422 & 1) == 0 )
  {
    sub_1C32C20(&FortuneBonusResultAction_TypeInfo);
    byte_4C34422 = 1;
  }
...
void FortuneBonusResultAction__Awake(FortuneBonusResultAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3441A & 1) == 0 )
  {
    sub_1C32C20(&Method_CStateManager_FortuneBonusResultAction___ctor__);
    sub_1C32C20(&Method_CStateManager_FortuneBonusResultAction__add__);
    sub_1C32C20(&CStateManager_FortuneBonusResultAction__TypeInfo);
    sub_1C32C20(&FortuneBonusResultAction_StateNone_TypeInfo);
    sub_1C32C20(&FortuneBonusResultAction_StatePlay_TypeInfo);
    sub_1C32C20(&FortuneBonusResultAction_StateTouchWait_TypeInfo);
    byte_4C3441A = 1;
  }
  p_fsm = &this->fields.fsm;
  if ( !this->fields.fsm )
  {
    v4 = (CStateManager_T__o *)sub_1C32E6C(CStateManager_FortuneBonusResultAction__TypeInfo);
    CStateManager_object____ctor(
      v4,
      (Il2CppObject *)this,
      3,
      (const MethodInfo_3322708 *)Method_CStateManager_FortuneBonusResultAction___ctor__);
    ...
    v8 = (Il2CppObject *)sub_1C32E6C(FortuneBonusResultAction_StateNone_TypeInfo);
    ...
    CStateManager_object___add(
      ...
      0,
      (IState_T__o *)v8,
      (const MethodInfo_33227B0 *)Method_CStateManager_FortuneBonusResultAction__add__);
    v10 = (CStateManager_T__o *)*p_fsm;
    v11 = (Il2CppObject *)sub_1C32E6C(FortuneBonusResultAction_StatePlay_TypeInfo);
    ...
    if ( !v10
      || (CStateManager_object___add(
          ...
          v13 = (Il2CppObject *)sub_1C32E6C(FortuneBonusResultAction_StateTouchWait_TypeInfo),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3441D & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_FortuneBonusResultAction___c__DisplayClass16_0__GetFortuneBonusDetailData_b__0__);
    sub_1C32C20(&FortuneBonusResultAction___c__DisplayClass16_0_TypeInfo);
    byte_4C3441D = 1;
  }
  v5 = sub_1C32E6C(FortuneBonusResultAction___c__DisplayClass16_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.endAction, (int32_t)endAct, (int32_t)method, v3);
...
void FortuneBonusResultAction__PlayAnim(FortuneBonusResultAction_o *this, const MethodInfo *method)
{
  ...
  if ( !commonEffectComponent )
    sub_1C32E7C(0);
  CommonEffectComponent__Init_43628936(commonEffectComponent, this->fields.animationName, 0, 0, 0);
}
...
void FortuneBonusResultAction__SetState(FortuneBonusResultAction_o *this, int32_t state, const MethodInfo *method)
{
  ...
  if ( (byte_4C34421 & 1) == 0 )
  {
    sub_1C32C20(&Method_CStateManager_FortuneBonusResultAction__setState__);
    byte_4C34421 = 1;
  }
  fsm = (CStateManager_T__o *)this->fields.fsm;
  if ( !fsm )
  ...
  CStateManager_object___setState(
    fsm,
    state,
    (const MethodInfo_332283C *)Method_CStateManager_FortuneBonusResultAction__setState__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3441C & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_FortuneBonusResultAction___c__Setup_b__14_0__);
    sub_1C32C20(&FortuneBonusResultAction___c_TypeInfo);
    sub_1C32C20(&StringLiteral_22388/*"omikuzi_{0}"*/);
    byte_4C3441C = 1;
  }
  entity = 0;
  this->fields.fortuneBonusData = fortuneBonus;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.fortuneBonusData, (int32_t)fortuneBonus, (int32_t)method, v3);
  ...
  if ( FortuneBonusRewardData )
  {
    ...
    if ( FortuneBonusDetailData )
    {
      ...
      Master_object = System_String__Format((System_String_o *)StringLiteral_22388/*"omikuzi_{0}"*/, v21, 0);
      ...
      if ( ListById )
      {
        ...
        if ( size >= v25->static_fields->REWARD_ITEM_COUNT )
        {
          ...
          if ( !_9__14_0 )
          {
            ...
            _9__14_0 = (System_Comparison_T__o *)sub_1C32E6C(System_Comparison_GiftEntity__TypeInfo);
            ...
            sub_1C32BC4((CGThumbnailListItem_o *)&static_fields->__9__14_0, (int32_t)_9__14_0, v39, v40);
          }
          ...
          while ( (__int64)v42 < SLODWORD(itemSpriteList->max_length) )
          {
            if ( !DataManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
            v43 = DataManager__GetMaster_object_((const MethodInfo_30DD39C *)Method_DataManager_GetMaster_ItemMaster___);
  ...
  if ( UnityEngine_Object__op_Equality(screenTouchInfo, 0, 0) )
  {
    ...
    if ( Instance )
    {
      ...
      if ( ScreeenTouchInfo )
      {
        ...
        sub_1C32BC4(p_screenTouchInfo, (int32_t)Component_object, v33, v34);
        goto LABEL_24;
      }
    }
LABEL_48:
...
void FortuneBonusResultAction__Update(FortuneBonusResultAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3441B & 1) == 0 )
  {
    sub_1C32C20(&Method_CStateManager_FortuneBonusResultAction__update__);
  ...
  if ( fsm )
    CStateManager_object___update(
      fsm,
      (const MethodInfo_3322818 *)Method_CStateManager_FortuneBonusResultAction__update__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C34423 & 1) == 0 )
  {
    ...
    sub_1C32C20(&CTouch_TypeInfo);
    sub_1C32C20(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1C32C20(&Method_FortuneBonusResultAction_StateTouchWait_update__);
    sub_1C32C20(&TerminalSceneComponent_TypeInfo);
    sub_1C32C20(&Method_FortuneBonusResultAction_StateTouchWait___c__DisplayClass1_0__update_b__0__);
    sub_1C32C20(&FortuneBonusResultAction_StateTouchWait___c__DisplayClass1_0_TypeInfo);
    byte_4C34423 = 1;
  }
  v4 = sub_1C32E6C(FortuneBonusResultAction_StateTouchWait___c__DisplayClass1_0_TypeInfo);
      ...
      if ( isTouchPush )
      {
        ...
        if ( isTouchPush )
        {
          ...
          if ( (*((_BYTE *)Method_FortuneBonusResultAction_StateTouchWait_update__ + 83) & 2) != 0 )
            v9 = (_QWORD *)sub_1C32C38(Method_FortuneBonusResultAction_StateTouchWait_update__);
...
void FortuneBonusResultAction___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C32E6C(FortuneBonusResultAction___c_TypeInfo);
  System_Object___ctor(v1, 0);
  FortuneBonusResultAction___c_TypeInfo->static_fields->__9 = (struct FortuneBonusResultAction___c_o *)v1;
  sub_1C32BC4((CGThumbnailListItem_o *)FortuneBonusResultAction___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
