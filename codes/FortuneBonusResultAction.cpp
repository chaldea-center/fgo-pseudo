void FortuneBonusResultAction___cctor(const MethodInfo *method)
{
  if ( (byte_4D2D369 & 1) == 0 )
  {
    sub_1C93AD4(&FortuneBonusResultAction_TypeInfo);
    byte_4D2D369 = 1;
  }
...
void FortuneBonusResultAction__Awake(FortuneBonusResultAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2D361 & 1) == 0 )
  {
    sub_1C93AD4(&Method_CStateManager_FortuneBonusResultAction___ctor__);
    sub_1C93AD4(&Method_CStateManager_FortuneBonusResultAction__add__);
    sub_1C93AD4(&CStateManager_FortuneBonusResultAction__TypeInfo);
    sub_1C93AD4(&FortuneBonusResultAction_StateNone_TypeInfo);
    sub_1C93AD4(&FortuneBonusResultAction_StatePlay_TypeInfo);
    sub_1C93AD4(&FortuneBonusResultAction_StateTouchWait_TypeInfo);
    byte_4D2D361 = 1;
  }
  p_fsm = &this->fields.fsm;
  if ( !this->fields.fsm )
  {
    v4 = (CStateManager_T__o *)sub_1C93D20(CStateManager_FortuneBonusResultAction__TypeInfo);
    CStateManager_object____ctor(
      v4,
      (Il2CppObject *)this,
      3,
      (const MethodInfo_33EE80C *)Method_CStateManager_FortuneBonusResultAction___ctor__);
    ...
    v12 = (Il2CppObject *)sub_1C93D20(FortuneBonusResultAction_StateNone_TypeInfo);
    ...
    CStateManager_object___add(
      ...
      0,
      (IState_T__o *)v12,
      (const MethodInfo_33EE8B4 *)Method_CStateManager_FortuneBonusResultAction__add__);
    v15 = (CStateManager_T__o *)*p_fsm;
    v16 = (Il2CppObject *)sub_1C93D20(FortuneBonusResultAction_StatePlay_TypeInfo);
    ...
    if ( !v15
      || (CStateManager_object___add(
          ...
          v18 = (Il2CppObject *)sub_1C93D20(FortuneBonusResultAction_StateTouchWait_TypeInfo),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2D364 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_FortuneBonusResultAction___c__DisplayClass16_0__GetFortuneBonusDetailData_b__0__);
    sub_1C93AD4(&FortuneBonusResultAction___c__DisplayClass16_0_TypeInfo);
    byte_4D2D364 = 1;
  }
  v5 = sub_1C93D20(FortuneBonusResultAction___c__DisplayClass16_0_TypeInfo);
...
void FortuneBonusResultAction__SetState(FortuneBonusResultAction_o *this, int32_t state, const MethodInfo *method)
{
  ...
  if ( (byte_4D2D368 & 1) == 0 )
  {
    sub_1C93AD4(&Method_CStateManager_FortuneBonusResultAction__setState__);
    byte_4D2D368 = 1;
  }
  fsm = (CStateManager_T__o *)this->fields.fsm;
  if ( !fsm )
  ...
  CStateManager_object___setState(
    fsm,
    state,
    (const MethodInfo_33EE940 *)Method_CStateManager_FortuneBonusResultAction__setState__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2D363 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_FortuneBonusResultAction___c__Setup_b__14_0__);
    sub_1C93AD4(&FortuneBonusResultAction___c_TypeInfo);
    sub_1C93AD4(&StringLiteral_22664/*"omikuzi_{0}"*/);
    byte_4D2D363 = 1;
  }
  entity = 0;
  ...
  if ( FortuneBonusRewardData )
  {
    ...
    if ( FortuneBonusDetailData )
    {
      ...
      Master_object = System_String__Format((System_String_o *)StringLiteral_22664/*"omikuzi_{0}"*/, v19, 0);
      ...
      if ( ListById )
      {
        ...
        if ( size >= v23->static_fields->REWARD_ITEM_COUNT )
        {
          ...
          if ( !_9__14_0 )
          {
            ...
            _9__14_0 = (System_Comparison_T__o *)sub_1C93D20(System_Comparison_GiftEntity__TypeInfo);
          ...
          while ( (__int64)v48 < SLODWORD(itemSpriteList->max_length) )
          {
            if ( !DataManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
            v49 = DataManager__GetMaster_object_((const MethodInfo_31A49E8 *)Method_DataManager_GetMaster_ItemMaster___);
  ...
  if ( UnityEngine_Object__op_Equality(screenTouchInfo, 0, 0) )
  {
    ...
    if ( Instance )
    {
      ...
      if ( ScreeenTouchInfo )
      {
        ...
        sub_1C93A78(p_screenTouchInfo, (int32_t)Component_object, v31, v32, v33, v34, v35, v36);
        goto LABEL_24;
      }
    }
LABEL_48:
...
void FortuneBonusResultAction__Update(FortuneBonusResultAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2D362 & 1) == 0 )
  {
    sub_1C93AD4(&Method_CStateManager_FortuneBonusResultAction__update__);
  ...
  if ( fsm )
    CStateManager_object___update(
      fsm,
      (const MethodInfo_33EE91C *)Method_CStateManager_FortuneBonusResultAction__update__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2D36A & 1) == 0 )
  {
    ...
    sub_1C93AD4(&CTouch_TypeInfo);
    sub_1C93AD4(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1C93AD4(&Method_FortuneBonusResultAction_StateTouchWait_update__);
    sub_1C93AD4(&TerminalSceneComponent_TypeInfo);
    sub_1C93AD4(&Method_FortuneBonusResultAction_StateTouchWait___c__DisplayClass1_0__update_b__0__);
    sub_1C93AD4(&FortuneBonusResultAction_StateTouchWait___c__DisplayClass1_0_TypeInfo);
    byte_4D2D36A = 1;
  }
  v4 = sub_1C93D20(FortuneBonusResultAction_StateTouchWait___c__DisplayClass1_0_TypeInfo);
      ...
      if ( isTouchPush )
      {
        ...
        if ( isTouchPush )
        {
          ...
          if ( (*((_BYTE *)Method_FortuneBonusResultAction_StateTouchWait_update__ + 83) & 2) != 0 )
            v14 = (_QWORD *)sub_1C93AEC(Method_FortuneBonusResultAction_StateTouchWait_update__);
...
void FortuneBonusResultAction___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C93D20(FortuneBonusResultAction___c_TypeInfo);
