        ...
        const MethodInfo *method)
{
  if ( (byte_4C3947A & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_24503/*"userCommandCodeId"*/);
    sub_1C32C20(&StringLiteral_20264/*"idx"*/);
    sub_1C32C20(&StringLiteral_16926/*"attachedUserCommandCodeId"*/);
    byte_4C3947A = 1;
  }
  ...
  RequestBase__addField_44144740((RequestBase_o *)this, (System_String_o *)StringLiteral_24503/*"userCommandCodeId"*/, userCommandCodeId, 0);
  RequestBase__addField_44144740(
    (RequestBase_o *)this,
    (System_String_o *)StringLiteral_16926/*"attachedUserCommandCodeId"*/,
...
System_String_o *CommandCodeAttachRequest__getURL(CommandCodeAttachRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C39479 & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_18150/*"commandCode/attach"*/);
    byte_4C39479 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63518544(BaseUrl, (System_String_o *)StringLiteral_18150/*"commandCode/attach"*/, 0);
}
