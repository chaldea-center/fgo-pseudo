        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A00265 & 1) == 0 )
  {
    sub_1B64A00(&StringLiteral_23614/*"svtId"*/, *(_QWORD *)&servantId);
    sub_1B64A00(&StringLiteral_24284/*"userCommandCodeId"*/, v11);
    sub_1B64A00(&StringLiteral_20137/*"idx"*/, v12);
    sub_1B64A00(&StringLiteral_16884/*"attachedUserCommandCodeId"*/, v13);
    byte_4A00265 = 1;
  }
  ...
  RequestBase__addField_40855016((RequestBase_o *)this, (System_String_o *)StringLiteral_24284/*"userCommandCodeId"*/, userCommandCodeId, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A00264 & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_18081/*"commandCode/attach"*/, v2);
    byte_4A00264 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61385136(BaseUrl, (System_String_o *)StringLiteral_18081/*"commandCode/attach"*/, 0LL);
}
