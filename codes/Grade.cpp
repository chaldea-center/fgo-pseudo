void __fastcall Grade___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B439BE & 1) == 0 )
  {
    sub_1BDB878(&Grade_TypeInfo, v1);
    sub_1BDB878(&string___TypeInfo, v2);
    sub_1BDB878(&StringLiteral_20457/*"img_listbg_04"*/, v3);
    sub_1BDB878(&StringLiteral_20454/*"img_listbg_01"*/, v4);
    sub_1BDB878(&StringLiteral_20464/*"img_mastername_line1"*/, v5);
    sub_1BDB878(&StringLiteral_20382/*"img_commonbg_04"*/, v6);
    sub_1BDB878(&StringLiteral_20222/*"icon_grade_1"*/, v7);
    sub_1BDB878(&StringLiteral_20467/*"img_masterprofile_bg2"*/, v8);
    sub_1BDB878(&StringLiteral_19671/*"frame_master_bg1"*/, v9);
    sub_1BDB878(&StringLiteral_20466/*"img_masterprofile_bg1"*/, v10);
    sub_1BDB878(&StringLiteral_23721/*"status_master_frame"*/, v11);
    sub_1BDB878(&StringLiteral_20456/*"img_listbg_03"*/, v12);
    sub_1BDB878(&StringLiteral_20463/*"img_masterform_bg"*/, v13);
    sub_1BDB878(&StringLiteral_20465/*"img_mastername_line2"*/, v14);
    sub_1BDB878(&StringLiteral_19670/*"frame_master_bg"*/, v15);
    sub_1BDB878(&StringLiteral_23722/*"status_master_frame1"*/, v16);
    byte_4B439BE = 1;
  }
  v17 = sub_1BDB920(string___TypeInfo, 2LL);
  if ( !v17 )
    goto LABEL_28;
  v21 = (struct System_String_array *)v17;
  if ( *(_DWORD *)(v17 + 24) <= 1u )
    goto LABEL_27;
  v22 = StringLiteral_20222/*"icon_grade_1"*/;
  *(_QWORD *)(v17 + 40) = StringLiteral_20222/*"icon_grade_1"*/;
  sub_1BDB81C((CGThumbnailListItem_o *)(v17 + 40), v22, v19, v20);
  Grade_TypeInfo->static_fields->gradeIconFileList = v21;
  sub_1BDB81C((CGThumbnailListItem_o *)Grade_TypeInfo->static_fields, (int32_t)v21, v23, v24);
  v17 = sub_1BDB920(string___TypeInfo, 2LL);
  if ( !v17 )
    goto LABEL_28;
  v26 = v17;
  if ( !*(_DWORD *)(v17 + 24) )
    goto LABEL_27;
  v27 = StringLiteral_20466/*"img_masterprofile_bg1"*/;
  *(_QWORD *)(v17 + 32) = StringLiteral_20466/*"img_masterprofile_bg1"*/;
  sub_1BDB81C((CGThumbnailListItem_o *)(v17 + 32), v27, v19, v25);
  if ( *(_DWORD *)(v26 + 24) <= 1u )
    goto LABEL_27;
  v29 = StringLiteral_20467/*"img_masterprofile_bg2"*/;
  *(_QWORD *)(v26 + 40) = StringLiteral_20467/*"img_masterprofile_bg2"*/;
  sub_1BDB81C((CGThumbnailListItem_o *)(v26 + 40), v29, v19, v28);
  static_fields = Grade_TypeInfo->static_fields;
  static_fields->masterProfileBgFileList = (struct System_String_array *)v26;
  sub_1BDB81C((CGThumbnailListItem_o *)&static_fields->masterProfileBgFileList, v26, v31, v32);
  v17 = sub_1BDB920(string___TypeInfo, 2LL);
  if ( !v17 )
    goto LABEL_28;
  v34 = v17;
  if ( !*(_DWORD *)(v17 + 24) )
    goto LABEL_27;
  v35 = StringLiteral_20464/*"img_mastername_line1"*/;
  *(_QWORD *)(v17 + 32) = StringLiteral_20464/*"img_mastername_line1"*/;
  sub_1BDB81C((CGThumbnailListItem_o *)(v17 + 32), v35, v19, v33);
  if ( *(_DWORD *)(v34 + 24) <= 1u )
    goto LABEL_27;
  v37 = StringLiteral_20465/*"img_mastername_line2"*/;
  *(_QWORD *)(v34 + 40) = StringLiteral_20465/*"img_mastername_line2"*/;
  sub_1BDB81C((CGThumbnailListItem_o *)(v34 + 40), v37, v19, v36);
  v38 = Grade_TypeInfo->static_fields;
  v38->masterProfileBgLineFileList = (struct System_String_array *)v34;
  sub_1BDB81C((CGThumbnailListItem_o *)&v38->masterProfileBgLineFileList, v34, v39, v40);
  v17 = sub_1BDB920(string___TypeInfo, 2LL);
  if ( !v17 )
    goto LABEL_28;
  v42 = v17;
  if ( !*(_DWORD *)(v17 + 24) )
    goto LABEL_27;
  v43 = StringLiteral_20382/*"img_commonbg_04"*/;
  *(_QWORD *)(v17 + 32) = StringLiteral_20382/*"img_commonbg_04"*/;
  sub_1BDB81C((CGThumbnailListItem_o *)(v17 + 32), v43, v19, v41);
  if ( *(_DWORD *)(v42 + 24) <= 1u )
    goto LABEL_27;
  v45 = StringLiteral_20463/*"img_masterform_bg"*/;
  *(_QWORD *)(v42 + 40) = StringLiteral_20463/*"img_masterform_bg"*/;
  sub_1BDB81C((CGThumbnailListItem_o *)(v42 + 40), v45, v19, v44);
  v46 = Grade_TypeInfo->static_fields;
  v46->masterEquipBgFileList = (struct System_String_array *)v42;
  sub_1BDB81C((CGThumbnailListItem_o *)&v46->masterEquipBgFileList, v42, v47, v48);
  v17 = sub_1BDB920(string___TypeInfo, 2LL);
  if ( !v17 )
    goto LABEL_28;
  v50 = v17;
  if ( !*(_DWORD *)(v17 + 24) )
    goto LABEL_27;
  v51 = StringLiteral_19670/*"frame_master_bg"*/;
  *(_QWORD *)(v17 + 32) = StringLiteral_19670/*"frame_master_bg"*/;
  sub_1BDB81C((CGThumbnailListItem_o *)(v17 + 32), v51, v19, v49);
  if ( *(_DWORD *)(v50 + 24) <= 1u )
    goto LABEL_27;
  v53 = StringLiteral_19671/*"frame_master_bg1"*/;
  *(_QWORD *)(v50 + 40) = StringLiteral_19671/*"frame_master_bg1"*/;
  sub_1BDB81C((CGThumbnailListItem_o *)(v50 + 40), v53, v19, v52);
  v54 = Grade_TypeInfo->static_fields;
  v54->battleIconBgFileList = (struct System_String_array *)v50;
  sub_1BDB81C((CGThumbnailListItem_o *)&v54->battleIconBgFileList, v50, v55, v56);
  v17 = sub_1BDB920(string___TypeInfo, 2LL);
  if ( !v17 )
    goto LABEL_28;
  v58 = v17;
  if ( !*(_DWORD *)(v17 + 24) )
    goto LABEL_27;
  v59 = StringLiteral_23721/*"status_master_frame"*/;
  *(_QWORD *)(v17 + 32) = StringLiteral_23721/*"status_master_frame"*/;
  sub_1BDB81C((CGThumbnailListItem_o *)(v17 + 32), v59, v19, v57);
  if ( *(_DWORD *)(v58 + 24) <= 1u )
    goto LABEL_27;
  v61 = StringLiteral_23722/*"status_master_frame1"*/;
  *(_QWORD *)(v58 + 40) = StringLiteral_23722/*"status_master_frame1"*/;
  sub_1BDB81C((CGThumbnailListItem_o *)(v58 + 40), v61, v19, v60);
  v62 = Grade_TypeInfo->static_fields;
  v62->mainMstIconBgFileList = (struct System_String_array *)v58;
  sub_1BDB81C((CGThumbnailListItem_o *)&v62->mainMstIconBgFileList, v58, v63, v64);
  v17 = sub_1BDB920(string___TypeInfo, 2LL);
  if ( !v17 )
    goto LABEL_28;
  v66 = v17;
  if ( !*(_DWORD *)(v17 + 24)
    || (v67 = StringLiteral_20454/*"img_listbg_01"*/,
        *(_QWORD *)(v17 + 32) = StringLiteral_20454/*"img_listbg_01"*/,
        sub_1BDB81C((CGThumbnailListItem_o *)(v17 + 32), v67, v19, v65),
        *(_DWORD *)(v66 + 24) <= 1u) )
  {
LABEL_27:
    sub_1BDBADC(v17, v18, v19);
  }
  v69 = StringLiteral_20456/*"img_listbg_03"*/;
  *(_QWORD *)(v66 + 40) = StringLiteral_20456/*"img_listbg_03"*/;
  sub_1BDB81C((CGThumbnailListItem_o *)(v66 + 40), v69, v19, v68);
  v70 = Grade_TypeInfo->static_fields;
  v70->supportBgFileList = (struct System_String_array *)v66;
  sub_1BDB81C((CGThumbnailListItem_o *)&v70->supportBgFileList, v66, v71, v72);
  v17 = sub_1BDB920(string___TypeInfo, 2LL);
  if ( !v17 )
LABEL_28:
    sub_1BDBAD4(v17, v18);
  ...
  if ( !*(_DWORD *)(v17 + 24) )
    goto LABEL_27;
  v75 = StringLiteral_20454/*"img_listbg_01"*/;
  *(_QWORD *)(v17 + 32) = StringLiteral_20454/*"img_listbg_01"*/;
  sub_1BDB81C((CGThumbnailListItem_o *)(v17 + 32), v75, v19, v73);
  if ( *(_DWORD *)(v74 + 24) <= 1u )
    goto LABEL_27;
  v77 = StringLiteral_20457/*"img_listbg_04"*/;
  *(_QWORD *)(v74 + 40) = StringLiteral_20457/*"img_listbg_04"*/;
  sub_1BDB81C((CGThumbnailListItem_o *)(v74 + 40), v77, v19, v76);
  v78 = Grade_TypeInfo->static_fields;
  v78->followerBgFileList = (struct System_String_array *)v74;
  sub_1BDB81C((CGThumbnailListItem_o *)&v78->followerBgFileList, v74, v79, v80);
}
...
System_String_o *__fastcall Grade__GetBattleIconBgImage(int32_t gradeKind, const MethodInfo *method)
{
  ...
  if ( (byte_4B439BA & 1) == 0 )
  {
    sub_1BDB878(&Grade_TypeInfo, method);
    byte_4B439BA = 1;
  }
  v4 = Grade_TypeInfo;
...
int32_t __fastcall Grade__GetKind(const MethodInfo *method)
{
  ...
  return TutorialFlag__Get_39449392(127, v1);
}


int32_t __fastcall Grade__GetKind_39449476(UserGameEntity_o *userGameEntity, const MethodInfo *method)
{
...
int32_t __fastcall Grade__GetKind_39449696(OtherUserGameEntity_o *otherUserGameEntity, const MethodInfo *method)
{
  TutorialFlag_c *v3; // x0
...
int32_t __fastcall Grade__GetKind_39449888(FollowerInfo_o *followerInfo, const MethodInfo *method)
{
  TutorialFlag_c *v3; // x0
