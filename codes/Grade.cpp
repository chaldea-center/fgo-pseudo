void Grade___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CB519C & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_20511/*"img_listbg_04"*/);
    sub_1C6BA08(&StringLiteral_20508/*"img_listbg_01"*/);
    sub_1C6BA08(&StringLiteral_20518/*"img_mastername_line1"*/);
    sub_1C6BA08(&StringLiteral_20432/*"img_commonbg_04"*/);
    sub_1C6BA08(&StringLiteral_20268/*"icon_grade_1"*/);
    sub_1C6BA08(&StringLiteral_20521/*"img_masterprofile_bg2"*/);
    sub_1C6BA08(&StringLiteral_19721/*"frame_master_bg1"*/);
    sub_1C6BA08(&StringLiteral_20520/*"img_masterprofile_bg1"*/);
    sub_1C6BA08(&StringLiteral_23785/*"status_master_frame"*/);
    sub_1C6BA08(&StringLiteral_20510/*"img_listbg_03"*/);
    sub_1C6BA08(&StringLiteral_20517/*"img_masterform_bg"*/);
    sub_1C6BA08(&StringLiteral_20519/*"img_mastername_line2"*/);
    sub_1C6BA08(&StringLiteral_19720/*"frame_master_bg"*/);
    sub_1C6BA08(&StringLiteral_23786/*"status_master_frame1"*/);
    byte_4CB519C = 1;
  }
  ...
  if ( *(_DWORD *)(v1 + 24) <= 1u )
    goto LABEL_27;
  v6 = StringLiteral_20268/*"icon_grade_1"*/;
  *(_QWORD *)(v1 + 40) = StringLiteral_20268/*"icon_grade_1"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)(v1 + 40), v6, v3, v4);
  Grade_TypeInfo->static_fields->gradeIconFileList = v5;
  sub_1C6B9AC((CGThumbnailListItem_o *)Grade_TypeInfo->static_fields, (int32_t)v5, v7, v8);
  v1 = sub_1C6BAB0(string___TypeInfo, 2);
  if ( !v1 )
    goto LABEL_28;
  v11 = v1;
  if ( !*(_DWORD *)(v1 + 24) )
    goto LABEL_27;
  v12 = StringLiteral_20520/*"img_masterprofile_bg1"*/;
  *(_QWORD *)(v1 + 32) = StringLiteral_20520/*"img_masterprofile_bg1"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)(v1 + 32), v12, v9, v10);
  if ( *(_DWORD *)(v11 + 24) <= 1u )
    goto LABEL_27;
  v15 = StringLiteral_20521/*"img_masterprofile_bg2"*/;
  *(_QWORD *)(v11 + 40) = StringLiteral_20521/*"img_masterprofile_bg2"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)(v11 + 40), v15, v13, v14);
  static_fields = Grade_TypeInfo->static_fields;
  static_fields->masterProfileBgFileList = (struct System_String_array *)v11;
  sub_1C6B9AC((CGThumbnailListItem_o *)&static_fields->masterProfileBgFileList, v11, v17, v18);
  v1 = sub_1C6BAB0(string___TypeInfo, 2);
  if ( !v1 )
    goto LABEL_28;
  v21 = v1;
  if ( !*(_DWORD *)(v1 + 24) )
    goto LABEL_27;
  v22 = StringLiteral_20518/*"img_mastername_line1"*/;
  *(_QWORD *)(v1 + 32) = StringLiteral_20518/*"img_mastername_line1"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)(v1 + 32), v22, v19, v20);
  if ( *(_DWORD *)(v21 + 24) <= 1u )
    goto LABEL_27;
  v25 = StringLiteral_20519/*"img_mastername_line2"*/;
  *(_QWORD *)(v21 + 40) = StringLiteral_20519/*"img_mastername_line2"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)(v21 + 40), v25, v23, v24);
  v26 = Grade_TypeInfo->static_fields;
  v26->masterProfileBgLineFileList = (struct System_String_array *)v21;
  sub_1C6B9AC((CGThumbnailListItem_o *)&v26->masterProfileBgLineFileList, v21, v27, v28);
  v1 = sub_1C6BAB0(string___TypeInfo, 2);
  if ( !v1 )
    goto LABEL_28;
  v31 = v1;
  if ( !*(_DWORD *)(v1 + 24) )
    goto LABEL_27;
  v32 = StringLiteral_20432/*"img_commonbg_04"*/;
  *(_QWORD *)(v1 + 32) = StringLiteral_20432/*"img_commonbg_04"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)(v1 + 32), v32, v29, v30);
  if ( *(_DWORD *)(v31 + 24) <= 1u )
    goto LABEL_27;
  v35 = StringLiteral_20517/*"img_masterform_bg"*/;
  *(_QWORD *)(v31 + 40) = StringLiteral_20517/*"img_masterform_bg"*/;
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&v36->masterEquipBgFileList, v31, v37, v38);
  v1 = sub_1C6BAB0(string___TypeInfo, 2);
  if ( !v1 )
    goto LABEL_28;
  v41 = v1;
  if ( !*(_DWORD *)(v1 + 24) )
    goto LABEL_27;
  v42 = StringLiteral_19720/*"frame_master_bg"*/;
  *(_QWORD *)(v1 + 32) = StringLiteral_19720/*"frame_master_bg"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)(v1 + 32), v42, v39, v40);
  if ( *(_DWORD *)(v41 + 24) <= 1u )
    goto LABEL_27;
  v45 = StringLiteral_19721/*"frame_master_bg1"*/;
  *(_QWORD *)(v41 + 40) = StringLiteral_19721/*"frame_master_bg1"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)(v41 + 40), v45, v43, v44);
  v46 = Grade_TypeInfo->static_fields;
  v46->battleIconBgFileList = (struct System_String_array *)v41;
  sub_1C6B9AC((CGThumbnailListItem_o *)&v46->battleIconBgFileList, v41, v47, v48);
  v1 = sub_1C6BAB0(string___TypeInfo, 2);
  if ( !v1 )
    goto LABEL_28;
  v51 = v1;
  if ( !*(_DWORD *)(v1 + 24) )
    goto LABEL_27;
  v52 = StringLiteral_23785/*"status_master_frame"*/;
  *(_QWORD *)(v1 + 32) = StringLiteral_23785/*"status_master_frame"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)(v1 + 32), v52, v49, v50);
  if ( *(_DWORD *)(v51 + 24) <= 1u )
    goto LABEL_27;
  v55 = StringLiteral_23786/*"status_master_frame1"*/;
  *(_QWORD *)(v51 + 40) = StringLiteral_23786/*"status_master_frame1"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)(v51 + 40), v55, v53, v54);
  v56 = Grade_TypeInfo->static_fields;
  v56->mainMstIconBgFileList = (struct System_String_array *)v51;
  sub_1C6B9AC((CGThumbnailListItem_o *)&v56->mainMstIconBgFileList, v51, v57, v58);
  v1 = sub_1C6BAB0(string___TypeInfo, 2);
  if ( !v1 )
    goto LABEL_28;
  v61 = v1;
  if ( !*(_DWORD *)(v1 + 24)
    || (v62 = StringLiteral_20508/*"img_listbg_01"*/,
        *(_QWORD *)(v1 + 32) = StringLiteral_20508/*"img_listbg_01"*/,
        sub_1C6B9AC((CGThumbnailListItem_o *)(v1 + 32), v62, v59, v60),
        *(_DWORD *)(v61 + 24) <= 1u) )
  {
LABEL_27:
    sub_1C6BC68(v1);
  }
  v65 = StringLiteral_20510/*"img_listbg_03"*/;
  *(_QWORD *)(v61 + 40) = StringLiteral_20510/*"img_listbg_03"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)(v61 + 40), v65, v63, v64);
  v66 = Grade_TypeInfo->static_fields;
  v66->supportBgFileList = (struct System_String_array *)v61;
  sub_1C6B9AC((CGThumbnailListItem_o *)&v66->supportBgFileList, v61, v67, v68);
  v1 = sub_1C6BAB0(string___TypeInfo, 2);
  if ( !v1 )
LABEL_28:
    sub_1C6BC60(v1, v2);
  ...
  if ( !*(_DWORD *)(v1 + 24) )
    goto LABEL_27;
  v72 = StringLiteral_20508/*"img_listbg_01"*/;
  *(_QWORD *)(v1 + 32) = StringLiteral_20508/*"img_listbg_01"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)(v1 + 32), v72, v69, v70);
  if ( *(_DWORD *)(v71 + 24) <= 1u )
    goto LABEL_27;
  v75 = StringLiteral_20511/*"img_listbg_04"*/;
  *(_QWORD *)(v71 + 40) = StringLiteral_20511/*"img_listbg_04"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)(v71 + 40), v75, v73, v74);
  v76 = Grade_TypeInfo->static_fields;
  v76->followerBgFileList = (struct System_String_array *)v71;
  sub_1C6B9AC((CGThumbnailListItem_o *)&v76->followerBgFileList, v71, v77, v78);
}
...
int32_t Grade__GetKind(const MethodInfo *method)
{
  ...
  return TutorialFlag__Get_40657328(127, v1);
}


int32_t Grade__GetKind_40657412(UserGameEntity_o *userGameEntity, const MethodInfo *method)
{
...
int32_t Grade__GetKind_40657632(OtherUserGameEntity_o *otherUserGameEntity, const MethodInfo *method)
{
  TutorialFlag_c *v3; // x0
...
int32_t Grade__GetKind_40657824(FollowerInfo_o *followerInfo, const MethodInfo *method)
{
  TutorialFlag_c *v3; // x0
