void Grade___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C368A9 & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_20443/*"img_listbg_04"*/);
    sub_1C32C20(&StringLiteral_20440/*"img_listbg_01"*/);
    sub_1C32C20(&StringLiteral_20450/*"img_mastername_line1"*/);
    sub_1C32C20(&StringLiteral_20364/*"img_commonbg_04"*/);
    sub_1C32C20(&StringLiteral_20201/*"icon_grade_1"*/);
    sub_1C32C20(&StringLiteral_20453/*"img_masterprofile_bg2"*/);
    sub_1C32C20(&StringLiteral_19655/*"frame_master_bg1"*/);
    sub_1C32C20(&StringLiteral_20452/*"img_masterprofile_bg1"*/);
    sub_1C32C20(&StringLiteral_23687/*"status_master_frame"*/);
    sub_1C32C20(&StringLiteral_20442/*"img_listbg_03"*/);
    sub_1C32C20(&StringLiteral_20449/*"img_masterform_bg"*/);
    sub_1C32C20(&StringLiteral_20451/*"img_mastername_line2"*/);
    sub_1C32C20(&StringLiteral_19654/*"frame_master_bg"*/);
    sub_1C32C20(&StringLiteral_23688/*"status_master_frame1"*/);
    byte_4C368A9 = 1;
  }
  ...
  if ( *(_DWORD *)(v1 + 24) <= 1u )
    goto LABEL_27;
  v5 = StringLiteral_20201/*"icon_grade_1"*/;
  *(_QWORD *)(v1 + 40) = StringLiteral_20201/*"icon_grade_1"*/;
  sub_1C32BC4((CGThumbnailListItem_o *)(v1 + 40), v5, v2, v3);
  Grade_TypeInfo->static_fields->gradeIconFileList = v4;
  sub_1C32BC4((CGThumbnailListItem_o *)Grade_TypeInfo->static_fields, (int32_t)v4, v6, v7);
  v1 = sub_1C32CC8(string___TypeInfo, 2);
  if ( !v1 )
    goto LABEL_28;
  v10 = v1;
  if ( !*(_DWORD *)(v1 + 24) )
    goto LABEL_27;
  v11 = StringLiteral_20452/*"img_masterprofile_bg1"*/;
  *(_QWORD *)(v1 + 32) = StringLiteral_20452/*"img_masterprofile_bg1"*/;
  sub_1C32BC4((CGThumbnailListItem_o *)(v1 + 32), v11, v8, v9);
  if ( *(_DWORD *)(v10 + 24) <= 1u )
    goto LABEL_27;
  v14 = StringLiteral_20453/*"img_masterprofile_bg2"*/;
  *(_QWORD *)(v10 + 40) = StringLiteral_20453/*"img_masterprofile_bg2"*/;
  sub_1C32BC4((CGThumbnailListItem_o *)(v10 + 40), v14, v12, v13);
  static_fields = Grade_TypeInfo->static_fields;
  static_fields->masterProfileBgFileList = (struct System_String_array *)v10;
  sub_1C32BC4((CGThumbnailListItem_o *)&static_fields->masterProfileBgFileList, v10, v16, v17);
  v1 = sub_1C32CC8(string___TypeInfo, 2);
  if ( !v1 )
    goto LABEL_28;
  v20 = v1;
  if ( !*(_DWORD *)(v1 + 24) )
    goto LABEL_27;
  v21 = StringLiteral_20450/*"img_mastername_line1"*/;
  *(_QWORD *)(v1 + 32) = StringLiteral_20450/*"img_mastername_line1"*/;
  sub_1C32BC4((CGThumbnailListItem_o *)(v1 + 32), v21, v18, v19);
  if ( *(_DWORD *)(v20 + 24) <= 1u )
    goto LABEL_27;
  v24 = StringLiteral_20451/*"img_mastername_line2"*/;
  *(_QWORD *)(v20 + 40) = StringLiteral_20451/*"img_mastername_line2"*/;
  sub_1C32BC4((CGThumbnailListItem_o *)(v20 + 40), v24, v22, v23);
  v25 = Grade_TypeInfo->static_fields;
  v25->masterProfileBgLineFileList = (struct System_String_array *)v20;
  sub_1C32BC4((CGThumbnailListItem_o *)&v25->masterProfileBgLineFileList, v20, v26, v27);
  v1 = sub_1C32CC8(string___TypeInfo, 2);
  if ( !v1 )
    goto LABEL_28;
  v30 = v1;
  if ( !*(_DWORD *)(v1 + 24) )
    goto LABEL_27;
  v31 = StringLiteral_20364/*"img_commonbg_04"*/;
  *(_QWORD *)(v1 + 32) = StringLiteral_20364/*"img_commonbg_04"*/;
  sub_1C32BC4((CGThumbnailListItem_o *)(v1 + 32), v31, v28, v29);
  if ( *(_DWORD *)(v30 + 24) <= 1u )
    goto LABEL_27;
  v34 = StringLiteral_20449/*"img_masterform_bg"*/;
  *(_QWORD *)(v30 + 40) = StringLiteral_20449/*"img_masterform_bg"*/;
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&v35->masterEquipBgFileList, v30, v36, v37);
  v1 = sub_1C32CC8(string___TypeInfo, 2);
  if ( !v1 )
    goto LABEL_28;
  v40 = v1;
  if ( !*(_DWORD *)(v1 + 24) )
    goto LABEL_27;
  v41 = StringLiteral_19654/*"frame_master_bg"*/;
  *(_QWORD *)(v1 + 32) = StringLiteral_19654/*"frame_master_bg"*/;
  sub_1C32BC4((CGThumbnailListItem_o *)(v1 + 32), v41, v38, v39);
  if ( *(_DWORD *)(v40 + 24) <= 1u )
    goto LABEL_27;
  v44 = StringLiteral_19655/*"frame_master_bg1"*/;
  *(_QWORD *)(v40 + 40) = StringLiteral_19655/*"frame_master_bg1"*/;
  sub_1C32BC4((CGThumbnailListItem_o *)(v40 + 40), v44, v42, v43);
  v45 = Grade_TypeInfo->static_fields;
  v45->battleIconBgFileList = (struct System_String_array *)v40;
  sub_1C32BC4((CGThumbnailListItem_o *)&v45->battleIconBgFileList, v40, v46, v47);
  v1 = sub_1C32CC8(string___TypeInfo, 2);
  if ( !v1 )
    goto LABEL_28;
  v50 = v1;
  if ( !*(_DWORD *)(v1 + 24) )
    goto LABEL_27;
  v51 = StringLiteral_23687/*"status_master_frame"*/;
  *(_QWORD *)(v1 + 32) = StringLiteral_23687/*"status_master_frame"*/;
  sub_1C32BC4((CGThumbnailListItem_o *)(v1 + 32), v51, v48, v49);
  if ( *(_DWORD *)(v50 + 24) <= 1u )
    goto LABEL_27;
  v54 = StringLiteral_23688/*"status_master_frame1"*/;
  *(_QWORD *)(v50 + 40) = StringLiteral_23688/*"status_master_frame1"*/;
  sub_1C32BC4((CGThumbnailListItem_o *)(v50 + 40), v54, v52, v53);
  v55 = Grade_TypeInfo->static_fields;
  v55->mainMstIconBgFileList = (struct System_String_array *)v50;
  sub_1C32BC4((CGThumbnailListItem_o *)&v55->mainMstIconBgFileList, v50, v56, v57);
  v1 = sub_1C32CC8(string___TypeInfo, 2);
  if ( !v1 )
    goto LABEL_28;
  v60 = v1;
  if ( !*(_DWORD *)(v1 + 24)
    || (v61 = StringLiteral_20440/*"img_listbg_01"*/,
        *(_QWORD *)(v1 + 32) = StringLiteral_20440/*"img_listbg_01"*/,
        sub_1C32BC4((CGThumbnailListItem_o *)(v1 + 32), v61, v58, v59),
        *(_DWORD *)(v60 + 24) <= 1u) )
  {
LABEL_27:
    sub_1C32E84(v1);
  }
  v64 = StringLiteral_20442/*"img_listbg_03"*/;
  *(_QWORD *)(v60 + 40) = StringLiteral_20442/*"img_listbg_03"*/;
  sub_1C32BC4((CGThumbnailListItem_o *)(v60 + 40), v64, v62, v63);
  v65 = Grade_TypeInfo->static_fields;
  v65->supportBgFileList = (struct System_String_array *)v60;
  sub_1C32BC4((CGThumbnailListItem_o *)&v65->supportBgFileList, v60, v66, v67);
  v1 = sub_1C32CC8(string___TypeInfo, 2);
  if ( !v1 )
LABEL_28:
    sub_1C32E7C(v1);
  ...
  if ( !*(_DWORD *)(v1 + 24) )
    goto LABEL_27;
  v71 = StringLiteral_20440/*"img_listbg_01"*/;
  *(_QWORD *)(v1 + 32) = StringLiteral_20440/*"img_listbg_01"*/;
  sub_1C32BC4((CGThumbnailListItem_o *)(v1 + 32), v71, v68, v69);
  if ( *(_DWORD *)(v70 + 24) <= 1u )
    goto LABEL_27;
  v74 = StringLiteral_20443/*"img_listbg_04"*/;
  *(_QWORD *)(v70 + 40) = StringLiteral_20443/*"img_listbg_04"*/;
  sub_1C32BC4((CGThumbnailListItem_o *)(v70 + 40), v74, v72, v73);
  v75 = Grade_TypeInfo->static_fields;
  v75->followerBgFileList = (struct System_String_array *)v70;
  sub_1C32BC4((CGThumbnailListItem_o *)&v75->followerBgFileList, v70, v76, v77);
}
...
int32_t Grade__GetKind(const MethodInfo *method)
{
  ...
  return TutorialFlag__Get_40328320(127, v1);
}


int32_t Grade__GetKind_40328404(UserGameEntity_o *userGameEntity, const MethodInfo *method)
{
...
int32_t Grade__GetKind_40328624(OtherUserGameEntity_o *otherUserGameEntity, const MethodInfo *method)
{
  TutorialFlag_c *v3; // x0
...
int32_t Grade__GetKind_40328816(FollowerInfo_o *followerInfo, const MethodInfo *method)
{
  TutorialFlag_c *v3; // x0
