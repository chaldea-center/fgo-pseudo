void __fastcall AiMaster___ctor(AiMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A4E0AE & 1) == 0 )
  {
    sub_1B863B8(&Method_DataMasterBase_AiMaster__AiEntity__string___ctor__, method);
    byte_4A4E0AE = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    109,
    (const MethodInfo_3216A14 *)Method_DataMasterBase_AiMaster__AiEntity__string___ctor__);
}
...
AiEntity_o *__fastcall AiMaster__GetEntity(AiMaster_o *this, int32_t id, int32_t idx, const MethodInfo *method)
{
  ...
  if ( (byte_4A4E0AC & 1) == 0 )
  {
    sub_1B863B8(&Method_DataMasterBase_AiMaster__AiEntity__string__GetEntity__, *(_QWORD *)&id);
    byte_4A4E0AC = 1;
  }
  ...
  return (AiEntity_o *)DataMasterBase_object__object__object___GetEntity(
                         (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                         PK,
                         (const MethodInfo_3218D38 *)Method_DataMasterBase_AiMaster__AiEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4E0AD & 1) == 0 )
  {
    sub_1B863B8(&Method_DataMasterBase_AiMaster__AiEntity__string__TryGetEntity__, entity);
    byte_4A4E0AD = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_3218D84 *)Method_DataMasterBase_AiMaster__AiEntity__string__TryGetEntity__);
}
...
AiEntity_array *__fastcall AiMaster__getListFormGroupId(int32_t id, const MethodInfo *method)
{
  ...
  if ( (byte_4A4E0AF & 1) == 0 )
  {
    sub_1B863B8(&AiEntity_TypeInfo, method);
    sub_1B863B8(&Method_System_Collections_ObjectModel_Collection_AiEntity__GetEnumerator__, v3);
    sub_1B863B8(&Method_DataManager_GetMasterData_AiMaster___, v4);
    sub_1B863B8(&System_IDisposable_TypeInfo, v5);
    sub_1B863B8(&System_Collections_Generic_IEnumerator_AiEntity__TypeInfo, v6);
    sub_1B863B8(&System_Collections_IEnumerator_TypeInfo, v7);
    sub_1B863B8(&Method_System_Collections_Generic_List_AiEntity__Add__, v8);
    sub_1B863B8(&Method_System_Collections_Generic_List_AiEntity__ToArray__, v9);
    sub_1B863B8(&Method_System_Collections_Generic_List_AiEntity___ctor__, v10);
    sub_1B863B8(&System_Collections_Generic_List_AiEntity__TypeInfo, v11);
    sub_1B863B8(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v12);
    byte_4A4E0AF = 1;
  }
  v13 = (System_Collections_Generic_List_object__o *)sub_1B86604(System_Collections_Generic_List_AiEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v13,
    (const MethodInfo_35FC124 *)Method_System_Collections_Generic_List_AiEntity___ctor__);
  ...
  Instance = (DataManager_o *)DataManager__GetMasterData_object_(
                                Instance,
                                (const MethodInfo_2F6DCB8 *)Method_DataManager_GetMasterData_AiMaster___);
  if ( !Instance )
    goto LABEL_41;
  ...
  Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                 ...
                 (const MethodInfo_31B0EE0 *)Method_System_Collections_ObjectModel_Collection_AiEntity__GetEnumerator__);
  if ( !Enumerator )
    sub_1B86614(0LL, v16);
  while ( 1 )
  {
...
LABEL_11:
    ...
    {
LABEL_18:
      v25 = sub_1BD6B4C(Enumerator, System_Collections_Generic_IEnumerator_AiEntity__TypeInfo, 0LL);
    }
...
LABEL_38:
    ...
    {
      if ( !v13 )
        sub_1B86614(v26, AiEntity_TypeInfo);
...
LABEL_41:
  ...
  return (AiEntity_array *)System_Collections_Generic_List_object___ToArray(
                             v13,
                             (const MethodInfo_35FE4B0 *)Method_System_Collections_Generic_List_AiEntity__ToArray__);
}