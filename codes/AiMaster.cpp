void __fastcall AiMaster___ctor(AiMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B15E1D & 1) == 0 )
  {
    sub_1BCA7E0(&Method_DataMasterBase_AiMaster__AiEntity__string___ctor__, method, v2);
    byte_4B15E1D = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    105,
    (const MethodInfo_31B3158 *)Method_DataMasterBase_AiMaster__AiEntity__string___ctor__);
}
...
AiEntity_o *__fastcall AiMaster__GetEntity(AiMaster_o *this, int32_t id, int32_t idx, const MethodInfo *method)
{
  ...
  if ( (byte_4B15E1B & 1) == 0 )
  {
    sub_1BCA7E0(&Method_DataMasterBase_AiMaster__AiEntity__string__GetEntity__, *(_QWORD *)&id, *(_QWORD *)&idx);
    byte_4B15E1B = 1;
  }
  ...
  return (AiEntity_o *)DataMasterBase_object__object__object___GetEntity(
                         (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                         PK,
                         (const MethodInfo_31B3198 *)Method_DataMasterBase_AiMaster__AiEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B15E1C & 1) == 0 )
  {
    sub_1BCA7E0(&Method_DataMasterBase_AiMaster__AiEntity__string__TryGetEntity__, entity, *(_QWORD *)&id);
    byte_4B15E1C = 1;
  }
  PK = (Il2CppObject *)AiBaseEntity__CreatePK(id, idx, 0LL);
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_31B31E8 *)Method_DataMasterBase_AiMaster__AiEntity__string__TryGetEntity__);
}
...
AiEntity_array *__fastcall AiMaster__getListFormGroupId(int32_t id, const MethodInfo *method)
{
  ...
  if ( (byte_4B15E1E & 1) == 0 )
  {
    sub_1BCA7E0(&AiEntity_TypeInfo, method, v2);
    sub_1BCA7E0(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__GetEnumerator__, v5, v6);
    sub_1BCA7E0(&Method_DataManager_GetMasterData_AiMaster___, v7, v8);
    ...
    sub_1BCA7E0(&Method_System_Collections_Generic_List_AiEntity__Add__, v15, v16);
    sub_1BCA7E0(&Method_System_Collections_Generic_List_AiEntity__ToArray__, v17, v18);
    sub_1BCA7E0(&Method_System_Collections_Generic_List_AiEntity___ctor__, v19, v20);
    sub_1BCA7E0(&System_Collections_Generic_List_AiEntity__TypeInfo, v21, v22);
  ...
  System_Collections_Generic_List_object____ctor(
    v25,
    (const MethodInfo_35A1428 *)Method_System_Collections_Generic_List_AiEntity___ctor__);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37DEB14 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_41;
  Instance = DataManager__GetMasterData_object_(
               (DataManager_o *)Instance,
               (const MethodInfo_2F12C90 *)Method_DataManager_GetMasterData_AiMaster___);
  if ( !Instance )
    goto LABEL_41;
...
LABEL_18:
    ...
    if ( *(unsigned __int8 *)(*(_QWORD *)v38 + 304LL) < (unsigned int)methodPtr_low
      || *(AiEntity_c **)(*(_QWORD *)(*(_QWORD *)v38 + 200LL) + 8 * methodPtr_low - 8) != AiEntity_TypeInfo )
    {
      sub_1BCACFC(v38);
LABEL_38:
      sub_1BCAA3C(v38, v39);
    ...
    {
      if ( !v25 )
        sub_1BCAA3C(v38, AiEntity_TypeInfo);
      items = v25->fields._items;
      v50 = Method_System_Collections_Generic_List_AiEntity__Add__;
      ++v25->fields._version;
      if ( !items )
        sub_1BCAA3C(v38, v47);
...
LABEL_41:
  ...
  return (AiEntity_array *)System_Collections_Generic_List_object___ToArray(
                             v25,
                             (const MethodInfo_35A37B4 *)Method_System_Collections_Generic_List_AiEntity__ToArray__);
}