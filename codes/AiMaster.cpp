void __fastcall AiMaster___ctor(AiMaster_o *this, const MethodInfo *method)
{
  if ( (byte_434FC09 & 1) == 0 )
  {
    sub_B70694(&Method_DataMasterBase_AiMaster__AiEntity__string___ctor__);
    byte_434FC09 = 1;
  }
  DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string____ctor(
    (DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string__o *)this,
    104,
    (const MethodInfo_21C07F4 *)Method_DataMasterBase_AiMaster__AiEntity__string___ctor__);
}
...
AiEntity_o *__fastcall AiMaster__GetEntity(AiMaster_o *this, int32_t id, int32_t idx, const MethodInfo *method)
{
  ...
  if ( (byte_434FC07 & 1) == 0 )
  {
    sub_B70694(&Method_DataMasterBase_AiMaster__AiEntity__string__GetEntity__);
    byte_434FC07 = 1;
  }
  ...
  return (AiEntity_o *)DataMasterBase_WarMessageMaster__WarMessageEntity__string___GetEntity(
                         ...
                         PK,
                         (const MethodInfo_21C0890 *)Method_DataMasterBase_AiMaster__AiEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_434FC08 & 1) == 0 )
  {
    sub_B70694(&Method_DataMasterBase_AiMaster__AiEntity__string__TryGetEntity__);
    byte_434FC08 = 1;
  }
  ...
  return DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string___TryGetEntity(
           ...
           PK,
           (const MethodInfo_21C08E8 *)Method_DataMasterBase_AiMaster__AiEntity__string__TryGetEntity__);
}
...
AiEntity_array *__fastcall AiMaster__getListFormGroupId(int32_t id, const MethodInfo *method)
{
  ...
  if ( (byte_434FC0A & 1) == 0 )
  {
    ...
    sub_B70694(&Method_DataManager_GetMasterData_AiMaster___);
    sub_B70694(&System_IDisposable_TypeInfo);
    sub_B70694(&System_Collections_Generic_IEnumerator_DataEntityBase__TypeInfo);
    sub_B70694(&System_Collections_IEnumerator_TypeInfo);
    sub_B70694(&Method_System_Collections_Generic_List_AiEntity__Add__);
    sub_B70694(&Method_System_Collections_Generic_List_AiEntity__ToArray__);
    sub_B70694(&Method_System_Collections_Generic_List_AiEntity___ctor__);
    sub_B70694(&System_Collections_Generic_List_AiEntity__TypeInfo);
    sub_B70694(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_434FC0A = 1;
  }
  v3 = (System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData__o *)sub_B70764(System_Collections_Generic_List_AiEntity__TypeInfo);
  System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData____ctor(
    v3,
    (const MethodInfo_30249C4 *)Method_System_Collections_Generic_List_AiEntity___ctor__);
  Instance = (DataManager_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2CE992C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_37;
  Instance = (DataManager_o *)DataManager__GetMasterData_WarQuestSelectionMaster_(
                                Instance,
                                (const MethodInfo_1CA35A0 *)Method_DataManager_GetMasterData_AiMaster___);
  if ( !Instance )
    goto LABEL_37;
...
LABEL_18:
    ...
    if ( *(&v16->klass->_2.bitflags2 + 1) < (unsigned int)v18
      || (AiEntity_c *)v16->klass->_2.typeHierarchy[v18 - 1] != AiEntity_TypeInfo )
    {
...
LABEL_35:
    ...
    {
      if ( !v3 )
        sub_B7076C(v16, AiEntity_TypeInfo);
      System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData___Add(
        v3,
        v16,
        (const MethodInfo_3025688 *)Method_System_Collections_Generic_List_AiEntity__Add__);
    }
  }
...
LABEL_37:
  ...
  return (AiEntity_array *)System_Collections_Generic_List_WarBoardUiData_SaveData___ToArray(
                             ...
                             (const MethodInfo_30277D4 *)Method_System_Collections_Generic_List_AiEntity__ToArray__);
}