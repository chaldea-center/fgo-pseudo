        ...
        const MethodInfo *method)
{
  ...
  sub_B52920(&this->fields.configuration);
  this->fields.playing = playingGo;
  sub_B52920(&this->fields.playing);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AC7BB & 1) == 0 )
  {
    sub_B52984(&Method_UnityEngine_GameObject_GetComponent_WarBoardPlayingUIController___);
    sub_B52984(&UnityEngine_Object_TypeInfo);
    byte_42AC7BB = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(playing, 0LL, 0LL) )
  {
    ...
    if ( !Component_srcLineSprite
      || (Component_srcLineSprite = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                                  ...
                                                                  (const MethodInfo_1B7B1B8 *)Method_UnityEngine_GameObject_GetComponent_WarBoardPlayingUIController___)) == 0LL )
    {
      sub_B52A5C(Component_srcLineSprite, v6);
    }
