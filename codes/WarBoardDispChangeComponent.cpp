        ...
        const MethodInfo *method)
{
  ...
  __int64 v6; // x2
  int max_length; // w8
  WarBoardPieceData_array *v8; // x19
  unsigned int v9; // w21
  WarBoardPieceData_o *v10; // x8
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !v10 )
        break;
      pieceComponent = (UnityEngine_Object_o *)v10->fields.pieceComponent;
      if ( pieceComponent
      ...
      Instance = (WarBoardPieceData_array *)UnityEngine_Object__op_Equality(v13, 0LL, 0LL);
      if ( ((unsigned __int8)Instance & 1) == 0 )
      {
        if ( !v13 )
          break;
        WarBoardServantPieceComponent__ChangeDyingAnimation((WarBoardServantPieceComponent_o *)v13, 0LL);
      }
        ...
        const MethodInfo *method)
{
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.playing, (int32_t)playingGo, v6, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BC3008(&UnityEngine_Object_TypeInfo, method);
    sub_1BC3008(&StringLiteral_14424/*"TopBase/BackButton"*/, v3);
    byte_4AFFDE6 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFFDE7 & 1) == 0 )
  {
    sub_1BC3008(&Method_UnityEngine_GameObject_GetComponent_WarBoardPlayingUIController___, isDisp);
  ...
  if ( UnityEngine_Object__op_Inequality(playing, 0LL, 0LL) )
  {
    ...
    if ( !Component_object
      || (Component_object = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                           Component_object,
                                                           (const MethodInfo_3055998 *)Method_UnityEngine_GameObject_GetComponent_WarBoardPlayingUIController___)) == 0LL )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFFDE5 & 1) == 0 )
  {
    sub_1BC3008(&Method_UnityEngine_Component_GetComponent_UIPanel___, isDisp);
    byte_4AFFDE5 = 1;
  }
