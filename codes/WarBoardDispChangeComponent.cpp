        ...
        const MethodInfo *method)
{
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.playing, (int32_t)playingGo, v6, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B761C0(&UnityEngine_Object_TypeInfo, method);
    sub_1B761C0(&StringLiteral_14528/*"TopBase/BackButton"*/, v3);
    byte_4A2BED5 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2BED6 & 1) == 0 )
  {
    sub_1B761C0(&Method_UnityEngine_GameObject_GetComponent_WarBoardPlayingUIController___, isDisp);
  ...
  if ( UnityEngine_Object__op_Inequality(playing, 0LL, 0LL) )
  {
    ...
    if ( !Component_object
      || (Component_object = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                           Component_object,
                                                           (const MethodInfo_2EB19B8 *)Method_UnityEngine_GameObject_GetComponent_WarBoardPlayingUIController___)) == 0LL )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2BED4 & 1) == 0 )
  {
    sub_1B761C0(&Method_UnityEngine_Component_GetComponent_UIPanel___, isDisp);
    byte_4A2BED4 = 1;
  }
