        ...
        const MethodInfo *method)
{
  ...
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.playing, (int32_t)playingGo, v10, v11, v12, v13, v14, v15);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E75361 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_UnityEngine_GameObject_GetComponent_WarBoardPlayingUIController___);
    sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    byte_4E75361 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(playing, 0, 0) )
  {
    ...
    if ( !Component_object
      || (Component_object = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                           Component_object,
                                                           (const MethodInfo_32A8444 *)Method_UnityEngine_GameObject_GetComponent_WarBoardPlayingUIController___)) == 0 )
    {
