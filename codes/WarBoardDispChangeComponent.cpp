        ...
        const MethodInfo *method)
{
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.playing, (int32_t)playingGo, v6, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B90010(&UnityEngine_Object_TypeInfo, method);
    sub_1B90010(&StringLiteral_14559/*"TopBase/BackButton"*/, v3);
    byte_4A6DE8D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6DE8E & 1) == 0 )
  {
    sub_1B90010(&Method_UnityEngine_GameObject_GetComponent_WarBoardPlayingUIController___, isDisp);
  ...
  if ( UnityEngine_Object__op_Inequality(playing, 0LL, 0LL) )
  {
    ...
    if ( !Component_object
      || (Component_object = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                           Component_object,
                                                           (const MethodInfo_2EDD768 *)Method_UnityEngine_GameObject_GetComponent_WarBoardPlayingUIController___)) == 0LL )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6DE8C & 1) == 0 )
  {
    sub_1B90010(&Method_UnityEngine_Component_GetComponent_UIPanel___, isDisp);
    byte_4A6DE8C = 1;
  }
