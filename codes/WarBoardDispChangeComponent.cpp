        ...
        const MethodInfo *method)
{
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.playing, (int32_t)playingGo, v6, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B715CC(&UnityEngine_Object_TypeInfo, method);
    sub_1B715CC(&StringLiteral_14485/*"TopBase/BackButton"*/, v3);
    byte_4A1DA6C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1DA6D & 1) == 0 )
  {
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponent_WarBoardPlayingUIController___, isDisp);
  ...
  if ( UnityEngine_Object__op_Inequality(playing, 0LL, 0LL) )
  {
    ...
    if ( !Component_object
      || (Component_object = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                           Component_object,
                                                           (const MethodInfo_2EAA998 *)Method_UnityEngine_GameObject_GetComponent_WarBoardPlayingUIController___)) == 0LL )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1DA6B & 1) == 0 )
  {
    sub_1B715CC(&Method_UnityEngine_Component_GetComponent_UIPanel___, isDisp);
    byte_4A1DA6B = 1;
  }
