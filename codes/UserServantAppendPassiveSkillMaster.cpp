void UserServantAppendPassiveSkillMaster___ctor(UserServantAppendPassiveSkillMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4E7862D & 1) == 0 )
  {
    sub_1D0F0B4(&Method_DataMasterBase_UserServantAppendPassiveSkillMaster__UserServantAppendPassiveSkillEntity__string___ctor__);
    byte_4E7862D = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    375,
    (const MethodInfo_3538564 *)Method_DataMasterBase_UserServantAppendPassiveSkillMaster__UserServantAppendPassiveSkillEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7862E & 1) == 0 )
  {
    sub_1D0F0B4(&Method_DataMasterBase_UserServantAppendPassiveSkillMaster__UserServantAppendPassiveSkillEntity__string__GetEntity__);
    byte_4E7862E = 1;
  }
  ...
  return (UserServantAppendPassiveSkillEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                                    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                                    PK,
                                                    (const MethodInfo_353AADC *)Method_DataMasterBase_UserServantAppendPassiveSkillMaster__UserServantAppendPassiveSkillEntity__string__GetEntity__);
}
...
bool UserServantAppendPassiveSkillMaster__IsAppendSkillExchangeLimit(int32_t svtId, const MethodInfo *method)
{
  ...
  if ( (byte_4E7862C & 1) == 0 )
  {
    ...
    *(_QWORD *)&svtId = sub_1D0F0B4(&NetworkManager_TypeInfo);
    byte_4E7862C = 1;
  }
  entity = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7862F & 1) == 0 )
  {
    sub_1D0F0B4(&Method_DataMasterBase_UserServantAppendPassiveSkillMaster__UserServantAppendPassiveSkillEntity__string__TryGetEntity__);
    byte_4E7862F = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_353AB28 *)Method_DataMasterBase_UserServantAppendPassiveSkillMaster__UserServantAppendPassiveSkillEntity__string__TryGetEntity__);
}