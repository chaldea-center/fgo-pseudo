...
int32_t __fastcall AiBaseEntity__ChangeNpCountPlayer(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC76AA & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_4494/*"ChangeNpCountPlayer"*/, method);
    byte_4BC76AA = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_4494/*"ChangeNpCountPlayer"*/, 0, v2);
}
...
int32_t __fastcall AiBaseEntity__GetActSelectIndex(AiBaseEntity_o *this, int32_t defIndex, const MethodInfo *method)
{
  ...
  if ( (byte_4BC76AB & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_2242/*"ActSelectIndex"*/, *(_QWORD *)&defIndex);
    byte_4BC76AB = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_2242/*"ActSelectIndex"*/, defIndex, v3);
}
...
bool __fastcall AiBaseEntity__IsDeadToEnableUpHate(AiBaseEntity_o *this, bool def, const MethodInfo *method)
{
  ...
  if ( (byte_4BC76AC & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_21142/*"isDeadToEnableUpHate"*/, def);
    byte_4BC76AC = 1;
  }
  ScriptIntParam = AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_21142/*"isDeadToEnableUpHate"*/, -1, v3);
  v7 = ScriptIntParam == 1;
  if ( ScriptIntParam == -1 )
    return def;
  return v7;
...
bool __fastcall AiBaseEntity__IsForcedActionSpeedAnyTime(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC76A7 & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_6944/*"ForcedActionSpeedAnyTime"*/, method);
    byte_4BC76A7 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_6944/*"ForcedActionSpeedAnyTime"*/, -1, v2) == 1;
}
...
bool __fastcall AiBaseEntity__IsForcedStepInSpeedAnyTime(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC76A8 & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_6947/*"ForcedStepInSpeedAnyTime"*/, method);
    byte_4BC76A8 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_6947/*"ForcedStepInSpeedAnyTime"*/, -1, v2) > 0;
}
...
bool __fastcall AiBaseEntity__IsIncludeUnsubState(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC76A6 & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_20970/*"includeUnsubState"*/, method);
    byte_4BC76A6 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_20970/*"includeUnsubState"*/, -1, v2) != -1;
}
...
bool __fastcall AiBaseEntity__IsResetNpCountPlayer(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC76A9 & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_11540/*"ResetNpCountPlayer"*/, method);
    byte_4BC76A9 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_11540/*"ResetNpCountPlayer"*/, -1, v2) == 1;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC76AD & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_7734/*"Individuality"*/, resValues);
    byte_4BC76AD = 1;
  }
  return EntityScriptUtil__TryGet2DimensionalIntArray(
           this->fields.script,
           (System_String_o *)StringLiteral_7734/*"Individuality"*/,
           resValues,
           v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC76AE & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_17346/*"baseAiId"*/, baseAiId);
    byte_4BC76AE = 1;
  }
  ScriptIntParam = AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_17346/*"baseAiId"*/, -1, v3);
...
System_Int64_array *__fastcall AiBaseEntity__getVals(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !result )
    return (System_Int64_array *)sub_1C1AC7C(long___TypeInfo, 0LL);
  return result;
}
