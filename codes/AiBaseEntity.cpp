...
int32_t __fastcall AiBaseEntity__ChangeNpCountPlayer(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FE754 & 1) == 0 )
  {
    sub_1B64A00(&StringLiteral_4388/*"ChangeNpCountPlayer"*/, method);
    byte_49FE754 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_4388/*"ChangeNpCountPlayer"*/, 0, v2);
}
...
int32_t __fastcall AiBaseEntity__GetActSelectIndex(AiBaseEntity_o *this, int32_t defIndex, const MethodInfo *method)
{
  ...
  if ( (byte_49FE755 & 1) == 0 )
  {
    sub_1B64A00(&StringLiteral_2210/*"ActSelectIndex"*/, *(_QWORD *)&defIndex);
    byte_49FE755 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_2210/*"ActSelectIndex"*/, defIndex, v3);
}
...
bool __fastcall AiBaseEntity__IsDeadToEnableUpHate(AiBaseEntity_o *this, bool def, const MethodInfo *method)
{
  ...
  if ( (byte_49FE756 & 1) == 0 )
  {
    sub_1B64A00(&StringLiteral_20706/*"isDeadToEnableUpHate"*/, def);
    byte_49FE756 = 1;
  }
...
bool __fastcall AiBaseEntity__IsForcedActionSpeedAnyTime(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FE751 & 1) == 0 )
  {
    sub_1B64A00(&StringLiteral_6754/*"ForcedActionSpeedAnyTime"*/, method);
    byte_49FE751 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_6754/*"ForcedActionSpeedAnyTime"*/, -1, v2) == 1;
}
...
bool __fastcall AiBaseEntity__IsForcedStepInSpeedAnyTime(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FE752 & 1) == 0 )
  {
    sub_1B64A00(&StringLiteral_6757/*"ForcedStepInSpeedAnyTime"*/, method);
    byte_49FE752 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_6757/*"ForcedStepInSpeedAnyTime"*/, -1, v2) > 0;
}
...
bool __fastcall AiBaseEntity__IsIncludeUnsubState(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FE750 & 1) == 0 )
  {
    sub_1B64A00(&StringLiteral_20536/*"includeUnsubState"*/, method);
    byte_49FE750 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_20536/*"includeUnsubState"*/, -1, v2) != -1;
}
...
bool __fastcall AiBaseEntity__IsResetNpCountPlayer(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FE753 & 1) == 0 )
  {
    sub_1B64A00(&StringLiteral_11284/*"ResetNpCountPlayer"*/, method);
    byte_49FE753 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_11284/*"ResetNpCountPlayer"*/, -1, v2) == 1;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE758 & 1) == 0 )
  {
    sub_1B64A00(&StringLiteral_17009/*"baseAiId"*/, baseAiId);
    byte_49FE758 = 1;
  }
...
System_Int64_array *__fastcall AiBaseEntity__getVals(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !result )
    return (System_Int64_array *)sub_1B64AA8(long___TypeInfo, 0LL);
  return result;
}
