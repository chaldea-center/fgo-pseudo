...
int32_t __fastcall AiBaseEntity__ChangeNpCountPlayer(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FE134 & 1) == 0 )
  {
    sub_1B64870(&StringLiteral_4387/*"ChangeNpCountPlayer"*/, method);
    byte_49FE134 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_4387/*"ChangeNpCountPlayer"*/, 0, v2);
}
...
int32_t __fastcall AiBaseEntity__GetActSelectIndex(AiBaseEntity_o *this, int32_t defIndex, const MethodInfo *method)
{
  ...
  if ( (byte_49FE135 & 1) == 0 )
  {
    sub_1B64870(&StringLiteral_2209/*"ActSelectIndex"*/, *(_QWORD *)&defIndex);
    byte_49FE135 = 1;
  }
...
bool __fastcall AiBaseEntity__IsDeadToEnableUpHate(AiBaseEntity_o *this, bool def, const MethodInfo *method)
{
  ...
  if ( (byte_49FE136 & 1) == 0 )
  {
    sub_1B64870(&StringLiteral_20706/*"isDeadToEnableUpHate"*/, def);
    byte_49FE136 = 1;
  }
...
bool __fastcall AiBaseEntity__IsForcedActionSpeedAnyTime(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FE131 & 1) == 0 )
  {
    sub_1B64870(&StringLiteral_6753/*"ForcedActionSpeedAnyTime"*/, method);
    byte_49FE131 = 1;
  }
...
bool __fastcall AiBaseEntity__IsForcedStepInSpeedAnyTime(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FE132 & 1) == 0 )
  {
    sub_1B64870(&StringLiteral_6756/*"ForcedStepInSpeedAnyTime"*/, method);
    byte_49FE132 = 1;
  }
...
bool __fastcall AiBaseEntity__IsIncludeUnsubState(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FE130 & 1) == 0 )
  {
    sub_1B64870(&StringLiteral_20536/*"includeUnsubState"*/, method);
    byte_49FE130 = 1;
  }
...
bool __fastcall AiBaseEntity__IsResetNpCountPlayer(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FE133 & 1) == 0 )
  {
    sub_1B64870(&StringLiteral_11283/*"ResetNpCountPlayer"*/, method);
    byte_49FE133 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_11283/*"ResetNpCountPlayer"*/, -1, v2) == 1;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE138 & 1) == 0 )
  {
    sub_1B64870(&StringLiteral_17008/*"baseAiId"*/, baseAiId);
    byte_49FE138 = 1;
  }
  ScriptIntParam = AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_17008/*"baseAiId"*/, -1, v3);
...
System_Int64_array *__fastcall AiBaseEntity__getVals(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !result )
    return (System_Int64_array *)sub_1B64918(long___TypeInfo, 0LL);
  return result;
}
