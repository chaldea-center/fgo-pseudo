...
int32_t __fastcall AiBaseEntity__ChangeNpCountPlayer(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6FA8A & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_4410/*"ChangeNpCountPlayer"*/, method);
    byte_4A6FA8A = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_4410/*"ChangeNpCountPlayer"*/, 0, v2);
}
...
int32_t __fastcall AiBaseEntity__GetActSelectIndex(AiBaseEntity_o *this, int32_t defIndex, const MethodInfo *method)
{
  ...
  if ( (byte_4A6FA8B & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_2213/*"ActSelectIndex"*/, *(_QWORD *)&defIndex);
    byte_4A6FA8B = 1;
  }
...
bool __fastcall AiBaseEntity__IsDeadToEnableUpHate(AiBaseEntity_o *this, bool def, const MethodInfo *method)
{
  ...
  if ( (byte_4A6FA8C & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_20812/*"isDeadToEnableUpHate"*/, def);
    byte_4A6FA8C = 1;
  }
  ScriptIntParam = AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_20812/*"isDeadToEnableUpHate"*/, -1, v3);
  v7 = ScriptIntParam == 1;
  if ( ScriptIntParam == -1 )
    return def;
  return v7;
...
bool __fastcall AiBaseEntity__IsForcedActionSpeedAnyTime(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6FA87 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_6784/*"ForcedActionSpeedAnyTime"*/, method);
    byte_4A6FA87 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_6784/*"ForcedActionSpeedAnyTime"*/, -1, v2) == 1;
}
...
bool __fastcall AiBaseEntity__IsForcedStepInSpeedAnyTime(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6FA88 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_6787/*"ForcedStepInSpeedAnyTime"*/, method);
    byte_4A6FA88 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_6787/*"ForcedStepInSpeedAnyTime"*/, -1, v2) > 0;
}
...
bool __fastcall AiBaseEntity__IsIncludeUnsubState(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6FA86 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_20642/*"includeUnsubState"*/, method);
    byte_4A6FA86 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_20642/*"includeUnsubState"*/, -1, v2) != -1;
}
...
bool __fastcall AiBaseEntity__IsResetNpCountPlayer(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6FA89 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_11341/*"ResetNpCountPlayer"*/, method);
    byte_4A6FA89 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_11341/*"ResetNpCountPlayer"*/, -1, v2) == 1;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FA8D & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_7571/*"Individuality"*/, resValues);
    byte_4A6FA8D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FA8E & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_17099/*"baseAiId"*/, baseAiId);
    byte_4A6FA8E = 1;
  }
  ScriptIntParam = AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_17099/*"baseAiId"*/, -1, v3);
...
System_Int64_array *__fastcall AiBaseEntity__getVals(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !result )
    return (System_Int64_array *)sub_1B900B8(long___TypeInfo, 0LL);
  return result;
}
