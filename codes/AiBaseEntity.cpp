...
int32_t AiBaseEntity__ChangeNpCountPlayer(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C56905 & 1) == 0 )
  {
    sub_1C3E564(&StringLiteral_4365/*"ChangeNpCountPlayer"*/);
    byte_4C56905 = 1;
  }
...
int32_t AiBaseEntity__GetActSelectIndex(AiBaseEntity_o *this, int32_t defIndex, const MethodInfo *method)
{
  ...
  if ( (byte_4C56906 & 1) == 0 )
  {
    sub_1C3E564(&StringLiteral_2117/*"ActSelectIndex"*/);
    byte_4C56906 = 1;
  }
...
bool AiBaseEntity__IsDeadToEnableUpHate(AiBaseEntity_o *this, bool def, const MethodInfo *method)
{
  ...
  if ( (byte_4C56907 & 1) == 0 )
  {
    sub_1C3E564(&StringLiteral_20928/*"isDeadToEnableUpHate"*/);
    byte_4C56907 = 1;
  }
  ScriptIntParam = AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_20928/*"isDeadToEnableUpHate"*/, -1, v3);
  v7 = ScriptIntParam == 1;
  if ( ScriptIntParam == -1 )
    return def;
  return v7;
...
bool AiBaseEntity__IsForcedActionSpeedAnyTime(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C56902 & 1) == 0 )
  {
    sub_1C3E564(&StringLiteral_6818/*"ForcedActionSpeedAnyTime"*/);
    byte_4C56902 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_6818/*"ForcedActionSpeedAnyTime"*/, -1, v2) == 1;
}
...
bool AiBaseEntity__IsForcedStepInSpeedAnyTime(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C56903 & 1) == 0 )
  {
    sub_1C3E564(&StringLiteral_6821/*"ForcedStepInSpeedAnyTime"*/);
    byte_4C56903 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_6821/*"ForcedStepInSpeedAnyTime"*/, -1, v2) > 0;
}
...
bool AiBaseEntity__IsIncludeUnsubState(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C56901 & 1) == 0 )
  {
    sub_1C3E564(&StringLiteral_20766/*"includeUnsubState"*/);
    byte_4C56901 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_20766/*"includeUnsubState"*/, -1, v2) != -1;
}
...
bool AiBaseEntity__IsResetNpCountPlayer(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C56904 & 1) == 0 )
  {
    sub_1C3E564(&StringLiteral_11368/*"ResetNpCountPlayer"*/);
    byte_4C56904 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_11368/*"ResetNpCountPlayer"*/, -1, v2) == 1;
}
...
bool AiBaseEntity__TryGetOverwriteBaseAiId(AiBaseEntity_o *this, int32_t *baseAiId, const MethodInfo *method)
{
  ...
  if ( (byte_4C56909 & 1) == 0 )
  {
    sub_1C3E564(&StringLiteral_17054/*"baseAiId"*/);
    byte_4C56909 = 1;
  }
  ScriptIntParam = AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_17054/*"baseAiId"*/, -1, v3);
...
System_Int64_array *AiBaseEntity__getVals(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !result )
    return (System_Int64_array *)sub_1C3E60C(long___TypeInfo, 0);
  return result;
}
