...
int32_t AiBaseEntity__ChangeNpCountPlayer(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C42B5C & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_4365/*"ChangeNpCountPlayer"*/);
    byte_4C42B5C = 1;
  }
...
int32_t AiBaseEntity__GetActSelectIndex(AiBaseEntity_o *this, int32_t defIndex, const MethodInfo *method)
{
  ...
  if ( (byte_4C42B5D & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_2117/*"ActSelectIndex"*/);
    byte_4C42B5D = 1;
  }
...
bool AiBaseEntity__IsDeadToEnableUpHate(AiBaseEntity_o *this, bool def, const MethodInfo *method)
{
  ...
  if ( (byte_4C42B5E & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_20910/*"isDeadToEnableUpHate"*/);
    byte_4C42B5E = 1;
  }
  ScriptIntParam = AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_20910/*"isDeadToEnableUpHate"*/, -1, v3);
  v7 = ScriptIntParam == 1;
  if ( ScriptIntParam == -1 )
    return def;
  return v7;
...
bool AiBaseEntity__IsForcedActionSpeedAnyTime(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C42B59 & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_6818/*"ForcedActionSpeedAnyTime"*/);
    byte_4C42B59 = 1;
  }
...
bool AiBaseEntity__IsForcedStepInSpeedAnyTime(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C42B5A & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_6821/*"ForcedStepInSpeedAnyTime"*/);
    byte_4C42B5A = 1;
  }
...
bool AiBaseEntity__IsIncludeUnsubState(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C42B58 & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_20748/*"includeUnsubState"*/);
    byte_4C42B58 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_20748/*"includeUnsubState"*/, -1, v2) != -1;
}
...
bool AiBaseEntity__IsResetNpCountPlayer(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C42B5B & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_11366/*"ResetNpCountPlayer"*/);
    byte_4C42B5B = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_11366/*"ResetNpCountPlayer"*/, -1, v2) == 1;
}
...
bool AiBaseEntity__TryGetOverwriteBaseAiId(AiBaseEntity_o *this, int32_t *baseAiId, const MethodInfo *method)
{
  ...
  if ( (byte_4C42B60 & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_17038/*"baseAiId"*/);
    byte_4C42B60 = 1;
  }
  ScriptIntParam = AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_17038/*"baseAiId"*/, -1, v3);
...
System_Int64_array *AiBaseEntity__getVals(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !result )
    return (System_Int64_array *)sub_1C37100(long___TypeInfo, 0);
  return result;
}
