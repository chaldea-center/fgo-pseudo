...
int32_t __fastcall AiBaseEntity__ChangeNpCountPlayer(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B667C1 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_4488/*"ChangeNpCountPlayer"*/, method);
    byte_4B667C1 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_4488/*"ChangeNpCountPlayer"*/, 0, v2);
}
...
int32_t __fastcall AiBaseEntity__GetActSelectIndex(AiBaseEntity_o *this, int32_t defIndex, const MethodInfo *method)
{
  ...
  if ( (byte_4B667C2 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_2238/*"ActSelectIndex"*/, *(_QWORD *)&defIndex);
    byte_4B667C2 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_2238/*"ActSelectIndex"*/, defIndex, v3);
}
...
bool __fastcall AiBaseEntity__IsDeadToEnableUpHate(AiBaseEntity_o *this, bool def, const MethodInfo *method)
{
  ...
  if ( (byte_4B667C3 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_21080/*"isDeadToEnableUpHate"*/, def);
    byte_4B667C3 = 1;
  }
  ScriptIntParam = AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_21080/*"isDeadToEnableUpHate"*/, -1, v3);
  v7 = ScriptIntParam == 1;
  if ( ScriptIntParam == -1 )
    return def;
  return v7;
...
bool __fastcall AiBaseEntity__IsForcedActionSpeedAnyTime(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B667BE & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_6921/*"ForcedActionSpeedAnyTime"*/, method);
    byte_4B667BE = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_6921/*"ForcedActionSpeedAnyTime"*/, -1, v2) == 1;
}
...
bool __fastcall AiBaseEntity__IsForcedStepInSpeedAnyTime(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B667BF & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_6924/*"ForcedStepInSpeedAnyTime"*/, method);
    byte_4B667BF = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_6924/*"ForcedStepInSpeedAnyTime"*/, -1, v2) > 0;
}
...
bool __fastcall AiBaseEntity__IsIncludeUnsubState(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B667BD & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_20908/*"includeUnsubState"*/, method);
    byte_4B667BD = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_20908/*"includeUnsubState"*/, -1, v2) != -1;
}
...
bool __fastcall AiBaseEntity__IsResetNpCountPlayer(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B667C0 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_11502/*"ResetNpCountPlayer"*/, method);
    byte_4B667C0 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_11502/*"ResetNpCountPlayer"*/, -1, v2) == 1;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B667C5 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_17287/*"baseAiId"*/, baseAiId);
    byte_4B667C5 = 1;
  }
  ScriptIntParam = AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_17287/*"baseAiId"*/, -1, v3);
...
System_Int64_array *__fastcall AiBaseEntity__getVals(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !result )
    return (System_Int64_array *)sub_1BE4B74(long___TypeInfo, 0LL);
  return result;
}
