...
int32_t __fastcall AiBaseEntity__ChangeNpCountPlayer(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BAA6B & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_4325/*"ChangeNpCountPlayer"*/, method);
    byte_49BAA6B = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_4325/*"ChangeNpCountPlayer"*/, 0, v2);
}
...
int32_t __fastcall AiBaseEntity__GetActSelectIndex(AiBaseEntity_o *this, int32_t defIndex, const MethodInfo *method)
{
  ...
  if ( (byte_49BAA6C & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_2123/*"ActSelectIndex"*/, *(_QWORD *)&defIndex);
    byte_49BAA6C = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_2123/*"ActSelectIndex"*/, defIndex, v3);
}
...
bool __fastcall AiBaseEntity__IsDeadToEnableUpHate(AiBaseEntity_o *this, bool def, const MethodInfo *method)
{
  ...
  if ( (byte_49BAA6D & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_20494/*"isDeadToEnableUpHate"*/, def);
    byte_49BAA6D = 1;
  }
  ScriptIntParam = AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_20494/*"isDeadToEnableUpHate"*/, -1, v3);
  v7 = ScriptIntParam == 1;
  if ( ScriptIntParam == -1 )
    return def;
  return v7;
...
bool __fastcall AiBaseEntity__IsForcedActionSpeedAnyTime(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BAA68 & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_6703/*"ForcedActionSpeedAnyTime"*/, method);
    byte_49BAA68 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_6703/*"ForcedActionSpeedAnyTime"*/, -1, v2) == 1;
}
...
bool __fastcall AiBaseEntity__IsForcedStepInSpeedAnyTime(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BAA69 & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_6706/*"ForcedStepInSpeedAnyTime"*/, method);
    byte_49BAA69 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_6706/*"ForcedStepInSpeedAnyTime"*/, -1, v2) > 0;
}
...
bool __fastcall AiBaseEntity__IsIncludeUnsubState(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BAA67 & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_20330/*"includeUnsubState"*/, method);
    byte_49BAA67 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_20330/*"includeUnsubState"*/, -1, v2) != -1;
}
...
bool __fastcall AiBaseEntity__IsResetNpCountPlayer(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BAA6A & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_11112/*"ResetNpCountPlayer"*/, method);
    byte_49BAA6A = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_11112/*"ResetNpCountPlayer"*/, -1, v2) == 1;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BAA6F & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_16755/*"baseAiId"*/, baseAiId);
    byte_49BAA6F = 1;
  }
  ScriptIntParam = AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_16755/*"baseAiId"*/, -1, v3);
...
System_Int64_array *__fastcall AiBaseEntity__getVals(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !result )
    return (System_Int64_array *)sub_1B4D038(long___TypeInfo, 0LL);
  return result;
}
