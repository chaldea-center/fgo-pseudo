...
int32_t __fastcall AiBaseEntity__ChangeNpCountPlayer(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDC141 & 1) == 0 )
  {
    sub_1C21E38(&StringLiteral_4503/*"ChangeNpCountPlayer"*/);
    byte_4BDC141 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_4503/*"ChangeNpCountPlayer"*/, 0, v2);
}
...
int32_t __fastcall AiBaseEntity__GetActSelectIndex(AiBaseEntity_o *this, int32_t defIndex, const MethodInfo *method)
{
  ...
  if ( (byte_4BDC142 & 1) == 0 )
  {
    sub_1C21E38(&StringLiteral_2251/*"ActSelectIndex"*/);
    byte_4BDC142 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_2251/*"ActSelectIndex"*/, defIndex, v3);
}
...
bool __fastcall AiBaseEntity__IsDeadToEnableUpHate(AiBaseEntity_o *this, bool def, const MethodInfo *method)
{
  ...
  if ( (byte_4BDC143 & 1) == 0 )
  {
    sub_1C21E38(&StringLiteral_21160/*"isDeadToEnableUpHate"*/);
    byte_4BDC143 = 1;
  }
  ScriptIntParam = AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_21160/*"isDeadToEnableUpHate"*/, -1, v3);
  v7 = ScriptIntParam == 1;
  if ( ScriptIntParam == -1 )
    return def;
  return v7;
...
bool __fastcall AiBaseEntity__IsForcedActionSpeedAnyTime(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDC13E & 1) == 0 )
  {
    sub_1C21E38(&StringLiteral_6954/*"ForcedActionSpeedAnyTime"*/);
    byte_4BDC13E = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_6954/*"ForcedActionSpeedAnyTime"*/, -1, v2) == 1;
}
...
bool __fastcall AiBaseEntity__IsForcedStepInSpeedAnyTime(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDC13F & 1) == 0 )
  {
    sub_1C21E38(&StringLiteral_6957/*"ForcedStepInSpeedAnyTime"*/);
    byte_4BDC13F = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_6957/*"ForcedStepInSpeedAnyTime"*/, -1, v2) > 0;
}
...
bool __fastcall AiBaseEntity__IsIncludeUnsubState(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDC13D & 1) == 0 )
  {
    sub_1C21E38(&StringLiteral_20988/*"includeUnsubState"*/);
    byte_4BDC13D = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_20988/*"includeUnsubState"*/, -1, v2) != -1;
}
...
bool __fastcall AiBaseEntity__IsResetNpCountPlayer(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDC140 & 1) == 0 )
  {
    sub_1C21E38(&StringLiteral_11550/*"ResetNpCountPlayer"*/);
    byte_4BDC140 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_11550/*"ResetNpCountPlayer"*/, -1, v2) == 1;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDC145 & 1) == 0 )
  {
    sub_1C21E38(&StringLiteral_17359/*"baseAiId"*/);
    byte_4BDC145 = 1;
  }
  ScriptIntParam = AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_17359/*"baseAiId"*/, -1, v3);
