...
int32_t __fastcall AiBaseEntity__ChangeNpCountPlayer(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B36DA8 & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_4485/*"ChangeNpCountPlayer"*/, method);
    byte_4B36DA8 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_4485/*"ChangeNpCountPlayer"*/, 0, v2);
}
...
int32_t __fastcall AiBaseEntity__GetActSelectIndex(AiBaseEntity_o *this, int32_t defIndex, const MethodInfo *method)
{
  ...
  if ( (byte_4B36DA9 & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_2237/*"ActSelectIndex"*/, *(_QWORD *)&defIndex);
    byte_4B36DA9 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_2237/*"ActSelectIndex"*/, defIndex, v3);
}
...
bool __fastcall AiBaseEntity__IsDeadToEnableUpHate(AiBaseEntity_o *this, bool def, const MethodInfo *method)
{
  ...
  if ( (byte_4B36DAA & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_21040/*"isDeadToEnableUpHate"*/, def);
    byte_4B36DAA = 1;
  }
  ScriptIntParam = AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_21040/*"isDeadToEnableUpHate"*/, -1, v3);
  v7 = ScriptIntParam == 1;
  if ( ScriptIntParam == -1 )
    return def;
  return v7;
...
bool __fastcall AiBaseEntity__IsForcedActionSpeedAnyTime(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B36DA5 & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_6917/*"ForcedActionSpeedAnyTime"*/, method);
    byte_4B36DA5 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_6917/*"ForcedActionSpeedAnyTime"*/, -1, v2) == 1;
}
...
bool __fastcall AiBaseEntity__IsForcedStepInSpeedAnyTime(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B36DA6 & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_6920/*"ForcedStepInSpeedAnyTime"*/, method);
    byte_4B36DA6 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_6920/*"ForcedStepInSpeedAnyTime"*/, -1, v2) > 0;
}
...
bool __fastcall AiBaseEntity__IsIncludeUnsubState(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B36DA4 & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_20868/*"includeUnsubState"*/, method);
    byte_4B36DA4 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_20868/*"includeUnsubState"*/, -1, v2) != -1;
}
...
bool __fastcall AiBaseEntity__IsResetNpCountPlayer(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B36DA7 & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_11489/*"ResetNpCountPlayer"*/, method);
    byte_4B36DA7 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_11489/*"ResetNpCountPlayer"*/, -1, v2) == 1;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B36DAC & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_17266/*"baseAiId"*/, baseAiId);
    byte_4B36DAC = 1;
  }
  ScriptIntParam = AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_17266/*"baseAiId"*/, -1, v3);
