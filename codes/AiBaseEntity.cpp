...
int32_t __fastcall AiBaseEntity__ChangeNpCountPlayer(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_40F7EC3 & 1) == 0 )
  {
    sub_B16FFC(&StringLiteral_3897, method);
    byte_40F7EC3 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_3897, 0, v2);
}
...
int32_t __fastcall AiBaseEntity__GetActSelectIndex(AiBaseEntity_o *this, int32_t defIndex, const MethodInfo *method)
{
  ...
  if ( (byte_40F7EC4 & 1) == 0 )
  {
    sub_B16FFC(&StringLiteral_1806, *(_QWORD *)&defIndex);
    byte_40F7EC4 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_1806, defIndex, v3);
}
...
bool __fastcall AiBaseEntity__IsDeadToEnableUpHate(AiBaseEntity_o *this, bool def, const MethodInfo *method)
{
  ...
  if ( (byte_40F7EC5 & 1) == 0 )
  {
    sub_B16FFC(&StringLiteral_19844, def);
    byte_40F7EC5 = 1;
  }
  ScriptIntParam = AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_19844, -1, v3);
  v7 = ScriptIntParam == 1;
  if ( ScriptIntParam == -1 )
    return def;
  return v7;
...
bool __fastcall AiBaseEntity__IsForcedActionSpeedAnyTime(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_40F7EC0 & 1) == 0 )
  {
    sub_B16FFC(&StringLiteral_6725, method);
    byte_40F7EC0 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_6725, -1, v2) == 1;
}
...
bool __fastcall AiBaseEntity__IsForcedStepInSpeedAnyTime(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_40F7EC1 & 1) == 0 )
  {
    sub_B16FFC(&StringLiteral_6728, method);
    byte_40F7EC1 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_6728, -1, v2) > 0;
}
...
bool __fastcall AiBaseEntity__IsIncludeUnsubState(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_40F7EBF & 1) == 0 )
  {
    sub_B16FFC(&StringLiteral_19695, method);
    byte_40F7EBF = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_19695, -1, v2) != -1;
}
...
bool __fastcall AiBaseEntity__IsResetNpCountPlayer(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_40F7EC2 & 1) == 0 )
  {
    sub_B16FFC(&StringLiteral_11415, method);
    byte_40F7EC2 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_11415, -1, v2) == 1;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40F7EC7 & 1) == 0 )
  {
    sub_B16FFC(&StringLiteral_16550, baseAiId);
    byte_40F7EC7 = 1;
  }
  ScriptIntParam = AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_16550, -1, v3);
