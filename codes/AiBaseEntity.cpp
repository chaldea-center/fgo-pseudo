...
int32_t __fastcall AiBaseEntity__ChangeNpCountPlayer(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C21B58 & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_4491/*"Column '{0}' is read only."*/, method);
    byte_4C21B58 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_4491/*"Column '{0}' is read only."*/, 0, v2);
}
...
int32_t __fastcall AiBaseEntity__GetActSelectIndex(AiBaseEntity_o *this, int32_t defIndex, const MethodInfo *method)
{
  ...
  if ( (byte_4C21B59 & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_2226/*"An attempt was made to move the position before the beginning of the stream."*/, *(_QWORD *)&defIndex);
    byte_4C21B59 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_2226/*"An attempt was made to move the position before the beginning of the stream."*/, defIndex, v3);
}
...
bool __fastcall AiBaseEntity__IsDeadToEnableUpHate(AiBaseEntity_o *this, bool def, const MethodInfo *method)
{
  ...
  if ( (byte_4C21B5A & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_21205/*"ms-MY"*/, def);
    byte_4C21B5A = 1;
  }
  ScriptIntParam = AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_21205/*"ms-MY"*/, -1, v3);
  v7 = ScriptIntParam == 1;
  if ( ScriptIntParam == -1 )
    return def;
  return v7;
...
bool __fastcall AiBaseEntity__IsForcedActionSpeedAnyTime(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C21B55 & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_6947/*"GhostWhite"*/, method);
    byte_4C21B55 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_6947/*"GhostWhite"*/, -1, v2) == 1;
}
...
bool __fastcall AiBaseEntity__IsForcedStepInSpeedAnyTime(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C21B56 & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_6950/*"GoForward"*/, method);
    byte_4C21B56 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_6950/*"GoForward"*/, -1, v2) > 0;
}
...
bool __fastcall AiBaseEntity__IsIncludeUnsubState(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C21B54 & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_21034/*"md4"*/, method);
    byte_4C21B54 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_21034/*"md4"*/, -1, v2) != -1;
}
...
bool __fastcall AiBaseEntity__IsResetNpCountPlayer(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C21B57 & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_11567/*"SERVANT_SORT_KIND_CREATE"*/, method);
    byte_4C21B57 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_11567/*"SERVANT_SORT_KIND_CREATE"*/, -1, v2) == 1;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21B5C & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_17403/*"card/combineCostume"*/, baseAiId);
    byte_4C21B5C = 1;
  }
  ScriptIntParam = AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_17403/*"card/combineCostume"*/, -1, v3);
...
System_Int64_array *__fastcall AiBaseEntity__getVals(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !result )
    return (System_Int64_array *)sub_1C3B80C(long___TypeInfo, 0LL);
  return result;
}
