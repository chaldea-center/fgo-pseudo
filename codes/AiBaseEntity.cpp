...
int32_t AiBaseEntity__ChangeNpCountPlayer(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC6F87 & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_4358/*"ChangeNpCountPlayer"*/);
    byte_4CC6F87 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_4358/*"ChangeNpCountPlayer"*/, 0, v2);
}
...
int32_t AiBaseEntity__GetActSelectIndex(AiBaseEntity_o *this, int32_t defIndex, const MethodInfo *method)
{
  ...
  if ( (byte_4CC6F88 & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_2112/*"ActSelectIndex"*/);
    byte_4CC6F88 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_2112/*"ActSelectIndex"*/, defIndex, v3);
}
...
bool AiBaseEntity__IsDeadToEnableUpHate(AiBaseEntity_o *this, bool def, const MethodInfo *method)
{
  ...
  if ( (byte_4CC6F89 & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_20989/*"isDeadToEnableUpHate"*/);
    byte_4CC6F89 = 1;
  }
  ScriptIntParam = AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_20989/*"isDeadToEnableUpHate"*/, -1, v3);
  v7 = ScriptIntParam == 1;
  if ( ScriptIntParam == -1 )
    return def;
  return v7;
...
bool AiBaseEntity__IsForcedActionSpeedAnyTime(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC6F84 & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_6813/*"ForcedActionSpeedAnyTime"*/);
    byte_4CC6F84 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_6813/*"ForcedActionSpeedAnyTime"*/, -1, v2) == 1;
}
...
bool AiBaseEntity__IsForcedStepInSpeedAnyTime(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC6F85 & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_6816/*"ForcedStepInSpeedAnyTime"*/);
    byte_4CC6F85 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_6816/*"ForcedStepInSpeedAnyTime"*/, -1, v2) > 0;
}
...
bool AiBaseEntity__IsIncludeUnsubState(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC6F83 & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_20826/*"includeUnsubState"*/);
    byte_4CC6F83 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_20826/*"includeUnsubState"*/, -1, v2) != -1;
}
...
bool AiBaseEntity__IsResetNpCountPlayer(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC6F86 & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_11371/*"ResetNpCountPlayer"*/);
    byte_4CC6F86 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_11371/*"ResetNpCountPlayer"*/, -1, v2) == 1;
}
...
bool AiBaseEntity__TryGetOverwriteBaseAiId(AiBaseEntity_o *this, int32_t *baseAiId, const MethodInfo *method)
{
  ...
  if ( (byte_4CC6F8B & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_17058/*"baseAiId"*/);
    byte_4CC6F8B = 1;
  }
  ScriptIntParam = AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_17058/*"baseAiId"*/, -1, v3);
...
System_Int64_array *AiBaseEntity__getVals(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !result )
    return (System_Int64_array *)sub_1C71458(long___TypeInfo, 0);
  return result;
}
