...
int32_t __fastcall AiBaseEntity__ChangeNpCountPlayer(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FC03C & 1) == 0 )
  {
    sub_1B640C8(&StringLiteral_4387/*"ChangeNpCountPlayer"*/, method);
    byte_49FC03C = 1;
  }
...
int32_t __fastcall AiBaseEntity__GetActSelectIndex(AiBaseEntity_o *this, int32_t defIndex, const MethodInfo *method)
{
  ...
  if ( (byte_49FC03D & 1) == 0 )
  {
    sub_1B640C8(&StringLiteral_2210/*"ActSelectIndex"*/, *(_QWORD *)&defIndex);
    byte_49FC03D = 1;
  }
...
bool __fastcall AiBaseEntity__IsDeadToEnableUpHate(AiBaseEntity_o *this, bool def, const MethodInfo *method)
{
  ...
  if ( (byte_49FC03E & 1) == 0 )
  {
    sub_1B640C8(&StringLiteral_20703/*"isDeadToEnableUpHate"*/, def);
    byte_49FC03E = 1;
  }
  ScriptIntParam = AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_20703/*"isDeadToEnableUpHate"*/, -1, v3);
  v7 = ScriptIntParam == 1;
  if ( ScriptIntParam == -1 )
    return def;
  return v7;
...
bool __fastcall AiBaseEntity__IsForcedActionSpeedAnyTime(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FC039 & 1) == 0 )
  {
    sub_1B640C8(&StringLiteral_6753/*"ForcedActionSpeedAnyTime"*/, method);
    byte_49FC039 = 1;
  }
...
bool __fastcall AiBaseEntity__IsForcedStepInSpeedAnyTime(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FC03A & 1) == 0 )
  {
    sub_1B640C8(&StringLiteral_6756/*"ForcedStepInSpeedAnyTime"*/, method);
    byte_49FC03A = 1;
  }
...
bool __fastcall AiBaseEntity__IsIncludeUnsubState(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FC038 & 1) == 0 )
  {
    sub_1B640C8(&StringLiteral_20533/*"includeUnsubState"*/, method);
    byte_49FC038 = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_20533/*"includeUnsubState"*/, -1, v2) != -1;
}
...
bool __fastcall AiBaseEntity__IsResetNpCountPlayer(AiBaseEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FC03B & 1) == 0 )
  {
    sub_1B640C8(&StringLiteral_11280/*"ResetNpCountPlayer"*/, method);
    byte_49FC03B = 1;
  }
  return AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_11280/*"ResetNpCountPlayer"*/, -1, v2) == 1;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC040 & 1) == 0 )
  {
    sub_1B640C8(&StringLiteral_17006/*"baseAiId"*/, baseAiId);
    byte_49FC040 = 1;
  }
  ScriptIntParam = AiBaseEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_17006/*"baseAiId"*/, -1, v3);
