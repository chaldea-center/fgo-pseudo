void EventRewardBgMaster___ctor(EventRewardBgMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4D30AEE & 1) == 0 )
  {
    sub_1C93AD4(&Method_DataMasterBase_EventRewardBgMaster__EventRewardBgEntity__string___ctor__);
    byte_4D30AEE = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    304,
    (const MethodInfo_3465C5C *)Method_DataMasterBase_EventRewardBgMaster__EventRewardBgEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D30AEC & 1) == 0 )
  {
    sub_1C93AD4(&Method_DataMasterBase_EventRewardBgMaster__EventRewardBgEntity__string__GetEntity__);
    byte_4D30AEC = 1;
  }
  ...
  return (EventRewardBgEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                    PK,
                                    (const MethodInfo_34681D4 *)Method_DataMasterBase_EventRewardBgMaster__EventRewardBgEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D30AEF & 1) == 0 )
  {
    sub_1C93AD4(&Method_System_Collections_ObjectModel_Collection_EventRewardBgEntity__get_Count__);
    sub_1C93AD4(&Method_System_Collections_ObjectModel_Collection_EventRewardBgEntity__get_Item__);
  ...
  {
LABEL_17:
    sub_1C93D2C(Instance, m_CancellationTokenSource_high);
  }
  ...
  while ( v13 < System_Collections_ObjectModel_Collection_object___get_Count(
                  list,
                  (const MethodInfo_33FBDAC *)Method_System_Collections_ObjectModel_Collection_EventRewardBgEntity__get_Count__) )
  {
    ...
    if ( Instance )
    {
      Instance = (DataManager_o *)System_Collections_ObjectModel_Collection_object___get_Item(
                                    ...
                                    v13,
                                    (const MethodInfo_33FBE3C *)Method_System_Collections_ObjectModel_Collection_EventRewardBgEntity__get_Item__);
      if ( Instance )
      {
        v14 = Instance;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D30AED & 1) == 0 )
  {
    sub_1C93AD4(&Method_DataMasterBase_EventRewardBgMaster__EventRewardBgEntity__string__TryGetEntity__);
    byte_4D30AED = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_3468220 *)Method_DataMasterBase_EventRewardBgMaster__EventRewardBgEntity__string__TryGetEntity__);
}