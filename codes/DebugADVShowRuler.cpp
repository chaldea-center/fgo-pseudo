...
void DebugADVShowRuler__OnClickShowRuler(DebugADVShowRuler_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C54B68 & 1) == 0 )
  {
    sub_1C3E564(&Method_UnityEngine_GameObject_AddComponent_PostProcessorRuler___);
    sub_1C3E564(&Method_UnityEngine_GameObject_GetComponent_Camera___);
    sub_1C3E564(&Method_UnityEngine_GameObject_GetComponent_PostProcessorRuler___);
    sub_1C3E564(&UnityEngine_Object_TypeInfo);
    sub_1C3E564(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1C3E564(&StringLiteral_25406/*"お使いの環境では、Compute Shaderがサポートされていないため、この機能を利用することができません。\r\nお手数ですが、以下のいずれかをご確認ください：\r\n\r\n１．お使いのデバイスやグラフィックカードがCompute Shaderに対応しているか\r\n２．最新のグラフィックドライバーがインストールされているか"*/);
    sub_1C3E564(&StringLiteral_25517/*"機能がサポートされていません"*/);
    sub_1C3E564(&StringLiteral_8890/*"Management/CommonUI/UI Root/CommonUICamera"*/);
    byte_4C54B68 = 1;
  }
  if ( UnityEngine_SystemInfo__get_supportsComputeShaders(0) )
  {
    ...
    v6 = UnityEngine_GameObject__GetComponent_object_(
           (UnityEngine_GameObject_o *)Component_object,
           (const MethodInfo_31510CC *)Method_UnityEngine_GameObject_GetComponent_PostProcessorRuler___);
    ...
    if ( UnityEngine_Object__op_Equality((UnityEngine_Object_o *)v6, 0, 0) )
    {
      ...
      if ( Component_object )
      {
        Component_object = (char *)UnityEngine_GameObject__AddComponent_object_(
                                     (UnityEngine_GameObject_o *)Component_object,
                                     (const MethodInfo_3150FE4 *)Method_UnityEngine_GameObject_AddComponent_PostProcessorRuler___);
        if ( Component_object )
        {
          rulerComputeShader = this->fields.rulerComputeShader;
          *((_QWORD *)Component_object + 16) = rulerComputeShader;
          sub_1C3E508((CGThumbnailListItem_o *)(Component_object + 128), (int32_t)rulerComputeShader, v7, v8);
          return;
        }
      }
LABEL_18:
  ...
  {
    v10 = (System_String_o *)StringLiteral_25517/*"機能がサポートされていません"*/;
    v11 = (System_String_o *)StringLiteral_25406/*"お使いの環境では、Compute Shaderがサポートされていないため、この機能を利用することができません。\r\nお手数ですが、以下のいずれかをご確認ください：\r\n\r\n１．お使いのデバイスやグラフィックカードがCompute Shaderに対応しているか\r\n２．最新のグラフィックドライバーがインストールされているか"*/;
    Component_object = (char *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39FF5A8 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    if ( !Component_object )
      goto LABEL_18;
