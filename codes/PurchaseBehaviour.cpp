void PurchaseBehaviour___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CC6CC1 & 1) == 0 )
  {
    sub_1C713B0(&Method_System_Collections_Generic_List_BankShopEntity___ctor__);
    sub_1C713B0(&Method_System_Collections_Generic_List_string___ctor__);
    sub_1C713B0(&System_Collections_Generic_List_BankShopEntity__TypeInfo);
  ...
  sub_1C71354(
    ...
    v6,
    v7);
  v8 = (System_Collections_Generic_List_object__o *)sub_1C715FC(System_Collections_Generic_List_BankShopEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v8,
    (const MethodInfo_380FEE4 *)Method_System_Collections_Generic_List_BankShopEntity___ctor__);
...
void PurchaseBehaviour___ctor(PurchaseBehaviour_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC6CC0 & 1) == 0 )
  {
    this = (PurchaseBehaviour_o *)sub_1C713B0(&PurchaseLogicExternal_TypeInfo);
    byte_4CC6CC0 = 1;
  }
  Instance = PurchaseLogic__GetInstance((const MethodInfo *)this);
  v2->fields._purchaseLogic = Instance;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&v2->fields._purchaseLogic, (int32_t)Instance, v4, v5, v6, v7, v8, v9);
  v10 = (Il2CppObject *)sub_1C715FC(PurchaseLogicExternal_TypeInfo);
...
void PurchaseBehaviour__BuildProductIdCollection(const MethodInfo *method)
{
  ...
  if ( (byte_4CC6CB4 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_System_Linq_Enumerable_Select_BankShopEntity__string___);
    sub_1C713B0(&Method_System_Linq_Enumerable_ToList_BankShopEntity___);
    sub_1C713B0(&Method_System_Linq_Enumerable_ToList_string___);
    sub_1C713B0(&System_Func_BankShopEntity__string__TypeInfo);
    sub_1C713B0(&ManagerConfig_TypeInfo);
    sub_1C713B0(&UnityEngine_Object_TypeInfo);
    sub_1C713B0(&PurchaseBehaviour_TypeInfo);
    sub_1C713B0(&Method_SingletonMonoBehaviour_DataManager__getInstance__);
    sub_1C713B0(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    sub_1C713B0(&Method_PurchaseBehaviour___c__BuildProductIdCollection_b__12_0__);
    sub_1C713B0(&PurchaseBehaviour___c_TypeInfo);
    byte_4CC6CB4 = 1;
  }
    ...
    if ( UnityEngine_Object__op_Inequality(v5, 0, 0) )
    {
      ...
      if ( !Instance
        || (Instance = DataManager__GetMasterData_object_(
                         ...
                         (const MethodInfo_314B10C *)Method_DataManager_GetMasterData_BankShopMaster___)) == 0 )
      {
      ...
      v9 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__ToList_object_(
                                                                  EnableEntitiyList,
                                                                  (const MethodInfo_318FC88 *)Method_System_Linq_Enumerable_ToList_BankShopEntity___);
      ...
      if ( !_9__12_0 )
      {
        ...
        _9__12_0 = (System_Func_object__object__o *)sub_1C715FC(System_Func_BankShopEntity__string__TypeInfo);
      ...
      v20 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_object__object_(
                                                                   ...
                                                                   (const MethodInfo_31818B4 *)Method_System_Linq_Enumerable_Select_BankShopEntity__string___);
...
PurchaseBehaviour_o *PurchaseBehaviour__GetInstance(const MethodInfo *method)
{
  ...
  if ( (byte_4CC6CB0 & 1) == 0 )
  {
    sub_1C713B0(&Method_UnityEngine_Component_GetComponentInChildren_PurchaseBehaviour___);
    sub_1C713B0(&UnityEngine_Object_TypeInfo);
    sub_1C713B0(&PurchaseBehaviour_TypeInfo);
    sub_1C713B0(&Method_SingletonMonoBehaviour_ManagementManager__getInstance__);
    byte_4CC6CB0 = 1;
  }
  v1 = PurchaseBehaviour_TypeInfo;
  if ( !PurchaseBehaviour_TypeInfo->_2.cctor_finished )
...
LABEL_21:
  ...
  if ( !v9 )
  {
    ...
    ComponentInChildren_object__51649344 = UnityEngine_Component__GetComponentInChildren_object__51649344(
                                             ...
                                             (const MethodInfo_3141B40 *)Method_UnityEngine_Component_GetComponentInChildren_PurchaseBehaviour___);
    v18 = PurchaseBehaviour_TypeInfo;
    v19 = ComponentInChildren_object__51649344;
    if ( !PurchaseBehaviour_TypeInfo->_2.cctor_finished )
    {
      j_il2cpp_runtime_class_init_0(PurchaseBehaviour_TypeInfo);
      v18 = PurchaseBehaviour_TypeInfo;
...
void PurchaseBehaviour__Ready_41711400(
        ...
        const MethodInfo *method)
{
  ...
  purchaseLogic = this->fields._purchaseLogic;
  if ( !purchaseLogic )
    sub_1C71608(0, shopId);
  PurchaseLogic__InitiatePurchase_41712524(purchaseLogic, shopId, productId, price, finishedAction, method);
}
...
void PurchaseBehaviour___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C715FC(PurchaseBehaviour___c_TypeInfo);
