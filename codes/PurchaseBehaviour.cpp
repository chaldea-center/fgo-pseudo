void __fastcall PurchaseBehaviour___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A4DDEA & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Collections_Generic_List_BankShopEntity___ctor__, v1);
    sub_1B863B8(&Method_System_Collections_Generic_List_string___ctor__, v2);
    sub_1B863B8(&System_Collections_Generic_List_BankShopEntity__TypeInfo, v3);
  ...
  sub_1B8635C((CGThumbnailListItem_o *)PurchaseBehaviour_TypeInfo->static_fields, (int32_t)v6, v7, v8);
  v9 = (System_Collections_Generic_List_object__o *)sub_1B86604(System_Collections_Generic_List_BankShopEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v9,
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&static_fields->BankShopEntityCollection, (int32_t)v9, v11, v12);
...
void __fastcall PurchaseBehaviour___ctor(PurchaseBehaviour_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4DDE9 & 1) == 0 )
  {
    this = (PurchaseBehaviour_o *)sub_1B863B8(&PurchaseLogicExternal_TypeInfo, method);
    byte_4A4DDE9 = 1;
  }
  Instance = PurchaseLogic__GetInstance((const MethodInfo *)this);
  v2->fields._purchaseLogic = Instance;
  sub_1B8635C((CGThumbnailListItem_o *)&v2->fields._purchaseLogic, (int32_t)Instance, v4, v5);
  v6 = (Il2CppObject *)sub_1B86604(PurchaseLogicExternal_TypeInfo);
  System_Object___ctor(v6, 0LL);
  v2->fields._purchaseLogicExternal = (struct PurchaseLogicExternal_o *)v6;
  sub_1B8635C((CGThumbnailListItem_o *)&v2->fields._purchaseLogicExternal, (int32_t)v6, v7, v8);
...
void __fastcall PurchaseBehaviour__Activate(const MethodInfo *method)
{
  ...
  if ( (byte_4A4DDDE & 1) == 0 )
  {
    ...
    sub_1B863B8(&PurchaseBehaviour_TypeInfo, v2);
    byte_4A4DDDE = 1;
  }
...
void __fastcall PurchaseBehaviour__ActivateBoth(const MethodInfo *method)
{
  ...
  if ( ((unsigned __int8)purchaseLogicExternal & 1) == 0 )
  {
    ...
    {
      sub_1B86614(purchaseLogicExternal, v6);
    }
...
void __fastcall PurchaseBehaviour__AddPreparePurchaseShopIdsToPlayerPrefs(int32_t shopId, const MethodInfo *method)
{
  ...
  if ( (byte_4A4DDE7 & 1) == 0 )
  {
    ...
    sub_1B863B8(&PurchaseBehaviour_TypeInfo, v3);
    byte_4A4DDE7 = 1;
  }
...
void __fastcall PurchaseBehaviour__BuildProductIdCollection(const MethodInfo *method)
{
  ...
  if ( (byte_4A4DDDD & 1) == 0 )
  {
    sub_1B863B8(&Method_DataManager_GetMasterData_BankShopMaster___, v1);
    sub_1B863B8(&Method_System_Linq_Enumerable_Select_BankShopEntity__string___, v3);
    sub_1B863B8(&Method_System_Linq_Enumerable_ToList_BankShopEntity___, v4);
    sub_1B863B8(&Method_System_Linq_Enumerable_ToList_string___, v5);
    sub_1B863B8(&System_Func_BankShopEntity__string__TypeInfo, v6);
    sub_1B863B8(&ManagerConfig_TypeInfo, v7);
    ...
    sub_1B863B8(&Method_PurchaseBehaviour___c__BuildProductIdCollection_b__12_0__, v12);
    sub_1B863B8(&PurchaseBehaviour___c_TypeInfo, v13);
    byte_4A4DDDD = 1;
  }
    ...
    if ( UnityEngine_Object__op_Inequality(v17, 0LL, 0LL) )
    {
      ...
      if ( !Instance
        || (Instance = DataManager__GetMasterData_object_(
                         ...
                         (const MethodInfo_2F6DCB8 *)Method_DataManager_GetMasterData_BankShopMaster___)) == 0LL )
      {
      ...
      v21 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__ToList_object_(
                                                                   EnableEntitiyList,
                                                                   (const MethodInfo_2FADBE0 *)Method_System_Linq_Enumerable_ToList_BankShopEntity___);
      ...
      if ( !_9__12_0 )
      {
        ...
        _9__12_0 = (System_Func_object__object__o *)sub_1B86604(System_Func_BankShopEntity__string__TypeInfo);
        ...
        sub_1B8635C((CGThumbnailListItem_o *)&static_fields->__9__12_0, (int32_t)_9__12_0, v26, v27);
      }
      v28 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_object__object_(
                                                                   ...
                                                                   (const MethodInfo_2FA1274 *)Method_System_Linq_Enumerable_Select_BankShopEntity__string___);
      ...
      sub_1B8635C((CGThumbnailListItem_o *)&v33->BankShopEntityCollection, (int32_t)v21, v29, v30);
      PurchaseBehaviour_TypeInfo->static_fields->ConsumableProductIdCollection = v31;
      sub_1B8635C((CGThumbnailListItem_o *)PurchaseBehaviour_TypeInfo->static_fields, (int32_t)v31, v34, v35);
    }
  }
}
...
PurchaseBehaviour_o *__fastcall PurchaseBehaviour__GetInstance(const MethodInfo *method)
{
  ...
  if ( (byte_4A4DDD9 & 1) == 0 )
  {
    sub_1B863B8(&Method_UnityEngine_Component_GetComponentInChildren_PurchaseBehaviour___, v1);
    sub_1B863B8(&UnityEngine_Object_TypeInfo, v2);
    sub_1B863B8(&PurchaseBehaviour_TypeInfo, v3);
    sub_1B863B8(&Method_SingletonMonoBehaviour_ManagementManager__getInstance__, v4);
    byte_4A4DDD9 = 1;
  }
...
LABEL_21:
  ...
  if ( !v13 )
  {
    ...
    ComponentInChildren_object__49695012 = UnityEngine_Component__GetComponentInChildren_object__49695012(
                                             ...
                                             (const MethodInfo_2F64924 *)Method_UnityEngine_Component_GetComponentInChildren_PurchaseBehaviour___);
    v18 = PurchaseBehaviour_TypeInfo;
    v19 = ComponentInChildren_object__49695012;
    if ( !PurchaseBehaviour_TypeInfo->_2.cctor_finished )
    {
      j_il2cpp_runtime_class_init_0(PurchaseBehaviour_TypeInfo);
      v18 = PurchaseBehaviour_TypeInfo;
    ...
    sub_1B8635C((CGThumbnailListItem_o *)&static_fields->_cached_instance, (int32_t)v19, v16, v17);
    goto LABEL_21;
  }
  return result;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4DDE6 & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Collections_Generic_List_string___ctor__, v1);
    sub_1B863B8(&System_Collections_Generic_List_string__TypeInfo, v2);
    sub_1B863B8(&UnityEngine_Object_TypeInfo, v3);
    sub_1B863B8(&PurchaseBehaviour_TypeInfo, v4);
    byte_4A4DDE6 = 1;
  }
  v5 = PurchaseBehaviour_TypeInfo;
  if ( !PurchaseBehaviour_TypeInfo->_2.cctor_finished )
...
void __fastcall PurchaseBehaviour__Ready(const MethodInfo *method)
{
  ...
  if ( (byte_4A4DDDB & 1) == 0 )
  {
    sub_1B863B8(&PurchaseBehaviour_TypeInfo, v1);
    byte_4A4DDDB = 1;
  }
...
void __fastcall PurchaseBehaviour__Ready_39589684(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4DDDC & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Linq_Enumerable_ToList_string___, productIdArray);
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)instance, 0LL, 0LL) )
  {
    ...
    sub_1B8635C((CGThumbnailListItem_o *)&static_fields->_cached_instance, (int32_t)instance, v7, v8);
  }
  ...
  sub_1B8635C((CGThumbnailListItem_o *)PurchaseBehaviour_TypeInfo->static_fields, (int32_t)v15, v12, v13);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !purchaseLogic )
    sub_1B86614(0LL, bankShop);
  PurchaseLogic__InitiatePurchase(purchaseLogic, bankShop, finishedAction, method);
}


void __fastcall PurchaseBehaviour__StartPayment_39590784(
        PurchaseBehaviour_o *this,
        int32_t shopId,
        ...
        const MethodInfo *method)
{
  ...
  purchaseLogic = this->fields._purchaseLogic;
  if ( !purchaseLogic )
    sub_1B86614(0LL, shopId);
  PurchaseLogic__InitiatePurchase_39590808(purchaseLogic, shopId, productId, price, finishedAction, method);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&purchaseLogic->fields._logOutputAction, (int32_t)value, (int32_t)method, v3);
}
...
void __fastcall PurchaseBehaviour___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A4DDEB & 1) == 0 )
  {
    sub_1B863B8(&PurchaseBehaviour___c_TypeInfo, v1);
    byte_4A4DDEB = 1;
  }
  v2 = (Il2CppObject *)sub_1B86604(PurchaseBehaviour___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  PurchaseBehaviour___c_TypeInfo->static_fields->__9 = (struct PurchaseBehaviour___c_o *)v2;
  sub_1B8635C((CGThumbnailListItem_o *)PurchaseBehaviour___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
