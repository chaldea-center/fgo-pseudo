        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0B75C & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_8495/*"MASTER_MISSION_RECEIVE_CONFIRM_CANCEL"*/, v3);
    sub_1B686D4(&StringLiteral_8498/*"MASTER_MISSION_RECEIVE_CONFIRM_DLG_SUB_MSG"*/, v4);
    sub_1B686D4(&StringLiteral_8497/*"MASTER_MISSION_RECEIVE_CONFIRM_DLG_MSG"*/, v5);
    sub_1B686D4(&StringLiteral_8496/*"MASTER_MISSION_RECEIVE_CONFIRM_DECIDE"*/, v6);
    sub_1B686D4(&StringLiteral_8499/*"MASTER_MISSION_RECEIVE_CONFIRM_DLG_TITLE"*/, v7);
    byte_4A0B75C = 1;
  }
  ...
  receiveConfirmListViewManager = (MasterMissionReceiveConfirmListViewManager_o *)LocalizationManager__Get(
                                                                                    (System_String_o *)StringLiteral_8499/*"MASTER_MISSION_RECEIVE_CONFIRM_DLG_TITLE"*/,
                                                                                    0LL);
  if ( !titleLabel )
    goto LABEL_12;
  ...
  receiveConfirmListViewManager = (MasterMissionReceiveConfirmListViewManager_o *)LocalizationManager__Get(
                                                                                    (System_String_o *)StringLiteral_8497/*"MASTER_MISSION_RECEIVE_CONFIRM_DLG_MSG"*/,
                                                                                    0LL);
  if ( !subTitleLabel )
    goto LABEL_12;
  ...
  receiveConfirmListViewManager = (MasterMissionReceiveConfirmListViewManager_o *)LocalizationManager__Get(
                                                                                    (System_String_o *)StringLiteral_8498/*"MASTER_MISSION_RECEIVE_CONFIRM_DLG_SUB_MSG"*/,
                                                                                    0LL);
  if ( !subTitleSmallLabel
    || (UILabel__set_text(subTitleSmallLabel, (System_String_o *)receiveConfirmListViewManager, 0LL),
        cancelLabel = this->fields.cancelLabel,
        receiveConfirmListViewManager = (MasterMissionReceiveConfirmListViewManager_o *)LocalizationManager__Get(
                                                                                          (System_String_o *)StringLiteral_8495/*"MASTER_MISSION_RECEIVE_CONFIRM_CANCEL"*/,
                                                                                          0LL),
        !cancelLabel)
    || (UILabel__set_text(cancelLabel, (System_String_o *)receiveConfirmListViewManager, 0LL),
        decideLabel = this->fields.decideLabel,
        receiveConfirmListViewManager = (MasterMissionReceiveConfirmListViewManager_o *)LocalizationManager__Get(
                                                                                          (System_String_o *)StringLiteral_8496/*"MASTER_MISSION_RECEIVE_CONFIRM_DECIDE"*/,
                                                                                          0LL),
        !decideLabel) )
  {
LABEL_12:
    sub_1B68930(receiveConfirmListViewManager, v8);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0B75D & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_MasterMissionReceiveConfirmDialog_OnClickCancelButton__, v3);
    sub_1B686D4(&Method_MasterMissionReceiveConfirmDialog__OnClickCancelButton_b__12_0__, v4);
    byte_4A0B75D = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( (*((_BYTE *)Method_MasterMissionReceiveConfirmDialog_OnClickCancelButton__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B686EC(Method_MasterMissionReceiveConfirmDialog_OnClickCancelButton__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B686D4(&System_Action_TypeInfo, method);
    sub_1B686D4(&Method_MasterMissionReceiveConfirmDialog_OnClickDecideButton__, v3);
    sub_1B686D4(&Method_MasterMissionReceiveConfirmDialog__OnClickDecideButton_b__13_0__, v4);
    byte_4A0B75E = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( (*((_BYTE *)Method_MasterMissionReceiveConfirmDialog_OnClickDecideButton__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B686EC(Method_MasterMissionReceiveConfirmDialog_OnClickDecideButton__);
    v6 = (System_Reflection_MethodBase_o *)sub_1B686B8(v5, v5[4]);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)v6, (int32_t)callback, v7, v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19B36B0;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19B3668;
}
