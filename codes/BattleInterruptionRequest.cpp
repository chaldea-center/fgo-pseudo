        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2127F & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_22458/*"phase"*/, *(_QWORD *)&questId);
    sub_1B715CC(&StringLiteral_22634/*"questId"*/, v9);
    sub_1B715CC(&StringLiteral_22843/*"restartWave"*/, v10);
    byte_4A2127F = 1;
  }
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22458/*"phase"*/, phase, v11);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22843/*"restartWave"*/, restartWave, v12);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2127E & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_17042/*"battle/interruption"*/, v2);
    byte_4A2127E = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61505504(BaseUrl, (System_String_o *)StringLiteral_17042/*"battle/interruption"*/, 0LL);
}
