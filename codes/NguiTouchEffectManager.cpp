...
void __fastcall NguiTouchEffectManager__Drag(UnityEngine_Vector2_o v, const MethodInfo *method)
{
  ...
  if ( (byte_4A746B4 & 1) == 0 )
  {
    method = (const MethodInfo *)sub_1B90010(&NguiTouchEffectManager_TypeInfo, v2);
    byte_4A746B4 = 1;
  }
  dragAction = NguiTouchEffectManager_TypeInfo->static_fields->dragAction;
  if ( !dragAction )
    sub_1B9026C(method, v2);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A746B1 & 1) == 0 )
  {
    sub_1B90010(&NguiTouchEffectManager_TypeInfo, method);
    byte_4A746B1 = 1;
  }
  static_fields = NguiTouchEffectManager_TypeInfo->static_fields;
  static_fields->dragAction = dragAction;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&static_fields->dragAction, (int32_t)dragAction, v2, v3);
}
...
void __fastcall NguiTouchEffectManager__RegisterUnPressFunc(System_Action_o *unPressAction, const MethodInfo *method)
{
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&static_fields->unPressAction, (int32_t)unPressAction, v2, v3);
}
...
void __fastcall NguiTouchEffectManager__UnPress(const MethodInfo *method)
{
  ...
  if ( (byte_4A746B3 & 1) == 0 )
  {
    method = (const MethodInfo *)sub_1B90010(&NguiTouchEffectManager_TypeInfo, v1);
    byte_4A746B3 = 1;
  }
