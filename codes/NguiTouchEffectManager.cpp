...
void __fastcall NguiTouchEffectManager__Drag(UnityEngine_Vector2_o v, const MethodInfo *method)
{
  ...
  if ( (byte_4B492C9 & 1) == 0 )
  {
    method = (const MethodInfo *)sub_1BDB878(&NguiTouchEffectManager_TypeInfo, v2);
    byte_4B492C9 = 1;
  }
  dragAction = NguiTouchEffectManager_TypeInfo->static_fields->dragAction;
  if ( !dragAction )
    sub_1BDBAD4(method, v2);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B492C6 & 1) == 0 )
  {
    sub_1BDB878(&NguiTouchEffectManager_TypeInfo, method);
    byte_4B492C6 = 1;
  }
  static_fields = NguiTouchEffectManager_TypeInfo->static_fields;
  static_fields->dragAction = dragAction;
  sub_1BDB81C((CGThumbnailListItem_o *)&static_fields->dragAction, (int32_t)dragAction, v2, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)NguiTouchEffectManager_TypeInfo->static_fields, (int32_t)pressAction, v2, v3);
}
...
void __fastcall NguiTouchEffectManager__RegisterUnPressFunc(System_Action_o *unPressAction, const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&static_fields->unPressAction, (int32_t)unPressAction, v2, v3);
}
...
void __fastcall NguiTouchEffectManager__UnPress(const MethodInfo *method)
{
  ...
  if ( (byte_4B492C8 & 1) == 0 )
  {
    method = (const MethodInfo *)sub_1BDB878(&NguiTouchEffectManager_TypeInfo, v1);
    byte_4B492C8 = 1;
  }
