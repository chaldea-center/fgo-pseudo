...
void __fastcall NguiTouchEffectManager__Drag(UnityEngine_Vector2_o v, const MethodInfo *method)
{
  ...
  if ( (byte_48E70E4 & 1) == 0 )
  {
    method = (const MethodInfo *)sub_1B00CCC(&NguiTouchEffectManager_TypeInfo, v2);
    byte_48E70E4 = 1;
  }
  dragAction = NguiTouchEffectManager_TypeInfo->static_fields->dragAction;
  if ( !dragAction )
    sub_1B00F28(method, v2);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E70E1 & 1) == 0 )
  {
    sub_1B00CCC(&NguiTouchEffectManager_TypeInfo, method);
    byte_48E70E1 = 1;
  }
  static_fields = NguiTouchEffectManager_TypeInfo->static_fields;
  static_fields->dragAction = dragAction;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&static_fields->dragAction, (int32_t)dragAction, v2, v3);
}
...
void __fastcall NguiTouchEffectManager__RegisterUnPressFunc(System_Action_o *unPressAction, const MethodInfo *method)
{
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&static_fields->unPressAction, (int32_t)unPressAction, v2, v3);
}
...
void __fastcall NguiTouchEffectManager__UnPress(const MethodInfo *method)
{
  ...
  if ( (byte_48E70E3 & 1) == 0 )
  {
    method = (const MethodInfo *)sub_1B00CCC(&NguiTouchEffectManager_TypeInfo, v1);
    byte_48E70E3 = 1;
  }
