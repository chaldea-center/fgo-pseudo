...
void __fastcall NguiTouchEffectManager__Drag(UnityEngine_Vector2_o v, const MethodInfo *method)
{
  ...
  if ( (byte_4BE0D80 & 1) == 0 )
  {
    method = (const MethodInfo *)sub_1C21E38(&NguiTouchEffectManager_TypeInfo);
    byte_4BE0D80 = 1;
  }
  dragAction = NguiTouchEffectManager_TypeInfo->static_fields->dragAction;
  if ( !dragAction )
    sub_1C22094(method, v2);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BE0D7D & 1) == 0 )
  {
    sub_1C21E38(&NguiTouchEffectManager_TypeInfo);
    byte_4BE0D7D = 1;
  }
  static_fields = NguiTouchEffectManager_TypeInfo->static_fields;
  static_fields->dragAction = dragAction;
  sub_1C21DDC((PartyOrganizationUtility_o *)&static_fields->dragAction, (int64_t)dragAction, v2, v3, v4, v5, v6, v7);
}
