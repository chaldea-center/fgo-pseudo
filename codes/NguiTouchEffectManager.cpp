...
void __fastcall NguiTouchEffectManager__Drag(UnityEngine_Vector2_o v, const MethodInfo *method)
{
  ...
  if ( (byte_4C26848 & 1) == 0 )
  {
    method = (const MethodInfo *)sub_1C3B764(&NguiTouchEffectManager_TypeInfo, v2);
    byte_4C26848 = 1;
  }
  dragAction = NguiTouchEffectManager_TypeInfo->static_fields->dragAction;
  if ( !dragAction )
    sub_1C3B9C0(method, v2);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C26845 & 1) == 0 )
  {
    sub_1C3B764(&NguiTouchEffectManager_TypeInfo, method);
    byte_4C26845 = 1;
  }
  static_fields = NguiTouchEffectManager_TypeInfo->static_fields;
  static_fields->dragAction = dragAction;
  sub_1C3B708((PartyOrganizationUtility_o *)&static_fields->dragAction, (int64_t)dragAction, v2, v3, v4, v5, v6, v7);
}
...
void __fastcall NguiTouchEffectManager__UnPress(const MethodInfo *method)
{
  ...
  if ( (byte_4C26847 & 1) == 0 )
  {
    method = (const MethodInfo *)sub_1C3B764(&NguiTouchEffectManager_TypeInfo, v1);
    byte_4C26847 = 1;
  }
