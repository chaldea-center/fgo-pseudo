...
void __fastcall NguiTouchEffectManager__Drag(UnityEngine_Vector2_o v, const MethodInfo *method)
{
  ...
  if ( (byte_4B6B3B5 & 1) == 0 )
  {
    method = (const MethodInfo *)sub_1BE4ACC(&NguiTouchEffectManager_TypeInfo, v2);
    byte_4B6B3B5 = 1;
  }
  dragAction = NguiTouchEffectManager_TypeInfo->static_fields->dragAction;
  if ( !dragAction )
    sub_1BE4D28(method, v2);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6B3B2 & 1) == 0 )
  {
    sub_1BE4ACC(&NguiTouchEffectManager_TypeInfo, method);
    byte_4B6B3B2 = 1;
  }
  static_fields = NguiTouchEffectManager_TypeInfo->static_fields;
  static_fields->dragAction = dragAction;
  sub_1BE4A70((PartyOrganizationUtility_o *)&static_fields->dragAction, (int64_t)dragAction, v2, v3, v4, v5, v6, v7);
}
...
void __fastcall NguiTouchEffectManager__UnPress(const MethodInfo *method)
{
  ...
  if ( (byte_4B6B3B4 & 1) == 0 )
  {
    method = (const MethodInfo *)sub_1BE4ACC(&NguiTouchEffectManager_TypeInfo, v1);
    byte_4B6B3B4 = 1;
  }
