...
System_Collections_IEnumerator_o *UICounterLabel__ExecAnimation(UICounterLabel_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2FFB3 & 1) == 0 )
  {
    sub_1C93AD4(&UICounterLabel__ExecAnimation_d__16_TypeInfo);
    byte_4D2FFB3 = 1;
  }
  v3 = sub_1C93D20(UICounterLabel__ExecAnimation_d__16_TypeInfo);
...
void UICounterLabel__SetCountLabel(UICounterLabel_o *this, int32_t count, const MethodInfo *method)
{
  ...
  if ( (byte_4D2FFB4 & 1) == 0 )
  {
    this = (UICounterLabel_o *)sub_1C93AD4(&int_TypeInfo);
    byte_4D2FFB4 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2FFB5 & 1) == 0 )
  {
    this = (UICounterLabel__ExecAnimation_d__16_o *)sub_1C93AD4(&UnityEngine_Application_TypeInfo);
    byte_4D2FFB5 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C93AE8(&Method_UICounterLabel__ExecAnimation_d__16_System_Collections_IEnumerator_Reset__);
  sub_1C93BFC(v3, v4);
}
