        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A72C & 1) == 0 )
  {
    sub_1B885B0(&UICounterLabel__ExecAnimation_d__16_TypeInfo);
    byte_4A5A72C = 1;
  }
  v3 = sub_1B887FC(UICounterLabel__ExecAnimation_d__16_TypeInfo);
...
void __fastcall UICounterLabel__SetCountLabel(UICounterLabel_o *this, int32_t count, const MethodInfo *method)
{
  ...
  if ( (byte_4A5A72D & 1) == 0 )
  {
    this = (UICounterLabel_o *)sub_1B885B0(&int_TypeInfo);
    byte_4A5A72D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.format, (int32_t)format, (int32_t)format, isFixedWidth);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A72E & 1) == 0 )
  {
    this = (UICounterLabel__ExecAnimation_d__16_o *)sub_1B885B0(&UnityEngine_Application_TypeInfo);
    byte_4A5A72E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B885C4(&Method_UICounterLabel__ExecAnimation_d__16_System_Collections_IEnumerator_Reset__);
  sub_1B886D8(v3, v4);
}
