        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC703C & 1) == 0 )
  {
    sub_1C1ABD4(&UICounterLabel__ExecAnimation_d__16_TypeInfo, method);
    byte_4BC703C = 1;
  }
  v3 = sub_1C1AE20(UICounterLabel__ExecAnimation_d__16_TypeInfo);
...
void __fastcall UICounterLabel__SetCountLabel(UICounterLabel_o *this, int32_t count, const MethodInfo *method)
{
  ...
  if ( (byte_4BC703D & 1) == 0 )
  {
    this = (UICounterLabel_o *)sub_1C1ABD4(&int_TypeInfo, *(_QWORD *)&count);
    byte_4BC703D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC703E & 1) == 0 )
  {
    this = (UICounterLabel__ExecAnimation_d__16_o *)sub_1C1ABD4(&UnityEngine_Application_TypeInfo, method);
    byte_4BC703E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C1ABE8(&Method_UICounterLabel__ExecAnimation_d__16_System_Collections_IEnumerator_Reset__);
  sub_1C1ACFC(v3, v4);
}
