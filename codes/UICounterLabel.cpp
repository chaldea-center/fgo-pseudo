        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6614B & 1) == 0 )
  {
    sub_1BE4ACC(&UICounterLabel__ExecAnimation_d__16_TypeInfo, method);
    byte_4B6614B = 1;
  }
  v3 = sub_1BE4D18(UICounterLabel__ExecAnimation_d__16_TypeInfo);
...
void __fastcall UICounterLabel__SetCountLabel(UICounterLabel_o *this, int32_t count, const MethodInfo *method)
{
  ...
  if ( (byte_4B6614C & 1) == 0 )
  {
    this = (UICounterLabel_o *)sub_1BE4ACC(&int_TypeInfo, *(_QWORD *)&count);
    byte_4B6614C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6614D & 1) == 0 )
  {
    this = (UICounterLabel__ExecAnimation_d__16_o *)sub_1BE4ACC(&UnityEngine_Application_TypeInfo, method);
    byte_4B6614D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BE4AE0(&Method_UICounterLabel__ExecAnimation_d__16_System_Collections_IEnumerator_Reset__);
  sub_1BE4BF4(v3, v4);
}
