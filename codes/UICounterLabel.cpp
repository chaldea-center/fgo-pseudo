...
System_Collections_IEnumerator_o *UICounterLabel__ExecAnimation(UICounterLabel_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C4256C & 1) == 0 )
  {
    sub_1C37058(&UICounterLabel__ExecAnimation_d__16_TypeInfo);
    byte_4C4256C = 1;
  }
  v3 = sub_1C372A4(UICounterLabel__ExecAnimation_d__16_TypeInfo);
...
void UICounterLabel__SetCountLabel(UICounterLabel_o *this, int32_t count, const MethodInfo *method)
{
  ...
  if ( (byte_4C4256D & 1) == 0 )
  {
    this = (UICounterLabel_o *)sub_1C37058(&int_TypeInfo);
    byte_4C4256D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C4256E & 1) == 0 )
  {
    this = (UICounterLabel__ExecAnimation_d__16_o *)sub_1C37058(&UnityEngine_Application_TypeInfo);
    byte_4C4256E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C3706C(&Method_UICounterLabel__ExecAnimation_d__16_System_Collections_IEnumerator_Reset__);
  sub_1C37180(v3, v4);
}
