...
System_Collections_IEnumerator_o *UICounterLabel__ExecAnimation(UICounterLabel_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEDC5A & 1) == 0 )
  {
    sub_1C7BAE8(&UICounterLabel__ExecAnimation_d__16_TypeInfo);
    byte_4CEDC5A = 1;
  }
  v3 = sub_1C7BD34(UICounterLabel__ExecAnimation_d__16_TypeInfo);
...
void UICounterLabel__SetCountLabel(UICounterLabel_o *this, int32_t count, const MethodInfo *method)
{
  ...
  if ( (byte_4CEDC5B & 1) == 0 )
  {
    this = (UICounterLabel_o *)sub_1C7BAE8(&int_TypeInfo);
    byte_4CEDC5B = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEDC5C & 1) == 0 )
  {
    this = (UICounterLabel__ExecAnimation_d__16_o *)sub_1C7BAE8(&UnityEngine_Application_TypeInfo);
    byte_4CEDC5C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C7BAFC(&Method_UICounterLabel__ExecAnimation_d__16_System_Collections_IEnumerator_Reset__);
  sub_1C7BC10(v3, v4);
}
