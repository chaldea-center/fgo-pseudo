        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B01573 & 1) == 0 )
  {
    sub_1BC3008(&UICounterLabel__ExecAnimation_d__16_TypeInfo, method);
    byte_4B01573 = 1;
  }
  v3 = sub_1BC3254(UICounterLabel__ExecAnimation_d__16_TypeInfo);
...
void __fastcall UICounterLabel__SetCountLabel(UICounterLabel_o *this, int32_t count, const MethodInfo *method)
{
  ...
  if ( (byte_4B01574 & 1) == 0 )
  {
    this = (UICounterLabel_o *)sub_1BC3008(&int_TypeInfo, *(_QWORD *)&count);
    byte_4B01574 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B01575 & 1) == 0 )
  {
    this = (UICounterLabel__ExecAnimation_d__16_o *)sub_1BC3008(&UnityEngine_Application_TypeInfo, method);
    byte_4B01575 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BC301C(&Method_UICounterLabel__ExecAnimation_d__16_System_Collections_IEnumerator_Reset__);
  sub_1BC3130(v3, v4);
}
