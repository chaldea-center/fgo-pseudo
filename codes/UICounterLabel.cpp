...
System_Collections_IEnumerator_o *UICounterLabel__ExecAnimation(UICounterLabel_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2BE01 & 1) == 0 )
  {
    sub_1C94098(&UICounterLabel__ExecAnimation_d__16_TypeInfo);
    byte_4D2BE01 = 1;
  }
  v3 = sub_1C942E4(UICounterLabel__ExecAnimation_d__16_TypeInfo);
...
void UICounterLabel__SetCountLabel(UICounterLabel_o *this, int32_t count, const MethodInfo *method)
{
  ...
  if ( (byte_4D2BE02 & 1) == 0 )
  {
    this = (UICounterLabel_o *)sub_1C94098(&int_TypeInfo);
    byte_4D2BE02 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2BE03 & 1) == 0 )
  {
    this = (UICounterLabel__ExecAnimation_d__16_o *)sub_1C94098(&UnityEngine_Application_TypeInfo);
    byte_4D2BE03 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C940AC(&Method_UICounterLabel__ExecAnimation_d__16_System_Collections_IEnumerator_Reset__);
  sub_1C941C0(v3, v4);
}
