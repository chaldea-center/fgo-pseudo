        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFCCD7 & 1) == 0 )
  {
    sub_1C2E12C(&UICounterLabel__ExecAnimation_d__16_TypeInfo, method);
    byte_4BFCCD7 = 1;
  }
  v3 = sub_1C2E378(UICounterLabel__ExecAnimation_d__16_TypeInfo);
...
void __fastcall UICounterLabel__SetCountLabel(UICounterLabel_o *this, int32_t count, const MethodInfo *method)
{
  ...
  if ( (byte_4BFCCD8 & 1) == 0 )
  {
    this = (UICounterLabel_o *)sub_1C2E12C(&int_TypeInfo, *(_QWORD *)&count);
    byte_4BFCCD8 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFCCD9 & 1) == 0 )
  {
    this = (UICounterLabel__ExecAnimation_d__16_o *)sub_1C2E12C(&UnityEngine_Application_TypeInfo, method);
    byte_4BFCCD9 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C2E140(&Method_UICounterLabel__ExecAnimation_d__16_System_Collections_IEnumerator_Reset__);
  sub_1C2E254(v3, v4);
}
