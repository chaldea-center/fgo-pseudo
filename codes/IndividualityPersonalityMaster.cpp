void __fastcall IndividualityPersonalityMaster___ctor(IndividualityPersonalityMaster_o *this, const MethodInfo *method)
{
  ...
  DataMasterBase_object__object__int____ctor(
    ...
    484,
    (const MethodInfo_32DFB18 *)Method_DataMasterBase_IndividualityPersonalityMaster__IndividualityPersonalityEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B44DCE & 1) == 0 )
  {
    ...
    sub_1BDB878(&System_Collections_Generic_IEnumerator_IndividualityPersonalityEntity__TypeInfo, v9);
    sub_1BDB878(&System_Collections_IEnumerator_TypeInfo, v10);
    sub_1BDB878(&IndividualityPersonalityEntity_TypeInfo, v11);
    byte_4B44DCE = 1;
  }
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
    sub_1BDBAD4(0LL, individuality);
  Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                 list,
                 (const MethodInfo_327DBFC *)Method_System_Collections_ObjectModel_Collection_IndividualityPersonalityEntity__GetEnumerator__);
  if ( !Enumerator )
    sub_1BDBAD4(0LL, v13);
  while ( 1 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B44DCF & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Linq_Enumerable_FirstOrDefault_IndividualityPersonalityEntity___, entity);
    sub_1BDB878(&System_Func_IndividualityPersonalityEntity__bool__TypeInfo, v7);
    sub_1BDB878(&Method_IndividualityPersonalityMaster___c__DisplayClass1_0__TryGetEntityByPersonalityValue_b__0__, v8);
    sub_1BDB878(&IndividualityPersonalityMaster___c__DisplayClass1_0_TypeInfo, v9);
    byte_4B44DCF = 1;
  }
  v10 = sub_1BDBAC4(IndividualityPersonalityMaster___c__DisplayClass1_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v10, 0LL);
  if ( !v10 )
    sub_1BDBAD4(v11, v12);
  *(_DWORD *)(v10 + 16) = personalityValue;
  list = this->fields.list;
  v14 = (System_Func_object__bool__o *)sub_1BDBAC4(System_Func_IndividualityPersonalityEntity__bool__TypeInfo);
  ...
  v15 = System_Linq_Enumerable__FirstOrDefault_object__50698552(
          ...
          (const MethodInfo_3059938 *)Method_System_Linq_Enumerable_FirstOrDefault_IndividualityPersonalityEntity___);
