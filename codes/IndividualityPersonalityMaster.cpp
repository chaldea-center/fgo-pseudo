void IndividualityPersonalityMaster___ctor(IndividualityPersonalityMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4D2CCD7 & 1) == 0 )
  {
    sub_1C94098(&Method_DataMasterBase_IndividualityPersonalityMaster__IndividualityPersonalityEntity__int___ctor__);
    byte_4D2CCD7 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    484,
    (const MethodInfo_345919C *)Method_DataMasterBase_IndividualityPersonalityMaster__IndividualityPersonalityEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2CCD5 & 1) == 0 )
  {
    sub_1C94098(&Method_System_Collections_ObjectModel_Collection_IndividualityPersonalityEntity__GetEnumerator__);
    ...
    sub_1C94098(&System_Collections_Generic_IEnumerator_IndividualityPersonalityEntity__TypeInfo);
    sub_1C94098(&System_Collections_IEnumerator_TypeInfo);
    sub_1C94098(&IndividualityPersonalityEntity_TypeInfo);
    byte_4D2CCD5 = 1;
  }
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
    sub_1C942F0(0, individuality);
  Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                 list,
                 (const MethodInfo_33F413C *)Method_System_Collections_ObjectModel_Collection_IndividualityPersonalityEntity__GetEnumerator__);
  if ( !Enumerator )
    sub_1C942F0(0, v6);
  while ( 1 )
  {
...
LABEL_9:
    ...
    {
LABEL_16:
      v15 = sub_1C6A420(Enumerator, System_Collections_Generic_IEnumerator_IndividualityPersonalityEntity__TypeInfo, 0);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2CCD6 & 1) == 0 )
  {
    sub_1C94098(&Method_System_Linq_Enumerable_FirstOrDefault_IndividualityPersonalityEntity___);
    sub_1C94098(&System_Func_IndividualityPersonalityEntity__bool__TypeInfo);
    sub_1C94098(&Method_IndividualityPersonalityMaster___c__DisplayClass1_0__TryGetEntityByPersonalityValue_b__0__);
    sub_1C94098(&IndividualityPersonalityMaster___c__DisplayClass1_0_TypeInfo);
    byte_4D2CCD6 = 1;
  }
  v7 = sub_1C942E4(IndividualityPersonalityMaster___c__DisplayClass1_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v7, 0);
  if ( !v7 )
    sub_1C942F0(v8, v9);
  *(_DWORD *)(v7 + 16) = personalityValue;
  list = this->fields.list;
  v11 = (System_Func_object__bool__o *)sub_1C942E4(System_Func_IndividualityPersonalityEntity__bool__TypeInfo);
  ...
  v12 = System_Linq_Enumerable__FirstOrDefault_object__52191056(
          ...
          (const MethodInfo_31C5F50 *)Method_System_Linq_Enumerable_FirstOrDefault_IndividualityPersonalityEntity___);
