void __fastcall IndividualityPersonalityMaster___ctor(IndividualityPersonalityMaster_o *this, const MethodInfo *method)
{
  ...
  DataMasterBase_object__object__int____ctor(
    ...
    484,
    (const MethodInfo_32ACD4C *)Method_DataMasterBase_IndividualityPersonalityMaster__IndividualityPersonalityEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B02380 & 1) == 0 )
  {
    ...
    sub_1BC3008(&System_Collections_Generic_IEnumerator_IndividualityPersonalityEntity__TypeInfo, v9);
    sub_1BC3008(&System_Collections_IEnumerator_TypeInfo, v10);
    sub_1BC3008(&IndividualityPersonalityEntity_TypeInfo, v11);
    byte_4B02380 = 1;
  }
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
    sub_1BC3264(0LL, individuality);
  Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                 list,
                 (const MethodInfo_324AE30 *)Method_System_Collections_ObjectModel_Collection_IndividualityPersonalityEntity__GetEnumerator__);
  if ( !Enumerator )
    sub_1BC3264(0LL, v13);
  while ( 1 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B02381 & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Linq_Enumerable_FirstOrDefault_IndividualityPersonalityEntity___, entity);
    sub_1BC3008(&System_Func_IndividualityPersonalityEntity__bool__TypeInfo, v7);
    sub_1BC3008(&Method_IndividualityPersonalityMaster___c__DisplayClass1_0__TryGetEntityByPersonalityValue_b__0__, v8);
    sub_1BC3008(&IndividualityPersonalityMaster___c__DisplayClass1_0_TypeInfo, v9);
    byte_4B02381 = 1;
  }
  v10 = sub_1BC3254(IndividualityPersonalityMaster___c__DisplayClass1_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v10, 0LL);
  if ( !v10 )
    sub_1BC3264(v11, v12);
  *(_DWORD *)(v10 + 16) = personalityValue;
  list = this->fields.list;
  v14 = (System_Func_object__bool__o *)sub_1BC3254(System_Func_IndividualityPersonalityEntity__bool__TypeInfo);
  ...
  v15 = System_Linq_Enumerable__FirstOrDefault_object__50493748(
          ...
          (const MethodInfo_3027934 *)Method_System_Linq_Enumerable_FirstOrDefault_IndividualityPersonalityEntity___);
