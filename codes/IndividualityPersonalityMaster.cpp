void __fastcall IndividualityPersonalityMaster___ctor(IndividualityPersonalityMaster_o *this, const MethodInfo *method)
{
  if ( (byte_42B1BA3 & 1) == 0 )
  {
    sub_B52984(&Method_DataMasterBase_IndividualityPersonalityMaster__IndividualityPersonalityEntity__int___ctor__);
    byte_42B1BA3 = 1;
  }
  DataMasterBase_WarMaster__WarEntity__int____ctor(
    (DataMasterBase_WarMaster__WarEntity__int__o *)this,
    476,
    (const MethodInfo_23E223C *)Method_DataMasterBase_IndividualityPersonalityMaster__IndividualityPersonalityEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B1BA2 & 1) == 0 )
  {
    ...
    sub_B52984(&IndividualityPersonalityEntity_TypeInfo);
    byte_42B1BA2 = 1;
  }
...
LABEL_16:
    ...
    if ( v17 )
    {
      v20 = *(&IndividualityPersonalityEntity_TypeInfo->_2.bitflags2 + 1);
      if ( *(unsigned __int8 *)(*v17 + 300LL) >= (unsigned int)v20
        && *(IndividualityPersonalityEntity_c **)(*(_QWORD *)(*v17 + 200LL) + 8 * v20 - 8) == IndividualityPersonalityEntity_TypeInfo )
      {
        v21 = v17[3];
        if ( !v21 )
          sub_B52A5C(v17, v18);
