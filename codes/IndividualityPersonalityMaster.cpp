void __fastcall IndividualityPersonalityMaster___ctor(IndividualityPersonalityMaster_o *this, const MethodInfo *method)
{
  ...
  DataMasterBase_object__object__int____ctor(
    ...
    478,
    (const MethodInfo_30F8720 *)Method_DataMasterBase_IndividualityPersonalityMaster__IndividualityPersonalityEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1FDCC & 1) == 0 )
  {
    sub_1B715CC(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__GetEnumerator__, individuality);
    sub_1B715CC(&Method_System_Linq_Enumerable_All_int___, v5);
    ...
    sub_1B715CC(&IndividualityPersonalityEntity_TypeInfo, v11);
    byte_4A1FDCC = 1;
  }
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
    sub_1B71828(0LL, individuality);
...
LABEL_16:
    ...
    if ( v23 )
    {
        ...
        && *(IndividualityPersonalityEntity_c **)(*(_QWORD *)(*v23 + 200LL) + 8 * methodPtr_low - 8) == IndividualityPersonalityEntity_TypeInfo )
      {
        ...
        {
          v28 = (System_Func_int__bool__o *)sub_1B71818(System_Func_int__bool__TypeInfo);
