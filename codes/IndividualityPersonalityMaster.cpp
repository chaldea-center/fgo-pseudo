void __fastcall IndividualityPersonalityMaster___ctor(IndividualityPersonalityMaster_o *this, const MethodInfo *method)
{
  ...
  DataMasterBase_object__object__int____ctor(
    ...
    477,
    (const MethodInfo_2FE6A0C *)Method_DataMasterBase_IndividualityPersonalityMaster__IndividualityPersonalityEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E2AF5 & 1) == 0 )
  {
    sub_1B00CCC(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__GetEnumerator__, individuality);
    sub_1B00CCC(&Method_System_Linq_Enumerable_All_int___, v5);
    sub_1B00CCC(&Method_System_Linq_Enumerable_Contains_int___, v6);
    ...
    sub_1B00CCC(&IndividualityPersonalityEntity_TypeInfo, v11);
    byte_48E2AF5 = 1;
  }
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
    sub_1B00F28(0LL, individuality);
...
LABEL_16:
    ...
    if ( v23 )
    {
        ...
        && *(IndividualityPersonalityEntity_c **)(*(_QWORD *)(*v23 + 200LL) + 8 * methodPtr_low - 8) == IndividualityPersonalityEntity_TypeInfo )
      {
        ...
        {
          v28 = (System_Func_int__bool__o *)sub_1B00F18(System_Func_int__bool__TypeInfo);
          ...
          if ( System_Linq_Enumerable__All_int_(
                 ...
                 (const MethodInfo_2D6C6C4 *)Method_System_Linq_Enumerable_All_int___) )
          {
            v29 = *((_DWORD *)v25 + 5);
            goto LABEL_27;
          }
