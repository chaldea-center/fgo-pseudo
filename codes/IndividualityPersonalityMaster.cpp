void __fastcall IndividualityPersonalityMaster___ctor(IndividualityPersonalityMaster_o *this, const MethodInfo *method)
{
  ...
  DataMasterBase_object__object__int____ctor(
    ...
    478,
    (const MethodInfo_30D6758 *)Method_DataMasterBase_IndividualityPersonalityMaster__IndividualityPersonalityEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FEE1D & 1) == 0 )
  {
    sub_1B64A00(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__GetEnumerator__, individuality);
    sub_1B64A00(&Method_System_Linq_Enumerable_All_int___, v5);
    ...
    sub_1B64A00(&IndividualityPersonalityEntity_TypeInfo, v11);
    byte_49FEE1D = 1;
  }
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
    sub_1B64C5C(0LL, individuality);
...
LABEL_16:
    ...
    if ( v23 )
    {
        ...
        && *(IndividualityPersonalityEntity_c **)(*(_QWORD *)(*v23 + 200LL) + 8 * methodPtr_low - 8) == IndividualityPersonalityEntity_TypeInfo )
      {
        ...
        {
          v28 = (System_Func_int__bool__o *)sub_1B64C4C(System_Func_int__bool__TypeInfo);
