void __fastcall IndividualityPersonalityMaster___ctor(IndividualityPersonalityMaster_o *this, const MethodInfo *method)
{
  if ( (byte_438C946 & 1) == 0 )
  {
    sub_B775C4(&Method_DataMasterBase_IndividualityPersonalityMaster__IndividualityPersonalityEntity__int___ctor__);
    byte_438C946 = 1;
  }
  DataMasterBase_WarMaster__WarEntity__int____ctor(
    (DataMasterBase_WarMaster__WarEntity__int__o *)this,
    477,
    (const MethodInfo_21FB7F8 *)Method_DataMasterBase_IndividualityPersonalityMaster__IndividualityPersonalityEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_438C945 & 1) == 0 )
  {
    ...
    sub_B775C4(&Method_System_Linq_Enumerable_All_int___);
    ...
    sub_B775C4(&IndividualityPersonalityEntity_TypeInfo);
    byte_438C945 = 1;
  }
  list = (System_Collections_ObjectModel_Collection_UnicastIPAddressInformation__o *)this->fields.list;
  if ( !list )
    sub_B7769C(0LL, individuality);
...
LABEL_16:
    ...
    if ( v16 )
    {
        ...
        && *(IndividualityPersonalityEntity_c **)(*(_QWORD *)(*v16 + 200LL) + 8 * v19 - 8) == IndividualityPersonalityEntity_TypeInfo )
      {
        ...
        {
          v21 = (System_Func_int__bool__o *)sub_B77694(System_Func_int__bool__TypeInfo);
          ...
          if ( System_Linq_Enumerable__All_int_(
                 ...
                 (const MethodInfo_1D1C8A8 *)Method_System_Linq_Enumerable_All_int___) )
          {
            v22 = *((_DWORD *)v18 + 5);
            goto LABEL_27;
          }
