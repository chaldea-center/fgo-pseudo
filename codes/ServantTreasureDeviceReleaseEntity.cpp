        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D3147F & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_ServantTreasureDeviceReleaseEntity___c__IsUseInternal_b__12_0__);
    sub_1C93AD4(&ServantTreasureDeviceReleaseEntity___c_TypeInfo);
    byte_4D3147F = 1;
  }
  value = 0;
    ...
    case 113:
      ...
      if ( !Master_object
        || (List = CommonReleaseMaster__getList((CommonReleaseMaster_o *)Master_object, currentCondTargetId, 0),
            v18 = (System_Collections_Generic_Dictionary_int__bool__o *)sub_1C93D20(System_Collections_Generic_Dictionary_int__bool__TypeInfo),
...
LABEL_43:
      ...
      v12 = System_Linq_Enumerable__Any_bool__52108372(
...
void ServantTreasureDeviceReleaseEntity___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C93D20(ServantTreasureDeviceReleaseEntity___c_TypeInfo);
