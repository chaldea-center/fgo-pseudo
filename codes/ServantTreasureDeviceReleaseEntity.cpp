        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5939186 & 1) == 0 )
  {
    ...
    sub_21FFC50(&Method_ServantTreasureDeviceReleaseEntity___c__IsUseInternal_b__12_0__);
    sub_21FFC50(&ServantTreasureDeviceReleaseEntity___c_TypeInfo);
    byte_5939186 = 1;
  }
  value = 0;
  switch ( currentCondType )
  {
    ...
    case 113:
      ...
      if ( Master_object )
      {
        ...
        v16 = (System_Collections_Generic_Dictionary_int__bool__o *)sub_21FFEBC(System_Collections_Generic_Dictionary_int__bool__TypeInfo);
...
void ServantTreasureDeviceReleaseEntity___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_21FFEBC(ServantTreasureDeviceReleaseEntity___c_TypeInfo);
