...
LABEL_12:
  ...
  else
  {
    ...
    v22 = entity;
    v23 = (EventRewardAnotherPayListViewItem_o *)sub_1C3B9B0(EventRewardAnotherPayListViewItem_TypeInfo);
    ...
    else
    {
      ...
      Master_object = (Il2CppObject *)sub_1C3B708(v28 + 4);
    }
    v29 = 1;
    if ( !anotherItemIds )
      goto LABEL_29;
  ...
  if ( (int)v30 >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( ((unsigned __int8)Master_object & 1) != 0 )
      {
        ...
        v33 = v40;
        v34 = (EventRewardAnotherPayListViewItem_o *)sub_1C3B9B0(EventRewardAnotherPayListViewItem_TypeInfo);
        ...
        else
        {
          ...
          Master_object = (Il2CppObject *)sub_1C3B708(v39 + 4);
        }
        ++v29;
      }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1CCF8 & 1) == 0 )
  {
    this = (EventRewardAnotherPayListViewManager_o *)sub_1C3B764(
...
LABEL_16:
  ...
  else
  {
    ...
    if ( (*((_BYTE *)Method_EventRewardAnotherPayListViewManager_OnClickListView__ + 83) & 2) != 0 )
      v8 = (_QWORD *)sub_1C3B77C(Method_EventRewardAnotherPayListViewManager_OnClickListView__);
