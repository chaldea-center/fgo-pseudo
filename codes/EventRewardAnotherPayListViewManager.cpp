        ...
        const MethodInfo *method)
{
  ...
  sub_1C32BC4(&this->fields.onClickAction, clickAction);
...
LABEL_12:
  ...
  else
  {
    ...
    v16 = entity;
    v17 = (EventRewardAnotherPayListViewItem_o *)sub_1C32E6C(EventRewardAnotherPayListViewItem_TypeInfo);
    ...
    else
    {
      ...
      Master_object = (Il2CppObject *)sub_1C32BC4(v22 + 4, v17);
    }
    v23 = 1;
    if ( !anotherItemIds )
      goto LABEL_29;
  ...
  if ( (int)max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( ((unsigned __int8)Master_object & 1) != 0 )
      {
        ...
        v27 = v34;
        v28 = (EventRewardAnotherPayListViewItem_o *)sub_1C32E6C(EventRewardAnotherPayListViewItem_TypeInfo);
        ...
        else
        {
          ...
          Master_object = (Il2CppObject *)sub_1C32BC4(v33 + 4, v28);
        }
        ++v23;
      }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C321EE & 1) == 0 )
  {
    this = (EventRewardAnotherPayListViewManager_o *)sub_1C32C20(&Method_EventRewardAnotherPayListViewManager_OnClickListView__);
    byte_4C321EE = 1;
  }
  if ( !obj )
    goto LABEL_16;
...
LABEL_16:
  ...
  else
  {
    ...
    if ( (*((_BYTE *)Method_EventRewardAnotherPayListViewManager_OnClickListView__ + 83) & 2) != 0 )
      v8 = (_QWORD *)sub_1C32C38(Method_EventRewardAnotherPayListViewManager_OnClickListView__);
