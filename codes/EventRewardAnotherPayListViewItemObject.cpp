        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F3F9 & 1) == 0 )
  {
    sub_1BDB878(&Method_UnityEngine_GameObject_GetComponent_EventRewardAnotherPayListViewItemDraw___, method);
    byte_4B3F3F9 = 1;
  }
  ...
  this->fields.itemDraw = (struct EventRewardAnotherPayListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_object_(
                                                                              dispObject,
                                                                              (const MethodInfo_3088520 *)Method_UnityEngine_GameObject_GetComponent_EventRewardAnotherPayListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F3FB & 1) == 0 )
  {
    sub_1BDB878(&EventRewardAnotherPayListViewItem_TypeInfo, method);
    byte_4B3F3FB = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F3FA & 1) == 0 )
  {
    sub_1BDB878(&EventRewardAnotherPayListViewItem_TypeInfo, item);
    byte_4B3F3FA = 1;
  }
  itemDraw = this->fields.itemDraw;
  if ( !itemDraw )
LABEL_9:
    sub_1BDBAD4(itemDraw, item);
  if ( item )
  {
    methodPtr_low = LOBYTE(EventRewardAnotherPayListViewItem_TypeInfo->vtable._0_Equals.methodPtr);
    ...
    {
      itemDraw = (EventRewardAnotherPayListViewItemDraw_o *)sub_1BDBD94(item);
      goto LABEL_9;
    }
  }
