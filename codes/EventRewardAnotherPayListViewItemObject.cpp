        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B16E1A & 1) == 0 )
  {
    sub_1BCAFF8(&Method_UnityEngine_GameObject_GetComponent_EventRewardAnotherPayListViewItemDraw___, method);
    byte_4B16E1A = 1;
  }
  ...
  this->fields.itemDraw = (struct EventRewardAnotherPayListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_object_(
                                                                              dispObject,
                                                                              (const MethodInfo_306E710 *)Method_UnityEngine_GameObject_GetComponent_EventRewardAnotherPayListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B16E1C & 1) == 0 )
  {
    sub_1BCAFF8(&EventRewardAnotherPayListViewItem_TypeInfo, method);
    byte_4B16E1C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B16E1B & 1) == 0 )
  {
    sub_1BCAFF8(&EventRewardAnotherPayListViewItem_TypeInfo, item);
    byte_4B16E1B = 1;
  }
  itemDraw = this->fields.itemDraw;
  if ( !itemDraw )
LABEL_9:
    sub_1BCB254(itemDraw, item);
  if ( item )
  {
    methodPtr_low = LOBYTE(EventRewardAnotherPayListViewItem_TypeInfo->vtable._0_Equals.methodPtr);
    ...
    {
      itemDraw = (EventRewardAnotherPayListViewItemDraw_o *)sub_1BCB514(item);
      goto LABEL_9;
    }
  }
