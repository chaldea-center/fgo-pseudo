...
void SampleEventListViewManager__CreateList(SampleEventListViewManager_o *this, int32_t sum, const MethodInfo *method)
{
  ...
  if ( (byte_4CC4B97 & 1) == 0 )
  {
    ...
    sub_1C713B0(&SampleEventListViewItem_TypeInfo);
    byte_4CC4B97 = 1;
  }
  ...
  if ( sum >= 1 )
  {
    ...
    do
    {
      v6 = (SampleEventListViewItem_o *)sub_1C715FC(SampleEventListViewItem_TypeInfo);
      ...
      else
      {
        ...
        sub_1C71354((GrandQuestFolderBoardItem_o *)(v19 + 4), (int32_t)v6, v9, v10, v11, v12, v13, v14);
      }
      ++v5;
    }
    while ( sum != v5 );
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC4B9B & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_System_Collections_Generic_List_Enumerator_SampleEventListViewObject__Dispose__);
    sub_1C713B0(&Method_System_Collections_Generic_List_Enumerator_SampleEventListViewObject__MoveNext__);
    sub_1C713B0(&Method_System_Collections_Generic_List_Enumerator_SampleEventListViewObject__get_Current__);
    sub_1C713B0(&Method_System_Collections_Generic_List_SampleEventListViewObject__GetEnumerator__);
    sub_1C713B0(&Method_SampleEventListViewManager_OnMoveEnd__);
    byte_4CC4B9B = 1;
  }
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    ObjectList,
    (const MethodInfo_3811210 *)Method_System_Collections_Generic_List_SampleEventListViewObject__GetEnumerator__);
  while ( System_Collections_Generic_List_Enumerator_object___MoveNext(
            &v14,
            (const MethodInfo_35962C8 *)Method_System_Collections_Generic_List_Enumerator_SampleEventListViewObject__MoveNext__) )
  {
    ...
    if ( !current )
      sub_1C71608(v11, v12);
    SampleEventListViewObject__Init_37924604((SampleEventListViewObject_o *)current, mode, v10, delay, v13);
  }
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v14,
    (const MethodInfo_35962C4 *)Method_System_Collections_Generic_List_Enumerator_SampleEventListViewObject__Dispose__);
}


// local variable allocation has failed, the output may be wrong!
void SampleEventListViewManager__RequestListObject_37924704(
        SampleEventListViewManager_o *this,
        int32_t mode,
        const MethodInfo *method)
{
            ...
            (const MethodInfo_35962C8 *)Method_System_Collections_Generic_List_Enumerator_SampleEventListViewObject__MoveNext__) )
  {
    ...
    if ( !current )
      sub_1C71608(v9, v10);
    SampleEventListViewObject__Init_37925572((SampleEventListViewObject_o *)current, mode, v8, v11);
  }
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v12,
    (const MethodInfo_35962C4 *)Method_System_Collections_Generic_List_Enumerator_SampleEventListViewObject__Dispose__);
...
void SampleEventListViewManager__SetMode(SampleEventListViewManager_o *this, int32_t mode, const MethodInfo *method)
{
  ...
  SampleEventListViewManager__SetMode_37924088(this, mode, 0, v3);
}


void SampleEventListViewManager__SetMode_37924088(
        SampleEventListViewManager_o *this,
        int32_t mode,
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C713B0(&System_Action_TypeInfo);
    sub_1C713B0(&Method_System_Collections_Generic_List_SampleEventListViewObject__get_Count__);
    sub_1C713B0(&Method_System_Collections_Generic_List_SampleEventListViewObject__get_Item__);
    sub_1C713B0(&Method_SampleEventListViewManager_OnMoveEnd__);
    ...
    else if ( v16->fields._size >= 1 )
    {
      ...
      while ( 1 )
      {
        Item = System_Collections_Generic_List_object___get_Item(
                 v16,
                 v18,
                 (const MethodInfo_3810448 *)Method_System_Collections_Generic_List_SampleEventListViewObject__get_Item__);
        ...
        if ( !Item )
          break;
        SampleEventListViewObject__Init_37924604((SampleEventListViewObject_o *)Item, 4, v20, (float)++v18 * 0.1, v21);
...
LABEL_15:
  ...
  else if ( mode == 2 )
  {
    ...
    SampleEventListViewManager__RequestListObject_37924704(this, 5, v12);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC4B99 & 1) == 0 )
  {
    this = (SampleEventListViewManager_o *)sub_1C713B0(&SampleEventListViewObject_TypeInfo);
    byte_4CC4B99 = 1;
  }
  if ( !obj
  ...
  if ( v5->fields.initMode == 2 )
    ...
    v7 = 2;
  SampleEventListViewObject__Init_37924004((SampleEventListViewObject_o *)obj, v7, (const MethodInfo *)item);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC4B96 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_UnityEngine_GameObject_GetComponent_SampleEventListViewObject___);
    sub_1C713B0(&Method_System_Collections_Generic_List_SampleEventListViewObject__Add__);
    sub_1C713B0(&Method_System_Collections_Generic_List_GameObject__GetEnumerator__);
    sub_1C713B0(&Method_System_Collections_Generic_List_SampleEventListViewObject___ctor__);
    sub_1C713B0(&System_Collections_Generic_List_SampleEventListViewObject__TypeInfo);
    sub_1C713B0(&UnityEngine_Object_TypeInfo);
    byte_4CC4B96 = 1;
  }
  memset(&v28, 0, sizeof(v28));
  v3 = (System_Collections_Generic_List_object__o *)sub_1C715FC(System_Collections_Generic_List_SampleEventListViewObject__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v3,
    (const MethodInfo_380FEE4 *)Method_System_Collections_Generic_List_SampleEventListViewObject___ctor__);
            ...
            (const MethodInfo_35962C8 *)Method_System_Collections_Generic_List_Enumerator_GameObject__MoveNext__) )
  {
    ...
    if ( v7 )
    {
      ...
      Component_object = UnityEngine_GameObject__GetComponent_object_(
                           ...
                           (const MethodInfo_31A2ED0 *)Method_UnityEngine_GameObject_GetComponent_SampleEventListViewObject___);
