...
void __fastcall ServantSellConfirmListViewItem___ctor_29050380(
        ServantSellConfirmListViewItem_o *this,
        int32_t index,
...
LABEL_18:
    ...
    this->fields._IsMaterialTdSvt_k__BackingField = UserServantEntity__IsMaterialTd(v34, 0LL);
  }
  else
  {
    ...
    sub_B5D560((BattleServantConfConponent_o *)&this->fields.servantEntity, 0LL, v35, v36, v37, v38, v39, v40);
    if ( (BYTE3(CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
      && !CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo->_2.cctor_finished )
    {
      j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EAA8B & 1) == 0 )
  {
    ...
    sub_B5D5C4(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v16, v17, v18);
    this = (ServantSellConfirmListViewItem_o *)sub_B5D5C4(&UserServantLeaderEntity_TypeInfo, v19, v20, v21);
    byte_42EAA8B = 1;
  }
    ...
    *(_OWORD *)&v36.fields.fakeValue = v23;
    ...
    if ( !this
      || (IsKeepServantEquip = ServantEntity__get_IsKeepServantEquip((ServantEntity_o *)this, 0LL),
          (this = (ServantSellConfirmListViewItem_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2A2FE60 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0LL)
...
{
  __int64 v3; // x3
  ServantSellConfirmListViewItem_o *v5; // x19
  int v6; // w1
  int v7; // w2
  __int64 v8; // x3
  int v9; // w1
  ...
  if ( (byte_42EAA8C & 1) == 0 )
  {
    ...
    sub_B5D5C4(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, v9, v10, v11);
    this = (ServantSellConfirmListViewItem_o *)sub_B5D5C4(
  ...
  if ( type != 2 )
  {
    if ( type != 1 )
      return;
    this = (ServantSellConfirmListViewItem_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2A2FE60 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( this )
    {
      this = (ServantSellConfirmListViewItem_o *)DataManager__GetMasterData_WarQuestSelectionMaster_(
                                                   (DataManager_o *)this,
