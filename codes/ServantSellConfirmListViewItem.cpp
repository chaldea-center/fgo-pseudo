...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantSellConfirmListViewItem___ctor_33506292(
        ServantSellConfirmListViewItem_o *this,
        int32_t index,
        ...
        const MethodInfo *method)
{
  ...
  if ( userServantEntity )
  {
    ...
    *(_QWORD *)&v35.fields.fakeValue = v17;
    Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47299060(v35, 0LL);
    if ( !v19 )
      goto LABEL_16;
    Entity = DataMasterBase_object__object__int___GetEntity(
               v19,
...
LABEL_16:
  ...
  else
  {
    ...
    sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.servantEntity, 0LL, v29, v30, v31, v32, v33, v34);
    if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62F67 & 1) == 0 )
  {
    ...
    this = (ServantSellConfirmListViewItem_o *)sub_1BE4ACC(&UserServantLeaderEntity_TypeInfo, v11);
    byte_4B62F67 = 1;
  }
  if ( type == 1 )
  {
    ...
    *(_OWORD *)&v26.fields.fakeValue = v13;
    ...
    if ( !this
      || (IsKeepServantEquip = ServantEntity__get_IsKeepServantEquip((ServantEntity_o *)this, 0LL),
          (this = (ServantSellConfirmListViewItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0LL)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62F68 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, v6);
    this = (ServantSellConfirmListViewItem_o *)sub_1BE4ACC(
  ...
  if ( type != 2 )
  {
    if ( type != 1 )
      return;
    this = (ServantSellConfirmListViewItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( this )
    {
      this = (ServantSellConfirmListViewItem_o *)DataManager__GetMasterData_object_(
                                                   (DataManager_o *)this,
