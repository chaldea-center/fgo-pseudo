...
void ServantSellConfirmListViewItem___ctor_36115984(
        ServantSellConfirmListViewItem_o *this,
        int32_t index,
        ...
        const MethodInfo *method)
{
  ...
  if ( userServantEntity )
  {
    ...
    *(_QWORD *)&v32.fields.fakeValue = v14;
    Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_50038008(v32, 0);
    if ( !v16 )
      goto LABEL_16;
    Entity = DataMasterBase_object__object__int___GetEntity(
               v16,
...
LABEL_16:
  ...
  else
  {
    ...
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.servantEntity, 0, v26, v27, v28, v29, v30, v31);
    if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E00A72 & 1) == 0 )
  {
    ...
    this = (ServantSellConfirmListViewItem_o *)sub_1CE6700(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4E00A72 = 1;
  }
  if ( type == 1 )
  {
    ...
    *(_OWORD *)&v20.fields.fakeValue = v8;
    ...
    if ( !this
      || (IsKeepServantEquip = ServantEntity__get_IsKeepServantEquip((ServantEntity_o *)this, 0),
          (this = (ServantSellConfirmListViewItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0)
        ...
        const MethodInfo *method)
{
  ...
  if ( type != 2 )
  {
    if ( type != 1 )
      return;
    this = (ServantSellConfirmListViewItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( this )
    {
      this = (ServantSellConfirmListViewItem_o *)DataManager__GetMasterData_object_(
                                                   (DataManager_o *)this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E00A76 & 1) == 0 )
  {
    this = (ServantSellConfirmListViewItem_o *)sub_1CE6700(&CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
    byte_4E00A76 = 1;
  }
