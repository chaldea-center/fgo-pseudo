...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantSellConfirmListViewItem___ctor_33076348(
        ServantSellConfirmListViewItem_o *this,
        int32_t index,
...
LABEL_16:
  ...
  else
  {
    ...
    sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.servantEntity, 0, v21, v22);
    if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B719A & 1) == 0 )
  {
    ...
    this = (ServantSellConfirmListViewItem_o *)sub_1B4CF90(
    ...
    *(_OWORD *)&v25.fields.fakeValue = v13;
    ...
    if ( !this
      || (IsKeepServantEquip = ServantEntity__get_IsKeepServantEquip((ServantEntity_o *)this, 0LL),
          (this = (ServantSellConfirmListViewItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37B4410 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0LL)
        ...
        const MethodInfo *method)
{
  ...
  if ( type != 2 )
  {
    if ( type != 1 )
      return;
    this = (ServantSellConfirmListViewItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37B4410 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( this )
    {
      this = (ServantSellConfirmListViewItem_o *)DataManager__GetMasterData_object_(
                                                   (DataManager_o *)this,
