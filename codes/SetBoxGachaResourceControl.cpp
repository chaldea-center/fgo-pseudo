        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31E71 & 1) == 0 )
  {
    sub_1B761C0(&Method_SetBoxGachaResourceControl_ClickMultiGacha__, method);
    byte_4A31E71 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetBoxGachaResourceControl_ClickMultiGacha__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B761D8(Method_SetBoxGachaResourceControl_ClickMultiGacha__);
...
void __fastcall SetBoxGachaResourceControl__ClickOneGacha(SetBoxGachaResourceControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A31E70 & 1) == 0 )
  {
    sub_1B761C0(&Method_SetBoxGachaResourceControl_ClickOneGacha__, method);
    byte_4A31E70 = 1;
  }
  v3 = Method_SetBoxGachaResourceControl_ClickOneGacha__;
  if ( (*((_BYTE *)Method_SetBoxGachaResourceControl_ClickOneGacha__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B761D8(Method_SetBoxGachaResourceControl_ClickOneGacha__);
  v4 = (System_Reflection_MethodBase_o *)sub_1B761A4(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 8, 0LL);
  clickCallbackFunc = this->fields.clickCallbackFunc;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31E72 & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_441/*"#4C4C4C"*/, isReset);
    byte_4A31E72 = 1;
  }
  v8 = 0uLL;
  ...
  {
LABEL_18:
    sub_1B7641C(oneBoxGachaBtn, isReset);
  }
  ((void (__fastcall *)(UnityEngine_Behaviour_o *, bool, void *))oneBoxGachaBtn->klass[1]._1.namespaze)(
    oneBoxGachaBtn,
    isReset,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31E6F & 1) == 0 )
  {
    sub_1B761C0(&BoxGachaUtility_TypeInfo, *(_QWORD *)&canDrawNum);
    byte_4A31E6F = 1;
  }
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19C27D4;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19C278C;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31E73 & 1) == 0 )
  {
    sub_1B761C0(&int_TypeInfo, *(_QWORD *)&gachaTime);
    byte_4A31E73 = 1;
  }
  v9[1] = 0LL;
