        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0CB5A & 1) == 0 )
  {
    sub_1B686D4(&Method_SetBoxGachaResourceControl_ClickMultiGacha__, method);
    byte_4A0CB5A = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetBoxGachaResourceControl_ClickMultiGacha__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B686EC(Method_SetBoxGachaResourceControl_ClickMultiGacha__);
...
void __fastcall SetBoxGachaResourceControl__ClickOneGacha(SetBoxGachaResourceControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0CB59 & 1) == 0 )
  {
    sub_1B686D4(&Method_SetBoxGachaResourceControl_ClickOneGacha__, method);
    byte_4A0CB59 = 1;
  }
  v3 = Method_SetBoxGachaResourceControl_ClickOneGacha__;
  if ( (*((_BYTE *)Method_SetBoxGachaResourceControl_ClickOneGacha__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B686EC(Method_SetBoxGachaResourceControl_ClickOneGacha__);
  v4 = (System_Reflection_MethodBase_o *)sub_1B686B8(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 8, 0LL);
  clickCallbackFunc = this->fields.clickCallbackFunc;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0CB5B & 1) == 0 )
  {
    sub_1B686D4(&StringLiteral_441/*"#4C4C4C"*/, isReset);
    byte_4A0CB5B = 1;
  }
  v8 = 0uLL;
  ...
  {
LABEL_18:
    sub_1B68930(oneBoxGachaBtn, isReset);
  }
  ((void (__fastcall *)(UnityEngine_Behaviour_o *, bool, void *))oneBoxGachaBtn->klass[1]._1.namespaze)(
    oneBoxGachaBtn,
    isReset,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0CB58 & 1) == 0 )
  {
    sub_1B686D4(&BoxGachaUtility_TypeInfo, *(_QWORD *)&canDrawNum);
    byte_4A0CB58 = 1;
  }
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19B5724;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19B56DC;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0CB5C & 1) == 0 )
  {
    sub_1B686D4(&int_TypeInfo, *(_QWORD *)&gachaTime);
    byte_4A0CB5C = 1;
  }
  v9[1] = 0LL;
