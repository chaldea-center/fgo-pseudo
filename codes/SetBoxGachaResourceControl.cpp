        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CE8AA8 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_SetBoxGachaResourceControl_ExeGacha__);
    byte_4CE8AA8 = 1;
  }
  v7 = Method_SetBoxGachaResourceControl_ExeGacha__;
  if ( (*((_BYTE *)Method_SetBoxGachaResourceControl_ExeGacha__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1C7BB00(Method_SetBoxGachaResourceControl_ExeGacha__);
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_18:
    sub_1C7BD40(oneBoxGachaBtn, isReset);
  }
  ((void (__fastcall *)(UnityEngine_Behaviour_o *, bool, const char *))oneBoxGachaBtn->klass[1]._1.name)(
    oneBoxGachaBtn,
    isReset,
        ...
        const MethodInfo *method)
{
  ...
  sub_1C7BA8C(&this->fields.clickCallbackFunc, callback);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1AA88AC;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1AA8854;
}
