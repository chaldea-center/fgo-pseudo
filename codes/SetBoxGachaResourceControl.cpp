        ...
        const MethodInfo *method)
{
  ...
  unsigned __int128 v9; // [xsp+0h] [xbp-30h] BYREF

  if ( (byte_42EBA0C & 1) == 0 )
  {
    sub_B5D5C4(&StringLiteral_358/*"#4C4C4C"*/, isReset, (_DWORD)method, v3);
    byte_42EBA0C = 1;
  }
  v9 = 0uLL;
  ...
  oneBoxGachaBtn = (UnityEngine_Behaviour_o *)UnityEngine_ColorUtility__TryParseHtmlString(
                                                (System_String_o *)StringLiteral_358/*"#4C4C4C"*/,
  ...
  {
LABEL_18:
    sub_B5D69C(oneBoxGachaBtn, isReset);
  }
  ((void (__fastcall *)(UnityEngine_Behaviour_o *, bool, void *))oneBoxGachaBtn->klass[1]._1.namespaze)(
    oneBoxGachaBtn,
    isReset,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EBA09 & 1) == 0 )
  {
    sub_B5D5C4(&BoxGachaUtility_TypeInfo, canDrawNum, (_DWORD)callback, method);
    byte_42EBA09 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42E5DB5 & 1) == 0 )
  {
    sub_B5D5C4(&int_TypeInfo, gachaTime, (_DWORD)callback, object);
    byte_42E5DB5 = 1;
  }
  v9[1] = 0LL;
        ...
        const MethodInfo *method)
{
  ...
  _DWORD *v30; // x11
  SetBoxGachaResourceControl_ClickDelegate_o *v31; // [xsp+8h] [xbp-48h] BYREF
...
LABEL_5:
    ...
    while ( 1 )
    {
      ...
      if ( *(__int16 *)(v21 + 72) == -1 )
        sub_B5D680(*(_QWORD *)&v19->fields.extra_arg, *(_QWORD *)&gachaTime, method);
