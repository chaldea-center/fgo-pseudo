        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CED9CE & 1) == 0 )
  {
    sub_1C7BAE8(&ServantCollectionCharaGraphFilterLogic_TypeInfo);
    byte_4CED9CE = 1;
  }
  v2 = (Il2CppObject *)sub_1C7BD34(ServantCollectionCharaGraphFilterLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CED9CD & 1) == 0 )
  {
    sub_1C7BAE8(&ServantCollectionCharaGraphSortLogic_TypeInfo);
    byte_4CED9CD = 1;
  }
  v2 = (CharaGraphSortLogicBase_o *)sub_1C7BD34(ServantCollectionCharaGraphSortLogic_TypeInfo);
