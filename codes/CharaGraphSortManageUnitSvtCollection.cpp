        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1EED9 & 1) == 0 )
  {
    sub_1B715CC(&ServantCollectionCharaGraphFilterLogic_TypeInfo, method);
    byte_4A1EED9 = 1;
  }
  v2 = (CharaGraphFilterLogicBase_o *)sub_1B71818(ServantCollectionCharaGraphFilterLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1EED8 & 1) == 0 )
  {
    sub_1B715CC(&ServantCollectionCharaGraphSortLogic_TypeInfo, method);
    byte_4A1EED8 = 1;
  }
  v2 = (CharaGraphSortLogicBase_o *)sub_1B71818(ServantCollectionCharaGraphSortLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  if ( (byte_4A1EED7 & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_1509/*"5"*/, method);
    byte_4A1EED7 = 1;
  }
