        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E03D62 & 1) == 0 )
  {
    sub_1CE6700(&ServantCollectionCharaGraphFilterLogic_TypeInfo);
    byte_4E03D62 = 1;
  }
  v2 = (Il2CppObject *)sub_1CE694C(ServantCollectionCharaGraphFilterLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E03D61 & 1) == 0 )
  {
    sub_1CE6700(&ServantCollectionCharaGraphSortLogic_TypeInfo);
    byte_4E03D61 = 1;
  }
  v2 = (CharaGraphSortLogicBase_o *)sub_1CE694C(ServantCollectionCharaGraphSortLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  return (System_String_o *)StringLiteral_1416/*"5"*/;
}