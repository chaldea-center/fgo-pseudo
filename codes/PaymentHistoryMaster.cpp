void __fastcall PaymentHistoryMaster___ctor(PaymentHistoryMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4AB6169 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataMasterBase_PaymentHistoryMaster__PaymentHistoryEntity__string___ctor__, method);
    byte_4AB6169 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    498,
    (const MethodInfo_31640A8 *)Method_DataMasterBase_PaymentHistoryMaster__PaymentHistoryEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB616A & 1) == 0 )
  {
    sub_1BAB41C(&System_Comparison_PaymentHistoryEntity__TypeInfo, method);
    sub_1BAB41C(&System_Converter_DataEntityBase__PaymentHistoryEntity__TypeInfo, v3);
    sub_1BAB41C(&Method_System_Collections_Generic_List_PaymentHistoryEntity__Sort__, v4);
    sub_1BAB41C(&Method_ObservableCollectionExtensions_ConvertAll_DataEntityBase__PaymentHistoryEntity___, v5);
    sub_1BAB41C(&Method_PaymentHistoryMaster___c__GetEntityList_b__1_0__, v6);
    sub_1BAB41C(&Method_PaymentHistoryMaster___c__GetEntityList_b__1_1__, v7);
    sub_1BAB41C(&PaymentHistoryMaster___c_TypeInfo, v8);
    byte_4AB616A = 1;
  }
  ...
  if ( !_9__1_0 )
  {
    ...
    _9__1_0 = (System_Converter_TInput__TOutput__o *)sub_1BAB668(System_Converter_DataEntityBase__PaymentHistoryEntity__TypeInfo);
    ...
    sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&static_fields->__9__1_0, (int32_t)_9__1_0, v14, v15);
  }
  v16 = ObservableCollectionExtensions__ConvertAll_object__object_(
          list,
          (System_Converter_T__TOutput__o *)_9__1_0,
          (const MethodInfo_2F48E74 *)Method_ObservableCollectionExtensions_ConvertAll_DataEntityBase__PaymentHistoryEntity___);
  ...
  if ( !_9__1_1 )
  {
    ...
    _9__1_1 = (System_Comparison_T__o *)sub_1BAB668(System_Comparison_PaymentHistoryEntity__TypeInfo);
    ...
    sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&v22->__9__1_1, (int32_t)_9__1_1, v23, v24);
  }
  if ( !v19 )
    sub_1BAB678(v16, v17);
  System_Collections_Generic_List_object___Sort_55899008(
    v19,
    _9__1_1,
    (const MethodInfo_354F380 *)Method_System_Collections_Generic_List_PaymentHistoryEntity__Sort__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB616B & 1) == 0 )
  {
    sub_1BAB41C(&System_Collections_Generic_List_Enumerator_PaymentHistoryEntity__TypeInfo, method);
    sub_1BAB41C(&Method_System_Collections_Generic_List_PaymentHistoryEntity__GetEnumerator__, v3);
    byte_4AB616B = 1;
  }
...
void __fastcall PaymentHistoryMaster___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB616C & 1) == 0 )
  {
    sub_1BAB41C(&PaymentHistoryMaster___c_TypeInfo, v1);
    byte_4AB616C = 1;
  }
  v2 = (Il2CppObject *)sub_1BAB668(PaymentHistoryMaster___c_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB616D & 1) == 0 )
  {
    sub_1BAB41C(&PaymentHistoryEntity_TypeInfo, entity);
    byte_4AB616D = 1;
  }
  if ( !entity )
    return 0LL;
