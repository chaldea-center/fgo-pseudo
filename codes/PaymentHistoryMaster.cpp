void __fastcall PaymentHistoryMaster___ctor(PaymentHistoryMaster_o *this, const MethodInfo *method)
{
  if ( (byte_49FE90C & 1) == 0 )
  {
    sub_1B64870(&Method_DataMasterBase_PaymentHistoryMaster__PaymentHistoryEntity__string___ctor__, method);
    byte_49FE90C = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    498,
    (const MethodInfo_30D6498 *)Method_DataMasterBase_PaymentHistoryMaster__PaymentHistoryEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE90D & 1) == 0 )
  {
    sub_1B64870(&System_Comparison_PaymentHistoryEntity__TypeInfo, method);
    sub_1B64870(&System_Converter_DataEntityBase__PaymentHistoryEntity__TypeInfo, v3);
    sub_1B64870(&Method_System_Collections_Generic_List_PaymentHistoryEntity__Sort__, v4);
    sub_1B64870(&Method_ObservableCollectionExtensions_ConvertAll_DataEntityBase__PaymentHistoryEntity___, v5);
    sub_1B64870(&Method_PaymentHistoryMaster___c__GetEntityList_b__1_0__, v6);
    sub_1B64870(&Method_PaymentHistoryMaster___c__GetEntityList_b__1_1__, v7);
    sub_1B64870(&PaymentHistoryMaster___c_TypeInfo, v8);
    byte_49FE90D = 1;
  }
  ...
  if ( !_9__1_0 )
  {
    ...
    _9__1_0 = (System_Converter_TInput__TOutput__o *)sub_1B64ABC(System_Converter_DataEntityBase__PaymentHistoryEntity__TypeInfo);
    ...
    sub_1B64814((ServantStatusBattleListViewItem_o *)&static_fields->__9__1_0, (int32_t)_9__1_0, v14, v15);
  }
  v16 = ObservableCollectionExtensions__ConvertAll_object__object_(
          list,
          (System_Converter_T__TOutput__o *)_9__1_0,
          (const MethodInfo_2EBEA18 *)Method_ObservableCollectionExtensions_ConvertAll_DataEntityBase__PaymentHistoryEntity___);
  ...
  if ( !_9__1_1 )
  {
    ...
    _9__1_1 = (System_Comparison_T__o *)sub_1B64ABC(System_Comparison_PaymentHistoryEntity__TypeInfo);
    ...
    sub_1B64814((ServantStatusBattleListViewItem_o *)&v22->__9__1_1, (int32_t)_9__1_1, v23, v24);
  }
  if ( !v19 )
    sub_1B64ACC(v16, v17);
  System_Collections_Generic_List_object___Sort_55252244(
    v19,
    _9__1_1,
    (const MethodInfo_34B1514 *)Method_System_Collections_Generic_List_PaymentHistoryEntity__Sort__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE90E & 1) == 0 )
  {
    sub_1B64870(&System_Collections_Generic_List_Enumerator_PaymentHistoryEntity__TypeInfo, method);
    sub_1B64870(&Method_System_Collections_Generic_List_PaymentHistoryEntity__GetEnumerator__, v3);
    byte_49FE90E = 1;
  }
...
void __fastcall PaymentHistoryMaster___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FE90F & 1) == 0 )
  {
    sub_1B64870(&PaymentHistoryMaster___c_TypeInfo, v1);
    byte_49FE90F = 1;
  }
  v2 = (Il2CppObject *)sub_1B64ABC(PaymentHistoryMaster___c_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE910 & 1) == 0 )
  {
    sub_1B64870(&PaymentHistoryEntity_TypeInfo, entity);
    byte_49FE910 = 1;
  }
  if ( !entity )
    return 0LL;
