void PaymentHistoryMaster___ctor(PaymentHistoryMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4C27878 & 1) == 0 )
  {
    sub_1C2D490(&Method_DataMasterBase_PaymentHistoryMaster__PaymentHistoryEntity__string___ctor__);
    byte_4C27878 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    505,
    (const MethodInfo_338A52C *)Method_DataMasterBase_PaymentHistoryMaster__PaymentHistoryEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C27879 & 1) == 0 )
  {
    sub_1C2D490(&System_Comparison_PaymentHistoryEntity__TypeInfo);
    sub_1C2D490(&System_Converter_PaymentHistoryEntity__PaymentHistoryEntity__TypeInfo);
    sub_1C2D490(&Method_DataMasterBase_PaymentHistoryMaster__PaymentHistoryEntity__string__getEntityList__);
    sub_1C2D490(&Method_System_Collections_Generic_List_PaymentHistoryEntity__Sort__);
    sub_1C2D490(&Method_ObservableCollectionExtensions_ConvertAll_PaymentHistoryEntity__PaymentHistoryEntity___);
    sub_1C2D490(&Method_PaymentHistoryMaster___c__GetEntityList_b__1_0__);
    sub_1C2D490(&Method_PaymentHistoryMaster___c__GetEntityList_b__1_1__);
    sub_1C2D490(&PaymentHistoryMaster___c_TypeInfo);
    byte_4C27879 = 1;
  }
  ...
  if ( !_9__1_0 )
  {
    ...
    _9__1_0 = (System_Converter_TInput__TOutput__o *)sub_1C2D6DC(System_Converter_PaymentHistoryEntity__PaymentHistoryEntity__TypeInfo);
  ...
  v10 = ObservableCollectionExtensions__ConvertAll_object__object_(
          ...
          (const MethodInfo_315B754 *)Method_ObservableCollectionExtensions_ConvertAll_PaymentHistoryEntity__PaymentHistoryEntity___);
  ...
  if ( !_9__1_1 )
  {
    ...
    _9__1_1 = (System_Comparison_T__o *)sub_1C2D6DC(System_Comparison_PaymentHistoryEntity__TypeInfo);
  ...
  System_Collections_Generic_List_object___Sort_58242632(
    v13,
    _9__1_1,
    (const MethodInfo_378B648 *)Method_System_Collections_Generic_List_PaymentHistoryEntity__Sort__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2787A & 1) == 0 )
  {
    sub_1C2D490(&System_Collections_Generic_List_Enumerator_PaymentHistoryEntity__TypeInfo);
    sub_1C2D490(&Method_System_Collections_Generic_List_PaymentHistoryEntity__GetEnumerator__);
    byte_4C2787A = 1;
  }
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    &v10,
    EntityList,
    (const MethodInfo_378A67C *)Method_System_Collections_Generic_List_PaymentHistoryEntity__GetEnumerator__);
  v9 = v10;
...
void PaymentHistoryMaster___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C2D6DC(PaymentHistoryMaster___c_TypeInfo);
  System_Object___ctor(v1, 0);
  PaymentHistoryMaster___c_TypeInfo->static_fields->__9 = (struct PaymentHistoryMaster___c_o *)v1;
  sub_1C2D434((CGThumbnailListItem_o *)PaymentHistoryMaster___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
