void __fastcall PaymentHistoryMaster___ctor(PaymentHistoryMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A4E91C & 1) == 0 )
  {
    sub_1B863B8(&Method_DataMasterBase_PaymentHistoryMaster__PaymentHistoryEntity__string___ctor__, method);
    byte_4A4E91C = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    505,
    (const MethodInfo_3216A14 *)Method_DataMasterBase_PaymentHistoryMaster__PaymentHistoryEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4E91D & 1) == 0 )
  {
    sub_1B863B8(&System_Comparison_PaymentHistoryEntity__TypeInfo, method);
    sub_1B863B8(&System_Converter_PaymentHistoryEntity__PaymentHistoryEntity__TypeInfo, v3);
    sub_1B863B8(&Method_DataMasterBase_PaymentHistoryMaster__PaymentHistoryEntity__string__getEntityList__, v4);
    sub_1B863B8(&Method_System_Collections_Generic_List_PaymentHistoryEntity__Sort__, v5);
    sub_1B863B8(&Method_ObservableCollectionExtensions_ConvertAll_PaymentHistoryEntity__PaymentHistoryEntity___, v6);
    sub_1B863B8(&Method_PaymentHistoryMaster___c__GetEntityList_b__1_0__, v7);
    sub_1B863B8(&Method_PaymentHistoryMaster___c__GetEntityList_b__1_1__, v8);
    sub_1B863B8(&PaymentHistoryMaster___c_TypeInfo, v9);
    byte_4A4E91D = 1;
  }
  ...
  if ( !_9__1_0 )
  {
    ...
    _9__1_0 = (System_Converter_TInput__TOutput__o *)sub_1B86604(System_Converter_PaymentHistoryEntity__PaymentHistoryEntity__TypeInfo);
    ...
    sub_1B8635C((CGThumbnailListItem_o *)&static_fields->__9__1_0, (int32_t)_9__1_0, v15, v16);
  }
  v17 = ObservableCollectionExtensions__ConvertAll_object__object_(
          list,
          (System_Converter_T__TOutput__o *)_9__1_0,
          (const MethodInfo_2FF6860 *)Method_ObservableCollectionExtensions_ConvertAll_PaymentHistoryEntity__PaymentHistoryEntity___);
  ...
  if ( !_9__1_1 )
  {
    ...
    _9__1_1 = (System_Comparison_T__o *)sub_1B86604(System_Comparison_PaymentHistoryEntity__TypeInfo);
    ...
    sub_1B8635C((CGThumbnailListItem_o *)&v23->__9__1_1, (int32_t)_9__1_1, v24, v25);
  }
  if ( !v20 )
    sub_1B86614(v17, v18);
  System_Collections_Generic_List_object___Sort_56615964(
    v20,
    _9__1_1,
    (const MethodInfo_35FE41C *)Method_System_Collections_Generic_List_PaymentHistoryEntity__Sort__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4E91E & 1) == 0 )
  {
    sub_1B863B8(&System_Collections_Generic_List_Enumerator_PaymentHistoryEntity__TypeInfo, method);
    sub_1B863B8(&Method_System_Collections_Generic_List_PaymentHistoryEntity__GetEnumerator__, v3);
    byte_4A4E91E = 1;
  }
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    &v11,
    EntityList,
    (const MethodInfo_35FD450 *)Method_System_Collections_Generic_List_PaymentHistoryEntity__GetEnumerator__);
  v10 = v11;
...
void __fastcall PaymentHistoryMaster___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A4E91F & 1) == 0 )
  {
    sub_1B863B8(&PaymentHistoryMaster___c_TypeInfo, v1);
    byte_4A4E91F = 1;
  }
  v2 = (Il2CppObject *)sub_1B86604(PaymentHistoryMaster___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  PaymentHistoryMaster___c_TypeInfo->static_fields->__9 = (struct PaymentHistoryMaster___c_o *)v2;
  sub_1B8635C((CGThumbnailListItem_o *)PaymentHistoryMaster___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
