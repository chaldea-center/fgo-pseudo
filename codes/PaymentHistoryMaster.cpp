void __fastcall PaymentHistoryMaster___ctor(PaymentHistoryMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4BFDBA4 & 1) == 0 )
  {
    sub_1C2E12C(&Method_DataMasterBase_PaymentHistoryMaster__PaymentHistoryEntity__string___ctor__, method);
    byte_4BFDBA4 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    502,
    (const MethodInfo_327D914 *)Method_DataMasterBase_PaymentHistoryMaster__PaymentHistoryEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFDBA5 & 1) == 0 )
  {
    sub_1C2E12C(&System_Comparison_PaymentHistoryEntity__TypeInfo, method);
    sub_1C2E12C(&System_Converter_PaymentHistoryEntity__PaymentHistoryEntity__TypeInfo, v3);
    sub_1C2E12C(&Method_DataMasterBase_PaymentHistoryMaster__PaymentHistoryEntity__string__getEntityList__, v4);
    sub_1C2E12C(&Method_System_Collections_Generic_List_PaymentHistoryEntity__Sort__, v5);
    sub_1C2E12C(&Method_ObservableCollectionExtensions_ConvertAll_PaymentHistoryEntity__PaymentHistoryEntity___, v6);
    sub_1C2E12C(&Method_PaymentHistoryMaster___c__GetEntityList_b__1_0__, v7);
    sub_1C2E12C(&Method_PaymentHistoryMaster___c__GetEntityList_b__1_1__, v8);
    sub_1C2E12C(&PaymentHistoryMaster___c_TypeInfo, v9);
    byte_4BFDBA5 = 1;
  }
  ...
  if ( !_9__1_0 )
  {
    ...
    _9__1_0 = (System_Converter_TInput__TOutput__o *)sub_1C2E378(System_Converter_PaymentHistoryEntity__PaymentHistoryEntity__TypeInfo);
  ...
  v21 = ObservableCollectionExtensions__ConvertAll_object__object_(
          ...
          (const MethodInfo_3058930 *)Method_ObservableCollectionExtensions_ConvertAll_PaymentHistoryEntity__PaymentHistoryEntity___);
  ...
  if ( !_9__1_1 )
  {
    ...
    _9__1_1 = (System_Comparison_T__o *)sub_1C2E378(System_Comparison_PaymentHistoryEntity__TypeInfo);
  ...
  System_Collections_Generic_List_object___Sort_57070448(
    v24,
    _9__1_1,
    (const MethodInfo_366D370 *)Method_System_Collections_Generic_List_PaymentHistoryEntity__Sort__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFDBA6 & 1) == 0 )
  {
    sub_1C2E12C(&System_Collections_Generic_List_Enumerator_PaymentHistoryEntity__TypeInfo, method);
    sub_1C2E12C(&Method_System_Collections_Generic_List_PaymentHistoryEntity__GetEnumerator__, v3);
    byte_4BFDBA6 = 1;
  }
...
void __fastcall PaymentHistoryMaster___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BFDBA7 & 1) == 0 )
  {
    sub_1C2E12C(&PaymentHistoryMaster___c_TypeInfo, v1);
    byte_4BFDBA7 = 1;
  }
  v2 = (Il2CppObject *)sub_1C2E378(PaymentHistoryMaster___c_TypeInfo);
