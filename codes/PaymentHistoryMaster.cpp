void __fastcall PaymentHistoryMaster___ctor(PaymentHistoryMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A1FEDF & 1) == 0 )
  {
    sub_1B715CC(&Method_DataMasterBase_PaymentHistoryMaster__PaymentHistoryEntity__string___ctor__, method);
    byte_4A1FEDF = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    498,
    (const MethodInfo_30F8A78 *)Method_DataMasterBase_PaymentHistoryMaster__PaymentHistoryEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1FEE0 & 1) == 0 )
  {
    sub_1B715CC(&System_Comparison_PaymentHistoryEntity__TypeInfo, method);
    sub_1B715CC(&System_Converter_DataEntityBase__PaymentHistoryEntity__TypeInfo, v3);
    sub_1B715CC(&Method_System_Collections_Generic_List_PaymentHistoryEntity__Sort__, v4);
    sub_1B715CC(&Method_ObservableCollectionExtensions_ConvertAll_DataEntityBase__PaymentHistoryEntity___, v5);
    sub_1B715CC(&Method_PaymentHistoryMaster___c__GetEntityList_b__1_0__, v6);
    sub_1B715CC(&Method_PaymentHistoryMaster___c__GetEntityList_b__1_1__, v7);
    sub_1B715CC(&PaymentHistoryMaster___c_TypeInfo, v8);
    byte_4A1FEE0 = 1;
  }
  ...
  if ( !_9__1_0 )
  {
    ...
    _9__1_0 = (System_Converter_TInput__TOutput__o *)sub_1B71818(System_Converter_DataEntityBase__PaymentHistoryEntity__TypeInfo);
  ...
  v16 = ObservableCollectionExtensions__ConvertAll_object__object_(
          ...
          (const MethodInfo_2EDF20C *)Method_ObservableCollectionExtensions_ConvertAll_DataEntityBase__PaymentHistoryEntity___);
  ...
  if ( !_9__1_1 )
  {
    ...
    _9__1_1 = (System_Comparison_T__o *)sub_1B71818(System_Comparison_PaymentHistoryEntity__TypeInfo);
  ...
  System_Collections_Generic_List_object___Sort_55385380(
    v19,
    _9__1_1,
    (const MethodInfo_34D1D24 *)Method_System_Collections_Generic_List_PaymentHistoryEntity__Sort__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1FEE1 & 1) == 0 )
  {
    sub_1B715CC(&System_Collections_Generic_List_Enumerator_PaymentHistoryEntity__TypeInfo, method);
    sub_1B715CC(&Method_System_Collections_Generic_List_PaymentHistoryEntity__GetEnumerator__, v3);
    byte_4A1FEE1 = 1;
  }
...
void __fastcall PaymentHistoryMaster___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A1FEE2 & 1) == 0 )
  {
    sub_1B715CC(&PaymentHistoryMaster___c_TypeInfo, v1);
    byte_4A1FEE2 = 1;
  }
  v2 = (Il2CppObject *)sub_1B71818(PaymentHistoryMaster___c_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1FEE3 & 1) == 0 )
  {
    sub_1B715CC(&PaymentHistoryEntity_TypeInfo, entity);
    byte_4A1FEE3 = 1;
  }
  if ( !entity )
    return 0LL;
