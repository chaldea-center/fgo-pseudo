void __fastcall PaymentHistoryMaster___ctor(PaymentHistoryMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4B1CAA5 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataMasterBase_PaymentHistoryMaster__PaymentHistoryEntity__string___ctor__, method);
    byte_4B1CAA5 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    505,
    (const MethodInfo_32CA594 *)Method_DataMasterBase_PaymentHistoryMaster__PaymentHistoryEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1CAA6 & 1) == 0 )
  {
    sub_1BCAFF8(&System_Comparison_PaymentHistoryEntity__TypeInfo, method);
    sub_1BCAFF8(&System_Converter_PaymentHistoryEntity__PaymentHistoryEntity__TypeInfo, v3);
    sub_1BCAFF8(&Method_DataMasterBase_PaymentHistoryMaster__PaymentHistoryEntity__string__getEntityList__, v4);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_PaymentHistoryEntity__Sort__, v5);
    sub_1BCAFF8(&Method_ObservableCollectionExtensions_ConvertAll_PaymentHistoryEntity__PaymentHistoryEntity___, v6);
    sub_1BCAFF8(&Method_PaymentHistoryMaster___c__GetEntityList_b__1_0__, v7);
    sub_1BCAFF8(&Method_PaymentHistoryMaster___c__GetEntityList_b__1_1__, v8);
    sub_1BCAFF8(&PaymentHistoryMaster___c_TypeInfo, v9);
    byte_4B1CAA6 = 1;
  }
  ...
  if ( !_9__1_0 )
  {
    ...
    _9__1_0 = (System_Converter_TInput__TOutput__o *)sub_1BCB244(System_Converter_PaymentHistoryEntity__PaymentHistoryEntity__TypeInfo);
  ...
  v17 = ObservableCollectionExtensions__ConvertAll_object__object_(
          ...
          (const MethodInfo_30A4650 *)Method_ObservableCollectionExtensions_ConvertAll_PaymentHistoryEntity__PaymentHistoryEntity___);
  ...
  if ( !_9__1_1 )
  {
    ...
    _9__1_1 = (System_Comparison_T__o *)sub_1BCB244(System_Comparison_PaymentHistoryEntity__TypeInfo);
  ...
  System_Collections_Generic_List_object___Sort_57390740(
    v20,
    _9__1_1,
    (const MethodInfo_36BB694 *)Method_System_Collections_Generic_List_PaymentHistoryEntity__Sort__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1CAA7 & 1) == 0 )
  {
    sub_1BCAFF8(&System_Collections_Generic_List_Enumerator_PaymentHistoryEntity__TypeInfo, method);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_PaymentHistoryEntity__GetEnumerator__, v3);
    byte_4B1CAA7 = 1;
  }
...
void __fastcall PaymentHistoryMaster___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B1CAA8 & 1) == 0 )
  {
    sub_1BCAFF8(&PaymentHistoryMaster___c_TypeInfo, v1);
    byte_4B1CAA8 = 1;
  }
  v2 = (Il2CppObject *)sub_1BCB244(PaymentHistoryMaster___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  PaymentHistoryMaster___c_TypeInfo->static_fields->__9 = (struct PaymentHistoryMaster___c_o *)v2;
  sub_1BCAF9C((CGThumbnailListItem_o *)PaymentHistoryMaster___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
