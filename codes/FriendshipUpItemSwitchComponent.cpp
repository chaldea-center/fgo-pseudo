        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17E50 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_FriendshipUpItemSwitchComponent_ChangeButtonState__, openSelectDialog);
    ...
    if ( (int)itemInfoArray->max_length >= 2 )
    {
      ...
      if ( ((unsigned __int8)IsNullOrEmpty & 1) != 0 )
      {
        ...
        if ( (*((_BYTE *)Method_FriendshipUpItemSwitchComponent_ChangeButtonState__ + 83) & 2) != 0 )
          v12 = (_QWORD *)sub_1BCB010(Method_FriendshipUpItemSwitchComponent_ChangeButtonState__);
...
LABEL_30:
    ...
    if ( ((unsigned __int8)IsNullOrEmpty & 1) == 0 )
    {
      ...
      if ( (*((_BYTE *)Method_FriendshipUpItemSwitchComponent_ChangeButtonState__ + 83) & 2) != 0 )
        v17 = (_QWORD *)sub_1BCB010(Method_FriendshipUpItemSwitchComponent_ChangeButtonState__);
      ...
      if ( UseFlag )
      {
        ...
        IsNullOrEmpty = (PartyOrganizationUtility_o *)SingletonTemplate_object___get_Instance((const MethodInfo_38F8EF8 *)Method_SingletonTemplate_PartyOrganizationUtility__get_Instance__);
        if ( !IsNullOrEmpty )
          goto LABEL_30;
...
LABEL_14:
  ...
  if ( max_length >= 2 )
  {
    ...
    IsNullOrEmpty = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38F8AD8 *)Method_SingletonMonoBehaviour_SwitchParameterDisplayManager__get_Instance__);
    if ( !IsNullOrEmpty )
      goto LABEL_14;
        ...
        const MethodInfo *method)
{
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.itemInfoArray, (int32_t)CachedQuestUseItems, v7, v8);
  ...
  if ( (index & 0x80000000) == 0 )
  {
    ...
    if ( !UnityEngine_Object__op_Equality(friendshipUpItemUseItem, 0LL, 0LL) )
    {
      ...
      if ( itemInfoArray->max_length <= index )
        sub_1BCB25C(gameObject, v8, v9);
      v11 = this->fields.friendshipUpItemUseItem;
      v12 = itemInfoArray->m_Items[index];
      gameObject = SingletonTemplate_object___get_Instance((const MethodInfo_38F8EF8 *)Method_SingletonTemplate_PartyOrganizationUtility__get_Instance__);
      if ( !gameObject || !v11 )
LABEL_14:
