        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E72E21 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_FriendshipUpItemSwitchComponent_ChangeButtonState__);
    ...
    if ( SLODWORD(itemInfoArray->max_length) >= 2 )
    {
      ...
      if ( ((unsigned __int8)IsNullOrEmpty & 1) != 0 )
      {
        ...
        if ( (*((_BYTE *)Method_FriendshipUpItemSwitchComponent_ChangeButtonState__ + 83) & 2) != 0 )
          v9 = (_QWORD *)sub_1D0F0CC(Method_FriendshipUpItemSwitchComponent_ChangeButtonState__);
...
LABEL_30:
    ...
    if ( ((unsigned __int8)IsNullOrEmpty & 1) == 0 )
    {
      ...
      if ( (*((_BYTE *)Method_FriendshipUpItemSwitchComponent_ChangeButtonState__ + 83) & 2) != 0 )
        v14 = (_QWORD *)sub_1D0F0CC(Method_FriendshipUpItemSwitchComponent_ChangeButtonState__);
      ...
      if ( UseFlag )
      {
        ...
        IsNullOrEmpty = (PartyOrganizationUtility_o *)SingletonTemplate_object___get_Instance((const MethodInfo_3BACB74 *)Method_SingletonTemplate_PartyOrganizationUtility__get_Instance__);
        if ( !IsNullOrEmpty )
          goto LABEL_30;
...
LABEL_14:
  ...
  if ( max_length >= 2 )
  {
    ...
    IsNullOrEmpty = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3BAC684 *)Method_SingletonMonoBehaviour_SwitchParameterDisplayManager__get_Instance__);
    if ( !IsNullOrEmpty )
      goto LABEL_14;
        ...
        const MethodInfo *method)
{
  ...
  if ( (index & 0x80000000) == 0 )
  {
    ...
    if ( !UnityEngine_Object__op_Equality(friendshipUpItemUseItem, 0, 0) )
    {
      ...
      gameObject = SingletonTemplate_object___get_Instance((const MethodInfo_3BACB74 *)Method_SingletonTemplate_PartyOrganizationUtility__get_Instance__);
      if ( !gameObject || !v9 )
LABEL_14:
