void ClassCompatibilityInfoDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4DFE4A9 & 1) == 0 )
  {
    sub_1CE6700(&ClassCompatibilityInfoDialog_TypeInfo);
    byte_4DFE4A9 = 1;
  }
...
void ClassCompatibilityInfoDialog__Close(ClassCompatibilityInfoDialog_o *this, const MethodInfo *method)
{
  ...
  ClassCompatibilityInfoDialog__Close_31886068(this, 0, v2);
}


void ClassCompatibilityInfoDialog__Close_31886068(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFE4A3 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_ClassCompatibilityInfoDialog_EndClose__);
    byte_4DFE4A3 = 1;
  }
...
void ClassCompatibilityInfoDialog__OnClickClassBoard(ClassCompatibilityInfoDialog_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&System_Action_TypeInfo);
    sub_1CE6700(&Method_ClassCompatibilityInfoDialog_EndCloseClassBoardEffectListDialog__);
    sub_1CE6700(&Method_ClassCompatibilityInfoDialog_OnClickClassBoard__);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ClassCompatibilityInfoDialog_OnClickClassBoard__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_ClassCompatibilityInfoDialog_OnClickClassBoard__);
...
void ClassCompatibilityInfoDialog__OnClickClose(ClassCompatibilityInfoDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFE4A4 & 1) == 0 )
  {
    sub_1CE6700(&Method_ClassCompatibilityInfoDialog_OnClickClose__);
    byte_4DFE4A4 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ClassCompatibilityInfoDialog_OnClickClose__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1CE6718(Method_ClassCompatibilityInfoDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFE4A2 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_ClassCompatibilityInfoDialog_EndOpen__);
    sub_1CE6700(&ClassCompatibilityInfoDialog_TypeInfo);
    sub_1CE6700(&CondType_TypeInfo);
    sub_1CE6700(&LocalizationManager_TypeInfo);
    sub_1CE6700(&StringLiteral_3412/*"CLASS_BOARD_EFFECT_DISP_BUTTON"*/);
  ...
  if ( !this->fields.state )
  {
    ...
    if ( gameObject )
    {
      ...
      if ( closeLabel )
      {
        ...
        gameObject = (UnityEngine_GameObject_o *)CondType__IsQuestClear_41467300(ClassBoardReleaseQuestId, -1, 0, 0);
              ...
              if ( gameObject )
              {
                ...
                if ( gameObject )
                {
                  ...
                  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                             (System_String_o *)StringLiteral_3412/*"CLASS_BOARD_EFFECT_DISP_BUTTON"*/,
                                                             0);
                  if ( classBoardLabel )
                  {
        ...
        const MethodInfo *method)
{
  if ( (byte_4DFE4A7 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_7704/*"InfoDialog/CloseButton"*/);
    byte_4DFE4A7 = 1;
  }
  return (System_String_o *)StringLiteral_7704/*"InfoDialog/CloseButton"*/;
}