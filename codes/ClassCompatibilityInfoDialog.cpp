void ClassCompatibilityInfoDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CC1109 & 1) == 0 )
  {
    sub_1C713B0(&ClassCompatibilityInfoDialog_TypeInfo);
    byte_4CC1109 = 1;
  }
...
void ClassCompatibilityInfoDialog__Close(ClassCompatibilityInfoDialog_o *this, const MethodInfo *method)
{
  ...
  ClassCompatibilityInfoDialog__Close_31405928(this, 0, v2);
}


void ClassCompatibilityInfoDialog__Close_31405928(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC1103 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_ClassCompatibilityInfoDialog_EndClose__);
    byte_4CC1103 = 1;
  }
...
void ClassCompatibilityInfoDialog__OnClickClassBoard(ClassCompatibilityInfoDialog_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C713B0(&System_Action_TypeInfo);
    sub_1C713B0(&Method_ClassCompatibilityInfoDialog_EndCloseClassBoardEffectListDialog__);
    sub_1C713B0(&Method_ClassCompatibilityInfoDialog_OnClickClassBoard__);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ClassCompatibilityInfoDialog_OnClickClassBoard__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C713C8(Method_ClassCompatibilityInfoDialog_OnClickClassBoard__);
...
void ClassCompatibilityInfoDialog__OnClickClose(ClassCompatibilityInfoDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC1104 & 1) == 0 )
  {
    sub_1C713B0(&Method_ClassCompatibilityInfoDialog_OnClickClose__);
    byte_4CC1104 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ClassCompatibilityInfoDialog_OnClickClose__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1C713C8(Method_ClassCompatibilityInfoDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC1102 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_ClassCompatibilityInfoDialog_EndOpen__);
    sub_1C713B0(&ClassCompatibilityInfoDialog_TypeInfo);
    sub_1C713B0(&CondType_TypeInfo);
    sub_1C713B0(&LocalizationManager_TypeInfo);
    sub_1C713B0(&StringLiteral_3382/*"CLASS_BOARD_EFFECT_DISP_BUTTON"*/);
  ...
  if ( !this->fields.state )
  {
    ...
    if ( gameObject )
    {
      ...
      if ( closeLabel )
      {
        ...
        gameObject = (UnityEngine_GameObject_o *)CondType__IsQuestClear_40596552(ClassBoardReleaseQuestId, -1, 0, 0);
              ...
              if ( gameObject )
              {
                ...
                if ( gameObject )
                {
                  ...
                  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                             (System_String_o *)StringLiteral_3382/*"CLASS_BOARD_EFFECT_DISP_BUTTON"*/,
                                                             0);
                  if ( classBoardLabel )
                  {
        ...
        const MethodInfo *method)
{
  if ( (byte_4CC1107 & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_7645/*"InfoDialog/CloseButton"*/);
    byte_4CC1107 = 1;
  }
  return (System_String_o *)StringLiteral_7645/*"InfoDialog/CloseButton"*/;
}