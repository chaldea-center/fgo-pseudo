        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F64A & 1) == 0 )
  {
    sub_1B761C0(&EventInfoRiverProgressDrawComponent__PlayChangeNewRiverAnim_d__19_TypeInfo, endAction);
    byte_4A2F64A = 1;
  }
  v7 = isFadeIn;
  v8 = sub_1B7640C(EventInfoRiverProgressDrawComponent__PlayChangeNewRiverAnim_d__19_TypeInfo);
  System_Object___ctor((Il2CppObject *)v8, 0LL);
  *(_DWORD *)(v8 + 16) = 0;
  *(_QWORD *)(v8 + 32) = this;
  sub_1B76164((ServantStatusBattleListViewItem_o *)(v8 + 32), (int32_t)this, v9, v10);
  *(_QWORD *)(v8 + 40) = endAction;
  sub_1B76164((ServantStatusBattleListViewItem_o *)(v8 + 40), (int32_t)endAction, v11, v12);
  *(_BYTE *)(v8 + 48) = v7;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F64C & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_EventInfoRiverProgressDrawComponent___c__DisplayClass21_0__PlayFade_b__0__, v14);
    sub_1B761C0(&Method_EventInfoRiverProgressDrawComponent___c__DisplayClass21_0__PlayFade_b__1__, v15);
    sub_1B761C0(&EventInfoRiverProgressDrawComponent___c__DisplayClass21_0_TypeInfo, v16);
    byte_4A2F64C = 1;
  }
  v17 = sub_1B7640C(EventInfoRiverProgressDrawComponent___c__DisplayClass21_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F64B & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_EventInfoRiverProgressDrawComponent___c__DisplayClass20_0__PlayProgressClearAnim_b__0__, v9);
    sub_1B761C0(&EventInfoRiverProgressDrawComponent___c__DisplayClass20_0_TypeInfo, v10);
    sub_1B761C0(&StringLiteral_17304/*"bit_scenario_open"*/, v11);
    byte_4A2F64B = 1;
  }
  v12 = sub_1B7640C(EventInfoRiverProgressDrawComponent___c__DisplayClass20_0_TypeInfo);
  ...
  *(_QWORD *)(v12 + 24) = endAction;
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.scenarioOpenObject, (int32_t)v22, v24, v25);
  scenarioOpenObject = this->fields.scenarioOpenObject;
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  GameObjectExtensions__SafeSetParent_33557996(scenarioOpenObject, gameObject, 0LL);
...
LABEL_18:
  ...
  if ( !v30
    || (v30[2].monitor = v31,
        sub_1B76164((ServantStatusBattleListViewItem_o *)&v30[2].monitor, (int32_t)v31, v32, v33),
        !Component_object) )
  {
LABEL_22:
    sub_1B7641C(nextUIObject, v14);
  }
  SimpleAnimation__Play_63672732((SimpleAnimation_o *)Component_object, (System_String_o *)StringLiteral_17304/*"bit_scenario_open"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( !System_String__IsNullOrEmpty(this->fields.releaseScenarioSEName, 0LL) )
  {
    ...
    if ( !v5 )
      sub_1B76424(releaseScenarioSEName, v3);
    ...
    if ( !SoundManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(SoundManager_TypeInfo);
    v9 = SoundManager__playSe_38520200(v7, v8, 0LL);
    result = 0.0;
    if ( *((int *)v6 + 6) >= 3 )
    {
      v10 = v9;
...
LABEL_18:
        sub_1B7641C(releaseScenarioSEName, v3);
      }
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F649 & 1) == 0 )
  {
    sub_1B761C0(&System_Action_TypeInfo, inputProgressData);
    sub_1B761C0(&EventInfoPointRiverProgressControl_TypeInfo, v7);
    sub_1B761C0(&Method_EventInfoRiverProgressDrawComponent__Setup_b__18_0__, v8);
    sub_1B761C0(&Method_EventInfoRiverProgressDrawComponent__Setup_b__18_1__, v9);
    sub_1B761C0(&Method_UnityEngine_Object_Instantiate_GameObject___, v10);
    sub_1B761C0(&UnityEngine_Object_TypeInfo, v11);
    sub_1B761C0(&StringLiteral_19170/*"event_gauge_back_0"*/, v12);
    sub_1B761C0(&StringLiteral_19175/*"event_gauge_frame_0"*/, v13);
    byte_4A2F649 = 1;
  }
  ...
  v18 = System_String__Concat_61535060((System_String_o *)StringLiteral_19170/*"event_gauge_back_0"*/, v17, 0LL);
  this->fields.gaugeBackFileName = v18;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.gaugeBackFileName, (int32_t)v18, v19, v20);
  v21 = this->fields.progressData;
  if ( !v21 )
    goto LABEL_17;
  v42 = v21->fields.ReleaseScenarioIndex + 1;
  v22 = System_Int32__ToString((int32_t)&v42, 0LL);
  v23 = System_String__Concat_61535060((System_String_o *)StringLiteral_19175/*"event_gauge_frame_0"*/, v22, 0LL);
  this->fields.gaugeFrameFileName = v23;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.gaugeFrameFileName, (int32_t)v23, v24, v25);
  ...
  if ( v32->fields.IsReleaseScenarioAnimEnd )
  {
    ...
    if ( ReleaseScenarioIndex < v34->static_fields->MAX_SCENARIO_RIVER_INDEX )
    {
      ...
      if ( nextUIObject )
      {
        ...
        sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.scenarioOpenObject, (int32_t)v36, v37, v38);
        scenarioOpenObject = this->fields.scenarioOpenObject;
        gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
        GameObjectExtensions__SafeSetParent_33557996(scenarioOpenObject, gameObject, 0LL);
        nextUIObject = this->fields.nextUIObject;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F64E & 1) == 0 )
  {
    sub_1B761C0(&Method_UnityEngine_Component_GetComponent_EventInfoUISlideAnimation___, method);
    sub_1B761C0(&Method_UnityEngine_GameObject_GetComponent_SimpleAnimation___, v5);
    sub_1B761C0(&UnityEngine_Object_TypeInfo, v6);
    sub_1B761C0(&StringLiteral_22942/*"river_fade_in"*/, v7);
    sub_1B761C0(&StringLiteral_22943/*"river_fade_out"*/, v8);
    this = (EventInfoRiverProgressDrawComponent__PlayChangeNewRiverAnim_d__19_o *)sub_1B761C0(&StringLiteral_22842/*"release_scenario_out"*/, v9);
    byte_4A2F64E = 1;
  }
  ...
  if ( _1__state == 1 )
  {
    ...
    if ( !this )
      goto LABEL_37;
    SimpleAnimation__Play_63672732((SimpleAnimation_o *)this, v4->fields._animName_5__2, 0LL);
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.endAction, (int32_t)endAction, (int32_t)v2, v3);
  if ( v4->fields.isFadeIn )
    v15 = (struct System_String_o **)&StringLiteral_22942/*"river_fade_in"*/;
  else
    v15 = (struct System_String_o **)&StringLiteral_22943/*"river_fade_out"*/;
  v16 = *v15;
  v4->fields._animName_5__2 = *v15;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&v4->fields._animName_5__2, (int32_t)v16, v13, v14);
  Component_object = (EventInfoUISlideAnimation_o *)UnityEngine_Component__GetComponent_object_(
                                                      (UnityEngine_Component_o *)_4__this,
                                                      (const MethodInfo_2E58EAC *)Method_UnityEngine_Component_GetComponent_EventInfoUISlideAnimation___);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)Component_object, 0LL, 0LL) )
  {
    ...
    if ( isFadeIn )
    {
      ...
      if ( !Component_object )
        goto LABEL_37;
      GameObjectExtensions__SetLocalPosition_33552152(
    ...
    v36.fields.y = y;
    v36.fields.z = z;
    EventInfoUISlideAnimation__StartSlideAnim_42056252(Component_object, 0LL, v36, isFadeIn, 0LL);
  }
  if ( !v4->fields.isFadeIn )
  {
    ...
    if ( ((unsigned __int8)this & 1) != 0 )
    {
      if ( v32 )
      {
        SimpleAnimation__Play_63672732((SimpleAnimation_o *)v32, (System_String_o *)StringLiteral_22842/*"release_scenario_out"*/, 0LL);
        goto LABEL_36;
      }
LABEL_37:
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B761D4(&Method_EventInfoRiverProgressDrawComponent__PlayChangeNewRiverAnim_d__19_System_Collections_IEnumerator_Reset__);
  sub_1B762E8(v3, v4);
}
