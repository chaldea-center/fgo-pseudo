...
{
  *(_OWORD *)&this->fields.detailMinHeight = xmmword_BAA8C0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22EB5 & 1) == 0 )
  {
    sub_1B715CC(&ClassBoardUtility_TypeInfo, name);
    byte_4A22EB5 = 1;
  }
...
LABEL_16:
    sub_1B71828(effectNameLabel, name);
  }
  return v16 + (float)this->fields.adjustSetPosY;
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B71828(effectDetailLabel, detail);
  }
