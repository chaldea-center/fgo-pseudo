...
{
  *(_OWORD *)&this->fields.detailMinHeight = xmmword_BB7280;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A7329E & 1) == 0 )
  {
    sub_1B90010(&ClassBoardUtility_TypeInfo, name);
    byte_4A7329E = 1;
  }
...
LABEL_16:
    sub_1B9026C(effectNameLabel, name);
  }
  return v16 + (float)this->fields.adjustSetPosY;
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B9026C(effectDetailLabel, detail);
  }
