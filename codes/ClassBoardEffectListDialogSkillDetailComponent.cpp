        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.listComponent, (int32_t)listComponent, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B482B3 & 1) == 0 )
  {
    sub_1BDB878(&ClassBoardUtility_TypeInfo, name);
    byte_4B482B3 = 1;
  }
...
LABEL_16:
    sub_1BDBAD4(effectNameLabel, name);
  }
  return v16 + (float)this->fields.adjustSetPosY;
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BDBAD4(effectDetailLabel, detail);
  }
