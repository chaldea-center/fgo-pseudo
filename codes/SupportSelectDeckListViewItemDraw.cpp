        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B41124 & 1) == 0 )
  {
    ...
    sub_1BDB878(&SupportSelectDeckListViewItemDraw_ClassInfo___TypeInfo, v3);
    byte_4B41124 = 1;
  }
  ...
  v5 = (struct SupportSelectDeckListViewItemDraw_ClassInfo_array *)sub_1BDB920(
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.memberObjectList, (int32_t)v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B41123 & 1) == 0 )
  {
    ...
    sub_1BDB878(&SupportSelectListViewObject_TypeInfo, v16);
    sub_1BDB878(&StringLiteral_12487/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_NOT_SELECT"*/, v17);
    sub_1BDB878(&StringLiteral_12500/*"SUPPORT_SELECT_CONFIRM_DECK_SUPPORT_NUM"*/, v18);
    sub_1BDB878(&StringLiteral_12519/*"SUPPORT_SELECT_NAME"*/, v19);
    sub_1BDB878(&StringLiteral_12488/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_SAME_KIND"*/, v20);
    byte_4B41123 = 1;
  }
  entity = 0LL;
  if ( data )
  {
    ...
    v24 = LocalizationManager__Get((System_String_o *)StringLiteral_12500/*"SUPPORT_SELECT_CONFIRM_DECK_SUPPORT_NUM"*/, 0LL);
    ...
    v29 = LocalizationManager__Get((System_String_o *)StringLiteral_12519/*"SUPPORT_SELECT_NAME"*/, 0LL);
    ...
    while ( 1 )
    {
      ...
      v42 = (System_Int64_array *)sub_1BDB920(long___TypeInfo, 1LL);
...
LABEL_84:
      ...
      else
      {
        ...
        if ( (Instance & 1) != 0 )
        {
          ...
          *(_OWORD *)&v64.fields.fakeValue = v53;
          ...
          v63 = v64;
          Instance = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_48231240(&v63, 0LL);
    ...
    if ( v61 )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v60 = &StringLiteral_12488/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_SAME_KIND"*/;
    }
    else
    {
      if ( v62 )
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v60 = &StringLiteral_12487/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_NOT_SELECT"*/;
    }
