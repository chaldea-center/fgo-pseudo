void SupportSelectDeckListViewItemDraw___ctor(SupportSelectDeckListViewItemDraw_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E00F13 & 1) == 0 )
  {
    ...
    sub_1CE6700(&SupportSelectDeckListViewItemDraw_ClassInfo___TypeInfo);
    byte_4E00F13 = 1;
  }
  ...
  v4 = (struct SupportSelectDeckListViewItemDraw_ClassInfo_array *)sub_1CE67A8(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E00F12 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_12654/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_NOT_SELECT"*/);
    sub_1CE6700(&StringLiteral_12667/*"SUPPORT_SELECT_CONFIRM_DECK_SUPPORT_NUM"*/);
    sub_1CE6700(&StringLiteral_12686/*"SUPPORT_SELECT_NAME"*/);
    sub_1CE6700(&StringLiteral_12655/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_SAME_KIND"*/);
    byte_4E00F12 = 1;
  }
  entity = 0;
  if ( data )
  {
    ...
    v12 = LocalizationManager__Get((System_String_o *)StringLiteral_12667/*"SUPPORT_SELECT_CONFIRM_DECK_SUPPORT_NUM"*/, 0);
    ...
    v17 = LocalizationManager__Get((System_String_o *)StringLiteral_12686/*"SUPPORT_SELECT_NAME"*/, 0);
    ...
    while ( 1 )
    {
      ...
      v29 = sub_1CE67A8(long___TypeInfo, 1);
...
LABEL_84:
      ...
      else
      {
        ...
        if ( (Instance & 1) != 0 )
        {
          ...
          *(_OWORD *)&v53.fields.fakeValue = v41;
          ...
          v52 = v53;
          Instance = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_50041532(&v52, 0);
    ...
    if ( v50 )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v49 = &StringLiteral_12655/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_SAME_KIND"*/;
    }
    else
    {
      if ( v51 )
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v49 = &StringLiteral_12654/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_NOT_SELECT"*/;
    }
