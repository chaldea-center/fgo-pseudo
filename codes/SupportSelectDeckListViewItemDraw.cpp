        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC4323 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&SupportSelectDeckListViewItemDraw_ClassInfo___TypeInfo, v3);
    byte_4BC4323 = 1;
  }
  ...
  v5 = (struct SupportSelectDeckListViewItemDraw_ClassInfo_array *)sub_1C1AC7C(
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.memberObjectList, (int64_t)v5, v6, v7, v8, v9, v10, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC4322 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&SupportSelectListViewObject_TypeInfo, v16);
    sub_1C1ABD4(&StringLiteral_12655/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_NOT_SELECT"*/, v17);
    sub_1C1ABD4(&StringLiteral_12668/*"SUPPORT_SELECT_CONFIRM_DECK_SUPPORT_NUM"*/, v18);
    sub_1C1ABD4(&StringLiteral_12687/*"SUPPORT_SELECT_NAME"*/, v19);
    sub_1C1ABD4(&StringLiteral_12656/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_SAME_KIND"*/, v20);
    byte_4BC4322 = 1;
  }
  entity = 0LL;
  if ( data )
  {
    ...
    v24 = LocalizationManager__Get((System_String_o *)StringLiteral_12668/*"SUPPORT_SELECT_CONFIRM_DECK_SUPPORT_NUM"*/, 0LL);
    ...
    v29 = LocalizationManager__Get((System_String_o *)StringLiteral_12687/*"SUPPORT_SELECT_NAME"*/, 0LL);
    ...
    while ( 1 )
    {
      ...
      v41 = (System_Int64_array *)sub_1C1AC7C(long___TypeInfo, 1LL);
...
LABEL_84:
    ...
    if ( v62 )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v61 = &StringLiteral_12656/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_SAME_KIND"*/;
    }
    else
    {
      if ( v63 )
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v61 = &StringLiteral_12655/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_NOT_SELECT"*/;
    }
