        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57ADB & 1) == 0 )
  {
    ...
    sub_1B885B0(&SupportSelectDeckListViewItemDraw_ClassInfo___TypeInfo);
    byte_4A57ADB = 1;
  }
  ...
  v4 = (struct SupportSelectDeckListViewItemDraw_ClassInfo_array *)sub_1B88658(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57ADA & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_12421/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_NOT_SELECT"*/);
    sub_1B885B0(&StringLiteral_12434/*"SUPPORT_SELECT_CONFIRM_DECK_SUPPORT_NUM"*/);
    sub_1B885B0(&StringLiteral_12453/*"SUPPORT_SELECT_NAME"*/);
    sub_1B885B0(&StringLiteral_12422/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_SAME_KIND"*/);
    byte_4A57ADA = 1;
  }
  entity = 0LL;
  if ( data )
  {
    ...
    v12 = LocalizationManager__Get((System_String_o *)StringLiteral_12434/*"SUPPORT_SELECT_CONFIRM_DECK_SUPPORT_NUM"*/, 0LL);
    ...
    v17 = LocalizationManager__Get((System_String_o *)StringLiteral_12453/*"SUPPORT_SELECT_NAME"*/, 0LL);
    ...
    while ( 1 )
    {
      ...
      v29 = (System_Int64_array *)sub_1B88658(long___TypeInfo, 1LL);
...
LABEL_84:
      ...
      else
      {
        ...
        if ( (Instance & 1) != 0 )
        {
          ...
          *(_OWORD *)&v53.fields.fakeValue = v41;
          ...
          v52 = v53;
          Instance = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_46453324(&v52, 0LL);
    ...
    if ( v50 )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v49 = &StringLiteral_12422/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_SAME_KIND"*/;
    }
    else
    {
      if ( v51 )
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v49 = &StringLiteral_12421/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_NOT_SELECT"*/;
    }
