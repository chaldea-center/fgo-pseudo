        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E79E & 1) == 0 )
  {
    ...
    sub_1C3B764(&SupportSelectDeckListViewItemDraw_ClassInfo___TypeInfo, v3);
    byte_4C1E79E = 1;
  }
  ...
  v5 = (struct SupportSelectDeckListViewItemDraw_ClassInfo_array *)sub_1C3B80C(
  ...
  sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.memberObjectList, (int64_t)v5, v6, v7, v8, v9, v10, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E79D & 1) == 0 )
  {
    ...
    sub_1C3B764(&SupportSelectListViewObject_TypeInfo, v16);
    sub_1C3B764(&StringLiteral_12702/*"Stale NFS file handle"*/, v17);
    sub_1C3B764(&StringLiteral_12715/*"StartAttribute"*/, v18);
    sub_1C3B764(&StringLiteral_12734/*"Start_nf"*/, v19);
    sub_1C3B764(&StringLiteral_12703/*"StandAlone is 'yes' and the value of the attribute '{0}' contains a definition in an external document that changes on normalization."*/, v20);
    byte_4C1E79D = 1;
  }
  entity = 0LL;
  if ( data )
  {
    ...
    v24 = LocalizationManager__Get((System_String_o *)StringLiteral_12715/*"StartAttribute"*/, 0LL);
    ...
    v29 = LocalizationManager__Get((System_String_o *)StringLiteral_12734/*"Start_nf"*/, 0LL);
    ...
    while ( 1 )
    {
      ...
      v41 = (System_Int64_array *)sub_1C3B80C(long___TypeInfo, 1LL);
...
LABEL_84:
    ...
    if ( v62 )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v61 = &StringLiteral_12703/*"StandAlone is 'yes' and the value of the attribute '{0}' contains a definition in an external document that changes on normalization."*/;
    }
    else
    {
      if ( v63 )
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v61 = &StringLiteral_12702/*"Stale NFS file handle"*/;
    }
