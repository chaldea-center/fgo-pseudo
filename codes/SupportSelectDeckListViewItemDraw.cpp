        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FAEF9 & 1) == 0 )
  {
    ...
    sub_1B64870(&SupportSelectDeckListViewItemDraw_ClassInfo___TypeInfo, v3);
    byte_49FAEF9 = 1;
  }
  ...
  v5 = (struct SupportSelectDeckListViewItemDraw_ClassInfo_array *)sub_1B64918(
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.memberObjectList, (int32_t)v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FAEF8 & 1) == 0 )
  {
    ...
    sub_1B64870(&SupportSelectListViewObject_TypeInfo, v16);
    sub_1B64870(&StringLiteral_12369/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_NOT_SELECT"*/, v17);
    sub_1B64870(&StringLiteral_12382/*"SUPPORT_SELECT_CONFIRM_DECK_SUPPORT_NUM"*/, v18);
    sub_1B64870(&StringLiteral_12401/*"SUPPORT_SELECT_NAME"*/, v19);
    sub_1B64870(&StringLiteral_12370/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_SAME_KIND"*/, v20);
    byte_49FAEF8 = 1;
  }
  entity = 0LL;
  if ( data )
  {
    ...
    v24 = LocalizationManager__Get((System_String_o *)StringLiteral_12382/*"SUPPORT_SELECT_CONFIRM_DECK_SUPPORT_NUM"*/, 0LL);
    ...
    v29 = LocalizationManager__Get((System_String_o *)StringLiteral_12401/*"SUPPORT_SELECT_NAME"*/, 0LL);
    ...
    while ( 1 )
    {
      ...
      v41 = (System_Int64_array *)sub_1B64918(long___TypeInfo, 1LL);
...
LABEL_84:
      ...
      else
      {
        ...
        if ( (Instance & 1) != 0 )
        {
          ...
          *(_OWORD *)&v65.fields.fakeValue = v53;
          ...
          v64 = v65;
          Instance = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_46184056(&v64, 0LL);
    ...
    if ( v62 )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v61 = &StringLiteral_12370/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_SAME_KIND"*/;
    }
    else
    {
      if ( v63 )
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v61 = &StringLiteral_12369/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_NOT_SELECT"*/;
    }
