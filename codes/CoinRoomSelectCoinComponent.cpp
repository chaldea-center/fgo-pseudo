...
void __fastcall CoinRoomSelectCoinComponent__EndOpen(CoinRoomSelectCoinComponent_o *this, const MethodInfo *method)
{
  ...
  CoinRoomCoinListViewManager__SetMode_44210168(coinListViewManager, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01A02 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_CoinRoomSelectCoinComponent___c__DisplayClass14_0__EndRequest_b__0__, v7);
    sub_1B64870(&CoinRoomSelectCoinComponent___c__DisplayClass14_0_TypeInfo, v8);
    sub_1B64870(&StringLiteral_21971/*"ng"*/, v9);
    byte_4A01A02 = 1;
  }
  v10 = sub_1B64ABC(CoinRoomSelectCoinComponent___c__DisplayClass14_0_TypeInfo);
  ...
  *(_QWORD *)(v10 + 24) = selectedCoinDic;
  sub_1B64814((ServantStatusBattleListViewItem_o *)(v10 + 24), (int32_t)selectedCoinDic, v15, v16);
...
void __fastcall CoinRoomSelectCoinComponent__Init(CoinRoomSelectCoinComponent_o *this, const MethodInfo *method)
{
  ...
  this->fields.state = 0;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.beforeUserCoinRoomEntity, 0, v2, v3);
  ...
  if ( !coinListViewManager
    ...
    || (coinListViewManager = (CoinRoomCoinListViewManager_o *)UnityEngine_Component__get_gameObject(
                                                                 ...
                                                                 0LL)) == 0LL )
  {
    sub_1B64ACC(coinListViewManager, v6);
  }
        ...
        const MethodInfo *method)
{
  ...
  _BOOL8 CanStrength_44197372; // x0
  __int64 v27; // x1
  ...
  if ( (byte_4A01A00 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_CoinRoomSelectCoinComponent_OnClickDecide__, v3);
    sub_1B64870(&Method_CoinRoomSelectCoinComponent_RequestCoinRoomPut__, v4);
    sub_1B64870(&Method_CoinRoomSelectCoinComponent__OnClickDecide_b__12_0__, v5);
    sub_1B64870(&Method_System_Collections_Generic_Dictionary_int__SelectedUserSvtCoin__Add__, v6);
    sub_1B64870(&Method_System_Collections_Generic_Dictionary_int__SelectedUserSvtCoin__GetEnumerator__, v7);
    sub_1B64870(&Method_System_Collections_Generic_Dictionary_int__SelectedUserSvtCoin___ctor__, v8);
    sub_1B64870(&System_Collections_Generic_Dictionary_int__SelectedUserSvtCoin__TypeInfo, v9);
    sub_1B64870(&Method_System_Linq_Enumerable_Any_KeyValuePair_int__SelectedUserSvtCoin____, v10);
    sub_1B64870(&Method_System_Collections_Generic_Dictionary_Enumerator_int__SelectedUserSvtCoin__Dispose__, v11);
    sub_1B64870(&Method_System_Collections_Generic_Dictionary_Enumerator_int__SelectedUserSvtCoin__MoveNext__, v12);
    sub_1B64870(&Method_System_Collections_Generic_Dictionary_Enumerator_int__SelectedUserSvtCoin__get_Current__, v13);
    sub_1B64870(&Method_System_Collections_Generic_KeyValuePair_int__SelectedUserSvtCoin__get_Key__, v14);
    sub_1B64870(&Method_System_Collections_Generic_KeyValuePair_int__SelectedUserSvtCoin__get_Value__, v15);
    byte_4A01A00 = 1;
  }
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CoinRoomSelectCoinComponent_OnClickDecide__ + 83) & 2) != 0 )
      v16 = (_QWORD *)sub_1B64888(Method_CoinRoomSelectCoinComponent_OnClickDecide__);
    ...
    v22 = (System_Collections_Generic_Dictionary_int__object__o *)sub_1B64ABC(System_Collections_Generic_Dictionary_int__SelectedUserSvtCoin__TypeInfo);
              ...
              (const MethodInfo_326BF50 *)Method_System_Collections_Generic_Dictionary_Enumerator_int__SelectedUserSvtCoin__MoveNext__) )
    {
      ...
      CanStrength_44197372 = CoinRoomCoinIconItem__IsCanStrength_44197372(
                               (int32_t)v37.fields._current.fields.key,
                               1,
                               v23);
      if ( CanStrength_44197372 )
      {
        if ( !v22 )
          sub_1B64ACC(CanStrength_44197372, v27);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B64870(&System_Action_TypeInfo, method);
    sub_1B64870(&Method_CoinRoomSelectCoinComponent_EndOpen__, v3);
    sub_1B64870(&LocalizationManager_TypeInfo, v4);
    sub_1B64870(&StringLiteral_3614/*"COIN_ROOM_SELECT_LIST_SUB_TITLE"*/, v5);
    byte_4A019FF = 1;
  }
  ...
  if ( !coinListPanel )
    goto LABEL_13;
  CoinRoomCoinListViewManager__SetMode_44210168((CoinRoomCoinListViewManager_o *)coinListPanel, 1, v8);
  subTitle = this->fields.subTitle;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  coinListPanel = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3614/*"COIN_ROOM_SELECT_LIST_SUB_TITLE"*/, 0LL);
  if ( !subTitle )
LABEL_13:
    sub_1B64ACC(coinListPanel, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01A01 & 1) == 0 )
  {
    sub_1B64870(&Method_CoinRoomSelectCoinComponent_EndRequest__, method);
    sub_1B64870(&CoinRoomUtility_TypeInfo, v3);
    sub_1B64870(&Method_NetworkManager_getRequest_CoinRoomRequest___, v4);
  ...
  if ( !confirmDialog )
    goto LABEL_11;
  CoinConfirmDialog__Close_44191264(confirmDialog, 0LL, v12);
  coinListViewManager = this->fields.coinListViewManager;
  if ( !coinListViewManager )
    goto LABEL_11;
  selectedCoinDic = coinListViewManager->fields.selectedCoinDic;
  ...
  confirmDialog = (CoinConfirmDialog_o *)NetworkManager__getRequest_object_(
                                           v16,
                                           (const MethodInfo_2EBCCAC *)Method_NetworkManager_getRequest_CoinRoomRequest___);
  if ( !confirmDialog )
LABEL_11:
    sub_1B64ACC(confirmDialog, v11);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B64870(&System_Action_TypeInfo, method);
    this = (CoinRoomSelectCoinComponent_o *)sub_1B64870(&Method_CoinRoomSelectCoinComponent_RequestCoinRoomPut__, v3);
    byte_4A01A04 = 1;
  }
  klass = v2[6].klass;
  if ( !klass
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01A05 & 1) == 0 )
  {
    ...
    this = (CoinRoomSelectCoinComponent___c__DisplayClass14_0_o *)sub_1B64870(
  ...
  CoinRoomEffectComponent__OpenEffect(
    ...
    v2);
  this = (CoinRoomSelectCoinComponent___c__DisplayClass14_0_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE318 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  v6 = (CommonUI_o *)this;
  if ( !CoinRoomUtility_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(CoinRoomUtility_TypeInfo);
  if ( !v6 )
