...
void CoinRoomSelectCoinComponent__EndOpen(CoinRoomSelectCoinComponent_o *this, const MethodInfo *method)
{
  ...
  CoinRoomCoinListViewManager__SetMode_49013020(coinListViewManager, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D347D8 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_CoinRoomSelectCoinComponent___c__DisplayClass14_0__EndRequest_b__0__);
    sub_1C93AD4(&CoinRoomSelectCoinComponent___c__DisplayClass14_0_TypeInfo);
    sub_1C93AD4(&StringLiteral_22483/*"ng"*/);
    byte_4D347D8 = 1;
  }
  v5 = sub_1C93D20(CoinRoomSelectCoinComponent___c__DisplayClass14_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v5, 0);
  if ( !v5 )
    goto LABEL_10;
  *(_QWORD *)(v5 + 16) = this;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)(v5 + 16), (int32_t)this, v8, v9, v10, v11, v12, v13);
  v6 = System_String__op_Equality(result, (System_String_o *)StringLiteral_22483/*"ng"*/, 0);
  if ( v6 )
    return;
  coinListViewManager = this->fields.coinListViewManager;
  if ( !coinListViewManager )
  ...
  *(_QWORD *)(v5 + 24) = selectedCoinDic;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)(v5 + 24), (int32_t)selectedCoinDic, v14, v15, v16, v17, v18, v19);
...
void CoinRoomSelectCoinComponent__Init(CoinRoomSelectCoinComponent_o *this, const MethodInfo *method)
{
  ...
  this->fields.state = 0;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.beforeUserCoinRoomEntity, 0, v2, v3, v4, v5, v6, v7);
  ...
  if ( !coinListViewManager
    ...
    || (coinListViewManager = (CoinRoomCoinListViewManager_o *)UnityEngine_Component__get_gameObject(
                                                                 ...
                                                                 0)) == 0 )
  {
    sub_1C93D2C(coinListViewManager, v10);
  }
...
void CoinRoomSelectCoinComponent__OnClickDecide(CoinRoomSelectCoinComponent_o *this, const MethodInfo *method)
{
  ...
  _BOOL8 CanStrength_49000476; // x0
  __int64 v14; // x1
  ...
  {
    sub_1C93AD4(&System_Action_TypeInfo);
    sub_1C93AD4(&Method_CoinRoomSelectCoinComponent_OnClickDecide__);
    sub_1C93AD4(&Method_CoinRoomSelectCoinComponent_RequestCoinRoomPut__);
    sub_1C93AD4(&Method_CoinRoomSelectCoinComponent__OnClickDecide_b__12_0__);
    ...
    sub_1C93AD4(&Method_System_Collections_Generic_KeyValuePair_int__SelectedUserSvtCoin__get_Key__);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CoinRoomSelectCoinComponent_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C93AEC(Method_CoinRoomSelectCoinComponent_OnClickDecide__);
    ...
    v9 = (System_Collections_Generic_Dictionary_int__object__o *)sub_1C93D20(System_Collections_Generic_Dictionary_int__SelectedUserSvtCoin__TypeInfo);
              ...
              (const MethodInfo_361DC10 *)Method_System_Collections_Generic_Dictionary_Enumerator_int__SelectedUserSvtCoin__MoveNext__) )
    {
      ...
      CanStrength_49000476 = CoinRoomCoinIconItem__IsCanStrength_49000476(
                               (int32_t)v24.fields._current.fields.key,
                               1,
                               v10);
      if ( CanStrength_49000476 )
      {
        if ( !v9 )
          sub_1C93D2C(CanStrength_49000476, v14);
...
void CoinRoomSelectCoinComponent__OpenSelectCoinList(CoinRoomSelectCoinComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C93AD4(&System_Action_TypeInfo);
    sub_1C93AD4(&Method_CoinRoomSelectCoinComponent_EndOpen__);
    sub_1C93AD4(&LocalizationManager_TypeInfo);
    sub_1C93AD4(&StringLiteral_3578/*"COIN_ROOM_SELECT_LIST_SUB_TITLE"*/);
    byte_4D347D5 = 1;
  }
  ...
  if ( !coinListPanel )
    goto LABEL_13;
  CoinRoomCoinListViewManager__SetMode_49013020((CoinRoomCoinListViewManager_o *)coinListPanel, 1, v5);
  subTitle = this->fields.subTitle;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  coinListPanel = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3578/*"COIN_ROOM_SELECT_LIST_SUB_TITLE"*/, 0);
  if ( !subTitle )
LABEL_13:
    sub_1C93D2C(coinListPanel, method);
...
void CoinRoomSelectCoinComponent__RequestCoinRoomPut(CoinRoomSelectCoinComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D347D7 & 1) == 0 )
  {
    sub_1C93AD4(&Method_CoinRoomSelectCoinComponent_EndRequest__);
    sub_1C93AD4(&CoinRoomUtility_TypeInfo);
    sub_1C93AD4(&Method_NetworkManager_getRequest_CoinRoomRequest___);
  ...
  if ( !confirmDialog )
    goto LABEL_11;
  CoinConfirmDialog__Close_48994764(confirmDialog, 0, v12);
  coinListViewManager = this->fields.coinListViewManager;
  if ( !coinListViewManager )
    goto LABEL_11;
  selectedCoinDic = coinListViewManager->fields.selectedCoinDic;
  ...
  confirmDialog = (CoinConfirmDialog_o *)NetworkManager__getRequest_object_(
                                           v16,
                                           (const MethodInfo_322FB9C *)Method_NetworkManager_getRequest_CoinRoomRequest___);
  if ( !confirmDialog )
LABEL_11:
    sub_1C93D2C(confirmDialog, v11);
...
void CoinRoomSelectCoinComponent___OnClickDecide_b__12_0(CoinRoomSelectCoinComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C93AD4(&System_Action_TypeInfo);
    this = (CoinRoomSelectCoinComponent_o *)sub_1C93AD4(&Method_CoinRoomSelectCoinComponent_RequestCoinRoomPut__);
    byte_4D347DA = 1;
  }
  klass = v2[6].klass;
  if ( !klass
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C93AD4(&CoinRoomUtility_TypeInfo);
    this = (CoinRoomSelectCoinComponent___c__DisplayClass14_0_o *)sub_1C93AD4(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4D347DB = 1;
  }
  ...
  CoinRoomEffectComponent__OpenEffect(
    ...
    v2);
  this = (CoinRoomSelectCoinComponent___c__DisplayClass14_0_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3AC52FC *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  v5 = (CommonUI_o *)this;
  if ( !CoinRoomUtility_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(CoinRoomUtility_TypeInfo);
  if ( !v5 )
