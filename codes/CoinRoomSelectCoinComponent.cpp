...
void CoinRoomSelectCoinComponent__EndOpen(CoinRoomSelectCoinComponent_o *this, const MethodInfo *method)
{
  ...
  CoinRoomCoinListViewManager__SetMode_48481696(coinListViewManager, 2, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CBA135 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_CoinRoomSelectCoinComponent___c__DisplayClass14_0__EndRequest_b__0__);
    sub_1C6BA08(&CoinRoomSelectCoinComponent___c__DisplayClass14_0_TypeInfo);
    sub_1C6BA08(&StringLiteral_22301/*"ng"*/);
    byte_4CBA135 = 1;
  }
  v5 = sub_1C6BC54(CoinRoomSelectCoinComponent___c__DisplayClass14_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v5, 0);
  if ( !v5 )
    goto LABEL_10;
  *(_QWORD *)(v5 + 16) = this;
  sub_1C6B9AC((CGThumbnailListItem_o *)(v5 + 16), (int32_t)this, v8, v9);
  v6 = System_String__op_Equality(result, (System_String_o *)StringLiteral_22301/*"ng"*/, 0);
  if ( v6 )
    return;
  coinListViewManager = this->fields.coinListViewManager;
  if ( !coinListViewManager )
  ...
  *(_QWORD *)(v5 + 24) = selectedCoinDic;
  sub_1C6B9AC((CGThumbnailListItem_o *)(v5 + 24), (int32_t)selectedCoinDic, v10, v11);
...
void CoinRoomSelectCoinComponent__Init(CoinRoomSelectCoinComponent_o *this, const MethodInfo *method)
{
  ...
  this->fields.state = 0;
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.beforeUserCoinRoomEntity, 0, v2, v3);
  ...
  if ( !coinListViewManager
    ...
    || (coinListViewManager = (CoinRoomCoinListViewManager_o *)UnityEngine_Component__get_gameObject(
                                                                 ...
                                                                 0)) == 0 )
  {
    sub_1C6BC60(coinListViewManager, v6);
  }
...
void CoinRoomSelectCoinComponent__OnClickDecide(CoinRoomSelectCoinComponent_o *this, const MethodInfo *method)
{
  ...
  _BOOL8 CanStrength_48470024; // x0
  __int64 v13; // x1
  ...
  {
    sub_1C6BA08(&System_Action_TypeInfo);
    sub_1C6BA08(&Method_CoinRoomSelectCoinComponent_OnClickDecide__);
    sub_1C6BA08(&Method_CoinRoomSelectCoinComponent_RequestCoinRoomPut__);
    sub_1C6BA08(&Method_CoinRoomSelectCoinComponent__OnClickDecide_b__12_0__);
    ...
    sub_1C6BA08(&Method_System_Collections_Generic_KeyValuePair_int__SelectedUserSvtCoin__get_Key__);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CoinRoomSelectCoinComponent_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C6BA20(Method_CoinRoomSelectCoinComponent_OnClickDecide__);
    ...
    v9 = (System_Collections_Generic_Dictionary_int__object__o *)sub_1C6BC54(System_Collections_Generic_Dictionary_int__SelectedUserSvtCoin__TypeInfo);
              ...
              (const MethodInfo_35AA310 *)Method_System_Collections_Generic_Dictionary_Enumerator_int__SelectedUserSvtCoin__MoveNext__) )
    {
      ...
      CanStrength_48470024 = CoinRoomCoinIconItem__IsCanStrength_48470024((int32_t)v21.fields._current.fields.key, 1, 0);
      if ( CanStrength_48470024 )
      {
        if ( !v9 )
          sub_1C6BC60(CanStrength_48470024, v13);
...
void CoinRoomSelectCoinComponent__OpenSelectCoinList(CoinRoomSelectCoinComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C6BA08(&System_Action_TypeInfo);
    sub_1C6BA08(&Method_CoinRoomSelectCoinComponent_EndOpen__);
  ...
  if ( !coinListPanel )
    goto LABEL_13;
  CoinRoomCoinListViewManager__SetMode_48481696((CoinRoomCoinListViewManager_o *)coinListPanel, 1, 0);
  subTitle = this->fields.subTitle;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  coinListPanel = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3549/*"COIN_ROOM_SELECT_LIST_SUB_TITLE"*/, 0);
  if ( !subTitle )
LABEL_13:
    sub_1C6BC60(coinListPanel, method);
...
void CoinRoomSelectCoinComponent__RequestCoinRoomPut(CoinRoomSelectCoinComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CBA134 & 1) == 0 )
  {
    sub_1C6BA08(&Method_CoinRoomSelectCoinComponent_EndRequest__);
    sub_1C6BA08(&CoinRoomUtility_TypeInfo);
    sub_1C6BA08(&Method_NetworkManager_getRequest_CoinRoomRequest___);
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.beforeUserCoinRoomEntity, (int32_t)UserCoinRoomEntity, v5, v6);
  confirmDialog = this->fields.confirmDialog;
  if ( !confirmDialog )
    goto LABEL_11;
  ...
  confirmDialog = (CoinConfirmDialog_o *)NetworkManager__getRequest_object_(
                                           v11,
                                           (const MethodInfo_31C6C44 *)Method_NetworkManager_getRequest_CoinRoomRequest___);
  if ( !confirmDialog )
LABEL_11:
    sub_1C6BC60(confirmDialog, v7);
...
void CoinRoomSelectCoinComponent___OnClickDecide_b__12_0(CoinRoomSelectCoinComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C6BA08(&System_Action_TypeInfo);
    this = (CoinRoomSelectCoinComponent_o *)sub_1C6BA08(&Method_CoinRoomSelectCoinComponent_RequestCoinRoomPut__);
    byte_4CBA137 = 1;
  }
  klass = v2[6].klass;
  if ( !klass
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C6BA08(&CoinRoomUtility_TypeInfo);
    this = (CoinRoomSelectCoinComponent___c__DisplayClass14_0_o *)sub_1C6BA08(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4CBA138 = 1;
  }
  ...
  CoinRoomEffectComponent__OpenEffect(
    ...
    0);
  this = (CoinRoomSelectCoinComponent___c__DisplayClass14_0_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A4F3B4 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  v4 = (CommonUI_o *)this;
  if ( !CoinRoomUtility_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(CoinRoomUtility_TypeInfo);
  if ( !v4 )
