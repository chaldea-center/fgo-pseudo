...
void __fastcall CoinRoomSelectCoinComponent__EndOpen(CoinRoomSelectCoinComponent_o *this, const MethodInfo *method)
{
  ...
  CoinRoomCoinListViewManager__SetMode_44577256(coinListViewManager, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5E6E9 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_CoinRoomSelectCoinComponent___c__DisplayClass14_0__EndRequest_b__0__);
    sub_1B885B0(&CoinRoomSelectCoinComponent___c__DisplayClass14_0_TypeInfo);
    sub_1B885B0(&StringLiteral_22055/*"ng"*/);
    byte_4A5E6E9 = 1;
  }
  v5 = sub_1B887FC(CoinRoomSelectCoinComponent___c__DisplayClass14_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v5, 0LL);
  if ( !v5 )
    goto LABEL_10;
  *(_QWORD *)(v5 + 16) = this;
  sub_1B88554((ServantStatusBattleListViewItem_o *)(v5 + 16), (int32_t)this, v8, v9);
  v6 = System_String__op_Equality(result, (System_String_o *)StringLiteral_22055/*"ng"*/, 0LL);
  if ( v6 )
    return;
  coinListViewManager = this->fields.coinListViewManager;
  if ( !coinListViewManager )
  ...
  *(_QWORD *)(v5 + 24) = selectedCoinDic;
  sub_1B88554((ServantStatusBattleListViewItem_o *)(v5 + 24), (int32_t)selectedCoinDic, v10, v11);
...
LABEL_10:
    sub_1B8880C(v6, v7);
  CommonUI__maskFadeout((CommonUI_o *)Instance, 1, EFFECT_FADE_TIME, v17, 0LL);
}
...
void __fastcall CoinRoomSelectCoinComponent__Init(CoinRoomSelectCoinComponent_o *this, const MethodInfo *method)
{
  ...
  this->fields.state = 0;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.beforeUserCoinRoomEntity, 0, v2, v3);
  ...
  if ( !coinListViewManager
    ...
    || (coinListViewManager = (CoinRoomCoinListViewManager_o *)UnityEngine_Component__get_gameObject(
                                                                 ...
                                                                 0LL)) == 0LL )
  {
    sub_1B8880C(coinListViewManager, v6);
  }
        ...
        const MethodInfo *method)
{
  ...
  _BOOL8 CanStrength_44564644; // x0
  __int64 v14; // x1
  ...
  {
    sub_1B885B0(&System_Action_TypeInfo);
    sub_1B885B0(&Method_CoinRoomSelectCoinComponent_OnClickDecide__);
    sub_1B885B0(&Method_CoinRoomSelectCoinComponent_RequestCoinRoomPut__);
    sub_1B885B0(&Method_CoinRoomSelectCoinComponent__OnClickDecide_b__12_0__);
    ...
    sub_1B885B0(&Method_System_Collections_Generic_KeyValuePair_int__SelectedUserSvtCoin__get_Key__);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CoinRoomSelectCoinComponent_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B885C8(Method_CoinRoomSelectCoinComponent_OnClickDecide__);
    ...
    v9 = (System_Collections_Generic_Dictionary_int__object__o *)sub_1B887FC(System_Collections_Generic_Dictionary_int__SelectedUserSvtCoin__TypeInfo);
              ...
              (const MethodInfo_32B7418 *)Method_System_Collections_Generic_Dictionary_Enumerator_int__SelectedUserSvtCoin__MoveNext__) )
    {
      ...
      CanStrength_44564644 = CoinRoomCoinIconItem__IsCanStrength_44564644(
                               (int32_t)v24.fields._current.fields.key,
                               1,
                               v10);
      if ( CanStrength_44564644 )
      {
        if ( !v9 )
          sub_1B8880C(CanStrength_44564644, v14);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B885B0(&System_Action_TypeInfo);
    sub_1B885B0(&Method_CoinRoomSelectCoinComponent_EndOpen__);
  ...
  if ( !coinListPanel )
    goto LABEL_13;
  CoinRoomCoinListViewManager__SetMode_44577256((CoinRoomCoinListViewManager_o *)coinListPanel, 1, v5);
  subTitle = this->fields.subTitle;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  coinListPanel = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3637/*"COIN_ROOM_SELECT_LIST_SUB_TITLE"*/, 0LL);
  if ( !subTitle )
LABEL_13:
    sub_1B8880C(coinListPanel, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5E6E8 & 1) == 0 )
  {
    sub_1B885B0(&Method_CoinRoomSelectCoinComponent_EndRequest__);
    sub_1B885B0(&CoinRoomUtility_TypeInfo);
    sub_1B885B0(&Method_NetworkManager_getRequest_CoinRoomRequest___);
  ...
  if ( !confirmDialog )
    goto LABEL_11;
  CoinConfirmDialog__Close_44559128(confirmDialog, 0LL, v8);
  coinListViewManager = this->fields.coinListViewManager;
  if ( !coinListViewManager )
    goto LABEL_11;
  selectedCoinDic = coinListViewManager->fields.selectedCoinDic;
  ...
  confirmDialog = (CoinConfirmDialog_o *)NetworkManager__getRequest_object_(
                                           v12,
                                           (const MethodInfo_2F019D8 *)Method_NetworkManager_getRequest_CoinRoomRequest___);
  if ( !confirmDialog )
LABEL_11:
    sub_1B8880C(confirmDialog, v7);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B885B0(&System_Action_TypeInfo);
    this = (CoinRoomSelectCoinComponent_o *)sub_1B885B0(&Method_CoinRoomSelectCoinComponent_RequestCoinRoomPut__);
    byte_4A5E6EB = 1;
  }
  klass = v2[6].klass;
  if ( !klass
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B885B0(&CoinRoomUtility_TypeInfo);
    this = (CoinRoomSelectCoinComponent___c__DisplayClass14_0_o *)sub_1B885B0(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4A5E6EC = 1;
  }
  ...
  CoinRoomEffectComponent__OpenEffect(
    ...
    v2);
  this = (CoinRoomSelectCoinComponent___c__DisplayClass14_0_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  v5 = (CommonUI_o *)this;
  if ( !CoinRoomUtility_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(CoinRoomUtility_TypeInfo);
  if ( !v5 )
