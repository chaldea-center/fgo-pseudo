void __fastcall EventInfoFortificationControl___ctor(EventInfoFortificationControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B379F9 & 1) == 0 )
  {
    ...
    sub_1BD3458(&Method_System_Collections_Generic_List_EventInfoFortificationViewItem___ctor__, v3);
    sub_1BD3458(&System_Collections_Generic_List_EventInfoFortificationViewItem__TypeInfo, v4);
    sub_1BD3458(
  ...
  System_Runtime_CompilerServices_RuntimeHelpers__InitializeArray_62433328(v6, v21, 0LL);
  this->fields.workTypeOrder = v7;
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.workTypeOrder, (int64_t)v7, v8, v9, v10, v11, v12, v13);
  v14 = (System_Collections_Generic_List_object__o *)sub_1BD36A4(System_Collections_Generic_List_EventInfoFortificationViewItem__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v14,
    (const MethodInfo_35C055C *)Method_System_Collections_Generic_List_EventInfoFortificationViewItem___ctor__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B379F7 & 1) == 0 )
  {
    sub_1BD3458(&Method_System_Collections_Generic_List_EventInfoFortificationViewItem__Add__, *(_QWORD *)&count);
    sub_1BD3458(&Method_UnityEngine_Object_Instantiate_EventInfoFortificationViewItem___, v5);
    sub_1BD3458(&UnityEngine_Object_TypeInfo, v6);
    sub_1BD3458(&StringLiteral_23717/*"spot_info_gauge_base_color"*/, v7);
    sub_1BD3458(&StringLiteral_23719/*"spot_info_gauge_s"*/, v8);
    sub_1BD3458(&StringLiteral_23716/*"spot_info_gauge_base"*/, v9);
    byte_4B379F7 = 1;
  }
  if ( count >= 1 )
  {
    ...
    do
    {
      ...
      v13 = UnityEngine_Object__Instantiate_object__50031952(
              fortificationViewItemPrefab,
              fortificationViewItemParent,
              (const MethodInfo_2FB6D50 *)Method_UnityEngine_Object_Instantiate_EventInfoFortificationViewItem___);
      ...
      if ( ((unsigned __int8)fortificationViewItemList & 1) != 0 )
      {
        ...
        EventInfoUIBase__SetSpriteByLocalAtlas(
          ...
          (System_String_o *)StringLiteral_23716/*"spot_info_gauge_base"*/,
          0LL);
        EventInfoUIBase__SetSpriteByLocalAtlas(
          (EventInfoUIBase_o *)this,
          (UISprite_o *)v13[2].monitor,
          (System_String_o *)StringLiteral_23719/*"spot_info_gauge_s"*/,
          0LL);
        EventInfoUIBase__SetSpriteByLocalAtlas(
          (EventInfoUIBase_o *)this,
          (UISprite_o *)v13[3].klass,
          (System_String_o *)StringLiteral_23717/*"spot_info_gauge_base_color"*/,
          0LL);
    ...
    if ( !fortificationViewItemList )
LABEL_18:
      sub_1BD36B4(fortificationViewItemList, v15);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B379F4 & 1) == 0 )
  {
    ...
    sub_1BD3458(&Method_EventInfoFortificationControl__Initialization_b__13_0__, v10);
    this = (EventInfoFortificationControl_o *)sub_1BD3458(
  ...
  sub_1BD33FC((PartyOrganizationUtility_o *)&v9->fields.eventUiEntity, (int64_t)entity, size, v3, v4, v5, v6, v7);
...
bool __fastcall EventInfoFortificationControl__IsFortificationEvent(int32_t eventId, const MethodInfo *method)
{
  ...
  if ( (byte_4B379F8 & 1) == 0 )
  {
    sub_1BD3458(&Method_DataManager_GetMaster_EventFortificationMaster___, method);
    sub_1BD3458(&DataManager_TypeInfo, v3);
    byte_4B379F8 = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2F31630 *)Method_DataManager_GetMaster_EventFortificationMaster___);
  if ( !Master_object )
    sub_1BD36B4(0LL, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B379F5 & 1) == 0 )
  {
    sub_1BD3458(&Method_DataManager_GetMasterData_EventFortificationMaster___, method);
    sub_1BD3458(&Method_DataManager_GetMaster_UserEventFortificationMaster___, v3);
    sub_1BD3458(&DataManager_TypeInfo, v4);
    sub_1BD3458(&Method_System_Linq_Enumerable_OrderBy_EventFortificationEntity__int___, v5);
    sub_1BD3458(&Method_System_Linq_Enumerable_ThenBy_EventFortificationEntity__int___, v6);
    sub_1BD3458(&Method_System_Linq_Enumerable_ToList_EventFortificationEntity___, v7);
    sub_1BD3458(&Method_EventInfoFortificationControl__SetupFortificationItem_b__17_0__, v8);
    sub_1BD3458(&System_Func_EventFortificationEntity__int__TypeInfo, v9);
    sub_1BD3458(&Method_System_Collections_Generic_List_EventInfoFortificationViewItem__get_Count__, v10);
    sub_1BD3458(&Method_System_Collections_Generic_List_EventFortificationEntity__get_Count__, v11);
    sub_1BD3458(&Method_System_Collections_Generic_List_EventFortificationEntity__get_Item__, v12);
    sub_1BD3458(&Method_System_Collections_Generic_List_EventInfoFortificationViewItem__get_Item__, v13);
    ...
    sub_1BD3458(&Method_EventInfoFortificationControl___c__SetupFortificationItem_b__17_1__, v17);
    sub_1BD3458(&EventInfoFortificationControl___c_TypeInfo, v18);
    byte_4B379F5 = 1;
  }
  v46 = 0LL;
  entities = 0LL;
    ...
    if ( entities )
    {
      ...
      if ( fortificationViewItemList )
      {
        EventInfoFortificationControl__CreateFortificationViewItem(
          ...
          v22);
        v24 = entities;
        v25 = (System_Func_object__int__o *)sub_1BD36A4(System_Func_EventFortificationEntity__int__TypeInfo);
        ...
        v26 = System_Linq_Enumerable__OrderBy_object__int_(
                ...
                (const MethodInfo_2F5A740 *)Method_System_Linq_Enumerable_OrderBy_EventFortificationEntity__int___);
        ...
        if ( !_9__17_1 )
        {
          ...
          _9__17_1 = (System_Func_object__int__o *)sub_1BD36A4(System_Func_EventFortificationEntity__int__TypeInfo);
          System_Func_object__int____ctor(
            _9__17_1,
            v29,
        ...
        v37 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__ThenBy_object__int_(
                                                                     ...
                                                                     (const MethodInfo_2F6A248 *)Method_System_Linq_Enumerable_ThenBy_EventFortificationEntity__int___);
        Instance = (DataManager_o *)System_Linq_Enumerable__ToList_object_(
                                      v37,
                                      (const MethodInfo_2F6EB10 *)Method_System_Linq_Enumerable_ToList_EventFortificationEntity___);
        ...
        if ( v38 )
        {
          ...
          do
          {
            ...
            Item = System_Collections_Generic_List_object___get_Item(
                     v38,
                     v40,
                     (const MethodInfo_35C0AC0 *)Method_System_Collections_Generic_List_EventInfoFortificationViewItem__get_Item__);
            if ( v41 )
            {
              if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
                j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
            ...
            else
            {
              v43 = (EventFortificationEntity_o *)System_Collections_Generic_List_object___get_Item(
                                                    v39,
                                                    v40,
                                                    (const MethodInfo_35C0AC0 *)Method_System_Collections_Generic_List_EventFortificationEntity__get_Item__);
              if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
                j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B379F6 & 1) == 0 )
  {
    sub_1BD3458(&Method_DataManager_GetMaster_UserEventFortificationMaster___, method);
    sub_1BD3458(&DataManager_TypeInfo, v3);
    sub_1BD3458(&int_TypeInfo, v4);
    sub_1BD3458(&LocalizationManager_TypeInfo, v5);
    sub_1BD3458(&StringLiteral_5737/*"EVENT_POINT_COMMON_FORMAT"*/, v6);
    byte_4B379F6 = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  ...
  v11 = LocalizationManager__Get((System_String_o *)StringLiteral_5737/*"EVENT_POINT_COMMON_FORMAT"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B379FA & 1) == 0 )
  {
    this = (EventInfoFortificationControl_o *)sub_1BD3458(&StringLiteral_19438/*"event_progress_bg"*/, method);
    byte_4B379FA = 1;
  }
  ...
  if ( !eventUiEntity
    || (EventInfoUIBase__LoadLocalAtlas((EventInfoUIBase_o *)v2, eventUiEntity->fields.eventId, 0LL),
        EventInfoUIBase__SetSpriteByLocalAtlas(
          ...
          v2->fields.bgSprite,
          (System_String_o *)StringLiteral_19438/*"event_progress_bg"*/,
          0LL),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B379FB & 1) == 0 )
  {
    this = (EventInfoFortificationControl_o *)sub_1BD3458(&Method_System_Array_IndexOf_int___, entity);
    byte_4B379FB = 1;
  }
  if ( !entity )
    sub_1BD36B4(this, entity);
...
void __fastcall EventInfoFortificationControl___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B3872F & 1) == 0 )
  {
    sub_1BD3458(&EventInfoFortificationControl___c_TypeInfo, v1);
    byte_4B3872F = 1;
  }
  v2 = (Il2CppObject *)sub_1BD36A4(EventInfoFortificationControl___c_TypeInfo);
