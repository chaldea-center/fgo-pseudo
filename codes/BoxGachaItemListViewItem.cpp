        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFEC1A & 1) == 0 )
  {
    sub_1CE6700(&Method_DataManager_GetMasterData_BoxGachaHistoryMaster___);
    sub_1CE6700(&Method_DataManager_GetMasterData_GiftAddMaster___);
    sub_1CE6700(&Method_DataMasterBase_BoxGachaHistoryMaster__BoxGachaHistoryEntity__int__TryGetEntity__);
  ...
  Instance = (void *)sub_1CE66A4(&this->fields.gachaBaseData, data);
  ...
  Instance = DataManager__GetMasterData_object_(
               ...
               (const MethodInfo_32043A8 *)Method_DataManager_GetMasterData_BoxGachaHistoryMaster___);
  if ( !Instance )
    goto LABEL_22;
  if ( DataMasterBase_object__object__int___TryGetEntity(
         ...
         &entity,
         boxGachaId,
         (const MethodInfo_34E92A8 *)Method_DataMasterBase_BoxGachaHistoryMaster__BoxGachaHistoryEntity__int__TryGetEntity__) )
  {
    Instance = entity;
    if ( !entity )
      goto LABEL_22;
  ...
  sub_1CE66A4(&this->fields.detailTxt, detail);
  ...
  if ( type == 1 )
  {
    ...
    Instance = (void *)sub_1CE66A4(&this->fields.giftEnt, GiftData);
    ...
    if ( giftEnt )
    {
      if ( !giftEnt->fields._IsReplacedData_k__BackingField
        ...
        && (Instance = DataManager__GetMasterData_object_(
                         (DataManager_o *)Instance,
                         (const MethodInfo_32043A8 *)Method_DataManager_GetMasterData_GiftAddMaster___)) != 0
        ...
        && (OverwriteDetailText = GiftAddEntity__GetOverwriteDetailText((GiftAddEntity_o *)Instance, 0),
            ...
            Instance = (void *)sub_1CE66A4(&this->fields.detailTxt, OverwriteDetailText),
            (giftEnt = *p_giftEnt) != 0) )
      {
...
void BoxGachaItemListViewItem__setGiftData(BoxGachaItemListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFEC1B & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    sub_1CE6700(&StringLiteral_22902/*"overwriteFirstTimeDispItemId"*/);
    sub_1CE6700(&StringLiteral_22893/*"overwriteDispItemId"*/);
  ...
  if ( giftEnt )
  {
    ...
    if ( gachaBaseData )
    {
      IntValue = EntityScriptUtil__GetIntValue(
                   ...
                   (System_String_o *)StringLiteral_22893/*"overwriteDispItemId"*/,
                   0,
                   0);
      ...
      {
        v8 = IntValue;
        IntValue = EntityScriptUtil__GetIntValue(v7->fields.script, (System_String_o *)StringLiteral_22902/*"overwriteFirstTimeDispItemId"*/, 0, 0);
        if ( (int)IntValue >= 1 )
        {
          v9 = IntValue;
          IntValue = UnityEngine_PlayerPrefs__GetInt_72876276((System_String_o *)StringLiteral_22901/*"overwriteFirstTimeDispItemGet"*/, 0);
          if ( !(_DWORD)IntValue )
            v8 = v9;
        }
        ...
        if ( v10 )
        {
          switch ( v10->fields.type )
          {
            ...
            case 6:
            case 7:
              IntValue = (__int64)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
              if ( !IntValue )
                break;
...
LABEL_19:
              ...
              IntValue = sub_1CE66A4(&this->fields.itemEnt, v15);
...
LABEL_26:
              IntValue = sub_1CE66A4(p_svtEnt, Entity);
LABEL_27:
