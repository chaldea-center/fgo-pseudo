        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31D12 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMasterData_BoxGachaHistoryMaster___, data);
    sub_1B761C0(&Method_DataManager_GetMasterData_GiftAddMaster___, v11);
    sub_1B761C0(&Method_DataMasterBase_BoxGachaHistoryMaster__BoxGachaHistoryEntity__int__TryGetEntity__, v12);
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.gachaBaseData, (int32_t)data, v14, v15);
  ...
  Instance = DataManager__GetMasterData_object_(
               ...
               (const MethodInfo_2E62408 *)Method_DataManager_GetMasterData_BoxGachaHistoryMaster___);
  if ( !Instance )
    goto LABEL_22;
  if ( DataMasterBase_object__object__int___TryGetEntity(
         ...
         &entity,
         boxGachaId,
         (const MethodInfo_30FF7D4 *)Method_DataMasterBase_BoxGachaHistoryMaster__BoxGachaHistoryEntity__int__TryGetEntity__) )
  {
    Instance = entity;
    if ( !entity )
      goto LABEL_22;
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.detailTxt, (int32_t)detail, v18, v19);
  ...
  if ( type == 1 )
  {
    ...
    sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.giftEnt, (int32_t)GiftData, v26, v27);
    ...
    if ( giftEnt )
    {
      if ( !giftEnt->fields._IsReplacedData_k__BackingField
        ...
        && (Instance = DataManager__GetMasterData_object_(
                         (DataManager_o *)Instance,
                         (const MethodInfo_2E62408 *)Method_DataManager_GetMasterData_GiftAddMaster___)) != 0LL
...
LABEL_22:
  ...
  if ( (type & 0xFFFFFFFE) == 2 )
  {
    ...
    sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.nameTxt, (int32_t)v34, v32, v33);
    this->fields.targetImgId = *((_DWORD *)v35 + 7);
    v36 = (struct System_String_o *)*((_QWORD *)v35 + 5);
    this->fields.extraDetailTxt = v36;
    sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.extraDetailTxt, (int32_t)v36, v37, v38);
  }
}
...
void __fastcall BoxGachaItemListViewItem__setGiftData(BoxGachaItemListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A31D13 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_DataMasterBase_CommandCodeMaster__CommandCodeEntity__int__GetEntity__, v7);
  ...
  if ( giftEnt )
  {
    ...
    sub_1B76164(p_svtEnt, v17, v15, v16);
    v12 = this->fields.giftEnt;
    if ( !v12 )
LABEL_23:
