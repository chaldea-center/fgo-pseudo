        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7180F & 1) == 0 )
  {
    sub_1D0F0B4(&Method_DataManager_GetMasterData_BoxGachaHistoryMaster___);
    sub_1D0F0B4(&Method_DataManager_GetMasterData_GiftAddMaster___);
    sub_1D0F0B4(&Method_DataMasterBase_BoxGachaHistoryMaster__BoxGachaHistoryEntity__int__TryGetEntity__);
  ...
  Instance = (void *)sub_1D0F058(&this->fields.gachaBaseData, data);
  ...
  Instance = DataManager__GetMasterData_object_(
               ...
               (const MethodInfo_324F1B8 *)Method_DataManager_GetMasterData_BoxGachaHistoryMaster___);
  if ( !Instance )
    goto LABEL_22;
  if ( DataMasterBase_object__object__int___TryGetEntity(
         ...
         &entity,
         boxGachaId,
         (const MethodInfo_3535BC8 *)Method_DataMasterBase_BoxGachaHistoryMaster__BoxGachaHistoryEntity__int__TryGetEntity__) )
  {
    Instance = entity;
    if ( !entity )
      goto LABEL_22;
  ...
  sub_1D0F058(&this->fields.detailTxt, detail);
  ...
  if ( type == 1 )
  {
    ...
    Instance = (void *)sub_1D0F058(&this->fields.giftEnt, GiftData);
    ...
    if ( giftEnt )
    {
      if ( !giftEnt->fields._IsReplacedData_k__BackingField
        ...
        && (Instance = DataManager__GetMasterData_object_(
                         (DataManager_o *)Instance,
                         (const MethodInfo_324F1B8 *)Method_DataManager_GetMasterData_GiftAddMaster___)) != 0
        ...
        && (OverwriteDetailText = GiftAddEntity__GetOverwriteDetailText((GiftAddEntity_o *)Instance, 0),
            ...
            Instance = (void *)sub_1D0F058(&this->fields.detailTxt, OverwriteDetailText),
            (giftEnt = *p_giftEnt) != 0) )
      {
...
void BoxGachaItemListViewItem__setGiftData(BoxGachaItemListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E71810 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    sub_1D0F0B4(&StringLiteral_22996/*"overwriteFirstTimeDispItemId"*/);
    sub_1D0F0B4(&StringLiteral_22987/*"overwriteDispItemId"*/);
  ...
  if ( giftEnt )
  {
    ...
    if ( gachaBaseData )
    {
      IntValue = EntityScriptUtil__GetIntValue(
                   ...
                   (System_String_o *)StringLiteral_22987/*"overwriteDispItemId"*/,
                   0,
                   0);
      ...
      {
        v8 = IntValue;
        IntValue = EntityScriptUtil__GetIntValue(v7->fields.script, (System_String_o *)StringLiteral_22996/*"overwriteFirstTimeDispItemId"*/, 0, 0);
        if ( (int)IntValue >= 1 )
        {
          v9 = IntValue;
          IntValue = UnityEngine_PlayerPrefs__GetInt_73317220((System_String_o *)StringLiteral_22995/*"overwriteFirstTimeDispItemGet"*/, 0);
          if ( !(_DWORD)IntValue )
            v8 = v9;
        }
        ...
        if ( v10 )
        {
          switch ( v10->fields.type )
          {
            ...
            case 6:
            case 7:
              IntValue = (__int64)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3BAC684 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
              if ( !IntValue )
                break;
...
LABEL_19:
              ...
              IntValue = sub_1D0F058(&this->fields.itemEnt, v15);
...
LABEL_26:
              IntValue = sub_1D0F058(p_svtEnt, Entity);
LABEL_27:
