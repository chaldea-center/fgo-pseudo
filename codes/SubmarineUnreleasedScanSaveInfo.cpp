        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)v6, (int32_t)scanIds, v7, v8);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B414BC & 1) == 0 )
  {
    ...
    sub_1BDB878(&SubmarineUnreleasedScanSaveInfo_TypeInfo, v6);
    byte_4B414BC = 1;
  }
  ...
  if ( (IsNullOrEmpty & 1) == 0 )
  {
    if ( value )
    {
      ...
      if ( (int)*(_QWORD *)&v10->max_length >= 2 )
      {
        ...
        if ( (v17 & 0xFFFFFFFE) == 0 )
LABEL_17:
          sub_1BDBADC(IsNullOrEmpty, v8, v15);
        v18 = 0LL;
        v19 = v17 - 2;
        while ( 1 )
        {
          ...
          if ( !v11 )
            sub_1BDBAD4(IsNullOrEmpty, (unsigned int)IsNullOrEmpty);
...
LABEL_19:
        ...
        v9 = sub_1BDBAC4(SubmarineUnreleasedScanSaveInfo_TypeInfo);
        System_Object___ctor((Il2CppObject *)v9, 0LL);
        *(_DWORD *)(v9 + 16) = v16;
        *(_QWORD *)(v9 + 24) = v24;
        sub_1BDB81C((CGThumbnailListItem_o *)(v9 + 24), (int32_t)v24, v25, v26);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B414BB & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Linq_Enumerable_Select_int__string___, method);
    sub_1BDB878(&Method_System_Linq_Enumerable_ToList_string___, v3);
    sub_1BDB878(&System_Func_int__string__TypeInfo, v4);
    sub_1BDB878(&Method_System_Collections_Generic_List_string__Insert__, v5);
    ...
    sub_1BDB878(&Method_SubmarineUnreleasedScanSaveInfo___c__GetSaveValue_b__9_0__, v9);
    sub_1BDB878(&SubmarineUnreleasedScanSaveInfo___c_TypeInfo, v10);
  ...
  if ( !_9__9_0 )
  {
    ...
    _9__9_0 = (System_Func_T__TResult__o *)sub_1BDBAC4(System_Func_int__string__TypeInfo);
    ...
    sub_1BDB81C((CGThumbnailListItem_o *)&static_fields->__9__9_0, (int32_t)_9__9_0, v18, v19);
  }
  ...
  System_Collections_Generic_List_object___Insert(
    ...
    0,
    v22,
    (const MethodInfo_36D6B74 *)Method_System_Collections_Generic_List_string__Insert__);
  ...
  return System_String__Join((System_String_o *)StringLiteral_820/*","*/, v24, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields._ScanIds_k__BackingField, (int32_t)value, (int32_t)method, v3);
}
...
void __fastcall SubmarineUnreleasedScanSaveInfo___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B414BD & 1) == 0 )
  {
    sub_1BDB878(&SubmarineUnreleasedScanSaveInfo___c_TypeInfo, v1);
    byte_4B414BD = 1;
  }
  v2 = (Il2CppObject *)sub_1BDBAC4(SubmarineUnreleasedScanSaveInfo___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  SubmarineUnreleasedScanSaveInfo___c_TypeInfo->static_fields->__9 = (struct SubmarineUnreleasedScanSaveInfo___c_o *)v2;
  sub_1BDB81C((CGThumbnailListItem_o *)SubmarineUnreleasedScanSaveInfo___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
