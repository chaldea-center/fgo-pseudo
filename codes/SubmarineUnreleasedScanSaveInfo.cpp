        ...
        const MethodInfo *method)
{
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)v6, (int32_t)scanIds, v7, v8);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B79A1 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&SubmarineUnreleasedScanSaveInfo_TypeInfo, v6);
    byte_49B79A1 = 1;
  }
...
LABEL_17:
        ...
        while ( 1 )
        {
          ...
          if ( !v11 )
            sub_1B4D1EC(IsNullOrEmpty, (unsigned int)IsNullOrEmpty);
...
LABEL_19:
        ...
        v9 = sub_1B4D1DC(SubmarineUnreleasedScanSaveInfo_TypeInfo);
        System_Object___ctor((Il2CppObject *)v9, 0LL);
        *(_DWORD *)(v9 + 16) = v14;
        *(_QWORD *)(v9 + 24) = v22;
        sub_1B4CF34((CGThumbnailListItem_o *)(v9 + 24), (int32_t)v22, v23, v24);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B79A0 & 1) == 0 )
  {
    sub_1B4CF90(&Method_System_Linq_Enumerable_Select_int__string___, method);
    sub_1B4CF90(&Method_System_Linq_Enumerable_ToList_string___, v3);
    sub_1B4CF90(&System_Func_int__string__TypeInfo, v4);
    sub_1B4CF90(&Method_System_Collections_Generic_List_string__Insert__, v5);
    ...
    sub_1B4CF90(&Method_SubmarineUnreleasedScanSaveInfo___c__GetSaveValue_b__9_0__, v9);
    sub_1B4CF90(&SubmarineUnreleasedScanSaveInfo___c_TypeInfo, v10);
  ...
  if ( !_9__9_0 )
  {
    ...
    _9__9_0 = (System_Func_T__TResult__o *)sub_1B4D1DC(System_Func_int__string__TypeInfo);
  ...
  return System_String__Join((System_String_o *)StringLiteral_816/*","*/, v24, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields._ScanIds_k__BackingField, (int32_t)value, (int32_t)method, v3);
}
...
void __fastcall SubmarineUnreleasedScanSaveInfo___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49B79A2 & 1) == 0 )
  {
    sub_1B4CF90(&SubmarineUnreleasedScanSaveInfo___c_TypeInfo, v1);
    byte_49B79A2 = 1;
  }
  v2 = (Il2CppObject *)sub_1B4D1DC(SubmarineUnreleasedScanSaveInfo___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  SubmarineUnreleasedScanSaveInfo___c_TypeInfo->static_fields->__9 = (struct SubmarineUnreleasedScanSaveInfo___c_o *)v2;
  sub_1B4CF34((CGThumbnailListItem_o *)SubmarineUnreleasedScanSaveInfo___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
