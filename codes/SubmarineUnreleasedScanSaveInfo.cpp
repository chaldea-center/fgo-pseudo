        ...
        const MethodInfo *method)
{
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)v6, (int32_t)scanIds, v7, v8);
}
...
LABEL_17:
        ...
        while ( 1 )
        {
          ...
          if ( !v7 )
            sub_1C6BC60(IsNullOrEmpty, (unsigned int)IsNullOrEmpty);
...
LABEL_19:
        ...
        *(_DWORD *)(v5 + 16) = v10;
        *(_QWORD *)(v5 + 24) = v18;
        sub_1C6B9AC((CGThumbnailListItem_o *)(v5 + 24), (int32_t)v18, v19, v20);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB2C23 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_System_Collections_Generic_List_string__Insert__);
    ...
    sub_1C6BA08(&System_Collections_Generic_List_int__TypeInfo);
    sub_1C6BA08(&Method_SubmarineUnreleasedScanSaveInfo___c__GetSaveValue_b__9_0__);
    sub_1C6BA08(&SubmarineUnreleasedScanSaveInfo___c_TypeInfo);
  ...
  if ( !_9__9_0 )
  {
    ...
    _9__9_0 = (System_Func_T__TResult__o *)sub_1C6BC54(System_Func_int__string__TypeInfo);
  ...
  System_Collections_Generic_List_object___Insert(
    ...
    0,
    v13,
    (const MethodInfo_3801724 *)Method_System_Collections_Generic_List_string__Insert__);
  ...
  return System_String__Join((System_String_o *)StringLiteral_808/*","*/, v15, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields._ScanIds_k__BackingField, (int32_t)value, (int32_t)method, v3);
}
...
void SubmarineUnreleasedScanSaveInfo___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C6BC54(SubmarineUnreleasedScanSaveInfo___c_TypeInfo);
  System_Object___ctor(v1, 0);
  SubmarineUnreleasedScanSaveInfo___c_TypeInfo->static_fields->__9 = (struct SubmarineUnreleasedScanSaveInfo___c_o *)v1;
  sub_1C6B9AC((CGThumbnailListItem_o *)SubmarineUnreleasedScanSaveInfo___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
