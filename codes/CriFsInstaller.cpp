void CriFsInstaller___ctor(CriFsInstaller_o *this, const MethodInfo *method)
{
  ...
  {
    v6 = sub_1C713C4(&System_Exception_TypeInfo);
    v7 = (System_Exception_o *)sub_1C715FC(v6);
    v8 = &StringLiteral_4864/*"CriFsPlugin is not initialized."*/;
    goto LABEL_12;
  }
  ...
  {
    v9 = sub_1C713C4(&System_Exception_TypeInfo);
    v7 = (System_Exception_o *)sub_1C715FC(v9);
    v8 = &StringLiteral_18374/*"criFsInstaller_Create() failed."*/;
LABEL_12:
    v10 = (System_String_o *)sub_1C713C4(v8);
    System_Exception___ctor_65777816(v7, v10, 0);
    v11 = sub_1C713C4(&Method_CriFsInstaller__ctor__);
    sub_1C714D8(v7, v11);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC07F3 & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_22290/*"net2:"*/);
    sub_1C713B0(&StringLiteral_20153/*"https:"*/);
    this = (CriFsInstaller_o *)sub_1C713B0(&StringLiteral_20118/*"http:"*/);
    byte_4CC07F3 = 1;
  }
  if ( !srcPath )
    goto LABEL_17;
  if ( System_String__StartsWith(srcPath, (System_String_o *)StringLiteral_20118/*"http:"*/, 0)
    || System_String__StartsWith(srcPath, (System_String_o *)StringLiteral_20153/*"https:"*/, 0) )
  {
    srcPath = System_String__Concat_64031724((System_String_o *)StringLiteral_22290/*"net2:"*/, srcPath, 0);
  }
  if ( installBufferSize >= 1 )
  {
    v12 = sub_1C71458(byte___TypeInfo, (unsigned int)installBufferSize);
    v10->fields.installBuffer = (struct System_Byte_array *)v12;
    sub_1C71354(&v10->fields.installBuffer, v12);
    v10->fields.installBufferGch = System_Runtime_InteropServices_GCHandle__Alloc_64711564(
...
void CriFsInstaller__Dispose(CriFsInstaller_o *this, const MethodInfo *method)
{
  ...
  CriFsInstaller__Dispose_31053484(this, 1, v2);
...
void CriFsInstaller__Dispose_31053484(CriFsInstaller_o *this, bool disposing, const MethodInfo *method)
{
  ...
  if ( disposing )
  {
    if ( this->fields.installBuffer )
    {
      ...
      sub_1C71354(&this->fields.installBuffer, 0);
    }
  }
}
...
void CriFsInstaller__Finalize(CriFsInstaller_o *this, const MethodInfo *method)
{
  ...
  CriFsInstaller__Dispose_31053484(this, 0, v2);
        ...
        const MethodInfo *method)
{
  ...
  if ( !off_4CC0810 )
  {
    ...
    *(_QWORD *)v27 = "criFsInstaller_Copy";
    ...
    v29 = 0x200000000LL;
    v31 = 0;
    off_4CC0810 = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD))sub_1C71A60(v25, binder);
  }
  v14 = sub_1C71A40(
          v11,
          binder,
          ...
          v27[0],
          v28);
  v22 = sub_1C71A40(v10, v15, v16, v17, v18, v19, v20, v21, v25[0], v26, v27[0], v28);
  v23 = off_4CC0810(installer, binder, v14, v22, buffer, buffer_size);
  sub_1C71A58(v14);
  sub_1C71A58(v22);
  return v23;
}
...
int32_t CriFsInstaller__criFsInstaller_ExecuteMain(const MethodInfo *method)
{
  ...
  v1 = (const MethodInfo *)off_4CC07F8;
  if ( !off_4CC07F8 )
  {
    v4 = 0;
    v3[0] = "cri_ware_unity";
    ...
    v3[4] = 0x200000000LL;
    v5 = 0;
    method = (const MethodInfo *)sub_1C71A60(v3);
    v1 = method;
    off_4CC07F8 = method;
  }
...
int32_t CriFsInstaller__criFsInstaller_GetProgress(intptr_t installer, float *progress, const MethodInfo *method)
{
  ...
  if ( !off_4CC0828 )
  {
    ...
    v7[4] = 0x200000000LL;
    v9 = 0;
    v3 = (void *)sub_1C71A60(v7, progress);
    off_4CC0828 = v3;
  }
