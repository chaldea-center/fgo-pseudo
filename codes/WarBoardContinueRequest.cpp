        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFF218 & 1) == 0 )
  {
    sub_1C2E12C(&NetworkManager_TypeInfo, *(_QWORD *)&stageId);
    sub_1C2E12C(&StringLiteral_23927/*"stageId"*/, v9);
    sub_1C2E12C(&StringLiteral_18538/*"consumeType"*/, v10);
    byte_4BFF218 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23927/*"stageId"*/, stageId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18538/*"consumeType"*/, consumeType, 0LL);
  if ( !warBoardData )
    sub_1C2E388(v11, v12);
...
System_String_o *__fastcall WarBoardContinueRequest__getURL(WarBoardContinueRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFF217 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&StringLiteral_25081/*"warBoard/continue"*/, v2);
    byte_4BFF217 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63235584(BaseUrl, (System_String_o *)StringLiteral_25081/*"warBoard/continue"*/, 0LL);
}
