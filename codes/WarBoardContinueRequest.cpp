        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0A60F & 1) == 0 )
  {
    sub_1B686D4(&NetworkManager_TypeInfo, *(_QWORD *)&stageId);
    sub_1B686D4(&StringLiteral_23396/*"stageId"*/, v9);
    sub_1B686D4(&StringLiteral_18151/*"consumeType"*/, v10);
    byte_4A0A60F = 1;
  }
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18151/*"consumeType"*/, consumeType, v11);
  if ( !warBoardData )
    sub_1B68930(v12, v13);
...
System_String_o *__fastcall WarBoardContinueRequest__getURL(WarBoardContinueRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0A60E & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_24532/*"warBoard/continue"*/, v2);
    byte_4A0A60E = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61419468(BaseUrl, (System_String_o *)StringLiteral_24532/*"warBoard/continue"*/, 0LL);
}
