        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A21484 & 1) == 0 )
  {
    sub_1B715CC(&NetworkManager_TypeInfo, *(_QWORD *)&stageId);
    sub_1B715CC(&StringLiteral_23419/*"stageId"*/, v9);
    sub_1B715CC(&StringLiteral_18167/*"consumeType"*/, v10);
    byte_4A21484 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23419/*"stageId"*/, stageId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18167/*"consumeType"*/, consumeType, 0LL);
  if ( !warBoardData )
    sub_1B71828(v11, v12);
...
System_String_o *__fastcall WarBoardContinueRequest__getURL(WarBoardContinueRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A21483 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_24556/*"warBoard/continue"*/, v2);
    byte_4A21483 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61505504(BaseUrl, (System_String_o *)StringLiteral_24556/*"warBoard/continue"*/, 0LL);
}
