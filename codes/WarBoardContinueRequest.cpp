        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F8F7 & 1) == 0 )
  {
    sub_1B761C0(&NetworkManager_TypeInfo, *(_QWORD *)&stageId);
    sub_1B761C0(&StringLiteral_23465/*"stageId"*/, v9);
    sub_1B761C0(&StringLiteral_18211/*"consumeType"*/, v10);
    byte_4A2F8F7 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23465/*"stageId"*/, stageId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18211/*"consumeType"*/, consumeType, 0LL);
  if ( !warBoardData )
    sub_1B7641C(v11, v12);
...
System_String_o *__fastcall WarBoardContinueRequest__getURL(WarBoardContinueRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2F8F6 & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_24602/*"warBoard/continue"*/, v2);
    byte_4A2F8F6 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61535060(BaseUrl, (System_String_o *)StringLiteral_24602/*"warBoard/continue"*/, 0LL);
}
