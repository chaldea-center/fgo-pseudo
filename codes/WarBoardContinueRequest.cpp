        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB6148 & 1) == 0 )
  {
    sub_1C13D24(&NetworkManager_TypeInfo, *(_QWORD *)&stageId);
    sub_1C13D24(&StringLiteral_23865/*"squareIndexes"*/, v9);
    sub_1C13D24(&StringLiteral_18498/*"conds"*/, v10);
    byte_4BB6148 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23865/*"squareIndexes"*/, stageId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18498/*"conds"*/, consumeType, 0LL);
  if ( !warBoardData )
    sub_1C13F80(v11, v12);
...
System_String_o *__fastcall WarBoardContinueRequest__getURL(WarBoardContinueRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB6147 & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_25013/*"voiceVolume"*/, v2);
    byte_4BB6147 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62967944(BaseUrl, (System_String_o *)StringLiteral_25013/*"voiceVolume"*/, 0LL);
}
