        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDDA3 & 1) == 0 )
  {
    sub_1B640C8(&NetworkManager_TypeInfo, *(_QWORD *)&stageId);
    sub_1B640C8(&StringLiteral_23380/*"stageId"*/, v9);
    sub_1B640C8(&StringLiteral_18146/*"consumeType"*/, v10);
    byte_49FDDA3 = 1;
  }
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18146/*"consumeType"*/, consumeType, v11);
  if ( !warBoardData )
    sub_1B64324(v12);
  WarBoardData__SetRequest(warBoardData, (RequestBase_o *)this, 0LL);
  RequestBase__addBaseField((RequestBase_o *)this, v13);
  RequestBase__WriteParameter((RequestBase_o *)this, v14);
...
System_String_o *__fastcall WarBoardContinueRequest__getURL(WarBoardContinueRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FDDA2 & 1) == 0 )
  {
    ...
    sub_1B640C8(&StringLiteral_24516/*"warBoard/continue"*/, v2);
    byte_49FDDA2 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61375396(BaseUrl, (System_String_o *)StringLiteral_24516/*"warBoard/continue"*/, 0LL);
}
