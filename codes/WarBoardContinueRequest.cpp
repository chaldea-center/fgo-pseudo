        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D32625 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_18376/*"consumeType"*/);
    byte_4D32625 = 1;
  }
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18376/*"consumeType"*/, consumeType, v9);
  if ( !warBoardData )
    sub_1C93D2C(v10, v11);
...
System_String_o *WarBoardContinueRequest__getURL(WarBoardContinueRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C93AD4(&NetworkManager_TypeInfo);
    sub_1C93AD4(&StringLiteral_25056/*"warBoard/continue"*/);
    byte_4D32624 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64425724(BaseUrl, (System_String_o *)StringLiteral_25056/*"warBoard/continue"*/, 0);
}
