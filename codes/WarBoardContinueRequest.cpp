        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFE9E & 1) == 0 )
  {
    sub_1B64870(&NetworkManager_TypeInfo, *(_QWORD *)&stageId);
    sub_1B64870(&StringLiteral_23384/*"stageId"*/, v9);
    sub_1B64870(&StringLiteral_18148/*"consumeType"*/, v10);
    byte_49FFE9E = 1;
  }
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18148/*"consumeType"*/, consumeType, v11);
  if ( !warBoardData )
    sub_1B64ACC(v12, v13);
...
System_String_o *__fastcall WarBoardContinueRequest__getURL(WarBoardContinueRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FFE9D & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_24520/*"warBoard/continue"*/, v2);
    byte_49FFE9D = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61383576(BaseUrl, (System_String_o *)StringLiteral_24520/*"warBoard/continue"*/, 0LL);
}
