        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB7F5C & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_18250/*"consumeType"*/);
    byte_4CB7F5C = 1;
  }
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18250/*"consumeType"*/, consumeType, v9);
  if ( !warBoardData )
    sub_1C6BC60(v10, v11);
...
System_String_o *WarBoardContinueRequest__getURL(WarBoardContinueRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C6BA08(&NetworkManager_TypeInfo);
    sub_1C6BA08(&StringLiteral_24844/*"warBoard/continue"*/);
    byte_4CB7F5B = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63966792(BaseUrl, (System_String_o *)StringLiteral_24844/*"warBoard/continue"*/, 0);
}
