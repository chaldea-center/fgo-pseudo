        ...
        const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.onGetRequest, (int32_t)onGetRequest, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C373E4 & 1) == 0 )
  {
    sub_1C32C20(&Method_ActionExtensions_Call_TutorialCommunicateAdapter___);
    byte_4C373E4 = 1;
  }
  ...
  ActionExtensions__Call_object_(
    ...
    (Il2CppObject *)this,
    (const MethodInfo_3029CE0 *)Method_ActionExtensions_Call_TutorialCommunicateAdapter___);
}
