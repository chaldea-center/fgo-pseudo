...
void EventInfoAssistListComponent__Setup(EventInfoAssistListComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2CA84 & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_GameObjectHelper_Instantiate_EventInfoAssistComponent___);
    this = (EventInfoAssistListComponent_o *)sub_1C94098(&UnityEngine_Object_TypeInfo);
    byte_4D2CA84 = 1;
  }
...
LABEL_15:
          v10 = GameObjectHelper__Instantiate_object_(
                  ...
                  0,
                  (const MethodInfo_31F63B4 *)Method_GameObjectHelper_Instantiate_EventInfoAssistComponent___);
