...
void EventInfoAssistListComponent__Setup(EventInfoAssistListComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E04C58 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_GameObjectHelper_Instantiate_EventInfoAssistComponent___);
    this = (EventInfoAssistListComponent_o *)sub_1CE6700(&UnityEngine_Object_TypeInfo);
    byte_4E04C58 = 1;
  }
...
LABEL_15:
          v10 = GameObjectHelper__Instantiate_object_(
                  ...
                  0,
                  (const MethodInfo_325DA60 *)Method_GameObjectHelper_Instantiate_EventInfoAssistComponent___);
