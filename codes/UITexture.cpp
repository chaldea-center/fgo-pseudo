void UITexture___ctor(UITexture_o *this, const MethodInfo *method)
{
  ...
  this->fields.mRect = (struct UnityEngine_Rect_o)xmmword_D350F0;
  if ( !byte_4E70F86 )
  {
...
LABEL_18:
    ...
    this->fields.mTexture = value;
    sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.mTexture, (int32_t)value, v17, v18, v19, v20, v21, v22);
    klass = this->klass;
    this->fields.mPMA = -1;
    ((void (__fastcall *)(UITexture_o *, const MethodInfo *))klass->vtable._30_MarkAsChanged.methodPtr)(
      this,
...
void UITexture__set_material(UITexture_o *this, UnityEngine_Material_o *value, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(mMat, (UnityEngine_Object_o *)value, 0) )
  {
    ...
    sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.mShader, 0, v6, v7, v8, v9, v10, v11);
    this->fields.mMat = value;
    sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.mMat, (int32_t)value, v12, v13, v14, v15, v16, v17);
    klass = this->klass;
    this->fields.mPMA = -1;
    ((void (__fastcall *)(UITexture_o *, const MethodInfo *))klass->vtable._30_MarkAsChanged.methodPtr)(
      this,
...
LABEL_18:
    ...
    UIWidget__RemoveFromPanel((UIWidget_o *)this, 0);
    this->fields.mShader = value;
    sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.mShader, (int32_t)value, v17, v18, v19, v20, v21, v22);
    this->fields.mPMA = -1;
    this->fields.mMat = 0;
    sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.mMat, 0, v23, v24, v25, v26, v27, v28);
