...
void SupportSelectConfirmCopyMenu__Close(SupportSelectConfirmCopyMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596CC12 & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_SupportSelectConfirmCopyMenu_OnFinishedClose__);
    byte_596CC12 = 1;
  }
...
void SupportSelectConfirmCopyMenu__OnClickCancel(SupportSelectConfirmCopyMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596CC14 & 1) == 0 )
  {
    sub_2213A60(&Method_SupportSelectConfirmCopyMenu_OnClickCancel__);
    byte_596CC14 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectConfirmCopyMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_2213A78(Method_SupportSelectConfirmCopyMenu_OnClickCancel__);
...
void SupportSelectConfirmCopyMenu__OnClickDecide(SupportSelectConfirmCopyMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596CC13 & 1) == 0 )
  {
    sub_2213A60(&Method_SupportSelectConfirmCopyMenu_OnClickDecide__);
    byte_596CC13 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectConfirmCopyMenu_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_2213A78(Method_SupportSelectConfirmCopyMenu_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_2213A44(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596CC11 & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_SupportSelectConfirmCopyMenu_OnFinishedOpen__);
    sub_2213A60(&StringLiteral_13049/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_CONFIRM_TARGET_DECK"*/);
    sub_2213A60(&StringLiteral_13048/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_CONFIRM_MESSAGE"*/);
    sub_2213A60(&StringLiteral_13050/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_CONFIRM_TITLE"*/);
    sub_2213A60(&StringLiteral_13045/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_CONFIRM_BASE_DECK"*/);
    sub_2213A60(&StringLiteral_13046/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_CONFIRM_CANCEL"*/);
    sub_2213A60(&StringLiteral_13047/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_CONFIRM_DECIDE"*/);
    byte_596CC11 = 1;
  }
  if ( this->fields.currentState == 2 )
  {
    ...
    baseDeckObj = LocalizationManager__Get((System_String_o *)StringLiteral_13050/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_CONFIRM_TITLE"*/, 0);
    if ( !titleLabel )
      goto LABEL_16;
    UILabel__set_text(titleLabel, baseDeckObj, 0);
    messageLabel = this->fields.messageLabel;
    baseDeckObj = LocalizationManager__Get((System_String_o *)StringLiteral_13048/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_CONFIRM_MESSAGE"*/, 0);
    if ( !messageLabel )
      goto LABEL_16;
    UILabel__set_text(messageLabel, baseDeckObj, 0);
    baseDeckTitleLabel = this->fields.baseDeckTitleLabel;
    baseDeckObj = LocalizationManager__Get((System_String_o *)StringLiteral_13045/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_CONFIRM_BASE_DECK"*/, 0);
    ...
    baseDeckObj = LocalizationManager__Get((System_String_o *)StringLiteral_13049/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_CONFIRM_TARGET_DECK"*/, 0);
    if ( !targetDeckTitleLabel )
      goto LABEL_16;
    UILabel__set_text(targetDeckTitleLabel, baseDeckObj, 0);
    decideButtonLabel = this->fields.decideButtonLabel;
    baseDeckObj = LocalizationManager__Get((System_String_o *)StringLiteral_13047/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_CONFIRM_DECIDE"*/, 0);
    if ( !decideButtonLabel
      || (UILabel__set_text(decideButtonLabel, baseDeckObj, 0),
          cancelButtonLabel = this->fields.cancelButtonLabel,
          baseDeckObj = LocalizationManager__Get((System_String_o *)StringLiteral_13046/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_CONFIRM_CANCEL"*/, 0),
          !cancelButtonLabel)
        ...
        const MethodInfo *method)
{
  ...
  sub_221405C(v8, SupportSelectConfirmCopyMenu_OnClickButtonEvent_TypeInfo, v9, v10);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_2007034;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_2006FEC;
}
