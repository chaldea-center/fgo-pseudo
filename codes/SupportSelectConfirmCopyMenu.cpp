...
void __fastcall SupportSelectConfirmCopyMenu__Close(SupportSelectConfirmCopyMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BF9F72 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_SupportSelectConfirmCopyMenu_OnFinishedClose__, v3);
    byte_4BF9F72 = 1;
  }
  this->fields.currentState = 2;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF9F74 & 1) == 0 )
  {
    sub_1C2E12C(&Method_SupportSelectConfirmCopyMenu_OnClickCancel__, method);
    byte_4BF9F74 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectConfirmCopyMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2E144(Method_SupportSelectConfirmCopyMenu_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF9F73 & 1) == 0 )
  {
    sub_1C2E12C(&Method_SupportSelectConfirmCopyMenu_OnClickDecide__, method);
    byte_4BF9F73 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectConfirmCopyMenu_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2E144(Method_SupportSelectConfirmCopyMenu_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C2E110(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF9F71 & 1) == 0 )
  {
    sub_1C2E12C(&System_Action_TypeInfo, baseDeckData);
    sub_1C2E12C(&LocalizationManager_TypeInfo, v9);
    sub_1C2E12C(&Method_SupportSelectConfirmCopyMenu_OnFinishedOpen__, v10);
    sub_1C2E12C(&StringLiteral_12672/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_CONFIRM_TARGET_DECK"*/, v11);
    sub_1C2E12C(&StringLiteral_12671/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_CONFIRM_MESSAGE"*/, v12);
    sub_1C2E12C(&StringLiteral_12673/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_CONFIRM_TITLE"*/, v13);
    sub_1C2E12C(&StringLiteral_12668/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_CONFIRM_BASE_DECK"*/, v14);
    sub_1C2E12C(&StringLiteral_12669/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_CONFIRM_CANCEL"*/, v15);
    sub_1C2E12C(&StringLiteral_12670/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_CONFIRM_DECIDE"*/, v16);
    byte_4BF9F71 = 1;
  }
  if ( this->fields.currentState == 2 )
  {
    ...
    baseDeckObj = LocalizationManager__Get((System_String_o *)StringLiteral_12673/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_CONFIRM_TITLE"*/, 0LL);
    if ( !titleLabel )
      goto LABEL_16;
    UILabel__set_text(titleLabel, baseDeckObj, 0LL);
    messageLabel = this->fields.messageLabel;
    baseDeckObj = LocalizationManager__Get((System_String_o *)StringLiteral_12671/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_CONFIRM_MESSAGE"*/, 0LL);
    if ( !messageLabel )
      goto LABEL_16;
    UILabel__set_text(messageLabel, baseDeckObj, 0LL);
    baseDeckTitleLabel = this->fields.baseDeckTitleLabel;
    baseDeckObj = LocalizationManager__Get((System_String_o *)StringLiteral_12668/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_CONFIRM_BASE_DECK"*/, 0LL);
    ...
    baseDeckObj = LocalizationManager__Get((System_String_o *)StringLiteral_12672/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_CONFIRM_TARGET_DECK"*/, 0LL);
    if ( !targetDeckTitleLabel )
      goto LABEL_16;
    UILabel__set_text(targetDeckTitleLabel, baseDeckObj, 0LL);
    decideButtonLabel = this->fields.decideButtonLabel;
    baseDeckObj = LocalizationManager__Get((System_String_o *)StringLiteral_12670/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_CONFIRM_DECIDE"*/, 0LL);
    if ( !decideButtonLabel
      || (UILabel__set_text(decideButtonLabel, baseDeckObj, 0LL),
          cancelButtonLabel = this->fields.cancelButtonLabel,
          baseDeckObj = LocalizationManager__Get((System_String_o *)StringLiteral_12669/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_CONFIRM_CANCEL"*/, 0LL),
          !cancelButtonLabel)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF9F6F & 1) == 0 )
  {
    sub_1C2E12C(&SupportSelectConfirmCopyMenu_OnClickButtonEvent_TypeInfo, value);
    byte_4BF9F6F = 1;
  }
  onClickButton = this->fields.onClickButton;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A6BDE8;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A6BDA0;
}
