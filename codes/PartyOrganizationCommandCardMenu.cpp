        ...
        const MethodInfo *method)
{
  ...
  v4 = (struct PartyOrganizationConfirmItemDraw_array *)sub_1B71674(PartyOrganizationConfirmItemDraw___TypeInfo, 3LL);
  this->fields.memberObjectList = v4;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.memberObjectList, (int32_t)v4, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  PartyOrganizationCommandCardMenu__Close_31808048(this, 0LL, v2);
}


void __fastcall PartyOrganizationCommandCardMenu__Close_31808048(
        PartyOrganizationCommandCardMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1B99A & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_PartyOrganizationCommandCardMenu_EndClose__, v6);
    byte_4A1B99A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1B99B & 1) == 0 )
  {
    sub_1B715CC(&Method_PartyOrganizationCommandCardMenu_OnClickCancel__, method);
    byte_4A1B99B = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationCommandCardMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B715E4(Method_PartyOrganizationCommandCardMenu_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1B999 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_PartyOrganizationCommandCardMenu_EndOpen__, v10);
    sub_1B715CC(&StringLiteral_10096/*"PARTY_ORGANIZATION_COMMAND_CARD_TITLE"*/, v11);
    sub_1B715CC(&StringLiteral_10095/*"PARTY_ORGANIZATION_COMMAND_CARD_CLOSE"*/, v12);
    byte_4A1B999 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10096/*"PARTY_ORGANIZATION_COMMAND_CARD_TITLE"*/, 0LL);
    if ( !titleLabel
      || (UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL),
          closeLabel = this->fields.closeLabel,
          gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10095/*"PARTY_ORGANIZATION_COMMAND_CARD_CLOSE"*/, 0LL),
          !closeLabel) )
    {
LABEL_13:
    ...
    AtlasManager__SetClassChart_37648204(compatibilitySprite, 0LL);
    this->fields.state = 1;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1B996 & 1) == 0 )
  {
    sub_1B715CC(&PartyOrganizationCommandCardMenu_CallbackFunc_TypeInfo, value);
    byte_4A1B996 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  ...
  v11 = (PartyOrganizationCommandCardMenu_o *)sub_1B71AE8(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19B37C4;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19B377C;
}
