void __fastcall EventRaceBoostEffect___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_42B040F & 1) == 0 )
  {
    sub_B52984(&EventRaceBoostEffect_TypeInfo);
    sub_B52984(&StringLiteral_21845/*"race_boost_effect_{0}"*/);
    sub_B52984(&StringLiteral_6225/*"EventRaceBoostEffect_{0}"*/);
    byte_42B040F = 1;
  }
  static_fields = (BattleServantConfConponent_o *)EventRaceBoostEffect_TypeInfo->static_fields;
  v8 = (System_Int32_array **)StringLiteral_21845/*"race_boost_effect_{0}"*/;
  static_fields->klass = (BattleServantConfConponent_c *)StringLiteral_21845/*"race_boost_effect_{0}"*/;
  sub_B52920(static_fields, v8, v1, v2, v3, v4, v5, v6);
  v9 = EventRaceBoostEffect_TypeInfo->static_fields;
  v10 = (System_Int32_array **)StringLiteral_6225/*"EventRaceBoostEffect_{0}"*/;
  v9->ANIM_NAME = (struct System_String_o *)StringLiteral_6225/*"EventRaceBoostEffect_{0}"*/;
  sub_B52920((BattleServantConfConponent_o *)&v9->ANIM_NAME, v10, v11, v12, v13, v14, v15, v16);
}
...
LABEL_11:
  ...
  {
    if ( max_length != 2 )
      return System_String__Concat_44570600(v4->m_Items[1], (System_String_o *)StringLiteral_16011/*"_"*/, v4->m_Items[2], 0LL);
LABEL_12:
    v8 = sub_B52A88(v4);
    sub_B52A28(v8, 0LL);
  }
...
void __fastcall EventRaceBoostEffect__OnDestroy(EventRaceBoostEffect_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.randvoiceSvt >= 1 )
  {
    ...
    VoiceAssetName_30972712 = ServantVoiceEntity__getVoiceAssetName_30972712(randvoiceSvt, 0LL);
    if ( !v5 )
      sub_B52A5C(VoiceAssetName_30972712, v7);
    SoundManager__ReleaseAudioAssetStorage(v5, VoiceAssetName_30972712, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  System_String_o *VoiceAssetName_30972712; // x21
  ...
  if ( (byte_42B0408 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_SingletonMonoBehaviour_SoundManager__get_Instance__);
    sub_B52984(&Method_EventRaceBoostEffect___c__DisplayClass13_0__SetUpAndPlay_b__0__);
    sub_B52984(&EventRaceBoostEffect___c__DisplayClass13_0_TypeInfo);
    byte_42B0408 = 1;
  }
  v15 = sub_B52A54(EventRaceBoostEffect___c__DisplayClass13_0_TypeInfo);
  ...
  *(_QWORD *)(v15 + 24) = boostEnt;
  ...
  sub_B52920((BattleServantConfConponent_o *)(v15 + 24), (System_Int32_array **)boostEnt, v25, v26, v27, v28, v29, v30);
  *(_QWORD *)(v15 + 48) = callback;
  *(_DWORD *)(v15 + 32) = boostGrade;
  *(_DWORD *)(v15 + 36) = boostPoint;
  *(_DWORD *)(v15 + 40) = itemImgId;
  sub_B52920((BattleServantConfConponent_o *)(v15 + 48), (System_Int32_array **)callback, v31, v32, v33, v34, v35, v36);
  if ( !playVoice )
  {
LABEL_9:
    ...
    sub_B52920((BattleServantConfConponent_o *)&this->fields.randvoiceId, 0LL, v37, v38, v39, v40, v41, v42);
...
LABEL_12:
    sub_B52A5C(v16, v17);
  SoundManager__LoadAudioAssetStorage(v57, VoiceAssetName_30972712, v59, 1, 0LL);
}
...
void __fastcall EventRaceBoostEffect__afterSE(EventRaceBoostEffect_o *this, const MethodInfo *method)
{
  ...
  {
    sub_B52984(&System_Action_TypeInfo);
    sub_B52984(&Method_EventRaceBoostEffect_afterVoice__);
  ...
  if ( !this->fields.destroyedBeforeVoiceStop )
  {
    ...
    else
    {
      ...
      v5 = System_String__Concat_44568316((System_String_o *)StringLiteral_3997/*"ChrVoice_"*/, v4, 0LL);
      ...
      SoundManager__playVoice_23788136(v7, randvoiceId, DEFAULT_VOLUME, v10, 0LL);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0409 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_EventRaceBoostEffect__setupLocal_b__14_0__);
    sub_B52984(&EventRaceBoostEffect_TypeInfo);
    ...
    sub_B52984(&StringLiteral_5719/*"EVENT_RACE_BOOST_COUNT"*/);
    sub_B52984(&StringLiteral_21413/*"onEndAnim"*/);
    byte_42B0409 = 1;
  }
    ...
    if ( v15 )
    {
      ...
      if ( v16 )
      {
        ...
        if ( boostEnt )
        {
          ...
          v20 = System_String__Format(SP_NAME, v19, 0LL);
          UIAtlasBySpriteName = UIAtlas__GetUIAtlasBySpriteName(v17, v20, 0LL);
          ...
          if ( effectSp )
          {
            ...
            while ( 1 )
            {
              ...
              {
                UISprite__set_atlas((UISprite_o *)UIAtlasBySpriteName, v22, 0LL);
                ...
                if ( v26 )
                {
                  ...
                  {
LABEL_84:
                    v50 = sub_B52A88(UIAtlasBySpriteName);
                    sub_B52A28(v50, 0LL);
                  }
                  UIAtlasBySpriteName = (UIAtlas_o *)*((_QWORD *)&v26->obj.klass + v23);
                  if ( UIAtlasBySpriteName )
                  {
                    UISprite__set_spriteName((UISprite_o *)UIAtlasBySpriteName, v20, 0LL);
                    effectSp = this->fields.effectSp;
                    ++v23;
                    if ( effectSp )
                      continue;
            ...
            if ( UnityEngine_Object__op_Inequality(boostItemSp, 0LL, 0LL) )
            {
              ...
              else
              {
                ...
                v29 = AtlasManager__SetItem(v28, itemImgId, 0LL);
              }
              ...
              if ( !UIAtlasBySpriteName )
                goto LABEL_83;
              UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)UIAtlasBySpriteName, v29, 0LL);
            }
            ...
            if ( UnityEngine_Object__op_Inequality(boostCntLb, 0LL, 0LL) )
            {
              ...
              v32 = LocalizationManager__Get((System_String_o *)StringLiteral_5719/*"EVENT_RACE_BOOST_COUNT"*/, 0LL);
              v52 = boostPoint;
              v33 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v52);
              UIAtlasBySpriteName = (UIAtlas_o *)System_String__Format(v32, v33, 0LL);
              if ( !v31 )
                goto LABEL_83;
            ...
            v37 = System_String__Format(ANIM_NAME, v36, 0LL);
            ...
            if ( UIAtlasBySpriteName )
            {
              ...
              if ( UIAtlasBySpriteName )
              {
                v39 = (UnityEngine_Object_o *)UnityEngine_Component__GetComponentInChildren_UIWidget_(
                                                (UnityEngine_Component_o *)UIAtlasBySpriteName,
                ...
                if ( ((unsigned __int8)UIAtlasBySpriteName & 1) != 0 )
                {
                  ...
                  {
                    SimpleAnimation__Play_16625408((SimpleAnimation_o *)ComponentInChildren_UIWidget, v37, 0LL);
                    ...
                    if ( UIAtlasBySpriteName )
                    {
                      ...
                      if ( *(_WORD *)&UIAtlasBySpriteName->klass->_2.bitflags1 )
                      {
                        ...
                        while ( *(p_offset - 1) != SimpleAnimation_State_TypeInfo )
                        {
                          ++v43;
                          p_offset += 2;
                          if ( v43 >= *(unsigned __int16 *)&UIAtlasBySpriteName->klass->_2.bitflags1 )
                            goto LABEL_65;
                        }
                        v45 = (__int64)(&klass->vtable._13_GetSides.method + 2 * *(_DWORD *)p_offset);
                      }
                      else
                      {
LABEL_65:
                        v45 = sub_AEB880(UIAtlasBySpriteName, SimpleAnimation_State_TypeInfo, 13LL, v40);
                      }
                      length = (*(float (__fastcall **)(UIAtlas_o *, _QWORD))v45)(v42, *(_QWORD *)(v45 + 8));
                      goto LABEL_75;
                    }
                  }
                }
                else
                {
                  ...
                  UIAtlasBySpriteName = (UIAtlas_o *)UnityEngine_Object__op_Inequality(v39, 0LL, 0LL);
                  if ( ((unsigned __int8)UIAtlasBySpriteName & 1) == 0 )
                    goto LABEL_76;
                  if ( v39 )
                  {
                    UnityEngine_Animation__Play_51067744((UnityEngine_Animation_o *)v39, v37, 0LL);
...
LABEL_75:
                      UnityEngine_MonoBehaviour__Invoke(
                        ...
                        (System_String_o *)StringLiteral_21413/*"onEndAnim"*/,
                        length,
                        0LL);
LABEL_76:
                      ...
                      {
                        EventRaceBoostEffect__afterSE(this, v48);
                      }
                      else
                      {
                        ...
                        SeManager__PlaySe(Se, 1.0, 0.0, v49, 0, 0LL);
                      }
                      return;
                    }
                  }
...
LABEL_83:
    sub_B52A5C(UIAtlasBySpriteName, boostEnt);
  }
}
