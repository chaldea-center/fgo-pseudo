void __fastcall EventRaceBoostEffect___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B33E23 & 1) == 0 )
  {
    sub_1BD3458(&EventRaceBoostEffect_TypeInfo, v1);
    sub_1BD3458(&StringLiteral_23023/*"race_boost_effect_{0}"*/, v8);
    sub_1BD3458(&StringLiteral_6331/*"EventRaceBoostEffect_{0}"*/, v9);
    byte_4B33E23 = 1;
  }
  EventRaceBoostEffect_TypeInfo->static_fields->SP_NAME = (struct System_String_o *)StringLiteral_23023/*"race_boost_effect_{0}"*/;
  sub_1BD33FC(
    (PartyOrganizationUtility_o *)EventRaceBoostEffect_TypeInfo->static_fields,
    StringLiteral_23023/*"race_boost_effect_{0}"*/,
    v2,
    v3,
    v4,
    v5,
    v6,
    v7);
  v10 = StringLiteral_6331/*"EventRaceBoostEffect_{0}"*/;
  static_fields = EventRaceBoostEffect_TypeInfo->static_fields;
  static_fields->ANIM_NAME = (struct System_String_o *)StringLiteral_6331/*"EventRaceBoostEffect_{0}"*/;
  sub_1BD33FC((PartyOrganizationUtility_o *)&static_fields->ANIM_NAME, v10, v12, v13, v14, v15, v16, v17);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !voiceStr || (this = (EventRaceBoostEffect_o *)System_String__Split(voiceStr, 0x5Fu, 0, 0LL), result = 0, !this) )
    sub_1BD36B4(this, voiceStr);
  if ( !LODWORD(this->fields.m_CancellationTokenSource) )
    sub_1BD36BC(this, voiceStr);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B33E21 & 1) == 0 )
  {
    this = (EventRaceBoostEffect_o *)sub_1BD3458(&StringLiteral_16309/*"_"*/, voiceStr);
    byte_4B33E21 = 1;
  }
...
void __fastcall EventRaceBoostEffect__OnDestroy(EventRaceBoostEffect_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.randvoiceSvt >= 1 )
  {
    ...
    VoiceAssetName_40667708 = ServantVoiceEntity__getVoiceAssetName_40667708(randvoiceSvt, 0LL);
    if ( !v6 )
      sub_1BD36B4(VoiceAssetName_40667708, v8);
    SoundManager__ReleaseAudioAssetStorage(v6, VoiceAssetName_40667708, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B33E1D & 1) == 0 )
  {
    sub_1BD3458(&System_Action_TypeInfo, boostEnt);
    sub_1BD3458(&Method_SingletonMonoBehaviour_SoundManager__get_Instance__, v15);
    sub_1BD3458(&Method_EventRaceBoostEffect___c__DisplayClass13_0__SetUpAndPlay_b__0__, v16);
    sub_1BD3458(&EventRaceBoostEffect___c__DisplayClass13_0_TypeInfo, v17);
    byte_4B33E1D = 1;
  }
  v18 = sub_1BD36A4(EventRaceBoostEffect___c__DisplayClass13_0_TypeInfo);
  ...
  *(_QWORD *)(v18 + 24) = boostEnt;
  ...
  sub_1BD33FC((PartyOrganizationUtility_o *)(v18 + 24), (int64_t)boostEnt, v28, v29, v30, v31, v32, v33);
  *(_QWORD *)(v18 + 48) = callback;
  *(_DWORD *)(v18 + 32) = boostGrade;
  *(_DWORD *)(v18 + 36) = boostPoint;
  *(_DWORD *)(v18 + 40) = itemImgId;
  sub_1BD33FC((PartyOrganizationUtility_o *)(v18 + 48), (int64_t)callback, v34, v35, v36, v37, v38, v39);
  if ( !playVoice )
  {
LABEL_9:
    ...
    sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.randvoiceId, 0LL, (int64_t)v40, v41, v42, v43, v44, v45);
  ...
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.randvoiceId, (int64_t)VoiceId, v51, v52, v53, v54, v55, v56);
...
LABEL_12:
    sub_1BD36B4(v19, v20);
  SoundManager__LoadAudioAssetStorage(v60, VoiceAssetName_40667708, v62, 1, 0LL);
}
...
void __fastcall EventRaceBoostEffect__afterSE(EventRaceBoostEffect_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B33E1F & 1) == 0 )
  {
    ...
    sub_1BD3458(&Method_EventRaceBoostEffect_afterVoice__, v3);
    sub_1BD3458(&SeManager_TypeInfo, v4);
    sub_1BD3458(&SoundManager_TypeInfo, v5);
    sub_1BD3458(&StringLiteral_4540/*"ChrVoice_"*/, v6);
    byte_4B33E1F = 1;
  }
  if ( !this->fields.destroyedBeforeVoiceStop )
  {
    ...
    else
    {
      ...
      v9 = System_String__Concat_62525248((System_String_o *)StringLiteral_4540/*"ChrVoice_"*/, v8, 0LL);
      ...
      if ( !SoundManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(SoundManager_TypeInfo);
      SoundManager__playVoice_39491156(v11, randvoiceId, DEFAULT_VOLUME, v14, 0LL);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  Il2CppObject *ComponentInChildren_object__49447820; // x23
  ...
  if ( (byte_4B33E1E & 1) == 0 )
  {
    ...
    sub_1BD3458(&Method_UnityEngine_Component_GetComponentInChildren_Animation___, v15);
    sub_1BD3458(&Method_UnityEngine_Component_GetComponentInChildren_SimpleAnimation___, v16);
    sub_1BD3458(&Method_EventRaceBoostEffect__setupLocal_b__14_0__, v17);
    sub_1BD3458(&Method_EventRaceBoostEffect_setupLocal__, v18);
    sub_1BD3458(&EventRaceBoostEffect_TypeInfo, v19);
    sub_1BD3458(&int_TypeInfo, v20);
    sub_1BD3458(&LocalizationManager_TypeInfo, v21);
    sub_1BD3458(&UnityEngine_Object_TypeInfo, v22);
    sub_1BD3458(&SimpleAnimation_State_TypeInfo, v23);
    sub_1BD3458(&TerminalSceneComponent_TypeInfo, v24);
    sub_1BD3458(&StringLiteral_5763/*"EVENT_RACE_BOOST_COUNT"*/, v25);
    sub_1BD3458(&StringLiteral_22525/*"onEndAnim"*/, v26);
    byte_4B33E1E = 1;
  }
  if ( this->fields.effectSp )
  {
    ...
    if ( !byte_4B31F06 )
    {
      sub_1BD3458(&TerminalSceneComponent_TypeInfo, boostEnt);
      byte_4B31F06 = 1;
    }
...
LABEL_73:
                    sub_1BD36BC(UIAtlasBySpriteName, boostEnt);
            ...
            if ( UnityEngine_Object__op_Inequality(boostCntLb, 0LL, 0LL) )
            {
              ...
              v51 = LocalizationManager__Get((System_String_o *)StringLiteral_5763/*"EVENT_RACE_BOOST_COUNT"*/, 0LL);
              v74 = boostPoint;
            ...
            if ( UIAtlasBySpriteName )
            {
              ...
              if ( UIAtlasBySpriteName )
              {
                v61 = UnityEngine_Component__GetComponentInChildren_object__49447820(
                        (UnityEngine_Component_o *)UIAtlasBySpriteName,
                ...
                if ( ((unsigned __int8)UIAtlasBySpriteName & 1) != 0 )
                {
                  ...
                  {
                    SimpleAnimation__Play_64663364((SimpleAnimation_o *)ComponentInChildren_object__49447820, v59, 0LL);
                    UIAtlasBySpriteName = (UIAtlas_o *)SimpleAnimation__get_Item(
                                                         (SimpleAnimation_o *)ComponentInChildren_object__49447820,
                                                         v59,
                                                         0LL);
                    if ( UIAtlasBySpriteName )
                    {
                      ...
                      {
LABEL_56:
                        v66 = sub_1C25438(UIAtlasBySpriteName, SimpleAnimation_State_TypeInfo, 13LL);
                      }
                ...
                else
                {
                  ...
                  if ( v61 )
                  {
                    UnityEngine_Animation__Play_70023276((UnityEngine_Animation_o *)v61, v59, 0LL);
...
LABEL_65:
                      UnityEngine_MonoBehaviour__Invoke(
                        ...
                        (System_String_o *)StringLiteral_22525/*"onEndAnim"*/,
                        length,
                        0LL);
LABEL_66:
                      ...
                      else
                      {
                        ...
                        if ( (*((_BYTE *)Method_EventRaceBoostEffect_setupLocal__ + 83) & 2) != 0 )
                          v70 = (_QWORD *)sub_1BD3470(Method_EventRaceBoostEffect_setupLocal__);
                        ...
                        System_Action___ctor(
                          ...
                          0LL);
                        OverwriteAssetSoundName__PlaySe_39393524(v71, Se, 1.0, v72, 0LL);
                      }
                      return;
                    }
                  }
...
LABEL_72:
    sub_1BD36B4(UIAtlasBySpriteName, boostEnt);
  }
}
