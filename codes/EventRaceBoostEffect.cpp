void __fastcall EventRaceBoostEffect___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A2AC8B & 1) == 0 )
  {
    sub_1B761C0(&EventRaceBoostEffect_TypeInfo, v1);
    sub_1B761C0(&StringLiteral_22736/*"race_boost_effect_{0}"*/, v4);
    sub_1B761C0(&StringLiteral_6198/*"EventRaceBoostEffect_{0}"*/, v5);
    byte_4A2AC8B = 1;
  }
  EventRaceBoostEffect_TypeInfo->static_fields->SP_NAME = (struct System_String_o *)StringLiteral_22736/*"race_boost_effect_{0}"*/;
  sub_1B76164(
    (ServantStatusBattleListViewItem_o *)EventRaceBoostEffect_TypeInfo->static_fields,
    StringLiteral_22736/*"race_boost_effect_{0}"*/,
    v2,
    v3);
  v6 = StringLiteral_6198/*"EventRaceBoostEffect_{0}"*/;
  static_fields = EventRaceBoostEffect_TypeInfo->static_fields;
  static_fields->ANIM_NAME = (struct System_String_o *)StringLiteral_6198/*"EventRaceBoostEffect_{0}"*/;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&static_fields->ANIM_NAME, v6, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !voiceStr || (this = (EventRaceBoostEffect_o *)System_String__Split(voiceStr, 0x5Fu, 0, 0LL), result = 0, !this) )
    sub_1B7641C(this, voiceStr);
  if ( !LODWORD(this->fields.m_CancellationTokenSource) )
    sub_1B76424(this, voiceStr);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2AC89 & 1) == 0 )
  {
    this = (EventRaceBoostEffect_o *)sub_1B761C0(&StringLiteral_16117/*"_"*/, voiceStr);
    byte_4A2AC89 = 1;
  }
...
void __fastcall EventRaceBoostEffect__OnDestroy(EventRaceBoostEffect_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.randvoiceSvt >= 1 )
  {
    ...
    VoiceAssetName_39581568 = ServantVoiceEntity__getVoiceAssetName_39581568(randvoiceSvt, 0LL);
    if ( !v6 )
      sub_1B7641C(VoiceAssetName_39581568, v8);
    SoundManager__ReleaseAudioAssetStorage(v6, VoiceAssetName_39581568, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  System_String_o *VoiceAssetName_39581568; // x21
  System_Action_o *v42; // x22

  if ( (byte_4A2AC85 & 1) == 0 )
  {
    sub_1B761C0(&System_Action_TypeInfo, boostEnt);
    sub_1B761C0(&Method_SingletonMonoBehaviour_SoundManager__get_Instance__, v15);
    sub_1B761C0(&Method_EventRaceBoostEffect___c__DisplayClass13_0__SetUpAndPlay_b__0__, v16);
    sub_1B761C0(&EventRaceBoostEffect___c__DisplayClass13_0_TypeInfo, v17);
    byte_4A2AC85 = 1;
  }
  v18 = sub_1B7640C(EventRaceBoostEffect___c__DisplayClass13_0_TypeInfo);
  ...
  *(_QWORD *)(v18 + 24) = boostEnt;
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)(v18 + 24), (int32_t)boostEnt, v24, v25);
  *(_QWORD *)(v18 + 48) = callback;
  *(_DWORD *)(v18 + 32) = boostGrade;
  *(_DWORD *)(v18 + 36) = boostPoint;
  *(_DWORD *)(v18 + 40) = itemImgId;
  sub_1B76164((ServantStatusBattleListViewItem_o *)(v18 + 48), (int32_t)callback, v26, v27);
  if ( !playVoice )
  {
LABEL_9:
    ...
    sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.randvoiceId, 0, (int32_t)v28, v29);
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.randvoiceId, (int32_t)VoiceId, v35, v36);
...
LABEL_12:
    sub_1B7641C(v19, v20);
  SoundManager__LoadAudioAssetStorage(v40, VoiceAssetName_39581568, v42, 1, 0LL);
}
...
void __fastcall EventRaceBoostEffect__afterSE(EventRaceBoostEffect_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2AC87 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_EventRaceBoostEffect_afterVoice__, v3);
  ...
  if ( !this->fields.destroyedBeforeVoiceStop )
  {
    ...
    else
    {
      ...
      v9 = System_String__Concat_61535060((System_String_o *)StringLiteral_4463/*"ChrVoice_"*/, v8, 0LL);
      ...
      if ( !SoundManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(SoundManager_TypeInfo);
      SoundManager__playVoice_38522468(v11, randvoiceId, DEFAULT_VOLUME, v14, 0LL);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  Il2CppObject *ComponentInChildren_object__48599312; // x23
  ...
  if ( (byte_4A2AC86 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_UnityEngine_Component_GetComponentInChildren_Animation___, v14);
    sub_1B761C0(&Method_UnityEngine_Component_GetComponentInChildren_SimpleAnimation___, v15);
    sub_1B761C0(&Method_EventRaceBoostEffect__setupLocal_b__14_0__, v16);
    sub_1B761C0(&Method_EventRaceBoostEffect_setupLocal__, v17);
    sub_1B761C0(&EventRaceBoostEffect_TypeInfo, v18);
    ...
    sub_1B761C0(&StringLiteral_5669/*"EVENT_RACE_BOOST_COUNT"*/, v24);
    sub_1B761C0(&StringLiteral_22243/*"onEndAnim"*/, v25);
    byte_4A2AC86 = 1;
  }
  if ( this->fields.effectSp )
  {
    ...
    if ( !byte_4A2915D )
    {
      sub_1B761C0(&TerminalSceneComponent_TypeInfo, boostEnt);
      byte_4A2915D = 1;
    }
...
LABEL_73:
                    sub_1B76424(UIAtlasBySpriteName, boostEnt);
            ...
            if ( UnityEngine_Object__op_Inequality(boostCntLb, 0LL, 0LL) )
            {
              ...
              v50 = LocalizationManager__Get((System_String_o *)StringLiteral_5669/*"EVENT_RACE_BOOST_COUNT"*/, 0LL);
              v73 = boostPoint;
            ...
            if ( UIAtlasBySpriteName )
            {
              ...
              if ( UIAtlasBySpriteName )
              {
                v60 = UnityEngine_Component__GetComponentInChildren_object__48599312(
                        (UnityEngine_Component_o *)UIAtlasBySpriteName,
                ...
                if ( ((unsigned __int8)UIAtlasBySpriteName & 1) != 0 )
                {
                  ...
                  {
                    SimpleAnimation__Play_63672732((SimpleAnimation_o *)ComponentInChildren_object__48599312, v58, 0LL);
                    UIAtlasBySpriteName = (UIAtlas_o *)SimpleAnimation__get_Item(
                                                         (SimpleAnimation_o *)ComponentInChildren_object__48599312,
                                                         v58,
                                                         0LL);
                    if ( UIAtlasBySpriteName )
                    {
                      ...
                      {
LABEL_56:
                        v65 = sub_1BC81A0(UIAtlasBySpriteName, SimpleAnimation_State_TypeInfo, 13LL);
                      }
                ...
                else
                {
                  ...
                  if ( v60 )
                  {
                    UnityEngine_Animation__Play_69032500((UnityEngine_Animation_o *)v60, v58, 0LL);
...
LABEL_65:
                      UnityEngine_MonoBehaviour__Invoke(
                        ...
                        (System_String_o *)StringLiteral_22243/*"onEndAnim"*/,
                        length,
                        0LL);
LABEL_66:
                      ...
                      else
                      {
                        ...
                        if ( (*((_BYTE *)Method_EventRaceBoostEffect_setupLocal__ + 83) & 2) != 0 )
                          v69 = (_QWORD *)sub_1B761D8(Method_EventRaceBoostEffect_setupLocal__);
                        ...
                        System_Action___ctor(
                          ...
                          0LL);
                        OverwriteAssetSoundName__PlaySe_38351504(v70, Se, 1.0, v71, 0LL);
                      }
                      return;
                    }
                  }
...
LABEL_72:
    sub_1B7641C(UIAtlasBySpriteName, boostEnt);
  }
}
