void SupportSelectMenu___ctor(SupportSelectMenu_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.SUPPORT_EDIT_BUTTON_POSITION_EDTTING.fields.x = xmmword_CF6170;
...
void SupportSelectMenu__Close(SupportSelectMenu_o *this, const MethodInfo *method)
{
  ...
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.supportServantData, 0, v2, v3, v4, v5, v6, v7);
...
void SupportSelectMenu__HideActiveSupportApplyIcon(SupportSelectMenu_o *this, const MethodInfo *method)
{
  ...
  {
LABEL_10:
    sub_1C7BD40(applyMainQuestSupport, method);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)applyMainQuestSupport, 0, 0);
}
...
void SupportSelectMenu__OnClickCancel(SupportSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEAC28 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_SupportSelectMenu_OnClickCancel__);
    byte_4CEAC28 = 1;
  }
  v3 = Method_SupportSelectMenu_OnClickCancel__;
  if ( (*((_BYTE *)Method_SupportSelectMenu_OnClickCancel__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C7BB00(Method_SupportSelectMenu_OnClickCancel__);
...
void SupportSelectMenu__OnClickDeckName(SupportSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEAC27 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_SupportSelectMenu_OnClickDeckName__);
    byte_4CEAC27 = 1;
  }
  v3 = Method_SupportSelectMenu_OnClickDeckName__;
  if ( (*((_BYTE *)Method_SupportSelectMenu_OnClickDeckName__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C7BB00(Method_SupportSelectMenu_OnClickDeckName__);
  v4 = (System_Reflection_MethodBase_o *)sub_1C7BACC(v3, v3[4]);
...
void SupportSelectMenu__OnClickGrandListInfoButton(SupportSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEAC2A & 1) == 0 )
  {
    sub_1C7BAE8(&Method_SupportSelectMenu_OnClickGrandListInfoButton__);
    byte_4CEAC2A = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SupportSelectMenu_OnClickGrandListInfoButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C7BB00(Method_SupportSelectMenu_OnClickGrandListInfoButton__);
  v4 = (System_Reflection_MethodBase_o *)sub_1C7BACC(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
  callbackFunc = this->fields.callbackFunc;
  if ( callbackFunc )
...
void SupportSelectMenu__OnClickSupportEdit(SupportSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEAC25 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_SupportSelectMenu_OnClickSupportEdit__);
    byte_4CEAC25 = 1;
  }
  v3 = Method_SupportSelectMenu_OnClickSupportEdit__;
  if ( (*((_BYTE *)Method_SupportSelectMenu_OnClickSupportEdit__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C7BB00(Method_SupportSelectMenu_OnClickSupportEdit__);
  v4 = (System_Reflection_MethodBase_o *)sub_1C7BACC(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
  callbackFunc = this->fields.callbackFunc;
  if ( callbackFunc )
...
void SupportSelectMenu__OnClickSwap(SupportSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEAC26 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_SupportSelectMenu_OnClickSwap__);
    byte_4CEAC26 = 1;
  }
  v3 = Method_SupportSelectMenu_OnClickSwap__;
  if ( (*((_BYTE *)Method_SupportSelectMenu_OnClickSwap__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C7BB00(Method_SupportSelectMenu_OnClickSwap__);
  v4 = (System_Reflection_MethodBase_o *)sub_1C7BACC(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
  callbackFunc = this->fields.callbackFunc;
  if ( callbackFunc )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEAC24 & 1) == 0 )
  {
    this = (SupportSelectMenu_o *)sub_1C7BAE8(&Method_SupportSelectMenu_OnClickTab__);
    byte_4CEAC24 = 1;
  }
  if ( !idxSprite )
    goto LABEL_8;
  ...
  if ( (*((_BYTE *)Method_SupportSelectMenu_OnClickTab__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1C7BB00(Method_SupportSelectMenu_OnClickTab__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEAC1F & 1) == 0 )
  {
    sub_1C7BAE8(&Method_System_Linq_Enumerable_Count_SupportServantData___);
    byte_4CEAC1F = 1;
  }
  ...
  v28 = System_Linq_Enumerable__Count_object_(
          ...
          (const MethodInfo_318FACC *)Method_System_Linq_Enumerable_Count_SupportServantData___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEAC21 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_20361/*"icon_event_2_{0}"*/);
    sub_1C7BAE8(&StringLiteral_20360/*"icon_event_2"*/);
    sub_1C7BAE8(&StringLiteral_20359/*"icon_event_1_{0}"*/);
    sub_1C7BAE8(&StringLiteral_20358/*"icon_event_1"*/);
    byte_4CEAC21 = 1;
  }
  ...
  else
  {
    if ( !v12 )
      goto LABEL_24;
    v14 = (System_String_o *)StringLiteral_20360/*"icon_event_2"*/;
  }
  ...
  else
  {
    if ( !currentEventQuestSupportSprite )
      goto LABEL_24;
    v17 = (System_String_o *)StringLiteral_20358/*"icon_event_1"*/;
  }
  ...
  {
LABEL_24:
    sub_1C7BD40(currentMainQuestSupportSprite, mainQuestActive);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEAC20 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_SupportSelectMenu___c__SetActiveSupportApplyIcon_b__47_0__);
    sub_1C7BAE8(&Method_SupportSelectMenu___c__SetActiveSupportApplyIcon_b__47_1__);
    sub_1C7BAE8(&SupportSelectMenu___c_TypeInfo);
    byte_4CEAC20 = 1;
  }
  ...
  if ( !_9__47_0 )
  {
    ...
    _9__47_0 = (System_Func_int__bool__o *)sub_1C7BD34(System_Func_int__bool__TypeInfo);
  ...
  if ( !_9__47_1 )
  {
    ...
    _9__47_1 = (System_Func_int__bool__o *)sub_1C7BD34(System_Func_int__bool__TypeInfo);
    ...
    sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&v31->__9__47_1, (int32_t)_9__47_1, v32, v33, v34, v35, v36, v37);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEAC23 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&int_TypeInfo);
    sub_1C7BAE8(&StringLiteral_17695/*"btn_txt_set0_1"*/);
    sub_1C7BAE8(&StringLiteral_17696/*"btn_txt_set{0}_1"*/);
    byte_4CEAC23 = 1;
  }
  ...
  if ( v10 >= 1 )
  {
    if ( !fixDeckIds )
LABEL_27:
      sub_1C7BD40(gameObject, *(_QWORD *)&currentId);
    v11 = 0;
    do
    {
...
LABEL_28:
      ...
      if ( v13 )
      {
        ...
        gameObject = (UnityEngine_Component_o *)System_String__Format((System_String_o *)StringLiteral_17696/*"btn_txt_set{0}_1"*/, v14, 0);
      ...
      {
        v15 = (System_String_o *)StringLiteral_17695/*"btn_txt_set0_1"*/;
        if ( isEventButton )
        {
LABEL_13:
...
void SupportSelectMenu__SetGrandListInfoButton(SupportSelectMenu_o *this, bool active, const MethodInfo *method)
{
  ...
  if ( (byte_4CEAC22 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_17618/*"btn_supportform_grand"*/);
    byte_4CEAC22 = 1;
  }
  ...
  {
    sub_1C7BD40(grandListInfoButton, active);
  }
  ...
  AtlasManager__SetPartyOrganizationImage(grandListInfoButtonSprite, (System_String_o *)StringLiteral_17618/*"btn_supportform_grand"*/, 0);
}
...
void SupportSelectMenu__SetupFooterButtons(SupportSelectMenu_o *this, bool isEditting, const MethodInfo *method)
{
  ...
  {
LABEL_15:
    sub_1C7BD40(helpButton, isEditting);
  }
  v12.fields.x = v9;
  v12.fields.y = v10;
  v12.fields.z = v11;
...
LABEL_38:
    sub_1C7BD40(indexGrid, *(_QWORD *)&deckNum);
  }
  indexGrid = (UnityEngine_Component_o *)this->fields.indicator;
  if ( !indexGrid )
    goto LABEL_38;
...
void SupportSelectMenu__onClickHelpButton(SupportSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEAC29 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_SupportSelectMenu_onClickHelpButton__);
    byte_4CEAC29 = 1;
  }
  v2 = Method_SupportSelectMenu_onClickHelpButton__;
  if ( (*((_BYTE *)Method_SupportSelectMenu_onClickHelpButton__ + 83) & 2) != 0 )
    v2 = (_QWORD *)sub_1C7BB00(Method_SupportSelectMenu_onClickHelpButton__);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1AADF00;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1AADEA0;
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C7BAE8(&int_TypeInfo);
    sub_1C7BAE8(&SupportSelectMenu_ResultKind_TypeInfo);
    byte_4CEAC2C = 1;
  }
  v12 = 0u;
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1AADFA4;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1AADF2C;
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C7BAE8(&int_TypeInfo);
    sub_1C7BAE8(&SupportSelectRootComponent_SwapKind_TypeInfo);
    byte_4CEAC2D = 1;
  }
  v16 = 0u;
  ...
  *(_QWORD *)&v16 = leader2;
  return (System_IAsyncResult_o *)sub_1C7BA9C(this, v15, callback, object);
}
...
void SupportSelectMenu___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C7BD34(SupportSelectMenu___c_TypeInfo);
