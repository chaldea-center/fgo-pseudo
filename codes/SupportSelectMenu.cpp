void __fastcall SupportSelectMenu___ctor(SupportSelectMenu_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.SUPPORT_EDIT_BUTTON_POSITION_EDTTING.fields.x = xmmword_BDED10;
...
void __fastcall SupportSelectMenu__Close(SupportSelectMenu_o *this, const MethodInfo *method)
{
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.supportServantData, 0, v2, v3);
...
void __fastcall SupportSelectMenu__HideActiveSupportApplyIcon(SupportSelectMenu_o *this, const MethodInfo *method)
{
  ...
  {
LABEL_10:
    sub_1BC3264(applyMainQuestSupport, method);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)applyMainQuestSupport, 0, 0LL);
}
...
void __fastcall SupportSelectMenu__OnClickCancel(SupportSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFE6FE & 1) == 0 )
  {
    sub_1BC3008(&Method_SupportSelectMenu_OnClickCancel__, method);
    byte_4AFE6FE = 1;
  }
  v3 = Method_SupportSelectMenu_OnClickCancel__;
  if ( (*((_BYTE *)Method_SupportSelectMenu_OnClickCancel__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1BC3020(Method_SupportSelectMenu_OnClickCancel__);
...
void __fastcall SupportSelectMenu__OnClickDeckName(SupportSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFE6FD & 1) == 0 )
  {
    sub_1BC3008(&Method_SupportSelectMenu_OnClickDeckName__, method);
    byte_4AFE6FD = 1;
  }
  v3 = Method_SupportSelectMenu_OnClickDeckName__;
  if ( (*((_BYTE *)Method_SupportSelectMenu_OnClickDeckName__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1BC3020(Method_SupportSelectMenu_OnClickDeckName__);
  v4 = (System_Reflection_MethodBase_o *)sub_1BC2FEC(v3, v3[4]);
...
void __fastcall SupportSelectMenu__OnClickSupportEdit(SupportSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFE6FB & 1) == 0 )
  {
    sub_1BC3008(&Method_SupportSelectMenu_OnClickSupportEdit__, method);
    byte_4AFE6FB = 1;
  }
  v3 = Method_SupportSelectMenu_OnClickSupportEdit__;
  if ( (*((_BYTE *)Method_SupportSelectMenu_OnClickSupportEdit__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1BC3020(Method_SupportSelectMenu_OnClickSupportEdit__);
  v4 = (System_Reflection_MethodBase_o *)sub_1BC2FEC(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
  callbackFunc = this->fields.callbackFunc;
  if ( callbackFunc )
...
void __fastcall SupportSelectMenu__OnClickSwap(SupportSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFE6FC & 1) == 0 )
  {
    sub_1BC3008(&Method_SupportSelectMenu_OnClickSwap__, method);
    byte_4AFE6FC = 1;
  }
  v3 = Method_SupportSelectMenu_OnClickSwap__;
  if ( (*((_BYTE *)Method_SupportSelectMenu_OnClickSwap__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1BC3020(Method_SupportSelectMenu_OnClickSwap__);
  v4 = (System_Reflection_MethodBase_o *)sub_1BC2FEC(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
  callbackFunc = this->fields.callbackFunc;
  if ( callbackFunc )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFE6FA & 1) == 0 )
  {
    this = (SupportSelectMenu_o *)sub_1BC3008(&Method_SupportSelectMenu_OnClickTab__, idxSprite);
    byte_4AFE6FA = 1;
  }
  if ( !idxSprite )
    goto LABEL_8;
  ...
  if ( (*((_BYTE *)Method_SupportSelectMenu_OnClickTab__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1BC3020(Method_SupportSelectMenu_OnClickTab__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFE6F6 & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Linq_Enumerable_Count_SupportServantData___, supportServantData);
    byte_4AFE6F6 = 1;
  }
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.dragSwapCallbackFunc, (int32_t)dragSwapCallbackFunc, v11, v12);
  p_supportServantData = &this->fields.supportServantData;
  this->fields.supportServantData = supportServantData;
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.supportServantData, (int32_t)supportServantData, v14, v15);
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  if ( !gameObject )
    goto LABEL_20;
  UnityEngine_GameObject__SetActive(gameObject, 1, 0LL);
  v18 = System_Linq_Enumerable__Count_object_(
          ...
          (const MethodInfo_301E214 *)Method_System_Linq_Enumerable_Count_SupportServantData___);
...
LABEL_21:
      sub_1BC326C(gameObject, v17, v22);
    v23 = supportServantData->m_Items[2] != 0LL;
  }
  else
  {
    v23 = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFE6F8 & 1) == 0 )
  {
    sub_1BC3008(&int_TypeInfo, mainQuestActive);
    sub_1BC3008(&StringLiteral_20003/*"icon_event_2_{0}"*/, v11);
    sub_1BC3008(&StringLiteral_20002/*"icon_event_2"*/, v12);
    sub_1BC3008(&StringLiteral_20001/*"icon_event_1_{0}"*/, v13);
    sub_1BC3008(&StringLiteral_20000/*"icon_event_1"*/, v14);
    byte_4AFE6F8 = 1;
  }
  ...
  if ( mainNo )
  {
    ...
    currentMainQuestSupportSprite = (UnityEngine_Component_o *)System_String__Format(
                                                                 (System_String_o *)StringLiteral_20003/*"icon_event_2_{0}"*/,
                                                                 v20,
                                                                 0LL);
    if ( !v19 )
      goto LABEL_24;
  ...
  else
  {
    if ( !v19 )
      goto LABEL_24;
    v21 = (System_String_o *)StringLiteral_20002/*"icon_event_2"*/;
  }
  ...
  if ( eventNo )
  {
    ...
    currentMainQuestSupportSprite = (UnityEngine_Component_o *)System_String__Format(
                                                                 (System_String_o *)StringLiteral_20001/*"icon_event_1_{0}"*/,
                                                                 v26,
                                                                 0LL);
  ...
  else
  {
    if ( !currentEventQuestSupportSprite )
      goto LABEL_24;
    v27 = (System_String_o *)StringLiteral_20000/*"icon_event_1"*/;
  }
  ...
  {
LABEL_24:
    sub_1BC3264(currentMainQuestSupportSprite, mainQuestActive);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFE6F7 & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Array_IndexOf_int___, *(_QWORD *)&nowDeckId);
    sub_1BC3008(&Method_System_Linq_Enumerable_Count_int___, v9);
    sub_1BC3008(&Method_System_Linq_Enumerable_Where_int___, v10);
    sub_1BC3008(&System_Func_int__bool__TypeInfo, v11);
    sub_1BC3008(&Method_SupportSelectMenu___c__SetActiveSupportApplyIcon_b__45_0__, v12);
    sub_1BC3008(&Method_SupportSelectMenu___c__SetActiveSupportApplyIcon_b__45_1__, v13);
    sub_1BC3008(&SupportSelectMenu___c_TypeInfo, v14);
    byte_4AFE6F7 = 1;
  }
  ...
  if ( !_9__45_0 )
  {
    ...
    _9__45_0 = (System_Func_int__bool__o *)sub_1BC3254(System_Func_int__bool__TypeInfo);
    ...
    sub_1BC2FAC((CGThumbnailListItem_o *)&static_fields->__9__45_0, (int32_t)_9__45_0, v21, v22);
  }
  ...
  if ( !_9__45_1 )
  {
    ...
    _9__45_1 = (System_Func_int__bool__o *)sub_1BC3254(System_Func_int__bool__TypeInfo);
    ...
    sub_1BC2FAC((CGThumbnailListItem_o *)&v33->__9__45_1, (int32_t)_9__45_1, v34, v35);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFE6F9 & 1) == 0 )
  {
    sub_1BC3008(&BalanceConfig_TypeInfo, *(_QWORD *)&currentId);
    sub_1BC3008(&int_TypeInfo, v8);
    sub_1BC3008(&StringLiteral_17449/*"btn_txt_set0_1"*/, v9);
    sub_1BC3008(&StringLiteral_17450/*"btn_txt_set{0}_1"*/, v10);
    byte_4AFE6F9 = 1;
  }
  ...
  if ( v13 >= 1 )
  {
    if ( !fixDeckIds )
LABEL_27:
      sub_1BC3264(gameObject, *(_QWORD *)&currentId);
    v14 = 0;
    do
    {
      if ( v14 >= fixDeckIds->max_length )
LABEL_28:
        sub_1BC326C(gameObject, *(_QWORD *)&currentId, isEventButton);
      v15 = (int)v14;
      ...
      if ( v16 )
      {
        ...
        gameObject = System_String__Format((System_String_o *)StringLiteral_17450/*"btn_txt_set{0}_1"*/, v17, 0LL);
        v18 = gameObject;
        if ( isEventButton )
          goto LABEL_13;
      }
      ...
      {
        v18 = (System_String_o *)StringLiteral_17449/*"btn_txt_set0_1"*/;
        if ( isEventButton )
        {
LABEL_13:
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_17:
    sub_1BC3264(helpButton, isEditting);
  }
  v12.fields.x = v9;
  v12.fields.y = v10;
  v12.fields.z = v11;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFE6F1 & 1) == 0 )
  {
    sub_1BC3008(&SupportSelectMenu_CallbackFunc_TypeInfo, value);
    byte_4AFE6F1 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFE6F3 & 1) == 0 )
  {
    sub_1BC3008(&SupportSelectMenu_DragSwapCallbackFunc_TypeInfo, value);
    byte_4AFE6F3 = 1;
  }
  ...
  while ( 1 )
  {
    ...
    v8 = sub_1BFD098(p_dragSwapCallbackFunc, v7, dragSwapCallbackFunc);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFE6F5 & 1) == 0 )
  {
    sub_1BC3008(&BalanceConfig_TypeInfo, *(_QWORD *)&deckNum);
...
LABEL_38:
    sub_1BC3264(indexGrid, *(_QWORD *)&deckNum);
  }
  indexGrid = (UnityEngine_Component_o *)this->fields.indicator;
  if ( !indexGrid )
    goto LABEL_38;
  ...
  for ( j = 0; ; j = index + 1 )
  {
    ...
    if ( j >= *(_DWORD *)(*(_QWORD *)&indexGrid[7].fields.m_CachedPtr + 168LL) )
      break;
...
void __fastcall SupportSelectMenu__onClickHelpButton(SupportSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFE6FF & 1) == 0 )
  {
    sub_1BC3008(&Method_SupportSelectMenu_onClickHelpButton__, method);
    byte_4AFE6FF = 1;
  }
  v2 = Method_SupportSelectMenu_onClickHelpButton__;
  if ( (*((_BYTE *)Method_SupportSelectMenu_onClickHelpButton__ + 83) & 2) != 0 )
    v2 = (_QWORD *)sub_1BC3020(Method_SupportSelectMenu_onClickHelpButton__);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A09E1C;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A09DBC;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFE701 & 1) == 0 )
  {
    ...
    sub_1BC3008(&SupportSelectMenu_ResultKind_TypeInfo, v10);
    byte_4AFE701 = 1;
  }
  v19 = 0u;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A09EC0;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A09E48;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFE702 & 1) == 0 )
  {
    ...
    sub_1BC3008(&SupportSelectRootComponent_SwapKind_TypeInfo, v14);
    byte_4AFE702 = 1;
  }
  v23 = 0u;
  ...
  *(_QWORD *)&v23 = leader2;
  return (System_IAsyncResult_o *)sub_1BC2FBC(this, v22, callback, object);
}
...
void __fastcall SupportSelectMenu___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AFE703 & 1) == 0 )
  {
    sub_1BC3008(&SupportSelectMenu___c_TypeInfo, v1);
    byte_4AFE703 = 1;
  }
  v2 = (Il2CppObject *)sub_1BC3254(SupportSelectMenu___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  SupportSelectMenu___c_TypeInfo->static_fields->__9 = (struct SupportSelectMenu___c_o *)v2;
  sub_1BC2FAC((CGThumbnailListItem_o *)SupportSelectMenu___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
