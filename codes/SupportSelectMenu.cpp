void __fastcall SupportSelectMenu___ctor(SupportSelectMenu_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.SUPPORT_EDIT_BUTTON_POSITION_EDTTING.fields.x = xmmword_BEB3C0;
...
void __fastcall SupportSelectMenu__HideActiveSupportApplyIcon(SupportSelectMenu_o *this, const MethodInfo *method)
{
  ...
  {
LABEL_10:
    sub_1BDBAD4(applyMainQuestSupport, method);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)applyMainQuestSupport, 0, 0LL);
}
...
void __fastcall SupportSelectMenu__OnClickCancel(SupportSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B4118C & 1) == 0 )
  {
    sub_1BDB878(&Method_SupportSelectMenu_OnClickCancel__, method);
    byte_4B4118C = 1;
  }
  v3 = Method_SupportSelectMenu_OnClickCancel__;
  if ( (*((_BYTE *)Method_SupportSelectMenu_OnClickCancel__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1BDB890(Method_SupportSelectMenu_OnClickCancel__);
...
void __fastcall SupportSelectMenu__OnClickDeckName(SupportSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B4118B & 1) == 0 )
  {
    sub_1BDB878(&Method_SupportSelectMenu_OnClickDeckName__, method);
    byte_4B4118B = 1;
  }
  v3 = Method_SupportSelectMenu_OnClickDeckName__;
  if ( (*((_BYTE *)Method_SupportSelectMenu_OnClickDeckName__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1BDB890(Method_SupportSelectMenu_OnClickDeckName__);
  v4 = (System_Reflection_MethodBase_o *)sub_1BDB85C(v3, v3[4]);
...
void __fastcall SupportSelectMenu__OnClickSupportEdit(SupportSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B41189 & 1) == 0 )
  {
    sub_1BDB878(&Method_SupportSelectMenu_OnClickSupportEdit__, method);
    byte_4B41189 = 1;
  }
  v3 = Method_SupportSelectMenu_OnClickSupportEdit__;
  if ( (*((_BYTE *)Method_SupportSelectMenu_OnClickSupportEdit__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1BDB890(Method_SupportSelectMenu_OnClickSupportEdit__);
  v4 = (System_Reflection_MethodBase_o *)sub_1BDB85C(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
  callbackFunc = this->fields.callbackFunc;
  if ( callbackFunc )
...
void __fastcall SupportSelectMenu__OnClickSwap(SupportSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B4118A & 1) == 0 )
  {
    sub_1BDB878(&Method_SupportSelectMenu_OnClickSwap__, method);
    byte_4B4118A = 1;
  }
  v3 = Method_SupportSelectMenu_OnClickSwap__;
  if ( (*((_BYTE *)Method_SupportSelectMenu_OnClickSwap__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1BDB890(Method_SupportSelectMenu_OnClickSwap__);
  v4 = (System_Reflection_MethodBase_o *)sub_1BDB85C(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
  callbackFunc = this->fields.callbackFunc;
  if ( callbackFunc )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B41188 & 1) == 0 )
  {
    this = (SupportSelectMenu_o *)sub_1BDB878(&Method_SupportSelectMenu_OnClickTab__, idxSprite);
    byte_4B41188 = 1;
  }
  if ( !idxSprite )
    goto LABEL_8;
  ...
  if ( (*((_BYTE *)Method_SupportSelectMenu_OnClickTab__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1BDB890(Method_SupportSelectMenu_OnClickTab__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B41184 & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Linq_Enumerable_Count_SupportServantData___, supportServantData);
    byte_4B41184 = 1;
  }
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.dragSwapCallbackFunc, (int32_t)dragSwapCallbackFunc, v11, v12);
  p_supportServantData = &this->fields.supportServantData;
  this->fields.supportServantData = supportServantData;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.supportServantData, (int32_t)supportServantData, v14, v15);
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  if ( !gameObject )
    goto LABEL_20;
  UnityEngine_GameObject__SetActive(gameObject, 1, 0LL);
  v18 = System_Linq_Enumerable__Count_object_(
          ...
          (const MethodInfo_304FE28 *)Method_System_Linq_Enumerable_Count_SupportServantData___);
...
LABEL_21:
      sub_1BDBADC(gameObject, v17, v22);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B41186 & 1) == 0 )
  {
    sub_1BDB878(&int_TypeInfo, mainQuestActive);
    sub_1BDB878(&StringLiteral_20215/*"icon_event_2_{0}"*/, v11);
    sub_1BDB878(&StringLiteral_20214/*"icon_event_2"*/, v12);
    sub_1BDB878(&StringLiteral_20213/*"icon_event_1_{0}"*/, v13);
    sub_1BDB878(&StringLiteral_20212/*"icon_event_1"*/, v14);
    byte_4B41186 = 1;
  }
  ...
  else
  {
    if ( !v19 )
      goto LABEL_24;
    v21 = (System_String_o *)StringLiteral_20214/*"icon_event_2"*/;
  }
  ...
  else
  {
    if ( !currentEventQuestSupportSprite )
      goto LABEL_24;
    v27 = (System_String_o *)StringLiteral_20212/*"icon_event_1"*/;
  }
  ...
  {
LABEL_24:
    sub_1BDBAD4(currentMainQuestSupportSprite, mainQuestActive);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B41185 & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Array_IndexOf_int___, *(_QWORD *)&nowDeckId);
    ...
    sub_1BDB878(&Method_SupportSelectMenu___c__SetActiveSupportApplyIcon_b__45_0__, v12);
    sub_1BDB878(&Method_SupportSelectMenu___c__SetActiveSupportApplyIcon_b__45_1__, v13);
    sub_1BDB878(&SupportSelectMenu___c_TypeInfo, v14);
    byte_4B41185 = 1;
  }
  ...
  if ( !_9__45_0 )
  {
    ...
    _9__45_0 = (System_Func_int__bool__o *)sub_1BDBAC4(System_Func_int__bool__TypeInfo);
    ...
    sub_1BDB81C((CGThumbnailListItem_o *)&static_fields->__9__45_0, (int32_t)_9__45_0, v21, v22);
  }
  ...
  if ( !_9__45_1 )
  {
    ...
    _9__45_1 = (System_Func_int__bool__o *)sub_1BDBAC4(System_Func_int__bool__TypeInfo);
    ...
    sub_1BDB81C((CGThumbnailListItem_o *)&v33->__9__45_1, (int32_t)_9__45_1, v34, v35);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B41187 & 1) == 0 )
  {
    sub_1BDB878(&BalanceConfig_TypeInfo, *(_QWORD *)&currentId);
    sub_1BDB878(&int_TypeInfo, v8);
    sub_1BDB878(&StringLiteral_17617/*"btn_txt_set0_1"*/, v9);
    sub_1BDB878(&StringLiteral_17618/*"btn_txt_set{0}_1"*/, v10);
    byte_4B41187 = 1;
  }
  ...
  if ( v13 >= 1 )
  {
    if ( !fixDeckIds )
LABEL_27:
      sub_1BDBAD4(gameObject, *(_QWORD *)&currentId);
    v14 = 0;
    do
    {
      if ( v14 >= fixDeckIds->max_length )
LABEL_28:
        sub_1BDBADC(gameObject, *(_QWORD *)&currentId, isEventButton);
      v15 = (int)v14;
      ...
      if ( v16 )
      {
        ...
        gameObject = System_String__Format((System_String_o *)StringLiteral_17618/*"btn_txt_set{0}_1"*/, v17, 0LL);
        v18 = gameObject;
        if ( isEventButton )
          goto LABEL_13;
      }
      ...
      {
        v18 = (System_String_o *)StringLiteral_17617/*"btn_txt_set0_1"*/;
        if ( isEventButton )
        {
LABEL_13:
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_17:
    sub_1BDBAD4(helpButton, isEditting);
  }
  v12.fields.x = v9;
  v12.fields.y = v10;
  v12.fields.z = v11;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B41181 & 1) == 0 )
  {
    sub_1BDB878(&SupportSelectMenu_DragSwapCallbackFunc_TypeInfo, value);
    byte_4B41181 = 1;
  }
  ...
  while ( 1 )
  {
    ...
    v8 = sub_1C15B34(p_dragSwapCallbackFunc, v7, dragSwapCallbackFunc);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B41183 & 1) == 0 )
  {
    sub_1BDB878(&BalanceConfig_TypeInfo, *(_QWORD *)&deckNum);
...
LABEL_38:
    sub_1BDBAD4(indexGrid, *(_QWORD *)&deckNum);
  }
  indexGrid = (UnityEngine_Component_o *)this->fields.indicator;
  if ( !indexGrid )
    goto LABEL_38;
...
void __fastcall SupportSelectMenu__onClickHelpButton(SupportSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B4118D & 1) == 0 )
  {
    sub_1BDB878(&Method_SupportSelectMenu_onClickHelpButton__, method);
    byte_4B4118D = 1;
  }
  v2 = Method_SupportSelectMenu_onClickHelpButton__;
  if ( (*((_BYTE *)Method_SupportSelectMenu_onClickHelpButton__ + 83) & 2) != 0 )
    v2 = (_QWORD *)sub_1BDB890(Method_SupportSelectMenu_onClickHelpButton__);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A218DC;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A2187C;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4118F & 1) == 0 )
  {
    ...
    sub_1BDB878(&SupportSelectMenu_ResultKind_TypeInfo, v10);
    byte_4B4118F = 1;
  }
  v19 = 0u;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A21980;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A21908;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B41190 & 1) == 0 )
  {
    ...
    sub_1BDB878(&SupportSelectRootComponent_SwapKind_TypeInfo, v14);
    byte_4B41190 = 1;
  }
  v23 = 0u;
  ...
  *(_QWORD *)&v23 = leader2;
  return (System_IAsyncResult_o *)sub_1BDB82C(this, v22, callback, object);
}
...
void __fastcall SupportSelectMenu___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B41191 & 1) == 0 )
  {
    sub_1BDB878(&SupportSelectMenu___c_TypeInfo, v1);
    byte_4B41191 = 1;
  }
  v2 = (Il2CppObject *)sub_1BDBAC4(SupportSelectMenu___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  SupportSelectMenu___c_TypeInfo->static_fields->__9 = (struct SupportSelectMenu___c_o *)v2;
  sub_1BDB81C((CGThumbnailListItem_o *)SupportSelectMenu___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
