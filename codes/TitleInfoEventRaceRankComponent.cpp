void TitleInfoEventRaceRankComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CECF8A & 1) == 0 )
  {
    sub_1C7BAE8(&TitleInfoEventRaceRankComponent_TypeInfo);
    byte_4CECF8A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CECF87 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_System_Collections_Generic_List_EventRaceMaster_GroupRankData__get_Item__);
    ...
    sub_1C7BAE8(&TitleInfoEventRaceRankComponent_TypeInfo);
    sub_1C7BAE8(&StringLiteral_23148/*"race_status_goal_"*/);
    sub_1C7BAE8(&StringLiteral_16165/*"_"*/);
    sub_1C7BAE8(&StringLiteral_23149/*"race_status_rank_"*/);
    sub_1C7BAE8(&StringLiteral_23147/*"race_status_"*/);
    sub_1C7BAE8(&StringLiteral_1124/*"000"*/);
    byte_4CECF87 = 1;
  }
...
LABEL_122:
  ...
  if ( !Instance
    ...
    || (GroupIdData = EventRaceMaster__getGroupIdData((EventRaceMaster_o *)Instance, eventIda, termId, 0),
        v30 = (System_Collections_Generic_List_bool__o *)sub_1C7BD34(System_Collections_Generic_List_bool__TypeInfo),
...
LABEL_120:
  ...
  if ( GroupIdData->fields._size >= 1 )
  {
    ...
    do
    {
      ...
      System_Collections_Generic_List_EventRaceMaster_GroupRankData___get_Item(
        ...
        GroupIdData,
        v31,
        (const MethodInfo_38E26B4 *)Method_System_Collections_Generic_List_EventRaceMaster_GroupRankData__get_Item__);
      ...
      if ( (unsigned int)v36 >= LODWORD(v34->max_length) )
      {
        System_Collections_Generic_List_bool___AddWithResize(
          v30,
          Instance & 1,
          *(const MethodInfo_37F8A1C **)(*(_QWORD *)(v35[4] + 192LL) + 112LL));
      }
      else
      {
  ...
  while ( 1 )
  {
    ...
    if ( GroupIdData->fields._size <= (signed int)v41 )
    {
      ...
      v52 = System_String__Concat_64215176(
              (System_String_o *)StringLiteral_23147/*"race_status_"*/,
              v51,
              (System_String_o *)StringLiteral_1124/*"000"*/,
              0);
    ...
    else
    {
      ...
      v47 = System_String__Concat_64176912((System_String_o *)StringLiteral_23147/*"race_status_"*/, v46, 0);
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
...
LABEL_80:
  ...
  while ( 1 )
  {
    ...
    v60 = System_String__Concat_64215176(
            (System_String_o *)StringLiteral_23147/*"race_status_"*/,
            v59,
            (System_String_o *)StringLiteral_1124/*"000"*/,
            0);
  ...
  while ( 1 )
  {
    ...
    v68 = System_String__Concat_64217180(
            (System_String_o *)StringLiteral_23149/*"race_status_rank_"*/,
            v66,
  ...
  while ( 1 )
  {
    ...
    v74 = System_String__Concat_64176912((System_String_o *)StringLiteral_23148/*"race_status_goal_"*/, v73, 0);
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
