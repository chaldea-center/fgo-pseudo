        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D28B94 & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_12508/*"SUMMON_LIST_DIALOG_SUMMONED_TEXT"*/);
    byte_4D28B94 = 1;
  }
  ...
  if ( isSummoned )
  {
    ...
    Component_object = (UIAtlas_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12508/*"SUMMON_LIST_DIALOG_SUMMONED_TEXT"*/, 0);
    if ( summonedLabel )
    {
