        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B189C0 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_UnityEngine_GameObject_GetComponent_UIAtlas___, *(_QWORD *)&moveIndex);
    sub_1BCAFF8(&LocalizationManager_TypeInfo, v13);
    sub_1BCAFF8(&UnityEngine_Object_TypeInfo, v14);
    sub_1BCAFF8(&StringLiteral_1/*""*/, v15);
    sub_1BCAFF8(&StringLiteral_12348/*"SUMMON_LIST_DIALOG_SUMMONED_TEXT"*/, v16);
    byte_4B189C0 = 1;
  }
  ...
  if ( isSummoned )
  {
    ...
    Component_object = (UIAtlas_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12348/*"SUMMON_LIST_DIALOG_SUMMONED_TEXT"*/, 0LL);
    if ( summonedLabel )
    {
...
LABEL_16:
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.onClickAction, (int32_t)onClickAction, v20, v21);
}