...
System_String_o *__fastcall UserBoxGachaEntity__CreatePK(int64_t userId, int32_t boxGachaId, const MethodInfo *method)
{
  if ( (byte_4C22BC3 & 1) == 0 )
  {
    sub_1C3B764(&Method_DataEntityBase_CreateMultiplePK_long__int___, *(_QWORD *)&boxGachaId);
    byte_4C22BC3 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C22BC2 & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_23352/*"superBoss"*/, v11);
    byte_4C22BC2 = 1;
  }
  ...
  if ( !script
    || !System_Collections_Generic_Dictionary_object__object___ContainsKey(
          ...
          (Il2CppObject *)StringLiteral_23352/*"superBoss"*/,
