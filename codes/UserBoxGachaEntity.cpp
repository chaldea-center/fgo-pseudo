...
System_String_o *__fastcall UserBoxGachaEntity__CreatePK(int64_t userId, int32_t boxGachaId, const MethodInfo *method)
{
  if ( (byte_4BC86CA & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataEntityBase_CreateMultiplePK_long__int___, *(_QWORD *)&boxGachaId);
    byte_4BC86CA = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC86C9 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_23272/*"replaceGiftIdList"*/, v11);
    byte_4BC86C9 = 1;
  }
  ...
  if ( !script
    || !System_Collections_Generic_Dictionary_object__object___ContainsKey(
          ...
          (Il2CppObject *)StringLiteral_23272/*"replaceGiftIdList"*/,
