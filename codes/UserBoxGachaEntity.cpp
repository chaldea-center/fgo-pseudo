...
System_String_o *__fastcall UserBoxGachaEntity__CreatePK(int64_t userId, int32_t boxGachaId, const MethodInfo *method)
{
  if ( (byte_4AB6917 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataEntityBase_CreateMultiplePK_long__int___, *(_QWORD *)&boxGachaId);
    byte_4AB6917 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB6916 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_22913/*"replaceGiftIdList"*/, v11);
    byte_4AB6916 = 1;
  }
  ...
  if ( !script
    || !System_Collections_Generic_Dictionary_object__object___ContainsKey(
          ...
          (Il2CppObject *)StringLiteral_22913/*"replaceGiftIdList"*/,
