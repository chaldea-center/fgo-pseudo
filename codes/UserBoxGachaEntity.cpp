...
System_String_o *__fastcall UserBoxGachaEntity__CreatePK(int64_t userId, int32_t boxGachaId, const MethodInfo *method)
{
  if ( (byte_4BFE39E & 1) == 0 )
  {
    sub_1C2E12C(&Method_DataEntityBase_CreateMultiplePK_long__int___, *(_QWORD *)&boxGachaId);
    byte_4BFE39E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFE39D & 1) == 0 )
  {
    ...
    sub_1C2E12C(&StringLiteral_23310/*"replaceGiftIdList"*/, v11);
    byte_4BFE39D = 1;
  }
  ...
  if ( !script
    || !System_Collections_Generic_Dictionary_object__object___ContainsKey(
          ...
          (Il2CppObject *)StringLiteral_23310/*"replaceGiftIdList"*/,
