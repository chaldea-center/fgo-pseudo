...
System_String_o *__fastcall UserBoxGachaEntity__CreatePK(int64_t userId, int32_t boxGachaId, const MethodInfo *method)
{
  if ( (byte_4A0971F & 1) == 0 )
  {
    sub_1B686D4(&Method_DataEntityBase_CreateMultiplePK_long__int___, *(_QWORD *)&boxGachaId);
    byte_4A0971F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0971E & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_22797/*"replaceGiftIdList"*/, v11);
    byte_4A0971E = 1;
  }
  ...
  if ( !script
    || !System_Collections_Generic_Dictionary_object__object___ContainsKey(
          ...
          (Il2CppObject *)StringLiteral_22797/*"replaceGiftIdList"*/,
