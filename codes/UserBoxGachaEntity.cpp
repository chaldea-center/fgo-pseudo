...
System_String_o *__fastcall UserBoxGachaEntity__CreatePK(int64_t userId, int32_t boxGachaId, const MethodInfo *method)
{
  if ( (byte_4B02D0A & 1) == 0 )
  {
    sub_1BC3008(&Method_DataEntityBase_CreateMultiplePK_long__int___, *(_QWORD *)&boxGachaId);
    byte_4B02D0A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B02D09 & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_22822/*"replaceGiftIdList"*/, v11);
    byte_4B02D09 = 1;
  }
  ...
  if ( !script
    || !System_Collections_Generic_Dictionary_object__object___ContainsKey(
          ...
          (Il2CppObject *)StringLiteral_22822/*"replaceGiftIdList"*/,
