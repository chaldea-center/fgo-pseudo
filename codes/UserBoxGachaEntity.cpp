...
System_String_o *__fastcall UserBoxGachaEntity__CreatePK(int64_t userId, int32_t boxGachaId, const MethodInfo *method)
{
  if ( (byte_49BBAF1 & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataEntityBase_CreateMultiplePK_long__int___, *(_QWORD *)&boxGachaId);
    byte_49BBAF1 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BBAF0 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_22599/*"replaceGiftIdList"*/, v11);
    byte_49BBAF0 = 1;
  }
  ...
  if ( !script
    || !System_Collections_Generic_Dictionary_object__object___ContainsKey(
          ...
          (Il2CppObject *)StringLiteral_22599/*"replaceGiftIdList"*/,
