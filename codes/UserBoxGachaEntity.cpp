...
System_String_o *__fastcall UserBoxGachaEntity__CreatePK(int64_t userId, int32_t boxGachaId, const MethodInfo *method)
{
  if ( (byte_4BB52ED & 1) == 0 )
  {
    sub_1C13D24(&Method_DataEntityBase_CreateMultiplePK_long__int___, *(_QWORD *)&boxGachaId);
    byte_4BB52ED = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB52EC & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_23252/*"remindDialogMessage_{0}_{1}"*/, v11);
    byte_4BB52EC = 1;
  }
  ...
  if ( !script
    || !System_Collections_Generic_Dictionary_object__object___ContainsKey(
          ...
          (Il2CppObject *)StringLiteral_23252/*"remindDialogMessage_{0}_{1}"*/,
