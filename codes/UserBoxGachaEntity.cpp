...
System_String_o *__fastcall UserBoxGachaEntity__CreatePK(int64_t userId, int32_t boxGachaId, const MethodInfo *method)
{
  if ( (byte_4A70A24 & 1) == 0 )
  {
    sub_1B90010(&Method_DataEntityBase_CreateMultiplePK_long__int___, *(_QWORD *)&boxGachaId);
    byte_4A70A24 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A70A23 & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_22908/*"replaceGiftIdList"*/, v11);
    byte_4A70A23 = 1;
  }
  ...
  if ( !script
    || !System_Collections_Generic_Dictionary_object__object___ContainsKey(
          ...
          (Il2CppObject *)StringLiteral_22908/*"replaceGiftIdList"*/,
