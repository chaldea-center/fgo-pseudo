...
System_String_o *__fastcall UserBoxGachaEntity__CreatePK(int64_t userId, int32_t boxGachaId, const MethodInfo *method)
{
  if ( (byte_4B4575D & 1) == 0 )
  {
    sub_1BDB878(&Method_DataEntityBase_CreateMultiplePK_long__int___, *(_QWORD *)&boxGachaId);
    byte_4B4575D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4575C & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_23069/*"replaceGiftIdList"*/, v11);
    byte_4B4575C = 1;
  }
  ...
  if ( !script
    || !System_Collections_Generic_Dictionary_object__object___ContainsKey(
          ...
          (Il2CppObject *)StringLiteral_23069/*"replaceGiftIdList"*/,
