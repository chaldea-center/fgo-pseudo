...
void __fastcall SelectTreasureDeviceInfo___ctor_40728508(
        ...
        const MethodInfo *method)
{
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.treasureDevices, (int32_t)inputTdChangeParam, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B01B7B & 1) == 0 )
  {
    sub_1BC3008(&System_Action_SelectTreasureDeviceInfo_TdChangeParam__TypeInfo, method);
    sub_1BC3008(&Method_BasicHelper_ForEach_SelectTreasureDeviceInfo_TdChangeParam___, v3);
    sub_1BC3008(&Method_SelectTreasureDeviceInfo___c__DisplayClass15_0__AssignTdIndexAutomatically_b__0__, v4);
    sub_1BC3008(&SelectTreasureDeviceInfo___c__DisplayClass15_0_TypeInfo, v5);
    byte_4B01B7B = 1;
  }
  v6 = sub_1BC3254(SelectTreasureDeviceInfo___c__DisplayClass15_0_TypeInfo);
  ...
  if ( !IsNullOrEmpty )
  {
    ...
    *(_DWORD *)(v6 + 16) = 1;
    ...
    v10 = (System_Action_object__o *)sub_1BC3254(System_Action_SelectTreasureDeviceInfo_TdChangeParam__TypeInfo);
    ...
    BasicHelper__ForEach_object_(
      ...
      (const MethodInfo_2FEDEFC *)Method_BasicHelper_ForEach_SelectTreasureDeviceInfo_TdChangeParam___);
  }
}
...
void __fastcall SelectTreasureDeviceInfo_TdChangeParam___ctor_40728928(
        SelectTreasureDeviceInfo_TdChangeParam_o *this,
        int32_t inputId,
        int32_t inputType,
        int32_t tdIndex,
        ...
        const MethodInfo *method)
{
  ...
  *(&v10[-1].fields._TdIndex_k__BackingField + 1) = inputType;
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)v10, (int32_t)inputMessage, v11, v12);
}
