        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B38A1D & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_18244/*"code"*/, code);
    byte_4B38A1D = 1;
  }
  RequestBase__addField_41965080((RequestBase_o *)this, (System_String_o *)StringLiteral_18244/*"code"*/, code, v3);
...
System_String_o *__fastcall CodeInputRequest__getURL(CodeInputRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B38A1B & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_18245/*"code/input"*/, v2);
    byte_4B38A1B = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62525248(BaseUrl, (System_String_o *)StringLiteral_18245/*"code/input"*/, 0LL);
}
