        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17A4E & 1) == 0 )
  {
    sub_1BCA7E0(&StringLiteral_18217/*"code"*/, code, method);
    byte_4B17A4E = 1;
  }
  RequestBase__addField_41862348((RequestBase_o *)this, (System_String_o *)StringLiteral_18217/*"code"*/, code, v3);
...
System_String_o *__fastcall CodeInputRequest__getURL(CodeInputRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B17A4C & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&StringLiteral_18218/*"code/input"*/, v3, v4);
    byte_4B17A4C = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62401220(BaseUrl, (System_String_o *)StringLiteral_18218/*"code/input"*/, 0LL);
}
