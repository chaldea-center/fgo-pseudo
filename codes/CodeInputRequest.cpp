        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3E97 & 1) == 0 )
  {
    sub_1B00CCC(&StringLiteral_17789/*"code"*/, code);
    byte_48E3E97 = 1;
  }
  RequestBase__addField_39752868((RequestBase_o *)this, (System_String_o *)StringLiteral_17789/*"code"*/, code, v3);
...
System_String_o *__fastcall CodeInputRequest__getURL(CodeInputRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E3E95 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_17790/*"code/input"*/, v2);
    byte_48E3E95 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_60325748(BaseUrl, (System_String_o *)StringLiteral_17790/*"code/input"*/, 0LL);
}
