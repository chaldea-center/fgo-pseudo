        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB7586 & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_18065/*"code"*/, code);
    byte_4AB7586 = 1;
  }
  RequestBase__addField_41516464((RequestBase_o *)this, (System_String_o *)StringLiteral_18065/*"code"*/, code, v3);
...
System_String_o *__fastcall CodeInputRequest__getURL(CodeInputRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB7584 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_18066/*"code/input"*/, v2);
    byte_4AB7584 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62048128(BaseUrl, (System_String_o *)StringLiteral_18066/*"code/input"*/, 0LL);
}
