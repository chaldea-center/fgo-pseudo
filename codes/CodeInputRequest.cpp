        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A716A4 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_18061/*"code"*/, code);
    byte_4A716A4 = 1;
  }
  RequestBase__addField_41181164((RequestBase_o *)this, (System_String_o *)StringLiteral_18061/*"code"*/, code, v3);
...
System_String_o *__fastcall CodeInputRequest__getURL(CodeInputRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A716A2 & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_18062/*"code/input"*/, v2);
    byte_4A716A2 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61787092(BaseUrl, (System_String_o *)StringLiteral_18062/*"code/input"*/, 0LL);
}
