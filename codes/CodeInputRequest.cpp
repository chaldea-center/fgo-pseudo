        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6846C & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_18268/*"code"*/, code);
    byte_4B6846C = 1;
  }
  RequestBase__addField_42104408((RequestBase_o *)this, (System_String_o *)StringLiteral_18268/*"code"*/, code, v3);
...
System_String_o *__fastcall CodeInputRequest__getURL(CodeInputRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6846A & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_18269/*"code/input"*/, v2);
    byte_4B6846A = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62698808(BaseUrl, (System_String_o *)StringLiteral_18269/*"code/input"*/, 0LL);
}
