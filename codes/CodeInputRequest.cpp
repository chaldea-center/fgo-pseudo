        ...
        const MethodInfo *method)
{
  ...
  RequestBase__addField_32020920((RequestBase_o *)this, (System_String_o *)StringLiteral_17612/*"code"*/, code, 0LL);
...
System_String_o *__fastcall CodeInputRequest__getURL(CodeInputRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B07CE & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_17613/*"code/input"*/);
    byte_42B07CE = 1;
  }
  ...
  return System_String__Concat_44568316(BaseUrl, (System_String_o *)StringLiteral_17613/*"code/input"*/, 0LL);
}
