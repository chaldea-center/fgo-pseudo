        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EA915 & 1) == 0 )
  {
    sub_B5D5C4(&StringLiteral_17706/*"code"*/, (_DWORD)code, (_DWORD)method, v3);
    byte_42EA915 = 1;
  }
  RequestBase__addField_32362260((RequestBase_o *)this, (System_String_o *)StringLiteral_17706/*"code"*/, code, 0LL);
...
System_String_o *__fastcall CodeInputRequest__getURL(CodeInputRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42EA913 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&StringLiteral_17707/*"code/input"*/, v4, v5, v6);
    byte_42EA913 = 1;
  }
  ...
  return System_String__Concat_44577788(BaseUrl, (System_String_o *)StringLiteral_17707/*"code/input"*/, 0LL);
}
