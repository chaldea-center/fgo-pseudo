        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A00581 & 1) == 0 )
  {
    sub_1B64870(&System_Action_CompensateArgForShowAll_EffectType__TypeInfo, perf);
    sub_1B64870(&Method_BasicHelper_ForEach_CompensateArgForShowAll_EffectType___, v11);
    sub_1B64870(&Method_BitValue_CompensateArgForShowAll_EffectType___ctor__, v12);
    sub_1B64870(&BitValue_CompensateArgForShowAll_EffectType__TypeInfo, v13);
    sub_1B64870(&Method_CompensateArgForShowAll___ctor_b__13_1__, v14);
    sub_1B64870(&System_Func_CompensateArgForShowAll_EffectType__int__TypeInfo, v15);
    sub_1B64870(&Method_CompensateArgForShowAll___c___ctor_b__13_0__, v16);
    sub_1B64870(&CompensateArgForShowAll___c_TypeInfo, v17);
    byte_4A00581 = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
  this->fields._Perf_k__BackingField = perf;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)perf, v18, v19);
  this->fields._ActObj_k__BackingField = actObj;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields._ActObj_k__BackingField, (int32_t)actObj, v20, v21);
  ...
  if ( !_9__13_0 )
  {
    ...
    _9__13_0 = (System_Func_T__TResult__o *)sub_1B64ABC(System_Func_CompensateArgForShowAll_EffectType__int__TypeInfo);
    ...
    sub_1B64814((ServantStatusBattleListViewItem_o *)&static_fields->__9__13_0, (int32_t)_9__13_0, v26, v27);
  }
  v28 = (BitValue_T__o *)sub_1B64ABC(BitValue_CompensateArgForShowAll_EffectType__TypeInfo);
  BitValue_Int32Enum____ctor(
    v28,
    (System_Func_T__int__o *)_9__13_0,
    (const MethodInfo_305AAD4 *)Method_BitValue_CompensateArgForShowAll_EffectType___ctor__);
  this->fields._EffectTypeBit_k__BackingField = (struct BitValue_CompensateArgForShowAll_EffectType__o *)v28;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields._EffectTypeBit_k__BackingField, (int32_t)v28, v29, v30);
  v31 = (System_Action_T__o *)sub_1B64ABC(System_Action_CompensateArgForShowAll_EffectType__TypeInfo);
  ...
  BasicHelper__ForEach_Int32Enum_(
    ...
    v31,
    (const MethodInfo_2E2883C *)Method_BasicHelper_ForEach_CompensateArgForShowAll_EffectType___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A00582 & 1) == 0 )
  {
    sub_1B64870(&Method_BitValue_CompensateArgForShowAll_EffectType__On__, *(_QWORD *)&x);
    byte_4A00582 = 1;
  }
  ...
  BitValue_Int32Enum___On(
    ...
    x,
    (const MethodInfo_305AB04 *)Method_BitValue_CompensateArgForShowAll_EffectType__On__);
}
...
void __fastcall CompensateArgForShowAll___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A00583 & 1) == 0 )
  {
    sub_1B64870(&CompensateArgForShowAll___c_TypeInfo, v1);
    byte_4A00583 = 1;
  }
  v2 = (Il2CppObject *)sub_1B64ABC(CompensateArgForShowAll___c_TypeInfo);
