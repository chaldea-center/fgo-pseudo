        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD87E7 & 1) == 0 )
  {
    sub_1C21E38(&ServantMissionCharaGraphFilterLogic_TypeInfo);
    byte_4BD87E7 = 1;
  }
  v2 = (ServantCollectionCharaGraphFilterLogic_o *)sub_1C22084(ServantMissionCharaGraphFilterLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD87E6 & 1) == 0 )
  {
    sub_1C21E38(&ServantMissionCharaGraphSortLogic_TypeInfo);
    byte_4BD87E6 = 1;
  }
  v2 = (ServantCollectionCharaGraphSortLogic_o *)sub_1C22084(ServantMissionCharaGraphSortLogic_TypeInfo);
