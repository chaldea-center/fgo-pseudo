        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3F01A & 1) == 0 )
  {
    sub_1C37058(&ServantMissionCharaGraphFilterLogic_TypeInfo);
    byte_4C3F01A = 1;
  }
  v2 = (ServantCollectionCharaGraphFilterLogic_o *)sub_1C372A4(ServantMissionCharaGraphFilterLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3F019 & 1) == 0 )
  {
    sub_1C37058(&ServantMissionCharaGraphSortLogic_TypeInfo);
    byte_4C3F019 = 1;
  }
  v2 = (ServantCollectionCharaGraphSortLogic_o *)sub_1C372A4(ServantMissionCharaGraphSortLogic_TypeInfo);
