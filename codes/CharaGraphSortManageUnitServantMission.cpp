        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E735B8 & 1) == 0 )
  {
    sub_1D0F0B4(&ServantMissionCharaGraphFilterLogic_TypeInfo);
    byte_4E735B8 = 1;
  }
  v2 = (ServantCollectionCharaGraphFilterLogic_o *)sub_1D0F300(ServantMissionCharaGraphFilterLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E735B7 & 1) == 0 )
  {
    sub_1D0F0B4(&ServantMissionCharaGraphSortLogic_TypeInfo);
    byte_4E735B7 = 1;
  }
  v2 = (ServantCollectionCharaGraphSortLogic_o *)sub_1D0F300(ServantMissionCharaGraphSortLogic_TypeInfo);
