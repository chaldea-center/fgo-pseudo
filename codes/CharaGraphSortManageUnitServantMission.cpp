        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF99CD & 1) == 0 )
  {
    sub_1C2E12C(&ServantMissionCharaGraphFilterLogic_TypeInfo, method);
    byte_4BF99CD = 1;
  }
  v2 = (ServantCollectionCharaGraphFilterLogic_o *)sub_1C2E378(ServantMissionCharaGraphFilterLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF99CC & 1) == 0 )
  {
    sub_1C2E12C(&ServantMissionCharaGraphSortLogic_TypeInfo, method);
    byte_4BF99CC = 1;
  }
  v2 = (ServantCollectionCharaGraphSortLogic_o *)sub_1C2E378(ServantMissionCharaGraphSortLogic_TypeInfo);
