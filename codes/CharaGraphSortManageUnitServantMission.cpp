        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1BEE8 & 1) == 0 )
  {
    sub_1B715CC(&ServantMissionCharaGraphFilterLogic_TypeInfo, method);
    byte_4A1BEE8 = 1;
  }
  v2 = (ServantCollectionCharaGraphFilterLogic_o *)sub_1B71818(ServantMissionCharaGraphFilterLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1BEE7 & 1) == 0 )
  {
    sub_1B715CC(&ServantMissionCharaGraphSortLogic_TypeInfo, method);
    byte_4A1BEE7 = 1;
  }
  v2 = (ServantCollectionCharaGraphSortLogic_o *)sub_1B71818(ServantMissionCharaGraphSortLogic_TypeInfo);
