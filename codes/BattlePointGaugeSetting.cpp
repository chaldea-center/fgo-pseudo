        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCABD3 & 1) == 0 )
  {
    this = (BattlePointGaugeSetting_o *)sub_1C1ABD4(&int_TypeInfo, *(_QWORD *)&phaseValue);
    byte_4BCABD3 = 1;
  }
  sprite = v6->fields.sprite;
  if ( !sprite )
    sub_1C1AE30(this, *(_QWORD *)&phaseValue);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCABD4 & 1) == 0 )
  {
    this = (BattlePointGaugeSetting_o *)sub_1C1ABD4(&int_TypeInfo, *(_QWORD *)&effectId);
    byte_4BCABD4 = 1;
  }
  sprite = v6->fields.sprite;
  if ( !sprite )
    sub_1C1AE30(this, *(_QWORD *)&effectId);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCABD5 & 1) == 0 )
  {
    sub_1C1ABD4(
      ...
      *(_QWORD *)&effectId);
    sub_1C1ABD4(&System_Func_BattlePointGaugeSetting_EffectSection_StepUpEffectData__bool__TypeInfo, v7);
    sub_1C1ABD4(&UnityEngine_Object_TypeInfo, v8);
    sub_1C1ABD4(&Method_BattlePointGaugeSetting___c__DisplayClass17_0__TryGetStepUpEffect_b__0__, v9);
    sub_1C1ABD4(&BattlePointGaugeSetting___c__DisplayClass17_0_TypeInfo, v10);
    byte_4BCABD5 = 1;
  }
  v11 = sub_1C1AE20(BattlePointGaugeSetting___c__DisplayClass17_0_TypeInfo);
  ...
  v16 = (System_Func_object__bool__o *)sub_1C1AE20(System_Func_BattlePointGaugeSetting_EffectSection_StepUpEffectData__bool__TypeInfo);
  ...
  v17 = System_Linq_Enumerable__FirstOrDefault_object__50081164(
          ...
          (const MethodInfo_2FC2D8C *)Method_System_Linq_Enumerable_FirstOrDefault_BattlePointGaugeSetting_EffectSection_StepUpEffectData___);
  if ( v17 )
    monitor = (UnityEngine_GameObject_o *)v17[1].monitor;
  else
    monitor = 0LL;
  *effectPrefab = monitor;
  sub_1C1AB78((PartyOrganizationUtility_o *)effectPrefab, (int64_t)monitor, v18, v19, v20, v21, v22, v23);
        ...
        const MethodInfo *method)
{
  ...
  if ( !stepUpEffectPrefabs )
    sub_1C1AE30(this, settingFileName);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCABD6 & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_17419/*"battlepoint_phase_{0}"*/, method);
    sub_1C1ABD4(&StringLiteral_17420/*"battlepoint_step_{0}"*/, v9);
    byte_4BCABD6 = 1;
  }
  v10 = StringLiteral_17419/*"battlepoint_phase_{0}"*/;
  this->fields.phaseSpriteNameFormat = (struct System_String_o *)StringLiteral_17419/*"battlepoint_phase_{0}"*/;
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields, v10, v2, v3, v4, v5, v6, v7);
  v11 = StringLiteral_17420/*"battlepoint_step_{0}"*/;
  this->fields.stepSpriteNameFormat = (struct System_String_o *)StringLiteral_17420/*"battlepoint_step_{0}"*/;
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.stepSpriteNameFormat, v11, v12, v13, v14, v15, v16, v17);
  System_Object___ctor((Il2CppObject *)this, 0LL);
}
