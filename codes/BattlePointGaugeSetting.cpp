        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E08198 & 1) == 0 )
  {
    this = (BattlePointGaugeSetting_o *)sub_1CE6700(&int_TypeInfo);
    byte_4E08198 = 1;
  }
  sprite = v4->fields.sprite;
  if ( !sprite )
    sub_1CE6958(this, *(_QWORD *)&phaseValue);
        ...
        const MethodInfo *method)
{
  ...
  sprite = v4->fields.sprite;
  if ( !sprite )
    sub_1CE6958(this, *(_QWORD *)&effectId);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E0819A & 1) == 0 )
  {
    sub_1CE6700(&Method_System_Linq_Enumerable_FirstOrDefault_BattlePointGaugeSetting_EffectSection_StepUpEffectData___);
    sub_1CE6700(&System_Func_BattlePointGaugeSetting_EffectSection_StepUpEffectData__bool__TypeInfo);
    sub_1CE6700(&UnityEngine_Object_TypeInfo);
    sub_1CE6700(&Method_BattlePointGaugeSetting___c__DisplayClass17_0__TryGetStepUpEffect_b__0__);
    sub_1CE6700(&BattlePointGaugeSetting___c__DisplayClass17_0_TypeInfo);
    byte_4E0819A = 1;
  }
  v7 = sub_1CE694C(BattlePointGaugeSetting___c__DisplayClass17_0_TypeInfo);
  ...
  v12 = (System_Func_object__bool__o *)sub_1CE694C(System_Func_BattlePointGaugeSetting_EffectSection_StepUpEffectData__bool__TypeInfo);
  ...
  v13 = System_Linq_Enumerable__FirstOrDefault_object__52613440(
          ...
          (const MethodInfo_322D140 *)Method_System_Linq_Enumerable_FirstOrDefault_BattlePointGaugeSetting_EffectSection_StepUpEffectData___);
  if ( v13 )
    monitor = (UnityEngine_GameObject_o *)v13[1].monitor;
  else
    monitor = 0;
  *effectPrefab = monitor;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)effectPrefab, (int32_t)monitor, v14, v15, v16, v17, v18, v19);
        ...
        const MethodInfo *method)
{
  ...
  if ( !stepUpEffectPrefabs )
    sub_1CE6958(this, settingFileName);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E0819B & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_17295/*"battlepoint_phase_{0}"*/);
    sub_1CE6700(&StringLiteral_17296/*"battlepoint_step_{0}"*/);
    byte_4E0819B = 1;
  }
  v9 = StringLiteral_17295/*"battlepoint_phase_{0}"*/;
  this->fields.phaseSpriteNameFormat = (struct System_String_o *)StringLiteral_17295/*"battlepoint_phase_{0}"*/;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields, v9, v2, v3, v4, v5, v6, v7);
  v10 = StringLiteral_17296/*"battlepoint_step_{0}"*/;
  this->fields.stepSpriteNameFormat = (struct System_String_o *)StringLiteral_17296/*"battlepoint_step_{0}"*/;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.stepSpriteNameFormat, v10, v11, v12, v13, v14, v15, v16);
  System_Object___ctor((Il2CppObject *)this, 0);
}
