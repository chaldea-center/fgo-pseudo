        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7AECA & 1) == 0 )
  {
    this = (BattlePointGaugeSetting_o *)sub_1D0F0B4(&int_TypeInfo);
    byte_4E7AECA = 1;
  }
  sprite = v4->fields.sprite;
  if ( !sprite )
    sub_1D0F30C(this, *(_QWORD *)&phaseValue);
        ...
        const MethodInfo *method)
{
  ...
  sprite = v4->fields.sprite;
  if ( !sprite )
    sub_1D0F30C(this, *(_QWORD *)&effectId);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7AECC & 1) == 0 )
  {
    sub_1D0F0B4(&Method_System_Linq_Enumerable_FirstOrDefault_BattlePointGaugeSetting_EffectSection_StepUpEffectData___);
    sub_1D0F0B4(&System_Func_BattlePointGaugeSetting_EffectSection_StepUpEffectData__bool__TypeInfo);
    sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    sub_1D0F0B4(&Method_BattlePointGaugeSetting___c__DisplayClass17_0__TryGetStepUpEffect_b__0__);
    sub_1D0F0B4(&BattlePointGaugeSetting___c__DisplayClass17_0_TypeInfo);
    byte_4E7AECC = 1;
  }
  v7 = sub_1D0F300(BattlePointGaugeSetting___c__DisplayClass17_0_TypeInfo);
  ...
  v12 = (System_Func_object__bool__o *)sub_1D0F300(System_Func_BattlePointGaugeSetting_EffectSection_StepUpEffectData__bool__TypeInfo);
  ...
  v13 = System_Linq_Enumerable__FirstOrDefault_object__52923832(
          ...
          (const MethodInfo_3278DB8 *)Method_System_Linq_Enumerable_FirstOrDefault_BattlePointGaugeSetting_EffectSection_StepUpEffectData___);
  if ( v13 )
    monitor = (UnityEngine_GameObject_o *)v13[1].monitor;
  else
    monitor = 0;
  *effectPrefab = monitor;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)effectPrefab, (int32_t)monitor, v14, v15, v16, v17, v18, v19);
        ...
        const MethodInfo *method)
{
  ...
  if ( !stepUpEffectPrefabs )
    sub_1D0F30C(this, settingFileName);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7AECD & 1) == 0 )
  {
    sub_1D0F0B4(&StringLiteral_17368/*"battlepoint_phase_{0}"*/);
    sub_1D0F0B4(&StringLiteral_17369/*"battlepoint_step_{0}"*/);
    byte_4E7AECD = 1;
  }
  v9 = StringLiteral_17368/*"battlepoint_phase_{0}"*/;
  this->fields.phaseSpriteNameFormat = (struct System_String_o *)StringLiteral_17368/*"battlepoint_phase_{0}"*/;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields, v9, v2, v3, v4, v5, v6, v7);
  v10 = StringLiteral_17369/*"battlepoint_step_{0}"*/;
  this->fields.stepSpriteNameFormat = (struct System_String_o *)StringLiteral_17369/*"battlepoint_step_{0}"*/;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.stepSpriteNameFormat, v10, v11, v12, v13, v14, v15, v16);
  System_Object___ctor((Il2CppObject *)this, 0);
}
