        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69CB9 & 1) == 0 )
  {
    this = (BattlePointGaugeSetting_o *)sub_1BE4ACC(&int_TypeInfo, *(_QWORD *)&phaseValue);
    byte_4B69CB9 = 1;
  }
  sprite = v6->fields.sprite;
  if ( !sprite )
    sub_1BE4D28(this, *(_QWORD *)&phaseValue);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69CBA & 1) == 0 )
  {
    this = (BattlePointGaugeSetting_o *)sub_1BE4ACC(&int_TypeInfo, *(_QWORD *)&effectId);
    byte_4B69CBA = 1;
  }
  sprite = v6->fields.sprite;
  if ( !sprite )
    sub_1BE4D28(this, *(_QWORD *)&effectId);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69CBB & 1) == 0 )
  {
    sub_1BE4ACC(
      ...
      *(_QWORD *)&effectId);
    sub_1BE4ACC(&System_Func_BattlePointGaugeSetting_EffectSection_StepUpEffectData__bool__TypeInfo, v7);
    sub_1BE4ACC(&UnityEngine_Object_TypeInfo, v8);
    sub_1BE4ACC(&Method_BattlePointGaugeSetting___c__DisplayClass17_0__TryGetStepUpEffect_b__0__, v9);
    sub_1BE4ACC(&BattlePointGaugeSetting___c__DisplayClass17_0_TypeInfo, v10);
    byte_4B69CBB = 1;
  }
  v11 = sub_1BE4D18(BattlePointGaugeSetting___c__DisplayClass17_0_TypeInfo);
  ...
  v16 = (System_Func_object__bool__o *)sub_1BE4D18(System_Func_BattlePointGaugeSetting_EffectSection_StepUpEffectData__bool__TypeInfo);
  ...
  v17 = System_Linq_Enumerable__FirstOrDefault_object__49793520(
          ...
          (const MethodInfo_2F7C9F0 *)Method_System_Linq_Enumerable_FirstOrDefault_BattlePointGaugeSetting_EffectSection_StepUpEffectData___);
  if ( v17 )
    monitor = (UnityEngine_GameObject_o *)v17[1].monitor;
  else
    monitor = 0LL;
  *effectPrefab = monitor;
  sub_1BE4A70((PartyOrganizationUtility_o *)effectPrefab, (int64_t)monitor, v18, v19, v20, v21, v22, v23);
        ...
        const MethodInfo *method)
{
  ...
  if ( !stepUpEffectPrefabs )
    sub_1BE4D28(this, settingFileName);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69CBC & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_17360/*"battlepoint_phase_{0}"*/, method);
    sub_1BE4ACC(&StringLiteral_17361/*"battlepoint_step_{0}"*/, v9);
    byte_4B69CBC = 1;
  }
  v10 = StringLiteral_17360/*"battlepoint_phase_{0}"*/;
  this->fields.phaseSpriteNameFormat = (struct System_String_o *)StringLiteral_17360/*"battlepoint_phase_{0}"*/;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields, v10, v2, v3, v4, v5, v6, v7);
  v11 = StringLiteral_17361/*"battlepoint_step_{0}"*/;
  this->fields.stepSpriteNameFormat = (struct System_String_o *)StringLiteral_17361/*"battlepoint_step_{0}"*/;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.stepSpriteNameFormat, v11, v12, v13, v14, v15, v16, v17);
  System_Object___ctor((Il2CppObject *)this, 0LL);
}
