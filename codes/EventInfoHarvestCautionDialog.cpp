...
void __fastcall EventInfoHarvestCautionDialog__Init(EventInfoHarvestCautionDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BC4DF & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_3656/*"COMMON_CONFIRM_CANCEL"*/, v3);
    sub_1B4CF90(&StringLiteral_5519/*"EVENT_HARVEST_CAUTION_DECIDE_BUTTON"*/, v4);
  ...
  titleLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5519/*"EVENT_HARVEST_CAUTION_DECIDE_BUTTON"*/, 0LL);
  if ( !decideLabel
  ...
  {
LABEL_9:
    sub_1B4D1EC(titleLabel, v6);
  }
  UILabel__set_text(cancelLabel, (System_String_o *)titleLabel, 0LL);
  this->fields.callback = 0LL;
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.callback, 0, v10, v11);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BC4E2 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_EventInfoHarvestCautionDialog_OnClickCancelButton__, v3);
    sub_1B4CF90(&Method_EventInfoHarvestCautionDialog__OnClickCancelButton_b__9_0__, v4);
    byte_49BC4E2 = 1;
  }
  if ( !this->fields.isClose )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoHarvestCautionDialog_OnClickCancelButton__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B4CFA8(Method_EventInfoHarvestCautionDialog_OnClickCancelButton__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B4CF90(&System_Action_TypeInfo, method);
    sub_1B4CF90(&Method_EventInfoHarvestCautionDialog_OnClickDecideButton__, v3);
    sub_1B4CF90(&Method_EventInfoHarvestCautionDialog__OnClickDecideButton_b__8_0__, v4);
    byte_49BC4E1 = 1;
  }
  if ( !this->fields.isClose )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoHarvestCautionDialog_OnClickDecideButton__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B4CFA8(Method_EventInfoHarvestCautionDialog_OnClickDecideButton__);
    v6 = (System_Reflection_MethodBase_o *)sub_1B4CF74(v5, v5[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BC4E0 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_DataManager_GetMasterData_QuestPhaseMaster___, v11);
    sub_1B4CF90(&Method_DataManager_GetMasterData_SpotMaster___, v12);
    sub_1B4CF90(&Method_DataMasterBase_SpotMaster__SpotEntity__int__GetEntity__, v13);
    sub_1B4CF90(&LocalizationManager_TypeInfo, v14);
    sub_1B4CF90(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v15);
    sub_1B4CF90(&StringLiteral_5520/*"EVENT_HARVEST_CAUTION_TITLE"*/, v16);
    sub_1B4CF90(&StringLiteral_19582/*"harvestGrowthBeforeQuestId"*/, v17);
    byte_49BC4E0 = 1;
  }
  ...
  Instance = (DataManager_o *)QuestPhaseEntity__getScriptIntParam(
                                ...
                                (System_String_o *)StringLiteral_19582/*"harvestGrowthBeforeQuestId"*/,
                                -1,
                                0LL);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5520/*"EVENT_HARVEST_CAUTION_TITLE"*/, 0LL);
  if ( !v24
...
LABEL_17:
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.callback, (int32_t)callback, v25, v26);
}
