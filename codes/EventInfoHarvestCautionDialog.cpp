...
void __fastcall EventInfoHarvestCautionDialog__Init(EventInfoHarvestCautionDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4188655 & 1) == 0 )
  {
    ...
    sub_B2C35C(&StringLiteral_5628/*"EVENT_HARVEST_CAUTION_DECIDE_BUTTON"*/, v4);
  ...
  titleLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5628/*"EVENT_HARVEST_CAUTION_DECIDE_BUTTON"*/, 0LL);
  if ( !decideLabel
...
LABEL_10:
  ...
  sub_B2C2F8((BattleServantConfConponent_o *)&this->fields.callback, 0LL, v10, v11, v12, v13, v14, v15);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4188658 & 1) == 0 )
  {
    ...
    sub_B2C35C(&Method_EventInfoHarvestCautionDialog__OnClickCancelButton_b__9_0__, v3);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B2C35C(&System_Action_TypeInfo, method);
    sub_B2C35C(&Method_EventInfoHarvestCautionDialog__OnClickDecideButton_b__8_0__, v3);
    sub_B2C35C(&SoundManager_TypeInfo, v4);
    byte_4188657 = 1;
  }
  if ( !this->fields.isClose )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4188656 & 1) == 0 )
  {
    ...
    sub_B2C35C(&Method_DataManager_GetMasterData_SpotMaster___, v12);
    sub_B2C35C(&Method_DataMasterBase_SpotMaster__SpotEntity__int__GetEntity__, v13);
    sub_B2C35C(&LocalizationManager_TypeInfo, v14);
    sub_B2C35C(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v15);
    sub_B2C35C(&StringLiteral_5629/*"EVENT_HARVEST_CAUTION_TITLE"*/, v16);
    sub_B2C35C(&StringLiteral_19111/*"harvestGrowthBeforeQuestId"*/, v17);
    byte_4188656 = 1;
  }
  ...
  Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5629/*"EVENT_HARVEST_CAUTION_TITLE"*/, 0LL);
  if ( !v24
    || (Instance = (DataManager_o *)System_String__Format(
                                      (System_String_o *)Instance,
                                      (Il2CppObject *)v24->fields.name,
                                      0LL),
        !titleLabel)
