...
void EventInfoHarvestCautionDialog__Init(EventInfoHarvestCautionDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C444C6 & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_5608/*"EVENT_HARVEST_CAUTION_DECIDE_BUTTON"*/);
  ...
  titleLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5608/*"EVENT_HARVEST_CAUTION_DECIDE_BUTTON"*/, 0);
  if ( !decideLabel
...
LABEL_9:
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.callback, 0, v6, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C444C9 & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_EventInfoHarvestCautionDialog_OnClickCancelButton__);
    sub_1C37058(&Method_EventInfoHarvestCautionDialog__OnClickCancelButton_b__9_0__);
    byte_4C444C9 = 1;
  }
  if ( !this->fields.isClose )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoHarvestCautionDialog_OnClickCancelButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C37070(Method_EventInfoHarvestCautionDialog_OnClickCancelButton__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C37058(&System_Action_TypeInfo);
    sub_1C37058(&Method_EventInfoHarvestCautionDialog_OnClickDecideButton__);
    sub_1C37058(&Method_EventInfoHarvestCautionDialog__OnClickDecideButton_b__8_0__);
    byte_4C444C8 = 1;
  }
  if ( !this->fields.isClose )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoHarvestCautionDialog_OnClickDecideButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C37070(Method_EventInfoHarvestCautionDialog_OnClickDecideButton__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C3703C(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C444C7 & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_5609/*"EVENT_HARVEST_CAUTION_TITLE"*/);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5609/*"EVENT_HARVEST_CAUTION_TITLE"*/, 0);
  if ( !v16
...
LABEL_17:
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.callback, (int32_t)callback, v17, v18);
}
