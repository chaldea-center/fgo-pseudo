...
void EventInfoHarvestCautionDialog__Init(EventInfoHarvestCautionDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC892F & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_5601/*"EVENT_HARVEST_CAUTION_DECIDE_BUTTON"*/);
  ...
  titleLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5601/*"EVENT_HARVEST_CAUTION_DECIDE_BUTTON"*/, 0);
  if ( !decideLabel
...
LABEL_9:
  ...
  sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.callback, 0, v7, v8, v9, v10, v11, v12);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC8932 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_EventInfoHarvestCautionDialog_OnClickCancelButton__);
    sub_1C713B0(&Method_EventInfoHarvestCautionDialog__OnClickCancelButton_b__9_0__);
    byte_4CC8932 = 1;
  }
  if ( !this->fields.isClose )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoHarvestCautionDialog_OnClickCancelButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C713C8(Method_EventInfoHarvestCautionDialog_OnClickCancelButton__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C713B0(&System_Action_TypeInfo);
    sub_1C713B0(&Method_EventInfoHarvestCautionDialog_OnClickDecideButton__);
    sub_1C713B0(&Method_EventInfoHarvestCautionDialog__OnClickDecideButton_b__8_0__);
    byte_4CC8931 = 1;
  }
  if ( !this->fields.isClose )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoHarvestCautionDialog_OnClickDecideButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C713C8(Method_EventInfoHarvestCautionDialog_OnClickDecideButton__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C71394(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC8930 & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_5602/*"EVENT_HARVEST_CAUTION_TITLE"*/);
    sub_1C713B0(&StringLiteral_20013/*"harvestGrowthBeforeQuestId"*/);
    byte_4CC8930 = 1;
  }
  ...
  Instance = (DataManager_o *)QuestPhaseEntity__getScriptIntParam(
                                ...
                                (System_String_o *)StringLiteral_20013/*"harvestGrowthBeforeQuestId"*/,
                                -1,
                                0);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5602/*"EVENT_HARVEST_CAUTION_TITLE"*/, 0);
  if ( !v17
...
LABEL_17:
  ...
  sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.callback, (int32_t)callback, v18, v19, v20, v21, v22, v23);
}
