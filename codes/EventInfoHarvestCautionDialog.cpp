...
void __fastcall EventInfoHarvestCautionDialog__Init(EventInfoHarvestCautionDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B68187 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_3795/*"COMMON_CONFIRM_CANCEL"*/, v3);
    sub_1BE4ACC(&StringLiteral_5716/*"EVENT_HARVEST_CAUTION_DECIDE_BUTTON"*/, v4);
  ...
  titleLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5716/*"EVENT_HARVEST_CAUTION_DECIDE_BUTTON"*/, 0LL);
  if ( !decideLabel
  ...
  {
LABEL_9:
    sub_1BE4D28(titleLabel, v6);
  }
  UILabel__set_text(cancelLabel, (System_String_o *)titleLabel, 0LL);
  this->fields.callback = 0LL;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.callback, 0LL, v10, v11, v12, v13, v14, v15);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6818A & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_EventInfoHarvestCautionDialog_OnClickCancelButton__, v3);
    sub_1BE4ACC(&Method_EventInfoHarvestCautionDialog__OnClickCancelButton_b__9_0__, v4);
    byte_4B6818A = 1;
  }
  if ( !this->fields.isClose )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoHarvestCautionDialog_OnClickCancelButton__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1BE4AE4(Method_EventInfoHarvestCautionDialog_OnClickCancelButton__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BE4ACC(&System_Action_TypeInfo, method);
    sub_1BE4ACC(&Method_EventInfoHarvestCautionDialog_OnClickDecideButton__, v3);
    sub_1BE4ACC(&Method_EventInfoHarvestCautionDialog__OnClickDecideButton_b__8_0__, v4);
    byte_4B68189 = 1;
  }
  if ( !this->fields.isClose )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoHarvestCautionDialog_OnClickDecideButton__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1BE4AE4(Method_EventInfoHarvestCautionDialog_OnClickDecideButton__);
    v6 = (System_Reflection_MethodBase_o *)sub_1BE4AB0(v5, v5[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B68188 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_DataManager_GetMasterData_QuestPhaseMaster___, v11);
    sub_1BE4ACC(&Method_DataManager_GetMasterData_SpotMaster___, v12);
    sub_1BE4ACC(&Method_DataMasterBase_SpotMaster__SpotEntity__int__GetEntity__, v13);
    sub_1BE4ACC(&LocalizationManager_TypeInfo, v14);
    sub_1BE4ACC(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v15);
    sub_1BE4ACC(&StringLiteral_5717/*"EVENT_HARVEST_CAUTION_TITLE"*/, v16);
    sub_1BE4ACC(&StringLiteral_20157/*"harvestGrowthBeforeQuestId"*/, v17);
    byte_4B68188 = 1;
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5717/*"EVENT_HARVEST_CAUTION_TITLE"*/, 0LL);
  if ( !v24
...
LABEL_17:
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.callback, (int64_t)callback, v25, v26, v27, v28, v29, v30);
}
