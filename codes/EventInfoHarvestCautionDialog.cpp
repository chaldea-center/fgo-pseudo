...
void __fastcall EventInfoHarvestCautionDialog__Init(EventInfoHarvestCautionDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B0DE6 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_5670/*"EVENT_HARVEST_CAUTION_DECIDE_BUTTON"*/);
  ...
  titleLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5670/*"EVENT_HARVEST_CAUTION_DECIDE_BUTTON"*/, 0LL);
  if ( !decideLabel
...
LABEL_10:
  ...
  sub_B52920((BattleServantConfConponent_o *)&this->fields.callback, 0LL, v7, v8, v9, v10, v11, v12);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0DE9 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_EventInfoHarvestCautionDialog__OnClickCancelButton_b__9_0__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B52984(&System_Action_TypeInfo);
    sub_B52984(&Method_EventInfoHarvestCautionDialog__OnClickDecideButton_b__8_0__);
    sub_B52984(&SoundManager_TypeInfo);
    byte_42B0DE8 = 1;
  }
  if ( !this->fields.isClose )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0DE7 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_5671/*"EVENT_HARVEST_CAUTION_TITLE"*/);
    sub_B52984(&StringLiteral_19254/*"harvestGrowthBeforeQuestId"*/);
    byte_42B0DE7 = 1;
  }
  ...
  Instance = (DataManager_o *)QuestPhaseEntity__getScriptIntParam(
                                ...
                                (System_String_o *)StringLiteral_19254/*"harvestGrowthBeforeQuestId"*/,
                                -1,
                                0LL);
  ...
  Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5671/*"EVENT_HARVEST_CAUTION_TITLE"*/, 0LL);
  if ( !v17
