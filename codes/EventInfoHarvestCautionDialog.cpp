...
void __fastcall EventInfoHarvestCautionDialog__Init(EventInfoHarvestCautionDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A21164 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_3737/*"COMMON_CONFIRM_CANCEL"*/, v3);
    sub_1B715CC(&StringLiteral_5600/*"EVENT_HARVEST_CAUTION_DECIDE_BUTTON"*/, v4);
  ...
  titleLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5600/*"EVENT_HARVEST_CAUTION_DECIDE_BUTTON"*/, 0LL);
  if ( !decideLabel
  ...
  {
LABEL_9:
    sub_1B71828(titleLabel, v6);
  }
  UILabel__set_text(cancelLabel, (System_String_o *)titleLabel, 0LL);
  this->fields.callback = 0LL;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.callback, 0, v10, v11);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A21167 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_EventInfoHarvestCautionDialog_OnClickCancelButton__, v3);
    sub_1B715CC(&Method_EventInfoHarvestCautionDialog__OnClickCancelButton_b__9_0__, v4);
    byte_4A21167 = 1;
  }
  if ( !this->fields.isClose )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoHarvestCautionDialog_OnClickCancelButton__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B715E4(Method_EventInfoHarvestCautionDialog_OnClickCancelButton__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B715CC(&System_Action_TypeInfo, method);
    sub_1B715CC(&Method_EventInfoHarvestCautionDialog_OnClickDecideButton__, v3);
    sub_1B715CC(&Method_EventInfoHarvestCautionDialog__OnClickDecideButton_b__8_0__, v4);
    byte_4A21166 = 1;
  }
  if ( !this->fields.isClose )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoHarvestCautionDialog_OnClickDecideButton__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B715E4(Method_EventInfoHarvestCautionDialog_OnClickDecideButton__);
    v6 = (System_Reflection_MethodBase_o *)sub_1B715B0(v5, v5[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A21165 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_DataManager_GetMasterData_QuestPhaseMaster___, v11);
    sub_1B715CC(&Method_DataManager_GetMasterData_SpotMaster___, v12);
    sub_1B715CC(&Method_DataMasterBase_SpotMaster__SpotEntity__int__GetEntity__, v13);
    sub_1B715CC(&LocalizationManager_TypeInfo, v14);
    sub_1B715CC(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v15);
    sub_1B715CC(&StringLiteral_5601/*"EVENT_HARVEST_CAUTION_TITLE"*/, v16);
    sub_1B715CC(&StringLiteral_19830/*"harvestGrowthBeforeQuestId"*/, v17);
    byte_4A21165 = 1;
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5601/*"EVENT_HARVEST_CAUTION_TITLE"*/, 0LL);
  if ( !v24
...
LABEL_17:
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.callback, (int32_t)callback, v25, v26);
}
