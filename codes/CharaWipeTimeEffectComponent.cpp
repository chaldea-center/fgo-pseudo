        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3A67 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_CharaWipeTimeEffectComponent_EndCreateEffect__, v8);
    sub_1B00CCC(&CommonEffectManager_TypeInfo, v9);
    sub_1B00CCC(&CommonEffectLoadComponent_LoadEndHandler_TypeInfo, v10);
    sub_1B00CCC(&UnityEngine_Object_TypeInfo, v11);
    sub_1B00CCC(&StringLiteral_13314/*"Talk/"*/, v12);
    sub_1B00CCC(&StringLiteral_4919/*"Custom/Sprite-ScriptActionFigureWipe"*/, v13);
    byte_48E3A67 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3A66 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_CharaWipeTimeEffectComponent_EndLoadWipe__, v6);
