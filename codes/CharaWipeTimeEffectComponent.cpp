        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A09F7E & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_CharaWipeTimeEffectComponent_EndCreateEffect__, v8);
    sub_1B686D4(&CommonEffectManager_TypeInfo, v9);
    sub_1B686D4(&CommonEffectLoadComponent_LoadEndHandler_TypeInfo, v10);
    sub_1B686D4(&UnityEngine_Object_TypeInfo, v11);
    sub_1B686D4(&StringLiteral_13473/*"Talk/"*/, v12);
    sub_1B686D4(&StringLiteral_4949/*"Custom/Sprite-ScriptActionFigureWipe"*/, v13);
    byte_4A09F7E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A09F7D & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_CharaWipeTimeEffectComponent_EndLoadWipe__, v6);
