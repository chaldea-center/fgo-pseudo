        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB70A3 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_CharaWipeTimeEffectComponent_EndCreateEffect__, v8);
    sub_1BAB41C(&CommonEffectManager_TypeInfo, v9);
    sub_1BAB41C(&CommonEffectLoadComponent_LoadEndHandler_TypeInfo, v10);
    sub_1BAB41C(&UnityEngine_Object_TypeInfo, v11);
    sub_1BAB41C(&StringLiteral_13566/*"Talk/"*/, v12);
    sub_1BAB41C(&StringLiteral_4974/*"Custom/Sprite-ScriptActionFigureWipe"*/, v13);
    byte_4AB70A3 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB70A2 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_CharaWipeTimeEffectComponent_EndLoadWipe__, v6);
