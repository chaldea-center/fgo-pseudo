        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF80D & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_CharaWipeTimeEffectComponent_EndCreateEffect__, v8);
    sub_1B64870(&CommonEffectManager_TypeInfo, v9);
    sub_1B64870(&CommonEffectLoadComponent_LoadEndHandler_TypeInfo, v10);
    sub_1B64870(&UnityEngine_Object_TypeInfo, v11);
    sub_1B64870(&StringLiteral_13471/*"Talk/"*/, v12);
    sub_1B64870(&StringLiteral_4950/*"Custom/Sprite-ScriptActionFigureWipe"*/, v13);
    byte_49FF80D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF80C & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_CharaWipeTimeEffectComponent_EndLoadWipe__, v6);
