        ...
        const MethodInfo *method)
{
  ...
  __int64 v32; // x3
  __int64 v33; // x4
  CommonEffectLoadComponent_LoadEndHandler_o *v34; // x22

  if ( (byte_40FAF0B & 1) == 0 )
  {
    sub_B16FFC(&Method_AssetData_GetObject_Texture2D___, data);
    sub_B16FFC(&AssetManager_TypeInfo, v11);
    sub_B16FFC(&Method_CharaWipeTimeEffectComponent_EndCreateEffect__, v12);
...
LABEL_24:
  ...
  *(float *)&v8 = 1.2039 - *(float *)&v8;
  UIStandFigureRender__SetGradation(v25, 0.2, 0LL);
    ...
    && !System_String__IsNullOrEmpty(this->fields.subEffectName, 0LL) )
  {
    ...
    CommonEffectManager__Create_18186748(v28, v29, v34, 0, 0, 0, 0LL);
  }
  else
  {
    CharaWipeTimeEffectComponent__EndCreateEffect(this, 0LL, v27);
  }
}
