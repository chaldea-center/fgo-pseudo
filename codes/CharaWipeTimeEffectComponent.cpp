        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67F78 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_CharaWipeTimeEffectComponent_EndCreateEffect__, v12);
    sub_1BE4ACC(&CommonEffectManager_TypeInfo, v13);
    sub_1BE4ACC(&CommonEffectLoadComponent_LoadEndHandler_TypeInfo, v14);
    sub_1BE4ACC(&UnityEngine_Object_TypeInfo, v15);
    sub_1BE4ACC(&StringLiteral_13736/*"Talk/"*/, v16);
    sub_1BE4ACC(&StringLiteral_5057/*"Custom/Sprite-ScriptActionFigureWipe"*/, v17);
    byte_4B67F78 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67F77 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_CharaWipeTimeEffectComponent_EndLoadWipe__, v10);
