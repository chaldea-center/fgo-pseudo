        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C583CF & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_CharaWipeTimeEffectComponent_EndCreateEffect__);
...
LABEL_21:
  ...
  *(float *)&v4 = 1.2039 - *(float *)&v4;
  ...
  {
    CharaWipeTimeEffectComponent__EndCreateEffect(this, 0, v13);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C3E564(&AssetManager_TypeInfo);
    sub_1C3E564(&Method_CharaWipeTimeEffectComponent_EndLoadWipe__);
