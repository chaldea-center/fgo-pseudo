        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4187C9A & 1) == 0 )
  {
    ...
    sub_B2C35C(&Method_CharaWipeTimeEffectComponent_EndCreateEffect__, v12);
    sub_B2C35C(&CommonEffectManager_TypeInfo, v13);
    sub_B2C35C(&CommonEffectLoadComponent_LoadEndHandler_TypeInfo, v14);
    sub_B2C35C(&UnityEngine_Object_TypeInfo, v15);
    sub_B2C35C(&StringLiteral_13554/*"Talk/"*/, v16);
    sub_B2C35C(&StringLiteral_4535/*"Custom/Sprite-ScriptActionFigureWipe"*/, v17);
    byte_4187C9A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4187C99 & 1) == 0 )
  {
    ...
    sub_B2C35C(&Method_CharaWipeTimeEffectComponent_EndLoadWipe__, v10);
