        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20DF3 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_CharaWipeTimeEffectComponent_EndCreateEffect__, v8);
    sub_1B715CC(&CommonEffectManager_TypeInfo, v9);
    sub_1B715CC(&CommonEffectLoadComponent_LoadEndHandler_TypeInfo, v10);
    sub_1B715CC(&UnityEngine_Object_TypeInfo, v11);
    sub_1B715CC(&StringLiteral_13488/*"Talk/"*/, v12);
    sub_1B715CC(&StringLiteral_4954/*"Custom/Sprite-ScriptActionFigureWipe"*/, v13);
    byte_4A20DF3 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20DF2 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_CharaWipeTimeEffectComponent_EndLoadWipe__, v6);
