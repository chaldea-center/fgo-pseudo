...
void __fastcall SetNoticeNumControl__clear(SetNoticeNumControl_o *this, const MethodInfo *method)
{
  ...
  v6 = (UnityEngine_Object_o *)noticeNumObj;
  ...
  if ( UnityEngine_Object__op_Inequality(v6, 0LL, 0LL) )
  {
    ...
    sub_B5D560(p_noticeNumObj, 0LL, v9, v10, v11, v12, v13, v14);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EBA89 & 1) == 0 )
  {
    sub_B5D5C4(&Method_UnityEngine_GameObject_GetComponent_NoticeNumberComponent___, resNum, (_DWORD)method, v3);
    byte_42EBA89 = 1;
  }
...
LABEL_13:
  ...
  if ( !gameObject )
    goto LABEL_13;
  v18 = UnityEngine_GameObject__get_transform(gameObject, 0LL);
