...
void __fastcall SetNoticeNumControl__clear(SetNoticeNumControl_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(v4, 0LL, 0LL) )
  {
    ...
    sub_1B4CF34(p_noticeNumObj, 0, v7, v8);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BECF1 & 1) == 0 )
  {
    sub_1B4CF90(&Method_UnityEngine_GameObject_GetComponent_NoticeNumberComponent___, *(_QWORD *)&resNum);
    byte_49BECF1 = 1;
  }
...
LABEL_15:
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.noticeNumObj, (int32_t)Object, v9, v10);
  ...
  if ( !byte_49B5361 )
  {
    gameObject = (UnityEngine_GameObject_o *)sub_1B4CF90(&UnityEngine_Vector3_TypeInfo, v11);
    byte_49B5361 = 1;
  }
  if ( !v13 )
    goto LABEL_15;
