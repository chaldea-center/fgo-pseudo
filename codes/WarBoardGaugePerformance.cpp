        ...
        const MethodInfo *method)
{
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)v10, (int64_t)target, v11, v12, v13, v14, v15, v16);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDA365 & 1) == 0 )
  {
    sub_1C21E38(&WarBoardGaugePerformance__Execute_d__6_TypeInfo);
    byte_4BDA365 = 1;
  }
  v3 = sub_1C22084(WarBoardGaugePerformance__Execute_d__6_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( _1__state )
  {
    ...
    if ( _4__this )
    {
      ...
      if ( !v16 )
        v17 = v15;
      v18 = Easing__Func_47743976(_4__this->fields.startValue, _4__this->fields.endValue, v17, 0, 0LL);
      if ( target )
      {
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C21E4C(&Method_WarBoardGaugePerformance__Execute_d__6_System_Collections_IEnumerator_Reset__);
  sub_1C21F60(v3, v4);
}
