        ...
        const MethodInfo *method)
{
  ...
  sub_1C71354((GrandQuestFolderBoardItem_o *)v10, (int32_t)target, v11, v12, v13, v14, v15, v16);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC5043 & 1) == 0 )
  {
    sub_1C713B0(&WarBoardGaugePerformance__Execute_d__6_TypeInfo);
    byte_4CC5043 = 1;
  }
  v3 = sub_1C715FC(WarBoardGaugePerformance__Execute_d__6_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( _1__state )
  {
    ...
    if ( _4__this )
    {
      ...
      if ( !v16 )
        v17 = v15;
      v18 = Easing__Func_49421132(_4__this->fields.startValue, _4__this->fields.endValue, v17, 0, 0);
      if ( target )
      {
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C713C4(&Method_WarBoardGaugePerformance__Execute_d__6_System_Collections_IEnumerator_Reset__);
  sub_1C714D8(v3, v4);
}
