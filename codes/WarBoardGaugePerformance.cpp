        ...
        const MethodInfo *method)
{
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)v10, (int32_t)target, v11, v12);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC41F & 1) == 0 )
  {
    sub_1B64870(&WarBoardGaugePerformance__Execute_d__6_TypeInfo, method);
    byte_49FC41F = 1;
  }
  v3 = sub_1B64ABC(WarBoardGaugePerformance__Execute_d__6_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( _1__state )
  {
    ...
    if ( _4__this )
    {
      ...
      if ( !v12 )
        v13 = v11;
      v14 = Easing__Func_46300120(_4__this->fields.startValue, _4__this->fields.endValue, v13, 0, 0LL);
      if ( target )
      {
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B64884(&Method_WarBoardGaugePerformance__Execute_d__6_System_Collections_IEnumerator_Reset__);
  sub_1B64998(v3, v4);
}
