        ...
        const MethodInfo *method)
{
  if ( (byte_40F8EBF & 1) == 0 )
  {
    sub_B16FFC(&StringLiteral_18709/*"followId"*/, followId);
    byte_40F8EBF = 1;
  }
  RequestBase__addField_30956696((RequestBase_o *)this, (System_String_o *)StringLiteral_18709/*"followId"*/, followId, 0LL);
...
System_String_o *__fastcall FollowdRemoveRequest__getURL(FollowdRemoveRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_40F8EBE & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_18708/*"follow/remove"*/, v2);
    byte_40F8EBE = 1;
  }
  ...
  return System_String__Concat_43743732(BaseUrl, (System_String_o *)StringLiteral_18708/*"follow/remove"*/, 0LL);
}
