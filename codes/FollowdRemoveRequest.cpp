...
void FollowdRemoveRequest__beginRequest(FollowdRemoveRequest_o *this, int64_t followId, const MethodInfo *method)
{
  ...
  RequestBase__addField_51200900((RequestBase_o *)this, (System_String_o *)StringLiteral_20396/*"followId"*/, followId, 0);
...
System_String_o *FollowdRemoveRequest__getURL(FollowdRemoveRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_593A25E & 1) == 0 )
  {
    ...
    sub_21FFC50(&StringLiteral_20395/*"follow/remove"*/);
    byte_593A25E = 1;
  }
  if ( !*(&NetworkManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_75438412(BaseUrl, (System_String_o *)StringLiteral_20395/*"follow/remove"*/, 0);
}
