        ...
        const MethodInfo *method)
{
  ...
  RequestBase__addField_41133280((RequestBase_o *)this, (System_String_o *)StringLiteral_19496/*"followId"*/, followId, v3);
...
System_String_o *__fastcall FollowdRemoveRequest__getURL(FollowdRemoveRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5CA2C & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_19495/*"follow/remove"*/);
    byte_4A5CA2C = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61707032(BaseUrl, (System_String_o *)StringLiteral_19495/*"follow/remove"*/, 0LL);
}
