        ...
        const MethodInfo *method)
{
  if ( (byte_4213278 & 1) == 0 )
  {
    sub_B0D8A4(&StringLiteral_18839/*"followId"*/, followId);
    byte_4213278 = 1;
  }
  RequestBase__addField_30435180((RequestBase_o *)this, (System_String_o *)StringLiteral_18839/*"followId"*/, followId, 0LL);
...
System_String_o *__fastcall FollowdRemoveRequest__getURL(FollowdRemoveRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4213277 & 1) == 0 )
  {
    ...
    sub_B0D8A4(&StringLiteral_18838/*"follow/remove"*/, v2);
    byte_4213277 = 1;
  }
  ...
  return System_String__Concat_43849904(BaseUrl, (System_String_o *)StringLiteral_18838/*"follow/remove"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v7 = ResponseCommandKind__SearchData(81, responseList, 0LL);
