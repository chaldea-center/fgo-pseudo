        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17AEE & 1) == 0 )
  {
    sub_1BCA7E0(&StringLiteral_19698/*"followId"*/, followId, method);
    byte_4B17AEE = 1;
  }
  RequestBase__addField_41868688((RequestBase_o *)this, (System_String_o *)StringLiteral_19698/*"followId"*/, followId, v3);
...
System_String_o *__fastcall FollowdRemoveRequest__getURL(FollowdRemoveRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B17AED & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&StringLiteral_19697/*"follow/remove"*/, v3, v4);
    byte_4B17AED = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62401220(BaseUrl, (System_String_o *)StringLiteral_19697/*"follow/remove"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v9 = ResponseCommandKind__SearchData(82, responseList, 0LL);
