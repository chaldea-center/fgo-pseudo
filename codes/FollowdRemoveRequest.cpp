        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F7F9 & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_19490/*"followId"*/, followId);
    byte_4A2F7F9 = 1;
  }
  RequestBase__addField_40947456((RequestBase_o *)this, (System_String_o *)StringLiteral_19490/*"followId"*/, followId, v3);
...
System_String_o *__fastcall FollowdRemoveRequest__getURL(FollowdRemoveRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2F7F8 & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_19489/*"follow/remove"*/, v2);
    byte_4A2F7F8 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61535060(BaseUrl, (System_String_o *)StringLiteral_19489/*"follow/remove"*/, 0LL);
}
