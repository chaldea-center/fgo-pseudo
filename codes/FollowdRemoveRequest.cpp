        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4653D & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_19525/*"followId"*/, followId);
    byte_4B4653D = 1;
  }
  RequestBase__addField_43153704((RequestBase_o *)this, (System_String_o *)StringLiteral_19525/*"followId"*/, followId, v3);
...
System_String_o *__fastcall FollowdRemoveRequest__getURL(FollowdRemoveRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B4653C & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_19524/*"follow/remove"*/, v2);
    byte_4B4653C = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62572260(BaseUrl, (System_String_o *)StringLiteral_19524/*"follow/remove"*/, 0LL);
}
