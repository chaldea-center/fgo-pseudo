        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB6045 & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_19801/*"float.ieee.754.64"*/, followId);
    byte_4BB6045 = 1;
  }
  RequestBase__addField_42309896((RequestBase_o *)this, (System_String_o *)StringLiteral_19801/*"float.ieee.754.64"*/, followId, v3);
...
System_String_o *__fastcall FollowdRemoveRequest__getURL(FollowdRemoveRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB6044 & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_19800/*"float.ieee.754.32"*/, v2);
    byte_4BB6044 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62967944(BaseUrl, (System_String_o *)StringLiteral_19800/*"float.ieee.754.32"*/, 0LL);
}
