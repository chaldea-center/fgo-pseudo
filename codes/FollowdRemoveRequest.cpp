        ...
        const MethodInfo *method)
{
  ...
  RequestBase__addField_32020452((RequestBase_o *)this, (System_String_o *)StringLiteral_18922/*"followId"*/, followId, 0LL);
...
System_String_o *__fastcall FollowdRemoveRequest__getURL(FollowdRemoveRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42AE9F3 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_18921/*"follow/remove"*/);
    byte_42AE9F3 = 1;
  }
  ...
  return System_String__Concat_44568316(BaseUrl, (System_String_o *)StringLiteral_18921/*"follow/remove"*/, 0LL);
}
