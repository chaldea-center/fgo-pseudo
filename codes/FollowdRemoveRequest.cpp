        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A003C1 & 1) == 0 )
  {
    sub_1B64A00(&StringLiteral_19421/*"followId"*/, followId);
    byte_4A003C1 = 1;
  }
  RequestBase__addField_40855016((RequestBase_o *)this, (System_String_o *)StringLiteral_19421/*"followId"*/, followId, v3);
...
System_String_o *__fastcall FollowdRemoveRequest__getURL(FollowdRemoveRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A003C0 & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_19420/*"follow/remove"*/, v2);
    byte_4A003C0 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61385136(BaseUrl, (System_String_o *)StringLiteral_19420/*"follow/remove"*/, 0LL);
}
