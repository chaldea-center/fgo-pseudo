        ...
        const MethodInfo *method)
{
  ...
  RequestBase__addField_42421084((RequestBase_o *)this, (System_String_o *)StringLiteral_19830/*"followId"*/, followId, v3);
...
System_String_o *__fastcall FollowdRemoveRequest__getURL(FollowdRemoveRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDDED0 & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_19829/*"follow/remove"*/);
    byte_4BDDED0 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63115476(BaseUrl, (System_String_o *)StringLiteral_19829/*"follow/remove"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v5 = ResponseCommandKind__SearchData(82, responseList, 0LL);
