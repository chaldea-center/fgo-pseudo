        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A56105 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_5579/*"EVENT_COMMAND_ASSIST_DIALOG_MAX_LEVEL_FORMAT"*/);
    sub_1B885B0(&StringLiteral_5578/*"EVENT_COMMAND_ASSIST_DIALOG_LEVEL_FORMAT"*/);
    byte_4A56105 = 1;
  }
  ...
  Master_object = (EventCommandAssistMaster_o *)System_String__Format_61721404(v16, v20, v24, 0LL);
  if ( !levelLabel )
    goto LABEL_19;
  ...
  v27 = LocalizationManager__Get((System_String_o *)StringLiteral_8236/*"LEVEL_INFO"*/, 0LL);
  ...
  WrapControlText__textAdjust(detailLabel, v33, 16, 0, 0, 0LL);
