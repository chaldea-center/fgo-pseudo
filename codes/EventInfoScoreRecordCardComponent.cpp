        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC911E & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_EventInfoScoreRecordCardComponent_OnTap__, v3);
    sub_1C1ABD4(&Method_EventInfoScoreRecordCardComponent__OnTap_b__3_0__, v4);
    sub_1C1ABD4(&Method_UnityEngine_GameObject_GetComponent_ScoreRecordCardDialog___, v5);
    ...
    if ( !UnityEngine_Object__op_Equality(baseTransform, 0LL, 0LL) )
    {
      ...
      if ( !UnityEngine_Object__op_Inequality(scoreRecordCardDialogInstance, 0LL, 0LL) )
      {
        ...
        if ( (*((_BYTE *)Method_EventInfoScoreRecordCardComponent_OnTap__ + 83) & 2) != 0 )
          v13 = (_QWORD *)sub_1C1ABEC(Method_EventInfoScoreRecordCardComponent_OnTap__);
        ...
        if ( Instance )
        {
          ...
          if ( v19 )
          {
            Component_object = UnityEngine_GameObject__GetComponent_object_(
                                 ...
                                 (const MethodInfo_2FEFBC0 *)Method_UnityEngine_GameObject_GetComponent_ScoreRecordCardDialog___);
            *p_scoreRecordCardDialogInstance = (struct ScoreRecordCardDialog_o *)Component_object;
            ...
            if ( UnityEngine_Object__op_Equality(v27, 0LL, 0LL) )
            {
              if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
                j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
              UnityEngine_Object__Destroy_70794412((UnityEngine_Object_o *)v19, 0LL);
              return;
            }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C1AE30(baseTransform, method);
  }
  ...
  sub_1C1AB78(p_scoreRecordCardDialogInstance, 0LL, v7, v8, v9, v10, v11, v12);
}