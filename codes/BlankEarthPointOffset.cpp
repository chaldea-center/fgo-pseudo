...
void BlankEarthPointOffset__LateUpdate(BlankEarthPointOffset_o *this, const MethodInfo *method)
{
  ...
  if ( !UnityEngine_Object__op_Equality(currentCamera, 0, 0) )
  {
    ...
    if ( !UnityEngine_Object__op_Equality(earthTransform, 0, 0) )
    {
      ...
      v28.fields.z = v16;
      v29 = UnityEngine_Camera__WorldToScreenPoint_82984900((UnityEngine_Camera_o *)targetTransform, v28, 0);
      ...
      v31.fields.x = v17;
      v32 = UnityEngine_Camera__ScreenToWorldPoint_82984924((UnityEngine_Camera_o *)targetTransform, v31, 0);
      v23 = v32.fields.x;
      v24 = v32.fields.y;
      v25 = v32.fields.z;
      targetTransform = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0);
      if ( !targetTransform )
LABEL_22:
        sub_21FFECC(targetTransform, v8);
      v33.fields.x = v23;
      v33.fields.y = v24;
      v33.fields.z = v25;
