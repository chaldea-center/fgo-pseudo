  ...
  if ( !UnityEngine_Object__op_Equality(currentCamera, 0LL, 0LL) )
  {
    ...
    if ( !UnityEngine_Object__op_Equality(earthTransform, 0LL, 0LL) )
    {
      ...
      *(UnityEngine_Vector3_o *)&v13 = UnityEngine_Transform__get_lossyScale(targetTransform, 0LL);
      ...
      v31.fields.z = v16;
      *(UnityEngine_Vector3_o *)&v17 = UnityEngine_Camera__WorldToScreenPoint_69942344(
      ...
      *(UnityEngine_Vector3_o *)(&v23 - 2) = UnityEngine_Transform__get_position(targetTransform, 0LL);
      ...
      v32.fields.x = v20;
      v32.fields.y = v21;
      v33 = UnityEngine_Camera__ScreenToWorldPoint_69942368((UnityEngine_Camera_o *)targetTransform, v32, 0LL);
      v27 = v33.fields.x;
      v28 = v33.fields.y;
      v29 = v33.fields.z;
      targetTransform = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0LL);
      if ( !targetTransform )
LABEL_20:
        sub_1BCB254(targetTransform, v5);
      v34.fields.x = v27;
      v34.fields.y = v28;
      v34.fields.z = v29;
        ...
        const MethodInfo *method)
{
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.earthTransform, (int32_t)earthObject, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.currentCamera, (int32_t)targetCamera, (int32_t)method, v3);
}