void __fastcall ServantLimitUpVoiceCache___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AFCD05 & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Collections_Generic_Dictionary_int__int___ctor__, v1);
    sub_1BC3008(&System_Collections_Generic_Dictionary_int__int__TypeInfo, v2);
    sub_1BC3008(&ServantLimitUpVoiceCache_TypeInfo, v3);
    byte_4AFCD05 = 1;
  }
  v4 = (System_Collections_Generic_Dictionary_int__int__o *)sub_1BC3254(System_Collections_Generic_Dictionary_int__int__TypeInfo);
  ...
  sub_1BC2FAC(ServantLimitUpVoiceCache_TypeInfo->static_fields);
  v5 = (System_Collections_Generic_Dictionary_int__int__o *)sub_1BC3254(System_Collections_Generic_Dictionary_int__int__TypeInfo);
  System_Collections_Generic_Dictionary_int__int____ctor(
    v5,
    (const MethodInfo_32FF0D8 *)Method_System_Collections_Generic_Dictionary_int__int___ctor__);
  static_fields = ServantLimitUpVoiceCache_TypeInfo->static_fields;
  static_fields->detailLimitUpVoiceFlagDic = v5;
  sub_1BC2FAC(&static_fields->detailLimitUpVoiceFlagDic);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFCD03 & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Collections_Generic_Dictionary_int__int__Add__, *(_QWORD *)&servantId);
    sub_1BC3008(&Method_System_Collections_Generic_Dictionary_int__int__ContainsKey__, v5);
    sub_1BC3008(&Method_System_Collections_Generic_Dictionary_int__int__get_Item__, v6);
    sub_1BC3008(&ServantLimitUpVoiceCache_TypeInfo, v7);
    byte_4AFCD03 = 1;
  }
  if ( type != 2 )
  {
    ...
    v14 = UnityEngine_Random__Range_69994520(0, 2, 0LL);
    ...
    if ( !materialLimitUpVoiceFlagDic )
LABEL_25:
      sub_1BC3264(materialLimitUpVoiceFlagDic, *(_QWORD *)&servantId);
LABEL_29:
  ...
  if ( !System_Collections_Generic_Dictionary_int__int___ContainsKey(
          ...
          (const MethodInfo_32FFC88 *)Method_System_Collections_Generic_Dictionary_int__int__ContainsKey__) )
  {
    v16 = UnityEngine_Random__Range_69994520(0, 2, 0LL);
...
void __fastcall ServantLimitUpVoiceCache__UpdateLimitUpVoice(int32_t type, int32_t servantId, const MethodInfo *method)
{
  ...
  if ( (byte_4AFCD04 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_System_Collections_Generic_Dictionary_int__int__ContainsKey__, v5);
    sub_1BC3008(&Method_System_Collections_Generic_Dictionary_int__int__get_Item__, v6);
    sub_1BC3008(&Method_System_Collections_Generic_Dictionary_int__int__set_Item__, v7);
    sub_1BC3008(&ServantLimitUpVoiceCache_TypeInfo, v8);
    byte_4AFCD04 = 1;
  }
  if ( type == 2 )
  {
...
LABEL_11:
      if ( materialLimitUpVoiceFlagDic )
      {
        v14 = System_Collections_Generic_Dictionary_int__int___get_Item(
                materialLimitUpVoiceFlagDic,
                servantId,
                (const MethodInfo_32FFA00 *)Method_System_Collections_Generic_Dictionary_int__int__get_Item__) == 0;
...
LABEL_22:
      sub_1BC3264(detailLimitUpVoiceFlagDic, *(_QWORD *)&servantId);
    }
  }
  else
  {
  ...
  detailLimitUpVoiceFlagDic = (System_Collections_Generic_Dictionary_int__int__o *)UnityEngine_Random__Range_69994520(
                                                                                     0,
                                                                                     2,
                                                                                     0LL);
  if ( !materialLimitUpVoiceFlagDic )
