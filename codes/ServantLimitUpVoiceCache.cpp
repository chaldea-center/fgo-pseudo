void ServantLimitUpVoiceCache___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4D2B08D & 1) == 0 )
  {
    ...
    sub_1C93AD4(&ServantLimitUpVoiceCache_TypeInfo);
    byte_4D2B08D = 1;
  }
  v1 = (System_Collections_Generic_Dictionary_int__int__o *)sub_1C93D20(System_Collections_Generic_Dictionary_int__int__TypeInfo);
  ...
  sub_1C93A78(ServantLimitUpVoiceCache_TypeInfo->static_fields, v1);
  ...
  sub_1C93A78(&static_fields->detailLimitUpVoiceFlagDic, v2);
}
...
bool ServantLimitUpVoiceCache__IsLimitUpVoiceNormal(int32_t type, int32_t servantId, const MethodInfo *method)
{
  ...
  if ( type != 2 )
  {
    ...
    v11 = UnityEngine_Random__Range_72079620(0, 2, 0);
    ...
    if ( !materialLimitUpVoiceFlagDic )
LABEL_25:
      sub_1C93D2C(materialLimitUpVoiceFlagDic, *(_QWORD *)&servantId);
LABEL_29:
  ...
  if ( !System_Collections_Generic_Dictionary_int__int___ContainsKey(
          ...
          (const MethodInfo_34B44B8 *)Method_System_Collections_Generic_Dictionary_int__int__ContainsKey__) )
  {
    v13 = UnityEngine_Random__Range_72079620(0, 2, 0);
...
LABEL_11:
      if ( materialLimitUpVoiceFlagDic )
      {
        v10 = System_Collections_Generic_Dictionary_int__int___get_Item(
                materialLimitUpVoiceFlagDic,
                servantId,
                (const MethodInfo_34B4230 *)Method_System_Collections_Generic_Dictionary_int__int__get_Item__) == 0;
...
LABEL_22:
      sub_1C93D2C(detailLimitUpVoiceFlagDic, *(_QWORD *)&servantId);
    }
  }
  else
  {
  ...
  detailLimitUpVoiceFlagDic = (System_Collections_Generic_Dictionary_int__int__o *)UnityEngine_Random__Range_72079620(
                                                                                     0,
                                                                                     2,
                                                                                     0);
  if ( !materialLimitUpVoiceFlagDic )
