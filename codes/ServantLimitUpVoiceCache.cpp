void __fastcall ServantLimitUpVoiceCache___cctor(const MethodInfo *method)
{
  ...
  sub_1B88554(ServantLimitUpVoiceCache_TypeInfo->static_fields, v1);
  ...
  sub_1B88554(&static_fields->detailLimitUpVoiceFlagDic, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( type != 2 )
  {
    ...
    v11 = UnityEngine_Random__Range_69419120(0, 2, 0LL);
    ...
    if ( !materialLimitUpVoiceFlagDic )
LABEL_25:
      sub_1B8880C(materialLimitUpVoiceFlagDic, *(_QWORD *)&servantId);
LABEL_29:
  ...
  if ( !System_Collections_Generic_Dictionary_int__int___ContainsKey(
          ...
          (const MethodInfo_3165074 *)Method_System_Collections_Generic_Dictionary_int__int__ContainsKey__) )
  {
    v13 = UnityEngine_Random__Range_69419120(0, 2, 0LL);
...
LABEL_11:
      if ( materialLimitUpVoiceFlagDic )
      {
        v10 = System_Collections_Generic_Dictionary_int__int___get_Item(
                materialLimitUpVoiceFlagDic,
                servantId,
                (const MethodInfo_3164DEC *)Method_System_Collections_Generic_Dictionary_int__int__get_Item__) == 0;
...
LABEL_22:
      sub_1B8880C(detailLimitUpVoiceFlagDic, *(_QWORD *)&servantId);
    }
  }
  else
  {
  ...
  detailLimitUpVoiceFlagDic = (System_Collections_Generic_Dictionary_int__int__o *)UnityEngine_Random__Range_69419120(
                                                                                     0,
                                                                                     2,
                                                                                     0LL);
  if ( !materialLimitUpVoiceFlagDic )
