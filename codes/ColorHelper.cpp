        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v7.fields.b = 0;
  ...
  if ( !System_String__StartsWith(colorCode, (System_String_o *)StringLiteral_369/*"#"*/, 0) )
    colorCode = System_String__Concat_64417744((System_String_o *)StringLiteral_369/*"#"*/, colorCode, 0);
...
LABEL_9:
  ...
  else
  {
    ...
    *(_QWORD *)&retstr->fields.value.fields.g = 0;
    retstr->fields.value.fields.a = 0.0;
    System_Nullable_Color____ctor(retstr, v8, (const MethodInfo_3990928 *)Method_System_Nullable_Color___ctor__);
  }
  return result;
}
...
float ColorHelper___GetClamped_g__Clamp_0_0(float value, const MethodInfo *method)
{
  ...
  if ( !byte_4D2E3EA )
  {
    sub_1C94098(&Method_System_Math_ThrowMinMaxException_float___);
    sub_1C94098(&System_Math_TypeInfo);
    byte_4D2E3EA = 1;
  }
  result = 0.0;
