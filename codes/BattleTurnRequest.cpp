void __fastcall BattleTurnRequest__beginRequest(BattleTurnRequest_o *this, int64_t battleId, const MethodInfo *method)
{
  ...
  if ( (byte_4AB7539 & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_17146/*"battleId"*/, battleId);
    byte_4AB7539 = 1;
  }
  RequestBase__addField_41522804((RequestBase_o *)this, (System_String_o *)StringLiteral_17146/*"battleId"*/, battleId, v3);
...
System_String_o *__fastcall BattleTurnRequest__getURL(BattleTurnRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB7537 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_17132/*"battle/turn"*/, v2);
    byte_4AB7537 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62048128(BaseUrl, (System_String_o *)StringLiteral_17132/*"battle/turn"*/, 0LL);
}
