void __fastcall BattleTurnRequest__beginRequest(BattleTurnRequest_o *this, int64_t battleId, const MethodInfo *method)
{
  ...
  if ( (byte_4B389D0 & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_17308/*"battleId"*/, battleId);
    byte_4B389D0 = 1;
  }
  RequestBase__addField_41971420((RequestBase_o *)this, (System_String_o *)StringLiteral_17308/*"battleId"*/, battleId, v3);
...
System_String_o *__fastcall BattleTurnRequest__getURL(BattleTurnRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B389CE & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_17294/*"battle/turn"*/, v2);
    byte_4B389CE = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62525248(BaseUrl, (System_String_o *)StringLiteral_17294/*"battle/turn"*/, 0LL);
}
