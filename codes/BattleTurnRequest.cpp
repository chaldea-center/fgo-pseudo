void __fastcall BattleTurnRequest__beginRequest(BattleTurnRequest_o *this, int64_t battleId, const MethodInfo *method)
{
  ...
  if ( (byte_4BC933A & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_17388/*"battleId"*/, battleId);
    byte_4BC933A = 1;
  }
  RequestBase__addField_42368496((RequestBase_o *)this, (System_String_o *)StringLiteral_17388/*"battleId"*/, battleId, v3);
...
System_String_o *__fastcall BattleTurnRequest__getURL(BattleTurnRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC9338 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_17374/*"battle/turn"*/, v2);
    byte_4BC9338 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63040368(BaseUrl, (System_String_o *)StringLiteral_17374/*"battle/turn"*/, 0LL);
}
