void __fastcall BattleTurnRequest__beginRequest(BattleTurnRequest_o *this, int64_t battleId, const MethodInfo *method)
{
  ...
  if ( (byte_4BB5F58 & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_17374/*"battle/turn"*/, battleId);
    byte_4BB5F58 = 1;
  }
  RequestBase__addField_42309896((RequestBase_o *)this, (System_String_o *)StringLiteral_17374/*"battle/turn"*/, battleId, v3);
...
System_String_o *__fastcall BattleTurnRequest__getURL(BattleTurnRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB5F56 & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_17360/*"baseVals.GetValue:"*/, v2);
    byte_4BB5F56 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62967944(BaseUrl, (System_String_o *)StringLiteral_17360/*"baseVals.GetValue:"*/, 0LL);
}
