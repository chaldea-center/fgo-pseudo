void __fastcall BuffMaster___ctor(BuffMaster_o *this, const MethodInfo *method)
{
  if ( (byte_48E2572 & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataMasterBase_BuffMaster__BuffEntity__int___ctor__, method);
    byte_48E2572 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    55,
    (const MethodInfo_2FE6A0C *)Method_DataMasterBase_BuffMaster__BuffEntity__int___ctor__);
}
...
int32_t __fastcall BuffMaster__GetBuffGroup(BuffMaster_o *this, int32_t buffId, int32_t def, const MethodInfo *method)
{
  ...
  if ( (byte_48E2576 & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataMasterBase_BuffMaster__BuffEntity__int__TryGetEntity__, *(_QWORD *)&buffId);
    byte_48E2576 = 1;
  }
  entity = 0LL;
        ...
        const MethodInfo *method)
{
         ...
         (const MethodInfo_2FE6AA0 *)Method_DataMasterBase_BuffMaster__BuffEntity__int__TryGetEntity__) )
  {
    if ( !entity )
      sub_1B00F28(0LL, v9);
    return BuffEntity__getScript_37760072((BuffEntity_o *)entity, key, def, v10);
  }
  return def;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E2577 & 1) == 0 )
  {
    sub_1B00CCC(&Method_BasicHelper_GetValue_string___, name);
    sub_1B00CCC(&Method_DataMasterBase_BuffMaster__BuffEntity__int__TryGetEntity__, v9);
    sub_1B00CCC(&StringLiteral_5275/*"DisplayCardBottomImageName"*/, v10);
    byte_48E2577 = 1;
  }
  entity = 0LL;
  ...
  if ( v11 )
  {
    ...
    Value_object = BasicHelper__GetValue_object_(
                     ...
                     (System_String_o *)StringLiteral_5275/*"DisplayCardBottomImageName"*/,
                     (Il2CppObject *)defName,
                     (const MethodInfo_2D510F4 *)Method_BasicHelper_GetValue_string___);
  }
  *name = (System_String_o *)Value_object;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)name, (int32_t)Value_object, v12, v13);
...
bool __fastcall BuffMaster__preProcess(BuffMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E2573 & 1) == 0 )
  {
    sub_1B00CCC(&BuffEntity_TypeInfo, method);
...
LABEL_44:
    ...
    if ( BuffEntity__GetCardEffectId(v27, (const MethodInfo *)effectId) >= 1 )
    {
      ...
      if ( !v12 )
        sub_1B00F28(CardEffectId, (unsigned int)CardEffectId);
