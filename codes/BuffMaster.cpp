void __fastcall BuffMaster___ctor(BuffMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4B447B2 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataMasterBase_BuffMaster__BuffEntity__int___ctor__, method);
    byte_4B447B2 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    60,
    (const MethodInfo_32DFB18 *)Method_DataMasterBase_BuffMaster__BuffEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B447B4 & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Collections_Generic_List_int__Add__, effectIdList);
    this = (BuffMaster_o *)sub_1BDB878(&Method_System_Collections_Generic_List_int__Contains__, v6);
    byte_4B447B4 = 1;
  }
  if ( effectId >= 1 )
  {
...
int32_t __fastcall BuffMaster__GetBuffGroup(BuffMaster_o *this, int32_t buffId, int32_t def, const MethodInfo *method)
{
  ...
  if ( (byte_4B447B7 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataMasterBase_BuffMaster__BuffEntity__int__TryGetEntity__, *(_QWORD *)&buffId);
    byte_4B447B7 = 1;
  }
  entity = 0LL;
        ...
        const MethodInfo *method)
{
         ...
         (const MethodInfo_32E1E88 *)Method_DataMasterBase_BuffMaster__BuffEntity__int__TryGetEntity__) )
  {
    if ( !entity )
      sub_1BDBAD4(0LL, v9);
    return BuffEntity__getScript_40820824((BuffEntity_o *)entity, key, def, v10);
  }
  return def;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B447B8 & 1) == 0 )
  {
    sub_1BDB878(&Method_BasicHelper_GetValue_string___, name);
    sub_1BDB878(&Method_DataMasterBase_BuffMaster__BuffEntity__int__TryGetEntity__, v9);
    sub_1BDB878(&StringLiteral_5331/*"DisplayCardBottomImageName"*/, v10);
    byte_4B447B8 = 1;
  }
  entity = 0LL;
  ...
  *name = (System_String_o *)Value_object;
  sub_1BDB81C((CGThumbnailListItem_o *)name, (int32_t)Value_object, v12, v13);
...
bool __fastcall BuffMaster__preProcess(BuffMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B447B3 & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Collections_ObjectModel_Collection_BuffEntity__GetEnumerator__, method);
    sub_1BDB878(&System_IDisposable_TypeInfo, v3);
    sub_1BDB878(&System_Collections_Generic_IEnumerator_BuffEntity__TypeInfo, v4);
  ...
  Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                 list,
                 (const MethodInfo_327DBFC *)Method_System_Collections_ObjectModel_Collection_BuffEntity__GetEnumerator__);
  if ( !Enumerator )
    sub_1BDBAD4(0LL, v14);
  while ( 1 )
  {
...
LABEL_9:
    ...
    {
LABEL_16:
      v23 = sub_1C2C00C(Enumerator, System_Collections_Generic_IEnumerator_BuffEntity__TypeInfo, 0LL);
    }
    ...
    if ( BuffEntity__GetCardEffectId(v26, (const MethodInfo *)effectId) >= 1 )
    {
      ...
      if ( !v11 )
        sub_1BDBAD4(CardEffectId, (unsigned int)CardEffectId);
              ...
              (const MethodInfo_36B9118 *)Method_System_Collections_Generic_List_int__Contains__) )
      {
        ...
        ++v11->fields._version;
        if ( !v35 )
          sub_1BDBAD4(v34, (unsigned int)v34);
...
LABEL_47:
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields._StateEffectIdArray_k__BackingField, (int32_t)v47, v48, v49);
  return 1;
}
