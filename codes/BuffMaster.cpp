void BuffMaster___ctor(BuffMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E04761 & 1) == 0 )
  {
    sub_1CE6700(&Method_DataMasterBase_BuffMaster__BuffEntity__int___ctor__);
    sub_1CE6700(&Method_System_Collections_Generic_Dictionary_int__BuffEntity_CondBuffValueData_____ctor__);
    sub_1CE6700(&System_Collections_Generic_Dictionary_int__BuffEntity_CondBuffValueData____TypeInfo);
    byte_4E04761 = 1;
  }
  v3 = (System_Collections_Generic_Dictionary_int__object__o *)sub_1CE694C(System_Collections_Generic_Dictionary_int__BuffEntity_CondBuffValueData____TypeInfo);
  System_Collections_Generic_Dictionary_int__object____ctor(
    v3,
    (const MethodInfo_355AB10 *)Method_System_Collections_Generic_Dictionary_int__BuffEntity_CondBuffValueData_____ctor__);
  this->fields.condBuffValueDataDict = (struct System_Collections_Generic_Dictionary_int__BuffEntity_CondBuffValueData____o *)v3;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.condBuffValueDataDict, (int32_t)v3, v4, v5, v6, v7, v8, v9);
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    60,
    (const MethodInfo_34E6CE4 *)Method_DataMasterBase_BuffMaster__BuffEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E04763 & 1) == 0 )
  {
    ...
    this = (BuffMaster_o *)sub_1CE6700(&Method_System_Collections_Generic_List_int__Contains__);
    byte_4E04763 = 1;
  }
  if ( effectId >= 1 )
  {
...
int32_t BuffMaster__GetBuffEffectId(BuffMaster_o *this, int32_t buffId, int32_t def, const MethodInfo *method)
{
  ...
  if ( (byte_4E04766 & 1) == 0 )
  {
    sub_1CE6700(&Method_BuffMaster_GetEntityParam_int___);
    sub_1CE6700(&System_Func_BuffEntity__int__TypeInfo);
    sub_1CE6700(&Method_BuffMaster___c__GetBuffEffectId_b__11_0__);
    sub_1CE6700(&BuffMaster___c_TypeInfo);
    byte_4E04766 = 1;
  }
  ...
  if ( !_9__11_0 )
  {
    ...
    _9__11_0 = (System_Func_object__int__o *)sub_1CE694C(System_Func_BuffEntity__int__TypeInfo);
  ...
  if ( !this )
    sub_1CE6958(v7, *(_QWORD *)&buffId);
  return BuffMaster__GetEntityParam_int_(
           this,
           buffId,
           def,
           (System_Func_BuffEntity__T__o *)_9__11_0,
           (const MethodInfo_31F6518 *)Method_BuffMaster_GetEntityParam_int___);
}
...
Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_o BuffMaster__GetEntityParam___Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_31F65C0 *method)
{
  void *monitor; // x20
  const MethodInfo_31F65C0_RGCTXs *rgctx_data; // x8
  ...
  if ( !rgctx_data )
  {
    this = (BuffMaster_o *)sub_1CE6700(&Method_DataMasterBase_BuffMaster__BuffEntity__int__TryGetEntity__);
    rgctx_data = method->rgctx_data;
    if ( !rgctx_data )
    {
      this = (BuffMaster_o *)sub_1CBC7E4(method);
      rgctx_data = method->rgctx_data;
    }
  }
...
LABEL_13:
    sub_1CE6958(this, *(_QWORD *)&buffId);
  }
...
int32_t BuffMaster__GetEntityParam_int_(
        ...
        int32_t def,
        System_Func_BuffEntity__T__o *funcGetParam,
        const MethodInfo_31F6518 *method)
{
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&Method_DataMasterBase_BuffMaster__BuffEntity__int__TryGetEntity__);
    sub_1CE6700(&Method_System_Collections_Generic_Dictionary_int__BuffEntity_CondBuffValueData____TryAdd__);
    sub_1CE6700(&Method_System_Collections_Generic_Dictionary_int__BuffEntity_CondBuffValueData____TryGetValue__);
    byte_4E04769 = 1;
  }
  entity = 0;
  ...
  if ( !System_Collections_Generic_Dictionary_int__object___TryGetValue(
          ...
          (const MethodInfo_355CC70 *)Method_System_Collections_Generic_Dictionary_int__BuffEntity_CondBuffValueData____TryGetValue__) )
  {
    if ( !DataMasterBase_object__object__int___TryGetEntity(
            (DataMasterBase_TMaster__TEntity__PKType__o *)this,
            &entity,
    ...
    if ( entity )
    {
      ...
      *dataArray = CondBuffValueArray;
      sub_1CE66A4((GrandQuestFolderBoardItem_o *)dataArray, (int32_t)CondBuffValueArray, v9, v10, v11, v12, v13, v14);
      if ( entity )
      {
        condBuffValueDataDict = (System_Collections_Generic_Dictionary_int__object__o *)this->fields.condBuffValueDataDict;
        if ( condBuffValueDataDict )
        {
          System_Collections_Generic_Dictionary_int__object___TryAdd(
            ...
            &(*dataArray)->obj,
            (const MethodInfo_355CCE8 *)Method_System_Collections_Generic_Dictionary_int__BuffEntity_CondBuffValueData____TryAdd__);
          return !BasicHelper__IsNullOrEmpty((System_Collections_ICollection_o *)*dataArray, 0);
        }
      }
    }
LABEL_13:
    sub_1CE6958(condBuffValueDataDict, *(_QWORD *)&buffId);
  }
  return !BasicHelper__IsNullOrEmpty((System_Collections_ICollection_o *)*dataArray, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E04767 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_DataMasterBase_BuffMaster__BuffEntity__int__TryGetEntity__);
    sub_1CE6700(&StringLiteral_5330/*"DisplayCardBottomImageName"*/);
    byte_4E04767 = 1;
  }
  entity = 0;
  ...
  if ( v9 )
  {
    ...
    Value_object = BasicHelper__GetValue_object_(
                     *(System_Collections_Generic_Dictionary_string__object__o **)((char *)&qword_60 + (_QWORD)entity),
                     (System_String_o *)StringLiteral_5330/*"DisplayCardBottomImageName"*/,
                     (Il2CppObject *)defName,
                     (const MethodInfo_31F1AB0 *)Method_BasicHelper_GetValue_string___);
  }
  *name = (System_String_o *)Value_object;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)name, (int32_t)Value_object, v10, v11, v12, v13, v14, v15);
...
bool BuffMaster__preProcess(BuffMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E04762 & 1) == 0 )
  {
    sub_1CE6700(&Method_System_Collections_ObjectModel_Collection_BuffEntity__GetEnumerator__);
    sub_1CE6700(&System_IDisposable_TypeInfo);
    sub_1CE6700(&System_Collections_Generic_IEnumerator_BuffEntity__TypeInfo);
  ...
  Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                 list,
                 (const MethodInfo_3481088 *)Method_System_Collections_ObjectModel_Collection_BuffEntity__GetEnumerator__);
  if ( !Enumerator )
    sub_1CE6958(0, v6);
  while ( 1 )
  {
...
LABEL_9:
    ...
    {
LABEL_16:
      v15 = sub_1CBCA7C(Enumerator, System_Collections_Generic_IEnumerator_BuffEntity__TypeInfo, 0);
    }
    ...
    if ( BuffEntity__GetCardEffectId(v18, (const MethodInfo *)effectId) >= 1 )
    {
      ...
      if ( !v3 )
        sub_1CE6958(CardEffectId, (unsigned int)CardEffectId);
...
void BuffMaster___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1CE694C(BuffMaster___c_TypeInfo);
