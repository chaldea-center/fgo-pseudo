void __fastcall BuffMaster___ctor(BuffMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4B36EF4 & 1) == 0 )
  {
    sub_1BD3458(&Method_DataMasterBase_BuffMaster__BuffEntity__int___ctor__, method);
    byte_4B36EF4 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    56,
    (const MethodInfo_31D1EB0 *)Method_DataMasterBase_BuffMaster__BuffEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B36EF6 & 1) == 0 )
  {
    sub_1BD3458(&Method_System_Collections_Generic_List_int__Add__, effectIdList);
    this = (BuffMaster_o *)sub_1BD3458(&Method_System_Collections_Generic_List_int__Contains__, v6);
    byte_4B36EF6 = 1;
  }
  if ( effectId >= 1 )
  {
...
int32_t __fastcall BuffMaster__GetBuffGroup(BuffMaster_o *this, int32_t buffId, int32_t def, const MethodInfo *method)
{
  ...
  if ( (byte_4B36EF9 & 1) == 0 )
  {
    sub_1BD3458(&Method_DataMasterBase_BuffMaster__BuffEntity__int__TryGetEntity__, *(_QWORD *)&buffId);
    byte_4B36EF9 = 1;
  }
  entity = 0LL;
        ...
        const MethodInfo *method)
{
         ...
         (const MethodInfo_31D1F44 *)Method_DataMasterBase_BuffMaster__BuffEntity__int__TryGetEntity__) )
  {
    if ( !entity )
      sub_1BD36B4(0LL, v9);
    return BuffEntity__getScript_39790656((BuffEntity_o *)entity, key, def, v10);
  }
  return def;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B36EFA & 1) == 0 )
  {
    sub_1BD3458(&Method_BasicHelper_GetValue_string___, name);
    sub_1BD3458(&Method_DataMasterBase_BuffMaster__BuffEntity__int__TryGetEntity__, v9);
    sub_1BD3458(&StringLiteral_5414/*"DisplayCardBottomImageName"*/, v10);
    byte_4B36EFA = 1;
  }
  entity = 0LL;
  ...
  if ( v11 )
  {
    ...
    Value_object = BasicHelper__GetValue_object_(
                     ...
                     (System_String_o *)StringLiteral_5414/*"DisplayCardBottomImageName"*/,
                     (Il2CppObject *)defName,
                     (const MethodInfo_2F1F620 *)Method_BasicHelper_GetValue_string___);
  }
  *name = (System_String_o *)Value_object;
  sub_1BD33FC((PartyOrganizationUtility_o *)name, (int64_t)Value_object, v12, v13, v14, v15, v16, v17);
...
bool __fastcall BuffMaster__preProcess(BuffMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B36EF5 & 1) == 0 )
  {
    sub_1BD3458(&BuffEntity_TypeInfo, method);
...
LABEL_45:
    ...
    if ( BuffEntity__GetCardEffectId(v27, (const MethodInfo *)effectId) >= 1 )
    {
      ...
      if ( !v12 )
        sub_1BD36B4(CardEffectId, (unsigned int)CardEffectId);
