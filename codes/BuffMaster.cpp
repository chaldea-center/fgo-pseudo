void __fastcall BuffMaster___ctor(BuffMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A1F835 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataMasterBase_BuffMaster__BuffEntity__int___ctor__, method);
    byte_4A1F835 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    56,
    (const MethodInfo_30F8720 *)Method_DataMasterBase_BuffMaster__BuffEntity__int___ctor__);
}
...
int32_t __fastcall BuffMaster__GetBuffGroup(BuffMaster_o *this, int32_t buffId, int32_t def, const MethodInfo *method)
{
  ...
  if ( (byte_4A1F839 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataMasterBase_BuffMaster__BuffEntity__int__TryGetEntity__, *(_QWORD *)&buffId);
    byte_4A1F839 = 1;
  }
  entity = 0LL;
        ...
        const MethodInfo *method)
{
         ...
         (const MethodInfo_30F87B4 *)Method_DataMasterBase_BuffMaster__BuffEntity__int__TryGetEntity__) )
  {
    if ( !entity )
      sub_1B71828(0LL, v9);
    return BuffEntity__getScript_38789536((BuffEntity_o *)entity, key, def, v10);
  }
  return def;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1F83A & 1) == 0 )
  {
    sub_1B715CC(&Method_BasicHelper_GetValue_string___, name);
    sub_1B715CC(&Method_DataMasterBase_BuffMaster__BuffEntity__int__TryGetEntity__, v9);
    sub_1B715CC(&StringLiteral_5312/*"DisplayCardBottomImageName"*/, v10);
    byte_4A1F83A = 1;
  }
  entity = 0LL;
  ...
  if ( v11 )
  {
    ...
    Value_object = BasicHelper__GetValue_object_(
                     ...
                     (System_String_o *)StringLiteral_5312/*"DisplayCardBottomImageName"*/,
                     (Il2CppObject *)defName,
                     (const MethodInfo_2E49748 *)Method_BasicHelper_GetValue_string___);
  }
  *name = (System_String_o *)Value_object;
  sub_1B71570((ServantStatusBattleListViewItem_o *)name, (int32_t)Value_object, v12, v13);
...
bool __fastcall BuffMaster__preProcess(BuffMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1F836 & 1) == 0 )
  {
    sub_1B715CC(&BuffEntity_TypeInfo, method);
...
LABEL_44:
    ...
    if ( BuffEntity__GetCardEffectId(v27, (const MethodInfo *)effectId) >= 1 )
    {
      ...
      if ( !v12 )
        sub_1B71828(CardEffectId, (unsigned int)CardEffectId);
