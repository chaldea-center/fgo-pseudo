void __fastcall BuffMaster___ctor(BuffMaster_o *this, const MethodInfo *method)
{
  if ( (byte_49BABB7 & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataMasterBase_BuffMaster__BuffEntity__int___ctor__, method);
    byte_49BABB7 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    60,
    (const MethodInfo_319B678 *)Method_DataMasterBase_BuffMaster__BuffEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BABB9 & 1) == 0 )
  {
    sub_1B4CF90(&Method_System_Collections_Generic_List_int__Add__, effectIdList);
    this = (BuffMaster_o *)sub_1B4CF90(&Method_System_Collections_Generic_List_int__Contains__, v6);
    byte_49BABB9 = 1;
  }
  if ( effectId >= 1 )
  {
...
int32_t __fastcall BuffMaster__GetBuffGroup(BuffMaster_o *this, int32_t buffId, int32_t def, const MethodInfo *method)
{
  ...
  if ( (byte_49BABBC & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataMasterBase_BuffMaster__BuffEntity__int__TryGetEntity__, *(_QWORD *)&buffId);
    byte_49BABBC = 1;
  }
  entity = 0LL;
        ...
        const MethodInfo *method)
{
         ...
         (const MethodInfo_319D9E8 *)Method_DataMasterBase_BuffMaster__BuffEntity__int__TryGetEntity__) )
  {
    if ( !entity )
      sub_1B4D1EC(0LL, v9);
    return BuffEntity__getScript_39550204((BuffEntity_o *)entity, key, def, v10);
  }
  return def;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BABBD & 1) == 0 )
  {
    sub_1B4CF90(&Method_BasicHelper_GetValue_string___, name);
    sub_1B4CF90(&Method_DataMasterBase_BuffMaster__BuffEntity__int__TryGetEntity__, v9);
    sub_1B4CF90(&StringLiteral_5232/*"DisplayCardBottomImageName"*/, v10);
    byte_49BABBD = 1;
  }
  entity = 0LL;
  ...
  if ( v11 )
  {
    ...
    Value_object = BasicHelper__GetValue_object_(
                     ...
                     (System_String_o *)StringLiteral_5232/*"DisplayCardBottomImageName"*/,
                     (Il2CppObject *)defName,
                     (const MethodInfo_2EEF7D0 *)Method_BasicHelper_GetValue_string___);
  }
  *name = (System_String_o *)Value_object;
  sub_1B4CF34((CGThumbnailListItem_o *)name, (int32_t)Value_object, v12, v13);
...
bool __fastcall BuffMaster__preProcess(BuffMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BABB8 & 1) == 0 )
  {
    sub_1B4CF90(&Method_System_Collections_ObjectModel_Collection_BuffEntity__GetEnumerator__, method);
    sub_1B4CF90(&System_IDisposable_TypeInfo, v3);
    sub_1B4CF90(&System_Collections_Generic_IEnumerator_BuffEntity__TypeInfo, v4);
  ...
  Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                 list,
                 (const MethodInfo_313B4BC *)Method_System_Collections_ObjectModel_Collection_BuffEntity__GetEnumerator__);
  if ( !Enumerator )
    sub_1B4D1EC(0LL, v14);
  while ( 1 )
  {
...
LABEL_9:
    ...
    {
LABEL_16:
      v23 = sub_1B9D724(Enumerator, System_Collections_Generic_IEnumerator_BuffEntity__TypeInfo, 0LL);
    }
    ...
    if ( BuffEntity__GetCardEffectId(v26, (const MethodInfo *)effectId) >= 1 )
    {
      ...
      if ( !v11 )
        sub_1B4D1EC(CardEffectId, (unsigned int)CardEffectId);
              ...
              (const MethodInfo_3563530 *)Method_System_Collections_Generic_List_int__Contains__) )
      {
        ...
        ++v11->fields._version;
        if ( !v35 )
          sub_1B4D1EC(v34, (unsigned int)v34);
...
LABEL_47:
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields._StateEffectIdArray_k__BackingField, (int32_t)v47, v48, v49);
  return 1;
}
