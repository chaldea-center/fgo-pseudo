void __fastcall BuffMaster___ctor(BuffMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A6FBCB & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_BuffMaster__BuffEntity__int___ctor__, method);
    byte_4A6FBCB = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    56,
    (const MethodInfo_312C568 *)Method_DataMasterBase_BuffMaster__BuffEntity__int___ctor__);
}
...
int32_t __fastcall BuffMaster__GetBuffGroup(BuffMaster_o *this, int32_t buffId, int32_t def, const MethodInfo *method)
{
  ...
  if ( (byte_4A6FBCF & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_BuffMaster__BuffEntity__int__TryGetEntity__, *(_QWORD *)&buffId);
    byte_4A6FBCF = 1;
  }
  entity = 0LL;
        ...
        const MethodInfo *method)
{
         ...
         (const MethodInfo_312C5FC *)Method_DataMasterBase_BuffMaster__BuffEntity__int__TryGetEntity__) )
  {
    if ( !entity )
      sub_1B9026C(0LL, v9);
    return BuffEntity__getScript_39048860((BuffEntity_o *)entity, key, def, v10);
  }
  return def;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FBD0 & 1) == 0 )
  {
    sub_1B90010(&Method_BasicHelper_GetValue_string___, name);
    sub_1B90010(&Method_DataMasterBase_BuffMaster__BuffEntity__int__TryGetEntity__, v9);
    sub_1B90010(&StringLiteral_5332/*"DisplayCardBottomImageName"*/, v10);
    byte_4A6FBD0 = 1;
  }
  entity = 0LL;
  ...
  *name = (System_String_o *)Value_object;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)name, (int32_t)Value_object, v12, v13);
...
bool __fastcall BuffMaster__preProcess(BuffMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6FBCC & 1) == 0 )
  {
    sub_1B90010(&BuffEntity_TypeInfo, method);
...
LABEL_44:
    ...
    if ( BuffEntity__GetCardEffectId(v27, (const MethodInfo *)effectId) >= 1 )
    {
      ...
      if ( !v12 )
        sub_1B9026C(CardEffectId, (unsigned int)CardEffectId);
