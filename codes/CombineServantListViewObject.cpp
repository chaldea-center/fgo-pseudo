...
void __fastcall CombineServantListViewObject__Awake(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6A8AA & 1) == 0 )
  {
    sub_1BE4ACC(&Method_UnityEngine_Component_GetComponent_UIDragDropListViewItem___, method);
    sub_1BE4ACC(&Method_UnityEngine_GameObject_GetComponent_CombineServantListViewItemDraw___, v3);
    byte_4B6A8AA = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2FA979C *)Method_UnityEngine_GameObject_GetComponent_CombineServantListViewItemDraw___);
  ...
  v13 = UnityEngine_Component__GetComponent_object_(
          ...
          (const MethodInfo_2F4FBB4 *)Method_UnityEngine_Component_GetComponent_UIDragDropListViewItem___);
  this->fields.itemDrag = (struct UIDragDropListViewItem_o *)v13;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.itemDrag, (int64_t)v13, v14, v15, v16, v17, v18, v19);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A8AF & 1) == 0 )
  {
    sub_1BE4ACC(&Method_UnityEngine_GameObject_GetComponent_CombineServantListViewObject___, method);
  ...
  if ( ((unsigned __int8)Component_object & 1) != 0 )
  {
    if ( !DragObject
      || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                               ...
                               (const MethodInfo_2FA979C *)Method_UnityEngine_GameObject_GetComponent_CombineServantListViewObject___)) == 0LL )
    {
      sub_1BE4D28(Component_object, v6);
    }
    CombineServantListViewObject__Init_46417200((CombineServantListViewObject_o *)Component_object, 2, v7);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A8B0 & 1) == 0 )
  {
    sub_1BE4ACC(&CombineServantListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4B6A8B0 = 1;
  }
  linkItem = this->fields.linkItem;
...
LABEL_7:
  ...
  if ( v13 <= 4 )
  {
    v33 = dword_C1A998[v13];
    this->fields.dispMode = dword_C1A984[v13];
  ...
  if ( p_callbackFunc->klass )
  {
    ...
    sub_1BE4A70(p_callbackFunc, 0LL, v27, v28, v29, v30, v31, v32);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineServantListViewObject__Init_46417200(
        CombineServantListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineServantListViewObject__Init_46419404(
        CombineServantListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineServantListViewObject__Init_46419488(
        CombineServantListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
bool __fastcall CombineServantListViewObject__IsCanDrag(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6A8AE & 1) == 0 )
  {
    ...
    this = (CombineServantListViewObject_o *)sub_1BE4ACC(&UnityEngine_Object_TypeInfo, v4);
    byte_4B6A8AE = 1;
  }
...
LABEL_19:
  ...
  sub_1BE4FE8(v2->fields.linkItem);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A8B3 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_CombineServantListViewObject_OnClickSelect__, v5);
    sub_1BE4ACC(&StringLiteral_10019/*"OnClickSelectBase"*/, v6);
    sub_1BE4ACC(&StringLiteral_10021/*"OnClickSelectMaterial"*/, v7);
    this = (CombineServantListViewObject_o *)sub_1BE4ACC(&StringLiteral_10023/*"OnClickSelectPush"*/, v8);
    byte_4B6A8B3 = 1;
  }
        ...
        if ( modeKind != 3 )
        {
          if ( modeKind == 2 )
          {
            ...
            if ( (*((_BYTE *)Method_CombineServantListViewObject_OnClickSelect__ + 83) & 2) != 0 )
              v22 = (_QWORD *)sub_1BE4AE4(Method_CombineServantListViewObject_OnClickSelect__);
            v17 = (System_Reflection_MethodBase_o *)sub_1BE4AB0(v22, v22[4]);
            if ( !v21 )
            {
...
LABEL_23:
          ...
          if ( modeKind == 1 )
          {
            ...
            if ( (*((_BYTE *)Method_CombineServantListViewObject_OnClickSelect__ + 83) & 2) != 0 )
              v16 = (_QWORD *)sub_1BE4AE4(Method_CombineServantListViewObject_OnClickSelect__);
          ...
          switch ( linkItem->fields.type )
          {
            ...
            case 0xC:
              if ( !CombineServantListViewItem__get_IsCanNotBaseSelect(linkItem, 0LL) || linkItem->fields.isBaseSvt )
              {
                ...
                if ( this )
                {
                  v23 = &StringLiteral_10019/*"OnClickSelectBase"*/;
LABEL_31:
            ...
            case 5:
              ...
              if ( linkItem->fields.isMaterialSvt )
              {
                ...
                if ( (*((_BYTE *)Method_CombineServantListViewObject_OnClickSelect__ + 83) & 2) != 0 )
                  v24 = (_QWORD *)sub_1BE4AE4(Method_CombineServantListViewObject_OnClickSelect__);
                v25 = 1;
              }
              else
              {
              ...
              v26 = (System_Reflection_MethodBase_o *)sub_1BE4AB0(v24, v24[4]);
              OverwriteAssetSoundName__PlaySystemSe(v26, v25, 0LL);
              this = (CombineServantListViewObject_o *)v3->fields.manager;
              if ( !this )
                goto LABEL_52;
              v23 = &StringLiteral_10021/*"OnClickSelectMaterial"*/;
              goto LABEL_31;
            default:
              return;
          }
...
LABEL_17:
          ...
          if ( (*((_BYTE *)Method_CombineServantListViewObject_OnClickSelect__ + 83) & 2) != 0 )
            v19 = (_QWORD *)sub_1BE4AE4(Method_CombineServantListViewObject_OnClickSelect__);
          v17 = (System_Reflection_MethodBase_o *)sub_1BE4AB0(v19, v19[4]);
          goto LABEL_23;
        }
        this = (CombineServantListViewObject_o *)v3->fields.manager;
        if ( this )
        {
          v23 = &StringLiteral_10023/*"OnClickSelectPush"*/;
          goto LABEL_31;
        }
LABEL_52:
        sub_1BE4D28(this, v10);
      }
    }
    else
    {
      sub_1BE4FE8(v3->fields.linkItem);
    }
    sub_1BE4FE8(manager);
    goto LABEL_52;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A8B4 & 1) == 0 )
  {
    sub_1BE4ACC(&CombineServantListViewItem_TypeInfo, method);
    sub_1BE4ACC(&CombineServantListViewManager_TypeInfo, v3);
    sub_1BE4ACC(&StringLiteral_10078/*"OnLongPushListView"*/, v4);
    this = (CombineServantListViewObject_o *)sub_1BE4ACC(&StringLiteral_10096/*"OnPressCancel"*/, v5);
    byte_4B6A8B4 = 1;
  }
  ...
  if ( linkItem )
  {
      ...
      && (CombineServantListViewItem_c *)linkItem->klass->_2.typeHierarchy[methodPtr_low - 1] == CombineServantListViewItem_TypeInfo )
    {
      ...
      else
      {
        ...
        if ( this )
        {
          UnityEngine_GameObject__SendMessage_70433460(
            (UnityEngine_GameObject_o *)this,
            (System_String_o *)StringLiteral_10096/*"OnPressCancel"*/,
            0LL);
          ...
          if ( this )
          {
            UnityEngine_Component__SendMessage(
              (UnityEngine_Component_o *)this,
              (System_String_o *)StringLiteral_10078/*"OnLongPushListView"*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A8B6 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&UnityEngine_Object_TypeInfo, v3);
    sub_1BE4ACC(&StringLiteral_10078/*"OnLongPushListView"*/, v4);
    sub_1BE4ACC(&StringLiteral_4132/*"CancelDragEnd"*/, v5);
    byte_4B6A8B6 = 1;
  }
    ...
    if ( manager )
    {
        ...
        && (CombineServantListViewManager_c *)manager->klass->_2.typeHierarchy[methodPtr_low - 1] == CombineServantListViewManager_TypeInfo )
      {
        if ( HIDWORD(manager[7].fields.mListViewObject) )
          return;
        UnityEngine_Component__SendMessage_70423240(
          (UnityEngine_Component_o *)manager,
          (System_String_o *)StringLiteral_4132/*"CancelDragEnd"*/,
          0LL);
        manager = (UIDragDropListViewItem_o *)this->fields.manager;
        if ( manager )
        {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A8AD & 1) == 0 )
  {
    sub_1BE4ACC(&CombineServantListViewItem_TypeInfo, isInput);
...
void __fastcall CombineServantListViewObject__SetItem_46417612(
        CombineServantListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall CombineServantListViewObject__SetupDisp(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( manager )
  {
    ...
    if ( LOBYTE(manager->klass->vtable._0_Equals.methodPtr) < (unsigned int)methodPtr_low
      || (CombineServantListViewManager_c *)manager->klass->_2.typeHierarchy[methodPtr_low - 1] != CombineServantListViewManager_TypeInfo )
    {
      sub_1BE4FE8(this->fields.manager);
      goto LABEL_26;
    }
  }
  linkItem = this->fields.linkItem;
  ...
  {
LABEL_26:
    v21 = sub_1BE4FE8(linkItem);
    CombineServantListViewObject__Init_46419404(v17, v18, v19, *(float *)&v21, v20);
    return;
  }
...
LABEL_24:
    sub_1BE4D28(IsSelectEnable, v12);
  }
}
...
void __fastcall CombineServantListViewObject__Start(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    CombineServantListViewObject__Init_46417200(this, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A8B2 & 1) == 0 )
  {
    sub_1BE4ACC(&CombineServantListViewItemDraw_DispMode_TypeInfo, method);
