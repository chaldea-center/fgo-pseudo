...
void __fastcall CombineServantListViewObject__Awake(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB98F5 & 1) == 0 )
  {
    sub_1BAB41C(&Method_UnityEngine_Component_GetComponent_UIDragDropListViewItem___, method);
    sub_1BAB41C(&Method_UnityEngine_GameObject_GetComponent_CombineServantListViewItemDraw___, v3);
    byte_4AB98F5 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2F13970 *)Method_UnityEngine_GameObject_GetComponent_CombineServantListViewItemDraw___);
  ...
  v9 = UnityEngine_Component__GetComponent_object_(
         ...
         (const MethodInfo_2EBAE18 *)Method_UnityEngine_Component_GetComponent_UIDragDropListViewItem___);
  this->fields.itemDrag = (struct UIDragDropListViewItem_o *)v9;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.itemDrag, (int32_t)v9, v10, v11);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB98FA & 1) == 0 )
  {
    sub_1BAB41C(&Method_UnityEngine_GameObject_GetComponent_CombineServantListViewObject___, method);
  ...
  if ( ((unsigned __int8)Component_object & 1) != 0 )
  {
    if ( !DragObject
      || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                               ...
                               (const MethodInfo_2F13970 *)Method_UnityEngine_GameObject_GetComponent_CombineServantListViewObject___)) == 0LL )
    {
      sub_1BAB678(Component_object, v6);
    }
    CombineServantListViewObject__Init_45751120((CombineServantListViewObject_o *)Component_object, 2, v7);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB98FB & 1) == 0 )
  {
    sub_1BAB41C(&CombineServantListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4AB98FB = 1;
  }
  linkItem = this->fields.linkItem;
...
LABEL_7:
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.callbackFunc, (int32_t)callbackFunc, v20, v21);
  if ( v13 <= 4 )
  {
    v25 = dword_BFBD00[v13];
    this->fields.dispMode = dword_BFBCEC[v13];
  ...
  if ( p_callbackFunc->klass )
  {
    ...
    sub_1BAB3C0(p_callbackFunc, 0, v23, v24);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineServantListViewObject__Init_45751120(
        CombineServantListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineServantListViewObject__Init_45753324(
        CombineServantListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineServantListViewObject__Init_45753408(
        CombineServantListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
bool __fastcall CombineServantListViewObject__IsCanDrag(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB98F9 & 1) == 0 )
  {
    ...
    this = (CombineServantListViewObject_o *)sub_1BAB41C(&UnityEngine_Object_TypeInfo, v4);
    byte_4AB98F9 = 1;
  }
...
LABEL_19:
  ...
  sub_1BAB938(v2->fields.linkItem);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB98FE & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_CombineServantListViewObject_OnClickSelect__, v5);
    sub_1BAB41C(&StringLiteral_9869/*"OnClickSelectBase"*/, v6);
    sub_1BAB41C(&StringLiteral_9871/*"OnClickSelectMaterial"*/, v7);
    this = (CombineServantListViewObject_o *)sub_1BAB41C(&StringLiteral_9873/*"OnClickSelectPush"*/, v8);
    byte_4AB98FE = 1;
  }
        ...
        if ( modeKind != 3 )
        {
          if ( modeKind == 2 )
          {
            ...
            if ( (*((_BYTE *)Method_CombineServantListViewObject_OnClickSelect__ + 83) & 2) != 0 )
              v22 = (_QWORD *)sub_1BAB434(Method_CombineServantListViewObject_OnClickSelect__);
            v17 = (System_Reflection_MethodBase_o *)sub_1BAB400(v22, v22[4]);
            if ( !v21 )
            {
...
LABEL_23:
          ...
          if ( modeKind == 1 )
          {
            ...
            if ( (*((_BYTE *)Method_CombineServantListViewObject_OnClickSelect__ + 83) & 2) != 0 )
              v16 = (_QWORD *)sub_1BAB434(Method_CombineServantListViewObject_OnClickSelect__);
...
LABEL_31:
            ...
            case 5:
              ...
              if ( linkItem->fields.isMaterialSvt )
              {
                ...
                if ( (*((_BYTE *)Method_CombineServantListViewObject_OnClickSelect__ + 83) & 2) != 0 )
                  v24 = (_QWORD *)sub_1BAB434(Method_CombineServantListViewObject_OnClickSelect__);
                v25 = 1;
              }
              else
              {
              ...
              v26 = (System_Reflection_MethodBase_o *)sub_1BAB400(v24, v24[4]);
...
LABEL_17:
          ...
          if ( (*((_BYTE *)Method_CombineServantListViewObject_OnClickSelect__ + 83) & 2) != 0 )
            v19 = (_QWORD *)sub_1BAB434(Method_CombineServantListViewObject_OnClickSelect__);
          v17 = (System_Reflection_MethodBase_o *)sub_1BAB400(v19, v19[4]);
          goto LABEL_23;
        }
        this = (CombineServantListViewObject_o *)v3->fields.manager;
        if ( this )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB98FF & 1) == 0 )
  {
    sub_1BAB41C(&CombineServantListViewItem_TypeInfo, method);
    sub_1BAB41C(&CombineServantListViewManager_TypeInfo, v3);
    sub_1BAB41C(&StringLiteral_9928/*"OnLongPushListView"*/, v4);
    this = (CombineServantListViewObject_o *)sub_1BAB41C(&StringLiteral_9946/*"OnPressCancel"*/, v5);
    byte_4AB98FF = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9901 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&UnityEngine_Object_TypeInfo, v3);
    sub_1BAB41C(&StringLiteral_9928/*"OnLongPushListView"*/, v4);
    sub_1BAB41C(&StringLiteral_4053/*"CancelDragEnd"*/, v5);
    byte_4AB9901 = 1;
  }
    ...
    if ( manager )
    {
        ...
        && (CombineServantListViewManager_c *)manager->klass->_2.typeHierarchy[methodPtr_low - 1] == CombineServantListViewManager_TypeInfo )
      {
        if ( HIDWORD(manager[7].fields.mListViewObject) )
          return;
        UnityEngine_Component__SendMessage_69771860(
          (UnityEngine_Component_o *)manager,
          (System_String_o *)StringLiteral_4053/*"CancelDragEnd"*/,
          0LL);
        manager = (UIDragDropListViewItem_o *)this->fields.manager;
        if ( manager )
        {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB98F8 & 1) == 0 )
  {
    sub_1BAB41C(&CombineServantListViewItem_TypeInfo, isInput);
...
void __fastcall CombineServantListViewObject__SetItem_45751532(
        CombineServantListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall CombineServantListViewObject__SetupDisp(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( manager )
  {
    ...
    if ( LOBYTE(manager->klass->vtable._0_Equals.methodPtr) < (unsigned int)methodPtr_low
      || (CombineServantListViewManager_c *)manager->klass->_2.typeHierarchy[methodPtr_low - 1] != CombineServantListViewManager_TypeInfo )
    {
      sub_1BAB938(this->fields.manager);
      goto LABEL_26;
    }
  }
  linkItem = this->fields.linkItem;
  ...
  {
LABEL_26:
    v21 = sub_1BAB938(linkItem);
    CombineServantListViewObject__Init_45753324(v17, v18, v19, *(float *)&v21, v20);
    return;
  }
...
LABEL_24:
    sub_1BAB678(IsSelectEnable, v12);
  }
}
...
void __fastcall CombineServantListViewObject__Start(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    CombineServantListViewObject__Init_45751120(this, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB98FD & 1) == 0 )
  {
    sub_1BAB41C(&CombineServantListViewItemDraw_DispMode_TypeInfo, method);
