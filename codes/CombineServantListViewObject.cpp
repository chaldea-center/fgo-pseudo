...
void CombineServantListViewObject__Awake(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB02C6 & 1) == 0 )
  {
    sub_1C6BA08(&Method_UnityEngine_Component_GetComponent_UIDragDropListViewItem___);
    sub_1C6BA08(&Method_UnityEngine_GameObject_GetComponent_CombineServantListViewItemDraw___);
    byte_4CB02C6 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_319312C *)Method_UnityEngine_GameObject_GetComponent_CombineServantListViewItemDraw___);
  ...
  v6 = UnityEngine_Component__GetComponent_object_(
         ...
         (const MethodInfo_3131B38 *)Method_UnityEngine_Component_GetComponent_UIDragDropListViewItem___);
  this->fields.itemDrag = (struct UIDragDropListViewItem_o *)v6;
  sub_1C6B9AC(&this->fields.itemDrag, v6);
}
  ...
  if ( ((unsigned __int8)Component_object & 1) != 0 )
  {
    if ( !DragObject
      || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                               ...
                               (const MethodInfo_319312C *)Method_UnityEngine_GameObject_GetComponent_CombineServantListViewObject___)) == 0 )
    {
      sub_1C6BC60(Component_object, v5);
    }
    CombineServantListViewObject__Init_31630920((CombineServantListViewObject_o *)Component_object, 2, v6);
  }
...
LABEL_7:
  ...
  {
    v21 = dword_D1E9C8[v13];
    this->fields.dispMode = dword_D1E9B4[v13];
...
void CombineServantListViewObject__Init_31630920(
        CombineServantListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void CombineServantListViewObject__Init_31633124(
        CombineServantListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void CombineServantListViewObject__Init_31633208(
        CombineServantListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
bool CombineServantListViewObject__IsCanDrag(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB02CA & 1) == 0 )
  {
    ...
    this = (CombineServantListViewObject_o *)sub_1C6BA08(&UnityEngine_Object_TypeInfo);
    byte_4CB02CA = 1;
  }
  ...
  {
    this = (CombineServantListViewObject_o *)sub_1C6BFFC(v2->fields.manager);
    goto LABEL_19;
  }
...
LABEL_19:
  ...
  v9 = (CombineServantListViewObject_o *)sub_1C6BFFC(v2->fields.linkItem);
...
void CombineServantListViewObject__OnClickSelect(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB02CF & 1) == 0 )
  {
    sub_1C6BA08(&CombineServantListViewItem_TypeInfo);
    sub_1C6BA08(&CombineServantListViewManager_TypeInfo);
    sub_1C6BA08(&Method_CombineServantListViewObject_OnClickSelect__);
    sub_1C6BA08(&StringLiteral_9863/*"OnClickSelectBase"*/);
    sub_1C6BA08(&StringLiteral_9865/*"OnClickSelectMaterial"*/);
    this = (CombineServantListViewObject_o *)sub_1C6BA08(&StringLiteral_9867/*"OnClickSelectPush"*/);
    byte_4CB02CF = 1;
  }
        ...
        if ( modeKind != 3 )
        {
          if ( modeKind == 2 )
          {
            ...
            if ( (*((_BYTE *)Method_CombineServantListViewObject_OnClickSelect__ + 83) & 2) != 0 )
              v17 = (_QWORD *)sub_1C6BA20(Method_CombineServantListViewObject_OnClickSelect__);
            v12 = (System_Reflection_MethodBase_o *)sub_1C6B9EC(v17, v17[4]);
            if ( !v16 )
            {
...
LABEL_23:
          ...
          if ( modeKind == 1 )
          {
            ...
            if ( (*((_BYTE *)Method_CombineServantListViewObject_OnClickSelect__ + 83) & 2) != 0 )
              v11 = (_QWORD *)sub_1C6BA20(Method_CombineServantListViewObject_OnClickSelect__);
...
LABEL_31:
            ...
            case 5:
              ...
              if ( linkItem->fields.isMaterialSvt )
              {
                ...
                if ( (*((_BYTE *)Method_CombineServantListViewObject_OnClickSelect__ + 83) & 2) != 0 )
                  v19 = (_QWORD *)sub_1C6BA20(Method_CombineServantListViewObject_OnClickSelect__);
                v20 = 1;
              }
              else
              {
              ...
              v21 = (System_Reflection_MethodBase_o *)sub_1C6B9EC(v19, v19[4]);
...
LABEL_17:
          ...
          if ( (*((_BYTE *)Method_CombineServantListViewObject_OnClickSelect__ + 83) & 2) != 0 )
            v14 = (_QWORD *)sub_1C6BA20(Method_CombineServantListViewObject_OnClickSelect__);
          v12 = (System_Reflection_MethodBase_o *)sub_1C6B9EC(v14, v14[4]);
          goto LABEL_23;
        }
        this = (CombineServantListViewObject_o *)v3->fields.manager;
        if ( this )
...
LABEL_52:
    ...
    this = (CombineServantListViewObject_o *)sub_1C6BFFC(manager);
    goto LABEL_52;
  }
}
...
void CombineServantListViewObject__OnDragDropStart(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( manager->klass->_2.naturalAligment < (unsigned int)naturalAligment
    || (CombineServantListViewManager_c *)manager->klass->_2.typeHierarchy[naturalAligment - 1] != CombineServantListViewManager_TypeInfo )
  {
    manager = (UITouchPress_o *)sub_1C6BFFC(manager);
    goto LABEL_14;
  }
...
void CombineServantListViewObject__OnLongPush(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB02D0 & 1) == 0 )
  {
    ...
    this = (CombineServantListViewObject_o *)sub_1C6BA08(&StringLiteral_9942/*"OnPressCancel"*/);
    byte_4CB02D0 = 1;
  }
  ...
  if ( linkItem )
  {
      ...
      && (CombineServantListViewItem_c *)linkItem->klass->_2.typeHierarchy[naturalAligment - 1] == CombineServantListViewItem_TypeInfo )
    {
      ...
      if ( manager )
      {
        ...
        if ( manager->klass->_2.naturalAligment < (unsigned int)v7
          || (CombineServantListViewManager_c *)manager->klass->_2.typeHierarchy[v7 - 1] != CombineServantListViewManager_TypeInfo )
        {
          v10 = (CombineServantListViewObject_o *)sub_1C6BFFC(v2->fields.manager);
    ...
    {
      this = (CombineServantListViewObject_o *)sub_1C6BFFC(v2->fields.linkItem);
    }
    sub_1C6BC60(this, v4);
  }
}
...
void CombineServantListViewObject__OnLongRelease(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB02D2 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&UnityEngine_Object_TypeInfo);
    sub_1C6BA08(&StringLiteral_9924/*"OnLongPushListView"*/);
    sub_1C6BA08(&StringLiteral_4025/*"CancelDragEnd"*/);
    byte_4CB02D2 = 1;
  }
    ...
    if ( manager )
    {
        ...
        && (CombineServantListViewManager_c *)manager->klass->_2.typeHierarchy[naturalAligment - 1] == CombineServantListViewManager_TypeInfo )
      {
        ...
        UnityEngine_Component__SendMessage_71630888(
          ...
          (System_String_o *)StringLiteral_4025/*"CancelDragEnd"*/,
          0);
        manager = (UIDragDropListViewItem_o *)this->fields.manager;
        if ( manager )
        {
      ...
      {
        manager = (UIDragDropListViewItem_o *)sub_1C6BFFC(manager);
      }
    }
LABEL_17:
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)itemDraw, 0, 0) )
  {
    ...
    v11 = (CombineServantListViewObject_o *)sub_1C6BFFC(itemDraw);
...
void CombineServantListViewObject__SetItem_31631332(
        CombineServantListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void CombineServantListViewObject__SetupDisp(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( manager )
  {
    ...
    if ( manager->klass->_2.naturalAligment < (unsigned int)naturalAligment
      || (CombineServantListViewManager_c *)manager->klass->_2.typeHierarchy[naturalAligment - 1] != CombineServantListViewManager_TypeInfo )
    {
      sub_1C6BFFC(this->fields.manager);
      goto LABEL_26;
    }
  }
  linkItem = this->fields.linkItem;
  ...
  {
LABEL_26:
    v15 = (CombineServantListViewObject_o *)sub_1C6BFFC(linkItem);
    CombineServantListViewObject__Init_31633124(v15, v16, v17, v19, v18);
    return;
  }
...
LABEL_24:
    sub_1C6BC60(IsSelectEnable, v10);
  }
}
...
void CombineServantListViewObject__Start(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    CombineServantListViewObject__Init_31630920(this, 2, v2);
}
...
System_String_o *CombineServantListViewObject__ToString(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB02CE & 1) == 0 )
  {
    sub_1C6BA08(&CombineServantListViewItemDraw_DispMode_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v11 = (CombineServantListViewObject_o *)sub_1C6BFFC(v8);
