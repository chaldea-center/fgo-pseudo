...
void __fastcall CombineServantListViewObject__Awake(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3AE11 & 1) == 0 )
  {
    sub_1BD3458(&Method_UnityEngine_Component_GetComponent_UIDragDropListViewItem___, method);
    sub_1BD3458(&Method_UnityEngine_GameObject_GetComponent_CombineServantListViewItemDraw___, v3);
    byte_4B3AE11 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2F81A7C *)Method_UnityEngine_GameObject_GetComponent_CombineServantListViewItemDraw___);
  ...
  v13 = UnityEngine_Component__GetComponent_object_(
          ...
          (const MethodInfo_2F28128 *)Method_UnityEngine_Component_GetComponent_UIDragDropListViewItem___);
  this->fields.itemDrag = (struct UIDragDropListViewItem_o *)v13;
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.itemDrag, (int64_t)v13, v14, v15, v16, v17, v18, v19);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3AE16 & 1) == 0 )
  {
    sub_1BD3458(&Method_UnityEngine_GameObject_GetComponent_CombineServantListViewObject___, method);
  ...
  if ( ((unsigned __int8)Component_object & 1) != 0 )
  {
    if ( !DragObject
      || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                               ...
                               (const MethodInfo_2F81A7C *)Method_UnityEngine_GameObject_GetComponent_CombineServantListViewObject___)) == 0LL )
    {
      sub_1BD36B4(Component_object, v6);
    }
    CombineServantListViewObject__Init_46254796((CombineServantListViewObject_o *)Component_object, 2, v7);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3AE17 & 1) == 0 )
  {
    sub_1BD3458(&CombineServantListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4B3AE17 = 1;
  }
  linkItem = this->fields.linkItem;
...
LABEL_7:
  ...
  if ( v13 <= 4 )
  {
    v33 = dword_C10854[v13];
    this->fields.dispMode = dword_C10840[v13];
  ...
  if ( p_callbackFunc->klass )
  {
    ...
    sub_1BD33FC(p_callbackFunc, 0LL, v27, v28, v29, v30, v31, v32);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineServantListViewObject__Init_46254796(
        CombineServantListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineServantListViewObject__Init_46257000(
        CombineServantListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineServantListViewObject__Init_46257084(
        CombineServantListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
bool __fastcall CombineServantListViewObject__IsCanDrag(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3AE15 & 1) == 0 )
  {
    ...
    this = (CombineServantListViewObject_o *)sub_1BD3458(&UnityEngine_Object_TypeInfo, v4);
    byte_4B3AE15 = 1;
  }
...
LABEL_19:
  ...
  sub_1BD3974(v2->fields.linkItem);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3AE1A & 1) == 0 )
  {
    ...
    sub_1BD3458(&Method_CombineServantListViewObject_OnClickSelect__, v5);
    sub_1BD3458(&StringLiteral_10010/*"OnClickSelectBase"*/, v6);
    sub_1BD3458(&StringLiteral_10012/*"OnClickSelectMaterial"*/, v7);
    this = (CombineServantListViewObject_o *)sub_1BD3458(&StringLiteral_10014/*"OnClickSelectPush"*/, v8);
    byte_4B3AE1A = 1;
  }
        ...
        if ( modeKind != 3 )
        {
          if ( modeKind == 2 )
          {
            ...
            if ( (*((_BYTE *)Method_CombineServantListViewObject_OnClickSelect__ + 83) & 2) != 0 )
              v22 = (_QWORD *)sub_1BD3470(Method_CombineServantListViewObject_OnClickSelect__);
            v17 = (System_Reflection_MethodBase_o *)sub_1BD343C(v22, v22[4]);
            if ( !v21 )
            {
...
LABEL_23:
          ...
          if ( modeKind == 1 )
          {
            ...
            if ( (*((_BYTE *)Method_CombineServantListViewObject_OnClickSelect__ + 83) & 2) != 0 )
              v16 = (_QWORD *)sub_1BD3470(Method_CombineServantListViewObject_OnClickSelect__);
          ...
          switch ( linkItem->fields.type )
          {
            ...
            case 0xC:
              if ( !CombineServantListViewItem__get_IsCanNotBaseSelect(linkItem, 0LL) || linkItem->fields.isBaseSvt )
              {
                ...
                if ( this )
                {
                  v23 = &StringLiteral_10010/*"OnClickSelectBase"*/;
LABEL_31:
            ...
            case 5:
              ...
              if ( linkItem->fields.isMaterialSvt )
              {
                ...
                if ( (*((_BYTE *)Method_CombineServantListViewObject_OnClickSelect__ + 83) & 2) != 0 )
                  v24 = (_QWORD *)sub_1BD3470(Method_CombineServantListViewObject_OnClickSelect__);
                v25 = 1;
              }
              else
              {
              ...
              v26 = (System_Reflection_MethodBase_o *)sub_1BD343C(v24, v24[4]);
              OverwriteAssetSoundName__PlaySystemSe(v26, v25, 0LL);
              this = (CombineServantListViewObject_o *)v3->fields.manager;
              if ( !this )
                goto LABEL_52;
              v23 = &StringLiteral_10012/*"OnClickSelectMaterial"*/;
              goto LABEL_31;
            default:
              return;
          }
...
LABEL_17:
          ...
          if ( (*((_BYTE *)Method_CombineServantListViewObject_OnClickSelect__ + 83) & 2) != 0 )
            v19 = (_QWORD *)sub_1BD3470(Method_CombineServantListViewObject_OnClickSelect__);
          v17 = (System_Reflection_MethodBase_o *)sub_1BD343C(v19, v19[4]);
          goto LABEL_23;
        }
        this = (CombineServantListViewObject_o *)v3->fields.manager;
        if ( this )
        {
          v23 = &StringLiteral_10014/*"OnClickSelectPush"*/;
          goto LABEL_31;
        }
LABEL_52:
        sub_1BD36B4(this, v10);
      }
    }
    else
    {
      sub_1BD3974(v3->fields.linkItem);
    }
    sub_1BD3974(manager);
    goto LABEL_52;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3AE1B & 1) == 0 )
  {
    sub_1BD3458(&CombineServantListViewItem_TypeInfo, method);
    sub_1BD3458(&CombineServantListViewManager_TypeInfo, v3);
    sub_1BD3458(&StringLiteral_10069/*"OnLongPushListView"*/, v4);
    this = (CombineServantListViewObject_o *)sub_1BD3458(&StringLiteral_10087/*"OnPressCancel"*/, v5);
    byte_4B3AE1B = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3AE1D & 1) == 0 )
  {
    ...
    sub_1BD3458(&UnityEngine_Object_TypeInfo, v3);
    sub_1BD3458(&StringLiteral_10069/*"OnLongPushListView"*/, v4);
    sub_1BD3458(&StringLiteral_4129/*"CancelDragEnd"*/, v5);
    byte_4B3AE1D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3AE14 & 1) == 0 )
  {
    sub_1BD3458(&CombineServantListViewItem_TypeInfo, isInput);
...
void __fastcall CombineServantListViewObject__SetItem_46255208(
        CombineServantListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall CombineServantListViewObject__SetupDisp(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
LABEL_26:
    v21 = sub_1BD3974(linkItem);
    CombineServantListViewObject__Init_46257000(v17, v18, v19, *(float *)&v21, v20);
    return;
  }
...
LABEL_24:
    sub_1BD36B4(IsSelectEnable, v12);
  }
}
...
void __fastcall CombineServantListViewObject__Start(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    CombineServantListViewObject__Init_46254796(this, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3AE19 & 1) == 0 )
  {
    sub_1BD3458(&CombineServantListViewItemDraw_DispMode_TypeInfo, method);
