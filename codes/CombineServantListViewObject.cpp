...
void CombineServantListViewObject__Awake(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C50D7E & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_UnityEngine_GameObject_GetComponent_CombineServantListViewItemDraw___);
    byte_4C50D7E = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_31510CC *)Method_UnityEngine_GameObject_GetComponent_CombineServantListViewItemDraw___);
  ...
  if ( ((unsigned __int8)Component_object & 1) != 0 )
  {
    if ( !DragObject
      || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                               ...
                               (const MethodInfo_31510CC *)Method_UnityEngine_GameObject_GetComponent_CombineServantListViewObject___)) == 0 )
    {
      sub_1C3E7C0(Component_object, v5);
    }
    CombineServantListViewObject__Init_31451484((CombineServantListViewObject_o *)Component_object, 2, v6);
  }
...
LABEL_7:
  ...
  {
    v21 = dword_C49BD0[v13];
    this->fields.dispMode = dword_C49BBC[v13];
...
void CombineServantListViewObject__Init_31451484(
        CombineServantListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void CombineServantListViewObject__Init_31453688(
        CombineServantListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void CombineServantListViewObject__Init_31453772(
        CombineServantListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
bool CombineServantListViewObject__IsCanDrag(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C50D82 & 1) == 0 )
  {
    ...
    this = (CombineServantListViewObject_o *)sub_1C3E564(&UnityEngine_Object_TypeInfo);
    byte_4C50D82 = 1;
  }
  ...
  {
    this = (CombineServantListViewObject_o *)sub_1C3EA80(v2->fields.manager);
    goto LABEL_19;
  }
...
LABEL_19:
  ...
  v9 = (CombineServantListViewObject_o *)sub_1C3EA80(v2->fields.linkItem);
...
void CombineServantListViewObject__OnClickSelect(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C50D87 & 1) == 0 )
  {
    sub_1C3E564(&CombineServantListViewItem_TypeInfo);
    sub_1C3E564(&CombineServantListViewManager_TypeInfo);
    sub_1C3E564(&Method_CombineServantListViewObject_OnClickSelect__);
    sub_1C3E564(&StringLiteral_9867/*"OnClickSelectBase"*/);
    sub_1C3E564(&StringLiteral_9869/*"OnClickSelectMaterial"*/);
    this = (CombineServantListViewObject_o *)sub_1C3E564(&StringLiteral_9871/*"OnClickSelectPush"*/);
    byte_4C50D87 = 1;
  }
        ...
        if ( modeKind != 3 )
        {
          if ( modeKind == 2 )
          {
            ...
            if ( (*((_BYTE *)Method_CombineServantListViewObject_OnClickSelect__ + 83) & 2) != 0 )
              v17 = (_QWORD *)sub_1C3E57C(Method_CombineServantListViewObject_OnClickSelect__);
            v12 = (System_Reflection_MethodBase_o *)sub_1C3E548(v17, v17[4]);
            if ( !v16 )
            {
...
LABEL_23:
          ...
          if ( modeKind == 1 )
          {
            ...
            if ( (*((_BYTE *)Method_CombineServantListViewObject_OnClickSelect__ + 83) & 2) != 0 )
              v11 = (_QWORD *)sub_1C3E57C(Method_CombineServantListViewObject_OnClickSelect__);
          ...
          switch ( linkItem->fields.type )
          {
            ...
            case 0xC:
              if ( !CombineServantListViewItem__get_IsCanNotBaseSelect(linkItem, 0) || linkItem->fields.isBaseSvt )
              {
                ...
                if ( this )
                {
                  v18 = &StringLiteral_9867/*"OnClickSelectBase"*/;
LABEL_31:
            ...
            case 5:
              ...
              if ( linkItem->fields.isMaterialSvt )
              {
                ...
                if ( (*((_BYTE *)Method_CombineServantListViewObject_OnClickSelect__ + 83) & 2) != 0 )
                  v19 = (_QWORD *)sub_1C3E57C(Method_CombineServantListViewObject_OnClickSelect__);
                v20 = 1;
              }
              else
              {
              ...
              v21 = (System_Reflection_MethodBase_o *)sub_1C3E548(v19, v19[4]);
              OverwriteAssetSoundName__PlaySystemSe(v21, v20, 0, 0);
              this = (CombineServantListViewObject_o *)v3->fields.manager;
              if ( !this )
                goto LABEL_52;
              v18 = &StringLiteral_9869/*"OnClickSelectMaterial"*/;
              goto LABEL_31;
            default:
              return;
          }
...
LABEL_17:
          ...
          if ( (*((_BYTE *)Method_CombineServantListViewObject_OnClickSelect__ + 83) & 2) != 0 )
            v14 = (_QWORD *)sub_1C3E57C(Method_CombineServantListViewObject_OnClickSelect__);
          v12 = (System_Reflection_MethodBase_o *)sub_1C3E548(v14, v14[4]);
          goto LABEL_23;
        }
        this = (CombineServantListViewObject_o *)v3->fields.manager;
        if ( this )
        {
          v18 = &StringLiteral_9871/*"OnClickSelectPush"*/;
          goto LABEL_31;
        }
LABEL_52:
        sub_1C3E7C0(this, v5);
    ...
    this = (CombineServantListViewObject_o *)sub_1C3EA80(manager);
    goto LABEL_52;
  }
}
...
void CombineServantListViewObject__OnLongPush(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C50D88 & 1) == 0 )
  {
    ...
    this = (CombineServantListViewObject_o *)sub_1C3E564(&StringLiteral_9946/*"OnPressCancel"*/);
    byte_4C50D88 = 1;
  }
  ...
  if ( linkItem )
  {
      ...
      && (CombineServantListViewItem_c *)linkItem->klass->_2.typeHierarchy[naturalAligment - 1] == CombineServantListViewItem_TypeInfo )
    {
      ...
      if ( manager )
      {
        ...
        if ( manager->klass->_2.naturalAligment < (unsigned int)v7
          || (CombineServantListViewManager_c *)manager->klass->_2.typeHierarchy[v7 - 1] != CombineServantListViewManager_TypeInfo )
        {
          v10 = (CombineServantListViewObject_o *)sub_1C3EA80(v2->fields.manager);
    ...
    {
      this = (CombineServantListViewObject_o *)sub_1C3EA80(v2->fields.linkItem);
    }
    sub_1C3E7C0(this, v4);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)itemDraw, 0, 0) )
  {
    ...
    v11 = (CombineServantListViewObject_o *)sub_1C3EA80(itemDraw);
...
void CombineServantListViewObject__SetItem_31451896(
        CombineServantListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void CombineServantListViewObject__SetupDisp(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
LABEL_26:
    v15 = (CombineServantListViewObject_o *)sub_1C3EA80(linkItem);
    CombineServantListViewObject__Init_31453688(v15, v16, v17, v19, v18);
    return;
  }
...
LABEL_24:
    sub_1C3E7C0(IsSelectEnable, v10);
  }
}
...
void CombineServantListViewObject__Start(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    CombineServantListViewObject__Init_31451484(this, 2, v2);
}
...
System_String_o *CombineServantListViewObject__ToString(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C50D86 & 1) == 0 )
  {
    sub_1C3E564(&CombineServantListViewItemDraw_DispMode_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v11 = (CombineServantListViewObject_o *)sub_1C3EA80(v8);
