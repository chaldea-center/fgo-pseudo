...
void CombineServantListViewObject__Awake(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_593221E & 1) == 0 )
  {
    ...
    sub_21FFC50(&Method_UnityEngine_GameObject_GetComponent_CombineServantListViewItemDraw___);
    byte_593221E = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_3883A78 *)Method_UnityEngine_GameObject_GetComponent_CombineServantListViewItemDraw___);
  ...
  if ( ((unsigned __int8)Component_object & 1) != 0 )
  {
    if ( !DragObject
      || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                               ...
                               (const MethodInfo_3883A78 *)Method_UnityEngine_GameObject_GetComponent_CombineServantListViewObject___)) == 0 )
    {
      sub_21FFECC(Component_object, v7);
    }
    CombineServantListViewObject__Init_37852704((CombineServantListViewObject_o *)Component_object, 2, v8);
  }
...
LABEL_11:
    sub_220024C(linkItem, CombineServantListViewItem_TypeInfo, callbackFunc, method);
    goto LABEL_12;
  }
  if ( !linkItem )
  {
...
LABEL_15:
  ...
  {
    v30 = dword_ECFAA0[initMode];
    this->fields.dispMode = dword_ECFA8C[initMode];
...
void CombineServantListViewObject__Init_37852704(
        CombineServantListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void CombineServantListViewObject__Init_37854964(
        CombineServantListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void CombineServantListViewObject__Init_37855048(
        CombineServantListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
bool CombineServantListViewObject__IsCanDrag(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_5932222 & 1) == 0 )
  {
    ...
    this = (CombineServantListViewObject_o *)sub_21FFC50(&UnityEngine_Object_TypeInfo);
    byte_5932222 = 1;
  }
  ...
  {
    this = (CombineServantListViewObject_o *)sub_220024C(
                                               v4->fields.manager,
...
LABEL_19:
  ...
  v14 = (CombineServantListViewObject_o *)sub_220024C(v4->fields.linkItem, CombineServantListViewItem_TypeInfo, v8, v9);
...
void CombineServantListViewObject__OnClickSelect(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_5932227 & 1) == 0 )
  {
    sub_21FFC50(&CombineServantListViewItem_TypeInfo);
    sub_21FFC50(&CombineServantListViewManager_TypeInfo);
    sub_21FFC50(&Method_CombineServantListViewObject_OnClickSelect__);
    sub_21FFC50(&StringLiteral_10253/*"OnClickSelectBase"*/);
    sub_21FFC50(&StringLiteral_10255/*"OnClickSelectMaterial"*/);
    this = (CombineServantListViewObject_o *)sub_21FFC50(&StringLiteral_10257/*"OnClickSelectPush"*/);
    byte_5932227 = 1;
  }
  ...
  if ( linkItem->klass->_2.naturalAligment < (unsigned int)naturalAligment
    || (CombineServantListViewItem_c *)linkItem->klass->_2.typeHierarchy[naturalAligment - 1] != CombineServantListViewItem_TypeInfo )
  {
    sub_220024C(v5->fields.linkItem, CombineServantListViewItem_TypeInfo, v2, v3);
LABEL_53:
    this = (CombineServantListViewObject_o *)sub_220024C(manager, v9, v2, v3);
    goto LABEL_54;
  }
  ...
  switch ( modeKind )
  {
    case 3:
      ...
      if ( this )
      {
        v22 = &StringLiteral_10257/*"OnClickSelectPush"*/;
        goto LABEL_40;
      }
LABEL_54:
      sub_21FFECC(this, v7);
    case 2:
      ...
      {
        if ( (*((_BYTE *)Method_CombineServantListViewObject_OnClickSelect__ + 83) & 2) != 0 )
          v14 = (_QWORD *)sub_21FFC68(Method_CombineServantListViewObject_OnClickSelect__);
        v23 = (System_Reflection_MethodBase_o *)sub_21FFC34(v14, v14[4]);
...
LABEL_17:
      ...
      {
LABEL_19:
        v20 = (System_Reflection_MethodBase_o *)sub_21FFC34(v14, v14[4]);
LABEL_20:
        OverwriteAssetSoundName__PlaySystemSe(v20, 2, 0, 0);
        return;
      }
LABEL_18:
      v14 = (_QWORD *)sub_21FFC68(v14);
      goto LABEL_19;
    case 1:
      ...
      if ( !v13 )
      {
        if ( (*((_BYTE *)Method_CombineServantListViewObject_OnClickSelect__ + 83) & 2) != 0 )
          v14 = (_QWORD *)sub_21FFC68(Method_CombineServantListViewObject_OnClickSelect__);
        v16 = (System_Reflection_MethodBase_o *)sub_21FFC34(v14, v14[4]);
...
LABEL_43:
    if ( !CombineServantListViewItem__get_IsCanNotSelect(linkItem, 0) )
    {
      if ( linkItem->fields.isMaterialSvt )
      {
        ...
        v24 = (System_Reflection_MethodBase_o *)sub_1FEBA28(Method_CombineServantListViewObject_OnClickSelect__);
        v25 = 1;
      }
      else
      {
      ...
      if ( this )
      {
        v22 = &StringLiteral_10255/*"OnClickSelectMaterial"*/;
        goto LABEL_40;
      }
      goto LABEL_54;
    }
...
LABEL_30:
  if ( !CombineServantListViewItem__get_IsCanNotBaseSelect(linkItem, 0) || linkItem->fields.isBaseSvt )
  {
    ...
    if ( this )
    {
      v22 = &StringLiteral_10253/*"OnClickSelectBase"*/;
LABEL_40:
  ...
  {
LABEL_44:
    v20 = (System_Reflection_MethodBase_o *)sub_1FEBA28(Method_CombineServantListViewObject_OnClickSelect__);
    goto LABEL_20;
  }
}
...
void CombineServantListViewObject__OnDragDropStart(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( manager->klass->_2.naturalAligment < (unsigned int)naturalAligment
    || (CombineServantListViewManager_c *)manager->klass->_2.typeHierarchy[naturalAligment - 1] != CombineServantListViewManager_TypeInfo )
  {
    manager = (UITouchPress_o *)sub_220024C(manager, CombineServantListViewManager_TypeInfo, v2, v3);
    goto LABEL_14;
  }
...
void CombineServantListViewObject__OnLongPush(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_5932228 & 1) == 0 )
  {
    ...
    this = (CombineServantListViewObject_o *)sub_21FFC50(&StringLiteral_10336/*"OnPressCancel"*/);
    byte_5932228 = 1;
  }
  ...
  if ( linkItem )
  {
      ...
      && (CombineServantListViewItem_c *)linkItem->klass->_2.typeHierarchy[naturalAligment - 1] == CombineServantListViewItem_TypeInfo )
    {
      ...
      if ( manager )
      {
        ...
        {
          v12 = (CombineServantListViewObject_o *)sub_220024C(
                                                    v4->fields.manager,
                                                    CombineServantListViewManager_TypeInfo,
                                                    v2,
                                                    v3);
...
void CombineServantListViewObject__OnLongRelease(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.linkItem )
  {
    ...
    if ( manager )
    {
      ...
      {
        manager = (UIDragDropListViewItem_o *)sub_220024C(manager, CombineServantListViewManager_TypeInfo, v6, v7);
      }
    }
LABEL_17:
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)itemDraw, 0, 0) )
  {
    ...
    {
      sub_220024C(manager, CombineServantListViewManager_TypeInfo, v9, v10);
    }
    else
    {
...
void CombineServantListViewObject__SetItem_37853116(
        CombineServantListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void CombineServantListViewObject__SetupDisp(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( manager )
  {
    ...
    if ( manager->klass->_2.naturalAligment < (unsigned int)naturalAligment
      || (CombineServantListViewManager_c *)manager->klass->_2.typeHierarchy[naturalAligment - 1] != CombineServantListViewManager_TypeInfo )
    {
      sub_220024C(this->fields.manager, CombineServantListViewManager_TypeInfo, v2, v3);
      goto LABEL_26;
    }
  }
  linkItem = this->fields.linkItem;
  ...
  {
LABEL_26:
    v21 = (CombineServantListViewObject_o *)sub_220024C(linkItem, v8, v2, v3);
    CombineServantListViewObject__Init_37854964(v21, v22, v23, v25, v24);
    return;
  }
...
LABEL_24:
    sub_21FFECC(IsSelectEnable, v15);
  }
}
...
void CombineServantListViewObject__Start(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    CombineServantListViewObject__Init_37852704(this, 2, v2);
}
...
System_String_o *CombineServantListViewObject__ToString(CombineServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_5932226 & 1) == 0 )
  {
    sub_21FFC50(&CombineServantListViewItemDraw_DispMode_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v13 = (CombineServantListViewObject_o *)sub_220024C(v8, System_Action_TypeInfo, v9, v10);
