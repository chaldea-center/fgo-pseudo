...
void BattleHitStopControl__Clear(BattleHitStopControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CF11C8 & 1) == 0 )
  {
    this = (BattleHitStopControl_o *)sub_1C7BAE8(&Method_System_Collections_Generic_List_GameObject__Clear__);
    byte_4CF11C8 = 1;
  }
...
void BattleHitStopControl__Start(BattleHitStopControl_o *this, const MethodInfo *method)
{
  ...
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.stopobjlist, (int32_t)v3, v4, v5, v6, v7, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF11CA & 1) == 0 )
  {
    sub_1C7BAE8(&BattleHitStopControl__stopwaitCor_d__5_TypeInfo);
    byte_4CF11CA = 1;
  }
  v5 = sub_1C7BD34(BattleHitStopControl__stopwaitCor_d__5_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF11CB & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_23308/*"resumeAnimation"*/);
    this = (BattleHitStopControl__stopwaitCor_d__5_o *)sub_1C7BAE8(&StringLiteral_23939/*"stopAnimation"*/);
    byte_4CF11CB = 1;
  }
  memset(&i, 0, sizeof(i));
      ...
      if ( this )
      {
        ...
        for ( i = v27;
              ...
              UnityEngine_GameObject__SendMessage_71851516(
                ...
                (System_String_o *)StringLiteral_23308/*"resumeAnimation"*/,
                0) )
        {
...
LABEL_26:
  ...
  if ( _1__state != 1 )
  {
    if ( !_1__state )
    {
      ...
      sub_1C7BA8C(p__2__current, (int32_t)milliSecPointOne, v2, v3, v4, v5, v6, v7);
      result = 1;
  ...
  for ( i = v27;
        ...
        UnityEngine_GameObject__SendMessage_71851516(
          (UnityEngine_GameObject_o *)i.fields._current,
          (System_String_o *)StringLiteral_23939/*"stopAnimation"*/,
          0) )
  {
    if ( !i.fields._current )
      sub_1C7BD40(0, v16);
  ...
  System_Collections_Generic_List_Enumerator_object___Dispose(
    ...
    (const MethodInfo_35BDF94 *)Method_System_Collections_Generic_List_Enumerator_GameObject__Dispose__);
  time = v8->fields.time;
  v19 = (UnityEngine_WaitForSeconds_o *)sub_1C7BD34(UnityEngine_WaitForSeconds_TypeInfo);
  ...
  sub_1C7BA8C(v20, (int32_t)v19, v21, v22, v23, v24, v25, v26);
  result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C7BAFC(&Method_BattleHitStopControl__stopwaitCor_d__5_System_Collections_IEnumerator_Reset__);
  sub_1C7BC10(v3, v4);
}
