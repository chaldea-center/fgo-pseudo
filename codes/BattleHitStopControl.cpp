...
void __fastcall BattleHitStopControl__Clear(BattleHitStopControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0B249 & 1) == 0 )
  {
    this = (BattleHitStopControl_o *)sub_1B686D4(&Method_System_Collections_Generic_List_GameObject__Clear__, method);
    byte_4A0B249 = 1;
  }
...
void __fastcall BattleHitStopControl__Start(BattleHitStopControl_o *this, const MethodInfo *method)
{
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.stopobjlist, (int32_t)v4, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0B24B & 1) == 0 )
  {
    sub_1B686D4(&BattleHitStopControl__stopwaitCor_d__5_TypeInfo, method);
    byte_4A0B24B = 1;
  }
  v5 = sub_1B68920(BattleHitStopControl__stopwaitCor_d__5_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0B24C & 1) == 0 )
  {
    ...
    sub_1B686D4(&UnityEngine_WaitForSeconds_TypeInfo, v9);
    sub_1B686D4(&StringLiteral_22834/*"resumeAnimation"*/, v10);
    this = (BattleHitStopControl__stopwaitCor_d__5_o *)sub_1B686D4(&StringLiteral_23469/*"stopAnimation"*/, v11);
    byte_4A0B24C = 1;
  }
  memset(&i, 0, sizeof(i));
      ...
      if ( this )
      {
        ...
        for ( i = v26;
              ...
              UnityEngine_GameObject__SendMessage_69153276(
                ...
                (System_String_o *)StringLiteral_22834/*"resumeAnimation"*/,
                0LL) )
        {
...
LABEL_26:
  ...
  if ( _1__state != 1 )
  {
    if ( !_1__state )
    {
      ...
      sub_1B68678(p__2__current, (int32_t)milliSecPointOne, v2, v3);
      result = 1;
  ...
  for ( i = v26;
        ...
        UnityEngine_GameObject__SendMessage_69153276(
          (UnityEngine_GameObject_o *)i.fields._current,
          (System_String_o *)StringLiteral_23469/*"stopAnimation"*/,
          0LL) )
  {
    if ( !i.fields._current )
      sub_1B68930(0LL, v19);
  ...
  sub_1B68678(v23, (int32_t)v22, v24, v25);
  result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B686E8(&Method_BattleHitStopControl__stopwaitCor_d__5_System_Collections_IEnumerator_Reset__);
  sub_1B687FC(v3, v4);
}
