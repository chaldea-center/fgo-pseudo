...
void BattleHitStopControl__Clear(BattleHitStopControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C29DB5 & 1) == 0 )
  {
    this = (BattleHitStopControl_o *)sub_1C2D490(&Method_System_Collections_Generic_List_GameObject__Clear__);
    byte_4C29DB5 = 1;
  }
...
void BattleHitStopControl__Start(BattleHitStopControl_o *this, const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.stopobjlist, (int32_t)v3, v4, v5);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C29DB7 & 1) == 0 )
  {
    sub_1C2D490(&BattleHitStopControl__stopwaitCor_d__5_TypeInfo);
    byte_4C29DB7 = 1;
  }
  v5 = sub_1C2D6DC(BattleHitStopControl__stopwaitCor_d__5_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C29DB8 & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_23064/*"resumeAnimation"*/);
    this = (BattleHitStopControl__stopwaitCor_d__5_o *)sub_1C2D490(&StringLiteral_23691/*"stopAnimation"*/);
    byte_4C29DB8 = 1;
  }
  memset(&i, 0, sizeof(i));
      ...
      if ( this )
      {
        ...
        for ( i = v19;
              ...
              UnityEngine_GameObject__SendMessage_71145580(
                ...
                (System_String_o *)StringLiteral_23064/*"resumeAnimation"*/,
                0) )
        {
...
LABEL_26:
  ...
  if ( _1__state != 1 )
  {
    if ( !_1__state )
    {
      ...
      sub_1C2D434(p__2__current, (int32_t)milliSecPointOne, v2, v3);
      result = 1;
  ...
  for ( i = v19;
        ...
        UnityEngine_GameObject__SendMessage_71145580(
          (UnityEngine_GameObject_o *)i.fields._current,
          (System_String_o *)StringLiteral_23691/*"stopAnimation"*/,
          0) )
  {
    if ( !i.fields._current )
      sub_1C2D6EC(0, v12);
  ...
  sub_1C2D434(v16, (int32_t)v15, v17, v18);
  result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C2D4A4(&Method_BattleHitStopControl__stopwaitCor_d__5_System_Collections_IEnumerator_Reset__);
  sub_1C2D5B8(v3, v4);
}
