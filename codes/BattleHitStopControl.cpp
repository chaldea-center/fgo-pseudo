...
void __fastcall BattleHitStopControl__Clear(BattleHitStopControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A72492 & 1) == 0 )
  {
    this = (BattleHitStopControl_o *)sub_1B90010(&Method_System_Collections_Generic_List_GameObject__Clear__, method);
    byte_4A72492 = 1;
  }
...
void __fastcall BattleHitStopControl__Start(BattleHitStopControl_o *this, const MethodInfo *method)
{
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.stopobjlist, (int32_t)v4, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A72494 & 1) == 0 )
  {
    sub_1B90010(&BattleHitStopControl__stopwaitCor_d__5_TypeInfo, method);
    byte_4A72494 = 1;
  }
  v5 = sub_1B9025C(BattleHitStopControl__stopwaitCor_d__5_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A72495 & 1) == 0 )
  {
    sub_1B90010(&DefCoroutine_TypeInfo, method);
    ...
    sub_1B90010(&StringLiteral_22947/*"resumeAnimation"*/, v10);
    this = (BattleHitStopControl__stopwaitCor_d__5_o *)sub_1B90010(&StringLiteral_23587/*"stopAnimation"*/, v11);
    byte_4A72495 = 1;
  }
  memset(&i, 0, sizeof(i));
      ...
      if ( this )
      {
        ...
        for ( i = v26;
              ...
              UnityEngine_GameObject__SendMessage_69520900(
                ...
                (System_String_o *)StringLiteral_22947/*"resumeAnimation"*/,
                0LL) )
        {
...
LABEL_26:
  ...
  if ( _1__state != 1 )
  {
    if ( !_1__state )
    {
      ...
      sub_1B8FFB4(p__2__current, (int32_t)milliSecPointOne, v2, v3);
      result = 1;
  ...
  for ( i = v26;
        ...
        UnityEngine_GameObject__SendMessage_69520900(
          (UnityEngine_GameObject_o *)i.fields._current,
          (System_String_o *)StringLiteral_23587/*"stopAnimation"*/,
          0LL) )
  {
    if ( !i.fields._current )
      sub_1B9026C(0LL, v19);
  ...
  sub_1B8FFB4(v23, (int32_t)v22, v24, v25);
  result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B90024(&Method_BattleHitStopControl__stopwaitCor_d__5_System_Collections_IEnumerator_Reset__);
  sub_1B90138(v3, v4);
}
