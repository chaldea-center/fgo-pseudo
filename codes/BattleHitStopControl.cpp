...
void BattleHitStopControl__Clear(BattleHitStopControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C45ACF & 1) == 0 )
  {
    this = (BattleHitStopControl_o *)sub_1C37058(&Method_System_Collections_Generic_List_GameObject__Clear__);
    byte_4C45ACF = 1;
  }
...
void BattleHitStopControl__Start(BattleHitStopControl_o *this, const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.stopobjlist, (int32_t)v3, v4, v5);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C45AD1 & 1) == 0 )
  {
    sub_1C37058(&BattleHitStopControl__stopwaitCor_d__5_TypeInfo);
    byte_4C45AD1 = 1;
  }
  v5 = sub_1C372A4(BattleHitStopControl__stopwaitCor_d__5_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C45AD2 & 1) == 0 )
  {
    sub_1C37058(&DefCoroutine_TypeInfo);
    ...
    sub_1C37058(&StringLiteral_23085/*"resumeAnimation"*/);
    this = (BattleHitStopControl__stopwaitCor_d__5_o *)sub_1C37058(&StringLiteral_23713/*"stopAnimation"*/);
    byte_4C45AD2 = 1;
  }
  memset(&i, 0, sizeof(i));
      ...
      if ( this )
      {
        ...
        for ( i = v17;
              ...
              UnityEngine_GameObject__SendMessage_71248628(
                ...
                (System_String_o *)StringLiteral_23085/*"resumeAnimation"*/,
                0) )
        {
...
LABEL_26:
  ...
  if ( _1__state != 1 )
  {
    if ( !_1__state )
    {
      ...
      sub_1C36FFC(p__2__current, (int32_t)milliSecPointOne, v2, v3);
      result = 1;
  ...
  for ( i = v17;
        ...
        UnityEngine_GameObject__SendMessage_71248628(
          (UnityEngine_GameObject_o *)i.fields._current,
          (System_String_o *)StringLiteral_23713/*"stopAnimation"*/,
          0) )
  {
    if ( !i.fields._current )
      sub_1C372B4(0);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C3706C(&Method_BattleHitStopControl__stopwaitCor_d__5_System_Collections_IEnumerator_Reset__);
  sub_1C37180(v3, v4);
}
