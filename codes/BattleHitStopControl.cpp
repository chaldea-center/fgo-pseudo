...
void __fastcall BattleHitStopControl__Clear(BattleHitStopControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDEC7D & 1) == 0 )
  {
    this = (BattleHitStopControl_o *)sub_1C21E38(&Method_System_Collections_Generic_List_GameObject__Clear__);
    byte_4BDEC7D = 1;
  }
...
void __fastcall BattleHitStopControl__Start(BattleHitStopControl_o *this, const MethodInfo *method)
{
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.stopobjlist, (int64_t)v3, v4, v5, v6, v7, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDEC7F & 1) == 0 )
  {
    sub_1C21E38(&BattleHitStopControl__stopwaitCor_d__5_TypeInfo);
    byte_4BDEC7F = 1;
  }
  v5 = sub_1C22084(BattleHitStopControl__stopwaitCor_d__5_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDEC80 & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_23331/*"resumeAnimation"*/);
    this = (BattleHitStopControl__stopwaitCor_d__5_o *)sub_1C21E38(&StringLiteral_23978/*"stopAnimation"*/);
    byte_4BDEC80 = 1;
  }
  memset(&i, 0, sizeof(i));
      ...
      if ( this )
      {
        ...
        for ( i = v27;
              ...
              UnityEngine_GameObject__SendMessage_70851072(
                ...
                (System_String_o *)StringLiteral_23331/*"resumeAnimation"*/,
                0LL) )
        {
...
LABEL_26:
  ...
  if ( _1__state != 1 )
  {
    if ( !_1__state )
    {
      ...
      sub_1C21DDC(p__2__current, v13, v2, v3, v4, v5, v6, v7);
      result = 1;
  ...
  for ( i = v27;
        ...
        UnityEngine_GameObject__SendMessage_70851072(
          (UnityEngine_GameObject_o *)i.fields._current,
          (System_String_o *)StringLiteral_23978/*"stopAnimation"*/,
          0LL) )
  {
    if ( !i.fields._current )
      sub_1C22094(0LL, v16);
  ...
  v20 = (PartyOrganizationUtility_o *)&v8->fields.__2__current;
  sub_1C21DDC(v20, (int64_t)v19, v21, v22, v23, v24, v25, v26);
  result = 1;
  *(_DWORD *)&v20[-1].fields._IsQuestStartMenuMode_k__BackingField = 2;
  return result;
}
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C21E4C(&Method_BattleHitStopControl__stopwaitCor_d__5_System_Collections_IEnumerator_Reset__);
  sub_1C21F60(v3, v4);
}
