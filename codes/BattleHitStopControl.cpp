...
void BattleHitStopControl__Clear(BattleHitStopControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2F446 & 1) == 0 )
  {
    this = (BattleHitStopControl_o *)sub_1C94098(&Method_System_Collections_Generic_List_GameObject__Clear__);
    byte_4D2F446 = 1;
  }
...
void BattleHitStopControl__Start(BattleHitStopControl_o *this, const MethodInfo *method)
{
  ...
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.stopobjlist, (int32_t)v3, v4, v5, v6, v7, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2F448 & 1) == 0 )
  {
    sub_1C94098(&BattleHitStopControl__stopwaitCor_d__5_TypeInfo);
    byte_4D2F448 = 1;
  }
  v5 = sub_1C942E4(BattleHitStopControl__stopwaitCor_d__5_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2F449 & 1) == 0 )
  {
    sub_1C94098(&DefCoroutine_TypeInfo);
    ...
    sub_1C94098(&StringLiteral_23314/*"resumeAnimation"*/);
    this = (BattleHitStopControl__stopwaitCor_d__5_o *)sub_1C94098(&StringLiteral_23943/*"stopAnimation"*/);
    byte_4D2F449 = 1;
  }
  memset(&i, 0, sizeof(i));
      ...
      if ( this )
      {
        ...
        for ( i = v27;
              ...
              UnityEngine_GameObject__SendMessage_72092340(
                ...
                (System_String_o *)StringLiteral_23314/*"resumeAnimation"*/,
                0) )
        {
...
LABEL_26:
  ...
  if ( _1__state != 1 )
  {
    if ( !_1__state )
    {
      ...
      sub_1C9403C(p__2__current, (int32_t)milliSecPointOne, v2, v3, v4, v5, v6, v7);
      result = 1;
  ...
  for ( i = v27;
        ...
        UnityEngine_GameObject__SendMessage_72092340(
          (UnityEngine_GameObject_o *)i.fields._current,
          (System_String_o *)StringLiteral_23943/*"stopAnimation"*/,
          0) )
  {
    if ( !i.fields._current )
      sub_1C942F0(0, v16);
  ...
  sub_1C9403C(v20, (int32_t)v19, v21, v22, v23, v24, v25, v26);
  result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C940AC(&Method_BattleHitStopControl__stopwaitCor_d__5_System_Collections_IEnumerator_Reset__);
  sub_1C941C0(v3, v4);
}
