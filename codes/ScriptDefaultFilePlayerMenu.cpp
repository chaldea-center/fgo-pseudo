...
void ScriptDefaultFilePlayerMenu__OnClickDecide(ScriptDefaultFilePlayerMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D29DF4 & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_ScriptDefaultFilePlayerMenu_EndPlayScript__);
    sub_1C94098(&ScriptManager_TypeInfo);
    sub_1C94098(&Method_SingletonMonoBehaviour_ScriptManager__get_Instance__);
    sub_1C94098(&StringLiteral_5210/*"DefaultScript.txt"*/);
    this = (ScriptDefaultFilePlayerMenu_o *)sub_1C94098(&StringLiteral_3271/*"C:/Avalon/Temporary/ScriptData"*/);
    byte_4D29DF4 = 1;
  }
      ...
      if ( startModeInput )
      {
        ...
        if ( this )
        {
          ...
          if ( ScriptManager__SetScriptPlayerSetting(
                 ...
                 0) )
          {
            this = (ScriptDefaultFilePlayerMenu_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3ABA574 *)Method_SingletonMonoBehaviour_ScriptManager__get_Instance__);
            if ( !this )
              goto LABEL_17;
          ...
          ScriptConnectData___ctor(
            &v25,
            (System_String_o *)StringLiteral_3271/*"C:/Avalon/Temporary/ScriptData"*/,
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1AC5C0C;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1AC5BC4;
}
