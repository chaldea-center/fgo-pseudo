        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFF684 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_ScriptDefaultFilePlayerMenu_EndPlayScript__, v4);
    sub_1BC3008(&ScriptManager_TypeInfo, v5);
    sub_1BC3008(&Method_SingletonMonoBehaviour_ScriptManager__get_Instance__, v6);
    sub_1BC3008(&StringLiteral_5164/*"DefaultScript.txt"*/, v7);
    this = (ScriptDefaultFilePlayerMenu_o *)sub_1BC3008(&StringLiteral_3241/*"C:/Avalon/Temporary/ScriptData"*/, v8);
    byte_4AFF684 = 1;
  }
  if ( v2->fields.state == 1 )
  {
    ...
    if ( genderInput )
    {
      ...
      if ( startModeInput )
      {
        ...
        sub_1BC2FAC((CGThumbnailListItem_o *)&v2->fields.selectStartModeName, (int32_t)v14, v11, v12);
        ...
        if ( this )
        {
          ...
          if ( ScriptManager__SetScriptPlayerSetting(
                 ...
                 0LL) )
          {
            this = (ScriptDefaultFilePlayerMenu_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38DFD48 *)Method_SingletonMonoBehaviour_ScriptManager__get_Instance__);
            if ( !this )
              goto LABEL_17;
          ...
          ScriptConnectData___ctor(
            &v27,
            (System_String_o *)StringLiteral_3241/*"C:/Avalon/Temporary/ScriptData"*/,
            (System_String_o *)StringLiteral_5164/*"DefaultScript.txt"*/,
            v21,
            v22,
            JumpLine,
            0,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFF681 & 1) == 0 )
  {
    sub_1BC3008(&ScriptManager_TypeInfo, callback);
    sub_1BC3008(&Method_SingletonMonoBehaviour_ScriptManager__get_Instance__, v6);
    sub_1BC3008(&Gender_Type_TypeInfo, v7);
    byte_4AFF681 = 1;
  }
  if ( !this->fields.state )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFF67F & 1) == 0 )
  {
    sub_1BC3008(&ScriptDefaultFilePlayerMenu_CallbackFunc_TypeInfo, value);
    byte_4AFF67F = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A0ABC0;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A0AB78;
}
