...
void ScriptDefaultFilePlayerMenu__OnClickDecide(ScriptDefaultFilePlayerMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC49A4 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_ScriptDefaultFilePlayerMenu_EndPlayScript__);
    sub_1C713B0(&ScriptManager_TypeInfo);
    sub_1C713B0(&Method_SingletonMonoBehaviour_ScriptManager__get_Instance__);
    sub_1C713B0(&StringLiteral_5200/*"DefaultScript.txt"*/);
    this = (ScriptDefaultFilePlayerMenu_o *)sub_1C713B0(&StringLiteral_3263/*"C:/Avalon/Temporary/ScriptData"*/);
    byte_4CC49A4 = 1;
  }
      ...
      if ( startModeInput )
      {
        ...
        if ( this )
        {
          ...
          if ( ScriptManager__SetScriptPlayerSetting(
                 ...
                 0) )
          {
            this = (ScriptDefaultFilePlayerMenu_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A5F158 *)Method_SingletonMonoBehaviour_ScriptManager__get_Instance__);
            if ( !this )
              goto LABEL_17;
          ...
          ScriptConnectData___ctor(
            &v25,
            (System_String_o *)StringLiteral_3263/*"C:/Avalon/Temporary/ScriptData"*/,
            (System_String_o *)StringLiteral_5200/*"DefaultScript.txt"*/,
            v19,
            v20,
            JumpLine,
            0,
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1AA4318;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1AA42D0;
}
