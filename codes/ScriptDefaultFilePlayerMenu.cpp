        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB1E52 & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_ScriptDefaultFilePlayerMenu_EndPlayScript__, v4);
    sub_1C13D24(&ScriptManager_TypeInfo, v5);
    sub_1C13D24(&Method_SingletonMonoBehaviour_ScriptManager__get_Instance__, v6);
    sub_1C13D24(&StringLiteral_5340/*"Default credentials are not supported on an FTP request."*/, v7);
    this = (ScriptDefaultFilePlayerMenu_o *)sub_1C13D24(&StringLiteral_3423/*"C"*/, v8);
    byte_4BB1E52 = 1;
  }
  if ( v2->fields.state == 1 )
  {
    ...
    if ( genderInput )
    {
      ...
      if ( startModeInput )
      {
        ...
        sub_1C13CC8((PartyOrganizationUtility_o *)&v2->fields.selectStartModeName, v18, v11, v12, v13, v14, v15, v16);
        ...
        if ( this )
        {
          ...
          if ( ScriptManager__SetScriptPlayerSetting(
                 ...
                 0LL) )
          {
            this = (ScriptDefaultFilePlayerMenu_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3869BD8 *)Method_SingletonMonoBehaviour_ScriptManager__get_Instance__);
            if ( !this )
              goto LABEL_17;
          ...
          ScriptConnectData___ctor(
            &v31,
            (System_String_o *)StringLiteral_3423/*"C"*/,
            (System_String_o *)StringLiteral_5340/*"Default credentials are not supported on an FTP request."*/,
            v25,
            v26,
            JumpLine,
            0,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB1E4F & 1) == 0 )
  {
    sub_1C13D24(&ScriptManager_TypeInfo, callback);
    sub_1C13D24(&Method_SingletonMonoBehaviour_ScriptManager__get_Instance__, v10);
    sub_1C13D24(&Gender_Type_TypeInfo, v11);
    byte_4BB1E4F = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( !byte_4BB1DF2 )
    {
      sub_1C13D24(&ScriptManager_TypeInfo, v23);
      byte_4BB1DF2 = 1;
    }
    ...
    if ( !byte_4BB1DF4 )
    {
      sub_1C13D24(&ScriptManager_TypeInfo, v32);
      byte_4BB1DF4 = 1;
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB1E4D & 1) == 0 )
  {
    sub_1C13D24(&ScriptDefaultFilePlayerMenu_CallbackFunc_TypeInfo, value);
    byte_4BB1E4D = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A52968;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A52920;
}
