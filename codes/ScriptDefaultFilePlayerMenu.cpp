        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B420FC & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_ScriptDefaultFilePlayerMenu_EndPlayScript__, v4);
    sub_1BDB878(&ScriptManager_TypeInfo, v5);
    sub_1BDB878(&Method_SingletonMonoBehaviour_ScriptManager__get_Instance__, v6);
    sub_1BDB878(&StringLiteral_5245/*"DefaultScript.txt"*/, v7);
    this = (ScriptDefaultFilePlayerMenu_o *)sub_1BDB878(&StringLiteral_3310/*"C:/Avalon/Temporary/ScriptData"*/, v8);
    byte_4B420FC = 1;
  }
  if ( v2->fields.state == 1 )
  {
    ...
    if ( genderInput )
    {
      ...
      if ( startModeInput )
      {
        ...
        sub_1BDB81C((CGThumbnailListItem_o *)&v2->fields.selectStartModeName, (int32_t)v14, v11, v12);
        ...
        if ( this )
        {
          ...
          if ( ScriptManager__SetScriptPlayerSetting(
                 ...
                 0LL) )
          {
            this = (ScriptDefaultFilePlayerMenu_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_ScriptManager__get_Instance__);
            if ( !this )
              goto LABEL_17;
          ...
          ScriptConnectData___ctor(
            &v27,
            (System_String_o *)StringLiteral_3310/*"C:/Avalon/Temporary/ScriptData"*/,
            (System_String_o *)StringLiteral_5245/*"DefaultScript.txt"*/,
            v21,
            v22,
            JumpLine,
            0,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B420F9 & 1) == 0 )
  {
    sub_1BDB878(&ScriptManager_TypeInfo, callback);
    sub_1BDB878(&Method_SingletonMonoBehaviour_ScriptManager__get_Instance__, v6);
    sub_1BDB878(&Gender_Type_TypeInfo, v7);
    byte_4B420F9 = 1;
  }
  if ( !this->fields.state )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B420F7 & 1) == 0 )
  {
    sub_1BDB878(&ScriptDefaultFilePlayerMenu_CallbackFunc_TypeInfo, value);
    byte_4B420F7 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A22680;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A22638;
}
