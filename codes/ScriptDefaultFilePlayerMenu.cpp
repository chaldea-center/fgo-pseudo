        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC5210 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_ScriptDefaultFilePlayerMenu_EndPlayScript__, v4);
    sub_1C1ABD4(&ScriptManager_TypeInfo, v5);
    sub_1C1ABD4(&Method_SingletonMonoBehaviour_ScriptManager__get_Instance__, v6);
    sub_1C1ABD4(&StringLiteral_5344/*"DefaultScript.txt"*/, v7);
    this = (ScriptDefaultFilePlayerMenu_o *)sub_1C1ABD4(&StringLiteral_3426/*"C:/Avalon/Temporary/ScriptData"*/, v8);
    byte_4BC5210 = 1;
  }
  if ( v2->fields.state == 1 )
  {
    ...
    if ( genderInput )
    {
      ...
      if ( startModeInput )
      {
        ...
        sub_1C1AB78((PartyOrganizationUtility_o *)&v2->fields.selectStartModeName, v18, v11, v12, v13, v14, v15, v16);
        ...
        if ( this )
        {
          ...
          if ( ScriptManager__SetScriptPlayerSetting(
                 ...
                 0LL) )
          {
            this = (ScriptDefaultFilePlayerMenu_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_387A8A8 *)Method_SingletonMonoBehaviour_ScriptManager__get_Instance__);
            if ( !this )
              goto LABEL_17;
          ...
          ScriptConnectData___ctor(
            &v31,
            (System_String_o *)StringLiteral_3426/*"C:/Avalon/Temporary/ScriptData"*/,
            (System_String_o *)StringLiteral_5344/*"DefaultScript.txt"*/,
            v25,
            v26,
            JumpLine,
            0,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC520D & 1) == 0 )
  {
    sub_1C1ABD4(&ScriptManager_TypeInfo, callback);
    sub_1C1ABD4(&Method_SingletonMonoBehaviour_ScriptManager__get_Instance__, v10);
    sub_1C1ABD4(&Gender_Type_TypeInfo, v11);
    byte_4BC520D = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( !byte_4BC51A9 )
    {
      sub_1C1ABD4(&ScriptManager_TypeInfo, v23);
      byte_4BC51A9 = 1;
    }
    ...
    if ( !byte_4BC51AB )
    {
      sub_1C1ABD4(&ScriptManager_TypeInfo, v32);
      byte_4BC51AB = 1;
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC520B & 1) == 0 )
  {
    sub_1C1ABD4(&ScriptDefaultFilePlayerMenu_CallbackFunc_TypeInfo, value);
    byte_4BC520B = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A59768;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A59720;
}
