void __fastcall EventEquipSkillPartsRenoCompletionBoardItemDraw___ctor(
...
void __fastcall EventEquipSkillPartsRenoCompletionBoardItemDraw__Awake(
        EventEquipSkillPartsRenoCompletionBoardItemDraw_o *this,
        const MethodInfo *method)
{
  ;
...
void __fastcall EventEquipSkillPartsRenoCompletionBoardItemDraw__UpdateUi(
        EventEquipSkillPartsRenoCompletionBoardItemDraw_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B0629F & 1) == 0 )
  {
    this = (EventEquipSkillPartsRenoCompletionBoardItemDraw_o *)sub_1BC3008(&AtlasManager_TypeInfo, item);
    byte_4B0629F = 1;
  }
  if ( !item )
    goto LABEL_9;
  ...
  if ( !this
    || (UILabel__set_text((UILabel_o *)this, item->fields._Name_k__BackingField, 0LL),
        (this = (EventEquipSkillPartsRenoCompletionBoardItemDraw_o *)v4->fields.nameLabel) == 0LL) )
  {
LABEL_9:
