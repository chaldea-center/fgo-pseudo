        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFBB0 & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_16567/*"accountLinkageAnx/continueUser"*/, v2);
    byte_49FFBB0 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61383576(BaseUrl, (System_String_o *)StringLiteral_16567/*"accountLinkageAnx/continueUser"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFBB2 & 1) == 0 )
  {
    ...
    this = (AccountLinkageContinueUserRequest_o *)sub_1B64870(&StringLiteral_24329/*"userId"*/, v11);
    byte_49FFBB2 = 1;
  }
  if ( !responseList )
    goto LABEL_15;
  ...
  if ( !v12 )
    goto LABEL_15;
  this = (AccountLinkageContinueUserRequest_o *)ResponseData__checkError_40851148(v12, 0LL);
  ...
  if ( this->klass->_1.element_class == long_TypeInfo->_1.element_class )
  {
    ...
    if ( this )
    {
      ...
      if ( this )
      {
        ...
        sub_1B64814((ServantStatusBattleListViewItem_o *)static_fields, v17, v20, v21);
        v22 = AccountLinkageParams_TypeInfo->static_fields;
        v22->newSecretKey = (struct System_String_o *)v18;
        sub_1B64814((ServantStatusBattleListViewItem_o *)&v22->newSecretKey, v18, v23, v24);
