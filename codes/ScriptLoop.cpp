void ScriptLoop___ctor(ScriptLoop_o *this, const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.switchCaseIndex, (int32_t)v3, v4, v5);
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.switchCaseMessage, (int32_t)v6, v7, v8);
...
void ScriptLoop__ExecuteLoop(ScriptLoop_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C39947 & 1) == 0 )
  {
    sub_1C32C20(&Method_System_Linq_Enumerable_LastOrDefault_int___);
    byte_4C39947 = 1;
  }
  ...
  v5 = System_Linq_Enumerable__LastOrDefault_int_(
         ...
         (const MethodInfo_31098A4 *)Method_System_Linq_Enumerable_LastOrDefault_int___);
...
bool ScriptLoop__IsExecuteLogErase(ScriptLoop_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C39948 & 1) == 0 )
  {
    sub_1C32C20(&Method_System_Collections_Generic_List_int__RemoveRange__);
    sub_1C32C20(&Method_System_Collections_Generic_List_string__RemoveRange__);
...
LABEL_15:
  ...
  if ( !switchCaseIndex
    || (System_Collections_Generic_List_int___RemoveRange(
          ...
          v6,
          (const MethodInfo_377CF80 *)Method_System_Collections_Generic_List_int__RemoveRange__),
        (switchCaseIndex = (System_Collections_Generic_List_int__o *)this->fields.switchCaseMessage) == 0) )
  {
LABEL_20:
    sub_1C32E7C(switchCaseIndex);
  }
  System_Collections_Generic_List_object___RemoveRange(
    (System_Collections_Generic_List_object__o *)switchCaseIndex,
    this->fields.lastLoopSwitchCaseCount,
    v6,
    (const MethodInfo_379A028 *)Method_System_Collections_Generic_List_string__RemoveRange__);
  result = 1;
...
LABEL_24:
    ...
    else
    {
      ...
      sub_1C32BC4((CGThumbnailListItem_o *)(v15 + 4), (int32_t)message, (int32_t)message, method);
    }
  }
  else
  {
    ...
    do
    {
      ...
      if ( System_Collections_Generic_List_int___get_Item(
             switchCaseIndex,
             v16,
             (const MethodInfo_377B4A8 *)Method_System_Collections_Generic_List_int__get_Item__) == index )
      {
        switchCaseIndex = (System_Collections_Generic_List_int__o *)this->fields.switchCaseMessage;
        if ( !switchCaseIndex )
          goto LABEL_24;
