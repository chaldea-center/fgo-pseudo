...
System_String_o *__fastcall BoxGachaBaseEntity__CreatePK(int32_t id, int32_t no, const MethodInfo *method)
{
  if ( (byte_49FE209 & 1) == 0 )
  {
    sub_1B64870(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&no);
    byte_49FE209 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE20B & 1) == 0 )
  {
    sub_1B64870(&Method_DataManager_GetMasterData_EventRewardSetMaster___, *(_QWORD *)&eventId);
