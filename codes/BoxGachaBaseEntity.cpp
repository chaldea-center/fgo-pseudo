...
System_String_o *__fastcall BoxGachaBaseEntity__CreatePK(int32_t id, int32_t no, const MethodInfo *method)
{
  if ( (byte_4BC778F & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&no);
    byte_4BC778F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC7791 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataManager_GetMasterData_EventRewardSetMaster___, *(_QWORD *)&eventId);
