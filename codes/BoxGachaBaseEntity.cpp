...
System_String_o *__fastcall BoxGachaBaseEntity__CreatePK(int32_t id, int32_t no, const MethodInfo *method)
{
  if ( (byte_4B668A9 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&no);
    byte_4B668A9 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B668AB & 1) == 0 )
  {
    sub_1BE4ACC(&Method_DataManager_GetMasterData_EventRewardSetMaster___, *(_QWORD *)&eventId);
