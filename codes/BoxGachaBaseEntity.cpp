...
System_String_o *__fastcall BoxGachaBaseEntity__CreatePK(int32_t id, int32_t no, const MethodInfo *method)
{
  if ( (byte_4AB5A4C & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&no);
    byte_4AB5A4C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB5A4E & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMasterData_EventRewardSetMaster___, *(_QWORD *)&eventId);
