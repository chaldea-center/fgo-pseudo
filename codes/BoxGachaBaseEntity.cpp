...
System_String_o *__fastcall BoxGachaBaseEntity__CreatePK(int32_t id, int32_t no, const MethodInfo *method)
{
  if ( (byte_4B1C1EC & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&no);
    byte_4B1C1EC = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1C1EE & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_EventRewardSetMaster___, *(_QWORD *)&eventId);
