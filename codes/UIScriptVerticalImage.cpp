void UIScriptVerticalImage___ctor(UIScriptVerticalImage_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C39A90 & 1) == 0 )
  {
    ...
    sub_1C32C20(&UIVerticalImageM___TypeInfo);
    byte_4C39A90 = 1;
  }
  v3 = (struct UIVerticalImageM_array *)sub_1C32CC8(UIVerticalImageM___TypeInfo, 2);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C39A8A & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_UIScriptVerticalImage_UpdateChange__);
    byte_4C39A8A = 1;
  }
...
void UIScriptVerticalImage__UpdateChange(UIScriptVerticalImage_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C39A8B & 1) == 0 )
  {
    ...
    this = (UIScriptVerticalImage_o *)sub_1C32C20(&StringLiteral_4699/*"ContinueChangeFade"*/);
    byte_4C39A8B = 1;
  }
