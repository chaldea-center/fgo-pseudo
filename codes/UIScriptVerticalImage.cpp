void UIScriptVerticalImage___ctor(UIScriptVerticalImage_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D32AAC & 1) == 0 )
  {
    ...
    sub_1C93AD4(&UIVerticalImageM___TypeInfo);
    byte_4D32AAC = 1;
  }
  v3 = (struct UIVerticalImageM_array *)sub_1C93B7C(UIVerticalImageM___TypeInfo, 2);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D32AA6 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_UIScriptVerticalImage_UpdateChange__);
    byte_4D32AA6 = 1;
  }
...
void UIScriptVerticalImage__UpdateChange(UIScriptVerticalImage_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D32AA7 & 1) == 0 )
  {
    ...
    this = (UIScriptVerticalImage_o *)sub_1C93AD4(&StringLiteral_4719/*"ContinueChangeFade"*/);
    byte_4D32AA7 = 1;
  }
