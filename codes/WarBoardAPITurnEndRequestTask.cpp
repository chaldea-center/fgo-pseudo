        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB3BDD & 1) == 0 )
  {
    sub_1BAB41C(&Method_NetworkManager_getRequest_WarBoardTurnEndRequest___, method);
  ...
  Instance = NetworkManager__getRequest_object_(
               0LL,
               (const MethodInfo_2F47108 *)Method_NetworkManager_getRequest_WarBoardTurnEndRequest___);
  if ( !monitor
