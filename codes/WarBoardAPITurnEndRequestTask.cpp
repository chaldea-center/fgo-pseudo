...
{
  WarBoardAPIRequestTask___ctor_36919764((WarBoardAPIRequestTask_o *)this, resultCallback, onStartBeginRequest, method);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFB53A & 1) == 0 )
  {
    sub_1C2E12C(&Method_NetworkManager_getRequest_WarBoardTurnEndRequest___, method);
  ...
  Instance = NetworkManager__getRequest_object_(
               0LL,
               (const MethodInfo_3056BC4 *)Method_NetworkManager_getRequest_WarBoardTurnEndRequest___);
  if ( !monitor
