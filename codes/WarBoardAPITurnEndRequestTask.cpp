        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2BE1A & 1) == 0 )
  {
    sub_1B761C0(&Method_NetworkManager_getRequest_WarBoardTurnEndRequest___, method);
  ...
  Instance = NetworkManager__getRequest_object_(
               0LL,
               (const MethodInfo_2EE44C0 *)Method_NetworkManager_getRequest_WarBoardTurnEndRequest___);
  if ( !monitor
