...
{
  WarBoardAPIRequestTask___ctor_36769368((WarBoardAPIRequestTask_o *)this, resultCallback, onStartBeginRequest, method);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB24FE & 1) == 0 )
  {
    sub_1C13D24(&Method_NetworkManager_getRequest_WarBoardTurnEndRequest___, method);
  ...
  Instance = NetworkManager__getRequest_object_(
               0LL,
               (const MethodInfo_3013AB4 *)Method_NetworkManager_getRequest_WarBoardTurnEndRequest___);
  if ( !monitor
