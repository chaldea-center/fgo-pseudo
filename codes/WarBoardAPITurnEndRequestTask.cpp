...
{
  WarBoardAPIRequestTask___ctor_36369024((WarBoardAPIRequestTask_o *)this, resultCallback, onStartBeginRequest, method);
}
        ...
        const MethodInfo *method)
{
  ...
  WarBoardTurnEndRequest_o *v11; // x21
  int64_t v12; // x2
  int32_t v13; // w3
  ...
  if ( (byte_4B14059 & 1) == 0 )
  {
    sub_1BCA7E0(&Method_NetworkManager_getRequest_WarBoardTurnEndRequest___, method, v2);
  ...
  Instance = NetworkManager__getRequest_object_(
               0LL,
               (const MethodInfo_2F964CC *)Method_NetworkManager_getRequest_WarBoardTurnEndRequest___);
  if ( !monitor
    || (v11 = (WarBoardTurnEndRequest_o *)Instance, Instance = (Il2CppObject *)WarBoardData__get_id(monitor, 0LL), !v11) )
  {
LABEL_9:
    sub_1BCAA3C(Instance, v9);
  }
  WarBoardTurnEndRequest__beginRequest(v11, (int32_t)Instance, monitor, 0LL);
