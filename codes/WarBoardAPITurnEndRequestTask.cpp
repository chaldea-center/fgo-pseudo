...
{
  WarBoardAPIRequestTask___ctor_37025440((WarBoardAPIRequestTask_o *)this, resultCallback, onStartBeginRequest, method);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1FD41 & 1) == 0 )
  {
    sub_1C3B764(&Method_NetworkManager_getRequest_WarBoardTurnEndRequest___, method);
  ...
  Instance = NetworkManager__getRequest_object_(
               0LL,
               (const MethodInfo_3075AE8 *)Method_NetworkManager_getRequest_WarBoardTurnEndRequest___);
  if ( !monitor
