...
{
  WarBoardAPIRequestTask___ctor_36447052((WarBoardAPIRequestTask_o *)this, resultCallback, onStartBeginRequest, method);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4C17B & 1) == 0 )
  {
    sub_1B863B8(&Method_NetworkManager_getRequest_WarBoardTurnEndRequest___, method);
  ...
  Instance = NetworkManager__getRequest_object_(
               0LL,
               (const MethodInfo_2FF4AF4 *)Method_NetworkManager_getRequest_WarBoardTurnEndRequest___);
  if ( !monitor
