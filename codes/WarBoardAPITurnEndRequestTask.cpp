        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FCA25 & 1) == 0 )
  {
    sub_1B64A00(&Method_NetworkManager_getRequest_WarBoardTurnEndRequest___, method);
  ...
  Instance = NetworkManager__getRequest_object_(
               0LL,
               (const MethodInfo_2EBD2C4 *)Method_NetworkManager_getRequest_WarBoardTurnEndRequest___);
  if ( !monitor
