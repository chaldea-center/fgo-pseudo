...
void __fastcall WarBoardCost___ctor_36030540(
        WarBoardCost_o *this,
        int32_t classId,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B13DFE & 1) == 0 )
  {
    sub_1BCA7E0(&WarBoardCost_TypeInfo, stagePieceDetailEntity, reinforcementsEntity);
    byte_4B13DFE = 1;
  }
  if ( entity )
  {
    ...
    v10 = sub_1BCAA2C(WarBoardCost_TypeInfo, stagePieceDetailEntity, reinforcementsEntity, method);
    *(_QWORD *)(v10 + 40) = -1LL;
    *(_QWORD *)(v10 + 48) = -1LL;
    ...
    *(_DWORD *)(v10 + 36) = wallAttackCost;
    ...
    if ( reinforcementsEntity )
      WarBoardCost__SetOverwriteCost_36030756((WarBoardCost_o *)v10, reinforcementsEntity, v11);
  }
  else
  {
    v10 = sub_1BCAA2C(WarBoardCost_TypeInfo, stagePieceDetailEntity, reinforcementsEntity, method);
...
System_String_o *__fastcall WarBoardCost__CurrentAndMaxPointToString(WarBoardCost_o *this, const MethodInfo *method)
{
  ...
  v6 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &CurrentActionPoint_k__BackingField);
  v7 = 40LL;
  if ( this->fields.overwirteBaseActionPoint < 0 )
    v7 = 24LL;
  v10 = *(_DWORD *)((char *)&this->klass + v7);
  v8 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v10);
  return System_String__Format_62415592((System_String_o *)StringLiteral_25309/*"{0}/{1}"*/, v6, v8, 0LL);
}
...
void __fastcall WarBoardCost__SetOverwriteCost_36030756(
        WarBoardCost_o *this,
        WarBoardReinforcementsEntity_o *reinforcementsEntity,
        const MethodInfo *method)
{
