...
void __fastcall WarBoardCost___ctor_36521284(
        WarBoardCost_o *this,
        int32_t classId,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDA0EF & 1) == 0 )
  {
    sub_1C21E38(&WarBoardCost_TypeInfo);
    byte_4BDA0EF = 1;
  }
  if ( entity )
  {
    ...
    v10 = sub_1C22084(WarBoardCost_TypeInfo);
    *(_QWORD *)(v10 + 40) = -1LL;
    *(_QWORD *)(v10 + 48) = -1LL;
    ...
    *(_DWORD *)(v10 + 36) = wallAttackCost;
    ...
    if ( reinforcementsEntity )
      WarBoardCost__SetOverwriteCost_36521500((WarBoardCost_o *)v10, reinforcementsEntity, v11);
  }
  else
  {
    v10 = sub_1C22084(WarBoardCost_TypeInfo);
...
System_String_o *__fastcall WarBoardCost__CurrentAndMaxPointToString(WarBoardCost_o *this, const MethodInfo *method)
{
  ...
  v9 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &CurrentActionPoint_k__BackingField, v2, v3, v4);
  v10 = 40LL;
  if ( this->fields.overwirteBaseActionPoint < 0 )
    v10 = 24LL;
  v13 = *(_DWORD *)((char *)&this->klass + v10);
  v11 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v13, v6, v7, v8);
  return System_String__Format_63129848((System_String_o *)StringLiteral_25498/*"{0}/{1}"*/, v9, v11, 0LL);
}
...
void __fastcall WarBoardCost__SetOverwriteCost_36521500(
        WarBoardCost_o *this,
        WarBoardReinforcementsEntity_o *reinforcementsEntity,
        const MethodInfo *method)
{
