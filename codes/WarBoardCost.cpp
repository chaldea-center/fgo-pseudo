...
void __fastcall WarBoardCost___ctor_36688932(
        WarBoardCost_o *this,
        int32_t classId,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1FAE5 & 1) == 0 )
  {
    sub_1C3B764(&WarBoardCost_TypeInfo, stagePieceDetailEntity);
    byte_4C1FAE5 = 1;
  }
  if ( entity )
  {
    ...
    v10 = sub_1C3B9B0(WarBoardCost_TypeInfo);
    *(_QWORD *)(v10 + 40) = -1LL;
    *(_QWORD *)(v10 + 48) = -1LL;
    ...
    *(_DWORD *)(v10 + 36) = wallAttackCost;
    ...
    if ( reinforcementsEntity )
      WarBoardCost__SetOverwriteCost_36689148((WarBoardCost_o *)v10, reinforcementsEntity, v11);
  }
  else
  {
    v10 = sub_1C3B9B0(WarBoardCost_TypeInfo);
...
System_String_o *__fastcall WarBoardCost__CurrentAndMaxPointToString(WarBoardCost_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1FAE4 & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_25568, v6);
    byte_4C1FAE4 = 1;
  }
  ...
  return System_String__Format_63382984((System_String_o *)StringLiteral_25568, v10, v12, 0LL);
}
...
void __fastcall WarBoardCost__SetOverwriteCost_36689148(
        WarBoardCost_o *this,
        WarBoardReinforcementsEntity_o *reinforcementsEntity,
        const MethodInfo *method)
{
