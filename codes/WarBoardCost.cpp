...
void WarBoardCost___ctor_38572052(
        WarBoardCost_o *this,
        int32_t classId,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2A177 & 1) == 0 )
  {
    sub_1C94098(&WarBoardCost_TypeInfo);
    byte_4D2A177 = 1;
  }
  if ( entity )
  {
    ...
    v10 = sub_1C942E4(WarBoardCost_TypeInfo);
    *(_QWORD *)(v10 + 40) = -1;
    *(_QWORD *)(v10 + 48) = -1;
    ...
    *(_DWORD *)(v10 + 36) = wallAttackCost;
    ...
    if ( reinforcementsEntity )
      WarBoardCost__SetOverwriteCost_38572268((WarBoardCost_o *)v10, reinforcementsEntity, v11);
  }
  else
  {
    v10 = sub_1C942E4(WarBoardCost_TypeInfo);
...
System_String_o *WarBoardCost__CurrentAndMaxPointToString(WarBoardCost_o *this, const MethodInfo *method)
{
  ...
  return System_String__Format_64459052((System_String_o *)StringLiteral_25409/*"{0}/{1}"*/, v3, v5, 0);
}
...
void WarBoardCost__SetOverwriteCost_38572268(
        WarBoardCost_o *this,
        WarBoardReinforcementsEntity_o *reinforcementsEntity,
        const MethodInfo *method)
{
