...
void WarBoardCost___ctor_38146040(
        WarBoardCost_o *this,
        int32_t classId,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB3CB1 & 1) == 0 )
  {
    sub_1C6BA08(&WarBoardCost_TypeInfo);
    byte_4CB3CB1 = 1;
  }
  if ( entity )
  {
    ...
    v10 = sub_1C6BC54(WarBoardCost_TypeInfo);
    *(_QWORD *)(v10 + 40) = -1;
    *(_QWORD *)(v10 + 48) = -1;
    ...
    *(_DWORD *)(v10 + 36) = wallAttackCost;
    ...
    if ( reinforcementsEntity )
      WarBoardCost__SetOverwriteCost_38146256((WarBoardCost_o *)v10, reinforcementsEntity, v11);
  }
  else
  {
    v10 = sub_1C6BC54(WarBoardCost_TypeInfo);
...
System_String_o *WarBoardCost__CurrentAndMaxPointToString(WarBoardCost_o *this, const MethodInfo *method)
{
  ...
  return System_String__Format_64008100((System_String_o *)StringLiteral_25266/*"{0}/{1}"*/, v3, v5, 0);
}
...
void WarBoardCost__SetOverwriteCost_38146256(
        WarBoardCost_o *this,
        WarBoardReinforcementsEntity_o *reinforcementsEntity,
        const MethodInfo *method)
{
