        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3A58B & 1) == 0 )
  {
    ...
    this = (FriendshipGauge_o *)sub_1BD3458(&DataManager_TypeInfo, v13);
    byte_4B3A58B = 1;
  }
  ...
  this = (FriendshipGauge_o *)DataManager__GetMaster_object_((const MethodInfo_2F31630 *)Method_DataManager_GetMaster_FriendshipMaster___);
...
void __fastcall FriendshipGauge__ChangeGaugeData(FriendshipGauge_o *this, int32_t friendship, const MethodInfo *method)
{
  ...
  if ( (byte_4B3A58A & 1) == 0 )
  {
    sub_1BD3458(&Method_DataManager_GetMasterData_FriendshipMaster___, *(_QWORD *)&friendship);
    ...
    sub_1BD3458(&StringLiteral_20517/*"img_bondsgage_point"*/, v7);
    byte_4B3A58A = 1;
  }
...
LABEL_36:
  ...
  while ( 1 )
  {
    ...
    if ( (__int64)v15 >= this->fields.maxFriendShipRank )
    {
      ...
      if ( !Instance )
        goto LABEL_36;
      UISprite__set_spriteName((UISprite_o *)Instance, (System_String_o *)StringLiteral_20517/*"img_bondsgage_point"*/, 0LL);
    }
    else
    {
      if ( !v11 )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3A588 & 1) == 0 )
  {
    sub_1BD3458(&FriendshipGauge_GaugeData_TypeInfo, *(_QWORD *)&friendshipId);
    byte_4B3A588 = 1;
  }
  this->fields.friendshipId = friendshipId;
  this->fields.maxFriendShipRank = exceedCount + inMaxFriendShipRank;
  v13 = (Il2CppObject *)sub_1BD36A4(FriendshipGauge_GaugeData_TypeInfo);
  System_Object___ctor(v13, 0LL);
  this->fields.nowGauge = (struct FriendshipGauge_GaugeData_o *)v13;
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.nowGauge, (int64_t)v13, v14, v15, v16, v17, v18, v19);
  nowGauge = this->fields.nowGauge;
  if ( !nowGauge )
    sub_1BD36B4(v20, v21);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3A589 & 1) == 0 )
  {
    sub_1BD3458(&FriendshipGauge_GaugeData_TypeInfo, *(_QWORD *)&friendship);
    byte_4B3A589 = 1;
  }
  v7 = (Il2CppObject *)sub_1BD36A4(FriendshipGauge_GaugeData_TypeInfo);
  System_Object___ctor(v7, 0LL);
  this->fields.nextGauge = (struct FriendshipGauge_GaugeData_o *)v7;
  p_nextGauge = &this->fields.nextGauge;
  sub_1BD33FC((PartyOrganizationUtility_o *)p_nextGauge, (int64_t)v7, v9, v10, v11, v12, v13, v14);
  v17 = *p_nextGauge;
  if ( !*p_nextGauge )
    sub_1BD36B4(v15, v16);
