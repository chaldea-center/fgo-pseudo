        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01CEF & 1) == 0 )
  {
    sub_1B64A00(&Method_DataManager_GetMasterData_FriendshipMaster___, max);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01CEE & 1) == 0 )
  {
    sub_1B64A00(&Method_DataManager_GetMasterData_FriendshipMaster___, *(_QWORD *)&friendshipId);
    sub_1B64A00(&Method_UnityEngine_GameObject_GetComponent_UISprite___, v8);
    sub_1B64A00(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v9);
    sub_1B64A00(&StringLiteral_20195/*"img_bondsgage_point"*/, v10);
    byte_4A01CEE = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE930 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01CEC & 1) == 0 )
  {
    sub_1B64A00(&FriendshipGauge_GaugeData_TypeInfo, *(_QWORD *)&friendshipId);
    byte_4A01CEC = 1;
  }
  this->fields.friendshipId = friendshipId;
  this->fields.maxFriendShipRank = exceedCount + inMaxFriendShipRank;
  v13 = (Il2CppObject *)sub_1B64C4C(FriendshipGauge_GaugeData_TypeInfo);
  System_Object___ctor(v13, 0LL);
  this->fields.nowGauge = (struct FriendshipGauge_GaugeData_o *)v13;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.nowGauge, (int32_t)v13, v14, v15);
  nowGauge = this->fields.nowGauge;
  if ( !nowGauge )
    sub_1B64C5C(v16, v17);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01CED & 1) == 0 )
  {
    sub_1B64A00(&FriendshipGauge_GaugeData_TypeInfo, *(_QWORD *)&friendship);
    byte_4A01CED = 1;
  }
  v7 = (Il2CppObject *)sub_1B64C4C(FriendshipGauge_GaugeData_TypeInfo);
  System_Object___ctor(v7, 0LL);
  this->fields.nextGauge = (struct FriendshipGauge_GaugeData_o *)v7;
  p_nextGauge = &this->fields.nextGauge;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)p_nextGauge, (int32_t)v7, v9, v10);
  v13 = *p_nextGauge;
  if ( !*p_nextGauge )
    sub_1B64C5C(v11, v12);
