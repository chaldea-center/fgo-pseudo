        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3F5B9 & 1) == 0 )
  {
    sub_1C37058(&SummonRootComponent__ActivateExternalPurchase_d__12_TypeInfo);
    byte_4C3F5B9 = 1;
  }
  v3 = sub_1C372A4(SummonRootComponent__ActivateExternalPurchase_d__12_TypeInfo);
...
void SummonRootComponent__EndLoadAssetData(SummonRootComponent_o *this, AssetData_o *data, const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.summonAssets, (int32_t)data, (int32_t)method, v3);
  ...
  if ( assetLoadCallback )
  {
    ...
    sub_1C36FFC(p_assetLoadCallback, 0, v7, v8);
...
void SummonRootComponent__EndLoadBg(SummonRootComponent_o *this, AssetData_o *data, const MethodInfo *method)
{
  ...
  if ( (byte_4C3F5BD & 1) == 0 )
  {
    ...
    sub_1C37058(&UnityEngine_Object_TypeInfo);
    this = (SummonRootComponent_o *)sub_1C37058(&StringLiteral_17136/*"bg"*/);
    byte_4C3F5BD = 1;
  }
  if ( !data )
    goto LABEL_18;
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&v4->fields.bgGo, (int32_t)v6, v8, v9);
  ...
  if ( !byte_4C3C921 )
  {
    this = (SummonRootComponent_o *)sub_1C37058(&UnityEngine_Vector3_TypeInfo);
    byte_4C3C921 = 1;
  }
  if ( !v11 )
    goto LABEL_18;
...
SummonControl_o *SummonRootComponent__GetSummonControl(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3F5C7 & 1) == 0 )
  {
    sub_1C37058(&Method_UnityEngine_GameObject_GetComponent_SummonControl___);
    sub_1C37058(&UnityEngine_Object_TypeInfo);
    byte_4C3F5C7 = 1;
  }
  ...
  return (SummonControl_o *)UnityEngine_GameObject__GetComponent_object_(
                              gameObject,
                              (const MethodInfo_313F1D8 *)Method_UnityEngine_GameObject_GetComponent_SummonControl___);
}
...
void SummonRootComponent__GoToSellServant(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  v2 = (SceneJumpInfo_o *)sub_1C372A4(SceneJumpInfo_TypeInfo);
  SceneJumpInfo___ctor_41479120(v2, (System_String_o *)StringLiteral_12687/*"SellServant"*/, 0, 0);
...
void SummonRootComponent__LoadAssetsToScene(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3F5C1 & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_UnityEngine_Object_Instantiate_GameObject___);
    sub_1C37058(&UnityEngine_Object_TypeInfo);
    sub_1C37058(&StringLiteral_13176/*"SummonRoot"*/);
    sub_1C37058(&StringLiteral_12917/*"SmmonEffPref"*/);
    sub_1C37058(&StringLiteral_13171/*"SummonEffect2Prefab"*/);
    byte_4C3F5C1 = 1;
  }
  ...
  Object_object__51154888 = AssetData__GetObject_object__51154888(
                              ...
                              (System_String_o *)StringLiteral_13171/*"SummonEffect2Prefab"*/,
                              (const MethodInfo_30C8FC8 *)Method_AssetData_GetObject_GameObject____78105168);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.summonEffPrefab, (int32_t)v5, v7, v8);
  ...
  if ( !byte_4C3C921 )
  {
    summonAssets = (UnityEngine_GameObject_o *)sub_1C37058(&UnityEngine_Vector3_TypeInfo);
    byte_4C3C921 = 1;
  }
  if ( !v10 )
    goto LABEL_27;
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&summonCtr->fields.summonInstance, (int32_t)summonAssets, v13, v14);
  ...
  if ( !summonAssets
    || (summonAssets = (UnityEngine_GameObject_o *)HutongGames_PlayMaker_FsmVariables__FindFsmGameObject(
                                                     ...
                                                     (System_String_o *)StringLiteral_12917/*"SmmonEffPref"*/,
                                                     0)) == 0
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3F5BF & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1C37058(&Method_SummonRootComponent_EndLoadAssetData__);
  ...
  else
  {
    ...
    sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.assetLoadCallback, (int32_t)callback, v7, v8);
    ...
    AssetManager__loadAssetStorage((System_String_o *)StringLiteral_5893/*"Effect/Summon"*/, v9, 1, 0);
  }
}
...
void SummonRootComponent__SetBg(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3F5BC & 1) == 0 )
  {
    sub_1C37058(&AssetManager_TypeInfo);
    sub_1C37058(&AssetLoader_LoadEndDataHandler_TypeInfo);
    sub_1C37058(&Method_SummonRootComponent_EndLoadBg__);
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.path, v5, v2, v3);
...
void SummonRootComponent__beginFinish(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( !gameObject
    || (SummonControl__quit((SummonControl_o *)gameObject, 0),
        ...
        (gameObject = (UnityEngine_GameObject_o *)SingletonTemplate_object___get_Instance((const MethodInfo_39ED65C *)Method_SingletonTemplate_MissionNotifyManager__get_Instance__)) == 0) )
  {
LABEL_12:
...
void SummonRootComponent__createSvtStandFigure(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  __int64 v13; // x24
  int32_t v14; // w0
  UIStandFigureR_o *RenderPrefab_40746196; // x0
  int32_t v16; // w2
...
LABEL_19:
    ...
    if ( v10 )
    {
      ...
      *(_QWORD *)&v18.fields.fakeValue = v12;
      v14 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48930896(v18, 0);
      RenderPrefab_40746196 = StandFigureManager__CreateRenderPrefab_40746196(
                                svtBase,
                                FIGURE_ID,
                                v14,
                                v10->fields.lv,
    ...
    {
      RenderPrefab_40746196 = StandFigureManager__CreateRenderPrefab_40676404(
                                svtBase,
                                FIGURE_ID,
                                0,
                                1,
    ...
    p_standFigure->klass = (CGThumbnailListItem_c *)RenderPrefab_40746196;
    sub_1C36FFC(p_standFigure, (int32_t)RenderPrefab_40746196, v16, v17);
  }
}
...
void SummonRootComponent__destroyAssetData(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( summonAssets && !AssetData__get_IsEmpty(summonAssets, 0) )
  {
    ...
    sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.summonAssets, 0, v5, v6);
...
void SummonRootComponent__destroySvtStandFigure(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(v4, 0, 0) )
  {
    ...
    *p_standFigure = 0;
    sub_1C36FFC((CGThumbnailListItem_o *)p_standFigure, 0, v7, v8);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3F5CB & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    sub_1C37058(&Method_SummonRootComponent___c__ActivateExternalPurchase_b__12_0__);
    sub_1C37058(&SummonRootComponent___c_TypeInfo);
  ...
  if ( !_9__12_0 )
  {
    ...
    _9__12_0 = (System_Func_bool__o *)sub_1C372A4(System_Func_bool__TypeInfo);
    ...
    sub_1C36FFC((CGThumbnailListItem_o *)&static_fields->__9__12_0, (int32_t)_9__12_0, v9, v10);
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C3706C(&Method_SummonRootComponent__ActivateExternalPurchase_d__12_System_Collections_IEnumerator_Reset__);
  sub_1C37180(v3, v4);
}
...
void SummonRootComponent___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C372A4(SummonRootComponent___c_TypeInfo);
  System_Object___ctor(v1, 0);
  SummonRootComponent___c_TypeInfo->static_fields->__9 = (struct SummonRootComponent___c_o *)v1;
  sub_1C36FFC((CGThumbnailListItem_o *)SummonRootComponent___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
