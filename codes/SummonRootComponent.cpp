void __fastcall SummonRootComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB25A2 & 1) == 0 )
  {
    sub_1BAB41C(&SummonRootComponent_TypeInfo, v1);
    byte_4AB25A2 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB2594 & 1) == 0 )
  {
    sub_1BAB41C(&SummonRootComponent__ActivateExternalPurchase_d__12_TypeInfo, method);
    byte_4AB2594 = 1;
  }
  v3 = sub_1BAB668(SummonRootComponent__ActivateExternalPurchase_d__12_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.summonAssets, (int32_t)data, (int32_t)method, v3);
  ...
  if ( assetLoadCallback )
  {
    ...
    sub_1BAB3C0(p_assetLoadCallback, 0, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB2598 & 1) == 0 )
  {
    ...
    this = (SummonRootComponent_o *)sub_1BAB41C(&StringLiteral_17197/*"bg"*/, v7);
    byte_4AB2598 = 1;
  }
  if ( !data )
    goto LABEL_18;
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&v4->fields.bgGo, (int32_t)v9, v11, v12);
  ...
  if ( !byte_4AB0691 )
  {
    this = (SummonRootComponent_o *)sub_1BAB41C(&UnityEngine_Vector3_TypeInfo, data);
    byte_4AB0691 = 1;
  }
  if ( !v14 )
    goto LABEL_18;
...
void __fastcall SummonRootComponent__GoToSellServant(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB25A1 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_12613/*"SellServant"*/, v3);
    byte_4AB25A1 = 1;
  }
  v4 = (SceneJumpInfo_o *)sub_1BAB668(SceneJumpInfo_TypeInfo);
  SceneJumpInfo___ctor_39049412(v4, (System_String_o *)StringLiteral_12613/*"SellServant"*/, 0, 0LL);
...
void __fastcall SummonRootComponent__LoadAssetsToScene(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB259C & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_UnityEngine_GameObject_GetComponent_PlayMakerFSM___, v3);
    sub_1BAB41C(&Method_UnityEngine_Object_Instantiate_GameObject___, v4);
    sub_1BAB41C(&UnityEngine_Object_TypeInfo, v5);
    sub_1BAB41C(&StringLiteral_13111/*"SummonRoot"*/, v6);
    sub_1BAB41C(&StringLiteral_12845/*"SmmonEffPref"*/, v7);
    sub_1BAB41C(&StringLiteral_13106/*"SummonEffect2Prefab"*/, v8);
    byte_4AB259C = 1;
  }
  ...
  Object_object__48916712 = AssetData__GetObject_object__48916712(
                              ...
                              (System_String_o *)StringLiteral_13106/*"SummonEffect2Prefab"*/,
                              (const MethodInfo_2EA68E8 *)Method_AssetData_GetObject_GameObject____76450888);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.summonEffPrefab, (int32_t)v11, v13, v14);
  ...
  if ( !byte_4AB0691 )
  {
    summonAssets = (UnityEngine_GameObject_o *)sub_1BAB41C(&UnityEngine_Vector3_TypeInfo, method);
    byte_4AB0691 = 1;
  }
  if ( !v16 )
    goto LABEL_27;
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&summonCtr->fields.summonInstance, (int32_t)summonAssets, v19, v20);
  ...
  if ( !summonAssets
    || (summonAssets = (UnityEngine_GameObject_o *)HutongGames_PlayMaker_FsmVariables__FindFsmGameObject(
                                                     ...
                                                     (System_String_o *)StringLiteral_12845/*"SmmonEffPref"*/,
                                                     0LL)) == 0LL
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB259A & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_SummonRootComponent_EndLoadAssetData__, v7);
    sub_1BAB41C(&StringLiteral_5855/*"Effect/Summon"*/, v8);
    byte_4AB259A = 1;
  }
  ...
  else
  {
    ...
    sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.assetLoadCallback, (int32_t)callback, v12, v13);
    ...
    AssetManager__loadAssetStorage((System_String_o *)StringLiteral_5855/*"Effect/Summon"*/, v14, 1, 0LL);
  }
}
...
void __fastcall SummonRootComponent__SetBg(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB2597 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&AssetLoader_LoadEndDataHandler_TypeInfo, v5);
    sub_1BAB41C(&Method_SummonRootComponent_EndLoadBg__, v6);
    sub_1BAB41C(&StringLiteral_3264/*"Bg/10500"*/, v7);
    byte_4AB2597 = 1;
  }
  v8 = StringLiteral_3264/*"Bg/10500"*/;
  this->fields.path = (struct System_String_o *)StringLiteral_3264/*"Bg/10500"*/;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.path, v8, v2, v3);
...
void __fastcall SummonRootComponent__beginFinish(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB2596 & 1) == 0 )
  {
    sub_1BAB41C(&Method_UnityEngine_GameObject_GetComponent_SummonControl___, method);
  ...
  else
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                               gameObject,
                                               (const MethodInfo_2F13970 *)Method_UnityEngine_GameObject_GetComponent_SummonControl___);
  }
  if ( !gameObject
    || (SummonControl__quit((SummonControl_o *)gameObject, 0LL),
        ...
        (gameObject = (UnityEngine_GameObject_o *)SingletonTemplate_object___get_Instance((const MethodInfo_378A64C *)Method_SingletonTemplate_MissionNotifyManager__get_Instance__)) == 0LL) )
  {
LABEL_12:
...
void __fastcall SummonRootComponent__createSvtStandFigure(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  __int64 v18; // x24
  int32_t v19; // w0
  UIStandFigureR_o *RenderPrefab_38362148; // x0
  int32_t v21; // w2
  int32_t v22; // w3
  ...
  if ( (byte_4AB259F & 1) == 0 )
  {
    ...
    sub_1BAB41C(&SummonRootComponent_TypeInfo, v6);
    byte_4AB259F = 1;
  }
...
LABEL_19:
    ...
    if ( v15 )
    {
      ...
      *(_QWORD *)&v23.fields.fakeValue = v17;
      v19 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46695852(v23, 0LL);
      RenderPrefab_38362148 = StandFigureManager__CreateRenderPrefab_38362148(
                                svtBase,
                                FIGURE_ID,
                                v19,
                                v15->fields.lv,
    ...
    {
      RenderPrefab_38362148 = StandFigureManager__CreateRenderPrefab_38362816(
                                svtBase,
                                FIGURE_ID,
                                0,
                                1,
    ...
    p_standFigure->klass = (ServantStatusBattleListViewItem_c *)RenderPrefab_38362148;
    sub_1BAB3C0(p_standFigure, (int32_t)RenderPrefab_38362148, v21, v22);
  }
}
...
void __fastcall SummonRootComponent__destroyAssetData(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( summonAssets && !AssetData__get_IsEmpty(summonAssets, 0LL) )
  {
    ...
    sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.summonAssets, 0, v5, v6);
...
void __fastcall SummonRootComponent__destroySvtStandFigure(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(v4, 0LL, 0LL) )
  {
    ...
    *p_standFigure = 0LL;
    sub_1BAB3C0((ServantStatusBattleListViewItem_o *)p_standFigure, 0, v8, v9);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB25A5 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_SummonRootComponent___c__ActivateExternalPurchase_b__12_0__, v5);
    sub_1BAB41C(&SummonRootComponent___c_TypeInfo, v6);
    sub_1BAB41C(&UnityEngine_WaitUntil_TypeInfo, v7);
    byte_4AB25A5 = 1;
  }
  ...
  if ( !_9__12_0 )
  {
    ...
    _9__12_0 = (System_Func_bool__o *)sub_1BAB668(System_Func_bool__TypeInfo);
    ...
    sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&static_fields->__9__12_0, (int32_t)_9__12_0, v14, v15);
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BAB430(&Method_SummonRootComponent__ActivateExternalPurchase_d__12_System_Collections_IEnumerator_Reset__);
  sub_1BAB544(v3, v4);
}
...
void __fastcall SummonRootComponent___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB25A3 & 1) == 0 )
  {
    sub_1BAB41C(&SummonRootComponent___c_TypeInfo, v1);
    byte_4AB25A3 = 1;
  }
  v2 = (Il2CppObject *)sub_1BAB668(SummonRootComponent___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  SummonRootComponent___c_TypeInfo->static_fields->__9 = (struct SummonRootComponent___c_o *)v2;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)SummonRootComponent___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB25A4 & 1) == 0 )
  {
    sub_1BAB41C(&PurchaseLogicExternal_TypeInfo, method);
    byte_4AB25A4 = 1;
  }
