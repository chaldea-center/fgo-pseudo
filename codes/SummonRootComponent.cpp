void __fastcall SummonRootComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FB4BF & 1) == 0 )
  {
    sub_1B64A00(&SummonRootComponent_TypeInfo, v1);
    byte_49FB4BF = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.summonAssets, (int32_t)data, (int32_t)method, v3);
  ...
  if ( assetLoadCallback )
  {
    ...
    sub_1B649A4(p_assetLoadCallback, 0, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB4B5 & 1) == 0 )
  {
    ...
    this = (SummonRootComponent_o *)sub_1B64A00(&StringLiteral_17099/*"bg"*/, v7);
    byte_49FB4B5 = 1;
  }
  if ( !data )
    goto LABEL_18;
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&v4->fields.bgGo, (int32_t)v9, v11, v12);
  ...
  if ( !byte_49F9821 )
  {
    this = (SummonRootComponent_o *)sub_1B64A00(&UnityEngine_Vector3_TypeInfo, data);
    byte_49F9821 = 1;
  }
  if ( !v14 )
    goto LABEL_18;
...
void __fastcall SummonRootComponent__GoToSellServant(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FB4BE & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_12529/*"SellServant"*/, v3);
    byte_49FB4BE = 1;
  }
  v4 = (SceneJumpInfo_o *)sub_1B64C4C(SceneJumpInfo_TypeInfo);
  SceneJumpInfo___ctor_38279460(v4, (System_String_o *)StringLiteral_12529/*"SellServant"*/, 0, 0LL);
...
void __fastcall SummonRootComponent__LoadAssetsToScene(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FB4B9 & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_UnityEngine_GameObject_GetComponent_PlayMakerFSM___, v3);
    sub_1B64A00(&Method_UnityEngine_Object_Instantiate_GameObject___, v4);
    sub_1B64A00(&UnityEngine_Object_TypeInfo, v5);
    sub_1B64A00(&StringLiteral_13022/*"SummonRoot"*/, v6);
    sub_1B64A00(&StringLiteral_12759/*"SmmonEffPref"*/, v7);
    sub_1B64A00(&StringLiteral_13017/*"SummonEffect2Prefab"*/, v8);
    byte_49FB4B9 = 1;
  }
  ...
  Object_object__48358160 = AssetData__GetObject_object__48358160(
                              ...
                              (System_String_o *)StringLiteral_13017/*"SummonEffect2Prefab"*/,
                              (const MethodInfo_2E1E310 *)Method_AssetData_GetObject_GameObject____75715992);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.summonEffPrefab, (int32_t)v11, v13, v14);
  ...
  if ( !byte_49F9821 )
  {
    summonAssets = (UnityEngine_GameObject_o *)sub_1B64A00(&UnityEngine_Vector3_TypeInfo, method);
    byte_49F9821 = 1;
  }
  if ( !v16 )
    goto LABEL_27;
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&summonCtr->fields.summonInstance, (int32_t)summonAssets, v19, v20);
  ...
  if ( !summonAssets
    || (summonAssets = (UnityEngine_GameObject_o *)HutongGames_PlayMaker_FsmVariables__FindFsmGameObject(
                                                     ...
                                                     (System_String_o *)StringLiteral_12759/*"SmmonEffPref"*/,
                                                     0LL)) == 0LL
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB4B7 & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_SummonRootComponent_EndLoadAssetData__, v7);
    sub_1B64A00(&StringLiteral_5827/*"Effect/Summon"*/, v8);
    byte_49FB4B7 = 1;
  }
  ...
  else
  {
    ...
    sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.assetLoadCallback, (int32_t)callback, v12, v13);
...
void __fastcall SummonRootComponent__SetBg(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FB4B4 & 1) == 0 )
  {
    ...
    sub_1B64A00(&AssetLoader_LoadEndDataHandler_TypeInfo, v5);
    sub_1B64A00(&Method_SummonRootComponent_EndLoadBg__, v6);
    sub_1B64A00(&StringLiteral_3247/*"Bg/10500"*/, v7);
    byte_49FB4B4 = 1;
  }
  v8 = StringLiteral_3247/*"Bg/10500"*/;
  this->fields.path = (struct System_String_o *)StringLiteral_3247/*"Bg/10500"*/;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.path, v8, v2, v3);
...
void __fastcall SummonRootComponent__beginFinish(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FB4B3 & 1) == 0 )
  {
    sub_1B64A00(&Method_UnityEngine_GameObject_GetComponent_SummonControl___, method);
  ...
  else
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                               gameObject,
                                               (const MethodInfo_2E8A7CC *)Method_UnityEngine_GameObject_GetComponent_SummonControl___);
  }
  if ( !gameObject
    || (SummonControl__quit((SummonControl_o *)gameObject, 0LL),
        ...
        (gameObject = (UnityEngine_GameObject_o *)SingletonTemplate_object___get_Instance((const MethodInfo_36EED50 *)Method_SingletonTemplate_MissionNotifyManager__get_Instance__)) == 0LL) )
  {
LABEL_12:
...
void __fastcall SummonRootComponent__createSvtStandFigure(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  __int64 v18; // x24
  int32_t v19; // w0
  UIStandFigureR_o *RenderPrefab_37666852; // x0
  int32_t v21; // w2
  int32_t v22; // w3
  ...
  if ( (byte_49FB4BC & 1) == 0 )
  {
    ...
    sub_1B64A00(&SummonRootComponent_TypeInfo, v6);
    byte_49FB4BC = 1;
  }
...
LABEL_19:
    ...
    if ( v15 )
    {
      ...
      *(_QWORD *)&v23.fields.fakeValue = v17;
      v19 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46182092(v23, 0LL);
      RenderPrefab_37666852 = StandFigureManager__CreateRenderPrefab_37666852(
                                svtBase,
                                FIGURE_ID,
                                v19,
                                v15->fields.lv,
    ...
    {
      RenderPrefab_37666852 = StandFigureManager__CreateRenderPrefab_37612660(
                                svtBase,
                                FIGURE_ID,
                                0,
                                1,
    ...
    p_standFigure->klass = (ServantStatusBattleListViewItem_c *)RenderPrefab_37666852;
    sub_1B649A4(p_standFigure, (int32_t)RenderPrefab_37666852, v21, v22);
  }
}
...
void __fastcall SummonRootComponent__destroyAssetData(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( summonAssets && !AssetData__get_IsEmpty(summonAssets, 0LL) )
  {
    ...
    sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.summonAssets, 0, v5, v6);
...
void __fastcall SummonRootComponent__destroySvtStandFigure(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(v4, 0LL, 0LL) )
  {
    ...
    *p_standFigure = 0LL;
    sub_1B649A4((ServantStatusBattleListViewItem_o *)p_standFigure, 0, v8, v9);
  }
}