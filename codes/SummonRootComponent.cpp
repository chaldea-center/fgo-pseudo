        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C238FE & 1) == 0 )
  {
    sub_1C2D490(&SummonRootComponent__ActivateExternalPurchase_d__12_TypeInfo);
    byte_4C238FE = 1;
  }
  v3 = sub_1C2D6DC(SummonRootComponent__ActivateExternalPurchase_d__12_TypeInfo);
...
void SummonRootComponent__EndLoadAssetData(SummonRootComponent_o *this, AssetData_o *data, const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.summonAssets, (int32_t)data, (int32_t)method, v3);
  ...
  if ( assetLoadCallback )
  {
    ...
    sub_1C2D434(p_assetLoadCallback, 0, v7, v8);
...
void SummonRootComponent__EndLoadBg(SummonRootComponent_o *this, AssetData_o *data, const MethodInfo *method)
{
  ...
  if ( (byte_4C23902 & 1) == 0 )
  {
    ...
    sub_1C2D490(&UnityEngine_Object_TypeInfo);
    this = (SummonRootComponent_o *)sub_1C2D490(&StringLiteral_17130/*"bg"*/);
    byte_4C23902 = 1;
  }
  if ( !data )
    goto LABEL_18;
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&v4->fields.bgGo, (int32_t)v6, v8, v9);
  ...
  if ( !byte_4C20DA1 )
  {
    this = (SummonRootComponent_o *)sub_1C2D490(&UnityEngine_Vector3_TypeInfo);
    byte_4C20DA1 = 1;
  }
  if ( !v11 )
    goto LABEL_18;
...
SummonControl_o *SummonRootComponent__GetSummonControl(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2390C & 1) == 0 )
  {
    sub_1C2D490(&Method_UnityEngine_GameObject_GetComponent_SummonControl___);
    sub_1C2D490(&UnityEngine_Object_TypeInfo);
    byte_4C2390C = 1;
  }
  ...
  return (SummonControl_o *)UnityEngine_GameObject__GetComponent_object_(
                              gameObject,
                              (const MethodInfo_3125ED0 *)Method_UnityEngine_GameObject_GetComponent_SummonControl___);
}
...
void SummonRootComponent__GoToSellServant(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  v2 = (SceneJumpInfo_o *)sub_1C2D6DC(SceneJumpInfo_TypeInfo);
  SceneJumpInfo___ctor_41257388(v2, (System_String_o *)StringLiteral_12682/*"SellServant"*/, 0, 0);
...
void SummonRootComponent__LoadAssetsToScene(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C23906 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_UnityEngine_Object_Instantiate_GameObject___);
    sub_1C2D490(&UnityEngine_Object_TypeInfo);
    sub_1C2D490(&StringLiteral_13172/*"SummonRoot"*/);
    sub_1C2D490(&StringLiteral_12913/*"SmmonEffPref"*/);
    sub_1C2D490(&StringLiteral_13167/*"SummonEffect2Prefab"*/);
    byte_4C23906 = 1;
  }
  ...
  Object_object__51051712 = AssetData__GetObject_object__51051712(
                              ...
                              (System_String_o *)StringLiteral_13167/*"SummonEffect2Prefab"*/,
                              (const MethodInfo_30AFCC0 *)Method_AssetData_GetObject_GameObject____77994080);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.summonEffPrefab, (int32_t)v5, v7, v8);
  ...
  if ( !byte_4C20DA1 )
  {
    summonAssets = (UnityEngine_GameObject_o *)sub_1C2D490(&UnityEngine_Vector3_TypeInfo);
    byte_4C20DA1 = 1;
  }
  if ( !v10 )
    goto LABEL_27;
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&summonCtr->fields.summonInstance, (int32_t)summonAssets, v13, v14);
  ...
  if ( !summonAssets
    || (summonAssets = (UnityEngine_GameObject_o *)HutongGames_PlayMaker_FsmVariables__FindFsmGameObject(
                                                     ...
                                                     (System_String_o *)StringLiteral_12913/*"SmmonEffPref"*/,
                                                     0)) == 0
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C23904 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1C2D490(&Method_SummonRootComponent_EndLoadAssetData__);
  ...
  else
  {
    ...
    sub_1C2D434((CGThumbnailListItem_o *)&this->fields.assetLoadCallback, (int32_t)callback, v8, v9);
    ...
    AssetManager__loadAssetStorage((System_String_o *)StringLiteral_5884/*"Effect/Summon"*/, v10, 1, 0);
  }
}
...
void SummonRootComponent__SetBg(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C23901 & 1) == 0 )
  {
    sub_1C2D490(&AssetManager_TypeInfo);
    sub_1C2D490(&AssetLoader_LoadEndDataHandler_TypeInfo);
    sub_1C2D490(&Method_SummonRootComponent_EndLoadBg__);
    sub_1C2D490(&StringLiteral_3147/*"Bg/10500"*/);
    byte_4C23901 = 1;
  }
  v5 = StringLiteral_3147/*"Bg/10500"*/;
  this->fields.path = (struct System_String_o *)StringLiteral_3147/*"Bg/10500"*/;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.path, v5, v2, v3);
...
void SummonRootComponent__beginFinish(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( !gameObject
    || (SummonControl__quit((SummonControl_o *)gameObject, 0),
        ...
        (gameObject = (UnityEngine_GameObject_o *)SingletonTemplate_object___get_Instance((const MethodInfo_39D40EC *)Method_SingletonTemplate_MissionNotifyManager__get_Instance__)) == 0) )
  {
LABEL_12:
...
void SummonRootComponent__createSvtStandFigure(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  __int64 v14; // x24
  int32_t v15; // w0
  UIStandFigureR_o *RenderPrefab_40524612; // x0
  int32_t v17; // w2
...
LABEL_19:
    ...
    if ( v11 )
    {
      ...
      *(_QWORD *)&v19.fields.fakeValue = v13;
      v15 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v19, 0);
      RenderPrefab_40524612 = StandFigureManager__CreateRenderPrefab_40524612(
                                svtBase,
                                FIGURE_ID,
                                v15,
                                v11->fields.lv,
    ...
    {
      RenderPrefab_40524612 = StandFigureManager__CreateRenderPrefab_40454792(
                                svtBase,
                                FIGURE_ID,
                                0,
                                1,
    ...
    p_standFigure->klass = (CGThumbnailListItem_c *)RenderPrefab_40524612;
    sub_1C2D434(p_standFigure, (int32_t)RenderPrefab_40524612, v17, v18);
  }
}
...
void SummonRootComponent__destroyAssetData(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( summonAssets && !AssetData__get_IsEmpty(summonAssets, 0) )
  {
    ...
    sub_1C2D434((CGThumbnailListItem_o *)&this->fields.summonAssets, 0, v5, v6);
...
void SummonRootComponent__destroySvtStandFigure(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(v4, 0, 0) )
  {
    ...
    *p_standFigure = 0;
    sub_1C2D434((CGThumbnailListItem_o *)p_standFigure, 0, v8, v9);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C23910 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    sub_1C2D490(&Method_SummonRootComponent___c__ActivateExternalPurchase_b__12_0__);
    sub_1C2D490(&SummonRootComponent___c_TypeInfo);
  ...
  if ( !_9__12_0 )
  {
    ...
    _9__12_0 = (System_Func_bool__o *)sub_1C2D6DC(System_Func_bool__TypeInfo);
    ...
    sub_1C2D434((CGThumbnailListItem_o *)&static_fields->__9__12_0, (int32_t)_9__12_0, v9, v10);
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C2D4A4(&Method_SummonRootComponent__ActivateExternalPurchase_d__12_System_Collections_IEnumerator_Reset__);
  sub_1C2D5B8(v3, v4);
}
...
void SummonRootComponent___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C2D6DC(SummonRootComponent___c_TypeInfo);
  System_Object___ctor(v1, 0);
  SummonRootComponent___c_TypeInfo->static_fields->__9 = (struct SummonRootComponent___c_o *)v1;
  sub_1C2D434((CGThumbnailListItem_o *)SummonRootComponent___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
