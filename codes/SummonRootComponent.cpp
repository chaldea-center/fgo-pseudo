void __fastcall SummonRootComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A2A876 & 1) == 0 )
  {
    sub_1B761C0(&SummonRootComponent_TypeInfo, v1);
    byte_4A2A876 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.summonAssets, (int32_t)data, (int32_t)method, v3);
  ...
  if ( assetLoadCallback )
  {
    ...
    sub_1B76164(p_assetLoadCallback, 0, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A86C & 1) == 0 )
  {
    ...
    this = (SummonRootComponent_o *)sub_1B761C0(&StringLiteral_17158/*"bg"*/, v7);
    byte_4A2A86C = 1;
  }
  if ( !data )
    goto LABEL_18;
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&v4->fields.bgGo, (int32_t)v9, v11, v12);
  ...
  if ( !byte_4A28BB1 )
  {
    this = (SummonRootComponent_o *)sub_1B761C0(&UnityEngine_Vector3_TypeInfo, data);
    byte_4A28BB1 = 1;
  }
  if ( !v14 )
    goto LABEL_18;
...
void __fastcall SummonRootComponent__GoToSellServant(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2A875 & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_12580/*"SellServant"*/, v3);
    byte_4A2A875 = 1;
  }
  v4 = (SceneJumpInfo_o *)sub_1B7640C(SceneJumpInfo_TypeInfo);
  SceneJumpInfo___ctor_38409780(v4, (System_String_o *)StringLiteral_12580/*"SellServant"*/, 0, 0LL);
...
void __fastcall SummonRootComponent__LoadAssetsToScene(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2A870 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_UnityEngine_GameObject_GetComponent_PlayMakerFSM___, v3);
    sub_1B761C0(&Method_UnityEngine_Object_Instantiate_GameObject___, v4);
    sub_1B761C0(&UnityEngine_Object_TypeInfo, v5);
    sub_1B761C0(&StringLiteral_13075/*"SummonRoot"*/, v6);
    sub_1B761C0(&StringLiteral_12812/*"SmmonEffPref"*/, v7);
    sub_1B761C0(&StringLiteral_13070/*"SummonEffect2Prefab"*/, v8);
    byte_4A2A870 = 1;
  }
  ...
  Object_object__48515452 = AssetData__GetObject_object__48515452(
                              ...
                              (System_String_o *)StringLiteral_13070/*"SummonEffect2Prefab"*/,
                              (const MethodInfo_2E4497C *)Method_AssetData_GetObject_GameObject____75903216);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.summonEffPrefab, (int32_t)v11, v13, v14);
  ...
  if ( !byte_4A28BB1 )
  {
    summonAssets = (UnityEngine_GameObject_o *)sub_1B761C0(&UnityEngine_Vector3_TypeInfo, method);
    byte_4A28BB1 = 1;
  }
  if ( !v16 )
    goto LABEL_27;
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&summonCtr->fields.summonInstance, (int32_t)summonAssets, v19, v20);
  ...
  if ( !summonAssets
    || (summonAssets = (UnityEngine_GameObject_o *)HutongGames_PlayMaker_FsmVariables__FindFsmGameObject(
                                                     ...
                                                     (System_String_o *)StringLiteral_12812/*"SmmonEffPref"*/,
                                                     0LL)) == 0LL
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A86E & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_SummonRootComponent_EndLoadAssetData__, v7);
    sub_1B761C0(&StringLiteral_5851/*"Effect/Summon"*/, v8);
    byte_4A2A86E = 1;
  }
  ...
  else
  {
    ...
    sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.assetLoadCallback, (int32_t)callback, v12, v13);
    ...
    AssetManager__loadAssetStorage((System_String_o *)StringLiteral_5851/*"Effect/Summon"*/, v14, 1, 0LL);
  }
}
...
void __fastcall SummonRootComponent__SetBg(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2A86B & 1) == 0 )
  {
    ...
    sub_1B761C0(&AssetLoader_LoadEndDataHandler_TypeInfo, v5);
    sub_1B761C0(&Method_SummonRootComponent_EndLoadBg__, v6);
    sub_1B761C0(&StringLiteral_3267/*"Bg/10500"*/, v7);
    byte_4A2A86B = 1;
  }
  v8 = StringLiteral_3267/*"Bg/10500"*/;
  this->fields.path = (struct System_String_o *)StringLiteral_3267/*"Bg/10500"*/;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.path, v8, v2, v3);
...
void __fastcall SummonRootComponent__beginFinish(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2A86A & 1) == 0 )
  {
    sub_1B761C0(&Method_UnityEngine_GameObject_GetComponent_SummonControl___, method);
  ...
  else
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                               gameObject,
                                               (const MethodInfo_2EB19B8 *)Method_UnityEngine_GameObject_GetComponent_SummonControl___);
  }
  if ( !gameObject
    || (SummonControl__quit((SummonControl_o *)gameObject, 0LL),
        ...
        (gameObject = (UnityEngine_GameObject_o *)SingletonTemplate_object___get_Instance((const MethodInfo_371299C *)Method_SingletonTemplate_MissionNotifyManager__get_Instance__)) == 0LL) )
  {
LABEL_12:
...
void __fastcall SummonRootComponent__createSvtStandFigure(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  __int64 v18; // x24
  int32_t v19; // w0
  UIStandFigureR_o *RenderPrefab_37796924; // x0
  int32_t v21; // w2
  int32_t v22; // w3
  ...
  if ( (byte_4A2A873 & 1) == 0 )
  {
    ...
    sub_1B761C0(&SummonRootComponent_TypeInfo, v6);
    byte_4A2A873 = 1;
  }
...
LABEL_19:
    ...
    if ( v15 )
    {
      ...
      *(_QWORD *)&v23.fields.fakeValue = v17;
      v19 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(v23, 0LL);
      RenderPrefab_37796924 = StandFigureManager__CreateRenderPrefab_37796924(
                                svtBase,
                                FIGURE_ID,
                                v19,
                                v15->fields.lv,
    ...
    {
      RenderPrefab_37796924 = StandFigureManager__CreateRenderPrefab_37742724(
                                svtBase,
                                FIGURE_ID,
                                0,
                                1,
    ...
    p_standFigure->klass = (ServantStatusBattleListViewItem_c *)RenderPrefab_37796924;
    sub_1B76164(p_standFigure, (int32_t)RenderPrefab_37796924, v21, v22);
  }
}
...
void __fastcall SummonRootComponent__destroyAssetData(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( summonAssets && !AssetData__get_IsEmpty(summonAssets, 0LL) )
  {
    ...
    sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.summonAssets, 0, v5, v6);
...
void __fastcall SummonRootComponent__destroySvtStandFigure(SummonRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(v4, 0LL, 0LL) )
  {
    ...
    *p_standFigure = 0LL;
    sub_1B76164((ServantStatusBattleListViewItem_o *)p_standFigure, 0, v8, v9);
  }
}