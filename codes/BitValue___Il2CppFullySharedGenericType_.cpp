void __fastcall BitValue___Il2CppFullySharedGenericType____ctor(
        ...
        const MethodInfo_2F6B4DC *method)
{
  int32_t v5; // w2
  int32_t v6; // w3
...
bool __fastcall BitValue___Il2CppFullySharedGenericType___Check(
        ...
        const MethodInfo_2F6B6CC *method)
{
  __int64 v3; // x23
  __int64 v4; // x8
  _QWORD *v5; // x20
...
bool __fastcall BitValue___Il2CppFullySharedGenericType___CheckAndOff(
        BitValue_T__o *this,
        Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_o val,
        const MethodInfo_2F6B7A8 *method)
{
  _QWORD *monitor; // x22
...
void __fastcall BitValue___Il2CppFullySharedGenericType___Off(
        BitValue_T__o *this,
        Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_o val,
        const MethodInfo_2F6B5EC *method)
{
  __int64 v4; // x24
  __int64 v5; // x8
  _QWORD *v6; // x21
...
void __fastcall BitValue___Il2CppFullySharedGenericType___On(
        BitValue_T__o *this,
        Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_o val,
        const MethodInfo_2F6B50C *method)
{
  __int64 v4; // x24
  __int64 v5; // x8
  _QWORD *v6; // x21
...
void __fastcall BitValue___Il2CppFullySharedGenericType___Reset(BitValue_T__o *this, const MethodInfo_2F6B900 *method)
{
  this->fields.value = 0;
}