...
System_String_o *__fastcall GiftAddEntity__GetOverwriteDetailText(GiftAddEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1FD95 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_22329/*"overwriteDetailText"*/, v4);
    byte_4A1FD95 = 1;
  }
  result = (System_String_o *)GiftAddEntity__GetScriptValue(this, (System_String_o *)StringLiteral_22329/*"overwriteDetailText"*/, v2);
  if ( result )
  {
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B715CC(&string_TypeInfo, method);
    sub_1B715CC(&StringLiteral_22360/*"overwriteTreasureEffectId"*/, v4);
    byte_4A1FD94 = 1;
  }
  result = (System_String_o *)GiftAddEntity__GetScriptValue(this, (System_String_o *)StringLiteral_22360/*"overwriteTreasureEffectId"*/, v2);
  if ( result )
  {
    if ( result->klass != string_TypeInfo )
    {
