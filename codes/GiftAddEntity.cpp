...
System_String_o *__fastcall GiftAddEntity__GetOverwriteDetailText(GiftAddEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2E202 & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_22375/*"overwriteDetailText"*/, v4);
    byte_4A2E202 = 1;
  }
  result = (System_String_o *)GiftAddEntity__GetScriptValue(this, (System_String_o *)StringLiteral_22375/*"overwriteDetailText"*/, v2);
  if ( result )
  {
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B761C0(&string_TypeInfo, method);
    sub_1B761C0(&StringLiteral_22406/*"overwriteTreasureEffectId"*/, v4);
    byte_4A2E201 = 1;
  }
  result = (System_String_o *)GiftAddEntity__GetScriptValue(this, (System_String_o *)StringLiteral_22406/*"overwriteTreasureEffectId"*/, v2);
  if ( result )
  {
    if ( result->klass != string_TypeInfo )
    {
