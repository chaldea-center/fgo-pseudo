...
System_String_o *__fastcall GiftAddEntity__GetOverWriteTitleSprite(GiftAddEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B66E97 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_22735/*"overwriteTitleSprite"*/, v4);
    byte_4B66E97 = 1;
  }
  result = (System_String_o *)GiftAddEntity__GetScriptValue(this, (System_String_o *)StringLiteral_22735/*"overwriteTitleSprite"*/, v2);
  if ( result )
  {
...
System_String_o *__fastcall GiftAddEntity__GetOverwriteDetailText(GiftAddEntity_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BE4ACC(&string_TypeInfo, method);
    sub_1BE4ACC(&StringLiteral_22703/*"overwriteDetailText"*/, v4);
    byte_4B66E96 = 1;
  }
  result = (System_String_o *)GiftAddEntity__GetScriptValue(this, (System_String_o *)StringLiteral_22703/*"overwriteDetailText"*/, v2);
  if ( result )
  {
    if ( result->klass != string_TypeInfo )
    {
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BE4ACC(&string_TypeInfo, method);
    sub_1BE4ACC(&StringLiteral_22737/*"overwriteTreasureEffectId"*/, v4);
    byte_4B66E95 = 1;
  }
  result = (System_String_o *)GiftAddEntity__GetScriptValue(this, (System_String_o *)StringLiteral_22737/*"overwriteTreasureEffectId"*/, v2);
  if ( result )
  {
    if ( result->klass != string_TypeInfo )
    {
