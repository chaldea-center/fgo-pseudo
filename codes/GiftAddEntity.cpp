...
System_String_o *__fastcall GiftAddEntity__GetOverWriteTitleSprite(GiftAddEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC7D7E & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_22806/*"overwriteTitleSprite"*/, v4);
    byte_4BC7D7E = 1;
  }
  result = (System_String_o *)GiftAddEntity__GetScriptValue(this, (System_String_o *)StringLiteral_22806/*"overwriteTitleSprite"*/, v2);
  if ( result )
  {
...
System_String_o *__fastcall GiftAddEntity__GetOverwriteDetailText(GiftAddEntity_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C1ABD4(&string_TypeInfo, method);
    sub_1C1ABD4(&StringLiteral_22773/*"overwriteDetailText"*/, v4);
    byte_4BC7D7D = 1;
  }
  result = (System_String_o *)GiftAddEntity__GetScriptValue(this, (System_String_o *)StringLiteral_22773/*"overwriteDetailText"*/, v2);
  if ( result )
  {
    if ( result->klass != string_TypeInfo )
    {
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C1ABD4(&string_TypeInfo, method);
    sub_1C1ABD4(&StringLiteral_22808/*"overwriteTreasureEffectId"*/, v4);
    byte_4BC7D7C = 1;
  }
  result = (System_String_o *)GiftAddEntity__GetScriptValue(this, (System_String_o *)StringLiteral_22808/*"overwriteTreasureEffectId"*/, v2);
  if ( result )
  {
    if ( result->klass != string_TypeInfo )
    {
