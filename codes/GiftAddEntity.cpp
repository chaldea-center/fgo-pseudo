...
System_String_o *__fastcall GiftAddEntity__GetOverwriteDetailText(GiftAddEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5B422 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_22384/*"overwriteDetailText"*/);
    byte_4A5B422 = 1;
  }
  result = (System_String_o *)GiftAddEntity__GetScriptValue(this, (System_String_o *)StringLiteral_22384/*"overwriteDetailText"*/, v2);
  if ( result )
  {
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B885B0(&string_TypeInfo);
    sub_1B885B0(&StringLiteral_22416/*"overwriteTreasureEffectId"*/);
    byte_4A5B421 = 1;
  }
  result = (System_String_o *)GiftAddEntity__GetScriptValue(this, (System_String_o *)StringLiteral_22416/*"overwriteTreasureEffectId"*/, v2);
  if ( result )
  {
    if ( result->klass != string_TypeInfo )
    {
