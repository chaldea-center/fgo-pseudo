...
void BattleActorAnimationDuringAct__Init(BattleActorAnimationDuringAct_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D33EC8 & 1) == 0 )
  {
    sub_1C93AD4(&BattleActorAnimationDuringAct_ChangeAlphaProcess_TypeInfo);
    byte_4D33EC8 = 1;
  }
  ...
  if ( AlphaCurve && UnityEngine_AnimationCurve__get_length(AlphaCurve, 0) >= 1 )
  {
    ...
    v6 = (BattleActorAnimationDuringAct_ChangeAlphaProcess_o *)sub_1C93D20(BattleActorAnimationDuringAct_ChangeAlphaProcess_TypeInfo);
    BattleActorAnimationDuringAct_ChangeAlphaProcess___ctor(v6, v4, AlphaChangeMeshRenderers, v7);
    this->fields._changeAlphaProc = v6;
    sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields._changeAlphaProc, (int32_t)v6, v8, v9, v10, v11, v12, v13);
  }
  else
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( this->fields._changeAlphaProc )
  {
    ...
    sub_1C93A78((GrandQuestFolderBoardItem_o *)&changeAlphaProc->fields, (int32_t)actor, v7, v8, v9, v10, v11, v12);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&v6->fields._animCurve, (int32_t)animCurve, v7, v8, v9, v10, v11, v12);
  ...
  *(float *)&v6[-1].fields._meshRenderers = KeyTime;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)v6, (int32_t)meshRenderers, v14, v15, v16, v17, v18, v19);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D33EC9 & 1) == 0 )
  {
    sub_1C93AD4(&System_Action_Material__TypeInfo);
    sub_1C93AD4(&Method_BattleActorControl_UpdateMaterialsOnRenderers_SkinnedMeshRenderer___);
    sub_1C93AD4(&UnityEngine_Object_TypeInfo);
    sub_1C93AD4(&Method_BattleActorAnimationDuringAct_ChangeAlphaProcess___c__DisplayClass7_0__Exec_b__0__);
    sub_1C93AD4(&BattleActorAnimationDuringAct_ChangeAlphaProcess___c__DisplayClass7_0_TypeInfo);
    byte_4D33EC9 = 1;
  }
  v5 = sub_1C93D20(BattleActorAnimationDuringAct_ChangeAlphaProcess___c__DisplayClass7_0_TypeInfo);
...
LABEL_21:
  ...
  v22 = (System_Action_object__o *)sub_1C93D20(System_Action_Material__TypeInfo);
  ...
  BattleActorControl__UpdateMaterialsOnRenderers_object_(
    ...
    (const MethodInfo_3194A44 *)Method_BattleActorControl_UpdateMaterialsOnRenderers_SkinnedMeshRenderer___);
LABEL_16:
  if ( this->fields._totalTime <= this->fields._elapsedTime )
  {
    this->fields._battleActor = 0;
    sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields, 0, v15, v16, v17, v18, v19, v20);
LABEL_19:
    LOBYTE(animCurve) = 0;
    return (char)animCurve;
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields, (int32_t)actor, (int32_t)method, v3, v4, v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D33ECA & 1) == 0 )
  {
    this = (BattleActorAnimationDuringAct_ChangeAlphaProcess___c__DisplayClass7_0_o *)sub_1C93AD4(&StringLiteral_16654/*"_fade"*/);
    byte_4D33ECA = 1;
  }
  if ( !material )
    sub_1C93D2C(this, material);
  UnityEngine_Material__SetFloat(material, (System_String_o *)StringLiteral_16654/*"_fade"*/, v4->fields.alpha, 0);
}