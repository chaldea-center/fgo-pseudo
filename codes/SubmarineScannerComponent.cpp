void SubmarineScannerComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E01285 & 1) == 0 )
  {
    ...
    sub_1CE6700(&SubmarineScannerComponent_TypeInfo);
    byte_4E01285 = 1;
  }
  ...
  *(_QWORD *)&static_fields->DEFAULT_JUMP_DURATION = 0x3F0000003F800000LL;
  ...
  v2 = (struct System_Int32_array *)sub_1CE67A8(int___TypeInfo, 2);
  if ( !v2 )
    sub_1CE6958(0, v3);
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&v12->ANIM_CHANGE_DIST_BORDERS, (int32_t)v11, v4, v5, v6, v7, v8, v9);
}
...
float SubmarineScannerComponent__GetJumpDuration(SubmarineScannerComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&SubmarineScannerComponent_TypeInfo);
    sub_1CE6700(&StringLiteral_9994/*"OnJumpEnd"*/);
    sub_1CE6700(&StringLiteral_9995/*"OnJumpStart"*/);
    byte_4E01280 = 1;
  }
  EventTimeByFunctionName = SubmarineScannerComponent__GetEventTimeByFunctionName(
                              this,
                              (System_String_o *)StringLiteral_9995/*"OnJumpStart"*/,
                              0.0,
                              v2);
  result = SubmarineScannerComponent__GetEventTimeByFunctionName(this, (System_String_o *)StringLiteral_9994/*"OnJumpEnd"*/, 0.0, v5)
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&SubmarineScannerComponent_TypeInfo);
    sub_1CE6700(&StringLiteral_6773/*"FinishEffectSelectedPanel"*/);
    byte_4E01282 = 1;
  }
  v4 = SubmarineScannerComponent_TypeInfo;
  if ( !SubmarineScannerComponent_TypeInfo->_2.cctor_finished )
  ...
  return SubmarineScannerComponent__GetEventTimeByFunctionName(
           this,
           (System_String_o *)StringLiteral_6773/*"FinishEffectSelectedPanel"*/,
...
float SubmarineScannerComponent__GetTimeToStartOpenPanel(SubmarineScannerComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&UnityEngine_Object_TypeInfo);
    sub_1CE6700(&StringLiteral_13193/*"StartOpenPanel"*/);
    byte_4E01283 = 1;
  }
  state = this->fields.state;
  if ( state )
  ...
  return SubmarineScannerComponent__GetEventTimeByFunctionName(
           this,
           (System_String_o *)StringLiteral_13193/*"StartOpenPanel"*/,
           length,
           v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E0127E & 1) == 0 )
  {
    sub_1CE6700(&Method_System_Collections_Generic_List_SimpleAnimation_EditorState__Add__);
    sub_1CE6700(&Method_System_Collections_Generic_List_SimpleAnimation_EditorState___ctor__);
    sub_1CE6700(&Method_System_Collections_Generic_List_SimpleAnimation_EditorState__get_Count__);
    sub_1CE6700(&Method_System_Collections_Generic_List_SimpleAnimation_EditorState__get_Item__);
    sub_1CE6700(&System_Collections_Generic_List_SimpleAnimation_EditorState__TypeInfo);
    sub_1CE6700(&System_Text_RegularExpressions_Regex_TypeInfo);
    sub_1CE6700(&StringLiteral_5337/*"DistIndex"*/);
    sub_1CE6700(&StringLiteral_12744/*"Scanner_\\d+_Dist(?<DistIndex>\\d+)"*/);
    byte_4E0127E = 1;
  }
  ...
  if ( !klass->_1.namespaze )
    return;
  v8 = (System_Text_RegularExpressions_Regex_o *)sub_1CE694C(System_Text_RegularExpressions_Regex_TypeInfo);
  System_Text_RegularExpressions_Regex___ctor_71645620(v8, (System_String_o *)StringLiteral_12744/*"Scanner_\\d+_Dist(?<DistIndex>\\d+)"*/, 0);
  DistIndex = SubmarineScannerComponent__GetDistIndex(v9, dist, v10);
  v12 = (System_Collections_Generic_List_object__o *)sub_1CE694C(System_Collections_Generic_List_SimpleAnimation_EditorState__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v12,
    (const MethodInfo_3905734 *)Method_System_Collections_Generic_List_SimpleAnimation_EditorState___ctor__);
  ...
  if ( (int)namespaze >= 1 )
  {
    ...
    while ( (unsigned int)v20 < (unsigned int)namespaze )
    {
      ...
      if ( !v8 )
        goto LABEL_29;
      AnimationComponent = (System_Text_RegularExpressions_Group_o *)System_Text_RegularExpressions_Regex__Match_71641240(
                                                                       v8,
      ...
      if ( ((unsigned __int8)AnimationComponent & 1) != 0 )
      {
        ...
        if ( !AnimationComponent )
          goto LABEL_29;
        AnimationComponent = System_Text_RegularExpressions_GroupCollection__get_Item_71624284(
                               (System_Text_RegularExpressions_GroupCollection_o *)AnimationComponent,
                               (System_String_o *)StringLiteral_5337/*"DistIndex"*/,
                               0);
        if ( !AnimationComponent )
          goto LABEL_29;
        ...
        if ( DistIndex == (_DWORD)AnimationComponent )
        {
          ...
          else
          {
            ...
            sub_1CE66A4((GrandQuestFolderBoardItem_o *)(v27 + 4), v21, v13, v14, v15, v16, v17, v18);
          }
        }
      }
...
LABEL_30:
    sub_1CE6960(AnimationComponent);
  }
LABEL_22:
  if ( !v12 )
LABEL_29:
    sub_1CE6958(AnimationComponent, v6);
  ...
  {
    v29 = UnityEngine_Random__Range_72878252(0, v28, 0);
    Item = System_Collections_Generic_List_object___get_Item(
             v12,
             v29,
             (const MethodInfo_3905C98 *)Method_System_Collections_Generic_List_SimpleAnimation_EditorState__get_Item__);
    LODWORD(data) = (_DWORD)Item;
    this->fields.state = (struct SimpleAnimation_EditorState_o *)Item;
    p_state = &this->fields.state;
  }
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)p_state, (int32_t)data, v13, v14, v15, v16, v17, v18);
}
