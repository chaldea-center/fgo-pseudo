void SubmarineScannerComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C3430D & 1) == 0 )
  {
    ...
    sub_1C32C20(&SubmarineScannerComponent_TypeInfo);
    byte_4C3430D = 1;
  }
  ...
  *(_QWORD *)&static_fields->DEFAULT_JUMP_DURATION = 0x3F0000003F800000LL;
  ...
  v2 = (struct System_Int32_array *)sub_1C32CC8(int___TypeInfo, 2);
  if ( !v2 )
    sub_1C32E7C(0);
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&v7->ANIM_CHANGE_DIST_BORDERS, (int32_t)v6, v3, v4);
}
...
float SubmarineScannerComponent__GetJumpDuration(SubmarineScannerComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C32C20(&SubmarineScannerComponent_TypeInfo);
    sub_1C32C20(&StringLiteral_9916/*"OnJumpEnd"*/);
    sub_1C32C20(&StringLiteral_9917/*"OnJumpStart"*/);
    byte_4C34308 = 1;
  }
  EventTimeByFunctionName = SubmarineScannerComponent__GetEventTimeByFunctionName(
                              ...
                              0.0,
                              v2);
  result = SubmarineScannerComponent__GetEventTimeByFunctionName(this, (System_String_o *)StringLiteral_9916/*"OnJumpEnd"*/, 0.0, v5)
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C32C20(&SubmarineScannerComponent_TypeInfo);
    sub_1C32C20(&StringLiteral_6727/*"FinishEffectSelectedPanel"*/);
    byte_4C3430A = 1;
  }
  v4 = SubmarineScannerComponent_TypeInfo;
  if ( !SubmarineScannerComponent_TypeInfo->_2.cctor_finished )
  ...
  return SubmarineScannerComponent__GetEventTimeByFunctionName(
           this,
           (System_String_o *)StringLiteral_6727/*"FinishEffectSelectedPanel"*/,
...
float SubmarineScannerComponent__GetTimeToStartOpenPanel(SubmarineScannerComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C32C20(&UnityEngine_Object_TypeInfo);
    sub_1C32C20(&StringLiteral_13058/*"StartOpenPanel"*/);
    byte_4C3430B = 1;
  }
  state = this->fields.state;
  if ( state )
  ...
  return SubmarineScannerComponent__GetEventTimeByFunctionName(this, (System_String_o *)StringLiteral_13058/*"StartOpenPanel"*/, length, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C34306 & 1) == 0 )
  {
    sub_1C32C20(&Method_System_Collections_Generic_List_SimpleAnimation_EditorState__Add__);
    sub_1C32C20(&Method_System_Collections_Generic_List_SimpleAnimation_EditorState___ctor__);
    sub_1C32C20(&Method_System_Collections_Generic_List_SimpleAnimation_EditorState__get_Count__);
    sub_1C32C20(&Method_System_Collections_Generic_List_SimpleAnimation_EditorState__get_Item__);
    sub_1C32C20(&System_Collections_Generic_List_SimpleAnimation_EditorState__TypeInfo);
    sub_1C32C20(&System_Text_RegularExpressions_Regex_TypeInfo);
    sub_1C32C20(&StringLiteral_5302/*"DistIndex"*/);
    sub_1C32C20(&StringLiteral_12613/*"Scanner_\\d+_Dist(?<DistIndex>\\d+)"*/);
    byte_4C34306 = 1;
  }
  ...
  if ( !klass->_1.namespaze )
    return;
  v7 = (System_Text_RegularExpressions_Regex_o *)sub_1C32E6C(System_Text_RegularExpressions_Regex_TypeInfo);
  System_Text_RegularExpressions_Regex___ctor(v7, (System_String_o *)StringLiteral_12613/*"Scanner_\\d+_Dist(?<DistIndex>\\d+)"*/, 0);
  DistIndex = SubmarineScannerComponent__GetDistIndex(v8, dist, v9);
  v11 = (System_Collections_Generic_List_object__o *)sub_1C32E6C(System_Collections_Generic_List_SimpleAnimation_EditorState__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v11,
    (const MethodInfo_3797F88 *)Method_System_Collections_Generic_List_SimpleAnimation_EditorState___ctor__);
  ...
  if ( (int)namespaze >= 1 )
  {
    ...
    while ( (unsigned int)v15 < (unsigned int)namespaze )
    {
      ...
      if ( !v7 )
        goto LABEL_29;
      AnimationComponent = (System_Text_RegularExpressions_Group_o *)System_Text_RegularExpressions_Regex__Match_70054040(
                                                                       v7,
      ...
      if ( ((unsigned __int8)AnimationComponent & 1) != 0 )
      {
        ...
        if ( !AnimationComponent )
          goto LABEL_29;
        AnimationComponent = System_Text_RegularExpressions_GroupCollection__get_Item_70037084(
                               (System_Text_RegularExpressions_GroupCollection_o *)AnimationComponent,
                               (System_String_o *)StringLiteral_5302/*"DistIndex"*/,
                               0);
        if ( !AnimationComponent )
          goto LABEL_29;
        ...
        if ( DistIndex == (_DWORD)AnimationComponent )
        {
          ...
          else
          {
            ...
            sub_1C32BC4((CGThumbnailListItem_o *)(v22 + 4), v16, v12, v13);
          }
        }
      }
...
LABEL_30:
    sub_1C32E84(AnimationComponent);
  }
LABEL_22:
  if ( !v11 )
LABEL_29:
    sub_1C32E7C(AnimationComponent);
  ...
  {
    v24 = UnityEngine_Random__Range_71183860(0, v23, 0);
    Item = System_Collections_Generic_List_object___get_Item(
             v11,
             v24,
             (const MethodInfo_37984EC *)Method_System_Collections_Generic_List_SimpleAnimation_EditorState__get_Item__);
    LODWORD(data) = (_DWORD)Item;
    this->fields.state = (struct SimpleAnimation_EditorState_o *)Item;
    p_state = &this->fields.state;
  }
  sub_1C32BC4((CGThumbnailListItem_o *)p_state, (int32_t)data, v12, v13);
}
