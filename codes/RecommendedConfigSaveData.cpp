void __fastcall RecommendedConfigSaveData___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A73663 & 1) == 0 )
  {
    sub_1B90010(&RecommendedConfigSaveData_TypeInfo, v1);
    sub_1B90010(&StringLiteral_10995/*"RECOMENDED_CONFIG_NORMAL"*/, v4);
    byte_4A73663 = 1;
  }
  ...
  sub_1B8FFB4(
    ...
    StringLiteral_10995/*"RECOMENDED_CONFIG_NORMAL"*/,
    v2,
    v3);
}
...
void __fastcall RecommendedConfigSaveData___ctor(RecommendedConfigSaveData_o *this, const MethodInfo *method)
{
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.selectRarityList, (int32_t)v4, v5, v6);
...
bool __fastcall RecommendedConfigSaveData__IsExist(RecommendedConfigSaveData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A7365E & 1) == 0 )
  {
    sub_1B90010(&RecommendedConfigSaveData_TypeInfo, method);
    byte_4A7365E = 1;
  }
...
RecommendedConfigSaveData_o *__fastcall RecommendedConfigSaveData__LoadConfigSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4A7365F & 1) == 0 )
  {
    sub_1B90010(&Method_UnityEngine_JsonUtility_FromJson_RecommendedConfigSaveData___, v1);
    sub_1B90010(&RecommendedConfigSaveData_TypeInfo, v2);
    byte_4A7365F = 1;
  }
  ...
  String_69497716 = UnityEngine_PlayerPrefs__GetString_69497716(v3->static_fields->SAVE_KEY, 0LL);
  return (RecommendedConfigSaveData_o *)UnityEngine_JsonUtility__FromJson_object_(
                                          String_69497716,
                                          (const MethodInfo_2EF576C *)Method_UnityEngine_JsonUtility_FromJson_RecommendedConfigSaveData___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73660 & 1) == 0 )
  {
    sub_1B90010(&RecommendedConfigSaveData_TypeInfo, saveData);
    byte_4A73660 = 1;
  }
