void __fastcall RecommendedConfigSaveData___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB9586 & 1) == 0 )
  {
    sub_1BAB41C(&RecommendedConfigSaveData_TypeInfo, v1);
    sub_1BAB41C(&StringLiteral_10997/*"RECOMENDED_CONFIG_NORMAL"*/, v4);
    byte_4AB9586 = 1;
  }
  RecommendedConfigSaveData_TypeInfo->static_fields->SAVE_KEY = (struct System_String_o *)StringLiteral_10997/*"RECOMENDED_CONFIG_NORMAL"*/;
  sub_1BAB3C0(
    (ServantStatusBattleListViewItem_o *)RecommendedConfigSaveData_TypeInfo->static_fields,
    StringLiteral_10997/*"RECOMENDED_CONFIG_NORMAL"*/,
    v2,
    v3);
}
...
void __fastcall RecommendedConfigSaveData___ctor(RecommendedConfigSaveData_o *this, const MethodInfo *method)
{
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.selectRarityList, (int32_t)v4, v5, v6);
...
bool __fastcall RecommendedConfigSaveData__IsExist(RecommendedConfigSaveData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB9581 & 1) == 0 )
  {
    sub_1BAB41C(&RecommendedConfigSaveData_TypeInfo, method);
    byte_4AB9581 = 1;
  }
...
RecommendedConfigSaveData_o *__fastcall RecommendedConfigSaveData__LoadConfigSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4AB9582 & 1) == 0 )
  {
    sub_1BAB41C(&Method_UnityEngine_JsonUtility_FromJson_RecommendedConfigSaveData___, v1);
    sub_1BAB41C(&RecommendedConfigSaveData_TypeInfo, v2);
    byte_4AB9582 = 1;
  }
  ...
  String_69758896 = UnityEngine_PlayerPrefs__GetString_69758896(v3->static_fields->SAVE_KEY, 0LL);
  return (RecommendedConfigSaveData_o *)UnityEngine_JsonUtility__FromJson_object_(
                                          String_69758896,
                                          (const MethodInfo_2F2B968 *)Method_UnityEngine_JsonUtility_FromJson_RecommendedConfigSaveData___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9583 & 1) == 0 )
  {
    sub_1BAB41C(&RecommendedConfigSaveData_TypeInfo, saveData);
    byte_4AB9583 = 1;
  }
