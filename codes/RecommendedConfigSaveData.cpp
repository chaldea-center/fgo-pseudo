void __fastcall RecommendedConfigSaveData___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C01191 & 1) == 0 )
  {
    sub_1C2E12C(&RecommendedConfigSaveData_TypeInfo, v1);
    sub_1C2E12C(&StringLiteral_11196/*"RECOMENDED_CONFIG_NORMAL"*/, v8);
    byte_4C01191 = 1;
  }
  RecommendedConfigSaveData_TypeInfo->static_fields->SAVE_KEY = (struct System_String_o *)StringLiteral_11196/*"RECOMENDED_CONFIG_NORMAL"*/;
  sub_1C2E0D0(
    (PartyOrganizationUtility_o *)RecommendedConfigSaveData_TypeInfo->static_fields,
    StringLiteral_11196/*"RECOMENDED_CONFIG_NORMAL"*/,
    v2,
    v3,
    v4,
    v5,
...
void __fastcall RecommendedConfigSaveData___ctor(RecommendedConfigSaveData_o *this, const MethodInfo *method)
{
  ...
  sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.selectRarityList, (int64_t)v4, v5, v6, v7, v8, v9, v10);
...
bool __fastcall RecommendedConfigSaveData__IsExist(RecommendedConfigSaveData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C0118C & 1) == 0 )
  {
    sub_1C2E12C(&RecommendedConfigSaveData_TypeInfo, method);
    byte_4C0118C = 1;
  }
...
RecommendedConfigSaveData_o *__fastcall RecommendedConfigSaveData__LoadConfigSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4C0118D & 1) == 0 )
  {
    sub_1C2E12C(&Method_UnityEngine_JsonUtility_FromJson_RecommendedConfigSaveData___, v1);
    sub_1C2E12C(&RecommendedConfigSaveData_TypeInfo, v2);
    byte_4C0118D = 1;
  }
  ...
  String_70947996 = UnityEngine_PlayerPrefs__GetString_70947996(v3->static_fields->SAVE_KEY, 0LL);
  return (RecommendedConfigSaveData_o *)UnityEngine_JsonUtility__FromJson_object_(
                                          String_70947996,
                                          (const MethodInfo_303AC88 *)Method_UnityEngine_JsonUtility_FromJson_RecommendedConfigSaveData___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C0118E & 1) == 0 )
  {
    sub_1C2E12C(&RecommendedConfigSaveData_TypeInfo, saveData);
    byte_4C0118E = 1;
  }
