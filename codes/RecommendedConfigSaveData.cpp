void RecommendedConfigSaveData___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C5ACE9 & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_10999/*"RECOMENDED_CONFIG_NORMAL"*/);
    byte_4C5ACE9 = 1;
  }
  RecommendedConfigSaveData_TypeInfo->static_fields->SAVE_KEY = (struct System_String_o *)StringLiteral_10999/*"RECOMENDED_CONFIG_NORMAL"*/;
  sub_1C3E508((CGThumbnailListItem_o *)RecommendedConfigSaveData_TypeInfo->static_fields, StringLiteral_10999/*"RECOMENDED_CONFIG_NORMAL"*/, v1, v2);
}
...
RecommendedConfigSaveData_o *RecommendedConfigSaveData__LoadConfigSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4C5ACE6 & 1) == 0 )
  {
    sub_1C3E564(&Method_UnityEngine_JsonUtility_FromJson_RecommendedConfigSaveData___);
    sub_1C3E564(&RecommendedConfigSaveData_TypeInfo);
    byte_4C5ACE6 = 1;
  }
  ...
  return (RecommendedConfigSaveData_o *)UnityEngine_JsonUtility__FromJson_object_(
                                          String_71300376,
                                          (const MethodInfo_3169E64 *)Method_UnityEngine_JsonUtility_FromJson_RecommendedConfigSaveData___);
}
