void RecommendedConfigSaveData___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E08AEA & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_11109/*"RECOMENDED_CONFIG_NORMAL"*/);
    byte_4E08AEA = 1;
  }
  RecommendedConfigSaveData_TypeInfo->static_fields->SAVE_KEY = (struct System_String_o *)StringLiteral_11109/*"RECOMENDED_CONFIG_NORMAL"*/;
  sub_1CE66A4(
    (GrandQuestFolderBoardItem_o *)RecommendedConfigSaveData_TypeInfo->static_fields,
    StringLiteral_11109/*"RECOMENDED_CONFIG_NORMAL"*/,
    v1,
    v2,
    v3,
    v4,
...
RecommendedConfigSaveData_o *RecommendedConfigSaveData__LoadConfigSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4E08AE7 & 1) == 0 )
  {
    sub_1CE6700(&Method_UnityEngine_JsonUtility_FromJson_RecommendedConfigSaveData___);
    sub_1CE6700(&RecommendedConfigSaveData_TypeInfo);
    byte_4E08AE7 = 1;
  }
  ...
  return (RecommendedConfigSaveData_o *)UnityEngine_JsonUtility__FromJson_object_(
                                          String_72876844,
                                          (const MethodInfo_3274BD4 *)Method_UnityEngine_JsonUtility_FromJson_RecommendedConfigSaveData___);
}
