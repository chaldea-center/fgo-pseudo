void __fastcall RecommendedConfigSaveData___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A01C63 & 1) == 0 )
  {
    sub_1B64870(&RecommendedConfigSaveData_TypeInfo, v1);
    sub_1B64870(&StringLiteral_10938/*"RECOMENDED_CONFIG_NORMAL"*/, v4);
    byte_4A01C63 = 1;
  }
  RecommendedConfigSaveData_TypeInfo->static_fields->SAVE_KEY = (struct System_String_o *)StringLiteral_10938/*"RECOMENDED_CONFIG_NORMAL"*/;
  sub_1B64814(
    (ServantStatusBattleListViewItem_o *)RecommendedConfigSaveData_TypeInfo->static_fields,
    StringLiteral_10938/*"RECOMENDED_CONFIG_NORMAL"*/,
    v2,
    v3);
}
...
void __fastcall RecommendedConfigSaveData___ctor(RecommendedConfigSaveData_o *this, const MethodInfo *method)
{
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.selectRarityList, (int32_t)v4, v5, v6);
...
bool __fastcall RecommendedConfigSaveData__IsExist(RecommendedConfigSaveData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A01C5E & 1) == 0 )
  {
    sub_1B64870(&RecommendedConfigSaveData_TypeInfo, method);
    byte_4A01C5E = 1;
  }
...
RecommendedConfigSaveData_o *__fastcall RecommendedConfigSaveData__LoadConfigSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4A01C5F & 1) == 0 )
  {
    sub_1B64870(&Method_UnityEngine_JsonUtility_FromJson_RecommendedConfigSaveData___, v1);
    sub_1B64870(&RecommendedConfigSaveData_TypeInfo, v2);
    byte_4A01C5F = 1;
  }
  ...
  String_69094192 = UnityEngine_PlayerPrefs__GetString_69094192(v3->static_fields->SAVE_KEY, 0LL);
  return (RecommendedConfigSaveData_o *)UnityEngine_JsonUtility__FromJson_object_(
                                          String_69094192,
                                          (const MethodInfo_2EA2048 *)Method_UnityEngine_JsonUtility_FromJson_RecommendedConfigSaveData___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01C60 & 1) == 0 )
  {
    sub_1B64870(&RecommendedConfigSaveData_TypeInfo, saveData);
    byte_4A01C60 = 1;
  }
