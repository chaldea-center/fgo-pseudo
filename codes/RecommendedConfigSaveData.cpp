void RecommendedConfigSaveData___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C46EF2 & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_10997/*"RECOMENDED_CONFIG_NORMAL"*/);
    byte_4C46EF2 = 1;
  }
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)RecommendedConfigSaveData_TypeInfo->static_fields, StringLiteral_10997/*"RECOMENDED_CONFIG_NORMAL"*/, v1, v2);
}
...
RecommendedConfigSaveData_o *RecommendedConfigSaveData__LoadConfigSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4C46EEF & 1) == 0 )
  {
    sub_1C37058(&Method_UnityEngine_JsonUtility_FromJson_RecommendedConfigSaveData___);
    sub_1C37058(&RecommendedConfigSaveData_TypeInfo);
    byte_4C46EEF = 1;
  }
  ...
  return (RecommendedConfigSaveData_o *)UnityEngine_JsonUtility__FromJson_object_(
                                          String_71225564,
                                          (const MethodInfo_3157F70 *)Method_UnityEngine_JsonUtility_FromJson_RecommendedConfigSaveData___);
}
