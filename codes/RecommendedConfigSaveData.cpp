void RecommendedConfigSaveData___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CCB414 & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_11001/*"RECOMENDED_CONFIG_NORMAL"*/);
    byte_4CCB414 = 1;
  }
  RecommendedConfigSaveData_TypeInfo->static_fields->SAVE_KEY = (struct System_String_o *)StringLiteral_11001/*"RECOMENDED_CONFIG_NORMAL"*/;
  sub_1C71354(
    (GrandQuestFolderBoardItem_o *)RecommendedConfigSaveData_TypeInfo->static_fields,
    StringLiteral_11001/*"RECOMENDED_CONFIG_NORMAL"*/,
    v1,
    v2,
    v3,
    v4,
...
RecommendedConfigSaveData_o *RecommendedConfigSaveData__LoadConfigSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4CCB411 & 1) == 0 )
  {
    sub_1C713B0(&Method_UnityEngine_JsonUtility_FromJson_RecommendedConfigSaveData___);
    sub_1C713B0(&RecommendedConfigSaveData_TypeInfo);
    byte_4CCB411 = 1;
  }
  ...
  return (RecommendedConfigSaveData_o *)UnityEngine_JsonUtility__FromJson_object_(
                                          String_71682912,
                                          (const MethodInfo_31BBC68 *)Method_UnityEngine_JsonUtility_FromJson_RecommendedConfigSaveData___);
}
