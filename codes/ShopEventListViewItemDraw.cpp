        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B5C3F & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_5755/*"EVENT_SHOP_BANNER_FINISHED_MSG"*/);
    ...
    this = (ShopEventListViewItemDraw_o *)sub_B52984(&StringLiteral_5754/*"EVENT_SHOP_BANNER_FINISHED_LOCKED_MSG"*/);
    byte_42B5C3F = 1;
  }
  ...
  if ( mode )
  {
    ...
    if ( infoBase )
    {
      ...
      if ( nameTextLabel )
      {
        ...
        NameText = System_String__Concat_44568316((System_String_o *)StringLiteral_15766/*"[000000]"*/, DetailText, 0LL);
        if ( messageTextLabel )
        {
          ...
          if ( eventPeriodLabel )
          {
            ...
            if ( changePeriodLabel )
            {
              ...
              if ( item->fields.isLocked )
              {
                ...
                NameText = LocalizationManager__Get((System_String_o *)StringLiteral_5756/*"EVENT_SHOP_BANNER_LOCKED_MSG"*/, 0LL);
                if ( !condMessageLabel )
                  goto LABEL_48;
              ...
              if ( item->fields.isClosedLimit )
              {
                ...
                NameText = LocalizationManager__Get((System_String_o *)StringLiteral_5753/*"EVENT_SHOP_BANNER_CLOSED_MSG"*/, 0LL);
                if ( !v30 )
                  goto LABEL_48;
...
LABEL_51:
                  ...
                  NameText = LocalizationManager__Get((System_String_o *)StringLiteral_5755/*"EVENT_SHOP_BANNER_FINISHED_MSG"*/, 0LL);
                  if ( !v27 )
                    goto LABEL_48;
...
LABEL_52:
                    ...
                    NameText = LocalizationManager__Get((System_String_o *)StringLiteral_5754/*"EVENT_SHOP_BANNER_FINISHED_LOCKED_MSG"*/, 0LL);
                    if ( !v28 )
                      goto LABEL_48;
