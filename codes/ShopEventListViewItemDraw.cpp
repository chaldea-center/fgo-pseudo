        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A052CB & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_5681/*"EVENT_SHOP_BANNER_FINISHED_MSG"*/, v8);
    sub_1B686D4(&StringLiteral_15782/*"[000000]"*/, v9);
    sub_1B686D4(&StringLiteral_5679/*"EVENT_SHOP_BANNER_CLOSED_MSG"*/, v10);
    sub_1B686D4(&StringLiteral_5682/*"EVENT_SHOP_BANNER_LOCKED_MSG"*/, v11);
    this = (ShopEventListViewItemDraw_o *)sub_1B686D4(&StringLiteral_5680/*"EVENT_SHOP_BANNER_FINISHED_LOCKED_MSG"*/, v12);
    byte_4A052CB = 1;
  }
  ...
  if ( mode )
  {
    ...
    NameText = System_String__Concat_61419468((System_String_o *)StringLiteral_15782/*"[000000]"*/, DetailText, 0LL);
    if ( !messageTextLabel )
      goto LABEL_45;
