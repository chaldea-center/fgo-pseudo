        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A590 & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_5705/*"EVENT_SHOP_BANNER_FINISHED_MSG"*/, v8);
    sub_1B761C0(&StringLiteral_15842/*"[000000]"*/, v9);
    sub_1B761C0(&StringLiteral_5703/*"EVENT_SHOP_BANNER_CLOSED_MSG"*/, v10);
    sub_1B761C0(&StringLiteral_5706/*"EVENT_SHOP_BANNER_LOCKED_MSG"*/, v11);
    this = (ShopEventListViewItemDraw_o *)sub_1B761C0(&StringLiteral_5704/*"EVENT_SHOP_BANNER_FINISHED_LOCKED_MSG"*/, v12);
    byte_4A2A590 = 1;
  }
  ...
  if ( mode )
  {
    ...
    NameText = System_String__Concat_61535060((System_String_o *)StringLiteral_15842/*"[000000]"*/, DetailText, 0LL);
    if ( !messageTextLabel )
      goto LABEL_45;
    ...
    if ( !item->fields.isFinished )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      NameText = LocalizationManager__Get((System_String_o *)StringLiteral_5706/*"EVENT_SHOP_BANNER_LOCKED_MSG"*/, 0LL);
      if ( !condMessageLabel )
        goto LABEL_45;
...
LABEL_48:
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        NameText = LocalizationManager__Get((System_String_o *)StringLiteral_5703/*"EVENT_SHOP_BANNER_CLOSED_MSG"*/, 0LL);
        if ( !v35 )
          goto LABEL_45;
    ...
    if ( !item->fields.isLocked )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      NameText = LocalizationManager__Get((System_String_o *)StringLiteral_5705/*"EVENT_SHOP_BANNER_FINISHED_MSG"*/, 0LL);
      if ( !v36 )
        goto LABEL_45;
...
LABEL_44:
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    NameText = LocalizationManager__Get((System_String_o *)StringLiteral_5704/*"EVENT_SHOP_BANNER_FINISHED_LOCKED_MSG"*/, 0LL);
    if ( !v33 )
      goto LABEL_45;
