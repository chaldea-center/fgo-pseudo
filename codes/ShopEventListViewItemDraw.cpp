        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C33C31 & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_5710/*"EVENT_SHOP_BANNER_FINISHED_MSG"*/);
    ...
    this = (ShopEventListViewItemDraw_o *)sub_1C32C20(&StringLiteral_5709/*"EVENT_SHOP_BANNER_FINISHED_LOCKED_MSG"*/);
    byte_4C33C31 = 1;
  }
  ...
  if ( mode )
  {
    ...
    NameText = System_String__Concat_63518544((System_String_o *)StringLiteral_15837/*"[000000]"*/, DetailText, 0);
    if ( !messageTextLabel )
      goto LABEL_45;
    ...
    if ( !item->fields.isFinished )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      NameText = LocalizationManager__Get((System_String_o *)StringLiteral_5711/*"EVENT_SHOP_BANNER_LOCKED_MSG"*/, 0);
      if ( !condMessageLabel )
        goto LABEL_45;
...
LABEL_48:
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        NameText = LocalizationManager__Get((System_String_o *)StringLiteral_5708/*"EVENT_SHOP_BANNER_CLOSED_MSG"*/, 0);
        if ( !v28 )
          goto LABEL_45;
    ...
    if ( !item->fields.isLocked )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      NameText = LocalizationManager__Get((System_String_o *)StringLiteral_5710/*"EVENT_SHOP_BANNER_FINISHED_MSG"*/, 0);
      if ( !v29 )
        goto LABEL_45;
...
LABEL_44:
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    NameText = LocalizationManager__Get((System_String_o *)StringLiteral_5709/*"EVENT_SHOP_BANNER_FINISHED_LOCKED_MSG"*/, 0);
    if ( !v26 )
      goto LABEL_45;
