  ...
  if ( ((unsigned __int8)v8 & 1) == 0 )
  {
    if ( item )
    {
      ...
      if ( v8 )
      {
        ...
        (*(void (__fastcall **)(void *, _BOOL8, _QWORD))(*(_QWORD *)v8 + 392LL))(
          v8,
          v11,
...
LABEL_35:
  ...
  if ( ((unsigned __int8)v8 & 1) == 0 )
  {
    if ( item )
    {
      ...
      if ( v13 )
      {
        v21.fields.a = *(float *)(v15 + v17);
        v21.fields.b = *(float *)(v15 + v18);
        v21.fields.g = *(float *)(v15 + v19);
        v21.fields.r = *v16;
        ...
        const MethodInfo *method)
{
  ...
  if ( !AtlasManager__SetShopBanner(v8, eventId, 0) )
  {
        ...
        const MethodInfo *method)
{
  ...
  int64_t endedAt; // x24
  ShopEventListViewItemDraw_o *v21; // x0
  ...
  if ( (byte_4C3F21B & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_5711/*"EVENT_SHOP_BANNER_FINISHED_MSG"*/);
    ...
    this = (ShopEventListViewItemDraw_o *)sub_1C37058(&StringLiteral_5710/*"EVENT_SHOP_BANNER_FINISHED_LOCKED_MSG"*/);
    byte_4C3F21B = 1;
  }
  ...
  if ( !item )
  {
    ...
    ShopEventListViewItemDraw__SetSpriteActive(v21, v6->fields.addRangeSprite, 0, v22);
    return;
  }
  ...
  if ( mode )
  {
    ...
    NameText = ShopEventListViewItem__get_NameText(item, v14);
    if ( !nameTextLabel )
      goto LABEL_45;
    UILabel__set_text(nameTextLabel, NameText, 0);
    messageTextLabel = v6->fields.messageTextLabel;
    DetailText = ShopEventListViewItem__get_DetailText(item, v16);
    NameText = System_String__Concat_63561656((System_String_o *)StringLiteral_15839/*"[000000]"*/, DetailText, 0);
    if ( !messageTextLabel )
      goto LABEL_45;
    ...
    if ( !item->fields.isFinished )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      NameText = LocalizationManager__Get((System_String_o *)StringLiteral_5712/*"EVENT_SHOP_BANNER_LOCKED_MSG"*/, 0);
      if ( !condMessageLabel )
        goto LABEL_45;
...
LABEL_48:
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        NameText = LocalizationManager__Get((System_String_o *)StringLiteral_5709/*"EVENT_SHOP_BANNER_CLOSED_MSG"*/, 0);
        if ( !v28 )
          goto LABEL_45;
        UILabel__set_text(v28, NameText, 0);
        if ( !item->fields.isFinished )
          goto LABEL_41;
      }
    }
    if ( !item->fields.isLocked )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      NameText = LocalizationManager__Get((System_String_o *)StringLiteral_5711/*"EVENT_SHOP_BANNER_FINISHED_MSG"*/, 0);
      if ( !v29 )
        goto LABEL_45;
...
LABEL_44:
        ShopEventListViewItemDraw__SetBaseButtonState(v6, item, mode, v25);
        return;
      }
      if ( !item->fields.isLocked )
        goto LABEL_44;
    }
    v26 = v6->fields.condMessageLabel;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    NameText = LocalizationManager__Get((System_String_o *)StringLiteral_5710/*"EVENT_SHOP_BANNER_FINISHED_LOCKED_MSG"*/, 0);
    if ( !v26 )
      goto LABEL_45;
    UILabel__set_text(v26, NameText, 0);
    if ( item->fields.isFinished )
      goto LABEL_44;
    goto LABEL_41;
  }
