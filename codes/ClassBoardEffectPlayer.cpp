...
void ClassBoardEffectPlayer___ctor_49607088(
        ...
        const MethodInfo *method)
{
  ...
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields, (int32_t)playerName, v5, v6, v7, v8, v9, v10);
}
...
Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_o ClassBoardEffectPlayer__GetData___Il2CppFullySharedGenericType_(
        ClassBoardEffectPlayer_o *this,
        const MethodInfo_324296C *method)
{
  __int64 v2; // x2
  long double v3; // q0
  __int64 *v6; // x8
  ...
  if ( (*(_BYTE *)(*v6 + 309) & 1) == 0 )
    v8 = sub_1CE513C(v3);
  v11 = (const void *)sub_1D0F200(data, v8, (char *)v14 - ((v9 + 15) & 0x1FFFFFFF0LL));
...
bool ClassBoardEffectPlayer__GetData_bool_(ClassBoardEffectPlayer_o *this, const MethodInfo_324287C *method)
{
  __int64 v2; // x2
  __int64 v3; // x3
  long double v4; // q0
  const MethodInfo_324287C_RGCTXs *rgctx_data; // x8
  ClassBoardEffectPlayer_o *v6; // x19
  ClassBoardEffectPlayer_o *_0_T; // x1
  Il2CppObject *data; // x19
  ClassBoardEffectPlayer_o *v11; // x0
  const MethodInfo_32428F4 *v12; // x1

  rgctx_data = method->rgctx_data;
  v6 = this;
  if ( !rgctx_data )
  {
    this = (ClassBoardEffectPlayer_o *)sub_1CE5198(method);
    rgctx_data = method->rgctx_data;
  }
  ...
  {
    this = (ClassBoardEffectPlayer_o *)sub_1CE513C(v4);
    _0_T = this;
  }
  if ( !data )
    sub_1D0F30C(this, _0_T);
...
int32_t ClassBoardEffectPlayer__GetData_int_(ClassBoardEffectPlayer_o *this, const MethodInfo_32428F4 *method)
{
  __int64 v2; // x2
  __int64 v3; // x3
  long double v4; // q0
  const MethodInfo_32428F4_RGCTXs *rgctx_data; // x8
  ClassBoardEffectPlayer_o *v6; // x19
  ClassBoardEffectPlayer_o *_0_T; // x1
  Il2CppObject *data; // x19
  ClassBoardEffectPlayer_o *v11; // x0
  const MethodInfo_324296C *v12; // x1
...
void ClassBoardEffectPlayer__SetData___Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_3242AE8 *method)
{
...
void ClassBoardEffectPlayer__SetData_bool_(ClassBoardEffectPlayer_o *this, bool obj, const MethodInfo_3242A2C *method)
{
  const MethodInfo_3242A2C_RGCTXs *rgctx_data; // x8
  Il2CppObject *v7; // x0
  int32_t v8; // w2
  int32_t v9; // w3
  ...
  this->fields.data = v7;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.data, (int32_t)v7, v8, v9, v10, v11, v12, v13);
}
...
void ClassBoardEffectPlayer__SetData_int_(
        ClassBoardEffectPlayer_o *this,
        int32_t obj,
        const MethodInfo_3242A8C *method)
{
  const MethodInfo_3242A8C_RGCTXs *rgctx_data; // x8
  Il2CppObject *v7; // x0
  int32_t v8; // w2
  int32_t v9; // w3
  System_String_o *v10; // x4
