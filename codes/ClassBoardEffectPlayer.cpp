...
void __fastcall ClassBoardEffectPlayer___ctor_29214356(
        ...
        const MethodInfo *method)
{
  ...
  sub_B77560((BattleServantConfConponent_o *)&this->fields, (System_Int32_array **)playerName, v5, v6, v7, v8, v9, v10);
}
...
bool __fastcall ClassBoardEffectPlayer__GetData_bool_(ClassBoardEffectPlayer_o *this, const MethodInfo_1C6C1C8 *method)
{
  Il2CppObject *data; // x20
  Il2CppClass *_0_T; // x19
  ClassBoardEffectPlayer_o *v5; // x0
  const MethodInfo_1C6C22C *v6; // x1

  data = this->fields.data;
  _0_T = method->rgctx_data->_0_T;
  if ( (BYTE2(_0_T->vtable[0].methodPtr) & 1) == 0 )
    this = (ClassBoardEffectPlayer_o *)sub_B0F2C4(method->rgctx_data->_0_T);
  if ( !data )
...
int32_t __fastcall ClassBoardEffectPlayer__GetData_int_(
        ClassBoardEffectPlayer_o *this,
        const MethodInfo_1C6C22C *method)
{
  Il2CppObject *data; // x20
  Il2CppClass *_0_T; // x19
  ClassBoardEffectPlayer_o *v5; // x0
  const MethodInfo_1C6C290 *v6; // x1
...
Il2CppObject *__fastcall ClassBoardEffectPlayer__GetData_object_(
        ClassBoardEffectPlayer_o *this,
        const MethodInfo_1C6C290 *method)
{
  Il2CppObject *data; // x20
  Il2CppClass *_0_T; // x19
  ...
  if ( data )
  {
    result = (Il2CppObject *)sub_B77684(data, _0_T);
    if ( result )
      return result;
    sub_B77990(data);
  }
...
void __fastcall ClassBoardEffectPlayer__SetData_bool_(
        ClassBoardEffectPlayer_o *this,
        bool obj,
        const MethodInfo_1C6C2E8 *method)
{
  ...
  if ( (BYTE2(_0_T->vtable[0].methodPtr) & 1) == 0 )
    sub_B0F2C4(method->rgctx_data->_0_T);
  v5 = (Il2CppObject *)j_il2cpp_value_box_0(_0_T, v12, method);
  this->fields.data = v5;
  sub_B77560((BattleServantConfConponent_o *)&this->fields.data, (System_Int32_array **)v5, v6, v7, v8, v9, v10, v11);
}
...
void __fastcall ClassBoardEffectPlayer__SetData_int_(
        ClassBoardEffectPlayer_o *this,
        int32_t obj,
        const MethodInfo_1C6C348 *method)
{
  Il2CppClass *_0_T; // x20
  Il2CppObject *v5; // x0
  System_String_array **v6; // x2
...
void __fastcall ClassBoardEffectPlayer__SetData_object_(
        ClassBoardEffectPlayer_o *this,
        Il2CppObject *obj,
        const MethodInfo_1C6C3A4 *method)
{
  System_String_array **v3; // x3
  System_Boolean_array **v4; // x4
  System_Int32_array **v5; // x5
