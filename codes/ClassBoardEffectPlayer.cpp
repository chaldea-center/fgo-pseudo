...
void __fastcall ClassBoardEffectPlayer___ctor_46914980(
        ...
        const MethodInfo *method)
{
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields, (int32_t)playerName, v5, v6);
}
...
Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_o __fastcall ClassBoardEffectPlayer__GetData___Il2CppFullySharedGenericType_(
        ClassBoardEffectPlayer_o *this,
        const MethodInfo_300E368 *method)
{
  __int64 v2; // x2
  long double v3; // q0
  __int64 *v6; // x8
  ...
  if ( (*(_BYTE *)(*v6 + 309) & 1) == 0 )
    v8 = sub_1C1B45C(v3);
  v11 = (const void *)sub_1BCB144(data, v8, (char *)v14 - ((v9 + 15) & 0x1FFFFFFF0LL));
...
bool __fastcall ClassBoardEffectPlayer__GetData_bool_(ClassBoardEffectPlayer_o *this, const MethodInfo_300E278 *method)
{
  __int64 v2; // x2
  __int64 v3; // x3
  long double v4; // q0
  const MethodInfo_300E278_RGCTXs *rgctx_data; // x8
  ClassBoardEffectPlayer_o *v6; // x19
  ClassBoardEffectPlayer_o *_0_T; // x1
  Il2CppObject *data; // x19
  ClassBoardEffectPlayer_o *v11; // x0
  const MethodInfo_300E2F0 *v12; // x1

  rgctx_data = method->rgctx_data;
  v6 = this;
  if ( !rgctx_data )
  {
    this = (ClassBoardEffectPlayer_o *)sub_1C1B4B8(method);
    rgctx_data = method->rgctx_data;
  }
  ...
  {
    this = (ClassBoardEffectPlayer_o *)sub_1C1B45C(v4);
    _0_T = this;
  }
  if ( !data )
    sub_1BCB254(this, _0_T);
...
int32_t __fastcall ClassBoardEffectPlayer__GetData_int_(
        ClassBoardEffectPlayer_o *this,
        const MethodInfo_300E2F0 *method)
{
  __int64 v2; // x2
  __int64 v3; // x3
  long double v4; // q0
  const MethodInfo_300E2F0_RGCTXs *rgctx_data; // x8
  ClassBoardEffectPlayer_o *v6; // x19
  ClassBoardEffectPlayer_o *_0_T; // x1
  Il2CppObject *data; // x19
  ClassBoardEffectPlayer_o *v11; // x0
  const MethodInfo_300E368 *v12; // x1
...
void __fastcall ClassBoardEffectPlayer__SetData___Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_300E4E4 *method)
{
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.data, (int32_t)v13, v14, v15);
}
...
void __fastcall ClassBoardEffectPlayer__SetData_bool_(
        ClassBoardEffectPlayer_o *this,
        bool obj,
        const MethodInfo_300E428 *method)
{
  __int64 v3; // x3
  __int64 v4; // x4
  const MethodInfo_300E428_RGCTXs *rgctx_data; // x8
  Il2CppObject *v9; // x0
  int32_t v10; // w2
  ...
  this->fields.data = v9;
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.data, (int32_t)v9, v10, v11);
}
...
void __fastcall ClassBoardEffectPlayer__SetData_int_(
        ClassBoardEffectPlayer_o *this,
        int32_t obj,
        const MethodInfo_300E488 *method)
{
  __int64 v3; // x3
  __int64 v4; // x4
  const MethodInfo_300E488_RGCTXs *rgctx_data; // x8
  Il2CppObject *v9; // x0
  int32_t v10; // w2
  const MethodInfo *v11; // x3
        ...
        const MethodInfo *method)
{
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.playCallback, (int32_t)callback, (int32_t)method, v3);
}
