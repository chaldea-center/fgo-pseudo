...
void ClassBoardEffectPlayer___ctor_48022972(
        ...
        const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields, (int32_t)playerName, v5, v6);
}
...
Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_o ClassBoardEffectPlayer__GetData___Il2CppFullySharedGenericType_(
        ClassBoardEffectPlayer_o *this,
        const MethodInfo_30DB51C *method)
{
  __int64 v2; // x2
  long double v3; // q0
  __int64 *v6; // x8
  ...
  if ( (*(_BYTE *)(*v6 + 309) & 1) == 0 )
    v8 = sub_1C8776C(v3);
  v11 = (const void *)sub_1C371A4(data, v8, (char *)v14 - ((v9 + 15) & 0x1FFFFFFF0LL));
...
bool ClassBoardEffectPlayer__GetData_bool_(ClassBoardEffectPlayer_o *this, const MethodInfo_30DB42C *method)
{
  __int64 v2; // x2
  __int64 v3; // x3
  long double v4; // q0
  const MethodInfo_30DB42C_RGCTXs *rgctx_data; // x8
  ClassBoardEffectPlayer_o *v6; // x19
  ClassBoardEffectPlayer_o *_0_T; // x1
  Il2CppObject *data; // x19
  ClassBoardEffectPlayer_o *v11; // x0
  const MethodInfo_30DB4A4 *v12; // x1

  rgctx_data = method->rgctx_data;
  v6 = this;
  if ( !rgctx_data )
  {
    this = (ClassBoardEffectPlayer_o *)sub_1C877C8(method);
    rgctx_data = method->rgctx_data;
  }
  ...
  {
    this = (ClassBoardEffectPlayer_o *)sub_1C8776C(v4);
    _0_T = this;
  }
  if ( !data )
    sub_1C372B4(this);
...
int32_t ClassBoardEffectPlayer__GetData_int_(ClassBoardEffectPlayer_o *this, const MethodInfo_30DB4A4 *method)
{
  __int64 v2; // x2
  __int64 v3; // x3
  long double v4; // q0
  const MethodInfo_30DB4A4_RGCTXs *rgctx_data; // x8
  ClassBoardEffectPlayer_o *v6; // x19
  ClassBoardEffectPlayer_o *_0_T; // x1
  Il2CppObject *data; // x19
  ClassBoardEffectPlayer_o *v11; // x0
  const MethodInfo_30DB51C *v12; // x1
...
void ClassBoardEffectPlayer__SetData___Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_30DB698 *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.data, (int32_t)v16, v17, v18);
}


void ClassBoardEffectPlayer__SetData_bool_(ClassBoardEffectPlayer_o *this, bool obj, const MethodInfo_30DB5DC *method)
{
  __int64 v3; // x3
  __int64 v4; // x4
  __int64 v5; // x5
  __int64 v6; // x6
  __int64 v7; // x7
  const MethodInfo_30DB5DC_RGCTXs *rgctx_data; // x8
  Il2CppObject *v12; // x0
  int32_t v13; // w2
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.data, (int32_t)v12, v13, v14);
}
...
void ClassBoardEffectPlayer__SetData_int_(
        ClassBoardEffectPlayer_o *this,
        int32_t obj,
        const MethodInfo_30DB63C *method)
{
  __int64 v3; // x3
  __int64 v4; // x4
  __int64 v5; // x5
  __int64 v6; // x6
  __int64 v7; // x7
  const MethodInfo_30DB63C_RGCTXs *rgctx_data; // x8
  Il2CppObject *v12; // x0
  int32_t v13; // w2
  const MethodInfo *v14; // x3
        ...
        const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.playCallback, (int32_t)callback, (int32_t)method, v3);
}
