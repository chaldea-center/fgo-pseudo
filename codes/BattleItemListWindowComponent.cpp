...
void BattleItemListWindowComponent__CloseWindow(BattleItemListWindowComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C4641A & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_3523/*"CLOSE_TO_TACTICAL"*/);
    sub_1C37058(&StringLiteral_3522/*"CLOSE_TO_MENU"*/);
    byte_4C4641A = 1;
  }
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.closeFsmEvent, (int32_t)v6, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C46419 & 1) == 0 )
  {
    sub_1C37058(&Method_BattleItemListWindowComponent_OnItemClick__);
  ...
  if ( !battleData
    || (itemList = this->fields.itemList,
        ...
        v10 = (BattleDropItemComponent_ClickDelegate_o *)sub_1C372A4(BattleDropItemComponent_ClickDelegate_TypeInfo),
        ...
        const MethodInfo *method)
{
  if ( (byte_4C4641B & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_12641/*"Scroll Bar/item_list_close"*/);
    byte_4C4641B = 1;
  }
  return (System_String_o *)StringLiteral_12641/*"Scroll Bar/item_list_close"*/;
}