        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47C40 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_3555/*"CLOSE_TO_TACTICAL"*/, method);
    sub_1BDB878(&StringLiteral_3554/*"CLOSE_TO_MENU"*/, v5);
    byte_4B47C40 = 1;
  }
  if ( this->fields.isFromBattleMenu )
    v6 = (struct System_String_o **)&StringLiteral_3554/*"CLOSE_TO_MENU"*/;
  else
    v6 = (struct System_String_o **)&StringLiteral_3555/*"CLOSE_TO_TACTICAL"*/;
  v7 = *v6;
  this->fields.closeFsmEvent = *v6;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.closeFsmEvent, (int32_t)v7, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47C3F & 1) == 0 )
  {
    sub_1BDB878(&Method_BattleItemListWindowComponent_OnItemClick__, fromBattleMenu);
    sub_1BDB878(&BattleDropItemComponent_ClickDelegate_TypeInfo, v7);
    byte_4B47C3F = 1;
  }
  ...
  if ( !battleData
    || (itemList = this->fields.itemList,
        ...
        v11 = (BattleDropItemComponent_ClickDelegate_o *)sub_1BDBAC4(BattleDropItemComponent_ClickDelegate_TypeInfo),
  ...
  {
    sub_1BDBAD4(battleData, fromBattleMenu);
  }
        ...
        const MethodInfo *method)
{
  if ( (byte_4B47C41 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_12607/*"Scroll Bar/item_list_close"*/, method);
    byte_4B47C41 = 1;
  }
  return (System_String_o *)StringLiteral_12607/*"Scroll Bar/item_list_close"*/;
}