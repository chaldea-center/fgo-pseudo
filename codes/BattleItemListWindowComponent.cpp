        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB8BCA & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_3601/*"CLOSE_TO_TACTICAL"*/, method);
    sub_1BAB41C(&StringLiteral_3600/*"CLOSE_TO_MENU"*/, v5);
    byte_4AB8BCA = 1;
  }
  if ( this->fields.isFromBattleMenu )
    v6 = (struct System_String_o **)&StringLiteral_3600/*"CLOSE_TO_MENU"*/;
  else
    v6 = (struct System_String_o **)&StringLiteral_3601/*"CLOSE_TO_TACTICAL"*/;
  v7 = *v6;
  this->fields.closeFsmEvent = *v6;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.closeFsmEvent, (int32_t)v7, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB8BC9 & 1) == 0 )
  {
    sub_1BAB41C(&Method_BattleItemListWindowComponent_OnItemClick__, fromBattleMenu);
    sub_1BAB41C(&BattleDropItemComponent_ClickDelegate_TypeInfo, v7);
    byte_4AB8BC9 = 1;
  }
  ...
  if ( !battleData
    || (itemList = this->fields.itemList,
        ...
        v11 = (BattleDropItemComponent_ClickDelegate_o *)sub_1BAB668(BattleDropItemComponent_ClickDelegate_TypeInfo),
  ...
  {
    sub_1BAB678(battleData, fromBattleMenu);
  }
        ...
        const MethodInfo *method)
{
  if ( (byte_4AB8BCB & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_12569/*"Scroll Bar/item_list_close"*/, method);
    byte_4AB8BCB = 1;
  }
  return (System_String_o *)StringLiteral_12569/*"Scroll Bar/item_list_close"*/;
}