        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A515E1 & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_3520/*"CLOSE_TO_TACTICAL"*/, method);
    sub_1B863B8(&StringLiteral_3519/*"CLOSE_TO_MENU"*/, v5);
    byte_4A515E1 = 1;
  }
  if ( this->fields.isFromBattleMenu )
    v6 = (struct System_String_o **)&StringLiteral_3519/*"CLOSE_TO_MENU"*/;
  else
    v6 = (struct System_String_o **)&StringLiteral_3520/*"CLOSE_TO_TACTICAL"*/;
  v7 = *v6;
  this->fields.closeFsmEvent = *v6;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.closeFsmEvent, (int32_t)v7, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A515E0 & 1) == 0 )
  {
    sub_1B863B8(&Method_BattleItemListWindowComponent_OnItemClick__, fromBattleMenu);
    sub_1B863B8(&BattleDropItemComponent_ClickDelegate_TypeInfo, v7);
    byte_4A515E0 = 1;
  }
  ...
  if ( !battleData
    || (itemList = this->fields.itemList,
        ...
        v11 = (BattleDropItemComponent_ClickDelegate_o *)sub_1B86604(BattleDropItemComponent_ClickDelegate_TypeInfo),
  ...
  {
    sub_1B86614(battleData, fromBattleMenu);
  }
        ...
        const MethodInfo *method)
{
  if ( (byte_4A515E2 & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_12421/*"Scroll Bar/item_list_close"*/, method);
    byte_4A515E2 = 1;
  }
  return (System_String_o *)StringLiteral_12421/*"Scroll Bar/item_list_close"*/;
}