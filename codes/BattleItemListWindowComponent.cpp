...
void BattleItemListWindowComponent__CloseWindow(BattleItemListWindowComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E07FC7 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_3551/*"CLOSE_TO_TACTICAL"*/);
    sub_1CE6700(&StringLiteral_3550/*"CLOSE_TO_MENU"*/);
    byte_4E07FC7 = 1;
  }
  if ( this->fields.isFromBattleMenu )
    v9 = (struct System_String_o **)&StringLiteral_3550/*"CLOSE_TO_MENU"*/;
  else
    v9 = (struct System_String_o **)&StringLiteral_3551/*"CLOSE_TO_TACTICAL"*/;
  v10 = *v9;
  this->fields.closeFsmEvent = *v9;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.closeFsmEvent, (int32_t)v10, v2, v3, v4, v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E07FC6 & 1) == 0 )
  {
    sub_1CE6700(&Method_BattleItemListWindowComponent_OnItemClick__);
    sub_1CE6700(&BattleDropItemComponent_ClickDelegate_TypeInfo);
    byte_4E07FC6 = 1;
  }
  ...
  if ( !battleData
    || (itemList = this->fields.itemList,
        ...
        v10 = (BattleDropItemComponent_ClickDelegate_o *)sub_1CE694C(BattleDropItemComponent_ClickDelegate_TypeInfo),
  ...
  {
    sub_1CE6958(battleData, fromBattleMenu);
  }
        ...
        const MethodInfo *method)
{
  if ( (byte_4E07FC8 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_12776/*"Scroll Bar/item_list_close"*/);
    byte_4E07FC8 = 1;
  }
  return (System_String_o *)StringLiteral_12776/*"Scroll Bar/item_list_close"*/;
}