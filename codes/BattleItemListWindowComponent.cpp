        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A30D3D & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_3602/*"CLOSE_TO_TACTICAL"*/, method);
    sub_1B761C0(&StringLiteral_3601/*"CLOSE_TO_MENU"*/, v5);
    byte_4A30D3D = 1;
  }
  if ( this->fields.isFromBattleMenu )
    v6 = (struct System_String_o **)&StringLiteral_3601/*"CLOSE_TO_MENU"*/;
  else
    v6 = (struct System_String_o **)&StringLiteral_3602/*"CLOSE_TO_TACTICAL"*/;
  v7 = *v6;
  this->fields.closeFsmEvent = *v6;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.closeFsmEvent, (int32_t)v7, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A30D3C & 1) == 0 )
  {
    sub_1B761C0(&Method_BattleItemListWindowComponent_OnItemClick__, fromBattleMenu);
    sub_1B761C0(&BattleDropItemComponent_ClickDelegate_TypeInfo, v7);
    byte_4A30D3C = 1;
  }
  ...
  if ( !battleData
    || (itemList = this->fields.itemList,
        ...
        v11 = (BattleDropItemComponent_ClickDelegate_o *)sub_1B7640C(BattleDropItemComponent_ClickDelegate_TypeInfo),
  ...
  {
    sub_1B7641C(battleData, fromBattleMenu);
  }
        ...
        const MethodInfo *method)
{
  if ( (byte_4A30D3E & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_12538/*"Scroll Bar/item_list_close"*/, method);
    byte_4A30D3E = 1;
  }
  return (System_String_o *)StringLiteral_12538/*"Scroll Bar/item_list_close"*/;
}