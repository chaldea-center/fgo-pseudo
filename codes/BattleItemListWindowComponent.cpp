...
void BattleItemListWindowComponent__CloseWindow(BattleItemListWindowComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2FDDD & 1) == 0 )
  {
    sub_1C94098(&StringLiteral_3528/*"CLOSE_TO_TACTICAL"*/);
    sub_1C94098(&StringLiteral_3527/*"CLOSE_TO_MENU"*/);
    byte_4D2FDDD = 1;
  }
  ...
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.closeFsmEvent, (int32_t)v10, v2, v3, v4, v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2FDDC & 1) == 0 )
  {
    sub_1C94098(&Method_BattleItemListWindowComponent_OnItemClick__);
  ...
  if ( !battleData
    || (itemList = this->fields.itemList,
        ...
        v10 = (BattleDropItemComponent_ClickDelegate_o *)sub_1C942E4(BattleDropItemComponent_ClickDelegate_TypeInfo),
  ...
  {
    sub_1C942F0(battleData, fromBattleMenu);
  }
        ...
        const MethodInfo *method)
{
  if ( (byte_4D2FDDE & 1) == 0 )
  {
    sub_1C94098(&StringLiteral_12695/*"Scroll Bar/item_list_close"*/);
    byte_4D2FDDE = 1;
  }
  return (System_String_o *)StringLiteral_12695/*"Scroll Bar/item_list_close"*/;
}