        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB764B & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_3645/*"CLOSE_SOUND_PLAYER"*/, method);
    sub_1C13D24(&StringLiteral_3644/*"CLOSE_SERIAL_CODE"*/, v9);
    byte_4BB764B = 1;
  }
  if ( this->fields.isFromBattleMenu )
    v10 = (struct System_String_o **)&StringLiteral_3644/*"CLOSE_SERIAL_CODE"*/;
  else
    v10 = (struct System_String_o **)&StringLiteral_3645/*"CLOSE_SOUND_PLAYER"*/;
  v11 = *v10;
  this->fields.closeFsmEvent = *v10;
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.closeFsmEvent, (int64_t)v11, v2, v3, v4, v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB764A & 1) == 0 )
  {
    sub_1C13D24(&Method_BattleItemListWindowComponent_OnItemClick__, fromBattleMenu);
    sub_1C13D24(&BattleDropItemComponent_ClickDelegate_TypeInfo, v7);
    byte_4BB764A = 1;
  }
  ...
  if ( !battleData
    || (itemList = this->fields.itemList,
        ...
        v11 = (BattleDropItemComponent_ClickDelegate_o *)sub_1C13F70(BattleDropItemComponent_ClickDelegate_TypeInfo),
  ...
  {
    sub_1C13F80(battleData, fromBattleMenu);
  }
        ...
        const MethodInfo *method)
{
  if ( (byte_4BB764C & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_12767/*"ScreenshotFolder"*/, method);
    byte_4BB764C = 1;
  }
  return (System_String_o *)StringLiteral_12767/*"ScreenshotFolder"*/;
}