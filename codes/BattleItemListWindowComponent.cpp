        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A018EA & 1) == 0 )
  {
    sub_1B64A00(&StringLiteral_3581/*"CLOSE_TO_TACTICAL"*/, method);
    sub_1B64A00(&StringLiteral_3580/*"CLOSE_TO_MENU"*/, v5);
    byte_4A018EA = 1;
  }
  if ( this->fields.isFromBattleMenu )
    v6 = (struct System_String_o **)&StringLiteral_3580/*"CLOSE_TO_MENU"*/;
  else
    v6 = (struct System_String_o **)&StringLiteral_3581/*"CLOSE_TO_TACTICAL"*/;
  v7 = *v6;
  this->fields.closeFsmEvent = *v6;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.closeFsmEvent, (int32_t)v7, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A018E9 & 1) == 0 )
  {
    sub_1B64A00(&Method_BattleItemListWindowComponent_OnItemClick__, fromBattleMenu);
    sub_1B64A00(&BattleDropItemComponent_ClickDelegate_TypeInfo, v7);
    byte_4A018E9 = 1;
  }
  ...
  if ( !battleData
    || (itemList = this->fields.itemList,
        ...
        v11 = (BattleDropItemComponent_ClickDelegate_o *)sub_1B64C4C(BattleDropItemComponent_ClickDelegate_TypeInfo),
  ...
  {
    sub_1B64C5C(battleData, fromBattleMenu);
  }
        ...
        const MethodInfo *method)
{
  if ( (byte_4A018EB & 1) == 0 )
  {
    sub_1B64A00(&StringLiteral_12491/*"Scroll Bar/item_list_close"*/, method);
    byte_4A018EB = 1;
  }
  return (System_String_o *)StringLiteral_12491/*"Scroll Bar/item_list_close"*/;
}