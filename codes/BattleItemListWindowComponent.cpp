...
void BattleItemListWindowComponent__CloseWindow(BattleItemListWindowComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CCA929 & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_3518/*"CLOSE_TO_TACTICAL"*/);
    sub_1C713B0(&StringLiteral_3517/*"CLOSE_TO_MENU"*/);
    byte_4CCA929 = 1;
  }
  if ( this->fields.isFromBattleMenu )
    v9 = (struct System_String_o **)&StringLiteral_3517/*"CLOSE_TO_MENU"*/;
  else
    v9 = (struct System_String_o **)&StringLiteral_3518/*"CLOSE_TO_TACTICAL"*/;
  v10 = *v9;
  this->fields.closeFsmEvent = *v9;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.closeFsmEvent, (int32_t)v10, v2, v3, v4, v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CCA928 & 1) == 0 )
  {
    sub_1C713B0(&Method_BattleItemListWindowComponent_OnItemClick__);
  ...
  if ( !battleData
    || (itemList = this->fields.itemList,
        ...
        v10 = (BattleDropItemComponent_ClickDelegate_o *)sub_1C715FC(BattleDropItemComponent_ClickDelegate_TypeInfo),
  ...
  {
    sub_1C71608(battleData, fromBattleMenu);
  }
        ...
        const MethodInfo *method)
{
  if ( (byte_4CCA92A & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_12651/*"Scroll Bar/item_list_close"*/);
    byte_4CCA92A = 1;
  }
  return (System_String_o *)StringLiteral_12651/*"Scroll Bar/item_list_close"*/;
}