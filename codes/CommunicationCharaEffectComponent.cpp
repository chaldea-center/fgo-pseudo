        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20E56 & 1) == 0 )
  {
    sub_1B715CC(&UnityEngine_Object_TypeInfo, *(_QWORD *)&faceType);
    byte_4A20E56 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(figure, 0LL, 0LL) )
  {
    ...
    if ( !v7 )
      sub_1B71828(0LL, v6);
    UIStandFigureRender__SetFace_40778680(v7, faceType, 0.0, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  struct UIStandFigureM_o *MeshPrefab_37771204; // x0
  int32_t v22; // w2
  int32_t v23; // w3

  if ( (byte_4A20E55 & 1) == 0 )
  {
    sub_1B715CC(&System_Action_TypeInfo, param);
    sub_1B715CC(&Method_CommunicationCharaEffectComponent_EndDispFigure__, v6);
    sub_1B715CC(&CommunicationCharaEffectParam_TypeInfo, v7);
    byte_4A20E55 = 1;
  }
  if ( param )
  {
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)p_communicationCharaParam, v11, (int32_t)method, v3);
  ...
  MeshPrefab_37771204 = StandFigureManager__CreateMeshPrefab_37771204(
                          figureBase,
                          svtId,
                          limitCount,
                          faceType,
                          ...
                          0,
                          0LL);
  this->fields.figure = MeshPrefab_37771204;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.figure, (int32_t)MeshPrefab_37771204, v22, v23);
}
