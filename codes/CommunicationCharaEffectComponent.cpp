        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF870 & 1) == 0 )
  {
    sub_1B64870(&UnityEngine_Object_TypeInfo, *(_QWORD *)&faceType);
    byte_49FF870 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(figure, 0LL, 0LL) )
  {
    ...
    if ( !v7 )
      sub_1B64ACC(0LL, v6);
    UIStandFigureRender__SetFace_40663412(v7, faceType, 0.0, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  struct UIStandFigureM_o *MeshPrefab_37665716; // x0
  int32_t v22; // w2
  int32_t v23; // w3

  if ( (byte_49FF86F & 1) == 0 )
  {
    sub_1B64870(&System_Action_TypeInfo, param);
    sub_1B64870(&Method_CommunicationCharaEffectComponent_EndDispFigure__, v6);
    sub_1B64870(&CommunicationCharaEffectParam_TypeInfo, v7);
    byte_49FF86F = 1;
  }
  if ( param )
  {
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)p_communicationCharaParam, v11, (int32_t)method, v3);
  ...
  MeshPrefab_37665716 = StandFigureManager__CreateMeshPrefab_37665716(
                          figureBase,
                          svtId,
                          limitCount,
                          faceType,
                          ...
                          0,
                          0LL);
  this->fields.figure = MeshPrefab_37665716;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.figure, (int32_t)MeshPrefab_37665716, v22, v23);
}
