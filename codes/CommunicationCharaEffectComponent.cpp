        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(figure, 0, 0) )
  {
    ...
    if ( !v7 )
      sub_1C2D6EC(0, v6);
    UIStandFigureRender__SetFace_43851168(v7, faceType, 0.0, 0);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  struct UIStandFigureM_o *MeshPrefab_40523828; // x0
  int32_t v20; // w2
  ...
  if ( (byte_4C2896B & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_CommunicationCharaEffectComponent_EndDispFigure__);
    sub_1C2D490(&CommunicationCharaEffectParam_TypeInfo);
    byte_4C2896B = 1;
  }
  if ( param )
  {
  ...
  sub_1C2D434((CGThumbnailListItem_o *)p_communicationCharaParam, v9, (int32_t)method, v3);
  ...
  MeshPrefab_40523828 = StandFigureManager__CreateMeshPrefab_40523828(
                          figureBase,
                          svtId,
                          limitCount,
                          faceType,
                          ...
                          0,
                          0);
  this->fields.figure = MeshPrefab_40523828;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.figure, (int32_t)MeshPrefab_40523828, v20, v21);
}
