        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F2CA & 1) == 0 )
  {
    sub_1B761C0(&UnityEngine_Object_TypeInfo, *(_QWORD *)&faceType);
    byte_4A2F2CA = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(figure, 0LL, 0LL) )
  {
    ...
    if ( !v7 )
      sub_1B7641C(0LL, v6);
    UIStandFigureRender__SetFace_40803420(v7, faceType, 0.0, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  struct UIStandFigureM_o *MeshPrefab_37796140; // x0
  int32_t v22; // w2
  int32_t v23; // w3

  if ( (byte_4A2F2C9 & 1) == 0 )
  {
    sub_1B761C0(&System_Action_TypeInfo, param);
    sub_1B761C0(&Method_CommunicationCharaEffectComponent_EndDispFigure__, v6);
    sub_1B761C0(&CommunicationCharaEffectParam_TypeInfo, v7);
    byte_4A2F2C9 = 1;
  }
  if ( param )
  {
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)p_communicationCharaParam, v11, (int32_t)method, v3);
  ...
  MeshPrefab_37796140 = StandFigureManager__CreateMeshPrefab_37796140(
                          figureBase,
                          svtId,
                          limitCount,
                          faceType,
                          ...
                          0,
                          0LL);
  this->fields.figure = MeshPrefab_37796140;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.figure, (int32_t)MeshPrefab_37796140, v22, v23);
}
