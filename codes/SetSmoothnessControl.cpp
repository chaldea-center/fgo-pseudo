...
void __fastcall SetSmoothnessControl__Init(SetSmoothnessControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD78CA & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_SetSmoothnessControl__Init_b__5_0__);
    sub_1C21E38(&string___TypeInfo);
    sub_1C21E38(&StringLiteral_9900/*"OPTION_SMOOTHNESS_BUTTON_2"*/);
    sub_1C21E38(&StringLiteral_9899/*"OPTION_SMOOTHNESS_BUTTON_1"*/);
    sub_1C21E38(&StringLiteral_9898/*"OPTION_SMOOTHNESS_ATTENTION"*/);
    sub_1C21E38(&StringLiteral_20914/*"img_txt_framerate"*/);
    byte_4BD78CA = 1;
  }
  ...
  AtlasManager__SetMyRoomImage(titleSptite, (System_String_o *)StringLiteral_20914/*"img_txt_framerate"*/, 0LL);
  attentionLabel = this->fields.attentionLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  fpsRadioButtonGroup = LocalizationManager__Get((System_String_o *)StringLiteral_9898/*"OPTION_SMOOTHNESS_ATTENTION"*/, 0LL);
  if ( !attentionLabel )
    goto LABEL_18;
  UILabel__set_text(attentionLabel, fpsRadioButtonGroup, 0LL);
  v7 = (System_String_array *)sub_1C21EE0(string___TypeInfo, 2LL);
  fpsRadioButtonGroup = LocalizationManager__Get((System_String_o *)StringLiteral_9899/*"OPTION_SMOOTHNESS_BUTTON_1"*/, 0LL);
  if ( !v7 )
    goto LABEL_18;
  if ( !v7->max_length
    || (v7->m_Items[0] = fpsRadioButtonGroup,
        sub_1C21DDC(v7->m_Items, fpsRadioButtonGroup),
        fpsRadioButtonGroup = LocalizationManager__Get((System_String_o *)StringLiteral_9900/*"OPTION_SMOOTHNESS_BUTTON_2"*/, 0LL),
        v7->max_length <= 1) )
  {
    sub_1C2209C(fpsRadioButtonGroup, v6);
  }
  v7->m_Items[1] = fpsRadioButtonGroup;
  sub_1C21DDC(&v7->m_Items[1], fpsRadioButtonGroup);
  ...
  {
LABEL_18:
    sub_1C22094(fpsRadioButtonGroup, v6);
  }
  v11->fields.selectedCallback = v12;
  sub_1C21DDC(&v11->fields.selectedCallback, v12);
}
...
void __fastcall SetSmoothnessControl__Reflection(SetSmoothnessControl_o *this, const MethodInfo *method)
{
  ...
  {
    v6 = v3;
    Value = System_Nullable_bool___get_Value(v6, (const MethodInfo_37679BC *)Method_System_Nullable_bool__get_Value__);
    if ( !OptionManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(OptionManager_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (*((_BYTE *)Method_SetSmoothnessControl__Init_b__5_0__ + 83) & 2) != 0 )
    v6 = (_QWORD *)sub_1C21E50(Method_SetSmoothnessControl__Init_b__5_0__);
