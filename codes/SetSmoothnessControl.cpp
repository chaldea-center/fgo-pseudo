...
void __fastcall SetSmoothnessControl__Init(SetSmoothnessControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA183 & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_SetSmoothnessControl__Init_b__5_0__, v6);
    sub_1B64A00(&string___TypeInfo, v7);
    sub_1B64A00(&StringLiteral_9660/*"OPTION_SMOOTHNESS_BUTTON_2"*/, v8);
    sub_1B64A00(&StringLiteral_9659/*"OPTION_SMOOTHNESS_BUTTON_1"*/, v9);
    sub_1B64A00(&StringLiteral_9658/*"OPTION_SMOOTHNESS_ATTENTION"*/, v10);
    sub_1B64A00(&StringLiteral_20464/*"img_txt_framerate"*/, v11);
    byte_49FA183 = 1;
  }
  ...
  fpsRadioButtonGroup = LocalizationManager__Get((System_String_o *)StringLiteral_9658/*"OPTION_SMOOTHNESS_ATTENTION"*/, 0LL);
  if ( !attentionLabel )
    goto LABEL_18;
  UILabel__set_text(attentionLabel, fpsRadioButtonGroup, 0LL);
  v16 = (System_String_array *)sub_1B64AA8(string___TypeInfo, 2LL);
  fpsRadioButtonGroup = LocalizationManager__Get((System_String_o *)StringLiteral_9659/*"OPTION_SMOOTHNESS_BUTTON_1"*/, 0LL);
  if ( !v16 )
    goto LABEL_18;
  if ( !v16->max_length
    || (v16->m_Items[0] = fpsRadioButtonGroup,
        sub_1B649A4(v16->m_Items),
        fpsRadioButtonGroup = LocalizationManager__Get((System_String_o *)StringLiteral_9660/*"OPTION_SMOOTHNESS_BUTTON_2"*/, 0LL),
        v16->max_length <= 1) )
  {
    sub_1B64C64(fpsRadioButtonGroup, v15);
  }
  v16->m_Items[1] = fpsRadioButtonGroup;
  sub_1B649A4(&v16->m_Items[1]);
  ...
  {
LABEL_18:
    sub_1B64C5C(fpsRadioButtonGroup, v15);
  }
  v18->fields.selectedCallback = v19;
  sub_1B649A4(&v18->fields.selectedCallback);
}
...
void __fastcall SetSmoothnessControl__Reflection(SetSmoothnessControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA184 & 1) == 0 )
  {
    sub_1B64A00(&Method_System_Nullable_bool__get_HasValue__, method);
    sub_1B64A00(&Method_System_Nullable_bool__get_Value__, v3);
  ...
  {
    v8 = v5;
    Value = System_Nullable_bool___get_Value(v8, (const MethodInfo_35CCB3C *)Method_System_Nullable_bool__get_Value__);
    if ( !OptionManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(OptionManager_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA185 & 1) == 0 )
  {
    sub_1B64A00(&Method_System_Nullable_bool___ctor__, *(_QWORD *)&selectedIndex);
    sub_1B64A00(&Method_SetSmoothnessControl__Init_b__5_0__, v5);
    byte_49FA185 = 1;
  }
  v6 = &v9;
  v9 = 0;
  ...
  if ( (*((_BYTE *)Method_SetSmoothnessControl__Init_b__5_0__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1B64A18(Method_SetSmoothnessControl__Init_b__5_0__);
