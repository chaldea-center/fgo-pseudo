...
void __fastcall SetSmoothnessControl__Init(SetSmoothnessControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3260E & 1) == 0 )
  {
    ...
    sub_1BD3458(&Method_SetSmoothnessControl__Init_b__5_0__, v6);
    sub_1BD3458(&string___TypeInfo, v7);
    sub_1BD3458(&StringLiteral_9850/*"OPTION_SMOOTHNESS_BUTTON_2"*/, v8);
    sub_1BD3458(&StringLiteral_9849/*"OPTION_SMOOTHNESS_BUTTON_1"*/, v9);
    sub_1BD3458(&StringLiteral_9848/*"OPTION_SMOOTHNESS_ATTENTION"*/, v10);
    sub_1BD3458(&StringLiteral_20794/*"img_txt_framerate"*/, v11);
    byte_4B3260E = 1;
  }
  ...
  AtlasManager__SetMyRoomImage(titleSptite, (System_String_o *)StringLiteral_20794/*"img_txt_framerate"*/, 0LL);
  attentionLabel = this->fields.attentionLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  fpsRadioButtonGroup = LocalizationManager__Get((System_String_o *)StringLiteral_9848/*"OPTION_SMOOTHNESS_ATTENTION"*/, 0LL);
  if ( !attentionLabel )
    goto LABEL_18;
  UILabel__set_text(attentionLabel, fpsRadioButtonGroup, 0LL);
  v16 = (System_String_array *)sub_1BD3500(string___TypeInfo, 2LL);
  fpsRadioButtonGroup = LocalizationManager__Get((System_String_o *)StringLiteral_9849/*"OPTION_SMOOTHNESS_BUTTON_1"*/, 0LL);
  if ( !v16 )
    goto LABEL_18;
  if ( !v16->max_length
    || (v16->m_Items[0] = fpsRadioButtonGroup,
        sub_1BD33FC(v16->m_Items),
        fpsRadioButtonGroup = LocalizationManager__Get((System_String_o *)StringLiteral_9850/*"OPTION_SMOOTHNESS_BUTTON_2"*/, 0LL),
        v16->max_length <= 1) )
  {
    sub_1BD36BC(fpsRadioButtonGroup, v15);
  }
  v16->m_Items[1] = fpsRadioButtonGroup;
  sub_1BD33FC(&v16->m_Items[1]);
  ...
  {
LABEL_18:
    sub_1BD36B4(fpsRadioButtonGroup, v15);
  }
  v20->fields.selectedCallback = v21;
  sub_1BD33FC(&v20->fields.selectedCallback);
}
...
void __fastcall SetSmoothnessControl__Reflection(SetSmoothnessControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3260F & 1) == 0 )
  {
    sub_1BD3458(&Method_System_Nullable_bool__get_HasValue__, method);
    sub_1BD3458(&Method_System_Nullable_bool__get_Value__, v3);
  ...
  {
    v8 = v5;
    Value = System_Nullable_bool___get_Value(v8, (const MethodInfo_36DA094 *)Method_System_Nullable_bool__get_Value__);
    if ( !OptionManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(OptionManager_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B32610 & 1) == 0 )
  {
    sub_1BD3458(&Method_System_Nullable_bool___ctor__, *(_QWORD *)&selectedIndex);
    sub_1BD3458(&Method_SetSmoothnessControl__Init_b__5_0__, v5);
    byte_4B32610 = 1;
  }
  v6 = &v9;
  v9 = 0;
  ...
  if ( (*((_BYTE *)Method_SetSmoothnessControl__Init_b__5_0__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1BD3470(Method_SetSmoothnessControl__Init_b__5_0__);
