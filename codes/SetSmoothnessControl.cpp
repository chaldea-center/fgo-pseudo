...
void SetSmoothnessControl__Init(SetSmoothnessControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC23FE & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_SetSmoothnessControl__Init_b__5_0__);
    sub_1C713B0(&string___TypeInfo);
    sub_1C713B0(&StringLiteral_9710/*"OPTION_SMOOTHNESS_BUTTON_2"*/);
    sub_1C713B0(&StringLiteral_9709/*"OPTION_SMOOTHNESS_BUTTON_1"*/);
    sub_1C713B0(&StringLiteral_9708/*"OPTION_SMOOTHNESS_ATTENTION"*/);
    sub_1C713B0(&StringLiteral_20743/*"img_txt_framerate"*/);
    byte_4CC23FE = 1;
  }
  ...
  AtlasManager__SetMyRoomImage(titleSptite, (System_String_o *)StringLiteral_20743/*"img_txt_framerate"*/, 0);
  attentionLabel = this->fields.attentionLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  fpsRadioButtonGroup = LocalizationManager__Get((System_String_o *)StringLiteral_9708/*"OPTION_SMOOTHNESS_ATTENTION"*/, 0);
  if ( !attentionLabel )
    goto LABEL_18;
  UILabel__set_text(attentionLabel, fpsRadioButtonGroup, 0);
  v7 = sub_1C71458(string___TypeInfo, 2);
  fpsRadioButtonGroup = LocalizationManager__Get((System_String_o *)StringLiteral_9709/*"OPTION_SMOOTHNESS_BUTTON_1"*/, 0);
  if ( !v7 )
    goto LABEL_18;
  if ( !*(_DWORD *)(v7 + 24)
    || (*(_QWORD *)(v7 + 32) = fpsRadioButtonGroup,
        sub_1C71354((GrandQuestFolderBoardItem_o *)(v7 + 32), (int32_t)fpsRadioButtonGroup, v8, v9, v10, v11, v12, v13),
        fpsRadioButtonGroup = LocalizationManager__Get((System_String_o *)StringLiteral_9710/*"OPTION_SMOOTHNESS_BUTTON_2"*/, 0),
        *(_DWORD *)(v7 + 24) <= 1u) )
  {
    sub_1C71610(fpsRadioButtonGroup);
  }
  *(_QWORD *)(v7 + 40) = fpsRadioButtonGroup;
  sub_1C71354((GrandQuestFolderBoardItem_o *)(v7 + 40), (int32_t)fpsRadioButtonGroup, v14, v15, v16, v17, v18, v19);
  ...
  {
LABEL_18:
    sub_1C71608(fpsRadioButtonGroup, v6);
  }
  v23->fields.selectedCallback = v24;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&v23->fields.selectedCallback, (int32_t)v24, v25, v26, v27, v28, v29, v30);
}
...
void SetSmoothnessControl__Reflection(SetSmoothnessControl_o *this, const MethodInfo *method)
{
  ...
  {
    v5 = v3;
    Value = System_Nullable_bool___get_Value(v5, (const MethodInfo_393511C *)Method_System_Nullable_bool__get_Value__);
    if ( !OptionManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(OptionManager_TypeInfo);
...
void SetSmoothnessControl___Init_b__5_0(SetSmoothnessControl_o *this, int32_t selectedIndex, const MethodInfo *method)
{
  ...
  if ( (*((_BYTE *)Method_SetSmoothnessControl__Init_b__5_0__ + 83) & 2) != 0 )
    v6 = (_QWORD *)sub_1C713C8(Method_SetSmoothnessControl__Init_b__5_0__);
