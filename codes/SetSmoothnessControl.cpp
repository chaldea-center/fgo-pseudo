...
void SetSmoothnessControl__Init(SetSmoothnessControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3E029 & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_SetSmoothnessControl__Init_b__5_0__);
    sub_1C37058(&string___TypeInfo);
    sub_1C37058(&StringLiteral_9709/*"OPTION_SMOOTHNESS_BUTTON_2"*/);
    sub_1C37058(&StringLiteral_9708/*"OPTION_SMOOTHNESS_BUTTON_1"*/);
    sub_1C37058(&StringLiteral_9707/*"OPTION_SMOOTHNESS_ATTENTION"*/);
    sub_1C37058(&StringLiteral_20665/*"img_txt_framerate"*/);
    byte_4C3E029 = 1;
  }
  ...
  AtlasManager__SetMyRoomImage(titleSptite, (System_String_o *)StringLiteral_20665/*"img_txt_framerate"*/, 0);
  ...
  if ( !*(_DWORD *)(v6 + 24)
    || (*(_QWORD *)(v6 + 32) = fpsRadioButtonGroup,
        sub_1C36FFC((CGThumbnailListItem_o *)(v6 + 32), (int32_t)fpsRadioButtonGroup, v7, v8),
        fpsRadioButtonGroup = LocalizationManager__Get((System_String_o *)StringLiteral_9709/*"OPTION_SMOOTHNESS_BUTTON_2"*/, 0),
        *(_DWORD *)(v6 + 24) <= 1u) )
  {
    sub_1C372BC(fpsRadioButtonGroup);
  }
  *(_QWORD *)(v6 + 40) = fpsRadioButtonGroup;
  sub_1C36FFC((CGThumbnailListItem_o *)(v6 + 40), (int32_t)fpsRadioButtonGroup, v9, v10);
  ...
  {
LABEL_18:
    sub_1C372B4(fpsRadioButtonGroup);
  }
  v15->fields.selectedCallback = v16;
  sub_1C36FFC((CGThumbnailListItem_o *)&v15->fields.selectedCallback, (int32_t)v16, v17, v18);
}
...
void SetSmoothnessControl__Reflection(SetSmoothnessControl_o *this, const MethodInfo *method)
{
  ...
  {
    v5 = v3;
    Value = System_Nullable_bool___get_Value(v5, (const MethodInfo_38C5060 *)Method_System_Nullable_bool__get_Value__);
    if ( !OptionManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(OptionManager_TypeInfo);
...
void SetSmoothnessControl___Init_b__5_0(SetSmoothnessControl_o *this, int32_t selectedIndex, const MethodInfo *method)
{
  ...
  if ( (*((_BYTE *)Method_SetSmoothnessControl__Init_b__5_0__ + 83) & 2) != 0 )
    v6 = (_QWORD *)sub_1C37070(Method_SetSmoothnessControl__Init_b__5_0__);
