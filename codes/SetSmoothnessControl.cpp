...
void __fastcall SetSmoothnessControl__Init(SetSmoothnessControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B413 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_SetSmoothnessControl__Init_b__5_0__, v6);
    sub_1B90010(&string___TypeInfo, v7);
    sub_1B90010(&StringLiteral_9709/*"OPTION_SMOOTHNESS_BUTTON_2"*/, v8);
    sub_1B90010(&StringLiteral_9708/*"OPTION_SMOOTHNESS_BUTTON_1"*/, v9);
    sub_1B90010(&StringLiteral_9707/*"OPTION_SMOOTHNESS_ATTENTION"*/, v10);
    sub_1B90010(&StringLiteral_20570/*"img_txt_framerate"*/, v11);
    byte_4A6B413 = 1;
  }
  ...
  AtlasManager__SetMyRoomImage(titleSptite, (System_String_o *)StringLiteral_20570/*"img_txt_framerate"*/, 0LL);
  ...
  v16 = (System_String_array *)sub_1B900B8(string___TypeInfo, 2LL);
  ...
  if ( !v18
    || (GameOptionRadioButtonGroup__SelectButtonByIndex(v18, (unsigned __int8)fpsRadioButtonGroup & 1, 1, v19),
        ...
        v21 = (System_Action_int__o *)sub_1B9025C(System_Action_int__TypeInfo),
        System_Action_int____ctor(v21, (Il2CppObject *)this, (intptr_t)Method_SetSmoothnessControl__Init_b__5_0__, 0LL),
        !v20) )
  {
LABEL_18:
    sub_1B9026C(fpsRadioButtonGroup, v15);
  }
  v20->fields.selectedCallback = v21;
  sub_1B8FFB4(&v20->fields.selectedCallback);
}
...
void __fastcall SetSmoothnessControl__Reflection(SetSmoothnessControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B414 & 1) == 0 )
  {
    sub_1B90010(&Method_System_Nullable_bool__get_HasValue__, method);
    sub_1B90010(&Method_System_Nullable_bool__get_Value__, v3);
  ...
  {
    v8 = v5;
    Value = System_Nullable_bool___get_Value(v8, (const MethodInfo_36298F4 *)Method_System_Nullable_bool__get_Value__);
    if ( !OptionManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(OptionManager_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B415 & 1) == 0 )
  {
    sub_1B90010(&Method_System_Nullable_bool___ctor__, *(_QWORD *)&selectedIndex);
    sub_1B90010(&Method_SetSmoothnessControl__Init_b__5_0__, v5);
    byte_4A6B415 = 1;
  }
  v6 = &v9;
  v9 = 0;
  ...
  if ( (*((_BYTE *)Method_SetSmoothnessControl__Init_b__5_0__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1B90028(Method_SetSmoothnessControl__Init_b__5_0__);
