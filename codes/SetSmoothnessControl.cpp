...
void SetSmoothnessControl__Init(SetSmoothnessControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E72594 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_SetSmoothnessControl__Init_b__5_0__);
    sub_1D0F0B4(&string___TypeInfo);
    sub_1D0F0B4(&StringLiteral_9826/*"OPTION_SMOOTHNESS_BUTTON_2"*/);
    sub_1D0F0B4(&StringLiteral_9825/*"OPTION_SMOOTHNESS_BUTTON_1"*/);
    sub_1D0F0B4(&StringLiteral_9824/*"OPTION_SMOOTHNESS_ATTENTION"*/);
    sub_1D0F0B4(&StringLiteral_21057/*"img_txt_framerate"*/);
    byte_4E72594 = 1;
  }
  ...
  AtlasManager__SetMyRoomImage(titleSptite, (System_String_o *)StringLiteral_21057/*"img_txt_framerate"*/, 0);
  attentionLabel = this->fields.attentionLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  fpsRadioButtonGroup = LocalizationManager__Get((System_String_o *)StringLiteral_9824/*"OPTION_SMOOTHNESS_ATTENTION"*/, 0);
  if ( !attentionLabel )
    goto LABEL_18;
  UILabel__set_text(attentionLabel, fpsRadioButtonGroup, 0);
  v7 = sub_1D0F15C(string___TypeInfo, 2);
  fpsRadioButtonGroup = LocalizationManager__Get((System_String_o *)StringLiteral_9825/*"OPTION_SMOOTHNESS_BUTTON_1"*/, 0);
  if ( !v7 )
    goto LABEL_18;
  if ( !*(_DWORD *)(v7 + 24)
    || (*(_QWORD *)(v7 + 32) = fpsRadioButtonGroup,
        sub_1D0F058((GrandQuestFolderBoardItem_o *)(v7 + 32), (int32_t)fpsRadioButtonGroup, v8, v9, v10, v11, v12, v13),
        fpsRadioButtonGroup = LocalizationManager__Get((System_String_o *)StringLiteral_9826/*"OPTION_SMOOTHNESS_BUTTON_2"*/, 0),
        *(_DWORD *)(v7 + 24) <= 1u) )
  {
    sub_1D0F314(fpsRadioButtonGroup);
  }
  *(_QWORD *)(v7 + 40) = fpsRadioButtonGroup;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)(v7 + 40), (int32_t)fpsRadioButtonGroup, v14, v15, v16, v17, v18, v19);
  ...
  if ( !v20
    || (GameOptionRadioButtonGroup__SelectButtonByIndex(v20, (unsigned __int8)fpsRadioButtonGroup & 1, 1, 0),
        ...
        v22 = (System_Action_int__o *)sub_1D0F300(System_Action_int__TypeInfo),
        System_Action_int____ctor(v22, (Il2CppObject *)this, (intptr_t)Method_SetSmoothnessControl__Init_b__5_0__, 0),
        !v21) )
  {
LABEL_18:
    sub_1D0F30C(fpsRadioButtonGroup, v6);
  }
  v21->fields.selectedCallback = v22;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&v21->fields.selectedCallback, (int32_t)v22, v23, v24, v25, v26, v27, v28);
}
...
void SetSmoothnessControl__Reflection(SetSmoothnessControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E72595 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_System_Nullable_bool__get_HasValue__);
    sub_1D0F0B4(&Method_System_Nullable_bool__get_Value__);
    sub_1D0F0B4(&OptionManager_TypeInfo);
    byte_4E72595 = 1;
  }
  ...
  {
    v5 = v3;
    Value = System_Nullable_bool___get_Value(v5, (const MethodInfo_3A80BA4 *)Method_System_Nullable_bool__get_Value__);
    if ( !OptionManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(OptionManager_TypeInfo);
...
void SetSmoothnessControl___Init_b__5_0(SetSmoothnessControl_o *this, int32_t selectedIndex, const MethodInfo *method)
{
  ...
  if ( (*((_BYTE *)Method_SetSmoothnessControl__Init_b__5_0__ + 83) & 2) != 0 )
    v6 = (_QWORD *)sub_1D0F0CC(Method_SetSmoothnessControl__Init_b__5_0__);
