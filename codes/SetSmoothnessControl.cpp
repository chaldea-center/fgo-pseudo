...
void __fastcall SetSmoothnessControl__Init(SetSmoothnessControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFD160 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_SetSmoothnessControl__Init_b__5_0__, v6);
    sub_1BC3008(&string___TypeInfo, v7);
    sub_1BC3008(&StringLiteral_9623/*"OPTION_SMOOTHNESS_BUTTON_2"*/, v8);
    sub_1BC3008(&StringLiteral_9622/*"OPTION_SMOOTHNESS_BUTTON_1"*/, v9);
    sub_1BC3008(&StringLiteral_9621/*"OPTION_SMOOTHNESS_ATTENTION"*/, v10);
    sub_1BC3008(&StringLiteral_20463/*"img_txt_framerate"*/, v11);
    byte_4AFD160 = 1;
  }
  ...
  AtlasManager__SetMyRoomImage(titleSptite, (System_String_o *)StringLiteral_20463/*"img_txt_framerate"*/, 0LL);
  attentionLabel = this->fields.attentionLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  fpsRadioButtonGroup = LocalizationManager__Get((System_String_o *)StringLiteral_9621/*"OPTION_SMOOTHNESS_ATTENTION"*/, 0LL);
  if ( !attentionLabel )
    goto LABEL_18;
  UILabel__set_text(attentionLabel, fpsRadioButtonGroup, 0LL);
  v16 = sub_1BC30B0(string___TypeInfo, 2LL);
  fpsRadioButtonGroup = LocalizationManager__Get((System_String_o *)StringLiteral_9622/*"OPTION_SMOOTHNESS_BUTTON_1"*/, 0LL);
  if ( !v16 )
    goto LABEL_18;
  if ( !*(_DWORD *)(v16 + 24)
    || (*(_QWORD *)(v16 + 32) = fpsRadioButtonGroup,
        sub_1BC2FAC((CGThumbnailListItem_o *)(v16 + 32), (int32_t)fpsRadioButtonGroup, v17, v18),
        fpsRadioButtonGroup = LocalizationManager__Get((System_String_o *)StringLiteral_9623/*"OPTION_SMOOTHNESS_BUTTON_2"*/, 0LL),
        *(_DWORD *)(v16 + 24) <= 1u) )
  {
    sub_1BC326C(fpsRadioButtonGroup, v15, v17);
  }
  *(_QWORD *)(v16 + 40) = fpsRadioButtonGroup;
  sub_1BC2FAC((CGThumbnailListItem_o *)(v16 + 40), (int32_t)fpsRadioButtonGroup, v17, v19);
  ...
  {
LABEL_18:
    sub_1BC3264(fpsRadioButtonGroup, v15);
  }
  v23->fields.selectedCallback = v24;
  sub_1BC2FAC((CGThumbnailListItem_o *)&v23->fields.selectedCallback, (int32_t)v24, v25, v26);
}
...
void __fastcall SetSmoothnessControl__Reflection(SetSmoothnessControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFD161 & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Nullable_bool__get_HasValue__, method);
    sub_1BC3008(&Method_System_Nullable_bool__get_Value__, v3);
  ...
  {
    v8 = v5;
    Value = System_Nullable_bool___get_Value(v8, (const MethodInfo_37BC954 *)Method_System_Nullable_bool__get_Value__);
    if ( !OptionManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(OptionManager_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFD162 & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Nullable_bool___ctor__, *(_QWORD *)&selectedIndex);
    sub_1BC3008(&Method_SetSmoothnessControl__Init_b__5_0__, v5);
    byte_4AFD162 = 1;
  }
  v6 = &v9;
  v9 = 0;
  ...
  if ( (*((_BYTE *)Method_SetSmoothnessControl__Init_b__5_0__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1BC3020(Method_SetSmoothnessControl__Init_b__5_0__);
