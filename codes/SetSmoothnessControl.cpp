...
void SetSmoothnessControl__Init(SetSmoothnessControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596B5CA & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_SetSmoothnessControl__Init_b__5_0__);
    sub_2213A60(&string___TypeInfo);
    sub_2213A60(&StringLiteral_10107/*"OPTION_SMOOTHNESS_BUTTON_2"*/);
    sub_2213A60(&StringLiteral_10106/*"OPTION_SMOOTHNESS_BUTTON_1"*/);
    sub_2213A60(&StringLiteral_10105/*"OPTION_SMOOTHNESS_ATTENTION"*/);
    sub_2213A60(&StringLiteral_21662/*"img_txt_framerate"*/);
    byte_596B5CA = 1;
  }
  ...
  AtlasManager__SetMyRoomImage(titleSptite, (System_String_o *)StringLiteral_21662/*"img_txt_framerate"*/, 0);
  attentionLabel = this->fields.attentionLabel;
  if ( !*(&LocalizationManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, v6, v7);
  fpsRadioButtonGroup = LocalizationManager__Get((System_String_o *)StringLiteral_10105/*"OPTION_SMOOTHNESS_ATTENTION"*/, 0);
  if ( !attentionLabel )
    goto LABEL_18;
  UILabel__set_text(attentionLabel, fpsRadioButtonGroup, 0);
  v11 = sub_2213B20(string___TypeInfo, 2);
  fpsRadioButtonGroup = LocalizationManager__Get((System_String_o *)StringLiteral_10106/*"OPTION_SMOOTHNESS_BUTTON_1"*/, 0);
  if ( !v11 )
    goto LABEL_18;
  if ( !*(_DWORD *)(v11 + 24)
    || (*(_QWORD *)(v11 + 32) = fpsRadioButtonGroup,
        sub_2213A04(
          ...
          v16,
          v17),
        fpsRadioButtonGroup = LocalizationManager__Get((System_String_o *)StringLiteral_10107/*"OPTION_SMOOTHNESS_BUTTON_2"*/, 0),
        (*(_DWORD *)(v11 + 24) & 0xFFFFFFFE) == 0) )
  {
    sub_2213CE4(fpsRadioButtonGroup);
  }
  *(_QWORD *)(v11 + 40) = fpsRadioButtonGroup;
  ...
  {
LABEL_18:
    sub_2213CDC(fpsRadioButtonGroup, v10);
  }
...
void SetSmoothnessControl___Init_b__5_0(SetSmoothnessControl_o *this, int32_t selectedIndex, const MethodInfo *method)
{
  ...
  if ( (v6[83] & 2) != 0 )
    v6 = (_BYTE *)sub_2213A78(v6);
  v7 = (System_Reflection_MethodBase_o *)sub_2213A44(v6, *((_QWORD *)v6 + 4));
