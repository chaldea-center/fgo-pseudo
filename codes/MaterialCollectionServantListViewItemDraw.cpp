        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFD23F & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_DataManager_GetMaster_ServantLimitMaster___, v7);
    ...
    sub_1BC3008(&StringLiteral_8496/*"MATERIAL_FIND_COMMAND_CODE"*/, v14);
    sub_1BC3008(&StringLiteral_8499/*"MATERIAL_FIND_SERVANT_EQUIP"*/, v15);
    sub_1BC3008(&StringLiteral_1/*""*/, v16);
    sub_1BC3008(&StringLiteral_8498/*"MATERIAL_FIND_SERVANT"*/, v17);
    byte_4AFD23F = 1;
  }
  if ( !item || !mode )
    return;
...
LABEL_14:
      ...
      *(_QWORD *)&v59.fields.fakeValue = v22;
      v24 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48024060(v59, 0LL);
      ...
      if ( v24 == v25->static_fields->ServantIdMashu1 && item->fields.isValentineList )
      {
        ...
        IsDataLostStateServant = (UserServantCollectionEntity_o *)DataManager__GetMaster_object_((const MethodInfo_3001E10 *)Method_DataManager_GetMaster_UserServantMaster___);
        ...
        if ( v26 )
        {
          HeroineData = UserServantMaster__getHeroineData(
                          ...
                          0LL);
          IsDataLostStateServant = (UserServantCollectionEntity_o *)DataManager__GetMaster_object_((const MethodInfo_3001E10 *)Method_DataManager_GetMaster_ServantLimitMaster___);
          if ( HeroineData )
          {
            ...
            *(_QWORD *)&v60.fields.fakeValue = v29;
            IsDataLostStateServant = (UserServantCollectionEntity_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48024060(
                                                                        v60,
                                                                        0LL);
            if ( v28 )
            {
                ...
                if ( item->fields.userSvtCollectionEntity )
                {
                  ...
                  if ( ((unsigned __int8)IsDataLostStateServant & 1) != 0 )
                  {
                    ...
                    *(_QWORD *)&v61.fields.fakeValue = v34;
                    v37 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48024060(v61, 0LL);
                    SpecialLimitCountPLD = BalanceConfig_TypeInfo->static_fields->SpecialLimitCountPLD;
                    v39 = (ServantOverwriteStatus_o *)sub_1BC3254(ServantOverwriteStatus_TypeInfo);
                    ServantOverwriteStatus___ctor_32954528(v39, v36, v37, SpecialLimitCountPLD, 0LL);
                    if ( !v39 )
                      goto LABEL_95;
...
LABEL_95:
        sub_1BC3264(IsDataLostStateServant, userCommandCodeCollectionEntity);
      }
      IsDataLostStateServant = (UserServantCollectionEntity_o *)this->fields.servantFaceIcon;
      if ( !IsDataLostStateServant )
        goto LABEL_95;
  ...
  else
  {
    ...
    if ( userCommandCodeCollectionEntity )
    {
      ...
      if ( !IsDataLostStateServant )
        goto LABEL_95;
      ServantFaceIconComponent__Set_40045084(
        (ServantFaceIconComponent_o *)IsDataLostStateServant,
...
LABEL_81:
  ...
  if ( item->fields.userSvtCollectionEntity )
  {
    ...
    v54 = &StringLiteral_8498/*"MATERIAL_FIND_SERVANT"*/;
    if ( v52 && ServantEntity__get_IsKeepServantEquip(v52, 0LL) )
      v54 = (__int64 *)&StringLiteral_8499/*"MATERIAL_FIND_SERVANT_EQUIP"*/;
...
LABEL_93:
  ...
  if ( item->fields.userCommandCodeCollectionEntity )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v56 = (System_String_o *)StringLiteral_8496/*"MATERIAL_FIND_COMMAND_CODE"*/;
    goto LABEL_93;
  }
LABEL_82:
  baseButton = (UnityEngine_Object_o *)this->fields.baseButton;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFD241 & 1) == 0 )
  {
    ...
    sub_1BC3008(&MyRoomParamsManager_TypeInfo, v5);
    sub_1BC3008(&StringLiteral_6346/*"FES_WAR_ID"*/, v6);
    sub_1BC3008(&StringLiteral_8504/*"MATERIAL_MAP_EPILOGUE_TITLE"*/, v7);
    byte_4AFD241 = 1;
  }
  ...
  {
    mLastTimeIcon = (UnityEngine_Component_o *)ConstantMaster__getValue((System_String_o *)StringLiteral_6346/*"FES_WAR_ID"*/, 0LL);
    ...
    if ( !byte_4AFD2AC )
    {
      sub_1BC3008(&MyRoomParamsManager_TypeInfo, item);
      byte_4AFD2AC = 1;
    }
    ...
    if ( v10 == war_id )
    {
      if ( v14 == quest_id )
      {
        ...
        if ( *(_DWORD *)(*(_QWORD *)&mLastTimeIcon[7].fields.m_CachedPtr + 16LL) == v16 && v16 != -1 )
        {
          ...
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          v19 = LocalizationManager__Get((System_String_o *)StringLiteral_8504/*"MATERIAL_MAP_EPILOGUE_TITLE"*/, 0LL);
          ...
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          v26 = LocalizationManager__Get((System_String_o *)StringLiteral_8504/*"MATERIAL_MAP_EPILOGUE_TITLE"*/, 0LL);
...
LABEL_70:
            sub_1BC3264(mLastTimeIcon, item);
          }
        }
      }
    }
