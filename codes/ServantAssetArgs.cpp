...
void __fastcall ServantAssetArgs___ctor_26788556(
        ServantAssetArgs_o *this,
        int32_t svtId,
        int32_t limitCount,
        ...
        const MethodInfo *method)
{
  ...
  return System_String__Join((System_String_o *)StringLiteral_16011/*"_"*/, para, 0LL);
}
...
System_String_o *__fastcall ServantAssetArgs__get_UniqueKey(ServantAssetArgs_o *this, const MethodInfo *method)
{
  ...
  {
    v4 = sub_B5299C(string___TypeInfo, 6LL);
    ...
    if ( !v5 || (v5 = (System_String_o *)sub_B52A44(v5, *(_QWORD *)(*(_QWORD *)v4 + 64LL))) != 0LL )
    {
      if ( !*(_DWORD *)(v4 + 24) )
        goto LABEL_25;
      *(_QWORD *)(v4 + 32) = v13;
      sub_B52920((BattleServantConfConponent_o *)(v4 + 32), v13, v7, v8, v9, v10, v11, v12);
      ...
      if ( !v5 || (v5 = (System_String_o *)sub_B52A44(v5, *(_QWORD *)(*(_QWORD *)v4 + 64LL))) != 0LL )
      {
        if ( *(_DWORD *)(v4 + 24) <= 1u )
          goto LABEL_25;
        *(_QWORD *)(v4 + 40) = v20;
        sub_B52920((BattleServantConfConponent_o *)(v4 + 40), v20, v14, v15, v16, v17, v18, v19);
        ...
        if ( !v5 || (v5 = (System_String_o *)sub_B52A44(v5, *(_QWORD *)(*(_QWORD *)v4 + 64LL))) != 0LL )
        {
          if ( *(_DWORD *)(v4 + 24) <= 2u )
            goto LABEL_25;
          *(_QWORD *)(v4 + 48) = v27;
          sub_B52920((BattleServantConfConponent_o *)(v4 + 48), v27, v21, v22, v23, v24, v25, v26);
          ...
          if ( !v5 || (v5 = (System_String_o *)sub_B52A44(v5, *(_QWORD *)(*(_QWORD *)v4 + 64LL))) != 0LL )
          {
            if ( *(_DWORD *)(v4 + 24) <= 3u )
              goto LABEL_25;
            *(_QWORD *)(v4 + 56) = v34;
            sub_B52920((BattleServantConfConponent_o *)(v4 + 56), v34, v28, v29, v30, v31, v32, v33);
            ...
            if ( !v5 || (v5 = (System_String_o *)sub_B52A44(v5, *(_QWORD *)(*(_QWORD *)v4 + 64LL))) != 0LL )
            {
              if ( *(_DWORD *)(v4 + 24) <= 4u )
                goto LABEL_25;
              *(_QWORD *)(v4 + 64) = v41;
              sub_B52920((BattleServantConfConponent_o *)(v4 + 64), v41, v35, v36, v37, v38, v39, v40);
              ...
              if ( !v5 || (v5 = (System_String_o *)sub_B52A44(v5, *(_QWORD *)(*(_QWORD *)v4 + 64LL))) != 0LL )
              {
                ...
                {
                  *(_QWORD *)(v4 + 72) = v48;
                  sub_B52920((BattleServantConfConponent_o *)(v4 + 72), v48, v42, v43, v44, v45, v46, v47);
                  ...
                  sub_B52920(p_uniqueKey, UniqueKey, v52, v53, v54, v55, v56, v57);
