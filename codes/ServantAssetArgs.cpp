        ...
        const MethodInfo *method)
{
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields._deckSvt_k__BackingField, (int32_t)deckSvt, v14, v15);
}


void __fastcall ServantAssetArgs___ctor_43286164(
        ServantAssetArgs_o *this,
        int32_t svtId,
        int32_t limitCount,
        ...
        const MethodInfo *method)
{
  if ( (byte_4A72850 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_16148/*"_"*/, para);
    byte_4A72850 = 1;
  }
  return System_String__Join((System_String_o *)StringLiteral_16148/*"_"*/, para, 0LL);
}
...
System_String_o *__fastcall ServantAssetArgs__get_UniqueKey(ServantAssetArgs_o *this, const MethodInfo *method)
{
  ...
  {
    v4 = sub_1B900B8(string___TypeInfo, 6LL);
    ...
    if ( !*(_DWORD *)(v4 + 24) )
      goto LABEL_13;
    *(_QWORD *)(v4 + 32) = v5;
    sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v4 + 32), (int32_t)v5, v7, v8);
    SvtId_k__BackingField = this->fields._CommandImageSvtId_k__BackingField;
    v5 = System_Int32__ToString((int32_t)&SvtId_k__BackingField, 0LL);
    if ( *(_DWORD *)(v4 + 24) <= 1u )
      goto LABEL_13;
    *(_QWORD *)(v4 + 40) = v5;
    sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v4 + 40), (int32_t)v5, v9, v10);
    SvtId_k__BackingField = this->fields._DispImageSvtId_k__BackingField;
    v5 = System_Int32__ToString((int32_t)&SvtId_k__BackingField, 0LL);
    if ( *(_DWORD *)(v4 + 24) <= 2u )
      goto LABEL_13;
    *(_QWORD *)(v4 + 48) = v5;
    sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v4 + 48), (int32_t)v5, v11, v12);
    SvtId_k__BackingField = this->fields._DispLimitCount_k__BackingField;
    v5 = System_Int32__ToString((int32_t)&SvtId_k__BackingField, 0LL);
    if ( *(_DWORD *)(v4 + 24) <= 3u )
      goto LABEL_13;
    *(_QWORD *)(v4 + 56) = v5;
    sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v4 + 56), (int32_t)v5, v13, v14);
    SvtId_k__BackingField = this->fields._OverwriteSvtVoiceId_k__BackingField;
    v5 = System_Int32__ToString((int32_t)&SvtId_k__BackingField, 0LL);
    if ( *(_DWORD *)(v4 + 24) <= 4u
      || (*(_QWORD *)(v4 + 64) = v5,
          sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v4 + 64), (int32_t)v5, v15, v16),
...
LABEL_13:
    ...
    *(_QWORD *)(v4 + 72) = v5;
    sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v4 + 72), (int32_t)v5, v17, v18);
    UniqueKey = ServantAssetArgs__GenerateUniqueKey(v19, (System_String_array *)v4, v20);
    *p_uniqueKey = UniqueKey;
    sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.uniqueKey, (int32_t)UniqueKey, v22, v23);
  }
  return *p_uniqueKey;
}
