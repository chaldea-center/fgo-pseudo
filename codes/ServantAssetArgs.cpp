...
void ServantAssetArgs___ctor_47403032(
...
System_String_o *ServantAssetArgs__GenerateUniqueKey(System_String_array *para, const MethodInfo *method)
{
  ...
  return System_String__Join((System_String_o *)StringLiteral_16207/*"_"*/, para, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( svtData && !svtData->fields.isEnemy )
  {
    ...
    BattlePointEntities = (ServantBattlePointMaster_o *)DataManager__GetMaster_object_((const MethodInfo_31A49E8 *)Method_DataManager_GetMaster_ServantBattlePointMaster___);
    if ( !BattlePointEntities
      || (BattlePointEntities = (ServantBattlePointMaster_o *)ServantBattlePointMaster__GetBattlePointEntities(
                                                                ...
                                                                0)) == 0 )
    {
      sub_1C93D2C(BattlePointEntities, v7);
    }
...
LABEL_20:
      ...
      {
LABEL_27:
        v22 = sub_1C69E5C(v14, System_Collections_Generic_IEnumerator_ServantBattlePointEntity__TypeInfo, 0);
      }
             ...
             (const MethodInfo_34632C0 *)Method_DataMasterBase_BattlePointMaster__BattlePointEntity__int__TryGetEntity__) )
      {
        ...
        {
          if ( !entity )
            sub_1C93D2C(IsHideBattlePointGauge, v27);
    ...
    {
LABEL_40:
      v31 = sub_1C69E5C(v14, System_IDisposable_TypeInfo, 0);
    }
...
System_String_o *ServantAssetArgs__get_UniqueKey(ServantAssetArgs_o *this, const MethodInfo *method)
{
  ...
  {
    v4 = sub_1C93B7C(string___TypeInfo, 6);
    ...
    *(_QWORD *)(v4 + 32) = v5;
    ...
    if ( *(_DWORD *)(v4 + 24) <= 1u )
      goto LABEL_13;
    *(_QWORD *)(v4 + 40) = v5;
    sub_1C93A78((GrandQuestFolderBoardItem_o *)(v4 + 40), (int32_t)v5, v13, v14, v15, v16, v17, v18);
    SvtId_k__BackingField = this->fields._DispImageSvtId_k__BackingField;
    v5 = System_Int32__ToString((int32_t)&SvtId_k__BackingField, 0);
    if ( *(_DWORD *)(v4 + 24) <= 2u )
      goto LABEL_13;
    *(_QWORD *)(v4 + 48) = v5;
    sub_1C93A78((GrandQuestFolderBoardItem_o *)(v4 + 48), (int32_t)v5, v19, v20, v21, v22, v23, v24);
    SvtId_k__BackingField = this->fields._DispLimitCount_k__BackingField;
    v5 = System_Int32__ToString((int32_t)&SvtId_k__BackingField, 0);
    if ( *(_DWORD *)(v4 + 24) <= 3u )
      goto LABEL_13;
    *(_QWORD *)(v4 + 56) = v5;
    sub_1C93A78((GrandQuestFolderBoardItem_o *)(v4 + 56), (int32_t)v5, v25, v26, v27, v28, v29, v30);
    SvtId_k__BackingField = this->fields._OverwriteSvtVoiceId_k__BackingField;
    v5 = System_Int32__ToString((int32_t)&SvtId_k__BackingField, 0);
    if ( *(_DWORD *)(v4 + 24) <= 4u
      || (*(_QWORD *)(v4 + 64) = v5,
          sub_1C93A78((GrandQuestFolderBoardItem_o *)(v4 + 64), (int32_t)v5, v31, v32, v33, v34, v35, v36),
...
LABEL_13:
    ...
    *(_QWORD *)(v4 + 72) = v5;
    sub_1C93A78((GrandQuestFolderBoardItem_o *)(v4 + 72), (int32_t)v5, v37, v38, v39, v40, v41, v42);
