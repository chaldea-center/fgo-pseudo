void __fastcall ServantStatusFlavorTextListViewItemDrawText2___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B18C18 & 1) == 0 )
  {
    sub_1BCAFF8(&ServantStatusFlavorTextListViewItemDrawText2_TypeInfo, v1);
    sub_1BCAFF8(&StringLiteral_20234/*"img_index_03"*/, v4);
    sub_1BCAFF8(&StringLiteral_20233/*"img_index_02"*/, v5);
    byte_4B18C18 = 1;
  }
  ...
  *(_QWORD *)&static_fields->LABEL_HEIGHT_MAX = 0xA800000BB8LL;
  ...
  v7 = StringLiteral_20233/*"img_index_02"*/;
  static_fields->TITLE_BASE_SPRITE_NAME = (struct System_String_o *)StringLiteral_20233/*"img_index_02"*/;
  sub_1BCAF9C((CGThumbnailListItem_o *)&static_fields->TITLE_BASE_SPRITE_NAME, v7, v2, v3);
  v8 = StringLiteral_20234/*"img_index_03"*/;
  v9 = ServantStatusFlavorTextListViewItemDrawText2_TypeInfo->static_fields;
  v9->TITLE_BASE_LONG_SPRITE_NAME = (struct System_String_o *)StringLiteral_20234/*"img_index_03"*/;
  sub_1BCAF9C((CGThumbnailListItem_o *)&v9->TITLE_BASE_LONG_SPRITE_NAME, v8, v10, v11);
}
        ...
        const MethodInfo *method)
{
  ...
  ShiningIconComponent__Set_40206624(newIcon, 0, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18C17 & 1) == 0 )
  {
    sub_1BCAFF8(&ServantStatusFlavorTextListViewItemDrawText2_TypeInfo, title);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18C16 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&RubyLabelHelper_TypeInfo, v15);
    sub_1BCAFF8(&ServantStatusFlavorTextListViewItemDrawText2_TypeInfo, v16);
    sub_1BCAFF8(&StringLiteral_20513/*"img_txt_profile"*/, v17);
    byte_4B18C16 = 1;
  }
  ...
  if ( item && mode && this->fields.isFirst )
  {
    ...
    if ( ((unsigned __int8)transform & 1) != 0 )
    {
      if ( profileNum >= 1 && this->fields.profileNumMax >= profileNum )
      {
        ...
        transform = System_String__Concat_62450424((System_String_o *)StringLiteral_20513/*"img_txt_profile"*/, v23, 0LL);
        if ( !v22 )
          goto LABEL_57;
    ...
    v30 = (RubyLabelHelper_o *)sub_1BCB244(RubyLabelHelper_TypeInfo);
...
LABEL_57:
    ...
    if ( UnityEngine_Object__op_Inequality(newIcon, 0LL, 0LL) )
    {
      ...
      if ( transform )
      {
        ShiningIconComponent__Set_40206624((ShiningIconComponent_o *)transform, isNew, 0LL);
        return;
      }
      goto LABEL_57;
    }
