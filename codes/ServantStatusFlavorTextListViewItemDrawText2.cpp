void __fastcall ServantStatusFlavorTextListViewItemDrawText2___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB26C6 & 1) == 0 )
  {
    sub_1BAB41C(&ServantStatusFlavorTextListViewItemDrawText2_TypeInfo, v1);
    sub_1BAB41C(&StringLiteral_20358/*"img_index_03"*/, v4);
    sub_1BAB41C(&StringLiteral_20357/*"img_index_02"*/, v5);
    byte_4AB26C6 = 1;
  }
  ...
  *(_QWORD *)&static_fields->LABEL_HEIGHT_MAX = 0xA800000BB8LL;
  ...
  v7 = StringLiteral_20357/*"img_index_02"*/;
  static_fields->TITLE_BASE_SPRITE_NAME = (struct System_String_o *)StringLiteral_20357/*"img_index_02"*/;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&static_fields->TITLE_BASE_SPRITE_NAME, v7, v2, v3);
  v8 = StringLiteral_20358/*"img_index_03"*/;
  v9 = ServantStatusFlavorTextListViewItemDrawText2_TypeInfo->static_fields;
  v9->TITLE_BASE_LONG_SPRITE_NAME = (struct System_String_o *)StringLiteral_20358/*"img_index_03"*/;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&v9->TITLE_BASE_LONG_SPRITE_NAME, v8, v10, v11);
}
        ...
        const MethodInfo *method)
{
  ...
  ShiningIconComponent__Set_38614928(newIcon, 0, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB26C5 & 1) == 0 )
  {
    sub_1BAB41C(&ServantStatusFlavorTextListViewItemDrawText2_TypeInfo, title);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB26C4 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&RubyLabelHelper_TypeInfo, v15);
    sub_1BAB41C(&ServantStatusFlavorTextListViewItemDrawText2_TypeInfo, v16);
    sub_1BAB41C(&StringLiteral_20601/*"img_txt_profile"*/, v17);
    byte_4AB26C4 = 1;
  }
  ...
  if ( item && mode && this->fields.isFirst )
  {
    ...
    if ( ((unsigned __int8)transform & 1) != 0 )
    {
      if ( profileNum >= 1 && this->fields.profileNumMax >= profileNum )
      {
        ...
        transform = System_String__Concat_62048128((System_String_o *)StringLiteral_20601/*"img_txt_profile"*/, v23, 0LL);
        if ( !v22 )
          goto LABEL_57;
    ...
    v30 = (RubyLabelHelper_o *)sub_1BAB668(RubyLabelHelper_TypeInfo);
...
LABEL_57:
    ...
    if ( UnityEngine_Object__op_Inequality(newIcon, 0LL, 0LL) )
    {
      ...
      if ( transform )
      {
        ShiningIconComponent__Set_38614928((ShiningIconComponent_o *)transform, isNew, 0LL);
        return;
      }
      goto LABEL_57;
    }
