void __fastcall ServantStatusFlavorTextListViewItemDrawText2___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B633D0 & 1) == 0 )
  {
    sub_1BE4ACC(&ServantStatusFlavorTextListViewItemDrawText2_TypeInfo, v1);
    sub_1BE4ACC(&StringLiteral_20616/*"img_index_03"*/, v8);
    sub_1BE4ACC(&StringLiteral_20615/*"img_index_02"*/, v9);
    byte_4B633D0 = 1;
  }
  ...
  *(_QWORD *)&static_fields->LABEL_HEIGHT_MAX = 0xA800000BB8LL;
  ...
  v11 = StringLiteral_20615/*"img_index_02"*/;
  static_fields->TITLE_BASE_SPRITE_NAME = (struct System_String_o *)StringLiteral_20615/*"img_index_02"*/;
  sub_1BE4A70((PartyOrganizationUtility_o *)&static_fields->TITLE_BASE_SPRITE_NAME, v11, v2, v3, v4, v5, v6, v7);
  v12 = StringLiteral_20616/*"img_index_03"*/;
  v13 = ServantStatusFlavorTextListViewItemDrawText2_TypeInfo->static_fields;
  v13->TITLE_BASE_LONG_SPRITE_NAME = (struct System_String_o *)StringLiteral_20616/*"img_index_03"*/;
  sub_1BE4A70((PartyOrganizationUtility_o *)&v13->TITLE_BASE_LONG_SPRITE_NAME, v12, v14, v15, v16, v17, v18, v19);
}
        ...
        const MethodInfo *method)
{
  ...
  ShiningIconComponent__Set_39139932(newIcon, 0, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B633CF & 1) == 0 )
  {
    sub_1BE4ACC(&ServantStatusFlavorTextListViewItemDrawText2_TypeInfo, title);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B633CE & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&RubyLabelHelper_TypeInfo, v15);
    sub_1BE4ACC(&ServantStatusFlavorTextListViewItemDrawText2_TypeInfo, v16);
    sub_1BE4ACC(&StringLiteral_20862/*"img_txt_profile"*/, v17);
    byte_4B633CE = 1;
  }
  ...
  if ( item && mode && this->fields.isFirst )
  {
    ...
    if ( ((unsigned __int8)transform & 1) != 0 )
    {
      if ( profileNum >= 1 && this->fields.profileNumMax >= profileNum )
      {
        ...
        transform = System_String__Concat_62698808((System_String_o *)StringLiteral_20862/*"img_txt_profile"*/, v23, 0LL);
        if ( !v22 )
          goto LABEL_57;
    ...
    v30 = (RubyLabelHelper_o *)sub_1BE4D18(RubyLabelHelper_TypeInfo);
...
LABEL_57:
    ...
    if ( UnityEngine_Object__op_Inequality(newIcon, 0LL, 0LL) )
    {
      ...
      if ( transform )
      {
        ShiningIconComponent__Set_39139932((ShiningIconComponent_o *)transform, isNew, 0LL);
        return;
      }
      goto LABEL_57;
    }
