...
void __fastcall SpotEntity___ctor_41244568(SpotEntity_o *this, SpotEntity_o *cSrc, const MethodInfo *method)
{
  __int64 v5; // x0
  __int64 v6; // x1
  int64_t v7; // x2
  ...
  *(_OWORD *)&this->fields.dispTargetId2 = *(_OWORD *)&cSrc->fields.dispTargetId2;
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)p_joinSpotIds, (int64_t)joinSpotIds, v23, v24, v25, v26, v27, v28);
...
int32_t __fastcall SpotEntity__GetPrioredImgId(SpotEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDD033 & 1) == 0 )
  {
    sub_1C21E38(&Method_DataManager_GetMasterData_SpotImageMaster___);
    sub_1C21E38(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    sub_1C21E38(&Method_SingletonTemplate_QuestTree__get_Instance__);
    byte_4BDD033 = 1;
  }
  Instance = (SpotImageEntity_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_388D058 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance
    || (Instance = (SpotImageEntity_array *)DataManager__GetMasterData_object_(
                                              (DataManager_o *)Instance,
                                              (const MethodInfo_2FAFE04 *)Method_DataManager_GetMasterData_SpotImageMaster___)) == 0LL
...
LABEL_13:
  ...
  else
  {
    ...
    while ( 1 )
    {
      ...
      Instance = (SpotImageEntity_array *)SingletonTemplate_object___get_Instance((const MethodInfo_388D478 *)Method_SingletonTemplate_QuestTree__get_Instance__);
      if ( !v9 || !Instance )
        goto LABEL_16;
...
bool __fastcall SpotEntity__HasFlag(SpotEntity_o *this, int32_t flag, const MethodInfo *method)
{
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_2FAFE04 *)Method_DataManager_GetMasterData_SpotAddMaster___)) == 0LL )
  {
...
bool __fastcall SpotEntity__IsOverRideName(SpotEntity_o *this, System_String_o **spotName, const MethodInfo *method)
{
  ...
  if ( (byte_4BDD02F & 1) == 0 )
  {
    sub_1C21E38(&Method_DataManager_GetMaster_SpotAddMaster___);
    sub_1C21E38(&DataManager_TypeInfo);
    byte_4BDD02F = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2FAFDB0 *)Method_DataManager_GetMaster_SpotAddMaster___);
  if ( !Master_object )
    sub_1C22094(0LL, v6);
