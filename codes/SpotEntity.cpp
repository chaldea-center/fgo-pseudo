...
void __fastcall SpotEntity___ctor_40367008(SpotEntity_o *this, SpotEntity_o *cSrc, const MethodInfo *method)
{
  __int64 v5; // x0
  __int64 v6; // x1
  int32_t v7; // w2
  ...
  *(_OWORD *)&this->fields.dispTargetId2 = *(_OWORD *)&cSrc->fields.dispTargetId2;
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.closedMessage, (int32_t)closedMessage, v11, v12);
  joinSpotIds = cSrc->fields.joinSpotIds;
  this->fields.joinSpotIds = joinSpotIds;
  p_joinSpotIds = &this->fields.joinSpotIds;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)p_joinSpotIds, (int32_t)joinSpotIds, v15, v16);
...
int32_t __fastcall SpotEntity__GetPrioredImgId(SpotEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB67EA & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMasterData_SpotImageMaster___, method);
  ...
  Instance = (SpotImageEntity_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_378A22C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance
    || (Instance = (SpotImageEntity_array *)DataManager__GetMasterData_object_(
                                              (DataManager_o *)Instance,
                                              (const MethodInfo_2EC55C8 *)Method_DataManager_GetMasterData_SpotImageMaster___)) == 0LL
...
LABEL_13:
  ...
  else
  {
    ...
    while ( 1 )
    {
      ...
      Instance = (SpotImageEntity_array *)SingletonTemplate_object___get_Instance((const MethodInfo_378A64C *)Method_SingletonTemplate_QuestTree__get_Instance__);
      if ( !v11 || !Instance )
        goto LABEL_16;
...
bool __fastcall SpotEntity__HasFlag(SpotEntity_o *this, int32_t flag, const MethodInfo *method)
{
  ...
  if ( (byte_4AB67E9 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMasterData_SpotAddMaster___, *(_QWORD *)&flag);
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_2EC55C8 *)Method_DataManager_GetMasterData_SpotAddMaster___)) == 0LL )
  {
...
bool __fastcall SpotEntity__IsOverRideName(SpotEntity_o *this, System_String_o **spotName, const MethodInfo *method)
{
  ...
  if ( (byte_4AB67E6 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMaster_SpotAddMaster___, spotName);
    sub_1BAB41C(&DataManager_TypeInfo, v5);
    byte_4AB67E6 = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2EC5574 *)Method_DataManager_GetMaster_SpotAddMaster___);
  if ( !Master_object )
    sub_1BAB678(0LL, v7);
...
int32_t __fastcall SpotEntity__get_z(SpotEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB67E5 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_DataMasterBase_SpotLayerMaster__SpotLayerEntity__int__TryGetEntity__, v4);
    byte_4AB67E5 = 1;
  }
  entity = 0LL;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
