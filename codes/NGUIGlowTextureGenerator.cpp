        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CCAF6E & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_16178/*"_ColorStrength"*/);
  ...
  *(_QWORD *)&this->fields.sigma = 0x3F80000041200000LL;
  ...
  sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields, (int32_t)maskSprite, v9, v10, v11, v12, v13, v14);
  this->fields.glowCompute = glowCompute;
  sub_1C71354(
    (GrandQuestFolderBoardItem_o *)&this->fields.glowCompute,
    (int32_t)glowCompute,
    v15,
    v16,
    v17,
  ...
  sub_1C71354((GrandQuestFolderBoardItem_o *)p_glowMaterial, (int32_t)glowMaterial, v22, v23, v24, v25, v26, v27);
  *((_DWORD *)p_glowMaterial + 2) = UnityEngine_Shader__PropertyToID((System_String_o *)StringLiteral_16346/*"_Sigma"*/, 0);
  *((_DWORD *)p_glowMaterial + 3) = UnityEngine_Shader__PropertyToID((System_String_o *)StringLiteral_16249/*"_Intensity"*/, 0);
  *((_DWORD *)p_glowMaterial + 4) = UnityEngine_Shader__PropertyToID((System_String_o *)StringLiteral_16255/*"_KernelSize"*/, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CCAF70 & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_9817/*"Offset"*/);
    sub_1C713B0(&StringLiteral_7693/*"InputTexture"*/);
    sub_1C713B0(&StringLiteral_12900/*"Size"*/);
    sub_1C713B0(&StringLiteral_4488/*"ClearColor"*/);
      ...
      if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)renderTexture, 0, 0) )
      {
        ...
        if ( Kernel )
        {
          Kernel = UnityEngine_ComputeShader__FindKernel(
                     ...
                     (System_String_o *)StringLiteral_4488/*"ClearColor"*/,
                     0);
            ...
            if ( renderTexture )
            {
              ...
              if ( v10 )
              {
                ...
                if ( Kernel )
                {
                  Kernel = UnityEngine_ComputeShader__FindKernel(
                             (UnityEngine_ComputeShader_o *)Kernel,
                             (System_String_o *)StringLiteral_3927/*"CSMain"*/,
                             0);
                  if ( this->fields.glowCompute )
                  {
                    v18 = Kernel;
                      ...
                      if ( Kernel )
                      {
                        ...
                        if ( this->fields.glowCompute )
                        {
                          UnityEngine_ComputeShader__SetTexture_71732204(
                            this->fields.glowCompute,
                            v18,
                            (System_String_o *)StringLiteral_7693/*"InputTexture"*/,
                          ...
                          if ( Kernel )
                          {
                            ...
                            if ( AtlasSprite )
                            {
                              ...
                              v21 = (int *)AtlasSprite;
                              Kernel = sub_1C71458(float___TypeInfo, 2);
                              if ( !Kernel )
                                goto LABEL_63;
                              ...
                              *(float *)(Kernel + 36) = (float)v21[7];
                              ...
                              UnityEngine_ComputeShader__SetFloats(
                                v20,
                                (System_String_o *)StringLiteral_9817/*"Offset"*/,
...
LABEL_64:
                              ...
                              *(float *)(Kernel + 36) = (float)v21[9];
                              ...
                              UnityEngine_ComputeShader__SetFloats(
                                v23,
                                (System_String_o *)StringLiteral_12900/*"Size"*/,
                                (System_Single_array *)Kernel,
                                0);
                            }
        ...
        const MethodInfo *method)
{
  ...
  if ( !glowMaterial )
    goto LABEL_12;
  UnityEngine_Material__SetFloat_71593676(glowMaterial, this->fields.SigmaProperty, this->fields.sigma, 0);
  glowMaterial = this->fields.glowMaterial;
  if ( !glowMaterial
    ...
    || (UnityEngine_Material__SetInt_71593464(glowMaterial, this->fields.KernelSizeProperty, this->fields.kernelSize, 0),
        (glowMaterial = this->fields.glowMaterial) == 0)
    || (UnityEngine_Material__SetColor_71588072(glowMaterial, this->fields.GlowColorProperty, this->fields.glowColor, 0),
        (glowMaterial = this->fields.glowMaterial) == 0)
    || (UnityEngine_Material__SetFloat_71593676(
          glowMaterial,
  ...
  {
LABEL_12:
    sub_1C71608(glowMaterial, renderTexture);
  }
  ...
  *(_OWORD *)&v13.fields._shadowSamplingMode_k__BackingField = *(_OWORD *)((char *)v18 + 12);
  ...
  UnityEngine_Graphics__Blit_71569372((UnityEngine_Texture_o *)renderTexture, v9, v11, 1, 0);
  UnityEngine_Graphics__Blit_71569372((UnityEngine_Texture_o *)v9, v12, this->fields.glowMaterial, 0, 0);
  UnityEngine_Graphics__Blit_71569372((UnityEngine_Texture_o *)v12, v9, this->fields.glowMaterial, 1, 0);
  UnityEngine_Graphics__Blit_71569372((UnityEngine_Texture_o *)v9, Temporary, this->fields.glowMaterial, 2, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CCAF6F & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_7116/*"Glow NGUITexture"*/);
    byte_4CCAF6F = 1;
  }
  v5 = (UnityEngine_RenderTexture_o *)sub_1C715FC(UnityEngine_RenderTexture_TypeInfo);
  UnityEngine_RenderTexture___ctor_71630968(v5, width, height, 0, 0);
  if ( !v5 )
    sub_1C71608(v6, v7);
  UnityEngine_RenderTexture__set_enableRandomWrite(v5, 1, 0);
  UnityEngine_Object__set_name((UnityEngine_Object_o *)v5, (System_String_o *)StringLiteral_7116/*"Glow NGUITexture"*/, 0);
