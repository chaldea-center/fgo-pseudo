        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFE6C0 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_16329/*"_ColorStrength"*/);
  ...
  *(_QWORD *)&this->fields.sigma = 0x3F80000041200000LL;
  ...
  sub_1CE66A4(&this->fields, maskSprite);
  this->fields.glowCompute = glowCompute;
  sub_1CE66A4(&this->fields.glowCompute, glowCompute);
  this->fields.glowMaterial = glowMaterial;
  p_glowMaterial = &this->fields.glowMaterial;
  sub_1CE66A4(p_glowMaterial, glowMaterial);
  *((_DWORD *)p_glowMaterial + 2) = UnityEngine_Shader__PropertyToID((System_String_o *)StringLiteral_16498/*"_Sigma"*/, 0);
  *((_DWORD *)p_glowMaterial + 3) = UnityEngine_Shader__PropertyToID((System_String_o *)StringLiteral_16400/*"_Intensity"*/, 0);
  *((_DWORD *)p_glowMaterial + 4) = UnityEngine_Shader__PropertyToID((System_String_o *)StringLiteral_16406/*"_KernelSize"*/, 0);
  *((_DWORD *)p_glowMaterial + 5) = UnityEngine_Shader__PropertyToID((System_String_o *)StringLiteral_16324/*"_Color"*/, 0);
  *((_DWORD *)p_glowMaterial + 6) = UnityEngine_Shader__PropertyToID((System_String_o *)StringLiteral_16329/*"_ColorStrength"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFE6C2 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_9892/*"Offset"*/);
    sub_1CE6700(&StringLiteral_7752/*"InputTexture"*/);
    sub_1CE6700(&StringLiteral_13025/*"Size"*/);
    sub_1CE6700(&StringLiteral_4525/*"ClearColor"*/);
      ...
      if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)renderTexture, 0, 0) )
      {
        ...
        if ( Kernel )
        {
          Kernel = UnityEngine_ComputeShader__FindKernel(
                     ...
                     (System_String_o *)StringLiteral_4525/*"ClearColor"*/,
                     0);
                      ...
                      if ( Kernel )
                      {
                        ...
                        if ( this->fields.glowCompute )
                        {
                          UnityEngine_ComputeShader__SetTexture_72926136(
                            this->fields.glowCompute,
                            v18,
                            (System_String_o *)StringLiteral_7752/*"InputTexture"*/,
                          ...
                          if ( Kernel )
                          {
                            ...
                            if ( AtlasSprite )
                            {
                              ...
                              v21 = (int *)AtlasSprite;
                              Kernel = sub_1CE67A8(float___TypeInfo, 2);
                              if ( !Kernel )
                                goto LABEL_63;
                              ...
                              *(float *)(Kernel + 36) = (float)v21[7];
                              ...
                              UnityEngine_ComputeShader__SetFloats(
                                v20,
                                (System_String_o *)StringLiteral_9892/*"Offset"*/,
...
LABEL_64:
                              ...
                              *(float *)(Kernel + 36) = (float)v21[9];
                              ...
                              UnityEngine_ComputeShader__SetFloats(
                                v23,
                                (System_String_o *)StringLiteral_13025/*"Size"*/,
                                (System_Single_array *)Kernel,
                                0);
                            }
        ...
        const MethodInfo *method)
{
  ...
  if ( !glowMaterial )
    goto LABEL_12;
  UnityEngine_Material__SetFloat_72787608(glowMaterial, this->fields.SigmaProperty, this->fields.sigma, 0);
  glowMaterial = this->fields.glowMaterial;
  if ( !glowMaterial
    ...
    || (UnityEngine_Material__SetInt_72787396(glowMaterial, this->fields.KernelSizeProperty, this->fields.kernelSize, 0),
        (glowMaterial = this->fields.glowMaterial) == 0)
    || (UnityEngine_Material__SetColor_72782004(glowMaterial, this->fields.GlowColorProperty, this->fields.glowColor, 0),
        (glowMaterial = this->fields.glowMaterial) == 0)
    || (UnityEngine_Material__SetFloat_72787608(
          glowMaterial,
  ...
  {
LABEL_12:
    sub_1CE6958(glowMaterial, renderTexture);
  }
  ...
  *(_OWORD *)&v13.fields._shadowSamplingMode_k__BackingField = *(_OWORD *)((char *)v18 + 12);
  ...
  UnityEngine_Graphics__Blit_72763304((UnityEngine_Texture_o *)renderTexture, v9, v11, 1, 0);
  UnityEngine_Graphics__Blit_72763304((UnityEngine_Texture_o *)v9, v12, this->fields.glowMaterial, 0, 0);
  UnityEngine_Graphics__Blit_72763304((UnityEngine_Texture_o *)v12, v9, this->fields.glowMaterial, 1, 0);
  UnityEngine_Graphics__Blit_72763304((UnityEngine_Texture_o *)v9, Temporary, this->fields.glowMaterial, 2, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFE6C1 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_7172/*"Glow NGUITexture"*/);
    byte_4DFE6C1 = 1;
  }
  v5 = (UnityEngine_RenderTexture_o *)sub_1CE694C(UnityEngine_RenderTexture_TypeInfo);
  UnityEngine_RenderTexture___ctor_72824900(v5, width, height, 0, 0);
  if ( !v5 )
    sub_1CE6958(v6, v7);
  UnityEngine_RenderTexture__set_enableRandomWrite(v5, 1, 0);
  UnityEngine_Object__set_name((UnityEngine_Object_o *)v5, (System_String_o *)StringLiteral_7172/*"Glow NGUITexture"*/, 0);
