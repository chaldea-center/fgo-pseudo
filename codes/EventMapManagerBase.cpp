...
void __fastcall EventMapManagerBase__Finish(EventMapManagerBase_o *this, const MethodInfo *method)
{
  ...
  sub_B77560((BattleServantConfConponent_o *)&this->fields.terminalMap, 0LL, v3, v4, v5, v6, v7, v8);
  this->fields.mapCamera = 0LL;
  sub_B77560((BattleServantConfConponent_o *)&this->fields.mapCamera, 0LL, v9, v10, v11, v12, v13, v14);
  this->fields.rootRoadP = 0LL;
  sub_B77560((BattleServantConfConponent_o *)&this->fields.rootRoadP, 0LL, v15, v16, v17, v18, v19, v20);
  this->fields.rootSpotP = 0LL;
  sub_B77560((BattleServantConfConponent_o *)&this->fields.rootSpotP, 0LL, v21, v22, v23, v24, v25, v26);
  this->fields.rootPathP = 0LL;
  sub_B77560((BattleServantConfConponent_o *)&this->fields.rootPathP, 0LL, v27, v28, v29, v30, v31, v32);
  this->fields.rootGimmickP = 0LL;
  sub_B77560((BattleServantConfConponent_o *)&this->fields.rootGimmickP, 0LL, v33, v34, v35, v36, v37, v38);
  this->fields.rootEffectP = 0LL;
  sub_B77560((BattleServantConfConponent_o *)&this->fields.rootEffectP, 0LL, v39, v40, v41, v42, v43, v44);
  this->fields.warInfo = 0LL;
  sub_B77560((BattleServantConfConponent_o *)&this->fields.warInfo, 0LL, v45, v46, v47, v48, v49, v50);
  this->fields.mapInfo = 0LL;
  sub_B77560((BattleServantConfConponent_o *)&this->fields.mapInfo, 0LL, v51, v52, v53, v54, v55, v56);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_438C683 & 1) == 0 )
  {
    this = (EventMapManagerBase_o *)sub_B775C4(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_438C683 = 1;
  }
  if ( !v4
    || ((touchBlockNum = v4->fields.touchBlockNum, value) ? (v6 = 1) : (v6 = -1),
        v4->fields.touchBlockNum = touchBlockNum + v6,
        v4->fields.touchBlockNum = UnityEngine_Mathf__Max_41473772(touchBlockNum + v6, 0, 0LL),
        (this = (EventMapManagerBase_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2D1653C *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__)) == 0LL) )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_438C684 & 1) == 0 )
  {
    this = (EventMapManagerBase_o *)sub_B775C4(&UnityEngine_Object_TypeInfo);
    byte_438C684 = 1;
  }
  if ( !v4 )
    goto LABEL_14;
  ...
  v4->fields.cameraWorkBlockNum = UnityEngine_Mathf__Max_41473772(cameraWorkBlockNum + v6, 0, 0LL);
