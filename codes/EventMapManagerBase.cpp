...
void EventMapManagerBase__SetCameraWorkBlock(EventMapManagerBase_o *this, bool value, const MethodInfo *method)
{
  ...
  if ( v5 )
    v9 = cameraWorkBlockNum - 1;
  else
    v9 = cameraWorkBlockNum + 1;
  v10 = *(&UnityEngine_Object_TypeInfo->_2.cctor_finished + 1);
  v4->fields.cameraWorkBlockNum = v9 & ~(v9 >> 31);
  if ( !v10 )
    j_il2cpp_runtime_class_init_0(v8, value, method);
  this = (EventMapManagerBase_o *)UnityEngine_Object__op_Inequality(mapCamera, 0, 0);
  if ( ((unsigned __int8)this & 1) != 0 )
  {
    v11 = v4->fields.mapCamera;
    if ( v11 )
    {
      v11->fields._IsTouchEnable_k__BackingField = v4->fields.cameraWorkBlockNum < 1;
      return;
    }
LABEL_13:
    sub_21FFECC(this, value);
