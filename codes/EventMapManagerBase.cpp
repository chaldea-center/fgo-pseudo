...
void EventMapManagerBase__Finish(EventMapManagerBase_o *this, const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.terminalMap, 0, v3, v4);
  this->fields.mapCamera = 0;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.mapCamera, 0, v5, v6);
  this->fields.rootRoadP = 0;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.rootRoadP, 0, v7, v8);
  this->fields.rootSpotP = 0;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.rootSpotP, 0, v9, v10);
  this->fields.rootPathP = 0;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.rootPathP, 0, v11, v12);
  this->fields.rootGimmickP = 0;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.rootGimmickP, 0, v13, v14);
  this->fields.rootEffectP = 0;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.rootEffectP, 0, v15, v16);
  this->fields.warInfo = 0;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.warInfo, 0, v17, v18);
  this->fields.mapInfo = 0;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.mapInfo, 0, v19, v20);
}
...
void EventMapManagerBase__SetAllTouchBlock(EventMapManagerBase_o *this, bool value, const MethodInfo *method)
{
  ...
  if ( (byte_4C342F2 & 1) == 0 )
  {
    this = (EventMapManagerBase_o *)sub_1C32C20(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4C342F2 = 1;
  }
  if ( !v4
    || (value ? (v5 = 1) : (v5 = -1),
        v4->fields.touchBlockNum = (v4->fields.touchBlockNum + v5) & ~((v4->fields.touchBlockNum + v5) >> 31),
        (this = (EventMapManagerBase_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39E2904 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__)) == 0) )
  {
    sub_1C32E7C(this);
  }
...
void EventMapManagerBase__SetCameraWorkBlock(EventMapManagerBase_o *this, bool value, const MethodInfo *method)
{
  ...
  if ( (byte_4C342F3 & 1) == 0 )
  {
    this = (EventMapManagerBase_o *)sub_1C32C20(&UnityEngine_Object_TypeInfo);
    byte_4C342F3 = 1;
  }
  if ( !v4 )
    goto LABEL_13;
        ...
        const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.mapInfo, (int32_t)mapInfo, v18, v19);
  this->fields.warInfo = warInfo;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.warInfo, (int32_t)warInfo, v20, v21);
  this->fields.mapCamera = mapCamera;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.mapCamera, (int32_t)mapCamera, v22, v23);
  this->fields.rootEffectP = rootEffectP;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.rootEffectP, (int32_t)rootEffectP, v24, v25);
  this->fields.rootGimmickP = rootGimmickP;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.rootGimmickP, (int32_t)rootGimmickP, v26, v27);
  this->fields.rootPathP = rootPathP;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.rootPathP, (int32_t)rootPathP, v28, v29);
  this->fields.rootRoadP = rootRoadP;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.rootRoadP, (int32_t)rootRoadP, v30, v31);
  this->fields.rootSpotP = rootSpotP;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.rootSpotP, (int32_t)rootSpotP, v32, v33);
}