...
void __fastcall EventMapManagerBase__Finish(EventMapManagerBase_o *this, const MethodInfo *method)
{
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.terminalMap, 0LL, v3, v4, v5, v6, v7, v8);
  this->fields.mapCamera = 0LL;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.mapCamera, 0LL, v9, v10, v11, v12, v13, v14);
  this->fields.rootRoadP = 0LL;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.rootRoadP, 0LL, v15, v16, v17, v18, v19, v20);
  this->fields.rootSpotP = 0LL;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.rootSpotP, 0LL, v21, v22, v23, v24, v25, v26);
  this->fields.rootPathP = 0LL;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.rootPathP, 0LL, v27, v28, v29, v30, v31, v32);
  this->fields.rootGimmickP = 0LL;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.rootGimmickP, 0LL, v33, v34, v35, v36, v37, v38);
  this->fields.rootEffectP = 0LL;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.rootEffectP, 0LL, v39, v40, v41, v42, v43, v44);
  this->fields.warInfo = 0LL;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.warInfo, 0LL, v45, v46, v47, v48, v49, v50);
  this->fields.mapInfo = 0LL;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.mapInfo, 0LL, v51, v52, v53, v54, v55, v56);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD904D & 1) == 0 )
  {
    this = (EventMapManagerBase_o *)sub_1C21E38(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4BD904D = 1;
  }
  if ( !v4
    || (value ? (v5 = 1) : (v5 = -1),
        v4->fields.touchBlockNum = (v4->fields.touchBlockNum + v5) & ~((v4->fields.touchBlockNum + v5) >> 31),
        (this = (EventMapManagerBase_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_388D058 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__)) == 0LL) )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD904E & 1) == 0 )
  {
    this = (EventMapManagerBase_o *)sub_1C21E38(&UnityEngine_Object_TypeInfo);
    byte_4BD904E = 1;
  }
  if ( !v4 )
    goto LABEL_13;
        ...
        const MethodInfo *method)
{
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.mapInfo, (int64_t)mapInfo, v18, v19, v20, v21, v22, v23);
  this->fields.warInfo = warInfo;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.warInfo, (int64_t)warInfo, v24, v25, v26, v27, v28, v29);
  this->fields.mapCamera = mapCamera;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.mapCamera, (int64_t)mapCamera, v30, v31, v32, v33, v34, v35);
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.rootPathP, (int64_t)rootPathP, v48, v49, v50, v51, v52, v53);
  this->fields.rootRoadP = rootRoadP;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.rootRoadP, (int64_t)rootRoadP, v54, v55, v56, v57, v58, v59);
  this->fields.rootSpotP = rootSpotP;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.rootSpotP, (int64_t)rootSpotP, v60, v61, v62, v63, v64, v65);
}