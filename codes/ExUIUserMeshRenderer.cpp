...
void __fastcall ExUIUserMeshRenderer__ClearUserMesh(ExUIUserMeshRenderer_o *this, const MethodInfo *method)
{
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)p_baseVertexs, 0, v2, v3);
  this->fields.baseUvs = 0LL;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.baseUvs, 0, v7, v8);
  this->fields.baseTriangles = 0LL;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.baseTriangles, 0, v9, v10);
...
void __fastcall ExUIUserMeshRenderer__ReScale(ExUIUserMeshRenderer_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FDFF5 & 1) == 0 )
  {
    ...
    sub_1B64A00(
      ...
      v4);
    sub_1B64A00(&UnityEngine_Vector2___TypeInfo, v5);
    sub_1B64A00(&UnityEngine_Vector3___TypeInfo, v6);
    byte_49FDFF5 = 1;
  }
  ...
  if ( v16 != this->fields.mWidth || v17 != this->fields.mHeight || this->fields.isChangeMesh )
  {
    ...
    {
      meshFilter = (struct UnityEngine_MeshFilter_o *)sub_1B64AA8(
      ...
      if ( !baseUvs )
        goto LABEL_64;
      meshFilter = (struct UnityEngine_MeshFilter_o *)sub_1B64AA8(UnityEngine_Vector2___TypeInfo, baseUvs->max_length);
    ...
    {
      meshFilter = (struct UnityEngine_MeshFilter_o *)sub_1B64AA8(UnityEngine_Vector3___TypeInfo, 4LL);
      if ( !meshFilter )
        goto LABEL_64;
...
LABEL_63:
      ...
      *((float *)&meshFilter[2].monitor + 1) = v44;
      ...
      if ( !this->fields.isUseUserMesh )
        goto LABEL_60;
      baseTriangles = (System_Array_o *)sub_1B64AA8(int___TypeInfo, 6LL);
      v51.fields.value = Field__PrivateImplementationDetails__DB96679C1D0C73505AD9AF543CB906F56E002FE26A9E2CD34DA2FF02F61EBB53;
      System_Runtime_CompilerServices_RuntimeHelpers__InitializeArray_61293216(baseTriangles, v51, 0LL);
    }
        ...
        const MethodInfo *method)
{
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.baseUvs, (int32_t)uvs, v8, v9);
  this->fields.baseTriangles = triangles;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.baseTriangles, (int32_t)triangles, v10, v11);
  klass = this->klass;
