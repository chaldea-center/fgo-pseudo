...
void __fastcall ExUIUserMeshRenderer__ClearUserMesh(ExUIUserMeshRenderer_o *this, const MethodInfo *method)
{
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)p_baseVertexs, 0LL, v2, v3, v4, v5, v6, v7);
  this->fields.baseUvs = 0LL;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.baseUvs, 0LL, v11, v12, v13, v14, v15, v16);
  this->fields.baseTriangles = 0LL;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.baseTriangles, 0LL, v17, v18, v19, v20, v21, v22);
...
void __fastcall ExUIUserMeshRenderer__ReScale(ExUIUserMeshRenderer_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B66032 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(
      ...
      v4);
    sub_1BE4ACC(&UnityEngine_Vector2___TypeInfo, v5);
    sub_1BE4ACC(&UnityEngine_Vector3___TypeInfo, v6);
    byte_4B66032 = 1;
  }
  ...
  if ( v16 != this->fields.mWidth || v17 != this->fields.mHeight || this->fields.isChangeMesh )
  {
    ...
    {
      meshFilter = (struct UnityEngine_MeshFilter_o *)sub_1BE4B74(
      ...
      if ( !baseUvs )
        goto LABEL_64;
      meshFilter = (struct UnityEngine_MeshFilter_o *)sub_1BE4B74(UnityEngine_Vector2___TypeInfo, baseUvs->max_length);
    ...
    {
      meshFilter = (struct UnityEngine_MeshFilter_o *)sub_1BE4B74(UnityEngine_Vector3___TypeInfo, 4LL);
      if ( !meshFilter )
        goto LABEL_64;
...
LABEL_63:
      ...
      *((float *)&meshFilter[2].monitor + 1) = v44;
      ...
      if ( !this->fields.isUseUserMesh )
        goto LABEL_60;
      baseTriangles = (System_Array_o *)sub_1BE4B74(int___TypeInfo, 6LL);
      v51.fields.value = Field__PrivateImplementationDetails__DB96679C1D0C73505AD9AF543CB906F56E002FE26A9E2CD34DA2FF02F61EBB53;
      System_Runtime_CompilerServices_RuntimeHelpers__InitializeArray_62606144(baseTriangles, v51, 0LL);
    }
        ...
        const MethodInfo *method)
{
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.baseUvs, (int64_t)uvs, v11, v12, v13, v14, v15, v16);
