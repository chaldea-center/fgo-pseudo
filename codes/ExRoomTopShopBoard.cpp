...
int64_t ExRoomTopShopBoard__GetDailyShopCloseTime(ExRoomTopShopBoard_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_5932DA9 & 1) == 0 )
  {
    ...
    this = (ExRoomTopShopBoard_o *)sub_21FFC50(&Method_System_Collections_Generic_List_ShopEntity__GetEnumerator__);
    byte_5932DA9 = 1;
  }
...
void ExRoomTopShopBoard__InitInfo(ExRoomTopShopBoard_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_5932DA7 & 1) == 0 )
  {
    ...
    this = (ExRoomTopShopBoard_o *)sub_21FFC50(&StringLiteral_18435/*"caldeagate_notice_00"*/);
    byte_5932DA7 = 1;
  }
  ...
  if ( !infoRoot )
    sub_21FFECC(DailyShopCloseTime, v4);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5932DA6 & 1) == 0 )
  {
    sub_21FFC50(&StringLiteral_18550/*"chaldea_category_1008"*/);
    byte_5932DA6 = 1;
  }
  ...
  if ( !topDisp
    ...
    || (AtlasManagerUnit__SetUI(
          ...
          (System_String_o *)StringLiteral_18550/*"chaldea_category_1008"*/,
          0),
        (exRoomAtlasManagerUnit = (AtlasManagerUnit_o *)this->fields.boardSprite) == 0) )
  {
    sub_21FFECC(exRoomAtlasManagerUnit, v11);
  }
