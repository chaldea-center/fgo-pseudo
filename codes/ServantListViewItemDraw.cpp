        ...
        const MethodInfo *method)
{
  ...
  if ( !item->fields.isEnabled )
  {
    ...
    if ( LocalizationManager_TypeInfo->_2.cctor_finished )
    {
      ...
      {
LABEL_48:
        v17 = &StringLiteral_11553/*"SELECT_SERVANT_EVENT_JOIN"*/;
LABEL_56:
        Component_object = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)*v17, 0);
        if ( !warningLabel )
          goto LABEL_78;
        v18 = (System_String_o *)Component_object;
        Component_object = (UnityEngine_Component_o *)warningLabel;
LABEL_58:
        UILabel__set_text((UILabel_o *)Component_object, v18, 0);
        goto LABEL_59;
      }
    }
    else
    ...
    v17 = &StringLiteral_11521/*"SELECT_CANNOT"*/;
    goto LABEL_56;
  }
LABEL_59:
  ...
  if ( UnityEngine_Object__op_Inequality(materialTdSprite, 0, 0) )
  {
    ...
    if ( item->fields.isMaterialTdSvt )
    {
      ...
      AtlasManager__SetEventSprite(v21, (System_String_o *)StringLiteral_23112/*"ribbon_noblephantasmup_01"*/, 0);
      if ( item->fields.isNeedAdjustIconLabelScale )
      {
        ...
        if ( Component_object )
        {
          ...
          v22.fields.y = 1.0;
          v22.fields.z = 1.0;
          ServantFaceIconComponent__AdjustIconLabelScale((ServantFaceIconComponent_o *)Component_object, v22, 0);
          return;
        }
LABEL_78:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3EFE9 & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_1/*""*/);
    sub_1C37058(&StringLiteral_20190/*"icon_equip_cc"*/);
    byte_4C3EFE9 = 1;
  }
  if ( !item || !mode )
    return;
  ...
  if ( UnityEngine_Object__op_Inequality(partyIcon, 0, 0) )
  {
    ...
    {
      v10 = item->fields.partyIndex >= 0;
      if ( !servantFaceIcon )
        goto LABEL_98;
    }
    FlashingIconComponent__Set_40901040((FlashingIconComponent_o *)servantFaceIcon, v10, 0);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(useSprite, 0, 0) )
  {
    ...
    if ( isUse )
    {
      ...
      if ( item->fields.userCommandCodeEntity )
        v13 = &StringLiteral_20190/*"icon_equip_cc"*/;
      else
        v13 = &StringLiteral_20189/*"icon_equip"*/;
  ...
  if ( !item->fields.isEnabled )
  {
    ...
    if ( LocalizationManager_TypeInfo->_2.cctor_finished )
    {
      ...
      {
LABEL_68:
        v22 = &StringLiteral_11553/*"SELECT_SERVANT_EVENT_JOIN"*/;
LABEL_76:
...
LABEL_78:
    ...
    v22 = &StringLiteral_11521/*"SELECT_CANNOT"*/;
    goto LABEL_76;
  }
LABEL_79:
  pushSprite = (UnityEngine_Object_o *)this->fields.pushSprite;
