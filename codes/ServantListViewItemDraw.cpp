        ...
        const MethodInfo *method)
{
  ...
  if ( !item->fields.isEnabled )
  {
    ...
    if ( LocalizationManager_TypeInfo->_2.cctor_finished )
    {
      ...
      {
LABEL_48:
        v18 = &StringLiteral_11723/*"SELECT_SERVANT_EVENT_JOIN"*/;
LABEL_56:
...
LABEL_58:
    ...
    v18 = &StringLiteral_11691/*"SELECT_CANNOT"*/;
    goto LABEL_56;
  }
LABEL_59:
  ...
  if ( UnityEngine_Object__op_Inequality(materialTdSprite, 0, 0) )
  {
    ...
    if ( item->fields.isMaterialTdSvt )
    {
      ...
      AtlasManager__SetEventSprite(v22, (System_String_o *)StringLiteral_23584/*"ribbon_noblephantasmup_01"*/, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E734E6 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_1/*""*/);
    sub_1D0F0B4(&StringLiteral_20569/*"icon_equip_cc"*/);
    byte_4E734E6 = 1;
  }
  if ( !item || !mode )
    return;
  ...
  if ( UnityEngine_Object__op_Inequality(partyIcon, 0, 0) )
  {
    ...
    FlashingIconComponent__Set_42263484((FlashingIconComponent_o *)servantFaceIcon, (bool)userCommandCodeEntity, 0);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(useSprite, 0, 0) )
  {
    ...
    if ( isUse )
    {
      ...
      if ( item->fields.userCommandCodeEntity )
        v12 = &StringLiteral_20569/*"icon_equip_cc"*/;
      else
        v12 = &StringLiteral_20568/*"icon_equip"*/;
  ...
  if ( !item->fields.isEnabled )
  {
    ...
    if ( LocalizationManager_TypeInfo->_2.cctor_finished )
    {
      ...
      {
LABEL_68:
        v21 = &StringLiteral_11723/*"SELECT_SERVANT_EVENT_JOIN"*/;
LABEL_76:
...
LABEL_78:
    ...
    v21 = &StringLiteral_11691/*"SELECT_CANNOT"*/;
    goto LABEL_76;
  }
LABEL_79:
  pushSprite = (UnityEngine_Object_o *)this->fields.pushSprite;
  ...
  {
LABEL_98:
    sub_1D0F30C(servantFaceIcon, userCommandCodeEntity);
  }
  ...
  if ( item->fields.isMaterialTdSvt )
  {
    ...
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetEventSprite(v25, (System_String_o *)StringLiteral_23584/*"ribbon_noblephantasmup_01"*/, 0);
    if ( item->fields.isNeedAdjustIconLabelScale )
    {
      servantFaceIcon = this->fields.servantFaceIcon;
      if ( !servantFaceIcon )
