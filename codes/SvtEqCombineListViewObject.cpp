...
void __fastcall SvtEqCombineListViewObject__Awake(SvtEqCombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B06164 & 1) == 0 )
  {
    sub_1BC3008(&Method_UnityEngine_Component_GetComponent_UIDragDropListViewItem___, method);
    sub_1BC3008(&Method_UnityEngine_GameObject_GetComponent_SvtEqCombineListViewItemDraw___, v3);
    byte_4B06164 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_3055998 *)Method_UnityEngine_GameObject_GetComponent_SvtEqCombineListViewItemDraw___);
  this->fields.itemDraw = (struct SvtEqCombineListViewItemDraw_o *)Component_object;
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.itemDraw, (int32_t)Component_object, v7, v8);
  v9 = UnityEngine_Component__GetComponent_object_(
         (UnityEngine_Component_o *)this,
         (const MethodInfo_2FF8634 *)Method_UnityEngine_Component_GetComponent_UIDragDropListViewItem___);
  this->fields.itemDrag = (struct UIDragDropListViewItem_o *)v9;
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.itemDrag, (int32_t)v9, v10, v11);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B06169 & 1) == 0 )
  {
    sub_1BC3008(&Method_UnityEngine_GameObject_GetComponent_SvtEqCombineListViewObject___, method);
  ...
  if ( ((unsigned __int8)Component_object & 1) != 0 )
  {
    if ( !DragObject
      || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                               ...
                               (const MethodInfo_3055998 *)Method_UnityEngine_GameObject_GetComponent_SvtEqCombineListViewObject___)) == 0LL )
    {
      sub_1BC3264(Component_object, v6);
    }
    SvtEqCombineListViewObject__Init_47797592((SvtEqCombineListViewObject_o *)Component_object, 2, v7);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B06166 & 1) == 0 )
  {
    sub_1BC3008(&SvtEqCombineListViewItem_TypeInfo, method);
    byte_4B06166 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B0616A & 1) == 0 )
  {
    sub_1BC3008(&SvtEqCombineListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4B0616A = 1;
  }
  linkItem = this->fields.linkItem;
...
LABEL_7:
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.callbackFunc, (int32_t)callbackFunc, v20, v21);
  if ( (unsigned int)v13 <= 4 && ((0x17u >> v13) & 1) != 0 )
  {
    v25 = dword_C194DC[v13];
    this->fields.dispMode = dword_C194C8[v13];
  ...
  if ( p_callbackFunc->klass )
  {
    ...
    sub_1BC2FAC(p_callbackFunc, 0, v23, v24);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall SvtEqCombineListViewObject__Init_47797592(
        SvtEqCombineListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall SvtEqCombineListViewObject__Init_47799828(
        SvtEqCombineListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall SvtEqCombineListViewObject__Init_47799912(
        SvtEqCombineListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
bool __fastcall SvtEqCombineListViewObject__IsCanDrag(SvtEqCombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B06168 & 1) == 0 )
  {
    ...
    sub_1BC3008(&SvtEqCombineListViewItem_TypeInfo, v4);
    sub_1BC3008(&SvtEqCombineListViewManager_TypeInfo, v5);
    byte_4B06168 = 1;
  }
...
LABEL_19:
  ...
  sub_1BC3524(this->fields.linkItem);
...
void __fastcall SvtEqCombineListViewObject__OnClickSelect(SvtEqCombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BC3008(&SvtEqCombineListViewItem_TypeInfo, method);
    sub_1BC3008(&SvtEqCombineListViewManager_TypeInfo, v4);
    sub_1BC3008(&Method_SvtEqCombineListViewObject_OnClickSelect__, v5);
    sub_1BC3008(&StringLiteral_9779/*"OnClickSelectBase"*/, v6);
    this = (SvtEqCombineListViewObject_o *)sub_1BC3008(&StringLiteral_9781/*"OnClickSelectMaterial"*/, v7);
    byte_4B0616D = 1;
  }
  ...
  if ( LOBYTE(linkItem->klass->vtable._0_Equals.methodPtr) < (unsigned int)methodPtr_low
    || (SvtEqCombineListViewItem_c *)linkItem->klass->_2.typeHierarchy[methodPtr_low - 1] != SvtEqCombineListViewItem_TypeInfo )
  {
    sub_1BC3524(v3->fields.linkItem);
LABEL_51:
    sub_1BC3524(manager);
    goto LABEL_52;
  }
  ...
  if ( modeKind == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SvtEqCombineListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v22 = (_QWORD *)sub_1BC3020(Method_SvtEqCombineListViewObject_OnClickSelect__);
    v17 = (System_Reflection_MethodBase_o *)sub_1BC2FEC(v22, v22[4]);
    if ( !v21 )
    {
  ...
  if ( modeKind == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SvtEqCombineListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v16 = (_QWORD *)sub_1BC3020(Method_SvtEqCombineListViewObject_OnClickSelect__);
...
LABEL_19:
  ...
  if ( !type )
  {
    if ( linkItem->fields.isLvMax && linkItem->fields.isLimitCntMax || linkItem->fields.isSvtEqMaterial )
    {
      ...
      if ( (*((_BYTE *)Method_SvtEqCombineListViewObject_OnClickSelect__ + 83) & 2) != 0 )
        v24 = (_QWORD *)sub_1BC3020(Method_SvtEqCombineListViewObject_OnClickSelect__);
    ...
    else
    {
      ...
      UnityEngine_Component__SendMessage(
        (UnityEngine_Component_o *)this,
        (System_String_o *)StringLiteral_9779/*"OnClickSelectBase"*/,
        (Il2CppObject *)v3,
        0LL);
    }
    type = linkItem->fields.type;
  ...
  if ( type == 1 )
  {
    if ( SvtEqCombineListViewItem__get_IsCanNotSelect(linkItem, (const MethodInfo *)v9) )
    {
      ...
      if ( (*((_BYTE *)Method_SvtEqCombineListViewObject_OnClickSelect__ + 83) & 2) != 0 )
        v26 = (_QWORD *)sub_1BC3020(Method_SvtEqCombineListViewObject_OnClickSelect__);
      v17 = (System_Reflection_MethodBase_o *)sub_1BC2FEC(v26, v26[4]);
LABEL_35:
    ...
    if ( linkItem->fields.isMaterialSvt )
    {
      ...
      if ( (*((_BYTE *)Method_SvtEqCombineListViewObject_OnClickSelect__ + 83) & 2) != 0 )
        v27 = (_QWORD *)sub_1BC3020(Method_SvtEqCombineListViewObject_OnClickSelect__);
      v28 = 1;
    }
    else
    {
    ...
    v29 = (System_Reflection_MethodBase_o *)sub_1BC2FEC(v27, v27[4]);
    OverwriteAssetSoundName__PlaySystemSe(v29, v28, 0, 0LL);
    this = (SvtEqCombineListViewObject_o *)v3->fields.manager;
    if ( this )
    {
      UnityEngine_Component__SendMessage(
        (UnityEngine_Component_o *)this,
        (System_String_o *)StringLiteral_9781/*"OnClickSelectMaterial"*/,
        (Il2CppObject *)v3,
        0LL);
      return;
    }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BC3008(&UnityEngine_Object_TypeInfo, method);
    sub_1BC3008(&SvtEqCombineListViewManager_TypeInfo, v3);
    byte_4B0616F = 1;
  }
  manager = (UITouchPress_o *)this->fields.manager;
  if ( !manager )
...
void __fastcall SvtEqCombineListViewObject__OnLongPush(SvtEqCombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B0616E & 1) == 0 )
  {
    sub_1BC3008(&SvtEqCombineListViewItem_TypeInfo, method);
    sub_1BC3008(&SvtEqCombineListViewManager_TypeInfo, v4);
    sub_1BC3008(&StringLiteral_9840/*"OnLongPushListView"*/, v5);
    this = (SvtEqCombineListViewObject_o *)sub_1BC3008(&StringLiteral_9858/*"OnPressCancel"*/, v6);
    byte_4B0616E = 1;
  }
  ...
  if ( linkItem )
  {
      ...
      && (SvtEqCombineListViewItem_c *)linkItem->klass->_2.typeHierarchy[methodPtr_low - 1] == SvtEqCombineListViewItem_TypeInfo )
    {
      ...
      if ( this )
      {
        UnityEngine_GameObject__SendMessage_70016176(
          (UnityEngine_GameObject_o *)this,
          (System_String_o *)StringLiteral_9858/*"OnPressCancel"*/,
          0LL);
        this = (SvtEqCombineListViewObject_o *)v3->fields.manager;
        if ( this )
        {
...
void __fastcall SvtEqCombineListViewObject__OnLongRelease(SvtEqCombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B06170 & 1) == 0 )
  {
    sub_1BC3008(&UnityEngine_Object_TypeInfo, method);
    sub_1BC3008(&SvtEqCombineListViewManager_TypeInfo, v3);
    sub_1BC3008(&StringLiteral_9840/*"OnLongPushListView"*/, v4);
    sub_1BC3008(&StringLiteral_3994/*"CancelDragEnd"*/, v5);
    byte_4B06170 = 1;
  }
    ...
    if ( manager )
    {
        ...
        && (SvtEqCombineListViewManager_c *)manager->klass->_2.typeHierarchy[methodPtr_low - 1] == SvtEqCombineListViewManager_TypeInfo )
      {
        if ( LODWORD(manager[5].fields.mListViewObject) )
          return;
        UnityEngine_Component__SendMessage_70006020(
          (UnityEngine_Component_o *)manager,
          (System_String_o *)StringLiteral_3994/*"CancelDragEnd"*/,
          0LL);
        manager = (UIDragDropListViewItem_o *)this->fields.manager;
        if ( manager )
        {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B06167 & 1) == 0 )
  {
    ...
    sub_1BC3008(&SvtEqCombineListViewItem_TypeInfo, v5);
    byte_4B06167 = 1;
  }
...
void __fastcall SvtEqCombineListViewObject__SetItem_47817880(
        SvtEqCombineListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall SvtEqCombineListViewObject__SetupDisp(SvtEqCombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( manager )
  {
    ...
    {
      sub_1BC3524(this->fields.manager);
      goto LABEL_26;
    }
  }
  linkItem = this->fields.linkItem;
...
void __fastcall SvtEqCombineListViewObject__Start(SvtEqCombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    SvtEqCombineListViewObject__Init_47797592(this, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B0616C & 1) == 0 )
  {
    sub_1BC3008(&SvtEqCombineListViewItemDraw_DispMode_TypeInfo, method);
