...
void __fastcall SvtEqCombineListViewObject__Awake(SvtEqCombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A026D8 & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_UnityEngine_GameObject_GetComponent_SvtEqCombineListViewItemDraw___, v3);
    byte_4A026D8 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2E8A7CC *)Method_UnityEngine_GameObject_GetComponent_SvtEqCombineListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A026DD & 1) == 0 )
  {
    sub_1B64A00(&Method_UnityEngine_GameObject_GetComponent_SvtEqCombineListViewObject___, method);
  ...
  if ( ((unsigned __int8)Component_object & 1) != 0 )
  {
    if ( !DragObject
      || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                               ...
                               (const MethodInfo_2E8A7CC *)Method_UnityEngine_GameObject_GetComponent_SvtEqCombineListViewObject___)) == 0LL )
    {
      sub_1B64C5C(Component_object, v6);
    }
    SvtEqCombineListViewObject__Init_45071784((SvtEqCombineListViewObject_o *)Component_object, 2, v7);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A026DA & 1) == 0 )
  {
    sub_1B64A00(&SvtEqCombineListViewItem_TypeInfo, method);
    byte_4A026DA = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A026DE & 1) == 0 )
  {
    sub_1B64A00(&SvtEqCombineListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4A026DE = 1;
  }
  linkItem = this->fields.linkItem;
...
LABEL_7:
  ...
  {
    v25 = dword_BDE51C[v13];
    this->fields.dispMode = dword_BDE508[v13];
...
// local variable allocation has failed, the output may be wrong!
void __fastcall SvtEqCombineListViewObject__Init_45071784(
        SvtEqCombineListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall SvtEqCombineListViewObject__Init_45074028(
        SvtEqCombineListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall SvtEqCombineListViewObject__Init_45074112(
        SvtEqCombineListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
bool __fastcall SvtEqCombineListViewObject__IsCanDrag(SvtEqCombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A026DC & 1) == 0 )
  {
    ...
    sub_1B64A00(&SvtEqCombineListViewItem_TypeInfo, v4);
    sub_1B64A00(&SvtEqCombineListViewManager_TypeInfo, v5);
    byte_4A026DC = 1;
  }
...
void __fastcall SvtEqCombineListViewObject__OnClickSelect(SvtEqCombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B64A00(&SvtEqCombineListViewItem_TypeInfo, method);
    sub_1B64A00(&SvtEqCombineListViewManager_TypeInfo, v4);
    sub_1B64A00(&Method_SvtEqCombineListViewObject_OnClickSelect__, v5);
    sub_1B64A00(&StringLiteral_9820/*"OnClickSelectBase"*/, v6);
    this = (SvtEqCombineListViewObject_o *)sub_1B64A00(&StringLiteral_9822/*"OnClickSelectMaterial"*/, v7);
    byte_4A026E1 = 1;
  }
...
LABEL_49:
  ...
  if ( modeKind == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SvtEqCombineListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v22 = (_QWORD *)sub_1B64A18(Method_SvtEqCombineListViewObject_OnClickSelect__);
    v17 = (System_Reflection_MethodBase_o *)sub_1B649E4(v22, v22[4]);
    if ( !v21 )
    {
  ...
  if ( modeKind == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SvtEqCombineListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v16 = (_QWORD *)sub_1B64A18(Method_SvtEqCombineListViewObject_OnClickSelect__);
...
LABEL_19:
  ...
  if ( !type )
  {
    if ( SvtEqCombineListViewItem__get_IsCanNotBaseSelect(linkItem, 0LL) )
    {
      ...
      if ( (*((_BYTE *)Method_SvtEqCombineListViewObject_OnClickSelect__ + 83) & 2) != 0 )
        v24 = (_QWORD *)sub_1B64A18(Method_SvtEqCombineListViewObject_OnClickSelect__);
  ...
  if ( type == 1 )
  {
    if ( SvtEqCombineListViewItem__get_IsCanNotSelect(linkItem, 0LL) )
    {
      ...
      if ( (*((_BYTE *)Method_SvtEqCombineListViewObject_OnClickSelect__ + 83) & 2) != 0 )
        v26 = (_QWORD *)sub_1B64A18(Method_SvtEqCombineListViewObject_OnClickSelect__);
      v17 = (System_Reflection_MethodBase_o *)sub_1B649E4(v26, v26[4]);
LABEL_33:
    ...
    if ( linkItem->fields.isMaterialSvt )
    {
      ...
      if ( (*((_BYTE *)Method_SvtEqCombineListViewObject_OnClickSelect__ + 83) & 2) != 0 )
        v27 = (_QWORD *)sub_1B64A18(Method_SvtEqCombineListViewObject_OnClickSelect__);
      v28 = 1;
    }
    else
    {
    ...
    v29 = (System_Reflection_MethodBase_o *)sub_1B649E4(v27, v27[4]);
    ...
    if ( this )
    {
      UnityEngine_Component__SendMessage(
        (UnityEngine_Component_o *)this,
        (System_String_o *)StringLiteral_9822/*"OnClickSelectMaterial"*/,
        (Il2CppObject *)v3,
        0LL);
      return;
    }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B64A00(&UnityEngine_Object_TypeInfo, method);
    sub_1B64A00(&SvtEqCombineListViewManager_TypeInfo, v3);
    byte_4A026E3 = 1;
  }
  manager = (UITouchPress_o *)this->fields.manager;
  if ( !manager )
...
void __fastcall SvtEqCombineListViewObject__OnLongPush(SvtEqCombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A026E2 & 1) == 0 )
  {
    ...
    this = (SvtEqCombineListViewObject_o *)sub_1B64A00(&StringLiteral_9897/*"OnPressCancel"*/, v6);
    byte_4A026E2 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A026DB & 1) == 0 )
  {
    ...
    sub_1B64A00(&SvtEqCombineListViewItem_TypeInfo, v5);
    byte_4A026DB = 1;
  }
...
void __fastcall SvtEqCombineListViewObject__SetItem_45091996(
        SvtEqCombineListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall SvtEqCombineListViewObject__Start(SvtEqCombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    SvtEqCombineListViewObject__Init_45071784(this, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A026E0 & 1) == 0 )
  {
    sub_1B64A00(&SvtEqCombineListViewItemDraw_DispMode_TypeInfo, method);
