...
void SvtEqCombineListViewObject__Awake(SvtEqCombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596A410 & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_UnityEngine_GameObject_GetComponent_SvtEqCombineListViewItemDraw___);
    byte_596A410 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_38B6F40 *)Method_UnityEngine_GameObject_GetComponent_SvtEqCombineListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596A415 & 1) == 0 )
  {
    sub_2213A60(&Method_UnityEngine_GameObject_GetComponent_SvtEqCombineListViewObject___);
  ...
  if ( ((unsigned __int8)Component_object & 1) != 0 )
  {
    if ( !DragObject
      || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                               ...
                               (const MethodInfo_38B6F40 *)Method_UnityEngine_GameObject_GetComponent_SvtEqCombineListViewObject___)) == 0 )
    {
      sub_2213CDC(Component_object, v7);
    }
    SvtEqCombineListViewObject__Init_37967180((SvtEqCombineListViewObject_o *)Component_object, 2, v8);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596A412 & 1) == 0 )
  {
    sub_2213A60(&SvtEqCombineListViewItem_TypeInfo);
    byte_596A412 = 1;
  }
...
LABEL_11:
    sub_221405C(linkItem, SvtEqCombineListViewItem_TypeInfo, callbackFunc, method);
    goto LABEL_12;
  }
  if ( !linkItem )
  {
...
LABEL_15:
  ...
  {
    v30 = dword_ED8BF8[initMode];
    this->fields.dispMode = dword_ED8BE4[initMode];
...
void SvtEqCombineListViewObject__Init_37967180(
        SvtEqCombineListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
  ...
  v10.fields.y = v6;
  v10.fields.z = v7;
  SvtEqCombineListViewObject__Init(this, initMode, 0, v4, v10, v3);
}


void SvtEqCombineListViewObject__Init_37969392(
        SvtEqCombineListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        const MethodInfo *method)
{
  ...
  v11.fields.y = v6;
  v11.fields.z = v7;
  SvtEqCombineListViewObject__Init(this, initMode, callbackFunc, delay, v11, method);
}


void SvtEqCombineListViewObject__Init_37969476(
        SvtEqCombineListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
{
  ...
  v11.fields.y = v6;
  v11.fields.z = v7;
  SvtEqCombineListViewObject__Init(this, initMode, callbackFunc, v4, v11, method);
}
...
bool SvtEqCombineListViewObject__IsCanDrag(SvtEqCombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    manager = (UITouchPress_o *)sub_221405C(manager, SvtEqCombineListViewManager_TypeInfo, v2, v3);
    goto LABEL_19;
  }
...
LABEL_19:
  ...
  v12 = (SvtEqCombineListViewObject_o *)sub_221405C(this->fields.linkItem, SvtEqCombineListViewItem_TypeInfo, v2, v3);
...
void SvtEqCombineListViewObject__OnClickSelect(SvtEqCombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596A419 & 1) == 0 )
  {
    sub_2213A60(&SvtEqCombineListViewItem_TypeInfo);
    sub_2213A60(&SvtEqCombineListViewManager_TypeInfo);
    sub_2213A60(&Method_SvtEqCombineListViewObject_OnClickSelect__);
    sub_2213A60(&StringLiteral_10266/*"OnClickSelectBase"*/);
    this = (SvtEqCombineListViewObject_o *)sub_2213A60(&StringLiteral_10268/*"OnClickSelectMaterial"*/);
    byte_596A419 = 1;
  }
  ...
  if ( linkItem->klass->_2.naturalAligment < (unsigned int)naturalAligment
    || (SvtEqCombineListViewItem_c *)linkItem->klass->_2.typeHierarchy[naturalAligment - 1] != SvtEqCombineListViewItem_TypeInfo )
  {
    sub_221405C(v5->fields.linkItem, SvtEqCombineListViewItem_TypeInfo, v2, v3);
LABEL_44:
    this = (SvtEqCombineListViewObject_o *)sub_221405C(manager, v9, v2, v3);
    goto LABEL_45;
  }
  ...
  if ( modeKind == 2 )
  {
    ...
    if ( !v22 )
    {
      if ( (*((_BYTE *)Method_SvtEqCombineListViewObject_OnClickSelect__ + 83) & 2) != 0 )
        v15 = (_QWORD *)sub_2213A78(Method_SvtEqCombineListViewObject_OnClickSelect__);
      v26 = (System_Reflection_MethodBase_o *)sub_2213A44(v15, v15[4]);
  ...
  if ( modeKind == 1 )
  {
    ...
    if ( !v14 )
    {
      if ( (*((_BYTE *)Method_SvtEqCombineListViewObject_OnClickSelect__ + 83) & 2) != 0 )
        v15 = (_QWORD *)sub_2213A78(Method_SvtEqCombineListViewObject_OnClickSelect__);
      v17 = (System_Reflection_MethodBase_o *)sub_2213A44(v15, v15[4]);
...
LABEL_16:
    if ( (v16 & 2) != 0 )
      v15 = (_QWORD *)sub_2213A78(v15);
    v23 = (System_Reflection_MethodBase_o *)sub_2213A44(v15, v15[4]);
    goto LABEL_19;
  }
  ...
  if ( !type )
  {
    ...
    {
      v25 = (System_Reflection_MethodBase_o *)sub_1FFEFAC(Method_SvtEqCombineListViewObject_OnClickSelect__);
    ...
    else
    {
      ...
      UnityEngine_Component__SendMessage(
        (UnityEngine_Component_o *)this,
        (System_String_o *)StringLiteral_10266/*"OnClickSelectBase"*/,
        (Il2CppObject *)v5,
        0);
    }
    type = linkItem->fields.type;
  ...
  if ( type == 1 )
  {
    ...
    {
      v23 = (System_Reflection_MethodBase_o *)sub_1FFEFAC(Method_SvtEqCombineListViewObject_OnClickSelect__);
LABEL_19:
    ...
    if ( linkItem->fields.isMaterialSvt )
    {
      ...
      v27 = (System_Reflection_MethodBase_o *)sub_1FFEFAC(Method_SvtEqCombineListViewObject_OnClickSelect__);
      v28 = 1;
    }
    else
    {
    ...
    if ( this )
    {
      UnityEngine_Component__SendMessage(
        (UnityEngine_Component_o *)this,
        (System_String_o *)StringLiteral_10268/*"OnClickSelectMaterial"*/,
        (Il2CppObject *)v5,
        0);
      return;
    }
...
void SvtEqCombineListViewObject__OnLongPush(SvtEqCombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596A41A & 1) == 0 )
  {
    ...
    this = (SvtEqCombineListViewObject_o *)sub_2213A60(&StringLiteral_10349/*"OnPressCancel"*/);
    byte_596A41A = 1;
  }
  ...
  if ( linkItem )
  {
      ...
      && (SvtEqCombineListViewItem_c *)linkItem->klass->_2.typeHierarchy[naturalAligment - 1] == SvtEqCombineListViewItem_TypeInfo )
    {
      ...
      if ( manager )
      {
        ...
        {
          v13 = (SvtEqCombineListViewObject_o *)sub_221405C(
                                                  v4->fields.manager,
    ...
    {
      this = (SvtEqCombineListViewObject_o *)sub_221405C(v4->fields.linkItem, SvtEqCombineListViewItem_TypeInfo, v2, v3);
    }
LABEL_18:
    sub_2213CDC(this, v6);
  }
...
void SvtEqCombineListViewObject__OnLongRelease(SvtEqCombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.linkItem )
  {
    ...
    if ( manager )
    {
      ...
      {
        manager = (UIDragDropListViewItem_o *)sub_221405C(manager, SvtEqCombineListViewManager_TypeInfo, v6, v7);
      }
    }
LABEL_17:
  ...
  if ( UnityEngine_Object__op_Inequality(itemDraw, 0, 0) )
  {
    ...
    if ( linkItem
      && ((naturalAligment = SvtEqCombineListViewItem_TypeInfo->_2.naturalAligment,
       ...
       || (SvtEqCombineListViewItem_c *)linkItem->klass->_2.typeHierarchy[naturalAligment - 1] != SvtEqCombineListViewItem_TypeInfo) )
    {
      v12 = (SvtEqCombineListViewItemDraw_o *)sub_221405C(
...
void SvtEqCombineListViewObject__SetItem_37987940(
        SvtEqCombineListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void SvtEqCombineListViewObject__SetupDisp(SvtEqCombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( manager )
  {
    ...
    {
      sub_221405C(this->fields.manager, SvtEqCombineListViewManager_TypeInfo, v2, v3);
      goto LABEL_26;
    }
  }
  linkItem = this->fields.linkItem;
  ...
  {
LABEL_26:
    v20 = (SvtEqCombineListViewManager_o *)sub_221405C(linkItem, v8, v2, v3);
...
void SvtEqCombineListViewObject__Start(SvtEqCombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    SvtEqCombineListViewObject__Init_37967180(this, 2, v2);
}
...
System_String_o *SvtEqCombineListViewObject__ToString(SvtEqCombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596A418 & 1) == 0 )
  {
    sub_2213A60(&SvtEqCombineListViewItemDraw_DispMode_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v13 = (SvtEqCombineListViewObject_o *)sub_221405C(v8, System_Action_TypeInfo, v9, v10);
