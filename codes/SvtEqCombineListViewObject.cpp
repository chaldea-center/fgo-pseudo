...
void __fastcall SvtEqCombineListViewObject__Awake(SvtEqCombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A020B7 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_UnityEngine_GameObject_GetComponent_SvtEqCombineListViewItemDraw___, v3);
    byte_4A020B7 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2E8A1B4 *)Method_UnityEngine_GameObject_GetComponent_SvtEqCombineListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A020BC & 1) == 0 )
  {
    sub_1B64870(&Method_UnityEngine_GameObject_GetComponent_SvtEqCombineListViewObject___, method);
  ...
  if ( ((unsigned __int8)Component_object & 1) != 0 )
  {
    if ( !DragObject
      || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                               ...
                               (const MethodInfo_2E8A1B4 *)Method_UnityEngine_GameObject_GetComponent_SvtEqCombineListViewObject___)) == 0LL )
    {
      sub_1B64ACC(Component_object, v6);
    }
    SvtEqCombineListViewObject__Init_45070224((SvtEqCombineListViewObject_o *)Component_object, 2, v7);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A020B9 & 1) == 0 )
  {
    sub_1B64870(&SvtEqCombineListViewItem_TypeInfo, method);
    byte_4A020B9 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A020BD & 1) == 0 )
  {
    sub_1B64870(&SvtEqCombineListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4A020BD = 1;
  }
  linkItem = this->fields.linkItem;
...
LABEL_7:
  ...
  {
    v25 = dword_BDE4CC[v13];
    this->fields.dispMode = dword_BDE4B8[v13];
...
// local variable allocation has failed, the output may be wrong!
void __fastcall SvtEqCombineListViewObject__Init_45070224(
        SvtEqCombineListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall SvtEqCombineListViewObject__Init_45072468(
        SvtEqCombineListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall SvtEqCombineListViewObject__Init_45072552(
        SvtEqCombineListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall SvtEqCombineListViewObject__OnClickSelect(SvtEqCombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B64870(&SvtEqCombineListViewItem_TypeInfo, method);
    sub_1B64870(&SvtEqCombineListViewManager_TypeInfo, v4);
    sub_1B64870(&Method_SvtEqCombineListViewObject_OnClickSelect__, v5);
    sub_1B64870(&StringLiteral_9819/*"OnClickSelectBase"*/, v6);
    this = (SvtEqCombineListViewObject_o *)sub_1B64870(&StringLiteral_9821/*"OnClickSelectMaterial"*/, v7);
    byte_4A020C0 = 1;
  }
...
LABEL_49:
  ...
  if ( modeKind == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SvtEqCombineListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v22 = (_QWORD *)sub_1B64888(Method_SvtEqCombineListViewObject_OnClickSelect__);
    v17 = (System_Reflection_MethodBase_o *)sub_1B64854(v22, v22[4]);
    if ( !v21 )
    {
  ...
  if ( modeKind == 1 )
  {
    v13 = SvtEqCombineListViewItem__get_UserSvtId(linkItem, 0LL);
    ...
    if ( (*((_BYTE *)Method_SvtEqCombineListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v16 = (_QWORD *)sub_1B64888(Method_SvtEqCombineListViewObject_OnClickSelect__);
...
LABEL_19:
  ...
  if ( !type )
  {
    if ( SvtEqCombineListViewItem__get_IsCanNotBaseSelect(linkItem, 0LL) )
    {
      ...
      if ( (*((_BYTE *)Method_SvtEqCombineListViewObject_OnClickSelect__ + 83) & 2) != 0 )
        v24 = (_QWORD *)sub_1B64888(Method_SvtEqCombineListViewObject_OnClickSelect__);
    ...
    else
    {
      ...
      UnityEngine_Component__SendMessage(
        (UnityEngine_Component_o *)this,
        (System_String_o *)StringLiteral_9819/*"OnClickSelectBase"*/,
        (Il2CppObject *)v3,
        0LL);
    }
    type = linkItem->fields.type;
  ...
  if ( type == 1 )
  {
    if ( SvtEqCombineListViewItem__get_IsCanNotSelect(linkItem, 0LL) )
    {
      ...
      if ( (*((_BYTE *)Method_SvtEqCombineListViewObject_OnClickSelect__ + 83) & 2) != 0 )
        v26 = (_QWORD *)sub_1B64888(Method_SvtEqCombineListViewObject_OnClickSelect__);
      v17 = (System_Reflection_MethodBase_o *)sub_1B64854(v26, v26[4]);
LABEL_33:
    ...
    if ( linkItem->fields.isMaterialSvt )
    {
      ...
      if ( (*((_BYTE *)Method_SvtEqCombineListViewObject_OnClickSelect__ + 83) & 2) != 0 )
        v27 = (_QWORD *)sub_1B64888(Method_SvtEqCombineListViewObject_OnClickSelect__);
      v28 = 1;
    }
    else
    {
    ...
    v29 = (System_Reflection_MethodBase_o *)sub_1B64854(v27, v27[4]);
    ...
    if ( this )
    {
      UnityEngine_Component__SendMessage(
        (UnityEngine_Component_o *)this,
        (System_String_o *)StringLiteral_9821/*"OnClickSelectMaterial"*/,
        (Il2CppObject *)v3,
        0LL);
      return;
    }
...
void __fastcall SvtEqCombineListViewObject__OnLongPush(SvtEqCombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A020C1 & 1) == 0 )
  {
    ...
    this = (SvtEqCombineListViewObject_o *)sub_1B64870(&StringLiteral_9896/*"OnPressCancel"*/, v6);
    byte_4A020C1 = 1;
  }
...
void __fastcall SvtEqCombineListViewObject__SetItem_45090436(
        SvtEqCombineListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall SvtEqCombineListViewObject__Start(SvtEqCombineListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    SvtEqCombineListViewObject__Init_45070224(this, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A020BF & 1) == 0 )
  {
    sub_1B64870(&SvtEqCombineListViewItemDraw_DispMode_TypeInfo, method);
