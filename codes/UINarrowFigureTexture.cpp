        ...
        const MethodInfo *method)
{
  ...
  if ( assetData )
  {
    ...
    if ( loadName )
    {
      ...
      if ( AssetManager__compAssetStorage_41093944(assetData, loadName, 0) )
      {
        v12 = this->fields.assetData;
        this->fields.loadName = 0;
        sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.loadName, 0, v6, v7, v8, v9, v10, v11);
...
LABEL_24:
  ...
  if ( assetData )
  {
    ...
    sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.assetData, 0, v10, v11, v12, v13, v14, v15);
  }
  loadName = this->fields.loadName;
  if ( loadName )
  {
    ...
    p_loadName->klass = 0;
    sub_1C7BA8C(p_loadName, 0, v18, v19, v20, v21, v22, v23);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEFF25 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&UINarrowFigureRender_TypeInfo);
    sub_1C7BAE8(&Method_UINarrowFigureTexture_EndLoadAsset__);
    byte_4CEFF25 = 1;
  }
  if ( !UINarrowFigureRender_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UINarrowFigureRender_TypeInfo);
...
LABEL_29:
      ...
      sub_1C7BA8C(p_callbackFunc, (int32_t)v15, v16, v17, v18, v19, v20, v21);
      return;
    }
  ...
  if ( callbackFunc )
  {
    ...
    sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.callbackFunc, (int32_t)v27, v28, v29, v30, v31, v32, v33);
  }
  UINarrowFigureTexture__ClearTexture(this, v11);
  this->fields.loadName = AssetName;
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.loadName, (int32_t)AssetName, v35, v36, v37, v38, v39, v40);
  v41 = this->fields.loadName;
  v42 = (AssetLoader_LoadEndDataHandler_o *)sub_1C7BD34(AssetLoader_LoadEndDataHandler_TypeInfo);
...
void UINarrowFigureTexture__SetTexture(UINarrowFigureTexture_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(v4, 0, 0) )
  {
    ...
    v7 = UnityEngine_Shader__Find((System_String_o *)StringLiteral_4944/*"Custom/SpriteWithMask"*/, 0);
  ...
  if ( !v10 )
    goto LABEL_28;
  UnityEngine_Material__SetTexture(v10, (System_String_o *)StringLiteral_16328/*"_MaskTex"*/, (UnityEngine_Texture_o *)bodyTexture, 0);
