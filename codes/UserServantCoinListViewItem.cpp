        ...
        const MethodInfo *method)
{
  ...
  sub_1B88554(&this->fields.userSvtCoinEntity, userSvtCoinEnt);
  ...
  *(_QWORD *)&v19.fields.fakeValue = v17;
  iconLabelInfo = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46449800(v19, 0LL);
  if ( !v16 )
LABEL_22:
    sub_1B8880C(iconLabelInfo, v8);
  ServantLimitMaster__TryGetEntity(
    ...
    0LL);
  if ( *p_servantEntity )
    ServantEntity__getName_39657284(
      *p_servantEntity,
  ...
  if ( (v7 & 1) != 0 )
  {
    ...
    if ( sortKind <= 14 )
    {
      if ( sortKind == 2 )
      {
        ...
        sub_1B88554(&this->fields.sortStr1, v21);
        ...
        if ( !iconLabelInfo )
          goto LABEL_35;
LABEL_32:
        IconLabelInfo__Set_38140136(iconLabelInfo, 57, stringLength, 0, 0, 0, 0, 0, 0LL);
        goto LABEL_33;
      }
      if ( sortKind == 14 )
      {
...
LABEL_15:
        sub_1B88554(p_sortStr1, sortRuby);
