        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A29A05 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMaster_ServantLimitMaster___, *(_QWORD *)&index);
    sub_1B761C0(&Method_DataManager_GetMaster_ServantMaster___, v7);
    sub_1B761C0(&Method_DataManager_GetMaster_SvtCoinMaster___, v8);
    sub_1B761C0(&Method_DataManager_GetMaster_UserServantCollectionMaster___, v9);
    sub_1B761C0(&DataManager_TypeInfo, v10);
    sub_1B761C0(&Method_DataMasterBase_ServantMaster__ServantEntity__int__TryGetEntity__, v11);
    sub_1B761C0(&Method_DataMasterBase_SvtCoinMaster__SvtCoinEntity__int__TryGetEntity__, v12);
  ...
  v16 = (IconLabelInfo_o *)sub_1B7640C(IconLabelInfo_TypeInfo);
  ...
  sub_1B76164(&this->fields.userSvtCoinEntity);
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  iconLabelInfo = (int64_t)DataManager__GetMaster_object_((const MethodInfo_2E623B4 *)Method_DataManager_GetMaster_SvtCoinMaster___);
  ...
  iconLabelInfo = (int64_t)DataManager__GetMaster_object_((const MethodInfo_2E623B4 *)Method_DataManager_GetMaster_ServantMaster___);
  ...
  EntityDefinitely = UserServantCollectionMaster__GetEntityDefinitely(
                       ...
                       0LL);
  iconLabelInfo = (int64_t)DataManager__GetMaster_object_((const MethodInfo_2E623B4 *)Method_DataManager_GetMaster_ServantLimitMaster___);
  if ( !EntityDefinitely )
    goto LABEL_22;
  ...
  *(_QWORD *)&v28.fields.fakeValue = v26;
  iconLabelInfo = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(v28, 0LL);
  if ( !v25 )
LABEL_22:
    sub_1B7641C(iconLabelInfo, v17);
  ServantLimitMaster__TryGetEntity(
    ...
    0LL);
  if ( *p_servantEntity )
    ServantEntity__getName_39472524(
      *p_servantEntity,
  ...
  if ( (v7 & 1) != 0 )
  {
    ...
    if ( sortKind <= 14 )
    {
      if ( sortKind == 2 )
      {
        ...
        sub_1B76164(&this->fields.sortStr1);
        ...
        if ( !iconLabelInfo )
          goto LABEL_35;
LABEL_32:
        IconLabelInfo__Set_37960168(iconLabelInfo, 57, stringLength, 0, 0, 0, 0, 0, 0LL);
        goto LABEL_33;
      }
      if ( sortKind == 14 )
      {
