        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DE680 & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataManager_GetMaster_ServantLimitMaster___, *(_QWORD *)&index);
    sub_1B00CCC(&Method_DataManager_GetMaster_ServantMaster___, v7);
    sub_1B00CCC(&Method_DataManager_GetMaster_SvtCoinMaster___, v8);
    ...
    sub_1B00CCC(&Method_DataMasterBase_SvtCoinMaster__SvtCoinEntity__int__TryGetEntity__, v12);
    sub_1B00CCC(&IconLabelInfo_TypeInfo, v13);
    sub_1B00CCC(&NetworkManager_TypeInfo, v14);
    sub_1B00CCC(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, v15);
    byte_48DE680 = 1;
  }
  v16 = (IconLabelInfo_o *)sub_1B00F18(IconLabelInfo_TypeInfo);
  IconLabelInfo___ctor(v16, 0LL);
  this->fields.iconLabelInfo = v16;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.iconLabelInfo, (int32_t)v16, v17, v18);
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.userSvtCoinEntity, (int32_t)userSvtCoinEnt, v21, v22);
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  iconLabelInfo = (int64_t)DataManager__GetMaster_object_((const MethodInfo_2D62BBC *)Method_DataManager_GetMaster_SvtCoinMaster___);
  ...
  iconLabelInfo = (int64_t)DataManager__GetMaster_object_((const MethodInfo_2D62BBC *)Method_DataManager_GetMaster_ServantMaster___);
  ...
  EntityDefinitely = UserServantCollectionMaster__GetEntityDefinitely(
                       ...
                       0LL);
  iconLabelInfo = (int64_t)DataManager__GetMaster_object_((const MethodInfo_2D62BBC *)Method_DataManager_GetMaster_ServantLimitMaster___);
  if ( !EntityDefinitely )
    goto LABEL_22;
  ...
  *(_QWORD *)&v32.fields.fakeValue = v30;
  iconLabelInfo = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_45313044(v32, 0LL);
  if ( !v29 )
LABEL_22:
    sub_1B00F28(iconLabelInfo, v19);
  ServantLimitMaster__TryGetEntity(
    ...
    0LL);
  if ( *p_servantEntity )
    ServantEntity__getName_38389620(
      *p_servantEntity,
  ...
  if ( (v9 & 1) != 0 )
  {
    ...
    if ( sortKind <= 14 )
    {
      if ( sortKind == 2 )
      {
        ...
        sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.sortStr1, v23, v7, v8);
        ...
        if ( !iconLabelInfo )
          goto LABEL_35;
LABEL_32:
        IconLabelInfo__Set_36930772(iconLabelInfo, 57, stringLength, 0, 0, 0, 0, 0, 0LL);
        goto LABEL_33;
      }
      if ( sortKind == 14 )
      {
...
LABEL_15:
        sub_1B00C70(p_sortStr1, (int32_t)sortRuby, v7, v8);
...
LABEL_35:
    ...
    sub_1B00C70((ServantStatusBattleListViewItem_o *)v19, v18, v7, v8);
    v20 = v19[7];
