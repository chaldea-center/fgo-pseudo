...
System_String_o *__fastcall BattleBgEntity__CreatePK(int32_t id, int32_t type, const MethodInfo *method)
{
  if ( (byte_4B446B1 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&type);
    byte_4B446B1 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B446B8 & 1) == 0 )
  {
    sub_1BDB878(&BattleBgEntity__GetAllSpecialShadowEffectIds_d__16_TypeInfo, *(_QWORD *)&defId);
    byte_4B446B8 = 1;
  }
  v5 = sub_1BDBAC4(BattleBgEntity__GetAllSpecialShadowEffectIds_d__16_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B446B4 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_3996/*"CameraClippingFar"*/, v3);
    sub_1BDB878(&StringLiteral_3997/*"CameraClippingNear"*/, v4);
    byte_4B446B4 = 1;
  }
  Millesimal = EntityScriptUtil__GetMillesimal(this->fields.script, (System_String_o *)StringLiteral_3997/*"CameraClippingNear"*/, -1.0, 0LL);
  v6 = EntityScriptUtil__GetMillesimal(this->fields.script, (System_String_o *)StringLiteral_3996/*"CameraClippingFar"*/, -1.0, 0LL);
  result = (System_Single_array *)sub_1BDB920(float___TypeInfo, 2LL);
  if ( !result )
    sub_1BDBAD4(0LL, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B446B7 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_10679/*"PlayerSpecialShadowEffectId"*/, v7);
    sub_1BDB878(&StringLiteral_6058/*"EnemySpecialShadowEffectId"*/, v8);
    byte_4B446B7 = 1;
  }
  script = this->fields.script;
  if ( isEnemy )
    v10 = &StringLiteral_6058/*"EnemySpecialShadowEffectId"*/;
  else
    v10 = &StringLiteral_10679/*"PlayerSpecialShadowEffectId"*/;
  v11 = (System_String_o *)*v10;
  IntValue = EntityScriptUtil__GetIntValue(script, (System_String_o *)StringLiteral_12937/*"SpecialShadowEffectId"*/, defId, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B446B2 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_BattleBgEntity___c__GetSubBgmPlayArgsArray_b__10_0__, v4);
    sub_1BDB878(&BattleBgEntity___c_TypeInfo, v5);
  ...
  if ( !_9__10_0 )
  {
    ...
    _9__10_0 = (System_Func_object__object__o *)sub_1BDBAC4(System_Func_List_object___SubBgmPlayArgs____TypeInfo);
...
int32_t __fastcall BattleBgEntity__GetSubBgmsPriority(BattleBgEntity_o *this, const MethodInfo *method)
{
  ...
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_23795/*"subBgmsPriority"*/, 0, 0LL);
}
...
bool __fastcall BattleBgEntity__IsAcceptedOverwrittenShadow(BattleBgEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4B446B6 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_2126/*"AcceptOverwrittenShadow"*/, method);
    byte_4B446B6 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_2126/*"AcceptOverwrittenShadow"*/, 0, 0LL) == 1;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B446BC & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_12937/*"SpecialShadowEffectId"*/, method);
    sub_1BDB878(&StringLiteral_10679/*"PlayerSpecialShadowEffectId"*/, v3);
    sub_1BDB878(&StringLiteral_6058/*"EnemySpecialShadowEffectId"*/, v4);
    byte_4B446BC = 1;
  }
  result = 0;
  ...
  switch ( this->fields.__1__state )
  {
    case 0:
      ...
      if ( !_4__this )
        goto LABEL_12;
      v8 = &StringLiteral_12937/*"SpecialShadowEffectId"*/;
      v7 = 1;
      goto LABEL_10;
    case 1:
      this->fields.__1__state = -1;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B446BE & 1) == 0 )
  {
    sub_1BDB878(&BattleBgEntity__GetAllSpecialShadowEffectIds_d__16_TypeInfo, method);
    byte_4B446BE = 1;
  }
  ...
  {
    v4 = (BattleBgEntity__GetAllSpecialShadowEffectIds_d__16_o *)sub_1BDBAC4(BattleBgEntity__GetAllSpecialShadowEffectIds_d__16_TypeInfo);
    ...
    sub_1BDB81C((CGThumbnailListItem_o *)&v4->fields.__4__this, (int32_t)_4__this, v6, v7);
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BDB88C(&Method_BattleBgEntity__GetAllSpecialShadowEffectIds_d__16_System_Collections_IEnumerator_Reset__);
  sub_1BDB9A0(v3, v4);
}
...
void __fastcall BattleBgEntity___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B446BB & 1) == 0 )
  {
    sub_1BDB878(&BattleBgEntity___c_TypeInfo, v1);
    byte_4B446BB = 1;
  }
  v2 = (Il2CppObject *)sub_1BDBAC4(BattleBgEntity___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  BattleBgEntity___c_TypeInfo->static_fields->__9 = (struct BattleBgEntity___c_o *)v2;
  sub_1BDB81C((CGThumbnailListItem_o *)BattleBgEntity___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
