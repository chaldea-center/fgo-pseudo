        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C56971 & 1) == 0 )
  {
    sub_1C3E564(&BattleBgEntity__GetAllSpecialShadowEffectIds_d__16_TypeInfo);
    byte_4C56971 = 1;
  }
  v5 = sub_1C3E7B0(BattleBgEntity__GetAllSpecialShadowEffectIds_d__16_TypeInfo);
...
System_Single_array *BattleBgEntity__GetCameraClippingRange(BattleBgEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C5696D & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_3966/*"CameraClippingFar"*/);
    sub_1C3E564(&StringLiteral_3967/*"CameraClippingNear"*/);
    byte_4C5696D = 1;
  }
  Millesimal = EntityScriptUtil__GetMillesimal(this->fields.script, (System_String_o *)StringLiteral_3967/*"CameraClippingNear"*/, -1.0, 0);
  v4 = EntityScriptUtil__GetMillesimal(this->fields.script, (System_String_o *)StringLiteral_3966/*"CameraClippingFar"*/, -1.0, 0);
  result = (System_Single_array *)sub_1C3E60C(float___TypeInfo, 2);
  if ( !result )
    sub_1C3E7C0(0, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( isEnemy )
    v8 = &StringLiteral_6048/*"EnemySpecialShadowEffectId"*/;
  else
    v8 = &StringLiteral_10686/*"PlayerSpecialShadowEffectId"*/;
  v9 = (System_String_o *)*v8;
  IntValue = EntityScriptUtil__GetIntValue(script, (System_String_o *)StringLiteral_12974/*"SpecialShadowEffectId"*/, defId, 0);
...
SubBgmPlayArgs_array *BattleBgEntity__GetSubBgmPlayArgsArray(BattleBgEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C5696B & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_BattleBgEntity___c__GetSubBgmPlayArgsArray_b__10_0__);
    sub_1C3E564(&BattleBgEntity___c_TypeInfo);
  ...
  if ( !_9__10_0 )
  {
    ...
    _9__10_0 = (System_Func_object__object__o *)sub_1C3E7B0(System_Func_List_object___SubBgmPlayArgs____TypeInfo);
...
int32_t BattleBgEntity__GetSubBgmsPriority(BattleBgEntity_o *this, const MethodInfo *method)
{
  ...
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_23784/*"subBgmsPriority"*/, 0, 0);
}
...
bool BattleBgEntity__IsAcceptedOverwrittenShadow(BattleBgEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4C5696F & 1) == 0 )
  {
    sub_1C3E564(&StringLiteral_2104/*"AcceptOverwrittenShadow"*/);
    byte_4C5696F = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_2104/*"AcceptOverwrittenShadow"*/, 0, 0) == 1;
}
        ...
        const MethodInfo *method)
{
  ...
  switch ( this->fields.__1__state )
  {
    case 0:
      ...
      if ( !_4__this )
        goto LABEL_12;
      v6 = &StringLiteral_12974/*"SpecialShadowEffectId"*/;
      v5 = 1;
      goto LABEL_10;
    case 1:
      this->fields.__1__state = -1;
        ...
        const MethodInfo *method)
{
  ...
  {
    v4 = (BattleBgEntity__GetAllSpecialShadowEffectIds_d__16_o *)sub_1C3E7B0(BattleBgEntity__GetAllSpecialShadowEffectIds_d__16_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C3E578(&Method_BattleBgEntity__GetAllSpecialShadowEffectIds_d__16_System_Collections_IEnumerator_Reset__);
  sub_1C3E68C(v3, v4);
}
...
void BattleBgEntity___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C3E7B0(BattleBgEntity___c_TypeInfo);
  System_Object___ctor(v1, 0);
  BattleBgEntity___c_TypeInfo->static_fields->__9 = (struct BattleBgEntity___c_o *)v1;
  sub_1C3E508((CGThumbnailListItem_o *)BattleBgEntity___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
