        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B46031 & 1) == 0 )
  {
    sub_1BDB878(&System_Comparison_QuestReleaseEntity__TypeInfo, eventUiEnt);
    ...
    sub_1BDB878(&Method_System_Linq_Enumerable_Any_QuestReleaseEntity___, v11);
    sub_1BDB878(&Method_System_Collections_Generic_List_Enumerator_QuestReleaseEntity__Dispose__, v12);
    sub_1BDB878(&Method_System_Collections_Generic_List_Enumerator_QuestReleaseEntity__MoveNext__, v13);
    sub_1BDB878(&Method_System_Collections_Generic_List_Enumerator_QuestReleaseEntity__get_Current__, v14);
    sub_1BDB878(&Method_System_Collections_Generic_List_QuestReleaseEntity__GetEnumerator__, v15);
    sub_1BDB878(&Method_System_Collections_Generic_List_QuestReleaseEntity__Sort__, v16);
    sub_1BDB878(&Method_EventInfoDiggingEventPointControl___c__GetNextQuestReleaseEntity_b__14_0__, v17);
    sub_1BDB878(&EventInfoDiggingEventPointControl___c_TypeInfo, v18);
    byte_4B46031 = 1;
  }
  ...
  if ( !v23 )
  {
    ...
    v23 = (System_Comparison_T__o *)sub_1BDBAC4(System_Comparison_QuestReleaseEntity__TypeInfo);
    ...
    sub_1BDB81C((CGThumbnailListItem_o *)&static_fields->__9__14_0, (int32_t)v23, v26, v27);
  }
...
LABEL_34:
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  v28 = DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_QuestMaster___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4602D & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_EventInfoDiggingEventPointControl__Initialization_b__7_0__, v6);
    sub_1BDB878(&StringLiteral_19230/*"event_point_bg_8036701"*/, v7);
    sub_1BDB878(&StringLiteral_19231/*"event_point_bg_8036702"*/, v8);
    byte_4B4602D = 1;
  }
  ...
  EventInfoUIBase__SetSpriteByLocalAtlas(
    ...
    (System_String_o *)StringLiteral_19230/*"event_point_bg_8036701"*/,
    0LL);
  ...
  if ( !userPointBgSprite
    || (((void (__fastcall *)(struct UISprite_o *, Il2CppMethodPointer))userPointBgSprite->klass->vtable._33_MakePixelPerfect.method)(
        ...
        EventInfoUIBase__SetSpriteByLocalAtlas(
          ...
          (System_String_o *)StringLiteral_19231/*"event_point_bg_8036702"*/,
          0LL),
        (userPointBgSprite = this->fields.nextPointBgSprite) == 0LL) )
  {
    sub_1BDBAD4(userPointBgSprite, v11);
  }
  ((void (__fastcall *)(struct UISprite_o *, Il2CppMethodPointer))userPointBgSprite->klass->vtable._33_MakePixelPerfect.method)(
    userPointBgSprite,
    userPointBgSprite->klass->vtable._34_get_minWidth.methodPtr);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4602E & 1) == 0 )
  {
    ...
    this = (EventInfoDiggingEventPointControl_o *)sub_1BDB878(&StringLiteral_5664/*"EVENT_POINT_COMMON_FORMAT_COUNT_STOP"*/, v3);
    byte_4B4602E = 1;
  }
  if ( v2->fields.eventUiValueEntityList )
  {
    ...
    this = (EventInfoDiggingEventPointControl_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5664/*"EVENT_POINT_COMMON_FORMAT_COUNT_STOP"*/, 0LL);
    if ( !nextPointLabel )
LABEL_12:
      sub_1BDBAD4(this, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B46030 & 1) == 0 )
  {
    sub_1BDB878(&long_TypeInfo, point);
  ...
  if ( !UnityEngine_Object__op_Equality(nextPointLabel, 0LL, 0LL) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v10 = LocalizationManager__Get((System_String_o *)StringLiteral_5663/*"EVENT_POINT_COMMON_FORMAT"*/, 0LL);
    v17 = point;
        ...
        const MethodInfo *method)
{
  ...
  {
    if ( !val )
      sub_1BDBAD4(HasMatchedType, v10);
...
void __fastcall EventInfoDiggingEventPointControl___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B46032 & 1) == 0 )
  {
    sub_1BDB878(&EventInfoDiggingEventPointControl___c_TypeInfo, v1);
    byte_4B46032 = 1;
  }
  v2 = (Il2CppObject *)sub_1BDBAC4(EventInfoDiggingEventPointControl___c_TypeInfo);
