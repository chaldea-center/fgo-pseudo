        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5BB1E & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_System_Linq_Enumerable_Any_QuestReleaseEntity___);
    ...
    sub_1B885B0(&Method_EventInfoDiggingEventPointControl___c__GetNextQuestReleaseEntity_b__14_0__);
    sub_1B885B0(&EventInfoDiggingEventPointControl___c_TypeInfo);
    byte_4A5BB1E = 1;
  }
  ...
  if ( !System_Linq_Enumerable__Any_object_(
          ...
          (const MethodInfo_2E8D2DC *)Method_System_Linq_Enumerable_Any_QuestReleaseEntity___) )
    return v9;
  ...
  if ( !v10 )
  {
    ...
    v10 = (System_Comparison_T__o *)sub_1B887FC(System_Comparison_QuestReleaseEntity__TypeInfo);
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)&static_fields->__9__14_0, (int32_t)v10, v13, v14);
  }
...
LABEL_34:
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  v15 = DataManager__GetMaster_object_((const MethodInfo_2E7F8B4 *)Method_DataManager_GetMaster_QuestMaster___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5BB1A & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_EventInfoDiggingEventPointControl__Initialization_b__7_0__);
    sub_1B885B0(&StringLiteral_19206/*"event_point_bg_8036701"*/);
    sub_1B885B0(&StringLiteral_19207/*"event_point_bg_8036702"*/);
    byte_4A5BB1A = 1;
  }
  ...
  System_Action___ctor(v7, (Il2CppObject *)this, Method_EventInfoDiggingEventPointControl__Initialization_b__7_0__, 0LL);
  ...
  EventInfoUIBase__SetSpriteByLocalAtlas(
    ...
    (System_String_o *)StringLiteral_19206/*"event_point_bg_8036701"*/,
    0LL);
  ...
  if ( !userPointBgSprite
    || (((void (__fastcall *)(struct UISprite_o *, Il2CppMethodPointer))userPointBgSprite->klass->vtable._33_MakePixelPerfect.method)(
        ...
        EventInfoUIBase__SetSpriteByLocalAtlas(
          ...
          (System_String_o *)StringLiteral_19207/*"event_point_bg_8036702"*/,
          0LL),
        (userPointBgSprite = this->fields.nextPointBgSprite) == 0LL) )
  {
    sub_1B8880C(userPointBgSprite, v8);
  }
  ((void (__fastcall *)(struct UISprite_o *, Il2CppMethodPointer))userPointBgSprite->klass->vtable._33_MakePixelPerfect.method)(
    userPointBgSprite,
    userPointBgSprite->klass->vtable._34_get_minWidth.methodPtr);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5BB1B & 1) == 0 )
  {
    ...
    this = (EventInfoDiggingEventPointControl_o *)sub_1B885B0(&StringLiteral_5645/*"EVENT_POINT_COMMON_FORMAT_COUNT_STOP"*/);
    byte_4A5BB1B = 1;
  }
  if ( v2->fields.eventUiValueEntityList )
  {
    ...
    this = (EventInfoDiggingEventPointControl_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5645/*"EVENT_POINT_COMMON_FORMAT_COUNT_STOP"*/, 0LL);
    if ( !nextPointLabel )
LABEL_12:
      sub_1B8880C(this, method);
        ...
        const MethodInfo *method)
{
  ...
  {
    if ( !val )
      sub_1B8880C(HasMatchedType, v10);
...
void __fastcall EventInfoDiggingEventPointControl___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1B887FC(EventInfoDiggingEventPointControl___c_TypeInfo);
