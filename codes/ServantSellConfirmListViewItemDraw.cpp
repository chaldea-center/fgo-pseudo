        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB0A87 & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_11703/*"SELECT_BONUS_SKILL_INVALID"*/, v8);
    sub_1C13D24(&StringLiteral_11699/*"SELECT"*/, v9);
    sub_1C13D24(&StringLiteral_12631/*"SUPPORT_INFO_HELP"*/, v10);
    ...
    this = (ServantSellConfirmListViewItemDraw_o *)sub_1C13D24(&StringLiteral_1/*""*/, v16);
    byte_4BB0A87 = 1;
  }
  if ( !isServant )
  {
...
LABEL_11:
  ...
  if ( UserServantEntity_k__BackingField && UserServantEntity__IsEventJoin(UserServantEntity_k__BackingField, 0LL) )
  {
    ...
    v18 = &StringLiteral_11717/*"SELECT_NO_SORTIE_FATIGURE"*/;
  ...
  if ( item->fields.attribute )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v18 = &StringLiteral_11693/*"SDK_INT"*/;
    return LocalizationManager__Get((System_String_o *)*v18, 0LL);
  }
LABEL_16:
  ...
  if ( item->fields._IsLock_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v18 = &StringLiteral_11703/*"SELECT_BONUS_SKILL_INVALID"*/;
    return LocalizationManager__Get((System_String_o *)*v18, 0LL);
  }
  if ( isServant )
  {
    if ( item->fields._IsFavorite_k__BackingField )
    {
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v18 = &StringLiteral_11699/*"SELECT"*/;
      return LocalizationManager__Get((System_String_o *)*v18, 0LL);
    }
    if ( item->fields._IsParty_k__BackingField )
    {
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v18 = &StringLiteral_11713/*"SELECT_ITEM"*/;
      return LocalizationManager__Get((System_String_o *)*v18, 0LL);
    }
    if ( item->fields._IsUseSupportServant_k__BackingField )
    {
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v18 = &StringLiteral_12631/*"SUPPORT_INFO_HELP"*/;
      return LocalizationManager__Get((System_String_o *)*v18, 0LL);
    }
  }
  if ( isCommandCode && item->fields._IsCommandCodeEquipped_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v18 = &StringLiteral_9468/*"NOT_HAVING_SHOP_ITEM_RECEIVABLE"*/;
    return LocalizationManager__Get((System_String_o *)*v18, 0LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB0A89 & 1) == 0 )
  {
    ...
    this = (ServantSellConfirmListViewItemDraw_o *)sub_1C13D24(&StringLiteral_23315/*"return"*/, v8);
    byte_4BB0A89 = 1;
  }
  if ( !item )
    goto LABEL_20;
  ...
  if ( v23 )
  {
    ...
    if ( item->fields._IsMaterialTdSvt_k__BackingField )
    {
      ...
      AtlasManager__SetEventSprite(v25, (System_String_o *)StringLiteral_23315/*"return"*/, 0LL);
    }
  }
    ...
    if ( dispMode )
    {
      ...
      if ( UserServantEntity_k__BackingField || UserCommandCodeEntity_k__BackingField )
      {
        ...
        if ( v14 )
        {
          ...
          FlashingIconComponent__Set_39267888(v16, IsParty_k__BackingField, 0LL);
        }
        ServantSellConfirmListViewItemDraw__SetSpriteActive(
        ...
        if ( UnityEngine_Object__op_Inequality(baseButton, 0LL, 0LL) )
        {
          ...
          {
LABEL_24:
            sub_1C13F80(v16, IsParty_k__BackingField);
          }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB0A86 & 1) == 0 )
  {
    sub_1C13D24(&TutorialFlag_TypeInfo, item);
    this = (ServantSellConfirmListViewItemDraw_o *)sub_1C13D24(&StringLiteral_1/*""*/, v11);
    byte_4BB0A86 = 1;
  }
  if ( !item )
    goto LABEL_17;
...
LABEL_15:
  ...
  if ( (unsigned int)(modeKind - 1) <= 1 )
  {
    ...
    this = (ServantSellConfirmListViewItemDraw_o *)TutorialFlag__Get_38831432(126, 0LL);
