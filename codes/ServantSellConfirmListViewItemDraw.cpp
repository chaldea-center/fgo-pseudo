        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E2B1 & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_11741/*"SHOP_BULK_WINDOW_DESTINATION"*/, v8);
    sub_1C3B764(&StringLiteral_11737/*"SHOP_BULK_WINDOW_AP_KIND"*/, v9);
    sub_1C3B764(&StringLiteral_12690/*"SqlTypeExceptionMessage"*/, v10);
    ...
    this = (ServantSellConfirmListViewItemDraw_o *)sub_1C3B764(&StringLiteral_1/*""*/, v16);
    byte_4C1E2B1 = 1;
  }
  if ( !isServant )
  {
...
LABEL_11:
  ...
  if ( UserServantEntity_k__BackingField && UserServantEntity__IsEventJoin(UserServantEntity_k__BackingField, 0LL) )
  {
    ...
    v18 = &StringLiteral_11755/*"SHOP_BUY_CONFIRM_CAN_SHOP_RESET_NO_LIMIT_MESSAGE"*/;
  ...
  if ( item->fields.attribute )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v18 = &StringLiteral_11731/*"SHOP_ACHIEVEMENT_FREE_EXCHANGE_CONDITIONS"*/;
    return LocalizationManager__Get((System_String_o *)*v18, 0LL);
  }
LABEL_16:
  if ( item->fields._IsChoice_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v18 = &StringLiteral_11732/*"SHOP_ACHIEVEMENT_PAID_EXCHANGE_CONDITIONS"*/;
    return LocalizationManager__Get((System_String_o *)*v18, 0LL);
  }
  if ( item->fields._IsLock_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v18 = &StringLiteral_11741/*"SHOP_BULK_WINDOW_DESTINATION"*/;
    return LocalizationManager__Get((System_String_o *)*v18, 0LL);
  }
  if ( isServant )
  {
    if ( item->fields._IsFavorite_k__BackingField )
    {
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v18 = &StringLiteral_11737/*"SHOP_BULK_WINDOW_AP_KIND"*/;
      return LocalizationManager__Get((System_String_o *)*v18, 0LL);
    }
    if ( item->fields._IsParty_k__BackingField )
    {
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v18 = &StringLiteral_11751/*"SHOP_BUY_COMMON_CONSUME_CONFIRM_WARNING"*/;
      return LocalizationManager__Get((System_String_o *)*v18, 0LL);
    }
    if ( item->fields._IsUseSupportServant_k__BackingField )
    {
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v18 = &StringLiteral_12690/*"SqlTypeExceptionMessage"*/;
      return LocalizationManager__Get((System_String_o *)*v18, 0LL);
    }
  }
  if ( isCommandCode && item->fields._IsCommandCodeEquipped_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v18 = &StringLiteral_9480/*"OPTION_SMOOTHNESS_BUTTON_2"*/;
    return LocalizationManager__Get((System_String_o *)*v18, 0LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E2B3 & 1) == 0 )
  {
    ...
    this = (ServantSellConfirmListViewItemDraw_o *)sub_1C3B764(&StringLiteral_23418/*"system.memory.free"*/, v8);
    byte_4C1E2B3 = 1;
  }
  if ( !item )
    goto LABEL_20;
  ...
  if ( v23 )
  {
    ...
    if ( item->fields._IsMaterialTdSvt_k__BackingField )
    {
      ...
      AtlasManager__SetEventSprite(v25, (System_String_o *)StringLiteral_23418/*"system.memory.free"*/, 0LL);
    }
  }
    ...
    if ( dispMode )
    {
      ...
      if ( UserServantEntity_k__BackingField || UserCommandCodeEntity_k__BackingField )
      {
        ...
        if ( v14 )
        {
          ...
          FlashingIconComponent__Set_39547472(v16, IsParty_k__BackingField, 0LL);
        }
        ServantSellConfirmListViewItemDraw__SetSpriteActive(
        ...
        if ( UnityEngine_Object__op_Inequality(baseButton, 0LL, 0LL) )
        {
          ...
          {
LABEL_24:
            sub_1C3B9C0(v16, IsParty_k__BackingField);
          }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E2B0 & 1) == 0 )
  {
    sub_1C3B764(&TutorialFlag_TypeInfo, item);
    this = (ServantSellConfirmListViewItemDraw_o *)sub_1C3B764(&StringLiteral_1/*""*/, v11);
    byte_4C1E2B0 = 1;
  }
  if ( !item )
    goto LABEL_17;
...
LABEL_15:
  ...
  if ( (unsigned int)(modeKind - 1) <= 1 )
  {
    ...
    this = (ServantSellConfirmListViewItemDraw_o *)TutorialFlag__Get_39109112(126, 0LL);
