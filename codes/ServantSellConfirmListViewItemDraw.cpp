...
int32_t __fastcall ServantSellConfirmListViewItemDraw__GetDispMode(int32_t initMode, const MethodInfo *method)
{
  if ( (unsigned int)(initMode - 1) > 2 )
    ...
    return dword_BF0730[initMode - 1];
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6C389 & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_11513/*"SELECT_LOCK"*/, v8);
    sub_1B90010(&StringLiteral_11509/*"SELECT_FAVORITE"*/, v9);
    sub_1B90010(&StringLiteral_12434/*"SUPPORT_MEMBER"*/, v10);
    sub_1B90010(&StringLiteral_11503/*"SELECT_CANNOT"*/, v11);
    sub_1B90010(&StringLiteral_11504/*"SELECT_CHOICE"*/, v12);
    sub_1B90010(&StringLiteral_11527/*"SELECT_SERVANT_EVENT_JOIN"*/, v13);
    sub_1B90010(&StringLiteral_11523/*"SELECT_PARTY"*/, v14);
    sub_1B90010(&StringLiteral_9294/*"NOT_SELECT_EQUIPED"*/, v15);
    this = (ServantSellConfirmListViewItemDraw_o *)sub_1B90010(&StringLiteral_1/*""*/, v16);
    byte_4A6C389 = 1;
  }
  if ( !isServant )
  {
...
LABEL_11:
  ...
  if ( UserServantEntity_k__BackingField && UserServantEntity__IsEventJoin(UserServantEntity_k__BackingField, 0LL) )
  {
    ...
    v18 = &StringLiteral_11527/*"SELECT_SERVANT_EVENT_JOIN"*/;
  ...
  if ( item->fields.attribute )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v18 = &StringLiteral_11503/*"SELECT_CANNOT"*/;
    return LocalizationManager__Get((System_String_o *)*v18, 0LL);
  }
LABEL_16:
  if ( item->fields._IsChoice_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v18 = &StringLiteral_11504/*"SELECT_CHOICE"*/;
    return LocalizationManager__Get((System_String_o *)*v18, 0LL);
  }
  if ( item->fields._IsLock_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v18 = &StringLiteral_11513/*"SELECT_LOCK"*/;
    return LocalizationManager__Get((System_String_o *)*v18, 0LL);
  }
  if ( isServant )
  {
    if ( item->fields._IsFavorite_k__BackingField )
    {
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v18 = &StringLiteral_11509/*"SELECT_FAVORITE"*/;
      return LocalizationManager__Get((System_String_o *)*v18, 0LL);
    }
    if ( item->fields._IsParty_k__BackingField )
    {
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v18 = &StringLiteral_11523/*"SELECT_PARTY"*/;
      return LocalizationManager__Get((System_String_o *)*v18, 0LL);
    }
    if ( item->fields._IsUseSupportServant_k__BackingField )
    {
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v18 = &StringLiteral_12434/*"SUPPORT_MEMBER"*/;
      return LocalizationManager__Get((System_String_o *)*v18, 0LL);
    }
  }
  if ( isCommandCode && item->fields._IsCommandCodeEquipped_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v18 = &StringLiteral_9294/*"NOT_SELECT_EQUIPED"*/;
    return LocalizationManager__Get((System_String_o *)*v18, 0LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6C38B & 1) == 0 )
  {
    ...
    this = (ServantSellConfirmListViewItemDraw_o *)sub_1B90010(&StringLiteral_22971/*"ribbon_noblephantasmup_01"*/, v8);
    byte_4A6C38B = 1;
  }
  if ( !item )
    goto LABEL_20;
  ...
  if ( v23 )
  {
    ...
    if ( item->fields._IsMaterialTdSvt_k__BackingField )
    {
      ...
      AtlasManager__SetEventSprite(v25, (System_String_o *)StringLiteral_22971/*"ribbon_noblephantasmup_01"*/, 0LL);
    }
  }
    ...
    if ( dispMode )
    {
      ...
      if ( UserServantEntity_k__BackingField || UserCommandCodeEntity_k__BackingField )
      {
        ...
        if ( v14 )
        {
          ...
          FlashingIconComponent__Set_38177124(v16, IsParty_k__BackingField, 0LL);
        }
        ServantSellConfirmListViewItemDraw__SetSpriteActive(
        ...
        if ( UnityEngine_Object__op_Inequality(baseButton, 0LL, 0LL) )
        {
          ...
          {
LABEL_24:
            sub_1B9026C(v16, IsParty_k__BackingField);
          }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6C388 & 1) == 0 )
  {
    sub_1B90010(&TutorialFlag_TypeInfo, item);
    this = (ServantSellConfirmListViewItemDraw_o *)sub_1B90010(&StringLiteral_1/*""*/, v11);
    byte_4A6C388 = 1;
  }
  if ( !item )
    goto LABEL_17;
...
LABEL_15:
  ...
  if ( (unsigned int)(modeKind - 1) <= 1 )
  {
    ...
    this = (ServantSellConfirmListViewItemDraw_o *)TutorialFlag__Get_37740444(126, 0LL);
