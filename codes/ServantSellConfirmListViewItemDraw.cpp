        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB21AF & 1) == 0 )
  {
    ...
    this = (ServantSellConfirmListViewItemDraw_o *)sub_1BAB41C(&StringLiteral_1/*""*/, v16);
    byte_4AB21AF = 1;
  }
  if ( !isServant )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB21B1 & 1) == 0 )
  {
    ...
    this = (ServantSellConfirmListViewItemDraw_o *)sub_1BAB41C(&StringLiteral_22976/*"ribbon_noblephantasmup_01"*/, v8);
    byte_4AB21B1 = 1;
  }
  if ( !item )
    goto LABEL_20;
  ...
  if ( v23 )
  {
    ...
    if ( item->fields._IsMaterialTdSvt_k__BackingField )
    {
      ...
      AtlasManager__SetEventSprite(v25, (System_String_o *)StringLiteral_22976/*"ribbon_noblephantasmup_01"*/, 0LL);
    }
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB21AE & 1) == 0 )
  {
    ...
    this = (ServantSellConfirmListViewItemDraw_o *)sub_1BAB41C(&StringLiteral_1/*""*/, v11);
    byte_4AB21AE = 1;
  }
  if ( !item )
    goto LABEL_17;
...
LABEL_15:
  ...
  if ( (unsigned int)(modeKind - 1) <= 1 )
  {
    ...
    this = (ServantSellConfirmListViewItemDraw_o *)TutorialFlag__Get_38072332(126, 0LL);
