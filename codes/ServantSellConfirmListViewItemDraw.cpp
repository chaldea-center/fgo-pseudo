...
int32_t __fastcall ServantSellConfirmListViewItemDraw__GetDispMode(int32_t initMode, const MethodInfo *method)
{
  if ( (unsigned int)(initMode - 1) > 2 )
    ...
    return dword_327E070[initMode - 1];
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B2135 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_11716/*"SELECT_LOCK"*/);
    sub_B52984(&StringLiteral_11712/*"SELECT_FAVORITE"*/);
    sub_B52984(&StringLiteral_12591/*"SUPPORT_MEMBER"*/);
    sub_B52984(&StringLiteral_11707/*"SELECT_CANNOT"*/);
    sub_B52984(&StringLiteral_11708/*"SELECT_CHOICE"*/);
    sub_B52984(&StringLiteral_11730/*"SELECT_SERVANT_EVENT_JOIN"*/);
    sub_B52984(&StringLiteral_11726/*"SELECT_PARTY"*/);
    sub_B52984(&StringLiteral_9403/*"NOT_SELECT_EQUIPED"*/);
    this = (ServantSellConfirmListViewItemDraw_o *)sub_B52984(&StringLiteral_1/*""*/);
    byte_42B2135 = 1;
  }
  if ( !isServant )
  {
...
LABEL_12:
  ...
  if ( UserServantEntity_k__BackingField && UserServantEntity__IsEventJoin(UserServantEntity_k__BackingField, 0LL) )
  {
    ...
    v9 = &StringLiteral_11730/*"SELECT_SERVANT_EVENT_JOIN"*/;
  ...
  if ( item->fields.attribute )
  {
    ...
    v9 = &StringLiteral_11707/*"SELECT_CANNOT"*/;
    return LocalizationManager__Get((System_String_o *)*v9, 0LL);
  }
LABEL_18:
  if ( item->fields._IsChoice_k__BackingField )
  {
    ...
    v9 = &StringLiteral_11708/*"SELECT_CHOICE"*/;
    return LocalizationManager__Get((System_String_o *)*v9, 0LL);
  }
  if ( item->fields._IsLock_k__BackingField )
  {
    ...
    v9 = &StringLiteral_11716/*"SELECT_LOCK"*/;
    return LocalizationManager__Get((System_String_o *)*v9, 0LL);
  }
  if ( isServant )
  {
    if ( item->fields._IsFavorite_k__BackingField )
    {
      ...
      v9 = &StringLiteral_11712/*"SELECT_FAVORITE"*/;
      return LocalizationManager__Get((System_String_o *)*v9, 0LL);
    }
    if ( item->fields._IsParty_k__BackingField )
    {
      ...
      v9 = &StringLiteral_11726/*"SELECT_PARTY"*/;
      return LocalizationManager__Get((System_String_o *)*v9, 0LL);
    }
    if ( item->fields._IsUseSupportServant_k__BackingField )
    {
      ...
      v9 = &StringLiteral_12591/*"SUPPORT_MEMBER"*/;
      return LocalizationManager__Get((System_String_o *)*v9, 0LL);
    }
  }
  if ( isCommandCode && item->fields._IsCommandCodeEquipped_k__BackingField )
  {
    ...
    v9 = &StringLiteral_9403/*"NOT_SELECT_EQUIPED"*/;
    return LocalizationManager__Get((System_String_o *)*v9, 0LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B2137 & 1) == 0 )
  {
    ...
    this = (ServantSellConfirmListViewItemDraw_o *)sub_B52984(&StringLiteral_22010/*"ribbon_noblephantasmup_01"*/);
    byte_42B2137 = 1;
  }
  if ( !item )
    goto LABEL_22;
  ...
  if ( v21 )
  {
    ...
    if ( item->fields._IsMaterialTdSvt_k__BackingField )
    {
      ...
      AtlasManager__SetEventSprite(v23, (System_String_o *)StringLiteral_22010/*"ribbon_noblephantasmup_01"*/, 0LL);
    }
  }
    ...
    if ( dispMode )
    {
      ...
      if ( UserServantEntity_k__BackingField || UserCommandCodeEntity_k__BackingField )
      {
        ...
        if ( v14 )
        {
          ...
          FlashingIconComponent__Set_22571356(v16, IsParty_k__BackingField, 0LL);
        }
        ServantSellConfirmListViewItemDraw__SetSpriteActive(
        ...
        if ( UnityEngine_Object__op_Inequality(baseButton, 0LL, 0LL) )
        {
          ...
          {
LABEL_26:
            sub_B52A5C(v16, IsParty_k__BackingField);
          }
...
LABEL_16:
  ...
  if ( (unsigned int)(modeKind - 1) <= 1 )
  {
    ...
    this = (ServantSellConfirmListViewItemDraw_o *)TutorialFlag__Get_29217932(126, 0LL);
