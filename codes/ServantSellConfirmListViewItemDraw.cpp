        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C52E96 & 1) == 0 )
  {
    ...
    this = (ServantSellConfirmListViewItemDraw_o *)sub_1C3E564(&StringLiteral_1/*""*/);
    byte_4C52E96 = 1;
  }
  if ( !isServant )
  {
...
LABEL_16:
  ...
  if ( isCommandCode && item->fields._IsCommandCodeEquipped_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v9 = &StringLiteral_9317/*"NOT_SELECT_EQUIPED"*/;
    return LocalizationManager__Get((System_String_o *)*v9, 0);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C52E98 & 1) == 0 )
  {
    ...
    this = (ServantSellConfirmListViewItemDraw_o *)sub_1C3E564(&StringLiteral_23131/*"ribbon_noblephantasmup_01"*/);
    byte_4C52E98 = 1;
  }
  if ( !item )
    goto LABEL_20;
  ...
  if ( v21 )
  {
    ...
    if ( item->fields._IsMaterialTdSvt_k__BackingField )
    {
      ...
      AtlasManager__SetEventSprite(v23, (System_String_o *)StringLiteral_23131/*"ribbon_noblephantasmup_01"*/, 0);
    }
  }
    ...
    if ( dispMode )
    {
      ...
      if ( UserServantEntity_k__BackingField || UserCommandCodeEntity_k__BackingField )
      {
        ...
        if ( v16 )
        {
          ...
          FlashingIconComponent__Set_40947528((FlashingIconComponent_o *)servantFaceIcon, IsParty_k__BackingField, 0);
        }
        ServantSellConfirmListViewItemDraw__SetSpriteActive(
        ...
        if ( UnityEngine_Object__op_Inequality(baseButton, 0, 0) )
        {
          ...
          {
LABEL_25:
            sub_1C3E7C0(servantFaceIcon, IsParty_k__BackingField);
          }
...
LABEL_15:
  ...
  if ( (unsigned int)(modeKind - 1) <= 1 )
  {
    ...
    this = (ServantSellConfirmListViewItemDraw_o *)TutorialFlag__Get_40473944(126, 0);
