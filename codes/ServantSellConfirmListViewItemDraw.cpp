...
int32_t __fastcall ServantSellConfirmListViewItemDraw__GetDispMode(int32_t initMode, const MethodInfo *method)
{
  if ( (unsigned int)(initMode - 1) > 2 )
    ...
    return dword_BE3BD4[initMode - 1];
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C038 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_11465/*"SELECT_LOCK"*/, v8);
    sub_1B715CC(&StringLiteral_11461/*"SELECT_FAVORITE"*/, v9);
    sub_1B715CC(&StringLiteral_12368/*"SUPPORT_MEMBER"*/, v10);
    sub_1B715CC(&StringLiteral_11455/*"SELECT_CANNOT"*/, v11);
    sub_1B715CC(&StringLiteral_11456/*"SELECT_CHOICE"*/, v12);
    sub_1B715CC(&StringLiteral_11479/*"SELECT_SERVANT_EVENT_JOIN"*/, v13);
    sub_1B715CC(&StringLiteral_11475/*"SELECT_PARTY"*/, v14);
    sub_1B715CC(&StringLiteral_9258/*"NOT_SELECT_EQUIPED"*/, v15);
    this = (ServantSellConfirmListViewItemDraw_o *)sub_1B715CC(&StringLiteral_1/*""*/, v16);
    byte_4A1C038 = 1;
  }
  if ( !isServant )
  {
...
LABEL_11:
  ...
  if ( UserServantEntity_k__BackingField && UserServantEntity__IsEventJoin(UserServantEntity_k__BackingField, 0LL) )
  {
    ...
    v18 = &StringLiteral_11479/*"SELECT_SERVANT_EVENT_JOIN"*/;
  ...
  if ( item->fields.attribute )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v18 = &StringLiteral_11455/*"SELECT_CANNOT"*/;
    return LocalizationManager__Get((System_String_o *)*v18, 0LL);
  }
LABEL_16:
  if ( item->fields._IsChoice_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v18 = &StringLiteral_11456/*"SELECT_CHOICE"*/;
    return LocalizationManager__Get((System_String_o *)*v18, 0LL);
  }
  if ( item->fields._IsLock_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v18 = &StringLiteral_11465/*"SELECT_LOCK"*/;
    return LocalizationManager__Get((System_String_o *)*v18, 0LL);
  }
  if ( isServant )
  {
    if ( item->fields._IsFavorite_k__BackingField )
    {
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v18 = &StringLiteral_11461/*"SELECT_FAVORITE"*/;
      return LocalizationManager__Get((System_String_o *)*v18, 0LL);
    }
    if ( item->fields._IsParty_k__BackingField )
    {
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v18 = &StringLiteral_11475/*"SELECT_PARTY"*/;
      return LocalizationManager__Get((System_String_o *)*v18, 0LL);
    }
    if ( item->fields._IsUseSupportServant_k__BackingField )
    {
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v18 = &StringLiteral_12368/*"SUPPORT_MEMBER"*/;
      return LocalizationManager__Get((System_String_o *)*v18, 0LL);
    }
  }
  if ( isCommandCode && item->fields._IsCommandCodeEquipped_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v18 = &StringLiteral_9258/*"NOT_SELECT_EQUIPED"*/;
    return LocalizationManager__Get((System_String_o *)*v18, 0LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C03A & 1) == 0 )
  {
    ...
    this = (ServantSellConfirmListViewItemDraw_o *)sub_1B715CC(&StringLiteral_22879/*"ribbon_noblephantasmup_01"*/, v8);
    byte_4A1C03A = 1;
  }
  if ( !item )
    goto LABEL_20;
  ...
  if ( v23 )
  {
    ...
    if ( item->fields._IsMaterialTdSvt_k__BackingField )
    {
      ...
      AtlasManager__SetEventSprite(v25, (System_String_o *)StringLiteral_22879/*"ribbon_noblephantasmup_01"*/, 0LL);
    }
  }
    ...
    if ( dispMode )
    {
      ...
      if ( UserServantEntity_k__BackingField || UserCommandCodeEntity_k__BackingField )
      {
        ...
        if ( v14 )
        {
          ...
          FlashingIconComponent__Set_37921456(v16, IsParty_k__BackingField, 0LL);
        }
        ServantSellConfirmListViewItemDraw__SetSpriteActive(
        ...
        if ( UnityEngine_Object__op_Inequality(baseButton, 0LL, 0LL) )
        {
          ...
          {
LABEL_24:
            sub_1B71828(v16, IsParty_k__BackingField);
          }
...
LABEL_10:
  ...
  if ( isCommandCode )
  {
    ...
    if ( !this )
      goto LABEL_10;
    ServantFaceIconComponent__Set_38021480(
      (ServantFaceIconComponent_o *)this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C037 & 1) == 0 )
  {
    sub_1B715CC(&TutorialFlag_TypeInfo, item);
    this = (ServantSellConfirmListViewItemDraw_o *)sub_1B715CC(&StringLiteral_1/*""*/, v11);
    byte_4A1C037 = 1;
  }
  if ( !item )
    goto LABEL_17;
...
LABEL_15:
  ...
  if ( (unsigned int)(modeKind - 1) <= 1 )
  {
    ...
    this = (ServantSellConfirmListViewItemDraw_o *)TutorialFlag__Get_37486428(126, 0LL);
