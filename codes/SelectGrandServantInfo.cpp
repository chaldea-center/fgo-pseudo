...
{
  SelectGrandServantInfo___c__DisplayClass28_0_o *v7; // x21
  ...
  if ( (byte_4D2B500 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_System_Linq_Enumerable_Any_UserServantEntity___);
    sub_1C93AD4(&System_Func_UserServantEntity__bool__TypeInfo);
    sub_1C93AD4(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    sub_1C93AD4(&Method_SelectGrandServantInfo___c__DisplayClass28_0___ctor_b__0__);
    sub_1C93AD4(&SelectGrandServantInfo___c__DisplayClass28_0_TypeInfo);
    byte_4D2B500 = 1;
  }
  entity = 0;
  System_Object___ctor((Il2CppObject *)this, 0);
  v7 = (SelectGrandServantInfo___c__DisplayClass28_0_o *)sub_1C93D20(SelectGrandServantInfo___c__DisplayClass28_0_TypeInfo);
  SelectGrandServantInfo___c__DisplayClass28_0___ctor(v7, 0);
  this->fields._UserServantEntity_k__BackingField = userServantEntity;
  p_fields = &this->fields;
  sub_1C93A78(&this->fields, userServantEntity);
  ...
  if ( GrandGraphDetailMaster__TryGetEntity(v11, &entity, id, (int32_t)Master_object, 0) )
  {
    ...
    sub_1C93A78(&this->fields._GrandGraphDetailEntity_k__BackingField, v13);
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (GrandGraphDetailMaster_o *)DataManager__GetMaster_object_((const MethodInfo_31A49E8 *)Method_DataManager_GetMaster_UserServantGrandMaster___);
  if ( this->fields._IsValid_k__BackingField )
  {
    ...
    *(_QWORD *)&v25.fields.fakeValue = v16;
    Master_object = (GrandGraphDetailMaster_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49654028(
                                                  v25,
                                                  0);
    if ( !v15 )
      goto LABEL_31;
    ...
    if ( this->fields._IsValid_k__BackingField )
    {
      ...
      if ( Master_object )
      {
        ...
        if ( v18 )
        {
          ...
          if ( v7 )
          {
            v7->fields.checkClassId = (int)Master_object;
            UserServantEntities = UserServantGrandMaster__GetUserServantEntities(v15, 0);
            v20 = (System_Func_object__bool__o *)sub_1C93D20(System_Func_UserServantEntity__bool__TypeInfo);
            System_Func_object__bool____ctor(
              v20,
              (Il2CppObject *)v7,
              Method_SelectGrandServantInfo___c__DisplayClass28_0___ctor_b__0__,
              0);
            v21 = System_Linq_Enumerable__Any_object__52110824(
                    (System_Collections_Generic_IEnumerable_TSource__o *)UserServantEntities,
                    (System_Func_TSource__bool__o *)v20,
                    (const MethodInfo_31B25E8 *)Method_System_Linq_Enumerable_Any_UserServantEntity___);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C93A78(&this->fields._GrandGraphDetailEntity_k__BackingField, value);
}
