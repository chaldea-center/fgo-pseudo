...
void LimitCntUpItemComponent__CloseItemDetail(LimitCntUpItemComponent_o *this, bool isDecide, const MethodInfo *method)
{
  ...
  if ( (byte_4C5AD3F & 1) == 0 )
  {
    sub_1C3E564(&Method_LimitCntUpItemComponent_CloseItemDetail__);
  ...
  if ( (*((_BYTE *)Method_LimitCntUpItemComponent_CloseItemDetail__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C3E57C(Method_LimitCntUpItemComponent_CloseItemDetail__);
...
void LimitCntUpItemComponent__OnClickItem(LimitCntUpItemComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C5AD3E & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_LimitCntUpItemComponent_CloseItemDetail__);
    sub_1C3E564(&Method_LimitCntUpItemComponent_OnClickItem__);
  ...
  if ( !this->fields.disableOpenItemDetailDialog )
  {
    ...
    if ( (*((_BYTE *)Method_LimitCntUpItemComponent_OnClickItem__ + 83) & 2) != 0 )
      v6 = (_QWORD *)sub_1C3E57C(Method_LimitCntUpItemComponent_OnClickItem__);
...
void LimitCntUpItemComponent__SetItemEntity(LimitCntUpItemComponent_o *this, int32_t id, const MethodInfo *method)
{
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.itemEnt, (int32_t)Entity, v8, v9);
}
...
void LimitCntUpItemComponent__SetItemIcon(LimitCntUpItemComponent_o *this, int32_t itemId, const MethodInfo *method)
{
  ...
  itemInfo = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39FF5A8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !itemInfo )
    goto LABEL_10;
  ...
  if ( !itemInfo
    || (Entity = DataMasterBase_object__object__int___GetEntity(
                   ...
                   (const MethodInfo_33B2F58 *)Method_DataMasterBase_ItemMaster__ItemEntity__int__GetEntity__),
        this->fields.itemEnt = (struct ItemEntity_o *)Entity,
        sub_1C3E508((CGThumbnailListItem_o *)&this->fields.itemEnt, (int32_t)Entity, v7, v8),
  ...
  {
LABEL_10:
    sub_1C3E7C0(itemInfo, *(_QWORD *)&itemId);
  }
        ...
        const MethodInfo *method)
{
  ...
  UserItemEntity_o *v42; // [xsp+38h] [xbp-38h] BYREF
  ...
  if ( (byte_4C5AD3B & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_3597/*"COMBINE_ITEM_INFO_HAVE"*/);
    sub_1C3E564(&StringLiteral_3598/*"COMBINE_ITEM_INFO_NEED"*/);
    byte_4C5AD3B = 1;
  }
  v42 = 0;
  entity = 0;
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.itemEnt, (int32_t)v11, v13, v14);
  ...
  if ( itemEnt->fields.type == 29 )
  {
    ...
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataManager__GetMaster_object_((const MethodInfo_30F9A1C *)Method_DataManager_GetMaster_UserSvtCoinMaster___);
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataManager__GetMaster_object_((const MethodInfo_30F9A1C *)Method_DataManager_GetMaster_UserItemMaster___);
  if ( !Master_object )
    goto LABEL_39;
...
LABEL_21:
  ...
  v26 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &haveItemNum, v20, v21, v22, v23, v24, v25);
  ...
  v34 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &needItemNum, v28, v29, v30, v31, v32, v33);
  Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)System_String__Format(
                                                                  (System_String_o *)StringLiteral_25072/*"{0:#,0}"*/,
                                                                  v34,
                                                                  0);
...
LABEL_36:
  ...
  v45.fields.b = v36;
  v45.fields.a = v38;
  UIWidget__set_color((UIWidget_o *)Master_object, v45, 0);
