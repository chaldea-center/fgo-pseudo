...
void LimitCntUpItemComponent__CloseItemDetail(LimitCntUpItemComponent_o *this, bool isDecide, const MethodInfo *method)
{
  ...
  if ( (byte_4D34ABD & 1) == 0 )
  {
    sub_1C93AD4(&Method_LimitCntUpItemComponent_CloseItemDetail__);
  ...
  if ( (*((_BYTE *)Method_LimitCntUpItemComponent_CloseItemDetail__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C93AEC(Method_LimitCntUpItemComponent_CloseItemDetail__);
...
void LimitCntUpItemComponent__OnClickItem(LimitCntUpItemComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D34ABC & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_LimitCntUpItemComponent_CloseItemDetail__);
    sub_1C93AD4(&Method_LimitCntUpItemComponent_OnClickItem__);
  ...
  if ( !this->fields.disableOpenItemDetailDialog )
  {
    ...
    if ( (*((_BYTE *)Method_LimitCntUpItemComponent_OnClickItem__ + 83) & 2) != 0 )
      v6 = (_QWORD *)sub_1C93AEC(Method_LimitCntUpItemComponent_OnClickItem__);
    v7 = (System_Reflection_MethodBase_o *)sub_1C93AB8(v6, v6[4]);
    OverwriteAssetSoundName__PlaySystemSe(v7, 0, 0, 0);
    gameObject = (UnityEngine_Component_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3AC52FC *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    if ( gameObject )
    {
      ...
      {
        v12 = (ItemLinkInfoWindowComponent_CallbackFunc_o *)sub_1C93D20(ItemLinkInfoWindowComponent_CallbackFunc_TypeInfo);
...
void LimitCntUpItemComponent__SetItemEntity(LimitCntUpItemComponent_o *this, int32_t id, const MethodInfo *method)
{
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.itemEnt, (int32_t)Entity, v8, v9, v10, v11, v12, v13);
}
...
void LimitCntUpItemComponent__SetItemIcon(LimitCntUpItemComponent_o *this, int32_t itemId, const MethodInfo *method)
{
  ...
  itemInfo = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3AC52FC *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !itemInfo )
    goto LABEL_10;
  ...
  if ( !itemInfo
    || (Entity = DataMasterBase_object__object__int___GetEntity(
                   ...
                   (const MethodInfo_3463274 *)Method_DataMasterBase_ItemMaster__ItemEntity__int__GetEntity__),
        this->fields.itemEnt = (struct ItemEntity_o *)Entity,
        sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.itemEnt, (int32_t)Entity, v7, v8, v9, v10, v11, v12),
  ...
  {
LABEL_10:
    sub_1C93D2C(itemInfo, *(_QWORD *)&itemId);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D34AB9 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_3618/*"COMBINE_ITEM_INFO_HAVE"*/);
    sub_1C93AD4(&StringLiteral_3619/*"COMBINE_ITEM_INFO_NEED"*/);
    byte_4D34AB9 = 1;
  }
  v34 = 0;
  entity = 0;
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.itemEnt, (int32_t)v11, v13, v14, v15, v16, v17, v18);
  ...
  if ( itemEnt->fields.type == 29 )
  {
    ...
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataManager__GetMaster_object_((const MethodInfo_31A49E8 *)Method_DataManager_GetMaster_UserSvtCoinMaster___);
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataManager__GetMaster_object_((const MethodInfo_31A49E8 *)Method_DataManager_GetMaster_UserItemMaster___);
  if ( !Master_object )
    goto LABEL_39;
...
LABEL_21:
  ...
  Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)LocalizationManager__Get(
                                                                  (System_String_o *)StringLiteral_3619/*"COMBINE_ITEM_INFO_NEED"*/,
                                                                  0);
  if ( !needTitleLb )
    goto LABEL_39;
  ...
  Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)LocalizationManager__Get(
                                                                  (System_String_o *)StringLiteral_3618/*"COMBINE_ITEM_INFO_HAVE"*/,
                                                                  0);
  if ( !haveTitleLb )
    goto LABEL_39;
