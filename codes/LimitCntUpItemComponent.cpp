        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05DC5 & 1) == 0 )
  {
    sub_1BC3008(&Method_LimitCntUpItemComponent_CloseItemDetail__, isDecide);
  ...
  if ( (*((_BYTE *)Method_LimitCntUpItemComponent_CloseItemDetail__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1BC3020(Method_LimitCntUpItemComponent_CloseItemDetail__);
...
void __fastcall LimitCntUpItemComponent__OnClickItem(LimitCntUpItemComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B05DC4 & 1) == 0 )
  {
    sub_1BC3008(&ItemLinkInfoWindowComponent_CallbackFunc_TypeInfo, method);
    sub_1BC3008(&ItemDetailInfoComponent_CallbackFunc_TypeInfo, v3);
    sub_1BC3008(&Method_LimitCntUpItemComponent_CloseItemDetail__, v4);
    sub_1BC3008(&Method_LimitCntUpItemComponent_OnClickItem__, v5);
  ...
  if ( !this->fields.disableOpenItemDetailDialog )
  {
    ...
    if ( (*((_BYTE *)Method_LimitCntUpItemComponent_OnClickItem__ + 83) & 2) != 0 )
      v11 = (_QWORD *)sub_1BC3020(Method_LimitCntUpItemComponent_OnClickItem__);
    v12 = (System_Reflection_MethodBase_o *)sub_1BC2FEC(v11, v11[4]);
    OverwriteAssetSoundName__PlaySystemSe(v12, 0, 0, 0LL);
    gameObject = (UnityEngine_Component_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38DFD48 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    if ( gameObject )
    {
      ...
      {
        v18 = (ItemDetailInfoComponent_CallbackFunc_o *)sub_1BC3254(ItemDetailInfoComponent_CallbackFunc_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05DC3 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMaster_ItemMaster___, *(_QWORD *)&id);
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.itemEnt, (int32_t)Entity, v10, v11);
}
        ...
        const MethodInfo *method)
{
  ...
  itemInfo = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38DFD48 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !itemInfo )
    goto LABEL_10;
  ...
  if ( !itemInfo
    || (Entity = DataMasterBase_object__object__int___GetEntity(
                   ...
                   (const MethodInfo_32AF070 *)Method_DataMasterBase_ItemMaster__ItemEntity__int__GetEntity__),
        this->fields.itemEnt = (struct ItemEntity_o *)Entity,
        sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.itemEnt, (int32_t)Entity, v9, v10),
  ...
  {
LABEL_10:
    sub_1BC3264(itemInfo, *(_QWORD *)&itemId);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05DC1 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMaster_ItemMaster___, usrId);
    sub_1BC3008(&Method_DataManager_GetMaster_UserItemMaster___, v9);
    sub_1BC3008(&Method_DataManager_GetMaster_UserSvtCoinMaster___, v10);
    ...
    sub_1BC3008(&StringLiteral_24811/*"{0:#,0}"*/, v15);
    sub_1BC3008(&StringLiteral_3560/*"COMBINE_ITEM_INFO_HAVE"*/, v16);
    sub_1BC3008(&StringLiteral_3561/*"COMBINE_ITEM_INFO_NEED"*/, v17);
    byte_4B05DC1 = 1;
  }
  v45 = 0LL;
  entity = 0LL;
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.itemEnt, (int32_t)v20, v22, v23);
  ...
  if ( itemEnt->fields.type == 29 )
  {
    ...
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataManager__GetMaster_object_((const MethodInfo_3001E10 *)Method_DataManager_GetMaster_UserSvtCoinMaster___);
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataManager__GetMaster_object_((const MethodInfo_3001E10 *)Method_DataManager_GetMaster_UserItemMaster___);
  if ( !Master_object )
    goto LABEL_39;
...
LABEL_21:
  ...
  Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)LocalizationManager__Get(
                                                                  (System_String_o *)StringLiteral_3561/*"COMBINE_ITEM_INFO_NEED"*/,
                                                                  0LL);
  if ( !needTitleLb )
    goto LABEL_39;
  ...
  Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)LocalizationManager__Get(
                                                                  (System_String_o *)StringLiteral_3560/*"COMBINE_ITEM_INFO_HAVE"*/,
                                                                  0LL);
  if ( !haveTitleLb )
    goto LABEL_39;
