...
void __fastcall SerialCodeComponent__onCloseWebView(SerialCodeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BF9043 & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_3641/*"CLOSE_SERIAL_CODE"*/, method);
    byte_4BF9043 = 1;
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
...
bool __fastcall SerialCodeComponent__openMenu(SerialCodeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BF9042 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_SerialCodeComponent_onCloseWebView__, v4);
    sub_1C2E12C(&WebViewManager_TypeInfo, v5);
    sub_1C2E12C(&StringLiteral_15832/*"WEB_VIEW_TITLE_SERIAL_CODE"*/, v6);
    sub_1C2E12C(&StringLiteral_12865/*"SerialCodeTop"*/, v7);
    byte_4BF9042 = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  if ( !gameObject )
  ...
  v10 = LocalizationManager__Get((System_String_o *)StringLiteral_15832/*"WEB_VIEW_TITLE_SERIAL_CODE"*/, 0LL);
  ...
  WebViewManager__OpenViewDynamic(v10, (System_String_o *)StringLiteral_12865/*"SerialCodeTop"*/, v11, 0LL);
  return 1;
}
