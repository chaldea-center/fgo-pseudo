...
bool SerialCodeComponent__openMenu(SerialCodeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2BF14 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_SerialCodeComponent_onCloseWebView__);
    sub_1C93AD4(&WebViewManager_TypeInfo);
    sub_1C93AD4(&StringLiteral_15652/*"WEB_VIEW_TITLE_SERIAL_CODE"*/);
    sub_1C93AD4(&StringLiteral_12807/*"SerialCodeTop"*/);
    byte_4D2BF14 = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0);
  if ( !gameObject )
  ...
  v5 = LocalizationManager__Get((System_String_o *)StringLiteral_15652/*"WEB_VIEW_TITLE_SERIAL_CODE"*/, 0);
  ...
  WebViewManager__OpenViewDynamic(v5, (System_String_o *)StringLiteral_12807/*"SerialCodeTop"*/, v6, 0);
  return 1;
}
