...
bool SerialCodeComponent__openMenu(SerialCodeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C229BB & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_SerialCodeComponent_onCloseWebView__);
    sub_1C2D490(&WebViewManager_TypeInfo);
    sub_1C2D490(&StringLiteral_15550/*"WEB_VIEW_TITLE_SERIAL_CODE"*/);
    sub_1C2D490(&StringLiteral_12704/*"SerialCodeTop"*/);
    byte_4C229BB = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0);
  if ( !gameObject )
  ...
  WebViewManager__OpenViewDynamic(v5, (System_String_o *)StringLiteral_12704/*"SerialCodeTop"*/, v6, 0);
  return 1;
}
