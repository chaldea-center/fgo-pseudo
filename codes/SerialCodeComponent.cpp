...
bool SerialCodeComponent__openMenu(SerialCodeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E72B7D & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_SerialCodeComponent_onCloseWebView__);
    sub_1D0F0B4(&WebViewManager_TypeInfo);
    sub_1D0F0B4(&StringLiteral_15756/*"WEB_VIEW_TITLE_SERIAL_CODE"*/);
    sub_1D0F0B4(&StringLiteral_12895/*"SerialCodeTop"*/);
    byte_4E72B7D = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0);
  if ( !gameObject )
  ...
  v5 = LocalizationManager__Get((System_String_o *)StringLiteral_15756/*"WEB_VIEW_TITLE_SERIAL_CODE"*/, 0);
  ...
  WebViewManager__OpenViewDynamic(v5, (System_String_o *)StringLiteral_12895/*"SerialCodeTop"*/, v6, 0);
  return 1;
}
