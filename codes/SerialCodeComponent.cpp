...
void __fastcall SerialCodeComponent__onCloseWebView(SerialCodeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1D84A & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_3641/*"COMMAND_SPELL_BATTLE_SAVEKEY"*/, method);
    byte_4C1D84A = 1;
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
...
bool __fastcall SerialCodeComponent__openMenu(SerialCodeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1D849 & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_SerialCodeComponent_onCloseWebView__, v4);
    sub_1C3B764(&WebViewManager_TypeInfo, v5);
    sub_1C3B764(&StringLiteral_15860/*"_FaceInfo"*/, v6);
    sub_1C3B764(&StringLiteral_12893/*"System attribute '{0}' is an invalid URI."*/, v7);
    byte_4C1D849 = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  if ( !gameObject )
  ...
  v10 = LocalizationManager__Get((System_String_o *)StringLiteral_15860/*"_FaceInfo"*/, 0LL);
  ...
  WebViewManager__OpenViewDynamic(v10, (System_String_o *)StringLiteral_12893/*"System attribute '{0}' is an invalid URI."*/, v11, 0LL);
  return 1;
}
