...
bool SerialCodeComponent__openMenu(SerialCodeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596BC8F & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_SerialCodeComponent_onCloseWebView__);
    sub_2213A60(&WebViewManager_TypeInfo);
    sub_2213A60(&StringLiteral_16164/*"WEB_VIEW_TITLE_SERIAL_CODE"*/);
    sub_2213A60(&StringLiteral_13247/*"SerialCodeTop"*/);
    byte_596BC8F = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0);
  if ( !gameObject )
  ...
  v7 = LocalizationManager__Get((System_String_o *)StringLiteral_16164/*"WEB_VIEW_TITLE_SERIAL_CODE"*/, 0);
  ...
  WebViewManager__OpenViewDynamic(v7, (System_String_o *)StringLiteral_13247/*"SerialCodeTop"*/, v8, 0);
  return 1;
}
