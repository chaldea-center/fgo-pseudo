...
void __fastcall SerialCodeComponent__onCloseWebView(SerialCodeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6255C & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_3638/*"CLOSE_SERIAL_CODE"*/, method);
    byte_4B6255C = 1;
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
...
bool __fastcall SerialCodeComponent__openMenu(SerialCodeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6255B & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_SerialCodeComponent_onCloseWebView__, v4);
    sub_1BE4ACC(&WebViewManager_TypeInfo, v5);
    sub_1BE4ACC(&StringLiteral_15758/*"WEB_VIEW_TITLE_SERIAL_CODE"*/, v6);
    sub_1BE4ACC(&StringLiteral_12804/*"SerialCodeTop"*/, v7);
    byte_4B6255B = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  if ( !gameObject )
  ...
  v10 = LocalizationManager__Get((System_String_o *)StringLiteral_15758/*"WEB_VIEW_TITLE_SERIAL_CODE"*/, 0LL);
  ...
  WebViewManager__OpenViewDynamic(v10, (System_String_o *)StringLiteral_12804/*"SerialCodeTop"*/, v11, 0LL);
  return 1;
}
