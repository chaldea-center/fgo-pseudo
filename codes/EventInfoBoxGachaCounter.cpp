void __fastcall EventInfoBoxGachaCounter___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A2EA22 & 1) == 0 )
  {
    sub_1B761C0(&EventInfoBoxGachaCounter_TypeInfo, v1);
    byte_4A2EA22 = 1;
  }
...
int64_t __fastcall EventInfoBoxGachaCounter__GetNextCount(EventInfoBoxGachaCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2EA21 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_DataManager_GetMasterData_QuestReleaseMaster___, v5);
    sub_1B761C0(&Method_System_Linq_Enumerable_FirstOrDefault_QuestReleaseEntity___, v6);
    sub_1B761C0(&Method_System_Linq_Enumerable_OrderBy_long__long___, v7);
    sub_1B761C0(&Method_System_Linq_Enumerable_ToList_long___, v8);
    sub_1B761C0(&Method_System_Collections_Generic_List_Enumerator_long__Dispose__, v9);
    sub_1B761C0(&Method_System_Collections_Generic_List_Enumerator_long__MoveNext__, v10);
    sub_1B761C0(&Method_System_Collections_Generic_List_Enumerator_long__get_Current__, v11);
    sub_1B761C0(&System_Func_long__long__TypeInfo, v12);
    sub_1B761C0(&System_Func_QuestReleaseEntity__bool__TypeInfo, v13);
    ...
    sub_1B761C0(&Method_System_Collections_Generic_List_long__Add__, v17);
    sub_1B761C0(&Method_System_Collections_Generic_List_long__GetEnumerator__, v18);
    sub_1B761C0(&Method_System_Collections_Generic_List_long___ctor__, v19);
    sub_1B761C0(&System_Collections_Generic_List_long__TypeInfo, v20);
    sub_1B761C0(&QuestEntity_TypeInfo, v21);
    sub_1B761C0(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v22);
    sub_1B761C0(&Method_EventInfoBoxGachaCounter___c__GetNextCount_b__21_0__, v23);
    sub_1B761C0(&Method_EventInfoBoxGachaCounter___c__GetNextCount_b__21_1__, v24);
    sub_1B761C0(&EventInfoBoxGachaCounter___c_TypeInfo, v25);
    byte_4A2EA21 = 1;
  }
  ...
  v31 = (System_Collections_Generic_List_long__o *)sub_1B7640C(System_Collections_Generic_List_long__TypeInfo);
...
LABEL_13:
    ...
    {
LABEL_20:
      v41 = sub_1BC81A0(Enumerator, System_Collections_Generic_IEnumerator_DataEntityBase__TypeInfo, 0LL);
    }
...
LABEL_60:
    ...
    if ( !v29 )
      sub_1B7641C(v42, QuestEntity_TypeInfo);
    ...
    if ( eventId == (_DWORD)v47 )
    {
      ...
      if ( !_9__21_1 )
      {
        ...
        _9__21_1 = (System_Func_object__bool__o *)sub_1B7640C(System_Func_QuestReleaseEntity__bool__TypeInfo);
        ...
        sub_1B76164((ServantStatusBattleListViewItem_o *)&static_fields->__9__21_1, (int32_t)_9__21_1, v55, v56);
      }
      v57 = System_Linq_Enumerable__FirstOrDefault_object__48787792(
              v51,
              (System_Func_TSource__bool__o *)_9__21_1,
              (const MethodInfo_2E87150 *)Method_System_Linq_Enumerable_FirstOrDefault_QuestReleaseEntity___);
      if ( v57 )
      {
        ValueInt = QuestReleaseEntity__getValueInt((QuestReleaseEntity_o *)v57, 0LL);
        if ( !v31 )
          sub_1B7641C(ValueInt, v59);
...
LABEL_44:
  ...
  if ( !_9__21_0 )
  {
    ...
    _9__21_0 = (System_Func_long__long__o *)sub_1B7640C(System_Func_long__long__TypeInfo);
    ...
    sub_1B76164((ServantStatusBattleListViewItem_o *)&v70->__9__21_0, (int32_t)_9__21_0, v71, v72);
  }
  v73 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__OrderBy_long__long_(
                                                               ...
                                                               (const MethodInfo_2E8C77C *)Method_System_Linq_Enumerable_OrderBy_long__long___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EA1E & 1) == 0 )
  {
    this = (EventInfoBoxGachaCounter_o *)sub_1B761C0(&int_TypeInfo, val);
    byte_4A2EA1E = 1;
  }
  if ( !val )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EA1F & 1) == 0 )
  {
    sub_1B761C0(&EventInfoBoxGachaCounter_TypeInfo, obj);
    ...
    sub_1B761C0(&StringLiteral_5728/*"EVENT_TOTALBOXGACHA_NEXT_FORMAT"*/, v11);
    this = (EventInfoBoxGachaCounter_o *)sub_1B761C0(&StringLiteral_5729/*"EVENT_TOTALBOXGACHA_TOTAL_FORMAT"*/, v12);
    byte_4A2EA1F = 1;
  }
  if ( !v4 )
LABEL_38:
  ...
  if ( v4->klass->_1.element_class == long_TypeInfo->_1.element_class )
  {
    ...
    if ( ((unsigned __int8)this & 1) != 0 )
    {
      ...
      else
      {
        ...
        v18 = LocalizationManager__Get((System_String_o *)StringLiteral_5729/*"EVENT_TOTALBOXGACHA_TOTAL_FORMAT"*/, 0LL);
        ...
        v41 = System_Math__Min_62354048(totalCount, TOTAL_COUNT_MAX, 0LL);
    ...
    if ( UnityEngine_Object__op_Inequality(nextCounter, 0LL, 0LL) )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v29 = LocalizationManager__Get((System_String_o *)StringLiteral_5728/*"EVENT_TOTALBOXGACHA_NEXT_FORMAT"*/, 0LL);
      ...
      if ( !System_Math_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
      v41 = System_Math__Min_62354048(v30, NEXT_COUNT_MAX, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EA1D & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_17402/*"box_status_side_02"*/, v4);
    sub_1B761C0(&StringLiteral_17403/*"box_status_side_03"*/, v5);
    sub_1B761C0(&StringLiteral_17404/*"box_status_side_04"*/, v6);
    sub_1B761C0(&StringLiteral_17401/*"box_status_side_01"*/, v7);
    byte_4A2EA1D = 1;
  }
  ...
  AtlasManager__SetEventUI(totalCounterBg, (System_String_o *)StringLiteral_17401/*"box_status_side_01"*/, 0LL);
  AtlasManager__SetEventUI(this->fields.nextCounterBg, (System_String_o *)StringLiteral_17402/*"box_status_side_02"*/, 0LL);
  AtlasManager__SetEventUI(this->fields.accessorySp, (System_String_o *)StringLiteral_17403/*"box_status_side_03"*/, 0LL);
  AtlasManager__SetEventUI(this->fields.completeSprite, (System_String_o *)StringLiteral_17404/*"box_status_side_04"*/, 0LL);
...
void __fastcall EventInfoBoxGachaCounter__UpdatePosition(EventInfoBoxGachaCounter_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(nextCounter, 0LL, 0LL) )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(accessorySp, 0LL, 0LL) )
    {
      ...
      {
        sub_1B7641C(nextCounterRoot, v5);
      }
...
void __fastcall EventInfoBoxGachaCounter___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A2EA23 & 1) == 0 )
  {
    sub_1B761C0(&EventInfoBoxGachaCounter___c_TypeInfo, v1);
    byte_4A2EA23 = 1;
  }
  v2 = (Il2CppObject *)sub_1B7640C(EventInfoBoxGachaCounter___c_TypeInfo);
