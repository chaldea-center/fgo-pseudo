void EventInfoBoxGachaCounter___cctor(const MethodInfo *method)
{
  if ( (byte_4C276E4 & 1) == 0 )
  {
    sub_1C2D490(&EventInfoBoxGachaCounter_TypeInfo);
    byte_4C276E4 = 1;
  }
...
int64_t EventInfoBoxGachaCounter__GetNextCount(EventInfoBoxGachaCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C276E3 & 1) == 0 )
  {
    sub_1C2D490(&Method_System_Collections_ObjectModel_Collection_QuestEntity__GetEnumerator__);
    ...
    sub_1C2D490(&Method_DataMasterBase_QuestMaster__QuestEntity__int__getEntityList__);
    sub_1C2D490(&Method_System_Linq_Enumerable_FirstOrDefault_QuestReleaseEntity___);
    sub_1C2D490(&Method_System_Linq_Enumerable_OrderBy_long__long___);
    ...
    sub_1C2D490(&System_Collections_Generic_IEnumerator_QuestEntity__TypeInfo);
    ...
    sub_1C2D490(&Method_EventInfoBoxGachaCounter___c__GetNextCount_b__21_0__);
    sub_1C2D490(&Method_EventInfoBoxGachaCounter___c__GetNextCount_b__21_1__);
    sub_1C2D490(&EventInfoBoxGachaCounter___c_TypeInfo);
    byte_4C276E3 = 1;
  }
  ...
  Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                 ...
                 (const MethodInfo_33217E0 *)Method_System_Collections_ObjectModel_Collection_QuestEntity__GetEnumerator__);
  if ( !Enumerator )
    sub_1C2D6EC(0, v9);
  while ( 1 )
  {
...
LABEL_13:
    ...
    {
LABEL_20:
      v18 = sub_1C7DCA8(Enumerator, System_Collections_Generic_IEnumerator_QuestEntity__TypeInfo, 0);
    }
    ...
    if ( eventId == (_DWORD)v23 )
    {
      ...
      if ( !_9__21_1 )
      {
        ...
        _9__21_1 = (System_Func_object__bool__o *)sub_1C2D6DC(System_Func_QuestReleaseEntity__bool__TypeInfo);
        ...
        sub_1C2D434((CGThumbnailListItem_o *)&static_fields->__9__21_1, (int32_t)_9__21_1, v31, v32);
      }
      v33 = System_Linq_Enumerable__FirstOrDefault_object__51348472(
              v27,
              (System_Func_TSource__bool__o *)_9__21_1,
              (const MethodInfo_30F83F8 *)Method_System_Linq_Enumerable_FirstOrDefault_QuestReleaseEntity___);
      if ( v33 )
      {
        ValueInt = QuestReleaseEntity__getValueInt((QuestReleaseEntity_o *)v33, 0);
        if ( !v8 )
          sub_1C2D6EC(ValueInt, v35);
  ...
  {
LABEL_42:
    v42 = sub_1C7DCA8(Enumerator, System_IDisposable_TypeInfo, 0);
  }
  ...
  if ( !_9__21_0 )
  {
    ...
    _9__21_0 = (System_Func_long__long__o *)sub_1C2D6DC(System_Func_long__long__TypeInfo);
    ...
    sub_1C2D434((CGThumbnailListItem_o *)&v46->__9__21_0, (int32_t)_9__21_0, v47, v48);
  }
  v49 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__OrderBy_long__long_(
                                                               ...
                                                               (const MethodInfo_30FDF60 *)Method_System_Linq_Enumerable_OrderBy_long__long___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C276E0 & 1) == 0 )
  {
    this = (EventInfoBoxGachaCounter_o *)sub_1C2D490(&int_TypeInfo);
    byte_4C276E0 = 1;
  }
  if ( !val )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C276E1 & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_5725/*"EVENT_TOTALBOXGACHA_NEXT_FORMAT"*/);
    this = (EventInfoBoxGachaCounter_o *)sub_1C2D490(&StringLiteral_5726/*"EVENT_TOTALBOXGACHA_TOTAL_FORMAT"*/);
    byte_4C276E1 = 1;
  }
  if ( !v4 )
LABEL_38:
  ...
  if ( v4->klass->_1.element_class == long_TypeInfo->_1.element_class )
  {
    ...
    if ( ((unsigned __int8)this & 1) != 0 )
    {
      ...
      else
      {
        ...
        v11 = LocalizationManager__Get((System_String_o *)StringLiteral_5726/*"EVENT_TOTALBOXGACHA_TOTAL_FORMAT"*/, 0);
        ...
        v34 = System_Math__Min_64982380(totalCount, TOTAL_COUNT_MAX, 0);
        v19 = (Il2CppObject *)j_il2cpp_value_box_0(long_TypeInfo, &v34, v16, v17, v18);
        this = (EventInfoBoxGachaCounter_o *)System_String__Format(v13, v19, 0);
    ...
    if ( UnityEngine_Object__op_Inequality(nextCounter, 0, 0) )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v22 = LocalizationManager__Get((System_String_o *)StringLiteral_5725/*"EVENT_TOTALBOXGACHA_NEXT_FORMAT"*/, 0);
      ...
      if ( !System_Math_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
      v34 = System_Math__Min_64982380(v23, NEXT_COUNT_MAX, 0);
      v30 = (Il2CppObject *)j_il2cpp_value_box_0(long_TypeInfo, &v34, v27, v28, v29);
      this = (EventInfoBoxGachaCounter_o *)System_String__Format(v24, v30, 0);
      if ( !v21 )
        goto LABEL_38;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C276DF & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_17373/*"box_status_side_02"*/);
    sub_1C2D490(&StringLiteral_17374/*"box_status_side_03"*/);
    sub_1C2D490(&StringLiteral_17375/*"box_status_side_04"*/);
    sub_1C2D490(&StringLiteral_17372/*"box_status_side_01"*/);
    byte_4C276DF = 1;
  }
  ...
  AtlasManager__SetEventUI(totalCounterBg, (System_String_o *)StringLiteral_17372/*"box_status_side_01"*/, 0);
  AtlasManager__SetEventUI(this->fields.nextCounterBg, (System_String_o *)StringLiteral_17373/*"box_status_side_02"*/, 0);
  AtlasManager__SetEventUI(this->fields.accessorySp, (System_String_o *)StringLiteral_17374/*"box_status_side_03"*/, 0);
  AtlasManager__SetEventUI(this->fields.completeSprite, (System_String_o *)StringLiteral_17375/*"box_status_side_04"*/, 0);
...
void EventInfoBoxGachaCounter__UpdatePosition(EventInfoBoxGachaCounter_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(nextCounter, 0, 0) )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(accessorySp, 0, 0) )
    {
      ...
      {
        sub_1C2D6EC(nextCounterRoot, v5);
      }
...
void EventInfoBoxGachaCounter___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C2D6DC(EventInfoBoxGachaCounter___c_TypeInfo);
  System_Object___ctor(v1, 0);
  EventInfoBoxGachaCounter___c_TypeInfo->static_fields->__9 = (struct EventInfoBoxGachaCounter___c_o *)v1;
  sub_1C2D434((CGThumbnailListItem_o *)EventInfoBoxGachaCounter___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
