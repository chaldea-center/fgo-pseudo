void __fastcall EventInfoBoxGachaCounter___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B1C926 & 1) == 0 )
  {
    sub_1BCAFF8(&EventInfoBoxGachaCounter_TypeInfo, v1);
    byte_4B1C926 = 1;
  }
...
int64_t __fastcall EventInfoBoxGachaCounter__GetNextCount(EventInfoBoxGachaCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1C925 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_System_Collections_ObjectModel_Collection_QuestEntity__GetEnumerator__, method);
    ...
    sub_1BCAFF8(&Method_DataMasterBase_QuestMaster__QuestEntity__int__getEntityList__, v6);
    sub_1BCAFF8(&Method_System_Linq_Enumerable_FirstOrDefault_QuestReleaseEntity___, v7);
    sub_1BCAFF8(&Method_System_Linq_Enumerable_OrderBy_long__long___, v8);
    sub_1BCAFF8(&Method_System_Linq_Enumerable_ToList_long___, v9);
    ...
    sub_1BCAFF8(&System_Func_long__long__TypeInfo, v13);
    sub_1BCAFF8(&System_Func_QuestReleaseEntity__bool__TypeInfo, v14);
    sub_1BCAFF8(&System_IDisposable_TypeInfo, v15);
    sub_1BCAFF8(&System_Collections_Generic_IEnumerator_QuestEntity__TypeInfo, v16);
    sub_1BCAFF8(&System_Collections_IEnumerator_TypeInfo, v17);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_long__Add__, v18);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_long__GetEnumerator__, v19);
    ...
    sub_1BCAFF8(&Method_EventInfoBoxGachaCounter___c__GetNextCount_b__21_0__, v23);
    sub_1BCAFF8(&Method_EventInfoBoxGachaCounter___c__GetNextCount_b__21_1__, v24);
    sub_1BCAFF8(&EventInfoBoxGachaCounter___c_TypeInfo, v25);
    byte_4B1C925 = 1;
  }
  ...
  v31 = (System_Collections_Generic_List_long__o *)sub_1BCB244(System_Collections_Generic_List_long__TypeInfo);
  ...
  Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                 ...
                 (const MethodInfo_3263BC0 *)Method_System_Collections_ObjectModel_Collection_QuestEntity__GetEnumerator__);
  if ( !Enumerator )
    sub_1BCB254(0LL, v32);
  while ( 1 )
  {
...
LABEL_13:
    ...
    {
LABEL_20:
      v41 = sub_1C1B560(Enumerator, System_Collections_Generic_IEnumerator_QuestEntity__TypeInfo, 0LL);
    }
    ...
    if ( eventId == (_DWORD)v46 )
    {
      ...
      if ( !_9__21_1 )
      {
        ...
        _9__21_1 = (System_Func_object__bool__o *)sub_1BCB244(System_Func_QuestReleaseEntity__bool__TypeInfo);
        ...
        sub_1BCAF9C((CGThumbnailListItem_o *)&static_fields->__9__21_1, (int32_t)_9__21_1, v54, v55);
      }
      v56 = System_Linq_Enumerable__FirstOrDefault_object__50595188(
              v50,
              (System_Func_TSource__bool__o *)_9__21_1,
              (const MethodInfo_3040574 *)Method_System_Linq_Enumerable_FirstOrDefault_QuestReleaseEntity___);
      if ( v56 )
      {
        ValueInt = QuestReleaseEntity__getValueInt((QuestReleaseEntity_o *)v56, 0LL);
        if ( !v31 )
          sub_1BCB254(ValueInt, v58);
        ...
        if ( (unsigned int)size >= items->max_length )
        {
          System_Collections_Generic_List_long___AddWithResize(
            v31,
            (int)ValueInt,
            *(const MethodInfo_36A1C04 **)(*(_QWORD *)(v60[4] + 192LL) + 112LL));
        }
        else
        {
  ...
  {
LABEL_42:
    v65 = sub_1C1B560(Enumerator, System_IDisposable_TypeInfo, 0LL);
  }
  ...
  if ( !_9__21_0 )
  {
    ...
    _9__21_0 = (System_Func_long__long__o *)sub_1BCB244(System_Func_long__long__TypeInfo);
    ...
    sub_1BCAF9C((CGThumbnailListItem_o *)&v69->__9__21_0, (int32_t)_9__21_0, v70, v71);
  }
  v72 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__OrderBy_long__long_(
                                                               ...
                                                               (const MethodInfo_3046004 *)Method_System_Linq_Enumerable_OrderBy_long__long___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1C922 & 1) == 0 )
  {
    this = (EventInfoBoxGachaCounter_o *)sub_1BCAFF8(&int_TypeInfo, val);
    byte_4B1C922 = 1;
  }
  if ( !val )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1C923 & 1) == 0 )
  {
    sub_1BCAFF8(&EventInfoBoxGachaCounter_TypeInfo, obj);
    ...
    sub_1BCAFF8(&StringLiteral_5688/*"EVENT_TOTALBOXGACHA_NEXT_FORMAT"*/, v11);
    this = (EventInfoBoxGachaCounter_o *)sub_1BCAFF8(&StringLiteral_5689/*"EVENT_TOTALBOXGACHA_TOTAL_FORMAT"*/, v12);
    byte_4B1C923 = 1;
  }
  if ( !v4 )
LABEL_38:
  ...
  if ( v4->klass->_1.element_class == long_TypeInfo->_1.element_class )
  {
    ...
    if ( ((unsigned __int8)this & 1) != 0 )
    {
      ...
      else
      {
        ...
        v18 = LocalizationManager__Get((System_String_o *)StringLiteral_5689/*"EVENT_TOTALBOXGACHA_TOTAL_FORMAT"*/, 0LL);
        ...
        v41 = System_Math__Min_63972800(totalCount, TOTAL_COUNT_MAX, 0LL);
    ...
    if ( UnityEngine_Object__op_Inequality(nextCounter, 0LL, 0LL) )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v29 = LocalizationManager__Get((System_String_o *)StringLiteral_5688/*"EVENT_TOTALBOXGACHA_NEXT_FORMAT"*/, 0LL);
      ...
      if ( !System_Math_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
      v41 = System_Math__Min_63972800(v30, NEXT_COUNT_MAX, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1C921 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_17239/*"box_status_side_02"*/, v4);
    sub_1BCAFF8(&StringLiteral_17240/*"box_status_side_03"*/, v5);
    sub_1BCAFF8(&StringLiteral_17241/*"box_status_side_04"*/, v6);
    sub_1BCAFF8(&StringLiteral_17238/*"box_status_side_01"*/, v7);
    byte_4B1C921 = 1;
  }
  ...
  AtlasManager__SetEventUI(totalCounterBg, (System_String_o *)StringLiteral_17238/*"box_status_side_01"*/, 0LL);
  AtlasManager__SetEventUI(this->fields.nextCounterBg, (System_String_o *)StringLiteral_17239/*"box_status_side_02"*/, 0LL);
  AtlasManager__SetEventUI(this->fields.accessorySp, (System_String_o *)StringLiteral_17240/*"box_status_side_03"*/, 0LL);
  AtlasManager__SetEventUI(this->fields.completeSprite, (System_String_o *)StringLiteral_17241/*"box_status_side_04"*/, 0LL);
...
void __fastcall EventInfoBoxGachaCounter__UpdatePosition(EventInfoBoxGachaCounter_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(nextCounter, 0LL, 0LL) )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(accessorySp, 0LL, 0LL) )
    {
      ...
      {
        sub_1BCB254(nextCounterRoot, v5);
      }
...
void __fastcall EventInfoBoxGachaCounter___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B1C927 & 1) == 0 )
  {
    sub_1BCAFF8(&EventInfoBoxGachaCounter___c_TypeInfo, v1);
    byte_4B1C927 = 1;
  }
  v2 = (Il2CppObject *)sub_1BCB244(EventInfoBoxGachaCounter___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  EventInfoBoxGachaCounter___c_TypeInfo->static_fields->__9 = (struct EventInfoBoxGachaCounter___c_o *)v2;
  sub_1BCAF9C((CGThumbnailListItem_o *)EventInfoBoxGachaCounter___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
