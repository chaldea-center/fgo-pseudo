void __fastcall EventInfoBoxGachaCounter___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B6738A & 1) == 0 )
  {
    sub_1BE4ACC(&EventInfoBoxGachaCounter_TypeInfo, v1);
    byte_4B6738A = 1;
  }
...
int64_t __fastcall EventInfoBoxGachaCounter__GetNextCount(EventInfoBoxGachaCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B67389 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_System_Linq_Enumerable_FirstOrDefault_QuestReleaseEntity___, v6);
    sub_1BE4ACC(&Method_System_Linq_Enumerable_OrderBy_long__long___, v7);
    sub_1BE4ACC(&Method_System_Linq_Enumerable_ToList_long___, v8);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Enumerator_long__Dispose__, v9);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Enumerator_long__MoveNext__, v10);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Enumerator_long__get_Current__, v11);
    sub_1BE4ACC(&System_Func_long__long__TypeInfo, v12);
    sub_1BE4ACC(&System_Func_QuestReleaseEntity__bool__TypeInfo, v13);
    ...
    sub_1BE4ACC(&Method_System_Collections_Generic_List_long__Add__, v17);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_long__GetEnumerator__, v18);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_long___ctor__, v19);
    sub_1BE4ACC(&System_Collections_Generic_List_long__TypeInfo, v20);
    sub_1BE4ACC(&QuestEntity_TypeInfo, v21);
    sub_1BE4ACC(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v22);
    sub_1BE4ACC(&Method_EventInfoBoxGachaCounter___c__GetNextCount_b__21_0__, v23);
    sub_1BE4ACC(&Method_EventInfoBoxGachaCounter___c__GetNextCount_b__21_1__, v24);
    sub_1BE4ACC(&EventInfoBoxGachaCounter___c_TypeInfo, v25);
    byte_4B67389 = 1;
  }
  ...
  v31 = (System_Collections_Generic_List_long__o *)sub_1BE4D18(System_Collections_Generic_List_long__TypeInfo);
...
LABEL_13:
    ...
    {
LABEL_20:
      v41 = sub_1C36AAC(Enumerator, System_Collections_Generic_IEnumerator_DataEntityBase__TypeInfo, 0LL);
    }
...
LABEL_60:
    ...
    if ( !v29 )
      sub_1BE4D28(v42, QuestEntity_TypeInfo);
    ...
    if ( eventId == (_DWORD)v47 )
    {
      ...
      if ( !_9__21_1 )
      {
        ...
        _9__21_1 = (System_Func_object__bool__o *)sub_1BE4D18(System_Func_QuestReleaseEntity__bool__TypeInfo);
      ...
      v61 = System_Linq_Enumerable__FirstOrDefault_object__49793520(
              v51,
              (System_Func_TSource__bool__o *)_9__21_1,
              (const MethodInfo_2F7C9F0 *)Method_System_Linq_Enumerable_FirstOrDefault_QuestReleaseEntity___);
      if ( v61 )
      {
        ValueInt = QuestReleaseEntity__getValueInt((QuestReleaseEntity_o *)v61, 0LL);
        if ( !v31 )
          sub_1BE4D28(ValueInt, v63);
        ...
        if ( (unsigned int)size >= items->max_length )
        {
          System_Collections_Generic_List_long___AddWithResize(
            v31,
            (int)ValueInt,
            *(const MethodInfo_35D4258 **)(*(_QWORD *)(v65[4] + 192LL) + 112LL));
        }
        else
        {
  ...
  {
LABEL_44:
    v70 = sub_1C36AAC(Enumerator, System_IDisposable_TypeInfo, 0LL);
  }
  ...
  if ( !_9__21_0 )
  {
    ...
    _9__21_0 = (System_Func_long__long__o *)sub_1BE4D18(System_Func_long__long__TypeInfo);
    ...
    sub_1BE4A70((PartyOrganizationUtility_o *)&v74->__9__21_0, (int64_t)_9__21_0, v75, v76, v77, v78, v79, v80);
  }
  v81 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__OrderBy_long__long_(
                                                               ...
                                                               (const MethodInfo_2F8201C *)Method_System_Linq_Enumerable_OrderBy_long__long___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67386 & 1) == 0 )
  {
    this = (EventInfoBoxGachaCounter_o *)sub_1BE4ACC(&int_TypeInfo, val);
    byte_4B67386 = 1;
  }
  if ( !val )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67387 & 1) == 0 )
  {
    sub_1BE4ACC(&EventInfoBoxGachaCounter_TypeInfo, obj);
    ...
    sub_1BE4ACC(&StringLiteral_5825/*"EVENT_TOTALBOXGACHA_NEXT_FORMAT"*/, v11);
    this = (EventInfoBoxGachaCounter_o *)sub_1BE4ACC(&StringLiteral_5826/*"EVENT_TOTALBOXGACHA_TOTAL_FORMAT"*/, v12);
    byte_4B67387 = 1;
  }
  if ( !v4 )
LABEL_38:
  ...
  if ( v4->klass->_1.element_class == long_TypeInfo->_1.element_class )
  {
    ...
    if ( ((unsigned __int8)this & 1) != 0 )
    {
      ...
      else
      {
        ...
        v18 = LocalizationManager__Get((System_String_o *)StringLiteral_5826/*"EVENT_TOTALBOXGACHA_TOTAL_FORMAT"*/, 0LL);
        ...
        v41 = System_Math__Min_63518292(totalCount, TOTAL_COUNT_MAX, 0LL);
    ...
    if ( UnityEngine_Object__op_Inequality(nextCounter, 0LL, 0LL) )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v29 = LocalizationManager__Get((System_String_o *)StringLiteral_5825/*"EVENT_TOTALBOXGACHA_NEXT_FORMAT"*/, 0LL);
      ...
      if ( !System_Math_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
      v41 = System_Math__Min_63518292(v30, NEXT_COUNT_MAX, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67385 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_17628/*"box_status_side_02"*/, v4);
    sub_1BE4ACC(&StringLiteral_17629/*"box_status_side_03"*/, v5);
    sub_1BE4ACC(&StringLiteral_17630/*"box_status_side_04"*/, v6);
    sub_1BE4ACC(&StringLiteral_17627/*"box_status_side_01"*/, v7);
    byte_4B67385 = 1;
  }
  ...
  AtlasManager__SetEventUI(totalCounterBg, (System_String_o *)StringLiteral_17627/*"box_status_side_01"*/, 0LL);
  AtlasManager__SetEventUI(this->fields.nextCounterBg, (System_String_o *)StringLiteral_17628/*"box_status_side_02"*/, 0LL);
  AtlasManager__SetEventUI(this->fields.accessorySp, (System_String_o *)StringLiteral_17629/*"box_status_side_03"*/, 0LL);
  AtlasManager__SetEventUI(this->fields.completeSprite, (System_String_o *)StringLiteral_17630/*"box_status_side_04"*/, 0LL);
...
void __fastcall EventInfoBoxGachaCounter__UpdatePosition(EventInfoBoxGachaCounter_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(nextCounter, 0LL, 0LL) )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(accessorySp, 0LL, 0LL) )
    {
      ...
      {
        sub_1BE4D28(nextCounterRoot, v5);
      }
...
void __fastcall EventInfoBoxGachaCounter___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B6738B & 1) == 0 )
  {
    sub_1BE4ACC(&EventInfoBoxGachaCounter___c_TypeInfo, v1);
    byte_4B6738B = 1;
  }
  v2 = (Il2CppObject *)sub_1BE4D18(EventInfoBoxGachaCounter___c_TypeInfo);
