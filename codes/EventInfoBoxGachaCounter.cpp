void EventInfoBoxGachaCounter___cctor(const MethodInfo *method)
{
  if ( (byte_4E04C6D & 1) == 0 )
  {
    sub_1CE6700(&EventInfoBoxGachaCounter_TypeInfo);
    byte_4E04C6D = 1;
  }
...
int64_t EventInfoBoxGachaCounter__GetNextCount(EventInfoBoxGachaCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E04C6C & 1) == 0 )
  {
    sub_1CE6700(&Method_System_Collections_ObjectModel_Collection_QuestEntity__GetEnumerator__);
    ...
    sub_1CE6700(&Method_DataMasterBase_QuestMaster__QuestEntity__int__getEntityList__);
    sub_1CE6700(&Method_System_Linq_Enumerable_FirstOrDefault_QuestReleaseEntity___);
    sub_1CE6700(&Method_System_Linq_Enumerable_OrderBy_long__long___);
    ...
    sub_1CE6700(&System_Collections_Generic_IEnumerator_QuestEntity__TypeInfo);
    ...
    sub_1CE6700(&Method_EventInfoBoxGachaCounter___c__GetNextCount_b__21_0__);
    sub_1CE6700(&Method_EventInfoBoxGachaCounter___c__GetNextCount_b__21_1__);
    sub_1CE6700(&EventInfoBoxGachaCounter___c_TypeInfo);
    byte_4E04C6C = 1;
  }
  ...
  Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                 ...
                 (const MethodInfo_3481088 *)Method_System_Collections_ObjectModel_Collection_QuestEntity__GetEnumerator__);
  if ( !Enumerator )
    sub_1CE6958(0, v9);
  while ( 1 )
  {
...
LABEL_13:
    ...
    {
LABEL_20:
      v18 = sub_1CBCA7C(Enumerator, System_Collections_Generic_IEnumerator_QuestEntity__TypeInfo, 0);
    }
    ...
    if ( eventId == (_DWORD)v23 )
    {
      ...
      if ( !_9__21_1 )
      {
        ...
        _9__21_1 = (System_Func_object__bool__o *)sub_1CE694C(System_Func_QuestReleaseEntity__bool__TypeInfo);
      ...
      v37 = System_Linq_Enumerable__FirstOrDefault_object__52613440(
              v27,
              (System_Func_TSource__bool__o *)_9__21_1,
              (const MethodInfo_322D140 *)Method_System_Linq_Enumerable_FirstOrDefault_QuestReleaseEntity___);
      if ( v37 )
      {
        ValueInt = QuestReleaseEntity__getValueInt((QuestReleaseEntity_o *)v37, 0);
        if ( !v8 )
          sub_1CE6958(ValueInt, v39);
        ...
        if ( (unsigned int)size >= LODWORD(items->max_length) )
        {
          System_Collections_Generic_List_long___AddWithResize(
            v8,
            (int)ValueInt,
            *(const MethodInfo_38EDF9C **)(*(_QWORD *)(v41[4] + 192LL) + 112LL));
        }
        else
        {
...
LABEL_42:
  ...
  if ( !_9__21_0 )
  {
    ...
    _9__21_0 = (System_Func_long__long__o *)sub_1CE694C(System_Func_long__long__TypeInfo);
    ...
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&v50->__9__21_0, (int32_t)_9__21_0, v51, v52, v53, v54, v55, v56);
  }
  v57 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__OrderBy_long__long_(
                                                               ...
                                                               (const MethodInfo_32331B0 *)Method_System_Linq_Enumerable_OrderBy_long__long___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E04C69 & 1) == 0 )
  {
    this = (EventInfoBoxGachaCounter_o *)sub_1CE6700(&int_TypeInfo);
    byte_4E04C69 = 1;
  }
  if ( !val )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E04C6A & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_5774/*"EVENT_TOTALBOXGACHA_NEXT_FORMAT"*/);
    this = (EventInfoBoxGachaCounter_o *)sub_1CE6700(&StringLiteral_5775/*"EVENT_TOTALBOXGACHA_TOTAL_FORMAT"*/);
    byte_4E04C6A = 1;
  }
  if ( !v4 )
LABEL_38:
  ...
  if ( v4->klass->_1.element_class == long_TypeInfo->_1.element_class )
  {
    ...
    if ( ((unsigned __int8)this & 1) != 0 )
    {
      ...
      else
      {
        ...
        v11 = LocalizationManager__Get((System_String_o *)StringLiteral_5775/*"EVENT_TOTALBOXGACHA_TOTAL_FORMAT"*/, 0);
        ...
        v28 = System_Math__Min_66644988(totalCount, TOTAL_COUNT_MAX, 0);
    ...
    if ( UnityEngine_Object__op_Inequality(nextCounter, 0, 0) )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v19 = LocalizationManager__Get((System_String_o *)StringLiteral_5774/*"EVENT_TOTALBOXGACHA_NEXT_FORMAT"*/, 0);
      ...
      if ( !System_Math_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
      v28 = System_Math__Min_66644988(v20, NEXT_COUNT_MAX, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E04C68 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_17562/*"box_status_side_02"*/);
    sub_1CE6700(&StringLiteral_17563/*"box_status_side_03"*/);
    sub_1CE6700(&StringLiteral_17564/*"box_status_side_04"*/);
    sub_1CE6700(&StringLiteral_17561/*"box_status_side_01"*/);
    byte_4E04C68 = 1;
  }
  ...
  AtlasManager__SetEventUI(totalCounterBg, (System_String_o *)StringLiteral_17561/*"box_status_side_01"*/, 0);
  AtlasManager__SetEventUI(this->fields.nextCounterBg, (System_String_o *)StringLiteral_17562/*"box_status_side_02"*/, 0);
  AtlasManager__SetEventUI(this->fields.accessorySp, (System_String_o *)StringLiteral_17563/*"box_status_side_03"*/, 0);
  AtlasManager__SetEventUI(this->fields.completeSprite, (System_String_o *)StringLiteral_17564/*"box_status_side_04"*/, 0);
...
void EventInfoBoxGachaCounter__UpdatePosition(EventInfoBoxGachaCounter_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(nextCounter, 0, 0) )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(accessorySp, 0, 0) )
    {
      ...
      {
        sub_1CE6958(nextCounterRoot, v5);
      }
...
void EventInfoBoxGachaCounter___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1CE694C(EventInfoBoxGachaCounter___c_TypeInfo);
