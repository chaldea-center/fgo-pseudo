void __fastcall EventInfoBoxGachaCounter___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49BB664 & 1) == 0 )
  {
    sub_1B4CF90(&EventInfoBoxGachaCounter_TypeInfo, v1);
    byte_49BB664 = 1;
  }
...
int64_t __fastcall EventInfoBoxGachaCounter__GetNextCount(EventInfoBoxGachaCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BB663 & 1) == 0 )
  {
    sub_1B4CF90(&Method_System_Collections_ObjectModel_Collection_QuestEntity__GetEnumerator__, method);
    ...
    sub_1B4CF90(&Method_DataMasterBase_QuestMaster__QuestEntity__int__getEntityList__, v6);
    sub_1B4CF90(&Method_System_Linq_Enumerable_FirstOrDefault_QuestReleaseEntity___, v7);
    sub_1B4CF90(&Method_System_Linq_Enumerable_OrderBy_long__long___, v8);
    sub_1B4CF90(&Method_System_Linq_Enumerable_ToList_long___, v9);
    ...
    sub_1B4CF90(&System_Func_long__long__TypeInfo, v13);
    sub_1B4CF90(&System_Func_QuestReleaseEntity__bool__TypeInfo, v14);
    sub_1B4CF90(&System_IDisposable_TypeInfo, v15);
    sub_1B4CF90(&System_Collections_Generic_IEnumerator_QuestEntity__TypeInfo, v16);
    sub_1B4CF90(&System_Collections_IEnumerator_TypeInfo, v17);
    sub_1B4CF90(&Method_System_Collections_Generic_List_long__Add__, v18);
    sub_1B4CF90(&Method_System_Collections_Generic_List_long__GetEnumerator__, v19);
    sub_1B4CF90(&Method_System_Collections_Generic_List_long___ctor__, v20);
    sub_1B4CF90(&System_Collections_Generic_List_long__TypeInfo, v21);
    sub_1B4CF90(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v22);
    sub_1B4CF90(&Method_EventInfoBoxGachaCounter___c__GetNextCount_b__21_0__, v23);
    sub_1B4CF90(&Method_EventInfoBoxGachaCounter___c__GetNextCount_b__21_1__, v24);
    sub_1B4CF90(&EventInfoBoxGachaCounter___c_TypeInfo, v25);
    byte_49BB663 = 1;
  }
  ...
  v31 = (System_Collections_Generic_List_long__o *)sub_1B4D1DC(System_Collections_Generic_List_long__TypeInfo);
  ...
  Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                 ...
                 (const MethodInfo_313B4BC *)Method_System_Collections_ObjectModel_Collection_QuestEntity__GetEnumerator__);
  if ( !Enumerator )
    sub_1B4D1EC(0LL, v32);
  while ( 1 )
  {
...
LABEL_13:
    ...
    {
LABEL_20:
      v41 = sub_1B9D724(Enumerator, System_Collections_Generic_IEnumerator_QuestEntity__TypeInfo, 0LL);
    }
    ...
    if ( eventId == (_DWORD)v46 )
    {
      ...
      if ( !_9__21_1 )
      {
        ...
        _9__21_1 = (System_Func_object__bool__o *)sub_1B4D1DC(System_Func_QuestReleaseEntity__bool__TypeInfo);
        ...
        sub_1B4CF34((CGThumbnailListItem_o *)&static_fields->__9__21_1, (int32_t)_9__21_1, v54, v55);
      }
      v56 = System_Linq_Enumerable__FirstOrDefault_object__49446844(
              v50,
              (System_Func_TSource__bool__o *)_9__21_1,
              (const MethodInfo_2F27FBC *)Method_System_Linq_Enumerable_FirstOrDefault_QuestReleaseEntity___);
      if ( v56 )
      {
        ValueInt = QuestReleaseEntity__getValueInt((QuestReleaseEntity_o *)v56, 0LL);
        if ( !v31 )
          sub_1B4D1EC(ValueInt, v58);
  ...
  {
LABEL_42:
    v65 = sub_1B9D724(Enumerator, System_IDisposable_TypeInfo, 0LL);
  }
  ...
  if ( !_9__21_0 )
  {
    ...
    _9__21_0 = (System_Func_long__long__o *)sub_1B4D1DC(System_Func_long__long__TypeInfo);
    ...
    sub_1B4CF34((CGThumbnailListItem_o *)&v69->__9__21_0, (int32_t)_9__21_0, v70, v71);
  }
  v72 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__OrderBy_long__long_(
                                                               ...
                                                               (const MethodInfo_2F2D950 *)Method_System_Linq_Enumerable_OrderBy_long__long___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BB660 & 1) == 0 )
  {
    this = (EventInfoBoxGachaCounter_o *)sub_1B4CF90(&int_TypeInfo, val);
    byte_49BB660 = 1;
  }
  if ( !val )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BB661 & 1) == 0 )
  {
    sub_1B4CF90(&EventInfoBoxGachaCounter_TypeInfo, obj);
    ...
    sub_1B4CF90(&StringLiteral_5632/*"EVENT_TOTALBOXGACHA_NEXT_FORMAT"*/, v11);
    this = (EventInfoBoxGachaCounter_o *)sub_1B4CF90(&StringLiteral_5633/*"EVENT_TOTALBOXGACHA_TOTAL_FORMAT"*/, v12);
    byte_49BB661 = 1;
  }
  if ( !v4 )
LABEL_38:
  ...
  if ( v4->klass->_1.element_class == long_TypeInfo->_1.element_class )
  {
    ...
    if ( ((unsigned __int8)this & 1) != 0 )
    {
      ...
      else
      {
        ...
        v18 = LocalizationManager__Get((System_String_o *)StringLiteral_5633/*"EVENT_TOTALBOXGACHA_TOTAL_FORMAT"*/, 0LL);
        ...
        v41 = System_Math__Min_62622128(totalCount, TOTAL_COUNT_MAX, 0LL);
    ...
    if ( UnityEngine_Object__op_Inequality(nextCounter, 0LL, 0LL) )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v29 = LocalizationManager__Get((System_String_o *)StringLiteral_5632/*"EVENT_TOTALBOXGACHA_NEXT_FORMAT"*/, 0LL);
      ...
      if ( !System_Math_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
      v41 = System_Math__Min_62622128(v30, NEXT_COUNT_MAX, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BB65F & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_17090/*"box_status_side_02"*/, v4);
    sub_1B4CF90(&StringLiteral_17091/*"box_status_side_03"*/, v5);
    sub_1B4CF90(&StringLiteral_17092/*"box_status_side_04"*/, v6);
    sub_1B4CF90(&StringLiteral_17089/*"box_status_side_01"*/, v7);
    byte_49BB65F = 1;
  }
  ...
  AtlasManager__SetEventUI(totalCounterBg, (System_String_o *)StringLiteral_17089/*"box_status_side_01"*/, 0LL);
  AtlasManager__SetEventUI(this->fields.nextCounterBg, (System_String_o *)StringLiteral_17090/*"box_status_side_02"*/, 0LL);
  AtlasManager__SetEventUI(this->fields.accessorySp, (System_String_o *)StringLiteral_17091/*"box_status_side_03"*/, 0LL);
  AtlasManager__SetEventUI(this->fields.completeSprite, (System_String_o *)StringLiteral_17092/*"box_status_side_04"*/, 0LL);
...
void __fastcall EventInfoBoxGachaCounter__UpdatePosition(EventInfoBoxGachaCounter_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(nextCounter, 0LL, 0LL) )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(accessorySp, 0LL, 0LL) )
    {
      ...
      {
        sub_1B4D1EC(nextCounterRoot, v5);
      }
...
void __fastcall EventInfoBoxGachaCounter___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49BB665 & 1) == 0 )
  {
    sub_1B4CF90(&EventInfoBoxGachaCounter___c_TypeInfo, v1);
    byte_49BB665 = 1;
  }
  v2 = (Il2CppObject *)sub_1B4D1DC(EventInfoBoxGachaCounter___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  EventInfoBoxGachaCounter___c_TypeInfo->static_fields->__9 = (struct EventInfoBoxGachaCounter___c_o *)v2;
  sub_1B4CF34((CGThumbnailListItem_o *)EventInfoBoxGachaCounter___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
