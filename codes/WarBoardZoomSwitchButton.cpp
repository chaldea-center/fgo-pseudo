void __fastcall WarBoardZoomSwitchButton___ctor(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA3FE & 1) == 0 )
  {
    sub_1B640C8(&WarBoardZoomSwitchButton_ZoomSpritePair___TypeInfo, method);
    byte_49FA3FE = 1;
  }
  v3 = (struct WarBoardZoomSwitchButton_ZoomSpritePair_array *)sub_1B64170(
                                                                 WarBoardZoomSwitchButton_ZoomSpritePair___TypeInfo,
                                                                 0LL);
  this->fields.zoomSpritePairArray = v3;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.zoomSpritePairArray, (int32_t)v3, v4, v5);
...
void __fastcall WarBoardZoomSwitchButton__ClickButton(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA3F9 & 1) == 0 )
  {
    sub_1B640C8(&Method_ActionExtensions_Call_float___, method);
    this = (WarBoardZoomSwitchButton_o *)sub_1B640C8(&Method_WarBoardZoomSwitchButton_ClickButton__, v3);
    byte_49FA3F9 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_WarBoardZoomSwitchButton_ClickButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1B640E0(Method_WarBoardZoomSwitchButton_ClickButton__);
...
LABEL_10:
  ...
  ActionExtensions__Call_float_(
    ...
    v10->fields.zoom,
    (const MethodInfo_2D90AC8 *)Method_ActionExtensions_Call_float___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA3FC & 1) == 0 )
  {
    this = (WarBoardZoomSwitchButton_o *)sub_1B640C8(&StringLiteral_1/*""*/, method);
    byte_49FA3FC = 1;
  }
...
void __fastcall WarBoardZoomSwitchButton__OnClickRuleButton(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA3F7 & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_WarBoardZoomSwitchButton_CloseRuleDialog__, v4);
    byte_49FA3F7 = 1;
  }
...
void __fastcall WarBoardZoomSwitchButton__UpdateUI(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( !UnityEngine_Object__op_Equality(buttonSprite, 0LL, 0LL) )
  {
    ...
    if ( !v5 )
      sub_1B64324(CurrentButtonSpriteName);
