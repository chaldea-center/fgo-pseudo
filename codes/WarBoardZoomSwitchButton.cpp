void WarBoardZoomSwitchButton___ctor(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2504C & 1) == 0 )
  {
    sub_1C2D490(&WarBoardZoomSwitchButton_ZoomSpritePair___TypeInfo);
    byte_4C2504C = 1;
  }
  v3 = (struct WarBoardZoomSwitchButton_ZoomSpritePair_array *)sub_1C2D538(
                                                                 WarBoardZoomSwitchButton_ZoomSpritePair___TypeInfo,
                                                                 0);
  this->fields.zoomSpritePairArray = v3;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.zoomSpritePairArray, (int32_t)v3, v4, v5);
...
void WarBoardZoomSwitchButton__ClickButton(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C25047 & 1) == 0 )
  {
    sub_1C2D490(&Method_ActionExtensions_Call_float___);
    this = (WarBoardZoomSwitchButton_o *)sub_1C2D490(&Method_WarBoardZoomSwitchButton_ClickButton__);
    byte_4C25047 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_WarBoardZoomSwitchButton_ClickButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1C2D4A8(Method_WarBoardZoomSwitchButton_ClickButton__);
  ...
  if ( (unsigned int)currentZoomIndex >= LODWORD(v7->max_length) )
...
LABEL_10:
  ...
  ActionExtensions__Call_float_(
    ...
    v9->fields.zoom,
    (const MethodInfo_301B290 *)Method_ActionExtensions_Call_float___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2504A & 1) == 0 )
  {
    this = (WarBoardZoomSwitchButton_o *)sub_1C2D490(&StringLiteral_1/*""*/);
    byte_4C2504A = 1;
  }
...
void WarBoardZoomSwitchButton__OnClickRuleButton(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C25045 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_WarBoardZoomSwitchButton_CloseRuleDialog__);
    byte_4C25045 = 1;
  }
...
void WarBoardZoomSwitchButton__UpdateUI(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( !UnityEngine_Object__op_Equality(buttonSprite, 0, 0) )
  {
    ...
    if ( !v5 )
      sub_1C2D6EC(CurrentButtonSpriteName, v7);
