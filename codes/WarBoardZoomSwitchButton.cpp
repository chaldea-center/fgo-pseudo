void __fastcall WarBoardZoomSwitchButton___ctor(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB3CCB & 1) == 0 )
  {
    sub_1BAB41C(&WarBoardZoomSwitchButton_ZoomSpritePair___TypeInfo, method);
    byte_4AB3CCB = 1;
  }
  v3 = (struct WarBoardZoomSwitchButton_ZoomSpritePair_array *)sub_1BAB4C4(
                                                                 WarBoardZoomSwitchButton_ZoomSpritePair___TypeInfo,
                                                                 0LL);
  this->fields.zoomSpritePairArray = v3;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.zoomSpritePairArray, (int32_t)v3, v4, v5);
...
void __fastcall WarBoardZoomSwitchButton__ClickButton(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB3CC6 & 1) == 0 )
  {
    sub_1BAB41C(&Method_ActionExtensions_Call_float___, method);
    this = (WarBoardZoomSwitchButton_o *)sub_1BAB41C(&Method_WarBoardZoomSwitchButton_ClickButton__, v3);
    byte_4AB3CC6 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_WarBoardZoomSwitchButton_ClickButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1BAB434(Method_WarBoardZoomSwitchButton_ClickButton__);
...
LABEL_10:
  ...
  ActionExtensions__Call_float_(
    ...
    v9->fields.zoom,
    (const MethodInfo_2E18518 *)Method_ActionExtensions_Call_float___);
...
void __fastcall WarBoardZoomSwitchButton__CloseRuleDialog(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB3CC5 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&WarBoardManager_TypeInfo, v2);
    byte_4AB3CC5 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB3CC9 & 1) == 0 )
  {
    this = (WarBoardZoomSwitchButton_o *)sub_1BAB41C(&StringLiteral_1/*""*/, method);
    byte_4AB3CC9 = 1;
  }
...
void __fastcall WarBoardZoomSwitchButton__OnClickRuleButton(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB3CC4 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_WarBoardZoomSwitchButton_CloseRuleDialog__, v3);
    byte_4AB3CC4 = 1;
  }
...
void __fastcall WarBoardZoomSwitchButton__UpdateRuleButton(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB3CC3 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_20189/*"icon_noticebg_01"*/, v4);
    byte_4AB3CC3 = 1;
  }
  ...
  if ( !Instance
    || (UISprite__set_spriteName(Instance, (System_String_o *)StringLiteral_20189/*"icon_noticebg_01"*/, 0LL),
        newRuleObject = this->fields.newRuleObject,
        (Instance = (UISprite_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_378A22C *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__)) == 0LL)
...
void __fastcall WarBoardZoomSwitchButton__UpdateUI(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( !UnityEngine_Object__op_Equality(buttonSprite, 0LL, 0LL) )
  {
    ...
    if ( !v5 )
      sub_1BAB678(CurrentButtonSpriteName, v7);
