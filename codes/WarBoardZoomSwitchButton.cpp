void __fastcall WarBoardZoomSwitchButton___ctor(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1DA9F & 1) == 0 )
  {
    sub_1B715CC(&WarBoardZoomSwitchButton_ZoomSpritePair___TypeInfo, method);
    byte_4A1DA9F = 1;
  }
  v3 = (struct WarBoardZoomSwitchButton_ZoomSpritePair_array *)sub_1B71674(
                                                                 WarBoardZoomSwitchButton_ZoomSpritePair___TypeInfo,
                                                                 0LL);
  this->fields.zoomSpritePairArray = v3;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.zoomSpritePairArray, (int32_t)v3, v4, v5);
...
void __fastcall WarBoardZoomSwitchButton__ClickButton(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1DA9A & 1) == 0 )
  {
    sub_1B715CC(&Method_ActionExtensions_Call_float___, method);
    this = (WarBoardZoomSwitchButton_o *)sub_1B715CC(&Method_WarBoardZoomSwitchButton_ClickButton__, v3);
    byte_4A1DA9A = 1;
  }
  ...
  if ( (*((_BYTE *)Method_WarBoardZoomSwitchButton_ClickButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1B715E4(Method_WarBoardZoomSwitchButton_ClickButton__);
...
LABEL_10:
  ...
  ActionExtensions__Call_float_(
    ...
    v9->fields.zoom,
    (const MethodInfo_2DB2E28 *)Method_ActionExtensions_Call_float___);
...
void __fastcall WarBoardZoomSwitchButton__CloseRuleDialog(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1DA99 & 1) == 0 )
  {
    ...
    sub_1B715CC(&WarBoardManager_TypeInfo, v2);
    byte_4A1DA99 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1DA9D & 1) == 0 )
  {
    this = (WarBoardZoomSwitchButton_o *)sub_1B715CC(&StringLiteral_1/*""*/, method);
    byte_4A1DA9D = 1;
  }
...
void __fastcall WarBoardZoomSwitchButton__OnClickRuleButton(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1DA98 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_WarBoardZoomSwitchButton_CloseRuleDialog__, v3);
    byte_4A1DA98 = 1;
  }
...
void __fastcall WarBoardZoomSwitchButton__UpdateRuleButton(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1DA97 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_20107/*"icon_noticebg_01"*/, v4);
    byte_4A1DA97 = 1;
  }
  ...
  if ( !Instance
    || (UISprite__set_spriteName(Instance, (System_String_o *)StringLiteral_20107/*"icon_noticebg_01"*/, 0LL),
        newRuleObject = this->fields.newRuleObject,
        (Instance = (UISprite_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__)) == 0LL)
...
void __fastcall WarBoardZoomSwitchButton__UpdateUI(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( !UnityEngine_Object__op_Equality(buttonSprite, 0LL, 0LL) )
  {
    ...
    if ( !v5 )
      sub_1B71828(CurrentButtonSpriteName, v7);
