void __fastcall WarBoardZoomSwitchButton___ctor(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FC4F3 & 1) == 0 )
  {
    sub_1B64870(&WarBoardZoomSwitchButton_ZoomSpritePair___TypeInfo, method);
    byte_49FC4F3 = 1;
  }
  v3 = (struct WarBoardZoomSwitchButton_ZoomSpritePair_array *)sub_1B64918(
                                                                 WarBoardZoomSwitchButton_ZoomSpritePair___TypeInfo,
                                                                 0LL);
  this->fields.zoomSpritePairArray = v3;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.zoomSpritePairArray, (int32_t)v3, v4, v5);
...
void __fastcall WarBoardZoomSwitchButton__ClickButton(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FC4EE & 1) == 0 )
  {
    sub_1B64870(&Method_ActionExtensions_Call_float___, method);
    this = (WarBoardZoomSwitchButton_o *)sub_1B64870(&Method_WarBoardZoomSwitchButton_ClickButton__, v3);
    byte_49FC4EE = 1;
  }
  ...
  if ( (*((_BYTE *)Method_WarBoardZoomSwitchButton_ClickButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1B64888(Method_WarBoardZoomSwitchButton_ClickButton__);
...
LABEL_10:
  ...
  ActionExtensions__Call_float_(
    ...
    v9->fields.zoom,
    (const MethodInfo_2D92DA4 *)Method_ActionExtensions_Call_float___);
...
void __fastcall WarBoardZoomSwitchButton__CloseRuleDialog(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FC4ED & 1) == 0 )
  {
    ...
    sub_1B64870(&WarBoardManager_TypeInfo, v2);
    byte_49FC4ED = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC4F1 & 1) == 0 )
  {
    this = (WarBoardZoomSwitchButton_o *)sub_1B64870(&StringLiteral_1/*""*/, method);
    byte_49FC4F1 = 1;
  }
...
void __fastcall WarBoardZoomSwitchButton__OnClickRuleButton(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FC4EC & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_WarBoardZoomSwitchButton_CloseRuleDialog__, v3);
    byte_49FC4EC = 1;
  }
...
void __fastcall WarBoardZoomSwitchButton__UpdateRuleButton(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FC4EB & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_20082/*"icon_noticebg_01"*/, v4);
    byte_49FC4EB = 1;
  }
  ...
  if ( !Instance
    || (UISprite__set_spriteName(Instance, (System_String_o *)StringLiteral_20082/*"icon_noticebg_01"*/, 0LL),
        newRuleObject = this->fields.newRuleObject,
        (Instance = (UISprite_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE318 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__)) == 0LL)
...
void __fastcall WarBoardZoomSwitchButton__UpdateUI(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( !UnityEngine_Object__op_Equality(buttonSprite, 0LL, 0LL) )
  {
    ...
    if ( !v5 )
      sub_1B64ACC(CurrentButtonSpriteName, v7);
