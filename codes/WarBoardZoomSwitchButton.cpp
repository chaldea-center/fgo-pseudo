void __fastcall WarBoardZoomSwitchButton___ctor(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4352699 & 1) == 0 )
  {
    sub_B70694(&WarBoardZoomSwitchButton_ZoomSpritePair___TypeInfo);
    byte_4352699 = 1;
  }
  v3 = (struct WarBoardZoomSwitchButton_ZoomSpritePair_array *)sub_B706AC(
...
void __fastcall WarBoardZoomSwitchButton__ClickButton(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4352694 & 1) == 0 )
  {
    sub_B70694(&Method_ActionExtensions_Call_float___);
    this = (WarBoardZoomSwitchButton_o *)sub_B70694(&SoundManager_TypeInfo);
    byte_4352694 = 1;
  }
...
LABEL_11:
  ...
  ActionExtensions__Call_float_(
    ...
    v6->fields.zoom,
    (const MethodInfo_2BFC2A0 *)Method_ActionExtensions_Call_float___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4352697 & 1) == 0 )
  {
    this = (WarBoardZoomSwitchButton_o *)sub_B70694(&StringLiteral_1/*""*/);
    byte_4352697 = 1;
  }
  currentZoomIndex = v2->fields.currentZoomIndex;
...
void __fastcall WarBoardZoomSwitchButton__OnClickRuleButton(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4352692 & 1) == 0 )
  {
    ...
    sub_B70694(&Method_WarBoardZoomSwitchButton_CloseRuleDialog__);
    byte_4352692 = 1;
  }
...
void __fastcall WarBoardZoomSwitchButton__UpdateUI(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( !UnityEngine_Object__op_Equality(buttonSprite, 0LL, 0LL) )
  {
    ...
    if ( !v5 )
      sub_B7076C(CurrentButtonSpriteName, v7);
