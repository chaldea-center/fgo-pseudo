void __fastcall WarBoardZoomSwitchButton___ctor(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B64ADB & 1) == 0 )
  {
    sub_1BE4ACC(&WarBoardZoomSwitchButton_ZoomSpritePair___TypeInfo, method);
    byte_4B64ADB = 1;
  }
  v3 = (struct WarBoardZoomSwitchButton_ZoomSpritePair_array *)sub_1BE4B74(
                                                                 WarBoardZoomSwitchButton_ZoomSpritePair___TypeInfo,
                                                                 0LL);
  this->fields.zoomSpritePairArray = v3;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.zoomSpritePairArray, (int64_t)v3, v4, v5, v6, v7, v8, v9);
...
void __fastcall WarBoardZoomSwitchButton__ClickButton(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B64AD6 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_ActionExtensions_Call_float___, method);
    this = (WarBoardZoomSwitchButton_o *)sub_1BE4ACC(&Method_WarBoardZoomSwitchButton_ClickButton__, v3);
    byte_4B64AD6 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_WarBoardZoomSwitchButton_ClickButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1BE4AE4(Method_WarBoardZoomSwitchButton_ClickButton__);
...
LABEL_10:
  ...
  ActionExtensions__Call_float_(
    ...
    v9->fields.zoom,
    (const MethodInfo_2EAB96C *)Method_ActionExtensions_Call_float___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B64AD9 & 1) == 0 )
  {
    this = (WarBoardZoomSwitchButton_o *)sub_1BE4ACC(&StringLiteral_1/*""*/, method);
    byte_4B64AD9 = 1;
  }
...
void __fastcall WarBoardZoomSwitchButton__OnClickRuleButton(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B64AD4 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_WarBoardZoomSwitchButton_CloseRuleDialog__, v3);
    byte_4B64AD4 = 1;
  }
...
void __fastcall WarBoardZoomSwitchButton__UpdateUI(WarBoardZoomSwitchButton_o *this, const MethodInfo *method)
{
  ...
  if ( !UnityEngine_Object__op_Equality(buttonSprite, 0LL, 0LL) )
  {
    ...
    if ( !v5 )
      sub_1BE4D28(CurrentButtonSpriteName, v7);
