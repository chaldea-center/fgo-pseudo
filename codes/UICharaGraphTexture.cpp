        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3C1D & 1) == 0 )
  {
    sub_1B00CCC(&AssetManager_TypeInfo, assetMain);
    byte_48E3C1D = 1;
  }
  if ( assetMain )
  {
    ...
    if ( loadName )
    {
      ...
      if ( AssetManager__compAssetStorage_36587492(assetMain, loadName, 0LL) )
      {
        ...
        if ( v8 )
        {
          if ( !AssetManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
          AssetManager__releaseAsset_36589816(v8, 0LL);
        }
        this->fields.assetMain = assetMain;
        sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.assetMain, (int32_t)assetMain, v6, v7);
        this->fields.loadName = 0LL;
        sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.loadName, 0, v9, v10);
        ...
        if ( callbackFunc )
        {
          ...
          sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.callbackFunc, 0, v13, v14);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3C24 & 1) == 0 )
  {
    sub_1B00CCC(&EventDelegate_Callback_TypeInfo, finishAction);
    sub_1B00CCC(&EventDelegate_TypeInfo, v7);
    sub_1B00CCC(&UnityEngine_Object_TypeInfo, v8);
    sub_1B00CCC(&Method_UICharaGraphTexture___c__DisplayClass49_0__ExecuteCharaGraphFadeout_b__0__, v9);
    sub_1B00CCC(&UICharaGraphTexture___c__DisplayClass49_0_TypeInfo, v10);
    byte_48E3C24 = 1;
  }
  v11 = sub_1B00F18(UICharaGraphTexture___c__DisplayClass49_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v11, 0LL);
  if ( !v11 )
    goto LABEL_15;
  *(_QWORD *)(v11 + 16) = finishAction;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)(v11 + 16), (int32_t)finishAction, v14, v15);
    ...
    if ( bodyTexture )
    {
      ...
      if ( bodyTexture )
      {
        ...
        if ( bodyTexture )
        {
          ...
          v20 = (EventDelegate_Callback_o *)sub_1B00F18(EventDelegate_Callback_TypeInfo);
          ...
          EventDelegate__Set_45634652(klass, v20, 0LL);
          return;
        }
      }
    }
LABEL_15:
    sub_1B00F28(bodyTexture, v13);
  }
}
...
LABEL_11:
      sub_1B00F28(nameTexture, method);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3C1B & 1) == 0 )
  {
    sub_1B00CCC(&System_Action_TypeInfo, callbackFunc);
    sub_1B00CCC(&AssetManager_TypeInfo, v6);
    sub_1B00CCC(&AssetLoader_LoadEndDataHandler_TypeInfo, v7);
    sub_1B00CCC(&Method_UICharaGraphTexture_EndLoadAsset__, v8);
    byte_48E3C1B = 1;
  }
  if ( this->fields.baseKind == 2 )
    CommandAssetName = CharaGraphManager__GetCommandAssetName(this->fields.commandCodeId, 0LL);
  else
    CommandAssetName = CharaGraphManager__GetAssetName_36700744(this->fields.imageSvtId, 0LL);
  p_callbackFunc = CommandAssetName;
  loadName = this->fields.loadName;
  if ( loadName )
  {
    if ( System_String__Equals_60334064(loadName, p_callbackFunc, 0LL) )
    {
      if ( callbackFunc )
      {
        ...
        sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.callbackFunc, (int32_t)v14, v15, v16);
      }
...
LABEL_28:
      ...
      sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.loadName, (int32_t)p_callbackFunc, v27, v28);
...
LABEL_27:
    sub_1B00C70(v3, (int32_t)v17, v24, v25);
    goto LABEL_28;
  }
  ...
  if ( !name )
    sub_1B00F28(0LL, v10);
  if ( !System_String__Equals_60334064(name, p_callbackFunc, 0LL) )
    goto LABEL_21;
...
LABEL_15:
  ...
  if ( assetMain )
  {
    if ( !AssetManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
    AssetManager__releaseAsset_36589816(assetMain, 0LL);
    this->fields.assetMain = 0LL;
    sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.assetMain, 0, v9, v10);
  }
  loadName = this->fields.loadName;
  if ( loadName )
  {
    ...
    sub_1B00C70(p_loadName, 0, v13, v14);
  }
}
...
void __fastcall UICharaGraphTexture__SetActive(UICharaGraphTexture_o *this, bool isActive, const MethodInfo *method)
{
  ...
  {
    sub_1B00F28(bodyTexture, isActive);
  }
...
void __fastcall UICharaGraphTexture__SetCharacter_39541296(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3C10 & 1) == 0 )
  {
    this = (UICharaGraphTexture_o *)sub_1B00CCC(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, userSvtEntity);
    byte_48E3C10 = 1;
  }
  if ( !userSvtEntity )
  ...
  *(_QWORD *)&v15.fields.fakeValue = v7;
  v9 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_45313044(v15, 0LL);
  v10 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_45313044(userSvtEntity->fields.limitCount, 0LL);
  UICharaGraphRender__SetCharacter(
    v6,
    v9,
    v10,
...
void __fastcall UICharaGraphTexture__SetCharacter_39541540(
        UICharaGraphTexture_o *this,
        UserServantEntity_o *userSvtEntity,
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v19.fields.fakeValue = v11;
  ...
  v14 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_45313044(userSvtEntity->fields.limitCount, 0LL);
  UICharaGraphRender__SetCharacter_39532776(
    v10,
    v13,
    v14,
    imageLimitCount,
...
void __fastcall UICharaGraphTexture__SetCharacter_39541800(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3C12 & 1) == 0 )
  {
    this = (UICharaGraphTexture_o *)sub_1B00CCC(
  ...
  *(_QWORD *)hp = 0LL;
  ...
  if ( !userSvtCollectionEntity )
    sub_1B00F28(this, userSvtCollectionEntity);
...
void __fastcall UICharaGraphTexture__SetCharacter_39542052(
        UICharaGraphTexture_o *this,
        UserServantCollectionEntity_o *userSvtCollectionEntity,
        int32_t imageLimitCount,
        System_Action_o *callbackFunc,
...
void __fastcall UICharaGraphTexture__SetCharacter_39542316(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( !servantLeaderInfo )
    sub_1B00F28(this, servantLeaderInfo);
...
void __fastcall UICharaGraphTexture__SetCharacter_39542512(
        UICharaGraphTexture_o *this,
        ServantLeaderInfo_o *servantLeaderInfo,
        int32_t imageLimitCount,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v16.fields.fakeValue = v9;
  v11 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_45313044(v16, 0LL);
  UICharaGraphRender__SetCharacter_39532776(
    v8,
    v11,
...
void __fastcall UICharaGraphTexture__SetCharacter_39542740(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( !equipTargetInfo )
    sub_1B00F28(this, equipTargetInfo);
  ...
  *(_QWORD *)&v14.fields.fakeValue = v9;
  v11 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_45313044(v14, 0LL);
  UICharaGraphRender__SetCharacter(
    v8,
    v11,
...
void __fastcall UICharaGraphTexture__SetCharacter_39542932(
        UICharaGraphTexture_o *this,
        EquipTargetInfo_o *equipTargetInfo,
        int32_t imageLimitCount,
        bool isNpcFollowerServantEquip,
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v19.fields.currentCryptoKey = v12;
  *(_QWORD *)&v19.fields.fakeValue = v11;
  v14 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_45313044(v19, 0LL);
  UICharaGraphRender__SetCharacter_39532776(
    v10,
    v14,
    equipTargetInfo->fields.limitCount,
        ...
        const MethodInfo *method)
{
  ...
  if ( !userCommandCodeEntity )
    sub_1B00F28(this, userCommandCodeEntity);
...
void __fastcall UICharaGraphTexture__SetCommand_39543312(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( !userCommandCodeCollectionEntity )
    sub_1B00F28(this, userCommandCodeCollectionEntity);
...
void __fastcall UICharaGraphTexture__SetCommand_39543456(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( !commandCodeEntity )
    sub_1B00F28(this, commandCodeEntity);
...
void __fastcall UICharaGraphTexture__SetCommand_39543600(
        UICharaGraphTexture_o *this,
...
void __fastcall UICharaGraphTexture__SetDepth(UICharaGraphTexture_o *this, int32_t d, const MethodInfo *method)
{
  ...
  if ( (byte_48E3C20 & 1) == 0 )
  {
    sub_1B00CCC(&UnityEngine_Object_TypeInfo, *(_QWORD *)&d);
    byte_48E3C20 = 1;
  }
  ...
  {
LABEL_20:
    sub_1B00F28(baseSprite, *(_QWORD *)&d);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3C1F & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_UICharaGraphTexture_EndLoadAsset__, v10);
    byte_48E3C1F = 1;
  }
  if ( v4 >= 11 )
  {
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.loadName, (int32_t)v13, v14, v15);
...
void __fastcall UICharaGraphTexture__SetFrame(UICharaGraphTexture_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E3C1C & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_857/*"+"*/, v6);
    sub_1B00CCC(&StringLiteral_10802/*"R"*/, v7);
    sub_1B00CCC(&StringLiteral_18445/*"e"*/, v8);
    sub_1B00CCC(&StringLiteral_17443/*"c"*/, v9);
    sub_1B00CCC(&StringLiteral_13016/*"T"*/, v10);
    sub_1B00CCC(&StringLiteral_8135/*"L"*/, v11);
    sub_1B00CCC(&StringLiteral_2622/*"B"*/, v12);
    sub_1B00CCC(&StringLiteral_18680/*"eframeB_hp"*/, v13);
    sub_1B00CCC(&StringLiteral_20159/*"img_ribbon_noblephantasmup"*/, v14);
    sub_1B00CCC(&StringLiteral_18679/*"eframeB_atk"*/, v15);
    this = (UICharaGraphTexture_o *)sub_1B00CCC(&StringLiteral_1/*""*/, v16);
    byte_48E3C1C = 1;
  }
  v69 = 0LL;
  ...
  if ( baseKind != 1 )
  {
    if ( !baseKind )
    {
      ...
      v29 = System_String__Concat_60325748(frameName, (System_String_o *)StringLiteral_8135/*"L"*/, 0LL);
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
      AtlasManager__SetCharaGraphaOption(v28, v29, 0LL);
      frameRightSprite = v3->fields.frameRightSprite;
      v31 = System_String__Concat_60325748(frameName, (System_String_o *)StringLiteral_10802/*"R"*/, 0LL);
      AtlasManager__SetCharaGraphaOption(frameRightSprite, v31, 0LL);
      frameTopSprite = v3->fields.frameTopSprite;
      v33 = System_String__Concat_60325748(frameName, (System_String_o *)StringLiteral_13016/*"T"*/, 0LL);
      AtlasManager__SetCharaGraphaOption(frameTopSprite, v33, 0LL);
      frameBottomSprite = v3->fields.frameBottomSprite;
      v35 = System_String__Concat_60325748(frameName, (System_String_o *)StringLiteral_2622/*"B"*/, 0LL);
      ...
      if ( SvtType__IsSvtMaterialTd(v3->fields.svtType, 0LL) )
      {
        ...
        if ( UnityEngine_Object__op_Inequality(materialTdSprite, 0LL, 0LL) )
        {
          ...
          if ( !AtlasManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
          AtlasManager__SetCharaGraphaOption(v43, (System_String_o *)StringLiteral_20159/*"img_ribbon_noblephantasmup"*/, 0LL);
        }
      }
      goto LABEL_24;
    }
    ...
    if ( baseKind == 2 )
    {
      v50 = System_String__Concat_60337008(
              (System_String_o *)StringLiteral_17443/*"c"*/,
              frameName,
              (System_String_o *)StringLiteral_13016/*"T"*/,
              0LL);
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
...
LABEL_24:
  ...
  v45 = System_String__Concat_60337008(
          (System_String_o *)StringLiteral_18445/*"e"*/,
          frameName,
          (System_String_o *)StringLiteral_13016/*"T"*/,
          0LL);
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
  ...
  v47 = System_String__Concat_60337008(
          (System_String_o *)StringLiteral_18445/*"e"*/,
          frameName,
          (System_String_o *)StringLiteral_2622/*"B"*/,
          0LL);
  ...
  if ( v3->fields.saintGraphType != 1 )
  {
    ...
    ((void (__fastcall *)(UISprite_o *, Il2CppMethodPointer))frameLeftSprite->klass->vtable._33_MakePixelPerfect.method)(
      frameLeftSprite,
      frameLeftSprite->klass->vtable._34_get_minWidth.methodPtr);
    AtlasManager__SetCharaGraphaOption(v3->fields.equipAtkSprite, (System_String_o *)StringLiteral_18679/*"eframeB_atk"*/, 0LL);
    ...
    ((void (__fastcall *)(UISprite_o *, Il2CppMethodPointer))frameLeftSprite->klass->vtable._33_MakePixelPerfect.method)(
      frameLeftSprite,
      frameLeftSprite->klass->vtable._34_get_minWidth.methodPtr);
    AtlasManager__SetCharaGraphaOption(v3->fields.equipHpSprite, (System_String_o *)StringLiteral_18680/*"eframeB_hp"*/, 0LL);
...
LABEL_25:
    ...
    && !SvtType__IsEnemyCollectionDetail(v3->fields.svtType, 0LL) )
  {
    if ( SvtType__IsStatusUp(v3->fields.svtType, 0LL) )
    {
      ...
      if ( v59 >= 1 )
      {
        frameLeftSprite = (UISprite_o *)System_String__Concat_60325748(
...
LABEL_95:
    sub_1B00F28(frameLeftSprite, v24);
  }
