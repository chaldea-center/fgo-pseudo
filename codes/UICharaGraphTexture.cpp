        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B386C0 & 1) == 0 )
  {
    sub_1BD3458(&AssetManager_TypeInfo, assetMain);
    byte_4B386C0 = 1;
  }
  if ( assetMain )
  {
    ...
    if ( loadName )
    {
      ...
      if ( AssetManager__compAssetStorage_38571692(assetMain, loadName, 0LL) )
      {
        ...
        if ( v12 )
        {
          if ( !AssetManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
          AssetManager__releaseAsset_38574016(v12, 0LL);
        }
        this->fields.assetMain = assetMain;
        sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.assetMain, (int64_t)assetMain, v6, v7, v8, v9, v10, v11);
        this->fields.loadName = 0LL;
        sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.loadName, 0LL, v13, v14, v15, v16, v17, v18);
        ...
        if ( callbackFunc )
        {
          ...
          sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.callbackFunc, 0LL, v21, v22, v23, v24, v25, v26);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B386C7 & 1) == 0 )
  {
    sub_1BD3458(&EventDelegate_Callback_TypeInfo, finishAction);
    sub_1BD3458(&EventDelegate_TypeInfo, v7);
    sub_1BD3458(&UnityEngine_Object_TypeInfo, v8);
    sub_1BD3458(&Method_UICharaGraphTexture___c__DisplayClass49_0__ExecuteCharaGraphFadeout_b__0__, v9);
    sub_1BD3458(&UICharaGraphTexture___c__DisplayClass49_0_TypeInfo, v10);
    byte_4B386C7 = 1;
  }
  v11 = sub_1BD36A4(UICharaGraphTexture___c__DisplayClass49_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v11, 0LL);
  if ( !v11 )
    goto LABEL_15;
  *(_QWORD *)(v11 + 16) = finishAction;
  sub_1BD33FC((PartyOrganizationUtility_o *)(v11 + 16), (int64_t)finishAction, v14, v15, v16, v17, v18, v19);
    ...
    if ( bodyTexture )
    {
      ...
      if ( bodyTexture )
      {
        ...
        if ( bodyTexture )
        {
          ...
          v24 = (EventDelegate_Callback_o *)sub_1BD36A4(EventDelegate_Callback_TypeInfo);
          ...
          EventDelegate__Set_47458532(klass, v24, 0LL);
          return;
        }
      }
    }
LABEL_15:
    sub_1BD36B4(bodyTexture, v13);
  }
}
...
LABEL_11:
      sub_1BD36B4(nameTexture, method);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B386BE & 1) == 0 )
  {
    sub_1BD3458(&System_Action_TypeInfo, callbackFunc);
    sub_1BD3458(&AssetManager_TypeInfo, v6);
    sub_1BD3458(&AssetLoader_LoadEndDataHandler_TypeInfo, v7);
    sub_1BD3458(&Method_UICharaGraphTexture_EndLoadAsset__, v8);
    byte_4B386BE = 1;
  }
  if ( this->fields.baseKind == 2 )
    CommandAssetName = CharaGraphManager__GetCommandAssetName(this->fields.commandCodeId, 0LL);
  else
    CommandAssetName = CharaGraphManager__GetAssetName_38687624(this->fields.imageSvtId, 0LL);
  p_callbackFunc = CommandAssetName;
  loadName = this->fields.loadName;
  if ( loadName )
  {
    if ( System_String__Equals_62533564(loadName, p_callbackFunc, 0LL) )
    {
      if ( callbackFunc )
      {
...
LABEL_28:
      ...
      v42 = (AssetLoader_LoadEndDataHandler_o *)sub_1BD36A4(AssetLoader_LoadEndDataHandler_TypeInfo);
...
LABEL_27:
    sub_1BD33FC(v3, v21, v28, v29, v30, v31, v32, v33);
    goto LABEL_28;
  }
  ...
  if ( !name )
    sub_1BD36B4(0LL, v10);
  if ( !System_String__Equals_62533564(name, p_callbackFunc, 0LL) )
    goto LABEL_21;
...
LABEL_15:
  ...
  if ( assetMain )
  {
    if ( !AssetManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
    AssetManager__releaseAsset_38574016(assetMain, 0LL);
    this->fields.assetMain = 0LL;
    sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.assetMain, 0LL, v9, v10, v11, v12, v13, v14);
  }
  loadName = this->fields.loadName;
  if ( loadName )
  {
    ...
    sub_1BD33FC(p_loadName, 0LL, v17, v18, v19, v20, v21, v22);
  }
}
...
void __fastcall UICharaGraphTexture__SetActive(UICharaGraphTexture_o *this, bool isActive, const MethodInfo *method)
{
  ...
  {
    sub_1BD36B4(bodyTexture, isActive);
  }
...
void __fastcall UICharaGraphTexture__SetCharacter_41658528(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B386B3 & 1) == 0 )
  {
    this = (UICharaGraphTexture_o *)sub_1BD3458(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, userSvtEntity);
    byte_4B386B3 = 1;
  }
  if ( !userSvtEntity )
  ...
  *(_QWORD *)&v15.fields.fakeValue = v7;
  v9 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47136620(v15, 0LL);
  v10 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47136620(userSvtEntity->fields.limitCount, 0LL);
  UICharaGraphRender__SetCharacter(
    v6,
    v9,
    v10,
...
void __fastcall UICharaGraphTexture__SetCharacter_41658772(
        UICharaGraphTexture_o *this,
        UserServantEntity_o *userSvtEntity,
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v19.fields.fakeValue = v11;
  ...
  v14 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47136620(userSvtEntity->fields.limitCount, 0LL);
  UICharaGraphRender__SetCharacter_41650008(
    v10,
    v13,
    v14,
    imageLimitCount,
...
void __fastcall UICharaGraphTexture__SetCharacter_41659032(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B386B5 & 1) == 0 )
  {
    this = (UICharaGraphTexture_o *)sub_1BD3458(
  ...
  *(_QWORD *)hp = 0LL;
  ...
  if ( !userSvtCollectionEntity )
    sub_1BD36B4(this, userSvtCollectionEntity);
...
void __fastcall UICharaGraphTexture__SetCharacter_41659284(
        UICharaGraphTexture_o *this,
        UserServantCollectionEntity_o *userSvtCollectionEntity,
        int32_t imageLimitCount,
        System_Action_o *callbackFunc,
...
void __fastcall UICharaGraphTexture__SetCharacter_41659548(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( !servantLeaderInfo )
    sub_1BD36B4(this, servantLeaderInfo);
...
void __fastcall UICharaGraphTexture__SetCharacter_41659744(
        UICharaGraphTexture_o *this,
        ServantLeaderInfo_o *servantLeaderInfo,
        int32_t imageLimitCount,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v16.fields.fakeValue = v9;
  v11 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47136620(v16, 0LL);
  UICharaGraphRender__SetCharacter_41650008(
    v8,
    v11,
...
void __fastcall UICharaGraphTexture__SetCharacter_41659972(
        UICharaGraphTexture_o *this,
...
void __fastcall UICharaGraphTexture__SetCharacter_41660164(
        UICharaGraphTexture_o *this,
        EquipTargetInfo_o *equipTargetInfo,
        int32_t imageLimitCount,
        bool isNpcFollowerServantEquip,
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v19.fields.currentCryptoKey = v12;
  *(_QWORD *)&v19.fields.fakeValue = v11;
  v14 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47136620(v19, 0LL);
  UICharaGraphRender__SetCharacter_41650008(
    v10,
    v14,
    equipTargetInfo->fields.limitCount,
        ...
        const MethodInfo *method)
{
  ...
  if ( !userCommandCodeEntity )
    sub_1BD36B4(this, userCommandCodeEntity);
...
void __fastcall UICharaGraphTexture__SetCommand_41660544(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( !userCommandCodeCollectionEntity )
    sub_1BD36B4(this, userCommandCodeCollectionEntity);
...
void __fastcall UICharaGraphTexture__SetCommand_41660688(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( !commandCodeEntity )
    sub_1BD36B4(this, commandCodeEntity);
...
void __fastcall UICharaGraphTexture__SetCommand_41660832(
        UICharaGraphTexture_o *this,
...
void __fastcall UICharaGraphTexture__SetDepth(UICharaGraphTexture_o *this, int32_t d, const MethodInfo *method)
{
  ...
  if ( (byte_4B386C3 & 1) == 0 )
  {
    sub_1BD3458(&UnityEngine_Object_TypeInfo, *(_QWORD *)&d);
    byte_4B386C3 = 1;
  }
  ...
  {
LABEL_20:
    sub_1BD36B4(baseSprite, *(_QWORD *)&d);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B386C2 & 1) == 0 )
  {
    ...
    sub_1BD3458(&Method_DataManager_GetMasterData_ServantLimitAddMaster___, v7);
    ...
    sub_1BD3458(&Method_UICharaGraphTexture_EndLoadAsset__, v10);
    byte_4B386C2 = 1;
  }
  if ( v4 >= 11 )
  {
    ...
    if ( !Instance
      || (Instance = DataManager__GetMasterData_object_(
                       (DataManager_o *)Instance,
                       (const MethodInfo_2F31684 *)Method_DataManager_GetMasterData_ServantLimitAddMaster___)) == 0LL )
    {
  ...
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.loadName, (int64_t)v13, v14, v15, v16, v17, v18, v19);
...
void __fastcall UICharaGraphTexture__SetFrame(UICharaGraphTexture_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B386BF & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_855/*"+"*/, v6);
    sub_1BD3458(&StringLiteral_11091/*"R"*/, v7);
    sub_1BD3458(&StringLiteral_18919/*"e"*/, v8);
    sub_1BD3458(&StringLiteral_17890/*"c"*/, v9);
    sub_1BD3458(&StringLiteral_13414/*"T"*/, v10);
    sub_1BD3458(&StringLiteral_8366/*"L"*/, v11);
    sub_1BD3458(&StringLiteral_2657/*"B"*/, v12);
    sub_1BD3458(&StringLiteral_19156/*"eframeB_hp"*/, v13);
    sub_1BD3458(&StringLiteral_20686/*"img_ribbon_noblephantasmup"*/, v14);
    sub_1BD3458(&StringLiteral_19155/*"eframeB_atk"*/, v15);
    this = (UICharaGraphTexture_o *)sub_1BD3458(&StringLiteral_1/*""*/, v16);
    byte_4B386BF = 1;
  }
  v69 = 0LL;
  ...
  if ( baseKind != 1 )
  {
    if ( !baseKind )
    {
      ...
      v29 = System_String__Concat_62525248(frameName, (System_String_o *)StringLiteral_8366/*"L"*/, 0LL);
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
      AtlasManager__SetCharaGraphaOption(v28, v29, 0LL);
      frameRightSprite = v3->fields.frameRightSprite;
      v31 = System_String__Concat_62525248(frameName, (System_String_o *)StringLiteral_11091/*"R"*/, 0LL);
      AtlasManager__SetCharaGraphaOption(frameRightSprite, v31, 0LL);
      frameTopSprite = v3->fields.frameTopSprite;
      v33 = System_String__Concat_62525248(frameName, (System_String_o *)StringLiteral_13414/*"T"*/, 0LL);
      AtlasManager__SetCharaGraphaOption(frameTopSprite, v33, 0LL);
      frameBottomSprite = v3->fields.frameBottomSprite;
      v35 = System_String__Concat_62525248(frameName, (System_String_o *)StringLiteral_2657/*"B"*/, 0LL);
      ...
      if ( SvtType__IsSvtMaterialTd(v3->fields.svtType, 0LL) )
      {
        ...
        if ( UnityEngine_Object__op_Inequality(materialTdSprite, 0LL, 0LL) )
        {
          ...
          if ( !AtlasManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
          AtlasManager__SetCharaGraphaOption(v43, (System_String_o *)StringLiteral_20686/*"img_ribbon_noblephantasmup"*/, 0LL);
        }
      }
      goto LABEL_24;
    }
    ...
    if ( baseKind == 2 )
    {
      v50 = System_String__Concat_62536508(
              (System_String_o *)StringLiteral_17890/*"c"*/,
              frameName,
              (System_String_o *)StringLiteral_13414/*"T"*/,
              0LL);
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
      AtlasManager__SetCharaGraphaOption(v49, v50, 0LL);
      v51 = v3->fields.frameBottomSprite;
      v52 = System_String__Concat_62536508(
              (System_String_o *)StringLiteral_17890/*"c"*/,
              frameName,
              (System_String_o *)StringLiteral_2657/*"B"*/,
              0LL);
...
LABEL_24:
  ...
  v45 = System_String__Concat_62536508(
          (System_String_o *)StringLiteral_18919/*"e"*/,
          frameName,
          (System_String_o *)StringLiteral_13414/*"T"*/,
          0LL);
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
  ...
  if ( v3->fields.saintGraphType != 1 )
  {
    ...
    ((void (__fastcall *)(UISprite_o *, Il2CppMethodPointer))frameLeftSprite->klass->vtable._33_MakePixelPerfect.method)(
      frameLeftSprite,
      frameLeftSprite->klass->vtable._34_get_minWidth.methodPtr);
    AtlasManager__SetCharaGraphaOption(v3->fields.equipAtkSprite, (System_String_o *)StringLiteral_19155/*"eframeB_atk"*/, 0LL);
    ...
    ((void (__fastcall *)(UISprite_o *, Il2CppMethodPointer))frameLeftSprite->klass->vtable._33_MakePixelPerfect.method)(
      frameLeftSprite,
      frameLeftSprite->klass->vtable._34_get_minWidth.methodPtr);
    AtlasManager__SetCharaGraphaOption(v3->fields.equipHpSprite, (System_String_o *)StringLiteral_19156/*"eframeB_hp"*/, 0LL);
...
LABEL_25:
    ...
    && !SvtType__IsEnemyCollectionDetail(v3->fields.svtType, 0LL) )
  {
    if ( SvtType__IsStatusUp(v3->fields.svtType, 0LL) )
    {
      ...
      if ( v59 >= 1 )
      {
        frameLeftSprite = (UISprite_o *)System_String__Concat_62525248(
...
LABEL_95:
    sub_1BD36B4(frameLeftSprite, v24);
  }
