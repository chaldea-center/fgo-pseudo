        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C23536 & 1) == 0 )
  {
    sub_1C3B764(&AssetManager_TypeInfo, assetMain);
    byte_4C23536 = 1;
  }
  if ( assetMain )
  {
    ...
    if ( loadName )
    {
      ...
      if ( AssetManager__compAssetStorage_39210780(assetMain, loadName, 0LL) )
      {
        ...
        if ( v12 )
        {
          if ( !AssetManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
          AssetManager__releaseAsset_39213104(v12, 0LL);
        }
        this->fields.assetMain = assetMain;
        sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.assetMain, (int64_t)assetMain, v6, v7, v8, v9, v10, v11);
        this->fields.loadName = 0LL;
        sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.loadName, 0LL, v13, v14, v15, v16, v17, v18);
        ...
        if ( callbackFunc )
        {
          ...
          sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.callbackFunc, 0LL, v21, v22, v23, v24, v25, v26);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2353D & 1) == 0 )
  {
    sub_1C3B764(&EventDelegate_Callback_TypeInfo, finishAction);
    sub_1C3B764(&EventDelegate_TypeInfo, v7);
    sub_1C3B764(&UnityEngine_Object_TypeInfo, v8);
    sub_1C3B764(&Method_UICharaGraphTexture___c__DisplayClass49_0__ExecuteCharaGraphFadeout_b__0__, v9);
    sub_1C3B764(&UICharaGraphTexture___c__DisplayClass49_0_TypeInfo, v10);
    byte_4C2353D = 1;
  }
  v11 = sub_1C3B9B0(UICharaGraphTexture___c__DisplayClass49_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v11, 0LL);
  if ( !v11 )
    goto LABEL_15;
  *(_QWORD *)(v11 + 16) = finishAction;
  sub_1C3B708((PartyOrganizationUtility_o *)(v11 + 16), (int64_t)finishAction, v14, v15, v16, v17, v18, v19);
    ...
    if ( bodyTexture )
    {
      ...
      if ( bodyTexture )
      {
        ...
        if ( bodyTexture )
        {
          ...
          v24 = (EventDelegate_Callback_o *)sub_1C3B9B0(EventDelegate_Callback_TypeInfo);
          ...
          EventDelegate__Set_48207248(klass, v24, 0LL);
          return;
        }
      }
    }
LABEL_15:
    sub_1C3B9C0(bodyTexture, v13);
  }
}
...
LABEL_11:
      sub_1C3B9C0(nameTexture, method);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( loadName )
  {
    if ( System_String__Equals_63376928(loadName, p_callbackFunc, 0LL) )
    {
      if ( callbackFunc )
      {
...
LABEL_28:
      ...
      v42 = (AssetLoader_LoadEndDataHandler_o *)sub_1C3B9B0(AssetLoader_LoadEndDataHandler_TypeInfo);
...
LABEL_27:
    sub_1C3B708(v3, v21, v28, v29, v30, v31, v32, v33);
    goto LABEL_28;
  }
  ...
  if ( !name )
    sub_1C3B9C0(0LL, v10);
  if ( !System_String__Equals_63376928(name, p_callbackFunc, 0LL) )
    goto LABEL_21;
...
LABEL_15:
  ...
  if ( assetMain )
  {
    if ( !AssetManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
    AssetManager__releaseAsset_39213104(assetMain, 0LL);
    this->fields.assetMain = 0LL;
    sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.assetMain, 0LL, v9, v10, v11, v12, v13, v14);
  }
  loadName = this->fields.loadName;
  if ( loadName )
  {
    ...
    sub_1C3B708(p_loadName, 0LL, v17, v18, v19, v20, v21, v22);
  }
}
...
void __fastcall UICharaGraphTexture__SetActive(UICharaGraphTexture_o *this, bool isActive, const MethodInfo *method)
{
  ...
  {
    sub_1C3B9C0(bodyTexture, isActive);
  }
...
void __fastcall UICharaGraphTexture__SetCharacter_42314172(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C23529 & 1) == 0 )
  {
    this = (UICharaGraphTexture_o *)sub_1C3B764(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, userSvtEntity);
    byte_4C23529 = 1;
  }
  if ( !userSvtEntity )
    sub_1C3B9C0(this, userSvtEntity);
  ...
  *(_QWORD *)&v15.fields.fakeValue = v7;
  ...
  v10 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47882560(userSvtEntity->fields.limitCount, 0LL);
  UICharaGraphRender__SetCharacter(
    v6,
    v9,
    v10,
...
void __fastcall UICharaGraphTexture__SetCharacter_42314416(
        UICharaGraphTexture_o *this,
        UserServantEntity_o *userSvtEntity,
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v19.fields.fakeValue = v11;
  ...
  v14 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47882560(userSvtEntity->fields.limitCount, 0LL);
  UICharaGraphRender__SetCharacter_42306460(
    v10,
    v13,
    v14,
    imageLimitCount,
...
void __fastcall UICharaGraphTexture__SetCharacter_42314680(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2352B & 1) == 0 )
  {
    this = (UICharaGraphTexture_o *)sub_1C3B764(
  ...
  *(_QWORD *)hp = 0LL;
  ...
  if ( !userSvtCollectionEntity )
    sub_1C3B9C0(this, userSvtCollectionEntity);
  ...
  *(_QWORD *)&v16.fields.fakeValue = v7;
  v9 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47882560(v16, 0LL);
  UICharaGraphRender__SetCharacter(
    v6,
    v9,
...
void __fastcall UICharaGraphTexture__SetCharacter_42314932(
        UICharaGraphTexture_o *this,
        UserServantCollectionEntity_o *userSvtCollectionEntity,
        int32_t imageLimitCount,
        System_Action_o *callbackFunc,
...
void __fastcall UICharaGraphTexture__SetCharacter_42315200(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( !servantLeaderInfo )
    sub_1C3B9C0(this, servantLeaderInfo);
...
void __fastcall UICharaGraphTexture__SetCharacter_42315400(
        UICharaGraphTexture_o *this,
        ServantLeaderInfo_o *servantLeaderInfo,
        int32_t imageLimitCount,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v16.fields.fakeValue = v9;
  v11 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47882560(v16, 0LL);
  UICharaGraphRender__SetCharacter_42306460(
    v8,
    v11,
...
void __fastcall UICharaGraphTexture__SetCharacter_42315632(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( !equipTargetInfo )
    sub_1C3B9C0(this, equipTargetInfo);
  ...
  *(_QWORD *)&v14.fields.fakeValue = v9;
  v11 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47882560(v14, 0LL);
  UICharaGraphRender__SetCharacter(
    v8,
    v11,
...
void __fastcall UICharaGraphTexture__SetCharacter_42315824(
        UICharaGraphTexture_o *this,
        EquipTargetInfo_o *equipTargetInfo,
        int32_t imageLimitCount,
        bool isNpcFollowerServantEquip,
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v19.fields.currentCryptoKey = v12;
  *(_QWORD *)&v19.fields.fakeValue = v11;
  v14 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47882560(v19, 0LL);
  UICharaGraphRender__SetCharacter_42306460(
    v10,
    v14,
    equipTargetInfo->fields.limitCount,
        ...
        const MethodInfo *method)
{
  ...
  if ( !userCommandCodeEntity )
    sub_1C3B9C0(this, userCommandCodeEntity);
  ...
  *(_QWORD *)&v12.fields.fakeValue = v7;
  v9 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47882560(v12, 0LL);
  UICharaGraphRender__SetCommand(v6, v9, v10);
  UICharaGraphTexture__LoadCharacter((UICharaGraphTexture_o *)v6, callbackFunc, v11);
}


void __fastcall UICharaGraphTexture__SetCommand_42316212(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( !userCommandCodeCollectionEntity )
    sub_1C3B9C0(this, userCommandCodeCollectionEntity);
...
void __fastcall UICharaGraphTexture__SetCommand_42316356(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( !commandCodeEntity )
    sub_1C3B9C0(this, commandCodeEntity);
...
void __fastcall UICharaGraphTexture__SetCommand_42316500(
        UICharaGraphTexture_o *this,
...
void __fastcall UICharaGraphTexture__SetDepth(UICharaGraphTexture_o *this, int32_t d, const MethodInfo *method)
{
  ...
  if ( (byte_4C23539 & 1) == 0 )
  {
    sub_1C3B764(&UnityEngine_Object_TypeInfo, *(_QWORD *)&d);
    byte_4C23539 = 1;
  }
  ...
  {
LABEL_20:
    sub_1C3B9C0(baseSprite, *(_QWORD *)&d);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C23538 & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_DataManager_GetMasterData_ServantLimitAddMaster___, v7);
    ...
    sub_1C3B764(&Method_UICharaGraphTexture_EndLoadAsset__, v10);
    byte_4C23538 = 1;
  }
  if ( v4 >= 11 )
  {
    ...
    if ( !Instance
      || (Instance = DataManager__GetMasterData_object_(
                       (DataManager_o *)Instance,
                       (const MethodInfo_2FF0204 *)Method_DataManager_GetMasterData_ServantLimitAddMaster___)) == 0LL )
    {
  ...
  sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.loadName, (int64_t)v13, v14, v15, v16, v17, v18, v19);
...
void __fastcall UICharaGraphTexture__SetFrame(UICharaGraphTexture_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C23535 & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_837/*", applePrice:"*/, v6);
    sub_1C3B764(&StringLiteral_11166/*"SAVEKEY_ConnectMarkEventId"*/, v7);
    sub_1C3B764(&StringLiteral_19063/*"fieldMotionIds"*/, v8);
    sub_1C3B764(&StringLiteral_18028/*"csISOLatin5"*/, v9);
    sub_1C3B764(&StringLiteral_13526/*"The OrderedDictionary is readonly and cannot be modified."*/, v10);
    sub_1C3B764(&StringLiteral_8398/*"MAX_FRIEND_HISTORY_NUM"*/, v11);
    sub_1C3B764(&StringLiteral_2657/*"B560"*/, v12);
    sub_1C3B764(&StringLiteral_19302/*"friend_cancel"*/, v13);
    sub_1C3B764(&StringLiteral_20851/*"lock"*/, v14);
    sub_1C3B764(&StringLiteral_19301/*"friend_accept"*/, v15);
    this = (UICharaGraphTexture_o *)sub_1C3B764(&StringLiteral_1/*""*/, v16);
    byte_4C23535 = 1;
  }
  v69 = 0LL;
  ...
  if ( baseKind != 1 )
  {
    if ( !baseKind )
    {
      ...
      v29 = System_String__Concat_63368612(frameName, (System_String_o *)StringLiteral_8398/*"MAX_FRIEND_HISTORY_NUM"*/, 0LL);
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
      AtlasManager__SetCharaGraphaOption(v28, v29, 0LL);
      frameRightSprite = v3->fields.frameRightSprite;
      v31 = System_String__Concat_63368612(frameName, (System_String_o *)StringLiteral_11166/*"SAVEKEY_ConnectMarkEventId"*/, 0LL);
      AtlasManager__SetCharaGraphaOption(frameRightSprite, v31, 0LL);
      frameTopSprite = v3->fields.frameTopSprite;
      v33 = System_String__Concat_63368612(frameName, (System_String_o *)StringLiteral_13526/*"The OrderedDictionary is readonly and cannot be modified."*/, 0LL);
      AtlasManager__SetCharaGraphaOption(frameTopSprite, v33, 0LL);
      frameBottomSprite = v3->fields.frameBottomSprite;
      v35 = System_String__Concat_63368612(frameName, (System_String_o *)StringLiteral_2657/*"B560"*/, 0LL);
      ...
      if ( SvtType__IsSvtMaterialTd(v3->fields.svtType, 0LL) )
      {
        ...
        if ( UnityEngine_Object__op_Inequality(materialTdSprite, 0LL, 0LL) )
        {
          ...
          if ( !AtlasManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
          AtlasManager__SetCharaGraphaOption(v43, (System_String_o *)StringLiteral_20851/*"lock"*/, 0LL);
        }
      }
      goto LABEL_24;
    }
    ...
    if ( baseKind == 2 )
    {
      v50 = System_String__Concat_63379872(
              (System_String_o *)StringLiteral_18028/*"csISOLatin5"*/,
              frameName,
              (System_String_o *)StringLiteral_13526/*"The OrderedDictionary is readonly and cannot be modified."*/,
              0LL);
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
      AtlasManager__SetCharaGraphaOption(v49, v50, 0LL);
      v51 = v3->fields.frameBottomSprite;
      v52 = System_String__Concat_63379872(
              (System_String_o *)StringLiteral_18028/*"csISOLatin5"*/,
              frameName,
              (System_String_o *)StringLiteral_2657/*"B560"*/,
              0LL);
...
LABEL_24:
  ...
  v45 = System_String__Concat_63379872(
          (System_String_o *)StringLiteral_19063/*"fieldMotionIds"*/,
          frameName,
          (System_String_o *)StringLiteral_13526/*"The OrderedDictionary is readonly and cannot be modified."*/,
          0LL);
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
  ...
  if ( v3->fields.saintGraphType != 1 )
  {
    ...
    ((void (__fastcall *)(UISprite_o *, Il2CppMethodPointer))frameLeftSprite->klass->vtable._33_MakePixelPerfect.method)(
      frameLeftSprite,
      frameLeftSprite->klass->vtable._34_get_minWidth.methodPtr);
    AtlasManager__SetCharaGraphaOption(v3->fields.equipAtkSprite, (System_String_o *)StringLiteral_19301/*"friend_accept"*/, 0LL);
    ...
    ((void (__fastcall *)(UISprite_o *, Il2CppMethodPointer))frameLeftSprite->klass->vtable._33_MakePixelPerfect.method)(
      frameLeftSprite,
      frameLeftSprite->klass->vtable._34_get_minWidth.methodPtr);
    AtlasManager__SetCharaGraphaOption(v3->fields.equipHpSprite, (System_String_o *)StringLiteral_19302/*"friend_cancel"*/, 0LL);
...
LABEL_25:
    ...
    && !SvtType__IsEnemyCollectionDetail(v3->fields.svtType, 0LL) )
  {
    if ( SvtType__IsStatusUp(v3->fields.svtType, 0LL) )
    {
      ...
      if ( v59 >= 1 )
      {
        frameLeftSprite = (UISprite_o *)System_String__Concat_63368612(
...
LABEL_95:
    sub_1C3B9C0(frameLeftSprite, v24);
  }
