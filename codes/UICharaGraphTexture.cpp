...
void UICharaGraphTexture__EndLoadAsset(UICharaGraphTexture_o *this, AssetData_o *assetMain, const MethodInfo *method)
{
  ...
  if ( assetMain )
  {
    ...
    if ( loadName )
    {
      ...
      if ( AssetManager__compAssetStorage_40805744(assetMain, loadName, 0) )
      {
        ...
        sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.loadName, 0, v13, v14, v15, v16, v17, v18);
        ...
        if ( callbackFunc )
        {
          ...
          sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.callbackFunc, 0, v21, v22, v23, v24, v25, v26);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC8C23 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_UICharaGraphTexture___c__DisplayClass49_0__ExecuteCharaGraphFadeout_b__0__);
    sub_1C713B0(&UICharaGraphTexture___c__DisplayClass49_0_TypeInfo);
    byte_4CC8C23 = 1;
  }
  v7 = sub_1C715FC(UICharaGraphTexture___c__DisplayClass49_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v7, 0);
  if ( !v7 )
    goto LABEL_15;
  *(_QWORD *)(v7 + 16) = finishAction;
  sub_1C71354((GrandQuestFolderBoardItem_o *)(v7 + 16), (int32_t)finishAction, v10, v11, v12, v13, v14, v15);
    ...
    if ( bodyTexture )
    {
      ...
      if ( bodyTexture )
      {
        ...
        if ( bodyTexture )
        {
          ...
          EventDelegate__Set_49625676(klass, v20, 0);
          return;
        }
      }
    }
LABEL_15:
    sub_1C71608(bodyTexture, v9);
  }
}
...
LABEL_11:
      sub_1C71608(nameTexture, method);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC8C1A & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_UICharaGraphTexture_EndLoadAsset__);
    byte_4CC8C1A = 1;
  }
  if ( this->fields.baseKind == 2 )
    CommandAssetName = CharaGraphManager__GetCommandAssetName(this->fields.commandCodeId, 0);
  else
    CommandAssetName = CharaGraphManager__GetAssetName_40930896(
  ...
  if ( loadName )
  {
    if ( System_String__Equals_64067044(loadName, p_callbackFunc, 0) )
    {
      if ( callbackFunc )
      {
...
LABEL_27:
    sub_1C71354(v3, (int32_t)v18, v25, v26, v27, v28, v29, v30);
    goto LABEL_28;
  }
  ...
  if ( !name )
    sub_1C71608(0, v7);
  if ( !System_String__Equals_64067044(name, p_callbackFunc, 0) )
    goto LABEL_21;
...
LABEL_15:
  ...
  if ( assetMain )
  {
    if ( !AssetManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
    AssetManager__releaseAsset_40808072(assetMain, 0);
    this->fields.assetMain = 0;
    sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.assetMain, 0, v8, v9, v10, v11, v12, v13);
  }
  loadName = this->fields.loadName;
  if ( loadName )
  {
    ...
    p_loadName->klass = 0;
    sub_1C71354(p_loadName, 0, v16, v17, v18, v19, v20, v21);
  }
}
...
void UICharaGraphTexture__SetCharacter_44216760(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC8C0F & 1) == 0 )
  {
    this = (UICharaGraphTexture_o *)sub_1C713B0(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    byte_4CC8C0F = 1;
  }
  if ( !userSvtEntity )
    goto LABEL_19;
  ...
  *(_QWORD *)&v27.fields.fakeValue = v7;
  v9 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49297952(v27, 0);
  v10 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49297952(userSvtEntity->fields.limitCount, 0);
...
void UICharaGraphTexture__SetCharacter_44217140(
        UICharaGraphTexture_o *this,
        UserServantEntity_o *userSvtEntity,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC8C10 & 1) == 0 )
  {
    ...
    this = (UICharaGraphTexture_o *)sub_1C713B0(&UserServantGrandInfo_TypeInfo);
    byte_4CC8C10 = 1;
  }
  if ( !userSvtEntity )
    goto LABEL_33;
  ...
  *(_QWORD *)&v34.fields.fakeValue = v16;
  v19 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49297952(v34, 0);
  v20 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49297952(userSvtEntity->fields.limitCount, 0);
  UICharaGraphRender__SetCharacter_44208136(
    v14,
    v19,
    v20,
    imageLimitCount,
...
void UICharaGraphTexture__SetCharacter_44217720(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)hp = 0;
  ...
  if ( !userSvtCollectionEntity )
    sub_1C71608(this, userSvtCollectionEntity);
  ...
  *(_QWORD *)&v25.fields.fakeValue = v7;
  v9 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49297952(v25, 0);
...
void UICharaGraphTexture__SetCharacter_44218056(
        UICharaGraphTexture_o *this,
        UserServantCollectionEntity_o *userSvtCollectionEntity,
        int32_t imageLimitCount,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v27.fields.fakeValue = v9;
  v11 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49297952(v27, 0);
  maxLimitCount = userSvtCollectionEntity->fields.maxLimitCount;
  maxLv = userSvtCollectionEntity->fields.maxLv;
  v14 = v11;
  IsGrandServant = UserServantCollectionEntity__IsGrandServant(userSvtCollectionEntity, 0);
...
void UICharaGraphTexture__SetCharacter_44218400(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v19.fields.fakeValue = v7;
  ...
  UICharaGraphRender__SetCharacter_44208136(v6, v11, limitCount, v15, exceedCount, lv, 0, 0, 0, IsGrandSvt, v18);
  UICharaGraphTexture__LoadCharacter((UICharaGraphTexture_o *)v6, callbackFunc, v17);
}


void UICharaGraphTexture__SetCharacter_44218648(
        UICharaGraphTexture_o *this,
        ServantLeaderInfo_o *servantLeaderInfo,
        int32_t imageLimitCount,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v26.fields.fakeValue = v9;
  v11 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49297952(v26, 0);
  exceedCount = servantLeaderInfo->fields.exceedCount;
  limitCount = servantLeaderInfo->fields.limitCount;
  lv = servantLeaderInfo->fields.lv;
  v15 = v11;
...
void UICharaGraphTexture__SetCharacter_44218976(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v14.fields.fakeValue = v9;
  v11 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49297952(v14, 0);
  UICharaGraphRender__SetCharacter(
    v8,
    v11,
...
void UICharaGraphTexture__SetCharacter_44219172(
        UICharaGraphTexture_o *this,
        EquipTargetInfo_o *equipTargetInfo,
        int32_t imageLimitCount,
        bool isNpcFollowerServantEquip,
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v19.fields.fakeValue = v11;
  v14 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49297952(v19, 0);
  UICharaGraphRender__SetCharacter_44208136(
    v10,
    v14,
    equipTargetInfo->fields.limitCount,
        ...
        const MethodInfo *method)
{
  ...
  if ( !userCommandCodeEntity )
    sub_1C71608(this, userCommandCodeEntity);
...
void UICharaGraphTexture__SetCommand_44219572(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( !userCommandCodeCollectionEntity )
    sub_1C71608(this, userCommandCodeCollectionEntity);
...
void UICharaGraphTexture__SetCommand_44219716(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( !commandCodeEntity )
    sub_1C71608(this, commandCodeEntity);
...
void UICharaGraphTexture__SetCommand_44219860(
        UICharaGraphTexture_o *this,
...
void UICharaGraphTexture__SetDepth(UICharaGraphTexture_o *this, int32_t d, const MethodInfo *method)
{
  ...
  {
LABEL_20:
    sub_1C71608(baseSprite, *(_QWORD *)&d);
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.loadName, (int32_t)v9, v10, v11, v12, v13, v14, v15);
  v16 = (AssetLoader_LoadEndDataHandler_o *)sub_1C715FC(AssetLoader_LoadEndDataHandler_TypeInfo);
...
void UICharaGraphTexture__SetFrame(UICharaGraphTexture_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC8C1B & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_10950/*"R"*/);
    sub_1C713B0(&StringLiteral_18740/*"e"*/);
    sub_1C713B0(&StringLiteral_17703/*"c"*/);
    ...
    sub_1C713B0(&StringLiteral_20623/*"img_ribbon_noblephantasmup"*/);
    sub_1C713B0(&StringLiteral_18986/*"eframeB_atk"*/);
    this = (UICharaGraphTexture_o *)sub_1C713B0(&StringLiteral_1/*""*/);
    byte_4CC8C1B = 1;
  }
  v56 = 0;
  ...
  if ( baseKind != 1 )
  {
    if ( !baseKind )
    {
      ...
      v16 = System_String__Concat_64031724(frameName, (System_String_o *)StringLiteral_8252/*"L"*/, 0);
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
      AtlasManager__SetCharaGraphaOption(v15, v16, 0);
      frameRightSprite = v3->fields.frameRightSprite;
      v18 = System_String__Concat_64031724(frameName, (System_String_o *)StringLiteral_10950/*"R"*/, 0);
      AtlasManager__SetCharaGraphaOption(frameRightSprite, v18, 0);
      frameTopSprite = v3->fields.frameTopSprite;
      v20 = System_String__Concat_64031724(frameName, (System_String_o *)StringLiteral_13327/*"T"*/, 0);
      AtlasManager__SetCharaGraphaOption(frameTopSprite, v20, 0);
      frameBottomSprite = v3->fields.frameBottomSprite;
      v22 = System_String__Concat_64031724(frameName, (System_String_o *)StringLiteral_2504/*"B"*/, 0);
      ...
      if ( SvtType__IsSvtMaterialTd(v3->fields.svtType, 0) )
      {
        ...
        if ( UnityEngine_Object__op_Inequality(materialTdSprite, 0, 0) )
        {
          ...
          if ( !AtlasManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
          AtlasManager__SetCharaGraphaOption(v30, (System_String_o *)StringLiteral_20623/*"img_ribbon_noblephantasmup"*/, 0);
        }
      }
      goto LABEL_24;
    }
    ...
    if ( baseKind == 2 )
    {
      v37 = System_String__Concat_64069988(
              (System_String_o *)StringLiteral_17703/*"c"*/,
              frameName,
      ...
      v39 = System_String__Concat_64069988(
              (System_String_o *)StringLiteral_17703/*"c"*/,
              frameName,
...
LABEL_24:
  ...
  if ( v3->fields.saintGraphType != 1 )
  {
    ...
    ((void (__fastcall *)(UISprite_o *, const MethodInfo *))frameLeftSprite->klass->vtable._33_MakePixelPerfect.methodPtr)(
      frameLeftSprite,
      frameLeftSprite->klass->vtable._33_MakePixelPerfect.method);
    AtlasManager__SetCharaGraphaOption(v3->fields.equipAtkSprite, (System_String_o *)StringLiteral_18986/*"eframeB_atk"*/, 0);
    ...
    ((void (__fastcall *)(UISprite_o *, const MethodInfo *))frameLeftSprite->klass->vtable._33_MakePixelPerfect.methodPtr)(
      frameLeftSprite,
      frameLeftSprite->klass->vtable._33_MakePixelPerfect.method);
    AtlasManager__SetCharaGraphaOption(v3->fields.equipHpSprite, (System_String_o *)StringLiteral_18987/*"eframeB_hp"*/, 0);
...
LABEL_25:
    ...
    && !SvtType__IsEnemyCollectionDetail(v3->fields.svtType, 0) )
  {
    if ( SvtType__IsStatusUp(v3->fields.svtType, 0) )
    {
      ...
      if ( v46 >= 1 )
      {
        frameLeftSprite = (UISprite_o *)System_String__Concat_64031724(
...
LABEL_96:
    sub_1C71608(frameLeftSprite, v11);
  }
