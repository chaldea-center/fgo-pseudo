        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F417 & 1) == 0 )
  {
    sub_1B761C0(&AssetManager_TypeInfo, assetMain);
    byte_4A2F417 = 1;
  }
  if ( assetMain )
  {
    ...
    if ( loadName )
    {
      ...
      if ( AssetManager__compAssetStorage_37609936(assetMain, loadName, 0LL) )
      {
        ...
        if ( v8 )
        {
          if ( !AssetManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
          AssetManager__releaseAsset_37612260(v8, 0LL);
        }
        this->fields.assetMain = assetMain;
        sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.assetMain, (int32_t)assetMain, v6, v7);
        this->fields.loadName = 0LL;
        sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.loadName, 0, v9, v10);
        ...
        if ( callbackFunc )
        {
          ...
          sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.callbackFunc, 0, v13, v14);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F41E & 1) == 0 )
  {
    sub_1B761C0(&EventDelegate_Callback_TypeInfo, finishAction);
    sub_1B761C0(&EventDelegate_TypeInfo, v7);
    sub_1B761C0(&UnityEngine_Object_TypeInfo, v8);
    sub_1B761C0(&Method_UICharaGraphTexture___c__DisplayClass49_0__ExecuteCharaGraphFadeout_b__0__, v9);
    sub_1B761C0(&UICharaGraphTexture___c__DisplayClass49_0_TypeInfo, v10);
    byte_4A2F41E = 1;
  }
  v11 = sub_1B7640C(UICharaGraphTexture___c__DisplayClass49_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v11, 0LL);
  if ( !v11 )
    goto LABEL_15;
  *(_QWORD *)(v11 + 16) = finishAction;
  sub_1B76164((ServantStatusBattleListViewItem_o *)(v11 + 16), (int32_t)finishAction, v14, v15);
    ...
    if ( bodyTexture )
    {
      ...
      if ( bodyTexture )
      {
        ...
        if ( bodyTexture )
        {
          ...
          v20 = (EventDelegate_Callback_o *)sub_1B7640C(EventDelegate_Callback_TypeInfo);
          ...
          EventDelegate__Set_46658580(klass, v20, 0LL);
          return;
        }
      }
    }
LABEL_15:
    sub_1B7641C(bodyTexture, v13);
  }
}
...
LABEL_11:
      sub_1B7641C(nameTexture, method);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F415 & 1) == 0 )
  {
    sub_1B761C0(&System_Action_TypeInfo, callbackFunc);
    sub_1B761C0(&AssetManager_TypeInfo, v6);
    sub_1B761C0(&AssetLoader_LoadEndDataHandler_TypeInfo, v7);
    sub_1B761C0(&Method_UICharaGraphTexture_EndLoadAsset__, v8);
    byte_4A2F415 = 1;
  }
  if ( this->fields.baseKind == 2 )
    CommandAssetName = CharaGraphManager__GetCommandAssetName(this->fields.commandCodeId, 0LL);
  else
    CommandAssetName = CharaGraphManager__GetAssetName_37724084(this->fields.imageSvtId, 0LL);
  p_callbackFunc = CommandAssetName;
  loadName = this->fields.loadName;
  if ( loadName )
  {
    if ( System_String__Equals_61543376(loadName, p_callbackFunc, 0LL) )
    {
      if ( callbackFunc )
      {
        ...
        sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.callbackFunc, (int32_t)v14, v15, v16);
      }
...
LABEL_28:
      ...
      sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.loadName, (int32_t)p_callbackFunc, v27, v28);
      v29 = this->fields.loadName;
      v30 = (AssetLoader_LoadEndDataHandler_o *)sub_1B7640C(AssetLoader_LoadEndDataHandler_TypeInfo);
...
LABEL_27:
    sub_1B76164(v3, (int32_t)v17, v24, v25);
    goto LABEL_28;
  }
  ...
  if ( !name )
    sub_1B7641C(0LL, v10);
  if ( !System_String__Equals_61543376(name, p_callbackFunc, 0LL) )
    goto LABEL_21;
...
LABEL_15:
  ...
  if ( assetMain )
  {
    if ( !AssetManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
    AssetManager__releaseAsset_37612260(assetMain, 0LL);
    this->fields.assetMain = 0LL;
    sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.assetMain, 0, v9, v10);
  }
  loadName = this->fields.loadName;
  if ( loadName )
  {
    ...
    sub_1B76164(p_loadName, 0, v13, v14);
  }
}
...
void __fastcall UICharaGraphTexture__SetActive(UICharaGraphTexture_o *this, bool isActive, const MethodInfo *method)
{
  ...
  {
    sub_1B7641C(bodyTexture, isActive);
  }
...
void __fastcall UICharaGraphTexture__SetCharacter_40650368(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F40A & 1) == 0 )
  {
    this = (UICharaGraphTexture_o *)sub_1B761C0(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, userSvtEntity);
    byte_4A2F40A = 1;
  }
  if ( !userSvtEntity )
  ...
  *(_QWORD *)&v15.fields.fakeValue = v7;
  v9 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(v15, 0LL);
  v10 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(userSvtEntity->fields.limitCount, 0LL);
  UICharaGraphRender__SetCharacter(
    v6,
    v9,
    v10,
...
void __fastcall UICharaGraphTexture__SetCharacter_40650612(
        UICharaGraphTexture_o *this,
        UserServantEntity_o *userSvtEntity,
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v19.fields.fakeValue = v11;
  v13 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(v19, 0LL);
  v14 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(userSvtEntity->fields.limitCount, 0LL);
  UICharaGraphRender__SetCharacter_40641848(
    v10,
    v13,
    v14,
    imageLimitCount,
...
void __fastcall UICharaGraphTexture__SetCharacter_40650872(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F40C & 1) == 0 )
  {
    this = (UICharaGraphTexture_o *)sub_1B761C0(
  ...
  *(_QWORD *)hp = 0LL;
  ...
  if ( !userSvtCollectionEntity )
    sub_1B7641C(this, userSvtCollectionEntity);
  ...
  *(_QWORD *)&v16.fields.fakeValue = v7;
  v9 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(v16, 0LL);
  UICharaGraphRender__SetCharacter(
    v6,
    v9,
...
void __fastcall UICharaGraphTexture__SetCharacter_40651124(
        UICharaGraphTexture_o *this,
        UserServantCollectionEntity_o *userSvtCollectionEntity,
        int32_t imageLimitCount,
        System_Action_o *callbackFunc,
...
void __fastcall UICharaGraphTexture__SetCharacter_40651388(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( !servantLeaderInfo )
    sub_1B7641C(this, servantLeaderInfo);
...
void __fastcall UICharaGraphTexture__SetCharacter_40651584(
        UICharaGraphTexture_o *this,
        ServantLeaderInfo_o *servantLeaderInfo,
        int32_t imageLimitCount,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v16.fields.fakeValue = v9;
  v11 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(v16, 0LL);
  UICharaGraphRender__SetCharacter_40641848(
    v8,
    v11,
...
void __fastcall UICharaGraphTexture__SetCharacter_40651812(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( !equipTargetInfo )
    sub_1B7641C(this, equipTargetInfo);
...
void __fastcall UICharaGraphTexture__SetCharacter_40652004(
        UICharaGraphTexture_o *this,
        EquipTargetInfo_o *equipTargetInfo,
        int32_t imageLimitCount,
        bool isNpcFollowerServantEquip,
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v19.fields.currentCryptoKey = v12;
  *(_QWORD *)&v19.fields.fakeValue = v11;
  v14 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(v19, 0LL);
  UICharaGraphRender__SetCharacter_40641848(
    v10,
    v14,
    equipTargetInfo->fields.limitCount,
        ...
        const MethodInfo *method)
{
  ...
  if ( !userCommandCodeEntity )
    sub_1B7641C(this, userCommandCodeEntity);
  ...
  *(_QWORD *)&v12.fields.fakeValue = v7;
  v9 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(v12, 0LL);
  UICharaGraphRender__SetCommand(v6, v9, v10);
  UICharaGraphTexture__LoadCharacter((UICharaGraphTexture_o *)v6, callbackFunc, v11);
}


void __fastcall UICharaGraphTexture__SetCommand_40652384(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( !userCommandCodeCollectionEntity )
    sub_1B7641C(this, userCommandCodeCollectionEntity);
...
void __fastcall UICharaGraphTexture__SetCommand_40652528(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( !commandCodeEntity )
    sub_1B7641C(this, commandCodeEntity);
...
void __fastcall UICharaGraphTexture__SetCommand_40652672(
        UICharaGraphTexture_o *this,
...
void __fastcall UICharaGraphTexture__SetDepth(UICharaGraphTexture_o *this, int32_t d, const MethodInfo *method)
{
  ...
  if ( (byte_4A2F41A & 1) == 0 )
  {
    sub_1B761C0(&UnityEngine_Object_TypeInfo, *(_QWORD *)&d);
    byte_4A2F41A = 1;
  }
  ...
  {
LABEL_20:
    sub_1B7641C(baseSprite, *(_QWORD *)&d);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F419 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_DataManager_GetMasterData_ServantLimitAddMaster___, v7);
    ...
    sub_1B761C0(&Method_UICharaGraphTexture_EndLoadAsset__, v10);
    byte_4A2F419 = 1;
  }
  if ( v4 >= 11 )
  {
    ...
    if ( !Instance
      || (Instance = DataManager__GetMasterData_object_(
                       (DataManager_o *)Instance,
                       (const MethodInfo_2E62408 *)Method_DataManager_GetMasterData_ServantLimitAddMaster___)) == 0LL )
    {
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.loadName, (int32_t)v13, v14, v15);
...
void __fastcall UICharaGraphTexture__SetFrame(UICharaGraphTexture_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2F416 & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_860/*"+"*/, v6);
    sub_1B761C0(&StringLiteral_10935/*"R"*/, v7);
    sub_1B761C0(&StringLiteral_18689/*"e"*/, v8);
    sub_1B761C0(&StringLiteral_17679/*"c"*/, v9);
    sub_1B761C0(&StringLiteral_13227/*"T"*/, v10);
    sub_1B761C0(&StringLiteral_8225/*"L"*/, v11);
    sub_1B761C0(&StringLiteral_2631/*"B"*/, v12);
    sub_1B761C0(&StringLiteral_18926/*"eframeB_hp"*/, v13);
    sub_1B761C0(&StringLiteral_20430/*"img_ribbon_noblephantasmup"*/, v14);
    sub_1B761C0(&StringLiteral_18925/*"eframeB_atk"*/, v15);
    this = (UICharaGraphTexture_o *)sub_1B761C0(&StringLiteral_1/*""*/, v16);
    byte_4A2F416 = 1;
  }
  v69 = 0LL;
  ...
  if ( baseKind != 1 )
  {
    if ( !baseKind )
    {
      ...
      v29 = System_String__Concat_61535060(frameName, (System_String_o *)StringLiteral_8225/*"L"*/, 0LL);
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
      AtlasManager__SetCharaGraphaOption(v28, v29, 0LL);
      frameRightSprite = v3->fields.frameRightSprite;
      v31 = System_String__Concat_61535060(frameName, (System_String_o *)StringLiteral_10935/*"R"*/, 0LL);
      AtlasManager__SetCharaGraphaOption(frameRightSprite, v31, 0LL);
      frameTopSprite = v3->fields.frameTopSprite;
      v33 = System_String__Concat_61535060(frameName, (System_String_o *)StringLiteral_13227/*"T"*/, 0LL);
      AtlasManager__SetCharaGraphaOption(frameTopSprite, v33, 0LL);
      frameBottomSprite = v3->fields.frameBottomSprite;
      v35 = System_String__Concat_61535060(frameName, (System_String_o *)StringLiteral_2631/*"B"*/, 0LL);
      ...
      if ( SvtType__IsSvtMaterialTd(v3->fields.svtType, 0LL) )
      {
        ...
        if ( UnityEngine_Object__op_Inequality(materialTdSprite, 0LL, 0LL) )
        {
          ...
          if ( !AtlasManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
          AtlasManager__SetCharaGraphaOption(v43, (System_String_o *)StringLiteral_20430/*"img_ribbon_noblephantasmup"*/, 0LL);
        }
      }
      goto LABEL_24;
    }
...
LABEL_24:
  ...
  v45 = System_String__Concat_61546320(
          (System_String_o *)StringLiteral_18689/*"e"*/,
          frameName,
          (System_String_o *)StringLiteral_13227/*"T"*/,
          0LL);
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
  ...
  if ( v3->fields.saintGraphType != 1 )
  {
    ...
    ((void (__fastcall *)(UISprite_o *, Il2CppMethodPointer))frameLeftSprite->klass->vtable._33_MakePixelPerfect.method)(
      frameLeftSprite,
      frameLeftSprite->klass->vtable._34_get_minWidth.methodPtr);
    AtlasManager__SetCharaGraphaOption(v3->fields.equipAtkSprite, (System_String_o *)StringLiteral_18925/*"eframeB_atk"*/, 0LL);
    ...
    ((void (__fastcall *)(UISprite_o *, Il2CppMethodPointer))frameLeftSprite->klass->vtable._33_MakePixelPerfect.method)(
      frameLeftSprite,
      frameLeftSprite->klass->vtable._34_get_minWidth.methodPtr);
    AtlasManager__SetCharaGraphaOption(v3->fields.equipHpSprite, (System_String_o *)StringLiteral_18926/*"eframeB_hp"*/, 0LL);
...
LABEL_25:
    ...
    && !SvtType__IsEnemyCollectionDetail(v3->fields.svtType, 0LL) )
  {
    if ( SvtType__IsStatusUp(v3->fields.svtType, 0LL) )
    {
      ...
      if ( v59 >= 1 )
      {
        frameLeftSprite = (UISprite_o *)System_String__Concat_61535060(
...
LABEL_95:
    sub_1B7641C(frameLeftSprite, v24);
  }
