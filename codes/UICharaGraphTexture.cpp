        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B176FA & 1) == 0 )
  {
    sub_1BCA7E0(&AssetManager_TypeInfo, assetMain, method);
    byte_4B176FA = 1;
  }
  if ( assetMain )
  {
    ...
    if ( loadName )
    {
      ...
      if ( AssetManager__compAssetStorage_38503380(assetMain, loadName, 0LL) )
      {
        ...
        if ( v13 )
        {
          ...
          AssetManager__releaseAsset_38505704(v13, 0LL);
        }
        this->fields.assetMain = assetMain;
        sub_1BCA784(
          (PartyOrganizationUtility_o *)&this->fields.assetMain,
          (int64_t)assetMain,
          v7,
          v8,
          v9,
        ...
        sub_1BCA784((PartyOrganizationUtility_o *)&this->fields.loadName, 0LL, v14, v15, v16, v17, v18, v19);
        ...
        if ( callbackFunc )
        {
          ...
          sub_1BCA784((PartyOrganizationUtility_o *)&this->fields.callbackFunc, 0LL, v22, v23, v24, v25, v26, v27);
        ...
        const MethodInfo *method)
{
  ...
  EventDelegate_Callback_o *v32; // x21
  __int64 v33; // x1

  if ( (byte_4B17701 & 1) == 0 )
  {
    sub_1BCA7E0(&EventDelegate_Callback_TypeInfo, finishAction, method);
    sub_1BCA7E0(&EventDelegate_TypeInfo, v8, v9);
    sub_1BCA7E0(&UnityEngine_Object_TypeInfo, v10, v11);
    sub_1BCA7E0(&Method_UICharaGraphTexture___c__DisplayClass49_0__ExecuteCharaGraphFadeout_b__0__, v12, v13);
    sub_1BCA7E0(&UICharaGraphTexture___c__DisplayClass49_0_TypeInfo, v14, v15);
    byte_4B17701 = 1;
  }
  v16 = sub_1BCAA2C(UICharaGraphTexture___c__DisplayClass49_0_TypeInfo, finishAction, method, v4);
  System_Object___ctor((Il2CppObject *)v16, 0LL);
  if ( !v16 )
    goto LABEL_15;
  *(_QWORD *)(v16 + 16) = finishAction;
  sub_1BCA784((PartyOrganizationUtility_o *)(v16 + 16), (int64_t)finishAction, v19, v20, v21, v22, v23, v24);
  ...
  if ( !UnityEngine_Object__op_Equality(spriteBase, 0LL, 0LL) )
  {
    ...
    if ( bodyTexture )
    {
      ...
      if ( bodyTexture )
      {
        v28 = UnityEngine_Component__get_gameObject(bodyTexture, 0LL);
        bodyTexture = (UnityEngine_Component_o *)TweenAlpha__Begin(v28, duration, 0.0, 0LL);
        if ( !*(_QWORD *)(v16 + 16) )
          return;
        if ( bodyTexture )
        {
          klass = (System_Collections_Generic_List_EventDelegate__o *)bodyTexture[3].klass;
          v32 = (EventDelegate_Callback_o *)sub_1BCAA2C(EventDelegate_Callback_TypeInfo, v18, v29, v30);
          ...
          if ( !EventDelegate_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(EventDelegate_TypeInfo, v33);
          EventDelegate__Set_47333340(klass, v32, 0LL);
          return;
        }
      }
    }
LABEL_15:
    sub_1BCAA3C(bodyTexture, v18);
  }
}
...
LABEL_11:
      sub_1BCAA3C(nameTexture, method);
    }
  }
}
...
void __fastcall UICharaGraphTexture__ExecuteSpriteFadeoutForce(UICharaGraphTexture_o *this, const MethodInfo *method)
{
  ...
  if ( !UnityEngine_Object__op_Equality(spriteBase, 0LL, 0LL) )
  {
    v8 = (UnityEngine_Object_o *)this->fields.spriteBase;
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    ...
    {
      v12 = (UnityEngine_GameObject_o *)this->fields.nameTexture;
      if ( v12 )
      {
        ((void (__fastcall *)(UnityEngine_GameObject_o *, Il2CppClass *, float))v12->klass[1]._1.castClass)(
          v12,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17703 & 1) == 0 )
  {
    sub_1BCA7E0(&UnityEngine_Object_TypeInfo, sprite, method);
    byte_4B17703 = 1;
  }
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B176F8 & 1) == 0 )
  {
    sub_1BCA7E0(&System_Action_TypeInfo, callbackFunc, method);
    sub_1BCA7E0(&AssetManager_TypeInfo, v6, v7);
    sub_1BCA7E0(&AssetLoader_LoadEndDataHandler_TypeInfo, v8, v9);
    sub_1BCA7E0(&Method_UICharaGraphTexture_EndLoadAsset__, v10, v11);
    byte_4B176F8 = 1;
  }
  if ( this->fields.baseKind == 2 )
    CommandAssetName = CharaGraphManager__GetCommandAssetName(this->fields.commandCodeId, 0LL);
  else
    CommandAssetName = CharaGraphManager__GetAssetName_38619312(this->fields.imageSvtId, 0LL);
  p_callbackFunc = CommandAssetName;
  loadName = this->fields.loadName;
  if ( loadName )
  {
    if ( System_String__Equals_62409536(loadName, p_callbackFunc, 0LL) )
    {
      if ( callbackFunc )
      {
        ...
        if ( v17 )
        {
          ...
          if ( (System_Action_c *)v17->klass != System_Action_TypeInfo )
            goto LABEL_25;
          p_callbackFunc->klass = (System_String_c *)v17;
          if ( (System_Action_c *)v17->klass != v25 )
            goto LABEL_25;
        }
        else
        {
    ...
    AssetManager__releaseAssetStorage(v29, 0LL);
LABEL_21:
    if ( !callbackFunc )
    {
LABEL_28:
      ...
      sub_1BCA784(
        ...
        v42,
        v43);
      v44 = this->fields.loadName;
      v48 = (AssetLoader_LoadEndDataHandler_o *)sub_1BCAA2C(AssetLoader_LoadEndDataHandler_TypeInfo, v45, v46, v47);
      AssetLoader_LoadEndDataHandler___ctor(v48, (Il2CppObject *)this, Method_UICharaGraphTexture_EndLoadAsset__, 0LL);
      if ( !AssetManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo, v49);
      AssetManager__loadAssetStorage(v44, v48, 1, 0LL);
      return;
    }
    v3 = (PartyOrganizationUtility_o *)&this->fields.callbackFunc;
    v30 = System_Delegate__Combine(
            (System_Delegate_o *)this->fields.callbackFunc,
            (System_Delegate_o *)callbackFunc,
            0LL);
    v24 = (int64_t)v30;
    ...
    {
      v3->klass = (PartyOrganizationUtility_c *)v30;
      if ( (System_Action_c *)v30->klass == v37 )
        goto LABEL_27;
    }
LABEL_25:
    sub_1BCACFC(v24);
LABEL_26:
    v3->klass = (PartyOrganizationUtility_c *)v24;
LABEL_27:
    sub_1BCA784(v3, v24, v31, v32, v33, v34, v35, v36);
    goto LABEL_28;
  }
  ...
  if ( !name )
    sub_1BCAA3C(0LL, v13);
  if ( !System_String__Equals_62409536(name, p_callbackFunc, 0LL) )
    goto LABEL_21;
  UICharaGraphTexture__SetFrame(this, v13);
  UICharaGraphTexture__SetTexture(this, v28);
  if ( callbackFunc )
    ((void (__fastcall *)(struct System_Reflection_MethodInfo_o *, _QWORD))callbackFunc->fields.m_target)(
      callbackFunc->fields.original_method_info,
      *(_QWORD *)&callbackFunc->fields.extra_arg);
...
void __fastcall UICharaGraphTexture__ReleaseCharacter(UICharaGraphTexture_o *this, const MethodInfo *method)
{
  ...
  {
    v8 = (UnityEngine_Component_o *)this->fields.bodyTexture;
    if ( !v8 )
      goto LABEL_24;
    ...
    if ( UnityEngine_Object__op_Inequality(gameObject, 0LL, 0LL) )
    {
      ...
      if ( !v8 )
        goto LABEL_24;
      v8 = (UnityEngine_Component_o *)UnityEngine_Component__get_gameObject(v8, 0LL);
      if ( !v8 )
        goto LABEL_24;
    ...
    if ( v8 )
    {
      ((void (__fastcall *)(UnityEngine_Component_o *, _QWORD, const char *))v8->klass[2]._1.gc_desc)(
        v8,
        0LL,
        v8->klass[2]._1.name);
      goto LABEL_15;
...
LABEL_15:
  ...
  if ( assetMain )
  {
    ...
    AssetManager__releaseAsset_38505704(assetMain, 0LL);
    this->fields.assetMain = 0LL;
    sub_1BCA784((PartyOrganizationUtility_o *)&this->fields.assetMain, 0LL, v12, v13, v14, v15, v16, v17);
  }
  loadName = this->fields.loadName;
  if ( loadName )
  {
    ...
    sub_1BCA784(p_loadName, 0LL, v20, v21, v22, v23, v24, v25);
  }
}
...
void __fastcall UICharaGraphTexture__SetActive(UICharaGraphTexture_o *this, bool isActive, const MethodInfo *method)
{
  ...
  {
    sub_1BCAA3C(bodyTexture, isActive);
  }
...
void __fastcall UICharaGraphTexture__SetCharacter_41557604(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B176ED & 1) == 0 )
  {
    this = (UICharaGraphTexture_o *)sub_1BCA7E0(
  ...
  *(_QWORD *)&v15.fields.fakeValue = v7;
  ...
  v10 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47011428(userSvtEntity->fields.limitCount, 0LL);
  UICharaGraphRender__SetCharacter(
    v6,
    v9,
    v10,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UICharaGraphTexture__SetCharacter_41557848(
        UICharaGraphTexture_o *this,
        UserServantEntity_o *userSvtEntity,
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v19.fields.fakeValue = v11;
  v13 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47011428(v19, 0LL);
  v14 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47011428(userSvtEntity->fields.limitCount, 0LL);
  UICharaGraphRender__SetCharacter_41549084(
    v10,
    v13,
    v14,
    imageLimitCount,
...
void __fastcall UICharaGraphTexture__SetCharacter_41558108(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)hp = 0LL;
  ...
  if ( !userSvtCollectionEntity )
    sub_1BCAA3C(this, userSvtCollectionEntity);
  ...
  if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, userSvtCollectionEntity);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UICharaGraphTexture__SetCharacter_41558360(
        UICharaGraphTexture_o *this,
        UserServantCollectionEntity_o *userSvtCollectionEntity,
        int32_t imageLimitCount,
        System_Action_o *callbackFunc,
...
void __fastcall UICharaGraphTexture__SetCharacter_41558624(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( !servantLeaderInfo )
    sub_1BCAA3C(this, servantLeaderInfo);
  ...
  if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, servantLeaderInfo);
  *(_QWORD *)&v15.fields.currentCryptoKey = v8;
  *(_QWORD *)&v15.fields.fakeValue = v7;
  v9 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47011428(v15, 0LL);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UICharaGraphTexture__SetCharacter_41558820(
        UICharaGraphTexture_o *this,
        ServantLeaderInfo_o *servantLeaderInfo,
        int32_t imageLimitCount,
        System_Action_o *callbackFunc,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UICharaGraphTexture__SetCharacter_41559048(
        UICharaGraphTexture_o *this,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UICharaGraphTexture__SetCharacter_41559240(
        UICharaGraphTexture_o *this,
        EquipTargetInfo_o *equipTargetInfo,
        int32_t imageLimitCount,
        bool isNpcFollowerServantEquip,
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v19.fields.currentCryptoKey = v12;
  *(_QWORD *)&v19.fields.fakeValue = v11;
  v14 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47011428(v19, 0LL);
  UICharaGraphRender__SetCharacter_41549084(
    v10,
    v14,
    equipTargetInfo->fields.limitCount,
        ...
        const MethodInfo *method)
{
  ...
  if ( !userCommandCodeEntity )
    sub_1BCAA3C(this, userCommandCodeEntity);
...
void __fastcall UICharaGraphTexture__SetCommand_41559620(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( !userCommandCodeCollectionEntity )
    sub_1BCAA3C(this, userCommandCodeCollectionEntity);
...
void __fastcall UICharaGraphTexture__SetCommand_41559764(
        UICharaGraphTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( !commandCodeEntity )
    sub_1BCAA3C(this, commandCodeEntity);
...
void __fastcall UICharaGraphTexture__SetCommand_41559908(
        UICharaGraphTexture_o *this,
...
void __fastcall UICharaGraphTexture__SetDepth(UICharaGraphTexture_o *this, int32_t d, const MethodInfo *method)
{
  ...
  if ( (byte_4B176FD & 1) == 0 )
  {
    sub_1BCA7E0(&UnityEngine_Object_TypeInfo, *(_QWORD *)&d, method);
    byte_4B176FD = 1;
  }
  ...
  {
LABEL_20:
    sub_1BCAA3C(baseSprite, *(_QWORD *)&d);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B176FC & 1) == 0 )
  {
    sub_1BCA7E0(&AssetManager_TypeInfo, *(_QWORD *)&svtId, *(_QWORD *)&imageLimitCount);
    ...
    sub_1BCA7E0(&Method_UICharaGraphTexture_EndLoadAsset__, v13, v14);
    byte_4B176FC = 1;
  }
  if ( v4 >= 11 )
  {
  ...
  v17 = CharaGraphManager__GetExCharaGraphAssetName(v5, 0LL);
  this->fields.loadName = v17;
  sub_1BCA784((PartyOrganizationUtility_o *)&this->fields.loadName, (int64_t)v17, v18, v19, v20, v21, v22, v23);
  ...
  AssetManager__loadAssetStorage(v17, v27, 1, 0LL);
}
...
void __fastcall UICharaGraphTexture__SetFrame(UICharaGraphTexture_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B176F9 & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&StringLiteral_855/*"+"*/, v8, v9);
    sub_1BCA7E0(&StringLiteral_11074/*"R"*/, v10, v11);
    sub_1BCA7E0(&StringLiteral_18890/*"e"*/, v12, v13);
    sub_1BCA7E0(&StringLiteral_17864/*"c"*/, v14, v15);
    sub_1BCA7E0(&StringLiteral_13395/*"T"*/, v16, v17);
    sub_1BCA7E0(&StringLiteral_8352/*"L"*/, v18, v19);
    sub_1BCA7E0(&StringLiteral_2652/*"B"*/, v20, v21);
    sub_1BCA7E0(&StringLiteral_19127/*"eframeB_hp"*/, v22, v23);
    sub_1BCA7E0(&StringLiteral_20656/*"img_ribbon_noblephantasmup"*/, v24, v25);
    sub_1BCA7E0(&StringLiteral_19126/*"eframeB_atk"*/, v26, v27);
    this = (UICharaGraphTexture_o *)sub_1BCA7E0(&StringLiteral_1/*""*/, v28, v29);
    byte_4B176F9 = 1;
  }
  v87 = 0LL;
  ...
  if ( baseKind != 1 )
  {
    if ( !baseKind )
    {
      v41 = v3->fields.frameLeftSprite;
      v43 = System_String__Concat_62401220(frameName, (System_String_o *)StringLiteral_8352/*"L"*/, 0LL);
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo, v42);
      AtlasManager__SetCharaGraphaOption(v41, v43, 0LL);
      frameRightSprite = v3->fields.frameRightSprite;
      v45 = System_String__Concat_62401220(frameName, (System_String_o *)StringLiteral_11074/*"R"*/, 0LL);
      AtlasManager__SetCharaGraphaOption(frameRightSprite, v45, 0LL);
      frameTopSprite = v3->fields.frameTopSprite;
      v47 = System_String__Concat_62401220(frameName, (System_String_o *)StringLiteral_13395/*"T"*/, 0LL);
      AtlasManager__SetCharaGraphaOption(frameTopSprite, v47, 0LL);
      frameBottomSprite = v3->fields.frameBottomSprite;
      v49 = System_String__Concat_62401220(frameName, (System_String_o *)StringLiteral_2652/*"B"*/, 0LL);
      AtlasManager__SetCharaGraphaOption(frameBottomSprite, v49, 0LL);
      raritySprite = v3->fields.raritySprite;
      v52 = UICharaGraphRender__GetRaritySprite((UICharaGraphRender_o *)v3, v51);
      AtlasManager__SetCharaGraphaOption(raritySprite, v52, 0LL);
      ...
      v55 = UICharaGraphRender__GetClassSprite((UICharaGraphRender_o *)v3, v54);
      AtlasManager__SetCharaGraphaOption(classSprite, v55, 0LL);
      if ( SvtType__IsSvtMaterialTd(v3->fields.svtType, 0LL) )
      {
        ...
        {
          v57 = v3->fields.materialTdSprite;
          if ( !AtlasManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo, v37);
          AtlasManager__SetCharaGraphaOption(v57, (System_String_o *)StringLiteral_20656/*"img_ribbon_noblephantasmup"*/, 0LL);
        }
      }
      goto LABEL_24;
    }
    ...
    if ( !frameLeftSprite )
      goto LABEL_95;
    UISprite__set_spriteName(frameLeftSprite, 0LL, 0LL);
    v64 = v3->fields.frameTopSprite;
    if ( baseKind == 2 )
    {
      v66 = System_String__Concat_62412480(
              (System_String_o *)StringLiteral_17864/*"c"*/,
              frameName,
              (System_String_o *)StringLiteral_13395/*"T"*/,
              0LL);
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo, v65);
      AtlasManager__SetCharaGraphaOption(v64, v66, 0LL);
      v67 = v3->fields.frameBottomSprite;
      v68 = System_String__Concat_62412480(
              (System_String_o *)StringLiteral_17864/*"c"*/,
              frameName,
              (System_String_o *)StringLiteral_2652/*"B"*/,
              0LL);
      AtlasManager__SetCharaGraphaOption(v67, v68, 0LL);
      v69 = v3->fields.raritySprite;
      v71 = UICharaGraphRender__GetRaritySprite((UICharaGraphRender_o *)v3, v70);
      AtlasManager__SetCharaGraphaOption(v69, v71, 0LL);
      frameLeftSprite = v3->fields.raritySprite;
      if ( !frameLeftSprite )
        goto LABEL_95;
      ((void (__fastcall *)(UISprite_o *, Il2CppMethodPointer))frameLeftSprite->klass->vtable._33_MakePixelPerfect.method)(
...
LABEL_24:
  ...
  if ( !frameLeftSprite )
    goto LABEL_95;
  UISprite__set_spriteName(frameLeftSprite, 0LL, 0LL);
  v58 = v3->fields.frameTopSprite;
  v60 = System_String__Concat_62412480(
          (System_String_o *)StringLiteral_18890/*"e"*/,
          frameName,
          (System_String_o *)StringLiteral_13395/*"T"*/,
          0LL);
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo, v59);
  AtlasManager__SetCharaGraphaOption(v58, v60, 0LL);
  v61 = v3->fields.frameBottomSprite;
  v62 = System_String__Concat_62412480(
          (System_String_o *)StringLiteral_18890/*"e"*/,
          frameName,
          (System_String_o *)StringLiteral_2652/*"B"*/,
          0LL);
  AtlasManager__SetCharaGraphaOption(v61, v62, 0LL);
  v63 = v3->fields.raritySprite;
  if ( v3->fields.saintGraphType != 1 )
  {
    v82 = UICharaGraphRender__GetRaritySprite((UICharaGraphRender_o *)v3, v37);
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo, v81);
    AtlasManager__SetCharaGraphaOption(v63, v82, 0LL);
    frameLeftSprite = v3->fields.raritySprite;
    if ( !frameLeftSprite )
      goto LABEL_95;
    ((void (__fastcall *)(UISprite_o *, Il2CppMethodPointer))frameLeftSprite->klass->vtable._33_MakePixelPerfect.method)(
      frameLeftSprite,
      frameLeftSprite->klass->vtable._34_get_minWidth.methodPtr);
    AtlasManager__SetCharaGraphaOption(v3->fields.equipAtkSprite, (System_String_o *)StringLiteral_19126/*"eframeB_atk"*/, 0LL);
    ...
    ((void (__fastcall *)(UISprite_o *, Il2CppMethodPointer))frameLeftSprite->klass->vtable._33_MakePixelPerfect.method)(
      frameLeftSprite,
      frameLeftSprite->klass->vtable._34_get_minWidth.methodPtr);
    AtlasManager__SetCharaGraphaOption(v3->fields.equipHpSprite, (System_String_o *)StringLiteral_19127/*"eframeB_hp"*/, 0LL);
...
LABEL_25:
    ...
    && !SvtType__IsEnemyCollectionDetail(v3->fields.svtType, 0LL) )
  {
    if ( SvtType__IsStatusUp(v3->fields.svtType, 0LL) )
    {
      ...
      v76 = static_fields->StatusUpAdjustAtk * atk;
      LODWORD(v87) = static_fields->StatusUpAdjustHp * v3->fields.hp;
      HIDWORD(v87) = v76;
      attackLabel = v3->fields.attackLabel;
      frameLeftSprite = (UISprite_o *)System_Int32__ToString((int32_t)&v87 + 4, 0LL);
      v37 = (MethodInfo *)frameLeftSprite;
      if ( v76 >= 1 )
      {
        frameLeftSprite = (UISprite_o *)System_String__Concat_62401220(
      ...
      if ( attackLabel )
      {
        UILabel__set_text(attackLabel, (System_String_o *)v37, 0LL);
        hpLabel = v3->fields.hpLabel;
        hp = v87;
        v80 = &v87;
LABEL_83:
        frameLeftSprite = (UISprite_o *)System_Int32__ToString((int32_t)v80, 0LL);
        v37 = (MethodInfo *)frameLeftSprite;
        if ( hp < 1 )
          goto LABEL_92;
        frameLeftSprite = (UISprite_o *)System_String__Concat_62401220(
...
LABEL_93:
    ...
    else
    {
      ...
      v84 = v3->fields.attackLabel;
      v85 = v3->fields.atk;
      v86 = IsKeepServantEquip;
      ...
      if ( v86 )
      {
        ...
        if ( v84 )
        {
          UILabel__set_text(v84, (System_String_o *)v37, 0LL);
          hpLabel = v3->fields.hpLabel;
          hp = v3->fields.hp;
          LODWORD(v80) = (_DWORD)v3 + 456;
          goto LABEL_83;
        }
      }
      else
      {
        if ( (v85 & 0x80000000) != 0 )
        {
          v37 = (MethodInfo *)StringLiteral_1/*""*/;
        }
        else
        {
          frameLeftSprite = (UISprite_o *)System_Int32__ToString((int32_t)frameLeftSprite, 0LL);
...
LABEL_95:
    sub_1BCAA3C(frameLeftSprite, v37);
  }
  ...
  v37 = (MethodInfo *)StringLiteral_1/*""*/;
LABEL_31:
  UILabel__set_text((UILabel_o *)frameLeftSprite, (System_String_o *)v37, 0LL);
  frameLeftSprite = (UISprite_o *)v3->fields.attackLabel;
  if ( !frameLeftSprite )
    goto LABEL_95;
  v88.fields.r = 1.0;
  ...
  v88.fields.b = v34;
  v88.fields.a = v39;
  UIWidget__set_color((UIWidget_o *)frameLeftSprite, v88, 0LL);
  frameLeftSprite = (UISprite_o *)v3->fields.hpLabel;
  if ( !frameLeftSprite )
    goto LABEL_95;
  v89.fields.r = 1.0;
  ...
  v89.fields.b = v35;
  v89.fields.a = v39;
  UIWidget__set_color((UIWidget_o *)frameLeftSprite, v89, 0LL);
}
...
void __fastcall UICharaGraphTexture__SetTexture(UICharaGraphTexture_o *this, const MethodInfo *method)
{
  ...
  *(UnityEngine_Rect_o *)&v9 = UICharaGraphRender__GetBodyUvRect((UICharaGraphRender_o *)this, v8);
  ...
  if ( (v16 & 1) != 0 )
  {
    ...
    if ( !v17 )
      goto LABEL_31;
    NameUvRect = UICharaGraphRender__GetNameUvRect((UICharaGraphRender_o *)this, v17->fields.mRect, v6);
    ...
    if ( UnityEngine_Object__op_Inequality(name2Texture, 0LL, 0LL) )
    {
      ...
      if ( gameObject )
      {
        ...
        if ( gameObject )
        {
          ...
          if ( v21 )
          {
            gameObject = ((__int64 (__fastcall *)(struct UITexture_o *, const MethodInfo *, Il2CppMethodPointer))v21->klass->vtable._27_set_mainTexture.method)(
                           v21,
                           v6,
                           v21->klass->vtable._28_get_shader.methodPtr);
            v22 = this->fields.name2Texture;
            if ( v22 )
            {
              v26 = UICharaGraphRender__GetNameUvRect((UICharaGraphRender_o *)this, v22->fields.mRect, v6);
              UITexture__set_uvRect(v22, v26, 0LL);
              return;
            }
          }
        }
...
LABEL_31:
  ...
  else
  {
    ...
    (*(void (__fastcall **)(__int64, _QWORD, _QWORD))(*(_QWORD *)gameObject + 744LL))(
      ...
      0LL,
      *(_QWORD *)(*(_QWORD *)gameObject + 752LL));
    v24 = (UnityEngine_Object_o *)this->fields.name2Texture;
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
