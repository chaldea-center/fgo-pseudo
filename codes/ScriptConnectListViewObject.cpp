...
void ScriptConnectListViewObject__Awake(ScriptConnectListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596DCFD & 1) == 0 )
  {
    sub_2213A60(&Method_UnityEngine_GameObject_GetComponent_ScriptConnectListViewItemDraw___);
    byte_596DCFD = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_38B6F40 *)Method_UnityEngine_GameObject_GetComponent_ScriptConnectListViewItemDraw___);
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_38B6F40 *)Method_UnityEngine_GameObject_GetComponent_ScriptConnectListViewObject___)) == 0) )
  {
    sub_2213CDC(DragObject, v4);
  }
  ScriptConnectListViewObject__Init_44340104((ScriptConnectListViewObject_o *)DragObject, 2, v6);
  return v5;
}
        ...
        const MethodInfo *method)
{
  ...
  {
    if ( (ScriptConnectListViewItem_c *)klass->_2.typeHierarchy[naturalAligment - 1] == ScriptConnectListViewItem_TypeInfo )
      v12 = initMode;
    else
      v12 = 0;
  }
  ...
  if ( !state || dispMode != this->fields.dispMode )
    ScriptConnectListViewObject__SetupDisp(this, v24);
...
void ScriptConnectListViewObject__Init_44340104(
        ScriptConnectListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
  ...
  v10.fields.y = v6;
  v10.fields.z = v7;
  ScriptConnectListViewObject__Init(this, initMode, 0, v4, v10, v3);
}


void ScriptConnectListViewObject__Init_44341300(
        ScriptConnectListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        const MethodInfo *method)
{
  ...
  v11.fields.y = v6;
  v11.fields.z = v7;
  ScriptConnectListViewObject__Init(this, initMode, callbackFunc, delay, v11, method);
}


void ScriptConnectListViewObject__Init_44341384(
        ScriptConnectListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
{
  ...
  v11.fields.y = v6;
  v11.fields.z = v7;
  ScriptConnectListViewObject__Init(this, initMode, callbackFunc, v4, v11, method);
}
...
void ScriptConnectListViewObject__SetupDisp(ScriptConnectListViewObject_o *this, const MethodInfo *method)
{
  ...
  ScriptConnectListViewItemDraw_o *v11; // x0
...
LABEL_8:
  ...
  if ( UnityEngine_Object__op_Inequality(itemDraw, 0, 0) )
  {
    ...
    if ( !v11 )
      sub_2213CDC(0, v9);
    ScriptConnectListViewItemDraw__SetItem(v11, (ScriptConnectListViewItem_o *)linkItem, this->fields.dispMode, v10);
  }
}
...
void ScriptConnectListViewObject__Start(ScriptConnectListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    ScriptConnectListViewObject__Init_44340104(this, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  __int64 v11; // x0
  bool v12; // zf
  ScriptConnectListViewObject_o *v13; // x0
  ...
  ScriptConnectListViewObject__remove_callbackFunc(v13, v14, v15);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_221405C(v8, System_Action_TypeInfo, v9, v10);
  ScriptConnectListViewObject__Awake(v13, v14);
}