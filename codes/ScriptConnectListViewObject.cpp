...
void ScriptConnectListViewObject__Awake(ScriptConnectListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEBC3C & 1) == 0 )
  {
    sub_1C7BAE8(&Method_UnityEngine_GameObject_GetComponent_ScriptConnectListViewItemDraw___);
    byte_4CEBC3C = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_31C70C8 *)Method_UnityEngine_GameObject_GetComponent_ScriptConnectListViewItemDraw___);
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_31C70C8 *)Method_UnityEngine_GameObject_GetComponent_ScriptConnectListViewObject___)) == 0) )
  {
    sub_1C7BD40(DragObject, v4);
  }
  ScriptConnectListViewObject__Init_37979168((ScriptConnectListViewObject_o *)DragObject, 2, v6);
  return v5;
}
...
void ScriptConnectListViewObject__Init_37979168(
        ScriptConnectListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void ScriptConnectListViewObject__Init_37980388(
        ScriptConnectListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void ScriptConnectListViewObject__Init_37980472(
        ScriptConnectListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void ScriptConnectListViewObject__Start(ScriptConnectListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    ScriptConnectListViewObject__Init_37979168(this, 2, v2);
}
