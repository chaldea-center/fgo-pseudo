...
void ScriptConnectListViewObject__Awake(ScriptConnectListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E74C2E & 1) == 0 )
  {
    sub_1D0F0B4(&Method_UnityEngine_GameObject_GetComponent_ScriptConnectListViewItemDraw___);
    byte_4E74C2E = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_32A8444 *)Method_UnityEngine_GameObject_GetComponent_ScriptConnectListViewItemDraw___);
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_32A8444 *)Method_UnityEngine_GameObject_GetComponent_ScriptConnectListViewObject___)) == 0) )
  {
    sub_1D0F30C(DragObject, v4);
  }
  ScriptConnectListViewObject__Init_38757612((ScriptConnectListViewObject_o *)DragObject, 2, v6);
  return v5;
}
...
void ScriptConnectListViewObject__Init_38757612(
        ScriptConnectListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void ScriptConnectListViewObject__Init_38758832(
        ScriptConnectListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void ScriptConnectListViewObject__Init_38758916(
        ScriptConnectListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void ScriptConnectListViewObject__Start(ScriptConnectListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    ScriptConnectListViewObject__Init_38757612(this, 2, v2);
}
