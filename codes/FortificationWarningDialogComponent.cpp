        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0017A & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_FortificationWarningDialogComponent__Close_b__16_0__, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A00179 & 1) == 0 )
  {
    sub_1B640C8(&Method_FortificationWarningDialogComponent_OnClickCancel__, method);
    byte_4A00179 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_FortificationWarningDialogComponent_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B640E0(Method_FortificationWarningDialogComponent_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A00177 & 1) == 0 )
  {
    sub_1B640C8(&Method_FortificationWarningDialogComponent_OnClickCheckBtn__, method);
    byte_4A00177 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_FortificationWarningDialogComponent_OnClickCheckBtn__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B640E0(Method_FortificationWarningDialogComponent_OnClickCheckBtn__);
  v4 = (System_Reflection_MethodBase_o *)sub_1B640AC(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A00178 & 1) == 0 )
  {
    sub_1B640C8(&Method_DataManager_GetMaster_EventRewardSceneMaster___, method);
    sub_1B640C8(&DataManager_TypeInfo, v3);
    sub_1B640C8(&Method_FortificationWarningDialogComponent_OnClickDecide__, v4);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_FortificationWarningDialogComponent_OnClickDecide__ + 83) & 2) != 0 )
      v9 = (_QWORD *)sub_1B640E0(Method_FortificationWarningDialogComponent_OnClickDecide__);
    ...
    Master_object = (EventRewardSceneEntity_array *)DataManager__GetMaster_object_((const MethodInfo_2E39398 *)Method_DataManager_GetMaster_EventRewardSceneMaster___);
    if ( Master_object )
    {
...
LABEL_21:
      ...
      if ( v17 )
      {
        ...
        v19 = (SceneJumpInfo_o *)sub_1B64314(SceneJumpInfo_TypeInfo, v15, v16);
        SceneJumpInfo___ctor_38274804(v19, (System_String_o *)StringLiteral_1/*""*/, EventID, slot + 1, 0LL);
        if ( v19 )
        {
          SceneJumpInfo__SetReturnNowScene(v19, 0LL);
          Master_object = (EventRewardSceneEntity_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EC03C *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
          if ( Master_object )
          {
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B640C8(&System_Action_TypeInfo, method);
    sub_1B640C8(&Method_FortificationWarningDialogComponent__Open_b__11_0__, v3);
    sub_1B640C8(&LocalizationManager_TypeInfo, v4);
    sub_1B640C8(&StringLiteral_6432/*"FORTIFICATION_EXPANSION_DIALOG_DECIDE"*/, v5);
    sub_1B640C8(&StringLiteral_6445/*"FORTIFICATION_WARNING_DIALOG_TITLE"*/, v6);
    sub_1B640C8(&StringLiteral_3734/*"COMMON_CONFIRM_CLOSE"*/, v7);
    sub_1B640C8(&StringLiteral_6444/*"FORTIFICATION_WARNING_DIALOG_DESCRIPTION"*/, v8);
    sub_1B640C8(&StringLiteral_6443/*"FORTIFICATION_WARNING_DIALOG_CHECKBOX"*/, v9);
    byte_4A00176 = 1;
  }
