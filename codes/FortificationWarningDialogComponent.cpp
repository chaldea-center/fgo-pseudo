...
void FortificationWarningDialogComponent__Close(FortificationWarningDialogComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CE891F & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_FortificationWarningDialogComponent__Close_b__16_0__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CE891E & 1) == 0 )
  {
    sub_1C7BAE8(&Method_FortificationWarningDialogComponent_OnClickCancel__);
    byte_4CE891E = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_FortificationWarningDialogComponent_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C7BB00(Method_FortificationWarningDialogComponent_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CE891C & 1) == 0 )
  {
    sub_1C7BAE8(&Method_FortificationWarningDialogComponent_OnClickCheckBtn__);
    byte_4CE891C = 1;
  }
  ...
  if ( (*((_BYTE *)Method_FortificationWarningDialogComponent_OnClickCheckBtn__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C7BB00(Method_FortificationWarningDialogComponent_OnClickCheckBtn__);
  v4 = (System_Reflection_MethodBase_o *)sub_1C7BACC(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CE891D & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_FortificationWarningDialogComponent_OnClickDecide__);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_FortificationWarningDialogComponent_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C7BB00(Method_FortificationWarningDialogComponent_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C7BACC(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
    if ( !TerminalPramsManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(TerminalPramsManager_TypeInfo);
    ...
    Master_object = (EventRewardSceneEntity_array *)DataManager__GetMaster_object_((const MethodInfo_31703A0 *)Method_DataManager_GetMaster_EventRewardSceneMaster___);
    if ( Master_object )
    {
...
LABEL_21:
      ...
      {
        slot = v9->fields.slot;
        v11 = (SceneJumpInfo_o *)sub_1C7BD34(SceneJumpInfo_TypeInfo);
        SceneJumpInfo___ctor_42057648(v11, (System_String_o *)StringLiteral_1/*""*/, EventID, slot + 1, 0);
        if ( v11 )
        {
          SceneJumpInfo__SetReturnNowScene(v11, 0);
          Master_object = (EventRewardSceneEntity_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A8C5A8 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
          if ( Master_object )
          {
...
void FortificationWarningDialogComponent__Open(FortificationWarningDialogComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C7BAE8(&System_Action_TypeInfo);
    sub_1C7BAE8(&Method_FortificationWarningDialogComponent__Open_b__11_0__);
    sub_1C7BAE8(&LocalizationManager_TypeInfo);
    sub_1C7BAE8(&StringLiteral_6500/*"FORTIFICATION_EXPANSION_DIALOG_DECIDE"*/);
    sub_1C7BAE8(&StringLiteral_6513/*"FORTIFICATION_WARNING_DIALOG_TITLE"*/);
    sub_1C7BAE8(&StringLiteral_3691/*"COMMON_CONFIRM_CLOSE"*/);
    sub_1C7BAE8(&StringLiteral_6512/*"FORTIFICATION_WARNING_DIALOG_DESCRIPTION"*/);
    sub_1C7BAE8(&StringLiteral_6511/*"FORTIFICATION_WARNING_DIALOG_CHECKBOX"*/);
    byte_4CE891B = 1;
  }
  if ( !this->fields.state )
  {
    ...
    v4 = LocalizationManager__Get((System_String_o *)StringLiteral_6513/*"FORTIFICATION_WARNING_DIALOG_TITLE"*/, 0);
    if ( !titleLb )
      goto LABEL_12;
    UILabel__set_text(titleLb, v4, 0);
    descriptionLb = this->fields.descriptionLb;
    v4 = LocalizationManager__Get((System_String_o *)StringLiteral_6512/*"FORTIFICATION_WARNING_DIALOG_DESCRIPTION"*/, 0);
    if ( !descriptionLb )
      goto LABEL_12;
    UILabel__set_text(descriptionLb, v4, 0);
    checkBoxLb = this->fields.checkBoxLb;
    v4 = LocalizationManager__Get((System_String_o *)StringLiteral_6511/*"FORTIFICATION_WARNING_DIALOG_CHECKBOX"*/, 0);
    if ( !checkBoxLb
      || (UILabel__set_text(checkBoxLb, v4, 0),
          decideButtonLb = this->fields.decideButtonLb,
          v4 = LocalizationManager__Get((System_String_o *)StringLiteral_6500/*"FORTIFICATION_EXPANSION_DIALOG_DECIDE"*/, 0),
          !decideButtonLb)
      || (UILabel__set_text(decideButtonLb, v4, 0),
          cancelButtonLb = this->fields.cancelButtonLb,
          v4 = LocalizationManager__Get((System_String_o *)StringLiteral_3691/*"COMMON_CONFIRM_CLOSE"*/, 0),
          !cancelButtonLb) )
    {
LABEL_12:
      sub_1C7BD40(v4, v5);
