        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0C9F6 & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_FortificationWarningDialogComponent__Close_b__16_0__, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0C9F5 & 1) == 0 )
  {
    sub_1B686D4(&Method_FortificationWarningDialogComponent_OnClickCancel__, method);
    byte_4A0C9F5 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_FortificationWarningDialogComponent_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B686EC(Method_FortificationWarningDialogComponent_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0C9F3 & 1) == 0 )
  {
    sub_1B686D4(&Method_FortificationWarningDialogComponent_OnClickCheckBtn__, method);
    byte_4A0C9F3 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_FortificationWarningDialogComponent_OnClickCheckBtn__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B686EC(Method_FortificationWarningDialogComponent_OnClickCheckBtn__);
  v4 = (System_Reflection_MethodBase_o *)sub_1B686B8(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0C9F4 & 1) == 0 )
  {
    sub_1B686D4(&Method_DataManager_GetMaster_EventRewardSceneMaster___, method);
    sub_1B686D4(&DataManager_TypeInfo, v3);
    sub_1B686D4(&Method_FortificationWarningDialogComponent_OnClickDecide__, v4);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_FortificationWarningDialogComponent_OnClickDecide__ + 83) & 2) != 0 )
      v9 = (_QWORD *)sub_1B686EC(Method_FortificationWarningDialogComponent_OnClickDecide__);
    ...
    Master_object = (EventRewardSceneEntity_array *)DataManager__GetMaster_object_((const MethodInfo_2E49CFC *)Method_DataManager_GetMaster_EventRewardSceneMaster___);
    if ( Master_object )
    {
...
LABEL_21:
      ...
      if ( !Master_object->max_length )
        sub_1B68938(Master_object, v15);
      v16 = Master_object->m_Items[0];
      if ( v16 )
      {
        slot = v16->fields.slot;
        v18 = (SceneJumpInfo_o *)sub_1B68920(SceneJumpInfo_TypeInfo);
        SceneJumpInfo___ctor_38336528(v18, (System_String_o *)StringLiteral_1/*""*/, EventID, slot + 1, 0LL);
        if ( v18 )
        {
          SceneJumpInfo__SetReturnNowScene(v18, 0LL);
          Master_object = (EventRewardSceneEntity_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36F769C *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
          if ( Master_object )
          {
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B686D4(&System_Action_TypeInfo, method);
    sub_1B686D4(&Method_FortificationWarningDialogComponent__Open_b__11_0__, v3);
    sub_1B686D4(&LocalizationManager_TypeInfo, v4);
    sub_1B686D4(&StringLiteral_6434/*"FORTIFICATION_EXPANSION_DIALOG_DECIDE"*/, v5);
    sub_1B686D4(&StringLiteral_6447/*"FORTIFICATION_WARNING_DIALOG_TITLE"*/, v6);
    sub_1B686D4(&StringLiteral_3732/*"COMMON_CONFIRM_CLOSE"*/, v7);
    sub_1B686D4(&StringLiteral_6446/*"FORTIFICATION_WARNING_DIALOG_DESCRIPTION"*/, v8);
    sub_1B686D4(&StringLiteral_6445/*"FORTIFICATION_WARNING_DIALOG_CHECKBOX"*/, v9);
    byte_4A0C9F2 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    v11 = LocalizationManager__Get((System_String_o *)StringLiteral_6447/*"FORTIFICATION_WARNING_DIALOG_TITLE"*/, 0LL);
    if ( !titleLb )
      goto LABEL_12;
    UILabel__set_text(titleLb, v11, 0LL);
    descriptionLb = this->fields.descriptionLb;
    v11 = LocalizationManager__Get((System_String_o *)StringLiteral_6446/*"FORTIFICATION_WARNING_DIALOG_DESCRIPTION"*/, 0LL);
    if ( !descriptionLb )
      goto LABEL_12;
    UILabel__set_text(descriptionLb, v11, 0LL);
    checkBoxLb = this->fields.checkBoxLb;
    v11 = LocalizationManager__Get((System_String_o *)StringLiteral_6445/*"FORTIFICATION_WARNING_DIALOG_CHECKBOX"*/, 0LL);
    if ( !checkBoxLb
      || (UILabel__set_text(checkBoxLb, v11, 0LL),
          decideButtonLb = this->fields.decideButtonLb,
          v11 = LocalizationManager__Get((System_String_o *)StringLiteral_6434/*"FORTIFICATION_EXPANSION_DIALOG_DECIDE"*/, 0LL),
          !decideButtonLb)
      || (UILabel__set_text(decideButtonLb, v11, 0LL),
          cancelButtonLb = this->fields.cancelButtonLb,
          v11 = LocalizationManager__Get((System_String_o *)StringLiteral_3732/*"COMMON_CONFIRM_CLOSE"*/, 0LL),
          !cancelButtonLb) )
    {
LABEL_12:
      sub_1B68930(v11, v12);
