        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73C7F & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_FortificationWarningDialogComponent__Close_b__16_0__, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73C7E & 1) == 0 )
  {
    sub_1B90010(&Method_FortificationWarningDialogComponent_OnClickCancel__, method);
    byte_4A73C7E = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_FortificationWarningDialogComponent_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B90028(Method_FortificationWarningDialogComponent_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73C7C & 1) == 0 )
  {
    sub_1B90010(&Method_FortificationWarningDialogComponent_OnClickCheckBtn__, method);
    byte_4A73C7C = 1;
  }
  ...
  if ( (*((_BYTE *)Method_FortificationWarningDialogComponent_OnClickCheckBtn__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B90028(Method_FortificationWarningDialogComponent_OnClickCheckBtn__);
  v4 = (System_Reflection_MethodBase_o *)sub_1B8FFF4(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73C7D & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_FortificationWarningDialogComponent_OnClickDecide__, v4);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_FortificationWarningDialogComponent_OnClickDecide__ + 83) & 2) != 0 )
      v9 = (_QWORD *)sub_1B90028(Method_FortificationWarningDialogComponent_OnClickDecide__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B90010(&System_Action_TypeInfo, method);
    sub_1B90010(&Method_FortificationWarningDialogComponent__Open_b__11_0__, v3);
    sub_1B90010(&LocalizationManager_TypeInfo, v4);
    sub_1B90010(&StringLiteral_6462/*"FORTIFICATION_EXPANSION_DIALOG_DECIDE"*/, v5);
    sub_1B90010(&StringLiteral_6475/*"FORTIFICATION_WARNING_DIALOG_TITLE"*/, v6);
    sub_1B90010(&StringLiteral_3757/*"COMMON_CONFIRM_CLOSE"*/, v7);
    sub_1B90010(&StringLiteral_6474/*"FORTIFICATION_WARNING_DIALOG_DESCRIPTION"*/, v8);
    sub_1B90010(&StringLiteral_6473/*"FORTIFICATION_WARNING_DIALOG_CHECKBOX"*/, v9);
    byte_4A73C7B = 1;
  }
  if ( !this->fields.state )
  {
    ...
    v11 = LocalizationManager__Get((System_String_o *)StringLiteral_6475/*"FORTIFICATION_WARNING_DIALOG_TITLE"*/, 0LL);
    if ( !titleLb )
      goto LABEL_12;
    UILabel__set_text(titleLb, v11, 0LL);
    descriptionLb = this->fields.descriptionLb;
    v11 = LocalizationManager__Get((System_String_o *)StringLiteral_6474/*"FORTIFICATION_WARNING_DIALOG_DESCRIPTION"*/, 0LL);
    if ( !descriptionLb )
      goto LABEL_12;
    UILabel__set_text(descriptionLb, v11, 0LL);
    checkBoxLb = this->fields.checkBoxLb;
    v11 = LocalizationManager__Get((System_String_o *)StringLiteral_6473/*"FORTIFICATION_WARNING_DIALOG_CHECKBOX"*/, 0LL);
    if ( !checkBoxLb
      || (UILabel__set_text(checkBoxLb, v11, 0LL),
          decideButtonLb = this->fields.decideButtonLb,
          v11 = LocalizationManager__Get((System_String_o *)StringLiteral_6462/*"FORTIFICATION_EXPANSION_DIALOG_DECIDE"*/, 0LL),
          !decideButtonLb)
      || (UILabel__set_text(decideButtonLb, v11, 0LL),
          cancelButtonLb = this->fields.cancelButtonLb,
          v11 = LocalizationManager__Get((System_String_o *)StringLiteral_3757/*"COMMON_CONFIRM_CLOSE"*/, 0LL),
          !cancelButtonLb) )
    {
LABEL_12:
      sub_1B9026C(v11, v12);
