        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E6473 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_FortificationWarningDialogComponent__Close_b__16_0__, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E6472 & 1) == 0 )
  {
    sub_1B00CCC(&Method_FortificationWarningDialogComponent_OnClickCancel__, method);
    byte_48E6472 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_FortificationWarningDialogComponent_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B00CE4(Method_FortificationWarningDialogComponent_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E6470 & 1) == 0 )
  {
    sub_1B00CCC(&Method_FortificationWarningDialogComponent_OnClickCheckBtn__, method);
    byte_48E6470 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_FortificationWarningDialogComponent_OnClickCheckBtn__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B00CE4(Method_FortificationWarningDialogComponent_OnClickCheckBtn__);
  v4 = (System_Reflection_MethodBase_o *)sub_1B00CB0(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E6471 & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataManager_GetMaster_EventRewardSceneMaster___, method);
    sub_1B00CCC(&DataManager_TypeInfo, v3);
    sub_1B00CCC(&Method_FortificationWarningDialogComponent_OnClickDecide__, v4);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_FortificationWarningDialogComponent_OnClickDecide__ + 83) & 2) != 0 )
      v9 = (_QWORD *)sub_1B00CE4(Method_FortificationWarningDialogComponent_OnClickDecide__);
    ...
    Master_object = (EventRewardSceneEntity_array *)DataManager__GetMaster_object_((const MethodInfo_2D62BBC *)Method_DataManager_GetMaster_EventRewardSceneMaster___);
    if ( Master_object )
    {
...
LABEL_21:
      ...
      if ( !Master_object->max_length )
        sub_1B00F30(Master_object, v15);
      v16 = Master_object->m_Items[0];
      if ( v16 )
      {
        slot = v16->fields.slot;
        v18 = (SceneJumpInfo_o *)sub_1B00F18(SceneJumpInfo_TypeInfo);
        SceneJumpInfo___ctor_37367776(v18, (System_String_o *)StringLiteral_1/*""*/, EventID, slot + 1, 0LL);
        if ( v18 )
        {
          SceneJumpInfo__SetReturnNowScene(v18, 0LL);
          Master_object = (EventRewardSceneEntity_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_35FBBF0 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
          if ( Master_object )
          {
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B00CCC(&System_Action_TypeInfo, method);
    sub_1B00CCC(&Method_FortificationWarningDialogComponent__Open_b__11_0__, v3);
    sub_1B00CCC(&LocalizationManager_TypeInfo, v4);
    sub_1B00CCC(&StringLiteral_6395/*"FORTIFICATION_EXPANSION_DIALOG_DECIDE"*/, v5);
    sub_1B00CCC(&StringLiteral_6408/*"FORTIFICATION_WARNING_DIALOG_TITLE"*/, v6);
    sub_1B00CCC(&StringLiteral_3715/*"COMMON_CONFIRM_CLOSE"*/, v7);
    sub_1B00CCC(&StringLiteral_6407/*"FORTIFICATION_WARNING_DIALOG_DESCRIPTION"*/, v8);
    sub_1B00CCC(&StringLiteral_6406/*"FORTIFICATION_WARNING_DIALOG_CHECKBOX"*/, v9);
    byte_48E646F = 1;
  }
  if ( !this->fields.state )
  {
    ...
    v11 = LocalizationManager__Get((System_String_o *)StringLiteral_6408/*"FORTIFICATION_WARNING_DIALOG_TITLE"*/, 0LL);
    if ( !titleLb )
      goto LABEL_12;
    UILabel__set_text(titleLb, v11, 0LL);
    descriptionLb = this->fields.descriptionLb;
    v11 = LocalizationManager__Get((System_String_o *)StringLiteral_6407/*"FORTIFICATION_WARNING_DIALOG_DESCRIPTION"*/, 0LL);
    if ( !descriptionLb )
      goto LABEL_12;
    UILabel__set_text(descriptionLb, v11, 0LL);
    checkBoxLb = this->fields.checkBoxLb;
    v11 = LocalizationManager__Get((System_String_o *)StringLiteral_6406/*"FORTIFICATION_WARNING_DIALOG_CHECKBOX"*/, 0LL);
    if ( !checkBoxLb
      || (UILabel__set_text(checkBoxLb, v11, 0LL),
          decideButtonLb = this->fields.decideButtonLb,
          v11 = LocalizationManager__Get((System_String_o *)StringLiteral_6395/*"FORTIFICATION_EXPANSION_DIALOG_DECIDE"*/, 0LL),
          !decideButtonLb)
      || (UILabel__set_text(decideButtonLb, v11, 0LL),
          cancelButtonLb = this->fields.cancelButtonLb,
          v11 = LocalizationManager__Get((System_String_o *)StringLiteral_3715/*"COMMON_CONFIRM_CLOSE"*/, 0LL),
          !cancelButtonLb) )
    {
LABEL_12:
      sub_1B00F28(v11, v12);
