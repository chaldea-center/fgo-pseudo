        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C26074 & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_FortificationWarningDialogComponent__Close_b__16_0__, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C26073 & 1) == 0 )
  {
    sub_1C3B764(&Method_FortificationWarningDialogComponent_OnClickCancel__, method);
    byte_4C26073 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_FortificationWarningDialogComponent_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3B77C(Method_FortificationWarningDialogComponent_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C26071 & 1) == 0 )
  {
    sub_1C3B764(&Method_FortificationWarningDialogComponent_OnClickCheckBtn__, method);
    byte_4C26071 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_FortificationWarningDialogComponent_OnClickCheckBtn__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C3B77C(Method_FortificationWarningDialogComponent_OnClickCheckBtn__);
  v4 = (System_Reflection_MethodBase_o *)sub_1C3B748(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C26072 & 1) == 0 )
  {
    sub_1C3B764(&Method_DataManager_GetMaster_EventRewardSceneMaster___, method);
    sub_1C3B764(&DataManager_TypeInfo, v3);
    sub_1C3B764(&Method_FortificationWarningDialogComponent_OnClickDecide__, v4);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_FortificationWarningDialogComponent_OnClickDecide__ + 83) & 2) != 0 )
      v9 = (_QWORD *)sub_1C3B77C(Method_FortificationWarningDialogComponent_OnClickDecide__);
    ...
    Master_object = (EventRewardSceneEntity_array *)DataManager__GetMaster_object_((const MethodInfo_2FF01B0 *)Method_DataManager_GetMaster_EventRewardSceneMaster___);
    if ( Master_object )
    {
...
LABEL_21:
      ...
      if ( !Master_object->max_length )
        sub_1C3B9C8(Master_object, v15);
      v16 = Master_object->m_Items[0];
      if ( v16 )
      {
        slot = v16->fields.slot;
        v18 = (SceneJumpInfo_o *)sub_1C3B9B0(SceneJumpInfo_TypeInfo);
        SceneJumpInfo___ctor_40098360(v18, (System_String_o *)StringLiteral_1/*""*/, EventID, slot + 1, 0LL);
        if ( v18 )
        {
          SceneJumpInfo__SetReturnNowScene(v18, 0LL);
          Master_object = (EventRewardSceneEntity_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
          if ( Master_object )
          {
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C3B764(&System_Action_TypeInfo, method);
    sub_1C3B764(&Method_FortificationWarningDialogComponent__Open_b__11_0__, v3);
    sub_1C3B764(&LocalizationManager_TypeInfo, v4);
    sub_1C3B764(&StringLiteral_6621/*"FinishedCloseMultiServant"*/, v5);
    sub_1C3B764(&StringLiteral_6634/*"Firebase.Analytics.FirebaseAnalytics, Firebase.Analytics"*/, v6);
    sub_1C3B764(&StringLiteral_3799/*"COSTUME_SELECT_SERVANT_EVENT_END_ITEM_COSTUME_MSG"*/, v7);
    sub_1C3B764(&StringLiteral_6633/*"Firebase's libApp.so was not found for this device's architecture\nin your APK.\n"*/, v8);
    sub_1C3B764(&StringLiteral_6632/*"Firebase wasn't available"*/, v9);
    byte_4C26070 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    v11 = LocalizationManager__Get((System_String_o *)StringLiteral_6634/*"Firebase.Analytics.FirebaseAnalytics, Firebase.Analytics"*/, 0LL);
    if ( !titleLb )
      goto LABEL_12;
    UILabel__set_text(titleLb, v11, 0LL);
    descriptionLb = this->fields.descriptionLb;
    v11 = LocalizationManager__Get((System_String_o *)StringLiteral_6633/*"Firebase's libApp.so was not found for this device's architecture\nin your APK.\n"*/, 0LL);
    if ( !descriptionLb )
      goto LABEL_12;
    UILabel__set_text(descriptionLb, v11, 0LL);
    checkBoxLb = this->fields.checkBoxLb;
    v11 = LocalizationManager__Get((System_String_o *)StringLiteral_6632/*"Firebase wasn't available"*/, 0LL);
    if ( !checkBoxLb
      || (UILabel__set_text(checkBoxLb, v11, 0LL),
          decideButtonLb = this->fields.decideButtonLb,
          v11 = LocalizationManager__Get((System_String_o *)StringLiteral_6621/*"FinishedCloseMultiServant"*/, 0LL),
          !decideButtonLb)
      || (UILabel__set_text(decideButtonLb, v11, 0LL),
          cancelButtonLb = this->fields.cancelButtonLb,
          v11 = LocalizationManager__Get((System_String_o *)StringLiteral_3799/*"COSTUME_SELECT_SERVANT_EVENT_END_ITEM_COSTUME_MSG"*/, 0LL),
          !cancelButtonLb) )
    {
LABEL_12:
      sub_1C3B9C0(v11, v12);
