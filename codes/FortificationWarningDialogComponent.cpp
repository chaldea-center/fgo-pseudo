        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B3198 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_FortificationWarningDialogComponent__Close_b__16_0__);
        ...
        const MethodInfo *method)
{
  ...
  if ( this->fields.state == 2 )
  {
    ...
    Master_WarQuestSelectionMaster = (EventRewardSceneMaster_o *)DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1A4F124 *)Method_DataManager_GetMaster_EventRewardSceneMaster___);
...
LABEL_25:
      ...
      if ( list )
      {
        ...
        v9 = (SceneJumpInfo_o *)sub_B52A54(SceneJumpInfo_TypeInfo);
        SceneJumpInfo___ctor_17466296(v9, (System_String_o *)StringLiteral_1/*""*/, EventID, items_high + 1, 0LL);
        if ( v9 )
        {
          SceneJumpInfo__SetReturnNowScene(v9, 0LL);
          Master_WarQuestSelectionMaster = (EventRewardSceneMaster_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
          if ( Master_WarQuestSelectionMaster )
          {
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B52984(&System_Action_TypeInfo);
    sub_B52984(&Method_FortificationWarningDialogComponent__Open_b__11_0__);
    sub_B52984(&LocalizationManager_TypeInfo);
    sub_B52984(&StringLiteral_6470/*"FORTIFICATION_EXPANSION_DIALOG_DECIDE"*/);
    sub_B52984(&StringLiteral_6483/*"FORTIFICATION_WARNING_DIALOG_TITLE"*/);
    sub_B52984(&StringLiteral_3294/*"COMMON_CONFIRM_CLOSE"*/);
    sub_B52984(&StringLiteral_6482/*"FORTIFICATION_WARNING_DIALOG_DESCRIPTION"*/);
    sub_B52984(&StringLiteral_6481/*"FORTIFICATION_WARNING_DIALOG_CHECKBOX"*/);
    byte_42B3194 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    v4 = LocalizationManager__Get((System_String_o *)StringLiteral_6483/*"FORTIFICATION_WARNING_DIALOG_TITLE"*/, 0LL);
    if ( !titleLb )
      goto LABEL_13;
    UILabel__set_text(titleLb, v4, 0LL);
    descriptionLb = this->fields.descriptionLb;
    v4 = LocalizationManager__Get((System_String_o *)StringLiteral_6482/*"FORTIFICATION_WARNING_DIALOG_DESCRIPTION"*/, 0LL);
    if ( !descriptionLb )
      goto LABEL_13;
    UILabel__set_text(descriptionLb, v4, 0LL);
    checkBoxLb = this->fields.checkBoxLb;
    v4 = LocalizationManager__Get((System_String_o *)StringLiteral_6481/*"FORTIFICATION_WARNING_DIALOG_CHECKBOX"*/, 0LL);
    if ( !checkBoxLb
      || (UILabel__set_text(checkBoxLb, v4, 0LL),
          decideButtonLb = this->fields.decideButtonLb,
          v4 = LocalizationManager__Get((System_String_o *)StringLiteral_6470/*"FORTIFICATION_EXPANSION_DIALOG_DECIDE"*/, 0LL),
          !decideButtonLb)
