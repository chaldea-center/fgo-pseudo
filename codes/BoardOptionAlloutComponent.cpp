...
void BoardOptionAlloutComponent__SetIcon(BoardOptionAlloutComponent_o *this, int32_t questId, const MethodInfo *method)
{
  ...
  if ( Master_object )
  {
    ...
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    ClearDeckInfo = (System_Collections_Generic_List_object__o *)DataManager__GetMaster_object_((const MethodInfo_30DD39C *)Method_DataManager_GetMaster_ServantLimitImageMaster___);
...
LABEL_31:
    ...
    while ( v9 < servantFaceIconList->fields._size )
    {
      ...
      if ( v7 && (max_length_low = LODWORD(v7->max_length), v9 < (int)max_length_low) )
      {
        ...
        if ( !v12 || !v13 )
          goto LABEL_31;
        IconLabelInfo__Set_40818388(v13, 2, v12[6], v12[6], 0, 0, 1, 0, 0, 0);
        v14 = v12[8];
        ...
        v19 = v12[5];
        v20 = v12[7];
        v21 = (ServantOverwriteStatus_o *)sub_1C32E6C(ServantOverwriteStatus_TypeInfo);
        ServantOverwriteStatus___ctor_33445156(v21, v19, v20, ServantLimitCountSealAfter, 0);
        if ( !v21 || !v10 )
          goto LABEL_31;
