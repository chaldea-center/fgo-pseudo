        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B649F5 & 1) == 0 )
  {
    sub_1BE4ACC(&WarBoardChangeWinConditionTask__Execute_d__2_TypeInfo, method);
    byte_4B649F5 = 1;
  }
  v3 = sub_1BE4D18(WarBoardChangeWinConditionTask__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BE4AE0(&Method_WarBoardChangeWinConditionTask__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1BE4BF4(v3, v4);
}
