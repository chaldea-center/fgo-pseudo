        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6DDDA & 1) == 0 )
  {
    sub_1B90010(&WarBoardChangeWinConditionTask__Execute_d__2_TypeInfo, method);
    byte_4A6DDDA = 1;
  }
  v3 = sub_1B9025C(WarBoardChangeWinConditionTask__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B90024(&Method_WarBoardChangeWinConditionTask__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1B90138(v3, v4);
}
