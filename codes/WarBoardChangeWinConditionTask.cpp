        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AEB17 & 1) == 0 )
  {
    sub_B52984(&WarBoardChangeWinConditionTask__Execute_d__2_TypeInfo);
    byte_42AEB17 = 1;
  }
  v3 = sub_B52A54(WarBoardChangeWinConditionTask__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_B52988(&Method_WarBoardChangeWinConditionTask__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_B52A28(v3, v4);
}
