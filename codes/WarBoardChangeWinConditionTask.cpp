        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1D9B9 & 1) == 0 )
  {
    sub_1B715CC(&WarBoardChangeWinConditionTask__Execute_d__2_TypeInfo, method);
    byte_4A1D9B9 = 1;
  }
  v3 = sub_1B71818(WarBoardChangeWinConditionTask__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B715E0(&Method_WarBoardChangeWinConditionTask__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1B716F4(v3, v4);
}
