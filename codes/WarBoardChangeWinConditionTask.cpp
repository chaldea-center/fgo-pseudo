        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FCA2D & 1) == 0 )
  {
    sub_1B64A00(&WarBoardChangeWinConditionTask__Execute_d__2_TypeInfo, method);
    byte_49FCA2D = 1;
  }
  v3 = sub_1B64C4C(WarBoardChangeWinConditionTask__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B64A14(&Method_WarBoardChangeWinConditionTask__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1B64B28(v3, v4);
}
