        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24F66 & 1) == 0 )
  {
    sub_1C2D490(&WarBoardChangeWinConditionTask__Execute_d__2_TypeInfo);
    byte_4C24F66 = 1;
  }
  v3 = sub_1C2D6DC(WarBoardChangeWinConditionTask__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C2D4A4(&Method_WarBoardChangeWinConditionTask__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1C2D5B8(v3, v4);
}
