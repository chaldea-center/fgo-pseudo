        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B427AC & 1) == 0 )
  {
    sub_1BDB878(&WarBoardChangeWinConditionTask__Execute_d__2_TypeInfo, method);
    byte_4B427AC = 1;
  }
  v3 = sub_1BDBAC4(WarBoardChangeWinConditionTask__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BDB88C(&Method_WarBoardChangeWinConditionTask__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1BDB9A0(v3, v4);
}
