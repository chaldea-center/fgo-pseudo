        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFB542 & 1) == 0 )
  {
    sub_1C2E12C(&WarBoardChangeWinConditionTask__Execute_d__2_TypeInfo, method);
    byte_4BFB542 = 1;
  }
  v3 = sub_1C2E378(WarBoardChangeWinConditionTask__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C2E140(&Method_WarBoardChangeWinConditionTask__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1C2E254(v3, v4);
}
