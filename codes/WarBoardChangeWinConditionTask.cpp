        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC5031 & 1) == 0 )
  {
    sub_1C713B0(&WarBoardChangeWinConditionTask__Execute_d__2_TypeInfo);
    byte_4CC5031 = 1;
  }
  v3 = sub_1C715FC(WarBoardChangeWinConditionTask__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C713C4(&Method_WarBoardChangeWinConditionTask__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1C714D8(v3, v4);
}
