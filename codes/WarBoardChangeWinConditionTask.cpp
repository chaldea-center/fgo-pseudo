        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B8C55 & 1) == 0 )
  {
    sub_1B4CF90(&WarBoardChangeWinConditionTask__Execute_d__2_TypeInfo, method);
    byte_49B8C55 = 1;
  }
  v3 = sub_1B4D1DC(WarBoardChangeWinConditionTask__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B4CFA4(&Method_WarBoardChangeWinConditionTask__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1B4D0B8(v3, v4);
}
