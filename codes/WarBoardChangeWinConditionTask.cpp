        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4C183 & 1) == 0 )
  {
    sub_1B863B8(&WarBoardChangeWinConditionTask__Execute_d__2_TypeInfo, method);
    byte_4A4C183 = 1;
  }
  v3 = sub_1B86604(WarBoardChangeWinConditionTask__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B863CC(&Method_WarBoardChangeWinConditionTask__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1B864E0(v3, v4);
}
