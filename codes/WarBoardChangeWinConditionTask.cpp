        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEC241 & 1) == 0 )
  {
    sub_1C7BAE8(&WarBoardChangeWinConditionTask__Execute_d__2_TypeInfo);
    byte_4CEC241 = 1;
  }
  v3 = sub_1C7BD34(WarBoardChangeWinConditionTask__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C7BAFC(&Method_WarBoardChangeWinConditionTask__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1C7BC10(v3, v4);
}
