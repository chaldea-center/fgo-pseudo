        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFFD33 & 1) == 0 )
  {
    sub_1BC3008(&WarBoardChangeWinConditionTask__Execute_d__2_TypeInfo, method);
    byte_4AFFD33 = 1;
  }
  v3 = sub_1BC3254(WarBoardChangeWinConditionTask__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BC301C(&Method_WarBoardChangeWinConditionTask__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1BC3130(v3, v4);
}
