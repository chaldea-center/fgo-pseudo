        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1A1E2 & 1) == 0 )
  {
    sub_1BCAFF8(&WarBoardChangeWinConditionTask__Execute_d__2_TypeInfo, method);
    byte_4B1A1E2 = 1;
  }
  v3 = sub_1BCB244(WarBoardChangeWinConditionTask__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BCB00C(&Method_WarBoardChangeWinConditionTask__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1BCB120(v3, v4);
}
