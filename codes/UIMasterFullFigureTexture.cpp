        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D32285 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&AssetManager_TypeInfo);
    sub_1C93AD4(&UIMasterFullFigureRender_TypeInfo);
    sub_1C93AD4(&Method_UIMasterFullFigureTexture_EndLoadAsset__);
    byte_4D32285 = 1;
  }
  if ( !UIMasterFullFigureRender_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UIMasterFullFigureRender_TypeInfo);
...
LABEL_27:
      ...
      sub_1C93A78(p_callbackFunc, (int32_t)v22, v23, v24, v25, v26, v27, v28);
      return;
    }
    v33 = this->fields.loadNameList;
    if ( !AssetManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
    AssetManager__releaseAssetStorage_41257108(v33, 0);
  }
  else
  {
    assetDataList = this->fields.assetDataList;
  ...
  if ( callbackFunc )
  {
    ...
    sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.callbackFunc, (int32_t)v35, v36, v37, v38, v39, v40, v41);
  }
  ...
  if ( !AssetManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
  AssetManager__loadAssetStorage_41254760(v43, v44, 1, 0);
}
