...
void UIViewport__LateUpdate(UIViewport_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(topLeft, 0, 0) )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(bottomRight, 0, 0) )
    {
      ...
      if ( !sourceCamera )
        goto LABEL_25;
      v22 = UnityEngine_Camera__WorldToScreenPoint_72722712(sourceCamera, position, 0);
      ...
      if ( !v8 )
        goto LABEL_25;
      v24 = UnityEngine_Camera__WorldToScreenPoint_72722712(v8, v23, 0);
      v11 = v24.fields.x;
      v12 = v24.fields.y;
...
void UIViewport__Start(UIViewport_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(v11, 0, 0) )
  {
    ...
    sub_1CE66A4(p_sourceCamera, (int32_t)main, v14, v15, v16, v17, v18, v19);
  }
}