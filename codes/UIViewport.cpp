...
void UIViewport__LateUpdate(UIViewport_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(topLeft, 0, 0) )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(bottomRight, 0, 0) )
    {
      ...
      if ( !sourceCamera )
        goto LABEL_25;
      v23 = UnityEngine_Camera__WorldToScreenPoint_82984900(sourceCamera, position, 0);
      ...
      if ( !v9 )
        goto LABEL_25;
      v25 = UnityEngine_Camera__WorldToScreenPoint_82984900(v9, v24, 0);
      v12 = v25.fields.x;
      v13 = v25.fields.y;
...
void UIViewport__Start(UIViewport_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(v12, 0, 0) )
  {
    ...
    sub_21FFBF4(p_sourceCamera, (int32_t)main, v15, v16, v17, v18, v19, v20);
  }
}