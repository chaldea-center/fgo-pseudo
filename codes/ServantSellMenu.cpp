        ...
        const MethodInfo *method)
{
  ...
  if ( onSelectSellServant )
  {
    ...
    sub_1C32BC4(p_onSelectSellServant, 0, (int32_t)servantList, (const MethodInfo *)commandCodeList);
...
void ServantSellMenu__Close(ServantSellMenu_o *this, System_Action_o *callback, const MethodInfo *method)
{
  ...
  if ( (byte_4C33B65 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_ServantSellMenu_EndClose__);
    byte_4C33B65 = 1;
  }
  servantOperationManager = this->fields.servantOperationManager;
  if ( !servantOperationManager )
    sub_1C32E7C(0);
  ServantOperationManager__SetMode_34983268(servantOperationManager, 1, 0);
  this->fields.onClose = callback;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.onClose, (int32_t)callback, v6, v7);
  this->fields.state = 4;
...
void ServantSellMenu__EndCloseShowServant(ServantSellMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C33B6F & 1) == 0 )
  {
    sub_1C32C20(&System_Action_ServantOperationManager_ActionKind__long____long____TypeInfo);
    sub_1C32C20(&Method_ServantSellMenu_OnSelectSellServant__);
    byte_4C33B6F = 1;
  }
  this->fields.state = 2;
  servantOperationManager = this->fields.servantOperationManager;
  v4 = (System_Action_T1__T2__T3__o *)sub_1C32E6C(System_Action_ServantOperationManager_ActionKind__long____long____TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C32C20(&System_Action_TypeInfo);
    sub_1C32C20(&Method_ServantSellMenu_EndCloseShowServant__);
  ...
  if ( !Instance )
LABEL_8:
    sub_1C32E7C(servantOperationManager);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C32C20(&System_Action_TypeInfo);
    sub_1C32C20(&Method_ServantSellMenu_EndCloseShowServantQuestJump__);
    sub_1C32C20(&Method_ServantSellMenu_EndCloseShowServant__);
    sub_1C32C20(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4C33B6D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( kind == 2 )
  {
    v6 = &StringLiteral_17552/*"btn_txt_cc_off"*/;
    v7 = &StringLiteral_17553/*"btn_txt_cc_on"*/;
  }
  else if ( kind == 1 )
  {
    v6 = &StringLiteral_17556/*"btn_txt_craftessence_off"*/;
    v7 = &StringLiteral_17557/*"btn_txt_craftessence_on"*/;
  }
  else
  {
    if ( kind )
    ...
    v6 = &StringLiteral_17596/*"btn_txt_servant_off"*/;
    v7 = &StringLiteral_17597/*"btn_txt_servant_on"*/;
  }
  if ( isSelected )
    v6 = v7;
  return (System_String_o *)*v6;
...
void ServantSellMenu__Init_35034064(ServantSellMenu_o *this, int32_t tabToInit, const MethodInfo *method)
{
  ServantOperationManager_o *servantOperationManager; // x0
...
void ServantSellMenu__OnClickTabCommandCode(ServantSellMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C33B6B & 1) == 0 )
  {
    sub_1C32C20(&Method_ServantSellMenu_OnClickTabCommandCode__);
    byte_4C33B6B = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantSellMenu_OnClickTabCommandCode__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C32C38(Method_ServantSellMenu_OnClickTabCommandCode__);
    ...
    if ( !servantOperationManager )
      sub_1C32E7C(0);
    ServantOperationManager__SetMode_34983268(servantOperationManager, 2, 0);
  }
}
...
void ServantSellMenu__OnClickTabServant(ServantSellMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C33B69 & 1) == 0 )
  {
    sub_1C32C20(&Method_ServantSellMenu_OnClickTabServant__);
    byte_4C33B69 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantSellMenu_OnClickTabServant__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C32C38(Method_ServantSellMenu_OnClickTabServant__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C32C04(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
...
void ServantSellMenu__OnClickTabServantEquip(ServantSellMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C33B6A & 1) == 0 )
  {
    sub_1C32C20(&Method_ServantSellMenu_OnClickTabServantEquip__);
    byte_4C33B6A = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantSellMenu_OnClickTabServantEquip__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C32C38(Method_ServantSellMenu_OnClickTabServantEquip__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C32C04(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C33B6C & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_ServantSellMenu_EndShowCommandCode__);
    sub_1C32C20(&Method_ServantSellMenu_EndShowServant__);
    sub_1C32C20(&Method_ServantSellMenu_OnSelectSellServant__);
    sub_1C32C20(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantSellMenu_OnSelectSellServant__ + 83) & 2) != 0 )
      v9 = (_QWORD *)sub_1C32C38(Method_ServantSellMenu_OnSelectSellServant__);
      ...
      if ( LODWORD(commandCodeList->max_length) )
      {
        ...
        if ( Instance )
        {
          ...
          if ( Instance )
          {
            ...
            if ( v13 )
            {
              CommonUI__OpenServantStatusDialog_31203604(
                (CommonUI_o *)v13,
                0,
    ...
    else
    {
      ...
      if ( LODWORD(servantList->max_length) )
      {
        ...
        v17 = (CommonUI_o *)v15;
        v18 = (ServantStatusDialog_ResultDelegate_o *)sub_1C32E6C(ServantStatusDialog_ResultDelegate_TypeInfo);
        ServantStatusDialog_ResultDelegate___ctor(v18, (Il2CppObject *)this, Method_ServantSellMenu_EndShowServant__, 0);
        if ( v17 )
        {
          CommonUI__OpenServantStatusDialog_31200916(v17, 34, servantStatusId, v18, 0, 0);
          return;
        }
LABEL_21:
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C32C20(&System_Action_TypeInfo);
    sub_1C32C20(&Method_ServantSellMenu_EndOpen__);
    byte_4C33B63 = 1;
  }
  ...
  if ( state )
  {
    if ( (state & 0xFFFFFFFE) == 2 )
    {
      ...
      sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.onOpen, (int32_t)onOpen, v8, v9);
  ...
  else
  {
    ...
    sub_1C32BC4(
      ...
      method);
    this->fields.onOpen = onOpen;
    sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.onOpen, (int32_t)onOpen, v11, v12);
    ...
    ServantOperationManager__SetMode_34983268((ServantOperationManager_o *)gameObject, 1, 0);
    this->fields.state = 1;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C33B67 & 1) == 0 )
  {
    ...
    this = (ServantSellMenu_o *)sub_1C32C20(&StringLiteral_17444/*"btn_bg_19"*/);
    byte_4C33B67 = 1;
  }
  if ( !tabButton
  ...
  v16 = &StringLiteral_17444/*"btn_bg_19"*/;
  if ( selectedKind != tabKind )
    v16 = &StringLiteral_17442/*"btn_bg_12"*/;
...
void ServantSellMenu__SetTabLabel(ServantSellMenu_o *this, int32_t kind, const MethodInfo *method)
{
  ...
  *(_QWORD *)servantEquipSum = 0;
  ...
  Instance = (DataManager_o *)System_String__Format_63559836(v20, v33, v34, 0);
  if ( !servantTabLabel )
    goto LABEL_39;
  ...
  Instance = (DataManager_o *)System_String__Format_63559836(v40, v47, v54, 0);
  ...
  Instance = (DataManager_o *)System_String__Format_63559836(v60, v73, v75, 0);
