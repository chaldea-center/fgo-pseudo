...
void __fastcall ServantSellMenu__CallOnOpen(ServantSellMenu_o *this, const MethodInfo *method)
{
  ...
  {
    p_onOpen->klass = 0LL;
    sub_1C3B708(p_onOpen, 0LL, v2, v3, v4, v5, v6, v7);
    ((void (__fastcall *)(struct System_Reflection_MethodInfo_o *, _QWORD))v9->fields.m_target)(
      v9->fields.original_method_info,
      *(_QWORD *)&v9->fields.extra_arg);
  }
...
void __fastcall ServantSellMenu__Close(ServantSellMenu_o *this, System_Action_o *callback, const MethodInfo *method)
{
  ...
  if ( (byte_4C1E2FC & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_ServantSellMenu_EndClose__, v5);
    byte_4C1E2FC = 1;
  }
  servantOperationManager = this->fields.servantOperationManager;
  if ( !servantOperationManager )
    sub_1C3B9C0(0LL, callback);
  ServantOperationManager__SetMode_33962724(servantOperationManager, 1, 0LL);
  this->fields.onClose = callback;
  sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.onClose, (int64_t)callback, v7, v8, v9, v10, v11, v12);
  this->fields.state = 4;
...
void __fastcall ServantSellMenu__EndCloseShowServant(ServantSellMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1E306 & 1) == 0 )
  {
    sub_1C3B764(&System_Action_ServantOperationManager_ActionKind__long____long____TypeInfo, method);
    sub_1C3B764(&Method_ServantSellMenu_OnSelectSellServant__, v3);
    byte_4C1E306 = 1;
  }
  this->fields.state = 2;
  servantOperationManager = this->fields.servantOperationManager;
  v5 = (System_Action_T1__T2__T3__o *)sub_1C3B9B0(System_Action_ServantOperationManager_ActionKind__long____long____TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E305 & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_ServantSellMenu_EndCloseShowServant__, v6);
  ...
  if ( !Instance )
LABEL_8:
    sub_1C3B9C0(servantOperationManager, isDecide);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C3B764(&System_Action_TypeInfo, isDecide);
    sub_1C3B764(&Method_ServantSellMenu_EndCloseShowServantQuestJump__, v9);
    sub_1C3B764(&Method_ServantSellMenu_EndCloseShowServant__, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E2FF & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_17909/*"contract"*/, *(_QWORD *)&kind);
    sub_1C3B764(&StringLiteral_17949/*"cp424"*/, v6);
    sub_1C3B764(&StringLiteral_17905/*"continue_decide"*/, v7);
    sub_1C3B764(&StringLiteral_17906/*"continue_input"*/, v8);
    sub_1C3B764(&StringLiteral_17950/*"cp437"*/, v9);
    sub_1C3B764(&StringLiteral_17910/*"contretire_win/btn_cancel"*/, v10);
    sub_1C3B764(&StringLiteral_1/*""*/, v11);
    byte_4C1E2FF = 1;
  }
  if ( kind == 2 )
  {
    v12 = &StringLiteral_17905/*"continue_decide"*/;
    v13 = &StringLiteral_17906/*"continue_input"*/;
  }
  else if ( kind == 1 )
  {
    v12 = &StringLiteral_17909/*"contract"*/;
    v13 = &StringLiteral_17910/*"contretire_win/btn_cancel"*/;
  }
  else
  {
    if ( kind )
    ...
    v12 = &StringLiteral_17949/*"cp424"*/;
    v13 = &StringLiteral_17950/*"cp437"*/;
  }
  if ( isSelected )
    v12 = v13;
  return (System_String_o *)*v12;
...
void __fastcall ServantSellMenu__Init_34013384(ServantSellMenu_o *this, int32_t tabToInit, const MethodInfo *method)
{
  ServantOperationManager_o *servantOperationManager; // x0

  servantOperationManager = this->fields.servantOperationManager;
  if ( !servantOperationManager )
    sub_1C3B9C0(0LL, tabToInit);
  ServantOperationManager__DestroyList(servantOperationManager, 0LL);
  this->fields.state = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E308 & 1) == 0 )
  {
    sub_1C3B764(&Method_System_Collections_Generic_List_long__AddRange__, selectedSvtIds);
    ...
    sub_1C3B764(&Method_System_Collections_Generic_List_long__get_Item__, v9);
...
void __fastcall ServantSellMenu__OnClickTabCommandCode(ServantSellMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1E302 & 1) == 0 )
  {
    sub_1C3B764(&Method_ServantSellMenu_OnClickTabCommandCode__, method);
    byte_4C1E302 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantSellMenu_OnClickTabCommandCode__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3B77C(Method_ServantSellMenu_OnClickTabCommandCode__);
    ...
    if ( !servantOperationManager )
      sub_1C3B9C0(0LL, v6);
    ServantOperationManager__SetMode_33962724(servantOperationManager, 2, 0LL);
  }
}
...
void __fastcall ServantSellMenu__OnClickTabServant(ServantSellMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1E300 & 1) == 0 )
  {
    sub_1C3B764(&Method_ServantSellMenu_OnClickTabServant__, method);
    byte_4C1E300 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantSellMenu_OnClickTabServant__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3B77C(Method_ServantSellMenu_OnClickTabServant__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C3B748(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
...
void __fastcall ServantSellMenu__OnClickTabServantEquip(ServantSellMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1E301 & 1) == 0 )
  {
    sub_1C3B764(&Method_ServantSellMenu_OnClickTabServantEquip__, method);
    byte_4C1E301 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantSellMenu_OnClickTabServantEquip__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3B77C(Method_ServantSellMenu_OnClickTabServantEquip__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C3B748(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E303 & 1) == 0 )
  {
    ...
    sub_1C3B764(&ServantStatusDialog_EndIndividualityDelegate_TypeInfo, v10);
    sub_1C3B764(&ServantStatusDialog_ResultDelegate_TypeInfo, v11);
    sub_1C3B764(&Method_ServantSellMenu_EndShowCommandCode__, v12);
    sub_1C3B764(&Method_ServantSellMenu_EndShowServant__, v13);
    sub_1C3B764(&Method_ServantSellMenu_OnSelectSellServant__, v14);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantSellMenu_OnSelectSellServant__ + 83) & 2) != 0 )
      v17 = (_QWORD *)sub_1C3B77C(Method_ServantSellMenu_OnSelectSellServant__);
      ...
      if ( commandCodeList->max_length )
      {
        ...
        if ( Instance )
        {
          ...
          if ( Instance )
          {
            ...
            v23 = (ServantStatusDialog_EndIndividualityDelegate_o *)sub_1C3B9B0(ServantStatusDialog_EndIndividualityDelegate_TypeInfo);
            ...
            if ( v22 )
            {
              CommonUI__OpenServantStatusDialog_31244736(
                (CommonUI_o *)v22,
                0,
    ...
    else
    {
      ...
      if ( servantList->max_length )
      {
        ...
        v26 = (CommonUI_o *)v24;
        v27 = (ServantStatusDialog_ResultDelegate_o *)sub_1C3B9B0(ServantStatusDialog_ResultDelegate_TypeInfo);
        ...
        if ( v26 )
        {
          CommonUI__OpenServantStatusDialog_31242108(v26, 34, servantStatusId, v27, 0LL, 0LL);
          return;
        }
LABEL_21:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E2FA & 1) == 0 )
  {
    sub_1C3B764(&System_Action_TypeInfo, onSelectSellServant);
    sub_1C3B764(&Method_ServantSellMenu_EndOpen__, v11);
    byte_4C1E2FA = 1;
  }
  ...
  if ( state )
  {
    if ( (state & 0xFFFFFFFE) == 2 )
    {
      ...
      sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.onOpen, (int64_t)onOpen, v13, v14, v15, v16, v17, v18);
  ...
  else
  {
    ...
    sub_1C3B708(
      ...
      v7);
    this->fields.onOpen = onOpen;
    sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.onOpen, (int64_t)onOpen, v20, v21, v22, v23, v24, v25);
    ...
    ServantOperationManager__SetMode_33962724((ServantOperationManager_o *)gameObject, 1, 0LL);
    this->fields.state = 1;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E2FE & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_17810/*"commandCode/setStatus"*/, tabButton);
    this = (ServantSellMenu_o *)sub_1C3B764(&StringLiteral_17812/*"commandCode/unlock"*/, v14);
    byte_4C1E2FE = 1;
  }
  if ( !tabButton
  ...
  v17 = &StringLiteral_17812/*"commandCode/unlock"*/;
  if ( selectedKind != tabKind )
    v17 = &StringLiteral_17810/*"commandCode/setStatus"*/;
...
LABEL_11:
    sub_1C3B9C0(servantOperationManager, v10);
  }
LABEL_10:
...
void __fastcall ServantSellMenu__SetTabLabel(ServantSellMenu_o *this, int32_t kind, const MethodInfo *method)
{
  ...
  *(_QWORD *)servantEquipSum = 0LL;
  ...
  Instance = (DataManager_o *)System_String__Format_63382984(v29, v36, v37, 0LL);
  if ( !servantTabLabel )
    goto LABEL_39;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v43 = LocalizationManager__Get((System_String_o *)StringLiteral_3491/*"CLOSE_SECRET_TREASURE_DEVICE_QUEST_CLEAR"*/, 0LL);
  ...
  Instance = (DataManager_o *)System_String__Format_63382984(v43, v47, v51, 0LL);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v57 = LocalizationManager__Get((System_String_o *)StringLiteral_3489/*"CLOSE_MENU"*/, 0LL);
  v69 = Count;
  v65 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v69, v58, v59, v60);
  if ( !byte_4C1CE74 )
  {
    sub_1C3B764(&BalanceConfig_TypeInfo, v61);
    byte_4C1CE74 = 1;
  }
  ...
  Instance = (DataManager_o *)System_String__Format_63382984(v57, v65, v67, 0LL);
