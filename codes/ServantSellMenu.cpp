        ...
        const MethodInfo *method)
{
  ...
  if ( onSelectSellServant )
  {
    ...
    sub_1BDB81C(p_onSelectSellServant, 0, (int32_t)servantList, (const MethodInfo *)commandCodeList);
...
void __fastcall ServantSellMenu__Close(ServantSellMenu_o *this, System_Action_o *callback, const MethodInfo *method)
{
  ...
  if ( (byte_4B40CE9 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_ServantSellMenu_EndClose__, v5);
    byte_4B40CE9 = 1;
  }
  servantOperationManager = this->fields.servantOperationManager;
  if ( !servantOperationManager )
    sub_1BDBAD4(0LL, callback);
  ServantOperationManager__SetMode_34177748(servantOperationManager, 1, 0LL);
  this->fields.onClose = callback;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.onClose, (int32_t)callback, v7, v8);
  this->fields.state = 4;
...
void __fastcall ServantSellMenu__EndCloseShowServant(ServantSellMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B40CF3 & 1) == 0 )
  {
    sub_1BDB878(&System_Action_ServantOperationManager_ActionKind__long____long____TypeInfo, method);
    sub_1BDB878(&Method_ServantSellMenu_OnSelectSellServant__, v3);
    byte_4B40CF3 = 1;
  }
  this->fields.state = 2;
  servantOperationManager = this->fields.servantOperationManager;
  v5 = (System_Action_T1__T2__T3__o *)sub_1BDBAC4(System_Action_ServantOperationManager_ActionKind__long____long____TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B40CF2 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_ServantSellMenu_EndCloseShowServant__, v6);
  ...
  if ( !Instance )
LABEL_8:
    sub_1BDBAD4(servantOperationManager, isDecide);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&System_Action_TypeInfo, isDecide);
    sub_1BDB878(&Method_ServantSellMenu_EndCloseShowServantQuestJump__, v9);
    sub_1BDB878(&Method_ServantSellMenu_EndCloseShowServant__, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B40CEC & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_17570/*"btn_txt_craftessence_off"*/, *(_QWORD *)&kind);
    sub_1BDB878(&StringLiteral_17610/*"btn_txt_servant_off"*/, v6);
    sub_1BDB878(&StringLiteral_17566/*"btn_txt_cc_off"*/, v7);
    sub_1BDB878(&StringLiteral_17567/*"btn_txt_cc_on"*/, v8);
    sub_1BDB878(&StringLiteral_17611/*"btn_txt_servant_on"*/, v9);
    sub_1BDB878(&StringLiteral_17571/*"btn_txt_craftessence_on"*/, v10);
    sub_1BDB878(&StringLiteral_1/*""*/, v11);
    byte_4B40CEC = 1;
  }
  if ( kind == 2 )
  {
    v12 = &StringLiteral_17566/*"btn_txt_cc_off"*/;
    v13 = &StringLiteral_17567/*"btn_txt_cc_on"*/;
  }
  else if ( kind == 1 )
  {
    v12 = &StringLiteral_17570/*"btn_txt_craftessence_off"*/;
    v13 = &StringLiteral_17571/*"btn_txt_craftessence_on"*/;
  }
  else
  {
    if ( kind )
    ...
    v12 = &StringLiteral_17610/*"btn_txt_servant_off"*/;
    v13 = &StringLiteral_17611/*"btn_txt_servant_on"*/;
  }
  if ( isSelected )
    v12 = v13;
  return (System_String_o *)*v12;
...
void __fastcall ServantSellMenu__Init_34228356(ServantSellMenu_o *this, int32_t tabToInit, const MethodInfo *method)
{
  ServantOperationManager_o *servantOperationManager; // x0

  servantOperationManager = this->fields.servantOperationManager;
  if ( !servantOperationManager )
    sub_1BDBAD4(0LL, tabToInit);
  ServantOperationManager__DestroyList(servantOperationManager, 0LL);
  this->fields.state = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B40CF5 & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Collections_Generic_List_long__AddRange__, selectedSvtIds);
    ...
    sub_1BDB878(&Method_System_Collections_Generic_List_long__get_Item__, v9);
...
void __fastcall ServantSellMenu__OnClickTabCommandCode(ServantSellMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B40CEF & 1) == 0 )
  {
    sub_1BDB878(&Method_ServantSellMenu_OnClickTabCommandCode__, method);
    byte_4B40CEF = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantSellMenu_OnClickTabCommandCode__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BDB890(Method_ServantSellMenu_OnClickTabCommandCode__);
    ...
    if ( !servantOperationManager )
      sub_1BDBAD4(0LL, v6);
    ServantOperationManager__SetMode_34177748(servantOperationManager, 2, 0LL);
  }
}
...
void __fastcall ServantSellMenu__OnClickTabServant(ServantSellMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B40CED & 1) == 0 )
  {
    sub_1BDB878(&Method_ServantSellMenu_OnClickTabServant__, method);
    byte_4B40CED = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantSellMenu_OnClickTabServant__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BDB890(Method_ServantSellMenu_OnClickTabServant__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BDB85C(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
...
void __fastcall ServantSellMenu__OnClickTabServantEquip(ServantSellMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B40CEE & 1) == 0 )
  {
    sub_1BDB878(&Method_ServantSellMenu_OnClickTabServantEquip__, method);
    byte_4B40CEE = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantSellMenu_OnClickTabServantEquip__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BDB890(Method_ServantSellMenu_OnClickTabServantEquip__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BDB85C(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  ServantStatusDialog_EndIndividualityDelegate_o *v24; // x22
  Il2CppObject *v25; // x0
  ...
  if ( (byte_4B40CF0 & 1) == 0 )
  {
    ...
    sub_1BDB878(&ServantStatusDialog_EndIndividualityDelegate_TypeInfo, v10);
    sub_1BDB878(&ServantStatusDialog_ResultDelegate_TypeInfo, v11);
    sub_1BDB878(&Method_ServantSellMenu_EndShowCommandCode__, v12);
    sub_1BDB878(&Method_ServantSellMenu_EndShowServant__, v13);
    sub_1BDB878(&Method_ServantSellMenu_OnSelectSellServant__, v14);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantSellMenu_OnSelectSellServant__ + 83) & 2) != 0 )
      v17 = (_QWORD *)sub_1BDB890(Method_ServantSellMenu_OnSelectSellServant__);
      ...
      if ( commandCodeList->max_length )
      {
        ...
        if ( Instance )
        {
          ...
          if ( Instance )
          {
            ...
            v24 = (ServantStatusDialog_EndIndividualityDelegate_o *)sub_1BDBAC4(ServantStatusDialog_EndIndividualityDelegate_TypeInfo);
            ...
            if ( v23 )
            {
              CommonUI__OpenServantStatusDialog_30846376(
                (CommonUI_o *)v23,
                0,
    ...
    else
    {
      ...
      if ( servantList->max_length )
      {
        ...
        v27 = (CommonUI_o *)v25;
        v28 = (ServantStatusDialog_ResultDelegate_o *)sub_1BDBAC4(ServantStatusDialog_ResultDelegate_TypeInfo);
        ...
        if ( v27 )
        {
          CommonUI__OpenServantStatusDialog_30843692(v27, 34, servantStatusId, v28, 0LL, 0LL);
          return;
        }
LABEL_21:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B40CE7 & 1) == 0 )
  {
    sub_1BDB878(&System_Action_TypeInfo, onSelectSellServant);
    sub_1BDB878(&Method_ServantSellMenu_EndOpen__, v7);
    byte_4B40CE7 = 1;
  }
  ...
  if ( state )
  {
    if ( (state & 0xFFFFFFFE) == 2 )
    {
      ...
      sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.onOpen, (int32_t)onOpen, v9, v10);
  ...
  else
  {
    ...
    sub_1BDB81C(
      ...
      method);
    this->fields.onOpen = onOpen;
    sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.onOpen, (int32_t)onOpen, v12, v13);
    ...
    ServantOperationManager__SetMode_34177748((ServantOperationManager_o *)gameObject, 1, 0LL);
    this->fields.state = 1;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B40CEB & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_17461/*"btn_bg_12"*/, tabButton);
    this = (ServantSellMenu_o *)sub_1BDB878(&StringLiteral_17463/*"btn_bg_19"*/, v14);
    byte_4B40CEB = 1;
  }
  if ( !tabButton
  ...
  v17 = &StringLiteral_17463/*"btn_bg_19"*/;
  if ( selectedKind != tabKind )
    v17 = &StringLiteral_17461/*"btn_bg_12"*/;
...
LABEL_11:
    sub_1BDBAD4(servantOperationManager, v10);
  }
LABEL_10:
...
void __fastcall ServantSellMenu__SetTabLabel(ServantSellMenu_o *this, int32_t kind, const MethodInfo *method)
{
  ...
  *(_QWORD *)servantEquipSum = 0LL;
  ...
  Instance = (DataManager_o *)System_String__Format_62613552(v29, v36, v37, 0LL);
  if ( !servantTabLabel )
    goto LABEL_39;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v43 = LocalizationManager__Get((System_String_o *)StringLiteral_3384/*"CHARA_GRAPH_TAB_SERVANT_EQUIP"*/, 0LL);
  ...
  Instance = (DataManager_o *)System_String__Format_62613552(v43, v47, v51, 0LL);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v57 = LocalizationManager__Get((System_String_o *)StringLiteral_3382/*"CHARA_GRAPH_TAB_COMMAND_CODE"*/, 0LL);
  v69 = Count;
  v65 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v69, v58, v59, v60);
  if ( !byte_4B3F1D5 )
  {
    sub_1BDB878(&BalanceConfig_TypeInfo, v61);
    byte_4B3F1D5 = 1;
  }
  ...
  Instance = (DataManager_o *)System_String__Format_62613552(v57, v65, v67, 0LL);
