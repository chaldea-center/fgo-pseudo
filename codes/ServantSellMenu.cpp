        ...
        const MethodInfo *method)
{
  ...
  if ( onSelectSellServant )
  {
    ...
    sub_1B71570(p_onSelectSellServant, 0, (int32_t)servantList, (int32_t)commandCodeList);
...
void __fastcall ServantSellMenu__Close(ServantSellMenu_o *this, System_Action_o *callback, const MethodInfo *method)
{
  ...
  if ( (byte_4A1C083 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_ServantSellMenu_EndClose__, v5);
    byte_4A1C083 = 1;
  }
  servantOperationManager = this->fields.servantOperationManager;
  if ( !servantOperationManager )
    sub_1B71828(0LL, callback);
  ServantOperationManager__SetMode_32570204(servantOperationManager, 1, method);
  this->fields.onClose = callback;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.onClose, (int32_t)callback, v7, v8);
  this->fields.state = 4;
...
void __fastcall ServantSellMenu__EndCloseShowServant(ServantSellMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1C08D & 1) == 0 )
  {
    sub_1B715CC(&System_Action_ServantOperationManager_ActionKind__long____long____TypeInfo, method);
    sub_1B715CC(&Method_ServantSellMenu_OnSelectSellServant__, v3);
    byte_4A1C08D = 1;
  }
  this->fields.state = 2;
  servantOperationManager = this->fields.servantOperationManager;
  v5 = (System_Action_T1__T2__T3__o *)sub_1B71818(System_Action_ServantOperationManager_ActionKind__long____long____TypeInfo);
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&servantOperationManager->fields.onSelect, (int32_t)v5, v8, v9);
  ServantOperationManager__SetMode_32570204(servantOperationManager, 2, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C08C & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_ServantSellMenu_EndCloseShowServant__, v6);
  ...
  if ( !Instance )
LABEL_8:
    sub_1B71828(servantOperationManager, isDecide);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B715CC(&System_Action_TypeInfo, isDecide);
    sub_1B715CC(&Method_ServantSellMenu_EndCloseShowServantQuestJump__, v9);
    sub_1B715CC(&Method_ServantSellMenu_EndCloseShowServant__, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C086 & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_17520/*"btn_txt_craftessence_off"*/, *(_QWORD *)&kind);
    sub_1B715CC(&StringLiteral_17560/*"btn_txt_servant_off"*/, v6);
    sub_1B715CC(&StringLiteral_17516/*"btn_txt_cc_off"*/, v7);
    sub_1B715CC(&StringLiteral_17517/*"btn_txt_cc_on"*/, v8);
    sub_1B715CC(&StringLiteral_17561/*"btn_txt_servant_on"*/, v9);
    sub_1B715CC(&StringLiteral_17521/*"btn_txt_craftessence_on"*/, v10);
    sub_1B715CC(&StringLiteral_1/*""*/, v11);
    byte_4A1C086 = 1;
  }
  if ( kind == 2 )
  {
    v12 = &StringLiteral_17516/*"btn_txt_cc_off"*/;
    v13 = &StringLiteral_17517/*"btn_txt_cc_on"*/;
  }
  else if ( kind == 1 )
  {
    v12 = &StringLiteral_17520/*"btn_txt_craftessence_off"*/;
    v13 = &StringLiteral_17521/*"btn_txt_craftessence_on"*/;
  }
  else
  {
    if ( kind )
    ...
    v12 = &StringLiteral_17560/*"btn_txt_servant_off"*/;
    v13 = &StringLiteral_17561/*"btn_txt_servant_on"*/;
  }
  if ( isSelected )
    v12 = v13;
  return (System_String_o *)*v12;
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantSellMenu__Init_32621020(ServantSellMenu_o *this, int32_t tabToInit, const MethodInfo *method)
{
  ServantOperationManager_o *servantOperationManager; // x0

  servantOperationManager = this->fields.servantOperationManager;
  if ( !servantOperationManager )
    sub_1B71828(0LL, tabToInit);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C08F & 1) == 0 )
  {
    sub_1B715CC(&Method_System_Collections_Generic_List_long__AddRange__, selectedSvtIds);
    ...
    sub_1B715CC(&Method_System_Collections_Generic_List_long__get_Item__, v9);
...
void __fastcall ServantSellMenu__OnClickTabCommandCode(ServantSellMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1C089 & 1) == 0 )
  {
    sub_1B715CC(&Method_ServantSellMenu_OnClickTabCommandCode__, method);
    byte_4A1C089 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantSellMenu_OnClickTabCommandCode__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B715E4(Method_ServantSellMenu_OnClickTabCommandCode__);
    ...
    if ( !servantOperationManager )
      sub_1B71828(0LL, v6);
    ServantOperationManager__SetMode_32570204(servantOperationManager, 2, v7);
  }
}
...
void __fastcall ServantSellMenu__OnClickTabServant(ServantSellMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1C087 & 1) == 0 )
  {
    sub_1B715CC(&Method_ServantSellMenu_OnClickTabServant__, method);
    byte_4A1C087 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantSellMenu_OnClickTabServant__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B715E4(Method_ServantSellMenu_OnClickTabServant__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B715B0(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
...
void __fastcall ServantSellMenu__OnClickTabServantEquip(ServantSellMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1C088 & 1) == 0 )
  {
    sub_1B715CC(&Method_ServantSellMenu_OnClickTabServantEquip__, method);
    byte_4A1C088 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantSellMenu_OnClickTabServantEquip__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B715E4(Method_ServantSellMenu_OnClickTabServantEquip__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B715B0(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C08A & 1) == 0 )
  {
    ...
    sub_1B715CC(&ServantStatusDialog_EndIndividualityDelegate_TypeInfo, v10);
    sub_1B715CC(&ServantStatusDialog_ResultDelegate_TypeInfo, v11);
    sub_1B715CC(&Method_ServantSellMenu_EndShowCommandCode__, v12);
    sub_1B715CC(&Method_ServantSellMenu_EndShowServant__, v13);
    sub_1B715CC(&Method_ServantSellMenu_OnSelectSellServant__, v14);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantSellMenu_OnSelectSellServant__ + 83) & 2) != 0 )
      v17 = (_QWORD *)sub_1B715E4(Method_ServantSellMenu_OnSelectSellServant__);
      ...
      if ( commandCodeList->max_length )
      {
        ...
        if ( Instance )
        {
          ...
          if ( Instance )
          {
            ...
            v23 = (ServantStatusDialog_EndIndividualityDelegate_o *)sub_1B71818(ServantStatusDialog_EndIndividualityDelegate_TypeInfo);
            ...
            if ( v22 )
            {
              CommonUI__OpenServantStatusDialog_30412476(
                (CommonUI_o *)v22,
                0,
    ...
    else
    {
      ...
      if ( servantList->max_length )
      {
        ...
        if ( v26 )
        {
          CommonUI__OpenServantStatusDialog_30409848(v26, 34, servantStatusId, v27, 0LL, 0LL);
          return;
        }
LABEL_21:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C081 & 1) == 0 )
  {
    sub_1B715CC(&System_Action_TypeInfo, onSelectSellServant);
    sub_1B715CC(&Method_ServantSellMenu_EndOpen__, v7);
    byte_4A1C081 = 1;
  }
  ...
  if ( state )
  {
    if ( (state & 0xFFFFFFFE) == 2 )
    {
      ...
      sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.onOpen, (int32_t)onOpen, v9, v10);
  ...
  else
  {
    ...
    sub_1B71570(
      ...
      (int32_t)method);
    this->fields.onOpen = onOpen;
    sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.onOpen, (int32_t)onOpen, v12, v13);
    ...
    ServantOperationManager__SetMode_32570204((ServantOperationManager_o *)gameObject, 1, v17);
    this->fields.state = 1;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C085 & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_17426/*"btn_bg_12"*/, tabButton);
    this = (ServantSellMenu_o *)sub_1B715CC(&StringLiteral_17428/*"btn_bg_19"*/, v14);
    byte_4A1C085 = 1;
  }
  if ( !tabButton
  ...
  v17 = &StringLiteral_17428/*"btn_bg_19"*/;
  if ( selectedKind != tabKind )
    v17 = &StringLiteral_17426/*"btn_bg_12"*/;
...
LABEL_12:
    sub_1B71828(servantOperationManager, v11);
  }
LABEL_11:
...
void __fastcall ServantSellMenu__SetTabLabel(ServantSellMenu_o *this, int32_t kind, const MethodInfo *method)
{
  ...
  *(_QWORD *)servantEquipSum = 0LL;
  ...
  Instance = (DataManager_o *)System_String__Format_61519876(v29, v36, v37, 0LL);
  if ( !servantTabLabel )
    goto LABEL_39;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v43 = LocalizationManager__Get((System_String_o *)StringLiteral_3436/*"CHARA_GRAPH_TAB_SERVANT_EQUIP"*/, 0LL);
  ...
  Instance = (DataManager_o *)System_String__Format_61519876(v43, v47, v51, 0LL);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v57 = LocalizationManager__Get((System_String_o *)StringLiteral_3434/*"CHARA_GRAPH_TAB_COMMAND_CODE"*/, 0LL);
  v69 = Count;
  v65 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v69, v58, v59, v60);
  if ( !byte_4A1B14F )
  {
    sub_1B715CC(&BalanceConfig_TypeInfo, v61);
    byte_4A1B14F = 1;
  }
  ...
  Instance = (DataManager_o *)System_String__Format_61519876(v57, v65, v67, 0LL);
