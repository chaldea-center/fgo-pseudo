...
void __fastcall ServantSellMenu__CallOnOpen(ServantSellMenu_o *this, const MethodInfo *method)
{
  ...
  {
    p_onOpen->klass = 0LL;
    sub_B52920(p_onOpen, 0LL, v2, v3, v4, v5, v6, v7);
    System_Action__Invoke(v9, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B2186 & 1) == 0 )
  {
    sub_B52984(&Method_System_Action_ServantSellMenu_ResultKind__long____long____Invoke__);
    byte_42B2186 = 1;
  }
  ...
  if ( onSelectSellServant )
  {
    ...
    System_Action_ServantSellMenu_ResultKind__long____long_____Invoke(
      ...
      servantList,
      commandCodeList,
      (const MethodInfo_2636F28 *)Method_System_Action_ServantSellMenu_ResultKind__long____long____Invoke__);
  }
}
...
void __fastcall ServantSellMenu__Close(ServantSellMenu_o *this, System_Action_o *callback, const MethodInfo *method)
{
  ...
  if ( (byte_42B217F & 1) == 0 )
  {
    ...
    sub_B52984(&Method_ServantSellMenu_EndClose__);
    byte_42B217F = 1;
  }
  servantOperationManager = this->fields.servantOperationManager;
  if ( !servantOperationManager )
    sub_B52A5C(0LL, callback);
  ServantOperationManager__SetMode_32212220(servantOperationManager, 1, 0LL);
...
void __fastcall ServantSellMenu__EndCloseShowServant(ServantSellMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B218A & 1) == 0 )
  {
    sub_B52984(&Method_System_Action_ServantOperationManager_ActionKind__long____long_____ctor__);
    sub_B52984(&System_Action_ServantOperationManager_ActionKind__long____long____TypeInfo);
    sub_B52984(&Method_ServantSellMenu_OnSelectSellServant__);
    byte_42B218A = 1;
  }
  this->fields.state = 2;
  servantOperationManager = this->fields.servantOperationManager;
  v4 = (System_Action_ServantSellMenu_ResultKind__long____long____o *)sub_B52A54(System_Action_ServantOperationManager_ActionKind__long____long____TypeInfo);
  System_Action_ServantSellMenu_ResultKind__long____long______ctor(
    v4,
    (Il2CppObject *)this,
    Method_ServantSellMenu_OnSelectSellServant__,
    (const MethodInfo_2636F14 *)Method_System_Action_ServantOperationManager_ActionKind__long____long_____ctor__);
  if ( !servantOperationManager )
    sub_B52A5C(v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B52984(&System_Action_TypeInfo);
    sub_B52984(&Method_ServantSellMenu_EndCloseShowServant__);
  ...
  if ( !Instance )
LABEL_8:
    sub_B52A5C(servantOperationManager, isDecide);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B52984(&System_Action_TypeInfo);
    sub_B52984(&Method_ServantSellMenu_EndCloseShowServantQuestJump__);
    sub_B52984(&Method_ServantSellMenu_EndCloseShowServant__);
    sub_B52984(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_42B2188 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( kind == 2 )
  {
    v6 = &StringLiteral_17162/*"btn_txt_cc_off"*/;
    v8 = &StringLiteral_17163/*"btn_txt_cc_on"*/;
  }
  else if ( kind == 1 )
  {
    v6 = &StringLiteral_17165/*"btn_txt_craftessence_off"*/;
    v8 = &StringLiteral_17166/*"btn_txt_craftessence_on"*/;
  }
  else
  {
    if ( kind )
    ...
    v6 = &StringLiteral_17205/*"btn_txt_servant_off"*/;
    v8 = &StringLiteral_17206/*"btn_txt_servant_on"*/;
  }
  if ( isSelected )
    v6 = v8;
  return (System_String_o *)*v6;
...
void __fastcall ServantSellMenu__Init_29009196(ServantSellMenu_o *this, int32_t tabToInit, const MethodInfo *method)
{
  ServantOperationManager_o *servantOperationManager; // x0

  servantOperationManager = this->fields.servantOperationManager;
  if ( !servantOperationManager )
    sub_B52A5C(0LL, tabToInit);
  ServantOperationManager__DestroyList(servantOperationManager, 0LL);
  this->fields.state = 0;
...
void __fastcall ServantSellMenu__OnClickTabCommandCode(ServantSellMenu_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( !servantOperationManager )
      sub_B52A5C(0LL, v4);
    ServantOperationManager__SetMode_32212220(servantOperationManager, 2, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B2187 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_ServantSellMenu_EndShowCommandCode__);
    sub_B52984(&Method_ServantSellMenu_EndShowServant__);
  ...
  if ( this->fields.state == 2 )
  {
      ...
      if ( commandCodeList->max_length )
      {
        ...
        if ( Instance )
        {
          ...
          if ( Instance )
          {
            ...
            v13 = (ServantStatusDialog_EndIndividualityDelegate_o *)sub_B52A54(ServantStatusDialog_EndIndividualityDelegate_TypeInfo);
            ...
            if ( v12 )
            {
              CommonUI__OpenServantStatusDialog_18171512(v12, 0, (UserCommandCodeEntity_o *)Entity, v13, 0LL, 0LL);
              return;
            }
          }
        }
    ...
    else
    {
      ...
      if ( servantList->max_length )
      {
        ...
        v16 = (CommonUI_o *)v14;
        v17 = (ServantStatusDialog_ResultDelegate_o *)sub_B52A54(ServantStatusDialog_ResultDelegate_TypeInfo);
        ...
        if ( v16 )
        {
          CommonUI__OpenServantStatusDialog_18168696(v16, 34, servantStatusId, v17, 0LL, 0LL);
          return;
        }
LABEL_22:
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B52984(&System_Action_TypeInfo);
    sub_B52984(&Method_ServantSellMenu_EndOpen__);
    byte_42B217D = 1;
  }
  ...
  else
  {
    ...
    ServantOperationManager__SetMode_32212220((ServantOperationManager_o *)gameObject, 1, 0LL);
    this->fields.state = 1;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B2181 & 1) == 0 )
  {
    ...
    this = (ServantSellMenu_o *)sub_B52984(&StringLiteral_17082/*"btn_bg_19"*/);
    byte_42B2181 = 1;
  }
  if ( !tabButton
  ...
  v16 = &StringLiteral_17082/*"btn_bg_19"*/;
  if ( selectedKind != tabKind )
    v16 = &StringLiteral_17080/*"btn_bg_12"*/;
...
LABEL_11:
    sub_B52A5C(servantOperationManager, v10);
  }
LABEL_10:
...
void __fastcall ServantSellMenu__SetTabLabel(ServantSellMenu_o *this, int32_t kind, const MethodInfo *method)
{
  ...
  int32_t v46; // [xsp+Ch] [xbp-94h] BYREF
  ...
  *(_QWORD *)servantEquipSum = 0LL;
  ...
  v19 = v15[26];
  v20 = v15[27];
  v21 = LocalizationManager__Get((System_String_o *)StringLiteral_3002/*"CHARA_GRAPH_TAB_SERVANT"*/, 0LL);
  ...
  Instance = (DataManager_o *)System_String__Format_44563852(v21, v22, v23, 0LL);
  if ( !servantTabLabel )
    goto LABEL_75;
  ...
  if ( kind )
    ...
    v27 = v17;
  UILabel__set_effectColor((UILabel_o *)Instance, *(UnityEngine_Color_o *)(&v24 - 3), 0LL);
  ...
  v29 = LocalizationManager__Get((System_String_o *)StringLiteral_3003/*"CHARA_GRAPH_TAB_SERVANT_EQUIP"*/, 0LL);
  ...
  Instance = (DataManager_o *)System_String__Format_44563852(v29, v30, v31, 0LL);
  ...
  v37 = LocalizationManager__Get((System_String_o *)StringLiteral_3001/*"CHARA_GRAPH_TAB_COMMAND_CODE"*/, 0LL);
  v46 = Count;
  ...
  Instance = (DataManager_o *)System_String__Format_44563852(v37, v38, v40, 0LL);
