...
void __fastcall ServantSellMenu__CallOnOpen(ServantSellMenu_o *this, const MethodInfo *method)
{
  ...
  {
    p_onOpen->klass = 0LL;
    sub_1C2E0D0(p_onOpen, 0LL, v2, v3, v4, v5, v6, v7);
    ((void (__fastcall *)(struct System_Reflection_MethodInfo_o *, _QWORD))v9->fields.m_target)(
      v9->fields.original_method_info,
      *(_QWORD *)&v9->fields.extra_arg);
  }
...
void __fastcall ServantSellMenu__Close(ServantSellMenu_o *this, System_Action_o *callback, const MethodInfo *method)
{
  ...
  if ( (byte_4BF9AF5 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_ServantSellMenu_EndClose__, v5);
    byte_4BF9AF5 = 1;
  }
  servantOperationManager = this->fields.servantOperationManager;
  if ( !servantOperationManager )
    sub_1C2E388(0LL, callback);
  ServantOperationManager__SetMode_33857408(servantOperationManager, 1, 0LL);
  this->fields.onClose = callback;
  sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.onClose, (int64_t)callback, v7, v8, v9, v10, v11, v12);
  this->fields.state = 4;
...
void __fastcall ServantSellMenu__EndCloseShowServant(ServantSellMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BF9AFF & 1) == 0 )
  {
    sub_1C2E12C(&System_Action_ServantOperationManager_ActionKind__long____long____TypeInfo, method);
    sub_1C2E12C(&Method_ServantSellMenu_OnSelectSellServant__, v3);
    byte_4BF9AFF = 1;
  }
  this->fields.state = 2;
  servantOperationManager = this->fields.servantOperationManager;
  v5 = (System_Action_T1__T2__T3__o *)sub_1C2E378(System_Action_ServantOperationManager_ActionKind__long____long____TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF9AFE & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_ServantSellMenu_EndCloseShowServant__, v6);
  ...
  if ( !Instance )
LABEL_8:
    sub_1C2E388(servantOperationManager, isDecide);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C2E12C(&System_Action_TypeInfo, isDecide);
    sub_1C2E12C(&Method_ServantSellMenu_EndCloseShowServantQuestJump__, v9);
    sub_1C2E12C(&Method_ServantSellMenu_EndCloseShowServant__, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF9AF8 & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_17879/*"btn_txt_craftessence_off"*/, *(_QWORD *)&kind);
    sub_1C2E12C(&StringLiteral_17919/*"btn_txt_servant_off"*/, v6);
    sub_1C2E12C(&StringLiteral_17875/*"btn_txt_cc_off"*/, v7);
    sub_1C2E12C(&StringLiteral_17876/*"btn_txt_cc_on"*/, v8);
    sub_1C2E12C(&StringLiteral_17920/*"btn_txt_servant_on"*/, v9);
    sub_1C2E12C(&StringLiteral_17880/*"btn_txt_craftessence_on"*/, v10);
    sub_1C2E12C(&StringLiteral_1/*""*/, v11);
    byte_4BF9AF8 = 1;
  }
  if ( kind == 2 )
  {
    v12 = &StringLiteral_17875/*"btn_txt_cc_off"*/;
    v13 = &StringLiteral_17876/*"btn_txt_cc_on"*/;
  }
  else if ( kind == 1 )
  {
    v12 = &StringLiteral_17879/*"btn_txt_craftessence_off"*/;
    v13 = &StringLiteral_17880/*"btn_txt_craftessence_on"*/;
  }
  else
  {
    if ( kind )
    ...
    v12 = &StringLiteral_17919/*"btn_txt_servant_off"*/;
    v13 = &StringLiteral_17920/*"btn_txt_servant_on"*/;
  }
  if ( isSelected )
    v12 = v13;
  return (System_String_o *)*v12;
...
void __fastcall ServantSellMenu__Init_33908008(ServantSellMenu_o *this, int32_t tabToInit, const MethodInfo *method)
{
  ServantOperationManager_o *servantOperationManager; // x0

  servantOperationManager = this->fields.servantOperationManager;
  if ( !servantOperationManager )
    sub_1C2E388(0LL, tabToInit);
  ServantOperationManager__DestroyList(servantOperationManager, 0LL);
  this->fields.state = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF9B01 & 1) == 0 )
  {
    sub_1C2E12C(&Method_System_Collections_Generic_List_long__AddRange__, selectedSvtIds);
    ...
    sub_1C2E12C(&Method_System_Collections_Generic_List_long__get_Item__, v9);
...
void __fastcall ServantSellMenu__OnClickTabCommandCode(ServantSellMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BF9AFB & 1) == 0 )
  {
    sub_1C2E12C(&Method_ServantSellMenu_OnClickTabCommandCode__, method);
    byte_4BF9AFB = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantSellMenu_OnClickTabCommandCode__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2E144(Method_ServantSellMenu_OnClickTabCommandCode__);
    ...
    if ( !servantOperationManager )
      sub_1C2E388(0LL, v6);
    ServantOperationManager__SetMode_33857408(servantOperationManager, 2, 0LL);
  }
}
...
void __fastcall ServantSellMenu__OnClickTabServant(ServantSellMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BF9AF9 & 1) == 0 )
  {
    sub_1C2E12C(&Method_ServantSellMenu_OnClickTabServant__, method);
    byte_4BF9AF9 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantSellMenu_OnClickTabServant__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2E144(Method_ServantSellMenu_OnClickTabServant__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C2E110(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
...
void __fastcall ServantSellMenu__OnClickTabServantEquip(ServantSellMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BF9AFA & 1) == 0 )
  {
    sub_1C2E12C(&Method_ServantSellMenu_OnClickTabServantEquip__, method);
    byte_4BF9AFA = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantSellMenu_OnClickTabServantEquip__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2E144(Method_ServantSellMenu_OnClickTabServantEquip__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C2E110(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF9AFC & 1) == 0 )
  {
    ...
    sub_1C2E12C(&ServantStatusDialog_EndIndividualityDelegate_TypeInfo, v10);
    sub_1C2E12C(&ServantStatusDialog_ResultDelegate_TypeInfo, v11);
    sub_1C2E12C(&Method_ServantSellMenu_EndShowCommandCode__, v12);
    sub_1C2E12C(&Method_ServantSellMenu_EndShowServant__, v13);
    sub_1C2E12C(&Method_ServantSellMenu_OnSelectSellServant__, v14);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantSellMenu_OnSelectSellServant__ + 83) & 2) != 0 )
      v17 = (_QWORD *)sub_1C2E144(Method_ServantSellMenu_OnSelectSellServant__);
      ...
      if ( commandCodeList->max_length )
      {
        ...
        if ( Instance )
        {
          ...
          if ( Instance )
          {
            ...
            v23 = (ServantStatusDialog_EndIndividualityDelegate_o *)sub_1C2E378(ServantStatusDialog_EndIndividualityDelegate_TypeInfo);
            ...
            if ( v22 )
            {
              CommonUI__OpenServantStatusDialog_31189816(
                (CommonUI_o *)v22,
                0,
    ...
    else
    {
      ...
      if ( servantList->max_length )
      {
        ...
        v26 = (CommonUI_o *)v24;
        v27 = (ServantStatusDialog_ResultDelegate_o *)sub_1C2E378(ServantStatusDialog_ResultDelegate_TypeInfo);
        ...
        if ( v26 )
        {
          CommonUI__OpenServantStatusDialog_31187188(v26, 34, servantStatusId, v27, 0LL, 0LL);
          return;
        }
LABEL_21:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF9AF3 & 1) == 0 )
  {
    sub_1C2E12C(&System_Action_TypeInfo, onSelectSellServant);
    sub_1C2E12C(&Method_ServantSellMenu_EndOpen__, v11);
    byte_4BF9AF3 = 1;
  }
  ...
  if ( state )
  {
    if ( (state & 0xFFFFFFFE) == 2 )
    {
      ...
      sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.onOpen, (int64_t)onOpen, v13, v14, v15, v16, v17, v18);
  ...
  else
  {
    ...
    sub_1C2E0D0(
      ...
      v7);
    this->fields.onOpen = onOpen;
    sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.onOpen, (int64_t)onOpen, v20, v21, v22, v23, v24, v25);
    ...
    ServantOperationManager__SetMode_33857408((ServantOperationManager_o *)gameObject, 1, 0LL);
    this->fields.state = 1;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF9AF7 & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_17780/*"btn_bg_12"*/, tabButton);
    this = (ServantSellMenu_o *)sub_1C2E12C(&StringLiteral_17782/*"btn_bg_19"*/, v14);
    byte_4BF9AF7 = 1;
  }
  if ( !tabButton
  ...
  v17 = &StringLiteral_17782/*"btn_bg_19"*/;
  if ( selectedKind != tabKind )
    v17 = &StringLiteral_17780/*"btn_bg_12"*/;
...
LABEL_11:
    sub_1C2E388(servantOperationManager, v10);
  }
LABEL_10:
...
void __fastcall ServantSellMenu__SetTabLabel(ServantSellMenu_o *this, int32_t kind, const MethodInfo *method)
{
  ...
  *(_QWORD *)servantEquipSum = 0LL;
  ...
  Instance = (DataManager_o *)System_String__Format_63249956(v29, v36, v37, 0LL);
  if ( !servantTabLabel )
    goto LABEL_39;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v43 = LocalizationManager__Get((System_String_o *)StringLiteral_3491/*"CHARA_GRAPH_TAB_SERVANT_EQUIP"*/, 0LL);
  ...
  Instance = (DataManager_o *)System_String__Format_63249956(v43, v47, v51, 0LL);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v57 = LocalizationManager__Get((System_String_o *)StringLiteral_3489/*"CHARA_GRAPH_TAB_COMMAND_CODE"*/, 0LL);
  v69 = Count;
  v65 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v69, v58, v59, v60);
  if ( !byte_4BF86F4 )
  {
    sub_1C2E12C(&BalanceConfig_TypeInfo, v61);
    byte_4BF86F4 = 1;
  }
  ...
  Instance = (DataManager_o *)System_String__Format_63249956(v57, v65, v67, 0LL);
