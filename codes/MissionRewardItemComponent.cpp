void __fastcall MissionRewardItemComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49BE1A9 & 1) == 0 )
  {
    sub_1B4CF90(&MissionRewardItemComponent_TypeInfo, v1);
    sub_1B4CF90(&StringLiteral_20171/*"img_shopbg04"*/, v4);
    byte_49BE1A9 = 1;
  }
  MissionRewardItemComponent_TypeInfo->static_fields->BaseSpriteDefaultName = (struct System_String_o *)StringLiteral_20171/*"img_shopbg04"*/;
  sub_1B4CF34((CGThumbnailListItem_o *)MissionRewardItemComponent_TypeInfo->static_fields, StringLiteral_20171/*"img_shopbg04"*/, v2, v3);
}
...
void __fastcall MissionRewardItemComponent__Awake(MissionRewardItemComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BE1A5 & 1) == 0 )
  {
    sub_1B4CF90(&MissionRewardItemComponent_TypeInfo, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BE1A8 & 1) == 0 )
  {
    sub_1B4CF90(&LocalizationManager_TypeInfo, *(_QWORD *)&itemId);
    byte_49BE1A8 = 1;
  }
  if ( itemId < 1 )
  {
