void MissionRewardItemComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CB950D & 1) == 0 )
  {
    sub_1C6BA08(&MissionRewardItemComponent_TypeInfo);
    sub_1C6BA08(&StringLiteral_20638/*"img_shopbg04"*/);
    byte_4CB950D = 1;
  }
  MissionRewardItemComponent_TypeInfo->static_fields->BaseSpriteDefaultName = (struct System_String_o *)StringLiteral_20638/*"img_shopbg04"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)MissionRewardItemComponent_TypeInfo->static_fields, StringLiteral_20638/*"img_shopbg04"*/, v1, v2);
}
