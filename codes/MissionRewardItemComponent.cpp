void MissionRewardItemComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E0839C & 1) == 0 )
  {
    sub_1CE6700(&MissionRewardItemComponent_TypeInfo);
    sub_1CE6700(&StringLiteral_20874/*"img_shopbg04"*/);
    byte_4E0839C = 1;
  }
  MissionRewardItemComponent_TypeInfo->static_fields->BaseSpriteDefaultName = (struct System_String_o *)StringLiteral_20874/*"img_shopbg04"*/;
  sub_1CE66A4(
