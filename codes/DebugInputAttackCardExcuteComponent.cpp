void DebugInputAttackCardExcuteComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E78C55 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&DebugInputAttackCardExcuteComponent_TypeInfo);
    sub_1D0F0B4(&int___TypeInfo);
    sub_1D0F0B4(&BattleCommand_TYPE___TypeInfo);
    sub_1D0F0B4(&Field__PrivateImplementationDetails__45B8AAA32A382159A53DF88A29858D4A57855F2295AB57F8CF442BB9CB7CBD9D);
    byte_4E78C55 = 1;
  }
  v1 = (struct System_Int32_array *)sub_1D0F15C(int___TypeInfo, 3);
  ...
  sub_1D0F058(
    ...
    v6,
    v7);
  v8 = sub_1D0F15C(BattleCommand_TYPE___TypeInfo, 3);
  ...
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&static_fields->CommandTypeList, v8, v10, v11, v12, v13, v14, v15);
  v16 = sub_1D0F15C(bool___TypeInfo, 3);
  v17 = DebugInputAttackCardExcuteComponent_TypeInfo->static_fields;
  v17->CommandTypeTreasure = (struct System_Boolean_array *)v16;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&v17->CommandTypeTreasure, v16, v18, v19, v20, v21, v22, v23);
  v24 = (System_Array_o *)sub_1D0F15C(int___TypeInfo, 3);
  v25.fields.value = Field__PrivateImplementationDetails__45B8AAA32A382159A53DF88A29858D4A57855F2295AB57F8CF442BB9CB7CBD9D;
  v26 = v24;
  System_Runtime_CompilerServices_RuntimeHelpers__InitializeArray_66261996(v24, v25, 0);
  v27 = DebugInputAttackCardExcuteComponent_TypeInfo->static_fields;
  v27->TreasureNpList = (struct System_Int32_array *)v26;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&v27->TreasureNpList, (int32_t)v26, v28, v29, v30, v31, v32, v33);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4E78C4C & 1) == 0 )
  {
    sub_1D0F0B4(&StringLiteral_25926/*"カードタイプ指定なし"*/);
    byte_4E78C4C = 1;
  }
  return (System_String_o *)StringLiteral_25926/*"カードタイプ指定なし"*/;
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4E78C4B & 1) == 0 )
  {
    sub_1D0F0B4(&StringLiteral_25937/*"サーヴァント指定なし"*/);
    byte_4E78C4B = 1;
  }
  return (System_String_o *)StringLiteral_25937/*"サーヴァント指定なし"*/;
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1D0F0B4(&DebugInputAttackCardExcuteComponent_TypeInfo);
    this = (DebugInputAttackCardExcuteComponent_o *)sub_1D0F0B4(&System_Math_TypeInfo);
    byte_4E78C54 = 1;
  }
  result = 0;
  if ( !cardLabelName )
    ...
    && System_Int32__TryParse((System_String_o *)this->fields.servantIdxList, &result, 0) )
  {
    ...
    if ( m_CancellationTokenSource )
    {
      ...
      *v9 = v10 - 100;
      ...
      this = (DebugInputAttackCardExcuteComponent_o *)System_Math__Max_67084744(v11, 100, 0);
...
LABEL_21:
    sub_1D0F30C(this, cardLabelName);
  }
}
    ...
    && System_Int32__TryParse((System_String_o *)this->fields.servantIdxList, &result, 0) )
  {
    ...
    if ( m_CancellationTokenSource )
    {
      ...
      *v9 = v10 + 100;
      if ( !System_Math_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
      this = (DebugInputAttackCardExcuteComponent_o *)System_Math__Min_67085072(v11, 1000, 0);
      if ( v7 >= LODWORD(m_CancellationTokenSource->fields._registeredCallbacksLists) )
        goto LABEL_22;
      *v9 = (_DWORD)this;
      treasureNpLabelList = v4->fields.treasureNpLabelList;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E78C4D & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&DebugInputAttackCardExcuteComponent_TypeInfo);
    sub_1D0F0B4(&StringLiteral_25992/*"宝具"*/);
    sub_1D0F0B4(&StringLiteral_26022/*"番目"*/);
    byte_4E78C4D = 1;
  }
  v3 = 0;
  v4 = 32;
  do
  {
    ...
    if ( SelectedServantIdxList->m_Items[v3] )
    {
      ...
      CommandTypeName = (__int64)System_String__Concat_65562772(v7, (System_String_o *)StringLiteral_26022/*"番目"*/, 0);
    ...
    else
    {
      ...
      if ( (byte_4E78C4B & 1) == 0 )
      {
        CommandTypeName = sub_1D0F0B4(&StringLiteral_25937/*"サーヴァント指定なし"*/);
        byte_4E78C4B = 1;
      }
      if ( !v10 )
        goto LABEL_45;
      CommandTypeName = (__int64)v10;
      method = (const MethodInfo *)StringLiteral_25937/*"サーヴァント指定なし"*/;
    }
...
LABEL_46:
    ...
    v17 = &StringLiteral_25992/*"宝具"*/;
    if ( !*(_BYTE *)(v15 + v3 + 32) )
    {
      v17 = &StringLiteral_25926/*"カードタイプ指定なし"*/;
      if ( (byte_4E78C4C & 1) == 0 )
      {
        sub_1D0F0B4(&StringLiteral_25926/*"カードタイプ指定なし"*/);
        byte_4E78C4C = 1;
    ...
    if ( !v20 )
LABEL_45:
      sub_1D0F30C(CommandTypeName, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E78C52 & 1) == 0 )
  {
    this = (DebugInputAttackCardExcuteComponent_o *)sub_1D0F0B4(&DebugInputAttackCardExcuteComponent_TypeInfo);
    byte_4E78C52 = 1;
  }
  *(_QWORD *)result = 0;
  if ( !cardLabelName )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E78C4F & 1) == 0 )
  {
    sub_1D0F0B4(&System_Action_int__string__TypeInfo);
    sub_1D0F0B4(&BattleCommand_TypeInfo);
    sub_1D0F0B4(&Method_DebugInputAttackCardExcuteComponent_TapSelectAttackCardTypeCallback__);
    ...
    sub_1D0F0B4(&StringLiteral_2379/*"Arts"*/);
    this = (DebugInputAttackCardExcuteComponent_o *)sub_1D0F0B4(&StringLiteral_25992/*"宝具"*/);
    byte_4E78C4F = 1;
  }
  if ( !v3 )
    goto LABEL_37;
  ...
  if ( !this || !name )
    goto LABEL_37;
  v6 = System_String__Substring_65608712(name, LODWORD(this->fields.m_CachedPtr) - 1, 1, 0);
...
LABEL_37:
    sub_1D0F30C(this, parentGameObject);
  if ( (int)this <= SLODWORD(attackCardTypeSelectButtonList->max_length) )
  {
    ...
    if ( (byte_4E78C4C & 1) == 0 )
    {
      this = (DebugInputAttackCardExcuteComponent_o *)sub_1D0F0B4(&StringLiteral_25926/*"カードタイプ指定なし"*/);
      byte_4E78C4C = 1;
    }
    if ( v8 )
    {
      parentGameObject = (UnityEngine_GameObject_o *)StringLiteral_25926/*"カードタイプ指定なし"*/;
      ...
      if ( items )
      {
        ...
        else
        {
          ...
          sub_1D0F058((GrandQuestFolderBoardItem_o *)(v18 + 4), (int32_t)parentGameObject, v9, v10, v11, v12, v13, v14);
        }
        if ( !BattleCommand_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(BattleCommand_TypeInfo);
        this = (DebugInputAttackCardExcuteComponent_o *)BattleCommand__GetCommandTypeName(
                                                          1,
                                                          (System_String_o *)StringLiteral_2379/*"Arts"*/,
                                                          0);
        ...
        if ( v25 )
        {
          ...
          if ( v36 )
          {
            ...
            if ( v47 )
            {
              ...
              parentGameObject = (UnityEngine_GameObject_o *)StringLiteral_25992/*"宝具"*/;
              ...
              if ( v59 )
              {
                ...
                v63 = (System_Action_T1__T2__o *)sub_1D0F300(System_Action_int__string__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1D0F0B4(&System_Action_int__string__TypeInfo);
    sub_1D0F0B4(&Method_DebugInputAttackCardExcuteComponent_TapServantSelectCallback__);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_string__Add__);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_string___ctor__);
    sub_1D0F0B4(&System_Collections_Generic_List_string__TypeInfo);
    this = (DebugInputAttackCardExcuteComponent_o *)sub_1D0F0B4(&StringLiteral_26022/*"番目"*/);
    byte_4E78C4E = 1;
  }
  if ( !v3 )
    goto LABEL_25;
  ...
  if ( (byte_4E78C4B & 1) == 0 )
  {
    this = (DebugInputAttackCardExcuteComponent_o *)sub_1D0F0B4(&StringLiteral_25937/*"サーヴァント指定なし"*/);
    byte_4E78C4B = 1;
  }
  if ( !v8 )
    goto LABEL_25;
  parentGameObject = (UnityEngine_GameObject_o *)StringLiteral_25937/*"サーヴァント指定なし"*/;
  items = v8->fields._items;
  v16 = Method_System_Collections_Generic_List_string__Add__;
  ++v8->fields._version;
  if ( !items )
  ...
  do
  {
    ...
    this = (DebugInputAttackCardExcuteComponent_o *)System_String__Concat_65562772(
                                                      v19,
                                                      (System_String_o *)StringLiteral_26022/*"番目"*/,
                                                      0);
  ...
  attackCardSelectWindow = v4->fields.attackCardSelectWindow;
  v33 = (System_Action_T1__T2__o *)sub_1D0F300(System_Action_int__string__TypeInfo);
  System_Action_int__object____ctor(
    v33,
    (Il2CppObject *)v4,
