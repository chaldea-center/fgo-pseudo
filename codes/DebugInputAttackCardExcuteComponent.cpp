void DebugInputAttackCardExcuteComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C58343 & 1) == 0 )
  {
    ...
    sub_1C3E564(&DebugInputAttackCardExcuteComponent_TypeInfo);
    sub_1C3E564(&int___TypeInfo);
    sub_1C3E564(&BattleCommand_TYPE___TypeInfo);
    sub_1C3E564(&Field__PrivateImplementationDetails__45B8AAA32A382159A53DF88A29858D4A57855F2295AB57F8CF442BB9CB7CBD9D);
    byte_4C58343 = 1;
  }
  v1 = (struct System_Int32_array *)sub_1C3E60C(int___TypeInfo, 3);
  DebugInputAttackCardExcuteComponent_TypeInfo->static_fields->SelectedServantIdxList = v1;
  sub_1C3E508((CGThumbnailListItem_o *)DebugInputAttackCardExcuteComponent_TypeInfo->static_fields, (int32_t)v1, v2, v3);
  v4 = sub_1C3E60C(BattleCommand_TYPE___TypeInfo, 3);
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&static_fields->CommandTypeList, v4, v6, v7);
  v8 = sub_1C3E60C(bool___TypeInfo, 3);
  v9 = DebugInputAttackCardExcuteComponent_TypeInfo->static_fields;
  v9->CommandTypeTreasure = (struct System_Boolean_array *)v8;
  sub_1C3E508((CGThumbnailListItem_o *)&v9->CommandTypeTreasure, v8, v10, v11);
  v12 = (System_Array_o *)sub_1C3E60C(int___TypeInfo, 3);
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&v15->TreasureNpList, (int32_t)v14, v16, v17);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4C5833A & 1) == 0 )
  {
    sub_1C3E564(&StringLiteral_25423/*"カードタイプ指定なし"*/);
    byte_4C5833A = 1;
  }
  return (System_String_o *)StringLiteral_25423/*"カードタイプ指定なし"*/;
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4C58339 & 1) == 0 )
  {
    sub_1C3E564(&StringLiteral_25434/*"サーヴァント指定なし"*/);
    byte_4C58339 = 1;
  }
  return (System_String_o *)StringLiteral_25434/*"サーヴァント指定なし"*/;
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C3E564(&DebugInputAttackCardExcuteComponent_TypeInfo);
    this = (DebugInputAttackCardExcuteComponent_o *)sub_1C3E564(&System_Math_TypeInfo);
    byte_4C58342 = 1;
  }
  result = 0;
  if ( !cardLabelName )
    ...
    && System_Int32__TryParse((System_String_o *)this->fields.servantIdxList, &result, 0) )
  {
    ...
    if ( m_CancellationTokenSource )
    {
      ...
      *v9 = v10 - 100;
      ...
      this = (DebugInputAttackCardExcuteComponent_o *)System_Math__Max_65159900(v11, 100, 0);
...
LABEL_22:
        sub_1C3E7C8(this, cardLabelName);
...
LABEL_21:
    sub_1C3E7C0(this, cardLabelName);
  }
}
    ...
    && System_Int32__TryParse((System_String_o *)this->fields.servantIdxList, &result, 0) )
  {
    ...
    if ( m_CancellationTokenSource )
    {
      ...
      *v9 = v10 + 100;
      if ( !System_Math_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
      this = (DebugInputAttackCardExcuteComponent_o *)System_Math__Min_65160228(v11, 1000, 0);
      if ( v7 >= LODWORD(m_CancellationTokenSource->fields._registeredCallbacksLists) )
        goto LABEL_22;
      *v9 = (_DWORD)this;
      treasureNpLabelList = v4->fields.treasureNpLabelList;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C5833B & 1) == 0 )
  {
    ...
    sub_1C3E564(&DebugInputAttackCardExcuteComponent_TypeInfo);
    sub_1C3E564(&StringLiteral_25490/*"宝具"*/);
    sub_1C3E564(&StringLiteral_25520/*"番目"*/);
    byte_4C5833B = 1;
  }
  v3 = 0;
  v4 = 32;
  do
  {
    ...
    if ( SelectedServantIdxList->m_Items[v3] )
    {
      ...
      CommandTypeName = (__int64)System_String__Concat_63636468(v7, (System_String_o *)StringLiteral_25520/*"番目"*/, 0);
    ...
    else
    {
      ...
      if ( (byte_4C58339 & 1) == 0 )
      {
        CommandTypeName = sub_1C3E564(&StringLiteral_25434/*"サーヴァント指定なし"*/);
        byte_4C58339 = 1;
      }
      if ( !v10 )
        goto LABEL_45;
      CommandTypeName = (__int64)v10;
      method = (const MethodInfo *)StringLiteral_25434/*"サーヴァント指定なし"*/;
    }
...
LABEL_46:
      sub_1C3E7C8(CommandTypeName, method);
    CommandTypeName = (__int64)DebugInputAttackCardExcuteComponent_TypeInfo;
    ...
    v17 = &StringLiteral_25490/*"宝具"*/;
    if ( !*(_BYTE *)(v15 + v3 + 32) )
    {
      v17 = &StringLiteral_25423/*"カードタイプ指定なし"*/;
      if ( (byte_4C5833A & 1) == 0 )
      {
        sub_1C3E564(&StringLiteral_25423/*"カードタイプ指定なし"*/);
        byte_4C5833A = 1;
    ...
    if ( !v20 )
LABEL_45:
      sub_1C3E7C0(CommandTypeName, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C58340 & 1) == 0 )
  {
    this = (DebugInputAttackCardExcuteComponent_o *)sub_1C3E564(&DebugInputAttackCardExcuteComponent_TypeInfo);
    byte_4C58340 = 1;
  }
  *(_QWORD *)result = 0;
  if ( !cardLabelName )
        ...
        const MethodInfo *method)
{
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&v7->fields.debugMenuTran, (int32_t)inputDebugMenuTran, v10, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C5833D & 1) == 0 )
  {
    sub_1C3E564(&System_Action_int__string__TypeInfo);
    sub_1C3E564(&BattleCommand_TypeInfo);
    sub_1C3E564(&Method_DebugInputAttackCardExcuteComponent_TapSelectAttackCardTypeCallback__);
    ...
    this = (DebugInputAttackCardExcuteComponent_o *)sub_1C3E564(&StringLiteral_25490/*"宝具"*/);
    byte_4C5833D = 1;
  }
  if ( !v3 )
    goto LABEL_37;
  ...
  if ( !this || !name )
    goto LABEL_37;
  v6 = System_String__Substring_63682392(name, LODWORD(this->fields.m_CachedPtr) - 1, 1, 0);
...
LABEL_37:
    sub_1C3E7C0(this, parentGameObject);
  if ( (int)this <= SLODWORD(attackCardTypeSelectButtonList->max_length) )
  {
    ...
    if ( (byte_4C5833A & 1) == 0 )
    {
      this = (DebugInputAttackCardExcuteComponent_o *)sub_1C3E564(&StringLiteral_25423/*"カードタイプ指定なし"*/);
      byte_4C5833A = 1;
    }
    if ( v8 )
    {
      parentGameObject = (UnityEngine_GameObject_o *)StringLiteral_25423/*"カードタイプ指定なし"*/;
      ...
      if ( items )
      {
        ...
        else
        {
          ...
          sub_1C3E508((CGThumbnailListItem_o *)(v14 + 4), (int32_t)parentGameObject, v9, v10);
        }
        if ( !BattleCommand_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(BattleCommand_TypeInfo);
          ...
          if ( v24 )
          {
            ...
            if ( v31 )
            {
              ...
              else
              {
                ...
                sub_1C3E508((CGThumbnailListItem_o *)(v35 + 4), (int32_t)v34, v29, v30);
              }
              v38 = Method_System_Collections_Generic_List_string__Add__;
              parentGameObject = (UnityEngine_GameObject_o *)StringLiteral_25490/*"宝具"*/;
              ...
              if ( v39 )
              {
                ...
                else
                {
                  ...
                  sub_1C3E508((CGThumbnailListItem_o *)(v41 + 4), (int32_t)parentGameObject, v36, v37);
                }
                attackCardSelectWindow = v4->fields.attackCardSelectWindow;
                v43 = (System_Action_T1__T2__o *)sub_1C3E7B0(System_Action_int__string__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C3E564(&System_Action_int__string__TypeInfo);
    sub_1C3E564(&Method_DebugInputAttackCardExcuteComponent_TapServantSelectCallback__);
    sub_1C3E564(&Method_System_Collections_Generic_List_string__Add__);
    sub_1C3E564(&Method_System_Collections_Generic_List_string___ctor__);
    sub_1C3E564(&System_Collections_Generic_List_string__TypeInfo);
    this = (DebugInputAttackCardExcuteComponent_o *)sub_1C3E564(&StringLiteral_25520/*"番目"*/);
    byte_4C5833C = 1;
  }
  if ( !v3 )
    goto LABEL_25;
  ...
  if ( (byte_4C58339 & 1) == 0 )
  {
    this = (DebugInputAttackCardExcuteComponent_o *)sub_1C3E564(&StringLiteral_25434/*"サーヴァント指定なし"*/);
    byte_4C58339 = 1;
  }
  if ( !v8 )
    goto LABEL_25;
  parentGameObject = (UnityEngine_GameObject_o *)StringLiteral_25434/*"サーヴァント指定なし"*/;
  items = v8->fields._items;
  v12 = Method_System_Collections_Generic_List_string__Add__;
  ++v8->fields._version;
  if ( !items )
  ...
  do
  {
    ...
    this = (DebugInputAttackCardExcuteComponent_o *)System_String__Concat_63636468(
                                                      v15,
                                                      (System_String_o *)StringLiteral_25520/*"番目"*/,
                                                      0);
  ...
  attackCardSelectWindow = v4->fields.attackCardSelectWindow;
  v25 = (System_Action_T1__T2__o *)sub_1C3E7B0(System_Action_int__string__TypeInfo);
  System_Action_int__object____ctor(
    v25,
    (Il2CppObject *)v4,
...
LABEL_14:
    sub_1C3E7C8(v11, *(_QWORD *)&idx);
  v11 = attackCardTypeNameList->m_Items[idx];
  if ( !v11 )
LABEL_13:
    sub_1C3E7C0(v11, *(_QWORD *)&idx);
...
LABEL_12:
    sub_1C3E7C8(v9, *(_QWORD *)&idx);
  v9 = servantIdxList->m_Items[idx];
  if ( !v9 )
LABEL_11:
    sub_1C3E7C0(v9, *(_QWORD *)&idx);
