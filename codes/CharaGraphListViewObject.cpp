...
void __fastcall CharaGraphListViewObject__Awake(CharaGraphListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0804D & 1) == 0 )
  {
    sub_1B686D4(&Method_UnityEngine_GameObject_GetComponent_CharaGraphListViewItemDraw___, method);
    byte_4A0804D = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2E98950 *)Method_UnityEngine_GameObject_GetComponent_CharaGraphListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0804F & 1) == 0 )
  {
    sub_1B686D4(&CharaGraphListViewItemBase_TypeInfo, method);
    byte_4A0804F = 1;
  }
...
void __fastcall CharaGraphListViewObject__SetItem_37789680(
        CharaGraphListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
