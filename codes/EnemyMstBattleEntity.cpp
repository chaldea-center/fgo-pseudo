        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B4678 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_17975/*"cutinId"*/);
    byte_42B4678 = 1;
  }
  result = 0;
  ...
  if ( script )
  {
    if ( System_Collections_Generic_Dictionary_XmlQualifiedName__XmlSchemaObject___ContainsKey(
           ...
           (System_Xml_XmlQualifiedName_o *)StringLiteral_17975/*"cutinId"*/,
           (const MethodInfo_2F1BA74 *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
    {
      ...
      Item = System_Collections_Generic_Dictionary_Type__IStoreExtension___get_Item(
               ...
               (System_Type_o *)StringLiteral_17975/*"cutinId"*/,
      ...
      Item = (void *)sub_B5299C(char___TypeInfo, 1LL);
      if ( !Item )
        goto LABEL_18;
      v6 = Item;
      if ( !*((_DWORD *)Item + 6) )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B4679 & 1) == 0 )
  {
    sub_B52984(&StringLiteral_21534/*"overwriteEnemyMasterBackgroundId"*/);
    byte_42B4679 = 1;
  }
  return EnemyMstBattleEntity__getScript(this, (System_String_o *)StringLiteral_21534/*"overwriteEnemyMasterBackgroundId"*/, defval, v3);
}
