        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1F95D & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_18369/*"cutinId"*/, v6);
    byte_4A1F95D = 1;
  }
  ...
  if ( script )
  {
    if ( !System_Collections_Generic_Dictionary_object__object___ContainsKey(
            ...
            (Il2CppObject *)StringLiteral_18369/*"cutinId"*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1F95E & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_22333/*"overwriteEnemyMasterBackgroundId"*/, *(_QWORD *)&defval);
    byte_4A1F95E = 1;
  }
  return EnemyMstBattleEntity__getScript(this, (System_String_o *)StringLiteral_22333/*"overwriteEnemyMasterBackgroundId"*/, defval, v3);
}
