        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC725A & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_18468/*"cutinId"*/);
    byte_4CC725A = 1;
  }
  ...
  if ( script )
  {
    if ( !System_Collections_Generic_Dictionary_object__object___ContainsKey(
            ...
            (Il2CppObject *)StringLiteral_18468/*"cutinId"*/,
...
int32_t EnemyMstBattleEntity__GetOverwriteFrame(EnemyMstBattleEntity_o *this, int32_t defval, const MethodInfo *method)
{
  ...
  if ( (byte_4CC725B & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_22654/*"overwriteEnemyMasterBackgroundId"*/);
    byte_4CC725B = 1;
  }
  return EnemyMstBattleEntity__getScript(this, (System_String_o *)StringLiteral_22654/*"overwriteEnemyMasterBackgroundId"*/, defval, v3);
}
