        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A28F8D & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMasterData_CommonConsumeMaster___, *(_QWORD *)&index);
    sub_1B761C0(&Method_DataManager_GetMasterData_CommonReleaseMaster___, v11);
  ...
  sub_1B76164(&this->fields.boostEntity);
  this->fields.usrItemEntityList = usrItemEntityList;
  sub_1B76164(&this->fields.usrItemEntityList);
  ...
  this->fields.commonConsumeEntity = CommonConsumeMaster__GetIdEntityList(
                                       ...
                                       0LL);
  sub_1B76164(&this->fields.commonConsumeEntity);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_371257C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_14;
  Instance = DataManager__GetMasterData_object_(
