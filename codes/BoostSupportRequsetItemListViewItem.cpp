        ...
        const MethodInfo *method)
{
  ...
  sub_1B8635C(&this->fields.boostEntity);
  this->fields.usrItemEntityList = usrItemEntityList;
  sub_1B8635C(&this->fields.usrItemEntityList);
  ...
  if ( !boostEntity
    ...
    || (this->fields.commonConsumeEntity = CommonConsumeMaster__GetIdEntityList(
                                             ...
                                             0LL),
        sub_1B8635C(&this->fields.commonConsumeEntity),
        (Master_object = DataManager__GetMaster_object_((const MethodInfo_2F6DC64 *)Method_DataManager_GetMaster_CommonReleaseMaster___)) == 0LL) )
  {
