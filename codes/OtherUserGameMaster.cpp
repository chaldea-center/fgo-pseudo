void __fastcall OtherUserGameMaster___ctor(OtherUserGameMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A2E344 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_OtherUserGameMaster__OtherUserGameEntity__long___ctor__, method);
    byte_4A2E344 = 1;
  }
  DataMasterBase_object__object__long____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    64,
    (const MethodInfo_30FF8EC *)Method_DataMasterBase_OtherUserGameMaster__OtherUserGameEntity__long___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E345 & 1) == 0 )
  {
    sub_1B761C0(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__, friendCode);
    ...
    sub_1B761C0(&OtherUserGameEntity_TypeInfo, v10);
    byte_4A2E345 = 1;
  }
  v11 = (System_Collections_Generic_List_object__o *)sub_1B7640C(System_Collections_Generic_List_OtherUserGameEntity__TypeInfo);
    ...
    if ( (int)list >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( list )
        {
          ...
          {
            list = (void *)System_String__Equals_61543376(friendCode, *((System_String_o **)list + 5), 0LL);
...
void __fastcall OtherUserGameMaster__continueDeviceOtherUser(OtherUserGameMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2E346 & 1) == 0 )
  {
    ...
    sub_1B761C0(&OtherUserGameEntity_TypeInfo, v9);
    sub_1B761C0(&OtherUserNewManager_TypeInfo, v10);
    byte_4A2E346 = 1;
  }
...
LABEL_19:
  ...
  OtherUserNewManager__SetOld_40223720(v21, 0LL);
}