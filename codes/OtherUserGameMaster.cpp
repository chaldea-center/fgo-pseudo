void __fastcall OtherUserGameMaster___ctor(OtherUserGameMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4B375BC & 1) == 0 )
  {
    sub_1BD3458(&Method_DataMasterBase_OtherUserGameMaster__OtherUserGameEntity__long___ctor__, method);
    byte_4B375BC = 1;
  }
  DataMasterBase_object__object__long____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    64,
    (const MethodInfo_31D205C *)Method_DataMasterBase_OtherUserGameMaster__OtherUserGameEntity__long___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B375BD & 1) == 0 )
  {
    sub_1BD3458(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__, friendCode);
    ...
    sub_1BD3458(&OtherUserGameEntity_TypeInfo, v10);
    byte_4B375BD = 1;
  }
  v11 = (System_Collections_Generic_List_object__o *)sub_1BD36A4(System_Collections_Generic_List_OtherUserGameEntity__TypeInfo);
    ...
    if ( (int)list >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( list )
        {
          ...
          {
            list = (void *)System_String__Equals_62533564(friendCode, *((System_String_o **)list + 5), 0LL);
...
void __fastcall OtherUserGameMaster__continueDeviceOtherUser(OtherUserGameMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B375BE & 1) == 0 )
  {
    ...
    sub_1BD3458(&OtherUserGameEntity_TypeInfo, v9);
    sub_1BD3458(&OtherUserNewManager_TypeInfo, v10);
    byte_4B375BE = 1;
  }
...
LABEL_23:
  ...
  OtherUserNewManager__SetOld_41242320(v21, 0LL);
}