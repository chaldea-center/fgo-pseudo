...
System_Int32_array *OpponentRangeAggregator__GetCandidate(OpponentRangeAggregator_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E7ABDE & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_BasicHelper_ExcludeNull_BattleServantData___);
    ...
    sub_1D0F0B4(&Method_OpponentRangeAggregator___c__GetCandidate_b__0_2__);
    sub_1D0F0B4(&Method_OpponentRangeAggregator___c__DisplayClass0_0__GetCandidate_b__0__);
    sub_1D0F0B4(&Method_OpponentRangeAggregator___c__DisplayClass0_0__GetCandidate_b__1__);
    sub_1D0F0B4(&OpponentRangeAggregator___c__DisplayClass0_0_TypeInfo);
    sub_1D0F0B4(&OpponentRangeAggregator___c_TypeInfo);
    byte_4E7ABDE = 1;
  }
  v3 = sub_1D0F300(OpponentRangeAggregator___c__DisplayClass0_0_TypeInfo);
    ...
    if ( v15 )
    {
      ...
      if ( battleData_k__BackingField )
      {
        ...
        *(_QWORD *)(v3 + 24) = TargetIndexArray;
        sub_1D0F058((GrandQuestFolderBoardItem_o *)(v3 + 24), (int32_t)TargetIndexArray, v20, v21, v22, v23, v24, v25);
        Candidate = (System_Collections_Generic_IEnumerable_TSource__o *)OpponentAllFieldTargetAggregator__GetCandidate(
                                                                           ...
                                                                           v26);
        v28 = (System_Func_T__TResult__o *)sub_1D0F300(System_Func_int__BattleServantData__TypeInfo);
        ...
        v30 = BasicHelper__ExcludeNull_object_(
                v29,
                (const MethodInfo_3238C40 *)Method_BasicHelper_ExcludeNull_BattleServantData___);
        ...
        if ( !_9__0_2 )
        {
          ...
          _9__0_2 = (System_Func_object__int__o *)sub_1D0F300(System_Func_BattleServantData__int__TypeInfo);
...
LABEL_25:
    sub_1D0F30C(battleData_k__BackingField, v5);
  }
...
void OpponentRangeAggregator_Cell___ctor_48724792(
...
void OpponentRangeAggregator___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1D0F300(OpponentRangeAggregator___c_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7ABE1 & 1) == 0 )
  {
    this = (OpponentRangeAggregator___c__DisplayClass0_0_o *)sub_1D0F0B4(&Method_System_Linq_Enumerable_Contains_int___);
    byte_4E7ABE1 = 1;
  }
  if ( !x )
    sub_1D0F30C(this, x);
