        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47B78 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_BasicHelper_ExcludeNull_BattleServantData___, v3);
    sub_1BDB878(&Method_System_Linq_Enumerable_Select_BattleServantData__int___, v4);
    sub_1BDB878(&Method_System_Linq_Enumerable_Select_int__BattleServantData___, v5);
    ...
    sub_1BDB878(&Method_OpponentRangeAggregator___c__GetCandidate_b__0_2__, v12);
    sub_1BDB878(&Method_OpponentRangeAggregator___c__DisplayClass0_0__GetCandidate_b__0__, v13);
    sub_1BDB878(&Method_OpponentRangeAggregator___c__DisplayClass0_0__GetCandidate_b__1__, v14);
    sub_1BDB878(&OpponentRangeAggregator___c__DisplayClass0_0_TypeInfo, v15);
    sub_1BDB878(&OpponentRangeAggregator___c_TypeInfo, v16);
    byte_4B47B78 = 1;
  }
  v17 = sub_1BDBAC4(OpponentRangeAggregator___c__DisplayClass0_0_TypeInfo);
    ...
    if ( v25 )
    {
      ...
      if ( battleData_k__BackingField )
      {
        ...
        *(_QWORD *)(v17 + 24) = TargetIndexArray;
        sub_1BDB81C((CGThumbnailListItem_o *)(v17 + 24), (int32_t)TargetIndexArray, v30, v31);
        Candidate = (System_Collections_Generic_IEnumerable_TSource__o *)OpponentAllFieldTargetAggregator__GetCandidate(
                                                                           ...
                                                                           v32);
        v34 = (System_Func_T__TResult__o *)sub_1BDBAC4(System_Func_int__BattleServantData__TypeInfo);
        ...
        v38 = (System_Func_object__bool__o *)sub_1BDBAC4(System_Func_BattleServantData__bool__TypeInfo);
        ...
        if ( !_9__0_2 )
        {
          ...
          _9__0_2 = (System_Func_object__int__o *)sub_1BDBAC4(System_Func_BattleServantData__int__TypeInfo);
          ...
          sub_1BDB81C((CGThumbnailListItem_o *)&static_fields->__9__0_2, (int32_t)_9__0_2, v45, v46);
        }
...
LABEL_25:
    sub_1BDBAD4(battleData_k__BackingField, v19);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47B79 & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Collections_Generic_List_int__Add__, *(_QWORD *)&baseIndex);
...
void __fastcall OpponentRangeAggregator_Cell___ctor_45862980(
        OpponentRangeAggregator_Cell_o this,
        int32_t col,
        int32_t row,
        const MethodInfo *method)
...
void __fastcall OpponentRangeAggregator___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B47B7A & 1) == 0 )
  {
    sub_1BDB878(&OpponentRangeAggregator___c_TypeInfo, v1);
    byte_4B47B7A = 1;
  }
  v2 = (Il2CppObject *)sub_1BDBAC4(OpponentRangeAggregator___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  OpponentRangeAggregator___c_TypeInfo->static_fields->__9 = (struct OpponentRangeAggregator___c_o *)v2;
  sub_1BDB81C((CGThumbnailListItem_o *)OpponentRangeAggregator___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47B7B & 1) == 0 )
  {
    this = (OpponentRangeAggregator___c__DisplayClass0_0_o *)sub_1BDB878(
