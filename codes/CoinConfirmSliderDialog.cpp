...
void __fastcall CoinConfirmSliderDialog__Close(CoinConfirmSliderDialog_o *this, const MethodInfo *method)
{
  ...
  CoinConfirmSliderDialog__Close_47047580(this, 0LL, v2);
}


void __fastcall CoinConfirmSliderDialog__Close_47047580(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1FF02 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_CoinConfirmSliderDialog_EndClose__, v6);
    byte_4B1FF02 = 1;
  }
...
void __fastcall CoinConfirmSliderDialog__OnClickCancel(CoinConfirmSliderDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1FF04 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_CoinConfirmSliderDialog_OnClickCancel__, method);
    byte_4B1FF04 = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_CoinConfirmSliderDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BCB010(Method_CoinConfirmSliderDialog_OnClickCancel__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BCAFDC(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0, 0LL);
    CoinConfirmSliderDialog__Close_47047580(this, 0LL, v5);
  }
}
...
void __fastcall CoinConfirmSliderDialog__OnClickDecide(CoinConfirmSliderDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1FF03 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_CoinConfirmSliderDialog_OnClickDecide__, method);
    byte_4B1FF03 = 1;
  }
  if ( this->fields.state == 1 && this->fields.onDecide )
  {
    ...
    if ( (*((_BYTE *)Method_CoinConfirmSliderDialog_OnClickDecide__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1BCB010(Method_CoinConfirmSliderDialog_OnClickDecide__);
    ...
    CoinConfirmSliderDialog__Close_47047580(this, 0LL, v7);
    onDecide = this->fields.onDecide;
    this->fields.onDecide = 0LL;
    sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.onDecide, 0, v9, v10);
    if ( !onDecide )
LABEL_13:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1FF00 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_CoinConfirmSliderDialog_OnSliderDragFinished__, canStrengthDic);
    sub_1BCAFF8(&CoinRoomUtility_TypeInfo, v7);
    sub_1BCAFF8(&int_TypeInfo, v8);
    sub_1BCAFF8(&LocalizationManager_TypeInfo, v9);
    sub_1BCAFF8(&UIProgressBar_OnDragFinished_TypeInfo, v10);
    sub_1BCAFF8(&StringLiteral_3523/*"COIN_ROOM_SLIDER_CONFIRM_DIALOG_DETAIL_1"*/, v11);
    sub_1BCAFF8(&StringLiteral_3524/*"COIN_ROOM_SLIDER_CONFIRM_DIALOG_DETAIL_2"*/, v12);
    sub_1BCAFF8(&StringLiteral_3525/*"COIN_ROOM_SLIDER_CONFIRM_DIALOG_TITLE"*/, v13);
    byte_4B1FF00 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.onDecide, (int32_t)onDecide, v16, v17);
    titleLabel = this->fields.titleLabel;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3525/*"COIN_ROOM_SLIDER_CONFIRM_DIALOG_TITLE"*/, 0LL);
    if ( !titleLabel )
      goto LABEL_17;
    ...
    v20 = LocalizationManager__Get((System_String_o *)StringLiteral_3523/*"COIN_ROOM_SLIDER_CONFIRM_DIALOG_DETAIL_1"*/, 0LL);
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3524/*"COIN_ROOM_SLIDER_CONFIRM_DIALOG_DETAIL_2"*/, 0LL);
    if ( !detailLabel_2 )
      goto LABEL_17;
    ...
    v29 = (UIProgressBar_OnDragFinished_o *)sub_1BCB244(UIProgressBar_OnDragFinished_TypeInfo);
    ...
    if ( !checkSlider
      || (checkSlider->fields.onDragFinished = v29,
          sub_1BCAF9C((CGThumbnailListItem_o *)&checkSlider->fields.onDragFinished, (int32_t)v29, v30, v31),
