...
void __fastcall CoinConfirmSliderDialog__Close(CoinConfirmSliderDialog_o *this, const MethodInfo *method)
{
  ...
  CoinConfirmSliderDialog__Close_44194824(this, 0LL, v2);
}


void __fastcall CoinConfirmSliderDialog__Close_44194824(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01FB8 & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_CoinConfirmSliderDialog_EndClose__, v6);
    byte_4A01FB8 = 1;
  }
...
void __fastcall CoinConfirmSliderDialog__OnClickCancel(CoinConfirmSliderDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A01FBA & 1) == 0 )
  {
    sub_1B64A00(&Method_CoinConfirmSliderDialog_OnClickCancel__, method);
    byte_4A01FBA = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_CoinConfirmSliderDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B64A18(Method_CoinConfirmSliderDialog_OnClickCancel__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B649E4(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0LL);
    CoinConfirmSliderDialog__Close_44194824(this, 0LL, v5);
  }
}
...
void __fastcall CoinConfirmSliderDialog__OnClickDecide(CoinConfirmSliderDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A01FB9 & 1) == 0 )
  {
    sub_1B64A00(&Method_CoinConfirmSliderDialog_OnClickDecide__, method);
    byte_4A01FB9 = 1;
  }
  if ( this->fields.state == 1 && this->fields.onDecide )
  {
    ...
    if ( (*((_BYTE *)Method_CoinConfirmSliderDialog_OnClickDecide__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B64A18(Method_CoinConfirmSliderDialog_OnClickDecide__);
    ...
    CoinConfirmSliderDialog__Close_44194824(this, 0LL, v7);
    onDecide = this->fields.onDecide;
    this->fields.onDecide = 0LL;
    sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.onDecide, 0, v9, v10);
    if ( !onDecide )
LABEL_13:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01FB6 & 1) == 0 )
  {
    sub_1B64A00(&Method_CoinConfirmSliderDialog_OnSliderDragFinished__, canStrengthDic);
    sub_1B64A00(&CoinRoomUtility_TypeInfo, v7);
    sub_1B64A00(&int_TypeInfo, v8);
    sub_1B64A00(&LocalizationManager_TypeInfo, v9);
    sub_1B64A00(&UIProgressBar_OnDragFinished_TypeInfo, v10);
    sub_1B64A00(&StringLiteral_3616/*"COIN_ROOM_SLIDER_CONFIRM_DIALOG_DETAIL_1"*/, v11);
    sub_1B64A00(&StringLiteral_3617/*"COIN_ROOM_SLIDER_CONFIRM_DIALOG_DETAIL_2"*/, v12);
    sub_1B64A00(&StringLiteral_3618/*"COIN_ROOM_SLIDER_CONFIRM_DIALOG_TITLE"*/, v13);
    byte_4A01FB6 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.onDecide, (int32_t)onDecide, v16, v17);
    ...
    v21 = LocalizationManager__Get((System_String_o *)StringLiteral_3616/*"COIN_ROOM_SLIDER_CONFIRM_DIALOG_DETAIL_1"*/, 0LL);
    ...
    v30 = (UIProgressBar_OnDragFinished_o *)sub_1B64C4C(UIProgressBar_OnDragFinished_TypeInfo);
    ...
    if ( !checkSlider
      || (checkSlider->fields.onDragFinished = v30,
          sub_1B649A4((ServantStatusBattleListViewItem_o *)&checkSlider->fields.onDragFinished, (int32_t)v30, v31, v32),
