...
void CoinConfirmSliderDialog__Close(CoinConfirmSliderDialog_o *this, const MethodInfo *method)
{
  ...
  CoinConfirmSliderDialog__Close_49752340(this, 0, v2);
}


void CoinConfirmSliderDialog__Close_49752340(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7B51F & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_CoinConfirmSliderDialog_EndClose__);
    byte_4E7B51F = 1;
  }
...
void CoinConfirmSliderDialog__OnClickCancel(CoinConfirmSliderDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E7B521 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_CoinConfirmSliderDialog_OnClickCancel__);
    byte_4E7B521 = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_CoinConfirmSliderDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1D0F0CC(Method_CoinConfirmSliderDialog_OnClickCancel__);
    v4 = (System_Reflection_MethodBase_o *)sub_1D0F098(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0, 0);
    CoinConfirmSliderDialog__Close_49752340(this, 0, v5);
  }
}
...
void CoinConfirmSliderDialog__OnClickDecide(CoinConfirmSliderDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E7B520 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_CoinConfirmSliderDialog_OnClickDecide__);
    byte_4E7B520 = 1;
  }
  if ( this->fields.state == 1 && this->fields.onDecide )
  {
    ...
    if ( (*((_BYTE *)Method_CoinConfirmSliderDialog_OnClickDecide__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1D0F0CC(Method_CoinConfirmSliderDialog_OnClickDecide__);
    ...
    CoinConfirmSliderDialog__Close_49752340(this, 0, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7B51D & 1) == 0 )
  {
    sub_1D0F0B4(&Method_CoinConfirmSliderDialog_OnSliderDragFinished__);
    sub_1D0F0B4(&CoinRoomUtility_TypeInfo);
    sub_1D0F0B4(&int_TypeInfo);
    sub_1D0F0B4(&LocalizationManager_TypeInfo);
    sub_1D0F0B4(&UIProgressBar_OnDragFinished_TypeInfo);
    sub_1D0F0B4(&StringLiteral_3596/*"COIN_ROOM_SLIDER_CONFIRM_DIALOG_DETAIL_1"*/);
    sub_1D0F0B4(&StringLiteral_3597/*"COIN_ROOM_SLIDER_CONFIRM_DIALOG_DETAIL_2"*/);
    sub_1D0F0B4(&StringLiteral_3598/*"COIN_ROOM_SLIDER_CONFIRM_DIALOG_TITLE"*/);
    byte_4E7B51D = 1;
  }
  if ( !this->fields.state )
  {
    ...
    sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.onDecide, (int32_t)onDecide, v9, v10, v11, v12, v13, v14);
    titleLabel = this->fields.titleLabel;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3598/*"COIN_ROOM_SLIDER_CONFIRM_DIALOG_TITLE"*/, 0);
    if ( !titleLabel )
      goto LABEL_17;
    ...
    v18 = LocalizationManager__Get((System_String_o *)StringLiteral_3596/*"COIN_ROOM_SLIDER_CONFIRM_DIALOG_DETAIL_1"*/, 0);
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3597/*"COIN_ROOM_SLIDER_CONFIRM_DIALOG_DETAIL_2"*/, 0);
    if ( !detailLabel_2 )
      goto LABEL_17;
    ...
    v24 = (UIProgressBar_OnDragFinished_o *)sub_1D0F300(UIProgressBar_OnDragFinished_TypeInfo);
