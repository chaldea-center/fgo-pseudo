...
void CoinConfirmSliderDialog__Close(CoinConfirmSliderDialog_o *this, const MethodInfo *method)
{
  ...
  CoinConfirmSliderDialog__Close_48164732(this, 0, v2);
}


void CoinConfirmSliderDialog__Close_48164732(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C46BFD & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_CoinConfirmSliderDialog_EndClose__);
    byte_4C46BFD = 1;
  }
...
void CoinConfirmSliderDialog__OnClickCancel(CoinConfirmSliderDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C46BFF & 1) == 0 )
  {
    sub_1C37058(&Method_CoinConfirmSliderDialog_OnClickCancel__);
    byte_4C46BFF = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_CoinConfirmSliderDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C37070(Method_CoinConfirmSliderDialog_OnClickCancel__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C3703C(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0, 0);
    CoinConfirmSliderDialog__Close_48164732(this, 0, v5);
  }
}
...
void CoinConfirmSliderDialog__OnClickDecide(CoinConfirmSliderDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C46BFE & 1) == 0 )
  {
    sub_1C37058(&Method_CoinConfirmSliderDialog_OnClickDecide__);
    byte_4C46BFE = 1;
  }
  if ( this->fields.state == 1 && this->fields.onDecide )
  {
    ...
    if ( (*((_BYTE *)Method_CoinConfirmSliderDialog_OnClickDecide__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1C37070(Method_CoinConfirmSliderDialog_OnClickDecide__);
    ...
    CoinConfirmSliderDialog__Close_48164732(this, 0, v7);
    onDecide = this->fields.onDecide;
    this->fields.onDecide = 0;
    sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.onDecide, 0, v9, v10);
    if ( !onDecide )
LABEL_13:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C46BFB & 1) == 0 )
  {
    sub_1C37058(&Method_CoinConfirmSliderDialog_OnSliderDragFinished__);
    sub_1C37058(&CoinRoomUtility_TypeInfo);
    sub_1C37058(&int_TypeInfo);
    sub_1C37058(&LocalizationManager_TypeInfo);
    sub_1C37058(&UIProgressBar_OnDragFinished_TypeInfo);
    sub_1C37058(&StringLiteral_3558/*"COIN_ROOM_SLIDER_CONFIRM_DIALOG_DETAIL_1"*/);
    sub_1C37058(&StringLiteral_3559/*"COIN_ROOM_SLIDER_CONFIRM_DIALOG_DETAIL_2"*/);
    sub_1C37058(&StringLiteral_3560/*"COIN_ROOM_SLIDER_CONFIRM_DIALOG_TITLE"*/);
    byte_4C46BFB = 1;
  }
  if ( !this->fields.state )
  {
    ...
    v24 = (UIProgressBar_OnDragFinished_o *)sub_1C372A4(UIProgressBar_OnDragFinished_TypeInfo);
    ...
    if ( !checkSlider
      || (checkSlider->fields.onDragFinished = v24,
          sub_1C36FFC((CGThumbnailListItem_o *)&checkSlider->fields.onDragFinished, (int32_t)v24, v25, v26),
