...
void CoinConfirmSliderDialog__Close(CoinConfirmSliderDialog_o *this, const MethodInfo *method)
{
  ...
  CoinConfirmSliderDialog__Close_49459152(this, 0, v2);
}


void CoinConfirmSliderDialog__Close_49459152(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E087ED & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_CoinConfirmSliderDialog_EndClose__);
    byte_4E087ED = 1;
  }
...
void CoinConfirmSliderDialog__OnClickCancel(CoinConfirmSliderDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E087EF & 1) == 0 )
  {
    sub_1CE6700(&Method_CoinConfirmSliderDialog_OnClickCancel__);
    byte_4E087EF = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_CoinConfirmSliderDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_CoinConfirmSliderDialog_OnClickCancel__);
    v4 = (System_Reflection_MethodBase_o *)sub_1CE66E4(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0, 0);
    CoinConfirmSliderDialog__Close_49459152(this, 0, v5);
  }
}
...
void CoinConfirmSliderDialog__OnClickDecide(CoinConfirmSliderDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E087EE & 1) == 0 )
  {
    sub_1CE6700(&Method_CoinConfirmSliderDialog_OnClickDecide__);
    byte_4E087EE = 1;
  }
  if ( this->fields.state == 1 && this->fields.onDecide )
  {
    ...
    if ( (*((_BYTE *)Method_CoinConfirmSliderDialog_OnClickDecide__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1CE6718(Method_CoinConfirmSliderDialog_OnClickDecide__);
    ...
    CoinConfirmSliderDialog__Close_49459152(this, 0, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E087EB & 1) == 0 )
  {
    sub_1CE6700(&Method_CoinConfirmSliderDialog_OnSliderDragFinished__);
    sub_1CE6700(&CoinRoomUtility_TypeInfo);
    sub_1CE6700(&int_TypeInfo);
    sub_1CE6700(&LocalizationManager_TypeInfo);
    sub_1CE6700(&UIProgressBar_OnDragFinished_TypeInfo);
    sub_1CE6700(&StringLiteral_3586/*"COIN_ROOM_SLIDER_CONFIRM_DIALOG_DETAIL_1"*/);
    sub_1CE6700(&StringLiteral_3587/*"COIN_ROOM_SLIDER_CONFIRM_DIALOG_DETAIL_2"*/);
    sub_1CE6700(&StringLiteral_3588/*"COIN_ROOM_SLIDER_CONFIRM_DIALOG_TITLE"*/);
    byte_4E087EB = 1;
  }
  if ( !this->fields.state )
  {
    ...
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.onDecide, (int32_t)onDecide, v9, v10, v11, v12, v13, v14);
    titleLabel = this->fields.titleLabel;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3588/*"COIN_ROOM_SLIDER_CONFIRM_DIALOG_TITLE"*/, 0);
    if ( !titleLabel )
      goto LABEL_17;
    ...
    v18 = LocalizationManager__Get((System_String_o *)StringLiteral_3586/*"COIN_ROOM_SLIDER_CONFIRM_DIALOG_DETAIL_1"*/, 0);
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3587/*"COIN_ROOM_SLIDER_CONFIRM_DIALOG_DETAIL_2"*/, 0);
    if ( !detailLabel_2 )
      goto LABEL_17;
    ...
    v24 = (UIProgressBar_OnDragFinished_o *)sub_1CE694C(UIProgressBar_OnDragFinished_TypeInfo);
