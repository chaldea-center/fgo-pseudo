...
void __fastcall CoinConfirmSliderDialog__Close(CoinConfirmSliderDialog_o *this, const MethodInfo *method)
{
  ...
  CoinConfirmSliderDialog__Close_45948632(this, 0LL, v2);
}


void __fastcall CoinConfirmSliderDialog__Close_45948632(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDFC00 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_CoinConfirmSliderDialog_EndClose__);
    byte_4BDFC00 = 1;
  }
...
void __fastcall CoinConfirmSliderDialog__OnClickCancel(CoinConfirmSliderDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDFC02 & 1) == 0 )
  {
    sub_1C21E38(&Method_CoinConfirmSliderDialog_OnClickCancel__);
    byte_4BDFC02 = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_CoinConfirmSliderDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_CoinConfirmSliderDialog_OnClickCancel__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C21E1C(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0, 0LL);
    CoinConfirmSliderDialog__Close_45948632(this, 0LL, v5);
  }
}
...
void __fastcall CoinConfirmSliderDialog__OnClickDecide(CoinConfirmSliderDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDFC01 & 1) == 0 )
  {
    sub_1C21E38(&Method_CoinConfirmSliderDialog_OnClickDecide__);
    byte_4BDFC01 = 1;
  }
  if ( this->fields.state == 1 && this->fields.onDecide )
  {
    ...
    if ( (*((_BYTE *)Method_CoinConfirmSliderDialog_OnClickDecide__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1C21E50(Method_CoinConfirmSliderDialog_OnClickDecide__);
    ...
    CoinConfirmSliderDialog__Close_45948632(this, 0LL, v7);
    onDecide = this->fields.onDecide;
    this->fields.onDecide = 0LL;
    sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.onDecide, 0LL, v9, v10, v11, v12, v13, v14);
    if ( !onDecide )
LABEL_13:
        ...
        const MethodInfo *method)
{
  ...
  UIProgressBar_OnDragFinished_o *v27; // x22
  int64_t v28; // x2
  int32_t v29; // w3
  ...
  if ( (byte_4BDFBFE & 1) == 0 )
  {
    sub_1C21E38(&Method_CoinConfirmSliderDialog_OnSliderDragFinished__);
    sub_1C21E38(&CoinRoomUtility_TypeInfo);
    sub_1C21E38(&int_TypeInfo);
    sub_1C21E38(&LocalizationManager_TypeInfo);
    sub_1C21E38(&UIProgressBar_OnDragFinished_TypeInfo);
    sub_1C21E38(&StringLiteral_3692/*"COIN_ROOM_SLIDER_CONFIRM_DIALOG_DETAIL_1"*/);
    sub_1C21E38(&StringLiteral_3693/*"COIN_ROOM_SLIDER_CONFIRM_DIALOG_DETAIL_2"*/);
    sub_1C21E38(&StringLiteral_3694/*"COIN_ROOM_SLIDER_CONFIRM_DIALOG_TITLE"*/);
    byte_4BDFBFE = 1;
  }
  if ( !this->fields.state )
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3694/*"COIN_ROOM_SLIDER_CONFIRM_DIALOG_TITLE"*/, 0LL);
    if ( !titleLabel )
      goto LABEL_17;
    ...
    v18 = LocalizationManager__Get((System_String_o *)StringLiteral_3692/*"COIN_ROOM_SLIDER_CONFIRM_DIALOG_DETAIL_1"*/, 0LL);
    detailLabel_1 = this->fields.detailLabel_1;
    v20 = v18;
    v36 = v17;
    v24 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v36, v21, v22, v23);
    gameObject = (UnityEngine_GameObject_o *)System_String__Format(v20, v24, 0LL);
    if ( !detailLabel_1 )
      goto LABEL_17;
    UILabel__set_text(detailLabel_1, (System_String_o *)gameObject, 0LL);
    detailLabel_2 = this->fields.detailLabel_2;
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3693/*"COIN_ROOM_SLIDER_CONFIRM_DIALOG_DETAIL_2"*/, 0LL);
    if ( !detailLabel_2 )
      goto LABEL_17;
    ...
    v27 = (UIProgressBar_OnDragFinished_o *)sub_1C22084(UIProgressBar_OnDragFinished_TypeInfo);
    ...
    if ( !checkSlider
      || (checkSlider->fields.onDragFinished = v27,
          sub_1C21DDC(
            ...
            v32,
            v33),
          CoinConfirmSliderDialog__SetSlider(this, 0, v34),
