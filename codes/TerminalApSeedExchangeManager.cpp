        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(mInstance, 0, 0) )
  {
    ...
    klass = (struct TerminalSceneComponent_o *)v10->fields.rpRoot->klass;
    if ( klass )
    {
      ...
      if ( UnityEngine_Object__op_Inequality(mPlayerStatus, 0, 0) )
      {
        ...
        v13 = (struct TerminalSceneComponent_o *)v10->fields.rpRoot->klass;
        if ( !v13 )
          goto LABEL_57;
      ...
      v14 = (struct TerminalSceneComponent_o *)v10->fields.rpRoot->klass;
      if ( v14 )
      {
        ...
        v16 = (struct TerminalSceneComponent_o *)v10->fields.rpRoot->klass;
        if ( v16 )
        {
...
void TerminalApSeedExchangeManager__Initialize(TerminalApSeedExchangeManager_o *this, const MethodInfo *method)
{
  ...
  __int64 v4; // x1
  ShopEntity_array *EnableEntitiyList_44234488; // x0
  ...
  if ( (byte_4E75933 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_System_Linq_Enumerable_FirstOrDefault_ShopEntity___);
    sub_1D0F0B4(&Method_System_Linq_Enumerable_Where_ShopEntity___);
    sub_1D0F0B4(&System_Func_ShopEntity__bool__TypeInfo);
    sub_1D0F0B4(&Method_TerminalApSeedExchangeManager_OnClickApSeedExchangeButton__);
    sub_1D0F0B4(&Method_TerminalApSeedExchangeManager___c__Initialize_b__4_0__);
    sub_1D0F0B4(&TerminalApSeedExchangeManager___c_TypeInfo);
    byte_4E75933 = 1;
  }
  ...
  if ( !Master_object )
    goto LABEL_15;
  EnableEntitiyList_44234488 = ShopMaster__GetEnableEntitiyList_44234488((ShopMaster_o *)Master_object, 0, 14, 0);
  v6 = TerminalApSeedExchangeManager___c_TypeInfo;
  v7 = (System_Collections_Generic_IEnumerable_TSource__o *)EnableEntitiyList_44234488;
  ...
  if ( !_9__4_0 )
  {
    ...
    _9__4_0 = (System_Func_object__bool__o *)sub_1D0F300(System_Func_ShopEntity__bool__TypeInfo);
  ...
  Master_object = System_Linq_Enumerable__FirstOrDefault_object_(
                    v17,
                    (const MethodInfo_3277A14 *)Method_System_Linq_Enumerable_FirstOrDefault_ShopEntity___);
  if ( !this
    || (this->fields.shopEntity = (struct ShopEntity_o *)Master_object,
        sub_1D0F058(
          (GrandQuestFolderBoardItem_o *)&this->fields.shopEntity,
...
LABEL_15:
  ...
  ApSeedExchangeButton__SetupBtn(apSeedExchangeButton, shopEntity, v26, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E75934 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1D0F0B4(&Method_TerminalApSeedExchangeManager_OnSelectExchangeItems__);
    byte_4E75934 = 1;
  }
  shopEntity = this->fields.shopEntity;
  if ( shopEntity )
  {
    v4 = (ShopBuyItemListViewItem_o *)sub_1D0F300(ShopBuyItemListViewItem_TypeInfo);
    ShopBuyItemListViewItem___ctor(v4, 0, 18, shopEntity, -1, 0);
    this->fields.listViewItem = v4;
    sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.listViewItem, (int32_t)v4, v5, v6, v7, v8, v9, v10);
    Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3BAC684 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    v12 = this->fields.shopEntity;
    listViewItem = this->fields.listViewItem;
    v14 = (CommonUI_o *)Instance;
    v15 = (System_Action_int__o *)sub_1D0F300(System_Action_int__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E75939 & 1) == 0 )
  {
    this = (TerminalApSeedExchangeManager_o *)sub_1D0F0B4(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4E75939 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E75935 & 1) == 0 )
  {
    ...
    this = (TerminalApSeedExchangeManager_o *)sub_1D0F0B4(&Method_TerminalApSeedExchangeManager_EndRequestShop__);
    byte_4E75935 = 1;
  }
  ...
  if ( buyCount )
  {
    ...
    PurchaseRequest__beginRequest((PurchaseRequest_o *)Request_object, shopEntity->fields.id, buyCount, 0, 0, 0, 0);
  }
  else
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E75937 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_TerminalApSeedExchangeManager_OnCloseResultDialog__);
    byte_4E75937 = 1;
  }
...
void TerminalApSeedExchangeManager___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1D0F300(TerminalApSeedExchangeManager___c_TypeInfo);
  System_Object___ctor(v1, 0);
  TerminalApSeedExchangeManager___c_TypeInfo->static_fields->__9 = (struct TerminalApSeedExchangeManager___c_o *)v1;
  sub_1D0F058(
    (GrandQuestFolderBoardItem_o *)TerminalApSeedExchangeManager___c_TypeInfo->static_fields,
    (int32_t)v1,
    v2,
    v3,
    v4,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7593B & 1) == 0 )
  {
    this = (TerminalApSeedExchangeManager___c_o *)sub_1D0F0B4(&BalanceConfig_TypeInfo);
    byte_4E7593B = 1;
  }
  if ( !ent )
