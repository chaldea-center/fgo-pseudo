        ...
        const MethodInfo *method)
{
  if ( (byte_49BC03A & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataEntityBase_CreateMultiplePK_int__int__string__string___, *(_QWORD *)&priority);
    byte_49BC03A = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__object__object_(
           ...
           (Il2CppObject *)name,
           (const MethodInfo_2F00734 *)Method_DataEntityBase_CreateMultiplePK_int__int__string__string___);
}
