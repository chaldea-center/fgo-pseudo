        ...
        const MethodInfo *method)
{
  if ( (byte_4D2DB79 & 1) == 0 )
  {
    sub_1C94098(&Method_DataEntityBase_CreateMultiplePK_int__int__string__string___);
    byte_4D2DB79 = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__object__object_(
           ...
           (Il2CppObject *)name,
           (const MethodInfo_319AD44 *)Method_DataEntityBase_CreateMultiplePK_int__int__string__string___);
}
