        ...
        const MethodInfo *method)
{
  if ( (byte_4B45CCC & 1) == 0 )
  {
    sub_1BDB878(&Method_DataEntityBase_CreateMultiplePK_int__int__string__string___, *(_QWORD *)&priority);
    byte_4B45CCC = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__object__object_(
           ...
           (Il2CppObject *)name,
           (const MethodInfo_303256C *)Method_DataEntityBase_CreateMultiplePK_int__int__string__string___);
}
