        ...
        const MethodInfo *method)
{
  if ( (byte_4E05CE9 & 1) == 0 )
  {
    sub_1CE6700(&Method_DataEntityBase_CreateMultiplePK_int__int__string__string___);
    byte_4E05CE9 = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__object__object_(
           ...
           (Il2CppObject *)name,
           (const MethodInfo_3202FB8 *)Method_DataEntityBase_CreateMultiplePK_int__int__string__string___);
}
