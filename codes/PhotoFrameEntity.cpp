        ...
        const MethodInfo *method)
{
  if ( (byte_4A4F6B3 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataEntityBase_CreateMultiplePK_int__int__string__string___, *(_QWORD *)&priority);
    byte_4A4F6B3 = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__object__object_(
           ...
           (Il2CppObject *)name,
           (const MethodInfo_2F6C8C8 *)Method_DataEntityBase_CreateMultiplePK_int__int__string__string___);
}
