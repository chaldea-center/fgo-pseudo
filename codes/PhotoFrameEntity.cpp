        ...
        const MethodInfo *method)
{
  if ( (byte_4E7898E & 1) == 0 )
  {
    sub_1D0F0B4(&Method_DataEntityBase_CreateMultiplePK_int__int__string__string___);
    byte_4E7898E = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__object__object_(
           ...
           (Il2CppObject *)name,
           (const MethodInfo_324DDC8 *)Method_DataEntityBase_CreateMultiplePK_int__int__string__string___);
}
