        ...
        const MethodInfo *method)
{
  if ( (byte_4C28586 & 1) == 0 )
  {
    sub_1C2D490(&Method_DataEntityBase_CreateMultiplePK_int__int__string__string___);
    byte_4C28586 = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__object__object_(
           ...
           (Il2CppObject *)name,
           (const MethodInfo_30CD560 *)Method_DataEntityBase_CreateMultiplePK_int__int__string__string___);
}
