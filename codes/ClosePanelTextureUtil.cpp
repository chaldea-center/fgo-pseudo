        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B793E & 1) == 0 )
  {
    positionCalculator = (SubmarinePanelPositionCalculator_o *)sub_1B4CF90(&ObjectDomain_TypeInfo, method);
    byte_49B793E = 1;
  }
  if ( !v3 )
    sub_1B4D1EC(positionCalculator, method);
  v6 = v3->fields._PanelUnitSize_k__BackingField.fields.x;
  v7 = v3->fields._PanelUnitSize_k__BackingField.fields.y;
  v8 = sub_1B4D1DC(ObjectDomain_TypeInfo);
        ...
        const MethodInfo *method)
{
  __int64 v4; // x1
  __int64 v5; // x1
  UnityEngine_Color_array *Pixels_68695212; // x0
  __int64 v7; // x1
  ...
  Pixels_68695212 = (UnityEngine_Color_array *)UnityEngine_Object__op_Equality(
                                                 (UnityEngine_Object_o *)baseTexture,
                                                 0LL,
                                                 0LL);
  v8 = 0LL;
  if ( ((unsigned __int8)Pixels_68695212 & 1) == 0 )
  {
    if ( !baseTexture )
      goto LABEL_19;
    Pixels_68695212 = UnityEngine_Texture2D__GetPixels_68695212(baseTexture, 0LL);
    if ( !Pixels_68695212 )
      goto LABEL_19;
    v9 = Pixels_68695212;
    Pixels_68695212 = (UnityEngine_Color_array *)sub_1B4D038(UnityEngine_Color___TypeInfo, Pixels_68695212->max_length);
    v10 = Pixels_68695212;
    if ( (int)*(_QWORD *)&v9->max_length >= 1 )
    {
      if ( !(unsigned int)*(_QWORD *)&v9->max_length )
LABEL_15:
        sub_1B4D1F4(Pixels_68695212, v7);
      v11 = 0LL;
      v12.n64_u64[0] = vdup_lane_s32(v21, 0).n64_u64[0];
      v13 = (unsigned int)*(_QWORD *)&v9->max_length - 1LL;
      p_r = &Pixels_68695212->m_Items[1].fields.r;
      v15 = &v9->m_Items[1].fields.r;
      while ( Pixels_68695212 )
      {
        if ( v11 >= Pixels_68695212->max_length )
          goto LABEL_15;
        v16 = *v15;
...
LABEL_19:
      sub_1B4D1EC(Pixels_68695212, v7);
    }
LABEL_16:
    ...
    v8 = (UnityEngine_Texture2D_o *)sub_1B4D1DC(UnityEngine_Texture2D_TypeInfo);
    UnityEngine_Texture2D___ctor_68692824(v8, v18, v19, 0LL);
    if ( !v8 )
      goto LABEL_19;
    UnityEngine_Texture2D__SetPixels_68693716(v8, v10, 0LL);
    UnityEngine_Texture2D__Apply_68694488(v8, 0LL);
  }
  return v8;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B7940 & 1) == 0 )
  {
    sub_1B4CF90(&PanelUniqueIDUtil_TypeInfo, excludePanelUniqueIds);
    objDomain = (ObjectDomain_o *)sub_1B4CF90(&UnityEngine_Texture2D_TypeInfo, v9);
    byte_49B7940 = 1;
  }
  if ( !v8 )
    goto LABEL_48;
  ...
  v43 = (UnityEngine_Texture2D_o *)sub_1B4D1DC(UnityEngine_Texture2D_TypeInfo);
  UnityEngine_Texture2D___ctor_68692824(v43, v10, v11, 0LL);
  ...
  if ( y == INFINITY )
    ...
    v28 = (int)y;
  objDomain = (ObjectDomain_o *)UnityEngine_Texture2D__GetPixels_68695212(closedPanelTexture, 0LL);
              ...
              if ( v28 >= 1 )
              {
                ...
                do
                {
                  if ( v39 >= v31->max_length )
                    sub_1B4D1F4(objDomain, excludePanelUniqueIds);
                  v40 = &v31->obj + (int)v39;
                  --v38;
                  v39 += v26;
                  v40[2].klass = 0LL;
  ...
  if ( !v43 )
LABEL_48:
    sub_1B4D1EC(objDomain, excludePanelUniqueIds);
  UnityEngine_Texture2D__SetPixels_68693716(v43, v31, 0LL);
  UnityEngine_Texture2D__Apply_68694488(v43, 0LL);
  return v41;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B793C & 1) == 0 )
  {
    sub_1B4CF90(&ObjectDomain___TypeInfo, closedPanelTexture);
    sub_1B4CF90(&ObjectDomain_TypeInfo, v5);
    sub_1B4CF90(&float___TypeInfo, v6);
    byte_49B793C = 1;
  }
  v7 = sub_1B4D038(float___TypeInfo, 4LL);
  if ( !positionCalculator )
    goto LABEL_62;
  v9 = v7;
  ...
  *(float *)(v9 + 44) = (float)(v20 >> 1) - v19;
  v21 = (ObjectDomain_array *)sub_1B4D038(ObjectDomain___TypeInfo, 4LL);
  ...
  v25 = ((__int64 (__fastcall *)(UnityEngine_Texture2D_o *, Il2CppMethodPointer))closedPanelTexture->klass->vtable._6_get_height.method)(
          closedPanelTexture,
          closedPanelTexture->klass->vtable._7_set_height.methodPtr);
  v26 = (Il2CppObject *)sub_1B4D1DC(ObjectDomain_TypeInfo);
  v27 = 1 - v24;
  if ( v22 <= 0 )
    v28 = -v22;
  else
...
LABEL_62:
    sub_1B4D1EC(v7, v8);
  v7 = sub_1B4D0CC(v29, v21->obj.klass->_1.element_class);
  if ( !v7 )
    goto LABEL_63;
  if ( !v21->max_length )
    goto LABEL_61;
  v21->m_Items[0] = (ObjectDomain_o *)v29;
  sub_1B4CF34((CGThumbnailListItem_o *)v21->m_Items, (int32_t)v29, v32, v33);
  v7 = ((__int64 (__fastcall *)(UnityEngine_Texture2D_o *, Il2CppMethodPointer))closedPanelTexture->klass->vtable._4_get_width.method)(
         closedPanelTexture,
         closedPanelTexture->klass->vtable._5_set_width.methodPtr);
  if ( !*(_DWORD *)(v9 + 24) )
  ...
  v38 = *(float *)(v9 + 40);
  v40 = *(float *)(v9 + 32);
  v41 = (Il2CppObject *)sub_1B4D1DC(ObjectDomain_TypeInfo);
  v42 = 1 - v36;
  if ( v35 <= 0 )
    v43 = -v35;
  else
  ...
  *(float *)&v46[1].monitor = v49;
  ...
  v7 = sub_1B4D0CC(v46, v21->obj.klass->_1.element_class);
  if ( !v7 )
  {
LABEL_63:
    v83 = sub_1B4D210();
  ...
  if ( v21->max_length <= 1
    || (v21->m_Items[1] = (ObjectDomain_o *)v46,
        sub_1B4CF34((CGThumbnailListItem_o *)&v21->m_Items[1], (int32_t)v46, v50, v51),
        v7 = ((__int64 (__fastcall *)(UnityEngine_Texture2D_o *, Il2CppMethodPointer))closedPanelTexture->klass->vtable._4_get_width.method)(
               closedPanelTexture,
               closedPanelTexture->klass->vtable._5_set_width.methodPtr),
        *(_DWORD *)(v9 + 24) <= 2u)
...
LABEL_61:
  ...
  v56 = ((__int64 (__fastcall *)(UnityEngine_Texture2D_o *, Il2CppMethodPointer))closedPanelTexture->klass->vtable._6_get_height.method)(
          closedPanelTexture,
          closedPanelTexture->klass->vtable._7_set_height.methodPtr);
  v57 = (Il2CppObject *)sub_1B4D1DC(ObjectDomain_TypeInfo);
  if ( v53 >= 0 )
    v58 = v53;
  else
    v58 = v53 + 1;
  ...
  *((float *)&v60[1].monitor + 1) = (float)v56;
  v7 = sub_1B4D0CC(v60, v21->obj.klass->_1.element_class);
  if ( !v7 )
    goto LABEL_63;
  if ( v21->max_length <= 2 )
    goto LABEL_61;
  v21->m_Items[2] = (ObjectDomain_o *)v60;
  sub_1B4CF34((CGThumbnailListItem_o *)&v21->m_Items[2], (int32_t)v60, v63, v64);
  v7 = ((__int64 (__fastcall *)(UnityEngine_Texture2D_o *, Il2CppMethodPointer))closedPanelTexture->klass->vtable._4_get_width.method)(
         closedPanelTexture,
         closedPanelTexture->klass->vtable._5_set_width.methodPtr);
  if ( !*(_DWORD *)(v9 + 24) )
  ...
  v71 = *(float *)(v9 + 40);
  v72 = *(_DWORD *)(v9 + 44);
  v73 = (Il2CppObject *)sub_1B4D1DC(ObjectDomain_TypeInfo);
  if ( v66 <= 0 )
    v74 = -v66;
  else
    v74 = 1 - v66;
  ...
  *(float *)&v78[1].monitor = (float)((float)v69 - v70) - v71;
  ...
  v7 = sub_1B4D0CC(v78, v21->obj.klass->_1.element_class);
  if ( !v7 )
    goto LABEL_63;
  if ( v21->max_length <= 3 )
    goto LABEL_61;
  v21->m_Items[3] = (ObjectDomain_o *)v78;
  sub_1B4CF34((CGThumbnailListItem_o *)&v21->m_Items[3], (int32_t)v78, v80, v81);
  return v21;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B793D & 1) == 0 )
  {
    positionCalculator = (SubmarinePanelPositionCalculator_o *)sub_1B4CF90(&ObjectDomain_TypeInfo, closedPanelTexture);
    byte_49B793D = 1;
  }
  if ( !v3 )
    sub_1B4D1EC(positionCalculator, closedPanelTexture);
  ...
  v9 = v14.fields.y;
  v10 = sub_1B4D1DC(ObjectDomain_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  UnityEngine_RenderTexture_o *Temporary_68712616; // x22
  ...
  if ( (byte_49B7941 & 1) == 0 )
  {
    sub_1B4CF90(&UnityEngine_Graphics_TypeInfo, *(_QWORD *)&resizeWidth);
    sub_1B4CF90(&UnityEngine_Object_TypeInfo, v7);
    sub_1B4CF90(&UnityEngine_Texture2D_TypeInfo, v8);
    byte_49B7941 = 1;
  }
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  ...
  {
    Temporary_68712616 = UnityEngine_RenderTexture__GetTemporary_68712616(resizeWidth, resizeHeight, 0, 7, 1, 0LL);
    if ( !UnityEngine_Graphics_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Graphics_TypeInfo);
    UnityEngine_Graphics__Blit((UnityEngine_Texture_o *)baseTexture, Temporary_68712616, 0LL);
    active = UnityEngine_RenderTexture__get_active(0LL);
    UnityEngine_RenderTexture__set_active(Temporary_68712616, 0LL);
    v9 = (UnityEngine_Texture2D_o *)sub_1B4D1DC(UnityEngine_Texture2D_TypeInfo);
    UnityEngine_Texture2D___ctor_68692824(v9, resizeWidth, resizeHeight, 0LL);
    if ( !v9 )
      sub_1B4D1EC(v12, v13);
    ...
    UnityEngine_Texture2D__ReadPixels_68694908(v9, v15, 0, 0, 0LL);
    UnityEngine_Texture2D__Apply_68694488(v9, 0LL);
    UnityEngine_RenderTexture__set_active(active, 0LL);
    UnityEngine_RenderTexture__ReleaseTemporary(Temporary_68712616, 0LL);
  }
  return v9;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B793F & 1) == 0 )
  {
    objDomain = (ObjectDomain_o *)sub_1B4CF90(&UnityEngine_Texture2D_TypeInfo, positionCalculator);
    byte_49B793F = 1;
  }
  if ( !v5 )
    goto LABEL_35;
  ...
  v11 = v8;
  UnityEngine_Texture2D___ctor_68692824(v8, v9, v10, 0LL);
  if ( !closedPanelTexture )
    goto LABEL_35;
  ...
  objDomain = (ObjectDomain_o *)UnityEngine_Texture2D__GetPixels_68691512(closedPanelTexture, v24, v25, v26, v27, 0LL);
  if ( !v11 )
LABEL_35:
    sub_1B4D1EC(objDomain, positionCalculator);
  UnityEngine_Texture2D__SetPixels_68693716(v11, (UnityEngine_Color_array *)objDomain, 0LL);
  UnityEngine_Texture2D__Apply_68694488(v11, 0LL);
  return v11;
}