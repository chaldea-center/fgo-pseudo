        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB18F & 1) == 0 )
  {
    positionCalculator = (SubmarinePanelPositionCalculator_o *)sub_1B64870(&ObjectDomain_TypeInfo, method);
    byte_49FB18F = 1;
  }
  if ( !v3 )
    sub_1B64ACC(positionCalculator, method);
  v6 = v3->fields._PanelUnitSize_k__BackingField.fields.x;
  v7 = v3->fields._PanelUnitSize_k__BackingField.fields.y;
  v8 = sub_1B64ABC(ObjectDomain_TypeInfo);
        ...
        const MethodInfo *method)
{
  __int64 v4; // x1
  __int64 v5; // x1
  UnityEngine_Color_array *Pixels_69026756; // x0
  __int64 v7; // x1
  ...
  Pixels_69026756 = (UnityEngine_Color_array *)UnityEngine_Object__op_Equality(
                                                 (UnityEngine_Object_o *)baseTexture,
                                                 0LL,
                                                 0LL);
  v8 = 0LL;
  if ( ((unsigned __int8)Pixels_69026756 & 1) == 0 )
  {
    if ( !baseTexture )
      goto LABEL_19;
    Pixels_69026756 = UnityEngine_Texture2D__GetPixels_69026756(baseTexture, 0LL);
    if ( !Pixels_69026756 )
      goto LABEL_19;
    v9 = Pixels_69026756;
    Pixels_69026756 = (UnityEngine_Color_array *)sub_1B64918(UnityEngine_Color___TypeInfo, Pixels_69026756->max_length);
    v10 = Pixels_69026756;
    if ( (int)*(_QWORD *)&v9->max_length >= 1 )
    {
      if ( !(unsigned int)*(_QWORD *)&v9->max_length )
LABEL_15:
        sub_1B64AD4(Pixels_69026756, v7);
      v11 = 0LL;
      v12.n64_u64[0] = vdup_lane_s32(v21, 0).n64_u64[0];
      v13 = (unsigned int)*(_QWORD *)&v9->max_length - 1LL;
      p_r = &Pixels_69026756->m_Items[1].fields.r;
      v15 = &v9->m_Items[1].fields.r;
      while ( Pixels_69026756 )
      {
        if ( v11 >= Pixels_69026756->max_length )
          goto LABEL_15;
        v16 = *v15;
...
LABEL_19:
      sub_1B64ACC(Pixels_69026756, v7);
    }
LABEL_16:
    ...
    v8 = (UnityEngine_Texture2D_o *)sub_1B64ABC(UnityEngine_Texture2D_TypeInfo);
    UnityEngine_Texture2D___ctor_69024368(v8, v18, v19, 0LL);
    if ( !v8 )
      goto LABEL_19;
    UnityEngine_Texture2D__SetPixels_69025260(v8, v10, 0LL);
    UnityEngine_Texture2D__Apply_69026032(v8, 0LL);
  }
  return v8;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB191 & 1) == 0 )
  {
    sub_1B64870(&PanelUniqueIDUtil_TypeInfo, excludePanelUniqueIds);
    objDomain = (ObjectDomain_o *)sub_1B64870(&UnityEngine_Texture2D_TypeInfo, v9);
    byte_49FB191 = 1;
  }
  if ( !v8 )
    goto LABEL_48;
  ...
  v43 = (UnityEngine_Texture2D_o *)sub_1B64ABC(UnityEngine_Texture2D_TypeInfo);
  UnityEngine_Texture2D___ctor_69024368(v43, v10, v11, 0LL);
  ...
  if ( y == INFINITY )
    ...
    v28 = (int)y;
  objDomain = (ObjectDomain_o *)UnityEngine_Texture2D__GetPixels_69026756(closedPanelTexture, 0LL);
              ...
              if ( v28 >= 1 )
              {
                ...
                do
                {
                  if ( v39 >= v31->max_length )
                    sub_1B64AD4(objDomain, excludePanelUniqueIds);
                  v40 = &v31->obj + (int)v39;
                  --v38;
                  v39 += v26;
                  v40[2].klass = 0LL;
  ...
  if ( !v43 )
LABEL_48:
    sub_1B64ACC(objDomain, excludePanelUniqueIds);
  UnityEngine_Texture2D__SetPixels_69025260(v43, v31, 0LL);
  UnityEngine_Texture2D__Apply_69026032(v43, 0LL);
  return v41;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB18D & 1) == 0 )
  {
    sub_1B64870(&ObjectDomain___TypeInfo, closedPanelTexture);
    sub_1B64870(&ObjectDomain_TypeInfo, v5);
    sub_1B64870(&float___TypeInfo, v6);
    byte_49FB18D = 1;
  }
  v7 = sub_1B64918(float___TypeInfo, 4LL);
  if ( !positionCalculator )
    goto LABEL_62;
  v9 = v7;
  ...
  *(float *)(v9 + 44) = v17 - RightTopEdgePos.fields.y;
  v18 = (ObjectDomain_array *)sub_1B64918(ObjectDomain___TypeInfo, 4LL);
  ...
  v22 = ((__int64 (__fastcall *)(UnityEngine_Texture2D_o *, Il2CppMethodPointer))closedPanelTexture->klass->vtable._6_get_height.method)(
          closedPanelTexture,
          closedPanelTexture->klass->vtable._7_set_height.methodPtr);
  v23 = (Il2CppObject *)sub_1B64ABC(ObjectDomain_TypeInfo);
  v24 = 1 - v21;
  if ( v19 <= 0 )
    v25 = -v19;
  else
...
LABEL_62:
    sub_1B64ACC(v7, v8);
  v7 = sub_1B649AC(v26, v18->obj.klass->_1.element_class);
  if ( !v7 )
    goto LABEL_63;
  if ( !v18->max_length )
    goto LABEL_61;
  v18->m_Items[0] = (ObjectDomain_o *)v26;
  sub_1B64814((ServantStatusBattleListViewItem_o *)v18->m_Items, (int32_t)v26, v29, v30);
  v7 = ((__int64 (__fastcall *)(UnityEngine_Texture2D_o *, Il2CppMethodPointer))closedPanelTexture->klass->vtable._4_get_width.method)(
         closedPanelTexture,
         closedPanelTexture->klass->vtable._5_set_width.methodPtr);
  if ( !*(_DWORD *)(v9 + 24) )
  ...
  v35 = *(float *)(v9 + 40);
  v37 = *(float *)(v9 + 32);
  v38 = (Il2CppObject *)sub_1B64ABC(ObjectDomain_TypeInfo);
  v39 = 1 - v33;
  if ( v32 <= 0 )
    v40 = -v32;
  else
  ...
  *(float *)&v43[1].monitor = v46;
  ...
  v7 = sub_1B649AC(v43, v18->obj.klass->_1.element_class);
  if ( !v7 )
  {
LABEL_63:
    v80 = sub_1B64AF0();
  ...
  if ( v18->max_length <= 1
    || (v18->m_Items[1] = (ObjectDomain_o *)v43,
        sub_1B64814((ServantStatusBattleListViewItem_o *)&v18->m_Items[1], (int32_t)v43, v47, v48),
        v7 = ((__int64 (__fastcall *)(UnityEngine_Texture2D_o *, Il2CppMethodPointer))closedPanelTexture->klass->vtable._4_get_width.method)(
               closedPanelTexture,
               closedPanelTexture->klass->vtable._5_set_width.methodPtr),
        *(_DWORD *)(v9 + 24) <= 2u)
...
LABEL_61:
  ...
  v53 = ((__int64 (__fastcall *)(UnityEngine_Texture2D_o *, Il2CppMethodPointer))closedPanelTexture->klass->vtable._6_get_height.method)(
          closedPanelTexture,
          closedPanelTexture->klass->vtable._7_set_height.methodPtr);
  v54 = (Il2CppObject *)sub_1B64ABC(ObjectDomain_TypeInfo);
  if ( v50 >= 0 )
    v55 = v50;
  else
    v55 = v50 + 1;
  ...
  *((float *)&v57[1].monitor + 1) = (float)v53;
  v7 = sub_1B649AC(v57, v18->obj.klass->_1.element_class);
  if ( !v7 )
    goto LABEL_63;
  if ( v18->max_length <= 2 )
    goto LABEL_61;
  v18->m_Items[2] = (ObjectDomain_o *)v57;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v18->m_Items[2], (int32_t)v57, v60, v61);
  v7 = ((__int64 (__fastcall *)(UnityEngine_Texture2D_o *, Il2CppMethodPointer))closedPanelTexture->klass->vtable._4_get_width.method)(
         closedPanelTexture,
         closedPanelTexture->klass->vtable._5_set_width.methodPtr);
  if ( !*(_DWORD *)(v9 + 24) )
  ...
  v68 = *(float *)(v9 + 40);
  v69 = *(_DWORD *)(v9 + 44);
  v70 = (Il2CppObject *)sub_1B64ABC(ObjectDomain_TypeInfo);
  if ( v63 <= 0 )
    v71 = -v63;
  else
    v71 = 1 - v63;
  ...
  *(float *)&v75[1].monitor = (float)((float)v66 - v67) - v68;
  ...
  v7 = sub_1B649AC(v75, v18->obj.klass->_1.element_class);
  if ( !v7 )
    goto LABEL_63;
  if ( v18->max_length <= 3 )
    goto LABEL_61;
  v18->m_Items[3] = (ObjectDomain_o *)v75;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v18->m_Items[3], (int32_t)v75, v77, v78);
  return v18;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB18E & 1) == 0 )
  {
    positionCalculator = (SubmarinePanelPositionCalculator_o *)sub_1B64870(&ObjectDomain_TypeInfo, closedPanelTexture);
    byte_49FB18E = 1;
  }
  if ( !v3 )
    sub_1B64ACC(positionCalculator, closedPanelTexture);
  ...
  v9 = sub_1B64ABC(ObjectDomain_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  UnityEngine_RenderTexture_o *Temporary_69044160; // x22
  ...
  if ( (byte_49FB192 & 1) == 0 )
  {
    sub_1B64870(&UnityEngine_Graphics_TypeInfo, *(_QWORD *)&resizeWidth);
    sub_1B64870(&UnityEngine_Object_TypeInfo, v7);
    sub_1B64870(&UnityEngine_Texture2D_TypeInfo, v8);
    byte_49FB192 = 1;
  }
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  ...
  {
    Temporary_69044160 = UnityEngine_RenderTexture__GetTemporary_69044160(resizeWidth, resizeHeight, 0, 7, 1, 0LL);
    if ( !UnityEngine_Graphics_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Graphics_TypeInfo);
    UnityEngine_Graphics__Blit((UnityEngine_Texture_o *)baseTexture, Temporary_69044160, 0LL);
    active = UnityEngine_RenderTexture__get_active(0LL);
    UnityEngine_RenderTexture__set_active(Temporary_69044160, 0LL);
    v9 = (UnityEngine_Texture2D_o *)sub_1B64ABC(UnityEngine_Texture2D_TypeInfo);
    UnityEngine_Texture2D___ctor_69024368(v9, resizeWidth, resizeHeight, 0LL);
    if ( !v9 )
      sub_1B64ACC(v12, v13);
    ...
    UnityEngine_Texture2D__ReadPixels_69026452(v9, v15, 0, 0, 0LL);
    UnityEngine_Texture2D__Apply_69026032(v9, 0LL);
    UnityEngine_RenderTexture__set_active(active, 0LL);
    UnityEngine_RenderTexture__ReleaseTemporary(Temporary_69044160, 0LL);
  }
  return v9;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB190 & 1) == 0 )
  {
    objDomain = (ObjectDomain_o *)sub_1B64870(&UnityEngine_Texture2D_TypeInfo, positionCalculator);
    byte_49FB190 = 1;
  }
  if ( !v5 )
    goto LABEL_35;
  ...
  v11 = v8;
  UnityEngine_Texture2D___ctor_69024368(v8, v9, v10, 0LL);
  if ( !closedPanelTexture )
    goto LABEL_35;
  ...
  objDomain = (ObjectDomain_o *)UnityEngine_Texture2D__GetPixels_69023056(closedPanelTexture, v24, v25, v26, v27, 0LL);
  if ( !v11 )
LABEL_35:
    sub_1B64ACC(objDomain, positionCalculator);
  UnityEngine_Texture2D__SetPixels_69025260(v11, (UnityEngine_Color_array *)objDomain, 0LL);
  UnityEngine_Texture2D__Apply_69026032(v11, 0LL);
  return v11;
}