        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC3CE2 & 1) == 0 )
  {
    positionCalculator = (SubmarinePanelPositionCalculator_o *)sub_1C713B0(&ObjectDomain_TypeInfo);
    byte_4CC3CE2 = 1;
  }
  if ( !v3 )
    sub_1C71608(positionCalculator, method);
  v6 = v3->fields._PanelUnitSize_k__BackingField.fields.x;
  v7 = v3->fields._PanelUnitSize_k__BackingField.fields.y;
  v8 = sub_1C715FC(ObjectDomain_TypeInfo);
...
UnityEngine_Texture2D_o *ClosePanelTextureUtil__CreateDarkTexture2D(
        ...
        const MethodInfo *method)
{
  UnityEngine_Color_array *Pixels_71614768; // x0
  __int64 v5; // x1
  ...
  Pixels_71614768 = (UnityEngine_Color_array *)UnityEngine_Object__op_Equality(
                                                 (UnityEngine_Object_o *)baseTexture,
                                                 0,
                                                 0);
  v6 = 0;
  if ( ((unsigned __int8)Pixels_71614768 & 1) == 0 )
  {
    if ( !baseTexture )
      goto LABEL_19;
    Pixels_71614768 = UnityEngine_Texture2D__GetPixels_71614768(baseTexture, 0);
    if ( !Pixels_71614768 )
      goto LABEL_19;
    v7 = Pixels_71614768;
    Pixels_71614768 = (UnityEngine_Color_array *)sub_1C71458(
                                                   UnityEngine_Color___TypeInfo,
                                                   LODWORD(Pixels_71614768->max_length));
    v8 = Pixels_71614768;
    if ( (int)v7->max_length >= 1 )
    {
      if ( !(unsigned int)v7->max_length )
LABEL_15:
        sub_1C71610(Pixels_71614768);
      v9 = 0;
      v10.n64_u64[0] = vdup_lane_s32(v19, 0).n64_u64[0];
      v11 = (unsigned int)v7->max_length - 1LL;
      p_a = &Pixels_71614768->m_Items[0].fields.a;
      v13 = &v7->m_Items[0].fields.a;
      while ( Pixels_71614768 )
      {
        if ( v9 >= LODWORD(Pixels_71614768->max_length) )
          goto LABEL_15;
        v14 = *v13;
...
LABEL_19:
      sub_1C71608(Pixels_71614768, v5);
    }
LABEL_16:
    ...
    v6 = (UnityEngine_Texture2D_o *)sub_1C715FC(UnityEngine_Texture2D_TypeInfo);
    UnityEngine_Texture2D___ctor_71612380(v6, v16, v17, 0);
    if ( !v6 )
      goto LABEL_19;
    UnityEngine_Texture2D__SetPixels_71613272(v6, v8, 0);
    UnityEngine_Texture2D__Apply_71614044(v6, 0);
  }
  return v6;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC3CE4 & 1) == 0 )
  {
    ...
    objDomain = (ObjectDomain_o *)sub_1C713B0(&UnityEngine_Texture2D_TypeInfo);
    byte_4CC3CE4 = 1;
  }
  if ( !v8 )
    goto LABEL_48;
  ...
  v42 = (UnityEngine_Texture2D_o *)sub_1C715FC(UnityEngine_Texture2D_TypeInfo);
  UnityEngine_Texture2D___ctor_71612380(v42, v9, v10, 0);
  ...
  if ( y == INFINITY )
    ...
    v27 = (int)y;
  objDomain = (ObjectDomain_o *)UnityEngine_Texture2D__GetPixels_71614768(closedPanelTexture, 0);
  ...
  if ( !v42 )
LABEL_48:
    sub_1C71608(objDomain, excludePanelUniqueIds);
  UnityEngine_Texture2D__SetPixels_71613272(v42, (UnityEngine_Color_array *)v30, 0);
  UnityEngine_Texture2D__Apply_71614044(v42, 0);
  return v40;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC3CE0 & 1) == 0 )
  {
    sub_1C713B0(&ObjectDomain___TypeInfo);
    sub_1C713B0(&ObjectDomain_TypeInfo);
    sub_1C713B0(&float___TypeInfo);
    byte_4CC3CE0 = 1;
  }
  v5 = sub_1C71458(float___TypeInfo, 4);
  if ( !positionCalculator )
    goto LABEL_62;
  v7 = v5;
  ...
  *(float *)(v7 + 44) = v17 - RightTopEdgePos.fields.y;
  v18 = (ObjectDomain_array *)sub_1C71458(ObjectDomain___TypeInfo, 4);
  ...
  v22 = ((__int64 (__fastcall *)(UnityEngine_Texture2D_o *, const MethodInfo *))closedPanelTexture->klass->vtable._6_get_height.methodPtr)(
          closedPanelTexture,
          closedPanelTexture->klass->vtable._6_get_height.method);
  v23 = (Il2CppObject *)sub_1C715FC(ObjectDomain_TypeInfo);
  v24 = 1 - v21;
  if ( v19 <= 0 )
    v25 = -v19;
  else
...
LABEL_62:
    sub_1C71608(v5, v6);
  v5 = sub_1C714EC(v26, v18->obj.klass->_1.element_class);
  if ( !v5 )
    goto LABEL_63;
  if ( !LODWORD(v18->max_length) )
    goto LABEL_61;
  v18->m_Items[0] = (ObjectDomain_o *)v26;
  sub_1C71354((GrandQuestFolderBoardItem_o *)v18->m_Items, (int32_t)v26, v29, v30, v31, v32, v33, v34);
  v5 = ((__int64 (__fastcall *)(UnityEngine_Texture2D_o *, const MethodInfo *))closedPanelTexture->klass->vtable._4_get_width.methodPtr)(
         closedPanelTexture,
         closedPanelTexture->klass->vtable._4_get_width.method);
  if ( !*(_DWORD *)(v7 + 24) )
  ...
  v39 = *(float *)(v7 + 40);
  v41 = *(float *)(v7 + 32);
  v42 = (Il2CppObject *)sub_1C715FC(ObjectDomain_TypeInfo);
  v43 = 1 - v37;
  if ( v36 <= 0 )
    v44 = -v36;
  else
  ...
  *(float *)&v47[1].monitor = v50;
  ...
  v5 = sub_1C714EC(v47, v18->obj.klass->_1.element_class);
  if ( !v5 )
  {
LABEL_63:
    v96 = sub_1C7162C();
  ...
  if ( LODWORD(v18->max_length) <= 1
    || (v18->m_Items[1] = (ObjectDomain_o *)v47,
        sub_1C71354((GrandQuestFolderBoardItem_o *)&v18->m_Items[1], (int32_t)v47, v51, v52, v53, v54, v55, v56),
        v5 = ((__int64 (__fastcall *)(UnityEngine_Texture2D_o *, const MethodInfo *))closedPanelTexture->klass->vtable._4_get_width.methodPtr)(
               closedPanelTexture,
               closedPanelTexture->klass->vtable._4_get_width.method),
        *(_DWORD *)(v7 + 24) <= 2u)
...
LABEL_61:
  ...
  v61 = ((__int64 (__fastcall *)(UnityEngine_Texture2D_o *, const MethodInfo *))closedPanelTexture->klass->vtable._6_get_height.methodPtr)(
          closedPanelTexture,
          closedPanelTexture->klass->vtable._6_get_height.method);
  v62 = (Il2CppObject *)sub_1C715FC(ObjectDomain_TypeInfo);
  if ( v58 >= 0 )
    v63 = v58;
  else
    v63 = v58 + 1;
  ...
  *((float *)&v65[1].monitor + 1) = (float)v61;
  v5 = sub_1C714EC(v65, v18->obj.klass->_1.element_class);
  if ( !v5 )
    goto LABEL_63;
  if ( LODWORD(v18->max_length) <= 2 )
    goto LABEL_61;
  v18->m_Items[2] = (ObjectDomain_o *)v65;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&v18->m_Items[2], (int32_t)v65, v68, v69, v70, v71, v72, v73);
  v5 = ((__int64 (__fastcall *)(UnityEngine_Texture2D_o *, const MethodInfo *))closedPanelTexture->klass->vtable._4_get_width.methodPtr)(
         closedPanelTexture,
         closedPanelTexture->klass->vtable._4_get_width.method);
  if ( !*(_DWORD *)(v7 + 24) )
  ...
  v80 = *(float *)(v7 + 40);
  v81 = *(_DWORD *)(v7 + 44);
  v82 = (Il2CppObject *)sub_1C715FC(ObjectDomain_TypeInfo);
  if ( v75 <= 0 )
    v83 = -v75;
  else
    v83 = 1 - v75;
  ...
  *(float *)&v87[1].monitor = (float)((float)v78 - v79) - v80;
  ...
  v5 = sub_1C714EC(v87, v18->obj.klass->_1.element_class);
  if ( !v5 )
    goto LABEL_63;
  if ( LODWORD(v18->max_length) <= 3 )
    goto LABEL_61;
  v18->m_Items[3] = (ObjectDomain_o *)v87;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&v18->m_Items[3], (int32_t)v87, v89, v90, v91, v92, v93, v94);
  return v18;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !v3 )
    sub_1C71608(positionCalculator, closedPanelTexture);
  ...
  v9 = sub_1C715FC(ObjectDomain_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  UnityEngine_RenderTexture_o *Temporary_71632240; // x22
  ...
  {
    Temporary_71632240 = UnityEngine_RenderTexture__GetTemporary_71632240(resizeWidth, resizeHeight, 0, 7, 1, 0);
    if ( !UnityEngine_Graphics_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Graphics_TypeInfo);
    UnityEngine_Graphics__Blit((UnityEngine_Texture_o *)baseTexture, Temporary_71632240, 0);
    active = UnityEngine_RenderTexture__get_active(0);
    UnityEngine_RenderTexture__set_active(Temporary_71632240, 0);
    v7 = (UnityEngine_Texture2D_o *)sub_1C715FC(UnityEngine_Texture2D_TypeInfo);
    UnityEngine_Texture2D___ctor_71612380(v7, resizeWidth, resizeHeight, 0);
    if ( !v7 )
      sub_1C71608(v10, v11);
    ...
    UnityEngine_Texture2D__ReadPixels_71614464(v7, v13, 0, 0, 0);
    UnityEngine_Texture2D__Apply_71614044(v7, 0);
    UnityEngine_RenderTexture__set_active(active, 0);
    UnityEngine_RenderTexture__ReleaseTemporary(Temporary_71632240, 0);
  }
  return v7;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( Height_k__BackingField <= 0.0 )
    return 0;
  v8 = (UnityEngine_Texture2D_o *)sub_1C715FC(UnityEngine_Texture2D_TypeInfo);
  ...
  v11 = v8;
  UnityEngine_Texture2D___ctor_71612380(v8, v9, v10, 0);
  if ( !closedPanelTexture )
    goto LABEL_35;
  ...
  objDomain = (ObjectDomain_o *)UnityEngine_Texture2D__GetPixels_71611068(closedPanelTexture, v24, v25, v26, v27, 0);
  if ( !v11 )
LABEL_35:
    sub_1C71608(objDomain, positionCalculator);
  UnityEngine_Texture2D__SetPixels_71613272(v11, (UnityEngine_Color_array *)objDomain, 0);
  UnityEngine_Texture2D__Apply_71614044(v11, 0);
  return v11;
}