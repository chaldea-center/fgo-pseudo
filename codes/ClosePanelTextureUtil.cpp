        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18EC2 & 1) == 0 )
  {
    positionCalculator = (SubmarinePanelPositionCalculator_o *)sub_1BCAFF8(&ObjectDomain_TypeInfo, method);
    byte_4B18EC2 = 1;
  }
  if ( !v3 )
    sub_1BCB254(positionCalculator, method);
  v6 = v3->fields._PanelUnitSize_k__BackingField.fields.x;
  v7 = v3->fields._PanelUnitSize_k__BackingField.fields.y;
  v8 = sub_1BCB244(ObjectDomain_TypeInfo);
        ...
        const MethodInfo *method)
{
  __int64 v4; // x1
  __int64 v5; // x1
  UnityEngine_Color_array *Pixels_70026868; // x0
  __int64 v7; // x1
  ...
  Pixels_70026868 = (UnityEngine_Color_array *)UnityEngine_Object__op_Equality(
                                                 (UnityEngine_Object_o *)baseTexture,
                                                 0LL,
                                                 0LL);
  v8 = 0LL;
  if ( ((unsigned __int8)Pixels_70026868 & 1) == 0 )
  {
    if ( !baseTexture )
      goto LABEL_19;
    Pixels_70026868 = UnityEngine_Texture2D__GetPixels_70026868(baseTexture, 0LL);
    if ( !Pixels_70026868 )
      goto LABEL_19;
    v9 = Pixels_70026868;
    Pixels_70026868 = (UnityEngine_Color_array *)sub_1BCB0A0(UnityEngine_Color___TypeInfo, Pixels_70026868->max_length);
    v11 = Pixels_70026868;
    if ( (int)*(_QWORD *)&v9->max_length >= 1 )
    {
      if ( !(unsigned int)*(_QWORD *)&v9->max_length )
LABEL_15:
        sub_1BCB25C(Pixels_70026868, v7, v10);
      v12 = 0LL;
      v13.n64_u64[0] = vdup_lane_s32(v22, 0).n64_u64[0];
      v14 = (unsigned int)*(_QWORD *)&v9->max_length - 1LL;
      p_r = &Pixels_70026868->m_Items[1].fields.r;
      v16 = &v9->m_Items[1].fields.r;
      while ( Pixels_70026868 )
      {
        if ( v12 >= Pixels_70026868->max_length )
          goto LABEL_15;
        v17 = *v16;
...
LABEL_19:
      sub_1BCB254(Pixels_70026868, v7);
    }
LABEL_16:
    ...
    v8 = (UnityEngine_Texture2D_o *)sub_1BCB244(UnityEngine_Texture2D_TypeInfo);
    UnityEngine_Texture2D___ctor_70024480(v8, v19, v20, 0LL);
    if ( !v8 )
      goto LABEL_19;
    UnityEngine_Texture2D__SetPixels_70025372(v8, v11, 0LL);
    UnityEngine_Texture2D__Apply_70026144(v8, 0LL);
  }
  return v8;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18EC4 & 1) == 0 )
  {
    sub_1BCAFF8(&PanelUniqueIDUtil_TypeInfo, excludePanelUniqueIds);
    objDomain = (ObjectDomain_o *)sub_1BCAFF8(&UnityEngine_Texture2D_TypeInfo, v9);
    byte_4B18EC4 = 1;
  }
  if ( !v8 )
    goto LABEL_48;
  ...
  v44 = (UnityEngine_Texture2D_o *)sub_1BCB244(UnityEngine_Texture2D_TypeInfo);
  UnityEngine_Texture2D___ctor_70024480(v44, v10, v11, 0LL);
  ...
  if ( y == INFINITY )
    ...
    v28 = (int)y;
  objDomain = (ObjectDomain_o *)UnityEngine_Texture2D__GetPixels_70026868(closedPanelTexture, 0LL);
              ...
              if ( v28 >= 1 )
              {
                ...
                do
                {
                  if ( v40 >= v31->max_length )
                    sub_1BCB25C(objDomain, excludePanelUniqueIds, v36);
                  v41 = &v31->obj + (int)v40;
                  --v39;
                  v40 += v26;
                  v41[2].klass = 0LL;
  ...
  if ( !v44 )
LABEL_48:
    sub_1BCB254(objDomain, excludePanelUniqueIds);
  UnityEngine_Texture2D__SetPixels_70025372(v44, v31, 0LL);
  UnityEngine_Texture2D__Apply_70026144(v44, 0LL);
  return v42;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18EC0 & 1) == 0 )
  {
    sub_1BCAFF8(&ObjectDomain___TypeInfo, closedPanelTexture);
    sub_1BCAFF8(&ObjectDomain_TypeInfo, v5);
    sub_1BCAFF8(&float___TypeInfo, v6);
    byte_4B18EC0 = 1;
  }
  v7 = sub_1BCB0A0(float___TypeInfo, 4LL);
  if ( !positionCalculator )
    goto LABEL_62;
  v9 = v7;
  ...
  *(float *)(v9 + 44) = v18 - RightTopEdgePos.fields.y;
  v19 = (ObjectDomain_array *)sub_1BCB0A0(ObjectDomain___TypeInfo, 4LL);
  ...
  v23 = ((__int64 (__fastcall *)(UnityEngine_Texture2D_o *, Il2CppMethodPointer))closedPanelTexture->klass->vtable._6_get_height.method)(
          closedPanelTexture,
          closedPanelTexture->klass->vtable._7_set_height.methodPtr);
  v24 = (Il2CppObject *)sub_1BCB244(ObjectDomain_TypeInfo);
  v25 = 1 - v22;
  if ( v20 <= 0 )
    v26 = -v20;
  else
...
LABEL_62:
    sub_1BCB254(v7, v8);
  v7 = sub_1BCB134(v27, v19->obj.klass->_1.element_class);
  if ( !v7 )
    goto LABEL_63;
  if ( !v19->max_length )
    goto LABEL_61;
  v19->m_Items[0] = (ObjectDomain_o *)v27;
  sub_1BCAF9C((CGThumbnailListItem_o *)v19->m_Items, (int32_t)v27, v12, v30);
  v7 = ((__int64 (__fastcall *)(UnityEngine_Texture2D_o *, Il2CppMethodPointer))closedPanelTexture->klass->vtable._4_get_width.method)(
         closedPanelTexture,
         closedPanelTexture->klass->vtable._5_set_width.methodPtr);
  if ( !*(_DWORD *)(v9 + 24) )
  ...
  v35 = *(float *)(v9 + 40);
  v37 = *(float *)(v9 + 32);
  v38 = (Il2CppObject *)sub_1BCB244(ObjectDomain_TypeInfo);
  v39 = 1 - v33;
  if ( v32 <= 0 )
    v40 = -v32;
  else
  ...
  *(float *)&v43[1].monitor = v46;
  ...
  v7 = sub_1BCB134(v43, v19->obj.klass->_1.element_class);
  if ( !v7 )
  {
LABEL_63:
    v77 = sub_1BCB278();
  ...
  if ( v19->max_length <= 1
    || (v19->m_Items[1] = (ObjectDomain_o *)v43,
        sub_1BCAF9C((CGThumbnailListItem_o *)&v19->m_Items[1], (int32_t)v43, v12, v47),
        v7 = ((__int64 (__fastcall *)(UnityEngine_Texture2D_o *, Il2CppMethodPointer))closedPanelTexture->klass->vtable._4_get_width.method)(
               closedPanelTexture,
               closedPanelTexture->klass->vtable._5_set_width.methodPtr),
        *(_DWORD *)(v9 + 24) <= 2u)
...
LABEL_61:
  ...
  v52 = ((__int64 (__fastcall *)(UnityEngine_Texture2D_o *, Il2CppMethodPointer))closedPanelTexture->klass->vtable._6_get_height.method)(
          closedPanelTexture,
          closedPanelTexture->klass->vtable._7_set_height.methodPtr);
  v53 = (Il2CppObject *)sub_1BCB244(ObjectDomain_TypeInfo);
  if ( v49 >= 0 )
    v54 = v49;
  else
    v54 = v49 + 1;
  ...
  *((float *)&v56[1].monitor + 1) = (float)v52;
  v7 = sub_1BCB134(v56, v19->obj.klass->_1.element_class);
  if ( !v7 )
    goto LABEL_63;
  if ( v19->max_length <= 2 )
    goto LABEL_61;
  v19->m_Items[2] = (ObjectDomain_o *)v56;
  sub_1BCAF9C((CGThumbnailListItem_o *)&v19->m_Items[2], (int32_t)v56, v12, v59);
  v7 = ((__int64 (__fastcall *)(UnityEngine_Texture2D_o *, Il2CppMethodPointer))closedPanelTexture->klass->vtable._4_get_width.method)(
         closedPanelTexture,
         closedPanelTexture->klass->vtable._5_set_width.methodPtr);
  if ( !*(_DWORD *)(v9 + 24) )
  ...
  v66 = *(float *)(v9 + 40);
  v67 = *(_DWORD *)(v9 + 44);
  v68 = (Il2CppObject *)sub_1BCB244(ObjectDomain_TypeInfo);
  if ( v61 <= 0 )
    v69 = -v61;
  else
    v69 = 1 - v61;
  ...
  *(float *)&v73[1].monitor = (float)((float)v64 - v65) - v66;
  ...
  v7 = sub_1BCB134(v73, v19->obj.klass->_1.element_class);
  if ( !v7 )
    goto LABEL_63;
  if ( v19->max_length <= 3 )
    goto LABEL_61;
  v19->m_Items[3] = (ObjectDomain_o *)v73;
  sub_1BCAF9C((CGThumbnailListItem_o *)&v19->m_Items[3], (int32_t)v73, v12, v75);
  return v19;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18EC1 & 1) == 0 )
  {
    positionCalculator = (SubmarinePanelPositionCalculator_o *)sub_1BCAFF8(&ObjectDomain_TypeInfo, closedPanelTexture);
    byte_4B18EC1 = 1;
  }
  if ( !v3 )
    sub_1BCB254(positionCalculator, closedPanelTexture);
  ...
  v9 = sub_1BCB244(ObjectDomain_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  UnityEngine_RenderTexture_o *Temporary_70044340; // x22
  ...
  if ( (byte_4B18EC5 & 1) == 0 )
  {
    sub_1BCAFF8(&UnityEngine_Graphics_TypeInfo, *(_QWORD *)&resizeWidth);
    sub_1BCAFF8(&UnityEngine_Object_TypeInfo, v7);
    sub_1BCAFF8(&UnityEngine_Texture2D_TypeInfo, v8);
    byte_4B18EC5 = 1;
  }
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  ...
  {
    Temporary_70044340 = UnityEngine_RenderTexture__GetTemporary_70044340(resizeWidth, resizeHeight, 0, 7, 1, 0LL);
    if ( !UnityEngine_Graphics_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Graphics_TypeInfo);
    UnityEngine_Graphics__Blit((UnityEngine_Texture_o *)baseTexture, Temporary_70044340, 0LL);
    active = UnityEngine_RenderTexture__get_active(0LL);
    UnityEngine_RenderTexture__set_active(Temporary_70044340, 0LL);
    v9 = (UnityEngine_Texture2D_o *)sub_1BCB244(UnityEngine_Texture2D_TypeInfo);
    UnityEngine_Texture2D___ctor_70024480(v9, resizeWidth, resizeHeight, 0LL);
    if ( !v9 )
      sub_1BCB254(v12, v13);
    ...
    UnityEngine_Texture2D__ReadPixels_70026564(v9, v15, 0, 0, 0LL);
    UnityEngine_Texture2D__Apply_70026144(v9, 0LL);
    UnityEngine_RenderTexture__set_active(active, 0LL);
    UnityEngine_RenderTexture__ReleaseTemporary(Temporary_70044340, 0LL);
  }
  return v9;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18EC3 & 1) == 0 )
  {
    objDomain = (ObjectDomain_o *)sub_1BCAFF8(&UnityEngine_Texture2D_TypeInfo, positionCalculator);
    byte_4B18EC3 = 1;
  }
  if ( !v5 )
    goto LABEL_35;
  ...
  v11 = v8;
  UnityEngine_Texture2D___ctor_70024480(v8, v9, v10, 0LL);
  if ( !closedPanelTexture )
    goto LABEL_35;
  ...
  objDomain = (ObjectDomain_o *)UnityEngine_Texture2D__GetPixels_70023168(closedPanelTexture, v24, v25, v26, v27, 0LL);
  if ( !v11 )
LABEL_35:
    sub_1BCB254(objDomain, positionCalculator);
  UnityEngine_Texture2D__SetPixels_70025372(v11, (UnityEngine_Color_array *)objDomain, 0LL);
  UnityEngine_Texture2D__Apply_70026144(v11, 0LL);
  return v11;
}