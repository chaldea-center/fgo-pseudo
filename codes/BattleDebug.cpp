void __fastcall BattleDebug___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_42AEC79 & 1) == 0 )
  {
    sub_B52984(&BattleDebug_TypeInfo);
...
void __fastcall BattleDebug__CheckNull(System_String_o *errorText, Il2CppObject *obj, const MethodInfo *method)
{
  ...
  if ( !obj )
  {
    v4 = sub_B52988(&System_Exception_TypeInfo);
    v5 = (System_Exception_o *)sub_B52A54(v4);
    System_Exception___ctor_16214224(v5, errorText, 0LL);
    v6 = sub_B52988(&Method_BattleDebug_CheckNull__);
    sub_B52A28(v5, v6);
  }
}
...
void __fastcall BattleDebug__Log_22961768(
        ...
        const MethodInfo *method)
{
  ...
  if ( exception )
  {
    ...
    v8 = (System_String_o *)sub_B52988(&StringLiteral_9115/*"Message:\n{0}\nStackTrace:\n{1}\n"*/);
    v4 = System_String__Format_44563852(v8, v6, v7, 0LL);
  }
  else
  {
    v4 = (System_String_o *)sub_B52988(&StringLiteral_1/*""*/);
  }
  v9 = v4;
  v10 = (System_String_o *)sub_B52988(&StringLiteral_26/*"\n"*/);
  v11 = System_String__Concat_44570600(errorText, v10, v9, 0LL);
  v12 = sub_B52988(&System_Exception_TypeInfo);
  v13 = (System_Exception_o *)sub_B52A54(v12);
  System_Exception___ctor_16214224(v13, v11, 0LL);
  v14 = sub_B52988(&Method_BattleDebug_OutputError__);
  sub_B52A28(v13, v14);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AEC78 & 1) == 0 )
  {
    sub_B52984(&Method_System_Array_FindAll_string___);
    sub_B52984(&BattleDebug_TypeInfo);
    sub_B52984(&Method_System_Predicate_string___ctor__);
    sub_B52984(&System_Predicate_string__TypeInfo);
    sub_B52984(&Method_System_Collections_Generic_Queue_string__ToArray__);
    sub_B52984(&Method_BattleDebug___c__DisplayClass7_0__getLoglist_b__0__);
    sub_B52984(&Method_BattleDebug___c__DisplayClass7_0__getLoglist_b__1__);
    sub_B52984(&BattleDebug___c__DisplayClass7_0_TypeInfo);
    sub_B52984(&StringLiteral_1/*""*/);
    byte_42AEC78 = 1;
  }
  v7 = sub_B52A54(BattleDebug___c__DisplayClass7_0_TypeInfo);
  BattleDebug___c__DisplayClass7_0___ctor((BattleDebug___c__DisplayClass7_0_o *)v7, 0LL);
  if ( !v7 )
    goto LABEL_14;
  *(_QWORD *)(v7 + 24) = serchText;
  *(_DWORD *)(v7 + 16) = tag;
  sub_B52920((BattleServantConfConponent_o *)(v7 + 24), (System_Int32_array **)serchText, v10, v11, v12, v13, v14, v15);
  ...
  logQueue = (System_Collections_Generic_Queue_string__o *)System_Collections_Generic_Queue_string___ToArray(
                                                             logQueue,
                                                             (const MethodInfo_28DE44C *)Method_System_Collections_Generic_Queue_string__ToArray__);
  v17 = (BattleBuffData_BuffData_array *)logQueue;
  if ( *(_DWORD *)(v7 + 16) )
  {
    v18 = (System_Predicate_peRenderTexture_ChangeLayerObject__o *)sub_B52A54(System_Predicate_string__TypeInfo);
    ...
    logQueue = (System_Collections_Generic_Queue_string__o *)System_Array__FindAll_BattleBuffData_BuffData_(
                                                               ...
                                                               (const MethodInfo_201AB88 *)Method_System_Array_FindAll_string___);
    v17 = (BattleBuffData_BuffData_array *)logQueue;
  }
  if ( !*(_QWORD *)(v7 + 24) )
LABEL_14:
    sub_B52A5C(logQueue, v9);
  v19 = (System_Predicate_peRenderTexture_ChangeLayerObject__o *)sub_B52A54(System_Predicate_string__TypeInfo);
  System_Predicate_peRenderTexture_ChangeLayerObject____ctor(
    v19,
    (Il2CppObject *)v7,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AF129 & 1) == 0 )
  {
    sub_B52984(&BattleDebug_TAG_TypeInfo);
    sub_B52984(&StringLiteral_1520/*"<{0}>"*/);
    byte_42AF129 = 1;
  }
  p_fields = &this->fields;
  v6 = (System_String_o *)j_il2cpp_value_box_0(BattleDebug_TAG_TypeInfo, p_fields);
  if ( !v6
    || (v8 = v6,
        ...
        v6 = System_String__Format((System_String_o *)StringLiteral_1520/*"<{0}>"*/, v9, 0LL),
        !s) )
  {
    sub_B52A5C(v6, v7);
  }
  return System_String__IndexOf_44640664(s, v6, 0LL) >= 0;
}
        ...
        const MethodInfo *method)
{
  ...
  v5 = System_String__Format((System_String_o *)StringLiteral_23732/*"{0}"*/, (Il2CppObject *)this->fields.serchText, 0LL);
  if ( !s )
    sub_B52A5C(v5, v6);
  return System_String__IndexOf_44640664(s, v5, 0LL) >= 0;
}