void __fastcall UserEventExpeditionMaster___ctor(UserEventExpeditionMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4BDD1FE & 1) == 0 )
  {
    sub_1C21E38(&Method_DataMasterBase_UserEventExpeditionMaster__UserEventExpeditionEntity__string___ctor__);
    byte_4BDD1FE = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    383,
    (const MethodInfo_325E55C *)Method_DataMasterBase_UserEventExpeditionMaster__UserEventExpeditionEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDD203 & 1) == 0 )
  {
    sub_1C21E38(&Method_System_Collections_ObjectModel_Collection_UserEventExpeditionEntity__get_Count__);
    sub_1C21E38(&Method_System_Collections_ObjectModel_Collection_UserEventExpeditionEntity__get_Item__);
    sub_1C21E38(&Method_System_Collections_Generic_List_ExpeditionInfo__Add__);
    sub_1C21E38(&Method_System_Collections_Generic_List_ExpeditionInfo___ctor__);
    sub_1C21E38(&System_Collections_Generic_List_ExpeditionInfo__TypeInfo);
  ...
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            list,
            (const MethodInfo_31F60CC *)Method_System_Collections_ObjectModel_Collection_UserEventExpeditionEntity__get_Count__);
  v7 = (System_Collections_Generic_List_object__o *)sub_1C22084(System_Collections_Generic_List_ExpeditionInfo__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v7,
    (const MethodInfo_364E880 *)Method_System_Collections_Generic_List_ExpeditionInfo___ctor__);
  if ( Count >= 1 )
  {
    v8 = 0;
    while ( 1 )
    {
      ...
      Item = System_Collections_ObjectModel_Collection_object___get_Item(
               list,
               v8,
               (const MethodInfo_31F615C *)Method_System_Collections_ObjectModel_Collection_UserEventExpeditionEntity__get_Item__);
      if ( Item )
      {
        v10 = Item;
    ...
    if ( namespaze >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( *(_DWORD *)(v15 + 20) )
        {
          ...
          RestTime = LocalizationManager__GetRestTime(v16, 0LL);
          ...
          if ( !RestTime )
            goto LABEL_35;
          list = (System_Collections_ObjectModel_Collection_T__o *)System_String__Equals_63123792(
                                                                     RestTime,
          ...
          if ( ((unsigned __int8)list & 1) != 0 )
          {
            ...
            else
            {
              ...
              sub_1C21DDC((PartyOrganizationUtility_o *)(v27 + 4), v15, v18, v19, v20, v21, v22, v23);
            }
          }
        }
        namespaze = (int)klass->_1.namespaze;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDD1FF & 1) == 0 )
  {
    sub_1C21E38(&Method_DataMasterBase_UserEventExpeditionMaster__UserEventExpeditionEntity__string__GetEntity__);
    byte_4BDD1FF = 1;
  }
  ...
  return (UserEventExpeditionEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                          (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                          PK,
                                          (const MethodInfo_3260880 *)Method_DataMasterBase_UserEventExpeditionMaster__UserEventExpeditionEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDD201 & 1) == 0 )
  {
    sub_1C21E38(&Method_System_Linq_Enumerable_Select_UserEventExpeditionEntity__UserEventExpeditionEntity___);
    sub_1C21E38(&Method_System_Linq_Enumerable_ToList_UserEventExpeditionEntity___);
    sub_1C21E38(&System_Func_UserEventExpeditionEntity__UserEventExpeditionEntity__TypeInfo);
    sub_1C21E38(&Method_UserEventExpeditionMaster___c__GetEntityList_b__3_0__);
    sub_1C21E38(&UserEventExpeditionMaster___c_TypeInfo);
    byte_4BDD201 = 1;
  }
  ...
  if ( !_9__3_0 )
  {
    ...
    _9__3_0 = (System_Func_object__object__o *)sub_1C22084(System_Func_UserEventExpeditionEntity__UserEventExpeditionEntity__TypeInfo);
  ...
  v14 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_object__object_(
                                                               ...
                                                               (const MethodInfo_2FE15B8 *)Method_System_Linq_Enumerable_Select_UserEventExpeditionEntity__UserEventExpeditionEntity___);
  return (System_Collections_Generic_List_UserEventExpeditionEntity__o *)System_Linq_Enumerable__ToList_object_(
                                                                           v14,
                                                                           (const MethodInfo_2FED5C8 *)Method_System_Linq_Enumerable_ToList_UserEventExpeditionEntity___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( Count >= 1 )
  {
    ...
    if ( !klass )
LABEL_27:
      sub_1C22094(result, *(_QWORD *)&eventId);
    namespaze = (int)klass->_1.namespaze;
    if ( namespaze >= 1 )
    {
      v15 = 0;
      ...
      {
        if ( namespaze == v15 )
          sub_1C2209C(result, *(_QWORD *)&eventId);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDD200 & 1) == 0 )
  {
    sub_1C21E38(&Method_DataMasterBase_UserEventExpeditionMaster__UserEventExpeditionEntity__string__TryGetEntity__);
    byte_4BDD200 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_32608CC *)Method_DataMasterBase_UserEventExpeditionMaster__UserEventExpeditionEntity__string__TryGetEntity__);
}
...
void __fastcall UserEventExpeditionMaster___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C22084(UserEventExpeditionMaster___c_TypeInfo);
