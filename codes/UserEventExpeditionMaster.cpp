void __fastcall UserEventExpeditionMaster___ctor(UserEventExpeditionMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4B457F8 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataMasterBase_UserEventExpeditionMaster__UserEventExpeditionEntity__string___ctor__, method);
    byte_4B457F8 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    385,
    (const MethodInfo_32E45D0 *)Method_DataMasterBase_UserEventExpeditionMaster__UserEventExpeditionEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B457FD & 1) == 0 )
  {
    sub_1BDB878(
      ...
      *(_QWORD *)&eventId);
    sub_1BDB878(&Method_System_Collections_ObjectModel_Collection_UserEventExpeditionEntity__get_Item__, v5);
    sub_1BDB878(&Method_System_Collections_Generic_List_ExpeditionInfo__Add__, v6);
    sub_1BDB878(&Method_System_Collections_Generic_List_ExpeditionInfo___ctor__, v7);
    sub_1BDB878(&System_Collections_Generic_List_ExpeditionInfo__TypeInfo, v8);
    sub_1BDB878(&LocalizationManager_TypeInfo, v9);
    sub_1BDB878(&NetworkManager_TypeInfo, v10);
    sub_1BDB878(&StringLiteral_13410/*"TIME_REST_TIMEOVER"*/, v11);
    byte_4B457FD = 1;
  }
  ...
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            list,
            (const MethodInfo_327D624 *)Method_System_Collections_ObjectModel_Collection_UserEventExpeditionEntity__get_Count__);
  v14 = (System_Collections_Generic_List_object__o *)sub_1BDBAC4(System_Collections_Generic_List_ExpeditionInfo__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v14,
    (const MethodInfo_36D5590 *)Method_System_Collections_Generic_List_ExpeditionInfo___ctor__);
  if ( Count >= 1 )
  {
    v15 = 0;
    while ( 1 )
    {
      ...
      Item = System_Collections_ObjectModel_Collection_object___get_Item(
               list,
               v15,
               (const MethodInfo_327D6B4 *)Method_System_Collections_ObjectModel_Collection_UserEventExpeditionEntity__get_Item__);
      if ( Item )
      {
        v18 = Item;
...
LABEL_35:
    ...
    if ( namespaze >= 1 )
    {
      ...
      {
        if ( v22 >= namespaze )
          sub_1BDBADC(list, *(_QWORD *)&eventId, v17);
        ...
        if ( *(_DWORD *)(v23 + 20) )
        {
          ...
          if ( !RestTime )
            goto LABEL_35;
          list = (System_Collections_ObjectModel_Collection_T__o *)System_String__Equals_62607564(
                                                                     RestTime,
          ...
          if ( ((unsigned __int8)list & 1) != 0 )
          {
            ...
            else
            {
              ...
              sub_1BDB81C((CGThumbnailListItem_o *)(v30 + 4), v23, v17, v26);
            }
          }
        }
        namespaze = (int)klass->_1.namespaze;
        ...
        const MethodInfo *method)
{
  ...
  return (UserEventExpeditionEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                          (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                          PK,
                                          (const MethodInfo_32E68F4 *)Method_DataMasterBase_UserEventExpeditionMaster__UserEventExpeditionEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B457FB & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Linq_Enumerable_Select_UserEventExpeditionEntity__UserEventExpeditionEntity___, method);
    sub_1BDB878(&Method_System_Linq_Enumerable_ToList_UserEventExpeditionEntity___, v3);
    sub_1BDB878(&System_Func_UserEventExpeditionEntity__UserEventExpeditionEntity__TypeInfo, v4);
    sub_1BDB878(&Method_UserEventExpeditionMaster___c__GetEntityList_b__3_0__, v5);
    sub_1BDB878(&UserEventExpeditionMaster___c_TypeInfo, v6);
    byte_4B457FB = 1;
  }
  ...
  if ( !_9__3_0 )
  {
    ...
    _9__3_0 = (System_Func_object__object__o *)sub_1BDBAC4(System_Func_UserEventExpeditionEntity__UserEventExpeditionEntity__TypeInfo);
  ...
  v14 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_object__object_(
                                                               ...
                                                               (const MethodInfo_3068484 *)Method_System_Linq_Enumerable_Select_UserEventExpeditionEntity__UserEventExpeditionEntity___);
  return (System_Collections_Generic_List_UserEventExpeditionEntity__o *)System_Linq_Enumerable__ToList_object_(
                                                                           v14,
                                                                           (const MethodInfo_307503C *)Method_System_Linq_Enumerable_ToList_UserEventExpeditionEntity___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B457FC & 1) == 0 )
  {
    sub_1BDB878(
      &Method_System_Collections_ObjectModel_Collection_UserEventExpeditionEntity__get_Count__,
      *(_QWORD *)&eventId);
    sub_1BDB878(&Method_System_Collections_ObjectModel_Collection_UserEventExpeditionEntity__get_Item__, v7);
...
LABEL_27:
    ...
    if ( namespaze >= 1 )
    {
      ...
      {
        if ( namespaze == v18 )
          sub_1BDBADC(result, *(_QWORD *)&eventId, v14);
        ...
        const MethodInfo *method)
{
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_32E6940 *)Method_DataMasterBase_UserEventExpeditionMaster__UserEventExpeditionEntity__string__TryGetEntity__);
}
...
void __fastcall UserEventExpeditionMaster___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B457FE & 1) == 0 )
  {
    sub_1BDB878(&UserEventExpeditionMaster___c_TypeInfo, v1);
    byte_4B457FE = 1;
  }
  v2 = (Il2CppObject *)sub_1BDBAC4(UserEventExpeditionMaster___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  UserEventExpeditionMaster___c_TypeInfo->static_fields->__9 = (struct UserEventExpeditionMaster___c_o *)v2;
  sub_1BDB81C((CGThumbnailListItem_o *)UserEventExpeditionMaster___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
