void __fastcall CharaGraphListMenuBase___ctor(CharaGraphListMenuBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5A4FF & 1) == 0 )
  {
    ...
    sub_1B885B0(&CharaGraphDefine_CharaGraphRootInfo_TypeInfo);
    byte_4A5A4FF = 1;
  }
  v3 = (CharaGraphDefine_CharaGraphRootInfo_o *)sub_1B887FC(CharaGraphDefine_CharaGraphRootInfo_TypeInfo);
  CharaGraphDefine_CharaGraphRootInfo___ctor(v3, 0LL);
  this->fields._RootInfo_k__BackingField = v3;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields._RootInfo_k__BackingField, (int32_t)v3, v4, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( item )
  {
    ...
    *svtItem = (CharaGraphServantListViewItem_o *)v8;
    v12 = LOBYTE(CharaGraphServantListViewItem_TypeInfo->vtable._0_Equals.methodPtr);
    if ( LOBYTE(item->klass->vtable._0_Equals.methodPtr) >= (unsigned int)v12 )
    {
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)svtItem, v13, (int32_t)commandCodeItem, (int32_t)method);
    v14 = LOBYTE(CharaGraphCommandCodeListViewItem_TypeInfo->vtable._0_Equals.methodPtr);
    if ( LOBYTE(item->klass->vtable._0_Equals.methodPtr) >= (unsigned int)v14 )
    {
    ...
    *commandCodeItem = (CharaGraphCommandCodeListViewItem_o *)v15;
    v16 = LOBYTE(CharaGraphCommandCodeListViewItem_TypeInfo->vtable._0_Equals.methodPtr);
    if ( LOBYTE(item->klass->vtable._0_Equals.methodPtr) >= (unsigned int)v16 )
    {
  ...
  {
    *svtItem = 0LL;
    sub_1B88554((ServantStatusBattleListViewItem_o *)svtItem, 0, (int32_t)commandCodeItem, (int32_t)method);
    v11 = 0;
    *commandCodeItem = 0LL;
  }
  sub_1B88554((ServantStatusBattleListViewItem_o *)commandCodeItem, v11, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A4E1 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_CharaGraphListMenuBase_EndClose__);
    byte_4A5A4E1 = 1;
  }
  ...
  System_Action___ctor(v10, (Il2CppObject *)this, Method_CharaGraphListMenuBase_EndClose__, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A4E4 & 1) == 0 )
  {
    sub_1B885B0(&CharaGraphListViewPatternCommandCode_TypeInfo);
    sub_1B885B0(&CharaGraphListViewPatternServantCollection_TypeInfo);
    sub_1B885B0(&CharaGraphListViewPatternServantEquip_TypeInfo);
    sub_1B885B0(&CharaGraphListViewPatternServant_TypeInfo);
    byte_4A5A4E4 = 1;
  }
  if ( (unsigned int)(kind - 1) > 2 )
    v7 = &CharaGraphListViewPatternServant_TypeInfo;
  else
    v7 = (CharaGraphListViewPatternServant_c **)off_44AEC40[kind - 1];
  v8 = sub_1B887FC(*v7);
  ...
  if ( !SortOwner_k__BackingField
    || (kind == 3
      ...
      : (p_ServantCollectionSortManageUnit_k__BackingField = (CharaGraphSortOwnerBase_Fields *)&SortOwner_k__BackingField->fields._ServantEquipSortManageUnit_k__BackingField),
        ...
        !v8) )
  {
    sub_1B8880C(SortOwner_k__BackingField, v9);
  }
  v17 = this->fields._SortOwner_k__BackingField;
  *(_QWORD *)(v8 + 16) = v17;
  sub_1B88554((ServantStatusBattleListViewItem_o *)(v8 + 16), (int32_t)v17, v15, v16);
  RootInfo_k__BackingField = this->fields._RootInfo_k__BackingField;
  *(_QWORD *)(v8 + 24) = RootInfo_k__BackingField;
  sub_1B88554((ServantStatusBattleListViewItem_o *)(v8 + 24), (int32_t)RootInfo_k__BackingField, v19, v20);
  *(_QWORD *)(v8 + 32) = setupInfo;
  sub_1B88554((ServantStatusBattleListViewItem_o *)(v8 + 32), (int32_t)setupInfo, v21, v22);
...
void __fastcall CharaGraphListMenuBase__EndClose(CharaGraphListMenuBase_o *this, const MethodInfo *method)
{
  ...
  if ( callbackOnClose )
  {
    ...
    sub_1B88554(p_callbackOnClose, 0, v3, v4);
...
void __fastcall CharaGraphListMenuBase__Exit(CharaGraphListMenuBase_o *this, int32_t result, const MethodInfo *method)
{
  ...
  if ( (byte_4A5A4E2 & 1) == 0 )
  {
    sub_1B885B0(&CharaGraphListMenuBase_RequestCallbackFunc_TypeInfo);
    sub_1B885B0(&Method_CharaGraphListMenuBase___c__DisplayClass38_0__Exit_g__OnEnd_0__);
    sub_1B885B0(&CharaGraphListMenuBase___c__DisplayClass38_0_TypeInfo);
    byte_4A5A4E2 = 1;
  }
  v5 = sub_1B887FC(CharaGraphListMenuBase___c__DisplayClass38_0_TypeInfo);
  ...
  *(_DWORD *)(v5 + 24) = result;
  v10 = (CharaGraphListMenuBase_RequestCallbackFunc_o *)sub_1B887FC(CharaGraphListMenuBase_RequestCallbackFunc_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  return (System_String_o *)StringLiteral_11626/*"SERVANT_LIST_EXPLANATION_STATUS"*/;
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B8880C(listViewManager, *(_QWORD *)&defaultTabKind);
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B8880C(listViewManager, isNeedSort);
  }
...
void __fastcall CharaGraphListMenuBase__OnClickFilterKind(CharaGraphListMenuBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5A4EE & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_CharaGraphListMenuBase__OnClickFilterKind_b__54_0__);
    byte_4A5A4EE = 1;
  }
  if ( this->fields.state == 2 )
  {
    listViewManager = this->fields.listViewManager;
    v4 = (System_Action_bool__o *)sub_1B887FC(System_Action_bool__TypeInfo);
...
void __fastcall CharaGraphListMenuBase__OnClickScaleChange(CharaGraphListMenuBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5A4EC & 1) == 0 )
  {
    sub_1B885B0(&Method_CharaGraphListMenuBase_OnClickScaleChange__);
    sub_1B885B0(&UnityEngine_Object_TypeInfo);
    byte_4A5A4EC = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CharaGraphListMenuBase_OnClickScaleChange__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B885C8(Method_CharaGraphListMenuBase_OnClickScaleChange__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A4EB & 1) == 0 )
  {
    this = (CharaGraphListMenuBase_o *)sub_1B885B0(&Method_CharaGraphListMenuBase_OnClickTab__);
    byte_4A5A4EB = 1;
  }
  if ( v4->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CharaGraphListMenuBase_OnClickTab__ + 83) & 2) != 0 )
      v8 = (_QWORD *)sub_1B885C8(Method_CharaGraphListMenuBase_OnClickTab__);
    ...
    if ( !RootInfo_k__BackingField )
LABEL_16:
      sub_1B8880C(this, finishCallback);
...
void __fastcall CharaGraphListMenuBase__OnClickTabCommandCode(CharaGraphListMenuBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5A4EA & 1) == 0 )
  {
    sub_1B885B0(&Method_CharaGraphListMenuBase__OnClickTabCommandCode_b__46_0__);
    sub_1B885B0(&CharaGraphListMenuBase_RequestCallbackFunc_TypeInfo);
    byte_4A5A4EA = 1;
  }
  v3 = (CharaGraphListMenuBase_RequestCallbackFunc_o *)sub_1B887FC(CharaGraphListMenuBase_RequestCallbackFunc_TypeInfo);
  CharaGraphListMenuBase_RequestCallbackFunc___ctor(
    v3,
    (Il2CppObject *)this,
...
void __fastcall CharaGraphListMenuBase__OnClickTabServant(CharaGraphListMenuBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5A4E8 & 1) == 0 )
  {
    sub_1B885B0(&Method_CharaGraphListMenuBase__OnClickTabServant_b__44_0__);
    sub_1B885B0(&CharaGraphListMenuBase_RequestCallbackFunc_TypeInfo);
    byte_4A5A4E8 = 1;
  }
  v3 = (CharaGraphListMenuBase_RequestCallbackFunc_o *)sub_1B887FC(CharaGraphListMenuBase_RequestCallbackFunc_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A4E9 & 1) == 0 )
  {
    sub_1B885B0(&Method_CharaGraphListMenuBase__OnClickTabServantEquip_b__45_0__);
    sub_1B885B0(&CharaGraphListMenuBase_RequestCallbackFunc_TypeInfo);
    byte_4A5A4E9 = 1;
  }
  v3 = (CharaGraphListMenuBase_RequestCallbackFunc_o *)sub_1B887FC(CharaGraphListMenuBase_RequestCallbackFunc_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A4F4 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_CharaGraphListMenuBase___c__DisplayClass66_0__OnEndSelectServantStatus_b__0__);
    sub_1B885B0(&CharaGraphListMenuBase___c__DisplayClass66_0_TypeInfo);
    byte_4A5A4F4 = 1;
  }
  v9 = sub_1B887FC(CharaGraphListMenuBase___c__DisplayClass66_0_TypeInfo);
  ...
  *(_DWORD *)(v9 + 24) = questId;
  ...
  System_Action___ctor(v18, v21, (intptr_t)image, 0LL);
  if ( !Instance )
LABEL_13:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A4F6 & 1) == 0 )
  {
    sub_1B885B0(&Method_CharaGraphListMenuBase_OnSelectServantAtKindChoice__);
    byte_4A5A4F6 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_CharaGraphListMenuBase_OnSelectServantAtKindChoice__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1B885C8(Method_CharaGraphListMenuBase_OnSelectServantAtKindChoice__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A4F5 & 1) == 0 )
  {
    sub_1B885B0(&Method_CharaGraphListMenuBase_OnSelectServantAtKindLock__);
    byte_4A5A4F5 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_CharaGraphListMenuBase_OnSelectServantAtKindLock__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1B885C8(Method_CharaGraphListMenuBase_OnSelectServantAtKindLock__);
  v6 = (System_Reflection_MethodBase_o *)sub_1B88594(v5, v5[4]);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B885B0(&System_Action_bool__TypeInfo);
    sub_1B885B0(&Method_CharaGraphListMenuBase_OnSelectServantAtKindPush__);
    sub_1B885B0(&Method_CharaGraphListMenuBase__OnSelectServantAtKindPush_g__EndPushRequest_71_1__);
    sub_1B885B0(&Method_CharaGraphListMenuBase__OnSelectServantAtKindPush_g__OnCloseDialog_71_0__);
  ...
  if ( (*((_BYTE *)Method_CharaGraphListMenuBase_OnSelectServantAtKindPush__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1B885C8(Method_CharaGraphListMenuBase_OnSelectServantAtKindPush__);
  v6 = (System_Reflection_MethodBase_o *)sub_1B88594(v5, v5[4]);
  OverwriteAssetSoundName__PlaySystemSe(v6, 0, 0LL);
  ...
  v11 = (System_Action_bool__o *)sub_1B887FC(System_Action_bool__TypeInfo);
  System_Action_bool____ctor(
    v11,
    (Il2CppObject *)this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A4F3 & 1) == 0 )
  {
    sub_1B885B0(&Method_CharaGraphListMenuBase_OnSelectServantAtKindStatus__);
    sub_1B885B0(&ServantStatusDialog_EndDelegate_TypeInfo);
    sub_1B885B0(&ServantStatusDialog_ResultDelegate_TypeInfo);
    this = (CharaGraphListMenuBase_o *)sub_1B885B0(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4A5A4F3 = 1;
  }
  svtItem = 0LL;
  commandCodeItem = 0LL;
...
LABEL_22:
  ...
  if ( (*((_BYTE *)Method_CharaGraphListMenuBase_OnSelectServantAtKindStatus__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1B885C8(Method_CharaGraphListMenuBase_OnSelectServantAtKindStatus__);
  ...
  {
    case 0:
      this = (CharaGraphListMenuBase_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
      if ( svtItem )
      {
        UserServantEntity_k__BackingField = svtItem->fields._UserServantEntity_k__BackingField;
        v14 = (CommonUI_o *)this;
        v15 = (ServantStatusDialog_ResultDelegate_o *)sub_1B887FC(ServantStatusDialog_ResultDelegate_TypeInfo);
        ...
        if ( v14 )
        {
          CommonUI__OpenServantStatusDialog_30504960(v14, 0, UserServantEntity_k__BackingField, v15, 0, 0LL);
          return;
        }
      }
      goto LABEL_22;
    case 1:
      ...
      if ( svtItem )
      {
        ...
        if ( v17 )
        {
          CommonUI__OpenServantStatusDialog_30504496(v17, 0, v16, v18, 0LL);
          return;
        }
      }
      goto LABEL_22;
    case 2:
      ...
      if ( commandCodeItem )
      {
        ...
        if ( v11 )
        {
          CommonUI__OpenServantStatusDialog_30506660(v11, 0, UserCommandCodeEntity_k__BackingField, v12, 0LL, 0LL);
          return;
        }
      }
      goto LABEL_22;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A4F2 & 1) == 0 )
  {
    this = (CharaGraphListMenuBase_o *)sub_1B885B0(&Method_CharaGraphListMenuBase_OnSelectServantLocal__);
    byte_4A5A4F2 = 1;
  }
  if ( !item )
    goto LABEL_17;
...
LABEL_8:
    ...
    if ( (*((_BYTE *)Method_CharaGraphListMenuBase_OnSelectServantLocal__ + 83) & 2) != 0 )
      v6 = (_QWORD *)sub_1B885C8(Method_CharaGraphListMenuBase_OnSelectServantLocal__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A4ED & 1) == 0 )
  {
    sub_1B885B0(&Method_CharaGraphListMenuBase_OnServantManageTabSelected__);
    sub_1B885B0(&CharaGraphListMenuBase_RequestCallbackFunc_TypeInfo);
    sub_1B885B0(&Method_CharaGraphListMenuBase___c__DisplayClass53_0__OnServantManageTabSelected_b__0__);
    sub_1B885B0(&CharaGraphListMenuBase___c__DisplayClass53_0_TypeInfo);
    byte_4A5A4ED = 1;
  }
  v5 = sub_1B887FC(CharaGraphListMenuBase___c__DisplayClass53_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v5, 0LL);
  if ( !v5 )
    goto LABEL_13;
  *(_QWORD *)(v5 + 16) = this;
...
LABEL_13:
  ...
  if ( RootInfo_k__BackingField->fields._ModeKind_k__BackingField != modeKindToUpdate )
  {
    ...
    if ( (*((_BYTE *)Method_CharaGraphListMenuBase_OnServantManageTabSelected__ + 83) & 2) != 0 )
      v11 = (_QWORD *)sub_1B885C8(Method_CharaGraphListMenuBase_OnServantManageTabSelected__);
    v12 = (System_Reflection_MethodBase_o *)sub_1B88594(v11, v11[4]);
    OverwriteAssetSoundName__PlaySystemSe(v12, 0, 0LL);
    if ( *(_DWORD *)(v5 + 24) == 4 )
      EventTutorialMaster__CheckTutorial(-1, 68, 0LL, 0, 0, 0, 0, 0LL);
    v13 = (CharaGraphListMenuBase_RequestCallbackFunc_o *)sub_1B887FC(CharaGraphListMenuBase_RequestCallbackFunc_TypeInfo);
    CharaGraphListMenuBase_RequestCallbackFunc___ctor(
      v13,
      (Il2CppObject *)v5,
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B885B0(&System_Action_TypeInfo);
    sub_1B885B0(&Method_CharaGraphListMenuBase_EndOpen__);
    sub_1B885B0(&CharaGraphSortOwnerNoSave_TypeInfo);
    byte_4A5A4DF = 1;
  }
  if ( !this->fields._SortOwner_k__BackingField )
  {
    v5 = (CharaGraphSortOwnerAllKind_o *)sub_1B887FC(CharaGraphSortOwnerNoSave_TypeInfo);
    CharaGraphSortOwnerAllKind___ctor(v5, v6);
    this->fields._SortOwner_k__BackingField = (struct CharaGraphSortOwnerBase_o *)v5;
    sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields._SortOwner_k__BackingField, (int32_t)v5, v7, v8);
  }
  ...
  if ( (unsigned int)(state - 2) < 2 )
  {
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.CallbackOnExit, (int32_t)callback, v9, v10);
    RootInfo_k__BackingField = this->fields._RootInfo_k__BackingField;
    if ( RootInfo_k__BackingField )
    {
      CharaGraphListMenuBase__SetTabKind(
...
LABEL_13:
  ...
  if ( !state )
  {
    ...
    System_Action___ctor(v19, (Il2CppObject *)this, Method_CharaGraphListMenuBase_EndOpen__, 0LL);
...
LABEL_14:
  ...
  EventUpValSetupInfo___ctor_38910068(v21, v20, 0, 0, 0, 0LL);
  listViewManager = this->fields.listViewManager;
...
void __fastcall CharaGraphListMenuBase__SetupButtonCallback(CharaGraphListMenuBase_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B885B0(&System_Action_TypeInfo);
    sub_1B885B0(&Method_CharaGraphListMenuBase_OnClickBonusFilterKind__);
    sub_1B885B0(&Method_CharaGraphListMenuBase_OnClickFilterKind__);
    sub_1B885B0(&Method_CharaGraphListMenuBase_OnClickScaleChange__);
    sub_1B885B0(&Method_CharaGraphListMenuBase_OnClickSortAscendingOrder__);
    sub_1B885B0(&Method_CharaGraphListMenuBase_OnClickSortKind__);
    sub_1B885B0(&Method_CharaGraphListMenuBase_OnClickTabChoice__);
    sub_1B885B0(&Method_CharaGraphListMenuBase_OnClickTabCommandCode__);
    sub_1B885B0(&Method_CharaGraphListMenuBase_OnClickTabLock__);
    sub_1B885B0(&Method_CharaGraphListMenuBase_OnClickTabMain__);
    sub_1B885B0(&Method_CharaGraphListMenuBase_OnClickTabPush__);
    sub_1B885B0(&Method_CharaGraphListMenuBase_OnClickTabServantEquip__);
    sub_1B885B0(&Method_CharaGraphListMenuBase_OnClickTabServant__);
    sub_1B885B0(&Method_CharaGraphListMenuBase_SetSortButtonImage__);
    sub_1B885B0(&UnityEngine_Object_TypeInfo);
    byte_4A5A4E0 = 1;
  }
  listViewManager = this->fields.listViewManager;
  ...
  if ( UnityEngine_Object__op_Inequality(charaGraphKindTabButtonGroup, 0LL, 0LL) )
  {
    ...
    System_Action___ctor(v11, (Il2CppObject *)this, Method_CharaGraphListMenuBase_OnClickTabServant__, 0LL);
    if ( !v10 )
      goto LABEL_29;
    v10->fields._OnClickTabServant_k__BackingField = v11;
    sub_1B88554(
      (ServantStatusBattleListViewItem_o *)&v10->fields._OnClickTabServant_k__BackingField,
      (int32_t)v11,
      v12,
      v13);
    v14 = this->fields.charaGraphKindTabButtonGroup;
    v15 = (System_Action_o *)sub_1B887FC(System_Action_TypeInfo);
    System_Action___ctor(v15, (Il2CppObject *)this, Method_CharaGraphListMenuBase_OnClickTabServantEquip__, 0LL);
    if ( !v14 )
      goto LABEL_29;
    v14->fields._OnClickTabServantEquip_k__BackingField = v15;
    sub_1B88554(
      (ServantStatusBattleListViewItem_o *)&v14->fields._OnClickTabServantEquip_k__BackingField,
      (int32_t)v15,
      v16,
      v17);
    v18 = this->fields.charaGraphKindTabButtonGroup;
    v19 = (System_Action_o *)sub_1B887FC(System_Action_TypeInfo);
    System_Action___ctor(v19, (Il2CppObject *)this, Method_CharaGraphListMenuBase_OnClickTabCommandCode__, 0LL);
    if ( !v18 )
      goto LABEL_29;
    v18->fields._OnClickTabCommandCode_k__BackingField = v19;
    sub_1B88554(
      (ServantStatusBattleListViewItem_o *)&v18->fields._OnClickTabCommandCode_k__BackingField,
      (int32_t)v19,
      v20,
      v21);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(charaGraphManageButtonGroup, 0LL, 0LL) )
  {
    ...
    System_Action___ctor(v24, (Il2CppObject *)this, Method_CharaGraphListMenuBase_OnClickTabMain__, 0LL);
    if ( !v23 )
      goto LABEL_29;
    v23->fields._OnClickTabMain_k__BackingField = v24;
    sub_1B88554(
      (ServantStatusBattleListViewItem_o *)&v23->fields._OnClickTabMain_k__BackingField,
      (int32_t)v24,
      v25,
      v26);
    v27 = this->fields.charaGraphManageButtonGroup;
    v28 = (System_Action_o *)sub_1B887FC(System_Action_TypeInfo);
    System_Action___ctor(v28, (Il2CppObject *)this, Method_CharaGraphListMenuBase_OnClickTabLock__, 0LL);
    if ( !v27 )
      goto LABEL_29;
    v27->fields._OnClickTabLock_k__BackingField = v28;
    sub_1B88554(
      (ServantStatusBattleListViewItem_o *)&v27->fields._OnClickTabLock_k__BackingField,
      (int32_t)v28,
      v29,
      v30);
    v31 = this->fields.charaGraphManageButtonGroup;
    v32 = (System_Action_o *)sub_1B887FC(System_Action_TypeInfo);
    System_Action___ctor(v32, (Il2CppObject *)this, Method_CharaGraphListMenuBase_OnClickTabChoice__, 0LL);
    if ( !v31 )
      goto LABEL_29;
    v31->fields._OnClickTabChoice_k__BackingField = v32;
    sub_1B88554(
      (ServantStatusBattleListViewItem_o *)&v31->fields._OnClickTabChoice_k__BackingField,
      (int32_t)v32,
      v33,
      v34);
    v35 = this->fields.charaGraphManageButtonGroup;
    v36 = (System_Action_o *)sub_1B887FC(System_Action_TypeInfo);
    System_Action___ctor(v36, (Il2CppObject *)this, Method_CharaGraphListMenuBase_OnClickTabPush__, 0LL);
    if ( !v35 )
      goto LABEL_29;
    v35->fields._OnClickTabPush_k__BackingField = v36;
    sub_1B88554(
      (ServantStatusBattleListViewItem_o *)&v35->fields._OnClickTabPush_k__BackingField,
      (int32_t)v36,
      v37,
      v38);
    v39 = this->fields.charaGraphManageButtonGroup;
    v40 = (System_Action_o *)sub_1B887FC(System_Action_TypeInfo);
    System_Action___ctor(v40, (Il2CppObject *)this, (intptr_t)Method_CharaGraphListMenuBase_OnClickScaleChange__, 0LL);
    if ( !v39 )
      goto LABEL_29;
    v39->fields._OnClickScaleChange_k__BackingField = v40;
    sub_1B88554(
      (ServantStatusBattleListViewItem_o *)&v39->fields._OnClickScaleChange_k__BackingField,
      (int32_t)v40,
      v41,
      v42);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(charaGraphSortButtonGroup, 0LL, 0LL) )
  {
    ...
    System_Action___ctor(v45, (Il2CppObject *)this, Method_CharaGraphListMenuBase_OnClickFilterKind__, 0LL);
    if ( v44 )
    {
      v44->fields._OnClickFilterKind_k__BackingField = v45;
      sub_1B88554(
        (ServantStatusBattleListViewItem_o *)&v44->fields._OnClickFilterKind_k__BackingField,
        (int32_t)v45,
        v46,
        v47);
      v48 = this->fields.charaGraphSortButtonGroup;
      v49 = (System_Action_o *)sub_1B887FC(System_Action_TypeInfo);
      System_Action___ctor(v49, (Il2CppObject *)this, Method_CharaGraphListMenuBase_OnClickSortKind__, 0LL);
      if ( v48 )
      {
        v48->fields._OnClickSortKind_k__BackingField = v49;
        sub_1B88554(
          (ServantStatusBattleListViewItem_o *)&v48->fields._OnClickSortKind_k__BackingField,
          (int32_t)v49,
          v50,
          v51);
        v52 = this->fields.charaGraphSortButtonGroup;
        v53 = (System_Action_o *)sub_1B887FC(System_Action_TypeInfo);
        System_Action___ctor(v53, (Il2CppObject *)this, Method_CharaGraphListMenuBase_OnClickSortAscendingOrder__, 0LL);
        if ( v52 )
        {
          v52->fields._OnClickSortAscendingOrder_k__BackingField = v53;
          sub_1B88554(
            (ServantStatusBattleListViewItem_o *)&v52->fields._OnClickSortAscendingOrder_k__BackingField,
            (int32_t)v53,
            v54,
            v55);
          v56 = this->fields.charaGraphSortButtonGroup;
          v57 = (System_Action_o *)sub_1B887FC(System_Action_TypeInfo);
          System_Action___ctor(v57, (Il2CppObject *)this, Method_CharaGraphListMenuBase_OnClickBonusFilterKind__, 0LL);
          if ( v56 )
          {
            v56->fields._OnClickBonusFilterKind_k__BackingField = v57;
            sub_1B88554(
              (ServantStatusBattleListViewItem_o *)&v56->fields._OnClickBonusFilterKind_k__BackingField,
              (int32_t)v57,
              v58,
              v59);
            return;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A4F8 & 1) == 0 )
  {
    ...
    sub_1B885B0(&NetworkManager_ResultCallbackFunc_TypeInfo);
    sub_1B885B0(&Method_CharaGraphListMenuBase___c__DisplayClass72_0__StatusRequest_g__EndStatusSync_0__);
    sub_1B885B0(&CharaGraphListMenuBase___c__DisplayClass72_0_TypeInfo);
    byte_4A5A4F8 = 1;
  }
  v5 = sub_1B887FC(CharaGraphListMenuBase___c__DisplayClass72_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v5, 0LL);
  if ( !v5 )
    goto LABEL_24;
...
LABEL_24:
      sub_1B8880C(listViewManager, v7);
    }
  }
  tabKind = this->fields.tabKind;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A4F9 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_CharaGraphListMenuBase_OnSelectServant__);
    byte_4A5A4F9 = 1;
  }
  this->fields.state = 2;
  listViewManager = this->fields.listViewManager;
  v6 = (CharaGraphListViewManager_CallbackFunc_o *)sub_1B887FC(CharaGraphListViewManager_CallbackFunc_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A4DD & 1) == 0 )
  {
    sub_1B885B0(&CharaGraphListMenuBase_CallbackFunc_TypeInfo);
    byte_4A5A4DD = 1;
  }
  ...
  while ( 1 )
  {
    ...
    v9 = sub_1BC3AA0(p_CallbackOnExit, v8, v6);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19CE78C;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19CE744;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A501 & 1) == 0 )
  {
    sub_1B885B0(&CharaGraphListMenuBase_ResultKind_TypeInfo);
    byte_4A5A501 = 1;
  }
  v9[1] = 0LL;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19CE728;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)&loc_19CE6E0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( CallbackOnExit )
  {
    ...
    sub_1B88554(p_CallbackOnExit, 0, (int32_t)method, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( !_4__this )
LABEL_6:
    sub_1B8880C(_4__this, isRequest);
