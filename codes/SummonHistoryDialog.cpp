...
void SummonHistoryDialog__OnClickClose(SummonHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596C9C7 & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_SummonHistoryDialog_OnClickClose__);
    sub_2213A60(&Method_SummonHistoryDialog__OnClickClose_b__6_0__);
    byte_596C9C7 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( (*((_BYTE *)Method_SummonHistoryDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_2213A78(Method_SummonHistoryDialog_OnClickClose__);
...
void SummonHistoryDialog__Open(SummonHistoryDialog_o *this, VaildGachaInfo_o *gachaInfo, const MethodInfo *method)
{
  ...
  if ( (byte_596C9C6 & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_DataManager_GetMaster_UserGachaPickupCollateralMaster___);
    sub_2213A60(&DataManager_TypeInfo);
    sub_2213A60(&LocalizationManager_TypeInfo);
    sub_2213A60(&NetworkManager_TypeInfo);
    sub_2213A60(&StringLiteral_43/*"\n"*/);
    sub_2213A60(&StringLiteral_7203/*"GACHA_HISTORY_UPPER_MESSAGE"*/);
    sub_2213A60(&StringLiteral_7196/*"GACHA_HISTORY_EMPTY"*/);
    sub_2213A60(&StringLiteral_7197/*"GACHA_HISTORY_GACHA_NUM"*/);
    sub_2213A60(&StringLiteral_7202/*"GACHA_HISTORY_TITLE"*/);
  ...
  v8 = LocalizationManager__Get((System_String_o *)StringLiteral_7202/*"GACHA_HISTORY_TITLE"*/, 0);
  ...
  name = System_String__Replace_75703400(
           name,
  ...
  name = LocalizationManager__Get((System_String_o *)StringLiteral_7203/*"GACHA_HISTORY_UPPER_MESSAGE"*/, 0);
  if ( !UpperMessageLabel )
    goto LABEL_53;
  UILabel__set_text(UpperMessageLabel, name, 0);
  v15 = **(System_String_o ***)(qword_5984390 + 184);
  if ( !*(&DataManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo, v13, v14);
  name = (System_String_o *)DataManager__GetMaster_object_((const MethodInfo_3856318 *)Method_DataManager_GetMaster_GachaPickupCollateralGroupMaster___);
  if ( !name )
    goto LABEL_53;
         ...
         0) )
  {
    ...
    name = (System_String_o *)DataManager__GetMaster_object_((const MethodInfo_3856318 *)Method_DataManager_GetMaster_GachaPickupCollateralMaster___);
    ...
    if ( ((unsigned __int8)name & 1) != 0 )
    {
      ...
      if ( !gachaPickupCollateralEntity->fields.maxGetNum )
      {
        ...
        Master_object = DataManager__GetMaster_object_((const MethodInfo_3856318 *)Method_DataManager_GetMaster_UserGachaPickupCollateralMaster___);
        ...
        name = LocalizationManager__Get((System_String_o *)StringLiteral_7197/*"GACHA_HISTORY_GACHA_NUM"*/, 0);
        if ( !gachaPickupCollateralEntity )
          goto LABEL_53;
        v22 = name;
        v42 = gachaPickupCollateralEntity->fields.triggerDrawNum - stackLoseNum;
        v23 = (Il2CppObject *)j_il2cpp_value_box_0(qword_5984348, &v42);
  ...
  if ( ListViewManager__get_ItemSum((ListViewManager_o *)name, 0) <= 0 )
  {
    ...
    if ( name )
    {
      ...
      if ( name )
      {
        ...
        name = LocalizationManager__Get((System_String_o *)StringLiteral_7196/*"GACHA_HISTORY_EMPTY"*/, 0);
        if ( messageLabel )
        {
...
LABEL_48:
  ...
  name = LocalizationManager__Get((System_String_o *)StringLiteral_3828/*"COMMON_CONFIRM_CLOSE"*/, 0);
  if ( !closeLabel )
    goto LABEL_53;
  UILabel__set_text(closeLabel, name, 0);
  this->fields.closeAction = 0;
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields.closeAction, 0, v30, v31, v32, v33, v34, v35);
  this->fields.decideAction = 0;
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields.decideAction, 0, v36, v37, v38, v39, v40, v41);
}
