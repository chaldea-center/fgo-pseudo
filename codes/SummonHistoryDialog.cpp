...
void SummonHistoryDialog__OnClickClose(SummonHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E00D1E & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_SummonHistoryDialog_OnClickClose__);
    sub_1CE6700(&Method_SummonHistoryDialog__OnClickClose_b__6_0__);
    byte_4E00D1E = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( (*((_BYTE *)Method_SummonHistoryDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_SummonHistoryDialog_OnClickClose__);
...
void SummonHistoryDialog__Open(SummonHistoryDialog_o *this, VaildGachaInfo_o *gachaInfo, const MethodInfo *method)
{
  ...
  if ( (byte_4E00D1D & 1) == 0 )
  {
    sub_1CE6700(&Method_DataManager_GetMaster_GachaPickupCollateralGroupMaster___);
    sub_1CE6700(&Method_DataManager_GetMaster_GachaPickupCollateralMaster___);
    sub_1CE6700(&Method_DataManager_GetMaster_UserGachaPickupCollateralMaster___);
    ...
    sub_1CE6700(&StringLiteral_6961/*"GACHA_HISTORY_UPPER_MESSAGE"*/);
    sub_1CE6700(&StringLiteral_6954/*"GACHA_HISTORY_EMPTY"*/);
    sub_1CE6700(&StringLiteral_6955/*"GACHA_HISTORY_GACHA_NUM"*/);
    sub_1CE6700(&StringLiteral_6960/*"GACHA_HISTORY_TITLE"*/);
  ...
  v5 = LocalizationManager__Get((System_String_o *)StringLiteral_6960/*"GACHA_HISTORY_TITLE"*/, 0);
  ...
  name = System_String__Replace_65169392(
           name,
  ...
  name = LocalizationManager__Get((System_String_o *)StringLiteral_6961/*"GACHA_HISTORY_UPPER_MESSAGE"*/, 0);
  ...
  name = (System_String_o *)DataManager__GetMaster_object_((const MethodInfo_3204354 *)Method_DataManager_GetMaster_GachaPickupCollateralGroupMaster___);
  if ( !name )
    goto LABEL_53;
         ...
         0) )
  {
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    name = (System_String_o *)DataManager__GetMaster_object_((const MethodInfo_3204354 *)Method_DataManager_GetMaster_GachaPickupCollateralMaster___);
    ...
    if ( ((unsigned __int8)name & 1) != 0 )
    {
      ...
      if ( !gachaPickupCollateralEntity->fields.maxGetNum )
      {
        if ( !DataManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
        Master_object = DataManager__GetMaster_object_((const MethodInfo_3204354 *)Method_DataManager_GetMaster_UserGachaPickupCollateralMaster___);
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        name = LocalizationManager__Get((System_String_o *)StringLiteral_6955/*"GACHA_HISTORY_GACHA_NUM"*/, 0);
        if ( !gachaPickupCollateralEntity )
          goto LABEL_53;
        v13 = name;
  ...
  if ( ListViewManager__get_ItemSum((ListViewManager_o *)name, 0) <= 0 )
  {
    ...
    if ( name )
    {
      ...
      if ( name )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        name = LocalizationManager__Get((System_String_o *)StringLiteral_6954/*"GACHA_HISTORY_EMPTY"*/, 0);
        if ( messageLabel )
        {
...
LABEL_48:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  name = LocalizationManager__Get((System_String_o *)StringLiteral_3714/*"COMMON_CONFIRM_CLOSE"*/, 0);
  if ( !closeLabel )
    goto LABEL_53;
  UILabel__set_text(closeLabel, name, 0);
  this->fields.closeAction = 0;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.closeAction, 0, v17, v18, v19, v20, v21, v22);
  this->fields.decideAction = 0;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.decideAction, 0, v23, v24, v25, v26, v27, v28);
}
