...
void __fastcall SummonHistoryDialog__OnClickClose(SummonHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B33828 & 1) == 0 )
  {
    ...
    sub_1BD3458(&Method_SummonHistoryDialog_OnClickClose__, v3);
    sub_1BD3458(&Method_SummonHistoryDialog__OnClickClose_b__6_0__, v4);
    byte_4B33828 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( (*((_BYTE *)Method_SummonHistoryDialog_OnClickClose__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1BD3470(Method_SummonHistoryDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B33827 & 1) == 0 )
  {
    sub_1BD3458(&Method_DataManager_GetMaster_GachaPickupCollateralGroupMaster___, gachaInfo);
    sub_1BD3458(&Method_DataManager_GetMaster_GachaPickupCollateralMaster___, v5);
    sub_1BD3458(&Method_DataManager_GetMaster_UserGachaPickupCollateralMaster___, v6);
    ...
    sub_1BD3458(&StringLiteral_7014/*"GACHA_HISTORY_UPPER_MESSAGE"*/, v13);
    sub_1BD3458(&StringLiteral_7007/*"GACHA_HISTORY_EMPTY"*/, v14);
    sub_1BD3458(&StringLiteral_7008/*"GACHA_HISTORY_GACHA_NUM"*/, v15);
    sub_1BD3458(&StringLiteral_7013/*"GACHA_HISTORY_TITLE"*/, v16);
  ...
  v19 = LocalizationManager__Get((System_String_o *)StringLiteral_7013/*"GACHA_HISTORY_TITLE"*/, 0LL);
  ...
  name = System_String__Replace_62544876(
           name,
  ...
  name = LocalizationManager__Get((System_String_o *)StringLiteral_7014/*"GACHA_HISTORY_UPPER_MESSAGE"*/, 0LL);
  ...
  name = (System_String_o *)DataManager__GetMaster_object_((const MethodInfo_2F31630 *)Method_DataManager_GetMaster_GachaPickupCollateralGroupMaster___);
  if ( !name )
    goto LABEL_53;
         ...
         0LL) )
  {
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    name = (System_String_o *)DataManager__GetMaster_object_((const MethodInfo_2F31630 *)Method_DataManager_GetMaster_GachaPickupCollateralMaster___);
    ...
    if ( ((unsigned __int8)name & 1) != 0 )
    {
      ...
      if ( !gachaPickupCollateralEntity->fields.maxGetNum )
      {
        if ( !DataManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
        Master_object = DataManager__GetMaster_object_((const MethodInfo_2F31630 *)Method_DataManager_GetMaster_UserGachaPickupCollateralMaster___);
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        name = LocalizationManager__Get((System_String_o *)StringLiteral_7008/*"GACHA_HISTORY_GACHA_NUM"*/, 0LL);
        if ( !gachaPickupCollateralEntity )
          goto LABEL_53;
        v30 = name;
  ...
  if ( ListViewManager__get_ItemSum((ListViewManager_o *)name, 0LL) <= 0 )
  {
    ...
    if ( name )
    {
      ...
      if ( name )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        name = LocalizationManager__Get((System_String_o *)StringLiteral_7007/*"GACHA_HISTORY_EMPTY"*/, 0LL);
        if ( messageLabel )
        {
...
LABEL_48:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  name = LocalizationManager__Get((System_String_o *)StringLiteral_3794/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
  if ( !closeLabel )
    goto LABEL_53;
  UILabel__set_text(closeLabel, name, 0LL);
  this->fields.closeAction = 0LL;
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.closeAction, 0LL, v34, v35, v36, v37, v38, v39);
  this->fields.decideAction = 0LL;
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.decideAction, 0LL, v40, v41, v42, v43, v44, v45);
}
