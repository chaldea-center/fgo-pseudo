...
void __fastcall SummonHistoryDialog__OnClickClose(SummonHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B40F3B & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_SummonHistoryDialog_OnClickClose__, v3);
    sub_1BDB878(&Method_SummonHistoryDialog__OnClickClose_b__6_0__, v4);
    byte_4B40F3B = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( (*((_BYTE *)Method_SummonHistoryDialog_OnClickClose__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1BDB890(Method_SummonHistoryDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B40F3A & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMaster_GachaPickupCollateralGroupMaster___, gachaInfo);
    sub_1BDB878(&Method_DataManager_GetMaster_GachaPickupCollateralMaster___, v5);
    sub_1BDB878(&Method_DataManager_GetMaster_UserGachaPickupCollateralMaster___, v6);
    ...
    sub_1BDB878(&StringLiteral_6920/*"GACHA_HISTORY_UPPER_MESSAGE"*/, v13);
    sub_1BDB878(&StringLiteral_6913/*"GACHA_HISTORY_EMPTY"*/, v14);
    sub_1BDB878(&StringLiteral_6914/*"GACHA_HISTORY_GACHA_NUM"*/, v15);
    sub_1BDB878(&StringLiteral_6919/*"GACHA_HISTORY_TITLE"*/, v16);
    sub_1BDB878(&StringLiteral_3717/*"COMMON_CONFIRM_CLOSE"*/, v17);
  ...
  v19 = LocalizationManager__Get((System_String_o *)StringLiteral_6919/*"GACHA_HISTORY_TITLE"*/, 0LL);
  ...
  name = (System_String_o *)DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_GachaPickupCollateralGroupMaster___);
  if ( !name )
    goto LABEL_53;
         ...
         0LL) )
  {
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    name = (System_String_o *)DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_GachaPickupCollateralMaster___);
    ...
    if ( ((unsigned __int8)name & 1) != 0 )
    {
      ...
      if ( !gachaPickupCollateralEntity->fields.maxGetNum )
      {
        if ( !DataManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
        Master_object = DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_UserGachaPickupCollateralMaster___);
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        name = LocalizationManager__Get((System_String_o *)StringLiteral_6914/*"GACHA_HISTORY_GACHA_NUM"*/, 0LL);
        if ( !gachaPickupCollateralEntity )
          goto LABEL_53;
        v30 = name;
  ...
  if ( ListViewManager__get_ItemSum((ListViewManager_o *)name, 0LL) <= 0 )
  {
    ...
    if ( name )
    {
      ...
      if ( name )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        name = LocalizationManager__Get((System_String_o *)StringLiteral_6913/*"GACHA_HISTORY_EMPTY"*/, 0LL);
        if ( messageLabel )
        {
...
LABEL_48:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  name = LocalizationManager__Get((System_String_o *)StringLiteral_3717/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
  if ( !closeLabel )
    goto LABEL_53;
  UILabel__set_text(closeLabel, name, 0LL);
  this->fields.closeAction = 0LL;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.closeAction, 0, v34, v35);
  this->fields.decideAction = 0LL;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.decideAction, 0, v36, v37);
}
