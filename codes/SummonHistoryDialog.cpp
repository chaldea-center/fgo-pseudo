...
void SummonHistoryDialog__OnClickClose(SummonHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C531CE & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_SummonHistoryDialog_OnClickClose__);
    sub_1C3E564(&Method_SummonHistoryDialog__OnClickClose_b__6_0__);
    byte_4C531CE = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( (*((_BYTE *)Method_SummonHistoryDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3E57C(Method_SummonHistoryDialog_OnClickClose__);
...
void SummonHistoryDialog__Open(SummonHistoryDialog_o *this, VaildGachaInfo_o *gachaInfo, const MethodInfo *method)
{
  ...
  if ( (byte_4C531CD & 1) == 0 )
  {
    sub_1C3E564(&Method_DataManager_GetMaster_GachaPickupCollateralGroupMaster___);
    sub_1C3E564(&Method_DataManager_GetMaster_GachaPickupCollateralMaster___);
    sub_1C3E564(&Method_DataManager_GetMaster_UserGachaPickupCollateralMaster___);
    ...
    sub_1C3E564(&StringLiteral_6910/*"GACHA_HISTORY_UPPER_MESSAGE"*/);
    sub_1C3E564(&StringLiteral_6903/*"GACHA_HISTORY_EMPTY"*/);
    sub_1C3E564(&StringLiteral_6904/*"GACHA_HISTORY_GACHA_NUM"*/);
    sub_1C3E564(&StringLiteral_6909/*"GACHA_HISTORY_TITLE"*/);
  ...
  v5 = LocalizationManager__Get((System_String_o *)StringLiteral_6909/*"GACHA_HISTORY_TITLE"*/, 0);
  ...
  name = System_String__Replace_63683016(
           name,
  ...
  name = LocalizationManager__Get((System_String_o *)StringLiteral_6910/*"GACHA_HISTORY_UPPER_MESSAGE"*/, 0);
  ...
  name = (System_String_o *)DataManager__GetMaster_object_((const MethodInfo_30F9A1C *)Method_DataManager_GetMaster_GachaPickupCollateralGroupMaster___);
  if ( !name )
    goto LABEL_53;
         ...
         0) )
  {
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    name = (System_String_o *)DataManager__GetMaster_object_((const MethodInfo_30F9A1C *)Method_DataManager_GetMaster_GachaPickupCollateralMaster___);
    ...
    if ( ((unsigned __int8)name & 1) != 0 )
    {
      ...
      if ( !gachaPickupCollateralEntity->fields.maxGetNum )
      {
        if ( !DataManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
        Master_object = DataManager__GetMaster_object_((const MethodInfo_30F9A1C *)Method_DataManager_GetMaster_UserGachaPickupCollateralMaster___);
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        name = LocalizationManager__Get((System_String_o *)StringLiteral_6904/*"GACHA_HISTORY_GACHA_NUM"*/, 0);
        if ( !gachaPickupCollateralEntity )
          goto LABEL_53;
        v19 = name;
        v27 = gachaPickupCollateralEntity->fields.triggerDrawNum - stackLoseNum;
        v20 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v27, v13, v14, v15, v16, v17, v18);
        Empty = System_String__Format(v19, v20, 0);
      }
    }
  }
  ...
  if ( ListViewManager__get_ItemSum((ListViewManager_o *)name, 0) <= 0 )
  {
    ...
    if ( name )
    {
      ...
      if ( name )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        name = LocalizationManager__Get((System_String_o *)StringLiteral_6903/*"GACHA_HISTORY_EMPTY"*/, 0);
        if ( messageLabel )
        {
...
LABEL_48:
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.closeAction, 0, v23, v24);
  this->fields.decideAction = 0;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.decideAction, 0, v25, v26);
}
