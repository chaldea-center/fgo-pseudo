        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD127 & 1) == 0 )
  {
    sub_1B640C8(&BattleWaveInfoData_TypeInfo, method);
    sub_1B640C8(&Method_System_Collections_Generic_List_Enumerator_UserInterruptionQuestEntity_Wave__Dispose__, v4);
    sub_1B640C8(&Method_System_Collections_Generic_List_Enumerator_UserInterruptionQuestEntity_Wave__MoveNext__, v5);
    sub_1B640C8(&Method_System_Collections_Generic_List_Enumerator_UserInterruptionQuestEntity_Wave__get_Current__, v6);
    sub_1B640C8(&Method_System_Collections_Generic_List_BattleWaveInfoData__Add__, v7);
    sub_1B640C8(&Method_System_Collections_Generic_List_UserInterruptionQuestEntity_Wave__GetEnumerator__, v8);
    sub_1B640C8(&Method_System_Collections_Generic_List_BattleWaveInfoData__ToArray__, v9);
    sub_1B640C8(&Method_System_Collections_Generic_List_BattleWaveInfoData___ctor__, v10);
    sub_1B640C8(&System_Collections_Generic_List_BattleWaveInfoData__TypeInfo, v11);
    byte_49FD127 = 1;
  }
  ...
  System_Collections_Generic_List_object____ctor(
    v12,
    (const MethodInfo_34ACEA0 *)Method_System_Collections_Generic_List_BattleWaveInfoData___ctor__);
  if ( BasicHelper__IsNullOrEmpty((System_Collections_ICollection_o *)this->fields.waveInfoList, 0LL) )
    UserInterruptionQuestEntity__SetWaveInfoScript(this, v13);
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    waveInfoList,
    (const MethodInfo_34AE26C *)Method_System_Collections_Generic_List_UserInterruptionQuestEntity_Wave__GetEnumerator__);
  v38 = v37;
  while ( System_Collections_Generic_List_Enumerator_object___MoveNext(
            &v38,
            (const MethodInfo_322A0B0 *)Method_System_Collections_Generic_List_Enumerator_UserInterruptionQuestEntity_Wave__MoveNext__) )
  {
    current = v38.fields._current;
    v18 = sub_1B64314(BattleWaveInfoData_TypeInfo, v15, v16);
    BattleWaveInfoData___ctor((BattleWaveInfoData_o *)v18, 0LL);
    if ( !current )
      sub_1B64324(v19);
    if ( !v18 )
      sub_1B64324(v19);
    *(_QWORD *)(v18 + 16) = current[1].klass;
    monitor = current[1].monitor;
    *(_QWORD *)(v18 + 24) = monitor;
    sub_1B6406C((ServantStatusBattleListViewItem_o *)(v18 + 24), (int32_t)monitor, v20, v21);
    klass = current[2].klass;
    *(_QWORD *)(v18 + 32) = klass;
    sub_1B6406C((ServantStatusBattleListViewItem_o *)(v18 + 32), (int32_t)klass, v24, v25);
    v26 = current[2].monitor;
    *(_QWORD *)(v18 + 40) = v26;
    sub_1B6406C((ServantStatusBattleListViewItem_o *)(v18 + 40), (int32_t)v26, v27, v28);
    *(_DWORD *)(v18 + 48) = current[3].klass;
    if ( !v12 )
      sub_1B64324(v29);
    items = v12->fields._items;
    v33 = Method_System_Collections_Generic_List_BattleWaveInfoData__Add__;
    ++v12->fields._version;
    if ( !items )
      sub_1B64324(v29);
    ...
    else
    {
      ...
      sub_1B6406C((ServantStatusBattleListViewItem_o *)(v35 + 4), v18, v30, v31);
    }
  }
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v38,
    (const MethodInfo_322A0AC *)Method_System_Collections_Generic_List_Enumerator_UserInterruptionQuestEntity_Wave__Dispose__);
  if ( !v12 )
LABEL_21:
    sub_1B64324(waveInfoList);
  return (BattleWaveInfoData_array *)System_Collections_Generic_List_object___ToArray(
                                       v12,
                                       (const MethodInfo_34AF2CC *)Method_System_Collections_Generic_List_BattleWaveInfoData__ToArray__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD125 & 1) == 0 )
  {
    sub_1B640C8(
      ...
      method);
    sub_1B640C8(&Newtonsoft_Json_JsonConvert_TypeInfo, v3);
    byte_49FD125 = 1;
  }
  ...
  if ( !optionInfo )
  {
    ...
    optionInfo = (UserInterruptionQuestEntity_InterruptionInfo_o *)Newtonsoft_Json_JsonConvert__DeserializeObject_object_(
                                                                     interruptionInfo,
                                                                     (const MethodInfo_2E8D908 *)Method_Newtonsoft_Json_JsonConvert_DeserializeObject_UserInterruptionQuestEntity_InterruptionInfo___);
    p_optionInfo->klass = (ServantStatusBattleListViewItem_c *)optionInfo;
    sub_1B6406C(p_optionInfo, (int32_t)optionInfo, v7, v8);
  }
  return optionInfo;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD126 & 1) == 0 )
  {
    sub_1B640C8(&Method_System_Collections_Generic_List_UserInterruptionQuestEntity_Wave__get_Count__, method);
    byte_49FD126 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD124 & 1) == 0 )
  {
    sub_1B640C8(&Method_Newtonsoft_Json_JsonConvert_DeserializeObject_List_UserInterruptionQuestEntity_Wave____, method);
    sub_1B640C8(&Newtonsoft_Json_JsonConvert_TypeInfo, v3);
    byte_49FD124 = 1;
  }
  ...
  v5 = Newtonsoft_Json_JsonConvert__DeserializeObject_object_(
         waveInfo,
         (const MethodInfo_2E8D908 *)Method_Newtonsoft_Json_JsonConvert_DeserializeObject_List_UserInterruptionQuestEntity_Wave____);
