        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C281A2 & 1) == 0 )
  {
    sub_1C2D490(&BattleWaveInfoData_TypeInfo);
    sub_1C2D490(&Method_System_Collections_Generic_List_Enumerator_UserInterruptionQuestEntity_Wave__Dispose__);
    sub_1C2D490(&Method_System_Collections_Generic_List_Enumerator_UserInterruptionQuestEntity_Wave__MoveNext__);
    sub_1C2D490(&Method_System_Collections_Generic_List_Enumerator_UserInterruptionQuestEntity_Wave__get_Current__);
    sub_1C2D490(&Method_System_Collections_Generic_List_BattleWaveInfoData__Add__);
    sub_1C2D490(&Method_System_Collections_Generic_List_UserInterruptionQuestEntity_Wave__GetEnumerator__);
    sub_1C2D490(&Method_System_Collections_Generic_List_BattleWaveInfoData__ToArray__);
  ...
  v3 = (System_Collections_Generic_List_object__o *)sub_1C2D6DC(System_Collections_Generic_List_BattleWaveInfoData__TypeInfo);
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    waveInfoList,
    (const MethodInfo_378A67C *)Method_System_Collections_Generic_List_UserInterruptionQuestEntity_Wave__GetEnumerator__);
  v32 = v31;
  while ( System_Collections_Generic_List_Enumerator_object___MoveNext(
            &v32,
            (const MethodInfo_3514508 *)Method_System_Collections_Generic_List_Enumerator_UserInterruptionQuestEntity_Wave__MoveNext__) )
  {
    current = v32.fields._current;
    v7 = sub_1C2D6DC(BattleWaveInfoData_TypeInfo);
    ...
    *(_QWORD *)(v7 + 24) = monitor;
    sub_1C2D434((CGThumbnailListItem_o *)(v7 + 24), (int32_t)monitor, v10, v11);
    klass = current[2].klass;
    *(_QWORD *)(v7 + 32) = klass;
    sub_1C2D434((CGThumbnailListItem_o *)(v7 + 32), (int32_t)klass, v14, v15);
    v16 = current[2].monitor;
    *(_QWORD *)(v7 + 40) = v16;
    sub_1C2D434((CGThumbnailListItem_o *)(v7 + 40), (int32_t)v16, v17, v18);
    *(_DWORD *)(v7 + 48) = current[3].klass;
    *(_DWORD *)(v7 + 104) = HIDWORD(current[3].klass);
    v19 = current[3].monitor;
    *(_QWORD *)(v7 + 112) = v19;
    sub_1C2D434((CGThumbnailListItem_o *)(v7 + 112), (int32_t)v19, v20, v21);
    if ( !v3 )
      sub_1C2D6EC(v22, v23);
    ...
    else
    {
      ...
      sub_1C2D434((CGThumbnailListItem_o *)(v29 + 4), v7, v24, v25);
    }
  }
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v32,
    (const MethodInfo_3514504 *)Method_System_Collections_Generic_List_Enumerator_UserInterruptionQuestEntity_Wave__Dispose__);
  if ( !v3 )
LABEL_21:
    sub_1C2D6EC(waveInfoList, v4);
  return (BattleWaveInfoData_array *)System_Collections_Generic_List_object___ToArray(
                                       v3,
                                       (const MethodInfo_378B6DC *)Method_System_Collections_Generic_List_BattleWaveInfoData__ToArray__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !waveInfoList
    || (waveInfoList = System_Collections_Generic_List_object___get_Item(
                         (System_Collections_Generic_List_object__o *)waveInfoList,
                         v6,
                         (const MethodInfo_37898B4 *)Method_System_Collections_Generic_List_UserInterruptionQuestEntity_Wave__get_Item__)) == 0
    || (v9 = *((_QWORD *)waveInfoList + 7)) == 0 )
  {
LABEL_16:
    sub_1C2D6EC(waveInfoList, v5);
  }
  return *(_DWORD *)(v9 + 24);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C281A0 & 1) == 0 )
  {
    sub_1C2D490(&Method_Newtonsoft_Json_JsonConvert_DeserializeObject_UserInterruptionQuestEntity_InterruptionInfo___);
    sub_1C2D490(&Newtonsoft_Json_JsonConvert_TypeInfo);
    byte_4C281A0 = 1;
  }
  ...
  if ( !optionInfo )
  {
    ...
    optionInfo = (UserInterruptionQuestEntity_InterruptionInfo_o *)Newtonsoft_Json_JsonConvert__DeserializeObject_object_(
                                                                     interruptionInfo,
                                                                     (const MethodInfo_312C808 *)Method_Newtonsoft_Json_JsonConvert_DeserializeObject_UserInterruptionQuestEntity_InterruptionInfo___);
    p_optionInfo->klass = (CGThumbnailListItem_c *)optionInfo;
    sub_1C2D434(p_optionInfo, (int32_t)optionInfo, v6, v7);
  }
  return optionInfo;
}
...
void UserInterruptionQuestEntity__SetWaveInfoScript(UserInterruptionQuestEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2819F & 1) == 0 )
  {
    sub_1C2D490(&Method_Newtonsoft_Json_JsonConvert_DeserializeObject_List_UserInterruptionQuestEntity_Wave____);
    sub_1C2D490(&Newtonsoft_Json_JsonConvert_TypeInfo);
    byte_4C2819F = 1;
  }
  ...
  v4 = Newtonsoft_Json_JsonConvert__DeserializeObject_object_(
         waveInfo,
         (const MethodInfo_312C808 *)Method_Newtonsoft_Json_JsonConvert_DeserializeObject_List_UserInterruptionQuestEntity_Wave____);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields._dropInfos_k__BackingField, (int32_t)value, (int32_t)method, v3);
}
