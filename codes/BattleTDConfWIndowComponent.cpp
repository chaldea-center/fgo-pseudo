void BattleTDConfWIndowComponent___cctor(const MethodInfo *method)
{
  if ( (byte_4CCAC22 & 1) == 0 )
  {
    sub_1C713B0(&BattleTDConfWIndowComponent_TypeInfo);
    byte_4CCAC22 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  return (System_String_o *)StringLiteral_4502/*"Close"*/;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CCAC20 & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_8606/*"MAX {0}%"*/);
    byte_4CCAC20 = 1;
  }
  ...
  v24 = System_String__Format((System_String_o *)StringLiteral_8606/*"MAX {0}%"*/, v23, 0);
  ...
  DetalShort_43276092 = TreasureDvcLvEntity__getDetalShort_43276092(v18, lva, 0);
  ...
  else
  {
    ...
    Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_9367/*"NP_UNKNOWN"*/, 0);
