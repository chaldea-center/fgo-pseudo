void BattleTDConfWIndowComponent___cctor(const MethodInfo *method)
{
  if ( (byte_4D300F2 & 1) == 0 )
  {
    sub_1C94098(&BattleTDConfWIndowComponent_TypeInfo);
    byte_4D300F2 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  return (System_String_o *)StringLiteral_4512/*"Close"*/;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D300F0 & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_8625/*"MAX {0}%"*/);
    byte_4D300F0 = 1;
  }
  ...
  v24 = System_String__Format((System_String_o *)StringLiteral_8625/*"MAX {0}%"*/, v23, 0);
  ...
  DetalShort_43771768 = TreasureDvcLvEntity__getDetalShort_43771768(v18, lva, 0);
  ...
  else
  {
    ...
    Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_9387/*"NP_UNKNOWN"*/, 0);
