void __fastcall BattleTDConfWIndowComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48E5763 & 1) == 0 )
  {
    sub_1B00CCC(&BattleTDConfWIndowComponent_TypeInfo, v1);
    byte_48E5763 = 1;
  }
        ...
        const MethodInfo *method)
{
  if ( (byte_48E5762 & 1) == 0 )
  {
    sub_1B00CCC(&StringLiteral_4495/*"Close"*/, method);
    byte_48E5762 = 1;
  }
  return (System_String_o *)StringLiteral_4495/*"Close"*/;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E5761 & 1) == 0 )
  {
    sub_1B00CCC(&BattleTDConfWIndowComponent_TypeInfo, *(_QWORD *)&tdId);
    sub_1B00CCC(&Method_DataManager_GetMasterData_TreasureDvcLvMaster___, v13);
    sub_1B00CCC(&Method_DataManager_GetMasterData_TreasureDvcMaster___, v14);
    sub_1B00CCC(&Method_DataMasterBase_TreasureDvcMaster__TreasureDvcEntity__int__GetEntity__, v15);
    ...
    sub_1B00CCC(&StringLiteral_8482/*"MAX {0}%"*/, v21);
    byte_48E5761 = 1;
  }
  ...
  v36 = System_String__Format((System_String_o *)StringLiteral_8482/*"MAX {0}%"*/, v35, 0LL);
  ...
  DetalShort_38675160 = TreasureDvcLvEntity__getDetalShort_38675160(v27, lva, 0LL);
  ...
  else
  {
    ...
    Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_9229/*"NP_UNKNOWN"*/, 0LL);
