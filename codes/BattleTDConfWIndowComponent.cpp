void __fastcall BattleTDConfWIndowComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B69E9E & 1) == 0 )
  {
    sub_1BE4ACC(&BattleTDConfWIndowComponent_TypeInfo, v1);
    byte_4B69E9E = 1;
  }
        ...
        const MethodInfo *method)
{
  if ( (byte_4B69E9D & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_4618/*"Close"*/, method);
    byte_4B69E9D = 1;
  }
  return (System_String_o *)StringLiteral_4618/*"Close"*/;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69E9C & 1) == 0 )
  {
    sub_1BE4ACC(&BattleTDConfWIndowComponent_TypeInfo, *(_QWORD *)&tdId);
    sub_1BE4ACC(&Method_DataManager_GetMasterData_TreasureDvcLvMaster___, v13);
    sub_1BE4ACC(&Method_DataManager_GetMasterData_TreasureDvcMaster___, v14);
    sub_1BE4ACC(&Method_DataMasterBase_TreasureDvcMaster__TreasureDvcEntity__int__GetEntity__, v15);
    ...
    sub_1BE4ACC(&StringLiteral_9486/*"NP_UNKNOWN"*/, v19);
    sub_1BE4ACC(&StringLiteral_1/*""*/, v20);
    sub_1BE4ACC(&StringLiteral_8722/*"MAX {0}%"*/, v21);
    byte_4B69E9C = 1;
  }
  ...
  v36 = System_String__Format((System_String_o *)StringLiteral_8722/*"MAX {0}%"*/, v35, 0LL);
  ...
  DetalShort_40989808 = TreasureDvcLvEntity__getDetalShort_40989808(v27, lva, 0LL);
  ...
  else
  {
    ...
    Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_9486/*"NP_UNKNOWN"*/, 0LL);
