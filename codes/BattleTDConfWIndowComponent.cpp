void __fastcall BattleTDConfWIndowComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49BE26D & 1) == 0 )
  {
    sub_1B4CF90(&BattleTDConfWIndowComponent_TypeInfo, v1);
    byte_49BE26D = 1;
  }
        ...
        const MethodInfo *method)
{
  if ( (byte_49BE26C & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_4453/*"Close"*/, method);
    byte_49BE26C = 1;
  }
  return (System_String_o *)StringLiteral_4453/*"Close"*/;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BE26B & 1) == 0 )
  {
    sub_1B4CF90(&BattleTDConfWIndowComponent_TypeInfo, *(_QWORD *)&tdId);
    sub_1B4CF90(&Method_DataManager_GetMasterData_TreasureDvcLvMaster___, v13);
    sub_1B4CF90(&Method_DataManager_GetMasterData_TreasureDvcMaster___, v14);
    sub_1B4CF90(&Method_DataMasterBase_TreasureDvcMaster__TreasureDvcEntity__int__GetEntity__, v15);
    ...
    sub_1B4CF90(&StringLiteral_8409/*"MAX {0}%"*/, v21);
    byte_49BE26B = 1;
  }
  ...
  v36 = System_String__Format((System_String_o *)StringLiteral_8409/*"MAX {0}%"*/, v35, 0LL);
  ...
  DetalShort_40630472 = TreasureDvcLvEntity__getDetalShort_40630472(v27, lva, 0LL);
  ...
  else
  {
    ...
    Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_9160/*"NP_UNKNOWN"*/, 0LL);
