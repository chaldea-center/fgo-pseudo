void BattleTDConfWIndowComponent___cctor(const MethodInfo *method)
{
  if ( (byte_4D34260 & 1) == 0 )
  {
    sub_1C93AD4(&BattleTDConfWIndowComponent_TypeInfo);
    byte_4D34260 = 1;
  }
        ...
        const MethodInfo *method)
{
  if ( (byte_4D3425F & 1) == 0 )
  {
    sub_1C93AD4(&StringLiteral_4529/*"Close"*/);
    byte_4D3425F = 1;
  }
  return (System_String_o *)StringLiteral_4529/*"Close"*/;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D3425E & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_8656/*"MAX {0}%"*/);
    byte_4D3425E = 1;
  }
  ...
  v24 = System_String__Format((System_String_o *)StringLiteral_8656/*"MAX {0}%"*/, v23, 0);
  ...
  DetalShort_43693056 = TreasureDvcLvEntity__getDetalShort_43693056(v18, lva, 0);
  ...
  else
  {
    ...
    Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_9419/*"NP_UNKNOWN"*/, 0);
