void __fastcall BattleTDConfWIndowComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BB79C1 & 1) == 0 )
  {
    sub_1C13D24(&BattleTDConfWIndowComponent_TypeInfo, v1);
    byte_4BB79C1 = 1;
  }
        ...
        const MethodInfo *method)
{
  if ( (byte_4BB79C0 & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_4621/*"Clip is in the same list multiple times, this is an error."*/, method);
    byte_4BB79C0 = 1;
  }
  return (System_String_o *)StringLiteral_4621/*"Clip is in the same list multiple times, this is an error."*/;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB79BF & 1) == 0 )
  {
    sub_1C13D24(&BattleTDConfWIndowComponent_TypeInfo, *(_QWORD *)&tdId);
    sub_1C13D24(&Method_DataManager_GetMasterData_TreasureDvcLvMaster___, v13);
    sub_1C13D24(&Method_DataManager_GetMasterData_TreasureDvcMaster___, v14);
    sub_1C13D24(&Method_DataMasterBase_TreasureDvcMaster__TreasureDvcEntity__int__GetEntity__, v15);
    ...
    sub_1C13D24(&StringLiteral_9510/*"NP_HIGHER"*/, v19);
    sub_1C13D24(&StringLiteral_1/*""*/, v20);
    sub_1C13D24(&StringLiteral_8746/*"MATERIAL_TOP_OPENING_{0:00000}"*/, v21);
    byte_4BB79BF = 1;
  }
  ...
  v36 = System_String__Format((System_String_o *)StringLiteral_8746/*"MATERIAL_TOP_OPENING_{0:00000}"*/, v35, 0LL);
  ...
  DetalShort_41197172 = TreasureDvcLvEntity__getDetalShort_41197172(v27, lva, 0LL);
  ...
  else
  {
    ...
    Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_9510/*"NP_HIGHER"*/, 0LL);
