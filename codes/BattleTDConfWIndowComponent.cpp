void __fastcall BattleTDConfWIndowComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A30FD0 & 1) == 0 )
  {
    sub_1B761C0(&BattleTDConfWIndowComponent_TypeInfo, v1);
    byte_4A30FD0 = 1;
  }
        ...
        const MethodInfo *method)
{
  if ( (byte_4A30FCF & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_4538/*"Close"*/, method);
    byte_4A30FCF = 1;
  }
  return (System_String_o *)StringLiteral_4538/*"Close"*/;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A30FCE & 1) == 0 )
  {
    sub_1B761C0(&BattleTDConfWIndowComponent_TypeInfo, *(_QWORD *)&tdId);
    sub_1B761C0(&Method_DataManager_GetMasterData_TreasureDvcLvMaster___, v13);
    sub_1B761C0(&Method_DataManager_GetMasterData_TreasureDvcMaster___, v14);
    sub_1B761C0(&Method_DataMasterBase_TreasureDvcMaster__TreasureDvcEntity__int__GetEntity__, v15);
    ...
    sub_1B761C0(&StringLiteral_8575/*"MAX {0}%"*/, v21);
    byte_4A30FCE = 1;
  }
  ...
  v36 = System_String__Format((System_String_o *)StringLiteral_8575/*"MAX {0}%"*/, v35, 0LL);
  ...
  DetalShort_39847920 = TreasureDvcLvEntity__getDetalShort_39847920(v27, lva, 0LL);
  ...
  else
  {
    ...
    Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_9329/*"NP_UNKNOWN"*/, 0LL);
