void __fastcall BattleTDConfWIndowComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BCADA7 & 1) == 0 )
  {
    sub_1C1ABD4(&BattleTDConfWIndowComponent_TypeInfo, v1);
    byte_4BCADA7 = 1;
  }
        ...
        const MethodInfo *method)
{
  if ( (byte_4BCADA6 & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_4624/*"Close"*/, method);
    byte_4BCADA6 = 1;
  }
  return (System_String_o *)StringLiteral_4624/*"Close"*/;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCADA5 & 1) == 0 )
  {
    sub_1C1ABD4(&BattleTDConfWIndowComponent_TypeInfo, *(_QWORD *)&tdId);
    sub_1C1ABD4(&Method_DataManager_GetMasterData_TreasureDvcLvMaster___, v13);
    sub_1C1ABD4(&Method_DataManager_GetMasterData_TreasureDvcMaster___, v14);
    sub_1C1ABD4(&Method_DataMasterBase_TreasureDvcMaster__TreasureDvcEntity__int__GetEntity__, v15);
    ...
    sub_1C1ABD4(&StringLiteral_9516/*"NP_UNKNOWN"*/, v19);
    sub_1C1ABD4(&StringLiteral_1/*""*/, v20);
    sub_1C1ABD4(&StringLiteral_8750/*"MAX {0}%"*/, v21);
    byte_4BCADA5 = 1;
  }
  ...
  v36 = System_String__Format((System_String_o *)StringLiteral_8750/*"MAX {0}%"*/, v35, 0LL);
  ...
  DetalShort_41253352 = TreasureDvcLvEntity__getDetalShort_41253352(v27, lva, 0LL);
  ...
  else
  {
    ...
    Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_9516/*"NP_UNKNOWN"*/, 0LL);
