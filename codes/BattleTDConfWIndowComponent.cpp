void __fastcall BattleTDConfWIndowComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A22B5A & 1) == 0 )
  {
    sub_1B715CC(&BattleTDConfWIndowComponent_TypeInfo, v1);
    byte_4A22B5A = 1;
  }
        ...
        const MethodInfo *method)
{
  if ( (byte_4A22B59 & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_4520/*"Close"*/, method);
    byte_4A22B59 = 1;
  }
  return (System_String_o *)StringLiteral_4520/*"Close"*/;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22B58 & 1) == 0 )
  {
    sub_1B715CC(&BattleTDConfWIndowComponent_TypeInfo, *(_QWORD *)&tdId);
    ...
    sub_1B715CC(&StringLiteral_8546/*"MAX {0}%"*/, v21);
    byte_4A22B58 = 1;
  }
  ...
  v36 = System_String__Format((System_String_o *)StringLiteral_8546/*"MAX {0}%"*/, v35, 0LL);
  ...
  DetalShort_39820684 = TreasureDvcLvEntity__getDetalShort_39820684(v27, lva, 0LL);
  ...
  else
  {
    ...
    Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_9300/*"NP_UNKNOWN"*/, 0LL);
