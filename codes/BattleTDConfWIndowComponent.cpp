void BattleTDConfWIndowComponent___cctor(const MethodInfo *method)
{
  if ( (byte_4CF1E78 & 1) == 0 )
  {
    sub_1C7BAE8(&BattleTDConfWIndowComponent_TypeInfo);
    byte_4CF1E78 = 1;
  }
        ...
        const MethodInfo *method)
{
  if ( (byte_4CF1E77 & 1) == 0 )
  {
    sub_1C7BAE8(&StringLiteral_4513/*"Close"*/);
    byte_4CF1E77 = 1;
  }
  return (System_String_o *)StringLiteral_4513/*"Close"*/;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF1E76 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_8629/*"MAX {0}%"*/);
    byte_4CF1E76 = 1;
  }
  ...
  v24 = System_String__Format((System_String_o *)StringLiteral_8629/*"MAX {0}%"*/, v23, 0);
  ...
  DetalShort_43533160 = TreasureDvcLvEntity__getDetalShort_43533160(v18, lva, 0);
  ...
  else
  {
    ...
    Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_9391/*"NP_UNKNOWN"*/, 0);
