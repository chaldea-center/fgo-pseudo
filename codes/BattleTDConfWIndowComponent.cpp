void __fastcall BattleTDConfWIndowComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A0BCD2 & 1) == 0 )
  {
    sub_1B686D4(&BattleTDConfWIndowComponent_TypeInfo, v1);
    byte_4A0BCD2 = 1;
  }
        ...
        const MethodInfo *method)
{
  if ( (byte_4A0BCD1 & 1) == 0 )
  {
    sub_1B686D4(&StringLiteral_4515/*"Close"*/, method);
    byte_4A0BCD1 = 1;
  }
  return (System_String_o *)StringLiteral_4515/*"Close"*/;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0BCD0 & 1) == 0 )
  {
    sub_1B686D4(&BattleTDConfWIndowComponent_TypeInfo, *(_QWORD *)&tdId);
    sub_1B686D4(&Method_DataManager_GetMasterData_TreasureDvcLvMaster___, v13);
    sub_1B686D4(&Method_DataManager_GetMasterData_TreasureDvcMaster___, v14);
    sub_1B686D4(&Method_DataMasterBase_TreasureDvcMaster__TreasureDvcEntity__int__GetEntity__, v15);
    ...
    sub_1B686D4(&StringLiteral_8541/*"MAX {0}%"*/, v21);
    byte_4A0BCD0 = 1;
  }
  ...
  v36 = System_String__Format((System_String_o *)StringLiteral_8541/*"MAX {0}%"*/, v35, 0LL);
  ...
  DetalShort_39682656 = TreasureDvcLvEntity__getDetalShort_39682656(v27, lva, 0LL);
  ...
  else
  {
    ...
    Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_9295/*"NP_UNKNOWN"*/, 0LL);
