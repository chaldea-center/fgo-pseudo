void __fastcall BattleTDConfWIndowComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A5E229 & 1) == 0 )
  {
    sub_1B885B0(&BattleTDConfWIndowComponent_TypeInfo);
    byte_4A5E229 = 1;
  }
        ...
        const MethodInfo *method)
{
  if ( (byte_4A5E228 & 1) == 0 )
  {
    sub_1B885B0(&StringLiteral_4539/*"Close"*/);
    byte_4A5E228 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5E227 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_8576/*"MAX {0}%"*/);
    byte_4A5E227 = 1;
  }
  ...
  v27 = System_String__Format((System_String_o *)StringLiteral_8576/*"MAX {0}%"*/, v26, 0LL);
  WrapControlText__textAdjust(maxParLbal, v27, 22, 0, 0, 0LL);
  ...
  DetalShort_40032868 = TreasureDvcLvEntity__getDetalShort_40032868(v18, lva, 0LL);
  ...
  else
  {
    ...
    Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_9332/*"NP_UNKNOWN"*/, 0LL);
