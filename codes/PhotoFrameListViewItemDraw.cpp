        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB18D4 & 1) == 0 )
  {
    ...
    this = (PhotoFrameListViewItemDraw_o *)sub_1C6BA08(&StringLiteral_17463/*"btn_bg_21"*/);
    byte_4CB18D4 = 1;
  }
  if ( !item )
    goto LABEL_24;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C6BA08(&UnityEngine_Object_TypeInfo);
    sub_1C6BA08(&StringLiteral_24165/*"thumbnail_"*/);
    byte_4CB18D2 = 1;
  }
  if ( item && mode )
  {
    ...
    if ( frameSampleSprite )
    {
      ...
      v8 = System_String__Concat_63966792(
             (System_String_o *)StringLiteral_24165/*"thumbnail_"*/,
...
LABEL_13:
    ...
    sub_1C6BC60(frameSampleSprite, item);
  }
}