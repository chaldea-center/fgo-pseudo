        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC29E1 & 1) == 0 )
  {
    ...
    this = (PhotoFrameListViewItemDraw_o *)sub_1C713B0(&StringLiteral_17470/*"btn_bg_21"*/);
    byte_4CC29E1 = 1;
  }
  if ( !item )
    goto LABEL_24;
...
LABEL_19:
  ...
  if ( !this )
    goto LABEL_24;
  if ( item->fields._IsSelected_k__BackingField )
    v13 = &StringLiteral_17470/*"btn_bg_21"*/;
  else
    v13 = &StringLiteral_17469/*"btn_bg_20"*/;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C713B0(&UnityEngine_Object_TypeInfo);
    sub_1C713B0(&StringLiteral_24185/*"thumbnail_"*/);
    byte_4CC29DF = 1;
  }
  if ( item && mode )
  {
    ...
    if ( frameSampleSprite )
    {
      ...
      v8 = System_String__Concat_64031724(
             (System_String_o *)StringLiteral_24185/*"thumbnail_"*/,
...
LABEL_13:
    ...
    sub_1C71608(frameSampleSprite, item);
  }
}