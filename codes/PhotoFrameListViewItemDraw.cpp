        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B400EA & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_17464/*"btn_bg_20"*/, v5);
    this = (PhotoFrameListViewItemDraw_o *)sub_1BDB878(&StringLiteral_17465/*"btn_bg_21"*/, v6);
    byte_4B400EA = 1;
  }
  if ( !item )
    goto LABEL_24;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B400E8 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_24117/*"thumbnail_"*/, v7);
    byte_4B400E8 = 1;
  }
  if ( item && mode )
  {
    ...
    if ( frameSampleSprite )
    {
      ...
      v9 = System_String__Concat_62572260(
             (System_String_o *)StringLiteral_24117/*"thumbnail_"*/,
...
LABEL_13:
    ...
    sub_1BDBAD4(frameSampleSprite, item);
  }
}