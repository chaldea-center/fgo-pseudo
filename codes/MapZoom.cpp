void __fastcall MapZoom___cctor(const MethodInfo *method)
{
  ...
  *(_OWORD *)&static_fields->ZOOM_DEFAULT = xmmword_BFACF0;
...
LABEL_16:
  ...
  if ( !byte_4BC484A )
  {
    sub_1C1ABD4(&MapZoom_TypeInfo, v7);
    byte_4BC484A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC47F6 & 1) == 0 )
  {
    sub_1C1ABD4(&System_Action_int__int__TypeInfo, mc);
    sub_1C1ABD4(&Method_MapZoom__Init_b__44_0__, v7);
    sub_1C1ABD4(&MapZoom_TypeInfo, v8);
  ...
  if ( UnityEngine_Object__op_Inequality(mCamera, 0LL, 0LL) )
  {
    ...
    sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.mMapCamera, 0LL, v11, v12, v13, v14, v15, v16);
    this->fields.touchDetector = 0LL;
    sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.touchDetector, 0LL, v17, v18, v19, v20, v21, v22);
  }
  this->fields.mMapCamera = mc;
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.mMapCamera, (int64_t)mc, v11, v12, v13, v14, v15, v16);
  if ( !mc
    || (v31 = mc->fields.mCamera,
        this->fields.mCamera = v31,
        sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.mCamera, (int64_t)v31, v25, v26, v27, v28, v29, v30),
  ...
  v41 = (System_Action_int__int__o *)sub_1C1AE20(System_Action_int__int__TypeInfo);
  ...
  {
    v49 = v42;
    v50 = sub_1C1AD10(v42, System_Action_int__int__TypeInfo);
    if ( v50 )
      goto LABEL_13;
    sub_1C1B0F0(v49);
  }
...
LABEL_13:
  ...
  sub_1C1AB78(p_OnChangeTouchCount_k__BackingField, v50, v43, v44, v45, v46, v47, v48);
...
void __fastcall MapZoom__MouseScrollWheel(MapZoom_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC47FB & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_9320/*"Mouse ScrollWheel"*/, method);
    byte_4BC47FB = 1;
  }
...
void __fastcall MapZoom__Process(MapZoom_o *this, const MethodInfo *method)
{
  ...
  if ( mAutoZmDuration > 0.0 )
  {
    ...
    {
      mAutoZmEdVal = Easing__Func_47676020(
...
void __fastcall MapZoom__SetZoomRate(MapZoom_o *this, float rate, bool xBaseUse, const MethodInfo *method)
{
  ...
  if ( (byte_4BC47F5 & 1) == 0 )
  {
    sub_1C1ABD4(&MapZoom_TypeInfo, xBaseUse);
    byte_4BC47F5 = 1;
  }
  v7 = MapZoom_TypeInfo;
  if ( !MapZoom_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC47F9 & 1) == 0 )
  {
    sub_1C1ABD4(&MapZoom_TypeInfo, is_tgt_update);
    byte_4BC47F9 = 1;
  }
  v9 = MapZoom_TypeInfo;
  if ( !MapZoom_TypeInfo->_2.cctor_finished )
  ...
  if ( !mCamera )
LABEL_15:
    sub_1C1AE30(mCamera, is_tgt_update);
        ...
        const MethodInfo *method)
{
  ...
  *((_DWORD *)p_mAutoZmEndAct - 2) = easeType;
  sub_1C1AB78((PartyOrganizationUtility_o *)p_mAutoZmEndAct, (int64_t)endAct, v13, v14, v15, v16, v17, v18);
...
void __fastcall MapZoom__UnInit(MapZoom_o *this, const MethodInfo *method)
{
  ...
  this->fields.mMapCamera = 0LL;
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.mMapCamera, 0LL, v2, v3, v4, v5, v6, v7);
  this->fields.touchDetector = 0LL;
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.touchDetector, 0LL, v9, v10, v11, v12, v13, v14);
}
