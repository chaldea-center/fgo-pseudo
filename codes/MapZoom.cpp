void __fastcall MapZoom___cctor(const MethodInfo *method)
{
  ...
  *(_OWORD *)&static_fields->ZOOM_DEFAULT = xmmword_BE2840;
...
LABEL_16:
  ...
  if ( !byte_4B63981 )
  {
    sub_1BE4ACC(&MapZoom_TypeInfo, v7);
    byte_4B63981 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B63927 & 1) == 0 )
  {
    sub_1BE4ACC(&System_Action_int__int__TypeInfo, mc);
    sub_1BE4ACC(&Method_MapZoom__Init_b__44_0__, v7);
    sub_1BE4ACC(&MapZoom_TypeInfo, v8);
  ...
  if ( UnityEngine_Object__op_Inequality(mCamera, 0LL, 0LL) )
  {
    ...
    sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.mMapCamera, 0LL, v11, v12, v13, v14, v15, v16);
    this->fields.touchDetector = 0LL;
    sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.touchDetector, 0LL, v17, v18, v19, v20, v21, v22);
  }
  this->fields.mMapCamera = mc;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.mMapCamera, (int64_t)mc, v11, v12, v13, v14, v15, v16);
  if ( !mc
    || (v31 = mc->fields.mCamera,
        this->fields.mCamera = v31,
        sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.mCamera, (int64_t)v31, v25, v26, v27, v28, v29, v30),
  ...
  v41 = (System_Action_int__int__o *)sub_1BE4D18(System_Action_int__int__TypeInfo);
  ...
  {
    v49 = v42;
    v50 = sub_1BE4C08(v42, System_Action_int__int__TypeInfo);
    if ( v50 )
      goto LABEL_13;
    sub_1BE4FE8(v49);
  }
...
LABEL_13:
  ...
  sub_1BE4A70(p_OnChangeTouchCount_k__BackingField, v50, v43, v44, v45, v46, v47, v48);
...
void __fastcall MapZoom__MouseScrollWheel(MapZoom_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6392C & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_9290/*"Mouse ScrollWheel"*/, method);
    byte_4B6392C = 1;
  }
...
void __fastcall MapZoom__Process(MapZoom_o *this, const MethodInfo *method)
{
  ...
  if ( mAutoZmDuration > 0.0 )
  {
    ...
    {
      mAutoZmEdVal = Easing__Func_47418952(
...
void __fastcall MapZoom__SetZoomRate(MapZoom_o *this, float rate, bool xBaseUse, const MethodInfo *method)
{
  ...
  if ( (byte_4B63926 & 1) == 0 )
  {
    sub_1BE4ACC(&MapZoom_TypeInfo, xBaseUse);
    byte_4B63926 = 1;
  }
  v7 = MapZoom_TypeInfo;
  if ( !MapZoom_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6392A & 1) == 0 )
  {
    sub_1BE4ACC(&MapZoom_TypeInfo, is_tgt_update);
    byte_4B6392A = 1;
  }
  v9 = MapZoom_TypeInfo;
  if ( !MapZoom_TypeInfo->_2.cctor_finished )
  ...
  if ( !mCamera )
LABEL_15:
    sub_1BE4D28(mCamera, is_tgt_update);
        ...
        const MethodInfo *method)
{
  ...
  *((_DWORD *)p_mAutoZmEndAct - 2) = easeType;
  sub_1BE4A70((PartyOrganizationUtility_o *)p_mAutoZmEndAct, (int64_t)endAct, v13, v14, v15, v16, v17, v18);
...
void __fastcall MapZoom__UnInit(MapZoom_o *this, const MethodInfo *method)
{
  ...
  this->fields.mMapCamera = 0LL;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.mMapCamera, 0LL, v2, v3, v4, v5, v6, v7);
  this->fields.touchDetector = 0LL;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.touchDetector, 0LL, v9, v10, v11, v12, v13, v14);
}
