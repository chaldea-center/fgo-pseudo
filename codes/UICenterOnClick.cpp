  ...
  if ( ((unsigned __int8)v7 & 1) != 0 )
  {
    if ( v6 )
    {
      ...
      if ( v7 )
      {
        ...
        if ( cachedTransform )
        {
          v19 = UnityEngine_Transform__InverseTransformPoint(cachedTransform, position, 0);
          if ( Component_object )
          {
            x = v19.fields.x;
            y = v19.fields.y;
            ...
            else
            {
              ...
              if ( !v7 )
                goto LABEL_29;
              LODWORD(v15) = (unsigned int)UnityEngine_Transform__get_localPosition(v7, 0);
            }
            ...
            v21.fields.z = -z;
            v21.fields.y = v16;
            SpringPanel__Begin(cachedGameObject, v21, 6.0, 0);
            return;
          }
        }
      }
