        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A7282C & 1) == 0 )
  {
    sub_1B90010(&Method_System_Linq_Enumerable_ToArray_BattleBuffData_BuffData___, svtData);
  ...
  *(_QWORD *)&v14.fields.fakeValue = v8;
  this->fields._SvtId_k__BackingField = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46506376(v14, 0LL);
  ...
  *(_QWORD *)&this->fields._TreasuredvcId_k__BackingField = *(_QWORD *)&svtData->fields.treasuredvcId;
  this->fields._DispLimitCount_k__BackingField = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46506376(
...
LABEL_8:
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields._BuffArray_k__BackingField, (int32_t)v11, v12, v13);
}