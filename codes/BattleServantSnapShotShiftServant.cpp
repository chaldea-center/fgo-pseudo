        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB880F & 1) == 0 )
  {
    sub_1BAB41C(&Method_System_Linq_Enumerable_ToArray_BattleBuffData_BuffData___, svtData);
  ...
  *(_QWORD *)&v14.fields.fakeValue = v8;
  this->fields._SvtId_k__BackingField = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46695852(v14, 0LL);
  ...
  *(_QWORD *)&this->fields._TreasuredvcId_k__BackingField = *(_QWORD *)&svtData->fields.treasuredvcId;
  this->fields._DispLimitCount_k__BackingField = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46695852(
...
LABEL_8:
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields._BuffArray_k__BackingField, (int32_t)v11, v12, v13);
}