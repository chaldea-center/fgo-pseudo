        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCA64B & 1) == 0 )
  {
    sub_1C1ABD4(&Method_System_Linq_Enumerable_ToArray_BattleBuffData_BuffData___, svtData);
  ...
  *(_QWORD *)&v18.fields.fakeValue = v8;
  this->fields._SvtId_k__BackingField = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47556128(v18, 0LL);
  ...
  *(_QWORD *)&this->fields._TreasuredvcId_k__BackingField = *(_QWORD *)&svtData->fields.treasuredvcId;
  this->fields._DispLimitCount_k__BackingField = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47556128(
