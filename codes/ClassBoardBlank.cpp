        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5E535 & 1) == 0 )
  {
    ...
    this = (ClassBoardBlank_o *)sub_1B885B0(&Method_System_Collections_Generic_List_IClassBoardSquareModel__get_Count__);
    byte_4A5E535 = 1;
  }
  memset(&v20, 0, sizeof(v20));
  if ( !linkSquares )
    sub_1B8880C(this, linkSquares);
  ...
  while ( 1 )
  {
    ...
    v10 = *(unsigned __int16 *)(&v20.fields._current->klass->_2.bitflags2 + 3);
    if ( *(_WORD *)(&v20.fields._current->klass->_2.bitflags2 + 3) )
    {
    ...
    {
LABEL_11:
      p_method = sub_1BDA590(v20.fields._current, IClassBoardSquareModel_TypeInfo, 5LL);
    }
    ...
    {
      v13 = current->klass;
      v14 = *(unsigned __int16 *)(&current->klass->_2.bitflags2 + 3);
      if ( *(_WORD *)(&current->klass->_2.bitflags2 + 3) )
      {
        ...
        v16 = (__int64)&v13->vtable[*(_DWORD *)v15 + 13].method;
      }
      else
      {
LABEL_18:
        v16 = sub_1BDA590(current, IClassBoardSquareModel_TypeInfo, 13LL);
      }
      v5 += (*(__int64 (__fastcall **)(Il2CppObject *, _QWORD, _QWORD))v16)(current, 0LL, *(_QWORD *)(v16 + 8)) & 1;
    }
  }
...
void __fastcall ClassBoardBlank__PlayTransition(ClassBoardBlank_o *this, const MethodInfo *method)
{
  ...
  v3 = (System_Collections_Generic_List_object__o *)sub_1B887FC(System_Collections_Generic_List_IClassBoardSquareModel__TypeInfo);
  ...
  v8 = *(unsigned __int16 *)(&SquareModel_k__BackingField->klass->_2.bitflags2 + 3);
  ...
  {
LABEL_8:
    p_method = sub_1BDA590(this->fields._SquareModel_k__BackingField, IClassBoardSquareModel_TypeInfo, 15LL);
  }
  ...
  ClassBoardSquare__PlaySimpleAnimation(
    ...
    *(System_String_o **)((char *)&this->klass + v14),
    0LL,
    0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v4 = (System_Collections_Generic_List_object__o *)sub_1B887FC(System_Collections_Generic_List_IClassBoardSquareModel__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v4,
    (const MethodInfo_34FD000 *)Method_System_Collections_Generic_List_IClassBoardSquareModel___ctor__);
