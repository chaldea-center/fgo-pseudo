...
void __fastcall WarBoardObjectAnimationEvent__Init(WarBoardObjectAnimationEvent_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.isInit )
  {
    if ( !this->fields.children )
    {
      ...
      sub_1B68678(
        (ServantStatusBattleListViewItem_o *)&this->fields.children,
    ...
    if ( UnityEngine_Object__op_Equality(myWidget, 0LL, 0LL) )
    {
      ...
      sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.myWidget, (int32_t)Component_object, v10, v11);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A06790 & 1) == 0 )
  {
    sub_1B686D4(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__, value);
    this = (WarBoardObjectAnimationEvent_o *)sub_1B686D4(&StringLiteral_14497/*"True"*/, v4);
    byte_4A06790 = 1;
  }
  result = 0;
...
LABEL_16:
  ...
  {
    this = (WarBoardObjectAnimationEvent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36F769C *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    v7 = this;
    v8 = 0LL;
    v9 = 2LL * ((unsigned int)m_CancellationTokenSource >> 1);
    do
    {
      if ( v8 + 1 >= LODWORD(v6->fields.m_CancellationTokenSource)
        || (v10 = (System_String_o **)(&v6->klass + v8),
            this = (WarBoardObjectAnimationEvent_o *)System_String__op_Equality(
                                                       v10[5],
                                                       (System_String_o *)StringLiteral_14497/*"True"*/,
                                                       0LL),
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        ...
        if ( !this )
          goto LABEL_16;
        WarBoardBackgroundComponent__SetDispBgDiff((WarBoardBackgroundComponent_o *)this, result, v11 & 1, 0LL);
      }
      v8 += 2LL;
    }
    while ( v9 != v8 );
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0678E & 1) == 0 )
  {
    this = (WarBoardObjectAnimationEvent_o *)sub_1B686D4(&UnityEngine_Object_TypeInfo, nameAndDepth);
    byte_4A0678E = 1;
  }
  result = 0;
  if ( !v4->fields.isInit )
