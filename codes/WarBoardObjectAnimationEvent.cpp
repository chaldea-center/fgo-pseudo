        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B34B5B & 1) == 0 )
  {
    sub_1BD3458(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__, value);
    this = (WarBoardObjectAnimationEvent_o *)sub_1BD3458(&StringLiteral_14746/*"True"*/, v4);
    byte_4B34B5B = 1;
  }
  result = 0;
...
LABEL_16:
  ...
  {
    this = (WarBoardObjectAnimationEvent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37FDC48 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    v7 = this;
    v8 = 0LL;
      ...
      if ( v8 + 1 >= LODWORD(v6->fields.m_CancellationTokenSource)
        || (v10 = (System_String_o **)(&v6->klass + v8),
            this = (WarBoardObjectAnimationEvent_o *)System_String__op_Equality(
                                                       v10[5],
                                                       (System_String_o *)StringLiteral_14746/*"True"*/,
                                                       0LL),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B34B59 & 1) == 0 )
  {
    this = (WarBoardObjectAnimationEvent_o *)sub_1BD3458(&UnityEngine_Object_TypeInfo, nameAndDepth);
    byte_4B34B59 = 1;
  }
  result = 0;
  if ( !v4->fields.isInit )
