void FadeLogger___cctor(const MethodInfo *method)
{
  ...
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)FadeLogger_TypeInfo->static_fields, v7, v1, v2, v3, v4, v5, v6);
}
...
void FadeLogger___ctor(FadeLogger_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_5937AD1 & 1) == 0 )
  {
    sub_21FFC50(&FadeLogger_Info_TypeInfo);
    byte_5937AD1 = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0);
  v3 = (FadeLogger_Info_o *)sub_21FFEBC(FadeLogger_Info_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  *(float *)&format.klass = duration;
  if ( (byte_5937AD2 & 1) == 0 )
  {
    sub_21FFC50(&MaskFade_Kind_TypeInfo);
    sub_21FFC50(&object___TypeInfo);
    sub_21FFC50(&StringLiteral_26477/*"{0} カラー[{1}] 状態[{2}] 再生時間[{3}s]"*/);
  ...
  if ( funkName )
  {
    v9 = (System_String_o *)sub_21FFDA4(funkName, v9->klass->_1.element_class);
    if ( !v9 )
      goto LABEL_18;
  }
  ...
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)v17->m_Items, (int32_t)funkName, v11, v12, v13, v14, v15, v16);
  v43 = fadeKind;
  ...
  if ( v9 )
  {
    v9 = (System_String_o *)sub_21FFDA4(v9, v17->obj.klass->_1.element_class);
    if ( !v9 )
      goto LABEL_18;
  }
  if ( (v17->max_length & 0xFFFFFFFE) == 0 )
    goto LABEL_17;
  v17->m_Items[1] = v25;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&v17->m_Items[1], (int32_t)v25, v19, v20, v21, v22, v23, v24);
  if ( state )
  {
    v9 = (System_String_o *)sub_21FFDA4(state, v17->obj.klass->_1.element_class);
    if ( !v9 )
      goto LABEL_18;
  }
  ...
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&v17->m_Items[2], (int32_t)state, v26, v27, v28, v29, v30, v31);
  v9 = System_Single__ToString_77012896(v32, &format, (const MethodInfo *)StringLiteral_1202/*"0.00"*/);
  v39 = (Il2CppObject *)v9;
  if ( v9 )
  {
    v9 = (System_String_o *)sub_21FFDA4(v9, v17->obj.klass->_1.element_class);
...
LABEL_17:
    sub_21FFED4(v9);
  v17->m_Items[3] = v39;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&v17->m_Items[3], (int32_t)v39, v33, v34, v35, v36, v37, v38);
  return System_String__Format_75484712((System_String_o *)StringLiteral_26477/*"{0} カラー[{1}] 状態[{2}] 再生時間[{3}s]"*/, v17, 0);
}
...
FadeLogger_o *FadeLogger__get_Instance(const MethodInfo *method)
{
  ...
  {
    v3 = (FadeLogger_o *)sub_21FFEBC(v2);
