void FadeLogger___cctor(const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)FadeLogger_TypeInfo->static_fields, StringLiteral_877/*"--------"*/, v1, v2);
}
...
void FadeLogger___ctor(FadeLogger_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C266DE & 1) == 0 )
  {
    sub_1C2D490(&FadeLogger_Info_TypeInfo);
    byte_4C266DE = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0);
  v3 = (FadeLogger_Info_o *)sub_1C2D6DC(FadeLogger_Info_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  __int64 v21; // x0
  System_Enum_o v22; // [xsp+0h] [xbp-50h] BYREF
  int32_t v23; // [xsp+10h] [xbp-40h]
  System_String_o format; // [xsp+1Ch] [xbp-34h] BYREF

  *(float *)&format.klass = duration;
  if ( (byte_4C266DF & 1) == 0 )
  {
    sub_1C2D490(&MaskFade_Kind_TypeInfo);
    sub_1C2D490(&object___TypeInfo);
    sub_1C2D490(&StringLiteral_25115/*"{0} カラー[{1}] 状態[{2}] 再生時間[{3}s]"*/);
    sub_1C2D490(&StringLiteral_1126/*"0.00"*/);
    byte_4C266DF = 1;
  }
  v9 = (System_String_o *)sub_1C2D538(object___TypeInfo, 4);
  if ( !v9 )
    sub_1C2D6EC(0, v10);
  v13 = (System_Object_array *)v9;
  if ( funkName )
  {
    v9 = (System_String_o *)sub_1C2D5CC(funkName, v9->klass->_1.element_class);
    if ( !v9 )
      goto LABEL_18;
  }
  ...
  sub_1C2D434((CGThumbnailListItem_o *)v13->m_Items, (int32_t)funkName, v11, v12);
  v22.klass = (System_Enum_c *)MaskFade_Kind_TypeInfo;
  v22.monitor = (void *)-1LL;
  v23 = fadeKind;
  v9 = System_Enum__ToString(&v22, 0);
  v15 = (Il2CppObject *)v9;
  if ( v9 )
  {
    v9 = (System_String_o *)sub_1C2D5CC(v9, v13->obj.klass->_1.element_class);
    if ( !v9 )
      goto LABEL_18;
  }
  if ( LODWORD(v13->max_length) <= 1 )
    goto LABEL_17;
  v13->m_Items[1] = v15;
  sub_1C2D434((CGThumbnailListItem_o *)&v13->m_Items[1], (int32_t)v15, v11, v14);
  if ( state )
  {
    v9 = (System_String_o *)sub_1C2D5CC(state, v13->obj.klass->_1.element_class);
    if ( !v9 )
      goto LABEL_18;
  }
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&v13->m_Items[2], (int32_t)state, v11, v16);
  v9 = System_Single__ToString_65053868(v17, &format, (const MethodInfo *)StringLiteral_1126/*"0.00"*/);
  v19 = (Il2CppObject *)v9;
  if ( v9 )
  {
    v9 = (System_String_o *)sub_1C2D5CC(v9, v13->obj.klass->_1.element_class);
...
LABEL_17:
  ...
  v13->m_Items[3] = v19;
  sub_1C2D434((CGThumbnailListItem_o *)&v13->m_Items[3], (int32_t)v19, v11, v18);
  return System_String__Format_63499292((System_String_o *)StringLiteral_25115/*"{0} カラー[{1}] 状態[{2}] 再生時間[{3}s]"*/, v13, 0);
}
...
FadeLogger_o *FadeLogger__get_Instance(const MethodInfo *method)
{
  ...
  {
    v2 = (FadeLogger_o *)sub_1C2D6DC(v1);
...
System_String_o *FadeLogger_Info__ToString(FadeLogger_Info_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.currentIndex == -1 )
  {
    ...
    return v12->static_fields->BLANK;
  }
  else
  {
    sb = this->fields.sb;
