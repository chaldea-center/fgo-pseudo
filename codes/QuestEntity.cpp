...
void QuestEntity___ctor_49427480(QuestEntity_o *this, QuestEntity_o *cSrc, const MethodInfo *method)
{
  __int64 v5; // x0
  __int64 v6; // x1
  ...
  *(_OWORD *)&this->fields.displayHours = *(_OWORD *)&cSrc->fields.displayHours;
  ...
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)p_recommendLv, (int32_t)recommendLv, v45, v46, v47, v48, v49, v50);
...
System_String_o *QuestEntity__GetBgmName(QuestEntity_o *this, int32_t warId, const MethodInfo *method)
{
  ...
  v11 = DataManager__GetMaster_object_((const MethodInfo_3822E50 *)Method_DataManager_GetMaster_SpotMaster___);
  SpotId = (MapMaster_o *)QuestEntity__getSpotId(this, v12);
  if ( !v11 )
LABEL_23:
    sub_21FFECC(SpotId, v9);
  SpotId = (MapMaster_o *)DataMasterBase_object__object__int___TryGetEntity(
...
LABEL_16:
  if ( !*(&DataManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo, v9);
  SpotId = (MapMaster_o *)DataManager__GetMaster_object_((const MethodInfo_3822E50 *)Method_DataManager_GetMaster_MapMaster___);
  if ( !SpotId )
    goto LABEL_23;
        ...
        const MethodInfo *method)
{
  ...
  v18 = (System_Collections_Generic_List_object__o *)sub_21FFEBC(System_Collections_Generic_List_EventCampaignEntity__TypeInfo);
...
System_String_o *QuestEntity__GetChapterSubTitle(QuestEntity_o *this, int32_t warId, const MethodInfo *method)
{
  ...
  if ( (byte_5938CE5 & 1) == 0 )
  {
    ...
    sub_21FFC50(&StringLiteral_3472/*"CHAPTER_F_START_ID"*/);
    byte_5938CE5 = 1;
  }
...
LABEL_14:
  ...
  id = this->fields.id;
  if ( id >= ConstantMaster__GetValue((ConstantMaster_o *)Instance, (System_String_o *)StringLiteral_3472/*"CHAPTER_F_START_ID"*/, 0) )
  {
    v11 = this->fields.id;
    if ( v11 <= ConstantMaster__GetValue(v9, (System_String_o *)StringLiteral_3471/*"CHAPTER_F_END_ID"*/, 0) )
LABEL_10:
...
System_String_o *QuestEntity__GetCostValueColor(int32_t costCalcVal, bool isOverCost, const MethodInfo *method)
{
  ...
  if ( (byte_5938CEF & 1) == 0 )
  {
    ...
    sub_21FFC50(&StringLiteral_10140/*"OVER_COST_COLOR"*/);
    sub_21FFC50(&StringLiteral_3403/*"CAMPAIGN_COST_COLOR"*/);
    byte_5938CEF = 1;
  }
  if ( costCalcVal < 1 )
  {
    result = (System_String_o *)StringLiteral_26433/*"{0}"*/;
    if ( !isOverCost )
      return result;
    goto LABEL_7;
  }
  ...
  result = LocalizationManager__Get((System_String_o *)StringLiteral_3403/*"CAMPAIGN_COST_COLOR"*/, 0);
  if ( isOverCost )
  {
LABEL_7:
    if ( !*(&LocalizationManager_TypeInfo->_2.cctor_finished + 1) )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, isOverCost);
    return LocalizationManager__Get((System_String_o *)StringLiteral_10140/*"OVER_COST_COLOR"*/, 0);
  }
  return result;
}
...
QuestPhaseDetailEntity_o *QuestEntity__GetPhaseDetail(QuestEntity_o *this, const MethodInfo *method)
{
  ...
  {
    v7 = 1;
    return QuestEntity__GetPhaseDetail_49428408(this, v7, v6);
  }
...
LABEL_19:
  ...
  if ( ConstantMaster__IsEnableFixGetQuestPhaseDetail(0) )
  {
    ...
    v7 = System_Math__Min_76940292(v7, MaxPhase, 0);
  }
  return QuestEntity__GetPhaseDetail_49428408(this, v7, v6);
}


QuestPhaseDetailEntity_o *QuestEntity__GetPhaseDetail_49428408(
        QuestEntity_o *this,
        int32_t phaseCnt,
        const MethodInfo *method)
{
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_3822EA4 *)Method_DataManager_GetMasterData_QuestPhaseDetailMaster___)) == 0 )
  {
...
QuestEntity_o *QuestEntity__GetPhaseDetailedEntity(QuestEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_5938CDB & 1) == 0 )
  {
    sub_21FFC50(&QuestEntity_TypeInfo);
    byte_5938CDB = 1;
  }
  ...
  {
    v4 = PhaseDetail;
    v5 = (QuestEntity_o *)sub_21FFEBC(QuestEntity_TypeInfo);
    QuestEntity___ctor_49427480(v5, this, v6);
    if ( !v5 )
      sub_21FFECC(v7, v8);
...
int64_t QuestEntity__GetRestTime(QuestEntity_o *this, bool is_itvl, const MethodInfo *method)
{
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_3822EA4 *)Method_DataManager_GetMasterData_QuestAddMaster___)) == 0 )
  {
    sub_21FFECC(Instance, v7);
  }
...
int32_t QuestEntity__GetWarId(QuestEntity_o *this, const MethodInfo *method)
{
  ...
  SpotId = DataManager__GetMaster_object_((const MethodInfo_3822E50 *)Method_DataManager_GetMaster_BlankEarthSpotMaster___);
  if ( !SpotId )
LABEL_16:
    sub_21FFECC(SpotId, v7);
  SpotId = (Il2CppObject *)DataMasterBase_object__object__int___TryGetEntity(
...
// local variable allocation has failed, the output may be wrong!
bool QuestEntity__HasFlag_49432408(QuestEntity_o *this, int64_t flag, int32_t phaseCnt, const MethodInfo *method)
{
  int64_t *p_flag; // x8
  QuestPhaseDetailEntity_o *PhaseDetail_49428408; // x0

  if ( this->fields.mIsPhaseDetailed
    || (PhaseDetail_49428408 = QuestEntity__GetPhaseDetail_49428408(this, phaseCnt, *(const MethodInfo **)&phaseCnt)) == 0 )
  {
    p_flag = &this->fields.flag;
  }
  else
        ...
        const MethodInfo *method)
{
  ...
  PhaseDetail_49428408 = QuestEntity__GetPhaseDetail_49428408(this, phaseCnt, *(const MethodInfo **)&phaseCnt);
  if ( PhaseDetail_49428408 )
    LOBYTE(PhaseDetail_49428408) = (PhaseDetail_49428408->fields.flag & flag) != 0;
  return (char)PhaseDetail_49428408;
}
...
bool QuestEntity__IsActiveRecollectionQuest(QuestEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_5938CF0 & 1) == 0 )
  {
    sub_21FFC50(&Method_DataManager_GetMaster_WarQuestSelectionMaster___);
    sub_21FFC50(&DataManager_TypeInfo);
    byte_5938CF0 = 1;
  }
  if ( this->fields.mIsPhaseDetailed || (PhaseDetail = QuestEntity__GetPhaseDetail(this, method)) == 0 )
  ...
  if ( !*(&DataManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo, method);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_3822E50 *)Method_DataManager_GetMaster_WarQuestSelectionMaster___);
  if ( !Master_object )
    sub_21FFECC(0, v7);
...
System_String_o *QuestEntity__getChapterSubStr(QuestEntity_o *this, int32_t warId, const MethodInfo *method)
{
  ...
  if ( (byte_5938CE4 & 1) == 0 )
  {
    ...
    sub_21FFC50(&LocalizationManager_TypeInfo);
    sub_21FFC50(&StringLiteral_8934/*"MATERIAL_MAP_CHAPTER_SUB_{0:D2}"*/);
    sub_21FFC50(&StringLiteral_8933/*"MATERIAL_MAP_CHAPTER_SUB"*/);
    byte_5938CE4 = 1;
  }
  ...
  PhaseDetail_49428408 = QuestEntity__GetPhaseDetail_49428408(this, 1, v6);
  if ( PhaseDetail_49428408 )
  {
    if ( (PhaseDetail_49428408->fields.flag & 0x2000000000000000LL) != 0 )
      return this->fields.chapterSubStr;
  }
  if ( !*(&DataManager_TypeInfo->_2.cctor_finished + 1) )
    ...
    || entity && WarEntity__IsChapterSubIdJapaneseNumeralsNormal((WarEntity_o *)entity, 0) )
  {
    if ( QuestBoardSectionId )
    {
      ...
      v16 = (Il2CppObject *)j_il2cpp_value_box_0(qword_594C070, &v30);
      v18 = System_String__Format((System_String_o *)StringLiteral_8934/*"MATERIAL_MAP_CHAPTER_SUB_{0:D2}"*/, v16, 0);
      if ( !*(&LocalizationManager_TypeInfo->_2.cctor_finished + 1) )
    ...
    else
    {
      ...
      v19 = (System_String_o *)StringLiteral_8933/*"MATERIAL_MAP_CHAPTER_SUB"*/;
    }
  ...
  else
  {
    if ( QuestBoardSectionId )
    {
      ...
      v22 = System_String__Format((System_String_o *)StringLiteral_8934/*"MATERIAL_MAP_CHAPTER_SUB_{0:D2}"*/, v20, 0);
      if ( !*(&LocalizationManager_TypeInfo->_2.cctor_finished + 1) )
    ...
    else
    {
      if ( !*(&LocalizationManager_TypeInfo->_2.cctor_finished + 1) )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, v11);
      v23 = (System_String_o *)StringLiteral_8933/*"MATERIAL_MAP_CHAPTER_SUB"*/;
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5938CEA & 1) == 0 )
  {
    ...
    sub_21FFC50(&Method_DataMasterBase_QuestConsumeItemMaster__QuestConsumeItemEntity__int__GetEntity__);
    sub_21FFC50(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_5938CEA = 1;
  }
  if ( this->fields.mIsPhaseDetailed
  ...
  result = (QuestConsumeItemEntity_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_476E8C0 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !result )
    goto LABEL_20;
  ...
  result = (QuestConsumeItemEntity_o *)DataMasterBase_object__object__int___GetEntity(
                                         ...
                                         this->fields.id,
                                         (const MethodInfo_3EDD388 *)Method_DataMasterBase_QuestConsumeItemMaster__QuestConsumeItemEntity__int__GetEntity__);
  if ( isNotItemConsume )
  {
    if ( result )
      return QuestConsumeItemEntity__GetNotConsumeItemEntity(result, v10);
LABEL_20:
    sub_21FFECC(result, v10);
  }
  return result;
}
...
System_String_o *QuestEntity__getRecommendLv_49431552(QuestEntity_o *this, int32_t phaseCnt, const MethodInfo *method)
{
  QuestPhaseDetailEntity_o *PhaseDetail_49428408; // x0
  System_String_o **p_recommendLv; // x19

  PhaseDetail_49428408 = QuestEntity__GetPhaseDetail_49428408(this, phaseCnt, method);
  if ( !PhaseDetail_49428408
    || (p_recommendLv = &PhaseDetail_49428408->fields.recommendLv,
        System_String__IsNullOrEmpty(PhaseDetail_49428408->fields.recommendLv, 0)) )
  {
    p_recommendLv = &this->fields.recommendLv;
  }
...
int32_t QuestEntity__getSpotId(QuestEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_5938CE0 & 1) == 0 )
  {
    sub_21FFC50(&Method_DataManager_GetMasterData_QuestSpotReleaseMaster___);
    sub_21FFC50(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_5938CE0 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_476E8C0 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_3822EA4 *)Method_DataManager_GetMasterData_QuestSpotReleaseMaster___)) == 0 )
  {
    sub_21FFECC(Instance, v4);
  }
...
int32_t QuestEntity__getSpotId_49429804(QuestEntity_o *this, int32_t phase, const MethodInfo *method)
{
  Il2CppObject *Instance; // x0
  __int64 v6; // x1
  int32_t result; // w0
  ...
  Instance = DataManager__GetMasterData_object_(
               (DataManager_o *)Instance,
               (const MethodInfo_3822EA4 *)Method_DataManager_GetMasterData_QuestSpotReleaseMaster___);
  if ( !Instance )
    goto LABEL_14;
  result = QuestSpotReleaseMaster__GetSpotId((QuestSpotReleaseMaster_o *)Instance, this->fields.id, 0);
  if ( result )
