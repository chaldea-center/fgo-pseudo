...
void __fastcall QuestEntity___ctor_25287656(QuestEntity_o *this, QuestEntity_o *cSrc, const MethodInfo *method)
{
  __int64 v5; // x0
  __int64 v6; // x1
...
System_String_o *__fastcall QuestEntity__GetBgmName(QuestEntity_o *this, int32_t warId, const MethodInfo *method)
{
  ...
  if ( (byte_42B01BF & 1) == 0 )
  {
    ...
    sub_B52984(&Method_DataManager_GetMaster_MapMaster___);
  ...
  if ( (BYTE3(DataManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0 && !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  v10 = (DataMasterBase_WarMaster__WarEntity__int__o *)DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1A4F124 *)Method_DataManager_GetMaster_SpotMaster___);
  SpotId = (MapMaster_o *)QuestEntity__getSpotId(this, v11);
  if ( !v10 )
LABEL_26:
    sub_B52A5C(SpotId, v8);
  SpotId = (MapMaster_o *)DataMasterBase_WarMaster__WarEntity__int___TryGetEntity(
                            v10,
                            &v15,
                            (int32_t)SpotId,
...
LABEL_18:
  if ( (BYTE3(DataManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0 && !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  SpotId = (MapMaster_o *)DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1A4F124 *)Method_DataManager_GetMaster_MapMaster___);
  if ( !SpotId )
    goto LABEL_26;
        ...
        const MethodInfo *method)
{
  ...
  v17 = (System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData__o *)sub_B52A54(System_Collections_Generic_List_EventCampaignEntity__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B01B8 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_2998/*"CHAPTER_F_START_ID"*/);
    byte_42B01B8 = 1;
  }
...
LABEL_14:
  ...
  id = this->fields.id;
  if ( id >= ConstantMaster__GetValue((ConstantMaster_o *)Instance, (System_String_o *)StringLiteral_2998/*"CHAPTER_F_START_ID"*/, 0LL) )
  {
    v11 = this->fields.id;
    if ( v11 <= ConstantMaster__GetValue(v9, (System_String_o *)StringLiteral_2997/*"CHAPTER_F_END_ID"*/, 0LL) )
LABEL_10:
...
int32_t __fastcall QuestEntity__GetChapterUnitId(QuestEntity_o *this, int32_t warId, const MethodInfo *method)
{
  ...
  v4 = (WarEntity_o *)sub_B52A54(WarEntity_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B01C2 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_9921/*"OVER_COST_COLOR"*/);
    sub_B52984(&StringLiteral_2949/*"CAMPAIGN_COST_COLOR"*/);
    byte_42B01C2 = 1;
  }
  if ( costCalcVal < 1 )
  {
    result = (System_String_o *)StringLiteral_23732/*"{0}"*/;
    if ( !isOverCost )
      return result;
    goto LABEL_8;
  }
  ...
  result = LocalizationManager__Get((System_String_o *)StringLiteral_2949/*"CAMPAIGN_COST_COLOR"*/, 0LL);
  if ( isOverCost )
  {
LABEL_8:
    if ( (BYTE3(LocalizationManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    ...
    return LocalizationManager__Get((System_String_o *)StringLiteral_9921/*"OVER_COST_COLOR"*/, 0LL);
  }
  return result;
}
...
QuestPhaseDetailEntity_o *__fastcall QuestEntity__GetPhaseDetail(QuestEntity_o *this, const MethodInfo *method)
{
  ...
  {
    v7 = 1;
    return QuestEntity__GetPhaseDetail_25288480(this, v7, v6);
  }
  Instance = (DataManager_o *)entity;
  if ( !entity )
LABEL_13:
...
QuestPhaseDetailEntity_o *__fastcall QuestEntity__GetPhaseDetail_25288480(
        QuestEntity_o *this,
        int32_t phaseCnt,
        const MethodInfo *method)
{
  ...
  if ( !Instance
    || (Instance = (DataManager_o *)DataManager__GetMasterData_WarQuestSelectionMaster_(
                                      Instance,
                                      (const MethodInfo_1A4F184 *)Method_DataManager_GetMasterData_QuestPhaseDetailMaster___)) == 0LL )
  {
    sub_B52A5C(Instance, v6);
  }
...
QuestEntity_o *__fastcall QuestEntity__GetPhaseDetailedEntity(QuestEntity_o *this, const MethodInfo *method)
{
  ...
  {
    v4 = PhaseDetail;
    v5 = (QuestEntity_o *)sub_B52A54(QuestEntity_TypeInfo);
    QuestEntity___ctor_25287656(v5, this, v6);
    if ( !v5 )
      sub_B52A5C(v7, v8);
    this = v5;
...
bool __fastcall QuestEntity__HasFlag_25292224(
        QuestEntity_o *this,
        int64_t flag,
        int32_t phaseCnt,
        const MethodInfo *method)
{
  QuestPhaseDetailEntity_o *PhaseDetail_25288480; // x0

  if ( this->fields.mIsPhaseDetailed )
    return (this->fields.flag & flag) != 0;
  PhaseDetail_25288480 = QuestEntity__GetPhaseDetail_25288480(this, phaseCnt, *(const MethodInfo **)&phaseCnt);
  if ( !PhaseDetail_25288480 )
    return (this->fields.flag & flag) != 0;
  else
    return QuestPhaseDetailEntity__HasFlag(PhaseDetail_25288480, flag, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  PhaseDetail_25288480 = QuestEntity__GetPhaseDetail_25288480(this, phaseCnt, *(const MethodInfo **)&phaseCnt);
  if ( PhaseDetail_25288480 )
    LOBYTE(PhaseDetail_25288480) = QuestPhaseDetailEntity__HasFlag(PhaseDetail_25288480, flag, 0LL);
  return (char)PhaseDetail_25288480;
}
...
bool __fastcall QuestEntity__IsActiveRecollectionQuest(QuestEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B01C3 & 1) == 0 )
  {
    sub_B52984(&Method_DataManager_GetMaster_WarQuestSelectionMaster___);
    sub_B52984(&DataManager_TypeInfo);
    byte_42B01C3 = 1;
  }
  ...
  if ( (BYTE3(DataManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0 && !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_WarQuestSelectionMaster = DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1A4F124 *)Method_DataManager_GetMaster_WarQuestSelectionMaster___);
  if ( !Master_WarQuestSelectionMaster )
    sub_B52A5C(0LL, v5);
...
System_String_o *__fastcall QuestEntity__getChapterSubStr(QuestEntity_o *this, int32_t warId, const MethodInfo *method)
{
  ...
  int32_t v30; // [xsp+8h] [xbp-18h] BYREF
  ...
  if ( (byte_42B01B6 & 1) == 0 )
  {
    ...
    sub_B52984(&LocalizationManager_TypeInfo);
    sub_B52984(&StringLiteral_8716/*"MATERIAL_MAP_CHAPTER_SUB_{0:D2}"*/);
    sub_B52984(&StringLiteral_8715/*"MATERIAL_MAP_CHAPTER_SUB"*/);
    byte_42B01B6 = 1;
  }
    ...
    || Entity && WarEntity__IsChapterSubIdJapaneseNumeralsNormal(Entity, 0LL) )
  {
    ...
    {
      v31 = ChapterUnitId;
      v14 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v31);
      v15 = System_String__Format((System_String_o *)StringLiteral_8716/*"MATERIAL_MAP_CHAPTER_SUB_{0:D2}"*/, v14, 0LL);
      if ( (BYTE3(LocalizationManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
        && !LocalizationManager_TypeInfo->_2.cctor_finished )
      {
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      ...
      v18 = v16;
      v19 = (Il2CppObject *)LocalizationManager__ChineseNumber(chapterSubId, 0LL);
      v20 = v18;
      return System_String__Format(v20, v19, 0LL);
    }
    if ( (BYTE3(LocalizationManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
      && !LocalizationManager_TypeInfo->_2.cctor_finished )
    {
    ...
    v24 = LocalizationManager__Get((System_String_o *)StringLiteral_8715/*"MATERIAL_MAP_CHAPTER_SUB"*/, 0LL);
    v25 = this->fields.chapterSubId;
    v26 = v24;
    v27 = (Il2CppObject *)LocalizationManager__ChineseNumber(v25, 0LL);
    v28 = v26;
  }
  else
  {
    if ( ChapterUnitId )
    {
      ...
      v22 = System_String__Format((System_String_o *)StringLiteral_8716/*"MATERIAL_MAP_CHAPTER_SUB_{0:D2}"*/, v21, 0LL);
      if ( (BYTE3(LocalizationManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
        && !LocalizationManager_TypeInfo->_2.cctor_finished )
      {
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      ...
      v19 = (Il2CppObject *)System_Int32__ToString((int)this + 116, 0LL);
      v20 = v23;
      return System_String__Format(v20, v19, 0LL);
    }
    if ( (BYTE3(LocalizationManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    ...
    v29 = LocalizationManager__Get((System_String_o *)StringLiteral_8715/*"MATERIAL_MAP_CHAPTER_SUB"*/, 0LL);
    v27 = (Il2CppObject *)System_Int32__ToString((int)this + 116, 0LL);
    v28 = v29;
  }
  return System_String__Format(v28, v27, 0LL);
}
...
int64_t __fastcall QuestEntity__getClosedAt(QuestEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B01BA & 1) == 0 )
  {
    sub_B52984(&Method_DataManager_GetMasterData_QuestAddMaster___);
    sub_B52984(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_42B01BA = 1;
  }
  Instance = (DataManager_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance
    || (Instance = (DataManager_o *)DataManager__GetMasterData_WarQuestSelectionMaster_(
                                      Instance,
                                      (const MethodInfo_1A4F184 *)Method_DataManager_GetMasterData_QuestAddMaster___)) == 0LL )
  {
    sub_B52A5C(Instance, v4);
  }
...
QuestConsumeItemEntity_o *__fastcall QuestEntity__getItemConsumeEntity(QuestEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B01BD & 1) == 0 )
  {
    ...
    sub_B52984(&Method_DataMasterBase_QuestConsumeItemMaster__QuestConsumeItemEntity__int__GetEntity__);
    sub_B52984(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_42B01BD = 1;
  }
  if ( this->fields.mIsPhaseDetailed || (PhaseDetail = QuestEntity__GetPhaseDetail(this, method)) == 0LL )
  ...
  if ( !Instance
    || (Instance = (DataManager_o *)DataManager__GetMasterData_WarQuestSelectionMaster_(
                                      Instance,
                                      (const MethodInfo_1A4F184 *)Method_DataManager_GetMasterData_QuestConsumeItemMaster___)) == 0LL )
  {
  ...
  return (QuestConsumeItemEntity_o *)DataMasterBase_WarMaster__WarEntity__int___GetEntity(
                                       (DataMasterBase_WarMaster__WarEntity__int__o *)Instance,
                                       this->fields.id,
                                       (const MethodInfo_23E22D8 *)Method_DataMasterBase_QuestConsumeItemMaster__QuestConsumeItemEntity__int__GetEntity__);
}
...
System_String_o *__fastcall QuestEntity__getRecommendLv_25291404(
        QuestEntity_o *this,
        int32_t phaseCnt,
        const MethodInfo *method)
{
  ...
  PhaseDetail_25288480 = QuestEntity__GetPhaseDetail_25288480(this, phaseCnt, method);
  if ( !PhaseDetail_25288480
    || (p_recommendLv = &PhaseDetail_25288480->fields.recommendLv,
        System_String__IsNullOrEmpty(PhaseDetail_25288480->fields.recommendLv, 0LL)) )
  {
...
int32_t __fastcall QuestEntity__getSpotId(QuestEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B01B1 & 1) == 0 )
  {
    sub_B52984(&Method_DataManager_GetMasterData_QuestSpotReleaseMaster___);
    sub_B52984(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_42B01B1 = 1;
  }
  Instance = (DataManager_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance
    || (Instance = (DataManager_o *)DataManager__GetMasterData_WarQuestSelectionMaster_(
                                      Instance,
                                      (const MethodInfo_1A4F184 *)Method_DataManager_GetMasterData_QuestSpotReleaseMaster___)) == 0LL )
  {
    sub_B52A5C(Instance, v4);
  }
...
int32_t __fastcall QuestEntity__getSpotId_25289156(QuestEntity_o *this, int32_t phase, const MethodInfo *method)
{
  DataManager_o *Instance; // x0
  __int64 v6; // x1
  int32_t result; // w0
  ...
  Instance = (DataManager_o *)DataManager__GetMasterData_WarQuestSelectionMaster_(
                                Instance,
                                (const MethodInfo_1A4F184 *)Method_DataManager_GetMasterData_QuestSpotReleaseMaster___);
  if ( !Instance )
    goto LABEL_14;
  result = QuestSpotReleaseMaster__GetSpotId((QuestSpotReleaseMaster_o *)Instance, this->fields.id, 0LL);
  if ( result )
