...
void QuestEntity___ctor_42463796(QuestEntity_o *this, QuestEntity_o *cSrc, const MethodInfo *method)
{
  __int64 v5; // x0
  int32_t v6; // w2
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.nameRuby, (int32_t)nameRuby, v10, v11);
  ...
  *(_OWORD *)&this->fields.charaIconId = *(_OWORD *)&cSrc->fields.charaIconId;
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.beforeActionVals, (int32_t)beforeActionVals, v13, v14);
  afterActionVals = cSrc->fields.afterActionVals;
  this->fields.afterActionVals = afterActionVals;
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.afterActionVals, (int32_t)afterActionVals, v16, v17);
  *(_OWORD *)&this->fields.displayHours = *(_OWORD *)&cSrc->fields.displayHours;
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.chapterSubStr, (int32_t)chapterSubStr, v19, v20);
  recommendLv = cSrc->fields.recommendLv;
  this->fields.recommendLv = recommendLv;
  p_recommendLv = &this->fields.recommendLv;
  sub_1C36FFC((CGThumbnailListItem_o *)p_recommendLv, (int32_t)recommendLv, v23, v24);
...
System_String_o *QuestEntity__GetBgmName(QuestEntity_o *this, int32_t warId, const MethodInfo *method)
{
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  v9 = DataManager__GetMaster_object_((const MethodInfo_30E7C04 *)Method_DataManager_GetMaster_SpotMaster___);
...
LABEL_16:
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  SpotId = (MapMaster_o *)DataManager__GetMaster_object_((const MethodInfo_30E7C04 *)Method_DataManager_GetMaster_MapMaster___);
  if ( !SpotId )
    goto LABEL_23;
        ...
        const MethodInfo *method)
{
  ...
  v16 = (System_Collections_Generic_List_object__o *)sub_1C372A4(System_Collections_Generic_List_EventCampaignEntity__TypeInfo);
...
System_String_o *QuestEntity__GetChapterSubTitle(QuestEntity_o *this, int32_t warId, const MethodInfo *method)
{
  ...
  if ( (byte_4C435BA & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_3338/*"CHAPTER_F_START_ID"*/);
    byte_4C435BA = 1;
  }
...
System_String_o *QuestEntity__GetCostValueColor(int32_t costCalcVal, bool isOverCost, const MethodInfo *method)
{
  ...
  if ( (byte_4C435C4 & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_9755/*"OVER_COST_COLOR"*/);
    sub_1C37058(&StringLiteral_3277/*"CAMPAIGN_COST_COLOR"*/);
    byte_4C435C4 = 1;
  }
  if ( costCalcVal < 1 )
  {
    result = (System_String_o *)StringLiteral_25101/*"{0}"*/;
    if ( !isOverCost )
      return result;
    goto LABEL_7;
  }
...
QuestPhaseDetailEntity_o *QuestEntity__GetPhaseDetail(QuestEntity_o *this, const MethodInfo *method)
{
  ...
  {
    v6 = 1;
    return QuestEntity__GetPhaseDetail_42464740(this, v6, v5);
  }
...
LABEL_19:
  ...
  if ( ConstantMaster__IsEnableFixGetQuestPhaseDetail(0) )
  {
    ...
    v6 = System_Math__Min_65085416(v6, MaxPhase, 0);
  }
  return QuestEntity__GetPhaseDetail_42464740(this, v6, v5);
}


QuestPhaseDetailEntity_o *QuestEntity__GetPhaseDetail_42464740(
        QuestEntity_o *this,
        int32_t phaseCnt,
        const MethodInfo *method)
{
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_30E7C58 *)Method_DataManager_GetMasterData_QuestPhaseDetailMaster___)) == 0 )
  {
    sub_1C372B4(Instance);
  }
...
QuestEntity_o *QuestEntity__GetPhaseDetailedEntity(QuestEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C435AF & 1) == 0 )
  {
    sub_1C37058(&QuestEntity_TypeInfo);
    byte_4C435AF = 1;
  }
  ...
  {
    v4 = PhaseDetail;
    v5 = (QuestEntity_o *)sub_1C372A4(QuestEntity_TypeInfo);
    QuestEntity___ctor_42463796(v5, this, v6);
    if ( !v5 )
      sub_1C372B4(v7);
    this = v5;
...
int64_t QuestEntity__GetRestTime(QuestEntity_o *this, bool is_itvl, const MethodInfo *method)
{
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_30E7C58 *)Method_DataManager_GetMasterData_QuestAddMaster___)) == 0 )
  {
    sub_1C372B4(Instance);
  }
...
bool QuestEntity__HasFlag_42469280(QuestEntity_o *this, int64_t flag, int32_t phaseCnt, const MethodInfo *method)
{
  int64_t *p_flag; // x8
  QuestPhaseDetailEntity_o *PhaseDetail_42464740; // x0

  if ( this->fields.mIsPhaseDetailed
    || (PhaseDetail_42464740 = QuestEntity__GetPhaseDetail_42464740(this, phaseCnt, *(const MethodInfo **)&phaseCnt)) == 0 )
  {
    p_flag = &this->fields.flag;
  }
  else
  {
    p_flag = &PhaseDetail_42464740->fields.flag;
  }
  return (*p_flag & flag) != 0;
}
        ...
        const MethodInfo *method)
{
  ...
  PhaseDetail_42464740 = QuestEntity__GetPhaseDetail_42464740(this, phaseCnt, *(const MethodInfo **)&phaseCnt);
  if ( PhaseDetail_42464740 )
    LOBYTE(PhaseDetail_42464740) = (PhaseDetail_42464740->fields.flag & flag) != 0;
  return (char)PhaseDetail_42464740;
}
...
bool QuestEntity__IsActiveRecollectionQuest(QuestEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C435C5 & 1) == 0 )
  {
    sub_1C37058(&Method_DataManager_GetMaster_WarQuestSelectionMaster___);
    sub_1C37058(&DataManager_TypeInfo);
    byte_4C435C5 = 1;
  }
  if ( this->fields.mIsPhaseDetailed || (PhaseDetail = QuestEntity__GetPhaseDetail(this, method)) == 0 )
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_30E7C04 *)Method_DataManager_GetMaster_WarQuestSelectionMaster___);
  if ( !Master_object )
    sub_1C372B4(0);
...
System_String_o *QuestEntity__getChapterSubStr(QuestEntity_o *this, int32_t warId, const MethodInfo *method)
{
  ...
  if ( (byte_4C435B9 & 1) == 0 )
  {
    ...
    sub_1C37058(&LocalizationManager_TypeInfo);
    sub_1C37058(&StringLiteral_8584/*"MATERIAL_MAP_CHAPTER_SUB_{0:D2}"*/);
    sub_1C37058(&StringLiteral_8583/*"MATERIAL_MAP_CHAPTER_SUB"*/);
    byte_4C435B9 = 1;
  }
  entity = 0;
  if ( !System_String__IsNullOrEmpty(this->fields.chapterSubStr, 0) )
    return this->fields.chapterSubStr;
  PhaseDetail_42464740 = QuestEntity__GetPhaseDetail_42464740(this, 1, v5);
  if ( PhaseDetail_42464740 )
  {
    if ( (PhaseDetail_42464740->fields.flag & 0x2000000000000000LL) != 0 )
      return this->fields.chapterSubStr;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    ...
    || entity && WarEntity__IsChapterSubIdJapaneseNumeralsNormal((WarEntity_o *)entity, 0) )
  {
    if ( QuestBoardSectionId )
    {
      ...
      v20 = System_String__Format((System_String_o *)StringLiteral_8584/*"MATERIAL_MAP_CHAPTER_SUB_{0:D2}"*/, v19, 0);
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v21 = v20;
    }
    else
    {
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v21 = (System_String_o *)StringLiteral_8583/*"MATERIAL_MAP_CHAPTER_SUB"*/;
    }
  ...
  else
  {
    if ( QuestBoardSectionId )
    {
      ...
      v23 = System_String__Format((System_String_o *)StringLiteral_8584/*"MATERIAL_MAP_CHAPTER_SUB_{0:D2}"*/, v22, 0);
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v24 = v23;
    }
    else
    {
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v24 = (System_String_o *)StringLiteral_8583/*"MATERIAL_MAP_CHAPTER_SUB"*/;
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C435BF & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_DataMasterBase_QuestConsumeItemMaster__QuestConsumeItemEntity__int__GetEntity__);
    sub_1C37058(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4C435BF = 1;
  }
  if ( this->fields.mIsPhaseDetailed
  ...
  result = (QuestConsumeItemEntity_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39ED16C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !result )
    goto LABEL_20;
  ...
  result = (QuestConsumeItemEntity_o *)DataMasterBase_object__object__int___GetEntity(
                                         ...
                                         this->fields.id,
                                         (const MethodInfo_33A10A0 *)Method_DataMasterBase_QuestConsumeItemMaster__QuestConsumeItemEntity__int__GetEntity__);
  if ( isNotItemConsume )
  {
    if ( result )
...
System_String_o *QuestEntity__getRecommendLv_42468408(QuestEntity_o *this, int32_t phaseCnt, const MethodInfo *method)
{
  QuestPhaseDetailEntity_o *PhaseDetail_42464740; // x0
  System_String_o **p_recommendLv; // x19

  PhaseDetail_42464740 = QuestEntity__GetPhaseDetail_42464740(this, phaseCnt, method);
  if ( !PhaseDetail_42464740
    || (p_recommendLv = &PhaseDetail_42464740->fields.recommendLv,
        System_String__IsNullOrEmpty(PhaseDetail_42464740->fields.recommendLv, 0)) )
  {
    p_recommendLv = &this->fields.recommendLv;
  }
...
int32_t QuestEntity__getSpotId(QuestEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C435B4 & 1) == 0 )
  {
    sub_1C37058(&Method_DataManager_GetMasterData_QuestSpotReleaseMaster___);
    sub_1C37058(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4C435B4 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39ED16C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_30E7C58 *)Method_DataManager_GetMasterData_QuestSpotReleaseMaster___)) == 0 )
  {
    sub_1C372B4(Instance);
  }
...
int32_t QuestEntity__getSpotId_42466504(QuestEntity_o *this, int32_t phase, const MethodInfo *method)
{
  Il2CppObject *Instance; // x0
  const MethodInfo *v6; // x2
  int32_t result; // w0
  ...
  Instance = DataManager__GetMasterData_object_(
               (DataManager_o *)Instance,
               (const MethodInfo_30E7C58 *)Method_DataManager_GetMasterData_QuestSpotReleaseMaster___);
  if ( !Instance )
    goto LABEL_14;
