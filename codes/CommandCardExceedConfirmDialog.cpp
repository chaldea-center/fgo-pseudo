        ...
        const MethodInfo *method)
{
  ...
  if ( onRequest )
  {
    ...
    sub_1C2E0D0(p_onRequest, 0LL, (int64_t)method, v3, v4, v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C01159 & 1) == 0 )
  {
    this = (CommandCardExceedConfirmDialog_o *)sub_1C2E12C(&BattleCommandData_TypeInfo, previousCard);
    byte_4C01159 = 1;
  }
  if ( !previousCard
    || (CombineCommandCardComponent__DispCommandCard(
          ...
          0,
          0LL),
        v11 = (BattleCommandData_o *)sub_1C2E378(BattleCommandData_TypeInfo),
        BattleCommandData___ctor_44763472(v11, data, 0LL),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C01153 & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_3749/*"COMMAND_CARD_EXCEED_CONFIRM_DIALOG_WARNING_QP"*/, isOk);
    sub_1C2E12C(&StringLiteral_3744/*"COMMAND_CARD_EXCEED_CONFIRM_DIALOG_MESSAGE_OK"*/, v4);
    byte_4C01153 = 1;
  }
  if ( isOk )
    v5 = (System_String_o **)&StringLiteral_3744/*"COMMAND_CARD_EXCEED_CONFIRM_DIALOG_MESSAGE_OK"*/;
  else
    v5 = (System_String_o **)&StringLiteral_3749/*"COMMAND_CARD_EXCEED_CONFIRM_DIALOG_WARNING_QP"*/;
  return *v5;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C01152 & 1) == 0 )
  {
    sub_1C2E12C(&LocalizationManager_TypeInfo, *(_QWORD *)&requiredQp);
    sub_1C2E12C(&StringLiteral_3746/*"COMMAND_CARD_EXCEED_CONFIRM_DIALOG_REQUIRED_QP_WARNING"*/, v6);
    byte_4C01152 = 1;
  }
  ...
  v8 = LocalizationManager__Get((System_String_o *)StringLiteral_3746/*"COMMAND_CARD_EXCEED_CONFIRM_DIALOG_REQUIRED_QP_WARNING"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C01155 & 1) == 0 )
  {
    sub_1C2E12C(&Method_CommandCardExceedConfirmDialog_OnClickCancel__, method);
    byte_4C01155 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_CommandCardExceedConfirmDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2E144(Method_CommandCardExceedConfirmDialog_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C01154 & 1) == 0 )
  {
    sub_1C2E12C(&Method_CommandCardExceedConfirmDialog_OnClickDecide__, method);
    byte_4C01154 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_CommandCardExceedConfirmDialog_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2E144(Method_CommandCardExceedConfirmDialog_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C2E110(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C0114F & 1) == 0 )
  {
    sub_1C2E12C(&System_Action_TypeInfo, userServantCommandCardEntity);
    sub_1C2E12C(&BalanceConfig_TypeInfo, v15);
    sub_1C2E12C(&EventDelegate_Callback_TypeInfo, v16);
    sub_1C2E12C(&Method_CommandCardExceedConfirmDialog_EndOpen__, v17);
    sub_1C2E12C(&Method_CommandCardExceedConfirmDialog_OnClickCancel__, v18);
    sub_1C2E12C(&Method_CommandCardExceedConfirmDialog_OnClickDecide__, v19);
    sub_1C2E12C(&Method_CommandCardExceedConfirmDialog_OnSliderValueChange__, v20);
    sub_1C2E12C(&Method_DataManager_GetMasterData_CommandCardRankParamMaster___, v21);
    sub_1C2E12C(&Method_DataManager_GetMasterData_ItemMaster___, v22);
    sub_1C2E12C(&Method_DataMasterBase_ItemMaster__ItemEntity__int__GetEntity__, v23);
    sub_1C2E12C(&EventDelegate_TypeInfo, v24);
  ...
  sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.onRequest, (int64_t)onRequest, v27, v28, v29, v30, v31, v32);
  ...
  MasterData_object = DataManager__GetMasterData_object_(
                        (DataManager_o *)Instance,
                        (const MethodInfo_2FD1830 *)Method_DataManager_GetMasterData_CommandCardRankParamMaster___);
  ...
  v75 = (EventDelegate_Callback_o *)sub_1C2E378(EventDelegate_Callback_TypeInfo);
  ...
  Instance = EventDelegate__Set_48083504(onChange, v75, 0LL);
  decideButton = this->fields.decideButton;
  if ( !decideButton
    || (onClick = decideButton->fields.onClick,
        v78 = (EventDelegate_Callback_o *)sub_1C2E378(EventDelegate_Callback_TypeInfo),
        EventDelegate_Callback___ctor(
          v78,
          (Il2CppObject *)this,
          (intptr_t)Method_CommandCardExceedConfirmDialog_OnClickDecide__,
          0LL),
        Instance = EventDelegate__Set_48083504(onClick, v78, 0LL),
...
LABEL_22:
  ...
  v81 = (EventDelegate_Callback_o *)sub_1C2E378(EventDelegate_Callback_TypeInfo);
  EventDelegate_Callback___ctor(
    v81,
    (Il2CppObject *)this,
    (intptr_t)Method_CommandCardExceedConfirmDialog_OnClickCancel__,
    0LL);
  EventDelegate__Set_48083504(v80, v81, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( max_length < 2 )
  {
    if ( !max_length )
LABEL_16:
      sub_1C2E390(this, *(_QWORD *)&itemUseCount);
...
LABEL_14:
    sub_1C2E388(this, *(_QWORD *)&itemUseCount);
  v9 = 4LL;
  while ( 1 )
  {
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C2E388(sliderWithButton, *(_QWORD *)&itemUsableCount);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C01150 & 1) == 0 )
  {
    sub_1C2E12C(&LocalizationManager_TypeInfo, *(_QWORD *)&itemUsableCount);
    sub_1C2E12C(&StringLiteral_3748/*"COMMAND_CARD_EXCEED_CONFIRM_DIALOG_USE_ITEM"*/, v5);
    sub_1C2E12C(&StringLiteral_3750/*"COMMAND_CARD_EXCEED_CONFIRM_DIRLOG_MULTI_DESCRIPTION"*/, v6);
    sub_1C2E12C(&StringLiteral_3739/*"COMMAND_CARD_EXCEED_CONFIRM_DIALOG_CANCEL_BUTTON"*/, v7);
    sub_1C2E12C(&StringLiteral_3751/*"COMMAND_CARD_EXCEED_CONFIRM_DIRLOG_TITLE"*/, v8);
    sub_1C2E12C(&StringLiteral_3740/*"COMMAND_CARD_EXCEED_CONFIRM_DIALOG_DECIDE_BUTTON"*/, v9);
    byte_4C01150 = 1;
  }
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_3751/*"COMMAND_CARD_EXCEED_CONFIRM_DIRLOG_TITLE"*/, 0LL);
  if ( !titleLabel )
    goto LABEL_20;
  UILabel__set_text(titleLabel, gameObject, 0LL);
  descriptionLabel = this->fields.descriptionLabel;
  gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_3750/*"COMMAND_CARD_EXCEED_CONFIRM_DIRLOG_MULTI_DESCRIPTION"*/, 0LL);
  if ( !descriptionLabel )
    goto LABEL_20;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_3748/*"COMMAND_CARD_EXCEED_CONFIRM_DIALOG_USE_ITEM"*/, 0LL);
  exceedItemEntity = this->fields.exceedItemEntity;
  if ( !exceedItemEntity
...
LABEL_15:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_3740/*"COMMAND_CARD_EXCEED_CONFIRM_DIALOG_DECIDE_BUTTON"*/, 0LL);
  if ( !decideButtonLabel )
    goto LABEL_20;
  UILabel__set_text(decideButtonLabel, gameObject, 0LL);
  cancelButtonLabel = this->fields.cancelButtonLabel;
  gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_3739/*"COMMAND_CARD_EXCEED_CONFIRM_DIALOG_CANCEL_BUTTON"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C01151 & 1) == 0 )
  {
    sub_1C2E12C(&int_TypeInfo, *(_QWORD *)&itemUseCount);
    sub_1C2E12C(&LocalizationManager_TypeInfo, v5);
    sub_1C2E12C(&StringLiteral_3741/*"COMMAND_CARD_EXCEED_CONFIRM_DIALOG_EXCEED_AFTER"*/, v6);
    sub_1C2E12C(&StringLiteral_3745/*"COMMAND_CARD_EXCEED_CONFIRM_DIALOG_REQUIRED_QP"*/, v7);
    sub_1C2E12C(&StringLiteral_3743/*"COMMAND_CARD_EXCEED_CONFIRM_DIALOG_ITEM_COUNT"*/, v8);
    sub_1C2E12C(&StringLiteral_3747/*"COMMAND_CARD_EXCEED_CONFIRM_DIALOG_USER_QP"*/, v9);
    this = (CommandCardExceedConfirmDialog_o *)sub_1C2E12C(&StringLiteral_3742/*"COMMAND_CARD_EXCEED_CONFIRM_DIALOG_EXCEED_PREVIOUS"*/, v10);
    byte_4C01151 = 1;
  }
  ...
  if ( (int)previousCommandDataList->max_length < 2 )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v13 = LocalizationManager__Get((System_String_o *)StringLiteral_3742/*"COMMAND_CARD_EXCEED_CONFIRM_DIALOG_EXCEED_PREVIOUS"*/, 0LL);
    ...
    this = (CommandCardExceedConfirmDialog_o *)System_String__Format_63249956(v13, NumberFormat, v15, 0LL);
...
LABEL_28:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v18 = LocalizationManager__Get((System_String_o *)StringLiteral_3742/*"COMMAND_CARD_EXCEED_CONFIRM_DIALOG_EXCEED_PREVIOUS"*/, 0LL);
  ...
  this = (CommandCardExceedConfirmDialog_o *)System_String__Format_63249956(v18, v19, v20, 0LL);
...
LABEL_13:
  this = (CommandCardExceedConfirmDialog_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3741/*"COMMAND_CARD_EXCEED_CONFIRM_DIALOG_EXCEED_AFTER"*/, 0LL);
  ...
  this = (CommandCardExceedConfirmDialog_o *)System_String__Format_63249956((System_String_o *)v22, v23, v24, 0LL);
  if ( !afterStatusLabel )
    goto LABEL_28;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v26 = LocalizationManager__Get((System_String_o *)StringLiteral_3743/*"COMMAND_CARD_EXCEED_CONFIRM_DIALOG_ITEM_COUNT"*/, 0LL);
  v45 = itemUseCount;
  ...
  v34 = RequiredQp;
  this = (CommandCardExceedConfirmDialog_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3745/*"COMMAND_CARD_EXCEED_CONFIRM_DIALOG_REQUIRED_QP"*/, 0LL);
  if ( !requiredQpLabel )
    goto LABEL_28;
  ...
  this = (CommandCardExceedConfirmDialog_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3747/*"COMMAND_CARD_EXCEED_CONFIRM_DIALOG_USER_QP"*/, 0LL);
  if ( !userQpLabel )
    goto LABEL_28;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C01158 & 1) == 0 )
  {
    this = (CommandCardExceedConfirmDialog_o *)sub_1C2E12C(&UnityEngine_Object_TypeInfo, method);
    byte_4C01158 = 1;
  }
