...
bool CommandSpellEntity__checkHideInDetailWindow(CommandSpellEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D307E7 & 1) == 0 )
  {
    sub_1C93AD4(&StringLiteral_7377/*"HideInDetailWindow"*/);
    byte_4D307E7 = 1;
  }
  param = 0;
  CommandSpellEntity__checkScript(this, (System_String_o *)StringLiteral_7377/*"HideInDetailWindow"*/, &param, v2);
  return param > 0;
}
...
System_Int32_array_array *CommandSpellEntity__getValues(CommandSpellEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D307E3 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_CommandSpellEntity___c__getValues_b__13_0__);
    sub_1C93AD4(&CommandSpellEntity___c_TypeInfo);
  ...
  if ( !svals )
  {
    v7 = sub_1C93B7C(int_____TypeInfo, 1);
    v4 = (System_String_o *)sub_1C93B7C(int___TypeInfo, 5);
    if ( v7 )
    {
      if ( !*(_DWORD *)(v7 + 24) )
LABEL_26:
        sub_1C93D34(v4);
      *(_QWORD *)(v7 + 32) = v4;
      sub_1C93A78((GrandQuestFolderBoardItem_o *)(v7 + 32), (int32_t)v4, v29, v30, v31, v32, v33, v34);
      return (System_Int32_array_array *)v7;
    }
LABEL_25:
    sub_1C93D2C(v4, v5);
  }
  v4 = (System_String_o *)sub_1C93B7C(int_____TypeInfo, LODWORD(svals->max_length));
  v6 = this->fields.svals;
  if ( !v6 )
    goto LABEL_25;
  v7 = (__int64)v4;
      ...
      if ( v4 )
      {
        ...
        if ( v4 )
        {
          ...
          if ( !_9__13_0 )
          {
            ...
            _9__13_0 = (System_Converter_object__int__o *)sub_1C93D20(System_Converter_string__int__TypeInfo);
...
void CommandSpellEntity___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C93D20(CommandSpellEntity___c_TypeInfo);
