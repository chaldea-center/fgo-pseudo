...
bool __fastcall CommandSpellEntity__checkHideInDetailWindow(CommandSpellEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB44DE & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_7409/*"Hidden/UIElements/EditorUIE"*/, method);
    byte_4BB44DE = 1;
  }
  param = 0;
  CommandSpellEntity__checkScript(this, (System_String_o *)StringLiteral_7409/*"Hidden/UIElements/EditorUIE"*/, &param, v2);
  return param > 0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB44DA & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_CommandSpellEntity___c__getValues_b__13_0__, v6);
    sub_1C13D24(&CommandSpellEntity___c_TypeInfo, v7);
  ...
  if ( !svals )
  {
    v15 = sub_1C13DCC(int_____TypeInfo, 1LL);
    v12 = (System_String_o *)sub_1C13DCC(int___TypeInfo, 5LL);
    if ( v15 )
    {
      if ( !*(_DWORD *)(v15 + 24) )
LABEL_26:
        sub_1C13F88(v12, v13);
      *(_QWORD *)(v15 + 32) = v12;
      sub_1C13CC8((PartyOrganizationUtility_o *)(v15 + 32), (int64_t)v12, v37, v38, v39, v40, v41, v42);
      return (System_Int32_array_array *)v15;
    }
LABEL_25:
    sub_1C13F80(v12, v13);
  }
  v12 = (System_String_o *)sub_1C13DCC(int_____TypeInfo, svals->max_length);
      ...
      if ( v12 )
      {
        ...
        if ( v12 )
        {
          ...
          if ( !_9__13_0 )
          {
            ...
            _9__13_0 = (System_Converter_object__int__o *)sub_1C13F70(System_Converter_string__int__TypeInfo);
          ...
          if ( v15 )
          {
            ...
            sub_1C13CC8(p_monitor, (int64_t)v12, v31, v32, v33, v34, v35, v36);
            v14 = this->fields.svals;
            ++v16;
...
void __fastcall CommandSpellEntity___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BB44E7 & 1) == 0 )
  {
    sub_1C13D24(&CommandSpellEntity___c_TypeInfo, v1);
    byte_4BB44E7 = 1;
  }
  v2 = (Il2CppObject *)sub_1C13F70(CommandSpellEntity___c_TypeInfo);
