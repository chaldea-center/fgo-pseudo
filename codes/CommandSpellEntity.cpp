...
bool CommandSpellEntity__checkHideInDetailWindow(CommandSpellEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C377B5 & 1) == 0 )
  {
    sub_1C32C20(&StringLiteral_7337/*"HideInDetailWindow"*/);
    byte_4C377B5 = 1;
  }
  param = 0;
  CommandSpellEntity__checkScript(this, (System_String_o *)StringLiteral_7337/*"HideInDetailWindow"*/, &param, v2);
  return param > 0;
}
...
System_Int32_array_array *CommandSpellEntity__getValues(CommandSpellEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C377B1 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_CommandSpellEntity___c__getValues_b__13_0__);
    sub_1C32C20(&CommandSpellEntity___c_TypeInfo);
  ...
  if ( !svals )
  {
    v6 = sub_1C32CC8(int_____TypeInfo, 1);
    v4 = (System_String_o *)sub_1C32CC8(int___TypeInfo, 5);
    if ( v6 )
    {
      if ( !*(_DWORD *)(v6 + 24) )
LABEL_26:
        sub_1C32E84(v4);
      *(_QWORD *)(v6 + 32) = v4;
      sub_1C32BC4((CGThumbnailListItem_o *)(v6 + 32), (int32_t)v4, v20, v21);
      return (System_Int32_array_array *)v6;
    }
LABEL_25:
    sub_1C32E7C(v4);
  }
  v4 = (System_String_o *)sub_1C32CC8(int_____TypeInfo, LODWORD(svals->max_length));
  v5 = this->fields.svals;
  if ( !v5 )
    goto LABEL_25;
  v6 = (__int64)v4;
      ...
      if ( v4 )
      {
        ...
        if ( v4 )
        {
          ...
          if ( !_9__13_0 )
          {
            ...
            _9__13_0 = (System_Converter_object__int__o *)sub_1C32E6C(System_Converter_string__int__TypeInfo);
...
void CommandSpellEntity___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C32E6C(CommandSpellEntity___c_TypeInfo);
  System_Object___ctor(v1, 0);
  CommandSpellEntity___c_TypeInfo->static_fields->__9 = (struct CommandSpellEntity___c_o *)v1;
  sub_1C32BC4((CGThumbnailListItem_o *)CommandSpellEntity___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
