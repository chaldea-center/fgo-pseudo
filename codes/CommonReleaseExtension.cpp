        ...
        const MethodInfo *method)
{
  ...
  v7 = sub_1BE4D18(CommonReleaseExtension_CommonReleaseCondOverwriterBeforeClearQuest_TypeInfo);
...
CommonReleaseMaster_o *__fastcall CommonReleaseExtension__get_master(const MethodInfo *method)
{
  ...
  if ( (byte_4B666B3 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_DataManager_GetMasterData_CommonReleaseMaster___, v1);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B666B5 & 1) == 0 )
  {
    this = (CommonReleaseExtension_CommonReleaseCondOverwriterBase_o *)sub_1BE4ACC(&CondType_TypeInfo, entity);
    byte_4B666B5 = 1;
  }
  if ( !entity )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B666B6 & 1) == 0 )
  {
    this = (CommonReleaseExtension_CommonReleaseCondOverwriterBeforeClearQuest_o *)sub_1BE4ACC(
                                                                                     &CondType_TypeInfo,
                                                                                     entity);
    byte_4B666B6 = 1;
  }
  ...
  if ( condType <= 36 )
  {
    if ( condType != 1 )
    {
      ...
      if ( !CondType_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
      IsQuestClear_38498148 = CondType__IsQuestClear_38498148(condId, beforeClearQuestId, isCheckResetFlag, 0LL);
      return !IsQuestClear_38498148;
    }
    ...
    if ( !CondType_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
    return CondType__IsQuestClear_38498148(v13, v14, v15, 0LL);
  }
  else
  {
    if ( condType != 46 )
...
LABEL_32:
      ...
      if ( !CondType_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
      IsQuestClear_38498148 = CondType__IsQuestPhaseClear_38555260(v21, condNum, v22, v23, 0LL);
      return !IsQuestClear_38498148;
    }
    ...
    if ( !CondType_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
    return CondType__IsQuestPhaseClear_38555260(v17, v16, v18, v19, 0LL);
  }
}