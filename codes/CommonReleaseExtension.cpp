        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AC4E1 & 1) == 0 )
  {
    sub_B52984(&CommonReleaseExtension_CommonReleaseCondOverwriterBeforeClearQuest_TypeInfo);
    byte_42AC4E1 = 1;
  }
  v7 = (CommonReleaseExtension_CommonReleaseCondOverwriterBeforeClearQuest_o *)sub_B52A54(CommonReleaseExtension_CommonReleaseCondOverwriterBeforeClearQuest_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AE284 & 1) == 0 )
  {
    this = (CommonReleaseExtension_CommonReleaseCondOverwriterBase_o *)sub_B52984(&CondType_TypeInfo);
    byte_42AE284 = 1;
  }
  if ( !entity )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AE285 & 1) == 0 )
  {
    this = (CommonReleaseExtension_CommonReleaseCondOverwriterBeforeClearQuest_o *)sub_B52984(&CondType_TypeInfo);
    byte_42AE285 = 1;
  }
  ...
  if ( condType <= 36 )
  {
    if ( condType != 1 )
    {
      ...
      if ( (BYTE3(CondType_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0 && !CondType_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
      IsQuestClear_25987760 = CondType__IsQuestClear_25987760(condId, beforeClearQuestId, isCheckResetFlag, 0LL);
      return !IsQuestClear_25987760;
    }
    ...
    if ( (BYTE3(CondType_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0 && !CondType_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
    return CondType__IsQuestClear_25987760(v13, v14, v15, 0LL);
  }
  else
  {
    if ( condType != 46 )
...
LABEL_36:
      ...
      if ( (BYTE3(CondType_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0 && !CondType_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
      IsQuestClear_25987760 = CondType__IsQuestPhaseClear_26043860(v21, condNum, v22, v23, 0LL);
      return !IsQuestClear_25987760;
    }
    ...
    if ( (BYTE3(CondType_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0 && !CondType_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
    return CondType__IsQuestPhaseClear_26043860(v17, v16, v18, v19, 0LL);
  }
}