        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDC043 & 1) == 0 )
  {
    sub_1C21E38(&CommonReleaseExtension_CommonReleaseCondOverwriterBeforeClearQuest_TypeInfo);
    byte_4BDC043 = 1;
  }
  v7 = sub_1C22084(CommonReleaseExtension_CommonReleaseCondOverwriterBeforeClearQuest_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDC044 & 1) == 0 )
  {
    this = (CommonReleaseExtension_CommonReleaseCondOverwriterBase_o *)sub_1C21E38(&CondType_TypeInfo);
    byte_4BDC044 = 1;
  }
  if ( !entity )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDC045 & 1) == 0 )
  {
    this = (CommonReleaseExtension_CommonReleaseCondOverwriterBeforeClearQuest_o *)sub_1C21E38(&CondType_TypeInfo);
    byte_4BDC045 = 1;
  }
  ...
  if ( condType <= 36 )
  {
    if ( condType != 1 )
    {
      ...
      if ( !CondType_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
      IsQuestClear_38834244 = CondType__IsQuestClear_38834244(condId, beforeClearQuestId, isCheckResetFlag, 0LL);
    ...
    if ( !CondType_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
    return CondType__IsQuestClear_38834244(v13, v14, v15, 0LL);
  }
  else
  {
    if ( condType != 46 )
...
LABEL_32:
      ...
      if ( !CondType_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
      IsQuestClear_38834244 = CondType__IsQuestPhaseClear_38891984(v21, condNum, v22, v23, 0LL);
      return !IsQuestClear_38834244;
    }
    ...
    if ( !CondType_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
    return CondType__IsQuestPhaseClear_38891984(v17, v16, v18, v19, 0LL);
  }
}