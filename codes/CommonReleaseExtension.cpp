        ...
        const MethodInfo *method)
{
  ...
  v7 = sub_1C2E378(CommonReleaseExtension_CommonReleaseCondOverwriterFirstOpenAfterQuestCleared_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v7 = sub_1C2E378(CommonReleaseExtension_CommonReleaseCondOverwriterBeforeClearQuest_TypeInfo);
  System_Object___ctor((Il2CppObject *)v7, 0LL);
...
CommonReleaseMaster_o *__fastcall CommonReleaseExtension__get_master(const MethodInfo *method)
{
  ...
  if ( (byte_4BFD247 & 1) == 0 )
  {
    sub_1C2E12C(&Method_DataManager_GetMasterData_CommonReleaseMaster___, v1);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFD24A & 1) == 0 )
  {
    this = (CommonReleaseExtension_CommonReleaseCondOverwriterBase_o *)sub_1C2E12C(&CondType_TypeInfo, entity);
    byte_4BFD24A = 1;
  }
  if ( !entity )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFD24B & 1) == 0 )
  {
    this = (CommonReleaseExtension_CommonReleaseCondOverwriterBeforeClearQuest_o *)sub_1C2E12C(
                                                                                     &CondType_TypeInfo,
                                                                                     entity);
    byte_4BFD24B = 1;
  }
  ...
  if ( condType <= 36 )
  {
    if ( condType != 1 )
    {
      ...
      if ( !CondType_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
      IsQuestClear_38902436 = CondType__IsQuestClear_38902436(condId, beforeClearQuestId, isCheckResetFlag, 0LL);
      return !IsQuestClear_38902436;
    }
    ...
    if ( !CondType_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
    return CondType__IsQuestClear_38902436(v13, v14, v15, 0LL);
  }
  else
  {
    if ( condType != 46 )
...
LABEL_32:
      ...
      if ( !CondType_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
      IsQuestClear_38902436 = CondType__IsQuestPhaseClear_38961020(v21, condNum, v22, v23, 0LL);
      return !IsQuestClear_38902436;
    }
    ...
    if ( !CondType_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
    return CondType__IsQuestPhaseClear_38961020(v17, v16, v18, v19, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFD24C & 1) == 0 )
  {
    this = (CommonReleaseExtension_CommonReleaseCondOverwriterFirstOpenAfterQuestCleared_o *)sub_1C2E12C(
                                                                                               &CondType_TypeInfo,
                                                                                               entity);
    byte_4BFD24C = 1;
  }
...
LABEL_19:
  ...
  if ( condType == 1 )
  {
    ...
    if ( !CondType_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
    IsQuestClear_38902436 = CondType__IsQuestClear_38902436(condId, -1, isCheckResetFlag, 0LL);
    if ( condId == asClearedQuestId )
    {
      v11 = !IsQuestClear_38902436;
      IsQuestClear_38902436 = 1;
