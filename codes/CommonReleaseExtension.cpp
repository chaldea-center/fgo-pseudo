        ...
        const MethodInfo *method)
{
  ...
  v7 = sub_1C3B9B0(CommonReleaseExtension_CommonReleaseCondOverwriterFirstOpenAfterQuestCleared_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v7 = sub_1C3B9B0(CommonReleaseExtension_CommonReleaseCondOverwriterBeforeClearQuest_TypeInfo);
  System_Object___ctor((Il2CppObject *)v7, 0LL);
...
CommonReleaseMaster_o *__fastcall CommonReleaseExtension__get_master(const MethodInfo *method)
{
  ...
  if ( (byte_4C21A56 & 1) == 0 )
  {
    sub_1C3B764(&Method_DataManager_GetMasterData_CommonReleaseMaster___, v1);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21A59 & 1) == 0 )
  {
    this = (CommonReleaseExtension_CommonReleaseCondOverwriterBase_o *)sub_1C3B764(&CondType_TypeInfo, entity);
    byte_4C21A59 = 1;
  }
  if ( !entity )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21A5A & 1) == 0 )
  {
    this = (CommonReleaseExtension_CommonReleaseCondOverwriterBeforeClearQuest_o *)sub_1C3B764(
                                                                                     &CondType_TypeInfo,
                                                                                     entity);
    byte_4C21A5A = 1;
  }
  ...
  if ( condType <= 36 )
  {
    if ( condType != 1 )
    {
      ...
      if ( !CondType_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
      IsQuestClear_39011304 = CondType__IsQuestClear_39011304(condId, beforeClearQuestId, isCheckResetFlag, 0LL);
    ...
    if ( !CondType_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
    return CondType__IsQuestClear_39011304(v13, v14, v15, 0LL);
  }
  else
  {
    if ( condType != 46 )
...
LABEL_32:
      ...
      if ( !CondType_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
      IsQuestClear_39011304 = CondType__IsQuestPhaseClear_39069888(v21, condNum, v22, v23, 0LL);
      return !IsQuestClear_39011304;
    }
    ...
    if ( !CondType_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
    return CondType__IsQuestPhaseClear_39069888(v17, v16, v18, v19, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21A5B & 1) == 0 )
  {
    this = (CommonReleaseExtension_CommonReleaseCondOverwriterFirstOpenAfterQuestCleared_o *)sub_1C3B764(
                                                                                               &CondType_TypeInfo,
                                                                                               entity);
    byte_4C21A5B = 1;
  }
...
LABEL_19:
  ...
  if ( condType == 1 )
  {
    ...
    if ( !CondType_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
    IsQuestClear_39011304 = CondType__IsQuestClear_39011304(condId, -1, isCheckResetFlag, 0LL);
    if ( condId == asClearedQuestId )
    {
      v11 = !IsQuestClear_39011304;
      IsQuestClear_39011304 = 1;
