        ...
        const MethodInfo *method)
{
  ...
  if ( !myRoomFsm
    || (PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_7101/*"GO_BATTLE"*/, 0LL),
        (myRoomFsm = (PlayMakerFSM_o *)this->fields.myRoomCtrl) == 0LL) )
  {
    sub_1C13F80(myRoomFsm, method);
  }
...
bool __fastcall MaterialCollectionComponent__closeMenu(MaterialCollectionComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BAFB54 & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_MaterialCollectionComponent_onClose__, v3);
    byte_4BAFB54 = 1;
  }
  ...
  if ( !materialCollectionMenu )
    sub_1C13F80(v6, v7);
  MaterialCollectionMenu__Close_32027576(materialCollectionMenu, v5, v8);
  return 1;
}
  ...
  if ( !materialCollectionMenu
    || (MaterialCollectionMenu__Init(materialCollectionMenu, method),
        (materialCollectionMenu = (MaterialCollectionMenu_o *)UnityEngine_Component__get_gameObject(
                                                                ...
                                                                0LL)) == 0LL) )
  {
    sub_1C13F80(materialCollectionMenu, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAFB53 & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_3634/*"CLOSE_FAVORITE_CHANGE"*/, method);
    byte_4BAFB53 = 1;
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    sub_1C13F80(0LL, method);
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_3634/*"CLOSE_FAVORITE_CHANGE"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAFB56 & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_3634/*"CLOSE_FAVORITE_CHANGE"*/, *(_QWORD *)&result);
    sub_1C13D24(&StringLiteral_3566/*"CLASS_BOARD_SQUARE_OPEN_CONFIRM_DIALOG_TITLE"*/, v5);
    byte_4BAFB56 = 1;
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    sub_1C13F80(0LL, *(_QWORD *)&result);
  v7 = &StringLiteral_3566/*"CLASS_BOARD_SQUARE_OPEN_CONFIRM_DIALOG_TITLE"*/;
  if ( result != 1 )
    v7 = &StringLiteral_3634/*"CLOSE_FAVORITE_CHANGE"*/;
...
bool __fastcall MaterialCollectionComponent__openMenu(MaterialCollectionComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C13D24(&System_Action_TypeInfo, method);
    sub_1C13D24(&MaterialCollectionMenu_CallbackFunc_TypeInfo, v3);
    sub_1C13D24(&Method_MaterialCollectionComponent__openMenu_b__5_0__, v4);
    sub_1C13D24(&Method_MaterialCollectionComponent_onEndMenu__, v5);
    byte_4BAFB52 = 1;
  }
  ...
  if ( !gameObject
    || (UnityEngine_GameObject__SetActive(gameObject, 1, 0LL),
        ...
        v10 = (MaterialCollectionMenu_CallbackFunc_o *)sub_1C13F70(MaterialCollectionMenu_CallbackFunc_TypeInfo),
