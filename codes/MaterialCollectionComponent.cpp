        ...
        const MethodInfo *method)
{
  ...
  if ( !myRoomFsm
    || (PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_7081/*"GO_NEXT"*/, 0LL),
        (myRoomFsm = (PlayMakerFSM_o *)this->fields.myRoomCtrl) == 0LL) )
  {
    sub_1BE4D28(myRoomFsm, method);
  }
...
bool __fastcall MaterialCollectionComponent__closeMenu(MaterialCollectionComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B62065 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_MaterialCollectionComponent_onClose__, v3);
    byte_4B62065 = 1;
  }
  ...
  if ( !materialCollectionMenu )
    sub_1BE4D28(v6, v7);
  MaterialCollectionMenu__Close_31842548(materialCollectionMenu, v5, v8);
  return 1;
}
  ...
  if ( !materialCollectionMenu
    || (MaterialCollectionMenu__Init(materialCollectionMenu, method),
        (materialCollectionMenu = (MaterialCollectionMenu_o *)UnityEngine_Component__get_gameObject(
                                                                ...
                                                                0LL)) == 0LL) )
  {
    sub_1BE4D28(materialCollectionMenu, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62064 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_3631/*"CLOSE_MATERIAL"*/, method);
    byte_4B62064 = 1;
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    sub_1BE4D28(0LL, method);
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_3631/*"CLOSE_MATERIAL"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62067 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_3631/*"CLOSE_MATERIAL"*/, *(_QWORD *)&result);
    sub_1BE4ACC(&StringLiteral_3563/*"CLICK_BACK"*/, v5);
    byte_4B62067 = 1;
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    sub_1BE4D28(0LL, *(_QWORD *)&result);
  v7 = &StringLiteral_3563/*"CLICK_BACK"*/;
  if ( result != 1 )
    v7 = &StringLiteral_3631/*"CLOSE_MATERIAL"*/;
...
bool __fastcall MaterialCollectionComponent__openMenu(MaterialCollectionComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BE4ACC(&System_Action_TypeInfo, method);
    sub_1BE4ACC(&MaterialCollectionMenu_CallbackFunc_TypeInfo, v3);
    sub_1BE4ACC(&Method_MaterialCollectionComponent__openMenu_b__5_0__, v4);
    sub_1BE4ACC(&Method_MaterialCollectionComponent_onEndMenu__, v5);
    byte_4B62063 = 1;
  }
  ...
  if ( !gameObject
    || (UnityEngine_GameObject__SetActive(gameObject, 1, 0LL),
        ...
        v10 = (MaterialCollectionMenu_CallbackFunc_o *)sub_1BE4D18(MaterialCollectionMenu_CallbackFunc_TypeInfo),
