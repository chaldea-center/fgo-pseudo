...
bool __fastcall MaterialCollectionComponent__closeMenu(MaterialCollectionComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49B61C6 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_MaterialCollectionComponent_onClose__, v3);
    byte_49B61C6 = 1;
  }
  ...
  if ( !materialCollectionMenu )
    sub_1B4D1EC(v6, v7);
  MaterialCollectionMenu__Close_31277304(materialCollectionMenu, v5, v8);
  return 1;
}
  ...
  if ( !materialCollectionMenu
    || (MaterialCollectionMenu__Init(materialCollectionMenu, method),
        (materialCollectionMenu = (MaterialCollectionMenu_o *)UnityEngine_Component__get_gameObject(
                                                                ...
                                                                0LL)) == 0LL) )
  {
    sub_1B4D1EC(materialCollectionMenu, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B61C5 & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_3490/*"CLOSE_MATERIAL"*/, method);
    byte_49B61C5 = 1;
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    sub_1B4D1EC(0LL, method);
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_3490/*"CLOSE_MATERIAL"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B61C8 & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_3490/*"CLOSE_MATERIAL"*/, *(_QWORD *)&result);
    sub_1B4CF90(&StringLiteral_3421/*"CLICK_BACK"*/, v5);
    byte_49B61C8 = 1;
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    sub_1B4D1EC(0LL, *(_QWORD *)&result);
  v7 = &StringLiteral_3421/*"CLICK_BACK"*/;
  if ( result != 1 )
    v7 = &StringLiteral_3490/*"CLOSE_MATERIAL"*/;
...
bool __fastcall MaterialCollectionComponent__openMenu(MaterialCollectionComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B4CF90(&System_Action_TypeInfo, method);
    sub_1B4CF90(&MaterialCollectionMenu_CallbackFunc_TypeInfo, v3);
    sub_1B4CF90(&Method_MaterialCollectionComponent__openMenu_b__5_0__, v4);
    sub_1B4CF90(&Method_MaterialCollectionComponent_onEndMenu__, v5);
    byte_49B61C4 = 1;
  }
  ...
  if ( !gameObject
    || (UnityEngine_GameObject__SetActive(gameObject, 1, 0LL),
        ...
        v10 = (MaterialCollectionMenu_CallbackFunc_o *)sub_1B4D1DC(MaterialCollectionMenu_CallbackFunc_TypeInfo),
