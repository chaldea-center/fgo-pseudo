...
bool MaterialCollectionComponent__closeMenu(MaterialCollectionComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C51E5D & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_MaterialCollectionComponent_onClose__);
    byte_4C51E5D = 1;
  }
  ...
  if ( !materialCollectionMenu )
    sub_1C3E7C0(v5, v6);
  MaterialCollectionMenu__Close_33286120(materialCollectionMenu, v4, v7);
  return 1;
}
  ...
  if ( !materialCollectionMenu
    || (MaterialCollectionMenu__Init(materialCollectionMenu, method),
        (materialCollectionMenu = (MaterialCollectionMenu_o *)UnityEngine_Component__get_gameObject(
                                                                ...
                                                                0)) == 0) )
  {
    sub_1C3E7C0(materialCollectionMenu, method);
  }
...
void MaterialCollectionComponent__onCloseWebView(MaterialCollectionComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C51E5C & 1) == 0 )
  {
    sub_1C3E564(&StringLiteral_3511/*"CLOSE_MATERIAL"*/);
    byte_4C51E5C = 1;
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
...
bool MaterialCollectionComponent__openMenu(MaterialCollectionComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C51E5B & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_MaterialCollectionComponent__openMenu_b__5_0__);
    sub_1C3E564(&Method_MaterialCollectionComponent_onEndMenu__);
    byte_4C51E5B = 1;
  }
  ...
  if ( !gameObject
    || (UnityEngine_GameObject__SetActive(gameObject, 1, 0),
        ...
        v7 = (MaterialCollectionMenu_CallbackFunc_o *)sub_1C3E7B0(MaterialCollectionMenu_CallbackFunc_TypeInfo),
