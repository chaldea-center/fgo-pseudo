...
bool __fastcall MaterialCollectionComponent__closeMenu(MaterialCollectionComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC2EFD & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_MaterialCollectionComponent_onClose__, v3);
    byte_4BC2EFD = 1;
  }
  ...
  if ( !materialCollectionMenu )
    sub_1C1AE30(v6, v7);
  MaterialCollectionMenu__Close_32056128(materialCollectionMenu, v5, v8);
  return 1;
}
  ...
  if ( !materialCollectionMenu
    || (MaterialCollectionMenu__Init(materialCollectionMenu, method),
        (materialCollectionMenu = (MaterialCollectionMenu_o *)UnityEngine_Component__get_gameObject(
                                                                ...
                                                                0LL)) == 0LL) )
  {
    sub_1C1AE30(materialCollectionMenu, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC2EFC & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_3637/*"CLOSE_MATERIAL"*/, method);
    byte_4BC2EFC = 1;
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC2EFF & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_3637/*"CLOSE_MATERIAL"*/, *(_QWORD *)&result);
    sub_1C1ABD4(&StringLiteral_3569/*"CLICK_BACK"*/, v5);
    byte_4BC2EFF = 1;
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    sub_1C1AE30(0LL, *(_QWORD *)&result);
  v7 = &StringLiteral_3569/*"CLICK_BACK"*/;
  if ( result != 1 )
    v7 = &StringLiteral_3637/*"CLOSE_MATERIAL"*/;
...
bool __fastcall MaterialCollectionComponent__openMenu(MaterialCollectionComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C1ABD4(&System_Action_TypeInfo, method);
    sub_1C1ABD4(&MaterialCollectionMenu_CallbackFunc_TypeInfo, v3);
    sub_1C1ABD4(&Method_MaterialCollectionComponent__openMenu_b__5_0__, v4);
    sub_1C1ABD4(&Method_MaterialCollectionComponent_onEndMenu__, v5);
    byte_4BC2EFB = 1;
  }
  ...
  if ( !gameObject
    || (UnityEngine_GameObject__SetActive(gameObject, 1, 0LL),
        ...
        v10 = (MaterialCollectionMenu_CallbackFunc_o *)sub_1C1AE20(MaterialCollectionMenu_CallbackFunc_TypeInfo),
