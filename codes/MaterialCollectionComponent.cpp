...
bool __fastcall MaterialCollectionComponent__closeMenu(MaterialCollectionComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3FCAC & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_MaterialCollectionComponent_onClose__, v3);
    byte_4B3FCAC = 1;
  }
  ...
  if ( !materialCollectionMenu )
    sub_1BDBAD4(v6, v7);
  MaterialCollectionMenu__Close_32392696(materialCollectionMenu, v5, v8);
  return 1;
}
  ...
  if ( !materialCollectionMenu
    || (MaterialCollectionMenu__Init(materialCollectionMenu, method),
        (materialCollectionMenu = (MaterialCollectionMenu_o *)UnityEngine_Component__get_gameObject(
                                                                ...
                                                                0LL)) == 0LL) )
  {
    sub_1BDBAD4(materialCollectionMenu, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3FCAB & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_3543/*"CLOSE_MATERIAL"*/, method);
    byte_4B3FCAB = 1;
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    sub_1BDBAD4(0LL, method);
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_3543/*"CLOSE_MATERIAL"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3FCAE & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_3543/*"CLOSE_MATERIAL"*/, *(_QWORD *)&result);
    sub_1BDB878(&StringLiteral_3471/*"CLICK_BACK"*/, v5);
    byte_4B3FCAE = 1;
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    sub_1BDBAD4(0LL, *(_QWORD *)&result);
  v7 = &StringLiteral_3471/*"CLICK_BACK"*/;
  if ( result != 1 )
    v7 = &StringLiteral_3543/*"CLOSE_MATERIAL"*/;
...
bool __fastcall MaterialCollectionComponent__openMenu(MaterialCollectionComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&System_Action_TypeInfo, method);
    sub_1BDB878(&MaterialCollectionMenu_CallbackFunc_TypeInfo, v3);
    sub_1BDB878(&Method_MaterialCollectionComponent__openMenu_b__5_0__, v4);
    sub_1BDB878(&Method_MaterialCollectionComponent_onEndMenu__, v5);
    byte_4B3FCAA = 1;
  }
  ...
  if ( !gameObject
    || (UnityEngine_GameObject__SetActive(gameObject, 1, 0LL),
        ...
        v10 = (MaterialCollectionMenu_CallbackFunc_o *)sub_1BDBAC4(MaterialCollectionMenu_CallbackFunc_TypeInfo),
