...
bool __fastcall MaterialCollectionComponent__closeMenu(MaterialCollectionComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD797E & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_MaterialCollectionComponent_onClose__);
    byte_4BD797E = 1;
  }
  ...
  if ( !materialCollectionMenu )
    sub_1C22094(v5, v6);
  MaterialCollectionMenu__Close_32091056(materialCollectionMenu, v4, v7);
  return 1;
}
  ...
  if ( !materialCollectionMenu
    || (MaterialCollectionMenu__Init(materialCollectionMenu, method),
        (materialCollectionMenu = (MaterialCollectionMenu_o *)UnityEngine_Component__get_gameObject(
                                                                ...
                                                                0LL)) == 0LL) )
  {
    sub_1C22094(materialCollectionMenu, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    sub_1C22094(0LL, *(_QWORD *)&result);
  v6 = &StringLiteral_3578/*"CLICK_BACK"*/;
  if ( result != 1 )
    v6 = &StringLiteral_3646/*"CLOSE_MATERIAL"*/;
...
bool __fastcall MaterialCollectionComponent__openMenu(MaterialCollectionComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD797C & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_MaterialCollectionComponent__openMenu_b__5_0__);
    sub_1C21E38(&Method_MaterialCollectionComponent_onEndMenu__);
    byte_4BD797C = 1;
  }
  ...
  if ( !gameObject
    || (UnityEngine_GameObject__SetActive(gameObject, 1, 0LL),
        ...
        v7 = (MaterialCollectionMenu_CallbackFunc_o *)sub_1C22084(MaterialCollectionMenu_CallbackFunc_TypeInfo),
