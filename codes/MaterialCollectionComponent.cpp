...
bool MaterialCollectionComponent__closeMenu(MaterialCollectionComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2BA2E & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_MaterialCollectionComponent_onClose__);
    byte_4D2BA2E = 1;
  }
  ...
  if ( !materialCollectionMenu )
    sub_1C93D2C(v5, v6);
  MaterialCollectionMenu__Close_33851112(materialCollectionMenu, v4, v7);
  return 1;
}
  ...
  if ( !materialCollectionMenu
    || (MaterialCollectionMenu__Init(materialCollectionMenu, method),
        (materialCollectionMenu = (MaterialCollectionMenu_o *)UnityEngine_Component__get_gameObject(
                                                                ...
                                                                0)) == 0) )
  {
    sub_1C93D2C(materialCollectionMenu, method);
  }
...
void MaterialCollectionComponent__onCloseWebView(MaterialCollectionComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2BA2D & 1) == 0 )
  {
    sub_1C93AD4(&StringLiteral_3532/*"CLOSE_MATERIAL"*/);
    byte_4D2BA2D = 1;
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    sub_1C93D2C(0, method);
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_3532/*"CLOSE_MATERIAL"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  v6 = &StringLiteral_3457/*"CLICK_BACK"*/;
  if ( result != 1 )
    v6 = &StringLiteral_3532/*"CLOSE_MATERIAL"*/;
...
bool MaterialCollectionComponent__openMenu(MaterialCollectionComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2BA2C & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_MaterialCollectionComponent__openMenu_b__5_0__);
    sub_1C93AD4(&Method_MaterialCollectionComponent_onEndMenu__);
    byte_4D2BA2C = 1;
  }
  ...
  if ( !gameObject
    || (UnityEngine_GameObject__SetActive(gameObject, 1, 0),
        ...
        v7 = (MaterialCollectionMenu_CallbackFunc_o *)sub_1C93D20(MaterialCollectionMenu_CallbackFunc_TypeInfo),
