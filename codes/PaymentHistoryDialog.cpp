void PaymentHistoryDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E735DC & 1) == 0 )
  {
    sub_1D0F0B4(&PaymentHistoryDialog_TypeInfo);
    sub_1D0F0B4(&StringLiteral_408/*"#494949"*/);
    byte_4E735DC = 1;
  }
...
void PaymentHistoryDialog__OnClickClose(PaymentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E735DA & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_PaymentHistoryDialog_OnClickClose__);
    sub_1D0F0B4(&Method_PaymentHistoryDialog__OnClickClose_b__16_0__);
    byte_4E735DA = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( (*((_BYTE *)Method_PaymentHistoryDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1D0F0CC(Method_PaymentHistoryDialog_OnClickClose__);
...
void PaymentHistoryDialog__OnClickReflect(PaymentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E735D9 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_PaymentHistoryDialog_OnClickReflect__);
    sub_1D0F0B4(&Method_PaymentHistoryDialog__OnClickReflect_b__15_0__);
    sub_1D0F0B4(&PaymentHistoryDialog_TypeInfo);
  ...
  *(_QWORD *)&v13.fields.b = 0;
  ...
  if ( (*((_BYTE *)Method_PaymentHistoryDialog_OnClickReflect__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1D0F0CC(Method_PaymentHistoryDialog_OnClickReflect__);
  ...
  if ( canReflect )
  {
    ...
    if ( !reflectButtonColor )
LABEL_17:
      sub_1D0F30C(reflectButtonColor, v7);
...
void PaymentHistoryDialog__Open(PaymentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E735D6 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_10468/*"PAYMENT_HISTORY_REFLECT_MESSAGE"*/);
    sub_1D0F0B4(&StringLiteral_10466/*"PAYMENT_HISTORY_NODATA"*/);
    sub_1D0F0B4(&StringLiteral_3724/*"COMMON_CONFIRM_CLOSE"*/);
    sub_1D0F0B4(&StringLiteral_10467/*"PAYMENT_HISTORY_REFLECT_BUTTON"*/);
    sub_1D0F0B4(&StringLiteral_10472/*"PAYMENT_HISTORY_TITLE"*/);
    sub_1D0F0B4(&StringLiteral_10473/*"PAYMENT_HISTORY_UPPER_MESSAGE"*/);
    byte_4E735D6 = 1;
  }
  ...
  v3 = LocalizationManager__Get((System_String_o *)StringLiteral_10472/*"PAYMENT_HISTORY_TITLE"*/, 0);
  ...
  paymentHistoryListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_10473/*"PAYMENT_HISTORY_UPPER_MESSAGE"*/, 0);
  ...
  paymentHistoryListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_10468/*"PAYMENT_HISTORY_REFLECT_MESSAGE"*/, 0);
  ...
  if ( ListViewManager__get_ItemSum((ListViewManager_o *)paymentHistoryListViewManager, 0) <= 0 )
  {
    ...
    if ( paymentHistoryListViewManager )
    {
      ...
      if ( paymentHistoryListViewManager )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        paymentHistoryListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_10466/*"PAYMENT_HISTORY_NODATA"*/, 0);
        if ( messageLabel )
        {
...
LABEL_22:
    sub_1D0F30C(paymentHistoryListViewManager, v6);
  }
LABEL_16:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  paymentHistoryListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_3724/*"COMMON_CONFIRM_CLOSE"*/, 0);
  if ( !closeLabel )
    goto LABEL_22;
  UILabel__set_text(closeLabel, paymentHistoryListViewManager, 0);
  reflectButtonLabel = this->fields.reflectButtonLabel;
  paymentHistoryListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_10467/*"PAYMENT_HISTORY_REFLECT_BUTTON"*/, 0);
  if ( !reflectButtonLabel )
    goto LABEL_22;
  UILabel__set_text(reflectButtonLabel, paymentHistoryListViewManager, 0);
  this->fields.closeAction = 0;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.closeAction, 0, v11, v12, v13, v14, v15, v16);
  this->fields.decideAction = 0;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.decideAction, 0, v17, v18, v19, v20, v21, v22);
}
...
void PaymentHistoryDialog__ResetScrollView(PaymentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  messageLabel = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10466/*"PAYMENT_HISTORY_NODATA"*/, 0);
  if ( !v4 )
LABEL_17:
  ...
  *(_QWORD *)&color.fields.b = 0;
  ...
  else
  {
    ...
    if ( this->fields.reflectCheckTime != Time )
    {
      ...
      reflectButtonColor = (UIButtonColor_o *)System_String__Format((System_String_o *)StringLiteral_25624/*"{0}"*/, v9, 0);
...
LABEL_28:
        sub_1D0F30C(reflectButtonColor, v4);
      }
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E735D8 & 1) == 0 )
  {
    sub_1D0F0B4(&PaymentHistoryDialog__WaitExternalPayment_d__14_TypeInfo);
    byte_4E735D8 = 1;
  }
  v2 = sub_1D0F300(PaymentHistoryDialog__WaitExternalPayment_d__14_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E735E0 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_PaymentHistoryDialog___c__WaitExternalPayment_b__14_0__);
    sub_1D0F0B4(&PaymentHistoryDialog___c_TypeInfo);
  ...
  else
  {
    ...
    if ( !_9__14_0 )
    {
      ...
      _9__14_0 = (System_Func_bool__o *)sub_1D0F300(System_Func_bool__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1D0F0C8(&Method_PaymentHistoryDialog__WaitExternalPayment_d__14_System_Collections_IEnumerator_Reset__);
  sub_1D0F1DC(v3, v4);
}
...
void PaymentHistoryDialog___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1D0F300(PaymentHistoryDialog___c_TypeInfo);
