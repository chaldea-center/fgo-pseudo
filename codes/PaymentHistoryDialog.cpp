void __fastcall PaymentHistoryDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FA99E & 1) == 0 )
  {
    sub_1B64870(&PaymentHistoryDialog_TypeInfo, v1);
    sub_1B64870(&StringLiteral_441/*"#494949"*/, v4);
    byte_49FA99E = 1;
  }
...
void __fastcall PaymentHistoryDialog__OnClickClose(PaymentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA99C & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_PaymentHistoryDialog_OnClickClose__, v3);
    sub_1B64870(&Method_PaymentHistoryDialog__OnClickClose_b__16_0__, v4);
    byte_49FA99C = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( (*((_BYTE *)Method_PaymentHistoryDialog_OnClickClose__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B64888(Method_PaymentHistoryDialog_OnClickClose__);
...
void __fastcall PaymentHistoryDialog__OnClickReflect(PaymentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA99B & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_PaymentHistoryDialog_OnClickReflect__, v4);
    sub_1B64870(&Method_PaymentHistoryDialog__OnClickReflect_b__15_0__, v5);
    sub_1B64870(&PaymentHistoryDialog_TypeInfo, v6);
  ...
  *(_QWORD *)&v18.fields.b = 0LL;
  ...
  if ( (*((_BYTE *)Method_PaymentHistoryDialog_OnClickReflect__ + 83) & 2) != 0 )
    v8 = (_QWORD *)sub_1B64888(Method_PaymentHistoryDialog_OnClickReflect__);
  ...
  if ( canReflect )
  {
    ...
    if ( !reflectButtonColor )
LABEL_17:
      sub_1B64ACC(reflectButtonColor, v12);
...
void __fastcall PaymentHistoryDialog__Open(PaymentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA998 & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_10308/*"PAYMENT_HISTORY_REFLECT_MESSAGE"*/, v4);
    sub_1B64870(&StringLiteral_10306/*"PAYMENT_HISTORY_NODATA"*/, v5);
    sub_1B64870(&StringLiteral_3733/*"COMMON_CONFIRM_CLOSE"*/, v6);
    sub_1B64870(&StringLiteral_10307/*"PAYMENT_HISTORY_REFLECT_BUTTON"*/, v7);
    sub_1B64870(&StringLiteral_10312/*"PAYMENT_HISTORY_TITLE"*/, v8);
    sub_1B64870(&StringLiteral_10313/*"PAYMENT_HISTORY_UPPER_MESSAGE"*/, v9);
    byte_49FA998 = 1;
  }
  ...
  v10 = LocalizationManager__Get((System_String_o *)StringLiteral_10312/*"PAYMENT_HISTORY_TITLE"*/, 0LL);
  ...
  paymentHistoryListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_10313/*"PAYMENT_HISTORY_UPPER_MESSAGE"*/, 0LL);
  ...
  paymentHistoryListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_10308/*"PAYMENT_HISTORY_REFLECT_MESSAGE"*/, 0LL);
  ...
  if ( ListViewManager__get_ItemSum((ListViewManager_o *)paymentHistoryListViewManager, 0LL) <= 0 )
  {
    ...
    if ( paymentHistoryListViewManager )
    {
      ...
      if ( paymentHistoryListViewManager )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        paymentHistoryListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_10306/*"PAYMENT_HISTORY_NODATA"*/, 0LL);
        if ( messageLabel )
        {
...
LABEL_22:
    sub_1B64ACC(paymentHistoryListViewManager, v13);
  }
LABEL_16:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  paymentHistoryListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_3733/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
  if ( !closeLabel )
    goto LABEL_22;
  UILabel__set_text(closeLabel, paymentHistoryListViewManager, 0LL);
  reflectButtonLabel = this->fields.reflectButtonLabel;
  paymentHistoryListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_10307/*"PAYMENT_HISTORY_REFLECT_BUTTON"*/, 0LL);
  if ( !reflectButtonLabel )
    goto LABEL_22;
  UILabel__set_text(reflectButtonLabel, paymentHistoryListViewManager, 0LL);
  this->fields.closeAction = 0LL;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.closeAction, 0, v18, v19);
  this->fields.decideAction = 0LL;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.decideAction, 0, v20, v21);
}
...
void __fastcall PaymentHistoryDialog__ResetScrollView(PaymentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B64870(&LocalizationManager_TypeInfo, method);
    sub_1B64870(&StringLiteral_10306/*"PAYMENT_HISTORY_NODATA"*/, v3);
    byte_49FA999 = 1;
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  messageLabel = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10306/*"PAYMENT_HISTORY_NODATA"*/, 0LL);
  if ( !v5 )
LABEL_17:
...
void __fastcall PaymentHistoryDialog__UpdateReflectButtonInfo(PaymentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA99D & 1) == 0 )
  {
    ...
    sub_1B64870(&NetworkManager_TypeInfo, v3);
    sub_1B64870(&PaymentHistoryDialog_TypeInfo, v4);
...
LABEL_28:
        sub_1B64ACC(reflectButtonColor, v9);
      }
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA99A & 1) == 0 )
  {
    sub_1B64870(&PaymentHistoryDialog__WaitExternalPayment_d__14_TypeInfo, method);
    byte_49FA99A = 1;
  }
  v2 = sub_1B64ABC(PaymentHistoryDialog__WaitExternalPayment_d__14_TypeInfo);
...
void __fastcall PaymentHistoryDialog___OnClickClose_b__16_0(PaymentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA99F & 1) == 0 )
  {
    sub_1B64870(&PaymentHistoryRequest_TypeInfo, method);
    byte_49FA99F = 1;
  }
  remain = this->fields.remain;
  if ( remain >= 1 )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA9A2 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_PaymentHistoryDialog___c__WaitExternalPayment_b__14_0__, v4);
    sub_1B64870(&PaymentHistoryDialog___c_TypeInfo, v5);
  ...
  else
  {
    ...
    if ( !_9__14_0 )
    {
      ...
      _9__14_0 = (System_Func_bool__o *)sub_1B64ABC(System_Func_bool__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B64884(&Method_PaymentHistoryDialog__WaitExternalPayment_d__14_System_Collections_IEnumerator_Reset__);
  sub_1B64998(v3, v4);
}
...
void __fastcall PaymentHistoryDialog___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FA9A0 & 1) == 0 )
  {
    sub_1B64870(&PaymentHistoryDialog___c_TypeInfo, v1);
    byte_49FA9A0 = 1;
  }
  v2 = (Il2CppObject *)sub_1B64ABC(PaymentHistoryDialog___c_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA9A1 & 1) == 0 )
  {
    sub_1B64870(&PurchaseLogicExternal_TypeInfo, method);
    byte_49FA9A1 = 1;
  }
