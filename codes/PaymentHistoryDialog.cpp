void __fastcall PaymentHistoryDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BD880B & 1) == 0 )
  {
    sub_1C21E38(&PaymentHistoryDialog_TypeInfo);
    sub_1C21E38(&StringLiteral_437/*"#494949"*/);
    byte_4BD880B = 1;
  }
...
void __fastcall PaymentHistoryDialog__OnClickClose(PaymentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD8809 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_PaymentHistoryDialog_OnClickClose__);
    sub_1C21E38(&Method_PaymentHistoryDialog__OnClickClose_b__16_0__);
    byte_4BD8809 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( (*((_BYTE *)Method_PaymentHistoryDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_PaymentHistoryDialog_OnClickClose__);
...
void __fastcall PaymentHistoryDialog__OnClickReflect(PaymentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD8808 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_PaymentHistoryDialog_OnClickReflect__);
    sub_1C21E38(&Method_PaymentHistoryDialog__OnClickReflect_b__15_0__);
    sub_1C21E38(&PaymentHistoryDialog_TypeInfo);
  ...
  *(_QWORD *)&v13.fields.b = 0LL;
  ...
  if ( (*((_BYTE *)Method_PaymentHistoryDialog_OnClickReflect__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C21E50(Method_PaymentHistoryDialog_OnClickReflect__);
  ...
  if ( canReflect )
  {
    ...
    if ( !reflectButtonColor )
LABEL_17:
      sub_1C22094(reflectButtonColor, v7);
...
void __fastcall PaymentHistoryDialog__Open(PaymentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD8805 & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_10560/*"PAYMENT_HISTORY_REFLECT_MESSAGE"*/);
    sub_1C21E38(&StringLiteral_10558/*"PAYMENT_HISTORY_NODATA"*/);
    sub_1C21E38(&StringLiteral_3811/*"COMMON_CONFIRM_CLOSE"*/);
    sub_1C21E38(&StringLiteral_10559/*"PAYMENT_HISTORY_REFLECT_BUTTON"*/);
    sub_1C21E38(&StringLiteral_10564/*"PAYMENT_HISTORY_TITLE"*/);
    sub_1C21E38(&StringLiteral_10565/*"PAYMENT_HISTORY_UPPER_MESSAGE"*/);
    byte_4BD8805 = 1;
  }
  ...
  v3 = LocalizationManager__Get((System_String_o *)StringLiteral_10564/*"PAYMENT_HISTORY_TITLE"*/, 0LL);
  ...
  paymentHistoryListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_10565/*"PAYMENT_HISTORY_UPPER_MESSAGE"*/, 0LL);
  ...
  paymentHistoryListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_10560/*"PAYMENT_HISTORY_REFLECT_MESSAGE"*/, 0LL);
  ...
  if ( ListViewManager__get_ItemSum((ListViewManager_o *)paymentHistoryListViewManager, 0LL) <= 0 )
  {
    ...
    if ( paymentHistoryListViewManager )
    {
      ...
      if ( paymentHistoryListViewManager )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        paymentHistoryListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_10558/*"PAYMENT_HISTORY_NODATA"*/, 0LL);
        if ( messageLabel )
        {
...
LABEL_22:
    sub_1C22094(paymentHistoryListViewManager, v6);
  }
LABEL_16:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  paymentHistoryListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_3811/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
  if ( !closeLabel )
    goto LABEL_22;
  UILabel__set_text(closeLabel, paymentHistoryListViewManager, 0LL);
  reflectButtonLabel = this->fields.reflectButtonLabel;
  paymentHistoryListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_10559/*"PAYMENT_HISTORY_REFLECT_BUTTON"*/, 0LL);
  if ( !reflectButtonLabel )
    goto LABEL_22;
  UILabel__set_text(reflectButtonLabel, paymentHistoryListViewManager, 0LL);
  this->fields.closeAction = 0LL;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.closeAction, 0LL, v11, v12, v13, v14, v15, v16);
  this->fields.decideAction = 0LL;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.decideAction, 0LL, v17, v18, v19, v20, v21, v22);
}
...
void __fastcall PaymentHistoryDialog__ResetScrollView(PaymentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  messageLabel = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10558/*"PAYMENT_HISTORY_NODATA"*/, 0LL);
  if ( !v4 )
LABEL_17:
  ...
  *(_QWORD *)&color.fields.b = 0LL;
  ...
  else
  {
    ...
    if ( this->fields.reflectCheckTime != Time )
    {
      ...
      reflectButtonColor = (UIButtonColor_o *)System_String__Format((System_String_o *)StringLiteral_25427/*"{0}"*/, v12, 0LL);
...
LABEL_28:
        sub_1C22094(reflectButtonColor, v4);
      }
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD8807 & 1) == 0 )
  {
    sub_1C21E38(&PaymentHistoryDialog__WaitExternalPayment_d__14_TypeInfo);
    byte_4BD8807 = 1;
  }
  v2 = sub_1C22084(PaymentHistoryDialog__WaitExternalPayment_d__14_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD880F & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_PaymentHistoryDialog___c__WaitExternalPayment_b__14_0__);
    sub_1C21E38(&PaymentHistoryDialog___c_TypeInfo);
  ...
  else
  {
    ...
    if ( !_9__14_0 )
    {
      ...
      _9__14_0 = (System_Func_bool__o *)sub_1C22084(System_Func_bool__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C21E4C(&Method_PaymentHistoryDialog__WaitExternalPayment_d__14_System_Collections_IEnumerator_Reset__);
  sub_1C21F60(v3, v4);
}
...
void __fastcall PaymentHistoryDialog___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C22084(PaymentHistoryDialog___c_TypeInfo);
