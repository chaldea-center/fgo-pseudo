void PaymentHistoryDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_5934530 & 1) == 0 )
  {
    sub_21FFC50(&PaymentHistoryDialog_TypeInfo);
    sub_21FFC50(&StringLiteral_433/*"#494949"*/);
    byte_5934530 = 1;
  }
...
void PaymentHistoryDialog__OnClickClose(PaymentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_593452E & 1) == 0 )
  {
    ...
    sub_21FFC50(&Method_PaymentHistoryDialog_OnClickClose__);
    sub_21FFC50(&Method_PaymentHistoryDialog__OnClickClose_b__16_0__);
    byte_593452E = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( (*((_BYTE *)Method_PaymentHistoryDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_21FFC68(Method_PaymentHistoryDialog_OnClickClose__);
...
void PaymentHistoryDialog__OnClickReflect(PaymentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_593452D & 1) == 0 )
  {
    ...
    sub_21FFC50(&Method_PaymentHistoryDialog_OnClickReflect__);
    sub_21FFC50(&Method_PaymentHistoryDialog__OnClickReflect_b__15_0__);
    sub_21FFC50(&PaymentHistoryDialog_TypeInfo);
  ...
  *(_QWORD *)&v18.fields.b = 0;
  if ( canReflect )
  {
    if ( (*((_BYTE *)Method_PaymentHistoryDialog_OnClickReflect__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_21FFC68(Method_PaymentHistoryDialog_OnClickReflect__);
    ...
    if ( !reflectButtonColor )
LABEL_18:
      sub_21FFECC(reflectButtonColor, v9);
  ...
  else
  {
    if ( (*((_BYTE *)Method_PaymentHistoryDialog_OnClickReflect__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_21FFC68(Method_PaymentHistoryDialog_OnClickReflect__);
    v17 = (System_Reflection_MethodBase_o *)sub_21FFC34(v3, v3[4]);
...
void PaymentHistoryDialog__Open(PaymentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_593452A & 1) == 0 )
  {
    ...
    sub_21FFC50(&StringLiteral_10744/*"PAYMENT_HISTORY_REFLECT_MESSAGE"*/);
    sub_21FFC50(&StringLiteral_10742/*"PAYMENT_HISTORY_NODATA"*/);
    sub_21FFC50(&StringLiteral_3823/*"COMMON_CONFIRM_CLOSE"*/);
    sub_21FFC50(&StringLiteral_10743/*"PAYMENT_HISTORY_REFLECT_BUTTON"*/);
    sub_21FFC50(&StringLiteral_10748/*"PAYMENT_HISTORY_TITLE"*/);
    sub_21FFC50(&StringLiteral_10749/*"PAYMENT_HISTORY_UPPER_MESSAGE"*/);
    byte_593452A = 1;
  }
  ...
  v5 = LocalizationManager__Get((System_String_o *)StringLiteral_10748/*"PAYMENT_HISTORY_TITLE"*/, 0);
  ...
  paymentHistoryListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_10749/*"PAYMENT_HISTORY_UPPER_MESSAGE"*/, 0);
  ...
  paymentHistoryListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_10744/*"PAYMENT_HISTORY_REFLECT_MESSAGE"*/, 0);
  ...
  if ( ListViewManager__get_ItemSum((ListViewManager_o *)paymentHistoryListViewManager, 0) <= 0 )
  {
    ...
    if ( paymentHistoryListViewManager )
    {
      ...
      if ( paymentHistoryListViewManager )
      {
        ...
        paymentHistoryListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_10742/*"PAYMENT_HISTORY_NODATA"*/, 0);
        if ( messageLabel )
        {
...
LABEL_22:
    sub_21FFECC(paymentHistoryListViewManager, v8);
  }
LABEL_16:
  ...
  paymentHistoryListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_3823/*"COMMON_CONFIRM_CLOSE"*/, 0);
  if ( !closeLabel )
    goto LABEL_22;
  UILabel__set_text(closeLabel, paymentHistoryListViewManager, 0);
  reflectButtonLabel = this->fields.reflectButtonLabel;
  paymentHistoryListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_10743/*"PAYMENT_HISTORY_REFLECT_BUTTON"*/, 0);
  if ( !reflectButtonLabel )
    goto LABEL_22;
  UILabel__set_text(reflectButtonLabel, paymentHistoryListViewManager, 0);
  this->fields.closeAction = 0;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&this->fields.closeAction, 0, v17, v18, v19, v20, v21, v22);
  this->fields.decideAction = 0;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&this->fields.decideAction, 0, v23, v24, v25, v26, v27, v28);
}
...
void PaymentHistoryDialog__ResetScrollView(PaymentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  messageLabel = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10742/*"PAYMENT_HISTORY_NODATA"*/, 0);
  if ( !v6 )
LABEL_17:
  ...
  *(_QWORD *)&color.fields.b = 0;
  ...
  else
  {
    ...
    if ( this->fields.reflectCheckTime != Time )
    {
      ...
      v11 = (Il2CppObject *)j_il2cpp_value_box_0(qword_594C090, &remain);
      reflectButtonColor = (UIButtonColor_o *)System_String__Format((System_String_o *)StringLiteral_26433/*"{0}"*/, v11, 0);
...
LABEL_28:
        sub_21FFECC(reflectButtonColor, v5);
      }
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_593452C & 1) == 0 )
  {
    sub_21FFC50(&PaymentHistoryDialog__WaitExternalPayment_d__14_TypeInfo);
    byte_593452C = 1;
  }
  v2 = sub_21FFEBC(PaymentHistoryDialog__WaitExternalPayment_d__14_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5934534 & 1) == 0 )
  {
    ...
    sub_21FFC50(&Method_PaymentHistoryDialog___c__WaitExternalPayment_b__14_0__);
    sub_21FFC50(&PaymentHistoryDialog___c_TypeInfo);
  ...
  if ( !_1__state )
  {
    ...
    if ( !_9__14_0 )
    {
      ...
      _9__14_0 = (System_Func_bool__o *)sub_21FFEBC(System_Func_bool__TypeInfo);
      ...
      sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&v12->__9__14_0, (int32_t)_9__14_0, v13, v14, v15, v16, v17, v18);
    }
    v19 = (UnityEngine_WaitUntil_o *)sub_21FFEBC(UnityEngine_WaitUntil_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_21FFC64(&Method_PaymentHistoryDialog__WaitExternalPayment_d__14_System_Collections_IEnumerator_Reset__);
  sub_21FFD90(v3, v4);
}
...
void PaymentHistoryDialog___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_21FFEBC(PaymentHistoryDialog___c_TypeInfo);
