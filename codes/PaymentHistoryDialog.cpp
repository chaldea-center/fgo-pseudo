void __fastcall PaymentHistoryDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A4A619 & 1) == 0 )
  {
    sub_1B863B8(&PaymentHistoryDialog_TypeInfo, v1);
    sub_1B863B8(&StringLiteral_408/*"#494949"*/, v4);
    byte_4A4A619 = 1;
  }
  ...
  sub_1B8635C((CGThumbnailListItem_o *)PaymentHistoryDialog_TypeInfo->static_fields, StringLiteral_408/*"#494949"*/, v2, v3);
}
...
void __fastcall PaymentHistoryDialog__OnClickClose(PaymentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4A617 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_PaymentHistoryDialog_OnClickClose__, v3);
    sub_1B863B8(&Method_PaymentHistoryDialog__OnClickClose_b__16_0__, v4);
    byte_4A4A617 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( (*((_BYTE *)Method_PaymentHistoryDialog_OnClickClose__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B863D0(Method_PaymentHistoryDialog_OnClickClose__);
...
void __fastcall PaymentHistoryDialog__OnClickReflect(PaymentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4A616 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_PaymentHistoryDialog_OnClickReflect__, v4);
    sub_1B863B8(&Method_PaymentHistoryDialog__OnClickReflect_b__15_0__, v5);
    sub_1B863B8(&PaymentHistoryDialog_TypeInfo, v6);
  ...
  *(_QWORD *)&v18.fields.b = 0LL;
  ...
  if ( (*((_BYTE *)Method_PaymentHistoryDialog_OnClickReflect__ + 83) & 2) != 0 )
    v8 = (_QWORD *)sub_1B863D0(Method_PaymentHistoryDialog_OnClickReflect__);
  ...
  if ( canReflect )
  {
    ...
    if ( !reflectButtonColor )
LABEL_17:
      sub_1B86614(reflectButtonColor, v12);
...
void __fastcall PaymentHistoryDialog__Open(PaymentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4A613 & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_10188/*"PAYMENT_HISTORY_REFLECT_MESSAGE"*/, v4);
    sub_1B863B8(&StringLiteral_10186/*"PAYMENT_HISTORY_NODATA"*/, v5);
    sub_1B863B8(&StringLiteral_3676/*"COMMON_CONFIRM_CLOSE"*/, v6);
    sub_1B863B8(&StringLiteral_10187/*"PAYMENT_HISTORY_REFLECT_BUTTON"*/, v7);
    sub_1B863B8(&StringLiteral_10192/*"PAYMENT_HISTORY_TITLE"*/, v8);
    sub_1B863B8(&StringLiteral_10193/*"PAYMENT_HISTORY_UPPER_MESSAGE"*/, v9);
    byte_4A4A613 = 1;
  }
  ...
  v10 = LocalizationManager__Get((System_String_o *)StringLiteral_10192/*"PAYMENT_HISTORY_TITLE"*/, 0LL);
  ...
  paymentHistoryListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_10193/*"PAYMENT_HISTORY_UPPER_MESSAGE"*/, 0LL);
  ...
  paymentHistoryListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_10188/*"PAYMENT_HISTORY_REFLECT_MESSAGE"*/, 0LL);
  ...
  if ( ListViewManager__get_ItemSum((ListViewManager_o *)paymentHistoryListViewManager, 0LL) <= 0 )
  {
    ...
    if ( paymentHistoryListViewManager )
    {
      ...
      if ( paymentHistoryListViewManager )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        paymentHistoryListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_10186/*"PAYMENT_HISTORY_NODATA"*/, 0LL);
        if ( messageLabel )
        {
...
LABEL_22:
    sub_1B86614(paymentHistoryListViewManager, v13);
  }
LABEL_16:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  paymentHistoryListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_3676/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
  if ( !closeLabel )
    goto LABEL_22;
  UILabel__set_text(closeLabel, paymentHistoryListViewManager, 0LL);
  reflectButtonLabel = this->fields.reflectButtonLabel;
  paymentHistoryListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_10187/*"PAYMENT_HISTORY_REFLECT_BUTTON"*/, 0LL);
  if ( !reflectButtonLabel )
    goto LABEL_22;
  UILabel__set_text(reflectButtonLabel, paymentHistoryListViewManager, 0LL);
  this->fields.closeAction = 0LL;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.closeAction, 0, v18, v19);
  this->fields.decideAction = 0LL;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.decideAction, 0, v20, v21);
}
...
void __fastcall PaymentHistoryDialog__ResetScrollView(PaymentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B863B8(&LocalizationManager_TypeInfo, method);
    sub_1B863B8(&StringLiteral_10186/*"PAYMENT_HISTORY_NODATA"*/, v3);
    byte_4A4A614 = 1;
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  messageLabel = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10186/*"PAYMENT_HISTORY_NODATA"*/, 0LL);
  if ( !v5 )
LABEL_17:
...
void __fastcall PaymentHistoryDialog__UpdateReflectButtonInfo(PaymentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4A618 & 1) == 0 )
  {
    ...
    sub_1B863B8(&NetworkManager_TypeInfo, v3);
    sub_1B863B8(&PaymentHistoryDialog_TypeInfo, v4);
  ...
  *(_QWORD *)&color.fields.b = 0LL;
  ...
  else
  {
    ...
    if ( this->fields.reflectCheckTime != Time )
    {
      ...
      reflectButtonColor = (UIButtonColor_o *)System_String__Format((System_String_o *)StringLiteral_24817/*"{0}"*/, v17, 0LL);
...
LABEL_28:
        sub_1B86614(reflectButtonColor, v9);
      }
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A615 & 1) == 0 )
  {
    sub_1B863B8(&PaymentHistoryDialog__WaitExternalPayment_d__14_TypeInfo, method);
    byte_4A4A615 = 1;
  }
  v2 = sub_1B86604(PaymentHistoryDialog__WaitExternalPayment_d__14_TypeInfo);
...
void __fastcall PaymentHistoryDialog___OnClickClose_b__16_0(PaymentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4A61A & 1) == 0 )
  {
    sub_1B863B8(&PaymentHistoryRequest_TypeInfo, method);
    byte_4A4A61A = 1;
  }
  remain = this->fields.remain;
  if ( remain >= 1 )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A61D & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_PaymentHistoryDialog___c__WaitExternalPayment_b__14_0__, v4);
    sub_1B863B8(&PaymentHistoryDialog___c_TypeInfo, v5);
  ...
  else
  {
    ...
    if ( !_9__14_0 )
    {
      ...
      _9__14_0 = (System_Func_bool__o *)sub_1B86604(System_Func_bool__TypeInfo);
    ...
    sub_1B8635C((CGThumbnailListItem_o *)&this->fields.__2__current, (int32_t)v15, v16, v17);
    v18 = 1;
    result = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B863CC(&Method_PaymentHistoryDialog__WaitExternalPayment_d__14_System_Collections_IEnumerator_Reset__);
  sub_1B864E0(v3, v4);
}
...
void __fastcall PaymentHistoryDialog___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A4A61B & 1) == 0 )
  {
    sub_1B863B8(&PaymentHistoryDialog___c_TypeInfo, v1);
    byte_4A4A61B = 1;
  }
  v2 = (Il2CppObject *)sub_1B86604(PaymentHistoryDialog___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  PaymentHistoryDialog___c_TypeInfo->static_fields->__9 = (struct PaymentHistoryDialog___c_o *)v2;
  sub_1B8635C((CGThumbnailListItem_o *)PaymentHistoryDialog___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
