void __fastcall PaymentHistoryDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49F88AF & 1) == 0 )
  {
    sub_1B640C8(&PaymentHistoryDialog_TypeInfo, v1);
    sub_1B640C8(&StringLiteral_441/*"#494949"*/, v4);
    byte_49F88AF = 1;
  }
  PaymentHistoryDialog_TypeInfo->static_fields->REFLECT_BUTTON_DISABLED_COLOR_CODE = (struct System_String_o *)StringLiteral_441/*"#494949"*/;
  sub_1B6406C(
    (ServantStatusBattleListViewItem_o *)PaymentHistoryDialog_TypeInfo->static_fields,
    StringLiteral_441/*"#494949"*/,
    v2,
    v3);
}
...
void __fastcall PaymentHistoryDialog__OnClickClose(PaymentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49F88AD & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_PaymentHistoryDialog_OnClickClose__, v4);
    sub_1B640C8(&Method_PaymentHistoryDialog__OnClickClose_b__16_0__, v5);
    byte_49F88AD = 1;
  }
  if ( !this->fields.state )
  {
    v6 = Method_PaymentHistoryDialog_OnClickClose__;
    if ( (*((_BYTE *)Method_PaymentHistoryDialog_OnClickClose__ + 83) & 2) != 0 )
      v6 = (_QWORD *)sub_1B640E0(Method_PaymentHistoryDialog_OnClickClose__);
  ...
  System_Action___ctor(v8, (Il2CppObject *)this, Method_PaymentHistoryDialog__OnClickClose_b__16_0__, 0LL);
...
void __fastcall PaymentHistoryDialog__OnClickReflect(PaymentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49F88AC & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_PaymentHistoryDialog_OnClickReflect__, v4);
    sub_1B640C8(&Method_PaymentHistoryDialog__OnClickReflect_b__15_0__, v5);
    sub_1B640C8(&PaymentHistoryDialog_TypeInfo, v6);
  ...
  *(_QWORD *)&v19.fields.b = 0LL;
  ...
  if ( (*((_BYTE *)Method_PaymentHistoryDialog_OnClickReflect__ + 83) & 2) != 0 )
    v8 = (_QWORD *)sub_1B640E0(Method_PaymentHistoryDialog_OnClickReflect__);
  ...
  if ( canReflect )
  {
    ...
    UnityEngine_ColorUtility__TryParseHtmlString(v11->static_fields->REFLECT_BUTTON_DISABLED_COLOR_CODE, &v19, 0LL);
    ...
    if ( !reflectButtonColor )
      goto LABEL_17;
    UIButtonColor__set_defaultColor(reflectButtonColor, v19, 0LL);
    reflectButtonColor = this->fields.reflectButtonColor;
    if ( !reflectButtonColor )
      goto LABEL_17;
    v13 = (PaymentHistoryDialog_o *)((__int64 (__fastcall *)(UIButtonColor_o *, _QWORD, Il2CppMethodPointer))reflectButtonColor->klass->vtable._5_set_isEnabled.method)(
                                      reflectButtonColor,
                                      0LL,
                                      reflectButtonColor->klass->vtable._6_OnInit.methodPtr);
    this->fields.isRemainFlag = 1;
    v15 = PaymentHistoryDialog__WaitExternalPayment(v13, v14);
    UnityEngine_MonoBehaviour__StartCoroutine_69113008((UnityEngine_MonoBehaviour_o *)this, v15, 0LL);
    ...
    if ( !reflectButtonColor )
LABEL_17:
      sub_1B64324(reflectButtonColor);
...
void __fastcall PaymentHistoryDialog__Open(PaymentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49F88A9 & 1) == 0 )
  {
    ...
    sub_1B640C8(&StringLiteral_10307/*"PAYMENT_HISTORY_REFLECT_MESSAGE"*/, v4);
    sub_1B640C8(&StringLiteral_10305/*"PAYMENT_HISTORY_NODATA"*/, v5);
    sub_1B640C8(&StringLiteral_3734/*"COMMON_CONFIRM_CLOSE"*/, v6);
    sub_1B640C8(&StringLiteral_10306/*"PAYMENT_HISTORY_REFLECT_BUTTON"*/, v7);
    sub_1B640C8(&StringLiteral_10311/*"PAYMENT_HISTORY_TITLE"*/, v8);
    sub_1B640C8(&StringLiteral_10312/*"PAYMENT_HISTORY_UPPER_MESSAGE"*/, v9);
    byte_49F88A9 = 1;
  }
  ...
  v10 = LocalizationManager__Get((System_String_o *)StringLiteral_10311/*"PAYMENT_HISTORY_TITLE"*/, 0LL);
  ...
  paymentHistoryListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_10312/*"PAYMENT_HISTORY_UPPER_MESSAGE"*/, 0LL);
  ...
  paymentHistoryListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_10307/*"PAYMENT_HISTORY_REFLECT_MESSAGE"*/, 0LL);
  ...
  if ( !paymentHistoryListViewManager )
    goto LABEL_22;
  PaymentHistoryListViewManager__CreateList((PaymentHistoryListViewManager_o *)paymentHistoryListViewManager, v14);
  paymentHistoryListViewManager = (System_String_o *)this->fields.paymentHistoryListViewManager;
  if ( !paymentHistoryListViewManager )
    goto LABEL_22;
  if ( ListViewManager__get_ItemSum((ListViewManager_o *)paymentHistoryListViewManager, 0LL) <= 0 )
  {
    ...
    if ( paymentHistoryListViewManager )
    {
      ...
      if ( paymentHistoryListViewManager )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        paymentHistoryListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_10305/*"PAYMENT_HISTORY_NODATA"*/, 0LL);
        if ( messageLabel )
        {
...
LABEL_22:
    sub_1B64324(paymentHistoryListViewManager);
  }
LABEL_16:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  paymentHistoryListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_3734/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
  if ( !closeLabel )
    goto LABEL_22;
  UILabel__set_text(closeLabel, paymentHistoryListViewManager, 0LL);
  reflectButtonLabel = this->fields.reflectButtonLabel;
  paymentHistoryListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_10306/*"PAYMENT_HISTORY_REFLECT_BUTTON"*/, 0LL);
  if ( !reflectButtonLabel )
    goto LABEL_22;
  UILabel__set_text(reflectButtonLabel, paymentHistoryListViewManager, 0LL);
  this->fields.closeAction = 0LL;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.closeAction, 0, v18, v19);
  this->fields.decideAction = 0LL;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.decideAction, 0, v20, v21);
}
...
void __fastcall PaymentHistoryDialog__ResetScrollView(PaymentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B640C8(&LocalizationManager_TypeInfo, method);
    sub_1B640C8(&StringLiteral_10305/*"PAYMENT_HISTORY_NODATA"*/, v3);
    byte_49F88AA = 1;
  }
  ...
  if ( !messageLabel )
    goto LABEL_17;
  PaymentHistoryListViewManager__CreateList((PaymentHistoryListViewManager_o *)messageLabel, v5);
  messageLabel = (UnityEngine_Component_o *)this->fields.paymentHistoryListViewManager;
  if ( !messageLabel )
    goto LABEL_17;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  messageLabel = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10305/*"PAYMENT_HISTORY_NODATA"*/, 0LL);
  if ( !v6 )
LABEL_17:
    sub_1B64324(messageLabel);
  UILabel__set_text(v6, (System_String_o *)messageLabel, 0LL);
LABEL_15:
...
void __fastcall PaymentHistoryDialog__UpdateReflectButtonInfo(PaymentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49F88AE & 1) == 0 )
  {
    ...
    sub_1B640C8(&NetworkManager_TypeInfo, v3);
    sub_1B640C8(&PaymentHistoryDialog_TypeInfo, v4);
  ...
  *(_QWORD *)&color.fields.b = 0LL;
  ...
  else
  {
    ...
    if ( this->fields.reflectCheckTime != Time )
    {
      ...
      v13 = (Il2CppObject *)j_il2cpp_value_box_0(long_TypeInfo, &remain);
      reflectButtonColor = (UIButtonColor_o *)System_String__Format((System_String_o *)StringLiteral_24883/*"{0}"*/, v13, 0LL);
      ...
      this->fields.reflectCheckTime = v10;
      if ( !isRemainFlag )
      {
        ...
        UnityEngine_ColorUtility__TryParseHtmlString(
          v15->static_fields->REFLECT_BUTTON_DISABLED_COLOR_CODE,
          &color,
          0LL);
        reflectButtonColor = this->fields.reflectButtonColor;
        if ( reflectButtonColor )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F88AB & 1) == 0 )
  {
    sub_1B640C8(&PaymentHistoryDialog__WaitExternalPayment_d__14_TypeInfo, method);
    byte_49F88AB = 1;
  }
  v3 = sub_1B64314(PaymentHistoryDialog__WaitExternalPayment_d__14_TypeInfo, method, v2);
...
void __fastcall PaymentHistoryDialog___OnClickClose_b__16_0(PaymentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49F88B0 & 1) == 0 )
  {
    sub_1B640C8(&PaymentHistoryRequest_TypeInfo, method);
    byte_49F88B0 = 1;
  }
  remain = this->fields.remain;
  if ( remain >= 1 )
        ...
        const MethodInfo *method)
{
  ...
  __int64 v9; // x1
  __int64 v10; // x2
  PaymentHistoryDialog___c_c *v11; // x0
  ...
  if ( (byte_49F88B3 & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_PaymentHistoryDialog___c__WaitExternalPayment_b__14_0__, v4);
    sub_1B640C8(&PaymentHistoryDialog___c_TypeInfo, v5);
  ...
  else
  {
    ...
    if ( !_9__14_0 )
    {
      ...
      _9__14_0 = (System_Func_bool__o *)sub_1B64314(System_Func_bool__TypeInfo, v9, v10);
      System_Func_bool____ctor(_9__14_0, v13, Method_PaymentHistoryDialog___c__WaitExternalPayment_b__14_0__, 0LL);
      static_fields = PaymentHistoryDialog___c_TypeInfo->static_fields;
      static_fields->__9__14_0 = _9__14_0;
      sub_1B6406C((ServantStatusBattleListViewItem_o *)&static_fields->__9__14_0, (int32_t)_9__14_0, v15, v16);
    }
    v17 = (UnityEngine_WaitUntil_o *)sub_1B64314(UnityEngine_WaitUntil_TypeInfo, v9, v10);
    UnityEngine_WaitUntil___ctor(v17, _9__14_0, 0LL);
    this->fields.__2__current = (Il2CppObject *)v17;
    sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.__2__current, (int32_t)v17, v18, v19);
    v20 = 1;
    result = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v6 = sub_1B640DC(&Method_PaymentHistoryDialog__WaitExternalPayment_d__14_System_Collections_IEnumerator_Reset__);
  sub_1B641F0(v5, v6);
}
...
void __fastcall PaymentHistoryDialog___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49F88B1 & 1) == 0 )
  {
    sub_1B640C8(&PaymentHistoryDialog___c_TypeInfo, v1);
    byte_49F88B1 = 1;
  }
  v3 = (Il2CppObject *)sub_1B64314(PaymentHistoryDialog___c_TypeInfo, v1, v2);
  System_Object___ctor(v3, 0LL);
  PaymentHistoryDialog___c_TypeInfo->static_fields->__9 = (struct PaymentHistoryDialog___c_o *)v3;
  sub_1B6406C(
    (ServantStatusBattleListViewItem_o *)PaymentHistoryDialog___c_TypeInfo->static_fields,
    (int32_t)v3,
    v4,
    v5);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F88B2 & 1) == 0 )
  {
    sub_1B640C8(&PurchaseLogicExternal_TypeInfo, method);
    byte_49F88B2 = 1;
  }
