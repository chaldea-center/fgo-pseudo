void __fastcall ServantExceedMaster___ctor(ServantExceedMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4B028F4 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataMasterBase_ServantExceedMaster__ServantExceedEntity__string___ctor__, method);
    byte_4B028F4 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    161,
    (const MethodInfo_32B1804 *)Method_DataMasterBase_ServantExceedMaster__ServantExceedEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (ServantExceedEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                    PK,
                                    (const MethodInfo_32B3B28 *)Method_DataMasterBase_ServantExceedMaster__ServantExceedEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B028EF & 1) == 0 )
  {
    sub_1BC3008(&Rarity_TypeInfo, *(_QWORD *)&rarity);
    byte_4B028EF = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B028F1 & 1) == 0 )
  {
    sub_1BC3008(&Rarity_TypeInfo, *(_QWORD *)&svtId);
    byte_4B028F1 = 1;
  }
...
// local variable allocation has failed, the output may be wrong!
int32_t __fastcall ServantExceedMaster__GetFrameType_41669540(
        ServantExceedMaster_o *this,
        int32_t svtId,
        int32_t limitCount,
        int32_t exceedCount,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B028F0 & 1) == 0 )
  {
    this = (ServantExceedMaster_o *)sub_1BC3008(&Rarity_TypeInfo, *(_QWORD *)&svtId);
    byte_4B028F0 = 1;
  }
  Rarity_41669740 = ServantExceedMaster__GetRarity_41669740(this, svtId, limitCount, *(const MethodInfo **)&exceedCount);
  Entity = ServantExceedMaster__GetEntity(v10, Rarity_41669740, exceedCount, v12);
  if ( Entity )
  {
    v14 = 40LL;
    if ( isGrandServant )
  ...
  else
  {
    if ( !Rarity_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(Rarity_TypeInfo);
    return Rarity__getFrameTypeImage(Rarity_41669740, 0, 0LL);
  }
}


// local variable allocation has failed, the output may be wrong!
int32_t __fastcall ServantExceedMaster__GetFrameType_41670196(
        ServantExceedMaster_o *this,
        int32_t *rarity,
        int32_t svtId,
        int32_t limitCount,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B028F2 & 1) == 0 )
  {
    this = (ServantExceedMaster_o *)sub_1BC3008(&Rarity_TypeInfo, rarity);
    byte_4B028F2 = 1;
  }
  Rarity_41669740 = ServantExceedMaster__GetRarity_41669740(this, svtId, limitCount, *(const MethodInfo **)&limitCount);
  *rarity = Rarity_41669740;
  Entity = ServantExceedMaster__GetEntity(v10, Rarity_41669740, exceedCount, v12);
  if ( Entity )
...
int32_t __fastcall ServantExceedMaster__GetRarity(ServantExceedMaster_o *this, int32_t svtId, const MethodInfo *method)
{
  ...
  return ServantExceedMaster__GetRarity_41669740(this, svtId, 0, v3);
}
...
// local variable allocation has failed, the output may be wrong!
int32_t __fastcall ServantExceedMaster__GetRarity_41669740(
        ServantExceedMaster_o *this,
        int32_t svtId,
        int32_t limitCount,
        const MethodInfo *method)
{
  ...
  if ( (byte_4B028F3 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_DataManager_GetMasterData_ServantLimitMaster___, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B028F6 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataMasterBase_ServantExceedMaster__ServantExceedEntity__string__TryGetEntity__, entity);
    byte_4B028F6 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_32B3B74 *)Method_DataMasterBase_ServantExceedMaster__ServantExceedEntity__string__TryGetEntity__);
}
