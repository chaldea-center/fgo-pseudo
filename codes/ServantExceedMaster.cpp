void __fastcall ServantExceedMaster___ctor(ServantExceedMaster_o *this, const MethodInfo *method)
{
  if ( (byte_43551C6 & 1) == 0 )
  {
    sub_B70694(&Method_DataMasterBase_ServantExceedMaster__ServantExceedEntity__string___ctor__);
    byte_43551C6 = 1;
  }
  DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string____ctor(
    (DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string__o *)this,
    156,
    (const MethodInfo_21C07F4 *)Method_DataMasterBase_ServantExceedMaster__ServantExceedEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_43551C4 & 1) == 0 )
  {
    sub_B70694(&Method_DataMasterBase_ServantExceedMaster__ServantExceedEntity__string__GetEntity__);
    byte_43551C4 = 1;
  }
  ...
  return (ServantExceedEntity_o *)DataMasterBase_WarMessageMaster__WarMessageEntity__string___GetEntity(
                                    ...
                                    PK,
                                    (const MethodInfo_21C0890 *)Method_DataMasterBase_ServantExceedMaster__ServantExceedEntity__string__GetEntity__);
}
...
// local variable allocation has failed, the output may be wrong!
int32_t __fastcall ServantExceedMaster__GetFrameType_31474112(
        ServantExceedMaster_o *this,
        int32_t svtId,
        int32_t limitCount,
        int32_t exceedCount,
        const MethodInfo *method)
{
  ...
  if ( (byte_43551C9 & 1) == 0 )
  {
    this = (ServantExceedMaster_o *)sub_B70694(&Rarity_TypeInfo);
    byte_43551C9 = 1;
  }
  Rarity_31474304 = ServantExceedMaster__GetRarity_31474304(this, svtId, limitCount, *(const MethodInfo **)&exceedCount);
  Entity = ServantExceedMaster__GetEntity(v8, Rarity_31474304, exceedCount, v10);
  if ( Entity )
    return Entity->fields.frameType;
  if ( (BYTE3(Rarity_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0 && !Rarity_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(Rarity_TypeInfo);
  return Rarity__getFrameTypeImage(Rarity_31474304, 0, 0LL);
}


// local variable allocation has failed, the output may be wrong!
int32_t __fastcall ServantExceedMaster__GetFrameType_31474608(
        ServantExceedMaster_o *this,
        int32_t *rarity,
        int32_t svtId,
        int32_t limitCount,
        ...
        const MethodInfo *method)
{
  ...
  Rarity_31474304 = ServantExceedMaster__GetRarity_31474304(this, svtId, limitCount, *(const MethodInfo **)&limitCount);
  *rarity = Rarity_31474304;
  Entity = ServantExceedMaster__GetEntity(v10, Rarity_31474304, exceedCount, v12);
  if ( Entity )
    return Entity->fields.frameType;
  v15 = *rarity;
  if ( (BYTE3(Rarity_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0 && !Rarity_TypeInfo->_2.cctor_finished )
...
int32_t __fastcall ServantExceedMaster__GetRarity(ServantExceedMaster_o *this, int32_t svtId, const MethodInfo *method)
{
  ...
  return ServantExceedMaster__GetRarity_31474304(this, svtId, 0, v3);
}
...
int32_t __fastcall ServantExceedMaster__GetRarity_31474304(
        ServantExceedMaster_o *this,
        int32_t svtId,
        int32_t limitCount,
        const MethodInfo *method)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_43551C5 & 1) == 0 )
  {
    sub_B70694(&Method_DataMasterBase_ServantExceedMaster__ServantExceedEntity__string__TryGetEntity__);
    byte_43551C5 = 1;
  }
  ...
  return DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string___TryGetEntity(
           ...
           PK,
           (const MethodInfo_21C08E8 *)Method_DataMasterBase_ServantExceedMaster__ServantExceedEntity__string__TryGetEntity__);
}
