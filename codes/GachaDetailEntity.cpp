        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5B3DB & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_GachaDetailEntity___c__GetScriptIntArray_b__8_0__);
    sub_1B885B0(&GachaDetailEntity___c_TypeInfo);
    byte_4A5B3DB = 1;
  }
  ...
  if ( !_9__8_0 )
  {
    ...
    _9__8_0 = (System_Converter_object__int__o *)sub_1B887FC(System_Converter_object__int__TypeInfo);
...
void __fastcall GachaDetailEntity___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1B887FC(GachaDetailEntity___c_TypeInfo);
  System_Object___ctor(v1, 0LL);
  GachaDetailEntity___c_TypeInfo->static_fields->__9 = (struct GachaDetailEntity___c_o *)v1;
  sub_1B88554((ServantStatusBattleListViewItem_o *)GachaDetailEntity___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
