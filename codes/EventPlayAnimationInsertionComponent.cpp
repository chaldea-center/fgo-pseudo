void __fastcall EventPlayAnimationInsertionComponent___cctor(const MethodInfo *method)
{
  if ( (byte_42B0582 & 1) == 0 )
  {
    sub_B52984(&EventPlayAnimationInsertionComponent_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  sub_B52920((BattleServantConfConponent_o *)&this->fields.nowPlayAnimName, v9, v2, v3, v4, v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B057C & 1) == 0 )
  {
    sub_B52984(&Method_UnityEngine_Component_GetComponent_Animator___);
    byte_42B057C = 1;
  }
  Component_WebViewObject = (struct UnityEngine_Animator_o *)UnityEngine_Component__GetComponent_WebViewObject_(
                                                               (UnityEngine_Component_o *)this,
                                                               (const MethodInfo_1A491D8 *)Method_UnityEngine_Component_GetComponent_Animator___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B057F & 1) == 0 )
  {
    ...
    sub_B52984(&EventPlayAnimationInsertionComponent___c__DisplayClass13_0_TypeInfo);
    sub_B52984(&Method_EventPlayAnimationInsertionComponent___c__DisplayClass13_1__ChangeAnimationSprite_b__0__);
    sub_B52984(&EventPlayAnimationInsertionComponent___c__DisplayClass13_1_TypeInfo);
    sub_B52984(&StringLiteral_941/*"/image/"*/);
    sub_B52984(&StringLiteral_7546/*"Image/"*/);
    sub_B52984(&StringLiteral_13759/*"Texture_"*/);
    byte_42B057F = 1;
  }
  v49 = 0;
  v4 = sub_B52A54(EventPlayAnimationInsertionComponent___c__DisplayClass13_0_TypeInfo);
  ...
  *(_QWORD *)(v4 + 16) = spriteNames;
  v13 = (__int64 *)(v4 + 16);
  sub_B52920((BattleServantConfConponent_o *)(v4 + 16), (System_Int32_array **)spriteNames, v7, v8, v9, v10, v11, v12);
  *(_QWORD *)(v4 + 24) = this;
  sub_B52920((BattleServantConfConponent_o *)(v4 + 24), (System_Int32_array **)this, v14, v15, v16, v17, v18, v19);
  ...
  if ( !gameObject
    || (name = UnityEngine_Object__get_name(gameObject, 0LL),
        gameObject = (UnityEngine_Object_o *)System_String__Concat_44568316(
                                               name,
                                               (System_String_o *)StringLiteral_941/*"/image/"*/,
                                               0LL),
        v49 = 1,
        (v21 = *v13) == 0) )
  {
LABEL_28:
  ...
  {
    v24 = sub_B52A54(EventPlayAnimationInsertionComponent___c__DisplayClass13_1_TypeInfo);
    ...
    *(_QWORD *)(v24 + 32) = v4;
    v31 = v24 + 32;
    sub_B52920((BattleServantConfConponent_o *)(v24 + 32), (System_Int32_array **)v4, v25, v26, v27, v28, v29, v30);
    *(_DWORD *)(v24 + 16) = 2 * v49;
    v32 = System_Int32__ToString((int32_t)&v49, 0LL);
    v33 = System_String__Concat_44570600(v22, (System_String_o *)StringLiteral_13759/*"Texture_"*/, v32, 0LL);
    ...
    if ( ((unsigned __int8)gameObject & 1) == 0 )
    {
      ...
      *(_QWORD *)(v24 + 24) = Component_srcLineSprite;
      sub_B52920((BattleServantConfConponent_o *)(v24 + 24), Component_srcLineSprite, v36, v37, v38, v39, v40, v41);
      ...
      if ( ((unsigned __int8)gameObject & 1) == 0 )
      {
        ...
        v45 = System_String__Concat_44568316(
                (System_String_o *)StringLiteral_7546/*"Image/"*/,
                *(System_String_o **)(v43 + 8 * v44 + 32),
                0LL);
        v46 = (AssetLoader_LoadEndDataHandler_o *)sub_B52A54(AssetLoader_LoadEndDataHandler_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( max_length >= 2 )
  {
    ...
    while ( 1 )
    {
      if ( v7 >= max_length )
      {
        v10 = sub_B52A88(IsNullOrEmpty);
        sub_B52A28(v10, 0LL);
      }
      IsNullOrEmpty = args->m_Items[v7];
      if ( !IsNullOrEmpty )
        break;
      v8 = System_String__Trim_44555648(IsNullOrEmpty, 0LL);
      IsNullOrEmpty = (System_String_o *)System_String__IsNullOrEmpty(v8, 0LL);
      if ( ((unsigned __int8)IsNullOrEmpty & 1) == 0 )
      {
        IsNullOrEmpty = System_String__Concat_44568316((System_String_o *)StringLiteral_7546/*"Image/"*/, v8, 0LL);
        if ( !v3 )
          break;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B52984(&UnityEngine_Object_TypeInfo);
    sub_B52984(&StringLiteral_16254/*"_in"*/);
    sub_B52984(&StringLiteral_2758/*"Base Layer."*/);
    sub_B52984(&StringLiteral_16274/*"_out"*/);
    sub_B52984(&StringLiteral_1/*""*/);
    byte_42B057E = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(mAnimator, 0LL, 0LL) )
  {
    ...
    if ( playInAnim )
    {
      v12 = (System_String_o *)StringLiteral_16254/*"_in"*/;
    }
    else
    {
      v12 = (System_String_o *)StringLiteral_16274/*"_out"*/;
      this->fields.isDestroy = 1;
    }
    v13 = System_String__Concat_44570600((System_String_o *)StringLiteral_2758/*"Base Layer."*/, animName, v12, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_AnimatorStateInfo__get_normalizedTime(&v6, 0LL) > 1.0 && this->fields.isLoadedSprite )
  {
    ...
    if ( !mAnimator )
      goto LABEL_14;
    if ( System_String__Contains((System_String_o *)mAnimator, (System_String_o *)StringLiteral_16274/*"_out"*/, 0LL)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AD93F & 1) == 0 )
  {
    ...
    sub_B52984(&EventPlayAnimationInsertionComponent_TypeInfo);
    sub_B52984(&UnityEngine_Object_TypeInfo);
    this = (EventPlayAnimationInsertionComponent___c__DisplayClass13_1_o *)sub_B52984(&StringLiteral_16329/*"a"*/);
    byte_42AD93F = 1;
  }
...
LABEL_26:
  ...
  if ( ((unsigned __int8)this & 1) != 0 )
  {
    ...
    {
      v13 = System_String__Concat_44568316(v11->m_Items[v12], (System_String_o *)StringLiteral_16329/*"a"*/, 0LL);
      this = (EventPlayAnimationInsertionComponent___c__DisplayClass13_1_o *)AssetData__GetObject_WarBoardWaitTimeSetting_(
                                                                               assetData,
                                                                               v13,
                                                                               (const MethodInfo_1A3B904 *)Method_AssetData_GetObject_Texture2D____68579976);
      ...
      if ( v14 )
      {
        ...
        if ( v16 )
        {
          UnityEngine_Material__SetTexture_41518048(
            v16,
