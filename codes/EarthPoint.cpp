void __fastcall EarthPoint___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A6CAAE & 1) == 0 )
  {
    sub_1B90010(&EarthPoint_TypeInfo, v1);
    byte_4A6CAAE = 1;
  }
  if ( !byte_4A6A9C1 )
  {
...
void __fastcall EarthPoint___ctor(EarthPoint_o *this, const MethodInfo *method)
{
  if ( (byte_4A6CAAD & 1) == 0 )
  {
    sub_1B90010(&BaseEarthPoint_TypeInfo, method);
    byte_4A6CAAD = 1;
  }
...
System_String_o *__fastcall EarthPoint__GetEffectName(EarthPoint_o *this, const MethodInfo *method)
{
  if ( (byte_4A6CAAC & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_18850/*"ef_difference11"*/, method);
    byte_4A6CAAC = 1;
  }
  return (System_String_o *)StringLiteral_18850/*"ef_difference11"*/;
}
...
LABEL_53:
  ...
  *(UnityEngine_Vector3_o *)&v22 = UnityEngine_Transform__get_position((UnityEngine_Transform_o *)transform, 0LL);
  if ( !v21 )
    goto LABEL_53;
  x = COERCE_FLOAT(UnityEngine_Camera__WorldToViewportPoint_69345740(v21, *(UnityEngine_Vector3_o *)&v22, 0LL));
  if ( x < 0.0 )
  {
...
LABEL_30:
      ...
      if ( !byte_4A6A9C1 )
      {
        transform = (UnityEngine_ParticleSystem_o *)sub_1B90010(&UnityEngine_Vector3_TypeInfo, v8);
        byte_4A6A9C1 = 1;
      }
      if ( !v26 )
        goto LABEL_53;
...
LABEL_29:
  ...
  if ( (mIsForward & ~v25) != 0 )
  {
    ...
    if ( transform )
    {
      UnityEngine_ParticleSystem__Clear_69820064(transform, 0LL);
LABEL_40:
      this->fields.IsParticleDisp = 0;
      return;
    }
