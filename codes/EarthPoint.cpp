void __fastcall EarthPoint___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB28F9 & 1) == 0 )
  {
    sub_1BAB41C(&EarthPoint_TypeInfo, v1);
    byte_4AB28F9 = 1;
  }
  if ( !byte_4AB0691 )
  {
...
void __fastcall EarthPoint___ctor(EarthPoint_o *this, const MethodInfo *method)
{
  if ( (byte_4AB28F8 & 1) == 0 )
  {
    sub_1BAB41C(&BaseEarthPoint_TypeInfo, method);
    byte_4AB28F8 = 1;
  }
...
System_String_o *__fastcall EarthPoint__GetEffectName(EarthPoint_o *this, const MethodInfo *method)
{
  if ( (byte_4AB28F7 & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_18854/*"ef_difference11"*/, method);
    byte_4AB28F7 = 1;
  }
  return (System_String_o *)StringLiteral_18854/*"ef_difference11"*/;
}
...
LABEL_53:
  ...
  *(UnityEngine_Vector3_o *)&v22 = UnityEngine_Transform__get_position((UnityEngine_Transform_o *)transform, 0LL);
  if ( !v21 )
    goto LABEL_53;
  x = COERCE_FLOAT(UnityEngine_Camera__WorldToViewportPoint_69606920(v21, *(UnityEngine_Vector3_o *)&v22, 0LL));
  if ( x < 0.0 )
  {
...
LABEL_30:
      ...
      if ( !byte_4AB0691 )
      {
        transform = (UnityEngine_ParticleSystem_o *)sub_1BAB41C(&UnityEngine_Vector3_TypeInfo, v8);
        byte_4AB0691 = 1;
      }
      if ( !v26 )
        goto LABEL_53;
...
LABEL_29:
  ...
  if ( (mIsForward & ~v25) != 0 )
  {
    ...
    if ( transform )
    {
      UnityEngine_ParticleSystem__Clear_70081204(transform, 0LL);
LABEL_40:
      this->fields.IsParticleDisp = 0;
      return;
    }
