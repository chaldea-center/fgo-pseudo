void EarthPoint___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C53663 & 1) == 0 )
  {
    sub_1C3E564(&EarthPoint_TypeInfo);
    byte_4C53663 = 1;
  }
  if ( !byte_4C506A1 )
  {
...
System_String_o *EarthPoint__GetEffectName(EarthPoint_o *this, const MethodInfo *method)
{
  if ( (byte_4C53661 & 1) == 0 )
  {
    sub_1C3E564(&StringLiteral_18845/*"ef_difference11"*/);
    byte_4C53661 = 1;
  }
  return (System_String_o *)StringLiteral_18845/*"ef_difference11"*/;
}
...
LABEL_53:
  ...
  if ( !v20 )
    goto LABEL_53;
  x = COERCE_FLOAT(UnityEngine_Camera__WorldToViewportPoint_71147840(v20, position, 0));
  if ( x < 0.0 )
  {
...
LABEL_30:
      ...
      if ( !byte_4C506A1 )
      {
        transform = (UnityEngine_ParticleSystem_o *)sub_1C3E564(&UnityEngine_Vector3_TypeInfo);
        byte_4C506A1 = 1;
      }
      if ( !v22 )
        goto LABEL_53;
...
LABEL_29:
  ...
  if ( (mIsForward & ~v21) != 0 )
  {
    ...
    if ( transform )
    {
      UnityEngine_ParticleSystem__Clear_71625460(transform, 0);
LABEL_40:
      this->fields.IsParticleDisp = 0;
      return;
    }
