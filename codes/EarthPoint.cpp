void EarthPoint___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C23C0A & 1) == 0 )
  {
    sub_1C2D490(&EarthPoint_TypeInfo);
    byte_4C23C0A = 1;
  }
  if ( !byte_4C20DA1 )
  {
...
System_String_o *EarthPoint__GetEffectName(EarthPoint_o *this, const MethodInfo *method)
{
  if ( (byte_4C23C08 & 1) == 0 )
  {
    sub_1C2D490(&StringLiteral_18815/*"ef_difference11"*/);
    byte_4C23C08 = 1;
  }
  return (System_String_o *)StringLiteral_18815/*"ef_difference11"*/;
}
...
LABEL_53:
  ...
  if ( !v20 )
    goto LABEL_53;
  x = COERCE_FLOAT(UnityEngine_Camera__WorldToViewportPoint_70969980(v20, position, 0));
  if ( x < 0.0 )
  {
...
LABEL_30:
      ...
      if ( !byte_4C20DA1 )
      {
        transform = (UnityEngine_ParticleSystem_o *)sub_1C2D490(&UnityEngine_Vector3_TypeInfo);
        byte_4C20DA1 = 1;
      }
      if ( !v22 )
        goto LABEL_53;
...
LABEL_29:
  ...
  if ( (mIsForward & ~v21) != 0 )
  {
    ...
    if ( transform )
    {
      UnityEngine_ParticleSystem__Clear_71447600(transform, 0);
LABEL_40:
      this->fields.IsParticleDisp = 0;
      return;
    }
