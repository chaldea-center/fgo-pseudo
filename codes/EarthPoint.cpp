void __fastcall EarthPoint___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BD9039 & 1) == 0 )
  {
    sub_1C21E38(&EarthPoint_TypeInfo);
    byte_4BD9039 = 1;
  }
  if ( !byte_4BD6BB1 )
  {
...
System_String_o *__fastcall EarthPoint__GetEffectName(EarthPoint_o *this, const MethodInfo *method)
{
  if ( (byte_4BD9037 & 1) == 0 )
  {
    sub_1C21E38(&StringLiteral_19149/*"ef_difference11"*/);
    byte_4BD9037 = 1;
  }
  return (System_String_o *)StringLiteral_19149/*"ef_difference11"*/;
}
...
LABEL_53:
  ...
  *(UnityEngine_Vector3_o *)&v20 = UnityEngine_Transform__get_position((UnityEngine_Transform_o *)transform, 0LL);
  if ( !v19 )
    goto LABEL_53;
  x = COERCE_FLOAT(UnityEngine_Camera__WorldToViewportPoint_70675592(v19, *(UnityEngine_Vector3_o *)&v20, 0LL));
  if ( x < 0.0 )
  {
...
LABEL_30:
      ...
      if ( !byte_4BD6BB1 )
      {
        transform = (UnityEngine_ParticleSystem_o *)sub_1C21E38(&UnityEngine_Vector3_TypeInfo);
        byte_4BD6BB1 = 1;
      }
      if ( !v24 )
        goto LABEL_53;
...
LABEL_29:
  ...
  if ( (mIsForward & ~v23) != 0 )
  {
    ...
    if ( transform )
    {
      UnityEngine_ParticleSystem__Clear_71150364(transform, 0LL);
LABEL_40:
      this->fields.IsParticleDisp = 0;
      return;
    }
