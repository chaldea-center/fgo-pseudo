void __fastcall EarthPoint___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49F908B & 1) == 0 )
  {
    sub_1B640C8(&EarthPoint_TypeInfo, v1);
    byte_49F908B = 1;
  }
  if ( !byte_49F7111 )
  {
...
System_String_o *__fastcall EarthPoint__GetEffectName(EarthPoint_o *this, const MethodInfo *method)
{
  if ( (byte_49F9089 & 1) == 0 )
  {
    sub_1B640C8(&StringLiteral_18752/*"ef_difference11"*/, method);
    byte_49F9089 = 1;
  }
  return (System_String_o *)StringLiteral_18752/*"ef_difference11"*/;
}
...
LABEL_53:
  ...
  *(UnityEngine_Vector3_o *)&v21 = UnityEngine_Transform__get_position((UnityEngine_Transform_o *)transform, 0LL);
  if ( !v20 )
    goto LABEL_53;
  x = COERCE_FLOAT(UnityEngine_Camera__WorldToViewportPoint_68934036(v20, *(UnityEngine_Vector3_o *)&v21, 0LL));
  if ( x < 0.0 )
  {
    v24 = this->fields.mIsForward;
...
LABEL_30:
      ...
      if ( !byte_49F7111 )
      {
        transform = (UnityEngine_ParticleSystem_o *)sub_1B640C8(&UnityEngine_Vector3_TypeInfo, v25);
        byte_49F7111 = 1;
      }
      if ( !v26 )
        goto LABEL_53;
...
LABEL_29:
  ...
  if ( (mIsForward & ~v24) != 0 )
  {
    ...
    if ( transform )
    {
      UnityEngine_ParticleSystem__Clear_69408360(transform, 0LL);
LABEL_40:
      this->fields.IsParticleDisp = 0;
      return;
    }
  ...
  if ( x >= 0.0 && v24 && !this->fields.IsParticleDisp )
  {
