        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E78DA3 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_System_Collections_Generic_List_string___ctor___80331168);
    sub_1D0F0B4(&System_Collections_Generic_List_string__TypeInfo);
    sub_1D0F0B4(&Method_ExUISkinTexture___c__DisplayClass4_0__loadTexture_b__0__);
    sub_1D0F0B4(&ExUISkinTexture___c__DisplayClass4_0_TypeInfo);
    byte_4E78DA3 = 1;
  }
  v7 = sub_1D0F300(ExUISkinTexture___c__DisplayClass4_0_TypeInfo);
  ...
  *(_QWORD *)(v7 + 24) = callback;
  ...
  v22 = (System_Collections_Generic_List_object__o *)sub_1D0F300(System_Collections_Generic_List_string__TypeInfo);
  System_Collections_Generic_List_object____ctor_60144716(
    v22,
    1,
    (const MethodInfo_395BC4C *)Method_System_Collections_Generic_List_string___ctor___80331168);
  if ( !v22
...
LABEL_12:
  ...
  else
  {
    ...
    sub_1D0F058((GrandQuestFolderBoardItem_o *)(v32 + 4), (int32_t)texName, v23, v24, v25, v26, v27, v28);
  }
...
void ExUISkinTexture__loadTexture_45151272(
        ExUISkinTexture_o *this,
        System_Action_o *callback,
        const MethodInfo *method)
{
  ...
  if ( (byte_4E78DA4 & 1) == 0 )
  {
    sub_1D0F0B4(&System_Action_TypeInfo);
    sub_1D0F0B4(&AtlasManager_TypeInfo);
    sub_1D0F0B4(&Method_ExUISkinTexture___c__DisplayClass5_0__loadTexture_b__0__);
    sub_1D0F0B4(&ExUISkinTexture___c__DisplayClass5_0_TypeInfo);
    byte_4E78DA4 = 1;
  }
  v5 = sub_1D0F300(ExUISkinTexture___c__DisplayClass5_0_TypeInfo);
...
void ExUISkinTexture__setupTexture(ExUISkinTexture_o *this, const MethodInfo *method)
{
  ...
  if ( !Instance )
    sub_1D0F30C(0, v4);
  AtlasManager__SetSkinLocal_41982968((AtlasManager_o *)Instance, this, this->fields.skinType, 0);
}
