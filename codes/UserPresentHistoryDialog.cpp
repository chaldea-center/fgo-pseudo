void __fastcall UserPresentHistoryDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A2CCD6 & 1) == 0 )
  {
    sub_1B761C0(&UserPresentHistoryDialog_TypeInfo, v1);
    byte_4A2CCD6 = 1;
  }
...
void __fastcall UserPresentHistoryDialog__OnClickClose(UserPresentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2CCD5 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_UserPresentHistoryDialog_OnClickClose__, v3);
    sub_1B761C0(&Method_UserPresentHistoryDialog__OnClickClose_b__11_0__, v4);
    byte_4A2CCD5 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( (*((_BYTE *)Method_UserPresentHistoryDialog_OnClickClose__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B761D8(Method_UserPresentHistoryDialog_OnClickClose__);
...
void __fastcall UserPresentHistoryDialog__Open(UserPresentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2CCD4 & 1) == 0 )
  {
    ...
    sub_1B761C0(&UserPresentHistoryDialog_TypeInfo, v3);
    sub_1B761C0(&StringLiteral_10452/*"PRESENT_HISTORY_NO_HISTORY_MESSAGE"*/, v4);
    sub_1B761C0(&StringLiteral_10450/*"PRESENT_HISTORY_DIALOG_SUBTITLE"*/, v5);
    sub_1B761C0(&StringLiteral_10451/*"PRESENT_HISTORY_DIALOG_TITLE"*/, v6);
  ...
  userPresentHistoryListViewManager = (UserPresentHistoryListViewManager_o *)LocalizationManager__Get(
                                                                               (System_String_o *)StringLiteral_10450/*"PRESENT_HISTORY_DIALOG_SUBTITLE"*/,
                                                                               0LL);
  if ( !subTitle )
    goto LABEL_28;
  ...
  userPresentHistoryListViewManager = (UserPresentHistoryListViewManager_o *)LocalizationManager__Get(
                                                                               (System_String_o *)StringLiteral_10451/*"PRESENT_HISTORY_DIALOG_TITLE"*/,
                                                                               0LL);
  if ( !titleLabel )
    goto LABEL_28;
    ...
    if ( userPresentHistoryListViewManager )
    {
      ...
      if ( userPresentHistoryListViewManager )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        userPresentHistoryListViewManager = (UserPresentHistoryListViewManager_o *)LocalizationManager__Get(
                                                                                     (System_String_o *)StringLiteral_10452/*"PRESENT_HISTORY_NO_HISTORY_MESSAGE"*/,
                                                                                     0LL);
        if ( messageLabel )
        {
...
LABEL_28:
    sub_1B7641C(userPresentHistoryListViewManager, v9);
  }
LABEL_20:
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.closeAction, 0, v20, v21);
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.decideAction, 0, v22, v23);
}
