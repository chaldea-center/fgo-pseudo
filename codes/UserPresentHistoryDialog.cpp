void UserPresentHistoryDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E03757 & 1) == 0 )
  {
    sub_1CE6700(&UserPresentHistoryDialog_TypeInfo);
    byte_4E03757 = 1;
  }
...
void UserPresentHistoryDialog__OnClickClose(UserPresentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E03756 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_UserPresentHistoryDialog_OnClickClose__);
    sub_1CE6700(&Method_UserPresentHistoryDialog__OnClickClose_b__11_0__);
    byte_4E03756 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( (*((_BYTE *)Method_UserPresentHistoryDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_UserPresentHistoryDialog_OnClickClose__);
...
void UserPresentHistoryDialog__Open(UserPresentHistoryDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E03755 & 1) == 0 )
  {
    ...
    sub_1CE6700(&UserPresentHistoryDialog_TypeInfo);
    sub_1CE6700(&StringLiteral_10555/*"PRESENT_HISTORY_NO_HISTORY_MESSAGE"*/);
    sub_1CE6700(&StringLiteral_10553/*"PRESENT_HISTORY_DIALOG_SUBTITLE"*/);
    sub_1CE6700(&StringLiteral_10554/*"PRESENT_HISTORY_DIALOG_TITLE"*/);
  ...
  userPresentHistoryListViewManager = (UserPresentHistoryListViewManager_o *)LocalizationManager__Get(
                                                                               (System_String_o *)StringLiteral_10553/*"PRESENT_HISTORY_DIALOG_SUBTITLE"*/,
                                                                               0);
  if ( !subTitle )
    goto LABEL_28;
  ...
  userPresentHistoryListViewManager = (UserPresentHistoryListViewManager_o *)LocalizationManager__Get(
                                                                               (System_String_o *)StringLiteral_10554/*"PRESENT_HISTORY_DIALOG_TITLE"*/,
                                                                               0);
  if ( !titleLabel )
    goto LABEL_28;
    ...
    if ( userPresentHistoryListViewManager )
    {
      ...
      if ( userPresentHistoryListViewManager )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        userPresentHistoryListViewManager = (UserPresentHistoryListViewManager_o *)LocalizationManager__Get(
                                                                                     (System_String_o *)StringLiteral_10555/*"PRESENT_HISTORY_NO_HISTORY_MESSAGE"*/,
                                                                                     0);
        if ( messageLabel )
        {
...
LABEL_28:
    sub_1CE6958(userPresentHistoryListViewManager, v3);
  }
LABEL_20:
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.closeAction, 0, v14, v15, v16, v17, v18, v19);
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.decideAction, 0, v20, v21, v22, v23, v24, v25);
}
