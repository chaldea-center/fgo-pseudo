void __fastcall SelectTdCommandTypeController___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B05760 & 1) == 0 )
  {
    sub_1BC3008(&SelectTdCommandTypeController_TypeInfo, v1);
  ...
  v4 = (System_Array_o *)sub_1BC30B0(BattleCommand_TYPE___TypeInfo, 3LL);
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)SelectTdCommandTypeController_TypeInfo->static_fields, (int32_t)v5, v6, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B0575E & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_DataManager_GetMaster_TreasureDvcMaster___, v3);
    ...
    sub_1BC3008(&Method_System_Linq_Enumerable_Select_BattleCommand_TYPE__int___, v6);
    ...
    sub_1BC3008(&System_Func_BattleCommand_TYPE__int__TypeInfo, v10);
    sub_1BC3008(&SelectTdCommandTypeController_TypeInfo, v11);
    sub_1BC3008(&Method_SelectTdCommandTypeController___c__GetCommandTypeArray_b__7_0__, v12);
    sub_1BC3008(&Method_SelectTdCommandTypeController___c__DisplayClass7_0__GetCommandTypeArray_b__1__, v13);
    sub_1BC3008(&SelectTdCommandTypeController___c__DisplayClass7_0_TypeInfo, v14);
    sub_1BC3008(&SelectTdCommandTypeController___c_TypeInfo, v15);
    byte_4B0575E = 1;
  }
  v16 = sub_1BC3254(SelectTdCommandTypeController___c__DisplayClass7_0_TypeInfo);
  ...
  svtData = (BattleServantData_o *)DataManager__GetMaster_object_((const MethodInfo_3001E10 *)Method_DataManager_GetMaster_TreasureDvcMaster___);
  if ( !svtData )
    goto LABEL_28;
  ...
  if ( !_9__7_0 )
  {
    ...
    _9__7_0 = (System_Func_T__TResult__o *)sub_1BC3254(System_Func_BattleCommand_TYPE__int__TypeInfo);
  ...
  v30 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_Int32Enum__int_(
                                                               ...
                                                               (const MethodInfo_3034528 *)Method_System_Linq_Enumerable_Select_BattleCommand_TYPE__int___);
  ...
  if ( !svtData )
  {
    ...
    if ( (BYTE5(svtData->fields.deckSvt) & 1) == 0 )
      svtData = (BattleServantData_o *)sub_1C1346C(inited);
    v17 = **(BattleServantData_o ***)&svtData->fields._ExistIndividualityServant_k__BackingField;
  }
  if ( !v16 )
LABEL_28:
    sub_1BC3264(svtData, v17);
  *(_QWORD *)(v16 + 16) = v17;
  sub_1BC2FAC((CGThumbnailListItem_o *)(v16 + 16), (int32_t)v17, v32, v33);
  v38 = (System_Func_int__bool__o *)sub_1BC3254(System_Func_int__bool__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B0575C & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_2738/*"BATTLE_DIALOG_TREASURE_DEVICE_TYPE_CHANGE_NOW_TYPE"*/, v2);
    byte_4B0575C = 1;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  return LocalizationManager__Get((System_String_o *)StringLiteral_2738/*"BATTLE_DIALOG_TREASURE_DEVICE_TYPE_CHANGE_NOW_TYPE"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BC3008(&LocalizationManager_TypeInfo, method);
    sub_1BC3008(&StringLiteral_2740/*"BATTLE_DIALOG_TREASURE_DEVICE_TYPE_CHANGE_TITLE"*/, v3);
    byte_4B0575B = 1;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_2740/*"BATTLE_DIALOG_TREASURE_DEVICE_TYPE_CHANGE_TITLE"*/, 0LL);
  svtData = this->fields.svtData;
  if ( !svtData )
    sub_1BC3264(v4, v5);
  v7 = v4;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B0575F & 1) == 0 )
  {
    this = (SelectTdCommandTypeController_o *)sub_1BC3008(
  ...
  if ( ((unsigned __int8)this & 1) == 0 )
  {
    ...
    *(_QWORD *)&v9.fields.fakeValue = v5;
    this = (SelectTdCommandTypeController_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48024060(
                                                v9,
                                                0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B0575A & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Array_IndexOf_SelectTreasureDeviceInfo_TdChangeParam___, method);
    sub_1BC3008(&Method_System_Linq_Enumerable_FirstOrDefault_SelectTreasureDeviceInfo_TdChangeParam___, v3);
    sub_1BC3008(&System_Func_SelectTreasureDeviceInfo_TdChangeParam__bool__TypeInfo, v4);
    sub_1BC3008(&Method_SelectTdCommandTypeController___c__DisplayClass2_0__GetNowSelectingCommandIndex_b__0__, v5);
    sub_1BC3008(&SelectTdCommandTypeController___c__DisplayClass2_0_TypeInfo, v6);
    byte_4B0575A = 1;
  }
  v7 = sub_1BC3254(SelectTdCommandTypeController___c__DisplayClass2_0_TypeInfo);
  ...
  if ( !v7
    ...
    || (treasureDevices = (System_Collections_Generic_IEnumerable_TSource__o *)SelectTreasureDeviceInfo_k__BackingField->fields.treasureDevices,
        v13 = (System_Func_object__bool__o *)sub_1BC3254(System_Func_SelectTreasureDeviceInfo_TdChangeParam__bool__TypeInfo),
        System_Func_object__bool____ctor(
          v13,
          (Il2CppObject *)v7,
          Method_SelectTdCommandTypeController___c__DisplayClass2_0__GetNowSelectingCommandIndex_b__0__,
          0LL),
        NowCommandTypeId = System_Linq_Enumerable__FirstOrDefault_object__50493748(
                             treasureDevices,
                             (System_Func_TSource__bool__o *)v13,
                             (const MethodInfo_3027934 *)Method_System_Linq_Enumerable_FirstOrDefault_SelectTreasureDeviceInfo_TdChangeParam___),
        (v14 = this->fields._SelectTreasureDeviceInfo_k__BackingField) == 0LL) )
  {
    sub_1BC3264(NowCommandTypeId, v10);
  }
  return System_Array__IndexOf_object_(
           (System_Object_array *)v14->fields.treasureDevices,
           NowCommandTypeId,
           (const MethodInfo_3100440 *)Method_System_Array_IndexOf_SelectTreasureDeviceInfo_TdChangeParam___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B0575D & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Linq_Enumerable_Select_int__SelectTreasureDeviceInfo_TdChangeParam___, method);
    sub_1BC3008(&Method_System_Linq_Enumerable_ToArray_SelectTreasureDeviceInfo_TdChangeParam___, v3);
    sub_1BC3008(&System_Func_int__SelectTreasureDeviceInfo_TdChangeParam__TypeInfo, v4);
    sub_1BC3008(&SelectTreasureDeviceInfo_TypeInfo, v5);
    sub_1BC3008(&Method_SelectTdCommandTypeController___c__DisplayClass6_0__MakeSelectTreasureDeviceInfo_b__0__, v6);
    sub_1BC3008(&SelectTdCommandTypeController___c__DisplayClass6_0_TypeInfo, v7);
    byte_4B0575D = 1;
  }
  v8 = sub_1BC3254(SelectTdCommandTypeController___c__DisplayClass6_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v8, 0LL);
  svtData = this->fields.svtData;
  if ( !svtData || (svtData = (BattleServantData_o *)BattleServantData__getTreasureDvcId(svtData, 0, 0LL, 0LL), !v8) )
    sub_1BC3264(svtData, v9);
  *(_DWORD *)(v8 + 16) = (_DWORD)svtData;
  CommandTypeArray = (System_Collections_Generic_IEnumerable_TSource__o *)SelectTdCommandTypeController__GetCommandTypeArray(
                                                                            this,
                                                                            v9);
  v12 = (System_Func_T__TResult__o *)sub_1BC3254(System_Func_int__SelectTreasureDeviceInfo_TdChangeParam__TypeInfo);
  ...
  v13 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_int__object_(
                                                               ...
                                                               (const MethodInfo_3033958 *)Method_System_Linq_Enumerable_Select_int__SelectTreasureDeviceInfo_TdChangeParam___);
  v14 = System_Linq_Enumerable__ToArray_object_(
          v13,
          (const MethodInfo_303E54C *)Method_System_Linq_Enumerable_ToArray_SelectTreasureDeviceInfo_TdChangeParam___);
  v15 = (SelectTreasureDeviceInfo_o *)sub_1BC3254(SelectTreasureDeviceInfo_TypeInfo);
  SelectTreasureDeviceInfo___ctor_40728508(v15, (SelectTreasureDeviceInfo_TdChangeParam_array *)v14, 0LL);
  return v15;
}
...
void __fastcall SelectTdCommandTypeController___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B05761 & 1) == 0 )
  {
    sub_1BC3008(&SelectTdCommandTypeController___c_TypeInfo, v1);
    byte_4B05761 = 1;
  }
  v2 = (Il2CppObject *)sub_1BC3254(SelectTdCommandTypeController___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  SelectTdCommandTypeController___c_TypeInfo->static_fields->__9 = (struct SelectTdCommandTypeController___c_o *)v2;
  sub_1BC2FAC((CGThumbnailListItem_o *)SelectTdCommandTypeController___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05762 & 1) == 0 )
  {
    sub_1BC3008(&SelectTreasureDeviceInfo_TdChangeParam_TypeInfo, *(_QWORD *)&x);
    byte_4B05762 = 1;
  }
  tdId = this->fields.tdId;
  v6 = (SelectTreasureDeviceInfo_TdChangeParam_o *)sub_1BC3254(SelectTreasureDeviceInfo_TdChangeParam_TypeInfo);
  SelectTreasureDeviceInfo_TdChangeParam___ctor_40728928(v6, tdId, x, x, 0LL, 0LL);
  return v6;
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4B05763 & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Linq_Enumerable_Contains_int___, *(_QWORD *)&x);
    byte_4B05763 = 1;
  }
