        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D3292F & 1) == 0 )
  {
    sub_1C93AD4(&Method_System_Collections_Generic_Dictionary_string__ScriptEncryptEntity__TryGetValue__);
    byte_4D3292F = 1;
  }
  value = 0;
  ...
  if ( result )
  {
    if ( System_Collections_Generic_Dictionary_object__object___TryGetValue(
           ...
           &value,
           (const MethodInfo_35303B4 *)Method_System_Collections_Generic_Dictionary_string__ScriptEncryptEntity__TryGetValue__) )
    {
...
void ScriptEncryptSettings__OnEnable(ScriptEncryptSettings_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D3292D & 1) == 0 )
  {
    sub_1C93AD4(&Method_System_Collections_Generic_Dictionary_string__ScriptEncryptEntity__Add__);
    sub_1C93AD4(&Method_System_Collections_Generic_Dictionary_string__ScriptEncryptEntity___ctor__);
    sub_1C93AD4(&System_Collections_Generic_Dictionary_string__ScriptEncryptEntity__TypeInfo);
    byte_4D3292D = 1;
  }
  if ( this->fields.settings )
  {
    v3 = (System_Collections_Generic_Dictionary_object__object__o *)sub_1C93D20(System_Collections_Generic_Dictionary_string__ScriptEncryptEntity__TypeInfo);
    System_Collections_Generic_Dictionary_object__object____ctor(
      v3,
      (const MethodInfo_352E1F8 *)Method_System_Collections_Generic_Dictionary_string__ScriptEncryptEntity___ctor__);
    ...
    sub_1C93A78((GrandQuestFolderBoardItem_o *)p_lookup, (int32_t)v3, v5, v6, v7, v8, v9, v10);
    ...
    if ( v14 >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        System_Collections_Generic_Dictionary_object__object___Add(
          ...
          *(Il2CppObject **)(v16 + 16),
          (Il2CppObject *)v16,
          (const MethodInfo_352EBA8 *)Method_System_Collections_Generic_Dictionary_string__ScriptEncryptEntity__Add__);
        v14 = *(_DWORD *)(v13 + 24);
        if ( (int)++v15 >= v14 )
          return;
      }
