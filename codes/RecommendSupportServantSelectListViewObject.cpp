        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E73479 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_UnityEngine_GameObject_GetComponent_RecommendSupportServantSelectListViewItemDraw___);
    byte_4E73479 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_32A8444 *)Method_UnityEngine_GameObject_GetComponent_RecommendSupportServantSelectListViewItemDraw___);
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_32A8444 *)Method_UnityEngine_GameObject_GetComponent_RecommendSupportServantSelectListViewObject___)) == 0) )
  {
...
// local variable allocation has failed, the output may be wrong!
void RecommendSupportServantSelectListViewObject__Init_36053896(
        RecommendSupportServantSelectListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void RecommendSupportServantSelectListViewObject__Init_36056312(
        RecommendSupportServantSelectListViewObject_o *this,
        int32_t initMode,
...
// local variable allocation has failed, the output may be wrong!
void RecommendSupportServantSelectListViewObject__Init_36056396(
        RecommendSupportServantSelectListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void RecommendSupportServantSelectListViewObject__SetItem_36064960(
        RecommendSupportServantSelectListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
        ...
        const MethodInfo *method)
{
  ...
  v11 = (RecommendSupportServantSelectListViewObject_o *)sub_1D0F6A8(v8);
