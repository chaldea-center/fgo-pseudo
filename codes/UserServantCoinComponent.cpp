...
bool UserServantCoinComponent__closeMenu(UserServantCoinComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CE9C2A & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_UserServantCoinComponent_onClose__);
    byte_4CE9C2A = 1;
  }
  ...
  if ( !userServantCoinListMenu )
    sub_1C7BD40(v5, v6);
  UserServantCoinMenu__Close_34278812(userServantCoinListMenu, v4, v7);
  return 1;
}
  ...
  if ( !userServantCoinListMenu
    || (UserServantCoinMenu__Init(userServantCoinListMenu, method),
        (userServantCoinListMenu = (UserServantCoinMenu_o *)UnityEngine_Component__get_gameObject(
                                                              ...
                                                              0)) == 0) )
  {
    sub_1C7BD40(userServantCoinListMenu, method);
  }
...
void UserServantCoinComponent__onEndMenu(UserServantCoinComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CE9C2C & 1) == 0 )
  {
    sub_1C7BAE8(&StringLiteral_3529/*"CLOSE_USER_SERVANT_COIN"*/);
    byte_4CE9C2C = 1;
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    sub_1C7BD40(0, method);
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_3529/*"CLOSE_USER_SERVANT_COIN"*/, 0);
}
...
bool UserServantCoinComponent__openMenu(UserServantCoinComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CE9C29 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_UserServantCoinComponent__openMenu_b__5_0__);
    sub_1C7BAE8(&Method_UserServantCoinComponent_onEndMenu__);
    byte_4CE9C29 = 1;
  }
  ...
  if ( !gameObject
    || (UnityEngine_GameObject__SetActive(gameObject, 1, 0),
        ...
        v7 = (UserServantCoinMenu_CallbackFunc_o *)sub_1C7BD34(UserServantCoinMenu_CallbackFunc_TypeInfo),
