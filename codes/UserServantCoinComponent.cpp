...
bool __fastcall UserServantCoinComponent__closeMenu(UserServantCoinComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B40162 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_UserServantCoinComponent_onClose__, v3);
    byte_4B40162 = 1;
  }
  ...
  if ( !userServantCoinListMenu )
    sub_1BDBAD4(v6, v7);
  UserServantCoinMenu__Close_32914700(userServantCoinListMenu, v5, v8);
  return 1;
}
  ...
  if ( !userServantCoinListMenu
    || (UserServantCoinMenu__Init(userServantCoinListMenu, method),
        (userServantCoinListMenu = (UserServantCoinMenu_o *)UnityEngine_Component__get_gameObject(
                                                              ...
                                                              0LL)) == 0LL) )
  {
    sub_1BDBAD4(userServantCoinListMenu, method);
  }
...
void __fastcall UserServantCoinComponent__onEndMenu(UserServantCoinComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B40164 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_3556/*"CLOSE_USER_SERVANT_COIN"*/, method);
    byte_4B40164 = 1;
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    sub_1BDBAD4(0LL, method);
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_3556/*"CLOSE_USER_SERVANT_COIN"*/, 0LL);
}
...
bool __fastcall UserServantCoinComponent__openMenu(UserServantCoinComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&System_Action_TypeInfo, method);
    sub_1BDB878(&UserServantCoinMenu_CallbackFunc_TypeInfo, v3);
    sub_1BDB878(&Method_UserServantCoinComponent__openMenu_b__5_0__, v4);
    sub_1BDB878(&Method_UserServantCoinComponent_onEndMenu__, v5);
    byte_4B40161 = 1;
  }
  ...
  if ( !gameObject
    || (UnityEngine_GameObject__SetActive(gameObject, 1, 0LL),
        ...
        v10 = (UserServantCoinMenu_CallbackFunc_o *)sub_1BDBAC4(UserServantCoinMenu_CallbackFunc_TypeInfo),
