...
bool __fastcall UserServantCoinComponent__closeMenu(UserServantCoinComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA65A & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_UserServantCoinComponent_onClose__, v3);
    byte_49FA65A = 1;
  }
  ...
  if ( !userServantCoinListMenu )
    sub_1B64C5C(v6, v7);
  UserServantCoinMenu__Close_31328200(userServantCoinListMenu, v5, v8);
  return 1;
}
  ...
  if ( !userServantCoinListMenu
    || (UserServantCoinMenu__Init(userServantCoinListMenu, method),
        (userServantCoinListMenu = (UserServantCoinMenu_o *)UnityEngine_Component__get_gameObject(
                                                              ...
                                                              0LL)) == 0LL) )
  {
    sub_1B64C5C(userServantCoinListMenu, method);
  }
...
void __fastcall UserServantCoinComponent__onEndMenu(UserServantCoinComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA65C & 1) == 0 )
  {
    sub_1B64A00(&StringLiteral_3582/*"CLOSE_USER_SERVANT_COIN"*/, method);
    byte_49FA65C = 1;
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
...
bool __fastcall UserServantCoinComponent__openMenu(UserServantCoinComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B64A00(&System_Action_TypeInfo, method);
    sub_1B64A00(&UserServantCoinMenu_CallbackFunc_TypeInfo, v3);
    sub_1B64A00(&Method_UserServantCoinComponent__openMenu_b__5_0__, v4);
    sub_1B64A00(&Method_UserServantCoinComponent_onEndMenu__, v5);
    byte_49FA659 = 1;
  }
  ...
  if ( !gameObject
    || (UnityEngine_GameObject__SetActive(gameObject, 1, 0LL),
        ...
        v10 = (UserServantCoinMenu_CallbackFunc_o *)sub_1B64C4C(UserServantCoinMenu_CallbackFunc_TypeInfo),
