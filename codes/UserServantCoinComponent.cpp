...
bool UserServantCoinComponent__closeMenu(UserServantCoinComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFFF64 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_UserServantCoinComponent_onClose__);
    byte_4DFFF64 = 1;
  }
  ...
  if ( !userServantCoinListMenu )
    sub_1CE6958(v5, v6);
  UserServantCoinMenu__Close_34829688(userServantCoinListMenu, v4, v7);
  return 1;
}
  ...
  if ( !userServantCoinListMenu
    || (UserServantCoinMenu__Init(userServantCoinListMenu, method),
        (userServantCoinListMenu = (UserServantCoinMenu_o *)UnityEngine_Component__get_gameObject(
                                                              ...
                                                              0)) == 0) )
  {
    sub_1CE6958(userServantCoinListMenu, method);
  }
...
void UserServantCoinComponent__onEndMenu(UserServantCoinComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFFF66 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_3552/*"CLOSE_USER_SERVANT_COIN"*/);
    byte_4DFFF66 = 1;
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    sub_1CE6958(0, method);
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_3552/*"CLOSE_USER_SERVANT_COIN"*/, 0);
}
...
bool UserServantCoinComponent__openMenu(UserServantCoinComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFFF63 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_UserServantCoinComponent__openMenu_b__5_0__);
    sub_1CE6700(&Method_UserServantCoinComponent_onEndMenu__);
    byte_4DFFF63 = 1;
  }
  ...
  if ( !gameObject
    || (UnityEngine_GameObject__SetActive(gameObject, 1, 0),
        ...
        v7 = (UserServantCoinMenu_CallbackFunc_o *)sub_1CE694C(UserServantCoinMenu_CallbackFunc_TypeInfo),
