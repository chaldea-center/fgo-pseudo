...
bool __fastcall UserServantCoinComponent__closeMenu(UserServantCoinComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B8ED & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_UserServantCoinComponent_onClose__, v3);
    byte_4A6B8ED = 1;
  }
  ...
  if ( !userServantCoinListMenu )
    sub_1B9026C(v6, v7);
  UserServantCoinMenu__Close_31615548(userServantCoinListMenu, v5, v8);
  return 1;
}
  ...
  if ( !userServantCoinListMenu
    || (UserServantCoinMenu__Init(userServantCoinListMenu, method),
        (userServantCoinListMenu = (UserServantCoinMenu_o *)UnityEngine_Component__get_gameObject(
                                                              ...
                                                              0LL)) == 0LL) )
  {
    sub_1B9026C(userServantCoinListMenu, method);
  }
...
void __fastcall UserServantCoinComponent__onEndMenu(UserServantCoinComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B8EF & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_3605/*"CLOSE_USER_SERVANT_COIN"*/, method);
    byte_4A6B8EF = 1;
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    sub_1B9026C(0LL, method);
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_3605/*"CLOSE_USER_SERVANT_COIN"*/, 0LL);
}
...
bool __fastcall UserServantCoinComponent__openMenu(UserServantCoinComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B90010(&System_Action_TypeInfo, method);
    sub_1B90010(&UserServantCoinMenu_CallbackFunc_TypeInfo, v3);
    sub_1B90010(&Method_UserServantCoinComponent__openMenu_b__5_0__, v4);
    sub_1B90010(&Method_UserServantCoinComponent_onEndMenu__, v5);
    byte_4A6B8EC = 1;
  }
  ...
  if ( !gameObject
    || (UnityEngine_GameObject__SetActive(gameObject, 1, 0LL),
        ...
        v10 = (UserServantCoinMenu_CallbackFunc_o *)sub_1B9025C(UserServantCoinMenu_CallbackFunc_TypeInfo),
