...
bool __fastcall UserServantCoinComponent__closeMenu(UserServantCoinComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A49CA8 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_UserServantCoinComponent_onClose__, v3);
    byte_4A49CA8 = 1;
  }
  ...
  if ( !userServantCoinListMenu )
    sub_1B86614(v6, v7);
  UserServantCoinMenu__Close_32236040(userServantCoinListMenu, v5, v8);
  return 1;
}
  ...
  if ( !userServantCoinListMenu
    || (UserServantCoinMenu__Init(userServantCoinListMenu, method),
        (userServantCoinListMenu = (UserServantCoinMenu_o *)UnityEngine_Component__get_gameObject(
                                                              ...
                                                              0LL)) == 0LL) )
  {
    sub_1B86614(userServantCoinListMenu, method);
  }
...
void __fastcall UserServantCoinComponent__onEndMenu(UserServantCoinComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A49CAA & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_3521/*"CLOSE_USER_SERVANT_COIN"*/, method);
    byte_4A49CAA = 1;
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    sub_1B86614(0LL, method);
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_3521/*"CLOSE_USER_SERVANT_COIN"*/, 0LL);
}
...
bool __fastcall UserServantCoinComponent__openMenu(UserServantCoinComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B863B8(&System_Action_TypeInfo, method);
    sub_1B863B8(&UserServantCoinMenu_CallbackFunc_TypeInfo, v3);
    sub_1B863B8(&Method_UserServantCoinComponent__openMenu_b__5_0__, v4);
    sub_1B863B8(&Method_UserServantCoinComponent_onEndMenu__, v5);
    byte_4A49CA7 = 1;
  }
  ...
  if ( !gameObject
    || (UnityEngine_GameObject__SetActive(gameObject, 1, 0LL),
        ...
        v10 = (UserServantCoinMenu_CallbackFunc_o *)sub_1B86604(UserServantCoinMenu_CallbackFunc_TypeInfo),
