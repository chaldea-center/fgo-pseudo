...
bool __fastcall UserServantCoinComponent__closeMenu(UserServantCoinComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_438935D & 1) == 0 )
  {
    ...
    sub_B775C4(&Method_UserServantCoinComponent_onClose__);
    byte_438935D = 1;
  }
  ...
  if ( !userServantCoinListMenu )
    sub_B7769C(v5, v6);
  UserServantCoinMenu__Close_21763456(userServantCoinListMenu, v4, v7);
  return 1;
}
  ...
  if ( !userServantCoinListMenu
    || (UserServantCoinMenu__Init(userServantCoinListMenu, method),
        (userServantCoinListMenu = (UserServantCoinMenu_o *)UnityEngine_Component__get_gameObject(
                                                              ...
                                                              0LL)) == 0LL) )
  {
    sub_B7769C(userServantCoinListMenu, method);
  }
...
void __fastcall UserServantCoinComponent__onEndMenu(UserServantCoinComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_438935F & 1) == 0 )
  {
    sub_B775C4(&StringLiteral_3237/*"CLOSE_USER_SERVANT_COIN"*/);
    byte_438935F = 1;
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    sub_B7769C(0LL, method);
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_3237/*"CLOSE_USER_SERVANT_COIN"*/, 0LL);
}
...
bool __fastcall UserServantCoinComponent__openMenu(UserServantCoinComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_438935C & 1) == 0 )
  {
    ...
    sub_B775C4(&Method_UserServantCoinComponent__openMenu_b__5_0__);
    sub_B775C4(&Method_UserServantCoinComponent_onEndMenu__);
    byte_438935C = 1;
  }
  ...
  if ( !gameObject
    || (UnityEngine_GameObject__SetActive(gameObject, 1, 0LL),
        ...
        v7 = (UserServantCoinMenu_CallbackFunc_o *)sub_B77694(UserServantCoinMenu_CallbackFunc_TypeInfo),
