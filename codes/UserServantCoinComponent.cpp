...
bool UserServantCoinComponent__closeMenu(UserServantCoinComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D27DAF & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_UserServantCoinComponent_onClose__);
    byte_4D27DAF = 1;
  }
  ...
  if ( !userServantCoinListMenu )
    sub_1C942F0(v5, v6);
  UserServantCoinMenu__Close_34460672(userServantCoinListMenu, v4, v7);
  return 1;
}
  ...
  if ( !userServantCoinListMenu
    || (UserServantCoinMenu__Init(userServantCoinListMenu, method),
        (userServantCoinListMenu = (UserServantCoinMenu_o *)UnityEngine_Component__get_gameObject(
                                                              ...
                                                              0)) == 0) )
  {
    sub_1C942F0(userServantCoinListMenu, method);
  }
...
void UserServantCoinComponent__onEndMenu(UserServantCoinComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D27DB1 & 1) == 0 )
  {
    sub_1C94098(&StringLiteral_3529/*"CLOSE_USER_SERVANT_COIN"*/);
    byte_4D27DB1 = 1;
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
...
bool UserServantCoinComponent__openMenu(UserServantCoinComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D27DAE & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_UserServantCoinComponent__openMenu_b__5_0__);
    sub_1C94098(&Method_UserServantCoinComponent_onEndMenu__);
    byte_4D27DAE = 1;
  }
  ...
  if ( !gameObject
    || (UnityEngine_GameObject__SetActive(gameObject, 1, 0),
        ...
        v7 = (UserServantCoinMenu_CallbackFunc_o *)sub_1C942E4(UserServantCoinMenu_CallbackFunc_TypeInfo),
