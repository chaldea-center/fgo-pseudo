...
bool __fastcall UserServantCoinComponent__closeMenu(UserServantCoinComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49B6736 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_UserServantCoinComponent_onClose__, v3);
    byte_49B6736 = 1;
  }
  ...
  if ( !userServantCoinListMenu )
    sub_1B4D1EC(v6, v7);
  UserServantCoinMenu__Close_31896636(userServantCoinListMenu, v5, v8);
  return 1;
}
  ...
  if ( !userServantCoinListMenu
    || (UserServantCoinMenu__Init(userServantCoinListMenu, method),
        (userServantCoinListMenu = (UserServantCoinMenu_o *)UnityEngine_Component__get_gameObject(
                                                              ...
                                                              0LL)) == 0LL) )
  {
    sub_1B4D1EC(userServantCoinListMenu, method);
  }
...
void __fastcall UserServantCoinComponent__onEndMenu(UserServantCoinComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49B6738 & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_3502/*"CLOSE_USER_SERVANT_COIN"*/, method);
    byte_49B6738 = 1;
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    sub_1B4D1EC(0LL, method);
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_3502/*"CLOSE_USER_SERVANT_COIN"*/, 0LL);
}
...
bool __fastcall UserServantCoinComponent__openMenu(UserServantCoinComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B4CF90(&System_Action_TypeInfo, method);
    sub_1B4CF90(&UserServantCoinMenu_CallbackFunc_TypeInfo, v3);
    sub_1B4CF90(&Method_UserServantCoinComponent__openMenu_b__5_0__, v4);
    sub_1B4CF90(&Method_UserServantCoinComponent_onEndMenu__, v5);
    byte_49B6735 = 1;
  }
  ...
  if ( !gameObject
    || (UnityEngine_GameObject__SetActive(gameObject, 1, 0LL),
        ...
        v10 = (UserServantCoinMenu_CallbackFunc_o *)sub_1B4D1DC(UserServantCoinMenu_CallbackFunc_TypeInfo),
