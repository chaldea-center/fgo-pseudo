void ScriptBackLog___ctor(ScriptBackLog_o *this, const MethodInfo *method)
{
  ...
  v3 = (System_Collections_Generic_List_object__o *)sub_1C32E6C(System_Collections_Generic_List_ScriptMessageLabel__TypeInfo);
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.logData, (int32_t)v3, v4, v5);
...
void ScriptBackLog__AddLog(ScriptBackLog_o *this, ScriptMessageLabel_o *label, const MethodInfo *method)
{
  ...
  else
  {
    ...
    sub_1C32BC4((CGThumbnailListItem_o *)(v10 + 4), (int32_t)label, (int32_t)method, v3);
  }
  if ( !label )
LABEL_12:
    sub_1C32E7C(logData);
...
void ScriptBackLog__ClearLog(ScriptBackLog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C398E5 & 1) == 0 )
  {
    this = (ScriptBackLog_o *)sub_1C32C20(&Method_System_Collections_Generic_List_ScriptMessageLabel__Clear__);
    byte_4C398E5 = 1;
  }
...
void ScriptBackLog__Close(ScriptBackLog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C398E3 & 1) == 0 )
  {
    this = (ScriptBackLog_o *)sub_1C32C20(&SoundManager_TypeInfo);
    byte_4C398E3 = 1;
  }
...
void ScriptBackLog__EraseLog(ScriptBackLog_o *this, int32_t startIndex, const MethodInfo *method)
{
  ...
  if ( (byte_4C398E6 & 1) == 0 )
  {
    sub_1C32C20(&Method_System_Collections_Generic_List_ScriptMessageLabel__RemoveRange__);
  ...
  if ( size >= startIndex )
    System_Collections_Generic_List_object___RemoveRange(
      ...
      startIndex,
      size - startIndex,
      (const MethodInfo_379A028 *)Method_System_Collections_Generic_List_ScriptMessageLabel__RemoveRange__);
}
...
int32_t ScriptBackLog__GetCount(ScriptBackLog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C398E9 & 1) == 0 )
  {
    this = (ScriptBackLog_o *)sub_1C32C20(&Method_System_Collections_Generic_List_ScriptMessageLabel__get_Count__);
    byte_4C398E9 = 1;
  }
  logData = v2->fields.logData;
  if ( !logData )
...
void ScriptBackLog__Open(ScriptBackLog_o *this, ScriptBackLog_ClickDelegate_o *func, const MethodInfo *method)
{
  ...
  if ( (byte_4C398E2 & 1) == 0 )
  {
    sub_1C32C20(&ScriptBackLogListViewManager_ClickDelegate_TypeInfo);
    sub_1C32C20(&Method_ScriptBackLog_OnClickEnd__);
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.clickFunc, (int32_t)func, v6, v7);
  v8 = StringLiteral_1/*""*/;
  this->fields._ReplayingAssetName_k__BackingField = (struct System_String_o *)StringLiteral_1/*""*/;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields._ReplayingAssetName_k__BackingField, v8, v9, v10);
  v11 = StringLiteral_1/*""*/;
  this->fields._ReplayingObjectName_k__BackingField = (struct System_String_o *)StringLiteral_1/*""*/;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields._ReplayingObjectName_k__BackingField, v11, v12, v13);
  this->fields._IsReplayingVoice_k__BackingField = 0;
  listViewManager = this->fields.listViewManager;
  logData = this->fields.logData;
  maxRangeY = this->fields.maxRangeY;
  v17 = (ScriptBackLogListViewManager_ClickDelegate_o *)sub_1C32E6C(ScriptBackLogListViewManager_ClickDelegate_TypeInfo);
...
LABEL_7:
  ...
  ScriptBackLogListViewManager__SetMode_44674856((ScriptBackLogListViewManager_o *)rootObject, 1, 0, v20);
}


void ScriptBackLog__Open_44671624(ScriptBackLog_o *this, const MethodInfo *method)
{
...
void ScriptBackLog__StopAllPlayVoiceAnimation(ScriptBackLog_o *this, const MethodInfo *method)
{
  ...
  while ( 1 )
  {
    ...
    if ( !System_String__op_Equality(
            *(System_String_o **)((char *)&v6.fields._current->klass + (unsigned __int64)&qword_90),
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1A78D64;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A78D24;
}
