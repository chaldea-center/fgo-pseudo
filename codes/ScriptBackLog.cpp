void ScriptBackLog___ctor(ScriptBackLog_o *this, const MethodInfo *method)
{
  ...
  v3 = (System_Collections_Generic_List_object__o *)sub_1C372A4(System_Collections_Generic_List_ScriptMessageLabel__TypeInfo);
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.logData, (int32_t)v3, v4, v5);
...
void ScriptBackLog__AddLog(ScriptBackLog_o *this, ScriptMessageLabel_o *label, const MethodInfo *method)
{
  ...
  else
  {
    ...
    sub_1C36FFC((CGThumbnailListItem_o *)(v10 + 4), (int32_t)label, (int32_t)method, v3);
  }
  if ( !label )
LABEL_12:
    sub_1C372B4(logData);
...
void ScriptBackLog__ClearLog(ScriptBackLog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C44EDF & 1) == 0 )
  {
    this = (ScriptBackLog_o *)sub_1C37058(&Method_System_Collections_Generic_List_ScriptMessageLabel__Clear__);
    byte_4C44EDF = 1;
  }
...
void ScriptBackLog__Close(ScriptBackLog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C44EDD & 1) == 0 )
  {
    this = (ScriptBackLog_o *)sub_1C37058(&SoundManager_TypeInfo);
    byte_4C44EDD = 1;
  }
...
void ScriptBackLog__EraseLog(ScriptBackLog_o *this, int32_t startIndex, const MethodInfo *method)
{
  ...
  if ( (byte_4C44EE0 & 1) == 0 )
  {
    sub_1C37058(&Method_System_Collections_Generic_List_ScriptMessageLabel__RemoveRange__);
  ...
  if ( size >= startIndex )
    System_Collections_Generic_List_object___RemoveRange(
      ...
      startIndex,
      size - startIndex,
      (const MethodInfo_37A4890 *)Method_System_Collections_Generic_List_ScriptMessageLabel__RemoveRange__);
}
...
int32_t ScriptBackLog__GetCount(ScriptBackLog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C44EE3 & 1) == 0 )
  {
    this = (ScriptBackLog_o *)sub_1C37058(&Method_System_Collections_Generic_List_ScriptMessageLabel__get_Count__);
    byte_4C44EE3 = 1;
  }
  logData = v2->fields.logData;
  if ( !logData )
...
void ScriptBackLog__Open(ScriptBackLog_o *this, ScriptBackLog_ClickDelegate_o *func, const MethodInfo *method)
{
  ...
  if ( (byte_4C44EDC & 1) == 0 )
  {
    sub_1C37058(&ScriptBackLogListViewManager_ClickDelegate_TypeInfo);
    sub_1C37058(&Method_ScriptBackLog_OnClickEnd__);
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.clickFunc, (int32_t)func, v6, v7);
  v8 = StringLiteral_1/*""*/;
  this->fields._ReplayingAssetName_k__BackingField = (struct System_String_o *)StringLiteral_1/*""*/;
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields._ReplayingAssetName_k__BackingField, v8, v9, v10);
  v11 = StringLiteral_1/*""*/;
  this->fields._ReplayingObjectName_k__BackingField = (struct System_String_o *)StringLiteral_1/*""*/;
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields._ReplayingObjectName_k__BackingField, v11, v12, v13);
  this->fields._IsReplayingVoice_k__BackingField = 0;
  listViewManager = this->fields.listViewManager;
  logData = this->fields.logData;
  maxRangeY = this->fields.maxRangeY;
  v17 = (ScriptBackLogListViewManager_ClickDelegate_o *)sub_1C372A4(ScriptBackLogListViewManager_ClickDelegate_TypeInfo);
...
LABEL_7:
  ...
  ScriptBackLogListViewManager__SetMode_44776960((ScriptBackLogListViewManager_o *)rootObject, 1, 0, v20);
}


void ScriptBackLog__Open_44773728(ScriptBackLog_o *this, const MethodInfo *method)
{
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1A7D094;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A7D054;
}
