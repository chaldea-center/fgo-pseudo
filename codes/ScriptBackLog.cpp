void ScriptBackLog___ctor(ScriptBackLog_o *this, const MethodInfo *method)
{
  ...
  v3 = (System_Collections_Generic_List_object__o *)sub_1C942E4(System_Collections_Generic_List_ScriptMessageLabel__TypeInfo);
  ...
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.logData, (int32_t)v3, v4, v5, v6, v7, v8, v9);
...
void ScriptBackLog__AddLog(ScriptBackLog_o *this, ScriptMessageLabel_o *label, const MethodInfo *method)
{
  ...
  else
  {
    ...
    sub_1C9403C((GrandQuestFolderBoardItem_o *)(v14 + 4), (int32_t)label, (int32_t)method, v3, v4, v5, v6, v7);
  }
  if ( !label )
LABEL_12:
    sub_1C942F0(logData, label);
...
void ScriptBackLog__ClearLog(ScriptBackLog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2E7FA & 1) == 0 )
  {
    this = (ScriptBackLog_o *)sub_1C94098(&Method_System_Collections_Generic_List_ScriptMessageLabel__Clear__);
    byte_4D2E7FA = 1;
  }
...
void ScriptBackLog__Close(ScriptBackLog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2E7F8 & 1) == 0 )
  {
    this = (ScriptBackLog_o *)sub_1C94098(&SoundManager_TypeInfo);
    byte_4D2E7F8 = 1;
  }
...
void ScriptBackLog__EraseLog(ScriptBackLog_o *this, int32_t startIndex, const MethodInfo *method)
{
  ...
  if ( (byte_4D2E7FB & 1) == 0 )
  {
    sub_1C94098(&Method_System_Collections_Generic_List_ScriptMessageLabel__RemoveRange__);
    sub_1C94098(&Method_System_Collections_Generic_List_ScriptMessageLabel__get_Count__);
    byte_4D2E7FB = 1;
  }
  logData = (System_Collections_Generic_List_object__o *)this->fields.logData;
  if ( !logData )
    sub_1C942F0(0, *(_QWORD *)&startIndex);
  size = logData->fields._size;
  if ( size >= startIndex )
    System_Collections_Generic_List_object___RemoveRange(
      ...
      startIndex,
      size - startIndex,
      (const MethodInfo_386C6A0 *)Method_System_Collections_Generic_List_ScriptMessageLabel__RemoveRange__);
}
...
int32_t ScriptBackLog__GetCount(ScriptBackLog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2E7FE & 1) == 0 )
  {
    this = (ScriptBackLog_o *)sub_1C94098(&Method_System_Collections_Generic_List_ScriptMessageLabel__get_Count__);
    byte_4D2E7FE = 1;
  }
  logData = v2->fields.logData;
  if ( !logData )
...
void ScriptBackLog__Open(ScriptBackLog_o *this, ScriptBackLog_ClickDelegate_o *func, const MethodInfo *method)
{
  ...
  if ( (byte_4D2E7F7 & 1) == 0 )
  {
    sub_1C94098(&ScriptBackLogListViewManager_ClickDelegate_TypeInfo);
    sub_1C94098(&Method_ScriptBackLog_OnClickEnd__);
  ...
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.clickFunc, (int32_t)func, v6, v7, v8, v9, v10, v11);
  v12 = StringLiteral_1/*""*/;
  ...
  v29 = (ScriptBackLogListViewManager_ClickDelegate_o *)sub_1C942E4(ScriptBackLogListViewManager_ClickDelegate_TypeInfo);
  ...
  {
LABEL_7:
    sub_1C942F0(rootObject, func);
  }
  ScriptBackLogListViewManager__SetMode_45577812((ScriptBackLogListViewManager_o *)rootObject, 1, 0, v32);
}


void ScriptBackLog__Open_45574580(ScriptBackLog_o *this, const MethodInfo *method)
{
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1ACA024;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1AC9FE4;
}
