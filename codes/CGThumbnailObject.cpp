...
void __fastcall CGThumbnailObject__Awake(CGThumbnailObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3FB3E & 1) == 0 )
  {
    sub_1BDB878(&Method_UnityEngine_GameObject_GetComponent_CGThumbnailListItemDraw___, method);
    byte_4B3FB3E = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_3088520 *)Method_UnityEngine_GameObject_GetComponent_CGThumbnailListItemDraw___);
...
CGThumbnailListItem_o *__fastcall CGThumbnailObject__GetItem(CGThumbnailObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3FB3F & 1) == 0 )
  {
    sub_1BDB878(&CGThumbnailListItem_TypeInfo, method);
    byte_4B3FB3F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3FB40 & 1) == 0 )
  {
    sub_1BDB878(&CGThumbnailListItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4B3FB40 = 1;
  }
...
void __fastcall CGThumbnailObject__SetInput(CGThumbnailObject_o *this, bool isInput, const MethodInfo *method)
{
  ...
  if ( (byte_4B3FB42 & 1) == 0 )
  {
    sub_1BDB878(&CGThumbnailListItem_TypeInfo, isInput);
...
void __fastcall CGThumbnailObject__SetItem_32276812(
        CGThumbnailObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall CGThumbnailObject__SetupDisp(CGThumbnailObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3FB41 & 1) == 0 )
  {
    sub_1BDB878(&Method_ActionExtensions_Call_string__string___, method);
    sub_1BDB878(&CGThumbnailListItem_TypeInfo, v3);
  ...
  if ( ((unsigned __int8)v9 & 1) != 0 )
  {
    if ( !linkItem
      ...
      || (ActionExtensions__Call_object__object_(
            ...
            (const MethodInfo_2F833C0 *)Method_ActionExtensions_Call_string__string___),
