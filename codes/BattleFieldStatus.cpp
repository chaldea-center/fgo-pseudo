void BattleFieldStatus___ctor(BattleFieldStatus_o *this, const MethodInfo *method)
{
  ...
  v3 = (struct System_Double_array *)sub_1C32CC8(double___TypeInfo, 1);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3A4BD & 1) == 0 )
  {
    sub_1C32C20(&Method_System_Collections_Generic_List_BattleServantData__FindAll__);
    ...
    sub_1C32C20(&Method_BattleFieldStatus___c__CommonAliveCount_b__3_0__);
    sub_1C32C20(&BattleFieldStatus___c_TypeInfo);
    byte_4C3A4BD = 1;
  }
  ...
  if ( !v5 )
  {
    ...
    v5 = (System_Predicate_object__o *)sub_1C32E6C(System_Predicate_BattleServantData__TypeInfo);
    ...
    sub_1C32BC4((CGThumbnailListItem_o *)&static_fields->__9__3_0, (int32_t)v5, v8, v9);
  }
  if ( !datalist
    || (All = System_Collections_Generic_List_object___FindAll(
                (System_Collections_Generic_List_object__o *)datalist,
                (System_Predicate_T__o *)v5,
                (const MethodInfo_3798ECC *)Method_System_Collections_Generic_List_BattleServantData__FindAll__)) == 0 )
  {
    sub_1C32E7C(All);
  }
  return *((_DWORD *)All + 6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3A4BE & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_System_Collections_Generic_List_BattleServantData__get_Count__);
    sub_1C32C20(&System_Predicate_BattleServantData__TypeInfo);
    sub_1C32C20(&Method_BattleFieldStatus___c__CommonRestCount_b__4_0__);
    sub_1C32C20(&BattleFieldStatus___c_TypeInfo);
    byte_4C3A4BE = 1;
  }
  All = BattleFieldStatus___c_TypeInfo;
  ...
  if ( !v5 )
  {
    ...
    sub_1C32BC4((CGThumbnailListItem_o *)&static_fields->__9__4_0, (int32_t)v5, v8, v9);
  }
  if ( !datalist
    || (All = System_Collections_Generic_List_object___FindAll(
                (System_Collections_Generic_List_object__o *)datalist,
...
void BattleFieldStatus___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C32E6C(BattleFieldStatus___c_TypeInfo);
  System_Object___ctor(v1, 0);
  BattleFieldStatus___c_TypeInfo->static_fields->__9 = (struct BattleFieldStatus___c_o *)v1;
  sub_1C32BC4((CGThumbnailListItem_o *)BattleFieldStatus___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
