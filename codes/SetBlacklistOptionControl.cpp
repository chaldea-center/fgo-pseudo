...
void SetBlacklistOptionControl__Init(SetBlacklistOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C51D6E & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_9663/*"OPTION_BLACKLIST_EXPLANATION"*/);
    byte_4C51D6E = 1;
  }
...
void SetBlacklistOptionControl__onClickOpenButton(SetBlacklistOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C51D6F & 1) == 0 )
  {
    sub_1C3E564(&Method_SetBlacklistOptionControl_onClickOpenButton__);
    sub_1C3E564(&StringLiteral_3440/*"CLICK_BLACKLIST"*/);
    byte_4C51D6F = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetBlacklistOptionControl_onClickOpenButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C3E57C(Method_SetBlacklistOptionControl_onClickOpenButton__);
