...
void SetBlacklistOptionControl__Init(SetBlacklistOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB12B6 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_9659/*"OPTION_BLACKLIST_EXPLANATION"*/);
    byte_4CB12B6 = 1;
  }
  blackListExpLabel = this->fields.blackListExpLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9659/*"OPTION_BLACKLIST_EXPLANATION"*/, 0);
...
void SetBlacklistOptionControl__onClickOpenButton(SetBlacklistOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB12B7 & 1) == 0 )
  {
    sub_1C6BA08(&Method_SetBlacklistOptionControl_onClickOpenButton__);
    sub_1C6BA08(&StringLiteral_3432/*"CLICK_BLACKLIST"*/);
    byte_4CB12B7 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetBlacklistOptionControl_onClickOpenButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C6BA20(Method_SetBlacklistOptionControl_onClickOpenButton__);
  v4 = (System_Reflection_MethodBase_o *)sub_1C6B9EC(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    sub_1C6BC60(0, v5);
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_3432/*"CLICK_BLACKLIST"*/, 0);
}