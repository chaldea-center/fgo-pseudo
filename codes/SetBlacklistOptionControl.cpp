...
void __fastcall SetBlacklistOptionControl__Init(SetBlacklistOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B17606 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_9588/*"OPTION_BLACKLIST_EXPLANATION"*/, v3);
    byte_4B17606 = 1;
  }
  blackListExpLabel = this->fields.blackListExpLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v5 = LocalizationManager__Get((System_String_o *)StringLiteral_9588/*"OPTION_BLACKLIST_EXPLANATION"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17607 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_SetBlacklistOptionControl_onClickOpenButton__, method);
    sub_1BCAFF8(&StringLiteral_3407/*"CLICK_BLACKLIST"*/, v3);
    byte_4B17607 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetBlacklistOptionControl_onClickOpenButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1BCB010(Method_SetBlacklistOptionControl_onClickOpenButton__);
  v5 = (System_Reflection_MethodBase_o *)sub_1BCAFDC(v4, v4[4]);
  OverwriteAssetSoundName__PlaySystemSe(v5, 0, 0, 0LL);
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    sub_1BCB254(0LL, v6);
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_3407/*"CLICK_BLACKLIST"*/, 0LL);
}