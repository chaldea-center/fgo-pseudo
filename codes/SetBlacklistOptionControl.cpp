...
void __fastcall SetBlacklistOptionControl__Init(SetBlacklistOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A04237 & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_9616/*"OPTION_BLACKLIST_EXPLANATION"*/, v3);
    byte_4A04237 = 1;
  }
  blackListExpLabel = this->fields.blackListExpLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v5 = LocalizationManager__Get((System_String_o *)StringLiteral_9616/*"OPTION_BLACKLIST_EXPLANATION"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A04238 & 1) == 0 )
  {
    sub_1B686D4(&Method_SetBlacklistOptionControl_onClickOpenButton__, method);
    sub_1B686D4(&StringLiteral_3507/*"CLICK_BLACKLIST"*/, v3);
    byte_4A04238 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetBlacklistOptionControl_onClickOpenButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1B686EC(Method_SetBlacklistOptionControl_onClickOpenButton__);
  v5 = (System_Reflection_MethodBase_o *)sub_1B686B8(v4, v4[4]);
  OverwriteAssetSoundName__PlaySystemSe(v5, 0, 0LL);
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    sub_1B68930(0LL, v6);
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_3507/*"CLICK_BLACKLIST"*/, 0LL);
}