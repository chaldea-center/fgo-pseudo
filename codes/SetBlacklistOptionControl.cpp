...
void __fastcall SetBlacklistOptionControl__Init(SetBlacklistOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4354145 & 1) == 0 )
  {
    ...
    sub_B70694(&StringLiteral_9896/*"OPTION_BLACKLIST_EXPLANATION"*/);
    byte_4354145 = 1;
  }
  ...
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9896/*"OPTION_BLACKLIST_EXPLANATION"*/, 0LL);
  if ( !blackListParent )
    sub_B7076C(v4, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4354146 & 1) == 0 )
  {
    ...
    sub_B70694(&StringLiteral_3114/*"CLICK_BLACKLIST"*/);
    byte_4354146 = 1;
  }
  ...
  if ( !blackListExpLabel )
    sub_B7076C(0LL, v3);
  PlayMakerFSM__SendEvent(blackListExpLabel, (System_String_o *)StringLiteral_3114/*"CLICK_BLACKLIST"*/, 0LL);
}