...
void __fastcall SetBlacklistOptionControl__Init(SetBlacklistOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BAFA65 & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_9838/*"OPTION_ADVANTAGE_CLASS_AUTO_INFO"*/, v3);
    byte_4BAFA65 = 1;
  }
  blackListExpLabel = this->fields.blackListExpLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v5 = LocalizationManager__Get((System_String_o *)StringLiteral_9838/*"OPTION_ADVANTAGE_CLASS_AUTO_INFO"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAFA66 & 1) == 0 )
  {
    sub_1C13D24(&Method_SetBlacklistOptionControl_onClickOpenButton__, method);
    sub_1C13D24(&StringLiteral_3569/*"CLICK_BACK"*/, v3);
    byte_4BAFA66 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetBlacklistOptionControl_onClickOpenButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1C13D3C(Method_SetBlacklistOptionControl_onClickOpenButton__);
  v5 = (System_Reflection_MethodBase_o *)sub_1C13D08(v4, v4[4]);
  OverwriteAssetSoundName__PlaySystemSe(v5, 0, 0, 0LL);
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    sub_1C13F80(0LL, v6);
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_3569/*"CLICK_BACK"*/, 0LL);
}