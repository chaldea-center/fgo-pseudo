...
void __fastcall SetBlacklistOptionControl__Init(SetBlacklistOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_40FC357 & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_9750/*"OPTION_BLACKLIST_EXPLANATION"*/, v3);
    byte_40FC357 = 1;
  }
  ...
  v5 = LocalizationManager__Get((System_String_o *)StringLiteral_9750/*"OPTION_BLACKLIST_EXPLANATION"*/, 0LL);
  if ( !blackListParent )
    sub_B170D4();
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FC358 & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_3037/*"CLICK_BLACKLIST"*/, v3);
    byte_40FC358 = 1;
  }
  ...
  if ( !blackListExpLabel )
    sub_B170D4();
  PlayMakerFSM__SendEvent(blackListExpLabel, (System_String_o *)StringLiteral_3037/*"CLICK_BLACKLIST"*/, 0LL);
}