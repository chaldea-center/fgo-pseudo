...
void __fastcall SetBlacklistOptionControl__Init(SetBlacklistOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B325D3 & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_9804/*"OPTION_BLACKLIST_EXPLANATION"*/, v3);
    byte_4B325D3 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B325D4 & 1) == 0 )
  {
    sub_1BD3458(&Method_SetBlacklistOptionControl_onClickOpenButton__, method);
    sub_1BD3458(&StringLiteral_3564/*"CLICK_BLACKLIST"*/, v3);
    byte_4B325D4 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetBlacklistOptionControl_onClickOpenButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1BD3470(Method_SetBlacklistOptionControl_onClickOpenButton__);
  v5 = (System_Reflection_MethodBase_o *)sub_1BD343C(v4, v4[4]);
  OverwriteAssetSoundName__PlaySystemSe(v5, 0, 0LL);
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    sub_1BD36B4(0LL, v6);
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_3564/*"CLICK_BLACKLIST"*/, 0LL);
}