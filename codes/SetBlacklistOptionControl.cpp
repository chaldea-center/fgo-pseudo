...
void SetBlacklistOptionControl__Init(SetBlacklistOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C32A04 & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_9662/*"OPTION_BLACKLIST_EXPLANATION"*/);
    byte_4C32A04 = 1;
  }
  blackListExpLabel = this->fields.blackListExpLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9662/*"OPTION_BLACKLIST_EXPLANATION"*/, 0);
...
void SetBlacklistOptionControl__onClickOpenButton(SetBlacklistOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C32A05 & 1) == 0 )
  {
    sub_1C32C20(&Method_SetBlacklistOptionControl_onClickOpenButton__);
    sub_1C32C20(&StringLiteral_3440/*"CLICK_BLACKLIST"*/);
    byte_4C32A05 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetBlacklistOptionControl_onClickOpenButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C32C38(Method_SetBlacklistOptionControl_onClickOpenButton__);
