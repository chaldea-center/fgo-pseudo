        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E0786F & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_System_Collections_Generic_List_BattleSkillInfoData__Clear__);
    this = (BattleSelfSkillInfoData_o *)sub_1CE6700(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    byte_4E0786F = 1;
  }
  if ( !svtData )
    goto LABEL_21;
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&v4->fields.rankChangeData, (int32_t)v11, v5, v6, v7, v8, v9, v10);
  ...
  *(_QWORD *)&v36.fields.fakeValue = v15;
  v17 = (BattleSelfSkillInfoData_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_50038008(v36, 0);
  ...
  if ( (int)v19 >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      v24 = (BattleSkillInfoData_o *)sub_1CE694C(BattleSkillInfoData_TypeInfo);
