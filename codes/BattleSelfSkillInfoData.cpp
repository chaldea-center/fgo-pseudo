        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1F176 & 1) == 0 )
  {
    sub_1BCAFF8(&BattleSkillInfoData_TypeInfo, svtData);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_BattleSkillInfoData__Add__, v5);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_BattleSkillInfoData__Clear__, v6);
    this = (BattleSelfSkillInfoData_o *)sub_1BCAFF8(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, v7);
    byte_4B1F176 = 1;
  }
  if ( !svtData )
    goto LABEL_21;
  ...
  if ( !this )
    goto LABEL_21;
  v10 = *(struct BattleBuffData_SkillRankChangeData_o **)&this->fields.cutInId;
  v4->fields.rankChangeData = v10;
  sub_1BCAF9C((CGThumbnailListItem_o *)&v4->fields.rankChangeData, (int32_t)v10, v8, v9);
  ...
  *(_QWORD *)&v32.fields.fakeValue = v14;
  v16 = (BattleSelfSkillInfoData_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48125176(v32, 0LL);
