        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47678 & 1) == 0 )
  {
    sub_1BDB878(&BattleSkillInfoData_TypeInfo, svtData);
    sub_1BDB878(&Method_System_Collections_Generic_List_BattleSkillInfoData__Add__, v5);
    sub_1BDB878(&Method_System_Collections_Generic_List_BattleSkillInfoData__Clear__, v6);
    this = (BattleSelfSkillInfoData_o *)sub_1BDB878(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, v7);
    byte_4B47678 = 1;
  }
  if ( !svtData )
    goto LABEL_21;
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&v4->fields.rankChangeData, (int32_t)v10, v8, v9);
  ...
  *(_QWORD *)&v32.fields.fakeValue = v14;
  v16 = (BattleSelfSkillInfoData_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48227716(v32, 0LL);
