        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7A54C & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_System_Collections_Generic_List_BattleSkillInfoData__Clear__);
    this = (BattleSelfSkillInfoData_o *)sub_1D0F0B4(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    byte_4E7A54C = 1;
  }
  if ( !svtData )
    goto LABEL_21;
  ...
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&v4->fields.rankChangeData, (int32_t)v11, v5, v6, v7, v8, v9, v10);
  ...
  *(_QWORD *)&v36.fields.fakeValue = v15;
  v17 = (BattleSelfSkillInfoData_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_50331200(v36, 0);
  ...
  if ( (int)v19 >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      v24 = sub_1D0F300(BattleSkillInfoData_TypeInfo);
      *(_DWORD *)(v24 + 64) = -1;
      *(_QWORD *)(v24 + 88) = -1;
      *(_QWORD *)(v24 + 96) = -1;
      *(_DWORD *)(v24 + 104) = -1;
