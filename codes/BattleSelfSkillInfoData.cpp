        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_593B5AD & 1) == 0 )
  {
    ...
    sub_21FFC50(&Method_System_Collections_Generic_List_BattleSkillInfoData__Clear__);
    this = (BattleSelfSkillInfoData_o *)sub_21FFC50(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    byte_593B5AD = 1;
  }
  if ( !svtData )
    goto LABEL_21;
  ...
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&v4->fields.rankChangeData, (int32_t)v11, v5, v6, v7, v8, v9, v10);
  ...
  *(_QWORD *)&v36.fields.fakeValue = v16;
  v17 = (BattleSelfSkillInfoData_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_55792412(v36, 0);
  ...
  if ( (int)v19 >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      v24 = sub_21FFEBC(BattleSkillInfoData_TypeInfo);
      *(_DWORD *)(v24 + 64) = -1;
      *(_QWORD *)(v24 + 88) = -1;
      *(_QWORD *)(v24 + 96) = -1;
      *(_DWORD *)(v24 + 104) = -1;
