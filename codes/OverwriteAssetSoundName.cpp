...
LABEL_17:
      sub_1C1AE30(OverwriteAssetSoundName, v7);
    }
  }
  return v3;
}
...
LABEL_22:
    sub_1C1AE30(OverwriteAssetSoundName, v9);
  }
  return v5;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC73C1 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_1046/*"."*/, v3);
    callMethod = (System_Reflection_MethodBase_o *)sub_1C1ABD4(&StringLiteral_15375/*"Unknown."*/, v4);
    byte_4BC73C1 = 1;
  }
  if ( !v2 )
    goto LABEL_10;
  ...
  if ( v6 )
  {
    ...
    if ( callMethod )
    {
      ...
      return System_String__Concat_63051628(v8, (System_String_o *)StringLiteral_1046/*"."*/, v9, 0LL);
    }
LABEL_10:
    sub_1C1AE30(callMethod, method);
  }
  ...
  return System_String__Concat_63040368((System_String_o *)StringLiteral_15375/*"Unknown."*/, v11, 0LL);
}
...
void __fastcall OverwriteAssetSoundName__Initialize(OverwriteAssetSoundName_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC73B2 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_OverwriteAssetSoundName__Initialize_b__4_0__, v4);
    sub_1C1ABD4(&StringLiteral_13471/*"System/OverwriteAssetSoundNameTable"*/, v5);
    byte_4BC73B2 = 1;
  }
  ...
  AssetManager__loadAssetStorage((System_String_o *)StringLiteral_13471/*"System/OverwriteAssetSoundNameTable"*/, v6, 1, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC73BC & 1) == 0 )
  {
    sub_1C1ABD4(&SeManager_TypeInfo, *(_QWORD *)&kind);
    byte_4BC73BC = 1;
  }
...
// local variable allocation has failed, the output may be wrong!
void __fastcall OverwriteAssetSoundName__PlayCommonSe_39814188(
        System_Reflection_MethodBase_o *callMethod,
        int32_t kind,
        float delayTime,
        ...
        const MethodInfo *method)
{
  ...
  if ( !SeManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(SeManager_TypeInfo);
  SeManager__PlayCommonSe_39881336(CommonKindName, delayTime, waitFrameCount, ignorePreDelay, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC73B3 & 1) == 0 )
  {
    sub_1C1ABD4(&SeManager_TypeInfo, name);
    byte_4BC73B3 = 1;
  }
...
// local variable allocation has failed, the output may be wrong!
SePlayer_o *__fastcall OverwriteAssetSoundName__PlaySeContinue_39812548(
        System_Reflection_MethodBase_o *callMethod,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC73B5 & 1) == 0 )
  {
    sub_1C1ABD4(&SeManager_TypeInfo, assetName);
    byte_4BC73B5 = 1;
  }
  ...
  return SeManager__PlaySe_39884160(
           v11,
           objectName,
...
SePlayer_o *__fastcall OverwriteAssetSoundName__PlaySe_39812720(
        System_Reflection_MethodBase_o *callMethod,
        System_String_o *name,
        float volume,
        float fadeinTime,
...
// local variable allocation has failed, the output may be wrong!
SePlayer_o *__fastcall OverwriteAssetSoundName__PlaySe_39812884(
        System_Reflection_MethodBase_o *callMethod,
        System_String_o *name,
        float volume,
...
SePlayer_o *__fastcall OverwriteAssetSoundName__PlaySe_39813056(
        System_Reflection_MethodBase_o *callMethod,
        System_String_o *assetName,
        System_String_o *objectName,
        float volume,
        ...
        const MethodInfo *method)
{
  ...
  if ( !SeManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(SeManager_TypeInfo);
  return SeManager__PlaySe_39884160(SoundName, objectName, volume, 0.0, callbackFunc, 0, ignorePreDelay, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !SeManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(SeManager_TypeInfo);
  SeManager__StopSe_39886488(SoundName, fadeoutTime, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC73C2 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_AssetData_GetObject_OverwriteAssetSoundNameTable___, assetData);
    byte_4BC73C2 = 1;
  }
  if ( assetData )
  {
    Object_object = AssetData__GetObject_object_(
                      assetData,
                      (const MethodInfo_2F8144C *)Method_AssetData_GetObject_OverwriteAssetSoundNameTable___);
    this->fields.table = (struct OverwriteAssetSoundNameTable_o *)Object_object;
    sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields, (int64_t)Object_object, v6, v7, v8, v9, v10, v11);
  }
