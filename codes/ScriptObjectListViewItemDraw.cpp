        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B64348 & 1) == 0 )
  {
    sub_1BE4ACC(&System_Converter_DataEntityBase__ShopScriptEntity__TypeInfo, item);
    sub_1BE4ACC(&Method_DataManager_GetMasterData_QuestMaster___, v7);
    sub_1BE4ACC(&Method_DataManager_GetMasterData_QuestScriptMaster___, v8);
    sub_1BE4ACC(&Method_DataManager_GetMasterData_ShopScriptMaster___, v9);
    sub_1BE4ACC(&Method_DataMasterBase_QuestMaster__QuestEntity__int__TryGetEntity__, v10);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Enumerator_ShopScriptEntity__Dispose__, v11);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Enumerator_ShopScriptEntity__MoveNext__, v12);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Enumerator_ShopScriptEntity__get_Current__, v13);
    sub_1BE4ACC(&Method_UnityEngine_GameObject_GetComponent_TweenColor___, v14);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_ShopScriptEntity__GetEnumerator__, v15);
    sub_1BE4ACC(&UnityEngine_Object_TypeInfo, v16);
    sub_1BE4ACC(&Method_ObservableCollectionExtensions_ConvertAll_DataEntityBase__ShopScriptEntity___, v17);
    sub_1BE4ACC(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v18);
    sub_1BE4ACC(&Method_ScriptObjectListViewItemDraw___c__SetItem_b__3_0__, v19);
    sub_1BE4ACC(&ScriptObjectListViewItemDraw___c_TypeInfo, v20);
    sub_1BE4ACC(&StringLiteral_116/*" "*/, v21);
    byte_4B64348 = 1;
  }
  result = 0;
  entity = 0LL;
...
LABEL_53:
      sub_1BE4D28(baseImageTexture, v22);
    }
    baseImageTexture = (UnityEngine_Component_o *)ScriptObjectListViewItem__get_TitleText(item, v22);
    if ( !baseImageTexture )
      goto LABEL_53;
    v24 = System_String__Remove_62717628((System_String_o *)baseImageTexture, 8, 0LL);
    result = 0;
    System_Int32__TryParse(v24, &result, 0LL);
    entity = 0LL;
    if ( !result )
      goto LABEL_32;
    baseImageTexture = (UnityEngine_Component_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !baseImageTexture )
      goto LABEL_53;
    ...
    if ( !_9__3_0 )
    {
      ...
      _9__3_0 = (System_Converter_TInput__TOutput__o *)sub_1BE4D18(System_Converter_DataEntityBase__ShopScriptEntity__TypeInfo);
    ...
    v37 = (System_Collections_Generic_List_object__o *)ObservableCollectionExtensions__ConvertAll_object__object_(
                                                         ...
                                                         (const MethodInfo_2FDF480 *)Method_ObservableCollectionExtensions_ConvertAll_DataEntityBase__ShopScriptEntity___);
    baseImageTexture = (UnityEngine_Component_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !baseImageTexture )
      goto LABEL_53;
    baseImageTexture = (UnityEngine_Component_o *)DataManager__GetMasterData_object_(
    ...
    System_Collections_Generic_List_object___GetEnumerator(
      ...
      v37,
      (const MethodInfo_35ECD1C *)Method_System_Collections_Generic_List_ShopScriptEntity__GetEnumerator__);
    v61 = v60;
    while ( 1 )
    {
      v39 = System_Collections_Generic_List_Enumerator_object___MoveNext(
              &v61,
              (const MethodInfo_3361CE0 *)Method_System_Collections_Generic_List_Enumerator_ShopScriptEntity__MoveNext__);
      if ( !v39 )
        break;
...
LABEL_28:
    System_Collections_Generic_List_Enumerator_object___Dispose(
      &v61,
      (const MethodInfo_3361CDC *)Method_System_Collections_Generic_List_Enumerator_ShopScriptEntity__Dispose__);
    if ( result )
    {
      if ( v38 )
      {
        ...
        baseImageTexture = (UnityEngine_Component_o *)System_String__Concat_62710068(
                                                        TitleText,
...
void __fastcall ScriptObjectListViewItemDraw___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B64349 & 1) == 0 )
  {
    sub_1BE4ACC(&ScriptObjectListViewItemDraw___c_TypeInfo, v1);
    byte_4B64349 = 1;
  }
  v2 = (Il2CppObject *)sub_1BE4D18(ScriptObjectListViewItemDraw___c_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6434A & 1) == 0 )
  {
    sub_1BE4ACC(&ShopScriptEntity_TypeInfo, entity);
    byte_4B6434A = 1;
  }
  if ( !entity )
    return 0LL;
