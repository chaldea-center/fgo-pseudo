        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6DEF3 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_DataManager_GetMasterData_UserServantStorageMaster___, v8);
    ...
    sub_1B90010(&StringLiteral_12401/*"SUM_INFO"*/, v12);
    byte_4A6DEF3 = 1;
  }
...
LABEL_20:
  ...
  v35 = LocalizationManager__Get((System_String_o *)StringLiteral_12401/*"SUM_INFO"*/, 0LL);
  ...
  Instance = (__int64)System_String__Format_61801464(v35, v39, v43, 0LL);
  if ( !servantTabLabel )
    goto LABEL_44;
  UILabel__set_text(servantTabLabel, (System_String_o *)Instance, 0LL);
  servantEquipTabLabel = this->fields.servantEquipTabLabel;
  v45 = LocalizationManager__Get((System_String_o *)StringLiteral_12401/*"SUM_INFO"*/, 0LL);
  ...
  Instance = (__int64)System_String__Format_61801464(v45, v49, v53, 0LL);
  ...
  if ( this->fields.totalSum >= 1 )
  {
    ...
    if ( callbackFunc )
    {
      ...
      if ( !baseListViewManager || (WarehouseListViewManager__GetSelectList(baseListViewManager, v8, v10), !v8) )
        sub_1B9026C(baseListViewManager, v9);
...
void __fastcall WarehouseListManager__OnClickReleaseAll(WarehouseListManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6DEF8 & 1) == 0 )
  {
    sub_1B90010(&Method_WarehouseListManager_OnClickReleaseAll__, method);
    byte_4A6DEF8 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_WarehouseListManager_OnClickReleaseAll__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B90028(Method_WarehouseListManager_OnClickReleaseAll__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6DEF9 & 1) == 0 )
  {
    sub_1B90010(&Method_System_Collections_Generic_List_long__Add__, *(_QWORD *)&resultKind);
    ...
    sub_1B90010(&Method_WarehouseListManager_OnSelectServant__, v10);
    byte_4A6DEF9 = 1;
  }
  if ( resultKind == 2 )
  {
    ...
    if ( modeKind )
    {
      if ( (unsigned int)(modeKind - 1) < 3 )
      {
        ...
        if ( (*((_BYTE *)Method_WarehouseListManager_OnSelectServant__ + 83) & 2) != 0 )
          v13 = (_QWORD *)sub_1B90028(Method_WarehouseListManager_OnSelectServant__);
    ...
    else
    {
      ...
      if ( callbackFunc )
      {
        ...
        sub_1B8FFB4(p_callbackFunc, 0, (int32_t)item, (int32_t)method);
        ...
        {
LABEL_35:
          sub_1B9026C(UserSvtId, *(_QWORD *)&resultKind);
        }
    ...
    switch ( this->fields.modeKind )
    {
      ...
      case 3:
        ...
        if ( !v24 )
          return;
        v22->klass = 0LL;
        sub_1B8FFB4(v22, 0, (int32_t)item, (int32_t)method);
        v25 = (System_Collections_Generic_List_long__o *)sub_1B9025C(System_Collections_Generic_List_long__TypeInfo);
        System_Collections_Generic_List_long____ctor(
          v25,
          (const MethodInfo_34F81A0 *)Method_System_Collections_Generic_List_long___ctor__);
        if ( !item )
...
void __fastcall WarehouseListManager__RefrashListDisp(WarehouseListManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6DEF4 & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_12402/*"SUM_OVER_INFO"*/, v4);
  ...
  *(_QWORD *)friendShipSum = 0LL;
  ...
  if ( totalSum < 1 )
  {
    v11 = (System_String_o **)&StringLiteral_12401/*"SUM_INFO"*/;
  }
  else
  {
    v11 = (System_String_o **)&StringLiteral_12401/*"SUM_INFO"*/;
    ...
    else
    {
      ...
      if ( v13 <= sendSpace )
        ...
        v7 = 3;
      if ( v13 > sendSpace )
        v11 = (System_String_o **)&StringLiteral_12402/*"SUM_OVER_INFO"*/;
    }
  }
  ...
  allReleaseButton = System_String__Format_61801464(v17, v21, v25, 0LL);
  if ( !sendDataLabel )
LABEL_22:
        ...
        const MethodInfo *method)
{
  ...
  sub_1B8FFB4(
    ...
    (int32_t)callback,
    (int32_t)method);
  WarehouseListManager__SetMode_35917732(this, mode, v6);
}
...
// local variable allocation has failed, the output may be wrong!
void __fastcall WarehouseListManager__SetMode_35917732(
        WarehouseListManager_o *this,
        int32_t mode,
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6DEF6 & 1) == 0 )
  {
    sub_1B90010(&WarehouseListViewManager_CallbackFunc_TypeInfo, *(_QWORD *)&mode);
    sub_1B90010(&Method_WarehouseListManager_OnSelectServant__, v5);
    byte_4A6DEF6 = 1;
  }
  baseListViewManager = this->fields.baseListViewManager;
  v7 = (WarehouseListViewManager_CallbackFunc_o *)sub_1B9025C(WarehouseListViewManager_CallbackFunc_TypeInfo);
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&baseListViewManager->fields.callbackFunc, (int32_t)v7, v10, v11);
  WarehouseListViewManager__SetMode_35960032(baseListViewManager, mode, v12);
}
...
LABEL_11:
  ...
  selectDoneLabel = (UILabel_o *)System_String__Format_61801464(v13, v17, v21, 0LL);
  if ( !v10 )
LABEL_18:
    sub_1B9026C(selectDoneLabel, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6DEF1 & 1) == 0 )
  {
    sub_1B90010(&WarehouseListManager_CallbackFunc_TypeInfo, value);
    byte_4A6DEF1 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19D42AC;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19D424C;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6DEFA & 1) == 0 )
  {
    ...
    sub_1B90010(&WarehouseListManager_ResultKind_TypeInfo, v11);
    byte_4A6DEFA = 1;
  }
  v17 = 0u;
