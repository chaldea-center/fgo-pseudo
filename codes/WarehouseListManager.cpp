        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E08C8 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_DataManager_GetMasterData_UserServantStorageMaster___, v8);
    ...
    sub_1B00CCC(&StringLiteral_12172/*"SUM_INFO"*/, v12);
    byte_48E08C8 = 1;
  }
  ...
  if ( (this->fields.kind & 0xFFFFFFFE) == 2 )
  {
    ...
    if ( SelfUserGame )
    {
      ...
      *(int32x2_t *)&this->fields.sendServantKeep = SelfUserGame[18];
      if ( v17 )
      {
...
LABEL_44:
  ...
  if ( !SelfUserGame )
    goto LABEL_44;
  *(int32x2_t *)&this->fields.baseServantKeep = SelfUserGame[18];
  Instance = (__int64)BalanceConfig_TypeInfo;
  if ( !BalanceConfig_TypeInfo->_2.cctor_finished )
  {
    j_il2cpp_runtime_class_init_0(BalanceConfig_TypeInfo);
...
LABEL_20:
  ...
  v35 = LocalizationManager__Get((System_String_o *)StringLiteral_12172/*"SUM_INFO"*/, 0LL);
  ...
  Instance = (__int64)System_String__Format_60340120(v35, v39, v43, 0LL);
  if ( !servantTabLabel )
    goto LABEL_44;
  UILabel__set_text(servantTabLabel, (System_String_o *)Instance, 0LL);
  servantEquipTabLabel = this->fields.servantEquipTabLabel;
  v45 = LocalizationManager__Get((System_String_o *)StringLiteral_12172/*"SUM_INFO"*/, 0LL);
  ...
  Instance = (__int64)System_String__Format_60340120(v45, v49, v53, 0LL);
  ...
  if ( this->fields.totalSum >= 1 )
  {
    ...
    if ( callbackFunc )
    {
      ...
      if ( !baseListViewManager || (WarehouseListViewManager__GetSelectList(baseListViewManager, v8, v10), !v8) )
        sub_1B00F28(baseListViewManager, v9);
...
void __fastcall WarehouseListManager__OnClickReleaseAll(WarehouseListManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E08CD & 1) == 0 )
  {
    sub_1B00CCC(&Method_WarehouseListManager_OnClickReleaseAll__, method);
    byte_48E08CD = 1;
  }
  ...
  if ( (*((_BYTE *)Method_WarehouseListManager_OnClickReleaseAll__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B00CE4(Method_WarehouseListManager_OnClickReleaseAll__);
        ...
        const MethodInfo *method)
{
  ...
  _QWORD *v20; // x9
  __int64 size; // x10
  ServantStatusBattleListViewItem_o *v22; // x20
  ...
  if ( (byte_48E08CE & 1) == 0 )
  {
    sub_1B00CCC(&Method_System_Collections_Generic_List_long__Add__, *(_QWORD *)&resultKind);
    ...
    sub_1B00CCC(&Method_WarehouseListManager_OnSelectServant__, v10);
    byte_48E08CE = 1;
  }
  if ( resultKind == 2 )
  {
    ...
    if ( modeKind )
    {
      if ( (unsigned int)(modeKind - 1) < 3 )
      {
        ...
        if ( (*((_BYTE *)Method_WarehouseListManager_OnSelectServant__ + 83) & 2) != 0 )
          v13 = (_QWORD *)sub_1B00CE4(Method_WarehouseListManager_OnSelectServant__);
    ...
    else
    {
      ...
      if ( callbackFunc )
      {
        ...
        sub_1B00C70(p_callbackFunc, 0, (int32_t)item, (int32_t)method);
        ...
        {
LABEL_35:
          sub_1B00F28(UserSvtId, *(_QWORD *)&resultKind);
        }
  ...
  else if ( resultKind == 1 )
  {
    switch ( this->fields.modeKind )
    {
      ...
      case 3:
        ...
        v22 = (ServantStatusBattleListViewItem_o *)&this->fields.callbackFunc;
        v23 = v24;
        if ( !v24 )
          return;
        v22->klass = 0LL;
        sub_1B00C70(v22, 0, (int32_t)item, (int32_t)method);
...
void __fastcall WarehouseListManager__RefrashListDisp(WarehouseListManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E08C9 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_12173/*"SUM_OVER_INFO"*/, v4);
  ...
  *(_QWORD *)friendShipSum = 0LL;
  ...
  if ( totalSum < 1 )
  {
    v11 = (System_String_o **)&StringLiteral_12172/*"SUM_INFO"*/;
  }
  else
  {
    v11 = (System_String_o **)&StringLiteral_12172/*"SUM_INFO"*/;
    ...
    else
    {
      ...
      if ( v13 <= sendSpace )
        ...
        v7 = 3;
      if ( v13 > sendSpace )
        v11 = (System_String_o **)&StringLiteral_12173/*"SUM_OVER_INFO"*/;
    }
  }
  ...
  allReleaseButton = System_String__Format_60340120(v17, v21, v25, 0LL);
  if ( !sendDataLabel )
LABEL_22:
        ...
        const MethodInfo *method)
{
  ...
  sub_1B00C70(
    ...
    (int32_t)callback,
    (int32_t)method);
  WarehouseListManager__SetMode_34631872(this, mode, v6);
}
...
// local variable allocation has failed, the output may be wrong!
void __fastcall WarehouseListManager__SetMode_34631872(
        WarehouseListManager_o *this,
        int32_t mode,
        const MethodInfo *method)
{
  ...
  if ( (byte_48E08CB & 1) == 0 )
  {
    sub_1B00CCC(&WarehouseListViewManager_CallbackFunc_TypeInfo, *(_QWORD *)&mode);
    sub_1B00CCC(&Method_WarehouseListManager_OnSelectServant__, v5);
    byte_48E08CB = 1;
  }
  baseListViewManager = this->fields.baseListViewManager;
  v7 = (WarehouseListViewManager_CallbackFunc_o *)sub_1B00F18(WarehouseListViewManager_CallbackFunc_TypeInfo);
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&baseListViewManager->fields.callbackFunc, (int32_t)v7, v10, v11);
  WarehouseListViewManager__SetMode_34673408(baseListViewManager, mode, v12);
}
...
LABEL_11:
  ...
  selectDoneLabel = (UILabel_o *)System_String__Format_60340120(v13, v17, v21, 0LL);
  if ( !v10 )
LABEL_18:
    sub_1B00F28(selectDoneLabel, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E08C6 & 1) == 0 )
  {
    sub_1B00CCC(&WarehouseListManager_CallbackFunc_TypeInfo, value);
    byte_48E08C6 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1949570;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1949510;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E08CF & 1) == 0 )
  {
    ...
    sub_1B00CCC(&WarehouseListManager_ResultKind_TypeInfo, v11);
    byte_48E08CF = 1;
  }
  v17 = 0u;
