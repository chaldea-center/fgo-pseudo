        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1FE61 & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_12657/*"Specified slot number was invalid."*/, v12);
    byte_4C1FE61 = 1;
  }
...
LABEL_20:
  ...
  v35 = LocalizationManager__Get((System_String_o *)StringLiteral_12657/*"Specified slot number was invalid."*/, 0LL);
  ...
  Instance = (__int64)System_String__Format_63382984(v35, v39, v43, 0LL);
  if ( !servantTabLabel )
    goto LABEL_44;
  UILabel__set_text(servantTabLabel, (System_String_o *)Instance, 0LL);
  servantEquipTabLabel = this->fields.servantEquipTabLabel;
  v45 = LocalizationManager__Get((System_String_o *)StringLiteral_12657/*"Specified slot number was invalid."*/, 0LL);
  ...
  Instance = (__int64)System_String__Format_63382984(v45, v49, v53, 0LL);
  ...
  if ( this->fields.totalSum >= 1 )
  {
    ...
    if ( callbackFunc )
    {
      ...
      if ( !baseListViewManager || (WarehouseListViewManager__GetSelectList(baseListViewManager, v12, v14), !v12) )
        sub_1C3B9C0(baseListViewManager, v13);
...
void __fastcall WarehouseListManager__OnClickReleaseAll(WarehouseListManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1FE66 & 1) == 0 )
  {
    sub_1C3B764(&Method_WarehouseListManager_OnClickReleaseAll__, method);
    byte_4C1FE66 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_WarehouseListManager_OnClickReleaseAll__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C3B77C(Method_WarehouseListManager_OnClickReleaseAll__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1FE67 & 1) == 0 )
  {
    sub_1C3B764(&Method_System_Collections_Generic_List_long__Add__, *(_QWORD *)&resultKind);
    ...
    sub_1C3B764(&Method_WarehouseListManager_OnSelectServant__, v14);
    byte_4C1FE67 = 1;
  }
  if ( resultKind == 2 )
  {
    ...
    if ( modeKind )
    {
      if ( (unsigned int)(modeKind - 1) < 3 )
      {
        ...
        if ( (*((_BYTE *)Method_WarehouseListManager_OnSelectServant__ + 83) & 2) != 0 )
          v17 = (_QWORD *)sub_1C3B77C(Method_WarehouseListManager_OnSelectServant__);
    ...
    else
    {
      ...
      if ( callbackFunc )
      {
        ...
        sub_1C3B708(p_callbackFunc, 0LL, (int64_t)item, (int32_t)method, v4, v5, v6, v7);
        ...
        {
LABEL_35:
          sub_1C3B9C0(UserSvtId, *(_QWORD *)&resultKind);
        }
    ...
    switch ( this->fields.modeKind )
    {
      ...
      case 3:
        ...
        if ( !v28 )
          return;
        v26->klass = 0LL;
        sub_1C3B708(v26, 0LL, (int64_t)item, (int32_t)method, v4, v5, v6, v7);
...
void __fastcall WarehouseListManager__RefrashListDisp(WarehouseListManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1FE62 & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_12658/*"Specified time is not supported in this calendar. It should be between {0} (Gregorian date) and {1} (Gregorian date), inclusive."*/, v4);
  ...
  *(_QWORD *)friendShipSum = 0LL;
  ...
  if ( totalSum < 1 )
  {
    v11 = (System_String_o **)&StringLiteral_12657/*"Specified slot number was invalid."*/;
  }
  else
  {
    v11 = (System_String_o **)&StringLiteral_12657/*"Specified slot number was invalid."*/;
    ...
    else
    {
      ...
      if ( v13 <= sendSpace )
        ...
        v7 = 3;
      if ( v13 > sendSpace )
        v11 = (System_String_o **)&StringLiteral_12658/*"Specified time is not supported in this calendar. It should be between {0} (Gregorian date) and {1} (Gregorian date), inclusive."*/;
    }
  }
  ...
  allReleaseButton = System_String__Format_63382984(v17, v21, v25, 0LL);
  if ( !sendDataLabel )
LABEL_22:
        ...
        const MethodInfo *method)
{
  ...
  sub_1C3B708(
    ...
    v6,
    v7);
  WarehouseListManager__SetMode_37137632(this, mode, v10);
}
...
// local variable allocation has failed, the output may be wrong!
void __fastcall WarehouseListManager__SetMode_37137632(
        WarehouseListManager_o *this,
        int32_t mode,
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1FE64 & 1) == 0 )
  {
    sub_1C3B764(&WarehouseListViewManager_CallbackFunc_TypeInfo, *(_QWORD *)&mode);
    sub_1C3B764(&Method_WarehouseListManager_OnSelectServant__, v5);
    byte_4C1FE64 = 1;
  }
  baseListViewManager = this->fields.baseListViewManager;
  v7 = (WarehouseListViewManager_CallbackFunc_o *)sub_1C3B9B0(WarehouseListViewManager_CallbackFunc_TypeInfo);
  ...
  sub_1C3B708(
    ...
    v14,
    v15);
  WarehouseListViewManager__SetMode_37180020(baseListViewManager, mode, v16);
}
...
LABEL_11:
  ...
  selectDoneLabel = (UILabel_o *)System_String__Format_63382984(v13, v17, v21, 0LL);
  if ( !v10 )
LABEL_18:
    sub_1C3B9C0(selectDoneLabel, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1FE5F & 1) == 0 )
  {
    sub_1C3B764(&WarehouseListManager_CallbackFunc_TypeInfo, value);
    byte_4C1FE5F = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A7AD44;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A7ACE4;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1FE68 & 1) == 0 )
  {
    ...
    sub_1C3B764(&WarehouseListManager_ResultKind_TypeInfo, v11);
    byte_4C1FE68 = 1;
  }
  v17 = 0u;
