        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1A2FA & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_12372/*"SUM_INFO"*/, v12);
    byte_4B1A2FA = 1;
  }
...
LABEL_20:
  ...
  Instance = (__int64)System_String__Format_62491716(v35, v39, v43, 0LL);
  if ( !servantTabLabel )
    goto LABEL_44;
  ...
  Instance = (__int64)System_String__Format_62491716(v45, v49, v53, 0LL);
  ...
  if ( this->fields.totalSum >= 1 )
  {
    ...
    if ( callbackFunc )
    {
      ...
      if ( !baseListViewManager || (WarehouseListViewManager__GetSelectList(baseListViewManager, v8, v10), !v8) )
        sub_1BCB254(baseListViewManager, v9);
...
void __fastcall WarehouseListManager__OnClickReleaseAll(WarehouseListManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1A2FF & 1) == 0 )
  {
    sub_1BCAFF8(&Method_WarehouseListManager_OnClickReleaseAll__, method);
    byte_4B1A2FF = 1;
  }
  ...
  if ( (*((_BYTE *)Method_WarehouseListManager_OnClickReleaseAll__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1BCB010(Method_WarehouseListManager_OnClickReleaseAll__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1A300 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_System_Collections_Generic_List_long__Add__, *(_QWORD *)&resultKind);
    ...
    sub_1BCAFF8(&Method_WarehouseListManager_OnSelectServant__, v10);
    byte_4B1A300 = 1;
  }
  if ( resultKind == 2 )
  {
    ...
    if ( modeKind )
    {
      if ( (unsigned int)(modeKind - 1) < 3 )
      {
        ...
        if ( (*((_BYTE *)Method_WarehouseListManager_OnSelectServant__ + 83) & 2) != 0 )
          v13 = (_QWORD *)sub_1BCB010(Method_WarehouseListManager_OnSelectServant__);
    ...
    else
    {
      ...
      if ( callbackFunc )
      {
        ...
        sub_1BCAF9C(p_callbackFunc, 0, (int32_t)item, method);
        ...
        {
LABEL_35:
          sub_1BCB254(UserSvtId, *(_QWORD *)&resultKind);
        }
    ...
    switch ( this->fields.modeKind )
    {
      ...
      case 3:
        ...
        if ( !v24 )
          return;
        v22->klass = 0LL;
        sub_1BCAF9C(v22, 0, (int32_t)item, method);
...
void __fastcall WarehouseListManager__RefrashListDisp(WarehouseListManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1A2FB & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_12373/*"SUM_OVER_INFO"*/, v4);
  ...
  *(_QWORD *)friendShipSum = 0LL;
  ...
  allReleaseButton = System_String__Format_62491716(v17, v21, v25, 0LL);
  if ( !sendDataLabel )
LABEL_22:
        ...
        const MethodInfo *method)
{
  ...
  WarehouseListManager__SetMode_37575116(this, mode, v6);
}
...
// local variable allocation has failed, the output may be wrong!
void __fastcall WarehouseListManager__SetMode_37575116(
        WarehouseListManager_o *this,
        int32_t mode,
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1A2FD & 1) == 0 )
  {
    sub_1BCAFF8(&WarehouseListViewManager_CallbackFunc_TypeInfo, *(_QWORD *)&mode);
    sub_1BCAFF8(&Method_WarehouseListManager_OnSelectServant__, v5);
    byte_4B1A2FD = 1;
  }
  baseListViewManager = this->fields.baseListViewManager;
  v7 = (WarehouseListViewManager_CallbackFunc_o *)sub_1BCB244(WarehouseListViewManager_CallbackFunc_TypeInfo);
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&baseListViewManager->fields.callbackFunc, (int32_t)v7, v10, v11);
  WarehouseListViewManager__SetMode_37618000(baseListViewManager, mode, v12);
}
...
LABEL_11:
  ...
  selectDoneLabel = (UILabel_o *)System_String__Format_62491716(v13, v17, v21, 0LL);
  if ( !v10 )
LABEL_18:
    sub_1BCB254(selectDoneLabel, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1A2F8 & 1) == 0 )
  {
    sub_1BCAFF8(&WarehouseListManager_CallbackFunc_TypeInfo, value);
    byte_4B1A2F8 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A13A44;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A139E4;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1A301 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&WarehouseListManager_ResultKind_TypeInfo, v11);
    byte_4B1A301 = 1;
  }
  v17 = 0u;
