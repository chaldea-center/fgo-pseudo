void __fastcall EventExpeditionMaster___ctor(EventExpeditionMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A2DEC7 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_EventExpeditionMaster__EventExpeditionEntity__string___ctor__, method);
    byte_4A2DEC7 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    380,
    (const MethodInfo_30FFA98 *)Method_DataMasterBase_EventExpeditionMaster__EventExpeditionEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (EventExpeditionEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                      (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                      PK,
                                      (const MethodInfo_30FFAD8 *)Method_DataMasterBase_EventExpeditionMaster__EventExpeditionEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2DECA & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_DataManager_GetMasterData_CommonReleaseMaster___, v6);
    sub_1B761C0(&EventExpeditionEntity_TypeInfo, v7);
    sub_1B761C0(&Method_System_Collections_Generic_List_EventExpeditionEntity__Add__, v8);
    sub_1B761C0(&Method_System_Collections_Generic_List_EventExpeditionEntity__ToArray__, v9);
    sub_1B761C0(&Method_System_Collections_Generic_List_EventExpeditionEntity___ctor__, v10);
    sub_1B761C0(&System_Collections_Generic_List_EventExpeditionEntity__TypeInfo, v11);
  ...
  v15 = (System_Collections_Generic_List_object__o *)sub_1B7640C(System_Collections_Generic_List_EventExpeditionEntity__TypeInfo);
...
LABEL_26:
            ...
            else
            {
              ...
              sub_1B76164((ServantStatusBattleListViewItem_o *)(v24 + 4), (int32_t)v19, v17, v18);
            }
          }
        }
      }
...
LABEL_21:
  ...
  return (EventExpeditionEntity_array *)System_Collections_Generic_List_object___ToArray(
                                          v15,
                                          (const MethodInfo_34D912C *)Method_System_Collections_Generic_List_EventExpeditionEntity__ToArray__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2DECB & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_System_Linq_Enumerable_Contains_int___, v10);
    sub_1B761C0(&EventExpeditionEntity_TypeInfo, v11);
    sub_1B761C0(&Method_System_Collections_Generic_List_EventExpeditionEntity___ctor__, v12);
    sub_1B761C0(&System_Collections_Generic_List_EventExpeditionEntity__TypeInfo, v13);
    byte_4A2DECB = 1;
  }
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
LABEL_15:
  ...
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            list,
            (const MethodInfo_309CAC8 *)Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__);
  v16 = (System_Collections_Generic_List_object__o *)sub_1B7640C(System_Collections_Generic_List_EventExpeditionEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v16,
    (const MethodInfo_34D6DA0 *)Method_System_Collections_Generic_List_EventExpeditionEntity___ctor__);
  if ( Count < 1 )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2DEC9 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_EventExpeditionMaster__EventExpeditionEntity__string__TryGetEntity__, entity);
    byte_4A2DEC9 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_30FFB28 *)Method_DataMasterBase_EventExpeditionMaster__EventExpeditionEntity__string__TryGetEntity__);
}