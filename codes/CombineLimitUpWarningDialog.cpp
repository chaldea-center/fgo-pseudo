...
void CombineLimitUpWarningDialog__Init(CombineLimitUpWarningDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CE84ED & 1) == 0 )
  {
    sub_1C7BAE8(&Method_CombineLimitUpWarningDialog_OnSliderDragFinished__);
  ...
  if ( !checkSlider
    || (checkSlider->fields.onDragFinished = v5,
        sub_1C7BA8C(&checkSlider->fields.onDragFinished, v5),
...
void CombineLimitUpWarningDialog__OnClickCancel(CombineLimitUpWarningDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CE84F1 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_CombineLimitUpWarningDialog_OnClickCancel__);
    sub_1C7BAE8(&Method_CombineLimitUpWarningDialog__OnClickCancel_b__24_0__);
    byte_4CE84F1 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CombineLimitUpWarningDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C7BB00(Method_CombineLimitUpWarningDialog_OnClickCancel__);
...
void CombineLimitUpWarningDialog__OnClickDecide(CombineLimitUpWarningDialog_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C7BAE8(&System_Action_TypeInfo);
    sub_1C7BAE8(&Method_CombineLimitUpWarningDialog_OnClickDecide__);
    sub_1C7BAE8(&Method_CombineLimitUpWarningDialog__OnClickDecide_b__23_0__);
    byte_4CE84F0 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CombineLimitUpWarningDialog_OnClickDecide__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1C7BB00(Method_CombineLimitUpWarningDialog_OnClickDecide__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C7BAE8(&System_Action_TypeInfo);
    sub_1C7BAE8(&Method_CombineLimitUpWarningDialog_EndOpen__);
    sub_1C7BAE8(&LocalizationManager_TypeInfo);
    sub_1C7BAE8(&StringLiteral_8291/*"LIMITUP_CHECK_COMBINE_TITLE"*/);
    sub_1C7BAE8(&StringLiteral_8290/*"LIMITUP_CHECK_COMBINE_BODY"*/);
    sub_1C7BAE8(&StringLiteral_3692/*"COMMON_CONFIRM_DECIDE"*/);
    sub_1C7BAE8(&StringLiteral_8292/*"LIMITUP_CHECK_WARNING_SLIDER"*/);
  ...
  sub_1C7BA8C(&this->fields.closeFunc, closeCallback);
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v6 = LocalizationManager__Get((System_String_o *)StringLiteral_8291/*"LIMITUP_CHECK_COMBINE_TITLE"*/, 0);
  if ( !titleLabel )
    goto LABEL_11;
  UILabel__set_text(titleLabel, v6, 0);
  warningLabel = this->fields.warningLabel;
  v6 = LocalizationManager__Get((System_String_o *)StringLiteral_8290/*"LIMITUP_CHECK_COMBINE_BODY"*/, 0);
  if ( !warningLabel )
    goto LABEL_11;
  UILabel__set_text(warningLabel, v6, 0);
  reInforeceLabel = this->fields.reInforeceLabel;
  v6 = LocalizationManager__Get((System_String_o *)StringLiteral_8292/*"LIMITUP_CHECK_WARNING_SLIDER"*/, 0);
  if ( !reInforeceLabel
    || (UILabel__set_text(reInforeceLabel, v6, 0),
        decideButtonLabel = this->fields.decideButtonLabel,
        v6 = LocalizationManager__Get((System_String_o *)StringLiteral_3692/*"COMMON_CONFIRM_DECIDE"*/, 0),
        !decideButtonLabel)
    || (UILabel__set_text(decideButtonLabel, v6, 0),
        cancelButtonLabel = this->fields.cancelButtonLabel,
        v6 = LocalizationManager__Get((System_String_o *)StringLiteral_3690/*"COMMON_CONFIRM_CANCEL"*/, 0),
        !cancelButtonLabel) )
  {
LABEL_11:
    sub_1C7BD40(v6, v7);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1AA8104;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1AA80BC;
}
