...
void CombineLimitUpWarningDialog__Init(CombineLimitUpWarningDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2B442 & 1) == 0 )
  {
    sub_1C2D490(&Method_CombineLimitUpWarningDialog_OnSliderDragFinished__);
  ...
  if ( !checkSlider
    || (checkSlider->fields.onDragFinished = v5,
        sub_1C2D434((CGThumbnailListItem_o *)&checkSlider->fields.onDragFinished, (int32_t)v5, v6, v7),
...
void CombineLimitUpWarningDialog__OnClickCancel(CombineLimitUpWarningDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2B446 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_CombineLimitUpWarningDialog_OnClickCancel__);
    sub_1C2D490(&Method_CombineLimitUpWarningDialog__OnClickCancel_b__24_0__);
    byte_4C2B446 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CombineLimitUpWarningDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2D4A8(Method_CombineLimitUpWarningDialog_OnClickCancel__);
...
void CombineLimitUpWarningDialog__OnClickDecide(CombineLimitUpWarningDialog_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C2D490(&System_Action_TypeInfo);
    sub_1C2D490(&Method_CombineLimitUpWarningDialog_OnClickDecide__);
    sub_1C2D490(&Method_CombineLimitUpWarningDialog__OnClickDecide_b__23_0__);
    byte_4C2B445 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CombineLimitUpWarningDialog_OnClickDecide__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1C2D4A8(Method_CombineLimitUpWarningDialog_OnClickDecide__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C2D490(&System_Action_TypeInfo);
    sub_1C2D490(&Method_CombineLimitUpWarningDialog_EndOpen__);
    sub_1C2D490(&LocalizationManager_TypeInfo);
    sub_1C2D490(&StringLiteral_8261/*"LIMITUP_CHECK_COMBINE_TITLE"*/);
    sub_1C2D490(&StringLiteral_8260/*"LIMITUP_CHECK_COMBINE_BODY"*/);
    sub_1C2D490(&StringLiteral_3679/*"COMMON_CONFIRM_DECIDE"*/);
    sub_1C2D490(&StringLiteral_8262/*"LIMITUP_CHECK_WARNING_SLIDER"*/);
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.closeFunc, (int32_t)closeCallback, v5, v6);
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v8 = LocalizationManager__Get((System_String_o *)StringLiteral_8261/*"LIMITUP_CHECK_COMBINE_TITLE"*/, 0);
  if ( !titleLabel )
    goto LABEL_11;
  UILabel__set_text(titleLabel, v8, 0);
  warningLabel = this->fields.warningLabel;
  v8 = LocalizationManager__Get((System_String_o *)StringLiteral_8260/*"LIMITUP_CHECK_COMBINE_BODY"*/, 0);
  if ( !warningLabel )
    goto LABEL_11;
  UILabel__set_text(warningLabel, v8, 0);
  reInforeceLabel = this->fields.reInforeceLabel;
  v8 = LocalizationManager__Get((System_String_o *)StringLiteral_8262/*"LIMITUP_CHECK_WARNING_SLIDER"*/, 0);
  if ( !reInforeceLabel
    ...
    || (UILabel__set_text(decideButtonLabel, v8, 0),
        ...
        v8 = LocalizationManager__Get((System_String_o *)StringLiteral_3677/*"COMMON_CONFIRM_CANCEL"*/, 0),
        !cancelButtonLabel) )
  {
LABEL_11:
    sub_1C2D6EC(v8, v9);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1A76860;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A76818;
}
