        ...
        const MethodInfo *method)
{
  if ( (byte_4A4F1CC & 1) == 0 )
  {
    sub_1B863B8(&Method_DataEntityBase_CreateMultiplePK_long__int__int__int___, *(_QWORD *)&eventId);
    byte_4A4F1CC = 1;
  }
  return DataEntityBase__CreateMultiplePK_long__int__int__int_(
           ...
           spotId,
           lv,
           (const MethodInfo_2F6C964 *)Method_DataEntityBase_CreateMultiplePK_long__int__int__int___);
}
