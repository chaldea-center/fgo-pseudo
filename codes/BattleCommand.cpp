void __fastcall BattleCommand___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B65A67 & 1) == 0 )
  {
    sub_1BE4ACC(&BattleCommand_TypeInfo, v1);
    sub_1BE4ACC(&BattleCommand_TYPE___TypeInfo, v2);
    sub_1BE4ACC(
      &Field__PrivateImplementationDetails__D0EE47FA46F276FE089AC8624109AA30225984329C335054459E360DBE11E12A,
      v3);
    byte_4B65A67 = 1;
  }
  v4 = (System_Array_o *)sub_1BE4B74(BattleCommand_TYPE___TypeInfo, 6LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B65A65 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_17130/*"arts_quick"*/, defaultValue);
    sub_1BE4ACC(&StringLiteral_23054/*"quick_buster"*/, v5);
    sub_1BE4ACC(&StringLiteral_17872/*"buster_arts"*/, v6);
    byte_4B65A65 = 1;
  }
  switch ( type )
  {
    case 1:
    case 3:
      v7 = &StringLiteral_17872/*"buster_arts"*/;
      goto LABEL_7;
    case 2:
    case 5:
      v7 = &StringLiteral_17130/*"arts_quick"*/;
      goto LABEL_7;
    case 4:
    case 6:
      v7 = &StringLiteral_23054/*"quick_buster"*/;
LABEL_7:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B65A5C & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_3402/*"Buster"*/, defaultText);
    sub_1BE4ACC(&StringLiteral_11099/*"Quick"*/, v5);
    sub_1BE4ACC(&StringLiteral_2504/*"Arts"*/, v6);
    byte_4B65A5C = 1;
  }
  switch ( type )
  {
    case 1:
      v7 = &StringLiteral_2504/*"Arts"*/;
      return (System_String_o *)*v7;
    case 3:
      v7 = &StringLiteral_11099/*"Quick"*/;
      return (System_String_o *)*v7;
    case 2:
      v7 = &StringLiteral_3402/*"Buster"*/;
      return (System_String_o *)*v7;
  }
  return v3;
}
        ...
        const MethodInfo *method)
{
  ...
  bool isARTS_38460600; // w21
  const MethodInfo *v7; // x1
  const MethodInfo *v9; // x1
  bool isBUSTER_38460700; // w21
  ...
  if ( (byte_4B65A66 & 1) == 0 )
  {
    sub_1BE4ACC(&BattleCommand_TypeInfo, *(_QWORD *)&afterTypeRawValue);
    byte_4B65A66 = 1;
  }
  if ( !BattleCommand_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(BattleCommand_TypeInfo);
  isARTS_38460600 = BattleCommand__isARTS_38460600(beforeTypeRawValue, *(const MethodInfo **)&afterTypeRawValue);
  if ( BattleCommand_TypeInfo->_2.cctor_finished )
  {
    if ( isARTS_38460600 )
      goto LABEL_7;
  ...
  else
  {
    ...
    {
LABEL_7:
      if ( BattleCommand__isBUSTER_38460700(afterTypeRawValue, v5) )
        return 1;
      if ( !BattleCommand_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(BattleCommand_TypeInfo);
      if ( BattleCommand__isQUICK_38460800(afterTypeRawValue, v7) )
        return 2;
      return 0;
    }
  }
  isBUSTER_38460700 = BattleCommand__isBUSTER_38460700(beforeTypeRawValue, v5);
  if ( BattleCommand_TypeInfo->_2.cctor_finished )
  {
    if ( isBUSTER_38460700 )
      goto LABEL_12;
  }
  else
  {
    ...
    {
LABEL_12:
      if ( BattleCommand__isARTS_38460600(afterTypeRawValue, v9) )
        return 3;
      if ( !BattleCommand_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(BattleCommand_TypeInfo);
      if ( BattleCommand__isQUICK_38460800(afterTypeRawValue, v11) )
        return 4;
      return 0;
    }
  }
  if ( BattleCommand__isQUICK_38460800(beforeTypeRawValue, v9) )
  {
    if ( !BattleCommand_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(BattleCommand_TypeInfo);
    if ( BattleCommand__isARTS_38460600(afterTypeRawValue, v12) )
      return 5;
    if ( !BattleCommand_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(BattleCommand_TypeInfo);
    if ( BattleCommand__isBUSTER_38460700(afterTypeRawValue, v13) )
      return 6;
  }
  return 0;
}
...
float __fastcall BattleCommand__getCriticalMagnification(BattleCommandData_o *data, const MethodInfo *method)
{
  ...
  if ( (byte_4B65A5F & 1) == 0 )
  {
    data = (BattleCommandData_o *)sub_1BE4ACC(&BattleCommand_TypeInfo, method);
    byte_4B65A5F = 1;
  }
  if ( !v2 )
...
float __fastcall BattleCommand__getCriticalMagnification_38460572(
        int32_t type,
        int32_t index,
        const MethodInfo *method)
{
...
float __fastcall BattleCommand__getMagnification_38460308(int32_t type, int32_t index, const MethodInfo *method)
{
...
float __fastcall BattleCommand__getNpMagnification(BattleCommandData_o *command, const MethodInfo *method)
{
  ...
  if ( (byte_4B65A5E & 1) == 0 )
  {
    command = (BattleCommandData_o *)sub_1BE4ACC(&BattleCommand_TypeInfo, method);
    byte_4B65A5E = 1;
  }
  if ( !v2 )
    sub_1BE4D28(command, method);
  CommandType = BattleCommandData__getCommandType(v2, 0LL);
  actionIndex = v2->fields.actionIndex;
  v5 = CommandType;
  if ( !BattleCommand_TypeInfo->_2.cctor_finished )
...
float __fastcall BattleCommand__getNpMagnification_38460440(int32_t type, int32_t index, const MethodInfo *method)
{
...
bool __fastcall BattleCommand__isARTS_38460600(int32_t type, const MethodInfo *method)
{
  if ( (byte_4B65A60 & 1) == 0 )
  {
...
bool __fastcall BattleCommand__isBUSTER_38460700(int32_t type, const MethodInfo *method)
{
  if ( (byte_4B65A61 & 1) == 0 )
  {
    sub_1BE4ACC(&BattleCommand_TypeInfo, method);
...
bool __fastcall BattleCommand__isQUICK_38460800(int32_t type, const MethodInfo *method)
{
  if ( (byte_4B65A62 & 1) == 0 )
  {
    sub_1BE4ACC(&BattleCommand_TypeInfo, method);
...
void __fastcall BattleCommand__setSprite(UISprite_o *sprite, int32_t type, const MethodInfo *method)
{
  ...
  if ( (byte_4B65A64 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_20404/*"icon_commandcard_quick"*/, *(_QWORD *)&type);
    sub_1BE4ACC(&StringLiteral_20402/*"icon_commandcard_buster"*/, v5);
    sprite = (UISprite_o *)sub_1BE4ACC(&StringLiteral_20401/*"icon_commandcard_arts"*/, v6);
    byte_4B65A64 = 1;
  }
  switch ( type )
  {
    case 3:
      if ( v4 )
      {
        ...
        v7 = &StringLiteral_20404/*"icon_commandcard_quick"*/;
        goto LABEL_12;
      }
      goto LABEL_15;
    case 2:
      ...
      {
        UnityEngine_Behaviour__set_enabled(v4, 1, 0LL);
        v7 = &StringLiteral_20402/*"icon_commandcard_buster"*/;
        goto LABEL_12;
      }
LABEL_15:
      sub_1BE4D28(sprite, *(_QWORD *)&type);
    case 1:
      if ( v4 )
      {
        UnityEngine_Behaviour__set_enabled(v4, 1, 0LL);
        v7 = &StringLiteral_20401/*"icon_commandcard_arts"*/;
LABEL_12:
