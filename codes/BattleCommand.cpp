void __fastcall BattleCommand___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BFC5E9 & 1) == 0 )
  {
    sub_1C2E12C(&BattleCommand_TypeInfo, v1);
    sub_1C2E12C(&BattleCommand_TYPE___TypeInfo, v2);
    sub_1C2E12C(
      &Field__PrivateImplementationDetails__D0EE47FA46F276FE089AC8624109AA30225984329C335054459E360DBE11E12A,
      v3);
    byte_4BFC5E9 = 1;
  }
  v4 = (System_Array_o *)sub_1C2E1D4(BattleCommand_TYPE___TypeInfo, 6LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFC5E7 & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_17216/*"arts_quick"*/, defaultValue);
    sub_1C2E12C(&StringLiteral_23162/*"quick_buster"*/, v5);
    sub_1C2E12C(&StringLiteral_17956/*"buster_arts"*/, v6);
    byte_4BFC5E7 = 1;
  }
  switch ( type )
  {
    case 1:
    case 3:
      v7 = &StringLiteral_17956/*"buster_arts"*/;
      goto LABEL_7;
    case 2:
    case 5:
      v7 = &StringLiteral_17216/*"arts_quick"*/;
      goto LABEL_7;
    case 4:
    case 6:
      v7 = &StringLiteral_23162/*"quick_buster"*/;
LABEL_7:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFC5DE & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_3405/*"Buster"*/, defaultText);
    sub_1C2E12C(&StringLiteral_11140/*"Quick"*/, v5);
    sub_1C2E12C(&StringLiteral_2503/*"Arts"*/, v6);
    byte_4BFC5DE = 1;
  }
  switch ( type )
  {
    case 1:
      v7 = &StringLiteral_2503/*"Arts"*/;
      return (System_String_o *)*v7;
    case 3:
      v7 = &StringLiteral_11140/*"Quick"*/;
      return (System_String_o *)*v7;
    case 2:
      v7 = &StringLiteral_3405/*"Buster"*/;
      return (System_String_o *)*v7;
  }
  return v3;
}
        ...
        const MethodInfo *method)
{
  ...
  bool isARTS_38864012; // w21
  const MethodInfo *v7; // x1
  const MethodInfo *v9; // x1
  bool isBUSTER_38864112; // w21
  ...
  if ( (byte_4BFC5E8 & 1) == 0 )
  {
    sub_1C2E12C(&BattleCommand_TypeInfo, *(_QWORD *)&afterTypeRawValue);
    byte_4BFC5E8 = 1;
  }
  if ( !BattleCommand_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(BattleCommand_TypeInfo);
  isARTS_38864012 = BattleCommand__isARTS_38864012(beforeTypeRawValue, *(const MethodInfo **)&afterTypeRawValue);
  if ( BattleCommand_TypeInfo->_2.cctor_finished )
  {
    if ( isARTS_38864012 )
      goto LABEL_7;
  ...
  else
  {
    ...
    {
LABEL_7:
      if ( BattleCommand__isBUSTER_38864112(afterTypeRawValue, v5) )
        return 1;
      if ( !BattleCommand_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(BattleCommand_TypeInfo);
      if ( BattleCommand__isQUICK_38864212(afterTypeRawValue, v7) )
        return 2;
      return 0;
    }
  }
  isBUSTER_38864112 = BattleCommand__isBUSTER_38864112(beforeTypeRawValue, v5);
  if ( BattleCommand_TypeInfo->_2.cctor_finished )
  {
    if ( isBUSTER_38864112 )
      goto LABEL_12;
  }
  else
  {
    ...
    {
LABEL_12:
      if ( BattleCommand__isARTS_38864012(afterTypeRawValue, v9) )
        return 3;
      if ( !BattleCommand_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(BattleCommand_TypeInfo);
      if ( BattleCommand__isQUICK_38864212(afterTypeRawValue, v11) )
        return 4;
      return 0;
    }
  }
  if ( BattleCommand__isQUICK_38864212(beforeTypeRawValue, v9) )
  {
    if ( !BattleCommand_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(BattleCommand_TypeInfo);
    if ( BattleCommand__isARTS_38864012(afterTypeRawValue, v12) )
      return 5;
    if ( !BattleCommand_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(BattleCommand_TypeInfo);
    if ( BattleCommand__isBUSTER_38864112(afterTypeRawValue, v13) )
      return 6;
  }
  return 0;
}
...
float __fastcall BattleCommand__getCriticalMagnification(BattleCommandData_o *data, const MethodInfo *method)
{
  ...
  if ( (byte_4BFC5E1 & 1) == 0 )
  {
    data = (BattleCommandData_o *)sub_1C2E12C(&BattleCommand_TypeInfo, method);
    byte_4BFC5E1 = 1;
  }
  if ( !v2 )
...
float __fastcall BattleCommand__getCriticalMagnification_38863984(
        int32_t type,
        int32_t index,
        const MethodInfo *method)
{
...
float __fastcall BattleCommand__getMagnification_38863720(int32_t type, int32_t index, const MethodInfo *method)
{
...
float __fastcall BattleCommand__getNpMagnification(BattleCommandData_o *command, const MethodInfo *method)
{
  ...
  if ( (byte_4BFC5E0 & 1) == 0 )
  {
    command = (BattleCommandData_o *)sub_1C2E12C(&BattleCommand_TypeInfo, method);
    byte_4BFC5E0 = 1;
  }
  if ( !v2 )
    sub_1C2E388(command, method);
  CommandType = BattleCommandData__getCommandType(v2, 0LL);
  actionIndex = v2->fields.actionIndex;
  v5 = CommandType;
  if ( !BattleCommand_TypeInfo->_2.cctor_finished )
...
float __fastcall BattleCommand__getNpMagnification_38863852(int32_t type, int32_t index, const MethodInfo *method)
{
...
bool __fastcall BattleCommand__isARTS_38864012(int32_t type, const MethodInfo *method)
{
  if ( (byte_4BFC5E2 & 1) == 0 )
  {
...
bool __fastcall BattleCommand__isBUSTER_38864112(int32_t type, const MethodInfo *method)
{
  if ( (byte_4BFC5E3 & 1) == 0 )
  {
    sub_1C2E12C(&BattleCommand_TypeInfo, method);
...
bool __fastcall BattleCommand__isQUICK_38864212(int32_t type, const MethodInfo *method)
{
  if ( (byte_4BFC5E4 & 1) == 0 )
  {
    sub_1C2E12C(&BattleCommand_TypeInfo, method);
...
void __fastcall BattleCommand__setSprite(UISprite_o *sprite, int32_t type, const MethodInfo *method)
{
  ...
  if ( (byte_4BFC5E6 & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_20488/*"icon_commandcard_quick"*/, *(_QWORD *)&type);
    sub_1C2E12C(&StringLiteral_20486/*"icon_commandcard_buster"*/, v5);
    sprite = (UISprite_o *)sub_1C2E12C(&StringLiteral_20485/*"icon_commandcard_arts"*/, v6);
    byte_4BFC5E6 = 1;
  }
  switch ( type )
  {
    case 3:
      if ( v4 )
      {
        ...
        v7 = &StringLiteral_20488/*"icon_commandcard_quick"*/;
        goto LABEL_12;
      }
      goto LABEL_15;
    case 2:
      ...
      {
        UnityEngine_Behaviour__set_enabled(v4, 1, 0LL);
        v7 = &StringLiteral_20486/*"icon_commandcard_buster"*/;
        goto LABEL_12;
      }
LABEL_15:
      sub_1C2E388(sprite, *(_QWORD *)&type);
    case 1:
      if ( v4 )
      {
        UnityEngine_Behaviour__set_enabled(v4, 1, 0LL);
        v7 = &StringLiteral_20485/*"icon_commandcard_arts"*/;
LABEL_12:
