void BattleCommand___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C41D7C & 1) == 0 )
  {
    ...
    sub_1C37058(&Field__PrivateImplementationDetails__D0EE47FA46F276FE089AC8624109AA30225984329C335054459E360DBE11E12A);
    byte_4C41D7C = 1;
  }
  v1 = (System_Array_o *)sub_1C37100(BattleCommand_TYPE___TypeInfo, 6);
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)BattleCommand_TypeInfo->static_fields, (int32_t)v3, v4, v5);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C41D7A & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_16896/*"arts_quick"*/);
    sub_1C37058(&StringLiteral_22908/*"quick_buster"*/);
    sub_1C37058(&StringLiteral_17637/*"buster_arts"*/);
    byte_4C41D7A = 1;
  }
  switch ( type )
  {
    case 1:
    case 3:
      v5 = &StringLiteral_17637/*"buster_arts"*/;
      goto LABEL_7;
    case 2:
    case 5:
      v5 = &StringLiteral_16896/*"arts_quick"*/;
      goto LABEL_7;
    case 4:
    case 6:
      v5 = &StringLiteral_22908/*"quick_buster"*/;
LABEL_7:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C41D71 & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_3250/*"Buster"*/);
    sub_1C37058(&StringLiteral_10941/*"Quick"*/);
        ...
        const MethodInfo *method)
{
  ...
  bool isARTS_40281172; // w21
  const MethodInfo *v7; // x1
  const MethodInfo *v9; // x1
  bool isBUSTER_40281272; // w21
  ...
  isARTS_40281172 = BattleCommand__isARTS_40281172(beforeTypeRawValue, *(const MethodInfo **)&afterTypeRawValue);
  if ( BattleCommand_TypeInfo->_2.cctor_finished )
  {
    if ( isARTS_40281172 )
      goto LABEL_7;
  ...
  else
  {
    ...
    {
LABEL_7:
      if ( BattleCommand__isBUSTER_40281272(afterTypeRawValue, v5) )
        return 1;
      if ( !BattleCommand_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(BattleCommand_TypeInfo);
      if ( BattleCommand__isQUICK_40281372(afterTypeRawValue, v7) )
        return 2;
      return 0;
    }
  }
  isBUSTER_40281272 = BattleCommand__isBUSTER_40281272(beforeTypeRawValue, v5);
  if ( BattleCommand_TypeInfo->_2.cctor_finished )
  {
    if ( isBUSTER_40281272 )
      goto LABEL_12;
  }
  else
  {
    ...
    {
LABEL_12:
      if ( BattleCommand__isARTS_40281172(afterTypeRawValue, v9) )
        return 3;
      if ( !BattleCommand_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(BattleCommand_TypeInfo);
      if ( BattleCommand__isQUICK_40281372(afterTypeRawValue, v11) )
        return 4;
      return 0;
    }
  }
  if ( BattleCommand__isQUICK_40281372(beforeTypeRawValue, v9) )
  {
    if ( !BattleCommand_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(BattleCommand_TypeInfo);
    if ( BattleCommand__isARTS_40281172(afterTypeRawValue, v12) )
      return 5;
    if ( !BattleCommand_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(BattleCommand_TypeInfo);
    if ( BattleCommand__isBUSTER_40281272(afterTypeRawValue, v13) )
      return 6;
  }
  return 0;
}
...
float BattleCommand__getCriticalMagnification(BattleCommandData_o *data, const MethodInfo *method)
{
  ...
  if ( (byte_4C41D74 & 1) == 0 )
  {
    data = (BattleCommandData_o *)sub_1C37058(&BattleCommand_TypeInfo);
    byte_4C41D74 = 1;
  }
  if ( !v2 )
    sub_1C372B4(data);
...
float BattleCommand__getCriticalMagnification_40281144(int32_t type, int32_t index, const MethodInfo *method)
{
...
float BattleCommand__getMagnification_40280880(int32_t type, int32_t index, const MethodInfo *method)
{
...
float BattleCommand__getNpMagnification(BattleCommandData_o *command, const MethodInfo *method)
{
  ...
  if ( (byte_4C41D73 & 1) == 0 )
  {
    command = (BattleCommandData_o *)sub_1C37058(&BattleCommand_TypeInfo);
    byte_4C41D73 = 1;
  }
  if ( !v2 )
    sub_1C372B4(command);
...
float BattleCommand__getNpMagnification_40281012(int32_t type, int32_t index, const MethodInfo *method)
{
...
bool BattleCommand__isARTS_40281172(int32_t type, const MethodInfo *method)
{
  if ( (byte_4C41D75 & 1) == 0 )
  {
    sub_1C37058(&BattleCommand_TypeInfo);
...
bool BattleCommand__isBUSTER_40281272(int32_t type, const MethodInfo *method)
{
  if ( (byte_4C41D76 & 1) == 0 )
  {
    sub_1C37058(&BattleCommand_TypeInfo);
...
bool BattleCommand__isQUICK_40281372(int32_t type, const MethodInfo *method)
{
  if ( (byte_4C41D77 & 1) == 0 )
  {
    sub_1C37058(&BattleCommand_TypeInfo);
...
void BattleCommand__setSprite(UISprite_o *sprite, int32_t type, const MethodInfo *method)
{
  ...
  if ( (byte_4C41D79 & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_20172/*"icon_commandcard_quick"*/);
    sub_1C37058(&StringLiteral_20170/*"icon_commandcard_buster"*/);
    sprite = (UISprite_o *)sub_1C37058(&StringLiteral_20169/*"icon_commandcard_arts"*/);
    byte_4C41D79 = 1;
  }
  switch ( type )
  {
    case 3:
      if ( v4 )
      {
        ...
        v5 = &StringLiteral_20172/*"icon_commandcard_quick"*/;
        goto LABEL_12;
      }
      goto LABEL_15;
    case 2:
      ...
      {
        UnityEngine_Behaviour__set_enabled(v4, 1, 0);
        v5 = &StringLiteral_20170/*"icon_commandcard_buster"*/;
        goto LABEL_12;
      }
LABEL_15:
      sub_1C372B4(sprite);
    case 1:
      ...
      {
        UnityEngine_Behaviour__set_enabled(v4, 1, 0);
        v5 = &StringLiteral_20169/*"icon_commandcard_arts"*/;
LABEL_12:
