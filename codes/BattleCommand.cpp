void BattleCommand___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C260B5 & 1) == 0 )
  {
    ...
    sub_1C2D490(&BattleCommand_TYPE___TypeInfo);
    sub_1C2D490(&Field__PrivateImplementationDetails__D0EE47FA46F276FE089AC8624109AA30225984329C335054459E360DBE11E12A);
    byte_4C260B5 = 1;
  }
  v1 = (System_Array_o *)sub_1C2D538(BattleCommand_TYPE___TypeInfo, 6);
  ...
  sub_1C2D434((CGThumbnailListItem_o *)BattleCommand_TypeInfo->static_fields, (int32_t)v3, v4, v5);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C260B3 & 1) == 0 )
  {
    sub_1C2D490(&StringLiteral_16891/*"arts_quick"*/);
    sub_1C2D490(&StringLiteral_22887/*"quick_buster"*/);
    sub_1C2D490(&StringLiteral_17631/*"buster_arts"*/);
    byte_4C260B3 = 1;
  }
  switch ( type )
  {
    case 1:
    case 3:
      v5 = &StringLiteral_17631/*"buster_arts"*/;
      goto LABEL_7;
    case 2:
    case 5:
      v5 = &StringLiteral_16891/*"arts_quick"*/;
      goto LABEL_7;
    case 4:
    case 6:
      v5 = &StringLiteral_22887/*"quick_buster"*/;
LABEL_7:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C260AA & 1) == 0 )
  {
    sub_1C2D490(&StringLiteral_3247/*"Buster"*/);
    sub_1C2D490(&StringLiteral_10934/*"Quick"*/);
    sub_1C2D490(&StringLiteral_2362/*"Arts"*/);
    byte_4C260AA = 1;
  }
  switch ( type )
  {
    case 1:
      v5 = &StringLiteral_2362/*"Arts"*/;
      return (System_String_o *)*v5;
    case 3:
      v5 = &StringLiteral_10934/*"Quick"*/;
      return (System_String_o *)*v5;
    case 2:
      v5 = &StringLiteral_3247/*"Buster"*/;
      return (System_String_o *)*v5;
  }
  return defaultText;
}
        ...
        const MethodInfo *method)
{
  ...
  bool isARTS_40060504; // w21
  const MethodInfo *v7; // x1
  const MethodInfo *v9; // x1
  bool isBUSTER_40060604; // w21
  ...
  isARTS_40060504 = BattleCommand__isARTS_40060504(beforeTypeRawValue, *(const MethodInfo **)&afterTypeRawValue);
  if ( BattleCommand_TypeInfo->_2.cctor_finished )
  {
    if ( isARTS_40060504 )
      goto LABEL_7;
  ...
  else
  {
    ...
    {
LABEL_7:
      if ( BattleCommand__isBUSTER_40060604(afterTypeRawValue, v5) )
        return 1;
      if ( !BattleCommand_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(BattleCommand_TypeInfo);
      if ( BattleCommand__isQUICK_40060704(afterTypeRawValue, v7) )
        return 2;
      return 0;
    }
  }
  isBUSTER_40060604 = BattleCommand__isBUSTER_40060604(beforeTypeRawValue, v5);
  if ( BattleCommand_TypeInfo->_2.cctor_finished )
  {
    if ( isBUSTER_40060604 )
      goto LABEL_12;
  }
  else
  {
    ...
    {
LABEL_12:
      if ( BattleCommand__isARTS_40060504(afterTypeRawValue, v9) )
        return 3;
      if ( !BattleCommand_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(BattleCommand_TypeInfo);
      if ( BattleCommand__isQUICK_40060704(afterTypeRawValue, v11) )
        return 4;
      return 0;
    }
  }
  if ( BattleCommand__isQUICK_40060704(beforeTypeRawValue, v9) )
  {
    if ( !BattleCommand_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(BattleCommand_TypeInfo);
    if ( BattleCommand__isARTS_40060504(afterTypeRawValue, v12) )
      return 5;
    if ( !BattleCommand_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(BattleCommand_TypeInfo);
    if ( BattleCommand__isBUSTER_40060604(afterTypeRawValue, v13) )
      return 6;
  }
  return 0;
}
...
float BattleCommand__getCriticalMagnification(BattleCommandData_o *data, const MethodInfo *method)
{
  ...
  if ( (byte_4C260AD & 1) == 0 )
  {
    data = (BattleCommandData_o *)sub_1C2D490(&BattleCommand_TypeInfo);
    byte_4C260AD = 1;
  }
  if ( !v2 )
...
float BattleCommand__getCriticalMagnification_40060476(int32_t type, int32_t index, const MethodInfo *method)
{
...
float BattleCommand__getMagnification_40060212(int32_t type, int32_t index, const MethodInfo *method)
{
...
float BattleCommand__getNpMagnification(BattleCommandData_o *command, const MethodInfo *method)
{
  ...
  if ( (byte_4C260AC & 1) == 0 )
  {
    command = (BattleCommandData_o *)sub_1C2D490(&BattleCommand_TypeInfo);
    byte_4C260AC = 1;
  }
  if ( !v2 )
...
float BattleCommand__getNpMagnification_40060344(int32_t type, int32_t index, const MethodInfo *method)
{
...
bool BattleCommand__isARTS_40060504(int32_t type, const MethodInfo *method)
{
  if ( (byte_4C260AE & 1) == 0 )
  {
    sub_1C2D490(&BattleCommand_TypeInfo);
...
bool BattleCommand__isBUSTER_40060604(int32_t type, const MethodInfo *method)
{
  if ( (byte_4C260AF & 1) == 0 )
  {
    sub_1C2D490(&BattleCommand_TypeInfo);
...
bool BattleCommand__isQUICK_40060704(int32_t type, const MethodInfo *method)
{
  if ( (byte_4C260B0 & 1) == 0 )
  {
    sub_1C2D490(&BattleCommand_TypeInfo);
...
void BattleCommand__setSprite(UISprite_o *sprite, int32_t type, const MethodInfo *method)
{
  ...
  if ( (byte_4C260B2 & 1) == 0 )
  {
    sub_1C2D490(&StringLiteral_20157/*"icon_commandcard_quick"*/);
    sub_1C2D490(&StringLiteral_20155/*"icon_commandcard_buster"*/);
    sprite = (UISprite_o *)sub_1C2D490(&StringLiteral_20154/*"icon_commandcard_arts"*/);
    byte_4C260B2 = 1;
  }
  switch ( type )
  {
    case 3:
      if ( v4 )
      {
        ...
        v5 = &StringLiteral_20157/*"icon_commandcard_quick"*/;
        goto LABEL_12;
      }
      goto LABEL_15;
    case 2:
      ...
      {
        UnityEngine_Behaviour__set_enabled(v4, 1, 0);
        v5 = &StringLiteral_20155/*"icon_commandcard_buster"*/;
        goto LABEL_12;
      }
LABEL_15:
      sub_1C2D6EC(sprite, *(_QWORD *)&type);
    case 1:
      if ( v4 )
      {
        UnityEngine_Behaviour__set_enabled(v4, 1, 0);
        v5 = &StringLiteral_20154/*"icon_commandcard_arts"*/;
LABEL_12:
