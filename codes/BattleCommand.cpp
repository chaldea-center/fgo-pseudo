...
float __fastcall BattleCommand__getCriticalMagnification_19055964(
        int32_t type,
        int32_t index,
...
float __fastcall BattleCommand__getMagnification_19055852(int32_t type, int32_t index, const MethodInfo *method)
{
...
float __fastcall BattleCommand__getNpMagnification_19055908(int32_t type, int32_t index, const MethodInfo *method)
{
...
void __fastcall BattleCommand__setSprite(UISprite_o *sprite, int32_t type, const MethodInfo *method)
{
  ...
  if ( (byte_4387D08 & 1) == 0 )
  {
    sub_B775C4(&StringLiteral_19710/*"icon_commandcard_quick"*/);
    sub_B775C4(&StringLiteral_19708/*"icon_commandcard_buster"*/);
    sprite = (UISprite_o *)sub_B775C4(&StringLiteral_19707/*"icon_commandcard_arts"*/);
    byte_4387D08 = 1;
  }
  switch ( type )
  {
    case 3:
      if ( v4 )
      {
        ...
        v5 = &StringLiteral_19710/*"icon_commandcard_quick"*/;
        goto LABEL_12;
      }
      goto LABEL_15;
    case 2:
      ...
      {
        UnityEngine_Behaviour__set_enabled(v4, 1, 0LL);
        v5 = &StringLiteral_19708/*"icon_commandcard_buster"*/;
        goto LABEL_12;
      }
LABEL_15:
      sub_B7769C(sprite, *(_QWORD *)&type);
    case 1:
      if ( v4 )
      {
        UnityEngine_Behaviour__set_enabled(v4, 1, 0LL);
        v5 = &StringLiteral_19707/*"icon_commandcard_arts"*/;
LABEL_12:
