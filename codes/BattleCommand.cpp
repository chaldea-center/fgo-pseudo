void BattleCommand___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C3678D & 1) == 0 )
  {
    ...
    sub_1C32C20(&Field__PrivateImplementationDetails__D0EE47FA46F276FE089AC8624109AA30225984329C335054459E360DBE11E12A);
    byte_4C3678D = 1;
  }
  v1 = (System_Array_o *)sub_1C32CC8(BattleCommand_TYPE___TypeInfo, 6);
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)BattleCommand_TypeInfo->static_fields, (int32_t)v3, v4, v5);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3678B & 1) == 0 )
  {
    sub_1C32C20(&StringLiteral_16894/*"arts_quick"*/);
    sub_1C32C20(&StringLiteral_22904/*"quick_buster"*/);
    sub_1C32C20(&StringLiteral_17635/*"buster_arts"*/);
    byte_4C3678B = 1;
  }
  switch ( type )
  {
    case 1:
    case 3:
      v5 = &StringLiteral_17635/*"buster_arts"*/;
      goto LABEL_7;
    case 2:
    case 5:
      v5 = &StringLiteral_16894/*"arts_quick"*/;
      goto LABEL_7;
    case 4:
    case 6:
      v5 = &StringLiteral_22904/*"quick_buster"*/;
LABEL_7:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C36782 & 1) == 0 )
  {
    sub_1C32C20(&StringLiteral_3250/*"Buster"*/);
    sub_1C32C20(&StringLiteral_10940/*"Quick"*/);
        ...
        const MethodInfo *method)
{
  ...
  bool isARTS_40182768; // w21
  const MethodInfo *v7; // x1
  const MethodInfo *v9; // x1
  bool isBUSTER_40182868; // w21
  ...
  isARTS_40182768 = BattleCommand__isARTS_40182768(beforeTypeRawValue, *(const MethodInfo **)&afterTypeRawValue);
  if ( BattleCommand_TypeInfo->_2.cctor_finished )
  {
    if ( isARTS_40182768 )
      goto LABEL_7;
  ...
  else
  {
    ...
    {
LABEL_7:
      if ( BattleCommand__isBUSTER_40182868(afterTypeRawValue, v5) )
        return 1;
      if ( !BattleCommand_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(BattleCommand_TypeInfo);
      if ( BattleCommand__isQUICK_40182968(afterTypeRawValue, v7) )
        return 2;
      return 0;
    }
  }
  isBUSTER_40182868 = BattleCommand__isBUSTER_40182868(beforeTypeRawValue, v5);
  if ( BattleCommand_TypeInfo->_2.cctor_finished )
  {
    if ( isBUSTER_40182868 )
      goto LABEL_12;
  }
  else
  {
    ...
    {
LABEL_12:
      if ( BattleCommand__isARTS_40182768(afterTypeRawValue, v9) )
        return 3;
      if ( !BattleCommand_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(BattleCommand_TypeInfo);
      if ( BattleCommand__isQUICK_40182968(afterTypeRawValue, v11) )
        return 4;
      return 0;
    }
  }
  if ( BattleCommand__isQUICK_40182968(beforeTypeRawValue, v9) )
  {
    if ( !BattleCommand_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(BattleCommand_TypeInfo);
    if ( BattleCommand__isARTS_40182768(afterTypeRawValue, v12) )
      return 5;
    if ( !BattleCommand_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(BattleCommand_TypeInfo);
    if ( BattleCommand__isBUSTER_40182868(afterTypeRawValue, v13) )
      return 6;
  }
  return 0;
}
...
float BattleCommand__getCriticalMagnification(BattleCommandData_o *data, const MethodInfo *method)
{
  ...
  if ( (byte_4C36785 & 1) == 0 )
  {
    data = (BattleCommandData_o *)sub_1C32C20(&BattleCommand_TypeInfo);
    byte_4C36785 = 1;
  }
  if ( !v2 )
    sub_1C32E7C(data);
...
float BattleCommand__getCriticalMagnification_40182740(int32_t type, int32_t index, const MethodInfo *method)
{
...
float BattleCommand__getMagnification_40182476(int32_t type, int32_t index, const MethodInfo *method)
{
...
float BattleCommand__getNpMagnification(BattleCommandData_o *command, const MethodInfo *method)
{
  ...
  if ( (byte_4C36784 & 1) == 0 )
  {
    command = (BattleCommandData_o *)sub_1C32C20(&BattleCommand_TypeInfo);
    byte_4C36784 = 1;
  }
  if ( !v2 )
    sub_1C32E7C(command);
...
float BattleCommand__getNpMagnification_40182608(int32_t type, int32_t index, const MethodInfo *method)
{
...
bool BattleCommand__isARTS_40182768(int32_t type, const MethodInfo *method)
{
  if ( (byte_4C36786 & 1) == 0 )
  {
    sub_1C32C20(&BattleCommand_TypeInfo);
...
bool BattleCommand__isBUSTER_40182868(int32_t type, const MethodInfo *method)
{
  if ( (byte_4C36787 & 1) == 0 )
  {
    sub_1C32C20(&BattleCommand_TypeInfo);
...
bool BattleCommand__isQUICK_40182968(int32_t type, const MethodInfo *method)
{
  if ( (byte_4C36788 & 1) == 0 )
  {
    sub_1C32C20(&BattleCommand_TypeInfo);
...
void BattleCommand__setSprite(UISprite_o *sprite, int32_t type, const MethodInfo *method)
{
  ...
  if ( (byte_4C3678A & 1) == 0 )
  {
    sub_1C32C20(&StringLiteral_20169/*"icon_commandcard_quick"*/);
    sub_1C32C20(&StringLiteral_20167/*"icon_commandcard_buster"*/);
    sprite = (UISprite_o *)sub_1C32C20(&StringLiteral_20166/*"icon_commandcard_arts"*/);
    byte_4C3678A = 1;
  }
  switch ( type )
  {
    case 3:
      if ( v4 )
      {
        ...
        v5 = &StringLiteral_20169/*"icon_commandcard_quick"*/;
        goto LABEL_12;
      }
      goto LABEL_15;
    case 2:
      ...
      {
        UnityEngine_Behaviour__set_enabled(v4, 1, 0);
        v5 = &StringLiteral_20167/*"icon_commandcard_buster"*/;
        goto LABEL_12;
      }
LABEL_15:
      sub_1C32E7C(sprite);
    case 1:
      ...
      {
        UnityEngine_Behaviour__set_enabled(v4, 1, 0);
        v5 = &StringLiteral_20166/*"icon_commandcard_arts"*/;
LABEL_12:
