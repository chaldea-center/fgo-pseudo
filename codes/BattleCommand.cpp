        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E1768 & 1) == 0 )
  {
    sub_1B00CCC(&StringLiteral_16683/*"arts_quick"*/, defaultValue);
    sub_1B00CCC(&StringLiteral_22421/*"quick_buster"*/, v5);
    sub_1B00CCC(&StringLiteral_17402/*"buster_arts"*/, v6);
    byte_48E1768 = 1;
  }
  switch ( type )
  {
    case 1:
    case 3:
      v7 = &StringLiteral_17402/*"buster_arts"*/;
      goto LABEL_7;
    case 2:
    case 5:
      v7 = &StringLiteral_16683/*"arts_quick"*/;
      goto LABEL_7;
    case 4:
    case 6:
      v7 = &StringLiteral_22421/*"quick_buster"*/;
LABEL_7:
...
float __fastcall BattleCommand__getCriticalMagnification_36366060(
        int32_t type,
        int32_t index,
        const MethodInfo *method)
{
...
float __fastcall BattleCommand__getMagnification_36365964(int32_t type, int32_t index, const MethodInfo *method)
{
...
float __fastcall BattleCommand__getNpMagnification_36366012(int32_t type, int32_t index, const MethodInfo *method)
{
...
void __fastcall BattleCommand__setSprite(UISprite_o *sprite, int32_t type, const MethodInfo *method)
{
  ...
  if ( (byte_48E1767 & 1) == 0 )
  {
    sub_1B00CCC(&StringLiteral_19856/*"icon_commandcard_quick"*/, *(_QWORD *)&type);
    sub_1B00CCC(&StringLiteral_19854/*"icon_commandcard_buster"*/, v5);
    sprite = (UISprite_o *)sub_1B00CCC(&StringLiteral_19853/*"icon_commandcard_arts"*/, v6);
    byte_48E1767 = 1;
  }
  switch ( type )
  {
    case 3:
      if ( v4 )
      {
        ...
        v7 = &StringLiteral_19856/*"icon_commandcard_quick"*/;
        goto LABEL_12;
      }
      goto LABEL_15;
    case 2:
      ...
      {
        UnityEngine_Behaviour__set_enabled(v4, 1, 0LL);
        v7 = &StringLiteral_19854/*"icon_commandcard_buster"*/;
        goto LABEL_12;
      }
LABEL_15:
      sub_1B00F28(sprite, *(_QWORD *)&type);
    case 1:
      if ( v4 )
      {
        UnityEngine_Behaviour__set_enabled(v4, 1, 0LL);
        v7 = &StringLiteral_19853/*"icon_commandcard_arts"*/;
LABEL_12:
