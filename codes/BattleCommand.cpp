...
float __fastcall BattleCommand__getCriticalMagnification_18903644(
        int32_t type,
        int32_t index,
...
float __fastcall BattleCommand__getMagnification_18903532(int32_t type, int32_t index, const MethodInfo *method)
{
...
float __fastcall BattleCommand__getNpMagnification_18903588(int32_t type, int32_t index, const MethodInfo *method)
{
...
void __fastcall BattleCommand__setSprite(UISprite_o *sprite, int32_t type, const MethodInfo *method)
{
  ...
  if ( (byte_434E737 & 1) == 0 )
  {
    sub_B70694(&StringLiteral_19620/*"icon_commandcard_quick"*/);
    sub_B70694(&StringLiteral_19618/*"icon_commandcard_buster"*/);
    sprite = (UISprite_o *)sub_B70694(&StringLiteral_19617/*"icon_commandcard_arts"*/);
    byte_434E737 = 1;
  }
  switch ( type )
  {
    case 3:
      if ( v4 )
      {
        ...
        v5 = &StringLiteral_19620/*"icon_commandcard_quick"*/;
        goto LABEL_12;
      }
      goto LABEL_15;
    case 2:
      ...
      {
        UnityEngine_Behaviour__set_enabled(v4, 1, 0LL);
        v5 = &StringLiteral_19618/*"icon_commandcard_buster"*/;
        goto LABEL_12;
      }
LABEL_15:
      sub_B7076C(sprite, *(_QWORD *)&type);
    case 1:
      if ( v4 )
      {
        UnityEngine_Behaviour__set_enabled(v4, 1, 0LL);
        v5 = &StringLiteral_19617/*"icon_commandcard_arts"*/;
LABEL_12:
