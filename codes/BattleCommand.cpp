void __fastcall BattleCommand___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B438AD & 1) == 0 )
  {
    sub_1BDB878(&BattleCommand_TypeInfo, v1);
  ...
  v4 = (System_Array_o *)sub_1BDB920(BattleCommand_TYPE___TypeInfo, 6LL);
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)BattleCommand_TypeInfo->static_fields, (int32_t)v5, v6, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B438AB & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_16904/*"arts_quick"*/, defaultValue);
    sub_1BDB878(&StringLiteral_22929/*"quick_buster"*/, v5);
    sub_1BDB878(&StringLiteral_17647/*"buster_arts"*/, v6);
    byte_4B438AB = 1;
  }
  switch ( type )
  {
    case 1:
    case 3:
      v7 = &StringLiteral_17647/*"buster_arts"*/;
      goto LABEL_7;
    case 2:
    case 5:
      v7 = &StringLiteral_16904/*"arts_quick"*/;
      goto LABEL_7;
    case 4:
    case 6:
      v7 = &StringLiteral_22929/*"quick_buster"*/;
LABEL_7:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B438A2 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_3292/*"Buster"*/, defaultText);
    sub_1BDB878(&StringLiteral_10937/*"Quick"*/, v5);
    sub_1BDB878(&StringLiteral_2392/*"Arts"*/, v6);
    byte_4B438A2 = 1;
  }
  switch ( type )
  {
    case 1:
      v7 = &StringLiteral_2392/*"Arts"*/;
      return (System_String_o *)*v7;
    case 3:
      v7 = &StringLiteral_10937/*"Quick"*/;
      return (System_String_o *)*v7;
    case 2:
      v7 = &StringLiteral_3292/*"Buster"*/;
      return (System_String_o *)*v7;
  }
  return v3;
}
        ...
        const MethodInfo *method)
{
  ...
  bool isARTS_39309712; // w21
  const MethodInfo *v7; // x1
  const MethodInfo *v9; // x1
  bool isBUSTER_39309812; // w21
  ...
  if ( (byte_4B438AC & 1) == 0 )
  {
    sub_1BDB878(&BattleCommand_TypeInfo, *(_QWORD *)&afterTypeRawValue);
    byte_4B438AC = 1;
  }
  if ( !BattleCommand_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(BattleCommand_TypeInfo);
  isARTS_39309712 = BattleCommand__isARTS_39309712(beforeTypeRawValue, *(const MethodInfo **)&afterTypeRawValue);
  if ( BattleCommand_TypeInfo->_2.cctor_finished )
  {
    if ( isARTS_39309712 )
      goto LABEL_7;
  ...
  else
  {
    ...
    {
LABEL_7:
      if ( BattleCommand__isBUSTER_39309812(afterTypeRawValue, v5) )
        return 1;
      if ( !BattleCommand_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(BattleCommand_TypeInfo);
      if ( BattleCommand__isQUICK_39309912(afterTypeRawValue, v7) )
        return 2;
      return 0;
    }
  }
  isBUSTER_39309812 = BattleCommand__isBUSTER_39309812(beforeTypeRawValue, v5);
  if ( BattleCommand_TypeInfo->_2.cctor_finished )
  {
    if ( isBUSTER_39309812 )
      goto LABEL_12;
  }
  else
  {
    ...
    {
LABEL_12:
      if ( BattleCommand__isARTS_39309712(afterTypeRawValue, v9) )
        return 3;
      if ( !BattleCommand_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(BattleCommand_TypeInfo);
      if ( BattleCommand__isQUICK_39309912(afterTypeRawValue, v11) )
        return 4;
      return 0;
    }
  }
  if ( BattleCommand__isQUICK_39309912(beforeTypeRawValue, v9) )
  {
    if ( !BattleCommand_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(BattleCommand_TypeInfo);
    if ( BattleCommand__isARTS_39309712(afterTypeRawValue, v12) )
      return 5;
    if ( !BattleCommand_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(BattleCommand_TypeInfo);
    if ( BattleCommand__isBUSTER_39309812(afterTypeRawValue, v13) )
      return 6;
  }
  return 0;
}
...
float __fastcall BattleCommand__getCriticalMagnification(BattleCommandData_o *data, const MethodInfo *method)
{
  ...
  if ( (byte_4B438A5 & 1) == 0 )
  {
    data = (BattleCommandData_o *)sub_1BDB878(&BattleCommand_TypeInfo, method);
    byte_4B438A5 = 1;
  }
  if ( !v2 )
...
float __fastcall BattleCommand__getCriticalMagnification_39309684(
        int32_t type,
        int32_t index,
        const MethodInfo *method)
{
...
float __fastcall BattleCommand__getMagnification_39309420(int32_t type, int32_t index, const MethodInfo *method)
{
...
float __fastcall BattleCommand__getNpMagnification(BattleCommandData_o *command, const MethodInfo *method)
{
  ...
  if ( (byte_4B438A4 & 1) == 0 )
  {
    command = (BattleCommandData_o *)sub_1BDB878(&BattleCommand_TypeInfo, method);
    byte_4B438A4 = 1;
  }
  if ( !v2 )
...
float __fastcall BattleCommand__getNpMagnification_39309552(int32_t type, int32_t index, const MethodInfo *method)
{
...
bool __fastcall BattleCommand__isARTS_39309712(int32_t type, const MethodInfo *method)
{
  if ( (byte_4B438A6 & 1) == 0 )
  {
...
bool __fastcall BattleCommand__isBUSTER_39309812(int32_t type, const MethodInfo *method)
{
  if ( (byte_4B438A7 & 1) == 0 )
  {
    sub_1BDB878(&BattleCommand_TypeInfo, method);
...
bool __fastcall BattleCommand__isQUICK_39309912(int32_t type, const MethodInfo *method)
{
  if ( (byte_4B438A8 & 1) == 0 )
  {
    sub_1BDB878(&BattleCommand_TypeInfo, method);
...
void __fastcall BattleCommand__setSprite(UISprite_o *sprite, int32_t type, const MethodInfo *method)
{
  ...
  if ( (byte_4B438AA & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_20190/*"icon_commandcard_quick"*/, *(_QWORD *)&type);
    sub_1BDB878(&StringLiteral_20188/*"icon_commandcard_buster"*/, v5);
    sprite = (UISprite_o *)sub_1BDB878(&StringLiteral_20187/*"icon_commandcard_arts"*/, v6);
    byte_4B438AA = 1;
  }
  switch ( type )
  {
    case 3:
      if ( v4 )
      {
        ...
        v7 = &StringLiteral_20190/*"icon_commandcard_quick"*/;
        goto LABEL_12;
      }
      goto LABEL_15;
    case 2:
      ...
      {
        UnityEngine_Behaviour__set_enabled(v4, 1, 0LL);
        v7 = &StringLiteral_20188/*"icon_commandcard_buster"*/;
        goto LABEL_12;
      }
LABEL_15:
      sub_1BDBAD4(sprite, *(_QWORD *)&type);
    case 1:
      if ( v4 )
      {
        UnityEngine_Behaviour__set_enabled(v4, 1, 0LL);
        v7 = &StringLiteral_20187/*"icon_commandcard_arts"*/;
LABEL_12:
