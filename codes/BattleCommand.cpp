void BattleCommand___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CED45D & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Field__PrivateImplementationDetails__D0EE47FA46F276FE089AC8624109AA30225984329C335054459E360DBE11E12A);
    byte_4CED45D = 1;
  }
  v1 = (System_Array_o *)sub_1C7BB90(BattleCommand_TYPE___TypeInfo, 6);
  ...
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)BattleCommand_TypeInfo->static_fields, (int32_t)v3, v4, v5, v6, v7, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CED45B & 1) == 0 )
  {
    sub_1C7BAE8(&StringLiteral_16975/*"arts_quick"*/);
    sub_1C7BAE8(&StringLiteral_23128/*"quick_buster"*/);
    sub_1C7BAE8(&StringLiteral_17727/*"buster_arts"*/);
    byte_4CED45B = 1;
  }
  switch ( type )
  {
    case 1:
    case 3:
      v5 = &StringLiteral_17727/*"buster_arts"*/;
      goto LABEL_7;
    case 2:
    case 5:
      v5 = &StringLiteral_16975/*"arts_quick"*/;
      goto LABEL_7;
    case 4:
    case 6:
      v5 = &StringLiteral_23128/*"quick_buster"*/;
LABEL_7:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CED452 & 1) == 0 )
  {
    sub_1C7BAE8(&StringLiteral_3252/*"Buster"*/);
    sub_1C7BAE8(&StringLiteral_10984/*"Quick"*/);
  ...
  switch ( type )
  {
    ...
    case 3:
      v5 = &StringLiteral_10984/*"Quick"*/;
      return (System_String_o *)*v5;
    case 2:
      v5 = &StringLiteral_3252/*"Buster"*/;
      return (System_String_o *)*v5;
  }
  return defaultText;
}
        ...
        const MethodInfo *method)
{
  ...
  bool isARTS_40843020; // w21
  const MethodInfo *v7; // x1
  const MethodInfo *v9; // x1
  bool isBUSTER_40843120; // w21
  ...
  isARTS_40843020 = BattleCommand__isARTS_40843020(beforeTypeRawValue, *(const MethodInfo **)&afterTypeRawValue);
  if ( BattleCommand_TypeInfo->_2.cctor_finished )
  {
    if ( isARTS_40843020 )
      goto LABEL_7;
  ...
  else
  {
    ...
    {
LABEL_7:
      if ( BattleCommand__isBUSTER_40843120(afterTypeRawValue, v5) )
        return 1;
      if ( !BattleCommand_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(BattleCommand_TypeInfo);
      if ( BattleCommand__isQUICK_40843220(afterTypeRawValue, v7) )
        return 2;
      return 0;
    }
  }
  isBUSTER_40843120 = BattleCommand__isBUSTER_40843120(beforeTypeRawValue, v5);
  if ( BattleCommand_TypeInfo->_2.cctor_finished )
  {
    if ( isBUSTER_40843120 )
      goto LABEL_12;
  }
  else
  {
    ...
    {
LABEL_12:
      if ( BattleCommand__isARTS_40843020(afterTypeRawValue, v9) )
        return 3;
      if ( !BattleCommand_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(BattleCommand_TypeInfo);
      if ( BattleCommand__isQUICK_40843220(afterTypeRawValue, v11) )
        return 4;
      return 0;
    }
  }
  if ( BattleCommand__isQUICK_40843220(beforeTypeRawValue, v9) )
  {
    if ( !BattleCommand_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(BattleCommand_TypeInfo);
    if ( BattleCommand__isARTS_40843020(afterTypeRawValue, v12) )
      return 5;
    if ( !BattleCommand_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(BattleCommand_TypeInfo);
    if ( BattleCommand__isBUSTER_40843120(afterTypeRawValue, v13) )
      return 6;
  }
  return 0;
}
...
float BattleCommand__getCriticalMagnification(BattleCommandData_o *data, const MethodInfo *method)
{
  ...
  if ( (byte_4CED455 & 1) == 0 )
  {
    data = (BattleCommandData_o *)sub_1C7BAE8(&BattleCommand_TypeInfo);
    byte_4CED455 = 1;
  }
  if ( !v2 )
...
float BattleCommand__getCriticalMagnification_40843000(int32_t type, int32_t index, const MethodInfo *method)
{
...
float BattleCommand__getMagnification_40842736(int32_t type, int32_t index, const MethodInfo *method)
{
...
float BattleCommand__getNpMagnification(BattleCommandData_o *command, const MethodInfo *method)
{
  ...
  if ( (byte_4CED454 & 1) == 0 )
  {
    command = (BattleCommandData_o *)sub_1C7BAE8(&BattleCommand_TypeInfo);
    byte_4CED454 = 1;
  }
  if ( !v2 )
    sub_1C7BD40(command, method);
  CommandType = BattleCommandData__getCommandType(v2, 0);
  actionIndex = v2->fields.actionIndex;
  v5 = CommandType;
  if ( !BattleCommand_TypeInfo->_2.cctor_finished )
...
float BattleCommand__getNpMagnification_40842868(int32_t type, int32_t index, const MethodInfo *method)
{
...
bool BattleCommand__isARTS_40843020(int32_t type, const MethodInfo *method)
{
  if ( (byte_4CED456 & 1) == 0 )
  {
    sub_1C7BAE8(&BattleCommand_TypeInfo);
...
bool BattleCommand__isBUSTER_40843120(int32_t type, const MethodInfo *method)
{
  if ( (byte_4CED457 & 1) == 0 )
  {
    sub_1C7BAE8(&BattleCommand_TypeInfo);
...
bool BattleCommand__isQUICK_40843220(int32_t type, const MethodInfo *method)
{
  if ( (byte_4CED458 & 1) == 0 )
  {
    sub_1C7BAE8(&BattleCommand_TypeInfo);
...
void BattleCommand__setSprite(UISprite_o *sprite, int32_t type, const MethodInfo *method)
{
  ...
  if ( (byte_4CED45A & 1) == 0 )
  {
    sub_1C7BAE8(&StringLiteral_20336/*"icon_commandcard_quick"*/);
    sub_1C7BAE8(&StringLiteral_20334/*"icon_commandcard_buster"*/);
    sprite = (UISprite_o *)sub_1C7BAE8(&StringLiteral_20333/*"icon_commandcard_arts"*/);
    byte_4CED45A = 1;
  }
  switch ( type )
  {
    case 3:
      if ( v4 )
      {
        ...
        v5 = &StringLiteral_20336/*"icon_commandcard_quick"*/;
        goto LABEL_12;
      }
      goto LABEL_15;
    case 2:
      ...
      {
        UnityEngine_Behaviour__set_enabled(v4, 1, 0);
        v5 = &StringLiteral_20334/*"icon_commandcard_buster"*/;
        goto LABEL_12;
      }
LABEL_15:
      sub_1C7BD40(sprite, *(_QWORD *)&type);
    case 1:
      if ( v4 )
      {
        UnityEngine_Behaviour__set_enabled(v4, 1, 0);
        v5 = &StringLiteral_20333/*"icon_commandcard_arts"*/;
LABEL_12:
