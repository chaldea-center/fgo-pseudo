void __fastcall ComponentPool_SubmarineEffectSelectedPanelComponent____ctor(
        ...
        int32_t poolSizeMax,
        const MethodInfo_248E120 *method)
{
  ...
  if ( (BYTE2(_1_System_Collections_Generic_List_T->vtable[0].methodPtr) & 1) == 0 )
    sub_AEB684(method->klass->rgctx_data->_1_System_Collections_Generic_List_T_);
  v15 = (struct System_Collections_Generic_List_T__o *)sub_B52A54(_1_System_Collections_Generic_List_T);
  method->klass->rgctx_data->_2_System_Collections_Generic_List_T___ctor->methodPointer();
  this->fields.availableComponentList = v15;
  sub_B52920((BattleServantConfConponent_o *)&this->fields, (System_Int32_array **)v15, v16, v17, v18, v19, v20, v21);
