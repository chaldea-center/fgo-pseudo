void __fastcall ComponentPool_SubmarineEffectSelectedPanelComponent____ctor(
        ...
        int32_t poolSizeMax,
        const MethodInfo_24A5FAC *method)
{
  ...
  if ( (BYTE2(_1_System_Collections_Generic_List_T->vtable[0].methodPtr) & 1) == 0 )
    sub_AF52C4(method->klass->rgctx_data->_1_System_Collections_Generic_List_T_);
  v15 = (struct System_Collections_Generic_List_T__o *)sub_B5D694(_1_System_Collections_Generic_List_T);
