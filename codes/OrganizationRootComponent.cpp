...
void __fastcall OrganizationRootComponent__BackBuyQpItem(OrganizationRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA105 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_OrganizationRootComponent_OnMoveEnd__, v3);
    byte_49FA105 = 1;
  }
  if ( this->fields.state == 5 )
  {
    ...
    sub_1B64814(&topListViewManager->fields.callbackFunc2);
    OrganizationTopListViewManager__SetMode_31399284(topListViewManager, 5, v8);
    this->fields.state = 6;
  }
}
  ...
  if ( !this->fields.state )
  {
    ...
    if ( !v6
      || (v6->fields.callbackFunc2 = v7,
          sub_1B64814(&v6->fields.callbackFunc2),
          OrganizationTopListViewManager__SetMode_31399284(v6, 2, v8),
          (topListViewManager = (UnityEngine_Component_o *)this->fields.titleInfo) == 0LL) )
    {
LABEL_11:
      sub_1B64ACC(topListViewManager, method);
    }
    TitleInfoControl__changeTitleInfo_36883740((TitleInfoControl_o *)topListViewManager, 0, 37, 0, 0LL);
    this->fields.state = 1;
  }
}
...
void __fastcall OrganizationRootComponent__OnMoveEnd(OrganizationRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA107 & 1) == 0 )
  {
    sub_1B64870(&OrganizationTopListViewManager_CallbackFunc_TypeInfo, method);
    sub_1B64870(&LocalizationManager_TypeInfo, v3);
    sub_1B64870(&Method_OrganizationRootComponent_OnSelectTop__, v4);
    sub_1B64870(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v5);
    sub_1B64870(&TutorialFlag_TypeInfo, v6);
    sub_1B64870(&StringLiteral_13438/*"TUTORIAL_MESSAGE_SHOP1"*/, v7);
    byte_49FA107 = 1;
  }
  switch ( this->fields.state )
  {
    case 1:
      this->fields.state = 2;
      topListViewManager = this->fields.topListViewManager;
      v9 = (OrganizationTopListViewManager_CallbackFunc_o *)sub_1B64ABC(OrganizationTopListViewManager_CallbackFunc_TypeInfo);
      ...
      sub_1B64814(&topListViewManager->fields.callbackFunc);
      OrganizationTopListViewManager__SetMode_31399284(topListViewManager, 1, v13);
      ...
      v11 = LocalizationManager__Get((System_String_o *)StringLiteral_13438/*"TUTORIAL_MESSAGE_SHOP1"*/, 0LL);
      if ( !Instance )
LABEL_19:
        sub_1B64ACC(v11, v12);
...
LABEL_15:
    ...
    case 7:
      ...
      v17 = (OrganizationTopListViewManager_CallbackFunc_o *)sub_1B64ABC(OrganizationTopListViewManager_CallbackFunc_TypeInfo);
      OrganizationTopListViewManager_CallbackFunc___ctor(
        v17,
        (Il2CppObject *)this,
        (intptr_t)Method_OrganizationRootComponent_OnSelectTop__,
      ...
      sub_1B64814(&v16->fields.callbackFunc);
      OrganizationTopListViewManager__SetMode_31399284(v16, 1, v19);
      break;
    default:
      return;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA109 & 1) == 0 )
  {
    sub_1B64870(&Method_OrganizationRootComponent_OnSelectTop__, result);
    byte_49FA109 = 1;
  }
  if ( result )
  {
    ...
    if ( (*((_BYTE *)Method_OrganizationRootComponent_OnSelectTop__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B64888(Method_OrganizationRootComponent_OnSelectTop__);
        ...
        const MethodInfo *method)
{
  ...
  if ( this->fields.state == 2 )
  {
    ...
    topListViewManager->fields.callbackFunc2 = v5;
    sub_1B64814(&topListViewManager->fields.callbackFunc2);
    OrganizationTopListViewManager__SetMode_31399284(topListViewManager, 3, v8);
    this->fields.state = 8;
  }
}
