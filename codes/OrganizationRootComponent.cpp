...
void OrganizationRootComponent__BackBuyQpItem(OrganizationRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596BD5E & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_OrganizationRootComponent_OnMoveEnd__);
    byte_596BD5E = 1;
  }
  if ( this->fields.state == 5 )
  {
    ...
    sub_2213A04(
      ...
      v11,
      v12);
    OrganizationTopListViewManager__SetMode_40678756(topListViewManager, 5, v13);
    this->fields.state = 6;
  }
}
    ...
    if ( !v5
      || (v5->fields.callbackFunc2 = v6,
          sub_2213A04(
            ...
            v11,
            v12),
          OrganizationTopListViewManager__SetMode_40678756(v5, 2, v13),
          (topListViewManager = (UnityEngine_Component_o *)this->fields.titleInfo) == 0) )
    {
LABEL_11:
      sub_2213CDC(topListViewManager, method);
    }
    TitleInfoControl__changeTitleInfo_46863248((TitleInfoControl_o *)topListViewManager, 0, 41, 0, 0);
    this->fields.state = 1;
  }
}
...
void OrganizationRootComponent__OnMoveEnd(OrganizationRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596BD60 & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_OrganizationRootComponent_OnSelectTop__);
    sub_2213A60(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_2213A60(&TutorialFlag_TypeInfo);
    sub_2213A60(&StringLiteral_14154/*"TUTORIAL_MESSAGE_SHOP1"*/);
    byte_596BD60 = 1;
  }
  state = this->fields.state;
  if ( state > 3 )
  {
    switch ( state )
    {
      ...
      case 7:
        topListViewManager = this->fields.topListViewManager;
        this->fields.state = 2;
        v5 = (OrganizationTopListViewManager_CallbackFunc_o *)sub_2213CCC(OrganizationTopListViewManager_CallbackFunc_TypeInfo);
        ...
        if ( topListViewManager )
        {
          ...
          sub_2213A04(
            ...
            v13,
            v14);
          OrganizationTopListViewManager__SetMode_40678756(topListViewManager, 1, v15);
          return;
        }
LABEL_24:
        sub_2213CDC(v7, v8);
...
LABEL_14:
  ...
  this->fields.state = 2;
  v18 = (OrganizationTopListViewManager_CallbackFunc_o *)sub_2213CCC(OrganizationTopListViewManager_CallbackFunc_TypeInfo);
  OrganizationTopListViewManager_CallbackFunc___ctor(
    v18,
    (Il2CppObject *)this,
    (intptr_t)Method_OrganizationRootComponent_OnSelectTop__,
  ...
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&v17->fields.callbackFunc, (int32_t)v18, v20, v21, v22, v23, v24, v25);
  OrganizationTopListViewManager__SetMode_40678756(v17, 1, v26);
  ...
  if ( !TutorialFlag__Get_47388504(103, 0) )
  {
    ...
    v7 = LocalizationManager__Get((System_String_o *)StringLiteral_14154/*"TUTORIAL_MESSAGE_SHOP1"*/, 0);
    if ( !Instance )
      goto LABEL_24;
        ...
        const MethodInfo *method)
{
  ...
  if ( result )
  {
    ...
    if ( (*((_BYTE *)Method_OrganizationRootComponent_OnSelectTop__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_2213A78(Method_OrganizationRootComponent_OnSelectTop__);
...
void OrganizationRootComponent__SelectBuyManaItem(OrganizationRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.state == 2 )
  {
    ...
    sub_2213A04(
      ...
      v11,
      v12);
    OrganizationTopListViewManager__SetMode_40678756(topListViewManager, 3, v13);
    this->fields.state = 8;
  }
}
