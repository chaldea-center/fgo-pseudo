        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C28DB3 & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_18519/*"deckInfo"*/);
    sub_1C2D490(&StringLiteral_19884/*"grandSvtInfo"*/);
    sub_1C2D490(&StringLiteral_22840/*"questId"*/);
    this = (EventDeckSetupRequest_o *)sub_1C2D490(&StringLiteral_23050/*"restartWave"*/);
    byte_4C28DB3 = 1;
  }
  if ( !userEventDeck )
    goto LABEL_10;
  ...
  RequestBase__addField(v13, (System_String_o *)StringLiteral_23050/*"restartWave"*/, restartWave, 0);
  RequestBase__addField(v13, (System_String_o *)StringLiteral_19133/*"eventId"*/, eventId, 0);
  RequestBase__addField(v13, (System_String_o *)StringLiteral_22840/*"questId"*/, questId, 0);
  RequestBase__addField(v13, (System_String_o *)StringLiteral_22660/*"phase"*/, phase, 0);
  v15 = (MiniMessagePack_MiniMessagePacker_o *)sub_1C2D6DC(MiniMessagePack_MiniMessagePacker_TypeInfo);
  MiniMessagePack_MiniMessagePacker___ctor(v15, 0);
  if ( !v15 )
LABEL_10:
    sub_1C2D6EC(this, userEventDeck);
  ...
  RequestBase__addField_44009064(v13, (System_String_o *)StringLiteral_18519/*"deckInfo"*/, v17, 0);
  v18 = MiniMessagePack_MiniMessagePacker__PackClass(v15, &grandSvtInfos->obj, 0);
  v19 = System_Convert__ToBase64String(v18, 0);
  RequestBase__addField_44009064(v13, (System_String_o *)StringLiteral_19884/*"grandSvtInfo"*/, v19, 0);
...
System_String_o *EventDeckSetupRequest__getURL(EventDeckSetupRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C28DB1 & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_19130/*"eventDeck/setup"*/);
    byte_4C28DB1 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63457864(BaseUrl, (System_String_o *)StringLiteral_19130/*"eventDeck/setup"*/, 0);
}
