        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E0650D & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_23036/*"phase"*/);
    sub_1CE6700(&StringLiteral_18743/*"deckInfo"*/);
    sub_1CE6700(&StringLiteral_20176/*"grandSvtInfo"*/);
    sub_1CE6700(&StringLiteral_23225/*"questId"*/);
    this = (EventDeckSetupRequest_o *)sub_1CE6700(&StringLiteral_23440/*"restartWave"*/);
    byte_4E0650D = 1;
  }
  if ( !userEventDeck )
    goto LABEL_10;
  ...
  RequestBase__addField(v13, (System_String_o *)StringLiteral_23440/*"restartWave"*/, restartWave, 0);
  RequestBase__addField(v13, (System_String_o *)StringLiteral_19400/*"eventId"*/, eventId, 0);
  RequestBase__addField(v13, (System_String_o *)StringLiteral_23225/*"questId"*/, questId, 0);
  RequestBase__addField(v13, (System_String_o *)StringLiteral_23036/*"phase"*/, phase, 0);
  v15 = (MiniMessagePack_MiniMessagePacker_o *)sub_1CE694C(MiniMessagePack_MiniMessagePacker_TypeInfo);
  MiniMessagePack_MiniMessagePacker___ctor(v15, 0);
  if ( !v15 )
LABEL_10:
    sub_1CE6958(this, userEventDeck);
  ...
  RequestBase__addField_45365032(v13, (System_String_o *)StringLiteral_18743/*"deckInfo"*/, v17, 0);
  v18 = MiniMessagePack_MiniMessagePacker__PackClass(v15, &grandSvtInfos->obj, 0);
  v19 = System_Convert__ToBase64String(v18, 0);
  RequestBase__addField_45365032(v13, (System_String_o *)StringLiteral_20176/*"grandSvtInfo"*/, v19, 0);
...
System_String_o *EventDeckSetupRequest__getURL(EventDeckSetupRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E0650B & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_19397/*"eventDeck/setup"*/);
    byte_4E0650B = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_65122828(BaseUrl, (System_String_o *)StringLiteral_19397/*"eventDeck/setup"*/, 0);
}
