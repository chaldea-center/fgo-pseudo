        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D324C4 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_22958/*"phase"*/);
    sub_1C93AD4(&StringLiteral_18683/*"deckInfo"*/);
    sub_1C93AD4(&StringLiteral_20110/*"grandSvtInfo"*/);
    sub_1C93AD4(&StringLiteral_23146/*"questId"*/);
    this = (EventDeckSetupRequest_o *)sub_1C93AD4(&StringLiteral_23359/*"restartWave"*/);
    byte_4D324C4 = 1;
  }
  if ( !userEventDeck )
    goto LABEL_10;
  ...
  RequestBase__addField(v13, (System_String_o *)StringLiteral_23359/*"restartWave"*/, restartWave, 0);
  RequestBase__addField(v13, (System_String_o *)StringLiteral_19339/*"eventId"*/, eventId, 0);
  RequestBase__addField(v13, (System_String_o *)StringLiteral_23146/*"questId"*/, questId, 0);
  RequestBase__addField(v13, (System_String_o *)StringLiteral_22958/*"phase"*/, phase, 0);
  v15 = (MiniMessagePack_MiniMessagePacker_o *)sub_1C93D20(MiniMessagePack_MiniMessagePacker_TypeInfo);
  MiniMessagePack_MiniMessagePacker___ctor(v15, 0);
  if ( !v15 )
LABEL_10:
    sub_1C93D2C(this, userEventDeck);
  ...
  RequestBase__addField_44907496(v13, (System_String_o *)StringLiteral_18683/*"deckInfo"*/, v17, 0);
  v18 = MiniMessagePack_MiniMessagePacker__PackClass(v15, &grandSvtInfos->obj, 0);
  v19 = System_Convert__ToBase64String(v18, 0);
  RequestBase__addField_44907496(v13, (System_String_o *)StringLiteral_20110/*"grandSvtInfo"*/, v19, 0);
...
System_String_o *EventDeckSetupRequest__getURL(EventDeckSetupRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D324C2 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_19336/*"eventDeck/setup"*/);
    byte_4D324C2 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64425724(BaseUrl, (System_String_o *)StringLiteral_19336/*"eventDeck/setup"*/, 0);
}
