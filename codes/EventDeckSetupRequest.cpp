        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB5FF0 & 1) == 0 )
  {
    sub_1C13D24(&System_Convert_TypeInfo, userEventDeck);
    sub_1C13D24(&JsonManager_TypeInfo, v13);
    sub_1C13D24(&MiniMessagePack_MiniMessagePacker_TypeInfo, v14);
    sub_1C13D24(&StringLiteral_19431/*"event/location"*/, v15);
    sub_1C13D24(&StringLiteral_22888/*"paymentsave.dat"*/, v16);
    sub_1C13D24(&StringLiteral_18807/*"debug_add_servant"*/, v17);
    sub_1C13D24(&StringLiteral_23064/*"q"*/, v18);
    this = (EventDeckSetupRequest_o *)sub_1C13D24(&StringLiteral_23278/*"requestApItem Param: {0}, {1}, {2}"*/, v19);
    byte_4BB5FF0 = 1;
  }
  if ( !userEventDeck )
    goto LABEL_10;
  ...
  RequestBase__addField(v12, (System_String_o *)StringLiteral_23278/*"requestApItem Param: {0}, {1}, {2}"*/, restartWave, v21);
  RequestBase__addField(v12, (System_String_o *)StringLiteral_19431/*"event/location"*/, eventId, v22);
  RequestBase__addField(v12, (System_String_o *)StringLiteral_23064/*"q"*/, questId, v23);
  RequestBase__addField(v12, (System_String_o *)StringLiteral_22888/*"paymentsave.dat"*/, phase, v24);
  v25 = (MiniMessagePack_MiniMessagePacker_o *)sub_1C13F70(MiniMessagePack_MiniMessagePacker_TypeInfo);
  MiniMessagePack_MiniMessagePacker___ctor(v25, 0LL);
  if ( !v25 )
LABEL_10:
    sub_1C13F80(this, userEventDeck);
  ...
  RequestBase__addField_42303556(v12, (System_String_o *)StringLiteral_18807/*"debug_add_servant"*/, v27, v28);
...
System_String_o *__fastcall EventDeckSetupRequest__getURL(EventDeckSetupRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB5FEE & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_19428/*"event/expeditionFinish"*/, v2);
    byte_4BB5FEE = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62967944(BaseUrl, (System_String_o *)StringLiteral_19428/*"event/expeditionFinish"*/, 0LL);
}
