void __fastcall ExUISpriteRenderer___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FB8DC & 1) == 0 )
  {
    sub_1B640C8(&ExUISpriteRenderer_TypeInfo, v1);
    byte_49FB8DC = 1;
  }
  *ExUISpriteRenderer_TypeInfo->static_fields = (struct ExUISpriteRenderer_StaticFields)xmmword_BA3650;
}
...
void __fastcall ExUISpriteRenderer__ClearImage(ExUISpriteRenderer_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FB8D3 & 1) == 0 )
  {
    ...
    sub_1B640C8(&StringLiteral_16284/*"_SubTex"*/, v3);
    byte_49FB8D3 = 1;
  }
...
LABEL_8:
  ...
  if ( assetData )
  {
    ...
    sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.assetData, 0, v6, v7);
  }
  ...
  if ( loadAssetName )
  {
    ...
    sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.loadAssetName, 0, v9, v10);
    callbackFunc = this->fields.callbackFunc;
    this->fields.callbackFunc = 0LL;
    sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.callbackFunc, 0, v12, v13);
    if ( callbackFunc )
...
void __fastcall ExUISpriteRenderer__EndLoad(ExUISpriteRenderer_o *this, AssetData_o *data, const MethodInfo *method)
{
  ...
  if ( (byte_49FB8D8 & 1) == 0 )
  {
    sub_1B640C8(&AssetManager_TypeInfo, data);
    byte_49FB8D8 = 1;
  }
  if ( data )
  {
    ...
    if ( loadAssetName )
    {
      if ( !AssetManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
      if ( AssetManager__compAssetStorage_37475140(data, loadAssetName, 0LL) )
      {
        assetData = this->fields.assetData;
        this->fields.loadAssetName = 0LL;
        sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.loadAssetName, 0, v6, v7);
        this->fields.assetData = data;
        sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.assetData, (int32_t)data, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  __int64 v29; // x1
  __int64 v30; // x2
  struct System_Action_o **v31; // x22
  ...
  if ( (byte_49FB8D7 & 1) == 0 )
  {
    sub_1B640C8(&System_Action_TypeInfo, assetName);
    sub_1B640C8(&AssetManager_TypeInfo, v11);
    sub_1B640C8(&Method_ExUISpriteRenderer_EndLoad__, v12);
...
LABEL_25:
      ...
      sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.callbackFunc, (int32_t)v20, v21, v22);
      return;
    }
    v28 = *p_loadAssetName;
    if ( !AssetManager_TypeInfo->_2.cctor_finished )
  ...
  else
  {
    ...
    if ( assetData )
    {
      if ( !AssetManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
      if ( AssetManager__compAssetStorage_37475140(assetData, assetName, 0LL) )
      {
  ...
  *p_loadAssetName = assetName;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.loadAssetName, (int32_t)assetName, v14, v15);
  if ( callback )
  {
    v31 = &this->fields.callbackFunc;
    v32 = System_Delegate__Combine((System_Delegate_o *)this->fields.callbackFunc, (System_Delegate_o *)callback, 0LL);
    v23 = v32;
    if ( v32 )
    {
    ...
    sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.callbackFunc, (int32_t)v32, v33, v34);
  }
  v36 = (AssetLoader_LoadEndDataHandler_o *)sub_1B64314(AssetLoader_LoadEndDataHandler_TypeInfo, v29, v30);
  AssetLoader_LoadEndDataHandler___ctor(v36, (Il2CppObject *)this, Method_ExUISpriteRenderer_EndLoad__, 0LL);
  if ( !AssetManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
  AssetManager__loadAssetStorage(assetName, v36, 1, 0LL);
}
...
void __fastcall ExUISpriteRenderer__OnStart(ExUISpriteRenderer_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FB8D2 & 1) == 0 )
  {
    sub_1B640C8(&Method_UnityEngine_Component_GetComponent_SpriteRenderer___, method);
  ...
  if ( UnityEngine_Object__op_Equality(spriteRenderer, 0LL, 0LL) )
  {
    Component_object = UnityEngine_Component__GetComponent_object_(
                         ...
                         (const MethodInfo_2E2FE90 *)Method_UnityEngine_Component_GetComponent_SpriteRenderer___);
    this->fields.spriteRenderer = (struct UnityEngine_SpriteRenderer_o *)Component_object;
    sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.spriteRenderer, (int32_t)Component_object, v6, v7);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB8D5 & 1) == 0 )
  {
    sub_1B640C8(&CommonUI_TypeInfo, assetName);
    sub_1B640C8(&ExUISpriteRenderer_TypeInfo, v5);
...
LABEL_61:
  ...
  v46.fields.y = (float)(v41 * (float)(mHeight - BACK_HEIGHT_16_9)) / (float)(BACK_HEIGHT_21_9 - BACK_HEIGHT_16_9);
  v46.fields.x = x;
  v46.fields.z = z;
...
void __fastcall ExUISpriteRenderer__SetAssetImage_37805544(
        ExUISpriteRenderer_o *this,
        System_String_o *assetName,
        System_String_o *assetLabel,
        System_Action_o *callback,
...
void __fastcall ExUISpriteRenderer__SetAssetTexture(ExUISpriteRenderer_o *this, const MethodInfo *method)
{
  ...
  int v15; // w22
  int v16; // w0
  UnityEngine_SpriteRenderer_o *v17; // x21
  float v18; // s9
  ...
  if ( (byte_49FB8DA & 1) == 0 )
  {
    ...
    sub_1B640C8(&StringLiteral_16551/*"a"*/, v4);
    sub_1B640C8(&StringLiteral_16284/*"_SubTex"*/, v5);
    byte_49FB8DA = 1;
  }
  if ( this->fields.isTextureAlphaImage )
  {
  ...
  {
    assetData = this->fields.assetData;
    spriteRenderer = (UnityEngine_Renderer_o *)System_String__Concat_61375396(
                                                 this->fields.assetLabel,
                                                 (System_String_o *)StringLiteral_16551/*"a"*/,
                                                 0LL);
    if ( assetData )
    {
      spriteRenderer = (UnityEngine_Renderer_o *)AssetData__GetObject_object__48347676(
                                                   assetData,
      ...
      if ( this->fields.spriteRenderer )
      {
        ...
        if ( spriteRenderer )
        {
          ...
          if ( v13 )
          {
            UnityEngine_Material__SetTexture(v13, (System_String_o *)StringLiteral_16284/*"_SubTex"*/, v9, 0LL);
            spriteRenderer = (UnityEngine_Renderer_o *)this->fields.spriteRenderer;
            if ( spriteRenderer )
            {
...
LABEL_14:
  ...
  v17 = this->fields.spriteRenderer;
  v18 = (float)v16;
  pivotOffset = UIWidget__get_pivotOffset((UIWidget_o *)this, 0LL);
  v31.fields.m_XMin = 0.0;
  v31.fields.m_YMin = 0.0;
  v31.fields.m_Width = (float)v15;
  v31.fields.m_Height = v18;
  spriteRenderer = (UnityEngine_Renderer_o *)UnityEngine_Sprite__Create_69158420(v14, v31, pivotOffset, 1.0, 0LL);
  if ( !v17 )
    goto LABEL_19;
  UnityEngine_SpriteRenderer__set_sprite(v17, (UnityEngine_Sprite_o *)spriteRenderer, 0LL);
  ExUISpriteRenderer__InitBaseScale(this, v19);
  x = this->fields.baseScale.fields.x;
  mWidth = this->fields.mWidth;
  v22 = ((__int64 (__fastcall *)(UnityEngine_Texture2D_o *, Il2CppMethodPointer))v14->klass->vtable._4_get_width.method)(
          v14,
  ...
  if ( !spriteRenderer )
    goto LABEL_19;
  v30.fields.y = (float)(y * (float)mHeight) / (float)v28;
  v30.fields.x = (float)(x * (float)mWidth) / (float)v25;
  v30.fields.z = v27;
  UnityEngine_Transform__set_localScale((UnityEngine_Transform_o *)spriteRenderer, v30, 0LL);
  *(_QWORD *)&this->fields.oldWidth = *(_QWORD *)&this->fields.mWidth;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB8D4 & 1) == 0 )
  {
    sub_1B640C8(&AssetManager_TypeInfo, tex);
    byte_49FB8D4 = 1;
  }
  assetData = this->fields.assetData;
  if ( assetData )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB8D6 & 1) == 0 )
  {
    sub_1B640C8(&ExUISpriteRenderer_TypeInfo, assetName);
    sub_1B640C8(&FSUtility_TypeInfo, v7);
    sub_1B640C8(&ManagerConfig_TypeInfo, v8);
    sub_1B640C8(&Method_SingletonMonoBehaviour_ScriptManager__get_Instance__, v9);
    byte_49FB8D6 = 1;
  }
  ...
  if ( FSUtility__IsFullScreenBack(assetName, 0LL) )
  {
    ...
    if ( sceneMode == 1 )
    {
      ...
      v18 = (float)v14->static_fields->WIDTH_21_9 / (float)v14->static_fields->HEIGHT;
      ...
      GameObjectExtensions__SetLocalScaleX(v19, LocalScaleX * (float)(v17 / v18), 0LL);
      ...
      GameObjectExtensions__SetLocalScaleY(v22, (float)(v17 / v18) * LocalScaleY, 0LL);
            ...
            if ( Instance )
            {
              ...
              if ( Instance )
              {
                if ( v26 == INFINITY )
                  ...
                  v28 = 2 * (int)v26;
                UIWidget__set_height((UIWidget_o *)Instance, v28, 0LL);
                if ( !FSUtility_TypeInfo->_2.cctor_finished )
                  j_il2cpp_runtime_class_init_0(FSUtility_TypeInfo);
                if ( !FSUtility__IsTablet(0LL) )
                {
                  ...
                  if ( !Instance )
                    goto LABEL_40;
                  v29 = (UIWidget_o *)*((_QWORD *)Instance + 74);
                  Instance = (void *)UnityEngine_Screen__get_width(0LL);
                  if ( !v29 )
                    goto LABEL_40;
                  UIWidget__set_width(v29, (int32_t)Instance, 0LL);
                }
                Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EC03C *)Method_SingletonMonoBehaviour_ScriptManager__get_Instance__);
                if ( Instance )
                {
                  ...
                  if ( Instance )
                  {
                    v30 = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)Instance, 0LL);
                    ...
                    v33 = v31->static_fields->HEIGHT;
                    if ( v33 <= 0 )
                      v34 = -v33;
                    else
                      v34 = 1 - v33;
                    GameObjectExtensions__SetLocalPositionY(v32, v26 + (float)(v34 >> 1), 0LL);
                    return;
                  }
                }
              }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB8D9 & 1) == 0 )
  {
    this = (ExUISpriteRenderer_o *)sub_1B640C8(&StringLiteral_16284/*"_SubTex"*/, tex);
    byte_49FB8D9 = 1;
  }
...
LABEL_11:
    ...
    UnityEngine_Material__SetTexture((UnityEngine_Material_o *)this, (System_String_o *)StringLiteral_16284/*"_SubTex"*/, 0LL, 0LL);
  }
  ...
  this = (ExUISpriteRenderer_o *)UnityEngine_Sprite__Create_69158420(tex, v21, pivotOffset, 1.0, 0LL);
  if ( !spriteRenderer )
    goto LABEL_11;
