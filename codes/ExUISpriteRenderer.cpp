void __fastcall ExUISpriteRenderer___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BFCBBD & 1) == 0 )
  {
    sub_1C2E12C(&ExUISpriteRenderer_TypeInfo, v1);
    byte_4BFCBBD = 1;
  }
  *ExUISpriteRenderer_TypeInfo->static_fields = (struct ExUISpriteRenderer_StaticFields)xmmword_C069E0;
}
...
void __fastcall ExUISpriteRenderer__ClearImage(ExUISpriteRenderer_o *this, const MethodInfo *method)
{
  ...
  {
LABEL_18:
    sub_1C2E388(spriteRenderer, method);
  }
...
LABEL_8:
  ...
  if ( assetData )
  {
    ...
    AssetManager__releaseAsset_39104116(assetData, 0LL);
    this->fields.assetData = 0LL;
    sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.assetData, 0LL, v6, v7, v8, v9, v10, v11);
  }
  ...
  if ( loadAssetName )
  {
    ...
    sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.loadAssetName, 0LL, v13, v14, v15, v16, v17, v18);
    callbackFunc = this->fields.callbackFunc;
    this->fields.callbackFunc = 0LL;
    sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.callbackFunc, 0LL, v20, v21, v22, v23, v24, v25);
    if ( callbackFunc )
...
void __fastcall ExUISpriteRenderer__EndLoad(ExUISpriteRenderer_o *this, AssetData_o *data, const MethodInfo *method)
{
  ...
  if ( (byte_4BFCBB9 & 1) == 0 )
  {
    sub_1C2E12C(&AssetManager_TypeInfo, data);
    byte_4BFCBB9 = 1;
  }
  if ( data )
  {
    ...
    if ( loadAssetName )
    {
      if ( !AssetManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
      if ( AssetManager__compAssetStorage_39101792(data, loadAssetName, 0LL) )
      {
        assetData = this->fields.assetData;
        this->fields.loadAssetName = 0LL;
        sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.loadAssetName, 0LL, v6, v7, v8, v9, v10, v11);
        this->fields.assetData = data;
        sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.assetData, (int64_t)data, v13, v14, v15, v16, v17, v18);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFCBB8 & 1) == 0 )
  {
    sub_1C2E12C(&System_Action_TypeInfo, assetName);
    sub_1C2E12C(&AssetManager_TypeInfo, v13);
    sub_1C2E12C(&Method_ExUISpriteRenderer_EndLoad__, v14);
    sub_1C2E12C(&AssetLoader_LoadEndDataHandler_TypeInfo, v15);
    byte_4BFCBB8 = 1;
  }
...
LABEL_25:
      ...
      sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.callbackFunc, (int64_t)v26, v27, v28, v29, v30, v31, v32);
      return;
    }
    v38 = *p_loadAssetName;
    if ( !AssetManager_TypeInfo->_2.cctor_finished )
  ...
  else
  {
    ...
    if ( assetData )
    {
      if ( !AssetManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
      if ( AssetManager__compAssetStorage_39101792(assetData, assetName, 0LL) )
      {
  ...
  *p_loadAssetName = assetName;
  ...
  if ( callback )
  {
    ...
    sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.callbackFunc, (int64_t)v40, v41, v42, v43, v44, v45, v46);
  }
  v48 = (AssetLoader_LoadEndDataHandler_o *)sub_1C2E378(AssetLoader_LoadEndDataHandler_TypeInfo);
...
void __fastcall ExUISpriteRenderer__OnStart(ExUISpriteRenderer_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFCBB3 & 1) == 0 )
  {
    sub_1C2E12C(&Method_UnityEngine_Component_GetComponent_SpriteRenderer___, method);
  ...
  if ( UnityEngine_Object__op_Equality(spriteRenderer, 0LL, 0LL) )
  {
    Component_object = UnityEngine_Component__GetComponent_object_(
                         ...
                         (const MethodInfo_2FC82D4 *)Method_UnityEngine_Component_GetComponent_SpriteRenderer___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFCBB6 & 1) == 0 )
  {
    sub_1C2E12C(&CommonUI_TypeInfo, assetName);
    sub_1C2E12C(&ExUISpriteRenderer_TypeInfo, v5);
...
void __fastcall ExUISpriteRenderer__SetAssetImage_39432440(
        ExUISpriteRenderer_o *this,
        System_String_o *assetName,
        System_String_o *assetLabel,
        System_Action_o *callback,
...
void __fastcall ExUISpriteRenderer__SetAssetTexture(ExUISpriteRenderer_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFCBBB & 1) == 0 )
  {
    ...
    sub_1C2E12C(&StringLiteral_16912/*"a"*/, v4);
    sub_1C2E12C(&StringLiteral_16643/*"_SubTex"*/, v5);
    byte_4BFCBBB = 1;
  }
  if ( this->fields.isTextureAlphaImage )
  {
  ...
  {
    assetData = this->fields.assetData;
    spriteRenderer = (UnityEngine_Renderer_o *)System_String__Concat_63235584(
                                                 this->fields.assetLabel,
                                                 (System_String_o *)StringLiteral_16912/*"a"*/,
                                                 0LL);
    if ( assetData )
    {
      spriteRenderer = (UnityEngine_Renderer_o *)AssetData__GetObject_object__50017172(
                                                   assetData,
      ...
      if ( this->fields.spriteRenderer )
      {
        ...
        if ( spriteRenderer )
        {
          ...
          v11 = (UnityEngine_Material_o *)sub_1C2E378(UnityEngine_Material_TypeInfo);
          UnityEngine_Material___ctor(v11, shader, 0LL);
          if ( v11 )
          {
            UnityEngine_Material__SetTexture(v11, (System_String_o *)StringLiteral_16643/*"_SubTex"*/, v9, 0LL);
            spriteRenderer = (UnityEngine_Renderer_o *)this->fields.spriteRenderer;
            if ( spriteRenderer )
            {
...
LABEL_14:
  ...
  spriteRenderer = (UnityEngine_Renderer_o *)UnityEngine_Sprite__Create_71020564(v12, v29, pivotOffset, 1.0, 0LL);
  if ( !v15 )
    goto LABEL_19;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFCBB5 & 1) == 0 )
  {
    sub_1C2E12C(&AssetManager_TypeInfo, tex);
    byte_4BFCBB5 = 1;
  }
  assetData = this->fields.assetData;
  if ( assetData )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFCBB7 & 1) == 0 )
  {
    sub_1C2E12C(&ExUISpriteRenderer_TypeInfo, assetName);
    sub_1C2E12C(&FSUtility_TypeInfo, v7);
    sub_1C2E12C(&ManagerConfig_TypeInfo, v8);
    sub_1C2E12C(&Method_SingletonMonoBehaviour_ScriptManager__get_Instance__, v9);
    byte_4BFCBB7 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFCBBA & 1) == 0 )
  {
    this = (ExUISpriteRenderer_o *)sub_1C2E12C(&StringLiteral_16643/*"_SubTex"*/, tex);
    byte_4BFCBBA = 1;
  }
  if ( v4->fields.isTextureAlphaImage )
  {
    ...
    {
LABEL_11:
      sub_1C2E388(this, tex);
    }
    UnityEngine_Material__SetTexture((UnityEngine_Material_o *)this, (System_String_o *)StringLiteral_16643/*"_SubTex"*/, 0LL, 0LL);
  }
  ...
  this = (ExUISpriteRenderer_o *)UnityEngine_Sprite__Create_71020564(tex, v21, pivotOffset, 1.0, 0LL);
  if ( !spriteRenderer )
    goto LABEL_11;
