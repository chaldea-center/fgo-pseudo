void ExUISpriteRenderer___cctor(const MethodInfo *method)
{
  if ( (byte_4D2BC2E & 1) == 0 )
  {
    sub_1C94098(&ExUISpriteRenderer_TypeInfo);
    byte_4D2BC2E = 1;
  }
  *ExUISpriteRenderer_TypeInfo->static_fields = (struct ExUISpriteRenderer_StaticFields)xmmword_CFF430;
}
...
void ExUISpriteRenderer__ClearImage(ExUISpriteRenderer_o *this, const MethodInfo *method)
{
  ...
  {
LABEL_18:
    sub_1C942F0(spriteRenderer, method);
  }
...
LABEL_8:
  ...
  if ( assetData )
  {
    ...
    sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.assetData, 0, v5, v6, v7, v8, v9, v10);
  }
  ...
  if ( loadAssetName )
  {
    ...
    sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.loadAssetName, 0, v12, v13, v14, v15, v16, v17);
    callbackFunc = this->fields.callbackFunc;
    this->fields.callbackFunc = 0;
    sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.callbackFunc, 0, v19, v20, v21, v22, v23, v24);
    if ( callbackFunc )
  ...
  if ( data )
  {
    ...
    if ( loadAssetName )
    {
      ...
      if ( AssetManager__compAssetStorage_41282980(data, loadAssetName, 0) )
      {
        assetData = this->fields.assetData;
        this->fields.loadAssetName = 0;
        sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.loadAssetName, 0, v6, v7, v8, v9, v10, v11);
        this->fields.assetData = data;
        sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.assetData, (int32_t)data, v13, v14, v15, v16, v17, v18);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2BC29 & 1) == 0 )
  {
    ...
    sub_1C94098(&AssetManager_TypeInfo);
    sub_1C94098(&Method_ExUISpriteRenderer_EndLoad__);
...
LABEL_25:
      ...
      sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.callbackFunc, (int32_t)v23, v24, v25, v26, v27, v28, v29);
      return;
    }
    v35 = *p_loadAssetName;
    if ( !AssetManager_TypeInfo->_2.cctor_finished )
  ...
  *p_loadAssetName = assetName;
  ...
  if ( callback )
  {
    ...
    sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.callbackFunc, (int32_t)v37, v38, v39, v40, v41, v42, v43);
  }
  v45 = (AssetLoader_LoadEndDataHandler_o *)sub_1C942E4(AssetLoader_LoadEndDataHandler_TypeInfo);
...
void ExUISpriteRenderer__SetAssetImage_41647524(
        ExUISpriteRenderer_o *this,
        System_String_o *assetName,
        System_String_o *assetLabel,
        System_Action_o *callback,
...
void ExUISpriteRenderer__SetAssetTexture(ExUISpriteRenderer_o *this, const MethodInfo *method)
{
  ...
  {
    assetData = this->fields.assetData;
    spriteRenderer = (UnityEngine_Renderer_o *)System_String__Concat_64417744(
                                                 this->fields.assetLabel,
                                                 (System_String_o *)StringLiteral_16690/*"a"*/,
                                                 0);
    if ( assetData )
    {
      spriteRenderer = (UnityEngine_Renderer_o *)AssetData__GetObject_object__51893132(
                                                   assetData,
      ...
      if ( this->fields.spriteRenderer )
      {
        ...
        if ( spriteRenderer )
        {
          ...
          if ( v8 )
          {
            UnityEngine_Material__SetTexture(v8, (System_String_o *)StringLiteral_16417/*"_SubTex"*/, v6, 0);
            spriteRenderer = (UnityEngine_Renderer_o *)this->fields.spriteRenderer;
            if ( spriteRenderer )
            {
...
LABEL_14:
  ...
  spriteRenderer = (UnityEngine_Renderer_o *)UnityEngine_Sprite__Create_72143984(v9, v26, pivotOffset, 1.0, 0);
  if ( !v12 )
    goto LABEL_19;
        ...
        const MethodInfo *method)
{
  ...
  Instance = (UnityEngine_Component_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3ABA574 *)Method_SingletonMonoBehaviour_ScriptManager__get_Instance__);
  if ( !Instance )
    goto LABEL_40;
...
void ExUISpriteRenderer__SetTexture(ExUISpriteRenderer_o *this, UnityEngine_Texture2D_o *tex, const MethodInfo *method)
{
  ...
  if ( (byte_4D2BC2B & 1) == 0 )
  {
    this = (ExUISpriteRenderer_o *)sub_1C94098(&StringLiteral_16417/*"_SubTex"*/);
    byte_4D2BC2B = 1;
  }
  if ( v4->fields.isTextureAlphaImage )
  {
    ...
    {
LABEL_11:
      sub_1C942F0(this, tex);
    }
    UnityEngine_Material__SetTexture((UnityEngine_Material_o *)this, (System_String_o *)StringLiteral_16417/*"_SubTex"*/, 0, 0);
  }
  ...
  this = (ExUISpriteRenderer_o *)UnityEngine_Sprite__Create_72143984(tex, v21, pivotOffset, 1.0, 0);
  if ( !spriteRenderer )
    goto LABEL_11;
