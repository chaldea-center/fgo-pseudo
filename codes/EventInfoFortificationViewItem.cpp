        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC9090 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataManager_GetMasterData_GiftMaster___, eventFortificationEntity);
    ...
    if ( ((unsigned __int8)Instance & 1) != 0 )
    {
      if ( LODWORD(v9->fields.m_CancellationTokenSource) )
      {
        ...
        if ( v11 )
        {
          ...
          if ( Instance )
          {
            ItemIconComponent__SetGift_39340176((ItemIconComponent_o *)Instance, v11[5], v11[6], v11[7], 0, 0LL);
            return;
          }
        }
LABEL_17:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC9091 & 1) == 0 )
  {
    sub_1C1ABD4(&int_TypeInfo, eventFortificationEntity);
    sub_1C1ABD4(&LocalizationManager_TypeInfo, v7);
    this = (EventInfoFortificationViewItem_o *)sub_1C1ABD4(&StringLiteral_6618/*"FORTIFICATION_GAUGE_BG_COLOR_{0}_{1}"*/, v8);
    byte_4BC9091 = 1;
  }
  v22 = 0uLL;
  if ( !eventFortificationEntity )
  ...
  v14 = System_String__Format_63054740((System_String_o *)StringLiteral_6618/*"FORTIFICATION_GAUGE_BG_COLOR_{0}_{1}"*/, v9, v13, 0LL);
  ...
  if ( !this )
LABEL_8:
    sub_1C1AE30(this, eventFortificationEntity);
