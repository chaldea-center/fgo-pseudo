    ...
    if ( ((unsigned __int8)Instance & 1) != 0 )
    {
      if ( LODWORD(v6->fields.m_CancellationTokenSource) )
      {
        ...
        if ( v8 )
        {
          ...
          if ( Instance )
          {
            ItemIconComponent__SetGift_40822420((ItemIconComponent_o *)Instance, v8[5], v8[6], v8[7], 0, 0);
            return;
          }
        }
LABEL_17:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C38EC4 & 1) == 0 )
  {
    ...
    this = (EventInfoFortificationViewItem_o *)sub_1C32C20(&StringLiteral_6492/*"FORTIFICATION_GAUGE_BG_COLOR_{0}_{1}"*/);
    byte_4C38EC4 = 1;
  }
  v26 = 0u;
  if ( !eventFortificationEntity )
  ...
  v18 = System_String__Format_63559836((System_String_o *)StringLiteral_6492/*"FORTIFICATION_GAUGE_BG_COLOR_{0}_{1}"*/, v10, v17, 0);
