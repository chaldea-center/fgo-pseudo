        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB5CAE & 1) == 0 )
  {
    sub_1C13D24(&Method_DataManager_GetMasterData_GiftMaster___, eventFortificationEntity);
    ...
    if ( ((unsigned __int8)Instance & 1) != 0 )
    {
      if ( LODWORD(v9->fields.m_CancellationTokenSource) )
      {
        ...
        if ( v11 )
        {
          ...
          if ( Instance )
          {
            ItemIconComponent__SetGift_39286592((ItemIconComponent_o *)Instance, v11[5], v11[6], v11[7], 0, 0LL);
            return;
          }
        }
LABEL_17:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB5CAF & 1) == 0 )
  {
    sub_1C13D24(&int_TypeInfo, eventFortificationEntity);
    sub_1C13D24(&LocalizationManager_TypeInfo, v7);
    this = (EventInfoFortificationViewItem_o *)sub_1C13D24(&StringLiteral_6615/*"FORTIFICATION_CONFIRM_DIALOG_SUB_TITLE"*/, v8);
    byte_4BB5CAF = 1;
  }
  v22 = 0uLL;
  if ( !eventFortificationEntity )
  ...
  v14 = System_String__Format_62982316((System_String_o *)StringLiteral_6615/*"FORTIFICATION_CONFIRM_DIALOG_SUB_TITLE"*/, v9, v13, 0LL);
  ...
  if ( !this )
LABEL_8:
    sub_1C13F80(this, eventFortificationEntity);
