        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1D9D5 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_GiftMaster___, eventFortificationEntity);
...
LABEL_18:
  ...
  if ( *(_QWORD *)&Instance->fields._DispLog )
  {
    ...
    if ( ((unsigned __int8)Instance & 1) != 0 )
    {
      ...
      {
        v12 = *(int32_t **)&v10->fields._DispLog;
        if ( v12 )
        {
          Instance = (DataManager_o *)this->fields.itemIcon;
          if ( Instance )
          {
            ItemIconComponent__SetGift_40107980((ItemIconComponent_o *)Instance, v12[5], v12[6], v12[7], 0, 0LL);
            return;
          }
        }
LABEL_17:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1D9D6 & 1) == 0 )
  {
    sub_1BCAFF8(&int_TypeInfo, eventFortificationEntity);
    sub_1BCAFF8(&LocalizationManager_TypeInfo, v7);
    this = (EventInfoFortificationViewItem_o *)sub_1BCAFF8(&StringLiteral_6444/*"FORTIFICATION_GAUGE_BG_COLOR_{0}_{1}"*/, v8);
    byte_4B1D9D6 = 1;
  }
  v22 = 0uLL;
  if ( !eventFortificationEntity )
  ...
  v14 = System_String__Format_62491716((System_String_o *)StringLiteral_6444/*"FORTIFICATION_GAUGE_BG_COLOR_{0}_{1}"*/, v9, v13, 0LL);
  ...
  if ( !this )
LABEL_8:
    sub_1BCB254(this, eventFortificationEntity);
