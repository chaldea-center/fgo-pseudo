    ...
    if ( ((unsigned __int8)Instance & 1) != 0 )
    {
      if ( LODWORD(v7->fields.m_CancellationTokenSource) )
      {
        ...
        if ( v9 )
        {
          ...
          if ( Instance )
          {
            ItemIconComponent__SetGift_41640856((ItemIconComponent_o *)Instance, v9[5], v9[6], v9[7], 0, 0);
            return;
          }
        }
LABEL_17:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D31DD0 & 1) == 0 )
  {
    ...
    this = (EventInfoFortificationViewItem_o *)sub_1C93AD4(&StringLiteral_6523/*"FORTIFICATION_GAUGE_BG_COLOR_{0}_{1}"*/);
    byte_4D31DD0 = 1;
  }
  v15 = 0u;
  if ( !eventFortificationEntity )
  ...
  v7 = System_String__Format_64467032((System_String_o *)StringLiteral_6523/*"FORTIFICATION_GAUGE_BG_COLOR_{0}_{1}"*/, v5, v6, 0);
  ...
  if ( !this )
LABEL_8:
    sub_1C93D2C(this, eventFortificationEntity);
