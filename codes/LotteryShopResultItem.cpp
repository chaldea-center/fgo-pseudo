        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E68CC & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_LotteryShopResultItem___c__EndShowServantEquipStatusDialog_b__5_0__, v4);
    sub_1B00CCC(&LotteryShopResultItem___c_TypeInfo, v5);
    byte_48E68CC = 1;
  }
  ...
  if ( !_9__5_0 )
  {
    ...
    _9__5_0 = (System_Action_o *)sub_1B00F18(System_Action_TypeInfo);
    ...
    sub_1B00C70((ServantStatusBattleListViewItem_o *)&static_fields->__9__5_0, (int32_t)_9__5_0, v13, v14);
  }
  if ( !v9 )
...
void __fastcall LotteryShopResultItem__OnClickDetail(LotteryShopResultItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E68CB & 1) == 0 )
  {
    ...
    sub_1B00CCC(&EquipTargetInfo_TypeInfo, v3);
    sub_1B00CCC(&Method_LotteryShopResultItem_EndShowServantEquipStatusDialog__, v4);
    sub_1B00CCC(&Method_LotteryShopResultItem_OnClickDetail__, v5);
  ...
  if ( (*((_BYTE *)Method_LotteryShopResultItem_OnClickDetail__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1B00CE4(Method_LotteryShopResultItem_OnClickDetail__);
  v8 = (System_Reflection_MethodBase_o *)sub_1B00CB0(v7, v7[4]);
  OverwriteAssetSoundName__PlaySystemSe(v8, 0, 0LL);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_35FBBF0 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  svtId = this->fields.svtId;
  v11 = (CommonUI_o *)Instance;
  v12 = (EquipTargetInfo_o *)sub_1B00F18(EquipTargetInfo_TypeInfo);
  EquipTargetInfo___ctor_37657184(v12, svtId, 0, 1, 0, 0LL);
  ...
  if ( !v11 )
    sub_1B00F28(v14, v15);
  CommonUI__OpenServantEquipStatusDialog_29952300(v11, 11, v12, v13, 0LL, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  ServantFaceIconComponent__Set_37004904(iconComp, svtId, 0, 0, 0, 0LL, 0LL, 2, !isGet, 0, 0LL, 0, 0, 0, 0, 0LL);
}
...
void __fastcall LotteryShopResultItem___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48E68CD & 1) == 0 )
  {
    sub_1B00CCC(&LotteryShopResultItem___c_TypeInfo, v1);
    byte_48E68CD = 1;
  }
  v2 = (Il2CppObject *)sub_1B00F18(LotteryShopResultItem___c_TypeInfo);
