        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5F3BF & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_LotteryShopResultItem___c__EndShowServantEquipStatusDialog_b__5_0__);
    sub_1B885B0(&LotteryShopResultItem___c_TypeInfo);
    byte_4A5F3BF = 1;
  }
  ...
  if ( !_9__5_0 )
  {
    ...
    _9__5_0 = (System_Action_o *)sub_1B887FC(System_Action_TypeInfo);
...
void __fastcall LotteryShopResultItem__OnClickDetail(LotteryShopResultItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5F3BE & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_LotteryShopResultItem_EndShowServantEquipStatusDialog__);
    sub_1B885B0(&Method_LotteryShopResultItem_OnClickDetail__);
    sub_1B885B0(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4A5F3BE = 1;
  }
  v3 = Method_LotteryShopResultItem_OnClickDetail__;
  if ( (*((_BYTE *)Method_LotteryShopResultItem_OnClickDetail__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B885C8(Method_LotteryShopResultItem_OnClickDetail__);
  v4 = (System_Reflection_MethodBase_o *)sub_1B88594(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  svtId = this->fields.svtId;
  v7 = (CommonUI_o *)Instance;
  v8 = (EquipTargetInfo_o *)sub_1B887FC(EquipTargetInfo_TypeInfo);
  EquipTargetInfo___ctor_38882840(v8, svtId, 0, 1, 0, 0LL);
  ...
  if ( !v7 )
    sub_1B8880C(v10, v11);
  CommonUI__OpenServantEquipStatusDialog_30509528(v7, 11, v8, v9, 0LL, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  ServantFaceIconComponent__Set_38217436(iconComp, svtId, 0, 0, 0, 0LL, 0LL, 2, !isGet, 0, 0LL, 0, 0, 0, 0, 0LL);
}
...
void __fastcall LotteryShopResultItem___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1B887FC(LotteryShopResultItem___c_TypeInfo);
