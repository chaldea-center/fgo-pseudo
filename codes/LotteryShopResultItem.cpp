        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AE646 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_LotteryShopResultItem___c__EndShowServantEquipStatusDialog_b__5_0__);
    sub_B52984(&LotteryShopResultItem___c_TypeInfo);
    byte_42AE646 = 1;
  }
  ...
  if ( !_9__5_0 )
  {
    ...
    _9__5_0 = (System_Action_o *)sub_B52A54(System_Action_TypeInfo);
...
void __fastcall LotteryShopResultItem__OnClickDetail(LotteryShopResultItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42AE645 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_LotteryShopResultItem_EndShowServantEquipStatusDialog__);
    sub_B52984(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  ...
  v5 = (CommonUI_o *)Instance;
  v6 = (EquipTargetInfo_o *)sub_B52A54(EquipTargetInfo_TypeInfo);
  EquipTargetInfo___ctor_29473128(v6, v4, 0, 1, 0, 0LL);
  ...
  if ( !v5 )
    sub_B52A5C(v8, v9);
  CommonUI__OpenServantEquipStatusDialog_18173384(v5, 11, v6, v7, 0LL, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  *(&this->fields.isNew + 4) = !isGet;
  ...
  ServantFaceIconComponent__Set_30467316(iconComp, svtId, 0, 0, 0, 0LL, 0LL, 2, !isGet, 0, 0LL, 0, 0, 0, 0, 0LL);
}
...
void __fastcall LotteryShopResultItem___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_B52A54(LotteryShopResultItem___c_TypeInfo);
