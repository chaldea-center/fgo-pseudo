        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C2E388(partyBuffLabelSprite, flag);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)partyBuffLabelSprite, v6, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFB112 & 1) == 0 )
  {
    sub_1C2E12C(&Method_System_Collections_Generic_List_GameObject__Add__, *(_QWORD *)&level);
    ...
    do
    {
      ...
      if ( !v6 )
      {
        ...
        else
        {
          ...
          sub_1C2E0D0((PartyOrganizationUtility_o *)(v21 + 4), (int64_t)Object, v12, v13, v14, v15, v16, v17);
        }
      }
      ++v8;
    }
