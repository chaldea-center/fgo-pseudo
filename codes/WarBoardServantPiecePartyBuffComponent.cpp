        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C71608(partyBuffLabelSprite, flag);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)partyBuffLabelSprite, v6, 0);
}
  ...
  if ( level >= 1 )
  {
    ...
    do
    {
      ...
      if ( !v5 )
      {
        ...
        v21.fields.z = 0.0;
        GameObjectExtensions__SetLocalPosition((UnityEngine_GameObject_o *)Object, v21, 0);
        if ( !Object
        ...
        else
        {
          ...
          sub_1C71354((GrandQuestFolderBoardItem_o *)(v20 + 4), (int32_t)Object, v11, v12, v13, v14, v15, v16);
        }
      }
      ++v7;
    }
