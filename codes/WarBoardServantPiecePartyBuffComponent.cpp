        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B64C5C(partyBuffLabelSprite, flag);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)partyBuffLabelSprite, v6, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC6CA & 1) == 0 )
  {
    sub_1B64A00(&Method_System_Collections_Generic_List_GameObject__Add__, *(_QWORD *)&level);
    ...
    do
    {
      ...
      if ( !v6 )
      {
        ...
        else
        {
          ...
          sub_1B649A4((ServantStatusBattleListViewItem_o *)(v17 + 4), (int32_t)Object, v12, v13);
        }
      }
      ++v8;
    }
