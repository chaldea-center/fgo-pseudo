        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B280F & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_18948/*"forceOverwrite"*/);
    byte_42B280F = 1;
  }
  ScriptObj = EventEquipSkillReleaseEntity__getScriptObj(
                this,
                (System_String_o *)StringLiteral_18948/*"forceOverwrite"*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B2811 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_22339/*"skills"*/);
  ...
  *lv = 0;
  ScriptObj = EventEquipSkillReleaseEntity__getScriptObj(
                this,
                (System_String_o *)StringLiteral_22339/*"skills"*/,
                (const MethodInfo *)id);
  if ( !ScriptObj )
    goto LABEL_22;
  v11 = ScriptObj;
      ...
      if ( v14 )
      {
          ...
          && (System_Collections_Generic_Dictionary_string__object__c *)v14->klass->_2.typeHierarchy[v15 - 1] == System_Collections_Generic_Dictionary_string__object__TypeInfo )
        {
          if ( !System_Collections_Generic_Dictionary_XmlQualifiedName__XmlSchemaObject___ContainsKey(
            ...
            || !System_Collections_Generic_Dictionary_XmlQualifiedName__XmlSchemaObject___ContainsKey(
                  v14,
                  (System_Xml_XmlQualifiedName_o *)StringLiteral_20487/*"lv"*/,
                  (const MethodInfo_2F1BA74 *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
          {
            LOBYTE(ScriptObj) = 0;
          ...
          if ( ScriptObj )
          {
            ...
            *id = *(_QWORD *)j_il2cpp_object_unbox_0(ScriptObj);
            ScriptObj = System_Collections_Generic_Dictionary_Type__IStoreExtension___get_Item(
                          (System_Collections_Generic_Dictionary_Type__IStoreExtension__o *)v14,
                          (System_Type_o *)StringLiteral_20487/*"lv"*/,
                          (const MethodInfo_2F1B73C *)Method_System_Collections_Generic_Dictionary_string__object__get_Item__);
            if ( ScriptObj )
            {
              if ( *(Il2CppClass **)(*(_QWORD *)ScriptObj + 64LL) == long_TypeInfo->_1.element_class )
