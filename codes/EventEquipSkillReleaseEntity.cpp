        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B66B33 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_19796/*"forceOverwrite"*/, v6);
    byte_4B66B33 = 1;
  }
  ScriptObj = EventEquipSkillReleaseEntity__getScriptObj(
                this,
                (System_String_o *)StringLiteral_19796/*"forceOverwrite"*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B66B34 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_19796/*"forceOverwrite"*/, method);
    byte_4B66B34 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B66B35 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__, *(_QWORD *)&idx);
    ...
    sub_1BE4ACC(&StringLiteral_23687/*"skills"*/, v16);
    sub_1BE4ACC(&StringLiteral_21528/*"lv"*/, v17);
    byte_4B66B35 = 1;
  }
  *id = 0;
  *lv = 0;
  ScriptObj = EventEquipSkillReleaseEntity__getScriptObj(
                this,
                (System_String_o *)StringLiteral_23687/*"skills"*/,
                (const MethodInfo *)id);
  if ( !ScriptObj )
    goto LABEL_20;
