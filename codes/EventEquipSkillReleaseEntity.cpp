        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB464C & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_19840/*"fontColorGradientPreset"*/, v6);
    byte_4BB464C = 1;
  }
  ScriptObj = EventEquipSkillReleaseEntity__getScriptObj(
                this,
                (System_String_o *)StringLiteral_19840/*"fontColorGradientPreset"*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB464D & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_19840/*"fontColorGradientPreset"*/, method);
    byte_4BB464D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB464E & 1) == 0 )
  {
    sub_1C13D24(&Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__, *(_QWORD *)&idx);
    ...
    sub_1C13D24(&StringLiteral_23740/*"single-transition-property"*/, v16);
    sub_1C13D24(&StringLiteral_21577/*"looptype"*/, v17);
    byte_4BB464E = 1;
  }
  *id = 0;
  *lv = 0;
  ScriptObj = EventEquipSkillReleaseEntity__getScriptObj(
                this,
                (System_String_o *)StringLiteral_23740/*"single-transition-property"*/,
                (const MethodInfo *)id);
  if ( !ScriptObj )
    goto LABEL_20;
