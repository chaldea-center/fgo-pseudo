        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1C49A & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_19385/*"forceOverwrite"*/, v6);
    byte_4B1C49A = 1;
  }
  ScriptObj = EventEquipSkillReleaseEntity__getScriptObj(
                this,
                (System_String_o *)StringLiteral_19385/*"forceOverwrite"*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1C49B & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_19385/*"forceOverwrite"*/, method);
    byte_4B1C49B = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1C49C & 1) == 0 )
  {
    sub_1BCAFF8(&Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__, *(_QWORD *)&idx);
    ...
    sub_1BCAFF8(&StringLiteral_23316/*"skills"*/, v16);
    sub_1BCAFF8(&StringLiteral_21177/*"lv"*/, v17);
    byte_4B1C49C = 1;
  }
  *id = 0;
  *lv = 0;
  ScriptObj = EventEquipSkillReleaseEntity__getScriptObj(
                this,
                (System_String_o *)StringLiteral_23316/*"skills"*/,
                (const MethodInfo *)id);
  if ( !ScriptObj )
    goto LABEL_20;
