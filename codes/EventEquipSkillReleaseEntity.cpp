        ...
        const MethodInfo *method)
{
  if ( (byte_4B449E7 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int___, *(_QWORD *)&type);
    byte_4B449E7 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B449EA & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_19565/*"forceOverwrite"*/, v6);
    byte_4B449EA = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B449EB & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_19565/*"forceOverwrite"*/, method);
    byte_4B449EB = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B449EC & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__, *(_QWORD *)&idx);
    ...
    sub_1BDB878(&StringLiteral_23555/*"skills"*/, v16);
    sub_1BDB878(&StringLiteral_21383/*"lv"*/, v17);
    byte_4B449EC = 1;
  }
  *id = 0;
  *lv = 0;
  ScriptObj = EventEquipSkillReleaseEntity__getScriptObj(
                this,
                (System_String_o *)StringLiteral_23555/*"skills"*/,
                (const MethodInfo *)id);
  if ( !ScriptObj )
    goto LABEL_20;
