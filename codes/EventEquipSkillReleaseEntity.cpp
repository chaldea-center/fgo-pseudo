        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4E413 & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_19320/*"forceOverwrite"*/, v6);
    byte_4A4E413 = 1;
  }
  ScriptObj = EventEquipSkillReleaseEntity__getScriptObj(
                this,
                (System_String_o *)StringLiteral_19320/*"forceOverwrite"*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4E414 & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_19320/*"forceOverwrite"*/, method);
    byte_4A4E414 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4E415 & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__, *(_QWORD *)&idx);
    ...
    sub_1B863B8(&StringLiteral_23204/*"skills"*/, v16);
    sub_1B863B8(&StringLiteral_21046/*"lv"*/, v17);
    byte_4A4E415 = 1;
  }
  *id = 0;
  *lv = 0;
  ScriptObj = EventEquipSkillReleaseEntity__getScriptObj(
                this,
                (System_String_o *)StringLiteral_23204/*"skills"*/,
                (const MethodInfo *)id);
  if ( !ScriptObj )
    goto LABEL_20;
