        ...
        const MethodInfo *method)
{
  if ( (byte_4BC7A19 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int___, *(_QWORD *)&type);
    byte_4BC7A19 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC7A1C & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_19854/*"forceOverwrite"*/, v6);
    byte_4BC7A1C = 1;
  }
  ScriptObj = EventEquipSkillReleaseEntity__getScriptObj(
                this,
                (System_String_o *)StringLiteral_19854/*"forceOverwrite"*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC7A1D & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_19854/*"forceOverwrite"*/, method);
    byte_4BC7A1D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC7A1E & 1) == 0 )
  {
    sub_1C1ABD4(&Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__, *(_QWORD *)&idx);
    ...
    sub_1C1ABD4(&StringLiteral_23760/*"skills"*/, v16);
    sub_1C1ABD4(&StringLiteral_21591/*"lv"*/, v17);
    byte_4BC7A1E = 1;
  }
  *id = 0;
  *lv = 0;
  ScriptObj = EventEquipSkillReleaseEntity__getScriptObj(
                this,
                (System_String_o *)StringLiteral_23760/*"skills"*/,
                (const MethodInfo *)id);
  if ( !ScriptObj )
    goto LABEL_20;
