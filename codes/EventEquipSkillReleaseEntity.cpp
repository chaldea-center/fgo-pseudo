        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A08BE4 & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_19466/*"forceOverwrite"*/, v6);
    byte_4A08BE4 = 1;
  }
  ScriptObj = EventEquipSkillReleaseEntity__getScriptObj(
                this,
                (System_String_o *)StringLiteral_19466/*"forceOverwrite"*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A08BE5 & 1) == 0 )
  {
    sub_1B686D4(&StringLiteral_19466/*"forceOverwrite"*/, method);
    byte_4A08BE5 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A08BE6 & 1) == 0 )
  {
    sub_1B686D4(&Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__, *(_QWORD *)&idx);
    ...
    sub_1B686D4(&StringLiteral_23271/*"skills"*/, v16);
    sub_1B686D4(&StringLiteral_21160/*"lv"*/, v17);
    byte_4A08BE6 = 1;
  }
  *id = 0;
  *lv = 0;
  ScriptObj = EventEquipSkillReleaseEntity__getScriptObj(
                this,
                (System_String_o *)StringLiteral_23271/*"skills"*/,
                (const MethodInfo *)id);
  if ( !ScriptObj )
    goto LABEL_20;
