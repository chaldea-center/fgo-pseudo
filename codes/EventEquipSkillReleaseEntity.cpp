        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BADE2 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_19233/*"forceOverwrite"*/, v6);
    byte_49BADE2 = 1;
  }
  ScriptObj = EventEquipSkillReleaseEntity__getScriptObj(
                this,
                (System_String_o *)StringLiteral_19233/*"forceOverwrite"*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BADE3 & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_19233/*"forceOverwrite"*/, method);
    byte_49BADE3 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BADE4 & 1) == 0 )
  {
    sub_1B4CF90(&Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__, *(_QWORD *)&idx);
    ...
    sub_1B4CF90(&StringLiteral_23080/*"skills"*/, v16);
    sub_1B4CF90(&StringLiteral_20936/*"lv"*/, v17);
    byte_49BADE4 = 1;
  }
  *id = 0;
  *lv = 0;
  ScriptObj = EventEquipSkillReleaseEntity__getScriptObj(
                this,
                (System_String_o *)StringLiteral_23080/*"skills"*/,
                (const MethodInfo *)id);
  if ( !ScriptObj )
    goto LABEL_20;
