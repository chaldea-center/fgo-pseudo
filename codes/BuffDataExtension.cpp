        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFB721 & 1) == 0 )
  {
    sub_1C2E12C(&System_Diagnostics_StackFrame_TypeInfo, *(_QWORD *)&stackBackCount);
    byte_4BFB721 = 1;
  }
  v4 = (System_Diagnostics_StackFrame_o *)sub_1C2E378(System_Diagnostics_StackFrame_TypeInfo);
  System_Diagnostics_StackFrame___ctor_63747976(v4, stackBackCount, 1, 0LL);
  if ( !v4 )
    sub_1C2E388(v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFB723 & 1) == 0 )
  {
    sub_1C2E12C(&int___TypeInfo, dataVals);
    byte_4BFB723 = 1;
  }
  Param = sub_1C2E1D4(int___TypeInfo, 1LL);
  if ( !dataVals || (v6 = (System_Int32_array *)Param, Param = DataVals__GetParam(dataVals, 151, 0, 0LL), !v6) )
    sub_1C2E388(Param, v5);
  if ( !v6->max_length )
    sub_1C2E390(Param, v5);
  v6->m_Items[1] = Param;
  return v6;
}
        ...
        const MethodInfo *method)
{
  ...
  return BasicHelper__IndexValue_int_(
           ...
           0,
           0,
           (const MethodInfo_2FC00C0 *)Method_BasicHelper_IndexValue_int____77762936) > 0;
}