        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C40E20 & 1) == 0 )
  {
    sub_1C37058(&System_Diagnostics_StackFrame_TypeInfo);
    byte_4C40E20 = 1;
  }
  v4 = (System_Diagnostics_StackFrame_o *)sub_1C372A4(System_Diagnostics_StackFrame_TypeInfo);
  System_Diagnostics_StackFrame___ctor_64864800(v4, stackBackCount, 1, 0);
  if ( !v4 )
    sub_1C372B4(v5);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields, (int32_t)inputGeneralParams, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  Param = sub_1C37100(int___TypeInfo, 1);
        ...
        const MethodInfo *method)
{
  ...
  return BasicHelper__IndexValue_int_(
           ...
           0,
           0,
           (const MethodInfo_30D6114 *)Method_BasicHelper_IndexValue_int____78110424) > 0;
}