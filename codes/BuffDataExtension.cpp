        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4C372 & 1) == 0 )
  {
    sub_1B863B8(&System_Diagnostics_StackFrame_TypeInfo, *(_QWORD *)&stackBackCount);
    byte_4A4C372 = 1;
  }
  v4 = (System_Diagnostics_StackFrame_o *)sub_1B86604(System_Diagnostics_StackFrame_TypeInfo);
  System_Diagnostics_StackFrame___ctor_62951028(v4, stackBackCount, 1, 0LL);
  if ( !v4 )
    sub_1B86614(v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields, (int32_t)inputGeneralParams, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4C374 & 1) == 0 )
  {
    sub_1B863B8(&int___TypeInfo, dataVals);
    byte_4A4C374 = 1;
  }
  Param = sub_1B86460(int___TypeInfo, 1LL);
  if ( !dataVals || (v6 = (System_Int32_array *)Param, Param = DataVals__GetParam(dataVals, 151, 0, 0LL), !v6) )
    sub_1B86614(Param, v5);
  if ( !v6->max_length )
    sub_1B8661C(Param, v5);
  v6->m_Items[1] = Param;
  return v6;
}
        ...
        const MethodInfo *method)
{
  ...
  return BasicHelper__IndexValue_int_(
           ...
           0,
           0,
           (const MethodInfo_2F5C4AC *)Method_BasicHelper_IndexValue_int____76090408) > 0;
}