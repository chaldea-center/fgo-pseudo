        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1FF28 & 1) == 0 )
  {
    sub_1C3B764(&System_Diagnostics_StackFrame_TypeInfo, *(_QWORD *)&stackBackCount);
    byte_4C1FF28 = 1;
  }
  v4 = (System_Diagnostics_StackFrame_o *)sub_1C3B9B0(System_Diagnostics_StackFrame_TypeInfo);
  System_Diagnostics_StackFrame___ctor_63881004(v4, stackBackCount, 1, 0LL);
  if ( !v4 )
    sub_1C3B9C0(v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1FF2A & 1) == 0 )
  {
    sub_1C3B764(&int___TypeInfo, dataVals);
    byte_4C1FF2A = 1;
  }
  Param = sub_1C3B80C(int___TypeInfo, 1LL);
  if ( !dataVals || (v6 = (System_Int32_array *)Param, Param = DataVals__GetParam(dataVals, 151, 0, 0LL), !v6) )
    sub_1C3B9C0(Param, v5);
  if ( !v6->max_length )
    sub_1C3B9C8(Param, v5);
  v6->m_Items[1] = Param;
  return v6;
}
        ...
        const MethodInfo *method)
{
  ...
  return BasicHelper__IndexValue_int_(
           ...
           0,
           0,
           (const MethodInfo_2FDE9F8 *)Method_BasicHelper_IndexValue_int____77908496) > 0;
}