...
System_String_o *__fastcall CommandCodeLockRequest__getURL(CommandCodeLockRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_40FA5B5 & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_17528/*"commandCode/lock"*/, v2);
    byte_40FA5B5 = 1;
  }
  ...
  return System_String__Concat_43743732(BaseUrl, (System_String_o *)StringLiteral_17528/*"commandCode/lock"*/, 0LL);
}
