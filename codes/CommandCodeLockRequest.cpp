...
System_String_o *__fastcall CommandCodeLockRequest__getURL(CommandCodeLockRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_41880FF & 1) == 0 )
  {
    ...
    sub_B2C35C(&StringLiteral_17595/*"commandCode/lock"*/, v2);
    byte_41880FF = 1;
  }
  ...
  return System_String__Concat_44305532(BaseUrl, (System_String_o *)StringLiteral_17595/*"commandCode/lock"*/, 0LL);
}
