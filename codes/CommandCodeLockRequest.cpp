...
System_String_o *__fastcall CommandCodeLockRequest__getURL(CommandCodeLockRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B03A59 & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_17991/*"commandCode/lock"*/, v2);
    byte_4B03A59 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62348648(BaseUrl, (System_String_o *)StringLiteral_17991/*"commandCode/lock"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v7 = ResponseCommandKind__SearchData(89, responseList, 0LL);
