...
System_String_o *__fastcall CommandCodeLockRequest__getURL(CommandCodeLockRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42E8BED & 1) == 0 )
  {
    ...
    sub_B5D5C4(&StringLiteral_17814/*"commandCode/lock"*/, v4, v5, v6);
    byte_42E8BED = 1;
  }
  ...
  return System_String__Concat_44577788(BaseUrl, (System_String_o *)StringLiteral_17814/*"commandCode/lock"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v12 = ResponseCommandKind__SearchData(89, responseList, 0LL);
