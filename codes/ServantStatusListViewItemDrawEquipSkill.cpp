void __fastcall ServantStatusListViewItemDrawEquipSkill___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A1C860 & 1) == 0 )
  {
    sub_1B715CC(&ServantStatusListViewItemDrawEquipSkill_TypeInfo, v1);
    byte_4A1C860 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C85E & 1) == 0 )
  {
    ...
    sub_1B715CC(&ServantStatusListViewItemDrawEquipSkill_TypeInfo, v8);
    sub_1B715CC(&StringLiteral_11838/*"SERVANT_STATUS_EXPLANATION_SKILL_PASSIVE"*/, v9);
    byte_4A1C85E = 1;
  }
  skillInfoList = 0LL;
  ...
  baseSprite = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11838/*"SERVANT_STATUS_EXPLANATION_SKILL_PASSIVE"*/, 0LL);
  if ( !explanationLabel )
    goto LABEL_89;
