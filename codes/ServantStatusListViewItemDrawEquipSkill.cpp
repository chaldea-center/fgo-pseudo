void __fastcall ServantStatusListViewItemDrawEquipSkill___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BC4A45 & 1) == 0 )
  {
    sub_1C1ABD4(&ServantStatusListViewItemDrawEquipSkill_TypeInfo, v1);
    byte_4BC4A45 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC4A43 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&ServantStatusListViewItemDrawEquipSkill_TypeInfo, v8);
    sub_1C1ABD4(&StringLiteral_12088/*"SERVANT_STATUS_EXPLANATION_SKILL_PASSIVE"*/, v9);
    byte_4BC4A43 = 1;
  }
  skillInfoList = 0LL;
  ...
  baseSprite = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12088/*"SERVANT_STATUS_EXPLANATION_SKILL_PASSIVE"*/, 0LL);
  if ( !explanationLabel )
    goto LABEL_89;
