void __fastcall UserGameMaster___ctor(UserGameMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4C22D43 & 1) == 0 )
  {
    sub_1C3B764(&Method_DataMasterBase_UserGameMaster__UserGameEntity__long___ctor__, method);
    byte_4C22D43 = 1;
  }
  DataMasterBase_object__object__long____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    28,
    (const MethodInfo_329B080 *)Method_DataMasterBase_UserGameMaster__UserGameEntity__long___ctor__);
}
...
bool __fastcall UserGameMaster__TryGetSelfUserGame(UserGameEntity_o **entity, const MethodInfo *method)
{
  ...
  if ( (byte_4C22D45 & 1) == 0 )
  {
    sub_1C3B764(&Method_DataManager_GetMaster_UserGameMaster___, method);
    sub_1C3B764(&DataManager_TypeInfo, v3);
    sub_1C3B764(&Method_DataMasterBase_UserGameMaster__UserGameEntity__long__TryGetEntity__, v4);
    sub_1C3B764(&NetworkManager_TypeInfo, v5);
    byte_4C22D45 = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2FF01B0 *)Method_DataManager_GetMaster_UserGameMaster___);
  ...
  return DataMasterBase_object__object__long___TryGetEntity(
           ...
           (const MethodInfo_329D3F0 *)Method_DataMasterBase_UserGameMaster__UserGameEntity__long__TryGetEntity__);
}
...
UserGameEntity_o *__fastcall UserGameMaster__getSelfUserGame(const MethodInfo *method)
{
  ...
  if ( (byte_4C22D44 & 1) == 0 )
  {
    sub_1C3B764(&Method_DataManager_GetMasterData_UserGameMaster___, v1);
    sub_1C3B764(&Method_DataMasterBase_UserGameMaster__UserGameEntity__long__GetEntity__, v2);
