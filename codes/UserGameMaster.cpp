void __fastcall UserGameMaster___ctor(UserGameMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4B458E2 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataMasterBase_UserGameMaster__UserGameEntity__long___ctor__, method);
    byte_4B458E2 = 1;
  }
  DataMasterBase_object__object__long____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    28,
    (const MethodInfo_32E2074 *)Method_DataMasterBase_UserGameMaster__UserGameEntity__long___ctor__);
}
...
bool __fastcall UserGameMaster__TryGetSelfUserGame(UserGameEntity_o **entity, const MethodInfo *method)
{
  ...
  if ( (byte_4B458E4 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMaster_UserGameMaster___, method);
    sub_1BDB878(&DataManager_TypeInfo, v3);
    sub_1BDB878(&Method_DataMasterBase_UserGameMaster__UserGameEntity__long__TryGetEntity__, v4);
    sub_1BDB878(&NetworkManager_TypeInfo, v5);
    byte_4B458E4 = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_UserGameMaster___);
  ...
  return DataMasterBase_object__object__long___TryGetEntity(
           ...
           (const MethodInfo_32E43E4 *)Method_DataMasterBase_UserGameMaster__UserGameEntity__long__TryGetEntity__);
}
...
UserGameEntity_o *__fastcall UserGameMaster__getSelfUserGame(const MethodInfo *method)
{
  ...
  if ( (byte_4B458E3 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMasterData_UserGameMaster___, v1);
    sub_1BDB878(&Method_DataMasterBase_UserGameMaster__UserGameEntity__long__GetEntity__, v2);
