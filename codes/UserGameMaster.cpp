void UserGameMaster___ctor(UserGameMaster_o *this, const MethodInfo *method)
{
  if ( (byte_59395DA & 1) == 0 )
  {
    sub_21FFC50(&Method_DataMasterBase_UserGameMaster__UserGameEntity__long___ctor__);
    byte_59395DA = 1;
  }
  DataMasterBase_object__object__long____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    28,
    (const MethodInfo_3EDD598 *)Method_DataMasterBase_UserGameMaster__UserGameEntity__long___ctor__);
}
...
bool UserGameMaster__TryGetSelfUserGame(UserGameEntity_o **entity, const MethodInfo *method)
{
  ...
  if ( (byte_59395DC & 1) == 0 )
  {
    ...
    sub_21FFC50(&Method_DataMasterBase_UserGameMaster__UserGameEntity__long__TryGetEntity__);
    sub_21FFC50(&NetworkManager_TypeInfo);
    byte_59395DC = 1;
  }
  if ( !*(&DataManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo, method);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_3822E50 *)Method_DataManager_GetMaster_UserGameMaster___);
  ...
  return DataMasterBase_object__object__long___TryGetEntity(
           ...
           (const MethodInfo_3EDFA34 *)Method_DataMasterBase_UserGameMaster__UserGameEntity__long__TryGetEntity__);
}
