        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4844C & 1) == 0 )
  {
    sub_1BDB878(&Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__, assetData);
    byte_4B4844C = 1;
  }
  if ( assetData )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4844D & 1) == 0 )
  {
    sub_1BDB878(&CoinRoomRootComponent__InitUI_d__6_TypeInfo, method);
    byte_4B4844D = 1;
  }
  v3 = sub_1BDBAC4(CoinRoomRootComponent__InitUI_d__6_TypeInfo);
...
void __fastcall CoinRoomRootComponent__beginInitialize(CoinRoomRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B4844B & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_CoinRoomRootComponent_EndLoadAsset__, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48450 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_BasicHelper_Find_GameObject___, v3);
    sub_1BDB878(&System_Func_GameObject__bool__TypeInfo, v4);
    sub_1BDB878(&Method_UnityEngine_GameObject_GetComponent_CoinRoomLobbyComponent___, v5);
    sub_1BDB878(&Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__, v6);
    sub_1BDB878(&Method_CoinRoomRootComponent___c__InitUI_b__6_0__, v7);
    sub_1BDB878(&CoinRoomRootComponent___c_TypeInfo, v8);
    this = (CoinRoomRootComponent__InitUI_d__6_o *)sub_1BDB878(&StringLiteral_14756/*"UIRootPanel"*/, v9);
    byte_4B48450 = 1;
  }
  ...
  if ( _1__state == 1 )
  {
    ...
    if ( !_9__6_0 )
    {
      ...
      _9__6_0 = (System_Func_object__bool__o *)sub_1BDBAC4(System_Func_GameObject__bool__TypeInfo);
      ...
      sub_1BDB81C((CGThumbnailListItem_o *)&static_fields->__9__6_0, (int32_t)_9__6_0, v27, v28);
    }
    this = (CoinRoomRootComponent__InitUI_d__6_o *)BasicHelper__Find_object_(
                                                     ...
                                                     (const MethodInfo_301D9C8 *)Method_BasicHelper_Find_GameObject___);
    if ( !this )
      goto LABEL_21;
    v29 = this;
    ...
    this = (CoinRoomRootComponent__InitUI_d__6_o *)UnityEngine_GameObject__GetComponent_object_(
                                                     ...
                                                     (const MethodInfo_3088520 *)Method_UnityEngine_GameObject_GetComponent_CoinRoomLobbyComponent___);
    if ( !_4__this )
      goto LABEL_21;
    if ( !this )
      goto LABEL_21;
    ...
    this = (CoinRoomRootComponent__InitUI_d__6_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    if ( !this )
      goto LABEL_21;
    ...
    if ( _4__this )
    {
      ...
      if ( this )
      {
        Object_object__50417328 = AssetData__GetObject_object__50417328(
                                    (AssetData_o *)this,
                                    (System_String_o *)StringLiteral_14756/*"UIRootPanel"*/,
        ...
        if ( this )
        {
          ...
          sub_1BDB81C((CGThumbnailListItem_o *)&v2->fields._createRoot_5__2, (int32_t)Object, v15, v16);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BDB88C(&Method_CoinRoomRootComponent__InitUI_d__6_System_Collections_IEnumerator_Reset__);
  sub_1BDB9A0(v3, v4);
}
...
void __fastcall CoinRoomRootComponent___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B4844E & 1) == 0 )
  {
    sub_1BDB878(&CoinRoomRootComponent___c_TypeInfo, v1);
    byte_4B4844E = 1;
  }
  v2 = (Il2CppObject *)sub_1BDBAC4(CoinRoomRootComponent___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  CoinRoomRootComponent___c_TypeInfo->static_fields->__9 = (struct CoinRoomRootComponent___c_o *)v2;
  sub_1BDB81C((CGThumbnailListItem_o *)CoinRoomRootComponent___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4844F & 1) == 0 )
  {
    this = (CoinRoomRootComponent___c_o *)sub_1BDB878(&StringLiteral_8469/*"LobbyPanel"*/, x);
    byte_4B4844F = 1;
  }
  if ( !x )
    sub_1BDBAD4(this, x);
  name = UnityEngine_Object__get_name((UnityEngine_Object_o *)x, 0LL);
  return System_String__op_Equality(name, (System_String_o *)StringLiteral_8469/*"LobbyPanel"*/, 0LL);
}