        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB931D & 1) == 0 )
  {
    sub_1BAB41C(&Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__, assetData);
    byte_4AB931D = 1;
  }
  if ( assetData )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB931E & 1) == 0 )
  {
    sub_1BAB41C(&CoinRoomRootComponent__InitUI_d__6_TypeInfo, method);
    byte_4AB931E = 1;
  }
  v3 = sub_1BAB668(CoinRoomRootComponent__InitUI_d__6_TypeInfo);
...
void __fastcall CoinRoomRootComponent__beginInitialize(CoinRoomRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB931C & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_CoinRoomRootComponent_EndLoadAsset__, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9321 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_BasicHelper_Find_GameObject___, v3);
    sub_1BAB41C(&System_Func_GameObject__bool__TypeInfo, v4);
    sub_1BAB41C(&Method_UnityEngine_GameObject_GetComponent_CoinRoomLobbyComponent___, v5);
    sub_1BAB41C(&Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__, v6);
    sub_1BAB41C(&Method_CoinRoomRootComponent___c__InitUI_b__6_0__, v7);
    sub_1BAB41C(&CoinRoomRootComponent___c_TypeInfo, v8);
    this = (CoinRoomRootComponent__InitUI_d__6_o *)sub_1BAB41C(&StringLiteral_14802/*"UIRootPanel"*/, v9);
    byte_4AB9321 = 1;
  }
  ...
  if ( _1__state == 1 )
  {
    ...
    if ( !_9__6_0 )
    {
      ...
      _9__6_0 = (System_Func_object__bool__o *)sub_1BAB668(System_Func_GameObject__bool__TypeInfo);
      ...
      sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&static_fields->__9__6_0, (int32_t)_9__6_0, v27, v28);
    }
    this = (CoinRoomRootComponent__InitUI_d__6_o *)BasicHelper__Find_object_(
                                                     ...
                                                     (const MethodInfo_2EB0308 *)Method_BasicHelper_Find_GameObject___);
    if ( !this )
      goto LABEL_21;
    v29 = this;
    ...
    this = (CoinRoomRootComponent__InitUI_d__6_o *)UnityEngine_GameObject__GetComponent_object_(
                                                     ...
                                                     (const MethodInfo_2F13970 *)Method_UnityEngine_GameObject_GetComponent_CoinRoomLobbyComponent___);
    if ( !_4__this )
      goto LABEL_21;
    if ( !this )
      goto LABEL_21;
    ...
    this = (CoinRoomRootComponent__InitUI_d__6_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_378A22C *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    if ( !this )
      goto LABEL_21;
    ...
    if ( _4__this )
    {
      ...
      if ( this )
      {
        Object_object__48916712 = AssetData__GetObject_object__48916712(
                                    (AssetData_o *)this,
                                    (System_String_o *)StringLiteral_14802/*"UIRootPanel"*/,
        ...
        if ( this )
        {
          ...
          sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&v2->fields._createRoot_5__2, (int32_t)Object, v15, v16);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BAB430(&Method_CoinRoomRootComponent__InitUI_d__6_System_Collections_IEnumerator_Reset__);
  sub_1BAB544(v3, v4);
}
...
void __fastcall CoinRoomRootComponent___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB931F & 1) == 0 )
  {
    sub_1BAB41C(&CoinRoomRootComponent___c_TypeInfo, v1);
    byte_4AB931F = 1;
  }
  v2 = (Il2CppObject *)sub_1BAB668(CoinRoomRootComponent___c_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9320 & 1) == 0 )
  {
    this = (CoinRoomRootComponent___c_o *)sub_1BAB41C(&StringLiteral_8460/*"LobbyPanel"*/, x);
    byte_4AB9320 = 1;
  }
  if ( !x )
    sub_1BAB678(this, x);
