        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A28C & 1) == 0 )
  {
    sub_1BE4ACC(&Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__, assetData);
    byte_4B6A28C = 1;
  }
  if ( assetData )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A28D & 1) == 0 )
  {
    sub_1BE4ACC(&CoinRoomRootComponent__InitUI_d__6_TypeInfo, method);
    byte_4B6A28D = 1;
  }
  v3 = sub_1BE4D18(CoinRoomRootComponent__InitUI_d__6_TypeInfo);
...
void __fastcall CoinRoomRootComponent__beginInitialize(CoinRoomRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6A28B & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_CoinRoomRootComponent_EndLoadAsset__, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A290 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_BasicHelper_Find_GameObject___, v3);
    sub_1BE4ACC(&System_Func_GameObject__bool__TypeInfo, v4);
    sub_1BE4ACC(&Method_UnityEngine_GameObject_GetComponent_CoinRoomLobbyComponent___, v5);
    sub_1BE4ACC(&Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__, v6);
    sub_1BE4ACC(&Method_CoinRoomRootComponent___c__InitUI_b__6_0__, v7);
    sub_1BE4ACC(&CoinRoomRootComponent___c_TypeInfo, v8);
    this = (CoinRoomRootComponent__InitUI_d__6_o *)sub_1BE4ACC(&StringLiteral_14975/*"UIRootPanel"*/, v9);
    byte_4B6A290 = 1;
  }
  ...
  if ( _1__state == 1 )
  {
    ...
    if ( !_9__6_0 )
    {
      ...
      _9__6_0 = (System_Func_object__bool__o *)sub_1BE4D18(System_Func_GameObject__bool__TypeInfo);
    ...
    this = (CoinRoomRootComponent__InitUI_d__6_o *)BasicHelper__Find_object_(
                                                     ...
                                                     (const MethodInfo_2F44C48 *)Method_BasicHelper_Find_GameObject___);
    if ( !this )
      goto LABEL_21;
    v41 = this;
    ...
    this = (CoinRoomRootComponent__InitUI_d__6_o *)UnityEngine_GameObject__GetComponent_object_(
                                                     ...
                                                     (const MethodInfo_2FA979C *)Method_UnityEngine_GameObject_GetComponent_CoinRoomLobbyComponent___);
    if ( !_4__this )
      goto LABEL_21;
    if ( !this )
      goto LABEL_21;
    ...
    this = (CoinRoomRootComponent__InitUI_d__6_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    if ( !this )
      goto LABEL_21;
    ...
    if ( _4__this )
    {
      ...
      if ( this )
      {
        Object_object__49525204 = AssetData__GetObject_object__49525204(
                                    (AssetData_o *)this,
                                    (System_String_o *)StringLiteral_14975/*"UIRootPanel"*/,
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BE4AE0(&Method_CoinRoomRootComponent__InitUI_d__6_System_Collections_IEnumerator_Reset__);
  sub_1BE4BF4(v3, v4);
}
...
void __fastcall CoinRoomRootComponent___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B6A28E & 1) == 0 )
  {
    sub_1BE4ACC(&CoinRoomRootComponent___c_TypeInfo, v1);
    byte_4B6A28E = 1;
  }
  v2 = (Il2CppObject *)sub_1BE4D18(CoinRoomRootComponent___c_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A28F & 1) == 0 )
  {
    this = (CoinRoomRootComponent___c_o *)sub_1BE4ACC(&StringLiteral_8601/*"LobbyPanel"*/, x);
    byte_4B6A28F = 1;
  }
  if ( !x )
    sub_1BE4D28(this, x);
  name = UnityEngine_Object__get_name((UnityEngine_Object_o *)x, 0LL);
  return System_String__op_Equality(name, (System_String_o *)StringLiteral_8601/*"LobbyPanel"*/, 0LL);
}