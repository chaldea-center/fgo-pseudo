        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E08851 & 1) == 0 )
  {
    sub_1CE6700(&CoinRoomRootComponent__InitUI_d__6_TypeInfo);
    byte_4E08851 = 1;
  }
  v3 = sub_1CE694C(CoinRoomRootComponent__InitUI_d__6_TypeInfo);
...
void CoinRoomRootComponent__beginInitialize(CoinRoomRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E0884F & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_CoinRoomRootComponent_EndLoadAsset__);
...
bool CoinRoomRootComponent__InitUI_d__6__MoveNext(CoinRoomRootComponent__InitUI_d__6_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E08854 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_BasicHelper_Find_GameObject___);
    sub_1CE6700(&System_Func_GameObject__bool__TypeInfo);
    sub_1CE6700(&Method_UnityEngine_GameObject_GetComponent_CoinRoomLobbyComponent___);
    sub_1CE6700(&Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    sub_1CE6700(&Method_CoinRoomRootComponent___c__InitUI_b__6_0__);
    sub_1CE6700(&CoinRoomRootComponent___c_TypeInfo);
    this = (CoinRoomRootComponent__InitUI_d__6_o *)sub_1CE6700(&StringLiteral_14933/*"UIRootPanel"*/);
    byte_4E08854 = 1;
  }
  ...
  if ( _1__state == 1 )
  {
    ...
    if ( !_9__6_0 )
    {
      ...
      _9__6_0 = (System_Func_object__bool__o *)sub_1CE694C(System_Func_GameObject__bool__TypeInfo);
    ...
    this = (CoinRoomRootComponent__InitUI_d__6_o *)BasicHelper__Find_object_(
                                                     ...
                                                     (const MethodInfo_31EE0A8 *)Method_BasicHelper_Find_GameObject___);
    if ( !this )
      goto LABEL_21;
    v34 = this;
    ...
    this = (CoinRoomRootComponent__InitUI_d__6_o *)UnityEngine_GameObject__GetComponent_object_(
                                                     ...
                                                     (const MethodInfo_325BE3C *)Method_UnityEngine_GameObject_GetComponent_CoinRoomLobbyComponent___);
    if ( !_4__this )
      goto LABEL_21;
    if ( !this )
      goto LABEL_21;
    ...
    this = (CoinRoomRootComponent__InitUI_d__6_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    if ( !this )
      goto LABEL_21;
    ...
    if ( _4__this )
    {
      ...
      if ( this )
      {
        Object_object__52317288 = AssetData__GetObject_object__52317288(
                                    (AssetData_o *)this,
                                    (System_String_o *)StringLiteral_14933/*"UIRootPanel"*/,
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1CE6714(&Method_CoinRoomRootComponent__InitUI_d__6_System_Collections_IEnumerator_Reset__);
  sub_1CE6828(v3, v4);
}
...
void CoinRoomRootComponent___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1CE694C(CoinRoomRootComponent___c_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E08853 & 1) == 0 )
  {
    this = (CoinRoomRootComponent___c_o *)sub_1CE6700(&StringLiteral_8544/*"LobbyPanel"*/);
    byte_4E08853 = 1;
  }
  if ( !x )
    sub_1CE6958(this, x);
  name = UnityEngine_Object__get_name((UnityEngine_Object_o *)x, 0);
  return System_String__op_Equality(name, (System_String_o *)StringLiteral_8544/*"LobbyPanel"*/, 0);
}