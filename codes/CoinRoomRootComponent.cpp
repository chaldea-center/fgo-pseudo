        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D347D1 & 1) == 0 )
  {
    sub_1C93AD4(&CoinRoomRootComponent__InitUI_d__6_TypeInfo);
    byte_4D347D1 = 1;
  }
  v3 = sub_1C93D20(CoinRoomRootComponent__InitUI_d__6_TypeInfo);
...
void CoinRoomRootComponent__beginInitialize(CoinRoomRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D347CF & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_CoinRoomRootComponent_EndLoadAsset__);
...
bool CoinRoomRootComponent__InitUI_d__6__MoveNext(CoinRoomRootComponent__InitUI_d__6_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D347D4 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_BasicHelper_Find_GameObject___);
    sub_1C93AD4(&System_Func_GameObject__bool__TypeInfo);
    sub_1C93AD4(&Method_UnityEngine_GameObject_GetComponent_CoinRoomLobbyComponent___);
    sub_1C93AD4(&Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    sub_1C93AD4(&Method_CoinRoomRootComponent___c__InitUI_b__6_0__);
    sub_1C93AD4(&CoinRoomRootComponent___c_TypeInfo);
    this = (CoinRoomRootComponent__InitUI_d__6_o *)sub_1C93AD4(&StringLiteral_14887/*"UIRootPanel"*/);
    byte_4D347D4 = 1;
  }
  ...
  if ( _1__state == 1 )
  {
    ...
    if ( !_9__6_0 )
    {
      ...
      _9__6_0 = (System_Func_object__bool__o *)sub_1C93D20(System_Func_GameObject__bool__TypeInfo);
    ...
    this = (CoinRoomRootComponent__InitUI_d__6_o *)BasicHelper__Find_object_(
                                                     ...
                                                     (const MethodInfo_318E744 *)Method_BasicHelper_Find_GameObject___);
    if ( !this )
      goto LABEL_21;
    v34 = this;
    ...
    this = (CoinRoomRootComponent__InitUI_d__6_o *)UnityEngine_GameObject__GetComponent_object_(
                                                     ...
                                                     (const MethodInfo_31FC084 *)Method_UnityEngine_GameObject_GetComponent_CoinRoomLobbyComponent___);
    if ( !_4__this )
      goto LABEL_21;
    if ( !this )
      goto LABEL_21;
    ...
    this = (CoinRoomRootComponent__InitUI_d__6_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3AC52FC *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    if ( !this )
      goto LABEL_21;
    ...
    if ( _4__this )
    {
      ...
      if ( this )
      {
        Object_object__51927708 = AssetData__GetObject_object__51927708(
                                    (AssetData_o *)this,
                                    (System_String_o *)StringLiteral_14887/*"UIRootPanel"*/,
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C93AE8(&Method_CoinRoomRootComponent__InitUI_d__6_System_Collections_IEnumerator_Reset__);
  sub_1C93BFC(v3, v4);
}
...
void CoinRoomRootComponent___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C93D20(CoinRoomRootComponent___c_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D347D3 & 1) == 0 )
  {
    this = (CoinRoomRootComponent___c_o *)sub_1C93AD4(&StringLiteral_8528/*"LobbyPanel"*/);
    byte_4D347D3 = 1;
  }
  if ( !x )
    sub_1C93D2C(this, x);
  name = UnityEngine_Object__get_name((UnityEngine_Object_o *)x, 0);
  return System_String__op_Equality(name, (System_String_o *)StringLiteral_8528/*"LobbyPanel"*/, 0);
}