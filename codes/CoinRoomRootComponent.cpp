        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB7DAE & 1) == 0 )
  {
    sub_1C13D24(&Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__, assetData);
    byte_4BB7DAE = 1;
  }
  if ( assetData )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB7DAF & 1) == 0 )
  {
    sub_1C13D24(&CoinRoomRootComponent__InitUI_d__6_TypeInfo, method);
    byte_4BB7DAF = 1;
  }
  v3 = sub_1C13F70(CoinRoomRootComponent__InitUI_d__6_TypeInfo);
...
void __fastcall CoinRoomRootComponent__beginInitialize(CoinRoomRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB7DAD & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_CoinRoomRootComponent_EndLoadAsset__, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB7DB2 & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_BasicHelper_Find_GameObject___, v3);
    sub_1C13D24(&System_Func_GameObject__bool__TypeInfo, v4);
    sub_1C13D24(&Method_UnityEngine_GameObject_GetComponent_CoinRoomLobbyComponent___, v5);
    sub_1C13D24(&Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__, v6);
    sub_1C13D24(&Method_CoinRoomRootComponent___c__InitUI_b__6_0__, v7);
    sub_1C13D24(&CoinRoomRootComponent___c_TypeInfo, v8);
    this = (CoinRoomRootComponent__InitUI_d__6_o *)sub_1C13D24(&StringLiteral_15010/*"UIR.ScaleTriangle"*/, v9);
    byte_4BB7DB2 = 1;
  }
  ...
  if ( _1__state == 1 )
  {
    ...
    if ( !_9__6_0 )
    {
      ...
      _9__6_0 = (System_Func_object__bool__o *)sub_1C13F70(System_Func_GameObject__bool__TypeInfo);
    ...
    this = (CoinRoomRootComponent__InitUI_d__6_o *)BasicHelper__Find_object_(
                                                     ...
                                                     (const MethodInfo_2F7AFA4 *)Method_BasicHelper_Find_GameObject___);
    if ( !this )
      goto LABEL_21;
    v41 = this;
    ...
    this = (CoinRoomRootComponent__InitUI_d__6_o *)UnityEngine_GameObject__GetComponent_object_(
                                                     ...
                                                     (const MethodInfo_2FDF9FC *)Method_UnityEngine_GameObject_GetComponent_CoinRoomLobbyComponent___);
    if ( !_4__this )
      goto LABEL_21;
    if ( !this )
      goto LABEL_21;
    ...
    this = (CoinRoomRootComponent__InitUI_d__6_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3869BD8 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    if ( !this )
      goto LABEL_21;
    ...
    if ( _4__this )
    {
      ...
      if ( this )
      {
        Object_object__49747248 = AssetData__GetObject_object__49747248(
                                    (AssetData_o *)this,
                                    (System_String_o *)StringLiteral_15010/*"UIR.ScaleTriangle"*/,
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C13D38(&Method_CoinRoomRootComponent__InitUI_d__6_System_Collections_IEnumerator_Reset__);
  sub_1C13E4C(v3, v4);
}
...
void __fastcall CoinRoomRootComponent___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BB7DB0 & 1) == 0 )
  {
    sub_1C13D24(&CoinRoomRootComponent___c_TypeInfo, v1);
    byte_4BB7DB0 = 1;
  }
  v2 = (Il2CppObject *)sub_1C13F70(CoinRoomRootComponent___c_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB7DB1 & 1) == 0 )
  {
    this = (CoinRoomRootComponent___c_o *)sub_1C13D24(&StringLiteral_8621/*"LoadServantFormEnd"*/, x);
    byte_4BB7DB1 = 1;
  }
  if ( !x )
    sub_1C13F80(this, x);
  name = UnityEngine_Object__get_name((UnityEngine_Object_o *)x, 0LL);
  return System_String__op_Equality(name, (System_String_o *)StringLiteral_8621/*"LoadServantFormEnd"*/, 0LL);
}