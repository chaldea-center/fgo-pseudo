        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2AF30 & 1) == 0 )
  {
    sub_1C2D490(&CoinRoomRootComponent__InitUI_d__6_TypeInfo);
    byte_4C2AF30 = 1;
  }
  v3 = sub_1C2D6DC(CoinRoomRootComponent__InitUI_d__6_TypeInfo);
...
void CoinRoomRootComponent__beginInitialize(CoinRoomRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2AF2E & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_CoinRoomRootComponent_EndLoadAsset__);
...
bool CoinRoomRootComponent__InitUI_d__6__MoveNext(CoinRoomRootComponent__InitUI_d__6_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2AF33 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_BasicHelper_Find_GameObject___);
    sub_1C2D490(&System_Func_GameObject__bool__TypeInfo);
    sub_1C2D490(&Method_UnityEngine_GameObject_GetComponent_CoinRoomLobbyComponent___);
    sub_1C2D490(&Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    sub_1C2D490(&Method_CoinRoomRootComponent___c__InitUI_b__6_0__);
    sub_1C2D490(&CoinRoomRootComponent___c_TypeInfo);
    this = (CoinRoomRootComponent__InitUI_d__6_o *)sub_1C2D490(&StringLiteral_14784/*"UIRootPanel"*/);
    byte_4C2AF33 = 1;
  }
  ...
  if ( _1__state == 1 )
  {
    ...
    if ( !_9__6_0 )
    {
      ...
      _9__6_0 = (System_Func_object__bool__o *)sub_1C2D6DC(System_Func_GameObject__bool__TypeInfo);
      ...
      sub_1C2D434((CGThumbnailListItem_o *)&static_fields->__9__6_0, (int32_t)_9__6_0, v20, v21);
    }
    this = (CoinRoomRootComponent__InitUI_d__6_o *)BasicHelper__Find_object_(
                                                     ...
                                                     (const MethodInfo_30B88BC *)Method_BasicHelper_Find_GameObject___);
    if ( !this )
      goto LABEL_21;
    v22 = this;
    ...
    this = (CoinRoomRootComponent__InitUI_d__6_o *)UnityEngine_GameObject__GetComponent_object_(
                                                     ...
                                                     (const MethodInfo_3125ED0 *)Method_UnityEngine_GameObject_GetComponent_CoinRoomLobbyComponent___);
    if ( !_4__this )
      goto LABEL_21;
    if ( !this )
      goto LABEL_21;
    ...
    this = (CoinRoomRootComponent__InitUI_d__6_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39D3CCC *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    if ( !this )
      goto LABEL_21;
    ...
    if ( _4__this )
    {
      ...
      if ( this )
      {
        Object_object__51051712 = AssetData__GetObject_object__51051712(
                                    (AssetData_o *)this,
                                    (System_String_o *)StringLiteral_14784/*"UIRootPanel"*/,
        ...
        if ( this )
        {
          ...
          sub_1C2D434((CGThumbnailListItem_o *)&v2->fields._createRoot_5__2, (int32_t)Object, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C2D4A4(&Method_CoinRoomRootComponent__InitUI_d__6_System_Collections_IEnumerator_Reset__);
  sub_1C2D5B8(v3, v4);
}
...
void CoinRoomRootComponent___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C2D6DC(CoinRoomRootComponent___c_TypeInfo);
  System_Object___ctor(v1, 0);
  CoinRoomRootComponent___c_TypeInfo->static_fields->__9 = (struct CoinRoomRootComponent___c_o *)v1;
  sub_1C2D434((CGThumbnailListItem_o *)CoinRoomRootComponent___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2AF32 & 1) == 0 )
  {
    this = (CoinRoomRootComponent___c_o *)sub_1C2D490(&StringLiteral_8472/*"LobbyPanel"*/);
    byte_4C2AF32 = 1;
  }
  if ( !x )
    sub_1C2D6EC(this, x);
  name = UnityEngine_Object__get_name((UnityEngine_Object_o *)x, 0);
  return System_String__op_Equality(name, (System_String_o *)StringLiteral_8472/*"LobbyPanel"*/, 0);
}