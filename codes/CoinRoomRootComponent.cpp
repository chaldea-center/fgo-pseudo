        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3B750 & 1) == 0 )
  {
    sub_1C32C20(&CoinRoomRootComponent__InitUI_d__6_TypeInfo);
    byte_4C3B750 = 1;
  }
  v3 = sub_1C32E6C(CoinRoomRootComponent__InitUI_d__6_TypeInfo);
...
void CoinRoomRootComponent__beginInitialize(CoinRoomRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3B74E & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_CoinRoomRootComponent_EndLoadAsset__);
...
bool CoinRoomRootComponent__InitUI_d__6__MoveNext(CoinRoomRootComponent__InitUI_d__6_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3B753 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_BasicHelper_Find_GameObject___);
    sub_1C32C20(&System_Func_GameObject__bool__TypeInfo);
    sub_1C32C20(&Method_UnityEngine_GameObject_GetComponent_CoinRoomLobbyComponent___);
    sub_1C32C20(&Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    sub_1C32C20(&Method_CoinRoomRootComponent___c__InitUI_b__6_0__);
    sub_1C32C20(&CoinRoomRootComponent___c_TypeInfo);
    this = (CoinRoomRootComponent__InitUI_d__6_o *)sub_1C32C20(&StringLiteral_14787/*"UIRootPanel"*/);
    byte_4C3B753 = 1;
  }
  ...
  if ( _1__state == 1 )
  {
    ...
    if ( !_9__6_0 )
    {
      ...
      _9__6_0 = (System_Func_object__bool__o *)sub_1C32E6C(System_Func_GameObject__bool__TypeInfo);
      ...
      sub_1C32BC4((CGThumbnailListItem_o *)&static_fields->__9__6_0, (int32_t)_9__6_0, v20, v21);
    }
    this = (CoinRoomRootComponent__InitUI_d__6_o *)BasicHelper__Find_object_(
                                                     ...
                                                     (const MethodInfo_30C735C *)Method_BasicHelper_Find_GameObject___);
    if ( !this )
      goto LABEL_21;
    v22 = this;
    ...
    this = (CoinRoomRootComponent__InitUI_d__6_o *)UnityEngine_GameObject__GetComponent_object_(
                                                     ...
                                                     (const MethodInfo_3134970 *)Method_UnityEngine_GameObject_GetComponent_CoinRoomLobbyComponent___);
    if ( !_4__this )
      goto LABEL_21;
    if ( !this )
      goto LABEL_21;
    ...
    this = (CoinRoomRootComponent__InitUI_d__6_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39E2904 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    if ( !this )
      goto LABEL_21;
    ...
    if ( _4__this )
    {
      ...
      if ( this )
      {
        Object_object__51111776 = AssetData__GetObject_object__51111776(
                                    (AssetData_o *)this,
                                    (System_String_o *)StringLiteral_14787/*"UIRootPanel"*/,
        ...
        if ( this )
        {
          ...
          sub_1C32BC4((CGThumbnailListItem_o *)&v2->fields._createRoot_5__2, (int32_t)Object, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C32C34(&Method_CoinRoomRootComponent__InitUI_d__6_System_Collections_IEnumerator_Reset__);
  sub_1C32D48(v3, v4);
}
...
void CoinRoomRootComponent___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C32E6C(CoinRoomRootComponent___c_TypeInfo);
  System_Object___ctor(v1, 0);
  CoinRoomRootComponent___c_TypeInfo->static_fields->__9 = (struct CoinRoomRootComponent___c_o *)v1;
  sub_1C32BC4((CGThumbnailListItem_o *)CoinRoomRootComponent___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3B752 & 1) == 0 )
  {
    this = (CoinRoomRootComponent___c_o *)sub_1C32C20(&StringLiteral_8478/*"LobbyPanel"*/);
    byte_4C3B752 = 1;
  }
  if ( !x )
    sub_1C32E7C(this);
  name = UnityEngine_Object__get_name((UnityEngine_Object_o *)x, 0);
  return System_String__op_Equality(name, (System_String_o *)StringLiteral_8478/*"LobbyPanel"*/, 0);
}