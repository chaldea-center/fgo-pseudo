        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C5AB5A & 1) == 0 )
  {
    sub_1C3E564(&CoinRoomRootComponent__InitUI_d__6_TypeInfo);
    byte_4C5AB5A = 1;
  }
  v3 = sub_1C3E7B0(CoinRoomRootComponent__InitUI_d__6_TypeInfo);
...
void CoinRoomRootComponent__beginInitialize(CoinRoomRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C5AB58 & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_CoinRoomRootComponent_EndLoadAsset__);
...
bool CoinRoomRootComponent__InitUI_d__6__MoveNext(CoinRoomRootComponent__InitUI_d__6_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C5AB5D & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_BasicHelper_Find_GameObject___);
    sub_1C3E564(&System_Func_GameObject__bool__TypeInfo);
    sub_1C3E564(&Method_UnityEngine_GameObject_GetComponent_CoinRoomLobbyComponent___);
    sub_1C3E564(&Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    sub_1C3E564(&Method_CoinRoomRootComponent___c__InitUI_b__6_0__);
    sub_1C3E564(&CoinRoomRootComponent___c_TypeInfo);
    this = (CoinRoomRootComponent__InitUI_d__6_o *)sub_1C3E564(&StringLiteral_14798/*"UIRootPanel"*/);
    byte_4C5AB5D = 1;
  }
  ...
  if ( _1__state == 1 )
  {
    ...
    if ( !_9__6_0 )
    {
      ...
      _9__6_0 = (System_Func_object__bool__o *)sub_1C3E7B0(System_Func_GameObject__bool__TypeInfo);
    ...
    this = (CoinRoomRootComponent__InitUI_d__6_o *)BasicHelper__Find_object_(
                                                     ...
                                                     (const MethodInfo_30E39DC *)Method_BasicHelper_Find_GameObject___);
    if ( !this )
      goto LABEL_21;
    v22 = this;
    ...
    this = (CoinRoomRootComponent__InitUI_d__6_o *)UnityEngine_GameObject__GetComponent_object_(
                                                     ...
                                                     (const MethodInfo_31510CC *)Method_UnityEngine_GameObject_GetComponent_CoinRoomLobbyComponent___);
    if ( !_4__this )
      goto LABEL_21;
    if ( !this )
      goto LABEL_21;
    ...
    this = (CoinRoomRootComponent__InitUI_d__6_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39FF5A8 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    if ( !this )
      goto LABEL_21;
    ...
    if ( _4__this )
    {
      ...
      if ( this )
      {
        Object_object__51228128 = AssetData__GetObject_object__51228128(
                                    (AssetData_o *)this,
                                    (System_String_o *)StringLiteral_14798/*"UIRootPanel"*/,
        ...
        if ( this )
        {
          ...
          sub_1C3E508((CGThumbnailListItem_o *)&v2->fields._createRoot_5__2, (int32_t)Object, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C3E578(&Method_CoinRoomRootComponent__InitUI_d__6_System_Collections_IEnumerator_Reset__);
  sub_1C3E68C(v3, v4);
}
...
void CoinRoomRootComponent___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C3E7B0(CoinRoomRootComponent___c_TypeInfo);
  System_Object___ctor(v1, 0);
  CoinRoomRootComponent___c_TypeInfo->static_fields->__9 = (struct CoinRoomRootComponent___c_o *)v1;
  sub_1C3E508((CGThumbnailListItem_o *)CoinRoomRootComponent___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C5AB5C & 1) == 0 )
  {
    this = (CoinRoomRootComponent___c_o *)sub_1C3E564(&StringLiteral_8479/*"LobbyPanel"*/);
    byte_4C5AB5C = 1;
  }
  if ( !x )
    sub_1C3E7C0(this, x);
