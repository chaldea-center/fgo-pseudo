        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0E82 & 1) == 0 )
  {
    sub_B52984(&CoinRoomRootComponent__InitUI_d__7_TypeInfo);
    byte_42B0E82 = 1;
  }
  v3 = sub_B52A54(CoinRoomRootComponent__InitUI_d__7_TypeInfo);
...
void __fastcall CoinRoomRootComponent__beginInitialize(CoinRoomRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B0E80 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_CoinRoomRootComponent_EndLoadAsset__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AD6F2 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_BasicHelper_Find_GameObject___);
    sub_B52984(&Method_System_Func_GameObject__bool___ctor__);
    sub_B52984(&System_Func_GameObject__bool__TypeInfo);
    sub_B52984(&Method_UnityEngine_GameObject_GetComponent_CoinRoomLobbyComponent___);
    sub_B52984(&Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    sub_B52984(&Method_CoinRoomRootComponent___c__InitUI_b__7_0__);
    sub_B52984(&CoinRoomRootComponent___c_TypeInfo);
    this = (CoinRoomRootComponent__InitUI_d__7_o *)sub_B52984(&StringLiteral_14787/*"UIRootPanel"*/);
    byte_42AD6F2 = 1;
  }
  ...
  if ( _1__state == 1 )
  {
    ...
    if ( !_9__7_0 )
    {
      ...
      _9__7_0 = (System_Func_WarBoardManager_WarBoardOnboardSkillTarget__bool__o *)sub_B52A54(System_Func_GameObject__bool__TypeInfo);
    ...
    this = (CoinRoomRootComponent__InitUI_d__7_o *)BasicHelper__Find_USFGOActorBattleActionEventConditional_OverwriteParamCondition_(
                                                     ...
                                                     (const MethodInfo_1A421B0 *)Method_BasicHelper_Find_GameObject___);
    if ( !this )
      goto LABEL_23;
    ...
    this = (CoinRoomRootComponent__InitUI_d__7_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                     v16,
                                                     (const MethodInfo_1B7B1B8 *)Method_UnityEngine_GameObject_GetComponent_CoinRoomLobbyComponent___);
    if ( !_4__this )
      goto LABEL_23;
    if ( !this )
      goto LABEL_23;
    ...
    this = (CoinRoomRootComponent__InitUI_d__7_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    if ( !this )
      goto LABEL_23;
      ...
      if ( this )
      {
        ...
        if ( this )
        {
          ...
          v2->fields._createRoot_5__2 = BaseMonoBehaviour__createObject(
                                          ...
                                          0LL,
                                          0LL);
          sub_B52920(&v2->fields._createRoot_5__2);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_B52988(&Method_CoinRoomRootComponent__InitUI_d__7_System_Collections_IEnumerator_Reset__);
  sub_B52A28(v3, v4);
}
...
void __fastcall CoinRoomRootComponent___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_B52A54(CoinRoomRootComponent___c_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AD6F1 & 1) == 0 )
  {
    this = (CoinRoomRootComponent___c_o *)sub_B52984(&StringLiteral_8615/*"LobbyPanel"*/);
    byte_42AD6F1 = 1;
  }
  if ( !x )
    sub_B52A5C(this, x);
  name = UnityEngine_Object__get_name((UnityEngine_Object_o *)x, 0LL);
  return System_String__op_Equality(name, (System_String_o *)StringLiteral_8615/*"LobbyPanel"*/, 0LL);
}