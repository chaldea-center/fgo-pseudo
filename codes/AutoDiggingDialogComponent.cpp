...
void AutoDiggingDialogComponent__EndClose(AutoDiggingDialogComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC1A07 & 1) == 0 )
  {
    sub_1C713B0(&Method_BasicHelper_Shuffle_DiggingBlockComponent___);
    byte_4CC1A07 = 1;
  }
  ...
  if ( closeCallbackFunc )
  {
    ...
    v4 = BasicHelper__Shuffle_object_(
           ...
           (const MethodInfo_313A334 *)Method_BasicHelper_Shuffle_DiggingBlockComponent___);
        ...
        const MethodInfo *method)
{
  ...
  v6 = (System_Collections_Generic_List_object__o *)sub_1C715FC(System_Collections_Generic_List_DiggingBlockComponent__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC1A04 & 1) == 0 )
  {
    sub_1C713B0(&Method_System_Collections_Generic_List_DiggingBlockComponent__Add__);
    sub_1C713B0(&Method_System_Collections_Generic_List_DiggingBlockComponent___ctor__);
    sub_1C713B0(&Method_System_Collections_Generic_List_DiggingBlockComponent__get_Count__);
    sub_1C713B0(&Method_System_Collections_Generic_List_DiggingBlockComponent__get_Item__);
    ...
    while ( consumeList )
    {
      ...
      if ( userItemNum - (int)Item >= 0 )
      {
        Item = System_Collections_Generic_List_object___get_Item(
                 (System_Collections_Generic_List_object__o *)blockList,
                 v13,
                 (const MethodInfo_3810448 *)Method_System_Collections_Generic_List_DiggingBlockComponent__get_Item__);
        if ( !v10 )
          break;
...
void AutoDiggingDialogComponent__OnClickCloseBtn(AutoDiggingDialogComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC1A06 & 1) == 0 )
  {
    sub_1C713B0(&Method_AutoDiggingDialogComponent_OnClickCloseBtn__);
    byte_4CC1A06 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_AutoDiggingDialogComponent_OnClickCloseBtn__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C713C8(Method_AutoDiggingDialogComponent_OnClickCloseBtn__);
...
void AutoDiggingDialogComponent__OnClickDecideBtn(AutoDiggingDialogComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC1A05 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_AutoDiggingDialogComponent_EndClose__);
    sub_1C713B0(&Method_AutoDiggingDialogComponent_OnClickDecideBtn__);
    byte_4CC1A05 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_AutoDiggingDialogComponent_OnClickDecideBtn__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C713C8(Method_AutoDiggingDialogComponent_OnClickDecideBtn__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C71394(v3, v3[4]);
    ...
    if ( activateMaskPanel )
    {
      *p_activateMaskPanel = 0;
      sub_1C71354(p_activateMaskPanel, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC19FF & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_AutoDiggingDialogComponent__Open_b__17_0__);
    ...
    sub_1C713B0(&Method_System_Collections_Generic_List_Enumerator_DiggingBlockComponent__get_Current__);
    sub_1C713B0(&Method_System_Collections_Generic_List_DiggingBlockComponent__AddRange__);
    sub_1C713B0(&Method_System_Collections_Generic_List_int__Add__);
    sub_1C713B0(&Method_System_Collections_Generic_List_DiggingBlockComponent__GetEnumerator__);
    ...
    sub_1C713B0(&Method_System_Collections_Generic_List_DiggingBlockComponent___ctor__);
    sub_1C713B0(&Method_System_Collections_Generic_List_DiggingBlockComponent__get_Count__);
    sub_1C713B0(&Method_System_Collections_Generic_List_List_DiggingBlockComponent___get_Item__);
    sub_1C713B0(&System_Collections_Generic_List_int__TypeInfo);
    sub_1C713B0(&System_Collections_Generic_List_DiggingBlockComponent__TypeInfo);
    sub_1C713B0(&LocalizationManager_TypeInfo);
    sub_1C713B0(&NetworkManager_TypeInfo);
    sub_1C713B0(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    sub_1C713B0(&StringLiteral_4994/*"DIGGING_CONFIRM_DIALOG_POSSESSION"*/);
    sub_1C713B0(&StringLiteral_2050/*"AUTO_DIGGING_CONFIRM_DIALOG_MESSAGE"*/);
    sub_1C713B0(&StringLiteral_4992/*"DIGGING_CONFIRM_DIALOG_CONSUME"*/);
    sub_1C713B0(&StringLiteral_2052/*"AUTO_DIGGING_CONFIRM_DIALOG_TITLE"*/);
    sub_1C713B0(&StringLiteral_2051/*"AUTO_DIGGING_CONFIRM_DIALOG_SUB_TITLE"*/);
    ...
    sub_1C713B0(&StringLiteral_2053/*"AUTO_DIGGING_CONFIRM_DIALOG_WARNING_MESSAGE"*/);
  ...
  System_Collections_Generic_List_int____ctor(
    v7,
    (const MethodInfo_37F2EA0 *)Method_System_Collections_Generic_List_int___ctor__);
  v8 = (System_Collections_Generic_List_object__o *)sub_1C715FC(System_Collections_Generic_List_DiggingBlockComponent__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v8,
    (const MethodInfo_380FEE4 *)Method_System_Collections_Generic_List_DiggingBlockComponent___ctor__);
  this->fields.autoDiggingBlockList = (struct System_Collections_Generic_List_DiggingBlockComponent__o *)v8;
  Instance = sub_1C71354(&this->fields.autoDiggingBlockList, v8);
  ...
  {
    v16 = (System_Collections_Generic_List_object__o *)sub_1C715FC(System_Collections_Generic_List_DiggingBlockComponent__TypeInfo);
    System_Collections_Generic_List_object____ctor(
      v16,
      (const MethodInfo_380FEE4 *)Method_System_Collections_Generic_List_DiggingBlockComponent___ctor__);
    ...
    while ( 1 )
    {
      ...
      if ( v15 == LODWORD(v71.fields._current[5].monitor) )
      {
        ...
        monitor = current[4].monitor;
        if ( !monitor )
          sub_1C71608(MasterData_object, v24);
        if ( !MasterData_object )
          sub_1C71608(0, v24);
        v26 = DataMasterBase_object__object__int___GetEntity(
                ...
                monitor[6],
                (const MethodInfo_3408E80 *)Method_DataMasterBase_EventDiggingBlockMaster__EventDiggingBlockEntity__int__GetEntity__);
        v27 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A5F158 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
        if ( !v27 )
          sub_1C71608(0, v28);
...
LABEL_22:
    ...
    if ( (Instance & 1) != 0 )
    {
      ...
      Item = System_Collections_Generic_List_object___get_Item(
               v14,
               v15,
               (const MethodInfo_3810448 *)Method_System_Collections_Generic_List_List_DiggingBlockComponent___get_Item__);
...
LABEL_101:
    ...
    else
    {
      ...
      System_Collections_Generic_List_object___AddRange(
        ...
        (const MethodInfo_3810924 *)Method_System_Collections_Generic_List_DiggingBlockComponent__AddRange__);
      v67 = 1;
    }
    v13 = this->fields.itemIcon;
    ++v15;
  ...
  Instance = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_11101/*"RESET_DIGGING_CONFIRM_DIALOG_DECIDE"*/, 0);
  if ( !v50 )
    goto LABEL_100;
  UILabel__set_text(v50, (System_String_o *)Instance, 0);
  Instance = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_11100/*"RESET_DIGGING_CONFIRM_DIALOG_CANCEL"*/, 0);
  ...
  Instance = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_4992/*"DIGGING_CONFIRM_DIALOG_CONSUME"*/, 0);
  if ( !consumeLabel )
    goto LABEL_100;
  UILabel__set_text(consumeLabel, (System_String_o *)Instance, 0);
  possessionLabel = this->fields.possessionLabel;
  Instance = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_4994/*"DIGGING_CONFIRM_DIALOG_POSSESSION"*/, 0);
  if ( !possessionLabel )
    goto LABEL_100;
  UILabel__set_text(possessionLabel, (System_String_o *)Instance, 0);
  titleLabel = this->fields.titleLabel;
  Instance = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_2052/*"AUTO_DIGGING_CONFIRM_DIALOG_TITLE"*/, 0);
  if ( !titleLabel )
    goto LABEL_100;
  UILabel__set_text(titleLabel, (System_String_o *)Instance, 0);
  subTitleLabel = this->fields.subTitleLabel;
  Instance = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_2051/*"AUTO_DIGGING_CONFIRM_DIALOG_SUB_TITLE"*/, 0);
  if ( !subTitleLabel )
    goto LABEL_100;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v57 = (System_String_o **)&StringLiteral_2050/*"AUTO_DIGGING_CONFIRM_DIALOG_MESSAGE"*/;
  if ( (v67 & 1) == 0 )
    v57 = (System_String_o **)&StringLiteral_2053/*"AUTO_DIGGING_CONFIRM_DIALOG_WARNING_MESSAGE"*/;
        ...
        const MethodInfo *method)
{
  ...
  if ( !decideButton
    || (decideButton = (UnityEngine_Component_o *)UnityEngine_Component__GetComponent_object_(
                                                    decideButton,
                                                    (const MethodInfo_31418DC *)Method_UnityEngine_Component_GetComponent_UICommonButton___)) == 0
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC1A01 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_System_Collections_Generic_List_Enumerator_DiggingBlockComponent__MoveNext__);
    sub_1C713B0(&Method_System_Collections_Generic_List_Enumerator_DiggingBlockComponent__get_Current__);
    sub_1C713B0(&Method_System_Collections_Generic_List_List_DiggingBlockComponent___Add__);
    sub_1C713B0(&Method_System_Collections_Generic_List_DiggingBlockComponent__Add__);
    sub_1C713B0(&Method_System_Collections_Generic_List_DiggingBlockComponent__GetEnumerator__);
    sub_1C713B0(&Method_System_Collections_Generic_List_List_DiggingBlockComponent____ctor__);
    sub_1C713B0(&Method_System_Collections_Generic_List_DiggingBlockComponent___ctor__);
    sub_1C713B0(&System_Collections_Generic_List_List_DiggingBlockComponent___TypeInfo);
    sub_1C713B0(&System_Collections_Generic_List_DiggingBlockComponent__TypeInfo);
    byte_4CC1A01 = 1;
  }
  memset(&v25, 0, sizeof(v25));
  v6 = (System_Collections_Generic_List_object__o *)sub_1C715FC(System_Collections_Generic_List_List_DiggingBlockComponent___TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v6,
    (const MethodInfo_380FEE4 *)Method_System_Collections_Generic_List_List_DiggingBlockComponent____ctor__);
  if ( blockKindNum >= 1 )
  {
    v7 = 0;
    do
