void __fastcall EventRewardGuideReleaseMaster___ctor(EventRewardGuideReleaseMaster_o *this, const MethodInfo *method)
{
  ...
  DataMasterBase_object__object__object____ctor(
    ...
    267,
    (const MethodInfo_324AE0C *)Method_DataMasterBase_EventRewardGuideReleaseMaster__EventRewardGuideReleaseEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC7BAE & 1) == 0 )
  {
    sub_1C1ABD4(
      ...
      *(_QWORD *)&eventId);
    sub_1C1ABD4(&Method_System_Collections_ObjectModel_Collection_EventRewardGuideReleaseEntity__get_Item__, v5);
    sub_1C1ABD4(&System_Comparison_EventRewardGuideReleaseEntity__TypeInfo, v6);
    sub_1C1ABD4(&Method_System_Collections_Generic_List_EventRewardGuideReleaseEntity__Add__, v7);
    sub_1C1ABD4(&Method_System_Collections_Generic_List_EventRewardGuideReleaseEntity__Sort__, v8);
    sub_1C1ABD4(&Method_System_Collections_Generic_List_EventRewardGuideReleaseEntity__ToArray__, v9);
    sub_1C1ABD4(&Method_System_Collections_Generic_List_EventRewardGuideReleaseEntity___ctor__, v10);
    sub_1C1ABD4(&System_Collections_Generic_List_EventRewardGuideReleaseEntity__TypeInfo, v11);
    sub_1C1ABD4(&Method_EventRewardGuideReleaseMaster___c__GetEntities_b__3_0__, v12);
    sub_1C1ABD4(&EventRewardGuideReleaseMaster___c_TypeInfo, v13);
    byte_4BC7BAE = 1;
  }
  v14 = (System_Collections_Generic_List_object__o *)sub_1C1AE20(System_Collections_Generic_List_EventRewardGuideReleaseEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v14,
    (const MethodInfo_363C05C *)Method_System_Collections_Generic_List_EventRewardGuideReleaseEntity___ctor__);
  ...
  while ( v17 < System_Collections_ObjectModel_Collection_object___get_Count(
                  ...
                  (const MethodInfo_31E297C *)Method_System_Collections_ObjectModel_Collection_EventRewardGuideReleaseEntity__get_Count__) )
  {
    list = this->fields.list;
    if ( !list )
      goto LABEL_24;
    list = System_Collections_ObjectModel_Collection_object___get_Item(
             (System_Collections_ObjectModel_Collection_T__o *)list,
             v17,
             (const MethodInfo_31E2A0C *)Method_System_Collections_ObjectModel_Collection_EventRewardGuideReleaseEntity__get_Item__);
    if ( list )
    {
      v15 = (int64_t)list;
  ...
  if ( !v28 )
  {
    ...
    v28 = (System_Comparison_T__o *)sub_1C1AE20(System_Comparison_EventRewardGuideReleaseEntity__TypeInfo);
...
LABEL_24:
  ...
  System_Collections_Generic_List_object___Sort_56877908(
    v14,
    v28,
    (const MethodInfo_363E354 *)Method_System_Collections_Generic_List_EventRewardGuideReleaseEntity__Sort__);
  return (EventRewardGuideReleaseEntity_array *)System_Collections_Generic_List_object___ToArray(
                                                  v14,
                                                  (const MethodInfo_363E3E8 *)Method_System_Collections_Generic_List_EventRewardGuideReleaseEntity__ToArray__);
}


// local variable allocation has failed, the output may be wrong!
EventRewardGuideReleaseEntity_array *__fastcall EventRewardGuideReleaseMaster__GetEntities_40450908(
        EventRewardGuideReleaseMaster_o *this,
        int32_t eventId,
        int32_t slot,
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC7BAF & 1) == 0 )
  {
    sub_1C1ABD4(&Method_System_Collections_Generic_List_EventRewardGuideReleaseEntity__Add__, *(_QWORD *)&eventId);
    sub_1C1ABD4(&Method_System_Collections_Generic_List_EventRewardGuideReleaseEntity__ToArray__, v7);
    sub_1C1ABD4(&Method_System_Collections_Generic_List_EventRewardGuideReleaseEntity___ctor__, v8);
    sub_1C1ABD4(&System_Collections_Generic_List_EventRewardGuideReleaseEntity__TypeInfo, v9);
    byte_4BC7BAF = 1;
  }
  Entities = EventRewardGuideReleaseMaster__GetEntities(this, eventId, *(const MethodInfo **)&slot);
  v11 = (System_Collections_Generic_List_object__o *)sub_1C1AE20(System_Collections_Generic_List_EventRewardGuideReleaseEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v11,
    (const MethodInfo_363C05C *)Method_System_Collections_Generic_List_EventRewardGuideReleaseEntity___ctor__);
  if ( !Entities )
        ...
        const MethodInfo *method)
{
  ...
  return (EventRewardGuideReleaseEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                              (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                              PK,
                                              (const MethodInfo_324D130 *)Method_DataMasterBase_EventRewardGuideReleaseMaster__EventRewardGuideReleaseEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_324D17C *)Method_DataMasterBase_EventRewardGuideReleaseMaster__EventRewardGuideReleaseEntity__string__TryGetEntity__);
}
...
void __fastcall EventRewardGuideReleaseMaster___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BC7BB0 & 1) == 0 )
  {
    sub_1C1ABD4(&EventRewardGuideReleaseMaster___c_TypeInfo, v1);
    byte_4BC7BB0 = 1;
  }
  v2 = (Il2CppObject *)sub_1C1AE20(EventRewardGuideReleaseMaster___c_TypeInfo);
