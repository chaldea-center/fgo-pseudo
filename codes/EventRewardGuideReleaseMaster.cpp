void __fastcall EventRewardGuideReleaseMaster___ctor(EventRewardGuideReleaseMaster_o *this, const MethodInfo *method)
{
  ...
  DataMasterBase_object__object__object____ctor(
    ...
    262,
    (const MethodInfo_2FE6D64 *)Method_DataMasterBase_EventRewardGuideReleaseMaster__EventRewardGuideReleaseEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E2919 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&System_Comparison_EventRewardGuideReleaseEntity__TypeInfo, v6);
    sub_1B00CCC(&EventRewardGuideReleaseEntity_TypeInfo, v7);
    sub_1B00CCC(&Method_System_Collections_Generic_List_EventRewardGuideReleaseEntity__Add__, v8);
    sub_1B00CCC(&Method_System_Collections_Generic_List_EventRewardGuideReleaseEntity__Sort__, v9);
    sub_1B00CCC(&Method_System_Collections_Generic_List_EventRewardGuideReleaseEntity__ToArray__, v10);
    sub_1B00CCC(&Method_System_Collections_Generic_List_EventRewardGuideReleaseEntity___ctor__, v11);
    sub_1B00CCC(&System_Collections_Generic_List_EventRewardGuideReleaseEntity__TypeInfo, v12);
    sub_1B00CCC(&Method_EventRewardGuideReleaseMaster___c__GetEntities_b__3_0__, v13);
    sub_1B00CCC(&EventRewardGuideReleaseMaster___c_TypeInfo, v14);
    byte_48E2919 = 1;
  }
  v15 = (System_Collections_Generic_List_object__o *)sub_1B00F18(System_Collections_Generic_List_EventRewardGuideReleaseEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v15,
    (const MethodInfo_33C119C *)Method_System_Collections_Generic_List_EventRewardGuideReleaseEntity___ctor__);
  ...
  if ( !v26 )
  {
    ...
    v26 = (System_Comparison_T__o *)sub_1B00F18(System_Comparison_EventRewardGuideReleaseEntity__TypeInfo);
    ...
    sub_1B00C70((ServantStatusBattleListViewItem_o *)&static_fields->__9__3_0, (int32_t)v26, v29, v30);
  }
  if ( !v15 )
LABEL_26:
  ...
  System_Collections_Generic_List_object___Sort_54277268(
    v15,
    v26,
    (const MethodInfo_33C3494 *)Method_System_Collections_Generic_List_EventRewardGuideReleaseEntity__Sort__);
  return (EventRewardGuideReleaseEntity_array *)System_Collections_Generic_List_object___ToArray(
                                                  v15,
                                                  (const MethodInfo_33C3528 *)Method_System_Collections_Generic_List_EventRewardGuideReleaseEntity__ToArray__);
}


// local variable allocation has failed, the output may be wrong!
EventRewardGuideReleaseEntity_array *__fastcall EventRewardGuideReleaseMaster__GetEntities_38011460(
        EventRewardGuideReleaseMaster_o *this,
        int32_t eventId,
        int32_t slot,
        const MethodInfo *method)
{
  ...
  if ( (byte_48E291A & 1) == 0 )
  {
    sub_1B00CCC(&Method_System_Collections_Generic_List_EventRewardGuideReleaseEntity__Add__, *(_QWORD *)&eventId);
    sub_1B00CCC(&Method_System_Collections_Generic_List_EventRewardGuideReleaseEntity__ToArray__, v7);
    sub_1B00CCC(&Method_System_Collections_Generic_List_EventRewardGuideReleaseEntity___ctor__, v8);
    sub_1B00CCC(&System_Collections_Generic_List_EventRewardGuideReleaseEntity__TypeInfo, v9);
    byte_48E291A = 1;
  }
  Entities = EventRewardGuideReleaseMaster__GetEntities(this, eventId, *(const MethodInfo **)&slot);
  v11 = (System_Collections_Generic_List_object__o *)sub_1B00F18(System_Collections_Generic_List_EventRewardGuideReleaseEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v11,
    (const MethodInfo_33C119C *)Method_System_Collections_Generic_List_EventRewardGuideReleaseEntity___ctor__);
  if ( !Entities )
        ...
        const MethodInfo *method)
{
  ...
  return (EventRewardGuideReleaseEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                              (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                              PK,
                                              (const MethodInfo_2FE6DA4 *)Method_DataMasterBase_EventRewardGuideReleaseMaster__EventRewardGuideReleaseEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_2FE6DF4 *)Method_DataMasterBase_EventRewardGuideReleaseMaster__EventRewardGuideReleaseEntity__string__TryGetEntity__);
}
...
void __fastcall EventRewardGuideReleaseMaster___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48E291B & 1) == 0 )
  {
    sub_1B00CCC(&EventRewardGuideReleaseMaster___c_TypeInfo, v1);
    byte_48E291B = 1;
  }
  v2 = (Il2CppObject *)sub_1B00F18(EventRewardGuideReleaseMaster___c_TypeInfo);
