void __fastcall EventRewardGuideReleaseMaster___ctor(EventRewardGuideReleaseMaster_o *this, const MethodInfo *method)
{
  ...
  DataMasterBase_object__object__object____ctor(
    ...
    269,
    (const MethodInfo_3216A14 *)Method_DataMasterBase_EventRewardGuideReleaseMaster__EventRewardGuideReleaseEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4E5A6 & 1) == 0 )
  {
    sub_1B863B8(
      ...
      *(_QWORD *)&eventId);
    sub_1B863B8(&Method_System_Collections_ObjectModel_Collection_EventRewardGuideReleaseEntity__get_Item__, v5);
    sub_1B863B8(&System_Comparison_EventRewardGuideReleaseEntity__TypeInfo, v6);
    sub_1B863B8(&Method_System_Collections_Generic_List_EventRewardGuideReleaseEntity__Add__, v7);
    sub_1B863B8(&Method_System_Collections_Generic_List_EventRewardGuideReleaseEntity__Sort__, v8);
    sub_1B863B8(&Method_System_Collections_Generic_List_EventRewardGuideReleaseEntity__ToArray__, v9);
    sub_1B863B8(&Method_System_Collections_Generic_List_EventRewardGuideReleaseEntity___ctor__, v10);
    sub_1B863B8(&System_Collections_Generic_List_EventRewardGuideReleaseEntity__TypeInfo, v11);
    sub_1B863B8(&Method_EventRewardGuideReleaseMaster___c__GetEntities_b__3_0__, v12);
    sub_1B863B8(&EventRewardGuideReleaseMaster___c_TypeInfo, v13);
    byte_4A4E5A6 = 1;
  }
  v14 = (System_Collections_Generic_List_object__o *)sub_1B86604(System_Collections_Generic_List_EventRewardGuideReleaseEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v14,
    (const MethodInfo_35FC124 *)Method_System_Collections_Generic_List_EventRewardGuideReleaseEntity___ctor__);
  ...
  while ( v17 < System_Collections_ObjectModel_Collection_object___get_Count(
                  ...
                  (const MethodInfo_31B0908 *)Method_System_Collections_ObjectModel_Collection_EventRewardGuideReleaseEntity__get_Count__) )
  {
    list = this->fields.list;
    if ( !list )
      goto LABEL_24;
    list = System_Collections_ObjectModel_Collection_object___get_Item(
             (System_Collections_ObjectModel_Collection_T__o *)list,
             v17,
             (const MethodInfo_31B0998 *)Method_System_Collections_ObjectModel_Collection_EventRewardGuideReleaseEntity__get_Item__);
    if ( list )
    {
  ...
  if ( !v24 )
  {
    ...
    v24 = (System_Comparison_T__o *)sub_1B86604(System_Comparison_EventRewardGuideReleaseEntity__TypeInfo);
...
LABEL_24:
  ...
  System_Collections_Generic_List_object___Sort_56615964(
    v14,
    v24,
    (const MethodInfo_35FE41C *)Method_System_Collections_Generic_List_EventRewardGuideReleaseEntity__Sort__);
  return (EventRewardGuideReleaseEntity_array *)System_Collections_Generic_List_object___ToArray(
                                                  v14,
                                                  (const MethodInfo_35FE4B0 *)Method_System_Collections_Generic_List_EventRewardGuideReleaseEntity__ToArray__);
}


// local variable allocation has failed, the output may be wrong!
EventRewardGuideReleaseEntity_array *__fastcall EventRewardGuideReleaseMaster__GetEntities_40220528(
        EventRewardGuideReleaseMaster_o *this,
        int32_t eventId,
        int32_t slot,
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4E5A7 & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Collections_Generic_List_EventRewardGuideReleaseEntity__Add__, *(_QWORD *)&eventId);
    sub_1B863B8(&Method_System_Collections_Generic_List_EventRewardGuideReleaseEntity__ToArray__, v7);
    sub_1B863B8(&Method_System_Collections_Generic_List_EventRewardGuideReleaseEntity___ctor__, v8);
    sub_1B863B8(&System_Collections_Generic_List_EventRewardGuideReleaseEntity__TypeInfo, v9);
    byte_4A4E5A7 = 1;
  }
  Entities = EventRewardGuideReleaseMaster__GetEntities(this, eventId, *(const MethodInfo **)&slot);
  v11 = (System_Collections_Generic_List_object__o *)sub_1B86604(System_Collections_Generic_List_EventRewardGuideReleaseEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v11,
    (const MethodInfo_35FC124 *)Method_System_Collections_Generic_List_EventRewardGuideReleaseEntity___ctor__);
  if ( !Entities )
        ...
        const MethodInfo *method)
{
  ...
  return (EventRewardGuideReleaseEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                              (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                              PK,
                                              (const MethodInfo_3218D38 *)Method_DataMasterBase_EventRewardGuideReleaseMaster__EventRewardGuideReleaseEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_3218D84 *)Method_DataMasterBase_EventRewardGuideReleaseMaster__EventRewardGuideReleaseEntity__string__TryGetEntity__);
}
...
void __fastcall EventRewardGuideReleaseMaster___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A4E5A8 & 1) == 0 )
  {
    sub_1B863B8(&EventRewardGuideReleaseMaster___c_TypeInfo, v1);
    byte_4A4E5A8 = 1;
  }
  v2 = (Il2CppObject *)sub_1B86604(EventRewardGuideReleaseMaster___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  EventRewardGuideReleaseMaster___c_TypeInfo->static_fields->__9 = (struct EventRewardGuideReleaseMaster___c_o *)v2;
  sub_1B8635C((CGThumbnailListItem_o *)EventRewardGuideReleaseMaster___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
