        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17BD3 & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&StringLiteral_22830/*"present/history"*/, v3, v4);
    byte_4B17BD3 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62401220(BaseUrl, (System_String_o *)StringLiteral_22830/*"present/history"*/, 0LL);
}