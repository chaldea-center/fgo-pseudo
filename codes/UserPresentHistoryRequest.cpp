        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB7708 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_22626/*"present/history"*/, v2);
    byte_4AB7708 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62048128(BaseUrl, (System_String_o *)StringLiteral_22626/*"present/history"*/, 0LL);
}