...
void __fastcall SupportSelectEditMenu__Close(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BF9FA4 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_SupportSelectEditMenu_OnFinishedClose__, v3);
    byte_4BF9FA4 = 1;
  }
  this->fields.currentState = 2;
...
void __fastcall SupportSelectEditMenu__OnClickCancel(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BF9FAB & 1) == 0 )
  {
    sub_1C2E12C(&Method_SupportSelectEditMenu_OnClickCancel__, method);
    byte_4BF9FAB = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectEditMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2E144(Method_SupportSelectEditMenu_OnClickCancel__);
...
void __fastcall SupportSelectEditMenu__OnClickChangeName(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BF9FAA & 1) == 0 )
  {
    sub_1C2E12C(&Method_SupportSelectEditMenu_OnClickChangeName__, method);
    byte_4BF9FAA = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectEditMenu_OnClickChangeName__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2E144(Method_SupportSelectEditMenu_OnClickChangeName__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C2E110(v3, v3[4]);
...
void __fastcall SupportSelectEditMenu__OnClickCopy(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BF9FA6 & 1) == 0 )
  {
    sub_1C2E12C(&Method_SupportSelectEditMenu_OnClickCopy__, method);
    byte_4BF9FA6 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectEditMenu_OnClickCopy__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2E144(Method_SupportSelectEditMenu_OnClickCopy__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C2E110(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
    onClickButton = this->fields.onClickButton;
    if ( onClickButton )
...
void __fastcall SupportSelectEditMenu__OnClickInitAll(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BF9FA8 & 1) == 0 )
  {
    sub_1C2E12C(&Method_SupportSelectEditMenu_OnClickInitAll__, method);
    byte_4BF9FA8 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectEditMenu_OnClickInitAll__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2E144(Method_SupportSelectEditMenu_OnClickInitAll__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C2E110(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
    onClickButton = this->fields.onClickButton;
    if ( onClickButton )
...
void __fastcall SupportSelectEditMenu__OnClickRemoveAll(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BF9FA7 & 1) == 0 )
  {
    sub_1C2E12C(&Method_SupportSelectEditMenu_OnClickRemoveAll__, method);
    byte_4BF9FA7 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectEditMenu_OnClickRemoveAll__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2E144(Method_SupportSelectEditMenu_OnClickRemoveAll__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C2E110(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
    onClickButton = this->fields.onClickButton;
    if ( onClickButton )
...
void __fastcall SupportSelectEditMenu__OnClickRemoveEquip(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BF9FA9 & 1) == 0 )
  {
    sub_1C2E12C(&Method_SupportSelectEditMenu_OnClickRemoveEquip__, method);
    byte_4BF9FA9 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectEditMenu_OnClickRemoveEquip__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2E144(Method_SupportSelectEditMenu_OnClickRemoveEquip__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C2E110(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
    onClickButton = this->fields.onClickButton;
    if ( onClickButton )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF9FA3 & 1) == 0 )
  {
    sub_1C2E12C(&System_Action_TypeInfo, deckData);
    sub_1C2E12C(&LocalizationManager_TypeInfo, v12);
    sub_1C2E12C(&Method_SupportSelectEditMenu_OnFinishedOpen__, v13);
    sub_1C2E12C(&StringLiteral_12695/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_REMOVE_EQUIP"*/, v14);
    sub_1C2E12C(&StringLiteral_12692/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_COPY"*/, v15);
    sub_1C2E12C(&StringLiteral_12693/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_INIT_ALL"*/, v16);
    sub_1C2E12C(&StringLiteral_12698/*"SUPPORT_SELECT_EDIT_MENU_TITLE"*/, v17);
    sub_1C2E12C(&StringLiteral_12696/*"SUPPORT_SELECT_EDIT_MENU_DECK_NAME"*/, v18);
    sub_1C2E12C(&StringLiteral_12694/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_REMOVE_ALL"*/, v19);
    sub_1C2E12C(&StringLiteral_12691/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_CHANGE_DECK_NAME"*/, v20);
    sub_1C2E12C(&StringLiteral_12690/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_CANCEL"*/, v21);
    sub_1C2E12C(&StringLiteral_12697/*"SUPPORT_SELECT_EDIT_MENU_MESSAGE"*/, v22);
    byte_4BF9FA3 = 1;
  }
  if ( deckData && this->fields.currentState == 2 )
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12698/*"SUPPORT_SELECT_EDIT_MENU_TITLE"*/, 0LL);
    if ( !titleLabel )
      goto LABEL_32;
    UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL);
    supportNameLabel = this->fields.supportNameLabel;
    v27 = LocalizationManager__Get((System_String_o *)StringLiteral_12696/*"SUPPORT_SELECT_EDIT_MENU_DECK_NAME"*/, 0LL);
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12697/*"SUPPORT_SELECT_EDIT_MENU_MESSAGE"*/, 0LL);
    if ( !messageLabel )
      goto LABEL_32;
    ...
    SupportSelectEditMenu__SetButtonText(v29, this->fields.copyButton, (System_String_o *)StringLiteral_12692/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_COPY"*/, v30);
    ...
    SupportSelectEditMenu__SetButtonText(v33, this->fields.removeAllButton, (System_String_o *)StringLiteral_12694/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_REMOVE_ALL"*/, v34);
    ...
    v36 = (SupportSelectEditMenu_o *)((__int64 (__fastcall *)(UnityEngine_GameObject_o *, __int64, __int64, Il2CppRuntimeInterfaceOffsetPair *))gameObject->klass[1]._1.implementedInterfaces)(
                                       ...
                                       1LL,
                                       gameObject->klass[1]._1.interfaceOffsets);
    SupportSelectEditMenu__SetButtonText(v36, this->fields.initAllButton, (System_String_o *)StringLiteral_12693/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_INIT_ALL"*/, v37);
    ...
    SupportSelectEditMenu__SetButtonText(
      v40,
      this->fields.removeEquipButton,
      (System_String_o *)StringLiteral_12695/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_REMOVE_EQUIP"*/,
      v41);
...
LABEL_32:
    ...
    SupportSelectEditMenu__SetButtonText(
      ...
      (System_String_o *)StringLiteral_12691/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_CHANGE_DECK_NAME"*/,
      v43);
    SupportSelectEditMenu__SetButtonText(v44, this->fields.cancelButton, (System_String_o *)StringLiteral_12690/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_CANCEL"*/, v45);
        ...
        const MethodInfo *method)
{
  __int64 v6; // x1
  __int64 v7; // x1
  Il2CppObject *ComponentInChildren_object__50103608; // x20

  if ( (byte_4BF9FA5 & 1) == 0 )
  {
    sub_1C2E12C(&Method_UnityEngine_Component_GetComponentInChildren_UILabel___, target);
    sub_1C2E12C(&LocalizationManager_TypeInfo, v6);
    this = (SupportSelectEditMenu_o *)sub_1C2E12C(&UnityEngine_Object_TypeInfo, v7);
    byte_4BF9FA5 = 1;
  }
  if ( !target )
    goto LABEL_12;
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)ComponentInChildren_object__50103608, 0LL, 0LL) )
  {
    ...
    {
      UILabel__set_text((UILabel_o *)ComponentInChildren_object__50103608, (System_String_o *)this, 0LL);
      return;
    }
LABEL_12:
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A6BFDC;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A6BF94;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF9FAE & 1) == 0 )
  {
    sub_1C2E12C(&SupportSelectEditMenu_ResultKind_TypeInfo, *(_QWORD *)&result);
    byte_4BF9FAE = 1;
  }
  v9[1] = 0LL;
