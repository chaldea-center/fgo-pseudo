...
void SupportSelectEditMenu__Close(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596CC3F & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_SupportSelectEditMenu_OnFinishedClose__);
    byte_596CC3F = 1;
  }
...
void SupportSelectEditMenu__OnClickCancel(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596CC46 & 1) == 0 )
  {
    sub_2213A60(&Method_SupportSelectEditMenu_OnClickCancel__);
    byte_596CC46 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectEditMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_2213A78(Method_SupportSelectEditMenu_OnClickCancel__);
...
void SupportSelectEditMenu__OnClickChangeName(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596CC45 & 1) == 0 )
  {
    sub_2213A60(&Method_SupportSelectEditMenu_OnClickChangeName__);
    byte_596CC45 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectEditMenu_OnClickChangeName__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_2213A78(Method_SupportSelectEditMenu_OnClickChangeName__);
    v4 = (System_Reflection_MethodBase_o *)sub_2213A44(v3, v3[4]);
...
void SupportSelectEditMenu__OnClickCopy(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596CC41 & 1) == 0 )
  {
    sub_2213A60(&Method_SupportSelectEditMenu_OnClickCopy__);
    byte_596CC41 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectEditMenu_OnClickCopy__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_2213A78(Method_SupportSelectEditMenu_OnClickCopy__);
    v4 = (System_Reflection_MethodBase_o *)sub_2213A44(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
    onClickButton = this->fields.onClickButton;
    if ( onClickButton )
...
void SupportSelectEditMenu__OnClickInitAll(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596CC43 & 1) == 0 )
  {
    sub_2213A60(&Method_SupportSelectEditMenu_OnClickInitAll__);
    byte_596CC43 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectEditMenu_OnClickInitAll__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_2213A78(Method_SupportSelectEditMenu_OnClickInitAll__);
    v4 = (System_Reflection_MethodBase_o *)sub_2213A44(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
    onClickButton = this->fields.onClickButton;
    if ( onClickButton )
...
void SupportSelectEditMenu__OnClickRemoveAll(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596CC42 & 1) == 0 )
  {
    sub_2213A60(&Method_SupportSelectEditMenu_OnClickRemoveAll__);
    byte_596CC42 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectEditMenu_OnClickRemoveAll__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_2213A78(Method_SupportSelectEditMenu_OnClickRemoveAll__);
    v4 = (System_Reflection_MethodBase_o *)sub_2213A44(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
    onClickButton = this->fields.onClickButton;
    if ( onClickButton )
...
void SupportSelectEditMenu__OnClickRemoveEquip(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596CC44 & 1) == 0 )
  {
    sub_2213A60(&Method_SupportSelectEditMenu_OnClickRemoveEquip__);
    byte_596CC44 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectEditMenu_OnClickRemoveEquip__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_2213A78(Method_SupportSelectEditMenu_OnClickRemoveEquip__);
    v4 = (System_Reflection_MethodBase_o *)sub_2213A44(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
    onClickButton = this->fields.onClickButton;
    if ( onClickButton )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596CC3E & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_SupportSelectEditMenu_OnFinishedOpen__);
    sub_2213A60(&StringLiteral_13072/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_REMOVE_EQUIP"*/);
    sub_2213A60(&StringLiteral_13069/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_COPY"*/);
    sub_2213A60(&StringLiteral_13070/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_INIT_ALL"*/);
    sub_2213A60(&StringLiteral_13075/*"SUPPORT_SELECT_EDIT_MENU_TITLE"*/);
    sub_2213A60(&StringLiteral_13073/*"SUPPORT_SELECT_EDIT_MENU_DECK_NAME"*/);
    sub_2213A60(&StringLiteral_13071/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_REMOVE_ALL"*/);
    sub_2213A60(&StringLiteral_13068/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_CHANGE_DECK_NAME"*/);
    sub_2213A60(&StringLiteral_13067/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_CANCEL"*/);
    sub_2213A60(&StringLiteral_13074/*"SUPPORT_SELECT_EDIT_MENU_MESSAGE"*/);
    byte_596CC3E = 1;
  }
  if ( this->fields.currentState == 2 && deckData )
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_13075/*"SUPPORT_SELECT_EDIT_MENU_TITLE"*/, 0);
    if ( !titleLabel )
      goto LABEL_32;
    UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0);
    supportNameLabel = this->fields.supportNameLabel;
    v18 = LocalizationManager__Get((System_String_o *)StringLiteral_13073/*"SUPPORT_SELECT_EDIT_MENU_DECK_NAME"*/, 0);
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_13074/*"SUPPORT_SELECT_EDIT_MENU_MESSAGE"*/, 0);
    if ( !messageLabel )
      goto LABEL_32;
    ...
    SupportSelectEditMenu__SetButtonText(v20, this->fields.copyButton, (System_String_o *)StringLiteral_13069/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_COPY"*/, v21);
    ...
    SupportSelectEditMenu__SetButtonText(v24, this->fields.removeAllButton, (System_String_o *)StringLiteral_13071/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_REMOVE_ALL"*/, v25);
    ...
    v27 = (SupportSelectEditMenu_o *)((__int64 (__fastcall *)(UnityEngine_GameObject_o *, __int64, __int64, Il2CppClass **))gameObject->klass[1]._1.nestedTypes)(
                                       ...
                                       1,
                                       gameObject->klass[1]._1.implementedInterfaces);
    SupportSelectEditMenu__SetButtonText(v27, this->fields.initAllButton, (System_String_o *)StringLiteral_13070/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_INIT_ALL"*/, v28);
    ...
    SupportSelectEditMenu__SetButtonText(
      v31,
      this->fields.removeEquipButton,
      (System_String_o *)StringLiteral_13072/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_REMOVE_EQUIP"*/,
      v32);
...
LABEL_32:
    ...
    SupportSelectEditMenu__SetButtonText(
      ...
      (System_String_o *)StringLiteral_13068/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_CHANGE_DECK_NAME"*/,
      v34);
    SupportSelectEditMenu__SetButtonText(v35, this->fields.cancelButton, (System_String_o *)StringLiteral_13067/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_CANCEL"*/, v36);
        ...
        const MethodInfo *method)
{
  __int64 v6; // x1
  __int64 v7; // x2
  Il2CppObject *ComponentInChildren_object__58855044; // x20
  __int64 v9; // x1
  __int64 v10; // x2
  ...
  if ( (byte_596CC40 & 1) == 0 )
  {
    ...
    sub_2213A60(&LocalizationManager_TypeInfo);
    this = (SupportSelectEditMenu_o *)sub_2213A60(&UnityEngine_Object_TypeInfo);
    byte_596CC40 = 1;
  }
  if ( !target )
    goto LABEL_12;
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)ComponentInChildren_object__58855044, 0, 0) )
  {
    ...
    {
      UILabel__set_text((UILabel_o *)ComponentInChildren_object__58855044, (System_String_o *)this, 0);
      return;
    }
LABEL_12:
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_2007258;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_2007210;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596CC49 & 1) == 0 )
  {
    sub_2213A60(&SupportSelectEditMenu_ResultKind_TypeInfo);
    byte_596CC49 = 1;
  }
  v9[1] = 0;
