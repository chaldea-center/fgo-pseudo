...
void SupportSelectEditMenu__Close(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E73B48 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_SupportSelectEditMenu_OnFinishedClose__);
    byte_4E73B48 = 1;
  }
  this->fields.currentState = 2;
...
void SupportSelectEditMenu__OnClickCancel(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E73B4F & 1) == 0 )
  {
    sub_1D0F0B4(&Method_SupportSelectEditMenu_OnClickCancel__);
    byte_4E73B4F = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectEditMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1D0F0CC(Method_SupportSelectEditMenu_OnClickCancel__);
...
void SupportSelectEditMenu__OnClickChangeName(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E73B4E & 1) == 0 )
  {
    sub_1D0F0B4(&Method_SupportSelectEditMenu_OnClickChangeName__);
    byte_4E73B4E = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectEditMenu_OnClickChangeName__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1D0F0CC(Method_SupportSelectEditMenu_OnClickChangeName__);
    v4 = (System_Reflection_MethodBase_o *)sub_1D0F098(v3, v3[4]);
...
void SupportSelectEditMenu__OnClickCopy(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E73B4A & 1) == 0 )
  {
    sub_1D0F0B4(&Method_SupportSelectEditMenu_OnClickCopy__);
    byte_4E73B4A = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectEditMenu_OnClickCopy__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1D0F0CC(Method_SupportSelectEditMenu_OnClickCopy__);
    v4 = (System_Reflection_MethodBase_o *)sub_1D0F098(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
    onClickButton = this->fields.onClickButton;
    if ( onClickButton )
...
void SupportSelectEditMenu__OnClickInitAll(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E73B4C & 1) == 0 )
  {
    sub_1D0F0B4(&Method_SupportSelectEditMenu_OnClickInitAll__);
    byte_4E73B4C = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectEditMenu_OnClickInitAll__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1D0F0CC(Method_SupportSelectEditMenu_OnClickInitAll__);
    v4 = (System_Reflection_MethodBase_o *)sub_1D0F098(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
    onClickButton = this->fields.onClickButton;
    if ( onClickButton )
...
void SupportSelectEditMenu__OnClickRemoveAll(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E73B4B & 1) == 0 )
  {
    sub_1D0F0B4(&Method_SupportSelectEditMenu_OnClickRemoveAll__);
    byte_4E73B4B = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectEditMenu_OnClickRemoveAll__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1D0F0CC(Method_SupportSelectEditMenu_OnClickRemoveAll__);
    v4 = (System_Reflection_MethodBase_o *)sub_1D0F098(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
    onClickButton = this->fields.onClickButton;
    if ( onClickButton )
...
void SupportSelectEditMenu__OnClickRemoveEquip(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E73B4D & 1) == 0 )
  {
    sub_1D0F0B4(&Method_SupportSelectEditMenu_OnClickRemoveEquip__);
    byte_4E73B4D = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectEditMenu_OnClickRemoveEquip__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1D0F0CC(Method_SupportSelectEditMenu_OnClickRemoveEquip__);
    v4 = (System_Reflection_MethodBase_o *)sub_1D0F098(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
    onClickButton = this->fields.onClickButton;
    if ( onClickButton )
...
void SupportSelectEditMenu__OnFinishedClose(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.onClickButton, 0, v2, v3, v4, v5, v6, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E73B47 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_SupportSelectEditMenu_OnFinishedOpen__);
    sub_1D0F0B4(&StringLiteral_12725/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_REMOVE_EQUIP"*/);
    sub_1D0F0B4(&StringLiteral_12722/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_COPY"*/);
    sub_1D0F0B4(&StringLiteral_12723/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_INIT_ALL"*/);
    sub_1D0F0B4(&StringLiteral_12728/*"SUPPORT_SELECT_EDIT_MENU_TITLE"*/);
    sub_1D0F0B4(&StringLiteral_12726/*"SUPPORT_SELECT_EDIT_MENU_DECK_NAME"*/);
    sub_1D0F0B4(&StringLiteral_12724/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_REMOVE_ALL"*/);
    sub_1D0F0B4(&StringLiteral_12721/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_CHANGE_DECK_NAME"*/);
    sub_1D0F0B4(&StringLiteral_12720/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_CANCEL"*/);
    sub_1D0F0B4(&StringLiteral_12727/*"SUPPORT_SELECT_EDIT_MENU_MESSAGE"*/);
    byte_4E73B47 = 1;
  }
  if ( deckData && this->fields.currentState == 2 )
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12728/*"SUPPORT_SELECT_EDIT_MENU_TITLE"*/, 0);
    if ( !titleLabel )
      goto LABEL_32;
    UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0);
    supportNameLabel = this->fields.supportNameLabel;
    v16 = LocalizationManager__Get((System_String_o *)StringLiteral_12726/*"SUPPORT_SELECT_EDIT_MENU_DECK_NAME"*/, 0);
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12727/*"SUPPORT_SELECT_EDIT_MENU_MESSAGE"*/, 0);
    if ( !messageLabel )
      goto LABEL_32;
    ...
    SupportSelectEditMenu__SetButtonText(v18, this->fields.copyButton, (System_String_o *)StringLiteral_12722/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_COPY"*/, v19);
    ...
    SupportSelectEditMenu__SetButtonText(v22, this->fields.removeAllButton, (System_String_o *)StringLiteral_12724/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_REMOVE_ALL"*/, v23);
    ...
    v25 = (SupportSelectEditMenu_o *)((__int64 (__fastcall *)(UnityEngine_GameObject_o *, __int64, __int64, Il2CppClass **))gameObject->klass[1]._1.nestedTypes)(
                                       ...
                                       1,
                                       gameObject->klass[1]._1.implementedInterfaces);
    SupportSelectEditMenu__SetButtonText(v25, this->fields.initAllButton, (System_String_o *)StringLiteral_12723/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_INIT_ALL"*/, v26);
    ...
    SupportSelectEditMenu__SetButtonText(
      v29,
      this->fields.removeEquipButton,
      (System_String_o *)StringLiteral_12725/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_REMOVE_EQUIP"*/,
      v30);
...
LABEL_32:
    ...
    SupportSelectEditMenu__SetButtonText(
      ...
      (System_String_o *)StringLiteral_12721/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_CHANGE_DECK_NAME"*/,
      v32);
    SupportSelectEditMenu__SetButtonText(v33, this->fields.cancelButton, (System_String_o *)StringLiteral_12720/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_CANCEL"*/, v34);
...
void SupportSelectEditMenu__SetButtonText(
        ...
        const MethodInfo *method)
{
  Il2CppObject *ComponentInChildren_object__52714476; // x20

  if ( (byte_4E73B49 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_UnityEngine_Component_GetComponentInChildren_UILabel___);
    sub_1D0F0B4(&LocalizationManager_TypeInfo);
    this = (SupportSelectEditMenu_o *)sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    byte_4E73B49 = 1;
  }
  if ( !target )
    goto LABEL_12;
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)ComponentInChildren_object__52714476, 0, 0) )
  {
    ...
    {
      UILabel__set_text((UILabel_o *)ComponentInChildren_object__52714476, (System_String_o *)this, 0);
      return;
    }
LABEL_12:
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1B39B90;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1B39B48;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E73B52 & 1) == 0 )
  {
    sub_1D0F0B4(&SupportSelectEditMenu_ResultKind_TypeInfo);
    byte_4E73B52 = 1;
  }
  v9[1] = 0;
