...
void __fastcall SupportSelectEditMenu__Close(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B41131 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_SupportSelectEditMenu_OnFinishedClose__, v3);
    byte_4B41131 = 1;
  }
  this->fields.currentState = 2;
...
void __fastcall SupportSelectEditMenu__OnClickCancel(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B41138 & 1) == 0 )
  {
    sub_1BDB878(&Method_SupportSelectEditMenu_OnClickCancel__, method);
    byte_4B41138 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectEditMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BDB890(Method_SupportSelectEditMenu_OnClickCancel__);
...
void __fastcall SupportSelectEditMenu__OnClickChangeName(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B41137 & 1) == 0 )
  {
    sub_1BDB878(&Method_SupportSelectEditMenu_OnClickChangeName__, method);
    byte_4B41137 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectEditMenu_OnClickChangeName__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BDB890(Method_SupportSelectEditMenu_OnClickChangeName__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BDB85C(v3, v3[4]);
...
void __fastcall SupportSelectEditMenu__OnClickCopy(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B41133 & 1) == 0 )
  {
    sub_1BDB878(&Method_SupportSelectEditMenu_OnClickCopy__, method);
    byte_4B41133 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectEditMenu_OnClickCopy__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BDB890(Method_SupportSelectEditMenu_OnClickCopy__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BDB85C(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
    onClickButton = this->fields.onClickButton;
    if ( onClickButton )
...
void __fastcall SupportSelectEditMenu__OnClickInitAll(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B41135 & 1) == 0 )
  {
    sub_1BDB878(&Method_SupportSelectEditMenu_OnClickInitAll__, method);
    byte_4B41135 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectEditMenu_OnClickInitAll__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BDB890(Method_SupportSelectEditMenu_OnClickInitAll__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BDB85C(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
    onClickButton = this->fields.onClickButton;
    if ( onClickButton )
...
void __fastcall SupportSelectEditMenu__OnClickRemoveAll(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B41134 & 1) == 0 )
  {
    sub_1BDB878(&Method_SupportSelectEditMenu_OnClickRemoveAll__, method);
    byte_4B41134 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectEditMenu_OnClickRemoveAll__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BDB890(Method_SupportSelectEditMenu_OnClickRemoveAll__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BDB85C(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
    onClickButton = this->fields.onClickButton;
    if ( onClickButton )
...
void __fastcall SupportSelectEditMenu__OnClickRemoveEquip(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B41136 & 1) == 0 )
  {
    sub_1BDB878(&Method_SupportSelectEditMenu_OnClickRemoveEquip__, method);
    byte_4B41136 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectEditMenu_OnClickRemoveEquip__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BDB890(Method_SupportSelectEditMenu_OnClickRemoveEquip__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BDB85C(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
    onClickButton = this->fields.onClickButton;
    if ( onClickButton )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B41130 & 1) == 0 )
  {
    sub_1BDB878(&System_Action_TypeInfo, deckData);
    sub_1BDB878(&LocalizationManager_TypeInfo, v9);
    sub_1BDB878(&Method_SupportSelectEditMenu_OnFinishedOpen__, v10);
    sub_1BDB878(&StringLiteral_12508/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_REMOVE_EQUIP"*/, v11);
    sub_1BDB878(&StringLiteral_12505/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_COPY"*/, v12);
    sub_1BDB878(&StringLiteral_12506/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_INIT_ALL"*/, v13);
    sub_1BDB878(&StringLiteral_12511/*"SUPPORT_SELECT_EDIT_MENU_TITLE"*/, v14);
    sub_1BDB878(&StringLiteral_12509/*"SUPPORT_SELECT_EDIT_MENU_DECK_NAME"*/, v15);
    sub_1BDB878(&StringLiteral_12507/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_REMOVE_ALL"*/, v16);
    sub_1BDB878(&StringLiteral_12504/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_CHANGE_DECK_NAME"*/, v17);
    sub_1BDB878(&StringLiteral_12503/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_CANCEL"*/, v18);
    sub_1BDB878(&StringLiteral_12510/*"SUPPORT_SELECT_EDIT_MENU_MESSAGE"*/, v19);
    byte_4B41130 = 1;
  }
  if ( deckData && this->fields.currentState == 2 )
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12511/*"SUPPORT_SELECT_EDIT_MENU_TITLE"*/, 0LL);
    if ( !titleLabel )
      goto LABEL_32;
    UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL);
    supportNameLabel = this->fields.supportNameLabel;
    v24 = LocalizationManager__Get((System_String_o *)StringLiteral_12509/*"SUPPORT_SELECT_EDIT_MENU_DECK_NAME"*/, 0LL);
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12510/*"SUPPORT_SELECT_EDIT_MENU_MESSAGE"*/, 0LL);
    if ( !messageLabel )
      goto LABEL_32;
    ...
    SupportSelectEditMenu__SetButtonText(v26, this->fields.copyButton, (System_String_o *)StringLiteral_12505/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_COPY"*/, v27);
    ...
    SupportSelectEditMenu__SetButtonText(v30, this->fields.removeAllButton, (System_String_o *)StringLiteral_12507/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_REMOVE_ALL"*/, v31);
    ...
    v33 = (SupportSelectEditMenu_o *)((__int64 (__fastcall *)(UnityEngine_GameObject_o *, __int64, __int64, Il2CppRuntimeInterfaceOffsetPair *))gameObject->klass[1]._1.implementedInterfaces)(
                                       ...
                                       1LL,
                                       gameObject->klass[1]._1.interfaceOffsets);
    SupportSelectEditMenu__SetButtonText(v33, this->fields.initAllButton, (System_String_o *)StringLiteral_12506/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_INIT_ALL"*/, v34);
    ...
    SupportSelectEditMenu__SetButtonText(
      v37,
      this->fields.removeEquipButton,
      (System_String_o *)StringLiteral_12508/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_REMOVE_EQUIP"*/,
      v38);
...
LABEL_32:
    ...
    SupportSelectEditMenu__SetButtonText(
      ...
      (System_String_o *)StringLiteral_12504/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_CHANGE_DECK_NAME"*/,
      v40);
    SupportSelectEditMenu__SetButtonText(v41, this->fields.cancelButton, (System_String_o *)StringLiteral_12503/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_CANCEL"*/, v42);
        ...
        const MethodInfo *method)
{
  __int64 v6; // x1
  __int64 v7; // x1
  Il2CppObject *ComponentInChildren_object__50504592; // x20

  if ( (byte_4B41132 & 1) == 0 )
  {
    sub_1BDB878(&Method_UnityEngine_Component_GetComponentInChildren_UILabel___, target);
    sub_1BDB878(&LocalizationManager_TypeInfo, v6);
    this = (SupportSelectEditMenu_o *)sub_1BDB878(&UnityEngine_Object_TypeInfo, v7);
    byte_4B41132 = 1;
  }
  if ( !target )
    goto LABEL_12;
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)ComponentInChildren_object__50504592, 0LL, 0LL) )
  {
    ...
    {
      UILabel__set_text((UILabel_o *)ComponentInChildren_object__50504592, (System_String_o *)this, 0LL);
      return;
    }
LABEL_12:
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A21860;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A21818;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4113B & 1) == 0 )
  {
    sub_1BDB878(&SupportSelectEditMenu_ResultKind_TypeInfo, *(_QWORD *)&result);
    byte_4B4113B = 1;
  }
  v9[1] = 0LL;
