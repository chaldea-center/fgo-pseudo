...
void __fastcall SupportSelectEditMenu__Close(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD8DBF & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_SupportSelectEditMenu_OnFinishedClose__);
    byte_4BD8DBF = 1;
  }
  this->fields.currentState = 2;
...
void __fastcall SupportSelectEditMenu__OnClickCancel(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD8DC6 & 1) == 0 )
  {
    sub_1C21E38(&Method_SupportSelectEditMenu_OnClickCancel__);
    byte_4BD8DC6 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectEditMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_SupportSelectEditMenu_OnClickCancel__);
...
void __fastcall SupportSelectEditMenu__OnClickChangeName(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD8DC5 & 1) == 0 )
  {
    sub_1C21E38(&Method_SupportSelectEditMenu_OnClickChangeName__);
    byte_4BD8DC5 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectEditMenu_OnClickChangeName__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_SupportSelectEditMenu_OnClickChangeName__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C21E1C(v3, v3[4]);
...
void __fastcall SupportSelectEditMenu__OnClickCopy(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD8DC1 & 1) == 0 )
  {
    sub_1C21E38(&Method_SupportSelectEditMenu_OnClickCopy__);
    byte_4BD8DC1 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectEditMenu_OnClickCopy__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_SupportSelectEditMenu_OnClickCopy__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C21E1C(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
    onClickButton = this->fields.onClickButton;
    if ( onClickButton )
...
void __fastcall SupportSelectEditMenu__OnClickInitAll(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD8DC3 & 1) == 0 )
  {
    sub_1C21E38(&Method_SupportSelectEditMenu_OnClickInitAll__);
    byte_4BD8DC3 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectEditMenu_OnClickInitAll__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_SupportSelectEditMenu_OnClickInitAll__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C21E1C(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
    onClickButton = this->fields.onClickButton;
    if ( onClickButton )
...
void __fastcall SupportSelectEditMenu__OnClickRemoveAll(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD8DC2 & 1) == 0 )
  {
    sub_1C21E38(&Method_SupportSelectEditMenu_OnClickRemoveAll__);
    byte_4BD8DC2 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectEditMenu_OnClickRemoveAll__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_SupportSelectEditMenu_OnClickRemoveAll__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C21E1C(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
    onClickButton = this->fields.onClickButton;
    if ( onClickButton )
...
void __fastcall SupportSelectEditMenu__OnClickRemoveEquip(SupportSelectEditMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD8DC4 & 1) == 0 )
  {
    sub_1C21E38(&Method_SupportSelectEditMenu_OnClickRemoveEquip__);
    byte_4BD8DC4 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectEditMenu_OnClickRemoveEquip__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_SupportSelectEditMenu_OnClickRemoveEquip__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C21E1C(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
    onClickButton = this->fields.onClickButton;
    if ( onClickButton )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD8DBE & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_SupportSelectEditMenu_OnFinishedOpen__);
    sub_1C21E38(&StringLiteral_12686/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_REMOVE_EQUIP"*/);
    sub_1C21E38(&StringLiteral_12683/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_COPY"*/);
    sub_1C21E38(&StringLiteral_12684/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_INIT_ALL"*/);
    sub_1C21E38(&StringLiteral_12689/*"SUPPORT_SELECT_EDIT_MENU_TITLE"*/);
    sub_1C21E38(&StringLiteral_12687/*"SUPPORT_SELECT_EDIT_MENU_DECK_NAME"*/);
    sub_1C21E38(&StringLiteral_12685/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_REMOVE_ALL"*/);
    sub_1C21E38(&StringLiteral_12682/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_CHANGE_DECK_NAME"*/);
    sub_1C21E38(&StringLiteral_12681/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_CANCEL"*/);
    sub_1C21E38(&StringLiteral_12688/*"SUPPORT_SELECT_EDIT_MENU_MESSAGE"*/);
    byte_4BD8DBE = 1;
  }
  if ( deckData && this->fields.currentState == 2 )
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12689/*"SUPPORT_SELECT_EDIT_MENU_TITLE"*/, 0LL);
    if ( !titleLabel )
      goto LABEL_32;
    UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL);
    supportNameLabel = this->fields.supportNameLabel;
    v16 = LocalizationManager__Get((System_String_o *)StringLiteral_12687/*"SUPPORT_SELECT_EDIT_MENU_DECK_NAME"*/, 0LL);
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12688/*"SUPPORT_SELECT_EDIT_MENU_MESSAGE"*/, 0LL);
    if ( !messageLabel )
      goto LABEL_32;
    ...
    SupportSelectEditMenu__SetButtonText(v18, this->fields.copyButton, (System_String_o *)StringLiteral_12683/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_COPY"*/, v19);
    ...
    SupportSelectEditMenu__SetButtonText(v22, this->fields.removeAllButton, (System_String_o *)StringLiteral_12685/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_REMOVE_ALL"*/, v23);
    ...
    v25 = (SupportSelectEditMenu_o *)((__int64 (__fastcall *)(UnityEngine_GameObject_o *, __int64, __int64, Il2CppRuntimeInterfaceOffsetPair *))gameObject->klass[1]._1.implementedInterfaces)(
                                       ...
                                       1LL,
                                       gameObject->klass[1]._1.interfaceOffsets);
    SupportSelectEditMenu__SetButtonText(v25, this->fields.initAllButton, (System_String_o *)StringLiteral_12684/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_INIT_ALL"*/, v26);
    ...
    SupportSelectEditMenu__SetButtonText(
      v29,
      this->fields.removeEquipButton,
      (System_String_o *)StringLiteral_12686/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_REMOVE_EQUIP"*/,
      v30);
...
LABEL_32:
    ...
    SupportSelectEditMenu__SetButtonText(
      ...
      (System_String_o *)StringLiteral_12682/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_CHANGE_DECK_NAME"*/,
      v32);
    SupportSelectEditMenu__SetButtonText(v33, this->fields.cancelButton, (System_String_o *)StringLiteral_12681/*"SUPPORT_SELECT_EDIT_MENU_BUTTON_CANCEL"*/, v34);
...
void __fastcall SupportSelectEditMenu__SetButtonText(
        ...
        const MethodInfo *method)
{
  Il2CppObject *ComponentInChildren_object__49965836; // x20

  if ( (byte_4BD8DC0 & 1) == 0 )
  {
    sub_1C21E38(&Method_UnityEngine_Component_GetComponentInChildren_UILabel___);
    sub_1C21E38(&LocalizationManager_TypeInfo);
    this = (SupportSelectEditMenu_o *)sub_1C21E38(&UnityEngine_Object_TypeInfo);
    byte_4BD8DC0 = 1;
  }
  if ( !target )
    goto LABEL_12;
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)ComponentInChildren_object__49965836, 0LL, 0LL) )
  {
    ...
    {
      UILabel__set_text((UILabel_o *)ComponentInChildren_object__49965836, (System_String_o *)this, 0LL);
      return;
    }
LABEL_12:
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A5FB3C;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A5FAF4;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD8DC9 & 1) == 0 )
  {
    sub_1C21E38(&SupportSelectEditMenu_ResultKind_TypeInfo);
    byte_4BD8DC9 = 1;
  }
  v9[1] = 0LL;
