void __fastcall LoginQuestMaster___ctor(LoginQuestMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A2E269 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_LoginQuestMaster__LoginQuestEntity__int___ctor__, method);
    byte_4A2E269 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    360,
    (const MethodInfo_30FF740 *)Method_DataMasterBase_LoginQuestMaster__LoginQuestEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E26A & 1) == 0 )
  {
    ...
    sub_1B761C0(&LoginQuestEntity_TypeInfo, v8);
    byte_4A2E26A = 1;
  }
