void __fastcall LoginQuestMaster___ctor(LoginQuestMaster_o *this, const MethodInfo *method)
{
  if ( (byte_48E2B1C & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataMasterBase_LoginQuestMaster__LoginQuestEntity__int___ctor__, method);
    byte_48E2B1C = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    359,
    (const MethodInfo_2FE6A0C *)Method_DataMasterBase_LoginQuestMaster__LoginQuestEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  int32_t *v18; // x10
  __int64 v19; // x0
  LoginQuestEntity_o *v20; // x0
  __int64 v21; // x1
  LoginQuestEntity_o *v22; // x21
  ...
  if ( (byte_48E2B1D & 1) == 0 )
  {
    ...
    sub_1B00CCC(&LoginQuestEntity_TypeInfo, v8);
    byte_48E2B1D = 1;
  }
