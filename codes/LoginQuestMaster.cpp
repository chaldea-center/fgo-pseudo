void __fastcall LoginQuestMaster___ctor(LoginQuestMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A1FDFC & 1) == 0 )
  {
    sub_1B715CC(&Method_DataMasterBase_LoginQuestMaster__LoginQuestEntity__int___ctor__, method);
    byte_4A1FDFC = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    360,
    (const MethodInfo_30F8720 *)Method_DataMasterBase_LoginQuestMaster__LoginQuestEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1FDFD & 1) == 0 )
  {
    ...
    sub_1B715CC(&LoginQuestEntity_TypeInfo, v8);
    byte_4A1FDFD = 1;
  }
