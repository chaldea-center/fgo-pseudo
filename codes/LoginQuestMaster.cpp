void __fastcall LoginQuestMaster___ctor(LoginQuestMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A08F8C & 1) == 0 )
  {
    sub_1B686D4(&Method_DataMasterBase_LoginQuestMaster__LoginQuestEntity__int___ctor__, method);
    byte_4A08F8C = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    360,
    (const MethodInfo_30E4480 *)Method_DataMasterBase_LoginQuestMaster__LoginQuestEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A08F8D & 1) == 0 )
  {
    ...
    sub_1B686D4(&LoginQuestEntity_TypeInfo, v8);
    byte_4A08F8D = 1;
  }
