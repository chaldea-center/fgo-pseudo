void __fastcall WarBoardActionTrendEntity___ctor(WarBoardActionTrendEntity_o *this, const MethodInfo *method)
{
  ...
  v4 = (struct System_Int32_array *)sub_1B64918(int___TypeInfo, 1LL);
  if ( !v4 )
    goto LABEL_8;
  v8 = v4;
  if ( !v4->max_length )
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.conditionIds, (int32_t)v4, v6, v7);
...
LABEL_9:
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)p_actionTypeIds, (int32_t)v4, v9, v10);
  *((_DWORD *)p_actionTypeIds + 3) = 0;
}


void __fastcall WarBoardActionTrendEntity___ctor_39994704(
        ...
        const MethodInfo *method)
{
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.conditionIds, (int32_t)conditionIds, v7, v8);
  ...
  sub_1B64814(p_actionTypeIds, (int32_t)actionTypeIds, v12, v13);
  p_actionTypeIds->monitor = *(void **)&cSrc->fields.attackValue;
}


void __fastcall WarBoardActionTrendEntity___ctor_39994856(
        WarBoardActionTrendEntity_o *this,
        ...
        const MethodInfo *method)
{
  ...
  __int64 v8; // x0
  __int64 v9; // x1
  const MethodInfo_35D07F0 *v10; // x3
  __int64 id; // x8
  struct System_Int32_array *conditionIds; // x1
  int32_t v13; // w2
  int32_t v14; // w3
  ...
  if ( (byte_49FF442 & 1) == 0 )
  {
    sub_1B64870(&Method_DataEntityBase_int___ctor__, futureEntity);
    sub_1B64870(&Method_System_Nullable_long___ctor__, v7);
    byte_49FF442 = 1;
  }
  DataEntityBase_int____ctor(
    (DataEntityBase_int__o *)this,
  ...
  *(_QWORD *)&v19.fields.hasValue = &v18;
  ...
  this->fields.conditionIds = conditionIds;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.conditionIds, (int32_t)conditionIds, v13, v14);
...
LABEL_6:
  ...
  this->fields.actionTypeIds = actionTypeIds;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.actionTypeIds, (int32_t)actionTypeIds, v15, v16);
}
...
{
  const MethodInfo_35D07F0 *v2; // x3
  __int64 v4; // x1
  __int64 v5; // x1
  int64_t id; // x20
  ...
  if ( (byte_49FF443 & 1) == 0 )
  {
    sub_1B64870(&Method_System_Nullable_long__GetValueOrDefault__, method);
    sub_1B64870(&Method_System_Nullable_long___ctor__, v4);
    sub_1B64870(&Method_System_Nullable_long__get_HasValue__, v5);
    byte_49FF443 = 1;
  }
