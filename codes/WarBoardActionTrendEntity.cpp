...
LABEL_9:
  ...
  sub_B52920((BattleServantConfConponent_o *)p_actionTypeIds, (System_Int32_array **)v3, v11, v12, v13, v14, v15, v16);
  *((_DWORD *)p_actionTypeIds + 3) = 0;
}


void __fastcall WarBoardActionTrendEntity___ctor_21364052(
...
void __fastcall WarBoardActionTrendEntity___ctor_21364216(
        WarBoardActionTrendEntity_o *this,
        ...
        const MethodInfo *method)
{
  __int64 v7; // x0
  __int64 v8; // x1
  const MethodInfo_2172180 *v9; // x3
  __int64 id; // x8
  struct System_Int32_array *conditionIds; // x1
...
{
  const MethodInfo_2172180 *v2; // x3
  int64_t id; // x20
  ...
  id = this->fields.id;
  v7.fields.value = (int64_t)&v6;
  *(_QWORD *)&v7.fields.has_value = id;
