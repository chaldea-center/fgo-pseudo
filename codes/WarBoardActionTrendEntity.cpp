void __fastcall WarBoardActionTrendEntity___ctor(WarBoardActionTrendEntity_o *this, const MethodInfo *method)
{
  ...
  v4 = (struct System_Int32_array *)sub_1B64170(int___TypeInfo, 1LL);
  if ( !v4 )
    goto LABEL_8;
  v7 = v4;
  if ( !v4->max_length )
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.conditionIds, (int32_t)v4, v5, v6);
...
LABEL_9:
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)p_actionTypeIds, (int32_t)v4, v8, v9);
  *((_DWORD *)p_actionTypeIds + 3) = 0;
}


void __fastcall WarBoardActionTrendEntity___ctor_39990196(
        ...
        const MethodInfo *method)
{
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.conditionIds, (int32_t)conditionIds, v6, v7);
  ...
  sub_1B6406C(p_actionTypeIds, (int32_t)actionTypeIds, v11, v12);
  p_actionTypeIds->monitor = *(void **)&cSrc->fields.attackValue;
}


void __fastcall WarBoardActionTrendEntity___ctor_39990348(
        WarBoardActionTrendEntity_o *this,
        ...
        const MethodInfo *method)
{
  __int64 v7; // x1
  __int64 v8; // x0
  const MethodInfo_35CE514 *v9; // x3
  __int64 id; // x8
  struct System_Int32_array *conditionIds; // x1
  int32_t v12; // w2
  int32_t v13; // w3
  ...
  if ( (byte_49FD349 & 1) == 0 )
  {
    sub_1B640C8(&Method_DataEntityBase_int___ctor__, futureEntity);
    sub_1B640C8(&Method_System_Nullable_long___ctor__, v7);
    byte_49FD349 = 1;
  }
  DataEntityBase_int____ctor(
    (DataEntityBase_int__o *)this,
  ...
  *(_QWORD *)&v18.fields.hasValue = &v17;
  ...
  this->fields.conditionIds = conditionIds;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.conditionIds, (int32_t)conditionIds, v12, v13);
...
LABEL_6:
  ...
  this->fields.actionTypeIds = actionTypeIds;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.actionTypeIds, (int32_t)actionTypeIds, v14, v15);
}
...
{
  const MethodInfo_35CE514 *v2; // x3
  __int64 v4; // x1
  __int64 v5; // x1
  int64_t id; // x20
  ...
  if ( (byte_49FD34A & 1) == 0 )
  {
    sub_1B640C8(&Method_System_Nullable_long__GetValueOrDefault__, method);
    sub_1B640C8(&Method_System_Nullable_long___ctor__, v4);
    sub_1B640C8(&Method_System_Nullable_long__get_HasValue__, v5);
    byte_49FD34A = 1;
  }
