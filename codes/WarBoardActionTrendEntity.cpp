void WarBoardActionTrendEntity___ctor(WarBoardActionTrendEntity_o *this, const MethodInfo *method)
{
  ...
  *(_DWORD *)(v3 + 32) = 23;
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.conditionIds, v3, v5, v6, v7, v8, v9, v10);
...
LABEL_9:
  ...
  *(_DWORD *)(v3 + 32) = 1;
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)p_actionTypeIds, v3, v11, v12, v13, v14, v15, v16);
  *((_DWORD *)p_actionTypeIds + 3) = 0;
}


void WarBoardActionTrendEntity___ctor_44432532(
        ...
        const MethodInfo *method)
{
  ...
  sub_1CE66A4(p_actionTypeIds, (int32_t)actionTypeIds, v16, v17, v18, v19, v20, v21);
  p_actionTypeIds->monitor = *(void **)&cSrc->fields.attackValue;
}


void WarBoardActionTrendEntity___ctor_44432684(
        WarBoardActionTrendEntity_o *this,
        ...
        const MethodInfo *method)
{
  __int64 v7; // x0
  __int64 v8; // x1
  const MethodInfo_3A2E600 *v9; // x3
  __int64 id; // x8
  struct System_Int32_array *conditionIds; // x1
  int32_t v12; // w2
  int32_t v13; // w3
...
{
  const MethodInfo_3A2E600 *v2; // x3
  int64_t id; // x20
