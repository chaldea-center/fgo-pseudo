void NoTitleDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_596C673 & 1) == 0 )
  {
    sub_2213A60(&NoTitleDialog_TypeInfo);
    byte_596C673 = 1;
  }
  static_fields = NoTitleDialog_TypeInfo->static_fields;
  *(_OWORD *)&static_fields->MESSAGE_WINDOW_SIZE_X_DEF = xmmword_E9CC70;
  *(_OWORD *)&static_fields->MESSAGE_LABEL_POS_Y_DEF = xmmword_E9DA80;
...
void NoTitleDialog__CallOnClick(NoTitleDialog_o *this, bool result, const MethodInfo *method)
{
  ...
  {
    p_onClick->klass = 0;
    sub_2213A04(p_onClick, 0, (System_String_o *)method, v3, v4, v5, v6, v7);
...
void NoTitleDialog__Close(NoTitleDialog_o *this, const MethodInfo *method)
{
  ...
  NoTitleDialog__Close_41770844(this, 0, v2);
}


void NoTitleDialog__Close_41770844(NoTitleDialog_o *this, System_Action_o *callback, const MethodInfo *method)
{
  System_String_o *v3; // x3
  int32_t v4; // w4
  int32_t v5; // w5
  ...
  if ( (byte_596C66C & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_NoTitleDialog_EndClose__);
    byte_596C66C = 1;
  }
...
void NoTitleDialog__EndClose(NoTitleDialog_o *this, const MethodInfo *method)
{
  ...
  {
    p_onClose->klass = 0;
    sub_2213A04(p_onClose, 0, v5, v6, v7, v8, v9, v10);
...
void NoTitleDialog__OnClickCancel(NoTitleDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596C670 & 1) == 0 )
  {
    sub_2213A60(&Method_NoTitleDialog_OnClickCancel__);
    byte_596C670 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_NoTitleDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_2213A78(Method_NoTitleDialog_OnClickCancel__);
...
void NoTitleDialog__OnClickClose(NoTitleDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596C671 & 1) == 0 )
  {
    sub_2213A60(&Method_NoTitleDialog_OnClickClose__);
    byte_596C671 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_NoTitleDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_2213A78(Method_NoTitleDialog_OnClickClose__);
    v4 = (System_Reflection_MethodBase_o *)sub_2213A44(v3, v3[4]);
...
void NoTitleDialog__OnClickDecide(NoTitleDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596C66E & 1) == 0 )
  {
    sub_2213A60(&Method_NoTitleDialog_OnClickDecide__);
    byte_596C66E = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_NoTitleDialog_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_2213A78(Method_NoTitleDialog_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_2213A44(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
    this->fields.isButtonEnable = 0;
...
void NoTitleDialog__OnClickDecide2(NoTitleDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596C66F & 1) == 0 )
  {
    sub_2213A60(&Method_NoTitleDialog_OnClickDecide2__);
    byte_596C66F = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_NoTitleDialog_OnClickDecide2__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_2213A78(Method_NoTitleDialog_OnClickDecide2__);
    v4 = (System_Reflection_MethodBase_o *)sub_2213A44(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_2213A60(&System_Action_TypeInfo);
    sub_2213A60(&Method_NoTitleDialog_EndOpen__);
    sub_2213A60(&StringLiteral_1/*""*/);
    byte_596C66A = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0);
  ...
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields.onClick, (int32_t)onClick, v13, v14, v15, v16, v17, v18);
