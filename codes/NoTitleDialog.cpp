void NoTitleDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E009C8 & 1) == 0 )
  {
    sub_1CE6700(&NoTitleDialog_TypeInfo);
    byte_4E009C8 = 1;
  }
  static_fields = NoTitleDialog_TypeInfo->static_fields;
  static_fields->MESSAGE_LABEL_POS_Y = 35;
  *(_OWORD *)&static_fields->MESSAGE_WINDOW_SIZE_X_DEF = xmmword_D24840;
  *(_OWORD *)&static_fields->MESSAGE_LABEL_POS_Y_DEF = xmmword_D25F60;
}
...
void NoTitleDialog__CallOnClick(NoTitleDialog_o *this, bool result, const MethodInfo *method)
{
  ...
  {
    p_onClick->klass = 0;
    sub_1CE66A4(p_onClick, 0, (int32_t)method, v3, v4, v5, v6, v7);
...
void NoTitleDialog__Close(NoTitleDialog_o *this, const MethodInfo *method)
{
  ...
  NoTitleDialog__Close_36041308(this, 0, v2);
}


void NoTitleDialog__Close_36041308(NoTitleDialog_o *this, System_Action_o *callback, const MethodInfo *method)
{
  int32_t v3; // w3
  System_String_o *v4; // x4
  int32_t v5; // w5
  ...
  if ( (byte_4E009C1 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_NoTitleDialog_EndClose__);
    byte_4E009C1 = 1;
  }
...
void NoTitleDialog__EndClose(NoTitleDialog_o *this, const MethodInfo *method)
{
  ...
  {
    p_onClose->klass = 0;
    sub_1CE66A4(p_onClose, 0, v5, v6, v7, v8, v9, v10);
...
void NoTitleDialog__OnClickCancel(NoTitleDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E009C5 & 1) == 0 )
  {
    sub_1CE6700(&Method_NoTitleDialog_OnClickCancel__);
    byte_4E009C5 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_NoTitleDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_NoTitleDialog_OnClickCancel__);
...
void NoTitleDialog__OnClickClose(NoTitleDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E009C6 & 1) == 0 )
  {
    sub_1CE6700(&Method_NoTitleDialog_OnClickClose__);
    byte_4E009C6 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_NoTitleDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_NoTitleDialog_OnClickClose__);
    v4 = (System_Reflection_MethodBase_o *)sub_1CE66E4(v3, v3[4]);
...
void NoTitleDialog__OnClickDecide(NoTitleDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E009C3 & 1) == 0 )
  {
    sub_1CE6700(&Method_NoTitleDialog_OnClickDecide__);
    byte_4E009C3 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_NoTitleDialog_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_NoTitleDialog_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1CE66E4(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
    this->fields.isButtonEnable = 0;
...
void NoTitleDialog__OnClickDecide2(NoTitleDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E009C4 & 1) == 0 )
  {
    sub_1CE6700(&Method_NoTitleDialog_OnClickDecide2__);
    byte_4E009C4 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_NoTitleDialog_OnClickDecide2__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_NoTitleDialog_OnClickDecide2__);
    v4 = (System_Reflection_MethodBase_o *)sub_1CE66E4(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&System_Action_TypeInfo);
    sub_1CE6700(&Method_NoTitleDialog_EndOpen__);
    sub_1CE6700(&StringLiteral_1/*""*/);
    byte_4E009BF = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0);
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.onClick, (int32_t)onClick, v13, v14, v15, v16, v17, v18);
