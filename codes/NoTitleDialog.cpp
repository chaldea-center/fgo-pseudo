void __fastcall NoTitleDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BF9A05 & 1) == 0 )
  {
    sub_1C2E12C(&NoTitleDialog_TypeInfo, v1);
    byte_4BF9A05 = 1;
  }
  static_fields = NoTitleDialog_TypeInfo->static_fields;
  static_fields->MESSAGE_LABEL_POS_Y = 35;
  *(_OWORD *)&static_fields->MESSAGE_WINDOW_SIZE_X_DEF = xmmword_C05E50;
  *(_OWORD *)&static_fields->MESSAGE_LABEL_POS_Y_DEF = xmmword_C07380;
}
...
void __fastcall NoTitleDialog__CallOnClick(NoTitleDialog_o *this, bool result, const MethodInfo *method)
{
  ...
  {
    p_onClick->klass = 0LL;
    sub_1C2E0D0(p_onClick, 0LL, (int64_t)method, v3, v4, v5, v6, v7);
...
void __fastcall NoTitleDialog__Close(NoTitleDialog_o *this, const MethodInfo *method)
{
  ...
  NoTitleDialog__Close_33802856(this, 0LL, v2);
}


void __fastcall NoTitleDialog__Close_33802856(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF99FE & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_NoTitleDialog_EndClose__, v10);
    byte_4BF99FE = 1;
  }
...
void __fastcall NoTitleDialog__EndClose(NoTitleDialog_o *this, const MethodInfo *method)
{
  ...
  {
    p_onClose->klass = 0LL;
    sub_1C2E0D0(p_onClose, 0LL, v5, v6, v7, v8, v9, v10);
...
void __fastcall NoTitleDialog__Init(NoTitleDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BF99FB & 1) == 0 )
  {
    sub_1C2E12C(&NoTitleDialog_TypeInfo, method);
...
void __fastcall NoTitleDialog__OnClickCancel(NoTitleDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BF9A02 & 1) == 0 )
  {
    sub_1C2E12C(&Method_NoTitleDialog_OnClickCancel__, method);
    byte_4BF9A02 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_NoTitleDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2E144(Method_NoTitleDialog_OnClickCancel__);
...
void __fastcall NoTitleDialog__OnClickClose(NoTitleDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BF9A03 & 1) == 0 )
  {
    sub_1C2E12C(&Method_NoTitleDialog_OnClickClose__, method);
    byte_4BF9A03 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_NoTitleDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2E144(Method_NoTitleDialog_OnClickClose__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C2E110(v3, v3[4]);
...
void __fastcall NoTitleDialog__OnClickDecide(NoTitleDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BF9A00 & 1) == 0 )
  {
    sub_1C2E12C(&Method_NoTitleDialog_OnClickDecide__, method);
    byte_4BF9A00 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_NoTitleDialog_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2E144(Method_NoTitleDialog_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C2E110(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
    this->fields.isButtonEnable = 0;
...
void __fastcall NoTitleDialog__OnClickDecide2(NoTitleDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BF9A01 & 1) == 0 )
  {
    sub_1C2E12C(&Method_NoTitleDialog_OnClickDecide2__, method);
    byte_4BF9A01 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_NoTitleDialog_OnClickDecide2__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2E144(Method_NoTitleDialog_OnClickDecide2__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C2E110(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF99FC & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_NoTitleDialog_EndOpen__, v11);
  ...
  sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.onClick, (int64_t)onClick, v15, v16, v17, v18, v19, v20);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF99FD & 1) == 0 )
  {
    sub_1C2E12C(&NoTitleDialog_TypeInfo, label);
