void __fastcall NoTitleDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B40BEC & 1) == 0 )
  {
    sub_1BDB878(&NoTitleDialog_TypeInfo, v1);
    byte_4B40BEC = 1;
  }
  static_fields = NoTitleDialog_TypeInfo->static_fields;
  static_fields->MESSAGE_LABEL_POS_Y = 35;
  *(_OWORD *)&static_fields->MESSAGE_WINDOW_SIZE_X_DEF = xmmword_BEA7F0;
  *(_OWORD *)&static_fields->MESSAGE_LABEL_POS_Y_DEF = xmmword_BEBE00;
}
...
void __fastcall NoTitleDialog__CallOnClick(NoTitleDialog_o *this, bool result, const MethodInfo *method)
{
  ...
  {
    p_onClick->klass = 0LL;
    sub_1BDB81C(p_onClick, 0, (int32_t)method, v3);
...
void __fastcall NoTitleDialog__Close(NoTitleDialog_o *this, const MethodInfo *method)
{
  ...
  NoTitleDialog__Close_34118380(this, 0LL, v2);
}


void __fastcall NoTitleDialog__Close_34118380(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B40BE5 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_NoTitleDialog_EndClose__, v6);
    byte_4B40BE5 = 1;
  }
...
void __fastcall NoTitleDialog__Init(NoTitleDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B40BE2 & 1) == 0 )
  {
    sub_1BDB878(&NoTitleDialog_TypeInfo, method);
...
void __fastcall NoTitleDialog__OnClickCancel(NoTitleDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B40BE9 & 1) == 0 )
  {
    sub_1BDB878(&Method_NoTitleDialog_OnClickCancel__, method);
    byte_4B40BE9 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_NoTitleDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BDB890(Method_NoTitleDialog_OnClickCancel__);
...
void __fastcall NoTitleDialog__OnClickClose(NoTitleDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B40BEA & 1) == 0 )
  {
    sub_1BDB878(&Method_NoTitleDialog_OnClickClose__, method);
    byte_4B40BEA = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_NoTitleDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BDB890(Method_NoTitleDialog_OnClickClose__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BDB85C(v3, v3[4]);
...
void __fastcall NoTitleDialog__OnClickDecide(NoTitleDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B40BE7 & 1) == 0 )
  {
    sub_1BDB878(&Method_NoTitleDialog_OnClickDecide__, method);
    byte_4B40BE7 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_NoTitleDialog_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BDB890(Method_NoTitleDialog_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BDB85C(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
    this->fields.isButtonEnable = 0;
...
void __fastcall NoTitleDialog__OnClickDecide2(NoTitleDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B40BE8 & 1) == 0 )
  {
    sub_1BDB878(&Method_NoTitleDialog_OnClickDecide2__, method);
    byte_4B40BE8 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_NoTitleDialog_OnClickDecide2__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BDB890(Method_NoTitleDialog_OnClickDecide2__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BDB85C(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B40BE3 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_NoTitleDialog_EndOpen__, v11);
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.onClick, (int32_t)onClick, v15, v16);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B40BE4 & 1) == 0 )
  {
    sub_1BDB878(&NoTitleDialog_TypeInfo, label);
