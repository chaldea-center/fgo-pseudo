void NoTitleDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C3F052 & 1) == 0 )
  {
    sub_1C37058(&NoTitleDialog_TypeInfo);
    byte_4C3F052 = 1;
  }
  static_fields = NoTitleDialog_TypeInfo->static_fields;
  static_fields->MESSAGE_LABEL_POS_Y = 35;
  *(_OWORD *)&static_fields->MESSAGE_WINDOW_SIZE_X_DEF = xmmword_C0E5A0;
  *(_OWORD *)&static_fields->MESSAGE_LABEL_POS_Y_DEF = xmmword_C0FCA0;
}
...
void NoTitleDialog__CallOnClick(NoTitleDialog_o *this, bool result, const MethodInfo *method)
{
  ...
  {
    p_onClick->klass = 0;
    sub_1C36FFC(p_onClick, 0, (int32_t)method, v3);
...
void NoTitleDialog__Close(NoTitleDialog_o *this, const MethodInfo *method)
{
  ...
  NoTitleDialog__Close_35019392(this, 0, v2);
}


void NoTitleDialog__Close_35019392(NoTitleDialog_o *this, System_Action_o *callback, const MethodInfo *method)
{
  const MethodInfo *v3; // x3
  ...
  if ( (byte_4C3F04B & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_NoTitleDialog_EndClose__);
    byte_4C3F04B = 1;
  }
...
void NoTitleDialog__OnClickCancel(NoTitleDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3F04F & 1) == 0 )
  {
    sub_1C37058(&Method_NoTitleDialog_OnClickCancel__);
    byte_4C3F04F = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_NoTitleDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C37070(Method_NoTitleDialog_OnClickCancel__);
...
void NoTitleDialog__OnClickClose(NoTitleDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3F050 & 1) == 0 )
  {
    sub_1C37058(&Method_NoTitleDialog_OnClickClose__);
    byte_4C3F050 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_NoTitleDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C37070(Method_NoTitleDialog_OnClickClose__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C3703C(v3, v3[4]);
...
void NoTitleDialog__OnClickDecide(NoTitleDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3F04D & 1) == 0 )
  {
    sub_1C37058(&Method_NoTitleDialog_OnClickDecide__);
    byte_4C3F04D = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_NoTitleDialog_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C37070(Method_NoTitleDialog_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C3703C(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
    this->fields.isButtonEnable = 0;
...
void NoTitleDialog__OnClickDecide2(NoTitleDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3F04E & 1) == 0 )
  {
    sub_1C37058(&Method_NoTitleDialog_OnClickDecide2__);
    byte_4C3F04E = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_NoTitleDialog_OnClickDecide2__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C37070(Method_NoTitleDialog_OnClickDecide2__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C3703C(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C37058(&System_Action_TypeInfo);
    sub_1C37058(&Method_NoTitleDialog_EndOpen__);
    sub_1C37058(&StringLiteral_1/*""*/);
    byte_4C3F049 = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0);
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.onClick, (int32_t)onClick, v12, v13);
