        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01BA9 & 1) == 0 )
  {
    sub_1B64A00(&BattleServantConfConponent_TypeInfo, parentObj);
    sub_1B64A00(&Method_UnityEngine_GameObject_GetComponent_EquipPossessionSkillInfoComponent___, v9);
  ...
  GameObjectExtensions__SetParent_33382564((UnityEngine_GameObject_o *)v12, parentObj, 0LL);
  if ( !v12 )
    goto LABEL_13;
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       ...
                       (const MethodInfo_2E8A7CC *)Method_UnityEngine_GameObject_GetComponent_EquipPossessionSkillInfoComponent___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01BAA & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_2842/*"BATTLE_DIALOG_DETAIL_NOEQUIP"*/, v4);
    byte_4A01BAA = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01BAB & 1) == 0 )
  {
    sub_1B64A00(&BattleServantConfConponent_TypeInfo, *(_QWORD *)&skillId);
    byte_4A01BAB = 1;
  }
  ...
  if ( !BattleServantConfConponent_TypeInfo->_2.cctor_finished )
  {
    ...
    if ( !v11 )
LABEL_23:
      sub_1B64C5C(NoEquipLabel, *(_QWORD *)&skillId);
  }
