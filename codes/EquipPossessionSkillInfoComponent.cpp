        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1945E & 1) == 0 )
  {
    sub_1BCA7E0(&BattleServantConfConponent_TypeInfo, parentObj, *(_QWORD *)&index);
    sub_1BCA7E0(&Method_UnityEngine_GameObject_GetComponent_EquipPossessionSkillInfoComponent___, v9, v10);
    sub_1BCA7E0(&Method_UnityEngine_Object_Instantiate_GameObject___, v11, v12);
    sub_1BCA7E0(&UnityEngine_Object_TypeInfo, v13, v14);
    byte_4B1945E = 1;
  }
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo, parentObj);
  v15 = UnityEngine_Object__Instantiate_object_(
          (Il2CppObject *)baseObj,
          (const MethodInfo_2F9779C *)Method_UnityEngine_Object_Instantiate_GameObject___);
  GameObjectExtensions__SetParent_34336872((UnityEngine_GameObject_o *)v15, parentObj, 0LL);
  if ( !v15 )
    goto LABEL_13;
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)v15, 1, 0LL);
  GameObjectExtensions__ResetTransform((UnityEngine_GameObject_o *)v15, 0LL);
  transform = UnityEngine_GameObject__get_transform((UnityEngine_GameObject_o *)v15, 0LL);
  v18 = transform;
  if ( !BattleServantConfConponent_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(BattleServantConfConponent_TypeInfo, v17);
  if ( !v18 )
    goto LABEL_13;
  v21.fields.z = 0.0;
  v21.fields.y = (float)-(BattleServantConfConponent_TypeInfo->static_fields->EQIUP_SKILL_OBJ_HEIGHT * index) + adjustY;
  v21.fields.x = 0.0;
  UnityEngine_Transform__set_localPosition(v18, v21, 0LL);
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       (UnityEngine_GameObject_o *)v15,
                       (const MethodInfo_2F626D0 *)Method_UnityEngine_GameObject_GetComponent_EquipPossessionSkillInfoComponent___);
  ...
  if ( ((unsigned __int8)transform & 1) != 0 )
  {
    if ( Component_object )
    {
      EquipPossessionSkillInfoComponent__Initialize((EquipPossessionSkillInfoComponent_o *)Component_object, v17);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1945F & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&StringLiteral_2880/*"BATTLE_DIALOG_DETAIL_NOEQUIP"*/, v6, v7);
    byte_4B1945F = 1;
  }
    ...
    if ( !UnityEngine_Object__op_Equality(equipSkillNameLabel, 0LL, 0LL) )
    {
      ...
      if ( !UnityEngine_Object__op_Equality(equipSkillConfLabel, 0LL, 0LL) )
      {
        ...
        if ( !UnityEngine_Object__op_Equality(NoEquipLabel, 0LL, 0LL) )
        {
          ...
          v18 = this->fields.NoEquipLabel;
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, v17);
          gameObject = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2880/*"BATTLE_DIALOG_DETAIL_NOEQUIP"*/, 0LL);
          if ( !v18 )
LABEL_28:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B19460 & 1) == 0 )
  {
    sub_1BCA7E0(&BattleServantConfConponent_TypeInfo, *(_QWORD *)&skillId, skillName);
    byte_4B19460 = 1;
  }
  ...
  if ( !BattleServantConfConponent_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(BattleServantConfConponent_TypeInfo, *(_QWORD *)&skillId);
  ...
  if ( !BattleServantConfConponent_TypeInfo->_2.cctor_finished )
  {
    ...
    if ( !v11 )
LABEL_23:
      sub_1BCAA3C(NoEquipLabel, *(_QWORD *)&skillId);
  }
