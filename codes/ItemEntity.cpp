...
System_String_o *__fastcall ItemEntity__GetAnotherPayName(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1FDE0 & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_16742/*"anotherPayName"*/, method);
    sub_1B715CC(&StringLiteral_1/*""*/, v4);
    byte_4A1FDE0 = 1;
  }
  return ItemEntity__getScript_39178416(
           this,
           (System_String_o *)StringLiteral_16742/*"anotherPayName"*/,
...
int32_t __fastcall ItemEntity__GetBattleAppearEffect(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1FDE2 & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_17053/*"battleAppearEffectId"*/, method);
    byte_4A1FDE2 = 1;
  }
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_17053/*"battleAppearEffectId"*/, 0, v2);
}
...
int32_t __fastcall ItemEntity__GetBattleAppearItemWait(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1FDE4 & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_17054/*"battleAppearItemWait"*/, method);
    byte_4A1FDE4 = 1;
  }
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_17054/*"battleAppearItemWait"*/, 0, v2);
}
...
int32_t __fastcall ItemEntity__GetBattleGetEffect(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1FDE3 & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_17061/*"battleGetEffectId"*/, method);
    byte_4A1FDE3 = 1;
  }
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_17061/*"battleGetEffectId"*/, 0, v2);
}
...
System_String_o *__fastcall ItemEntity__GetCountText(ItemEntity_o *this, int32_t num, const MethodInfo *method)
{
  ...
  return System_String__Concat_61505504(v6, this->fields.unit, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1FDD9 & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_860/*"+"*/, *(_QWORD *)&num);
    sub_1B715CC(&StringLiteral_25104/*"×"*/, v5);
    byte_4A1FDD9 = 1;
  }
  if ( System_String__IsNullOrEmpty(this->fields.unit, 0LL) )
  {
    ...
    return System_String__Concat_61505504((System_String_o *)*v10, CountText, 0LL);
  }
  else
  {
    v11 = System_Int32__ToString((int32_t)&v13, 0LL);
    return System_String__Concat_61505504(v11, this->fields.unit, 0LL);
  }
}
...
int32_t __fastcall ItemEntity__GetImageId(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.type == 29 )
  {
    ...
    if ( !System_String__IsNullOrEmpty(OverwriteImageIdInfo, 0LL) )
    {
      ...
      Master_object = (System_String_array *)DataManager__GetMaster_object_((const MethodInfo_2E5B394 *)Method_DataManager_GetMaster_CommonReleaseMaster___);
...
int32_t __fastcall ItemEntity__GetMaxNum(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1FDE1 & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_21298/*"maxNum"*/, method);
    byte_4A1FDE1 = 1;
  }
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_21298/*"maxNum"*/, 0, v2);
}
...
System_String_o *__fastcall ItemEntity__GetOverwriteImageIdInfo(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1FDDD & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_22336/*"overwriteImageIdInfo"*/, method);
    sub_1B715CC(&StringLiteral_1/*""*/, v4);
    byte_4A1FDDD = 1;
  }
  return ItemEntity__getScript_39178416(
           this,
           (System_String_o *)StringLiteral_22336/*"overwriteImageIdInfo"*/,
           (System_String_o *)StringLiteral_1/*""*/,
           v2);
}
...
System_String_o *__fastcall ItemEntity__GetOverwritePresentboxDetail(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1FDDC & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_22346/*"overwritePresentboxDetail"*/, method);
    sub_1B715CC(&StringLiteral_1/*""*/, v4);
    byte_4A1FDDC = 1;
  }
  return ItemEntity__getScript_39178416(
           this,
           (System_String_o *)StringLiteral_22346/*"overwritePresentboxDetail"*/,
           (System_String_o *)StringLiteral_1/*""*/,
           v2);
}
...
bool __fastcall ItemEntity__IsEnable_39177740(ItemEntity_o *this, int64_t checkTime, const MethodInfo *method)
{
...
bool __fastcall ItemEntity__IsRewardDispTogether(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1FDDE & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_22493/*"playEffect"*/, method);
    byte_4A1FDDE = 1;
  }
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_22493/*"playEffect"*/, 0, v2) != 1;
}
...
System_String_o *__fastcall ItemEntity__getScript_39178416(
        ItemEntity_o *this,
        System_String_o *key,
