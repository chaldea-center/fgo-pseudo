...
System_String_o *__fastcall ItemEntity__GetAnotherPayName(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFDA83 & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_17087/*"anotherPayName"*/, method);
    sub_1C2E12C(&StringLiteral_1/*""*/, v4);
    byte_4BFDA83 = 1;
  }
  return ItemEntity__getScript_40720568(
           this,
           (System_String_o *)StringLiteral_17087/*"anotherPayName"*/,
...
int32_t __fastcall ItemEntity__GetBattleAppearEffect(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFDA85 & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_17404/*"battleAppearEffectId"*/, method);
    byte_4BFDA85 = 1;
  }
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_17404/*"battleAppearEffectId"*/, 0, v2);
}
...
int32_t __fastcall ItemEntity__GetBattleAppearItemWait(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFDA87 & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_17405/*"battleAppearItemWait"*/, method);
    byte_4BFDA87 = 1;
  }
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_17405/*"battleAppearItemWait"*/, 0, v2);
}
...
int32_t __fastcall ItemEntity__GetBattleGetEffect(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFDA86 & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_17412/*"battleGetEffectId"*/, method);
    byte_4BFDA86 = 1;
  }
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_17412/*"battleGetEffectId"*/, 0, v2);
}
...
System_String_o *__fastcall ItemEntity__GetCountText(ItemEntity_o *this, int32_t num, const MethodInfo *method)
{
  ...
  return System_String__Concat_63235584(v6, this->fields.unit, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFDA7C & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_837/*"+"*/, *(_QWORD *)&num);
    sub_1C2E12C(&StringLiteral_25638/*"×"*/, v5);
    byte_4BFDA7C = 1;
  }
  if ( System_String__IsNullOrEmpty(this->fields.unit, 0LL) )
  {
    ...
    if ( v8 )
      v10 = &StringLiteral_837/*"+"*/;
    else
      v10 = &StringLiteral_25638/*"×"*/;
    return System_String__Concat_63235584((System_String_o *)*v10, CountText, 0LL);
  }
  else
  {
    v11 = System_Int32__ToString((int32_t)&v13, 0LL);
    return System_String__Concat_63235584(v11, this->fields.unit, 0LL);
  }
}
...
System_String_o *__fastcall ItemEntity__GetEffectExplanation(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFDA8A & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_19247/*"effectExplanation"*/, method);
    sub_1C2E12C(&StringLiteral_1/*""*/, v4);
    byte_4BFDA8A = 1;
  }
  return ItemEntity__getScript_40720568(
           this,
           (System_String_o *)StringLiteral_19247/*"effectExplanation"*/,
           (System_String_o *)StringLiteral_1/*""*/,
           v2);
}
...
int32_t __fastcall ItemEntity__GetEventId(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFDA88 & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_19472/*"eventId"*/, method);
    byte_4BFDA88 = 1;
  }
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_19472/*"eventId"*/, 0, v2);
}
...
int32_t __fastcall ItemEntity__GetImageId(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.type == 29 )
  {
    ...
    if ( !System_String__IsNullOrEmpty(OverwriteImageIdInfo, 0LL) )
    {
      ...
      Master_object = (System_String_array *)DataManager__GetMaster_object_((const MethodInfo_2FD17DC *)Method_DataManager_GetMaster_CommonReleaseMaster___);
...
int32_t __fastcall ItemEntity__GetMaxNum(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFDA84 & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_21748/*"maxNum"*/, method);
    byte_4BFDA84 = 1;
  }
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_21748/*"maxNum"*/, 0, v2);
}
...
int32_t __fastcall ItemEntity__GetNotDuplicationGroupId(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFDA8D & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_22560/*"notDuplicationGroupId"*/, method);
    byte_4BFDA8D = 1;
  }
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_22560/*"notDuplicationGroupId"*/, 0, v2);
}
...
System_String_o *__fastcall ItemEntity__GetOverwriteImageIdInfo(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFDA80 & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_22813/*"overwriteImageIdInfo"*/, method);
    sub_1C2E12C(&StringLiteral_1/*""*/, v4);
    byte_4BFDA80 = 1;
  }
  return ItemEntity__getScript_40720568(
           this,
           (System_String_o *)StringLiteral_22813/*"overwriteImageIdInfo"*/,
           (System_String_o *)StringLiteral_1/*""*/,
           v2);
}
...
System_String_o *__fastcall ItemEntity__GetOverwritePresentboxDetail(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFDA7F & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_22824/*"overwritePresentboxDetail"*/, method);
    sub_1C2E12C(&StringLiteral_1/*""*/, v4);
    byte_4BFDA7F = 1;
  }
  return ItemEntity__getScript_40720568(
           this,
           (System_String_o *)StringLiteral_22824/*"overwritePresentboxDetail"*/,
           (System_String_o *)StringLiteral_1/*""*/,
           v2);
}
...
int32_t __fastcall ItemEntity__GetQuestUseItemGroupId(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFDA8C & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_23123/*"questUseItemGroupId"*/, method);
    byte_4BFDA8C = 1;
  }
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_23123/*"questUseItemGroupId"*/, 0, v2);
}
...
int32_t __fastcall ItemEntity__GetQuestUseItemPriority(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFDA8B & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_23124/*"questUseItemPriority"*/, method);
    byte_4BFDA8B = 1;
  }
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_23124/*"questUseItemPriority"*/, 0, v2);
}
...
int32_t __fastcall ItemEntity__GetTradePickupTime(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFDA89 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&StringLiteral_24487/*"tradePickupTime"*/, v4);
    byte_4BFDA89 = 1;
  }
  ...
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_24487/*"tradePickupTime"*/, v5->static_fields->SECONDS_PER_DAY, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFDA8E & 1) == 0 )
  {
    sub_1C2E12C(&Method_DataManager_GetMaster_EventMaster___, *(_QWORD *)&eventId);
...
bool __fastcall ItemEntity__IsEnable_40719892(ItemEntity_o *this, int64_t checkTime, const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
bool __fastcall ItemEntity__IsEnable_40721992(ItemEntity_o *this, int32_t eventId, const MethodInfo *method)
{
  __int64 v5; // x1
  __int64 v6; // x1
  __int64 v7; // x1
...
bool __fastcall ItemEntity__IsRewardDispTogether(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFDA81 & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_22975/*"playEffect"*/, method);
    byte_4BFDA81 = 1;
  }
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_22975/*"playEffect"*/, 0, v2) != 1;
}
...
System_String_o *__fastcall ItemEntity__getScript_40720568(
        ItemEntity_o *this,
        System_String_o *key,
