...
System_String_o *ItemEntity__GetAnotherPayName(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E04EAE & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_16967/*"anotherPayName"*/);
    sub_1CE6700(&StringLiteral_1/*""*/);
    byte_4E04EAE = 1;
  }
  return ItemEntity__getScript_43510096(
           this,
           (System_String_o *)StringLiteral_16967/*"anotherPayName"*/,
...
int32_t ItemEntity__GetBattleAppearEffect(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E04EB0 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_17244/*"battleAppearEffectId"*/);
    byte_4E04EB0 = 1;
  }
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_17244/*"battleAppearEffectId"*/, 0, v2);
}
...
int32_t ItemEntity__GetBattleAppearItemWait(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E04EB2 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_17245/*"battleAppearItemWait"*/);
    byte_4E04EB2 = 1;
  }
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_17245/*"battleAppearItemWait"*/, 0, v2);
}
...
int32_t ItemEntity__GetBattleGetEffect(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E04EB1 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_17254/*"battleGetEffectId"*/);
    byte_4E04EB1 = 1;
  }
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_17254/*"battleGetEffectId"*/, 0, v2);
}
...
System_String_o *ItemEntity__GetCountText(ItemEntity_o *this, int32_t num, const MethodInfo *method)
{
  ...
  return System_String__Concat_65122828(v6, this->fields.unit, 0);
}
...
System_String_o *ItemEntity__GetCountTextWithPrefix(ItemEntity_o *this, int32_t num, const MethodInfo *method)
{
  ...
  if ( System_String__IsNullOrEmpty(this->fields.unit, 0) )
  {
    ...
    if ( v7 )
      ...
      v9 = &StringLiteral_25681/*"×"*/;
    return System_String__Concat_65122828((System_String_o *)*v9, CountText, 0);
  }
  else
  {
    v10 = System_Int32__ToString((int32_t)&v12, 0);
    return System_String__Concat_65122828(v10, this->fields.unit, 0);
  }
}
...
System_String_o *ItemEntity__GetEffectExplanation(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E04EB5 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_19157/*"effectExplanation"*/);
    sub_1CE6700(&StringLiteral_1/*""*/);
    byte_4E04EB5 = 1;
  }
  return ItemEntity__getScript_43510096(
           this,
           (System_String_o *)StringLiteral_19157/*"effectExplanation"*/,
           (System_String_o *)StringLiteral_1/*""*/,
           v2);
}
...
int32_t ItemEntity__GetEventId(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_19400/*"eventId"*/, 0, v2);
}
...
int32_t ItemEntity__GetImageId(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.type == 29 )
  {
    ...
    if ( !BasicHelper__IsNullOrEmpty((System_Collections_ICollection_o *)OverwriteImageIdInfo, 0) )
    {
      ...
      Master_object = (System_String_o *)DataManager__GetMaster_object_((const MethodInfo_3204354 *)Method_DataManager_GetMaster_CommonReleaseMaster___);
...
int32_t ItemEntity__GetMaxNum(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E04EAF & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_21837/*"maxNum"*/);
    byte_4E04EAF = 1;
  }
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_21837/*"maxNum"*/, 0, v2);
}
...
int32_t ItemEntity__GetNotDuplicationGroupId(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E04EB8 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_22645/*"notDuplicationGroupId"*/);
    byte_4E04EB8 = 1;
  }
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_22645/*"notDuplicationGroupId"*/, 0, v2);
}
...
System_String_array *ItemEntity__GetOverwriteImageIdInfo(ItemEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4E04EAB & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_22909/*"overwriteImageIdInfo"*/);
    byte_4E04EAB = 1;
  }
  return EntityScriptUtil__GetStringArray(this->fields.script, (System_String_o *)StringLiteral_22909/*"overwriteImageIdInfo"*/, 0, 0);
}
...
System_String_o *ItemEntity__GetOverwritePresentboxDetail(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E04EAA & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_22921/*"overwritePresentboxDetail"*/);
    sub_1CE6700(&StringLiteral_1/*""*/);
    byte_4E04EAA = 1;
  }
  return ItemEntity__getScript_43510096(
           this,
           (System_String_o *)StringLiteral_22921/*"overwritePresentboxDetail"*/,
           (System_String_o *)StringLiteral_1/*""*/,
           v2);
}
...
int32_t ItemEntity__GetQuestUseItemGroupId(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E04EB7 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_23232/*"questUseItemGroupId"*/);
    byte_4E04EB7 = 1;
  }
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_23232/*"questUseItemGroupId"*/, 0, v2);
}
...
int32_t ItemEntity__GetQuestUseItemPriority(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E04EB6 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_23233/*"questUseItemPriority"*/);
    byte_4E04EB6 = 1;
  }
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_23233/*"questUseItemPriority"*/, 0, v2);
}
...
System_Int32_array *ItemEntity__GetSkillList(ItemEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4E04EBB & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_23886/*"skillList"*/);
    byte_4E04EBB = 1;
  }
  return EntityScriptUtil__GetIntArray(this->fields.script, (System_String_o *)StringLiteral_23886/*"skillList"*/, 0, 0);
}
...
int32_t ItemEntity__GetTradePickupTime(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E04EB4 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_24560/*"tradePickupTime"*/);
    byte_4E04EB4 = 1;
  }
  ...
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_24560/*"tradePickupTime"*/, v4->static_fields->SECONDS_PER_DAY, v2);
}
...
bool ItemEntity__IsEnable_43508920(ItemEntity_o *this, int64_t checkTime, const MethodInfo *method)
{
  return this->fields.startedAt <= checkTime && (this->fields.endedAt == 0 || this->fields.endedAt >= checkTime);
}


bool ItemEntity__IsEnable_43511588(ItemEntity_o *this, int32_t eventId, const MethodInfo *method)
{
  int64_t Time; // x21
  Il2CppObject *Master_object; // x0
...
bool ItemEntity__IsRewardDispTogether(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E04EAC & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_23074/*"playEffect"*/);
    byte_4E04EAC = 1;
  }
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_23074/*"playEffect"*/, 0, v2) != 1;
}
...
System_String_o *ItemEntity__getScript_43510096(
        ItemEntity_o *this,
        System_String_o *key,
