...
System_String_o *ItemEntity__GetAnotherPayName(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB6750 & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_16805/*"anotherPayName"*/);
    sub_1C6BA08(&StringLiteral_1/*""*/);
    byte_4CB6750 = 1;
  }
  return ItemEntity__getScript_42601540(
           this,
           (System_String_o *)StringLiteral_16805/*"anotherPayName"*/,
...
int32_t ItemEntity__GetBattleAppearEffect(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB6752 & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_17079/*"battleAppearEffectId"*/);
    byte_4CB6752 = 1;
  }
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_17079/*"battleAppearEffectId"*/, 0, v2);
}
...
int32_t ItemEntity__GetBattleAppearItemWait(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB6754 & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_17080/*"battleAppearItemWait"*/);
    byte_4CB6754 = 1;
  }
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_17080/*"battleAppearItemWait"*/, 0, v2);
}
...
int32_t ItemEntity__GetBattleGetEffect(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB6753 & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_17088/*"battleGetEffectId"*/);
    byte_4CB6753 = 1;
  }
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_17088/*"battleGetEffectId"*/, 0, v2);
}
...
System_String_o *ItemEntity__GetCountText(ItemEntity_o *this, int32_t num, const MethodInfo *method)
{
  ...
  return System_String__Concat_63966792(v6, this->fields.unit, 0);
}
...
System_String_o *ItemEntity__GetCountTextWithPrefix(ItemEntity_o *this, int32_t num, const MethodInfo *method)
{
  ...
  if ( System_String__IsNullOrEmpty(this->fields.unit, 0) )
  {
    ...
    if ( v7 )
      ...
      v9 = &StringLiteral_25377/*"×"*/;
    return System_String__Concat_63966792((System_String_o *)*v9, CountText, 0);
  }
  else
  {
    v10 = System_Int32__ToString((int32_t)&v12, 0);
    return System_String__Concat_63966792(v10, this->fields.unit, 0);
  }
}
...
System_String_o *ItemEntity__GetEffectExplanation(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB6757 & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_18955/*"effectExplanation"*/);
    sub_1C6BA08(&StringLiteral_1/*""*/);
    byte_4CB6757 = 1;
  }
  return ItemEntity__getScript_42601540(
           this,
           (System_String_o *)StringLiteral_18955/*"effectExplanation"*/,
           (System_String_o *)StringLiteral_1/*""*/,
           v2);
}
...
int32_t ItemEntity__GetEventId(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_19195/*"eventId"*/, 0, v2);
}
...
int32_t ItemEntity__GetImageId(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.type == 29 )
  {
    ...
    if ( !BasicHelper__IsNullOrEmpty((System_Collections_ICollection_o *)OverwriteImageIdInfo, 0) )
    {
      ...
      Master_object = (System_String_o *)DataManager__GetMaster_object_((const MethodInfo_313B314 *)Method_DataManager_GetMaster_CommonReleaseMaster___);
...
int32_t ItemEntity__GetMaxNum(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB6751 & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_21586/*"maxNum"*/);
    byte_4CB6751 = 1;
  }
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_21586/*"maxNum"*/, 0, v2);
}
...
int32_t ItemEntity__GetNotDuplicationGroupId(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB675A & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_22389/*"notDuplicationGroupId"*/);
    byte_4CB675A = 1;
  }
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_22389/*"notDuplicationGroupId"*/, 0, v2);
}
...
System_String_array *ItemEntity__GetOverwriteImageIdInfo(ItemEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4CB674D & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_22647/*"overwriteImageIdInfo"*/);
    byte_4CB674D = 1;
  }
  return EntityScriptUtil__GetStringArray(this->fields.script, (System_String_o *)StringLiteral_22647/*"overwriteImageIdInfo"*/, 0, 0);
}
...
System_String_o *ItemEntity__GetOverwritePresentboxDetail(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB674C & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_22659/*"overwritePresentboxDetail"*/);
    sub_1C6BA08(&StringLiteral_1/*""*/);
    byte_4CB674C = 1;
  }
  return ItemEntity__getScript_42601540(
           this,
           (System_String_o *)StringLiteral_22659/*"overwritePresentboxDetail"*/,
           (System_String_o *)StringLiteral_1/*""*/,
           v2);
}
...
int32_t ItemEntity__GetQuestUseItemGroupId(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB6759 & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_22961/*"questUseItemGroupId"*/);
    byte_4CB6759 = 1;
  }
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_22961/*"questUseItemGroupId"*/, 0, v2);
}
...
int32_t ItemEntity__GetQuestUseItemPriority(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB6758 & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_22962/*"questUseItemPriority"*/);
    byte_4CB6758 = 1;
  }
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_22962/*"questUseItemPriority"*/, 0, v2);
}
...
int32_t ItemEntity__GetTradePickupTime(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB6756 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_24267/*"tradePickupTime"*/);
    byte_4CB6756 = 1;
  }
  ...
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_24267/*"tradePickupTime"*/, v4->static_fields->SECONDS_PER_DAY, v2);
}
...
bool ItemEntity__IsEnable_42600356(ItemEntity_o *this, int64_t checkTime, const MethodInfo *method)
{
  return this->fields.startedAt <= checkTime && (this->fields.endedAt == 0 || this->fields.endedAt >= checkTime);
}


bool ItemEntity__IsEnable_42603032(ItemEntity_o *this, int32_t eventId, const MethodInfo *method)
{
  int64_t Time; // x21
  Il2CppObject *Master_object; // x0
...
bool ItemEntity__IsRewardDispTogether(ItemEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB674E & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_22805/*"playEffect"*/);
    byte_4CB674E = 1;
  }
  return ItemEntity__getScript(this, (System_String_o *)StringLiteral_22805/*"playEffect"*/, 0, v2) != 1;
}
...
System_String_o *ItemEntity__getScript_42601540(
        ItemEntity_o *this,
        System_String_o *key,
