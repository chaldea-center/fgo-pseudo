        ...
        const MethodInfo *method)
{
  ...
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&v8->fields, (int32_t)aiActEnt, v9, v10, v11, v12, v13, v14);
  v8->fields._AiEnt_k__BackingField = aiEnt;
  v8 = (BaseAiActArgument_o *)((char *)v8 + 24);
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)v8, (int32_t)aiEnt, v15, v16, v17, v18, v19, v20);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_593B93C & 1) == 0 )
  {
    sub_21FFC50(&BaseAiActBattleLogicTask_TypeInfo);
    byte_593B93C = 1;
  }
  v7 = (BaseAiActBattleLogicTask_o *)sub_21FFEBC(BaseAiActBattleLogicTask_TypeInfo);
  BaseAiActBattleLogicTask___ctor(v7, actType, 0);
  return BaseAiActArgument__MakeTask_53875968(this, v7, logicAi, v8);
}


BattleLogicTask_o *BaseAiActArgument__MakeTask_53875968(
        BaseAiActArgument_o *this,
        BaseAiActBattleLogicTask_o *task,
        BattleLogicBaseAi_o *logicAi,
        const MethodInfo *method)
