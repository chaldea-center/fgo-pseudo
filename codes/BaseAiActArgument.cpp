        ...
        const MethodInfo *method)
{
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields, (int64_t)aiActEnt, v7, v8, v9, v10, v11, v12);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6983A & 1) == 0 )
  {
    sub_1BE4ACC(&BaseAiActBattleLogicTask_TypeInfo, logicAi);
    byte_4B6983A = 1;
  }
  v7 = (BaseAiActBattleLogicTask_o *)sub_1BE4D18(BaseAiActBattleLogicTask_TypeInfo);
  BaseAiActBattleLogicTask___ctor(v7, actType, 0LL);
  return BaseAiActArgument__MakeTask_44493816(this, v7, logicAi, v8);
}


BattleLogicTask_o *__fastcall BaseAiActArgument__MakeTask_44493816(
        BaseAiActArgument_o *this,
        BaseAiActBattleLogicTask_o *task,
        BattleLogicBaseAi_o *logicAi,
        const MethodInfo *method)
