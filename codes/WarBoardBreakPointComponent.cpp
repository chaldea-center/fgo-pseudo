void WarBoardBreakPointComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E74E28 & 1) == 0 )
  {
    sub_1D0F0B4(&WarBoardBreakPointComponent_TypeInfo);
    sub_1D0F0B4(&StringLiteral_9058/*"MasterPoint_recharge_effect_1"*/);
    sub_1D0F0B4(&StringLiteral_17678/*"break_on_boss"*/);
    sub_1D0F0B4(&StringLiteral_21897/*"master_gauge_off_{0}"*/);
    sub_1D0F0B4(&StringLiteral_17676/*"break_off_boss"*/);
    sub_1D0F0B4(&StringLiteral_17677/*"break_on"*/);
    sub_1D0F0B4(&StringLiteral_17675/*"break_off"*/);
    sub_1D0F0B4(&StringLiteral_25246/*"wall_gauge_{0}"*/);
    sub_1D0F0B4(&StringLiteral_21898/*"master_gauge_{0}"*/);
    sub_1D0F0B4(&StringLiteral_3251/*"BreakPoint_effect_{0}"*/);
    sub_1D0F0B4(&StringLiteral_9057/*"MasterPoint_effect_{0}"*/);
    byte_4E74E28 = 1;
  }
  WarBoardBreakPointComponent_TypeInfo->static_fields->BreakPointOnImageName = (struct System_String_o *)StringLiteral_17677/*"break_on"*/;
  sub_1D0F058(
    (GrandQuestFolderBoardItem_o *)WarBoardBreakPointComponent_TypeInfo->static_fields,
    StringLiteral_17677/*"break_on"*/,
    v1,
    v2,
    v3,
    v4,
    v5,
    v6);
  v7 = StringLiteral_17675/*"break_off"*/;
  static_fields = WarBoardBreakPointComponent_TypeInfo->static_fields;
  static_fields->BreakPointOffImageName = (struct System_String_o *)StringLiteral_17675/*"break_off"*/;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&static_fields->BreakPointOffImageName, v7, v9, v10, v11, v12, v13, v14);
  v15 = StringLiteral_17678/*"break_on_boss"*/;
  v16 = WarBoardBreakPointComponent_TypeInfo->static_fields;
  v16->EnemyBreakPointOnImageName = (struct System_String_o *)StringLiteral_17678/*"break_on_boss"*/;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&v16->EnemyBreakPointOnImageName, v15, v17, v18, v19, v20, v21, v22);
  v23 = StringLiteral_17676/*"break_off_boss"*/;
  v24 = WarBoardBreakPointComponent_TypeInfo->static_fields;
  v24->EnemyBreakPointOffImageName = (struct System_String_o *)StringLiteral_17676/*"break_off_boss"*/;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&v24->EnemyBreakPointOffImageName, v23, v25, v26, v27, v28, v29, v30);
  v31 = StringLiteral_3251/*"BreakPoint_effect_{0}"*/;
  v32 = WarBoardBreakPointComponent_TypeInfo->static_fields;
  v32->BreakPointEffectName = (struct System_String_o *)StringLiteral_3251/*"BreakPoint_effect_{0}"*/;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&v32->BreakPointEffectName, v31, v33, v34, v35, v36, v37, v38);
  v39 = StringLiteral_21898/*"master_gauge_{0}"*/;
  v40 = WarBoardBreakPointComponent_TypeInfo->static_fields;
  v40->MasterPointOnImageName = (struct System_String_o *)StringLiteral_21898/*"master_gauge_{0}"*/;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&v40->MasterPointOnImageName, v39, v41, v42, v43, v44, v45, v46);
  v47 = StringLiteral_21897/*"master_gauge_off_{0}"*/;
  v48 = WarBoardBreakPointComponent_TypeInfo->static_fields;
  v48->MasterPointOffImageName = (struct System_String_o *)StringLiteral_21897/*"master_gauge_off_{0}"*/;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&v48->MasterPointOffImageName, v47, v49, v50, v51, v52, v53, v54);
  v55 = StringLiteral_9057/*"MasterPoint_effect_{0}"*/;
  v56 = WarBoardBreakPointComponent_TypeInfo->static_fields;
  v56->MasterPointEffectName = (struct System_String_o *)StringLiteral_9057/*"MasterPoint_effect_{0}"*/;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&v56->MasterPointEffectName, v55, v57, v58, v59, v60, v61, v62);
  v63 = StringLiteral_9058/*"MasterPoint_recharge_effect_1"*/;
  v64 = WarBoardBreakPointComponent_TypeInfo->static_fields;
  v64->MasterPointRechargeEffectName = (struct System_String_o *)StringLiteral_9058/*"MasterPoint_recharge_effect_1"*/;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&v64->MasterPointRechargeEffectName, v63, v65, v66, v67, v68, v69, v70);
  v71 = WarBoardBreakPointComponent_TypeInfo->static_fields;
  v72 = StringLiteral_25246/*"wall_gauge_{0}"*/;
  v71->wallPointImageName = (struct System_String_o *)StringLiteral_25246/*"wall_gauge_{0}"*/;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&v71->wallPointImageName, v72, v73, v74, v75, v76, v77, v78);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E74E23 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_UnityEngine_GameObject_GetComponent_WarBoardBreakPointEffectComponent___);
    ...
    sub_1D0F0B4(&Method_WarBoardBreakPointComponent__OnBreak_b__26_0__);
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)CommonEffectAsset_object, 0, 0) )
  {
    ...
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    BreakEffectName = (char *)UnityEngine_Object__Instantiate_object__53335036(
    ...
    BreakEffectName = (char *)UnityEngine_GameObject__GetComponent_object_(
                                ...
                                (const MethodInfo_32A8444 *)Method_UnityEngine_GameObject_GetComponent_WarBoardBreakPointEffectComponent___);
    if ( !BreakEffectName )
      goto LABEL_37;
    *((_QWORD *)BreakEffectName + 4) = this;
    sub_1D0F058((GrandQuestFolderBoardItem_o *)(BreakEffectName + 32), (int32_t)this, v14, v15, v16, v17, v18, v19);
    v20 = (WarBoardCommonEffectPerformance_o *)sub_1D0F300(WarBoardCommonEffectPerformance_TypeInfo);
    ...
    *(_QWORD *)&v63.fields.value.fields.y = 0;
    ...
    if ( startCallback )
    {
      ...
      sub_1D0F058((GrandQuestFolderBoardItem_o *)&v21->fields.StartCallback, (int32_t)v23, v24, v25, v26, v27, v28, v29);
    }
    else if ( !v21 )
    {
      goto LABEL_37;
    ...
    v33 = (WarBoardTaskBase_TaskCallback_o *)sub_1D0F300(WarBoardTaskBase_TaskCallback_TypeInfo);
...
LABEL_26:
    ...
    if ( (WarBoardTaskBase_TaskCallback_c *)v34->klass == WarBoardTaskBase_TaskCallback_TypeInfo )
    {
      ...
      {
LABEL_27:
        sub_1D0F058((GrandQuestFolderBoardItem_o *)startCallback, (int32_t)v30, v35, v36, v37, v38, v39, v40);
        if ( taskList )
        {
          ...
          if ( items )
          {
            ...
            else
            {
              ...
              sub_1D0F058((GrandQuestFolderBoardItem_o *)(v51 + 4), (int32_t)v21, v42, v43, v44, v45, v46, v47);
            }
            return;
          }
        }
        ...
        {
          v52 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3BAC684 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
          BreakEffectName = (char *)sub_1D0F15C(WarBoardTaskBase___TypeInfo, 1);
          if ( BreakEffectName )
          {
            v53 = BreakEffectName;
            v54 = sub_1D0F1F0(v21, *(_QWORD *)(*(_QWORD *)BreakEffectName + 64LL));
            if ( !v54 )
            {
              v61 = sub_1D0F330();
              sub_1D0F1DC(v61, 0);
            ...
            if ( !*((_DWORD *)v53 + 6) )
              sub_1D0F314(v54);
            *((_QWORD *)v53 + 4) = v21;
            sub_1D0F058((GrandQuestFolderBoardItem_o *)(v53 + 32), (int32_t)v21, v55, v56, v57, v58, v59, v60);
            if ( v52 )
            {
...
LABEL_37:
        sub_1D0F30C(BreakEffectName, v10);
      }
    }
LABEL_25:
    sub_1D0F6A8(v30);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E74E24 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    sub_1D0F0B4(&WarBoardTaskBase_TaskCallback_TypeInfo);
    sub_1D0F0B4(&Method_WarBoardBreakPointComponent__ShowMasterRechargeEffect_b__27_0__);
    sub_1D0F0B4(&WarBoardBreakPointComponent_TypeInfo);
    sub_1D0F0B4(&WarBoardCommonEffectPerformance_TypeInfo);
    sub_1D0F0B4(&Method_WarBoardManager_GetCommonEffectAsset_GameObject___);
    sub_1D0F0B4(&WarBoardTaskBase___TypeInfo);
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)CommonEffectAsset_object, 0, 0) )
  {
    ...
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    Instance = UnityEngine_Object__Instantiate_object__53335036(
                 CommonEffectAsset_object,
                 transform,
                 (const MethodInfo_32DD3FC *)Method_UnityEngine_Object_Instantiate_GameObject____80459208);
    if ( Instance )
    {
      ...
      if ( Instance )
      {
        ...
        sub_1D0F058((GrandQuestFolderBoardItem_o *)&Instance[2], (int32_t)this, v11, v12, v13, v14, v15, v16);
        v17 = (WarBoardCommonEffectPerformance_o *)sub_1D0F300(WarBoardCommonEffectPerformance_TypeInfo);
        ...
        *(_QWORD *)&v51.fields.value.fields.y = 0;
        ...
        if ( v18 )
        {
          ...
          v21 = (WarBoardTaskBase_TaskCallback_o *)sub_1D0F300(WarBoardTaskBase_TaskCallback_TypeInfo);
          WarBoardTaskBase_TaskCallback___ctor(
            v21,
            (Il2CppObject *)this,
          ...
          if ( taskList )
          {
            ...
            if ( items )
            {
              ...
              else
              {
                ...
                sub_1D0F058((GrandQuestFolderBoardItem_o *)(v39 + 4), (int32_t)v18, v30, v31, v32, v33, v34, v35);
              }
              return;
            }
          }
          ...
          {
            v40 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3BAC684 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
            Instance = (Il2CppObject *)sub_1D0F15C(WarBoardTaskBase___TypeInfo, 1);
            if ( Instance )
            {
              v41 = Instance;
              v42 = sub_1D0F1F0(v18, Instance->klass->_1.element_class);
              if ( !v42 )
              {
                v49 = sub_1D0F330();
                sub_1D0F1DC(v49, 0);
              ...
              sub_1D0F058((GrandQuestFolderBoardItem_o *)&v41[2], (int32_t)v18, v43, v44, v45, v46, v47, v48);
              if ( v40 )
              {
