void __fastcall WarBoardBreakPointComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_42AEB0D & 1) == 0 )
  {
    sub_B52984(&WarBoardBreakPointComponent_TypeInfo);
    sub_B52984(&StringLiteral_9031/*"MasterPoint_recharge_effect_1"*/);
    sub_B52984(&StringLiteral_17054/*"break_on_boss"*/);
    sub_B52984(&StringLiteral_20567/*"master_gauge_off_{0}"*/);
    sub_B52984(&StringLiteral_17052/*"break_off_boss"*/);
    sub_B52984(&StringLiteral_17053/*"break_on"*/);
    sub_B52984(&StringLiteral_17051/*"break_off"*/);
    sub_B52984(&StringLiteral_23389/*"wall_gauge_{0}"*/);
    sub_B52984(&StringLiteral_20568/*"master_gauge_{0}"*/);
    sub_B52984(&StringLiteral_2895/*"BreakPoint_effect_{0}"*/);
    sub_B52984(&StringLiteral_9030/*"MasterPoint_effect_{0}"*/);
    byte_42AEB0D = 1;
  }
  static_fields = (BattleServantConfConponent_o *)WarBoardBreakPointComponent_TypeInfo->static_fields;
  v8 = (System_Int32_array **)StringLiteral_17053/*"break_on"*/;
  static_fields->klass = (BattleServantConfConponent_c *)StringLiteral_17053/*"break_on"*/;
  sub_B52920(static_fields, v8, v1, v2, v3, v4, v5, v6);
  v9 = WarBoardBreakPointComponent_TypeInfo->static_fields;
  v10 = (System_Int32_array **)StringLiteral_17051/*"break_off"*/;
  v9->BreakPointOffImageName = (struct System_String_o *)StringLiteral_17051/*"break_off"*/;
  sub_B52920((BattleServantConfConponent_o *)&v9->BreakPointOffImageName, v10, v11, v12, v13, v14, v15, v16);
  v17 = WarBoardBreakPointComponent_TypeInfo->static_fields;
  v18 = (System_Int32_array **)StringLiteral_17054/*"break_on_boss"*/;
  v17->EnemyBreakPointOnImageName = (struct System_String_o *)StringLiteral_17054/*"break_on_boss"*/;
  sub_B52920((BattleServantConfConponent_o *)&v17->EnemyBreakPointOnImageName, v18, v19, v20, v21, v22, v23, v24);
  v25 = WarBoardBreakPointComponent_TypeInfo->static_fields;
  v26 = (System_Int32_array **)StringLiteral_17052/*"break_off_boss"*/;
  v25->EnemyBreakPointOffImageName = (struct System_String_o *)StringLiteral_17052/*"break_off_boss"*/;
  sub_B52920((BattleServantConfConponent_o *)&v25->EnemyBreakPointOffImageName, v26, v27, v28, v29, v30, v31, v32);
  v33 = WarBoardBreakPointComponent_TypeInfo->static_fields;
  v34 = (System_Int32_array **)StringLiteral_2895/*"BreakPoint_effect_{0}"*/;
  v33->BreakPointEffectName = (struct System_String_o *)StringLiteral_2895/*"BreakPoint_effect_{0}"*/;
  sub_B52920((BattleServantConfConponent_o *)&v33->BreakPointEffectName, v34, v35, v36, v37, v38, v39, v40);
  v41 = WarBoardBreakPointComponent_TypeInfo->static_fields;
  v42 = (System_Int32_array **)StringLiteral_20568/*"master_gauge_{0}"*/;
  v41->MasterPointOnImageName = (struct System_String_o *)StringLiteral_20568/*"master_gauge_{0}"*/;
  sub_B52920((BattleServantConfConponent_o *)&v41->MasterPointOnImageName, v42, v43, v44, v45, v46, v47, v48);
  v49 = WarBoardBreakPointComponent_TypeInfo->static_fields;
  v50 = (System_Int32_array **)StringLiteral_20567/*"master_gauge_off_{0}"*/;
  v49->MasterPointOffImageName = (struct System_String_o *)StringLiteral_20567/*"master_gauge_off_{0}"*/;
  sub_B52920((BattleServantConfConponent_o *)&v49->MasterPointOffImageName, v50, v51, v52, v53, v54, v55, v56);
  v57 = WarBoardBreakPointComponent_TypeInfo->static_fields;
  v58 = (System_Int32_array **)StringLiteral_9030/*"MasterPoint_effect_{0}"*/;
  v57->MasterPointEffectName = (struct System_String_o *)StringLiteral_9030/*"MasterPoint_effect_{0}"*/;
  sub_B52920((BattleServantConfConponent_o *)&v57->MasterPointEffectName, v58, v59, v60, v61, v62, v63, v64);
  v65 = WarBoardBreakPointComponent_TypeInfo->static_fields;
  v66 = (System_Int32_array **)StringLiteral_9031/*"MasterPoint_recharge_effect_1"*/;
  v65->MasterPointRechargeEffectName = (struct System_String_o *)StringLiteral_9031/*"MasterPoint_recharge_effect_1"*/;
  sub_B52920((BattleServantConfConponent_o *)&v65->MasterPointRechargeEffectName, v66, v67, v68, v69, v70, v71, v72);
  v73 = WarBoardBreakPointComponent_TypeInfo->static_fields;
  v74 = (System_Int32_array **)StringLiteral_23389/*"wall_gauge_{0}"*/;
  v73->wallPointImageName = (struct System_String_o *)StringLiteral_23389/*"wall_gauge_{0}"*/;
  sub_B52920((BattleServantConfConponent_o *)&v73->wallPointImageName, v74, v75, v76, v77, v78, v79, v80);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( this->fields.isMaster || this->fields.isThirdForce )
  {
    ...
    v4 = &v12;
    MasterPointEffectName = v3->static_fields->MasterPointEffectName;
    v6 = int_TypeInfo;
    v12 = 1;
  }
  else
  {
    ...
    v4 = &v13;
    MasterPointEffectName = v9->static_fields->BreakPointEffectName;
    v6 = int_TypeInfo;
    if ( isEnemyServant )
      v11 = 2;
    else
  ...
  v7 = (Il2CppObject *)j_il2cpp_value_box_0(v6, v4);
  return System_String__Format(MasterPointEffectName, v7, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AEB08 & 1) == 0 )
  {
    sub_B52984(&Method_UnityEngine_GameObject_GetComponent_WarBoardBreakPointEffectComponent___);
    ...
    sub_B52984(&Method_WarBoardBreakPointComponent__OnBreak_b__26_0__);
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)CommonEffectAsset_object, 0LL, 0LL) )
  {
    ...
    BreakEffectName = (char *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                ...
                                (const MethodInfo_1B7B1B8 *)Method_UnityEngine_GameObject_GetComponent_WarBoardBreakPointEffectComponent___);
    if ( !BreakEffectName )
      goto LABEL_29;
    *((_QWORD *)BreakEffectName + 3) = this;
    sub_B52920(
      ...
      v18,
      v19);
    v20 = (WarBoardCommonEffectPerformance_o *)sub_B52A54(WarBoardCommonEffectPerformance_TypeInfo);
    ...
    *(_QWORD *)&v52.fields.value.fields.z = 0LL;
    ...
    if ( startCallback )
    {
      ...
      sub_B52920((BattleServantConfConponent_o *)&v21->fields.StartCallback, v22, v23, v24, v25, v26, v27, v28);
    }
    else if ( !v21 )
    {
      goto LABEL_29;
    ...
    v31 = (WarBoardTaskBase_TaskCallback_o *)sub_B52A54(WarBoardTaskBase_TaskCallback_TypeInfo);
    ...
    if ( !v32 || *v32 == (System_Int32_array *)WarBoardTaskBase_TaskCallback_TypeInfo )
    {
      ...
      sub_B52920((BattleServantConfConponent_o *)&v21->fields.EndCallback, v32, v33, v34, v35, v36, v37, v38);
      if ( taskList )
      {
      ...
      BreakEffectName = (char *)sub_B5299C(WarBoardTaskBase___TypeInfo, 1LL);
      if ( !BreakEffectName )
        goto LABEL_29;
      v40 = BreakEffectName;
      v41 = sub_B52A44(v21, *(_QWORD *)(*(_QWORD *)BreakEffectName + 64LL));
      if ( v41 )
      {
        if ( !*((_DWORD *)v40 + 6) )
        {
        ...
        *((_QWORD *)v40 + 4) = v21;
        sub_B52920((BattleServantConfConponent_o *)(v40 + 32), (System_Int32_array **)v21, v42, v43, v44, v45, v46, v47);
        if ( v39 )
        {
...
LABEL_29:
        sub_B52A5C(BreakEffectName, v10);
      }
LABEL_31:
      v48 = sub_B52A7C();
      sub_B52A28(v48, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AEB09 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    sub_B52984(&WarBoardTaskBase_TaskCallback_TypeInfo);
    sub_B52984(&Method_WarBoardBreakPointComponent__ShowMasterRechargeEffect_b__27_0__);
    sub_B52984(&WarBoardBreakPointComponent_TypeInfo);
    sub_B52984(&WarBoardCommonEffectPerformance_TypeInfo);
    sub_B52984(&Method_WarBoardManager_GetCommonEffectAsset_GameObject___);
    sub_B52984(&WarBoardTaskBase___TypeInfo);
  ...
  Instance = (char *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)CommonEffectAsset_object, 0LL, 0LL) )
  {
    ...
    *((_QWORD *)Instance + 3) = this;
    sub_B52920(
      ...
      v15,
      v16);
    v17 = (WarBoardCommonEffectPerformance_o *)sub_B52A54(WarBoardCommonEffectPerformance_TypeInfo);
    ...
    *(_QWORD *)&v41.fields.value.fields.z = 0LL;
    ...
    else
    {
      ...
      sub_B52920((BattleServantConfConponent_o *)&v18->fields.StartCallback, v21, v22, v23, v24, v25, v26, v27);
      if ( taskList )
      {
        System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData___Add(
          (System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData__o *)taskList,
      ...
      Instance = (char *)sub_B5299C(WarBoardTaskBase___TypeInfo, 1LL);
      if ( !Instance )
        goto LABEL_27;
      v29 = Instance;
      v30 = sub_B52A44(v18, *(_QWORD *)(*(_QWORD *)Instance + 64LL));
      if ( v30 )
      {
        if ( !*((_DWORD *)v29 + 6) )
        {
        ...
        *((_QWORD *)v29 + 4) = v18;
        sub_B52920((BattleServantConfConponent_o *)(v29 + 32), (System_Int32_array **)v18, v31, v32, v33, v34, v35, v36);
        if ( v28 )
        {
