        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BC54D & 1) == 0 )
  {
    sub_1B4CF90(&System_DateTime_TypeInfo, at);
    sub_1B4CF90(&int_TypeInfo, v4);
    sub_1B4CF90(&NetworkManager_TypeInfo, v5);
    sub_1B4CF90(&System_TimeSpan_TypeInfo, v6);
    sub_1B4CF90(&StringLiteral_24661/*"{0:D2}:{1:D2}:{2:D2}[-]"*/, v7);
    byte_49BC54D = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  Time = NetworkManager__getTime(0LL);
  dateData = NetworkManager__getDateTime_39104976(Time, 0LL).fields._dateData;
  v10 = NetworkManager__getDateTime_39104976(at, 0LL).fields._dateData;
  if ( !System_DateTime_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_DateTime_TypeInfo);
  v34.fields._dateData = v10;
  v39.fields._dateData = dateData;
  ticks = System_DateTime__op_Subtraction_62500356(v34, v39, 0LL).fields._ticks;
  ...
  v16 = System_String__Concat_61093468(RestTimeColorStr, (System_String_o *)StringLiteral_24661/*"{0:D2}:{1:D2}:{2:D2}[-]"*/, 0LL);
  v32 = v13;
  ...
  return System_String__Format_61134828(v16, v20, v24, v28, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BC54E & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_15627/*"[FF0000]"*/, *(_QWORD *)&restHours);
    sub_1B4CF90(&StringLiteral_15634/*"[FFFFFF]"*/, v4);
    sub_1B4CF90(&StringLiteral_15630/*"[FFFF00]"*/, v5);
    byte_49BC54E = 1;
  }
  if ( restHours <= 4 )
    v6 = &StringLiteral_15630/*"[FFFF00]"*/;
  else
    v6 = (__int64 *)&StringLiteral_15634/*"[FFFFFF]"*/;
  if ( restHours <= 0 )
    v6 = &StringLiteral_15627/*"[FF0000]"*/;
        ...
        const MethodInfo *method)
{
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_2F01B24 *)Method_DataManager_GetMasterData_EventRaidMaster___)) == 0LL )
  {
...
void __fastcall EventInfoRaidTimeComponent__UpdateDisp(EventInfoRaidTimeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BC54C & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_5589/*"EVENT_RAID_TIME_OVER_TXT_"*/, v5);
    sub_1B4CF90(&StringLiteral_1153/*"00:00:00[-]"*/, v6);
    sub_1B4CF90(&StringLiteral_5588/*"EVENT_RAID_TIME_OVER_TXT"*/, v7);
    sub_1B4CF90(&StringLiteral_5586/*"EVENT_RAID_TIME_LIMIT_TXT_"*/, v8);
    sub_1B4CF90(&StringLiteral_5585/*"EVENT_RAID_TIME_LIMIT_TXT"*/, v9);
    byte_49BC54C = 1;
  }
    ...
    if ( !UnityEngine_Object__op_Equality(timeText, 0LL, 0LL) )
    {
      ...
      if ( reidTimeLimit >= 1 )
      {
        ...
        if ( eventUiEntity )
        {
          ...
          Time = (UnityEngine_GameObject_o *)System_String__Concat_61093468(
                                               (System_String_o *)StringLiteral_5586/*"EVENT_RAID_TIME_LIMIT_TXT_"*/,
                                               v16,
                                               0LL);
          ...
          if ( v17 )
          {
            ...
            v20 = System_String__Concat_61093468((System_String_o *)StringLiteral_5589/*"EVENT_RAID_TIME_OVER_TXT_"*/, v19, 0LL);
            ...
            if ( v21 )
              ...
              v22 = (System_String_o *)StringLiteral_5585/*"EVENT_RAID_TIME_LIMIT_TXT"*/;
            ...
            if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
            v25 = v24 ? v20 : (System_String_o *)StringLiteral_5588/*"EVENT_RAID_TIME_OVER_TXT"*/;
                     ...
                     v26) )
              {
                ...
                if ( Time )
                {
                  ...
                  if ( reidTimeLimit - (__int64)v15 < 1 )
                  {
                    if ( !byte_49B8100 )
                    {
                      sub_1B4CF90(&RaidAutoUpdateRequest_TypeInfo, v13);
                      byte_49B8100 = 1;
                    }
                        ...
                        if ( Time )
                        {
                          ...
                          if ( Time )
                          {
                            ...
                            if ( Time )
                            {
                              ...
                              Time = (UnityEngine_GameObject_o *)System_String__Concat_61093468(
                                                                   RestTimeColorStr,
                                                                   (System_String_o *)StringLiteral_1153/*"00:00:00[-]"*/,
                                                                   0LL);
                              if ( v32 )
                              {
