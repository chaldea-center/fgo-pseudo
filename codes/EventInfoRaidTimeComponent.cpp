        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC9108 & 1) == 0 )
  {
    sub_1C1ABD4(&System_DateTime_TypeInfo, at);
    sub_1C1ABD4(&int_TypeInfo, v4);
    sub_1C1ABD4(&NetworkManager_TypeInfo, v5);
    sub_1C1ABD4(&System_TimeSpan_TypeInfo, v6);
    sub_1C1ABD4(&StringLiteral_25371/*"{0:D2}:{1:D2}:{2:D2}[-]"*/, v7);
    byte_4BC9108 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  Time = NetworkManager__getTime(0LL);
  dateData = NetworkManager__getDateTime_39760652(Time, 0LL).fields._dateData;
  v10 = NetworkManager__getDateTime_39760652(at, 0LL).fields._dateData;
  if ( !System_DateTime_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_DateTime_TypeInfo);
  v34.fields._dateData = v10;
  v39.fields._dateData = dateData;
  ticks = System_DateTime__op_Subtraction_63733588(v34, v39, 0LL).fields._ticks;
  ...
  v16 = System_String__Concat_63040368(RestTimeColorStr, (System_String_o *)StringLiteral_25371/*"{0:D2}:{1:D2}:{2:D2}[-]"*/, 0LL);
  v32 = v13;
  ...
  return System_String__Format_63054808(v16, v20, v24, v28, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC9109 & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_16196/*"[FF0000]"*/, *(_QWORD *)&restHours);
    sub_1C1ABD4(&StringLiteral_16203/*"[FFFFFF]"*/, v4);
    sub_1C1ABD4(&StringLiteral_16199/*"[FFFF00]"*/, v5);
    byte_4BC9109 = 1;
  }
  if ( restHours <= 4 )
    v6 = &StringLiteral_16199/*"[FFFF00]"*/;
  else
    v6 = (__int64 *)&StringLiteral_16203/*"[FFFFFF]"*/;
  if ( restHours <= 0 )
    v6 = &StringLiteral_16196/*"[FF0000]"*/;
...
void __fastcall EventInfoRaidTimeComponent__UpdateDisp(EventInfoRaidTimeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC9107 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_5803/*"EVENT_RAID_TIME_OVER_TXT_"*/, v5);
    sub_1C1ABD4(&StringLiteral_1228/*"00:00:00[-]"*/, v6);
    sub_1C1ABD4(&StringLiteral_5802/*"EVENT_RAID_TIME_OVER_TXT"*/, v7);
    sub_1C1ABD4(&StringLiteral_5800/*"EVENT_RAID_TIME_LIMIT_TXT_"*/, v8);
    sub_1C1ABD4(&StringLiteral_5799/*"EVENT_RAID_TIME_LIMIT_TXT"*/, v9);
    byte_4BC9107 = 1;
  }
    ...
    if ( !UnityEngine_Object__op_Equality(timeText, 0LL, 0LL) )
    {
      ...
      if ( reidTimeLimit >= 1 )
      {
        ...
        if ( eventUiEntity )
        {
          ...
          Time = (UnityEngine_GameObject_o *)System_String__Concat_63040368(
          ...
          if ( v17 )
          {
            ...
            v20 = System_String__Concat_63040368((System_String_o *)StringLiteral_5803/*"EVENT_RAID_TIME_OVER_TXT_"*/, v19, 0LL);
            ...
            if ( v21 )
              ...
              v22 = (System_String_o *)StringLiteral_5799/*"EVENT_RAID_TIME_LIMIT_TXT"*/;
            ...
            if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
            v25 = v24 ? v20 : (System_String_o *)StringLiteral_5802/*"EVENT_RAID_TIME_OVER_TXT"*/;
                     ...
                     v26) )
              {
                ...
                if ( Time )
                {
                  ...
                  if ( reidTimeLimit - (__int64)v15 < 1 )
                  {
                    if ( !byte_4BC4D78 )
                    {
                      sub_1C1ABD4(&RaidAutoUpdateRequest_TypeInfo, v13);
                      byte_4BC4D78 = 1;
                    }
