        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B387A8 & 1) == 0 )
  {
    sub_1BD3458(&System_DateTime_TypeInfo, at);
    sub_1BD3458(&int_TypeInfo, v4);
    sub_1BD3458(&NetworkManager_TypeInfo, v5);
    sub_1BD3458(&System_TimeSpan_TypeInfo, v6);
    sub_1BD3458(&StringLiteral_25239/*"{0:D2}:{1:D2}:{2:D2}[-]"*/, v7);
    byte_4B387A8 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  Time = NetworkManager__getTime(0LL);
  dateData = NetworkManager__getDateTime_39341492(Time, 0LL).fields._dateData;
  v10 = NetworkManager__getDateTime_39341492(at, 0LL).fields._dateData;
  if ( !System_DateTime_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_DateTime_TypeInfo);
  v34.fields._dateData = v10;
  v39.fields._dateData = dateData;
  ticks = System_DateTime__op_Subtraction_63218468(v34, v39, 0LL).fields._ticks;
  ...
  v16 = System_String__Concat_62525248(RestTimeColorStr, (System_String_o *)StringLiteral_25239/*"{0:D2}:{1:D2}:{2:D2}[-]"*/, 0LL);
  v32 = v13;
  ...
  return System_String__Format_62539688(v16, v20, v24, v28, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B387A9 & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_16118/*"[FF0000]"*/, *(_QWORD *)&restHours);
    sub_1BD3458(&StringLiteral_16125/*"[FFFFFF]"*/, v4);
    sub_1BD3458(&StringLiteral_16121/*"[FFFF00]"*/, v5);
    byte_4B387A9 = 1;
  }
  if ( restHours <= 4 )
    v6 = &StringLiteral_16121/*"[FFFF00]"*/;
  else
    v6 = (__int64 *)&StringLiteral_16125/*"[FFFFFF]"*/;
  if ( restHours <= 0 )
    v6 = &StringLiteral_16118/*"[FF0000]"*/;
...
void __fastcall EventInfoRaidTimeComponent__UpdateDisp(EventInfoRaidTimeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B387A7 & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_5779/*"EVENT_RAID_TIME_OVER_TXT_"*/, v5);
    sub_1BD3458(&StringLiteral_1225/*"00:00:00[-]"*/, v6);
    sub_1BD3458(&StringLiteral_5778/*"EVENT_RAID_TIME_OVER_TXT"*/, v7);
    sub_1BD3458(&StringLiteral_5776/*"EVENT_RAID_TIME_LIMIT_TXT_"*/, v8);
    sub_1BD3458(&StringLiteral_5775/*"EVENT_RAID_TIME_LIMIT_TXT"*/, v9);
    byte_4B387A7 = 1;
  }
    ...
    if ( !UnityEngine_Object__op_Equality(timeText, 0LL, 0LL) )
    {
      ...
      if ( reidTimeLimit >= 1 )
      {
        ...
        if ( eventUiEntity )
        {
          ...
          Time = (UnityEngine_GameObject_o *)System_String__Concat_62525248(
                                               (System_String_o *)StringLiteral_5776/*"EVENT_RAID_TIME_LIMIT_TXT_"*/,
                                               v16,
                                               0LL);
          ...
          if ( v17 )
          {
            ...
            v20 = System_String__Concat_62525248((System_String_o *)StringLiteral_5779/*"EVENT_RAID_TIME_OVER_TXT_"*/, v19, 0LL);
            ...
            if ( v21 )
              ...
              v22 = (System_String_o *)StringLiteral_5775/*"EVENT_RAID_TIME_LIMIT_TXT"*/;
            ...
            if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
            v25 = v24 ? v20 : (System_String_o *)StringLiteral_5778/*"EVENT_RAID_TIME_OVER_TXT"*/;
                     ...
                     v26) )
              {
                ...
                if ( Time )
                {
                  ...
                  if ( reidTimeLimit - (__int64)v15 < 1 )
                  {
                    if ( !byte_4B344AD )
                    {
                      sub_1BD3458(&RaidAutoUpdateRequest_TypeInfo, v13);
                      byte_4B344AD = 1;
                    }
