        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC899F & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_25199/*"{0:D2}:{1:D2}:{2:D2}[-]"*/);
    byte_4CC899F = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  Time = NetworkManager__getTime(0);
  v5.fields._dateData = NetworkManager__getDateTime_41643704(Time, 0).fields._dateData;
  v6.fields._dateData = NetworkManager__getDateTime_41643704(at, 0).fields._dateData;
  if ( !System_DateTime_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_DateTime_TypeInfo);
  v7.fields._dateData = v6.fields._dateData;
  v8.fields._dateData = v5.fields._dateData;
  ticks = System_DateTime__op_Subtraction_65432720(v7, v8, 0).fields._ticks;
  ...
  v16 = System_String__Concat_64031724(RestTimeColorStr, (System_String_o *)StringLiteral_25199/*"{0:D2}:{1:D2}:{2:D2}[-]"*/, 0);
  v25 = v13;
  ...
  return System_String__Format_64073100(v16, v17, v19, v21, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC89A0 & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_15930/*"[FFFFFF]"*/);
        ...
        const MethodInfo *method)
{
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_314B10C *)Method_DataManager_GetMasterData_EventRaidMaster___)) == 0 )
  {
...
void EventInfoRaidTimeComponent__UpdateDisp(EventInfoRaidTimeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC899E & 1) == 0 )
  {
    ...
    sub_1C713B0(&NetworkManager_TypeInfo);
    sub_1C713B0(&UnityEngine_Object_TypeInfo);
    sub_1C713B0(&StringLiteral_5674/*"EVENT_RAID_TIME_OVER_TXT_"*/);
    sub_1C713B0(&StringLiteral_1128/*"00:00:00[-]"*/);
    sub_1C713B0(&StringLiteral_5673/*"EVENT_RAID_TIME_OVER_TXT"*/);
    sub_1C713B0(&StringLiteral_5671/*"EVENT_RAID_TIME_LIMIT_TXT_"*/);
    sub_1C713B0(&StringLiteral_5670/*"EVENT_RAID_TIME_LIMIT_TXT"*/);
    byte_4CC899E = 1;
  }
    ...
    if ( !UnityEngine_Object__op_Equality(timeText, 0, 0) )
    {
      ...
      if ( reidTimeLimit >= 1 )
      {
        ...
        if ( eventUiEntity )
        {
          ...
          Time = (UnityEngine_GameObject_o *)System_String__Concat_64031724(
                                               (System_String_o *)StringLiteral_5671/*"EVENT_RAID_TIME_LIMIT_TXT_"*/,
                                               v9,
                                               0);
          ...
          if ( v10 )
          {
            ...
            v13 = System_String__Concat_64031724((System_String_o *)StringLiteral_5674/*"EVENT_RAID_TIME_OVER_TXT_"*/, v12, 0);
            ...
            if ( v14 )
              ...
              v15 = (System_String_o *)StringLiteral_5670/*"EVENT_RAID_TIME_LIMIT_TXT"*/;
            ...
            if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
            v18 = v17 ? v13 : (System_String_o *)StringLiteral_5673/*"EVENT_RAID_TIME_OVER_TXT"*/;
                     ...
                     v19) )
              {
                ...
                if ( Time )
                {
                  ...
                  if ( reidTimeLimit - (__int64)v8 < 1 )
                  {
                    if ( !byte_4CC45A9 )
                    {
                      sub_1C713B0(&RaidAutoUpdateRequest_TypeInfo);
                      byte_4CC45A9 = 1;
                    }
