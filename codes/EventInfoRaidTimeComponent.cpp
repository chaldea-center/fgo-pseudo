        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E402B & 1) == 0 )
  {
    sub_1B00CCC(&System_DateTime_TypeInfo, at);
    sub_1B00CCC(&int_TypeInfo, v4);
    sub_1B00CCC(&NetworkManager_TypeInfo, v5);
    sub_1B00CCC(&System_TimeSpan_TypeInfo, v6);
    sub_1B00CCC(&StringLiteral_24584/*"{0:D2}:{1:D2}:{2:D2}[-]"*/, v7);
    byte_48E402B = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  Time = NetworkManager__getTime(0LL);
  dateData = NetworkManager__getDateTime_37173004(Time, 0LL).fields._dateData;
  v10 = NetworkManager__getDateTime_37173004(at, 0LL).fields._dateData;
  if ( !System_DateTime_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_DateTime_TypeInfo);
  v34.fields._dateData = v10;
  v39.fields._dateData = dateData;
  ticks = System_DateTime__op_Subtraction_61018500(v34, v39, 0LL).fields._ticks;
  ...
  v16 = System_String__Concat_60325748(RestTimeColorStr, (System_String_o *)StringLiteral_24584/*"{0:D2}:{1:D2}:{2:D2}[-]"*/, 0LL);
  v32 = v13;
  ...
  return System_String__Format_60340188(v16, v20, v24, v28, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E402C & 1) == 0 )
  {
    sub_1B00CCC(&StringLiteral_15702/*"[FF0000]"*/, *(_QWORD *)&restHours);
    sub_1B00CCC(&StringLiteral_15708/*"[FFFFFF]"*/, v4);
    sub_1B00CCC(&StringLiteral_15705/*"[FFFF00]"*/, v5);
    byte_48E402C = 1;
  }
  if ( restHours <= 4 )
    v6 = &StringLiteral_15705/*"[FFFF00]"*/;
  else
    v6 = (__int64 *)&StringLiteral_15708/*"[FFFFFF]"*/;
  if ( restHours <= 0 )
    v6 = &StringLiteral_15702/*"[FF0000]"*/;
...
void __fastcall EventInfoRaidTimeComponent__UpdateDisp(EventInfoRaidTimeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E402A & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_5627/*"EVENT_RAID_TIME_OVER_TXT_"*/, v5);
    sub_1B00CCC(&StringLiteral_1224/*"00:00:00[-]"*/, v6);
    sub_1B00CCC(&StringLiteral_5626/*"EVENT_RAID_TIME_OVER_TXT"*/, v7);
    sub_1B00CCC(&StringLiteral_5624/*"EVENT_RAID_TIME_LIMIT_TXT_"*/, v8);
    sub_1B00CCC(&StringLiteral_5623/*"EVENT_RAID_TIME_LIMIT_TXT"*/, v9);
    byte_48E402A = 1;
  }
    ...
    if ( !UnityEngine_Object__op_Equality(timeText, 0LL, 0LL) )
    {
      ...
      if ( reidTimeLimit >= 1 )
      {
        ...
        if ( eventUiEntity )
        {
          ...
          Time = (UnityEngine_GameObject_o *)System_String__Concat_60325748(
                                               (System_String_o *)StringLiteral_5624/*"EVENT_RAID_TIME_LIMIT_TXT_"*/,
                                               v16,
                                               0LL);
          ...
          if ( v17 )
          {
            ...
            v20 = System_String__Concat_60325748((System_String_o *)StringLiteral_5627/*"EVENT_RAID_TIME_OVER_TXT_"*/, v19, 0LL);
            ...
            if ( v21 )
              ...
              v22 = (System_String_o *)StringLiteral_5623/*"EVENT_RAID_TIME_LIMIT_TXT"*/;
            ...
            if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
            v25 = v24 ? v20 : (System_String_o *)StringLiteral_5626/*"EVENT_RAID_TIME_OVER_TXT"*/;
                     ...
                     v26) )
              {
                ...
                if ( Time )
                {
                  ...
                  if ( reidTimeLimit - (__int64)v15 < 1 )
                  {
                    if ( !byte_48DFCC3 )
                    {
                      sub_1B00CCC(&RaidAutoUpdateRequest_TypeInfo, v13);
                      byte_48DFCC3 = 1;
                    }
                        ...
                        if ( Time )
                        {
                          ...
                          if ( Time )
                          {
                            ...
                            if ( Time )
                            {
                              ...
                              Time = (UnityEngine_GameObject_o *)System_String__Concat_60325748(
                                                                   RestTimeColorStr,
                                                                   (System_String_o *)StringLiteral_1224/*"00:00:00[-]"*/,
                                                                   0LL);
                              if ( v32 )
                              {
