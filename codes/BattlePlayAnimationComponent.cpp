        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C5A3BF & 1) == 0 )
  {
    sub_1C3E564(&BattlePlayAnimationComponent_SaveData_TypeInfo);
    byte_4C5A3BF = 1;
  }
  ...
  v7 = (BattlePlayAnimationComponent_SaveData_o *)sub_1C3E7B0(BattlePlayAnimationComponent_SaveData_TypeInfo);
  BattlePlayAnimationComponent_SaveData___ctor(v7, v8);
  WrapAnimation = UnityEngine_Object__get_name((UnityEngine_Object_o *)this, 0);
  if ( !v7 )
LABEL_9:
    sub_1C3E7C0(WrapAnimation, v4);
        ...
        const MethodInfo *method)
{
  ...
  if ( !wrapAnimation )
  {
    ...
    sub_1C3E508((CGThumbnailListItem_o *)p_wrapAnimation, (int32_t)wrapAnimation, v6, v7);
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.animName, v6, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields, (int32_t)objName, (int32_t)data, method);
  if ( !data )
    sub_1C3E7C0(v6, v7);
  animName = data->fields.animName;
  this->fields.animName = animName;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.animName, (int32_t)animName, v8, v9);
  result = this;
