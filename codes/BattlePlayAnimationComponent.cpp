        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C465C8 & 1) == 0 )
  {
    sub_1C37058(&BattlePlayAnimationComponent_SaveData_TypeInfo);
    byte_4C465C8 = 1;
  }
  ...
  v6 = (BattlePlayAnimationComponent_SaveData_o *)sub_1C372A4(BattlePlayAnimationComponent_SaveData_TypeInfo);
  BattlePlayAnimationComponent_SaveData___ctor(v6, v7);
  WrapAnimation = UnityEngine_Object__get_name((UnityEngine_Object_o *)this, 0);
  if ( !v6 )
LABEL_9:
    sub_1C372B4(WrapAnimation);
        ...
        const MethodInfo *method)
{
  ...
  if ( !wrapAnimation )
  {
    ...
    sub_1C36FFC((CGThumbnailListItem_o *)p_wrapAnimation, (int32_t)wrapAnimation, v6, v7);
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.animName, v6, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields, (int32_t)objName, (int32_t)data, method);
  if ( !data )
    sub_1C372B4(v6);
  animName = data->fields.animName;
  this->fields.animName = animName;
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.animName, (int32_t)animName, v7, v8);
  result = this;
