        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5E11B & 1) == 0 )
  {
    sub_1B885B0(&BattlePlayAnimationComponent_SaveData_TypeInfo);
    byte_4A5E11B = 1;
  }
  ...
  v7 = (BattlePlayAnimationComponent_SaveData_o *)sub_1B887FC(BattlePlayAnimationComponent_SaveData_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( !wrapAnimation )
  {
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)p_wrapAnimation, (int32_t)wrapAnimation, v6, v7);
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.animName, v6, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)objName, (int32_t)data, (int32_t)method);
  if ( !data )
    sub_1B8880C(v6, v7);
  animName = data->fields.animName;
  this->fields.animName = animName;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.animName, (int32_t)animName, v8, v9);
  result = this;
