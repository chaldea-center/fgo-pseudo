        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BE07E & 1) == 0 )
  {
    sub_1B4CF90(&BattlePlayAnimationComponent_SaveData_TypeInfo, method);
    byte_49BE07E = 1;
  }
  WrapAnimation = (System_String_o *)BattlePlayAnimationComponent__get_WrapAnimation(this, method);
  if ( !WrapAnimation )
    goto LABEL_8;
  result = (BattlePlayAnimationComponent_SaveData_o *)((__int64 (__fastcall *)(System_String_o *, Il2CppMethodPointer))WrapAnimation->klass->vtable._5_System_Collections_IEnumerable_GetEnumerator.method)(
                                                        WrapAnimation,
                                                        WrapAnimation->klass->vtable._6_System_Collections_Generic_IEnumerable_System_Char__GetEnumerator.methodPtr);
  if ( result )
  {
    v6 = result;
    v7 = (BattlePlayAnimationComponent_SaveData_o *)sub_1B4D1DC(BattlePlayAnimationComponent_SaveData_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( !wrapAnimation )
  {
    ...
    sub_1B4CF34((CGThumbnailListItem_o *)p_wrapAnimation, (int32_t)wrapAnimation, v6, v7);
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.animName, v6, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields, (int32_t)objName, (int32_t)data, method);
  if ( !data )
    sub_1B4D1EC(v6, v7);
  animName = data->fields.animName;
  this->fields.animName = animName;
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.animName, (int32_t)animName, v8, v9);
  result = this;
