        ...
        const MethodInfo *method)
{
  ...
  __int64 v4; // x0
  WrapBattleBaseAnimation_SimpleData_o *v5; // x20
  BattlePlayAnimationComponent_SaveData_o *v6; // x21
  const MethodInfo *v7; // x1
  const MethodInfo *v8; // x3

  if ( (byte_4C3AFB4 & 1) == 0 )
  {
    sub_1C32C20(&BattlePlayAnimationComponent_SaveData_TypeInfo);
    byte_4C3AFB4 = 1;
  }
  WrapAnimation = (System_String_o *)BattlePlayAnimationComponent__get_WrapAnimation(this, method);
  if ( !WrapAnimation )
    goto LABEL_9;
  v4 = ((__int64 (__fastcall *)(System_String_o *, const MethodInfo *))WrapAnimation->klass->vtable._5_System_Collections_IEnumerable_GetEnumerator.methodPtr)(
         WrapAnimation,
         WrapAnimation->klass->vtable._5_System_Collections_IEnumerable_GetEnumerator.method);
  if ( !v4 )
    return 0;
  v5 = (WrapBattleBaseAnimation_SimpleData_o *)v4;
  v6 = (BattlePlayAnimationComponent_SaveData_o *)sub_1C32E6C(BattlePlayAnimationComponent_SaveData_TypeInfo);
  BattlePlayAnimationComponent_SaveData___ctor(v6, v7);
  WrapAnimation = UnityEngine_Object__get_name((UnityEngine_Object_o *)this, 0);
  if ( !v6 )
LABEL_9:
    sub_1C32E7C(WrapAnimation);
  BattlePlayAnimationComponent_SaveData__Init(v6, WrapAnimation, v5, v8);
  return v6;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !wrapAnimation )
  {
    ...
    sub_1C32BC4((CGThumbnailListItem_o *)p_wrapAnimation, (int32_t)wrapAnimation, v6, v7);
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.animName, v6, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields, (int32_t)objName, (int32_t)data, method);
  if ( !data )
    sub_1C32E7C(v6);
  animName = data->fields.animName;
  this->fields.animName = animName;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.animName, (int32_t)animName, v7, v8);
  result = this;
