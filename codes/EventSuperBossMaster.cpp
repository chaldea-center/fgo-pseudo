void __fastcall EventSuperBossMaster___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A6FFF2 & 1) == 0 )
  {
    sub_1B90010(&EventSuperBossMaster_TypeInfo, v1);
    sub_1B90010(&StringLiteral_5727/*"EVENT_SUPERBOSS_ENCOUNTER_{0}_{1}"*/, v4);
    byte_4A6FFF2 = 1;
  }
  EventSuperBossMaster_TypeInfo->static_fields->SAVE_KEY = (struct System_String_o *)StringLiteral_5727/*"EVENT_SUPERBOSS_ENCOUNTER_{0}_{1}"*/;
  sub_1B8FFB4(
    (ServantStatusBattleListViewItem_o *)EventSuperBossMaster_TypeInfo->static_fields,
    StringLiteral_5727/*"EVENT_SUPERBOSS_ENCOUNTER_{0}_{1}"*/,
    v2,
    v3);
}
...
void __fastcall EventSuperBossMaster___ctor(EventSuperBossMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A6FFEF & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_EventSuperBossMaster__EventSuperBossEntity__string___ctor__, method);
    byte_4A6FFEF = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    170,
    (const MethodInfo_312C8C0 *)Method_DataMasterBase_EventSuperBossMaster__EventSuperBossEntity__string___ctor__);
}
...
void __fastcall EventSuperBossMaster__DeleteContinueData(EventSuperBossMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6FFF1 & 1) == 0 )
  {
    ...
    sub_1B90010(&EventSuperBossMaster_TypeInfo, v5);
  ...
  if ( Count >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      for ( i = 0; ; ++i )
      {
        ...
        v28 = System_String__Format_61801464(SAVE_KEY, v23, v27, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FFF0 & 1) == 0 )
  {
    ...
    sub_1B90010(&EventSuperBossEntity_TypeInfo, v6);
    sub_1B90010(&EventSuperBossMaster_TypeInfo, v7);
    sub_1B90010(&int_TypeInfo, v8);
    sub_1B90010(&Method_System_Collections_Generic_List_EventSuperBossEntity__Add__, v9);
    sub_1B90010(&Method_System_Collections_Generic_List_EventSuperBossEntity__RemoveAt__, v10);
    sub_1B90010(&Method_System_Collections_Generic_List_EventSuperBossEntity___ctor__, v11);
    sub_1B90010(&Method_System_Collections_Generic_List_EventSuperBossEntity__get_Count__, v12);
    sub_1B90010(&Method_System_Collections_Generic_List_EventSuperBossEntity__get_Item__, v13);
    sub_1B90010(&System_Collections_Generic_List_EventSuperBossEntity__TypeInfo, v14);
    byte_4A6FFF0 = 1;
  }
  v15 = (System_Collections_Generic_List_object__o *)sub_1B9025C(System_Collections_Generic_List_EventSuperBossEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v15,
    (const MethodInfo_351018C *)Method_System_Collections_Generic_List_EventSuperBossEntity___ctor__);
...
LABEL_18:
  ...
  if ( !v15->fields._size )
    return 0LL;
  v28 = (System_Collections_Generic_List_object__o *)sub_1B9025C(System_Collections_Generic_List_EventSuperBossEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v28,
    (const MethodInfo_351018C *)Method_System_Collections_Generic_List_EventSuperBossEntity___ctor__);
  v32 = 0;
...
LABEL_21:
    ...
    v40 = System_String__Format_61801464(SAVE_KEY, v35, v39, 0LL);
    ...
    if ( v42 >= 1 )
    {
      ...
      while ( 1 )
      {
        list = System_Collections_Generic_List_object___get_Item(
                 v15,
                 v44,
                 (const MethodInfo_35106F0 *)Method_System_Collections_Generic_List_EventSuperBossEntity__get_Item__);
        if ( !list )
          goto LABEL_49;
      ...
      System_Collections_Generic_List_object___RemoveAt(
        v15,
        v44,
        (const MethodInfo_3512194 *)Method_System_Collections_Generic_List_EventSuperBossEntity__RemoveAt__);
    }
  }
  if ( v42 >= 1 )
  {
    do
    {
      ...
      v69 = System_String__Format_61801464(v63, v64, v68, 0LL);
      list = System_Collections_Generic_List_object___get_Item(
               v15,
               0,
               (const MethodInfo_35106F0 *)Method_System_Collections_Generic_List_EventSuperBossEntity__get_Item__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FFED & 1) == 0 )
  {
    sub_1B90010(
      ...
      *(_QWORD *)&eventId);
    sub_1B90010(&EventSuperBossEntity_TypeInfo, v7);
    byte_4A6FFED = 1;
  }
  ...
  return (EventSuperBossEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                     (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                     PK,
                                     (const MethodInfo_312C900 *)Method_DataMasterBase_EventSuperBossMaster__EventSuperBossEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FFEE & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_EventSuperBossMaster__EventSuperBossEntity__string__TryGetEntity__, entity);
    sub_1B90010(&EventSuperBossEntity_TypeInfo, v9);
    byte_4A6FFEE = 1;
  }
  if ( !EventSuperBossEntity_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(EventSuperBossEntity_TypeInfo);
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_312C950 *)Method_DataMasterBase_EventSuperBossMaster__EventSuperBossEntity__string__TryGetEntity__);
}