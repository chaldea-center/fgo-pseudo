...
bool __fastcall WarBoardCondType__IsBossStatus(int32_t bossId, int32_t status, const MethodInfo *method)
{
  ...
  return WarBoardData__IsBossInfo(Instance, bossId, (System_String_o *)StringLiteral_22675/*"status"*/, status, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !Instance )
    goto LABEL_17;
  Instance = WarBoardData__GetPieces_22465708((WarBoardData_o *)Instance, forceId, groupId, v11);
  if ( !Instance )
    goto LABEL_17;
...
LABEL_30:
    ...
    case 21:
      ...
      if ( !Instance )
        sub_B7076C(0LL, v18);
      result = WarBoardManager__IsNowTurn_18844020((WarBoardManager_o *)Instance, forceId, groupId, 0LL);
      break;
    case 22:
        ...
        const MethodInfo *method)
{
  ...
  if ( !Instance
    ...
    || (Instance = WarBoardData__GetPieces_22465708((WarBoardData_o *)Instance, forceId, groupId, v9)) == 0LL )
  {
LABEL_14:
        ...
        const MethodInfo *method)
{
  ...
  if ( !Instance
    || (Instance = (void *)*((_QWORD *)Instance + 54)) == 0LL
    || (Instance = WarBoardData__GetPieces_22465708((WarBoardData_o *)Instance, forceId, groupId, v11)) == 0LL )
  {
LABEL_14:
    sub_B7076C(Instance, v10);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !Instance )
    goto LABEL_18;
  Instance = WarBoardData__GetPieces_22465708((WarBoardData_o *)Instance, forceId, groupId, v9);
  if ( !Instance )
    goto LABEL_18;
  v10 = *((_DWORD *)Instance + 6);
  v11 = Instance;
...
bool __fastcall WarBoardCondType__IsWallDestroy(int32_t wallId, const MethodInfo *method)
{
  ...
  if ( (byte_43503D9 & 1) == 0 )
  {
    ...
    sub_B70694(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    sub_B70694(&Method_WarBoardCondType___c__DisplayClass10_0__IsWallDestroy_b__0__);
    sub_B70694(&Method_WarBoardCondType___c__DisplayClass10_0__IsWallDestroy_b__1__);
    sub_B70694(&WarBoardCondType___c__DisplayClass10_0_TypeInfo);
    byte_43503D9 = 1;
  }
  v3 = (WarBoardCondType___c__DisplayClass10_0_o *)sub_B70764(WarBoardCondType___c__DisplayClass10_0_TypeInfo);
  ...
  if ( v6 )
  {
    ...
    v8 = (System_Func_WarBoardManager_WarBoardOnboardSkillTarget__bool__o *)sub_B70764(System_Func_WarBoardWallData__bool__TypeInfo);
  ...
  else
  {
    ...
    {
      v12 = (System_Func_WarBoardManager_WarBoardOnboardSkillTarget__bool__o *)sub_B70764(System_Func_WarBoardUserWallData__bool__TypeInfo);
      System_Func_WarBoardManager_WarBoardOnboardSkillTarget__bool____ctor(
        v12,
        (Il2CppObject *)v3,
        ...
        const MethodInfo *method)
{
  ...
  *srcServantCount = 0;
  ...
  Instance = (WarBoardManager_o *)DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1CA3540 *)Method_DataManager_GetMaster_WarBoardSquareIndexGroupMaster___);
  if ( !Instance )
    goto LABEL_14;
