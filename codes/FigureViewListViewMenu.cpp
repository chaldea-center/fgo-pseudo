...
void FigureViewListViewMenu__Close(FigureViewListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.state )
  {
    ...
    sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.figureAssetList, 0, v5, v6, v7, v8, v9, v10);
    this->fields.state = 0;
  }
...
void FigureViewListViewMenu__OnClickItem(FigureViewListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC48FB & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_FigureViewListViewMenu_OnEndFigureView__);
    sub_1C713B0(&ScriptManager_TypeInfo);
    byte_4CC48FB = 1;
  }
  if ( this->fields.state == 2 )
...
void FigureViewListViewMenu__OnEndFigureView(FigureViewListViewMenu_o *this, bool isExit, const MethodInfo *method)
{
  ...
  if ( (byte_4CC48FC & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_FigureViewListViewMenu_OnClickItem__);
    byte_4CC48FC = 1;
  }
...
void FigureViewListViewMenu__OnSearchLabelChange(FigureViewListViewMenu_o *this, const MethodInfo *method)
{
  ...
  ListViewManager__DestroyList(listViewManager, 0);
  this->fields.figureAssetList = 0;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.figureAssetList, 0, v4, v5, v6, v7, v8, v9);
  callbackFunc = this->fields.callbackFunc;
  this->fields.state = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC48F9 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_FigureViewListViewMenu___c__Open_b__12_1__);
    sub_1C713B0(&Method_FigureViewListViewMenu___c__DisplayClass12_0__Open_b__0__);
    sub_1C713B0(&FigureViewListViewMenu___c__DisplayClass12_0_TypeInfo);
    sub_1C713B0(&FigureViewListViewMenu___c_TypeInfo);
    sub_1C713B0(&StringLiteral_4372/*"CharaFigure"*/);
    byte_4CC48F9 = 1;
  }
  result = 0;
  if ( !this->fields.state )
  {
    v5 = sub_1C715FC(FigureViewListViewMenu___c__DisplayClass12_0_TypeInfo);
    ...
    AssetStorageList = (System_Collections_Generic_IEnumerable_T__o *)AssetManager__getAssetStorageList(
                                                                        (System_String_o *)StringLiteral_4372/*"CharaFigure"*/,
                                                                        0);
    v13 = (System_Collections_Generic_List_object__o *)sub_1C715FC(System_Collections_Generic_List_string__TypeInfo);
          ...
          if ( rootObject )
          {
            ...
            if ( v5 )
            {
              *(_QWORD *)(v5 + 16) = rootObject;
              ...
              sub_1C71354((GrandQuestFolderBoardItem_o *)(v5 + 16), (int32_t)rootObject, v16, v17, v18, v19, v20, v21);
              result = 0;
              if ( System_String__IsNullOrEmpty(*(System_String_o **)(v5 + 16), 0)
                || !System_Int32__TryParse(*v22, &result, 0) )
              {
                *v22 = 0;
                sub_1C71354((GrandQuestFolderBoardItem_o *)(v5 + 16), 0, v23, v24, v25, v26, v27, v28);
              }
              if ( *v22 )
              {
                v29 = (System_Predicate_object__o *)sub_1C715FC(System_Predicate_string__TypeInfo);
              ...
              if ( !v30 )
              {
                ...
                v30 = (System_Comparison_T__o *)sub_1C715FC(System_Comparison_string__TypeInfo);
...
void FigureViewListViewMenu__StartMenu(FigureViewListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC48F8 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_FigureViewListViewMenu__StartMenu_b__11_0__);
    byte_4CC48F8 = 1;
  }
  TestScript_DebugTest_DebugItem_DebugItemMenuBase__StartMenu(
    (TestScript_DebugTest_DebugItem_DebugItemMenuBase_o *)this,
    0);
  v3 = (FigureViewListViewMenu_CallbackFunc_o *)sub_1C715FC(FigureViewListViewMenu_CallbackFunc_TypeInfo);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1AA3E1C;
LABEL_6:
...
void FigureViewListViewMenu___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C715FC(FigureViewListViewMenu___c_TypeInfo);
