void BaseMenu___cctor(const MethodInfo *method)
{
  ...
  *BaseMenu_TypeInfo->static_fields = (struct BaseMenu_StaticFields)xmmword_C12610;
}
    ...
    if ( UnityEngine_Object__op_Inequality(closeTransform, 0, 0) )
    {
      ...
      if ( ((unsigned __int8)transform & 1) != 0 )
      {
        if ( v15 )
        {
          ...
          sub_1C3E508(&v15->fields.eventReceiver, gameObject);
          ...
          sub_1C3E508(&v15->fields.callWhenFinished, v17);
          return;
        }
LABEL_24:
    ...
    if ( (v9 & 1) != 0 )
    {
      ...
      if ( ((unsigned __int8)gameObject & 1) != 0 )
      {
        if ( v16 )
        {
          ...
          sub_1C3E508(&v16->fields.eventReceiver, v17);
          ...
          sub_1C3E508(&v16->fields.callWhenFinished, v18);
          return;
        }
        goto LABEL_31;
      }
