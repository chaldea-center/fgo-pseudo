void BaseMenu___cctor(const MethodInfo *method)
{
  ...
  *BaseMenu_TypeInfo->static_fields = (struct BaseMenu_StaticFields)xmmword_D25230;
}
    ...
    if ( UnityEngine_Object__op_Inequality(closeTransform, 0, 0) )
    {
      ...
      if ( ((unsigned __int8)transform & 1) != 0 )
      {
        if ( v15 )
        {
          ...
          sub_1CE66A4(&v15->fields.eventReceiver, gameObject);
          v17 = StringLiteral_6027/*"EndCloseBaseDialog"*/;
          v15->fields.callWhenFinished = (struct System_String_o *)StringLiteral_6027/*"EndCloseBaseDialog"*/;
          sub_1CE66A4(&v15->fields.callWhenFinished, v17);
          return;
        }
LABEL_24:
    ...
    if ( (v9 & 1) != 0 )
    {
      ...
      if ( ((unsigned __int8)gameObject & 1) != 0 )
      {
        if ( v16 )
        {
          ...
          sub_1CE66A4(&v16->fields.eventReceiver, v17);
          v18 = StringLiteral_6059/*"EndOpenBaseDialog"*/;
          v16->fields.callWhenFinished = (struct System_String_o *)StringLiteral_6059/*"EndOpenBaseDialog"*/;
          sub_1CE66A4(&v16->fields.callWhenFinished, v18);
          return;
        }
        goto LABEL_31;
      }
