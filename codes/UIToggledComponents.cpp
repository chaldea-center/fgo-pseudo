...
void UIToggledComponents__Awake(UIToggledComponents_o *this, const MethodInfo *method)
{
  ...
  _QWORD *v18; // x9
  __int64 v19; // x8
  const MethodInfo_3810718 *v20; // x2
  ...
  if ( (byte_4CCBB80 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_System_Collections_Generic_List_MonoBehaviour__Add__);
    sub_1C713B0(&Method_System_Collections_Generic_List_MonoBehaviour__get_Count__);
    sub_1C713B0(&UnityEngine_Object_TypeInfo);
    sub_1C713B0(&Method_UIToggledComponents_Toggle__);
    byte_4CCBB80 = 1;
  }
...
LABEL_11:
      sub_1C71354((GrandQuestFolderBoardItem_o *)p_target, (int32_t)v4, v5, v6, v7, v8, v9, v10);
      goto LABEL_12;
    }
    v4 = (Il2CppObject *)this->fields.target;
    v18 = Method_System_Collections_Generic_List_MonoBehaviour__Add__;
    if ( this->fields.inverse )
    {
      ...
      if ( activate )
      {
        ...
        v20 = *(const MethodInfo_3810718 **)(*(_QWORD *)(v18[4] + 192LL) + 112LL);
        goto LABEL_25;
      }
    }
    else
    {
      v19 = *((_QWORD *)activate + 2);
      ++*((_DWORD *)activate + 7);
      if ( v19 )
      {
        if ( *(_DWORD *)(v19 + 24) )
...
LABEL_12:
  ...
  EventDelegate__Add(v14, v15, v17);
}
...
void UIToggledComponents__Toggle(UIToggledComponents_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C713B0(&Method_System_Collections_Generic_List_MonoBehaviour__get_Count__);
    sub_1C713B0(&Method_System_Collections_Generic_List_MonoBehaviour__get_Item__);
  ...
  if ( UnityEngine_Behaviour__get_enabled((UnityEngine_Behaviour_o *)this, 0) )
  {
    ...
    while ( v5 < activate->fields._size )
    {
      activate = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___get_Item(
                                                                activate,
                                                                v5,
                                                                (const MethodInfo_3810448 *)Method_System_Collections_Generic_List_MonoBehaviour__get_Item__);
