        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7163A & 1) == 0 )
  {
    sub_1D0F0B4(&Method_EventCraftFirstTimeSupportToolDialogComponent_OnClickClose__);
    byte_4E7163A = 1;
  }
  ...
  if ( (*((_BYTE *)Method_EventCraftFirstTimeSupportToolDialogComponent_OnClickClose__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1D0F0CC(Method_EventCraftFirstTimeSupportToolDialogComponent_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E71639 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_3937/*"CRAFT_EVENT_FIRST_TIME_SUPPORT_TOOL_DIALOG_DETAIL"*/);
    sub_1D0F0B4(&StringLiteral_3724/*"COMMON_CONFIRM_CLOSE"*/);
    sub_1D0F0B4(&StringLiteral_3938/*"CRAFT_EVENT_FIRST_TIME_SUPPORT_TOOL_DIALOG_POSSESSION"*/);
    byte_4E71639 = 1;
  }
  ...
  supportToolItem = (ItemIconComponent_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3938/*"CRAFT_EVENT_FIRST_TIME_SUPPORT_TOOL_DIALOG_POSSESSION"*/, 0);
  if ( !possessionLb
    || (UILabel__set_text(possessionLb, (System_String_o *)supportToolItem, 0),
        detailLabel = this->fields.detailLabel,
        supportToolItem = (ItemIconComponent_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3937/*"CRAFT_EVENT_FIRST_TIME_SUPPORT_TOOL_DIALOG_DETAIL"*/, 0),
        !detailLabel)
    || (UILabel__set_text(detailLabel, (System_String_o *)supportToolItem, 0),
        closeButtonLb = this->fields.closeButtonLb,
        supportToolItem = (ItemIconComponent_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3724/*"COMMON_CONFIRM_CLOSE"*/, 0),
        !closeButtonLb) )
  {
LABEL_13:
    sub_1D0F30C(supportToolItem, id);
  }
