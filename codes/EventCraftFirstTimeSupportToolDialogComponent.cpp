        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3D1CE & 1) == 0 )
  {
    sub_1C37058(&Method_EventCraftFirstTimeSupportToolDialogComponent_OnClickClose__);
    byte_4C3D1CE = 1;
  }
  ...
  if ( (*((_BYTE *)Method_EventCraftFirstTimeSupportToolDialogComponent_OnClickClose__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C37070(Method_EventCraftFirstTimeSupportToolDialogComponent_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3D1CD & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_3898/*"CRAFT_EVENT_FIRST_TIME_SUPPORT_TOOL_DIALOG_DETAIL"*/);
    sub_1C37058(&StringLiteral_3685/*"COMMON_CONFIRM_CLOSE"*/);
    sub_1C37058(&StringLiteral_3899/*"CRAFT_EVENT_FIRST_TIME_SUPPORT_TOOL_DIALOG_POSSESSION"*/);
    byte_4C3D1CD = 1;
  }
