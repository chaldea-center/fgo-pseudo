void __fastcall SignedData___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A4C33C & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData___ctor__, v1);
    sub_1B863B8(&System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__TypeInfo, v2);
    sub_1B863B8(&SignedData_TypeInfo, v3);
    byte_4A4C33C = 1;
  }
  v4 = (System_Collections_Concurrent_ConcurrentQueue_T__o *)sub_1B86604(System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__TypeInfo);
  System_Collections_Concurrent_ConcurrentQueue_object____ctor(
    v4,
    (const MethodInfo_3201BA8 *)Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData___ctor__);
  ...
  sub_1B8635C((CGThumbnailListItem_o *)SignedData_TypeInfo->static_fields, (int32_t)v4, v5, v6);
  v7 = (System_Collections_Concurrent_ConcurrentQueue_T__o *)sub_1B86604(System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__TypeInfo);
  System_Collections_Concurrent_ConcurrentQueue_object____ctor(
    v7,
    (const MethodInfo_3201BA8 *)Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData___ctor__);
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&static_fields->SIGNED_PACK_QUEUE_ACCOUNT_REGIST, (int32_t)v7, v9, v10);
}
...
void __fastcall SignedData__CreateSignedPackData(int32_t maxCount, const MethodInfo *method)
{
  ...
  System_Byte_array *Bytes_62679520; // x21
  ...
  if ( (byte_4A4C33A & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__Enqueue__, method);
    sub_1B863B8(&Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__get_Count__, v2);
    sub_1B863B8(&System_Convert_TypeInfo, v3);
    sub_1B863B8(&System_Security_Cryptography_CryptoConfig_TypeInfo, v4);
    sub_1B863B8(&System_IDisposable_TypeInfo, v5);
    sub_1B863B8(&NetworkManager_TypeInfo, v6);
    sub_1B863B8(&CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo, v7);
    sub_1B863B8(&System_Security_Cryptography_RSACryptoServiceProvider_TypeInfo, v8);
    sub_1B863B8(&SignedData_TypeInfo, v9);
    sub_1B863B8(&SignedData_SignedPackData_TypeInfo, v10);
    sub_1B863B8(&SignedValue_TypeInfo, v11);
    sub_1B863B8(&System_Text_StringBuilder_TypeInfo, v12);
    sub_1B863B8(&StringLiteral_11825/*"SHA256"*/, v13);
    sub_1B863B8(&StringLiteral_1570/*"<RSAKeyValue><Modulus>"*/, v14);
    sub_1B863B8(&StringLiteral_1521/*"</D></RSAKeyValue>"*/, v15);
    byte_4A4C33A = 1;
  }
  ...
  Bytes_62679520 = System_BitConverter__GetBytes_62679520(v18->static_fields->exist, 0LL);
  v20 = (System_Text_StringBuilder_o *)sub_1B86604(System_Text_StringBuilder_TypeInfo);
  System_Text_StringBuilder___ctor(v20, 0LL);
  if ( !v20
    || (appended = (_QWORD **)System_Text_StringBuilder__Append_61730360(
                                v20,
...
LABEL_29:
    ...
    while ( v30 < (unsigned int)v29 )
    {
      if ( !Bytes_62679520 )
        goto LABEL_70;
      v31 = Bytes_62679520->max_length;
      if ( (int)v30 % v31 >= (unsigned int)v31 )
        break;
      v32 = *(_BYTE *)(v28 + 32 + v30);
      v33 = Bytes_62679520->m_Items[(int)v30 % v31 + 4];
      if ( !System_Convert_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(System_Convert_TypeInfo);
      v34 = System_Convert__ToChar_62692916(v33 ^ v32, 0LL);
      appended = (_QWORD **)System_Text_StringBuilder__Append_61732688(v20, v34, 0LL);
      LODWORD(v29) = *(_DWORD *)(v28 + 24);
      if ( (__int64)++v30 >= (int)v29 )
        goto LABEL_29;
    }
LABEL_69:
    sub_1B8661C(appended, v22);
  }
LABEL_30:
  System_Text_StringBuilder__Append_61730360(v20, (System_String_o *)StringLiteral_1521/*"</D></RSAKeyValue>"*/, 0LL);
  ...
  v37 = (System_Security_Cryptography_RSACryptoServiceProvider_o *)sub_1B86604(System_Security_Cryptography_RSACryptoServiceProvider_TypeInfo);
  ...
  v40 = System_Security_Cryptography_CryptoConfig__MapNameToOID((System_String_o *)StringLiteral_11825/*"SHA256"*/, 0LL);
  ...
  if ( (userIdNumber & 0x8000000000000000LL) != 0 )
  {
    ...
    Count = System_Collections_Concurrent_ConcurrentQueue_object___get_Count(
              ...
              (const MethodInfo_3202178 *)Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__get_Count__);
    if ( Count < maxCount )
    {
      v64 = maxCount - Count;
      do
      {
        ...
        *(_QWORD *)&v86.fields._d = 0LL;
        ...
        v67 = sub_1B86604(SignedData_SignedPackData_TypeInfo);
        ...
        if ( !v67 )
          sub_1B86614(v68, v68);
        *(_QWORD *)(v67 + 16) = v68;
        sub_1B8635C((CGThumbnailListItem_o *)(v67 + 16), (int32_t)v68, v69, v70);
        ...
        *(_QWORD *)(v67 + 24) = v73;
        sub_1B8635C((CGThumbnailListItem_o *)(v67 + 24), (int32_t)v73, v74, v75);
        ...
        System_Collections_Concurrent_ConcurrentQueue_object___Enqueue(
          v77,
          (Il2CppObject *)v67,
          (const MethodInfo_3202D78 *)Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__Enqueue__);
        --v64;
      }
      while ( v64 );
    }
    ...
    if ( v45 < maxCount )
    {
      ...
      do
      {
        ...
        *(_QWORD *)&v85.fields._d = 0LL;
        ...
        v49 = sub_1B86604(SignedData_SignedPackData_TypeInfo);
  ...
  {
LABEL_66:
    v81 = sub_1BD6B4C(v37, System_IDisposable_TypeInfo, 0LL);
  }
...
bool __fastcall SignedData__GetSignedPackData(SignedData_SignedPackData_o **outData, const MethodInfo *method)
{
  ...
  if ( (byte_4A4C337 & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__TryDequeue__, method);
  ...
  if ( (userIdNumber & 0x8000000000000000LL) != 0 )
  {
    ...
    if ( v9 )
      return System_Collections_Concurrent_ConcurrentQueue_object___TryDequeue(
               ...
               (const MethodInfo_3203014 *)Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__TryDequeue__);
LABEL_15:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4C33B & 1) == 0 )
  {
    sub_1B863B8(&System_Convert_TypeInfo, hashAlgorithm);
    sub_1B863B8(&StringLiteral_9288/*"No Algorithm"*/, v7);
    byte_4A4C33B = 1;
  }
  if ( System_String__IsNullOrEmpty(hashAlgorithm, 0LL) )
    return (System_String_o *)StringLiteral_9288/*"No Algorithm"*/;
...
System_Threading_Tasks_Task_o *__fastcall SignedData__RefillSigningData(int32_t maxCount, const MethodInfo *method)
{
  ...
  if ( (byte_4A4C338 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__get_Count__, v3);
    sub_1B863B8(&SignedData_TypeInfo, v4);
    sub_1B863B8(&System_Threading_Tasks_Task_TypeInfo, v5);
    sub_1B863B8(&Method_SignedData___c__DisplayClass5_0__RefillSigningData_b__0__, v6);
    sub_1B863B8(&SignedData___c__DisplayClass5_0_TypeInfo, v7);
    byte_4A4C338 = 1;
  }
  v8 = sub_1B86604(SignedData___c__DisplayClass5_0_TypeInfo);
  ...
  *(_DWORD *)(v8 + 16) = maxCount;
  ...
  if ( !SIGNED_PACK_QUEUE )
LABEL_12:
    sub_1B86614(SIGNED_PACK_QUEUE, v10);
  if ( System_Collections_Concurrent_ConcurrentQueue_object___get_Count(
         SIGNED_PACK_QUEUE,
         (const MethodInfo_3202178 *)Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__get_Count__) >= *(_DWORD *)(v8 + 16) )
    return 0LL;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4C33D & 1) == 0 )
  {
    sub_1B863B8(&SignedData_TypeInfo, method);
    byte_4A4C33D = 1;
  }
