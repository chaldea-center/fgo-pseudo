void __fastcall SignedData___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B42965 & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData___ctor__, v1);
    sub_1BDB878(&System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__TypeInfo, v2);
    sub_1BDB878(&SignedData_TypeInfo, v3);
    byte_4B42965 = 1;
  }
  v4 = (System_Collections_Concurrent_ConcurrentQueue_T__o *)sub_1BDBAC4(System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__TypeInfo);
  System_Collections_Concurrent_ConcurrentQueue_object____ctor(
    v4,
    (const MethodInfo_32CF764 *)Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData___ctor__);
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)SignedData_TypeInfo->static_fields, (int32_t)v4, v5, v6);
  v7 = (System_Collections_Concurrent_ConcurrentQueue_T__o *)sub_1BDBAC4(System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__TypeInfo);
  System_Collections_Concurrent_ConcurrentQueue_object____ctor(
    v7,
    (const MethodInfo_32CF764 *)Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData___ctor__);
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&static_fields->SIGNED_PACK_QUEUE_ACCOUNT_REGIST, (int32_t)v7, v9, v10);
}
...
void __fastcall SignedData__CreateSignedPackData(int32_t maxCount, const MethodInfo *method)
{
  ...
  System_Byte_array *Bytes_63607348; // x21
  ...
  if ( (byte_4B42963 & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__Enqueue__, method);
    sub_1BDB878(&Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__get_Count__, v2);
    sub_1BDB878(&System_Convert_TypeInfo, v3);
    sub_1BDB878(&System_Security_Cryptography_CryptoConfig_TypeInfo, v4);
    sub_1BDB878(&System_IDisposable_TypeInfo, v5);
    sub_1BDB878(&NetworkManager_TypeInfo, v6);
    sub_1BDB878(&CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo, v7);
    sub_1BDB878(&System_Security_Cryptography_RSACryptoServiceProvider_TypeInfo, v8);
    sub_1BDB878(&SignedData_TypeInfo, v9);
    sub_1BDB878(&SignedData_SignedPackData_TypeInfo, v10);
    sub_1BDB878(&SignedValue_TypeInfo, v11);
    sub_1BDB878(&System_Text_StringBuilder_TypeInfo, v12);
    sub_1BDB878(&StringLiteral_11999/*"SHA256"*/, v13);
    sub_1BDB878(&StringLiteral_1581/*"<RSAKeyValue><Modulus>"*/, v14);
    sub_1BDB878(&StringLiteral_1532/*"</D></RSAKeyValue>"*/, v15);
    byte_4B42963 = 1;
  }
  ...
  Bytes_63607348 = System_BitConverter__GetBytes_63607348(v18->static_fields->exist, 0LL);
  v20 = (System_Text_StringBuilder_o *)sub_1BDBAC4(System_Text_StringBuilder_TypeInfo);
  System_Text_StringBuilder___ctor(v20, 0LL);
  if ( !v20
    || (appended = (_QWORD **)System_Text_StringBuilder__Append_62657444(
                                v20,
                                (System_String_o *)StringLiteral_1581/*"<RSAKeyValue><Modulus>"*/,
                                0LL),
        (io = SignedValue_TypeInfo->static_fields->io) == 0LL) )
  {
LABEL_70:
    sub_1BDBAD4(appended, v22);
  }
...
LABEL_29:
    ...
    while ( v31 < (unsigned int)v30 )
    {
      if ( !Bytes_63607348 )
        goto LABEL_70;
      v32 = Bytes_63607348->max_length;
      if ( (int)v31 % v32 >= (unsigned int)v32 )
        break;
      v33 = *(_BYTE *)(v29 + 32 + v31);
      v34 = Bytes_63607348->m_Items[(int)v31 % v32 + 4];
      if ( !System_Convert_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(System_Convert_TypeInfo);
      v35 = System_Convert__ToChar_63620744(v34 ^ v33, 0LL);
      appended = (_QWORD **)System_Text_StringBuilder__Append_62659772(v20, v35, 0LL);
      LODWORD(v30) = *(_DWORD *)(v29 + 24);
      if ( (__int64)++v31 >= (int)v30 )
        goto LABEL_29;
    }
LABEL_69:
    sub_1BDBADC(appended, v22, v23);
  }
LABEL_30:
  System_Text_StringBuilder__Append_62657444(v20, (System_String_o *)StringLiteral_1532/*"</D></RSAKeyValue>"*/, 0LL);
  ...
  v38 = (System_Security_Cryptography_RSACryptoServiceProvider_o *)sub_1BDBAC4(System_Security_Cryptography_RSACryptoServiceProvider_TypeInfo);
  ...
  v41 = System_Security_Cryptography_CryptoConfig__MapNameToOID((System_String_o *)StringLiteral_11999/*"SHA256"*/, 0LL);
  ...
  if ( (userIdNumber & 0x8000000000000000LL) != 0 )
  {
    ...
    Count = System_Collections_Concurrent_ConcurrentQueue_object___get_Count(
              ...
              (const MethodInfo_32CFD34 *)Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__get_Count__);
    if ( Count < maxCount )
    {
      v65 = maxCount - Count;
      do
      {
        ...
        *(_QWORD *)&v87.fields._d = 0LL;
        ...
        v68 = sub_1BDBAC4(SignedData_SignedPackData_TypeInfo);
        ...
        if ( !v68 )
          sub_1BDBAD4(v69, v69);
        *(_QWORD *)(v68 + 16) = v69;
        sub_1BDB81C((CGThumbnailListItem_o *)(v68 + 16), (int32_t)v69, v70, v71);
        ...
        *(_QWORD *)(v68 + 24) = v74;
        sub_1BDB81C((CGThumbnailListItem_o *)(v68 + 24), (int32_t)v74, v75, v76);
        ...
        System_Collections_Concurrent_ConcurrentQueue_object___Enqueue(
          v78,
          (Il2CppObject *)v68,
          (const MethodInfo_32D0934 *)Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__Enqueue__);
        --v65;
      }
      while ( v65 );
    }
    ...
    if ( v46 < maxCount )
    {
      ...
      do
      {
        ...
        *(_QWORD *)&v86.fields._d = 0LL;
        ...
        v50 = sub_1BDBAC4(SignedData_SignedPackData_TypeInfo);
  ...
  {
LABEL_66:
    v82 = sub_1C2C00C(v38, System_IDisposable_TypeInfo, 0LL);
  }
...
bool __fastcall SignedData__GetSignedPackData(SignedData_SignedPackData_o **outData, const MethodInfo *method)
{
  ...
  if ( (byte_4B42960 & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__TryDequeue__, method);
  ...
  if ( (userIdNumber & 0x8000000000000000LL) != 0 )
  {
    ...
    if ( v9 )
      return System_Collections_Concurrent_ConcurrentQueue_object___TryDequeue(
               ...
               (const MethodInfo_32D0BD0 *)Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__TryDequeue__);
LABEL_15:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B42964 & 1) == 0 )
  {
    sub_1BDB878(&System_Convert_TypeInfo, hashAlgorithm);
    sub_1BDB878(&StringLiteral_9436/*"No Algorithm"*/, v7);
    byte_4B42964 = 1;
  }
...
System_Threading_Tasks_Task_o *__fastcall SignedData__RefillSigningData(int32_t maxCount, const MethodInfo *method)
{
  ...
  if ( (byte_4B42961 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__get_Count__, v3);
    sub_1BDB878(&SignedData_TypeInfo, v4);
    sub_1BDB878(&System_Threading_Tasks_Task_TypeInfo, v5);
    sub_1BDB878(&Method_SignedData___c__DisplayClass5_0__RefillSigningData_b__0__, v6);
    sub_1BDB878(&SignedData___c__DisplayClass5_0_TypeInfo, v7);
    byte_4B42961 = 1;
  }
  v8 = sub_1BDBAC4(SignedData___c__DisplayClass5_0_TypeInfo);
  ...
  *(_DWORD *)(v8 + 16) = maxCount;
  ...
  if ( !SIGNED_PACK_QUEUE )
LABEL_12:
    sub_1BDBAD4(SIGNED_PACK_QUEUE, v10);
  if ( System_Collections_Concurrent_ConcurrentQueue_object___get_Count(
         SIGNED_PACK_QUEUE,
         (const MethodInfo_32CFD34 *)Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__get_Count__) >= *(_DWORD *)(v8 + 16) )
    return 0LL;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B42966 & 1) == 0 )
  {
    sub_1BDB878(&SignedData_TypeInfo, method);
    byte_4B42966 = 1;
  }
