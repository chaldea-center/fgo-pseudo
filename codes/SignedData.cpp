void __fastcall SignedData___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C1FEF2 & 1) == 0 )
  {
    sub_1C3B764(&Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData___ctor__, v1);
    sub_1C3B764(&System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__TypeInfo, v2);
    sub_1C3B764(&SignedData_TypeInfo, v3);
    byte_4C1FEF2 = 1;
  }
  v4 = (System_Collections_Concurrent_ConcurrentQueue_T__o *)sub_1C3B9B0(System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__TypeInfo);
  System_Collections_Concurrent_ConcurrentQueue_object____ctor(
    v4,
    (const MethodInfo_32871D4 *)Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData___ctor__);
  ...
  sub_1C3B708((PartyOrganizationUtility_o *)SignedData_TypeInfo->static_fields, (int64_t)v4, v5, v6, v7, v8, v9, v10);
  v11 = (System_Collections_Concurrent_ConcurrentQueue_T__o *)sub_1C3B9B0(System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__TypeInfo);
  System_Collections_Concurrent_ConcurrentQueue_object____ctor(
    v11,
    (const MethodInfo_32871D4 *)Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData___ctor__);
...
void __fastcall SignedData__CreateSignedPackData(int32_t maxCount, const MethodInfo *method)
{
  ...
  System_Byte_array *Bytes_63985232; // x21
  ...
  if ( (byte_4C1FEF0 & 1) == 0 )
  {
    sub_1C3B764(&Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__Enqueue__, method);
    sub_1C3B764(&Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__get_Count__, v2);
    sub_1C3B764(&System_Convert_TypeInfo, v3);
    sub_1C3B764(&System_Security_Cryptography_CryptoConfig_TypeInfo, v4);
    sub_1C3B764(&System_IDisposable_TypeInfo, v5);
    sub_1C3B764(&NetworkManager_TypeInfo, v6);
    sub_1C3B764(&CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo, v7);
    sub_1C3B764(&System_Security_Cryptography_RSACryptoServiceProvider_TypeInfo, v8);
    sub_1C3B764(&SignedData_TypeInfo, v9);
    sub_1C3B764(&SignedData_SignedPackData_TypeInfo, v10);
    sub_1C3B764(&SignedValue_TypeInfo, v11);
    sub_1C3B764(&System_Text_StringBuilder_TypeInfo, v12);
    sub_1C3B764(&StringLiteral_12224/*"SUPPORT_SELECT_EQUIP_CHANGE_TITLE"*/, v13);
    sub_1C3B764(&StringLiteral_1639/*"<ds.DataRow.SetColumnError|API> {0}, column={1}, error='{2}'"*/, v14);
    sub_1C3B764(&StringLiteral_1590/*"<b>pointerEnter</b>: "*/, v15);
    byte_4C1FEF0 = 1;
  }
  ...
  Bytes_63985232 = System_BitConverter__GetBytes_63985232(v18->static_fields->exist, 0LL);
  v20 = (System_Text_StringBuilder_o *)sub_1C3B9B0(System_Text_StringBuilder_TypeInfo);
  System_Text_StringBuilder___ctor(v20, 0LL);
  if ( !v20
    || (appended = (_QWORD **)System_Text_StringBuilder__Append_62529764(
                                v20,
                                (System_String_o *)StringLiteral_1639/*"<ds.DataRow.SetColumnError|API> {0}, column={1}, error='{2}'"*/,
                                0LL),
        (io = SignedValue_TypeInfo->static_fields->io) == 0LL) )
  {
LABEL_70:
    sub_1C3B9C0(appended, v22);
  }
...
LABEL_29:
    ...
    while ( v30 < (unsigned int)v29 )
    {
      if ( !Bytes_63985232 )
        goto LABEL_70;
      v31 = Bytes_63985232->max_length;
      if ( (int)v30 % v31 >= (unsigned int)v31 )
        break;
      v32 = *(_BYTE *)(v28 + 32 + v30);
      v33 = Bytes_63985232->m_Items[(int)v30 % v31 + 4];
      if ( !System_Convert_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(System_Convert_TypeInfo);
      v34 = System_Convert__ToChar_63998808(v33 ^ v32, 0LL);
      appended = (_QWORD **)System_Text_StringBuilder__Append_62532092(v20, v34, 0LL);
      LODWORD(v29) = *(_DWORD *)(v28 + 24);
      if ( (__int64)++v30 >= (int)v29 )
        goto LABEL_29;
    }
LABEL_69:
    sub_1C3B9C8(appended, v22);
  }
LABEL_30:
  System_Text_StringBuilder__Append_62529764(v20, (System_String_o *)StringLiteral_1590/*"<b>pointerEnter</b>: "*/, 0LL);
  ...
  v37 = (System_Security_Cryptography_RSACryptoServiceProvider_o *)sub_1C3B9B0(System_Security_Cryptography_RSACryptoServiceProvider_TypeInfo);
  ...
  v40 = System_Security_Cryptography_CryptoConfig__MapNameToOID_62842884((System_String_o *)StringLiteral_12224/*"SUPPORT_SELECT_EQUIP_CHANGE_TITLE"*/, 0LL);
  ...
  if ( (userIdNumber & 0x8000000000000000LL) != 0 )
  {
    ...
    Count = System_Collections_Concurrent_ConcurrentQueue_object___get_Count(
              ...
              (const MethodInfo_32877A4 *)Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__get_Count__);
    if ( Count < maxCount )
    {
      v72 = maxCount - Count;
      do
      {
        ...
        *(_QWORD *)&v102.fields._d = 0LL;
        ...
        v75 = sub_1C3B9B0(SignedData_SignedPackData_TypeInfo);
        ...
        if ( !v75 )
          sub_1C3B9C0(v76, v76);
        *(_QWORD *)(v75 + 16) = v76;
        sub_1C3B708((PartyOrganizationUtility_o *)(v75 + 16), (int64_t)v76, v77, v78, v79, v80, v81, v82);
        ...
        *(_QWORD *)(v75 + 24) = v85;
        sub_1C3B708((PartyOrganizationUtility_o *)(v75 + 24), (int64_t)v85, v86, v87, v88, v89, v90, v91);
        ...
        System_Collections_Concurrent_ConcurrentQueue_object___Enqueue(
          v93,
          (Il2CppObject *)v75,
          (const MethodInfo_32883A4 *)Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__Enqueue__);
        --v72;
      }
      while ( v72 );
    }
    ...
    if ( v45 < maxCount )
    {
      ...
      do
      {
        ...
        *(_QWORD *)&v101.fields._d = 0LL;
        ...
        v49 = sub_1C3B9B0(SignedData_SignedPackData_TypeInfo);
        ...
        if ( !v49 )
          sub_1C3B9C0(v50, v50);
        *(_QWORD *)(v49 + 16) = v50;
        sub_1C3B708((PartyOrganizationUtility_o *)(v49 + 16), (int64_t)v50, v51, v52, v53, v54, v55, v56);
        v57 = System_Int64__ToString((int64_t)&userIdNumber, 0LL);
        v59 = System_String__Concat_63368612(v57, v48, 0LL);
        if ( !SignedData_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(SignedData_TypeInfo);
        v60 = SignedData__MakeSignedData(v37, v40, v59, v58);
        v61 = CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit(v60, 0LL);
        *(_QWORD *)(v49 + 24) = v61;
        sub_1C3B708((PartyOrganizationUtility_o *)(v49 + 24), (int64_t)v61, v62, v63, v64, v65, v66, v67);
  ...
  {
LABEL_66:
    v97 = sub_1C8D744(v37, System_IDisposable_TypeInfo, 0LL);
  }
...
bool __fastcall SignedData__GetSignedPackData(SignedData_SignedPackData_o **outData, const MethodInfo *method)
{
  ...
  if ( (byte_4C1FEED & 1) == 0 )
  {
    sub_1C3B764(&Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__TryDequeue__, method);
    sub_1C3B764(&NetworkManager_TypeInfo, v3);
    sub_1C3B764(&SignedData_TypeInfo, v4);
    byte_4C1FEED = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  ...
  if ( (userIdNumber & 0x8000000000000000LL) != 0 )
  {
    ...
    if ( v9 )
      return System_Collections_Concurrent_ConcurrentQueue_object___TryDequeue(
               ...
               (const MethodInfo_3288640 *)Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__TryDequeue__);
LABEL_15:
    sub_1C3B9C0(v9, method);
  }
  v9 = *static_fields;
  if ( !*static_fields )
    goto LABEL_15;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1FEF1 & 1) == 0 )
  {
    sub_1C3B764(&System_Convert_TypeInfo, hashAlgorithm);
    sub_1C3B764(&StringLiteral_9605/*"OnApplicationPause"*/, v7);
    byte_4C1FEF1 = 1;
  }
  if ( System_String__IsNullOrEmpty(hashAlgorithm, 0LL) )
    return (System_String_o *)StringLiteral_9605/*"OnApplicationPause"*/;
...
System_Threading_Tasks_Task_o *__fastcall SignedData__RefillSigningData(int32_t maxCount, const MethodInfo *method)
{
  ...
  if ( (byte_4C1FEEE & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__get_Count__, v3);
    sub_1C3B764(&SignedData_TypeInfo, v4);
    sub_1C3B764(&System_Threading_Tasks_Task_TypeInfo, v5);
    sub_1C3B764(&Method_SignedData___c__DisplayClass5_0__RefillSigningData_b__0__, v6);
    sub_1C3B764(&SignedData___c__DisplayClass5_0_TypeInfo, v7);
    byte_4C1FEEE = 1;
  }
  v8 = sub_1C3B9B0(SignedData___c__DisplayClass5_0_TypeInfo);
  ...
  *(_DWORD *)(v8 + 16) = maxCount;
  ...
  if ( !SIGNED_PACK_QUEUE )
LABEL_12:
    sub_1C3B9C0(SIGNED_PACK_QUEUE, v10);
  if ( System_Collections_Concurrent_ConcurrentQueue_object___get_Count(
         SIGNED_PACK_QUEUE,
         (const MethodInfo_32877A4 *)Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__get_Count__) >= *(_DWORD *)(v8 + 16) )
    return 0LL;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1FEF3 & 1) == 0 )
  {
    sub_1C3B764(&SignedData_TypeInfo, method);
    byte_4C1FEF3 = 1;
  }
