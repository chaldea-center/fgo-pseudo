void SignedData___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C357F4 & 1) == 0 )
  {
    sub_1C32C20(&Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData___ctor__);
    sub_1C32C20(&System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__TypeInfo);
    sub_1C32C20(&SignedData_TypeInfo);
    byte_4C357F4 = 1;
  }
  v1 = (System_Collections_Concurrent_ConcurrentQueue_T__o *)sub_1C32E6C(System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__TypeInfo);
  System_Collections_Concurrent_ConcurrentQueue_object____ctor(
    v1,
    (const MethodInfo_3384160 *)Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData___ctor__);
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)SignedData_TypeInfo->static_fields, (int32_t)v1, v2, v3);
  v4 = (System_Collections_Concurrent_ConcurrentQueue_T__o *)sub_1C32E6C(System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__TypeInfo);
  System_Collections_Concurrent_ConcurrentQueue_object____ctor(
    v4,
    (const MethodInfo_3384160 *)Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData___ctor__);
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&static_fields->SIGNED_PACK_QUEUE_ACCOUNT_REGIST, (int32_t)v4, v6, v7);
}
...
void SignedData__CreateSignedPackData(int32_t maxCount, const MethodInfo *method)
{
  ...
  SignedValue_c *v4; // x0
  System_Byte_array *Bytes_64567792; // x21
  ...
  if ( (byte_4C357F2 & 1) == 0 )
  {
    sub_1C32C20(&Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__Enqueue__);
    sub_1C32C20(&Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__get_Count__);
    sub_1C32C20(&System_Convert_TypeInfo);
    sub_1C32C20(&System_Security_Cryptography_CryptoConfig_TypeInfo);
    sub_1C32C20(&System_IDisposable_TypeInfo);
    sub_1C32C20(&NetworkManager_TypeInfo);
    sub_1C32C20(&CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo);
    sub_1C32C20(&System_Security_Cryptography_RSACryptoServiceProvider_TypeInfo);
    sub_1C32C20(&SignedData_TypeInfo);
    sub_1C32C20(&SignedData_SignedPackData_TypeInfo);
    sub_1C32C20(&SignedValue_TypeInfo);
    sub_1C32C20(&System_Text_StringBuilder_TypeInfo);
    sub_1C32C20(&StringLiteral_12031/*"SHA256"*/);
    sub_1C32C20(&StringLiteral_1558/*"<RSAKeyValue><Modulus>"*/);
    sub_1C32C20(&StringLiteral_1508/*"</D></RSAKeyValue>"*/);
    byte_4C357F2 = 1;
  }
  ...
  *(_QWORD *)&v64.fields._d = 0;
  ...
  Bytes_64567792 = System_BitConverter__GetBytes_64567792(v4->static_fields->exist, 0);
  v6 = (System_Text_StringBuilder_o *)sub_1C32E6C(System_Text_StringBuilder_TypeInfo);
  System_Text_StringBuilder___ctor(v6, 0);
  if ( !v6
    || (appended = (_QWORD **)System_Text_StringBuilder__Append_63603608(v6, (System_String_o *)StringLiteral_1558/*"<RSAKeyValue><Modulus>"*/, 0),
...
LABEL_29:
    ...
    while ( v15 < (unsigned int)v14 )
    {
      if ( !Bytes_64567792 )
        goto LABEL_70;
      v16 = Bytes_64567792->max_length;
      if ( (int)v15 % v16 >= (unsigned int)v16 )
        break;
      v17 = *(_BYTE *)(v13 + 32 + v15);
      v18 = Bytes_64567792->m_Items[(int)v15 % v16];
      if ( !System_Convert_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(System_Convert_TypeInfo);
      v19 = System_Convert__ToChar_64581188(v18 ^ v17, 0);
      appended = (_QWORD **)System_Text_StringBuilder__Append_63605936(v6, v19, 0);
...
LABEL_30:
  System_Text_StringBuilder__Append_63603608(v6, (System_String_o *)StringLiteral_1508/*"</D></RSAKeyValue>"*/, 0);
  ...
  v22 = (System_Security_Cryptography_RSACryptoServiceProvider_o *)sub_1C32E6C(System_Security_Cryptography_RSACryptoServiceProvider_TypeInfo);
  ...
  v24 = System_Security_Cryptography_CryptoConfig__MapNameToOID((System_String_o *)StringLiteral_12031/*"SHA256"*/, 0);
  ...
  if ( userIdNumber < 0 )
  {
    ...
    Count = System_Collections_Concurrent_ConcurrentQueue_object___get_Count(
              ...
              (const MethodInfo_3384730 *)Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__get_Count__);
    if ( Count < maxCount )
    {
      v46 = maxCount - Count;
      do
      {
        ...
        *(_QWORD *)&v67.fields._d = 0;
        ...
        v49 = sub_1C32E6C(SignedData_SignedPackData_TypeInfo);
        ...
        if ( !v49 )
          sub_1C32E7C(v50);
        *(_QWORD *)(v49 + 16) = v50;
        sub_1C32BC4((CGThumbnailListItem_o *)(v49 + 16), (int32_t)v50, v51, v52);
        ...
        *(_QWORD *)(v49 + 24) = v55;
        sub_1C32BC4((CGThumbnailListItem_o *)(v49 + 24), (int32_t)v55, v56, v57);
        ...
        System_Collections_Concurrent_ConcurrentQueue_object___Enqueue(
          v58,
          (Il2CppObject *)v49,
          (const MethodInfo_3385330 *)Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__Enqueue__);
        --v46;
      }
      while ( v46 );
    }
    ...
    if ( v28 < maxCount )
    {
      ...
      do
      {
        ...
        *(_QWORD *)&v66.fields._d = 0;
        ...
        v32 = sub_1C32E6C(SignedData_SignedPackData_TypeInfo);
  ...
  {
LABEL_66:
    v62 = sub_1C83438(v22, System_IDisposable_TypeInfo, 0);
  }
...
bool SignedData__GetSignedPackData(SignedData_SignedPackData_o **outData, const MethodInfo *method)
{
  ...
  if ( (byte_4C357EF & 1) == 0 )
  {
    sub_1C32C20(&Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__TryDequeue__);
    sub_1C32C20(&NetworkManager_TypeInfo);
    sub_1C32C20(&SignedData_TypeInfo);
    byte_4C357EF = 1;
  }
  ...
  if ( userIdNumber < 0 )
  {
    ...
    if ( v7 )
      return System_Collections_Concurrent_ConcurrentQueue_object___TryDequeue(
               ...
               (const MethodInfo_33855CC *)Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__TryDequeue__);
LABEL_15:
    sub_1C32E7C(v7);
  }
  v7 = *static_fields;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C32C20(&System_Convert_TypeInfo);
    sub_1C32C20(&StringLiteral_9442/*"No Algorithm"*/);
    byte_4C357F3 = 1;
  }
  if ( System_String__IsNullOrEmpty(hashAlgorithm, 0) )
    return (System_String_o *)StringLiteral_9442/*"No Algorithm"*/;
...
System_Threading_Tasks_Task_o *SignedData__RefillSigningData(int32_t maxCount, const MethodInfo *method)
{
  ...
  if ( (byte_4C357F0 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__get_Count__);
    sub_1C32C20(&SignedData_TypeInfo);
    sub_1C32C20(&System_Threading_Tasks_Task_TypeInfo);
    sub_1C32C20(&Method_SignedData___c__DisplayClass5_0__RefillSigningData_b__0__);
    sub_1C32C20(&SignedData___c__DisplayClass5_0_TypeInfo);
    byte_4C357F0 = 1;
  }
  v3 = sub_1C32E6C(SignedData___c__DisplayClass5_0_TypeInfo);
  ...
  *(_DWORD *)(v3 + 16) = maxCount;
  ...
  if ( !SIGNED_PACK_QUEUE )
LABEL_12:
    sub_1C32E7C(SIGNED_PACK_QUEUE);
  if ( System_Collections_Concurrent_ConcurrentQueue_object___get_Count(
         SIGNED_PACK_QUEUE,
         (const MethodInfo_3384730 *)Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__get_Count__) >= *(_DWORD *)(v3 + 16) )
    return 0;
