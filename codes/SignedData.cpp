void __fastcall SignedData___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB3D8A & 1) == 0 )
  {
    sub_1BAB41C(&Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData___ctor__, v1);
    sub_1BAB41C(&System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__TypeInfo, v2);
    sub_1BAB41C(&SignedData_TypeInfo, v3);
    byte_4AB3D8A = 1;
  }
  v4 = (System_Collections_Concurrent_ConcurrentQueue_T__o *)sub_1BAB668(System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__TypeInfo);
  System_Collections_Concurrent_ConcurrentQueue_object____ctor(
    v4,
    (const MethodInfo_31523E8 *)Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData___ctor__);
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)SignedData_TypeInfo->static_fields, (int32_t)v4, v5, v6);
  v7 = (System_Collections_Concurrent_ConcurrentQueue_T__o *)sub_1BAB668(System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__TypeInfo);
  System_Collections_Concurrent_ConcurrentQueue_object____ctor(
    v7,
    (const MethodInfo_31523E8 *)Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData___ctor__);
...
void __fastcall SignedData__CreateSignedPackData(int32_t maxCount, const MethodInfo *method)
{
  ...
  System_Byte_array *Bytes_62664420; // x21
  ...
  if ( (byte_4AB3D88 & 1) == 0 )
  {
    sub_1BAB41C(&Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__Enqueue__, method);
    sub_1BAB41C(&Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__get_Count__, v2);
    sub_1BAB41C(&System_Convert_TypeInfo, v3);
    sub_1BAB41C(&System_Security_Cryptography_CryptoConfig_TypeInfo, v4);
    sub_1BAB41C(&System_IDisposable_TypeInfo, v5);
    sub_1BAB41C(&NetworkManager_TypeInfo, v6);
    sub_1BAB41C(&CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo, v7);
    sub_1BAB41C(&System_Security_Cryptography_RSACryptoServiceProvider_TypeInfo, v8);
    sub_1BAB41C(&SignedData_TypeInfo, v9);
    sub_1BAB41C(&SignedData_SignedPackData_TypeInfo, v10);
    sub_1BAB41C(&SignedValue_TypeInfo, v11);
    sub_1BAB41C(&System_Text_StringBuilder_TypeInfo, v12);
    sub_1BAB41C(&StringLiteral_11982/*"SHA256"*/, v13);
    sub_1BAB41C(&StringLiteral_1655/*"<RSAKeyValue><Modulus>"*/, v14);
    sub_1BAB41C(&StringLiteral_1606/*"</D></RSAKeyValue>"*/, v15);
    byte_4AB3D88 = 1;
  }
  ...
  Bytes_62664420 = System_BitConverter__GetBytes_62664420(v17->static_fields->exist, 0LL);
  v19 = (System_Text_StringBuilder_o *)sub_1BAB668(System_Text_StringBuilder_TypeInfo);
  System_Text_StringBuilder___ctor(v19, 0LL);
  if ( !v19
    || (appended = (_QWORD **)System_Text_StringBuilder__Append_61210024(
                                v19,
...
LABEL_25:
    ...
    while ( v29 < (unsigned int)v28 )
    {
      if ( !Bytes_62664420 )
        goto LABEL_66;
      v30 = Bytes_62664420->max_length;
      if ( (int)v29 % v30 >= (unsigned int)v30 )
        break;
      v31 = *(_BYTE *)(v27 + 32 + v29);
      v32 = Bytes_62664420->m_Items[(int)v29 % v30 + 4];
      if ( !System_Convert_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(System_Convert_TypeInfo);
      v33 = System_Convert__ToChar_62677996(v32 ^ v31, 0LL);
      appended = (_QWORD **)System_Text_StringBuilder__Append_61212352(v19, v33, 0LL);
      LODWORD(v28) = *(_DWORD *)(v27 + 24);
      if ( (__int64)++v29 >= (int)v28 )
        goto LABEL_25;
    }
LABEL_65:
    sub_1BAB680(appended, v21);
  }
LABEL_26:
  System_Text_StringBuilder__Append_61210024(v19, (System_String_o *)StringLiteral_1606/*"</D></RSAKeyValue>"*/, 0LL);
  ...
  v36 = (System_Security_Cryptography_RSACryptoServiceProvider_o *)sub_1BAB668(System_Security_Cryptography_RSACryptoServiceProvider_TypeInfo);
  ...
  v39 = System_Security_Cryptography_CryptoConfig__MapNameToOID_61523144((System_String_o *)StringLiteral_11982/*"SHA256"*/, 0LL);
  ...
  if ( (v83 & 0x8000000000000000LL) != 0 )
  {
    ...
    Count = System_Collections_Concurrent_ConcurrentQueue_object___get_Count(
              ...
              (const MethodInfo_31529B8 *)Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__get_Count__);
    if ( Count < maxCount )
    {
      v63 = maxCount - Count;
      do
      {
        ...
        *(_QWORD *)&v85.fields._d = 0LL;
        ...
        v66 = sub_1BAB668(SignedData_SignedPackData_TypeInfo);
        ...
        if ( !v66 )
          sub_1BAB678(v67, v67);
        *(_QWORD *)(v66 + 16) = v67;
        sub_1BAB3C0((ServantStatusBattleListViewItem_o *)(v66 + 16), (int32_t)v67, v68, v69);
        ...
        *(_QWORD *)(v66 + 24) = v72;
        sub_1BAB3C0((ServantStatusBattleListViewItem_o *)(v66 + 24), (int32_t)v72, v73, v74);
        ...
        System_Collections_Concurrent_ConcurrentQueue_object___Enqueue(
          v76,
          (Il2CppObject *)v66,
          (const MethodInfo_31535B8 *)Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__Enqueue__);
        --v63;
      }
      while ( v63 );
    }
    ...
    if ( v44 < maxCount )
    {
      ...
      do
      {
        ...
        *(_QWORD *)&v84.fields._d = 0LL;
        ...
        v48 = sub_1BAB668(SignedData_SignedPackData_TypeInfo);
        ...
        if ( !v48 )
          sub_1BAB678(v49, v49);
        *(_QWORD *)(v48 + 16) = v49;
        sub_1BAB3C0((ServantStatusBattleListViewItem_o *)(v48 + 16), (int32_t)v49, v50, v51);
        v52 = System_Int64__ToString((int64_t)&v83, 0LL);
        v54 = System_String__Concat_62048128(v52, v47, 0LL);
        if ( !SignedData_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(SignedData_TypeInfo);
        v55 = SignedData__MakeSignedData(v36, v39, v54, v53);
        v56 = CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit(v55, 0LL);
        *(_QWORD *)(v48 + 24) = v56;
        sub_1BAB3C0((ServantStatusBattleListViewItem_o *)(v48 + 24), (int32_t)v56, v57, v58);
  ...
  {
LABEL_62:
    v80 = sub_1BFD3FC(v36, System_IDisposable_TypeInfo, 0LL);
  }
...
bool __fastcall SignedData__GetSignedPackData(SignedData_SignedPackData_o **outData, const MethodInfo *method)
{
  ...
  if ( (byte_4AB3D85 & 1) == 0 )
  {
    sub_1BAB41C(&Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__TryDequeue__, method);
    sub_1BAB41C(&NetworkManager_TypeInfo, v3);
    sub_1BAB41C(&SignedData_TypeInfo, v4);
    byte_4AB3D85 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  ...
  if ( (v8 & 0x8000000000000000LL) != 0 )
  {
    ...
    if ( v10 )
      return System_Collections_Concurrent_ConcurrentQueue_object___TryDequeue(
               ...
               (const MethodInfo_3153854 *)Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__TryDequeue__);
LABEL_11:
    sub_1BAB678(v10, v6);
  }
  v10 = *static_fields;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB3D89 & 1) == 0 )
  {
    sub_1BAB41C(&System_Convert_TypeInfo, hashAlgorithm);
    sub_1BAB41C(&StringLiteral_9420/*"No Algorithm"*/, v7);
    byte_4AB3D89 = 1;
  }
  if ( System_String__IsNullOrEmpty(hashAlgorithm, 0LL) )
    return (System_String_o *)StringLiteral_9420/*"No Algorithm"*/;
...
System_Threading_Tasks_Task_o *__fastcall SignedData__RefillSigningData(int32_t maxCount, const MethodInfo *method)
{
  ...
  if ( (byte_4AB3D86 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__get_Count__, v3);
    sub_1BAB41C(&SignedData_TypeInfo, v4);
    sub_1BAB41C(&System_Threading_Tasks_Task_TypeInfo, v5);
    sub_1BAB41C(&Method_SignedData___c__DisplayClass5_0__RefillSigningData_b__0__, v6);
    sub_1BAB41C(&SignedData___c__DisplayClass5_0_TypeInfo, v7);
    byte_4AB3D86 = 1;
  }
  v8 = sub_1BAB668(SignedData___c__DisplayClass5_0_TypeInfo);
  ...
  *(_DWORD *)(v8 + 16) = maxCount;
  ...
  if ( !SIGNED_PACK_QUEUE )
LABEL_12:
    sub_1BAB678(SIGNED_PACK_QUEUE, v10);
  if ( System_Collections_Concurrent_ConcurrentQueue_object___get_Count(
         SIGNED_PACK_QUEUE,
         (const MethodInfo_31529B8 *)Method_System_Collections_Concurrent_ConcurrentQueue_SignedData_SignedPackData__get_Count__) >= *(_DWORD *)(v8 + 16) )
    return 0LL;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB3D8B & 1) == 0 )
  {
    sub_1BAB41C(&SignedData_TypeInfo, method);
    byte_4AB3D8B = 1;
  }
