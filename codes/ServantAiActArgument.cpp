        ...
        const MethodInfo *method)
{
  ...
  sub_1B8635C((CGThumbnailListItem_o *)v9, (int32_t)svtData, v10, v11);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields._SvtData_k__BackingField, (int32_t)value, (int32_t)method, v3);
}