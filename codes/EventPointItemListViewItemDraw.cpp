void EventPointItemListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4DFED25 & 1) == 0 )
  {
    sub_1CE6700(&EventPointItemListViewItemDraw_TypeInfo);
    sub_1CE6700(&StringLiteral_19524/*"event_rewardpoint_"*/);
    sub_1CE6700(&StringLiteral_19520/*"event_rewardget_"*/);
    byte_4DFED25 = 1;
  }
  EventPointItemListViewItemDraw_TypeInfo->static_fields->BOARD_SPRITE_BASE_NAME = (struct System_String_o *)StringLiteral_19524/*"event_rewardpoint_"*/;
  sub_1CE66A4(EventPointItemListViewItemDraw_TypeInfo->static_fields, StringLiteral_19524/*"event_rewardpoint_"*/);
  v1 = StringLiteral_19520/*"event_rewardget_"*/;
  static_fields = EventPointItemListViewItemDraw_TypeInfo->static_fields;
  static_fields->GET_SPRITE_NAME = (struct System_String_o *)StringLiteral_19520/*"event_rewardget_"*/;
  sub_1CE66A4(&static_fields->GET_SPRITE_NAME, v1);
}
  ...
  if ( (v4 & 1) != 0 )
  {
    ...
    if ( !v6
      || (mAtlas = v6->fields.mAtlas,
          ...
          v4 = sub_1CE66A4(&this->fields.baseAtlas, mAtlas),
    ...
    sub_1CE66A4(&this->fields.baseSpriteName, mSpriteName);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (getRewardImgObj & 1) != 0 )
  {
    ...
    if ( eventRewardEnt->fields.eventId >= 1 )
    {
      ...
      if ( bgImageId < 1 )
      {
        ...
        v14 = System_String__Concat_65161092(v12, v15, (System_String_o *)StringLiteral_1124/*"00"*/, 0);
      }
      else
      {
        if ( !eventRewardEnt )
        ...
        v14 = System_String__Concat_65122828(v12, v13, 0);
      }
      v16 = v14;
  ...
  v17 = sub_1CE694C(System_Collections_Generic_List_GameObject__TypeInfo);
...
LABEL_60:
  ...
  if ( (int)item >= 1 )
  {
    ...
    if ( (int)v22 <= 1 )
      ...
      v23 = v22;
    ItemIconComponent__SetItemImage_42067256((ItemIconComponent_o *)getRewardImgObj, (int32_t)item, v23, 0);
    goto LABEL_62;
  }
  rewardNum = v5->fields.rewardNum;
  if ( rewardNum < 1 )
...
LABEL_51:
    *(_DWORD *)(v17 + 28) = v33 + 1;
    ...
    else
    {
      ...
      *(_DWORD *)(v17 + 24) = v36 + 1;
      *(_QWORD *)(v37 + 32) = item;
      getRewardImgObj = sub_1CE66A4(v37 + 32, item);
    }
    goto LABEL_62;
  }
  ...
  if ( (getRewardImgObj & 1) != 0 )
  {
    ...
    if ( (getRewardImgObj & 1) != 0 )
    {
      ...
      else
      {
        ...
        *(_DWORD *)(v17 + 24) = v31 + 1;
        *(_QWORD *)(v32 + 32) = item;
        getRewardImgObj = sub_1CE66A4(v32 + 32, item);
      }
      item = (EventPointItemListViewItem_o *)this->fields.countLbInfo;
      v33 = *(_DWORD *)(v17 + 28);
      v34 = *(_QWORD *)(v17 + 16);
      ...
      if ( getRewardImgObj )
      {
        ...
        if ( v44 )
        {
          ...
          if ( v45 < 1 )
          {
            ...
            v49 = System_String__Concat_65161092(v47, v50, (System_String_o *)StringLiteral_1124/*"00"*/, 0);
          }
          else
          {
            if ( !v44 )
            ...
            v49 = System_String__Concat_65122828(v47, v48, 0);
          }
          v51 = v49;
          if ( !EventRewardRootComponent_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(EventRewardRootComponent_TypeInfo);
...
LABEL_91:
    sub_1CE6958(getRewardImgObj, item);
  }
}