void __fastcall EventPointItemListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A73D8A & 1) == 0 )
  {
    sub_1B90010(&EventPointItemListViewItemDraw_TypeInfo, v1);
    sub_1B90010(&StringLiteral_19275/*"event_rewardpoint_"*/, v4);
    sub_1B90010(&StringLiteral_19271/*"event_rewardget_"*/, v5);
    byte_4A73D8A = 1;
  }
  EventPointItemListViewItemDraw_TypeInfo->static_fields->BOARD_SPRITE_BASE_NAME = (struct System_String_o *)StringLiteral_19275/*"event_rewardpoint_"*/;
  sub_1B8FFB4(
    (ServantStatusBattleListViewItem_o *)EventPointItemListViewItemDraw_TypeInfo->static_fields,
    StringLiteral_19275/*"event_rewardpoint_"*/,
    v2,
    v3);
  v6 = StringLiteral_19271/*"event_rewardget_"*/;
  static_fields = EventPointItemListViewItemDraw_TypeInfo->static_fields;
  static_fields->GET_SPRITE_NAME = (struct System_String_o *)StringLiteral_19271/*"event_rewardget_"*/;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&static_fields->GET_SPRITE_NAME, v6, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73D89 & 1) == 0 )
  {
    sub_1B90010(&EventPointItemListViewItemDraw_TypeInfo, item);
    sub_1B90010(&EventRewardRootComponent_TypeInfo, v7);
    sub_1B90010(&Method_System_Collections_Generic_List_GameObject__Add__, v8);
    sub_1B90010(&Method_System_Collections_Generic_List_GameObject__Clear__, v9);
    ...
    sub_1B90010(&StringLiteral_1221/*"00"*/, v13);
    byte_4A73D89 = 1;
  }
  eventId = 0;
  if ( !v5 || !mode )
  ...
  if ( (getRewardImgObj & 1) != 0 )
  {
    ...
    if ( eventRewardEnt->fields.eventId >= 1 )
    {
      ...
      if ( bgImageId < 1 )
      {
        ...
        v21 = System_String__Concat_61798352(v19, v22, (System_String_o *)StringLiteral_1221/*"00"*/, 0LL);
      }
      else
      {
        if ( !eventRewardEnt )
        ...
        v21 = System_String__Concat_61787092(v19, v20, 0LL);
      }
      v23 = v21;
  ...
  v24 = sub_1B9025C(System_Collections_Generic_List_GameObject__TypeInfo);
...
LABEL_60:
  ...
  if ( (int)item >= 1 )
  {
    ...
    if ( v29 <= 1 )
      ...
      v30 = v29;
    ItemIconComponent__SetItemImage_38199412((ItemIconComponent_o *)getRewardImgObj, (int32_t)item, v30, 0LL);
    goto LABEL_62;
  }
  rewardNum = v5->fields.rewardNum;
  if ( rewardNum < 1 )
...
LABEL_51:
    *(_DWORD *)(v24 + 28) = v43 + 1;
    ...
    else
    {
      ...
      *(_DWORD *)(v24 + 24) = v46 + 1;
      *(_QWORD *)(v47 + 32) = item;
      sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v47 + 32), (int32_t)item, v32, v33);
    }
    goto LABEL_62;
  }
  ...
  if ( (getRewardImgObj & 1) != 0 )
  {
    ...
    if ( (getRewardImgObj & 1) != 0 )
    {
      ...
      else
      {
        ...
        *(_DWORD *)(v24 + 24) = v41 + 1;
        *(_QWORD *)(v42 + 32) = item;
        sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v42 + 32), (int32_t)item, (int32_t)v25, v38);
      }
      item = (EventPointItemListViewItem_o *)this->fields.countLbInfo;
      v43 = *(_DWORD *)(v24 + 28);
      v44 = *(_QWORD *)(v24 + 16);
      ...
      if ( getRewardImgObj )
      {
        ...
        if ( v54 )
        {
          ...
          if ( v55 < 1 )
          {
            ...
            v59 = System_String__Concat_61798352(v57, v60, (System_String_o *)StringLiteral_1221/*"00"*/, 0LL);
          }
          else
          {
            if ( !v54 )
            ...
            v59 = System_String__Concat_61787092(v57, v58, 0LL);
          }
          v61 = v59;
          if ( !EventRewardRootComponent_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(EventRewardRootComponent_TypeInfo);
...
LABEL_91:
    sub_1B9026C(getRewardImgObj, item);
  }
}