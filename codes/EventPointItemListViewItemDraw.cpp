void __fastcall EventPointItemListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BCBBEE & 1) == 0 )
  {
    sub_1C1ABD4(&EventPointItemListViewItemDraw_TypeInfo, v1);
    sub_1C1ABD4(&StringLiteral_19565/*"event_rewardpoint_"*/, v8);
    sub_1C1ABD4(&StringLiteral_19561/*"event_rewardget_"*/, v9);
    byte_4BCBBEE = 1;
  }
  EventPointItemListViewItemDraw_TypeInfo->static_fields->BOARD_SPRITE_BASE_NAME = (struct System_String_o *)StringLiteral_19565/*"event_rewardpoint_"*/;
  sub_1C1AB78(
    (PartyOrganizationUtility_o *)EventPointItemListViewItemDraw_TypeInfo->static_fields,
    StringLiteral_19565/*"event_rewardpoint_"*/,
    v2,
    v3,
    v4,
    v5,
    v6,
    v7);
  v10 = StringLiteral_19561/*"event_rewardget_"*/;
  static_fields = EventPointItemListViewItemDraw_TypeInfo->static_fields;
  static_fields->GET_SPRITE_NAME = (struct System_String_o *)StringLiteral_19561/*"event_rewardget_"*/;
  sub_1C1AB78((PartyOrganizationUtility_o *)&static_fields->GET_SPRITE_NAME, v10, v12, v13, v14, v15, v16, v17);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCBBED & 1) == 0 )
  {
    sub_1C1ABD4(&EventPointItemListViewItemDraw_TypeInfo, item);
    sub_1C1ABD4(&EventRewardRootComponent_TypeInfo, v7);
  ...
  if ( (getRewardImgObj & 1) != 0 )
  {
    ...
    if ( eventRewardEnt->fields.eventId >= 1 )
    {
      ...
      if ( bgImageId < 1 )
      {
        ...
        v21 = System_String__Concat_63051628(v19, v22, (System_String_o *)StringLiteral_1220/*"00"*/, 0LL);
      }
      else
      {
        if ( !eventRewardEnt )
        ...
        v21 = System_String__Concat_63040368(v19, v20, 0LL);
      }
      v23 = v21;
  ...
  v24 = sub_1C1AE20(System_Collections_Generic_List_GameObject__TypeInfo);
...
LABEL_60:
  ...
  if ( (int)item >= 1 )
  {
    ...
    if ( v29 <= 1 )
      ...
      v30 = v29;
    ItemIconComponent__SetItemImage_39342608((ItemIconComponent_o *)getRewardImgObj, (int32_t)item, v30, 0LL);
    goto LABEL_62;
  }
  rewardNum = v5->fields.rewardNum;
  if ( rewardNum < 1 )
...
LABEL_51:
    *(_DWORD *)(v24 + 28) = v51 + 1;
    ...
    else
    {
      ...
      *(_DWORD *)(v24 + 24) = v54 + 1;
      *(_QWORD *)(v55 + 32) = item;
      sub_1C1AB78((PartyOrganizationUtility_o *)(v55 + 32), (int64_t)item, v32, v33, v34, v35, v36, v37);
    }
    goto LABEL_62;
  }
  ...
  if ( (getRewardImgObj & 1) != 0 )
  {
    ...
    if ( (getRewardImgObj & 1) != 0 )
    {
      ...
      else
      {
        ...
        *(_DWORD *)(v24 + 24) = v49 + 1;
        *(_QWORD *)(v50 + 32) = item;
        sub_1C1AB78((PartyOrganizationUtility_o *)(v50 + 32), (int64_t)item, v25, v42, v43, v44, v45, v46);
      }
      item = (EventPointItemListViewItem_o *)this->fields.countLbInfo;
      v51 = *(_DWORD *)(v24 + 28);
      v52 = *(_QWORD *)(v24 + 16);
      ...
      if ( getRewardImgObj )
      {
        ...
        if ( v62 )
        {
          ...
          if ( v63 < 1 )
          {
            ...
            v67 = System_String__Concat_63051628(v65, v68, (System_String_o *)StringLiteral_1220/*"00"*/, 0LL);
          }
          else
          {
            if ( !v62 )
            ...
            v67 = System_String__Concat_63040368(v65, v66, 0LL);
          }
          v69 = v67;
          if ( !EventRewardRootComponent_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(EventRewardRootComponent_TypeInfo);
...
LABEL_91:
    sub_1C1AE30(getRewardImgObj, item);
  }
}