        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB7F5 & 1) == 0 )
  {
    ...
    sub_1B64A00(&SubmarineQuestSaveInfo_TypeInfo, v3);
    byte_49FB7F5 = 1;
  }
  ...
  v21 = sub_1B64C4C(SubmarineQuestSaveInfo_TypeInfo);
...
SubmarineQuestSaveInfo_o *__fastcall SubmarineQuestSaveInfo__CreateDefault(const MethodInfo *method)
{
  ...
  if ( (byte_49FB7F4 & 1) == 0 )
  {
    sub_1B64A00(&SubmarineQuestSaveInfo_TypeInfo, v1);
    byte_49FB7F4 = 1;
  }
  v2 = sub_1B64C4C(SubmarineQuestSaveInfo_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v29[0] = 0;
  v5 = sub_1B64AA8(string___TypeInfo, 8LL);
  ...
  *(_QWORD *)(v5 + 40) = StringLiteral_869/*","*/;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)(v5 + 40), v12, v10, v11);
  QuestId_k__BackingField = this->fields._PhaseCnt_k__BackingField;
  v6 = System_Int32__ToString((int32_t)&QuestId_k__BackingField, 0LL);
  if ( *(_DWORD *)(v5 + 24) <= 2u )
    goto LABEL_15;
  *(_QWORD *)(v5 + 48) = v6;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)(v5 + 48), (int32_t)v6, v13, v14);
  if ( *(_DWORD *)(v5 + 24) <= 3u )
    goto LABEL_15;
  v17 = (int)StringLiteral_869/*","*/;
  *(_QWORD *)(v5 + 56) = StringLiteral_869/*","*/;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)(v5 + 56), v17, v15, v16);
  ...
  if ( *(_DWORD *)(v5 + 24) <= 4u )
    goto LABEL_15;
  *(_QWORD *)(v5 + 64) = v6;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)(v5 + 64), (int32_t)v6, v18, v19);
  if ( *(_DWORD *)(v5 + 24) <= 5u
    || (v22 = (int)StringLiteral_869/*","*/,
        *(_QWORD *)(v5 + 72) = StringLiteral_869/*","*/,
        sub_1B649A4((ServantStatusBattleListViewItem_o *)(v5 + 72), v22, v20, v21),
        v29[0] = this->fields._IsQuestPhaseClear_k__BackingField,
        v6 = System_Boolean__ToString((bool)v29, 0LL),
        *(_DWORD *)(v5 + 24) <= 6u)
    || (*(_QWORD *)(v5 + 80) = v6,
        sub_1B649A4((ServantStatusBattleListViewItem_o *)(v5 + 80), (int32_t)v6, v23, v24),
        *(_DWORD *)(v5 + 24) <= 7u) )
  {
LABEL_15:
    sub_1B64C64(v6, v7);
  ...
  *(_QWORD *)(v5 + 88) = StringLiteral_869/*","*/;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)(v5 + 88), v27, v25, v26);
  return System_String__Concat_61398664((System_String_array *)v5, 0LL);
}
