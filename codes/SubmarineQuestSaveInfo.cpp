        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18F08 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&SubmarineQuestSaveInfo_TypeInfo, v3);
    byte_4B18F08 = 1;
  }
  ...
  v25 = sub_1BCB244(SubmarineQuestSaveInfo_TypeInfo);
...
SubmarineQuestSaveInfo_o *__fastcall SubmarineQuestSaveInfo__CreateDefault(const MethodInfo *method)
{
  ...
  if ( (byte_4B18F07 & 1) == 0 )
  {
    sub_1BCAFF8(&SubmarineQuestSaveInfo_TypeInfo, v1);
    byte_4B18F07 = 1;
  }
  v2 = sub_1BCB244(SubmarineQuestSaveInfo_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v22[0] = 0;
  v5 = sub_1BCB0A0(string___TypeInfo, 8LL);
  ...
  if ( *(_DWORD *)(v5 + 24) <= 5u
    || (v17 = (int)StringLiteral_806/*","*/,
        *(_QWORD *)(v5 + 72) = StringLiteral_806/*","*/,
        sub_1BCAF9C((CGThumbnailListItem_o *)(v5 + 72), v17, v8, v16),
        v22[0] = this->fields._IsQuestPhaseClear_k__BackingField,
        v6 = System_Boolean__ToString((bool)v22, 0LL),
        *(_DWORD *)(v5 + 24) <= 6u)
    || (*(_QWORD *)(v5 + 80) = v6,
        sub_1BCAF9C((CGThumbnailListItem_o *)(v5 + 80), (int32_t)v6, v8, v18),
        *(_DWORD *)(v5 + 24) <= 7u) )
  {
LABEL_15:
  ...
  *(_QWORD *)(v5 + 88) = StringLiteral_806/*","*/;
  sub_1BCAF9C((CGThumbnailListItem_o *)(v5 + 88), v20, v8, v19);
