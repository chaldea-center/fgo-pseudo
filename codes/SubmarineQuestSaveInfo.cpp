        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B414AD & 1) == 0 )
  {
    ...
    sub_1BDB878(&SubmarineQuestSaveInfo_TypeInfo, v3);
    byte_4B414AD = 1;
  }
  ...
  v25 = sub_1BDBAC4(SubmarineQuestSaveInfo_TypeInfo);
...
SubmarineQuestSaveInfo_o *__fastcall SubmarineQuestSaveInfo__CreateDefault(const MethodInfo *method)
{
  ...
  if ( (byte_4B414AC & 1) == 0 )
  {
    sub_1BDB878(&SubmarineQuestSaveInfo_TypeInfo, v1);
    byte_4B414AC = 1;
  }
  v2 = sub_1BDBAC4(SubmarineQuestSaveInfo_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v22[0] = 0;
  v5 = sub_1BDB920(string___TypeInfo, 8LL);
  ...
  *(_QWORD *)(v5 + 32) = v6;
  ...
  if ( *(_DWORD *)(v5 + 24) <= 1u )
    goto LABEL_15;
  v11 = (int)StringLiteral_820/*","*/;
  *(_QWORD *)(v5 + 40) = StringLiteral_820/*","*/;
  ...
  *(_QWORD *)(v5 + 48) = v6;
  ...
  if ( *(_DWORD *)(v5 + 24) <= 3u )
    goto LABEL_15;
  v14 = (int)StringLiteral_820/*","*/;
  *(_QWORD *)(v5 + 56) = StringLiteral_820/*","*/;
  ...
  *(_QWORD *)(v5 + 64) = v6;
  ...
  if ( *(_DWORD *)(v5 + 24) <= 5u
    || (v17 = (int)StringLiteral_820/*","*/,
        *(_QWORD *)(v5 + 72) = StringLiteral_820/*","*/,
        sub_1BDB81C((CGThumbnailListItem_o *)(v5 + 72), v17, v8, v16),
        v22[0] = this->fields._IsQuestPhaseClear_k__BackingField,
        v6 = System_Boolean__ToString((bool)v22, 0LL),
        *(_DWORD *)(v5 + 24) <= 6u)
    || (*(_QWORD *)(v5 + 80) = v6,
        sub_1BDB81C((CGThumbnailListItem_o *)(v5 + 80), (int32_t)v6, v8, v18),
        *(_DWORD *)(v5 + 24) <= 7u) )
  {
LABEL_15:
  ...
  *(_QWORD *)(v5 + 88) = StringLiteral_820/*","*/;
  sub_1BDB81C((CGThumbnailListItem_o *)(v5 + 88), v20, v8, v19);
