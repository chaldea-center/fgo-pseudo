...
SubmarineQuestSaveInfo_o *SubmarineQuestSaveInfo__CreateBySaveValue(System_String_o *value, const MethodInfo *method)
{
  ...
  v17 = sub_1D0F300(SubmarineQuestSaveInfo_TypeInfo);
...
SubmarineQuestSaveInfo_o *SubmarineQuestSaveInfo__CreateDefault(const MethodInfo *method)
{
  ...
  v1 = sub_1D0F300(SubmarineQuestSaveInfo_TypeInfo);
...
System_String_o *SubmarineQuestSaveInfo__GetSaveValue(SubmarineQuestSaveInfo_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)(v3 + 40) = StringLiteral_810/*","*/;
  ...
  if ( *(_DWORD *)(v3 + 24) <= 2u )
    goto LABEL_15;
  *(_QWORD *)(v3 + 48) = v4;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)(v3 + 48), (int32_t)v4, v19, v20, v21, v22, v23, v24);
  if ( *(_DWORD *)(v3 + 24) <= 3u )
    goto LABEL_15;
  ...
  *(_QWORD *)(v3 + 56) = StringLiteral_810/*","*/;
  ...
  if ( *(_DWORD *)(v3 + 24) <= 4u )
    goto LABEL_15;
  *(_QWORD *)(v3 + 64) = v4;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)(v3 + 64), (int32_t)v4, v32, v33, v34, v35, v36, v37);
  if ( *(_DWORD *)(v3 + 24) <= 5u
    || (v44 = StringLiteral_810/*","*/,
        *(_QWORD *)(v3 + 72) = StringLiteral_810/*","*/,
        sub_1D0F058((GrandQuestFolderBoardItem_o *)(v3 + 72), v44, v38, v39, v40, v41, v42, v43),
        v59[0] = this->fields._IsQuestPhaseClear_k__BackingField,
        v4 = System_Boolean__ToString((bool)v59, 0),
        *(_DWORD *)(v3 + 24) <= 6u)
    || (*(_QWORD *)(v3 + 80) = v4,
        sub_1D0F058((GrandQuestFolderBoardItem_o *)(v3 + 80), (int32_t)v4, v45, v46, v47, v48, v49, v50),
        *(_DWORD *)(v3 + 24) <= 7u) )
  {
LABEL_15:
    sub_1D0F314(v4);
  ...
  *(_QWORD *)(v3 + 88) = StringLiteral_810/*","*/;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)(v3 + 88), v57, v51, v52, v53, v54, v55, v56);
  return System_String__Concat_65603304((System_String_array *)v3, 0);
}
