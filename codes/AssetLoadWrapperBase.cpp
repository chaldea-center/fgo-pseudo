void __fastcall AssetLoadWrapperBase___ctor(AssetLoadWrapperBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A07D8C & 1) == 0 )
  {
    sub_1B686D4(&AssetPathLoadCounter_TypeInfo, method);
    byte_4A07D8C = 1;
  }
  v3 = (AssetPathLoadCounter_o *)sub_1B68920(AssetPathLoadCounter_TypeInfo);
  AssetPathLoadCounter___ctor(v3, v4);
  this->fields.pathCounter = v3;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)v3, v5, v6);
...
void __fastcall AssetLoadWrapperBase__ReleaseAll(AssetLoadWrapperBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A07D8B & 1) == 0 )
  {
    ...
    sub_1B686D4(&System_Collections_Generic_IEnumerator_KeyValuePair_string__int___TypeInfo, v3);
    sub_1B686D4(&System_Collections_IEnumerator_TypeInfo, v4);
    sub_1B686D4(&Method_System_Collections_Generic_KeyValuePair_string__int__get_Key__, v5);
    sub_1B686D4(&Method_System_Collections_Generic_KeyValuePair_string__int__get_Value__, v6);
    byte_4A07D8B = 1;
  }
  pathCounter = this->fields.pathCounter;
  if ( !pathCounter )
...
LABEL_9:
    ...
    {
LABEL_16:
      v17 = sub_1BBA6B4(Enumerator, System_Collections_Generic_IEnumerator_KeyValuePair_string__int___TypeInfo, 0LL);
    }
...
LABEL_26:
  ...
  if ( !pathCounter )
LABEL_30:
    sub_1B68930(pathCounter, method);
