void AssetLoadWrapperBase___ctor(AssetLoadWrapperBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2F9F7 & 1) == 0 )
  {
    sub_1C93AD4(&AssetPathLoadCounter_TypeInfo);
    byte_4D2F9F7 = 1;
  }
  v3 = (AssetPathLoadCounter_o *)sub_1C93D20(AssetPathLoadCounter_TypeInfo);
...
void AssetLoadWrapperBase__ReleaseAll(AssetLoadWrapperBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2F9F6 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&System_Collections_Generic_IEnumerator_KeyValuePair_string__int___TypeInfo);
...
LABEL_9:
    ...
    {
LABEL_16:
      v13 = sub_1C69E5C(Enumerator, System_Collections_Generic_IEnumerator_KeyValuePair_string__int___TypeInfo, 0);
    }
...
LABEL_26:
  ...
  if ( !pathCounter )
LABEL_30:
    sub_1C93D2C(pathCounter, method);
