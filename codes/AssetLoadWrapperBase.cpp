void __fastcall AssetLoadWrapperBase___ctor(AssetLoadWrapperBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1EBF4 & 1) == 0 )
  {
    sub_1B715CC(&AssetPathLoadCounter_TypeInfo, method);
    byte_4A1EBF4 = 1;
  }
  v3 = (AssetPathLoadCounter_o *)sub_1B71818(AssetPathLoadCounter_TypeInfo);
...
void __fastcall AssetLoadWrapperBase__ReleaseAll(AssetLoadWrapperBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1EBF3 & 1) == 0 )
  {
    ...
    sub_1B715CC(&System_Collections_Generic_IEnumerator_KeyValuePair_string__int___TypeInfo, v3);
    sub_1B715CC(&System_Collections_IEnumerator_TypeInfo, v4);
    sub_1B715CC(&Method_System_Collections_Generic_KeyValuePair_string__int__get_Key__, v5);
    sub_1B715CC(&Method_System_Collections_Generic_KeyValuePair_string__int__get_Value__, v6);
    byte_4A1EBF3 = 1;
  }
  pathCounter = this->fields.pathCounter;
  if ( !pathCounter )
...
LABEL_9:
    ...
    {
LABEL_16:
      v17 = sub_1BC35AC(Enumerator, System_Collections_Generic_IEnumerator_KeyValuePair_string__int___TypeInfo, 0LL);
    }
...
LABEL_26:
  ...
  if ( !pathCounter )
LABEL_30:
    sub_1B71828(pathCounter, method);
