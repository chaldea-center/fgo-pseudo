void __fastcall AssetLoadWrapperBase___ctor(AssetLoadWrapperBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E1983 & 1) == 0 )
  {
    sub_1B00CCC(&AssetPathLoadCounter_TypeInfo, method);
    byte_48E1983 = 1;
  }
  v3 = (AssetPathLoadCounter_o *)sub_1B00F18(AssetPathLoadCounter_TypeInfo);
...
void __fastcall AssetLoadWrapperBase__ReleaseAll(AssetLoadWrapperBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E1982 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&System_Collections_Generic_IEnumerator_KeyValuePair_string__int___TypeInfo, v3);
    sub_1B00CCC(&System_Collections_IEnumerator_TypeInfo, v4);
    sub_1B00CCC(&Method_System_Collections_Generic_KeyValuePair_string__int__get_Key__, v5);
    sub_1B00CCC(&Method_System_Collections_Generic_KeyValuePair_string__int__get_Value__, v6);
    byte_48E1982 = 1;
  }
  pathCounter = this->fields.pathCounter;
  if ( !pathCounter )
...
LABEL_9:
    ...
    {
LABEL_16:
      v17 = sub_1B52CAC(Enumerator, System_Collections_Generic_IEnumerator_KeyValuePair_string__int___TypeInfo, 0LL);
    }
...
LABEL_26:
  ...
  if ( !pathCounter )
LABEL_30:
    sub_1B00F28(pathCounter, method);
