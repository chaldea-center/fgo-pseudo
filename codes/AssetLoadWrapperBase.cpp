void __fastcall AssetLoadWrapperBase___ctor(AssetLoadWrapperBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B65C99 & 1) == 0 )
  {
    sub_1BE4ACC(&AssetPathLoadCounter_TypeInfo, method);
    byte_4B65C99 = 1;
  }
  v3 = (AssetPathLoadCounter_o *)sub_1BE4D18(AssetPathLoadCounter_TypeInfo);
  AssetPathLoadCounter___ctor(v3, v4);
  this->fields.pathCounter = v3;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields, (int64_t)v3, v5, v6, v7, v8, v9, v10);
...
void __fastcall AssetLoadWrapperBase__ReleaseAll(AssetLoadWrapperBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B65C98 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&System_Collections_Generic_IEnumerator_KeyValuePair_string__int___TypeInfo, v3);
    sub_1BE4ACC(&System_Collections_IEnumerator_TypeInfo, v4);
    sub_1BE4ACC(&Method_System_Collections_Generic_KeyValuePair_string__int__get_Key__, v5);
    sub_1BE4ACC(&Method_System_Collections_Generic_KeyValuePair_string__int__get_Value__, v6);
    byte_4B65C98 = 1;
  }
  pathCounter = this->fields.pathCounter;
  if ( !pathCounter )
...
LABEL_9:
    ...
    {
LABEL_16:
      v17 = sub_1C36AAC(Enumerator, System_Collections_Generic_IEnumerator_KeyValuePair_string__int___TypeInfo, 0LL);
    }
...
LABEL_26:
  ...
  if ( !pathCounter )
LABEL_30:
    sub_1BE4D28(pathCounter, method);
