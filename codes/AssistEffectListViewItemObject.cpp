...
void AssistEffectListViewItemObject__Awake(AssistEffectListViewItemObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C31769 & 1) == 0 )
  {
    sub_1C32C20(&Method_UnityEngine_GameObject_GetComponent_AssistEffectListViewItemDraw___);
    byte_4C31769 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_3134970 *)Method_UnityEngine_GameObject_GetComponent_AssistEffectListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3176A & 1) == 0 )
  {
    sub_1C32C20(&AssistEffectListViewItem_TypeInfo);
    byte_4C3176A = 1;
  }
...
LABEL_9:
  ...
  if ( item )
  {
    ...
    {
      itemDraw = (AssistEffectListViewItemDraw_o *)sub_1C3313C(item);
      goto LABEL_9;
    }
  }
