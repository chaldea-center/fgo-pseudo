...
void AssistEffectListViewItemObject__Awake(AssistEffectListViewItemObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E71016 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_UnityEngine_GameObject_GetComponent_AssistEffectListViewItemDraw___);
    byte_4E71016 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_32A8444 *)Method_UnityEngine_GameObject_GetComponent_AssistEffectListViewItemDraw___);
...
LABEL_9:
  ...
  if ( item )
  {
    ...
    {
      itemDraw = (AssistEffectListViewItemDraw_o *)sub_1D0F6A8(item);
      goto LABEL_9;
    }
  }
