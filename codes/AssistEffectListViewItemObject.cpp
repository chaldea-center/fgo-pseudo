...
void AssistEffectListViewItemObject__Awake(AssistEffectListViewItemObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C50A39 & 1) == 0 )
  {
    sub_1C3E564(&Method_UnityEngine_GameObject_GetComponent_AssistEffectListViewItemDraw___);
    byte_4C50A39 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_31510CC *)Method_UnityEngine_GameObject_GetComponent_AssistEffectListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C50A3A & 1) == 0 )
  {
    sub_1C3E564(&AssistEffectListViewItem_TypeInfo);
    byte_4C50A3A = 1;
  }
...
LABEL_9:
  ...
  if ( item )
  {
    ...
    {
      itemDraw = (AssistEffectListViewItemDraw_o *)sub_1C3EA80(item);
      goto LABEL_9;
    }
  }
