        ...
        const MethodInfo *method)
{
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)p_conditionTypes, (int32_t)v4, v6, v7);
  *((_DWORD *)p_conditionTypes + 2) = 0;
}


void __fastcall WarBoardActionTrendConditionEntity___ctor_40135992(
        WarBoardActionTrendConditionEntity_o *this,
        ...
        const MethodInfo *method)
{
  ...
  p_conditionTypes = &this->fields.conditionTypes;
  sub_1B76164((ServantStatusBattleListViewItem_o *)p_conditionTypes, (int32_t)conditionTypes, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EE8B & 1) == 0 )
  {
    sub_1B761C0(&Method_System_Array_Sort_int_____, method);
    sub_1B761C0(&Method_System_Array_Sort_int___, v4);
    sub_1B761C0(&System_Comparison_int____TypeInfo, v5);
    sub_1B761C0(&Method_WarBoardActionTrendConditionEntity__GetSortedMultiIndividuality_g__DoubleIntSort_13_0__, v6);
    byte_4A2EE8B = 1;
  }
  resValues = 0LL;
  if ( WarBoardActionTrendConditionEntity__TryGetMultiIndividuality(this, &resValues, v2) )
  {
    ...
    v8 = (System_Comparison_T__o *)sub_1B7640C(System_Comparison_int____TypeInfo);
    System_Comparison_object____ctor(
      v8,
      0LL,
      Method_WarBoardActionTrendConditionEntity__GetSortedMultiIndividuality_g__DoubleIntSort_13_0__,
      0LL);
    System_Array__Sort_object__48432360(v7, v8, (const MethodInfo_2E304E8 *)Method_System_Array_Sort_int_____);
    v11 = resValues;
    if ( !resValues )
      sub_1B7641C(v9, v10);
    ...
    if ( (int)v12 >= 1 )
    {
      ...
      do
      {
        if ( v13 >= (unsigned int)v12 )
          sub_1B76424(v9, v10);
        System_Array__Sort_int_(v11->m_Items[v13], (const MethodInfo_2E30204 *)Method_System_Array_Sort_int___);
        ...
        const MethodInfo *method)
{
  if ( (byte_4A2EE8E & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_7459/*"IgnoreIndivUnreleaseable"*/, method);
    byte_4A2EE8E = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_7459/*"IgnoreIndivUnreleaseable"*/, 0, 0LL) != 0;
}
        ...
        const MethodInfo *method)
{
  ...
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_7524/*"IncludeIgnoreIndividuality"*/, 0, 0LL) != 0;
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4A2EE8C & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_7525/*"IncludePassiveIndividuality"*/, method);
    byte_4A2EE8C = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_7525/*"IncludePassiveIndividuality"*/, 0, 0LL) != 0;
}
