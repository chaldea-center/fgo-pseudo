        ...
        const MethodInfo *method)
{
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)p_conditionTypes, (int32_t)v4, v6, v7);
  *((_DWORD *)p_conditionTypes + 2) = 0;
}


void __fastcall WarBoardActionTrendConditionEntity___ctor_40712840(
        WarBoardActionTrendConditionEntity_o *this,
        ...
        const MethodInfo *method)
{
  ...
  p_conditionTypes = &this->fields.conditionTypes;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)p_conditionTypes, (int32_t)conditionTypes, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB6CBE & 1) == 0 )
  {
    sub_1BAB41C(&Method_System_Array_Sort_int_____, method);
    sub_1BAB41C(&Method_System_Array_Sort_int___, v4);
    sub_1BAB41C(&System_Comparison_int____TypeInfo, v5);
    sub_1BAB41C(&Method_WarBoardActionTrendConditionEntity__GetSortedMultiIndividuality_g__DoubleIntSort_13_0__, v6);
    byte_4AB6CBE = 1;
  }
  resValues = 0LL;
  if ( WarBoardActionTrendConditionEntity__TryGetMultiIndividuality(this, &resValues, v2) )
  {
    ...
    v8 = (System_Comparison_T__o *)sub_1BAB668(System_Comparison_int____TypeInfo);
    System_Comparison_object____ctor(
      v8,
      0LL,
      Method_WarBoardActionTrendConditionEntity__GetSortedMultiIndividuality_g__DoubleIntSort_13_0__,
      0LL);
    System_Array__Sort_object__48833124(v7, v8, (const MethodInfo_2E92264 *)Method_System_Array_Sort_int_____);
    v11 = resValues;
    if ( !resValues )
      sub_1BAB678(v9, v10);
    ...
    if ( (int)v12 >= 1 )
    {
      ...
      do
      {
        if ( v13 >= (unsigned int)v12 )
          sub_1BAB680(v9, v10);
        System_Array__Sort_int_(v11->m_Items[v13], (const MethodInfo_2E91F80 *)Method_System_Array_Sort_int___);
        ...
        const MethodInfo *method)
{
  if ( (byte_4AB6CC1 & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_7464/*"IgnoreIndivUnreleaseable"*/, method);
    byte_4AB6CC1 = 1;
  }
        ...
        const MethodInfo *method)
{
  if ( (byte_4AB6CBF & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_7530/*"IncludePassiveIndividuality"*/, method);
    byte_4AB6CBF = 1;
  }
