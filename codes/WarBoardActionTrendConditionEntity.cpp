        ...
        const MethodInfo *method)
{
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)p_conditionTypes, (int32_t)v4, v6, v7);
  *((_DWORD *)p_conditionTypes + 2) = 0;
}


void __fastcall WarBoardActionTrendConditionEntity___ctor_42269760(
        WarBoardActionTrendConditionEntity_o *this,
        ...
        const MethodInfo *method)
{
  ...
  p_conditionTypes = &this->fields.conditionTypes;
  sub_1BC2FAC((CGThumbnailListItem_o *)p_conditionTypes, (int32_t)conditionTypes, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B030ED & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Array_Sort_int_____, method);
    sub_1BC3008(&Method_System_Array_Sort_int___, v4);
    sub_1BC3008(&System_Comparison_int____TypeInfo, v5);
    sub_1BC3008(&Method_WarBoardActionTrendConditionEntity__GetSortedMultiIndividuality_g__DoubleIntSort_13_0__, v6);
    byte_4B030ED = 1;
  }
  resValues = 0LL;
  if ( WarBoardActionTrendConditionEntity__TryGetMultiIndividuality(this, &resValues, v2) )
  {
    ...
    v8 = (System_Comparison_T__o *)sub_1BC3254(System_Comparison_int____TypeInfo);
    System_Comparison_object____ctor(
      v8,
      0LL,
      Method_WarBoardActionTrendConditionEntity__GetSortedMultiIndividuality_g__DoubleIntSort_13_0__,
      0LL);
    System_Array__Sort_object__50130684(v7, v8, (const MethodInfo_2FCEEFC *)Method_System_Array_Sort_int_____);
    v12 = resValues;
    if ( !resValues )
      sub_1BC3264(v9, v10);
    ...
    if ( (int)v13 >= 1 )
    {
      ...
      do
      {
        ...
        System_Array__Sort_int_(v12->m_Items[v14], (const MethodInfo_2FCEC18 *)Method_System_Array_Sort_int___);
        ...
        const MethodInfo *method)
{
  if ( (byte_4B030F0 & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_7473/*"IgnoreIndivUnreleaseable"*/, method);
    byte_4B030F0 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_7473/*"IgnoreIndivUnreleaseable"*/, 0, 0LL) != 0;
}
        ...
        const MethodInfo *method)
{
  ...
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_7505/*"IncludeIgnoreIndividuality"*/, 0, 0LL) != 0;
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4B030EE & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_7506/*"IncludePassiveIndividuality"*/, method);
    byte_4B030EE = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_7506/*"IncludePassiveIndividuality"*/, 0, 0LL) != 0;
}
