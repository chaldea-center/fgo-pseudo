        ...
        const MethodInfo *method)
{
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)p_conditionTypes, (int32_t)v4, v6, v7);
  *((_DWORD *)p_conditionTypes + 2) = 0;
}


void __fastcall WarBoardActionTrendConditionEntity___ctor_39988740(
        WarBoardActionTrendConditionEntity_o *this,
        ...
        const MethodInfo *method)
{
  ...
  p_conditionTypes = &this->fields.conditionTypes;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)p_conditionTypes, (int32_t)conditionTypes, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD342 & 1) == 0 )
  {
    sub_1B640C8(&Method_System_Array_Sort_int_____, method);
    sub_1B640C8(&Method_System_Array_Sort_int___, v4);
    sub_1B640C8(&System_Comparison_int____TypeInfo, v5);
    sub_1B640C8(&Method_WarBoardActionTrendConditionEntity__GetSortedMultiIndividuality_g__DoubleIntSort_13_0__, v6);
    byte_49FD342 = 1;
  }
  resValues = 0LL;
  if ( WarBoardActionTrendConditionEntity__TryGetMultiIndividuality(this, &resValues, v2) )
  {
    v9 = (System_Object_array *)resValues;
    v10 = (System_Comparison_T__o *)sub_1B64314(System_Comparison_int____TypeInfo, v7, v8);
    System_Comparison_object____ctor(
      v10,
      0LL,
      Method_WarBoardActionTrendConditionEntity__GetSortedMultiIndividuality_g__DoubleIntSort_13_0__,
      0LL);
    System_Array__Sort_object__48264584(v9, v10, (const MethodInfo_2E07588 *)Method_System_Array_Sort_int_____);
    v13 = resValues;
    if ( !resValues )
      sub_1B64324(v11);
    ...
    if ( (int)v14 >= 1 )
    {
      ...
      do
      {
        if ( v15 >= (unsigned int)v14 )
          sub_1B6432C(v11, v12);
        System_Array__Sort_int_(v13->m_Items[v15], (const MethodInfo_2E072A4 *)Method_System_Array_Sort_int___);
        ...
        const MethodInfo *method)
{
  if ( (byte_49FD345 & 1) == 0 )
  {
    sub_1B640C8(&StringLiteral_7429/*"IgnoreIndivUnreleaseable"*/, method);
    byte_49FD345 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_7429/*"IgnoreIndivUnreleaseable"*/, 0, 0LL) != 0;
}
        ...
        const MethodInfo *method)
{
  ...
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_7491/*"IncludeIgnoreIndividuality"*/, 0, 0LL) != 0;
}
        ...
        const MethodInfo *method)
{
  if ( (byte_49FD343 & 1) == 0 )
  {
    sub_1B640C8(&StringLiteral_7492/*"IncludePassiveIndividuality"*/, method);
    byte_49FD343 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_7492/*"IncludePassiveIndividuality"*/, 0, 0LL) != 0;
}
