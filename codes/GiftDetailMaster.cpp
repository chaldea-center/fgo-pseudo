void GiftDetailMaster___ctor(GiftDetailMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4CEEA98 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_DataMasterBase_GiftDetailMaster__GiftDetailEntity__int___ctor__);
    byte_4CEEA98 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    427,
    (const MethodInfo_342BFD8 *)Method_DataMasterBase_GiftDetailMaster__GiftDetailEntity__int___ctor__);
}
