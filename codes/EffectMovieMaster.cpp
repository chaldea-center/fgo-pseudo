void EffectMovieMaster___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C42E20 & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_5910/*"Effect/weapon/{0}/usm/"*/);
    sub_1C37058(&StringLiteral_5852/*"Effect/BattleCommon/usm/"*/);
    sub_1C37058(&StringLiteral_5913/*"Effect/weapon/{0}/{1}/usm/"*/);
    sub_1C37058(&StringLiteral_9518/*"NoblePhantasm/{0}/usm/"*/);
    byte_4C42E20 = 1;
  }
  EffectMovieMaster_TypeInfo->static_fields->NOBLE_PATH = (struct System_String_o *)StringLiteral_9518/*"NoblePhantasm/{0}/usm/"*/;
  sub_1C36FFC((CGThumbnailListItem_o *)EffectMovieMaster_TypeInfo->static_fields, StringLiteral_9518/*"NoblePhantasm/{0}/usm/"*/, v1, v2);
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&static_fields->WEAPON_PATH, v3, v5, v6);
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&v8->WEAPON_SUB_PATH, v7, v9, v10);
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&v12->BATTLECOMMON_PATH, v11, v13, v14);
}
...
void EffectMovieMaster___ctor(EffectMovieMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4C42E1F & 1) == 0 )
  {
    sub_1C37058(&Method_DataMasterBase_EffectMovieMaster__EffectMovieEntity__int___ctor__);
    byte_4C42E1F = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    514,
    (const MethodInfo_339ED7C *)Method_DataMasterBase_EffectMovieMaster__EffectMovieEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C42E1E & 1) == 0 )
  {
    sub_1C37058(&Method_DataMasterBase_EffectMovieMaster__EffectMovieEntity__int__GetEntity__);
            ...
            (const MethodInfo_35299F8 *)Method_System_Collections_Generic_List_Enumerator_int__MoveNext__) )
  {
    ...
    Entity = DataMasterBase_object__object__int___GetEntity(
               (DataMasterBase_TMaster__TEntity__PKType__o *)this,
               v20.fields._current,
               (const MethodInfo_33A10A0 *)Method_DataMasterBase_EffectMovieMaster__EffectMovieEntity__int__GetEntity__);
    if ( !Entity )
      sub_1C372B4(0);
    FilePath = (Il2CppObject *)EffectMovieEntity__GetFilePath((EffectMovieEntity_o *)Entity, current, 0, v9);
    v13 = FilePath;
    if ( !v5 )
      sub_1C372B4(FilePath);
