...
System_String_o *__fastcall StorageTakeoutRequest__getURL(StorageTakeoutRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_40F7C0D & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_22242/*"storage/takeout"*/, v2);
    byte_40F7C0D = 1;
  }
  ...
  return System_String__Concat_43743732(BaseUrl, (System_String_o *)StringLiteral_22242/*"storage/takeout"*/, 0LL);
}
