...
System_String_o *__fastcall StorageTakeoutRequest__getURL(StorageTakeoutRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42E7B05 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&StringLiteral_22637/*"storage/takeout"*/, v4, v5, v6);
    byte_42E7B05 = 1;
  }
  ...
  return System_String__Concat_44577788(BaseUrl, (System_String_o *)StringLiteral_22637/*"storage/takeout"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v12 = ResponseCommandKind__SearchData(59, responseList, 0LL);
  if ( v12
