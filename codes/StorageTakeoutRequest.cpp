...
System_String_o *__fastcall StorageTakeoutRequest__getURL(StorageTakeoutRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42135C2 & 1) == 0 )
  {
    ...
    sub_B0D8A4(&StringLiteral_22410/*"storage/takeout"*/, v2);
    byte_42135C2 = 1;
  }
  ...
  return System_String__Concat_43849904(BaseUrl, (System_String_o *)StringLiteral_22410/*"storage/takeout"*/, 0LL);
}
