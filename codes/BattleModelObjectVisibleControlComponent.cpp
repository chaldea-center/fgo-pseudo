        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A5A9 & 1) == 0 )
  {
    sub_1B885B0(&System_Action_BattleModelObjectVisibleControlComponent_ServantObjVisibleCtrCompStruct__TypeInfo);
    sub_1B885B0(&Method_BasicHelper_ForEach_BattleModelObjectVisibleControlComponent_ServantObjVisibleCtrCompStruct___);
    sub_1B885B0(&Method_BattleModelObjectVisibleControlComponent___c__Awake_b__5_0__);
    sub_1B885B0(&BattleModelObjectVisibleControlComponent___c_TypeInfo);
    byte_4A5A5A9 = 1;
  }
  ...
  if ( !_9__5_0 )
  {
    ...
    _9__5_0 = (System_Action_object__o *)sub_1B887FC(System_Action_BattleModelObjectVisibleControlComponent_ServantObjVisibleCtrCompStruct__TypeInfo);
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)&static_fields->__9__5_0, (int32_t)_9__5_0, v8, v9);
  }
  BasicHelper__ForEach_object_(
    visibleChangeObjects,
    (System_Action_T__o *)_9__5_0,
    (const MethodInfo_2E6CCC0 *)Method_BasicHelper_ForEach_BattleModelObjectVisibleControlComponent_ServantObjVisibleCtrCompStruct___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A5AB & 1) == 0 )
  {
    sub_1B885B0(&System_Action_BattleModelObjectVisibleControlComponent_ServantObjVisibleCtrCompStruct__TypeInfo);
    sub_1B885B0(&Method_BasicHelper_ForEach_BattleModelObjectVisibleControlComponent_ServantObjVisibleCtrCompStruct___);
    this = (BattleModelObjectVisibleControlComponent_o *)sub_1B885B0(&Method_BattleModelObjectVisibleControlComponent__EndProc_b__8_0__);
    byte_4A5A5AB = 1;
  }
  ...
  if ( !visibleChangeObjects[1].monitor || v4->fields.executeTiming != timing )
    return 0;
  v6 = (System_Action_object__o *)sub_1B887FC(System_Action_BattleModelObjectVisibleControlComponent_ServantObjVisibleCtrCompStruct__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A5AA & 1) == 0 )
  {
    sub_1B885B0(&System_Action_BattleModelObjectVisibleControlComponent_ServantObjVisibleCtrCompStruct__TypeInfo);
    sub_1B885B0(&Method_BasicHelper_ForEach_BattleModelObjectVisibleControlComponent_ServantObjVisibleCtrCompStruct___);
    this = (BattleModelObjectVisibleControlComponent_o *)sub_1B885B0(&Method_BattleModelObjectVisibleControlComponent__ExecuteProc_b__7_0__);
    byte_4A5A5AA = 1;
  }
  visibleChangeObjects = (System_Collections_Generic_IEnumerable_T__o *)v4->fields.visibleChangeObjects;
  if ( !visibleChangeObjects )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A5AC & 1) == 0 )
  {
    sub_1B885B0(&System_Action_BattleModelObjectVisibleControlComponent_ServantObjVisibleCtrCompStruct__TypeInfo);
    sub_1B885B0(&Method_BasicHelper_ForEach_BattleModelObjectVisibleControlComponent_ServantObjVisibleCtrCompStruct___);
    sub_1B885B0(&Method_BattleModelObjectVisibleControlComponent___c__DisplayClass9_0__IsSkinnedMesh_b__0__);
    sub_1B885B0(&BattleModelObjectVisibleControlComponent___c__DisplayClass9_0_TypeInfo);
    byte_4A5A5AC = 1;
  }
  v3 = sub_1B887FC(BattleModelObjectVisibleControlComponent___c__DisplayClass9_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v3, 0LL);
  if ( !v3 )
    sub_1B8880C(v4, v5);
  *(_BYTE *)(v3 + 16) = 0;
  visibleChangeObjects = (System_Collections_Generic_IEnumerable_T__o *)this->fields.visibleChangeObjects;
  v7 = (System_Action_object__o *)sub_1B887FC(System_Action_BattleModelObjectVisibleControlComponent_ServantObjVisibleCtrCompStruct__TypeInfo);
  System_Action_object____ctor(
    v7,
    (Il2CppObject *)v3,
        ...
        const MethodInfo *method)
{
  ...
  v3 = (System_Collections_Generic_List_object__o *)sub_1B887FC(System_Collections_Generic_List_SkinnedMeshRenderer__TypeInfo);
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.skinnedMeshList, (int32_t)v3, v4, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A5AD & 1) == 0 )
  {
    sub_1B885B0(&Method_UnityEngine_GameObject_GetComponentInChildren_SkinnedMeshRenderer___);
  ...
  if ( !UnityEngine_Object__op_Equality(gameObject, 0LL, 0LL) )
  {
    ...
    if ( skinnedMeshList )
    {
      ComponentInChildren_object = UnityEngine_GameObject__GetComponentInChildren_object_(
                                     skinnedMeshList,
                                     (const MethodInfo_2ECF11C *)Method_UnityEngine_GameObject_GetComponentInChildren_SkinnedMeshRenderer___);
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      ...
      if ( skinnedMeshList )
      {
        v9 = *(_QWORD *)&skinnedMeshList->fields.m_CachedPtr;
        ...
        if ( v9 )
        {
          ...
          if ( (unsigned int)klass_low >= *(_DWORD *)(v9 + 24) )
          {
          ...
          else
          {
            ...
            *(_QWORD *)(v12 + 32) = ComponentInChildren_object;
            sub_1B88554((ServantStatusBattleListViewItem_o *)(v12 + 32), (int32_t)ComponentInChildren_object, v7, v8);
          }
          return;
        }
      }
    }
    sub_1B8880C(skinnedMeshList, v4);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A5AF & 1) == 0 )
  {
    this = (BattleModelObjectVisibleControlComponent_ServantObjVisibleCtrCompStruct_o *)sub_1B885B0(&Method_System_Collections_Generic_List_SkinnedMeshRenderer__get_Count__);
    byte_4A5A5AF = 1;
  }
...
void __fastcall BattleModelObjectVisibleControlComponent___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1B887FC(BattleModelObjectVisibleControlComponent___c_TypeInfo);
