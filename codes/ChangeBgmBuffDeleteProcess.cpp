        ...
        const MethodInfo *method)
{
  ...
  v7 = (BattleFieldEnvironmentData_o *)sub_1D0F15C(BattleBuffData_BuffData___TypeInfo, 1);
  if ( !v7 )
    goto LABEL_10;
  v15 = v7;
  if ( buff )
  {
    v7 = (BattleFieldEnvironmentData_o *)sub_1D0F1F0(buff, v7->klass->_1.element_class);
    if ( !v7 )
    {
      v17 = sub_1D0F330(0);
      sub_1D0F1DC(v17, 0);
