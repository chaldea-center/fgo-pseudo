        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB6DD5 & 1) == 0 )
  {
    sub_1C13D24(&BattleBuffData_BuffData___TypeInfo, buff);
    byte_4BB6DD5 = 1;
  }
  FieldEnvData_k__BackingField = this->fields._FieldEnvData_k__BackingField;
  v7 = (BattleFieldEnvironmentData_o *)sub_1C13DCC(BattleBuffData_BuffData___TypeInfo, 1LL);
  if ( !v7 )
    goto LABEL_10;
  v15 = v7;
  if ( buff )
  {
    v7 = (BattleFieldEnvironmentData_o *)sub_1C13E60(buff, v7->klass->_1.element_class);
    if ( !v7 )
    {
      v17 = sub_1C13FA4(0LL);
      sub_1C13E4C(v17, 0LL);
