        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6928E & 1) == 0 )
  {
    sub_1BE4ACC(&BattleBuffData_BuffData___TypeInfo, buff);
    byte_4B6928E = 1;
  }
  FieldEnvData_k__BackingField = this->fields._FieldEnvData_k__BackingField;
  v7 = (BattleFieldEnvironmentData_o *)sub_1BE4B74(BattleBuffData_BuffData___TypeInfo, 1LL);
  if ( !v7 )
    goto LABEL_10;
  v15 = v7;
  if ( buff )
  {
    v7 = (BattleFieldEnvironmentData_o *)sub_1BE4C08(buff, v7->klass->_1.element_class);
    if ( !v7 )
    {
      v17 = sub_1BE4D4C(0LL);
      sub_1BE4BF4(v17, 0LL);
