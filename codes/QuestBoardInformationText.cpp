void __fastcall QuestBoardInformationText___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B41775 & 1) == 0 )
  {
    sub_1BDB878(&QuestBoardInformationText_TypeInfo, v1);
    sub_1BDB878(&StringLiteral_17703/*"caldeagate_notice_{0:00}"*/, v4);
    byte_4B41775 = 1;
  }
  QuestBoardInformationText_TypeInfo->static_fields->QUEST_BOARD_INFO_FRAME_NAME = (struct System_String_o *)StringLiteral_17703/*"caldeagate_notice_{0:00}"*/;
  sub_1BDB81C((CGThumbnailListItem_o *)QuestBoardInformationText_TypeInfo->static_fields, StringLiteral_17703/*"caldeagate_notice_{0:00}"*/, v2, v3);
  ...
  *(_QWORD *)&v8->INFO_FRAME_SIDE_SIZE = 0x1200000050LL;
  v8->CAMPAIGN_TOP_COLOR = (struct UnityEngine_Color_o)xmmword_BEA6A0;
  v8->INFO_LABEL_BASE_WIDTH = 355;
  v5->static_fields->CAMPAIGN_BOTTOM_COLOR = (struct UnityEngine_Color_o)xmmword_BEA9A0;
  __asm { FMOV            V0.4S, #1.0 }
  v5->static_fields->NORMAL_TOP_COLOR = _Q0;
  v5->static_fields->NORMAL_BOTTOM_COLOR = (struct UnityEngine_Color_o)xmmword_BEACB0;
        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.dispText, (int32_t)dispText, v13, v14);
  this->fields.dispTextExtend = dispTextExtend;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.dispTextExtend, (int32_t)dispTextExtend, v15, v16);
...
void __fastcall QuestBoardInformationText___ctor_35474892(
        QuestBoardInformationText_o *this,
        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.dispText, (int32_t)inDispText, v13, v14);
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.timeDataList, (int32_t)TimeDataList, v18, v19);
...
void __fastcall QuestBoardInformationText___ctor_35475808(
        QuestBoardInformationText_o *this,
        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields, (int32_t)boardMessageEntity, v13, v14);
  this->fields.dispText = dispText;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.dispText, (int32_t)dispText, v15, v16);
  this->fields.time = time;
  this->fields.isCampaign = 0;
  this->fields.eventCampaignEnt = eventCampaignEnt;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.eventCampaignEnt, (int32_t)eventCampaignEnt, v17, v18);
...
void __fastcall QuestBoardInformationText___ctor_35475976(
        QuestBoardInformationText_o *this,
        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.eventEntity, (int32_t)eventEntity, v13, v14);
  this->fields.dispText = dispText;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.dispText, (int32_t)dispText, v15, v16);
  this->fields.time = time;
  this->fields.isCampaign = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4176D & 1) == 0 )
  {
    ...
    this = (QuestBoardInformationText_o *)sub_1BDB878(&StringLiteral_1/*""*/, v7);
    byte_4B4176D = 1;
  }
  ...
  if ( !eventCampaignEnt )
  {
    ...
    v42 = sub_1BDB920(object___TypeInfo, 1LL);
    time = v3->fields.time;
    v44 = v42;
    ...
    if ( !v44 )
      goto LABEL_39;
    v46 = RestTime2;
    if ( !RestTime2 || (RestTime2 = sub_1BDB9B4(RestTime2, *(_QWORD *)(*(_QWORD *)v44 + 64LL))) != 0 )
    {
      if ( *(_DWORD *)(v44 + 24) )
      {
        *(_QWORD *)(v44 + 32) = v46;
        sub_1BDB81C((CGThumbnailListItem_o *)(v44 + 32), v46, v18, v45);
        if ( dispTextExtend )
        {
  ...
  *(float *)&v10 = (float)eventCampaignEnt[12] / 1000.0;
  if ( boardMessageEnt && boardMessageEnt->fields.referenceType == 5 )
  {
    ...
    v12 = sub_1BDB920(object___TypeInfo, 1LL);
    v51 = v10;
    RestTime2 = j_il2cpp_value_box_0(float_TypeInfo, &v51, v13, v14, v15);
    if ( !v12 )
      goto LABEL_39;
    v20 = RestTime2;
    if ( !RestTime2 || (RestTime2 = sub_1BDB9B4(RestTime2, *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
    {
      if ( *(_DWORD *)(v12 + 24) )
      {
        *(_QWORD *)(v12 + 32) = v20;
        sub_1BDB81C((CGThumbnailListItem_o *)(v12 + 32), v20, v18, v19);
        if ( v11 )
        {
          v21 = v11;
  ...
  if ( v3->fields.eventEntity && eventCampaignEnt[5] == 26 )
  {
    ...
    if ( (int)RestTime2 < 1 )
    {
      if ( v25 )
      {
        ...
        sub_1BDB81C((CGThumbnailListItem_o *)&v25->fields._BehindText_k__BackingField, v47, v23, v24);
        return;
      }
      goto LABEL_39;
    }
    v26 = RestTime2;
    v27 = sub_1BDB920(object___TypeInfo, 3LL);
    v50 = v10;
    RestTime2 = j_il2cpp_value_box_0(float_TypeInfo, &v50, v28, v29, v30);
    if ( !v27 )
      goto LABEL_39;
    v32 = RestTime2;
    if ( !RestTime2 || (RestTime2 = sub_1BDB9B4(RestTime2, *(_QWORD *)(*(_QWORD *)v27 + 64LL))) != 0 )
    {
      if ( !*(_DWORD *)(v27 + 24) )
        goto LABEL_40;
      *(_QWORD *)(v27 + 32) = v32;
      sub_1BDB81C((CGThumbnailListItem_o *)(v27 + 32), v32, v18, v31);
      v49 = v26;
      ...
      if ( !RestTime2 || (RestTime2 = sub_1BDB9B4(RestTime2, *(_QWORD *)(*(_QWORD *)v27 + 64LL))) != 0 )
      {
        if ( *(_DWORD *)(v27 + 24) <= 1u )
          goto LABEL_40;
        *(_QWORD *)(v27 + 40) = v37;
        sub_1BDB81C((CGThumbnailListItem_o *)(v27 + 40), v37, v18, v36);
        ...
        if ( !RestTime2 || (RestTime2 = sub_1BDB9B4(RestTime2, *(_QWORD *)(*(_QWORD *)v27 + 64LL))) != 0 )
        {
          ...
          {
            *(_QWORD *)(v27 + 48) = v40;
            sub_1BDB81C((CGThumbnailListItem_o *)(v27 + 48), v40, v18, v39);
            if ( v25 )
            {
              v21 = v25;
...
LABEL_39:
            sub_1BDBAD4(RestTime2, v17);
          }
LABEL_40:
          sub_1BDBADC(RestTime2, v17, v18);
        }
      }
    }
LABEL_41:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4176C & 1) == 0 )
  {
    sub_1BDB878(&QuestBoardInformationText_TypeInfo, component);
    byte_4B4176C = 1;
  }
  ...
  if ( !v6
    ...
    || (this->fields.isChangedText = System_String__op_Inequality(
        ...
        (behindLabelText = *component) == 0LL) )
  {
    sub_1BDBAD4(behindLabelText, component);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4176E & 1) == 0 )
  {
    sub_1BDB878(&TerminalBoardOptionTextData_TypeInfo, isLeft);
  ...
  if ( !this->fields.dispTextExtend )
  {
    ...
    v7 = (TerminalBoardOptionTextData_o *)sub_1BDBAC4(TerminalBoardOptionTextData_TypeInfo);
    TerminalBoardOptionTextData___ctor(v7, (System_String_o *)StringLiteral_1/*""*/, dispText, 0, isLeft, 0LL);
    this->fields.dispTextExtend = v7;
    sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.dispTextExtend, (int32_t)v7, v8, v9);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B41774 & 1) == 0 )
  {
    sub_1BDB878(&QuestBoardInformationText_TypeInfo, endTime);
    sub_1BDB878(&QuestBoardInformationText_TimeData___TypeInfo, v8);
    sub_1BDB878(&QuestBoardInformationText_TimeData_TypeInfo, v9);
    byte_4B41774 = 1;
  }
  v10 = (QuestBoardInformationText_TimeData_array *)sub_1BDB920(QuestBoardInformationText_TimeData___TypeInfo, 2LL);
  v11 = sub_1BDBAC4(QuestBoardInformationText_TimeData_TypeInfo);
  System_Object___ctor((Il2CppObject *)v11, 0LL);
  if ( !v11 )
    goto LABEL_13;
  *(_QWORD *)(v11 + 24) = defaultColor;
  sub_1BDB81C((CGThumbnailListItem_o *)(v11 + 24), (int32_t)defaultColor, v14, v15);
  if ( !v10 )
    goto LABEL_13;
  v16 = sub_1BDB9B4(v11, v10->obj.klass->_1.element_class);
  if ( !v16 )
    goto LABEL_14;
  if ( !v10->max_length )
    goto LABEL_15;
  v10->m_Items[0] = (QuestBoardInformationText_TimeData_o *)v11;
  sub_1BDB81C((CGThumbnailListItem_o *)v10->m_Items, v11, v18, v19);
  v20 = sub_1BDBAC4(QuestBoardInformationText_TimeData_TypeInfo);
  System_Object___ctor((Il2CppObject *)v20, 0LL);
  if ( !v20 )
LABEL_13:
    sub_1BDBAD4(v12, v13);
  *(_QWORD *)(v20 + 24) = changedColor;
  sub_1BDB81C((CGThumbnailListItem_o *)(v20 + 24), (int32_t)changedColor, v21, v22);
  ...
  *(_QWORD *)(v20 + 16) = endTime - v23->static_fields->CHANGE_START_REMAINING_TIME;
  v16 = sub_1BDB9B4(v20, v10->obj.klass->_1.element_class);
  if ( !v16 )
  {
LABEL_14:
    v26 = sub_1BDBAF8();
...
LABEL_15:
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&v10->m_Items[1], v20, v18, v24);
  return v10;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( v5 >= (unsigned int)v4 )
    sub_1BDBADC(this, nowTime, method);
        ...
        const MethodInfo *method)
{
  ...
  int32_t Value; // w4
  int32_t v17; // w0
  int64_t NextDayTime_40368856; // x0
  uint64_t v19; // x20
  uint64_t v20; // x21
  uint64_t v21; // x20
  uint64_t v22; // x21
  ...
  if ( (byte_4B4176F & 1) == 0 )
  {
    ...
    sub_1BDB878(&System_DateTime_TypeInfo, v4);
    sub_1BDB878(&NetworkManager_TypeInfo, v5);
    sub_1BDB878(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v6);
    sub_1BDB878(&StringLiteral_4995/*"DAILY_DROP_UP_RESET_AT"*/, v7);
    sub_1BDB878(&StringLiteral_4994/*"DAILY_DROP_UP_COUNT"*/, v8);
    byte_4B4176F = 1;
  }
...
LABEL_26:
  ...
  if ( Entity )
  {
    ...
    Value = ConstantMaster__getValue((System_String_o *)StringLiteral_4995/*"DAILY_DROP_UP_RESET_AT"*/, 0LL);
    v30.fields._dateData = (uint64_t)&t1;
    System_DateTime___ctor_63962604(v30, Year, Month, Day, Value, 0, 0, 0LL);
    v17 = ConstantMaster__getValue((System_String_o *)StringLiteral_4995/*"DAILY_DROP_UP_RESET_AT"*/, 0LL);
    NextDayTime_40368856 = NetworkManager__getNextDayTime_40368856(v17, 0LL);
    v19 = NetworkManager__getServerDateTime_40279056(NextDayTime_40368856, 0LL).fields._dateData;
    v20 = NetworkManager__getServerDateTime_40279056(Entity->fields.updatedAt, 0LL).fields._dateData;
...
LABEL_23:
  ...
  v23 = ConstantMaster__getValue((System_String_o *)StringLiteral_4994/*"DAILY_DROP_UP_COUNT"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B41770 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_4995/*"DAILY_DROP_UP_RESET_AT"*/, v4);
    byte_4B41770 = 1;
  }
  Value = ConstantMaster__getValue((System_String_o *)StringLiteral_4995/*"DAILY_DROP_UP_RESET_AT"*/, 0LL);
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  NextDayTime_40368856 = NetworkManager__getNextDayTime_40368856(Value, 0LL);
  time = this->fields.time;
  cctor_finished = LocalizationManager_TypeInfo->_2.cctor_finished;
  if ( time >= NextDayTime_40368856 )
  {
    v9 = NextDayTime_40368856;
    if ( !cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    time = v9;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B41771 & 1) == 0 )
  {
    sub_1BDB878(&AtlasManager_TypeInfo, component);
    sub_1BDB878(&int_TypeInfo, v15);
    sub_1BDB878(&QuestBoardInformationText_TypeInfo, v16);
    byte_4B41771 = 1;
  }
...
LABEL_51:
    sub_1BDBAD4(IsTextEmpty, component);
  }
...
void __fastcall QuestBoardInformationText__SetTime_35477980(
        QuestBoardInformationText_o *this,
        BoardOptionTextWithIconComponent_o **component,
        UISprite_o **frameSprite,
        int64_t checkTime,
