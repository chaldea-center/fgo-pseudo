        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0CFA & 1) == 0 )
  {
    sub_B52984(&SimpleChainableAction___TypeInfo);
    sysActions = (System_Action_Action__array *)sub_B52984(&SimpleChainableAction_TypeInfo);
    byte_42B0CFA = 1;
  }
  if ( !v2 )
LABEL_14:
    sub_B52A5C(sysActions, method);
  v3 = *(_QWORD *)&v2->max_length;
  sysActions = (System_Action_Action__array *)sub_B5299C(SimpleChainableAction___TypeInfo, (unsigned int)v3);
  v4 = sysActions;
  if ( (int)v3 >= 1 )
  {
    v5 = 0LL;
    ...
    do
    {
      if ( v5 >= v2->max_length )
        goto LABEL_13;
      v9 = *m_Items;
      v10 = sub_B52A54(SimpleChainableAction_TypeInfo);
      ChainableActionBase___ctor((ChainableActionBase_o *)v10, 0LL);
      *(_QWORD *)(v10 + 40) = v9;
      sub_B52920((BattleServantConfConponent_o *)(v10 + 40), v9, v11, v12, v13, v14, v15, v16);
      if ( !v4 )
        goto LABEL_14;
      if ( v10 )
      {
        sysActions = (System_Action_Action__array *)sub_B52A44(v10, v4->obj.klass->_1.element_class);
        if ( !sysActions )
        {
          v25 = sub_B52A7C(0LL);
          sub_B52A28(v25, 0LL);
      ...
      {
LABEL_13:
        v24 = sub_B52A88(sysActions);
        sub_B52A28(v24, 0LL);
      }
      v8->klass = (BattleServantConfConponent_c *)v10;
      sub_B52920(v8, (System_Int32_array **)v10, v17, v18, v19, v20, v21, v22);
      ++v5;
      ++m_Items;
...
void __fastcall SimpleChainableAction__ExecuteOnDetail(SimpleChainableAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B0CF9 & 1) == 0 )
  {
    sub_B52984(&Method_ActionExtensions_Call_Action___);
  ...
  ActionExtensions__Call_BlankEarth_QAARotateEarthResponse_(
    sysChainAction,
    v6,
    (const MethodInfo_2D61674 *)Method_ActionExtensions_Call_Action___);
}