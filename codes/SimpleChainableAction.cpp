        ...
        const MethodInfo *method)
{
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.sysChainAction, (int32_t)action, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B20A23 & 1) == 0 )
  {
    sub_1BCAFF8(&SimpleChainableAction___TypeInfo, method);
    sysActions = (System_Action_Action__array *)sub_1BCAFF8(&SimpleChainableAction_TypeInfo, v3);
    byte_4B20A23 = 1;
  }
  if ( !v2 )
LABEL_13:
    sub_1BCB254(sysActions, method);
  v4 = *(_QWORD *)&v2->max_length;
  v5 = sub_1BCB0A0(SimpleChainableAction___TypeInfo, (unsigned int)v4);
  ...
  if ( (int)v4 >= 1 )
  {
    ...
    do
    {
      if ( v9 >= v2->max_length )
        goto LABEL_12;
      v13 = *m_Items;
      v14 = sub_1BCB244(SimpleChainableAction_TypeInfo);
      ChainableActionBase___ctor((ChainableActionBase_o *)v14, v15);
      *(_QWORD *)(v14 + 40) = v13;
      sub_1BCAF9C((CGThumbnailListItem_o *)(v14 + 40), (int32_t)v13, v16, v17);
      if ( !v8 )
        goto LABEL_13;
      v5 = sub_1BCB134(v14, v8->obj.klass->_1.element_class);
      if ( !v5 )
      {
        v20 = sub_1BCB278(0LL);
        sub_1BCB120(v20, 0LL);
...
void __fastcall SimpleChainableAction__ExecuteOnDetail(SimpleChainableAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B20A22 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_ActionExtensions_Call_Action___, method);
  ...
  ActionExtensions__Call_object_(
    sysChainAction,
    (Il2CppObject *)v5,
    (const MethodInfo_2F6A0EC *)Method_ActionExtensions_Call_Action___);
}