        ...
        const MethodInfo *method)
{
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.sysChainAction, (int32_t)action, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CBA858 & 1) == 0 )
  {
    sub_1C6BA08(&SimpleChainableAction___TypeInfo);
    sysActions = (System_Action_Action__array *)sub_1C6BA08(&SimpleChainableAction_TypeInfo);
    byte_4CBA858 = 1;
  }
  if ( !v2 )
LABEL_13:
    sub_1C6BC60(sysActions, method);
  max_length = v2->max_length;
  v4 = sub_1C6BAB0(SimpleChainableAction___TypeInfo, (unsigned int)max_length);
  v5 = (unsigned int *)v4;
  if ( (int)max_length >= 1 )
  {
    v6 = 0;
    ...
    do
    {
      if ( v6 >= LODWORD(v2->max_length) )
        goto LABEL_12;
      v10 = *m_Items;
      v11 = sub_1C6BC54(SimpleChainableAction_TypeInfo);
      ChainableActionBase___ctor((ChainableActionBase_o *)v11, v12);
      *(_QWORD *)(v11 + 40) = v10;
      sub_1C6B9AC((CGThumbnailListItem_o *)(v11 + 40), (int32_t)v10, v13, v14);
      if ( !v5 )
        goto LABEL_13;
      v4 = sub_1C6BB44(v11, *(_QWORD *)(*(_QWORD *)v5 + 64LL));
      if ( !v4 )
      {
        v18 = sub_1C6BC84(0);
        sub_1C6BB30(v18, 0);
...
void SimpleChainableAction__ExecuteOnDetail(SimpleChainableAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CBA857 & 1) == 0 )
  {
    sub_1C6BA08(&Method_ActionExtensions_Call_Action___);
  ...
  ActionExtensions__Call_object_(
    sysChainAction,
    (Il2CppObject *)v4,
    (const MethodInfo_3085F64 *)Method_ActionExtensions_Call_Action___);
}