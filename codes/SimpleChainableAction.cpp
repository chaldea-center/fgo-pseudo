        ...
        const MethodInfo *method)
{
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.sysChainAction, (int32_t)action, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0D47B & 1) == 0 )
  {
    sub_1B686D4(&SimpleChainableAction___TypeInfo, method);
    sysActions = (System_Action_Action__array *)sub_1B686D4(&SimpleChainableAction_TypeInfo, v3);
    byte_4A0D47B = 1;
  }
  if ( !v2 )
LABEL_13:
    sub_1B68930(sysActions, method);
  v4 = *(_QWORD *)&v2->max_length;
  v5 = sub_1B6877C(SimpleChainableAction___TypeInfo, (unsigned int)v4);
  ...
  if ( (int)v4 >= 1 )
  {
    ...
    do
    {
      if ( v8 >= v2->max_length )
        goto LABEL_12;
      v12 = *m_Items;
      v13 = sub_1B68920(SimpleChainableAction_TypeInfo);
      ChainableActionBase___ctor((ChainableActionBase_o *)v13, v14);
      *(_QWORD *)(v13 + 40) = v12;
      sub_1B68678((ServantStatusBattleListViewItem_o *)(v13 + 40), (int32_t)v12, v15, v16);
      if ( !v7 )
        goto LABEL_13;
      v5 = sub_1B68810(v13, v7->obj.klass->_1.element_class);
      if ( !v5 )
      {
        v20 = sub_1B68954(0LL);
        sub_1B687FC(v20, 0LL);
...
void __fastcall SimpleChainableAction__ExecuteOnDetail(SimpleChainableAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0D47A & 1) == 0 )
  {
    sub_1B686D4(&Method_ActionExtensions_Call_Action___, method);
  ...
  ActionExtensions__Call_object_(
    sysChainAction,
    (Il2CppObject *)v5,
    (const MethodInfo_2DA1358 *)Method_ActionExtensions_Call_Action___);
}