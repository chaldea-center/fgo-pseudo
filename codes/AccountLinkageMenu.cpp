...
void AccountLinkageMenu__InitView(AccountLinkageMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC223E & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_1873/*"ACCOUNT_LINKAGE_MENU_MESSAGE"*/);
    sub_1C713B0(&StringLiteral_1874/*"ACCOUNT_LINKAGE_MENU_WARNING"*/);
    byte_4CC223E = 1;
  }
  messageLabel = this->fields.messageLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_1873/*"ACCOUNT_LINKAGE_MENU_MESSAGE"*/, 0);
  if ( !messageLabel
    || (UILabel__set_text(messageLabel, v4, 0),
        warningLabel = this->fields.warningLabel,
        v4 = LocalizationManager__Get((System_String_o *)StringLiteral_1874/*"ACCOUNT_LINKAGE_MENU_WARNING"*/, 0),
        !warningLabel) )
  {
    sub_1C71608(v4, v5);
  }
...
void AccountLinkageMenu__UpdateView(AccountLinkageMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC223F & 1) == 0 )
  {
    ...
    sub_1C713B0(&System_DateTimeOffset_TypeInfo);
    sub_1C713B0(&System_DateTime_TypeInfo);
    sub_1C713B0(&LocalizationManager_TypeInfo);
    sub_1C713B0(&StringLiteral_1864/*"ACCOUNT_LINKAGE_DATE"*/);
    sub_1C713B0(&StringLiteral_1893/*"ACCOUNT_LINKAGE_STATUS_LINKED"*/);
    sub_1C713B0(&StringLiteral_25132/*"yyyy/MM/dd"*/);
    sub_1C713B0(&StringLiteral_858/*"-"*/);
    sub_1C713B0(&StringLiteral_1859/*"ACCOUNT_LINKAGE_BUTTON_LINK"*/);
    sub_1C713B0(&StringLiteral_1858/*"ACCOUNT_LINKAGE_BUTTON_DELINK"*/);
    sub_1C713B0(&StringLiteral_1894/*"ACCOUNT_LINKAGE_STATUS_NOT_LINKED"*/);
    sub_1C713B0(&StringLiteral_1876/*"ACCOUNT_LINKAGE_ON_MAINTENANCE"*/);
    byte_4CC223F = 1;
  }
  entity = 0;
  *(_QWORD *)&v26.fields._offsetMinutes = 0;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  SelfUserAccountLinkage = (uint64_t)LocalizationManager__Get((System_String_o *)StringLiteral_1864/*"ACCOUNT_LINKAGE_DATE"*/, 0);
  if ( !linkageDateLabel )
    goto LABEL_43;
  ...
  if ( (SelfUserAccountLinkage & 1) == 0 )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
LABEL_30:
    SelfUserAccountLinkage = (uint64_t)LocalizationManager__Get((System_String_o *)StringLiteral_1894/*"ACCOUNT_LINKAGE_STATUS_NOT_LINKED"*/, 0);
    ...
    if ( AccountLinkageParams_TypeInfo->static_fields->isAniplexPlusServerError )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v22 = LocalizationManager__Get((System_String_o *)StringLiteral_1876/*"ACCOUNT_LINKAGE_ON_MAINTENANCE"*/, 0);
      v23 = System_String__Concat_64031724(mText, v22, 0);
      UILabel__set_text(v20, v23, 0);
    }
    linkageButtonLabel = this->fields.linkageButtonLabel;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    SelfUserAccountLinkage = (uint64_t)LocalizationManager__Get((System_String_o *)StringLiteral_1859/*"ACCOUNT_LINKAGE_BUTTON_LINK"*/, 0);
    if ( linkageButtonLabel )
    {
      ...
      if ( SelfUserAccountLinkage )
      {
        ...
        if ( v15 )
        {
          ...
          v18 = (System_String_o *)StringLiteral_858/*"-"*/;
          goto LABEL_42;
        }
      }
    }
LABEL_43:
    sub_1C71608(SelfUserAccountLinkage, v5);
  }
  if ( !entity )
    goto LABEL_43;
  ...
  if ( type != 1 )
    goto LABEL_30;
  SelfUserAccountLinkage = (uint64_t)LocalizationManager__Get((System_String_o *)StringLiteral_1893/*"ACCOUNT_LINKAGE_STATUS_LINKED"*/, 0);
  if ( !linkageStatusLabel )
    goto LABEL_43;
  UILabel__set_text(linkageStatusLabel, (System_String_o *)SelfUserAccountLinkage, 0);
  if ( AccountLinkageParams_TypeInfo->static_fields->isAniplexPlusServerError )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v10 = LocalizationManager__Get((System_String_o *)StringLiteral_1876/*"ACCOUNT_LINKAGE_ON_MAINTENANCE"*/, 0);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  SelfUserAccountLinkage = (uint64_t)LocalizationManager__Get((System_String_o *)StringLiteral_1858/*"ACCOUNT_LINKAGE_BUTTON_DELINK"*/, 0);
  if ( !v12 )
    goto LABEL_43;
  ...
  *(_QWORD *)&v29.fields._offsetMinutes = 0;
  ...
  v18 = System_DateTime__ToString_65429908(v17, (System_String_o *)StringLiteral_25132/*"yyyy/MM/dd"*/, 0);
  v19 = v16;
LABEL_42:
  v25 = System_String__Concat_64031724(v19, v18, 0);
