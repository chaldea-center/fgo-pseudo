...
void AccountLinkageMenu__InitView(AccountLinkageMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C221B0 & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_1878/*"ACCOUNT_LINKAGE_MENU_MESSAGE"*/);
    sub_1C2D490(&StringLiteral_1879/*"ACCOUNT_LINKAGE_MENU_WARNING"*/);
    byte_4C221B0 = 1;
  }
...
void AccountLinkageMenu__UpdateView(AccountLinkageMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C221B1 & 1) == 0 )
  {
    ...
    sub_1C2D490(&LocalizationManager_TypeInfo);
    sub_1C2D490(&StringLiteral_1869/*"ACCOUNT_LINKAGE_DATE"*/);
    sub_1C2D490(&StringLiteral_1898/*"ACCOUNT_LINKAGE_STATUS_LINKED"*/);
    sub_1C2D490(&StringLiteral_24979/*"yyyy/MM/dd"*/);
    sub_1C2D490(&StringLiteral_861/*"-"*/);
    sub_1C2D490(&StringLiteral_1864/*"ACCOUNT_LINKAGE_BUTTON_LINK"*/);
    sub_1C2D490(&StringLiteral_1863/*"ACCOUNT_LINKAGE_BUTTON_DELINK"*/);
    sub_1C2D490(&StringLiteral_1899/*"ACCOUNT_LINKAGE_STATUS_NOT_LINKED"*/);
    sub_1C2D490(&StringLiteral_1881/*"ACCOUNT_LINKAGE_ON_MAINTENANCE"*/);
    byte_4C221B1 = 1;
  }
  entity = 0;
...
LABEL_30:
    ...
    if ( AccountLinkageParams_TypeInfo->static_fields->isAniplexPlusServerError )
    {
      ...
      v23 = System_String__Concat_63457864(mText, v22, 0);
...
LABEL_43:
    sub_1C2D6EC(SelfUserAccountLinkage, v5);
  }
  if ( !entity )
    goto LABEL_43;
  ...
  *(_QWORD *)&v29.fields._offsetMinutes = 0;
  ...
  v18 = System_DateTime__ToString_64858404(v17, (System_String_o *)StringLiteral_24979/*"yyyy/MM/dd"*/, 0);
  v19 = v16;
LABEL_42:
  v25 = System_String__Concat_63457864(v19, v18, 0);
