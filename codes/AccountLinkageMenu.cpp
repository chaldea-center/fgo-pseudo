...
void __fastcall AccountLinkageMenu__InitView(AccountLinkageMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA081 & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_2008/*"ACCOUNT_LINKAGE_MENU_MESSAGE"*/, v3);
    sub_1B64A00(&StringLiteral_2009/*"ACCOUNT_LINKAGE_MENU_WARNING"*/, v4);
    byte_49FA081 = 1;
  }
...
void __fastcall AccountLinkageMenu__UpdateView(AccountLinkageMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA082 & 1) == 0 )
  {
    ...
    sub_1B64A00(&System_DateTimeOffset_TypeInfo, v3);
    sub_1B64A00(&System_DateTime_TypeInfo, v4);
    sub_1B64A00(&LocalizationManager_TypeInfo, v5);
    sub_1B64A00(&StringLiteral_1999/*"ACCOUNT_LINKAGE_DATE"*/, v6);
    sub_1B64A00(&StringLiteral_2028/*"ACCOUNT_LINKAGE_STATUS_LINKED"*/, v7);
    sub_1B64A00(&StringLiteral_24789/*"yyyy/MM/dd"*/, v8);
    sub_1B64A00(&StringLiteral_920/*"-"*/, v9);
    sub_1B64A00(&StringLiteral_1994/*"ACCOUNT_LINKAGE_BUTTON_LINK"*/, v10);
    sub_1B64A00(&StringLiteral_1993/*"ACCOUNT_LINKAGE_BUTTON_DELINK"*/, v11);
    sub_1B64A00(&StringLiteral_2029/*"ACCOUNT_LINKAGE_STATUS_NOT_LINKED"*/, v12);
    sub_1B64A00(&StringLiteral_2011/*"ACCOUNT_LINKAGE_ON_MAINTENANCE"*/, v13);
    byte_49FA082 = 1;
  }
  entity = 0LL;
  v37 = 0LL;
...
LABEL_43:
    sub_1B64C5C(SelfUserAccountLinkage, v16);
  }
  if ( !entity )
    goto LABEL_43;
  ...
  *(_QWORD *)&v40.fields._offsetMinutes = 0LL;
  ...
  v28 = System_DateTime__ToString_62075772(v39, (System_String_o *)StringLiteral_24789/*"yyyy/MM/dd"*/, 0LL);
  v29 = v27;
LABEL_42:
  v35 = System_String__Concat_61385136(v29, v28, 0LL);
