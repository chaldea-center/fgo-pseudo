...
void AccountLinkageMenu__InitView(AccountLinkageMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2758B & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_1873/*"ACCOUNT_LINKAGE_MENU_MESSAGE"*/);
    sub_1C94098(&StringLiteral_1874/*"ACCOUNT_LINKAGE_MENU_WARNING"*/);
    byte_4D2758B = 1;
  }
...
void AccountLinkageMenu__UpdateView(AccountLinkageMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2758C & 1) == 0 )
  {
    ...
    sub_1C94098(&LocalizationManager_TypeInfo);
    sub_1C94098(&StringLiteral_1864/*"ACCOUNT_LINKAGE_DATE"*/);
    sub_1C94098(&StringLiteral_1893/*"ACCOUNT_LINKAGE_STATUS_LINKED"*/);
    sub_1C94098(&StringLiteral_25254/*"yyyy/MM/dd"*/);
    sub_1C94098(&StringLiteral_858/*"-"*/);
    sub_1C94098(&StringLiteral_1859/*"ACCOUNT_LINKAGE_BUTTON_LINK"*/);
    sub_1C94098(&StringLiteral_1858/*"ACCOUNT_LINKAGE_BUTTON_DELINK"*/);
    sub_1C94098(&StringLiteral_1894/*"ACCOUNT_LINKAGE_STATUS_NOT_LINKED"*/);
    sub_1C94098(&StringLiteral_1876/*"ACCOUNT_LINKAGE_ON_MAINTENANCE"*/);
    byte_4D2758C = 1;
  }
  entity = 0;
...
LABEL_43:
    sub_1C942F0(SelfUserAccountLinkage, v5);
  }
  if ( !entity )
    goto LABEL_43;
  ...
  if ( AccountLinkageParams_TypeInfo->static_fields->isAniplexPlusServerError )
  {
    ...
    v11 = System_String__Concat_64417744(v9, v10, 0);
  ...
  *(_QWORD *)&v29.fields._offsetMinutes = 0;
  ...
  v18 = System_DateTime__ToString_65815928(v17, (System_String_o *)StringLiteral_25254/*"yyyy/MM/dd"*/, 0);
  v19 = v16;
LABEL_42:
  v25 = System_String__Concat_64417744(v19, v18, 0);
