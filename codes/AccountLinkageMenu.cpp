...
void __fastcall AccountLinkageMenu__InitView(AccountLinkageMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49F9A61 & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_2007/*"ACCOUNT_LINKAGE_MENU_MESSAGE"*/, v3);
    sub_1B64870(&StringLiteral_2008/*"ACCOUNT_LINKAGE_MENU_WARNING"*/, v4);
    byte_49F9A61 = 1;
  }
...
void __fastcall AccountLinkageMenu__UpdateView(AccountLinkageMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49F9A62 & 1) == 0 )
  {
    ...
    sub_1B64870(&System_DateTimeOffset_TypeInfo, v3);
    sub_1B64870(&System_DateTime_TypeInfo, v4);
    sub_1B64870(&LocalizationManager_TypeInfo, v5);
    sub_1B64870(&StringLiteral_1998/*"ACCOUNT_LINKAGE_DATE"*/, v6);
    sub_1B64870(&StringLiteral_2027/*"ACCOUNT_LINKAGE_STATUS_LINKED"*/, v7);
    sub_1B64870(&StringLiteral_24789/*"yyyy/MM/dd"*/, v8);
    sub_1B64870(&StringLiteral_920/*"-"*/, v9);
    sub_1B64870(&StringLiteral_1993/*"ACCOUNT_LINKAGE_BUTTON_LINK"*/, v10);
    sub_1B64870(&StringLiteral_1992/*"ACCOUNT_LINKAGE_BUTTON_DELINK"*/, v11);
    sub_1B64870(&StringLiteral_2028/*"ACCOUNT_LINKAGE_STATUS_NOT_LINKED"*/, v12);
    sub_1B64870(&StringLiteral_2010/*"ACCOUNT_LINKAGE_ON_MAINTENANCE"*/, v13);
    byte_49F9A62 = 1;
  }
  entity = 0LL;
  v37 = 0LL;
    ...
    if ( linkageButtonLabel )
    {
      ...
      if ( SelfUserAccountLinkage )
      {
        ...
        if ( v26 )
        {
          ...
          v28 = (System_String_o *)StringLiteral_920/*"-"*/;
          goto LABEL_42;
        }
      }
    }
LABEL_43:
    sub_1B64ACC(SelfUserAccountLinkage, v16);
  }
  if ( !entity )
    goto LABEL_43;
  ...
  *(_QWORD *)&v40.fields._offsetMinutes = 0LL;
  ...
  v28 = System_DateTime__ToString_62074212(v39, (System_String_o *)StringLiteral_24789/*"yyyy/MM/dd"*/, 0LL);
  v29 = v27;
LABEL_42:
  v35 = System_String__Concat_61383576(v29, v28, 0LL);
