...
void __fastcall AccountLinkageMenu__InitView(AccountLinkageMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD778B & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_2012/*"ACCOUNT_LINKAGE_MENU_MESSAGE"*/);
    sub_1C21E38(&StringLiteral_2013/*"ACCOUNT_LINKAGE_MENU_WARNING"*/);
    byte_4BD778B = 1;
  }
  messageLabel = this->fields.messageLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_2012/*"ACCOUNT_LINKAGE_MENU_MESSAGE"*/, 0LL);
  if ( !messageLabel
    || (UILabel__set_text(messageLabel, v4, 0LL),
        warningLabel = this->fields.warningLabel,
        v4 = LocalizationManager__Get((System_String_o *)StringLiteral_2013/*"ACCOUNT_LINKAGE_MENU_WARNING"*/, 0LL),
        !warningLabel) )
  {
    sub_1C22094(v4, v5);
  }
...
void __fastcall AccountLinkageMenu__UpdateView(AccountLinkageMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD778C & 1) == 0 )
  {
    ...
    sub_1C21E38(&LocalizationManager_TypeInfo);
    sub_1C21E38(&StringLiteral_2003/*"ACCOUNT_LINKAGE_DATE"*/);
    sub_1C21E38(&StringLiteral_2032/*"ACCOUNT_LINKAGE_STATUS_LINKED"*/);
    sub_1C21E38(&StringLiteral_25326/*"yyyy/MM/dd"*/);
    sub_1C21E38(&StringLiteral_918/*"-"*/);
    sub_1C21E38(&StringLiteral_1998/*"ACCOUNT_LINKAGE_BUTTON_LINK"*/);
    sub_1C21E38(&StringLiteral_1997/*"ACCOUNT_LINKAGE_BUTTON_DELINK"*/);
    sub_1C21E38(&StringLiteral_2033/*"ACCOUNT_LINKAGE_STATUS_NOT_LINKED"*/);
    sub_1C21E38(&StringLiteral_2015/*"ACCOUNT_LINKAGE_ON_MAINTENANCE"*/);
    byte_4BD778C = 1;
  }
  entity = 0LL;
  v26 = 0LL;
...
LABEL_30:
    ...
    if ( AccountLinkageParams_TypeInfo->static_fields->isAniplexPlusServerError )
    {
      ...
      v22 = System_String__Concat_63115476(mText, v21, 0LL);
    ...
    if ( linkageButtonLabel )
    {
      ...
      if ( SelfUserAccountLinkage )
      {
        ...
        if ( v15 )
        {
          ...
          v17 = (System_String_o *)StringLiteral_918/*"-"*/;
          goto LABEL_42;
        }
      }
    }
LABEL_43:
    sub_1C22094(SelfUserAccountLinkage, v5);
  }
  if ( !entity )
    goto LABEL_43;
  ...
  if ( AccountLinkageParams_TypeInfo->static_fields->isAniplexPlusServerError )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v10 = LocalizationManager__Get((System_String_o *)StringLiteral_2015/*"ACCOUNT_LINKAGE_ON_MAINTENANCE"*/, 0LL);
    v11 = System_String__Concat_63115476(v9, v10, 0LL);
  ...
  *(_QWORD *)&v29.fields._offsetMinutes = 0LL;
  ...
  v17 = System_DateTime__ToString_63806448(v28, (System_String_o *)StringLiteral_25326/*"yyyy/MM/dd"*/, 0LL);
  v18 = v16;
LABEL_42:
  v24 = System_String__Concat_63115476(v18, v17, 0LL);
