...
void __fastcall AccountLinkageMenu__InitView(AccountLinkageMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BAF961 & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_2011/*"ACCOUNT_LINKAGE_MAINTENANCE_MESSAGE"*/, v3);
    sub_1C13D24(&StringLiteral_2012/*"ACCOUNT_LINKAGE_MENU_MESSAGE"*/, v4);
    byte_4BAF961 = 1;
  }
  messageLabel = this->fields.messageLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v6 = LocalizationManager__Get((System_String_o *)StringLiteral_2011/*"ACCOUNT_LINKAGE_MAINTENANCE_MESSAGE"*/, 0LL);
  if ( !messageLabel
    || (UILabel__set_text(messageLabel, v6, 0LL),
        warningLabel = this->fields.warningLabel,
        v6 = LocalizationManager__Get((System_String_o *)StringLiteral_2012/*"ACCOUNT_LINKAGE_MENU_MESSAGE"*/, 0LL),
        !warningLabel) )
  {
    sub_1C13F80(v6, v7);
  }
...
void __fastcall AccountLinkageMenu__UpdateView(AccountLinkageMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BAF962 & 1) == 0 )
  {
    ...
    sub_1C13D24(&System_DateTimeOffset_TypeInfo, v3);
    sub_1C13D24(&System_DateTime_TypeInfo, v4);
    sub_1C13D24(&LocalizationManager_TypeInfo, v5);
    sub_1C13D24(&StringLiteral_2002/*"ACCOUNT_LINKAGE_CONTINUE_SUCCESS"*/, v6);
    sub_1C13D24(&StringLiteral_2031/*"ACCOUNT_LINKAGE_SELECT_CONTINUE_TYPE_NO_DATA"*/, v7);
    sub_1C13D24(&StringLiteral_25282/*"yyyy"*/, v8);
    sub_1C13D24(&StringLiteral_918/*"-"*/, v9);
    sub_1C13D24(&StringLiteral_1997/*"ACCOUNT_LINKAGE_BUTTON_DELINK"*/, v10);
    sub_1C13D24(&StringLiteral_1996/*"ACCOUNT_DELETE_RECONFIRM_MESSAGE"*/, v11);
    sub_1C13D24(&StringLiteral_2032/*"ACCOUNT_LINKAGE_STATUS_LINKED"*/, v12);
    sub_1C13D24(&StringLiteral_2014/*"ACCOUNT_LINKAGE_NOTICE_CANNOT_GET_CONTINUE_NUMBER"*/, v13);
    byte_4BAF962 = 1;
  }
  entity = 0LL;
  v37 = 0LL;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  SelfUserAccountLinkage = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_2002/*"ACCOUNT_LINKAGE_CONTINUE_SUCCESS"*/, 0LL);
  if ( !linkageDateLabel )
    goto LABEL_43;
  ...
  if ( (SelfUserAccountLinkage & 1) == 0 )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
LABEL_30:
    SelfUserAccountLinkage = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_2032/*"ACCOUNT_LINKAGE_STATUS_LINKED"*/, 0LL);
    ...
    if ( AccountLinkageParams_TypeInfo->static_fields->isAniplexPlusServerError )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v32 = LocalizationManager__Get((System_String_o *)StringLiteral_2014/*"ACCOUNT_LINKAGE_NOTICE_CANNOT_GET_CONTINUE_NUMBER"*/, 0LL);
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    SelfUserAccountLinkage = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_1997/*"ACCOUNT_LINKAGE_BUTTON_DELINK"*/, 0LL);
    if ( linkageButtonLabel )
    {
      ...
      if ( SelfUserAccountLinkage )
      {
        ...
        if ( v26 )
        {
          ...
          v28 = (System_String_o *)StringLiteral_918/*"-"*/;
          goto LABEL_42;
        }
      }
    }
LABEL_43:
    sub_1C13F80(SelfUserAccountLinkage, v16);
  }
  if ( !entity )
    goto LABEL_43;
  ...
  if ( type != 1 )
    goto LABEL_30;
  SelfUserAccountLinkage = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_2031/*"ACCOUNT_LINKAGE_SELECT_CONTINUE_TYPE_NO_DATA"*/, 0LL);
  if ( !linkageStatusLabel )
    goto LABEL_43;
  UILabel__set_text(linkageStatusLabel, (System_String_o *)SelfUserAccountLinkage, 0LL);
  if ( AccountLinkageParams_TypeInfo->static_fields->isAniplexPlusServerError )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v21 = LocalizationManager__Get((System_String_o *)StringLiteral_2014/*"ACCOUNT_LINKAGE_NOTICE_CANNOT_GET_CONTINUE_NUMBER"*/, 0LL);
    v22 = System_String__Concat_62967944(v20, v21, 0LL);
    UILabel__set_text(v19, v22, 0LL);
  }
  v23 = this->fields.linkageButtonLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  SelfUserAccountLinkage = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_1996/*"ACCOUNT_DELETE_RECONFIRM_MESSAGE"*/, 0LL);
  if ( !v23 )
    goto LABEL_43;
  ...
  *(_QWORD *)&v40.fields._offsetMinutes = 0LL;
  ...
  v28 = System_DateTime__ToString_63658916(v39, (System_String_o *)StringLiteral_25282/*"yyyy"*/, 0LL);
  v29 = v27;
LABEL_42:
  v35 = System_String__Concat_62967944(v29, v28, 0LL);
