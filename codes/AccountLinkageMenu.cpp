...
void __fastcall AccountLinkageMenu__InitView(AccountLinkageMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B61E72 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_2008/*"ACCOUNT_LINKAGE_MENU_MESSAGE"*/, v3);
    sub_1BE4ACC(&StringLiteral_2009/*"ACCOUNT_LINKAGE_MENU_WARNING"*/, v4);
    byte_4B61E72 = 1;
  }
...
void __fastcall AccountLinkageMenu__UpdateView(AccountLinkageMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B61E73 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&System_DateTimeOffset_TypeInfo, v3);
    sub_1BE4ACC(&System_DateTime_TypeInfo, v4);
    sub_1BE4ACC(&LocalizationManager_TypeInfo, v5);
    sub_1BE4ACC(&StringLiteral_1999/*"ACCOUNT_LINKAGE_DATE"*/, v6);
    sub_1BE4ACC(&StringLiteral_2028/*"ACCOUNT_LINKAGE_STATUS_LINKED"*/, v7);
    sub_1BE4ACC(&StringLiteral_25226/*"yyyy/MM/dd"*/, v8);
    sub_1BE4ACC(&StringLiteral_915/*"-"*/, v9);
    sub_1BE4ACC(&StringLiteral_1994/*"ACCOUNT_LINKAGE_BUTTON_LINK"*/, v10);
    sub_1BE4ACC(&StringLiteral_1993/*"ACCOUNT_LINKAGE_BUTTON_DELINK"*/, v11);
    sub_1BE4ACC(&StringLiteral_2029/*"ACCOUNT_LINKAGE_STATUS_NOT_LINKED"*/, v12);
    sub_1BE4ACC(&StringLiteral_2011/*"ACCOUNT_LINKAGE_ON_MAINTENANCE"*/, v13);
    byte_4B61E73 = 1;
  }
  entity = 0LL;
  v37 = 0LL;
...
LABEL_30:
    ...
    if ( AccountLinkageParams_TypeInfo->static_fields->isAniplexPlusServerError )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v32 = LocalizationManager__Get((System_String_o *)StringLiteral_2011/*"ACCOUNT_LINKAGE_ON_MAINTENANCE"*/, 0LL);
...
LABEL_43:
    sub_1BE4D28(SelfUserAccountLinkage, v16);
  }
  if ( !entity )
    goto LABEL_43;
  ...
  if ( AccountLinkageParams_TypeInfo->static_fields->isAniplexPlusServerError )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v21 = LocalizationManager__Get((System_String_o *)StringLiteral_2011/*"ACCOUNT_LINKAGE_ON_MAINTENANCE"*/, 0LL);
    v22 = System_String__Concat_62698808(v20, v21, 0LL);
  ...
  *(_QWORD *)&v40.fields._offsetMinutes = 0LL;
  ...
  v28 = System_DateTime__ToString_63389780(v39, (System_String_o *)StringLiteral_25226/*"yyyy/MM/dd"*/, 0LL);
  v29 = v27;
LABEL_42:
  v35 = System_String__Concat_62698808(v29, v28, 0LL);
