...
void __fastcall AccountLinkageMenu__InitView(AccountLinkageMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC2D0A & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_2012/*"ACCOUNT_LINKAGE_MENU_MESSAGE"*/, v3);
    sub_1C1ABD4(&StringLiteral_2013/*"ACCOUNT_LINKAGE_MENU_WARNING"*/, v4);
    byte_4BC2D0A = 1;
  }
  ...
  if ( !messageLabel
    || (UILabel__set_text(messageLabel, v6, 0LL),
        ...
        v6 = LocalizationManager__Get((System_String_o *)StringLiteral_2013/*"ACCOUNT_LINKAGE_MENU_WARNING"*/, 0LL),
        !warningLabel) )
  {
    sub_1C1AE30(v6, v7);
  }
...
void __fastcall AccountLinkageMenu__UpdateView(AccountLinkageMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC2D0B & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&System_DateTimeOffset_TypeInfo, v3);
    sub_1C1ABD4(&System_DateTime_TypeInfo, v4);
    sub_1C1ABD4(&LocalizationManager_TypeInfo, v5);
    sub_1C1ABD4(&StringLiteral_2003/*"ACCOUNT_LINKAGE_DATE"*/, v6);
    sub_1C1ABD4(&StringLiteral_2032/*"ACCOUNT_LINKAGE_STATUS_LINKED"*/, v7);
    sub_1C1ABD4(&StringLiteral_25304/*"yyyy/MM/dd"*/, v8);
    sub_1C1ABD4(&StringLiteral_918/*"-"*/, v9);
    sub_1C1ABD4(&StringLiteral_1998/*"ACCOUNT_LINKAGE_BUTTON_LINK"*/, v10);
    sub_1C1ABD4(&StringLiteral_1997/*"ACCOUNT_LINKAGE_BUTTON_DELINK"*/, v11);
    sub_1C1ABD4(&StringLiteral_2033/*"ACCOUNT_LINKAGE_STATUS_NOT_LINKED"*/, v12);
    sub_1C1ABD4(&StringLiteral_2015/*"ACCOUNT_LINKAGE_ON_MAINTENANCE"*/, v13);
    byte_4BC2D0B = 1;
  }
  entity = 0LL;
  v37 = 0LL;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  SelfUserAccountLinkage = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_2003/*"ACCOUNT_LINKAGE_DATE"*/, 0LL);
  if ( !linkageDateLabel )
    goto LABEL_43;
  ...
  if ( (SelfUserAccountLinkage & 1) == 0 )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
LABEL_30:
    SelfUserAccountLinkage = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_2033/*"ACCOUNT_LINKAGE_STATUS_NOT_LINKED"*/, 0LL);
    ...
    if ( AccountLinkageParams_TypeInfo->static_fields->isAniplexPlusServerError )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v32 = LocalizationManager__Get((System_String_o *)StringLiteral_2015/*"ACCOUNT_LINKAGE_ON_MAINTENANCE"*/, 0LL);
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    SelfUserAccountLinkage = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_1998/*"ACCOUNT_LINKAGE_BUTTON_LINK"*/, 0LL);
...
LABEL_43:
    sub_1C1AE30(SelfUserAccountLinkage, v16);
  }
  if ( !entity )
    goto LABEL_43;
  ...
  if ( AccountLinkageParams_TypeInfo->static_fields->isAniplexPlusServerError )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v21 = LocalizationManager__Get((System_String_o *)StringLiteral_2015/*"ACCOUNT_LINKAGE_ON_MAINTENANCE"*/, 0LL);
    v22 = System_String__Concat_63040368(v20, v21, 0LL);
  ...
  *(_QWORD *)&v40.fields._offsetMinutes = 0LL;
  ...
  v28 = System_DateTime__ToString_63731340(v39, (System_String_o *)StringLiteral_25304/*"yyyy/MM/dd"*/, 0LL);
  v29 = v27;
LABEL_42:
  v35 = System_String__Concat_63040368(v29, v28, 0LL);
