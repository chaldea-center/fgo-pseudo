...
void __fastcall AccountLinkageMenu__InitView(AccountLinkageMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3FA30 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_1902/*"ACCOUNT_LINKAGE_MENU_MESSAGE"*/, v3);
    sub_1BDB878(&StringLiteral_1903/*"ACCOUNT_LINKAGE_MENU_WARNING"*/, v4);
    byte_4B3FA30 = 1;
  }
  messageLabel = this->fields.messageLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v6 = LocalizationManager__Get((System_String_o *)StringLiteral_1902/*"ACCOUNT_LINKAGE_MENU_MESSAGE"*/, 0LL);
  if ( !messageLabel
    || (UILabel__set_text(messageLabel, v6, 0LL),
        warningLabel = this->fields.warningLabel,
        v6 = LocalizationManager__Get((System_String_o *)StringLiteral_1903/*"ACCOUNT_LINKAGE_MENU_WARNING"*/, 0LL),
        !warningLabel) )
  {
    sub_1BDBAD4(v6, v7);
  }
...
void __fastcall AccountLinkageMenu__UpdateView(AccountLinkageMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3FA31 & 1) == 0 )
  {
    ...
    sub_1BDB878(&System_DateTimeOffset_TypeInfo, v3);
    sub_1BDB878(&System_DateTime_TypeInfo, v4);
    sub_1BDB878(&LocalizationManager_TypeInfo, v5);
    sub_1BDB878(&StringLiteral_1893/*"ACCOUNT_LINKAGE_DATE"*/, v6);
    sub_1BDB878(&StringLiteral_1922/*"ACCOUNT_LINKAGE_STATUS_LINKED"*/, v7);
    sub_1BDB878(&StringLiteral_25076/*"yyyy/MM/dd"*/, v8);
    sub_1BDB878(&StringLiteral_871/*"-"*/, v9);
    sub_1BDB878(&StringLiteral_1888/*"ACCOUNT_LINKAGE_BUTTON_LINK"*/, v10);
    sub_1BDB878(&StringLiteral_1887/*"ACCOUNT_LINKAGE_BUTTON_DELINK"*/, v11);
    sub_1BDB878(&StringLiteral_1923/*"ACCOUNT_LINKAGE_STATUS_NOT_LINKED"*/, v12);
    sub_1BDB878(&StringLiteral_1905/*"ACCOUNT_LINKAGE_ON_MAINTENANCE"*/, v13);
    byte_4B3FA31 = 1;
  }
  entity = 0LL;
  v37 = 0LL;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  SelfUserAccountLinkage = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_1893/*"ACCOUNT_LINKAGE_DATE"*/, 0LL);
  if ( !linkageDateLabel )
    goto LABEL_43;
  ...
  if ( (SelfUserAccountLinkage & 1) == 0 )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
LABEL_30:
    SelfUserAccountLinkage = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_1923/*"ACCOUNT_LINKAGE_STATUS_NOT_LINKED"*/, 0LL);
    ...
    if ( AccountLinkageParams_TypeInfo->static_fields->isAniplexPlusServerError )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v32 = LocalizationManager__Get((System_String_o *)StringLiteral_1905/*"ACCOUNT_LINKAGE_ON_MAINTENANCE"*/, 0LL);
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    SelfUserAccountLinkage = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_1888/*"ACCOUNT_LINKAGE_BUTTON_LINK"*/, 0LL);
    if ( linkageButtonLabel )
    {
      ...
      if ( SelfUserAccountLinkage )
      {
        ...
        if ( v26 )
        {
          ...
          v28 = (System_String_o *)StringLiteral_871/*"-"*/;
          goto LABEL_42;
        }
      }
    }
LABEL_43:
    sub_1BDBAD4(SelfUserAccountLinkage, v16);
  }
  if ( !entity )
    goto LABEL_43;
  ...
  if ( type != 1 )
    goto LABEL_30;
  SelfUserAccountLinkage = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_1922/*"ACCOUNT_LINKAGE_STATUS_LINKED"*/, 0LL);
  if ( !linkageStatusLabel )
    goto LABEL_43;
  UILabel__set_text(linkageStatusLabel, (System_String_o *)SelfUserAccountLinkage, 0LL);
  if ( AccountLinkageParams_TypeInfo->static_fields->isAniplexPlusServerError )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v21 = LocalizationManager__Get((System_String_o *)StringLiteral_1905/*"ACCOUNT_LINKAGE_ON_MAINTENANCE"*/, 0LL);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  SelfUserAccountLinkage = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_1887/*"ACCOUNT_LINKAGE_BUTTON_DELINK"*/, 0LL);
  if ( !v23 )
    goto LABEL_43;
  ...
  *(_QWORD *)&v40.fields._offsetMinutes = 0LL;
  ...
  v28 = System_DateTime__ToString_63976336(v39, (System_String_o *)StringLiteral_25076/*"yyyy/MM/dd"*/, 0LL);
  v29 = v27;
LABEL_42:
  v35 = System_String__Concat_62572260(v29, v28, 0LL);
