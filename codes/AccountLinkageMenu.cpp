...
void __fastcall AccountLinkageMenu__InitView(AccountLinkageMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B30E & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_2007/*"ACCOUNT_LINKAGE_MENU_MESSAGE"*/, v3);
    sub_1B90010(&StringLiteral_2008/*"ACCOUNT_LINKAGE_MENU_WARNING"*/, v4);
    byte_4A6B30E = 1;
  }
  messageLabel = this->fields.messageLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v6 = LocalizationManager__Get((System_String_o *)StringLiteral_2007/*"ACCOUNT_LINKAGE_MENU_MESSAGE"*/, 0LL);
  if ( !messageLabel
    || (UILabel__set_text(messageLabel, v6, 0LL),
        warningLabel = this->fields.warningLabel,
        v6 = LocalizationManager__Get((System_String_o *)StringLiteral_2008/*"ACCOUNT_LINKAGE_MENU_WARNING"*/, 0LL),
        !warningLabel) )
  {
    sub_1B9026C(v6, v7);
  }
...
void __fastcall AccountLinkageMenu__UpdateView(AccountLinkageMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B30F & 1) == 0 )
  {
    ...
    sub_1B90010(&System_DateTimeOffset_TypeInfo, v3);
    sub_1B90010(&System_DateTime_TypeInfo, v4);
    sub_1B90010(&LocalizationManager_TypeInfo, v5);
    sub_1B90010(&StringLiteral_1998/*"ACCOUNT_LINKAGE_DATE"*/, v6);
    sub_1B90010(&StringLiteral_2027/*"ACCOUNT_LINKAGE_STATUS_LINKED"*/, v7);
    sub_1B90010(&StringLiteral_24923/*"yyyy/MM/dd"*/, v8);
    sub_1B90010(&StringLiteral_919/*"-"*/, v9);
    sub_1B90010(&StringLiteral_1993/*"ACCOUNT_LINKAGE_BUTTON_LINK"*/, v10);
    sub_1B90010(&StringLiteral_1992/*"ACCOUNT_LINKAGE_BUTTON_DELINK"*/, v11);
    sub_1B90010(&StringLiteral_2028/*"ACCOUNT_LINKAGE_STATUS_NOT_LINKED"*/, v12);
    sub_1B90010(&StringLiteral_2010/*"ACCOUNT_LINKAGE_ON_MAINTENANCE"*/, v13);
    byte_4A6B30F = 1;
  }
  entity = 0LL;
  v37 = 0LL;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  SelfUserAccountLinkage = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_1998/*"ACCOUNT_LINKAGE_DATE"*/, 0LL);
  if ( !linkageDateLabel )
    goto LABEL_43;
  ...
  if ( (SelfUserAccountLinkage & 1) == 0 )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
LABEL_30:
    SelfUserAccountLinkage = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_2028/*"ACCOUNT_LINKAGE_STATUS_NOT_LINKED"*/, 0LL);
    ...
    if ( AccountLinkageParams_TypeInfo->static_fields->isAniplexPlusServerError )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v32 = LocalizationManager__Get((System_String_o *)StringLiteral_2010/*"ACCOUNT_LINKAGE_ON_MAINTENANCE"*/, 0LL);
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    SelfUserAccountLinkage = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_1993/*"ACCOUNT_LINKAGE_BUTTON_LINK"*/, 0LL);
    if ( linkageButtonLabel )
    {
      ...
      if ( SelfUserAccountLinkage )
      {
        ...
        if ( v26 )
        {
          ...
          v28 = (System_String_o *)StringLiteral_919/*"-"*/;
          goto LABEL_42;
        }
      }
    }
LABEL_43:
    sub_1B9026C(SelfUserAccountLinkage, v16);
  }
  if ( !entity )
    goto LABEL_43;
  ...
  if ( type != 1 )
    goto LABEL_30;
  SelfUserAccountLinkage = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_2027/*"ACCOUNT_LINKAGE_STATUS_LINKED"*/, 0LL);
  if ( !linkageStatusLabel )
    goto LABEL_43;
  UILabel__set_text(linkageStatusLabel, (System_String_o *)SelfUserAccountLinkage, 0LL);
  if ( AccountLinkageParams_TypeInfo->static_fields->isAniplexPlusServerError )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v21 = LocalizationManager__Get((System_String_o *)StringLiteral_2010/*"ACCOUNT_LINKAGE_ON_MAINTENANCE"*/, 0LL);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  SelfUserAccountLinkage = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_1992/*"ACCOUNT_LINKAGE_BUTTON_DELINK"*/, 0LL);
  if ( !v23 )
    goto LABEL_43;
  ...
  *(_QWORD *)&v40.fields._offsetMinutes = 0LL;
  ...
  v28 = System_DateTime__ToString_62477736(v39, (System_String_o *)StringLiteral_24923/*"yyyy/MM/dd"*/, 0LL);
  v29 = v27;
LABEL_42:
  v35 = System_String__Concat_61787092(v29, v28, 0LL);
