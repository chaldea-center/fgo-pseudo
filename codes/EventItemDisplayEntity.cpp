...
bool __fastcall EventItemDisplayEntity__IsEnable(EventItemDisplayEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FEAF1 & 1) == 0 )
  {
    sub_1B64A00(&Method_DataManager_GetMasterData_EventItemDisplayReleaseMaster___, method);
    sub_1B64A00(
  ...
  else
  {
    ...
    Instance = DataManager__GetMasterData_object_(
                 ...
                 (const MethodInfo_2E3BCE0 *)Method_DataManager_GetMasterData_EventItemDisplayReleaseMaster___);
    ...
    if ( (int)v10 >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        Instance = (Il2CppObject *)DataMasterBase_object__object__int___TryGetEntity(
                                     ...
                                     (const MethodInfo_30D67EC *)Method_DataMasterBase_EventItemDisplayReleaseMaster__EventItemDisplayReleaseEntity__int__TryGetEntity__);
