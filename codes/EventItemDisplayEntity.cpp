...
bool __fastcall EventItemDisplayEntity__IsEnable(EventItemDisplayEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4E460 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataManager_GetMasterData_EventItemDisplayReleaseMaster___, method);
    sub_1B863B8(
  ...
  else
  {
    ...
    Instance = DataManager__GetMasterData_object_(
                 ...
                 (const MethodInfo_2F6DCB8 *)Method_DataManager_GetMasterData_EventItemDisplayReleaseMaster___);
    ...
    if ( (int)v10 >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        Instance = (Il2CppObject *)DataMasterBase_object__object__int___TryGetEntity(
                                     ...
                                     (const MethodInfo_32142CC *)Method_DataMasterBase_EventItemDisplayReleaseMaster__EventItemDisplayReleaseEntity__int__TryGetEntity__);
