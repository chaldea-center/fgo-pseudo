        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFCC58 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_DataMasterBase_ServantClassMaster__ServantClassEntity__int__GetEntity__, v10);
        ...
        const MethodInfo *method)
{
  ...
  __int64 v11; // x1
  int32_t FrameType_41104696; // w2
  const MethodInfo *v13; // x4

  if ( (byte_4BFCC57 & 1) == 0 )
  {
    sub_1C2E12C(&Method_DataManager_GetMasterData_ServantExceedMaster___, *(_QWORD *)&svtId);
  ...
  FrameType_41104696 = ServantExceedMaster__GetFrameType_41104696(
                         ...
                         0,
                         0LL);
  ServantClassIconComponent__SetImage(this, classId, FrameType_41104696, 0, v13);
}


// local variable allocation has failed, the output may be wrong!
void __fastcall ServantClassIconComponent__Set_39525024(
        ServantClassIconComponent_o *this,
        int32_t classId,
        int32_t rarity,
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFCC55 & 1) == 0 )
  {
    sub_1C2E12C(&Rarity_TypeInfo, *(_QWORD *)&classId);
    byte_4BFCC55 = 1;
  }
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantClassIconComponent__Set_39525152(
        ServantClassIconComponent_o *this,
        int32_t svtId,
        int32_t limitCount,
        int32_t exceedCount,
        const MethodInfo *method)
{
  ...
  if ( !Instance
    ...
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_2FD1830 *)Method_DataManager_GetMasterData_ServantExceedMaster___)) == 0LL
    || (Instance = (Il2CppObject *)ServantExceedMaster__GetFrameType_41104696(
                                     (ServantExceedMaster_o *)Instance,
                                     svtId,
                                     limitCount,
                                     exceedCount,
