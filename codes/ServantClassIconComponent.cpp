void ServantClassIconComponent___cctor(const MethodInfo *method)
{
  if ( (byte_4E03F63 & 1) == 0 )
  {
    sub_1CE6700(&ServantClassIconComponent_TypeInfo);
    byte_4E03F63 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  FrameType_43829508 = ServantExceedMaster__GetFrameType_43829508(
                         ...
                         v13,
                         0);
  ServantClassIconComponent__SetImage(this, classId, FrameType_43829508, 0, v13, 0, v15);
}


void ServantClassIconComponent__Set_42220680(
        ServantClassIconComponent_o *this,
        int32_t classId,
        int32_t rarity,
        const MethodInfo *method)
...
void ServantClassIconComponent__Set_42220816(
        ServantClassIconComponent_o *this,
        int32_t svtId,
        int32_t limitCount,
        int32_t exceedCount,
        const MethodInfo *method)
{
  ...
  if ( !Instance
    ...
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_32043A8 *)Method_DataManager_GetMasterData_ServantExceedMaster___)) == 0
    || (Instance = (Il2CppObject *)ServantExceedMaster__GetFrameType_43829508(
                                     (ServantExceedMaster_o *)Instance,
                                     svtId,
                                     limitCount,
                                     exceedCount,
