void ServantClassIconComponent___cctor(const MethodInfo *method)
{
  if ( (byte_4C26786 & 1) == 0 )
  {
    sub_1C2D490(&ServantClassIconComponent_TypeInfo);
    byte_4C26786 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataManager__GetMaster_object_((const MethodInfo_30CE8FC *)Method_DataManager_GetMaster_ServantClassMaster___);
  v15 = Master_object;
  if ( isGrandServant )
  {
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataManager__GetMaster_object_((const MethodInfo_30CE8FC *)Method_DataManager_GetMaster_GrandGraphDetailMaster___);
    if ( !Master_object )
      goto LABEL_42;
        ...
        const MethodInfo *method)
{
  ...
  FrameType_42450052 = ServantExceedMaster__GetFrameType_42450052(
                         ...
                         v13,
                         0);
  ServantClassIconComponent__SetImage(this, classId, FrameType_42450052, 0, v13, 0, v15);
}


void ServantClassIconComponent__Set_40768952(
        ServantClassIconComponent_o *this,
        int32_t classId,
        int32_t rarity,
        const MethodInfo *method)
...
void ServantClassIconComponent__Set_40769088(
        ServantClassIconComponent_o *this,
        int32_t svtId,
        int32_t limitCount,
        int32_t exceedCount,
        const MethodInfo *method)
{
  ...
  if ( !Instance
    ...
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_30CE950 *)Method_DataManager_GetMasterData_ServantExceedMaster___)) == 0
    || (Instance = (Il2CppObject *)ServantExceedMaster__GetFrameType_42450052(
                                     (ServantExceedMaster_o *)Instance,
                                     svtId,
                                     limitCount,
                                     exceedCount,
