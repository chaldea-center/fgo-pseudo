        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C35673 & 1) == 0 )
  {
    sub_1C32C20(&WarBoardTaskPlayedEventId__Execute_d__2_TypeInfo);
    byte_4C35673 = 1;
  }
  v3 = sub_1C32E6C(WarBoardTaskPlayedEventId__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C32C34(&Method_WarBoardTaskPlayedEventId__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1C32D48(v3, v4);
}
