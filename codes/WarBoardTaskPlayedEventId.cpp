        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3502F & 1) == 0 )
  {
    sub_1BD3458(&WarBoardTaskPlayedEventId__Execute_d__2_TypeInfo, method);
    byte_4B3502F = 1;
  }
  v3 = sub_1BD36A4(WarBoardTaskPlayedEventId__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BD346C(&Method_WarBoardTaskPlayedEventId__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1BD3580(v3, v4);
}
