        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A06B8D & 1) == 0 )
  {
    sub_1B686D4(&WarBoardTaskPlayedEventId__Execute_d__2_TypeInfo, method);
    byte_4A06B8D = 1;
  }
  v3 = sub_1B68920(WarBoardTaskPlayedEventId__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B686E8(&Method_WarBoardTaskPlayedEventId__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1B687FC(v3, v4);
}
