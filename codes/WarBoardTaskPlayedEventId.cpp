        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4189333 & 1) == 0 )
  {
    sub_B2C35C(&WarBoardTaskPlayedEventId__Execute_d__2_TypeInfo, method);
    byte_4189333 = 1;
  }
  v3 = sub_B2C42C(WarBoardTaskPlayedEventId__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_B2C360(&Method_WarBoardTaskPlayedEventId__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_B2C400(v3, v4);
}
