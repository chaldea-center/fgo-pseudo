        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB3C1D & 1) == 0 )
  {
    sub_1BAB41C(&WarBoardTaskPlayedEventId__Execute_d__2_TypeInfo, method);
    byte_4AB3C1D = 1;
  }
  v3 = sub_1BAB668(WarBoardTaskPlayedEventId__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BAB430(&Method_WarBoardTaskPlayedEventId__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1BAB544(v3, v4);
}
