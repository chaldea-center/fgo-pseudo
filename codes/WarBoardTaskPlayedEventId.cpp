        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDA38B & 1) == 0 )
  {
    sub_1C21E38(&WarBoardTaskPlayedEventId__Execute_d__2_TypeInfo);
    byte_4BDA38B = 1;
  }
  v3 = sub_1C22084(WarBoardTaskPlayedEventId__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C21E4C(&Method_WarBoardTaskPlayedEventId__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1C21F60(v3, v4);
}
