        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA350 & 1) == 0 )
  {
    sub_1B640C8(&WarBoardTaskPlayedEventId__Execute_d__2_TypeInfo, method);
    byte_49FA350 = 1;
  }
  v4 = sub_1B64314(WarBoardTaskPlayedEventId__Execute_d__2_TypeInfo, method, v2);
        ...
        const MethodInfo *method)
{
  ...
  v6 = sub_1B640DC(&Method_WarBoardTaskPlayedEventId__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1B641F0(v5, v6);
}
