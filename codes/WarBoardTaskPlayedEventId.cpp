        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC445 & 1) == 0 )
  {
    sub_1B64870(&WarBoardTaskPlayedEventId__Execute_d__2_TypeInfo, method);
    byte_49FC445 = 1;
  }
  v3 = sub_1B64ABC(WarBoardTaskPlayedEventId__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B64884(&Method_WarBoardTaskPlayedEventId__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1B64998(v3, v4);
}
