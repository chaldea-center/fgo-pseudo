        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2A417 & 1) == 0 )
  {
    sub_1C94098(&WarBoardTaskPlayedEventId__Execute_d__2_TypeInfo);
    byte_4D2A417 = 1;
  }
  v3 = sub_1C942E4(WarBoardTaskPlayedEventId__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C940AC(&Method_WarBoardTaskPlayedEventId__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1C941C0(v3, v4);
}
