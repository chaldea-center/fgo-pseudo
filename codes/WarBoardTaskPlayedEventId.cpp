        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1A21A & 1) == 0 )
  {
    sub_1BCAFF8(&WarBoardTaskPlayedEventId__Execute_d__2_TypeInfo, method);
    byte_4B1A21A = 1;
  }
  v3 = sub_1BCB244(WarBoardTaskPlayedEventId__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BCB00C(&Method_WarBoardTaskPlayedEventId__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1BCB120(v3, v4);
}
