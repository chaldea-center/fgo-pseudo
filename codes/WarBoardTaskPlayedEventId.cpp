        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC58FC & 1) == 0 )
  {
    sub_1C1ABD4(&WarBoardTaskPlayedEventId__Execute_d__2_TypeInfo, method);
    byte_4BC58FC = 1;
  }
  v3 = sub_1C1AE20(WarBoardTaskPlayedEventId__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C1ABE8(&Method_WarBoardTaskPlayedEventId__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1C1ACFC(v3, v4);
}
