        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4C1BB & 1) == 0 )
  {
    sub_1B863B8(&WarBoardTaskPlayedEventId__Execute_d__2_TypeInfo, method);
    byte_4A4C1BB = 1;
  }
  v3 = sub_1B86604(WarBoardTaskPlayedEventId__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B863CC(&Method_WarBoardTaskPlayedEventId__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1B864E0(v3, v4);
}
