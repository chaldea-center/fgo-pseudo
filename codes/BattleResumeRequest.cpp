        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4187F2B & 1) == 0 )
  {
    sub_B2C35C(&StringLiteral_21614/*"questPhase"*/, battleId);
    sub_B2C35C(&StringLiteral_22989/*"usedTurnList"*/, v11);
    sub_B2C35C(&StringLiteral_21612/*"questId"*/, v12);
    sub_B2C35C(&StringLiteral_16649/*"battleId"*/, v13);
    byte_4187F2B = 1;
  }
...
System_String_o *__fastcall BattleResumeRequest__getMockData(BattleResumeRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4187F2A & 1) == 0 )
  {
    ...
    sub_B2C35C(&StringLiteral_9158/*"MockBattleResumeRequest"*/, v2);
    byte_4187F2A = 1;
  }
  ...
  return NetworkManager__getMockFile((System_String_o *)StringLiteral_9158/*"MockBattleResumeRequest"*/, 0LL);
}
...
System_String_o *__fastcall BattleResumeRequest__getURL(BattleResumeRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_B2C35C(&NetworkManager_TypeInfo, method);
    sub_B2C35C(&StringLiteral_16634/*"battle/resume"*/, v2);
    byte_4187F29 = 1;
  }
  if ( (BYTE3(NetworkManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !NetworkManager_TypeInfo->_2.cctor_finished )
  ...
  return System_String__Concat_44305532(BaseUrl, (System_String_o *)StringLiteral_16634/*"battle/resume"*/, 0LL);
}
