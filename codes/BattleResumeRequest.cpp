        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1DEF8 & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_22658/*"questPhase"*/, battleId);
    sub_1BCAFF8(&StringLiteral_24279/*"usedTurnList"*/, v11);
...
System_String_o *__fastcall BattleResumeRequest__getMockData(BattleResumeRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1DEF7 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_9061/*"MockBattleResumeRequest"*/, v2);
    byte_4B1DEF7 = 1;
  }
...
System_String_o *__fastcall BattleResumeRequest__getURL(BattleResumeRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BCAFF8(&NetworkManager_TypeInfo, method);
    sub_1BCAFF8(&StringLiteral_16919/*"battle/resume"*/, v2);
    byte_4B1DEF6 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62450424(BaseUrl, (System_String_o *)StringLiteral_16919/*"battle/resume"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( v8
    && (v9 = v8, ResponseData__checkError_43347888(v8, 0LL))
