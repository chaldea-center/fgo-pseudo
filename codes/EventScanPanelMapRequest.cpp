        ...
        const MethodInfo *method)
{
  if ( (byte_4C394DF & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_21417/*"mapId"*/);
    sub_1C32C20(&StringLiteral_22623/*"panelMapDetailId"*/);
    sub_1C32C20(&StringLiteral_22624/*"panelScanId"*/);
    byte_4C394DF = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19143/*"eventId"*/, eventId, 0);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21417/*"mapId"*/, mapId, 0);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22623/*"panelMapDetailId"*/, panelMapDetailId, 0);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22624/*"panelScanId"*/, panelScanId, 0);
...
System_String_o *EventScanPanelMapRequest__getURL(EventScanPanelMapRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C394DE & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_19134/*"event/scanPanelMap"*/);
    byte_4C394DE = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63518544(BaseUrl, (System_String_o *)StringLiteral_19134/*"event/scanPanelMap"*/, 0);
}
