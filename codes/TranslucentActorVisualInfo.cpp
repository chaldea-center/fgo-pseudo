        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C0070A & 1) == 0 )
  {
    sub_1C2E12C(&Method_BasicHelper_IndexValue_BattleBuffData_BuffData___, buffDataArray);
    sub_1C2E12C(&Method_DataManager_GetMasterData_BuffMaster___, v5);
    sub_1C2E12C(&Method_DataMasterBase_BuffMaster__BuffEntity__int__GetEntity__, v6);
    sub_1C2E12C(&Method_System_Nullable_float__GetValueOrDefault__, v7);
  ...
  v10 = BasicHelper__IndexValue_object_(
          ...
          0,
          0LL,
          (const MethodInfo_2FC01A4 *)Method_BasicHelper_IndexValue_BattleBuffData_BuffData___);
  if ( !v10 )
    goto LABEL_10;
  v11 = v10;
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_2FD1830 *)Method_DataManager_GetMasterData_BuffMaster___)) == 0LL )
  {
