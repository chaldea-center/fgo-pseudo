        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5DE7B & 1) == 0 )
  {
    sub_1B885B0(&Method_BasicHelper_IndexValue_BattleBuffData_BuffData___);
  ...
  v5 = BasicHelper__IndexValue_object_(
         ...
         0,
         0LL,
         (const MethodInfo_2E6E754 *)Method_BasicHelper_IndexValue_BattleBuffData_BuffData___);
  if ( !v5 )
    goto LABEL_10;
  v6 = v5;
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_2E7F908 *)Method_DataManager_GetMasterData_BuffMaster___)) == 0LL )
  {
