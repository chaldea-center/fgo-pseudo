...
System_String_o *__fastcall FriendAcceptRequest__getURL(FriendAcceptRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB6047 & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_19939/*"frame_master_bg"*/, v2);
    byte_4BB6047 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62967944(BaseUrl, (System_String_o *)StringLiteral_19939/*"frame_master_bg"*/, 0LL);
}
