        ...
        const MethodInfo *method)
{
  ...
  RequestBase__addField_40919284((RequestBase_o *)this, (System_String_o *)StringLiteral_23776/*"targetUserId"*/, targetUserId, v3);
...
System_String_o *__fastcall FriendAcceptRequest__getURL(FriendAcceptRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0A513 & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_19565/*"friend/accept"*/, v2);
    byte_4A0A513 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61419468(BaseUrl, (System_String_o *)StringLiteral_19565/*"friend/accept"*/, 0LL);
}
