        ...
        const MethodInfo *method)
{
  ...
  RequestBase__addField_43183652((RequestBase_o *)this, (System_String_o *)StringLiteral_23764/*"targetUserId"*/, targetUserId, v3);
...
System_String_o *__fastcall FriendAcceptRequest__getURL(FriendAcceptRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B03AEE & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_19484/*"friend/accept"*/, v2);
    byte_4B03AEE = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62348648(BaseUrl, (System_String_o *)StringLiteral_19484/*"friend/accept"*/, 0LL);
}
