...
System_String_o *__fastcall FriendAcceptRequest__getURL(FriendAcceptRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42EBDE3 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&StringLiteral_19131/*"friend/accept"*/, v4, v5, v6);
    byte_42EBDE3 = 1;
  }
  ...
  return System_String__Concat_44577788(BaseUrl, (System_String_o *)StringLiteral_19131/*"friend/accept"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v12 = ResponseCommandKind__SearchData(14, responseList, 0LL);
