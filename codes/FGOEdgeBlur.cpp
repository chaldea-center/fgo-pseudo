void __fastcall FGOEdgeBlur___ctor(FGOEdgeBlur_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42AF0DF & 1) == 0 )
  {
    sub_B52984(&UnityEngine_RenderTexture___TypeInfo);
  ...
  *(_OWORD *)&this->fields._thickness = xmmword_327B020;
  ...
  v7 = (struct UnityEngine_RenderTexture_array *)sub_B5299C(UnityEngine_RenderTexture___TypeInfo, 6LL);
  ...
  sub_B52920(
    ...
    v12,
    v13);
  v14 = (struct System_Single_array *)sub_B5299C(float___TypeInfo, 10LL);
...
void __fastcall FGOEdgeBlur__Blur(FGOEdgeBlur_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42AF0DE & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_16207/*"_Weights"*/);
    sub_B52984(&StringLiteral_16193/*"_Threshold"*/);
    sub_B52984(&StringLiteral_16109/*"_Intensity"*/);
    sub_B52984(&StringLiteral_16247/*"_customColor0"*/);
    sub_B52984(&StringLiteral_16155/*"_Rect"*/);
    sub_B52984(&StringLiteral_16190/*"_Thickness"*/);
    sub_B52984(&StringLiteral_16135/*"_Offset"*/);
    byte_42AF0DE = 1;
  }
  *(_QWORD *)&methoda.slot = 0LL;
  ...
  if ( !UnityEngine_Object__op_Equality(texture, 0LL, 0LL) )
  {
    ...
    *(_QWORD *)&v88.fields.z = methoda.invoker_method;
    UnityEngine_Material__SetVector(material, (System_String_o *)StringLiteral_16155/*"_Rect"*/, v88, 0LL);
    Temporary_35676488 = (__int64)this->fields._material;
    if ( !Temporary_35676488 )
      goto LABEL_88;
    UnityEngine_Material__SetFloat(
      (UnityEngine_Material_o *)Temporary_35676488,
      (System_String_o *)StringLiteral_16190/*"_Thickness"*/,
    ...
    UnityEngine_Material__SetFloat(
      (UnityEngine_Material_o *)Temporary_35676488,
      (System_String_o *)StringLiteral_16193/*"_Threshold"*/,
    ...
    UnityEngine_Material__SetFloat(
      (UnityEngine_Material_o *)Temporary_35676488,
      (System_String_o *)StringLiteral_16109/*"_Intensity"*/,
    ...
    UnityEngine_Material__SetFloat(
      (UnityEngine_Material_o *)Temporary_35676488,
      (System_String_o *)StringLiteral_16135/*"_Offset"*/,
      this->fields._offset,
      0LL);
    Temporary_35676488 = (__int64)this->fields._material;
    if ( !Temporary_35676488 )
      goto LABEL_88;
    UnityEngine_Material__SetFloatArray_41522552(
      (UnityEngine_Material_o *)Temporary_35676488,
      (System_String_o *)StringLiteral_16207/*"_Weights"*/,
    ...
    UnityEngine_Graphics__Blit_41496468(v18, rt0, v20, 0, 0LL);
    Temporary_35676488 = (__int64)this->fields._rt0;
    if ( !Temporary_35676488 )
      goto LABEL_88;
    Temporary_35676488 = (*(__int64 (__fastcall **)(__int64, _QWORD))(*(_QWORD *)Temporary_35676488 + 376LL))(
                           Temporary_35676488,
                           *(_QWORD *)(*(_QWORD *)Temporary_35676488 + 384LL));
    v21 = this->fields._rt0;
    if ( !v21 )
      goto LABEL_88;
    v22 = Temporary_35676488;
    Temporary_35676488 = ((__int64 (__fastcall *)(struct UnityEngine_RenderTexture_o *, Il2CppMethodPointer))v21->klass->vtable._6_get_height.method)(
                           this->fields._rt0,
                           v21->klass->vtable._7_set_height.methodPtr);
    v23 = (System_Int32_array **)this->fields._rt0;
    if ( this->fields._iteration >= 1 )
    {
      v24 = Temporary_35676488;
      v25 = 0LL;
      v26 = 32LL;
      while ( 1 )
      {
        ...
        v22 = v27 >> 1;
        v24 = v28 >> 1;
        format = UnityEngine_RenderTexture__get_format((UnityEngine_RenderTexture_o *)Temporary_35676488, 0LL);
        Temporary_35676488 = (__int64)UnityEngine_RenderTexture__GetTemporary_35676488(v22, v24, 0, format, 0LL);
        if ( !renderTextures )
          goto LABEL_88;
        v23 = (System_Int32_array **)Temporary_35676488;
        if ( Temporary_35676488 )
        {
          Temporary_35676488 = sub_B52A44(Temporary_35676488, renderTextures->obj.klass->_1.element_class);
          if ( !Temporary_35676488 )
          {
            v79 = sub_B52A7C(0LL);
            sub_B52A28(v79, 0LL);
        ...
        *(Il2CppClass **)((char *)&renderTextures->obj.klass + v26) = (Il2CppClass *)v23;
        sub_B52920((BattleServantConfConponent_o *)((char *)renderTextures + v26), v23, v32, v33, v34, v35, v36, v37);
        ...
        UnityEngine_Graphics__Blit_41496468(v29, (UnityEngine_RenderTexture_o *)v23, v38, 1, 0LL);
        ++v25;
        v26 += 8LL;
      ...
      if ( (int)v25 - 2 >= 0 )
      {
        ...
        while ( 1 )
        {
          ...
          UnityEngine_Graphics__Blit_41496468(v29, (UnityEngine_RenderTexture_o *)v23, v42, 2, 0LL);
          ...
          *(Il2CppClass **)((char *)&v49->obj.klass + v40) = 0LL;
          sub_B52920((BattleServantConfConponent_o *)((char *)v49 + v40), 0LL, v43, v44, v45, v46, v47, v48);
...
LABEL_88:
        sub_B52A5C(Temporary_35676488, v17);
      }
...
LABEL_52:
    ...
    UnityEngine_Graphics__Blit_41496468((UnityEngine_Texture_o *)v23, v50, v51, 3, 0LL);
    UnityEngine_RenderTexture__ReleaseTemporary((UnityEngine_RenderTexture_o *)v23, 0LL);
    drawShader = this->fields._drawShader;
    v53 = (UnityEngine_Material_o *)sub_B52A54(UnityEngine_Material_TypeInfo);
    ...
    HasProperty_41519220 = UnityEngine_Material__HasProperty_41519220(v53, (System_String_o *)StringLiteral_16247/*"_customColor0"*/, 0LL);
    r = this->fields._color.fields.r;
    g = this->fields._color.fields.g;
    b = this->fields._color.fields.b;
    a = this->fields._color.fields.a;
    if ( HasProperty_41519220 )
      UnityEngine_Material__SetColor(v53, (System_String_o *)StringLiteral_16247/*"_customColor0"*/, *(UnityEngine_Color_o *)&r, 0LL);
    else
      UnityEngine_Material__set_color(v53, *(UnityEngine_Color_o *)&r, 0LL);
    Temporary_35676488 = (__int64)this->fields._renderer;
    if ( !Temporary_35676488 )
      goto LABEL_88;
    UnityEngine_Renderer__set_sharedMaterial((UnityEngine_Renderer_o *)Temporary_35676488, v53, 0LL);
    Temporary_35676488 = (__int64)this->fields._rt0;
    if ( !Temporary_35676488 )
      goto LABEL_88;
    Temporary_35676488 = (*(__int64 (__fastcall **)(__int64, _QWORD))(*(_QWORD *)Temporary_35676488 + 376LL))(
    ...
    v62 = (UnityEngine_Texture2D_o *)sub_B52A54(UnityEngine_Texture2D_TypeInfo);
    UnityEngine_Texture2D___ctor_35719436(v62, v60, v61, 3, 0, 0, 0LL);
    ...
    *(_QWORD *)&v90.fields.m_Width = methoda.invoker_method;
    UnityEngine_Texture2D__ReadPixels_35721636(v62, v90, 0, 0, 0LL);
    UnityEngine_Texture2D__Apply_35721460(v62, 0LL);
    ...
    if ( shapeSettingParticles )
    {
      ...
      if ( (int)v71 >= 1 )
      {
        ...
        while ( v72 < (unsigned int)v71 )
        {
          ...
          Temporary_35676488 = UnityEngine_Object__op_Equality(v73, 0LL, 0LL);
          if ( (Temporary_35676488 & 1) == 0 )
          {
            if ( !v73 )
              goto LABEL_88;
...
LABEL_89:
        v78 = sub_B52A88(Temporary_35676488);
        sub_B52A28(v78, 0LL);
      }
    }
LABEL_76:
    ...
    if ( colorSettingParticles )
    {
      ...
      if ( (int)v75 >= 1 )
      {
        ...
        while ( v76 < (unsigned int)v75 )
        {
          ...
          Temporary_35676488 = UnityEngine_Object__op_Equality(v77, 0LL, 0LL);
          if ( (Temporary_35676488 & 1) == 0 )
          {
            if ( !v77 )
              goto LABEL_88;
...
LABEL_18:
      ...
      v23 = ((__int64 (__fastcall *)(struct UnityEngine_Texture_o *, Il2CppMethodPointer))v21->klass->vtable._6_get_height.method)(
              ...
              v21->klass->vtable._7_set_height.methodPtr);
      v24 = (UnityEngine_RenderTexture_o *)sub_B52A54(UnityEngine_RenderTexture_TypeInfo);
      UnityEngine_RenderTexture___ctor_35675304(v24, v22, v23, 0, 0, 0LL);
      ...
      sub_B52920((BattleServantConfConponent_o *)p_renderer, (System_Int32_array **)v41, v34, v35, v36, v37, v38, v39);
...
void __fastcall FGOEdgeBlur__OnDestroy(FGOEdgeBlur_o *this, const MethodInfo *method)
{
  ...
  sub_B52920((BattleServantConfConponent_o *)&this->fields._material, 0LL, v2, v3, v4, v5, v6, v7);
  v8->fields._rt0 = 0LL;
