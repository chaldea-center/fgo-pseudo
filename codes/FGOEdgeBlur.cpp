void __fastcall FGOEdgeBlur___ctor(FGOEdgeBlur_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B4386A & 1) == 0 )
  {
    sub_1BDB878(&UnityEngine_RenderTexture___TypeInfo, method);
    sub_1BDB878(&float___TypeInfo, v3);
    byte_4B4386A = 1;
  }
  __asm { FMOV            V2.4S, #1.0 }
  this->fields._iteration = 4;
  this->fields._Rect = (struct UnityEngine_Rect_o)xmmword_BEA950;
  *(_OWORD *)&this->fields._thickness = xmmword_BEC220;
  this->fields._color = _Q2;
  this->fields._particleColor = _Q2;
  v9 = (struct UnityEngine_RenderTexture_array *)sub_1BDB920(UnityEngine_RenderTexture___TypeInfo, 6LL);
  this->fields._renderTextures = v9;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields._renderTextures, (int32_t)v9, v10, v11);
  v12 = (struct System_Single_array *)sub_1BDB920(float___TypeInfo, 10LL);
  this->fields._weights = v12;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields._weights, (int32_t)v12, v13, v14);
...
void __fastcall FGOEdgeBlur__Blur(FGOEdgeBlur_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B43869 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_16391/*"_Weights"*/, v6);
    sub_1BDB878(&StringLiteral_16356/*"_Threshold"*/, v7);
    sub_1BDB878(&StringLiteral_16227/*"_Intensity"*/, v8);
    sub_1BDB878(&StringLiteral_16523/*"_customColor0"*/, v9);
    sub_1BDB878(&StringLiteral_16300/*"_Rect"*/, v10);
    sub_1BDB878(&StringLiteral_16353/*"_Thickness"*/, v11);
    sub_1BDB878(&StringLiteral_16262/*"_Offset"*/, v12);
    byte_4B43869 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(texture, 0LL, 0LL) )
  {
    ...
    UnityEngine_Material__SetVector(
      ...
      (System_String_o *)StringLiteral_16300/*"_Rect"*/,
      v71,
      0LL);
    material = (__int64)this->fields._material;
    if ( !material )
    ...
    UnityEngine_Material__SetFloat(
      (UnityEngine_Material_o *)material,
      (System_String_o *)StringLiteral_16353/*"_Thickness"*/,
    ...
    UnityEngine_Material__SetFloat(
      (UnityEngine_Material_o *)material,
      (System_String_o *)StringLiteral_16356/*"_Threshold"*/,
    ...
    UnityEngine_Material__SetFloat(
      (UnityEngine_Material_o *)material,
      (System_String_o *)StringLiteral_16262/*"_Offset"*/,
      this->fields._offset,
      0LL);
    material = (__int64)this->fields._material;
    if ( !material )
      goto LABEL_82;
    UnityEngine_Material__SetFloatArray_70154388(
      (UnityEngine_Material_o *)material,
      (System_String_o *)StringLiteral_16391/*"_Weights"*/,
    ...
    UnityEngine_Graphics__Blit_70129540(v16, rt0, v18, 0, 0LL);
    ...
    if ( this->fields._iteration >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        material = (__int64)UnityEngine_RenderTexture__GetTemporary_70192320(v20, v23, 0, format, 0LL);
        if ( !renderTextures )
          goto LABEL_82;
        v31 = (UnityEngine_RenderTexture_o *)material;
        if ( material )
        {
          material = sub_1BDB9B4(material, renderTextures->obj.klass->_1.element_class);
          if ( !material )
          {
            v64 = sub_1BDBAF8(0LL);
            sub_1BDB9A0(v64, 0LL);
        ...
        *(Il2CppClass **)((char *)&renderTextures->obj.klass + v25) = (Il2CppClass *)v31;
        sub_1BDB81C((CGThumbnailListItem_o *)((char *)renderTextures + v25), (int32_t)v31, v21, v30);
        v32 = this->fields._material;
        if ( !UnityEngine_Graphics_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(UnityEngine_Graphics_TypeInfo);
        UnityEngine_Graphics__Blit_70129540(v22, v31, v32, 1, 0LL);
        ++v24;
        v25 += 8LL;
      ...
      if ( (int)v24 - 2 >= 0 )
      {
        ...
        while ( 1 )
        {
          ...
          if ( !UnityEngine_Graphics_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(UnityEngine_Graphics_TypeInfo);
          UnityEngine_Graphics__Blit_70129540(v22, v35, v36, 2, 0LL);
          ...
          v39[4] = 0LL;
          sub_1BDB81C((CGThumbnailListItem_o *)(v39 + 4), 0, v21, v37);
...
LABEL_49:
    ...
    if ( !UnityEngine_Graphics_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Graphics_TypeInfo);
    UnityEngine_Graphics__Blit_70129540((UnityEngine_Texture_o *)v35, v41, v42, 3, 0LL);
    UnityEngine_RenderTexture__ReleaseTemporary(v35, 0LL);
    drawShader = this->fields._drawShader;
    v44 = (UnityEngine_Material_o *)sub_1BDBAC4(UnityEngine_Material_TypeInfo);
    ...
    HasProperty_70150152 = UnityEngine_Material__HasProperty_70150152(v44, (System_String_o *)StringLiteral_16523/*"_customColor0"*/, 0LL);
    r = this->fields._color.fields.r;
    g = this->fields._color.fields.g;
    b = this->fields._color.fields.b;
    a = this->fields._color.fields.a;
    if ( HasProperty_70150152 )
      UnityEngine_Material__SetColor(v44, (System_String_o *)StringLiteral_16523/*"_customColor0"*/, *(UnityEngine_Color_o *)&r, 0LL);
    else
    ...
    v53 = (UnityEngine_Texture2D_o *)sub_1BDBAC4(UnityEngine_Texture2D_TypeInfo);
    UnityEngine_Texture2D___ctor_70172040(v53, v51, v52, 3, 0, 0, 0LL);
    ...
    {
LABEL_82:
      sub_1BDBAD4(material, v14);
    }
    v72.fields.m_Height = (float)(int)material;
    v72.fields.m_Width = (float)v55;
    v72.fields.m_XMin = 0.0;
    v72.fields.m_YMin = 0.0;
    UnityEngine_Texture2D__ReadPixels_70174504(v53, v72, 0, 0, 0LL);
    UnityEngine_Texture2D__Apply_70174084(v53, 0LL);
...
void __fastcall FGOEdgeBlur__Initialize(FGOEdgeBlur_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B43868 & 1) == 0 )
  {
    ...
    sub_1BDB878(&UnityEngine_RenderTexture_TypeInfo, v4);
    sub_1BDB878(&UnityEngine_Renderer_var, v5);
    sub_1BDB878(&UnityEngine_Renderer_TypeInfo, v6);
...
LABEL_17:
      ...
      sub_1BDB81C((CGThumbnailListItem_o *)&this->fields._material, (int32_t)v19, v20, v21);
      ...
      v27 = (UnityEngine_RenderTexture_o *)sub_1BDBAC4(UnityEngine_RenderTexture_TypeInfo);
      UnityEngine_RenderTexture___ctor_70190704(v27, v25, v26, 0, 0, 0LL);
      this->fields._rt0 = v27;
      sub_1BDB81C((CGThumbnailListItem_o *)&this->fields._rt0, (int32_t)v27, v28, v29);
      ...
      sub_1BDB81C((CGThumbnailListItem_o *)p_renderer, v38, v33, v34);
...
void __fastcall FGOEdgeBlur__OnDestroy(FGOEdgeBlur_o *this, const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields._material, 0, v2, v3);
  v4->fields._rt0 = 0LL;
...
void __fastcall FGOEdgeBlur__set_Texture(FGOEdgeBlur_o *this, UnityEngine_Texture_o *value, const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields._texture, (int32_t)value, (int32_t)method, v3);
