...
System_String_o *__fastcall ServantAddEntity__GetIdentifyText(ServantAddEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B45249 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_16657/*"addIdentifyText"*/, v4);
    byte_4B45249 = 1;
  }
  value = 0LL;
  ...
  if ( result )
  {
    if ( !System_Collections_Generic_Dictionary_object__object___TryGetValue(
            ...
            (Il2CppObject *)StringLiteral_16657/*"addIdentifyText"*/,
            &value,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45248 & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__, method);
    sub_1BDB878(&string_TypeInfo, v3);
    sub_1BDB878(&StringLiteral_22531/*"overWriteServantShortName"*/, v4);
    byte_4B45248 = 1;
  }
  value = 0LL;
  result = (System_String_o *)this->fields.script;
  if ( result )
  {
    if ( !System_Collections_Generic_Dictionary_object__object___TryGetValue(
            (System_Collections_Generic_Dictionary_object__object__o *)result,
            (Il2CppObject *)StringLiteral_22531/*"overWriteServantShortName"*/,
            &value,
            (const MethodInfo_33A1A3C *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
      return 0LL;
    result = (System_String_o *)value;
...
int32_t __fastcall ServantAddEntity__GetPresentDialogMessageId(ServantAddEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B45247 & 1) == 0 )
  {
    sub_1BDB878(&ServantAddMaster_TypeInfo, method);
    byte_4B45247 = 1;
  }
