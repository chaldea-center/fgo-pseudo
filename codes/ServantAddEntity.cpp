...
System_String_o *__fastcall ServantAddEntity__GetIdentifyText(ServantAddEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B027FD & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_16524/*"addIdentifyText"*/, v4);
    byte_4B027FD = 1;
  }
  value = 0LL;
  ...
  if ( result )
  {
    if ( !System_Collections_Generic_Dictionary_object__object___TryGetValue(
            ...
            (Il2CppObject *)StringLiteral_16524/*"addIdentifyText"*/,
            &value,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B027FC & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__, method);
    sub_1BC3008(&string_TypeInfo, v3);
    sub_1BC3008(&StringLiteral_22292/*"overWriteServantShortName"*/, v4);
    byte_4B027FC = 1;
  }
  value = 0LL;
  result = (System_String_o *)this->fields.script;
  if ( result )
  {
    if ( !System_Collections_Generic_Dictionary_object__object___TryGetValue(
            (System_Collections_Generic_Dictionary_object__object__o *)result,
            (Il2CppObject *)StringLiteral_22292/*"overWriteServantShortName"*/,
            &value,
            (const MethodInfo_336E7F4 *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
      return 0LL;
    result = (System_String_o *)value;
...
int32_t __fastcall ServantAddEntity__GetPresentDialogMessageId(ServantAddEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B027FB & 1) == 0 )
  {
    sub_1BC3008(&ServantAddMaster_TypeInfo, method);
    byte_4B027FB = 1;
  }
