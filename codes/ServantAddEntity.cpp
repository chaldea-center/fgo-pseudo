...
System_String_o *__fastcall ServantAddEntity__GetIdentifyText(ServantAddEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4EC4F & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_16434/*"addIdentifyText"*/, v4);
    byte_4A4EC4F = 1;
  }
  value = 0LL;
  ...
  if ( result )
  {
    if ( !System_Collections_Generic_Dictionary_object__object___TryGetValue(
            ...
            (Il2CppObject *)StringLiteral_16434/*"addIdentifyText"*/,
            &value,
        ...
        const MethodInfo *method)
{
  ...
  if ( result )
  {
    if ( !System_Collections_Generic_Dictionary_object__object___TryGetValue(
            (System_Collections_Generic_Dictionary_object__object__o *)result,
            (Il2CppObject *)StringLiteral_22191/*"overWriteServantShortName"*/,
            &value,
            (const MethodInfo_32CFEEC *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
      return 0LL;
    result = (System_String_o *)value;
...
int32_t __fastcall ServantAddEntity__GetPresentDialogMessageId(ServantAddEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4EC4D & 1) == 0 )
  {
    sub_1B863B8(&ServantAddMaster_TypeInfo, method);
    byte_4A4EC4D = 1;
  }
