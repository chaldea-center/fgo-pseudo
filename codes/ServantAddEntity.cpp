...
System_String_o *__fastcall ServantAddEntity__GetIdentifyText(ServantAddEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC8129 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_16936/*"addIdentifyText"*/, v4);
    byte_4BC8129 = 1;
  }
  value = 0LL;
  ...
  if ( result )
  {
    if ( !System_Collections_Generic_Dictionary_object__object___TryGetValue(
            ...
            (Il2CppObject *)StringLiteral_16936/*"addIdentifyText"*/,
            &value,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC8128 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__, method);
    sub_1C1ABD4(&string_TypeInfo, v3);
    sub_1C1ABD4(&StringLiteral_22746/*"overWriteServantShortName"*/, v4);
    byte_4BC8128 = 1;
  }
  value = 0LL;
  result = (System_String_o *)this->fields.script;
  if ( result )
  {
    if ( !System_Collections_Generic_Dictionary_object__object___TryGetValue(
            (System_Collections_Generic_Dictionary_object__object__o *)result,
            (Il2CppObject *)StringLiteral_22746/*"overWriteServantShortName"*/,
            &value,
            (const MethodInfo_33044FC *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
      return 0LL;
    result = (System_String_o *)value;
...
int32_t __fastcall ServantAddEntity__GetPresentDialogMessageId(ServantAddEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC8127 & 1) == 0 )
  {
    sub_1C1ABD4(&ServantAddMaster_TypeInfo, method);
    byte_4BC8127 = 1;
  }
