...
System_String_o *__fastcall ServantAddEntity__GetIdentifyText(ServantAddEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFDDF1 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&StringLiteral_16959/*"addIdentifyText"*/, v4);
    byte_4BFDDF1 = 1;
  }
  value = 0LL;
  ...
  if ( result )
  {
    if ( !System_Collections_Generic_Dictionary_object__object___TryGetValue(
            ...
            (Il2CppObject *)StringLiteral_16959/*"addIdentifyText"*/,
            &value,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFDDF0 & 1) == 0 )
  {
    sub_1C2E12C(&Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__, method);
    sub_1C2E12C(&string_TypeInfo, v3);
    sub_1C2E12C(&StringLiteral_22779/*"overWriteServantShortName"*/, v4);
    byte_4BFDDF0 = 1;
  }
  value = 0LL;
  result = (System_String_o *)this->fields.script;
  if ( result )
  {
    if ( !System_Collections_Generic_Dictionary_object__object___TryGetValue(
            (System_Collections_Generic_Dictionary_object__object__o *)result,
            (Il2CppObject *)StringLiteral_22779/*"overWriteServantShortName"*/,
            &value,
            (const MethodInfo_3337380 *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
      return 0LL;
    result = (System_String_o *)value;
...
int32_t __fastcall ServantAddEntity__GetPresentDialogMessageId(ServantAddEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFDDEF & 1) == 0 )
  {
    sub_1C2E12C(&ServantAddMaster_TypeInfo, method);
    byte_4BFDDEF = 1;
  }
