        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67224 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_22676/*"overWriteServantShortName"*/, v4);
    byte_4B67224 = 1;
  }
  value = 0LL;
  ...
  if ( result )
  {
    if ( !System_Collections_Generic_Dictionary_object__object___TryGetValue(
            ...
            (Il2CppObject *)StringLiteral_22676/*"overWriteServantShortName"*/,
            &value,
...
int32_t __fastcall ServantAddEntity__GetPresentDialogMessageId(ServantAddEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B67223 & 1) == 0 )
  {
    sub_1BE4ACC(&ServantAddMaster_TypeInfo, method);
    byte_4B67223 = 1;
  }
