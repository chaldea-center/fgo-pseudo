        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A7049B & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_22391/*"overWriteServantShortName"*/, v4);
    byte_4A7049B = 1;
  }
  value = 0LL;
  ...
  if ( result )
  {
    if ( !System_Collections_Generic_Dictionary_object__object___TryGetValue(
            ...
            (Il2CppObject *)StringLiteral_22391/*"overWriteServantShortName"*/,
            &value,
...
int32_t __fastcall ServantAddEntity__GetPresentDialogMessageId(ServantAddEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A7049A & 1) == 0 )
  {
    sub_1B90010(&ServantAddMaster_TypeInfo, method);
    byte_4A7049A = 1;
  }
