        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E561 & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_22349/*"overWriteServantShortName"*/, v4);
    byte_4A2E561 = 1;
  }
  value = 0LL;
  ...
  if ( result )
  {
    if ( !System_Collections_Generic_Dictionary_object__object___TryGetValue(
            ...
            (Il2CppObject *)StringLiteral_22349/*"overWriteServantShortName"*/,
            &value,
...
int32_t __fastcall ServantAddEntity__GetPresentDialogMessageId(ServantAddEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2E560 & 1) == 0 )
  {
    sub_1B761C0(&ServantAddMaster_TypeInfo, method);
    byte_4A2E560 = 1;
  }
