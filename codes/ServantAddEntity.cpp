...
System_String_o *__fastcall ServantAddEntity__GetIdentifyText(ServantAddEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BB52D & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_16361/*"addIdentifyText"*/, v4);
    byte_49BB52D = 1;
  }
  value = 0LL;
  ...
  if ( result )
  {
    if ( !System_Collections_Generic_Dictionary_object__object___TryGetValue(
            ...
            (Il2CppObject *)StringLiteral_16361/*"addIdentifyText"*/,
            &value,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BB52C & 1) == 0 )
  {
    sub_1B4CF90(&Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__, method);
    sub_1B4CF90(&string_TypeInfo, v3);
    sub_1B4CF90(&StringLiteral_22077/*"overWriteServantShortName"*/, v4);
    byte_49BB52C = 1;
  }
  value = 0LL;
  result = (System_String_o *)this->fields.script;
  if ( result )
  {
    if ( !System_Collections_Generic_Dictionary_object__object___TryGetValue(
            (System_Collections_Generic_Dictionary_object__object__o *)result,
            (Il2CppObject *)StringLiteral_22077/*"overWriteServantShortName"*/,
            &value,
            (const MethodInfo_3259324 *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
      return 0LL;
    result = (System_String_o *)value;
...
int32_t __fastcall ServantAddEntity__GetPresentDialogMessageId(ServantAddEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BB52B & 1) == 0 )
  {
    sub_1B4CF90(&ServantAddMaster_TypeInfo, method);
    byte_49BB52B = 1;
  }
