void DataEntityBase_long____ctor(DataEntityBase_long__o *this, const MethodInfo_33B0ABC *method)
{
  DataEntityBase___ctor((DataEntityBase_o *)this, 0);
}


System_String_o *DataEntityBase_long___get_PrimaryKey(DataEntityBase_long__o *this, const MethodInfo_33B0A7C *method)
{
