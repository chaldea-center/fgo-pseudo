...
void SupportDeckFixErrorDialog__Close(SupportDeckFixErrorDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C23927 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_SupportDeckFixErrorDialog_OnFinishedClose__);
    byte_4C23927 = 1;
  }
  this->fields.state = 3;
...
void SupportDeckFixErrorDialog__OnClickClose(SupportDeckFixErrorDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C23928 & 1) == 0 )
  {
    sub_1C2D490(&Method_SupportDeckFixErrorDialog_OnClickClose__);
    byte_4C23928 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportDeckFixErrorDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2D4A8(Method_SupportDeckFixErrorDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C23926 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_SupportDeckFixErrorDialog_OnFinishedOpen__);
    sub_1C2D490(&StringLiteral_12486/*"SUPPORT_DECK_FIXED_ERROR_MESSAGE"*/);
    sub_1C2D490(&StringLiteral_12489/*"SUPPORT_DECK_FIXED_ERROR_TITLE"*/);
  ...
  if ( state == 3 || !state )
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12489/*"SUPPORT_DECK_FIXED_ERROR_TITLE"*/, 0);
    if ( !titleLabel
      || (UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0),
          messageLabel = this->fields.messageLabel,
          gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12486/*"SUPPORT_DECK_FIXED_ERROR_MESSAGE"*/, 0),
          !messageLabel)
