...
void __fastcall SupportDeckFixErrorDialog__Close(SupportDeckFixErrorDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A57A98 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_SupportDeckFixErrorDialog_OnFinishedClose__);
    byte_4A57A98 = 1;
  }
  this->fields.state = 3;
...
void __fastcall SupportDeckFixErrorDialog__OnClickClose(SupportDeckFixErrorDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A57A99 & 1) == 0 )
  {
    sub_1B885B0(&Method_SupportDeckFixErrorDialog_OnClickClose__);
    byte_4A57A99 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportDeckFixErrorDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B885C8(Method_SupportDeckFixErrorDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57A97 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_SupportDeckFixErrorDialog_OnFinishedOpen__);
    sub_1B885B0(&StringLiteral_12387/*"SUPPORT_DECK_FIXED_ERROR_MESSAGE"*/);
    sub_1B885B0(&StringLiteral_12390/*"SUPPORT_DECK_FIXED_ERROR_TITLE"*/);
  ...
  if ( state == 3 || !state )
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12390/*"SUPPORT_DECK_FIXED_ERROR_TITLE"*/, 0LL);
    if ( !titleLabel
      || (UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL),
          messageLabel = this->fields.messageLabel,
          gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12387/*"SUPPORT_DECK_FIXED_ERROR_MESSAGE"*/, 0LL),
          !messageLabel)
