...
void __fastcall SupportDeckFixErrorDialog__Close(SupportDeckFixErrorDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1E75B & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_SupportDeckFixErrorDialog_OnFinishedClose__, v3);
    byte_4C1E75B = 1;
  }
  this->fields.state = 3;
...
void __fastcall SupportDeckFixErrorDialog__OnClickClose(SupportDeckFixErrorDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1E75C & 1) == 0 )
  {
    sub_1C3B764(&Method_SupportDeckFixErrorDialog_OnClickClose__, method);
    byte_4C1E75C = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportDeckFixErrorDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3B77C(Method_SupportDeckFixErrorDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E75A & 1) == 0 )
  {
    sub_1C3B764(&System_Action_TypeInfo, messageList);
    sub_1C3B764(&LocalizationManager_TypeInfo, v5);
    sub_1C3B764(&Method_SupportDeckFixErrorDialog_OnFinishedOpen__, v6);
    sub_1C3B764(&StringLiteral_12668/*"Spitfire"*/, v7);
    sub_1C3B764(&StringLiteral_12671/*"Spot"*/, v8);
  ...
  if ( state == 3 || !state )
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12671/*"Spot"*/, 0LL);
    if ( !titleLabel
      || (UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL),
          messageLabel = this->fields.messageLabel,
          gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12668/*"Spitfire"*/, 0LL),
          !messageLabel)
