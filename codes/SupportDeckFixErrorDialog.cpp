...
void SupportDeckFixErrorDialog__Close(SupportDeckFixErrorDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596CBF5 & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_SupportDeckFixErrorDialog_OnFinishedClose__);
    byte_596CBF5 = 1;
  }
...
void SupportDeckFixErrorDialog__OnClickClose(SupportDeckFixErrorDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596CBF6 & 1) == 0 )
  {
    sub_2213A60(&Method_SupportDeckFixErrorDialog_OnClickClose__);
    byte_596CBF6 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportDeckFixErrorDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_2213A78(Method_SupportDeckFixErrorDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596CBF4 & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_SupportDeckFixErrorDialog_OnFinishedOpen__);
    sub_2213A60(&StringLiteral_13017/*"SUPPORT_DECK_FIXED_ERROR_MESSAGE"*/);
    sub_2213A60(&StringLiteral_13020/*"SUPPORT_DECK_FIXED_ERROR_TITLE"*/);
  ...
  if ( state == 3 || !state )
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_13020/*"SUPPORT_DECK_FIXED_ERROR_TITLE"*/, 0);
    if ( !titleLabel
      || (UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0),
          messageLabel = this->fields.messageLabel,
          gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_13017/*"SUPPORT_DECK_FIXED_ERROR_MESSAGE"*/, 0),
          !messageLabel)
