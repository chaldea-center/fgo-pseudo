...
void __fastcall SupportDeckFixErrorDialog__Close(SupportDeckFixErrorDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6C792 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_SupportDeckFixErrorDialog_OnFinishedClose__, v3);
    byte_4A6C792 = 1;
  }
  this->fields.state = 3;
...
void __fastcall SupportDeckFixErrorDialog__OnClickClose(SupportDeckFixErrorDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6C793 & 1) == 0 )
  {
    sub_1B90010(&Method_SupportDeckFixErrorDialog_OnClickClose__, method);
    byte_4A6C793 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportDeckFixErrorDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B90028(Method_SupportDeckFixErrorDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6C791 & 1) == 0 )
  {
    sub_1B90010(&System_Action_TypeInfo, messageList);
    sub_1B90010(&LocalizationManager_TypeInfo, v5);
    sub_1B90010(&Method_SupportDeckFixErrorDialog_OnFinishedOpen__, v6);
    sub_1B90010(&StringLiteral_12412/*"SUPPORT_DECK_FIXED_ERROR_MESSAGE"*/, v7);
    sub_1B90010(&StringLiteral_12415/*"SUPPORT_DECK_FIXED_ERROR_TITLE"*/, v8);
  ...
  if ( state == 3 || !state )
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12415/*"SUPPORT_DECK_FIXED_ERROR_TITLE"*/, 0LL);
    if ( !titleLabel
      || (UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL),
          messageLabel = this->fields.messageLabel,
          gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12412/*"SUPPORT_DECK_FIXED_ERROR_MESSAGE"*/, 0LL),
          !messageLabel)
