        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BC7A3 & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_16738/*"bankShopId"*/, *(_QWORD *)&shopId);
    byte_49BC7A3 = 1;
  }
  this->fields.cancelShopId = shopId;
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_16738/*"bankShopId"*/, shopId, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BC7A2 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_22990/*"shop/cancelPurchaseByBank"*/, v2);
    byte_49BC7A2 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61093468(BaseUrl, (System_String_o *)StringLiteral_22990/*"shop/cancelPurchaseByBank"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( v8 && (v9 = v8, ResponseData__checkError_41839176(v8, 0LL)) && v9->fields.success )
  {
