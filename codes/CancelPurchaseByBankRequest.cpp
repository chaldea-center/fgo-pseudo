...
System_String_o *CancelPurchaseByBankRequest__getURL(CancelPurchaseByBankRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C5880A & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_23455/*"shop/cancelPurchaseByBank"*/);
    byte_4C5880A = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63636468(BaseUrl, (System_String_o *)StringLiteral_23455/*"shop/cancelPurchaseByBank"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    v9 = (System_String_o *)StringLiteral_22233/*"ng"*/;
  }
