        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B68441 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_17270/*"bankShopId"*/, *(_QWORD *)&shopId);
    byte_4B68441 = 1;
  }
  this->fields.cancelShopId = shopId;
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_17270/*"bankShopId"*/, shopId, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B68440 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_23596/*"shop/cancelPurchaseByBank"*/, v2);
    byte_4B68440 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62698808(BaseUrl, (System_String_o *)StringLiteral_23596/*"shop/cancelPurchaseByBank"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( v8 && (v9 = v8, ResponseData__checkError_42194996(v8, 0LL)) && v9->fields.success )
  {
