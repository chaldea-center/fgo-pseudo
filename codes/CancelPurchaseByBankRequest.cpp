        ...
        const MethodInfo *method)
{
  if ( (byte_49FFC10 & 1) == 0 )
  {
    sub_1B64870(&StringLiteral_16991/*"bankShopId"*/, *(_QWORD *)&shopId);
    byte_49FFC10 = 1;
  }
  this->fields.cancelShopId = shopId;
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_16991/*"bankShopId"*/, shopId, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFC0F & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_23171/*"shop/cancelPurchaseByBank"*/, v2);
    byte_49FFC0F = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61383576(BaseUrl, (System_String_o *)StringLiteral_23171/*"shop/cancelPurchaseByBank"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( v8 && (v9 = v8, ResponseData__checkError_40851148(v8, 0LL)) && v9->fields.success )
  {
