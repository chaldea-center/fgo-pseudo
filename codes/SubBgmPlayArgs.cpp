BgmPlayArgs_o *SubBgmPlayArgs__Clone(SubBgmPlayArgs_o *this, const MethodInfo *method)
{
  ...
  v8 = (BgmPlayArgs_o *)sub_1C3E7B0(SubBgmPlayArgs_TypeInfo);
  v9 = volume;
  v10 = v8;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C563A1 & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_System_Collections_Generic_List_SubBgmPlayArgs__Add__);
    sub_1C3E564(&Method_System_Collections_Generic_List_SubBgmPlayArgs__ToArray__);
    sub_1C3E564(&Method_System_Collections_Generic_List_SubBgmPlayArgs___ctor__);
    sub_1C3E564(&System_Collections_Generic_List_SubBgmPlayArgs__TypeInfo);
    sub_1C3E564(&Method_System_Nullable_float___ctor__);
    sub_1C3E564(&SubBgmPlayArgs_TypeInfo);
    byte_4C563A1 = 1;
  }
  entity = 0;
  v3 = (System_Collections_Generic_List_object__o *)sub_1C3E7B0(System_Collections_Generic_List_SubBgmPlayArgs__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v3,
    (const MethodInfo_37B4C2C *)Method_System_Collections_Generic_List_SubBgmPlayArgs___ctor__);
      ...
      if ( v10 )
      {
        ...
        if ( ((unsigned __int8)Master_object & 1) != 0 )
        {
          ...
          System_Nullable_float____ctor(
            ...
            v12,
            (const MethodInfo_38DD2E0 *)Method_System_Nullable_float___ctor__);
          v15 = (BgmPlayArgs_o *)sub_1C3E7B0(SubBgmPlayArgs_TypeInfo);
          v16 = volume;
...
LABEL_28:
  ...
  return (SubBgmPlayArgs_array *)System_Collections_Generic_List_object___ToArray(
                                   v3,
                                   (const MethodInfo_37B6FB8 *)Method_System_Collections_Generic_List_SubBgmPlayArgs__ToArray__);
}