        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D27169 & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_EventTradeSweetsWithdrawalConfirmDialogComponent__Close_b__45_0__);
    byte_4D27169 = 1;
  }
  this->fields.state = 4;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D27168 & 1) == 0 )
  {
    sub_1C94098(&Method_EventTradeSweetsWithdrawalConfirmDialogComponent_OnClickCancel__);
    byte_4D27168 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_EventTradeSweetsWithdrawalConfirmDialogComponent_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C940B0(Method_EventTradeSweetsWithdrawalConfirmDialogComponent_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D27167 & 1) == 0 )
  {
    sub_1C94098(&Method_EventTradeSweetsWithdrawalConfirmDialogComponent_OnClickDecide__);
    byte_4D27167 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_EventTradeSweetsWithdrawalConfirmDialogComponent_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C940B0(Method_EventTradeSweetsWithdrawalConfirmDialogComponent_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C9407C(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C94098(&System_Action_TypeInfo);
    sub_1C94098(&Method_EventTradeSweetsWithdrawalConfirmDialogComponent_EndOpen__);
    byte_4D27163 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D27165 & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_13557/*"TRADE_EVENT_WITHDRAWAL_DIALOG_COUNT_KIND"*/);
    byte_4D27165 = 1;
  }
  ...
  exchangeOriginLb = (UnityEngine_Component_o *)DataManager__GetMaster_object_((const MethodInfo_319C0E0 *)Method_DataManager_GetMaster_UserItemMaster___);
    ...
    else
    {
      ...
      while ( 1 )
      {
        ...
        if ( !exchangeOriginItemIcon2 )
          break;
        if ( v22 >= LODWORD(exchangeOriginItemIcon2->max_length) || v22 >= (unsigned int)max_length )
LABEL_76:
          sub_1C942F8(exchangeOriginLb);
        ...
        AtlasManager__SetItem(v25, objectId, 0);
        ...
        if ( !exchangeOriginCounts2 )
          break;
        if ( v22 >= LODWORD(exchangeOriginCounts2->max_length) )
          goto LABEL_76;
        if ( !exchangeOriginLb )
          break;
        ...
        if ( !v30 )
          break;
        UILabel__set_text(v30, (System_String_o *)exchangeOriginLb, 0);
        exchangeOriginCountKinds2 = this->fields.exchangeOriginCountKinds2;
        if ( !exchangeOriginCountKinds2 )
          break;
        if ( v22 >= LODWORD(exchangeOriginCountKinds2->max_length) )
          goto LABEL_76;
        v33 = exchangeOriginCountKinds2->m_Items[v22];
        exchangeOriginLb = (UnityEngine_Component_o *)LocalizationManager__Get(
                                                        (System_String_o *)StringLiteral_13557/*"TRADE_EVENT_WITHDRAWAL_DIALOG_COUNT_KIND"*/,
                                                        0);
        if ( !v33 )
          break;
        UILabel__set_text(v33, (System_String_o *)exchangeOriginLb, 0);
        exchangeOriginItemList = this->fields.exchangeOriginItemList;
        if ( !exchangeOriginItemList )
          break;
...
LABEL_75:
    sub_1C942F0(exchangeOriginLb, method);
  }
  v9 = 0;
  do
  {
    ...
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetItem(v12, v13, 0);
    if ( !NetworkManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
    if ( !byte_4D2633A )
    {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    exchangeOriginLb = (UnityEngine_Component_o *)LocalizationManager__GetNumberFormatLong(v18, 0);
    if ( !v17 )
      goto LABEL_75;
    UILabel__set_text(v17, (System_String_o *)exchangeOriginLb, 0);
    exchangeOriginCountKinds = this->fields.exchangeOriginCountKinds;
    if ( !exchangeOriginCountKinds )
      goto LABEL_75;
    if ( (unsigned int)v9 >= LODWORD(exchangeOriginCountKinds->max_length) )
      goto LABEL_76;
    v20 = exchangeOriginCountKinds->m_Items[v9];
    exchangeOriginLb = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_13557/*"TRADE_EVENT_WITHDRAWAL_DIALOG_COUNT_KIND"*/, 0);
    if ( !v20 )
      goto LABEL_75;
    UILabel__set_text(v20, (System_String_o *)exchangeOriginLb, 0);
    exchangeOriginItemList = this->fields.exchangeOriginItemList;
    if ( !exchangeOriginItemList )
      goto LABEL_75;
    LODWORD(max_length) = exchangeOriginItemList->max_length;
...
LABEL_72:
  ...
  v36.fields.z = z;
  v36.fields.x = v34;
  UnityEngine_Transform__set_localPosition((UnityEngine_Transform_o *)exchangeOriginLb, v36, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  exchangeOriginLbAfter = (UnityEngine_Component_o *)DataManager__GetMaster_object_((const MethodInfo_319C0E0 *)Method_DataManager_GetMaster_UserItemMaster___);
  exchangeOriginItemList = this->fields.exchangeOriginItemList;
  if ( !exchangeOriginItemList )
    goto LABEL_81;
  max_length = exchangeOriginItemList->max_length;
    ...
    else
    {
      ...
      while ( 1 )
      {
        ...
        if ( !exchangeOriginItemIcon2After )
          break;
        if ( v27 >= LODWORD(exchangeOriginItemIcon2After->max_length) || v27 >= (unsigned int)max_length )
LABEL_82:
          sub_1C942F8(exchangeOriginLbAfter);
        ...
        if ( !AtlasManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
        AtlasManager__SetItem(v31, objectId, 0);
        if ( !NetworkManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
        if ( !byte_4D2633A )
        {
        ...
        if ( !exchangeOriginCounts2After )
          break;
        if ( v27 >= LODWORD(exchangeOriginCounts2After->max_length) )
          goto LABEL_82;
        if ( !exchangeOriginLbAfter )
          break;
        ...
        if ( !v37 )
          break;
        UILabel__set_text(v37, (System_String_o *)exchangeOriginLbAfter, 0);
        exchangeOriginCountKinds2After = this->fields.exchangeOriginCountKinds2After;
        if ( !exchangeOriginCountKinds2After )
          break;
        if ( v27 >= LODWORD(exchangeOriginCountKinds2After->max_length) )
          goto LABEL_82;
        ...
        if ( !v41 )
          break;
        UILabel__set_text(v41, (System_String_o *)exchangeOriginLbAfter, 0);
        exchangeOriginItemList = this->fields.exchangeOriginItemList;
        if ( !exchangeOriginItemList )
          break;
        LODWORD(max_length) = exchangeOriginItemList->max_length;
...
LABEL_81:
    sub_1C942F0(exchangeOriginLbAfter, *(_QWORD *)&completeNum);
  }
  v11 = 0;
  do
  {
    ...
    if ( !exchangeOriginItemIconAfter )
      goto LABEL_81;
    if ( (unsigned int)v11 >= LODWORD(exchangeOriginItemIconAfter->max_length) || v11 >= (unsigned int)max_length )
      goto LABEL_82;
    ...
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetItem(v15, v14, 0);
    if ( !NetworkManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
    if ( !byte_4D2633A )
    {
    ...
    if ( !exchangeOriginCountsAfter )
      goto LABEL_81;
    if ( (unsigned int)v11 >= LODWORD(exchangeOriginCountsAfter->max_length) )
      goto LABEL_82;
    if ( !exchangeOriginLbAfter )
      goto LABEL_81;
    ...
    if ( !v19 )
      goto LABEL_81;
    if ( (unsigned int)v11 >= LODWORD(v19->max_length) )
      goto LABEL_82;
    v20 = v19->m_Items[v11];
    if ( !v20 )
      goto LABEL_81;
    ...
    if ( !v21 )
      goto LABEL_81;
    UILabel__set_text(v21, (System_String_o *)exchangeOriginLbAfter, 0);
    exchangeOriginCountKindsAfter = this->fields.exchangeOriginCountKindsAfter;
    if ( !exchangeOriginCountKindsAfter )
      goto LABEL_81;
    if ( (unsigned int)v11 >= LODWORD(exchangeOriginCountKindsAfter->max_length) )
      goto LABEL_82;
    ...
    if ( !v25 )
      goto LABEL_81;
    UILabel__set_text(v25, (System_String_o *)exchangeOriginLbAfter, 0);
    exchangeOriginItemList = this->fields.exchangeOriginItemList;
    if ( !exchangeOriginItemList )
      goto LABEL_81;
    LODWORD(max_length) = exchangeOriginItemList->max_length;
...
LABEL_78:
  ...
  v44.fields.z = z;
  v44.fields.x = v42;
  UnityEngine_Transform__set_localPosition((UnityEngine_Transform_o *)exchangeOriginLbAfter, v44, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D27164 & 1) == 0 )
  {
    ...
    sub_1C94098(&DataManager_TypeInfo);
    sub_1C94098(&LocalizationManager_TypeInfo);
    sub_1C94098(&StringLiteral_13556/*"TRADE_EVENT_WITHDRAWAL_DIALOG_BEFORE_LABEL"*/);
    sub_1C94098(&StringLiteral_13561/*"TRADE_EVENT_WITHDRAWAL_DIALOG_RETURN_ITEMS_NONE"*/);
    sub_1C94098(&StringLiteral_13562/*"TRADE_EVENT_WITHDRAWAL_DIALOG_TITLE"*/);
    sub_1C94098(&StringLiteral_3689/*"COMMON_CONFIRM_CANCEL"*/);
    sub_1C94098(&StringLiteral_13559/*"TRADE_EVENT_WITHDRAWAL_DIALOG_MESSAGE"*/);
    sub_1C94098(&StringLiteral_13555/*"TRADE_EVENT_WITHDRAWAL_DIALOG_AFTER_LABEL"*/);
    sub_1C94098(&StringLiteral_13558/*"TRADE_EVENT_WITHDRAWAL_DIALOG_EXECUTE"*/);
    this = (EventTradeSweetsWithdrawalConfirmDialogComponent_o *)sub_1C94098(&StringLiteral_13560/*"TRADE_EVENT_WITHDRAWAL_DIALOG_RETURN_ITEMS"*/);
    byte_4D27164 = 1;
  }
  if ( !item )
    goto LABEL_29;
  ...
  sub_1C9403C(&v6->fields.tradeGoodsEntity, TradeGoodsEntity_k__BackingField);
  v6->fields.onDecide = onDecide;
  sub_1C9403C(&v6->fields.onDecide, onDecide);
  ...
  this = (EventTradeSweetsWithdrawalConfirmDialogComponent_o *)LocalizationManager__Get(
                                                                 (System_String_o *)StringLiteral_13562/*"TRADE_EVENT_WITHDRAWAL_DIALOG_TITLE"*/,
                                                                 0);
  if ( !titleLabel )
    goto LABEL_29;
  ...
  this = (EventTradeSweetsWithdrawalConfirmDialogComponent_o *)LocalizationManager__Get(
                                                                 (System_String_o *)StringLiteral_13559/*"TRADE_EVENT_WITHDRAWAL_DIALOG_MESSAGE"*/,
                                                                 0);
  if ( !detailLabel )
    goto LABEL_29;
  ...
  this = (EventTradeSweetsWithdrawalConfirmDialogComponent_o *)LocalizationManager__Get(
                                                                 (System_String_o *)StringLiteral_13556/*"TRADE_EVENT_WITHDRAWAL_DIALOG_BEFORE_LABEL"*/,
                                                                 0);
  if ( !exchangeOriginLb )
    goto LABEL_29;
  ...
  this = (EventTradeSweetsWithdrawalConfirmDialogComponent_o *)LocalizationManager__Get(
                                                                 (System_String_o *)StringLiteral_13555/*"TRADE_EVENT_WITHDRAWAL_DIALOG_AFTER_LABEL"*/,
                                                                 0);
  if ( !exchangeOriginLbAfter )
    goto LABEL_29;
  ...
  this = (EventTradeSweetsWithdrawalConfirmDialogComponent_o *)LocalizationManager__Get(
                                                                 (System_String_o *)StringLiteral_13558/*"TRADE_EVENT_WITHDRAWAL_DIALOG_EXECUTE"*/,
                                                                 0);
  if ( !decideButtonLb )
    goto LABEL_29;
  ...
  this = (EventTradeSweetsWithdrawalConfirmDialogComponent_o *)LocalizationManager__Get(
                                                                 (System_String_o *)StringLiteral_13560/*"TRADE_EVENT_WITHDRAWAL_DIALOG_RETURN_ITEMS"*/,
                                                                 0);
  if ( !returnItemsLabel )
    goto LABEL_29;
  ...
  this = (EventTradeSweetsWithdrawalConfirmDialogComponent_o *)LocalizationManager__Get(
                                                                 (System_String_o *)StringLiteral_13561/*"TRADE_EVENT_WITHDRAWAL_DIALOG_RETURN_ITEMS_NONE"*/,
                                                                 0);
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  this = (EventTradeSweetsWithdrawalConfirmDialogComponent_o *)DataManager__GetMaster_object_((const MethodInfo_319C0E0 *)Method_DataManager_GetMaster_CommonConsumeMaster___);
  ...
  this = (EventTradeSweetsWithdrawalConfirmDialogComponent_o *)sub_1C9403C(
  ...
  this = (EventTradeSweetsWithdrawalConfirmDialogComponent_o *)EventTradeListViewItemDraw__GetDisplayMode(3, item, v23);
  if ( !v6->fields.listViewItemDraw
    || (v25 = (int)this,
        EventTradeListViewItemDraw__SetItem(v6->fields.listViewItemDraw, item, (int32_t)this, v24),
        (this = (EventTradeSweetsWithdrawalConfirmDialogComponent_o *)v6->fields.listViewItemDraw) == 0) )
  {
LABEL_29:
    sub_1C942F0(this, item);
  }
  EventTradeListViewItemDraw__UpdateItem((EventTradeListViewItemDraw_o *)this, item, v25, v26);
}
