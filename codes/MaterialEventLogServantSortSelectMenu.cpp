        ...
        const MethodInfo *method)
{
  ...
  MaterialEventLogServantSortSelectMenu__Close_33143284(this, 0, v2);
}


void MaterialEventLogServantSortSelectMenu__Close_33143284(
        MaterialEventLogServantSortSelectMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C22548 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_MaterialEventLogServantSortSelectMenu_EndClose__);
    byte_4C22548 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C22546 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_MaterialEventLogServantSortSelectMenu___c__DisplayClass42_0__InitCategoryContainer_b__0__);
    this = (MaterialEventLogServantSortSelectMenu_o *)sub_1C2D490(&MaterialEventLogServantSortSelectMenu___c__DisplayClass42_0_TypeInfo);
    byte_4C22546 = 1;
  }
...
LABEL_27:
  ...
  if ( SLODWORD(categoryKindKist->max_length) >= 1 )
  {
    ...
    while ( 1 )
    {
      v15 = sub_1C2D6DC(MaterialEventLogServantSortSelectMenu___c__DisplayClass42_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2254D & 1) == 0 )
  {
    sub_1C2D490(&Method_MaterialEventLogServantSortSelectMenu_OnClickCancel__);
    byte_4C2254D = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_MaterialEventLogServantSortSelectMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2D4A8(Method_MaterialEventLogServantSortSelectMenu_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2254E & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_MaterialEventLogServantSortSelectMenu_OnClickClear__);
    byte_4C2254E = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_MaterialEventLogServantSortSelectMenu_OnClickClear__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2D4A8(Method_MaterialEventLogServantSortSelectMenu_OnClickClear__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C2D474(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2254C & 1) == 0 )
  {
    this = (MaterialEventLogServantSortSelectMenu_o *)sub_1C2D490(&Method_MaterialEventLogServantSortSelectMenu_OnClickDecide__);
    byte_4C2254C = 1;
  }
  if ( v2->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_MaterialEventLogServantSortSelectMenu_OnClickDecide__ + 83) & 2) != 0 )
      v7 = (_QWORD *)sub_1C2D4A8(Method_MaterialEventLogServantSortSelectMenu_OnClickDecide__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C22553 & 1) == 0 )
  {
    sub_1C2D490(&Method_MaterialEventLogServantSortSelectMenu_OnClickFilterButton__);
    byte_4C22553 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_MaterialEventLogServantSortSelectMenu_OnClickFilterButton__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1C2D4A8(Method_MaterialEventLogServantSortSelectMenu_OnClickFilterButton__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C2D490(&Method_System_Collections_Generic_List_ListViewSort_FilterKind__ToArray__);
    sub_1C2D490(&Method_MaterialEventLogServantSortSelectMenu_OnClickReset__);
    byte_4C2254F = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_MaterialEventLogServantSortSelectMenu_OnClickReset__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2D4A8(Method_MaterialEventLogServantSortSelectMenu_OnClickReset__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C2D474(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
    useFilterKindList = (System_Collections_Generic_List_T__o *)this->fields.useFilterKindList;
    if ( !useFilterKindList
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C22550 & 1) == 0 )
  {
    sub_1C2D490(&Method_MaterialEventLogServantSortSelectMenu_OnClickSortId__);
    byte_4C22550 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_MaterialEventLogServantSortSelectMenu_OnClickSortId__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2D4A8(Method_MaterialEventLogServantSortSelectMenu_OnClickSortId__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C2D474(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
    operationSortInfo = this->fields.operationSortInfo;
    if ( !operationSortInfo )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C22552 & 1) == 0 )
  {
    sub_1C2D490(&Method_MaterialEventLogServantSortSelectMenu_OnClickSortLimitCount__);
    byte_4C22552 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_MaterialEventLogServantSortSelectMenu_OnClickSortLimitCount__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2D4A8(Method_MaterialEventLogServantSortSelectMenu_OnClickSortLimitCount__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C2D474(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
    operationSortInfo = this->fields.operationSortInfo;
    if ( !operationSortInfo )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C22551 & 1) == 0 )
  {
    sub_1C2D490(&Method_MaterialEventLogServantSortSelectMenu_OnClickSortRarity__);
    byte_4C22551 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_MaterialEventLogServantSortSelectMenu_OnClickSortRarity__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2D4A8(Method_MaterialEventLogServantSortSelectMenu_OnClickSortRarity__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C2D474(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
    operationSortInfo = this->fields.operationSortInfo;
    if ( !operationSortInfo )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C22544 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_MaterialEventLogServantSortSelectMenu_EndOpen__);
...
LABEL_13:
        ...
        ListViewSort___ctor_43601448(v17, v15, 0);
        ...
        if ( title2Label )
        {
          ...
          if ( explanationLabel )
          {
            ...
            gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11718/*"SERVANT_SORT_EXPLANATION2"*/, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( !operationSortInfo || !sort1Button )
    goto LABEL_35;
  v5 = (System_String_o **)(operationSortInfo->fields.sortKind == 27 ? &StringLiteral_17432/*"btn_bg_03"*/ : &StringLiteral_17433/*"btn_bg_04"*/);
  ...
  if ( !v6 || !sort1Button )
    goto LABEL_35;
  v7 = (System_String_o **)(v6->fields.sortKind == 2 ? &StringLiteral_17432/*"btn_bg_03"*/ : &StringLiteral_17433/*"btn_bg_04"*/);
  if ( (UISprite__set_spriteName((UISprite_o *)sort1Button, *v7, 0),
    ...
    || !sort1Button
    || (v8->fields.sortKind != 9 ? (v9 = &StringLiteral_17433/*"btn_bg_04"*/) : (v9 = &StringLiteral_17432/*"btn_bg_03"*/),
  ...
  {
LABEL_35:
    sub_1C2D6EC(sort1Button, method);
  }
  System_Collections_Generic_List_object___GetEnumerator(
    (System_Collections_Generic_List_Enumerator_T__o *)&v19,
        ...
        const MethodInfo *method)
{
  ...
  if ( !servantFilterRoot
    || (UnityEngine_GameObject__SetActive(servantFilterRoot, 1, 0),
        v6 = (System_Array_o *)sub_1C2D538(ListViewSort_FilterCategoryKind___TypeInfo, 4),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C22547 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_System_Collections_Generic_List_ServantFilterButtonControl__GetEnumerator__);
    sub_1C2D490(&Method_MaterialEventLogServantSortSelectMenu_OnClickFilterButton__);
    sub_1C2D490(&Method_MaterialEventLogServantSortSelectMenu__SetupFilterButtons_b__43_0__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C22545 & 1) == 0 )
  {
    ...
    this = (MaterialEventLogServantSortSelectMenu_o *)sub_1C2D490(&Method_System_Collections_Generic_List_ListViewSort_FilterKind__ToArray__);
    byte_4C22545 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C22556 & 1) == 0 )
  {
    this = (MaterialEventLogServantSortSelectMenu_o *)sub_1C2D490(&Method_System_Collections_Generic_List_ListViewSort_FilterKind__Contains__);
    byte_4C22556 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v10 = (MaterialEventLogServantSortSelectMenu_o *)sub_1C2D9AC(v7);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1A6AD74;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A6AD2C;
}
