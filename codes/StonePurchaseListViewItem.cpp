        ...
        const MethodInfo *method)
{
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.bankShop, (int32_t)bankShop, v9, v10);
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.entity, (int32_t)Entity, v14, v15);
}
        ...
        const MethodInfo *method)
{
  ...
  return System_String__Concat_61645176((System_String_o *)StringLiteral_7981/*"Item "*/, *p_name, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( entity )
    ...
    p_detail = (System_String_o **)&StringLiteral_18829/*"error"*/;
  return *p_detail;
}
