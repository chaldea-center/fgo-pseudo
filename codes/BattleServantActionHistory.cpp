...
void BattleServantActionHistory___ctor_47201856(
        BattleServantActionHistory_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2F64B & 1) == 0 )
  {
    sub_1C94098(&BattleServantActionHistory_SaveData_TypeInfo);
    byte_4D2F64B = 1;
  }
  v3 = sub_1C942E4(BattleServantActionHistory_SaveData_TypeInfo);
