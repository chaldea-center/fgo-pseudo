        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E188 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_JsonManager_DeserializeArray_EffectFlipData___, v3);
    sub_1B761C0(&JsonManager_TypeInfo, v4);
    sub_1B761C0(&StringLiteral_16637/*"actEnemyEffectFlip"*/, v5);
    byte_4A2E188 = 1;
  }
  result = (EffectFlipData_array *)BasicHelper__GetValue_object__object_(
                                     (System_Collections_Generic_Dictionary_K__V__o *)this->fields.script,
                                     (Il2CppObject *)StringLiteral_16637/*"actEnemyEffectFlip"*/,
                                     0LL,
  ...
  if ( result )
  {
    ...
    return (EffectFlipData_array *)JsonManager__DeserializeArray_object_(
                                     &v7->obj,
                                     (const MethodInfo_2EC89B0 *)Method_JsonManager_DeserializeArray_EffectFlipData___);
  }
  return result;
}
...
System_Int32_array *__fastcall FunctionEntity__GetFuncIndividuality(FunctionEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2E185 & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_19660/*"funcIndividuality"*/, v8);
    byte_4A2E185 = 1;
  }
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (System_Int32_array *)DataManager__GetMaster_object_((const MethodInfo_2E623B4 *)Method_DataManager_GetMaster_FuncTypeDetailMaster___);
  if ( !Master_object
  ...
  IntArrayDefaultEmpty = (System_Collections_Generic_IEnumerable_T__o *)EntityScriptUtil__GetIntArrayDefaultEmpty(
                                                                          this->fields.script,
                                                                          (System_String_o *)StringLiteral_19660/*"funcIndividuality"*/,
                                                                          0LL);
  System_Collections_Generic_List_int___AddRange(
    v9,
...
int32_t __fastcall FunctionEntity__GetPopupTextCondensedScaleSize(FunctionEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2E186 & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_10690/*"PopupTextCondensedScaleSize"*/, method);
    byte_4A2E186 = 1;
  }
  return FunctionEntity__getScript(this, (System_String_o *)StringLiteral_10690/*"PopupTextCondensedScaleSize"*/, 0, v2);
}
...
int32_t __fastcall FunctionEntity__GetPopupTextCondensedScaleValue(FunctionEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2E187 & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_10691/*"PopupTextCondensedScaleValue"*/, method);
    byte_4A2E187 = 1;
  }
  return FunctionEntity__getScript(this, (System_String_o *)StringLiteral_10691/*"PopupTextCondensedScaleValue"*/, 0, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  *originalTvals = 0LL;
  sub_1B76164((ServantStatusBattleListViewItem_o *)originalTvals, 0, (int32_t)overwriteTvals, (int32_t)method);
  if ( !FunctionEntity__TryGetOverwriteTvals(this, overwriteTvals, v7) )
  {
    tvals = this->fields.tvals;
    *originalTvals = tvals;
    sub_1B76164((ServantStatusBattleListViewItem_o *)originalTvals, (int32_t)tvals, v8, v9);
  }
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4A2E184 & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_22407/*"overwriteTvals"*/, tvalsArray);
    byte_4A2E184 = 1;
  }
  return EntityScriptUtil__TryGet2DimensionalIntArray(
           this->fields.script,
           (System_String_o *)StringLiteral_22407/*"overwriteTvals"*/,
           tvalsArray,
           0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B766DC(script);
  return (unsigned int)FunctionEntity__getScript_39154140(v13, v14, v15, v16);
}


System_String_o *__fastcall FunctionEntity__getScript_39154140(
        FunctionEntity_o *this,
        System_String_o *key,
