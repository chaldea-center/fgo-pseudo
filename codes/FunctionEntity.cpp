        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4E6F1 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_JsonManager_DeserializeArray_EffectFlipData___, v3);
    sub_1B863B8(&JsonManager_TypeInfo, v4);
    sub_1B863B8(&StringLiteral_16411/*"actEnemyEffectFlip"*/, v5);
    byte_4A4E6F1 = 1;
  }
  result = (EffectFlipData_array *)BasicHelper__GetValue_object__object_(
                                     (System_Collections_Generic_Dictionary_K__V__o *)this->fields.script,
                                     (Il2CppObject *)StringLiteral_16411/*"actEnemyEffectFlip"*/,
                                     0LL,
  ...
  if ( result )
  {
    ...
    return (EffectFlipData_array *)JsonManager__DeserializeArray_object_(
                                     &v7->obj,
                                     (const MethodInfo_2FD883C *)Method_JsonManager_DeserializeArray_EffectFlipData___);
  }
  return result;
}
...
int32_t __fastcall FunctionEntity__GetAddStateBuffId(FunctionEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !vals )
    sub_1B86614(isAddState, v4);
  if ( !vals->max_length )
    sub_1B8661C(isAddState, v4);
...
int32_t __fastcall FunctionEntity__GetAddStateBuffTypeFromFunction(FunctionEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4E6EC & 1) == 0 )
  {
    sub_1B863B8(&Method_DataManager_GetMaster_BuffMaster___, method);
    sub_1B863B8(&DataManager_TypeInfo, v3);
    sub_1B863B8(&Method_DataMasterBase_BuffMaster__BuffEntity__int__TryGetEntity__, v4);
    byte_4A4E6EC = 1;
  }
  entity = 0LL;
...
System_Int32_array *__fastcall FunctionEntity__GetFuncIndividuality(FunctionEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4E6EE & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_19455/*"funcIndividuality"*/, v8);
    byte_4A4E6EE = 1;
  }
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (System_Int32_array *)DataManager__GetMaster_object_((const MethodInfo_2F6DC64 *)Method_DataManager_GetMaster_FuncTypeDetailMaster___);
  if ( !Master_object
  ...
  IntArrayDefaultEmpty = (System_Collections_Generic_IEnumerable_T__o *)EntityScriptUtil__GetIntArrayDefaultEmpty(
                                                                          this->fields.script,
                                                                          (System_String_o *)StringLiteral_19455/*"funcIndividuality"*/,
                                                                          0LL);
  System_Collections_Generic_List_int___AddRange(
    v9,
        ...
        const MethodInfo *method)
{
  if ( (byte_4A4E6F2 & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_21922/*"noEffectText"*/, defText);
    byte_4A4E6F2 = 1;
  }
  return EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_21922/*"noEffectText"*/, defText, 0LL);
}
...
int32_t __fastcall FunctionEntity__GetPopupTextCondensedScaleSize(FunctionEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4E6EF & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_10535/*"PopupTextCondensedScaleSize"*/, method);
    byte_4A4E6EF = 1;
  }
  return FunctionEntity__getScript(this, (System_String_o *)StringLiteral_10535/*"PopupTextCondensedScaleSize"*/, 0, v2);
}
...
int32_t __fastcall FunctionEntity__GetPopupTextCondensedScaleValue(FunctionEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4E6F0 & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_10536/*"PopupTextCondensedScaleValue"*/, method);
    byte_4A4E6F0 = 1;
  }
  return FunctionEntity__getScript(this, (System_String_o *)StringLiteral_10536/*"PopupTextCondensedScaleValue"*/, 0, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  *originalTvals = 0LL;
  sub_1B8635C((CGThumbnailListItem_o *)originalTvals, 0, (int32_t)overwriteTvals, method);
  if ( !FunctionEntity__TryGetOverwriteTvals(this, overwriteTvals, v7) )
  {
    tvals = this->fields.tvals;
    *originalTvals = tvals;
    sub_1B8635C((CGThumbnailListItem_o *)originalTvals, (int32_t)tvals, v8, v9);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4E6F5 & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_22585/*"quoteBattleValueKey"*/, battleValueKey);
    byte_4A4E6F5 = 1;
  }
  IntValue = EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_22585/*"quoteBattleValueKey"*/, 0, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4E6F3 & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__, data);
    sub_1B863B8(&Method_JsonManager_Deserialize_BattleSkillDropInfo_JsonConvertData___, v6);
    sub_1B863B8(&JsonManager_TypeInfo, v7);
    sub_1B863B8(&StringLiteral_16875/*"battleSkillDropInfo"*/, v8);
    byte_4A4E6F3 = 1;
  }
  value = 0LL;
  *data = 0LL;
  sub_1B8635C((CGThumbnailListItem_o *)data, 0, (int32_t)method, v3);
  script = this->fields.script;
  if ( !script )
    sub_1B86614(0LL, v9);
  if ( System_Collections_Generic_Dictionary_object__object___TryGetValue(
         (System_Collections_Generic_Dictionary_object__object__o *)script,
         (Il2CppObject *)StringLiteral_16875/*"battleSkillDropInfo"*/,
         &value,
         (const MethodInfo_32CFEEC *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
  {
    ...
    v12 = JsonManager__Deserialize_object_(
            v11,
            (const MethodInfo_2FD86EC *)Method_JsonManager_Deserialize_BattleSkillDropInfo_JsonConvertData___);
    *data = (BattleSkillDropInfo_JsonConvertData_o *)v12;
    sub_1B8635C((CGThumbnailListItem_o *)data, (int32_t)v12, v13, v14);
  }
  return *data != 0LL;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4E6F4 & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Enum_TryParse_BattleValueTargetType___, valueTargetType);
    sub_1B863B8(&System_Enum_TypeInfo, v5);
    sub_1B863B8(&StringLiteral_16882/*"battleValueTarget"*/, v6);
    byte_4A4E6F4 = 1;
  }
  *valueTargetType = 0;
  StringValue = EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_16882/*"battleValueTarget"*/, 0LL, 0LL);
  ...
  return System_Enum__TryParse_Int32Enum_(
           StringValue,
           valueTargetType,
           (const MethodInfo_2F7678C *)Method_System_Enum_TryParse_BattleValueTargetType___);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4A4E6ED & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_22263/*"overwriteTvals"*/, tvalsArray);
    byte_4A4E6ED = 1;
  }
  return EntityScriptUtil__TryGet2DimensionalIntArray(
           this->fields.script,
           (System_String_o *)StringLiteral_22263/*"overwriteTvals"*/,
           tvalsArray,
           0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B868D4(script);
  return (unsigned int)FunctionEntity__getScript_40308708(v13, v14, v15, v16);
}


System_String_o *__fastcall FunctionEntity__getScript_40308708(
        FunctionEntity_o *this,
        System_String_o *key,
