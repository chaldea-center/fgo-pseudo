        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B373ED & 1) == 0 )
  {
    ...
    sub_1BD3458(&Method_JsonManager_DeserializeArray_EffectFlipData___, v3);
    sub_1BD3458(&JsonManager_TypeInfo, v4);
    sub_1BD3458(&StringLiteral_16833/*"actEnemyEffectFlip"*/, v5);
    byte_4B373ED = 1;
  }
  result = (EffectFlipData_array *)BasicHelper__GetValue_object__object_(
                                     (System_Collections_Generic_Dictionary_K__V__o *)this->fields.script,
                                     (Il2CppObject *)StringLiteral_16833/*"actEnemyEffectFlip"*/,
                                     0LL,
  ...
  if ( result )
  {
    ...
    return (EffectFlipData_array *)JsonManager__DeserializeArray_object_(
                                     &v7->obj,
                                     (const MethodInfo_2F98C0C *)Method_JsonManager_DeserializeArray_EffectFlipData___);
  }
  return result;
}
...
int32_t __fastcall FunctionEntity__GetAddStateBuffId(FunctionEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !vals )
    sub_1BD36B4(isAddState, v4);
  if ( !vals->max_length )
    sub_1BD36BC(isAddState, v4);
...
System_Int32_array *__fastcall FunctionEntity__GetFuncIndividuality(FunctionEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B373EA & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_19898/*"funcIndividuality"*/, v8);
    byte_4B373EA = 1;
  }
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (System_Int32_array *)DataManager__GetMaster_object_((const MethodInfo_2F31630 *)Method_DataManager_GetMaster_FuncTypeDetailMaster___);
  if ( !Master_object
  ...
  IntArrayDefaultEmpty = (System_Collections_Generic_IEnumerable_T__o *)EntityScriptUtil__GetIntArrayDefaultEmpty(
                                                                          this->fields.script,
                                                                          (System_String_o *)StringLiteral_19898/*"funcIndividuality"*/,
                                                                          0LL);
  System_Collections_Generic_List_int___AddRange(
    v9,
        ...
        const MethodInfo *method)
{
  if ( (byte_4B373EE & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_22359/*"noEffectText"*/, defText);
    byte_4B373EE = 1;
  }
  return EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_22359/*"noEffectText"*/, defText, 0LL);
}
...
int32_t __fastcall FunctionEntity__GetPopupTextCondensedScaleSize(FunctionEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B373EB & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_10845/*"PopupTextCondensedScaleSize"*/, method);
    byte_4B373EB = 1;
  }
  return FunctionEntity__getScript(this, (System_String_o *)StringLiteral_10845/*"PopupTextCondensedScaleSize"*/, 0, v2);
}
...
int32_t __fastcall FunctionEntity__GetPopupTextCondensedScaleValue(FunctionEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B373EC & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_10846/*"PopupTextCondensedScaleValue"*/, method);
    byte_4B373EC = 1;
  }
  return FunctionEntity__getScript(this, (System_String_o *)StringLiteral_10846/*"PopupTextCondensedScaleValue"*/, 0, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  *originalTvals = 0LL;
  ...
  if ( !FunctionEntity__TryGetOverwriteTvals(this, overwriteTvals, v11) )
  {
    ...
    *originalTvals = tvals;
    sub_1BD33FC((PartyOrganizationUtility_o *)originalTvals, (int64_t)tvals, v12, v13, v14, v15, v16, v17);
  }
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4B373E9 & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_22693/*"overwriteTvals"*/, tvalsArray);
    byte_4B373E9 = 1;
  }
  return EntityScriptUtil__TryGet2DimensionalIntArray(
           this->fields.script,
           (System_String_o *)StringLiteral_22693/*"overwriteTvals"*/,
           tvalsArray,
           0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1BD3974(script);
  return (unsigned int)FunctionEntity__getScript_40137484(v13, v14, v15, v16);
}


System_String_o *__fastcall FunctionEntity__getScript_40137484(
        FunctionEntity_o *this,
        System_String_o *key,
