        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB4925 & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_JsonManager_DeserializeArray_EffectFlipData___, v3);
    sub_1C13D24(&JsonManager_TypeInfo, v4);
    sub_1C13D24(&StringLiteral_16898/*"accept-language"*/, v5);
    byte_4BB4925 = 1;
  }
  result = (EffectFlipData_array *)BasicHelper__GetValue_object__object_(
                                     (System_Collections_Generic_Dictionary_K__V__o *)this->fields.script,
                                     (Il2CppObject *)StringLiteral_16898/*"accept-language"*/,
                                     0LL,
  ...
  if ( result )
  {
    ...
    return (EffectFlipData_array *)JsonManager__DeserializeArray_object_(
                                     &v7->obj,
                                     (const MethodInfo_2FF6CCC *)Method_JsonManager_DeserializeArray_EffectFlipData___);
  }
  return result;
}
...
int32_t __fastcall FunctionEntity__GetAddStateBuffId(FunctionEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !vals )
    sub_1C13F80(isAddState, v4);
  if ( !vals->max_length )
    sub_1C13F88(isAddState, v4);
...
System_Int32_array *__fastcall FunctionEntity__GetFuncIndividuality(FunctionEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB4922 & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_19980/*"fsmObjDestroy"*/, v8);
    byte_4BB4922 = 1;
  }
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (System_Int32_array *)DataManager__GetMaster_object_((const MethodInfo_2F8F418 *)Method_DataManager_GetMaster_FuncTypeDetailMaster___);
  if ( !Master_object
  ...
  IntArrayDefaultEmpty = (System_Collections_Generic_IEnumerable_T__o *)EntityScriptUtil__GetIntArrayDefaultEmpty(
                                                                          this->fields.script,
                                                                          (System_String_o *)StringLiteral_19980/*"fsmObjDestroy"*/,
                                                                          0LL);
  System_Collections_Generic_List_int___AddRange(
    v9,
        ...
        const MethodInfo *method)
{
  if ( (byte_4BB4926 & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_22455/*"no UILabel"*/, defText);
    byte_4BB4926 = 1;
  }
  return EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_22455/*"no UILabel"*/, defText, 0LL);
}
...
int32_t __fastcall FunctionEntity__GetPopupTextCondensedScaleSize(FunctionEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB4923 & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_10883/*"Po"*/, method);
    byte_4BB4923 = 1;
  }
  return FunctionEntity__getScript(this, (System_String_o *)StringLiteral_10883/*"Po"*/, 0, v2);
}
...
int32_t __fastcall FunctionEntity__GetPopupTextCondensedScaleValue(FunctionEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB4924 & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_10884/*"Pointer startIndex and length do not refer to a valid string."*/, method);
    byte_4BB4924 = 1;
  }
  return FunctionEntity__getScript(this, (System_String_o *)StringLiteral_10884/*"Pointer startIndex and length do not refer to a valid string."*/, 0, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  *originalTvals = 0LL;
  ...
  if ( !FunctionEntity__TryGetOverwriteTvals(this, overwriteTvals, v11) )
  {
    ...
    *originalTvals = tvals;
    sub_1C13CC8((PartyOrganizationUtility_o *)originalTvals, (int64_t)tvals, v12, v13, v14, v15, v16, v17);
  }
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4BB4921 & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_22791/*"overwritePresentboxDetail"*/, tvalsArray);
    byte_4BB4921 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1C14240(script);
  return (unsigned int)FunctionEntity__getScript_40483904(v13, v14, v15, v16);
}


System_String_o *__fastcall FunctionEntity__getScript_40483904(
        FunctionEntity_o *this,
        System_String_o *key,
