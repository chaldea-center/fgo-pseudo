...
void __fastcall ConfirmGrandServantResetDialog__Init(ConfirmGrandServantResetDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B17383 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_ConfirmGrandServantResetDialog_OnSliderDragFinished__, method);
    sub_1BCAFF8(&UIProgressBar_OnDragFinished_TypeInfo, v3);
    byte_4B17383 = 1;
  }
  ...
  if ( !checkSlider
    || (UIProgressBar__set_value(checkSlider, 0.0, 0LL),
        ...
        v6 = (UIProgressBar_OnDragFinished_o *)sub_1BCB244(UIProgressBar_OnDragFinished_TypeInfo),
  ...
  sub_1BCAF9C(&v5->fields.onDragFinished);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17385 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_ConfirmGrandServantResetDialog_OnClickOk__, method);
    byte_4B17385 = 1;
  }
  if ( this->fields.baseState == 2 )
  {
    ...
    else
    {
      ...
      if ( (*((_BYTE *)Method_ConfirmGrandServantResetDialog_OnClickOk__ + 83) & 2) != 0 )
        v5 = (_QWORD *)sub_1BCB010(Method_ConfirmGrandServantResetDialog_OnClickOk__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17384 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_3719/*"CONFIRM_GRAND_SERVANT_RESET_DIALOG_MESSAGE"*/, v14);
    byte_4B17384 = 1;
  }
  ...
  Master_object = (__int64)DataManager__GetMaster_object_((const MethodInfo_301AA50 *)Method_DataManager_GetMaster_GrandGraphMaster___);
  ...
  *(_QWORD *)&v42.fields.fakeValue = v18;
  Master_object = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48125176(v42, 0LL);
  if ( !v17 )
    goto LABEL_34;
  ...
  v29 = LocalizationManager__Get((System_String_o *)StringLiteral_3719/*"CONFIRM_GRAND_SERVANT_RESET_DIALOG_MESSAGE"*/, 0LL);
  v30 = (System_Object_array *)sub_1BCB0A0(object___TypeInfo, 4LL);
...
LABEL_34:
  ...
  if ( Master_object )
  {
    Master_object = sub_1BCB134(Master_object, v30->obj.klass->_1.element_class);
    if ( !Master_object )
      goto LABEL_36;
  }
  if ( !v30->max_length )
    goto LABEL_35;
  v30->m_Items[0] = v31;
  Master_object = sub_1BCAF9C(v30->m_Items);
  v32 = *(Il2CppObject **)(v22 + 32);
  if ( v32 )
  {
    Master_object = sub_1BCB134(v32, v30->obj.klass->_1.element_class);
    if ( !Master_object )
      goto LABEL_36;
  }
  if ( v30->max_length <= 1 )
    goto LABEL_35;
  v30->m_Items[1] = v32;
  Master_object = sub_1BCAF9C(&v30->m_Items[1]);
  if ( !v28 )
    goto LABEL_34;
  monitor = (Il2CppObject *)v28[1].monitor;
  if ( monitor )
  {
    Master_object = sub_1BCB134(v28[1].monitor, v30->obj.klass->_1.element_class);
    if ( !Master_object )
      goto LABEL_36;
  }
  if ( v30->max_length <= 2 )
...
LABEL_36:
  ...
  if ( v30->max_length <= 3 )
LABEL_35:
    sub_1BCB25C(Master_object, v16, v20);
  v30->m_Items[3] = v37;
  sub_1BCAF9C(&v30->m_Items[3]);
  Master_object = (__int64)System_String__Format_62491852(v29, v30, 0LL);
  if ( !messageLabel )
    goto LABEL_34;
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_9:
    sub_1BCB254(sliderThumbSprite, sliderOn);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17380 & 1) == 0 )
  {
    sub_1BCAFF8(&ConfirmGrandServantResetDialog_CallbackFunc_TypeInfo, value);
    byte_4B17380 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (ConfirmGrandServantResetDialog_o *)sub_1BCB514(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A0D910;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A0D8C8;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17388 & 1) == 0 )
  {
    sub_1BCAFF8(&ConfirmGrandServantResetDialog_Result_TypeInfo, *(_QWORD *)&result);
    byte_4B17388 = 1;
  }
  v9[1] = 0LL;
