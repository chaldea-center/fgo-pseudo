        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFC92 & 1) == 0 )
  {
    sub_1B64870(&StringLiteral_20972/*"latitude"*/, *(_QWORD *)&eventId);
    sub_1B64870(&StringLiteral_19061/*"eventId"*/, v7);
    sub_1B64870(&StringLiteral_19872/*"horizontalAccuracy"*/, v8);
    sub_1B64870(&StringLiteral_24441/*"verticalAccuracy"*/, v9);
    sub_1B64870(&StringLiteral_23858/*"timestamp"*/, v10);
    sub_1B64870(&StringLiteral_21129/*"longitude"*/, v11);
    sub_1B64870(&StringLiteral_16673/*"altitude"*/, v12);
    byte_49FFC92 = 1;
  }
  ...
  RequestBase__addField_40882408((RequestBase_o *)this, (System_String_o *)StringLiteral_20972/*"latitude"*/, latitude, 0LL);
  longitude = UnityEngine_LocationInfo__get_longitude(locInfo, 0LL);
  RequestBase__addField_40882408((RequestBase_o *)this, (System_String_o *)StringLiteral_21129/*"longitude"*/, longitude, 0LL);
  altitude = UnityEngine_LocationInfo__get_altitude(locInfo, 0LL);
  RequestBase__addField_40882408((RequestBase_o *)this, (System_String_o *)StringLiteral_16673/*"altitude"*/, altitude, 0LL);
  horizontalAccuracy = UnityEngine_LocationInfo__get_horizontalAccuracy(locInfo, 0LL);
  RequestBase__addField_40882408((RequestBase_o *)this, (System_String_o *)StringLiteral_19872/*"horizontalAccuracy"*/, horizontalAccuracy, 0LL);
  verticalAccuracy = UnityEngine_LocationInfo__get_verticalAccuracy(locInfo, 0LL);
  RequestBase__addField_40882408((RequestBase_o *)this, (System_String_o *)StringLiteral_24441/*"verticalAccuracy"*/, verticalAccuracy, 0LL);
  timestamp = UnityEngine_LocationInfo__get_timestamp(locInfo, 0LL);
  RequestBase__addField_40882560((RequestBase_o *)this, (System_String_o *)StringLiteral_23858/*"timestamp"*/, timestamp, 0LL);
...
System_String_o *__fastcall EventLocationRequest__getURL(EventLocationRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FFC91 & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_19047/*"event/location"*/, v2);
    byte_49FFC91 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61383576(BaseUrl, (System_String_o *)StringLiteral_19047/*"event/location"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFC93 & 1) == 0 )
  {
    sub_1B64870(&Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__, responseList);
    sub_1B64870(&JsonManager_TypeInfo, v5);
    sub_1B64870(&ResponseCommandKind_TypeInfo, v6);
    sub_1B64870(&StringLiteral_21108/*"locationCampaign"*/, v7);
    sub_1B64870(&StringLiteral_21971/*"ng"*/, v8);
    sub_1B64870(&StringLiteral_21972/*"ngParse"*/, v9);
    byte_49FFC93 = 1;
  }
  if ( !ResponseCommandKind_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(ResponseCommandKind_TypeInfo);
  v10 = ResponseCommandKind__SearchData(69, responseList, 0LL);
  if ( !v10 || (v11 = v10, !ResponseData__checkError_40851148(v10, 0LL)) )
  {
