        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B1153 & 1) == 0 )
  {
    sub_B52984(&StringLiteral_20346/*"latitude"*/);
    sub_B52984(&StringLiteral_18606/*"eventId"*/);
    sub_B52984(&StringLiteral_19305/*"horizontalAccuracy"*/);
    sub_B52984(&StringLiteral_23329/*"verticalAccuracy"*/);
    sub_B52984(&StringLiteral_22891/*"timestamp"*/);
    sub_B52984(&StringLiteral_20471/*"longitude"*/);
    sub_B52984(&StringLiteral_16426/*"altitude"*/);
    byte_42B1153 = 1;
  }
  ...
  RequestBase__addField_32020608((RequestBase_o *)this, (System_String_o *)StringLiteral_20346/*"latitude"*/, latitude, 0LL);
  longitude = UnityEngine_LocationInfo__get_longitude(locInfo, 0LL);
  RequestBase__addField_32020608((RequestBase_o *)this, (System_String_o *)StringLiteral_20471/*"longitude"*/, longitude, 0LL);
  altitude = UnityEngine_LocationInfo__get_altitude(locInfo, 0LL);
  RequestBase__addField_32020608((RequestBase_o *)this, (System_String_o *)StringLiteral_16426/*"altitude"*/, altitude, 0LL);
  horizontalAccuracy = UnityEngine_LocationInfo__get_horizontalAccuracy(locInfo, 0LL);
  RequestBase__addField_32020608((RequestBase_o *)this, (System_String_o *)StringLiteral_19305/*"horizontalAccuracy"*/, horizontalAccuracy, 0LL);
  verticalAccuracy = UnityEngine_LocationInfo__get_verticalAccuracy(locInfo, 0LL);
  RequestBase__addField_32020608((RequestBase_o *)this, (System_String_o *)StringLiteral_23329/*"verticalAccuracy"*/, verticalAccuracy, 0LL);
  timestamp = UnityEngine_LocationInfo__get_timestamp(locInfo, 0LL);
  RequestBase__addField_32020764((RequestBase_o *)this, (System_String_o *)StringLiteral_22891/*"timestamp"*/, timestamp, 0LL);
...
System_String_o *__fastcall EventLocationRequest__getURL(EventLocationRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B1152 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_18594/*"event/location"*/);
    byte_42B1152 = 1;
  }
  ...
  return System_String__Concat_44568316(BaseUrl, (System_String_o *)StringLiteral_18594/*"event/location"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B1154 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_20451/*"locationCampaign"*/);
    sub_B52984(&StringLiteral_21239/*"ng"*/);
    sub_B52984(&StringLiteral_21240/*"ngParse"*/);
    byte_42B1154 = 1;
  }
  value = 0LL;
