void __fastcall EventInfoDetectiveRankControl___cctor(const MethodInfo *method)
{
  if ( (byte_4BDCD97 & 1) == 0 )
  {
    sub_1C21E38(&EventInfoDetectiveRankControl_TypeInfo);
    byte_4BDCD97 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDCD8F & 1) == 0 )
  {
    ...
    sub_1C21E38(&TerminalSceneComponent_TypeInfo);
    sub_1C21E38(&StringLiteral_11358/*"RankUpEffect"*/);
    byte_4BDCD8F = 1;
  }
  ...
  if ( !v8 )
    goto LABEL_41;
  v9 = *(AssetData_o **)(v8 + 248);
  if ( !v9 )
    goto LABEL_18;
  Object_39013000 = AssetData__GetObject_39013000(v9, (System_String_o *)StringLiteral_11358/*"RankUpEffect"*/, 0LL);
  v17 = (struct UnityEngine_GameObject_o *)Object_39013000;
  if ( Object_39013000 )
  {
    v18 = UnityEngine_GameObject_TypeInfo;
    if ( (UnityEngine_GameObject_c *)Object_39013000->klass == UnityEngine_GameObject_TypeInfo )
    {
      this->fields.effectBasePrefab = (struct UnityEngine_GameObject_o *)Object_39013000;
  ...
  p_effectBasePrefab = &this->fields.effectBasePrefab;
LABEL_17:
  sub_1C21DDC((PartyOrganizationUtility_o *)p_effectBasePrefab, (int64_t)v17, v11, v12, v13, v14, v15, v16);
LABEL_18:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDCD94 & 1) == 0 )
  {
    ...
    sub_1C21E38(&UnityEngine_Object_TypeInfo);
    sub_1C21E38(&Method_EventInfoDetectiveRankControl___c__DisplayClass26_0__PlayAnim_b__0__);
    sub_1C21E38(&Method_EventInfoDetectiveRankControl___c__DisplayClass26_0__PlayAnim_b__1__);
    sub_1C21E38(&EventInfoDetectiveRankControl___c__DisplayClass26_0_TypeInfo);
    byte_4BDCD94 = 1;
  }
  v7 = sub_1C22084(EventInfoDetectiveRankControl___c__DisplayClass26_0_TypeInfo);
      ...
      *(_DWORD *)(v7 + 24) = progressValue;
      if ( this->fields.userRank < progressValue )
      {
        ...
        if ( rankSprite )
        {
          ...
          GameObjectExtensions__SafeSetParent_34803616(v27, gameObject, 0LL);
          if ( v27 )
          {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDCD91 & 1) == 0 )
  {
    ...
    this = (EventInfoDetectiveRankControl_o *)sub_1C21E38(&StringLiteral_5791/*"EVENT_PROGRESS_NEXT_RANK_NONE"*/);
    byte_4BDCD91 = 1;
  }
  ...
  if ( nextEventProgressValueEntity )
  {
    ...
    if ( conditionTextLabel )
      goto LABEL_5;
LABEL_9:
    sub_1C22094(this, condMessage);
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  this = (EventInfoDetectiveRankControl_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5791/*"EVENT_PROGRESS_NEXT_RANK_NONE"*/, 0LL);
  condMessage = this;
  if ( !conditionTextLabel )
    goto LABEL_9;
LABEL_5:
        ...
        const MethodInfo *method)
{
  ...
  if ( !v16 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v18 = LocalizationManager__Get((System_String_o *)StringLiteral_3825/*"COMMON_COUNT_OPERATOR_PLUS"*/, 0LL);
    v17 = System_String__Concat_63115476(v17, v18, 0LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDCD93 & 1) == 0 )
  {
    ...
    sub_1C21E38(&int_TypeInfo);
    sub_1C21E38(&Method_System_Collections_Generic_List_UserEventRandomMissionEntity__get_Count__);
    sub_1C21E38(&LocalizationManager_TypeInfo);
    sub_1C21E38(&UnityEngine_Object_TypeInfo);
  ...
  if ( !UnityEngine_Object__op_Equality(missionStartedCountBgSprite, 0LL, 0LL) )
  {
    ...
    if ( UnityEngine_GameObject__get_activeSelf((UnityEngine_GameObject_o *)gameObject, 0LL) )
    {
      ...
      if ( !UnityEngine_Object__op_Equality(missionStartedCountTextLabel, 0LL, 0LL) )
      {
        if ( !DataManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
        gameObject = (UnityEngine_Component_o *)DataManager__GetMaster_object_((const MethodInfo_2FAFDB0 *)Method_DataManager_GetMaster_UserEventRandomMissionMaster___);
        eventUiEntity = this->fields.eventUiEntity;
        if ( eventUiEntity )
        {
          if ( gameObject )
          {
            UserEventRandomMissionProgressList = UserEventRandomMissionMaster__GetUserEventRandomMissionProgressList(
                                                   ...
                                                   eventUiEntity->fields.eventId,
                                                   0LL);
            gameObject = (UnityEngine_Component_o *)DataManager__GetMaster_object_((const MethodInfo_2FAFDB0 *)Method_DataManager_GetMaster_EventDetailMaster___);
              ...
              if ( gameObject )
              {
                ...
                if ( gameObject )
                {
                  ...
                  if ( UserEventRandomMissionProgressList )
                  {
                    ...
                    gameObject = (UnityEngine_Component_o *)System_String__Format_63129848(v16, v17, v21, 0LL);
                    if ( v11 )
                    {
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C21E38(&AtlasManager_TypeInfo);
    sub_1C21E38(&Method_System_Collections_Generic_List_EventInfoDetectiveRankControl_ViewData__Find__);
    sub_1C21E38(&System_Predicate_EventInfoDetectiveRankControl_ViewData__TypeInfo);
    sub_1C21E38(&Method_EventInfoDetectiveRankControl___c__DisplayClass21_0__SetupTitleBg_b__0__);
    sub_1C21E38(&EventInfoDetectiveRankControl___c__DisplayClass21_0_TypeInfo);
    byte_4BDCD90 = 1;
  }
  v5 = sub_1C22084(EventInfoDetectiveRankControl___c__DisplayClass21_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v5, 0LL);
  if ( !v5 )
    goto LABEL_11;
  *(_DWORD *)(v5 + 16) = userRank;
  viewDataList = this->fields.viewDataList;
  v9 = (System_Predicate_object__o *)sub_1C22084(System_Predicate_EventInfoDetectiveRankControl_ViewData__TypeInfo);
  ...
  v10 = System_Collections_Generic_List_object___Find(
          ...
          (const MethodInfo_364F71C *)Method_System_Collections_Generic_List_EventInfoDetectiveRankControl_ViewData__Find__);
  if ( v10 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDCD98 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_EventInfoDetectiveRankControl___c__DisplayClass26_0__PlayAnim_b__2__);
    sub_1C21E38(&Method_EventInfoDetectiveRankControl___c__DisplayClass26_0__PlayAnim_b__3__);
    sub_1C21E38(&Method_EventInfoDetectiveRankControl___c__DisplayClass26_0__PlayAnim_b__4__);
    sub_1C21E38(&StringLiteral_5792/*"EVENT_PROGRESS_RANKUP_MESSAGE"*/);
    this = (EventInfoDetectiveRankControl___c__DisplayClass26_0_o *)sub_1C21E38(&StringLiteral_5793/*"EVENT_PROGRESS_RANKUP_TITLE"*/);
    byte_4BDCD98 = 1;
  }
  ...
  if ( !_9__2 )
  {
    _9__2 = (System_Predicate_object__o *)sub_1C22084(System_Predicate_EventInfoDetectiveRankControl_ViewData__TypeInfo);
    System_Predicate_object____ctor(
      _9__2,
      (Il2CppObject *)v2,
  ...
  if ( !_9__3 )
  {
    _9__3 = (System_Predicate_object__o *)sub_1C22084(System_Predicate_EventInfoDetectiveRankControl_ViewData__TypeInfo);
    System_Predicate_object____ctor(
      _9__3,
      (Il2CppObject *)v2,
    ...
    sub_1C21DDC((PartyOrganizationUtility_o *)&v2->fields.__9__3, (int64_t)_9__3, v16, v17, v18, v19, v20, v21);
  }
  if ( !v14 )
    goto LABEL_19;
  this = (EventInfoDetectiveRankControl___c__DisplayClass26_0_o *)System_Collections_Generic_List_object___Find(
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v24 = LocalizationManager__Get((System_String_o *)StringLiteral_5793/*"EVENT_PROGRESS_RANKUP_TITLE"*/, 0LL);
  v25 = LocalizationManager__Get((System_String_o *)StringLiteral_5792/*"EVENT_PROGRESS_RANKUP_MESSAGE"*/, 0LL);
  this = (EventInfoDetectiveRankControl___c__DisplayClass26_0_o *)System_String__Format_63129848(
                                                                    v25,
                                                                    callback,
                                                                    v22,
                                                                    0LL);
  ...
  if ( !_9__4 )
  {
    ...
    sub_1C21DDC((PartyOrganizationUtility_o *)&v2->fields.__9__4, (int64_t)_9__4, v28, v29, v30, v31, v32, v33);
  }
  if ( !Instance )
LABEL_19:
        ...
        const MethodInfo *method)
{
  ...
  if ( !_4__this
    || (afterRank = this->fields.afterRank,
        ...
        (_4__this = (EventInfoUIProgressControl_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_388D058 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__)) == 0LL) )
  {
    sub_1C22094(_4__this, method);
  }
