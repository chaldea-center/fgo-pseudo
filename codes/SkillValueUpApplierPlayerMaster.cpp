        ...
        const MethodInfo *method)
{
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields, (int32_t)data, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A511F6 & 1) == 0 )
  {
    sub_1B863B8(&Method_BasicHelper_ExcludeNull_DataVals___, funcUnit);
    sub_1B863B8(&System_IDisposable_TypeInfo, v5);
    sub_1B863B8(&System_Collections_Generic_IEnumerable_DataVals__TypeInfo, v6);
    sub_1B863B8(&System_Collections_Generic_IEnumerator_DataVals__TypeInfo, v7);
    this = (SkillValueUpApplierPlayerMaster_o *)sub_1B863B8(&System_Collections_IEnumerator_TypeInfo, v8);
    byte_4A511F6 = 1;
  }
  if ( !funcUnit )
    goto LABEL_40;
  ...
  sub_1B8635C(p_FuncParamValueUpInfo_k__BackingField, v10, v12, v13);
  ...
  this = (SkillValueUpApplierPlayerMaster_o *)BasicHelper__ExcludeNull_object_(
                                                v14,
                                                (const MethodInfo_2F58608 *)Method_BasicHelper_ExcludeNull_DataVals___);
  if ( !this )
LABEL_40:
    sub_1B86614(this, funcUnit);
  klass = this->klass;
  v16 = this;
  ...
  {
LABEL_13:
    v19 = sub_1BD6B4C(this, System_Collections_Generic_IEnumerable_DataVals__TypeInfo, 0LL);
  }
...
LABEL_20:
    ...
    {
LABEL_27:
      v29 = sub_1BD6B4C(v21, System_Collections_Generic_IEnumerator_DataVals__TypeInfo, 0LL);
    }
    ...
    if ( !v30 )
      sub_1B86614(v31, v31);
    *(_QWORD *)(v30 + 104) = v31;
    sub_1B8635C((CGThumbnailListItem_o *)(v30 + 104), v31, v32, v33);
  }
  v34 = *(_QWORD *)v21;
  ...
  {
LABEL_35:
    v37 = sub_1BD6B4C(v21, System_IDisposable_TypeInfo, 0LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A511F8 & 1) == 0 )
  {
    sub_1B863B8(&BattleBuffData_ActValueRequest_TypeInfo, method);
    sub_1B863B8(&BattleBuffData_CheckIndividualitiesData_TypeInfo, v3);
    ...
    sub_1B863B8(&System_Collections_Generic_IEnumerable_BattleServantData__TypeInfo, v7);
    sub_1B863B8(&System_Collections_Generic_IEnumerator_BattleServantData__TypeInfo, v8);
    sub_1B863B8(&System_Collections_IEnumerator_TypeInfo, v9);
    sub_1B863B8(&Method_SkillValueUpApplierPlayerMaster___c__CalcSkillValueUpRate_b__5_0__, v10);
    sub_1B863B8(&SkillValueUpApplierPlayerMaster___c_TypeInfo, v11);
    byte_4A511F8 = 1;
  }
  ...
  if ( !_9__5_0 )
  {
    ...
    _9__5_0 = (System_Func_object__bool__o *)sub_1B86604(System_Func_BattleServantData__bool__TypeInfo);
...
LABEL_49:
  ...
  {
LABEL_15:
    v25 = sub_1BD6B4C(data, System_Collections_Generic_IEnumerable_BattleServantData__TypeInfo, 0LL);
  }
  ...
  {
    if ( !v28 )
      sub_1B86614(ActValueDetail, v27);
    v30 = v28->klass;
...
LABEL_23:
    ...
    {
LABEL_30:
      v37 = sub_1BD6B4C(v28, System_Collections_Generic_IEnumerator_BattleServantData__TypeInfo, 0LL);
    }
    v38 = (BattleServantData_o *)(*(__int64 (__fastcall **)(BattleBuffData_ActValueResponse_o *, _QWORD))v37)(
                                   v28,
                                   *(_QWORD *)(v37 + 8));
    v39 = (BattleBuffData_CheckIndividualitiesData_o *)sub_1B86604(BattleBuffData_CheckIndividualitiesData_TypeInfo);
    BattleBuffData_CheckIndividualitiesData___ctor_43787208(v39, v38, 0LL, 0LL, 0LL, 0LL, 0LL, 0LL);
    v40 = (BattleBuffData_ActValueRequest_o *)sub_1B86604(BattleBuffData_ActValueRequest_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A511F7 & 1) == 0 )
  {
    sub_1B863B8(&FuncParamValueUpInfoDefault_TypeInfo, dataVals);
    byte_4A511F7 = 1;
  }
...
void __fastcall SkillValueUpApplierPlayerMaster___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A511F9 & 1) == 0 )
  {
    sub_1B863B8(&SkillValueUpApplierPlayerMaster___c_TypeInfo, v1);
    byte_4A511F9 = 1;
  }
  v2 = (Il2CppObject *)sub_1B86604(SkillValueUpApplierPlayerMaster___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  SkillValueUpApplierPlayerMaster___c_TypeInfo->static_fields->__9 = (struct SkillValueUpApplierPlayerMaster___c_o *)v2;
  sub_1B8635C((CGThumbnailListItem_o *)SkillValueUpApplierPlayerMaster___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
