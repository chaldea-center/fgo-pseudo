        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0B5FA & 1) == 0 )
  {
    sub_1B686D4(&Method_BasicHelper_ExcludeNull_DataVals___, funcUnit);
    sub_1B686D4(&System_IDisposable_TypeInfo, v5);
    sub_1B686D4(&System_Collections_Generic_IEnumerable_DataVals__TypeInfo, v6);
    sub_1B686D4(&System_Collections_Generic_IEnumerator_DataVals__TypeInfo, v7);
    this = (SkillValueUpApplierPlayerMaster_o *)sub_1B686D4(&System_Collections_IEnumerator_TypeInfo, v8);
    byte_4A0B5FA = 1;
  }
  if ( !funcUnit )
    goto LABEL_40;
  ...
  sub_1B68678(p_FuncParamValueUpInfo_k__BackingField, v10, v12, v13);
  ...
  this = (SkillValueUpApplierPlayerMaster_o *)BasicHelper__ExcludeNull_object_(
                                                v14,
                                                (const MethodInfo_2E35AA4 *)Method_BasicHelper_ExcludeNull_DataVals___);
  if ( !this )
LABEL_40:
    sub_1B68930(this, funcUnit);
  klass = this->klass;
  v16 = this;
  ...
  {
LABEL_13:
    v19 = sub_1BBA6B4(this, System_Collections_Generic_IEnumerable_DataVals__TypeInfo, 0LL);
  }
...
LABEL_20:
    ...
    {
LABEL_27:
      v29 = sub_1BBA6B4(v21, System_Collections_Generic_IEnumerator_DataVals__TypeInfo, 0LL);
    }
    ...
    if ( !v30 )
      sub_1B68930(v31, v31);
    *(_QWORD *)(v30 + 104) = v31;
    sub_1B68678((ServantStatusBattleListViewItem_o *)(v30 + 104), v31, v32, v33);
  }
  v34 = *(_QWORD *)v21;
  ...
  {
LABEL_35:
    v37 = sub_1BBA6B4(v21, System_IDisposable_TypeInfo, 0LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0B5FC & 1) == 0 )
  {
    sub_1B686D4(&BattleBuffData_ActValueRequest_TypeInfo, method);
    ...
    sub_1B686D4(&System_Collections_Generic_IEnumerable_BattleServantData__TypeInfo, v7);
    sub_1B686D4(&System_Collections_Generic_IEnumerator_BattleServantData__TypeInfo, v8);
    sub_1B686D4(&System_Collections_IEnumerator_TypeInfo, v9);
    sub_1B686D4(&Method_SkillValueUpApplierPlayerMaster___c__CalcSkillValueUpRate_b__5_0__, v10);
    sub_1B686D4(&SkillValueUpApplierPlayerMaster___c_TypeInfo, v11);
    byte_4A0B5FC = 1;
  }
  ...
  if ( !_9__5_0 )
  {
    ...
    _9__5_0 = (System_Func_object__bool__o *)sub_1B68920(System_Func_BattleServantData__bool__TypeInfo);
    ...
    sub_1B68678((ServantStatusBattleListViewItem_o *)&static_fields->__9__5_0, (int32_t)_9__5_0, v19, v20);
  }
...
LABEL_49:
  ...
  {
LABEL_15:
    v25 = sub_1BBA6B4(data, System_Collections_Generic_IEnumerable_BattleServantData__TypeInfo, 0LL);
  }
  ...
  {
    if ( !v28 )
      sub_1B68930(ActValueDetail, v27);
    v30 = v28->klass;
...
LABEL_23:
    ...
    {
LABEL_30:
      v37 = sub_1BBA6B4(v28, System_Collections_Generic_IEnumerator_BattleServantData__TypeInfo, 0LL);
    }
    v38 = (BattleServantData_o *)(*(__int64 (__fastcall **)(BattleBuffData_ActValueResponse_o *, _QWORD))v37)(
                                   v28,
                                   *(_QWORD *)(v37 + 8));
    v39 = (BattleBuffData_CheckIndividualitiesData_o *)sub_1B68920(BattleBuffData_CheckIndividualitiesData_TypeInfo);
    BattleBuffData_CheckIndividualitiesData___ctor(v39, v38, 0LL, 0LL, 0LL, 0LL, 0LL);
    v40 = (BattleBuffData_ActValueRequest_o *)sub_1B68920(BattleBuffData_ActValueRequest_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0B5FB & 1) == 0 )
  {
    sub_1B686D4(&FuncParamValueUpInfoDefault_TypeInfo, dataVals);
    byte_4A0B5FB = 1;
  }
...
void __fastcall SkillValueUpApplierPlayerMaster___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A0B5FD & 1) == 0 )
  {
    sub_1B686D4(&SkillValueUpApplierPlayerMaster___c_TypeInfo, v1);
    byte_4A0B5FD = 1;
  }
  v2 = (Il2CppObject *)sub_1B68920(SkillValueUpApplierPlayerMaster___c_TypeInfo);
