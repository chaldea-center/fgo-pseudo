        ...
        const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields, (int32_t)data, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2A1EB & 1) == 0 )
  {
    sub_1C2D490(&Method_BasicHelper_ExcludeNull_DataVals___);
    sub_1C2D490(&System_IDisposable_TypeInfo);
    sub_1C2D490(&System_Collections_Generic_IEnumerable_DataVals__TypeInfo);
    sub_1C2D490(&System_Collections_Generic_IEnumerator_DataVals__TypeInfo);
    this = (SkillValueUpApplierPlayerMaster_o *)sub_1C2D490(&System_Collections_IEnumerator_TypeInfo);
    byte_4C2A1EB = 1;
  }
  if ( !funcUnit )
    goto LABEL_40;
  ...
  sub_1C2D434(p_FuncParamValueUpInfo_k__BackingField, v6, v8, v9);
  ...
  this = (SkillValueUpApplierPlayerMaster_o *)BasicHelper__ExcludeNull_object_(
                                                v10,
                                                (const MethodInfo_30B8644 *)Method_BasicHelper_ExcludeNull_DataVals___);
  if ( !this )
LABEL_40:
  ...
  {
LABEL_13:
    v15 = sub_1C7DCA8(this, System_Collections_Generic_IEnumerable_DataVals__TypeInfo, 0);
  }
...
LABEL_20:
    ...
    {
LABEL_27:
      v25 = sub_1C7DCA8(v17, System_Collections_Generic_IEnumerator_DataVals__TypeInfo, 0);
    }
    ...
    if ( !v26 )
      sub_1C2D6EC(v27, v27);
    *(_QWORD *)(v26 + 104) = v27;
    sub_1C2D434((CGThumbnailListItem_o *)(v26 + 104), v27, v28, v29);
  }
  v30 = *(_QWORD *)v17;
  ...
  {
LABEL_35:
    v33 = sub_1C7DCA8(v17, System_IDisposable_TypeInfo, 0);
  }
        ...
        const MethodInfo *method)
{
  ...
  int v17; // w24
  BattleBuffData_ActValueResponse_o *v18; // x20
  BattleServantData_o *v19; // x21
  BattleBuffData_CheckIndividualitiesData_o *v20; // x23
  BattleBuffData_ActValueRequest_o *v21; // x22

  if ( (byte_4C2A1ED & 1) == 0 )
  {
    sub_1C2D490(&BattleBuffData_ActValueRequest_TypeInfo);
    ...
    sub_1C2D490(&Method_SkillValueUpApplierPlayerMaster___c__CalcSkillValueUpRate_b__5_0__);
    sub_1C2D490(&SkillValueUpApplierPlayerMaster___c_TypeInfo);
    byte_4C2A1ED = 1;
  }
  ...
  if ( !_9__5_0 )
  {
    ...
    _9__5_0 = (System_Func_object__bool__o *)sub_1C2D6DC(System_Func_BattleServantData__bool__TypeInfo);
...
LABEL_24:
  ...
  do
  {
    if ( v17 >= (unsigned int)m_CancellationTokenSource )
      sub_1C2D6F4(data, method, v15);
    v19 = (BattleServantData_o *)*((_QWORD *)&v14->fields.rootfsm + v17);
    v20 = (BattleBuffData_CheckIndividualitiesData_o *)sub_1C2D6DC(BattleBuffData_CheckIndividualitiesData_TypeInfo);
    BattleBuffData_CheckIndividualitiesData___ctor_45569888(v20, v19, 0, 0, 0, 0, 0, 1, 0);
    v21 = (BattleBuffData_ActValueRequest_o *)sub_1C2D6DC(BattleBuffData_ActValueRequest_TypeInfo);
    BattleBuffData_ActValueRequest___ctor(v21, 113, v20, 0, 0);
    if ( !v19 )
      goto LABEL_24;
    data = (BattleData_o *)BattleServantData__get_BuffData(v19, 0);
    if ( !data )
      goto LABEL_24;
    data = (BattleData_o *)BattleBuffData__GetActValueDetail((BattleBuffData_o *)data, v21, 0);
    method = (const MethodInfo *)data;
    if ( v18 )
      BattleBuffData_ActValueResponse__Merge(v18, (BattleBuffData_ActValueResponse_o *)data, 0);
    else
      v18 = (BattleBuffData_ActValueResponse_o *)data;
    m_CancellationTokenSource = (int)v14->fields.m_CancellationTokenSource;
    ++v17;
  }
  while ( v17 < m_CancellationTokenSource );
  if ( v18 )
    return BattleBuffData_ActValueResponse__GetClampedValue(v18, 0);
  else
    return 0;
}
...
void SkillValueUpApplierPlayerMaster___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C2D6DC(SkillValueUpApplierPlayerMaster___c_TypeInfo);
  System_Object___ctor(v1, 0);
  SkillValueUpApplierPlayerMaster___c_TypeInfo->static_fields->__9 = (struct SkillValueUpApplierPlayerMaster___c_o *)v1;
  sub_1C2D434((CGThumbnailListItem_o *)SkillValueUpApplierPlayerMaster___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
