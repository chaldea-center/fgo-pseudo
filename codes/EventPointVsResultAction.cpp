void __fastcall EventPointVsResultAction___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A1C817 & 1) == 0 )
  {
    sub_1B715CC(&EventPointVsResultAction_TypeInfo, v1);
    sub_1B715CC(&StringLiteral_17272/*"bit_vs_result_"*/, v4);
    byte_4A1C817 = 1;
  }
  EventPointVsResultAction_TypeInfo->static_fields->ANIMATION_NAME = (struct System_String_o *)StringLiteral_17272/*"bit_vs_result_"*/;
  sub_1B71570(
    (ServantStatusBattleListViewItem_o *)EventPointVsResultAction_TypeInfo->static_fields,
    StringLiteral_17272/*"bit_vs_result_"*/,
    v2,
    v3);
}
...
void __fastcall EventPointVsResultAction__Awake(EventPointVsResultAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1C80F & 1) == 0 )
  {
    sub_1B715CC(&Method_CStateManager_EventPointVsResultAction___ctor__, method);
    sub_1B715CC(&Method_CStateManager_EventPointVsResultAction__add__, v3);
    sub_1B715CC(&CStateManager_EventPointVsResultAction__TypeInfo, v4);
    ...
    sub_1B715CC(&EventPointVsResultAction_StateNone_TypeInfo, v8);
    sub_1B715CC(&EventPointVsResultAction_StatePlay_TypeInfo, v9);
    sub_1B715CC(&EventPointVsResultAction_StateTouchWait_TypeInfo, v10);
    byte_4A1C80F = 1;
  }
  p_mFSM = &this->fields.mFSM;
  if ( !this->fields.mFSM )
  {
    v12 = (CStateManager_T__o *)sub_1B71818(CStateManager_EventPointVsResultAction__TypeInfo);
    CStateManager_object____ctor(
      v12,
      (Il2CppObject *)this,
      3,
      (const MethodInfo_308625C *)Method_CStateManager_EventPointVsResultAction___ctor__);
    this->fields.mFSM = (struct CStateManager_EventPointVsResultAction__o *)v12;
    sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.mFSM, (int32_t)v12, v13, v14);
    mFSM = (CStateManager_T__o *)this->fields.mFSM;
    v16 = (Il2CppObject *)sub_1B71818(EventPointVsResultAction_StateNone_TypeInfo);
    ...
    CStateManager_object___add(
      ...
      0,
      (IState_T__o *)v16,
      (const MethodInfo_3086304 *)Method_CStateManager_EventPointVsResultAction__add__);
    v19 = (CStateManager_T__o *)*p_mFSM;
    v20 = (Il2CppObject *)sub_1B71818(EventPointVsResultAction_StatePlay_TypeInfo);
    ...
    v22 = (Il2CppObject *)sub_1B71818(EventPointVsResultAction_StateTouchWait_TypeInfo);
      ...
      if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)v27, 0LL, 0LL) )
      {
        ...
        if ( v27 )
        {
          ...
          if ( ComponentInChildren_object )
          {
            ...
            sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.particleObj, (int32_t)v27, v29, v30);
            return;
          }
        }
LABEL_23:
        sub_1B71828(ComponentInChildren_object, v18);
      }
    }
  }
}
...
int32_t __fastcall EventPointVsResultAction__GetState(EventPointVsResultAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1C815 & 1) == 0 )
  {
    this = (EventPointVsResultAction_o *)sub_1B715CC(&Method_CStateManager_EventPointVsResultAction__getState__, method);
    byte_4A1C815 = 1;
  }
  mFSM = v2->fields.mFSM;
  if ( !mFSM )
        ...
        const MethodInfo *method)
{
  ...
  while ( 1 )
  {
    if ( (byte_4A1C814 & 1) == 0 )
    {
      sub_1B715CC(&System_Action_TypeInfo, *(_QWORD *)&cnt);
      sub_1B715CC(&Method_EventPointVsResultAction___c__DisplayClass23_0__LoadSvts_b__0__, v13);
      sub_1B715CC(&EventPointVsResultAction___c__DisplayClass23_0_TypeInfo, v14);
      byte_4A1C814 = 1;
    }
    v15 = sub_1B71818(EventPointVsResultAction___c__DisplayClass23_0_TypeInfo);
    System_Object___ctor((Il2CppObject *)v15, 0LL);
    if ( !v15 )
      goto LABEL_19;
    *(_QWORD *)(v15 + 16) = this;
    sub_1B71570((ServantStatusBattleListViewItem_o *)(v15 + 16), (int32_t)this, v17, v18);
    *(_DWORD *)(v15 + 24) = v11;
    *(_QWORD *)(v15 + 32) = servants;
    v19 = (System_Int32_array **)(v15 + 32);
    sub_1B71570((ServantStatusBattleListViewItem_o *)(v15 + 32), (int32_t)servants, v20, v21);
    *(_QWORD *)(v15 + 40) = faces;
    v22 = (Face_Type_array **)(v15 + 40);
    sub_1B71570((ServantStatusBattleListViewItem_o *)(v15 + 40), (int32_t)faces, v23, v24);
    *(_QWORD *)(v15 + 56) = callBack;
    v25 = (System_Action_o **)(v15 + 56);
    *(_DWORD *)(v15 + 48) = winType;
    sub_1B71570((ServantStatusBattleListViewItem_o *)(v15 + 56), (int32_t)callBack, v26, v27);
    v28 = *(int *)(v15 + 24);
    if ( (int)v28 > 2 )
      goto LABEL_11;
    servants = *v19;
...
LABEL_20:
  ...
  if ( !v34 )
LABEL_19:
    sub_1B71828(v16, *(_QWORD *)&cnt);
  UIStandFigureR__SetCharacter_40751940(v34, v35 / 10, v35 % 10, 0, v33, v36, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C813 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_EventPointVsResultAction__Play_b__22_0__, v10);
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.localMask, (int32_t)maskFade, v13, v14);
  ...
  if ( ((unsigned __int8)gameObject & 1) != 0 )
  {
    ...
    {
LABEL_14:
      v24 = sub_1BC35AC(gameObject, SimpleAnimation_State_TypeInfo, 8LL);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C816 & 1) == 0 )
  {
    sub_1B715CC(&Method_CStateManager_EventPointVsResultAction__setState__, *(_QWORD *)&state);
    byte_4A1C816 = 1;
  }
  mFSM = (CStateManager_T__o *)this->fields.mFSM;
  if ( !mFSM )
  ...
  CStateManager_object___setState(
    mFSM,
    state,
    (const MethodInfo_3086390 *)Method_CStateManager_EventPointVsResultAction__setState__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C811 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_EventPointVsResultAction___c__DisplayClass19_0__Setup_b__0__, v9);
    sub_1B715CC(&EventPointVsResultAction___c__DisplayClass19_0_TypeInfo, v10);
    byte_4A1C811 = 1;
  }
  v11 = sub_1B71818(EventPointVsResultAction___c__DisplayClass19_0_TypeInfo);
  ...
  *(_DWORD *)(v11 + 24) = resultNo;
  sub_1B71570((ServantStatusBattleListViewItem_o *)(v11 + 32), (int32_t)callBack, v16, v17);
...
void __fastcall EventPointVsResultAction__Update(EventPointVsResultAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1C810 & 1) == 0 )
  {
    sub_1B715CC(&Method_CStateManager_EventPointVsResultAction__update__, method);
    byte_4A1C810 = 1;
  }
  mFSM = (CStateManager_T__o *)this->fields.mFSM;
  if ( mFSM )
    CStateManager_object___update(
      mFSM,
      (const MethodInfo_308636C *)Method_CStateManager_EventPointVsResultAction__update__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C812 & 1) == 0 )
  {
    sub_1B715CC(&Method_UnityEngine_Component_GetComponentInChildren_Animation___, callBack);
    ...
    sub_1B715CC(&EventPointVsResultAction_TypeInfo, v7);
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponent_ScreenTouchInformationComponent___, v8);
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.mAnimation, (int32_t)v16, v17, v18);
  transform = (UnityEngine_Component_o *)UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0LL);
  if ( !transform )
    goto LABEL_19;
  ...
  v27 = System_String__Concat_61505504(ANIMATION_NAME, v26, 0LL);
  this->fields.animationName = v27;
  p_animationName = &this->fields.animationName;
  sub_1B71570((ServantStatusBattleListViewItem_o *)p_animationName, (int32_t)v27, v29, v30);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C818 & 1) == 0 )
  {
    ...
    this = (EventPointVsResultAction_StatePlay_o *)sub_1B715CC(&SimpleAnimation_State_TypeInfo, v5);
    byte_4A1C818 = 1;
  }
  if ( !that )
    goto LABEL_43;
  ...
  if ( !UnityEngine_Object__op_Inequality(mSimpleAnimation, 0LL, 0LL) )
  {
    ...
    if ( this )
    {
      UnityEngine_Animation__Play_69002944((UnityEngine_Animation_o *)this, that->fields.animationName, 0LL);
      this = (EventPointVsResultAction_StatePlay_o *)that->fields.mAnimation;
      if ( this )
      {
        ...
        sub_1B71570(p_mAnimState, (int32_t)Item, v20, v21);
...
LABEL_43:
  ...
  if ( !this )
    goto LABEL_43;
  SimpleAnimation__Play_63643176((SimpleAnimation_o *)this, that->fields.animationName, 0LL);
  this = (EventPointVsResultAction_StatePlay_o *)that->fields.mSimpleAnimation;
  if ( !this )
    goto LABEL_43;
  ...
  sub_1B71570(p_fields, (int32_t)v7, v9, v10);
  ...
  {
LABEL_14:
    v16 = sub_1BC35AC(p_fields->klass, SimpleAnimation_State_TypeInfo, 14LL);
  }
  ...
  {
LABEL_33:
    v27 = sub_1BC35AC(p_fields->klass, SimpleAnimation_State_TypeInfo, 6LL);
  }
  ...
  {
LABEL_40:
    v32 = sub_1BC35AC(v28, SimpleAnimation_State_TypeInfo, 8LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C819 & 1) == 0 )
  {
    sub_1B715CC(&SimpleAnimation_State_TypeInfo, that);
    byte_4A1C819 = 1;
  }
  ...
  if ( mSimpleAnimState )
  {
    ...
    {
LABEL_8:
      p_method = sub_1BC35AC(this->fields.mSimpleAnimState, SimpleAnimation_State_TypeInfo, 3LL);
    }
    ...
    {
LABEL_20:
      v19 = sub_1BC35AC(v15, SimpleAnimation_State_TypeInfo, 14LL);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C81A & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_EventPointVsResultAction_StateTouchWait_update__, v6);
    sub_1B715CC(&Method_EventPointVsResultAction_StateTouchWait___c__DisplayClass1_0__update_b__0__, v7);
    sub_1B715CC(&EventPointVsResultAction_StateTouchWait___c__DisplayClass1_0_TypeInfo, v8);
    byte_4A1C81A = 1;
  }
  v9 = sub_1B71818(EventPointVsResultAction_StateTouchWait___c__DisplayClass1_0_TypeInfo);
      ...
      if ( isTouchPush )
      {
        ...
        if ( isTouchPush )
        {
          ...
          if ( (*((_BYTE *)Method_EventPointVsResultAction_StateTouchWait_update__ + 83) & 2) != 0 )
            v15 = (_QWORD *)sub_1B715E4(Method_EventPointVsResultAction_StateTouchWait_update__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C81B & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_EventPointVsResultAction___c__DisplayClass19_0__Setup_b__1__, v7);
    this = (EventPointVsResultAction___c__DisplayClass19_0_o *)sub_1B715CC(&StringLiteral_3118/*"Back/back{0}"*/, v8);
    byte_4A1C81B = 1;
  }
  ...
  this = (EventPointVsResultAction___c__DisplayClass19_0_o *)System_String__Format(
                                                               (System_String_o *)StringLiteral_3118/*"Back/back{0}"*/,
                                                               v13,
                                                               0LL);
  ...
  if ( !_9__1 )
  {
    ...
    sub_1B71570((ServantStatusBattleListViewItem_o *)&v5->fields.__9__1, (int32_t)_9__1, v16, v17);
  }
  if ( !mBg )
    goto LABEL_13;
