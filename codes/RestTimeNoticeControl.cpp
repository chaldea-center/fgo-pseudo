        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C3B9C0(restTimeLabel, method);
  }
  v5.fields.r = 0.69804;
  v5.fields.a = 1.0;
  v5.fields.g = 0.69804;
...
void __fastcall RestTimeNoticeControl__Start(RestTimeNoticeControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C25A6A & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_RestTimeNoticeControl__Start_b__6_0__, v4);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C25A6B & 1) == 0 )
  {
    sub_1C3B764(&Method_System_Array_Empty_object___, now);
    sub_1C3B764(&int_TypeInfo, v5);
    sub_1C3B764(&LocalizationManager_TypeInfo, v6);
    sub_1C3B764(&StringLiteral_5730/*"Easing type not implemented"*/, v7);
    sub_1C3B764(&StringLiteral_5846/*"Empty symbols submission token"*/, v8);
    sub_1C3B764(&StringLiteral_5847/*"EmptyObjectFromNull"*/, v9);
    sub_1C3B764(&StringLiteral_5759/*"Effect/BoxGacha"*/, v10);
    byte_4C25A6B = 1;
  }
  endAt = this->fields.endAt;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v12 = LocalizationManager__Get((System_String_o *)StringLiteral_5846/*"Empty symbols submission token"*/, 0LL);
  ...
  v19 = System_String__Format_63383120(v15, **(System_Object_array ***)(v18 + 184), 0LL);
  ...
  if ( (int)(v23 / 0x15180) >= 1 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v28 = LocalizationManager__Get((System_String_o *)StringLiteral_5730/*"Easing type not implemented"*/, 0LL);
    v29 = &v45;
    v45 = v24;
LABEL_23:
  ...
  if ( (int)(v23 / 0xE10) >= 1 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v28 = LocalizationManager__Get((System_String_o *)StringLiteral_5847/*"EmptyObjectFromNull"*/, 0LL);
    v44 = v30;
    v29 = &v44;
    goto LABEL_23;
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v38 = LocalizationManager__Get((System_String_o *)StringLiteral_5759/*"Effect/BoxGacha"*/, 0LL);
  v43 = v37;
...
void __fastcall RestTimeNoticeControl___Start_b__6_0(RestTimeNoticeControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C25A6C & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_21006/*"materialReferenceIndex"*/, v3);
    byte_4C25A6C = 1;
  }
  textImage = this->fields.textImage;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetBondAtlasImage(textImage, (System_String_o *)StringLiteral_21006/*"materialReferenceIndex"*/, 0LL);
