...
void RestTimeNoticeControl__SetRestTimeLabelColorWhite(RestTimeNoticeControl_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C93D2C(restTimeLabel, method);
  }
  v5.fields.r = 0.69804;
  v5.fields.a = 1.0;
  v5.fields.g = 0.69804;
...
void RestTimeNoticeControl__Start(RestTimeNoticeControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D34B21 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_RestTimeNoticeControl__Start_b__6_0__);
...
void RestTimeNoticeControl__UpdateRestTime(RestTimeNoticeControl_o *this, int64_t now, const MethodInfo *method)
{
  ...
  if ( (byte_4D34B22 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_5661/*"EVENT_MIN_TXT"*/);
    byte_4D34B22 = 1;
  }
  endAt = this->fields.endAt;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v6 = LocalizationManager__Get((System_String_o *)StringLiteral_5758/*"EVENT_TIMEOVER_TXT"*/, 0);
  ...
  v13 = System_String__Format_64467168(v9, **(System_Object_array ***)(v12 + 184), 0);
  ...
  v32.fields.a = 1.0;
  v17 = endAt - now;
  UILabel__set_effectColor(restTimeLabel, v32, 0);
  if ( (__int64)v17 < 1 )
    goto LABEL_26;
  v18 = v17 / 0x15180;
  if ( (int)(v17 / 0x15180) >= 1 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v19 = LocalizationManager__Get((System_String_o *)StringLiteral_5622/*"EVENT_DAY_TXT"*/, 0);
    v20 = &v31;
    v31 = v18;
LABEL_23:
  ...
  if ( (int)(v17 / 0xE10) >= 1 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v19 = LocalizationManager__Get((System_String_o *)StringLiteral_5759/*"EVENT_TIME_TXT"*/, 0);
    v30 = v21;
    v20 = &v30;
    goto LABEL_23;
  }
  v26 = (v17 / 0x3C) & ~((int)(v17 / 0x3C) >> 31);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v27 = LocalizationManager__Get((System_String_o *)StringLiteral_5661/*"EVENT_MIN_TXT"*/, 0);
  v29 = v26;
  v28 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v29);
  restTimeLabel = (UILabel_o *)System_String__Format(v27, v28, 0);
  v23 = this->fields.restTimeLabel;
  if ( !v23 )
LABEL_32:
    sub_1C93D2C(restTimeLabel, v15);
  v13 = (System_String_o *)restTimeLabel;
  v33.fields.r = 1.0;
  v33.fields.g = 1.0;
  v33.fields.b = 1.0;
LABEL_25:
  v33.fields.a = 1.0;
  UILabel__set_effectColor(v23, v33, 0);
LABEL_26:
  restTimeLabel = this->fields.restTimeLabel;
  if ( !restTimeLabel )
    goto LABEL_32;
...
void RestTimeNoticeControl___Start_b__6_0(RestTimeNoticeControl_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C93AD4(&AtlasManager_TypeInfo);
    sub_1C93AD4(&StringLiteral_20953/*"img_txt_special_ascension"*/);
    byte_4D34B23 = 1;
  }
  textImage = this->fields.textImage;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetBondAtlasImage(textImage, (System_String_o *)StringLiteral_20953/*"img_txt_special_ascension"*/, 0);
