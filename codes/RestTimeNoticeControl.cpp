        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C1AE30(restTimeLabel, method);
  }
  v5.fields.r = 0.69804;
  v5.fields.a = 1.0;
  v5.fields.g = 0.69804;
...
void __fastcall RestTimeNoticeControl__Start(RestTimeNoticeControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BCB4DB & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_RestTimeNoticeControl__Start_b__6_0__, v4);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCB4DC & 1) == 0 )
  {
    sub_1C1ABD4(&Method_System_Array_Empty_object___, now);
    sub_1C1ABD4(&int_TypeInfo, v5);
    sub_1C1ABD4(&LocalizationManager_TypeInfo, v6);
    sub_1C1ABD4(&StringLiteral_5728/*"EVENT_DAY_TXT"*/, v7);
    sub_1C1ABD4(&StringLiteral_5844/*"EVENT_TIMEOVER_TXT"*/, v8);
    sub_1C1ABD4(&StringLiteral_5845/*"EVENT_TIME_TXT"*/, v9);
    sub_1C1ABD4(&StringLiteral_5757/*"EVENT_MIN_TXT"*/, v10);
    byte_4BCB4DC = 1;
  }
  endAt = this->fields.endAt;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v12 = LocalizationManager__Get((System_String_o *)StringLiteral_5844/*"EVENT_TIMEOVER_TXT"*/, 0LL);
  ...
  v19 = System_String__Format_63054876(v15, **(System_Object_array ***)(v18 + 184), 0LL);
  ...
  if ( (int)(v23 / 0x15180) >= 1 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v28 = LocalizationManager__Get((System_String_o *)StringLiteral_5728/*"EVENT_DAY_TXT"*/, 0LL);
    v29 = &v45;
    v45 = v24;
LABEL_23:
  ...
  if ( (int)(v23 / 0xE10) >= 1 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v28 = LocalizationManager__Get((System_String_o *)StringLiteral_5845/*"EVENT_TIME_TXT"*/, 0LL);
    v44 = v30;
    v29 = &v44;
    goto LABEL_23;
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v38 = LocalizationManager__Get((System_String_o *)StringLiteral_5757/*"EVENT_MIN_TXT"*/, 0LL);
  v43 = v37;
...
void __fastcall RestTimeNoticeControl___Start_b__6_0(RestTimeNoticeControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BCB4DD & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_20942/*"img_txt_special_ascension"*/, v3);
    byte_4BCB4DD = 1;
  }
  textImage = this->fields.textImage;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetBondAtlasImage(textImage, (System_String_o *)StringLiteral_20942/*"img_txt_special_ascension"*/, 0LL);
