        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B64ACC(restTimeLabel, method);
  }
  v5.fields.r = 0.69804;
  v5.fields.a = 1.0;
  v5.fields.g = 0.69804;
...
void __fastcall RestTimeNoticeControl__Start(RestTimeNoticeControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A01D0E & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_RestTimeNoticeControl__Start_b__6_0__, v4);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01D0F & 1) == 0 )
  {
    sub_1B64870(&Method_System_Array_Empty_object___, now);
    sub_1B64870(&int_TypeInfo, v5);
    sub_1B64870(&LocalizationManager_TypeInfo, v6);
    sub_1B64870(&StringLiteral_5589/*"EVENT_DAY_TXT"*/, v7);
    sub_1B64870(&StringLiteral_5701/*"EVENT_TIMEOVER_TXT"*/, v8);
    sub_1B64870(&StringLiteral_5702/*"EVENT_TIME_TXT"*/, v9);
    sub_1B64870(&StringLiteral_5614/*"EVENT_MIN_TXT"*/, v10);
    byte_4A01D0F = 1;
  }
  ...
  if ( (*(_BYTE *)(v17 + 309) & 1) == 0 )
    v17 = sub_1BB674C(v17);
  v18 = System_String__Format_61398084(v14, **(System_Object_array ***)(v17 + 184), 0LL);
  ...
  if ( (int)(v22 / 0x15180) >= 1 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v27 = LocalizationManager__Get((System_String_o *)StringLiteral_5589/*"EVENT_DAY_TXT"*/, 0LL);
    v28 = &v44;
    v44 = v23;
LABEL_23:
  ...
  if ( (int)(v22 / 0xE10) >= 1 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v27 = LocalizationManager__Get((System_String_o *)StringLiteral_5702/*"EVENT_TIME_TXT"*/, 0LL);
    v43 = v29;
    v28 = &v43;
    goto LABEL_23;
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v37 = LocalizationManager__Get((System_String_o *)StringLiteral_5614/*"EVENT_MIN_TXT"*/, 0LL);
  v42 = v36;
...
void __fastcall RestTimeNoticeControl___Start_b__6_0(RestTimeNoticeControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A01D10 & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_20509/*"img_txt_special_ascension"*/, v3);
    byte_4A01D10 = 1;
  }
