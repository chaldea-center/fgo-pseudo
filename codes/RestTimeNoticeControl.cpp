...
void __fastcall RestTimeNoticeControl__Start(RestTimeNoticeControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B289D & 1) == 0 )
  {
    ...
    sub_B52984(&Method_RestTimeNoticeControl__Start_b__6_0__);
        ...
        const MethodInfo *method)
{
  ...
  v6 = LocalizationManager__Get((System_String_o *)StringLiteral_5776/*"EVENT_TIMEOVER_TXT"*/, 0LL);
  ...
  if ( (*(_BYTE *)(v12 + 306) & 1) == 0 )
    sub_AEB684(*v7[6]);
  v13 = System_String__Format_44647040(v6, **(System_Object_array ***)(v12 + 184), 0LL);
  ...
  *(UnityEngine_Color_o *)&v18 = UnityEngine_Color__get_white(0LL);
  ...
  if ( (int)(v22 / 0x15180) >= 1 )
  {
    ...
    v24 = LocalizationManager__Get((System_String_o *)StringLiteral_5665/*"EVENT_DAY_TXT"*/, 0LL);
    v25 = &v40;
    v40 = v23;
    goto LABEL_29;
  }
  ...
  if ( (int)(v22 / 0xE10) >= 1 )
  {
    ...
    v24 = LocalizationManager__Get((System_String_o *)StringLiteral_5777/*"EVENT_TIME_TXT"*/, 0LL);
    v39 = v26;
    v25 = &v39;
LABEL_29:
    v27 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, v25);
    v28 = System_String__Format(v24, v27, 0LL);
  ...
  v34 = (v22 / 0x3C) & ~((int)(v22 / 0x3C) >> 31);
  if ( (BYTE3(LocalizationManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !LocalizationManager_TypeInfo->_2.cctor_finished )
  {
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  }
  v35 = LocalizationManager__Get((System_String_o *)StringLiteral_5689/*"EVENT_MIN_TXT"*/, 0LL);
  v38 = v34;
...
void __fastcall RestTimeNoticeControl___Start_b__6_0(RestTimeNoticeControl_o *this, const MethodInfo *method)
{
  ...
  {
    sub_B52984(&AtlasManager_TypeInfo);
    sub_B52984(&StringLiteral_19890/*"img_txt_special_ascension"*/);
    byte_42B289F = 1;
  }
  textImage = this->fields.textImage;
  if ( (BYTE3(AtlasManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0 && !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetBondAtlasImage(textImage, (System_String_o *)StringLiteral_19890/*"img_txt_special_ascension"*/, 0LL);
