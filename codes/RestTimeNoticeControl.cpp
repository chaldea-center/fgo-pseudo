...
void RestTimeNoticeControl__SetRestTimeLabelColorWhite(RestTimeNoticeControl_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C7BD40(restTimeLabel, method);
  }
  v5.fields.r = 0.69804;
  v5.fields.a = 1.0;
  v5.fields.g = 0.69804;
...
void RestTimeNoticeControl__Start(RestTimeNoticeControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CF2732 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_RestTimeNoticeControl__Start_b__6_0__);
...
void RestTimeNoticeControl__UpdateRestTime(RestTimeNoticeControl_o *this, int64_t now, const MethodInfo *method)
{
  ...
  if ( (byte_4CF2733 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_5643/*"EVENT_MIN_TXT"*/);
    byte_4CF2733 = 1;
  }
  endAt = this->fields.endAt;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v6 = LocalizationManager__Get((System_String_o *)StringLiteral_5740/*"EVENT_TIMEOVER_TXT"*/, 0);
  ...
  v13 = System_String__Format_64218356(v9, **(System_Object_array ***)(v12 + 184), 0);
  ...
  if ( (int)(v17 / 0x15180) >= 1 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v19 = LocalizationManager__Get((System_String_o *)StringLiteral_5605/*"EVENT_DAY_TXT"*/, 0);
    v20 = &v33;
    v33 = v18;
LABEL_23:
  ...
  if ( (int)(v17 / 0xE10) >= 1 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v19 = LocalizationManager__Get((System_String_o *)StringLiteral_5741/*"EVENT_TIME_TXT"*/, 0);
    v32 = v21;
    v20 = &v32;
    goto LABEL_23;
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v29 = LocalizationManager__Get((System_String_o *)StringLiteral_5643/*"EVENT_MIN_TXT"*/, 0);
  v31 = v28;
...
void RestTimeNoticeControl___Start_b__6_0(RestTimeNoticeControl_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C7BAE8(&AtlasManager_TypeInfo);
    sub_1C7BAE8(&StringLiteral_20891/*"img_txt_special_ascension"*/);
    byte_4CF2734 = 1;
  }
  textImage = this->fields.textImage;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetBondAtlasImage(textImage, (System_String_o *)StringLiteral_20891/*"img_txt_special_ascension"*/, 0);
