        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A462 & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_20122/*"img_frameselect"*/, v4);
  ...
  AtlasManager__SetPartyOrganizationImage(frameSprite, (System_String_o *)StringLiteral_20122/*"img_frameselect"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B86614(frameSprite, isActive);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( item )
  {
    ...
    if ( !byte_4A4A49B )
    {
      sub_1B863B8(&RecommendSupportMessageSelectDialog_TypeInfo, item);
      byte_4A4A49B = 1;
    }
