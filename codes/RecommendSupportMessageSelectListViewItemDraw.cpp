        ...
        const MethodInfo *method)
{
  ...
  AtlasManager__SetPartyOrganizationImage(frameSprite, (System_String_o *)StringLiteral_20428/*"img_frameselect"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C3E7C0(frameSprite, isActive);
  }
