        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62D03 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_20607/*"img_frameselect"*/, v4);
  ...
  AtlasManager__SetPartyOrganizationImage(frameSprite, (System_String_o *)StringLiteral_20607/*"img_frameselect"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BE4D28(frameSprite, isActive);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( item )
  {
    ...
    if ( !byte_4B62D72 )
    {
      sub_1BE4ACC(&RecommendSupportMessageSelectDialog_TypeInfo, item);
      byte_4B62D72 = 1;
    }
