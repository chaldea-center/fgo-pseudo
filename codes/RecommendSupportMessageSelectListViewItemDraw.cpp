        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A1BB & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_20311/*"img_frameselect"*/, v4);
  ...
  AtlasManager__SetPartyOrganizationImage(frameSprite, (System_String_o *)StringLiteral_20311/*"img_frameselect"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B7641C(frameSprite, isActive);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( item )
  {
    ...
    if ( !byte_4A2A26A )
    {
      sub_1B761C0(&RecommendSupportMessageSelectDialog_TypeInfo, item);
      byte_4A2A26A = 1;
    }
