        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC3BD3 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_20667/*"img_frameselect"*/, v4);
  ...
  AtlasManager__SetPartyOrganizationImage(frameSprite, (System_String_o *)StringLiteral_20667/*"img_frameselect"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C1AE30(frameSprite, isActive);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( item )
  {
    ...
    if ( !byte_4BC3C0C )
    {
      sub_1C1ABD4(&RecommendSupportMessageSelectDialog_TypeInfo, item);
      byte_4BC3C0C = 1;
    }
