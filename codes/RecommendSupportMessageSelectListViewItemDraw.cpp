        ...
        const MethodInfo *method)
{
  ...
  AtlasManager__SetPartyOrganizationImage(frameSprite, (System_String_o *)StringLiteral_20637/*"img_frameselect"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C93D2C(frameSprite, isActive);
  }
