        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1BD56 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_20266/*"img_frameselect"*/, v4);
  ...
  AtlasManager__SetPartyOrganizationImage(frameSprite, (System_String_o *)StringLiteral_20266/*"img_frameselect"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B71828(frameSprite, isActive);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( item )
  {
    ...
    if ( !byte_4A1BE05 )
    {
      sub_1B715CC(&RecommendSupportMessageSelectDialog_TypeInfo, item);
      byte_4A1BE05 = 1;
    }
