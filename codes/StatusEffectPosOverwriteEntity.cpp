void StatusEffectPosOverwriteEntity___ctor(StatusEffectPosOverwriteEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4C579F1 & 1) == 0 )
  {
...
System_String_o *StatusEffectPosOverwriteEntity__CreatePK(
...
System_String_o *StatusEffectPosOverwriteEntity__CreatePrimaryKey(
...
UnityEngine_Vector3_o StatusEffectPosOverwriteEntity__GetOffset(
        StatusEffectPosOverwriteEntity_o *this,
        bool isFlip,
        const MethodInfo *method)
{
...
UnityEngine_Vector3_o StatusEffectPosOverwriteEntity__GetRotation(
        StatusEffectPosOverwriteEntity_o *this,
        const MethodInfo *method)
{
...
UnityEngine_Vector3_o StatusEffectPosOverwriteEntity__GetScale(
        StatusEffectPosOverwriteEntity_o *this,
        const MethodInfo *method)
{
  unsigned __int64 v2; // d0
