void __fastcall WarBoardMessageScriptMaster___ctor(WarBoardMessageScriptMaster_o *this, const MethodInfo *method)
{
  if ( (byte_42132E1 & 1) == 0 )
  {
    sub_B0D8A4(&Method_DataMasterBase_WarBoardMessageScriptMaster__WarBoardMessageScriptEntity__string___ctor__, method);
    byte_42132E1 = 1;
  }
  DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string____ctor(
    (DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string__o *)this,
    413,
    (const MethodInfo_2669F88 *)Method_DataMasterBase_WarBoardMessageScriptMaster__WarBoardMessageScriptEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42132E2 & 1) == 0 )
  {
    sub_B0D8A4(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__GetEnumerator__, imageId);
    ...
    sub_B0D8A4(&WarBoardMessageScriptEntity_TypeInfo, v8);
    byte_42132E2 = 1;
  }
...
LABEL_16:
    ...
    {
      v19 = (System_String_o **)sub_B0DC70(v19);
LABEL_35:
      sub_B0D97C(v19);
    }
    if ( !imageId )
      sub_B0D97C(v19);
    if ( System_String__Equals_43837244(imageId, v19[2], 0LL) )
    {
      v22 = 66;
      goto LABEL_25;
    }
