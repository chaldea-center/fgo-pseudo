void __fastcall WarBoardMessageScriptMaster___ctor(WarBoardMessageScriptMaster_o *this, const MethodInfo *method)
{
  ...
  DataMasterBase_object__object__object____ctor(
    ...
    421,
    (const MethodInfo_32CA594 *)Method_DataMasterBase_WarBoardMessageScriptMaster__WarBoardMessageScriptEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1D668 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_System_Collections_ObjectModel_Collection_WarBoardMessageScriptEntity__GetEnumerator__, imageId);
    sub_1BCAFF8(&System_IDisposable_TypeInfo, v5);
    sub_1BCAFF8(&System_Collections_Generic_IEnumerator_WarBoardMessageScriptEntity__TypeInfo, v6);
    sub_1BCAFF8(&System_Collections_IEnumerator_TypeInfo, v7);
    byte_4B1D668 = 1;
  }
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
    sub_1BCB254(0LL, imageId);
  Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                 list,
                 (const MethodInfo_3263BC0 *)Method_System_Collections_ObjectModel_Collection_WarBoardMessageScriptEntity__GetEnumerator__);
  if ( !Enumerator )
    sub_1BCB254(0LL, v9);
  while ( 1 )
  {
...
LABEL_9:
    ...
    {
LABEL_16:
      v18 = sub_1C1B560(Enumerator, System_Collections_Generic_IEnumerator_WarBoardMessageScriptEntity__TypeInfo, 0LL);
    }
    ...
    if ( !imageId )
      sub_1BCB254(v19, v20);
    if ( System_String__Equals_62485728(imageId, *(System_String_o **)(v19 + 16), 0LL) )
      goto LABEL_23;
  }
  v21 = 0LL;
LABEL_23:
