void UIToggle___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E09131 & 1) == 0 )
  {
    sub_1CE6700(&Method_BetterList_UIToggle___ctor__);
    sub_1CE6700(&BetterList_UIToggle__TypeInfo);
    sub_1CE6700(&UIToggle_TypeInfo);
    byte_4E09131 = 1;
  }
  v1 = (BetterList_T__o *)sub_1CE694C(BetterList_UIToggle__TypeInfo);
  BetterList_object____ctor(v1, (const MethodInfo_3460C38 *)Method_BetterList_UIToggle___ctor__);
  UIToggle_TypeInfo->static_fields->list = (struct BetterList_UIToggle__o *)v1;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)UIToggle_TypeInfo->static_fields, (int32_t)v1, v2, v3, v4, v5, v6, v7);
}
...
void UIToggle___ctor(UIToggle_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E09130 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_9908/*"OnActivate"*/);
    byte_4E09130 = 1;
  }
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.onChange, (int32_t)v3, v4, v5, v6, v7, v8, v9);
  v10 = StringLiteral_9908/*"OnActivate"*/;
  this->fields.functionName = (struct System_String_o *)StringLiteral_9908/*"OnActivate"*/;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.functionName, v10, v11, v12, v13, v14, v15, v16);
...
UIToggle_o *UIToggle__GetActiveToggle(int32_t group, const MethodInfo *method)
{
  ...
  if ( (byte_4E0912B & 1) == 0 )
  {
    sub_1CE6700(&Method_BetterList_UIToggle__get_Item__);
...
LABEL_19:
    ...
    Item = BetterList_object___get_Item(list, i, (const MethodInfo_34602E4 *)Method_BetterList_UIToggle__get_Item__);
...
void UIToggle__OnDisable(UIToggle_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E0912D & 1) == 0 )
  {
    sub_1CE6700(&Method_BetterList_UIToggle__Remove__);
    sub_1CE6700(&UIToggle_TypeInfo);
    byte_4E0912D = 1;
  }
  ...
  BetterList_object___Remove(
    list,
    (Il2CppObject *)this,
    (const MethodInfo_34607C4 *)Method_BetterList_UIToggle__Remove__);
}
...
void UIToggle__OnEnable(UIToggle_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E0912C & 1) == 0 )
  {
    sub_1CE6700(&Method_BetterList_UIToggle__Add__);
    sub_1CE6700(&UIToggle_TypeInfo);
    byte_4E0912C = 1;
  }
  v3 = UIToggle_TypeInfo;
  ...
  if ( !list )
    sub_1CE6958(0, method);
  BetterList_object___Add(list, (Il2CppObject *)this, (const MethodInfo_346050C *)Method_BetterList_UIToggle__Add__);
}
            ...
            while ( 1 )
            {
              ...
              while ( 1 )
              {
                ...
                Item = BetterList_object___get_Item(
                         ...
                         v10,
                         (const MethodInfo_34602E4 *)Method_BetterList_UIToggle__get_Item__);
                if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
                  j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
...
LABEL_52:
        ...
        if ( UnityEngine_Object__op_Equality(current, 0, 0) )
        {
          ...
          sub_1CE66A4(static_fields, (int32_t)this, v23, v24, v25, v26, v27, v28);
          onChange = this->fields.onChange;
          if ( !EventDelegate_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(EventDelegate_TypeInfo);
          IsValid_50356184 = EventDelegate__IsValid_50356184(onChange, v33);
          if ( IsValid_50356184 )
            v37 = 0;
          else
            v37 = v31;
          if ( IsValid_50356184 )
          {
            ...
            if ( !EventDelegate_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(EventDelegate_TypeInfo);
            EventDelegate__Execute_50327612(v38, v36);
          }
          else
          {
            ...
            if ( UnityEngine_Object__op_Inequality(eventReceiver, 0, 0) )
            {
              if ( !System_String__IsNullOrEmpty(this->fields.functionName, 0) )
              {
                ...
                if ( !v46 )
                  goto LABEL_98;
                UnityEngine_GameObject__SendMessage_72898824(v46, functionName, (Il2CppObject *)Active, 1, 0);
              }
              v31 = v37;
            }
          }
          ...
          v49->current = v31;
          sub_1CE66A4((GrandQuestFolderBoardItem_o *)&v49->current, (int32_t)v31, v39, v40, v41, v42, v43, v44);
        }
        ...
        if ( UnityEngine_Object__op_Inequality(activeAnimation, 0, 0) )
        {
          if ( state )
            ...
            v52 = -1;
          v53 = (UnityEngine_Object_o *)ActiveAnimation__Play_50356412(this->fields.activeAnimation, 0, v52, 2, 0, v51);
          if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
...
void UIToggle__Start(UIToggle_o *this, const MethodInfo *method)
{
  ...
  else
  {
    ...
    if ( UnityEngine_Object__op_Inequality(checkSprite, 0, 0) )
    {
      ...
      if ( UnityEngine_Object__op_Equality(activeSprite, 0, 0) )
      {
        ...
        sub_1CE66A4(
          ...
          v14);
        *p_checkSprite = 0;
        sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.checkSprite, 0, v16, v17, v18, v19, v20, v21);
      }
    }
    ...
    if ( UnityEngine_Object__op_Inequality(checkAnimation, 0, 0) )
    {
      ...
      if ( UnityEngine_Object__op_Equality(activeAnimation, 0, 0) )
      {
        ...
        sub_1CE66A4(
          ...
          v30);
        *p_checkAnimation = 0;
        sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.checkAnimation, 0, v32, v33, v34, v35, v36, v37);
      }
    }
    if ( !UnityEngine_Application_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Application_TypeInfo);
    ...
    if ( !EventDelegate_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(EventDelegate_TypeInfo);
    if ( EventDelegate__IsValid_50356184(onChange, v38) )
    {
      this->fields.eventReceiver = 0;
      sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.eventReceiver, 0, v43, v44, v45, v46, v47, v48);
      this->fields.functionName = 0;
      sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.functionName, 0, v49, v50, v51, v52, v53, v54);
    }
  }
}
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1B1EBF0;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1B1EB9C;
}
