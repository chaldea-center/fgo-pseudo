...
bool UIFont__CheckIfRelated(UIFont_o *a, UIFont_o *b, const MethodInfo *method)
{
  ...
  if ( ((unsigned __int8)isDynamic & 1) != 0 )
  {
    if ( !b )
      goto LABEL_28;
    if ( UIFont__get_isDynamic(b, v8) )
    {
      isDynamic = UIFont__get_dynamicFont(a, v9);
      if ( !isDynamic )
        goto LABEL_28;
      ...
      if ( !*((_DWORD *)isDynamic + 6) )
        goto LABEL_29;
      v11 = (System_String_o *)*((_QWORD *)isDynamic + 4);
      isDynamic = UIFont__get_dynamicFont(b, v10);
      if ( !isDynamic )
        goto LABEL_28;
      isDynamic = UnityEngine_Font__get_fontNames((UnityEngine_Font_o *)isDynamic, 0);
      if ( !isDynamic )
...
LABEL_29:
  ...
  if ( UnityEngine_Object__op_Equality((UnityEngine_Object_o *)a, (UnityEngine_Object_o *)b, 0) )
    return 1;
  isDynamic = (void *)UIFont__References(a, b, v12);
  if ( ((unsigned __int8)isDynamic & 1) != 0 )
    return 1;
  if ( !b )
LABEL_28:
...
LABEL_30:
  ...
  if ( (int)m_CancellationTokenSource >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !v14 )
        goto LABEL_30;
      Active_object = (UIFont_o *)UnityEngine_Behaviour__get_enabled((UnityEngine_Behaviour_o *)v13[4], 0);
      if ( ((unsigned __int8)Active_object & 1) != 0 )
      {
        ...
        if ( ((unsigned __int8)Active_object & 1) != 0 )
        {
          ...
          if ( ((unsigned __int8)Active_object & 1) != 0 )
          {
            data = (UIFont_o *)v14[1]._1.byval_arg.data;
            UILabel__set_bitmapFont((UILabel_o *)v14, 0, v17);
            UILabel__set_bitmapFont((UILabel_o *)v14, data, v19);
          }
        }
      }
      if ( v11 == v12 )
  ...
  if ( !Active_object )
    goto LABEL_30;
  v21 = (int)Active_object->fields.m_CancellationTokenSource;
  if ( v21 >= 1 )
  {
    v22 = 0;
    while ( 1 )
    {
      Active_object = (UIFont_o *)UIFont__get_symbols(this, v20);
      if ( !Active_object )
        break;
        ...
        if ( v12 >= (int)mSymbols )
        {
          if ( (int)mSymbols >= 1 )
          {
            if ( text )
            {
              ...
              while ( 1 )
              {
                mSymbols = (System_Collections_Generic_List_object__o *)System_String__get_Chars(text, offset + v16, 0);
                if ( !v13->fields.sequence )
                  break;
                if ( (unsigned __int16)mSymbols != System_String__get_Chars(v13->fields.sequence, v16, 0) )
                  goto LABEL_16;
                if ( v15 == ++v16 )
                  goto LABEL_15;
              }
...
LABEL_19:
        ...
        if ( size >= 1 )
        {
          ...
          while ( 1 )
          {
            IsNullOrEmpty = UIFont__get_symbols(this, v21);
            if ( !IsNullOrEmpty )
              break;
...
void UIFont__set_dynamicFont(UIFont_o *this, UnityEngine_Font_o *value, const MethodInfo *method)
{
  ...
  {
    v8 = (UnityEngine_Object_o *)this->fields.mDynamicFont;
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  ...
  if ( UnityEngine_Object__op_Inequality(mReplacement, (UnityEngine_Object_o *)value, 0) )
  {
    ...
    if ( v8 )
    {
      ...
      if ( UnityEngine_Object__op_Equality(v9, (UnityEngine_Object_o *)this, 0) )
        UIFont__set_replacement(value, 0, v10);
    }
