        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA64A & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_17395/*"btn_Polaroid_bg"*/, v7);
    sub_1B64A00(&StringLiteral_10326/*"PHOTO_SETTING_CHANGE_SERVANT_BUTTON"*/, v8);
    sub_1B64A00(&StringLiteral_10329/*"PHOTO_SETTING_HIDE_UI_BUTTON"*/, v9);
    sub_1B64A00(&StringLiteral_10328/*"PHOTO_SETTING_EXCHANGE_POSITION_BUTTON"*/, v10);
    sub_1B64A00(&StringLiteral_10325/*"PHOTO_SETTING_CHANGE_MASTER_SETTING_BUTTON"*/, v11);
    sub_1B64A00(&StringLiteral_10327/*"PHOTO_SETTING_CHANGE_SERVANT_FACE_BUTTON"*/, v12);
    byte_49FA64A = 1;
  }
  changeServantButtonLabel = this->fields.changeServantButtonLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  myRoomControl = LocalizationManager__Get((System_String_o *)StringLiteral_10326/*"PHOTO_SETTING_CHANGE_SERVANT_BUTTON"*/, 0LL);
  ...
  myRoomControl = LocalizationManager__Get((System_String_o *)StringLiteral_10327/*"PHOTO_SETTING_CHANGE_SERVANT_FACE_BUTTON"*/, 0LL);
  ...
  myRoomControl = LocalizationManager__Get((System_String_o *)StringLiteral_10325/*"PHOTO_SETTING_CHANGE_MASTER_SETTING_BUTTON"*/, 0LL);
  ...
  myRoomControl = LocalizationManager__Get((System_String_o *)StringLiteral_10328/*"PHOTO_SETTING_EXCHANGE_POSITION_BUTTON"*/, 0LL);
  ...
  myRoomControl = LocalizationManager__Get((System_String_o *)StringLiteral_10329/*"PHOTO_SETTING_HIDE_UI_BUTTON"*/, 0LL);
  ...
  MyRoomControl__SetPhotoCampaignSprite(
    ...
    (System_String_o *)StringLiteral_17395/*"btn_Polaroid_bg"*/,
    0LL);
  myRoomControl = (System_String_o *)this->fields.myRoomControl;
  if ( !myRoomControl )
    goto LABEL_32;
        ...
        const MethodInfo *method)
{
  ...
  sub_1B649A4(&this->fields.myRoomControl);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA64D & 1) == 0 )
  {
    sub_1B64A00(&Method_PhotoSettingButtonComponent_OnClickChangeMasterSettingButton__, method);
    byte_49FA64D = 1;
  }
  ...
  if ( (*((_BYTE *)Method_PhotoSettingButtonComponent_OnClickChangeMasterSettingButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B64A18(Method_PhotoSettingButtonComponent_OnClickChangeMasterSettingButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA64B & 1) == 0 )
  {
    sub_1B64A00(&Method_PhotoSettingButtonComponent_OnClickChangeServantButton__, method);
    byte_49FA64B = 1;
  }
  ...
  if ( (*((_BYTE *)Method_PhotoSettingButtonComponent_OnClickChangeServantButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B64A18(Method_PhotoSettingButtonComponent_OnClickChangeServantButton__);
  v4 = (System_Reflection_MethodBase_o *)sub_1B649E4(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
  myRoomControl = this->fields.myRoomControl;
  if ( !myRoomControl )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA64C & 1) == 0 )
  {
    sub_1B64A00(&Method_PhotoSettingButtonComponent_OnClickChangeServantFaceButton__, method);
    byte_49FA64C = 1;
  }
  ...
  if ( (*((_BYTE *)Method_PhotoSettingButtonComponent_OnClickChangeServantFaceButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B64A18(Method_PhotoSettingButtonComponent_OnClickChangeServantFaceButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA64E & 1) == 0 )
  {
    sub_1B64A00(&Method_PhotoSettingButtonComponent_OnClickExchangePositionButton__, method);
    byte_49FA64E = 1;
  }
  ...
  if ( (*((_BYTE *)Method_PhotoSettingButtonComponent_OnClickExchangePositionButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B64A18(Method_PhotoSettingButtonComponent_OnClickExchangePositionButton__);
  v4 = (System_Reflection_MethodBase_o *)sub_1B649E4(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
  myRoomControl = this->fields.myRoomControl;
  if ( !myRoomControl )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA64F & 1) == 0 )
  {
    sub_1B64A00(&Method_PhotoSettingButtonComponent_OnClickHideUIButton__, method);
    byte_49FA64F = 1;
  }
  ...
  if ( (*((_BYTE *)Method_PhotoSettingButtonComponent_OnClickHideUIButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B64A18(Method_PhotoSettingButtonComponent_OnClickHideUIButton__);
  v4 = (System_Reflection_MethodBase_o *)sub_1B649E4(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
  myRoomControl = this->fields.myRoomControl;
  if ( !myRoomControl )
