        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A56BFD & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_17462/*"btn_Polaroid_bg"*/);
    sub_1B885B0(&StringLiteral_10373/*"PHOTO_SETTING_CHANGE_SERVANT_BUTTON"*/);
    sub_1B885B0(&StringLiteral_10376/*"PHOTO_SETTING_HIDE_UI_BUTTON"*/);
    sub_1B885B0(&StringLiteral_10375/*"PHOTO_SETTING_EXCHANGE_POSITION_BUTTON"*/);
    sub_1B885B0(&StringLiteral_10372/*"PHOTO_SETTING_CHANGE_MASTER_SETTING_BUTTON"*/);
    sub_1B885B0(&StringLiteral_10374/*"PHOTO_SETTING_CHANGE_SERVANT_FACE_BUTTON"*/);
    byte_4A56BFD = 1;
  }
  changeServantButtonLabel = this->fields.changeServantButtonLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  myRoomControl = LocalizationManager__Get((System_String_o *)StringLiteral_10373/*"PHOTO_SETTING_CHANGE_SERVANT_BUTTON"*/, 0LL);
  ...
  myRoomControl = LocalizationManager__Get((System_String_o *)StringLiteral_10374/*"PHOTO_SETTING_CHANGE_SERVANT_FACE_BUTTON"*/, 0LL);
  ...
  myRoomControl = LocalizationManager__Get((System_String_o *)StringLiteral_10372/*"PHOTO_SETTING_CHANGE_MASTER_SETTING_BUTTON"*/, 0LL);
  ...
  myRoomControl = LocalizationManager__Get((System_String_o *)StringLiteral_10375/*"PHOTO_SETTING_EXCHANGE_POSITION_BUTTON"*/, 0LL);
  ...
  myRoomControl = LocalizationManager__Get((System_String_o *)StringLiteral_10376/*"PHOTO_SETTING_HIDE_UI_BUTTON"*/, 0LL);
  ...
  MyRoomControl__SetPhotoCampaignSprite(
    ...
    (System_String_o *)StringLiteral_17462/*"btn_Polaroid_bg"*/,
    0LL);
  myRoomControl = (System_String_o *)this->fields.myRoomControl;
  if ( !myRoomControl )
    goto LABEL_32;
  ...
  v14 = useChangeServantFace ? 1.0 : 0.5;
  ...
  v25.fields.g = v14;
  v25.fields.b = v14;
  UIWidget__set_color((UIWidget_o *)myRoomControl, v25, 0LL);
  ...
  v26.fields.g = v14;
  v26.fields.b = v14;
  UIWidget__set_color((UIWidget_o *)myRoomControl, v26, 0LL);
  ...
  if ( type == 1 )
  {
    ...
    if ( myRoomControl )
    {
      v16 = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)myRoomControl, 0LL);
      v21.fields.x = this->fields.topButtonPosition.fields.x;
      v21.fields.z = this->fields.topButtonPosition.fields.z;
      v21.fields.y = this->fields.topButtonPosition.fields.y + this->fields.moveButtonPositionY;
      this->fields.topButtonPosition.fields.y = v21.fields.y;
      GameObjectExtensions__SetLocalPosition(v16, v21, 0LL);
      myRoomControl = (System_String_o *)this->fields.changeMasterSettingButton;
      if ( myRoomControl )
      {
        v17 = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)myRoomControl, 0LL);
        v22.fields.x = this->fields.topButtonPosition.fields.x;
        v22.fields.z = this->fields.topButtonPosition.fields.z;
        v22.fields.y = this->fields.topButtonPosition.fields.y + this->fields.moveButtonPositionY;
        this->fields.topButtonPosition.fields.y = v22.fields.y;
        GameObjectExtensions__SetLocalPosition(v17, v22, 0LL);
        goto LABEL_29;
      }
    }
LABEL_32:
    sub_1B8880C(myRoomControl, v9);
  }
LABEL_29:
  myRoomControl = (System_String_o *)this->fields.changeServantFaceButton;
  if ( !myRoomControl )
    goto LABEL_32;
  v18 = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)myRoomControl, 0LL);
  v23.fields.x = this->fields.topButtonPosition.fields.x;
  v23.fields.z = this->fields.topButtonPosition.fields.z;
  v23.fields.y = this->fields.topButtonPosition.fields.y + this->fields.moveButtonPositionY;
  this->fields.topButtonPosition.fields.y = v23.fields.y;
  GameObjectExtensions__SetLocalPosition(v18, v23, 0LL);
  myRoomControl = (System_String_o *)this->fields.changeServantButton;
  if ( !myRoomControl )
    goto LABEL_32;
  v19 = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)myRoomControl, 0LL);
  v24.fields.x = this->fields.topButtonPosition.fields.x;
  v24.fields.z = this->fields.topButtonPosition.fields.z;
  v24.fields.y = this->fields.topButtonPosition.fields.y + this->fields.moveButtonPositionY;
  this->fields.topButtonPosition.fields.y = v24.fields.y;
  GameObjectExtensions__SetLocalPosition(v19, v24, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B88554(&this->fields.myRoomControl, myRoom);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A56C00 & 1) == 0 )
  {
    sub_1B885B0(&Method_PhotoSettingButtonComponent_OnClickChangeMasterSettingButton__);
    byte_4A56C00 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_PhotoSettingButtonComponent_OnClickChangeMasterSettingButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B885C8(Method_PhotoSettingButtonComponent_OnClickChangeMasterSettingButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A56BFE & 1) == 0 )
  {
    sub_1B885B0(&Method_PhotoSettingButtonComponent_OnClickChangeServantButton__);
    byte_4A56BFE = 1;
  }
  ...
  if ( (*((_BYTE *)Method_PhotoSettingButtonComponent_OnClickChangeServantButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B885C8(Method_PhotoSettingButtonComponent_OnClickChangeServantButton__);
  v4 = (System_Reflection_MethodBase_o *)sub_1B88594(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
  myRoomControl = this->fields.myRoomControl;
  if ( !myRoomControl )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A56BFF & 1) == 0 )
  {
    sub_1B885B0(&Method_PhotoSettingButtonComponent_OnClickChangeServantFaceButton__);
    byte_4A56BFF = 1;
  }
  ...
  if ( (*((_BYTE *)Method_PhotoSettingButtonComponent_OnClickChangeServantFaceButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B885C8(Method_PhotoSettingButtonComponent_OnClickChangeServantFaceButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A56C01 & 1) == 0 )
  {
    sub_1B885B0(&Method_PhotoSettingButtonComponent_OnClickExchangePositionButton__);
    byte_4A56C01 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_PhotoSettingButtonComponent_OnClickExchangePositionButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B885C8(Method_PhotoSettingButtonComponent_OnClickExchangePositionButton__);
  v4 = (System_Reflection_MethodBase_o *)sub_1B88594(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
  myRoomControl = this->fields.myRoomControl;
  if ( !myRoomControl )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A56C02 & 1) == 0 )
  {
    sub_1B885B0(&Method_PhotoSettingButtonComponent_OnClickHideUIButton__);
    byte_4A56C02 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_PhotoSettingButtonComponent_OnClickHideUIButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B885C8(Method_PhotoSettingButtonComponent_OnClickHideUIButton__);
  v4 = (System_Reflection_MethodBase_o *)sub_1B88594(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
  myRoomControl = this->fields.myRoomControl;
  if ( !myRoomControl )
