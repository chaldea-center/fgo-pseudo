        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AF7B7 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_17066/*"btn_Polaroid_bg"*/);
    sub_B52984(&StringLiteral_10505/*"PHOTO_SETTING_CHANGE_SERVANT_BUTTON"*/);
    sub_B52984(&StringLiteral_10508/*"PHOTO_SETTING_HIDE_UI_BUTTON"*/);
    sub_B52984(&StringLiteral_10507/*"PHOTO_SETTING_EXCHANGE_POSITION_BUTTON"*/);
    sub_B52984(&StringLiteral_10504/*"PHOTO_SETTING_CHANGE_MASTER_SETTING_BUTTON"*/);
    sub_B52984(&StringLiteral_10506/*"PHOTO_SETTING_CHANGE_SERVANT_FACE_BUTTON"*/);
    byte_42AF7B7 = 1;
  }
  ...
  myRoomControl = LocalizationManager__Get((System_String_o *)StringLiteral_10505/*"PHOTO_SETTING_CHANGE_SERVANT_BUTTON"*/, 0LL);
  ...
  myRoomControl = LocalizationManager__Get((System_String_o *)StringLiteral_10506/*"PHOTO_SETTING_CHANGE_SERVANT_FACE_BUTTON"*/, 0LL);
  ...
  myRoomControl = LocalizationManager__Get((System_String_o *)StringLiteral_10504/*"PHOTO_SETTING_CHANGE_MASTER_SETTING_BUTTON"*/, 0LL);
  ...
  myRoomControl = LocalizationManager__Get((System_String_o *)StringLiteral_10507/*"PHOTO_SETTING_EXCHANGE_POSITION_BUTTON"*/, 0LL);
  ...
  myRoomControl = LocalizationManager__Get((System_String_o *)StringLiteral_10508/*"PHOTO_SETTING_HIDE_UI_BUTTON"*/, 0LL);
  ...
  MyRoomControl__SetPhotoCampaignSprite(
    ...
    (System_String_o *)StringLiteral_17066/*"btn_Polaroid_bg"*/,
    0LL);
  myRoomControl = (System_String_o *)this->fields.myRoomControl;
  if ( !myRoomControl )
    goto LABEL_33;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AF7BA & 1) == 0 )
  {
    sub_B52984(&Method_PhotoSettingButtonComponent_OnClickChangeMasterSettingButton__);
    byte_42AF7BA = 1;
  }
  ...
  if ( (*((_BYTE *)Method_PhotoSettingButtonComponent_OnClickChangeMasterSettingButton__ + 75) & 2) != 0 )
    v3 = (_QWORD *)sub_B5298C(Method_PhotoSettingButtonComponent_OnClickChangeMasterSettingButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AF7B8 & 1) == 0 )
  {
    sub_B52984(&Method_PhotoSettingButtonComponent_OnClickChangeServantButton__);
    byte_42AF7B8 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_PhotoSettingButtonComponent_OnClickChangeServantButton__ + 75) & 2) != 0 )
    v3 = (_QWORD *)sub_B5298C(Method_PhotoSettingButtonComponent_OnClickChangeServantButton__);
  v4 = (System_Reflection_MethodBase_o *)sub_B52968(v3, v3[3]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
  myRoomControl = this->fields.myRoomControl;
  if ( !myRoomControl )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AF7B9 & 1) == 0 )
  {
    sub_B52984(&Method_PhotoSettingButtonComponent_OnClickChangeServantFaceButton__);
    byte_42AF7B9 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_PhotoSettingButtonComponent_OnClickChangeServantFaceButton__ + 75) & 2) != 0 )
    v4 = (_QWORD *)sub_B5298C(Method_PhotoSettingButtonComponent_OnClickChangeServantFaceButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AF7BB & 1) == 0 )
  {
    sub_B52984(&Method_PhotoSettingButtonComponent_OnClickExchangePositionButton__);
    byte_42AF7BB = 1;
  }
  ...
  if ( (*((_BYTE *)Method_PhotoSettingButtonComponent_OnClickExchangePositionButton__ + 75) & 2) != 0 )
    v3 = (_QWORD *)sub_B5298C(Method_PhotoSettingButtonComponent_OnClickExchangePositionButton__);
  v4 = (System_Reflection_MethodBase_o *)sub_B52968(v3, v3[3]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
  myRoomControl = this->fields.myRoomControl;
  if ( !myRoomControl )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AF7BC & 1) == 0 )
  {
    sub_B52984(&Method_PhotoSettingButtonComponent_OnClickHideUIButton__);
    byte_42AF7BC = 1;
  }
  ...
  if ( (*((_BYTE *)Method_PhotoSettingButtonComponent_OnClickHideUIButton__ + 75) & 2) != 0 )
    v3 = (_QWORD *)sub_B5298C(Method_PhotoSettingButtonComponent_OnClickHideUIButton__);
  v4 = (System_Reflection_MethodBase_o *)sub_B52968(v3, v3[3]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
  myRoomControl = this->fields.myRoomControl;
  if ( !myRoomControl )
