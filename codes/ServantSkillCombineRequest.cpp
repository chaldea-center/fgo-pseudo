        ...
        const MethodInfo *method)
{
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22547/*"num"*/, selectSkillIndex, v9);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23743/*"skillId"*/, selectSkillId, v10);
...
System_String_o *ServantSkillCombineRequest__getURL(ServantSkillCombineRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2E4B4 & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_17840/*"card/combineSkill"*/);
    byte_4D2E4B4 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64417744(BaseUrl, (System_String_o *)StringLiteral_17840/*"card/combineSkill"*/, 0);
}
