void __fastcall ClassBoardSave__CheckOpenedMissionClearDialog(const MethodInfo *method)
{
  ...
  if ( (byte_4B6A1A4 & 1) == 0 )
  {
    sub_1BE4ACC(&ClassBoardSave_TypeInfo, v1);
    sub_1BE4ACC(&Method_JsonManager_DeserializeArray_ClassBoardSave_ClassBoardSaveData___, v2);
    sub_1BE4ACC(&JsonManager_TypeInfo, v3);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_ClassBoardSave_ClassBoardSaveData__AddRange__, v4);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_ClassBoardSave_ClassBoardSaveData__Clear__, v5);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_ClassBoardSave_ClassBoardSaveData___ctor__, v6);
    sub_1BE4ACC(&System_Collections_Generic_List_ClassBoardSave_ClassBoardSaveData__TypeInfo, v7);
    sub_1BE4ACC(&StringLiteral_3546/*"CLASS_BOARD_OPEND_MISSION_CLEAR_KEY"*/, v8);
    byte_4B6A1A4 = 1;
  }
  if ( !ClassBoardSave_TypeInfo->static_fields->cachePlayCondOpenEffectList )
  {
    v9 = (System_Collections_Generic_List_object__o *)sub_1BE4D18(System_Collections_Generic_List_ClassBoardSave_ClassBoardSaveData__TypeInfo);
    System_Collections_Generic_List_object____ctor(
      v9,
      (const MethodInfo_35EB9F0 *)Method_System_Collections_Generic_List_ClassBoardSave_ClassBoardSaveData___ctor__);
    ...
    if ( ((unsigned __int8)HasKey & 1) != 0 )
    {
      ...
      v22 = JsonManager__DeserializeArray_object_(
              String_70410276,
              (const MethodInfo_2FC092C *)Method_JsonManager_DeserializeArray_ClassBoardSave_ClassBoardSaveData___);
      if ( v22 )
      {
        ...
        if ( HasKey )
        {
          System_Collections_Generic_List_object___AddRange(
            ...
            v17,
            (const MethodInfo_35EC430 *)Method_System_Collections_Generic_List_ClassBoardSave_ClassBoardSaveData__AddRange__);
          return;
        }
LABEL_14:
        sub_1BE4D28(HasKey, v17);
      }
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A1A3 & 1) == 0 )
  {
    sub_1BE4ACC(&ClassBoardSave_ClassBoardSaveData_TypeInfo, method);
    sub_1BE4ACC(&IClassBoardSquareModel_TypeInfo, v3);
    byte_4B6A1A3 = 1;
  }
  v4 = sub_1BE4D18(ClassBoardSave_ClassBoardSaveData_TypeInfo);
...
LABEL_18:
  ...
  *(_DWORD *)(v4 + 16) = v5;
  ...
  {
LABEL_15:
    v14 = sub_1C36AAC(squareModel, IClassBoardSquareModel_TypeInfo, 0LL);
  }
...
bool __fastcall ClassBoardSave__IsPlayCondOpenEffect(IClassBoardLockModel_o *lockModel, const MethodInfo *method)
{
  ...
  if ( (byte_4B6A1A1 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_BasicHelper_Any_ClassBoardSave_ClassBoardSaveData___, method);
    sub_1BE4ACC(&ClassBoardSave_TypeInfo, v3);
    sub_1BE4ACC(&System_Func_ClassBoardSave_ClassBoardSaveData__bool__TypeInfo, v4);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_ClassBoardSave_ClassBoardSaveData__get_Count__, v5);
    sub_1BE4ACC(&Method_ClassBoardSave___c__DisplayClass4_0__IsPlayCondOpenEffect_b__0__, v6);
    sub_1BE4ACC(&ClassBoardSave___c__DisplayClass4_0_TypeInfo, v7);
    sub_1BE4ACC(&StringLiteral_3546/*"CLASS_BOARD_OPEND_MISSION_CLEAR_KEY"*/, v8);
    byte_4B6A1A1 = 1;
  }
  v9 = sub_1BE4D18(ClassBoardSave___c__DisplayClass4_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v9, 0LL);
  if ( !v9 )
    goto LABEL_9;
  *(_QWORD *)(v9 + 16) = lockModel;
  sub_1BE4A70((PartyOrganizationUtility_o *)(v9 + 16), (int64_t)lockModel, v12, v13, v14, v15, v16, v17);
  HasKey = UnityEngine_PlayerPrefs__HasKey((System_String_o *)StringLiteral_3546/*"CLASS_BOARD_OPEND_MISSION_CLEAR_KEY"*/, 0LL);
  if ( !HasKey )
    return 0;
...
LABEL_9:
  ...
  {
    v20 = (System_Func_object__bool__o *)sub_1BE4D18(System_Func_ClassBoardSave_ClassBoardSaveData__bool__TypeInfo);
    ...
    return BasicHelper__Any_object_(
             ...
             (const MethodInfo_2F4407C *)Method_BasicHelper_Any_ClassBoardSave_ClassBoardSaveData___);
  }
  return 0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A1A2 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_ClassBoardSave_GetSquareSaveKey__, method);
    sub_1BE4ACC(&ClassBoardSave_TypeInfo, v3);
    sub_1BE4ACC(&Method_System_Linq_Enumerable_Select_IClassBoardLockModel__ClassBoardSave_ClassBoardSaveData___, v4);
    sub_1BE4ACC(&Method_System_Linq_Enumerable_ToList_ClassBoardSave_ClassBoardSaveData___, v5);
    sub_1BE4ACC(&System_Func_IClassBoardLockModel__ClassBoardSave_ClassBoardSaveData__TypeInfo, v6);
    sub_1BE4ACC(&System_Collections_Generic_IReadOnlyCollection_IClassBoardLockModel__TypeInfo, v7);
    sub_1BE4ACC(&JsonManager_TypeInfo, v8);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_ClassBoardSave_ClassBoardSaveData__AddRange__, v9);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_ClassBoardSave_ClassBoardSaveData__ToArray__, v10);
    sub_1BE4ACC(&StringLiteral_3546/*"CLASS_BOARD_OPEND_MISSION_CLEAR_KEY"*/, v11);
    byte_4B6A1A2 = 1;
  }
  if ( locks )
  {
    ...
    {
LABEL_8:
      p_method = sub_1C36AAC(locks, System_Collections_Generic_IReadOnlyCollection_IClassBoardLockModel__TypeInfo, 0LL);
    }
    if ( (*(int (__fastcall **)(System_Collections_Generic_IReadOnlyCollection_IClassBoardLockModel__o *, _QWORD))p_method)(
           locks,
           *(_QWORD *)(p_method + 8)) >= 1 )
    {
      v16 = (System_Func_object__object__o *)sub_1BE4D18(System_Func_IClassBoardLockModel__ClassBoardSave_ClassBoardSaveData__TypeInfo);
      ...
      v17 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_object__object_(
                                                                   ...
                                                                   (const MethodInfo_2F8A8A8 *)Method_System_Linq_Enumerable_Select_IClassBoardLockModel__ClassBoardSave_ClassBoardSaveData___);
      v18 = System_Linq_Enumerable__ToList_object_(
              v17,
              (const MethodInfo_2F96830 *)Method_System_Linq_Enumerable_ToList_ClassBoardSave_ClassBoardSaveData___);
      ...
      {
        sub_1BE4D28(cachePlayCondOpenEffectList, v19);
      }
      v21 = System_Collections_Generic_List_object___ToArray(
              cachePlayCondOpenEffectList,
              (const MethodInfo_35EDD7C *)Method_System_Collections_Generic_List_ClassBoardSave_ClassBoardSaveData__ToArray__);
      if ( !JsonManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(JsonManager_TypeInfo);
      v22 = JsonManager__toJson(&v21->obj, 0, 0, 0LL);
      UnityEngine_PlayerPrefs__SetString((System_String_o *)StringLiteral_3546/*"CLASS_BOARD_OPEND_MISSION_CLEAR_KEY"*/, v22, 0LL);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A1A5 & 1) == 0 )
  {
    sub_1BE4ACC(&ClassBoardSave_ClassBoardSaveData_TypeInfo, obj);
    byte_4B6A1A5 = 1;
  }
  if ( !obj )
    return 0;
