void ClassBoardSave__CheckOpenedMissionClearDialog(const MethodInfo *method)
{
  ...
  if ( (byte_4D346D4 & 1) == 0 )
  {
    sub_1C93AD4(&ClassBoardSave_TypeInfo);
    sub_1C93AD4(&Method_JsonManager_DeserializeArray_ClassBoardSave_ClassBoardSaveData___);
    sub_1C93AD4(&JsonManager_TypeInfo);
    sub_1C93AD4(&Method_System_Collections_Generic_List_ClassBoardSave_ClassBoardSaveData__AddRange__);
    sub_1C93AD4(&Method_System_Collections_Generic_List_ClassBoardSave_ClassBoardSaveData__Clear__);
    sub_1C93AD4(&Method_System_Collections_Generic_List_ClassBoardSave_ClassBoardSaveData___ctor__);
    sub_1C93AD4(&System_Collections_Generic_List_ClassBoardSave_ClassBoardSaveData__TypeInfo);
    sub_1C93AD4(&StringLiteral_3432/*"CLASS_BOARD_OPEND_MISSION_CLEAR_KEY"*/);
    byte_4D346D4 = 1;
  }
  if ( !ClassBoardSave_TypeInfo->static_fields->cachePlayCondOpenEffectList )
  {
    v1 = (System_Collections_Generic_List_object__o *)sub_1C93D20(System_Collections_Generic_List_ClassBoardSave_ClassBoardSaveData__TypeInfo);
    System_Collections_Generic_List_object____ctor(
      v1,
      (const MethodInfo_3879168 *)Method_System_Collections_Generic_List_ClassBoardSave_ClassBoardSaveData___ctor__);
    ...
    HasKey = (struct System_Collections_Generic_List_ClassBoardSave_ClassBoardSaveData__o *)UnityEngine_PlayerPrefs__HasKey(
                                                                                              (System_String_o *)StringLiteral_3432/*"CLASS_BOARD_OPEND_MISSION_CLEAR_KEY"*/,
                                                                                              0);
    if ( ((unsigned __int8)HasKey & 1) != 0 )
    {
      ...
      v14 = JsonManager__DeserializeArray_object_(
              String_72078212,
              (const MethodInfo_3213F70 *)Method_JsonManager_DeserializeArray_ClassBoardSave_ClassBoardSaveData___);
      if ( v14 )
      {
        ...
        if ( HasKey )
        {
          System_Collections_Generic_List_object___AddRange(
            ...
            v9,
            (const MethodInfo_3879BA8 *)Method_System_Collections_Generic_List_ClassBoardSave_ClassBoardSaveData__AddRange__);
          return;
        }
LABEL_14:
        sub_1C93D2C(HasKey, v9);
      }
    }
  }
}
...
void ClassBoardSave__DeleteOpenedMissionClearDialogByBaseId(int32_t baseId, const MethodInfo *method)
{
  ...
  if ( (byte_4D346D2 & 1) == 0 )
  {
    sub_1C93AD4(&ClassBoardSave_TypeInfo);
    sub_1C93AD4(&JsonManager_TypeInfo);
    sub_1C93AD4(&Method_System_Collections_Generic_List_ClassBoardSave_ClassBoardSaveData__RemoveAll__);
    sub_1C93AD4(&Method_System_Collections_Generic_List_ClassBoardSave_ClassBoardSaveData__ToArray__);
    sub_1C93AD4(&System_Predicate_ClassBoardSave_ClassBoardSaveData__TypeInfo);
    sub_1C93AD4(&Method_ClassBoardSave___c__DisplayClass6_0__DeleteOpenedMissionClearDialogByBaseId_b__0__);
    sub_1C93AD4(&ClassBoardSave___c__DisplayClass6_0_TypeInfo);
    sub_1C93AD4(&StringLiteral_3432/*"CLASS_BOARD_OPEND_MISSION_CLEAR_KEY"*/);
    byte_4D346D2 = 1;
  }
  v3 = sub_1C93D20(ClassBoardSave___c__DisplayClass6_0_TypeInfo);
  ...
  *(_DWORD *)(v3 + 16) = baseId;
  ...
  if ( !cachePlayCondOpenEffectList )
    return;
  v7 = (System_Predicate_object__o *)sub_1C93D20(System_Predicate_ClassBoardSave_ClassBoardSaveData__TypeInfo);
  ...
  System_Collections_Generic_List_object___RemoveAll(
    ...
    (const MethodInfo_387AFF8 *)Method_System_Collections_Generic_List_ClassBoardSave_ClassBoardSaveData__RemoveAll__);
...
LABEL_10:
  ...
  v8 = System_Collections_Generic_List_object___ToArray(
         v4,
         (const MethodInfo_387B4F4 *)Method_System_Collections_Generic_List_ClassBoardSave_ClassBoardSaveData__ToArray__);
  if ( !JsonManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(JsonManager_TypeInfo);
  v9 = JsonManager__toJson(&v8->obj, 0, 0, 0);
  UnityEngine_PlayerPrefs__SetString((System_String_o *)StringLiteral_3432/*"CLASS_BOARD_OPEND_MISSION_CLEAR_KEY"*/, v9, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D346D3 & 1) == 0 )
  {
    sub_1C93AD4(&ClassBoardSave_ClassBoardSaveData_TypeInfo);
    sub_1C93AD4(&IClassBoardSquareModel_TypeInfo);
    byte_4D346D3 = 1;
  }
  v3 = sub_1C93D20(ClassBoardSave_ClassBoardSaveData_TypeInfo);
  System_Object___ctor((Il2CppObject *)v3, 0);
  if ( !squareModel )
    goto LABEL_18;
  ...
  {
LABEL_8:
    v9 = sub_1C69E5C(squareModel, IClassBoardSquareModel_TypeInfo, 1);
  }
...
LABEL_18:
  ...
  *(_DWORD *)(v3 + 16) = v4;
  ...
  {
LABEL_15:
    v13 = sub_1C69E5C(squareModel, IClassBoardSquareModel_TypeInfo, 0);
  }
...
bool ClassBoardSave__IsPlayCondOpenEffect(IClassBoardLockModel_o *lockModel, const MethodInfo *method)
{
  ...
  if ( (byte_4D346D0 & 1) == 0 )
  {
    sub_1C93AD4(&Method_BasicHelper_Any_ClassBoardSave_ClassBoardSaveData___);
    sub_1C93AD4(&ClassBoardSave_TypeInfo);
    sub_1C93AD4(&System_Func_ClassBoardSave_ClassBoardSaveData__bool__TypeInfo);
    sub_1C93AD4(&Method_System_Collections_Generic_List_ClassBoardSave_ClassBoardSaveData__get_Count__);
    sub_1C93AD4(&Method_ClassBoardSave___c__DisplayClass4_0__IsPlayCondOpenEffect_b__0__);
    sub_1C93AD4(&ClassBoardSave___c__DisplayClass4_0_TypeInfo);
    sub_1C93AD4(&StringLiteral_3432/*"CLASS_BOARD_OPEND_MISSION_CLEAR_KEY"*/);
    byte_4D346D0 = 1;
  }
  v3 = sub_1C93D20(ClassBoardSave___c__DisplayClass4_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v3, 0);
  if ( !v3 )
    goto LABEL_9;
  *(_QWORD *)(v3 + 16) = lockModel;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)(v3 + 16), (int32_t)lockModel, v6, v7, v8, v9, v10, v11);
  HasKey = UnityEngine_PlayerPrefs__HasKey((System_String_o *)StringLiteral_3432/*"CLASS_BOARD_OPEND_MISSION_CLEAR_KEY"*/, 0);
  if ( !HasKey )
    return 0;
...
LABEL_9:
  ...
  {
    v14 = (System_Func_object__bool__o *)sub_1C93D20(System_Func_ClassBoardSave_ClassBoardSaveData__bool__TypeInfo);
    ...
    return BasicHelper__Any_object_(
             ...
             (const MethodInfo_318DB78 *)Method_BasicHelper_Any_ClassBoardSave_ClassBoardSaveData___);
  }
  return 0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D346D1 & 1) == 0 )
  {
    sub_1C93AD4(&Method_ClassBoardSave_GetSquareSaveKey__);
    sub_1C93AD4(&ClassBoardSave_TypeInfo);
    sub_1C93AD4(&Method_System_Linq_Enumerable_Select_IClassBoardLockModel__ClassBoardSave_ClassBoardSaveData___);
    sub_1C93AD4(&Method_System_Linq_Enumerable_ToList_ClassBoardSave_ClassBoardSaveData___);
    sub_1C93AD4(&System_Func_IClassBoardLockModel__ClassBoardSave_ClassBoardSaveData__TypeInfo);
    sub_1C93AD4(&System_Collections_Generic_IReadOnlyCollection_IClassBoardLockModel__TypeInfo);
    sub_1C93AD4(&JsonManager_TypeInfo);
    sub_1C93AD4(&Method_System_Collections_Generic_List_ClassBoardSave_ClassBoardSaveData__AddRange__);
    sub_1C93AD4(&Method_System_Collections_Generic_List_ClassBoardSave_ClassBoardSaveData__ToArray__);
    sub_1C93AD4(&StringLiteral_3432/*"CLASS_BOARD_OPEND_MISSION_CLEAR_KEY"*/);
  ...
  if ( locks )
  {
    ...
    {
LABEL_8:
      v6 = sub_1C69E5C(locks, System_Collections_Generic_IReadOnlyCollection_IClassBoardLockModel__TypeInfo, 0);
    }
    if ( (*(int (__fastcall **)(System_Collections_Generic_IReadOnlyCollection_IClassBoardLockModel__o *, _QWORD))v6)(
           locks,
           *(_QWORD *)(v6 + 8)) >= 1 )
    {
      v7 = (System_Func_object__object__o *)sub_1C93D20(System_Func_IClassBoardLockModel__ClassBoardSave_ClassBoardSaveData__TypeInfo);
      ...
      v8 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_object__object_(
                                                                  ...
                                                                  (const MethodInfo_31DAB40 *)Method_System_Linq_Enumerable_Select_IClassBoardLockModel__ClassBoardSave_ClassBoardSaveData___);
      v9 = System_Linq_Enumerable__ToList_object_(
             v8,
             (const MethodInfo_31E8E3C *)Method_System_Linq_Enumerable_ToList_ClassBoardSave_ClassBoardSaveData___);
      ...
      {
        sub_1C93D2C(cachePlayCondOpenEffectList, v10);
      }
      ...
      UnityEngine_PlayerPrefs__SetString((System_String_o *)StringLiteral_3432/*"CLASS_BOARD_OPEND_MISSION_CLEAR_KEY"*/, v13, 0);
    }
  }
}
