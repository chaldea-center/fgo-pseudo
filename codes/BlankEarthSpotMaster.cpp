void __fastcall BlankEarthSpotMaster___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A6FB4D & 1) == 0 )
  {
    sub_1B90010(&BlankEarthSpotMaster_TypeInfo, v1);
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)BlankEarthSpotMaster_TypeInfo->static_fields, (int32_t)v4, v5, v6);
}
...
void __fastcall BlankEarthSpotMaster___ctor(BlankEarthSpotMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A6FB4C & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_BlankEarthSpotMaster__BlankEarthSpotEntity__int___ctor__, method);
    byte_4A6FB4C = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    18,
    (const MethodInfo_312C568 *)Method_DataMasterBase_BlankEarthSpotMaster__BlankEarthSpotEntity__int___ctor__);
}
...
bool __fastcall BlankEarthSpotMaster__ContainsMapId(int32_t mapId, const MethodInfo *method)
{
  ...
  if ( (byte_4A6FB45 & 1) == 0 )
  {
    sub_1B90010(&BlankEarthSpotMaster_TypeInfo, method);
    sub_1B90010(&Method_System_Collections_Generic_HashSet_int__Contains__, v3);
    byte_4A6FB45 = 1;
  }
        ...
        const MethodInfo *method)
{
  if ( (byte_4A6FB49 & 1) == 0 )
  {
    sub_1B90010(&Method_System_Linq_Enumerable_OfType_BlankEarthSpotEntity___, method);
    byte_4A6FB49 = 1;
  }
  return (System_Collections_Generic_IEnumerable_BlankEarthSpotEntity__o *)System_Linq_Enumerable__OfType_object_(
                                                                             (System_Collections_IEnumerable_o *)this->fields.list,
                                                                             (const MethodInfo_2EB82A0 *)Method_System_Linq_Enumerable_OfType_BlankEarthSpotEntity___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FB47 & 1) == 0 )
  {
    sub_1B90010(&Method_System_Linq_Enumerable_ToArray_BlankEarthSpotEntity___, method);
    byte_4A6FB47 = 1;
  }
  ...
  return (BlankEarthSpotEntity_array *)System_Linq_Enumerable__ToArray_object_(
                                         ...
                                         (const MethodInfo_2EC6F94 *)Method_System_Linq_Enumerable_ToArray_BlankEarthSpotEntity___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FB48 & 1) == 0 )
  {
    sub_1B90010(&Method_System_Linq_Enumerable_ToArray_BlankEarthSpotEntity___, *(_QWORD *)&mapId);
    sub_1B90010(&Method_System_Linq_Enumerable_Where_BlankEarthSpotEntity___, v5);
    sub_1B90010(&System_Func_BlankEarthSpotEntity__bool__TypeInfo, v6);
    sub_1B90010(&Method_BlankEarthSpotMaster___c__DisplayClass4_0__GetByMapId_b__0__, v7);
    sub_1B90010(&BlankEarthSpotMaster___c__DisplayClass4_0_TypeInfo, v8);
    byte_4A6FB48 = 1;
  }
  v9 = sub_1B9025C(BlankEarthSpotMaster___c__DisplayClass4_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v9, 0LL);
  if ( !v9 )
    sub_1B9026C(v10, v11);
  *(_DWORD *)(v9 + 16) = mapId;
  v12 = BlankEarthSpotMaster__EnumerateOwns(this, v11);
  v13 = (System_Func_object__bool__o *)sub_1B9025C(System_Func_BlankEarthSpotEntity__bool__TypeInfo);
  ...
  v14 = System_Linq_Enumerable__Where_object_(
          ...
          (const MethodInfo_2ECC92C *)Method_System_Linq_Enumerable_Where_BlankEarthSpotEntity___);
  return (BlankEarthSpotEntity_array *)System_Linq_Enumerable__ToArray_object_(
                                         v14,
                                         (const MethodInfo_2EC6F94 *)Method_System_Linq_Enumerable_ToArray_BlankEarthSpotEntity___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FB4A & 1) == 0 )
  {
    sub_1B90010(&Method_System_Linq_Enumerable_Any_BlankEarthSpotEntity___, targetIds);
    sub_1B90010(&System_Func_BlankEarthSpotEntity__bool__TypeInfo, v5);
    sub_1B90010(&Method_BlankEarthSpotMaster___c__DisplayClass6_0__HasAnyIds_b__0__, v6);
    sub_1B90010(&BlankEarthSpotMaster___c__DisplayClass6_0_TypeInfo, v7);
    byte_4A6FB4A = 1;
  }
  v8 = sub_1B9025C(BlankEarthSpotMaster___c__DisplayClass6_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v8, 0LL);
  if ( !v8 )
    sub_1B9026C(v9, v10);
  *(_QWORD *)(v8 + 16) = targetIds;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v8 + 16), (int32_t)targetIds, v11, v12);
  if ( !*(_QWORD *)(v8 + 16) )
    return 0;
  v14 = BlankEarthSpotMaster__EnumerateOwns(this, v13);
  v15 = (System_Func_object__bool__o *)sub_1B9025C(System_Func_BlankEarthSpotEntity__bool__TypeInfo);
  System_Func_object__bool____ctor(
    v15,
    (Il2CppObject *)v8,
  ...
  return System_Linq_Enumerable__Any_object__48880324(
           ...
           (const MethodInfo_2E9DAC4 *)Method_System_Linq_Enumerable_Any_BlankEarthSpotEntity___);
}
...
bool __fastcall BlankEarthSpotMaster__preProcess(BlankEarthSpotMaster_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B90010(&BlankEarthSpotMaster_TypeInfo, method);
    sub_1B90010(&Method_System_Linq_Enumerable_Select_BlankEarthSpotEntity__int___, v3);
    sub_1B90010(&System_Func_BlankEarthSpotEntity__int__TypeInfo, v4);
    sub_1B90010(&Method_System_Collections_Generic_HashSet_int__Clear__, v5);
    sub_1B90010(&Method_System_Collections_Generic_HashSet_int__UnionWith__, v6);
    sub_1B90010(&Method_BlankEarthSpotMaster___c__preProcess_b__2_0__, v7);
    sub_1B90010(&BlankEarthSpotMaster___c_TypeInfo, v8);
    byte_4A6FB46 = 1;
  }
  ...
  if ( !_9__2_0 )
  {
    ...
    _9__2_0 = (System_Func_object__int__o *)sub_1B9025C(System_Func_BlankEarthSpotEntity__int__TypeInfo);
    ...
    sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&static_fields->__9__2_0, (int32_t)_9__2_0, v19, v20);
  }
  targetMapIdHashSet = (System_Collections_Generic_HashSet_int__o *)System_Linq_Enumerable__Select_object__int_(
                                                                      ...
                                                                      (const MethodInfo_2EBE4B0 *)Method_System_Linq_Enumerable_Select_BlankEarthSpotEntity__int___);
  if ( !v11 )
LABEL_14:
    sub_1B9026C(targetMapIdHashSet, method);
...
void __fastcall BlankEarthSpotMaster___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A6FB4E & 1) == 0 )
  {
    sub_1B90010(&BlankEarthSpotMaster___c_TypeInfo, v1);
    byte_4A6FB4E = 1;
  }
  v2 = (Il2CppObject *)sub_1B9025C(BlankEarthSpotMaster___c_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FB4F & 1) == 0 )
  {
    this = (BlankEarthSpotMaster___c__DisplayClass6_0_o *)sub_1B90010(
