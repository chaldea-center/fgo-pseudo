bool AiEntity__IsNoBackStepNpc(AiEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB5E6B & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_9503/*"NoBackStepNpc"*/);
    byte_4CB5E6B = 1;
  }
  return AiBaseEntity__getScriptIntParam((AiBaseEntity_o *)this, (System_String_o *)StringLiteral_9503/*"NoBackStepNpc"*/, -1, v2) == 1;
}
