void WarBoardOnboardSkillNameComponent___ctor(WarBoardOnboardSkillNameComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.skillNames, (int32_t)v3, v4, v5);
        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    sub_1C6B9AC((CGThumbnailListItem_o *)(v10 + 4), (int32_t)name, (int32_t)method, v3);
  }
}
