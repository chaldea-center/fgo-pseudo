        ...
        const MethodInfo *method)
{
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.skillNames, (int32_t)v4, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2BEDA & 1) == 0 )
  {
    sub_1B761C0(&Method_System_Collections_Generic_List_string__Add__, name);
    byte_4A2BEDA = 1;
  }
  ...
  else
  {
    ...
    sub_1B76164((ServantStatusBattleListViewItem_o *)(v10 + 4), (int32_t)name, (int32_t)method, v3);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2BED8 & 1) == 0 )
  {
    sub_1B761C0(&Method_System_Collections_Generic_List_string__Clear__, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2BED9 & 1) == 0 )
  {
    sub_1B761C0(&Method_System_Collections_Generic_List_string__get_Count__, method);
    sub_1B761C0(&Method_System_Collections_Generic_List_string__get_Item__, v3);
    sub_1B761C0(&StringLiteral_1/*""*/, v4);
    byte_4A2BED9 = 1;
  }
  skillNames = this->fields.skillNames;
