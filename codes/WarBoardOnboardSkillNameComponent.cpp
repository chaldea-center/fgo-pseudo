        ...
        const MethodInfo *method)
{
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.skillNames, (int32_t)v4, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6DE92 & 1) == 0 )
  {
    sub_1B90010(&Method_System_Collections_Generic_List_string__Add__, name);
    byte_4A6DE92 = 1;
  }
  ...
  else
  {
    ...
    sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v10 + 4), (int32_t)name, (int32_t)method, v3);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6DE90 & 1) == 0 )
  {
    sub_1B90010(&Method_System_Collections_Generic_List_string__Clear__, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6DE91 & 1) == 0 )
  {
    sub_1B90010(&Method_System_Collections_Generic_List_string__get_Count__, method);
    sub_1B90010(&Method_System_Collections_Generic_List_string__get_Item__, v3);
    sub_1B90010(&StringLiteral_1/*""*/, v4);
    byte_4A6DE91 = 1;
  }
  skillNames = this->fields.skillNames;
