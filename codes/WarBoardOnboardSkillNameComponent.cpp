        ...
        const MethodInfo *method)
{
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.skillNames, (int32_t)v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA3CE & 1) == 0 )
  {
    sub_1B640C8(&Method_System_Collections_Generic_List_string__Clear__, method);
