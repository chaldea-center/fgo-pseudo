        ...
        const MethodInfo *method)
{
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.skillNames, (int64_t)v4, v5, v6, v7, v8, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B64AAD & 1) == 0 )
  {
    sub_1BE4ACC(&Method_System_Collections_Generic_List_string__Add__, name);
    byte_4B64AAD = 1;
  }
  ...
  else
  {
    ...
    sub_1BE4A70((PartyOrganizationUtility_o *)(v14 + 4), (int64_t)name, (int64_t)method, v3, v4, v5, v6, v7);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B64AAB & 1) == 0 )
  {
    sub_1BE4ACC(&Method_System_Collections_Generic_List_string__Clear__, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B64AAC & 1) == 0 )
  {
    sub_1BE4ACC(&Method_System_Collections_Generic_List_string__get_Count__, method);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_string__get_Item__, v3);
    sub_1BE4ACC(&StringLiteral_1/*""*/, v4);
    byte_4B64AAC = 1;
  }
  skillNames = this->fields.skillNames;
