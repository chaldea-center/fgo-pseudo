...
void __fastcall QuestBoardListViewObject__Awake(QuestBoardListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FB530 & 1) == 0 )
  {
    sub_1B64870(&Method_UnityEngine_GameObject_GetComponent_QuestBoardListViewItemDraw___, method);
    byte_49FB530 = 1;
  }
  ...
  if ( !dispObject
    || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                             dispObject,
                             (const MethodInfo_2E8A1B4 *)Method_UnityEngine_GameObject_GetComponent_QuestBoardListViewItemDraw___),
  ...
  {
    sub_1B64ACC(dispObject, v3);
  }
  itemDraw->fields.mListViewObject = this;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&itemDraw->fields.mListViewObject, (int32_t)this, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB532 & 1) == 0 )
  {
    sub_1B64870(&QuestBoardListViewItem_TypeInfo, method);
    byte_49FB532 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  QuestBoardListViewObject__Init_33729560(this, initMode, 0LL, v3);
}
...
void __fastcall QuestBoardListViewObject__Init_33729560(
        QuestBoardListViewObject_o *this,
        int32_t initMode,
        ...
        const MethodInfo *method)
{
  ...
  QuestBoardListViewObject__Init_33729644(this, initMode, callbackFunc, v4, *(UnityEngine_Vector3_o *)&v5, method);
}


// local variable allocation has failed, the output may be wrong!
void __fastcall QuestBoardListViewObject__Init_33729644(
        QuestBoardListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB534 & 1) == 0 )
  {
    sub_1B64870(&QuestBoardListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_49FB534 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB53D & 1) == 0 )
  {
    sub_1B64870(&QuestBoardListViewItem_TypeInfo, isOpend);
    sub_1B64870(&QuestBoardListViewManager_TypeInfo, v4);
    sub_1B64870(&Method_QuestBoardListViewObject_OnClickClearResetBtn__, v5);
            ...
            if ( QuestEntity__HasFlag((QuestEntity_o *)manager, 0x400000000000000LL, 0LL) )
            {
              ...
              if ( MapControl_QuestInfo__IsClear(manager, 0LL) )
              {
                ...
                if ( (*((_BYTE *)Method_QuestBoardListViewObject_OnClickClearResetBtn__ + 83) & 2) != 0 )
                  v12 = (_QWORD *)sub_1B64888(Method_QuestBoardListViewObject_OnClickClearResetBtn__);
                ...
                if ( !byte_49F97AD )
                {
                  sub_1B64870(&TerminalSceneComponent_TypeInfo, isOpend);
                  byte_49F97AD = 1;
                }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB53C & 1) == 0 )
  {
    sub_1B64870(&CondType_TypeInfo, isOpened);
    sub_1B64870(&QuestBoardListViewItem_TypeInfo, v5);
    sub_1B64870(&QuestBoardListViewManager_TypeInfo, v6);
    sub_1B64870(&Method_QuestBoardListViewObject_OnClickInfoBtn__, v7);
  ...
  if ( !byte_49F97AD )
  {
    sub_1B64870(&TerminalSceneComponent_TypeInfo, isOpened);
    byte_49F97AD = 1;
  }
  ...
  *(_QWORD *)&isOpened = QuestBoardListViewManager_TypeInfo;
  ...
  {
LABEL_63:
    sub_1B64ACC(mInstance, isOpened);
  }
  ...
  if ( CondType__IsQuestClear_37290360(v15, -1, 0, 0LL) )
  {
LABEL_30:
    mInstance = (TerminalSceneComponent_o *)this->fields.manager;
    if ( !mInstance )
          ...
          else
          {
            if ( !v3 )
            {
              ...
              if ( (*((_BYTE *)Method_QuestBoardListViewObject_OnClickInfoBtn__ + 83) & 2) != 0 )
                v20 = (_QWORD *)sub_1B64888(Method_QuestBoardListViewObject_OnClickInfoBtn__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB53A & 1) == 0 )
  {
    sub_1B64870(&QuestBoardListViewItem_TypeInfo, is_press);
    sub_1B64870(&QuestBoardListViewManager_TypeInfo, v5);
    byte_49FB53A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB53E & 1) == 0 )
  {
    sub_1B64870(&EventDelegate_TypeInfo, scrTerminalListTop);
    sub_1B64870(&Method_UnityEngine_GameObject_GetComponent_UITouchPress___, v5);
    sub_1B64870(&Method_System_Collections_Generic_List_EventDelegate__Add__, v6);
    sub_1B64870(&Method_System_Collections_Generic_List_EventDelegate__get_Count__, v7);
    sub_1B64870(&UnityEngine_Object_TypeInfo, v8);
    sub_1B64870(&StringLiteral_17723/*"cbfTitleInfoBtnBack_Click"*/, v9);
    byte_49FB53E = 1;
  }
  v10 = (EventDelegate_o *)sub_1B64ABC(EventDelegate_TypeInfo);
  EventDelegate___ctor_46517956(
    v10,
    (UnityEngine_MonoBehaviour_o *)scrTerminalListTop,
    (System_String_o *)StringLiteral_17723/*"cbfTitleInfoBtnBack_Click"*/,
    0LL);
    ...
    if ( Component_object )
    {
      ...
      if ( v17 )
      {
        ...
        else
        {
          ...
          *(_QWORD *)(v20 + 32) = v10;
          sub_1B64814((ServantStatusBattleListViewItem_o *)(v20 + 32), (int32_t)v10, v14, v15);
        }
        return;
      }
    }
...
void __fastcall QuestBoardListViewObject__SetItem_33729284(
        QuestBoardListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall QuestBoardListViewObject__SetupDisp(QuestBoardListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B64870(&UnityEngine_Object_TypeInfo, method);
    sub_1B64870(&QuestBoardListViewItem_TypeInfo, v3);
    byte_49FB535 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
...
void __fastcall QuestBoardListViewObject__Start(QuestBoardListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    QuestBoardListViewObject__Init_33729560(this, 2, 0LL, v2);
}
