...
void __fastcall QuestBoardListViewObject__Awake(QuestBoardListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49F9441 & 1) == 0 )
  {
    sub_1B640C8(&Method_UnityEngine_GameObject_GetComponent_QuestBoardListViewItemDraw___, method);
    byte_49F9441 = 1;
  }
  ...
  if ( !dispObject
    || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                             dispObject,
                             (const MethodInfo_2E87ED8 *)Method_UnityEngine_GameObject_GetComponent_QuestBoardListViewItemDraw___),
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&itemDraw->fields.mListViewObject, (int32_t)this, v7, v8);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F9443 & 1) == 0 )
  {
    sub_1B640C8(&QuestBoardListViewItem_TypeInfo, method);
    byte_49F9443 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  QuestBoardListViewObject__Init_33728524(this, initMode, 0LL, v3);
}
...
void __fastcall QuestBoardListViewObject__Init_33728524(
        QuestBoardListViewObject_o *this,
        int32_t initMode,
        ...
        const MethodInfo *method)
{
  ...
  QuestBoardListViewObject__Init_33728608(this, initMode, callbackFunc, v4, *(UnityEngine_Vector3_o *)&v5, method);
}


// local variable allocation has failed, the output may be wrong!
void __fastcall QuestBoardListViewObject__Init_33728608(
        QuestBoardListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F9445 & 1) == 0 )
  {
    sub_1B640C8(&QuestBoardListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_49F9445 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F944E & 1) == 0 )
  {
    sub_1B640C8(&QuestBoardListViewItem_TypeInfo, isOpend);
    sub_1B640C8(&QuestBoardListViewManager_TypeInfo, v4);
    sub_1B640C8(&Method_QuestBoardListViewObject_OnClickClearResetBtn__, v5);
            ...
            if ( QuestEntity__HasFlag((QuestEntity_o *)manager, 0x400000000000000LL, 0LL) )
            {
              ...
              if ( MapControl_QuestInfo__IsClear(manager, 0LL) )
              {
                ...
                if ( (*((_BYTE *)Method_QuestBoardListViewObject_OnClickClearResetBtn__ + 83) & 2) != 0 )
                  v12 = (_QWORD *)sub_1B640E0(Method_QuestBoardListViewObject_OnClickClearResetBtn__);
                ...
                manager = (MapControl_QuestInfo_o *)v15->static_fields->mInstance;
                if ( manager )
                {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F944D & 1) == 0 )
  {
    sub_1B640C8(&CondType_TypeInfo, isOpened);
    sub_1B640C8(&QuestBoardListViewItem_TypeInfo, v5);
    sub_1B640C8(&QuestBoardListViewManager_TypeInfo, v6);
    sub_1B640C8(&Method_QuestBoardListViewObject_OnClickInfoBtn__, v7);
  ...
  if ( !byte_49F76BD )
  {
    sub_1B640C8(&TerminalSceneComponent_TypeInfo, isOpened);
    byte_49F76BD = 1;
  }
...
LABEL_63:
  ...
  if ( CondType__IsQuestClear_37285996(v15, -1, 0, 0LL) )
  {
LABEL_30:
    mInstance = (TerminalSceneComponent_o *)this->fields.manager;
    if ( !mInstance )
      ...
      && (QuestBoardListViewManager_c *)mInstance->klass->_2.typeHierarchy[v16 - 1] == QuestBoardListViewManager_TypeInfo )
    {
      ...
      if ( mInstance )
      {
        ...
        v20 = linkItem[1].monitor;
        if ( v20 )
        {
          if ( (_DWORD)mInstance == v20[4] )
          {
            if ( !TerminalSceneComponent_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(TerminalSceneComponent_TypeInfo);
            if ( !byte_49F76BD )
          ...
          else
          {
            if ( !isOpened )
            {
              v22 = Method_QuestBoardListViewObject_OnClickInfoBtn__;
              if ( (*((_BYTE *)Method_QuestBoardListViewObject_OnClickInfoBtn__ + 83) & 2) != 0 )
                v22 = (_QWORD *)sub_1B640E0(Method_QuestBoardListViewObject_OnClickInfoBtn__);
            ...
            if ( mInstance )
            {
              ...
              if ( !byte_49F76BD )
              {
                sub_1B640C8(&TerminalSceneComponent_TypeInfo, v24);
                byte_49F76BD = 1;
              }
...
LABEL_64:
    sub_1B645E4(mInstance);
    QuestBoardListViewManager__OnChangeAlphaAnim(v26, v27);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F944B & 1) == 0 )
  {
    sub_1B640C8(&QuestBoardListViewItem_TypeInfo, is_press);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F944F & 1) == 0 )
  {
    sub_1B640C8(&EventDelegate_TypeInfo, scrTerminalListTop);
    sub_1B640C8(&Method_UnityEngine_GameObject_GetComponent_UITouchPress___, v5);
    sub_1B640C8(&Method_System_Collections_Generic_List_EventDelegate__Add__, v6);
    sub_1B640C8(&Method_System_Collections_Generic_List_EventDelegate__get_Count__, v7);
    sub_1B640C8(&UnityEngine_Object_TypeInfo, v8);
    sub_1B640C8(&StringLiteral_17721/*"cbfTitleInfoBtnBack_Click"*/, v9);
    byte_49F944F = 1;
  }
  v10 = (EventDelegate_o *)sub_1B64314(EventDelegate_TypeInfo, scrTerminalListTop, method);
  EventDelegate___ctor_46509032(
    v10,
    (UnityEngine_MonoBehaviour_o *)scrTerminalListTop,
    (System_String_o *)StringLiteral_17721/*"cbfTitleInfoBtnBack_Click"*/,
    0LL);
    ...
    if ( Component_object )
    {
      ...
      if ( v16 )
      {
        ...
        else
        {
          ...
          *(_QWORD *)(v19 + 32) = v10;
          sub_1B6406C((ServantStatusBattleListViewItem_o *)(v19 + 32), (int32_t)v10, v13, v14);
        }
        return;
      }
    }
...
void __fastcall QuestBoardListViewObject__SetItem_33728248(
        QuestBoardListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall QuestBoardListViewObject__SetupDisp(QuestBoardListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B640C8(&UnityEngine_Object_TypeInfo, method);
    sub_1B640C8(&QuestBoardListViewItem_TypeInfo, v3);
    byte_49F9446 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
...
void __fastcall QuestBoardListViewObject__Start(QuestBoardListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    QuestBoardListViewObject__Init_33728524(this, 2, 0LL, v2);
}
