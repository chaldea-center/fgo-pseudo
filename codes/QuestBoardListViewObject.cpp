...
void __fastcall QuestBoardListViewObject__Awake(QuestBoardListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1EDBC & 1) == 0 )
  {
    sub_1C3B764(&Method_UnityEngine_GameObject_GetComponent_QuestBoardListViewItemDraw___, method);
    byte_4C1EDBC = 1;
  }
  ...
  if ( !dispObject
    || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                             dispObject,
                             (const MethodInfo_3041A18 *)Method_UnityEngine_GameObject_GetComponent_QuestBoardListViewItemDraw___),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1EDBE & 1) == 0 )
  {
    sub_1C3B764(&QuestBoardListViewItem_TypeInfo, method);
    byte_4C1EDBE = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  QuestBoardListViewObject__Init_35268252(this, initMode, 0LL, v3);
}
...
void __fastcall QuestBoardListViewObject__Init_35268252(
        QuestBoardListViewObject_o *this,
        int32_t initMode,
        ...
        const MethodInfo *method)
{
  ...
  QuestBoardListViewObject__Init_35268336(this, initMode, callbackFunc, v4, *(UnityEngine_Vector3_o *)&v5, method);
}


// local variable allocation has failed, the output may be wrong!
void __fastcall QuestBoardListViewObject__Init_35268336(
        QuestBoardListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1EDC0 & 1) == 0 )
  {
    sub_1C3B764(&QuestBoardListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4C1EDC0 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1EDC9 & 1) == 0 )
  {
    sub_1C3B764(&QuestBoardListViewItem_TypeInfo, isOpend);
    sub_1C3B764(&QuestBoardListViewManager_TypeInfo, v4);
    sub_1C3B764(&Method_QuestBoardListViewObject_OnClickClearResetBtn__, v5);
            ...
            if ( QuestEntity__HasFlag((QuestEntity_o *)manager, 0x400000000000000LL, 0LL) )
            {
              ...
              if ( MapControl_QuestInfo__IsClear(manager, 0LL) )
              {
                ...
                if ( (*((_BYTE *)Method_QuestBoardListViewObject_OnClickClearResetBtn__ + 83) & 2) != 0 )
                  v12 = (_QWORD *)sub_1C3B77C(Method_QuestBoardListViewObject_OnClickClearResetBtn__);
                ...
                if ( !byte_4C1CAE3 )
                {
                  sub_1C3B764(&TerminalSceneComponent_TypeInfo, isOpend);
                  byte_4C1CAE3 = 1;
                }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1EDC8 & 1) == 0 )
  {
    sub_1C3B764(&CondType_TypeInfo, isOpened);
    sub_1C3B764(&QuestBoardListViewItem_TypeInfo, v5);
    sub_1C3B764(&QuestBoardListViewManager_TypeInfo, v6);
    sub_1C3B764(&Method_QuestBoardListViewObject_OnClickInfoBtn__, v7);
  ...
  if ( !byte_4C1CAE3 )
  {
    sub_1C3B764(&TerminalSceneComponent_TypeInfo, isOpened);
    byte_4C1CAE3 = 1;
  }
  ...
  *(_QWORD *)&isOpened = QuestBoardListViewManager_TypeInfo;
  ...
  {
LABEL_63:
    sub_1C3B9C0(mInstance, isOpened);
  }
  ...
  if ( CondType__IsQuestClear_39011304(v15, -1, 0, 0LL) )
  {
LABEL_30:
    mInstance = (TerminalSceneComponent_o *)this->fields.manager;
    if ( !mInstance )
          ...
          else
          {
            if ( !v3 )
            {
              ...
              if ( (*((_BYTE *)Method_QuestBoardListViewObject_OnClickInfoBtn__ + 83) & 2) != 0 )
                v20 = (_QWORD *)sub_1C3B77C(Method_QuestBoardListViewObject_OnClickInfoBtn__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1EDC6 & 1) == 0 )
  {
    sub_1C3B764(&QuestBoardListViewItem_TypeInfo, is_press);
    sub_1C3B764(&QuestBoardListViewManager_TypeInfo, v5);
    byte_4C1EDC6 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1EDCA & 1) == 0 )
  {
    sub_1C3B764(&EventDelegate_TypeInfo, scrTerminalListTop);
    sub_1C3B764(&Method_UnityEngine_GameObject_GetComponent_UITouchPress___, v5);
    sub_1C3B764(&Method_System_Collections_Generic_List_EventDelegate__Add__, v6);
    sub_1C3B764(&Method_System_Collections_Generic_List_EventDelegate__get_Count__, v7);
    sub_1C3B764(&UnityEngine_Object_TypeInfo, v8);
    sub_1C3B764(&StringLiteral_18139/*"dateTimeOption"*/, v9);
    byte_4C1EDCA = 1;
  }
  v10 = (EventDelegate_o *)sub_1C3B9B0(EventDelegate_TypeInfo);
  EventDelegate___ctor_48223064(
    v10,
    (UnityEngine_MonoBehaviour_o *)scrTerminalListTop,
    (System_String_o *)StringLiteral_18139/*"dateTimeOption"*/,
    0LL);
    ...
    if ( Component_object )
    {
      ...
      if ( v21 )
      {
        ...
        else
        {
          ...
          *(_QWORD *)(v24 + 32) = v10;
          sub_1C3B708((PartyOrganizationUtility_o *)(v24 + 32), (int64_t)v10, v14, v15, v16, v17, v18, v19);
        }
        return;
      }
    }
...
void __fastcall QuestBoardListViewObject__SetItem_35267976(
        QuestBoardListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall QuestBoardListViewObject__SetupDisp(QuestBoardListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C3B764(&UnityEngine_Object_TypeInfo, method);
    sub_1C3B764(&QuestBoardListViewItem_TypeInfo, v3);
    byte_4C1EDC1 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
...
void __fastcall QuestBoardListViewObject__Start(QuestBoardListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    QuestBoardListViewObject__Init_35268252(this, 2, 0LL, v2);
}
