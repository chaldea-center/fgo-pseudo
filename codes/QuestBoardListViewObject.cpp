...
void QuestBoardListViewObject__Awake(QuestBoardListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C346D2 & 1) == 0 )
  {
    sub_1C32C20(&Method_UnityEngine_GameObject_GetComponent_QuestBoardListViewItemDraw___);
    byte_4C346D2 = 1;
  }
  ...
  if ( !dispObject
    || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                             dispObject,
                             (const MethodInfo_3134970 *)Method_UnityEngine_GameObject_GetComponent_QuestBoardListViewItemDraw___),
  ...
  sub_1C32BC4(itemDraw + 6, (int32_t)this, v7, v8);
}
...
void QuestBoardListViewObject__Init(QuestBoardListViewObject_o *this, int32_t initMode, const MethodInfo *method)
{
  ...
  QuestBoardListViewObject__Init_36425384(this, initMode, 0, v3);
}
...
void QuestBoardListViewObject__Init_36425384(
        ...
        const MethodInfo *method)
{
  ...
  QuestBoardListViewObject__Init_36425468(this, initMode, callbackFunc, v4, *(UnityEngine_Vector3_o *)&v5, method);
}


void QuestBoardListViewObject__Init_36425468(
        QuestBoardListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        ...
        const MethodInfo *method)
{
  ...
  if ( p_callbackFunc->klass )
  {
    ...
    sub_1C32BC4(p_callbackFunc, 0, (int32_t)v18, v19);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C346E0 & 1) == 0 )
  {
    sub_1C32C20(&QuestBoardListViewItem_TypeInfo);
    sub_1C32C20(&QuestBoardListViewManager_TypeInfo);
    sub_1C32C20(&Method_QuestBoardListViewObject_OnClickClearResetBtn__);
            ...
            if ( QuestEntity__HasFlag((QuestEntity_o *)manager, 0x400000000000000LL, 0) )
            {
              ...
              if ( MapControl_QuestInfo__IsClear(manager, 0) )
              {
                ...
                if ( (*((_BYTE *)Method_QuestBoardListViewObject_OnClickClearResetBtn__ + 83) & 2) != 0 )
                  v9 = (_QWORD *)sub_1C32C38(Method_QuestBoardListViewObject_OnClickClearResetBtn__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C346DF & 1) == 0 )
  {
    ...
    sub_1C32C20(&QuestBoardListViewItem_TypeInfo);
    sub_1C32C20(&QuestBoardListViewManager_TypeInfo);
    sub_1C32C20(&Method_QuestBoardListViewObject_OnClickInfoBtn__);
    sub_1C32C20(&TerminalSceneComponent_TypeInfo);
    byte_4C346DF = 1;
  }
  if ( !TerminalSceneComponent_TypeInfo->_2.cctor_finished )
...
LABEL_63:
  ...
  if ( CondType__IsQuestClear_40225464(v11, -1, 0, 0) )
  {
LABEL_30:
    mInstance = (TerminalSceneComponent_o *)this->fields.manager;
    if ( !mInstance )
          ...
          else
          {
            if ( !isOpened )
            {
              ...
              if ( (*((_BYTE *)Method_QuestBoardListViewObject_OnClickInfoBtn__ + 83) & 2) != 0 )
                v16 = (_QWORD *)sub_1C32C38(Method_QuestBoardListViewObject_OnClickInfoBtn__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C346E1 & 1) == 0 )
  {
    ...
    sub_1C32C20(&UnityEngine_Object_TypeInfo);
    sub_1C32C20(&StringLiteral_17787/*"cbfTitleInfoBtnBack_Click"*/);
    byte_4C346E1 = 1;
  }
  v5 = (EventDelegate_o *)sub_1C32E6C(EventDelegate_TypeInfo);
  EventDelegate___ctor_49231324(
    v5,
    (UnityEngine_MonoBehaviour_o *)scrTerminalListTop,
    (System_String_o *)StringLiteral_17787/*"cbfTitleInfoBtnBack_Click"*/,
    0);
    ...
    if ( Component_object )
    {
      ...
      if ( m_CachedPtr )
      {
        ...
        else
        {
          ...
          *(_QWORD *)(v14 + 32) = v5;
          sub_1C32BC4((CGThumbnailListItem_o *)(v14 + 32), (int32_t)v5, v8, v9);
        }
        return;
      }
    }
...
void QuestBoardListViewObject__SetItem_36425108(
        QuestBoardListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void QuestBoardListViewObject__Start(QuestBoardListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    QuestBoardListViewObject__Init_36425384(this, 2, 0, v2);
}
