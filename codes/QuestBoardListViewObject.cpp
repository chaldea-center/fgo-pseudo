...
void __fastcall QuestBoardListViewObject__Awake(QuestBoardListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5813D & 1) == 0 )
  {
    sub_1B885B0(&Method_UnityEngine_GameObject_GetComponent_QuestBoardListViewItemDraw___);
    byte_4A5813D = 1;
  }
  ...
  if ( !dispObject
    || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                             dispObject,
                             (const MethodInfo_2ECEEB8 *)Method_UnityEngine_GameObject_GetComponent_QuestBoardListViewItemDraw___),
  ...
  {
    sub_1B8880C(dispObject, v3);
  }
  itemDraw->fields.mListViewObject = this;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&itemDraw->fields.mListViewObject, (int32_t)this, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  QuestBoardListViewObject__Init_34018108(this, initMode, 0LL, v3);
}
...
void __fastcall QuestBoardListViewObject__Init_34018108(
        QuestBoardListViewObject_o *this,
        int32_t initMode,
        ...
        const MethodInfo *method)
{
  ...
  QuestBoardListViewObject__Init_34018192(this, initMode, callbackFunc, v4, *(UnityEngine_Vector3_o *)&v5, method);
}


void __fastcall QuestBoardListViewObject__Init_34018192(
        QuestBoardListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5814A & 1) == 0 )
  {
    sub_1B885B0(&QuestBoardListViewItem_TypeInfo);
    sub_1B885B0(&QuestBoardListViewManager_TypeInfo);
    sub_1B885B0(&Method_QuestBoardListViewObject_OnClickClearResetBtn__);
            ...
            if ( QuestEntity__HasFlag((QuestEntity_o *)manager, 0x400000000000000LL, 0LL) )
            {
              ...
              if ( MapControl_QuestInfo__IsClear(manager, 0LL) )
              {
                ...
                if ( (*((_BYTE *)Method_QuestBoardListViewObject_OnClickClearResetBtn__ + 83) & 2) != 0 )
                  v9 = (_QWORD *)sub_1B885C8(Method_QuestBoardListViewObject_OnClickClearResetBtn__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A58149 & 1) == 0 )
  {
    ...
    sub_1B885B0(&QuestBoardListViewItem_TypeInfo);
    sub_1B885B0(&QuestBoardListViewManager_TypeInfo);
    sub_1B885B0(&Method_QuestBoardListViewObject_OnClickInfoBtn__);
    sub_1B885B0(&TerminalSceneComponent_TypeInfo);
    byte_4A58149 = 1;
  }
  if ( !TerminalSceneComponent_TypeInfo->_2.cctor_finished )
  ...
  *(_QWORD *)&isOpened = QuestBoardListViewManager_TypeInfo;
  ...
  {
LABEL_63:
    sub_1B8880C(mInstance, isOpened);
  }
  ...
  if ( CondType__IsQuestClear_37596684(v11, -1, 0, 0LL) )
  {
LABEL_30:
    mInstance = (TerminalSceneComponent_o *)this->fields.manager;
    if ( !mInstance )
          ...
          else
          {
            if ( !v3 )
            {
              ...
              if ( (*((_BYTE *)Method_QuestBoardListViewObject_OnClickInfoBtn__ + 83) & 2) != 0 )
                v16 = (_QWORD *)sub_1B885C8(Method_QuestBoardListViewObject_OnClickInfoBtn__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5814B & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_System_Collections_Generic_List_EventDelegate__get_Count__);
    sub_1B885B0(&UnityEngine_Object_TypeInfo);
    sub_1B885B0(&StringLiteral_17791/*"cbfTitleInfoBtnBack_Click"*/);
    byte_4A5814B = 1;
  }
  v5 = (EventDelegate_o *)sub_1B887FC(EventDelegate_TypeInfo);
  EventDelegate___ctor_46787224(
    v5,
    (UnityEngine_MonoBehaviour_o *)scrTerminalListTop,
    (System_String_o *)StringLiteral_17791/*"cbfTitleInfoBtnBack_Click"*/,
    0LL);
  ...
  if ( ((unsigned __int8)gameObject & 1) != 0 )
  {
    if ( Component_object )
    {
      ...
      if ( (int)klass_low > 0 )
        return;
      v12 = *(_QWORD *)&gameObject->fields.m_CachedPtr;
      ...
      if ( v12 )
      {
        ...
        else
        {
          ...
          *(_QWORD *)(v15 + 32) = v5;
          sub_1B88554((ServantStatusBattleListViewItem_o *)(v15 + 32), (int32_t)v5, v9, v10);
        }
        return;
      }
    }
...
void __fastcall QuestBoardListViewObject__SetItem_34017832(
        QuestBoardListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall QuestBoardListViewObject__Start(QuestBoardListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    QuestBoardListViewObject__Init_34018108(this, 2, 0LL, v2);
}
