...
void __fastcall QuestBoardListViewObject__Awake(QuestBoardListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB2C88 & 1) == 0 )
  {
    sub_1BAB41C(&Method_UnityEngine_GameObject_GetComponent_QuestBoardListViewItemDraw___, method);
    byte_4AB2C88 = 1;
  }
  ...
  if ( !dispObject
    || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                             dispObject,
                             (const MethodInfo_2F13970 *)Method_UnityEngine_GameObject_GetComponent_QuestBoardListViewItemDraw___),
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&itemDraw->fields.mListViewObject, (int32_t)this, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB2C8A & 1) == 0 )
  {
    sub_1BAB41C(&QuestBoardListViewItem_TypeInfo, method);
    byte_4AB2C8A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  QuestBoardListViewObject__Init_34317212(this, initMode, 0LL, v3);
}
...
void __fastcall QuestBoardListViewObject__Init_34317212(
        QuestBoardListViewObject_o *this,
        int32_t initMode,
        ...
        const MethodInfo *method)
{
  ...
  QuestBoardListViewObject__Init_34317296(this, initMode, callbackFunc, v4, *(UnityEngine_Vector3_o *)&v5, method);
}


// local variable allocation has failed, the output may be wrong!
void __fastcall QuestBoardListViewObject__Init_34317296(
        QuestBoardListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB2C8C & 1) == 0 )
  {
    sub_1BAB41C(&QuestBoardListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4AB2C8C = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
  ...
  {
    v22 = dword_BC2F50[v11];
    this->fields.dispMode = *((_DWORD *)&xmmword_BC34E0 + v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB2C95 & 1) == 0 )
  {
    sub_1BAB41C(&QuestBoardListViewItem_TypeInfo, isOpend);
    sub_1BAB41C(&QuestBoardListViewManager_TypeInfo, v4);
    sub_1BAB41C(&Method_QuestBoardListViewObject_OnClickClearResetBtn__, v5);
            ...
            if ( QuestEntity__HasFlag((QuestEntity_o *)manager, 0x400000000000000LL, 0LL) )
            {
              ...
              if ( MapControl_QuestInfo__IsClear(manager, 0LL) )
              {
                ...
                if ( (*((_BYTE *)Method_QuestBoardListViewObject_OnClickClearResetBtn__ + 83) & 2) != 0 )
                  v12 = (_QWORD *)sub_1BAB434(Method_QuestBoardListViewObject_OnClickClearResetBtn__);
                ...
                if ( !byte_4AB0C49 )
                {
                  sub_1BAB41C(&TerminalSceneComponent_TypeInfo, isOpend);
                  byte_4AB0C49 = 1;
                }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB2C94 & 1) == 0 )
  {
    sub_1BAB41C(&CondType_TypeInfo, isOpened);
    sub_1BAB41C(&QuestBoardListViewItem_TypeInfo, v5);
    sub_1BAB41C(&QuestBoardListViewManager_TypeInfo, v6);
    sub_1BAB41C(&Method_QuestBoardListViewObject_OnClickInfoBtn__, v7);
  ...
  if ( !byte_4AB0C49 )
  {
    sub_1BAB41C(&TerminalSceneComponent_TypeInfo, isOpened);
    byte_4AB0C49 = 1;
  }
  ...
  *(_QWORD *)&isOpened = QuestBoardListViewManager_TypeInfo;
  ...
  {
LABEL_63:
    sub_1BAB678(mInstance, isOpened);
  }
  ...
  if ( CondType__IsQuestClear_37980612(v15, -1, 0, 0LL) )
  {
LABEL_30:
    mInstance = (TerminalSceneComponent_o *)this->fields.manager;
    if ( !mInstance )
          ...
          else
          {
            if ( !v3 )
            {
              ...
              if ( (*((_BYTE *)Method_QuestBoardListViewObject_OnClickInfoBtn__ + 83) & 2) != 0 )
                v20 = (_QWORD *)sub_1BAB434(Method_QuestBoardListViewObject_OnClickInfoBtn__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB2C92 & 1) == 0 )
  {
    sub_1BAB41C(&QuestBoardListViewItem_TypeInfo, is_press);
    sub_1BAB41C(&QuestBoardListViewManager_TypeInfo, v5);
    byte_4AB2C92 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB2C96 & 1) == 0 )
  {
    sub_1BAB41C(&EventDelegate_TypeInfo, scrTerminalListTop);
    sub_1BAB41C(&Method_UnityEngine_GameObject_GetComponent_UITouchPress___, v5);
    sub_1BAB41C(&Method_System_Collections_Generic_List_EventDelegate__Add__, v6);
    sub_1BAB41C(&Method_System_Collections_Generic_List_EventDelegate__get_Count__, v7);
    sub_1BAB41C(&UnityEngine_Object_TypeInfo, v8);
    sub_1BAB41C(&StringLiteral_17822/*"cbfTitleInfoBtnBack_Click"*/, v9);
    byte_4AB2C96 = 1;
  }
  v10 = (EventDelegate_o *)sub_1BAB668(EventDelegate_TypeInfo);
  EventDelegate___ctor_47033580(
    v10,
    (UnityEngine_MonoBehaviour_o *)scrTerminalListTop,
    (System_String_o *)StringLiteral_17822/*"cbfTitleInfoBtnBack_Click"*/,
    0LL);
    ...
    if ( Component_object )
    {
      ...
      if ( v17 )
      {
        ...
        else
        {
          ...
          *(_QWORD *)(v20 + 32) = v10;
          sub_1BAB3C0((ServantStatusBattleListViewItem_o *)(v20 + 32), (int32_t)v10, v14, v15);
        }
        return;
      }
    }
...
void __fastcall QuestBoardListViewObject__SetItem_34316936(
        QuestBoardListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall QuestBoardListViewObject__SetupDisp(QuestBoardListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BAB41C(&UnityEngine_Object_TypeInfo, method);
    sub_1BAB41C(&QuestBoardListViewItem_TypeInfo, v3);
    byte_4AB2C8D = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
...
void __fastcall QuestBoardListViewObject__Start(QuestBoardListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    QuestBoardListViewObject__Init_34317212(this, 2, 0LL, v2);
}
