...
void __fastcall QuestBoardListViewObject__Awake(QuestBoardListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4B2A4 & 1) == 0 )
  {
    sub_1B863B8(&Method_UnityEngine_GameObject_GetComponent_QuestBoardListViewItemDraw___, method);
    byte_4A4B2A4 = 1;
  }
  ...
  if ( !dispObject
    || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                             dispObject,
                             (const MethodInfo_2FC0DF0 *)Method_UnityEngine_GameObject_GetComponent_QuestBoardListViewItemDraw___),
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&itemDraw->fields.mListViewObject, (int32_t)this, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4B2A6 & 1) == 0 )
  {
    sub_1B863B8(&QuestBoardListViewItem_TypeInfo, method);
    byte_4A4B2A6 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  QuestBoardListViewObject__Init_34761092(this, initMode, 0LL, v3);
}
...
void __fastcall QuestBoardListViewObject__Init_34761092(
        QuestBoardListViewObject_o *this,
        int32_t initMode,
        ...
        const MethodInfo *method)
{
  ...
  QuestBoardListViewObject__Init_34761176(this, initMode, callbackFunc, v4, *(UnityEngine_Vector3_o *)&v5, method);
}


// local variable allocation has failed, the output may be wrong!
void __fastcall QuestBoardListViewObject__Init_34761176(
        QuestBoardListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4B2A8 & 1) == 0 )
  {
    sub_1B863B8(&QuestBoardListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4A4B2A8 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4B2B1 & 1) == 0 )
  {
    sub_1B863B8(&QuestBoardListViewItem_TypeInfo, isOpend);
    sub_1B863B8(&QuestBoardListViewManager_TypeInfo, v4);
    sub_1B863B8(&Method_QuestBoardListViewObject_OnClickClearResetBtn__, v5);
            ...
            if ( QuestEntity__HasFlag((QuestEntity_o *)manager, 0x400000000000000LL, 0LL) )
            {
              ...
              if ( MapControl_QuestInfo__IsClear(manager, 0LL) )
              {
                ...
                if ( (*((_BYTE *)Method_QuestBoardListViewObject_OnClickClearResetBtn__ + 83) & 2) != 0 )
                  v12 = (_QWORD *)sub_1B863D0(Method_QuestBoardListViewObject_OnClickClearResetBtn__);
                ...
                if ( !byte_4A48DB8 )
                {
                  sub_1B863B8(&TerminalSceneComponent_TypeInfo, isOpend);
                  byte_4A48DB8 = 1;
                }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4B2B0 & 1) == 0 )
  {
    sub_1B863B8(&CondType_TypeInfo, isOpened);
    sub_1B863B8(&QuestBoardListViewItem_TypeInfo, v5);
    sub_1B863B8(&QuestBoardListViewManager_TypeInfo, v6);
    sub_1B863B8(&Method_QuestBoardListViewObject_OnClickInfoBtn__, v7);
  ...
  if ( !byte_4A48DB8 )
  {
    sub_1B863B8(&TerminalSceneComponent_TypeInfo, isOpened);
    byte_4A48DB8 = 1;
  }
  ...
  *(_QWORD *)&isOpened = QuestBoardListViewManager_TypeInfo;
  ...
  {
LABEL_63:
    sub_1B86614(mInstance, isOpened);
  }
  ...
  if ( CondType__IsQuestClear_38542260(v15, -1, 0, 0LL) )
  {
LABEL_30:
    mInstance = (TerminalSceneComponent_o *)this->fields.manager;
    if ( !mInstance )
          ...
          else
          {
            if ( !v3 )
            {
              ...
              if ( (*((_BYTE *)Method_QuestBoardListViewObject_OnClickInfoBtn__ + 83) & 2) != 0 )
                v20 = (_QWORD *)sub_1B863D0(Method_QuestBoardListViewObject_OnClickInfoBtn__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4B2AE & 1) == 0 )
  {
    sub_1B863B8(&QuestBoardListViewItem_TypeInfo, is_press);
    sub_1B863B8(&QuestBoardListViewManager_TypeInfo, v5);
    byte_4A4B2AE = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4B2B2 & 1) == 0 )
  {
    sub_1B863B8(&EventDelegate_TypeInfo, scrTerminalListTop);
    sub_1B863B8(&Method_UnityEngine_GameObject_GetComponent_UITouchPress___, v5);
    sub_1B863B8(&Method_System_Collections_Generic_List_EventDelegate__Add__, v6);
    sub_1B863B8(&Method_System_Collections_Generic_List_EventDelegate__get_Count__, v7);
    sub_1B863B8(&UnityEngine_Object_TypeInfo, v8);
    sub_1B863B8(&StringLiteral_17562/*"cbfTitleInfoBtnBack_Click"*/, v9);
    byte_4A4B2B2 = 1;
  }
  v10 = (EventDelegate_o *)sub_1B86604(EventDelegate_TypeInfo);
  EventDelegate___ctor_47774748(
    v10,
    (UnityEngine_MonoBehaviour_o *)scrTerminalListTop,
    (System_String_o *)StringLiteral_17562/*"cbfTitleInfoBtnBack_Click"*/,
    0LL);
    ...
    if ( Component_object )
    {
      ...
      if ( v17 )
      {
        ...
        else
        {
          ...
          *(_QWORD *)(v20 + 32) = v10;
          sub_1B8635C((CGThumbnailListItem_o *)(v20 + 32), (int32_t)v10, v14, v15);
        }
        return;
      }
    }
...
void __fastcall QuestBoardListViewObject__SetItem_34760816(
        QuestBoardListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall QuestBoardListViewObject__SetupDisp(QuestBoardListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B863B8(&UnityEngine_Object_TypeInfo, method);
    sub_1B863B8(&QuestBoardListViewItem_TypeInfo, v3);
    byte_4A4B2A9 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
...
void __fastcall QuestBoardListViewObject__Start(QuestBoardListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    QuestBoardListViewObject__Init_34761092(this, 2, 0LL, v2);
}
