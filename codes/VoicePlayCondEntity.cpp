        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E05B2D & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_18327/*"combineAnimation"*/);
    byte_4E05B2D = 1;
  }
  return VoicePlayCondEntity__GetScriptStr(this, (System_String_o *)StringLiteral_18327/*"combineAnimation"*/, defVal, v3);
}
...
int32_t VoicePlayCondEntity__GetWeight(VoicePlayCondEntity_o *this, int32_t defVal, const MethodInfo *method)
{
  ...
  if ( (byte_4E05B2C & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_25215/*"weight"*/);
    byte_4E05B2C = 1;
  }
  return VoicePlayCondEntity__GetScriptIntParam(this, (System_String_o *)StringLiteral_25215/*"weight"*/, defVal, v3);
}
