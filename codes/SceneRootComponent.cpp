...
void SceneRootComponent__Start(SceneRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E04398 & 1) == 0 )
  {
    sub_1CE6700(&Method_UnityEngine_Component_GetComponentInChildren_UIRoot___);
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.myFSM, (int32_t)Component_object, v4, v5, v6, v7, v8, v9);
  ComponentInChildren_object__52407772 = UnityEngine_Component__GetComponentInChildren_object__52407772(
                                           (UnityEngine_Component_o *)this,
                                           (const MethodInfo_31FADDC *)Method_UnityEngine_Component_GetComponentInChildren_UIRoot___);
  this->fields.uiRoot = (struct UIRoot_o *)ComponentInChildren_object__52407772;
  sub_1CE66A4(
...
void SceneRootComponent__beginInitialize(SceneRootComponent_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.kind = 0x100000000LL;
  MainMenuBar__setActiveScene_42436436(this, 0, 1, 0, 0);
}
...
void SceneRootComponent__beginResume_42637824(SceneRootComponent_o *this, const MethodInfo *method)
{
...
void SceneRootComponent__beginStartUp_42637640(SceneRootComponent_o *this, const MethodInfo *method)
{
...
bool SceneRootComponent__checkSceneName(SceneRootComponent_o *this, System_String_o *name, const MethodInfo *method)
{
  ...
  return System_String__Equals_65158148((System_String_o *)gameObject, name, 0);
}
...
void SceneRootComponent__sendMessageResume(SceneRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E0439B & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_11245/*"RESUME"*/);
    byte_4E0439B = 1;
  }
  myFSM = (UnityEngine_Object_o *)this->fields.myFSM;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  if ( UnityEngine_Object__op_Inequality(myFSM, 0, 0) )
  {
    Instance = (PlayMakerFSM_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_NetworkManager__get_Instance__);
    if ( !Instance )
      goto LABEL_11;
    if ( NetworkManager__CheckServerLimitTime((NetworkManager_o *)Instance, 0) )
    {
      ...
      if ( Instance )
      {
        PlayMakerFSM__SendEvent(Instance, (System_String_o *)StringLiteral_11245/*"RESUME"*/, 0);
        return;
      }
LABEL_11:
...
void SceneRootComponent__sendMessageStartUp(SceneRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E0439A & 1) == 0 )
  {
    sub_1CE6700(&UnityEngine_Object_TypeInfo);
    sub_1CE6700(&Method_SingletonMonoBehaviour_NetworkManager__get_Instance__);
    sub_1CE6700(&StringLiteral_12435/*"STARTUP"*/);
    byte_4E0439A = 1;
  }
  myFSM = (UnityEngine_Object_o *)this->fields.myFSM;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  if ( UnityEngine_Object__op_Inequality(myFSM, 0, 0) )
  {
    ...
    if ( NetworkManager__CheckServerLimitTime((NetworkManager_o *)Instance, 0) )
    {
      ...
      if ( Instance )
      {
        PlayMakerFSM__SendEvent(Instance, (System_String_o *)StringLiteral_12435/*"STARTUP"*/, 0);
        return;
      }
LABEL_11:
      sub_1CE6958(Instance, v5);
        ...
        const MethodInfo *method)
{
  ...
  MainMenuBar__setActiveScene_42436436(this, kind, depth, 0, 0);
}