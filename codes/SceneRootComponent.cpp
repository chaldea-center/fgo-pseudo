...
void SceneRootComponent__Start(SceneRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C42910 & 1) == 0 )
  {
    sub_1C37058(&Method_UnityEngine_Component_GetComponentInChildren_UIRoot___);
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.myFSM, (int32_t)Component_object, v4, v5);
  ComponentInChildren_object__51242636 = UnityEngine_Component__GetComponentInChildren_object__51242636(
                                           (UnityEngine_Component_o *)this,
                                           (const MethodInfo_30DE68C *)Method_UnityEngine_Component_GetComponentInChildren_UIRoot___);
  this->fields.uiRoot = (struct UIRoot_o *)ComponentInChildren_object__51242636;
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.uiRoot, (int32_t)ComponentInChildren_object__51242636, v7, v8);
  if ( this->fields.manualWidth >= 1 && this->fields.manualHeight >= 1 )
    CommonFunction__ReScaleUiFunc(this->fields.uiRoot, 0);
}
...
void SceneRootComponent__beginInitialize(SceneRootComponent_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.kind = 0x100000000LL;
  MainMenuBar__setActiveScene_41287064(this, 0, 1, 0, 0);
}
...
void SceneRootComponent__beginResume_41481372(SceneRootComponent_o *this, const MethodInfo *method)
{
...
void SceneRootComponent__beginStartUp_41481188(SceneRootComponent_o *this, const MethodInfo *method)
{
...
bool SceneRootComponent__checkSceneName(SceneRootComponent_o *this, System_String_o *name, const MethodInfo *method)
{
  ...
  if ( !gameObject || (gameObject = (UnityEngine_Object_o *)UnityEngine_Object__get_name(gameObject, 0)) == 0 )
    sub_1C372B4(gameObject);
  return System_String__Equals_63596960((System_String_o *)gameObject, name, 0);
}
...
void SceneRootComponent__sendMessageResume(SceneRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C42913 & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_11133/*"RESUME"*/);
    byte_4C42913 = 1;
  }
  myFSM = (UnityEngine_Object_o *)this->fields.myFSM;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  if ( UnityEngine_Object__op_Inequality(myFSM, 0, 0) )
  {
    Instance = (PlayMakerFSM_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39ED16C *)Method_SingletonMonoBehaviour_NetworkManager__get_Instance__);
    if ( !Instance )
      goto LABEL_11;
    if ( NetworkManager__CheckServerLimitTime((NetworkManager_o *)Instance, 0) )
    {
      ...
      if ( Instance )
      {
        PlayMakerFSM__SendEvent(Instance, (System_String_o *)StringLiteral_11133/*"RESUME"*/, 0);
        return;
      }
LABEL_11:
      sub_1C372B4(Instance);
...
void SceneRootComponent__sendMessageStartUp(SceneRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C42912 & 1) == 0 )
  {
    sub_1C37058(&UnityEngine_Object_TypeInfo);
    sub_1C37058(&Method_SingletonMonoBehaviour_NetworkManager__get_Instance__);
    sub_1C37058(&StringLiteral_12308/*"STARTUP"*/);
    byte_4C42912 = 1;
  }
  myFSM = (UnityEngine_Object_o *)this->fields.myFSM;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  if ( UnityEngine_Object__op_Inequality(myFSM, 0, 0) )
  {
    ...
    if ( NetworkManager__CheckServerLimitTime((NetworkManager_o *)Instance, 0) )
    {
      ...
      if ( Instance )
      {
        PlayMakerFSM__SendEvent(Instance, (System_String_o *)StringLiteral_12308/*"STARTUP"*/, 0);
        return;
      }
LABEL_11:
      sub_1C372B4(Instance);
        ...
        const MethodInfo *method)
{
  ...
  MainMenuBar__setActiveScene_41287064(this, kind, depth, 0, 0);
}