...
void UIAlphaMaskTexture__EndLoadAsset(UIAlphaMaskTexture_o *this, AssetData_o *asset, const MethodInfo *method)
{
  ...
  if ( asset )
  {
    ...
    sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.assetData, (int32_t)asset, (int32_t)method, v3);
...
void UIAlphaMaskTexture__Release(UIAlphaMaskTexture_o *this, const MethodInfo *method)
{
  ...
  if ( loadName )
  {
    ...
    p_loadName->klass = 0;
    sub_1C32BC4(p_loadName, 0, v10, v11);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3918D & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_UIAlphaMaskTexture_EndLoadAsset__);
    byte_4C3918D = 1;
  }
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.loadName, (int32_t)loadName, v8, v9);
