void __fastcall BoostItemListViewItemDraw___cctor(const MethodInfo *method)
{
  if ( (byte_4A56EA4 & 1) == 0 )
  {
    sub_1B885B0(&BoostItemListViewItemDraw_TypeInfo);
    byte_4A56EA4 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A56EA3 & 1) == 0 )
  {
    ...
    this = (BoostItemListViewItemDraw_o *)sub_1B885B0(&StringLiteral_20167/*"icon_race_"*/);
    byte_4A56EA3 = 1;
  }
  if ( mode )
  {
    ...
    this = (BoostItemListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3949/*"CURRENT_NUM_TXT"*/, 0LL);
    if ( !infoLabel )
      goto LABEL_34;
    ...
    if ( (byte_4A56E9F & 1) == 0 )
    {
      this = (BoostItemListViewItemDraw_o *)sub_1B885B0(&StringLiteral_19052/*"error"*/);
      byte_4A56E9F = 1;
    }
    if ( !nameLabel )
      goto LABEL_34;
    ...
    WrapControlText__textAdjust(detailLabel, v20, v19->static_fields->DETAIL_FONT_SIZE, 0, 0, 0LL);
    ...
    if ( magnification >= 2 )
    {
      ...
      this = (BoostItemListViewItemDraw_o *)System_String__Concat_61707032(
                                              (System_String_o *)StringLiteral_20167/*"icon_race_"*/,
                                              v22,
                                              0LL);
...
LABEL_34:
    ...
    if ( isCanNotSelect )
    {
      ...
      v25 = *(float *)&v24->fields.mShouldBeProcessed;
      v26 = *(float *)&v24->fields.mProcessedText;
      v27 = *((float *)&v24->fields.mProcessedText + 1);
      v28 = *(float *)&v24->fields.mPremultiply;
      if ( !v23 )
        goto LABEL_34;
    }
    else
    ...
    UIWidget__set_color(v23, *(UnityEngine_Color_o *)&v25, 0LL);
