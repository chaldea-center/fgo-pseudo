void __fastcall BoostItemListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B32D0E & 1) == 0 )
  {
    sub_1BD3458(&BoostItemListViewItemDraw_TypeInfo, v1);
    byte_4B32D0E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B32D0D & 1) == 0 )
  {
    ...
    sub_1BD3458(&BoostItemListViewItemDraw_TypeInfo, v7);
    sub_1BD3458(&LocalizationManager_TypeInfo, v8);
    sub_1BD3458(&StringLiteral_4023/*"CURRENT_NUM_TXT"*/, v9);
    this = (BoostItemListViewItemDraw_o *)sub_1BD3458(&StringLiteral_20410/*"icon_race_"*/, v10);
    byte_4B32D0D = 1;
  }
  if ( mode )
  {
    ...
    this = (BoostItemListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_4023/*"CURRENT_NUM_TXT"*/, 0LL);
    if ( !infoLabel )
      goto LABEL_34;
    ...
    if ( (byte_4B32D09 & 1) == 0 )
    {
      this = (BoostItemListViewItemDraw_o *)sub_1BD3458(&StringLiteral_19278/*"error"*/, item);
      byte_4B32D09 = 1;
    }
    if ( !nameLabel )
      goto LABEL_34;
    ...
    if ( magnification >= 2 )
    {
      ...
      this = (BoostItemListViewItemDraw_o *)System_String__Concat_62525248(
                                              (System_String_o *)StringLiteral_20410/*"icon_race_"*/,
                                              v26,
                                              0LL);
