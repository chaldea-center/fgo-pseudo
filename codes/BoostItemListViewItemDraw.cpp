void __fastcall BoostItemListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48DE7CB & 1) == 0 )
  {
    sub_1B00CCC(&BoostItemListViewItemDraw_TypeInfo, v1);
    byte_48DE7CB = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DE7CA & 1) == 0 )
  {
    ...
    sub_1B00CCC(&BoostItemListViewItemDraw_TypeInfo, v7);
    sub_1B00CCC(&LocalizationManager_TypeInfo, v8);
    sub_1B00CCC(&StringLiteral_3906/*"CURRENT_NUM_TXT"*/, v9);
    this = (BoostItemListViewItemDraw_o *)sub_1B00CCC(&StringLiteral_19895/*"icon_race_"*/, v10);
    byte_48DE7CA = 1;
  }
  if ( mode )
  {
    ...
    this = (BoostItemListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3906/*"CURRENT_NUM_TXT"*/, 0LL);
    if ( !infoLabel )
      goto LABEL_34;
    ...
    if ( (byte_48DE7C6 & 1) == 0 )
    {
      this = (BoostItemListViewItemDraw_o *)sub_1B00CCC(&StringLiteral_18800/*"error"*/, item);
      byte_48DE7C6 = 1;
    }
    if ( !nameLabel )
      goto LABEL_34;
    ...
    if ( magnification >= 2 )
    {
      ...
      this = (BoostItemListViewItemDraw_o *)System_String__Concat_60325748(
                                              (System_String_o *)StringLiteral_19895/*"icon_race_"*/,
                                              v26,
                                              0LL);
...
LABEL_34:
    ...
    if ( isCanNotSelect )
    {
      ...
      v29 = *((float *)&v28->fields.localKey + 1);
      v30 = *(float *)&v28->fields.mActiveTTF;
      v31 = *((float *)&v28->fields.mActiveTTF + 1);
      mDensity = v28->fields.mDensity;
      if ( !v27 )
        goto LABEL_34;
    }
    else
