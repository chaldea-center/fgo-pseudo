void BoostItemListViewItemDraw___cctor(const MethodInfo *method)
{
  if ( (byte_4CE9D7A & 1) == 0 )
  {
    sub_1C7BAE8(&BoostItemListViewItemDraw_TypeInfo);
    byte_4CE9D7A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CE9D79 & 1) == 0 )
  {
    ...
    this = (BoostItemListViewItemDraw_o *)sub_1C7BAE8(&StringLiteral_20384/*"icon_race_"*/);
    byte_4CE9D79 = 1;
  }
  if ( mode )
  {
    ...
    this = (BoostItemListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3942/*"CURRENT_NUM_TXT"*/, 0);
    if ( !infoLabel )
      goto LABEL_34;
    ...
    if ( (byte_4CE9D76 & 1) == 0 )
    {
      this = (BoostItemListViewItemDraw_o *)sub_1C7BAE8(&StringLiteral_19209/*"error"*/);
      byte_4CE9D76 = 1;
    }
    if ( !nameLabel )
      goto LABEL_34;
    ...
    if ( magnification >= 2 )
    {
      ...
      this = (BoostItemListViewItemDraw_o *)System_String__Concat_64176912(
                                              (System_String_o *)StringLiteral_20384/*"icon_race_"*/,
                                              v22,
                                              0);
