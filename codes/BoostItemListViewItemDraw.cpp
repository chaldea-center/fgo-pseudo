void __fastcall BoostItemListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BF9197 & 1) == 0 )
  {
    sub_1C2E12C(&BoostItemListViewItemDraw_TypeInfo, v1);
    byte_4BF9197 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF9196 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&BoostItemListViewItemDraw_TypeInfo, v7);
    sub_1C2E12C(&LocalizationManager_TypeInfo, v8);
    sub_1C2E12C(&StringLiteral_4029/*"CURRENT_NUM_TXT"*/, v9);
    this = (BoostItemListViewItemDraw_o *)sub_1C2E12C(&StringLiteral_20532/*"icon_race_"*/, v10);
    byte_4BF9196 = 1;
  }
  if ( mode )
  {
    ...
    this = (BoostItemListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_4029/*"CURRENT_NUM_TXT"*/, 0LL);
    if ( !infoLabel )
      goto LABEL_34;
    ...
    if ( (byte_4BF9192 & 1) == 0 )
    {
      this = (BoostItemListViewItemDraw_o *)sub_1C2E12C(&StringLiteral_19392/*"error"*/, item);
      byte_4BF9192 = 1;
    }
    if ( !nameLabel )
      goto LABEL_34;
    ...
    if ( magnification >= 2 )
    {
      ...
      this = (BoostItemListViewItemDraw_o *)System_String__Concat_63235584(
                                              (System_String_o *)StringLiteral_20532/*"icon_race_"*/,
                                              v26,
                                              0LL);
