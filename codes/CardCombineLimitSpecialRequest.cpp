        ...
        const MethodInfo *method)
{
  ...
  RequestBase__addField_45612144((RequestBase_o *)this, (System_String_o *)StringLiteral_17297/*"baseUserSvtId"*/, userServantId, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7913A & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_18021/*"card/combineLimitSpecial"*/);
    byte_4E7913A = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_65562772(BaseUrl, (System_String_o *)StringLiteral_18021/*"card/combineLimitSpecial"*/, 0);
}
