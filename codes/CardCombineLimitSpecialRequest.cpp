        ...
        const MethodInfo *method)
{
  if ( (byte_4A4FE45 & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_16839/*"baseUserSvtId"*/, userServantId);
    byte_4A4FE45 = 1;
  }
  RequestBase__addField_42287768((RequestBase_o *)this, (System_String_o *)StringLiteral_16839/*"baseUserSvtId"*/, userServantId, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4FE44 & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_17519/*"card/combineLimitSpecial"*/, v2);
    byte_4A4FE44 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61645176(BaseUrl, (System_String_o *)StringLiteral_17519/*"card/combineLimitSpecial"*/, 0LL);
}
