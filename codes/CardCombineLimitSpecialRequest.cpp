        ...
        const MethodInfo *method)
{
  if ( (byte_4A0A383 & 1) == 0 )
  {
    sub_1B686D4(&StringLiteral_17019/*"baseUserSvtId"*/, userServantId);
    byte_4A0A383 = 1;
  }
  RequestBase__addField_40919284((RequestBase_o *)this, (System_String_o *)StringLiteral_17019/*"baseUserSvtId"*/, userServantId, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0A382 & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_17684/*"card/combineLimitSpecial"*/, v2);
    byte_4A0A382 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61419468(BaseUrl, (System_String_o *)StringLiteral_17684/*"card/combineLimitSpecial"*/, 0LL);
}
