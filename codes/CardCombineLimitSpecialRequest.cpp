        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A212C1 & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_17034/*"baseUserSvtId"*/, userServantId);
    byte_4A212C1 = 1;
  }
  RequestBase__addField_40922716((RequestBase_o *)this, (System_String_o *)StringLiteral_17034/*"baseUserSvtId"*/, userServantId, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A212C0 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_17699/*"card/combineLimitSpecial"*/, v2);
    byte_4A212C0 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61505504(BaseUrl, (System_String_o *)StringLiteral_17699/*"card/combineLimitSpecial"*/, 0LL);
}
