        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB7744 & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_23516/*"stageId"*/, *(_QWORD *)&stageId);
    sub_1BAB41C(&StringLiteral_17184/*"befSquareIndex"*/, v18);
    sub_1BAB41C(&StringLiteral_22571/*"pieceIndex"*/, v19);
    sub_1BAB41C(&StringLiteral_19884/*"groupId"*/, v20);
    sub_1BAB41C(&StringLiteral_19564/*"forceId"*/, v21);
    sub_1BAB41C(&StringLiteral_16739/*"aftSquareIndex"*/, v22);
    sub_1BAB41C(&StringLiteral_23898/*"targetWallId"*/, v23);
    byte_4AB7744 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23516/*"stageId"*/, stageId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19564/*"forceId"*/, forceId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19884/*"groupId"*/, groupId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22571/*"pieceIndex"*/, pieceIndex, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23898/*"targetWallId"*/, targetWallId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_17184/*"befSquareIndex"*/, befSquareIndex, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_16739/*"aftSquareIndex"*/, aftSquareIndex, 0LL);
  if ( !warBoardData )
    sub_1BAB678(v24, v25);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BAB41C(&NetworkManager_TypeInfo, method);
    sub_1BAB41C(&StringLiteral_24666/*"warBoard/wallAttack"*/, v2);
    byte_4AB7743 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62048128(BaseUrl, (System_String_o *)StringLiteral_24666/*"warBoard/wallAttack"*/, 0LL);
}
