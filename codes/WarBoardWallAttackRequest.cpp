        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_438BDFA & 1) == 0 )
  {
    ...
    sub_B775C4(&StringLiteral_23093/*"targetWallId"*/);
    byte_438BDFA = 1;
  }
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23093/*"targetWallId"*/, targetWallId, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B775C4(&NetworkManager_TypeInfo);
    sub_B775C4(&StringLiteral_23696/*"warBoard/wallAttack"*/);
    byte_438BDF9 = 1;
  }
  if ( (BYTE3(NetworkManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !NetworkManager_TypeInfo->_2.cctor_finished )
  ...
  return System_String__Concat_44901936(BaseUrl, (System_String_o *)StringLiteral_23696/*"warBoard/wallAttack"*/, 0LL);
}
