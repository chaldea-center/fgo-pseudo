        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FA91D & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_16619, v18);
    sub_B16FFC(&StringLiteral_21382, v19);
    sub_B16FFC(&StringLiteral_19013, v20);
    sub_B16FFC(&StringLiteral_18734, v21);
    sub_B16FFC(&StringLiteral_16221, v22);
    sub_B16FFC(&StringLiteral_22523, v23);
    byte_40FA91D = 1;
  }
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22523, targetWallId, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B16FFC(&NetworkManager_TypeInfo, method);
    sub_B16FFC(&StringLiteral_23119, v2);
    byte_40FA91C = 1;
  }
  if ( (BYTE3(NetworkManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !NetworkManager_TypeInfo->_2.cctor_finished )
  ...
  return System_String__Concat_43743732(BaseUrl, (System_String_o *)StringLiteral_23119, 0LL);
}
