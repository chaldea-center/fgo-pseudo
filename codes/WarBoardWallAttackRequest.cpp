        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F916 & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_17145/*"befSquareIndex"*/, v18);
    sub_1B761C0(&StringLiteral_22523/*"pieceIndex"*/, v19);
    sub_1B761C0(&StringLiteral_19848/*"groupId"*/, v20);
    sub_1B761C0(&StringLiteral_19528/*"forceId"*/, v21);
    sub_1B761C0(&StringLiteral_16702/*"aftSquareIndex"*/, v22);
    sub_1B761C0(&StringLiteral_23847/*"targetWallId"*/, v23);
    byte_4A2F916 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23465/*"stageId"*/, stageId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19528/*"forceId"*/, forceId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19848/*"groupId"*/, groupId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22523/*"pieceIndex"*/, pieceIndex, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23847/*"targetWallId"*/, targetWallId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_17145/*"befSquareIndex"*/, befSquareIndex, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_16702/*"aftSquareIndex"*/, aftSquareIndex, 0LL);
  if ( !warBoardData )
    sub_1B7641C(v24, v25);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B761C0(&NetworkManager_TypeInfo, method);
    sub_1B761C0(&StringLiteral_24611/*"warBoard/wallAttack"*/, v2);
    byte_4A2F915 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61535060(BaseUrl, (System_String_o *)StringLiteral_24611/*"warBoard/wallAttack"*/, 0LL);
}
