        ...
        const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.assistData, (int32_t)assistData, (int32_t)method, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C37D51 & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_5526/*"EVENT_ASSIST_SKILL_MAX_LEVEL_FORMAT"*/);
    sub_1C32C20(&StringLiteral_5525/*"EVENT_ASSIST_SKILL_LEVEL_FORMAT"*/);
    byte_4C37D51 = 1;
  }
  if ( this->fields.assistData )
  {
    ...
    if ( !v8 )
      goto LABEL_46;
    GameObjectExtensions__SetLocalPosition_36036656((UnityEngine_GameObject_o *)Instance, v8->fields.objectPosition, 0);
    ...
    if ( UnityEngine_Object__op_Inequality(skillIconSprite, 0, 0) )
    {
      ...
      if ( !v21 )
        goto LABEL_46;
      GameObjectExtensions__SetLocalPosition_36036656((UnityEngine_GameObject_o *)Instance, v21->fields.iconPosition, 0);
    ...
    if ( UnityEngine_Object__op_Inequality(levelLabel, 0, 0) )
    {
      ...
      v27 = LocalizationManager__Get((System_String_o *)StringLiteral_5525/*"EVENT_ASSIST_SKILL_LEVEL_FORMAT"*/, 0);
      lv = v7->fields.lv;
      ...
      if ( Instance )
      {
        ...
        if ( v36 )
        {
          ...
          if ( v37 )
          {
            ...
            if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
            v41 = LocalizationManager__Get((System_String_o *)StringLiteral_5526/*"EVENT_ASSIST_SKILL_MAX_LEVEL_FORMAT"*/, 0);
            v49 = v39;
