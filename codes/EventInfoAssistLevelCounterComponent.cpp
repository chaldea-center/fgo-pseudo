        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDCD02 & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_5667/*"EVENT_ASSIST_SKILL_MAX_LEVEL_FORMAT"*/);
    sub_1C21E38(&StringLiteral_5666/*"EVENT_ASSIST_SKILL_LEVEL_FORMAT"*/);
    byte_4BDCD02 = 1;
  }
  if ( this->fields.assistData )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(levelLabel, 0LL, 0LL) )
    {
      ...
      v25 = LocalizationManager__Get((System_String_o *)StringLiteral_5666/*"EVENT_ASSIST_SKILL_LEVEL_FORMAT"*/, 0LL);
      lv = v8->fields.lv;
      ...
      if ( Instance )
      {
        ...
        if ( v31 )
        {
          ...
          if ( v32 )
          {
            ...
            if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
            v36 = LocalizationManager__Get((System_String_o *)StringLiteral_5667/*"EVENT_ASSIST_SKILL_MAX_LEVEL_FORMAT"*/, 0LL);
            v41 = v34;
