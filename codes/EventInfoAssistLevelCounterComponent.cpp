        ...
        const MethodInfo *method)
{
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.assistData, (int32_t)assistData, (int32_t)method, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4EA89 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_DataManager_GetMasterData_AssistMaster___, v3);
    ...
    sub_1B863B8(&StringLiteral_5482/*"EVENT_ASSIST_SKILL_MAX_LEVEL_FORMAT"*/, v8);
    sub_1B863B8(&StringLiteral_5481/*"EVENT_ASSIST_SKILL_LEVEL_FORMAT"*/, v9);
    byte_4A4EA89 = 1;
  }
  if ( this->fields.assistData )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(levelLabel, 0LL, 0LL) )
    {
      ...
      v32 = LocalizationManager__Get((System_String_o *)StringLiteral_5481/*"EVENT_ASSIST_SKILL_LEVEL_FORMAT"*/, 0LL);
      lv = v15->fields.lv;
      ...
      if ( Instance )
      {
        ...
        if ( v38 )
        {
          ...
          if ( v39 )
          {
            ...
            if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
            v43 = LocalizationManager__Get((System_String_o *)StringLiteral_5482/*"EVENT_ASSIST_SKILL_MAX_LEVEL_FORMAT"*/, 0LL);
            v48 = v41;
