...
void __fastcall FixedSpringPanel__AdvanceTowardsPosition(FixedSpringPanel_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B492BF & 1) == 0 )
  {
    ...
    sub_1BDB878(&SpringPanel_TypeInfo, v3);
    byte_4B492BF = 1;
  }
  ...
  *(UnityEngine_Vector3_o *)&v8 = UnityEngine_Transform__get_localPosition(mTrans, 0LL);
  ...
  v28 = NGUIMath__SpringLerp_48596608(localPosition, this->fields.target, this->fields.strength, v7, 0LL);
  x = v28.fields.x;
  y = v28.fields.y;
  z = v28.fields.z;
...
LABEL_26:
  ...
  if ( v19 && this->fields.onFinished )
  {
    ...
    sub_1BDB81C((CGThumbnailListItem_o *)SpringPanel_TypeInfo->static_fields, (int32_t)this, v21, v22);
    ...
    if ( onFinished )
    {
      ...
      sub_1BDB81C((CGThumbnailListItem_o *)SpringPanel_TypeInfo->static_fields, 0, v24, v25);
      return;
    }
    goto LABEL_26;
  }
