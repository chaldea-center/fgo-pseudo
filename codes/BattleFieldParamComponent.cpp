...
{
  *(_OWORD *)&this->fields.RAID_POSITION.fields.x = xmmword_C09890;
...
void BattleFieldParamComponent__InitUpdateView(BattleFieldParamComponent_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.data )
  {
    ...
    if ( root )
    {
      ...
      if ( !byte_4C20DA1 )
      {
        root = (UnityEngine_GameObject_o *)sub_1C2D490(&UnityEngine_Vector3_TypeInfo);
        byte_4C20DA1 = 1;
      }
      if ( v4 )
      {
            ...
            if ( battle_ent )
            {
              ...
              if ( battleInfo )
              {
                ...
                if ( raidInfo && raidInfo->max_length )
                {
                  ...
                  {
                    root = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39D3CCC *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
                    if ( !root )
                      goto LABEL_34;
                    ...
                    if ( !v12 )
                      goto LABEL_34;
                    root = (UnityEngine_GameObject_o *)EventRaidMaster__GetEntity(v12, eventId, (int32_t)root, 0);
                    if ( root )
                    {
        ...
        const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.perf, (int32_t)Perf_k__BackingField, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( ((unsigned __int8)ShowServantParam & 1) == 0 )
  {
    ...
    {
      sub_1C2D6EC(ShowServantParam, v7);
    }
