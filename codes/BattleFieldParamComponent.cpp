...
{
  *(_OWORD *)&this->fields.RAID_POSITION.fields.x = xmmword_D24E70;
...
void BattleFieldParamComponent__InitUpdateView(BattleFieldParamComponent_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.data )
  {
    ...
    if ( root )
    {
      ...
      if ( !byte_4DFE0A9 )
      {
        root = sub_1CE6700(&UnityEngine_Vector3_TypeInfo);
        byte_4DFE0A9 = 1;
      }
      if ( v4 )
      {
            ...
            if ( battle_ent )
            {
              ...
              if ( battleInfo )
              {
                ...
                if ( raidInfo && raidInfo->max_length )
                {
                  ...
                  if ( (root & 1) == 0 )
                  {
                    root = (__int64)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
                    if ( !root )
                      goto LABEL_34;
...
void BattleFieldParamComponent__ShowFieldConf(BattleFieldParamComponent_o *this, const MethodInfo *method)
{
  ...
  if ( !this )
    goto LABEL_11;
  this = (BattleFieldParamComponent_o *)ChangeBattlePhaseNotify__get_Phase((ChangeBattlePhaseNotify_o *)this, 0);
  if ( (_DWORD)this != 1 )
    return;
  v5 = v4->fields.perf;
        ...
        const MethodInfo *method)
{
  ...
  {
    if ( !buffData
      || (v8 = this->fields.showBuffComponent, ShowServantParam = BattleBuffData__getShowServantParam(buffData, 0), !v8) )
    {
      sub_1CE6958(ShowServantParam, v7);
    }
    BattleServantShowBuffComponent__setBuffList(v8, ShowServantParam, 0);
  }
}