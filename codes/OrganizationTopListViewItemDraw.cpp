        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA72C & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_20365/*"img_shop_0"*/, v7);
    this = (OrganizationTopListViewItemDraw_o *)sub_1B64A00(&StringLiteral_1/*""*/, v8);
    byte_49FA72C = 1;
  }
  if ( item && mode )
  {
    ...
    {
      v11 = v6[6];
      imageName = (System_String_o *)StringLiteral_20365/*"img_shop_0"*/;
