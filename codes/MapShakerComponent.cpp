void MapShakerComponent___ctor(MapShakerComponent_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.MagnitudeXMax = xmmword_C11960;
  this->fields.flag = 1;
...
void MapShakerComponent__Update(MapShakerComponent_o *this, const MethodInfo *method)
{
  ...
  switch ( shakeType )
  {
    ...
    case 1:
      ...
      break;
    case 0:
      v6 = UnityEngine_Random__Range_71301784(0, 2, 0);
      ...
      v12 = UnityEngine_Random__Range_71301784(0, 2, 0);
...
void MapShakerComponent__getMap(MapShakerComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.toShake, (int32_t)dispRoot, v2, v3);
}