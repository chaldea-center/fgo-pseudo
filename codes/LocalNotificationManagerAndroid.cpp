void LocalNotificationManagerAndroid___ctor(LocalNotificationManagerAndroid_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D323D9 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_SingletonTemplate_LocalNotificationManagerAndroid___ctor__);
    byte_4D323D9 = 1;
  }
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields._noticeIdTable, (int32_t)v3, v4, v5, v6, v7, v8, v9);
  SingletonTemplate_object____ctor(
    (SingletonTemplate_CLASS__o *)this,
    (const MethodInfo_3AC58E4 *)Method_SingletonTemplate_LocalNotificationManagerAndroid___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D323D7 & 1) == 0 )
  {
    sub_1C93AD4(&Unity_Notifications_Android_AndroidNotificationCenter_TypeInfo);
    sub_1C93AD4(&Method_System_Collections_Generic_Dictionary_string__int__ContainsKey__);
    sub_1C93AD4(&Method_System_Collections_Generic_Dictionary_string__int__Remove__);
    ...
    if ( noticeIdTable )
    {
      ...
      if ( noticeIdTable )
      {
        System_Collections_Generic_Dictionary_object__int___Remove(
          (System_Collections_Generic_Dictionary_object__int__o *)noticeIdTable,
          (Il2CppObject *)key,
          (const MethodInfo_3527184 *)Method_System_Collections_Generic_Dictionary_string__int__Remove__);
        return;
      }
    }
LABEL_11:
    sub_1C93D2C(noticeIdTable, key);
  }
}
    ...
    if ( (int)max_length >= 1 )
    {
      ...
      for ( i = &NotificationChannels->m_Items[0].fields._Id_k__BackingField; ; i += 7 )
      {
        if ( v7 >= (unsigned int)max_length )
          sub_1C93D34(NotificationChannels);
        ...
        const MethodInfo *method)
{
  ...
  __int64 v24; // x0
  __int64 v25; // x1
  Unity_Notifications_Android_AndroidNotification_o v26; // [xsp+0h] [xbp-2D0h] BYREF
  _BYTE dest[192]; // [xsp+C0h] [xbp-210h] BYREF
  System_Nullable_Color__o v28; // [xsp+180h] [xbp-150h] BYREF
  System_Nullable_Color__o v29; // [xsp+198h] [xbp-138h] BYREF
  ...
  if ( (byte_4D323D6 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_22586/*"notification_icon"*/);
    byte_4D323D6 = 1;
  }
  memset(&s, 0, sizeof(s));
  if ( this->fields._RegisteredChannel_k__BackingField )
  {
    ...
    v10.fields._dateData = System_DateTime__AddSeconds((System_DateTime_o)&dateData, (double)intervalSeconds, 0).fields._dateData;
    Unity_Notifications_Android_AndroidNotification___ctor(
      ...
      v10,
      0);
    s.fields._SmallIcon_k__BackingField = (struct System_String_o *)StringLiteral_22586/*"notification_icon"*/;
    sub_1C93A78(
      (GrandQuestFolderBoardItem_o *)&s.fields._SmallIcon_k__BackingField,
      StringLiteral_22586/*"notification_icon"*/,
      v11,
      v12,
      v13,
      v14,
    ...
    System_Nullable_Color____ctor(&v29, v32, (const MethodInfo_399CD48 *)Method_System_Nullable_Color___ctor__);
    v28 = v29;
    Unity_Notifications_Android_AndroidNotification__set_Color(&s, &v28, 0);
    s.fields._ShowTimestamp_k__BackingField = 1;
    memcpy(dest, &s, sizeof(dest));
    ChannelId_k__BackingField = this->fields._ChannelId_k__BackingField;
    if ( !Unity_Notifications_Android_AndroidNotificationCenter_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(Unity_Notifications_Android_AndroidNotificationCenter_TypeInfo);
    memcpy(&v26, dest, sizeof(v26));
    v24 = Unity_Notifications_Android_AndroidNotificationCenter__SendNotification(&v26, ChannelId_k__BackingField, 0);
