        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40F8D7B & 1) == 0 )
  {
    ...
    sub_B16FFC(&Method_SingletonTemplate_LocalNotificationManagerAndroid___ctor__, v7);
  ...
  SingletonTemplate_clsQuestCheck____ctor(
    ...
    (const MethodInfo_2A555A4 *)Method_SingletonTemplate_LocalNotificationManagerAndroid___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40F8D79 & 1) == 0 )
  {
    sub_B16FFC(&Unity_Notifications_Android_AndroidNotificationCenter_TypeInfo, key);
    sub_B16FFC(&Method_System_Collections_Generic_Dictionary_string__int__ContainsKey__, v5);
    sub_B16FFC(&Method_System_Collections_Generic_Dictionary_string__int__Remove__, v6);
         ...
         (const MethodInfo_2D9C430 *)Method_System_Collections_Generic_Dictionary_string__int__ContainsKey__) )
  {
    ...
    if ( v9 )
    {
      ...
      v11 = this->fields._noticeIdTable;
      if ( v11 )
      {
        System_Collections_Generic_Dictionary_Type__int___Remove(
          (System_Collections_Generic_Dictionary_Type__int__o *)v11,
          (System_Type_o *)key,
          (const MethodInfo_2D9DBDC *)Method_System_Collections_Generic_Dictionary_string__int__Remove__);
        return;
      }
    }
LABEL_12:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40F8D7A & 1) == 0 )
  {
    sub_B16FFC(&Unity_Notifications_Android_AndroidNotificationCenter_TypeInfo, method);
    sub_B16FFC(&Method_System_Collections_Generic_Dictionary_string__int__Clear__, v3);
    byte_40F8D7A = 1;
  }
  if ( (BYTE3(Unity_Notifications_Android_AndroidNotificationCenter_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !Unity_Notifications_Android_AndroidNotificationCenter_TypeInfo->_2.cctor_finished )
  ...
  if ( !System_String__IsNullOrEmpty(this->fields._ChannelId_k__BackingField, 0LL) )
  {
    ...
    if ( (int)v6 >= 1 )
    {
      ...
      for ( i = &NotificationChannels->m_Items[0].fields._Id_k__BackingField; ; i += 6 )
      {
        ...
        {
          sub_B17100(NotificationChannels, v4, v5);
          sub_B170A0();
        }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B16FFC(&Unity_Notifications_Android_AndroidNotificationCenter_TypeInfo, key);
    sub_B16FFC(&System_DateTime_TypeInfo, v9);
  ...
  if ( this->fields._RegisteredChannel_k__BackingField )
  {
    ...
    v41.fields.g = 0.6196;
    v41.fields.b = 0.6196;
    UnityEngine_Color___ctor_40666012(v41, v27, v28, v29, &methoda);
    *(_QWORD *)&v42.fields.r = methoda.methodPointer;
    *(_QWORD *)&v42.fields.b = methoda.invoker_method;
    memset(&v35, 0, sizeof(v35));
    System_Nullable_Color____ctor(&v35, v42, (const MethodInfo_2965EB0 *)Method_System_Nullable_Color___ctor__);
    v34 = v35;
