        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F6C7 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_SingletonTemplate_LocalNotificationManagerAndroid___ctor__, v4);
    byte_4A2F6C7 = 1;
  }
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields._noticeIdTable, (int32_t)v5, v6, v7);
  SingletonTemplate_object____ctor(
    (SingletonTemplate_CLASS__o *)this,
    (const MethodInfo_3712A94 *)Method_SingletonTemplate_LocalNotificationManagerAndroid___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F6C5 & 1) == 0 )
  {
    sub_1B761C0(&Unity_Notifications_Android_AndroidNotificationCenter_TypeInfo, key);
    sub_1B761C0(&Method_System_Collections_Generic_Dictionary_string__int__ContainsKey__, v5);
    sub_1B761C0(&Method_System_Collections_Generic_Dictionary_string__int__Remove__, v6);
    ...
    if ( noticeIdTable )
    {
      ...
      if ( noticeIdTable )
      {
        System_Collections_Generic_Dictionary_object__int___Remove(
          (System_Collections_Generic_Dictionary_object__int__o *)noticeIdTable,
          (Il2CppObject *)key,
          (const MethodInfo_319E3C4 *)Method_System_Collections_Generic_Dictionary_string__int__Remove__);
        return;
      }
    }
LABEL_11:
    sub_1B7641C(noticeIdTable, key);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F6C6 & 1) == 0 )
  {
    sub_1B761C0(&Unity_Notifications_Android_AndroidNotificationCenter_TypeInfo, method);
    sub_1B761C0(&Method_System_Collections_Generic_Dictionary_string__int__Clear__, v3);
    byte_4A2F6C6 = 1;
  }
  if ( !Unity_Notifications_Android_AndroidNotificationCenter_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(Unity_Notifications_Android_AndroidNotificationCenter_TypeInfo);
    ...
    if ( (int)v5 >= 1 )
    {
      ...
      for ( i = &NotificationChannels->m_Items[0].fields._Id_k__BackingField; ; i += 7 )
      {
        if ( v7 >= (unsigned int)v5 )
          sub_1B76424(NotificationChannels, v4);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F6C4 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_System_Nullable_Color___ctor__, v11);
    sub_1B761C0(&string_TypeInfo, v12);
    sub_1B761C0(&StringLiteral_22146/*"notification_icon"*/, v13);
    byte_4A2F6C4 = 1;
  }
  memset(&s, 0, sizeof(s));
  if ( this->fields._RegisteredChannel_k__BackingField )
  {
    ...
    Unity_Notifications_Android_AndroidNotification___ctor(
      ...
      v29,
      0LL);
    s.fields._SmallIcon_k__BackingField = (struct System_String_o *)StringLiteral_22146/*"notification_icon"*/;
    sub_1B76164(
      (ServantStatusBattleListViewItem_o *)&s.fields._SmallIcon_k__BackingField,
      StringLiteral_22146/*"notification_icon"*/,
      v15,
      v16);
    ...
    System_Nullable_Color____ctor(&v25, v30, (const MethodInfo_35F1430 *)Method_System_Nullable_Color___ctor__);
    v24 = v25;
