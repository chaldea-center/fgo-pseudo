void CharaGraphSortOwnerGrandSameServant___ctor(CharaGraphSortOwnerGrandSameServant_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E721D2 & 1) == 0 )
  {
    sub_1D0F0B4(&CharaGraphSortManageUnitGrandSameServant_TypeInfo);
    byte_4E721D2 = 1;
  }
  v3 = (CharaGraphSortManageUnitServant_o *)sub_1D0F300(CharaGraphSortManageUnitGrandSameServant_TypeInfo);
        ...
        const MethodInfo *method)
{
  if ( (byte_4E721D1 & 1) == 0 )
  {
    sub_1D0F0B4(&StringLiteral_4434/*"CharaGraphSort_GrandSameServant"*/);
    byte_4E721D1 = 1;
  }
  return (System_String_o *)StringLiteral_4434/*"CharaGraphSort_GrandSameServant"*/;
}
