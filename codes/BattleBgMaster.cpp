void BattleBgMaster___ctor(BattleBgMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4C26F04 & 1) == 0 )
  {
    sub_1C2D490(&Method_DataMasterBase_BattleBgMaster__BattleBgEntity__string___ctor__);
    byte_4C26F04 = 1;
  }
  ...
  DataMasterBase_object__object__object____ctor(
    ...
    133,
    (const MethodInfo_338A52C *)Method_DataMasterBase_BattleBgMaster__BattleBgEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  int v10; // w1
  int32_t v11; // w2
  const MethodInfo_3AE36B8 *v12; // x3
  ...
  if ( (byte_4C26F07 & 1) == 0 )
  {
    sub_1C2D490(&Method_System_ValueTuple_int__int___ctor__);
    byte_4C26F07 = 1;
  }
  entity = 0;
  ...
  if ( v10 > 0 )
  {
    ...
    v12 = (const MethodInfo_3AE36B8 *)Method_System_ValueTuple_int__int___ctor__;
...
BattleBgEntity_o *BattleBgMaster__GetEntity(BattleBgMaster_o *this, int32_t id, int32_t type, const MethodInfo *method)
{
  ...
  if ( (byte_4C26F02 & 1) == 0 )
  {
    sub_1C2D490(&Method_DataMasterBase_BattleBgMaster__BattleBgEntity__string__GetEntity__);
    byte_4C26F02 = 1;
  }
  ...
  return (BattleBgEntity_o *)DataMasterBase_object__object__object___GetEntity(
                               (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                               PK,
                               (const MethodInfo_338C850 *)Method_DataMasterBase_BattleBgMaster__BattleBgEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C26F03 & 1) == 0 )
  {
    sub_1C2D490(&Method_DataMasterBase_BattleBgMaster__BattleBgEntity__string__TryGetEntity__);
    byte_4C26F03 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_338C89C *)Method_DataMasterBase_BattleBgMaster__BattleBgEntity__string__TryGetEntity__);
}
...
bool BattleBgMaster__preProcess(BattleBgMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C26F06 & 1) == 0 )
  {
    sub_1C2D490(&Method_System_Linq_Enumerable_Cast_BattleBgEntity___);
    ...
    sub_1C2D490(&System_Collections_Generic_IEnumerable_BattleBgEntity__TypeInfo);
    sub_1C2D490(&System_Collections_Generic_IEnumerable_int__TypeInfo);
    sub_1C2D490(&System_Collections_Generic_IEnumerator_BattleBgEntity__TypeInfo);
  ...
  v4 = System_Linq_Enumerable__Cast_object_(
         ...
         (const MethodInfo_30DD028 *)Method_System_Linq_Enumerable_Cast_BattleBgEntity___);
  if ( !v4 )
    sub_1C2D6EC(0, v5);
  klass = v4->klass;
  v7 = v4;
  ...
  {
LABEL_8:
    v10 = sub_1C7DCA8(v4, System_Collections_Generic_IEnumerable_BattleBgEntity__TypeInfo, 0);
  }
...
LABEL_16:
    ...
    {
LABEL_23:
      v21 = sub_1C7DCA8(v13, System_Collections_Generic_IEnumerator_BattleBgEntity__TypeInfo, 0);
    }
    ...
    {
LABEL_31:
      v31 = sub_1C7DCA8(AllSpecialShadowEffectIds, System_Collections_Generic_IEnumerable_int__TypeInfo, 0);
    }
...
LABEL_45:
      ...
      {
        if ( !v3 )
          sub_1C2D6EC(v42, (unsigned int)v42);
    ...
    {
LABEL_54:
      v46 = sub_1C7DCA8(v33, System_IDisposable_TypeInfo, 0);
    }
  ...
  {
LABEL_63:
    v50 = sub_1C7DCA8(v13, System_IDisposable_TypeInfo, 0);
  }
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.bgSpecialShadowEffectIdArray, (int32_t)v51, v52, v53);
  return 1;
}