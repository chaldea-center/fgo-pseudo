...
void BattleActorNodeLookAt__Awake(BattleActorNodeLookAt_o *this, const MethodInfo *method)
{
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.selfTransform, (int32_t)transform, v4, v5, v6, v7, v8, v9);
}
  ...
  if ( type == 1 )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(lookTargetObj, 0, 0) )
    {
      ...
      if ( sqrtf((float)((float)(z - v17) * (float)(z - v17)) + (float)((float)(v18 * v18) + (float)(v19 * v19))) > 0.001 )
      {
        ...
        v32.fields.y = v19;
        v32.fields.z = z - v17;
        v34 = UnityEngine_Quaternion__LookRotation_72856820(v32, 0);
        v20 = v34.fields.x;
        v21 = v34.fields.y;
        v22 = v34.fields.z;
        w = v34.fields.w;
