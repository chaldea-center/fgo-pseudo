      ...
      *(float *)&methoda.invoker_method = position.fields.z;
      if ( UnityEngine_Vector3__get_magnitude(position, &methoda) > 0.001 )
      {
        *(_QWORD *)&v29.fields.x = methoda.methodPointer;
        ...
        v30 = UnityEngine_Quaternion__LookRotation_35647968(v29, 0LL);
        v19 = v30.fields.x;
        y = v30.fields.y;
        z = v30.fields.z;
        w = v30.fields.w;
...
LABEL_18:
  ...
  else if ( x == 0.0 )
  {
    ...
    *(UnityEngine_Quaternion_o *)&v7 = UnityEngine_Quaternion__Euler_35649096(
