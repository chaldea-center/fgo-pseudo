        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1A1EC & 1) == 0 )
  {
    sub_1BCAFF8(&WarBoardDispNotiDialog__Execute_d__5_TypeInfo, method);
    byte_4B1A1EC = 1;
  }
  v3 = sub_1BCB244(WarBoardDispNotiDialog__Execute_d__5_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1A1EE & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_WarBoardDispNotiDialog___c__DisplayClass5_0__Execute_b__0__, v4);
    sub_1BCAFF8(&Method_WarBoardDispNotiDialog___c__DisplayClass5_0__Execute_b__1__, v5);
    sub_1BCAFF8(&WarBoardDispNotiDialog___c__DisplayClass5_0_TypeInfo, v6);
  ...
  else
  {
    ...
    v11 = sub_1BCB244(WarBoardDispNotiDialog___c__DisplayClass5_0_TypeInfo);
    ...
    sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.__2__current, (int32_t)v18, v19, v20);
    v21 = 1;
    result = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BCB00C(&Method_WarBoardDispNotiDialog__Execute_d__5_System_Collections_IEnumerator_Reset__);
  sub_1BCB120(v3, v4);
}
