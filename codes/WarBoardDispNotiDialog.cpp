        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_593623B & 1) == 0 )
  {
    sub_21FFC50(&WarBoardDispNotiDialog__Execute_d__5_TypeInfo);
    byte_593623B = 1;
  }
  v3 = sub_21FFEBC(WarBoardDispNotiDialog__Execute_d__5_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_593623D & 1) == 0 )
  {
    ...
    sub_21FFC50(&Method_WarBoardDispNotiDialog___c__DisplayClass5_0__Execute_b__0__);
    sub_21FFC50(&Method_WarBoardDispNotiDialog___c__DisplayClass5_0__Execute_b__1__);
    sub_21FFC50(&WarBoardDispNotiDialog___c__DisplayClass5_0_TypeInfo);
  ...
  if ( !_1__state )
  {
    ...
    v6 = sub_21FFEBC(WarBoardDispNotiDialog___c__DisplayClass5_0_TypeInfo);
    ...
    System_Func_bool____ctor(
      ...
      0);
    v13 = (UnityEngine_WaitUntil_o *)sub_21FFEBC(UnityEngine_WaitUntil_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_21FFC64(&Method_WarBoardDispNotiDialog__Execute_d__5_System_Collections_IEnumerator_Reset__);
  sub_21FFD90(v3, v4);
}
