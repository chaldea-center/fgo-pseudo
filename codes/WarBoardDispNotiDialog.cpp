        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24F70 & 1) == 0 )
  {
    sub_1C2D490(&WarBoardDispNotiDialog__Execute_d__5_TypeInfo);
    byte_4C24F70 = 1;
  }
  v3 = sub_1C2D6DC(WarBoardDispNotiDialog__Execute_d__5_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24F72 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_WarBoardDispNotiDialog___c__DisplayClass5_0__Execute_b__0__);
    sub_1C2D490(&Method_WarBoardDispNotiDialog___c__DisplayClass5_0__Execute_b__1__);
    sub_1C2D490(&WarBoardDispNotiDialog___c__DisplayClass5_0_TypeInfo);
  ...
  else
  {
    ...
    v6 = sub_1C2D6DC(WarBoardDispNotiDialog___c__DisplayClass5_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C2D4A4(&Method_WarBoardDispNotiDialog__Execute_d__5_System_Collections_IEnumerator_Reset__);
  sub_1C2D5B8(v3, v4);
}
