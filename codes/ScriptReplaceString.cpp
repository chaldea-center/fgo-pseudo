...
void ScriptReplaceString__Init(const MethodInfo *method)
{
  ...
  if ( (byte_4D329F3 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&ScriptReplaceString_TypeInfo);
    sub_1C93AD4(&StringLiteral_15917/*"[#[FF0000]主[-]人公:しゅじんこう]はぐだぐだな主人公"*/);
    sub_1C93AD4(&StringLiteral_25763/*"ルビを含むテキストにも[#置換:ちかん]できますよ"*/);
    byte_4D329F3 = 1;
  }
  ...
  ScriptReplaceString__SetString(1, (System_String_o *)StringLiteral_15917/*"[#[FF0000]主[-]人公:しゅじんこう]はぐだぐだな主人公"*/, size);
  ScriptReplaceString__SetString_45578704(5, (System_String_o *)StringLiteral_25763/*"ルビを含むテキストにも[#置換:ちかん]できますよ"*/, v6);
  ScriptReplaceString_TypeInfo->static_fields->playerGenderIndex = 1;
}
...
void ScriptReplaceString__SetString(int32_t index, System_String_o *str, const MethodInfo *method)
{
  ...
  if ( !ScriptReplaceString_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(ScriptReplaceString_TypeInfo);
  ScriptReplaceString__SetString_45578704(index, str, method);
}


void ScriptReplaceString__SetString_45578704(int32_t num, System_String_o *str, const MethodInfo *method)
{
...
LABEL_27:
  ...
  while ( 1 )
  {
    ...
    else
    {
      ...
      sub_1C93A78((GrandQuestFolderBoardItem_o *)(v20 + 4), (int32_t)v6, v7, v8, v9, v10, v11, v12);
    }
    v13 = ScriptReplaceString_TypeInfo;
  }
  ...
  else
  {
    ...
    sub_1C93A78((GrandQuestFolderBoardItem_o *)(v24 + 4), (int32_t)v14, v7, v8, v9, v10, v11, v12);
  }
}