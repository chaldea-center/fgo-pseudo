void __fastcall ScriptReplaceString___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB79BE & 1) == 0 )
  {
    ...
    sub_1BAB41C(&ScriptReplaceString_TypeInfo, v3);
    byte_4AB79BE = 1;
  }
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)ScriptReplaceString_TypeInfo->static_fields, (int32_t)v4, v5, v6);
...
int32_t __fastcall ScriptReplaceString__GetPlayerGenderIndex(const MethodInfo *method)
{
  ...
  if ( (byte_4AB79BD & 1) == 0 )
  {
    sub_1BAB41C(&ScriptReplaceString_TypeInfo, v1);
    byte_4AB79BD = 1;
  }
...
void __fastcall ScriptReplaceString__Init(const MethodInfo *method)
{
  ...
  if ( (byte_4AB79B8 & 1) == 0 )
  {
    sub_1BAB41C(&Method_System_Collections_Generic_List_string__Clear__, v1);
    sub_1BAB41C(&ScriptReplaceString_TypeInfo, v2);
    sub_1BAB41C(&StringLiteral_15855/*"[#[FF0000]主[-]人公:しゅじんこう]はぐだぐだな主人公"*/, v3);
    sub_1BAB41C(&StringLiteral_25366/*"ルビを含むテキストにも[#置換:ちかん]できますよ"*/, v4);
    byte_4AB79B8 = 1;
  }
  ...
  ScriptReplaceString__SetString(1, (System_String_o *)StringLiteral_15855/*"[#[FF0000]主[-]人公:しゅじんこう]はぐだぐだな主人公"*/, size);
  ScriptReplaceString__SetString_42107936(5, (System_String_o *)StringLiteral_25366/*"ルビを含むテキストにも[#置換:ちかん]できますよ"*/, v9);
  ScriptReplaceString_TypeInfo->static_fields->playerGenderIndex = 1;
}
...
void __fastcall ScriptReplaceString__SetPlayerGenderIndex(int32_t index, const MethodInfo *method)
{
  ...
  if ( (byte_4AB79BC & 1) == 0 )
  {
    sub_1BAB41C(&ScriptReplaceString_TypeInfo, method);
    byte_4AB79BC = 1;
  }
...
void __fastcall ScriptReplaceString__SetString(int32_t index, System_String_o *str, const MethodInfo *method)
{
  if ( (byte_4AB79B9 & 1) == 0 )
  {
    sub_1BAB41C(&ScriptReplaceString_TypeInfo, str);
    byte_4AB79B9 = 1;
  }
  if ( !ScriptReplaceString_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(ScriptReplaceString_TypeInfo);
  ScriptReplaceString__SetString_42107936(index, str, method);
}


void __fastcall ScriptReplaceString__SetString_42107936(int32_t num, System_String_o *str, const MethodInfo *method)
{
  __int64 v5; // x1
  __int64 v6; // x1
  __int64 v7; // x1
  ...
  if ( (byte_4AB79BA & 1) == 0 )
  {
    sub_1BAB41C(&Method_System_Collections_Generic_List_string__Add__, str);
    sub_1BAB41C(&Method_System_Collections_Generic_List_string__get_Count__, v5);
    sub_1BAB41C(&Method_System_Collections_Generic_List_string__set_Item__, v6);
    sub_1BAB41C(&ScriptMessageLabel_TypeInfo, v7);
    sub_1BAB41C(&ScriptReplaceString_TypeInfo, v8);
...
LABEL_27:
  ...
  while ( 1 )
  {
    ...
    else
    {
      ...
      sub_1BAB3C0((ServantStatusBattleListViewItem_o *)(v21 + 4), (int32_t)v11, v12, v13);
    }
    v14 = ScriptReplaceString_TypeInfo;
  }
  ...
  else
  {
    ...
    sub_1BAB3C0((ServantStatusBattleListViewItem_o *)(v25 + 4), (int32_t)v15, v12, v13);
  }
}