void __fastcall ScriptReplaceString___cctor(const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)ScriptReplaceString_TypeInfo->static_fields, (int32_t)v1, v2, v3);
...
void __fastcall ScriptReplaceString__Init(const MethodInfo *method)
{
  ...
  if ( (byte_4A5CDB9 & 1) == 0 )
  {
    ...
    sub_1B885B0(&ScriptReplaceString_TypeInfo);
    sub_1B885B0(&StringLiteral_15825/*"[#[FF0000]主[-]人公:しゅじんこう]はぐだぐだな主人公"*/);
    sub_1B885B0(&StringLiteral_25323/*"ルビを含むテキストにも[#置換:ちかん]できますよ"*/);
    byte_4A5CDB9 = 1;
  }
  ...
  ScriptReplaceString__SetString(1, (System_String_o *)StringLiteral_15825/*"[#[FF0000]主[-]人公:しゅじんこう]はぐだぐだな主人公"*/, size);
  ScriptReplaceString__SetString_41706576(5, (System_String_o *)StringLiteral_25323/*"ルビを含むテキストにも[#置換:ちかん]できますよ"*/, v6);
  ScriptReplaceString_TypeInfo->static_fields->playerGenderIndex = 1;
}
...
void __fastcall ScriptReplaceString__SetString(int32_t index, System_String_o *str, const MethodInfo *method)
{
  ...
  if ( !ScriptReplaceString_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(ScriptReplaceString_TypeInfo);
  ScriptReplaceString__SetString_41706576(index, str, method);
}


void __fastcall ScriptReplaceString__SetString_41706576(int32_t num, System_String_o *str, const MethodInfo *method)
{
...
LABEL_27:
  ...
  while ( 1 )
  {
    ...
    else
    {
      ...
      sub_1B88554((ServantStatusBattleListViewItem_o *)(v16 + 4), (int32_t)v6, v7, v8);
    }
    v9 = ScriptReplaceString_TypeInfo;
  }
  ...
  else
  {
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)(v20 + 4), (int32_t)v10, v7, v8);
  }
}