...
void __fastcall ScriptReplaceString__Init(const MethodInfo *method)
{
  ...
  if ( (byte_42B5B0F & 1) == 0 )
  {
    ...
    sub_B52984(&ScriptReplaceString_TypeInfo);
    sub_B52984(&StringLiteral_15743/*"[#[FF0000]主[-]人公:しゅじんこう]はぐだぐだな主人公"*/);
    sub_B52984(&StringLiteral_24038/*"ルビを含むテキストにも[#置換:ちかん]できますよ"*/);
    byte_42B5B0F = 1;
  }
  ...
  ScriptReplaceString__SetString(1, (System_String_o *)StringLiteral_15743/*"[#[FF0000]主[-]人公:しゅじんこう]はぐだぐだな主人公"*/, v4);
  ScriptReplaceString__SetString_34841636(5, (System_String_o *)StringLiteral_24038/*"ルビを含むテキストにも[#置換:ちかん]できますよ"*/, v5);
  ScriptReplaceString_TypeInfo->static_fields->playerGenderIndex = 1;
}
...
void __fastcall ScriptReplaceString__SetString(int32_t index, System_String_o *str, const MethodInfo *method)
{
  ...
  ScriptReplaceString__SetString_34841636(index, str, method);
}


void __fastcall ScriptReplaceString__SetString_34841636(int32_t num, System_String_o *str, const MethodInfo *method)
{
  __int64 v5; // x1
