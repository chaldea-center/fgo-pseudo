void __fastcall ScriptReplaceString___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B468F1 & 1) == 0 )
  {
    ...
    sub_1BDB878(&ScriptReplaceString_TypeInfo, v3);
    byte_4B468F1 = 1;
  }
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)ScriptReplaceString_TypeInfo->static_fields, (int32_t)v4, v5, v6);
...
int32_t __fastcall ScriptReplaceString__GetPlayerGenderIndex(const MethodInfo *method)
{
  ...
  if ( (byte_4B468F0 & 1) == 0 )
  {
    sub_1BDB878(&ScriptReplaceString_TypeInfo, v1);
    byte_4B468F0 = 1;
  }
...
System_String_o *__fastcall ScriptReplaceString__GetString(int32_t num, const MethodInfo *method)
{
  ...
  if ( (byte_4B468EE & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Collections_Generic_List_string__get_Item__, method);
    sub_1BDB878(&ScriptReplaceString_TypeInfo, v3);
    byte_4B468EE = 1;
  }
...
void __fastcall ScriptReplaceString__Init(const MethodInfo *method)
{
  ...
  if ( (byte_4B468EB & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Collections_Generic_List_string__Clear__, v1);
    sub_1BDB878(&ScriptReplaceString_TypeInfo, v2);
    sub_1BDB878(&StringLiteral_15795/*"[#[FF0000]主[-]人公:しゅじんこう]はぐだぐだな主人公"*/, v3);
    sub_1BDB878(&StringLiteral_25522/*"ルビを含むテキストにも[#置換:ちかん]できますよ"*/, v4);
    byte_4B468EB = 1;
  }
  ...
  ScriptReplaceString__SetString(1, (System_String_o *)StringLiteral_15795/*"[#[FF0000]主[-]人公:しゅじんこう]はぐだぐだな主人公"*/, size);
  ScriptReplaceString__SetString_43698508(5, (System_String_o *)StringLiteral_25522/*"ルビを含むテキストにも[#置換:ちかん]できますよ"*/, v9);
  ScriptReplaceString_TypeInfo->static_fields->playerGenderIndex = 1;
}
...
void __fastcall ScriptReplaceString__SetPlayerGenderIndex(int32_t index, const MethodInfo *method)
{
  ...
  if ( (byte_4B468EF & 1) == 0 )
  {
    sub_1BDB878(&ScriptReplaceString_TypeInfo, method);
    byte_4B468EF = 1;
  }
...
void __fastcall ScriptReplaceString__SetString(int32_t index, System_String_o *str, const MethodInfo *method)
{
  if ( (byte_4B468EC & 1) == 0 )
  {
    sub_1BDB878(&ScriptReplaceString_TypeInfo, str);
    byte_4B468EC = 1;
  }
  if ( !ScriptReplaceString_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(ScriptReplaceString_TypeInfo);
  ScriptReplaceString__SetString_43698508(index, str, method);
}


void __fastcall ScriptReplaceString__SetString_43698508(int32_t num, System_String_o *str, const MethodInfo *method)
{
  __int64 v5; // x1
  __int64 v6; // x1
  __int64 v7; // x1
  ...
  if ( (byte_4B468ED & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Collections_Generic_List_string__Add__, str);
    sub_1BDB878(&Method_System_Collections_Generic_List_string__get_Count__, v5);
    sub_1BDB878(&Method_System_Collections_Generic_List_string__set_Item__, v6);
    sub_1BDB878(&ScriptMessageLabel_TypeInfo, v7);
    sub_1BDB878(&ScriptReplaceString_TypeInfo, v8);
...
LABEL_27:
  ...
  while ( 1 )
  {
    ...
    else
    {
      ...
      sub_1BDB81C((CGThumbnailListItem_o *)(v21 + 4), (int32_t)v11, v12, v13);
    }
    v14 = ScriptReplaceString_TypeInfo;
  }
  ...
  else
  {
    ...
    sub_1BDB81C((CGThumbnailListItem_o *)(v25 + 4), (int32_t)v15, v12, v13);
  }
}