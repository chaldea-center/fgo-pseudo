void __fastcall AiFieldMaster___ctor(AiFieldMaster_o *this, const MethodInfo *method)
{
  if ( (byte_49FE144 & 1) == 0 )
  {
    sub_1B64870(&Method_DataMasterBase_AiFieldMaster__AiFieldEntity__string___ctor__, method);
    byte_49FE144 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    181,
    (const MethodInfo_30D6498 *)Method_DataMasterBase_AiFieldMaster__AiFieldEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE142 & 1) == 0 )
  {
    sub_1B64870(&Method_DataMasterBase_AiFieldMaster__AiFieldEntity__string__GetEntity__, *(_QWORD *)&id);
    byte_49FE142 = 1;
  }
  ...
  return (AiFieldEntity_o *)DataMasterBase_object__object__object___GetEntity(
                              (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                              PK,
                              (const MethodInfo_30D64D8 *)Method_DataMasterBase_AiFieldMaster__AiFieldEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE143 & 1) == 0 )
  {
    sub_1B64870(&Method_DataMasterBase_AiFieldMaster__AiFieldEntity__string__TryGetEntity__, entity);
    byte_49FE143 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_30D6528 *)Method_DataMasterBase_AiFieldMaster__AiFieldEntity__string__TryGetEntity__);
}
...
AiFieldEntity_array *__fastcall AiFieldMaster__getListFormGroupId(int32_t id, const MethodInfo *method)
{
  ...
  if ( (byte_49FE145 & 1) == 0 )
  {
    sub_1B64870(&AiFieldEntity_TypeInfo, method);
    sub_1B64870(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__GetEnumerator__, v3);
    sub_1B64870(&Method_DataManager_GetMasterData_AiFieldMaster___, v4);
    ...
    sub_1B64870(&Method_System_Collections_Generic_List_AiFieldEntity__Add__, v8);
    sub_1B64870(&Method_System_Collections_Generic_List_AiFieldEntity__ToArray__, v9);
    sub_1B64870(&Method_System_Collections_Generic_List_AiFieldEntity___ctor__, v10);
    sub_1B64870(&System_Collections_Generic_List_AiFieldEntity__TypeInfo, v11);
    sub_1B64870(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v12);
    byte_49FE145 = 1;
  }
  v13 = (System_Collections_Generic_List_object__o *)sub_1B64ABC(System_Collections_Generic_List_AiFieldEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v13,
    (const MethodInfo_34AF17C *)Method_System_Collections_Generic_List_AiFieldEntity___ctor__);
  ...
  Instance = DataManager__GetMasterData_object_(
               ...
               (const MethodInfo_2E3B6C8 *)Method_DataManager_GetMasterData_AiFieldMaster___);
  if ( !Instance )
    goto LABEL_41;
...
LABEL_38:
    ...
    {
      if ( !v13 )
        sub_1B64ACC(v26, AiFieldEntity_TypeInfo);
...
LABEL_41:
  ...
  return (AiFieldEntity_array *)System_Collections_Generic_List_object___ToArray(
                                  v13,
                                  (const MethodInfo_34B15A8 *)Method_System_Collections_Generic_List_AiFieldEntity__ToArray__);
}