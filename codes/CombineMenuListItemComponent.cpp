        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCB358 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_3735/*"COMBINE_PREPARATION"*/, v3);
    sub_1C1ABD4(&StringLiteral_440/*"#6B6B6B"*/, v4);
    sub_1C1ABD4(&StringLiteral_447/*"#E1C896"*/, v5);
    sub_1C1ABD4(&StringLiteral_445/*"#B7A37B"*/, v6);
    byte_4BCB358 = 1;
  }
  ...
  *(_QWORD *)&v14.fields.b = 0LL;
  ...
  v8 = LocalizationManager__Get((System_String_o *)StringLiteral_3735/*"COMBINE_PREPARATION"*/, 0LL);
  if ( !preparationLabel )
    goto LABEL_10;
        ...
        const MethodInfo *method)
{
  ...
  if ( !disableMessageLabel )
    sub_1C1AE30(0LL, disableMessage);
        ...
        const MethodInfo *method)
{
  ...
  if ( !preparationLabel
    ...
    || (preparationLabel = (UnityEngine_Component_o *)UnityEngine_Component__get_gameObject(preparationLabel, 0LL)) == 0LL )
  {
    sub_1C1AE30(preparationLabel, isActive);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)preparationLabel, isActive, 0LL);
}
