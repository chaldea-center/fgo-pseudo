        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C258E7 & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_3732/*"CONFIRM_TITLE_SVTEQ_COMBINE"*/, v3);
    sub_1C3B764(&StringLiteral_419/*"#E60000"*/, v4);
    sub_1C3B764(&StringLiteral_426/*"#PCDATA"*/, v5);
    sub_1C3B764(&StringLiteral_424/*"#FFFF00"*/, v6);
    byte_4C258E7 = 1;
  }
  ...
  *(_QWORD *)&v14.fields.b = 0LL;
  ...
  v8 = LocalizationManager__Get((System_String_o *)StringLiteral_3732/*"CONFIRM_TITLE_SVTEQ_COMBINE"*/, 0LL);
  if ( !preparationLabel )
    goto LABEL_10;
  UILabel__set_text(preparationLabel, v8, 0LL);
  UnityEngine_ColorUtility__TryParseHtmlString((System_String_o *)StringLiteral_426/*"#PCDATA"*/, &color, 0LL);
  UnityEngine_ColorUtility__TryParseHtmlString((System_String_o *)StringLiteral_424/*"#FFFF00"*/, &v14, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( !disableMessageLabel )
    sub_1C3B9C0(0LL, disableMessage);
        ...
        const MethodInfo *method)
{
  ...
  if ( !preparationLabel
    ...
    || (preparationLabel = (UnityEngine_Component_o *)UnityEngine_Component__get_gameObject(preparationLabel, 0LL)) == 0LL )
  {
    sub_1C3B9C0(preparationLabel, isActive);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)preparationLabel, isActive, 0LL);
}
