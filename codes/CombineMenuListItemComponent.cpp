        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BE824 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_3590/*"COMBINE_PREPARATION"*/, v3);
    sub_1B4CF90(&StringLiteral_411/*"#6B6B6B"*/, v4);
    sub_1B4CF90(&StringLiteral_418/*"#E1C896"*/, v5);
    sub_1B4CF90(&StringLiteral_416/*"#B7A37B"*/, v6);
    byte_49BE824 = 1;
  }
  ...
  *(_QWORD *)&v14.fields.b = 0LL;
  ...
  v8 = LocalizationManager__Get((System_String_o *)StringLiteral_3590/*"COMBINE_PREPARATION"*/, 0LL);
  if ( !preparationLabel )
    goto LABEL_10;
        ...
        const MethodInfo *method)
{
  ...
  if ( !disableMessageLabel )
    sub_1B4D1EC(0LL, disableMessage);
        ...
        const MethodInfo *method)
{
  ...
  if ( !preparationLabel
    ...
    || (preparationLabel = (UnityEngine_Component_o *)UnityEngine_Component__get_gameObject(preparationLabel, 0LL)) == 0LL )
  {
    sub_1B4D1EC(preparationLabel, isActive);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)preparationLabel, isActive, 0LL);
}
