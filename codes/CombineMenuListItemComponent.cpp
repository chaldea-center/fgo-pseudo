        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01B8D & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_3666/*"COMBINE_PREPARATION"*/, v3);
    sub_1B64870(&StringLiteral_444/*"#6B6B6B"*/, v4);
    sub_1B64870(&StringLiteral_451/*"#E1C896"*/, v5);
    sub_1B64870(&StringLiteral_449/*"#B7A37B"*/, v6);
    byte_4A01B8D = 1;
  }
  ...
  *(_QWORD *)&v14.fields.b = 0LL;
  ...
  v8 = LocalizationManager__Get((System_String_o *)StringLiteral_3666/*"COMBINE_PREPARATION"*/, 0LL);
  if ( !preparationLabel )
    goto LABEL_10;
  ...
  UnityEngine_ColorUtility__TryParseHtmlString((System_String_o *)StringLiteral_449/*"#B7A37B"*/, &v14, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( !disableMessageLabel )
    sub_1B64ACC(0LL, disableMessage);
        ...
        const MethodInfo *method)
{
  ...
  if ( !preparationLabel
    ...
    || (preparationLabel = (UnityEngine_Component_o *)UnityEngine_Component__get_gameObject(preparationLabel, 0LL)) == 0LL )
  {
    sub_1B64ACC(preparationLabel, isActive);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)preparationLabel, isActive, 0LL);
}
