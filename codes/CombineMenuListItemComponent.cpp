        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A51F1F & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_3609/*"COMBINE_PREPARATION"*/, v3);
    sub_1B863B8(&StringLiteral_411/*"#6B6B6B"*/, v4);
    sub_1B863B8(&StringLiteral_418/*"#E1C896"*/, v5);
    sub_1B863B8(&StringLiteral_416/*"#B7A37B"*/, v6);
    byte_4A51F1F = 1;
  }
  ...
  *(_QWORD *)&v14.fields.b = 0LL;
  ...
  v8 = LocalizationManager__Get((System_String_o *)StringLiteral_3609/*"COMBINE_PREPARATION"*/, 0LL);
  if ( !preparationLabel )
    goto LABEL_10;
        ...
        const MethodInfo *method)
{
  ...
  if ( !disableMessageLabel )
    sub_1B86614(0LL, disableMessage);
        ...
        const MethodInfo *method)
{
  ...
  if ( !preparationLabel
    ...
    || (preparationLabel = (UnityEngine_Component_o *)UnityEngine_Component__get_gameObject(preparationLabel, 0LL)) == 0LL )
  {
    sub_1B86614(preparationLabel, isActive);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)preparationLabel, isActive, 0LL);
}
