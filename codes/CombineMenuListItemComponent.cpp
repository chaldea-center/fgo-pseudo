        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C010B9 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&StringLiteral_3732/*"COMBINE_PREPARATION"*/, v3);
    sub_1C2E12C(&StringLiteral_419/*"#6B6B6B"*/, v4);
    sub_1C2E12C(&StringLiteral_426/*"#E1C896"*/, v5);
    sub_1C2E12C(&StringLiteral_424/*"#B7A37B"*/, v6);
    byte_4C010B9 = 1;
  }
  ...
  *(_QWORD *)&v14.fields.b = 0LL;
  ...
  v8 = LocalizationManager__Get((System_String_o *)StringLiteral_3732/*"COMBINE_PREPARATION"*/, 0LL);
  if ( !preparationLabel )
    goto LABEL_10;
  UILabel__set_text(preparationLabel, v8, 0LL);
  UnityEngine_ColorUtility__TryParseHtmlString((System_String_o *)StringLiteral_426/*"#E1C896"*/, &color, 0LL);
  UnityEngine_ColorUtility__TryParseHtmlString((System_String_o *)StringLiteral_424/*"#B7A37B"*/, &v14, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( !disableMessageLabel )
    sub_1C2E388(0LL, disableMessage);
        ...
        const MethodInfo *method)
{
  ...
  if ( !preparationLabel
    ...
    || (preparationLabel = (UnityEngine_Component_o *)UnityEngine_Component__get_gameObject(preparationLabel, 0LL)) == 0LL )
  {
    sub_1C2E388(preparationLabel, isActive);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)preparationLabel, isActive, 0LL);
}
