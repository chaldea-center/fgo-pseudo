        ...
        const MethodInfo *method)
{
  ...
  unsigned __int128 v12; // [xsp+0h] [xbp-60h] BYREF
  UnityEngine_Color_o v13; // [xsp+10h] [xbp-50h] BYREF
  UnityEngine_Color_o color; // [xsp+20h] [xbp-40h] BYREF

  if ( (byte_49FFA8D & 1) == 0 )
  {
    sub_1B640C8(&LocalizationManager_TypeInfo, method);
    sub_1B640C8(&StringLiteral_3667/*"COMBINE_PREPARATION"*/, v3);
    sub_1B640C8(&StringLiteral_444/*"#6B6B6B"*/, v4);
    sub_1B640C8(&StringLiteral_451/*"#E1C896"*/, v5);
    sub_1B640C8(&StringLiteral_449/*"#B7A37B"*/, v6);
    byte_49FFA8D = 1;
  }
  ...
  *(_QWORD *)&v13.fields.b = 0LL;
  ...
  v8 = LocalizationManager__Get((System_String_o *)StringLiteral_3667/*"COMBINE_PREPARATION"*/, 0LL);
  if ( !preparationLabel )
    goto LABEL_10;
  UILabel__set_text(preparationLabel, v8, 0LL);
  UnityEngine_ColorUtility__TryParseHtmlString((System_String_o *)StringLiteral_451/*"#E1C896"*/, &color, 0LL);
  UnityEngine_ColorUtility__TryParseHtmlString((System_String_o *)StringLiteral_449/*"#B7A37B"*/, &v13, 0LL);
