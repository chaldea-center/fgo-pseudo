        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48602 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_3644/*"COMBINE_PREPARATION"*/, v3);
    sub_1BDB878(&StringLiteral_412/*"#6B6B6B"*/, v4);
    sub_1BDB878(&StringLiteral_420/*"#E1C896"*/, v5);
    sub_1BDB878(&StringLiteral_418/*"#B7A37B"*/, v6);
    byte_4B48602 = 1;
  }
  ...
  *(_QWORD *)&v14.fields.b = 0LL;
  ...
  v8 = LocalizationManager__Get((System_String_o *)StringLiteral_3644/*"COMBINE_PREPARATION"*/, 0LL);
  if ( !preparationLabel )
    goto LABEL_10;
  UILabel__set_text(preparationLabel, v8, 0LL);
  UnityEngine_ColorUtility__TryParseHtmlString((System_String_o *)StringLiteral_420/*"#E1C896"*/, &color, 0LL);
  UnityEngine_ColorUtility__TryParseHtmlString((System_String_o *)StringLiteral_418/*"#B7A37B"*/, &v14, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( !disableMessageLabel )
    sub_1BDBAD4(0LL, disableMessage);
        ...
        const MethodInfo *method)
{
  ...
  if ( !preparationLabel
    ...
    || (preparationLabel = (UnityEngine_Component_o *)UnityEngine_Component__get_gameObject(preparationLabel, 0LL)) == 0LL )
  {
    sub_1BDBAD4(preparationLabel, isActive);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)preparationLabel, isActive, 0LL);
}
