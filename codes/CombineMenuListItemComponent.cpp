        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B2C50 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_3228/*"COMBINE_PREPARATION"*/);
    sub_B52984(&StringLiteral_361/*"#6B6B6B"*/);
    sub_B52984(&StringLiteral_366/*"#E1C896"*/);
    sub_B52984(&StringLiteral_364/*"#B7A37B"*/);
    byte_42B2C50 = 1;
  }
  ...
  *(_QWORD *)&v10.fields.r = 0LL;
  ...
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_3228/*"COMBINE_PREPARATION"*/, 0LL);
  if ( !preparationLabel )
    goto LABEL_11;
  UILabel__set_text(preparationLabel, v4, 0LL);
  UnityEngine_ColorUtility__TryParseHtmlString((System_String_o *)StringLiteral_366/*"#E1C896"*/, &color, 0LL);
  UnityEngine_ColorUtility__TryParseHtmlString((System_String_o *)StringLiteral_364/*"#B7A37B"*/, &v10, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( !preparationLabel
    ...
    || (preparationLabel = (UnityEngine_Component_o *)UnityEngine_Component__get_gameObject(preparationLabel, 0LL)) == 0LL )
  {
    sub_B52A5C(preparationLabel, isActive);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)preparationLabel, isActive, 0LL);
}
