        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0B877 & 1) == 0 )
  {
    sub_1B686D4(&BattleLogicTask___TypeInfo, creator);
    byte_4A0B877 = 1;
  }
  ...
  if ( ((unsigned __int8)logicNpcAi & 1) == 0 )
    return (BattleLogicTask_array *)sub_1B6877C(BattleLogicTask___TypeInfo, 0LL);
  if ( !logic || !creator || (logicNpcAi = logic->fields.logicNpcAi) == 0LL )
    sub_1B68930(logicNpcAi, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0B878 & 1) == 0 )
  {
    sub_1B686D4(&Method_BasicHelper_Any_AiNpcBattleServantData___, creator);
    sub_1B686D4(&System_Func_AiNpcBattleServantData__bool__TypeInfo, v8);
    sub_1B686D4(&Method_ReactTaskTargetNpc___c__DisplayClass1_0__ExistTargetPriority_b__0__, v9);
    sub_1B686D4(&ReactTaskTargetNpc___c__DisplayClass1_0_TypeInfo, v10);
    byte_4A0B878 = 1;
  }
  v11 = sub_1B68920(ReactTaskTargetNpc___c__DisplayClass1_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v11, 0LL);
  if ( !v11
    || (*(_QWORD *)(v11 + 16) = creator,
        sub_1B68678((ServantStatusBattleListViewItem_o *)(v11 + 16), (int32_t)creator, v14, v15),
        *(_QWORD *)(v11 + 24) = logic,
        sub_1B68678((ServantStatusBattleListViewItem_o *)(v11 + 24), (int32_t)logic, v16, v17),
        v18 = *(_QWORD *)(v11 + 24),
  ...
  v21 = (System_Func_object__bool__o *)sub_1B68920(System_Func_AiNpcBattleServantData__bool__TypeInfo);
  ...
  return BasicHelper__Any_object_(
           ...
           (const MethodInfo_2E35150 *)Method_BasicHelper_Any_AiNpcBattleServantData___);
}
