        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2A3EB & 1) == 0 )
  {
    sub_1C2D490(&Method_BasicHelper_Any_AiNpcBattleServantData___);
    sub_1C2D490(&System_Func_AiNpcBattleServantData__bool__TypeInfo);
    sub_1C2D490(&Method_ReactTaskTargetNpc___c__DisplayClass1_0__ExistTargetPriority_b__0__);
    sub_1C2D490(&ReactTaskTargetNpc___c__DisplayClass1_0_TypeInfo);
    byte_4C2A3EB = 1;
  }
  v8 = sub_1C2D6DC(ReactTaskTargetNpc___c__DisplayClass1_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v8, 0);
  if ( !v8
    || (*(_QWORD *)(v8 + 16) = creator,
        sub_1C2D434((CGThumbnailListItem_o *)(v8 + 16), (int32_t)creator, v11, v12),
        *(_QWORD *)(v8 + 24) = logic,
        sub_1C2D434((CGThumbnailListItem_o *)(v8 + 24), (int32_t)logic, v13, v14),
        v15 = *(_QWORD *)(v8 + 24),
  ...
  v18 = (System_Func_object__bool__o *)sub_1C2D6DC(System_Func_AiNpcBattleServantData__bool__TypeInfo);
  ...
  return BasicHelper__Any_object_(
           ...
           (const MethodInfo_30B7CF0 *)Method_BasicHelper_Any_AiNpcBattleServantData___);
}
