        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05006 & 1) == 0 )
  {
    sub_1BC3008(&BattleLogicTask___TypeInfo, creator);
    byte_4B05006 = 1;
  }
  ...
  if ( ((unsigned __int8)logicNpcAi & 1) == 0 )
    return (BattleLogicTask_array *)sub_1BC30B0(BattleLogicTask___TypeInfo, 0LL);
  if ( !logic || !creator || (logicNpcAi = logic->fields.logicNpcAi) == 0LL )
    sub_1BC3264(logicNpcAi, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05007 & 1) == 0 )
  {
    sub_1BC3008(&Method_BasicHelper_Any_AiNpcBattleServantData___, creator);
    sub_1BC3008(&System_Func_AiNpcBattleServantData__bool__TypeInfo, v8);
    sub_1BC3008(&Method_ReactTaskTargetNpc___c__DisplayClass1_0__ExistTargetPriority_b__0__, v9);
    sub_1BC3008(&ReactTaskTargetNpc___c__DisplayClass1_0_TypeInfo, v10);
    byte_4B05007 = 1;
  }
  v11 = sub_1BC3254(ReactTaskTargetNpc___c__DisplayClass1_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v11, 0LL);
  if ( !v11
    || (*(_QWORD *)(v11 + 16) = creator,
        sub_1BC2FAC((CGThumbnailListItem_o *)(v11 + 16), (int32_t)creator, v14, v15),
        *(_QWORD *)(v11 + 24) = logic,
        sub_1BC2FAC((CGThumbnailListItem_o *)(v11 + 24), (int32_t)logic, v16, v17),
        v18 = *(_QWORD *)(v11 + 24),
  ...
  v21 = (System_Func_object__bool__o *)sub_1BC3254(System_Func_AiNpcBattleServantData__bool__TypeInfo);
  ...
  return BasicHelper__Any_object_(
           ...
           (const MethodInfo_2FEB2DC *)Method_BasicHelper_Any_AiNpcBattleServantData___);
}
