void __fastcall EventInfoChronologyButton___ctor(EventInfoChronologyButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2EA29 & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_17961/*"chronology_button"*/, method);
    sub_1B761C0(&StringLiteral_14461/*"TitleInfoChronologyDialogPrefab"*/, v5);
    byte_4A2EA29 = 1;
  }
  *(_QWORD *)&this->fields.defaultPosY = 0xC3310000C2D20000LL;
  v6 = StringLiteral_17961/*"chronology_button"*/;
  this->fields.buttonSpriteName = (struct System_String_o *)StringLiteral_17961/*"chronology_button"*/;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.buttonSpriteName, v6, v2, v3);
  v7 = StringLiteral_14461/*"TitleInfoChronologyDialogPrefab"*/;
  this->fields.dialogChronologyAssetName = (struct System_String_o *)StringLiteral_14461/*"TitleInfoChronologyDialogPrefab"*/;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.dialogChronologyAssetName, v7, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EA28 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_UnityEngine_GameObject_GetComponent_EventInfoChronologyDialog___, v5);
  ...
  if ( assetData )
  {
    ...
    Component_object = UnityEngine_GameObject__GetComponent_object_(
                         mInstance,
                         (const MethodInfo_2EB19B8 *)Method_UnityEngine_GameObject_GetComponent_EventInfoChronologyDialog___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EA25 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_EventInfoChronologyButton_CallbackLoadAsset__, v7);
    sub_1B761C0(&Method_EventInfoChronologyButton__Initialization_b__12_0__, v8);
    ...
    sub_1B761C0(&StringLiteral_3470/*"CHRONOLOGY_OPEN_BUTTON"*/, v12);
    sub_1B761C0(&StringLiteral_13585/*"Terminal/Info"*/, v13);
    byte_4A2EA25 = 1;
  }
  ...
  if ( ((unsigned __int8)button & 1) != 0 )
  {
    ...
    if ( System_String__IsNullOrEmpty(v17->fields.mText, 0LL) )
    {
      ...
      button = LocalizationManager__Get((System_String_o *)StringLiteral_3470/*"CHRONOLOGY_OPEN_BUTTON"*/, 0LL);
      if ( !v18 )
LABEL_21:
        sub_1B7641C(button, v16);
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.eventUiEntity, (int32_t)entity, v21, v22);
  ...
  else
  {
    ...
    AssetManager__loadAssetStorage((System_String_o *)StringLiteral_13585/*"Terminal/Info"*/, v25, 1, 0LL);
  }
...
void __fastcall EventInfoChronologyButton__OnClickOpen(EventInfoChronologyButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2EA24 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_EventInfoChronologyButton_OnClickOpen__, v3);
    sub_1B761C0(&UnityEngine_Object_TypeInfo, v4);
    sub_1B761C0(&Method_EventInfoChronologyButton___c__OnClickOpen_b__11_0__, v5);
    sub_1B761C0(&EventInfoChronologyButton___c_TypeInfo, v6);
    byte_4A2EA24 = 1;
  }
  ...
  if ( ((unsigned __int8)v8 & 1) != 0 )
  {
    ...
    if ( (unsigned int)(v10->fields.state - 1) >= 2 )
    {
      ...
      if ( (*((_BYTE *)Method_EventInfoChronologyButton_OnClickOpen__ + 83) & 2) != 0 )
        v11 = (_QWORD *)sub_1B761D8(Method_EventInfoChronologyButton_OnClickOpen__);
      ...
      if ( !_9__11_0 )
      {
        ...
        _9__11_0 = (System_Action_o *)sub_1B7640C(System_Action_TypeInfo);
        ...
        sub_1B76164((ServantStatusBattleListViewItem_o *)&static_fields->__9__11_0, (int32_t)_9__11_0, v18, v19);
      }
      if ( v14 )
      {
...
void __fastcall EventInfoChronologyButton__ReleaseAsset(EventInfoChronologyButton_o *this, const MethodInfo *method)
{
  ...
  if ( eventUiEntity )
    EventInfoUIBase__ReleaseEventUIAssetData_42048108((EventInfoUIBase_o *)this, eventUiEntity, 0LL);
  ...
  if ( UnityEngine_Object__op_Inequality(v5, 0LL, 0LL) )
  {
    ...
    *p_dialogChronology = 0LL;
    sub_1B76164((ServantStatusBattleListViewItem_o *)p_dialogChronology, 0, v9, v10);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EA2A & 1) == 0 )
  {
    sub_1B761C0(&Method_UnityEngine_GameObject_GetComponent_EventInfoChronologyDialog___, method);
  ...
  if ( ((unsigned __int8)mInstance & 1) == 0 )
  {
    ...
    Component_object = UnityEngine_GameObject__GetComponent_object_(
                         ...
                         (const MethodInfo_2EB19B8 *)Method_UnityEngine_GameObject_GetComponent_EventInfoChronologyDialog___);
    this->fields.dialogChronology = (struct EventInfoChronologyDialog_o *)Component_object;
    sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.dialogChronology, (int32_t)Component_object, v9, v10);
    if ( !TerminalSceneComponent_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(TerminalSceneComponent_TypeInfo);
    if ( !byte_4A2915D )
    {
...
void __fastcall EventInfoChronologyButton___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A2EA2B & 1) == 0 )
  {
    sub_1B761C0(&EventInfoChronologyButton___c_TypeInfo, v1);
    byte_4A2EA2B = 1;
  }
  v2 = (Il2CppObject *)sub_1B7640C(EventInfoChronologyButton___c_TypeInfo);
