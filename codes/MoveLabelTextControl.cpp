void MoveLabelTextControl___ctor(MoveLabelTextControl_o *this, const MethodInfo *method)
{
  ...
  v3 = (System_Collections_Hashtable_o *)sub_1CE694C(System_Collections_Hashtable_TypeInfo);
  System_Collections_Hashtable___ctor_66485444(v3, 0);
  this->fields.table = v3;
  sub_1CE66A4(&this->fields.table, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFE8E6 & 1) == 0 )
  {
    ...
    sub_1CE6700(&iTween_LoopType_TypeInfo);
    ...
    sub_1CE6700(&StringLiteral_21691/*"looptype"*/);
    sub_1CE6700(&StringLiteral_21584/*"linear"*/);
    sub_1CE6700(&StringLiteral_21238/*"isLocal"*/);
    sub_1CE6700(&StringLiteral_22775/*"oncomplete"*/);
    this = (MoveLabelTextControl_o *)sub_1CE6700(&iTween_TypeInfo);
    byte_4DFE8E6 = 1;
  }
  if ( !targetLb )
    goto LABEL_28;
  ...
  this = (MoveLabelTextControl_o *)sub_1CE66A4(&v6->fields.targetLb, targetLb);
...
LABEL_28:
  ...
  ((void (__fastcall *)(struct System_Collections_Hashtable_o *, __int64, MoveLabelTextControl_o *, const MethodInfo *))v20->klass->vtable._22_Add.methodPtr)(
    v20,
    StringLiteral_21691/*"looptype"*/,
    this,
    v20->klass->vtable._22_Add.method);
  v21 = v6->fields.table;
  if ( !iTween_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(iTween_TypeInfo);
  iTween__MoveTo_64760392(v12, v21, 0);
}