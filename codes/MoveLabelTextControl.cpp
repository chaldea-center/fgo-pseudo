void MoveLabelTextControl___ctor(MoveLabelTextControl_o *this, const MethodInfo *method)
{
  ...
  v3 = (System_Collections_Hashtable_o *)sub_1C93D20(System_Collections_Hashtable_TypeInfo);
  System_Collections_Hashtable___ctor_65788340(v3, 0);
  this->fields.table = v3;
  sub_1C93A78(&this->fields.table, v3);
        ...
        const MethodInfo *method)
{
  ...
  struct System_Collections_Hashtable_o *v15; // x21
  ...
  if ( (byte_4D2A8C4 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&iTween_LoopType_TypeInfo);
    ...
    sub_1C93AD4(&StringLiteral_21620/*"looptype"*/);
    sub_1C93AD4(&StringLiteral_21513/*"linear"*/);
    sub_1C93AD4(&StringLiteral_21170/*"isLocal"*/);
    sub_1C93AD4(&StringLiteral_22702/*"oncomplete"*/);
    this = (MoveLabelTextControl_o *)sub_1C93AD4(&iTween_TypeInfo);
    byte_4D2A8C4 = 1;
  }
  if ( !targetLb )
    goto LABEL_28;
  ...
  this = (MoveLabelTextControl_o *)sub_1C93A78(&v6->fields.targetLb, targetLb);
  ...
  if ( !v15 )
    goto LABEL_28;
  ((void (__fastcall *)(struct System_Collections_Hashtable_o *, void *, MoveLabelTextControl_o *, const MethodInfo *))v15->klass->vtable._22_Add.methodPtr)(
    v15,
  ...
  if ( !v16 )
    goto LABEL_28;
  ((void (__fastcall *)(struct System_Collections_Hashtable_o *, __int64, MoveLabelTextControl_o *, const MethodInfo *))v16->klass->vtable._22_Add.methodPtr)(
    v16,
...
LABEL_28:
  ...
  ((void (__fastcall *)(struct System_Collections_Hashtable_o *, __int64, MoveLabelTextControl_o *, const MethodInfo *))v19->klass->vtable._22_Add.methodPtr)(
    v19,
    StringLiteral_21620/*"looptype"*/,
    this,
    v19->klass->vtable._22_Add.method);
  v20 = v6->fields.table;
  if ( !iTween_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(iTween_TypeInfo);
  iTween__MoveTo_64063288(v12, v20, 0);
}