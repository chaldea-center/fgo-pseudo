void MoveLabelTextControl___ctor(MoveLabelTextControl_o *this, const MethodInfo *method)
{
  ...
  v3 = (System_Collections_Hashtable_o *)sub_1D0F300(System_Collections_Hashtable_TypeInfo);
  System_Collections_Hashtable___ctor_66925388(v3, 0);
  this->fields.table = v3;
  sub_1D0F058(&this->fields.table, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E714DB & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&iTween_LoopType_TypeInfo);
    ...
    sub_1D0F0B4(&StringLiteral_21784/*"looptype"*/);
    sub_1D0F0B4(&StringLiteral_21677/*"linear"*/);
    sub_1D0F0B4(&StringLiteral_21329/*"isLocal"*/);
    sub_1D0F0B4(&StringLiteral_22868/*"oncomplete"*/);
    this = (MoveLabelTextControl_o *)sub_1D0F0B4(&iTween_TypeInfo);
    byte_4E714DB = 1;
  }
  if ( !targetLb )
    goto LABEL_28;
  ...
  this = (MoveLabelTextControl_o *)sub_1D0F058(&v6->fields.targetLb, targetLb);
...
LABEL_28:
  ...
  ((void (__fastcall *)(struct System_Collections_Hashtable_o *, __int64, MoveLabelTextControl_o *, const MethodInfo *))v20->klass->vtable._22_Add.methodPtr)(
    v20,
    StringLiteral_21784/*"looptype"*/,
    this,
    v20->klass->vtable._22_Add.method);
  v21 = v6->fields.table;
  if ( !iTween_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(iTween_TypeInfo);
  iTween__MoveTo_65200336(v12, v21, 0);
}