void MoveLabelTextControl___ctor(MoveLabelTextControl_o *this, const MethodInfo *method)
{
  ...
  v3 = (System_Collections_Hashtable_o *)sub_1C372A4(System_Collections_Hashtable_TypeInfo);
  System_Collections_Hashtable___ctor_64925884(v3, 0);
  this->fields.table = v3;
  sub_1C36FFC(&this->fields.table, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3D072 & 1) == 0 )
  {
    ...
    sub_1C37058(&iTween_LoopType_TypeInfo);
    ...
    sub_1C37058(&StringLiteral_21357/*"looptype"*/);
    sub_1C37058(&StringLiteral_21252/*"linear"*/);
    sub_1C37058(&StringLiteral_20930/*"isLocal"*/);
    sub_1C37058(&StringLiteral_22430/*"oncomplete"*/);
    this = (MoveLabelTextControl_o *)sub_1C37058(&iTween_TypeInfo);
    byte_4C3D072 = 1;
  }
  if ( !targetLb )
    goto LABEL_28;
  ...
  this = (MoveLabelTextControl_o *)sub_1C36FFC(&v6->fields.targetLb, targetLb);
...
LABEL_28:
  ...
  ((void (__fastcall *)(struct System_Collections_Hashtable_o *, __int64, MoveLabelTextControl_o *, const MethodInfo *))v44->klass->vtable._22_Add.methodPtr)(
    v44,
    StringLiteral_21357/*"looptype"*/,
    this,
    v44->klass->vtable._22_Add.method);
  v51 = v6->fields.table;
  if ( !iTween_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(iTween_TypeInfo);
  iTween__MoveTo_63199220(v12, v51, 0);
}