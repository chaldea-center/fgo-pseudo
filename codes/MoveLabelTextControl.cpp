        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B20629 & 1) == 0 )
  {
    sub_1BCAFF8(&bool_TypeInfo, parent);
    sub_1BCAFF8(&iTween_LoopType_TypeInfo, v7);
    ...
    sub_1BCAFF8(&StringLiteral_18397/*"delay"*/, v14);
    sub_1BCAFF8(&StringLiteral_21164/*"looptype"*/, v15);
    sub_1BCAFF8(&StringLiteral_21060/*"linear"*/, v16);
    sub_1BCAFF8(&StringLiteral_20742/*"isLocal"*/, v17);
    sub_1BCAFF8(&StringLiteral_22229/*"oncomplete"*/, v18);
    this = (MoveLabelTextControl_o *)sub_1BCAFF8(&iTween_TypeInfo, v19);
    byte_4B20629 = 1;
  }
  if ( !targetLb )
    goto LABEL_28;
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&v6->fields.targetLb, (int32_t)targetLb, v21, v22);
...
LABEL_28:
  ...
  ((void (__fastcall *)(struct System_Collections_Hashtable_o *, __int64, MoveLabelTextControl_o *, Il2CppMethodPointer))v47->klass->vtable._22_Add.method)(
    v47,
    StringLiteral_21164/*"looptype"*/,
    this,
    v47->klass->vtable._23_Clear.methodPtr);
  v51 = v6->fields.table;
  if ( !iTween_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(iTween_TypeInfo);
  iTween__MoveTo_62087988(v27, v51, 0LL);
}