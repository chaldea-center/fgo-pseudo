        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0C701 & 1) == 0 )
  {
    sub_1B686D4(&bool_TypeInfo, parent);
    sub_1B686D4(&iTween_LoopType_TypeInfo, v7);
    ...
    sub_1B686D4(&StringLiteral_18484/*"delay"*/, v14);
    sub_1B686D4(&StringLiteral_21146/*"looptype"*/, v15);
    sub_1B686D4(&StringLiteral_21048/*"linear"*/, v16);
    sub_1B686D4(&StringLiteral_20727/*"isLocal"*/, v17);
    sub_1B686D4(&StringLiteral_22198/*"oncomplete"*/, v18);
    this = (MoveLabelTextControl_o *)sub_1B686D4(&iTween_TypeInfo, v19);
    byte_4A0C701 = 1;
  }
  if ( !targetLb )
    goto LABEL_28;
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&v6->fields.targetLb, (int32_t)targetLb, v21, v22);
...
LABEL_28:
  ...
  if ( !iTween_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(iTween_TypeInfo);
  iTween__MoveTo_59957800(v27, v51, 0LL);
}