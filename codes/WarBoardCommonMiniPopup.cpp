void __fastcall WarBoardCommonMiniPopup___ctor(WarBoardCommonMiniPopup_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA37A & 1) == 0 )
  {
    sub_1B640C8(&WarBoardCommonMiniPopup_LineLayout___TypeInfo, method);
    sub_1B640C8(&WarBoardInfoPopupBase_TypeInfo, v3);
    byte_49FA37A = 1;
  }
  v4 = sub_1B64170(WarBoardCommonMiniPopup_LineLayout___TypeInfo, 2LL);
  if ( !v4 )
    sub_1B64324(0LL);
  v7 = *(_DWORD *)(v4 + 24);
  if ( !v7 || (*(_QWORD *)(v4 + 32) = 0xC1B0000042080000LL, v7 == 1) )
    sub_1B6432C(v4, v4);
  *(_QWORD *)(v4 + 40) = 0xC208000041E80000LL;
  this->fields.lineLayouts = (struct WarBoardCommonMiniPopup_LineLayout_array *)v4;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.lineLayouts, v4, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA375 & 1) == 0 )
  {
    sub_1B640C8(&Method_System_Linq_Enumerable_Count_char___, message);
    sub_1B640C8(&System_Func_char__bool__TypeInfo, v4);
    sub_1B640C8(&Method_WarBoardCommonMiniPopup___c__GetLineCount_b__11_0__, v5);
    sub_1B640C8(&WarBoardCommonMiniPopup___c_TypeInfo, v6);
    byte_49FA375 = 1;
  }
  ...
  if ( !_9__11_0 )
  {
    ...
    _9__11_0 = (System_Func_char__bool__o *)sub_1B64314(System_Func_char__bool__TypeInfo, message, method);
    ...
    sub_1B6406C((ServantStatusBattleListViewItem_o *)&static_fields->__9__11_0, (int32_t)_9__11_0, v11, v12);
  }
  return System_Linq_Enumerable__Count_char_(
           ...
           (const MethodInfo_2E56818 *)Method_System_Linq_Enumerable_Count_char___)
       + 1;
}
...
void __fastcall WarBoardCommonMiniPopup__OnClickClose(WarBoardCommonMiniPopup_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA378 & 1) == 0 )
  {
    sub_1B640C8(&Method_WarBoardCommonMiniPopup_OnClickClose__, method);
    byte_49FA378 = 1;
  }
    ...
    && !this->fields._isHideAnimating_k__BackingField )
  {
    ...
    if ( (*((_BYTE *)Method_WarBoardCommonMiniPopup_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B640E0(Method_WarBoardCommonMiniPopup_OnClickClose__);
...
void __fastcall WarBoardCommonMiniPopup__OnClickNo(WarBoardCommonMiniPopup_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA377 & 1) == 0 )
  {
    sub_1B640C8(&Method_WarBoardCommonMiniPopup_OnClickNo__, method);
    byte_49FA377 = 1;
  }
  if ( WarBoardInfoPopupBase__get_isShown((WarBoardInfoPopupBase_o *)this, method)
    && !this->fields._isShowAnimating_k__BackingField
    && !this->fields._isHideAnimating_k__BackingField )
  {
    ...
    if ( (*((_BYTE *)Method_WarBoardCommonMiniPopup_OnClickNo__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B640E0(Method_WarBoardCommonMiniPopup_OnClickNo__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B640AC(v3, v3[4]);
...
void __fastcall WarBoardCommonMiniPopup__OnClickYes(WarBoardCommonMiniPopup_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA376 & 1) == 0 )
  {
    sub_1B640C8(&Method_WarBoardCommonMiniPopup_OnClickYes__, method);
    byte_49FA376 = 1;
  }
  if ( WarBoardInfoPopupBase__get_isShown((WarBoardInfoPopupBase_o *)this, method)
    && !this->fields._isShowAnimating_k__BackingField
    && !this->fields._isHideAnimating_k__BackingField )
  {
    ...
    if ( (*((_BYTE *)Method_WarBoardCommonMiniPopup_OnClickYes__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B640E0(Method_WarBoardCommonMiniPopup_OnClickYes__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B640AC(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  *(UnityEngine_Vector3_o *)&v17 = UnityEngine_Transform__get_localPosition(
  ...
  {
LABEL_15:
    sub_1B64324(noticeButtonRoot);
  }
  UILabel__set_text((UILabel_o *)noticeButtonRoot, noButton, 0LL);
  WarBoardInfoPopupBase__Show((WarBoardInfoPopupBase_o *)this, v21);
}
        ...
        const MethodInfo *method)
{
  ...
  *(UnityEngine_Vector3_o *)&v11 = UnityEngine_Transform__get_localPosition(
  ...
  v20.fields.z = v14;
  UnityEngine_Transform__set_localPosition((UnityEngine_Transform_o *)noticeButtonRoot, v20, 0LL);
  noticeButtonRoot = (UnityEngine_GameObject_o *)this->fields.messgeLabel;
  if ( !noticeButtonRoot )
    goto LABEL_15;
  UILabel__set_text((UILabel_o *)noticeButtonRoot, message, 0LL);
...
void __fastcall WarBoardCommonMiniPopup___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FA37B & 1) == 0 )
  {
    sub_1B640C8(&WarBoardCommonMiniPopup___c_TypeInfo, v1);
    byte_49FA37B = 1;
  }
  v3 = (Il2CppObject *)sub_1B64314(WarBoardCommonMiniPopup___c_TypeInfo, v1, v2);
  System_Object___ctor(v3, 0LL);
  WarBoardCommonMiniPopup___c_TypeInfo->static_fields->__9 = (struct WarBoardCommonMiniPopup___c_o *)v3;
  sub_1B6406C(
