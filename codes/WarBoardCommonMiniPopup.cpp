void WarBoardCommonMiniPopup___ctor(WarBoardCommonMiniPopup_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2A443 & 1) == 0 )
  {
    sub_1C94098(&WarBoardCommonMiniPopup_LineLayout___TypeInfo);
    sub_1C94098(&WarBoardInfoPopupBase_TypeInfo);
    byte_4D2A443 = 1;
  }
  v3 = sub_1C94140(WarBoardCommonMiniPopup_LineLayout___TypeInfo, 2);
  if ( !v3 )
    sub_1C942F0(0, v4);
  v11 = *(_DWORD *)(v3 + 24);
  ...
  *(_QWORD *)(v3 + 40) = 0xC208000041E80000LL;
  ...
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.lineLayouts, v3, v5, v6, v7, v8, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2A43E & 1) == 0 )
  {
    sub_1C94098(&Method_System_Linq_Enumerable_Count_char___);
    sub_1C94098(&System_Func_char__bool__TypeInfo);
    sub_1C94098(&Method_WarBoardCommonMiniPopup___c__GetLineCount_b__11_0__);
    sub_1C94098(&WarBoardCommonMiniPopup___c_TypeInfo);
    byte_4D2A43E = 1;
  }
  ...
  if ( !_9__11_0 )
  {
    ...
    _9__11_0 = (System_Func_char__bool__o *)sub_1C942E4(System_Func_char__bool__TypeInfo);
  ...
  return System_Linq_Enumerable__Count_char_(
           ...
           (const MethodInfo_31BD394 *)Method_System_Linq_Enumerable_Count_char___)
       + 1;
}
...
void WarBoardCommonMiniPopup__OnClickClose(WarBoardCommonMiniPopup_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2A441 & 1) == 0 )
  {
    sub_1C94098(&Method_WarBoardCommonMiniPopup_OnClickClose__);
    byte_4D2A441 = 1;
  }
    ...
    && !this->fields._isHideAnimating_k__BackingField )
  {
    ...
    if ( (*((_BYTE *)Method_WarBoardCommonMiniPopup_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C940B0(Method_WarBoardCommonMiniPopup_OnClickClose__);
...
void WarBoardCommonMiniPopup__OnClickNo(WarBoardCommonMiniPopup_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2A440 & 1) == 0 )
  {
    sub_1C94098(&Method_WarBoardCommonMiniPopup_OnClickNo__);
    byte_4D2A440 = 1;
  }
  if ( WarBoardInfoPopupBase__get_isShown((WarBoardInfoPopupBase_o *)this, method)
    && !this->fields._isShowAnimating_k__BackingField
    && !this->fields._isHideAnimating_k__BackingField )
  {
    ...
    if ( (*((_BYTE *)Method_WarBoardCommonMiniPopup_OnClickNo__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C940B0(Method_WarBoardCommonMiniPopup_OnClickNo__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C9407C(v3, v3[4]);
...
void WarBoardCommonMiniPopup__OnClickYes(WarBoardCommonMiniPopup_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2A43F & 1) == 0 )
  {
    sub_1C94098(&Method_WarBoardCommonMiniPopup_OnClickYes__);
    byte_4D2A43F = 1;
  }
  if ( WarBoardInfoPopupBase__get_isShown((WarBoardInfoPopupBase_o *)this, method)
    && !this->fields._isShowAnimating_k__BackingField
    && !this->fields._isHideAnimating_k__BackingField )
  {
    ...
    if ( (*((_BYTE *)Method_WarBoardCommonMiniPopup_OnClickYes__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C940B0(Method_WarBoardCommonMiniPopup_OnClickYes__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C9407C(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_15:
    ((void (__fastcall __noreturn *)(_QWORD, _QWORD))sub_1C942F0)(noticeButtonRoot, v13);
  }
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_15:
    ((void (__fastcall __noreturn *)(_QWORD, _QWORD))sub_1C942F0)(noticeButtonRoot, v12);
  }
...
void WarBoardCommonMiniPopup___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C942E4(WarBoardCommonMiniPopup___c_TypeInfo);
