void __fastcall WarBoardCommonMiniPopup___ctor(WarBoardCommonMiniPopup_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A59138 & 1) == 0 )
  {
    sub_1B885B0(&WarBoardCommonMiniPopup_LineLayout___TypeInfo);
    sub_1B885B0(&WarBoardInfoPopupBase_TypeInfo);
    byte_4A59138 = 1;
  }
  v3 = sub_1B88658(WarBoardCommonMiniPopup_LineLayout___TypeInfo, 2LL);
  if ( !v3 )
    sub_1B8880C(0LL, v4);
  v7 = *(_DWORD *)(v3 + 24);
  ...
  *(_QWORD *)(v3 + 40) = 0xC208000041E80000LL;
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.lineLayouts, v3, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A59133 & 1) == 0 )
  {
    sub_1B885B0(&Method_System_Linq_Enumerable_Count_char___);
    sub_1B885B0(&System_Func_char__bool__TypeInfo);
    sub_1B885B0(&Method_WarBoardCommonMiniPopup___c__GetLineCount_b__11_0__);
    sub_1B885B0(&WarBoardCommonMiniPopup___c_TypeInfo);
    byte_4A59133 = 1;
  }
  ...
  if ( !_9__11_0 )
  {
    ...
    _9__11_0 = (System_Func_char__bool__o *)sub_1B887FC(System_Func_char__bool__TypeInfo);
    System_Func_char__bool____ctor(_9__11_0, v6, Method_WarBoardCommonMiniPopup___c__GetLineCount_b__11_0__, 0LL);
  ...
  return System_Linq_Enumerable__Count_char_(
           ...
           (const MethodInfo_2E9D584 *)Method_System_Linq_Enumerable_Count_char___)
       + 1;
}
...
void __fastcall WarBoardCommonMiniPopup__OnClickClose(WarBoardCommonMiniPopup_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A59136 & 1) == 0 )
  {
    sub_1B885B0(&Method_WarBoardCommonMiniPopup_OnClickClose__);
    byte_4A59136 = 1;
  }
    ...
    && !this->fields._isHideAnimating_k__BackingField )
  {
    ...
    if ( (*((_BYTE *)Method_WarBoardCommonMiniPopup_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B885C8(Method_WarBoardCommonMiniPopup_OnClickClose__);
...
void __fastcall WarBoardCommonMiniPopup__OnClickNo(WarBoardCommonMiniPopup_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A59135 & 1) == 0 )
  {
    sub_1B885B0(&Method_WarBoardCommonMiniPopup_OnClickNo__);
    byte_4A59135 = 1;
  }
  if ( WarBoardInfoPopupBase__get_isShown((WarBoardInfoPopupBase_o *)this, method)
    && !this->fields._isShowAnimating_k__BackingField
    && !this->fields._isHideAnimating_k__BackingField )
  {
    ...
    if ( (*((_BYTE *)Method_WarBoardCommonMiniPopup_OnClickNo__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B885C8(Method_WarBoardCommonMiniPopup_OnClickNo__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B88594(v3, v3[4]);
...
void __fastcall WarBoardCommonMiniPopup__OnClickYes(WarBoardCommonMiniPopup_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A59134 & 1) == 0 )
  {
    sub_1B885B0(&Method_WarBoardCommonMiniPopup_OnClickYes__);
    byte_4A59134 = 1;
  }
  if ( WarBoardInfoPopupBase__get_isShown((WarBoardInfoPopupBase_o *)this, method)
    && !this->fields._isShowAnimating_k__BackingField
    && !this->fields._isHideAnimating_k__BackingField )
  {
    ...
    if ( (*((_BYTE *)Method_WarBoardCommonMiniPopup_OnClickYes__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B885C8(Method_WarBoardCommonMiniPopup_OnClickYes__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B88594(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  *(UnityEngine_Vector3_o *)&v18 = UnityEngine_Transform__get_localPosition(
  ...
  {
LABEL_15:
    ((void (__fastcall __noreturn *)(_QWORD, _QWORD))sub_1B8880C)(noticeButtonRoot, v11);
  }
        ...
        const MethodInfo *method)
{
  ...
  *(UnityEngine_Vector3_o *)&v16 = UnityEngine_Transform__get_localPosition(
  ...
  {
LABEL_15:
    ((void (__fastcall __noreturn *)(_QWORD, _QWORD))sub_1B8880C)(noticeButtonRoot, v9);
  }
...
void __fastcall WarBoardCommonMiniPopup___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1B887FC(WarBoardCommonMiniPopup___c_TypeInfo);
