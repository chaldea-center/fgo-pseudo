void __fastcall WarBoardCommonMiniPopup___ctor(WarBoardCommonMiniPopup_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4C1E5 & 1) == 0 )
  {
    sub_1B863B8(&WarBoardCommonMiniPopup_LineLayout___TypeInfo, method);
    sub_1B863B8(&WarBoardInfoPopupBase_TypeInfo, v3);
    byte_4A4C1E5 = 1;
  }
  v4 = sub_1B86460(WarBoardCommonMiniPopup_LineLayout___TypeInfo, 2LL);
  if ( !v4 )
    sub_1B86614(0LL, v5);
  v8 = *(_DWORD *)(v4 + 24);
  ...
  *(_QWORD *)(v4 + 40) = 0xC208000041E80000LL;
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.lineLayouts, v4, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4C1E0 & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Linq_Enumerable_Count_char___, message);
    sub_1B863B8(&System_Func_char__bool__TypeInfo, v4);
    sub_1B863B8(&Method_WarBoardCommonMiniPopup___c__GetLineCount_b__11_0__, v5);
    sub_1B863B8(&WarBoardCommonMiniPopup___c_TypeInfo, v6);
    byte_4A4C1E0 = 1;
  }
  ...
  if ( !_9__11_0 )
  {
    ...
    _9__11_0 = (System_Func_char__bool__o *)sub_1B86604(System_Func_char__bool__TypeInfo);
  ...
  return System_Linq_Enumerable__Count_char_(
           ...
           (const MethodInfo_2F8C060 *)Method_System_Linq_Enumerable_Count_char___)
       + 1;
}
...
void __fastcall WarBoardCommonMiniPopup__OnClickClose(WarBoardCommonMiniPopup_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4C1E3 & 1) == 0 )
  {
    sub_1B863B8(&Method_WarBoardCommonMiniPopup_OnClickClose__, method);
    byte_4A4C1E3 = 1;
  }
    ...
    && !this->fields._isHideAnimating_k__BackingField )
  {
    ...
    if ( (*((_BYTE *)Method_WarBoardCommonMiniPopup_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B863D0(Method_WarBoardCommonMiniPopup_OnClickClose__);
...
void __fastcall WarBoardCommonMiniPopup__OnClickNo(WarBoardCommonMiniPopup_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4C1E2 & 1) == 0 )
  {
    sub_1B863B8(&Method_WarBoardCommonMiniPopup_OnClickNo__, method);
    byte_4A4C1E2 = 1;
  }
  if ( WarBoardInfoPopupBase__get_isShown((WarBoardInfoPopupBase_o *)this, method)
    && !this->fields._isShowAnimating_k__BackingField
    && !this->fields._isHideAnimating_k__BackingField )
  {
    ...
    if ( (*((_BYTE *)Method_WarBoardCommonMiniPopup_OnClickNo__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B863D0(Method_WarBoardCommonMiniPopup_OnClickNo__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B8639C(v3, v3[4]);
...
void __fastcall WarBoardCommonMiniPopup__OnClickYes(WarBoardCommonMiniPopup_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4C1E1 & 1) == 0 )
  {
    sub_1B863B8(&Method_WarBoardCommonMiniPopup_OnClickYes__, method);
    byte_4A4C1E1 = 1;
  }
  if ( WarBoardInfoPopupBase__get_isShown((WarBoardInfoPopupBase_o *)this, method)
    && !this->fields._isShowAnimating_k__BackingField
    && !this->fields._isHideAnimating_k__BackingField )
  {
    ...
    if ( (*((_BYTE *)Method_WarBoardCommonMiniPopup_OnClickYes__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B863D0(Method_WarBoardCommonMiniPopup_OnClickYes__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B8639C(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  *(UnityEngine_Vector3_o *)&v18 = UnityEngine_Transform__get_localPosition(
  ...
  {
LABEL_15:
    ((void (__fastcall __noreturn *)(_QWORD, _QWORD))sub_1B86614)(noticeButtonRoot, v11);
  }
        ...
        const MethodInfo *method)
{
  ...
  *(UnityEngine_Vector3_o *)&v16 = UnityEngine_Transform__get_localPosition(
  ...
  {
LABEL_15:
    ((void (__fastcall __noreturn *)(_QWORD, _QWORD))sub_1B86614)(noticeButtonRoot, v9);
  }
...
void __fastcall WarBoardCommonMiniPopup___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A4C1E6 & 1) == 0 )
  {
    sub_1B863B8(&WarBoardCommonMiniPopup___c_TypeInfo, v1);
    byte_4A4C1E6 = 1;
  }
  v2 = (Il2CppObject *)sub_1B86604(WarBoardCommonMiniPopup___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  WarBoardCommonMiniPopup___c_TypeInfo->static_fields->__9 = (struct WarBoardCommonMiniPopup___c_o *)v2;
  sub_1B8635C((CGThumbnailListItem_o *)WarBoardCommonMiniPopup___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
