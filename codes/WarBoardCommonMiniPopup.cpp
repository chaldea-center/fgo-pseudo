void WarBoardCommonMiniPopup___ctor(WarBoardCommonMiniPopup_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C40C88 & 1) == 0 )
  {
    sub_1C37058(&WarBoardCommonMiniPopup_LineLayout___TypeInfo);
    sub_1C37058(&WarBoardInfoPopupBase_TypeInfo);
    byte_4C40C88 = 1;
  }
  v3 = sub_1C37100(WarBoardCommonMiniPopup_LineLayout___TypeInfo, 2);
  if ( !v3 )
    sub_1C372B4(0);
  v6 = *(_DWORD *)(v3 + 24);
  ...
  *(_QWORD *)(v3 + 40) = 0xC208000041E80000LL;
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.lineLayouts, v3, v4, v5);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.hideCompleteCallback, 0, (int32_t)method, v3);
...
LABEL_7:
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.hideCompleteCallback, (int32_t)v10, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C40C83 & 1) == 0 )
  {
    sub_1C37058(&Method_System_Linq_Enumerable_Count_char___);
    sub_1C37058(&System_Func_char__bool__TypeInfo);
    sub_1C37058(&Method_WarBoardCommonMiniPopup___c__GetLineCount_b__11_0__);
    sub_1C37058(&WarBoardCommonMiniPopup___c_TypeInfo);
    byte_4C40C83 = 1;
  }
  ...
  if ( !_9__11_0 )
  {
    ...
    _9__11_0 = (System_Func_char__bool__o *)sub_1C372A4(System_Func_char__bool__TypeInfo);
  ...
  return System_Linq_Enumerable__Count_char_(
           ...
           (const MethodInfo_3108B44 *)Method_System_Linq_Enumerable_Count_char___)
       + 1;
}
...
void WarBoardCommonMiniPopup__OnClickClose(WarBoardCommonMiniPopup_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C40C86 & 1) == 0 )
  {
    sub_1C37058(&Method_WarBoardCommonMiniPopup_OnClickClose__);
    byte_4C40C86 = 1;
  }
    ...
    && !this->fields._isHideAnimating_k__BackingField )
  {
    ...
    if ( (*((_BYTE *)Method_WarBoardCommonMiniPopup_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C37070(Method_WarBoardCommonMiniPopup_OnClickClose__);
...
void WarBoardCommonMiniPopup__OnClickNo(WarBoardCommonMiniPopup_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C40C85 & 1) == 0 )
  {
    sub_1C37058(&Method_WarBoardCommonMiniPopup_OnClickNo__);
    byte_4C40C85 = 1;
  }
  if ( WarBoardInfoPopupBase__get_isShown((WarBoardInfoPopupBase_o *)this, method)
    && !this->fields._isShowAnimating_k__BackingField
    && !this->fields._isHideAnimating_k__BackingField )
  {
    ...
    if ( (*((_BYTE *)Method_WarBoardCommonMiniPopup_OnClickNo__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C37070(Method_WarBoardCommonMiniPopup_OnClickNo__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C3703C(v3, v3[4]);
...
void WarBoardCommonMiniPopup__OnClickYes(WarBoardCommonMiniPopup_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C40C84 & 1) == 0 )
  {
    sub_1C37058(&Method_WarBoardCommonMiniPopup_OnClickYes__);
    byte_4C40C84 = 1;
  }
  if ( WarBoardInfoPopupBase__get_isShown((WarBoardInfoPopupBase_o *)this, method)
    && !this->fields._isShowAnimating_k__BackingField
    && !this->fields._isHideAnimating_k__BackingField )
  {
    ...
    if ( (*((_BYTE *)Method_WarBoardCommonMiniPopup_OnClickYes__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C37070(Method_WarBoardCommonMiniPopup_OnClickYes__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C3703C(v3, v3[4]);
...
void WarBoardCommonMiniPopup___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C372A4(WarBoardCommonMiniPopup___c_TypeInfo);
  System_Object___ctor(v1, 0);
  WarBoardCommonMiniPopup___c_TypeInfo->static_fields->__9 = (struct WarBoardCommonMiniPopup___c_o *)v1;
  sub_1C36FFC((CGThumbnailListItem_o *)WarBoardCommonMiniPopup___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
