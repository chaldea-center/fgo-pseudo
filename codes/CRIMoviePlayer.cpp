...
void __fastcall CRIMoviePlayer__CreateTexture(CRIMoviePlayer_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FFFE5 & 1) == 0 )
  {
    ...
    sub_1B640C8(&UnityEngine_Texture2D_TypeInfo, v3);
    byte_49FFFE5 = 1;
  }
  ...
  {
    v8 = (UnityEngine_Texture2D_o *)sub_1B64314(UnityEngine_Texture2D_TypeInfo, v6, v7);
    UnityEngine_Texture2D___ctor_69016000(v8, 128, 128, 1, 0, 0LL);
    texture = (UIWidget_o *)this->fields.texture;
    if ( texture )
    {
      ...
      if ( texture )
      {
        ...
        v9.fields.b = 0.0;
        v9.fields.a = 1.0;
        UIWidget__set_color(texture, v9, 0LL);
        goto LABEL_10;
      }
    }
LABEL_12:
...
void __fastcall CRIMoviePlayer__Dispose(CRIMoviePlayer_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FFFE1 & 1) == 0 )
  {
    this = (CRIMoviePlayer_o *)sub_1B640C8(&UnityEngine_Object_TypeInfo, method);
    byte_49FFFE1 = 1;
  }
...
void __fastcall CRIMoviePlayer__EndCallBack(CRIMoviePlayer_o *this, const MethodInfo *method)
{
  ...
  if ( callBack )
  {
    ...
    sub_1B6406C(p_callBack, 0, v7, v8);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFFE0 & 1) == 0 )
  {
    sub_1B640C8(&CinemascopeSideFrame_TypeInfo, name);
    sub_1B640C8(&Method_System_Nullable_int__get_HasValue__, v22);
    sub_1B640C8(&Method_System_Nullable_int__get_Value__, v23);
    byte_49FFFE0 = 1;
  }
  ...
  if ( !Value )
  {
    v28 = sub_1B64314(CinemascopeSideFrame_TypeInfo, v25, v26);
    *(_WORD *)(v28 + 16) = 257;
    System_Object___ctor((Il2CppObject *)v28, 0LL);
    *(_WORD *)(v28 + 16) = 257;
    *p_cinemascopeSideFrame = (struct CinemascopeSideFrame_o *)v28;
    sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.cinemascopeSideFrame, v28, v29, v30);
    Value = *p_cinemascopeSideFrame;
    if ( !*p_cinemascopeSideFrame )
      goto LABEL_17;
  }
  v34 = CinemascopeSideFrame__Show(Value, name, v26);
  if ( v34.fields.hasValue )
  {
    ...
    Value = (CinemascopeSideFrame_o *)System_Nullable_int___get_Value(
                                        v35,
                                        (const MethodInfo_35CDDA0 *)Method_System_Nullable_int__get_Value__);
    if ( !texture )
      goto LABEL_17;
  ...
  if ( CriMana_Player__SetFile((CriMana_Player_o *)Value, cpk, path, 0, 0LL) )
  {
    ...
    sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.callBack, (int32_t)callBack, (int32_t)v32, v33);
    Value = (CinemascopeSideFrame_o *)this->fields._player_k__BackingField;
    if ( !Value )
      goto LABEL_17;
...
void __fastcall CRIMoviePlayer__MovieSeekByRelativeTime(CRIMoviePlayer_o *this, int32_t sec, const MethodInfo *method)
{
  ...
  if ( player_k__BackingField && CriMana_Player__get_status(player_k__BackingField, 0LL) == 5 && this->fields.isPlaying )
  {
    ...
    {
      sub_1B64324(frameInfo);
    }
    v9 = CRIMoviePlayer__SeekSequence(this, *(_DWORD *)&frameInfo->fields.wasStopping * sec / 1000 + a, v8);
...
void __fastcall CRIMoviePlayer__OnDestroy(CRIMoviePlayer_o *this, const MethodInfo *method)
{
  ...
  struct CriMana_Player_o *player_k__BackingField; // x8
  UnityEngine_Object_o *klass; // x20
  struct CriMana_Player_o *v10; // x8
  UnityEngine_Object_o *gameObject; // x20
  ...
  if ( (byte_49FFFE6 & 1) == 0 )
  {
    ...
    sub_1B640C8(&TouchEffectManager_TypeInfo, v4);
    byte_49FFFE6 = 1;
  }
  ...
  if ( player_k__BackingField )
  {
    ...
    {
      v10 = this->fields._player_k__BackingField;
      if ( v10 )
      {
        Instance = (CommonUI_o *)v10[1].klass;
        if ( Instance )
        {
      ...
      if ( UnityEngine_Object__op_Inequality(texture, 0LL, 0LL) )
      {
        ...
        if ( !v5
          || (v6 = this->fields._material,
              v5 = (struct UITexture_o *)((__int64 (__fastcall *)(struct UITexture_o *, Il2CppMethodPointer))v5->klass->vtable._26_get_mainTexture.method)(
                                           v5,
        ...
        UnityEngine_Material__set_mainTexture(v6, (UnityEngine_Texture_o *)v5, 0LL);
      }
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFFE2 & 1) == 0 )
  {
    sub_1B640C8(&CRIMoviePlayer__PlaySequence_d__23_TypeInfo, isBgmPause);
    byte_49FFFE2 = 1;
  }
  v9 = isVoicePause;
  v10 = sub_1B64314(CRIMoviePlayer__PlaySequence_d__23_TypeInfo, isBgmPause, isSePause);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFFE4 & 1) == 0 )
  {
    sub_1B640C8(&CRIMoviePlayer__SeekSequence_d__25_TypeInfo, *(_QWORD *)&frame);
    byte_49FFFE4 = 1;
  }
  v5 = sub_1B64314(CRIMoviePlayer__SeekSequence_d__25_TypeInfo, *(_QWORD *)&frame, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFFE7 & 1) == 0 )
  {
    sub_1B640C8(&BgmManager_TypeInfo, isVoicePause);
    sub_1B640C8(&SeManager_TypeInfo, v8);
    byte_49FFFE7 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFFE3 & 1) == 0 )
  {
    sub_1B640C8(&CRIMoviePlayer__StopSequence_d__24_TypeInfo, method);
    byte_49FFFE3 = 1;
  }
  v4 = sub_1B64314(CRIMoviePlayer__StopSequence_d__24_TypeInfo, method, v2);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFFE9 & 1) == 0 )
  {
    ...
    this = (CRIMoviePlayer__PlaySequence_d__23_o *)sub_1B640C8(&TouchEffectManager_TypeInfo, v3);
    byte_49FFFE9 = 1;
  }
  ...
  switch ( v2->fields.__1__state )
  {
    case 0:
      ...
      this = (CRIMoviePlayer__PlaySequence_d__23_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EC03C *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
      if ( !this )
        goto LABEL_56;
...
LABEL_34:
        ...
        if ( (_DWORD)this == 5 )
        {
          ...
          if ( !this->fields.__1__state )
          {
            v2->fields.__2__current = 0LL;
            v20 = (ServantStatusBattleListViewItem_o *)&v2->fields.__2__current;
            sub_1B6406C(v20, 0, v16, v17);
            v21 = 4;
LABEL_54:
            *(_DWORD *)&v20[-1].fields.isMine = v21;
            return 1;
          }
        }
...
LABEL_32:
      CRIMoviePlayer__EndCallBack(_4__this, v14);
      return 0;
    case 5:
      v2->fields.__1__state = -1;
      if ( !_4__this )
        ...
        const MethodInfo *method)
{
  ...
  v6 = sub_1B640DC(&Method_CRIMoviePlayer__PlaySequence_d__23_System_Collections_IEnumerator_Reset__);
  sub_1B641F0(v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  __int64 v17; // x1
  __int64 v18; // x2
  UnityEngine_WaitForEndOfFrame_o *v19; // x21
  int32_t v20; // w2
  int32_t v21; // w3
  ...
  if ( (byte_49FFFEA & 1) == 0 )
  {
    sub_1B640C8(&Method_CRIMoviePlayer__SeekSequence_b__25_0__, method);
    sub_1B640C8(&Method_CRIMoviePlayer__SeekSequence_b__25_1__, v5);
    sub_1B640C8(&System_Func_bool__TypeInfo, v6);
    sub_1B640C8(&UnityEngine_WaitForEndOfFrame_TypeInfo, v7);
    this = (CRIMoviePlayer__SeekSequence_d__25_o *)sub_1B640C8(&UnityEngine_WaitUntil_TypeInfo, v8);
    byte_49FFFEA = 1;
  }
  ...
  switch ( v4->fields.__1__state )
  {
    ...
    case 1:
      ...
      v4->fields._waitForEOF_5__4 = v19;
      sub_1B6406C((ServantStatusBattleListViewItem_o *)&v4->fields._waitForEOF_5__4, (int32_t)v19, v20, v21);
...
LABEL_25:
        ...
        if ( CriMana_Player__get_status((CriMana_Player_o *)this, 0LL) != 5 )
        {
          ...
          sub_1B6406C(p__2__current, (int32_t)waitForEOF_5__4, v15, v16);
          v14 = 2;
LABEL_38:
      ...
      sub_1B6406C((ServantStatusBattleListViewItem_o *)&v4->fields._waitForEOF_5__4, 0, v15, v16);
      if ( !v4->fields._retry_5__3 )
      {
        v35 = (System_Func_bool__o *)sub_1B64314(System_Func_bool__TypeInfo, v24, v25);
        System_Func_bool____ctor(v35, (Il2CppObject *)_4__this, Method_CRIMoviePlayer__SeekSequence_b__25_0__, 0LL);
        v38 = (UnityEngine_WaitUntil_o *)sub_1B64314(UnityEngine_WaitUntil_TypeInfo, v36, v37);
        UnityEngine_WaitUntil___ctor(v38, v35, 0LL);
        v4->fields.__2__current = (Il2CppObject *)v38;
        p__2__current = (ServantStatusBattleListViewItem_o *)&v4->fields.__2__current;
        sub_1B6406C(p__2__current, (int32_t)v38, v39, v40);
        v14 = 3;
        goto LABEL_38;
      }
      v4->fields._retry_5__3 = 0;
...
LABEL_36:
      ...
      System_Func_bool____ctor(v28, (Il2CppObject *)_4__this, Method_CRIMoviePlayer__SeekSequence_b__25_1__, 0LL);
      v31 = (UnityEngine_WaitUntil_o *)sub_1B64314(UnityEngine_WaitUntil_TypeInfo, v29, v30);
      UnityEngine_WaitUntil___ctor(v31, v28, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  v5 = (System_NotSupportedException_o *)sub_1B64314(v2, v3, v4);
  System_NotSupportedException___ctor(v5, 0LL);
  v6 = sub_1B640DC(&Method_CRIMoviePlayer__SeekSequence_d__25_System_Collections_IEnumerator_Reset__);
  sub_1B641F0(v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  v5 = (System_NotSupportedException_o *)sub_1B64314(v2, v3, v4);
  System_NotSupportedException___ctor(v5, 0LL);
  v6 = sub_1B640DC(&Method_CRIMoviePlayer__StopSequence_d__24_System_Collections_IEnumerator_Reset__);
  sub_1B641F0(v5, v6);
}
