...
void TitleInfoEventDailyPoint__Close(TitleInfoEventDailyPoint_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.voicePlayer )
  {
    ...
    SoundManager__stopVoice_42673932(voiceName, 0.0, 0);
    this->fields.voicePlayer = 0;
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.voicePlayer, 0, v6, v7, v8, v9, v10, v11);
  }
  ...
  if ( !System_String__IsNullOrEmpty(this->fields.voiceAssetName, 0) )
  {
    ...
    *p_voiceAssetName = 0;
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.voiceAssetName, 0, v20, v21, v22, v23, v24, v25);
  }
  ...
  *((_DWORD *)p_endCallback + 16) = 0;
  ...
  {
    *p_endCallback = 0;
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)p_endCallback, 0, v13, v14, v15, v16, v17, v18);
...
void TitleInfoEventDailyPoint__EndPlayVoice(TitleInfoEventDailyPoint_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E02CEE & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_10785/*"PlayVoice"*/);
    byte_4E02CEE = 1;
  }
    ...
    if ( voiceList )
    {
      ...
      if ( voiceList )
      {
        ...
        if ( (unsigned int)playCnt >= voiceList->fields._size )
          sub_1CE6960(voiceList);
        v5 = *((_QWORD *)&voiceList->fields._syncRoot + playCnt);
        if ( v5 )
        {
          UnityEngine_MonoBehaviour__Invoke(
            (UnityEngine_MonoBehaviour_o *)this,
            (System_String_o *)StringLiteral_10785/*"PlayVoice"*/,
            *(float *)(v5 + 24),
            0);
          return;
        }
...
void TitleInfoEventDailyPoint__OnLoadSvtVoice(TitleInfoEventDailyPoint_o *this, const MethodInfo *method)
{
  ...
  System_String_o *VoiceAssetName_43939436; // x0
  int32_t v38; // w2
  int32_t v39; // w3
  ...
  if ( (byte_4E02CEB & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_System_Collections_Generic_List_ServantVoiceData____AddRange__);
    sub_1CE6700(&Method_System_Collections_Generic_List_ServantVoiceData____Add__);
    sub_1CE6700(&Method_System_Collections_Generic_List_ServantVoiceData_____ctor__);
    sub_1CE6700(&Method_System_Collections_Generic_List_ServantVoiceData____get_Count__);
    sub_1CE6700(&Method_System_Collections_Generic_List_ServantVoiceData____get_Item__);
    sub_1CE6700(&System_Collections_Generic_List_ServantVoiceData____TypeInfo);
    sub_1CE6700(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    sub_1CE6700(&SoundManager_TypeInfo);
    this = (TitleInfoEventDailyPoint_o *)sub_1CE6700(&Method_TitleInfoEventDailyPoint__OnLoadSvtVoice_b__26_0__);
    byte_4E02CEB = 1;
  }
  ...
  {
    v4 = (System_Collections_Generic_List_object__o *)sub_1CE694C(System_Collections_Generic_List_ServantVoiceData____TypeInfo);
    System_Collections_Generic_List_object____ctor(
      v4,
      (const MethodInfo_3905734 *)Method_System_Collections_Generic_List_ServantVoiceData_____ctor__);
    this = (TitleInfoEventDailyPoint_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !this )
      goto LABEL_39;
    ...
    v9 = (System_Collections_Generic_List_object__o *)sub_1CE694C(System_Collections_Generic_List_ServantVoiceData____TypeInfo);
    System_Collections_Generic_List_object____ctor(
      v9,
      (const MethodInfo_3905734 *)Method_System_Collections_Generic_List_ServantVoiceData_____ctor__);
    v2->fields.voiceList = (struct System_Collections_Generic_List_ServantVoiceData____o *)v9;
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&v2->fields.voiceList, (int32_t)v9, v10, v11, v12, v13, v14, v15);
    if ( (int)max_length >= 1 )
    {
      v16 = 0;
      while ( 1 )
...
LABEL_40:
        ...
        if ( !v7 )
          break;
        this = (TitleInfoEventDailyPoint_o *)ServantVoiceMaster__getEntity_43960224(
        ...
        if ( this )
        {
          ...
          System_Collections_Generic_List_object___AddRange(
            ...
            (const MethodInfo_3906174 *)Method_System_Collections_Generic_List_ServantVoiceData____AddRange__);
        }
...
LABEL_18:
    ...
    if ( !v36 )
      goto LABEL_39;
    VoiceAssetName_43939436 = ServantVoiceEntity__getVoiceAssetName_43939436(v36->fields.svtId, 0);
    v2->fields.voiceAssetName = VoiceAssetName_43939436;
    sub_1CE66A4(
      (GrandQuestFolderBoardItem_o *)&v2->fields.voiceAssetName,
      (int32_t)VoiceAssetName_43939436,
      v38,
      v39,
      v40,
      v41,
...
void TitleInfoEventDailyPoint__OnTouchDisp(TitleInfoEventDailyPoint_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E02CF0 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_TitleInfoEventDailyPoint_OnTouchDisp__);
    sub_1CE6700(&Method_TitleInfoEventDailyPoint__OnTouchDisp_b__31_0__);
    byte_4E02CF0 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_TitleInfoEventDailyPoint_OnTouchDisp__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1CE6718(Method_TitleInfoEventDailyPoint_OnTouchDisp__);
  ...
  if ( !v8 )
LABEL_11:
    sub_1CE6958(screenTouchInfo, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E02CEA & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_17378/*"bit_dedicate_reward_"*/);
    byte_4E02CEA = 1;
  }
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.endCallback, (int32_t)callback, v33, v34, v35, v36, v37, v38);
  ...
  v41 = System_String__Concat((Il2CppObject *)StringLiteral_17378/*"bit_dedicate_reward_"*/, v40, 0);
  ...
  if ( UnityEngine_Object__op_Inequality(simpleAnimation, 0, 0) )
  {
    ...
    if ( transform )
    {
      ...
      if ( transform )
      {
        ...
        {
LABEL_31:
          v48 = sub_1CBCA7C(transform, SimpleAnimation_State_TypeInfo, 14);
        }
...
void TitleInfoEventDailyPoint__PlayVoice(TitleInfoEventDailyPoint_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E02CED & 1) == 0 )
  {
    ...
    sub_1CE6700(&SoundManager_TypeInfo);
    sub_1CE6700(&Method_TitleInfoEventDailyPoint_EndPlayVoice__);
    byte_4E02CED = 1;
  }
  voiceList = (System_Collections_Generic_List_object__o *)this->fields.voiceList;
  if ( !voiceList )
  ...
  if ( !v11
    || (v12 = *(struct System_String_o **)(v11 + 16),
        ...
        sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.voiceName, (int32_t)v12, v4, v5, v6, v7, v8, v9),
        (eventPointBehavior = this->fields.eventPointBehavior) == 0) )
  {
LABEL_13:
    sub_1CE6958(voiceList, method);
  }
  VoiceAssetName_43939436 = ServantVoiceEntity__getVoiceAssetName_43939436(eventPointBehavior->fields.svtId, 0);
  v15 = SeManager_TypeInfo;
  voiceName = this->fields.voiceName;
  v17 = VoiceAssetName_43939436;
  ...
  if ( !SoundManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(SoundManager_TypeInfo);
  v20 = SoundManager__playVoice_42673536(v17, voiceName, DEFAULT_VOLUME, v19, 0, 0);
  this->fields.voicePlayer = v20;
  p_voicePlayer = (GrandQuestFolderBoardItem_o *)&this->fields.voicePlayer;
  sub_1CE66A4(p_voicePlayer, (int32_t)v20, v22, v23, v24, v25, v26, v27);
...
void TitleInfoEventDailyPoint__StartVoice(TitleInfoEventDailyPoint_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E02CEC & 1) == 0 )
  {
    sub_1CE6700(&Method_System_Collections_Generic_List_ServantVoiceData____get_Count__);
    sub_1CE6700(&Method_System_Collections_Generic_List_ServantVoiceData____get_Item__);
    this = (TitleInfoEventDailyPoint_o *)sub_1CE6700(&System_Random_TypeInfo);
    byte_4E02CEC = 1;
  }
  ...
  {
    v4 = (System_Random_o *)sub_1CE694C(System_Random_TypeInfo);
...
void TitleInfoEventDailyPoint___OnLoadSvtVoice_b__26_0(TitleInfoEventDailyPoint_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E02CF2 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_DataMasterBase_BgmMaster__BgmEntity__int__GetEntity__);
    sub_1CE6700(&UnityEngine_Object_TypeInfo);
    sub_1CE6700(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1CE6700(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    sub_1CE6700(&SoundManager_TypeInfo);
    sub_1CE6700(&StringLiteral_13198/*"StartVoice"*/);
    byte_4E02CF2 = 1;
  }
  ...
  UnityEngine_MonoBehaviour__Invoke(
    (UnityEngine_MonoBehaviour_o *)this,
    (System_String_o *)StringLiteral_13198/*"StartVoice"*/,
  ...
  {
    Instance = (CommonUI_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !Instance )
      goto LABEL_38;
    ...
    Instance = (CommonUI_o *)DataMasterBase_object__object__int___GetEntity(
                               ...
                               v7->fields.bgmId,
                               (const MethodInfo_34E925C *)Method_DataMasterBase_BgmMaster__BgmEntity__int__GetEntity__);
    if ( !Instance )
      goto LABEL_38;
    ...
    if ( ((unsigned __int8)Instance & 1) != 0 )
    {
      ...
      if ( v12 )
      {
        ...
        if ( Instance )
        {
          ...
          SimpleAnimation__Play_68069172(v12, name, 0);
          goto LABEL_37;
        }
      }
LABEL_38:
      ...
      if ( ((unsigned __int8)Instance & 1) != 0 )
      {
        ...
        if ( v16 )
        {
          ...
          if ( Instance )
          {
            ...
            UnityEngine_Animation__Play_72661460(v16, v17, 0);
            goto LABEL_37;
          }
        }
        goto LABEL_38;
