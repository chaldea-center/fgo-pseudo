...
void __fastcall TitleInfoEventDailyPoint__Close(TitleInfoEventDailyPoint_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.voicePlayer )
  {
    ...
    SoundManager__stopVoice_39491520(voiceName, 0.0, 0LL);
    this->fields.voicePlayer = 0LL;
    sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.voicePlayer, 0LL, v6, v7, v8, v9, v10, v11);
  }
  ...
  if ( !System_String__IsNullOrEmpty(this->fields.voiceAssetName, 0LL) )
  {
    ...
    *p_voiceAssetName = 0LL;
    sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.voiceAssetName, 0LL, v20, v21, v22, v23, v24, v25);
  }
  ...
  *((_DWORD *)p_endCallback + 16) = 0;
  ...
  {
    *p_endCallback = 0LL;
    sub_1BD33FC((PartyOrganizationUtility_o *)p_endCallback, 0LL, v13, v14, v15, v16, v17, v18);
...
void __fastcall TitleInfoEventDailyPoint__EndPlayVoice(TitleInfoEventDailyPoint_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3546E & 1) == 0 )
  {
    sub_1BD3458(&Method_System_Collections_Generic_List_ServantVoiceData____get_Item__, method);
    sub_1BD3458(&StringLiteral_10820/*"PlayVoice"*/, v3);
    byte_4B3546E = 1;
  }
    ...
    if ( voiceList )
    {
      ...
      if ( voiceList )
      {
        ...
        if ( (unsigned int)playCnt >= voiceList->fields._size )
          sub_1BD36BC(voiceList, method);
        v6 = *((_QWORD *)&voiceList->fields._syncRoot + playCnt);
        if ( v6 )
        {
          UnityEngine_MonoBehaviour__Invoke(
            (UnityEngine_MonoBehaviour_o *)this,
            (System_String_o *)StringLiteral_10820/*"PlayVoice"*/,
            *(float *)(v6 + 24),
            0LL);
          return;
        }
...
void __fastcall TitleInfoEventDailyPoint__OnLoadSvtVoice(TitleInfoEventDailyPoint_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3546B & 1) == 0 )
  {
    ...
    sub_1BD3458(&Method_DataManager_GetMasterData_ServantVoiceMaster___, v3);
    sub_1BD3458(&Method_DataManager_GetMasterData_VoicePlayCondMaster___, v4);
    sub_1BD3458(&Method_System_Collections_Generic_List_ServantVoiceData____AddRange__, v5);
    sub_1BD3458(&Method_System_Collections_Generic_List_ServantVoiceData____Add__, v6);
    sub_1BD3458(&Method_System_Collections_Generic_List_ServantVoiceData_____ctor__, v7);
    sub_1BD3458(&Method_System_Collections_Generic_List_ServantVoiceData____get_Count__, v8);
    sub_1BD3458(&Method_System_Collections_Generic_List_ServantVoiceData____get_Item__, v9);
    sub_1BD3458(&System_Collections_Generic_List_ServantVoiceData____TypeInfo, v10);
    sub_1BD3458(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v11);
    sub_1BD3458(&SoundManager_TypeInfo, v12);
    this = (TitleInfoEventDailyPoint_o *)sub_1BD3458(&Method_TitleInfoEventDailyPoint__OnLoadSvtVoice_b__26_0__, v13);
    byte_4B3546B = 1;
  }
  ...
  {
    v15 = (System_Collections_Generic_List_object__o *)sub_1BD36A4(System_Collections_Generic_List_ServantVoiceData____TypeInfo);
    System_Collections_Generic_List_object____ctor(
      v15,
      (const MethodInfo_35C055C *)Method_System_Collections_Generic_List_ServantVoiceData_____ctor__);
    this = (TitleInfoEventDailyPoint_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37FDC48 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !this )
      goto LABEL_39;
    ...
    v20 = (System_Collections_Generic_List_object__o *)sub_1BD36A4(System_Collections_Generic_List_ServantVoiceData____TypeInfo);
    System_Collections_Generic_List_object____ctor(
      v20,
      (const MethodInfo_35C055C *)Method_System_Collections_Generic_List_ServantVoiceData_____ctor__);
    v2->fields.voiceList = (struct System_Collections_Generic_List_ServantVoiceData____o *)v20;
    sub_1BD33FC((PartyOrganizationUtility_o *)&v2->fields.voiceList, (int64_t)v20, v21, v22, v23, v24, v25, v26);
    if ( (int)v19 >= 1 )
    {
      v27 = 0LL;
      while ( 1 )
...
LABEL_40:
        ...
        if ( !v18 )
          break;
        this = (TitleInfoEventDailyPoint_o *)ServantVoiceMaster__getEntity_40689740(
        ...
        if ( this )
        {
          ...
          System_Collections_Generic_List_object___AddRange(
            ...
            (const MethodInfo_35C0F9C *)Method_System_Collections_Generic_List_ServantVoiceData____AddRange__);
        }
...
LABEL_18:
    ...
    this = (TitleInfoEventDailyPoint_o *)DataManager__GetMasterData_object_(
                                           (DataManager_o *)this,
                                           (const MethodInfo_2F31684 *)Method_DataManager_GetMasterData_VoicePlayCondMaster___);
    if ( !v15 )
      goto LABEL_39;
      ...
      do
      {
        ...
        if ( ((unsigned __int8)this & 1) != 0 )
        {
          ...
          else
          {
            ...
            sub_1BD33FC((PartyOrganizationUtility_o *)(v46 + 4), (int64_t)v45, v36, v37, v38, v39, v40, v41);
          }
        }
      }
      while ( size != ++v32 );
    ...
    if ( !v47 )
      goto LABEL_39;
    VoiceAssetName_40667708 = ServantVoiceEntity__getVoiceAssetName_40667708(v47->fields.svtId, 0LL);
    v2->fields.voiceAssetName = VoiceAssetName_40667708;
    sub_1BD33FC(
      (PartyOrganizationUtility_o *)&v2->fields.voiceAssetName,
      (int64_t)VoiceAssetName_40667708,
      v49,
      v50,
      v51,
      v52,
...
void __fastcall TitleInfoEventDailyPoint__OnTouchDisp(TitleInfoEventDailyPoint_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B35470 & 1) == 0 )
  {
    ...
    sub_1BD3458(&Method_TitleInfoEventDailyPoint_OnTouchDisp__, v5);
    sub_1BD3458(&Method_TitleInfoEventDailyPoint__OnTouchDisp_b__31_0__, v6);
    byte_4B35470 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_TitleInfoEventDailyPoint_OnTouchDisp__ + 83) & 2) != 0 )
    v8 = (_QWORD *)sub_1BD3470(Method_TitleInfoEventDailyPoint_OnTouchDisp__);
  ...
  if ( !v12 )
LABEL_11:
    sub_1BD36B4(screenTouchInfo, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3546A & 1) == 0 )
  {
    sub_1BD3458(&Method_UnityEngine_GameObject_GetComponent_ScreenTouchInformationComponent___, callback);
    sub_1BD3458(&Method_UnityEngine_GameObject_GetComponent_UILabel___, v10);
    ...
    sub_1BD3458(&StringLiteral_17419/*"bit_dedicate_reward_"*/, v18);
    byte_4B3546A = 1;
  }
  ...
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.endCallback, (int64_t)callback, v42, v43, v44, v45, v46, v47);
  ...
  v53 = System_String__Concat((Il2CppObject *)StringLiteral_17419/*"bit_dedicate_reward_"*/, v52, 0LL);
  ...
  if ( UnityEngine_Object__op_Inequality(simpleAnimation, 0LL, 0LL) )
  {
    ...
    if ( transform )
    {
      ...
      if ( transform )
      {
        ...
        {
LABEL_31:
          v60 = sub_1C25438(transform, SimpleAnimation_State_TypeInfo, 14LL);
        }
...
void __fastcall TitleInfoEventDailyPoint__PlayVoice(TitleInfoEventDailyPoint_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BD3458(&System_Action_TypeInfo, method);
    sub_1BD3458(&Method_System_Collections_Generic_List_ServantVoiceData____get_Item__, v3);
    sub_1BD3458(&SeManager_TypeInfo, v4);
    sub_1BD3458(&SoundManager_TypeInfo, v5);
    sub_1BD3458(&Method_TitleInfoEventDailyPoint_EndPlayVoice__, v6);
    byte_4B3546D = 1;
  }
  voiceList = (System_Collections_Generic_List_object__o *)this->fields.voiceList;
  if ( !voiceList )
  ...
  if ( !v15
    || (v16 = *(struct System_String_o **)(v15 + 16),
        ...
        sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.voiceName, (int64_t)v16, v8, v9, v10, v11, v12, v13),
        (eventPointBehavior = this->fields.eventPointBehavior) == 0LL) )
  {
LABEL_13:
    sub_1BD36B4(voiceList, method);
  }
  VoiceAssetName_40667708 = ServantVoiceEntity__getVoiceAssetName_40667708(eventPointBehavior->fields.svtId, 0LL);
  v19 = SeManager_TypeInfo;
  voiceName = this->fields.voiceName;
  v21 = VoiceAssetName_40667708;
  ...
  if ( !SoundManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(SoundManager_TypeInfo);
  v24 = SoundManager__playVoice_39491156(v21, voiceName, DEFAULT_VOLUME, v23, 0LL);
  this->fields.voicePlayer = v24;
  p_voicePlayer = &this->fields.voicePlayer;
  sub_1BD33FC((PartyOrganizationUtility_o *)p_voicePlayer, (int64_t)v24, v26, v27, v28, v29, v30, v31);
...
void __fastcall TitleInfoEventDailyPoint__StartVoice(TitleInfoEventDailyPoint_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3546C & 1) == 0 )
  {
    sub_1BD3458(&Method_System_Collections_Generic_List_ServantVoiceData____get_Count__, method);
    sub_1BD3458(&Method_System_Collections_Generic_List_ServantVoiceData____get_Item__, v3);
    this = (TitleInfoEventDailyPoint_o *)sub_1BD3458(&System_Random_TypeInfo, v4);
    byte_4B3546C = 1;
  }
  ...
  {
    v6 = (System_Random_o *)sub_1BD36A4(System_Random_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B35472 & 1) == 0 )
  {
    ...
    sub_1BD3458(&Method_DataManager_GetMasterData_BgmMaster___, v3);
    sub_1BD3458(&Method_DataMasterBase_BgmMaster__BgmEntity__int__GetEntity__, v4);
    ...
    sub_1BD3458(&StringLiteral_13145/*"StartVoice"*/, v9);
    byte_4B35472 = 1;
  }
  ...
  UnityEngine_MonoBehaviour__Invoke(
    (UnityEngine_MonoBehaviour_o *)this,
    (System_String_o *)StringLiteral_13145/*"StartVoice"*/,
  ...
  if ( eventPointBehavior->fields.bgmId >= 1 )
  {
    ...
    Instance = (CommonUI_o *)DataMasterBase_object__object__int___GetEntity(
                               ...
                               v14->fields.bgmId,
                               (const MethodInfo_31D1EF0 *)Method_DataMasterBase_BgmMaster__BgmEntity__int__GetEntity__);
    if ( !Instance )
      goto LABEL_38;
    ...
    if ( ((unsigned __int8)Instance & 1) != 0 )
    {
      ...
      if ( v19 )
      {
        ...
        if ( Instance )
        {
          ...
          SimpleAnimation__Play_64663364(v19, name, 0LL);
          goto LABEL_37;
        }
      }
LABEL_38:
      ...
      if ( ((unsigned __int8)Instance & 1) != 0 )
      {
        ...
        if ( v23 )
        {
          ...
          if ( Instance )
          {
            ...
            UnityEngine_Animation__Play_70023276(v23, v24, 0LL);
            goto LABEL_37;
          }
        }
        goto LABEL_38;
