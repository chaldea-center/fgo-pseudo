...
void CommandCodeInfo___ctor_46938676(CommandCodeInfo_o *this, CommandCodeInfo_SaveData_o *sv, const MethodInfo *method)
{
  __int64 v5; // x0
  __int64 v6; // x1
...
CommandCodeInfo_SaveData_o *CommandCodeInfo__GetSaveData(CommandCodeInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CCA3A6 & 1) == 0 )
  {
    sub_1C713B0(&CommandCodeInfo_SaveData_TypeInfo);
    byte_4CCA3A6 = 1;
  }
  v3 = (Il2CppObject *)sub_1C715FC(CommandCodeInfo_SaveData_TypeInfo);
