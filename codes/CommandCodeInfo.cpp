...
void CommandCodeInfo___ctor_46485844(CommandCodeInfo_o *this, CommandCodeInfo_SaveData_o *sv, const MethodInfo *method)
{
  __int64 v5; // x0
...
CommandCodeInfo_SaveData_o *CommandCodeInfo__GetSaveData(CommandCodeInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3A8C0 & 1) == 0 )
  {
    sub_1C32C20(&CommandCodeInfo_SaveData_TypeInfo);
    byte_4C3A8C0 = 1;
  }
  v3 = (Il2CppObject *)sub_1C32E6C(CommandCodeInfo_SaveData_TypeInfo);
