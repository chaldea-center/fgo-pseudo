...
void CommandCodeInfo___ctor_48097684(CommandCodeInfo_o *this, CommandCodeInfo_SaveData_o *sv, const MethodInfo *method)
{
  __int64 v5; // x0
  __int64 v6; // x1
...
CommandCodeInfo_SaveData_o *CommandCodeInfo__GetSaveData(CommandCodeInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E7A710 & 1) == 0 )
  {
    sub_1D0F0B4(&CommandCodeInfo_SaveData_TypeInfo);
    byte_4E7A710 = 1;
  }
  v3 = (Il2CppObject *)sub_1D0F300(CommandCodeInfo_SaveData_TypeInfo);
