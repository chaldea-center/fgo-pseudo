void UseInFsmFuncParam___ctor(UseInFsmFuncParam_o *this, DataVals_o *dataVal, const MethodInfo *method)
{
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.hashTargetId, (int32_t)v7, v8, v9, v10, v11, v12, v13);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E0743F & 1) == 0 )
  {
    ...
    this = (UseInFsmFuncParam_o *)sub_1CE6700(&Method_System_Collections_Generic_HashSet_int__Contains__);
    byte_4E0743F = 1;
  }
  if ( !v3 )
    goto LABEL_11;
...
UseInFsmFuncParam_o *UseInFsmFuncParam__Make(DataVals_o *dataVal, const MethodInfo *method)
{
  ...
  if ( (byte_4E07441 & 1) == 0 )
  {
    dataVal = (DataVals_o *)sub_1CE6700(&UseInFsmFuncParam_TypeInfo);
    byte_4E07441 = 1;
  }
  if ( !v2 )
    sub_1CE6958(dataVal, method);
  if ( !DataVals__ExistUseInFsmParam(v2, 0) )
    return 0;
  v3 = (UseInFsmFuncParam_o *)sub_1CE694C(UseInFsmFuncParam_TypeInfo);
