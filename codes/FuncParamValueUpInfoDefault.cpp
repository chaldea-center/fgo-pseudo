void __fastcall FuncParamValueUpInfoDefault___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A014AD & 1) == 0 )
  {
    sub_1B64A00(&FuncParamValueUpInfoDefault_TypeInfo, v1);
    sub_1B64A00(&DataVals_TYPE___TypeInfo, v2);
    byte_4A014AD = 1;
  }
  v3 = (struct DataVals_TYPE_array *)sub_1B64AA8(DataVals_TYPE___TypeInfo, 1LL);
  if ( !v3 )
    sub_1B64C5C(0LL, v4);
  if ( !v3->max_length )
    sub_1B64C64(v3, v3);
...
void __fastcall FuncParamValueUpInfoDefault___ctor(FuncParamValueUpInfoDefault_o *this, const MethodInfo *method)
{
  if ( (byte_4A014AC & 1) == 0 )
  {
    sub_1B64A00(&FuncParamValueUpInfoBase_TypeInfo, method);
    byte_4A014AC = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A014A8 & 1) == 0 )
  {
    sub_1B64A00(&Method_BasicHelper_IndexValue_int____75721264, *(_QWORD *)&valueUp);
    sub_1B64A00(&FuncParamValueUpInfoDefault_TypeInfo, v5);
    byte_4A014A8 = 1;
  }
  if ( !dataVals )
    return 0LL;
  ...
  if ( valueUp )
  {
    ...
    if ( funcEnt )
    {
      ...
      if ( isParam || IsIgnoreValueUpBuffType )
        return 0LL;
      v6 = sub_1B64C4C(FuncParamValueUpInfoDefault_TypeInfo);
      ...
      *(_QWORD *)(v6 + 24) = ValueUpTypeArray;
      sub_1B649A4((ServantStatusBattleListViewItem_o *)(v6 + 24), (int32_t)ValueUpTypeArray, v18, v19);
    }
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A014A9 & 1) == 0 )
  {
    sub_1B64A00(&Method_System_Enum_TryParse_DataVals_TYPE___, method);
    sub_1B64A00(&System_Enum_TypeInfo, v3);
    sub_1B64A00(&Method_System_Collections_Generic_List_DataVals_TYPE__Add__, v4);
    sub_1B64A00(&Method_System_Collections_Generic_List_DataVals_TYPE__ToArray__, v5);
    sub_1B64A00(&Method_System_Collections_Generic_List_DataVals_TYPE___ctor__, v6);
    dataVals = (DataVals_o *)sub_1B64A00(&System_Collections_Generic_List_DataVals_TYPE__TypeInfo, v7);
    byte_4A014A9 = 1;
  }
  result = 0;
  if ( !v2 )
  ...
  if ( IsNullOrEmpty )
    return v10;
  v11 = (System_Collections_Generic_List_T__o *)sub_1B64C4C(System_Collections_Generic_List_DataVals_TYPE__TypeInfo);
  System_Collections_Generic_List_Int32Enum____ctor(
    v11,
    (const MethodInfo_3494848 *)Method_System_Collections_Generic_List_DataVals_TYPE___ctor__);
  ...
  if ( (int)monitor >= 1 )
  {
    ...
    do
    {
      ...
      dataVals = (DataVals_o *)System_Enum__TryParse_Int32Enum_(
                                 v14,
                                 &result,
                                 (const MethodInfo_2E44D58 *)Method_System_Enum_TryParse_DataVals_TYPE___);
  ...
  if ( !v11 )
LABEL_21:
    sub_1B64C5C(dataVals, method);
  return (DataVals_TYPE_array *)System_Collections_Generic_List_Int32Enum___ToArray(
                                  v11,
                                  (const MethodInfo_3496BF4 *)Method_System_Collections_Generic_List_DataVals_TYPE__ToArray__);
}
...
bool __fastcall FuncParamValueUpInfoDefault__IsIgnoreValueUpBuffType(int32_t buffId, const MethodInfo *method)
{
  ...
  if ( (byte_4A014AB & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_DataManager_GetMaster_BuffMaster___, v3);
    sub_1B64A00(&Method_DataManager_GetMaster_BuffTypeDetailMaster___, v4);
    sub_1B64A00(&DataManager_TypeInfo, v5);
    sub_1B64A00(&Method_DataMasterBase_BuffTypeDetailMaster__BuffTypeDetailEntity__int__TryGetEntity__, v6);
    sub_1B64A00(&Method_DataMasterBase_BuffMaster__BuffEntity__int__TryGetEntity__, v7);
    byte_4A014AB = 1;
  }
  v12 = 0LL;
  entity = 0LL;
  ...
  if ( ((unsigned __int8)Master_object & 1) != 0 )
  {
    if ( entity )
    {
      ...
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      Master_object = DataManager__GetMaster_object_((const MethodInfo_2E3BC8C *)Method_DataManager_GetMaster_BuffTypeDetailMaster___);
...
bool __fastcall FuncParamValueUpInfoDefault__IsIgnoreValueUpFuncType(int32_t funcType, const MethodInfo *method)
{
  ...
  if ( (byte_4A014AA & 1) == 0 )
  {
    sub_1B64A00(&Method_DataManager_GetMaster_FuncTypeDetailMaster___, method);
    sub_1B64A00(&DataManager_TypeInfo, v3);
    sub_1B64A00(&Method_DataMasterBase_FuncTypeDetailMaster__FuncTypeDetailEntity__int__TryGetEntity__, v4);
    byte_4A014AA = 1;
  }
  entity = 0LL;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2E3BC8C *)Method_DataManager_GetMaster_FuncTypeDetailMaster___);
  if ( !Master_object )
    goto LABEL_11;
  Master_object = (Il2CppObject *)DataMasterBase_object__object__int___TryGetEntity(
                                    (DataMasterBase_TMaster__TEntity__PKType__o *)Master_object,
                                    &entity,
                                    funcType,
                                    (const MethodInfo_30D67EC *)Method_DataMasterBase_FuncTypeDetailMaster__FuncTypeDetailEntity__int__TryGetEntity__);
  if ( ((unsigned __int8)Master_object & 1) != 0 )
  {
    if ( entity )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A014A7 & 1) == 0 )
  {
    sub_1B64A00(&FuncParamValueUpInfoDefault_TypeInfo, method);
    byte_4A014A7 = 1;
  }
