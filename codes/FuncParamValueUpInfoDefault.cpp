void __fastcall FuncParamValueUpInfoDefault___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B1F366 & 1) == 0 )
  {
    sub_1BCAFF8(&FuncParamValueUpInfoDefault_TypeInfo, v1);
    sub_1BCAFF8(&DataVals_TYPE___TypeInfo, v2);
    byte_4B1F366 = 1;
  }
  v3 = (struct DataVals_TYPE_array *)sub_1BCB0A0(DataVals_TYPE___TypeInfo, 1LL);
  if ( !v3 )
    sub_1BCB254(0LL, v4);
  if ( !v3->max_length )
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)FuncParamValueUpInfoDefault_TypeInfo->static_fields, (int32_t)v3, v5, v6);
}
...
void __fastcall FuncParamValueUpInfoDefault___ctor(FuncParamValueUpInfoDefault_o *this, const MethodInfo *method)
{
  if ( (byte_4B1F365 & 1) == 0 )
  {
    sub_1BCAFF8(&FuncParamValueUpInfoBase_TypeInfo, method);
    byte_4B1F365 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1F361 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_BasicHelper_IndexValue_int____76920464, *(_QWORD *)&valueUp);
    sub_1BCAFF8(&FuncParamValueUpInfoDefault_TypeInfo, v5);
    byte_4B1F361 = 1;
  }
  if ( !dataVals )
    return 0LL;
  ...
  if ( valueUp )
  {
    ...
    if ( funcEnt )
    {
      ...
      if ( isParam || IsIgnoreValueUpBuffType )
        return 0LL;
      v6 = sub_1BCB244(FuncParamValueUpInfoDefault_TypeInfo);
      ...
      *(_QWORD *)(v6 + 24) = ValueUpTypeArray;
      sub_1BCAF9C((CGThumbnailListItem_o *)(v6 + 24), (int32_t)ValueUpTypeArray, v18, v19);
    }
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1F362 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_System_Enum_TryParse_DataVals_TYPE___, method);
    sub_1BCAFF8(&System_Enum_TypeInfo, v3);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_DataVals_TYPE__Add__, v4);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_DataVals_TYPE__ToArray__, v5);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_DataVals_TYPE___ctor__, v6);
    dataVals = (DataVals_o *)sub_1BCAFF8(&System_Collections_Generic_List_DataVals_TYPE__TypeInfo, v7);
    byte_4B1F362 = 1;
  }
  result = 0;
  if ( !v2 )
  ...
  if ( IsNullOrEmpty )
    return v10;
  v11 = (System_Collections_Generic_List_T__o *)sub_1BCB244(System_Collections_Generic_List_DataVals_TYPE__TypeInfo);
  System_Collections_Generic_List_Int32Enum____ctor(
    v11,
    (const MethodInfo_369EB84 *)Method_System_Collections_Generic_List_DataVals_TYPE___ctor__);
  ...
  if ( (int)monitor >= 1 )
  {
    ...
    do
    {
      if ( v14 >= (unsigned int)monitor )
        sub_1BCB25C(dataVals, method, v12);
      v15 = (System_String_o *)*((_QWORD *)&ParamAsStringArray[2].klass + v14);
      if ( !System_Enum_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(System_Enum_TypeInfo);
      dataVals = (DataVals_o *)System_Enum__TryParse_Int32Enum_(
                                 v15,
                                 &result,
                                 (const MethodInfo_30215E8 *)Method_System_Enum_TryParse_DataVals_TYPE___);
      if ( ((unsigned __int8)dataVals & 1) != 0 )
      {
        ...
        v17 = Method_System_Collections_Generic_List_DataVals_TYPE__Add__;
        ++v11->fields._version;
        if ( !items )
          goto LABEL_21;
        ...
        if ( (unsigned int)size >= items->max_length )
        {
          System_Collections_Generic_List_Int32Enum___AddWithResize(
            v11,
            (int32_t)method,
            *(const MethodInfo_369F3D8 **)(*(_QWORD *)(v17[4] + 192LL) + 112LL));
        }
        else
        {
  ...
  if ( !v11 )
LABEL_21:
    sub_1BCB254(dataVals, method);
  return (DataVals_TYPE_array *)System_Collections_Generic_List_Int32Enum___ToArray(
                                  v11,
                                  (const MethodInfo_36A0E90 *)Method_System_Collections_Generic_List_DataVals_TYPE__ToArray__);
}
...
bool __fastcall FuncParamValueUpInfoDefault__IsIgnoreValueUpBuffType(int32_t buffId, const MethodInfo *method)
{
  ...
  if ( (byte_4B1F364 & 1) == 0 )
  {
    sub_1BCAFF8(&BuffList_TypeInfo, method);
    sub_1BCAFF8(&Method_DataManager_GetMaster_BuffMaster___, v3);
    sub_1BCAFF8(&Method_DataManager_GetMaster_BuffTypeDetailMaster___, v4);
    sub_1BCAFF8(&DataManager_TypeInfo, v5);
    sub_1BCAFF8(&Method_DataMasterBase_BuffTypeDetailMaster__BuffTypeDetailEntity__int__TryGetEntity__, v6);
    sub_1BCAFF8(&Method_DataMasterBase_BuffMaster__BuffEntity__int__TryGetEntity__, v7);
    byte_4B1F364 = 1;
  }
  v12 = 0LL;
  entity = 0LL;
  ...
  if ( ((unsigned __int8)Master_object & 1) != 0 )
  {
    if ( entity )
    {
      ...
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      Master_object = DataManager__GetMaster_object_((const MethodInfo_301AA50 *)Method_DataManager_GetMaster_BuffTypeDetailMaster___);
...
bool __fastcall FuncParamValueUpInfoDefault__IsIgnoreValueUpFuncType(int32_t funcType, const MethodInfo *method)
{
  ...
  if ( (byte_4B1F363 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_DataMasterBase_FuncTypeDetailMaster__FuncTypeDetailEntity__int__TryGetEntity__, v4);
    byte_4B1F363 = 1;
  }
  entity = 0LL;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_301AA50 *)Method_DataManager_GetMaster_FuncTypeDetailMaster___);
  if ( !Master_object )
    goto LABEL_11;
  Master_object = (Il2CppObject *)DataMasterBase_object__object__int___TryGetEntity(
                                    (DataMasterBase_TMaster__TEntity__PKType__o *)Master_object,
                                    &entity,
                                    funcType,
                                    (const MethodInfo_32C7E4C *)Method_DataMasterBase_FuncTypeDetailMaster__FuncTypeDetailEntity__int__TryGetEntity__);
  if ( ((unsigned __int8)Master_object & 1) != 0 )
  {
    if ( entity )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1F360 & 1) == 0 )
  {
    sub_1BCAFF8(&FuncParamValueUpInfoDefault_TypeInfo, method);
    byte_4B1F360 = 1;
  }
