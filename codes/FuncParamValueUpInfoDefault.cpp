void __fastcall FuncParamValueUpInfoDefault___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A5DB46 & 1) == 0 )
  {
    ...
    sub_1B885B0(&DataVals_TYPE___TypeInfo);
    byte_4A5DB46 = 1;
  }
  v1 = (struct DataVals_TYPE_array *)sub_1B88658(DataVals_TYPE___TypeInfo, 1LL);
  if ( !v1 )
    sub_1B8880C(0LL, v2);
  if ( !v1->max_length )
    sub_1B88814(v1, v1);
...
void __fastcall FuncParamValueUpInfoDefault___ctor(FuncParamValueUpInfoDefault_o *this, const MethodInfo *method)
{
  if ( (byte_4A5DB45 & 1) == 0 )
  {
    sub_1B885B0(&FuncParamValueUpInfoBase_TypeInfo);
    byte_4A5DB45 = 1;
  }
  ...
  if ( valueUp )
  {
    ...
    if ( funcEnt )
    {
      ...
      if ( isParam || IsIgnoreValueUpBuffType )
        return 0LL;
      v5 = sub_1B887FC(FuncParamValueUpInfoDefault_TypeInfo);
      ...
      *(_QWORD *)(v5 + 24) = ValueUpTypeArray;
      sub_1B88554((ServantStatusBattleListViewItem_o *)(v5 + 24), (int32_t)ValueUpTypeArray, v17, v18);
    }
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5DB42 & 1) == 0 )
  {
    sub_1B885B0(&Method_System_Enum_TryParse_DataVals_TYPE___);
    sub_1B885B0(&System_Enum_TypeInfo);
    sub_1B885B0(&Method_System_Collections_Generic_List_DataVals_TYPE__Add__);
    sub_1B885B0(&Method_System_Collections_Generic_List_DataVals_TYPE__ToArray__);
    sub_1B885B0(&Method_System_Collections_Generic_List_DataVals_TYPE___ctor__);
    dataVals = (DataVals_o *)sub_1B885B0(&System_Collections_Generic_List_DataVals_TYPE__TypeInfo);
    byte_4A5DB42 = 1;
  }
  result = 0;
  if ( !v2 )
  ...
  if ( IsNullOrEmpty )
    return v5;
  v6 = (System_Collections_Generic_List_T__o *)sub_1B887FC(System_Collections_Generic_List_DataVals_TYPE__TypeInfo);
  System_Collections_Generic_List_Int32Enum____ctor(
    v6,
    (const MethodInfo_34E27E8 *)Method_System_Collections_Generic_List_DataVals_TYPE___ctor__);
  ...
  if ( (int)monitor >= 1 )
  {
    ...
    do
    {
      ...
      dataVals = (DataVals_o *)System_Enum__TryParse_Int32Enum_(
                                 v9,
                                 &result,
                                 (const MethodInfo_2E88980 *)Method_System_Enum_TryParse_DataVals_TYPE___);
  ...
  if ( !v6 )
LABEL_21:
    sub_1B8880C(dataVals, method);
  return (DataVals_TYPE_array *)System_Collections_Generic_List_Int32Enum___ToArray(
                                  v6,
                                  (const MethodInfo_34E4AF4 *)Method_System_Collections_Generic_List_DataVals_TYPE__ToArray__);
}
...
bool __fastcall FuncParamValueUpInfoDefault__IsIgnoreValueUpBuffType(int32_t buffId, const MethodInfo *method)
{
  ...
  if ( ((unsigned __int8)Master_object & 1) != 0 )
  {
    if ( entity )
    {
      ...
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      Master_object = DataManager__GetMaster_object_((const MethodInfo_2E7F8B4 *)Method_DataManager_GetMaster_BuffTypeDetailMaster___);
...
bool __fastcall FuncParamValueUpInfoDefault__IsIgnoreValueUpFuncType(int32_t funcType, const MethodInfo *method)
{
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2E7F8B4 *)Method_DataManager_GetMaster_FuncTypeDetailMaster___);
  if ( !Master_object )
    goto LABEL_11;
  Master_object = (Il2CppObject *)DataMasterBase_object__object__int___TryGetEntity(
                                    (DataMasterBase_TMaster__TEntity__PKType__o *)Master_object,
