void __fastcall FuncParamValueUpInfoDefault___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A7285D & 1) == 0 )
  {
    sub_1B90010(&FuncParamValueUpInfoDefault_TypeInfo, v1);
    sub_1B90010(&DataVals_TYPE___TypeInfo, v2);
    byte_4A7285D = 1;
  }
  v3 = (struct DataVals_TYPE_array *)sub_1B900B8(DataVals_TYPE___TypeInfo, 1LL);
  if ( !v3 )
    sub_1B9026C(0LL, v4);
  if ( !v3->max_length )
    sub_1B90274(v3, v3);
...
void __fastcall FuncParamValueUpInfoDefault___ctor(FuncParamValueUpInfoDefault_o *this, const MethodInfo *method)
{
  if ( (byte_4A7285C & 1) == 0 )
  {
    sub_1B90010(&FuncParamValueUpInfoBase_TypeInfo, method);
    byte_4A7285C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A72858 & 1) == 0 )
  {
    sub_1B90010(&Method_BasicHelper_IndexValue_int____76174832, *(_QWORD *)&valueUp);
    sub_1B90010(&FuncParamValueUpInfoDefault_TypeInfo, v5);
    byte_4A72858 = 1;
  }
  if ( !dataVals )
    return 0LL;
  ...
  if ( valueUp )
  {
    ...
    if ( funcEnt )
    {
      ...
      if ( isParam || IsIgnoreValueUpBuffType )
        return 0LL;
      v6 = sub_1B9025C(FuncParamValueUpInfoDefault_TypeInfo);
      ...
      *(_QWORD *)(v6 + 24) = ValueUpTypeArray;
      sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v6 + 24), (int32_t)ValueUpTypeArray, v18, v19);
    }
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A72859 & 1) == 0 )
  {
    sub_1B90010(&Method_System_Enum_TryParse_DataVals_TYPE___, method);
    sub_1B90010(&System_Enum_TypeInfo, v3);
    sub_1B90010(&Method_System_Collections_Generic_List_DataVals_TYPE__Add__, v4);
    sub_1B90010(&Method_System_Collections_Generic_List_DataVals_TYPE__ToArray__, v5);
    sub_1B90010(&Method_System_Collections_Generic_List_DataVals_TYPE___ctor__, v6);
    dataVals = (DataVals_o *)sub_1B90010(&System_Collections_Generic_List_DataVals_TYPE__TypeInfo, v7);
    byte_4A72859 = 1;
  }
  result = 0;
  if ( !v2 )
  ...
  if ( IsNullOrEmpty )
    return v10;
  v11 = (System_Collections_Generic_List_T__o *)sub_1B9025C(System_Collections_Generic_List_DataVals_TYPE__TypeInfo);
  System_Collections_Generic_List_Int32Enum____ctor(
    v11,
    (const MethodInfo_34F5974 *)Method_System_Collections_Generic_List_DataVals_TYPE___ctor__);
  ...
  if ( (int)monitor >= 1 )
  {
    ...
    do
    {
      ...
      dataVals = (DataVals_o *)System_Enum__TryParse_Int32Enum_(
                                 v14,
                                 &result,
                                 (const MethodInfo_2E97294 *)Method_System_Enum_TryParse_DataVals_TYPE___);
  ...
  if ( !v11 )
LABEL_21:
    sub_1B9026C(dataVals, method);
  return (DataVals_TYPE_array *)System_Collections_Generic_List_Int32Enum___ToArray(
                                  v11,
                                  (const MethodInfo_34F7C80 *)Method_System_Collections_Generic_List_DataVals_TYPE__ToArray__);
}
...
bool __fastcall FuncParamValueUpInfoDefault__IsIgnoreValueUpBuffType(int32_t buffId, const MethodInfo *method)
{
  ...
  if ( (byte_4A7285B & 1) == 0 )
  {
    sub_1B90010(&BuffList_TypeInfo, method);
    sub_1B90010(&Method_DataManager_GetMaster_BuffMaster___, v3);
    sub_1B90010(&Method_DataManager_GetMaster_BuffTypeDetailMaster___, v4);
    sub_1B90010(&DataManager_TypeInfo, v5);
    sub_1B90010(&Method_DataMasterBase_BuffTypeDetailMaster__BuffTypeDetailEntity__int__TryGetEntity__, v6);
    sub_1B90010(&Method_DataMasterBase_BuffMaster__BuffEntity__int__TryGetEntity__, v7);
    byte_4A7285B = 1;
  }
  v12 = 0LL;
  entity = 0LL;
  ...
  if ( ((unsigned __int8)Master_object & 1) != 0 )
  {
    if ( entity )
    {
      ...
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      Master_object = DataManager__GetMaster_object_((const MethodInfo_2E8E1C8 *)Method_DataManager_GetMaster_BuffTypeDetailMaster___);
...
bool __fastcall FuncParamValueUpInfoDefault__IsIgnoreValueUpFuncType(int32_t funcType, const MethodInfo *method)
{
  ...
  if ( (byte_4A7285A & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_DataMasterBase_FuncTypeDetailMaster__FuncTypeDetailEntity__int__TryGetEntity__, v4);
    byte_4A7285A = 1;
  }
  entity = 0LL;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2E8E1C8 *)Method_DataManager_GetMaster_FuncTypeDetailMaster___);
  if ( !Master_object )
    goto LABEL_11;
  Master_object = (Il2CppObject *)DataMasterBase_object__object__int___TryGetEntity(
                                    (DataMasterBase_TMaster__TEntity__PKType__o *)Master_object,
                                    &entity,
                                    funcType,
                                    (const MethodInfo_312C5FC *)Method_DataMasterBase_FuncTypeDetailMaster__FuncTypeDetailEntity__int__TryGetEntity__);
  if ( ((unsigned __int8)Master_object & 1) != 0 )
  {
    if ( entity )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A72857 & 1) == 0 )
  {
    sub_1B90010(&FuncParamValueUpInfoDefault_TypeInfo, method);
    byte_4A72857 = 1;
  }
