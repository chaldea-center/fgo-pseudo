void FuncParamValueUpInfoDefault___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E7A766 & 1) == 0 )
  {
    sub_1D0F0B4(&FuncParamValueUpInfoDefault_TypeInfo);
    sub_1D0F0B4(&DataVals_TYPE___TypeInfo);
    byte_4E7A766 = 1;
  }
  v1 = sub_1D0F15C(DataVals_TYPE___TypeInfo, 1);
  if ( !v1 )
    sub_1D0F30C(0, v2);
  if ( !*(_DWORD *)(v1 + 24) )
    sub_1D0F314(v1);
...
void FuncParamValueUpInfoDefault___ctor(FuncParamValueUpInfoDefault_o *this, const MethodInfo *method)
{
  if ( (byte_4E7A765 & 1) == 0 )
  {
    sub_1D0F0B4(&FuncParamValueUpInfoBase_TypeInfo);
    byte_4E7A765 = 1;
  }
  ...
  if ( valueUp )
  {
    ...
    if ( funcEnt )
    {
      ...
      if ( isParam || IsIgnoreValueUpBuffType )
        return 0;
      v5 = sub_1D0F300(FuncParamValueUpInfoDefault_TypeInfo);
      ...
      *(_QWORD *)(v5 + 24) = ValueUpTypeArray;
      sub_1D0F058((GrandQuestFolderBoardItem_o *)(v5 + 24), (int32_t)ValueUpTypeArray, v17, v18, v19, v20, v21, v22);
    }
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7A762 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_System_Enum_TryParse_DataVals_TYPE___);
    sub_1D0F0B4(&System_Enum_TypeInfo);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_DataVals_TYPE__Add__);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_DataVals_TYPE__ToArray__);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_DataVals_TYPE___ctor__);
    dataVals = (DataVals_o *)sub_1D0F0B4(&System_Collections_Generic_List_DataVals_TYPE__TypeInfo);
    byte_4E7A762 = 1;
  }
  result = 0;
  if ( !v2 )
  ...
  if ( IsNullOrEmpty )
    return v5;
  v6 = (System_Collections_Generic_List_T__o *)sub_1D0F300(System_Collections_Generic_List_DataVals_TYPE__TypeInfo);
  System_Collections_Generic_List_Int32Enum____ctor(
    v6,
    (const MethodInfo_39413C4 *)Method_System_Collections_Generic_List_DataVals_TYPE___ctor__);
  ...
  if ( (int)monitor >= 1 )
  {
    ...
    do
    {
      ...
      dataVals = (DataVals_o *)System_Enum__TryParse_Int32Enum_(
                                 v9,
                                 &result,
                                 (const MethodInfo_3255E5C *)Method_System_Enum_TryParse_DataVals_TYPE___);
  ...
  if ( !v6 )
LABEL_21:
    sub_1D0F30C(dataVals, method);
  return (DataVals_TYPE_array *)System_Collections_Generic_List_Int32Enum___ToArray(
                                  v6,
                                  (const MethodInfo_39436D0 *)Method_System_Collections_Generic_List_DataVals_TYPE__ToArray__);
}
...
bool FuncParamValueUpInfoDefault__IsIgnoreValueUpBuffType(int32_t buffId, const MethodInfo *method)
{
  ...
  if ( ((unsigned __int8)Master_object & 1) != 0 )
  {
    if ( entity )
    {
      ...
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      Master_object = DataManager__GetMaster_object_((const MethodInfo_324F164 *)Method_DataManager_GetMaster_BuffTypeDetailMaster___);
...
bool FuncParamValueUpInfoDefault__IsIgnoreValueUpFuncType(int32_t funcType, const MethodInfo *method)
{
  ...
  if ( (byte_4E7A763 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_DataManager_GetMaster_FuncTypeDetailMaster___);
    sub_1D0F0B4(&DataManager_TypeInfo);
    sub_1D0F0B4(&Method_DataMasterBase_FuncTypeDetailMaster__FuncTypeDetailEntity__int__TryGetEntity__);
    byte_4E7A763 = 1;
  }
  entity = 0;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_324F164 *)Method_DataManager_GetMaster_FuncTypeDetailMaster___);
  if ( !Master_object )
    goto LABEL_11;
  Master_object = (Il2CppObject *)DataMasterBase_object__object__int___TryGetEntity(
                                    (DataMasterBase_TMaster__TEntity__PKType__o *)Master_object,
                                    &entity,
                                    funcType,
                                    (const MethodInfo_3535BC8 *)Method_DataMasterBase_FuncTypeDetailMaster__FuncTypeDetailEntity__int__TryGetEntity__);
  if ( ((unsigned __int8)Master_object & 1) != 0 )
  {
    if ( entity )
