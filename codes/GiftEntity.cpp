...
void GiftEntity___ctor_42296692(
        GiftEntity_o *this,
        GiftEntity_o *cSrc,
        int32_t priorIconId,
        bool replace,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C57099 & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_11110/*"RESULT_BOUNDS_GET_CLASS_SKILL"*/);
    sub_1C3E564(&StringLiteral_12010/*"SERVANT_UNIT"*/);
    sub_1C3E564(&StringLiteral_5750/*"EXCEPT_SERVANT_UNIT"*/);
    sub_1C3E564(&StringLiteral_11637/*"SERVANT_EQUIP_UNIT"*/);
  ...
  switch ( this->fields.type )
  {
    ...
    case 7:
      ...
      *nameText = Name;
             ...
             || ServantEntity__get_IsStatusUp(v9, 0) )
      {
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        v13 = &StringLiteral_11637/*"SERVANT_EQUIP_UNIT"*/;
      }
      else
      {
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        v13 = &StringLiteral_5750/*"EXCEPT_SERVANT_UNIT"*/;
      }
      goto LABEL_68;
    case 2:
      Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39FF5A8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      ...
      *nameText = v18;
      sub_1C3E508((CGThumbnailListItem_o *)nameText, (int32_t)v18, v16, v17);
    ...
    case 3:
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v24 = LocalizationManager__Get((System_String_o *)StringLiteral_6520/*"FRIENDSHIP_NAME"*/, 0);
      *nameText = v24;
      sub_1C3E508((CGThumbnailListItem_o *)nameText, (int32_t)v24, v25, v26);
      v13 = &StringLiteral_6521/*"FRIENDSHIP_UNIT"*/;
      goto LABEL_68;
    case 4:
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v27 = LocalizationManager__Get((System_String_o *)StringLiteral_14857/*"USER_EXP_NAME"*/, 0);
      *nameText = v27;
      sub_1C3E508((CGThumbnailListItem_o *)nameText, (int32_t)v27, v28, v29);
      v13 = &StringLiteral_14858/*"USER_EXP_UNIT"*/;
      goto LABEL_68;
    case 5:
      Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39FF5A8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( !Instance )
      ...
      v31 = CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_49039980(v30, 0);
      *nameText = v31;
      sub_1C3E508((CGThumbnailListItem_o *)nameText, (int32_t)v31, v32, v33);
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v13 = &StringLiteral_14823/*"UNIT_INFO"*/;
      goto LABEL_68;
    case 8:
    ...
    case 0xB:
      ...
      *nameText = v34;
      sub_1C3E508((CGThumbnailListItem_o *)nameText, (int32_t)v34, v35, v36);
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v13 = &StringLiteral_3667/*"COMMAND_CODE_UNIT"*/;
LABEL_68:
      v44 = LocalizationManager__Get((System_String_o *)*v13, 0);
      num = this->fields.num;
      v51 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &num, v45, v46, v47, v48, v49, v50);
      v52 = System_String__Format(v44, v51, 0);
      *countText = v52;
      sub_1C3E508((CGThumbnailListItem_o *)countText, (int32_t)v52, v53, v54);
      return;
    case 0xC:
      Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39FF5A8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( !Instance )
      ...
      *countText = (System_String_o *)StringLiteral_1/*""*/;
      sub_1C3E508((CGThumbnailListItem_o *)countText, StringLiteral_1/*""*/, v38, v39);
      if ( !Entity )
        goto LABEL_72;
    ...
    case 0x12:
      *countText = (System_String_o *)StringLiteral_1/*""*/;
      sub_1C3E508((CGThumbnailListItem_o *)countText, StringLiteral_1/*""*/, (int32_t)countText, method);
      Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39FF5A8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( !Instance )
        goto LABEL_72;
      Instance = DataManager__GetMasterData_object_(
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      Instance = LocalizationManager__Get((System_String_o *)StringLiteral_11110/*"RESULT_BOUNDS_GET_CLASS_SKILL"*/, 0);
      if ( !v42 )
LABEL_72:
...
LABEL_52:
      *nameText = unknownNameText;
      sub_1C3E508((CGThumbnailListItem_o *)nameText, (int32_t)unknownNameText, (int32_t)countText, method);
      *countText = (System_String_o *)StringLiteral_1/*""*/;
      LODWORD(klass) = StringLiteral_1/*""*/;
LABEL_53:
      v41 = countText;
  ...
  sub_1C3E508((CGThumbnailListItem_o *)v41, (int32_t)klass, v21, v22);
}
...
System_String_o *GiftEntity__GetRewardName(GiftEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C5709A & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_8713/*"MISSION_REWARD_FOMAT_COMMANDCODE"*/);
  ...
  switch ( this->fields.type )
  {
    ...
    case 2:
      ...
      return System_String__Concat_63674716(v6, (System_String_o *)StringLiteral_113/*" "*/, CountText, 0);
    case 3:
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v8 = &StringLiteral_6520/*"FRIENDSHIP_NAME"*/;
      return LocalizationManager__Get((System_String_o *)*v8, 0);
    case 4:
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v8 = &StringLiteral_14857/*"USER_EXP_NAME"*/;
      return LocalizationManager__Get((System_String_o *)*v8, 0);
    case 5:
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      Master_object = DataManager__GetMaster_object_((const MethodInfo_30F9A1C *)Method_DataManager_GetMaster_EquipMaster___);
      if ( !Master_object )
        goto LABEL_62;
      Master_object = DataMasterBase_object__object__int___GetEntity(
                        (DataMasterBase_TMaster__TEntity__PKType__o *)Master_object,
      ...
      if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo);
      return CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_49039980(v9, 0);
    case 8:
    ...
    case 9:
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      Master_object = LocalizationManager__Get((System_String_o *)StringLiteral_8714/*"MISSION_REWARD_FOMAT_COSTUME_RELEASE"*/, 0);
      if ( !Entity )
        goto LABEL_62;
    ...
    case 0xB:
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      Master_object = DataManager__GetMaster_object_((const MethodInfo_30F9A1C *)Method_DataManager_GetMaster_CommandCodeMaster___);
      if ( !Master_object )
        goto LABEL_62;
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      Master_object = LocalizationManager__Get((System_String_o *)StringLiteral_8713/*"MISSION_REWARD_FOMAT_COMMANDCODE"*/, 0);
      if ( !v16 )
        goto LABEL_62;
      v14 = (System_String_o *)Master_object;
...
LABEL_61:
    ...
    case 0xC:
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      Master_object = DataManager__GetMaster_object_((const MethodInfo_30F9A1C *)Method_DataManager_GetMaster_EventPointBuffMaster___);
      if ( !Master_object
        || (Master_object = DataMasterBase_object__object__int___GetEntity(
                              (DataMasterBase_TMaster__TEntity__PKType__o *)Master_object,
                              this->fields.objectId,
                              (const MethodInfo_33B2F58 *)Method_DataMasterBase_EventPointBuffMaster__EventPointBuffEntity__int__GetEntity__)) == 0 )
      {
LABEL_62:
