...
void __fastcall GiftEntity___ctor_39159528(
        GiftEntity_o *this,
        GiftEntity_o *cSrc,
        int32_t priorIconId,
        bool replace,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1FDA6 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataManager_GetMasterData_CommandCodeMaster___, nameText);
    sub_1B715CC(&Method_DataManager_GetMasterData_EquipMaster___, v7);
    sub_1B715CC(&Method_DataManager_GetMasterData_EventPointBuffMaster___, v8);
    sub_1B715CC(&Method_DataManager_GetMasterData_ItemMaster___, v9);
    sub_1B715CC(&Method_DataManager_GetMasterData_ServantCostumeMaster___, v10);
    ...
    sub_1B715CC(&Method_DataMasterBase_EventPointBuffMaster__EventPointBuffEntity__int__GetEntity__, v14);
    sub_1B715CC(&Method_DataMasterBase_EquipMaster__EquipEntity__int__GetEntity__, v15);
    sub_1B715CC(&Method_DataMasterBase_CommandCodeMaster__CommandCodeEntity__int__GetEntity__, v16);
    ...
    sub_1B715CC(&StringLiteral_3722/*"COMMAND_CODE_UNIT"*/, v21);
    sub_1B715CC(&StringLiteral_6468/*"FRIENDSHIP_UNIT"*/, v22);
    sub_1B715CC(&StringLiteral_6467/*"FRIENDSHIP_NAME"*/, v23);
    sub_1B715CC(&StringLiteral_14748/*"UNIT_INFO"*/, v24);
    sub_1B715CC(&StringLiteral_14783/*"USER_EXP_UNIT"*/, v25);
    sub_1B715CC(&StringLiteral_14782/*"USER_EXP_NAME"*/, v26);
    sub_1B715CC(&StringLiteral_11909/*"SERVANT_UNIT"*/, v27);
    sub_1B715CC(&StringLiteral_5725/*"EXCEPT_SERVANT_UNIT"*/, v28);
    sub_1B715CC(&StringLiteral_11561/*"SERVANT_EQUIP_UNIT"*/, v29);
  ...
  switch ( this->fields.type )
  {
    ...
    case 7:
      ...
      *nameText = Name;
      sub_1B71570((ServantStatusBattleListViewItem_o *)nameText, (int32_t)Name, v35, v36);
      if ( ServantEntity__get_IsServant(v33, 0LL) || ServantEntity__get_IsServantMaterialTd(v33, 0LL) )
      {
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        v37 = &StringLiteral_11909/*"SERVANT_UNIT"*/;
      }
             ...
             || ServantEntity__get_IsStatusUp(v33, 0LL) )
      {
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        v37 = &StringLiteral_11561/*"SERVANT_EQUIP_UNIT"*/;
      }
      else
      {
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        v37 = &StringLiteral_5725/*"EXCEPT_SERVANT_UNIT"*/;
      }
      goto LABEL_61;
    case 2:
      Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      ...
      *nameText = v46;
      sub_1B71570((ServantStatusBattleListViewItem_o *)nameText, (int32_t)v46, v44, v45);
    ...
    case 3:
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v50 = LocalizationManager__Get((System_String_o *)StringLiteral_6467/*"FRIENDSHIP_NAME"*/, 0LL);
      *nameText = v50;
      sub_1B71570((ServantStatusBattleListViewItem_o *)nameText, (int32_t)v50, v51, v52);
      v37 = &StringLiteral_6468/*"FRIENDSHIP_UNIT"*/;
      goto LABEL_61;
    case 4:
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v53 = LocalizationManager__Get((System_String_o *)StringLiteral_14782/*"USER_EXP_NAME"*/, 0LL);
      *nameText = v53;
      sub_1B71570((ServantStatusBattleListViewItem_o *)nameText, (int32_t)v53, v54, v55);
      v37 = &StringLiteral_14783/*"USER_EXP_UNIT"*/;
      goto LABEL_61;
    case 5:
      Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( !Instance )
      ...
      v57 = CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_46344112(v56, 0LL);
      *nameText = v57;
      sub_1B71570((ServantStatusBattleListViewItem_o *)nameText, (int32_t)v57, v58, v59);
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v37 = &StringLiteral_14748/*"UNIT_INFO"*/;
      goto LABEL_61;
    case 8:
    ...
    case 0xB:
      ...
      *nameText = v61;
      sub_1B71570((ServantStatusBattleListViewItem_o *)nameText, (int32_t)v61, v62, v63);
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v37 = &StringLiteral_3722/*"COMMAND_CODE_UNIT"*/;
LABEL_61:
      ...
      *countText = v72;
      sub_1B71570((ServantStatusBattleListViewItem_o *)countText, (int32_t)v72, v73, v74);
      return;
    case 0xC:
      Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( !Instance
        || (Instance = DataManager__GetMasterData_object_(
                         (DataManager_o *)Instance,
                         (const MethodInfo_2E5B3E8 *)Method_DataManager_GetMasterData_EventPointBuffMaster___)) == 0LL
        || (Entity = DataMasterBase_object__object__int___GetEntity(
                       (DataMasterBase_TMaster__TEntity__PKType__o *)Instance,
                       this->fields.objectId,
                       (const MethodInfo_30F8760 *)Method_DataMasterBase_EventPointBuffMaster__EventPointBuffEntity__int__GetEntity__),
            *countText = (System_String_o *)StringLiteral_1/*""*/,
            sub_1B71570((ServantStatusBattleListViewItem_o *)countText, (int32_t)StringLiteral_1/*""*/, v65, v66),
            !Entity) )
      {
LABEL_65:
    ...
    default:
      ...
      if ( !byte_4A1B3BE )
      {
        sub_1B715CC(&LocalizationManager_TypeInfo, nameText);
        byte_4A1B3BE = 1;
      }
...
LABEL_43:
      v60 = countText;
LABEL_44:
      sub_1B71570((ServantStatusBattleListViewItem_o *)v60, (int32_t)klass, v41, v42);
      return;
  }
}
...
System_String_o *__fastcall GiftEntity__GetRewardName(GiftEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1FDA7 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataManager_GetMaster_CommandCodeMaster___, method);
    sub_1B715CC(&Method_DataManager_GetMaster_EquipMaster___, v3);
    sub_1B715CC(&Method_DataManager_GetMaster_EventPointBuffMaster___, v4);
    sub_1B715CC(&Method_DataManager_GetMaster_ItemMaster___, v5);
    sub_1B715CC(&Method_DataManager_GetMaster_ServantCostumeMaster___, v6);
    ...
    sub_1B715CC(&Method_DataMasterBase_EventPointBuffMaster__EventPointBuffEntity__int__GetEntity__, v11);
    sub_1B715CC(&Method_DataMasterBase_EquipMaster__EquipEntity__int__GetEntity__, v12);
    sub_1B715CC(&Method_DataMasterBase_CommandCodeMaster__CommandCodeEntity__int__GetEntity__, v13);
    sub_1B715CC(&LocalizationManager_TypeInfo, v14);
    sub_1B715CC(&CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo, v15);
    sub_1B715CC(&StringLiteral_8652/*"MISSION_REWARD_FOMAT_COSTUME_RELEASE"*/, v16);
    sub_1B715CC(&StringLiteral_8651/*"MISSION_REWARD_FOMAT_COMMANDCODE"*/, v17);
    sub_1B715CC(&StringLiteral_117/*" "*/, v18);
    sub_1B715CC(&StringLiteral_6467/*"FRIENDSHIP_NAME"*/, v19);
    sub_1B715CC(&StringLiteral_14782/*"USER_EXP_NAME"*/, v20);
  ...
  switch ( this->fields.type )
  {
    ...
    case 2:
      ...
      return System_String__Concat_61516764(v26, (System_String_o *)StringLiteral_117/*" "*/, CountText, 0LL);
    case 3:
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v28 = &StringLiteral_6467/*"FRIENDSHIP_NAME"*/;
      return LocalizationManager__Get((System_String_o *)*v28, 0LL);
    case 4:
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v28 = &StringLiteral_14782/*"USER_EXP_NAME"*/;
      return LocalizationManager__Get((System_String_o *)*v28, 0LL);
    case 5:
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      Master_object = DataManager__GetMaster_object_((const MethodInfo_2E5B394 *)Method_DataManager_GetMaster_EquipMaster___);
      if ( !Master_object )
        goto LABEL_62;
      Master_object = DataMasterBase_object__object__int___GetEntity(
                        (DataMasterBase_TMaster__TEntity__PKType__o *)Master_object,
      ...
      if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo);
      return CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_46344112(v29, 0LL);
    case 8:
    ...
    case 9:
      ...
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      Master_object = DataManager__GetMaster_object_((const MethodInfo_2E5B394 *)Method_DataManager_GetMaster_ServantCostumeMaster___);
      if ( !Master_object )
        goto LABEL_62;
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      Master_object = LocalizationManager__Get((System_String_o *)StringLiteral_8652/*"MISSION_REWARD_FOMAT_COSTUME_RELEASE"*/, 0LL);
      if ( !Entity )
        goto LABEL_62;
    ...
    case 0xB:
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      Master_object = DataManager__GetMaster_object_((const MethodInfo_2E5B394 *)Method_DataManager_GetMaster_CommandCodeMaster___);
      if ( !Master_object )
        goto LABEL_62;
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      Master_object = LocalizationManager__Get((System_String_o *)StringLiteral_8651/*"MISSION_REWARD_FOMAT_COMMANDCODE"*/, 0LL);
      if ( !v36 )
        goto LABEL_62;
      v34 = (System_String_o *)Master_object;
...
LABEL_61:
    ...
    case 0xC:
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      Master_object = DataManager__GetMaster_object_((const MethodInfo_2E5B394 *)Method_DataManager_GetMaster_EventPointBuffMaster___);
      if ( !Master_object
        || (Master_object = DataMasterBase_object__object__int___GetEntity(
                              (DataMasterBase_TMaster__TEntity__PKType__o *)Master_object,
                              this->fields.objectId,
