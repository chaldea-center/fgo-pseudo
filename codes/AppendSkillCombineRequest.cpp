        ...
        const MethodInfo *method)
{
  if ( (byte_4C393F6 & 1) == 0 )
  {
    sub_1C32C20(&StringLiteral_23514/*"skillNum"*/);
    sub_1C32C20(&StringLiteral_17047/*"baseUserSvtId"*/);
    sub_1C32C20(&StringLiteral_18403/*"currentSkillLv"*/);
    byte_4C393F6 = 1;
  }
  RequestBase__addField_44144740((RequestBase_o *)this, (System_String_o *)StringLiteral_17047/*"baseUserSvtId"*/, baseUsrSvtId, 0);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23514/*"skillNum"*/, skillNum, 0);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18403/*"currentSkillLv"*/, currentSkillLv, 0);
...
System_String_o *AppendSkillCombineRequest__getURL(AppendSkillCombineRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C393F5 & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_17740/*"card/combineAppendPassiveSkill"*/);
    byte_4C393F5 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63518544(BaseUrl, (System_String_o *)StringLiteral_17740/*"card/combineAppendPassiveSkill"*/, 0);
}
