        ...
        const MethodInfo *method)
{
  if ( (byte_42B2D82 & 1) == 0 )
  {
    sub_B52984(&StringLiteral_22331/*"skillNum"*/);
    sub_B52984(&StringLiteral_16738/*"baseUserSvtId"*/);
    sub_B52984(&StringLiteral_17957/*"currentSkillLv"*/);
    byte_42B2D82 = 1;
  }
  RequestBase__addField_32020452((RequestBase_o *)this, (System_String_o *)StringLiteral_16738/*"baseUserSvtId"*/, baseUsrSvtId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22331/*"skillNum"*/, skillNum, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_17957/*"currentSkillLv"*/, currentSkillLv, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B2D81 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_17333/*"card/combineAppendPassiveSkill"*/);
    byte_42B2D81 = 1;
  }
  ...
  return System_String__Concat_44568316(BaseUrl, (System_String_o *)StringLiteral_17333/*"card/combineAppendPassiveSkill"*/, 0LL);
}
