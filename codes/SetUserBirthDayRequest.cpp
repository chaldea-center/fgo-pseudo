        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC94C5 & 1) == 0 )
  {
    sub_1C1ABD4(&NetworkManager_TypeInfo, normalName);
    sub_1C1ABD4(&Method_SingletonMonoBehaviour_NetworkManager__get_Instance__, v11);
    sub_1C1ABD4(&StringLiteral_17467/*"birthDay"*/, v12);
    byte_4BC94C5 = 1;
  }
  ...
  if ( !Instance )
    sub_1C1AE30(0LL, v14);
  NetworkManager__SetSignup_39750576((NetworkManager_o *)Instance, normalName, genderType, month, day, 0LL);
  v17.fields._dateData = (uint64_t)&dateTime;
  dateTime.fields._dateData = 0LL;
  System_DateTime___ctor_63719520(v17, 2000, month, day, 0, 0, 0, 1, 0LL);
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  v18.fields._dateData = dateTime.fields._dateData;
  Time_39759872 = NetworkManager__getTime_39759872(v18, 0LL);
  RequestBase__addField_42368496((RequestBase_o *)this, (System_String_o *)StringLiteral_17467/*"birthDay"*/, Time_39759872, 0LL);
...
System_String_o *__fastcall SetUserBirthDayRequest__getURL(SetUserBirthDayRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC94C4 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_23007/*"profile/editBirth"*/, v2);
    byte_4BC94C4 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63040368(BaseUrl, (System_String_o *)StringLiteral_23007/*"profile/editBirth"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC94C6 & 1) == 0 )
  {
    sub_1C1ABD4(&System_DateTime_TypeInfo, responseList);
    sub_1C1ABD4(&JsonManager_TypeInfo, v5);
    sub_1C1ABD4(&NetworkManager_TypeInfo, v6);
    sub_1C1ABD4(&ResponseCommandKind_TypeInfo, v7);
    sub_1C1ABD4(&Method_SingletonMonoBehaviour_NetworkManager__get_Instance__, v8);
  ...
  if ( v10 && (v12 = v10, ResponseData__checkError(v10, v10->fields.resCode, v11)) )
  {
    ...
    if ( !NetworkManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
    dateData = NetworkManager__getDateTime_39760652(mAndroidApiKey, 0LL).fields._dateData;
    Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_387A8A8 *)Method_SingletonMonoBehaviour_NetworkManager__get_Instance__);
    ...
    if ( !v20
      || (NetworkManager__SetSignup_39750576(
            v20,
            ...
            0LL),
          (SelfUserGame = (NetworkManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_387A8A8 *)Method_SingletonMonoBehaviour_NetworkManager__get_Instance__)) == 0LL) )
    {
LABEL_19:
  ...
  {
    v23 = (System_String_o *)StringLiteral_22437/*"ng"*/;
  }
