        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_435632D & 1) == 0 )
  {
    ...
    sub_B70694(&StringLiteral_16970/*"birthDay"*/);
    byte_435632D = 1;
  }
  ...
  if ( !Instance )
    sub_B7076C(0LL, v12);
  NetworkManager__SetSignup_25934352(Instance, normalName, genderType, month, day, 0LL);
  v15.fields.dateData = (uint64_t)&dateTime;
  dateTime.fields.dateData = 0LL;
  System_DateTime___ctor_42970000(v15, 2000, month, day, 0, 0, 0, 1, 0LL);
  ...
  RequestBase__addField_32336108((RequestBase_o *)this, (System_String_o *)StringLiteral_16970/*"birthDay"*/, Time_25947024, 0LL);
...
System_String_o *__fastcall SetUserBirthDayRequest__getURL(SetUserBirthDayRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_B70694(&NetworkManager_TypeInfo);
    sub_B70694(&StringLiteral_21900/*"profile/editBirth"*/);
    byte_435632C = 1;
  }
  if ( (BYTE3(NetworkManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !NetworkManager_TypeInfo->_2.cctor_finished )
  ...
  return System_String__Concat_44758168(BaseUrl, (System_String_o *)StringLiteral_21900/*"profile/editBirth"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( v5 && (v6 = v5, ResponseData__checkError_29653500(v5, 0LL)) )
  {
    ...
    dateData = NetworkManager__getDateTime_25947808(mAndroidProjectId, 0LL).fields.dateData;
    Instance = SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2CE992C *)Method_SingletonMonoBehaviour_NetworkManager__get_Instance__);
    ...
    if ( !v14
      || (NetworkManager__SetSignup_25934352(v14, mAndroidApiKey, commandList_high, Month, (int32_t)SelfUserGame, 0LL),
          (SelfUserGame = (NetworkManager_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2CE992C *)Method_SingletonMonoBehaviour_NetworkManager__get_Instance__)) == 0LL) )
    {
LABEL_20:
  ...
  {
    v17 = (System_String_o *)StringLiteral_21408/*"ng"*/;
  }
