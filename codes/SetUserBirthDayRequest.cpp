        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A21423 & 1) == 0 )
  {
    sub_1B715CC(&NetworkManager_TypeInfo, normalName);
    sub_1B715CC(&Method_SingletonMonoBehaviour_NetworkManager__get_Instance__, v11);
    sub_1B715CC(&StringLiteral_17140/*"birthDay"*/, v12);
    byte_4A21423 = 1;
  }
  ...
  if ( !Instance )
    sub_1B71828(0LL, v14);
  NetworkManager__SetSignup_38262348((NetworkManager_o *)Instance, normalName, genderType, month, day, 0LL);
  v19.fields._dateData = (uint64_t)&dateTime;
  dateTime.fields._dateData = 0LL;
  System_DateTime___ctor_62184328(v19, 2000, month, day, 0, 0, 0, 1, 0LL);
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  v20.fields._dateData = dateTime.fields._dateData;
  Time_38271424 = NetworkManager__getTime_38271424(v20, 0LL);
  RequestBase__addField_40922716((RequestBase_o *)this, (System_String_o *)StringLiteral_17140/*"birthDay"*/, Time_38271424, v16);
...
System_String_o *__fastcall SetUserBirthDayRequest__getURL(SetUserBirthDayRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A21422 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_22558/*"profile/editBirth"*/, v2);
    byte_4A21422 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61505504(BaseUrl, (System_String_o *)StringLiteral_22558/*"profile/editBirth"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A21424 & 1) == 0 )
  {
    sub_1B715CC(&System_DateTime_TypeInfo, responseList);
    sub_1B715CC(&JsonManager_TypeInfo, v5);
    sub_1B715CC(&NetworkManager_TypeInfo, v6);
    sub_1B715CC(&ResponseCommandKind_TypeInfo, v7);
    sub_1B715CC(&Method_SingletonMonoBehaviour_NetworkManager__get_Instance__, v8);
  ...
  if ( v10 && (v12 = v10, ResponseData__checkError(v10, v10->fields.resCode, v11)) )
  {
    ...
    if ( !NetworkManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
    dateData = NetworkManager__getDateTime_38183252(mAndroidApiKey, 0LL).fields._dateData;
    Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_NetworkManager__get_Instance__);
    ...
    if ( !v20
      || (NetworkManager__SetSignup_38262348(
            v20,
            ...
            0LL),
          (SelfUserGame = (NetworkManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_NetworkManager__get_Instance__)) == 0LL) )
    {
LABEL_21:
