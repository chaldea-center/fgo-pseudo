        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B4585 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_16835/*"birthDay"*/);
    byte_42B4585 = 1;
  }
  ...
  if ( !Instance )
    sub_B52A5C(0LL, v12);
  NetworkManager__SetSignup_25728456(Instance, normalName, genderType, month, day, 0LL);
  v15.fields.dateData = (uint64_t)&dateTime;
  dateTime.fields.dateData = 0LL;
  System_DateTime___ctor_15506956(v15, 2000, month, day, 0, 0, 0, 1, 0LL);
  ...
  RequestBase__addField_32020452((RequestBase_o *)this, (System_String_o *)StringLiteral_16835/*"birthDay"*/, Time_25741128, 0LL);
...
System_String_o *__fastcall SetUserBirthDayRequest__getURL(SetUserBirthDayRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_B52984(&NetworkManager_TypeInfo);
    sub_B52984(&StringLiteral_21721/*"profile/editBirth"*/);
    byte_42B4584 = 1;
  }
  if ( (BYTE3(NetworkManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !NetworkManager_TypeInfo->_2.cctor_finished )
  ...
  return System_String__Concat_44568316(BaseUrl, (System_String_o *)StringLiteral_21721/*"profile/editBirth"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( v5 && (v6 = v5, ResponseData__checkError_29724768(v5, 0LL)) )
  {
    ...
    dateData = NetworkManager__getDateTime_25741912(mAndroidProjectId, 0LL).fields.dateData;
    ...
    if ( !v14
      || (NetworkManager__SetSignup_25728456(v14, mAndroidApiKey, commandList_high, Month, (int32_t)SelfUserGame, 0LL),
          (SelfUserGame = (NetworkManager_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_NetworkManager__get_Instance__)) == 0LL) )
    {
LABEL_20:
  ...
  {
    v17 = (System_String_o *)StringLiteral_21239/*"ng"*/;
  }
