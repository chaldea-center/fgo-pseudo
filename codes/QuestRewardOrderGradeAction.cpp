...
void __fastcall QuestRewardOrderGradeAction__Awake(QuestRewardOrderGradeAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FB5DE & 1) == 0 )
  {
    sub_1B64870(&Method_CStateManager_QuestRewardOrderGradeAction___ctor__, method);
    sub_1B64870(&Method_CStateManager_QuestRewardOrderGradeAction__add__, v3);
    sub_1B64870(&CStateManager_QuestRewardOrderGradeAction__TypeInfo, v4);
    ...
    sub_1B64870(&QuestRewardOrderGradeAction_StateItemLabel_TypeInfo, v8);
    sub_1B64870(&QuestRewardOrderGradeAction_StateNone_TypeInfo, v9);
    sub_1B64870(&QuestRewardOrderGradeAction_StatePlay_TypeInfo, v10);
    sub_1B64870(&QuestRewardOrderGradeAction_StateTouchWait_TypeInfo, v11);
    byte_49FB5DE = 1;
  }
  p_mFSM = &this->fields.mFSM;
  if ( !this->fields.mFSM )
  {
    v13 = (CStateManager_T__o *)sub_1B64ABC(CStateManager_QuestRewardOrderGradeAction__TypeInfo);
    CStateManager_object____ctor(
      v13,
      (Il2CppObject *)this,
      4,
      (const MethodInfo_3063598 *)Method_CStateManager_QuestRewardOrderGradeAction___ctor__);
    ...
    v17 = (Il2CppObject *)sub_1B64ABC(QuestRewardOrderGradeAction_StateNone_TypeInfo);
    ...
    CStateManager_object___add(
      ...
      0,
      (IState_T__o *)v17,
      (const MethodInfo_3063640 *)Method_CStateManager_QuestRewardOrderGradeAction__add__);
    v20 = (CStateManager_T__o *)*p_mFSM;
    v21 = (Il2CppObject *)sub_1B64ABC(QuestRewardOrderGradeAction_StatePlay_TypeInfo);
    ...
    v23 = (Il2CppObject *)sub_1B64ABC(QuestRewardOrderGradeAction_StateItemLabel_TypeInfo);
    ...
    v25 = (Il2CppObject *)sub_1B64ABC(QuestRewardOrderGradeAction_StateTouchWait_TypeInfo);
  ...
  if ( UnityEngine_Object__op_Equality(particleObj, 0LL, 0LL) )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(particlePrefab, 0LL, 0LL) )
    {
      ...
      if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)v30, 0LL, 0LL) )
      {
        ...
        if ( !byte_49F9201 )
        {
          sub_1B64870(&UnityEngine_Vector3_TypeInfo, v31);
          byte_49F9201 = 1;
        }
        ...
        if ( v30 )
        {
          ...
          if ( ComponentInChildren_object )
          {
            ...
            sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.particleObj, (int32_t)v30, v32, v33);
            return;
          }
        }
LABEL_24:
        sub_1B64ACC(ComponentInChildren_object, v19);
      }
    }
  }
}
...
int32_t __fastcall QuestRewardOrderGradeAction__GetState(QuestRewardOrderGradeAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FB5E2 & 1) == 0 )
  {
    this = (QuestRewardOrderGradeAction_o *)sub_1B64870(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB5E1 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_QuestRewardOrderGradeAction__Play_b__14_0__, v10);
    sub_1B64870(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v11);
    sub_1B64870(&SimpleAnimation_State_TypeInfo, v12);
    byte_49FB5E1 = 1;
  }
  this->fields.mEndAct = end_act;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.mEndAct, (int32_t)end_act, (int32_t)method, v4);
  ...
  if ( ((unsigned __int8)gameObject & 1) != 0 )
  {
    ...
    {
LABEL_14:
      v22 = sub_1BB6850(gameObject, SimpleAnimation_State_TypeInfo, 8LL);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB5E3 & 1) == 0 )
  {
    sub_1B64870(&Method_CStateManager_QuestRewardOrderGradeAction__setState__, *(_QWORD *)&state);
    byte_49FB5E3 = 1;
  }
  mFSM = (CStateManager_T__o *)this->fields.mFSM;
  if ( !mFSM )
  ...
  CStateManager_object___setState(
    mFSM,
    state,
    (const MethodInfo_30636CC *)Method_CStateManager_QuestRewardOrderGradeAction__setState__);
}
...
void __fastcall QuestRewardOrderGradeAction__Setup(QuestRewardOrderGradeAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FB5E0 & 1) == 0 )
  {
    sub_1B64870(&Method_UnityEngine_Component_GetComponentInChildren_Animation___, method);
    sub_1B64870(&Method_UnityEngine_Component_GetComponentInChildren_CommonEffectComponent___, v3);
    sub_1B64870(&Method_UnityEngine_Component_GetComponentInChildren_SimpleAnimation___, v4);
    sub_1B64870(&Method_UnityEngine_GameObject_GetComponent_ScreenTouchInformationComponent___, v5);
  ...
  if ( !transform )
    goto LABEL_19;
  v13 = UnityEngine_Component__GetComponentInChildren_object__48440272(
          transform,
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.mSimpleAnimation, (int32_t)v13, v14, v15);
  transform = (UnityEngine_Component_o *)UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0LL);
  if ( !transform )
    goto LABEL_19;
...
void __fastcall QuestRewardOrderGradeAction__Update(QuestRewardOrderGradeAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FB5DF & 1) == 0 )
  {
    sub_1B64870(&Method_CStateManager_QuestRewardOrderGradeAction__update__, method);
    byte_49FB5DF = 1;
  }
  mFSM = (CStateManager_T__o *)this->fields.mFSM;
  if ( mFSM )
    CStateManager_object___update(
      mFSM,
      (const MethodInfo_30636A8 *)Method_CStateManager_QuestRewardOrderGradeAction__update__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB5E6 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_GameObjectExtensions_SafeGetComponent_MoveObject___, v4);
    sub_1B64870(&ManagerConfig_TypeInfo, v5);
    sub_1B64870(&Method_QuestRewardOrderGradeAction_StateItemLabel_begin__, v6);
    sub_1B64870(&Method_QuestRewardOrderGradeAction_StateItemLabel___c__DisplayClass1_0__begin_b__0__, v7);
    sub_1B64870(&Method_QuestRewardOrderGradeAction_StateItemLabel___c__DisplayClass1_0__begin_b__1__, v8);
    sub_1B64870(&QuestRewardOrderGradeAction_StateItemLabel___c__DisplayClass1_0_TypeInfo, v9);
    byte_49FB5E6 = 1;
  }
  v10 = sub_1B64ABC(QuestRewardOrderGradeAction_StateItemLabel___c__DisplayClass1_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v10, 0LL);
  if ( !v10 )
    goto LABEL_13;
  *(_QWORD *)(v10 + 32) = that;
  sub_1B64814((ServantStatusBattleListViewItem_o *)(v10 + 32), (int32_t)that, v13, v14);
  v15 = *(_QWORD *)(v10 + 32);
  if ( !v15 )
    goto LABEL_13;
  ...
  *(_QWORD *)(v10 + 16) = gameObject;
  sub_1B64814((ServantStatusBattleListViewItem_o *)(v10 + 16), (int32_t)gameObject, v17, v18);
  ...
  *(_QWORD *)(v10 + 24) = Component_object;
  sub_1B64814((ServantStatusBattleListViewItem_o *)(v10 + 24), (int32_t)Component_object, v20, v21);
...
LABEL_13:
  ...
  if ( (*((_BYTE *)Method_QuestRewardOrderGradeAction_StateItemLabel_begin__ + 83) & 2) != 0 )
    v32 = (_QWORD *)sub_1B64888(Method_QuestRewardOrderGradeAction_StateItemLabel_begin__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB5E4 & 1) == 0 )
  {
    ...
    this = (QuestRewardOrderGradeAction_StatePlay_o *)sub_1B64870(&SimpleAnimation_State_TypeInfo, v5);
    byte_49FB5E4 = 1;
  }
  if ( !that )
    goto LABEL_38;
  ...
  if ( ((unsigned __int8)this & 1) == 0 )
  {
    ...
    if ( v21 )
    {
      ...
      if ( this )
      {
        ...
        this = (QuestRewardOrderGradeAction_StatePlay_o *)UnityEngine_Animation__Play_68881008(v21, name, 0LL);
        ...
        if ( v23 )
        {
          ...
          if ( this )
          {
            ...
            sub_1B64814(p_fields, (int32_t)Item, v27, v28);
...
LABEL_38:
  ...
  this = (QuestRewardOrderGradeAction_StatePlay_o *)SimpleAnimation__Play_63521240(v7, v8, 0LL);
  ...
  sub_1B64814(p_mSimpleAnimState, (int32_t)v11, v13, v14);
  ...
  {
LABEL_16:
    v19 = sub_1BB6850(p_mSimpleAnimState->klass, SimpleAnimation_State_TypeInfo, 6LL);
  }
  ...
  {
LABEL_33:
    v33 = sub_1BB6850(v29, SimpleAnimation_State_TypeInfo, 8LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B64870(&UnityEngine_Object_TypeInfo, that);
    this = (QuestRewardOrderGradeAction_StatePlay_o *)sub_1B64870(
  ...
  if ( ((unsigned __int8)this & 1) != 0 )
  {
    ...
    if ( SimpleAnimation__IsPlaying(v6, name, 0LL) )
      return;
LABEL_17:
    this = (QuestRewardOrderGradeAction_StatePlay_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE318 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    if ( this )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB5E7 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_QuestRewardOrderGradeAction_StateTouchWait_update__, v7);
    sub_1B64870(&Method_QuestRewardOrderGradeAction_StateTouchWait___c__DisplayClass1_0__update_b__0__, v8);
    sub_1B64870(&QuestRewardOrderGradeAction_StateTouchWait___c__DisplayClass1_0_TypeInfo, v9);
    byte_49FB5E7 = 1;
  }
  v10 = sub_1B64ABC(QuestRewardOrderGradeAction_StateTouchWait___c__DisplayClass1_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v10, 0LL);
  if ( !v10 )
    goto LABEL_18;
  *(_QWORD *)(v10 + 16) = that;
      ...
      if ( isTouchPush )
      {
        ...
        if ( isTouchPush )
        {
          ...
          if ( (*((_BYTE *)Method_QuestRewardOrderGradeAction_StateTouchWait_update__ + 83) & 2) != 0 )
            v16 = (_QWORD *)sub_1B64888(Method_QuestRewardOrderGradeAction_StateTouchWait_update__);
