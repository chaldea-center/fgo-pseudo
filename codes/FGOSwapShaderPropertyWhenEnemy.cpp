void __fastcall FGOSwapShaderPropertyWhenEnemy___ctor(FGOSwapShaderPropertyWhenEnemy_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_418859F & 1) == 0 )
  {
    ...
    sub_B2C35C(&FGOSwapShaderPropertyWhenEnemy_RendererType___TypeInfo, v4);
    sub_B2C35C(&StringLiteral_15959/*"_CullMode"*/, v5);
    byte_418859F = 1;
  }
  v6 = (struct FGOSwapShaderPropertyWhenEnemy_RendererType_array *)sub_B2C374(
  ...
  sub_B2C2F8(
    ...
    v12,
    v13);
  v14 = (System_Int32_array **)StringLiteral_15959/*"_CullMode"*/;
  this->fields.propertyName = (struct System_String_o *)StringLiteral_15959/*"_CullMode"*/;
  sub_B2C2F8((BattleServantConfConponent_o *)&this->fields.propertyName, v14, v15, v16, v17, v18, v19, v20);
  ...
  v21 = (System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData__o *)sub_B2C42C(System_Collections_Generic_List_Renderer__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_418859E & 1) == 0 )
  {
    ...
    sub_B2C35C(&Method_System_Collections_Generic_List_Renderer__Clear__, v5);
    sub_B2C35C(&Method_System_Collections_Generic_List_Renderer__GetEnumerator__, v6);
    sub_B2C35C(&Method_System_Collections_Generic_List_Renderer__get_Count__, v7);
    ...
    if ( this->fields.isDestroyMaterialWhenOnDestroy )
    {
                ...
                (const MethodInfo_20EA42C *)Method_System_Collections_Generic_List_Enumerator_Renderer__MoveNext__) )
      {
        if ( !v20.fields.current )
          sub_B2C434(0LL, v16);
        materials = UnityEngine_Renderer__get_materials((UnityEngine_Renderer_o *)v20.fields.current, 0LL);
        v12 = materials;
        if ( !materials )
          sub_B2C434(0LL, v11);
          ...
          do
          {
            ...
            if ( ((unsigned __int8)materials & 1) == 0 )
            {
              if ( this->fields.isDestroyImmediate )
              {
                ...
                UnityEngine_Object__DestroyImmediate_35315108(v15, 0LL);
              }
              else
              {
                if ( (WORD1(UnityEngine_Object_TypeInfo->vtable._0_Equals.methodPtr) & 0x400) != 0
...
void __fastcall FGOSwapShaderPropertyWhenEnemy__Start(FGOSwapShaderPropertyWhenEnemy_o *this, const MethodInfo *method)
{
  ...
  int i; // w24
  char *v54; // x8
  UnityEngine_Material_o *v55; // x21
  float Float; // s0
  float x; // s9
  float v58; // s8
  ...
  __int64 v63; // x0
  __int64 v64; // x0
  struct UnityEngine_GameObject_array *v65; // [xsp+0h] [xbp-B0h]
  unsigned __int64 v66; // [xsp+8h] [xbp-A8h]
  UnityEngine_GameObject_o *v67; // [xsp+10h] [xbp-A0h]
  System_Collections_Generic_List_Enumerator_T__o v68; // [xsp+18h] [xbp-98h] BYREF
  System_Collections_Generic_List_Enumerator_T__o v69; // [xsp+30h] [xbp-80h] BYREF
  ...
  if ( (byte_418859D & 1) == 0 )
  {
    ...
    sub_B2C35C(&Method_UnityEngine_GameObject_GetComponent_BattleActorControl___, v6);
    sub_B2C35C(&Method_System_Collections_Generic_List_Renderer__Add__, v7);
    sub_B2C35C(&Method_System_Collections_Generic_List_Renderer__Contains__, v8);
    sub_B2C35C(&Method_System_Collections_Generic_List_Renderer__GetEnumerator__, v9);
    sub_B2C35C(&System_Math_TypeInfo, v10);
    sub_B2C35C(&UnityEngine_Object_TypeInfo, v11);
    sub_B2C35C(&UnityEngine_Renderer_TypeInfo, v12);
    ...
    if ( !UnityEngine_Object__op_Equality(webView, 0LL, 0LL) )
    {
      ...
      if ( (gameObject & 1) == 0 )
      {
        if ( Component_srcLineSprite )
        {
          ...
          v21 = (struct UnityEngine_GameObject_array *)sub_B2C374(UnityEngine_GameObject___TypeInfo, 1LL);
              ...
              if ( (int)v36 >= 1 )
              {
                ...
                while ( 1 )
                {
                  ...
                  if ( (int)v39 >= 1 )
                    break;
LABEL_47:
                  LODWORD(v36) = v65->max_length;
                  v37 = v66 + 1;
                  if ( (__int64)(v66 + 1) >= (int)v36 )
                    goto LABEL_48;
                }
                v40 = 0LL;
                v41 = v65->m_Items[v37];
...
LABEL_46:
                ...
                gameObject = sub_B2C728(*(_QWORD *)(v46 + 8 * v45));
LABEL_73:
                v62 = sub_B2C460(gameObject);
                sub_B2C400(v62, 0LL);
              }
LABEL_48:
              gameObject = (__int64)this->fields.targetRenderers;
              if ( gameObject )
              {
                          ...
                          (const MethodInfo_20EA42C *)Method_System_Collections_Generic_List_Enumerator_Renderer__MoveNext__) )
                {
                  if ( !v69.fields.current )
                    sub_B2C434(0LL, v61);
                  materials = UnityEngine_Renderer__get_materials((UnityEngine_Renderer_o *)v69.fields.current, 0LL);
                  v51 = materials;
                  if ( !materials )
                    sub_B2C434(0LL, v50);
                  v52 = *((_DWORD *)materials + 6);
                  if ( v52 >= 1 )
                  {
                    for ( i = 0; i < v52; ++i )
                    {
                      ...
                      {
                        v63 = sub_B2C460(materials);
                        sub_B2C400(v63, 0LL);
                      }
                      v54 = (char *)&v51[2 * i];
                      v55 = (UnityEngine_Material_o *)*((_QWORD *)v54 + 4);
                      if ( !v55 )
                        sub_B2C434(materials, v50);
                      materials = (void *)UnityEngine_Material__HasProperty_40688736(
                                            *((UnityEngine_Material_o **)v54 + 4),
                                            this->fields.propertyName,
                                            0LL);
                      if ( ((unsigned __int8)materials & 1) != 0 )
                      {
                        Float = UnityEngine_Material__GetFloat(v55, this->fields.propertyName, 0LL);
                        ...
                        if ( vabds_f32(v58, x) <= equivalentRange )
                        {
                        ...
                        else
                        {
                          ...
                          if ( vabds_f32(v58, y) <= equivalentRange )
                            UnityEngine_Material__SetFloat(
                              v55,
                              this->fields.propertyName,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_418859C & 1) == 0 )
  {
    sub_B2C35C(&UnityEngine_MeshRenderer_var, method);
    sub_B2C35C(&UnityEngine_ParticleSystemRenderer_var, v3);
    sub_B2C35C(&UnityEngine_Renderer_var, v4);
    sub_B2C35C(&UnityEngine_SkinnedMeshRenderer_var, v5);
    sub_B2C35C(&UnityEngine_SpriteRenderer_var, v6);
