void __fastcall FGOSwapShaderPropertyWhenEnemy___ctor(FGOSwapShaderPropertyWhenEnemy_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_43521E5 & 1) == 0 )
  {
    ...
    sub_B70694(&FGOSwapShaderPropertyWhenEnemy_RendererType___TypeInfo);
    sub_B70694(&StringLiteral_16184/*"_CullMode"*/);
    byte_43521E5 = 1;
  }
  v3 = (struct FGOSwapShaderPropertyWhenEnemy_RendererType_array *)sub_B706AC(
  ...
  sub_B70630(
    ...
    v9,
    v10);
  v11 = (System_Int32_array **)StringLiteral_16184/*"_CullMode"*/;
  this->fields.propertyName = (struct System_String_o *)StringLiteral_16184/*"_CullMode"*/;
  sub_B70630((BattleServantConfConponent_o *)&this->fields.propertyName, v11, v12, v13, v14, v15, v16, v17);
  ...
  v18 = (System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData__o *)sub_B70764(System_Collections_Generic_List_Renderer__TypeInfo);
    ...
    if ( !UnityEngine_Object__op_Equality(webView, 0LL, 0LL) )
    {
      ...
      if ( (gameObject & 1) == 0 )
      {
        if ( Component_srcLineSprite )
        {
          ...
          v10 = (struct UnityEngine_GameObject_array *)sub_B706AC(UnityEngine_GameObject___TypeInfo, 1LL);
          ...
          if ( v17 )
          {
            ...
            if ( gameObject )
            {
              gameObject = sub_B70754(gameObject, v17->obj.klass->_1.element_class);
              if ( !gameObject )
              {
                v53 = sub_B7078C(0LL);
                sub_B70738(v53, 0LL);
            ...
            sub_B70630((BattleServantConfConponent_o *)v17->m_Items, v24, v18, v19, v20, v21, v22, v23);
...
LABEL_46:
                ...
                gameObject = sub_B70A60(*(_QWORD *)(v35 + 8 * v34));
LABEL_73:
                          ...
                          (const MethodInfo_22212CC *)Method_System_Collections_Generic_List_Enumerator_Renderer__MoveNext__) )
                {
                  ...
                  if ( v41 >= 1 )
                  {
                    for ( i = 0; i < v41; ++i )
                    {
                      ...
                      {
                        v52 = sub_B70798(materials);
                        sub_B70738(v52, 0LL);
                      }
                      v43 = (char *)&v40[2 * i];
                      v44 = (UnityEngine_Material_o *)*((_QWORD *)v43 + 4);
                      if ( !v44 )
                        sub_B7076C(materials, v39);
                      materials = (void *)UnityEngine_Material__HasProperty_41121140(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_43521E2 & 1) == 0 )
  {
    sub_B70694(&UnityEngine_MeshRenderer_var);
    sub_B70694(&UnityEngine_ParticleSystemRenderer_var);
    sub_B70694(&UnityEngine_Renderer_var);
    sub_B70694(&UnityEngine_SkinnedMeshRenderer_var);
    sub_B70694(&UnityEngine_SpriteRenderer_var);
