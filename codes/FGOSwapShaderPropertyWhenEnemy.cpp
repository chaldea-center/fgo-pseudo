void FGOSwapShaderPropertyWhenEnemy___ctor(FGOSwapShaderPropertyWhenEnemy_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C41D48 & 1) == 0 )
  {
    ...
    sub_1C37058(&FGOSwapShaderPropertyWhenEnemy_RendererType___TypeInfo);
    sub_1C37058(&StringLiteral_16182/*"_CullMode"*/);
    byte_4C41D48 = 1;
  }
  v3 = sub_1C37100(FGOSwapShaderPropertyWhenEnemy_RendererType___TypeInfo, 1);
  if ( !v3 )
    sub_1C372B4(0);
  if ( !*(_DWORD *)(v3 + 24) )
    sub_1C372BC(v3);
  *(_DWORD *)(v3 + 32) = 1;
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.targetRendererTypes, v3, v4, v5);
  v6 = StringLiteral_16182/*"_CullMode"*/;
  this->fields.propertyName = (struct System_String_o *)StringLiteral_16182/*"_CullMode"*/;
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.propertyName, v6, v7, v8);
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.targetRenderers, (int32_t)v9, v10, v11);
    ...
    if ( !UnityEngine_Object__op_Equality(monitor, 0, 0) )
    {
      ...
      if ( ((unsigned __int8)gameObject & 1) == 0 )
      {
        if ( Component_object )
        {
          ...
          v10 = (struct UnityEngine_GameObject_array *)sub_1C37100(UnityEngine_GameObject___TypeInfo, 1);
          this->fields.targetObjects = v10;
          sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.targetObjects, (int32_t)v10, v11, v12);
          ...
          if ( v13 )
          {
            ...
            sub_1C36FFC((CGThumbnailListItem_o *)v13->m_Items, (int32_t)gameObject, v14, v15);
                ...
                while ( 1 )
                {
                  ...
                  if ( ((unsigned __int8)gameObject & 1) == 0 )
                  {
                    ...
                    else
                    {
                      ...
                      *(_QWORD *)(v33 + 32) = v26;
                      sub_1C36FFC((CGThumbnailListItem_o *)(v33 + 32), (int32_t)v26, v28, v29);
                    }
                  }
                          ...
                          (const MethodInfo_352D810 *)Method_System_Collections_Generic_List_Enumerator_Renderer__MoveNext__) )
                {
                  ...
                  if ( v36 >= 1 )
                  {
                    for ( i = 0; i < v36; ++i )
                    {
                      ...
                      materials = (void *)UnityEngine_Material__HasProperty_71132888(
...
System_Type_o *FGOSwapShaderPropertyWhenEnemy__ToRendererType(int32_t rendererType, const MethodInfo *method)
{
  ...
  if ( (byte_4C41D45 & 1) == 0 )
  {
    sub_1C37058(&UnityEngine_MeshRenderer_var);
    sub_1C37058(&UnityEngine_ParticleSystemRenderer_var);
    sub_1C37058(&UnityEngine_Renderer_var);
    sub_1C37058(&UnityEngine_SkinnedMeshRenderer_var);
    sub_1C37058(&UnityEngine_SpriteRenderer_var);
