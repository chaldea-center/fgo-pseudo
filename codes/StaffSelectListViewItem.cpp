        ...
        const MethodInfo *method)
{
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields._StaffPhotoEntity_k__BackingField, (int32_t)entity, v13, v14);
  if ( !entity )
    goto LABEL_7;
  id = entity->fields.id;
...
LABEL_6:
  ...
  *((_BYTE *)p_PhotoCampaignAtlas_k__BackingField - 7) = v20;
  sub_1B8635C((CGThumbnailListItem_o *)p_PhotoCampaignAtlas_k__BackingField, (int32_t)photoCampaignAtlas, v17, v18);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !StaffPhotoEntity_k__BackingField )
    sub_1B86614(this, selectStaffPhotoId);
