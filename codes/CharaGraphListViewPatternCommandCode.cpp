        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB818 & 1) == 0 )
  {
    sub_1B640C8(&Method_BasicHelper_ToIterator_CharaGraphCommandCodeListViewItem___, method);
    sub_1B640C8(&Method_CharaGraphListViewPatternBase_GetMaster_UserCommandCodeMaster___, v4);
    sub_1B640C8(&Method_CharaGraphListViewPatternBase_GetMaster_UserServantCommandCodeMaster___, v5);
    sub_1B640C8(&System_Func_int__CharaGraphCommandCodeListViewItem__TypeInfo, v6);
    sub_1B640C8(&NetworkManager_TypeInfo, v7);
    sub_1B640C8(&Method_CharaGraphListViewPatternCommandCode___c__DisplayClass2_0__GenerateListViewItem_b__0__, v8);
    sub_1B640C8(&CharaGraphListViewPatternCommandCode___c__DisplayClass2_0_TypeInfo, v9);
    byte_49FB818 = 1;
  }
  v10 = sub_1B64314(CharaGraphListViewPatternCommandCode___c__DisplayClass2_0_TypeInfo, method, v2);
  System_Object___ctor((Il2CppObject *)v10, 0LL);
  if ( !v10 )
    goto LABEL_10;
  *(_QWORD *)(v10 + 16) = this;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)(v10 + 16), (int32_t)this, v12, v13);
  Master_object = (UserCommandCodeMaster_o *)CharaGraphListViewPatternBase__GetMaster_object_((const MethodInfo_2E2D0EC *)Method_CharaGraphListViewPatternBase_GetMaster_UserCommandCodeMaster___);
  if ( !Master_object )
    goto LABEL_10;
  List = UserCommandCodeMaster__getList(Master_object, 0LL);
  *(_QWORD *)(v10 + 24) = List;
  v15 = (__int64 *)(v10 + 24);
  sub_1B6406C((ServantStatusBattleListViewItem_o *)(v10 + 24), (int32_t)List, v16, v17);
  v18 = CharaGraphListViewPatternBase__GetMaster_object_((const MethodInfo_2E2D0EC *)Method_CharaGraphListViewPatternBase_GetMaster_UserServantCommandCodeMaster___);
...
LABEL_10:
  ...
  v22 = (System_Func_T__TResult__o *)sub_1B64314(System_Func_int__CharaGraphCommandCodeListViewItem__TypeInfo, v19, v20);
  ...
  return (System_Collections_Generic_IEnumerable_CharaGraphListViewItemBase__o *)BasicHelper__ToIterator_object_(
                                                                                   *(_DWORD *)(v21 + 24),
                                                                                   ...
                                                                                   (const MethodInfo_2E29810 *)Method_BasicHelper_ToIterator_CharaGraphCommandCodeListViewItem___);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_49FB817 & 1) == 0 )
  {
    sub_1B640C8(&StringLiteral_3698/*"COMMAND_CODE_EMPTY"*/, method);
    byte_49FB817 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB819 & 1) == 0 )
  {
    this = (CharaGraphListViewPatternCommandCode___c__DisplayClass2_0_o *)sub_1B640C8(
  ...
  v9 = (CharaGraphCommandCodeListViewItem_o *)sub_1B64314(
                                                CharaGraphCommandCodeListViewItem_TypeInfo,
                                                *(_QWORD *)&i,
                                                method);
