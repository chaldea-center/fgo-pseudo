        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC6702 & 1) == 0 )
  {
    sub_1C713B0(&Method_BasicHelper_ToIterator_CharaGraphCommandCodeListViewItem___);
    sub_1C713B0(&Method_CharaGraphListViewPatternBase_GetMaster_UserCommandCodeMaster___);
    sub_1C713B0(&Method_CharaGraphListViewPatternBase_GetMaster_UserServantCommandCodeMaster___);
    sub_1C713B0(&System_Func_int__CharaGraphCommandCodeListViewItem__TypeInfo);
    sub_1C713B0(&NetworkManager_TypeInfo);
    sub_1C713B0(&Method_CharaGraphListViewPatternCommandCode___c__DisplayClass2_0__GenerateListViewItem_b__0__);
    sub_1C713B0(&CharaGraphListViewPatternCommandCode___c__DisplayClass2_0_TypeInfo);
    byte_4CC6702 = 1;
  }
  v3 = sub_1C715FC(CharaGraphListViewPatternCommandCode___c__DisplayClass2_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v3, 0);
  if ( !v3 )
    goto LABEL_14;
  *(_QWORD *)(v3 + 16) = this;
  sub_1C71354((GrandQuestFolderBoardItem_o *)(v3 + 16), (int32_t)this, v6, v7, v8, v9, v10, v11);
  Master_object = (UserCommandCodeMaster_o *)CharaGraphListViewPatternBase__GetMaster_object_((const MethodInfo_313E784 *)Method_CharaGraphListViewPatternBase_GetMaster_UserCommandCodeMaster___);
  if ( !Master_object )
    goto LABEL_14;
  List = UserCommandCodeMaster__getList(Master_object, 0);
  *(_QWORD *)(v3 + 24) = List;
  v13 = (__int64 *)(v3 + 24);
  sub_1C71354((GrandQuestFolderBoardItem_o *)(v3 + 24), (int32_t)List, v14, v15, v16, v17, v18, v19);
  v20 = CharaGraphListViewPatternBase__GetMaster_object_((const MethodInfo_313E784 *)Method_CharaGraphListViewPatternBase_GetMaster_UserServantCommandCodeMaster___);
...
LABEL_14:
  ...
  v22 = (System_Func_T__TResult__o *)sub_1C715FC(System_Func_int__CharaGraphCommandCodeListViewItem__TypeInfo);
  ...
  return (System_Collections_Generic_IEnumerable_CharaGraphListViewItemBase__o *)BasicHelper__ToIterator_object_(
                                                                                   *(_DWORD *)(v21 + 24),
                                                                                   ...
                                                                                   (const MethodInfo_313AB7C *)Method_BasicHelper_ToIterator_CharaGraphCommandCodeListViewItem___);
}
        ...
        const MethodInfo *method)
{
  ...
  return (System_String_o *)StringLiteral_3642/*"COMMAND_CODE_EMPTY"*/;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC6703 & 1) == 0 )
  {
    this = (CharaGraphListViewPatternCommandCode___c__DisplayClass2_0_o *)sub_1C713B0(&CharaGraphCommandCodeListViewItem_TypeInfo);
    byte_4CC6703 = 1;
  }
  ...
  v9 = (CharaGraphCommandCodeListViewItem_o *)sub_1C715FC(CharaGraphCommandCodeListViewItem_TypeInfo);
