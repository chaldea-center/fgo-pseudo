void __fastcall ChainableActionBase___ctor(ChainableActionBase_o *this, const MethodInfo *method)
{
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&v2->fields, 0LL, v3, v4, v5, v6, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB8E4F & 1) == 0 )
  {
    this = (ChainableActionBase_o *)sub_1C13D24(&System_Action_TypeInfo, endCallbacks);
    byte_4BB8E4F = 1;
  }
  if ( !v4->fields._IsExecuted_k__BackingField )
  {
    if ( !endCallbacks )
      sub_1C13F80(this, endCallbacks);
...
LABEL_16:
        ...
        sub_1C13CC8((PartyOrganizationUtility_o *)&v4->fields, (int64_t)v8, v9, v10, v11, v12, v13, v14);
