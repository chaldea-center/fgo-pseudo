void __fastcall ChainableActionBase___ctor(ChainableActionBase_o *this, const MethodInfo *method)
{
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&v2->fields, 0, v3, v4);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A32786 & 1) == 0 )
  {
    this = (ChainableActionBase_o *)sub_1B761C0(&System_Action_TypeInfo, endCallbacks);
    byte_4A32786 = 1;
  }
  if ( !v4->fields._IsExecuted_k__BackingField )
  {
    if ( !endCallbacks )
      sub_1B7641C(this, endCallbacks);
...
LABEL_16:
        ...
        sub_1B76164((ServantStatusBattleListViewItem_o *)&v4->fields, (int32_t)v8, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.nextAction, (int32_t)nextAction, (int32_t)method, v3);
}
