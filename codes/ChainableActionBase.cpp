void __fastcall ChainableActionBase___ctor(ChainableActionBase_o *this, const MethodInfo *method)
{
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&v2->fields, 0, v3, v4);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B065AA & 1) == 0 )
  {
    this = (ChainableActionBase_o *)sub_1BC3008(&System_Action_TypeInfo, endCallbacks);
    byte_4B065AA = 1;
  }
  if ( !v4->fields._IsExecuted_k__BackingField )
  {
    if ( !endCallbacks )
      sub_1BC3264(this, endCallbacks);
      ...
      do
      {
        ...
        if ( v8 )
        {
            ...
            || (*p_fields = v8, (System_Action_c *)v8->klass != v11) )
          {
            sub_1BC3524(v8);
LABEL_16:
            sub_1BC326C(this, endCallbacks, method);
          }
        }
        else
        {
        ...
        sub_1BC2FAC((CGThumbnailListItem_o *)&v4->fields, (int32_t)v8, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.nextAction, (int32_t)nextAction, (int32_t)method, v3);
}
