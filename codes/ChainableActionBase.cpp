void __fastcall ChainableActionBase___ctor(ChainableActionBase_o *this, const MethodInfo *method)
{
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&v2->fields, 0LL, v3, v4, v5, v6, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6B33F & 1) == 0 )
  {
    this = (ChainableActionBase_o *)sub_1BE4ACC(&System_Action_TypeInfo, endCallbacks);
    byte_4B6B33F = 1;
  }
  if ( !v4->fields._IsExecuted_k__BackingField )
  {
    if ( !endCallbacks )
      sub_1BE4D28(this, endCallbacks);
...
LABEL_16:
        ...
        sub_1BE4A70((PartyOrganizationUtility_o *)&v4->fields, (int64_t)v8, v9, v10, v11, v12, v13, v14);
