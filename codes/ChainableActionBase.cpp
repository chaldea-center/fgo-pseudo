void __fastcall ChainableActionBase___ctor(ChainableActionBase_o *this, const MethodInfo *method)
{
  ...
  sub_B52920((BattleServantConfConponent_o *)&v2->fields, 0LL, v3, v4, v5, v6, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B16FF & 1) == 0 )
  {
    this = (ChainableActionBase_o *)sub_B52984(&System_Action_TypeInfo);
    byte_42B16FF = 1;
  }
    ...
    if ( (int)v5 >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        *p_fields = (System_Delegate_o *)v8;
        sub_B52920((BattleServantConfConponent_o *)&v4->fields, v8, v9, v10, v11, v12, v13, v14);
        LODWORD(v5) = endCallbacks->max_length;
        if ( (__int64)++v6 >= (int)v5 )
          return v4;
      }
      this = (ChainableActionBase_o *)sub_B52D50(v8);
LABEL_14:
      sub_B52A5C(this, endCallbacks);
    }
  }
  return v4;
}
