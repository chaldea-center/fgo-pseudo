        ...
        const MethodInfo *method)
{
  ...
  this->fields.id = id;
  p_id = &this->fields.id;
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.id, (int32_t)id, index, (const MethodInfo *)callback);
  ...
  *((_DWORD *)p_callback - 2) = index;
  sub_1C6B9AC((CGThumbnailListItem_o *)p_callback, (int32_t)callback, v12, v13);
}
