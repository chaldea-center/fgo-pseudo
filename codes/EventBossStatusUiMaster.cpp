void __fastcall EventBossStatusUiMaster___ctor(EventBossStatusUiMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A6FD54 & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_EventBossStatusUiMaster__EventBossStatusUiEntity__string___ctor__, method);
    byte_4A6FD54 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    288,
    (const MethodInfo_312C8C0 *)Method_DataMasterBase_EventBossStatusUiMaster__EventBossStatusUiEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (EventBossStatusUiEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                        (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                        PK,
                                        (const MethodInfo_312C900 *)Method_DataMasterBase_EventBossStatusUiMaster__EventBossStatusUiEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FD55 & 1) == 0 )
  {
    ...
    sub_1B90010(&EventBossStatusUiEntity_TypeInfo, v5);
    ...
    sub_1B90010(&Method_System_Collections_Generic_List_EventBossStatusUiEntity__Add__, v9);
    sub_1B90010(&Method_System_Collections_Generic_List_EventBossStatusUiEntity___ctor__, v10);
    sub_1B90010(&System_Collections_Generic_List_EventBossStatusUiEntity__TypeInfo, v11);
    byte_4A6FD55 = 1;
  }
  v12 = (System_Collections_Generic_List_object__o *)sub_1B9025C(System_Collections_Generic_List_EventBossStatusUiEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v12,
    (const MethodInfo_351018C *)Method_System_Collections_Generic_List_EventBossStatusUiEntity___ctor__);
...
LABEL_35:
    ...
    {
      if ( !v12 )
        sub_1B9026C(v25, EventBossStatusUiEntity_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FD53 & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_EventBossStatusUiMaster__EventBossStatusUiEntity__string__TryGetEntity__, entity);
    byte_4A6FD53 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_312C950 *)Method_DataMasterBase_EventBossStatusUiMaster__EventBossStatusUiEntity__string__TryGetEntity__);
}