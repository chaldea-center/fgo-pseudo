void __fastcall PartyOrganizationChangeMenu___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A6BCD1 & 1) == 0 )
  {
    ...
    sub_1B90010(&PartyOrganizationChangeMenu_TypeInfo, v2);
    byte_4A6BCD1 = 1;
  }
...
void __fastcall PartyOrganizationChangeMenu___ctor(PartyOrganizationChangeMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6BCD0 & 1) == 0 )
  {
    ...
    sub_1B90010(&BaseMenu_TypeInfo, v3);
    sub_1B90010(&PartyOrganizationChangeObject___TypeInfo, v4);
    byte_4A6BCD0 = 1;
  }
  ...
  v6 = (struct PartyOrganizationChangeObject_array *)sub_1B900B8(
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.partyOrganizationChangeObjectList, (int32_t)v6, v7, v8);
...
LABEL_8:
  ...
  while ( 1 )
  {
    ...
    if ( (unsigned int)v5 >= max_length )
      sub_1B90274(mainDeckBase, method);
...
void __fastcall PartyOrganizationChangeMenu__Close(PartyOrganizationChangeMenu_o *this, const MethodInfo *method)
{
  ...
  PartyOrganizationChangeMenu__Close_32017396(this, 0LL, v2);
}


void __fastcall PartyOrganizationChangeMenu__Close_32017396(
        PartyOrganizationChangeMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6BCC8 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_PartyOrganizationChangeMenu_EndClose__, v6);
    byte_4A6BCC8 = 1;
  }
...
void __fastcall PartyOrganizationChangeMenu__EndOpen(PartyOrganizationChangeMenu_o *this, const MethodInfo *method)
{
  ...
  UnityEngine_Rect_o v44; // 0:s3.4,4:s4.4,8:s5.4,12:s6.4

  if ( (byte_4A6BCC7 & 1) == 0 )
  {
    sub_1B90010(&System_Action_TypeInfo, method);
    sub_1B90010(&PartyOrganizationChangeObject_CallbackFunc_TypeInfo, v5);
    sub_1B90010(&Method_UnityEngine_Component_GetComponent_FSOffset___, v6);
    sub_1B90010(&FSUtility_TypeInfo, v7);
    sub_1B90010(&LocalizationManager_TypeInfo, v8);
    sub_1B90010(&Method_PartyOrganizationChangeMenu_EndOpenTutorialArrow__, v9);
    sub_1B90010(&Method_PartyOrganizationChangeMenu_OnClickEmptyItem__, v10);
    sub_1B90010(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v11);
    sub_1B90010(&StringLiteral_10008/*"OpenServantDetail"*/, v12);
    sub_1B90010(&StringLiteral_13527/*"TUTORIAL_MESSAGE_PARTY_ORGANIZATION4"*/, v13);
    byte_4A6BCC7 = 1;
  }
  if ( (this->fields.openSelectMember & 0x80000000) != 0 )
  {
    ...
    if ( mode )
    {
      ...
      if ( mode == 5 )
      {
        ...
        v36 = LocalizationManager__Get((System_String_o *)StringLiteral_13527/*"TUTORIAL_MESSAGE_PARTY_ORGANIZATION4"*/, 0LL);
        v37 = (System_Action_o *)sub_1B9025C(System_Action_TypeInfo);
        System_Action___ctor(v37, (Il2CppObject *)this, Method_PartyOrganizationChangeMenu_EndOpenTutorialArrow__, 0LL);
        if ( !Instance )
          goto LABEL_47;
        v42.fields.x = AddOffset.fields.x + 422.0;
        v42.fields.y = AddOffset.fields.y + -231.0;
        v43.fields.m_XMin = AddOffset.fields.x + 329.0;
        v43.fields.m_YMin = AddOffset.fields.y + -291.0;
        v43.fields.m_Width = 190.0;
        v43.fields.m_Height = 90.0;
        CommonUI__OpenTutorialNotificationDialogArrow((CommonUI_o *)Instance, v36, v42, v43, 0.0, 0LL, -1, v37, 0LL);
      }
      else if ( mode == 4 )
      {
        tutorialMaskBase = this->fields.tutorialMaskBase;
        ...
        v25 = (PartyOrganizationChangeObject_CallbackFunc_o *)sub_1B9025C(PartyOrganizationChangeObject_CallbackFunc_TypeInfo);
        ...
        if ( !tutorialPartyOrganizationChangeEmptyObject )
          goto LABEL_47;
        PartyOrganizationChangeObject__SetItem(tutorialPartyOrganizationChangeEmptyObject, partyItem, 1, v25, v26);
        tutorialAddOffsetFS = this->fields.tutorialAddOffsetFS;
        if ( !FSUtility_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(FSUtility_TypeInfo);
        v28 = FSUtility__GetAddOffset(tutorialAddOffsetFS, 1, 0LL);
        ...
        System_Action___ctor(v30, (Il2CppObject *)this, Method_PartyOrganizationChangeMenu_EndOpenTutorialArrow__, 0LL);
        if ( !v29 )
          goto LABEL_47;
        v44.fields.m_YMin = v28.fields.y + -205.0;
        v44.fields.m_XMin = v28.fields.x + -320.0;
        v41.fields.y = v28.fields.y + 70.0;
        v41.fields.x = v28.fields.x + -245.0;
        v44.fields.m_Width = 150.0;
        v44.fields.m_Height = 380.0;
        CommonUI__OpenTutorialArrowMark((CommonUI_o *)v29, v41, 0.0, v44, v30, 0LL);
      }
    }
    ...
    case 3:
      ...
      if ( partyOrganizationChangeObjectList )
      {
        ...
        if ( (unsigned int)openSelectMember >= partyOrganizationChangeObjectList->max_length )
          sub_1B90274(tutorialMaskBase, method);
        ...
        if ( tutorialMaskBase )
        {
          UnityEngine_Component__SendMessage_69510680(
            (UnityEngine_Component_o *)tutorialMaskBase,
            (System_String_o *)StringLiteral_10008/*"OpenServantDetail"*/,
            0LL);
          return;
        }
      }
...
LABEL_10:
  ...
  while ( 1 )
  {
    ...
    if ( (int)v5 >= max_length )
      break;
    if ( (unsigned int)v5 >= max_length )
      sub_1B90274(basePartyItem, method);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B90010(&System_Action_TypeInfo, method);
    sub_1B90010(&Method_PartyOrganizationChangeMenu_EndCloseTutorialArrowDecide__, v4);
    sub_1B90010(&Method_PartyOrganizationChangeMenu_OnClickDecide__, v5);
  ...
  if ( state == 7 )
  {
    if ( this->fields.mode == 5 )
    {
      ...
      if ( (*((_BYTE *)Method_PartyOrganizationChangeMenu_OnClickDecide__ + 83) & 2) != 0 )
        v8 = (_QWORD *)sub_1B90028(Method_PartyOrganizationChangeMenu_OnClickDecide__);
      ...
      if ( !Instance )
        sub_1B9026C(v12, v13);
      CommonUI__CloseTutorialNotificationDialogArrow_30550932((CommonUI_o *)Instance, v11, 0LL);
    }
  }
  else if ( state == 2 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6BCCE & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_PartyOrganizationChangeMenu_EndCloseTutorialArrowEmptyItem__, v5);
    sub_1B90010(&Method_PartyOrganizationChangeMenu_OnClickEmptyItem__, v6);
  ...
  if ( this->fields.state == 7 && this->fields.mode == 4 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationChangeMenu_OnClickEmptyItem__ + 83) & 2) != 0 )
      v8 = (_QWORD *)sub_1B90028(Method_PartyOrganizationChangeMenu_OnClickEmptyItem__);
    v9 = (System_Reflection_MethodBase_o *)sub_1B8FFF4(v8, v8[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6BCCB & 1) == 0 )
  {
    sub_1B90010(&Method_PartyOrganizationChangeMenu_OnClickInfomation__, method);
    byte_4A6BCCB = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationChangeMenu_OnClickInfomation__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B90028(Method_PartyOrganizationChangeMenu_OnClickInfomation__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6BCCC & 1) == 0 )
  {
    sub_1B90010(&Method_PartyOrganizationChangeMenu_OnClickPointEvent__, method);
    byte_4A6BCCC = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationChangeMenu_OnClickPointEvent__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B90028(Method_PartyOrganizationChangeMenu_OnClickPointEvent__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B8FFF4(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
    this->fields.state = 3;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6BCCD & 1) == 0 )
  {
    sub_1B90010(&Method_PartyOrganizationChangeMenu_OnClickQuestInfomation__, method);
    byte_4A6BCCD = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationChangeMenu_OnClickQuestInfomation__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B90028(Method_PartyOrganizationChangeMenu_OnClickQuestInfomation__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B8FFF4(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
    this->fields.state = 3;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6BCC6 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_PartyOrganizationChangeMenu_EndOpen__, v21);
    sub_1B90010(&StringLiteral_10287/*"PARTY_ORGANIZATION_QUEST_RESTRICTION_EXPLANATION_COLOR"*/, v22);
    sub_1B90010(&StringLiteral_10313/*"PARTY_ORGANIZATION_SERVANT_CHANGE_EXPLANATION"*/, v23);
    byte_4A6BCC6 = 1;
  }
  message = 0LL;
  switch ( this->fields.state )
  {
    case 0:
      ...
      sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.openCallbackFunc, (int32_t)openCallback, v31, v32);
      this->fields.basePartyItem = basePartyItem;
      sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.basePartyItem, (int32_t)basePartyItem, v33, v34);
      this->fields.partyItem = partyItem;
      sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.partyItem, (int32_t)partyItem, v35, v36);
      this->fields.openSelectMember = selectMember;
      this->fields.setupInfo = setupInfo;
      sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.setupInfo, (int32_t)setupInfo, v37, v38);
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10313/*"PARTY_ORGANIZATION_SERVANT_CHANGE_EXPLANATION"*/, 0LL);
      if ( !explanationLabel )
        goto LABEL_22;
      ...
      if ( questRestrictionInfo && QuestRestrictionInfo__GetExplanationMessage(questRestrictionInfo, &message, 0LL) )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        v46 = LocalizationManager__Get((System_String_o *)StringLiteral_10287/*"PARTY_ORGANIZATION_QUEST_RESTRICTION_EXPLANATION_COLOR"*/, 0LL);
        gameObject = (UnityEngine_GameObject_o *)System_String__Concat_61787092(v46, message, 0LL);
...
LABEL_22:
    ...
    case 7:
      ...
      this->fields.basePartyItem = basePartyItem;
      sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.basePartyItem, (int32_t)basePartyItem, v26, v27);
      this->fields.partyItem = partyItem;
      sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.partyItem, (int32_t)partyItem, v28, v29);
      this->fields.openSelectMember = selectMember;
      goto LABEL_21;
    case 5:
      this->fields.mode = tutorialMode;
      ...
      sub_1B8FFB4(
        ...
        (int32_t)basePartyItem);
      this->fields.openCallbackFunc = openCallback;
      sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.openCallbackFunc, (int32_t)openCallback, v50, v51);
      this->fields.basePartyItem = basePartyItem;
      sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.basePartyItem, (int32_t)basePartyItem, v52, v53);
      this->fields.partyItem = partyItem;
      sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.partyItem, (int32_t)partyItem, v54, v55);
      this->fields.openSelectMember = selectMember;
      this->fields.setupInfo = setupInfo;
      sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.setupInfo, (int32_t)setupInfo, v56, v57);
      this->fields.questRestrictionInfo = questRestrictionInfo;
      sub_1B8FFB4(
        (ServantStatusBattleListViewItem_o *)&this->fields.questRestrictionInfo,
        (int32_t)questRestrictionInfo,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6BCC5 & 1) == 0 )
  {
    sub_1B90010(&PartyOrganizationChangeObject_CallbackFunc_TypeInfo, *(_QWORD *)&friendBonusVal);
    sub_1B90010(&Method_PartyOrganizationChangeMenu_OnClickItem__, v5);
    byte_4A6BCC5 = 1;
  }
...
LABEL_11:
  ...
  while ( 1 )
  {
    ...
    if ( (unsigned int)v8 >= max_length )
      sub_1B90274(partyListViewIndicator, *(_QWORD *)&friendBonusVal);
    partyItem = this->fields.partyItem;
    v11 = partyOrganizationChangeObjectList->m_Items[v8];
    v12 = (PartyOrganizationChangeObject_CallbackFunc_o *)sub_1B9025C(PartyOrganizationChangeObject_CallbackFunc_TypeInfo);
    PartyOrganizationChangeObject_CallbackFunc___ctor(
      v12,
      (Il2CppObject *)this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6BCC9 & 1) == 0 )
  {
    ...
    sub_1B90010(&PartyOrganizationChangeMenu_TypeInfo, v9);
    sub_1B90010(&QuestInformationComponent_TypeInfo, v10);
    sub_1B90010(&StringLiteral_17697/*"buttontxt_formation_20"*/, v11);
    byte_4A6BCC9 = 1;
  }
  questRestrictionInfo = this->fields.questRestrictionInfo;
  if ( questRestrictionInfo )
...
LABEL_8:
  ...
  if ( (v16 & 1) != 0 )
  {
    ...
    partyRemoveButton = (QuestRestrictionInfo_o *)System_Convert__ToInt32_62409428(setupInfo != 0LL, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6BCC3 & 1) == 0 )
  {
    sub_1B90010(&PartyOrganizationChangeMenu_CallbackFunc_TypeInfo, value);
    byte_4A6BCC3 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  ...
  v11 = (PartyOrganizationChangeMenu_o *)sub_1B9052C(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19D0138;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19D00E0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6BCD2 & 1) == 0 )
  {
    ...
    sub_1B90010(&PartyOrganizationChangeMenu_ResultKind_TypeInfo, v9);
    byte_4A6BCD2 = 1;
  }
  v14[2] = 0LL;
