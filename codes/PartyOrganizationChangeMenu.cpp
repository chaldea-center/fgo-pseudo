void __fastcall PartyOrganizationChangeMenu___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AFDA89 & 1) == 0 )
  {
    ...
    sub_1BC3008(&PartyOrganizationChangeMenu_TypeInfo, v2);
    byte_4AFDA89 = 1;
  }
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)PartyOrganizationChangeMenu_TypeInfo->static_fields, (int32_t)v3, v5, v6);
}
...
void __fastcall PartyOrganizationChangeMenu___ctor(PartyOrganizationChangeMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFDA88 & 1) == 0 )
  {
    ...
    sub_1BC3008(&BaseMenu_TypeInfo, v3);
    sub_1BC3008(&PartyOrganizationChangeObject___TypeInfo, v4);
    byte_4AFDA88 = 1;
  }
  ...
  v6 = (struct PartyOrganizationChangeObject_array *)sub_1BC30B0(
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.partyOrganizationChangeObjectList, (int32_t)v6, v7, v8);
...
LABEL_8:
  ...
  while ( 1 )
  {
    ...
    if ( (unsigned int)v6 >= max_length )
      sub_1BC326C(mainDeckBase, method, v4);
...
void __fastcall PartyOrganizationChangeMenu__Close(PartyOrganizationChangeMenu_o *this, const MethodInfo *method)
{
  ...
  PartyOrganizationChangeMenu__Close_33283304(this, 0LL, v2);
}


void __fastcall PartyOrganizationChangeMenu__Close_33283304(
        PartyOrganizationChangeMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFDA80 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_PartyOrganizationChangeMenu_EndClose__, v6);
    byte_4AFDA80 = 1;
  }
...
void __fastcall PartyOrganizationChangeMenu__EndOpen(PartyOrganizationChangeMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFDA7F & 1) == 0 )
  {
    ...
    sub_1BC3008(&PartyOrganizationChangeObject_CallbackFunc_TypeInfo, v5);
    sub_1BC3008(&Method_UnityEngine_Component_GetComponent_FSOffset___, v6);
    sub_1BC3008(&FSUtility_TypeInfo, v7);
    sub_1BC3008(&LocalizationManager_TypeInfo, v8);
    sub_1BC3008(&Method_PartyOrganizationChangeMenu_EndOpenTutorialArrow__, v9);
    sub_1BC3008(&Method_PartyOrganizationChangeMenu_OnClickEmptyItem__, v10);
    sub_1BC3008(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v11);
    sub_1BC3008(&StringLiteral_9915/*"OpenServantDetail"*/, v12);
    sub_1BC3008(&StringLiteral_13468/*"TUTORIAL_MESSAGE_PARTY_ORGANIZATION4"*/, v13);
    byte_4AFDA7F = 1;
  }
  if ( (this->fields.openSelectMember & 0x80000000) != 0 )
  {
    ...
    if ( mode )
    {
      ...
      if ( mode == 5 )
      {
        ...
        v38 = LocalizationManager__Get((System_String_o *)StringLiteral_13468/*"TUTORIAL_MESSAGE_PARTY_ORGANIZATION4"*/, 0LL);
      ...
      else if ( mode == 4 )
      {
        ...
        v25 = (PartyOrganizationChangeObject_CallbackFunc_o *)sub_1BC3254(PartyOrganizationChangeObject_CallbackFunc_TypeInfo);
    ...
    case 3:
      ...
      if ( partyOrganizationChangeObjectList )
      {
        ...
        if ( (unsigned int)openSelectMember >= partyOrganizationChangeObjectList->max_length )
          sub_1BC326C(tutorialMaskBase, method, v32);
        ...
        if ( tutorialMaskBase )
        {
          UnityEngine_Component__SendMessage_70006020(
            (UnityEngine_Component_o *)tutorialMaskBase,
            (System_String_o *)StringLiteral_9915/*"OpenServantDetail"*/,
            0LL);
          return;
        }
      }
...
void __fastcall PartyOrganizationChangeMenu__ModifyItem(PartyOrganizationChangeMenu_o *this, const MethodInfo *method)
{
  ...
  while ( 1 )
  {
    ...
    if ( (int)v6 >= max_length )
      break;
    if ( (unsigned int)v6 >= max_length )
      sub_1BC326C(partyItem, method, v4);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BC3008(&System_Action_TypeInfo, method);
    sub_1BC3008(&Method_PartyOrganizationChangeMenu_EndCloseTutorialArrowDecide__, v4);
    sub_1BC3008(&Method_PartyOrganizationChangeMenu_OnClickDecide__, v5);
  ...
  if ( state == 7 )
  {
    if ( this->fields.mode == 5 )
    {
      ...
      if ( (*((_BYTE *)Method_PartyOrganizationChangeMenu_OnClickDecide__ + 83) & 2) != 0 )
        v8 = (_QWORD *)sub_1BC3020(Method_PartyOrganizationChangeMenu_OnClickDecide__);
      ...
      if ( !Instance )
        sub_1BC3264(v12, v13);
      CommonUI__CloseTutorialNotificationDialogArrow_30756568((CommonUI_o *)Instance, v11, 0LL);
    }
  }
  else if ( state == 2 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFDA86 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_PartyOrganizationChangeMenu_EndCloseTutorialArrowEmptyItem__, v5);
    sub_1BC3008(&Method_PartyOrganizationChangeMenu_OnClickEmptyItem__, v6);
  ...
  if ( this->fields.state == 7 && this->fields.mode == 4 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationChangeMenu_OnClickEmptyItem__ + 83) & 2) != 0 )
      v8 = (_QWORD *)sub_1BC3020(Method_PartyOrganizationChangeMenu_OnClickEmptyItem__);
    v9 = (System_Reflection_MethodBase_o *)sub_1BC2FEC(v8, v8[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFDA83 & 1) == 0 )
  {
    sub_1BC3008(&Method_PartyOrganizationChangeMenu_OnClickInfomation__, method);
    byte_4AFDA83 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationChangeMenu_OnClickInfomation__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BC3020(Method_PartyOrganizationChangeMenu_OnClickInfomation__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFDA84 & 1) == 0 )
  {
    sub_1BC3008(&Method_PartyOrganizationChangeMenu_OnClickPointEvent__, method);
    byte_4AFDA84 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationChangeMenu_OnClickPointEvent__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BC3020(Method_PartyOrganizationChangeMenu_OnClickPointEvent__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BC2FEC(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
    this->fields.state = 3;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFDA85 & 1) == 0 )
  {
    sub_1BC3008(&Method_PartyOrganizationChangeMenu_OnClickQuestInfomation__, method);
    byte_4AFDA85 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationChangeMenu_OnClickQuestInfomation__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BC3020(Method_PartyOrganizationChangeMenu_OnClickQuestInfomation__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BC2FEC(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
    this->fields.state = 3;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFDA7E & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_PartyOrganizationChangeMenu_EndOpen__, v20);
    sub_1BC3008(&StringLiteral_10175/*"PARTY_ORGANIZATION_QUEST_RESTRICTION_EXPLANATION_COLOR"*/, v21);
    sub_1BC3008(&StringLiteral_10201/*"PARTY_ORGANIZATION_SERVANT_CHANGE_EXPLANATION"*/, v22);
    byte_4AFDA7E = 1;
  }
  message = 0LL;
  switch ( this->fields.state )
  {
    case 0:
      ...
      sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.partyItem, (int32_t)partyItem, v30, v31);
      this->fields.openSelectMember = selectMember;
      this->fields.setupInfo = setupInfo;
      sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.setupInfo, (int32_t)setupInfo, v32, v33);
      this->fields.questRestrictionInfo = questRestrictionInfo;
      sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.questRestrictionInfo, (int32_t)questRestrictionInfo, v34, v35);
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10201/*"PARTY_ORGANIZATION_SERVANT_CHANGE_EXPLANATION"*/, 0LL);
      if ( !explanationLabel )
        goto LABEL_22;
      ...
      if ( questRestrictionInfo && QuestRestrictionInfo__GetExplanationMessage(questRestrictionInfo, &message, 0LL) )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        v41 = LocalizationManager__Get((System_String_o *)StringLiteral_10175/*"PARTY_ORGANIZATION_QUEST_RESTRICTION_EXPLANATION_COLOR"*/, 0LL);
        gameObject = (UnityEngine_GameObject_o *)System_String__Concat_62348648(v41, message, 0LL);
...
LABEL_22:
    ...
    case 7:
      ...
      sub_1BC2FAC(
        ...
        (const MethodInfo *)partyItem);
      this->fields.openCallbackFunc = openCallback;
      sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.openCallbackFunc, (int32_t)openCallback, v23, v24);
      this->fields.partyItem = partyItem;
      sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.partyItem, (int32_t)partyItem, v25, v26);
      this->fields.openSelectMember = selectMember;
      goto LABEL_21;
    case 5:
      this->fields.mode = tutorialMode;
      ...
      this->fields.partyItem = partyItem;
      sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.partyItem, (int32_t)partyItem, v47, v48);
      this->fields.openSelectMember = selectMember;
      this->fields.setupInfo = setupInfo;
...
LABEL_7:
  ...
  while ( 1 )
  {
    ...
    if ( (unsigned int)v5 >= max_length )
      sub_1BC326C(this, isInput, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFDA7D & 1) == 0 )
  {
    ...
    sub_1BC3008(&PartyOrganizationChangeObject_CallbackFunc_TypeInfo, v5);
    sub_1BC3008(&Method_PartyOrganizationChangeMenu_OnClickItem__, v6);
    sub_1BC3008(&Method_PartyOrganizationChangeMenu_OnModifyItem__, v7);
    byte_4AFDA7D = 1;
  }
  partyListViewIndicator = this->fields.partyListViewIndicator;
  if ( !partyListViewIndicator
...
LABEL_11:
  ...
  while ( 1 )
  {
    ...
    if ( (unsigned int)v11 >= max_length )
      sub_1BC326C(partyListViewIndicator, *(_QWORD *)&friendBonusVal, v9);
    partyItem = this->fields.partyItem;
    v14 = partyOrganizationChangeObjectList->m_Items[v11];
    v15 = (PartyOrganizationChangeObject_CallbackFunc_o *)sub_1BC3254(PartyOrganizationChangeObject_CallbackFunc_TypeInfo);
    PartyOrganizationChangeObject_CallbackFunc___ctor(
      v15,
      (Il2CppObject *)this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFDA81 & 1) == 0 )
  {
    ...
    sub_1BC3008(&PartyOrganizationChangeMenu_TypeInfo, v9);
    sub_1BC3008(&QuestInformationComponent_TypeInfo, v10);
    sub_1BC3008(&StringLiteral_17507/*"buttontxt_formation_20"*/, v11);
    byte_4AFDA81 = 1;
  }
  questRestrictionInfo = this->fields.questRestrictionInfo;
  if ( questRestrictionInfo )
...
LABEL_8:
  ...
  if ( (v16 & 1) != 0 )
  {
    ...
    partyRemoveButton = (QuestRestrictionInfo_o *)System_Convert__ToInt32_63402508(setupInfo != 0LL, 0LL);
    if ( LAYOUT_POS_X_HINT )
    {
      if ( (unsigned int)partyRemoveButton >= LAYOUT_POS_X_HINT->max_length )
        sub_1BC326C(partyRemoveButton, isMove, v20);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFDA7B & 1) == 0 )
  {
    sub_1BC3008(&PartyOrganizationChangeMenu_CallbackFunc_TypeInfo, value);
    byte_4AFDA7B = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  ...
  v11 = (PartyOrganizationChangeMenu_o *)sub_1BC3524(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A078B4;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A0785C;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFDA8A & 1) == 0 )
  {
    ...
    sub_1BC3008(&PartyOrganizationChangeMenu_ResultKind_TypeInfo, v9);
    byte_4AFDA8A = 1;
  }
  v14[2] = 0LL;
