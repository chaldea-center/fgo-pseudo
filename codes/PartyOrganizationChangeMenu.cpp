void __fastcall PartyOrganizationChangeMenu___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FA41A & 1) == 0 )
  {
    ...
    sub_1B64870(&PartyOrganizationChangeMenu_TypeInfo, v2);
    byte_49FA41A = 1;
  }
...
void __fastcall PartyOrganizationChangeMenu___ctor(PartyOrganizationChangeMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA419 & 1) == 0 )
  {
    ...
    sub_1B64870(&BaseMenu_TypeInfo, v3);
    sub_1B64870(&PartyOrganizationChangeObject___TypeInfo, v4);
    byte_49FA419 = 1;
  }
  ...
  v6 = (struct PartyOrganizationChangeObject_array *)sub_1B64918(
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.partyOrganizationChangeObjectList, (int32_t)v6, v7, v8);
...
LABEL_8:
  ...
  while ( 1 )
  {
    ...
    if ( (unsigned int)v5 >= max_length )
      sub_1B64AD4(mainDeckBase, method);
...
void __fastcall PartyOrganizationChangeMenu__Close(PartyOrganizationChangeMenu_o *this, const MethodInfo *method)
{
  ...
  PartyOrganizationChangeMenu__Close_31726504(this, 0LL, v2);
}


void __fastcall PartyOrganizationChangeMenu__Close_31726504(
        PartyOrganizationChangeMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA411 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_PartyOrganizationChangeMenu_EndClose__, v6);
    byte_49FA411 = 1;
  }
...
void __fastcall PartyOrganizationChangeMenu__EndOpen(PartyOrganizationChangeMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA410 & 1) == 0 )
  {
    ...
    sub_1B64870(&PartyOrganizationChangeObject_CallbackFunc_TypeInfo, v5);
    sub_1B64870(&Method_UnityEngine_Component_GetComponent_FSOffset___, v6);
    sub_1B64870(&FSUtility_TypeInfo, v7);
    sub_1B64870(&LocalizationManager_TypeInfo, v8);
    sub_1B64870(&Method_PartyOrganizationChangeMenu_EndOpenTutorialArrow__, v9);
    sub_1B64870(&Method_PartyOrganizationChangeMenu_OnClickEmptyItem__, v10);
    sub_1B64870(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v11);
    sub_1B64870(&StringLiteral_9958/*"OpenServantDetail"*/, v12);
    sub_1B64870(&StringLiteral_13437/*"TUTORIAL_MESSAGE_PARTY_ORGANIZATION4"*/, v13);
    byte_49FA410 = 1;
  }
  if ( (this->fields.openSelectMember & 0x80000000) != 0 )
  {
    ...
    if ( mode )
    {
      ...
      if ( mode == 5 )
      {
        ...
        v37 = LocalizationManager__Get((System_String_o *)StringLiteral_13437/*"TUTORIAL_MESSAGE_PARTY_ORGANIZATION4"*/, 0LL);
      ...
      else if ( mode == 4 )
      {
        ...
        v25 = (PartyOrganizationChangeObject_CallbackFunc_o *)sub_1B64ABC(PartyOrganizationChangeObject_CallbackFunc_TypeInfo);
    ...
    case 3:
      ...
      if ( partyOrganizationChangeObjectList )
      {
        ...
        if ( (unsigned int)openSelectMember >= partyOrganizationChangeObjectList->max_length )
          sub_1B64AD4(tutorialMaskBase, method);
        ...
        if ( tutorialMaskBase )
        {
          UnityEngine_Component__SendMessage_69107156(
            (UnityEngine_Component_o *)tutorialMaskBase,
            (System_String_o *)StringLiteral_9958/*"OpenServantDetail"*/,
            0LL);
          return;
        }
      }
...
LABEL_10:
  ...
  while ( 1 )
  {
    ...
    if ( (int)v5 >= max_length )
      break;
    if ( (unsigned int)v5 >= max_length )
      sub_1B64AD4(basePartyItem, method);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B64870(&System_Action_TypeInfo, method);
    sub_1B64870(&Method_PartyOrganizationChangeMenu_EndCloseTutorialArrowDecide__, v4);
    sub_1B64870(&Method_PartyOrganizationChangeMenu_OnClickDecide__, v5);
  ...
  if ( state == 7 )
  {
    if ( this->fields.mode == 5 )
    {
      ...
      if ( (*((_BYTE *)Method_PartyOrganizationChangeMenu_OnClickDecide__ + 83) & 2) != 0 )
        v8 = (_QWORD *)sub_1B64888(Method_PartyOrganizationChangeMenu_OnClickDecide__);
      ...
      if ( !Instance )
        sub_1B64ACC(v12, v13);
      CommonUI__CloseTutorialNotificationDialogArrow_30372596((CommonUI_o *)Instance, v11, 0LL);
    }
  }
  else if ( state == 2 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA417 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_PartyOrganizationChangeMenu_EndCloseTutorialArrowEmptyItem__, v5);
    sub_1B64870(&Method_PartyOrganizationChangeMenu_OnClickEmptyItem__, v6);
  ...
  if ( this->fields.state == 7 && this->fields.mode == 4 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationChangeMenu_OnClickEmptyItem__ + 83) & 2) != 0 )
      v8 = (_QWORD *)sub_1B64888(Method_PartyOrganizationChangeMenu_OnClickEmptyItem__);
    v9 = (System_Reflection_MethodBase_o *)sub_1B64854(v8, v8[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA414 & 1) == 0 )
  {
    sub_1B64870(&Method_PartyOrganizationChangeMenu_OnClickInfomation__, method);
    byte_49FA414 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationChangeMenu_OnClickInfomation__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B64888(Method_PartyOrganizationChangeMenu_OnClickInfomation__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA415 & 1) == 0 )
  {
    sub_1B64870(&Method_PartyOrganizationChangeMenu_OnClickPointEvent__, method);
    byte_49FA415 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationChangeMenu_OnClickPointEvent__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B64888(Method_PartyOrganizationChangeMenu_OnClickPointEvent__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B64854(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
    this->fields.state = 3;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA416 & 1) == 0 )
  {
    sub_1B64870(&Method_PartyOrganizationChangeMenu_OnClickQuestInfomation__, method);
    byte_49FA416 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationChangeMenu_OnClickQuestInfomation__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B64888(Method_PartyOrganizationChangeMenu_OnClickQuestInfomation__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B64854(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
    this->fields.state = 3;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA40F & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_PartyOrganizationChangeMenu_EndOpen__, v21);
    sub_1B64870(&StringLiteral_10233/*"PARTY_ORGANIZATION_QUEST_RESTRICTION_EXPLANATION_COLOR"*/, v22);
    sub_1B64870(&StringLiteral_10259/*"PARTY_ORGANIZATION_SERVANT_CHANGE_EXPLANATION"*/, v23);
    byte_49FA40F = 1;
  }
  message = 0LL;
  switch ( this->fields.state )
  {
    case 0:
      ...
      sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.openCallbackFunc, (int32_t)openCallback, v31, v32);
      this->fields.basePartyItem = basePartyItem;
      sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.basePartyItem, (int32_t)basePartyItem, v33, v34);
      this->fields.partyItem = partyItem;
      sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.partyItem, (int32_t)partyItem, v35, v36);
      this->fields.openSelectMember = selectMember;
      this->fields.setupInfo = setupInfo;
      sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.setupInfo, (int32_t)setupInfo, v37, v38);
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10259/*"PARTY_ORGANIZATION_SERVANT_CHANGE_EXPLANATION"*/, 0LL);
      if ( !explanationLabel )
        goto LABEL_22;
      ...
      if ( questRestrictionInfo && QuestRestrictionInfo__GetExplanationMessage(questRestrictionInfo, &message, 0LL) )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        v46 = LocalizationManager__Get((System_String_o *)StringLiteral_10233/*"PARTY_ORGANIZATION_QUEST_RESTRICTION_EXPLANATION_COLOR"*/, 0LL);
        gameObject = (UnityEngine_GameObject_o *)System_String__Concat_61383576(v46, message, 0LL);
...
LABEL_22:
    ...
    case 7:
      ...
      this->fields.basePartyItem = basePartyItem;
      sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.basePartyItem, (int32_t)basePartyItem, v26, v27);
      this->fields.partyItem = partyItem;
      sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.partyItem, (int32_t)partyItem, v28, v29);
      this->fields.openSelectMember = selectMember;
      goto LABEL_21;
    case 5:
      this->fields.mode = tutorialMode;
      ...
      sub_1B64814(
        ...
        (int32_t)basePartyItem);
      this->fields.openCallbackFunc = openCallback;
      sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.openCallbackFunc, (int32_t)openCallback, v50, v51);
      this->fields.basePartyItem = basePartyItem;
      sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.basePartyItem, (int32_t)basePartyItem, v52, v53);
      this->fields.partyItem = partyItem;
      sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.partyItem, (int32_t)partyItem, v54, v55);
      this->fields.openSelectMember = selectMember;
      this->fields.setupInfo = setupInfo;
      sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.setupInfo, (int32_t)setupInfo, v56, v57);
      this->fields.questRestrictionInfo = questRestrictionInfo;
      sub_1B64814(
        (ServantStatusBattleListViewItem_o *)&this->fields.questRestrictionInfo,
        (int32_t)questRestrictionInfo,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA40E & 1) == 0 )
  {
    sub_1B64870(&PartyOrganizationChangeObject_CallbackFunc_TypeInfo, *(_QWORD *)&friendBonusVal);
    sub_1B64870(&Method_PartyOrganizationChangeMenu_OnClickItem__, v5);
    byte_49FA40E = 1;
  }
...
LABEL_11:
  ...
  while ( 1 )
  {
    ...
    if ( (unsigned int)v8 >= max_length )
      sub_1B64AD4(partyListViewIndicator, *(_QWORD *)&friendBonusVal);
    partyItem = this->fields.partyItem;
    v11 = partyOrganizationChangeObjectList->m_Items[v8];
    v12 = (PartyOrganizationChangeObject_CallbackFunc_o *)sub_1B64ABC(PartyOrganizationChangeObject_CallbackFunc_TypeInfo);
    PartyOrganizationChangeObject_CallbackFunc___ctor(
      v12,
      (Il2CppObject *)this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA412 & 1) == 0 )
  {
    ...
    sub_1B64870(&PartyOrganizationChangeMenu_TypeInfo, v9);
    sub_1B64870(&QuestInformationComponent_TypeInfo, v10);
    sub_1B64870(&StringLiteral_17603/*"buttontxt_formation_20"*/, v11);
    byte_49FA412 = 1;
  }
  questRestrictionInfo = this->fields.questRestrictionInfo;
  if ( questRestrictionInfo )
...
LABEL_8:
  ...
  if ( (v16 & 1) != 0 )
  {
    ...
    partyRemoveButton = (QuestRestrictionInfo_o *)System_Convert__ToInt32_62005904(setupInfo != 0LL, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA40C & 1) == 0 )
  {
    sub_1B64870(&PartyOrganizationChangeMenu_CallbackFunc_TypeInfo, value);
    byte_49FA40C = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  ...
  v11 = (PartyOrganizationChangeMenu_o *)sub_1B64D8C(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19A6D34;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19A6CDC;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA41B & 1) == 0 )
  {
    ...
    sub_1B64870(&PartyOrganizationChangeMenu_ResultKind_TypeInfo, v9);
    byte_49FA41B = 1;
  }
  v14[2] = 0LL;
