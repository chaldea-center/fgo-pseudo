void __fastcall PartyOrganizationChangeMenu___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BC36D1 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&PartyOrganizationChangeMenu_TypeInfo, v2);
    byte_4BC36D1 = 1;
  }
  ...
  sub_1C1AB78(PartyOrganizationChangeMenu_TypeInfo->static_fields);
}
...
void __fastcall PartyOrganizationChangeMenu___ctor(PartyOrganizationChangeMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC36D0 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&BaseMenu_TypeInfo, v3);
    sub_1C1ABD4(&PartyOrganizationChangeObject___TypeInfo, v4);
    byte_4BC36D0 = 1;
  }
  ...
  this->fields.partyOrganizationChangeObjectList = (struct PartyOrganizationChangeObject_array *)sub_1C1AC7C(
                                                                                                   PartyOrganizationChangeObject___TypeInfo,
                                                                                                   (unsigned int)v5->static_fields->DeckMemberMax);
  sub_1C1AB78(&this->fields.partyOrganizationChangeObjectList);
...
LABEL_8:
  ...
  while ( 1 )
  {
    ...
    if ( (unsigned int)v5 >= max_length )
      sub_1C1AE38(mainDeckBase, method);
...
void __fastcall PartyOrganizationChangeMenu__Close(PartyOrganizationChangeMenu_o *this, const MethodInfo *method)
{
  ...
  PartyOrganizationChangeMenu__Close_32906096(this, 0LL, v2);
}


void __fastcall PartyOrganizationChangeMenu__Close_32906096(
        PartyOrganizationChangeMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC36C8 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_PartyOrganizationChangeMenu_EndClose__, v5);
    byte_4BC36C8 = 1;
  }
...
void __fastcall PartyOrganizationChangeMenu__EndOpen(PartyOrganizationChangeMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC36C7 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&PartyOrganizationChangeObject_CallbackFunc_TypeInfo, v4);
    sub_1C1ABD4(&Method_UnityEngine_Component_GetComponent_FSOffset___, v5);
    sub_1C1ABD4(&FSUtility_TypeInfo, v6);
    sub_1C1ABD4(&LocalizationManager_TypeInfo, v7);
    sub_1C1ABD4(&Method_PartyOrganizationChangeMenu_EndOpenTutorialArrow__, v8);
    sub_1C1ABD4(&Method_PartyOrganizationChangeMenu_OnClickEmptyItem__, v9);
    sub_1C1ABD4(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v10);
    sub_1C1ABD4(&StringLiteral_10189/*"OpenServantDetail"*/, v11);
    sub_1C1ABD4(&StringLiteral_13747/*"TUTORIAL_MESSAGE_PARTY_ORGANIZATION4"*/, v12);
    byte_4BC36C7 = 1;
  }
  if ( (this->fields.openSelectMember & 0x80000000) != 0 )
  {
    ...
    if ( mode )
    {
      ...
      if ( mode == 5 )
      {
        ...
        v35 = LocalizationManager__Get((System_String_o *)StringLiteral_13747/*"TUTORIAL_MESSAGE_PARTY_ORGANIZATION4"*/, 0LL);
      ...
      else if ( mode == 4 )
      {
        ...
        v24 = (PartyOrganizationChangeObject_CallbackFunc_o *)sub_1C1AE20(PartyOrganizationChangeObject_CallbackFunc_TypeInfo);
        ...
        v28 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_387A8A8 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    ...
    case 3:
      ...
      if ( partyOrganizationChangeObjectList )
      {
        ...
        if ( (unsigned int)openSelectMember >= partyOrganizationChangeObjectList->max_length )
          sub_1C1AE38(tutorialMaskBase, method);
        ...
        if ( tutorialMaskBase )
        {
          UnityEngine_Component__SendMessage_70765652(
            (UnityEngine_Component_o *)tutorialMaskBase,
            (System_String_o *)StringLiteral_10189/*"OpenServantDetail"*/,
            0LL);
          return;
        }
      }
...
LABEL_10:
  ...
  while ( 1 )
  {
    ...
    if ( (int)v5 >= max_length )
      break;
    if ( (unsigned int)v5 >= max_length )
      sub_1C1AE38(basePartyItem, method);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C1ABD4(&System_Action_TypeInfo, method);
    sub_1C1ABD4(&Method_PartyOrganizationChangeMenu_EndCloseTutorialArrowDecide__, v4);
    sub_1C1ABD4(&Method_PartyOrganizationChangeMenu_OnClickDecide__, v5);
  ...
  if ( state == 7 )
  {
    if ( this->fields.mode == 5 )
    {
      ...
      if ( (*((_BYTE *)Method_PartyOrganizationChangeMenu_OnClickDecide__ + 83) & 2) != 0 )
        v8 = (_QWORD *)sub_1C1ABEC(Method_PartyOrganizationChangeMenu_OnClickDecide__);
      ...
      if ( !Instance )
        sub_1C1AE30(v12, v13);
      CommonUI__CloseTutorialNotificationDialogArrow_31124484((CommonUI_o *)Instance, v11, 0LL);
    }
  }
  else if ( state == 2 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC36CE & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_PartyOrganizationChangeMenu_EndCloseTutorialArrowEmptyItem__, v5);
    sub_1C1ABD4(&Method_PartyOrganizationChangeMenu_OnClickEmptyItem__, v6);
  ...
  if ( this->fields.state == 7 && this->fields.mode == 4 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationChangeMenu_OnClickEmptyItem__ + 83) & 2) != 0 )
      v8 = (_QWORD *)sub_1C1ABEC(Method_PartyOrganizationChangeMenu_OnClickEmptyItem__);
    v9 = (System_Reflection_MethodBase_o *)sub_1C1ABB8(v8, v8[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC36CB & 1) == 0 )
  {
    sub_1C1ABD4(&Method_PartyOrganizationChangeMenu_OnClickInfomation__, method);
    byte_4BC36CB = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationChangeMenu_OnClickInfomation__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C1ABEC(Method_PartyOrganizationChangeMenu_OnClickInfomation__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC36CC & 1) == 0 )
  {
    sub_1C1ABD4(&Method_PartyOrganizationChangeMenu_OnClickPointEvent__, method);
    byte_4BC36CC = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationChangeMenu_OnClickPointEvent__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C1ABEC(Method_PartyOrganizationChangeMenu_OnClickPointEvent__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C1ABB8(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
    this->fields.state = 3;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC36CD & 1) == 0 )
  {
    sub_1C1ABD4(&Method_PartyOrganizationChangeMenu_OnClickQuestInfomation__, method);
    byte_4BC36CD = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationChangeMenu_OnClickQuestInfomation__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C1ABEC(Method_PartyOrganizationChangeMenu_OnClickQuestInfomation__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C1ABB8(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
    this->fields.state = 3;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC36C6 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_PartyOrganizationChangeMenu_EndOpen__, v21);
    sub_1C1ABD4(&StringLiteral_10474/*"PARTY_ORGANIZATION_QUEST_RESTRICTION_EXPLANATION_COLOR"*/, v22);
    sub_1C1ABD4(&StringLiteral_10500/*"PARTY_ORGANIZATION_SERVANT_CHANGE_EXPLANATION"*/, v23);
    byte_4BC36C6 = 1;
  }
  message = 0LL;
  switch ( this->fields.state )
  {
    case 0:
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10500/*"PARTY_ORGANIZATION_SERVANT_CHANGE_EXPLANATION"*/, 0LL);
      if ( !explanationLabel )
        goto LABEL_22;
      ...
      if ( questRestrictionInfo && QuestRestrictionInfo__GetExplanationMessage(questRestrictionInfo, &message, 0LL) )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        v30 = LocalizationManager__Get((System_String_o *)StringLiteral_10474/*"PARTY_ORGANIZATION_QUEST_RESTRICTION_EXPLANATION_COLOR"*/, 0LL);
        gameObject = (UnityEngine_GameObject_o *)System_String__Concat_63040368(v30, message, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC36C5 & 1) == 0 )
  {
    sub_1C1ABD4(&PartyOrganizationChangeObject_CallbackFunc_TypeInfo, *(_QWORD *)&friendBonusVal);
    sub_1C1ABD4(&Method_PartyOrganizationChangeMenu_OnClickItem__, v5);
    byte_4BC36C5 = 1;
  }
...
LABEL_11:
  ...
  while ( 1 )
  {
    ...
    if ( (unsigned int)v8 >= max_length )
      sub_1C1AE38(partyListViewIndicator, *(_QWORD *)&friendBonusVal);
    partyItem = this->fields.partyItem;
    v11 = partyOrganizationChangeObjectList->m_Items[v8];
    v12 = (PartyOrganizationChangeObject_CallbackFunc_o *)sub_1C1AE20(PartyOrganizationChangeObject_CallbackFunc_TypeInfo);
    PartyOrganizationChangeObject_CallbackFunc___ctor(
      v12,
      (Il2CppObject *)this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC36C9 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&PartyOrganizationChangeMenu_TypeInfo, v9);
    sub_1C1ABD4(&QuestInformationComponent_TypeInfo, v10);
    sub_1C1ABD4(&StringLiteral_17956/*"buttontxt_formation_20"*/, v11);
    byte_4BC36C9 = 1;
  }
  questRestrictionInfo = this->fields.questRestrictionInfo;
  if ( questRestrictionInfo )
...
LABEL_8:
  ...
  if ( (v16 & 1) != 0 )
  {
    ...
    partyRemoveButton = (QuestRestrictionInfo_o *)System_Convert__ToInt32_63663032(setupInfo != 0LL, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC36C3 & 1) == 0 )
  {
    sub_1C1ABD4(&PartyOrganizationChangeMenu_CallbackFunc_TypeInfo, value);
    byte_4BC36C3 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (PartyOrganizationChangeMenu_o *)sub_1C1B0F0(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A56394;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A5633C;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC36D2 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&PartyOrganizationChangeMenu_ResultKind_TypeInfo, v9);
    byte_4BC36D2 = 1;
  }
  v14[2] = 0LL;
