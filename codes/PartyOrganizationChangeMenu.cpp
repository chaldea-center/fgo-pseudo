void __fastcall PartyOrganizationChangeMenu___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B6281E & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&PartyOrganizationChangeMenu_TypeInfo, v2);
    byte_4B6281E = 1;
  }
  ...
  sub_1BE4A70(PartyOrganizationChangeMenu_TypeInfo->static_fields);
}
...
void __fastcall PartyOrganizationChangeMenu___ctor(PartyOrganizationChangeMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6281D & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&BaseMenu_TypeInfo, v3);
    sub_1BE4ACC(&PartyOrganizationChangeObject___TypeInfo, v4);
    byte_4B6281D = 1;
  }
  ...
  this->fields.partyOrganizationChangeObjectList = (struct PartyOrganizationChangeObject_array *)sub_1BE4B74(
                                                                                                   PartyOrganizationChangeObject___TypeInfo,
                                                                                                   (unsigned int)v5->static_fields->DeckMemberMax);
  sub_1BE4A70(&this->fields.partyOrganizationChangeObjectList);
...
LABEL_8:
  ...
  while ( 1 )
  {
    ...
    if ( (unsigned int)v5 >= max_length )
      sub_1BE4D30(mainDeckBase, method);
...
void __fastcall PartyOrganizationChangeMenu__Close(PartyOrganizationChangeMenu_o *this, const MethodInfo *method)
{
  ...
  PartyOrganizationChangeMenu__Close_32658968(this, 0LL, v2);
}


void __fastcall PartyOrganizationChangeMenu__Close_32658968(
        PartyOrganizationChangeMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62815 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_PartyOrganizationChangeMenu_EndClose__, v5);
    byte_4B62815 = 1;
  }
...
void __fastcall PartyOrganizationChangeMenu__EndOpen(PartyOrganizationChangeMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B62814 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&PartyOrganizationChangeObject_CallbackFunc_TypeInfo, v4);
    sub_1BE4ACC(&Method_UnityEngine_Component_GetComponent_FSOffset___, v5);
    sub_1BE4ACC(&FSUtility_TypeInfo, v6);
    sub_1BE4ACC(&LocalizationManager_TypeInfo, v7);
    sub_1BE4ACC(&Method_PartyOrganizationChangeMenu_EndOpenTutorialArrow__, v8);
    sub_1BE4ACC(&Method_PartyOrganizationChangeMenu_OnClickEmptyItem__, v9);
    sub_1BE4ACC(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v10);
    sub_1BE4ACC(&StringLiteral_10158/*"OpenServantDetail"*/, v11);
    sub_1BE4ACC(&StringLiteral_13702/*"TUTORIAL_MESSAGE_PARTY_ORGANIZATION4"*/, v12);
    byte_4B62814 = 1;
  }
  if ( (this->fields.openSelectMember & 0x80000000) != 0 )
  {
    ...
    if ( mode )
    {
      ...
      if ( mode == 5 )
      {
        ...
        v35 = LocalizationManager__Get((System_String_o *)StringLiteral_13702/*"TUTORIAL_MESSAGE_PARTY_ORGANIZATION4"*/, 0LL);
      ...
      else if ( mode == 4 )
      {
        ...
        v24 = (PartyOrganizationChangeObject_CallbackFunc_o *)sub_1BE4D18(PartyOrganizationChangeObject_CallbackFunc_TypeInfo);
        ...
        v28 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    ...
    case 3:
      ...
      if ( partyOrganizationChangeObjectList )
      {
        ...
        if ( (unsigned int)openSelectMember >= partyOrganizationChangeObjectList->max_length )
          sub_1BE4D30(tutorialMaskBase, method);
        ...
        if ( tutorialMaskBase )
        {
          UnityEngine_Component__SendMessage_70423240(
            (UnityEngine_Component_o *)tutorialMaskBase,
            (System_String_o *)StringLiteral_10158/*"OpenServantDetail"*/,
            0LL);
          return;
        }
      }
...
LABEL_10:
  ...
  while ( 1 )
  {
    ...
    if ( (int)v5 >= max_length )
      break;
    if ( (unsigned int)v5 >= max_length )
      sub_1BE4D30(basePartyItem, method);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BE4ACC(&System_Action_TypeInfo, method);
    sub_1BE4ACC(&Method_PartyOrganizationChangeMenu_EndCloseTutorialArrowDecide__, v4);
    sub_1BE4ACC(&Method_PartyOrganizationChangeMenu_OnClickDecide__, v5);
  ...
  if ( state == 7 )
  {
    if ( this->fields.mode == 5 )
    {
      ...
      if ( (*((_BYTE *)Method_PartyOrganizationChangeMenu_OnClickDecide__ + 83) & 2) != 0 )
        v8 = (_QWORD *)sub_1BE4AE4(Method_PartyOrganizationChangeMenu_OnClickDecide__);
      ...
      if ( !Instance )
        sub_1BE4D28(v12, v13);
      CommonUI__CloseTutorialNotificationDialogArrow_30899300((CommonUI_o *)Instance, v11, 0LL);
    }
  }
  else if ( state == 2 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6281B & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_PartyOrganizationChangeMenu_EndCloseTutorialArrowEmptyItem__, v5);
    sub_1BE4ACC(&Method_PartyOrganizationChangeMenu_OnClickEmptyItem__, v6);
  ...
  if ( this->fields.state == 7 && this->fields.mode == 4 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationChangeMenu_OnClickEmptyItem__ + 83) & 2) != 0 )
      v8 = (_QWORD *)sub_1BE4AE4(Method_PartyOrganizationChangeMenu_OnClickEmptyItem__);
    v9 = (System_Reflection_MethodBase_o *)sub_1BE4AB0(v8, v8[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62818 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_PartyOrganizationChangeMenu_OnClickInfomation__, method);
    byte_4B62818 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationChangeMenu_OnClickInfomation__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BE4AE4(Method_PartyOrganizationChangeMenu_OnClickInfomation__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62819 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_PartyOrganizationChangeMenu_OnClickPointEvent__, method);
    byte_4B62819 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationChangeMenu_OnClickPointEvent__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BE4AE4(Method_PartyOrganizationChangeMenu_OnClickPointEvent__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BE4AB0(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
    this->fields.state = 3;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6281A & 1) == 0 )
  {
    sub_1BE4ACC(&Method_PartyOrganizationChangeMenu_OnClickQuestInfomation__, method);
    byte_4B6281A = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationChangeMenu_OnClickQuestInfomation__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BE4AE4(Method_PartyOrganizationChangeMenu_OnClickQuestInfomation__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BE4AB0(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
    this->fields.state = 3;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62813 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_PartyOrganizationChangeMenu_EndOpen__, v21);
    sub_1BE4ACC(&StringLiteral_10441/*"PARTY_ORGANIZATION_QUEST_RESTRICTION_EXPLANATION_COLOR"*/, v22);
    sub_1BE4ACC(&StringLiteral_10467/*"PARTY_ORGANIZATION_SERVANT_CHANGE_EXPLANATION"*/, v23);
    byte_4B62813 = 1;
  }
  message = 0LL;
  switch ( this->fields.state )
  {
    case 0:
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10467/*"PARTY_ORGANIZATION_SERVANT_CHANGE_EXPLANATION"*/, 0LL);
      if ( !explanationLabel )
        goto LABEL_22;
      ...
      if ( questRestrictionInfo && QuestRestrictionInfo__GetExplanationMessage(questRestrictionInfo, &message, 0LL) )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        v30 = LocalizationManager__Get((System_String_o *)StringLiteral_10441/*"PARTY_ORGANIZATION_QUEST_RESTRICTION_EXPLANATION_COLOR"*/, 0LL);
        gameObject = (UnityEngine_GameObject_o *)System_String__Concat_62698808(v30, message, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62812 & 1) == 0 )
  {
    sub_1BE4ACC(&PartyOrganizationChangeObject_CallbackFunc_TypeInfo, *(_QWORD *)&friendBonusVal);
    sub_1BE4ACC(&Method_PartyOrganizationChangeMenu_OnClickItem__, v5);
    byte_4B62812 = 1;
  }
...
LABEL_11:
  ...
  while ( 1 )
  {
    ...
    if ( (unsigned int)v8 >= max_length )
      sub_1BE4D30(partyListViewIndicator, *(_QWORD *)&friendBonusVal);
    partyItem = this->fields.partyItem;
    v11 = partyOrganizationChangeObjectList->m_Items[v8];
    v12 = (PartyOrganizationChangeObject_CallbackFunc_o *)sub_1BE4D18(PartyOrganizationChangeObject_CallbackFunc_TypeInfo);
    PartyOrganizationChangeObject_CallbackFunc___ctor(
      v12,
      (Il2CppObject *)this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62816 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&PartyOrganizationChangeMenu_TypeInfo, v9);
    sub_1BE4ACC(&QuestInformationComponent_TypeInfo, v10);
    sub_1BE4ACC(&StringLiteral_17900/*"buttontxt_formation_20"*/, v11);
    byte_4B62816 = 1;
  }
  questRestrictionInfo = this->fields.questRestrictionInfo;
  if ( questRestrictionInfo )
...
LABEL_8:
  ...
  if ( (v16 & 1) != 0 )
  {
    ...
    partyRemoveButton = (QuestRestrictionInfo_o *)System_Convert__ToInt32_63321472(setupInfo != 0LL, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62810 & 1) == 0 )
  {
    sub_1BE4ACC(&PartyOrganizationChangeMenu_CallbackFunc_TypeInfo, value);
    byte_4B62810 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (PartyOrganizationChangeMenu_o *)sub_1BE4FE8(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A20E00;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A20DA8;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6281F & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&PartyOrganizationChangeMenu_ResultKind_TypeInfo, v9);
    byte_4B6281F = 1;
  }
  v14[2] = 0LL;
