void __fastcall RemovedBuffInfo___ctor(RemovedBuffInfo_o *this, const MethodInfo *method)
{
  ...
  v11 = (System_Collections_Generic_List_object__o *)sub_1C3B9B0(System_Collections_Generic_List_BattleBuffData_BuffData__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v11,
    (const MethodInfo_368B438 *)Method_System_Collections_Generic_List_BattleBuffData_BuffData___ctor__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24BC5 & 1) == 0 )
  {
    sub_1C3B764(&Method_System_Collections_Generic_List_BattleBuffData_BuffData__AddRange__, buffDataEnumerable);
    byte_4C24BC5 = 1;
  }
...
LABEL_8:
    sub_1C3B9C0(RemovedAllBuffList_k__BackingField, buffDataEnumerable);
  }
}
