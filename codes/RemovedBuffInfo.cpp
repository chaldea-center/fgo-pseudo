void RemovedBuffInfo___ctor(RemovedBuffInfo_o *this, const MethodInfo *method)
{
  ...
  v6 = (System_Collections_Generic_List_object__o *)sub_1C32E6C(System_Collections_Generic_List_BattleBuffData_BuffData__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v6,
    (const MethodInfo_3797F88 *)Method_System_Collections_Generic_List_BattleBuffData_BuffData___ctor__);
  this->fields._RemovedLinkedBuffList_k__BackingField = (struct System_Collections_Generic_List_BattleBuffData_BuffData__o *)v6;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields._RemovedLinkedBuffList_k__BackingField, (int32_t)v6, v7, v8);
}
...
LABEL_8:
    sub_1C32E7C(RemovedAllBuffList_k__BackingField);
  }
}
...
bool RemovedBuffInfo__get_ExistRemoveBuff(RemovedBuffInfo_o *this, const MethodInfo *method)
{
  ...
  if ( RemovedAllBuffList_k__BackingField )
  {
    ...
    v7 = 0;
    System_Nullable_int____ctor(v5, size, (const MethodInfo_38BDF3C *)Method_System_Nullable_int___ctor__);
