void __fastcall RemovedBuffInfo___ctor(RemovedBuffInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A511E6 & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Collections_Generic_List_BattleBuffData_BuffData___ctor__, method);
  ...
  v7 = (System_Collections_Generic_List_object__o *)sub_1B86604(System_Collections_Generic_List_BattleBuffData_BuffData__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v7,
    (const MethodInfo_35FC124 *)Method_System_Collections_Generic_List_BattleBuffData_BuffData___ctor__);
  this->fields._RemovedLinkedBuffList_k__BackingField = (struct System_Collections_Generic_List_BattleBuffData_BuffData__o *)v7;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields._RemovedLinkedBuffList_k__BackingField, (int32_t)v7, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A511E7 & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Collections_Generic_List_BattleBuffData_BuffData__AddRange__, buffDataEnumerable);
    byte_4A511E7 = 1;
  }
...
LABEL_8:
    sub_1B86614(RemovedAllBuffList_k__BackingField, buffDataEnumerable);
  }
}
