void MultiplyTargetMatrixChr___ctor(MultiplyTargetMatrixChr_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3ABA7 & 1) == 0 )
  {
    sub_1C32C20(&StringLiteral_16577/*"_rootMatrix"*/);
    sub_1C32C20(&StringLiteral_16555/*"_invrootMatrix"*/);
    byte_4C3ABA7 = 1;
  }
  v5 = StringLiteral_16577/*"_rootMatrix"*/;
  this->fields.mainMatrix = (struct System_String_o *)StringLiteral_16577/*"_rootMatrix"*/;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.mainMatrix, v5, v2, v3);
  v6 = StringLiteral_16555/*"_invrootMatrix"*/;
  this->fields.invertMatrix = (struct System_String_o *)StringLiteral_16555/*"_invrootMatrix"*/;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.invertMatrix, v6, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.targetObj, (int32_t)transform, v5, v6);
}
...
void MultiplyTargetMatrixChr__UpdateMatrix(MultiplyTargetMatrixChr_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3ABA3 & 1) == 0 )
  {
    ...
    sub_1C32C20(&UnityEngine_Renderer___TypeInfo);
    byte_4C3ABA3 = 1;
  }
  ...
  if ( targetXWeaponTrails )
  {
    ...
    if ( max_length )
    {
      ...
      {
        v9 = (struct UnityEngine_Renderer_array *)sub_1C32CC8(UnityEngine_Renderer___TypeInfo, max_length);
        this->fields.targetXWeaponTrailRenderers = v9;
        sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.targetXWeaponTrailRenderers, (int32_t)v9, v10, v11);
        targetXWeaponTrails = this->fields.targetXWeaponTrails;
        if ( !targetXWeaponTrails )
LABEL_27:
      ...
      while ( 1 )
      {
        ...
        if ( ((unsigned __int8)Component_object & 1) != 0 )
        {
          ...
          if ( ((unsigned __int8)Component_object & 1) != 0 )
          {
            ...
            if ( Component_object )
            {
              Component_object = (Il2CppObject *)sub_1C32D5C(Component_object, *(_QWORD *)(*(_QWORD *)v20 + 64LL));
              if ( !Component_object )
              {
                v24 = sub_1C32EA0(0);
                sub_1C32D48(v24, 0);
...
LABEL_30:
            ...
            *(_QWORD *)&v20[2 * v12] = v23;
            sub_1C32BC4((CGThumbnailListItem_o *)&v20[v13], (int32_t)v23, v21, v22);
          }
        }
        targetXWeaponTrails = this->fields.targetXWeaponTrails;
        ++v12;
...
void MultiplyTargetMatrixChr__setupTarget(MultiplyTargetMatrixChr_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(targetObj, 0, 0) )
  {
    ...
    sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.targetObj, (int32_t)TargetRoot, v7, v8);
    ...
    if ( UnityEngine_Object__op_Inequality(v9, 0, 0) && !System_String__IsNullOrEmpty(this->fields.targetObjPath, 0) )
    {
      ...
      sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.targetObj, (int32_t)v10, v11, v12);
    }
  }
}
