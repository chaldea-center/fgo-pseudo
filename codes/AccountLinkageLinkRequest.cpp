        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3E18 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_16403/*"accountLinkageAnx/link"*/, v2);
    byte_48E3E18 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_60325748(BaseUrl, (System_String_o *)StringLiteral_16403/*"accountLinkageAnx/link"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3E1A & 1) == 0 )
  {
    ...
    this = (AccountLinkageLinkRequest_o *)sub_1B00CCC(&StringLiteral_21754/*"ng"*/, v5);
    byte_48E3E1A = 1;
  }
  if ( !responseList )
    goto LABEL_13;
