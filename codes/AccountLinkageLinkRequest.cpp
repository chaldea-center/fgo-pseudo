...
System_String_o *AccountLinkageLinkRequest__getURL(AccountLinkageLinkRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C94098(&NetworkManager_TypeInfo);
    sub_1C94098(&StringLiteral_16705/*"accountLinkageAnx/link"*/);
    byte_4D2E2F0 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64417744(BaseUrl, (System_String_o *)StringLiteral_16705/*"accountLinkageAnx/link"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2E2F2 & 1) == 0 )
  {
    ...
    this = (AccountLinkageLinkRequest_o *)sub_1C94098(&StringLiteral_22424/*"ng"*/);
    byte_4D2E2F2 = 1;
  }
  if ( !responseList )
    goto LABEL_10;
