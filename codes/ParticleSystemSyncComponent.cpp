...
void __fastcall ParticleSystemSyncComponent__Awake(ParticleSystemSyncComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A07B63 & 1) == 0 )
  {
    sub_1B686D4(&Method_UnityEngine_Component_GetComponentsInChildren_ParticleSystem____75777288, method);
    byte_4A07B63 = 1;
  }
  ...
  if ( particles )
  {
    ...
    if ( max_length >= 1 )
    {
      ...
      do
      {
        ...
        UnityEngine_ParticleSystem__Simulate_69451796(v5, v11, 0LL);
        UnityEngine_ParticleSystem__Play_69451952(v5, 0LL);
        max_length = particles->max_length;
        ++v4;
      }
