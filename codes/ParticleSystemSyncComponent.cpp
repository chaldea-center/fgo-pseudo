...
void __fastcall ParticleSystemSyncComponent__Awake(ParticleSystemSyncComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B65A52 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_UnityEngine_Component_GetComponentsInChildren_ParticleSystem____77181000, method);
    byte_4B65A52 = 1;
  }
  ...
  if ( particles )
  {
    ...
    if ( max_length >= 1 )
    {
      ...
      do
      {
        ...
        UnityEngine_ParticleSystem__Simulate_70731940(v5, v11, 0LL);
        UnityEngine_ParticleSystem__Play_70732096(v5, 0LL);
        max_length = particles->max_length;
        ++v4;
      }
