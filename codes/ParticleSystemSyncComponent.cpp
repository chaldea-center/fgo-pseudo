...
void ParticleSystemSyncComponent__Awake(ParticleSystemSyncComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596F553 & 1) == 0 )
  {
    sub_2213A60(&Method_UnityEngine_Component_GetComponentsInChildren_ParticleSystem____91731912);
    byte_596F553 = 1;
  }
  ...
  if ( particles )
  {
    ...
    if ( max_length >= 1 )
    {
      ...
      do
      {
        ...
        UnityEngine_ParticleSystem__Simulate_83836784(v5, v12, 0);
        UnityEngine_ParticleSystem__Play_83836996(v5, 0);
        max_length = particles->max_length;
        ++v4;
      }
