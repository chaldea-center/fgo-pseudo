...
void __fastcall ParticleSystemSyncComponent__Awake(ParticleSystemSyncComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFC5D4 & 1) == 0 )
  {
    sub_1C2E12C(&Method_UnityEngine_Component_GetComponentsInChildren_ParticleSystem____77780160, method);
    byte_4BFC5D4 = 1;
  }
  ...
  if ( particles )
  {
    ...
    if ( max_length >= 1 )
    {
      ...
      do
      {
        ...
        UnityEngine_ParticleSystem__Simulate_71269828(v5, v11, 0LL);
        UnityEngine_ParticleSystem__Play_71269984(v5, 0LL);
        max_length = particles->max_length;
        ++v4;
      }
