...
void __fastcall ParticleSystemSyncComponent__Awake(ParticleSystemSyncComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB3575 & 1) == 0 )
  {
    sub_1C13D24(&Method_UnityEngine_Component_GetComponentsInChildren_ParticleSystem____77489440, method);
    byte_4BB3575 = 1;
  }
  ...
  if ( particles )
  {
    ...
    if ( max_length >= 1 )
    {
      ...
      do
      {
        ...
        UnityEngine_ParticleSystem__Simulate_71002096(v5, v11, 0LL);
        UnityEngine_ParticleSystem__Play_71002252(v5, 0LL);
        max_length = particles->max_length;
        ++v4;
      }
