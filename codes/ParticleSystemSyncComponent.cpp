...
void __fastcall ParticleSystemSyncComponent__Awake(ParticleSystemSyncComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B43896 & 1) == 0 )
  {
    sub_1BDB878(&Method_UnityEngine_Component_GetComponentsInChildren_ParticleSystem____77096288, method);
    byte_4B43896 = 1;
  }
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.particles, (int32_t)ComponentsInChildren_object, v4, v5);
}
  ...
  if ( particles )
  {
    ...
    if ( max_length >= 1 )
    {
      ...
      do
      {
        ...
        UnityEngine_ParticleSystem__Simulate_70568156(v6, v12, 0LL);
        UnityEngine_ParticleSystem__Play_70568312(v6, 0LL);
        max_length = particles->max_length;
        ++v5;
      }
