...
void __fastcall ParticleSystemSyncComponent__Awake(ParticleSystemSyncComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B36044 & 1) == 0 )
  {
    sub_1BD3458(&Method_UnityEngine_Component_GetComponentsInChildren_ParticleSystem____76991528, method);
    byte_4B36044 = 1;
  }
  ...
  if ( particles )
  {
    ...
    if ( max_length >= 1 )
    {
      ...
      do
      {
        ...
        UnityEngine_ParticleSystem__Simulate_70558212(v5, v11, 0LL);
        UnityEngine_ParticleSystem__Play_70558368(v5, 0LL);
        max_length = particles->max_length;
        ++v4;
      }
