...
void __fastcall ParticleSystemSyncComponent__Awake(ParticleSystemSyncComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5A04D & 1) == 0 )
  {
    sub_1B885B0(&Method_UnityEngine_Component_GetComponentsInChildren_ParticleSystem____76107576);
    byte_4A5A04D = 1;
  }
  ...
  if ( particles )
  {
    ...
    if ( max_length >= 1 )
    {
      ...
      do
      {
        ...
        UnityEngine_ParticleSystem__Simulate_69739360(v5, v11, 0LL);
        UnityEngine_ParticleSystem__Play_69739516(v5, 0LL);
        max_length = particles->max_length;
        ++v4;
      }
