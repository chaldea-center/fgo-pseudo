...
void __fastcall ParticleSystemSyncComponent__Awake(ParticleSystemSyncComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1E9C8 & 1) == 0 )
  {
    sub_1B715CC(&Method_UnityEngine_Component_GetComponentsInChildren_ParticleSystem____75869128, method);
    byte_4A1E9C8 = 1;
  }
  ...
  if ( particles )
  {
    ...
    if ( max_length >= 1 )
    {
      ...
      do
      {
        ...
        UnityEngine_ParticleSystem__Simulate_69537832(v5, v11, 0LL);
        UnityEngine_ParticleSystem__Play_69537988(v5, 0LL);
        max_length = particles->max_length;
        ++v4;
      }
