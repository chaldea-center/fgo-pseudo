...
void __fastcall ParticleSystemSyncComponent__Awake(ParticleSystemSyncComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4D316 & 1) == 0 )
  {
    sub_1B863B8(&Method_UnityEngine_Component_GetComponentsInChildren_ParticleSystem____76107032, method);
    byte_4A4D316 = 1;
  }
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.particles, (int32_t)ComponentsInChildren_object, v4, v5);
}
  ...
  if ( particles )
  {
    ...
    if ( max_length >= 1 )
    {
      ...
      do
      {
        ...
        UnityEngine_ParticleSystem__Simulate_69638544(v5, v11, 0LL);
        UnityEngine_ParticleSystem__Play_69638700(v5, 0LL);
        max_length = particles->max_length;
        ++v4;
      }
