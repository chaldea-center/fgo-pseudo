void AccountDeleteConfirmDialog___cctor(const MethodInfo *method)
{
  if ( (byte_4CAFF12 & 1) == 0 )
  {
    sub_1C6BA08(&AccountDeleteConfirmDialog_TypeInfo);
    sub_1C6BA08(&StringLiteral_407/*"#494949"*/);
    byte_4CAFF12 = 1;
  }
  ...
  sub_1C6B9AC(AccountDeleteConfirmDialog_TypeInfo->static_fields, StringLiteral_407/*"#494949"*/);
}
...
void AccountDeleteConfirmDialog__Close(AccountDeleteConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  AccountDeleteConfirmDialog__Close_31308252(this, 0, v2);
}


void AccountDeleteConfirmDialog__Close_31308252(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CAFF0D & 1) == 0 )
  {
    sub_1C6BA08(&Method_AccountDeleteConfirmDialog_EndClose__);
...
void AccountDeleteConfirmDialog__OnClickCancel(AccountDeleteConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CAFF0F & 1) == 0 )
  {
    sub_1C6BA08(&Method_AccountDeleteConfirmDialog_OnClickCancel__);
    byte_4CAFF0F = 1;
  }
  ...
  {
    AccountDeleteConfirmDialog__Close_31308252(this, 0, v5);
...
void AccountDeleteConfirmDialog__OnClickDecide(AccountDeleteConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CAFF0E & 1) == 0 )
  {
    sub_1C6BA08(&Method_AccountDeleteConfirmDialog_OnClickDecide__);
    byte_4CAFF0E = 1;
  }
  ...
  if ( this->fields.clickFunc )
  {
    AccountDeleteConfirmDialog__Close_31308252(this, 0, v8);
    clickFunc = this->fields.clickFunc;
    if ( clickFunc )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CAFF0B & 1) == 0 )
  {
    sub_1C6BA08(&Method_AccountDeleteConfirmDialog_OnSliderDragFinished__);
    sub_1C6BA08(&LocalizationManager_TypeInfo);
    sub_1C6BA08(&UIProgressBar_OnDragFinished_TypeInfo);
    sub_1C6BA08(&StringLiteral_1835/*"ACCOUNT_DELETE_CONFIRM_DECIDE"*/);
    sub_1C6BA08(&StringLiteral_1834/*"ACCOUNT_DELETE_CONFIRM_CANCEL"*/);
    sub_1C6BA08(&StringLiteral_1836/*"ACCOUNT_DELETE_CONFIRM_MESSAGE"*/);
    sub_1C6BA08(&StringLiteral_1838/*"ACCOUNT_DELETE_CONFIRM_WARNING"*/);
    sub_1C6BA08(&StringLiteral_1837/*"ACCOUNT_DELETE_CONFIRM_TITLE"*/);
    byte_4CAFF0B = 1;
  }
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  checkSlider = LocalizationManager__Get((System_String_o *)StringLiteral_1837/*"ACCOUNT_DELETE_CONFIRM_TITLE"*/, 0);
  if ( !titleLabel )
    goto LABEL_13;
  UILabel__set_text(titleLabel, checkSlider, 0);
  messageLabel = this->fields.messageLabel;
  checkSlider = LocalizationManager__Get((System_String_o *)StringLiteral_1836/*"ACCOUNT_DELETE_CONFIRM_MESSAGE"*/, 0);
  if ( !messageLabel )
    goto LABEL_13;
  UILabel__set_text(messageLabel, checkSlider, 0);
  warningLabel = this->fields.warningLabel;
  checkSlider = LocalizationManager__Get((System_String_o *)StringLiteral_1838/*"ACCOUNT_DELETE_CONFIRM_WARNING"*/, 0);
  if ( !warningLabel )
    goto LABEL_13;
  UILabel__set_text(warningLabel, checkSlider, 0);
  buttonCancelLabel = this->fields.buttonCancelLabel;
  checkSlider = LocalizationManager__Get((System_String_o *)StringLiteral_1834/*"ACCOUNT_DELETE_CONFIRM_CANCEL"*/, 0);
  if ( !buttonCancelLabel )
    goto LABEL_13;
  UILabel__set_text(buttonCancelLabel, checkSlider, 0);
  buttonDecideLabel = this->fields.buttonDecideLabel;
  checkSlider = LocalizationManager__Get((System_String_o *)StringLiteral_1835/*"ACCOUNT_DELETE_CONFIRM_DECIDE"*/, 0);
  ...
  if ( !checkSlider
    || (UIProgressBar__set_value((UIProgressBar_o *)checkSlider, 0.0, 0),
        ...
        v13 = (UIProgressBar_OnDragFinished_o *)sub_1C6BC54(UIProgressBar_OnDragFinished_TypeInfo),
  ...
  {
LABEL_13:
    sub_1C6BC60(checkSlider, v7);
  }
  v12->fields.onDragFinished = v13;
  sub_1C6B9AC(&v12->fields.onDragFinished, v13);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1A98004;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A97FBC;
}
