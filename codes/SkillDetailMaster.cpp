void __fastcall SkillDetailMaster___ctor(SkillDetailMaster_o *this, const MethodInfo *method)
{
  if ( (byte_49FCD17 & 1) == 0 )
  {
    sub_1B640C8(&Method_DataMasterBase_SkillDetailMaster__SkillDetailEntity__int___ctor__, method);
    byte_49FCD17 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    54,
    (const MethodInfo_30D3E64 *)Method_DataMasterBase_SkillDetailMaster__SkillDetailEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FCD18 & 1) == 0 )
  {
    sub_1B640C8(&Method_DataMasterBase_SkillDetailMaster__SkillDetailEntity__int__TryGetEntity__, *(_QWORD *)&id);
  ...
  if ( DataMasterBase_object__object__int___TryGetEntity(
         ...
         &entity,
         id,
         (const MethodInfo_30D3EF8 *)Method_DataMasterBase_SkillDetailMaster__SkillDetailEntity__int__TryGetEntity__) )
  {
    if ( !entity )
      sub_1B64324(0LL);
    if ( isShort )
