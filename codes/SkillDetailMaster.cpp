void __fastcall SkillDetailMaster___ctor(SkillDetailMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A70875 & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_SkillDetailMaster__SkillDetailEntity__int___ctor__, method);
    byte_4A70875 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    54,
    (const MethodInfo_312C568 *)Method_DataMasterBase_SkillDetailMaster__SkillDetailEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A70876 & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_SkillDetailMaster__SkillDetailEntity__int__TryGetEntity__, *(_QWORD *)&id);
  ...
  if ( DataMasterBase_object__object__int___TryGetEntity(
         ...
         &entity,
         id,
         (const MethodInfo_312C5FC *)Method_DataMasterBase_SkillDetailMaster__SkillDetailEntity__int__TryGetEntity__) )
  {
    if ( !entity )
      sub_1B9026C(0LL, v8);
    if ( isShort )
