void NGUIDebug___cctor(const MethodInfo *method)
{
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&static_fields->mLines, (int32_t)v1, v3, v4, v5, v6, v7, v8);
  v9 = NGUIDebug_TypeInfo->static_fields;
  v9->mInstance = 0;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&v9->mInstance, 0, v10, v11, v12, v13, v14, v15);
}
...
void NGUIDebug__CreateInstance(const MethodInfo *method)
{
  ...
  if ( (byte_4D351AD & 1) == 0 )
  {
    sub_1C93AD4(&Method_UnityEngine_GameObject_AddComponent_NGUIDebug___);
    sub_1C93AD4(&UnityEngine_GameObject_TypeInfo);
    sub_1C93AD4(&NGUIDebug_TypeInfo);
    sub_1C93AD4(&UnityEngine_Object_TypeInfo);
    sub_1C93AD4(&StringLiteral_16378/*"_NGUI Debug"*/);
    byte_4D351AD = 1;
  }
  ...
  {
    v3 = (UnityEngine_GameObject_o *)sub_1C93D20(UnityEngine_GameObject_TypeInfo);
    UnityEngine_GameObject___ctor(v3, (System_String_o *)StringLiteral_16378/*"_NGUI Debug"*/, 0);
    if ( !v3 )
      sub_1C93D2C(v4, v5);
    v6 = UnityEngine_GameObject__AddComponent_object_(
           v3,
           (const MethodInfo_31FBF9C *)Method_UnityEngine_GameObject_AddComponent_NGUIDebug___);
    ...
    sub_1C93A78((GrandQuestFolderBoardItem_o *)&static_fields->mInstance, (int32_t)v14, v7, v8, v9, v10, v11, v12);
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
...
void NGUIDebug__Log(System_Object_array *objs, const MethodInfo *method)
{
  ...
  if ( (byte_4D351AF & 1) == 0 )
  {
    ...
    objs = (System_Object_array *)sub_1C93AD4(&StringLiteral_1/*""*/);
    byte_4D351AF = 1;
  }
  if ( !v2 )
    goto LABEL_16;
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v5 )
        objs = (System_Object_array *)System_String__Concat_64463988(v4, (System_String_o *)StringLiteral_810/*", "*/, v6, 0);
      else
        objs = (System_Object_array *)System_String__Concat_64425724(v4, v6, 0);
      max_length = v2->max_length;
      ++v5;
      ...
      if ( v10 )
      {
        ...
        if ( name )
        {
          ...
          else
          {
            ...
            *((_QWORD *)v15 + 4) = text;
            sub_1C93A78((GrandQuestFolderBoardItem_o *)(v15 + 32), (int32_t)text, v4, v5, v6, v7, v8, v9);
          }
...
void NGUIDebug__OnGUI(NGUIDebug_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D351B2 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_8408/*"Last Hit: "*/);
      ...
      if ( UnityEngine_Object__op_Inequality(hoveredObject, 0, 0) )
      {
        ...
        if ( UnityEngine_Application__get_isPlaying(0) )
        {
          ...
          v21 = System_String__Replace_64472288(
                  ...
                  0);
          v22 = System_String__Concat_64425724((System_String_o *)StringLiteral_8408/*"Last Hit: "*/, v21, 0);
