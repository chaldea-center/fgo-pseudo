void NGUIDebug___cctor(const MethodInfo *method)
{
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&static_fields->mLines, (int32_t)v1, v3, v4);
  v5 = NGUIDebug_TypeInfo->static_fields;
  v5->mInstance = 0;
  sub_1C3E508((CGThumbnailListItem_o *)&v5->mInstance, 0, v6, v7);
}
...
void NGUIDebug__CreateInstance(const MethodInfo *method)
{
  ...
  if ( (byte_4C5B4A3 & 1) == 0 )
  {
    sub_1C3E564(&Method_UnityEngine_GameObject_AddComponent_NGUIDebug___);
    sub_1C3E564(&UnityEngine_GameObject_TypeInfo);
    sub_1C3E564(&NGUIDebug_TypeInfo);
    sub_1C3E564(&UnityEngine_Object_TypeInfo);
    sub_1C3E564(&StringLiteral_16287/*"_NGUI Debug"*/);
    byte_4C5B4A3 = 1;
  }
  ...
  {
    v3 = (UnityEngine_GameObject_o *)sub_1C3E7B0(UnityEngine_GameObject_TypeInfo);
    UnityEngine_GameObject___ctor(v3, (System_String_o *)StringLiteral_16287/*"_NGUI Debug"*/, 0);
    if ( !v3 )
      sub_1C3E7C0(v4, v5);
    v6 = UnityEngine_GameObject__AddComponent_object_(
           v3,
           (const MethodInfo_3150FE4 *)Method_UnityEngine_GameObject_AddComponent_NGUIDebug___);
    ...
    sub_1C3E508((CGThumbnailListItem_o *)&static_fields->mInstance, (int32_t)v10, v7, v8);
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
...
void NGUIDebug__Log(System_Object_array *objs, const MethodInfo *method)
{
  ...
  if ( (byte_4C5B4A5 & 1) == 0 )
  {
    ...
    objs = (System_Object_array *)sub_1C3E564(&StringLiteral_1/*""*/);
    byte_4C5B4A5 = 1;
  }
  if ( !v2 )
    goto LABEL_16;
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v5 )
        objs = (System_Object_array *)System_String__Concat_63674716(v4, (System_String_o *)StringLiteral_812/*", "*/, v6, 0);
      else
        objs = (System_Object_array *)System_String__Concat_63636468(v4, v6, 0);
      max_length = v2->max_length;
      ++v5;
      ...
      if ( v6 )
      {
        ...
        if ( name )
        {
          ...
          else
          {
            ...
            *((_QWORD *)v11 + 4) = text;
            sub_1C3E508((CGThumbnailListItem_o *)(v11 + 32), (int32_t)text, v4, v5);
          }
...
void NGUIDebug__OnGUI(NGUIDebug_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C5B4A8 & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_8359/*"Last Hit: "*/);
      ...
      if ( UnityEngine_Object__op_Inequality(hoveredObject, 0, 0) )
      {
        ...
        if ( UnityEngine_Application__get_isPlaying(0) )
        {
          ...
          v21 = System_String__Replace_63683016(
                  ...
                  0);
          v22 = System_String__Concat_63636468((System_String_o *)StringLiteral_8359/*"Last Hit: "*/, v21, 0);
