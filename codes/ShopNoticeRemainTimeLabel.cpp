        ...
        const MethodInfo *method)
{
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.label, (int32_t)label, v12, v13);
  this->fields.monoBehaviour = monoBehaviour;
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields, (int32_t)monoBehaviour, v14, v15);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( isChangeTimeOverLabelColorToRed )
    this->fields.onTimeOverLabelColor = (struct UnityEngine_Color_o)xmmword_BAB400;
}
...
void __fastcall ShopNoticeRemainTimeLabel__Start(ShopNoticeRemainTimeLabel_o *this, const MethodInfo *method)
{
  ...
  if ( !monoBehaviour )
    sub_1B4D1EC(updated, v6);
  started = UnityEngine_MonoBehaviour__StartCoroutine_68789728(monoBehaviour, updated, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B72F7 & 1) == 0 )
  {
    sub_1B4CF90(&ShopNoticeRemainTimeLabel__UpdateRemainTimeLabel_d__9_TypeInfo, method);
    byte_49B72F7 = 1;
  }
  v3 = sub_1B4D1DC(ShopNoticeRemainTimeLabel__UpdateRemainTimeLabel_d__9_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B72F8 & 1) == 0 )
  {
    ...
    this = (ShopNoticeRemainTimeLabel__UpdateRemainTimeLabel_d__9_o *)sub_1B4CF90(
  ...
  else
  {
    if ( _1__state )
      return 0;
    v2->fields.__1__state = -1;
    v7 = (UnityEngine_WaitForSeconds_o *)sub_1B4D1DC(UnityEngine_WaitForSeconds_TypeInfo);
    UnityEngine_WaitForSeconds___ctor(v7, 1.0, 0LL);
    v2->fields._loopWait_5__2 = v7;
    sub_1B4CF34((CGThumbnailListItem_o *)&v2->fields._loopWait_5__2, (int32_t)v7, v8, v9);
  }
  if ( !_4__this )
    goto LABEL_18;
...
LABEL_18:
  ...
  sub_1B4CF34(p__2__current, (int32_t)loopWait_5__2, v13, v14);
  result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B4CFA4(&Method_ShopNoticeRemainTimeLabel__UpdateRemainTimeLabel_d__9_System_Collections_IEnumerator_Reset__);
  sub_1B4D0B8(v3, v4);
}
