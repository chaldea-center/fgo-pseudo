        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.label, (int32_t)label, v12, v13);
  this->fields.monoBehaviour = monoBehaviour;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields, (int32_t)monoBehaviour, v14, v15);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( isChangeTimeOverLabelColorToRed )
    this->fields.onTimeOverLabelColor = (struct UnityEngine_Color_o)xmmword_BEC0B0;
}
...
void __fastcall ShopNoticeRemainTimeLabel__Start(ShopNoticeRemainTimeLabel_o *this, const MethodInfo *method)
{
  ...
  if ( !monoBehaviour )
    sub_1BDBAD4(updated, v6);
  started = UnityEngine_MonoBehaviour__StartCoroutine_70269772(monoBehaviour, updated, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B40DFA & 1) == 0 )
  {
    sub_1BDB878(&ShopNoticeRemainTimeLabel__UpdateRemainTimeLabel_d__9_TypeInfo, method);
    byte_4B40DFA = 1;
  }
  v3 = sub_1BDBAC4(ShopNoticeRemainTimeLabel__UpdateRemainTimeLabel_d__9_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B40DFB & 1) == 0 )
  {
    ...
    this = (ShopNoticeRemainTimeLabel__UpdateRemainTimeLabel_d__9_o *)sub_1BDB878(
  ...
  else
  {
    if ( _1__state )
      return 0;
    v2->fields.__1__state = -1;
    v7 = (UnityEngine_WaitForSeconds_o *)sub_1BDBAC4(UnityEngine_WaitForSeconds_TypeInfo);
    UnityEngine_WaitForSeconds___ctor(v7, 1.0, 0LL);
    v2->fields._loopWait_5__2 = v7;
    sub_1BDB81C((CGThumbnailListItem_o *)&v2->fields._loopWait_5__2, (int32_t)v7, v8, v9);
  }
  if ( !_4__this )
    goto LABEL_18;
...
LABEL_18:
  ...
  sub_1BDB81C(p__2__current, (int32_t)loopWait_5__2, v13, v14);
  result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BDB88C(&Method_ShopNoticeRemainTimeLabel__UpdateRemainTimeLabel_d__9_System_Collections_IEnumerator_Reset__);
  sub_1BDB9A0(v3, v4);
}
