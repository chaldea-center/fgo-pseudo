        ...
        const MethodInfo *method)
{
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.label, (int32_t)label, v7, v8);
  this->fields.monoBehaviour = monoBehaviour;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)monoBehaviour, v9, v10);
}
...
void __fastcall ShopNoticeRemainTimeLabel__Start(ShopNoticeRemainTimeLabel_o *this, const MethodInfo *method)
{
  ...
  if ( !monoBehaviour )
    sub_1B71828(updated, v6);
  started = UnityEngine_MonoBehaviour__StartCoroutine_69243124(monoBehaviour, updated, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C16F & 1) == 0 )
  {
    sub_1B715CC(&ShopNoticeRemainTimeLabel__UpdateRemainTimeLabel_d__8_TypeInfo, method);
    byte_4A1C16F = 1;
  }
  v3 = sub_1B71818(ShopNoticeRemainTimeLabel__UpdateRemainTimeLabel_d__8_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C170 & 1) == 0 )
  {
    ...
    this = (ShopNoticeRemainTimeLabel__UpdateRemainTimeLabel_d__8_o *)sub_1B715CC(
  ...
  else
  {
    if ( _1__state )
      return 0;
    v2->fields.__1__state = -1;
    v7 = (UnityEngine_WaitForSeconds_o *)sub_1B71818(UnityEngine_WaitForSeconds_TypeInfo);
    UnityEngine_WaitForSeconds___ctor(v7, 1.0, 0LL);
    v2->fields._loopWait_5__2 = v7;
    sub_1B71570((ServantStatusBattleListViewItem_o *)&v2->fields._loopWait_5__2, (int32_t)v7, v8, v9);
  }
  if ( !_4__this )
    goto LABEL_16;
...
LABEL_16:
  ...
  sub_1B71570(p__2__current, (int32_t)loopWait_5__2, v13, v14);
  result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B715E0(&Method_ShopNoticeRemainTimeLabel__UpdateRemainTimeLabel_d__8_System_Collections_IEnumerator_Reset__);
  sub_1B716F4(v3, v4);
}
