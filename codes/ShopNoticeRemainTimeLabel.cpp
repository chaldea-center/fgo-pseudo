        ...
        const MethodInfo *method)
{
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.label, (int32_t)label, v12, v13);
  this->fields.monoBehaviour = monoBehaviour;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields, (int32_t)monoBehaviour, v14, v15);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( isChangeTimeOverLabelColorToRed )
    this->fields.onTimeOverLabelColor = (struct UnityEngine_Color_o)xmmword_C135B0;
}
...
void ShopNoticeRemainTimeLabel__Start(ShopNoticeRemainTimeLabel_o *this, const MethodInfo *method)
{
  ...
  if ( !monoBehaviour )
    sub_1C3E7C0(updated, v6);
  started = UnityEngine_MonoBehaviour__StartCoroutine_71327136(monoBehaviour, updated, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C52FF6 & 1) == 0 )
  {
    sub_1C3E564(&ShopNoticeRemainTimeLabel__UpdateRemainTimeLabel_d__9_TypeInfo);
    byte_4C52FF6 = 1;
  }
  v3 = sub_1C3E7B0(ShopNoticeRemainTimeLabel__UpdateRemainTimeLabel_d__9_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C52FF7 & 1) == 0 )
  {
    ...
    this = (ShopNoticeRemainTimeLabel__UpdateRemainTimeLabel_d__9_o *)sub_1C3E564(&UnityEngine_WaitForSeconds_TypeInfo);
    byte_4C52FF7 = 1;
  }
  ...
  else
  {
    ...
    sub_1C3E508((CGThumbnailListItem_o *)&v2->fields._loopWait_5__2, (int32_t)v5, v6, v7);
  }
  if ( !_4__this )
    goto LABEL_18;
...
LABEL_18:
  ...
  sub_1C3E508(p__2__current, (int32_t)loopWait_5__2, v11, v12);
  result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C3E578(&Method_ShopNoticeRemainTimeLabel__UpdateRemainTimeLabel_d__9_System_Collections_IEnumerator_Reset__);
  sub_1C3E68C(v3, v4);
}
