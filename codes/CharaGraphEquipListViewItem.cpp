        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4D800 & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Linq_Enumerable_Contains_long___, *(_QWORD *)&index);
  ...
  *(_OWORD *)&v21.fields.fakeValue = v15;
  ...
  v20 = v21;
  v12 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_47437768(&v20, 0LL);
...
LABEL_10:
  ...
  if ( System_Linq_Enumerable__Contains_long_(
         ...
         v16,
         (const MethodInfo_2F886E8 *)Method_System_Linq_Enumerable_Contains_long___) )
  {
