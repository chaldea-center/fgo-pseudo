...
void __fastcall TweenAnimationComponent__OnFinishAnimation(TweenAnimationComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1BCAF9C(p_onFinishAnimation, 0, v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B1E1 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_9830/*"OnFinishAnimation"*/, v9);
    byte_4B1B1E1 = 1;
  }
...
LABEL_8:
        ...
        sub_1BCAF9C((CGThumbnailListItem_o *)&tweener->fields.eventReceiver, (int32_t)gameObject, v14, v15);
        v16 = StringLiteral_9830/*"OnFinishAnimation"*/;
        tweener->fields.callWhenFinished = (struct System_String_o *)StringLiteral_9830/*"OnFinishAnimation"*/;
        sub_1BCAF9C((CGThumbnailListItem_o *)&tweener->fields.callWhenFinished, v16, v17, v18);
        this->fields.onFinishAnimation = onFinish;
        sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.onFinishAnimation, (int32_t)onFinish, v19, v20);
        return;
      }
    }
    sub_1BCB254(v10, v11);
