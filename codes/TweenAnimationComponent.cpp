...
void TweenAnimationComponent__OnFinishAnimation(TweenAnimationComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1CE66A4(p_onFinishAnimation, 0, v3, v4, v5, v6, v7, v8);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E036AD & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_9984/*"OnFinishAnimation"*/);
    byte_4E036AD = 1;
  }
...
LABEL_8:
        ...
        sub_1CE66A4(
          ...
          v17,
          v18);
        v19 = StringLiteral_9984/*"OnFinishAnimation"*/;
        tweener->fields.callWhenFinished = (struct System_String_o *)StringLiteral_9984/*"OnFinishAnimation"*/;
        sub_1CE66A4((GrandQuestFolderBoardItem_o *)&tweener->fields.callWhenFinished, v19, v20, v21, v22, v23, v24, v25);
