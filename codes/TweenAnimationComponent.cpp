...
void TweenAnimationComponent__OnFinishAnimation(TweenAnimationComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1D0F058(p_onFinishAnimation, 0, v3, v4, v5, v6, v7, v8);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E76320 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_10025/*"OnFinishAnimation"*/);
    byte_4E76320 = 1;
  }
...
LABEL_8:
        ...
        sub_1D0F058(
          ...
          v17,
          v18);
        v19 = StringLiteral_10025/*"OnFinishAnimation"*/;
        tweener->fields.callWhenFinished = (struct System_String_o *)StringLiteral_10025/*"OnFinishAnimation"*/;
        sub_1D0F058((GrandQuestFolderBoardItem_o *)&tweener->fields.callWhenFinished, v19, v20, v21, v22, v23, v24, v25);
