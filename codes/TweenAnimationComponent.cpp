...
void __fastcall TweenAnimationComponent__OnFinishAnimation(TweenAnimationComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1BE4A70(p_onFinishAnimation, 0LL, v3, v4, v5, v6, v7, v8);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B65848 & 1) == 0 )
  {
    sub_1BE4ACC(&UnityEngine_Object_TypeInfo, *(_QWORD *)&animationType);
    sub_1BE4ACC(&StringLiteral_10057/*"OnFinishAnimation"*/, v9);
    byte_4B65848 = 1;
  }
...
LABEL_8:
        ...
        sub_1BE4A70(
          ...
          v18,
          v19);
        v20 = StringLiteral_10057/*"OnFinishAnimation"*/;
        tweener->fields.callWhenFinished = (struct System_String_o *)StringLiteral_10057/*"OnFinishAnimation"*/;
        sub_1BE4A70((PartyOrganizationUtility_o *)&tweener->fields.callWhenFinished, v20, v21, v22, v23, v24, v25, v26);
