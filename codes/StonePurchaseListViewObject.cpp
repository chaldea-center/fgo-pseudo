...
void __fastcall StonePurchaseListViewObject__Awake(StonePurchaseListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E04CA & 1) == 0 )
  {
    sub_1B00CCC(&Method_UnityEngine_GameObject_GetComponent_StonePurchaseListViewItemDraw___, method);
    byte_48E04CA = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2DADE08 *)Method_UnityEngine_GameObject_GetComponent_StonePurchaseListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E04CE & 1) == 0 )
  {
    sub_1B00CCC(&Method_UnityEngine_GameObject_GetComponent_StonePurchaseListViewObject___, method);
    byte_48E04CE = 1;
  }
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_2DADE08 *)Method_UnityEngine_GameObject_GetComponent_StonePurchaseListViewObject___)) == 0LL) )
  {
    sub_1B00F28(DragObject, v4);
  }
  StonePurchaseListViewObject__Init_34123232((StonePurchaseListViewObject_o *)DragObject, 2, v6);
  return v5;
}
        ...
        const MethodInfo *method)
{
  ...
  StonePurchaseListViewObject__Init_34123232((StonePurchaseListViewObject_o *)dragObject, 2, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E04D8 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_6113/*"EventExitMove2"*/, v3);
    byte_48E04D8 = 1;
  }
  dragObject = (UnityEngine_Object_o *)this->fields.dragObject;
...
LABEL_13:
    ...
    v17 = StringLiteral_6113/*"EventExitMove2"*/;
    *(_QWORD *)&v13[3].fields.m_CachedPtr = StringLiteral_6113/*"EventExitMove2"*/;
...
LABEL_10:
  ...
  StonePurchaseListViewObject__Init_34123232((StonePurchaseListViewObject_o *)Component_object, 2, v13);
  UnityEngine_MonoBehaviour__Invoke(
    (UnityEngine_MonoBehaviour_o *)this,
        ...
        const MethodInfo *method)
{
  ...
  if ( !dragObject
    || (dragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                   dragObject,
                                                   (const MethodInfo_2DADE08 *)Method_UnityEngine_GameObject_GetComponent_StonePurchaseListViewObject___)) == 0LL
    || (StonePurchaseListViewObject__Init_34123232((StonePurchaseListViewObject_o *)dragObject, 2, v12),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E04CC & 1) == 0 )
  {
    sub_1B00CCC(&StonePurchaseListViewItem_TypeInfo, method);
    byte_48E04CC = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E04CF & 1) == 0 )
  {
    sub_1B00CCC(&StonePurchaseListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_48E04CF = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall StonePurchaseListViewObject__Init_34123232(
        StonePurchaseListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall StonePurchaseListViewObject__Init_34124528(
        StonePurchaseListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall StonePurchaseListViewObject__Init_34124612(
        StonePurchaseListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall StonePurchaseListViewObject__SetupDisp(StonePurchaseListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B00CCC(&UnityEngine_Object_TypeInfo, method);
    sub_1B00CCC(&StonePurchaseListViewItem_TypeInfo, v3);
    byte_48E04D0 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E04DA & 1) == 0 )
  {
    sub_1B00CCC(&StonePurchaseListViewItemDraw_DispMode_TypeInfo, method);
