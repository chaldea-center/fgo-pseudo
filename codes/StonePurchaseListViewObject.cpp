...
void __fastcall StonePurchaseListViewObject__Awake(StonePurchaseListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_438A54C & 1) == 0 )
  {
    sub_B775C4(&Method_UnityEngine_GameObject_GetComponent_StonePurchaseListViewItemDraw___);
    byte_438A54C = 1;
  }
  ...
  Component_srcLineSprite = (struct StonePurchaseListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                                        dispObject,
                                                                        (const MethodInfo_1DEBFC4 *)Method_UnityEngine_GameObject_GetComponent_StonePurchaseListViewItemDraw___);
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                    DragObject,
                                                    (const MethodInfo_1DEBFC4 *)Method_UnityEngine_GameObject_GetComponent_StonePurchaseListViewObject___)) == 0LL) )
  {
...
LABEL_14:
    ...
    sub_B77560((BattleServantConfConponent_o *)&v12[3], gameObject, v14, v15, v16, v17, v18, v19);
    v20 = (System_Int32_array **)StringLiteral_6308/*"EventExitMove2"*/;
    v12[3].monitor = (void *)StringLiteral_6308/*"EventExitMove2"*/;
    sub_B77560((BattleServantConfConponent_o *)&v12[3].monitor, v20, v21, v22, v23, v24, v25, v26);
  }
}
...
// local variable allocation has failed, the output may be wrong!
void __fastcall StonePurchaseListViewObject__Init_23904396(
        StonePurchaseListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall StonePurchaseListViewObject__Init_23905624(
        StonePurchaseListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall StonePurchaseListViewObject__Init_23905688(
        StonePurchaseListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall StonePurchaseListViewObject__SetupDisp(StonePurchaseListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( linkItem )
  {
    v4 = *(&StonePurchaseListViewItem_TypeInfo->_2.bitflags2 + 1);
    if ( *(&linkItem->klass->_2.bitflags2 + 1) >= (unsigned int)v4
      && (StonePurchaseListViewItem_c *)linkItem->klass->_2.typeHierarchy[v4 - 1] == StonePurchaseListViewItem_TypeInfo )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_438A55C & 1) == 0 )
  {
    sub_B775C4(&StonePurchaseListViewItemDraw_DispMode_TypeInfo);
    sub_B775C4(&StringLiteral_82/*" "*/);
    byte_438A55C = 1;
  }
  v14 = 0.0;
  v13 = 0LL;
  v4 = j_il2cpp_value_box_0(StonePurchaseListViewItemDraw_DispMode_TypeInfo, &this->fields.dispMode, v2);
  if ( !v4 )
    sub_B7769C(0LL, v5);
  v6 = v4;
        ...
        const MethodInfo *method)
{
  ...
  v11 = (StonePurchaseListViewObject_o *)sub_B77990(v8);
