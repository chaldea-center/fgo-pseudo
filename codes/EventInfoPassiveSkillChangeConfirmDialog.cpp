        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v21.fields.fakeValue = v8;
  ServantLimitCountSealAfter = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_55997068(v21, 0);
  if ( !Master_object )
    goto LABEL_30;
         ...
         0) )
  {
    ...
    *(_QWORD *)&v22.fields.fakeValue = v16;
    ServantLimitCountSealAfter = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_55997068(v22, 0);
    if ( entity )
    {
      if ( v17 )
      {
...
LABEL_30:
    sub_2213CDC(ServantLimitCountSealAfter, v11);
  }
  v18 = -1;
  return ServantEntity__getName(servantEntity, v18, -1, 1, 0, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5971D0F & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_EventInfoPassiveSkillChangeConfirmDialog_OnClose__);
    sub_2213A60(&Method_EventInfoPassiveSkillChangeConfirmDialog__OnClose_b__9_0__);
    byte_5971D0F = 1;
  }
  if ( BaseDialog__IsInputState((BaseDialog_o *)this, 0) )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoPassiveSkillChangeConfirmDialog_OnClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_2213A78(Method_EventInfoPassiveSkillChangeConfirmDialog_OnClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5971D0E & 1) == 0 )
  {
    ...
    sub_2213A60(&StringLiteral_5829/*"EVENT_INFO_PASSIVE_SKILL_CHANGE_CONFIRM_DIALOG_DESCRIPTION"*/);
    byte_5971D0E = 1;
  }
  ...
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_5829/*"EVENT_INFO_PASSIVE_SKILL_CHANGE_CONFIRM_DIALOG_DESCRIPTION"*/, 0);
  ClassName = (System_String_o *)sub_2213B20(object___TypeInfo, 2);
...
LABEL_19:
  ...
  if ( ClassName )
  {
    ClassName = (System_String_o *)sub_2213BB4(ClassName, v24->obj.klass->_1.element_class);
    if ( !ClassName )
    {
LABEL_18:
      v37 = sub_2213D00(ClassName, v26);
      sub_2213BA0(v37, 0);
    }
  }
LABEL_12:
  if ( !LODWORD(v24->max_length) )
    goto LABEL_17;
  v24->m_Items[0] = v25;
  sub_2213A04((MissionNaviTransitionBoardItem_o *)v24->m_Items, (int32_t)v25, v18, v19, v20, v21, v22, v23);
...
LABEL_17:
    sub_2213CE4(ClassName);
  v24->m_Items[1] = v35;
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&v24->m_Items[1], (int32_t)v35, v29, v30, v31, v32, v33, v34);
  UILabelHelper__SetTextSafely_51178244(descriptionLabel, v15, v24, 0);
