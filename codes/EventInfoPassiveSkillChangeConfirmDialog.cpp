        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v18.fields.fakeValue = v6;
  ServantLimitCountSealAfter = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_50331200(v18, 0);
  if ( !Master_object )
    goto LABEL_30;
         ...
         0) )
  {
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    v11 = DataManager__GetMaster_object_((const MethodInfo_324F164 *)Method_DataManager_GetMaster_ServantLimitImageMaster___);
    ...
    *(_QWORD *)&v19.fields.fakeValue = v12;
    ServantLimitCountSealAfter = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_50331200(v19, 0);
    if ( entity )
    {
      if ( v14 )
      {
...
LABEL_30:
    sub_1D0F30C(ServantLimitCountSealAfter, v10);
  }
  v15 = -1;
  return ServantEntity__getName(servantEntity, v15, -1, 1, 0, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E78AC8 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_EventInfoPassiveSkillChangeConfirmDialog_OnClose__);
    sub_1D0F0B4(&Method_EventInfoPassiveSkillChangeConfirmDialog__OnClose_b__9_0__);
    byte_4E78AC8 = 1;
  }
  if ( BaseDialog__IsInputState((BaseDialog_o *)this, 0) )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoPassiveSkillChangeConfirmDialog_OnClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1D0F0CC(Method_EventInfoPassiveSkillChangeConfirmDialog_OnClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E78AC7 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_5678/*"EVENT_INFO_PASSIVE_SKILL_CHANGE_CONFIRM_DIALOG_DESCRIPTION"*/);
    byte_4E78AC7 = 1;
  }
  ...
  v14 = LocalizationManager__Get((System_String_o *)StringLiteral_5678/*"EVENT_INFO_PASSIVE_SKILL_CHANGE_CONFIRM_DIALOG_DESCRIPTION"*/, 0);
  ClassName = (System_String_o *)sub_1D0F15C(object___TypeInfo, 2);
...
LABEL_18:
  ...
  if ( ClassName )
  {
    ClassName = (System_String_o *)sub_1D0F1F0(ClassName, v23->obj.klass->_1.element_class);
    if ( !ClassName )
    {
LABEL_19:
      v35 = sub_1D0F330(ClassName);
      sub_1D0F1DC(v35, 0);
    }
  }
LABEL_12:
  if ( !LODWORD(v23->max_length) )
    goto LABEL_17;
  v23->m_Items[0] = v24;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)v23->m_Items, (int32_t)v24, v17, v18, v19, v20, v21, v22);
...
LABEL_17:
    sub_1D0F314(ClassName);
  v23->m_Items[1] = v33;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&v23->m_Items[1], (int32_t)v33, v27, v28, v29, v30, v31, v32);
  UILabelHelper__SetTextSafely_45516012(descriptionLabel, v14, v23, 0);
