...
void EventRewardPartsSkillConfirmDialog__Close(EventRewardPartsSkillConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C51572 & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_EventRewardPartsSkillConfirmDialog_Init__);
    byte_4C51572 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C51574 & 1) == 0 )
  {
    sub_1C3E564(&Method_EventRewardPartsSkillConfirmDialog_OnClickCancel__);
    byte_4C51574 = 1;
  }
  if ( this->fields.baseState == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_EventRewardPartsSkillConfirmDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3E57C(Method_EventRewardPartsSkillConfirmDialog_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C51573 & 1) == 0 )
  {
    sub_1C3E564(&Method_EventRewardPartsSkillConfirmDialog_OnClickDecide__);
    byte_4C51573 = 1;
  }
  if ( this->fields.baseState == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_EventRewardPartsSkillConfirmDialog_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3E57C(Method_EventRewardPartsSkillConfirmDialog_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C3E548(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C51571 & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_EventRewardPartsSkillConfirmDialog___c__DisplayClass16_0__Open_b__0__);
    sub_1C3E564(&EventRewardPartsSkillConfirmDialog___c__DisplayClass16_0_TypeInfo);
    sub_1C3E564(&StringLiteral_5698/*"EVENT_REWARD_PARTS_SKILL_TITLE"*/);
    sub_1C3E564(&StringLiteral_5694/*"EVENT_REWARD_PARTS_SKILL_INFO_TITLE"*/);
    sub_1C3E564(&StringLiteral_5695/*"EVENT_REWARD_PARTS_SKILL_MSG"*/);
    sub_1C3E564(&StringLiteral_3688/*"COMMON_CONFIRM_NO"*/);
    sub_1C3E564(&StringLiteral_3693/*"COMMON_CONFIRM_YES"*/);
    sub_1C3E564(&StringLiteral_5693/*"EVENT_REWARD_PARTS_SKILL_CONFIRM"*/);
    byte_4C51571 = 1;
  }
  v7 = (Il2CppObject *)sub_1C3E7B0(EventRewardPartsSkillConfirmDialog___c__DisplayClass16_0_TypeInfo);
  System_Object___ctor(v7, 0);
  if ( !v7 )
    goto LABEL_27;
  v7[1].klass = (Il2CppClass *)this;
  Master_object = (AssistMaster_o *)sub_1C3E508(&v7[1], this);
  if ( !shopEnt )
    goto LABEL_27;
  ...
  Master_object = (AssistMaster_o *)sub_1C3E508(&v7[1].monitor, NextPartsEntity);
  if ( !v7[1].monitor )
    goto LABEL_27;
  v14 = (System_String_o *)*((_QWORD *)v7[1].monitor + 3);
  this->fields.onDecide = onDecideAction;
  sub_1C3E508(&this->fields.onDecide, onDecideAction);
  ...
  Master_object = (AssistMaster_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5698/*"EVENT_REWARD_PARTS_SKILL_TITLE"*/, 0);
  if ( !titleLabel )
    goto LABEL_27;
  ...
  Master_object = (AssistMaster_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5694/*"EVENT_REWARD_PARTS_SKILL_INFO_TITLE"*/, 0);
  ...
  v21 = LocalizationManager__Get((System_String_o *)StringLiteral_5695/*"EVENT_REWARD_PARTS_SKILL_MSG"*/, 0);
  ...
  Master_object = (AssistMaster_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5693/*"EVENT_REWARD_PARTS_SKILL_CONFIRM"*/, 0);
  if ( !confirmMsgLabel
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C51577 & 1) == 0 )
  {
    this = (EventRewardPartsSkillConfirmDialog___c__DisplayClass16_0_o *)sub_1C3E564(&AtlasManager_TypeInfo);
    byte_4C51577 = 1;
  }
