        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFC97D & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_EventRewardPartsSkillConfirmDialog_Init__, v3);
    byte_4AFC97D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFC97F & 1) == 0 )
  {
    sub_1BC3008(&Method_EventRewardPartsSkillConfirmDialog_OnClickCancel__, method);
  ...
  if ( this->fields.baseState == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_EventRewardPartsSkillConfirmDialog_OnClickCancel__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1BC3020(Method_EventRewardPartsSkillConfirmDialog_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFC97E & 1) == 0 )
  {
    sub_1BC3008(&Method_EventRewardPartsSkillConfirmDialog_OnClickDecide__, method);
    sub_1BC3008(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v3);
    byte_4AFC97E = 1;
  }
  if ( this->fields.baseState == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_EventRewardPartsSkillConfirmDialog_OnClickDecide__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1BC3020(Method_EventRewardPartsSkillConfirmDialog_OnClickDecide__);
    v5 = (System_Reflection_MethodBase_o *)sub_1BC2FEC(v4, v4[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFC97C & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_BaseDialog_EndOpenBaseDialog__, v8);
    sub_1BC3008(&Method_DataManager_GetMaster_AssistMaster___, v9);
    sub_1BC3008(&DataManager_TypeInfo, v10);
    sub_1BC3008(&LocalizationManager_TypeInfo, v11);
    sub_1BC3008(&Method_EventRewardPartsSkillConfirmDialog___c__DisplayClass16_0__Open_b__0__, v12);
    sub_1BC3008(&EventRewardPartsSkillConfirmDialog___c__DisplayClass16_0_TypeInfo, v13);
    sub_1BC3008(&StringLiteral_5648/*"EVENT_REWARD_PARTS_SKILL_TITLE"*/, v14);
    sub_1BC3008(&StringLiteral_5644/*"EVENT_REWARD_PARTS_SKILL_INFO_TITLE"*/, v15);
    sub_1BC3008(&StringLiteral_5645/*"EVENT_REWARD_PARTS_SKILL_MSG"*/, v16);
    sub_1BC3008(&StringLiteral_3651/*"COMMON_CONFIRM_NO"*/, v17);
    sub_1BC3008(&StringLiteral_3656/*"COMMON_CONFIRM_YES"*/, v18);
    sub_1BC3008(&StringLiteral_5643/*"EVENT_REWARD_PARTS_SKILL_CONFIRM"*/, v19);
    byte_4AFC97C = 1;
  }
  v20 = (Il2CppObject *)sub_1BC3254(EventRewardPartsSkillConfirmDialog___c__DisplayClass16_0_TypeInfo);
  System_Object___ctor(v20, 0LL);
  if ( !v20 )
    goto LABEL_27;
  v20[1].klass = (Il2CppClass *)this;
  Master_object = (AssistMaster_o *)sub_1BC2FAC(&v20[1]);
  if ( !shopEnt )
    goto LABEL_27;
  ...
  if ( !targetIds->max_length )
    sub_1BC326C(Master_object, v22, v23);
  ...
  Master_object = (AssistMaster_o *)sub_1BC2FAC(&v20[1].monitor);
  if ( !v20[1].monitor )
    goto LABEL_27;
  ...
  Master_object = (AssistMaster_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5648/*"EVENT_REWARD_PARTS_SKILL_TITLE"*/, 0LL);
  if ( !titleLabel )
    goto LABEL_27;
  ...
  Master_object = (AssistMaster_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5644/*"EVENT_REWARD_PARTS_SKILL_INFO_TITLE"*/, 0LL);
  ...
  v34 = LocalizationManager__Get((System_String_o *)StringLiteral_5645/*"EVENT_REWARD_PARTS_SKILL_MSG"*/, 0LL);
  ...
  Master_object = (AssistMaster_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5643/*"EVENT_REWARD_PARTS_SKILL_CONFIRM"*/, 0LL);
  if ( !confirmMsgLabel
    || (UILabel__set_text(confirmMsgLabel, (System_String_o *)Master_object, 0LL),
        decideLabel = this->fields.decideLabel,
        Master_object = (AssistMaster_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3656/*"COMMON_CONFIRM_YES"*/, 0LL),
        !decideLabel)
    || (UILabel__set_text(decideLabel, (System_String_o *)Master_object, 0LL),
        cancelLabel = this->fields.cancelLabel,
        Master_object = (AssistMaster_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3651/*"COMMON_CONFIRM_NO"*/, 0LL),
        !cancelLabel) )
  {
LABEL_27:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFC982 & 1) == 0 )
  {
    this = (EventRewardPartsSkillConfirmDialog___c__DisplayClass16_0_o *)sub_1BC3008(&AtlasManager_TypeInfo, method);
    byte_4AFC982 = 1;
  }
