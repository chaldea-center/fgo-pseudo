...
void EventRewardPartsSkillConfirmDialog__Close(EventRewardPartsSkillConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFF150 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_EventRewardPartsSkillConfirmDialog_Init__);
    byte_4DFF150 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFF152 & 1) == 0 )
  {
    sub_1CE6700(&Method_EventRewardPartsSkillConfirmDialog_OnClickCancel__);
    byte_4DFF152 = 1;
  }
  if ( this->fields.baseState == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_EventRewardPartsSkillConfirmDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_EventRewardPartsSkillConfirmDialog_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFF151 & 1) == 0 )
  {
    sub_1CE6700(&Method_EventRewardPartsSkillConfirmDialog_OnClickDecide__);
    byte_4DFF151 = 1;
  }
  if ( this->fields.baseState == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_EventRewardPartsSkillConfirmDialog_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_EventRewardPartsSkillConfirmDialog_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1CE66E4(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFF14F & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_EventRewardPartsSkillConfirmDialog___c__DisplayClass16_0__Open_b__0__);
    sub_1CE6700(&EventRewardPartsSkillConfirmDialog___c__DisplayClass16_0_TypeInfo);
    sub_1CE6700(&StringLiteral_5738/*"EVENT_REWARD_PARTS_SKILL_TITLE"*/);
    sub_1CE6700(&StringLiteral_5734/*"EVENT_REWARD_PARTS_SKILL_INFO_TITLE"*/);
    sub_1CE6700(&StringLiteral_5735/*"EVENT_REWARD_PARTS_SKILL_MSG"*/);
    sub_1CE6700(&StringLiteral_3717/*"COMMON_CONFIRM_NO"*/);
    sub_1CE6700(&StringLiteral_3722/*"COMMON_CONFIRM_YES"*/);
    sub_1CE6700(&StringLiteral_5733/*"EVENT_REWARD_PARTS_SKILL_CONFIRM"*/);
    byte_4DFF14F = 1;
  }
  v7 = (Il2CppObject *)sub_1CE694C(EventRewardPartsSkillConfirmDialog___c__DisplayClass16_0_TypeInfo);
  System_Object___ctor(v7, 0);
  if ( !v7 )
    goto LABEL_27;
  v7[1].klass = (Il2CppClass *)this;
  Master_object = (AssistMaster_o *)sub_1CE66A4(&v7[1], this);
  if ( !shopEnt )
    goto LABEL_27;
  ...
  Master_object = (AssistMaster_o *)DataManager__GetMaster_object_((const MethodInfo_3204354 *)Method_DataManager_GetMaster_AssistMaster___);
  if ( !Master_object )
    goto LABEL_27;
  ...
  Master_object = (AssistMaster_o *)sub_1CE66A4(&v7[1].monitor, NextPartsEntity);
  if ( !v7[1].monitor )
    goto LABEL_27;
  v14 = (System_String_o *)*((_QWORD *)v7[1].monitor + 3);
  this->fields.onDecide = onDecideAction;
  sub_1CE66A4(&this->fields.onDecide, onDecideAction);
  ...
  Master_object = (AssistMaster_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5738/*"EVENT_REWARD_PARTS_SKILL_TITLE"*/, 0);
  if ( !titleLabel )
    goto LABEL_27;
  ...
  Master_object = (AssistMaster_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5734/*"EVENT_REWARD_PARTS_SKILL_INFO_TITLE"*/, 0);
  ...
  v21 = LocalizationManager__Get((System_String_o *)StringLiteral_5735/*"EVENT_REWARD_PARTS_SKILL_MSG"*/, 0);
  ...
  Master_object = (AssistMaster_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5733/*"EVENT_REWARD_PARTS_SKILL_CONFIRM"*/, 0);
  if ( !confirmMsgLabel
    || (UILabel__set_text(confirmMsgLabel, (System_String_o *)Master_object, 0),
        decideLabel = this->fields.decideLabel,
        Master_object = (AssistMaster_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3722/*"COMMON_CONFIRM_YES"*/, 0),
        !decideLabel)
    || (UILabel__set_text(decideLabel, (System_String_o *)Master_object, 0),
        cancelLabel = this->fields.cancelLabel,
        Master_object = (AssistMaster_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3717/*"COMMON_CONFIRM_NO"*/, 0),
        !cancelLabel) )
  {
LABEL_27:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFF155 & 1) == 0 )
  {
    this = (EventRewardPartsSkillConfirmDialog___c__DisplayClass16_0_o *)sub_1CE6700(&AtlasManager_TypeInfo);
    byte_4DFF155 = 1;
  }
