        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_43500D1 & 1) == 0 )
  {
    ...
    this = (WarehouseUIDragDropListViewItem_o *)sub_B70694(&WarehouseListViewObject_TypeInfo);
    byte_43500D1 = 1;
  }
  mListViewObject = (WarehouseListViewObject_o *)v3->fields.mListViewObject;
  if ( !mListViewObject )
    goto LABEL_24;
  v5 = *(&WarehouseListViewObject_TypeInfo->_2.bitflags2 + 1);
  if ( *(&mListViewObject->klass->_2.bitflags2 + 1) < (unsigned int)v5
    || (WarehouseListViewObject_c *)mListViewObject->klass->_2.typeHierarchy[v5 - 1] != WarehouseListViewObject_TypeInfo )
  {
    sub_B70A60(v3->fields.mListViewObject);
    goto LABEL_22;
  }
...
LABEL_23:
    ...
    WarehouseListViewObject__Init(mListViewObject, 3, 0LL, zero.fields.x, *(UnityEngine_Vector3_o *)&zero.fields.y, v11);
    goto LABEL_24;
  }
  v6 = *(&WarehouseListViewManager_TypeInfo->_2.bitflags2 + 1);
...
LABEL_22:
  ...
  WarehouseListViewObject__Init(mListViewObject, 3, 0LL, v12.fields.x, *(UnityEngine_Vector3_o *)&v12.fields.y, v7);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B70694(&WarehouseListViewManager_TypeInfo);
    sub_B70694(&WarehouseListViewObject_TypeInfo);
    byte_43500D0 = 1;
  }
  mListViewObject = this->fields.mListViewObject;
  if ( !mListViewObject )
LABEL_11:
    sub_B7076C(mListViewObject, surface);
  ...
  {
LABEL_10:
    mListViewObject = (struct ListViewObject_o *)sub_B70A60(mListViewObject);
    goto LABEL_11;
  }
...
LABEL_24:
  ...
  {
    sub_B70A60(this->fields.mListViewObject);
  }
  v14 = (WarehouseUIDragDropListViewItem_o *)sub_B70A60(mDragScrollView);
  WarehouseUIDragDropListViewItem__OnDragDropMove(v14, v16, v15);
}
...
{
  void *main; // x0
  WarehouseListViewManager_c *v4; // x1
  ...
  if ( (byte_43500CF & 1) == 0 )
  {
    sub_B70694(&UnityEngine_BoxCollider_TypeInfo);
    sub_B70694(&Method_UnityEngine_Component_GetComponent_WarehouseListViewObject___);
    sub_B70694(&UnityEngine_Object_TypeInfo);
  ...
  UnityEngine_Camera__ScreenPointToRay_41063004(&v48, v5, v50, 0LL);
  v47 = v48;
  if ( UnityEngine_Physics__Raycast_16817328(&v47, &v49, 0LL) )
  {
    ...
    Component_WebViewObject = (UnityEngine_Object_o *)UnityEngine_Component__GetComponent_WebViewObject_(
                                                        ...
                                                        (const MethodInfo_1BE3FF4 *)Method_UnityEngine_Component_GetComponent_WarehouseListViewObject___);
    if ( (BYTE3(UnityEngine_Object_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
      && !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    {
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    ...
    if ( ((unsigned __int8)main & 1) != 0 )
    {
      ...
      if ( monitor )
      {
        ...
        if ( *(&monitor->klass->_2.bitflags2 + 1) < (unsigned int)v10
          || (WarehouseListViewManager_c *)monitor->klass->_2.typeHierarchy[v10 - 1] != WarehouseListViewManager_TypeInfo )
        {
  ...
  *(UnityEngine_Vector3_o *)&v18 = UnityEngine_Camera__ScreenToWorldPoint_41062500(v16, v51, 0LL);
  if ( !klass )
    goto LABEL_83;
  v21 = v18;
  v22 = v19;
  ...
  {
LABEL_85:
    v44 = (WarehouseUIDragDropListViewItem_o *)sub_B70A60(main);
...
LABEL_76:
            v39 = 0;
            if ( !UIScrollView__IsLimitOverPosition2_38904620(
...
LABEL_80:
  v43 = 0;
  if ( !UIScrollView__IsLimitOverPosition2_38904620((UIScrollView_o *)scrollView, *(UnityEngine_Vector3_o *)&v42, 0LL) )
  {
    v40 = -0.5;
    goto LABEL_82;
  }
