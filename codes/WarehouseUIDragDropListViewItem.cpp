        ...
        const MethodInfo *method)
{
  ...
  WarehouseUIDragDropListViewItem_o *v13; // x0
...
LABEL_22:
    ...
    && (WarehouseListViewObject_c *)mListViewObject->klass->_2.typeHierarchy[naturalAligment - 1] == WarehouseListViewObject_TypeInfo )
  {
    ...
    if ( !mDragScrollView
      || (v7 = (const MethodInfo *)WarehouseListViewManager_TypeInfo,
          v9 = WarehouseListViewManager_TypeInfo->_2.naturalAligment,
          mDragScrollView->klass->_2.naturalAligment >= (unsigned int)v9)
      && (WarehouseListViewManager_c *)mDragScrollView->klass->_2.typeHierarchy[v9 - 1] == WarehouseListViewManager_TypeInfo )
    {
      Item = (ListViewItem_o *)WarehouseListViewObject__GetItem(
                                 (WarehouseListViewObject_o *)this->fields.mListViewObject,
                                 v7);
      WarehouseListViewObject__OnDragDropStart(mListViewObject, v11);
      if ( Item )
      {
...
void WarehouseUIDragDropListViewItem__Update(WarehouseUIDragDropListViewItem_o *this, const MethodInfo *method)
{
  ...
  {
LABEL_77:
    main = (intptr_t)WarehouseListViewObject__GetItem((WarehouseListViewObject_o *)Component_object, v8);
    goto LABEL_78;
  }
