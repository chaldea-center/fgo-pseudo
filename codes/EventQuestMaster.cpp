void EventQuestMaster___ctor(EventQuestMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4E04AD4 & 1) == 0 )
  {
    sub_1CE6700(&Method_DataMasterBase_EventQuestMaster__EventQuestEntity__string___ctor__);
    byte_4E04AD4 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    86,
    (const MethodInfo_34EBC44 *)Method_DataMasterBase_EventQuestMaster__EventQuestEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( AddPassiveCampaigns )
  {
              ...
              (const MethodInfo_36809F0 *)Method_System_Collections_Generic_List_Enumerator_EventCampaignEntity__MoveNext__) )
    {
      ...
      {
        if ( !current )
          sub_1CE6958(IsPassiveCampaignApplicable, v15);
        if ( !v8 )
          sub_1CE6958(IsPassiveCampaignApplicable, v15);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E04AD6 & 1) == 0 )
  {
    ...
    sub_1CE6700(&DataManager_TypeInfo);
    sub_1CE6700(&Method_System_Linq_Enumerable_OfType_EventQuestEntity___);
    sub_1CE6700(&Method_System_Linq_Enumerable_OrderBy_EventQuestEntity__int___);
    sub_1CE6700(&Method_System_Linq_Enumerable_ToArray_EventQuestEntity___);
    sub_1CE6700(&System_Func_EventQuestEntity__int__TypeInfo);
    ...
    sub_1CE6700(&Method_EventQuestMaster___c__GetEnabledEventCampaignForQuest_b__6_0__);
    sub_1CE6700(&EventQuestMaster___c_TypeInfo);
    byte_4E04AD6 = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  ...
  if ( !eventQuestEntitiesOrderedByIsExceptedCache )
  {
    v15 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__OfType_object_(
                                                                 ...
                                                                 (const MethodInfo_3232D7C *)Method_System_Linq_Enumerable_OfType_EventQuestEntity___);
    ...
    if ( !_9__6_0 )
    {
      ...
      _9__6_0 = (System_Func_object__int__o *)sub_1CE694C(System_Func_EventQuestEntity__int__TypeInfo);
    ...
    v26 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__OrderBy_object__int_(
                                                                 ...
                                                                 (const MethodInfo_32333CC *)Method_System_Linq_Enumerable_OrderBy_EventQuestEntity__int___);
    eventQuestEntitiesOrderedByIsExceptedCache = (GrandQuestFolderBoardItem_c *)System_Linq_Enumerable__ToArray_object_(
                                                                                  v26,
                                                                                  (const MethodInfo_32438A8 *)Method_System_Linq_Enumerable_ToArray_EventQuestEntity___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E04AD2 & 1) == 0 )
  {
    sub_1CE6700(&Method_DataMasterBase_EventQuestMaster__EventQuestEntity__string__GetEntity__);
    byte_4E04AD2 = 1;
  }
  ...
  return (EventQuestEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                 (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                 PK,
                                 (const MethodInfo_34EE1BC *)Method_DataMasterBase_EventQuestMaster__EventQuestEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E04AD5 & 1) == 0 )
  {
    sub_1CE6700(&Method_System_Collections_ObjectModel_Collection_EventQuestEntity__get_Count__);
    sub_1CE6700(&Method_System_Collections_ObjectModel_Collection_EventQuestEntity__get_Item__);
    byte_4E04AD5 = 1;
  }
  ...
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            ...
            (const MethodInfo_3480AB0 *)Method_System_Collections_ObjectModel_Collection_EventQuestEntity__get_Count__);
  if ( Count >= 1 )
  {
    v7 = Count;
    v8 = 0;
    while ( 1 )
    {
      ...
      result = (EventQuestEntity_o *)System_Collections_ObjectModel_Collection_object___get_Item(
                                       (System_Collections_ObjectModel_Collection_T__o *)result,
                                       v8,
                                       (const MethodInfo_3480B40 *)Method_System_Collections_ObjectModel_Collection_EventQuestEntity__get_Item__);
      if ( !result )
        break;
...
LABEL_12:
    sub_1CE6958(result, *(_QWORD *)&questId);
  }
  return 0;
}
        ...
        const MethodInfo *method)
{
  ...
  __int64 v17; // x1
  const MethodInfo_3243710 *v18; // x1
  ...
  if ( !(questPhase | questId) )
  {
    ...
    if ( Instance )
    {
      ...
      if ( Instance )
      {
        ...
        v18 = (const MethodInfo_3243710 *)Method_System_Linq_Enumerable_ToArray_int___;
...
LABEL_22:
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Instance = DataManager__GetMaster_object_((const MethodInfo_3204354 *)Method_DataManager_GetMaster_QuestGroupMaster___);
  if ( !Instance )
    goto LABEL_22;
            ...
            (const MethodInfo_367C970 *)Method_System_Collections_Generic_HashSet_Enumerator_int__MoveNext__) )
  {
    ...
    {
      if ( !v9 )
        sub_1CE6958(IsEventNotIncluded, v17);
      System_Collections_Generic_HashSet_int___Add(
        v9,
        current,
        (const MethodInfo_37AE4C4 *)Method_System_Collections_Generic_HashSet_int__Add__);
        ...
        const MethodInfo *method)
{
  ...
  if ( max_length >= 1 )
  {
    ...
    {
      if ( max_length == v11 )
        sub_1CE6960(EnabledEventCampaignForQuest);
...
LABEL_12:
    sub_1CE6958(EnabledEventCampaignForQuest, v9);
  }
  v11 = 0;
  return v11 >= max_length;
}
...
bool EventQuestMaster__IsExistEvent(EventQuestMaster_o *this, int32_t eventId, const MethodInfo *method)
{
  ...
  if ( (byte_4E04ADA & 1) == 0 )
  {
    sub_1CE6700(&Method_System_Linq_Enumerable_Any_EventQuestEntity___);
    sub_1CE6700(&Method_System_Linq_Enumerable_Where_EventQuestEntity___);
    sub_1CE6700(&System_Func_EventQuestEntity__bool__TypeInfo);
    sub_1CE6700(&Method_EventQuestMaster___c__IsExistEvent_b__11_0__);
    sub_1CE6700(&Method_EventQuestMaster___c__DisplayClass11_0__IsExistEvent_b__1__);
    sub_1CE6700(&EventQuestMaster___c__DisplayClass11_0_TypeInfo);
    sub_1CE6700(&EventQuestMaster___c_TypeInfo);
    byte_4E04ADA = 1;
  }
  v5 = sub_1CE694C(EventQuestMaster___c__DisplayClass11_0_TypeInfo);
  ...
  *(_DWORD *)(v5 + 16) = eventId;
  ...
  if ( !_9__11_0 )
  {
    ...
    _9__11_0 = (System_Func_object__bool__o *)sub_1CE694C(System_Func_EventQuestEntity__bool__TypeInfo);
  ...
  v19 = System_Linq_Enumerable__Where_object_(
          ...
          (const MethodInfo_324B214 *)Method_System_Linq_Enumerable_Where_EventQuestEntity___);
  v20 = (System_Func_object__bool__o *)sub_1CE694C(System_Func_EventQuestEntity__bool__TypeInfo);
  ...
  return System_Linq_Enumerable__Any_object__52502356(
           ...
           (const MethodInfo_3211F54 *)Method_System_Linq_Enumerable_Any_EventQuestEntity___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E04AD7 & 1) == 0 )
  {
    sub_1CE6700(&Method_System_Collections_ObjectModel_Collection_EventQuestEntity__GetEnumerator__);
    sub_1CE6700(&System_IDisposable_TypeInfo);
    sub_1CE6700(&System_Collections_Generic_IEnumerator_EventQuestEntity__TypeInfo);
  ...
  Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                 list,
                 (const MethodInfo_3481088 *)Method_System_Collections_ObjectModel_Collection_EventQuestEntity__GetEnumerator__);
  if ( !Enumerator )
    sub_1CE6958(0, v10);
  while ( 1 )
  {
...
LABEL_9:
    ...
    {
LABEL_16:
      v20 = sub_1CBCA7C(Enumerator, System_Collections_Generic_IEnumerator_EventQuestEntity__TypeInfo, 0);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( e->fields._action > 4u )
  {
    ...
    v10 = sub_1CE6714(&Method_EventQuestMaster_OnListChangedImplementation__);
    sub_1CE6828(v9, v10);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E04AD3 & 1) == 0 )
  {
    sub_1CE6700(&Method_DataMasterBase_EventQuestMaster__EventQuestEntity__string__TryGetEntity__);
    byte_4E04AD3 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_34EE208 *)Method_DataMasterBase_EventQuestMaster__EventQuestEntity__string__TryGetEntity__);
}
...
void EventQuestMaster___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1CE694C(EventQuestMaster___c_TypeInfo);
