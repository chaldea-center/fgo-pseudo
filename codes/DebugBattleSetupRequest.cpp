...
System_String_o *DebugBattleSetupRequest__getURL(DebugBattleSetupRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2E3AB & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_18108/*"clientdebug/battlesetup"*/);
    byte_4D2E3AB = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64417744(BaseUrl, (System_String_o *)StringLiteral_18108/*"clientdebug/battlesetup"*/, 0);
}