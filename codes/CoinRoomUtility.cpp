void __fastcall CoinRoomUtility___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B20157 & 1) == 0 )
  {
    sub_1BCAFF8(&CoinRoomUtility_TypeInfo, v1);
    sub_1BCAFF8(&StringLiteral_4490/*"CoinRoom"*/, v4);
    byte_4B20157 = 1;
  }
  CoinRoomUtility_TypeInfo->static_fields->ASSET_NAME = (struct System_String_o *)StringLiteral_4490/*"CoinRoom"*/;
  sub_1BCAF9C((CGThumbnailListItem_o *)CoinRoomUtility_TypeInfo->static_fields, StringLiteral_4490/*"CoinRoom"*/, v2, v3);
  v6.fields._dateData = (uint64_t)&v5;
  CoinRoomUtility_TypeInfo->static_fields->EFFECT_FADE_TIME = 0.5;
  v5 = 0LL;
  System_DateTime___ctor_63835756(v6, 1970, 1, 1, 0, 0, 0, 1, 0LL);
...
int32_t __fastcall CoinRoomUtility__CalcPoint(const MethodInfo *method)
{
  ...
  if ( (byte_4B2014D & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_3510/*"COIN_ROOM_GET"*/, v1);
    byte_4B2014D = 1;
  }
  return ConstantMaster__getValue((System_String_o *)StringLiteral_3510/*"COIN_ROOM_GET"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B20155 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_AssetData_GetObjectList_GameObject___, name);
    ...
    sub_1BCAFF8(&Method_System_Collections_Generic_List_UIAtlas__Add__, v7);
    ...
    assetData = (AssetData_o *)sub_1BCAFF8(&UnityEngine_Object_TypeInfo, v10);
    byte_4B20155 = 1;
  }
  if ( !v4
    || (assetData = (AssetData_o *)AssetData__GetObjectList_object_(
                                     v4,
                                     (const MethodInfo_2FFC188 *)Method_AssetData_GetObjectList_GameObject___)) == 0LL )
  {
LABEL_18:
    sub_1BCB254(assetData, name);
  }
  v11 = (int)assetData->fields.name;
  v12 = (System_Collections_Generic_List_object__o *)sub_1BCB244(System_Collections_Generic_List_UIAtlas__TypeInfo);
  ...
  if ( v11 >= 1 )
  {
    ...
    do
    {
      ...
      v15 = System_String__Concat_62450424(name, v14, 0LL);
...
UserCoinRoomEntity_o *__fastcall CoinRoomUtility__GetUserCoinRoomEntity(const MethodInfo *method)
{
  ...
  if ( (byte_4B20150 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_UserCoinRoomMaster___, v1);
    sub_1BCAFF8(&Method_DataMasterBase_UserCoinRoomMaster__UserCoinRoomEntity__long__TryGetEntity__, v2);
  ...
  MasterData_object = DataManager__GetMasterData_object_(
                        Instance,
                        (const MethodInfo_301AAA4 *)Method_DataManager_GetMasterData_UserCoinRoomMaster___);
...
LABEL_12:
  ...
  DataMasterBase_object__object__long___TryGetEntity(
    ...
    *(_QWORD *)(*(_QWORD *)&Instance[1].fields._DispLog + 64LL),
    (const MethodInfo_32CA3A8 *)Method_DataMasterBase_UserCoinRoomMaster__UserCoinRoomEntity__long__TryGetEntity__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B20151 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_System_Collections_ObjectModel_Collection_UserSvtCoinEntity__GetEnumerator__, v1);
    sub_1BCAFF8(&Method_DataManager_GetMaster_UserSvtCoinMaster___, v2);
    sub_1BCAFF8(&DataManager_TypeInfo, v3);
    sub_1BCAFF8(&Method_DataMasterBase_UserSvtCoinMaster__UserSvtCoinEntity__string__getEntityList__, v4);
    sub_1BCAFF8(&System_IDisposable_TypeInfo, v5);
    sub_1BCAFF8(&System_Collections_Generic_IEnumerator_UserSvtCoinEntity__TypeInfo, v6);
    sub_1BCAFF8(&System_Collections_IEnumerator_TypeInfo, v7);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_DataEntityBase__Add__, v8);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_DataEntityBase___ctor__, v9);
    sub_1BCAFF8(&System_Collections_Generic_List_DataEntityBase__TypeInfo, v10);
    byte_4B20151 = 1;
  }
  ...
  if ( !Master_object
    || (monitor = (System_Collections_ObjectModel_Collection_T__o *)Master_object[2].monitor,
        v14 = (System_Collections_Generic_List_object__o *)sub_1BCB244(System_Collections_Generic_List_DataEntityBase__TypeInfo),
        System_Collections_Generic_List_object____ctor(
          v14,
  ...
  Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                 monitor,
                 (const MethodInfo_3263BC0 *)Method_System_Collections_ObjectModel_Collection_UserSvtCoinEntity__GetEnumerator__);
  if ( !Enumerator )
    sub_1BCB254(0LL, v15);
  while ( 1 )
  {
...
LABEL_12:
    ...
    {
LABEL_19:
      v24 = sub_1C1B560(Enumerator, System_Collections_Generic_IEnumerator_UserSvtCoinEntity__TypeInfo, 0LL);
    }
...
bool __fastcall CoinRoomUtility__IsTargetQuestClear(const MethodInfo *method)
{
  ...
  if ( (byte_4B20154 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_UserQuestMaster___, v1);
    sub_1BCAFF8(&NetworkManager_TypeInfo, v2);
    sub_1BCAFF8(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v3);
    sub_1BCAFF8(&StringLiteral_3515/*"COIN_ROOM_RELEASE_QUEST_ID"*/, v4);
    byte_4B20154 = 1;
  }
  Value = ConstantMaster__getValue((System_String_o *)StringLiteral_3515/*"COIN_ROOM_RELEASE_QUEST_ID"*/, 0LL);
  Instance = (DataManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38F8AD8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_12;
  MasterData_object = DataManager__GetMasterData_object_(
...
int32_t __fastcall CoinRoomUtility__MaxPoint(const MethodInfo *method)
{
  ...
  if ( (byte_4B2014E & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_3513/*"COIN_ROOM_MAX"*/, v1);
    byte_4B2014E = 1;
  }
  return ConstantMaster__getValue((System_String_o *)StringLiteral_3513/*"COIN_ROOM_MAX"*/, 0LL);
}
...
int32_t __fastcall CoinRoomUtility__MonthExchangeMaxNum(const MethodInfo *method)
{
  ...
  if ( (byte_4B2014F & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_3514/*"COIN_ROOM_MAX_NUM"*/, v1);
    byte_4B2014F = 1;
  }
  return ConstantMaster__getValue((System_String_o *)StringLiteral_3514/*"COIN_ROOM_MAX_NUM"*/, 0LL);
}
...
int64_t __fastcall CoinRoomUtility__NextMonthUnixTime(const MethodInfo *method)
{
  ...
  if ( (byte_4B20156 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&NetworkManager_TypeInfo, v3);
    sub_1BCAFF8(&System_TimeSpan_TypeInfo, v4);
    byte_4B20156 = 1;
  }
  v13 = 0LL;
  v14 = 0LL;
  ...
  v11 = 0LL;
  System_DateTime___ctor_63834804(v18, Year, Month, 1, 0LL);
