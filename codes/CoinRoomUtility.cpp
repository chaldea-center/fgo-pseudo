void __fastcall CoinRoomUtility___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A0204B & 1) == 0 )
  {
    sub_1B64A00(&CoinRoomUtility_TypeInfo, v1);
    sub_1B64A00(&StringLiteral_4535/*"CoinRoom"*/, v4);
    byte_4A0204B = 1;
  }
  CoinRoomUtility_TypeInfo->static_fields->ASSET_NAME = (struct System_String_o *)StringLiteral_4535/*"CoinRoom"*/;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)CoinRoomUtility_TypeInfo->static_fields, StringLiteral_4535/*"CoinRoom"*/, v2, v3);
  v6.fields._dateData = (uint64_t)&v5;
  CoinRoomUtility_TypeInfo->static_fields->EFFECT_FADE_TIME = 0.5;
  v5 = 0LL;
  System_DateTime___ctor_62063952(v6, 1970, 1, 1, 0, 0, 0, 1, 0LL);
...
int32_t __fastcall CoinRoomUtility__CalcPoint(const MethodInfo *method)
{
  ...
  if ( (byte_4A02041 & 1) == 0 )
  {
    sub_1B64A00(&StringLiteral_3603/*"COIN_ROOM_GET"*/, v1);
    byte_4A02041 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02049 & 1) == 0 )
  {
    sub_1B64A00(&Method_AssetData_GetObjectList_GameObject___, name);
    ...
    sub_1B64A00(&Method_System_Collections_Generic_List_UIAtlas__Add__, v7);
    ...
    assetData = (AssetData_o *)sub_1B64A00(&UnityEngine_Object_TypeInfo, v10);
    byte_4A02049 = 1;
  }
  if ( !v4
    || (assetData = (AssetData_o *)AssetData__GetObjectList_object_(
                                     v4,
                                     (const MethodInfo_2E1E4C8 *)Method_AssetData_GetObjectList_GameObject___)) == 0LL )
  {
LABEL_18:
    sub_1B64C5C(assetData, name);
  }
  v11 = (int)assetData->fields.name;
  v12 = (System_Collections_Generic_List_object__o *)sub_1B64C4C(System_Collections_Generic_List_UIAtlas__TypeInfo);
  ...
  if ( v11 >= 1 )
  {
    ...
    do
    {
      ...
      v15 = System_String__Concat_61385136(name, v14, 0LL);
...
UserCoinRoomEntity_o *__fastcall CoinRoomUtility__GetUserCoinRoomEntity(const MethodInfo *method)
{
  ...
  if ( (byte_4A02044 & 1) == 0 )
  {
    sub_1B64A00(&Method_DataManager_GetMasterData_UserCoinRoomMaster___, v1);
    sub_1B64A00(&Method_DataMasterBase_UserCoinRoomMaster__UserCoinRoomEntity__long__TryGetEntity__, v2);
  ...
  MasterData_object = DataManager__GetMasterData_object_(
                        Instance,
                        (const MethodInfo_2E3BCE0 *)Method_DataManager_GetMasterData_UserCoinRoomMaster___);
...
LABEL_8:
  ...
  DataMasterBase_object__object__long___TryGetEntity(
    ...
    &entity,
    (int64_t)Instance,
    (const MethodInfo_30D6998 *)Method_DataMasterBase_UserCoinRoomMaster__UserCoinRoomEntity__long__TryGetEntity__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02045 & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_DataManager_GetMaster_UserSvtCoinMaster___, v2);
    sub_1B64A00(&DataManager_TypeInfo, v3);
    sub_1B64A00(&System_IDisposable_TypeInfo, v4);
    sub_1B64A00(&System_Collections_Generic_IEnumerator_DataEntityBase__TypeInfo, v5);
    sub_1B64A00(&System_Collections_IEnumerator_TypeInfo, v6);
    sub_1B64A00(&Method_System_Collections_Generic_List_DataEntityBase__Add__, v7);
    sub_1B64A00(&Method_System_Collections_Generic_List_DataEntityBase___ctor__, v8);
    sub_1B64A00(&System_Collections_Generic_List_DataEntityBase__TypeInfo, v9);
    sub_1B64A00(&UserSvtCoinEntity_TypeInfo, v10);
    byte_4A02045 = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2E3BC8C *)Method_DataManager_GetMaster_UserSvtCoinMaster___);
  if ( !Master_object
    || (klass = (System_Collections_ObjectModel_Collection_T__o *)Master_object[2].klass,
        v14 = (System_Collections_Generic_List_object__o *)sub_1B64C4C(System_Collections_Generic_List_DataEntityBase__TypeInfo),
        System_Collections_Generic_List_object____ctor(
          v14,
          (const MethodInfo_34AF794 *)Method_System_Collections_Generic_List_DataEntityBase___ctor__),
        !klass) )
  {
...
LABEL_38:
    ...
    {
      if ( !v14 )
        sub_1B64C5C(v25, UserSvtCoinEntity_TypeInfo);
...
bool __fastcall CoinRoomUtility__IsTargetQuestClear(const MethodInfo *method)
{
  ...
  if ( (byte_4A02048 & 1) == 0 )
  {
    sub_1B64A00(&Method_DataManager_GetMasterData_UserQuestMaster___, v1);
    sub_1B64A00(&NetworkManager_TypeInfo, v2);
    sub_1B64A00(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v3);
    sub_1B64A00(&StringLiteral_3608/*"COIN_ROOM_RELEASE_QUEST_ID"*/, v4);
    byte_4A02048 = 1;
  }
...
int32_t __fastcall CoinRoomUtility__MaxPoint(const MethodInfo *method)
{
  ...
  if ( (byte_4A02042 & 1) == 0 )
  {
    sub_1B64A00(&StringLiteral_3606/*"COIN_ROOM_MAX"*/, v1);
    byte_4A02042 = 1;
  }
...
int32_t __fastcall CoinRoomUtility__MonthExchangeMaxNum(const MethodInfo *method)
{
  ...
  if ( (byte_4A02043 & 1) == 0 )
  {
    sub_1B64A00(&StringLiteral_3607/*"COIN_ROOM_MAX_NUM"*/, v1);
    byte_4A02043 = 1;
  }
...
int64_t __fastcall CoinRoomUtility__NextMonthUnixTime(const MethodInfo *method)
{
  ...
  if ( (byte_4A0204A & 1) == 0 )
  {
    ...
    sub_1B64A00(&NetworkManager_TypeInfo, v3);
    sub_1B64A00(&System_TimeSpan_TypeInfo, v4);
    byte_4A0204A = 1;
  }
  v13 = 0LL;
  v14 = 0LL;
  ...
  v11 = 0LL;
  System_DateTime___ctor_62063008(v18, Year, Month, 1, 0LL);
