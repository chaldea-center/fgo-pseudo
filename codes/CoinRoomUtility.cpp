void __fastcall CoinRoomUtility___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A314B7 & 1) == 0 )
  {
    sub_1B761C0(&CoinRoomUtility_TypeInfo, v1);
    sub_1B761C0(&StringLiteral_4556/*"CoinRoom"*/, v4);
    byte_4A314B7 = 1;
  }
  CoinRoomUtility_TypeInfo->static_fields->ASSET_NAME = (struct System_String_o *)StringLiteral_4556/*"CoinRoom"*/;
  sub_1B76164((ServantStatusBattleListViewItem_o *)CoinRoomUtility_TypeInfo->static_fields, StringLiteral_4556/*"CoinRoom"*/, v2, v3);
  v6.fields._dateData = (uint64_t)&v5;
  CoinRoomUtility_TypeInfo->static_fields->EFFECT_FADE_TIME = 0.5;
  v5 = 0LL;
  System_DateTime___ctor_62213884(v6, 1970, 1, 1, 0, 0, 0, 1, 0LL);
...
int32_t __fastcall CoinRoomUtility__CalcPoint(const MethodInfo *method)
{
  ...
  if ( (byte_4A314AD & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_3624/*"COIN_ROOM_GET"*/, v1);
    byte_4A314AD = 1;
  }
  return ConstantMaster__getValue((System_String_o *)StringLiteral_3624/*"COIN_ROOM_GET"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A314B5 & 1) == 0 )
  {
    sub_1B761C0(&Method_AssetData_GetObjectList_GameObject___, name);
    ...
    sub_1B761C0(&Method_System_Collections_Generic_List_UIAtlas__Add__, v7);
    ...
    assetData = (AssetData_o *)sub_1B761C0(&UnityEngine_Object_TypeInfo, v10);
    byte_4A314B5 = 1;
  }
  if ( !v4
    || (assetData = (AssetData_o *)AssetData__GetObjectList_object_(
                                     v4,
                                     (const MethodInfo_2E44B34 *)Method_AssetData_GetObjectList_GameObject___)) == 0LL )
  {
LABEL_18:
    sub_1B7641C(assetData, name);
  }
  v11 = (int)assetData->fields.name;
  v12 = (System_Collections_Generic_List_object__o *)sub_1B7640C(System_Collections_Generic_List_UIAtlas__TypeInfo);
  ...
  if ( v11 >= 1 )
  {
    ...
    do
    {
      ...
      v15 = System_String__Concat_61535060(name, v14, 0LL);
...
UserCoinRoomEntity_o *__fastcall CoinRoomUtility__GetUserCoinRoomEntity(const MethodInfo *method)
{
  ...
  if ( (byte_4A314B0 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMasterData_UserCoinRoomMaster___, v1);
    sub_1B761C0(&Method_DataMasterBase_UserCoinRoomMaster__UserCoinRoomEntity__long__TryGetEntity__, v2);
  ...
  MasterData_object = DataManager__GetMasterData_object_(
                        Instance,
                        (const MethodInfo_2E62408 *)Method_DataManager_GetMasterData_UserCoinRoomMaster___);
...
LABEL_8:
  ...
  DataMasterBase_object__object__long___TryGetEntity(
    ...
    &entity,
    (int64_t)Instance,
    (const MethodInfo_30FF980 *)Method_DataMasterBase_UserCoinRoomMaster__UserCoinRoomEntity__long__TryGetEntity__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A314B1 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_DataManager_GetMaster_UserSvtCoinMaster___, v2);
    sub_1B761C0(&DataManager_TypeInfo, v3);
    sub_1B761C0(&System_IDisposable_TypeInfo, v4);
    sub_1B761C0(&System_Collections_Generic_IEnumerator_DataEntityBase__TypeInfo, v5);
    sub_1B761C0(&System_Collections_IEnumerator_TypeInfo, v6);
    sub_1B761C0(&Method_System_Collections_Generic_List_DataEntityBase__Add__, v7);
    sub_1B761C0(&Method_System_Collections_Generic_List_DataEntityBase___ctor__, v8);
    sub_1B761C0(&System_Collections_Generic_List_DataEntityBase__TypeInfo, v9);
  ...
  if ( !Master_object
    || (klass = (System_Collections_ObjectModel_Collection_T__o *)Master_object[2].klass,
        v14 = (System_Collections_Generic_List_object__o *)sub_1B7640C(System_Collections_Generic_List_DataEntityBase__TypeInfo),
        System_Collections_Generic_List_object____ctor(
          v14,
          (const MethodInfo_34D6DA0 *)Method_System_Collections_Generic_List_DataEntityBase___ctor__),
        !klass) )
  {
...
LABEL_38:
    ...
    {
      if ( !v14 )
        sub_1B7641C(v25, UserSvtCoinEntity_TypeInfo);
...
bool __fastcall CoinRoomUtility__IsTargetQuestClear(const MethodInfo *method)
{
  ...
  if ( (byte_4A314B4 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMasterData_UserQuestMaster___, v1);
    sub_1B761C0(&NetworkManager_TypeInfo, v2);
    sub_1B761C0(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v3);
    sub_1B761C0(&StringLiteral_3629/*"COIN_ROOM_RELEASE_QUEST_ID"*/, v4);
    byte_4A314B4 = 1;
  }
  Value = ConstantMaster__getValue((System_String_o *)StringLiteral_3629/*"COIN_ROOM_RELEASE_QUEST_ID"*/, 0LL);
  Instance = (DataManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_371257C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_8;
  MasterData_object = DataManager__GetMasterData_object_(
...
int32_t __fastcall CoinRoomUtility__MaxPoint(const MethodInfo *method)
{
  ...
  if ( (byte_4A314AE & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_3627/*"COIN_ROOM_MAX"*/, v1);
    byte_4A314AE = 1;
  }
  return ConstantMaster__getValue((System_String_o *)StringLiteral_3627/*"COIN_ROOM_MAX"*/, 0LL);
}
...
int32_t __fastcall CoinRoomUtility__MonthExchangeMaxNum(const MethodInfo *method)
{
  ...
  if ( (byte_4A314AF & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_3628/*"COIN_ROOM_MAX_NUM"*/, v1);
    byte_4A314AF = 1;
  }
  return ConstantMaster__getValue((System_String_o *)StringLiteral_3628/*"COIN_ROOM_MAX_NUM"*/, 0LL);
}
...
int64_t __fastcall CoinRoomUtility__NextMonthUnixTime(const MethodInfo *method)
{
  ...
  if ( (byte_4A314B6 & 1) == 0 )
  {
    ...
    sub_1B761C0(&NetworkManager_TypeInfo, v3);
    sub_1B761C0(&System_TimeSpan_TypeInfo, v4);
    byte_4A314B6 = 1;
  }
  v13 = 0LL;
  v14 = 0LL;
  ...
  v11 = 0LL;
  System_DateTime___ctor_62212940(v18, Year, Month, 1, 0LL);
