...
void __fastcall FGO_param3ObjectPoint__Start(FGO_param3ObjectPoint_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1E9BB & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_16534/*"_threeValue2"*/, v3);
    sub_1B715CC(&StringLiteral_16529/*"_threeValue0"*/, v4);
    sub_1B715CC(&StringLiteral_16530/*"_threeValue1"*/, v5);
    byte_4A1E9BB = 1;
  }
  ...
  if ( !renderer )
    goto LABEL_22;
  UnityEngine_Material__EnableKeyword((UnityEngine_Material_o *)renderer, (System_String_o *)StringLiteral_16529/*"_threeValue0"*/, 0LL);
  renderer = *p_renderer;
  if ( !*p_renderer )
    goto LABEL_22;
  renderer = (UnityEngine_Renderer_o *)UnityEngine_Renderer__get_sharedMaterial(renderer, 0LL);
  if ( !renderer )
    goto LABEL_22;
  UnityEngine_Material__EnableKeyword((UnityEngine_Material_o *)renderer, (System_String_o *)StringLiteral_16530/*"_threeValue1"*/, 0LL);
  renderer = *p_renderer;
  if ( !*p_renderer )
    goto LABEL_22;
  renderer = (UnityEngine_Renderer_o *)UnityEngine_Renderer__get_sharedMaterial(renderer, 0LL);
  if ( !renderer )
    goto LABEL_22;
  UnityEngine_Material__EnableKeyword((UnityEngine_Material_o *)renderer, (System_String_o *)StringLiteral_16534/*"_threeValue2"*/, 0LL);
  renderer = *p_renderer;
  if ( !*p_renderer )
    goto LABEL_22;
  renderer = (UnityEngine_Renderer_o *)UnityEngine_Renderer__get_sharedMaterial(renderer, 0LL);
  ...
  if ( !v12 )
    goto LABEL_22;
  UnityEngine_Material__SetFloat(v12, (System_String_o *)StringLiteral_16529/*"_threeValue0"*/, v13, 0LL);
  renderer = *p_renderer;
  if ( !*p_renderer )
    goto LABEL_22;
  renderer = (UnityEngine_Renderer_o *)UnityEngine_Renderer__get_sharedMaterial(renderer, 0LL);
  ...
  *(UnityEngine_Vector3_o *)(&v15 - 1) = UnityEngine_Transform__get_position((UnityEngine_Transform_o *)renderer, 0LL);
  if ( !v14
    || (UnityEngine_Material__SetFloat(v14, (System_String_o *)StringLiteral_16530/*"_threeValue1"*/, v15, 0LL),
...
LABEL_22:
  ...
  UnityEngine_Material__SetFloat(v17, (System_String_o *)StringLiteral_16534/*"_threeValue2"*/, v18, 0LL);
}
...
void __fastcall FGO_param3ObjectPoint__Update(FGO_param3ObjectPoint_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1E9BC & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_16534/*"_threeValue2"*/, method);
    sub_1B715CC(&StringLiteral_16529/*"_threeValue0"*/, v3);
    sub_1B715CC(&StringLiteral_16530/*"_threeValue1"*/, v4);
    byte_4A1E9BC = 1;
  }
  renderer = this->fields._renderer;
  if ( !renderer )
  ...
  if ( !v6 )
    goto LABEL_16;
  UnityEngine_Material__SetFloat(v6, (System_String_o *)StringLiteral_16529/*"_threeValue0"*/, v7, 0LL);
  renderer = this->fields._renderer;
  if ( !renderer )
    goto LABEL_16;
  renderer = (UnityEngine_Renderer_o *)UnityEngine_Renderer__get_sharedMaterial(renderer, 0LL);
  ...
  *(UnityEngine_Vector3_o *)(&v9 - 1) = UnityEngine_Transform__get_position((UnityEngine_Transform_o *)renderer, 0LL);
  if ( !v8
    || (UnityEngine_Material__SetFloat(v8, (System_String_o *)StringLiteral_16530/*"_threeValue1"*/, v9, 0LL),
...
LABEL_16:
  ...
  UnityEngine_Material__SetFloat(v11, (System_String_o *)StringLiteral_16534/*"_threeValue2"*/, v12, 0LL);
}