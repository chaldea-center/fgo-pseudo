...
void __fastcall FGO_param3ObjectPoint__Start(FGO_param3ObjectPoint_o *this, const MethodInfo *method)
{
  ...
  if ( !v20 )
    goto LABEL_22;
  UnityEngine_Material__SetFloat(v20, (System_String_o *)StringLiteral_16748/*"_threeValue0"*/, v21, 0LL);
  renderer = *p_renderer;
  if ( !*p_renderer )
    goto LABEL_22;
  renderer = (UnityEngine_Renderer_o *)UnityEngine_Renderer__get_sharedMaterial(renderer, 0LL);
  ...
  *(UnityEngine_Vector3_o *)(&v23 - 1) = UnityEngine_Transform__get_position((UnityEngine_Transform_o *)renderer, 0LL);
  if ( !v22
    || (UnityEngine_Material__SetFloat(v22, (System_String_o *)StringLiteral_16749/*"_threeValue1"*/, v23, 0LL),
...
LABEL_22:
  ...
  UnityEngine_Material__SetFloat(v25, (System_String_o *)StringLiteral_16753/*"_threeValue2"*/, v26, 0LL);
}
...
void __fastcall FGO_param3ObjectPoint__Update(FGO_param3ObjectPoint_o *this, const MethodInfo *method)
{
  ...
  if ( !v9 )
    goto LABEL_16;
  UnityEngine_Material__SetFloat(v9, (System_String_o *)StringLiteral_16748/*"_threeValue0"*/, v10, 0LL);
  renderer = this->fields._renderer;
  if ( !renderer )
    goto LABEL_16;
  renderer = (UnityEngine_Renderer_o *)UnityEngine_Renderer__get_sharedMaterial(renderer, 0LL);
  ...
  *(UnityEngine_Vector3_o *)(&v12 - 1) = UnityEngine_Transform__get_position((UnityEngine_Transform_o *)renderer, 0LL);
  if ( !v11
    || (UnityEngine_Material__SetFloat(v11, (System_String_o *)StringLiteral_16749/*"_threeValue1"*/, v12, 0LL),
...
LABEL_16:
  ...
  UnityEngine_Material__SetFloat(v14, (System_String_o *)StringLiteral_16753/*"_threeValue2"*/, v15, 0LL);
}