...
void FGO_param3ObjectPoint__Start(FGO_param3ObjectPoint_o *this, const MethodInfo *method)
{
  ...
  if ( !renderer )
    goto LABEL_22;
  UnityEngine_Material__EnableKeyword((UnityEngine_Material_o *)renderer, (System_String_o *)StringLiteral_16589/*"_threeValue0"*/, 0);
  renderer = *p_renderer;
  if ( !*p_renderer )
    goto LABEL_22;
  renderer = (UnityEngine_Renderer_o *)UnityEngine_Renderer__get_sharedMaterial(renderer, 0);
  if ( !renderer )
    goto LABEL_22;
  UnityEngine_Material__EnableKeyword((UnityEngine_Material_o *)renderer, (System_String_o *)StringLiteral_16590/*"_threeValue1"*/, 0);
  renderer = *p_renderer;
  if ( !*p_renderer )
    goto LABEL_22;
  renderer = (UnityEngine_Renderer_o *)UnityEngine_Renderer__get_sharedMaterial(renderer, 0);
  if ( !renderer )
    goto LABEL_22;
  UnityEngine_Material__EnableKeyword((UnityEngine_Material_o *)renderer, (System_String_o *)StringLiteral_16594/*"_threeValue2"*/, 0);
  renderer = *p_renderer;
  if ( !*p_renderer )
    goto LABEL_22;
  renderer = (UnityEngine_Renderer_o *)UnityEngine_Renderer__get_sharedMaterial(renderer, 0);
  ...
  if ( !v8 )
    goto LABEL_22;
  UnityEngine_Material__SetFloat(v8, (System_String_o *)StringLiteral_16589/*"_threeValue0"*/, v9, 0);
  renderer = *p_renderer;
  if ( !*p_renderer )
    goto LABEL_22;
  renderer = (UnityEngine_Renderer_o *)UnityEngine_Renderer__get_sharedMaterial(renderer, 0);
  ...
  if ( !v10
    || (UnityEngine_Material__SetFloat(v10, (System_String_o *)StringLiteral_16590/*"_threeValue1"*/, position.fields.y, 0),
...
LABEL_22:
  ...
  UnityEngine_Material__SetFloat(v12, (System_String_o *)StringLiteral_16594/*"_threeValue2"*/, v14.fields.z, 0);
}
...
void FGO_param3ObjectPoint__Update(FGO_param3ObjectPoint_o *this, const MethodInfo *method)
{
  ...
  if ( !v4 )
    goto LABEL_16;
  UnityEngine_Material__SetFloat(v4, (System_String_o *)StringLiteral_16589/*"_threeValue0"*/, v5, 0);
  renderer = this->fields._renderer;
  if ( !renderer )
    goto LABEL_16;
  renderer = (UnityEngine_Renderer_o *)UnityEngine_Renderer__get_sharedMaterial(renderer, 0);
  ...
  position = UnityEngine_Transform__get_position((UnityEngine_Transform_o *)renderer, 0);
  if ( !v6
    || (UnityEngine_Material__SetFloat(v6, (System_String_o *)StringLiteral_16590/*"_threeValue1"*/, position.fields.y, 0),
...
LABEL_16:
  ...
  UnityEngine_Material__SetFloat(v8, (System_String_o *)StringLiteral_16594/*"_threeValue2"*/, v10.fields.z, 0);
}