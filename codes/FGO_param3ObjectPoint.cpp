...
void FGO_param3ObjectPoint__Start(FGO_param3ObjectPoint_o *this, const MethodInfo *method)
{
  ...
  if ( !v13 )
    goto LABEL_22;
  UnityEngine_Material__SetFloat(v13, (System_String_o *)StringLiteral_17262/*"_threeValue0"*/, v17, 0);
  renderer = *p_renderer;
  if ( !*p_renderer )
    goto LABEL_22;
  renderer = (UnityEngine_Renderer_o *)UnityEngine_Renderer__get_sharedMaterial(renderer, 0);
  ...
  if ( !v14
    || (UnityEngine_Material__SetFloat(v14, (System_String_o *)StringLiteral_17263/*"_threeValue1"*/, y, 0), (renderer = *p_renderer) == 0)
    || (renderer = (UnityEngine_Renderer_o *)UnityEngine_Renderer__get_sharedMaterial(renderer, 0),
...
LABEL_22:
  ...
  UnityEngine_Material__SetFloat(v16, (System_String_o *)StringLiteral_17267/*"_threeValue2"*/, z, 0);
}
...
void FGO_param3ObjectPoint__Update(FGO_param3ObjectPoint_o *this, const MethodInfo *method)
{
  ...
  if ( !v4 )
    goto LABEL_16;
  UnityEngine_Material__SetFloat(v4, (System_String_o *)StringLiteral_17262/*"_threeValue0"*/, v8, 0);
  renderer = this->fields._renderer;
  if ( !renderer )
    goto LABEL_16;
  renderer = (UnityEngine_Renderer_o *)UnityEngine_Renderer__get_sharedMaterial(renderer, 0);
  ...
  y = UnityEngine_Transform__get_position((UnityEngine_Transform_o *)renderer, 0).fields.y;
  if ( !v5
    || (UnityEngine_Material__SetFloat(v5, (System_String_o *)StringLiteral_17263/*"_threeValue1"*/, y, 0),
...
LABEL_16:
  ...
  UnityEngine_Material__SetFloat(v7, (System_String_o *)StringLiteral_17267/*"_threeValue2"*/, z, 0);
}