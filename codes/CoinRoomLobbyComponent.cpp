        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9316 & 1) == 0 )
  {
    sub_1BAB41C(&CoinRoomUtility_TypeInfo, assetData);
    sub_1BAB41C(&Method_System_Linq_Enumerable_Any_UIAtlas___, v4);
    sub_1BAB41C(&StringLiteral_5371/*"DownloadCoinRoomAtlas"*/, v5);
    byte_4AB9316 = 1;
  }
  if ( assetData )
  {
...
void __fastcall CoinRoomLobbyComponent__OnClickBack(CoinRoomLobbyComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB9317 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_CoinRoomLobbyComponent_OnClickBack__, v3);
    sub_1BAB41C(&Method_CoinRoomLobbyComponent__OnClickBack_b__12_0__, v4);
    sub_1BAB41C(&SceneJumpInfo_TypeInfo, v5);
  ...
  if ( (*((_BYTE *)Method_CoinRoomLobbyComponent_OnClickBack__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1BAB434(Method_CoinRoomLobbyComponent_OnClickBack__);
  ...
  if ( !maskCollider
    || (UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)maskCollider, 0, 0LL),
        v13 = (SceneJumpInfo_o *)sub_1BAB668(SceneJumpInfo_TypeInfo),
        SceneJumpInfo___ctor(v13, 0LL),
        !v13)
    || (SceneJumpInfo__SetReturnNowScene(v13, 0LL),
        (maskCollider = (UnityEngine_Collider_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_378A22C *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__)) == 0LL) )
  {
LABEL_13:
    sub_1BAB678(maskCollider, v9);
  }
...
void __fastcall CoinRoomLobbyComponent__OnClickHelp(CoinRoomLobbyComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB9318 & 1) == 0 )
  {
    sub_1BAB41C(&Method_CoinRoomLobbyComponent_OnClickHelp__, method);
    byte_4AB9318 = 1;
  }
  v2 = Method_CoinRoomLobbyComponent_OnClickHelp__;
  if ( (*((_BYTE *)Method_CoinRoomLobbyComponent_OnClickHelp__ + 83) & 2) != 0 )
    v2 = (_QWORD *)sub_1BAB434(Method_CoinRoomLobbyComponent_OnClickHelp__);
...
void __fastcall CoinRoomLobbyComponent__OnClickSelectCoin(CoinRoomLobbyComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB931A & 1) == 0 )
  {
    sub_1BAB41C(&Method_CoinRoomLobbyComponent_OnClickSelectCoin__, method);
    byte_4AB931A = 1;
  }
  v3 = Method_CoinRoomLobbyComponent_OnClickSelectCoin__;
  if ( (*((_BYTE *)Method_CoinRoomLobbyComponent_OnClickSelectCoin__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1BAB434(Method_CoinRoomLobbyComponent_OnClickSelectCoin__);
  ...
  {
    sub_1BAB678(titleInfoControl, v5);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9315 & 1) == 0 )
  {
    sub_1BAB41C(&CoinRoomUtility_TypeInfo, myFSM);
    sub_1BAB41C(&Method_UnityEngine_GameObject_GetComponent_CoinRoomControlEffect___, v5);
    sub_1BAB41C(&Method_UnityEngine_GameObject_GetComponent_ParticleSystem___, v6);
    sub_1BAB41C(&Method_UnityEngine_GameObject_GetComponent_SimpleAnimation___, v7);
    sub_1BAB41C(&Method_UnityEngine_GameObject_GetComponent_UISlider___, v8);
    sub_1BAB41C(&int_TypeInfo, v9);
    sub_1BAB41C(&LocalizationManager_TypeInfo, v10);
    sub_1BAB41C(&StringLiteral_18953/*"effect_Circle_loop"*/, v11);
    sub_1BAB41C(&StringLiteral_3624/*"COIN_ROOM_LOBBY_INFO"*/, v12);
    sub_1BAB41C(&StringLiteral_3625/*"COIN_ROOM_LOBBY_TIME_INFO"*/, v13);
    byte_4AB9315 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       gaugeBarObject,
                       (const MethodInfo_2F13970 *)Method_UnityEngine_GameObject_GetComponent_UISlider___);
  ...
  v24 = LocalizationManager__Get((System_String_o *)StringLiteral_3624/*"COIN_ROOM_LOBBY_INFO"*/, 0LL);
  ...
  gaugeBarObject = (UnityEngine_GameObject_o *)System_String__Format_62062500(v24, v29, v33, 0LL);
  if ( !lobbyInfoLabel )
    goto LABEL_27;
  UILabel__set_text(lobbyInfoLabel, (System_String_o *)gaugeBarObject, 0LL);
  v34 = LocalizationManager__Get((System_String_o *)StringLiteral_3625/*"COIN_ROOM_LOBBY_TIME_INFO"*/, 0LL);
  ...
  gaugeBarObject = (UnityEngine_GameObject_o *)System_String__Format_62062500(v34, v43, v38, 0LL);
  if ( !lobbyTimeLabel )
    goto LABEL_27;
  ...
  if ( !gaugeBarObject )
    goto LABEL_27;
  TitleInfoControl__setBackBtnSprite_37565572((TitleInfoControl_o *)gaugeBarObject, 1, 0, 0, 0LL);
  gaugeBarObject = (UnityEngine_GameObject_o *)this->fields.titleInfoControl;
  if ( !gaugeBarObject )
    goto LABEL_27;
  ...
  if ( !gaugeBarObject
    || (gaugeBarObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                       gaugeBarObject,
                                                       (const MethodInfo_2F13970 *)Method_UnityEngine_GameObject_GetComponent_SimpleAnimation___)) == 0LL )
  {
LABEL_27:
    sub_1BAB678(gaugeBarObject, v14);
  }
  SimpleAnimation__Play_64185800((SimpleAnimation_o *)gaugeBarObject, (System_String_o *)StringLiteral_18953/*"effect_Circle_loop"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB931B & 1) == 0 )
  {
    sub_1BAB41C(&Method_System_Collections_Generic_List_Enumerator_UIAtlas__Dispose__, gameObject);
    ...
    this = (CoinRoomLobbyComponent_o *)sub_1BAB41C(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9319 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_25318/*"あと "*/, v4);
    byte_4AB9319 = 1;
  }
  ...
  if ( !RestTime5 )
    sub_1BAB678(0LL, v8);
  v9 = RestTime5;
  if ( System_String__Contains(RestTime5, (System_String_o *)StringLiteral_25318/*"あと "*/, 0LL) )
    return System_String__Replace_62067756(
             v9,
             (System_String_o *)StringLiteral_25318/*"あと "*/,
...
void __fastcall CoinRoomLobbyComponent___OnClickBack_b__12_0(CoinRoomLobbyComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BAB678(coinRoomSelectCoinComponent, method);
  }
