        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B20120 & 1) == 0 )
  {
    sub_1BCAFF8(&CoinRoomUtility_TypeInfo, assetData);
    sub_1BCAFF8(&Method_System_Linq_Enumerable_Any_UIAtlas___, v4);
    sub_1BCAFF8(&StringLiteral_5293/*"DownloadCoinRoomAtlas"*/, v5);
    byte_4B20120 = 1;
  }
  if ( assetData )
  {
    ...
    DownloadAtlas = CoinRoomUtility__GetDownloadAtlas(assetData, (System_String_o *)StringLiteral_5293/*"DownloadCoinRoomAtlas"*/, method);
...
void __fastcall CoinRoomLobbyComponent__OnClickBack(CoinRoomLobbyComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B20121 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_CoinRoomLobbyComponent_OnClickBack__, v3);
    sub_1BCAFF8(&Method_CoinRoomLobbyComponent__OnClickBack_b__12_0__, v4);
  ...
  if ( (*((_BYTE *)Method_CoinRoomLobbyComponent_OnClickBack__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1BCB010(Method_CoinRoomLobbyComponent_OnClickBack__);
  ...
  if ( !maskCollider
    ...
    || (SceneJumpInfo__SetReturnNowScene(v13, 0LL),
        (maskCollider = (UnityEngine_Collider_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38F8AD8 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__)) == 0LL) )
  {
LABEL_13:
    sub_1BCB254(maskCollider, v9);
  }
...
void __fastcall CoinRoomLobbyComponent__OnClickSelectCoin(CoinRoomLobbyComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B20124 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_CoinRoomLobbyComponent_OnClickSelectCoin__, method);
    byte_4B20124 = 1;
  }
  v3 = Method_CoinRoomLobbyComponent_OnClickSelectCoin__;
  if ( (*((_BYTE *)Method_CoinRoomLobbyComponent_OnClickSelectCoin__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1BCB010(Method_CoinRoomLobbyComponent_OnClickSelectCoin__);
  ...
  {
    sub_1BCB254(titleInfoControl, v5);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B2011F & 1) == 0 )
  {
    sub_1BCAFF8(&CoinRoomUtility_TypeInfo, myFSM);
    sub_1BCAFF8(&Method_UnityEngine_GameObject_GetComponent_CoinRoomControlEffect___, v5);
    sub_1BCAFF8(&Method_UnityEngine_GameObject_GetComponent_ParticleSystem___, v6);
    sub_1BCAFF8(&Method_UnityEngine_GameObject_GetComponent_SimpleAnimation___, v7);
    sub_1BCAFF8(&Method_UnityEngine_GameObject_GetComponent_UISlider___, v8);
    sub_1BCAFF8(&int_TypeInfo, v9);
    sub_1BCAFF8(&LocalizationManager_TypeInfo, v10);
    sub_1BCAFF8(&StringLiteral_18768/*"effect_Circle_loop"*/, v11);
    sub_1BCAFF8(&StringLiteral_3511/*"COIN_ROOM_LOBBY_INFO"*/, v12);
    sub_1BCAFF8(&StringLiteral_3512/*"COIN_ROOM_LOBBY_TIME_INFO"*/, v13);
    byte_4B2011F = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       gaugeBarObject,
                       (const MethodInfo_306E710 *)Method_UnityEngine_GameObject_GetComponent_UISlider___);
  ...
  v24 = LocalizationManager__Get((System_String_o *)StringLiteral_3511/*"COIN_ROOM_LOBBY_INFO"*/, 0LL);
  ...
  gaugeBarObject = (UnityEngine_GameObject_o *)System_String__Format_62491716(v24, v29, v33, 0LL);
  if ( !lobbyInfoLabel )
    goto LABEL_27;
  UILabel__set_text(lobbyInfoLabel, (System_String_o *)gaugeBarObject, 0LL);
  v34 = LocalizationManager__Get((System_String_o *)StringLiteral_3512/*"COIN_ROOM_LOBBY_TIME_INFO"*/, 0LL);
  ...
  gaugeBarObject = (UnityEngine_GameObject_o *)System_String__Format_62491716(v34, v43, v38, 0LL);
  if ( !lobbyTimeLabel )
    goto LABEL_27;
  ...
  if ( !gaugeBarObject )
    goto LABEL_27;
  TitleInfoControl__setTitleInfo((TitleInfoControl_o *)gaugeBarObject, myFSM, 1, 0LL, 88, 0LL);
  gaugeBarObject = (UnityEngine_GameObject_o *)this->fields.titleInfoControl;
  if ( !gaugeBarObject )
    goto LABEL_27;
  TitleInfoControl__setBackBtnSprite_39034208((TitleInfoControl_o *)gaugeBarObject, 1, 0, 0, 0LL);
  gaugeBarObject = (UnityEngine_GameObject_o *)this->fields.titleInfoControl;
  if ( !gaugeBarObject )
    goto LABEL_27;
  TitleInfoControl__setTitleImgFromBanner((TitleInfoControl_o *)gaugeBarObject, 0, 0, 1, 88, 0LL);
  gaugeBarObject = (UnityEngine_GameObject_o *)this->fields.titleInfoControl;
  if ( !gaugeBarObject )
    goto LABEL_27;
  ...
  if ( !gaugeBarObject
    || (gaugeBarObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                       gaugeBarObject,
                                                       (const MethodInfo_306E710 *)Method_UnityEngine_GameObject_GetComponent_SimpleAnimation___)) == 0LL )
  {
LABEL_27:
    sub_1BCB254(gaugeBarObject, v14);
  }
  SimpleAnimation__Play_65395744((SimpleAnimation_o *)gaugeBarObject, (System_String_o *)StringLiteral_18768/*"effect_Circle_loop"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B20125 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_System_Collections_Generic_List_Enumerator_UIAtlas__Dispose__, gameObject);
    ...
    this = (CoinRoomLobbyComponent_o *)sub_1BCAFF8(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B20123 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_25163/*"あと "*/, v4);
    byte_4B20123 = 1;
  }
  ...
  if ( !RestTime5 )
    sub_1BCB254(0LL, v8);
  v9 = RestTime5;
  if ( System_String__Contains(RestTime5, (System_String_o *)StringLiteral_25163/*"あと "*/, 0LL) )
    return System_String__Replace_62496972(
             v9,
             (System_String_o *)StringLiteral_25163/*"あと "*/,
...
void __fastcall CoinRoomLobbyComponent___OnClickBack_b__12_0(CoinRoomLobbyComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BCB254(coinRoomSelectCoinComponent, method);
  }
