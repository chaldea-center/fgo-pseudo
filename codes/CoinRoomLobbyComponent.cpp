        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2AF28 & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_5328/*"DownloadCoinRoomAtlas"*/);
    byte_4C2AF28 = 1;
  }
  if ( assetData )
  {
    ...
    DownloadAtlas = CoinRoomUtility__GetDownloadAtlas(assetData, (System_String_o *)StringLiteral_5328/*"DownloadCoinRoomAtlas"*/, method);
...
void CoinRoomLobbyComponent__OnClickBack(CoinRoomLobbyComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2AF29 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_CoinRoomLobbyComponent_OnClickBack__);
    sub_1C2D490(&Method_CoinRoomLobbyComponent__OnClickBack_b__12_0__);
  ...
  if ( (*((_BYTE *)Method_CoinRoomLobbyComponent_OnClickBack__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C2D4A8(Method_CoinRoomLobbyComponent_OnClickBack__);
  ...
  if ( !maskCollider
    || (UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)maskCollider, 0, 0),
        v9 = (SceneJumpInfo_o *)sub_1C2D6DC(SceneJumpInfo_TypeInfo),
        SceneJumpInfo___ctor(v9, 0),
        !v9)
    || (SceneJumpInfo__SetReturnNowScene(v9, 0),
        (maskCollider = (UnityEngine_Collider_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39D3CCC *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__)) == 0) )
  {
LABEL_13:
    sub_1C2D6EC(maskCollider, v5);
  }
...
void CoinRoomLobbyComponent__OnClickHelp(CoinRoomLobbyComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2AF2A & 1) == 0 )
  {
    sub_1C2D490(&Method_CoinRoomLobbyComponent_OnClickHelp__);
    byte_4C2AF2A = 1;
  }
  v2 = Method_CoinRoomLobbyComponent_OnClickHelp__;
  if ( (*((_BYTE *)Method_CoinRoomLobbyComponent_OnClickHelp__ + 83) & 2) != 0 )
    v2 = (_QWORD *)sub_1C2D4A8(Method_CoinRoomLobbyComponent_OnClickHelp__);
...
void CoinRoomLobbyComponent__OnClickSelectCoin(CoinRoomLobbyComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2AF2C & 1) == 0 )
  {
    sub_1C2D490(&Method_CoinRoomLobbyComponent_OnClickSelectCoin__);
    byte_4C2AF2C = 1;
  }
  v3 = Method_CoinRoomLobbyComponent_OnClickSelectCoin__;
  if ( (*((_BYTE *)Method_CoinRoomLobbyComponent_OnClickSelectCoin__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C2D4A8(Method_CoinRoomLobbyComponent_OnClickSelectCoin__);
  v4 = (System_Reflection_MethodBase_o *)sub_1C2D474(v3, v3[4]);
  ...
  {
    sub_1C2D6EC(titleInfoControl, v5);
  }
...
void CoinRoomLobbyComponent__OpenLobby(CoinRoomLobbyComponent_o *this, PlayMakerFSM_o *myFSM, const MethodInfo *method)
{
  ...
  CoinRoomLobbyComponent_o *v27; // x0
  int v28; // w21
  ...
  UnityEngine_ParticleSystem_MinMaxCurve_o v39; // [xsp+30h] [xbp-70h] BYREF
  ...
  if ( (byte_4C2AF27 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_UnityEngine_GameObject_GetComponent_UISlider___);
    sub_1C2D490(&int_TypeInfo);
    sub_1C2D490(&LocalizationManager_TypeInfo);
    sub_1C2D490(&StringLiteral_18921/*"effect_Circle_loop"*/);
    sub_1C2D490(&StringLiteral_3539/*"COIN_ROOM_LOBBY_INFO"*/);
    sub_1C2D490(&StringLiteral_3540/*"COIN_ROOM_LOBBY_TIME_INFO"*/);
    byte_4C2AF27 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       gaugeBarObject,
                       (const MethodInfo_3125ED0 *)Method_UnityEngine_GameObject_GetComponent_UISlider___);
  ...
  UnityEngine_ParticleSystem_MinMaxCurve__op_Implicit(&v39, v14, 0);
  v15.fields.m_ParticleSystem = (struct UnityEngine_ParticleSystem_o *)&m_ParticleSystem;
  v38 = v39;
  UnityEngine_ParticleSystem_MainModule__set_startSize(v15, &v38, 0);
  gaugeBarObject = this->fields.energyPartLoopObject;
  if ( !gaugeBarObject )
    goto LABEL_27;
  ...
  v16 = LocalizationManager__Get((System_String_o *)StringLiteral_3539/*"COIN_ROOM_LOBBY_INFO"*/, 0);
  lobbyInfoLabel = this->fields.lobbyInfoLabel;
  v39.fields.m_Mode = v10;
  v21 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v39, v18, v19, v20);
  v37 = v12;
  v25 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v37, v22, v23, v24);
  gaugeBarObject = (UnityEngine_GameObject_o *)System_String__Format_63499156(v16, v21, v25, 0);
  if ( !lobbyInfoLabel )
    goto LABEL_27;
  UILabel__set_text(lobbyInfoLabel, (System_String_o *)gaugeBarObject, 0);
  v26 = LocalizationManager__Get((System_String_o *)StringLiteral_3540/*"COIN_ROOM_LOBBY_TIME_INFO"*/, 0);
  v27 = (CoinRoomLobbyComponent_o *)CoinRoomUtility__MonthRemainingNum((const MethodInfo *)v26);
  v28 = (int)v27;
  v30 = (Il2CppObject *)CoinRoomLobbyComponent__SetTimeLabel(v27, v29);
  lobbyTimeLabel = this->fields.lobbyTimeLabel;
  v36 = v28;
  v35 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v36, v32, v33, v34);
  gaugeBarObject = (UnityEngine_GameObject_o *)System_String__Format_63499156(v26, v35, v30, 0);
  if ( !lobbyTimeLabel )
    goto LABEL_27;
  ...
  if ( !gaugeBarObject )
    goto LABEL_27;
  TitleInfoControl__setBackBtnSprite_39620988((TitleInfoControl_o *)gaugeBarObject, 1, 0, 0, 0);
  gaugeBarObject = (UnityEngine_GameObject_o *)this->fields.titleInfoControl;
  if ( !gaugeBarObject )
    goto LABEL_27;
  ...
  if ( !gaugeBarObject
    || (gaugeBarObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                       gaugeBarObject,
                                                       (const MethodInfo_3125ED0 *)Method_UnityEngine_GameObject_GetComponent_SimpleAnimation___)) == 0 )
  {
LABEL_27:
    sub_1C2D6EC(gaugeBarObject, v5);
  }
  SimpleAnimation__Play_66404364((SimpleAnimation_o *)gaugeBarObject, (System_String_o *)StringLiteral_18921/*"effect_Circle_loop"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2AF2D & 1) == 0 )
  {
    ...
    this = (CoinRoomLobbyComponent_o *)sub_1C2D490(&Method_System_Collections_Generic_List_UIAtlas__GetEnumerator__);
    byte_4C2AF2D = 1;
  }
...
System_String_o *CoinRoomLobbyComponent__SetTimeLabel(CoinRoomLobbyComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2AF2B & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_25361/*"あと "*/);
    byte_4C2AF2B = 1;
  }
  ...
  if ( !RestTime5 )
    sub_1C2D6EC(0, v5);
  v6 = RestTime5;
  if ( System_String__Contains(RestTime5, (System_String_o *)StringLiteral_25361/*"あと "*/, 0) )
    return System_String__Replace_63504412(
             v6,
             (System_String_o *)StringLiteral_25361/*"あと "*/,
...
void CoinRoomLobbyComponent___OnClickBack_b__12_0(CoinRoomLobbyComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C2D6EC(coinRoomSelectCoinComponent, method);
  }
