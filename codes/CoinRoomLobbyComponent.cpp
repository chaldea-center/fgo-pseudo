        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7B57B & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_5384/*"DownloadCoinRoomAtlas"*/);
    byte_4E7B57B = 1;
  }
  if ( assetData )
  {
    ...
    DownloadAtlas = CoinRoomUtility__GetDownloadAtlas(assetData, (System_String_o *)StringLiteral_5384/*"DownloadCoinRoomAtlas"*/, method);
...
void CoinRoomLobbyComponent__OnClickBack(CoinRoomLobbyComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E7B57C & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_CoinRoomLobbyComponent_OnClickBack__);
    sub_1D0F0B4(&Method_CoinRoomLobbyComponent__OnClickBack_b__12_0__);
  ...
  if ( (*((_BYTE *)Method_CoinRoomLobbyComponent_OnClickBack__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1D0F0CC(Method_CoinRoomLobbyComponent_OnClickBack__);
  ...
  if ( !maskCollider
    || (UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)maskCollider, 0, 0),
        v9 = (SceneJumpInfo_o *)sub_1D0F300(SceneJumpInfo_TypeInfo),
        SceneJumpInfo___ctor(v9, 0),
        !v9)
    || (SceneJumpInfo__SetReturnNowScene(v9, 0),
        (maskCollider = (UnityEngine_Collider_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3BAC684 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__)) == 0) )
  {
LABEL_13:
    sub_1D0F30C(maskCollider, v5);
  }
...
void CoinRoomLobbyComponent__OnClickHelp(CoinRoomLobbyComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E7B57D & 1) == 0 )
  {
    sub_1D0F0B4(&Method_CoinRoomLobbyComponent_OnClickHelp__);
    byte_4E7B57D = 1;
  }
  v2 = Method_CoinRoomLobbyComponent_OnClickHelp__;
  if ( (*((_BYTE *)Method_CoinRoomLobbyComponent_OnClickHelp__ + 83) & 2) != 0 )
    v2 = (_QWORD *)sub_1D0F0CC(Method_CoinRoomLobbyComponent_OnClickHelp__);
...
void CoinRoomLobbyComponent__OnClickSelectCoin(CoinRoomLobbyComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E7B57F & 1) == 0 )
  {
    sub_1D0F0B4(&Method_CoinRoomLobbyComponent_OnClickSelectCoin__);
    byte_4E7B57F = 1;
  }
  v3 = Method_CoinRoomLobbyComponent_OnClickSelectCoin__;
  if ( (*((_BYTE *)Method_CoinRoomLobbyComponent_OnClickSelectCoin__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1D0F0CC(Method_CoinRoomLobbyComponent_OnClickSelectCoin__);
  v4 = (System_Reflection_MethodBase_o *)sub_1D0F098(v3, v3[4]);
  ...
  {
    sub_1D0F30C(titleInfoControl, v5);
  }
...
void CoinRoomLobbyComponent__OpenLobby(CoinRoomLobbyComponent_o *this, PlayMakerFSM_o *myFSM, const MethodInfo *method)
{
  ...
  if ( (byte_4E7B57A & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_UnityEngine_GameObject_GetComponent_UISlider___);
    sub_1D0F0B4(&int_TypeInfo);
    sub_1D0F0B4(&LocalizationManager_TypeInfo);
    sub_1D0F0B4(&StringLiteral_19250/*"effect_Circle_loop"*/);
    sub_1D0F0B4(&StringLiteral_3584/*"COIN_ROOM_LOBBY_INFO"*/);
    sub_1D0F0B4(&StringLiteral_3585/*"COIN_ROOM_LOBBY_TIME_INFO"*/);
    byte_4E7B57A = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       gaugeBarObject,
                       (const MethodInfo_32A8444 *)Method_UnityEngine_GameObject_GetComponent_UISlider___);
  ...
  v16 = LocalizationManager__Get((System_String_o *)StringLiteral_3584/*"COIN_ROOM_LOBBY_INFO"*/, 0);
  ...
  gaugeBarObject = (UnityEngine_GameObject_o *)System_String__Format_65604080(v16, v18, v19, 0);
  if ( !lobbyInfoLabel )
    goto LABEL_27;
  UILabel__set_text(lobbyInfoLabel, (System_String_o *)gaugeBarObject, 0);
  v20 = LocalizationManager__Get((System_String_o *)StringLiteral_3585/*"COIN_ROOM_LOBBY_TIME_INFO"*/, 0);
  ...
  gaugeBarObject = (UnityEngine_GameObject_o *)System_String__Format_65604080(v20, v26, v24, 0);
  if ( !lobbyTimeLabel )
    goto LABEL_27;
  ...
  if ( !gaugeBarObject )
    goto LABEL_27;
  TitleInfoControl__setBackBtnSprite_41257740((TitleInfoControl_o *)gaugeBarObject, 1, 0, 0, 0);
  gaugeBarObject = (UnityEngine_GameObject_o *)this->fields.titleInfoControl;
  if ( !gaugeBarObject )
    goto LABEL_27;
  ...
  if ( !gaugeBarObject
    || (gaugeBarObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                       gaugeBarObject,
                                                       (const MethodInfo_32A8444 *)Method_UnityEngine_GameObject_GetComponent_SimpleAnimation___)) == 0 )
  {
LABEL_27:
    sub_1D0F30C(gaugeBarObject, v5);
  }
  SimpleAnimation__Play_68509268((SimpleAnimation_o *)gaugeBarObject, (System_String_o *)StringLiteral_19250/*"effect_Circle_loop"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7B580 & 1) == 0 )
  {
    ...
    this = (CoinRoomLobbyComponent_o *)sub_1D0F0B4(&Method_System_Collections_Generic_List_UIAtlas__GetEnumerator__);
    byte_4E7B580 = 1;
  }
...
System_String_o *CoinRoomLobbyComponent__SetTimeLabel(CoinRoomLobbyComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E7B57E & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_25907/*"あと "*/);
    byte_4E7B57E = 1;
  }
  ...
  if ( !RestTime5 )
    sub_1D0F30C(0, v5);
  v6 = RestTime5;
  if ( System_String__Contains(RestTime5, (System_String_o *)StringLiteral_25907/*"あと "*/, 0) )
    return System_String__Replace_65609336(
             v6,
             (System_String_o *)StringLiteral_25907/*"あと "*/,
...
void CoinRoomLobbyComponent___OnClickBack_b__12_0(CoinRoomLobbyComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1D0F30C(coinRoomSelectCoinComponent, method);
  }
