        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5E6DA & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_5370/*"DownloadCoinRoomAtlas"*/);
    byte_4A5E6DA = 1;
  }
  if ( assetData )
  {
    ...
    DownloadAtlas = CoinRoomUtility__GetDownloadAtlas(assetData, (System_String_o *)StringLiteral_5370/*"DownloadCoinRoomAtlas"*/, method);
...
void __fastcall CoinRoomLobbyComponent__OnClickBack(CoinRoomLobbyComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5E6DB & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_CoinRoomLobbyComponent_OnClickBack__);
    sub_1B885B0(&Method_CoinRoomLobbyComponent__OnClickBack_b__12_0__);
  ...
  if ( (*((_BYTE *)Method_CoinRoomLobbyComponent_OnClickBack__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B885C8(Method_CoinRoomLobbyComponent_OnClickBack__);
  ...
  if ( !maskCollider
    || (UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)maskCollider, 0, 0LL),
        v9 = (SceneJumpInfo_o *)sub_1B887FC(SceneJumpInfo_TypeInfo),
        SceneJumpInfo___ctor(v9, 0LL),
        !v9)
    || (SceneJumpInfo__SetReturnNowScene(v9, 0LL),
        (maskCollider = (UnityEngine_Collider_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__)) == 0LL) )
  {
LABEL_13:
    sub_1B8880C(maskCollider, v5);
  }
...
void __fastcall CoinRoomLobbyComponent__OnClickHelp(CoinRoomLobbyComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5E6DC & 1) == 0 )
  {
    sub_1B885B0(&Method_CoinRoomLobbyComponent_OnClickHelp__);
    byte_4A5E6DC = 1;
  }
  v2 = Method_CoinRoomLobbyComponent_OnClickHelp__;
  if ( (*((_BYTE *)Method_CoinRoomLobbyComponent_OnClickHelp__ + 83) & 2) != 0 )
    v2 = (_QWORD *)sub_1B885C8(Method_CoinRoomLobbyComponent_OnClickHelp__);
...
void __fastcall CoinRoomLobbyComponent__OnClickSelectCoin(CoinRoomLobbyComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5E6DE & 1) == 0 )
  {
    sub_1B885B0(&Method_CoinRoomLobbyComponent_OnClickSelectCoin__);
    byte_4A5E6DE = 1;
  }
  v3 = Method_CoinRoomLobbyComponent_OnClickSelectCoin__;
  if ( (*((_BYTE *)Method_CoinRoomLobbyComponent_OnClickSelectCoin__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B885C8(Method_CoinRoomLobbyComponent_OnClickSelectCoin__);
  v4 = (System_Reflection_MethodBase_o *)sub_1B88594(v3, v3[4]);
  ...
  {
    sub_1B8880C(titleInfoControl, v5);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5E6D9 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_UnityEngine_GameObject_GetComponent_UISlider___);
    sub_1B885B0(&int_TypeInfo);
    sub_1B885B0(&LocalizationManager_TypeInfo);
    sub_1B885B0(&StringLiteral_18924/*"effect_Circle_loop"*/);
    sub_1B885B0(&StringLiteral_3626/*"COIN_ROOM_LOBBY_INFO"*/);
    sub_1B885B0(&StringLiteral_3627/*"COIN_ROOM_LOBBY_TIME_INFO"*/);
    byte_4A5E6D9 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       gaugeBarObject,
                       (const MethodInfo_2ECEEB8 *)Method_UnityEngine_GameObject_GetComponent_UISlider___);
  ...
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_3626/*"COIN_ROOM_LOBBY_INFO"*/, 0LL);
  ...
  gaugeBarObject = (UnityEngine_GameObject_o *)System_String__Format_61721404(v15, v20, v24, 0LL);
  if ( !lobbyInfoLabel )
    goto LABEL_27;
  UILabel__set_text(lobbyInfoLabel, (System_String_o *)gaugeBarObject, 0LL);
  v25 = LocalizationManager__Get((System_String_o *)StringLiteral_3627/*"COIN_ROOM_LOBBY_TIME_INFO"*/, 0LL);
  ...
  gaugeBarObject = (UnityEngine_GameObject_o *)System_String__Format_61721404(v25, v34, v29, 0LL);
  if ( !lobbyTimeLabel )
    goto LABEL_27;
  ...
  if ( !gaugeBarObject )
    goto LABEL_27;
  TitleInfoControl__setBackBtnSprite_37184884((TitleInfoControl_o *)gaugeBarObject, 1, 0, 0, 0LL);
  gaugeBarObject = (UnityEngine_GameObject_o *)this->fields.titleInfoControl;
  if ( !gaugeBarObject )
    goto LABEL_27;
  ...
  if ( !gaugeBarObject
    || (gaugeBarObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                       gaugeBarObject,
                                                       (const MethodInfo_2ECEEB8 *)Method_UnityEngine_GameObject_GetComponent_SimpleAnimation___)) == 0LL )
  {
LABEL_27:
    sub_1B8880C(gaugeBarObject, v5);
  }
  SimpleAnimation__Play_63844704((SimpleAnimation_o *)gaugeBarObject, (System_String_o *)StringLiteral_18924/*"effect_Circle_loop"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5E6DF & 1) == 0 )
  {
    ...
    this = (CoinRoomLobbyComponent_o *)sub_1B885B0(&Method_System_Collections_Generic_List_UIAtlas__GetEnumerator__);
    byte_4A5E6DF = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5E6DD & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_25275/*"あと "*/);
    byte_4A5E6DD = 1;
  }
  ...
  if ( !RestTime5 )
    sub_1B8880C(0LL, v5);
  v6 = RestTime5;
  if ( System_String__Contains(RestTime5, (System_String_o *)StringLiteral_25275/*"あと "*/, 0LL) )
    return System_String__Replace_61726660(
             v6,
             (System_String_o *)StringLiteral_25275/*"あと "*/,
...
void __fastcall CoinRoomLobbyComponent___OnClickBack_b__12_0(CoinRoomLobbyComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B8880C(coinRoomSelectCoinComponent, method);
  }
