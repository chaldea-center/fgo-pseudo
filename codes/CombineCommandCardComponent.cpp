        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05CA9 & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_14999/*"Unlit/Transparent Colored"*/, data);
    byte_4B05CA9 = 1;
  }
  ...
  BattleCommandComponent__setShader((BattleCommandComponent_o *)this, (System_String_o *)StringLiteral_14999/*"Unlit/Transparent Colored"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BC3264(objectRoot, isEnable);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05CAE & 1) == 0 )
  {
    sub_1BC3008(&BalanceConfig_TypeInfo, *(_QWORD *)&commandCardParam);
    sub_1BC3008(&LocalizationManager_TypeInfo, v7);
    sub_1BC3008(&UnityEngine_Object_TypeInfo, v8);
    sub_1BC3008(&StringLiteral_8709/*"MSG_ABLED_COMMAND_CARD_EXCEED"*/, v9);
    byte_4B05CAE = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(exceedableLabel, 0LL, 0LL) )
  {
    ...
    gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_8709/*"MSG_ABLED_COMMAND_CARD_EXCEED"*/, 0LL);
    if ( !v11 )
      goto LABEL_14;
        ...
        const MethodInfo *method)
{
  ...
  GameObjectExtensions__SetLocalScale_35213928(v8, scale, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05CAD & 1) == 0 )
  {
    ...
    sub_1BC3008(&LocalizationManager_TypeInfo, v7);
    sub_1BC3008(&UnityEngine_Object_TypeInfo, v8);
    sub_1BC3008(&StringLiteral_3604/*"COMMAND_CARD_EXCEED_STATUS_COMBINE"*/, v9);
    byte_4B05CAD = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(powerUpCardValue, 0LL, 0LL) )
  {
    ...
    if ( isShowValue )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v14 = LocalizationManager__Get((System_String_o *)StringLiteral_3604/*"COMMAND_CARD_EXCEED_STATUS_COMBINE"*/, 0LL);
      ...
      gameObject = (UnityEngine_Component_o *)System_String__Format_62389940(v14, NumberFormat, v17, 0LL);
      if ( v13 )
      {
