        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C010CA & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_15404/*"Unlit/Transparent Colored"*/, data);
    byte_4C010CA = 1;
  }
  ...
  BattleCommandComponent__setShader((BattleCommandComponent_o *)this, (System_String_o *)StringLiteral_15404/*"Unlit/Transparent Colored"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C2E388(objectRoot, isEnable);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C010CF & 1) == 0 )
  {
    sub_1C2E12C(&BalanceConfig_TypeInfo, *(_QWORD *)&commandCardParam);
    sub_1C2E12C(&LocalizationManager_TypeInfo, v7);
    sub_1C2E12C(&UnityEngine_Object_TypeInfo, v8);
    sub_1C2E12C(&StringLiteral_8932/*"MSG_ABLED_COMMAND_CARD_EXCEED"*/, v9);
    byte_4C010CF = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  GameObjectExtensions__SetLocalScale_34859908(v8, scale, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C010CE & 1) == 0 )
  {
    ...
    sub_1C2E12C(&LocalizationManager_TypeInfo, v7);
    sub_1C2E12C(&UnityEngine_Object_TypeInfo, v8);
    sub_1C2E12C(&StringLiteral_3757/*"COMMAND_CARD_EXCEED_STATUS_COMBINE"*/, v9);
    byte_4C010CE = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(powerUpCardValue, 0LL, 0LL) )
  {
    ...
    if ( isShowValue )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v14 = LocalizationManager__Get((System_String_o *)StringLiteral_3757/*"COMMAND_CARD_EXCEED_STATUS_COMBINE"*/, 0LL);
      ...
      gameObject = (UnityEngine_Component_o *)System_String__Format_63249956(v14, NumberFormat, v17, 0LL);
      if ( v13 )
      {
