        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A453 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_15333/*"Unlit/Transparent Colored"*/, data);
    byte_4B6A453 = 1;
  }
  ...
  BattleCommandComponent__setShader((BattleCommandComponent_o *)this, (System_String_o *)StringLiteral_15333/*"Unlit/Transparent Colored"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BE4D28(objectRoot, isEnable);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A458 & 1) == 0 )
  {
    sub_1BE4ACC(&BalanceConfig_TypeInfo, *(_QWORD *)&commandCardParam);
    sub_1BE4ACC(&LocalizationManager_TypeInfo, v7);
    sub_1BE4ACC(&UnityEngine_Object_TypeInfo, v8);
    sub_1BE4ACC(&StringLiteral_8898/*"MSG_ABLED_COMMAND_CARD_EXCEED"*/, v9);
    byte_4B6A458 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(exceedableLabel, 0LL, 0LL) )
  {
    ...
    gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_8898/*"MSG_ABLED_COMMAND_CARD_EXCEED"*/, 0LL);
    if ( !v11 )
      goto LABEL_14;
        ...
        const MethodInfo *method)
{
  ...
  GameObjectExtensions__SetLocalScale_34488912(v8, scale, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A457 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&LocalizationManager_TypeInfo, v7);
    sub_1BE4ACC(&UnityEngine_Object_TypeInfo, v8);
    sub_1BE4ACC(&StringLiteral_3754/*"COMMAND_CARD_EXCEED_STATUS_COMBINE"*/, v9);
    byte_4B6A457 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(powerUpCardValue, 0LL, 0LL) )
  {
    ...
    if ( isShowValue )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v14 = LocalizationManager__Get((System_String_o *)StringLiteral_3754/*"COMMAND_CARD_EXCEED_STATUS_COMBINE"*/, 0LL);
      ...
      gameObject = (UnityEngine_Component_o *)System_String__Format_62713180(v14, NumberFormat, v17, 0LL);
      if ( v13 )
      {
