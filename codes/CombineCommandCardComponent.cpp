        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B199D4 & 1) == 0 )
  {
    sub_1BCA7E0(&StringLiteral_15295/*"Unlit/Transparent Colored"*/, data, userCommandCodeId);
    byte_4B199D4 = 1;
  }
  ...
  BattleCommandComponent__setShader((BattleCommandComponent_o *)this, (System_String_o *)StringLiteral_15295/*"Unlit/Transparent Colored"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  v17.fields.b = b;
  v17.fields.a = a;
  BattleCommandComponent__SetCardColor((BattleCommandComponent_o *)this, v17, 0LL);
  ...
  if ( !UnityEngine_Object__op_Equality(lockInfoObj, 0LL, 0LL) )
  {
    ...
    if ( icon )
    {
      ...
      if ( Component_object )
      {
        ...
        v18.fields.b = b;
        v18.fields.a = a;
        UIWidget__set_color((UIWidget_o *)Component_object, v18, 0LL);
        ...
        if ( icon )
        {
          ...
          v19.fields.b = b;
          v19.fields.a = a;
          UIWidget__set_color((UIWidget_o *)icon, v19, 0LL);
          ...
          if ( icon )
          {
            ...
            v20.fields.b = b;
            v20.fields.a = a;
            UIWidget__set_color((UIWidget_o *)icon, v20, 0LL);
            ...
            if ( icon )
            {
              ...
              v21.fields.r = r;
              v21.fields.g = g;
              UIWidget__set_color((UIWidget_o *)icon, v21, 0LL);
              return;
            }
          }
        }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BCAA3C(objectRoot, isEnable);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B199D9 & 1) == 0 )
  {
    sub_1BCA7E0(&BalanceConfig_TypeInfo, *(_QWORD *)&commandCardParam, isShowExceedable);
    sub_1BCA7E0(&LocalizationManager_TypeInfo, v7, v8);
    sub_1BCA7E0(&UnityEngine_Object_TypeInfo, v9, v10);
    sub_1BCA7E0(&StringLiteral_8878/*"MSG_ABLED_COMMAND_CARD_EXCEED"*/, v11, v12);
    byte_4B199D9 = 1;
  }
  ...
  {
    v15 = this->fields.exceedableLabel;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, v14);
    gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_8878/*"MSG_ABLED_COMMAND_CARD_EXCEED"*/, 0LL);
    if ( !v15 )
      goto LABEL_14;
    UILabel__set_text(v15, gameObject, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  GameObjectExtensions__SetLocalScale_34333164(v8, scale, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B199D6 & 1) == 0 )
  {
    sub_1BCA7E0(&UnityEngine_Object_TypeInfo, target, isActive);
    byte_4B199D6 = 1;
  }
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B199D8 & 1) == 0 )
  {
    sub_1BCA7E0(&BalanceConfig_TypeInfo, *(_QWORD *)&commandCardParam, isShowValue);
    sub_1BCA7E0(&LocalizationManager_TypeInfo, v7, v8);
    sub_1BCA7E0(&UnityEngine_Object_TypeInfo, v9, v10);
    sub_1BCA7E0(&StringLiteral_3745/*"COMMAND_CARD_EXCEED_STATUS_COMBINE"*/, v11, v12);
    byte_4B199D8 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(powerUpCardValue, 0LL, 0LL) )
  {
    ...
    if ( isShowValue )
    {
      ...
      v17 = this->fields.powerUpCardValue;
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, v16);
      v18 = LocalizationManager__Get((System_String_o *)StringLiteral_3745/*"COMMAND_CARD_EXCEED_STATUS_COMBINE"*/, 0LL);
      ...
      v22 = (Il2CppObject *)LocalizationManager__GetNumberFormat(v21->static_fields->CommandCardParamUpMax, 0LL);
      gameObject = (UnityEngine_Component_o *)System_String__Format_62415592(v18, NumberFormat, v22, 0LL);
      if ( v17 )
      {
