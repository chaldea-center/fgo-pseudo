        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C258F8 & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_15432/*"XmlResolver"*/, data);
    byte_4C258F8 = 1;
  }
  ...
  BattleCommandComponent__setShader((BattleCommandComponent_o *)this, (System_String_o *)StringLiteral_15432/*"XmlResolver"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C3B9C0(objectRoot, isEnable);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C258FD & 1) == 0 )
  {
    sub_1C3B764(&BalanceConfig_TypeInfo, *(_QWORD *)&commandCardParam);
    sub_1C3B764(&LocalizationManager_TypeInfo, v7);
    sub_1C3B764(&UnityEngine_Object_TypeInfo, v8);
    sub_1C3B764(&StringLiteral_8934/*"Mongolian (Traditional Mongolian, PRC)"*/, v9);
    byte_4C258FD = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(exceedableLabel, 0LL, 0LL) )
  {
    ...
    gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_8934/*"Mongolian (Traditional Mongolian, PRC)"*/, 0LL);
    if ( !v11 )
      goto LABEL_14;
        ...
        const MethodInfo *method)
{
  ...
  GameObjectExtensions__SetLocalScale_34965512(v8, scale, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C258FC & 1) == 0 )
  {
    ...
    sub_1C3B764(&LocalizationManager_TypeInfo, v7);
    sub_1C3B764(&UnityEngine_Object_TypeInfo, v8);
    sub_1C3B764(&StringLiteral_3757/*"CONTINUECOUNT"*/, v9);
    byte_4C258FC = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(powerUpCardValue, 0LL, 0LL) )
  {
    ...
    if ( isShowValue )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v14 = LocalizationManager__Get((System_String_o *)StringLiteral_3757/*"CONTINUECOUNT"*/, 0LL);
      ...
      gameObject = (UnityEngine_Component_o *)System_String__Format_63382984(v14, NumberFormat, v17, 0LL);
      if ( v13 )
      {
