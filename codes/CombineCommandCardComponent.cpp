        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48615 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_15104/*"Unlit/Transparent Colored"*/, data);
    byte_4B48615 = 1;
  }
  ...
  BattleCommandComponent__setShader((BattleCommandComponent_o *)this, (System_String_o *)StringLiteral_15104/*"Unlit/Transparent Colored"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BDBAD4(objectRoot, isEnable);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4861A & 1) == 0 )
  {
    sub_1BDB878(&BalanceConfig_TypeInfo, *(_QWORD *)&commandCardParam);
    sub_1BDB878(&LocalizationManager_TypeInfo, v7);
    sub_1BDB878(&UnityEngine_Object_TypeInfo, v8);
    sub_1BDB878(&StringLiteral_8782/*"MSG_ABLED_COMMAND_CARD_EXCEED"*/, v9);
    byte_4B4861A = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(exceedableLabel, 0LL, 0LL) )
  {
    ...
    gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_8782/*"MSG_ABLED_COMMAND_CARD_EXCEED"*/, 0LL);
    if ( !v11 )
      goto LABEL_14;
        ...
        const MethodInfo *method)
{
  ...
  GameObjectExtensions__SetLocalScale_35213112(v8, scale, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48619 & 1) == 0 )
  {
    ...
    sub_1BDB878(&LocalizationManager_TypeInfo, v7);
    sub_1BDB878(&UnityEngine_Object_TypeInfo, v8);
    sub_1BDB878(&StringLiteral_3673/*"COMMAND_CARD_EXCEED_STATUS_COMBINE"*/, v9);
    byte_4B48619 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(powerUpCardValue, 0LL, 0LL) )
  {
    ...
    if ( isShowValue )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v14 = LocalizationManager__Get((System_String_o *)StringLiteral_3673/*"COMMAND_CARD_EXCEED_STATUS_COMBINE"*/, 0LL);
      ...
      gameObject = (UnityEngine_Component_o *)System_String__Format_62613552(v14, NumberFormat, v17, 0LL);
      if ( v13 )
      {
