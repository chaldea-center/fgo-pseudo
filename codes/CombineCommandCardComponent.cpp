        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB7F75 & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_15369/*"Unknown property '{0}'."*/, data);
    byte_4BB7F75 = 1;
  }
  ...
  BattleCommandComponent__setShader((BattleCommandComponent_o *)this, (System_String_o *)StringLiteral_15369/*"Unknown property '{0}'."*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C13F80(objectRoot, isEnable);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB7F7A & 1) == 0 )
  {
    sub_1C13D24(&BalanceConfig_TypeInfo, *(_QWORD *)&commandCardParam);
    sub_1C13D24(&LocalizationManager_TypeInfo, v7);
    sub_1C13D24(&UnityEngine_Object_TypeInfo, v8);
    sub_1C13D24(&StringLiteral_8922/*"MOUSE UP AS BUTTON"*/, v9);
    byte_4BB7F7A = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(exceedableLabel, 0LL, 0LL) )
  {
    ...
    gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_8922/*"MOUSE UP AS BUTTON"*/, 0LL);
    if ( !v11 )
      goto LABEL_14;
        ...
        const MethodInfo *method)
{
  ...
  GameObjectExtensions__SetLocalScale_34713904(v8, scale, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB7F79 & 1) == 0 )
  {
    ...
    sub_1C13D24(&LocalizationManager_TypeInfo, v7);
    sub_1C13D24(&UnityEngine_Object_TypeInfo, v8);
    sub_1C13D24(&StringLiteral_3757/*"COMMAND_CARD_EXCEED_SELECT_BASE_MSG"*/, v9);
    byte_4BB7F79 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(powerUpCardValue, 0LL, 0LL) )
  {
    ...
    if ( isShowValue )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v14 = LocalizationManager__Get((System_String_o *)StringLiteral_3757/*"COMMAND_CARD_EXCEED_SELECT_BASE_MSG"*/, 0LL);
      ...
      gameObject = (UnityEngine_Component_o *)System_String__Format_62982316(v14, NumberFormat, v17, 0LL);
      if ( v13 )
      {
