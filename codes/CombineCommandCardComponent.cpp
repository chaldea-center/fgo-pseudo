        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31628 & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_15123/*"Unlit/Transparent Colored"*/, data);
    byte_4A31628 = 1;
  }
  ...
  BattleCommandComponent__setShader((BattleCommandComponent_o *)this, (System_String_o *)StringLiteral_15123/*"Unlit/Transparent Colored"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B7641C(objectRoot, isEnable);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A3162D & 1) == 0 )
  {
    sub_1B761C0(&BalanceConfig_TypeInfo, *(_QWORD *)&commandCardParam);
    sub_1B761C0(&LocalizationManager_TypeInfo, v7);
    sub_1B761C0(&UnityEngine_Object_TypeInfo, v8);
    sub_1B761C0(&StringLiteral_8747/*"MSG_ABLED_COMMAND_CARD_EXCEED"*/, v9);
    byte_4A3162D = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(exceedableLabel, 0LL, 0LL) )
  {
    ...
    gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_8747/*"MSG_ABLED_COMMAND_CARD_EXCEED"*/, 0LL);
    if ( !v11 )
      goto LABEL_14;
        ...
        const MethodInfo *method)
{
  ...
  GameObjectExtensions__SetLocalScale_33554168(v8, scale, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A3162C & 1) == 0 )
  {
    ...
    sub_1B761C0(&LocalizationManager_TypeInfo, v7);
    sub_1B761C0(&UnityEngine_Object_TypeInfo, v8);
    sub_1B761C0(&StringLiteral_3713/*"COMMAND_CARD_EXCEED_STATUS_COMBINE"*/, v9);
    byte_4A3162C = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(powerUpCardValue, 0LL, 0LL) )
  {
    ...
    if ( isShowValue )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v14 = LocalizationManager__Get((System_String_o *)StringLiteral_3713/*"COMMAND_CARD_EXCEED_STATUS_COMBINE"*/, 0LL);
      ...
      gameObject = (UnityEngine_Component_o *)System_String__Format_61549432(v14, NumberFormat, v17, 0LL);
      if ( v13 )
      {
