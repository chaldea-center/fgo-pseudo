void __fastcall BattleCallBack___Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____ctor(
        ...
        const MethodInfo_304C768 *method)
{
  _QWORD *monitor; // x20
  void **v6; // x23
  ...
  sub_1B640F0(
    ...
    *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v14 + 192) + 8LL) + 128LL) + 32LL,
    ...
    (unsigned int)v11);
  sub_19B62A4(this, *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(monitor[4] + 192LL) + 8LL) + 128LL) + 64LL, klass);
}


void __fastcall BattleCallBack___Il2CppFullySharedGenericType____Il2CppFullySharedGenericType___call(
        BattleCallBack_T1__T2__o *this,
        const MethodInfo_304C8D4 *method)
{
  ...
  v9 = *(_QWORD *)sub_1B640EC(this, (char *)rgctx_data->_1_BattleCallBack_T1__T2_->_1.fields + 64);
  v10 = (const void *)sub_1B640EC(this, method->klass->rgctx_data->_1_BattleCallBack_T1__T2_->_1.fields);
  memcpy(v7, v10, native_size);
  v11 = (const void *)sub_1B640EC(this, (char *)method->klass->rgctx_data->_1_BattleCallBack_T1__T2_->_1.fields + 32);
  memcpy(v8, v11, v6);
