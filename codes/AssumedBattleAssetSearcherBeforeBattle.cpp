        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B68DF5 & 1) == 0 )
  {
    sub_1BE4ACC(&AssumedBattleAssetSearcherBeforeBattle_TypeInfo, v1);
    byte_4B68DF5 = 1;
  }
  v2 = (AssumedBattleAssetSearcherBase_o *)sub_1BE4D18(AssumedBattleAssetSearcherBeforeBattle_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B68DF4 & 1) == 0 )
  {
    sub_1BE4ACC(&AssumedBattleAssetLoadManager_AnalyzedResultParam_TypeInfo, method);
    sub_1BE4ACC(&Method_System_Collections_Generic_HashSet_SimpleTreasureDeviceData__UnionWith__, v3);
    sub_1BE4ACC(&Method_System_Collections_Generic_HashSet_SimpleSkillData__UnionWith__, v4);
    sub_1BE4ACC(&Method_System_Collections_Generic_HashSet_SimpleSkillData___ctor__, v5);
    sub_1BE4ACC(&Method_System_Collections_Generic_HashSet_SimpleTreasureDeviceData___ctor__, v6);
    sub_1BE4ACC(&System_Collections_Generic_HashSet_SimpleSkillData__TypeInfo, v7);
    this = (AssumedBattleAssetSearcherBeforeBattle_o *)sub_1BE4ACC(
  ...
  v10 = (AssumedBattleAssetLoadManager_AnalyzedResultParam_o *)sub_1BE4D18(AssumedBattleAssetLoadManager_AnalyzedResultParam_TypeInfo);
  AssumedBattleAssetLoadManager_AnalyzedResultParam___ctor(v10, v11);
  v12 = (System_Collections_Generic_HashSet_SimpleSkillData__o *)sub_1BE4D18(System_Collections_Generic_HashSet_SimpleSkillData__TypeInfo);
  System_Collections_Generic_HashSet_SimpleSkillData____ctor(
    v12,
    (const MethodInfo_34A745C *)Method_System_Collections_Generic_HashSet_SimpleSkillData___ctor__);
  ...
  System_Collections_Generic_HashSet_SimpleSkillData___UnionWith(
    ...
    (const MethodInfo_34A864C *)Method_System_Collections_Generic_HashSet_SimpleSkillData__UnionWith__);
  ...
  v17 = (System_Collections_Generic_HashSet_SimpleTreasureDeviceData__o *)sub_1BE4D18(System_Collections_Generic_HashSet_SimpleTreasureDeviceData__TypeInfo);
  System_Collections_Generic_HashSet_SimpleTreasureDeviceData____ctor(
    v17,
    (const MethodInfo_34A95B0 *)Method_System_Collections_Generic_HashSet_SimpleTreasureDeviceData___ctor__);
  ...
  System_Collections_Generic_HashSet_SimpleTreasureDeviceData___UnionWith(
    v17,
    (System_Collections_Generic_IEnumerable_T__o *)this,
    (const MethodInfo_34AA7A0 *)Method_System_Collections_Generic_HashSet_SimpleTreasureDeviceData__UnionWith__);
