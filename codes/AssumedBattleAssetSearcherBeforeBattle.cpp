AssumedBattleAssetSearcherBeforeBattle_o *AssumedBattleAssetSearcherBeforeBattle__Create(const MethodInfo *method)
{
  ...
  if ( (byte_4CC990A & 1) == 0 )
  {
    sub_1C713B0(&AssumedBattleAssetSearcherBeforeBattle_TypeInfo);
    byte_4CC990A = 1;
  }
  v1 = (AssumedBattleAssetSearcherBase_o *)sub_1C715FC(AssumedBattleAssetSearcherBeforeBattle_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC9909 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_System_Collections_Generic_HashSet_SimpleTreasureDeviceData__UnionWith__);
    ...
    sub_1C713B0(&Method_System_Collections_Generic_HashSet_SimpleTreasureDeviceData___ctor__);
    sub_1C713B0(&System_Collections_Generic_HashSet_SimpleSkillData__TypeInfo);
    this = (AssumedBattleAssetSearcherBeforeBattle_o *)sub_1C713B0(&System_Collections_Generic_HashSet_SimpleTreasureDeviceData__TypeInfo);
    byte_4CC9909 = 1;
  }
  ...
  v4 = (AssumedBattleAssetLoadManager_AnalyzedResultParam_o *)sub_1C715FC(AssumedBattleAssetLoadManager_AnalyzedResultParam_TypeInfo);
  AssumedBattleAssetLoadManager_AnalyzedResultParam___ctor(v4, v5);
  v6 = (System_Collections_Generic_HashSet_SimpleSkillData__o *)sub_1C715FC(System_Collections_Generic_HashSet_SimpleSkillData__TypeInfo);
  ...
  v11 = (System_Collections_Generic_HashSet_SimpleTreasureDeviceData__o *)sub_1C715FC(System_Collections_Generic_HashSet_SimpleTreasureDeviceData__TypeInfo);
  System_Collections_Generic_HashSet_SimpleTreasureDeviceData____ctor(
    v11,
    (const MethodInfo_36CB4A4 *)Method_System_Collections_Generic_HashSet_SimpleTreasureDeviceData___ctor__);
  ...
  System_Collections_Generic_HashSet_SimpleTreasureDeviceData___UnionWith(
    v11,
    (System_Collections_Generic_IEnumerable_T__o *)this,
    (const MethodInfo_36CC694 *)Method_System_Collections_Generic_HashSet_SimpleTreasureDeviceData__UnionWith__);
