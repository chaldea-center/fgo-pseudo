        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDE7CA & 1) == 0 )
  {
    sub_1C21E38(&AssumedBattleAssetSearcherBeforeBattle_TypeInfo);
    byte_4BDE7CA = 1;
  }
  v1 = (AssumedBattleAssetSearcherBase_o *)sub_1C22084(AssumedBattleAssetSearcherBeforeBattle_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDE7C9 & 1) == 0 )
  {
    sub_1C21E38(&AssumedBattleAssetLoadManager_AnalyzedResultParam_TypeInfo);
    sub_1C21E38(&Method_System_Collections_Generic_HashSet_SimpleTreasureDeviceData__UnionWith__);
    sub_1C21E38(&Method_System_Collections_Generic_HashSet_SimpleSkillData__UnionWith__);
    sub_1C21E38(&Method_System_Collections_Generic_HashSet_SimpleSkillData___ctor__);
    sub_1C21E38(&Method_System_Collections_Generic_HashSet_SimpleTreasureDeviceData___ctor__);
    sub_1C21E38(&System_Collections_Generic_HashSet_SimpleSkillData__TypeInfo);
    this = (AssumedBattleAssetSearcherBeforeBattle_o *)sub_1C21E38(&System_Collections_Generic_HashSet_SimpleTreasureDeviceData__TypeInfo);
    byte_4BDE7C9 = 1;
  }
  ...
  v4 = (AssumedBattleAssetLoadManager_AnalyzedResultParam_o *)sub_1C22084(AssumedBattleAssetLoadManager_AnalyzedResultParam_TypeInfo);
  AssumedBattleAssetLoadManager_AnalyzedResultParam___ctor(v4, v5);
  v6 = (System_Collections_Generic_HashSet_SimpleSkillData__o *)sub_1C22084(System_Collections_Generic_HashSet_SimpleSkillData__TypeInfo);
  System_Collections_Generic_HashSet_SimpleSkillData____ctor(
    v6,
    (const MethodInfo_350AD70 *)Method_System_Collections_Generic_HashSet_SimpleSkillData___ctor__);
  ...
  System_Collections_Generic_HashSet_SimpleSkillData___UnionWith(
    ...
    (const MethodInfo_350BF60 *)Method_System_Collections_Generic_HashSet_SimpleSkillData__UnionWith__);
  ...
  v11 = (System_Collections_Generic_HashSet_SimpleTreasureDeviceData__o *)sub_1C22084(System_Collections_Generic_HashSet_SimpleTreasureDeviceData__TypeInfo);
  System_Collections_Generic_HashSet_SimpleTreasureDeviceData____ctor(
    v11,
    (const MethodInfo_350CEC4 *)Method_System_Collections_Generic_HashSet_SimpleTreasureDeviceData___ctor__);
  ...
  System_Collections_Generic_HashSet_SimpleTreasureDeviceData___UnionWith(
    v11,
    (System_Collections_Generic_IEnumerable_T__o *)this,
    (const MethodInfo_350E0B4 *)Method_System_Collections_Generic_HashSet_SimpleTreasureDeviceData__UnionWith__);
