        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B1C47 & 1) == 0 )
  {
    sub_B52984(&AssumedBattleAssetSearcherBeforeBattle_TypeInfo);
    byte_42B1C47 = 1;
  }
  v1 = (AssumedBattleAssetSearcherBase_o *)sub_B52A54(AssumedBattleAssetSearcherBeforeBattle_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B1C46 & 1) == 0 )
  {
    sub_B52984(&AssumedBattleAssetLoadManager_AnalyzedResultParam_TypeInfo);
    sub_B52984(&Method_System_Collections_Generic_HashSet_SimpleSkillData__UnionWith__);
    sub_B52984(&Method_System_Collections_Generic_HashSet_SimpleTreasureDeviceData__UnionWith__);
    sub_B52984(&Method_System_Collections_Generic_HashSet_SimpleTreasureDeviceData___ctor___68489576);
    sub_B52984(&Method_System_Collections_Generic_HashSet_SimpleSkillData___ctor___68489512);
    sub_B52984(&System_Collections_Generic_HashSet_SimpleTreasureDeviceData__TypeInfo);
    this = (AssumedBattleAssetSearcherBeforeBattle_o *)sub_B52984(&System_Collections_Generic_HashSet_SimpleSkillData__TypeInfo);
    byte_42B1C46 = 1;
  }
  ...
  v4 = (AssumedBattleAssetLoadManager_AnalyzedResultParam_o *)sub_B52A54(AssumedBattleAssetLoadManager_AnalyzedResultParam_TypeInfo);
  AssumedBattleAssetLoadManager_AnalyzedResultParam___ctor(v4, 0LL);
  v5 = (System_Collections_Generic_HashSet_SimpleSkillData__o *)sub_B52A54(System_Collections_Generic_HashSet_SimpleSkillData__TypeInfo);
  System_Collections_Generic_HashSet_SimpleSkillData____ctor(
    v5,
    (const MethodInfo_24E23B4 *)Method_System_Collections_Generic_HashSet_SimpleSkillData___ctor___68489512);
  ...
  System_Collections_Generic_HashSet_SimpleSkillData___UnionWith(
    ...
    (const MethodInfo_24E3578 *)Method_System_Collections_Generic_HashSet_SimpleSkillData__UnionWith__);
  ...
  v10 = (System_Collections_Generic_HashSet_SimpleTreasureDeviceData__o *)sub_B52A54(System_Collections_Generic_HashSet_SimpleTreasureDeviceData__TypeInfo);
  System_Collections_Generic_HashSet_SimpleTreasureDeviceData____ctor(
    v10,
    (const MethodInfo_24E46A0 *)Method_System_Collections_Generic_HashSet_SimpleTreasureDeviceData___ctor___68489576);
  ...
  if ( !v10
    || (System_Collections_Generic_HashSet_SimpleTreasureDeviceData___UnionWith(
          v10,
          (System_Collections_Generic_IEnumerable_T__o *)this,
          (const MethodInfo_24E5864 *)Method_System_Collections_Generic_HashSet_SimpleTreasureDeviceData__UnionWith__),
