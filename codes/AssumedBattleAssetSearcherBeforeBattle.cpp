AssumedBattleAssetSearcherBeforeBattle_o *AssumedBattleAssetSearcherBeforeBattle__Create(const MethodInfo *method)
{
  ...
  if ( (byte_4C29776 & 1) == 0 )
  {
    sub_1C2D490(&AssumedBattleAssetSearcherBeforeBattle_TypeInfo);
    byte_4C29776 = 1;
  }
  v1 = (AssumedBattleAssetSearcherBase_o *)sub_1C2D6DC(AssumedBattleAssetSearcherBeforeBattle_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C29775 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_System_Collections_Generic_HashSet_SimpleTreasureDeviceData__UnionWith__);
    ...
    sub_1C2D490(&Method_System_Collections_Generic_HashSet_SimpleTreasureDeviceData___ctor__);
    sub_1C2D490(&System_Collections_Generic_HashSet_SimpleSkillData__TypeInfo);
    this = (AssumedBattleAssetSearcherBeforeBattle_o *)sub_1C2D490(&System_Collections_Generic_HashSet_SimpleTreasureDeviceData__TypeInfo);
    byte_4C29775 = 1;
  }
  ...
  v4 = (AssumedBattleAssetLoadManager_AnalyzedResultParam_o *)sub_1C2D6DC(AssumedBattleAssetLoadManager_AnalyzedResultParam_TypeInfo);
  AssumedBattleAssetLoadManager_AnalyzedResultParam___ctor(v4, v5);
  v6 = (System_Collections_Generic_HashSet_SimpleSkillData__o *)sub_1C2D6DC(System_Collections_Generic_HashSet_SimpleSkillData__TypeInfo);
  ...
  v11 = (System_Collections_Generic_HashSet_SimpleTreasureDeviceData__o *)sub_1C2D6DC(System_Collections_Generic_HashSet_SimpleTreasureDeviceData__TypeInfo);
  System_Collections_Generic_HashSet_SimpleTreasureDeviceData____ctor(
    v11,
    (const MethodInfo_36450A8 *)Method_System_Collections_Generic_HashSet_SimpleTreasureDeviceData___ctor__);
  ...
  System_Collections_Generic_HashSet_SimpleTreasureDeviceData___UnionWith(
    v11,
    (System_Collections_Generic_IEnumerable_T__o *)this,
    (const MethodInfo_3646298 *)Method_System_Collections_Generic_HashSet_SimpleTreasureDeviceData__UnionWith__);
