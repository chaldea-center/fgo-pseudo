        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B2973 & 1) == 0 )
  {
    sub_B52984(&Method_UnityEngine_GameObject_GetComponent_SupportSelectDeckListViewItemDraw___);
    byte_42B2973 = 1;
  }
  ...
  Component_srcLineSprite = (struct SupportSelectDeckListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                                            dispObject,
                                                                            (const MethodInfo_1B7B1B8 *)Method_UnityEngine_GameObject_GetComponent_SupportSelectDeckListViewItemDraw___);
...
void __fastcall SupportSelectDeckListViewObject__SetMode_29815172(
        SupportSelectDeckListViewObject_o *this,
        int32_t mode,
...
LABEL_5:
    ...
    while ( 1 )
    {
      ...
      if ( *(__int16 *)(v22 + 72) == -1 )
        sub_B52A40(*(_QWORD *)&v20->fields.extra_arg, *(_QWORD *)&deckId, method, v3);
