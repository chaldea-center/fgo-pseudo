        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DF2CF & 1) == 0 )
  {
    sub_1B00CCC(&Method_UnityEngine_GameObject_GetComponent_SupportSelectDeckListViewItemDraw___, method);
    byte_48DF2CF = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2DADE08 *)Method_UnityEngine_GameObject_GetComponent_SupportSelectDeckListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DF2D0 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&SupportSelectDeckListViewItem_TypeInfo, v3);
    byte_48DF2D0 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DF2D1 & 1) == 0 )
  {
    sub_1B00CCC(&SupportSelectDeckListViewItem_TypeInfo, method);
    sub_1B00CCC(&Method_SupportSelectDeckListViewObject_OnSelected__, v3);
    byte_48DF2D1 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
  ...
  else
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectDeckListViewObject_OnSelected__ + 83) & 2) != 0 )
      v6 = (_QWORD *)sub_1B00CE4(Method_SupportSelectDeckListViewObject_OnSelected__);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.onSelected, 0, (int32_t)method, v3);
...
void __fastcall SupportSelectDeckListViewObject__SetMode_32126884(
        SupportSelectDeckListViewObject_o *this,
        int32_t mode,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DF2CD & 1) == 0 )
  {
    sub_1B00CCC(&SupportSelectDeckListViewObject_OnSelectEvent_TypeInfo, value);
    byte_48DF2CD = 1;
  }
  onSelected = this->fields.onSelected;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_194785C;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1947814;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DF2D3 & 1) == 0 )
  {
    sub_1B00CCC(&int_TypeInfo, *(_QWORD *)&deckId);
    byte_48DF2D3 = 1;
  }
  v9[1] = 0LL;
