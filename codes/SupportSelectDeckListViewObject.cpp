        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18B85 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_UnityEngine_GameObject_GetComponent_SupportSelectDeckListViewItemDraw___, method);
    byte_4B18B85 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_306E710 *)Method_UnityEngine_GameObject_GetComponent_SupportSelectDeckListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18B86 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&SupportSelectDeckListViewItem_TypeInfo, v3);
    byte_4B18B86 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18B87 & 1) == 0 )
  {
    sub_1BCAFF8(&SupportSelectDeckListViewItem_TypeInfo, method);
    sub_1BCAFF8(&Method_SupportSelectDeckListViewObject_OnSelected__, v3);
    byte_4B18B87 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
  ...
  else
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectDeckListViewObject_OnSelected__ + 83) & 2) != 0 )
      v6 = (_QWORD *)sub_1BCB010(Method_SupportSelectDeckListViewObject_OnSelected__);
        ...
        const MethodInfo *method)
{
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.onSelected, 0, (int32_t)method, v3);
...
void __fastcall SupportSelectDeckListViewObject__SetMode_34844212(
        SupportSelectDeckListViewObject_o *this,
        int32_t mode,
        ...
        const MethodInfo *method)
{
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.onSelected, (int32_t)onSelected, (int32_t)onSelected, method);
  ((void (__fastcall *)(SupportSelectDeckListViewObject_o *, bool, Il2CppMethodPointer))this->klass->vtable._9_SetInput.method)(
    this,
    mode == 2,
    this->klass->vtable._10_Invalidation.methodPtr);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18B83 & 1) == 0 )
  {
    sub_1BCAFF8(&SupportSelectDeckListViewObject_OnSelectEvent_TypeInfo, value);
    byte_4B18B83 = 1;
  }
  onSelected = this->fields.onSelected;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A11BAC;
LABEL_6:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18B89 & 1) == 0 )
  {
    sub_1BCAFF8(&int_TypeInfo, *(_QWORD *)&deckId);
    byte_4B18B89 = 1;
  }
  v9[1] = 0LL;
