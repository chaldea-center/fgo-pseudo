...
void __fastcall MaterialEventLogListViewObject__Awake(MaterialEventLogListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B3793 & 1) == 0 )
  {
    sub_B52984(&Method_UnityEngine_GameObject_GetComponent_MaterialEventLogListViewItemDraw___);
    byte_42B3793 = 1;
  }
  ...
  Component_srcLineSprite = (struct MaterialEventLogListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                                           dispObject,
                                                                           (const MethodInfo_1B7B1B8 *)Method_UnityEngine_GameObject_GetComponent_MaterialEventLogListViewItemDraw___);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall MaterialEventLogListViewObject__Init_31567204(
        MaterialEventLogListViewObject_o *this,
        int32_t initMode,
...
void __fastcall MaterialEventLogListViewObject__Init_31567276(
        MaterialEventLogListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        ...
        const MethodInfo *method)
{
  ...
  if ( v15 <= 3 )
  {
    v27 = dword_327C138[v15];
    this->fields.dispMode = dword_32788A0[v15];
...
void __fastcall MaterialEventLogListViewObject__SetItem_31566996(
        MaterialEventLogListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
