        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA347 & 1) == 0 )
  {
    sub_1B64A00(&MaterialEventLogListViewItem_TypeInfo, method);
...
void __fastcall MaterialEventLogListViewObject__Awake(MaterialEventLogListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA340 & 1) == 0 )
  {
    sub_1B64A00(&Method_UnityEngine_GameObject_GetComponent_MaterialEventLogListViewItemDraw___, method);
    byte_49FA340 = 1;
  }
  ...
  this->fields.itemDraw = (struct MaterialEventLogListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_object_(
                                                                         dispObject,
                                                                         (const MethodInfo_2E8A7CC *)Method_UnityEngine_GameObject_GetComponent_MaterialEventLogListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  MaterialEventLogListViewObject__Init_30970768(this, initMode, 0LL, limitCount, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !byte_49F9821 )
  {
    transform = sub_1B64A00(&UnityEngine_Vector3_TypeInfo, v3);
    byte_49F9821 = 1;
  }
  if ( !v4 )
...
void __fastcall MaterialEventLogListViewObject__Init_30970768(
        MaterialEventLogListViewObject_o *this,
        int32_t initMode,
        ...
        const MethodInfo *method)
{
  ...
  MaterialEventLogListViewObject__Init_30970860(
    this,
    initMode,
    callbackFunc,
    v5,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall MaterialEventLogListViewObject__Init_30970860(
        MaterialEventLogListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA345 & 1) == 0 )
  {
    sub_1B64A00(&MaterialEventLogListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_49FA345 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
  ...
  {
    v21 = dword_BA3000[v13];
    this->fields.dispMode = *((_DWORD *)&xmmword_BA3590 + v13);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA344 & 1) == 0 )
  {
    sub_1B64A00(&Method_UnityEngine_Component_GetComponent_UIButton___, isSelect);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA343 & 1) == 0 )
  {
    sub_1B64A00(&MaterialEventLogListViewItem_TypeInfo, isInput);
    sub_1B64A00(&UnityEngine_Object_TypeInfo, v5);
    byte_49FA343 = 1;
  }
...
void __fastcall MaterialEventLogListViewObject__SetItem_30970584(
        MaterialEventLogListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA346 & 1) == 0 )
  {
    sub_1B64A00(&Method_UnityEngine_Component_GetComponent_UIButton___, *(_QWORD *)&limitCount);
    sub_1B64A00(&MaterialEventLogListViewItem_TypeInfo, v5);
...
LABEL_20:
      sub_1B64C5C(IsEnableSelect, v11);
    }
  }
}
...
void __fastcall MaterialEventLogListViewObject__Start(MaterialEventLogListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    MaterialEventLogListViewObject__Init_30970768(this, 2, 0LL, -1, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  v11 = (MaterialEventLogListViewObject_o *)sub_1B64F1C(v8);
