        ...
        const MethodInfo *method)
{
  ...
  struct BlankEarthSpotNavimenuMaster___c_StaticFields *v29; // x0
...
LABEL_16:
    ...
    if ( v16 )
    {
      v19 = *(&BlankEarthSpotNavimenuEntity_TypeInfo->_2.bitflags2 + 1);
      if ( *(&v16->klass->_2.bitflags2 + 1) >= (unsigned int)v19
        && (BlankEarthSpotNavimenuEntity_c *)v16->klass->_2.typeHierarchy[v19 - 1] == BlankEarthSpotNavimenuEntity_TypeInfo )
      {
