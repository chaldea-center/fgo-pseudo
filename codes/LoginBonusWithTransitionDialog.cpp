        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC9D14 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_LoginBonusWithTransitionDialog___c__DisplayClass1_0__Open_b__0__);
    sub_1C713B0(&LoginBonusWithTransitionDialog___c__DisplayClass1_0_TypeInfo);
  ...
  v14 = sub_1C715FC(LoginBonusWithTransitionDialog___c__DisplayClass1_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v14, 0);
  if ( !v14 )
    goto LABEL_15;
  *(_QWORD *)(v14 + 16) = onDecideCallback;
  sub_1C71354((GrandQuestFolderBoardItem_o *)(v14 + 16), (int32_t)onDecideCallback, v17, v18, v19, v20, v21, v22);
  *(_QWORD *)(v14 + 24) = onCancelCallback;
  sub_1C71354((GrandQuestFolderBoardItem_o *)(v14 + 24), (int32_t)onCancelCallback, v23, v24, v25, v26, v27, v28);
  ...
  sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.clickFunc, (int32_t)v29, v30, v31, v32, v33, v34, v35);
  buttonCancelLabel = this->fields.buttonCancelLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  buttonDecideLabel = LocalizationManager__Get((System_String_o *)StringLiteral_3680/*"COMMON_CONFIRM_CLOSE"*/, 0);
  ...
  buttonDecideLabel = EntityScriptUtil__GetStringValue(TransitionDialog, (System_String_o *)StringLiteral_22251/*"name"*/, 0, 0);
  if ( !titleLabel )
    goto LABEL_15;
  UILabel__set_text(titleLabel, buttonDecideLabel, 0);
  messageLabel = this->fields.messageLabel;
  v40 = CommonUI_CampaignDirectBonusData__GetTransitionDialog(bonusData, 0);
  buttonDecideLabel = EntityScriptUtil__GetStringValue(v40, (System_String_o *)StringLiteral_18638/*"detail"*/, 0, 0);
  if ( !messageLabel
  ...
  {
LABEL_15:
    sub_1C71608(buttonDecideLabel, v16);
  }
  ...
  System_Action___ctor(v41, (Il2CppObject *)this, Method_CommonConfirmDialog_EndOpen__, 0);
  BaseDialog__Open((BaseDialog_o *)this, v41, 0, 0, 0);
}


void LoginBonusWithTransitionDialog__Open_46208192(
        LoginBonusWithTransitionDialog_o *this,
        CommonUI_CampaignDirectBonusData_o *bonusData,
        GiftMaster_o *giftMst,
        ItemMaster_o *itemMst,
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_10:
    sub_1C71608(buttonDecide, bonusData);
  }
  v13 = 0;
  v14 = y;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC9D15 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_LoginBonusWithTransitionDialog___c__DisplayClass1_1__Open_b__1__);
    sub_1C713B0(&LoginBonusWithTransitionDialog___c__DisplayClass1_1_TypeInfo);
    byte_4CC9D15 = 1;
  }
  v5 = sub_1C715FC(LoginBonusWithTransitionDialog___c__DisplayClass1_1_TypeInfo);
  ...
  CommonUI__CloseLoginBonusWithTransitionDialog((CommonUI_o *)Instance, v15, 0);
}
