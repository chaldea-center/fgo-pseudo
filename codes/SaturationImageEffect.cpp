        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3A595 & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_16450/*"_MainTex"*/, v7);
  ...
  UnityEngine_Material__SetTexture(material, (System_String_o *)StringLiteral_16450/*"_MainTex"*/, this->fields.texture, 0LL);
