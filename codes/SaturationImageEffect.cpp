        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4817C & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_16243/*"_MainTex"*/, v7);
  ...
  UnityEngine_Material__SetTexture(material, (System_String_o *)StringLiteral_16243/*"_MainTex"*/, this->fields.texture, 0LL);
