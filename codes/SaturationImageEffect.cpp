        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB90BE & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_16293/*"_MainTex"*/, v7);
  ...
  UnityEngine_Material__SetTexture(material, (System_String_o *)StringLiteral_16293/*"_MainTex"*/, this->fields.texture, 0LL);
