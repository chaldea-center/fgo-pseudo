        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A02D & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_16471/*"_MainTex"*/, v7);
  ...
  UnityEngine_Material__SetTexture(material, (System_String_o *)StringLiteral_16471/*"_MainTex"*/, this->fields.texture, 0LL);
