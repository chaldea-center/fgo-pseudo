        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B195B0 & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&StringLiteral_16431/*"_MainTex"*/, v7, v8);
  ...
  UnityEngine_Material__SetTexture(material, (System_String_o *)StringLiteral_16431/*"_MainTex"*/, this->fields.texture, 0LL);
