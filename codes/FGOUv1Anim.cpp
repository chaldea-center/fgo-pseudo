void __fastcall FGOUv1Anim___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A07B4A & 1) == 0 )
  {
    sub_1B686D4(&FGOUv1Anim_TypeInfo, v1);
    sub_1B686D4(&StringLiteral_16286/*"_SubTex"*/, v2);
    byte_4A07B4A = 1;
  }
...
void __fastcall FGOUv1Anim__UpdateUV(FGOUv1Anim_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A07B49 & 1) == 0 )
  {
    ...
    sub_1B686D4(&FGOUv1Anim_TypeInfo, v3);
...
LABEL_28:
  ...
  if ( UnityEngine_Material__HasProperty(v11, FGOUv1Anim_TypeInfo->static_fields->subTexID, 0LL) )
  {
    ...
    UnityEngine_Material__SetTextureOffset_69037412(v11, v12->static_fields->subTexID, this->fields.m_Offset, 0LL);
  }
  if ( !UnityEngine_Application_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Application_TypeInfo);
  if ( !UnityEngine_Application__get_isPlaying(0LL) )
