        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB5855 & 1) == 0 )
  {
    sub_1BAB41C(&System_Enum_TypeInfo, dataString);
    sub_1BAB41C(&CondType_Kind_var, v4);
    sub_1BAB41C(&CondType_Kind_TypeInfo, v5);
    sub_1BAB41C(&BlankEarthSpotAnimStateManager_SpotStateData_TypeInfo, v6);
    this = (BlankEarthSpotAnimStateManager_o *)sub_1BAB41C(&System_Type_TypeInfo, v7);
    byte_4AB5855 = 1;
  }
  if ( !dataString )
    sub_1BAB678(this, dataString);
  v8 = System_String__Split(dataString, 0x2Cu, 0, 0LL);
  v9 = sub_1BAB668(BlankEarthSpotAnimStateManager_SpotStateData_TypeInfo);
  ...
  *(_DWORD *)(v9 + 20) = System_Int32__Parse(v8->m_Items[1], 0LL);
  ...
  if ( v8->max_length <= 2 )
    sub_1BAB680(TypeFromHandle, v16);
  v17 = TypeFromHandle;
  v18 = v8->m_Items[2];
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB5856 & 1) == 0 )
  {
    sub_1BAB41C(
      ...
      *(_QWORD *)&spotId);
    sub_1BAB41C(&System_Func_BlankEarthSpotAnimStateManager_SpotStateData__bool__TypeInfo, v11);
    sub_1BAB41C(&Method_BlankEarthSpotAnimStateManager___c__DisplayClass10_0__GetCurrentAnimIndex_b__0__, v12);
    sub_1BAB41C(&BlankEarthSpotAnimStateManager___c__DisplayClass10_0_TypeInfo, v13);
    byte_4AB5856 = 1;
  }
  v14 = sub_1BAB668(BlankEarthSpotAnimStateManager___c__DisplayClass10_0_TypeInfo);
  ...
  *(_BYTE *)(v14 + 24) = isCheckResetFlag;
  SortedSpotStateDataArray = (System_Collections_Generic_IEnumerable_TSource__o *)BlankEarthSpotAnimStateManager__get_SortedSpotStateDataArray(
                                                                                    this,
                                                                                    v16);
  v18 = (System_Func_object__bool__o *)sub_1BAB668(System_Func_BlankEarthSpotAnimStateManager_SpotStateData__bool__TypeInfo);
  ...
  v19 = System_Linq_Enumerable__FirstOrDefault_object__49186032(
          ...
          (const MethodInfo_2EE84F0 *)Method_System_Linq_Enumerable_FirstOrDefault_BlankEarthSpotAnimStateManager_SpotStateData___);
  if ( v19 )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB5854 & 1) == 0 )
  {
    sub_1BAB41C(&Method_System_Array_Empty_BlankEarthSpotAnimStateManager_SpotStateData___, method);
    sub_1BAB41C(&Method_BasicHelper_ExcludeNull_BlankEarthSpotAnimStateManager_SpotStateData___, v4);
    sub_1BAB41C(&Method_BlankEarthSpotAnimStateManager_ConvertStrToSpotStateData__, v5);
    sub_1BAB41C(&Method_DataManager_GetMaster_ConstantStrMaster___, v6);
    sub_1BAB41C(&DataManager_TypeInfo, v7);
    sub_1BAB41C(&Method_DataMasterBase_ConstantStrMaster__ConstantStrEntity__string__TryGetEntity__, v8);
    sub_1BAB41C(&Method_System_Linq_Enumerable_Select_string__BlankEarthSpotAnimStateManager_SpotStateData___, v9);
    sub_1BAB41C(&Method_System_Linq_Enumerable_ToArray_BlankEarthSpotAnimStateManager_SpotStateData___, v10);
    sub_1BAB41C(&System_Func_string__BlankEarthSpotAnimStateManager_SpotStateData__TypeInfo, v11);
    sub_1BAB41C(&StringLiteral_3043/*"BLANK_EARTH_SPOT_ANIM_STATE"*/, v12);
    byte_4AB5854 = 1;
  }
  ...
  if ( !v14 )
  {
    sub_1BFD354(Method_System_Array_Empty_BlankEarthSpotAnimStateManager_SpotStateData___);
    v14 = v13[7];
  }
  v15 = *(_QWORD *)(v14 + 16);
  if ( (*(_BYTE *)(v15 + 309) & 1) == 0 )
    v15 = sub_1BFD2F8(v2);
  if ( !*(_DWORD *)(v15 + 224) )
    *(__n128 *)&v2 = j_il2cpp_runtime_class_init_0(v15);
  ...
  Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataManager__GetMaster_object_((const MethodInfo_2EC5574 *)Method_DataManager_GetMaster_ConstantStrMaster___);
  if ( !Master_object )
    goto LABEL_21;
  Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataMasterBase_object__object__object___TryGetEntity(
                                                                  Master_object,
                                                                  &entity,
                                                                  (Il2CppObject *)StringLiteral_3043/*"BLANK_EARTH_SPOT_ANIM_STATE"*/,
      ...
      if ( entity )
      {
        ...
        if ( Master_object )
        {
          v20 = (System_Collections_Generic_IEnumerable_TSource__o *)System_String__Split(
                                                                       ...
                                                                       0,
                                                                       0LL);
          v21 = (System_Func_object__object__o *)sub_1BAB668(System_Func_string__BlankEarthSpotAnimStateManager_SpotStateData__TypeInfo);
          ...
          v22 = (System_Collections_Generic_IEnumerable_T__o *)System_Linq_Enumerable__Select_object__object_(
                                                                 ...
                                                                 (const MethodInfo_2EF4318 *)Method_System_Linq_Enumerable_Select_string__BlankEarthSpotAnimStateManager_SpotStateData___);
          v23 = BasicHelper__ExcludeNull_object_(
                  v22,
                  (const MethodInfo_2EB0090 *)Method_BasicHelper_ExcludeNull_BlankEarthSpotAnimStateManager_SpotStateData___);
          return (BlankEarthSpotAnimStateManager_SpotStateData_array *)System_Linq_Enumerable__ToArray_object_(
                                                                         (System_Collections_Generic_IEnumerable_TSource__o *)v23,
                                                                         (const MethodInfo_2EFD0EC *)Method_System_Linq_Enumerable_ToArray_BlankEarthSpotAnimStateManager_SpotStateData___);
        }
      }
LABEL_21:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB5853 & 1) == 0 )
  {
    sub_1BAB41C(&Method_System_Linq_Enumerable_OrderBy_BlankEarthSpotAnimStateManager_SpotStateData__int___, method);
    sub_1BAB41C(&Method_System_Linq_Enumerable_ToArray_BlankEarthSpotAnimStateManager_SpotStateData___, v3);
    sub_1BAB41C(&System_Func_BlankEarthSpotAnimStateManager_SpotStateData__int__TypeInfo, v4);
    sub_1BAB41C(&Method_BlankEarthSpotAnimStateManager___c__get_SortedSpotStateDataArray_b__6_0__, v5);
    sub_1BAB41C(&BlankEarthSpotAnimStateManager___c_TypeInfo, v6);
    byte_4AB5853 = 1;
  }
  ...
  if ( !sortedSpotStateDataArray )
  {
    ...
    if ( !_9__6_0 )
    {
      ...
      _9__6_0 = (System_Func_object__int__o *)sub_1BAB668(System_Func_BlankEarthSpotAnimStateManager_SpotStateData__int__TypeInfo);
      ...
      sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&static_fields->__9__6_0, (int32_t)_9__6_0, v14, v15);
    }
    v16 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__OrderBy_object__int_(
                                                                 ...
                                                                 (const MethodInfo_2EEDCCC *)Method_System_Linq_Enumerable_OrderBy_BlankEarthSpotAnimStateManager_SpotStateData__int___);
    ...
    sub_1BAB3C0(p_sortedSpotStateDataArray, (int32_t)sortedSpotStateDataArray, v17, v18);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !spotStateDataArray )
  {
    ...
    sub_1BAB3C0(p_fields, (int32_t)spotStateDataArray, v5, v6);
  }
...
void __fastcall BlankEarthSpotAnimStateManager___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB5858 & 1) == 0 )
  {
    sub_1BAB41C(&BlankEarthSpotAnimStateManager___c_TypeInfo, v1);
    byte_4AB5858 = 1;
  }
  v2 = (Il2CppObject *)sub_1BAB668(BlankEarthSpotAnimStateManager___c_TypeInfo);
