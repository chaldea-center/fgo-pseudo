        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDC0C7 & 1) == 0 )
  {
    sub_1C21E38(&Method_EntityScriptUtil_GetScriptValue_List_object___List_float____);
    sub_1C21E38(&Method_EntityScriptValueConvertLogic_ObjectListToFloatList__);
    sub_1C21E38(&System_Func_List_object___List_float___TypeInfo);
    sub_1C21E38(&Method_System_Collections_Generic_List_float__ToArray__);
    byte_4BDC0C7 = 1;
  }
  if ( !script )
    return defaultArray;
  v7 = (System_Func_object__object__o *)sub_1C22084(System_Func_List_object___List_float___TypeInfo);
  System_Func_object__object____ctor(v7, 0LL, Method_EntityScriptValueConvertLogic_ObjectListToFloatList__, 0LL);
  result = (System_Single_array *)EntityScriptUtil__GetScriptValue_object__object_(
                                    script,
                                    key,
                                    (System_Func_TSource__TDestination__o *)v7,
                                    0LL,
                                    (const MethodInfo_2FB659C *)Method_EntityScriptUtil_GetScriptValue_List_object___List_float____);
  if ( result )
    result = System_Collections_Generic_List_float___ToArray(
               (System_Collections_Generic_List_float__o *)result,
               (const MethodInfo_36712E8 *)Method_System_Collections_Generic_List_float__ToArray__);
  if ( !result )
    return defaultArray;
  return result;
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4BDC0C2 & 1) == 0 )
  {
    sub_1C21E38(&Method_BasicHelper_GetValue_double___);
    byte_4BDC0C2 = 1;
  }
  if ( script )
    return BasicHelper__GetValue_double_(
             ...
             key,
             defaultValue,
             (const MethodInfo_2F9DBC8 *)Method_BasicHelper_GetValue_double___);
  return defaultValue;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !script )
    return defaultValue;
  v7 = (System_Func_object__object__o *)sub_1C22084(System_Func_List_object___List_int___TypeInfo);
...
Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_o __fastcall EntityScriptUtil__GetScriptValue___Il2CppFullySharedGenericType____Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_2FB66FC *method)
{
  Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_c *klass; // x21
  const MethodInfo_2FB66FC_RGCTXs *rgctx_data; // x24
  ...
  _QWORD *v15; // x0
  __int64 v16; // x1
  const MethodInfo_2FB66FC_RGCTXs *v17; // x8
...
LABEL_15:
  ...
  if ( (BYTE5(_2_TSource->vtable[0].methodPtr) & 1) == 0 )
    _2_TSource = (Il2CppClass *)sub_1C73D14(v12);
  v15 = (_QWORD *)sub_1C21F84(v13, _2_TSource, v11);
  if ( !v27 )
    sub_1C22094(v15, v16);
...
System_Nullable_int__o __fastcall EntityScriptUtil__GetScriptValue_long__Nullable_int__(
        ...
        const MethodInfo_2FB6434 *method)
{
  __int64 v10; // x0
  __int64 v11; // x1
  __int64 v12; // x2
  __int64 v13; // x3
  long double v14; // q0
  const MethodInfo_2FB6434_RGCTXs *rgctx_data; // x8
  ...
  if ( script )
  {
    ...
    if ( (v10 & 1) != 0 )
    {
      ...
      else
      {
        ...
        v23 = sub_1C21E4C(&System_InvalidCastException_TypeInfo);
...
Il2CppObject *__fastcall EntityScriptUtil__GetScriptValue_object__object_(
        ...
        const MethodInfo_2FB659C *method)
{
  _BOOL8 v10; // x0
  __int64 v11; // x1
  long double v12; // q0
  ...
  if ( script )
  {
    ...
    if ( v10 )
    {
      ...
      if ( (BYTE5(_2_TSource->vtable[0].methodPtr) & 1) == 0 )
        _2_TSource = (Il2CppClass *)sub_1C73D14(v12);
      if ( v13 && !sub_1C21F74(v13, _2_TSource) )
        sub_1C22354(v13);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDC0BF & 1) == 0 )
  {
    sub_1C21E38(&Method_EntityScriptUtil_GetScriptValue_List_object___string_____);
    sub_1C21E38(&Method_EntityScriptValueConvertLogic_ObjectListToStringArray__);
    sub_1C21E38(&System_Func_List_object___string____TypeInfo);
    byte_4BDC0BF = 1;
  }
  if ( !script )
    return defaultValue;
  v7 = (System_Func_object__object__o *)sub_1C22084(System_Func_List_object___string____TypeInfo);
  ...
  return (System_String_array *)EntityScriptUtil__GetScriptValue_object__object_(
                                  ...
                                  (System_Func_TSource__TDestination__o *)v7,
                                  &defaultValue->obj,
                                  (const MethodInfo_2FB659C *)Method_EntityScriptUtil_GetScriptValue_List_object___string_____);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C21E38(&Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__);
    sub_1C21E38(&Method_EntityScriptUtil_GetScriptValue_List_object___List_int______);
    sub_1C21E38(&Method_EntityScriptValueConvertLogic_DoubleObjectListToIntArrayList__);
    sub_1C21E38(&System_Func_List_object___List_int_____TypeInfo);
    sub_1C21E38(&Method_System_Collections_Generic_List_int____ToArray__);
    byte_4BDC0C6 = 1;
  }
  *resValue = 0LL;
  sub_1C21DDC((PartyOrganizationUtility_o *)resValue, 0LL, (int64_t)resValue, (int32_t)method, v4, v5, v6, v7);
  if ( !script
    || !System_Collections_Generic_Dictionary_object__object___ContainsKey(
          (System_Collections_Generic_Dictionary_object__object__o *)script,
          (Il2CppObject *)key,
  ...
  v11 = (System_Func_object__object__o *)sub_1C22084(System_Func_List_object___List_int_____TypeInfo);
  ...
  ScriptValue_object__object = EntityScriptUtil__GetScriptValue_object__object_(
                                 ...
                                 0LL,
                                 (const MethodInfo_2FB659C *)Method_EntityScriptUtil_GetScriptValue_List_object___List_int______);
  ...
  *resValue = (System_Int32_array_array *)v19;
  sub_1C21DDC((PartyOrganizationUtility_o *)resValue, (int64_t)v19, v13, v14, v15, v16, v17, v18);
  return 1;
}
        ...
        const MethodInfo *method)
{
  ...
  *resValue = IntArray;
  sub_1C21DDC((PartyOrganizationUtility_o *)resValue, (int64_t)IntArray, v6, v7, v8, v9, v10, v11);
  return IntArray != 0LL;
}