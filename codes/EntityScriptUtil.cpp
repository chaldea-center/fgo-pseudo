        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C56885 & 1) == 0 )
  {
    sub_1C3E564(&Method_EntityScriptUtil_GetScriptValue_List_object___List_float____);
    sub_1C3E564(&Method_EntityScriptValueConvertLogic_ObjectListToFloatList__);
    sub_1C3E564(&System_Func_List_object___List_float___TypeInfo);
    sub_1C3E564(&Method_System_Collections_Generic_List_float__ToArray__);
    byte_4C56885 = 1;
  }
  if ( !script )
    return defaultArray;
  v7 = (System_Func_object__object__o *)sub_1C3E7B0(System_Func_List_object___List_float___TypeInfo);
  ...
  result = (System_Single_array *)EntityScriptUtil__GetScriptValue_object__object_(
                                    ...
                                    0,
                                    (const MethodInfo_3100208 *)Method_EntityScriptUtil_GetScriptValue_List_object___List_float____);
  if ( result )
        ...
        const MethodInfo *method)
{
  if ( (byte_4C56880 & 1) == 0 )
  {
    sub_1C3E564(&Method_BasicHelper_GetValue_double___);
    byte_4C56880 = 1;
  }
  if ( script )
    return BasicHelper__GetValue_double_(
             ...
             key,
             defaultValue,
             (const MethodInfo_30E720C *)Method_BasicHelper_GetValue_double___);
  return defaultValue;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !script )
    return defaultValue;
  v7 = (System_Func_object__object__o *)sub_1C3E7B0(System_Func_List_object___List_int___TypeInfo);
...
Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_o EntityScriptUtil__GetScriptValue___Il2CppFullySharedGenericType____Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_3100368 *method)
{
  Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_c *klass; // x21
  const MethodInfo_3100368_RGCTXs *rgctx_data; // x24
  ...
  _QWORD *v15; // x0
  __int64 v16; // x1
  const MethodInfo_3100368_RGCTXs *v17; // x8
...
LABEL_15:
  ...
  if ( (*(&_2_TSource->_2.bitflags2 + 2) & 1) == 0 )
    _2_TSource = (Il2CppClass *)sub_1C8EC78(v12);
  v15 = (_QWORD *)sub_1C3E6B0(v13, _2_TSource, v11);
  if ( !v27 )
    sub_1C3E7C0(v15, v16);
...
System_Nullable_int__o EntityScriptUtil__GetScriptValue_long__Nullable_int__(
        ...
        const MethodInfo_31000A0 *method)
{
  __int64 v10; // x0
  __int64 v11; // x1
  __int64 v12; // x2
  __int64 v13; // x3
  long double v14; // q0
  const MethodInfo_31000A0_RGCTXs *rgctx_data; // x8
  ...
  if ( script )
  {
    ...
    if ( (v10 & 1) != 0 )
    {
      ...
      else
      {
        ...
        v23 = sub_1C3E578(&System_InvalidCastException_TypeInfo);
...
Il2CppObject *EntityScriptUtil__GetScriptValue_object__object_(
        ...
        const MethodInfo_3100208 *method)
{
  _BOOL8 v10; // x0
  __int64 v11; // x1
  long double v12; // q0
  ...
  if ( script )
  {
    ...
    if ( v10 )
    {
      ...
      if ( (*(&_2_TSource->_2.bitflags2 + 2) & 1) == 0 )
        _2_TSource = (Il2CppClass *)sub_1C8EC78(v12);
      if ( v13 && !sub_1C3E6A0(v13, _2_TSource) )
        sub_1C3EA80(v13);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C5687D & 1) == 0 )
  {
    sub_1C3E564(&Method_EntityScriptUtil_GetScriptValue_List_object___string_____);
    sub_1C3E564(&Method_EntityScriptValueConvertLogic_ObjectListToStringArray__);
    sub_1C3E564(&System_Func_List_object___string____TypeInfo);
    byte_4C5687D = 1;
  }
  if ( !script )
    return defaultValue;
  v7 = (System_Func_object__object__o *)sub_1C3E7B0(System_Func_List_object___string____TypeInfo);
  ...
  return (System_String_array *)EntityScriptUtil__GetScriptValue_object__object_(
                                  ...
                                  (System_Func_TSource__TDestination__o *)v7,
                                  &defaultValue->obj,
                                  (const MethodInfo_3100208 *)Method_EntityScriptUtil_GetScriptValue_List_object___string_____);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C3E564(&Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__);
    sub_1C3E564(&Method_EntityScriptUtil_GetScriptValue_List_object___List_int______);
    sub_1C3E564(&Method_EntityScriptValueConvertLogic_DoubleObjectListToIntArrayList__);
    sub_1C3E564(&System_Func_List_object___List_int_____TypeInfo);
    sub_1C3E564(&Method_System_Collections_Generic_List_int____ToArray__);
    byte_4C56884 = 1;
  }
  *resValue = 0;
  sub_1C3E508((CGThumbnailListItem_o *)resValue, 0, (int32_t)resValue, method);
  if ( !script
    || !System_Collections_Generic_Dictionary_object__object___ContainsKey(
          (System_Collections_Generic_Dictionary_object__object__o *)script,
          (Il2CppObject *)key,
  ...
  v7 = (System_Func_object__object__o *)sub_1C3E7B0(System_Func_List_object___List_int_____TypeInfo);
  ...
  ScriptValue_object__object = EntityScriptUtil__GetScriptValue_object__object_(
                                 ...
                                 (System_Func_TSource__TDestination__o *)v7,
                                 0,
                                 (const MethodInfo_3100208 *)Method_EntityScriptUtil_GetScriptValue_List_object___List_int______);
  ...
  *resValue = (System_Int32_array_array *)v11;
  sub_1C3E508((CGThumbnailListItem_o *)resValue, (int32_t)v11, v9, v10);
  return 1;
}
        ...
        const MethodInfo *method)
{
  ...
  *resValue = IntArray;
  sub_1C3E508((CGThumbnailListItem_o *)resValue, (int32_t)IntArray, v6, v7);
  return IntArray != 0;
}