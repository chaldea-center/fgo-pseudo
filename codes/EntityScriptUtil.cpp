        ...
        const MethodInfo *method)
{
  if ( (byte_49FE0AB & 1) == 0 )
  {
    sub_1B64870(&Method_BasicHelper_GetValue_double___, key);
    byte_49FE0AB = 1;
  }
  if ( script )
    return BasicHelper__GetValue_double_(
             ...
             key,
             defaultValue,
             (const MethodInfo_2E2990C *)Method_BasicHelper_GetValue_double___);
  return defaultValue;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE0AD & 1) == 0 )
  {
    sub_1B64870(&Method_EntityScriptUtil_GetScriptValue_List_object___List_int____, key);
    sub_1B64870(&Method_EntityScriptValueConvertLogic_ObjectListToIntList__, v7);
    sub_1B64870(&System_Func_List_object___List_int___TypeInfo, v8);
    sub_1B64870(&Method_System_Collections_Generic_List_int__ToArray__, v9);
    byte_49FE0AD = 1;
  }
  if ( !script )
    return defaultValue;
  v10 = (System_Func_object__object__o *)sub_1B64ABC(System_Func_List_object___List_int___TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE0AE & 1) == 0 )
  {
    sub_1B64870(&Method_System_Array_Empty_int___, key);
    byte_49FE0AE = 1;
  }
        ...
        const MethodInfo *method)
{
  if ( (byte_49FE0AA & 1) == 0 )
  {
    sub_1B64870(&Method_BasicHelper_GetValue_long___, key);
    byte_49FE0AA = 1;
  }
  if ( script )
...
Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_o __fastcall EntityScriptUtil__GetScriptValue___Il2CppFullySharedGenericType____Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_2E444F4 *method)
{
  Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_c *klass; // x21
  const MethodInfo_2E444F4_RGCTXs *rgctx_data; // x24
  ...
  _QWORD *v14; // x0
  __int64 v15; // x1
  const MethodInfo_2E444F4_RGCTXs *v16; // x8
...
LABEL_15:
  ...
  if ( (BYTE5(_2_TSource->vtable[0].methodPtr) & 1) == 0 )
    _2_TSource = (Il2CppClass *)sub_1BB674C(method->rgctx_data->_2_TSource);
  v14 = (_QWORD *)sub_1B649BC(v12, _2_TSource, v11);
  if ( !v26 )
    sub_1B64ACC(v14, v15);
...
System_Nullable_int__o __fastcall EntityScriptUtil__GetScriptValue_long__Nullable_int__(
        ...
        const MethodInfo_2E4422C *method)
{
  __int64 v10; // x0
  __int64 v11; // x1
  __int64 v12; // x2
  __int64 v13; // x3
  const MethodInfo_2E4422C_RGCTXs *rgctx_data; // x8
  ...
  if ( script )
  {
    ...
    if ( (v10 & 1) != 0 )
    {
      ...
      {
        v10 = sub_1BB674C(_2_TSource);
        _2_TSource = v10;
      }
      if ( !v15 )
        sub_1B64ACC(v10, _2_TSource);
      ...
      else
      {
        ...
        v22 = sub_1B64884(&System_InvalidCastException_TypeInfo);
...
Il2CppObject *__fastcall EntityScriptUtil__GetScriptValue_object__object_(
        ...
        const MethodInfo_2E44394 *method)
{
  _BOOL8 v10; // x0
  __int64 v11; // x1
  ...
  if ( script )
  {
    ...
    if ( v10 )
    {
      ...
      _2_TSource = method->rgctx_data->_2_TSource;
      if ( (BYTE5(_2_TSource->vtable[0].methodPtr) & 1) == 0 )
        _2_TSource = (Il2CppClass *)sub_1BB674C(_2_TSource);
      if ( v12 && !sub_1B649AC(v12, _2_TSource) )
        sub_1B64D8C(v12);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE0A8 & 1) == 0 )
  {
    sub_1B64870(&Method_EntityScriptUtil_GetScriptValue_List_object___string_____, key);
    sub_1B64870(&Method_EntityScriptValueConvertLogic_ObjectListToStringArray__, v7);
    sub_1B64870(&System_Func_List_object___string____TypeInfo, v8);
    byte_49FE0A8 = 1;
  }
  if ( !script )
    return defaultValue;
  v9 = (System_Func_object__object__o *)sub_1B64ABC(System_Func_List_object___string____TypeInfo);
  ...
  return (System_String_array *)EntityScriptUtil__GetScriptValue_object__object_(
                                  ...
                                  &defaultValue->obj,
                                  (const MethodInfo_2E44394 *)Method_EntityScriptUtil_GetScriptValue_List_object___string_____);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE0A9 & 1) == 0 )
  {
    sub_1B64870(&Method_System_Array_Empty_string___, key);
    byte_49FE0A9 = 1;
  }
  ...
  if ( !v7 )
  {
    sub_1BB67A8(Method_System_Array_Empty_string___);
    v7 = v6[7];
  }
  v8 = *(_QWORD *)(v7 + 16);
  if ( (*(_BYTE *)(v8 + 309) & 1) == 0 )
        ...
        const MethodInfo *method)
{
  if ( (byte_49FE0A7 & 1) == 0 )
  {
    sub_1B64870(&Method_BasicHelper_GetValue_string___, key);
    byte_49FE0A7 = 1;
  }
  if ( script )
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B64870(&Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__, key);
    sub_1B64870(&Method_EntityScriptUtil_GetScriptValue_List_object___List_int______, v7);
    sub_1B64870(&Method_EntityScriptValueConvertLogic_DoubleObjectListToIntArrayList__, v8);
    sub_1B64870(&System_Func_List_object___List_int_____TypeInfo, v9);
    sub_1B64870(&Method_System_Collections_Generic_List_int____ToArray__, v10);
    byte_49FE0AF = 1;
  }
  *resValue = 0LL;
  sub_1B64814((ServantStatusBattleListViewItem_o *)resValue, 0, (int32_t)resValue, (int32_t)method);
  if ( !script
    || !System_Collections_Generic_Dictionary_object__object___ContainsKey(
          (System_Collections_Generic_Dictionary_object__object__o *)script,
          (Il2CppObject *)key,
  ...
  v11 = (System_Func_object__object__o *)sub_1B64ABC(System_Func_List_object___List_int_____TypeInfo);
  ...
  ScriptValue_object__object = EntityScriptUtil__GetScriptValue_object__object_(
                                 ...
                                 0LL,
                                 (const MethodInfo_2E44394 *)Method_EntityScriptUtil_GetScriptValue_List_object___List_int______);
  if ( ScriptValue_object__object )
    v15 = System_Collections_Generic_List_object___ToArray(
            ...
            (const MethodInfo_34B15A8 *)Method_System_Collections_Generic_List_int____ToArray__);
  else
    v15 = 0LL;
  *resValue = (System_Int32_array_array *)v15;
  sub_1B64814((ServantStatusBattleListViewItem_o *)resValue, (int32_t)v15, v13, v14);
  return 1;
}
        ...
        const MethodInfo *method)
{
  ...
  *resValue = IntArray;
  sub_1B64814((ServantStatusBattleListViewItem_o *)resValue, (int32_t)IntArray, v6, v7);
  return IntArray != 0LL;
}