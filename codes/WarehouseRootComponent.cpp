...
void WarehouseRootComponent__Init(WarehouseRootComponent_o *this, const MethodInfo *method)
{
  ...
  WarehouseListMenu_CallbackFunc_o *v7; // x23
  __int64 v8; // x0
  __int64 v9; // x1
  int32_t v10; // w1
  WarehouseListMenu_o *v11; // x21
  EventUpValSetupInfo_o *v12; // x20
  WarehouseListMenu_CallbackFunc_o *v13; // x22
  ...
  if ( (byte_59363C4 & 1) == 0 )
  {
    sub_21FFC50(&WarehouseListMenu_CallbackFunc_TypeInfo);
    sub_21FFC50(&Method_WarehouseRootComponent_OnSelectWarehouseList__);
  ...
  if ( !this->fields.state )
  {
    ...
    if ( transitionData )
    {
      v4 = System_String__op_Equality(transitionData->fields.name, (System_String_o *)StringLiteral_13240/*"ServantEquipList"*/, 0);
      warehouseListMenu = this->fields.warehouseListMenu;
      setupInfo = this->fields.setupInfo;
      v7 = (WarehouseListMenu_CallbackFunc_o *)sub_21FFEBC(WarehouseListMenu_CallbackFunc_TypeInfo);
      ...
      if ( v4 )
      {
        if ( warehouseListMenu )
        {
          v10 = 1;
LABEL_12:
          WarehouseListMenu__Open(warehouseListMenu, v10, setupInfo, v7, 0);
          this->fields.transitionData = 0;
          sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&this->fields.transitionData, 0, v14, v15, v16, v17, v18, v19);
          return;
        }
      }
      else if ( warehouseListMenu )
      {
        v10 = 0;
        goto LABEL_12;
      }
    ...
    {
      v11 = this->fields.warehouseListMenu;
      v12 = this->fields.setupInfo;
      v13 = (WarehouseListMenu_CallbackFunc_o *)sub_21FFEBC(WarehouseListMenu_CallbackFunc_TypeInfo);
      WarehouseListMenu_CallbackFunc___ctor(
        v13,
        (Il2CppObject *)this,
        Method_WarehouseRootComponent_OnSelectWarehouseList__,
      ...
      if ( v11 )
      {
        WarehouseListMenu__Open(v11, 0, v12, v13, 0);
        return;
      }
    }
    sub_21FFECC(v8, v9);
...
void WarehouseRootComponent__OnClickBack(WarehouseRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_59363C6 & 1) == 0 )
  {
    sub_21FFC50(&WarehouseListMenu_RequestCallbackFunc_TypeInfo);
    sub_21FFC50(&Method_WarehouseRootComponent_EndClickBackRequest__);
    sub_21FFC50(&Method_WarehouseRootComponent_OnClickBack__);
    byte_59363C6 = 1;
  }
  v3 = Method_WarehouseRootComponent_OnClickBack__;
  if ( (*((_BYTE *)Method_WarehouseRootComponent_OnClickBack__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_21FFC68(Method_WarehouseRootComponent_OnClickBack__);
  v4 = (System_Reflection_MethodBase_o *)sub_21FFC34(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0, 0);
  warehouseListMenu = this->fields.warehouseListMenu;
  v6 = (WarehouseListMenu_RequestCallbackFunc_o *)sub_21FFEBC(WarehouseListMenu_RequestCallbackFunc_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_21FFC50(&WarehouseListMenu_RequestCallbackFunc_TypeInfo);
    sub_21FFC50(&Method_WarehouseRootComponent_EndServantQuestRequest__);
    byte_59363C5 = 1;
  }
  if ( this->fields.state == 1 )
  {
...
void WarehouseRootComponent__beginFinish(WarehouseRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( !warehouseListMenu
    ...
    || (UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)warehouseListMenu, 0, 0),
        (warehouseListMenu = (WarehouseListMenu_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_476E8C0 *)Method_SingletonMonoBehaviour_AtlasManager__get_Instance__)) == 0) )
  {
    sub_21FFECC(warehouseListMenu, method);
  }
...
void WarehouseRootComponent__beginStartUp(WarehouseRootComponent_o *this, Il2CppObject *data, const MethodInfo *method)
{
  ...
  if ( (byte_59363C2 & 1) == 0 )
  {
    ...
    sub_21FFC50(&Method_WarehouseRootComponent_EndLoadCommonBg__);
    byte_59363C2 = 1;
  }
  if ( !data )
  {
...
LABEL_11:
  ...
  if ( data->klass->_2.typeHierarchy[naturalAligment - 1] == v10 )
    ...
    v14 = 0;
LABEL_15:
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)p_transitionData, v14, (System_String_o *)method, v3, v4, v5, v6, v7);
  if ( !*(&BgmManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(BgmManager_TypeInfo, v15, v16);
  ...
  if ( !titleInfo )
    goto LABEL_30;
  TitleInfoControl__setTitleInfo(titleInfo, this->fields.myFSM, 1, 0, 87, 0);
  titleInfo = this->fields.titleInfo;
  if ( !titleInfo )
    goto LABEL_30;
  ...
  v24 = (EventUpValSetupInfo_o *)sub_21FFEBC(EventUpValSetupInfo_TypeInfo);
  EventUpValSetupInfo___ctor_48687632(v24, v23, 0, 0, 0, 0);
  this->fields.setupInfo = v24;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&this->fields.setupInfo, (int32_t)v24, v25, v26, v27, v28, v29, v30);
...
LABEL_30:
  ...
  System_Action___ctor(v32, (Il2CppObject *)this, Method_WarehouseRootComponent_EndLoadCommonBg__, 0);
  if ( !*(&AtlasManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo, v33, v34);
  AtlasManager__LoadUISkin(v32, 2, 1, 0);
}