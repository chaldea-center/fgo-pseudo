...
void __fastcall WarehouseRootComponent__Init(WarehouseRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42AF92A & 1) == 0 )
  {
    sub_B52984(&WarehouseListMenu_CallbackFunc_TypeInfo);
    sub_B52984(&Method_WarehouseRootComponent_OnSelectWarehouseList__);
  ...
  if ( !this->fields.state )
  {
    ...
    if ( transitionData )
    {
      v4 = System_String__op_Equality(transitionData->fields.name, (System_String_o *)StringLiteral_12803/*"ServantEquipList"*/, 0LL);
      warehouseListMenu = this->fields.warehouseListMenu;
      setupInfo = this->fields.setupInfo;
      v7 = v4;
      v8 = (WarehouseListMenu_CallbackFunc_o *)sub_B52A54(WarehouseListMenu_CallbackFunc_TypeInfo);
      ...
      if ( warehouseListMenu )
      {
        ...
        sub_B52920((BattleServantConfConponent_o *)&this->fields.transitionData, 0LL, v16, v17, v18, v19, v20, v21);
        return;
      }
    }
    else
    {
      ...
      v15 = (WarehouseListMenu_CallbackFunc_o *)sub_B52A54(WarehouseListMenu_CallbackFunc_TypeInfo);
      WarehouseListMenu_CallbackFunc___ctor(
        v15,
        (Il2CppObject *)this,
        Method_WarehouseRootComponent_OnSelectWarehouseList__,
...
void __fastcall WarehouseRootComponent__OnClickBack(WarehouseRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42AF92C & 1) == 0 )
  {
    sub_B52984(&WarehouseListMenu_RequestCallbackFunc_TypeInfo);
    sub_B52984(&SoundManager_TypeInfo);
    sub_B52984(&Method_WarehouseRootComponent_EndClickBackRequest__);
    byte_42AF92C = 1;
  }
  ...
  warehouseListMenu = this->fields.warehouseListMenu;
  v4 = (WarehouseListMenu_RequestCallbackFunc_o *)sub_B52A54(WarehouseListMenu_RequestCallbackFunc_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B52984(&WarehouseListMenu_RequestCallbackFunc_TypeInfo);
    sub_B52984(&Method_WarehouseRootComponent_EndServantQuestRequest__);
    byte_42AF92B = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    {
      warehouseListMenu = this->fields.warehouseListMenu;
      v6 = (WarehouseListMenu_RequestCallbackFunc_o *)sub_B52A54(WarehouseListMenu_RequestCallbackFunc_TypeInfo);
      WarehouseListMenu_RequestCallbackFunc___ctor(
        v6,
        (Il2CppObject *)this,
...
void __fastcall WarehouseRootComponent__beginFinish(WarehouseRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( !warehouseListMenu
    ...
    || (UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)warehouseListMenu, 0, 0LL),
        (warehouseListMenu = (WarehouseListMenu_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_AtlasManager__get_Instance__)) == 0LL) )
  {
    sub_B52A5C(warehouseListMenu, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AF928 & 1) == 0 )
  {
    ...
    sub_B52984(&SoundManager_TypeInfo);
    sub_B52984(&Method_WarehouseRootComponent_EndLoadCommonBg__);
    byte_42AF928 = 1;
  }
  if ( data )
  {
  ...
  v18 = (EventUpValSetupInfo_o *)sub_B52A54(EventUpValSetupInfo_TypeInfo);
  EventUpValSetupInfo___ctor_24343028(v18, v17, 0, 0, 0, 0LL);
