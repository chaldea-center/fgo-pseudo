...
void WarehouseRootComponent__Init(WarehouseRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E027CD & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_WarehouseRootComponent_OnSelectWarehouseList__);
  ...
  if ( !this->fields.state )
  {
    ...
    if ( transitionData )
    {
      v4 = System_String__op_Equality(transitionData->fields.name, (System_String_o *)StringLiteral_12863/*"ServantEquipList"*/, 0);
      warehouseListMenu = this->fields.warehouseListMenu;
      setupInfo = this->fields.setupInfo;
      v7 = v4;
      v8 = (WarehouseListMenu_CallbackFunc_o *)sub_1CE694C(WarehouseListMenu_CallbackFunc_TypeInfo);
      ...
      if ( warehouseListMenu )
      {
        ...
        sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.transitionData, 0, v11, v12, v13, v14, v15, v16);
        return;
      }
LABEL_9:
      sub_1CE6958(v9, v10);
    ...
    v19 = (WarehouseListMenu_CallbackFunc_o *)sub_1CE694C(WarehouseListMenu_CallbackFunc_TypeInfo);
    WarehouseListMenu_CallbackFunc___ctor(
      v19,
      (Il2CppObject *)this,
      Method_WarehouseRootComponent_OnSelectWarehouseList__,
...
void WarehouseRootComponent__OnClickBack(WarehouseRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E027CF & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_WarehouseRootComponent_EndClickBackRequest__);
    sub_1CE6700(&Method_WarehouseRootComponent_OnClickBack__);
    byte_4E027CF = 1;
  }
  v3 = Method_WarehouseRootComponent_OnClickBack__;
  if ( (*((_BYTE *)Method_WarehouseRootComponent_OnClickBack__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1CE6718(Method_WarehouseRootComponent_OnClickBack__);
  v4 = (System_Reflection_MethodBase_o *)sub_1CE66E4(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0, 0);
  warehouseListMenu = this->fields.warehouseListMenu;
  v6 = (WarehouseListMenu_RequestCallbackFunc_o *)sub_1CE694C(WarehouseListMenu_RequestCallbackFunc_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&WarehouseListMenu_RequestCallbackFunc_TypeInfo);
    sub_1CE6700(&Method_WarehouseRootComponent_EndServantQuestRequest__);
    byte_4E027CE = 1;
  }
  if ( this->fields.state == 1 )
  {
...
void WarehouseRootComponent__beginFinish(WarehouseRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( !warehouseListMenu
    ...
    || (UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)warehouseListMenu, 0, 0),
        (warehouseListMenu = (WarehouseListMenu_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_AtlasManager__get_Instance__)) == 0) )
  {
    sub_1CE6958(warehouseListMenu, method);
  }
...
void WarehouseRootComponent__beginStartUp(WarehouseRootComponent_o *this, Il2CppObject *data, const MethodInfo *method)
{
  ...
  if ( (byte_4E027CB & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_WarehouseRootComponent_EndLoadCommonBg__);
    byte_4E027CB = 1;
  }
  if ( !data )
  {
...
LABEL_11:
  ...
  if ( data->klass->_2.typeHierarchy[naturalAligment - 1] == v10 )
    ...
    v14 = 0;
LABEL_15:
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)p_transitionData, v14, (int32_t)method, v3, v4, v5, v6, v7);
  ...
  titleInfo = (TitleInfoControl_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !titleInfo )
    goto LABEL_30;
  ...
  v20 = (EventUpValSetupInfo_o *)sub_1CE694C(EventUpValSetupInfo_TypeInfo);
  EventUpValSetupInfo___ctor_42890508(v20, v19, 0, 0, 0, 0);
  this->fields.setupInfo = v20;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.setupInfo, (int32_t)v20, v21, v22, v23, v24, v25, v26);
