void __fastcall RecoverMaster___ctor(RecoverMaster_o *this, const MethodInfo *method)
{
  if ( (byte_42B3A1F & 1) == 0 )
  {
    sub_B52984(&Method_DataMasterBase_RecoverMaster__RecoverEntity__int___ctor__);
    byte_42B3A1F = 1;
  }
  DataMasterBase_WarMaster__WarEntity__int____ctor(
    (DataMasterBase_WarMaster__WarEntity__int__o *)this,
    117,
    (const MethodInfo_23E223C *)Method_DataMasterBase_RecoverMaster__RecoverEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B3A20 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_System_Comparison_RecoverEntity___ctor__);
    sub_B52984(&System_Comparison_RecoverEntity__TypeInfo);
    sub_B52984(&Method_System_Collections_Generic_List_RecoverEntity__Add__);
    sub_B52984(&Method_System_Collections_Generic_List_RecoverEntity__Sort__);
    sub_B52984(&Method_System_Collections_Generic_List_RecoverEntity___ctor__);
    sub_B52984(&System_Collections_Generic_List_RecoverEntity__TypeInfo);
    sub_B52984(&RecoverEntity_TypeInfo);
    sub_B52984(&Method_RecoverMaster___c__getRecvEntityList_b__1_0__);
    sub_B52984(&RecoverMaster___c_TypeInfo);
    byte_42B3A20 = 1;
  }
  v5 = (System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData__o *)sub_B52A54(System_Collections_Generic_List_RecoverEntity__TypeInfo);
  System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData____ctor(
    v5,
    (const MethodInfo_2FF0940 *)Method_System_Collections_Generic_List_RecoverEntity___ctor__);
...
LABEL_10:
        ...
        if ( v6->fields.missionConditionDetailId == RecoverTarget )
          System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData___Add(
            v5,
            v6,
            (const MethodInfo_2FF1604 *)Method_System_Collections_Generic_List_RecoverEntity__Add__);
      }
    }
    else
    {
  ...
  if ( !_9__1_0 )
  {
    ...
    _9__1_0 = (System_Comparison_TitleInfoControl_EventEndTimeInfo__o *)sub_B52A54(System_Comparison_RecoverEntity__TypeInfo);
    System_Comparison_TitleInfoControl_EventEndTimeInfo____ctor(
      _9__1_0,
      v12,
      Method_RecoverMaster___c__getRecvEntityList_b__1_0__,
      (const MethodInfo_2483370 *)Method_System_Comparison_RecoverEntity___ctor__);
...
LABEL_29:
  ...
  System_Collections_Generic_List_TitleInfoControl_EventEndTimeInfo___Sort(
    ...
    (const MethodInfo_2FF36E0 *)Method_System_Collections_Generic_List_RecoverEntity__Sort__);
...
void __fastcall RecoverMaster___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_B52A54(RecoverMaster___c_TypeInfo);
