void ScriptSubLayer___ctor(ScriptSubLayer_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2931B & 1) == 0 )
  {
    sub_1C2D490(&Method_System_Collections_Generic_List_ScriptCharaData___ctor__);
    sub_1C2D490(&System_Collections_Generic_List_ScriptCharaData__TypeInfo);
    byte_4C2931B = 1;
  }
  v3 = (System_Collections_Generic_List_object__o *)sub_1C2D6DC(System_Collections_Generic_List_ScriptCharaData__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v3,
    (const MethodInfo_3789350 *)Method_System_Collections_Generic_List_ScriptCharaData___ctor__);
  this->fields.listCharaData = (struct System_Collections_Generic_List_ScriptCharaData__o *)v3;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.listCharaData, (int32_t)v3, v4, v5);
...
void ScriptSubLayer__CreateEffectController(ScriptSubLayer_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C29317 & 1) == 0 )
  {
    sub_1C2D490(&ScriptActionRenderEffectController_TypeInfo);
    byte_4C29317 = 1;
  }
  ...
  v5 = (ScriptActionRenderEffectController_o *)sub_1C2D6DC(ScriptActionRenderEffectController_TypeInfo);
  ScriptActionRenderEffectController___ctor(v5, material, 0);
  this->fields._effectController_k__BackingField = v5;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields._effectController_k__BackingField, (int32_t)v5, v6, v7);
}


void ScriptSubLayer__CreateRenderTexture(ScriptSubLayer_o *this, const MethodInfo *method)
{
  struct UnityEngine_RenderTexture_o *Temporary_71072008; // x0
  int32_t v4; // w2
  const MethodInfo *v5; // x3
  __int64 v6; // x1
  ...
  if ( (byte_4C29316 & 1) == 0 )
  {
    sub_1C2D490(&StringLiteral_13671/*"TempRenderTexture"*/);
    byte_4C29316 = 1;
  }
  Temporary_71072008 = UnityEngine_RenderTexture__GetTemporary_71072008(1024, 1024, 0, 0, 0);
  this->fields._renderTexture_k__BackingField = Temporary_71072008;
  sub_1C2D434(
    (CGThumbnailListItem_o *)&this->fields._renderTexture_k__BackingField,
    (int32_t)Temporary_71072008,
    v4,
    v5);
  ...
  if ( !renderTexture_k__BackingField
    || (UnityEngine_Object__set_name(renderTexture_k__BackingField, (System_String_o *)StringLiteral_13671/*"TempRenderTexture"*/, 0),
        (renderTexture_k__BackingField = (UnityEngine_Object_o *)this->fields.meshRender) == 0) )
  {
    sub_1C2D6EC(renderTexture_k__BackingField, v6);
  }
...
void ScriptSubLayer__Init(ScriptSubLayer_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C29315 & 1) == 0 )
  {
    sub_1C2D490(&Method_System_Collections_Generic_List_ScriptCharaData__Clear__);
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields._layerKey_k__BackingField, v8, v5, v6);
  ...
  *(_QWORD *)&this->fields._backgroundColor_k__BackingField.fields.r = 0;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields._renderTexture_k__BackingField, 0, v9, v10);
  this->fields._effectController_k__BackingField = 0;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields._effectController_k__BackingField, 0, v11, v12);
...
void ScriptSubLayer__MoveAlphaCharaData(ScriptSubLayer_o *this, float duration, float alpha, const MethodInfo *method)
{
  ...
  if ( (byte_4C29311 & 1) == 0 )
  {
    sub_1C2D490(&Method_System_Collections_Generic_List_Enumerator_ScriptCharaData__Dispose__);
    sub_1C2D490(&Method_System_Collections_Generic_List_Enumerator_ScriptCharaData__MoveNext__);
    sub_1C2D490(&Method_System_Collections_Generic_List_Enumerator_ScriptCharaData__get_Current__);
    sub_1C2D490(&Method_System_Collections_Generic_List_ScriptCharaData__GetEnumerator__);
    sub_1C2D490(&UnityEngine_Object_TypeInfo);
    byte_4C29311 = 1;
  }
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    listCharaData,
    (const MethodInfo_378A67C *)Method_System_Collections_Generic_List_ScriptCharaData__GetEnumerator__);
  while ( System_Collections_Generic_List_Enumerator_object___MoveNext(
            &v10,
            (const MethodInfo_3514508 *)Method_System_Collections_Generic_List_Enumerator_ScriptCharaData__MoveNext__) )
  {
  ...
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v10,
    (const MethodInfo_3514504 *)Method_System_Collections_Generic_List_Enumerator_ScriptCharaData__Dispose__);
}
...
void ScriptSubLayer__RegistCharaData(ScriptSubLayer_o *this, ScriptCharaData_o *charaData, const MethodInfo *method)
{
  ...
  if ( (byte_4C2930E & 1) == 0 )
  {
    sub_1C2D490(&Method_System_Collections_Generic_List_ScriptCharaData__Add__);
    sub_1C2D490(&StringLiteral_12634/*"ScriptRenderSub"*/);
    byte_4C2930E = 1;
  }
  listCharaData = (System_Collections_Generic_List_object__o *)this->fields.listCharaData;
  if ( !listCharaData )
  ...
  else
  {
    ...
    sub_1C2D434((CGThumbnailListItem_o *)(v10 + 4), (int32_t)charaData, (int32_t)method, v3);
  }
  listCharaData = (System_Collections_Generic_List_object__o *)UnityEngine_LayerMask__NameToLayer(
                                                                 (System_String_o *)StringLiteral_12634/*"ScriptRenderSub"*/,
                                                                 0);
  if ( !charaData )
LABEL_10:
    sub_1C2D6EC(listCharaData, charaData);
...
void ScriptSubLayer__RemoveCharaData(ScriptSubLayer_o *this, ScriptCharaData_o *charaData, const MethodInfo *method)
{
  ...
  if ( (byte_4C2930D & 1) == 0 )
  {
    sub_1C2D490(&Method_System_Collections_Generic_List_ScriptCharaData__Remove__);
    byte_4C2930D = 1;
  }
  listCharaData = (System_Collections_Generic_List_object__o *)this->fields.listCharaData;
  if ( !listCharaData )
    sub_1C2D6EC(0, charaData);
  System_Collections_Generic_List_object___Remove(
    listCharaData,
    (Il2CppObject *)charaData,
    (const MethodInfo_378B0AC *)Method_System_Collections_Generic_List_ScriptCharaData__Remove__);
}
    ...
    if ( i.fields._current )
    {
      ...
      if ( v8 )
      {
        ...
        else
        {
          ...
          sub_1C2D434((CGThumbnailListItem_o *)(v15 + 4), (int32_t)current, v10, v11);
        }
      }
    }
  }
...
void ScriptSubLayer__ResetShake(ScriptSubLayer_o *this, const MethodInfo *method)
{
  ...
  if ( !byte_4C20DA1 )
  {
    shakeRoot = (UnityEngine_GameObject_o *)sub_1C2D490(&UnityEngine_Vector3_TypeInfo);
    byte_4C20DA1 = 1;
  }
  if ( !v5 )
LABEL_8:
        ...
        const MethodInfo *method)
{
  ...
  if ( !UnityEngine_Object__op_Equality(edgeMaskSubMaterial_k__BackingField, (UnityEngine_Object_o *)mat, 0) )
  {
    ...
    sub_1C2D434((CGThumbnailListItem_o *)&this->fields._edgeMaskSubMaterial_k__BackingField, (int32_t)mat, v10, v11);
...
void ScriptSubLayer__SetLayerActive(ScriptSubLayer_o *this, const MethodInfo *method)
{
  ...
  v3 = UnityEngine_LayerMask__NameToLayer((System_String_o *)StringLiteral_12634/*"ScriptRenderSub"*/, 0);
...
void ScriptSubLayer__SetLayerKey(ScriptSubLayer_o *this, System_String_o *key, const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields._layerKey_k__BackingField, (int32_t)key, (int32_t)method, v3);
}
...
void ScriptSubLayer__SetMaskLayer(ScriptSubLayer_o *this, ScriptSubLayer_o *maskLayer, const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.subLayerMask, (int32_t)maskLayer, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_9:
    sub_1C2D6EC(subStretchBase, stretchObj);
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C2D490(&UnityEngine_Object_TypeInfo);
    sub_1C2D490(&StringLiteral_19987/*"horizontally"*/);
    sub_1C2D490(&StringLiteral_5989/*"EndExecuteStretch"*/);
    sub_1C2D490(&StringLiteral_19988/*"horizontallyLeft"*/);
    sub_1C2D490(&StringLiteral_19693/*"full"*/);
    sub_1C2D490(&StringLiteral_24651/*"verticalUp"*/);
    sub_1C2D490(&StringLiteral_24647/*"verticalDown"*/);
    sub_1C2D490(&StringLiteral_24643/*"vertical"*/);
    sub_1C2D490(&StringLiteral_19989/*"horizontallyRight"*/);
    byte_4C29314 = 1;
  }
...
LABEL_10:
        ...
        else
        {
          ...
          if ( subStretchBase )
          {
            ...
            if ( v21 )
            {
              ...
              sub_1C2D434((CGThumbnailListItem_o *)&v21->fields.eventReceiver, (int32_t)subStretchBase, v23, v24);
              v25 = StringLiteral_5989/*"EndExecuteStretch"*/;
              v21->fields.callWhenFinished = (struct System_String_o *)StringLiteral_5989/*"EndExecuteStretch"*/;
              sub_1C2D434((CGThumbnailListItem_o *)&v21->fields.callWhenFinished, v25, v26, v27);
      ...
      sub_1C2D6EC(subStretchBase, name);
    }
    ...
    if ( v28 <= 0x70027A90 )
    {
      if ( v28 != 264610898 )
      {
        if ( v28 == 690205847 )
        {
          if ( !System_String__op_Equality(name, (System_String_o *)StringLiteral_24647/*"verticalDown"*/, 0) )
            goto LABEL_10;
          v15 = 1.0;
          v16 = scale;
          z = 1.0;
        ...
        {
          if ( v28 != 1879210640 || !System_String__op_Equality(name, (System_String_o *)StringLiteral_19989/*"horizontallyRight"*/, 0) )
            goto LABEL_10;
          v16 = 1.0;
          v15 = scale;
          z = 1.0;
...
LABEL_47:
      ...
      if ( !System_String__op_Equality(name, (System_String_o *)StringLiteral_19987/*"horizontally"*/, 0) )
        goto LABEL_10;
      v16 = 1.0;
      v15 = scale;
LABEL_43:
    ...
    if ( v28 > 0x8EBB41AE )
    {
      if ( v28 != -454329761 )
      {
        if ( v28 == -8801476 && System_String__op_Equality(name, (System_String_o *)StringLiteral_19693/*"full"*/, 0) )
        {
          z = 1.0;
          v15 = scale;
          v16 = scale;
      ...
      if ( !System_String__op_Equality(name, (System_String_o *)StringLiteral_19988/*"horizontallyLeft"*/, 0) )
        goto LABEL_10;
      v29 = x * scale;
      v30 = 0.0;
      v16 = 1.0;
    ...
    else
    {
      if ( v28 == -2027301573 )
      {
        if ( !System_String__op_Equality(name, (System_String_o *)StringLiteral_24643/*"vertical"*/, 0) )
          goto LABEL_10;
        v15 = 1.0;
        v16 = scale;
        goto LABEL_43;
      }
      if ( v28 != -1900330578 || !System_String__op_Equality(name, (System_String_o *)StringLiteral_24651/*"verticalUp"*/, 0) )
        goto LABEL_10;
      v15 = 1.0;
      v16 = scale;
      v29 = 0.0;
...
void ScriptSubLayer__set_layerKey(ScriptSubLayer_o *this, System_String_o *value, const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields._layerKey_k__BackingField, (int32_t)value, (int32_t)method, v3);
}
