void ScriptSubLayer___ctor(ScriptSubLayer_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C58DEA & 1) == 0 )
  {
    sub_1C3E564(&Method_System_Collections_Generic_List_ScriptCharaData___ctor__);
    sub_1C3E564(&System_Collections_Generic_List_ScriptCharaData__TypeInfo);
    byte_4C58DEA = 1;
  }
  v3 = (System_Collections_Generic_List_object__o *)sub_1C3E7B0(System_Collections_Generic_List_ScriptCharaData__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v3,
    (const MethodInfo_37B4C2C *)Method_System_Collections_Generic_List_ScriptCharaData___ctor__);
  this->fields.listCharaData = (struct System_Collections_Generic_List_ScriptCharaData__o *)v3;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.listCharaData, (int32_t)v3, v4, v5);
...
void ScriptSubLayer__CreateEffectController(ScriptSubLayer_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C58DE6 & 1) == 0 )
  {
    sub_1C3E564(&ScriptActionRenderEffectController_TypeInfo);
    byte_4C58DE6 = 1;
  }
  ...
  v5 = (ScriptActionRenderEffectController_o *)sub_1C3E7B0(ScriptActionRenderEffectController_TypeInfo);
  ScriptActionRenderEffectController___ctor(v5, material, 0);
  this->fields._effectController_k__BackingField = v5;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields._effectController_k__BackingField, (int32_t)v5, v6, v7);
}


void ScriptSubLayer__CreateRenderTexture(ScriptSubLayer_o *this, const MethodInfo *method)
{
  struct UnityEngine_RenderTexture_o *Temporary_71249868; // x0
  int32_t v4; // w2
  const MethodInfo *v5; // x3
  __int64 v6; // x1
  ...
  if ( (byte_4C58DE5 & 1) == 0 )
  {
    sub_1C3E564(&StringLiteral_13685/*"TempRenderTexture"*/);
    byte_4C58DE5 = 1;
  }
  Temporary_71249868 = UnityEngine_RenderTexture__GetTemporary_71249868(1024, 1024, 0, 0, 0);
  this->fields._renderTexture_k__BackingField = Temporary_71249868;
  sub_1C3E508(
    (CGThumbnailListItem_o *)&this->fields._renderTexture_k__BackingField,
    (int32_t)Temporary_71249868,
    v4,
    v5);
  ...
  if ( !renderTexture_k__BackingField
    || (UnityEngine_Object__set_name(renderTexture_k__BackingField, (System_String_o *)StringLiteral_13685/*"TempRenderTexture"*/, 0),
        (renderTexture_k__BackingField = (UnityEngine_Object_o *)this->fields.meshRender) == 0) )
  {
    sub_1C3E7C0(renderTexture_k__BackingField, v6);
  }
...
void ScriptSubLayer__Init(ScriptSubLayer_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C58DE4 & 1) == 0 )
  {
    sub_1C3E564(&Method_System_Collections_Generic_List_ScriptCharaData__Clear__);
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields._layerKey_k__BackingField, v8, v5, v6);
  ...
  *(_QWORD *)&this->fields._backgroundColor_k__BackingField.fields.r = 0;
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields._effectController_k__BackingField, 0, v11, v12);
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.subLayerMask, 0, size, v13);
  meshRender = (ExUIMeshRenderer_o *)this->fields.renderRoot;
  if ( !meshRender )
LABEL_13:
    sub_1C3E7C0(meshRender, v4);
...
void ScriptSubLayer__MoveAlphaCharaData(ScriptSubLayer_o *this, float duration, float alpha, const MethodInfo *method)
{
  ...
  if ( (byte_4C58DE0 & 1) == 0 )
  {
    sub_1C3E564(&Method_System_Collections_Generic_List_Enumerator_ScriptCharaData__Dispose__);
    sub_1C3E564(&Method_System_Collections_Generic_List_Enumerator_ScriptCharaData__MoveNext__);
    sub_1C3E564(&Method_System_Collections_Generic_List_Enumerator_ScriptCharaData__get_Current__);
    sub_1C3E564(&Method_System_Collections_Generic_List_ScriptCharaData__GetEnumerator__);
    sub_1C3E564(&UnityEngine_Object_TypeInfo);
    byte_4C58DE0 = 1;
  }
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    listCharaData,
    (const MethodInfo_37B5F58 *)Method_System_Collections_Generic_List_ScriptCharaData__GetEnumerator__);
  while ( System_Collections_Generic_List_Enumerator_object___MoveNext(
            &v10,
            (const MethodInfo_353FC4C *)Method_System_Collections_Generic_List_Enumerator_ScriptCharaData__MoveNext__) )
  {
  ...
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v10,
    (const MethodInfo_353FC48 *)Method_System_Collections_Generic_List_Enumerator_ScriptCharaData__Dispose__);
}
...
void ScriptSubLayer__RegistCharaData(ScriptSubLayer_o *this, ScriptCharaData_o *charaData, const MethodInfo *method)
{
  ...
  if ( (byte_4C58DDD & 1) == 0 )
  {
    sub_1C3E564(&Method_System_Collections_Generic_List_ScriptCharaData__Add__);
    sub_1C3E564(&StringLiteral_12646/*"ScriptRenderSub"*/);
    byte_4C58DDD = 1;
  }
  listCharaData = (System_Collections_Generic_List_object__o *)this->fields.listCharaData;
  if ( !listCharaData )
  ...
  else
  {
    ...
    sub_1C3E508((CGThumbnailListItem_o *)(v10 + 4), (int32_t)charaData, (int32_t)method, v3);
  }
  listCharaData = (System_Collections_Generic_List_object__o *)UnityEngine_LayerMask__NameToLayer(
                                                                 (System_String_o *)StringLiteral_12646/*"ScriptRenderSub"*/,
                                                                 0);
  if ( !charaData )
LABEL_10:
    sub_1C3E7C0(listCharaData, charaData);
...
void ScriptSubLayer__RemoveCharaData(ScriptSubLayer_o *this, ScriptCharaData_o *charaData, const MethodInfo *method)
{
  ...
  if ( (byte_4C58DDC & 1) == 0 )
  {
    sub_1C3E564(&Method_System_Collections_Generic_List_ScriptCharaData__Remove__);
    byte_4C58DDC = 1;
  }
  listCharaData = (System_Collections_Generic_List_object__o *)this->fields.listCharaData;
  if ( !listCharaData )
    sub_1C3E7C0(0, charaData);
  System_Collections_Generic_List_object___Remove(
    listCharaData,
    (Il2CppObject *)charaData,
    (const MethodInfo_37B6988 *)Method_System_Collections_Generic_List_ScriptCharaData__Remove__);
}
    ...
    if ( i.fields._current )
    {
      ...
      if ( v8 )
      {
        ...
        else
        {
          ...
          sub_1C3E508((CGThumbnailListItem_o *)(v15 + 4), (int32_t)current, v10, v11);
        }
      }
    }
  }
...
void ScriptSubLayer__ResetShake(ScriptSubLayer_o *this, const MethodInfo *method)
{
  ...
  if ( !byte_4C506A1 )
  {
    shakeRoot = (UnityEngine_GameObject_o *)sub_1C3E564(&UnityEngine_Vector3_TypeInfo);
    byte_4C506A1 = 1;
  }
  if ( !v5 )
LABEL_8:
        ...
        const MethodInfo *method)
{
  ...
  if ( !UnityEngine_Object__op_Equality(edgeMaskSubMaterial_k__BackingField, (UnityEngine_Object_o *)mat, 0) )
  {
    ...
    sub_1C3E508((CGThumbnailListItem_o *)&this->fields._edgeMaskSubMaterial_k__BackingField, (int32_t)mat, v10, v11);
...
void ScriptSubLayer__SetLayerActive(ScriptSubLayer_o *this, const MethodInfo *method)
{
  ...
  v3 = UnityEngine_LayerMask__NameToLayer((System_String_o *)StringLiteral_12646/*"ScriptRenderSub"*/, 0);
...
void ScriptSubLayer__SetLayerKey(ScriptSubLayer_o *this, System_String_o *key, const MethodInfo *method)
{
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields._layerKey_k__BackingField, (int32_t)key, (int32_t)method, v3);
}
...
void ScriptSubLayer__SetMaskLayer(ScriptSubLayer_o *this, ScriptSubLayer_o *maskLayer, const MethodInfo *method)
{
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.subLayerMask, (int32_t)maskLayer, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_9:
    sub_1C3E7C0(subStretchBase, stretchObj);
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C3E564(&UnityEngine_Object_TypeInfo);
    sub_1C3E564(&StringLiteral_20020/*"horizontally"*/);
    sub_1C3E564(&StringLiteral_5998/*"EndExecuteStretch"*/);
    sub_1C3E564(&StringLiteral_20021/*"horizontallyLeft"*/);
    sub_1C3E564(&StringLiteral_19726/*"full"*/);
    sub_1C3E564(&StringLiteral_24694/*"verticalUp"*/);
    sub_1C3E564(&StringLiteral_24690/*"verticalDown"*/);
    sub_1C3E564(&StringLiteral_24686/*"vertical"*/);
    sub_1C3E564(&StringLiteral_20022/*"horizontallyRight"*/);
    byte_4C58DE3 = 1;
  }
...
LABEL_10:
        ...
        else
        {
          ...
          if ( subStretchBase )
          {
            ...
            if ( v21 )
            {
              ...
              sub_1C3E508((CGThumbnailListItem_o *)&v21->fields.eventReceiver, (int32_t)subStretchBase, v23, v24);
              v25 = StringLiteral_5998/*"EndExecuteStretch"*/;
              v21->fields.callWhenFinished = (struct System_String_o *)StringLiteral_5998/*"EndExecuteStretch"*/;
              sub_1C3E508((CGThumbnailListItem_o *)&v21->fields.callWhenFinished, v25, v26, v27);
      ...
      sub_1C3E7C0(subStretchBase, name);
    }
    ...
    if ( v28 <= 0x70027A90 )
    {
      if ( v28 != 264610898 )
      {
        if ( v28 == 690205847 )
        {
          if ( !System_String__op_Equality(name, (System_String_o *)StringLiteral_24690/*"verticalDown"*/, 0) )
            goto LABEL_10;
          v15 = 1.0;
          v16 = scale;
          z = 1.0;
        ...
        {
          if ( v28 != 1879210640 || !System_String__op_Equality(name, (System_String_o *)StringLiteral_20022/*"horizontallyRight"*/, 0) )
            goto LABEL_10;
          v16 = 1.0;
          v15 = scale;
          z = 1.0;
...
LABEL_47:
      ...
      if ( !System_String__op_Equality(name, (System_String_o *)StringLiteral_20020/*"horizontally"*/, 0) )
        goto LABEL_10;
      v16 = 1.0;
      v15 = scale;
LABEL_43:
    ...
    if ( v28 > 0x8EBB41AE )
    {
      if ( v28 != -454329761 )
      {
        if ( v28 == -8801476 && System_String__op_Equality(name, (System_String_o *)StringLiteral_19726/*"full"*/, 0) )
        {
          z = 1.0;
          v15 = scale;
          v16 = scale;
      ...
      if ( !System_String__op_Equality(name, (System_String_o *)StringLiteral_20021/*"horizontallyLeft"*/, 0) )
        goto LABEL_10;
      v29 = x * scale;
      v30 = 0.0;
      v16 = 1.0;
    ...
    else
    {
      if ( v28 == -2027301573 )
      {
        if ( !System_String__op_Equality(name, (System_String_o *)StringLiteral_24686/*"vertical"*/, 0) )
          goto LABEL_10;
        v15 = 1.0;
        v16 = scale;
        goto LABEL_43;
      }
      if ( v28 != -1900330578 || !System_String__op_Equality(name, (System_String_o *)StringLiteral_24694/*"verticalUp"*/, 0) )
        goto LABEL_10;
      v15 = 1.0;
      v16 = scale;
      v29 = 0.0;
...
void ScriptSubLayer__set_layerKey(ScriptSubLayer_o *this, System_String_o *value, const MethodInfo *method)
{
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields._layerKey_k__BackingField, (int32_t)value, (int32_t)method, v3);
}
