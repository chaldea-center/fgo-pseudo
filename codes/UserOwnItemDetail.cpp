...
UserOwnItemInfo_o *UserOwnItemDetail__GetUserOwnInfoByItemId(int32_t itemId, const MethodInfo *method)
{
  ...
  if ( (byte_4CB778C & 1) == 0 )
  {
    *(_QWORD *)&itemId = sub_1C6BA08(&Method_DataMasterBase_ItemMaster__ItemEntity__int__TryGetEntity__);
    byte_4CB778C = 1;
  }
  entity = 0;
         ...
         (const MethodInfo_33F9128 *)Method_DataMasterBase_ItemMaster__ItemEntity__int__TryGetEntity__) )
  {
    ...
    v4 = entity;
    if ( entity )
      return UserOwnItemDetail__GetUserOwnItemInfo_43798604(
               (int32_t)entity[3].klass,
               (ItemEntity_o *)entity,
               ItemMaster,
               v5);
LABEL_8:
    sub_1C6BC60(ItemMaster, v4);
  }
  return 0;
}
        ...
        const MethodInfo *method)
{
  ...
  Il2CppObject *UserOwnItemInfo_43798604; // x0
  int32_t v11; // w2
  ...
  if ( (byte_4CB778D & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_System_Collections_Generic_List_UserOwnItemInfo__Add__);
    sub_1C6BA08(&Method_System_Collections_Generic_List_ItemEntity__GetEnumerator__);
    sub_1C6BA08(&Method_System_Collections_Generic_List_UserOwnItemInfo___ctor__);
    *(_QWORD *)&itemType = sub_1C6BA08(&System_Collections_Generic_List_UserOwnItemInfo__TypeInfo);
    byte_4CB778D = 1;
  }
  ...
  if ( !ItemMaster
    || (EntityListByType = ItemMaster__GetEntityListByType(ItemMaster, v2, 0),
        ...
        v7 = (System_Collections_Generic_List_object__o *)sub_1C6BC54(System_Collections_Generic_List_UserOwnItemInfo__TypeInfo),
        System_Collections_Generic_List_object____ctor(
          v7,
          (const MethodInfo_3800140 *)Method_System_Collections_Generic_List_UserOwnItemInfo___ctor__),
        !EntityListByType) )
  {
    sub_1C6BC60(ItemMaster, v4);
  }
  ...
  while ( 1 )
  {
    ...
    if ( !v20.fields._current )
      sub_1C6BC60(v8, 0);
    UserOwnItemInfo_43798604 = (Il2CppObject *)UserOwnItemDetail__GetUserOwnItemInfo_43798604(
                                                 (int32_t)v20.fields._current[3].klass,
                                                 (ItemEntity_o *)v20.fields._current,
                                                 SelfUserGame,
                                                 v9);
    v13 = UserOwnItemInfo_43798604;
    if ( UserOwnItemInfo_43798604 )
    {
      if ( !v7 )
        sub_1C6BC60(UserOwnItemInfo_43798604, UserOwnItemInfo_43798604);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB778B & 1) == 0 )
  {
    ...
    userGameEntity = (UserGameEntity_o *)sub_1C6BA08(&UserOwnItemInfo_TypeInfo);
    byte_4CB778B = 1;
  }
  v14 = 0;
  entity = 0;
...
LABEL_11:
  ...
  if ( v8 )
  {
    v11 = v14;
    v10 = entity;
    v9 = (UserOwnItemInfo_o *)sub_1C6BC54(UserOwnItemInfo_TypeInfo);
    UserOwnItemInfo___ctor_43798180(v9, (ItemEntity_o *)v10, v11, v12);
  }
  return v9;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB778A & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_System_Collections_Generic_List_ItemEntity__GetEnumerator__);
    sub_1C6BA08(&Method_System_Collections_Generic_List_UserOwnItemInfo___ctor__);
    sub_1C6BA08(&System_Collections_Generic_List_UserOwnItemInfo__TypeInfo);
    sub_1C6BA08(&NetworkManager_TypeInfo);
    sub_1C6BA08(&UserOwnItemInfo_TypeInfo);
    byte_4CB778A = 1;
  }
  memset(&v26, 0, sizeof(v26));
  entity = 0;
  v3 = (System_Collections_Generic_List_object__o *)sub_1C6BC54(System_Collections_Generic_List_UserOwnItemInfo__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v3,
    (const MethodInfo_3800140 *)Method_System_Collections_Generic_List_UserOwnItemInfo___ctor__);
  ...
  while ( 1 )
  {
    ...
    v12 = entity;
    v13 = (UserOwnItemInfo_o *)sub_1C6BC54(UserOwnItemInfo_TypeInfo);
    UserOwnItemInfo___ctor_43798180(v13, current, v12, v14);
    if ( !v3 )
      sub_1C6BC60(v15, v16);
...
// local variable allocation has failed, the output may be wrong!
UserOwnItemInfo_o *UserOwnItemDetail__GetUserOwnItemInfo_43798604(
        int32_t itemType,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB778E & 1) == 0 )
  {
    sub_1C6BA08(&UserOwnFriendPoint_TypeInfo);
    sub_1C6BA08(&UserOwnManaPrism_TypeInfo);
    sub_1C6BA08(&UserOwnQp_TypeInfo);
    sub_1C6BA08(&UserOwnRarePrism_TypeInfo);
    sub_1C6BA08(&UserOwnStone_TypeInfo);
    *(_QWORD *)&itemType = sub_1C6BA08(&UserOwnSvtCoin_TypeInfo);
    byte_4CB778E = 1;
  }
  if ( v6 <= 13 )
  {
    if ( v6 > 4 )
    {
      if ( v6 == 5 )
      {
        v7 = (UserOwnManaPrism_o *)sub_1C6BC54(UserOwnManaPrism_TypeInfo);
        UserOwnManaPrism___ctor(v7, itemEntity, userGameEntity, v14);
        return (UserOwnItemInfo_o *)v7;
      }
      if ( v6 == 13 )
      {
        v7 = (UserOwnManaPrism_o *)sub_1C6BC54(UserOwnFriendPoint_TypeInfo);
    ...
    else
    {
      if ( v6 == 1 )
      {
        v7 = (UserOwnManaPrism_o *)sub_1C6BC54(UserOwnQp_TypeInfo);
        UserOwnQp___ctor((UserOwnQp_o *)v7, itemEntity, userGameEntity, v13);
        return (UserOwnItemInfo_o *)v7;
      }
      if ( v6 == 2 )
      {
        v7 = (UserOwnManaPrism_o *)sub_1C6BC54(UserOwnStone_TypeInfo);
  ...
  else
  {
    if ( v6 == 22 )
    {
      v7 = (UserOwnManaPrism_o *)sub_1C6BC54(UserOwnRarePrism_TypeInfo);
      UserOwnRarePrism___ctor((UserOwnRarePrism_o *)v7, itemEntity, userGameEntity, v12);
      return (UserOwnItemInfo_o *)v7;
    }
    if ( v6 == 29 )
    {
      v7 = (UserOwnManaPrism_o *)sub_1C6BC54(UserOwnSvtCoin_TypeInfo);
      UserOwnSvtCoin___ctor((UserOwnSvtCoin_o *)v7, itemEntity, userGameEntity, v8);
      return (UserOwnItemInfo_o *)v7;
    }
  }
  if ( !itemEntity )
    sub_1C6BC60(*(_QWORD *)&itemType, itemEntity);
