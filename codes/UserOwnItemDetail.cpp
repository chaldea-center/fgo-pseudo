...
UserOwnItemInfo_o *UserOwnItemDetail__GetUserOwnInfoByItemId(int32_t itemId, const MethodInfo *method)
{
  ...
  if ( (byte_4C38E56 & 1) == 0 )
  {
    *(_QWORD *)&itemId = sub_1C32C20(&Method_DataMasterBase_ItemMaster__ItemEntity__int__TryGetEntity__);
    byte_4C38E56 = 1;
  }
  entity = 0;
         ...
         (const MethodInfo_3396884 *)Method_DataMasterBase_ItemMaster__ItemEntity__int__TryGetEntity__) )
  {
    ...
    if ( entity )
      return UserOwnItemDetail__GetUserOwnItemInfo_43449972(
        ...
        const MethodInfo *method)
{
  ...
  Il2CppObject *UserOwnItemInfo_43449972; // x0
  int32_t v10; // w2
  ...
  if ( (byte_4C38E57 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_System_Collections_Generic_List_UserOwnItemInfo__Add__);
    sub_1C32C20(&Method_System_Collections_Generic_List_ItemEntity__GetEnumerator__);
    sub_1C32C20(&Method_System_Collections_Generic_List_UserOwnItemInfo___ctor__);
    *(_QWORD *)&itemType = sub_1C32C20(&System_Collections_Generic_List_UserOwnItemInfo__TypeInfo);
    byte_4C38E57 = 1;
  }
  ...
  if ( !ItemMaster
    || (EntityListByType = ItemMaster__GetEntityListByType(ItemMaster, v2, 0),
        ...
        v6 = (System_Collections_Generic_List_object__o *)sub_1C32E6C(System_Collections_Generic_List_UserOwnItemInfo__TypeInfo),
        System_Collections_Generic_List_object____ctor(
          v6,
          (const MethodInfo_3797F88 *)Method_System_Collections_Generic_List_UserOwnItemInfo___ctor__),
        !EntityListByType) )
  {
    sub_1C32E7C(ItemMaster);
  }
  ...
  while ( 1 )
  {
    ...
    if ( !v19.fields._current )
      sub_1C32E7C(v7);
    UserOwnItemInfo_43449972 = (Il2CppObject *)UserOwnItemDetail__GetUserOwnItemInfo_43449972(
                                                 (int32_t)v19.fields._current[3].klass,
                                                 (ItemEntity_o *)v19.fields._current,
                                                 SelfUserGame,
                                                 v8);
    v12 = UserOwnItemInfo_43449972;
    if ( UserOwnItemInfo_43449972 )
    {
      if ( !v6 )
        sub_1C32E7C(UserOwnItemInfo_43449972);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C38E55 & 1) == 0 )
  {
    ...
    userGameEntity = (UserGameEntity_o *)sub_1C32C20(&UserOwnItemInfo_TypeInfo);
    byte_4C38E55 = 1;
  }
  v13 = 0;
  entity = 0;
...
LABEL_11:
  ...
  if ( v7 )
  {
    v10 = v13;
    v9 = entity;
    v8 = (UserOwnItemInfo_o *)sub_1C32E6C(UserOwnItemInfo_TypeInfo);
    UserOwnItemInfo___ctor_43449548(v8, (ItemEntity_o *)v9, v10, v11);
  }
  return v8;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C38E54 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_System_Collections_Generic_List_ItemEntity__GetEnumerator__);
    sub_1C32C20(&Method_System_Collections_Generic_List_UserOwnItemInfo___ctor__);
    sub_1C32C20(&System_Collections_Generic_List_UserOwnItemInfo__TypeInfo);
    sub_1C32C20(&NetworkManager_TypeInfo);
    sub_1C32C20(&UserOwnItemInfo_TypeInfo);
    byte_4C38E54 = 1;
  }
  memset(&v23, 0, sizeof(v23));
  entity = 0;
  v3 = (System_Collections_Generic_List_object__o *)sub_1C32E6C(System_Collections_Generic_List_UserOwnItemInfo__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v3,
    (const MethodInfo_3797F88 *)Method_System_Collections_Generic_List_UserOwnItemInfo___ctor__);
  ...
  while ( 1 )
  {
    ...
    v10 = entity;
    v11 = (UserOwnItemInfo_o *)sub_1C32E6C(UserOwnItemInfo_TypeInfo);
    UserOwnItemInfo___ctor_43449548(v11, current, v10, v12);
    if ( !v3 )
      sub_1C32E7C(v13);
...
// local variable allocation has failed, the output may be wrong!
UserOwnItemInfo_o *UserOwnItemDetail__GetUserOwnItemInfo_43449972(
        int32_t itemType,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C38E58 & 1) == 0 )
  {
    sub_1C32C20(&UserOwnFriendPoint_TypeInfo);
    sub_1C32C20(&UserOwnManaPrism_TypeInfo);
    sub_1C32C20(&UserOwnQp_TypeInfo);
    sub_1C32C20(&UserOwnRarePrism_TypeInfo);
    sub_1C32C20(&UserOwnStone_TypeInfo);
    *(_QWORD *)&itemType = sub_1C32C20(&UserOwnSvtCoin_TypeInfo);
    byte_4C38E58 = 1;
  }
  if ( v6 <= 13 )
  {
    if ( v6 > 4 )
    {
      if ( v6 == 5 )
      {
        v7 = (UserOwnManaPrism_o *)sub_1C32E6C(UserOwnManaPrism_TypeInfo);
        UserOwnManaPrism___ctor(v7, itemEntity, userGameEntity, v14);
        return (UserOwnItemInfo_o *)v7;
      }
      if ( v6 == 13 )
      {
        v7 = (UserOwnManaPrism_o *)sub_1C32E6C(UserOwnFriendPoint_TypeInfo);
    ...
    else
    {
      if ( v6 == 1 )
      {
        v7 = (UserOwnManaPrism_o *)sub_1C32E6C(UserOwnQp_TypeInfo);
        UserOwnQp___ctor((UserOwnQp_o *)v7, itemEntity, userGameEntity, v13);
        return (UserOwnItemInfo_o *)v7;
      }
      if ( v6 == 2 )
      {
        v7 = (UserOwnManaPrism_o *)sub_1C32E6C(UserOwnStone_TypeInfo);
