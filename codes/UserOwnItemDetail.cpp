...
UserOwnItemInfo_o *UserOwnItemDetail__GetUserOwnInfoByItemId(int32_t itemId, const MethodInfo *method)
{
  ...
  if ( (byte_4D2DE25 & 1) == 0 )
  {
    *(_QWORD *)&itemId = sub_1C94098(&Method_DataMasterBase_ItemMaster__ItemEntity__int__TryGetEntity__);
    byte_4D2DE25 = 1;
  }
  entity = 0;
         ...
         (const MethodInfo_345B50C *)Method_DataMasterBase_ItemMaster__ItemEntity__int__TryGetEntity__) )
  {
    ...
    v4 = entity;
    if ( entity )
      return UserOwnItemDetail__GetUserOwnItemInfo_44425804(
               (int32_t)entity[3].klass,
               (ItemEntity_o *)entity,
               ItemMaster,
               v5);
LABEL_8:
    sub_1C942F0(ItemMaster, v4);
  }
  return 0;
}
        ...
        const MethodInfo *method)
{
  ...
  Il2CppObject *UserOwnItemInfo_44425804; // x0
  int32_t v11; // w2
  int32_t v12; // w3
  ...
  if ( (byte_4D2DE26 & 1) == 0 )
  {
    sub_1C94098(&Method_System_Collections_Generic_List_Enumerator_ItemEntity__Dispose__);
    sub_1C94098(&Method_System_Collections_Generic_List_Enumerator_ItemEntity__MoveNext__);
    sub_1C94098(&Method_System_Collections_Generic_List_Enumerator_ItemEntity__get_Current__);
    sub_1C94098(&Method_System_Collections_Generic_List_UserOwnItemInfo__Add__);
    sub_1C94098(&Method_System_Collections_Generic_List_ItemEntity__GetEnumerator__);
    sub_1C94098(&Method_System_Collections_Generic_List_UserOwnItemInfo___ctor__);
    *(_QWORD *)&itemType = sub_1C94098(&System_Collections_Generic_List_UserOwnItemInfo__TypeInfo);
    byte_4D2DE26 = 1;
  }
  ...
  if ( !ItemMaster
    || (EntityListByType = ItemMaster__GetEntityListByType(ItemMaster, v2, 0),
        ...
        v7 = (System_Collections_Generic_List_object__o *)sub_1C942E4(System_Collections_Generic_List_UserOwnItemInfo__TypeInfo),
        System_Collections_Generic_List_object____ctor(
          v7,
          (const MethodInfo_386A600 *)Method_System_Collections_Generic_List_UserOwnItemInfo___ctor__),
        !EntityListByType) )
  {
    sub_1C942F0(ItemMaster, v4);
  }
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    (const MethodInfo_386B92C *)Method_System_Collections_Generic_List_ItemEntity__GetEnumerator__);
  v24 = v23;
  while ( 1 )
  {
    v8 = System_Collections_Generic_List_Enumerator_object___MoveNext(
           &v24,
           (const MethodInfo_35EC1C0 *)Method_System_Collections_Generic_List_Enumerator_ItemEntity__MoveNext__);
    if ( !v8 )
      break;
    if ( !v24.fields._current )
      sub_1C942F0(v8, 0);
    UserOwnItemInfo_44425804 = (Il2CppObject *)UserOwnItemDetail__GetUserOwnItemInfo_44425804(
                                                 (int32_t)v24.fields._current[3].klass,
                                                 (ItemEntity_o *)v24.fields._current,
                                                 SelfUserGame,
                                                 v9);
    v17 = UserOwnItemInfo_44425804;
    if ( UserOwnItemInfo_44425804 )
    {
      if ( !v7 )
        sub_1C942F0(UserOwnItemInfo_44425804, UserOwnItemInfo_44425804);
  ...
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v24,
    (const MethodInfo_35EC1BC *)Method_System_Collections_Generic_List_Enumerator_ItemEntity__Dispose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2DE24 & 1) == 0 )
  {
    ...
    userGameEntity = (UserGameEntity_o *)sub_1C94098(&UserOwnItemInfo_TypeInfo);
    byte_4D2DE24 = 1;
  }
  v14 = 0;
  entity = 0;
...
LABEL_11:
  ...
  if ( v8 )
  {
    v11 = v14;
    v10 = entity;
    v9 = (UserOwnItemInfo_o *)sub_1C942E4(UserOwnItemInfo_TypeInfo);
    UserOwnItemInfo___ctor_44425380(v9, (ItemEntity_o *)v10, v11, v12);
  }
  return v9;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2DE23 & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_System_Collections_Generic_List_ItemEntity__GetEnumerator__);
    sub_1C94098(&Method_System_Collections_Generic_List_UserOwnItemInfo___ctor__);
    sub_1C94098(&System_Collections_Generic_List_UserOwnItemInfo__TypeInfo);
    sub_1C94098(&NetworkManager_TypeInfo);
    sub_1C94098(&UserOwnItemInfo_TypeInfo);
    byte_4D2DE23 = 1;
  }
  memset(&v30, 0, sizeof(v30));
  entity = 0;
  v3 = (System_Collections_Generic_List_object__o *)sub_1C942E4(System_Collections_Generic_List_UserOwnItemInfo__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v3,
    (const MethodInfo_386A600 *)Method_System_Collections_Generic_List_UserOwnItemInfo___ctor__);
  ...
  while ( 1 )
  {
    ...
    v12 = entity;
    v13 = (UserOwnItemInfo_o *)sub_1C942E4(UserOwnItemInfo_TypeInfo);
    UserOwnItemInfo___ctor_44425380(v13, current, v12, v14);
    if ( !v3 )
      sub_1C942F0(v15, v16);
...
// local variable allocation has failed, the output may be wrong!
UserOwnItemInfo_o *UserOwnItemDetail__GetUserOwnItemInfo_44425804(
        int32_t itemType,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2DE27 & 1) == 0 )
  {
    sub_1C94098(&UserOwnFriendPoint_TypeInfo);
    sub_1C94098(&UserOwnManaPrism_TypeInfo);
    sub_1C94098(&UserOwnQp_TypeInfo);
    sub_1C94098(&UserOwnRarePrism_TypeInfo);
    sub_1C94098(&UserOwnStone_TypeInfo);
    *(_QWORD *)&itemType = sub_1C94098(&UserOwnSvtCoin_TypeInfo);
    byte_4D2DE27 = 1;
  }
  if ( v6 <= 13 )
  {
    if ( v6 > 4 )
    {
      if ( v6 == 5 )
      {
        v7 = (UserOwnManaPrism_o *)sub_1C942E4(UserOwnManaPrism_TypeInfo);
        UserOwnManaPrism___ctor(v7, itemEntity, userGameEntity, v14);
        return (UserOwnItemInfo_o *)v7;
      }
      if ( v6 == 13 )
      {
        v7 = (UserOwnManaPrism_o *)sub_1C942E4(UserOwnFriendPoint_TypeInfo);
    ...
    else
    {
      if ( v6 == 1 )
      {
        v7 = (UserOwnManaPrism_o *)sub_1C942E4(UserOwnQp_TypeInfo);
        UserOwnQp___ctor((UserOwnQp_o *)v7, itemEntity, userGameEntity, v13);
        return (UserOwnItemInfo_o *)v7;
      }
      if ( v6 == 2 )
      {
        v7 = (UserOwnManaPrism_o *)sub_1C942E4(UserOwnStone_TypeInfo);
  ...
  else
  {
    if ( v6 == 22 )
    {
      v7 = (UserOwnManaPrism_o *)sub_1C942E4(UserOwnRarePrism_TypeInfo);
      UserOwnRarePrism___ctor((UserOwnRarePrism_o *)v7, itemEntity, userGameEntity, v12);
      return (UserOwnItemInfo_o *)v7;
    }
    if ( v6 == 29 )
    {
      v7 = (UserOwnManaPrism_o *)sub_1C942E4(UserOwnSvtCoin_TypeInfo);
      UserOwnSvtCoin___ctor((UserOwnSvtCoin_o *)v7, itemEntity, userGameEntity, v8);
      return (UserOwnItemInfo_o *)v7;
    }
  }
  if ( !itemEntity )
    sub_1C942F0(*(_QWORD *)&itemType, itemEntity);
