...
UserOwnItemInfo_o *UserOwnItemDetail__GetUserOwnInfoByItemId(int32_t itemId, const MethodInfo *method)
{
  ...
  if ( (byte_4C28750 & 1) == 0 )
  {
    *(_QWORD *)&itemId = sub_1C2D490(&Method_DataMasterBase_ItemMaster__ItemEntity__int__TryGetEntity__);
    byte_4C28750 = 1;
  }
  entity = 0;
         ...
         (const MethodInfo_3387DE4 *)Method_DataMasterBase_ItemMaster__ItemEntity__int__TryGetEntity__) )
  {
    ...
    v4 = entity;
    if ( entity )
      return UserOwnItemDetail__GetUserOwnItemInfo_43315108(
               (int32_t)entity[3].klass,
               (ItemEntity_o *)entity,
               ItemMaster,
               v5);
LABEL_8:
    sub_1C2D6EC(ItemMaster, v4);
  }
  return 0;
}
        ...
        const MethodInfo *method)
{
  ...
  Il2CppObject *UserOwnItemInfo_43315108; // x0
  int32_t v11; // w2
  ...
  if ( (byte_4C28751 & 1) == 0 )
  {
    sub_1C2D490(&Method_System_Collections_Generic_List_Enumerator_ItemEntity__Dispose__);
    sub_1C2D490(&Method_System_Collections_Generic_List_Enumerator_ItemEntity__MoveNext__);
    sub_1C2D490(&Method_System_Collections_Generic_List_Enumerator_ItemEntity__get_Current__);
    sub_1C2D490(&Method_System_Collections_Generic_List_UserOwnItemInfo__Add__);
    sub_1C2D490(&Method_System_Collections_Generic_List_ItemEntity__GetEnumerator__);
    sub_1C2D490(&Method_System_Collections_Generic_List_UserOwnItemInfo___ctor__);
    *(_QWORD *)&itemType = sub_1C2D490(&System_Collections_Generic_List_UserOwnItemInfo__TypeInfo);
    byte_4C28751 = 1;
  }
  ...
  if ( !ItemMaster
    || (EntityListByType = ItemMaster__GetEntityListByType(ItemMaster, v2, 0),
        ...
        v7 = (System_Collections_Generic_List_object__o *)sub_1C2D6DC(System_Collections_Generic_List_UserOwnItemInfo__TypeInfo),
        System_Collections_Generic_List_object____ctor(
          v7,
          (const MethodInfo_3789350 *)Method_System_Collections_Generic_List_UserOwnItemInfo___ctor__),
        !EntityListByType) )
  {
    sub_1C2D6EC(ItemMaster, v4);
  }
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    (const MethodInfo_378A67C *)Method_System_Collections_Generic_List_ItemEntity__GetEnumerator__);
  v20 = v19;
  while ( 1 )
  {
    v8 = System_Collections_Generic_List_Enumerator_object___MoveNext(
           &v20,
           (const MethodInfo_3514508 *)Method_System_Collections_Generic_List_Enumerator_ItemEntity__MoveNext__);
    if ( !v8 )
      break;
    if ( !v20.fields._current )
      sub_1C2D6EC(v8, 0);
    UserOwnItemInfo_43315108 = (Il2CppObject *)UserOwnItemDetail__GetUserOwnItemInfo_43315108(
                                                 (int32_t)v20.fields._current[3].klass,
                                                 (ItemEntity_o *)v20.fields._current,
                                                 SelfUserGame,
                                                 v9);
    v13 = UserOwnItemInfo_43315108;
    if ( UserOwnItemInfo_43315108 )
    {
      if ( !v7 )
        sub_1C2D6EC(UserOwnItemInfo_43315108, UserOwnItemInfo_43315108);
  ...
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v20,
    (const MethodInfo_3514504 *)Method_System_Collections_Generic_List_Enumerator_ItemEntity__Dispose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2874F & 1) == 0 )
  {
    ...
    userGameEntity = (UserGameEntity_o *)sub_1C2D490(&UserOwnItemInfo_TypeInfo);
    byte_4C2874F = 1;
  }
  v14 = 0;
  entity = 0;
...
LABEL_11:
  ...
  if ( v8 )
  {
    v11 = v14;
    v10 = entity;
    v9 = (UserOwnItemInfo_o *)sub_1C2D6DC(UserOwnItemInfo_TypeInfo);
    UserOwnItemInfo___ctor_43314684(v9, (ItemEntity_o *)v10, v11, v12);
  }
  return v9;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2874E & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_System_Collections_Generic_List_ItemEntity__GetEnumerator__);
    sub_1C2D490(&Method_System_Collections_Generic_List_UserOwnItemInfo___ctor__);
    sub_1C2D490(&System_Collections_Generic_List_UserOwnItemInfo__TypeInfo);
    sub_1C2D490(&NetworkManager_TypeInfo);
    sub_1C2D490(&UserOwnItemInfo_TypeInfo);
    byte_4C2874E = 1;
  }
  memset(&v26, 0, sizeof(v26));
  entity = 0;
  v3 = (System_Collections_Generic_List_object__o *)sub_1C2D6DC(System_Collections_Generic_List_UserOwnItemInfo__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v3,
    (const MethodInfo_3789350 *)Method_System_Collections_Generic_List_UserOwnItemInfo___ctor__);
  ...
  while ( 1 )
  {
    ...
    v12 = entity;
    v13 = (UserOwnItemInfo_o *)sub_1C2D6DC(UserOwnItemInfo_TypeInfo);
    UserOwnItemInfo___ctor_43314684(v13, current, v12, v14);
    if ( !v3 )
      sub_1C2D6EC(v15, v16);
    ...
    else
    {
      ...
      sub_1C2D434((CGThumbnailListItem_o *)(v22 + 4), (int32_t)v13, v17, v18);
    }
  }
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v26,
...
// local variable allocation has failed, the output may be wrong!
UserOwnItemInfo_o *UserOwnItemDetail__GetUserOwnItemInfo_43315108(
        int32_t itemType,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C28752 & 1) == 0 )
  {
    sub_1C2D490(&UserOwnFriendPoint_TypeInfo);
    sub_1C2D490(&UserOwnManaPrism_TypeInfo);
    sub_1C2D490(&UserOwnQp_TypeInfo);
    sub_1C2D490(&UserOwnRarePrism_TypeInfo);
    sub_1C2D490(&UserOwnStone_TypeInfo);
    *(_QWORD *)&itemType = sub_1C2D490(&UserOwnSvtCoin_TypeInfo);
    byte_4C28752 = 1;
  }
  if ( v6 <= 13 )
  {
    if ( v6 > 4 )
    {
      if ( v6 == 5 )
      {
        v7 = (UserOwnManaPrism_o *)sub_1C2D6DC(UserOwnManaPrism_TypeInfo);
        UserOwnManaPrism___ctor(v7, itemEntity, userGameEntity, v14);
        return (UserOwnItemInfo_o *)v7;
      }
      if ( v6 == 13 )
      {
        v7 = (UserOwnManaPrism_o *)sub_1C2D6DC(UserOwnFriendPoint_TypeInfo);
    ...
    else
    {
      if ( v6 == 1 )
      {
        v7 = (UserOwnManaPrism_o *)sub_1C2D6DC(UserOwnQp_TypeInfo);
        UserOwnQp___ctor((UserOwnQp_o *)v7, itemEntity, userGameEntity, v13);
        return (UserOwnItemInfo_o *)v7;
      }
      if ( v6 == 2 )
      {
        v7 = (UserOwnManaPrism_o *)sub_1C2D6DC(UserOwnStone_TypeInfo);
  ...
  else
  {
    if ( v6 == 22 )
    {
      v7 = (UserOwnManaPrism_o *)sub_1C2D6DC(UserOwnRarePrism_TypeInfo);
      UserOwnRarePrism___ctor((UserOwnRarePrism_o *)v7, itemEntity, userGameEntity, v12);
      return (UserOwnItemInfo_o *)v7;
    }
    if ( v6 == 29 )
    {
      v7 = (UserOwnManaPrism_o *)sub_1C2D6DC(UserOwnSvtCoin_TypeInfo);
      UserOwnSvtCoin___ctor((UserOwnSvtCoin_o *)v7, itemEntity, userGameEntity, v8);
      return (UserOwnItemInfo_o *)v7;
    }
  }
  if ( !itemEntity )
    sub_1C2D6EC(*(_QWORD *)&itemType, itemEntity);
