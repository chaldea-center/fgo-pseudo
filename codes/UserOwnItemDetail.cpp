...
UserOwnItemInfo_o *UserOwnItemDetail__GetUserOwnInfoByItemId(int32_t itemId, const MethodInfo *method)
{
  ...
  if ( (byte_4E78C0F & 1) == 0 )
  {
    *(_QWORD *)&itemId = sub_1D0F0B4(&Method_DataMasterBase_ItemMaster__ItemEntity__int__TryGetEntity__);
    byte_4E78C0F = 1;
  }
  entity = 0;
         ...
         (const MethodInfo_3535BC8 *)Method_DataMasterBase_ItemMaster__ItemEntity__int__TryGetEntity__) )
  {
    ...
    v4 = entity;
    if ( entity )
      return UserOwnItemDetail__GetUserOwnItemInfo_44992004(
               (int32_t)entity[3].klass,
               (ItemEntity_o *)entity,
               ItemMaster,
               v5);
LABEL_8:
    sub_1D0F30C(ItemMaster, v4);
  }
  return 0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E78C0E & 1) == 0 )
  {
    ...
    userGameEntity = (UserGameEntity_o *)sub_1D0F0B4(&UserOwnItemInfo_TypeInfo);
    byte_4E78C0E = 1;
  }
  v14 = 0;
  entity = 0;
...
LABEL_11:
  ...
  if ( v8 )
  {
    v11 = v14;
    v10 = entity;
    v9 = (UserOwnItemInfo_o *)sub_1D0F300(UserOwnItemInfo_TypeInfo);
    UserOwnItemInfo___ctor_44991580(v9, (ItemEntity_o *)v10, v11, v12);
  }
  return v9;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E78C0D & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_System_Collections_Generic_List_UserOwnItemInfo__Add__);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_ItemEntity__GetEnumerator__);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_UserOwnItemInfo___ctor__);
    sub_1D0F0B4(&System_Collections_Generic_List_UserOwnItemInfo__TypeInfo);
    sub_1D0F0B4(&NetworkManager_TypeInfo);
    sub_1D0F0B4(&UserOwnItemInfo_TypeInfo);
    byte_4E78C0D = 1;
  }
  memset(&v30, 0, sizeof(v30));
  entity = 0;
  v3 = (System_Collections_Generic_List_object__o *)sub_1D0F300(System_Collections_Generic_List_UserOwnItemInfo__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v3,
    (const MethodInfo_395BBDC *)Method_System_Collections_Generic_List_UserOwnItemInfo___ctor__);
  ...
  while ( 1 )
  {
    ...
    v12 = entity;
    v13 = (UserOwnItemInfo_o *)sub_1D0F300(UserOwnItemInfo_TypeInfo);
    UserOwnItemInfo___ctor_44991580(v13, current, v12, v14);
    if ( !v3 )
      sub_1D0F30C(v15, v16);
...
// local variable allocation has failed, the output may be wrong!
UserOwnItemInfo_o *UserOwnItemDetail__GetUserOwnItemInfo_44992004(
        int32_t itemType,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E78C10 & 1) == 0 )
  {
    sub_1D0F0B4(&UserOwnFriendPoint_TypeInfo);
    sub_1D0F0B4(&UserOwnManaPrism_TypeInfo);
    sub_1D0F0B4(&UserOwnQp_TypeInfo);
    sub_1D0F0B4(&UserOwnRarePrism_TypeInfo);
    sub_1D0F0B4(&UserOwnStone_TypeInfo);
    *(_QWORD *)&itemType = sub_1D0F0B4(&UserOwnSvtCoin_TypeInfo);
    byte_4E78C10 = 1;
  }
  if ( v6 <= 13 )
  {
    if ( v6 > 4 )
    {
      if ( v6 == 5 )
      {
        v7 = (UserOwnManaPrism_o *)sub_1D0F300(UserOwnManaPrism_TypeInfo);
        UserOwnManaPrism___ctor(v7, itemEntity, userGameEntity, v14);
        return (UserOwnItemInfo_o *)v7;
      }
      if ( v6 == 13 )
      {
        v7 = (UserOwnManaPrism_o *)sub_1D0F300(UserOwnFriendPoint_TypeInfo);
    ...
    else
    {
      if ( v6 == 1 )
      {
        v7 = (UserOwnManaPrism_o *)sub_1D0F300(UserOwnQp_TypeInfo);
        UserOwnQp___ctor((UserOwnQp_o *)v7, itemEntity, userGameEntity, v13);
        return (UserOwnItemInfo_o *)v7;
      }
      if ( v6 == 2 )
      {
        v7 = (UserOwnManaPrism_o *)sub_1D0F300(UserOwnStone_TypeInfo);
  ...
  else
  {
    if ( v6 == 22 )
    {
      v7 = (UserOwnManaPrism_o *)sub_1D0F300(UserOwnRarePrism_TypeInfo);
      UserOwnRarePrism___ctor((UserOwnRarePrism_o *)v7, itemEntity, userGameEntity, v12);
      return (UserOwnItemInfo_o *)v7;
    }
    if ( v6 == 29 )
    {
      v7 = (UserOwnManaPrism_o *)sub_1D0F300(UserOwnSvtCoin_TypeInfo);
      UserOwnSvtCoin___ctor((UserOwnSvtCoin_o *)v7, itemEntity, userGameEntity, v8);
      return (UserOwnItemInfo_o *)v7;
    }
  }
  if ( !itemEntity )
    sub_1D0F30C(*(_QWORD *)&itemType, itemEntity);
