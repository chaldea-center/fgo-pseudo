        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB7CBC & 1) == 0 )
  {
    sub_1BAB41C(&EventInfoUserEventPointControl__CountUpAnim_d__25_TypeInfo, addCound);
    byte_4AB7CBC = 1;
  }
  v5 = sub_1BAB668(EventInfoUserEventPointControl__CountUpAnim_d__25_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB7CB8 & 1) == 0 )
  {
    this = (EventInfoUserEventPointControl_o *)sub_1BAB41C(&TerminalPramsManager_TypeInfo, method);
    byte_4AB7CB8 = 1;
  }
...
LABEL_25:
    ...
    if ( v3->fields.isActiveEffect )
    {
      ...
      if ( !byte_4AB496E )
      {
        sub_1BAB41C(&TerminalPramsManager_TypeInfo, oldTotalPoint_k__BackingField);
        byte_4AB496E = 1;
      }
        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    if ( !_4__this )
LABEL_21:
      sub_1BAB678(targetFrameRate, v7);
    v8 = 0;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BAB430(&Method_EventInfoUserEventPointControl__CountUpAnim_d__25_System_Collections_IEnumerator_Reset__);
  sub_1BAB544(v3, v4);
}
