void __fastcall ScriptLogMessage___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B1E31C & 1) == 0 )
  {
    sub_1BCAFF8(&ScriptLogMessage_TypeInfo, v1);
    byte_4B1E31C = 1;
  }
...
void __fastcall ScriptLogMessage___ctor(ScriptLogMessage_o *this, const MethodInfo *method)
{
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.defaultColorTag, v5, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1E30F & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_21049/*"line"*/, v9);
    this = (ScriptLogMessage_o *)sub_1BCAFF8(&StringLiteral_1/*""*/, v10);
    byte_4B1E30F = 1;
  }
...
LABEL_60:
  ...
  if ( System_String__get_Chars(v7, 1, 0LL) == 35 )
  {
    ...
    v16 = System_String__Substring_62496348(v7, 2, v7->fields._stringLength - 3, 0LL);
    this = (ScriptLogMessage_o *)sub_1BCB0A0(char___TypeInfo, 1LL);
    if ( !this )
      goto LABEL_60;
    ...
    if ( LODWORD(this->fields.m_CancellationTokenSource) )
    {
      ...
      if ( !v16 )
        goto LABEL_60;
      this = (ScriptLogMessage_o *)System_String__Split_62499500(v16, (System_Char_array *)this, 0LL);
      if ( !this )
        goto LABEL_60;
...
LABEL_61:
    sub_1BCB25C(this, text, v17);
  }
  if ( System_String__get_Chars(v7, 1, 0LL) == 94 )
  {
    ScriptLogMessage__FetchImageSprite(v8, v28);
    v29 = System_String__Substring_62496348(v7, 2, v7->fields._stringLength - 3, 0LL);
    this = (ScriptLogMessage_o *)sub_1BCB0A0(char___TypeInfo, 1LL);
    if ( !this )
      goto LABEL_60;
    text = (System_String_o *)this;
    ...
    if ( !v29 )
      goto LABEL_60;
    this = (ScriptLogMessage_o *)System_String__Split_62499500(v29, (System_Char_array *)this, 0LL);
    if ( !this )
      goto LABEL_60;
    ...
    if ( v30 <= 1 )
    {
      ...
      if ( LODWORD(this->fields.m_CancellationTokenSource) )
      {
        ...
        if ( !v32 )
          goto LABEL_60;
        this = (ScriptLogMessage_o *)System_String__Split_62499500(
                                       (System_String_o *)v32,
        ...
        else
        {
          ...
          sub_1BCAF9C((CGThumbnailListItem_o *)&analyzeLabel->fields.ruby, (int32_t)RubyLabel, v47, v48);
    ...
    if ( v34 <= 3 )
    {
      if ( (unsigned int)v34 > 2 )
      {
        ...
        if ( LODWORD(this->fields.m_CancellationTokenSource) )
        {
          ...
          if ( !rubyPrefab )
            goto LABEL_60;
          this = (ScriptLogMessage_o *)System_String__Split_62499500(rubyPrefab, (System_Char_array *)this, 0LL);
          if ( !this )
            goto LABEL_60;
          v50 = this;
          if ( LODWORD(this->fields.m_CancellationTokenSource) )
  ...
  else
  {
    if ( System_String__get_Chars(v7, 1, 0LL) != 126 )
    {
      ...
      sub_1BCAF9C((CGThumbnailListItem_o *)&analyzeLabel->fields, (int32_t)MainLabel, v42, v43);
      ScriptMessageLabel__UpdateLabel(
        analyzeLabel,
        &analyzeLabel->fields.main,
        &v8->fields.dispPosition,
    ...
    v37 = System_String__Substring_62496348(v7, 2, v7->fields._stringLength - 3, 0LL);
    this = (ScriptLogMessage_o *)sub_1BCB0A0(char___TypeInfo, 1LL);
    if ( !this )
      goto LABEL_60;
    text = (System_String_o *)this;
    ...
    if ( !v37 )
      goto LABEL_60;
    this = (ScriptLogMessage_o *)System_String__Split_62499500(v37, (System_Char_array *)this, 0LL);
    if ( !this )
      goto LABEL_60;
    v38 = this;
    if ( !LODWORD(this->fields.m_CancellationTokenSource) )
    ...
    if ( SLODWORD(v38->fields.m_CancellationTokenSource) >= 2 )
      ...
      p_mainPrefab = (System_String_o **)&StringLiteral_21049/*"line"*/;
        ...
        const MethodInfo *method)
{
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.voiceAssetName, (int32_t)assetName, (int32_t)objectName, method);
  v5->fields.voiceObjectName = objectName;
  v5 = (ScriptLogMessage_o *)((char *)v5 + 216);
  sub_1BCAF9C((CGThumbnailListItem_o *)v5, (int32_t)objectName, v8, v9);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ScriptLogMessage__AddText_43844872(
        ScriptLogMessage_o *this,
        System_String_o *text,
        bool isLineHead,
        int32_t lineLength,
...
void __fastcall ScriptLogMessage__ClearTalkName(ScriptLogMessage_o *this, const MethodInfo *method)
{
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.talkName, v5, v2, v3);
}
...
UISprite_o *__fastcall ScriptLogMessage__FetchImageSprite(ScriptLogMessage_o *this, const MethodInfo *method)
{
  ...
  if ( !byte_4B16191 )
  {
    this = (ScriptLogMessage_o *)sub_1BCAFF8(&UnityEngine_Vector3_TypeInfo, method);
    byte_4B16191 = 1;
  }
  if ( !v4 )
    goto LABEL_10;
...
int32_t __fastcall ScriptLogMessage__GetDefaultFontSize(ScriptLogMessage_o *this, const MethodInfo *method)
{
  ...
  return ScriptMessageLabel__GetFontSize((System_String_o *)StringLiteral_856/*"-"*/, defaultFontSize, 0LL);
}
...
void __fastcall ScriptLogMessage__Init(ScriptLogMessage_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1E30E & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_UnityEngine_GameObject_GetComponent_UILabel___, v3);
    sub_1BCAFF8(&Method_UnityEngine_GameObject_GetComponent_UISprite___, v4);
    ...
    sub_1BCAFF8(&StringLiteral_856/*"-"*/, v8);
    sub_1BCAFF8(&StringLiteral_25135/*"■"*/, v9);
    byte_4B1E30E = 1;
  }
  if ( !this->fields.isInit )
  {
    ...
    this->fields.defaultFontSize = ScriptMessageLabel__GetFontSize(
                                     (System_String_o *)StringLiteral_856/*"-"*/,
                                     defaultFontSize,
                                     0LL);
    v11 = (ScriptMessageLabel_o *)sub_1BCB244(ScriptMessageLabel_TypeInfo);
    ScriptMessageLabel___ctor(v11, 0LL);
    this->fields.analyzeLabel = v11;
    p_analyzeLabel = &this->fields.analyzeLabel;
    sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.analyzeLabel, (int32_t)v11, v13, v14);
    ...
    sub_1BCAF9C((CGThumbnailListItem_o *)&v20->fields, (int32_t)transform, v21, v22);
    if ( !*p_analyzeLabel )
      goto LABEL_47;
    ...
    sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.defaultFontType, (int32_t)trueTypeFont, v24, v25);
    this->fields.fontType = trueTypeFont;
    sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.fontType, (int32_t)trueTypeFont, v26, v27);
    transform = (UnityEngine_GameObject_o *)UnityEngine_Object__Instantiate_object_(
    ...
    sub_1BCAF9C((CGThumbnailListItem_o *)&v30->fields.ruby, (int32_t)transform, v31, v32);
    transform = (UnityEngine_GameObject_o *)UnityEngine_Object__Instantiate_object_(
    ...
    sub_1BCAF9C((CGThumbnailListItem_o *)&v35->fields.image, (int32_t)transform, v36, v37);
    transform = (UnityEngine_GameObject_o *)UnityEngine_Object__Instantiate_object_(
    ...
    if ( !v40
      || (v40->fields.playVoice = (struct UIButton_o *)transform,
          sub_1BCAF9C((CGThumbnailListItem_o *)&v40->fields.playVoice, (int32_t)transform, v41, v42),
...
LABEL_47:
    ...
    UILabel__set_text(main, (System_String_o *)StringLiteral_25135/*"■"*/, 0LL);
    ...
    UILabel__set_text(ruby, (System_String_o *)StringLiteral_25135/*"■"*/, 0LL);
...
void __fastcall ScriptLogMessage__Quit(ScriptLogMessage_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.isInit )
  {
    ...
    *((_BYTE *)p_analyzeLabel + 52) = 0;
    ...
    sub_1BCAF9C((CGThumbnailListItem_o *)p_analyzeLabel, 0, v5, v6);
    this->fields.defaultFontType = 0LL;
    sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.defaultFontType, 0, v7, v8);
    this->fields.fontType = 0LL;
    sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.fontType, 0, v9, v10);
  }
}
...
void __fastcall ScriptLogMessage__ReleasePlayVoice(ScriptLogMessage_o *this, const MethodInfo *method)
{
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.voiceAssetName, v5, v2, v3);
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)p_voiceObjectName, v6, v8, v9);
...
void __fastcall ScriptLogMessage__ReturnText(ScriptLogMessage_o *this, const MethodInfo *method)
{
  ...
  this->fields.defaultColorTag = (struct System_String_o *)StringLiteral_1/*""*/;
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.defaultColorTag, v10, v4, v5);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1E318 & 1) == 0 )
  {
    sub_1BCAFF8(&ScriptLogMessage_TypeInfo, isLineHead);
    byte_4B1E318 = 1;
  }
  if ( isLineHead )
  {
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BCB254(backLogDialog, assetName);
  }
        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.talkName, (int32_t)text, v6, v7);
    fontType = this->fields.fontType;
    defaultFontType = this->fields.defaultFontType;
    this->fields.fontType = defaultFontType;
    sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.fontType, (int32_t)defaultFontType, v10, v11);
    ...
    sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.fontType, (int32_t)fontType, v17, v18);
  }
  return 1;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1E310 & 1) == 0 )
  {
    sub_1BCAFF8(&ScriptLogMessage_ProcAddLabel2_TypeInfo, txt);
    sub_1BCAFF8(&ScriptLogMessage_ProcAddLabel_TypeInfo, v9);
    sub_1BCAFF8(&ScriptMessageLabel_TypeInfo, v10);
    sub_1BCAFF8(&ScriptReplaceString_TypeInfo, v11);
    sub_1BCAFF8(&System_Text_StringBuilder_TypeInfo, v12);
    sub_1BCAFF8(&Method_ScriptLogMessage___c__DisplayClass54_0__UpdateLabels_b__0__, v13);
    sub_1BCAFF8(&Method_ScriptLogMessage___c__DisplayClass54_0__UpdateLabels_b__1__, v14);
    sub_1BCAFF8(&ScriptLogMessage___c__DisplayClass54_0_TypeInfo, v15);
    sub_1BCAFF8(&StringLiteral_23074/*"servantName"*/, v16);
    sub_1BCAFF8(&StringLiteral_15689/*"[-]"*/, v17);
    sub_1BCAFF8(&StringLiteral_19911/*"i"*/, v18);
    sub_1BCAFF8(&StringLiteral_15888/*"[~1]"*/, v19);
    sub_1BCAFF8(&StringLiteral_15824/*"[^"*/, v20);
    sub_1BCAFF8(&StringLiteral_22712/*"r"*/, v21);
    sub_1BCAFF8(&StringLiteral_18771/*"effectmessage"*/, v22);
    sub_1BCAFF8(&StringLiteral_21049/*"line"*/, v23);
    sub_1BCAFF8(&StringLiteral_20104/*"image"*/, v24);
    sub_1BCAFF8(&StringLiteral_15670/*"["*/, v25);
    sub_1BCAFF8(&StringLiteral_15887/*"[~"*/, v26);
    sub_1BCAFF8(&StringLiteral_15923/*"]"*/, v27);
    byte_4B1E310 = 1;
  }
  text = 0LL;
  v28 = sub_1BCB244(ScriptLogMessage___c__DisplayClass54_0_TypeInfo);
  ...
  *(_BYTE *)(v28 + 32) = isFoward;
  v33 = (System_Text_StringBuilder_o *)sub_1BCB244(System_Text_StringBuilder_TypeInfo);
  System_Text_StringBuilder___ctor(v33, 0LL);
  *(_QWORD *)(v28 + 16) = v33;
  v34 = (System_Text_StringBuilder_o **)(v28 + 16);
  sub_1BCAF9C((CGThumbnailListItem_o *)(v28 + 16), (int32_t)v33, v35, v36);
  if ( enforceColor )
  {
    this->fields.defaultColorTag = enforceColor;
    sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.defaultColorTag, (int32_t)enforceColor, v37, v38);
  }
  ...
  *(_QWORD *)(v28 + 40) = defaultColorTag;
  sub_1BCAF9C((CGThumbnailListItem_o *)(v28 + 40), (int32_t)defaultColorTag, v37, v38);
  v41 = sub_1BCB244(ScriptLogMessage_ProcAddLabel_TypeInfo);
  ScriptLogMessage_ProcAddLabel___ctor(
    ...
    v42);
  v85 = (ScriptLogMessage_ProcAddLabel2_o *)sub_1BCB244(ScriptLogMessage_ProcAddLabel2_TypeInfo);
  ...
  while ( 1 )
  {
    if ( System_String__get_Chars(txt, v44, 0LL) != 91 )
    {
      ...
      if ( !v55 )
        goto LABEL_84;
      v46 = v44 + 1;
      Chars = (__int64)System_Text_StringBuilder__Append_62536696(v55, Chars, 0LL);
      goto LABEL_37;
    }
    if ( !ScriptMessageLabel_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(ScriptMessageLabel_TypeInfo);
    ...
    if ( (unsigned __int16)Chars == 37 )
    {
      ...
      v49 = System_String__Substring_62496348(txt, v44 + 2, v45 + v48 - 2, 0LL);
...
LABEL_33:
      ...
      sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.defaultColorTag, (int32_t)v59, v53, v54);
      v62 = *(_BYTE *)(v28 + 32);
      v63 = this;
      v64 = v60;
LABEL_34:
      ...
      *(_QWORD *)(v28 + 40) = v67;
LABEL_35:
      sub_1BCAF9C((CGThumbnailListItem_o *)(v28 + 40), (int32_t)v67, v65, v66);
      goto LABEL_36;
    }
    Chars = System_String__get_Chars(txt, v46, 0LL);
    if ( (unsigned __int16)Chars == 38 )
    {
      ...
      if ( !byte_4B1E162 )
      {
        sub_1BCAFF8(&ScriptReplaceString_TypeInfo, v56);
        byte_4B1E162 = 1;
      }
    ...
    if ( (unsigned __int16)Chars == 35 )
    {
      if ( !v41 )
        goto LABEL_84;
      (*(void (__fastcall **)(_QWORD, _QWORD))(v41 + 24))(*(_QWORD *)(v41 + 64), *(_QWORD *)(v41 + 40));
      Chars = (__int64)System_String__Substring_62496348(txt, v44, v45 + v48 + 1, 0LL);
      goto LABEL_51;
    }
    Chars = System_String__get_Chars(txt, v46, 0LL);
...
LABEL_37:
  ...
  Chars = System_String__Equals_62485728(v68, (System_String_o *)StringLiteral_18771/*"effectmessage"*/, 0LL);
  if ( (Chars & 1) != 0 )
    goto LABEL_36;
  Chars = System_String__Equals_62485728(v68, (System_String_o *)StringLiteral_19911/*"i"*/, 0LL);
  if ( (Chars & 1) != 0 )
  {
    if ( !v41 )
      goto LABEL_84;
    ...
    v70 = v45 + v48 - 3;
LABEL_49:
    v71 = System_String__Substring_62496348(txt, v69, v70, 0LL);
    v72 = &StringLiteral_15824/*"[^"*/;
LABEL_50:
    Chars = (__int64)System_String__Concat_62488672(
                       (System_String_o *)*v72,
                       v71,
...
LABEL_53:
  ...
  Chars = System_String__Equals_62485728(v68, (System_String_o *)StringLiteral_22712/*"r"*/, 0LL);
  if ( (Chars & 1) != 0 )
  {
    if ( !v41 )
      goto LABEL_84;
    ...
    if ( enforceColora )
    {
      *p_defaultColorTag = enforceColora;
      sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.defaultColorTag, (int32_t)enforceColora, v65, v66);
    }
    v67 = *p_defaultColorTag;
    *(_QWORD *)(v28 + 40) = *p_defaultColorTag;
    goto LABEL_35;
  }
  Chars = System_String__Equals_62485728(v68, (System_String_o *)StringLiteral_23074/*"servantName"*/, 0LL);
  if ( (Chars & 1) != 0 )
  {
    if ( !v41 )
      goto LABEL_84;
    (*(void (__fastcall **)(_QWORD, _QWORD))(v41 + 24))(*(_QWORD *)(v41 + 64), *(_QWORD *)(v41 + 40));
    v76 = System_String__Substring_62496348(txt, v44 + 12, v45 + v48 - 12, 0LL);
    if ( !ScriptMessageLabel_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(ScriptMessageLabel_TypeInfo);
    ...
    sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.defaultColorTag, (int32_t)v78, v80, v81);
  ...
  Chars = System_String__StartsWith(v68, (System_String_o *)StringLiteral_21049/*"line"*/, 0LL);
  if ( (Chars & 1) != 0 )
  {
    if ( !v41 )
      goto LABEL_84;
    (*(void (__fastcall **)(_QWORD, _QWORD))(v41 + 24))(*(_QWORD *)(v41 + 64), *(_QWORD *)(v41 + 40));
    Chars = (__int64)System_String__Substring_62496348(txt, v44 + 5, v45 + v48 - 5, 0LL);
    if ( !Chars )
      goto LABEL_84;
    if ( *(int *)(Chars + 16) >= 1 )
    {
      v71 = System_String__Trim((System_String_o *)Chars, 0LL);
      v72 = &StringLiteral_15887/*"[~"*/;
      goto LABEL_50;
    }
    v73 = v85;
    if ( !v85 )
      goto LABEL_84;
    v74 = StringLiteral_15888/*"[~1]"*/;
    goto LABEL_53;
  }
  if ( v48 < txt->fields._stringLength )
  {
    text = System_String__Substring_62496348(txt, v44, v45 + v48 + 1, 0LL);
    if ( !ScriptMessageLabel_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(ScriptMessageLabel_TypeInfo);
    ...
    if ( !*v34 )
      goto LABEL_84;
    Chars = (__int64)System_Text_StringBuilder__Append_62534368((System_Text_StringBuilder_o *)Chars, text, 0LL);
    goto LABEL_36;
  }
  v83 = *v34;
  ...
  if ( !v83 )
    goto LABEL_84;
  Chars = (__int64)System_Text_StringBuilder__Append_62534368(v83, (System_String_o *)Chars, 0LL);
LABEL_82:
  if ( !v41 )
LABEL_84:
    sub_1BCB254(Chars, v30);
  (*(void (__fastcall **)(_QWORD, _QWORD))(v41 + 24))(*(_QWORD *)(v41 + 64), *(_QWORD *)(v41 + 40));
...
void __fastcall ScriptLogMessage__UpdatePlayVoice(ScriptLogMessage_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1E311 & 1) == 0 )
  {
    sub_1BCAFF8(&System_Action_string__string__bool__TypeInfo, method);
    sub_1BCAFF8(&Method_ScriptLogMessage_SetBackLogReplayingVoice__, v3);
    byte_4B1E311 = 1;
  }
  if ( this->fields.isReservedAddPlayVoice && !this->fields.isDelayAddPlayVoice )
  {
      ...
      && !System_String__IsNullOrEmpty(this->fields.voiceObjectName, 0LL) )
    {
      ...
      v8 = (System_Action_T1__T2__T3__o *)sub_1BCB244(System_Action_string__string__bool__TypeInfo);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A169C4;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A16984;
}
...
LABEL_9:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A169D8;
}
...
LABEL_8:
  ...
  *((_QWORD *)tmpTxt + 20) = tmpColorTag;
  sub_1BCAF9C((CGThumbnailListItem_o *)(tmpTxt + 160), (int32_t)tmpColorTag, v4, v5);
}
...
LABEL_7:
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this[3].fields, (int32_t)tmpColorTag, (int32_t)method, v3);
}