void ScriptLogMessage___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CB828E & 1) == 0 )
  {
    sub_1C6BA08(&ScriptLogMessage_TypeInfo);
    byte_4CB828E = 1;
  }
...
void ScriptLogMessage___ctor(ScriptLogMessage_o *this, const MethodInfo *method)
{
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.defaultColorTag, v5, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB8281 & 1) == 0 )
  {
    ...
    this = (ScriptLogMessage_o *)sub_1C6BA08(&StringLiteral_1/*""*/);
    byte_4CB8281 = 1;
  }
...
LABEL_60:
  ...
  if ( System_String__get_Chars(v7, 1, 0) == 35 )
  {
    ...
    v14 = System_String__Substring_64012732(v7, 2, v7->fields._stringLength - 3, 0);
    this = (ScriptLogMessage_o *)sub_1C6BAB0(char___TypeInfo, 1);
    if ( !this )
      goto LABEL_60;
    ...
    if ( LODWORD(this->fields.m_CancellationTokenSource) )
    {
      ...
      if ( !v14 )
        goto LABEL_60;
      this = (ScriptLogMessage_o *)System_String__Split_64015884(v14, (System_Char_array *)this, 0);
      if ( !this )
        goto LABEL_60;
...
LABEL_61:
  ...
  if ( System_String__get_Chars(v7, 1, 0) == 94 )
  {
    ...
    v26 = System_String__Substring_64012732(v7, 2, v7->fields._stringLength - 3, 0);
    this = (ScriptLogMessage_o *)sub_1C6BAB0(char___TypeInfo, 1);
    if ( !this )
      goto LABEL_60;
    text = (System_String_o *)this;
    ...
    if ( !v26 )
      goto LABEL_60;
    this = (ScriptLogMessage_o *)System_String__Split_64015884(v26, (System_Char_array *)this, 0);
    if ( !this )
      goto LABEL_60;
    ...
    if ( v27 <= 1 )
    {
      ...
      if ( LODWORD(this->fields.m_CancellationTokenSource) )
      {
        ...
        if ( !v29 )
          goto LABEL_60;
        this = (ScriptLogMessage_o *)System_String__Split_64015884((System_String_o *)v29, (System_Char_array *)this, 0);
        if ( !this )
          goto LABEL_60;
        ...
        else
        {
          ...
          sub_1C6B9AC((CGThumbnailListItem_o *)&analyzeLabel->fields.ruby, (int32_t)RubyLabel, v44, v45);
          if ( LODWORD(v42->fields.m_CancellationTokenSource) >= 2 )
          {
            ScriptMessageLabel__UpdateImageRuby(
              ...
              &v8->fields.dispPosition,
              v8->fields.fontSize,
              (System_String_o *)v42->fields.backLogDialog,
              (System_String_o *)v42->fields.mainPrefab,
              v8->fields.fontType,
              v8->fields.horizontalAlign,
              0);
            goto LABEL_15;
    ...
    if ( v31 <= 3 )
    {
      if ( (unsigned int)v31 > 2 )
      {
        ...
        if ( LODWORD(this->fields.m_CancellationTokenSource) )
        {
          ...
          if ( !rubyPrefab )
            goto LABEL_60;
          this = (ScriptLogMessage_o *)System_String__Split_64015884(rubyPrefab, (System_Char_array *)this, 0);
          if ( !this )
            goto LABEL_60;
          v47 = this;
          if ( LODWORD(this->fields.m_CancellationTokenSource) )
          {
            ...
            {
              v48 = (int)this;
              v49 = System_Int32__Parse((System_String_o *)v47->fields.mainPrefab, 0);
              v50.fields.x = (float)v48;
              v50.fields.y = (float)v49;
  ...
  else
  {
    if ( System_String__get_Chars(v7, 1, 0) != 126 )
    {
      ...
      sub_1C6B9AC((CGThumbnailListItem_o *)&analyzeLabel->fields, (int32_t)MainLabel, v39, v40);
      ScriptMessageLabel__UpdateLabel(
        analyzeLabel,
        &analyzeLabel->fields.main,
        &v8->fields.dispPosition,
    ...
    v34 = System_String__Substring_64012732(v7, 2, v7->fields._stringLength - 3, 0);
    this = (ScriptLogMessage_o *)sub_1C6BAB0(char___TypeInfo, 1);
    if ( !this )
      goto LABEL_60;
    text = (System_String_o *)this;
    ...
    if ( !v34 )
      goto LABEL_60;
    this = (ScriptLogMessage_o *)System_String__Split_64015884(v34, (System_Char_array *)this, 0);
    if ( !this )
      goto LABEL_60;
    v35 = this;
    if ( !LODWORD(this->fields.m_CancellationTokenSource) )
    ...
    if ( SLODWORD(v35->fields.m_CancellationTokenSource) >= 2 )
      ...
      p_mainPrefab = (System_String_o **)&StringLiteral_21323/*"line"*/;
        ...
        const MethodInfo *method)
{
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.voiceAssetName, (int32_t)assetName, (int32_t)objectName, method);
  v5->fields.voiceObjectName = objectName;
  v5 = (ScriptLogMessage_o *)((char *)v5 + 216);
  sub_1C6B9AC((CGThumbnailListItem_o *)v5, (int32_t)objectName, v8, v9);
...
// local variable allocation has failed, the output may be wrong!
void ScriptLogMessage__AddText_45065596(
        ScriptLogMessage_o *this,
        System_String_o *text,
        bool isLineHead,
        int32_t lineLength,
...
void ScriptLogMessage__ClearTalkName(ScriptLogMessage_o *this, const MethodInfo *method)
{
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.talkName, v5, v2, v3);
}
...
UISprite_o *ScriptLogMessage__FetchImageSprite(ScriptLogMessage_o *this, const MethodInfo *method)
{
  ...
  if ( !byte_4CAFC09 )
  {
    this = (ScriptLogMessage_o *)sub_1C6BA08(&UnityEngine_Vector3_TypeInfo);
    byte_4CAFC09 = 1;
  }
  if ( !v4 )
    goto LABEL_10;
...
int32_t ScriptLogMessage__GetDefaultFontSize(ScriptLogMessage_o *this, const MethodInfo *method)
{
  ...
  return ScriptMessageLabel__GetFontSize((System_String_o *)StringLiteral_858/*"-"*/, defaultFontSize, 0);
}
...
void ScriptLogMessage__Init(ScriptLogMessage_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.isInit )
  {
    ...
    this->fields.defaultFontSize = ScriptMessageLabel__GetFontSize(
                                     ...
                                     defaultFontSize,
                                     0);
    v4 = (ScriptMessageLabel_o *)sub_1C6BC54(ScriptMessageLabel_TypeInfo);
    ScriptMessageLabel___ctor(v4, 0);
    this->fields.analyzeLabel = v4;
    p_analyzeLabel = &this->fields.analyzeLabel;
    sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.analyzeLabel, (int32_t)v4, v6, v7);
    ...
    sub_1C6B9AC((CGThumbnailListItem_o *)&v13->fields, (int32_t)transform, v14, v15);
    if ( !*p_analyzeLabel )
      goto LABEL_47;
    ...
    sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.defaultFontType, (int32_t)trueTypeFont, v17, v18);
    this->fields.fontType = trueTypeFont;
    sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.fontType, (int32_t)trueTypeFont, v19, v20);
    transform = (UnityEngine_GameObject_o *)UnityEngine_Object__Instantiate_object_(
    ...
    sub_1C6B9AC((CGThumbnailListItem_o *)&v23->fields.ruby, (int32_t)transform, v24, v25);
    transform = (UnityEngine_GameObject_o *)UnityEngine_Object__Instantiate_object_(
    ...
    sub_1C6B9AC((CGThumbnailListItem_o *)&v28->fields.image, (int32_t)transform, v29, v30);
    transform = (UnityEngine_GameObject_o *)UnityEngine_Object__Instantiate_object_(
    ...
    if ( !v33
      || (v33->fields.playVoice = (struct UIButton_o *)transform,
          sub_1C6B9AC((CGThumbnailListItem_o *)&v33->fields.playVoice, (int32_t)transform, v34, v35),
...
LABEL_47:
    ...
    UILabel__set_text(main, (System_String_o *)StringLiteral_25466/*"■"*/, 0);
    ...
    UILabel__set_text(ruby, (System_String_o *)StringLiteral_25466/*"■"*/, 0);
...
void ScriptLogMessage__Quit(ScriptLogMessage_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.isInit )
  {
    ...
    *((_BYTE *)p_analyzeLabel + 52) = 0;
    ...
    sub_1C6B9AC((CGThumbnailListItem_o *)p_analyzeLabel, 0, v5, v6);
    this->fields.defaultFontType = 0;
    sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.defaultFontType, 0, v7, v8);
    this->fields.fontType = 0;
    sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.fontType, 0, v9, v10);
  }
}
...
void ScriptLogMessage__ReleasePlayVoice(ScriptLogMessage_o *this, const MethodInfo *method)
{
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.voiceAssetName, v5, v2, v3);
  v6 = StringLiteral_1/*""*/;
  this->fields.voiceObjectName = (struct System_String_o *)StringLiteral_1/*""*/;
  p_voiceObjectName = &this->fields.voiceObjectName;
  sub_1C6B9AC((CGThumbnailListItem_o *)p_voiceObjectName, v6, v8, v9);
...
void ScriptLogMessage__ReturnText(ScriptLogMessage_o *this, const MethodInfo *method)
{
  ...
  v10 = StringLiteral_1/*""*/;
  this->fields.defaultColorTag = (struct System_String_o *)StringLiteral_1/*""*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.defaultColorTag, v10, v4, v5);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C6BC60(backLogDialog, assetName);
  }
...
bool ScriptLogMessage__SetTalkName(ScriptLogMessage_o *this, System_String_o *text, const MethodInfo *method)
{
  ...
  else
  {
    ...
    sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.talkName, (int32_t)text, v6, v7);
    fontType = this->fields.fontType;
    defaultFontType = this->fields.defaultFontType;
    this->fields.fontType = defaultFontType;
    sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.fontType, (int32_t)defaultFontType, v10, v11);
    ...
    sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.fontType, (int32_t)fontType, v17, v18);
  }
  return 1;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB8282 & 1) == 0 )
  {
    sub_1C6BA08(&ScriptLogMessage_ProcAddLabel2_TypeInfo);
    sub_1C6BA08(&ScriptLogMessage_ProcAddLabel_TypeInfo);
    sub_1C6BA08(&ScriptMessageLabel_TypeInfo);
    sub_1C6BA08(&ScriptReplaceString_TypeInfo);
    sub_1C6BA08(&System_Text_StringBuilder_TypeInfo);
    sub_1C6BA08(&Method_ScriptLogMessage___c__DisplayClass54_0__UpdateLabels_b__0__);
    sub_1C6BA08(&Method_ScriptLogMessage___c__DisplayClass54_0__UpdateLabels_b__1__);
    sub_1C6BA08(&ScriptLogMessage___c__DisplayClass54_0_TypeInfo);
  ...
  text = 0;
  v9 = sub_1C6BC54(ScriptLogMessage___c__DisplayClass54_0_TypeInfo);
  ...
  *(_BYTE *)(v9 + 32) = isFoward;
  v14 = (System_Text_StringBuilder_o *)sub_1C6BC54(System_Text_StringBuilder_TypeInfo);
  System_Text_StringBuilder___ctor(v14, 0);
  *(_QWORD *)(v9 + 16) = v14;
  v15 = (System_Text_StringBuilder_o **)(v9 + 16);
  sub_1C6B9AC((CGThumbnailListItem_o *)(v9 + 16), (int32_t)v14, v16, v17);
  if ( enforceColor )
  {
    this->fields.defaultColorTag = enforceColor;
    sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.defaultColorTag, (int32_t)enforceColor, v18, v19);
  }
  ...
  *(_QWORD *)(v9 + 40) = defaultColorTag;
  sub_1C6B9AC((CGThumbnailListItem_o *)(v9 + 40), (int32_t)defaultColorTag, v18, v19);
  v22 = sub_1C6BC54(ScriptLogMessage_ProcAddLabel_TypeInfo);
  ScriptLogMessage_ProcAddLabel___ctor(
    ...
    v23);
  v65 = (ScriptLogMessage_ProcAddLabel2_o *)sub_1C6BC54(ScriptLogMessage_ProcAddLabel2_TypeInfo);
  ...
  while ( 1 )
  {
    if ( System_String__get_Chars(txt, v25, 0) != 91 )
    {
      ...
      if ( !v36 )
        goto LABEL_84;
      v27 = v25 + 1;
      Chars = (__int64)System_Text_StringBuilder__Append_64053080(v36, Chars, 0);
      goto LABEL_37;
    }
    if ( !ScriptMessageLabel_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(ScriptMessageLabel_TypeInfo);
    ...
    if ( (unsigned __int16)Chars == 37 )
    {
      ...
      v30 = System_String__Substring_64012732(txt, v25 + 2, v26 + v29 - 2, 0);
...
LABEL_33:
      ...
      sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.defaultColorTag, (int32_t)v39, v34, v35);
      v42 = *(_BYTE *)(v9 + 32);
      v43 = this;
      v44 = v40;
LABEL_34:
      ...
      *(_QWORD *)(v9 + 40) = v47;
LABEL_35:
      sub_1C6B9AC((CGThumbnailListItem_o *)(v9 + 40), (int32_t)v47, v45, v46);
      goto LABEL_36;
    }
    Chars = System_String__get_Chars(txt, v27, 0);
    ...
    if ( (unsigned __int16)Chars == 35 )
    {
      if ( !v22 )
        goto LABEL_84;
      (*(void (__fastcall **)(_QWORD, _QWORD))(v22 + 24))(*(_QWORD *)(v22 + 64), *(_QWORD *)(v22 + 40));
      Chars = (__int64)System_String__Substring_64012732(txt, v25, v26 + v29 + 1, 0);
      goto LABEL_51;
    }
    Chars = System_String__get_Chars(txt, v27, 0);
...
LABEL_37:
  ...
  Chars = System_String__Equals_64002112(v48, (System_String_o *)StringLiteral_18972/*"effectmessage"*/, 0);
  if ( (Chars & 1) != 0 )
    goto LABEL_36;
  Chars = System_String__Equals_64002112(v48, (System_String_o *)StringLiteral_20155/*"i"*/, 0);
  if ( (Chars & 1) != 0 )
  {
    if ( !v22 )
      goto LABEL_84;
    ...
    v50 = v26 + v29 - 3;
LABEL_49:
    v51 = System_String__Substring_64012732(txt, v49, v50, 0);
    v52 = &StringLiteral_15951/*"[^"*/;
LABEL_50:
    Chars = (__int64)System_String__Concat_64005056(
                       (System_String_o *)*v52,
                       v51,
...
LABEL_53:
  ...
  Chars = System_String__Equals_64002112(v48, (System_String_o *)StringLiteral_23012/*"r"*/, 0);
  if ( (Chars & 1) != 0 )
  {
    if ( !v22 )
      goto LABEL_84;
    ...
    if ( enforceColora )
    {
      *p_defaultColorTag = enforceColora;
      sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.defaultColorTag, (int32_t)enforceColora, v45, v46);
    }
    v47 = *p_defaultColorTag;
    *(_QWORD *)(v9 + 40) = *p_defaultColorTag;
    goto LABEL_35;
  }
  Chars = System_String__Equals_64002112(v48, (System_String_o *)StringLiteral_23387/*"servantName"*/, 0);
  if ( (Chars & 1) != 0 )
  {
    if ( !v22 )
      goto LABEL_84;
    (*(void (__fastcall **)(_QWORD, _QWORD))(v22 + 24))(*(_QWORD *)(v22 + 64), *(_QWORD *)(v22 + 40));
    v56 = System_String__Substring_64012732(txt, v25 + 12, v26 + v29 - 12, 0);
    if ( !ScriptMessageLabel_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(ScriptMessageLabel_TypeInfo);
    ...
    sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.defaultColorTag, (int32_t)v58, v60, v61);
  ...
  Chars = System_String__StartsWith(v48, (System_String_o *)StringLiteral_21323/*"line"*/, 0);
  if ( (Chars & 1) != 0 )
  {
    if ( !v22 )
      goto LABEL_84;
    (*(void (__fastcall **)(_QWORD, _QWORD))(v22 + 24))(*(_QWORD *)(v22 + 64), *(_QWORD *)(v22 + 40));
    Chars = (__int64)System_String__Substring_64012732(txt, v25 + 5, v26 + v29 - 5, 0);
    if ( !Chars )
      goto LABEL_84;
    if ( *(int *)(Chars + 16) >= 1 )
    {
      v51 = System_String__Trim((System_String_o *)Chars, 0);
      v52 = &StringLiteral_16015/*"[~"*/;
      goto LABEL_50;
    }
    v53 = v65;
    if ( !v65 )
      goto LABEL_84;
    v54 = StringLiteral_16016/*"[~1]"*/;
    goto LABEL_53;
  }
  if ( v29 < txt->fields._stringLength )
  {
    text = System_String__Substring_64012732(txt, v25, v26 + v29 + 1, 0);
    if ( !ScriptMessageLabel_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(ScriptMessageLabel_TypeInfo);
    ...
    if ( !*v15 )
      goto LABEL_84;
    Chars = (__int64)System_Text_StringBuilder__Append_64050752((System_Text_StringBuilder_o *)Chars, text, 0);
    goto LABEL_36;
  }
  v63 = *v15;
  ...
  if ( !v63 )
    goto LABEL_84;
  Chars = (__int64)System_Text_StringBuilder__Append_64050752(v63, (System_String_o *)Chars, 0);
LABEL_82:
  if ( !v22 )
LABEL_84:
    sub_1C6BC60(Chars, v11);
  (*(void (__fastcall **)(_QWORD, _QWORD))(v22 + 24))(*(_QWORD *)(v22 + 64), *(_QWORD *)(v22 + 40));
...
void ScriptLogMessage__UpdatePlayVoice(ScriptLogMessage_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB8283 & 1) == 0 )
  {
    sub_1C6BA08(&System_Action_string__string__bool__TypeInfo);
    sub_1C6BA08(&Method_ScriptLogMessage_SetBackLogReplayingVoice__);
    byte_4CB8283 = 1;
  }
  if ( this->fields.isReservedAddPlayVoice && !this->fields.isDelayAddPlayVoice )
  {
      ...
      && !System_String__IsNullOrEmpty(this->fields.voiceObjectName, 0) )
    {
      ...
      v7 = (System_Action_T1__T2__T3__o *)sub_1C6BC54(System_Action_string__string__bool__TypeInfo);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1AA37E8;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1AA37A8;
}
...
LABEL_8:
  ...
  this->fields.method_code = (intptr_t)m_target;
LABEL_9:
  this->fields.extra_arg = (intptr_t)sub_1AA37FC;
}
...
LABEL_8:
  ...
  *((_QWORD *)tmpTxt + 20) = tmpColorTag;
  sub_1C6B9AC((CGThumbnailListItem_o *)(tmpTxt + 160), (int32_t)tmpColorTag, v4, v5);
}
...
LABEL_7:
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this[3].fields, (int32_t)tmpColorTag, (int32_t)method, v3);
}