void ScriptLogMessage___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E069AD & 1) == 0 )
  {
    sub_1CE6700(&ScriptLogMessage_TypeInfo);
    byte_4E069AD = 1;
  }
...
void ScriptLogMessage___ctor(ScriptLogMessage_o *this, const MethodInfo *method)
{
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.defaultColorTag, v9, v2, v3, v4, v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E069A0 & 1) == 0 )
  {
    ...
    this = (ScriptLogMessage_o *)sub_1CE6700(&StringLiteral_1/*""*/);
    byte_4E069A0 = 1;
  }
...
LABEL_60:
  ...
  if ( System_String__get_Chars(v10, 1, 0) == 35 )
  {
    ...
    v17 = System_String__Substring_65168768(v10, 2, v10->fields._stringLength - 3, 0);
    this = (ScriptLogMessage_o *)sub_1CE67A8(char___TypeInfo, 1);
    if ( !this )
      goto LABEL_60;
    ...
    if ( LODWORD(this->fields.m_CancellationTokenSource) )
    {
      ...
      if ( !v17 )
        goto LABEL_60;
      this = (ScriptLogMessage_o *)System_String__Split_65171920(v17, (System_Char_array *)this, 0);
      if ( !this )
        goto LABEL_60;
...
LABEL_61:
  ...
  if ( System_String__get_Chars(v10, 1, 0) == 94 )
  {
    ...
    v29 = System_String__Substring_65168768(v10, 2, v10->fields._stringLength - 3, 0);
    this = (ScriptLogMessage_o *)sub_1CE67A8(char___TypeInfo, 1);
    if ( !this )
      goto LABEL_60;
    text = (System_String_o *)this;
    ...
    if ( !v29 )
      goto LABEL_60;
    this = (ScriptLogMessage_o *)System_String__Split_65171920(v29, (System_Char_array *)this, 0);
    if ( !this )
      goto LABEL_60;
    ...
    if ( v30 <= 1 )
    {
      ...
      if ( LODWORD(this->fields.m_CancellationTokenSource) )
      {
        ...
        if ( !v32 )
          goto LABEL_60;
        this = (ScriptLogMessage_o *)System_String__Split_65171920((System_String_o *)v32, (System_Char_array *)this, 0);
        if ( !this )
          goto LABEL_60;
    ...
    if ( v34 <= 3 )
    {
      if ( (unsigned int)v34 > 2 )
      {
        ...
        if ( LODWORD(this->fields.m_CancellationTokenSource) )
        {
          ...
          if ( !rubyPrefab )
            goto LABEL_60;
          this = (ScriptLogMessage_o *)System_String__Split_65171920(rubyPrefab, (System_Char_array *)this, 0);
          if ( !this )
            goto LABEL_60;
          v58 = this;
          if ( LODWORD(this->fields.m_CancellationTokenSource) )
  ...
  else
  {
    ...
    v37 = System_String__Substring_65168768(v10, 2, v10->fields._stringLength - 3, 0);
    this = (ScriptLogMessage_o *)sub_1CE67A8(char___TypeInfo, 1);
    if ( !this )
      goto LABEL_60;
    text = (System_String_o *)this;
    ...
    if ( !v37 )
      goto LABEL_60;
    this = (ScriptLogMessage_o *)System_String__Split_65171920(v37, (System_Char_array *)this, 0);
    if ( !this )
      goto LABEL_60;
    v38 = this;
    if ( !LODWORD(this->fields.m_CancellationTokenSource) )
    ...
    if ( SLODWORD(v38->fields.m_CancellationTokenSource) >= 2 )
      ...
      p_mainPrefab = (System_String_o **)&StringLiteral_21573/*"line"*/;
        ...
        const MethodInfo *method)
{
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)v9, (int32_t)objectName, v12, v13, v14, v15, v16, v17);
...
void ScriptLogMessage__AddText_45951148(
        ScriptLogMessage_o *this,
        System_String_o *text,
        bool isLineHead,
        int32_t lineLength,
...
void ScriptLogMessage__ClearTalkName(ScriptLogMessage_o *this, const MethodInfo *method)
{
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.talkName, v9, v2, v3, v4, v5, v6, v7);
}
...
UISprite_o *ScriptLogMessage__FetchImageSprite(ScriptLogMessage_o *this, const MethodInfo *method)
{
  ...
  if ( !byte_4DFE0A9 )
  {
    this = (ScriptLogMessage_o *)sub_1CE6700(&UnityEngine_Vector3_TypeInfo);
    byte_4DFE0A9 = 1;
  }
  if ( !v4 )
    goto LABEL_10;
...
int32_t ScriptLogMessage__GetDefaultFontSize(ScriptLogMessage_o *this, const MethodInfo *method)
{
  ...
  return ScriptMessageLabel__GetFontSize((System_String_o *)StringLiteral_860/*"-"*/, defaultFontSize, 0);
}
...
void ScriptLogMessage__Init(ScriptLogMessage_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.isInit )
  {
    ...
    this->fields.defaultFontSize = ScriptMessageLabel__GetFontSize(
                                     ...
                                     defaultFontSize,
                                     0);
    v4 = (ScriptMessageLabel_o *)sub_1CE694C(ScriptMessageLabel_TypeInfo);
    ScriptMessageLabel___ctor(v4, 0);
    this->fields.analyzeLabel = v4;
    p_analyzeLabel = &this->fields.analyzeLabel;
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.analyzeLabel, (int32_t)v4, v6, v7, v8, v9, v10, v11);
    ...
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&v17->fields, (int32_t)transform, v18, v19, v20, v21, v22, v23);
    if ( !*p_analyzeLabel )
      goto LABEL_47;
    ...
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&v39->fields.ruby, (int32_t)transform, v40, v41, v42, v43, v44, v45);
    transform = (UnityEngine_GameObject_o *)UnityEngine_Object__Instantiate_object_(
    ...
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&v48->fields.image, (int32_t)transform, v49, v50, v51, v52, v53, v54);
    transform = (UnityEngine_GameObject_o *)UnityEngine_Object__Instantiate_object_(
...
LABEL_47:
    ...
    UILabel__set_text(main, (System_String_o *)StringLiteral_25770/*"■"*/, 0);
    ...
    UILabel__set_text(ruby, (System_String_o *)StringLiteral_25770/*"■"*/, 0);
...
void ScriptLogMessage__Quit(ScriptLogMessage_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.isInit )
  {
    ...
    *((_BYTE *)p_analyzeLabel + 52) = 0;
    ...
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)p_analyzeLabel, 0, v5, v6, v7, v8, v9, v10);
    this->fields.defaultFontType = 0;
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.defaultFontType, 0, v11, v12, v13, v14, v15, v16);
    this->fields.fontType = 0;
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.fontType, 0, v17, v18, v19, v20, v21, v22);
  }
}
...
void ScriptLogMessage__ReleasePlayVoice(ScriptLogMessage_o *this, const MethodInfo *method)
{
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.voiceAssetName, v9, v2, v3, v4, v5, v6, v7);
  v10 = StringLiteral_1/*""*/;
  this->fields.voiceObjectName = (struct System_String_o *)StringLiteral_1/*""*/;
  p_voiceObjectName = &this->fields.voiceObjectName;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)p_voiceObjectName, v10, v12, v13, v14, v15, v16, v17);
...
void ScriptLogMessage__ReturnText(ScriptLogMessage_o *this, const MethodInfo *method)
{
  ...
  v14 = StringLiteral_1/*""*/;
  this->fields.defaultColorTag = (struct System_String_o *)StringLiteral_1/*""*/;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.defaultColorTag, v14, v4, v5, v6, v7, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1CE6958(backLogDialog, assetName);
  }
...
bool ScriptLogMessage__SetTalkName(ScriptLogMessage_o *this, System_String_o *text, const MethodInfo *method)
{
  ...
  else
  {
    ...
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.talkName, (int32_t)text, v6, v7, v8, v9, v10, v11);
    ...
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.fontType, (int32_t)fontType, v25, v26, v27, v28, v29, v30);
  }
  return 1;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E069A1 & 1) == 0 )
  {
    sub_1CE6700(&ScriptLogMessage_ProcAddLabel2_TypeInfo);
    sub_1CE6700(&ScriptLogMessage_ProcAddLabel_TypeInfo);
    sub_1CE6700(&ScriptMessageLabel_TypeInfo);
    sub_1CE6700(&ScriptReplaceString_TypeInfo);
    sub_1CE6700(&System_Text_StringBuilder_TypeInfo);
    sub_1CE6700(&Method_ScriptLogMessage___c__DisplayClass54_0__UpdateLabels_b__0__);
    sub_1CE6700(&Method_ScriptLogMessage___c__DisplayClass54_0__UpdateLabels_b__1__);
    sub_1CE6700(&ScriptLogMessage___c__DisplayClass54_0_TypeInfo);
  ...
  text = 0;
  v9 = sub_1CE694C(ScriptLogMessage___c__DisplayClass54_0_TypeInfo);
  ...
  *(_BYTE *)(v9 + 32) = isFoward;
  v18 = (System_Text_StringBuilder_o *)sub_1CE694C(System_Text_StringBuilder_TypeInfo);
  System_Text_StringBuilder___ctor(v18, 0);
  *(_QWORD *)(v9 + 16) = v18;
  v19 = (System_Text_StringBuilder_o **)(v9 + 16);
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)(v9 + 16), (int32_t)v18, v20, v21, v22, v23, v24, v25);
  if ( enforceColor )
  {
  ...
  *(_QWORD *)(v9 + 40) = defaultColorTag;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)(v9 + 40), (int32_t)defaultColorTag, v26, v27, v28, v29, v30, v31);
  v34 = sub_1CE694C(ScriptLogMessage_ProcAddLabel_TypeInfo);
  ScriptLogMessage_ProcAddLabel___ctor(
    ...
    v35);
  v89 = (ScriptLogMessage_ProcAddLabel2_o *)sub_1CE694C(ScriptLogMessage_ProcAddLabel2_TypeInfo);
  ...
  while ( 1 )
  {
    if ( System_String__get_Chars(txt, v37, 0) != 91 )
    {
      ...
      if ( !v52 )
        goto LABEL_84;
      v39 = v37 + 1;
      Chars = (__int64)System_Text_StringBuilder__Append_65209116(v52, Chars, 0);
      goto LABEL_37;
    }
    if ( !ScriptMessageLabel_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(ScriptMessageLabel_TypeInfo);
    ...
    if ( (unsigned __int16)Chars == 37 )
    {
      ...
      v42 = System_String__Substring_65168768(txt, v37 + 2, v38 + v41 - 2, 0);
...
LABEL_34:
      ...
      *(_QWORD *)(v9 + 40) = v67;
LABEL_35:
      sub_1CE66A4((GrandQuestFolderBoardItem_o *)(v9 + 40), (int32_t)v67, v61, v62, v63, v64, v65, v66);
      goto LABEL_36;
    }
    Chars = System_String__get_Chars(txt, v39, 0);
    ...
    if ( (unsigned __int16)Chars == 35 )
    {
      if ( !v34 )
        goto LABEL_84;
      (*(void (__fastcall **)(_QWORD, _QWORD))(v34 + 24))(*(_QWORD *)(v34 + 64), *(_QWORD *)(v34 + 40));
      Chars = (__int64)System_String__Substring_65168768(txt, v37, v38 + v41 + 1, 0);
      goto LABEL_51;
    }
    Chars = System_String__get_Chars(txt, v39, 0);
...
LABEL_37:
  ...
  Chars = System_String__Equals_65158148(v68, (System_String_o *)StringLiteral_19174/*"effectmessage"*/, 0);
  if ( (Chars & 1) != 0 )
    goto LABEL_36;
  Chars = System_String__Equals_65158148(v68, (System_String_o *)StringLiteral_20377/*"i"*/, 0);
  if ( (Chars & 1) != 0 )
  {
    if ( !v34 )
      goto LABEL_84;
    ...
    v70 = v38 + v41 - 3;
LABEL_49:
    v71 = System_String__Substring_65168768(txt, v69, v70, 0);
    v72 = &StringLiteral_16107/*"[^"*/;
LABEL_50:
    Chars = (__int64)System_String__Concat_65161092(
                       (System_String_o *)*v72,
                       v71,
...
LABEL_53:
  ...
  Chars = System_String__Equals_65158148(v68, (System_String_o *)StringLiteral_23283/*"r"*/, 0);
  if ( (Chars & 1) != 0 )
  {
    if ( !v34 )
      goto LABEL_84;
  ...
  Chars = System_String__Equals_65158148(v68, (System_String_o *)StringLiteral_23663/*"servantName"*/, 0);
  if ( (Chars & 1) != 0 )
  {
    if ( !v34 )
      goto LABEL_84;
    (*(void (__fastcall **)(_QWORD, _QWORD))(v34 + 24))(*(_QWORD *)(v34 + 64), *(_QWORD *)(v34 + 40));
    v76 = System_String__Substring_65168768(txt, v37 + 12, v38 + v41 - 12, 0);
    if ( !ScriptMessageLabel_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(ScriptMessageLabel_TypeInfo);
  ...
  Chars = System_String__StartsWith(v68, (System_String_o *)StringLiteral_21573/*"line"*/, 0);
  if ( (Chars & 1) != 0 )
  {
    if ( !v34 )
      goto LABEL_84;
    (*(void (__fastcall **)(_QWORD, _QWORD))(v34 + 24))(*(_QWORD *)(v34 + 64), *(_QWORD *)(v34 + 40));
    Chars = (__int64)System_String__Substring_65168768(txt, v37 + 5, v38 + v41 - 5, 0);
    if ( !Chars )
      goto LABEL_84;
    if ( *(int *)(Chars + 16) >= 1 )
    {
      v71 = System_String__Trim((System_String_o *)Chars, 0);
      v72 = &StringLiteral_16171/*"[~"*/;
      goto LABEL_50;
    }
    v73 = v89;
    if ( !v89 )
      goto LABEL_84;
    v74 = StringLiteral_16172/*"[~1]"*/;
    goto LABEL_53;
  }
  if ( v41 < txt->fields._stringLength )
  {
    text = System_String__Substring_65168768(txt, v37, v38 + v41 + 1, 0);
    if ( !ScriptMessageLabel_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(ScriptMessageLabel_TypeInfo);
    ...
    if ( !*v19 )
      goto LABEL_84;
    Chars = (__int64)System_Text_StringBuilder__Append_65206788((System_Text_StringBuilder_o *)Chars, text, 0);
    goto LABEL_36;
  }
  v87 = *v19;
  ...
  if ( !v87 )
    goto LABEL_84;
  Chars = (__int64)System_Text_StringBuilder__Append_65206788(v87, (System_String_o *)Chars, 0);
LABEL_82:
  if ( !v34 )
LABEL_84:
    sub_1CE6958(Chars, v11);
  (*(void (__fastcall **)(_QWORD, _QWORD))(v34 + 24))(*(_QWORD *)(v34 + 64), *(_QWORD *)(v34 + 40));
...
void ScriptLogMessage__UpdatePlayVoice(ScriptLogMessage_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E069A2 & 1) == 0 )
  {
    sub_1CE6700(&System_Action_string__string__bool__TypeInfo);
    sub_1CE6700(&Method_ScriptLogMessage_SetBackLogReplayingVoice__);
    byte_4E069A2 = 1;
  }
  if ( this->fields.isReservedAddPlayVoice && !this->fields.isDelayAddPlayVoice )
  {
      ...
      && !System_String__IsNullOrEmpty(this->fields.voiceObjectName, 0) )
    {
      ...
      v7 = (System_Action_T1__T2__T3__o *)sub_1CE694C(System_Action_string__string__bool__TypeInfo);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1B19278;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1B19238;
}
...
LABEL_8:
  ...
  this->fields.method_code = (intptr_t)m_target;
LABEL_9:
  this->fields.extra_arg = (intptr_t)sub_1B1928C;
}
...
LABEL_8:
  ...
  *((_QWORD *)tmpTxt + 20) = tmpColorTag;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)tmpTxt + 1, (int32_t)tmpColorTag, v4, v5, v6, v7, v8, v9);
}
...
LABEL_7:
  ...
  sub_1CE66A4(
    (GrandQuestFolderBoardItem_o *)&this[3].fields,
    (int32_t)tmpColorTag,
    (int32_t)method,
    v3,
    (System_String_o *)v4,
