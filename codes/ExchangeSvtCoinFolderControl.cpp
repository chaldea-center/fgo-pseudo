void __fastcall ExchangeSvtCoinFolderControl___cctor(const MethodInfo *method)
{
  if ( (byte_4BD77EA & 1) == 0 )
  {
    sub_1C21E38(&ExchangeSvtCoinFolderControl_TypeInfo);
    sub_1C21E38(&StringLiteral_5893/*"EXCHANGE_SVT_COIN_FOLDER_NAME_{0}"*/);
    byte_4BD77EA = 1;
  }
  ExchangeSvtCoinFolderControl_TypeInfo->static_fields->FOLDER_NAME = (struct System_String_o *)StringLiteral_5893/*"EXCHANGE_SVT_COIN_FOLDER_NAME_{0}"*/;
  sub_1C21DDC(ExchangeSvtCoinFolderControl_TypeInfo->static_fields, StringLiteral_5893/*"EXCHANGE_SVT_COIN_FOLDER_NAME_{0}"*/);
}
        ...
        const MethodInfo *method)
{
  ...
  *((_DWORD *)p_onClickAction - 2) = 0;
  sub_1C21DDC(p_onClickAction, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  __int64 v8; // x3
  __int64 v9; // x4
  ExchangeSvtCoinFolderControl_c *v10; // x0
  ...
  sub_1C21DDC(&this->fields.onClickAction, onClickAction);
  v10 = ExchangeSvtCoinFolderControl_TypeInfo;
