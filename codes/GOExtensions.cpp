...
Il2CppObject *GOExtensions__AddComponentWithData_object_(
        ...
        const MethodInfo_31C6658 *method)
{
  const MethodInfo_31C6658_RGCTXs *rgctx_data; // x8
  intptr_t _0_T; // x22
  ...
  const MethodInfo_31C6764 *v21; // x1
  ...
  TypeFromHandle = (System_Type_o *)sub_1C7BC24(v11, _1_T);
  v15 = TypeFromHandle;
  v16 = method->rgctx_data->_1_T;
  if ( (*(&v16->_2.bitflags2 + 2) & 1) == 0 )
  {
    TypeFromHandle = (System_Type_o *)sub_1C51B7C(v14);
    v16 = (Il2CppClass *)TypeFromHandle;
  }
  if ( !v15 )
LABEL_14:
    sub_1C7BD40(TypeFromHandle, v10);
  v17 = (WellFired_Data_DataComponent_o *)sub_1C7BC24(v15, v16);
  if ( v17 )
  {
...
Il2CppObject *GOExtensions__AddDisabledComponentWithData_object_(
        UnityEngine_GameObject_o *gameObject,
        WellFired_Data_DataBaseEntry_o *data,
        const MethodInfo_31C6864 *method)
{
  const MethodInfo_31C6864_RGCTXs *rgctx_data; // x8
  intptr_t _0_T; // x22
  System_RuntimeTypeHandle_o v8; // x0
  System_Type_o *TypeFromHandle; // x0
  __int64 v10; // x1
  ...
  const MethodInfo_31C6980 *v20; // x0
...
Il2CppObject *GOExtensions__AddDisabledComponent_object_(
        UnityEngine_GameObject_o *gameObject,
        const MethodInfo_31C6764 *method)
{
  const MethodInfo_31C6764_RGCTXs *rgctx_data; // x8
  intptr_t _0_T; // x21
  ...
  const MethodInfo_31C6864 *v20; // x2
  ...
  _1_T = method->rgctx_data->_1_T;
  if ( (*(&_1_T->_2.bitflags2 + 2) & 1) == 0 )
    _1_T = (Il2CppClass *)sub_1C51B7C(v10);
  TypeFromHandle = (System_Type_o *)sub_1C7BC24(v9, _1_T);
  v13 = TypeFromHandle;
  v14 = method->rgctx_data->_1_T;
  if ( (*(&v14->_2.bitflags2 + 2) & 1) == 0 )
  {
    TypeFromHandle = (System_Type_o *)sub_1C51B7C(v12);
    v14 = (Il2CppClass *)TypeFromHandle;
  }
  if ( !v13 )
LABEL_14:
    sub_1C7BD40(TypeFromHandle, v8);
  v15 = (UnityEngine_Behaviour_o *)sub_1C7BC24(v13, v14);
  if ( v15 )
  {
...
Il2CppObject *GOExtensions__ConstructFromResourcePersistant_object_(
        ...
        const MethodInfo_31C6D18 *method)
{
...
LABEL_11:
  ...
  _1_T = method->rgctx_data->_1_T;
  if ( (*(&_1_T->_2.bitflags2 + 2) & 1) == 0 )
    _1_T = (Il2CppClass *)sub_1C51B7C(v15);
  v17 = sub_1C7BC24(Component, _1_T);
  v19 = method->rgctx_data->_1_T;
  if ( (*(&v19->_2.bitflags2 + 2) & 1) == 0 )
    v19 = (Il2CppClass *)sub_1C51B7C(v18);
  if ( v17 )
  {
    result = (Il2CppObject *)sub_1C7BC24(v17, v19);
    if ( result )
      return result;
    sub_1C7C0DC(v17);
  }
...
Il2CppObject *GOExtensions__ConstructFromResource_object_(System_String_o *name, const MethodInfo_31C6B98 *method)
{
  UnityEngine_Object_o *v4; // x0
  UnityEngine_GameObject_c **v5; // x20
  Il2CppObject *v6; // x0
...
LABEL_11:
  ...
  if ( !v7 )
    sub_1C7BD40(TypeFromHandle, v11);
  Component = UnityEngine_GameObject__GetComponent((UnityEngine_GameObject_o *)v7, TypeFromHandle, 0);
  _1_T = method->rgctx_data->_1_T;
  if ( (*(&_1_T->_2.bitflags2 + 2) & 1) == 0 )
    _1_T = (Il2CppClass *)sub_1C51B7C(v13);
  v15 = sub_1C7BC24(Component, _1_T);
  v17 = method->rgctx_data->_1_T;
  if ( (*(&v17->_2.bitflags2 + 2) & 1) == 0 )
    v17 = (Il2CppClass *)sub_1C51B7C(v16);
  if ( v15 )
  {
    result = (Il2CppObject *)sub_1C7BC24(v15, v17);
    if ( result )
      return result;
    sub_1C7C0DC(v15);
  }
...
Il2CppObject *GOExtensions__ConstructPersistant_object_(const MethodInfo_31C6EA4 *method)
{
  const MethodInfo_31C6980 **rgctx_data; // x8
  Il2CppObject *v3; // x0
  __int64 v4; // x1
  ...
  rgctx_data = (const MethodInfo_31C6980 **)method->rgctx_data;
  if ( !rgctx_data )
  {
    sub_1C7BAE8(&UnityEngine_Object_TypeInfo);
    sub_1C7BAE8(&System_Type_TypeInfo);
  ...
  _1_T = method->rgctx_data->_1_T;
  if ( (*(&_1_T->_2.bitflags2 + 2) & 1) == 0 )
    _1_T = (Il2CppClass *)sub_1C51B7C(v11);
  v13 = sub_1C7BC24(Component, _1_T);
  v15 = method->rgctx_data->_1_T;
  if ( (*(&v15->_2.bitflags2 + 2) & 1) == 0 )
    v15 = (Il2CppClass *)sub_1C51B7C(v14);
  if ( v13 )
  {
    result = (Il2CppObject *)sub_1C7BC24(v13, v15);
    if ( result )
      return result;
    sub_1C7C0DC(v13);
  }
...
Il2CppObject *GOExtensions__Construct_object_(const MethodInfo_31C6980 *method)
{
  const MethodInfo_31C6980_RGCTXs *rgctx_data; // x8
  intptr_t _0_T; // x20
  ...
  if ( !byte_4CE7E59 )
  {
    TypeFromHandle = sub_1C7BAE8(&UnityEngine_Vector3_TypeInfo);
    byte_4CE7E59 = 1;
  }
  if ( !v9 )
    goto LABEL_23;
  ...
  if ( !byte_4CE7E5F )
  {
    TypeFromHandle = sub_1C7BAE8(&UnityEngine_Quaternion_TypeInfo);
    byte_4CE7E5F = 1;
  }
  if ( !v10 )
LABEL_23:
    sub_1C7BD40(TypeFromHandle, v6);
  ...
  _1_T = method->rgctx_data->_1_T;
  if ( (*(&_1_T->_2.bitflags2 + 2) & 1) == 0 )
    _1_T = (Il2CppClass *)sub_1C51B7C(v16);
  v18 = sub_1C7BC24(Component, _1_T);
  v20 = method->rgctx_data->_1_T;
  if ( (*(&v20->_2.bitflags2 + 2) & 1) == 0 )
    v20 = (Il2CppClass *)sub_1C51B7C(v19);
  if ( v18 )
  {
    result = (Il2CppObject *)sub_1C7BC24(v18, v20);
    if ( result )
      return result;
    sub_1C7C0DC(v18);
  }
