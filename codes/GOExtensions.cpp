        ...
        const MethodInfo_38B674C *method)
{
  ...
  long double v12; // q0
  const MethodInfo_38B674C_RGCTXs *v13; // x8
  ...
  TypeFromHandle = (System_Type_o *)sub_2213BB4(v14, _1_T);
  if ( !TypeFromHandle )
LABEL_10:
    sub_2213CDC(TypeFromHandle, v10);
        ...
        const MethodInfo_38B68C0 *method)
{
  ...
  UnityEngine_Component_o *v11; // x0
  long double v12; // q0
  const MethodInfo_38B68C0_RGCTXs *v13; // x8
  UnityEngine_Component_o *v14; // x20
  __int64 _1_T; // x1
        ...
        const MethodInfo_38B680C *method)
{
  ...
  long double v10; // q0
  const MethodInfo_38B680C_RGCTXs *v11; // x8
  ...
  if ( (*(_WORD *)(_1_T + 309) & 1) == 0 )
    _1_T = sub_224B908(v10);
  TypeFromHandle = (System_Type_o *)sub_2213BB4(v12, _1_T);
  if ( !TypeFromHandle )
LABEL_10:
...
LABEL_11:
  ...
  if ( (*(_WORD *)(_1_T + 309) & 1) == 0 )
    _1_T = sub_224B908(v17);
  return (Il2CppObject *)sub_2213BB4(v19, _1_T);
}
...
Il2CppObject *GOExtensions__ConstructPersistant_object_(const MethodInfo_38B6DC4 *method)
{
  ...
  UnityEngine_Component_o *Component; // x0
  long double v13; // q0
  const MethodInfo_38B6DC4_RGCTXs *v14; // x8
  ...
  if ( (*(_WORD *)(_1_T + 309) & 1) == 0 )
    _1_T = sub_224B908(v13);
  return (Il2CppObject *)sub_2213BB4(v15, _1_T);
}
...
Il2CppObject *GOExtensions__Construct_object_(const MethodInfo_38B6990 *method)
{
  ...
  UnityEngine_Component_o *Component; // x0
  long double v17; // q0
  const MethodInfo_38B6990_RGCTXs *v18; // x8
  UnityEngine_Component_o *v19; // x19
  __int64 _1_T; // x1
  ...
  TypeFromHandle = (UnityEngine_Transform_o *)System_Type__GetTypeFromHandle(v5, 0);
  if ( !TypeFromHandle )
    goto LABEL_17;
  v8 = (System_String_o *)((__int64 (__fastcall *)(UnityEngine_Transform_o *, const MethodInfo *))TypeFromHandle->klass->vtable._3_ToString.methodPtr)(
                            TypeFromHandle,
  ...
  if ( !v9 )
    goto LABEL_17;
  TypeFromHandle = UnityEngine_GameObject__get_transform(v9, 0);
  v10 = TypeFromHandle;
  if ( !byte_5969AE0 )
  {
    TypeFromHandle = (UnityEngine_Transform_o *)sub_2213A60(&UnityEngine_Vector3_TypeInfo);
    byte_5969AE0 = 1;
  }
  if ( !v10 )
    goto LABEL_17;
  ...
  if ( !byte_5969AE6 )
  {
    TypeFromHandle = (UnityEngine_Transform_o *)sub_2213A60(&UnityEngine_Quaternion_TypeInfo);
    byte_5969AE6 = 1;
  }
  if ( !v11 )
LABEL_17:
