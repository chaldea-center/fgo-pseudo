...
Il2CppObject *GOExtensions__AddComponentWithData_object_(
        ...
        const MethodInfo_31A2460 *method)
{
  const MethodInfo_31A2460_RGCTXs *rgctx_data; // x8
  intptr_t _0_T; // x22
  ...
  const MethodInfo_31A256C *v21; // x1
  ...
  TypeFromHandle = (System_Type_o *)sub_1C714EC(v11, _1_T);
  v15 = TypeFromHandle;
  v16 = method->rgctx_data->_1_T;
  if ( (*(&v16->_2.bitflags2 + 2) & 1) == 0 )
  {
    TypeFromHandle = (System_Type_o *)sub_1C47444(v14);
    v16 = (Il2CppClass *)TypeFromHandle;
  }
  if ( !v15 )
LABEL_14:
    sub_1C71608(TypeFromHandle, v10);
  v17 = (WellFired_Data_DataComponent_o *)sub_1C714EC(v15, v16);
  if ( v17 )
  {
...
Il2CppObject *GOExtensions__AddDisabledComponentWithData_object_(
        UnityEngine_GameObject_o *gameObject,
        WellFired_Data_DataBaseEntry_o *data,
        const MethodInfo_31A266C *method)
{
  const MethodInfo_31A266C_RGCTXs *rgctx_data; // x8
  intptr_t _0_T; // x22
  System_RuntimeTypeHandle_o v8; // x0
  System_Type_o *TypeFromHandle; // x0
  __int64 v10; // x1
  ...
  const MethodInfo_31A2788 *v20; // x0
...
Il2CppObject *GOExtensions__AddDisabledComponent_object_(
        UnityEngine_GameObject_o *gameObject,
        const MethodInfo_31A256C *method)
{
  const MethodInfo_31A256C_RGCTXs *rgctx_data; // x8
  intptr_t _0_T; // x21
  ...
  const MethodInfo_31A266C *v20; // x2
  ...
  _1_T = method->rgctx_data->_1_T;
  if ( (*(&_1_T->_2.bitflags2 + 2) & 1) == 0 )
    _1_T = (Il2CppClass *)sub_1C47444(v10);
  TypeFromHandle = (System_Type_o *)sub_1C714EC(v9, _1_T);
  v13 = TypeFromHandle;
  v14 = method->rgctx_data->_1_T;
  if ( (*(&v14->_2.bitflags2 + 2) & 1) == 0 )
  {
    TypeFromHandle = (System_Type_o *)sub_1C47444(v12);
    v14 = (Il2CppClass *)TypeFromHandle;
  }
  if ( !v13 )
LABEL_14:
    sub_1C71608(TypeFromHandle, v8);
  v15 = (UnityEngine_Behaviour_o *)sub_1C714EC(v13, v14);
  if ( v15 )
  {
...
Il2CppObject *GOExtensions__ConstructFromResourcePersistant_object_(
        ...
        const MethodInfo_31A2B20 *method)
{
...
LABEL_11:
  ...
  _1_T = method->rgctx_data->_1_T;
  if ( (*(&_1_T->_2.bitflags2 + 2) & 1) == 0 )
    _1_T = (Il2CppClass *)sub_1C47444(v15);
  v17 = sub_1C714EC(Component, _1_T);
  v19 = method->rgctx_data->_1_T;
  if ( (*(&v19->_2.bitflags2 + 2) & 1) == 0 )
    v19 = (Il2CppClass *)sub_1C47444(v18);
  if ( v17 )
  {
    result = (Il2CppObject *)sub_1C714EC(v17, v19);
    if ( result )
      return result;
    sub_1C719A4(v17);
  }
...
Il2CppObject *GOExtensions__ConstructFromResource_object_(System_String_o *name, const MethodInfo_31A29A0 *method)
{
  UnityEngine_Object_o *v4; // x0
  UnityEngine_GameObject_c **v5; // x20
  Il2CppObject *v6; // x0
...
LABEL_11:
  ...
  if ( !v7 )
    sub_1C71608(TypeFromHandle, v11);
  Component = UnityEngine_GameObject__GetComponent((UnityEngine_GameObject_o *)v7, TypeFromHandle, 0);
  _1_T = method->rgctx_data->_1_T;
  if ( (*(&_1_T->_2.bitflags2 + 2) & 1) == 0 )
    _1_T = (Il2CppClass *)sub_1C47444(v13);
  v15 = sub_1C714EC(Component, _1_T);
  v17 = method->rgctx_data->_1_T;
  if ( (*(&v17->_2.bitflags2 + 2) & 1) == 0 )
    v17 = (Il2CppClass *)sub_1C47444(v16);
  if ( v15 )
  {
    result = (Il2CppObject *)sub_1C714EC(v15, v17);
    if ( result )
      return result;
    sub_1C719A4(v15);
  }
...
Il2CppObject *GOExtensions__ConstructPersistant_object_(const MethodInfo_31A2CAC *method)
{
  const MethodInfo_31A2788 **rgctx_data; // x8
  Il2CppObject *v3; // x0
  __int64 v4; // x1
  ...
  rgctx_data = (const MethodInfo_31A2788 **)method->rgctx_data;
  if ( !rgctx_data )
  {
    sub_1C713B0(&UnityEngine_Object_TypeInfo);
    sub_1C713B0(&System_Type_TypeInfo);
  ...
  _1_T = method->rgctx_data->_1_T;
  if ( (*(&_1_T->_2.bitflags2 + 2) & 1) == 0 )
    _1_T = (Il2CppClass *)sub_1C47444(v11);
  v13 = sub_1C714EC(Component, _1_T);
  v15 = method->rgctx_data->_1_T;
  if ( (*(&v15->_2.bitflags2 + 2) & 1) == 0 )
    v15 = (Il2CppClass *)sub_1C47444(v14);
  if ( v13 )
  {
    result = (Il2CppObject *)sub_1C714EC(v13, v15);
    if ( result )
      return result;
    sub_1C719A4(v13);
  }
...
Il2CppObject *GOExtensions__Construct_object_(const MethodInfo_31A2788 *method)
{
  const MethodInfo_31A2788_RGCTXs *rgctx_data; // x8
  intptr_t _0_T; // x20
  ...
  if ( !byte_4CC0D09 )
  {
    TypeFromHandle = sub_1C713B0(&UnityEngine_Vector3_TypeInfo);
    byte_4CC0D09 = 1;
  }
  if ( !v9 )
    goto LABEL_23;
  ...
  if ( !byte_4CC0D0F )
  {
    TypeFromHandle = sub_1C713B0(&UnityEngine_Quaternion_TypeInfo);
    byte_4CC0D0F = 1;
  }
  if ( !v10 )
LABEL_23:
    sub_1C71608(TypeFromHandle, v6);
  ...
  _1_T = method->rgctx_data->_1_T;
  if ( (*(&_1_T->_2.bitflags2 + 2) & 1) == 0 )
    _1_T = (Il2CppClass *)sub_1C47444(v16);
  v18 = sub_1C714EC(Component, _1_T);
  v20 = method->rgctx_data->_1_T;
  if ( (*(&v20->_2.bitflags2 + 2) & 1) == 0 )
    v20 = (Il2CppClass *)sub_1C47444(v19);
  if ( v18 )
  {
    result = (Il2CppObject *)sub_1C714EC(v18, v20);
    if ( result )
      return result;
    sub_1C719A4(v18);
  }
