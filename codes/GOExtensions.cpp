...
Il2CppObject *GOExtensions__AddComponentWithData_object_(
        ...
        const MethodInfo_3125460 *method)
{
  const MethodInfo_3125460_RGCTXs *rgctx_data; // x8
  intptr_t _0_T; // x22
  ...
  const MethodInfo_312556C *v21; // x1
  ...
  TypeFromHandle = (System_Type_o *)sub_1C2D5CC(v11, _1_T);
  v15 = TypeFromHandle;
  v16 = method->rgctx_data->_1_T;
  if ( (*(&v16->_2.bitflags2 + 2) & 1) == 0 )
  {
    TypeFromHandle = (System_Type_o *)sub_1C7DBA4(v14);
    v16 = (Il2CppClass *)TypeFromHandle;
  }
  if ( !v15 )
LABEL_14:
    sub_1C2D6EC(TypeFromHandle, v10);
  v17 = (WellFired_Data_DataComponent_o *)sub_1C2D5CC(v15, v16);
  if ( v17 )
  {
...
Il2CppObject *GOExtensions__AddDisabledComponentWithData_object_(
        UnityEngine_GameObject_o *gameObject,
        WellFired_Data_DataBaseEntry_o *data,
        const MethodInfo_312566C *method)
{
  const MethodInfo_312566C_RGCTXs *rgctx_data; // x8
  intptr_t _0_T; // x22
  System_RuntimeTypeHandle_o v8; // x0
  System_Type_o *TypeFromHandle; // x0
  __int64 v10; // x1
  ...
  const MethodInfo_3125788 *v20; // x0
...
Il2CppObject *GOExtensions__AddDisabledComponent_object_(
        UnityEngine_GameObject_o *gameObject,
        const MethodInfo_312556C *method)
{
  const MethodInfo_312556C_RGCTXs *rgctx_data; // x8
  intptr_t _0_T; // x21
  ...
  const MethodInfo_312566C *v20; // x2
  ...
  _1_T = method->rgctx_data->_1_T;
  if ( (*(&_1_T->_2.bitflags2 + 2) & 1) == 0 )
    _1_T = (Il2CppClass *)sub_1C7DBA4(v10);
  TypeFromHandle = (System_Type_o *)sub_1C2D5CC(v9, _1_T);
  v13 = TypeFromHandle;
  v14 = method->rgctx_data->_1_T;
  if ( (*(&v14->_2.bitflags2 + 2) & 1) == 0 )
  {
    TypeFromHandle = (System_Type_o *)sub_1C7DBA4(v12);
    v14 = (Il2CppClass *)TypeFromHandle;
  }
  if ( !v13 )
LABEL_14:
    sub_1C2D6EC(TypeFromHandle, v8);
  v15 = (UnityEngine_Behaviour_o *)sub_1C2D5CC(v13, v14);
  if ( v15 )
  {
...
Il2CppObject *GOExtensions__ConstructFromResourcePersistant_object_(
        ...
        const MethodInfo_3125B20 *method)
{
...
LABEL_11:
  ...
  _1_T = method->rgctx_data->_1_T;
  if ( (*(&_1_T->_2.bitflags2 + 2) & 1) == 0 )
    _1_T = (Il2CppClass *)sub_1C7DBA4(v15);
  v17 = sub_1C2D5CC(Component, _1_T);
  v19 = method->rgctx_data->_1_T;
  if ( (*(&v19->_2.bitflags2 + 2) & 1) == 0 )
    v19 = (Il2CppClass *)sub_1C7DBA4(v18);
  if ( v17 )
  {
    result = (Il2CppObject *)sub_1C2D5CC(v17, v19);
    if ( result )
      return result;
    sub_1C2D9AC(v17);
  }
...
Il2CppObject *GOExtensions__ConstructFromResource_object_(System_String_o *name, const MethodInfo_31259A0 *method)
{
  UnityEngine_Object_o *v4; // x0
  UnityEngine_GameObject_c **v5; // x20
  Il2CppObject *v6; // x0
...
Il2CppObject *GOExtensions__ConstructPersistant_object_(const MethodInfo_3125CAC *method)
{
  const MethodInfo_3125788 **rgctx_data; // x8
  Il2CppObject *v3; // x0
  __int64 v4; // x1
  ...
  rgctx_data = (const MethodInfo_3125788 **)method->rgctx_data;
  if ( !rgctx_data )
  {
    sub_1C2D490(&UnityEngine_Object_TypeInfo);
    sub_1C2D490(&System_Type_TypeInfo);
  ...
  _1_T = method->rgctx_data->_1_T;
  if ( (*(&_1_T->_2.bitflags2 + 2) & 1) == 0 )
    _1_T = (Il2CppClass *)sub_1C7DBA4(v11);
  v13 = sub_1C2D5CC(Component, _1_T);
  v15 = method->rgctx_data->_1_T;
  if ( (*(&v15->_2.bitflags2 + 2) & 1) == 0 )
    v15 = (Il2CppClass *)sub_1C7DBA4(v14);
  if ( v13 )
  {
    result = (Il2CppObject *)sub_1C2D5CC(v13, v15);
    if ( result )
      return result;
    sub_1C2D9AC(v13);
  }
...
Il2CppObject *GOExtensions__Construct_object_(const MethodInfo_3125788 *method)
{
  const MethodInfo_3125788_RGCTXs *rgctx_data; // x8
  intptr_t _0_T; // x20
  ...
  if ( !byte_4C20DA1 )
  {
    TypeFromHandle = (UnityEngine_Transform_o *)sub_1C2D490(&UnityEngine_Vector3_TypeInfo);
    byte_4C20DA1 = 1;
  }
  if ( !v9 )
    goto LABEL_23;
  ...
  if ( !byte_4C20DA7 )
  {
    TypeFromHandle = (UnityEngine_Transform_o *)sub_1C2D490(&UnityEngine_Quaternion_TypeInfo);
    byte_4C20DA7 = 1;
  }
  if ( !v10 )
LABEL_23:
    sub_1C2D6EC(TypeFromHandle, v6);
  ...
  _1_T = method->rgctx_data->_1_T;
  if ( (*(&_1_T->_2.bitflags2 + 2) & 1) == 0 )
    _1_T = (Il2CppClass *)sub_1C7DBA4(v16);
  v18 = sub_1C2D5CC(Component, _1_T);
  v20 = method->rgctx_data->_1_T;
  if ( (*(&v20->_2.bitflags2 + 2) & 1) == 0 )
    v20 = (Il2CppClass *)sub_1C7DBA4(v19);
  if ( v18 )
  {
    result = (Il2CppObject *)sub_1C2D5CC(v18, v20);
    if ( result )
      return result;
    sub_1C2D9AC(v18);
  }
