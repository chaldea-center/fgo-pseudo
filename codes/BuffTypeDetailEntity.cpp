        ...
        const MethodInfo *method)
{
  ...
  sub_1B011E8(script);
  return (unsigned int)BuffTypeDetailEntity__GetScript_37769540(v13, v14, v15, v16);
}
        ...
        const MethodInfo *method)
{
  ...
  __int64 v11; // x1
  __int64 v12; // x1
  System_String_o *Script_37769540; // x21
  ...
  if ( (byte_48E257C & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_BuffTypeDetailEntity___c__GetScriptIntArray_b__3_0__, v11);
    sub_1B00CCC(&BuffTypeDetailEntity___c_TypeInfo, v12);
    byte_48E257C = 1;
  }
  Script_37769540 = BuffTypeDetailEntity__GetScript_37769540(this, key, 0LL, (const MethodInfo *)separator);
  IsNullOrEmpty = System_String__IsNullOrEmpty(Script_37769540, 0LL);
  if ( IsNullOrEmpty )
    return defValues;
  if ( !Script_37769540 )
    sub_1B00F28(IsNullOrEmpty, v15);
  v17 = (System_Collections_Generic_IEnumerable_TSource__o *)System_String__Split(Script_37769540, separator, 0, 0LL);
  ...
  if ( !_9__3_0 )
  {
    ...
    sub_1B00C70((ServantStatusBattleListViewItem_o *)&static_fields->__9__3_0, (int32_t)_9__3_0, v22, v23);
  }
...
System_String_o *__fastcall BuffTypeDetailEntity__GetScript_37769540(
        BuffTypeDetailEntity_o *this,
        System_String_o *key,
        ...
        const MethodInfo *method)
{
  ...
  return BuffTypeDetailEntity__GetScript(this, (System_String_o *)StringLiteral_12550/*"ShowStateWarBoardEnemyEquip"*/, defVal, v3);
}
...
void __fastcall BuffTypeDetailEntity___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48E257F & 1) == 0 )
  {
    sub_1B00CCC(&BuffTypeDetailEntity___c_TypeInfo, v1);
    byte_48E257F = 1;
  }
  v2 = (Il2CppObject *)sub_1B00F18(BuffTypeDetailEntity___c_TypeInfo);
