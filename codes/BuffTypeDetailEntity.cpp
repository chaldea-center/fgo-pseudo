        ...
        const MethodInfo *method)
{
  ...
  sub_1C14240(script);
  return (unsigned int)BuffTypeDetailEntity__GetScript_40158720(v13, v14, v15, v16);
}
        ...
        const MethodInfo *method)
{
  ...
  __int64 v11; // x1
  __int64 v12; // x1
  System_String_o *Script_40158720; // x21
  ...
  if ( (byte_4BB4431 & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_BuffTypeDetailEntity___c__GetScriptIntArray_b__3_0__, v11);
    sub_1C13D24(&BuffTypeDetailEntity___c_TypeInfo, v12);
    byte_4BB4431 = 1;
  }
  Script_40158720 = BuffTypeDetailEntity__GetScript_40158720(this, key, 0LL, (const MethodInfo *)separator);
  IsNullOrEmpty = System_String__IsNullOrEmpty(Script_40158720, 0LL);
  if ( IsNullOrEmpty )
    return defValues;
  if ( !Script_40158720 )
    sub_1C13F80(IsNullOrEmpty, v15);
  v17 = (System_Collections_Generic_IEnumerable_TSource__o *)System_String__Split(Script_40158720, separator, 0, 0LL);
  ...
  if ( !_9__3_0 )
  {
    ...
    sub_1C13CC8((PartyOrganizationUtility_o *)&static_fields->__9__3_0, (int64_t)_9__3_0, v22, v23, v24, v25, v26, v27);
  }
...
System_String_o *__fastcall BuffTypeDetailEntity__GetScript_40158720(
        BuffTypeDetailEntity_o *this,
        System_String_o *key,
        ...
        const MethodInfo *method)
{
  ...
  return BuffTypeDetailEntity__GetScript(this, (System_String_o *)StringLiteral_12992/*"Short read"*/, defVal, v3);
}
...
void __fastcall BuffTypeDetailEntity___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BB4434 & 1) == 0 )
  {
    sub_1C13D24(&BuffTypeDetailEntity___c_TypeInfo, v1);
    byte_4BB4434 = 1;
  }
  v2 = (Il2CppObject *)sub_1C13F70(BuffTypeDetailEntity___c_TypeInfo);
