        ...
        const MethodInfo *method)
{
  ...
  sub_1BCB514(script);
  return (unsigned int)BuffTypeDetailEntity__GetScript_41016144(v13, v14, v15, v16);
}
        ...
        const MethodInfo *method)
{
  ...
  __int64 v11; // x1
  __int64 v12; // x1
  System_String_o *Script_41016144; // x21
  ...
  if ( (byte_4B1C25F & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_BuffTypeDetailEntity___c__GetScriptIntArray_b__3_0__, v11);
    sub_1BCAFF8(&BuffTypeDetailEntity___c_TypeInfo, v12);
    byte_4B1C25F = 1;
  }
  Script_41016144 = BuffTypeDetailEntity__GetScript_41016144(this, key, 0LL, (const MethodInfo *)separator);
  IsNullOrEmpty = System_String__IsNullOrEmpty(Script_41016144, 0LL);
  if ( IsNullOrEmpty )
    return defValues;
  if ( !Script_41016144 )
    sub_1BCB254(IsNullOrEmpty, v15);
  v17 = (System_Collections_Generic_IEnumerable_TSource__o *)System_String__Split(Script_41016144, separator, 0, 0LL);
  ...
  if ( !_9__3_0 )
  {
    ...
    sub_1BCAF9C((CGThumbnailListItem_o *)&static_fields->__9__3_0, (int32_t)_9__3_0, v22, v23);
  }
...
System_String_o *__fastcall BuffTypeDetailEntity__GetScript_41016144(
        BuffTypeDetailEntity_o *this,
        System_String_o *key,
        ...
        const MethodInfo *method)
{
  ...
  return BuffTypeDetailEntity__GetScript(this, (System_String_o *)StringLiteral_12754/*"ShowStateWarBoardEnemyEquip"*/, defVal, v3);
}
...
void __fastcall BuffTypeDetailEntity___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B1C262 & 1) == 0 )
  {
    sub_1BCAFF8(&BuffTypeDetailEntity___c_TypeInfo, v1);
    byte_4B1C262 = 1;
  }
  v2 = (Il2CppObject *)sub_1BCB244(BuffTypeDetailEntity___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  BuffTypeDetailEntity___c_TypeInfo->static_fields->__9 = (struct BuffTypeDetailEntity___c_o *)v2;
  sub_1BCAF9C((CGThumbnailListItem_o *)BuffTypeDetailEntity___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
