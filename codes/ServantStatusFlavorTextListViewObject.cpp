        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6C240 & 1) == 0 )
  {
    sub_1B90010(&Method_UnityEngine_GameObject_GetComponent_ServantStatusFlavorTextListViewItemDraw___, method);
    byte_4A6C240 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2EDD768 *)Method_UnityEngine_GameObject_GetComponent_ServantStatusFlavorTextListViewItemDraw___);
  this->fields.itemDraw = (struct ServantStatusFlavorTextListViewItemDraw_o *)Component_object;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.itemDraw, (int32_t)Component_object, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6C242 & 1) == 0 )
  {
    sub_1B90010(&UnityEngine_BoxCollider_TypeInfo, method);
    sub_1B90010(&Method_UnityEngine_Component_GetComponent_Collider___, v3);
...
void __fastcall ServantStatusFlavorTextListViewObject__HideNew(
        ServantStatusFlavorTextListViewObject_o *this,
        const MethodInfo *method)
{
  ...
  if ( !itemDraw )
    sub_1B9026C(0LL, method);
  ((void (__fastcall *)(struct ServantStatusFlavorTextListViewItemDraw_o *, void *))itemDraw->klass->vtable._9_HideNew.method)(
    itemDraw,
        ...
        const MethodInfo *method)
{
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.callbackFunc, (int32_t)callbackFunc, v13, v14);
  if ( (unsigned int)initMode <= 3 )
  {
    v16 = dword_BB6C20[initMode];
    this->fields.dispMode = *((_DWORD *)&xmmword_BB7840 + initMode);
  ...
  if ( v19 )
  {
    ...
    sub_1B8FFB4(p_callbackFunc, 0, v17, v18);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantStatusFlavorTextListViewObject__Init_32669388(
        ServantStatusFlavorTextListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantStatusFlavorTextListViewObject__Init_32670720(
        ServantStatusFlavorTextListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantStatusFlavorTextListViewObject__Init_32670804(
        ServantStatusFlavorTextListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6C247 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_9864/*"OnClickListViewVoice"*/, method);
    byte_4A6C247 = 1;
  }
  manager = (UnityEngine_Component_o *)this->fields.manager;
  if ( !manager )
    sub_1B9026C(0LL, method);
  UnityEngine_Component__SendMessage(manager, (System_String_o *)StringLiteral_9864/*"OnClickListViewVoice"*/, (Il2CppObject *)this, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !transform
    || (parent = UnityEngine_Transform__get_parent(transform, 0LL),
        ...
        sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.baseParent, (int32_t)parent, v6, v7),
        (transform = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0LL)) == 0LL)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6C244 & 1) == 0 )
  {
    sub_1B90010(&Method_UnityEngine_Component_GetComponent_Collider___, isInput);
        ...
        const MethodInfo *method)
{
  ...
  v12 = isOpen;
  v13 = isNew;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.mainInfo, (int32_t)item, id, isOpen);
  this->fields.id = id;
  this->fields.isOpen = v12;
  this->fields.isNew = v13;
  this->fields.messageData = text;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.messageData, (int32_t)text, v14, v15);
  this->fields.profileNum = profileNum;
  ServantStatusFlavorTextListViewObject__Init_32669388(this, 2, v16);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.manager, (int32_t)manager, (int32_t)method, v3);
  if ( !*((_DWORD *)p_manager + 12) )
    ServantStatusFlavorTextListViewObject__Init_32669388(this, 2, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6C243 & 1) == 0 )
  {
    sub_1B90010(&UnityEngine_Object_TypeInfo, isVisible);
    byte_4A6C243 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !itemDraw )
    sub_1B9026C(0LL, method);
  ((void (__fastcall *)(struct ServantStatusFlavorTextListViewItemDraw_o *, struct ServantStatusListViewItem_o *, Il2CppMethodPointer))itemDraw->klass->vtable._8_UpdateParameter.method)(
    itemDraw,
    this->fields.mainInfo,
    itemDraw->klass->vtable._9_HideNew.methodPtr);
}
        ...
        const MethodInfo *method)
{
  ...
  v11 = (ServantStatusFlavorTextListViewObject_o *)sub_1B9052C(v8);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B90010(&UnityEngine_Object_TypeInfo, method);
    sub_1B90010(&ServantStatusFlavorTextListViewItemDrawText2_TypeInfo, v3);
    byte_4A6C23D = 1;
  }
  x = this->fields.basePosition.fields.x;
  y = this->fields.basePosition.fields.y;
