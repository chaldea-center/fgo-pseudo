        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4101938 & 1) == 0 )
  {
    sub_B16FFC(&Method_UnityEngine_GameObject_GetComponent_ServantStatusFlavorTextListViewItemDraw___, method);
    byte_4101938 = 1;
  }
  ...
  Component_srcLineSprite = (struct ServantStatusFlavorTextListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                                                  dispObject,
                                                                                  (const MethodInfo_19D14E0 *)Method_UnityEngine_GameObject_GetComponent_ServantStatusFlavorTextListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( v27 )
  {
    ...
    sub_B16F98(p_callbackFunc, 0LL, v21, v22, v23, v24, v25, v26);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantStatusFlavorTextListViewObject__Init_36635344(
        ServantStatusFlavorTextListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantStatusFlavorTextListViewObject__Init_36636640(
        ServantStatusFlavorTextListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantStatusFlavorTextListViewObject__Init_36636856(
        ServantStatusFlavorTextListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
        ...
        const MethodInfo *method)
{
  ...
  int v9; // w20
  __int64 v10; // x11
  ServantStatusFlavorTextListViewItemDrawText2_o *v11; // x21
  ...
  {
    sub_B16FFC(&UnityEngine_Object_TypeInfo, method);
    sub_B16FFC(&ServantStatusFlavorTextListViewItemDrawText2_TypeInfo, v3);
    byte_4101935 = 1;
  }
  x = this->fields.basePosition.fields.x;
  y = this->fields.basePosition.fields.y;
        ...
        *(&itemDraw->klass->_2.bitflags2 + 1) >= (unsigned int)v10) )
  {
    if ( (ServantStatusFlavorTextListViewItemDrawText2_c *)itemDraw->klass->_2.typeHierarchy[v10 - 1] == ServantStatusFlavorTextListViewItemDrawText2_TypeInfo )
      v11 = (ServantStatusFlavorTextListViewItemDrawText2_o *)this->fields.itemDraw;
    else
      v11 = 0LL;
  }
  else
    ...
    if ( !v11
      || (v13 = this->fields.basePosition.fields.y,
          *(UnityEngine_Vector3_o *)(&v14 - 1) = ServantStatusFlavorTextListViewItemDrawText2__get_MessageLabelPosition(
                                                   v11,
                                                   v12),
          (newIcon = v11->fields.newIcon) == 0LL) )
    {
      sub_B170D4();
    }
    v16 = (float)((float)(v13 + v14) - (float)SHIDWORD(newIcon[5].klass)) + (float)SLODWORD(newIcon[13].klass);
  }
  else
  {
    v16 = y + (float)((float)v9 * -0.5);
  }
  v17 = x;
  v18 = z;
  result.fields.z = v18;
