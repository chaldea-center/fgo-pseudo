        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5755F & 1) == 0 )
  {
    sub_1B885B0(&Method_UnityEngine_GameObject_GetComponent_ServantStatusFlavorTextListViewItemDraw___);
    byte_4A5755F = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2ECEEB8 *)Method_UnityEngine_GameObject_GetComponent_ServantStatusFlavorTextListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.callbackFunc, (int32_t)callbackFunc, v13, v14);
  if ( (unsigned int)initMode <= 3 )
  {
    v16 = dword_BB3DA0[initMode];
    this->fields.dispMode = *((_DWORD *)&xmmword_BB49C0 + initMode);
  ...
  if ( v19 )
  {
    ...
    sub_1B88554(p_callbackFunc, 0, v17, v18);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantStatusFlavorTextListViewObject__Init_32636448(
        ServantStatusFlavorTextListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantStatusFlavorTextListViewObject__Init_32637780(
        ServantStatusFlavorTextListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantStatusFlavorTextListViewObject__Init_32637864(
        ServantStatusFlavorTextListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57566 & 1) == 0 )
  {
    sub_1B885B0(&StringLiteral_9858/*"OnClickListViewVoice"*/);
    byte_4A57566 = 1;
  }
  manager = (UnityEngine_Component_o *)this->fields.manager;
  if ( !manager )
    sub_1B8880C(0LL, method);
  UnityEngine_Component__SendMessage(manager, (System_String_o *)StringLiteral_9858/*"OnClickListViewVoice"*/, (Il2CppObject *)this, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !transform
    || (parent = UnityEngine_Transform__get_parent(transform, 0LL),
        ...
        sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.baseParent, (int32_t)parent, v6, v7),
        (transform = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0LL)) == 0LL)
        ...
        const MethodInfo *method)
{
  ...
  v12 = isOpen;
  v13 = isNew;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.mainInfo, (int32_t)item, id, isOpen);
  this->fields.id = id;
  this->fields.isOpen = v12;
  this->fields.isNew = v13;
  this->fields.messageData = text;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.messageData, (int32_t)text, v14, v15);
  this->fields.profileNum = profileNum;
  ServantStatusFlavorTextListViewObject__Init_32636448(this, 2, v16);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !*((_DWORD *)p_manager + 12) )
    ServantStatusFlavorTextListViewObject__Init_32636448(this, 2, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  v11 = (ServantStatusFlavorTextListViewObject_o *)sub_1B88ACC(v8);
    ...
    if ( !v10
      || (v13 = this->fields.basePosition.fields.y,
          *(UnityEngine_Vector3_o *)(&v14 - 1) = ServantStatusFlavorTextListViewItemDrawText2__get_MessageLabelPosition(
                                                   ...
                                                   v12),
          (klass = v10[3].klass) == 0LL) )
    {
      sub_1B8880C(v11, v12);
    }
    v16 = (float)((float)(v13 + v14) - (float)SHIDWORD(klass->_1.implementedInterfaces))
