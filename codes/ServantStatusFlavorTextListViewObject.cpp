        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A42C & 1) == 0 )
  {
    sub_1B761C0(&Method_UnityEngine_GameObject_GetComponent_ServantStatusFlavorTextListViewItemDraw___, method);
    byte_4A2A42C = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2EB19B8 *)Method_UnityEngine_GameObject_GetComponent_ServantStatusFlavorTextListViewItemDraw___);
  this->fields.itemDraw = (struct ServantStatusFlavorTextListViewItemDraw_o *)Component_object;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.itemDraw, (int32_t)Component_object, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A42E & 1) == 0 )
  {
    sub_1B761C0(&UnityEngine_BoxCollider_TypeInfo, method);
    sub_1B761C0(&Method_UnityEngine_Component_GetComponent_Collider___, v3);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.callbackFunc, (int32_t)callbackFunc, v13, v14);
  if ( (unsigned int)initMode <= 3 )
  {
    v16 = dword_BAC630[initMode];
    this->fields.dispMode = *((_DWORD *)&xmmword_BAD250 + initMode);
  ...
  if ( v19 )
  {
    ...
    sub_1B76164(p_callbackFunc, 0, v17, v18);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantStatusFlavorTextListViewObject__Init_32549468(
        ServantStatusFlavorTextListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantStatusFlavorTextListViewObject__Init_32550800(
        ServantStatusFlavorTextListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantStatusFlavorTextListViewObject__Init_32550884(
        ServantStatusFlavorTextListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A433 & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_9855/*"OnClickListViewVoice"*/, method);
    byte_4A2A433 = 1;
  }
  manager = (UnityEngine_Component_o *)this->fields.manager;
  if ( !manager )
    sub_1B7641C(0LL, method);
  UnityEngine_Component__SendMessage(manager, (System_String_o *)StringLiteral_9855/*"OnClickListViewVoice"*/, (Il2CppObject *)this, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !transform
    || (parent = UnityEngine_Transform__get_parent(transform, 0LL),
        ...
        sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.baseParent, (int32_t)parent, v6, v7),
        (transform = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0LL)) == 0LL)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A430 & 1) == 0 )
  {
    sub_1B761C0(&Method_UnityEngine_Component_GetComponent_Collider___, isInput);
        ...
        const MethodInfo *method)
{
  ...
  v12 = isOpen;
  v13 = isNew;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.mainInfo, (int32_t)item, id, isOpen);
  this->fields.id = id;
  this->fields.isOpen = v12;
  this->fields.isNew = v13;
  this->fields.messageData = text;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.messageData, (int32_t)text, v14, v15);
  this->fields.profileNum = profileNum;
  ServantStatusFlavorTextListViewObject__Init_32549468(this, 2, v16);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.manager, (int32_t)manager, (int32_t)method, v3);
  if ( !*((_DWORD *)p_manager + 12) )
    ServantStatusFlavorTextListViewObject__Init_32549468(this, 2, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A42F & 1) == 0 )
  {
    sub_1B761C0(&UnityEngine_Object_TypeInfo, isVisible);
    byte_4A2A42F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v11 = (ServantStatusFlavorTextListViewObject_o *)sub_1B766DC(v8);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B761C0(&UnityEngine_Object_TypeInfo, method);
    sub_1B761C0(&ServantStatusFlavorTextListViewItemDrawText2_TypeInfo, v3);
    byte_4A2A429 = 1;
  }
  x = this->fields.basePosition.fields.x;
  y = this->fields.basePosition.fields.y;
