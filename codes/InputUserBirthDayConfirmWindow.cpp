...
void __fastcall InputUserBirthDayConfirmWindow__Close(InputUserBirthDayConfirmWindow_o *this, const MethodInfo *method)
{
  ...
  InputUserBirthDayConfirmWindow__Close_30924700(this, 0LL, v2);
}


void __fastcall InputUserBirthDayConfirmWindow__Close_30924700(
        InputUserBirthDayConfirmWindow_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1B12D & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_InputUserBirthDayConfirmWindow_EndClose__, v5);
    byte_4A1B12D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1B12E & 1) == 0 )
  {
    sub_1B715CC(&Method_InputUserBirthDayConfirmWindow_OnClickCancel__, method);
    byte_4A1B12E = 1;
  }
  ...
  if ( (*((_BYTE *)Method_InputUserBirthDayConfirmWindow_OnClickCancel__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B715E4(Method_InputUserBirthDayConfirmWindow_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1B12C & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_InputUserBirthDayConfirmWindow_EndOpen__, v15);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1B12A & 1) == 0 )
  {
    sub_1B715CC(&InputUserBirthDayConfirmWindow_CallbackFunc_TypeInfo, value);
    byte_4A1B12A = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (InputUserBirthDayConfirmWindow_o *)sub_1B71AE8(v8);
        ...
        const MethodInfo *method)
{
  if ( (byte_4A1B12F & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_3179/*"BaseWindow/CancleBtn"*/, method);
    byte_4A1B12F = 1;
  }
  return (System_String_o *)StringLiteral_3179/*"BaseWindow/CancleBtn"*/;
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19B2360;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19B2318;
}
