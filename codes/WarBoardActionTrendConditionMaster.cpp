        ...
        const MethodInfo *method)
{
  ...
  DataMasterBase_object__object__int____ctor(
    ...
    343,
    (const MethodInfo_319B678 *)Method_DataMasterBase_WarBoardActionTrendConditionMaster__WarBoardActionTrendConditionEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  *condType = 0;
  if ( !condEntityArray )
LABEL_17:
    sub_1B4D1EC(condEntityArray, matchCond);
...
LABEL_18:
        sub_1B4D1F4(condEntityArray, matchCond);
      v10 = v5->m_Items[v9];
      if ( !v10 )
        goto LABEL_17;
