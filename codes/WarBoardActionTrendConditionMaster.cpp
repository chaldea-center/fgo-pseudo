        ...
        const MethodInfo *method)
{
  ...
  DataMasterBase_object__object__int____ctor(
    ...
    343,
    (const MethodInfo_3211F5C *)Method_DataMasterBase_WarBoardActionTrendConditionMaster__WarBoardActionTrendConditionEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  *condType = 0;
  if ( !condEntityArray )
LABEL_17:
    sub_1B86614(condEntityArray, matchCond);
...
LABEL_18:
        sub_1B8661C(condEntityArray, matchCond);
      v10 = v5->m_Items[v9];
      if ( !v10 )
        goto LABEL_17;
