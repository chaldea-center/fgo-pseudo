System_String_o *ExternalPaymentReflectRequest__getURL(ExternalPaymentReflectRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC8F50 & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_19402/*"externalPayment/reflect"*/);
    byte_4CC8F50 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64031724(BaseUrl, (System_String_o *)StringLiteral_19402/*"externalPayment/reflect"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC8F51 & 1) == 0 )
  {
    ...
    this = (ExternalPaymentReflectRequest_o *)sub_1C713B0(&StringLiteral_22316/*"ng"*/);
    byte_4CC8F51 = 1;
  }
  if ( !responseList )
    goto LABEL_15;
