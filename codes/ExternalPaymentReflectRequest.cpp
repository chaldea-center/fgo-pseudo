...
System_String_o *ExternalPaymentReflectRequest__getURL(ExternalPaymentReflectRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C394E7 & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_19338/*"externalPayment/reflect"*/);
    byte_4C394E7 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63518544(BaseUrl, (System_String_o *)StringLiteral_19338/*"externalPayment/reflect"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C394E8 & 1) == 0 )
  {
    ...
    this = (ExternalPaymentReflectRequest_o *)sub_1C32C20(&StringLiteral_22212/*"ng"*/);
    byte_4C394E8 = 1;
  }
  if ( !responseList )
    goto LABEL_12;
...
LABEL_12:
  ...
  {
    v7 = (System_String_o *)StringLiteral_22212/*"ng"*/;
  }
