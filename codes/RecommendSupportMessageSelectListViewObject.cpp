        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFDECE & 1) == 0 )
  {
    sub_1BC3008(&Method_UnityEngine_GameObject_GetComponent_RecommendSupportMessageSelectListViewItemDraw___, method);
    byte_4AFDECE = 1;
  }
  ...
  if ( !dispObject
    || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                             dispObject,
                             (const MethodInfo_3055998 *)Method_UnityEngine_GameObject_GetComponent_RecommendSupportMessageSelectListViewItemDraw___),
        ...
        sub_1BC2FAC((CGThumbnailListItem_o *)p_itemDraw, (int32_t)Component_object, v7, v8),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFDED0 & 1) == 0 )
  {
    sub_1BC3008(&RecommendSupportMessageSelectListViewItem_TypeInfo, method);
    byte_4AFDED0 = 1;
  }
...
void __fastcall RecommendSupportMessageSelectListViewObject__SetItem_33840176(
        RecommendSupportMessageSelectListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
