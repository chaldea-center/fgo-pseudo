        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB1F55 & 1) == 0 )
  {
    sub_1BAB41C(&Method_UnityEngine_GameObject_GetComponent_RecommendSupportMessageSelectListViewItemDraw___, method);
    byte_4AB1F55 = 1;
  }
  ...
  if ( !dispObject
    || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                             dispObject,
                             (const MethodInfo_2F13970 *)Method_UnityEngine_GameObject_GetComponent_RecommendSupportMessageSelectListViewItemDraw___),
        ...
        sub_1BAB3C0((ServantStatusBattleListViewItem_o *)p_itemDraw, (int32_t)Component_object, v7, v8),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB1F57 & 1) == 0 )
  {
    sub_1BAB41C(&RecommendSupportMessageSelectListViewItem_TypeInfo, method);
    byte_4AB1F57 = 1;
  }
...
void __fastcall RecommendSupportMessageSelectListViewObject__SetItem_32820368(
        RecommendSupportMessageSelectListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
