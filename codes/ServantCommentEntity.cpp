void __fastcall ServantCommentEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BDCC3A & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_23208/*"readJudgeKey"*/);
    sub_1C21E38(&StringLiteral_18510/*"condTitle"*/);
    sub_1C21E38(&StringLiteral_23587/*"setLabel"*/);
    sub_1C21E38(&StringLiteral_20591/*"imageLimit"*/);
    byte_4BDCC3A = 1;
  }
  ServantCommentEntity_TypeInfo->static_fields->SCRIPT_IMAGE_LIMIT = (struct System_String_o *)StringLiteral_20591/*"imageLimit"*/;
  sub_1C21DDC(
    (PartyOrganizationUtility_o *)ServantCommentEntity_TypeInfo->static_fields,
    StringLiteral_20591/*"imageLimit"*/,
    v1,
    v2,
    v3,
    v4,
    v5,
    v6);
  v7 = StringLiteral_18510/*"condTitle"*/;
  static_fields = ServantCommentEntity_TypeInfo->static_fields;
  static_fields->SCRIPT_COND_TITLE = (struct System_String_o *)StringLiteral_18510/*"condTitle"*/;
  sub_1C21DDC((PartyOrganizationUtility_o *)&static_fields->SCRIPT_COND_TITLE, v7, v9, v10, v11, v12, v13, v14);
  v15 = StringLiteral_23587/*"setLabel"*/;
  v16 = ServantCommentEntity_TypeInfo->static_fields;
  v16->SCRIPT_LABEL_TYPE = (struct System_String_o *)StringLiteral_23587/*"setLabel"*/;
  sub_1C21DDC((PartyOrganizationUtility_o *)&v16->SCRIPT_LABEL_TYPE, v15, v17, v18, v19, v20, v21, v22);
  v23 = StringLiteral_23208/*"readJudgeKey"*/;
  v24 = ServantCommentEntity_TypeInfo->static_fields;
  v24->SCRIPT_READ_JUDGE = (struct System_String_o *)StringLiteral_23208/*"readJudgeKey"*/;
  sub_1C21DDC((PartyOrganizationUtility_o *)&v24->SCRIPT_READ_JUDGE, v23, v25, v26, v27, v28, v29, v30);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDCC2F & 1) == 0 )
  {
    textType = (System_String_o *)sub_1C21E38(&CondType_TypeInfo);
    byte_4BDCC2F = 1;
  }
  if ( condValues )
  {
    ...
    {
      if ( !(_DWORD)v11 )
        sub_1C2209C(textType, *(_QWORD *)&condType);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDCC35 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_ServantCommentEntity___c__GetScriptIntArray_b__30_0__);
    sub_1C21E38(&ServantCommentEntity___c_TypeInfo);
  ...
  if ( !_9__30_0 )
  {
    ...
    _9__30_0 = (System_Func_object__int__o *)sub_1C22084(System_Func_string__int__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C21E38(&CondType_TypeInfo);
    this = (ServantCommentEntity_o *)sub_1C21E38(&NetworkManager_TypeInfo);
    byte_4BDCC2A = 1;
  }
    ...
    if ( (int)v8 >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( v13 != questId )
        {
          ...
          if ( !CondType_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
          this = (ServantCommentEntity_o *)CondType__IsQuestPhaseClear(userIdNumber, v13, condValue2, -1, 0, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDCC29 & 1) == 0 )
  {
    ...
    sub_1C21E38(&NetworkManager_TypeInfo);
    this = (ServantCommentEntity_o *)sub_1C21E38(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4BDCC29 = 1;
  }
  condValues = v6->fields.condValues;
  if ( condValues )
    ...
    if ( (int)*(_QWORD *)&condValues->max_length >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( condType == 1 )
        {
          ...
          if ( !CondType_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
          this = (ServantCommentEntity_o *)CondType__IsQuestPhaseClear(userIdNumber, v11, condValue2, -1, 0, 0LL);
          if ( ((unsigned __int8)this & 1) != 0 )
            goto LABEL_46;
        }
        else if ( (oldFriendShipRank & 0x80000000) != 0 || condType != 9 )
        {
          ...
          if ( !CondType_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
          this = (ServantCommentEntity_o *)CondType__IsOpen_38874632(condType, v11, v17, svtId, 0LL);
          if ( ((unsigned __int8)this & 1) != 0 )
          {
LABEL_46:
            addCheck = v30;
  ...
  else
  {
    ...
    if ( (oldFriendShipRank & 0x80000000) != 0 || v19 != 9 )
    {
      ...
      if ( !CondType_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
      IsQuestPhaseClear = CondType__IsOpen_38874632(v19, v24, v27, v26, 0LL);
      if ( !IsQuestPhaseClear )
        return IsQuestPhaseClear;
    }
    else
...
LABEL_60:
  if ( !addCheck )
    return IsQuestPhaseClear;
  this = (ServantCommentEntity_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_388D058 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this
    || (this = (ServantCommentEntity_o *)DataManager__GetMasterData_object_(
                                           (DataManager_o *)this,
                                           (const MethodInfo_2FAFE04 *)Method_DataManager_GetMasterData_ServantCommentAddMaster___)) == 0LL )
  {
LABEL_33:
...
void __fastcall ServantCommentEntity___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C22084(ServantCommentEntity___c_TypeInfo);
