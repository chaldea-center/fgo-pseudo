void ServantCommentEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CB6B78 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_23064/*"readJudgeKey"*/);
    sub_1C6BA08(&StringLiteral_18232/*"condTitle"*/);
    sub_1C6BA08(&StringLiteral_23432/*"setLabel"*/);
    sub_1C6BA08(&StringLiteral_20352/*"imageLimit"*/);
    sub_1C6BA08(&StringLiteral_20992/*"isHideUntilCond"*/);
    byte_4CB6B78 = 1;
  }
  ServantCommentEntity_TypeInfo->static_fields->SCRIPT_IMAGE_LIMIT = (struct System_String_o *)StringLiteral_20352/*"imageLimit"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)ServantCommentEntity_TypeInfo->static_fields, StringLiteral_20352/*"imageLimit"*/, v1, v2);
  v3 = StringLiteral_18232/*"condTitle"*/;
  static_fields = ServantCommentEntity_TypeInfo->static_fields;
  static_fields->SCRIPT_COND_TITLE = (struct System_String_o *)StringLiteral_18232/*"condTitle"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)&static_fields->SCRIPT_COND_TITLE, v3, v5, v6);
  v7 = StringLiteral_23432/*"setLabel"*/;
  v8 = ServantCommentEntity_TypeInfo->static_fields;
  v8->SCRIPT_LABEL_TYPE = (struct System_String_o *)StringLiteral_23432/*"setLabel"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)&v8->SCRIPT_LABEL_TYPE, v7, v9, v10);
  v11 = StringLiteral_23064/*"readJudgeKey"*/;
  v12 = ServantCommentEntity_TypeInfo->static_fields;
  v12->SCRIPT_READ_JUDGE = (struct System_String_o *)StringLiteral_23064/*"readJudgeKey"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)&v12->SCRIPT_READ_JUDGE, v11, v13, v14);
  v15 = StringLiteral_20992/*"isHideUntilCond"*/;
  v16 = ServantCommentEntity_TypeInfo->static_fields;
  v16->SCRIPT_HIDE_UNTIL_COND = (struct System_String_o *)StringLiteral_20992/*"isHideUntilCond"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)&v16->SCRIPT_HIDE_UNTIL_COND, v15, v17, v18);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB6B6C & 1) == 0 )
  {
    textType = (System_String_o *)sub_1C6BA08(&CondType_TypeInfo);
    byte_4CB6B6C = 1;
  }
  if ( condValues )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB6B72 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_ServantCommentEntity___c__GetScriptIntArray_b__31_0__);
    sub_1C6BA08(&ServantCommentEntity___c_TypeInfo);
  ...
  if ( !_9__31_0 )
  {
    ...
    _9__31_0 = (System_Func_object__int__o *)sub_1C6BC54(System_Func_string__int__TypeInfo);
    ...
    sub_1C6B9AC((CGThumbnailListItem_o *)&static_fields->__9__31_0, (int32_t)_9__31_0, v16, v17);
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C6BA08(&CondType_TypeInfo);
    this = (ServantCommentEntity_o *)sub_1C6BA08(&NetworkManager_TypeInfo);
    byte_4CB6B67 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB6B66 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&NetworkManager_TypeInfo);
    this = (ServantCommentEntity_o *)sub_1C6BA08(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4CB6B66 = 1;
  }
  condValues = v6->fields.condValues;
  if ( condValues )
    ...
    if ( (int)condValues->max_length >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        else if ( oldFriendShipRank < 0 || condType != 9 )
        {
          ...
          if ( !CondType_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
          this = (ServantCommentEntity_o *)CondType__IsOpen_40597736(condType, v11, v17, svtId, 0);
          if ( ((unsigned __int8)this & 1) != 0 )
          {
LABEL_46:
            addCheck = v30;
  ...
  else
  {
    ...
    if ( oldFriendShipRank < 0 || v19 != 9 )
    {
      ...
      if ( !CondType_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
      IsQuestPhaseClear = CondType__IsOpen_40597736(v19, v24, v27, v26, 0);
      if ( !IsQuestPhaseClear )
        return IsQuestPhaseClear;
    }
    else
...
LABEL_60:
  if ( !addCheck )
    return IsQuestPhaseClear;
  this = (ServantCommentEntity_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A4F3B4 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this
    || (this = (ServantCommentEntity_o *)DataManager__GetMasterData_object_(
                                           (DataManager_o *)this,
                                           (const MethodInfo_313B368 *)Method_DataManager_GetMasterData_ServantCommentAddMaster___)) == 0 )
  {
LABEL_33:
...
void ServantCommentEntity___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C6BC54(ServantCommentEntity___c_TypeInfo);
  System_Object___ctor(v1, 0);
  ServantCommentEntity___c_TypeInfo->static_fields->__9 = (struct ServantCommentEntity___c_o *)v1;
  sub_1C6B9AC((CGThumbnailListItem_o *)ServantCommentEntity___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
