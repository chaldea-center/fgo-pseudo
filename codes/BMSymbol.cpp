...
bool BMSymbol__Validate(BMSymbol_o *this, UIAtlas_o *atlas, const MethodInfo *method)
{
  ...
  if ( !this->fields.mIsValid )
  {
    ...
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.mSprite, (int32_t)Sprite, v7, v8, v9, v10, v11, v12);
    ...
    if ( atlas )
    {
      ...
      {
        *p_mSprite = 0;
        sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.mSprite, 0, v16, v17, v18, v19, v20, v21);
        return this->fields.mSprite != 0;
      }
      v22 = (int *)*p_mSprite;
      if ( *p_mSprite )
