        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B03699 & 1) == 0 )
  {
    sub_1BC3008(&int_TypeInfo, callback);
    sub_1BC3008(&SoundManager_TypeInfo, v7);
    sub_1BC3008(&StringLiteral_24957/*"{0}_{1}"*/, v8);
    byte_4B03699 = 1;
  }
  ...
  v11 = System_String__Format_62389940((System_String_o *)StringLiteral_24957/*"{0}_{1}"*/, voiceDataStr, v10, 0LL);
  this->fields.voicePath = v11;
  p_voicePath = &this->fields.voicePath;
  sub_1BC2FAC((CGThumbnailListItem_o *)p_voicePath, (int32_t)v11, v13, v14);
  v15 = *p_voicePath;
