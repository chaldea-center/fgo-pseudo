        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4601F & 1) == 0 )
  {
    sub_1BDB878(&int_TypeInfo, callback);
  ...
  v11 = System_String__Format_62613552((System_String_o *)StringLiteral_25286/*"{0}_{1}"*/, voiceDataStr, v10, 0LL);
  this->fields.voicePath = v11;
  p_voicePath = &this->fields.voicePath;
  sub_1BDB81C((CGThumbnailListItem_o *)p_voicePath, (int32_t)v11, v13, v14);
  v15 = *p_voicePath;
