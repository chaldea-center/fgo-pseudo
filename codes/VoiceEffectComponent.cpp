        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1DBA2 & 1) == 0 )
  {
    sub_1BCAFF8(&int_TypeInfo, callback);
    sub_1BCAFF8(&SoundManager_TypeInfo, v7);
    sub_1BCAFF8(&StringLiteral_24978/*"{0}_{1}"*/, v8);
    byte_4B1DBA2 = 1;
  }
  ...
  v11 = System_String__Format_62491716((System_String_o *)StringLiteral_24978/*"{0}_{1}"*/, voiceDataStr, v10, 0LL);
  this->fields.voicePath = v11;
  p_voicePath = &this->fields.voicePath;
  sub_1BCAF9C((CGThumbnailListItem_o *)p_voicePath, (int32_t)v11, v13, v14);
  v15 = *p_voicePath;
