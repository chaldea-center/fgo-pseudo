        ...
        const MethodInfo *method)
{
  ...
  v9 = System_String__Format_61721404((System_String_o *)StringLiteral_25098/*"{0}_{1}"*/, voiceDataStr, v8, 0LL);
  this->fields.voicePath = v9;
  p_voicePath = &this->fields.voicePath;
  sub_1B88554((ServantStatusBattleListViewItem_o *)p_voicePath, (int32_t)v9, v11, v12);
  v13 = *p_voicePath;
