...
void __fastcall CombineHelpListViewObject__Awake(CombineHelpListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42E999D & 1) == 0 )
  {
    sub_B5D5C4(&Method_UnityEngine_GameObject_GetComponent_CombineHelpListViewItemDraw___, (_DWORD)method, v2, v3);
    byte_42E999D = 1;
  }
  ...
  Component_srcLineSprite = (struct CombineHelpListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                                      dispObject,
                                                                      (const MethodInfo_1CC439C *)Method_UnityEngine_GameObject_GetComponent_CombineHelpListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  CombineHelpListViewObject_o *v8; // x20
  const MethodInfo *v9; // x3
  UnityEngine_Vector3_o zero; // 0:s0.4,4:s1.4,8:s2.4 OVERLAPPED

  if ( (byte_42E99A0 & 1) == 0 )
  {
    sub_B5D5C4(&Method_UnityEngine_GameObject_GetComponent_CombineHelpListViewObject___, (_DWORD)method, v2, v3);
    byte_42E99A0 = 1;
  }
  ...
  if ( !DragObject
    || (v7 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                    DragObject,
                                                    (const MethodInfo_1CC439C *)Method_UnityEngine_GameObject_GetComponent_CombineHelpListViewObject___)) == 0LL) )
  {
    sub_B5D69C(DragObject, v6);
  }
  v8 = (CombineHelpListViewObject_o *)DragObject;
  zero = UnityEngine_Vector3__get_zero(0LL);
  CombineHelpListViewObject__Init(v8, 2, 0LL, zero.fields.x, *(UnityEngine_Vector3_o *)&zero.fields.y, v9);
  return v7;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42E999F & 1) == 0 )
  {
    sub_B5D5C4(&CombineHelpListViewItem_TypeInfo, (_DWORD)method, v2, v3);
    byte_42E999F = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
    return 0LL;
  v6 = *(&CombineHelpListViewItem_TypeInfo->_2.bitflags2 + 1);
  if ( *(&linkItem->klass->_2.bitflags2 + 1) < (unsigned int)v6 )
    return 0LL;
  if ( (CombineHelpListViewItem_c *)linkItem->klass->_2.typeHierarchy[v6 - 1] == CombineHelpListViewItem_TypeInfo )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42E99A1 & 1) == 0 )
  {
    sub_B5D5C4(&CombineHelpListViewItem_TypeInfo, initMode, (_DWORD)callbackFunc, method);
    byte_42E99A1 = 1;
  }
  linkItem = this->fields.linkItem;
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineHelpListViewObject__Init_26975700(
        CombineHelpListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineHelpListViewObject__Init_26976244(
        CombineHelpListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineHelpListViewObject__Init_26976784(
        CombineHelpListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall CombineHelpListViewObject__SetupDisp(CombineHelpListViewObject_o *this, const MethodInfo *method)
{
  ...
  CombineHelpListViewItemDraw_o *v14; // x0
  ...
  if ( linkItem )
  {
    v9 = *(&CombineHelpListViewItem_TypeInfo->_2.bitflags2 + 1);
    if ( *(&linkItem->klass->_2.bitflags2 + 1) >= (unsigned int)v9
      && (CombineHelpListViewItem_c *)linkItem->klass->_2.typeHierarchy[v9 - 1] == CombineHelpListViewItem_TypeInfo )
    {
...
LABEL_8:
  ...
  if ( UnityEngine_Object__op_Inequality(itemDraw, 0LL, 0LL) )
  {
    ...
    if ( !v14 )
      sub_B5D69C(0LL, v12);
    CombineHelpListViewItemDraw__SetItem(v14, (CombineHelpListViewItem_o *)linkItem, this->fields.dispMode, v13);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  v12 = (CombineHelpListViewObject_o *)sub_B5D990(v9);
