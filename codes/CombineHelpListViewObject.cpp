...
void CombineHelpListViewObject__Awake(CombineHelpListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E7B89B & 1) == 0 )
  {
    sub_1D0F0B4(&Method_UnityEngine_GameObject_GetComponent_CombineHelpListViewItemDraw___);
    byte_4E7B89B = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_32A8444 *)Method_UnityEngine_GameObject_GetComponent_CombineHelpListViewItemDraw___);
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_32A8444 *)Method_UnityEngine_GameObject_GetComponent_CombineHelpListViewObject___)) == 0) )
  {
    sub_1D0F30C(DragObject, v4);
  }
  CombineHelpListViewObject__Init_50130656((CombineHelpListViewObject_o *)DragObject, 2, v6);
  return v5;
}
...
void CombineHelpListViewObject__Init_50130656(
        CombineHelpListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void CombineHelpListViewObject__Init_50131252(
        CombineHelpListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void CombineHelpListViewObject__Init_50131840(
        CombineHelpListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
