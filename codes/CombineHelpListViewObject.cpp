...
void CombineHelpListViewObject__Awake(CombineHelpListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2B23B & 1) == 0 )
  {
    sub_1C2D490(&Method_UnityEngine_GameObject_GetComponent_CombineHelpListViewItemDraw___);
    byte_4C2B23B = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_3125ED0 *)Method_UnityEngine_GameObject_GetComponent_CombineHelpListViewItemDraw___);
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_3125ED0 *)Method_UnityEngine_GameObject_GetComponent_CombineHelpListViewObject___)) == 0) )
  {
    sub_1C2D6EC(DragObject, v4);
  }
  CombineHelpListViewObject__Init_48270152((CombineHelpListViewObject_o *)DragObject, 2, v6);
  return v5;
}
...
void CombineHelpListViewObject__Init_48270152(
        CombineHelpListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void CombineHelpListViewObject__Init_48270748(
        CombineHelpListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void CombineHelpListViewObject__Init_48271336(
        CombineHelpListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
