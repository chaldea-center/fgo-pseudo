...
void __fastcall CombineHelpListViewObject__Awake(CombineHelpListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B0F3B & 1) == 0 )
  {
    sub_B52984(&Method_UnityEngine_GameObject_GetComponent_CombineHelpListViewItemDraw___);
    byte_42B0F3B = 1;
  }
  ...
  Component_srcLineSprite = (struct CombineHelpListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                                      dispObject,
                                                                      (const MethodInfo_1B7B1B8 *)Method_UnityEngine_GameObject_GetComponent_CombineHelpListViewItemDraw___);
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                    DragObject,
                                                    (const MethodInfo_1B7B1B8 *)Method_UnityEngine_GameObject_GetComponent_CombineHelpListViewObject___)) == 0LL) )
  {
    sub_B52A5C(DragObject, v4);
  }
  v6 = (CombineHelpListViewObject_o *)DragObject;
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineHelpListViewObject__Init_26747192(
        CombineHelpListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineHelpListViewObject__Init_26747736(
        CombineHelpListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CombineHelpListViewObject__Init_26748276(
        CombineHelpListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall CombineHelpListViewObject__SetupDisp(CombineHelpListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( linkItem )
  {
    v4 = *(&CombineHelpListViewItem_TypeInfo->_2.bitflags2 + 1);
    if ( *(&linkItem->klass->_2.bitflags2 + 1) >= (unsigned int)v4
      && (CombineHelpListViewItem_c *)linkItem->klass->_2.typeHierarchy[v4 - 1] == CombineHelpListViewItem_TypeInfo )
    {
        ...
        const MethodInfo *method)
{
  ...
  v11 = (CombineHelpListViewObject_o *)sub_B52D50(v8);
