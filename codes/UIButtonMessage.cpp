...
void UIButtonMessage__Send(UIButtonMessage_o *this, const MethodInfo *method)
{
  ...
  UnityEngine_Component_o *ComponentsInChildren_object__52198636; // x0
  __int64 v5; // x1
  ...
  if ( !System_String__IsNullOrEmpty(this->fields.functionName, 0) )
  {
    ...
    ComponentsInChildren_object__52198636 = (UnityEngine_Component_o *)UnityEngine_Object__op_Equality(target, 0, 0);
    if ( ((unsigned __int8)ComponentsInChildren_object__52198636 & 1) != 0 )
    {
      gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0);
      this->fields.target = gameObject;
      sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.target, (int32_t)gameObject, v7, v8, v9, v10, v11, v12);
    }
    ...
    if ( this->fields.includeChildren )
    {
      if ( v13 )
      {
        ComponentsInChildren_object__52198636 = (UnityEngine_Component_o *)UnityEngine_GameObject__GetComponentsInChildren_object__52198636(
                                                                             this->fields.target,
        ...
        {
          klass = ComponentsInChildren_object__52198636[1].klass;
          ...
          while ( 1 )
          {
            ComponentsInChildren_object__52198636 = (UnityEngine_Component_o *)*((_QWORD *)&v15[1].monitor + v17);
            if ( !ComponentsInChildren_object__52198636 )
              break;
            v18 = UnityEngine_Component__get_gameObject(ComponentsInChildren_object__52198636, 0);
            functionName = this->fields.functionName;
            v20 = v18;
            ComponentsInChildren_object__52198636 = (UnityEngine_Component_o *)UnityEngine_Component__get_gameObject(
            ...
            UnityEngine_GameObject__SendMessage_71850432(
              v20,
              functionName,
              (Il2CppObject *)ComponentsInChildren_object__52198636,
              1,
              0);
            if ( v16 == v17 )
              return;
