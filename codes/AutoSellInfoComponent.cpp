        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E00CB4 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_16073/*"[FF0000]{0}{1:#,0}[-]"*/);
    byte_4E00CB4 = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0);
  if ( !gameObject )
...
LABEL_12:
      ...
      gameObject = (UnityEngine_GameObject_o *)System_String__Format_65164136(
                                                 (System_String_o *)StringLiteral_25619/*"{0}{1:#,0}"*/,
                                                 v13,
                                                 v17,
                                                 0);
      if ( !manaLabel )
    ...
    else
    {
      ...
      if ( v21 <= 0 )
      {
        ...
        v23 = (System_String_o *)StringLiteral_16073/*"[FF0000]{0}{1:#,0}[-]"*/;
      }
      else
      {
        LODWORD(v35) = v21;
        v22 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v35);
        v23 = (System_String_o *)StringLiteral_25619/*"{0}{1:#,0}"*/;
      }
      gameObject = (UnityEngine_GameObject_o *)System_String__Format_65164136(v23, v13, v22, 0);
      if ( !v20 )
        goto LABEL_37;
      v18 = (System_String_o *)gameObject;
      v19 = v20;
  ...
  if ( befQp != -1 )
  {
    ...
    if ( befQp + qp >= QpMax )
    {
      ...
      if ( v32 <= 0 )
      {
        ...
        v34 = (System_String_o *)StringLiteral_16073/*"[FF0000]{0}{1:#,0}[-]"*/;
      }
      else
      {
        v35 = v32;
        v33 = (Il2CppObject *)j_il2cpp_value_box_0(long_TypeInfo, &v35);
        v34 = (System_String_o *)StringLiteral_25619/*"{0}{1:#,0}"*/;
      }
      gameObject = (UnityEngine_GameObject_o *)System_String__Format_65164136(v34, PlusOperatorString, v33, 0);
      if ( qpLabel )
      {
