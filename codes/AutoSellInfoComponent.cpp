        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B73CF & 1) == 0 )
  {
    sub_1B4CF90(&BalanceConfig_TypeInfo, *(_QWORD *)&mana);
    sub_1B4CF90(&int_TypeInfo, v11);
    sub_1B4CF90(&StringLiteral_24808/*"{0}{1:#,0}"*/, v12);
    sub_1B4CF90(&StringLiteral_15628/*"[FF0000]{0}{1:#,0}[-]"*/, v13);
    byte_49B73CF = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  if ( !gameObject )
...
LABEL_12:
      ...
      gameObject = (UnityEngine_GameObject_o *)System_String__Format_61134760(
                                                 (System_String_o *)StringLiteral_24808/*"{0}{1:#,0}"*/,
                                                 v16,
                                                 v23,
                                                 0LL);
      if ( !manaLabel )
    ...
    else
    {
      ...
      if ( v27 <= 0 )
      {
        ...
        v29 = (System_String_o *)StringLiteral_15628/*"[FF0000]{0}{1:#,0}[-]"*/;
      }
      else
      {
        v44 = v27;
        v28 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v44, v17, v18, v19);
        v29 = (System_String_o *)StringLiteral_24808/*"{0}{1:#,0}"*/;
      }
      gameObject = (UnityEngine_GameObject_o *)System_String__Format_61134760(v29, v16, v28, 0LL);
      if ( !v26 )
        goto LABEL_37;
      v24 = (System_String_o *)gameObject;
      v25 = v26;
  ...
  if ( befQp != -1 )
  {
    ...
    if ( befQp + qp >= QpMax )
    {
      ...
      if ( v41 <= 0 )
      {
        ...
        v43 = (System_String_o *)StringLiteral_15628/*"[FF0000]{0}{1:#,0}[-]"*/;
      }
      else
      {
        v44 = v41;
        v42 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v44, v30, v31, v32);
        v43 = (System_String_o *)StringLiteral_24808/*"{0}{1:#,0}"*/;
      }
      gameObject = (UnityEngine_GameObject_o *)System_String__Format_61134760(v43, PlusOperatorString, v42, 0LL);
      if ( qpLabel )
      {
