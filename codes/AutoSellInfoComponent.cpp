        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FACC8 & 1) == 0 )
  {
    sub_1B64870(&BalanceConfig_TypeInfo, *(_QWORD *)&mana);
    sub_1B64870(&int_TypeInfo, v11);
    sub_1B64870(&StringLiteral_25007/*"{0}{1:#,0}"*/, v12);
    sub_1B64870(&StringLiteral_15868/*"[FF0000]{0}{1:#,0}[-]"*/, v13);
    byte_49FACC8 = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  if ( !gameObject )
...
LABEL_12:
    ...
    else
    {
      ...
      gameObject = (UnityEngine_GameObject_o *)System_String__Format_61397948(v29, v16, v28, 0LL);
      if ( !v26 )
        goto LABEL_37;
      v24 = (System_String_o *)gameObject;
      v25 = v26;
  ...
  if ( befQp != -1 )
  {
    ...
    if ( befQp + qp >= QpMax )
    {
      ...
      gameObject = (UnityEngine_GameObject_o *)System_String__Format_61397948(v43, PlusOperatorString, v42, 0LL);
      if ( qpLabel )
      {
