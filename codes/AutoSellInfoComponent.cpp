        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A578A7 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_15934/*"[FF0000]{0}{1:#,0}[-]"*/);
    byte_4A578A7 = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  if ( !gameObject )
...
LABEL_12:
      ...
      gameObject = (UnityEngine_GameObject_o *)System_String__Format_61721404(
                                                 (System_String_o *)StringLiteral_25104/*"{0}{1:#,0}"*/,
                                                 v13,
                                                 v20,
                                                 0LL);
      if ( !manaLabel )
    ...
    else
    {
      ...
      if ( v24 <= 0 )
      {
        ...
        v26 = (System_String_o *)StringLiteral_15934/*"[FF0000]{0}{1:#,0}[-]"*/;
      }
      else
      {
        v41 = v24;
        v25 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v41, v14, v15, v16);
        v26 = (System_String_o *)StringLiteral_25104/*"{0}{1:#,0}"*/;
      }
      gameObject = (UnityEngine_GameObject_o *)System_String__Format_61721404(v26, v13, v25, 0LL);
      if ( !v23 )
        goto LABEL_37;
      v21 = (System_String_o *)gameObject;
      v22 = v23;
  ...
  if ( befQp != -1 )
  {
    ...
    if ( befQp + qp >= QpMax )
    {
      ...
      if ( v38 <= 0 )
      {
        ...
        v40 = (System_String_o *)StringLiteral_15934/*"[FF0000]{0}{1:#,0}[-]"*/;
      }
      else
      {
        v41 = v38;
        v39 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v41, v27, v28, v29);
        v40 = (System_String_o *)StringLiteral_25104/*"{0}{1:#,0}"*/;
      }
      gameObject = (UnityEngine_GameObject_o *)System_String__Format_61721404(v40, PlusOperatorString, v39, 0LL);
      if ( qpLabel )
      {
