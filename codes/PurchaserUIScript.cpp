...
void PurchaserUIScript__ClearLog(PurchaserUIScript_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C428F3 & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_15999/*"[purchase log]\n"*/);
    byte_4C428F3 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(puchaserLogLabel, 0, 0) )
  {
    ...
    if ( UnityEngine_Behaviour__get_isActiveAndEnabled((UnityEngine_Behaviour_o *)v4, 0) )
    {
      ...
      if ( v4 )
      {
        UILabel__set_text(v4, (System_String_o *)StringLiteral_15999/*"[purchase log]\n"*/, 0);
        return;
      }
LABEL_11:
      sub_1C372B4(v4);
...
void PurchaserUIScript__CopyLogToClipboard(PurchaserUIScript_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(puchaserLogLabel, 0, 0) )
  {
    ...
    if ( !v5 )
LABEL_13:
      sub_1C372B4(isActiveAndEnabled);
...
void PurchaserUIScript__Purchase(PurchaserUIScript_o *this, int32_t index, const MethodInfo *method)
{
  ...
  if ( (byte_4C428F5 & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_PurchaserUIScript___c__Purchase_b__8_0__);
    sub_1C37058(&PurchaserUIScript___c_TypeInfo);
    byte_4C428F5 = 1;
  }
      ...
      & 1) != 0 )
  {
    ...
    if ( !v8 )
    {
      ...
      v8 = (PurchaseLogic_ProductFinishedAction_o *)sub_1C372A4(PurchaseLogic_ProductFinishedAction_TypeInfo);
      ...
      sub_1C36FFC((CGThumbnailListItem_o *)&static_fields->__9__8_0, (int32_t)v8, v12, v13);
    }
    ...
    if ( productIdCollection )
    {
      ...
      if ( v15 )
      {
        ...
        if ( purchaseLogic )
        {
          PurchaseLogic__InitiatePurchase_41435968(
            purchaseLogic,
            index + 1,
...
void PurchaserUIScript__Start(PurchaserUIScript_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C428F2 & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_PurchaserUIScript__Start_b__5_0__);
    sub_1C37058(&Method_PurchaserUIScript__Start_b__5_1__);
  ...
  v12 = (System_Action_object__o *)sub_1C372A4(System_Action_string__TypeInfo);
  ...
  if ( !v11
    ...
    || (purchaseLogic[2].monitor = v12,
        sub_1C36FFC((CGThumbnailListItem_o *)&purchaseLogic[2].monitor, (int32_t)v12, v13, v14),
        v15 = this->fields._purchaseBehaviour,
        v16 = (System_Action_object__o *)sub_1C372A4(System_Action_string__TypeInfo),
...
LABEL_27:
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&purchaseLogic[2].fields, (int32_t)v16, v17, v18);
}
...
void PurchaserUIScript___Start_b__5_0(PurchaserUIScript_o *this, System_String_o *str, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(puchaserLogLabel, 0, 0) )
  {
    ...
    if ( ((unsigned __int8)isActiveAndEnabled & 1) != 0 )
    {
      ...
      if ( v7 )
      {
        v8 = System_String__Concat_63599904(v7->fields.mText, str, (System_String_o *)StringLiteral_43/*"\n"*/, 0);
...
void PurchaserUIScript___Start_b__5_1(PurchaserUIScript_o *this, System_String_o *str, const MethodInfo *method)
{
  ...
  if ( (byte_4C428F7 & 1) == 0 )
  {
    ...
    sub_1C37058(&UnityEngine_Object_TypeInfo);
    sub_1C37058(&StringLiteral_43/*"\n"*/);
    sub_1C37058(&StringLiteral_15950/*"[UnityIAP]課金エラー:"*/);
    byte_4C428F7 = 1;
  }
  v5 = (Il2CppObject *)System_String__Concat_63561656((System_String_o *)StringLiteral_15950/*"[UnityIAP]課金エラー:"*/, str, 0);
  ...
  if ( UnityEngine_Object__op_Inequality(puchaserLogLabel, 0, 0) )
  {
    ...
    if ( ((unsigned __int8)isActiveAndEnabled & 1) != 0 )
    {
      ...
      if ( v8 )
      {
        v9 = System_String__Concat_63599904(v8->fields.mText, str, (System_String_o *)StringLiteral_43/*"\n"*/, 0);
...
void PurchaserUIScript___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C372A4(PurchaserUIScript___c_TypeInfo);
  System_Object___ctor(v1, 0);
  PurchaserUIScript___c_TypeInfo->static_fields->__9 = (struct PurchaserUIScript___c_o *)v1;
  sub_1C36FFC((CGThumbnailListItem_o *)PurchaserUIScript___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
