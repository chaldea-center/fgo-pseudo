...
void PurchaserUIScript__Purchase(PurchaserUIScript_o *this, int32_t index, const MethodInfo *method)
{
  ...
  struct PurchaserUIScript___c_StaticFields *monitor; // x8
      ...
      & 1) != 0 )
  {
    ...
    if ( !*(&PurchaserUIScript___c_TypeInfo->_2.cctor_finished + 1) )
    {
      j_il2cpp_runtime_class_init_0(PurchaserUIScript___c_TypeInfo, v7);
      purchaseLogic = (PurchaseLogic_o *)PurchaserUIScript___c_TypeInfo;
    }
    monitor = (struct PurchaserUIScript___c_StaticFields *)purchaseLogic[2].monitor;
    _9__8_0 = monitor->__9__8_0;
    if ( !_9__8_0 )
    {
      if ( !HIDWORD(purchaseLogic[2].fields._buyProductFinishedAction) )
      {
        j_il2cpp_runtime_class_init_0(purchaseLogic, v7);
...
void PurchaserUIScript__Start(PurchaserUIScript_o *this, const MethodInfo *method)
{
  ...
  struct PurchaseBehaviour_o *v14; // x22
  ...
  v30 = 0;
  purchaseLogic = System_Int32__ToString((int32_t)&v30, 0);
  if ( !stoneValueLabel )
    goto LABEL_27;
  ...
  if ( UnityEngine_Object__op_Inequality(purchaseBehaviour, 0, 0) )
  {
    ...
    PurchaseBehaviour__Activate((const MethodInfo *)v12);
  }
  v13 = (UnityEngine_Object_o *)this->fields._purchaseBehaviour;
  if ( !*(&UnityEngine_Object_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo, v11);
  purchaseLogic = (System_String_o *)UnityEngine_Object__op_Inequality(v13, 0, 0);
  if ( !this->fields._purchaseBehaviour )
    goto LABEL_27;
  if ( ((unsigned int)purchaseLogic
      & UnityEngine_Behaviour__get_isActiveAndEnabled((UnityEngine_Behaviour_o *)this->fields._purchaseBehaviour, 0)
