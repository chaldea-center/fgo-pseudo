...
void PurchaserUIScript__ClearLog(PurchaserUIScript_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E76FF4 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_16203/*"[purchase log]\n"*/);
    byte_4E76FF4 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(puchaserLogLabel, 0, 0) )
  {
    ...
    if ( UnityEngine_Behaviour__get_isActiveAndEnabled((UnityEngine_Behaviour_o *)v5, 0) )
    {
      ...
      if ( v5 )
      {
        UILabel__set_text(v5, (System_String_o *)StringLiteral_16203/*"[purchase log]\n"*/, 0);
        return;
      }
LABEL_11:
      sub_1D0F30C(v5, v4);
...
void PurchaserUIScript__CopyLogToClipboard(PurchaserUIScript_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(puchaserLogLabel, 0, 0) )
  {
    ...
    if ( !v6 )
LABEL_13:
      sub_1D0F30C(isActiveAndEnabled, v4);
...
void PurchaserUIScript__Purchase(PurchaserUIScript_o *this, int32_t index, const MethodInfo *method)
{
  ...
  {
    sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    sub_1D0F0B4(&PurchaseLogic_ProductFinishedAction_TypeInfo);
    sub_1D0F0B4(&Method_PurchaserUIScript___c__Purchase_b__8_0__);
    sub_1D0F0B4(&PurchaserUIScript___c_TypeInfo);
    byte_4E76FF6 = 1;
  }
      ...
      & 1) != 0 )
  {
    ...
    if ( !v9 )
    {
      ...
      v9 = (PurchaseLogic_ProductFinishedAction_o *)sub_1D0F300(PurchaseLogic_ProductFinishedAction_TypeInfo);
      ...
      sub_1D0F058((GrandQuestFolderBoardItem_o *)&static_fields->__9__8_0, (int32_t)v9, v13, v14, v15, v16, v17, v18);
    }
    ...
    if ( productIdCollection )
    {
      ...
      if ( v20 )
      {
        ...
        if ( purchaseLogic )
        {
          PurchaseLogic__InitiatePurchase_42812524(
            purchaseLogic,
            index + 1,
...
void PurchaserUIScript__Start(PurchaserUIScript_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E76FF3 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_PurchaserUIScript__Start_b__5_0__);
    sub_1D0F0B4(&Method_PurchaserUIScript__Start_b__5_1__);
  ...
  {
LABEL_27:
    sub_1D0F30C(purchaseLogic, v5);
  }
  purchaseLogic[2].fields = (System_String_Fields)v21;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&purchaseLogic[2].fields, (int32_t)v21, v22, v23, v24, v25, v26, v27);
}
...
void PurchaserUIScript___Start_b__5_0(PurchaserUIScript_o *this, System_String_o *str, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(puchaserLogLabel, 0, 0) )
  {
    ...
    if ( ((unsigned __int8)isActiveAndEnabled & 1) != 0 )
    {
      ...
      if ( v8 )
      {
        v9 = System_String__Concat_65601036(v8->fields.mText, str, (System_String_o *)StringLiteral_43/*"\n"*/, 0);
        UILabel__set_text(v8, v9, 0);
        return;
      }
LABEL_11:
      sub_1D0F30C(isActiveAndEnabled, v6);
    }
  }
}
...
void PurchaserUIScript___Start_b__5_1(PurchaserUIScript_o *this, System_String_o *str, const MethodInfo *method)
{
  ...
  if ( (byte_4E76FF8 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    sub_1D0F0B4(&StringLiteral_43/*"\n"*/);
    sub_1D0F0B4(&StringLiteral_16153/*"[UnityIAP]課金エラー:"*/);
    byte_4E76FF8 = 1;
  }
  v5 = (Il2CppObject *)System_String__Concat_65562772((System_String_o *)StringLiteral_16153/*"[UnityIAP]課金エラー:"*/, str, 0);
  ...
  if ( UnityEngine_Object__op_Inequality(puchaserLogLabel, 0, 0) )
  {
    ...
    if ( ((unsigned __int8)isActiveAndEnabled & 1) != 0 )
    {
      ...
      if ( v9 )
      {
        v10 = System_String__Concat_65601036(v9->fields.mText, str, (System_String_o *)StringLiteral_43/*"\n"*/, 0);
        UILabel__set_text(v9, v10, 0);
        return;
      }
LABEL_13:
      sub_1D0F30C(isActiveAndEnabled, v7);
    }
  }
}
...
void PurchaserUIScript___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1D0F300(PurchaserUIScript___c_TypeInfo);
