...
void __fastcall PurchaserUIScript__ClearLog(PurchaserUIScript_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFD0F8 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&StringLiteral_16295/*"[purchase log]\n"*/, v3);
    byte_4BFD0F8 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(puchaserLogLabel, 0LL, 0LL) )
  {
    ...
    if ( UnityEngine_Behaviour__get_isActiveAndEnabled((UnityEngine_Behaviour_o *)v6, 0LL) )
    {
      ...
      if ( v6 )
      {
        UILabel__set_text(v6, (System_String_o *)StringLiteral_16295/*"[purchase log]\n"*/, 0LL);
        return;
      }
LABEL_11:
      sub_1C2E388(v6, v5);
...
void __fastcall PurchaserUIScript__CopyLogToClipboard(PurchaserUIScript_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFD0F9 & 1) == 0 )
  {
    sub_1C2E12C(&UnityEngine_GUIUtility_TypeInfo, method);
  ...
  if ( UnityEngine_Object__op_Inequality(puchaserLogLabel, 0LL, 0LL) )
  {
    ...
    if ( !v7 )
LABEL_13:
      sub_1C2E388(isActiveAndEnabled, v5);
...
void __fastcall PurchaserUIScript__Purchase(PurchaserUIScript_o *this, int32_t index, const MethodInfo *method)
{
  ...
  if ( (byte_4BFD0FA & 1) == 0 )
  {
    ...
    sub_1C2E12C(&PurchaseLogic_ProductFinishedAction_TypeInfo, v5);
    sub_1C2E12C(&Method_PurchaserUIScript___c__Purchase_b__8_0__, v6);
    sub_1C2E12C(&PurchaserUIScript___c_TypeInfo, v7);
    byte_4BFD0FA = 1;
  }
                                        ...
                                        0LL) & 1) != 0 )
  {
    ...
    if ( !v12 )
    {
      ...
      v12 = (PurchaseLogic_ProductFinishedAction_o *)sub_1C2E378(PurchaseLogic_ProductFinishedAction_TypeInfo);
      ...
      sub_1C2E0D0((PartyOrganizationUtility_o *)&static_fields->__9__8_0, (int64_t)v12, v16, v17, v18, v19, v20, v21);
    }
    productIdCollection = this->fields._productIdCollection;
    if ( productIdCollection )
    {
      if ( productIdCollection->max_length <= index )
        sub_1C2E390(purchaseLogic, v10);
      ...
      if ( v23 )
      {
        ...
        if ( purchaseLogic )
        {
          PurchaseLogic__InitiatePurchase_39945808(
            purchaseLogic,
            index + 1,
...
void __fastcall PurchaserUIScript__Start(PurchaserUIScript_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFD0F7 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_PurchaserUIScript__Start_b__5_0__, v5);
    sub_1C2E12C(&Method_PurchaserUIScript__Start_b__5_1__, v6);
  ...
  v18 = (System_Action_object__o *)sub_1C2E378(System_Action_string__TypeInfo);
  ...
  if ( !v17
    ...
    || (purchaseLogic[2].monitor = v18,
        sub_1C2E0D0((PartyOrganizationUtility_o *)&purchaseLogic[2].monitor, (int64_t)v18, v19, v20, v21, v22, v23, v24),
        v25 = this->fields._purchaseBehaviour,
        v26 = (System_Action_object__o *)sub_1C2E378(System_Action_string__TypeInfo),
...
LABEL_27:
  ...
  sub_1C2E0D0((PartyOrganizationUtility_o *)&purchaseLogic[2].fields, (int64_t)v26, v27, v28, v29, v30, v31, v32);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFD0FB & 1) == 0 )
  {
    sub_1C2E12C(&UnityEngine_Object_TypeInfo, str);
  ...
  if ( UnityEngine_Object__op_Inequality(puchaserLogLabel, 0LL, 0LL) )
  {
    ...
    if ( ((unsigned __int8)isActiveAndEnabled & 1) != 0 )
    {
      ...
      if ( v9 )
      {
        v10 = System_String__Concat_63246844(v9->fields.mText, str, (System_String_o *)StringLiteral_43/*"\n"*/, 0LL);
        UILabel__set_text(v9, v10, 0LL);
        return;
      }
LABEL_11:
      sub_1C2E388(isActiveAndEnabled, v7);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFD0FC & 1) == 0 )
  {
    sub_1C2E12C(&UnityEngine_Debug_TypeInfo, str);
    sub_1C2E12C(&UnityEngine_Object_TypeInfo, v5);
    sub_1C2E12C(&StringLiteral_43/*"\n"*/, v6);
    sub_1C2E12C(&StringLiteral_16247/*"[UnityIAP]課金エラー:"*/, v7);
    byte_4BFD0FC = 1;
  }
  v8 = (Il2CppObject *)System_String__Concat_63235584((System_String_o *)StringLiteral_16247/*"[UnityIAP]課金エラー:"*/, str, 0LL);
  ...
  if ( UnityEngine_Object__op_Inequality(puchaserLogLabel, 0LL, 0LL) )
  {
    ...
    if ( ((unsigned __int8)isActiveAndEnabled & 1) != 0 )
    {
      ...
      if ( v12 )
      {
        v13 = System_String__Concat_63246844(v12->fields.mText, str, (System_String_o *)StringLiteral_43/*"\n"*/, 0LL);
        UILabel__set_text(v12, v13, 0LL);
        return;
      }
LABEL_13:
      sub_1C2E388(isActiveAndEnabled, v10);
    }
  }
}
...
void __fastcall PurchaserUIScript___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BFD0FD & 1) == 0 )
  {
    sub_1C2E12C(&PurchaserUIScript___c_TypeInfo, v1);
    byte_4BFD0FD = 1;
  }
  v2 = (Il2CppObject *)sub_1C2E378(PurchaserUIScript___c_TypeInfo);
