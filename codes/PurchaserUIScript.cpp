...
void PurchaserUIScript__ClearLog(PurchaserUIScript_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEDFE6 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_16055/*"[purchase log]\n"*/);
    byte_4CEDFE6 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(puchaserLogLabel, 0, 0) )
  {
    ...
    if ( UnityEngine_Behaviour__get_isActiveAndEnabled((UnityEngine_Behaviour_o *)v5, 0) )
    {
      ...
      if ( v5 )
      {
        UILabel__set_text(v5, (System_String_o *)StringLiteral_16055/*"[purchase log]\n"*/, 0);
        return;
      }
LABEL_11:
      sub_1C7BD40(v5, v4);
...
void PurchaserUIScript__CopyLogToClipboard(PurchaserUIScript_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(puchaserLogLabel, 0, 0) )
  {
    ...
    if ( !v6 )
LABEL_13:
      sub_1C7BD40(isActiveAndEnabled, v4);
...
void PurchaserUIScript__Purchase(PurchaserUIScript_o *this, int32_t index, const MethodInfo *method)
{
  ...
  {
    sub_1C7BAE8(&UnityEngine_Object_TypeInfo);
    sub_1C7BAE8(&PurchaseLogic_ProductFinishedAction_TypeInfo);
    sub_1C7BAE8(&Method_PurchaserUIScript___c__Purchase_b__8_0__);
    sub_1C7BAE8(&PurchaserUIScript___c_TypeInfo);
    byte_4CEDFE8 = 1;
  }
      ...
      & 1) != 0 )
  {
    ...
    if ( !v9 )
    {
      ...
      v9 = (PurchaseLogic_ProductFinishedAction_o *)sub_1C7BD34(PurchaseLogic_ProductFinishedAction_TypeInfo);
      ...
      sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&static_fields->__9__8_0, (int32_t)v9, v13, v14, v15, v16, v17, v18);
    }
    ...
    if ( productIdCollection )
    {
      ...
      if ( v20 )
      {
        ...
        if ( purchaseLogic )
        {
          PurchaseLogic__InitiatePurchase_42013884(
            purchaseLogic,
            index + 1,
...
void PurchaserUIScript__Start(PurchaserUIScript_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEDFE5 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_PurchaserUIScript__Start_b__5_0__);
    sub_1C7BAE8(&Method_PurchaserUIScript__Start_b__5_1__);
  ...
  if ( !v12
    ...
    || (purchaseLogic[2].monitor = v13,
        sub_1C7BA8C(
          ...
          v19),
        v20 = this->fields._purchaseBehaviour,
        v21 = (System_Action_object__o *)sub_1C7BD34(System_Action_string__TypeInfo),
  ...
  {
LABEL_27:
    sub_1C7BD40(purchaseLogic, v5);
  }
  purchaseLogic[2].fields = (System_String_Fields)v21;
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&purchaseLogic[2].fields, (int32_t)v21, v22, v23, v24, v25, v26, v27);
}
...
void PurchaserUIScript___Start_b__5_0(PurchaserUIScript_o *this, System_String_o *str, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(puchaserLogLabel, 0, 0) )
  {
    ...
    if ( ((unsigned __int8)isActiveAndEnabled & 1) != 0 )
    {
      ...
      if ( v8 )
      {
        v9 = System_String__Concat_64215176(v8->fields.mText, str, (System_String_o *)StringLiteral_43/*"\n"*/, 0);
        UILabel__set_text(v8, v9, 0);
        return;
      }
LABEL_11:
      sub_1C7BD40(isActiveAndEnabled, v6);
    }
  }
}
...
void PurchaserUIScript___Start_b__5_1(PurchaserUIScript_o *this, System_String_o *str, const MethodInfo *method)
{
  ...
  if ( (byte_4CEDFEA & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&UnityEngine_Object_TypeInfo);
    sub_1C7BAE8(&StringLiteral_43/*"\n"*/);
    sub_1C7BAE8(&StringLiteral_16006/*"[UnityIAP]課金エラー:"*/);
    byte_4CEDFEA = 1;
  }
  v5 = (Il2CppObject *)System_String__Concat_64176912((System_String_o *)StringLiteral_16006/*"[UnityIAP]課金エラー:"*/, str, 0);
  ...
  if ( UnityEngine_Object__op_Inequality(puchaserLogLabel, 0, 0) )
  {
    ...
    if ( ((unsigned __int8)isActiveAndEnabled & 1) != 0 )
    {
      ...
      if ( v9 )
      {
        v10 = System_String__Concat_64215176(v9->fields.mText, str, (System_String_o *)StringLiteral_43/*"\n"*/, 0);
        UILabel__set_text(v9, v10, 0);
        return;
      }
LABEL_13:
      sub_1C7BD40(isActiveAndEnabled, v7);
    }
  }
}
...
void PurchaserUIScript___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C7BD34(PurchaserUIScript___c_TypeInfo);
