...
void __fastcall PurchaserUIScript__ClearLog(PurchaserUIScript_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E2150 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_15776/*"[purchase log]\n"*/, v3);
    byte_48E2150 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(puchaserLogLabel, 0LL, 0LL) )
  {
    ...
    if ( UnityEngine_Behaviour__get_isActiveAndEnabled((UnityEngine_Behaviour_o *)v6, 0LL) )
    {
      ...
      if ( v6 )
      {
        UILabel__set_text(v6, (System_String_o *)StringLiteral_15776/*"[purchase log]\n"*/, 0LL);
        return;
      }
LABEL_11:
      sub_1B00F28(v6, v5);
...
void __fastcall PurchaserUIScript__CopyLogToClipboard(PurchaserUIScript_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E2151 & 1) == 0 )
  {
    sub_1B00CCC(&UnityEngine_GUIUtility_TypeInfo, method);
  ...
  if ( UnityEngine_Object__op_Inequality(puchaserLogLabel, 0LL, 0LL) )
  {
    ...
    if ( !v7 )
LABEL_13:
      sub_1B00F28(isActiveAndEnabled, v5);
...
void __fastcall PurchaserUIScript__Purchase(PurchaserUIScript_o *this, int32_t index, const MethodInfo *method)
{
  ...
  if ( (byte_48E2152 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&PurchaseLogic_ProductFinishedAction_TypeInfo, v5);
    sub_1B00CCC(&Method_PurchaserUIScript___c__Purchase_b__8_0__, v6);
    sub_1B00CCC(&PurchaserUIScript___c_TypeInfo, v7);
    byte_48E2152 = 1;
  }
                                        ...
                                        0LL) & 1) != 0 )
  {
    ...
    if ( !monitor )
    {
      ...
      monitor = (PurchaseLogic_ProductFinishedAction_o *)sub_1B00F18(PurchaseLogic_ProductFinishedAction_TypeInfo);
      ...
      sub_1B00C70((ServantStatusBattleListViewItem_o *)&static_fields->__9__8_0, (int32_t)monitor, v16, v17);
    }
    productIdCollection = this->fields._productIdCollection;
    if ( productIdCollection )
    {
      if ( productIdCollection->max_length <= index )
        sub_1B00F30(purchaseLogic, v10);
      ...
      if ( v19 )
      {
        ...
        if ( purchaseLogic )
        {
          PurchaseLogic__InitiatePurchase_37331724(purchaseLogic, productIdCollection->m_Items[index], 0, monitor, v11);
          return;
        }
      }
    }
LABEL_19:
    sub_1B00F28(purchaseLogic, v10);
  }
}
...
void __fastcall PurchaserUIScript__Start(PurchaserUIScript_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E214F & 1) == 0 )
  {
    ...
    sub_1B00CCC(&UnityEngine_Object_TypeInfo, v3);
    sub_1B00CCC(&PurchaseBehaviour_TypeInfo, v4);
    sub_1B00CCC(&Method_PurchaserUIScript__Start_b__5_0__, v5);
    sub_1B00CCC(&Method_PurchaserUIScript__Start_b__5_1__, v6);
  ...
  v18 = (System_Action_object__o *)sub_1B00F18(System_Action_string__TypeInfo);
  ...
  if ( !v17
    ...
    || (purchaseLogic[2].klass = (System_String_c *)v18,
        sub_1B00C70((ServantStatusBattleListViewItem_o *)&purchaseLogic[2], (int32_t)v18, v19, v20),
        v21 = this->fields._purchaseBehaviour,
        v22 = (System_Action_object__o *)sub_1B00F18(System_Action_string__TypeInfo),
...
LABEL_27:
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&purchaseLogic[2].monitor, (int32_t)v22, v23, v24);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E2153 & 1) == 0 )
  {
    sub_1B00CCC(&UnityEngine_Object_TypeInfo, str);
  ...
  if ( UnityEngine_Object__op_Inequality(puchaserLogLabel, 0LL, 0LL) )
  {
    ...
    if ( ((unsigned __int8)isActiveAndEnabled & 1) != 0 )
    {
      ...
      if ( v9 )
      {
        v10 = System_String__Concat_60337008(v9->fields.mText, str, (System_String_o *)StringLiteral_43/*"\n"*/, 0LL);
        UILabel__set_text(v9, v10, 0LL);
        return;
      }
LABEL_11:
      sub_1B00F28(isActiveAndEnabled, v7);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E2154 & 1) == 0 )
  {
    sub_1B00CCC(&UnityEngine_Debug_TypeInfo, str);
    sub_1B00CCC(&UnityEngine_Object_TypeInfo, v5);
    sub_1B00CCC(&StringLiteral_43/*"\n"*/, v6);
    sub_1B00CCC(&StringLiteral_15728/*"[UnityIAP]課金エラー:"*/, v7);
    byte_48E2154 = 1;
  }
  v8 = (Il2CppObject *)System_String__Concat_60325748((System_String_o *)StringLiteral_15728/*"[UnityIAP]課金エラー:"*/, str, 0LL);
  ...
  if ( UnityEngine_Object__op_Inequality(puchaserLogLabel, 0LL, 0LL) )
  {
    ...
    if ( ((unsigned __int8)isActiveAndEnabled & 1) != 0 )
    {
      ...
      if ( v12 )
      {
        v13 = System_String__Concat_60337008(v12->fields.mText, str, (System_String_o *)StringLiteral_43/*"\n"*/, 0LL);
        UILabel__set_text(v12, v13, 0LL);
        return;
      }
LABEL_13:
      sub_1B00F28(isActiveAndEnabled, v10);
    }
  }
}
...
void __fastcall PurchaserUIScript___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48E2155 & 1) == 0 )
  {
    sub_1B00CCC(&PurchaserUIScript___c_TypeInfo, v1);
    byte_48E2155 = 1;
  }
  v2 = (Il2CppObject *)sub_1B00F18(PurchaserUIScript___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  PurchaserUIScript___c_TypeInfo->static_fields->__9 = (struct PurchaserUIScript___c_o *)v2;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)PurchaserUIScript___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
