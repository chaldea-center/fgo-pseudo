...
void __fastcall PurchaserUIScript__ClearLog(PurchaserUIScript_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDBEF3 & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_16282/*"[purchase log]\n"*/);
    byte_4BDBEF3 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(puchaserLogLabel, 0LL, 0LL) )
  {
    ...
    if ( UnityEngine_Behaviour__get_isActiveAndEnabled((UnityEngine_Behaviour_o *)v5, 0LL) )
    {
      ...
      if ( v5 )
      {
        UILabel__set_text(v5, (System_String_o *)StringLiteral_16282/*"[purchase log]\n"*/, 0LL);
        return;
      }
LABEL_11:
      sub_1C22094(v5, v4);
...
void __fastcall PurchaserUIScript__CopyLogToClipboard(PurchaserUIScript_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(puchaserLogLabel, 0LL, 0LL) )
  {
    ...
    if ( !v6 )
LABEL_13:
      sub_1C22094(isActiveAndEnabled, v4);
...
void __fastcall PurchaserUIScript__Purchase(PurchaserUIScript_o *this, int32_t index, const MethodInfo *method)
{
  ...
  if ( (byte_4BDBEF5 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_PurchaserUIScript___c__Purchase_b__8_0__);
    sub_1C21E38(&PurchaserUIScript___c_TypeInfo);
    byte_4BDBEF5 = 1;
  }
                                        ...
                                        0LL) & 1) != 0 )
  {
    ...
    if ( !v9 )
    {
      ...
      sub_1C21DDC((PartyOrganizationUtility_o *)&static_fields->__9__8_0, (int64_t)v9, v13, v14, v15, v16, v17, v18);
    }
    productIdCollection = this->fields._productIdCollection;
    if ( productIdCollection )
    {
      if ( productIdCollection->max_length <= index )
        sub_1C2209C(purchaseLogic, v7);
...
void __fastcall PurchaserUIScript__Start(PurchaserUIScript_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDBEF2 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_PurchaserUIScript__Start_b__5_0__);
    sub_1C21E38(&Method_PurchaserUIScript__Start_b__5_1__);
  ...
  if ( !v12
    ...
    || (purchaseLogic[2].monitor = v13,
        sub_1C21DDC((PartyOrganizationUtility_o *)&purchaseLogic[2].monitor, (int64_t)v13, v14, v15, v16, v17, v18, v19),
        v20 = this->fields._purchaseBehaviour,
        v21 = (System_Action_object__o *)sub_1C22084(System_Action_string__TypeInfo),
        System_Action_object____ctor(v21, (Il2CppObject *)this, Method_PurchaserUIScript__Start_b__5_1__, 0LL),
        !v20)
    || (purchaseLogic = (System_String_o *)v20->fields._purchaseLogic) == 0LL )
  {
LABEL_27:
    sub_1C22094(purchaseLogic, v5);
  }
  purchaseLogic[2].fields = (System_String_Fields)v21;
  sub_1C21DDC((PartyOrganizationUtility_o *)&purchaseLogic[2].fields, (int64_t)v21, v22, v23, v24, v25, v26, v27);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(puchaserLogLabel, 0LL, 0LL) )
  {
    ...
    if ( ((unsigned __int8)isActiveAndEnabled & 1) != 0 )
    {
      ...
      if ( v8 )
      {
        v9 = System_String__Concat_63126736(v8->fields.mText, str, (System_String_o *)StringLiteral_43/*"\n"*/, 0LL);
        UILabel__set_text(v8, v9, 0LL);
        return;
      }
LABEL_11:
      sub_1C22094(isActiveAndEnabled, v6);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  v5 = (Il2CppObject *)System_String__Concat_63115476((System_String_o *)StringLiteral_16234/*"[UnityIAP]課金エラー:"*/, str, 0LL);
  ...
  if ( UnityEngine_Object__op_Inequality(puchaserLogLabel, 0LL, 0LL) )
  {
    ...
    if ( ((unsigned __int8)isActiveAndEnabled & 1) != 0 )
    {
      ...
      if ( v9 )
      {
        v10 = System_String__Concat_63126736(v9->fields.mText, str, (System_String_o *)StringLiteral_43/*"\n"*/, 0LL);
        UILabel__set_text(v9, v10, 0LL);
        return;
      }
LABEL_13:
      sub_1C22094(isActiveAndEnabled, v7);
    }
  }
}
...
void __fastcall PurchaserUIScript___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C22084(PurchaserUIScript___c_TypeInfo);
