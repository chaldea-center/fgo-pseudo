...
void __fastcall PurchaserUIScript__ClearLog(PurchaserUIScript_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42AFC20 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_15916/*"[purchase log]\n"*/);
    byte_42AFC20 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(puchaserLogLabel, 0LL, 0LL) )
  {
    ...
    if ( UnityEngine_Behaviour__get_isActiveAndEnabled((UnityEngine_Behaviour_o *)v5, 0LL) )
    {
      ...
      if ( v5 )
      {
        UILabel__set_text(v5, (System_String_o *)StringLiteral_15916/*"[purchase log]\n"*/, 0LL);
        return;
      }
LABEL_12:
      sub_B52A5C(v5, v4);
...
void __fastcall PurchaserUIScript__CopyLogToClipboard(PurchaserUIScript_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(puchaserLogLabel, 0LL, 0LL) )
  {
    ...
    if ( !v6 )
LABEL_15:
      sub_B52A5C(isActiveAndEnabled, v4);
...
void __fastcall PurchaserUIScript__Purchase(PurchaserUIScript_o *this, int32_t index, const MethodInfo *method)
{
  ...
  if ( (byte_42AFC22 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_PurchaserUIScript___c__Purchase_b__8_0__);
    sub_B52984(&PurchaserUIScript___c_TypeInfo);
    byte_42AFC22 = 1;
  }
                                        ...
                                        0LL) & 1) != 0 )
  {
    ...
    if ( !_9__8_0 )
    {
      ...
      _9__8_0 = (PurchaseLogic_ProductFinishedAction_o *)sub_B52A54(PurchaseLogic_ProductFinishedAction_TypeInfo);
    ...
    if ( productIdCollection )
    {
      ...
      if ( v20 )
      {
        ...
        if ( purchaseLogic )
        {
          PurchaseLogic__InitiatePurchase_24707968(purchaseLogic, productIdCollection->m_Items[index], 0, _9__8_0, v8);
          return;
        }
      }
    }
LABEL_22:
    sub_B52A5C(purchaseLogic, v7);
  }
}
...
void __fastcall PurchaserUIScript__Start(PurchaserUIScript_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42AFC1F & 1) == 0 )
  {
    ...
    sub_B52984(&Method_PurchaserUIScript__Start_b__5_0__);
    sub_B52984(&Method_PurchaserUIScript__Start_b__5_1__);
  ...
  if ( !v12
    ...
    || (purchaseLogic[2].klass = (System_String_c *)v13,
        sub_B52920(
          ...
          v19),
        v20 = this->fields._purchaseBehaviour,
        v21 = (System_Action_DrawLotsDisplayMessage_DisplayedInGroup_SaveData__o *)sub_B52A54(System_Action_string__TypeInfo),
        System_Action_DrawLotsDisplayMessage_DisplayedInGroup_SaveData____ctor(
          v21,
          (Il2CppObject *)this,
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(puchaserLogLabel, 0LL, 0LL) )
  {
    ...
    if ( ((unsigned __int8)isActiveAndEnabled & 1) != 0 )
    {
      ...
      if ( v8 )
      {
        v9 = System_String__Concat_44570600(v8->fields.mText, str, (System_String_o *)StringLiteral_26/*"\n"*/, 0LL);
        UILabel__set_text(v8, v9, 0LL);
        return;
      }
LABEL_12:
      sub_B52A5C(isActiveAndEnabled, v6);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  v5 = (Il2CppObject *)System_String__Concat_44568316((System_String_o *)StringLiteral_15868/*"[UnityIAP]課金エラー:"*/, str, 0LL);
  ...
  if ( UnityEngine_Object__op_Inequality(puchaserLogLabel, 0LL, 0LL) )
  {
    ...
    if ( ((unsigned __int8)isActiveAndEnabled & 1) != 0 )
    {
      ...
      if ( v9 )
      {
        v10 = System_String__Concat_44570600(v9->fields.mText, str, (System_String_o *)StringLiteral_26/*"\n"*/, 0LL);
        UILabel__set_text(v9, v10, 0LL);
        return;
      }
LABEL_15:
      sub_B52A5C(isActiveAndEnabled, v7);
    }
  }
}
...
void __fastcall PurchaserUIScript___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_B52A54(PurchaserUIScript___c_TypeInfo);
  System_Object___ctor(v1, 0LL);
  static_fields = PurchaserUIScript___c_TypeInfo->static_fields;
  static_fields->__9 = (struct PurchaserUIScript___c_o *)v1;
