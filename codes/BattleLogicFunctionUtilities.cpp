        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC689 & 1) == 0 )
  {
    sub_1B64870(
      ...
      targetSvtArray);
    sub_1B64870(&Method_System_Linq_Enumerable_ToArray_FunctionProgressCache_SvtCache___, v7);
    sub_1B64870(&System_Func_BattleServantData__FunctionProgressCache_SvtCache__TypeInfo, v8);
    sub_1B64870(&Method_BattleLogicFunctionUtilities_FunctionProgressCache___ctor_b__7_0__, v9);
    byte_49FC689 = 1;
  }
  ...
  sub_1B64814(
    ...
    v10,
    v11);
  v12 = (System_Func_object__object__o *)sub_1B64ABC(System_Func_BattleServantData__FunctionProgressCache_SvtCache__TypeInfo);
  ...
  v13 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_object__object_(
                                                               ...
                                                               (const MethodInfo_2E6B688 *)Method_System_Linq_Enumerable_Select_BattleServantData__FunctionProgressCache_SvtCache___);
  v14 = System_Linq_Enumerable__ToArray_object_(
          v13,
          (const MethodInfo_2E736A0 *)Method_System_Linq_Enumerable_ToArray_FunctionProgressCache_SvtCache___);
  this->fields._SvtCacheArray_k__BackingField = (struct BattleLogicFunctionUtilities_FunctionProgressCache_SvtCache_array *)v14;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)v14, v15, v16);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC68C & 1) == 0 )
  {
    sub_1B64870(
      ...
      *(_QWORD *)&svtUniqueId);
    sub_1B64870(&System_Func_FunctionProgressCache_SvtCache__bool__TypeInfo, v5);
    sub_1B64870(
      &Method_BattleLogicFunctionUtilities_FunctionProgressCache___c__DisplayClass10_0__GetElemByUniqueId_b__0__,
      v6);
    sub_1B64870(&BattleLogicFunctionUtilities_FunctionProgressCache___c__DisplayClass10_0_TypeInfo, v7);
    byte_49FC68C = 1;
  }
  v8 = sub_1B64ABC(BattleLogicFunctionUtilities_FunctionProgressCache___c__DisplayClass10_0_TypeInfo);
  ...
  *(_DWORD *)(v8 + 16) = svtUniqueId;
  ...
  v12 = (System_Func_object__bool__o *)sub_1B64ABC(System_Func_FunctionProgressCache_SvtCache__bool__TypeInfo);
  System_Func_object__bool____ctor(
    v12,
    (Il2CppObject *)v8,
    Method_BattleLogicFunctionUtilities_FunctionProgressCache___c__DisplayClass10_0__GetElemByUniqueId_b__0__,
    0LL);
  return (BattleLogicFunctionUtilities_FunctionProgressCache_SvtCache_o *)System_Linq_Enumerable__FirstOrDefault_object__48626624(
                                                                            SvtCacheArray_k__BackingField,
                                                                            (System_Func_TSource__bool__o *)v12,
                                                                            (const MethodInfo_2E5FBC0 *)Method_System_Linq_Enumerable_FirstOrDefault_FunctionProgressCache_SvtCache___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC68B & 1) == 0 )
  {
    sub_1B64870(&System_Action_FunctionProgressCache_SvtCache__TypeInfo, method);
    sub_1B64870(&Method_BasicHelper_ForEach_FunctionProgressCache_SvtCache___, v3);
    sub_1B64870(&Method_BattleLogicFunctionUtilities_FunctionProgressCache___c__MakeAfterSvtCache_b__9_0__, v4);
    sub_1B64870(&BattleLogicFunctionUtilities_FunctionProgressCache___c_TypeInfo, v5);
    byte_49FC68B = 1;
  }
  ...
  if ( !_9__9_0 )
  {
    ...
    _9__9_0 = (System_Action_object__o *)sub_1B64ABC(System_Action_FunctionProgressCache_SvtCache__TypeInfo);
  ...
  BasicHelper__ForEach_object_(
    ...
    (const MethodInfo_2E28B3C *)Method_BasicHelper_ForEach_FunctionProgressCache_SvtCache___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC68A & 1) == 0 )
  {
    sub_1B64870(&System_Action_FunctionProgressCache_SvtCache__TypeInfo, method);
    sub_1B64870(&Method_BasicHelper_ForEach_FunctionProgressCache_SvtCache___, v3);
    sub_1B64870(&Method_BattleLogicFunctionUtilities_FunctionProgressCache___c__MakeBeforeSvtCache_b__8_0__, v4);
    sub_1B64870(&BattleLogicFunctionUtilities_FunctionProgressCache___c_TypeInfo, v5);
    byte_49FC68A = 1;
  }
  v6 = BattleLogicFunctionUtilities_FunctionProgressCache___c_TypeInfo;
  ...
  if ( !_9__8_0 )
  {
    ...
    v9 = (Il2CppObject *)v6->static_fields->__9;
    _9__8_0 = (System_Action_object__o *)sub_1B64ABC(System_Action_FunctionProgressCache_SvtCache__TypeInfo);
    System_Action_object____ctor(
      _9__8_0,
      v9,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC68D & 1) == 0 )
  {
    sub_1B64870(&BattleLogicFunctionUtilities_FunctionProgressCache_SvtCache_TypeInfo, x);
    byte_49FC68D = 1;
  }
  v5 = (BattleLogicFunctionUtilities_FunctionProgressCache_SvtCache_o *)sub_1B64ABC(BattleLogicFunctionUtilities_FunctionProgressCache_SvtCache_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)root, v7, v8);
  this->fields._SvtData_k__BackingField = svtData;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields._SvtData_k__BackingField, (int32_t)svtData, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields._After_k__BackingField, (int32_t)v5, v6, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields._Before_k__BackingField, (int32_t)v5, v6, v7);
}
...
void __fastcall BattleLogicFunctionUtilities_FunctionProgressCache___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FC68E & 1) == 0 )
  {
    sub_1B64870(&BattleLogicFunctionUtilities_FunctionProgressCache___c_TypeInfo, v1);
    byte_49FC68E = 1;
  }
  v2 = (Il2CppObject *)sub_1B64ABC(BattleLogicFunctionUtilities_FunctionProgressCache___c_TypeInfo);
