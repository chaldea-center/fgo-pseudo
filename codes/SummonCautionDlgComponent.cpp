void __fastcall SummonCautionDlgComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B189C9 & 1) == 0 )
  {
    sub_1BCAFF8(&SummonCautionDlgComponent_TypeInfo, v1);
    byte_4B189C9 = 1;
  }
  static_fields = SummonCautionDlgComponent_TypeInfo->static_fields;
  *(_OWORD *)&static_fields->TITLE_LABEL_POS_Y = xmmword_BE2280;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B189C5 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_SummonCautionDlgComponent_EndClose__, v6);
    byte_4B189C5 = 1;
  }
...
void __fastcall SummonCautionDlgComponent__EndClose(SummonCautionDlgComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(bonusSelectMsgInfo, 0LL, 0LL) )
  {
    ...
    if ( !v7 )
      sub_1BCB254(0LL, v4);
    BonusSelectSummonMsgInfo__Init(v7, 0LL);
  }
...
void __fastcall SummonCautionDlgComponent__Init(SummonCautionDlgComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B189C3 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&SummonCautionDlgComponent_TypeInfo, v4);
    sub_1BCAFF8(&StringLiteral_3651/*"COMMON_CONFIRM_DECIDE"*/, v5);
    sub_1BCAFF8(&StringLiteral_3650/*"COMMON_CONFIRM_CLOSE"*/, v6);
  ...
  titleLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3651/*"COMMON_CONFIRM_DECIDE"*/, 0LL);
  if ( !confirmBtnLabel )
    goto LABEL_26;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B189C4 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_UnityEngine_GameObject_GetComponent_BonusSelectSummonMsgInfo___, title);
    sub_1BCAFF8(&LocalizationManager_TypeInfo, v21);
    sub_1BCAFF8(&Method_UnityEngine_Object_Instantiate_GameObject____77001424, v22);
    sub_1BCAFF8(&UnityEngine_Object_TypeInfo, v23);
    sub_1BCAFF8(&SummonCautionDlgComponent_TypeInfo, v24);
    sub_1BCAFF8(&StringLiteral_12342/*"SUMMON_GROUP_STONEPAY_WARNING_MSG"*/, v25);
    sub_1BCAFF8(&StringLiteral_3651/*"COMMON_CONFIRM_DECIDE"*/, v26);
    sub_1BCAFF8(&StringLiteral_12369/*"SUMMON_STONEPAY_WARNING_MSG"*/, v27);
    sub_1BCAFF8(&StringLiteral_3649/*"COMMON_CONFIRM_CANCEL"*/, v28);
    sub_1BCAFF8(&StringLiteral_12321/*"SUMMON_BONUS_SELECT_WARNING_MSG"*/, v29);
    sub_1BCAFF8(&StringLiteral_12317/*"SUMMON_BONUS_SELECT_DIALOG_SUMMON"*/, v30);
    byte_4B189C4 = 1;
  }
  ...
  if ( isGroupSummon )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(addMsgInfo, 0LL, 0LL) )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v47 = LocalizationManager__Get((System_String_o *)StringLiteral_12369/*"SUMMON_STONEPAY_WARNING_MSG"*/, 0LL);
      v48 = LocalizationManager__Get((System_String_o *)StringLiteral_12342/*"SUMMON_GROUP_STONEPAY_WARNING_MSG"*/, 0LL);
      DateTime = (Il2CppObject *)LocalizationManager__GetDateTime(summonCloseAt, 0LL);
      v50 = System_String__Format(v48, DateTime, 0LL);
      titleLabel = (UILabel_o *)System_String__Concat_62450424(v47, v50, 0LL);
  ...
  if ( gachaId )
  {
    ...
    if ( titleLabel )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v51 = LocalizationManager__Get((System_String_o *)StringLiteral_12369/*"SUMMON_STONEPAY_WARNING_MSG"*/, 0LL);
      v52 = LocalizationManager__Get((System_String_o *)StringLiteral_12321/*"SUMMON_BONUS_SELECT_WARNING_MSG"*/, 0LL);
      v53 = (Il2CppObject *)LocalizationManager__GetDateTime(summonCloseAt, 0LL);
      v54 = System_String__Format(v52, v53, 0LL);
      titleLabel = (UILabel_o *)System_String__Concat_62450424(v51, v54, 0LL);
      if ( this->fields.addMsgLabel )
      {
        UILabel__set_text(this->fields.addMsgLabel, (System_String_o *)titleLabel, 0LL);
        titleLabel = this->fields.addMsgLabel;
        if ( titleLabel )
        {
          ...
          if ( titleLabel )
          {
            ...
            if ( ((unsigned __int8)titleLabel & 1) != 0 )
            {
              ...
              if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
                j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
              titleLabel = (UILabel_o *)UnityEngine_Object__Instantiate_object__51002592(
              ...
              Component_object = UnityEngine_GameObject__GetComponent_object_(
                                   ...
                                   (const MethodInfo_306E710 *)Method_UnityEngine_GameObject_GetComponent_BonusSelectSummonMsgInfo___);
            ...
            if ( titleLabel )
            {
              ...
              v63 = this->fields.confirmBtnLabel;
              if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
              titleLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12317/*"SUMMON_BONUS_SELECT_DIALOG_SUMMON"*/, 0LL);
              if ( v63 )
              {
                UILabel__set_text(v63, (System_String_o *)titleLabel, 0LL);
                cancelBtnLb = this->fields.cancelBtnLb;
...
LABEL_61:
  ...
  v65 = 1;
LABEL_59:
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)titleLabel, v65, 0LL);
  titleLabel = (UILabel_o *)UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  if ( !titleLabel )
    goto LABEL_61;
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)titleLabel, 1, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B189C1 & 1) == 0 )
  {
    sub_1BCAFF8(&SummonCautionDlgComponent_CallbackFunc_TypeInfo, value);
    byte_4B189C1 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
        ...
        const MethodInfo *method)
{
  if ( (byte_4B189C7 & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_4613/*"ConfirmWindow/ConfirmBntInfo/CancleButton"*/, method);
    byte_4B189C7 = 1;
  }
  return (System_String_o *)StringLiteral_4613/*"ConfirmWindow/ConfirmBntInfo/CancleButton"*/;
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A11458;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A11410;
}
