void SummonCautionDlgComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CEAA01 & 1) == 0 )
  {
    sub_1C7BAE8(&SummonCautionDlgComponent_TypeInfo);
    byte_4CEAA01 = 1;
  }
  static_fields = SummonCautionDlgComponent_TypeInfo->static_fields;
  *(_OWORD *)&static_fields->TITLE_LABEL_POS_Y = xmmword_CF5BA0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEA9FD & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_SummonCautionDlgComponent_EndClose__);
    byte_4CEA9FD = 1;
  }
...
void SummonCautionDlgComponent__Init(SummonCautionDlgComponent_o *this, const MethodInfo *method)
{
  ...
  titleLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3692/*"COMMON_CONFIRM_DECIDE"*/, 0);
  if ( !confirmBtnLabel )
    goto LABEL_26;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEA9FC & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_UnityEngine_GameObject_GetComponent_BonusSelectSummonMsgInfo___);
    sub_1C7BAE8(&LocalizationManager_TypeInfo);
    sub_1C7BAE8(&Method_UnityEngine_Object_Instantiate_GameObject____78879968);
    sub_1C7BAE8(&UnityEngine_Object_TypeInfo);
    sub_1C7BAE8(&SummonCautionDlgComponent_TypeInfo);
    sub_1C7BAE8(&StringLiteral_12505/*"SUMMON_GROUP_STONEPAY_WARNING_MSG"*/);
    sub_1C7BAE8(&StringLiteral_3692/*"COMMON_CONFIRM_DECIDE"*/);
    sub_1C7BAE8(&StringLiteral_12532/*"SUMMON_STONEPAY_WARNING_MSG"*/);
    sub_1C7BAE8(&StringLiteral_3690/*"COMMON_CONFIRM_CANCEL"*/);
    sub_1C7BAE8(&StringLiteral_12480/*"SUMMON_BONUS_SELECT_DIALOG_SUMMON"*/);
    byte_4CEA9FC = 1;
  }
  ...
  if ( isGroupSummon )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(addMsgInfo, 0, 0) )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v37 = LocalizationManager__Get((System_String_o *)StringLiteral_12532/*"SUMMON_STONEPAY_WARNING_MSG"*/, 0);
      v38 = LocalizationManager__Get((System_String_o *)StringLiteral_12505/*"SUMMON_GROUP_STONEPAY_WARNING_MSG"*/, 0);
      DateTime = (Il2CppObject *)LocalizationManager__GetDateTime(summonCloseAt, 0);
      v40 = System_String__Format(v38, DateTime, 0);
      titleLabel = (UILabel_o *)System_String__Concat_64176912(v37, v40, 0);
  ...
  if ( gachaId )
  {
    ...
    if ( titleLabel )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v41 = LocalizationManager__Get((System_String_o *)StringLiteral_12532/*"SUMMON_STONEPAY_WARNING_MSG"*/, 0);
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      titleLabel = (UILabel_o *)DataManager__GetMaster_object_((const MethodInfo_31703A0 *)Method_DataManager_GetMaster_GachaDetailMaster___);
      if ( titleLabel )
      {
        ...
        if ( titleLabel )
        {
          ...
          titleLabel = (UILabel_o *)System_String__Concat_64176912(v41, v44, 0);
          if ( this->fields.addMsgLabel )
          {
            UILabel__set_text(this->fields.addMsgLabel, (System_String_o *)titleLabel, 0);
            titleLabel = this->fields.addMsgLabel;
            if ( titleLabel )
            {
              ...
              if ( titleLabel )
              {
                ...
                if ( ((unsigned __int8)titleLabel & 1) != 0 )
                {
                  ...
                  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
                    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
                  titleLabel = (UILabel_o *)UnityEngine_Object__Instantiate_object__52412380(
                  ...
                  Component_object = UnityEngine_GameObject__GetComponent_object_(
                                       ...
                                       (const MethodInfo_31C70C8 *)Method_UnityEngine_GameObject_GetComponent_BonusSelectSummonMsgInfo___);
                ...
                if ( titleLabel )
                {
                  ...
                  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                  titleLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12480/*"SUMMON_BONUS_SELECT_DIALOG_SUMMON"*/, 0);
                  if ( v57 )
                  {
        ...
        const MethodInfo *method)
{
  if ( (byte_4CEA9FF & 1) == 0 )
  {
    sub_1C7BAE8(&StringLiteral_4655/*"ConfirmWindow/ConfirmBntInfo/CancleButton"*/);
    byte_4CEA9FF = 1;
  }
  return (System_String_o *)StringLiteral_4655/*"ConfirmWindow/ConfirmBntInfo/CancleButton"*/;
}
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1AAD6CC;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1AAD684;
}
