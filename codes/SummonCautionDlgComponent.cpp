void SummonCautionDlgComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C33E80 & 1) == 0 )
  {
    sub_1C32C20(&SummonCautionDlgComponent_TypeInfo);
    byte_4C33E80 = 1;
  }
  static_fields = SummonCautionDlgComponent_TypeInfo->static_fields;
  *(_OWORD *)&static_fields->TITLE_LABEL_POS_Y = xmmword_C0CCF0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C33E7C & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_SummonCautionDlgComponent_EndClose__);
    byte_4C33E7C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C33E7B & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_UnityEngine_GameObject_GetComponent_BonusSelectSummonMsgInfo___);
    sub_1C32C20(&LocalizationManager_TypeInfo);
    sub_1C32C20(&Method_UnityEngine_Object_Instantiate_GameObject____78147088);
    sub_1C32C20(&UnityEngine_Object_TypeInfo);
    sub_1C32C20(&SummonCautionDlgComponent_TypeInfo);
    sub_1C32C20(&StringLiteral_12446/*"SUMMON_GROUP_STONEPAY_WARNING_MSG"*/);
    sub_1C32C20(&StringLiteral_3686/*"COMMON_CONFIRM_DECIDE"*/);
    sub_1C32C20(&StringLiteral_12473/*"SUMMON_STONEPAY_WARNING_MSG"*/);
    sub_1C32C20(&StringLiteral_3684/*"COMMON_CONFIRM_CANCEL"*/);
    sub_1C32C20(&StringLiteral_12421/*"SUMMON_BONUS_SELECT_DIALOG_SUMMON"*/);
    byte_4C33E7B = 1;
  }
  ...
  if ( isGroupSummon )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(addMsgInfo, 0, 0) )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v36 = LocalizationManager__Get((System_String_o *)StringLiteral_12473/*"SUMMON_STONEPAY_WARNING_MSG"*/, 0);
      v37 = LocalizationManager__Get((System_String_o *)StringLiteral_12446/*"SUMMON_GROUP_STONEPAY_WARNING_MSG"*/, 0);
      DateTime = (Il2CppObject *)LocalizationManager__GetDateTime(summonCloseAt, 0);
      v39 = System_String__Format(v37, DateTime, 0);
      titleLabel = (UILabel_o *)System_String__Concat_63518544(v36, v39, 0);
  ...
  if ( gachaId )
  {
    ...
    if ( titleLabel )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v40 = LocalizationManager__Get((System_String_o *)StringLiteral_12473/*"SUMMON_STONEPAY_WARNING_MSG"*/, 0);
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      titleLabel = (UILabel_o *)DataManager__GetMaster_object_((const MethodInfo_30DD39C *)Method_DataManager_GetMaster_GachaDetailMaster___);
      if ( titleLabel )
      {
        ...
        if ( titleLabel )
        {
          ...
          titleLabel = (UILabel_o *)System_String__Concat_63518544(v40, v43, 0);
          if ( this->fields.addMsgLabel )
          {
            UILabel__set_text(this->fields.addMsgLabel, (System_String_o *)titleLabel, 0);
            titleLabel = this->fields.addMsgLabel;
            if ( titleLabel )
            {
              ...
              if ( titleLabel )
              {
                ...
                if ( ((unsigned __int8)titleLabel & 1) != 0 )
                {
                  ...
                  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
                    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
                  titleLabel = (UILabel_o *)UnityEngine_Object__Instantiate_object__51812484(
                  ...
                  Component_object = UnityEngine_GameObject__GetComponent_object_(
                                       ...
                                       (const MethodInfo_3134970 *)Method_UnityEngine_GameObject_GetComponent_BonusSelectSummonMsgInfo___);
                ...
                if ( titleLabel )
                {
                  ...
                  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                  titleLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12421/*"SUMMON_BONUS_SELECT_DIALOG_SUMMON"*/, 0);
                  if ( v52 )
                  {
        ...
        const MethodInfo *method)
{
  if ( (byte_4C33E7E & 1) == 0 )
  {
    sub_1C32C20(&StringLiteral_4651/*"ConfirmWindow/ConfirmBntInfo/CancleButton"*/);
    byte_4C33E7E = 1;
  }
...
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A736AC;
}
