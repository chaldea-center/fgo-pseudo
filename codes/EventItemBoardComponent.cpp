...
void __fastcall EventItemBoardComponent__OnClickItem(EventItemBoardComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0AE41 & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_EventItemBoardComponent_OnClickItem__, v4);
    sub_1B686D4(&Method_EventItemBoardComponent_SpendItemDlg__, v5);
    ...
    sub_1B686D4(&StringLiteral_14784/*"USE_ITEM_CONFIRM_MSG"*/, v9);
  ...
  if ( this->fields.isEnableSelect )
  {
    ...
    if ( ((unsigned __int8)v14 & 1) != 0 )
    {
      ...
      v18 = LocalizationManager__Get((System_String_o *)StringLiteral_3733/*"COMMON_CONFIRM_DECIDE"*/, 0LL);
      ...
      if ( (*((_BYTE *)Method_EventItemBoardComponent_OnClickItem__ + 83) & 2) != 0 )
        v20 = (_QWORD *)sub_1B686EC(Method_EventItemBoardComponent_OnClickItem__);
      v21 = (System_Reflection_MethodBase_o *)sub_1B686B8(v20, v20[4]);
      OverwriteAssetSoundName__PlaySystemSe(v21, 0, 0LL);
      v14 = LocalizationManager__Get((System_String_o *)StringLiteral_14784/*"USE_ITEM_CONFIRM_MSG"*/, 0LL);
      ...
      v25 = (CommonConfirmDialog_ClickDelegate_o *)sub_1B68920(CommonConfirmDialog_ClickDelegate_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( onCloseDialogFunc )
  {
    ...
    sub_1B68678((ServantStatusBattleListViewItem_o *)p_onCloseDialogFunc, 0, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0AE40 & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_24888/*"{0:N0}"*/, v12);
    sub_1B686D4(&StringLiteral_919/*"-"*/, v13);
    sub_1B686D4(&StringLiteral_19123/*"event_item_board_description"*/, v14);
    byte_4A0AE40 = 1;
  }
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.dialog, (int32_t)dialog, v16, v17);
          ...
          if ( v22 )
          {
            ...
            if ( maskImg )
            {
              ...
              if ( maskImg )
              {
                ...
                maskImg = (int64_t)ItemEntity__getScript_39127996(
                                     (ItemEntity_o *)maskImg,
                                     (System_String_o *)StringLiteral_19123/*"event_item_board_description"*/,
                ...
                if ( itemDetailLb )
                {
                  ...
                  maskImg = (int64_t)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36F769C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
                  if ( maskImg )
                  {
                    ...
                    if ( *p_itemEntity && MasterData_object )
                    {
                      ...
                      maskImg = (int64_t)System_String__Format((System_String_o *)StringLiteral_24888/*"{0:N0}"*/, v31, 0LL);
                      if ( currentNumLb )
                      {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0AE42 & 1) == 0 )
  {
    sub_1B686D4(&System_Action_TypeInfo, isDecided);
    sub_1B686D4(&Method_EventItemBoardComponent_OnCloseConfirmDialog__, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0AE3E & 1) == 0 )
  {
    sub_1B686D4(&EventItemBoardComponent_CallbackFunc_TypeInfo, value);
    byte_4A0AE3E = 1;
  }
  onCloseDialogFunc = this->fields.onCloseDialogFunc;
  p_onCloseDialogFunc = &this->fields.onCloseDialogFunc;
  ...
  else
  {
    if ( v8 == 1 )
    {
      if ( LOBYTE(this[1].fields.method_ptr) )
      {
        ...
        {
          if ( (v11 & 1) != 0 )
            v9 = (Il2CppObject *)sub_19B2488;
          else
            v9 = (Il2CppObject *)sub_19B243C;
        }
        else if ( (v11 & 1) != 0 )
        {
          v9 = (Il2CppObject *)sub_19B23B0;
        }
        else
        {
          v9 = (Il2CppObject *)sub_19B2380;
        }
      }
      else
      {
        v9 = (Il2CppObject *)sub_19B2348;
      }
      goto LABEL_16;
    }
    if ( !object )
...
LABEL_17:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19B22F0;
}
