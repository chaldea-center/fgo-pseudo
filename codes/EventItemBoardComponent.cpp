...
void __fastcall EventItemBoardComponent__OnClickItem(EventItemBoardComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B46A4D & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_EventItemBoardComponent_OnClickItem__, v4);
    sub_1BDB878(&Method_EventItemBoardComponent_SpendItemDlg__, v5);
    ...
    sub_1BDB878(&StringLiteral_14832/*"USE_ITEM_CONFIRM_MSG"*/, v9);
  ...
  if ( this->fields.isEnableSelect )
  {
    ...
    if ( ((unsigned __int8)v14 & 1) != 0 )
    {
      ...
      v18 = LocalizationManager__Get((System_String_o *)StringLiteral_3718/*"COMMON_CONFIRM_DECIDE"*/, 0LL);
      ...
      if ( (*((_BYTE *)Method_EventItemBoardComponent_OnClickItem__ + 83) & 2) != 0 )
        v20 = (_QWORD *)sub_1BDB890(Method_EventItemBoardComponent_OnClickItem__);
      v21 = (System_Reflection_MethodBase_o *)sub_1BDB85C(v20, v20[4]);
      OverwriteAssetSoundName__PlaySystemSe(v21, 0, 0, 0LL);
      v14 = LocalizationManager__Get((System_String_o *)StringLiteral_14832/*"USE_ITEM_CONFIRM_MSG"*/, 0LL);
      itemEntity = this->fields.itemEntity;
      if ( !itemEntity )
        goto LABEL_19;
      v23 = System_String__Format(v14, (Il2CppObject *)itemEntity->fields.name, 0LL);
      Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
      v25 = (CommonConfirmDialog_ClickDelegate_o *)sub_1BDBAC4(CommonConfirmDialog_ClickDelegate_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( onCloseDialogFunc )
  {
    ...
    sub_1BDB81C((CGThumbnailListItem_o *)p_onCloseDialogFunc, 0, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B46A4C & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_25166/*"{0:N0}"*/, v12);
    sub_1BDB878(&StringLiteral_871/*"-"*/, v13);
    sub_1BDB878(&StringLiteral_19215/*"event_item_board_description"*/, v14);
    byte_4B46A4C = 1;
  }
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.dialog, (int32_t)dialog, v16, v17);
  this->fields.onCloseDialogFunc = onConfirmSelectItemFunc;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.onCloseDialogFunc, (int32_t)onConfirmSelectItemFunc, v18, v19);
  maskImg = this->fields.maskImg;
  if ( !maskImg )
    goto LABEL_35;
  ...
  if ( !maskImg )
    goto LABEL_35;
  UILabel__set_text((UILabel_o *)maskImg, (System_String_o *)StringLiteral_871/*"-"*/, 0LL);
          ...
          if ( v22 )
          {
            ...
            if ( maskImg )
            {
              ...
              if ( maskImg )
              {
                ...
                maskImg = ItemEntity__getScript_41235552(
                            (ItemEntity_o *)maskImg,
                            (System_String_o *)StringLiteral_19215/*"event_item_board_description"*/,
                ...
                if ( itemDetailLb )
                {
                  ...
                  maskImg = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
                  if ( maskImg )
                  {
                    ...
                    if ( *p_itemEntity && MasterData_object )
                    {
                      ...
                      maskImg = System_String__Format((System_String_o *)StringLiteral_25166/*"{0:N0}"*/, v31, 0LL);
                      if ( currentNumLb )
                      {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B46A4E & 1) == 0 )
  {
    sub_1BDB878(&System_Action_TypeInfo, isDecided);
    sub_1BDB878(&Method_EventItemBoardComponent_OnCloseConfirmDialog__, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B46A4A & 1) == 0 )
  {
    sub_1BDB878(&EventItemBoardComponent_CallbackFunc_TypeInfo, value);
    byte_4B46A4A = 1;
  }
  onCloseDialogFunc = this->fields.onCloseDialogFunc;
  p_onCloseDialogFunc = &this->fields.onCloseDialogFunc;
  ...
  else
  {
    if ( v8 == 1 )
    {
      if ( LOBYTE(this[1].fields.method_ptr) )
      {
        ...
        {
          if ( (v11 & 1) != 0 )
            v9 = (Il2CppObject *)sub_1A26E14;
          else
            v9 = (Il2CppObject *)sub_1A26DC8;
        }
        else if ( (v11 & 1) != 0 )
        {
          v9 = (Il2CppObject *)sub_1A26D3C;
        }
        else
        {
          v9 = (Il2CppObject *)sub_1A26D0C;
        }
      }
      else
      {
        v9 = (Il2CppObject *)sub_1A26CD4;
      }
      goto LABEL_16;
    }
    if ( !object )
...
LABEL_17:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A26C7C;
}
