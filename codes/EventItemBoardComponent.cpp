...
void __fastcall EventItemBoardComponent__OnClickItem(EventItemBoardComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C24038 & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_EventItemBoardComponent_OnClickItem__, v4);
    sub_1C3B764(&Method_EventItemBoardComponent_SpendItemDlg__, v5);
    ...
    sub_1C3B764(&StringLiteral_15148/*"WAR_BOARD_PROGRESS_OPPONENT_BUFF_TYPES"*/, v9);
  ...
  if ( this->fields.isEnableSelect )
  {
    ...
    if ( ((unsigned __int8)v14 & 1) != 0 )
    {
      ...
      v18 = LocalizationManager__Get((System_String_o *)StringLiteral_3800/*"COSTUME_SELECT_SERVANT_EVENT_ITEM_COSTUME_MSG"*/, 0LL);
      ...
      if ( (*((_BYTE *)Method_EventItemBoardComponent_OnClickItem__ + 83) & 2) != 0 )
        v20 = (_QWORD *)sub_1C3B77C(Method_EventItemBoardComponent_OnClickItem__);
      v21 = (System_Reflection_MethodBase_o *)sub_1C3B748(v20, v20[4]);
      OverwriteAssetSoundName__PlaySystemSe(v21, 0, 0, 0LL);
      v14 = LocalizationManager__Get((System_String_o *)StringLiteral_15148/*"WAR_BOARD_PROGRESS_OPPONENT_BUFF_TYPES"*/, 0LL);
      ...
      v25 = (CommonConfirmDialog_ClickDelegate_o *)sub_1C3B9B0(CommonConfirmDialog_ClickDelegate_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( onCloseDialogFunc )
  {
    ...
    sub_1C3B708((PartyOrganizationUtility_o *)p_onCloseDialogFunc, 0LL, v2, v3, v4, v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24037 & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_25485, v15);
    sub_1C3B764(&StringLiteral_897/*"--MM--Z"*/, v16);
    sub_1C3B764(&StringLiteral_19570/*"hi"*/, v17);
    byte_4C24037 = 1;
  }
  ...
  sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.dialog, (int64_t)dialog, v19, v20, v21, v22, v23, v24);
  ...
  if ( !maskImg )
    goto LABEL_35;
  UILabel__set_text((UILabel_o *)maskImg, (System_String_o *)StringLiteral_897/*"--MM--Z"*/, 0LL);
          ...
          if ( v33 )
          {
            ...
            if ( maskImg )
            {
              ...
              if ( maskImg )
              {
                ...
                maskImg = ItemEntity__getScript_40831412(
                            (ItemEntity_o *)maskImg,
                            (System_String_o *)StringLiteral_19570/*"hi"*/,
                ...
                if ( itemDetailLb )
                {
                  ...
                  maskImg = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
                  if ( maskImg )
                  {
                    ...
                    if ( *p_itemEntity && MasterData_object )
                    {
                      ...
                      maskImg = System_String__Format((System_String_o *)StringLiteral_25485, v42, 0LL);
                      if ( currentNumLb )
                      {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24039 & 1) == 0 )
  {
    sub_1C3B764(&System_Action_TypeInfo, isDecided);
    sub_1C3B764(&Method_EventItemBoardComponent_OnCloseConfirmDialog__, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24035 & 1) == 0 )
  {
    sub_1C3B764(&EventItemBoardComponent_CallbackFunc_TypeInfo, value);
    byte_4C24035 = 1;
  }
  onCloseDialogFunc = this->fields.onCloseDialogFunc;
  p_onCloseDialogFunc = &this->fields.onCloseDialogFunc;
  ...
  else
  {
    if ( v12 == 1 )
    {
      if ( LOBYTE(this[1].fields.method_ptr) )
      {
        ...
        {
          if ( (v15 & 1) != 0 )
            v13 = (Il2CppObject *)sub_1A7E3FC;
          else
            v13 = (Il2CppObject *)sub_1A7E3B0;
        }
        else if ( (v15 & 1) != 0 )
        {
          v13 = (Il2CppObject *)sub_1A7E324;
        }
        else
        {
          v13 = (Il2CppObject *)sub_1A7E2F4;
        }
      }
      else
      {
        v13 = (Il2CppObject *)sub_1A7E2BC;
      }
      goto LABEL_16;
    }
    if ( !object )
...
LABEL_17:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A7E264;
}
