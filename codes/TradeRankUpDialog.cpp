        ...
        const MethodInfo *method)
{
  ...
  __int64 v19; // x1
  Il2CppObject *ComponentInChildren_object__52196464; // x21
  ...
  if ( (byte_4CF052D & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_UnityEngine_GameObject_GetComponentInChildren_UILabel____78862872);
  ...
  if ( tradeGoodsEntity )
  {
    ...
    if ( ((unsigned __int8)v10 & 1) == 0 )
    {
      ...
      if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)Component_object, 0, 0) )
      {
        ...
        v10 = System_String__Format((System_String_o *)StringLiteral_20667/*"img_popularitem_{0}"*/, v13, 0);
        if ( atlasList )
        {
          v14 = v10;
          ...
          ComponentInChildren_object__52196464 = UnityEngine_GameObject__GetComponentInChildren_object__52196464(
                                                   (UnityEngine_GameObject_o *)v9,
                                                   1,
                                                   (const MethodInfo_31C7470 *)Method_UnityEngine_GameObject_GetComponentInChildren_UILabel____78862872);
          if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
          v10 = (System_String_o *)UnityEngine_Object__op_Inequality(
                                     (UnityEngine_Object_o *)ComponentInChildren_object__52196464,
                                     0,
                                     0);
          if ( ((unsigned __int8)v10 & 1) == 0 )
            goto LABEL_23;
          ...
          {
            UILabel__set_text((UILabel_o *)ComponentInChildren_object__52196464, tradeGoodsEntity->fields.name, 0);
LABEL_23:
...
void TradeRankUpDialog__OnClickClose(TradeRankUpDialog_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C7BAE8(&UnityEngine_Object_TypeInfo);
    sub_1C7BAE8(&Method_TradeRankUpDialog_OnClickClose__);
    byte_4CF052C = 1;
  }
  ...
  if ( (*((_BYTE *)Method_TradeRankUpDialog_OnClickClose__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1C7BB00(Method_TradeRankUpDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF052B & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&UnityEngine_Object_TypeInfo);
    sub_1C7BAE8(&StringLiteral_13568/*"TRADE_RANK_UP_DIALOG_DESCRIPTION"*/);
    sub_1C7BAE8(&StringLiteral_13567/*"TRADE_RANK_NAME_{0}"*/);
    byte_4CF052B = 1;
  }
  closeBtn = (UnityEngine_Object_o *)this->fields.closeBtn;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  if ( eventProgressEntity )
  {
    ...
    v18 = System_String__Format((System_String_o *)StringLiteral_13567/*"TRADE_RANK_NAME_{0}"*/, v17, 0);
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v19 = LocalizationManager__Get(v18, 0);
    v41 = progressValue;
    v20 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v41);
    v21 = System_String__Format((System_String_o *)StringLiteral_13567/*"TRADE_RANK_NAME_{0}"*/, v20, 0);
    ...
    Master_object = (UILabel_o *)DataManager__GetMaster_object_((const MethodInfo_31703A0 *)Method_DataManager_GetMaster_EventTradeStoreMaster___);
    if ( Master_object )
    {
      ...
      if ( UnityEngine_Object__op_Inequality(descriptionLabel, 0, 0) )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        v32 = LocalizationManager__Get((System_String_o *)StringLiteral_13568/*"TRADE_RANK_UP_DIALOG_DESCRIPTION"*/, 0);
        if ( v30 )
        {
          v40 = 0;
      ...
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      Master_object = (UILabel_o *)DataManager__GetMaster_object_((const MethodInfo_31703A0 *)Method_DataManager_GetMaster_EventTradeGoodsMaster___);
      if ( Master_object )
      {
