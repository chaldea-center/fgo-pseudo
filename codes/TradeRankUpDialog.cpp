        ...
        const MethodInfo *method)
{
  ...
  __int64 v31; // x1
  Il2CppObject *ComponentInChildren_object__48962912; // x21
  ...
  if ( (byte_4A3004D & 1) == 0 )
  {
    sub_1B761C0(&Method_System_Collections_Generic_List_Enumerator_UIAtlas__Dispose__, atlasList);
    ...
    sub_1B761C0(&Method_UnityEngine_GameObject_GetComponentInChildren_UILabel____75970824, v9);
    sub_1B761C0(&Method_UnityEngine_GameObject_GetComponent_UISprite___, v10);
    sub_1B761C0(&int_TypeInfo, v11);
    sub_1B761C0(&Method_System_Collections_Generic_List_UIAtlas__GetEnumerator__, v12);
    sub_1B761C0(&Method_UnityEngine_Object_Instantiate_GameObject____75989608, v13);
    sub_1B761C0(&UnityEngine_Object_TypeInfo, v14);
    sub_1B761C0(&StringLiteral_20388/*"img_popularitem_{0}"*/, v15);
    byte_4A3004D = 1;
  }
  ...
  if ( tradeGoodsEntity )
  {
    ...
    if ( ((unsigned __int8)v19 & 1) == 0 )
    {
      ...
      if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)Component_object, 0LL, 0LL) )
      {
        ...
        v19 = System_String__Format((System_String_o *)StringLiteral_20388/*"img_popularitem_{0}"*/, v25, 0LL);
        if ( atlasList )
        {
          v26 = v19;
          ...
          ComponentInChildren_object__48962912 = UnityEngine_GameObject__GetComponentInChildren_object__48962912(
                                                   (UnityEngine_GameObject_o *)v18,
                                                   1,
                                                   (const MethodInfo_2EB1D60 *)Method_UnityEngine_GameObject_GetComponentInChildren_UILabel____75970824);
          if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
          v19 = (System_String_o *)UnityEngine_Object__op_Inequality(
                                     (UnityEngine_Object_o *)ComponentInChildren_object__48962912,
                                     0LL,
                                     0LL);
          if ( ((unsigned __int8)v19 & 1) == 0 )
            goto LABEL_23;
          if ( ComponentInChildren_object__48962912 )
          {
            UILabel__set_text((UILabel_o *)ComponentInChildren_object__48962912, tradeGoodsEntity->fields.name, 0LL);
LABEL_23:
...
void __fastcall TradeRankUpDialog__OnClickClose(TradeRankUpDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A3004C & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_TradeRankUpDialog_OnClickClose__, v3);
    byte_4A3004C = 1;
  }
  ...
  if ( (*((_BYTE *)Method_TradeRankUpDialog_OnClickClose__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1B761D8(Method_TradeRankUpDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A3004B & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMaster_EventTradeGoodsMaster___, eventProgressEntity);
    sub_1B761C0(&Method_DataManager_GetMaster_EventTradeStoreMaster___, v9);
    sub_1B761C0(&DataManager_TypeInfo, v10);
    sub_1B761C0(&int_TypeInfo, v11);
    sub_1B761C0(&LocalizationManager_TypeInfo, v12);
    sub_1B761C0(&Method_System_Nullable_int___ctor__, v13);
    sub_1B761C0(&System_Nullable_int__TypeInfo, v14);
    sub_1B761C0(&UnityEngine_Object_TypeInfo, v15);
    sub_1B761C0(&StringLiteral_13414/*"TRADE_RANK_UP_DIALOG_DESCRIPTION"*/, v16);
    sub_1B761C0(&StringLiteral_13413/*"TRADE_RANK_NAME_{0}"*/, v17);
    byte_4A3004B = 1;
  }
  closeBtn = (UnityEngine_Object_o *)this->fields.closeBtn;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  if ( eventProgressEntity )
  {
    ...
    sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.onClosed, (int32_t)inOnClosed, v19, v20);
    ...
    v26 = System_String__Format((System_String_o *)StringLiteral_13413/*"TRADE_RANK_NAME_{0}"*/, v25, 0LL);
    ...
    v32 = System_String__Format((System_String_o *)StringLiteral_13413/*"TRADE_RANK_NAME_{0}"*/, v31, 0LL);
    ...
    Master_object = (UILabel_o *)DataManager__GetMaster_object_((const MethodInfo_2E623B4 *)Method_DataManager_GetMaster_EventTradeStoreMaster___);
    if ( Master_object )
    {
      ...
      if ( UnityEngine_Object__op_Inequality(descriptionLabel, 0LL, 0LL) )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        v46 = LocalizationManager__Get((System_String_o *)StringLiteral_13414/*"TRADE_RANK_UP_DIALOG_DESCRIPTION"*/, 0LL);
        if ( v41 )
        {
          v53 = 0LL;
      ...
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      Master_object = (UILabel_o *)DataManager__GetMaster_object_((const MethodInfo_2E623B4 *)Method_DataManager_GetMaster_EventTradeGoodsMaster___);
      if ( Master_object )
      {
