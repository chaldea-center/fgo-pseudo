        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2026E & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_DataManager_GetMasterData_CommonReleaseMaster___, v19);
    sub_1B715CC(&Method_DataManager_GetMasterData_EventFilterMaster___, v20);
    sub_1B715CC(&Method_DataManager_GetMasterData_ServantPassiveSkillReleaseMaster___, v21);
    sub_1B715CC(&Method_DataManager_GetMaster_UserExchangeSvtMaster___, v22);
    sub_1B715CC(&DataManager_TypeInfo, v23);
  ...
  if ( this->fields.eventId >= 1 )
  {
    ...
    if ( !Instance )
      goto LABEL_40;
    if ( EventFilterMaster__TryGetEntity_38927152(
...
LABEL_39:
    ...
    Instance = (DataManager_o *)DataManager__GetMaster_object_((const MethodInfo_2E5B394 *)Method_DataManager_GetMaster_UserExchangeSvtMaster___);
    if ( Instance )
    {
...
LABEL_21:
  ...
  Instance = (DataManager_o *)DataManager__GetMasterData_object_(
                                Instance,
                                (const MethodInfo_2E5B3E8 *)Method_DataManager_GetMasterData_ServantPassiveSkillReleaseMaster___);
  if ( !Instance )
    goto LABEL_40;
