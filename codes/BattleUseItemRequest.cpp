        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42E7DC3 & 1) == 0 )
  {
    sub_B5D5C4(&NetworkManager_TypeInfo, itemId, num, *(_QWORD *)&eventId);
    sub_B5D5C4(&StringLiteral_21449/*"num"*/, v9, v10, v11);
    sub_B5D5C4(&StringLiteral_18701/*"eventId"*/, v12, v13, v14);
...
System_String_o *__fastcall BattleUseItemRequest__getURL(BattleUseItemRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42E7DC1 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&StringLiteral_16842/*"battle/useItem"*/, v4, v5, v6);
    byte_42E7DC1 = 1;
  }
  if ( (BYTE3(NetworkManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !NetworkManager_TypeInfo->_2.cctor_finished )
  ...
  return System_String__Concat_44577788(BaseUrl, (System_String_o *)StringLiteral_16842/*"battle/useItem"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v12 = ResponseCommandKind__SearchData(107, responseList, 0LL);
