        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C391EA & 1) == 0 )
  {
    ...
    sub_1C32C20(&AssetManager_TypeInfo);
    sub_1C32C20(&Method_UIEquipGraphM_EndLoadAsset__);
    sub_1C32C20(&UIEquipGraphRender_TypeInfo);
    byte_4C391EA = 1;
  }
  if ( !UIEquipGraphRender_TypeInfo->_2.cctor_finished )
...
void UIEquipGraphM__SetTexture(UIEquipGraphM_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C391EC & 1) == 0 )
  {
    ...
    this = (UIEquipGraphM_o *)sub_1C32C20(&StringLiteral_16629/*"a"*/);
    byte_4C391EC = 1;
  }
  ...
  if ( !v4
    || (LastName = AssetData__get_LastName(assetDataList->m_Items[0], 0),
        ...
        this = (UIEquipGraphM_o *)AssetData__GetObject_object__51111776(
                                    v4,
                                    v10,
