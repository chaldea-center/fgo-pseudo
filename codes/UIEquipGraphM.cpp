        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D321DD & 1) == 0 )
  {
    ...
    sub_1C93AD4(&AssetManager_TypeInfo);
    sub_1C93AD4(&Method_UIEquipGraphM_EndLoadAsset__);
    sub_1C93AD4(&UIEquipGraphRender_TypeInfo);
    byte_4D321DD = 1;
  }
  if ( !UIEquipGraphRender_TypeInfo->_2.cctor_finished )
...
void UIEquipGraphM__SetTexture(UIEquipGraphM_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D321DF & 1) == 0 )
  {
    ...
    this = (UIEquipGraphM_o *)sub_1C93AD4(&StringLiteral_16734/*"a"*/);
    byte_4D321DF = 1;
  }
  ...
  if ( !v4
    || (LastName = AssetData__get_LastName(assetDataList->m_Items[0], 0),
        ...
        this = (UIEquipGraphM_o *)AssetData__GetObject_object__51927708(
                                    v4,
                                    v14,
