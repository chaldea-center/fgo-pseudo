        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E06227 & 1) == 0 )
  {
    ...
    sub_1CE6700(&AssetManager_TypeInfo);
    sub_1CE6700(&Method_UIEquipGraphM_EndLoadAsset__);
    sub_1CE6700(&UIEquipGraphRender_TypeInfo);
    byte_4E06227 = 1;
  }
  if ( !UIEquipGraphRender_TypeInfo->_2.cctor_finished )
...
void UIEquipGraphM__SetTexture(UIEquipGraphM_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E06229 & 1) == 0 )
  {
    ...
    this = (UIEquipGraphM_o *)sub_1CE6700(&StringLiteral_16786/*"a"*/);
    byte_4E06229 = 1;
  }
  ...
  if ( !v4
    || (LastName = AssetData__get_LastName(assetDataList->m_Items[0], 0),
        ...
        this = (UIEquipGraphM_o *)AssetData__GetObject_object__52317288(
                                    v4,
                                    v14,
