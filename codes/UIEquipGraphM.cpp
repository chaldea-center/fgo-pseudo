        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E78ECE & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&AssetManager_TypeInfo);
    sub_1D0F0B4(&Method_UIEquipGraphM_EndLoadAsset__);
    sub_1D0F0B4(&UIEquipGraphRender_TypeInfo);
    byte_4E78ECE = 1;
  }
  if ( !UIEquipGraphRender_TypeInfo->_2.cctor_finished )
...
void UIEquipGraphM__SetTexture(UIEquipGraphM_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E78ED0 & 1) == 0 )
  {
    ...
    this = (UIEquipGraphM_o *)sub_1D0F0B4(&StringLiteral_16857/*"a"*/);
    byte_4E78ED0 = 1;
  }
  ...
  if ( !v4
    || (LastName = AssetData__get_LastName(assetDataList->m_Items[0], 0),
        ...
        this = (UIEquipGraphM_o *)AssetData__GetObject_object__52624444(
                                    v4,
                                    v14,
