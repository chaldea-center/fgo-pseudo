        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E71084 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_CenterEffectDetailDialog_EndClose__);
    byte_4E71084 = 1;
  }
...
void CenterEffectDetailDialog__OnClickCancel(CenterEffectDetailDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E71085 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_CenterEffectDetailDialog_OnClickCancel__);
    byte_4E71085 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1D0F0B4(&System_Action_TypeInfo);
    sub_1D0F0B4(&Method_CenterEffectDetailDialog_EndOpen__);
    sub_1D0F0B4(&Method_DataManager_GetMaster_StageMaster___);
    sub_1D0F0B4(&DataManager_TypeInfo);
    sub_1D0F0B4(&Method_System_Linq_Enumerable_Distinct_CenterEffectDetailDialog_CenterEffectDetailSkillInfo___);
    sub_1D0F0B4(&Method_System_Linq_Enumerable_ToList_CenterEffectDetailDialog_CenterEffectDetailSkillInfo___);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_Enumerator_StageEntity__Dispose__);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_Enumerator_StageEntity__MoveNext__);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_Enumerator_StageEntity__get_Current__);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_CenterEffectDetailDialog_CenterEffectDetailSkillInfo__Add__);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_StageEntity__GetEnumerator__);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_CenterEffectDetailDialog_CenterEffectDetailSkillInfo___ctor__);
    ...
    sub_1D0F0B4(&System_Collections_Generic_List_CenterEffectDetailDialog_CenterEffectDetailSkillInfo__TypeInfo);
    sub_1D0F0B4(&LocalizationManager_TypeInfo);
    sub_1D0F0B4(&StringLiteral_3346/*"CENTER_EFFECT_DETAIL_DIALOG_TITLE"*/);
    sub_1D0F0B4(&StringLiteral_3724/*"COMMON_CONFIRM_CLOSE"*/);
    sub_1D0F0B4(&StringLiteral_3345/*"CENTER_EFFECT_DETAIL_DIALOG_MESSAGE"*/);
    byte_4E71083 = 1;
  }
  ...
  closeBtn = LocalizationManager__Get((System_String_o *)StringLiteral_3346/*"CENTER_EFFECT_DETAIL_DIALOG_TITLE"*/, 0);
  if ( !titleLabel )
    goto LABEL_35;
  UILabel__set_text(titleLabel, closeBtn, 0);
  titleDetailLabel = this->fields.titleDetailLabel;
  closeBtn = LocalizationManager__Get((System_String_o *)StringLiteral_3345/*"CENTER_EFFECT_DETAIL_DIALOG_MESSAGE"*/, 0);
  if ( !titleDetailLabel )
    goto LABEL_35;
  UILabel__set_text(titleDetailLabel, closeBtn, 0);
  closeLabel = this->fields.closeLabel;
  closeBtn = LocalizationManager__Get((System_String_o *)StringLiteral_3724/*"COMMON_CONFIRM_CLOSE"*/, 0);
  if ( !closeLabel )
    goto LABEL_35;
  ...
  v15 = (System_Collections_Generic_List_CenterEffectDetailDialog_CenterEffectDetailSkillInfo__o *)sub_1D0F300(System_Collections_Generic_List_CenterEffectDetailDialog_CenterEffectDetailSkillInfo__TypeInfo);
  System_Collections_Generic_List_CenterEffectDetailDialog_CenterEffectDetailSkillInfo____ctor(
    v15,
    (const MethodInfo_39F9F60 *)Method_System_Collections_Generic_List_CenterEffectDetailDialog_CenterEffectDetailSkillInfo___ctor__);
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  closeBtn = (System_String_o *)DataManager__GetMaster_object_((const MethodInfo_324F164 *)Method_DataManager_GetMaster_StageMaster___);
  if ( !closeBtn )
    goto LABEL_35;
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    (const MethodInfo_395CF08 *)Method_System_Collections_Generic_List_StageEntity__GetEnumerator__);
  v40 = v39;
  while ( 1 )
  {
    v16 = System_Collections_Generic_List_Enumerator_object___MoveNext(
            &v40,
            (const MethodInfo_36CDF88 *)Method_System_Collections_Generic_List_Enumerator_StageEntity__MoveNext__);
    if ( !v16 )
      break;
      ...
      do
      {
        ...
        if ( (unsigned int)size >= LODWORD(items->max_length) )
        {
          System_Collections_Generic_List_CenterEffectDetailDialog_CenterEffectDetailSkillInfo___AddWithResize(
            v15,
            v34,
            *(const MethodInfo_39FA7B4 **)(*(_QWORD *)(v32[4] + 192LL) + 112LL));
        }
        else
        {
  ...
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v40,
    (const MethodInfo_36CDF84 *)Method_System_Collections_Generic_List_Enumerator_StageEntity__Dispose__);
  v35 = System_Linq_Enumerable__Distinct_CenterEffectDetailDialog_CenterEffectDetailSkillInfo_(
          (System_Collections_Generic_IEnumerable_TSource__o *)v15,
          (const MethodInfo_3272AB8 *)Method_System_Linq_Enumerable_Distinct_CenterEffectDetailDialog_CenterEffectDetailSkillInfo___);
  closeBtn = (System_String_o *)System_Linq_Enumerable__ToList_CenterEffectDetailDialog_CenterEffectDetailSkillInfo_(
                                  v35,
                                  (const MethodInfo_329560C *)Method_System_Linq_Enumerable_ToList_CenterEffectDetailDialog_CenterEffectDetailSkillInfo___);
        ...
        const MethodInfo *method)
{
  ...
  v11 = (CenterEffectDetailDialog_o *)sub_1D0F6A8(v8);
