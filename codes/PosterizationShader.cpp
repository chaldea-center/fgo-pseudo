        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2AA4A & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_16182/*"_DisplayColor"*/);
    sub_1C2D490(&StringLiteral_16305/*"_PetternNumber"*/);
    sub_1C2D490(&StringLiteral_16184/*"_Divedenum"*/);
  ...
  if ( !material
    ...
    || (UnityEngine_Material__SetFloat(material, (System_String_o *)StringLiteral_16184/*"_Divedenum"*/, this->fields.divedenum, 0),
        (material = ImageEffectBase__get_material((ImageEffectBase_o *)this, 0)) == 0)
    || (UnityEngine_Material__SetFloat(
          material,
          (System_String_o *)StringLiteral_16182/*"_DisplayColor"*/,
  ...
  UnityEngine_Material__SetInt(material, (System_String_o *)StringLiteral_16305/*"_PetternNumber"*/, this->fields.petternNumber, 0);
