        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AF827 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_16070/*"_DisplayColor"*/);
    sub_B52984(&StringLiteral_16143/*"_PetternNumber"*/);
    sub_B52984(&StringLiteral_16072/*"_Divedenum"*/);
  ...
  if ( !material
    ...
    || (UnityEngine_Material__SetFloat(material, (System_String_o *)StringLiteral_16072/*"_Divedenum"*/, this->fields.divedenum, 0LL),
        (material = ImageEffectBase__get_material((ImageEffectBase_o *)this, 0LL)) == 0LL)
    || (UnityEngine_Material__SetFloat(
          material,
          (System_String_o *)StringLiteral_16070/*"_DisplayColor"*/,
  ...
  UnityEngine_Material__SetInt(material, (System_String_o *)StringLiteral_16143/*"_PetternNumber"*/, this->fields.petternNumber, 0LL);
