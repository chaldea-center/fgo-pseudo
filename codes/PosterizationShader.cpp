        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40F8FC6 & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_15900, v7);
    sub_B16FFC(&StringLiteral_15973, v8);
    sub_B16FFC(&StringLiteral_15902, v9);
    sub_B16FFC(&StringLiteral_15991, v10);
    byte_40F8FC6 = 1;
  }
  ...
  if ( !material
    ...
    || (UnityEngine_Material__SetFloat(v12, (System_String_o *)StringLiteral_15902, this->fields.divedenum, 0LL),
  ...
  UnityEngine_Material__SetInt(v14, (System_String_o *)StringLiteral_15973, this->fields.petternNumber, 0LL);
