        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C446B1 & 1) == 0 )
  {
    ...
    sub_1C37058(&RaceResultEffectParam_TypeInfo);
    this = (TermObjectSwitchEffectSubComponent_o *)sub_1C37058(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4C446B1 = 1;
  }
  if ( param
  ...
  this = (TermObjectSwitchEffectSubComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39ED16C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this )
    goto LABEL_31;
