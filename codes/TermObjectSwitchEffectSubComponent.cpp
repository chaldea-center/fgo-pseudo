        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D320A3 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&RaceResultEffectParam_TypeInfo);
    this = (TermObjectSwitchEffectSubComponent_o *)sub_1C93AD4(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4D320A3 = 1;
  }
  if ( param
  ...
  this = (TermObjectSwitchEffectSubComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3AC52FC *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this )
    goto LABEL_31;
