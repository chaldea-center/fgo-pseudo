        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4184554 & 1) == 0 )
  {
    ...
    this = (TermObjectSwitchEffectSubComponent_o *)sub_B2C35C(
  ...
  this = (TermObjectSwitchEffectSubComponent_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2841668 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this )
    goto LABEL_31;
