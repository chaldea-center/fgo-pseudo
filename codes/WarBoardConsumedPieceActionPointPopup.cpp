        ...
        const MethodInfo *method)
{
  if ( (byte_4B42813 & 1) == 0 )
  {
    sub_1BDB878(&WarBoardInfoPopupBase_TypeInfo, method);
    byte_4B42813 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B42811 & 1) == 0 )
  {
    sub_1BDB878(&Method_WarBoardConsumedPieceActionPointPopup_OnClickClose__, method);
    byte_4B42811 = 1;
  }
    ...
    && !this->fields._isHideAnimating_k__BackingField )
  {
    ...
    if ( (*((_BYTE *)Method_WarBoardConsumedPieceActionPointPopup_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BDB890(Method_WarBoardConsumedPieceActionPointPopup_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B42810 & 1) == 0 )
  {
    sub_1BDB878(&int_TypeInfo, clickCallback);
    sub_1BDB878(&LocalizationManager_TypeInfo, v9);
    sub_1BDB878(&NGUITools_TypeInfo, v10);
    sub_1BDB878(&UnityEngine_Object_TypeInfo, v11);
    sub_1BDB878(&Method_System_Collections_ObjectModel_ReadOnlyCollection_WarBoardPieceData__get_Count__, v12);
    sub_1BDB878(&Method_System_Collections_ObjectModel_ReadOnlyCollection_WarBoardPieceData__get_Item__, v13);
    sub_1BDB878(&System_Text_StringBuilder_TypeInfo, v14);
    sub_1BDB878(&StringLiteral_15363/*"WARBOARD_CONSUMED_PIECE_ACTION_POINT_CLOSE"*/, v15);
    sub_1BDB878(&StringLiteral_15364/*"WARBOARD_CONSUMED_PIECE_ACTION_POINT_MESSAGE"*/, v16);
    byte_4B42810 = 1;
  }
  ...
  v17 = LocalizationManager__Get((System_String_o *)StringLiteral_15364/*"WARBOARD_CONSUMED_PIECE_ACTION_POINT_MESSAGE"*/, 0LL);
  v36 = consumedPoint;
  ...
  Count = (System_String_o *)System_Collections_ObjectModel_ReadOnlyCollection_object___get_Count(
                               ...
                               (const MethodInfo_38C2AF8 *)Method_System_Collections_ObjectModel_ReadOnlyCollection_WarBoardPieceData__get_Count__);
  if ( (int)Count >= 1 )
  {
    v25 = 0;
    while ( 1 )
    {
      Item = System_Collections_ObjectModel_ReadOnlyCollection_object___get_Item(
               (System_Collections_ObjectModel_ReadOnlyCollection_T__o *)consumedPieceList,
               v25,
               (const MethodInfo_38C2B80 *)Method_System_Collections_ObjectModel_ReadOnlyCollection_WarBoardPieceData__get_Item__);
      Count = (System_String_o *)System_Collections_ObjectModel_ReadOnlyCollection_object___get_Count(
                                   (System_Collections_ObjectModel_ReadOnlyCollection_T__o *)consumedPieceList,
                                   (const MethodInfo_38C2AF8 *)Method_System_Collections_ObjectModel_ReadOnlyCollection_WarBoardPieceData__get_Count__);
      if ( !Item )
      ...
      if ( !v24 )
        break;
      if ( v25 == v27 - 1 )
        System_Text_StringBuilder__Append_62657444(v24, Count, 0LL);
      else
        System_Text_StringBuilder__AppendLine_62658668(v24, Count, 0LL);
      ++v25;
      Count = (System_String_o *)System_Collections_ObjectModel_ReadOnlyCollection_object___get_Count(
                                   (System_Collections_ObjectModel_ReadOnlyCollection_T__o *)consumedPieceList,
                                   (const MethodInfo_38C2AF8 *)Method_System_Collections_ObjectModel_ReadOnlyCollection_WarBoardPieceData__get_Count__);
...
LABEL_16:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  Count = LocalizationManager__Get((System_String_o *)StringLiteral_15363/*"WARBOARD_CONSUMED_PIECE_ACTION_POINT_CLOSE"*/, 0LL);
  if ( !closeButtonLabel )
    goto LABEL_36;
  ...
  NGUITools__UpdateWidgetCollider_48642940(gameObject, 1, 0LL);
