void BoardMessageReleaseMaster___ctor(BoardMessageReleaseMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4C56A17 & 1) == 0 )
  {
    sub_1C3E564(&Method_DataMasterBase_BoardMessageReleaseMaster__BoardMessageReleaseEntity__string___ctor__);
    byte_4C56A17 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    237,
    (const MethodInfo_33B56EC *)Method_DataMasterBase_BoardMessageReleaseMaster__BoardMessageReleaseEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C56A15 & 1) == 0 )
  {
    sub_1C3E564(&Method_DataMasterBase_BoardMessageReleaseMaster__BoardMessageReleaseEntity__string__GetEntity__);
    byte_4C56A15 = 1;
  }
  ...
  return (BoardMessageReleaseEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                          (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                          PK,
                                          (const MethodInfo_33B7A10 *)Method_DataMasterBase_BoardMessageReleaseMaster__BoardMessageReleaseEntity__string__GetEntity__);
}
...
bool BoardMessageReleaseMaster__IsOpen(BoardMessageReleaseMaster_o *this, int32_t messageId, const MethodInfo *method)
{
  ...
  if ( (byte_4C56A18 & 1) == 0 )
  {
    sub_1C3E564(&Method_System_Collections_ObjectModel_Collection_BoardMessageReleaseEntity__get_Count__);
    sub_1C3E564(&Method_System_Collections_ObjectModel_Collection_BoardMessageReleaseEntity__get_Item__);
  ...
  list = (void *)System_Collections_ObjectModel_Collection_object___get_Count(
                   ...
                   (const MethodInfo_334C3C8 *)Method_System_Collections_ObjectModel_Collection_BoardMessageReleaseEntity__get_Count__);
  if ( (int)list >= 1 )
  {
    v8 = (int)list;
    v9 = 0;
    while ( 1 )
    {
      ...
      list = System_Collections_ObjectModel_Collection_object___get_Item(
               (System_Collections_ObjectModel_Collection_T__o *)list,
               v9,
               (const MethodInfo_334C458 *)Method_System_Collections_ObjectModel_Collection_BoardMessageReleaseEntity__get_Item__);
      if ( !list )
        break;
      v10 = list;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C56A16 & 1) == 0 )
  {
    sub_1C3E564(&Method_DataMasterBase_BoardMessageReleaseMaster__BoardMessageReleaseEntity__string__TryGetEntity__);
    byte_4C56A16 = 1;
  }
  PK = (Il2CppObject *)BoardMessageReleaseEntity__CreatePK(
                         messageId,
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_33B7A5C *)Method_DataMasterBase_BoardMessageReleaseMaster__BoardMessageReleaseEntity__string__TryGetEntity__);
}