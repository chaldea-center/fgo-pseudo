void __fastcall BoardMessageReleaseMaster___ctor(BoardMessageReleaseMaster_o *this, const MethodInfo *method)
{
  if ( (byte_40FB0C6 & 1) == 0 )
  {
    sub_B16FFC(&Method_DataMasterBase_BoardMessageReleaseMaster__BoardMessageReleaseEntity__string___ctor__, method);
    byte_40FB0C6 = 1;
  }
  DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string____ctor(
    (DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string__o *)this,
    229,
    (const MethodInfo_266F73C *)Method_DataMasterBase_BoardMessageReleaseMaster__BoardMessageReleaseEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (BoardMessageReleaseEntity_o *)DataMasterBase_WarGroupMaster__WarGroupEntity__string___GetEntity(
                                          ...
                                          PK,
                                          (const MethodInfo_266F7D8 *)Method_DataMasterBase_BoardMessageReleaseMaster__BoardMessageReleaseEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  int32_t Count; // w0
  BoardMessageReleaseEntity_c **v26; // x26
  int32_t v27; // w22
  int32_t v28; // w23
  ...
  __int64 v32; // x10
  BoardMessageReleaseMaster_o *v33; // x22
  int32_t v34; // w20
  BoardMessageReleaseEntity_c **v35; // x19
  int32_t monitor; // w25
  ...
  if ( (byte_40FB0C7 & 1) == 0 )
  {
    sub_B16FFC(&BoardMessageReleaseEntity_TypeInfo, *(_QWORD *)&messageId);
    ...
    sub_B16FFC(&Method_System_Collections_Generic_Dictionary_int__bool__ContainsKey__, v10);
    sub_B16FFC(&Method_System_Collections_Generic_Dictionary_int__bool___ctor__, v11);
    sub_B16FFC(&Method_System_Collections_Generic_Dictionary_int__bool__get_Count__, v12);
    sub_B16FFC(&Method_System_Collections_Generic_Dictionary_int__bool__get_Item__, v13);
    sub_B16FFC(&Method_System_Collections_Generic_Dictionary_int__bool__get_Values__, v14);
    sub_B16FFC(&Method_System_Collections_Generic_Dictionary_int__bool__set_Item__, v15);
    sub_B16FFC(&System_Collections_Generic_Dictionary_int__bool__TypeInfo, v16);
    sub_B16FFC(&Method_System_Collections_Generic_List_Enumerator_bool__Dispose__, v17);
    sub_B16FFC(&Method_System_Collections_Generic_List_Enumerator_bool__MoveNext__, v18);
    sub_B16FFC(&Method_System_Collections_Generic_List_Enumerator_bool__get_Current__, v19);
  ...
  if ( Count >= 1 )
  {
    v26 = &BoardMessageReleaseEntity_TypeInfo;
    v27 = Count;
    v28 = 0;
    v49 = Count;
    while ( 1 )
    {
      ...
      if ( *(&Item->klass->_2.bitflags2 + 1) < (unsigned int)v32
        || (BoardMessageReleaseEntity_c *)Item->klass->_2.typeHierarchy[v32 - 1] != *v26 )
      {
        break;
      }
        ...
        const MethodInfo *method)
{
  ...
  return DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string___TryGetEntity(
           ...
           PK,
           (const MethodInfo_266F830 *)Method_DataMasterBase_BoardMessageReleaseMaster__BoardMessageReleaseEntity__string__TryGetEntity__);
}