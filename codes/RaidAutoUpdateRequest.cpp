int64_t __fastcall RaidAutoUpdateRequest__GetAccessCompletedTimeEventMap(const MethodInfo *method)
{
  ...
  if ( (byte_49FDCF3 & 1) == 0 )
  {
    sub_1B640C8(&RaidAutoUpdateRequest_TypeInfo, v1);
    byte_49FDCF3 = 1;
  }
...
bool __fastcall RaidAutoUpdateRequest__IsExpirationDateUpdateEventMap(const MethodInfo *method)
{
  ...
  if ( (byte_49FDCF0 & 1) == 0 )
  {
    ...
    sub_1B640C8(&RaidAutoUpdateRequest_TypeInfo, v2);
    byte_49FDCF0 = 1;
  }
...
void __fastcall RaidAutoUpdateRequest__UpdateAccessTime(const MethodInfo *method)
{
  ...
  if ( (byte_49FDCF2 & 1) == 0 )
  {
    ...
    sub_1B640C8(&RaidAutoUpdateRequest_TypeInfo, v3);
    byte_49FDCF2 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
...
System_String_o *__fastcall RaidAutoUpdateRequest__getURL(RaidAutoUpdateRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FDCEF & 1) == 0 )
  {
    ...
    sub_1B640C8(&StringLiteral_7222/*"Home/RaidAutoUpdate"*/, v2);
    byte_49FDCEF = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61375396(BaseUrl, (System_String_o *)StringLiteral_7222/*"Home/RaidAutoUpdate"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDCF1 & 1) == 0 )
  {
    ...
    sub_1B640C8(&RaidAutoUpdateRequest_TypeInfo, v6);
