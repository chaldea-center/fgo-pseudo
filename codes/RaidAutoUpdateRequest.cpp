int64_t __fastcall RaidAutoUpdateRequest__GetAccessCompletedTimeEventMap(const MethodInfo *method)
{
  ...
  if ( (byte_4A213D4 & 1) == 0 )
  {
    sub_1B715CC(&RaidAutoUpdateRequest_TypeInfo, v1);
    byte_4A213D4 = 1;
  }
...
bool __fastcall RaidAutoUpdateRequest__IsExpirationDateUpdateEventMap(const MethodInfo *method)
{
  ...
  if ( (byte_4A213D1 & 1) == 0 )
  {
    ...
    sub_1B715CC(&RaidAutoUpdateRequest_TypeInfo, v2);
    byte_4A213D1 = 1;
  }
...
void __fastcall RaidAutoUpdateRequest__UpdateAccessTime(const MethodInfo *method)
{
  ...
  if ( (byte_4A213D3 & 1) == 0 )
  {
    ...
    sub_1B715CC(&RaidAutoUpdateRequest_TypeInfo, v3);
    byte_4A213D3 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
...
System_String_o *__fastcall RaidAutoUpdateRequest__getURL(RaidAutoUpdateRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A213D0 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_7227/*"Home/RaidAutoUpdate"*/, v2);
    byte_4A213D0 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61505504(BaseUrl, (System_String_o *)StringLiteral_7227/*"Home/RaidAutoUpdate"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A213D2 & 1) == 0 )
  {
    ...
    sub_1B715CC(&RaidAutoUpdateRequest_TypeInfo, v6);
