...
System_String_o *__fastcall RaidAutoUpdateRequest__getURL(RaidAutoUpdateRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_B52984(&NetworkManager_TypeInfo);
    sub_B52984(&StringLiteral_7215/*"Home/RaidAutoUpdate"*/);
    byte_42AE4F9 = 1;
  }
  if ( (BYTE3(NetworkManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !NetworkManager_TypeInfo->_2.cctor_finished )
  ...
  return System_String__Concat_44568316(BaseUrl, (System_String_o *)StringLiteral_7215/*"Home/RaidAutoUpdate"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_19:
    v11 = (System_String_o *)StringLiteral_21388/*"ok"*/;
  }
