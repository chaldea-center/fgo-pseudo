int64_t __fastcall RaidAutoUpdateRequest__GetAccessCompletedTimeEventMap(const MethodInfo *method)
{
  ...
  if ( (byte_4B38B0B & 1) == 0 )
  {
    sub_1BD3458(&RaidAutoUpdateRequest_TypeInfo, v1);
    byte_4B38B0B = 1;
  }
...
bool __fastcall RaidAutoUpdateRequest__IsExpirationDateUpdateEventMap(const MethodInfo *method)
{
  ...
  if ( (byte_4B38B08 & 1) == 0 )
  {
    ...
    sub_1BD3458(&RaidAutoUpdateRequest_TypeInfo, v2);
    byte_4B38B08 = 1;
  }
...
void __fastcall RaidAutoUpdateRequest__UpdateAccessTime(const MethodInfo *method)
{
  ...
  if ( (byte_4B38B0A & 1) == 0 )
  {
    ...
    sub_1BD3458(&RaidAutoUpdateRequest_TypeInfo, v3);
    byte_4B38B0A = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
...
System_String_o *__fastcall RaidAutoUpdateRequest__getURL(RaidAutoUpdateRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B38B07 & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_7390/*"Home/RaidAutoUpdate"*/, v2);
    byte_4B38B07 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62525248(BaseUrl, (System_String_o *)StringLiteral_7390/*"Home/RaidAutoUpdate"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B38B09 & 1) == 0 )
  {
    ...
    sub_1BD3458(&RaidAutoUpdateRequest_TypeInfo, v6);
  ...
  if ( !v9 )
    goto LABEL_14;
  v10 = v9;
  if ( !ResponseData__checkError_42055668(v9, 0LL) )
    goto LABEL_14;
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
