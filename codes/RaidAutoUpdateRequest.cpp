int64_t __fastcall RaidAutoUpdateRequest__GetAccessCompletedTimeEventMap(const MethodInfo *method)
{
  ...
  if ( (byte_49BC8BC & 1) == 0 )
  {
    sub_1B4CF90(&RaidAutoUpdateRequest_TypeInfo, v1);
    byte_49BC8BC = 1;
  }
...
bool __fastcall RaidAutoUpdateRequest__IsExpirationDateUpdateEventMap(const MethodInfo *method)
{
  ...
  if ( (byte_49BC8B9 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&RaidAutoUpdateRequest_TypeInfo, v2);
    byte_49BC8B9 = 1;
  }
...
void __fastcall RaidAutoUpdateRequest__UpdateAccessTime(const MethodInfo *method)
{
  ...
  if ( (byte_49BC8BB & 1) == 0 )
  {
    ...
    sub_1B4CF90(&RaidAutoUpdateRequest_TypeInfo, v3);
    byte_49BC8BB = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
...
System_String_o *__fastcall RaidAutoUpdateRequest__getURL(RaidAutoUpdateRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BC8B8 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_7161/*"Home/RaidAutoUpdate"*/, v2);
    byte_49BC8B8 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61093468(BaseUrl, (System_String_o *)StringLiteral_7161/*"Home/RaidAutoUpdate"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BC8BA & 1) == 0 )
  {
    ...
    sub_1B4CF90(&RaidAutoUpdateRequest_TypeInfo, v6);
  ...
  if ( !v9 )
    goto LABEL_14;
  v10 = v9;
  if ( !ResponseData__checkError_41839176(v9, 0LL) )
    goto LABEL_14;
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
