int64_t __fastcall RaidAutoUpdateRequest__GetAccessCompletedTimeEventMap(const MethodInfo *method)
{
  ...
  if ( (byte_4B03B3A & 1) == 0 )
  {
    sub_1BC3008(&RaidAutoUpdateRequest_TypeInfo, v1);
    byte_4B03B3A = 1;
  }
...
bool __fastcall RaidAutoUpdateRequest__IsExpirationDateUpdateEventMap(const MethodInfo *method)
{
  ...
  if ( (byte_4B03B37 & 1) == 0 )
  {
    ...
    sub_1BC3008(&RaidAutoUpdateRequest_TypeInfo, v2);
    byte_4B03B37 = 1;
  }
...
void __fastcall RaidAutoUpdateRequest__UpdateAccessTime(const MethodInfo *method)
{
  ...
  if ( (byte_4B03B39 & 1) == 0 )
  {
    ...
    sub_1BC3008(&RaidAutoUpdateRequest_TypeInfo, v3);
    byte_4B03B39 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
...
System_String_o *__fastcall RaidAutoUpdateRequest__getURL(RaidAutoUpdateRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B03B36 & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_7269/*"Home/RaidAutoUpdate"*/, v2);
    byte_4B03B36 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62348648(BaseUrl, (System_String_o *)StringLiteral_7269/*"Home/RaidAutoUpdate"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B03B38 & 1) == 0 )
  {
    ...
    sub_1BC3008(&RaidAutoUpdateRequest_TypeInfo, v6);
