...
int64_t __fastcall RaidAutoUpdateRequest__GetAccessCompletedTimeEventMap(const MethodInfo *method)
{
  ...
  if ( (byte_41860E1 & 1) == 0 )
  {
    sub_B2C35C(&RaidAutoUpdateRequest_TypeInfo, v1);
    byte_41860E1 = 1;
  }
...
bool __fastcall RaidAutoUpdateRequest__IsExpirationDateUpdateEventMap(const MethodInfo *method)
{
  ...
  if ( (byte_41860DE & 1) == 0 )
  {
    ...
    sub_B2C35C(&RaidAutoUpdateRequest_TypeInfo, v2);
    byte_41860DE = 1;
  }
...
void __fastcall RaidAutoUpdateRequest__UpdateAccessTime(const MethodInfo *method)
{
  ...
  if ( (byte_41860E0 & 1) == 0 )
  {
    ...
    sub_B2C35C(&RaidAutoUpdateRequest_TypeInfo, v3);
    byte_41860E0 = 1;
  }
  if ( (BYTE3(NetworkManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !NetworkManager_TypeInfo->_2.cctor_finished )
...
System_String_o *__fastcall RaidAutoUpdateRequest__getURL(RaidAutoUpdateRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_41860DD & 1) == 0 )
  {
    ...
    sub_B2C35C(&StringLiteral_7169/*"Home/RaidAutoUpdate"*/, v2);
    byte_41860DD = 1;
  }
  if ( (BYTE3(NetworkManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !NetworkManager_TypeInfo->_2.cctor_finished )
  ...
  return System_String__Concat_44305532(BaseUrl, (System_String_o *)StringLiteral_7169/*"Home/RaidAutoUpdate"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_41860DF & 1) == 0 )
  {
    ...
    sub_B2C35C(&RaidAutoUpdateRequest_TypeInfo, v6);
  ...
  if ( !v9 )
    goto LABEL_19;
  v10 = v9;
  if ( !ResponseData__checkError_31019724(v9, 0LL) )
    goto LABEL_19;
  if ( (BYTE3(NetworkManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !NetworkManager_TypeInfo->_2.cctor_finished )
  {
  ...
  {
LABEL_19:
    v15 = (System_String_o *)StringLiteral_21218/*"ok"*/;
  }
