        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F9B1F & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_9609/*"OPTION_ADVANTAGE_CLASS_AUTO_INFO"*/, v4);
    sub_1B64870(&StringLiteral_9608/*"OPTION_ADVANTAGE_CLASS_AUTO"*/, v5);
    byte_49F9B1F = 1;
  }
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v7 = LocalizationManager__Get((System_String_o *)StringLiteral_9608/*"OPTION_ADVANTAGE_CLASS_AUTO"*/, 0LL);
  if ( !titleLabel
    || (UILabel__set_text(titleLabel, v7, 0LL),
        infoLabel = this->fields.infoLabel,
        v7 = LocalizationManager__Get((System_String_o *)StringLiteral_9609/*"OPTION_ADVANTAGE_CLASS_AUTO_INFO"*/, 0LL),
        !infoLabel) )
  {
    sub_1B64ACC(v7, v8);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F9B21 & 1) == 0 )
  {
    sub_1B64870(&Method_SetAdvantageClassAutoOptionControl_OnClickButton__, method);
    byte_49F9B21 = 1;
  }
  klass = this->klass;
  this->fields.flag ^= 1u;
  ...
  if ( (*((_BYTE *)Method_SetAdvantageClassAutoOptionControl_OnClickButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1B64888(Method_SetAdvantageClassAutoOptionControl_OnClickButton__);
