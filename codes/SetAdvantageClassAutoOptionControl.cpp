...
void SetAdvantageClassAutoOptionControl__Init(SetAdvantageClassAutoOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3DFE2 & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_9657/*"OPTION_ADVANTAGE_CLASS_AUTO_INFO"*/);
    sub_1C37058(&StringLiteral_9656/*"OPTION_ADVANTAGE_CLASS_AUTO"*/);
    byte_4C3DFE2 = 1;
  }
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9656/*"OPTION_ADVANTAGE_CLASS_AUTO"*/, 0);
  if ( !titleLabel
    || (UILabel__set_text(titleLabel, v4, 0),
        infoLabel = this->fields.infoLabel,
        v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9657/*"OPTION_ADVANTAGE_CLASS_AUTO_INFO"*/, 0),
        !infoLabel) )
  {
    sub_1C372B4(v4);
  }
  ...
  SetAdvantageClassAutoOptionControl__RefreshDisplay(this, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3DFE4 & 1) == 0 )
  {
    sub_1C37058(&Method_SetAdvantageClassAutoOptionControl_OnClickButton__);
    byte_4C3DFE4 = 1;
  }
  klass = this->klass;
  this->fields.flag ^= 1u;
  ...
  if ( (*((_BYTE *)Method_SetAdvantageClassAutoOptionControl_OnClickButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1C37070(Method_SetAdvantageClassAutoOptionControl_OnClickButton__);
