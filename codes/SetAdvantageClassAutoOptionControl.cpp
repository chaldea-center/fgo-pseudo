...
void SetAdvantageClassAutoOptionControl__Init(SetAdvantageClassAutoOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C51D62 & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_9657/*"OPTION_ADVANTAGE_CLASS_AUTO_INFO"*/);
    sub_1C3E564(&StringLiteral_9656/*"OPTION_ADVANTAGE_CLASS_AUTO"*/);
    byte_4C51D62 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C51D64 & 1) == 0 )
  {
    sub_1C3E564(&Method_SetAdvantageClassAutoOptionControl_OnClickButton__);
    byte_4C51D64 = 1;
  }
  klass = this->klass;
  this->fields.flag ^= 1u;
  ...
  if ( (*((_BYTE *)Method_SetAdvantageClassAutoOptionControl_OnClickButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1C3E57C(Method_SetAdvantageClassAutoOptionControl_OnClickButton__);
