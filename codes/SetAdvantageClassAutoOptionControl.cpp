        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD7883 & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_9848/*"OPTION_ADVANTAGE_CLASS_AUTO_INFO"*/);
    sub_1C21E38(&StringLiteral_9847/*"OPTION_ADVANTAGE_CLASS_AUTO"*/);
    byte_4BD7883 = 1;
  }
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9847/*"OPTION_ADVANTAGE_CLASS_AUTO"*/, 0LL);
  if ( !titleLabel
    || (UILabel__set_text(titleLabel, v4, 0LL),
        infoLabel = this->fields.infoLabel,
        v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9848/*"OPTION_ADVANTAGE_CLASS_AUTO_INFO"*/, 0LL),
        !infoLabel) )
  {
    sub_1C22094(v4, v5);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD7885 & 1) == 0 )
  {
    sub_1C21E38(&Method_SetAdvantageClassAutoOptionControl_OnClickButton__);
    byte_4BD7885 = 1;
  }
  klass = this->klass;
  this->fields.flag ^= 1u;
  ...
  if ( (*((_BYTE *)Method_SetAdvantageClassAutoOptionControl_OnClickButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1C21E50(Method_SetAdvantageClassAutoOptionControl_OnClickButton__);
