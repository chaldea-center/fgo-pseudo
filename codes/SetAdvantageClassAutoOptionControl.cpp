        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_418B13D & 1) == 0 )
  {
    ...
    sub_B2C35C(&StringLiteral_9776/*"OPTION_ADVANTAGE_CLASS_AUTO_INFO"*/, v4);
    sub_B2C35C(&StringLiteral_9775/*"OPTION_ADVANTAGE_CLASS_AUTO"*/, v5);
    byte_418B13D = 1;
  }
  ...
  v7 = LocalizationManager__Get((System_String_o *)StringLiteral_9775/*"OPTION_ADVANTAGE_CLASS_AUTO"*/, 0LL);
  if ( !infoLabel
    || (UILabel__set_text(infoLabel, v7, 0LL),
        switchButton = (UILabel_o *)this->fields.switchButton,
        v7 = LocalizationManager__Get((System_String_o *)StringLiteral_9776/*"OPTION_ADVANTAGE_CLASS_AUTO_INFO"*/, 0LL),
        !switchButton) )
  {
    sub_B2C434(v7, v8);
  }
