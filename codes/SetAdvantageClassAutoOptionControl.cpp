        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B325C7 & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_9798/*"OPTION_ADVANTAGE_CLASS_AUTO_INFO"*/, v4);
    sub_1BD3458(&StringLiteral_9797/*"OPTION_ADVANTAGE_CLASS_AUTO"*/, v5);
    byte_4B325C7 = 1;
  }
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v7 = LocalizationManager__Get((System_String_o *)StringLiteral_9797/*"OPTION_ADVANTAGE_CLASS_AUTO"*/, 0LL);
  if ( !titleLabel
    || (UILabel__set_text(titleLabel, v7, 0LL),
        infoLabel = this->fields.infoLabel,
        v7 = LocalizationManager__Get((System_String_o *)StringLiteral_9798/*"OPTION_ADVANTAGE_CLASS_AUTO_INFO"*/, 0LL),
        !infoLabel) )
  {
    sub_1BD36B4(v7, v8);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B325C9 & 1) == 0 )
  {
    sub_1BD3458(&Method_SetAdvantageClassAutoOptionControl_OnClickButton__, method);
    byte_4B325C9 = 1;
  }
  klass = this->klass;
  this->fields.flag ^= 1u;
  ...
  if ( (*((_BYTE *)Method_SetAdvantageClassAutoOptionControl_OnClickButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1BD3470(Method_SetAdvantageClassAutoOptionControl_OnClickButton__);
