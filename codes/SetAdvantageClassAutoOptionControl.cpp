...
void SetAdvantageClassAutoOptionControl__Init(SetAdvantageClassAutoOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E7254B & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_9774/*"OPTION_ADVANTAGE_CLASS_AUTO_INFO"*/);
    sub_1D0F0B4(&StringLiteral_9773/*"OPTION_ADVANTAGE_CLASS_AUTO"*/);
    byte_4E7254B = 1;
  }
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9773/*"OPTION_ADVANTAGE_CLASS_AUTO"*/, 0);
  if ( !titleLabel
    || (UILabel__set_text(titleLabel, v4, 0),
        infoLabel = this->fields.infoLabel,
        v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9774/*"OPTION_ADVANTAGE_CLASS_AUTO_INFO"*/, 0),
        !infoLabel) )
  {
    sub_1D0F30C(v4, v5);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7254D & 1) == 0 )
  {
    sub_1D0F0B4(&Method_SetAdvantageClassAutoOptionControl_OnClickButton__);
    byte_4E7254D = 1;
  }
  klass = this->klass;
  this->fields.flag ^= 1u;
  ...
  if ( (*((_BYTE *)Method_SetAdvantageClassAutoOptionControl_OnClickButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1D0F0CC(Method_SetAdvantageClassAutoOptionControl_OnClickButton__);
