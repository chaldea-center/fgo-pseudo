void __fastcall FriendshipMaster___ctor(FriendshipMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A4E6D7 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataMasterBase_FriendshipMaster__FriendshipEntity__string___ctor__, method);
    byte_4A4E6D7 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    31,
    (const MethodInfo_3216A14 *)Method_DataMasterBase_FriendshipMaster__FriendshipEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4E6D5 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataMasterBase_FriendshipMaster__FriendshipEntity__string__GetEntity__, *(_QWORD *)&id);
    byte_4A4E6D5 = 1;
  }
  ...
  return (FriendshipEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                 (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                 PK,
                                 (const MethodInfo_3218D38 *)Method_DataMasterBase_FriendshipMaster__FriendshipEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  *late = 0;
  while ( 1 )
  {
    ...
    v20 = System_String__Concat_61683424(v18, (System_String_o *)StringLiteral_1468/*":"*/, v19, 0LL);
    EntityFromId = DataMasterBase_object__object__object___TryGetEntityFromId(
                     (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                     &result,
                     v20,
                     (const MethodInfo_32183E8 *)Method_DataMasterBase_FriendshipMaster__FriendshipEntity__string__TryGetEntityFromId__);
    if ( !EntityFromId )
      break;
    if ( v16 <= friendship )
    {
...
int32_t __fastcall FriendshipMaster__GetRankMax(FriendshipMaster_o *this, int32_t id, const MethodInfo *method)
{
  ...
  if ( (byte_4A4E6D9 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataMasterBase_FriendshipMaster__FriendshipEntity__string__get_lookup__, *(_QWORD *)&id);
    sub_1B863B8(&System_Collections_Generic_IReadOnlyDictionary_string__FriendshipEntity__TypeInfo, v4);
    sub_1B863B8(&StringLiteral_1468/*":"*/, v5);
    byte_4A4E6D9 = 1;
  }
  for ( i = 0; ; i = v18 + 1 )
  {
    ...
    v9 = System_String__Concat_61683424(v7, (System_String_o *)StringLiteral_1468/*":"*/, v8, 0LL);
    lookup = DataMasterBase_object__object__object___get_lookup(
               (DataMasterBase_TMaster__TEntity__PKType__o *)this,
               (const MethodInfo_3216B2C *)Method_DataMasterBase_FriendshipMaster__FriendshipEntity__string__get_lookup__);
    if ( !lookup )
      sub_1B86614(0LL, v11);
    klass = lookup->klass;
    v13 = lookup;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4E6D6 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataMasterBase_FriendshipMaster__FriendshipEntity__string__TryGetEntity__, entity);
    byte_4A4E6D6 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_3218D84 *)Method_DataMasterBase_FriendshipMaster__FriendshipEntity__string__TryGetEntity__);
}