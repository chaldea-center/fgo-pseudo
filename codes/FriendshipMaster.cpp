void __fastcall FriendshipMaster___ctor(FriendshipMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A08E95 & 1) == 0 )
  {
    sub_1B686D4(&Method_DataMasterBase_FriendshipMaster__FriendshipEntity__string___ctor__, method);
    byte_4A08E95 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    31,
    (const MethodInfo_30E47D8 *)Method_DataMasterBase_FriendshipMaster__FriendshipEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A08E93 & 1) == 0 )
  {
    sub_1B686D4(&Method_DataMasterBase_FriendshipMaster__FriendshipEntity__string__GetEntity__, *(_QWORD *)&id);
    byte_4A08E93 = 1;
  }
  ...
  return (FriendshipEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                 (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                 PK,
                                 (const MethodInfo_30E4818 *)Method_DataMasterBase_FriendshipMaster__FriendshipEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A08E96 & 1) == 0 )
  {
    sub_1B686D4(&Method_DataMasterBase_TryGetEntityFromId_FriendshipEntity___, *(_QWORD *)&friendshipId);
  ...
  *late = 0;
  while ( 1 )
  {
    ...
    v20 = System_String__Concat_61430728(v18, (System_String_o *)StringLiteral_1544/*":"*/, v19, 0LL);
    result = 0LL;
    EntityFromId_object = DataMasterBase__TryGetEntityFromId_object_(
                            (DataMasterBase_o *)this,
                            &result,
                            v20,
                            (const MethodInfo_2E4A1F0 *)Method_DataMasterBase_TryGetEntityFromId_FriendshipEntity___);
    ...
    if ( v16 <= friendship )
    {
      *rank = *max;
      ...
      if ( !result )
LABEL_23:
        sub_1B68930(EntityFromId_object, v22);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A08E94 & 1) == 0 )
  {
    sub_1B686D4(&Method_DataMasterBase_FriendshipMaster__FriendshipEntity__string__TryGetEntity__, entity);
    byte_4A08E94 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_30E4868 *)Method_DataMasterBase_FriendshipMaster__FriendshipEntity__string__TryGetEntity__);
}
...
int32_t __fastcall FriendshipMaster__getRankMax(FriendshipMaster_o *this, int32_t id, const MethodInfo *method)
{
  ...
  if ( (byte_4A08E97 & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_1544/*":"*/, v4);
    byte_4A08E97 = 1;
  }
  for ( i = 0; ; i = v17 + 1 )
  {
    ...
    v8 = System_String__Concat_61430728(v6, (System_String_o *)StringLiteral_1544/*":"*/, v7, 0LL);
