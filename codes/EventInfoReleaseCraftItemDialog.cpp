        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E79389 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_UnityEngine_GameObject_GetComponent_EventInfoCraftItemComponent___);
    ...
    if ( !v8 )
    {
      if ( v7 )
      {
        ...
        Component_object = UnityEngine_GameObject__GetComponent_object_(
                             ...
                             (const MethodInfo_32A8444 *)Method_UnityEngine_GameObject_GetComponent_EventInfoCraftItemComponent___);
        if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
...
void EventInfoReleaseCraftItemDialog__OnClose(EventInfoReleaseCraftItemDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E7938B & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_EventInfoReleaseCraftItemDialog_OnClose__);
    sub_1D0F0B4(&Method_EventInfoReleaseCraftItemDialog__OnClose_b__11_0__);
    sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    byte_4E7938B = 1;
  }
  if ( this->fields.canTap )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoReleaseCraftItemDialog_OnClose__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1D0F0CC(Method_EventInfoReleaseCraftItemDialog_OnClose__);
...
void EventInfoReleaseCraftItemDialog__OnToCraft(EventInfoReleaseCraftItemDialog_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1D0F0B4(&System_Action_TypeInfo);
    sub_1D0F0B4(&Method_EventInfoReleaseCraftItemDialog_OnToCraft__);
    sub_1D0F0B4(&Method_EventInfoReleaseCraftItemDialog__OnToCraft_b__10_0__);
    byte_4E7938A = 1;
  }
  if ( this->fields.canTap )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoReleaseCraftItemDialog_OnToCraft__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1D0F0CC(Method_EventInfoReleaseCraftItemDialog_OnToCraft__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E79388 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    sub_1D0F0B4(&StringLiteral_3957/*"CRAFT_RELEASE_DIALOG_RELEASE_STORE_DESCRIPTION"*/);
    byte_4E79388 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(storeLabel, 0, 0) )
  {
    ...
    v13 = LocalizationManager__Get((System_String_o *)StringLiteral_3957/*"CRAFT_RELEASE_DIALOG_RELEASE_STORE_DESCRIPTION"*/, 0);
    v17 = v12;
    ...
    Master_object = (EventTradeStoreMaster_o *)System_String__Format_65604080(v13, v14, v15, 0);
    if ( !v11 )
LABEL_15:
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1D0F0B4(&System_Action_TypeInfo);
    sub_1D0F0B4(&Method_EventInfoReleaseCraftItemDialog__Setup_b__7_0__);
    sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    byte_4E79387 = 1;
  }
  this->fields.canTap = 0;
  ...
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.onClosed, (int32_t)inOnClosed, v14, v15, v16, v17, v18, v19);
