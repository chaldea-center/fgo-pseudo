        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2883D & 1) == 0 )
  {
    sub_1C2D490(&Method_UnityEngine_GameObject_GetComponent_EventInfoCraftItemComponent___);
    ...
    if ( !v8 )
    {
      if ( v7 )
      {
        ...
        Component_object = UnityEngine_GameObject__GetComponent_object_(
                             ...
                             (const MethodInfo_3125ED0 *)Method_UnityEngine_GameObject_GetComponent_EventInfoCraftItemComponent___);
        if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
...
void EventInfoReleaseCraftItemDialog__OnClose(EventInfoReleaseCraftItemDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2883F & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_EventInfoReleaseCraftItemDialog_OnClose__);
    sub_1C2D490(&Method_EventInfoReleaseCraftItemDialog__OnClose_b__11_0__);
    sub_1C2D490(&UnityEngine_Object_TypeInfo);
    byte_4C2883F = 1;
  }
  if ( this->fields.canTap )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoReleaseCraftItemDialog_OnClose__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1C2D4A8(Method_EventInfoReleaseCraftItemDialog_OnClose__);
...
void EventInfoReleaseCraftItemDialog__OnToCraft(EventInfoReleaseCraftItemDialog_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C2D490(&System_Action_TypeInfo);
    sub_1C2D490(&Method_EventInfoReleaseCraftItemDialog_OnToCraft__);
    sub_1C2D490(&Method_EventInfoReleaseCraftItemDialog__OnToCraft_b__10_0__);
    byte_4C2883E = 1;
  }
  if ( this->fields.canTap )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoReleaseCraftItemDialog_OnToCraft__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2D4A8(Method_EventInfoReleaseCraftItemDialog_OnToCraft__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2883C & 1) == 0 )
  {
    ...
    sub_1C2D490(&UnityEngine_Object_TypeInfo);
    sub_1C2D490(&StringLiteral_3911/*"CRAFT_RELEASE_DIALOG_RELEASE_STORE_DESCRIPTION"*/);
    byte_4C2883C = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(storeLabel, 0, 0) )
  {
    ...
    v13 = LocalizationManager__Get((System_String_o *)StringLiteral_3911/*"CRAFT_RELEASE_DIALOG_RELEASE_STORE_DESCRIPTION"*/, 0);
    v23 = v12;
    ...
    Master_object = (EventTradeStoreMaster_o *)System_String__Format_63499156(v13, v17, v21, 0);
    if ( !v11 )
LABEL_15:
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C2D490(&System_Action_TypeInfo);
    sub_1C2D490(&Method_EventInfoReleaseCraftItemDialog__Setup_b__7_0__);
    sub_1C2D490(&UnityEngine_Object_TypeInfo);
    byte_4C2883B = 1;
  }
  this->fields.canTap = 0;
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.onClosed, (int32_t)inOnClosed, v14, v15);
  this->fields.onToCraft = inOnToCraft;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.onToCraft, (int32_t)inOnToCraft, v16, v17);
