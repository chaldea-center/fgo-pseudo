void BgmMaster___ctor(BgmMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4C3762D & 1) == 0 )
  {
    sub_1C32C20(&Method_DataMasterBase_BgmMaster__BgmEntity__int___ctor__);
    byte_4C3762D = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    85,
    (const MethodInfo_3394514 *)Method_DataMasterBase_BgmMaster__BgmEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C37630 & 1) == 0 )
  {
    sub_1C32C20(&Method_System_Linq_Enumerable_FirstOrDefault_BgmEntity___);
    sub_1C32C20(&Method_System_Linq_Enumerable_OfType_BgmEntity___);
    sub_1C32C20(&System_Func_BgmEntity__bool__TypeInfo);
    sub_1C32C20(&Method_BgmMaster___c__DisplayClass3_0__GetBgmIdFromFileName_b__0__);
    sub_1C32C20(&BgmMaster___c__DisplayClass3_0_TypeInfo);
    byte_4C37630 = 1;
  }
  v7 = sub_1C32E6C(BgmMaster___c__DisplayClass3_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v7, 0);
  if ( !v7 )
    sub_1C32E7C(v8);
  *(_QWORD *)(v7 + 16) = bgmName;
  sub_1C32BC4((CGThumbnailListItem_o *)(v7 + 16), (int32_t)bgmName, v9, v10);
  v11 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__OfType_object_(
                                                               (System_Collections_IEnumerable_o *)this->fields.list,
                                                               (const MethodInfo_310C5CC *)Method_System_Linq_Enumerable_OfType_BgmEntity___);
  v12 = (System_Func_object__bool__o *)sub_1C32E6C(System_Func_BgmEntity__bool__TypeInfo);
  ...
  v13 = System_Linq_Enumerable__FirstOrDefault_object__51408536(
          ...
          (const MethodInfo_3106E98 *)Method_System_Linq_Enumerable_FirstOrDefault_BgmEntity___);
  if ( v13 )
    return (int32_t)v13[1].klass;
  return defId;
}
        ...
        const MethodInfo *method)
{
  ...
  System_Collections_Generic_IReadOnlyDictionary_string__TEntity__o *v9; // x22
  ...
  if ( (byte_4C3762E & 1) == 0 )
  {
    sub_1C32C20(&Method_DataMasterBase_BgmMaster__BgmEntity__int__get_lookup__);
    sub_1C32C20(&System_Collections_Generic_IReadOnlyDictionary_string__BgmEntity__TypeInfo);
  ...
  if ( SLODWORD(ids->max_length) >= 1 )
  {
    ...
    while ( 1 )
    {
      lookup = DataMasterBase_object__object__int___get_lookup(
                 (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                 (const MethodInfo_339462C *)Method_DataMasterBase_BgmMaster__BgmEntity__int__get_lookup__);
      if ( v7 >= LODWORD(ids->max_length) )
        sub_1C32E84(lookup);
      v9 = lookup;
      v6 = System_Int32__ToString((int)ids + 4 * (int)v7 + 32, 0);
      if ( !v9 )
        break;
      klass = v9->klass;
      v11 = v6;
      ...
      if ( *(_WORD *)&v9->klass->_2.rank )
      {
        ...
        v14 = (__int64)&klass->vtable[*(_DWORD *)p_offset + 1];
      }
      else
      {
LABEL_13:
        v14 = sub_1C83438(v9, System_Collections_Generic_IReadOnlyDictionary_string__BgmEntity__TypeInfo, 1);
      }
      v6 = (System_String_o *)(*(__int64 (__fastcall **)(System_Collections_Generic_IReadOnlyDictionary_string__TEntity__o *, System_String_o *, __int64 *, _QWORD))v14)(
                                v9,
                                v11,
                                &v23,
                                *(_QWORD *)(v14 + 8));
        ...
        const MethodInfo *method)
{
  if ( !x || (this = (BgmMaster___c__DisplayClass3_0_o *)this->fields.bgmName) == 0 )
    sub_1C32E7C(this);
  return System_String__Equals_63553848((System_String_o *)this, x->fields.fileName, 0);
}