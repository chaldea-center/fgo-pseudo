void __fastcall BgmMaster___ctor(BgmMaster_o *this, const MethodInfo *method)
{
  if ( (byte_43512AC & 1) == 0 )
  {
    sub_B70694(&Method_DataMasterBase_BgmMaster__BgmEntity__int___ctor__);
    byte_43512AC = 1;
  }
  DataMasterBase_WarMaster__WarEntity__int____ctor(
    (DataMasterBase_WarMaster__WarEntity__int__o *)this,
    80,
    (const MethodInfo_21C03A4 *)Method_DataMasterBase_BgmMaster__BgmEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_43512AF & 1) == 0 )
  {
    sub_B70694(&Method_System_Linq_Enumerable_FirstOrDefault_BgmEntity___);
    sub_B70694(&Method_System_Linq_Enumerable_OfType_BgmEntity___);
    sub_B70694(&Method_System_Func_BgmEntity__bool___ctor__);
    sub_B70694(&System_Func_BgmEntity__bool__TypeInfo);
    sub_B70694(&Method_BgmMaster___c__DisplayClass3_0__GetBgmIdFromFileName_b__0__);
    sub_B70694(&BgmMaster___c__DisplayClass3_0_TypeInfo);
    byte_43512AF = 1;
  }
  v7 = sub_B70764(BgmMaster___c__DisplayClass3_0_TypeInfo);
  BgmMaster___c__DisplayClass3_0___ctor((BgmMaster___c__DisplayClass3_0_o *)v7, 0LL);
  if ( !v7 )
    sub_B7076C(v8, v9);
  *(_QWORD *)(v7 + 16) = bgmName;
  sub_B70630((BattleServantConfConponent_o *)(v7 + 16), (System_Int32_array **)bgmName, v10, v11, v12, v13, v14, v15);
  v16 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__OfType_BattleActionData_MasterBuffData_(
                                                               ...
                                                               (const MethodInfo_1CBF924 *)Method_System_Linq_Enumerable_OfType_BgmEntity___);
  v17 = (System_Func_WarBoardManager_WarBoardOnboardSkillTarget__bool__o *)sub_B70764(System_Func_BgmEntity__bool__TypeInfo);
  System_Func_WarBoardManager_WarBoardOnboardSkillTarget__bool____ctor(
    v17,
    (Il2CppObject *)v7,
    Method_BgmMaster___c__DisplayClass3_0__GetBgmIdFromFileName_b__0__,
    (const MethodInfo_29AC578 *)Method_System_Func_BgmEntity__bool___ctor__);
  v18 = System_Linq_Enumerable__FirstOrDefault_WarBoardData_SquareRangeSearch_(
          v16,
          (System_Func_TSource__bool__o *)v17,
          (const MethodInfo_1CBD194 *)Method_System_Linq_Enumerable_FirstOrDefault_BgmEntity___);
  if ( v18 )
        ...
        const MethodInfo *method)
{
  ...
  if ( (int)ids->max_length >= 1 )
  {
    for ( i = 0LL; (__int64)i < (int)ids->max_length; ++i )
    {
      ...
      {
LABEL_13:
        p_method = sub_B08590(v10, System_Collections_Generic_IReadOnlyDictionary_string__DataEntityBase__TypeInfo, 1LL);
      }
      ...
      if ( ((unsigned __int8)v6 & 1) != 0 )
      {
        ...
        {
          v19 = (BgmMaster_o *)sub_B70A60(v23);
        ...
        const MethodInfo *method)
{
  if ( !x || (this = (BgmMaster___c__DisplayClass3_0_o *)this->fields.bgmName) == 0LL )
    sub_B7076C(this, x);
  return System_String__Equals_44745508((System_String_o *)this, x->fields.fileName, 0LL);
}