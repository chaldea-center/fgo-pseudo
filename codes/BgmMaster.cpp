void __fastcall BgmMaster___ctor(BgmMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A6FB1B & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_BgmMaster__BgmEntity__int___ctor__, method);
    byte_4A6FB1B = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    81,
    (const MethodInfo_312C568 *)Method_DataMasterBase_BgmMaster__BgmEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FB1D & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_BgmMaster__BgmEntity__int__TryGetEntity__, *(_QWORD *)&id);
    byte_4A6FB1D = 1;
  }
  entity = 0LL;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FB1E & 1) == 0 )
  {
    sub_1B90010(&Method_System_Linq_Enumerable_FirstOrDefault_BgmEntity___, bgmName);
    sub_1B90010(&Method_System_Linq_Enumerable_OfType_BgmEntity___, v7);
    sub_1B90010(&System_Func_BgmEntity__bool__TypeInfo, v8);
    sub_1B90010(&Method_BgmMaster___c__DisplayClass3_0__GetBgmIdFromFileName_b__0__, v9);
    sub_1B90010(&BgmMaster___c__DisplayClass3_0_TypeInfo, v10);
    byte_4A6FB1E = 1;
  }
  v11 = sub_1B9025C(BgmMaster___c__DisplayClass3_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v11, 0LL);
  if ( !v11 )
    sub_1B9026C(v12, v13);
  *(_QWORD *)(v11 + 16) = bgmName;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v11 + 16), (int32_t)bgmName, v14, v15);
  v16 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__OfType_object_(
                                                               (System_Collections_IEnumerable_o *)this->fields.list,
                                                               (const MethodInfo_2EB82A0 *)Method_System_Linq_Enumerable_OfType_BgmEntity___);
  v17 = (System_Func_object__bool__o *)sub_1B9025C(System_Func_BgmEntity__bool__TypeInfo);
  ...
  v18 = System_Linq_Enumerable__FirstOrDefault_object__48967524(
          ...
          (const MethodInfo_2EB2F64 *)Method_System_Linq_Enumerable_FirstOrDefault_BgmEntity___);
  if ( v18 )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FB1C & 1) == 0 )
  {
    sub_1B90010(&BgmEntity_TypeInfo, ids);
...
LABEL_13:
      ...
      if ( ((unsigned __int8)v11 & 1) != 0 )
      {
        ...
        else
        {
          ...
          sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v28 + 4), (int32_t)v12, v22, v23);
        }
      }
    }
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FB20 & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_BgmMaster__BgmEntity__int__TryGetEntity__, *(_QWORD *)&bgmId);
    byte_4A6FB20 = 1;
  }
  entity = 0LL;
        ...
        const MethodInfo *method)
{
  if ( !x || (this = (BgmMaster___c__DisplayClass3_0_o *)this->fields.bgmName) == 0LL )
    sub_1B9026C(this, x);
  return System_String__Equals_61795408((System_String_o *)this, x->fields.fileName, 0LL);
}