        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F8977 & 1) == 0 )
  {
    sub_1B640C8(&StringLiteral_20077/*"icon_limit_on"*/, *(_QWORD *)&limitCount);
    this = (ServantStatusLimitCountGauge_o *)sub_1B640C8(&StringLiteral_20076/*"icon_limit_off"*/, v7);
    byte_49F8977 = 1;
  }
...
LABEL_16:
  ...
  while ( 1 )
  {
    ...
    if ( v9 >= (int)max_length )
      break;
    if ( v9 >= max_length )
      sub_1B6432C(this, *(_QWORD *)&limitCount);
    ...
    else
    {
      if ( !this )
        goto LABEL_16;
      if ( v9 >= limitCount )
        v11 = (System_String_o **)&StringLiteral_20076/*"icon_limit_off"*/;
      else
        v11 = (System_String_o **)&StringLiteral_20077/*"icon_limit_on"*/;
      v12 = *v11;
    }
