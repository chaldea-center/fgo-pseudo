        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2D1B0 & 1) == 0 )
  {
    ...
    this = (ServantStatusLimitCountGauge_o *)sub_1C93AD4(&StringLiteral_20432/*"icon_limit_off"*/);
    byte_4D2D1B0 = 1;
  }
  ...
  while ( 1 )
  {
    ...
    else
    {
      if ( !this )
        goto LABEL_16;
      if ( v8 >= limitCount )
        v10 = (System_String_o **)&StringLiteral_20432/*"icon_limit_off"*/;
      else
        v10 = (System_String_o **)&StringLiteral_20433/*"icon_limit_on"*/;
      v11 = *v10;
    }
