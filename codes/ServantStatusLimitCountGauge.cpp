        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFE801 & 1) == 0 )
  {
    ...
    this = (ServantStatusLimitCountGauge_o *)sub_1BC3008(&StringLiteral_20013/*"icon_limit_off"*/, v7);
    byte_4AFE801 = 1;
  }
...
LABEL_16:
  ...
  while ( 1 )
  {
    ...
    if ( v9 >= (int)max_length )
      break;
    if ( v9 >= max_length )
      sub_1BC326C(this, *(_QWORD *)&limitCount, *(_QWORD *)&limitMax);
    ...
    else
    {
      if ( !this )
        goto LABEL_16;
      if ( v9 >= limitCount )
        v11 = (System_String_o **)&StringLiteral_20013/*"icon_limit_off"*/;
      else
        v11 = (System_String_o **)&StringLiteral_20014/*"icon_limit_on"*/;
      v12 = *v11;
    }
