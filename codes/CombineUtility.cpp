        ...
        const MethodInfo *method)
{
  ...
  __int64 v20; // x8
  bool v21; // w10
  const MethodInfo_2F01AD0 **v22; // x25
  const MethodInfo_319D99C **v23; // x27
  unsigned __int64 v24; // x28
  int v25; // w29
  int32_t *v26; // x23
  int32_t v27; // w24
  UserServantEntity_o *v28; // x8
  const MethodInfo_319D99C **v29; // x22
  ...
  const MethodInfo_2F01AD0 **v36; // x20
  int64_t v37; // x0
  __int64 v38; // x25
  __int64 v39; // x26
  int64_t v40; // x24
  ...
  if ( (byte_49BE832 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_DataManager_GetMaster_UserSvtCoinMaster___, v12);
  ...
  v18 = (int64_t)DataManager__GetMaster_object_((const MethodInfo_2F01AD0 *)Method_DataManager_GetMaster_UserSvtCoinMaster___);
...
LABEL_38:
  ...
  if ( (int)v20 >= 1 )
  {
    v22 = (const MethodInfo_2F01AD0 **)&Method_DataManager_GetMaster_ItemMaster___;
    v23 = (const MethodInfo_319D99C **)&Method_DataMasterBase_ItemMaster__ItemEntity__int__GetEntity__;
    v24 = 0LL;
    v25 = needQp != 0 && v21;
...
LABEL_39:
      ...
      if ( v18 && *(_DWORD *)(v18 + 48) == 29 )
      {
        ...
        *(_OWORD *)&v52.fields.fakeValue = v34;
        ...
        v50 = v52;
        v37 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_47012096(&v50, 0LL);
        ...
        *(_QWORD *)&v55.fields.fakeValue = v38;
        v41 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47008572(v55, 0LL);
        v18 = (int64_t)v46;
        if ( !v46 )
          goto LABEL_38;
      ...
      else
      {
        ...
        *(_OWORD *)&v52.fields.fakeValue = v43;
        if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
        v51 = v52;
        v18 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_47012096(&v51, 0LL);
        if ( !Master_object )
          goto LABEL_38;
...
System_String_o *__fastcall CombineUtility__GetServantShortName(int32_t svtId, const MethodInfo *method)
{
  ...
  if ( (byte_49BE834 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_DataManager_GetMaster_ServantChangeMaster___, v3);
    ...
    sub_1B4CF90(&Method_DataMasterBase_ServantAddMaster__ServantAddEntity__int__TryGetEntity__, v10);
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  v15 = (ServantChangeMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2F01AD0 *)Method_DataManager_GetMaster_ServantChangeMaster___);
  if ( !v15 )
    goto LABEL_44;
  ...
  if ( System_String__IsNullOrEmpty(Empty, 0LL) )
  {
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    v15 = (ServantChangeMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2F01AD0 *)Method_DataManager_GetMaster_ServantLimitAddMaster___);
    if ( !v15 )
      goto LABEL_44;
  ...
  if ( System_String__IsNullOrEmpty(Empty, 0LL) )
  {
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    v15 = (ServantChangeMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2F01AD0 *)Method_DataManager_GetMaster_ServantAddMaster___);
    if ( !v15 )
      goto LABEL_44;
  ...
  if ( System_String__IsNullOrEmpty(Empty, 0LL) )
  {
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    v15 = (ServantChangeMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2F01AD0 *)Method_DataManager_GetMaster_ServantMaster___);
    if ( !v15 )
      goto LABEL_44;
    if ( DataMasterBase_object__object__int___TryGetEntity(
           (DataMasterBase_TMaster__TEntity__PKType__o *)v15,
           ...
           (const MethodInfo_319D9E8 *)Method_DataMasterBase_ServantMaster__ServantEntity__int__TryGetEntity__) )
    {
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      v15 = (ServantChangeMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2F01AD0 *)Method_DataManager_GetMaster_ServantLimitImageMaster___);
      if ( v15 )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BE833 & 1) == 0 )
  {
    sub_1B4CF90(&LocalizationManager_TypeInfo, nameLabel);
    sub_1B4CF90(&string_TypeInfo, v9);
    sub_1B4CF90(&StringLiteral_43/*"\n"*/, v10);
    sub_1B4CF90(&StringLiteral_9118/*"NOT_SELECT_EQUIPED"*/, v11);
    byte_49BE833 = 1;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v12 = LocalizationManager__Get((System_String_o *)StringLiteral_9118/*"NOT_SELECT_EQUIPED"*/, 0LL);
  if ( !equipLabel )
    goto LABEL_13;
  ...
  if ( !dispName )
    return;
  v15 = System_String__Concat_61093468(equipLabel->fields.mText, (System_String_o *)StringLiteral_43/*"\n"*/, 0LL);
  UILabel__set_text(equipLabel, v15, 0LL);
  ServantShortName = CombineUtility__GetServantShortName(attachSvtId, v16);
  v18 = System_String__Concat_61093468((System_String_o *)StringLiteral_43/*"\n"*/, ServantShortName, 0LL);
