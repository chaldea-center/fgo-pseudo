        ...
        const MethodInfo *method)
{
  ...
  bool v15; // w10
  const MethodInfo_31A49E8 **v16; // x25
  const MethodInfo_3463274 **v17; // x27
  unsigned __int64 v18; // x28
  int v19; // w29
  int32_t *m_Items; // x23
  int32_t v21; // w24
  UserServantEntity_o *v22; // x8
  const MethodInfo_3463274 **v23; // x22
  ...
  const MethodInfo_31A49E8 **v30; // x20
  int64_t v31; // x0
  __int64 v32; // x25
  __int64 v33; // x26
  int64_t v34; // x24
  ...
  v12 = (int64_t)DataManager__GetMaster_object_((const MethodInfo_31A49E8 *)Method_DataManager_GetMaster_UserSvtCoinMaster___);
...
LABEL_38:
  ...
  if ( (int)max_length >= 1 )
  {
    v16 = (const MethodInfo_31A49E8 **)&Method_DataManager_GetMaster_ItemMaster___;
    v17 = (const MethodInfo_3463274 **)&Method_DataMasterBase_ItemMaster__ItemEntity__int__GetEntity__;
    v18 = 0;
    v19 = needQp != 0 && v15;
...
LABEL_39:
      ...
      if ( v12 && *(_DWORD *)(v12 + 48) == 29 )
      {
        ...
        *(_OWORD *)&v46.fields.fakeValue = v28;
        ...
        v44 = v46;
        v31 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_49657552(&v44, 0);
      ...
      else
      {
        ...
        *(_OWORD *)&v46.fields.fakeValue = v37;
        if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
        v45 = v46;
        v12 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_49657552(&v45, 0);
        if ( !Master_object )
          goto LABEL_38;
...
System_String_o *CombineUtility__GetServantShortName(int32_t svtId, const MethodInfo *method)
{
  ...
  if ( (byte_4D34999 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_DataManager_GetMaster_ServantChangeMaster___);
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  v5 = (ServantChangeMaster_o *)DataManager__GetMaster_object_((const MethodInfo_31A49E8 *)Method_DataManager_GetMaster_ServantChangeMaster___);
  if ( !v5 )
    goto LABEL_44;
  ...
  if ( System_String__IsNullOrEmpty(Empty, 0) )
  {
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    v5 = (ServantChangeMaster_o *)DataManager__GetMaster_object_((const MethodInfo_31A49E8 *)Method_DataManager_GetMaster_ServantLimitAddMaster___);
    if ( !v5 )
      goto LABEL_44;
  ...
  if ( System_String__IsNullOrEmpty(Empty, 0) )
  {
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    v5 = (ServantChangeMaster_o *)DataManager__GetMaster_object_((const MethodInfo_31A49E8 *)Method_DataManager_GetMaster_ServantAddMaster___);
    if ( !v5 )
      goto LABEL_44;
  ...
  if ( System_String__IsNullOrEmpty(Empty, 0) )
  {
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    v5 = (ServantChangeMaster_o *)DataManager__GetMaster_object_((const MethodInfo_31A49E8 *)Method_DataManager_GetMaster_ServantMaster___);
    if ( !v5 )
      goto LABEL_44;
    if ( DataMasterBase_object__object__int___TryGetEntity(
           (DataMasterBase_TMaster__TEntity__PKType__o *)v5,
           ...
           (const MethodInfo_34632C0 *)Method_DataMasterBase_ServantMaster__ServantEntity__int__TryGetEntity__) )
    {
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      v5 = (ServantChangeMaster_o *)DataManager__GetMaster_object_((const MethodInfo_31A49E8 *)Method_DataManager_GetMaster_ServantLimitImageMaster___);
      if ( v5 )
        ...
        const MethodInfo *method)
{
  ...
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_9371/*"NOT_SELECT_EQUIPED"*/, 0);
  if ( !equipLabel )
    goto LABEL_13;
  ...
  if ( !dispName )
    return;
  v12 = System_String__Concat_64425724(equipLabel->fields.mText, (System_String_o *)StringLiteral_43/*"\n"*/, 0);
  UILabel__set_text(equipLabel, v12, 0);
  ServantShortName = CombineUtility__GetServantShortName(attachSvtId, v13);
  v15 = System_String__Concat_64425724((System_String_o *)StringLiteral_43/*"\n"*/, ServantShortName, 0);
