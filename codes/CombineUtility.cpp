        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48614 & 1) == 0 )
  {
    sub_1BDB878(&BalanceConfig_TypeInfo, *(_QWORD *)&atkMax);
    byte_4B48614 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48613 & 1) == 0 )
  {
    sub_1BDB878(&BalanceConfig_TypeInfo, *(_QWORD *)&hpMax);
    byte_4B48613 = 1;
  }
  v9 = BalanceConfig_TypeInfo;
  if ( !BalanceConfig_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo *method)
{
  ...
  __int64 v21; // x8
  bool v22; // w10
  const MethodInfo_3033908 **v23; // x25
  const MethodInfo_32E1E3C **v24; // x27
  unsigned __int64 v25; // x28
  int v26; // w29
  int32_t *v27; // x23
  int32_t v28; // w24
  UserServantEntity_o *v29; // x8
  const MethodInfo_32E1E3C **v30; // x22
  ...
  const MethodInfo_3033908 **v37; // x20
  int64_t v38; // x0
  __int64 v39; // x25
  __int64 v40; // x26
  int64_t v41; // x24
  ...
  if ( (byte_4B48610 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_DataManager_GetMaster_UserSvtCoinMaster___, v12);
  ...
  v18 = (int64_t)DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_UserSvtCoinMaster___);
...
LABEL_38:
  ...
  if ( (int)v21 >= 1 )
  {
    v23 = (const MethodInfo_3033908 **)&Method_DataManager_GetMaster_ItemMaster___;
    v24 = (const MethodInfo_32E1E3C **)&Method_DataMasterBase_ItemMaster__ItemEntity__int__GetEntity__;
    v25 = 0LL;
    v26 = needQp != 0 && v22;
...
LABEL_39:
      ...
      if ( v18 && *(_DWORD *)(v18 + 48) == 29 )
      {
        ...
        *(_OWORD *)&v53.fields.fakeValue = v35;
        ...
        v51 = v53;
        v38 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_48231240(&v51, 0LL);
      ...
      else
      {
        ...
        *(_OWORD *)&v53.fields.fakeValue = v44;
        if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
        v52 = v53;
        v18 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_48231240(&v52, 0LL);
        if ( !Master_object )
          goto LABEL_38;
...
System_String_o *__fastcall CombineUtility__GetServantShortName(int32_t svtId, const MethodInfo *method)
{
  ...
  if ( (byte_4B48612 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_DataManager_GetMaster_ServantChangeMaster___, v3);
    ...
    sub_1BDB878(&Method_DataMasterBase_ServantAddMaster__ServantAddEntity__int__TryGetEntity__, v10);
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  v15 = (ServantChangeMaster_o *)DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_ServantChangeMaster___);
  if ( !v15 )
    goto LABEL_44;
  ...
  if ( System_String__IsNullOrEmpty(Empty, 0LL) )
  {
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    v15 = (ServantChangeMaster_o *)DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_ServantLimitAddMaster___);
    if ( !v15 )
      goto LABEL_44;
  ...
  if ( System_String__IsNullOrEmpty(Empty, 0LL) )
  {
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    v15 = (ServantChangeMaster_o *)DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_ServantAddMaster___);
    if ( !v15 )
      goto LABEL_44;
  ...
  if ( System_String__IsNullOrEmpty(Empty, 0LL) )
  {
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    v15 = (ServantChangeMaster_o *)DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_ServantMaster___);
    if ( !v15 )
      goto LABEL_44;
    if ( DataMasterBase_object__object__int___TryGetEntity(
           (DataMasterBase_TMaster__TEntity__PKType__o *)v15,
           ...
           (const MethodInfo_32E1E88 *)Method_DataMasterBase_ServantMaster__ServantEntity__int__TryGetEntity__) )
    {
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      v15 = (ServantChangeMaster_o *)DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_ServantLimitImageMaster___);
      if ( v15 )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48611 & 1) == 0 )
  {
    sub_1BDB878(&LocalizationManager_TypeInfo, nameLabel);
    sub_1BDB878(&string_TypeInfo, v9);
    sub_1BDB878(&StringLiteral_43/*"\n"*/, v10);
    sub_1BDB878(&StringLiteral_9313/*"NOT_SELECT_EQUIPED"*/, v11);
    byte_4B48611 = 1;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v12 = LocalizationManager__Get((System_String_o *)StringLiteral_9313/*"NOT_SELECT_EQUIPED"*/, 0LL);
  if ( !equipLabel )
    goto LABEL_13;
  ...
  if ( !dispName )
    return;
  v15 = System_String__Concat_62572260(equipLabel->fields.mText, (System_String_o *)StringLiteral_43/*"\n"*/, 0LL);
  UILabel__set_text(equipLabel, v15, 0LL);
  ServantShortName = CombineUtility__GetServantShortName(attachSvtId, v16);
  v18 = System_String__Concat_62572260((System_String_o *)StringLiteral_43/*"\n"*/, ServantShortName, 0LL);
