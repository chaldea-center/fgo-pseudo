        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20E1F & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_GameObjectExtensions_HasComponent_FGO_param1anim___, v5);
    sub_1B715CC(&Method_GameObjectExtensions_HasComponent_FGO_param2anim___, v6);
    sub_1B715CC(&Method_GameObjectExtensions_HasComponent_FGO_param3anim___, v7);
    sub_1B715CC(&Method_GameObjectExtensions_HasComponent_Renderer___, v8);
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponent_CommonEffectComponent___, v9);
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponent_Renderer___, v10);
    sub_1B715CC(&Method_UnityEngine_Object_Instantiate_GameObject___, v11);
    sub_1B715CC(&UnityEngine_Object_TypeInfo, v12);
    sub_1B715CC(&StringLiteral_16534/*"_threeValue2"*/, v13);
    sub_1B715CC(&StringLiteral_16538/*"_twoValue0"*/, v14);
    sub_1B715CC(&StringLiteral_16539/*"_twoValue1"*/, v15);
    sub_1B715CC(&StringLiteral_16529/*"_threeValue0"*/, v16);
    sub_1B715CC(&StringLiteral_16530/*"_threeValue1"*/, v17);
    sub_1B715CC(&StringLiteral_16511/*"_oneValue"*/, v18);
    byte_4A20E1F = 1;
  }
  if ( this->fields.isEnable )
  {
    ...
    if ( v23 )
    {
      ...
      *(UnityEngine_Quaternion_o *)&v41 = CommonEffectManager__GetFlipQuaternion(flip, v34);
      ...
      if ( !Component_object )
        sub_1B71828(0LL, v60);
      CommonEffectComponent__Init_40428228(Component_object, data, this->fields.isSkip, this->fields.isPause, v61);
      ...
      for ( i = 0; ; ++i )
      {
        ...
        HasComponent_object = GameObjectExtensions__HasComponent_object_(
                                v73,
                                (const MethodInfo_2EAC2B8 *)Method_GameObjectExtensions_HasComponent_Renderer___);
        if ( HasComponent_object )
        {
          if ( !v73 )
            sub_1B71828(HasComponent_object, v75);
          ...
          v79 = GameObjectExtensions__HasComponent_object_(
                  v73,
                  (const MethodInfo_2EAC2B8 *)Method_GameObjectExtensions_HasComponent_FGO_param1anim___);
          if ( v79 )
          {
            if ( !material )
              sub_1B71828(v79, v80);
            UnityEngine_Material__EnableKeyword(material, (System_String_o *)StringLiteral_16511/*"_oneValue"*/, 0LL);
            UnityEngine_Material__SetFloat(material, (System_String_o *)StringLiteral_16511/*"_oneValue"*/, 0.0, 0LL);
          }
          v81 = GameObjectExtensions__HasComponent_object_(
                  v73,
                  (const MethodInfo_2EAC2B8 *)Method_GameObjectExtensions_HasComponent_FGO_param2anim___);
          if ( v81 )
          {
            if ( !material )
              sub_1B71828(v81, v82);
            UnityEngine_Material__EnableKeyword(material, (System_String_o *)StringLiteral_16538/*"_twoValue0"*/, 0LL);
            UnityEngine_Material__EnableKeyword(material, (System_String_o *)StringLiteral_16539/*"_twoValue1"*/, 0LL);
            UnityEngine_Material__SetFloat(material, (System_String_o *)StringLiteral_16538/*"_twoValue0"*/, 0.0, 0LL);
            UnityEngine_Material__SetFloat(material, (System_String_o *)StringLiteral_16539/*"_twoValue1"*/, 0.0, 0LL);
          }
          v83 = GameObjectExtensions__HasComponent_object_(
                  v73,
                  (const MethodInfo_2EAC2B8 *)Method_GameObjectExtensions_HasComponent_FGO_param3anim___);
          if ( v83 )
          {
            if ( !material )
              sub_1B71828(v83, v84);
            UnityEngine_Material__EnableKeyword(material, (System_String_o *)StringLiteral_16529/*"_threeValue0"*/, 0LL);
            UnityEngine_Material__EnableKeyword(material, (System_String_o *)StringLiteral_16530/*"_threeValue1"*/, 0LL);
            UnityEngine_Material__EnableKeyword(material, (System_String_o *)StringLiteral_16534/*"_threeValue2"*/, 0LL);
            UnityEngine_Material__SetFloat(material, (System_String_o *)StringLiteral_16529/*"_threeValue0"*/, 0.0, 0LL);
            UnityEngine_Material__SetFloat(material, (System_String_o *)StringLiteral_16530/*"_threeValue1"*/, 0.0, 0LL);
            UnityEngine_Material__SetFloat(material, (System_String_o *)StringLiteral_16534/*"_threeValue2"*/, 0.0, 0LL);
          }
        }
      }
    ...
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    UnityEngine_Object__Destroy_69257852(v86, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  CommonEffectLoadComponent__Init_40439052(this, filename, 0LL, callback, isSkip, isPause, flip, v7);
}


void __fastcall CommonEffectLoadComponent__Init_40439052(
        CommonEffectLoadComponent_o *this,
        System_String_o *filename,
        Il2CppObject *param,
        CommonEffectLoadComponent_LoadEndHandler_o *callback,
...
LABEL_12:
  ...
  CommonEffectLoadComponent__Init_40439256(this, filename, v15);
  if ( callback && !this->fields.isInit )
    goto LABEL_12;
}


void __fastcall CommonEffectLoadComponent__Init_40439256(
        CommonEffectLoadComponent_o *this,
        System_String_o *filename,
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20E1E & 1) == 0 )
  {
    sub_1B715CC(&AssetManager_TypeInfo, filename);
    sub_1B715CC(&Method_CommonEffectLoadComponent_EndLoad__, v6);
    sub_1B715CC(&AssetLoader_LoadEndDataHandler_TypeInfo, v7);
    sub_1B715CC(&UnityEngine_Object_TypeInfo, v8);
    sub_1B715CC(&StringLiteral_5855/*"EffectLoad("*/, v9);
    sub_1B715CC(&StringLiteral_814/*")"*/, v10);
    byte_4A20E1E = 1;
  }
  if ( !this->fields.isInit )
  {
    *(_WORD *)&this->fields.isInit = 257;
    ...
    sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.effectName, (int32_t)filename, (int32_t)method, v3);
    gameObject = (UnityEngine_Object_o *)UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
    v12 = System_String__Concat_61516764(
            (System_String_o *)StringLiteral_5855/*"EffectLoad("*/,
            filename,
...
void __fastcall CommonEffectLoadComponent__Start(CommonEffectLoadComponent_o *this, const MethodInfo *method)
{
  ...
  if ( !System_String__IsNullOrEmpty(this->fields.effectName, 0LL) )
    CommonEffectLoadComponent__Init_40439256(this, this->fields.effectName, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20E1C & 1) == 0 )
  {
    sub_1B715CC(&CommonEffectLoadComponent_LoadEndHandler_TypeInfo, value);
    byte_4A20E1C = 1;
  }
  loadCallback = this->fields.loadCallback;
  ...
  while ( 1 )
  {
    ...
    v9 = sub_1BACABC(p_loadCallback, v8, v6);
  ...
  else
  {
    if ( !v8 )
    {
      if ( LOBYTE(this[1].fields.method_ptr) )
      {
        ...
        {
          if ( (v12 & 1) != 0 )
            v9 = (Il2CppObject *)sub_19B9FF8;
          else
            v9 = (Il2CppObject *)sub_19B9FBC;
        }
        else if ( (v12 & 1) != 0 )
        {
          v9 = (Il2CppObject *)sub_19B9F38;
        }
        else
        {
          v9 = (Il2CppObject *)sub_19B9F0C;
        }
      }
      else
      {
        v9 = (Il2CppObject *)sub_19B9EDC;
      }
      goto LABEL_16;
    }
    if ( !object )
...
LABEL_17:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19B9E94;
}
