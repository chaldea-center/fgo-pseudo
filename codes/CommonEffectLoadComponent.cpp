        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1DB26 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_GameObjectExtensions_HasComponent_FGO_param1anim___, v5);
    sub_1BCAFF8(&Method_GameObjectExtensions_HasComponent_FGO_param2anim___, v6);
    sub_1BCAFF8(&Method_GameObjectExtensions_HasComponent_FGO_param3anim___, v7);
    sub_1BCAFF8(&Method_GameObjectExtensions_HasComponent_Renderer___, v8);
    sub_1BCAFF8(&Method_UnityEngine_GameObject_GetComponent_CommonEffectComponent___, v9);
    sub_1BCAFF8(&Method_UnityEngine_GameObject_GetComponent_Renderer___, v10);
    sub_1BCAFF8(&Method_UnityEngine_Object_Instantiate_GameObject___, v11);
    sub_1BCAFF8(&UnityEngine_Object_TypeInfo, v12);
    sub_1BCAFF8(&StringLiteral_16457/*"_threeValue2"*/, v13);
    sub_1BCAFF8(&StringLiteral_16461/*"_twoValue0"*/, v14);
    sub_1BCAFF8(&StringLiteral_16462/*"_twoValue1"*/, v15);
    sub_1BCAFF8(&StringLiteral_16452/*"_threeValue0"*/, v16);
    sub_1BCAFF8(&StringLiteral_16453/*"_threeValue1"*/, v17);
    sub_1BCAFF8(&StringLiteral_16433/*"_oneValue"*/, v18);
    byte_4B1DB26 = 1;
  }
  if ( this->fields.isEnable )
  {
    ...
    if ( v23 )
    {
      ...
      *(UnityEngine_Quaternion_o *)&v41 = CommonEffectManager__GetFlipQuaternion(flip, v34);
      ...
      if ( !Component_object )
        sub_1BCB254(0LL, v60);
      CommonEffectComponent__Init_42859760(Component_object, data, this->fields.isSkip, this->fields.isPause, v61);
      ...
      for ( i = 0; ; ++i )
      {
        ...
        HasComponent_object = GameObjectExtensions__HasComponent_object_(
                                v73,
                                (const MethodInfo_3070030 *)Method_GameObjectExtensions_HasComponent_Renderer___);
        if ( HasComponent_object )
        {
          if ( !v73 )
            sub_1BCB254(HasComponent_object, v75);
          ...
          v79 = GameObjectExtensions__HasComponent_object_(
                  v73,
                  (const MethodInfo_3070030 *)Method_GameObjectExtensions_HasComponent_FGO_param1anim___);
          if ( v79 )
          {
            if ( !material )
              sub_1BCB254(v79, v80);
            UnityEngine_Material__EnableKeyword(material, (System_String_o *)StringLiteral_16433/*"_oneValue"*/, 0LL);
            UnityEngine_Material__SetFloat(material, (System_String_o *)StringLiteral_16433/*"_oneValue"*/, 0.0, 0LL);
          }
          v81 = GameObjectExtensions__HasComponent_object_(
                  v73,
                  (const MethodInfo_3070030 *)Method_GameObjectExtensions_HasComponent_FGO_param2anim___);
          if ( v81 )
          {
            if ( !material )
              sub_1BCB254(v81, v82);
            UnityEngine_Material__EnableKeyword(material, (System_String_o *)StringLiteral_16461/*"_twoValue0"*/, 0LL);
            UnityEngine_Material__EnableKeyword(material, (System_String_o *)StringLiteral_16462/*"_twoValue1"*/, 0LL);
            UnityEngine_Material__SetFloat(material, (System_String_o *)StringLiteral_16461/*"_twoValue0"*/, 0.0, 0LL);
            UnityEngine_Material__SetFloat(material, (System_String_o *)StringLiteral_16462/*"_twoValue1"*/, 0.0, 0LL);
          }
          v83 = GameObjectExtensions__HasComponent_object_(
                  v73,
                  (const MethodInfo_3070030 *)Method_GameObjectExtensions_HasComponent_FGO_param3anim___);
          if ( v83 )
          {
            if ( !material )
              sub_1BCB254(v83, v84);
            UnityEngine_Material__EnableKeyword(material, (System_String_o *)StringLiteral_16452/*"_threeValue0"*/, 0LL);
            UnityEngine_Material__EnableKeyword(material, (System_String_o *)StringLiteral_16453/*"_threeValue1"*/, 0LL);
            UnityEngine_Material__EnableKeyword(material, (System_String_o *)StringLiteral_16457/*"_threeValue2"*/, 0LL);
            UnityEngine_Material__SetFloat(material, (System_String_o *)StringLiteral_16452/*"_threeValue0"*/, 0.0, 0LL);
            UnityEngine_Material__SetFloat(material, (System_String_o *)StringLiteral_16453/*"_threeValue1"*/, 0.0, 0LL);
            UnityEngine_Material__SetFloat(material, (System_String_o *)StringLiteral_16457/*"_threeValue2"*/, 0.0, 0LL);
          }
        }
      }
    ...
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    UnityEngine_Object__Destroy_70136076(v86, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  CommonEffectLoadComponent__Init_42871960(this, filename, 0LL, callback, isSkip, isPause, flip, v7);
}


void __fastcall CommonEffectLoadComponent__Init_42871960(
        CommonEffectLoadComponent_o *this,
        System_String_o *filename,
        Il2CppObject *param,
        CommonEffectLoadComponent_LoadEndHandler_o *callback,
...
LABEL_12:
  ...
  CommonEffectLoadComponent__Init_42872164(this, filename, v15);
  if ( callback && !this->fields.isInit )
    goto LABEL_12;
}


void __fastcall CommonEffectLoadComponent__Init_42872164(
        CommonEffectLoadComponent_o *this,
        System_String_o *filename,
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1DB25 & 1) == 0 )
  {
    sub_1BCAFF8(&AssetManager_TypeInfo, filename);
    sub_1BCAFF8(&Method_CommonEffectLoadComponent_EndLoad__, v6);
    sub_1BCAFF8(&AssetLoader_LoadEndDataHandler_TypeInfo, v7);
    sub_1BCAFF8(&UnityEngine_Object_TypeInfo, v8);
    sub_1BCAFF8(&StringLiteral_5869/*"EffectLoad("*/, v9);
    sub_1BCAFF8(&StringLiteral_754/*")"*/, v10);
    byte_4B1DB25 = 1;
  }
  if ( !this->fields.isInit )
  {
    *(_WORD *)&this->fields.isInit = 257;
    ...
    sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.effectName, (int32_t)filename, (int32_t)method, v3);
    gameObject = (UnityEngine_Object_o *)UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
    v12 = System_String__Concat_62488672(
            (System_String_o *)StringLiteral_5869/*"EffectLoad("*/,
            filename,
...
void __fastcall CommonEffectLoadComponent__Start(CommonEffectLoadComponent_o *this, const MethodInfo *method)
{
  ...
  if ( !System_String__IsNullOrEmpty(this->fields.effectName, 0LL) )
    CommonEffectLoadComponent__Init_42872164(this, this->fields.effectName, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1DB23 & 1) == 0 )
  {
    sub_1BCAFF8(&CommonEffectLoadComponent_LoadEndHandler_TypeInfo, value);
    byte_4B1DB23 = 1;
  }
  loadCallback = this->fields.loadCallback;
  ...
  while ( 1 )
  {
    ...
    v9 = sub_1C05088(p_loadCallback, v8, v6);
  ...
  else
  {
    if ( !v8 )
    {
      if ( LOBYTE(this[1].fields.method_ptr) )
      {
        ...
        {
          if ( (v12 & 1) != 0 )
            v9 = (Il2CppObject *)sub_1A16398;
          else
            v9 = (Il2CppObject *)sub_1A1635C;
        }
        else if ( (v12 & 1) != 0 )
        {
          v9 = (Il2CppObject *)sub_1A162D8;
        }
        else
        {
          v9 = (Il2CppObject *)sub_1A162AC;
        }
      }
      else
      {
        v9 = (Il2CppObject *)sub_1A1627C;
      }
      goto LABEL_16;
    }
    if ( !object )
...
LABEL_17:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A16234;
}
