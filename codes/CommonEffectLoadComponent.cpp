        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF839 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_GameObjectExtensions_HasComponent_FGO_param1anim___, v5);
    sub_1B64870(&Method_GameObjectExtensions_HasComponent_FGO_param2anim___, v6);
    sub_1B64870(&Method_GameObjectExtensions_HasComponent_FGO_param3anim___, v7);
    sub_1B64870(&Method_GameObjectExtensions_HasComponent_Renderer___, v8);
    sub_1B64870(&Method_UnityEngine_GameObject_GetComponent_CommonEffectComponent___, v9);
    sub_1B64870(&Method_UnityEngine_GameObject_GetComponent_Renderer___, v10);
    sub_1B64870(&Method_UnityEngine_Object_Instantiate_GameObject___, v11);
    sub_1B64870(&UnityEngine_Object_TypeInfo, v12);
    sub_1B64870(&StringLiteral_16517/*"_threeValue2"*/, v13);
    sub_1B64870(&StringLiteral_16521/*"_twoValue0"*/, v14);
    sub_1B64870(&StringLiteral_16522/*"_twoValue1"*/, v15);
    sub_1B64870(&StringLiteral_16512/*"_threeValue0"*/, v16);
    sub_1B64870(&StringLiteral_16513/*"_threeValue1"*/, v17);
    sub_1B64870(&StringLiteral_16494/*"_oneValue"*/, v18);
    byte_49FF839 = 1;
  }
  if ( this->fields.isEnable )
  {
    ...
    if ( v23 )
    {
      ...
      *(UnityEngine_Quaternion_o *)&v41 = CommonEffectManager__GetFlipQuaternion(flip, v34);
      ...
      if ( !Component_object )
        sub_1B64ACC(0LL, v60);
      CommonEffectComponent__Init_40310112(Component_object, data, this->fields.isSkip, this->fields.isPause, v61);
      ...
      for ( i = 0; ; ++i )
      {
        ...
        HasComponent_object = GameObjectExtensions__HasComponent_object_(
                                v73,
                                (const MethodInfo_2E8BAD4 *)Method_GameObjectExtensions_HasComponent_Renderer___);
        if ( HasComponent_object )
        {
          if ( !v73 )
            sub_1B64ACC(HasComponent_object, v75);
          ...
          v79 = GameObjectExtensions__HasComponent_object_(
                  v73,
                  (const MethodInfo_2E8BAD4 *)Method_GameObjectExtensions_HasComponent_FGO_param1anim___);
          if ( v79 )
          {
            if ( !material )
              sub_1B64ACC(v79, v80);
          ...
          v81 = GameObjectExtensions__HasComponent_object_(
                  v73,
                  (const MethodInfo_2E8BAD4 *)Method_GameObjectExtensions_HasComponent_FGO_param2anim___);
          if ( v81 )
          {
            if ( !material )
              sub_1B64ACC(v81, v82);
          ...
          v83 = GameObjectExtensions__HasComponent_object_(
                  v73,
                  (const MethodInfo_2E8BAD4 *)Method_GameObjectExtensions_HasComponent_FGO_param3anim___);
          if ( v83 )
          {
            if ( !material )
              sub_1B64ACC(v83, v84);
    ...
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    UnityEngine_Object__Destroy_69135916(v86, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  CommonEffectLoadComponent__Init_40320936(this, filename, 0LL, callback, isSkip, isPause, flip, v7);
}


void __fastcall CommonEffectLoadComponent__Init_40320936(
        CommonEffectLoadComponent_o *this,
        System_String_o *filename,
        Il2CppObject *param,
        CommonEffectLoadComponent_LoadEndHandler_o *callback,
...
LABEL_12:
  ...
  CommonEffectLoadComponent__Init_40321140(this, filename, v15);
  if ( callback && !this->fields.isInit )
    goto LABEL_12;
}


void __fastcall CommonEffectLoadComponent__Init_40321140(
        CommonEffectLoadComponent_o *this,
        System_String_o *filename,
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF838 & 1) == 0 )
  {
    sub_1B64870(&AssetManager_TypeInfo, filename);
    sub_1B64870(&Method_CommonEffectLoadComponent_EndLoad__, v6);
    sub_1B64870(&AssetLoader_LoadEndDataHandler_TypeInfo, v7);
    sub_1B64870(&UnityEngine_Object_TypeInfo, v8);
    sub_1B64870(&StringLiteral_5849/*"EffectLoad("*/, v9);
    sub_1B64870(&StringLiteral_815/*")"*/, v10);
    byte_49FF838 = 1;
  }
  if ( !this->fields.isInit )
  {
    *(_WORD *)&this->fields.isInit = 257;
    ...
    sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.effectName, (int32_t)filename, (int32_t)method, v3);
...
void __fastcall CommonEffectLoadComponent__Start(CommonEffectLoadComponent_o *this, const MethodInfo *method)
{
  ...
  if ( !System_String__IsNullOrEmpty(this->fields.effectName, 0LL) )
    CommonEffectLoadComponent__Init_40321140(this, this->fields.effectName, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF836 & 1) == 0 )
  {
    sub_1B64870(&CommonEffectLoadComponent_LoadEndHandler_TypeInfo, value);
    byte_49FF836 = 1;
  }
  loadCallback = this->fields.loadCallback;
  ...
  while ( 1 )
  {
    ...
    v9 = sub_1B9FD60(p_loadCallback, v8, v6);
  ...
  else
  {
    if ( !v8 )
    {
      if ( LOBYTE(this[1].fields.method_ptr) )
      {
        ...
        {
          if ( (v12 & 1) != 0 )
            v9 = (Il2CppObject *)sub_19AD650;
          else
            v9 = (Il2CppObject *)sub_19AD614;
        }
        else if ( (v12 & 1) != 0 )
        {
          v9 = (Il2CppObject *)sub_19AD590;
        }
        else
        {
          v9 = (Il2CppObject *)sub_19AD564;
        }
      }
      else
      {
        v9 = (Il2CppObject *)sub_19AD534;
      }
      goto LABEL_16;
    }
    if ( !object )
...
LABEL_17:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19AD4EC;
}
