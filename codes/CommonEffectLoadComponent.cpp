        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B38558 & 1) == 0 )
  {
    ...
    sub_1BD3458(&Method_GameObjectExtensions_HasComponent_FGO_param1anim___, v5);
    sub_1BD3458(&Method_GameObjectExtensions_HasComponent_FGO_param2anim___, v6);
    sub_1BD3458(&Method_GameObjectExtensions_HasComponent_FGO_param3anim___, v7);
    sub_1BD3458(&Method_GameObjectExtensions_HasComponent_Renderer___, v8);
    sub_1BD3458(&Method_UnityEngine_GameObject_GetComponent_CommonEffectComponent___, v9);
    sub_1BD3458(&Method_UnityEngine_GameObject_GetComponent_Renderer___, v10);
    sub_1BD3458(&Method_UnityEngine_Object_Instantiate_GameObject___, v11);
    sub_1BD3458(&UnityEngine_Object_TypeInfo, v12);
    sub_1BD3458(&StringLiteral_16773/*"_threeValue2"*/, v13);
    sub_1BD3458(&StringLiteral_16777/*"_twoValue0"*/, v14);
    sub_1BD3458(&StringLiteral_16778/*"_twoValue1"*/, v15);
    sub_1BD3458(&StringLiteral_16768/*"_threeValue0"*/, v16);
    sub_1BD3458(&StringLiteral_16769/*"_threeValue1"*/, v17);
    sub_1BD3458(&StringLiteral_16750/*"_oneValue"*/, v18);
    byte_4B38558 = 1;
  }
  if ( this->fields.isEnable )
  {
    ...
    if ( v23 )
    {
      ...
      *(UnityEngine_Quaternion_o *)&v41 = CommonEffectManager__GetFlipQuaternion(flip, v34);
      ...
      if ( !Component_object )
        sub_1BD36B4(0LL, v60);
      CommonEffectComponent__Init_41482436(Component_object, data, this->fields.isSkip, this->fields.isPause, v61);
      ...
      for ( i = 0; ; ++i )
      {
        ...
        HasComponent_object = GameObjectExtensions__HasComponent_object_(
                                v73,
                                (const MethodInfo_2F8339C *)Method_GameObjectExtensions_HasComponent_Renderer___);
        if ( HasComponent_object )
        {
          if ( !v73 )
            sub_1BD36B4(HasComponent_object, v75);
          ...
          v79 = GameObjectExtensions__HasComponent_object_(
                  v73,
                  (const MethodInfo_2F8339C *)Method_GameObjectExtensions_HasComponent_FGO_param1anim___);
          if ( v79 )
          {
            if ( !material )
              sub_1BD36B4(v79, v80);
            UnityEngine_Material__EnableKeyword(material, (System_String_o *)StringLiteral_16750/*"_oneValue"*/, 0LL);
            UnityEngine_Material__SetFloat(material, (System_String_o *)StringLiteral_16750/*"_oneValue"*/, 0.0, 0LL);
          }
          v81 = GameObjectExtensions__HasComponent_object_(
                  v73,
                  (const MethodInfo_2F8339C *)Method_GameObjectExtensions_HasComponent_FGO_param2anim___);
          if ( v81 )
          {
            if ( !material )
              sub_1BD36B4(v81, v82);
            UnityEngine_Material__EnableKeyword(material, (System_String_o *)StringLiteral_16777/*"_twoValue0"*/, 0LL);
            UnityEngine_Material__EnableKeyword(material, (System_String_o *)StringLiteral_16778/*"_twoValue1"*/, 0LL);
            UnityEngine_Material__SetFloat(material, (System_String_o *)StringLiteral_16777/*"_twoValue0"*/, 0.0, 0LL);
            UnityEngine_Material__SetFloat(material, (System_String_o *)StringLiteral_16778/*"_twoValue1"*/, 0.0, 0LL);
          }
          v83 = GameObjectExtensions__HasComponent_object_(
                  v73,
                  (const MethodInfo_2F8339C *)Method_GameObjectExtensions_HasComponent_FGO_param3anim___);
          if ( v83 )
          {
            if ( !material )
              sub_1BD36B4(v83, v84);
            UnityEngine_Material__EnableKeyword(material, (System_String_o *)StringLiteral_16768/*"_threeValue0"*/, 0LL);
            UnityEngine_Material__EnableKeyword(material, (System_String_o *)StringLiteral_16769/*"_threeValue1"*/, 0LL);
            UnityEngine_Material__EnableKeyword(material, (System_String_o *)StringLiteral_16773/*"_threeValue2"*/, 0LL);
            UnityEngine_Material__SetFloat(material, (System_String_o *)StringLiteral_16768/*"_threeValue0"*/, 0.0, 0LL);
            UnityEngine_Material__SetFloat(material, (System_String_o *)StringLiteral_16769/*"_threeValue1"*/, 0.0, 0LL);
            UnityEngine_Material__SetFloat(material, (System_String_o *)StringLiteral_16773/*"_threeValue2"*/, 0.0, 0LL);
          }
        }
      }
    ...
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    UnityEngine_Object__Destroy_70278272(v86, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  CommonEffectLoadComponent__Init_41493452(this, filename, 0LL, callback, isSkip, isPause, flip, v7);
}


// local variable allocation has failed, the output may be wrong!
void __fastcall CommonEffectLoadComponent__Init_41493452(
        CommonEffectLoadComponent_o *this,
        System_String_o *filename,
        Il2CppObject *param,
        CommonEffectLoadComponent_LoadEndHandler_o *callback,
...
LABEL_12:
  ...
  CommonEffectLoadComponent__Init_41493656(this, filename, v15);
  if ( callback && !this->fields.isInit )
    goto LABEL_12;
}


void __fastcall CommonEffectLoadComponent__Init_41493656(
        CommonEffectLoadComponent_o *this,
        System_String_o *filename,
        const MethodInfo *method)
{
  ...
  if ( (byte_4B38557 & 1) == 0 )
  {
    sub_1BD3458(&AssetManager_TypeInfo, filename);
    sub_1BD3458(&Method_CommonEffectLoadComponent_EndLoad__, v10);
    sub_1BD3458(&AssetLoader_LoadEndDataHandler_TypeInfo, v11);
    sub_1BD3458(&UnityEngine_Object_TypeInfo, v12);
    sub_1BD3458(&StringLiteral_5998/*"EffectLoad("*/, v13);
    sub_1BD3458(&StringLiteral_809/*")"*/, v14);
    byte_4B38557 = 1;
  }
  if ( !this->fields.isInit )
  {
    *(_WORD *)&this->fields.isInit = 257;
    ...
    v16 = System_String__Concat_62536508(
            (System_String_o *)StringLiteral_5998/*"EffectLoad("*/,
            filename,
...
void __fastcall CommonEffectLoadComponent__Start(CommonEffectLoadComponent_o *this, const MethodInfo *method)
{
  ...
  if ( !System_String__IsNullOrEmpty(this->fields.effectName, 0LL) )
    CommonEffectLoadComponent__Init_41493656(this, this->fields.effectName, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B38555 & 1) == 0 )
  {
    sub_1BD3458(&CommonEffectLoadComponent_LoadEndHandler_TypeInfo, value);
    byte_4B38555 = 1;
  }
  loadCallback = this->fields.loadCallback;
  ...
  while ( 1 )
  {
    ...
    v9 = sub_1C0E948(p_loadCallback, v8, v6);
  ...
  else
  {
    if ( !v12 )
    {
      if ( LOBYTE(this[1].fields.method_ptr) )
      {
        ...
        {
          if ( (v16 & 1) != 0 )
            v13 = (Il2CppObject *)sub_1A16534;
          else
            v13 = (Il2CppObject *)sub_1A164F8;
        }
        else if ( (v16 & 1) != 0 )
        {
          v13 = (Il2CppObject *)sub_1A16474;
        }
        else
        {
          v13 = (Il2CppObject *)sub_1A16448;
        }
      }
      else
      {
        v13 = (Il2CppObject *)sub_1A16418;
      }
      goto LABEL_16;
    }
    if ( !object )
...
LABEL_17:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A163D0;
}
