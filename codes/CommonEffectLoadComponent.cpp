...
void CommonEffectLoadComponent__EndLoad(CommonEffectLoadComponent_o *this, AssetData_o *data, const MethodInfo *method)
{
  ...
  if ( (byte_4C3903C & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_GameObjectExtensions_HasComponent_FGO_param1anim___);
    sub_1C32C20(&Method_GameObjectExtensions_HasComponent_FGO_param2anim___);
    sub_1C32C20(&Method_GameObjectExtensions_HasComponent_FGO_param3anim___);
    sub_1C32C20(&Method_GameObjectExtensions_HasComponent_Renderer___);
    ...
    sub_1C32C20(&StringLiteral_16592/*"_threeValue2"*/);
    sub_1C32C20(&StringLiteral_16596/*"_twoValue0"*/);
    sub_1C32C20(&StringLiteral_16597/*"_twoValue1"*/);
    sub_1C32C20(&StringLiteral_16587/*"_threeValue0"*/);
    sub_1C32C20(&StringLiteral_16588/*"_threeValue1"*/);
    sub_1C32C20(&StringLiteral_16568/*"_oneValue"*/);
    byte_4C3903C = 1;
  }
  if ( this->fields.isEnable )
  {
    ...
    if ( v7 )
    {
      ...
      if ( !Component_object )
        sub_1C32E7C(0);
      CommonEffectComponent__Init_43629008(Component_object, data, this->fields.isSkip, this->fields.isPause, 0);
      ...
      for ( i = 0; ; ++i )
      {
        ...
        HasComponent_object = GameObjectExtensions__HasComponent_object_(
                                v37,
                                (const MethodInfo_3136290 *)Method_GameObjectExtensions_HasComponent_Renderer___);
        if ( HasComponent_object )
        {
          ...
          v41 = GameObjectExtensions__HasComponent_object_(
                  v37,
                  (const MethodInfo_3136290 *)Method_GameObjectExtensions_HasComponent_FGO_param1anim___);
          if ( v41 )
          {
            if ( !material )
              sub_1C32E7C(v41);
            UnityEngine_Material__EnableKeyword(material, (System_String_o *)StringLiteral_16568/*"_oneValue"*/, 0);
            UnityEngine_Material__SetFloat(material, (System_String_o *)StringLiteral_16568/*"_oneValue"*/, 0.0, 0);
          }
          v42 = GameObjectExtensions__HasComponent_object_(
                  v37,
                  (const MethodInfo_3136290 *)Method_GameObjectExtensions_HasComponent_FGO_param2anim___);
          if ( v42 )
          {
            if ( !material )
              sub_1C32E7C(v42);
            UnityEngine_Material__EnableKeyword(material, (System_String_o *)StringLiteral_16596/*"_twoValue0"*/, 0);
            UnityEngine_Material__EnableKeyword(material, (System_String_o *)StringLiteral_16597/*"_twoValue1"*/, 0);
            UnityEngine_Material__SetFloat(material, (System_String_o *)StringLiteral_16596/*"_twoValue0"*/, 0.0, 0);
            UnityEngine_Material__SetFloat(material, (System_String_o *)StringLiteral_16597/*"_twoValue1"*/, 0.0, 0);
          }
          v43 = GameObjectExtensions__HasComponent_object_(
                  v37,
                  (const MethodInfo_3136290 *)Method_GameObjectExtensions_HasComponent_FGO_param3anim___);
          if ( v43 )
          {
            if ( !material )
              sub_1C32E7C(v43);
            UnityEngine_Material__EnableKeyword(material, (System_String_o *)StringLiteral_16587/*"_threeValue0"*/, 0);
            UnityEngine_Material__EnableKeyword(material, (System_String_o *)StringLiteral_16588/*"_threeValue1"*/, 0);
            UnityEngine_Material__EnableKeyword(material, (System_String_o *)StringLiteral_16592/*"_threeValue2"*/, 0);
            UnityEngine_Material__SetFloat(material, (System_String_o *)StringLiteral_16587/*"_threeValue0"*/, 0.0, 0);
            UnityEngine_Material__SetFloat(material, (System_String_o *)StringLiteral_16588/*"_threeValue1"*/, 0.0, 0);
            UnityEngine_Material__SetFloat(material, (System_String_o *)StringLiteral_16592/*"_threeValue2"*/, 0.0, 0);
          }
        }
      }
        ...
        const MethodInfo *method)
{
  ...
  CommonEffectLoadComponent__Init_43641460(this, filename, 0, callback, isSkip, isPause, flip, v7);
}


void CommonEffectLoadComponent__Init_43641460(
        CommonEffectLoadComponent_o *this,
        System_String_o *filename,
        Il2CppObject *param,
        CommonEffectLoadComponent_LoadEndHandler_o *callback,
...
LABEL_12:
  ...
  CommonEffectLoadComponent__Init_43641664(this, filename, v15);
  if ( callback && !this->fields.isInit )
    goto LABEL_12;
}


void CommonEffectLoadComponent__Init_43641664(
        CommonEffectLoadComponent_o *this,
        System_String_o *filename,
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3903B & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_CommonEffectLoadComponent_EndLoad__);
    sub_1C32C20(&AssetLoader_LoadEndDataHandler_TypeInfo);
    sub_1C32C20(&UnityEngine_Object_TypeInfo);
    sub_1C32C20(&StringLiteral_5919/*"EffectLoad("*/);
  ...
  if ( !this->fields.isInit )
  {
    *(_WORD *)&this->fields.isInit = 257;
    ...
    sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.effectName, (int32_t)filename, (int32_t)method, v3);
    gameObject = (UnityEngine_Object_o *)UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0);
    v7 = System_String__Concat_63556792(
           (System_String_o *)StringLiteral_5919/*"EffectLoad("*/,
           filename,
...
void CommonEffectLoadComponent__Start(CommonEffectLoadComponent_o *this, const MethodInfo *method)
{
  ...
  if ( !System_String__IsNullOrEmpty(this->fields.effectName, 0) )
    CommonEffectLoadComponent__Init_43641664(this, this->fields.effectName, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  while ( 1 )
  {
    ...
    v9 = sub_1C6CE78(p_loadCallback, v8, v6);
...
LABEL_17:
  this->fields.extra_arg = (intptr_t)sub_1A78290;
}
