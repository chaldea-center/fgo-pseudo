        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDDE4E & 1) == 0 )
  {
    sub_1C21E38(&StringLiteral_23068/*"purchaseToken"*/);
    byte_4BDDE4E = 1;
  }
  RequestBase__addField_42414744((RequestBase_o *)this, (System_String_o *)StringLiteral_23068/*"purchaseToken"*/, purchaseToken, v3);
...
System_String_o *__fastcall CommitPurchaseRequest__getURL(CommitPurchaseRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDDE4D & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_23687/*"shop/CommitPurchase"*/);
    byte_4BDDE4D = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63115476(BaseUrl, (System_String_o *)StringLiteral_23687/*"shop/CommitPurchase"*/, 0LL);
}
