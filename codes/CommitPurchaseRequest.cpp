        ...
        const MethodInfo *method)
{
  if ( (byte_4A0A3C8 & 1) == 0 )
  {
    sub_1B686D4(&StringLiteral_22580/*"purchaseToken"*/, purchaseToken);
    byte_4A0A3C8 = 1;
  }
  RequestBase__addField_40920848((RequestBase_o *)this, (System_String_o *)StringLiteral_22580/*"purchaseToken"*/, purchaseToken, 0LL);
...
System_String_o *__fastcall CommitPurchaseRequest__getURL(CommitPurchaseRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0A3C7 & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_23182/*"shop/CommitPurchase"*/, v2);
    byte_4A0A3C7 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61419468(BaseUrl, (System_String_o *)StringLiteral_23182/*"shop/CommitPurchase"*/, 0LL);
}
