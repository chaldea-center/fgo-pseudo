        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5C9AD & 1) == 0 )
  {
    sub_1B885B0(&StringLiteral_22657/*"purchaseToken"*/);
    byte_4A5C9AD = 1;
  }
  RequestBase__addField_41126952((RequestBase_o *)this, (System_String_o *)StringLiteral_22657/*"purchaseToken"*/, purchaseToken, v3);
...
System_String_o *__fastcall CommitPurchaseRequest__getURL(CommitPurchaseRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5C9AC & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_23262/*"shop/CommitPurchase"*/);
    byte_4A5C9AC = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61707032(BaseUrl, (System_String_o *)StringLiteral_23262/*"shop/CommitPurchase"*/, 0LL);
}
