        ...
        const MethodInfo *method)
{
  if ( (byte_4A4FE8A & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_22506/*"purchaseToken"*/, purchaseToken);
    byte_4A4FE8A = 1;
  }
  RequestBase__addField_42282000((RequestBase_o *)this, (System_String_o *)StringLiteral_22506/*"purchaseToken"*/, purchaseToken, 0LL);
...
System_String_o *__fastcall CommitPurchaseRequest__getURL(CommitPurchaseRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4FE89 & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_23112/*"shop/CommitPurchase"*/, v2);
    byte_4A4FE89 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61645176(BaseUrl, (System_String_o *)StringLiteral_23112/*"shop/CommitPurchase"*/, 0LL);
}
