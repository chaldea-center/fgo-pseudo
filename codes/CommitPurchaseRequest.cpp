        ...
        const MethodInfo *method)
{
  if ( (byte_49FDB5D & 1) == 0 )
  {
    sub_1B640C8(&StringLiteral_22565/*"purchaseToken"*/, purchaseToken);
    byte_49FDB5D = 1;
  }
  RequestBase__addField_40850936((RequestBase_o *)this, (System_String_o *)StringLiteral_22565/*"purchaseToken"*/, purchaseToken, 0LL);
...
System_String_o *__fastcall CommitPurchaseRequest__getURL(CommitPurchaseRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FDB5C & 1) == 0 )
  {
    ...
    sub_1B640C8(&StringLiteral_23166/*"shop/CommitPurchase"*/, v2);
    byte_49FDB5C = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61375396(BaseUrl, (System_String_o *)StringLiteral_23166/*"shop/CommitPurchase"*/, 0LL);
}
