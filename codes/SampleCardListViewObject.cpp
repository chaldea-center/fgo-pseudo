...
void SampleCardListViewObject__CardIntoMove2(SampleCardListViewObject_o *this, const MethodInfo *method)
{
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.dragObject, 0, v8, v9);
...
void SampleCardListViewObject__CardIntoStart(SampleCardListViewObject_o *this, float delay, const MethodInfo *method)
{
  ...
  if ( (byte_4C5450E & 1) == 0 )
  {
    ...
    sub_1C3E564(&SampleCardListViewItem_TypeInfo);
    this = (SampleCardListViewObject_o *)sub_1C3E564(&StringLiteral_4332/*"CardIntoMove"*/);
    byte_4C5450E = 1;
  }
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&v4->fields.dragObject, v9, v11, v12);
  ...
  SampleCardListViewObject__Init_37688184(this, v14, v13);
  this = *p_dragObject;
  if ( !*p_dragObject
    || (transform = UnityEngine_GameObject__get_transform((UnityEngine_GameObject_o *)this, 0),
        (this = (SampleCardListViewObject_o *)UnityEngine_Component__get_transform((UnityEngine_Component_o *)v4, 0)) == 0)
    || (v16 = UnityEngine_Transform__TransformPoint_71368164((UnityEngine_Transform_o *)this, 5000.0, 0.0, 0.0, 0),
        !transform) )
  {
LABEL_20:
...
void SampleCardListViewObject__CardTurnMove(SampleCardListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C54512 & 1) == 0 )
  {
    this = (SampleCardListViewObject_o *)sub_1C3E564(&StringLiteral_4341/*"CardTurnMove2"*/);
    byte_4C54512 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  SampleCardListViewObject__set_IsFront(
    ...
    v8);
  SampleCardListViewObject__Init_37688184((SampleCardListViewObject_o *)Component_object, 2, v9);
  return v5;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C5450C & 1) == 0 )
  {
    this = (SampleCardListViewObject_o *)sub_1C3E564(&SampleCardListViewItem_TypeInfo);
    byte_4C5450C = 1;
  }
...
LABEL_30:
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&v9->fields.callbackFunc, (int32_t)callbackFunc, v19, v20);
  v24 = 1;
  switch ( v8 )
  {
    case 0:
...
LABEL_20:
      ...
      {
        p_callbackFunc->klass = 0;
        sub_1C3E508(p_callbackFunc, 0, v22, v23);
...
// local variable allocation has failed, the output may be wrong!
void SampleCardListViewObject__Init_37688184(
        SampleCardListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void SampleCardListViewObject__Init_37689148(
        SampleCardListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void SampleCardListViewObject__Init_37690860(
        SampleCardListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void SampleCardListViewObject__Start(SampleCardListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    SampleCardListViewObject__Init_37688184(this, 2, v2);
}
