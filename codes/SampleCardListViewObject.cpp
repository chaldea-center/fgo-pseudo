...
void SampleCardListViewObject__CardIntoMove2(SampleCardListViewObject_o *this, const MethodInfo *method)
{
  ...
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.dragObject, 0, v8, v9, v10, v11, v12, v13);
...
void SampleCardListViewObject__CardIntoStart(SampleCardListViewObject_o *this, float delay, const MethodInfo *method)
{
  ...
  if ( (byte_4D29F26 & 1) == 0 )
  {
    ...
    sub_1C94098(&SampleCardListViewItem_TypeInfo);
    this = (SampleCardListViewObject_o *)sub_1C94098(&StringLiteral_4335/*"CardIntoMove"*/);
    byte_4D29F26 = 1;
  }
  ...
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&v4->fields.dragObject, v9, v11, v12, v13, v14, v15, v16);
  ...
  SampleCardListViewObject__Init_38294252(this, v18, v17);
  this = *p_dragObject;
  if ( !*p_dragObject
    || (transform = UnityEngine_GameObject__get_transform((UnityEngine_GameObject_o *)this, 0),
        (this = (SampleCardListViewObject_o *)UnityEngine_Component__get_transform((UnityEngine_Component_o *)v4, 0)) == 0)
    || (v20 = UnityEngine_Transform__TransformPoint_72137752((UnityEngine_Transform_o *)this, 5000.0, 0.0, 0.0, 0),
        !transform) )
  {
LABEL_20:
...
void SampleCardListViewObject__CardTurnMove(SampleCardListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D29F2A & 1) == 0 )
  {
    this = (SampleCardListViewObject_o *)sub_1C94098(&StringLiteral_4344/*"CardTurnMove2"*/);
    byte_4D29F2A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  SampleCardListViewObject__set_IsFront(
    ...
    v8);
  SampleCardListViewObject__Init_38294252((SampleCardListViewObject_o *)Component_object, 2, v9);
  return v5;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D29F24 & 1) == 0 )
  {
    this = (SampleCardListViewObject_o *)sub_1C94098(&SampleCardListViewItem_TypeInfo);
    byte_4D29F24 = 1;
  }
...
LABEL_20:
      ...
      {
        p_callbackFunc->klass = 0;
        sub_1C9403C(p_callbackFunc, 0, v26, v27, v28, v29, v30, v31);
...
// local variable allocation has failed, the output may be wrong!
void SampleCardListViewObject__Init_38294252(
        SampleCardListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void SampleCardListViewObject__Init_38295216(
        SampleCardListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void SampleCardListViewObject__Init_38296928(
        SampleCardListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void SampleCardListViewObject__Start(SampleCardListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    SampleCardListViewObject__Init_38294252(this, 2, v2);
}
