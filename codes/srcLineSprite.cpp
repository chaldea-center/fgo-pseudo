void __fastcall srcLineSprite___ctor(srcLineSprite_o *this, const MethodInfo *method)
{
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.msSpriteName, v5, v2, v3);
...
void __fastcall srcLineSprite__Awake(srcLineSprite_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6D3E7 & 1) == 0 )
  {
    sub_1B90010(&Method_CStateManager_srcLineSprite___ctor__, method);
    sub_1B90010(&Method_CStateManager_srcLineSprite__add__, v3);
    sub_1B90010(&CStateManager_srcLineSprite__TypeInfo, v4);
    sub_1B90010(&UnityEngine_Object_TypeInfo, v5);
    sub_1B90010(&srcLineSprite_StateMapMain_TypeInfo, v6);
    sub_1B90010(&srcLineSprite_StateNone_TypeInfo, v7);
    sub_1B90010(&srcLineSprite_StateQaaDisp_TypeInfo, v8);
    sub_1B90010(&srcLineSprite_StateQaaGray_TypeInfo, v9);
    sub_1B90010(&srcLineSprite_StateQaaHide_TypeInfo, v10);
    byte_4A6D3E7 = 1;
  }
  ...
  if ( !this->fields.mFSM )
  {
    v16 = (CStateManager_T__o *)sub_1B9025C(CStateManager_srcLineSprite__TypeInfo);
    CStateManager_object____ctor(
      v16,
      (Il2CppObject *)this,
      5,
      (const MethodInfo_30B99A8 *)Method_CStateManager_srcLineSprite___ctor__);
    this->fields.mFSM = (struct CStateManager_srcLineSprite__o *)v16;
    sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.mFSM, (int32_t)v16, v17, v18);
    mFSM = (CStateManager_T__o *)this->fields.mFSM;
    v20 = (srcLineSprite_StateNone_o *)sub_1B9025C(srcLineSprite_StateNone_TypeInfo);
    ...
    CStateManager_object___add(
      ...
      0,
      (IState_T__o *)v20,
      (const MethodInfo_30B9A50 *)Method_CStateManager_srcLineSprite__add__);
    v23 = (CStateManager_T__o *)*p_mFSM;
    v24 = (srcLineSprite_StateMapMain_o *)sub_1B9025C(srcLineSprite_StateMapMain_TypeInfo);
    ...
    v26 = (srcLineSprite_StateQaaHide_o *)sub_1B9025C(srcLineSprite_StateQaaHide_TypeInfo);
    ...
    v28 = (srcLineSprite_StateQaaGray_o *)sub_1B9025C(srcLineSprite_StateQaaGray_TypeInfo);
    ...
    if ( !v27
      || (CStateManager_object___add(
          ...
          v30 = (srcLineSprite_StateQaaDisp_o *)sub_1B9025C(srcLineSprite_StateQaaDisp_TypeInfo),
...
System_String_o *__fastcall srcLineSprite__GetGobjName(int32_t id, const MethodInfo *method)
{
  ...
  if ( (byte_4A6D3E6 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_12931/*"Spot_Line_"*/, method);
  ...
  return System_String__Concat_61787092((System_String_o *)StringLiteral_12931/*"Spot_Line_"*/, v3, 0LL);
}
...
int32_t __fastcall srcLineSprite__GetState(srcLineSprite_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6D3E9 & 1) == 0 )
  {
    this = (srcLineSprite_o *)sub_1B90010(&Method_CStateManager_srcLineSprite__getState__, method);
    byte_4A6D3E9 = 1;
  }
  mFSM = v2->fields.mFSM;
  if ( !mFSM )
...
{
  srcLineSprite__SetQaaColorAnim_34756692(this, isActive, 0.5, method);
}


void __fastcall srcLineSprite__SetQaaColorAnimQuick(srcLineSprite_o *this, bool isActive, const MethodInfo *method)
{
  srcLineSprite__SetQaaColorAnim_34756692(this, isActive, 0.0, method);
}


// local variable allocation has failed, the output may be wrong!
void __fastcall srcLineSprite__SetQaaColorAnim_34756692(
        srcLineSprite_o *this,
        bool is_disp,
        float time,
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6D3EC & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_srcLineSprite___c__DisplayClass39_0__SetQaaColorAnim_b__0__, v8);
    sub_1B90010(&Method_srcLineSprite___c__DisplayClass39_0__SetQaaColorAnim_b__1__, v9);
    sub_1B90010(&srcLineSprite___c__DisplayClass39_0_TypeInfo, v10);
    byte_4A6D3EC = 1;
  }
  v11 = sub_1B9025C(srcLineSprite___c__DisplayClass39_0_TypeInfo);
  ...
  *(_QWORD *)(v11 + 24) = Component_object;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v11 + 24), (int32_t)Component_object, v18, v19);
  v20 = is_disp ? 1.0 : 0.5;
  *(float *)(v11 + 32) = v20;
...
LABEL_12:
  ...
  if ( is_disp )
    ...
    v24 = 1.0;
  EasingObject__Play_46627140(v21, v24, v20, time, v22, v23, 0.0, 17, 0LL);
}


void __fastcall srcLineSprite__SetQaaScaleAnim(srcLineSprite_o *this, bool isDisp, const MethodInfo *method)
{
  srcLineSprite__SetQaaScaleAnim_34756000(this, isDisp, 0.5, method);
}


void __fastcall srcLineSprite__SetQaaScaleAnimQuick(srcLineSprite_o *this, bool isDisp, const MethodInfo *method)
{
  srcLineSprite__SetQaaScaleAnim_34756000(this, isDisp, 0.0, method);
}


// local variable allocation has failed, the output may be wrong!
void __fastcall srcLineSprite__SetQaaScaleAnim_34756000(
        srcLineSprite_o *this,
        bool is_disp,
        float time,
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6D3EB & 1) == 0 )
  {
    sub_1B90010(&Method_UITweener_Begin_TweenPosition___, is_disp);
    sub_1B90010(&Method_UITweener_Begin_TweenScale___, v7);
    sub_1B90010(&StringLiteral_13005/*"StateQaaEnd"*/, v8);
    byte_4A6D3EB = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  ...
  if ( is_disp )
  {
    if ( !byte_4A6A9C1 )
    {
      mcMyTrans = (UnityEngine_Transform_o *)sub_1B90010(&UnityEngine_Vector3_TypeInfo, v11);
      byte_4A6A9C1 = 1;
    }
  ...
  *((_DWORD *)&v12[5].fields + 1) = *p_x;
  ...
  v12[3].monitor = v26;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&v12[3].monitor, (int32_t)v26, v27, v28);
  v29 = StringLiteral_13005/*"StateQaaEnd"*/;
  *(_QWORD *)&v12[3].fields.m_CachedPtr = StringLiteral_13005/*"StateQaaEnd"*/;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&v12[3].fields, v29, v30, v31);
  if ( time != 0.0 || is_disp )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6D3EA & 1) == 0 )
  {
    sub_1B90010(&Method_CStateManager_srcLineSprite__setState__, *(_QWORD *)&state);
    byte_4A6D3EA = 1;
  }
  ...
  if ( !v9 )
    sub_1B9026C(0LL, v8);
  CStateManager_object___setState(v9, state, (const MethodInfo_30B9ADC *)Method_CStateManager_srcLineSprite__setState__);
}
...
void __fastcall srcLineSprite__Update(srcLineSprite_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6D3E8 & 1) == 0 )
  {
    sub_1B90010(&Method_CStateManager_srcLineSprite__update__, method);
    byte_4A6D3E8 = 1;
  }
  mFSM = (CStateManager_T__o *)this->fields.mFSM;
  if ( mFSM )
    CStateManager_object___update(mFSM, (const MethodInfo_30B9AB8 *)Method_CStateManager_srcLineSprite__update__);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)v4, (int32_t)sSpriteName, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6D3F6 & 1) == 0 )
  {
    this = (srcLineSprite_StateMapMain_o *)sub_1B90010(&UnityEngine_Object_TypeInfo, that);
    byte_4A6D3F6 = 1;
  }
  if ( !that )
    goto LABEL_18;
