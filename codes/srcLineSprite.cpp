void __fastcall srcLineSprite___ctor(srcLineSprite_o *this, const MethodInfo *method)
{
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.msSpriteName, (int64_t)v9, v2, v3, v4, v5, v6, v7);
...
void __fastcall srcLineSprite__Awake(srcLineSprite_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B63FCF & 1) == 0 )
  {
    sub_1BE4ACC(&Method_CStateManager_srcLineSprite___ctor__, method);
    sub_1BE4ACC(&Method_CStateManager_srcLineSprite__add__, v3);
    sub_1BE4ACC(&CStateManager_srcLineSprite__TypeInfo, v4);
    sub_1BE4ACC(&UnityEngine_Object_TypeInfo, v5);
    sub_1BE4ACC(&srcLineSprite_StateMapMain_TypeInfo, v6);
    sub_1BE4ACC(&srcLineSprite_StateNone_TypeInfo, v7);
    sub_1BE4ACC(&srcLineSprite_StateQaaDisp_TypeInfo, v8);
    sub_1BE4ACC(&srcLineSprite_StateQaaGray_TypeInfo, v9);
    sub_1BE4ACC(&srcLineSprite_StateQaaHide_TypeInfo, v10);
    byte_4B63FCF = 1;
  }
  ...
  if ( !this->fields.mFSM )
  {
    v16 = (CStateManager_T__o *)sub_1BE4D18(CStateManager_srcLineSprite__TypeInfo);
    CStateManager_object____ctor(
      v16,
      (Il2CppObject *)this,
      5,
      (const MethodInfo_318A548 *)Method_CStateManager_srcLineSprite___ctor__);
    this->fields.mFSM = (struct CStateManager_srcLineSprite__o *)v16;
    sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.mFSM, (int64_t)v16, v17, v18, v19, v20, v21, v22);
    mFSM = (CStateManager_T__o *)this->fields.mFSM;
    v24 = (Il2CppObject *)sub_1BE4D18(srcLineSprite_StateNone_TypeInfo);
    ...
    CStateManager_object___add(
      ...
      0,
      (IState_T__o *)v24,
      (const MethodInfo_318A5F0 *)Method_CStateManager_srcLineSprite__add__);
    v27 = (CStateManager_T__o *)*p_mFSM;
    v28 = (Il2CppObject *)sub_1BE4D18(srcLineSprite_StateMapMain_TypeInfo);
    ...
    v30 = (Il2CppObject *)sub_1BE4D18(srcLineSprite_StateQaaHide_TypeInfo);
    ...
    v32 = (Il2CppObject *)sub_1BE4D18(srcLineSprite_StateQaaGray_TypeInfo);
    ...
    if ( !v31
      || (CStateManager_object___add(
          ...
          v34 = (Il2CppObject *)sub_1BE4D18(srcLineSprite_StateQaaDisp_TypeInfo),
...
System_String_o *__fastcall srcLineSprite__GetGobjName(int32_t id, const MethodInfo *method)
{
  ...
  if ( (byte_4B63FCE & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_13103/*"Spot_Line_"*/, method);
  ...
  return System_String__Concat_62698808((System_String_o *)StringLiteral_13103/*"Spot_Line_"*/, v3, 0LL);
}
...
int32_t __fastcall srcLineSprite__GetState(srcLineSprite_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B63FD1 & 1) == 0 )
  {
    this = (srcLineSprite_o *)sub_1BE4ACC(&Method_CStateManager_srcLineSprite__getState__, method);
    byte_4B63FD1 = 1;
  }
  mFSM = v2->fields.mFSM;
  if ( !mFSM )
...
{
  srcLineSprite__SetQaaColorAnim_35487680(this, isActive, 0.5, method);
}


void __fastcall srcLineSprite__SetQaaColorAnimQuick(srcLineSprite_o *this, bool isActive, const MethodInfo *method)
{
  srcLineSprite__SetQaaColorAnim_35487680(this, isActive, 0.0, method);
}


// local variable allocation has failed, the output may be wrong!
void __fastcall srcLineSprite__SetQaaColorAnim_35487680(
        srcLineSprite_o *this,
        bool is_disp,
        float time,
        const MethodInfo *method)
{
  ...
  if ( (byte_4B63FD4 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_srcLineSprite___c__DisplayClass39_0__SetQaaColorAnim_b__0__, v8);
    sub_1BE4ACC(&Method_srcLineSprite___c__DisplayClass39_0__SetQaaColorAnim_b__1__, v9);
    sub_1BE4ACC(&srcLineSprite___c__DisplayClass39_0_TypeInfo, v10);
    byte_4B63FD4 = 1;
  }
  v11 = sub_1BE4D18(srcLineSprite___c__DisplayClass39_0_TypeInfo);
  ...
  *(_QWORD *)(v11 + 24) = Component_object;
  sub_1BE4A70((PartyOrganizationUtility_o *)(v11 + 24), (int64_t)Component_object, v22, v23, v24, v25, v26, v27);
  v28 = is_disp ? 1.0 : 0.5;
  *(float *)(v11 + 32) = v28;
...
LABEL_12:
  ...
  if ( is_disp )
    ...
    v32 = 1.0;
  EasingObject__Play_47420128(v29, v32, v28, time, v30, v31, 0.0, 17, 0LL);
}


void __fastcall srcLineSprite__SetQaaScaleAnim(srcLineSprite_o *this, bool isDisp, const MethodInfo *method)
{
  srcLineSprite__SetQaaScaleAnim_35486988(this, isDisp, 0.5, method);
}


void __fastcall srcLineSprite__SetQaaScaleAnimQuick(srcLineSprite_o *this, bool isDisp, const MethodInfo *method)
{
  srcLineSprite__SetQaaScaleAnim_35486988(this, isDisp, 0.0, method);
}


// local variable allocation has failed, the output may be wrong!
void __fastcall srcLineSprite__SetQaaScaleAnim_35486988(
        srcLineSprite_o *this,
        bool is_disp,
        float time,
        const MethodInfo *method)
{
  ...
  if ( (byte_4B63FD3 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_UITweener_Begin_TweenPosition___, is_disp);
    sub_1BE4ACC(&Method_UITweener_Begin_TweenScale___, v7);
    sub_1BE4ACC(&StringLiteral_13177/*"StateQaaEnd"*/, v8);
    byte_4B63FD3 = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  ...
  if ( is_disp )
  {
    if ( !byte_4B612E1 )
    {
      mcMyTrans = (UnityEngine_Transform_o *)sub_1BE4ACC(&UnityEngine_Vector3_TypeInfo, v11);
      byte_4B612E1 = 1;
    }
  ...
  *((_DWORD *)&v12[5].fields + 1) = *p_x;
  ...
  v12[3].monitor = v26;
  sub_1BE4A70((PartyOrganizationUtility_o *)&v12[3].monitor, (int64_t)v26, v27, v28, v29, v30, v31, v32);
  v33 = StringLiteral_13177/*"StateQaaEnd"*/;
  *(_QWORD *)&v12[3].fields.m_CachedPtr = StringLiteral_13177/*"StateQaaEnd"*/;
  sub_1BE4A70((PartyOrganizationUtility_o *)&v12[3].fields, v33, v34, v35, v36, v37, v38, v39);
  if ( time != 0.0 || is_disp )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B63FD2 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_CStateManager_srcLineSprite__setState__, *(_QWORD *)&state);
    byte_4B63FD2 = 1;
  }
  ...
  CStateManager_object___setState(
    v13,
    state,
    (const MethodInfo_318A67C *)Method_CStateManager_srcLineSprite__setState__);
}
...
void __fastcall srcLineSprite__Update(srcLineSprite_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B63FD0 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_CStateManager_srcLineSprite__update__, method);
    byte_4B63FD0 = 1;
  }
  mFSM = (CStateManager_T__o *)this->fields.mFSM;
  if ( mFSM )
    CStateManager_object___update(mFSM, (const MethodInfo_318A658 *)Method_CStateManager_srcLineSprite__update__);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)v8, (int64_t)sSpriteName, v10, v11, v12, v13, v14, v15);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B63FD6 & 1) == 0 )
  {
    this = (srcLineSprite_StateMapMain_o *)sub_1BE4ACC(&UnityEngine_Object_TypeInfo, that);
    byte_4B63FD6 = 1;
  }
  if ( !that )
    goto LABEL_18;
        ...
        const MethodInfo *method)
{
  ...
  {
    case 2:
      srcLineSprite__SetQaaColorAnim_35487680(that, 1, 0.5, method);
      break;
    case 1:
    ...
    case 0:
      ...
      if ( this )
      {
        ...
        srcLineSprite__SetQaaScaleAnim_35486988(that, 1, 0.5, v6);
        return;
      }
LABEL_11:
      sub_1BE4D28(this, that);
        ...
        const MethodInfo *method)
{
  ...
  switch ( dispType )
  {
    case 2:
      ...
      break;
    case 1:
      srcLineSprite__SetQaaColorAnim_35487680(that, 0, 0.5, method);
      break;
    case 0:
        ...
        const MethodInfo *method)
{
  ...
  if ( dispType )
  {
    if ( (unsigned int)(dispType - 1) < 2 )
      srcLineSprite__SetQaaScaleAnim_35486988(that, 0, 0.5, method);
  }
  else
  {
    ActionExtensions__Call(that->fields.mStateEndAct, 0LL);
