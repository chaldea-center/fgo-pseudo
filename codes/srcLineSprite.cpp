void __fastcall srcLineSprite___ctor(srcLineSprite_o *this, const MethodInfo *method)
{
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.msSpriteName, v5, v2, v3);
...
void __fastcall srcLineSprite__Awake(srcLineSprite_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49B822E & 1) == 0 )
  {
    sub_1B4CF90(&Method_CStateManager_srcLineSprite___ctor__, method);
    sub_1B4CF90(&Method_CStateManager_srcLineSprite__add__, v3);
    sub_1B4CF90(&CStateManager_srcLineSprite__TypeInfo, v4);
    sub_1B4CF90(&UnityEngine_Object_TypeInfo, v5);
    sub_1B4CF90(&srcLineSprite_StateMapMain_TypeInfo, v6);
    sub_1B4CF90(&srcLineSprite_StateNone_TypeInfo, v7);
    sub_1B4CF90(&srcLineSprite_StateQaaDisp_TypeInfo, v8);
    sub_1B4CF90(&srcLineSprite_StateQaaGray_TypeInfo, v9);
    sub_1B4CF90(&srcLineSprite_StateQaaHide_TypeInfo, v10);
    byte_49B822E = 1;
  }
  ...
  if ( !this->fields.mFSM )
  {
    v16 = (CStateManager_T__o *)sub_1B4D1DC(CStateManager_srcLineSprite__TypeInfo);
    CStateManager_object____ctor(
      v16,
      (Il2CppObject *)this,
      5,
      (const MethodInfo_312D7A4 *)Method_CStateManager_srcLineSprite___ctor__);
    this->fields.mFSM = (struct CStateManager_srcLineSprite__o *)v16;
    sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.mFSM, (int32_t)v16, v17, v18);
    mFSM = (CStateManager_T__o *)this->fields.mFSM;
    v20 = (Il2CppObject *)sub_1B4D1DC(srcLineSprite_StateNone_TypeInfo);
    ...
    CStateManager_object___add(
      ...
      0,
      (IState_T__o *)v20,
      (const MethodInfo_312D84C *)Method_CStateManager_srcLineSprite__add__);
    v23 = (CStateManager_T__o *)*p_mFSM;
    v24 = (Il2CppObject *)sub_1B4D1DC(srcLineSprite_StateMapMain_TypeInfo);
    ...
    v26 = (Il2CppObject *)sub_1B4D1DC(srcLineSprite_StateQaaHide_TypeInfo);
    ...
    v28 = (Il2CppObject *)sub_1B4D1DC(srcLineSprite_StateQaaGray_TypeInfo);
    ...
    if ( !v27
      || (CStateManager_object___add(
          ...
          v30 = (Il2CppObject *)sub_1B4D1DC(srcLineSprite_StateQaaDisp_TypeInfo),
...
System_String_o *__fastcall srcLineSprite__GetGobjName(int32_t id, const MethodInfo *method)
{
  ...
  if ( (byte_49B822D & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_12712/*"Spot_Line_"*/, method);
  ...
  return System_String__Concat_61093468((System_String_o *)StringLiteral_12712/*"Spot_Line_"*/, v3, 0LL);
}
...
int32_t __fastcall srcLineSprite__GetState(srcLineSprite_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49B8230 & 1) == 0 )
  {
    this = (srcLineSprite_o *)sub_1B4CF90(&Method_CStateManager_srcLineSprite__getState__, method);
    byte_49B8230 = 1;
  }
  mFSM = v2->fields.mFSM;
  if ( !mFSM )
...
{
  srcLineSprite__SetQaaColorAnim_35083208(this, isActive, 0.5, method);
}


void __fastcall srcLineSprite__SetQaaColorAnimQuick(srcLineSprite_o *this, bool isActive, const MethodInfo *method)
{
  srcLineSprite__SetQaaColorAnim_35083208(this, isActive, 0.0, method);
}


// local variable allocation has failed, the output may be wrong!
void __fastcall srcLineSprite__SetQaaColorAnim_35083208(
        srcLineSprite_o *this,
        bool is_disp,
        float time,
        const MethodInfo *method)
{
  ...
  if ( (byte_49B8233 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_srcLineSprite___c__DisplayClass39_0__SetQaaColorAnim_b__0__, v8);
    sub_1B4CF90(&Method_srcLineSprite___c__DisplayClass39_0__SetQaaColorAnim_b__1__, v9);
    sub_1B4CF90(&srcLineSprite___c__DisplayClass39_0_TypeInfo, v10);
    byte_49B8233 = 1;
  }
  v11 = sub_1B4D1DC(srcLineSprite___c__DisplayClass39_0_TypeInfo);
  ...
  *(_QWORD *)(v11 + 24) = Component_object;
  sub_1B4CF34((CGThumbnailListItem_o *)(v11 + 24), (int32_t)Component_object, v18, v19);
  v20 = is_disp ? 1.0 : 0.5;
  *(float *)(v11 + 32) = v20;
...
LABEL_12:
  ...
  if ( is_disp )
    ...
    v24 = 1.0;
  EasingObject__Play_47132360(v21, v24, v20, time, v22, v23, 0.0, 17, 0LL);
}


void __fastcall srcLineSprite__SetQaaScaleAnim(srcLineSprite_o *this, bool isDisp, const MethodInfo *method)
{
  srcLineSprite__SetQaaScaleAnim_35082516(this, isDisp, 0.5, method);
}


void __fastcall srcLineSprite__SetQaaScaleAnimQuick(srcLineSprite_o *this, bool isDisp, const MethodInfo *method)
{
  srcLineSprite__SetQaaScaleAnim_35082516(this, isDisp, 0.0, method);
}


// local variable allocation has failed, the output may be wrong!
void __fastcall srcLineSprite__SetQaaScaleAnim_35082516(
        srcLineSprite_o *this,
        bool is_disp,
        float time,
        const MethodInfo *method)
{
  ...
  if ( (byte_49B8232 & 1) == 0 )
  {
    sub_1B4CF90(&Method_UITweener_Begin_TweenPosition___, is_disp);
    sub_1B4CF90(&Method_UITweener_Begin_TweenScale___, v7);
    sub_1B4CF90(&StringLiteral_12781/*"StateQaaEnd"*/, v8);
    byte_49B8232 = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  ...
  if ( is_disp )
  {
    if ( !byte_49B5361 )
    {
      mcMyTrans = (UnityEngine_Transform_o *)sub_1B4CF90(&UnityEngine_Vector3_TypeInfo, v11);
      byte_49B5361 = 1;
    }
  ...
  *((_DWORD *)&v12[5].fields + 1) = *p_x;
  ...
  v12[3].monitor = v26;
  sub_1B4CF34((CGThumbnailListItem_o *)&v12[3].monitor, (int32_t)v26, v27, v28);
  v29 = StringLiteral_12781/*"StateQaaEnd"*/;
  *(_QWORD *)&v12[3].fields.m_CachedPtr = StringLiteral_12781/*"StateQaaEnd"*/;
  sub_1B4CF34((CGThumbnailListItem_o *)&v12[3].fields, v29, v30, v31);
  if ( time != 0.0 || is_disp )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B8231 & 1) == 0 )
  {
    sub_1B4CF90(&Method_CStateManager_srcLineSprite__setState__, *(_QWORD *)&state);
    byte_49B8231 = 1;
  }
  ...
  if ( !v9 )
    sub_1B4D1EC(0LL, v8);
  CStateManager_object___setState(v9, state, (const MethodInfo_312D8D8 *)Method_CStateManager_srcLineSprite__setState__);
}
...
void __fastcall srcLineSprite__Update(srcLineSprite_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49B822F & 1) == 0 )
  {
    sub_1B4CF90(&Method_CStateManager_srcLineSprite__update__, method);
    byte_49B822F = 1;
  }
  mFSM = (CStateManager_T__o *)this->fields.mFSM;
  if ( mFSM )
    CStateManager_object___update(mFSM, (const MethodInfo_312D8B4 *)Method_CStateManager_srcLineSprite__update__);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.mcAtlasP, (int32_t)cAtlasP, (int32_t)sSpriteName, method);
  v4->fields.msSpriteName = sSpriteName;
  v4 = (srcLineSprite_o *)((char *)v4 + 120);
  sub_1B4CF34((CGThumbnailListItem_o *)v4, (int32_t)sSpriteName, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B8235 & 1) == 0 )
  {
    this = (srcLineSprite_StateMapMain_o *)sub_1B4CF90(&UnityEngine_Object_TypeInfo, that);
    byte_49B8235 = 1;
  }
  if ( !that )
    goto LABEL_18;
        ...
        const MethodInfo *method)
{
  ...
  {
    case 2:
      srcLineSprite__SetQaaColorAnim_35083208(that, 1, 0.5, method);
      break;
    case 1:
    ...
    case 0:
      ...
      if ( this )
      {
        ...
        srcLineSprite__SetQaaScaleAnim_35082516(that, 1, 0.5, v6);
        return;
      }
LABEL_11:
      sub_1B4D1EC(this, that);
        ...
        const MethodInfo *method)
{
  ...
  switch ( dispType )
  {
    case 2:
      ...
      break;
    case 1:
      srcLineSprite__SetQaaColorAnim_35083208(that, 0, 0.5, method);
      break;
    case 0:
        ...
        const MethodInfo *method)
{
  ...
  if ( dispType )
  {
    if ( (unsigned int)(dispType - 1) < 2 )
      srcLineSprite__SetQaaScaleAnim_35082516(that, 0, 0.5, method);
  }
  else
  {
    ActionExtensions__Call(that->fields.mStateEndAct, 0LL);
