void __fastcall WeightRate_object____ctor(WeightRate_T__o *this, const MethodInfo_2C1D3AC *method)
{
  if ( !this )
...
void __fastcall WeightRate_object___ReverseWeight(WeightRate_T__o *this, const MethodInfo_2C1D040 *method)
{
  ...
  if ( (BYTE2(_0_System_Collections_Generic_List_WeightRate_WeightSeed_T->vtable[0].methodPtr) & 1) == 0 )
    sub_AEB684(method->klass->rgctx_data->_0_System_Collections_Generic_List_WeightRate_WeightSeed_T__);
  v5 = sub_B52A54(_0_System_Collections_Generic_List_WeightRate_WeightSeed_T);
...
LABEL_42:
  ...
  if ( (v10 & 1) == 0 )
  {
    sub_AEB684((*p_klass)->rgctx_data->_23_WeightRate___c_T_);
    v10 = WORD1(_23_WeightRate___c_T->vtable[0].methodPtr);
  }
  if ( (v10 & 0x400) != 0 )
  {
  ...
  if ( !v14 )
  {
    ...
    {
      sub_AEB684(rgctx_data->_23_WeightRate___c_T_);
      rgctx_data = (*p_klass)->rgctx_data;
    }
    ...
    if ( (BYTE2(_25_System_Comparison_WeightRate_WeightSeed_T->vtable[0].methodPtr) & 1) == 0 )
      sub_AEB684(_25_System_Comparison_WeightRate_WeightSeed_T);
    v14 = (System_Int32_array **)sub_B52A54(_25_System_Comparison_WeightRate_WeightSeed_T);
...
void __fastcall WeightRate_object___SetAdjust(WeightRate_T__o *this, const MethodInfo_2C1C994 *method)
{
  struct System_Collections_Generic_List_WeightRate_WeightSeed_T___o *list; // x0
  int32_t v5; // w22
  unsigned int v6; // w21
...
bool __fastcall WeightRate_object___checkWeight(WeightRate_T__o *this, const MethodInfo_2C1C964 *method)
{
  return this->fields.totalweight > 0;
}


int32_t __fastcall WeightRate_object___getCount(WeightRate_T__o *this, const MethodInfo_2C1C974 *method)
{
  struct System_Collections_Generic_List_WeightRate_WeightSeed_T___o *list; // x0
...
Il2CppObject *__fastcall WeightRate_object___getData(
        ...
        int32_t keywieght,
        const MethodInfo_2C1CA58 *method)
{
  ...
  while ( 1 )
  {
    ...
    v11 = System_Collections_Generic_List_Enumerator_BattleLogicBuff_ReduceHpProcess_BuffInfo___MoveNext(
            &v23,
            (const MethodInfo_201195C *)method->klass->rgctx_data->_13_System_Collections_Generic_List_Enumerator_WeightRate_WeightSeed_T___MoveNext);
    if ( !v11 )
      break;
...
LABEL_10:
  ...
  if ( (BYTE2(_14_System_Collections_Generic_List_Enumerator_WeightRate_WeightSeed_T->vtable[0].methodPtr) & 1) == 0 )
    sub_AEB684(_14_System_Collections_Generic_List_Enumerator_WeightRate_WeightSeed_T);
  ...
  {
LABEL_16:
    p_method = sub_AEB880(&v20, System_IDisposable_TypeInfo, 0LL, v13);
  }
...
Il2CppObject *__fastcall WeightRate_object___getData_46255208(
        WeightRate_T__o *this,
        int32_t keyWeight,
        Il2CppObject *skipValue,
        const MethodInfo_2C1CC68 *method)
{
  ...
  if ( (BYTE2(_0_System_Collections_Generic_List_WeightRate_WeightSeed_T->vtable[0].methodPtr) & 1) == 0 )
    sub_AEB684(method->klass->rgctx_data->_0_System_Collections_Generic_List_WeightRate_WeightSeed_T__);
  v13 = sub_B52A54(_0_System_Collections_Generic_List_WeightRate_WeightSeed_T);
  ...
  while ( 1 )
  {
    ...
    if ( !v42.fields.current )
      sub_B52A5C(v16, v17);
    if ( System_Object__Equals_42268688((Il2CppObject *)v42.fields.current[1].monitor, skipValue, 0LL) )
    {
  ...
  _14_System_Collections_Generic_List_Enumerator_WeightRate_WeightSeed_T = method->klass->rgctx_data->_14_System_Collections_Generic_List_Enumerator_WeightRate_WeightSeed_T__;
  if ( (BYTE2(_14_System_Collections_Generic_List_Enumerator_WeightRate_WeightSeed_T->vtable[0].methodPtr) & 1) == 0 )
    sub_AEB684(method->klass->rgctx_data->_14_System_Collections_Generic_List_Enumerator_WeightRate_WeightSeed_T__);
  ...
  {
LABEL_17:
    p_method = sub_AEB880(&v38, System_IDisposable_TypeInfo, 0LL, v18);
  }
...
LABEL_27:
  ...
  {
LABEL_33:
    v35 = sub_AEB880(&v38, System_IDisposable_TypeInfo, 0LL, v29);
  }
...
int32_t __fastcall WeightRate_object___getTotalWeight(WeightRate_T__o *this, const MethodInfo_2C1C95C *method)
{
...
void __fastcall WeightRate_object___removeWeight(
        WeightRate_T__o *this,
        Il2CppObject *t,
        const MethodInfo_2C1C6E4 *method)
{
  ...
  if ( (BYTE2(_5_WeightRate___c__DisplayClass4_0_T->vtable[0].methodPtr) & 1) == 0 )
    sub_AEB684(method->klass->rgctx_data->_5_WeightRate___c__DisplayClass4_0_T_);
  v7 = sub_B52A54(_5_WeightRate___c__DisplayClass4_0_T);
  ...
  if ( !v7 )
    goto LABEL_26;
  *(_QWORD *)(v7 + 16) = t;
  sub_B52920((BattleServantConfConponent_o *)(v7 + 16), (System_Int32_array **)t, v10, v11, v12, v13, v14, v15);
  list = this->fields.list;
  ...
  if ( (BYTE2(_8_System_Predicate_WeightRate_WeightSeed_T->vtable[0].methodPtr) & 1) == 0 )
    sub_AEB684(method->klass->rgctx_data->_8_System_Predicate_WeightRate_WeightSeed_T__);
  v18 = sub_B52A54(_8_System_Predicate_WeightRate_WeightSeed_T);
...
LABEL_26:
  ...
  {
LABEL_20:
    p_method = sub_AEB880(&v27, System_IDisposable_TypeInfo, 0LL, v22);
  }
...
void __fastcall WeightRate_object___setWeight(
        ...
        int32_t weight,
        Il2CppObject *t,
        const MethodInfo_2C1C5C8 *method)
{
  ...
  else
  {
    ...
    _0_System_Collections_Generic_List_WeightRate_WeightSeed_T = method->klass->rgctx_data->_0_System_Collections_Generic_List_WeightRate_WeightSeed_T__;
    if ( (BYTE2(_0_System_Collections_Generic_List_WeightRate_WeightSeed_T->vtable[0].methodPtr) & 1) == 0 )
      sub_AEB684(_0_System_Collections_Generic_List_WeightRate_WeightSeed_T);
    v13 = (struct System_Collections_Generic_List_WeightRate_WeightSeed_T___o *)sub_B52A54(_0_System_Collections_Generic_List_WeightRate_WeightSeed_T);
    (*p_klass)->rgctx_data->_1_System_Collections_Generic_List_WeightRate_WeightSeed_T____ctor->methodPointer();
    this->fields.list = v13;
    sub_B52920((BattleServantConfConponent_o *)p_fields, (System_Int32_array **)v13, v14, v15, v16, v17, v18, v19);
  ...
  *p_totalweight = totalweight + weight;
  ...
  if ( (BYTE2(_2_WeightRate_WeightSeed_T->vtable[0].methodPtr) & 1) == 0 )
    sub_AEB684((*p_klass)->rgctx_data->_2_WeightRate_WeightSeed_T_);
  v21 = sub_B52A54(_2_WeightRate_WeightSeed_T);
