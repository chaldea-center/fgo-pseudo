        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A6CD & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_DataManager_GetMaster_ServantTreasureDvcMaster___, v13);
    sub_1B761C0(&Method_DataManager_GetMaster_UserServantMaster___, v14);
    sub_1B761C0(&DataManager_TypeInfo, v15);
    sub_1B761C0(&Method_System_Linq_Enumerable_FirstOrDefault_UserServantEntity___, v16);
    sub_1B761C0(&Method_System_Linq_Enumerable_OrderByDescending_UserServantEntity__int___, v17);
    sub_1B761C0(&System_Func_UserServantEntity__int__TypeInfo, v18);
    sub_1B761C0(&IconLabelInfo_TypeInfo, v19);
    ...
    sub_1B761C0(&Method_BonusSelectSummonPartyServantListViewItem___c___ctor_b__10_0__, v22);
    sub_1B761C0(&BonusSelectSummonPartyServantListViewItem___c_TypeInfo, v23);
    byte_4A2A6CD = 1;
  }
  userServantList = 0LL;
  v24 = (IconLabelInfo_o *)sub_1B7640C(IconLabelInfo_TypeInfo);
  IconLabelInfo___ctor(v24, 0LL);
  this->fields.iconLabelInfo = v24;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.iconLabelInfo, (int32_t)v24, v25, v26);
  ListViewItem___ctor_40521064((ListViewItem_o *)this, index, 0LL);
  this->fields.lineupEntity = lineupEntity;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.lineupEntity, (int32_t)lineupEntity, v27, v28);
  this->fields.servantEntity = servantEntity;
  p_servantEntity = &this->fields.servantEntity;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.servantEntity, (int32_t)servantEntity, v30, v31);
  ...
  *(_QWORD *)&v60.fields.fakeValue = v33;
  Instance = (void *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(v60, 0LL);
  if ( !Master_object )
    goto LABEL_30;
         ...
         0LL) )
  {
    ...
    if ( !_9__10_0 )
    {
      ...
      _9__10_0 = (System_Func_object__int__o *)sub_1B7640C(System_Func_UserServantEntity__int__TypeInfo);
      ...
      sub_1B76164((ServantStatusBattleListViewItem_o *)&static_fields->__9__10_0, (int32_t)_9__10_0, v46, v47);
    }
    v48 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__OrderByDescending_object__int_(
                                                                 ...
                                                                 (const MethodInfo_2E8CDF0 *)Method_System_Linq_Enumerable_OrderByDescending_UserServantEntity__int___);
    v49 = System_Linq_Enumerable__FirstOrDefault_object_(
            v48,
            (const MethodInfo_2E86100 *)Method_System_Linq_Enumerable_FirstOrDefault_UserServantEntity___);
    this->fields.userServantEntity = (struct UserServantEntity_o *)v49;
    sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.userServantEntity, (int32_t)v49, v50, v51);
  }
  this->fields.baseItem = baseItem;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.baseItem, (int32_t)baseItem, v39, v40);
  ...
  *(_QWORD *)&v61.fields.fakeValue = v54;
  Instance = (void *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(v61, 0LL);
...
LABEL_30:
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  v56 = DataManager__GetMaster_object_((const MethodInfo_2E623B4 *)Method_DataManager_GetMaster_ServantTreasureDvcMaster___);
  this->fields.svtTdMaster = (struct ServantTreasureDvcMaster_o *)v56;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.svtTdMaster, (int32_t)v56, v57, v58);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A6D1 & 1) == 0 )
  {
    this = (BonusSelectSummonPartyServantListViewItem_o *)sub_1B761C0(
  ...
  *(_QWORD *)&v12.fields.fakeValue = v9;
  this = (BonusSelectSummonPartyServantListViewItem_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(
                                                          v12,
                                                          0LL);
  if ( !svtTdMaster
...
LABEL_11:
  ...
  *tdMaxLv = ServantTreasureDvcEntity__getLevelMax((ServantTreasureDvcEntity_o *)this, 0LL);
  ...
  if ( userServantEntity )
    UserServantEntity__getTreasureDeviceInfo_40027404(userServantEntity, tdLv, tdMaxLv, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A6D0 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMaster_ServantClassMaster___, method);
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  this = (BonusSelectSummonPartyServantListViewItem_o *)DataManager__GetMaster_object_((const MethodInfo_2E623B4 *)Method_DataManager_GetMaster_ServantClassMaster___);
  ...
  if ( !v9
    ...
    || (this = (BonusSelectSummonPartyServantListViewItem_o *)DataMasterBase_object__object__int___GetEntity(
                                                                ...
                                                                v9->fields.classId,
                                                                (const MethodInfo_30FF780 *)Method_DataMasterBase_ServantClassMaster__ServantClassEntity__int__GetEntity__)) == 0LL
...
LABEL_13:
  ...
  *(_QWORD *)&v13.fields.fakeValue = v11;
  v2->fields.sortValue2B = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(v13, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !ListViewSort__IsUnSelectedAllTargetFilters(sort, v20, 0LL)
    && !ListViewSort__IsMatchNPTypeFilter_40614636(sort, this->fields.servantEntity, 0LL) )
  {
    return 0;
  }
  ...
  if ( !ListViewSort__IsUnSelectedAllTargetFilters(sort, v22, 0LL)
    && !ListViewSort__IsMatchNPEffectFilter_40615244(sort, this->fields.servantEntity, 0LL) )
  {
    return 0;
  }
  ...
  CollectionStateFilterKindList = sub_1B76268(ListViewSort_FilterKind___TypeInfo, 1LL);
  if ( !CollectionStateFilterKindList )
    goto LABEL_66;
  ...
  *(_DWORD *)(CollectionStateFilterKindList + 32) = 50;
  ...
  if ( !CollectionStateFilterKindList )
LABEL_66:
    sub_1B7641C(CollectionStateFilterKindList, sort);
  v30 = CollectionStateFilterKindList;
  if ( !*(_DWORD *)(CollectionStateFilterKindList + 24) )
LABEL_67:
    sub_1B76424(CollectionStateFilterKindList, v30);
        ...
        const MethodInfo *method)
{
  ...
  int32_t v20; // w1
  ServantStatusBattleListViewItem_o *p_sortStr1; // x19
  int32_t tdMaxLv[2]; // [xsp+18h] [xbp-28h] BYREF

  if ( (byte_4A2A6CF & 1) == 0 )
  {
    sub_1B761C0(&BonusSelectSummonPartyServantListViewItem_TypeInfo, sort);
  ...
  *(_WORD *)&this->fields.isTermination = 0;
  ...
  v13 = System_Math__Max_62353708(v12, 1, 0LL);
  if ( !iconLabelInfo )
    goto LABEL_18;
  IconLabelInfo__Set_37960168(iconLabelInfo, 33, v13, tdMaxLv[0], 0, 0, 0, 0, 0LL);
  if ( !sort )
    goto LABEL_18;
...
LABEL_18:
  ...
  sub_1B76164(p_sortStr1, v20, v15, v16);
...
void __fastcall BonusSelectSummonPartyServantListViewItem___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A2A6D2 & 1) == 0 )
  {
    sub_1B761C0(&BonusSelectSummonPartyServantListViewItem___c_TypeInfo, v1);
    byte_4A2A6D2 = 1;
  }
  v2 = (Il2CppObject *)sub_1B7640C(BonusSelectSummonPartyServantListViewItem___c_TypeInfo);
  ...
  sub_1B76164(
    (ServantStatusBattleListViewItem_o *)BonusSelectSummonPartyServantListViewItem___c_TypeInfo->static_fields,
    (int32_t)v2,
    v3,
    v4);
}
