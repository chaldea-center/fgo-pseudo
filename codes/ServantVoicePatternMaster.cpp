void __fastcall ServantVoicePatternMaster___ctor(ServantVoicePatternMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A20355 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataMasterBase_ServantVoicePatternMaster__ServantVoicePatternEntity__string___ctor__, method);
    byte_4A20355 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    480,
    (const MethodInfo_30F8A78 *)Method_DataMasterBase_ServantVoicePatternMaster__ServantVoicePatternEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (ServantVoicePatternEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                          (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                          PK,
                                          (const MethodInfo_30F8AB8 *)Method_DataMasterBase_ServantVoicePatternMaster__ServantVoicePatternEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20354 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_System_Collections_Generic_List_ServantVoicePatternEntity__Add__, v10);
    sub_1B715CC(&Method_System_Collections_Generic_List_ServantVoicePatternEntity___ctor__, v11);
    sub_1B715CC(&System_Collections_Generic_List_ServantVoicePatternEntity__TypeInfo, v12);
    sub_1B715CC(&ServantVoicePatternEntity_TypeInfo, v13);
    byte_4A20354 = 1;
  }
  v14 = (System_Collections_Generic_List_object__o *)sub_1B71818(System_Collections_Generic_List_ServantVoicePatternEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v14,
    (const MethodInfo_34CFA2C *)Method_System_Collections_Generic_List_ServantVoicePatternEntity___ctor__);
...
LABEL_36:
    ...
    {
      if ( !v14 )
        sub_1B71828(v27, ServantVoicePatternEntity_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_30F8B08 *)Method_DataMasterBase_ServantVoicePatternMaster__ServantVoicePatternEntity__string__TryGetEntity__);
}