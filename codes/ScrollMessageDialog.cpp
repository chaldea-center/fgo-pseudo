void ScrollMessageDialog___ctor(ScrollMessageDialog_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.TITLE_LABEL_MAX_WIDTH = xmmword_D24D20;
  *(_OWORD *)&this->fields.MULTILINE_TITLE_MESSAGE_POS_Y = xmmword_D24A00;
...
void ScrollMessageDialog__Close(ScrollMessageDialog_o *this, const MethodInfo *method)
{
  ...
  ScrollMessageDialog__Close_33038552(this, 0, v2);
}


void ScrollMessageDialog__Close_33038552(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFEEEB & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_ScrollMessageDialog_EndClose__);
    byte_4DFEEEB = 1;
  }
...
void ScrollMessageDialog__OnClickCancel(ScrollMessageDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFEEED & 1) == 0 )
  {
    sub_1CE6700(&Method_ScrollMessageDialog_OnClickCancel__);
  ...
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_ScrollMessageDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_ScrollMessageDialog_OnClickCancel__);
...
void ScrollMessageDialog__OnClickOk(ScrollMessageDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFEEEC & 1) == 0 )
  {
    sub_1CE6700(&Method_ScrollMessageDialog_OnClickOk__);
    sub_1CE6700(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4DFEEEC = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_ScrollMessageDialog_OnClickOk__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_ScrollMessageDialog_OnClickOk__);
    v4 = (System_Reflection_MethodBase_o *)sub_1CE66E4(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, this->fields.onClickSeKind, 0, 0);
    Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    if ( !Instance )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFEEE9 & 1) == 0 )
  {
    ...
    sub_1CE6700(&UnityEngine_Object_TypeInfo);
    sub_1CE6700(&Method_ScrollMessageDialog_EndOpen__);
    sub_1CE6700(&StringLiteral_43/*"\n"*/);
    sub_1CE6700(&StringLiteral_24491/*"titleFontSize"*/);
    sub_1CE6700(&StringLiteral_21884/*"messageFontSize"*/);
    sub_1CE6700(&StringLiteral_3714/*"COMMON_CONFIRM_CLOSE"*/);
    sub_1CE6700(&StringLiteral_1/*""*/);
    byte_4DFEEE9 = 1;
  }
  this->fields.clickFunc = func;
  mPanel = sub_1CE66A4(&this->fields.clickFunc, func);
  if ( !canBackKeyClose )
  {
  ...
  if ( script )
  {
    ...
    {
      IntValue = EntityScriptUtil__GetIntValue(script, (System_String_o *)StringLiteral_24491/*"titleFontSize"*/, 0, 0);
      if ( IntValue >= 1 )
...
LABEL_69:
  ...
  mPanel = System_Collections_Generic_Dictionary_object__object___get_Count(
             (System_Collections_Generic_Dictionary_object__object__o *)script,
             (const MethodInfo_35B4660 *)Method_System_Collections_Generic_Dictionary_string__object__get_Count__);
  if ( (int)mPanel <= 0 )
    goto LABEL_69;
  mPanel = EntityScriptUtil__GetIntValue(script, (System_String_o *)StringLiteral_21884/*"messageFontSize"*/, 0, 0);
  v32 = this->fields.messageLabel;
  if ( (int)mPanel >= 1 )
  {
    if ( !v32 )
...
LABEL_86:
  ...
  if ( UnityEngine_Object__op_Inequality(okBtnLabel, 0, 0) )
  {
    ...
    mPanel = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_3714/*"COMMON_CONFIRM_CLOSE"*/, 0);
    if ( v50 )
    {
...
void ScrollMessageDialog__Open_33038228(
        ScrollMessageDialog_o *this,
        System_String_o *title,
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1B0EC74;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1B0EC2C;
}
