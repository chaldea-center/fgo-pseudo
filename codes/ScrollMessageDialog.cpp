...
void __fastcall ScrollMessageDialog__Close(ScrollMessageDialog_o *this, const MethodInfo *method)
{
  ...
  ScrollMessageDialog__Close_45192360(this, 0LL, v2);
}


void __fastcall ScrollMessageDialog__Close_45192360(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31ACE & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_ScrollMessageDialog_EndClose__, v6);
    byte_4A31ACE = 1;
  }
...
void __fastcall ScrollMessageDialog__OnClickCancel(ScrollMessageDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A31AD0 & 1) == 0 )
  {
    sub_1B761C0(&Method_ScrollMessageDialog_OnClickCancel__, method);
  ...
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_ScrollMessageDialog_OnClickCancel__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1B761D8(Method_ScrollMessageDialog_OnClickCancel__);
...
void __fastcall ScrollMessageDialog__OnClickOk(ScrollMessageDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A31ACF & 1) == 0 )
  {
    sub_1B761C0(&Method_ScrollMessageDialog_OnClickOk__, method);
    sub_1B761C0(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v3);
    byte_4A31ACF = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_ScrollMessageDialog_OnClickOk__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1B761D8(Method_ScrollMessageDialog_OnClickOk__);
    v5 = (System_Reflection_MethodBase_o *)sub_1B761A4(v4, v4[4]);
    OverwriteAssetSoundName__PlaySystemSe(v5, this->fields.onClickSeKind, 0LL);
    Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_371257C *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    if ( !Instance )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31ACC & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_UnityEngine_Component_GetComponent_UIWidget___, v15);
    sub_1B761C0(&LocalizationManager_TypeInfo, v16);
    sub_1B761C0(&UnityEngine_Object_TypeInfo, v17);
    sub_1B761C0(&Method_ScrollMessageDialog_EndOpen__, v18);
    sub_1B761C0(&StringLiteral_43/*"\n"*/, v19);
    sub_1B761C0(&StringLiteral_3755/*"COMMON_CONFIRM_CLOSE"*/, v20);
    sub_1B761C0(&StringLiteral_1/*""*/, v21);
    byte_4A31ACC = 1;
  }
  this->fields.clickFunc = func;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.clickFunc, (int32_t)func, (int32_t)message, leftIndent);
  if ( !v13 )
    goto LABEL_84;
  v24 = StringLiteral_1/*""*/;
...
LABEL_84:
  ...
  if ( UnityEngine_Object__op_Inequality(okBtnLabel, 0LL, 0LL) )
  {
    ...
    mPanel = LocalizationManager__Get((System_String_o *)StringLiteral_3755/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
    if ( v56 )
    {
...
void __fastcall ScrollMessageDialog__Open_45192068(
        ScrollMessageDialog_o *this,
        System_String_o *title,
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19C2284;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19C223C;
}
