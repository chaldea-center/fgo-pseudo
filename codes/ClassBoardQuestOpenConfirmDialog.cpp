...
void ClassBoardQuestOpenConfirmDialog__Close(ClassBoardQuestOpenConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  ClassBoardQuestOpenConfirmDialog__Close_48082888(this, 0, v2);
}


void ClassBoardQuestOpenConfirmDialog__Close_48082888(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C46B25 & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_ClassBoardQuestOpenConfirmDialog_EndClose__);
    byte_4C46B25 = 1;
  }
...
void ClassBoardQuestOpenConfirmDialog__OnClickClose(ClassBoardQuestOpenConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C46B27 & 1) == 0 )
  {
    sub_1C37058(&Method_ClassBoardQuestOpenConfirmDialog_OnClickClose__);
    byte_4C46B27 = 1;
  }
  if ( this->fields.IsButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_ClassBoardQuestOpenConfirmDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C37070(Method_ClassBoardQuestOpenConfirmDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C46B26 & 1) == 0 )
  {
    sub_1C37058(&Method_ClassBoardQuestOpenConfirmDialog_OnClickDecide__);
    byte_4C46B26 = 1;
  }
  if ( this->fields.IsButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_ClassBoardQuestOpenConfirmDialog_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C37070(Method_ClassBoardQuestOpenConfirmDialog_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C3703C(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
    ClickFunc = this->fields.ClickFunc;
    this->fields.IsButtonEnable = 0;
...
void ClassBoardQuestOpenConfirmDialog__OnEnable(ClassBoardQuestOpenConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  AndroidBackKeyManager__AddBackBtn_44960000(v4, (System_String_o *)StringLiteral_4648/*"ConfirmWindow/CancelButton"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C37058(&System_Action_TypeInfo);
    sub_1C37058(&Method_ClassBoardQuestOpenConfirmDialog_EndOpen__);
    sub_1C37058(&LocalizationManager_TypeInfo);
    sub_1C37058(&StringLiteral_3414/*"CLASS_BOARD_QUEST_OPEN_DIALOG_MOVE"*/);
    sub_1C37058(&StringLiteral_3415/*"CLASS_BOARD_QUEST_OPEN_DIALOG_MSG_"*/);
    sub_1C37058(&StringLiteral_3416/*"CLASS_BOARD_QUEST_OPEN_DIALOG_TITLE"*/);
    sub_1C37058(&StringLiteral_3413/*"CLASS_BOARD_QUEST_OPEN_DIALOG_DECIDE"*/);
    byte_4C46B24 = 1;
  }
  ...
  v7 = System_String__Concat_63561656((System_String_o *)StringLiteral_3415/*"CLASS_BOARD_QUEST_OPEN_DIALOG_MSG_"*/, v6, 0);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1A7FC4C;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A7FC04;
}
