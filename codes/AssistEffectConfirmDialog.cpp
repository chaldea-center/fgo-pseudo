...
LABEL_10:
  ...
  sub_1C9403C(&this->fields.closeCallback, 0);
}
...
void AssistEffectConfirmDialog__OnClickCloseButton(AssistEffectConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2628B & 1) == 0 )
  {
    sub_1C94098(&Method_AssistEffectConfirmDialog_OnClickCloseButton__);
    byte_4D2628B = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2628A & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_AssistEffectConfirmDialog__Open_b__11_0__);
    sub_1C94098(&LocalizationManager_TypeInfo);
    sub_1C94098(&UnityEngine_Object_TypeInfo);
    sub_1C94098(&StringLiteral_5527/*"EVENT_ASSIST_SKILL_CONFIRM_DIALOG_NO_DATA"*/);
    sub_1C94098(&StringLiteral_5526/*"EVENT_ASSIST_SKILL_CONFIRM_DIALOG_MESSAGE"*/);
    sub_1C94098(&StringLiteral_5528/*"EVENT_ASSIST_SKILL_CONFIRM_DIALOG_TITLE"*/);
    byte_4D2628A = 1;
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5528/*"EVENT_ASSIST_SKILL_CONFIRM_DIALOG_TITLE"*/, 0);
  if ( !titleLabel )
    goto LABEL_24;
  UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0);
  messageLabel = this->fields.messageLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5526/*"EVENT_ASSIST_SKILL_CONFIRM_DIALOG_MESSAGE"*/, 0);
  if ( !messageLabel )
    goto LABEL_24;
  UILabel__set_text(messageLabel, (System_String_o *)gameObject, 0);
  this->fields.closeCallback = closeCallback;
  sub_1C9403C(&this->fields.closeCallback, closeCallback);
...
LABEL_22:
      ...
      else
      {
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5527/*"EVENT_ASSIST_SKILL_CONFIRM_DIALOG_NO_DATA"*/, 0);
        if ( noDataLabel )
        {
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1ABEE08;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1ABEDC8;
}
