        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB2B9F & 1) == 0 )
  {
    sub_1C6BA08(&Method_System_Linq_Enumerable_Last_string___);
    byte_4CB2B9F = 1;
  }
  ...
  if ( LODWORD(name[1].klass) == 1 )
    ...
    return (System_String_o *)System_Linq_Enumerable__Last_object_(
                                ...
                                (const MethodInfo_3166318 *)Method_System_Linq_Enumerable_Last_string___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB2B9E & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_22012/*"mstMapGimmickLayer: mapGimmickId: {0}, z: {1}"*/);
    byte_4CB2B9E = 1;
  }
  ...
  return System_String__Format_64008100((System_String_o *)StringLiteral_22012/*"mstMapGimmickLayer: mapGimmickId: {0}, z: {1}"*/, MapGimmickId, v8, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C6BA08(&int_TypeInfo);
    sub_1C6BA08(&StringLiteral_22010/*"mstMapGimmick: mapGimmickId: {0}, x: {1}, y: {2}"*/);
    byte_4CB2B9D = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0);
  if ( !gameObject
  ...
  return System_String__Format_64008168((System_String_o *)StringLiteral_22010/*"mstMapGimmick: mapGimmickId: {0}, x: {1}, y: {2}"*/, MapGimmickId, v11, v12, 0);
}