        ...
        const MethodInfo *method)
{
  ...
  if ( !servantFaceIcon )
    goto LABEL_12;
  ServantFaceIconComponent__Set_40018236(servantFaceIcon, userServantEntity, 0LL, 0LL, 0LL);
  ...
  if ( !iconLabelLevel )
    goto LABEL_12;
  UIIconLabel__Set_40036752(iconLabelLevel, 2, lv, (int32_t)servantFaceIcon, 0, 0LL, 0, 0, 0, 0, 0LL);
  ...
  if ( !iconLabelFriendRank )
    goto LABEL_12;
  UIIconLabel__Set_40036752(iconLabelFriendRank, 32, (int32_t)servantFaceIcon, 0, 0, 0LL, 0, 0, 0, 0, 0LL);
  ...
  servantFaceIcon = (ServantFaceIconComponent_o *)LocalizationManager__GetLevelList_40284868(v10, 0LL);
