void __fastcall SyncWidget___ctor(SyncWidget_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B461B5 & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Array_Empty_Action___, method);
    sub_1BDB878(&Method_System_Array_Empty_SyncWidget_SyncParamType___, v6);
    byte_4B461B5 = 1;
  }
  ...
  if ( !v8 )
  {
    sub_1C2BF64(Method_System_Array_Empty_SyncWidget_SyncParamType___);
    v8 = v7[7];
  }
  v9 = *(_QWORD *)(v8 + 16);
  if ( (*(_BYTE *)(v9 + 309) & 1) == 0 )
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.syncParamTypeArray, (int32_t)v12, v2, v3);
  if ( !byte_4B3E80A )
  {
  ...
  *(struct UnityEngine_Vector2_o *)&v16 = UnityEngine_Vector2_TypeInfo->static_fields->zeroVector;
  ...
  if ( !v18 )
  {
    sub_1C2BF64(Method_System_Array_Empty_Action___);
    v18 = v17[7];
  }
  v19 = *(_QWORD *)(v18 + 16);
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.syncActionArray, (int32_t)v22, v14, v15);
...
void __fastcall SyncWidget__Awake(SyncWidget_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B461B2 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_System_Linq_Enumerable_Select_SyncWidget_SyncParamType__Action___, v3);
    sub_1BDB878(&Method_System_Linq_Enumerable_ToArray_Action___, v4);
    sub_1BDB878(&System_Func_SyncWidget_SyncParamType__Action__TypeInfo, v5);
    byte_4B461B2 = 1;
  }
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.self, (int32_t)Component_object, v7, v8);
  syncParamTypeArray = (System_Collections_Generic_IEnumerable_TSource__o *)this->fields.syncParamTypeArray;
  v10 = (System_Func_T__TResult__o *)sub_1BDBAC4(System_Func_SyncWidget_SyncParamType__Action__TypeInfo);
  ...
  v11 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_Int32Enum__object_(
                                                               ...
                                                               (const MethodInfo_3066980 *)Method_System_Linq_Enumerable_Select_SyncWidget_SyncParamType__Action___);
  v12 = System_Linq_Enumerable__ToArray_object_(
          v11,
          (const MethodInfo_30707A8 *)Method_System_Linq_Enumerable_ToArray_Action___);
  this->fields.syncActionArray = (struct System_Action_array *)v12;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.syncActionArray, (int32_t)v12, v13, v14);
...
System_Action_o *__fastcall SyncWidget__ConvertTypeToAction(SyncWidget_o *this, int32_t type, const MethodInfo *method)
{
  ...
  if ( (byte_4B461B4 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_SyncWidget_SyncColorAlpha__, v5);
    sub_1BDB878(&Method_SyncWidget__ConvertTypeToAction_b__9_0__, v6);
    sub_1BDB878(&Method_SyncWidget__ConvertTypeToAction_b__9_1__, v7);
    sub_1BDB878(&Method_SyncWidget__ConvertTypeToAction_b__9_2__, v8);
    sub_1BDB878(&Method_SyncWidget___c__ConvertTypeToAction_b__9_3__, v9);
    sub_1BDB878(&SyncWidget___c_TypeInfo, v10);
    byte_4B461B4 = 1;
  }
  switch ( type )
  {
...
LABEL_15:
    ...
    default:
      ...
      if ( !_9__9_3 )
      {
        ...
        _9__9_3 = (System_Action_o *)sub_1BDBAC4(System_Action_TypeInfo);
        ...
        sub_1BDB81C((CGThumbnailListItem_o *)&static_fields->__9__9_3, (int32_t)_9__9_3, v17, v18);
      }
      result = _9__9_3;
      break;
  }
...
void __fastcall SyncWidget__Sync(SyncWidget_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B461B3 & 1) == 0 )
  {
    sub_1BDB878(&System_Action_Action__TypeInfo, method);
    sub_1BDB878(&Method_BasicHelper_ForEach_Action___, v3);
    sub_1BDB878(&UnityEngine_Object_TypeInfo, v4);
    sub_1BDB878(&Method_SyncWidget___c__Sync_b__8_0__, v5);
    sub_1BDB878(&SyncWidget___c_TypeInfo, v6);
    byte_4B461B3 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(self, 0LL, 0LL) )
  {
            ...
            this->klass[1]._1.image) & 1) == 0 )
    {
      ...
      if ( !_9__8_0 )
      {
        ...
        _9__8_0 = (System_Action_object__o *)sub_1BDBAC4(System_Action_Action__TypeInfo);
      ...
      BasicHelper__ForEach_object_(
        ...
        (const MethodInfo_301FA1C *)Method_BasicHelper_ForEach_Action___);
    }
  }
}
...
void __fastcall SyncWidget__SyncColorAlpha(SyncWidget_o *this, const MethodInfo *method)
{
  ...
  if ( !byte_4B3E915 )
  {
    this = (SyncWidget_o *)sub_1BDB878(&UnityEngine_Mathf_TypeInfo, method);
    byte_4B3E915 = 1;
  }
  v10 = fabsf(a);
  v11 = fabsf(v9);
...
void __fastcall SyncWidget___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B461B6 & 1) == 0 )
  {
    sub_1BDB878(&SyncWidget___c_TypeInfo, v1);
    byte_4B461B6 = 1;
  }
  v2 = (Il2CppObject *)sub_1BDBAC4(SyncWidget___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  SyncWidget___c_TypeInfo->static_fields->__9 = (struct SyncWidget___c_o *)v2;
  sub_1BDB81C((CGThumbnailListItem_o *)SyncWidget___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
