void __fastcall SyncWidget___ctor(SyncWidget_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FFFA7 & 1) == 0 )
  {
    sub_1B64A00(&Method_System_Array_Empty_Action___, method);
    sub_1B64A00(&Method_System_Array_Empty_SyncWidget_SyncParamType___, v5);
    byte_49FFFA7 = 1;
  }
  ...
  if ( !v7 )
  {
    sub_1BB6938(Method_System_Array_Empty_SyncWidget_SyncParamType___);
    v7 = v6[7];
  }
  v8 = *(_QWORD *)(v7 + 16);
  if ( (*(_BYTE *)(v8 + 309) & 1) == 0 )
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.syncParamTypeArray, (int32_t)v11, v2, v3);
  if ( !byte_49F971A )
  {
    sub_1B64A00(&UnityEngine_Vector2_TypeInfo, v12);
    byte_49F971A = 1;
  }
  ...
  if ( !v16 )
  {
    sub_1BB6938(Method_System_Array_Empty_Action___);
    v16 = v15[7];
  }
  v17 = *(_QWORD *)(v16 + 16);
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.syncActionArray, (int32_t)v20, v13, v14);
...
void __fastcall SyncWidget__Awake(SyncWidget_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FFFA4 & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_System_Linq_Enumerable_Select_SyncWidget_SyncParamType__Action___, v3);
    sub_1B64A00(&Method_System_Linq_Enumerable_ToArray_Action___, v4);
    sub_1B64A00(&System_Func_SyncWidget_SyncParamType__Action__TypeInfo, v5);
    byte_49FFFA4 = 1;
  }
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.self, (int32_t)Component_object, v7, v8);
  syncParamTypeArray = (System_Collections_Generic_IEnumerable_TSource__o *)this->fields.syncParamTypeArray;
  v10 = (System_Func_T__TResult__o *)sub_1B64C4C(System_Func_SyncWidget_SyncParamType__Action__TypeInfo);
  ...
  v11 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_Int32Enum__object_(
                                                               ...
                                                               (const MethodInfo_2E6A490 *)Method_System_Linq_Enumerable_Select_SyncWidget_SyncParamType__Action___);
  v12 = System_Linq_Enumerable__ToArray_object_(
          v11,
          (const MethodInfo_2E73CB8 *)Method_System_Linq_Enumerable_ToArray_Action___);
  this->fields.syncActionArray = (struct System_Action_array *)v12;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.syncActionArray, (int32_t)v12, v13, v14);
...
System_Action_o *__fastcall SyncWidget__ConvertTypeToAction(SyncWidget_o *this, int32_t type, const MethodInfo *method)
{
  ...
  if ( (byte_49FFFA6 & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_SyncWidget_SyncColorAlpha__, v5);
    sub_1B64A00(&Method_SyncWidget__ConvertTypeToAction_b__9_0__, v6);
    sub_1B64A00(&Method_SyncWidget__ConvertTypeToAction_b__9_1__, v7);
    sub_1B64A00(&Method_SyncWidget__ConvertTypeToAction_b__9_2__, v8);
    sub_1B64A00(&Method_SyncWidget___c__ConvertTypeToAction_b__9_3__, v9);
    sub_1B64A00(&SyncWidget___c_TypeInfo, v10);
    byte_49FFFA6 = 1;
  }
  switch ( type )
  {
...
LABEL_15:
    ...
    default:
      ...
      if ( !_9__9_3 )
      {
        ...
        _9__9_3 = (System_Action_o *)sub_1B64C4C(System_Action_TypeInfo);
        ...
        sub_1B649A4((ServantStatusBattleListViewItem_o *)&static_fields->__9__9_3, (int32_t)_9__9_3, v17, v18);
      }
      result = _9__9_3;
      break;
  }
...
void __fastcall SyncWidget__Sync(SyncWidget_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FFFA5 & 1) == 0 )
  {
    sub_1B64A00(&System_Action_Action__TypeInfo, method);
    sub_1B64A00(&Method_BasicHelper_ForEach_Action___, v3);
    sub_1B64A00(&UnityEngine_Object_TypeInfo, v4);
    sub_1B64A00(&Method_SyncWidget___c__Sync_b__8_0__, v5);
    sub_1B64A00(&SyncWidget___c_TypeInfo, v6);
    byte_49FFFA5 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(self, 0LL, 0LL) )
  {
            ...
            this->klass[1]._1.image) & 1) == 0 )
    {
      ...
      if ( !_9__8_0 )
      {
        ...
        _9__8_0 = (System_Action_object__o *)sub_1B64C4C(System_Action_Action__TypeInfo);
      ...
      BasicHelper__ForEach_object_(
        ...
        (const MethodInfo_2E29154 *)Method_BasicHelper_ForEach_Action___);
    }
  }
}
...
void __fastcall SyncWidget__SyncColorAlpha(SyncWidget_o *this, const MethodInfo *method)
{
  ...
  if ( !byte_49F9825 )
  {
    this = (SyncWidget_o *)sub_1B64A00(&UnityEngine_Mathf_TypeInfo, method);
    byte_49F9825 = 1;
  }
  v10 = fabsf(a);
  v11 = fabsf(v9);
...
void __fastcall SyncWidget___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FFFA8 & 1) == 0 )
  {
    sub_1B64A00(&SyncWidget___c_TypeInfo, v1);
    byte_49FFFA8 = 1;
  }
  v2 = (Il2CppObject *)sub_1B64C4C(SyncWidget___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  SyncWidget___c_TypeInfo->static_fields->__9 = (struct SyncWidget___c_o *)v2;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)SyncWidget___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
