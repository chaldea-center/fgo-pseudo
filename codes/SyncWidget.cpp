void SyncWidget___ctor(SyncWidget_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E78E68 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_System_Array_Empty_Action___);
    sub_1D0F0B4(&Method_System_Array_Empty_SyncWidget_SyncParamType___);
    byte_4E78E68 = 1;
  }
  ...
  if ( !v11 )
  {
    sub_1CE5198(Method_System_Array_Empty_SyncWidget_SyncParamType___);
    v11 = v10[7];
  }
  v12 = *(_QWORD *)(v11 + 16);
  ...
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.syncParamTypeArray, (int32_t)v15, v2, v3, v4, v5, v6, v7);
  if ( !byte_4E70B79 )
  {
  ...
  *(struct UnityEngine_Vector2_o *)&v22 = UnityEngine_Vector2_TypeInfo->static_fields->zeroVector;
  ...
  if ( !v24 )
  {
    sub_1CE5198(Method_System_Array_Empty_Action___);
    v24 = v23[7];
  }
  v25 = *(_QWORD *)(v24 + 16);
  ...
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.syncActionArray, (int32_t)v28, v16, v17, v18, v19, v20, v21);
...
void SyncWidget__Awake(SyncWidget_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E78E65 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_System_Linq_Enumerable_Select_SyncWidget_SyncParamType__Action___);
    sub_1D0F0B4(&Method_System_Linq_Enumerable_ToArray_Action___);
    sub_1D0F0B4(&System_Func_SyncWidget_SyncParamType__Action__TypeInfo);
    byte_4E78E65 = 1;
  }
  ...
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.self, (int32_t)Component_object, v4, v5, v6, v7, v8, v9);
  syncParamTypeArray = (System_Collections_Generic_IEnumerable_TSource__o *)this->fields.syncParamTypeArray;
  v11 = (System_Func_T__TResult__o *)sub_1D0F300(System_Func_SyncWidget_SyncParamType__Action__TypeInfo);
  ...
  v12 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_Int32Enum__object_(
                                                               ...
                                                               (const MethodInfo_32845B8 *)Method_System_Linq_Enumerable_Select_SyncWidget_SyncParamType__Action___);
  v13 = System_Linq_Enumerable__ToArray_object_(
          v12,
          (const MethodInfo_328FDE8 *)Method_System_Linq_Enumerable_ToArray_Action___);
  this->fields.syncActionArray = (struct System_Action_array *)v13;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.syncActionArray, (int32_t)v13, v14, v15, v16, v17, v18, v19);
...
System_Action_o *SyncWidget__ConvertTypeToAction(SyncWidget_o *this, int32_t type, const MethodInfo *method)
{
  ...
  if ( (byte_4E78E67 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_SyncWidget_SyncColorAlpha__);
    sub_1D0F0B4(&Method_SyncWidget__ConvertTypeToAction_b__9_0__);
    sub_1D0F0B4(&Method_SyncWidget__ConvertTypeToAction_b__9_1__);
    sub_1D0F0B4(&Method_SyncWidget__ConvertTypeToAction_b__9_2__);
    sub_1D0F0B4(&Method_SyncWidget___c__ConvertTypeToAction_b__9_3__);
    sub_1D0F0B4(&SyncWidget___c_TypeInfo);
    byte_4E78E67 = 1;
  }
  switch ( type )
  {
...
LABEL_15:
    ...
    default:
      ...
      if ( !_9__9_3 )
      {
        ...
        _9__9_3 = (System_Action_o *)sub_1D0F300(System_Action_TypeInfo);
...
void SyncWidget__Sync(SyncWidget_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E78E66 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_BasicHelper_ForEach_Action___);
    sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    sub_1D0F0B4(&Method_SyncWidget___c__Sync_b__8_0__);
    sub_1D0F0B4(&SyncWidget___c_TypeInfo);
    byte_4E78E66 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(self, 0, 0) )
  {
        ...
        & 1) == 0 )
    {
      ...
      if ( !_9__8_0 )
      {
        ...
        _9__8_0 = (System_Action_object__o *)sub_1D0F300(System_Action_Action__TypeInfo);
      ...
      BasicHelper__ForEach_object_(
        ...
        (const MethodInfo_323AF0C *)Method_BasicHelper_ForEach_Action___);
    }
  }
}
...
void SyncWidget__SyncColorAlpha(SyncWidget_o *this, const MethodInfo *method)
{
  ...
  if ( !byte_4E70C9D )
  {
    this = (SyncWidget_o *)sub_1D0F0B4(&UnityEngine_Mathf_TypeInfo);
    byte_4E70C9D = 1;
  }
  v10 = fabsf(a);
  v11 = fabsf(v9);
...
void SyncWidget___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1D0F300(SyncWidget___c_TypeInfo);
