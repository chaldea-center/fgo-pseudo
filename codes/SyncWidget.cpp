void SyncWidget___ctor(SyncWidget_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB7ABA & 1) == 0 )
  {
    sub_1C6BA08(&Method_System_Array_Empty_Action___);
    sub_1C6BA08(&Method_System_Array_Empty_SyncWidget_SyncParamType___);
    byte_4CB7ABA = 1;
  }
  ...
  if ( !v7 )
  {
    sub_1C41AF8(Method_System_Array_Empty_SyncWidget_SyncParamType___);
    v7 = v6[7];
  }
  v8 = *(_QWORD *)(v7 + 16);
  if ( (*(_BYTE *)(v8 + 309) & 1) == 0 )
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.syncParamTypeArray, (int32_t)v11, v2, v3);
  if ( !byte_4CAFAE9 )
  {
  ...
  *(struct UnityEngine_Vector2_o *)&v14 = UnityEngine_Vector2_TypeInfo->static_fields->zeroVector;
  ...
  if ( !v16 )
  {
    sub_1C41AF8(Method_System_Array_Empty_Action___);
    v16 = v15[7];
  }
  v17 = *(_QWORD *)(v16 + 16);
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.syncActionArray, (int32_t)v20, v12, v13);
...
void SyncWidget__Awake(SyncWidget_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB7AB7 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_System_Linq_Enumerable_Select_SyncWidget_SyncParamType__Action___);
    sub_1C6BA08(&Method_System_Linq_Enumerable_ToArray_Action___);
    sub_1C6BA08(&System_Func_SyncWidget_SyncParamType__Action__TypeInfo);
    byte_4CB7AB7 = 1;
  }
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.self, (int32_t)Component_object, v4, v5);
  syncParamTypeArray = (System_Collections_Generic_IEnumerable_TSource__o *)this->fields.syncParamTypeArray;
  v7 = (System_Func_T__TResult__o *)sub_1C6BC54(System_Func_SyncWidget_SyncParamType__Action__TypeInfo);
  ...
  v8 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_Int32Enum__object_(
                                                              ...
                                                              (const MethodInfo_316FD18 *)Method_System_Linq_Enumerable_Select_SyncWidget_SyncParamType__Action___);
  v9 = System_Linq_Enumerable__ToArray_object_(
         v8,
         (const MethodInfo_317B248 *)Method_System_Linq_Enumerable_ToArray_Action___);
  this->fields.syncActionArray = (struct System_Action_array *)v9;
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.syncActionArray, (int32_t)v9, v10, v11);
...
System_Action_o *SyncWidget__ConvertTypeToAction(SyncWidget_o *this, int32_t type, const MethodInfo *method)
{
  ...
  if ( (byte_4CB7AB9 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_SyncWidget_SyncColorAlpha__);
    sub_1C6BA08(&Method_SyncWidget__ConvertTypeToAction_b__9_0__);
    sub_1C6BA08(&Method_SyncWidget__ConvertTypeToAction_b__9_1__);
    sub_1C6BA08(&Method_SyncWidget__ConvertTypeToAction_b__9_2__);
    sub_1C6BA08(&Method_SyncWidget___c__ConvertTypeToAction_b__9_3__);
    sub_1C6BA08(&SyncWidget___c_TypeInfo);
    byte_4CB7AB9 = 1;
  }
  switch ( type )
  {
...
LABEL_15:
    ...
    default:
      ...
      if ( !_9__9_3 )
      {
        ...
        _9__9_3 = (System_Action_o *)sub_1C6BC54(System_Action_TypeInfo);
        ...
        sub_1C6B9AC((CGThumbnailListItem_o *)&static_fields->__9__9_3, (int32_t)_9__9_3, v11, v12);
      }
      result = _9__9_3;
      break;
  }
...
void SyncWidget__Sync(SyncWidget_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB7AB8 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_BasicHelper_ForEach_Action___);
    sub_1C6BA08(&UnityEngine_Object_TypeInfo);
    sub_1C6BA08(&Method_SyncWidget___c__Sync_b__8_0__);
    sub_1C6BA08(&SyncWidget___c_TypeInfo);
    byte_4CB7AB8 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(self, 0, 0) )
  {
        ...
        & 1) == 0 )
    {
      ...
      if ( !_9__8_0 )
      {
        ...
        _9__8_0 = (System_Action_object__o *)sub_1C6BC54(System_Action_Action__TypeInfo);
        ...
        sub_1C6B9AC((CGThumbnailListItem_o *)&static_fields->__9__8_0, (int32_t)_9__8_0, v10, v11);
      }
      BasicHelper__ForEach_object_(
        syncActionArray,
        (System_Action_T__o *)_9__8_0,
        (const MethodInfo_3127050 *)Method_BasicHelper_ForEach_Action___);
    }
  }
}
...
void SyncWidget__SyncColorAlpha(SyncWidget_o *this, const MethodInfo *method)
{
  ...
  if ( !byte_4CAFC0D )
  {
    this = (SyncWidget_o *)sub_1C6BA08(&UnityEngine_Mathf_TypeInfo);
    byte_4CAFC0D = 1;
  }
  v10 = fabsf(a);
  v11 = fabsf(v9);
...
void SyncWidget___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C6BC54(SyncWidget___c_TypeInfo);
  System_Object___ctor(v1, 0);
  SyncWidget___c_TypeInfo->static_fields->__9 = (struct SyncWidget___c_o *)v1;
  sub_1C6B9AC((CGThumbnailListItem_o *)SyncWidget___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
