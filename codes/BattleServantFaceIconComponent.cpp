void __fastcall BattleServantFaceIconComponent___ctor(BattleServantFaceIconComponent_o *this, const MethodInfo *method)
{
  if ( (byte_48E1CA8 & 1) == 0 )
  {
    sub_1B00CCC(&ServantFaceIconComponent_TypeInfo, method);
    byte_48E1CA8 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E1CA7 & 1) == 0 )
  {
    sub_1B00CCC(&UnityEngine_Object_TypeInfo, widget);
    byte_48E1CA7 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E1CA6 & 1) == 0 )
  {
    sub_1B00CCC(&int_TypeInfo, *(_QWORD *)&dropNum);
    sub_1B00CCC(&StringLiteral_24794/*"×{0}"*/, v7);
    this = (BattleServantFaceIconComponent_o *)sub_1B00CCC(&StringLiteral_1/*""*/, v8);
    byte_48E1CA6 = 1;
  }
...
LABEL_8:
    sub_1B00F28(this, *(_QWORD *)&dropNum);
  }
  v11 = dropNum;
  v10 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v11, method, v3, v4);
  this = (BattleServantFaceIconComponent_o *)System_String__Format((System_String_o *)StringLiteral_24794/*"×{0}"*/, v10, 0LL);
  if ( !dropNumLabel )
    goto LABEL_8;
...
void __fastcall BattleServantFaceIconComponent__SetSvtDrop_36872656(
        BattleServantFaceIconComponent_o *this,
        int64_t userSvtId,
