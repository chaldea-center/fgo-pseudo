void __fastcall BattleServantFaceIconComponent___ctor(BattleServantFaceIconComponent_o *this, const MethodInfo *method)
{
  if ( (byte_4BFCB5F & 1) == 0 )
  {
    sub_1C2E12C(&ServantFaceIconComponent_TypeInfo, method);
    byte_4BFCB5F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFCB5E & 1) == 0 )
  {
    sub_1C2E12C(&UnityEngine_Object_TypeInfo, widget);
    byte_4BFCB5E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFCB5D & 1) == 0 )
  {
    sub_1C2E12C(&int_TypeInfo, *(_QWORD *)&dropNum);
    sub_1C2E12C(&StringLiteral_25639/*"×{0}"*/, v7);
    this = (BattleServantFaceIconComponent_o *)sub_1C2E12C(&StringLiteral_1/*""*/, v8);
    byte_4BFCB5D = 1;
  }
...
LABEL_8:
    sub_1C2E388(this, *(_QWORD *)&dropNum);
  }
  v11 = dropNum;
  v10 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v11, method, v3, v4);
  this = (BattleServantFaceIconComponent_o *)System_String__Format((System_String_o *)StringLiteral_25639/*"×{0}"*/, v10, 0LL);
  if ( !dropNumLabel )
    goto LABEL_8;
...
void __fastcall BattleServantFaceIconComponent__SetSvtDrop_39392892(
        BattleServantFaceIconComponent_o *this,
        int64_t userSvtId,
