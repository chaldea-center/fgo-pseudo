void __fastcall BattleServantFaceIconComponent___ctor(BattleServantFaceIconComponent_o *this, const MethodInfo *method)
{
  if ( (byte_49FB87E & 1) == 0 )
  {
    sub_1B640C8(&ServantFaceIconComponent_TypeInfo, method);
    byte_49FB87E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB87D & 1) == 0 )
  {
    sub_1B640C8(&UnityEngine_Object_TypeInfo, widget);
    byte_49FB87D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB87C & 1) == 0 )
  {
    sub_1B640C8(&int_TypeInfo, *(_QWORD *)&dropNum);
    sub_1B640C8(&StringLiteral_25062/*"×{0}"*/, v5);
    this = (BattleServantFaceIconComponent_o *)sub_1B640C8(&StringLiteral_1/*""*/, v6);
    byte_49FB87C = 1;
  }
...
LABEL_8:
  ...
  this = (BattleServantFaceIconComponent_o *)System_String__Format((System_String_o *)StringLiteral_25062/*"×{0}"*/, v8, 0LL);
  if ( !dropNumLabel )
    goto LABEL_8;
...
void __fastcall BattleServantFaceIconComponent__SetSvtDrop_37764784(
        BattleServantFaceIconComponent_o *this,
        int64_t userSvtId,
