        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4F3AA & 1) == 0 )
  {
    sub_1B863B8(&Method_DataManager_GetMasterData_UserCommandCodeMaster___, collectList);
    sub_1B863B8(&Method_DataMasterBase_UserCommandCodeMaster__UserCommandCodeEntity__long__isEntityExistsFromId__, v5);
    ...
    sub_1B863B8(&Method_System_Collections_Generic_List_long__GetEnumerator__, v11);
...
LABEL_29:
        ...
        if ( (__int64)v19 >= 1 )
        {
          ...
          Instance = (Il2CppObject *)DataMasterBase_object__object__long___isEntityExistsFromId(
                                       ...
                                       (const MethodInfo_3215DB8 *)Method_DataMasterBase_UserCommandCodeMaster__UserCommandCodeEntity__long__isEntityExistsFromId__);
        ...
        const MethodInfo *method)
{
  if ( (byte_4A4F3A8 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataEntityBase_CreateMultiplePK_long__long___, svtId);
    byte_4A4F3A8 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  *(_OWORD *)&v12.fields.fakeValue = v3;
  ...
  v11 = v12;
  v4 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_47437768(&v11, 0LL);
  ...
  *(_OWORD *)&v10.fields.fakeValue = v5;
  v7 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_47437768(&v10, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4F3A9 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataManager_GetMasterData_UserCommandCodeMaster___, *(_QWORD *)&index);
    sub_1B863B8(&Method_DataMasterBase_UserCommandCodeMaster__UserCommandCodeEntity__long__TryGetEntity__, v5);
    this = (UserServantCommandCodeEntity_o *)sub_1B863B8(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v6);
    byte_4A4F3A9 = 1;
  }
  entity = 0LL;
        ...
        const MethodInfo *method)
{
  if ( (byte_4A4F3AB & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Array_IndexOf_long___, commandCodeId);
    byte_4A4F3AB = 1;
  }
