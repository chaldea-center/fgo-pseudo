        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF09A & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_1532/*"80341001"*/, v5);
    byte_49FF09A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF09C & 1) == 0 )
  {
    sub_1B64870(&Method_EventInfoCooltimeNoticeButton_OnClickButton__, method);
    byte_49FF09C = 1;
  }
  ...
  if ( (*((_BYTE *)Method_EventInfoCooltimeNoticeButton_OnClickButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1B64888(Method_EventInfoCooltimeNoticeButton_OnClickButton__);
