        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EA8B & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_1531/*"80341001"*/, v5);
    byte_4A2EA8B = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EA8D & 1) == 0 )
  {
    sub_1B761C0(&Method_EventInfoCooltimeNoticeButton_OnClickButton__, method);
    byte_4A2EA8D = 1;
  }
  ...
  if ( (*((_BYTE *)Method_EventInfoCooltimeNoticeButton_OnClickButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1B761D8(Method_EventInfoCooltimeNoticeButton_OnClickButton__);
