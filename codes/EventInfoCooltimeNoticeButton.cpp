        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDCD88 & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_1533/*"80341001"*/);
    byte_4BDCD88 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(bgSprite, 0LL, 0LL) )
  {
    ...
    AtlasManager__SetEventUI(v6, (System_String_o *)StringLiteral_1533/*"80341001"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDCD8A & 1) == 0 )
  {
    sub_1C21E38(&Method_EventInfoCooltimeNoticeButton_OnClickButton__);
    byte_4BDCD8A = 1;
  }
  ...
  if ( (*((_BYTE *)Method_EventInfoCooltimeNoticeButton_OnClickButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1C21E50(Method_EventInfoCooltimeNoticeButton_OnClickButton__);
