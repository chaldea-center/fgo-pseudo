        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20619 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_1532/*"80341001"*/, v5);
    byte_4A20619 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2061B & 1) == 0 )
  {
    sub_1B715CC(&Method_EventInfoCooltimeNoticeButton_OnClickButton__, method);
    byte_4A2061B = 1;
  }
  ...
  if ( (*((_BYTE *)Method_EventInfoCooltimeNoticeButton_OnClickButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1B715E4(Method_EventInfoCooltimeNoticeButton_OnClickButton__);
