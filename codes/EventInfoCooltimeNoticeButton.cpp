        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A70819 & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_1532/*"80341001"*/, v5);
    byte_4A70819 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(bgSprite, 0LL, 0LL) )
  {
    ...
    AtlasManager__SetEventUI(v8, (System_String_o *)StringLiteral_1532/*"80341001"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A7081B & 1) == 0 )
  {
    sub_1B90010(&Method_EventInfoCooltimeNoticeButton_OnClickButton__, method);
    byte_4A7081B = 1;
  }
  ...
  if ( (*((_BYTE *)Method_EventInfoCooltimeNoticeButton_OnClickButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1B90028(Method_EventInfoCooltimeNoticeButton_OnClickButton__);
