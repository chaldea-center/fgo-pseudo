        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2DC65 & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_1437/*"80341001"*/);
    byte_4D2DC65 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(bgSprite, 0, 0) )
  {
    ...
    AtlasManager__SetEventUI(v6, (System_String_o *)StringLiteral_1437/*"80341001"*/, 0);
...
void EventInfoCooltimeNoticeButton__OnClickButton(EventInfoCooltimeNoticeButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2DC67 & 1) == 0 )
  {
    sub_1C94098(&Method_EventInfoCooltimeNoticeButton_OnClickButton__);
    byte_4D2DC67 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_EventInfoCooltimeNoticeButton_OnClickButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1C940B0(Method_EventInfoCooltimeNoticeButton_OnClickButton__);
