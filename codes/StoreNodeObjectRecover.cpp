void __fastcall StoreNodeObjectRecover___ctor(StoreNodeObjectRecover_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42AEDE3 & 1) == 0 )
  {
    sub_B52984(&Method_System_Collections_Generic_Dictionary_string__Action___ctor__);
    sub_B52984(&System_Collections_Generic_Dictionary_string__Action__TypeInfo);
    byte_42AEDE3 = 1;
  }
  v3 = (System_Collections_Generic_Dictionary_XmlQualifiedName__XmlSchemaObject__o *)sub_B52A54(System_Collections_Generic_Dictionary_string__Action__TypeInfo);
  System_Collections_Generic_Dictionary_XmlQualifiedName__XmlSchemaObject____ctor(
    v3,
    (const MethodInfo_2F1AC50 *)Method_System_Collections_Generic_Dictionary_string__Action___ctor__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AEDE1 & 1) == 0 )
  {
    sub_B52984(&Method_System_Collections_Generic_Dictionary_string__Action__set_Item__);
    sub_B52984(&Method_UnityEngine_GameObject_AddComponent_StoreNodeObjectRecover___);
    sub_B52984(&Method_UnityEngine_GameObject_GetComponent_StoreNodeObjectRecover___);
    gameObject = (UnityEngine_GameObject_o *)sub_B52984(&UnityEngine_Object_TypeInfo);
    byte_42AEDE1 = 1;
  }
  if ( !v6 )
    goto LABEL_13;
  Component_srcLineSprite = UnityEngine_GameObject__GetComponent_srcLineSprite_(
                              v6,
                              (const MethodInfo_1B7B1B8 *)Method_UnityEngine_GameObject_GetComponent_StoreNodeObjectRecover___);
  ...
  if ( ((unsigned __int8)gameObject & 1) != 0 )
  {
    gameObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__AddComponent_UnitySynchronizationContext_SynchronizationContextBehavoir_(
                                               v6,
                                               (const MethodInfo_1B7B0BC *)Method_UnityEngine_GameObject_AddComponent_StoreNodeObjectRecover___);
  ...
  {
LABEL_13:
    sub_B52A5C(gameObject, storeObject);
  }
  System_Collections_Generic_Dictionary_XmlQualifiedName__XmlSchemaObject___set_Item(
    ...
    (const MethodInfo_2F1B7D8 *)Method_System_Collections_Generic_Dictionary_string__Action__set_Item__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AEDE2 & 1) == 0 )
  {
    sub_B52984(&Method_System_Collections_Generic_Dictionary_string__Action__ContainsKey__);
    sub_B52984(&Method_System_Collections_Generic_Dictionary_string__Action__get_Item__);
    byte_42AEDE2 = 1;
  }
  ...
  if ( !System_Collections_Generic_Dictionary_XmlQualifiedName__XmlSchemaObject___ContainsKey(
          ...
          (const MethodInfo_2F1BA74 *)Method_System_Collections_Generic_Dictionary_string__Action__ContainsKey__) )
    return;
  recoverPairDictionary = this->fields.recoverPairDictionary;
  if ( !recoverPairDictionary )
LABEL_9:
    sub_B52A5C(recoverPairDictionary, recoverTargetVarName);
  Item = (System_Action_o *)System_Collections_Generic_Dictionary_Type__IStoreExtension___get_Item(
                              ...
                              (const MethodInfo_2F1B73C *)Method_System_Collections_Generic_Dictionary_string__Action__get_Item__);
  if ( Item )
