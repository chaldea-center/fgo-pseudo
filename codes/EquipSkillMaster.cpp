void __fastcall EquipSkillMaster___ctor(EquipSkillMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42EB855 & 1) == 0 )
  {
    sub_B5D5C4(&Method_DataMasterBase_EquipSkillMaster__EquipSkillEntity__string___ctor__, (_DWORD)method, v2, v3);
    byte_42EB855 = 1;
  }
  DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string____ctor(
    (DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string__o *)this,
    48,
    (const MethodInfo_23FB1C4 *)Method_DataMasterBase_EquipSkillMaster__EquipSkillEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EB853 & 1) == 0 )
  {
    sub_B5D5C4(&Method_DataMasterBase_EquipSkillMaster__EquipSkillEntity__string__GetEntity__, equipId, num, method);
    byte_42EB853 = 1;
  }
  ...
  return (EquipSkillEntity_o *)DataMasterBase_WarMessageMaster__WarMessageEntity__string___GetEntity(
                                 ...
                                 PK,
                                 (const MethodInfo_23FB260 *)Method_DataMasterBase_EquipSkillMaster__EquipSkillEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  return DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string___TryGetEntity(
           ...
           PK,
           (const MethodInfo_23FB2B8 *)Method_DataMasterBase_EquipSkillMaster__EquipSkillEntity__string__TryGetEntity__);
}