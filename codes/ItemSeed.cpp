...
UnityEngine_Vector3_o ItemSeed__GetPosition(ItemSeed_o *this, const MethodInfo *method)
{
  ...
  if ( !transform )
    sub_1C6BC60(0, v3);
  return UnityEngine_Transform__TransformPoint_71686456(transform, 0.0, 0.0, 0.0, 0);
}
...
void ItemSeed__SetTransform(ItemSeed_o *this, UnityEngine_GameObject_o *obj, const MethodInfo *method)
{
  ...
  if ( (byte_4CB7A07 & 1) == 0 )
  {
    this = (ItemSeed_o *)sub_1C6BA08(&StringLiteral_12790/*"SetBaseTransform"*/);
    byte_4CB7A07 = 1;
  }
  if ( !obj )
    goto LABEL_10;
