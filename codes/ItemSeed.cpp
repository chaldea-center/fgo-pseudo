...
UnityEngine_Vector3_o ItemSeed__GetPosition(ItemSeed_o *this, const MethodInfo *method)
{
  ...
  if ( !transform )
    sub_1D0F30C(0, v3);
  return UnityEngine_Transform__TransformPoint_73386264(transform, 0.0, 0.0, 0.0, 0);
}
...
void ItemSeed__SetTransform(ItemSeed_o *this, UnityEngine_GameObject_o *obj, const MethodInfo *method)
{
  ...
  if ( (byte_4E78DAD & 1) == 0 )
  {
    this = (ItemSeed_o *)sub_1D0F0B4(&StringLiteral_12972/*"SetBaseTransform"*/);
    byte_4E78DAD = 1;
  }
  if ( !obj )
    goto LABEL_10;
