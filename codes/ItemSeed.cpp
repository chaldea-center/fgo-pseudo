...
UnityEngine_Vector3_o ItemSeed__GetPosition(ItemSeed_o *this, const MethodInfo *method)
{
  ...
  if ( !transform )
    sub_1CE6958(0, v3);
  return UnityEngine_Transform__TransformPoint_72945320(transform, 0.0, 0.0, 0.0, 0);
}
...
void ItemSeed__SetTransform(ItemSeed_o *this, UnityEngine_GameObject_o *obj, const MethodInfo *method)
{
  ...
  if ( (byte_4E06106 & 1) == 0 )
  {
    this = (ItemSeed_o *)sub_1CE6700(&StringLiteral_12922/*"SetBaseTransform"*/);
    byte_4E06106 = 1;
  }
  if ( !obj )
    goto LABEL_10;
