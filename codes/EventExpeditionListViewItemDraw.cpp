...
void EventExpeditionListViewItemDraw__Awake(EventExpeditionListViewItemDraw_o *this, const MethodInfo *method)
{
  ...
  if ( ((unsigned __int8)Parent & 1) != 0 )
  {
    ...
    Parent = (UnityEngine_Component_o *)sub_1D0F058(&this->fields.baseAtlas, mAtlas);
...
void EventExpeditionListViewItemDraw__DestroyAnimObj(EventExpeditionListViewItemDraw_o *this, const MethodInfo *method)
{
  ...
  if ( !effectParent )
LABEL_37:
    sub_1D0F30C(effectParent, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E716F4 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    sub_1D0F0B4(&StringLiteral_17532/*"bit_runningdog_{0}_1"*/);
    byte_4E716F4 = 1;
  }
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  ...
  sub_1D0F058(&this->fields.runAnim, Component_object);
  ...
  if ( !v12
    || (UnityEngine_Transform__set_localScale(v12, UnityEngine_Vector3_TypeInfo->static_fields->oneVector, 0),
        ...
        gameObject = (UnityEngine_GameObject_o *)System_String__Format((System_String_o *)StringLiteral_17532/*"bit_runningdog_{0}_1"*/, v14, 0),
        !runAnim) )
  {
LABEL_16:
    sub_1D0F30C(gameObject, v8);
  }
  UnityEngine_Animation__Play_73101556(runAnim, (System_String_o *)gameObject, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E716F7 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_13609/*"TIME_REST_NONE"*/);
    sub_1D0F0B4(&StringLiteral_5878/*"EXPEDITION_TIME_REST"*/);
    this = (EventExpeditionListViewItemDraw_o *)sub_1D0F0B4(&StringLiteral_1/*""*/);
    byte_4E716F7 = 1;
  }
  entity = 0;
  if ( !item )
  ...
  if ( item->fields.currentEventId >= 1 )
  {
    ...
    this = (EventExpeditionListViewItemDraw_o *)DataManager__GetMaster_object_((const MethodInfo_324F164 *)Method_DataManager_GetMaster_EventMaster___);
    if ( !this )
      goto LABEL_26;
           ...
           (const MethodInfo_3535BC8 *)Method_DataMasterBase_EventMaster__EventEntity__int__TryGetEntity__) )
    {
      ...
      if ( entity )
      {
        ...
        if ( (__int64)this >= (__int64)entity[6].klass )
        {
          if ( eventPeriodRestText )
          {
            ...
            this = (EventExpeditionListViewItemDraw_o *)LocalizationManager__Get(
                                                          (System_String_o *)StringLiteral_13609/*"TIME_REST_NONE"*/,
                                                          0);
        ...
        else
        {
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          this = (EventExpeditionListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5878/*"EXPEDITION_TIME_REST"*/, 0);
          if ( eventPeriodRestText )
          {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E716F2 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_EventExpeditionListViewItemDraw___c__SetItem_b__27_0__);
    sub_1D0F0B4(&EventExpeditionListViewItemDraw___c_TypeInfo);
    sub_1D0F0B4(&StringLiteral_23919/*"shop_item_menu_{0}_2"*/);
    sub_1D0F0B4(&StringLiteral_23918/*"shop_item_menu_mask"*/);
    sub_1D0F0B4(&StringLiteral_19530/*"event_gauge_back"*/);
    sub_1D0F0B4(&StringLiteral_19537/*"event_gauge_front"*/);
    sub_1D0F0B4(&StringLiteral_5875/*"EXPEDITION_REWARD_TITLE_LABEL"*/);
    sub_1D0F0B4(&StringLiteral_5867/*"EXPEDITION_EVENT_END"*/);
    sub_1D0F0B4(&StringLiteral_1/*""*/);
    this = (EventExpeditionListViewItemDraw_o *)sub_1D0F0B4(&StringLiteral_19538/*"event_gauge_front_complete"*/);
    byte_4E716F2 = 1;
  }
  if ( item && mode )
  {
    ...
    v13 = System_String__Format((System_String_o *)StringLiteral_23919/*"shop_item_menu_{0}_2"*/, v12, 0);
    ...
    this = (EventExpeditionListViewItemDraw_o *)AtlasManager__SetEventUI_41967144(
                                                  v14,
                                                  maskSprite,
                                                  (System_String_o *)StringLiteral_23918/*"shop_item_menu_mask"*/,
                                                  0);
    ...
    AtlasManager__SetEventUI_41967144(v18, placeIconSprite, v19, 0);
    AtlasManager__SetEventUI_41967144(
      item->fields.currentEventId,
      v6->fields.progressGaugeF,
      (System_String_o *)StringLiteral_19537/*"event_gauge_front"*/,
      0);
    this = (EventExpeditionListViewItemDraw_o *)AtlasManager__SetEventUI_41967144(
                                                  item->fields.currentEventId,
                                                  v6->fields.progressGaugeB,
                                                  (System_String_o *)StringLiteral_19530/*"event_gauge_back"*/,
                                                  0);
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    this = (EventExpeditionListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5875/*"EXPEDITION_REWARD_TITLE_LABEL"*/, 0);
    if ( !rewardTitleLabel )
      goto LABEL_69;
    ...
    this = (EventExpeditionListViewItemDraw_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3BAC684 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !this )
      goto LABEL_69;
    ...
    if ( !_9__27_0 )
    {
      ...
      _9__27_0 = (System_Comparison_T__o *)sub_1D0F300(System_Comparison_GiftEntity__TypeInfo);
      ...
      this = (EventExpeditionListViewItemDraw_o *)sub_1D0F058(&static_fields->__9__27_0, _9__27_0);
    }
    if ( !v27 )
LABEL_69:
      sub_1D0F30C(this, item);
...
LABEL_49:
        ...
        v6->fields.runAnim = 0;
        sub_1D0F058(&v6->fields.runAnim, 0);
        break;
      case 3:
        goto LABEL_54;
      case 4:
        ...
        if ( !AtlasManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
        AtlasManager__SetEventUI_41967144(v37, progressGaugeF, (System_String_o *)StringLiteral_19538/*"event_gauge_front_complete"*/, 0);
LABEL_54:
        this = (EventExpeditionListViewItemDraw_o *)v6->fields.MaskObj;
        if ( !this )
          goto LABEL_69;
          ...
          if ( this )
          {
            ...
            if ( this )
            {
              ...
              if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
              this = (EventExpeditionListViewItemDraw_o *)LocalizationManager__Get(
                                                            (System_String_o *)StringLiteral_5867/*"EXPEDITION_EVENT_END"*/,
                                                            0);
              if ( eventEndText )
              {
                v39 = this;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E716F3 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    sub_1D0F0B4(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    sub_1D0F0B4(&StringLiteral_5852/*"EXPEDITION_BEST_MATCH_LABEL"*/);
    sub_1D0F0B4(&StringLiteral_17532/*"bit_runningdog_{0}_1"*/);
    sub_1D0F0B4(&StringLiteral_5854/*"EXPEDITION_COMPLETE_LABEL"*/);
    sub_1D0F0B4(&StringLiteral_17533/*"bit_runningdog_{0}_2"*/);
    sub_1D0F0B4(&StringLiteral_13627/*"TIME_REST_TIMEOVER"*/);
    sub_1D0F0B4(&StringLiteral_1/*""*/);
    sub_1D0F0B4(&StringLiteral_19538/*"event_gauge_front_complete"*/);
    sub_1D0F0B4(&StringLiteral_5877/*"EXPEDITION_TIME_LABEL"*/);
    byte_4E716F3 = 1;
  }
  entity = 0;
  ...
  if ( mode == 3 )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(v20, 0, 0) )
    {
      ...
      if ( !UnityEngine_Animation__get_isPlaying((UnityEngine_Animation_o *)ExpeditionInfo, 0) )
      {
        ...
        ExpeditionInfo = System_String__Format((System_String_o *)StringLiteral_17532/*"bit_runningdog_{0}_1"*/, v22, 0);
        if ( !v21 )
          goto LABEL_95;
        UnityEngine_Animation__Play_73101556(v21, (System_String_o *)ExpeditionInfo, 0);
      }
    }
  }
  ...
  {
LABEL_95:
    sub_1D0F30C(ExpeditionInfo, v11);
  }
...
LABEL_93:
  ...
  ExpeditionInfo = LocalizationManager__Get((System_String_o *)StringLiteral_13627/*"TIME_REST_TIMEOVER"*/, 0);
  if ( !RestTime )
    goto LABEL_95;
  v25 = System_String__Equals_65598092(RestTime, (System_String_o *)ExpeditionInfo, 0);
  if ( v12 >= 1 && v25 )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(v28, 0, 0) )
    {
      ...
      ExpeditionInfo = System_String__Format((System_String_o *)StringLiteral_17533/*"bit_runningdog_{0}_2"*/, v31, 0);
      if ( !v30 )
        goto LABEL_95;
      UnityEngine_Animation__Play_73101556(v30, (System_String_o *)ExpeditionInfo, 0);
    }
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  ...
  ExpeditionInfo = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3BAC684 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !ExpeditionInfo )
    goto LABEL_95;
         ...
         0) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    ExpeditionInfo = LocalizationManager__Get((System_String_o *)StringLiteral_5877/*"EXPEDITION_TIME_LABEL"*/, 0);
    if ( !entity )
      goto LABEL_95;
    ...
    ExpeditionTimeLabel = (Il2CppObject *)EventExpeditionListViewItemDraw__GetExpeditionTimeLabel(
                                            ...
                                            v36,
                                            v41);
    ExpeditionInfo = System_String__Format_65604080(v43, name, ExpeditionTimeLabel, 0);
    if ( !timeLeftLabel )
      goto LABEL_95;
    ...
    if ( ((unsigned __int8)ExpeditionInfo & 1) != 0 )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v51 = LocalizationManager__Get((System_String_o *)StringLiteral_5852/*"EXPEDITION_BEST_MATCH_LABEL"*/, 0);
      v52 = System_String__Concat_65562772(mText, v51, 0);
  ...
  if ( !v54 )
    goto LABEL_95;
  if ( System_String__Equals_65598092(v54, (System_String_o *)ExpeditionInfo, 0) )
  {
    ...
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetEventUI_41967144(v55, progressGaugeF, (System_String_o *)StringLiteral_19538/*"event_gauge_front_complete"*/, 0);
    v57 = this->fields.timeLeftLabel;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    ExpeditionInfo = LocalizationManager__Get((System_String_o *)StringLiteral_5854/*"EXPEDITION_COMPLETE_LABEL"*/, 0);
    if ( !v57 )
      goto LABEL_95;
...
void EventExpeditionListViewItemDraw___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1D0F300(EventExpeditionListViewItemDraw___c_TypeInfo);
  System_Object___ctor(v1, 0);
  EventExpeditionListViewItemDraw___c_TypeInfo->static_fields->__9 = (struct EventExpeditionListViewItemDraw___c_o *)v1;
  sub_1D0F058(EventExpeditionListViewItemDraw___c_TypeInfo->static_fields, v1);
}
