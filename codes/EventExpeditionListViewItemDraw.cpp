  ...
  if ( UnityEngine_Object__op_Inequality(timeLeftLabel, 0LL, 0LL) )
  {
    ...
    if ( Parent )
    {
      ...
      if ( Parent )
      {
        ...
        sub_1B76164((ServantStatusBattleListViewItem_o *)p_MaskObj, (int32_t)v16, v18, v19);
        ...
        const MethodInfo *method)
{
  ...
  if ( !effectParent )
LABEL_37:
    sub_1B7641C(effectParent, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31BF9 & 1) == 0 )
  {
    sub_1B761C0(&Method_UnityEngine_GameObject_GetComponent_Animation___, effect);
    ...
    sub_1B761C0(&StringLiteral_17302/*"bit_runningdog_{0}_1"*/, v10);
    byte_4A31BF9 = 1;
  }
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.runAnim, (int32_t)Component_object, v15, v16);
  ...
  if ( !byte_4A28BB1 )
  {
    gameObject = (UnityEngine_GameObject_o *)sub_1B761C0(&UnityEngine_Vector3_TypeInfo, v12);
    byte_4A28BB1 = 1;
  }
  if ( !v17 )
    goto LABEL_16;
  ...
  if ( !v18
    || (UnityEngine_Transform__set_localScale(v18, UnityEngine_Vector3_TypeInfo->static_fields->oneVector, 0LL),
        ...
        gameObject = (UnityEngine_GameObject_o *)System_String__Format((System_String_o *)StringLiteral_17302/*"bit_runningdog_{0}_1"*/, v23, 0LL),
        !runAnim) )
  {
LABEL_16:
    sub_1B7641C(gameObject, v12);
  }
  UnityEngine_Animation__Play_69032500(runAnim, (System_String_o *)gameObject, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31BFC & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMaster_EventMaster___, item);
    ...
    sub_1B761C0(&StringLiteral_13325/*"TIME_REST_NONE"*/, v9);
    sub_1B761C0(&StringLiteral_5784/*"EXPEDITION_TIME_REST"*/, v10);
    this = (EventExpeditionListViewItemDraw_o *)sub_1B761C0(&StringLiteral_1/*""*/, v11);
    byte_4A31BFC = 1;
  }
  entity = 0LL;
  if ( !item )
  ...
  if ( item->fields.currentEventId >= 1 )
  {
    ...
    this = (EventExpeditionListViewItemDraw_o *)DataManager__GetMaster_object_((const MethodInfo_2E623B4 *)Method_DataManager_GetMaster_EventMaster___);
    if ( !this )
      goto LABEL_26;
      ...
      if ( entity )
      {
        ...
        if ( (__int64)this >= (__int64)entity[6].klass )
        {
          if ( eventPeriodRestText )
          {
            ...
            this = (EventExpeditionListViewItemDraw_o *)LocalizationManager__Get(
                                                          (System_String_o *)StringLiteral_13325/*"TIME_REST_NONE"*/,
                                                          0LL);
        ...
        else
        {
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          this = (EventExpeditionListViewItemDraw_o *)LocalizationManager__Get(
                                                        (System_String_o *)StringLiteral_5784/*"EXPEDITION_TIME_REST"*/,
                                                        0LL);
          if ( eventPeriodRestText )
          {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31BF7 & 1) == 0 )
  {
    ...
    sub_1B761C0(&System_Comparison_GiftEntity__TypeInfo, v8);
    sub_1B761C0(&Method_DataManager_GetMasterData_GiftMaster___, v9);
    sub_1B761C0(&EventRewardRootComponent_TypeInfo, v10);
    sub_1B761C0(&int_TypeInfo, v11);
    sub_1B761C0(&Method_System_Collections_Generic_List_GiftEntity__Sort__, v12);
    sub_1B761C0(&Method_System_Collections_Generic_List_GiftEntity__get_Count__, v13);
    sub_1B761C0(&Method_System_Collections_Generic_List_GiftEntity__get_Item__, v14);
    sub_1B761C0(&LocalizationManager_TypeInfo, v15);
    sub_1B761C0(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v16);
    sub_1B761C0(&Method_EventExpeditionListViewItemDraw___c__SetItem_b__27_0__, v17);
    sub_1B761C0(&EventExpeditionListViewItemDraw___c_TypeInfo, v18);
    sub_1B761C0(&StringLiteral_23266/*"shop_item_menu_{0}_2"*/, v19);
    sub_1B761C0(&StringLiteral_23265/*"shop_item_menu_mask"*/, v20);
    sub_1B761C0(&StringLiteral_19169/*"event_gauge_back"*/, v21);
    sub_1B761C0(&StringLiteral_19176/*"event_gauge_front"*/, v22);
    sub_1B761C0(&StringLiteral_5781/*"EXPEDITION_REWARD_TITLE_LABEL"*/, v23);
    sub_1B761C0(&StringLiteral_5773/*"EXPEDITION_EVENT_END"*/, v24);
    sub_1B761C0(&StringLiteral_1/*""*/, v25);
    this = (EventExpeditionListViewItemDraw_o *)sub_1B761C0(&StringLiteral_19177/*"event_gauge_front_complete"*/, v26);
    byte_4A31BF7 = 1;
  }
  if ( item && mode )
  {
    ...
    v33 = System_String__Format((System_String_o *)StringLiteral_23266/*"shop_item_menu_{0}_2"*/, v32, 0LL);
    ...
    this = (EventExpeditionListViewItemDraw_o *)AtlasManager__SetEventUI_37679488(
                                                  v34,
                                                  maskSprite,
                                                  (System_String_o *)StringLiteral_23265/*"shop_item_menu_mask"*/,
                                                  0LL);
    ...
    AtlasManager__SetEventUI_37679488(v38, placeIconSprite, v39, 0LL);
    AtlasManager__SetEventUI_37679488(
      item->fields.currentEventId,
      v7->fields.progressGaugeF,
      (System_String_o *)StringLiteral_19176/*"event_gauge_front"*/,
      0LL);
    this = (EventExpeditionListViewItemDraw_o *)AtlasManager__SetEventUI_37679488(
                                                  item->fields.currentEventId,
                                                  v7->fields.progressGaugeB,
                                                  (System_String_o *)StringLiteral_19169/*"event_gauge_back"*/,
                                                  0LL);
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    this = (EventExpeditionListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5781/*"EXPEDITION_REWARD_TITLE_LABEL"*/, 0LL);
    if ( !rewardTitleLabel )
      goto LABEL_69;
    ...
    this = (EventExpeditionListViewItemDraw_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_371257C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !this )
      goto LABEL_69;
    ...
    if ( !_9__27_0 )
    {
      ...
      _9__27_0 = (System_Comparison_T__o *)sub_1B7640C(System_Comparison_GiftEntity__TypeInfo);
      ...
      sub_1B76164((ServantStatusBattleListViewItem_o *)&static_fields->__9__27_0, (int32_t)_9__27_0, v52, v53);
    }
    if ( !v47 )
LABEL_69:
      sub_1B7641C(this, item);
    ...
    if ( v47->fields._size >= 1 )
    {
      ...
      if ( !this )
        goto LABEL_69;
      v56 = v55[7] <= 1 ? -1 : v55[7];
      ItemIconComponent__SetGift_37964100((ItemIconComponent_o *)this, v55[5], v55[6], v56, 0, 0LL);
...
LABEL_49:
        ...
        sub_1B76164((ServantStatusBattleListViewItem_o *)&v7->fields.runAnim, 0, v57, v58);
        break;
      case 3:
        goto LABEL_54;
      case 4:
        ...
        if ( !AtlasManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
        AtlasManager__SetEventUI_37679488(v59, progressGaugeF, (System_String_o *)StringLiteral_19177/*"event_gauge_front_complete"*/, 0LL);
LABEL_54:
        this = (EventExpeditionListViewItemDraw_o *)v7->fields.MaskObj;
        if ( !this )
          goto LABEL_69;
          ...
          if ( this )
          {
            ...
            if ( this )
            {
              ...
              if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
              this = (EventExpeditionListViewItemDraw_o *)LocalizationManager__Get(
                                                            (System_String_o *)StringLiteral_5773/*"EXPEDITION_EVENT_END"*/,
                                                            0LL);
              if ( eventEndText )
              {
                v61 = this;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B761C0(&AtlasManager_TypeInfo, item);
    sub_1B761C0(&Method_DataManager_GetMasterData_EventExpeditionMaster___, v7);
    sub_1B761C0(&Method_DataManager_GetMasterData_EventExpeditionPieceMaster___, v8);
    ...
    sub_1B761C0(&StringLiteral_5758/*"EXPEDITION_BEST_MATCH_LABEL"*/, v14);
    sub_1B761C0(&StringLiteral_17302/*"bit_runningdog_{0}_1"*/, v15);
    sub_1B761C0(&StringLiteral_5760/*"EXPEDITION_COMPLETE_LABEL"*/, v16);
    sub_1B761C0(&StringLiteral_17303/*"bit_runningdog_{0}_2"*/, v17);
    sub_1B761C0(&StringLiteral_13343/*"TIME_REST_TIMEOVER"*/, v18);
    sub_1B761C0(&StringLiteral_1/*""*/, v19);
    sub_1B761C0(&StringLiteral_19177/*"event_gauge_front_complete"*/, v20);
    sub_1B761C0(&StringLiteral_5783/*"EXPEDITION_TIME_LABEL"*/, v21);
    byte_4A31BF8 = 1;
  }
  entity = 0LL;
  ...
  if ( mode == 3 )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(v37, 0LL, 0LL) )
    {
      ...
      if ( !UnityEngine_Animation__get_isPlaying((UnityEngine_Animation_o *)ExpeditionInfo, 0LL) )
      {
        ...
        ExpeditionInfo = System_String__Format((System_String_o *)StringLiteral_17302/*"bit_runningdog_{0}_1"*/, v42, 0LL);
        if ( !v41 )
          goto LABEL_95;
        UnityEngine_Animation__Play_69032500(v41, (System_String_o *)ExpeditionInfo, 0LL);
      }
    }
  }
  ...
  {
LABEL_95:
    sub_1B7641C(ExpeditionInfo, v26);
  }
...
LABEL_93:
  ...
  ExpeditionInfo = LocalizationManager__Get((System_String_o *)StringLiteral_13343/*"TIME_REST_TIMEOVER"*/, 0LL);
  if ( !RestTime )
    goto LABEL_95;
  v45 = System_String__Equals_61543376(RestTime, (System_String_o *)ExpeditionInfo, 0LL);
  if ( v27 >= 1 && v45 )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(v49, 0LL, 0LL) )
    {
      ...
      ExpeditionInfo = System_String__Format((System_String_o *)StringLiteral_17303/*"bit_runningdog_{0}_2"*/, v55, 0LL);
      if ( !v51 )
        goto LABEL_95;
      UnityEngine_Animation__Play_69032500(v51, (System_String_o *)ExpeditionInfo, 0LL);
    }
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  ...
  ExpeditionInfo = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_371257C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !ExpeditionInfo )
    goto LABEL_95;
         ...
         0LL) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    ExpeditionInfo = LocalizationManager__Get((System_String_o *)StringLiteral_5783/*"EXPEDITION_TIME_LABEL"*/, 0LL);
    if ( !entity )
      goto LABEL_95;
    ...
    ExpeditionTimeLabel = (Il2CppObject *)EventExpeditionListViewItemDraw__GetExpeditionTimeLabel(
                                            ...
                                            v60,
                                            v65);
    ExpeditionInfo = System_String__Format_61549432(v67, name, ExpeditionTimeLabel, 0LL);
    if ( !timeLeftLabel )
      goto LABEL_95;
    ...
    if ( ((unsigned __int8)ExpeditionInfo & 1) != 0 )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v75 = LocalizationManager__Get((System_String_o *)StringLiteral_5758/*"EXPEDITION_BEST_MATCH_LABEL"*/, 0LL);
      v76 = System_String__Concat_61535060(mText, v75, 0LL);
  ...
  if ( !v78 )
    goto LABEL_95;
  if ( System_String__Equals_61543376(v78, (System_String_o *)ExpeditionInfo, 0LL) )
  {
    ...
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetEventUI_37679488(v79, progressGaugeF, (System_String_o *)StringLiteral_19177/*"event_gauge_front_complete"*/, 0LL);
    v81 = this->fields.timeLeftLabel;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    ExpeditionInfo = LocalizationManager__Get((System_String_o *)StringLiteral_5760/*"EXPEDITION_COMPLETE_LABEL"*/, 0LL);
    if ( !v81 )
      goto LABEL_95;
...
void __fastcall EventExpeditionListViewItemDraw___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A31BFD & 1) == 0 )
  {
    sub_1B761C0(&EventExpeditionListViewItemDraw___c_TypeInfo, v1);
    byte_4A31BFD = 1;
  }
  v2 = (Il2CppObject *)sub_1B7640C(EventExpeditionListViewItemDraw___c_TypeInfo);
