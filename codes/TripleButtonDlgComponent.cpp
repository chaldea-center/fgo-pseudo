void __fastcall TripleButtonDlgComponent___ctor(TripleButtonDlgComponent_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.messagePosNormal.fields.x = xmmword_BA6990;
...
void __fastcall TripleButtonDlgComponent__Close(TripleButtonDlgComponent_o *this, const MethodInfo *method)
{
  ...
  TripleButtonDlgComponent__Close_37084440(this, 0LL, v2);
}


void __fastcall TripleButtonDlgComponent__Close_37084440(
        TripleButtonDlgComponent_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A07918 & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_TripleButtonDlgComponent_EndClose__, v5);
    byte_4A07918 = 1;
  }
...
void __fastcall TripleButtonDlgComponent__OnClickCancel(TripleButtonDlgComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0791B & 1) == 0 )
  {
    sub_1B686D4(&Method_TripleButtonDlgComponent_OnClickCancel__, method);
    byte_4A0791B = 1;
  }
  v3 = Method_TripleButtonDlgComponent_OnClickCancel__;
  if ( (*((_BYTE *)Method_TripleButtonDlgComponent_OnClickCancel__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B686EC(Method_TripleButtonDlgComponent_OnClickCancel__);
...
void __fastcall TripleButtonDlgComponent__OnClickMiddle(TripleButtonDlgComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0791A & 1) == 0 )
  {
    sub_1B686D4(&Method_TripleButtonDlgComponent_OnClickMiddle__, method);
    byte_4A0791A = 1;
  }
  v3 = Method_TripleButtonDlgComponent_OnClickMiddle__;
  if ( (*((_BYTE *)Method_TripleButtonDlgComponent_OnClickMiddle__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B686EC(Method_TripleButtonDlgComponent_OnClickMiddle__);
  v4 = (System_Reflection_MethodBase_o *)sub_1B686B8(v3, v3[4]);
...
void __fastcall TripleButtonDlgComponent__OnClickRight(TripleButtonDlgComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A07919 & 1) == 0 )
  {
    sub_1B686D4(&Method_TripleButtonDlgComponent_OnClickRight__, method);
    byte_4A07919 = 1;
  }
  v3 = Method_TripleButtonDlgComponent_OnClickRight__;
  if ( (*((_BYTE *)Method_TripleButtonDlgComponent_OnClickRight__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B686EC(Method_TripleButtonDlgComponent_OnClickRight__);
  v4 = (System_Reflection_MethodBase_o *)sub_1B686B8(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A07913 & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_TripleButtonDlgComponent_EndOpen__, v24);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0791C & 1) == 0 )
  {
    ...
    this = (TripleButtonDlgComponent_o *)sub_1B686D4(&StringLiteral_13192/*"TALKRESUME_CONFIRM_CANCEL"*/, v3);
    byte_4A0791C = 1;
  }
  ...
  v6 = LocalizationManager__Get((System_String_o *)StringLiteral_13192/*"TALKRESUME_CONFIRM_CANCEL"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0791D & 1) == 0 )
  {
    this = (TripleButtonDlgComponent_o *)sub_1B686D4(&Method_UnityEngine_Component_GetComponent_UIRect___, sprite);
    byte_4A0791D = 1;
  }
  if ( !sprite )
    goto LABEL_8;
  this = (TripleButtonDlgComponent_o *)UnityEngine_Component__GetComponent_object_(
                                         ...
                                         (const MethodInfo_2E407F4 *)Method_UnityEngine_Component_GetComponent_UIRect___);
  if ( !this )
    goto LABEL_8;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A07917 & 1) == 0 )
  {
    ...
    this = (TripleButtonDlgComponent_o *)sub_1B686D4(&UnityEngine_Object_TypeInfo, v6);
    byte_4A07917 = 1;
  }
  if ( !buttonObj )
    goto LABEL_10;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A07910 & 1) == 0 )
  {
    sub_1B686D4(&TripleButtonDlgComponent_CallbackFunc_TypeInfo, value);
    byte_4A07910 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19AF71C;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19AF6D4;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0791F & 1) == 0 )
  {
    sub_1B686D4(&TripleButtonDlgComponent_ResultClicked_TypeInfo, *(_QWORD *)&result);
    byte_4A0791F = 1;
  }
  v9[1] = 0LL;
