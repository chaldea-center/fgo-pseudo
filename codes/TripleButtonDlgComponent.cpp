void __fastcall TripleButtonDlgComponent___ctor(TripleButtonDlgComponent_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.messagePosNormal.fields.x = xmmword_BC3220;
...
void __fastcall TripleButtonDlgComponent__Close(TripleButtonDlgComponent_o *this, const MethodInfo *method)
{
  ...
  TripleButtonDlgComponent__Close_38352056(this, 0LL, v2);
}


void __fastcall TripleButtonDlgComponent__Close_38352056(
        TripleButtonDlgComponent_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4D19F & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_TripleButtonDlgComponent_EndClose__, v5);
    byte_4A4D19F = 1;
  }
...
void __fastcall TripleButtonDlgComponent__OnClickCancel(TripleButtonDlgComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4D1A2 & 1) == 0 )
  {
    sub_1B863B8(&Method_TripleButtonDlgComponent_OnClickCancel__, method);
    byte_4A4D1A2 = 1;
  }
  v3 = Method_TripleButtonDlgComponent_OnClickCancel__;
  if ( (*((_BYTE *)Method_TripleButtonDlgComponent_OnClickCancel__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B863D0(Method_TripleButtonDlgComponent_OnClickCancel__);
...
void __fastcall TripleButtonDlgComponent__OnClickMiddle(TripleButtonDlgComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4D1A1 & 1) == 0 )
  {
    sub_1B863B8(&Method_TripleButtonDlgComponent_OnClickMiddle__, method);
    byte_4A4D1A1 = 1;
  }
  v3 = Method_TripleButtonDlgComponent_OnClickMiddle__;
  if ( (*((_BYTE *)Method_TripleButtonDlgComponent_OnClickMiddle__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B863D0(Method_TripleButtonDlgComponent_OnClickMiddle__);
  v4 = (System_Reflection_MethodBase_o *)sub_1B8639C(v3, v3[4]);
...
void __fastcall TripleButtonDlgComponent__OnClickRight(TripleButtonDlgComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4D1A0 & 1) == 0 )
  {
    sub_1B863B8(&Method_TripleButtonDlgComponent_OnClickRight__, method);
    byte_4A4D1A0 = 1;
  }
  v3 = Method_TripleButtonDlgComponent_OnClickRight__;
  if ( (*((_BYTE *)Method_TripleButtonDlgComponent_OnClickRight__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B863D0(Method_TripleButtonDlgComponent_OnClickRight__);
  v4 = (System_Reflection_MethodBase_o *)sub_1B8639C(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4D19A & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_TripleButtonDlgComponent_EndOpen__, v24);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4D1A3 & 1) == 0 )
  {
    ...
    this = (TripleButtonDlgComponent_o *)sub_1B863B8(&StringLiteral_13116/*"TALKRESUME_CONFIRM_CANCEL"*/, v3);
    byte_4A4D1A3 = 1;
  }
  ...
  v6 = LocalizationManager__Get((System_String_o *)StringLiteral_13116/*"TALKRESUME_CONFIRM_CANCEL"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4D1A4 & 1) == 0 )
  {
    this = (TripleButtonDlgComponent_o *)sub_1B863B8(&Method_UnityEngine_Component_GetComponent_UIRect___, sprite);
    byte_4A4D1A4 = 1;
  }
  if ( !sprite )
    goto LABEL_8;
  this = (TripleButtonDlgComponent_o *)UnityEngine_Component__GetComponent_object_(
                                         ...
                                         (const MethodInfo_2F646C0 *)Method_UnityEngine_Component_GetComponent_UIRect___);
  if ( !this )
    goto LABEL_8;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4D19E & 1) == 0 )
  {
    ...
    this = (TripleButtonDlgComponent_o *)sub_1B863B8(&UnityEngine_Object_TypeInfo, v6);
    byte_4A4D19E = 1;
  }
  if ( !buttonObj )
    goto LABEL_10;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4D197 & 1) == 0 )
  {
    sub_1B863B8(&TripleButtonDlgComponent_CallbackFunc_TypeInfo, value);
    byte_4A4D197 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4D19D & 1) == 0 )
  {
    sub_1B863B8(&Method_UnityEngine_GameObject_GetComponent_UICommonButton___, disabled);
...
LABEL_10:
    sub_1B86614(middleBtn, disabled);
  }
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19D1CF0;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19D1CA8;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4D1A6 & 1) == 0 )
  {
    sub_1B863B8(&TripleButtonDlgComponent_ResultClicked_TypeInfo, *(_QWORD *)&result);
    byte_4A4D1A6 = 1;
  }
  v9[1] = 0LL;
