void __fastcall TripleButtonDlgComponent___ctor(TripleButtonDlgComponent_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.messagePosNormal.fields.x = xmmword_BE26F0;
...
void __fastcall TripleButtonDlgComponent__Close(TripleButtonDlgComponent_o *this, const MethodInfo *method)
{
  ...
  TripleButtonDlgComponent__Close_39320584(this, 0LL, v2);
}


void __fastcall TripleButtonDlgComponent__Close_39320584(
        TripleButtonDlgComponent_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B18D & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_TripleButtonDlgComponent_EndClose__, v5);
    byte_4B1B18D = 1;
  }
...
void __fastcall TripleButtonDlgComponent__OnClickCancel(TripleButtonDlgComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1B190 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_TripleButtonDlgComponent_OnClickCancel__, method);
    byte_4B1B190 = 1;
  }
  v3 = Method_TripleButtonDlgComponent_OnClickCancel__;
  if ( (*((_BYTE *)Method_TripleButtonDlgComponent_OnClickCancel__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1BCB010(Method_TripleButtonDlgComponent_OnClickCancel__);
...
void __fastcall TripleButtonDlgComponent__OnClickMiddle(TripleButtonDlgComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1B18F & 1) == 0 )
  {
    sub_1BCAFF8(&Method_TripleButtonDlgComponent_OnClickMiddle__, method);
    byte_4B1B18F = 1;
  }
  v3 = Method_TripleButtonDlgComponent_OnClickMiddle__;
  if ( (*((_BYTE *)Method_TripleButtonDlgComponent_OnClickMiddle__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1BCB010(Method_TripleButtonDlgComponent_OnClickMiddle__);
  v4 = (System_Reflection_MethodBase_o *)sub_1BCAFDC(v3, v3[4]);
...
void __fastcall TripleButtonDlgComponent__OnClickRight(TripleButtonDlgComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1B18E & 1) == 0 )
  {
    sub_1BCAFF8(&Method_TripleButtonDlgComponent_OnClickRight__, method);
    byte_4B1B18E = 1;
  }
  v3 = Method_TripleButtonDlgComponent_OnClickRight__;
  if ( (*((_BYTE *)Method_TripleButtonDlgComponent_OnClickRight__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1BCB010(Method_TripleButtonDlgComponent_OnClickRight__);
  v4 = (System_Reflection_MethodBase_o *)sub_1BCAFDC(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B188 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_TripleButtonDlgComponent_EndOpen__, v24);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B191 & 1) == 0 )
  {
    ...
    this = (TripleButtonDlgComponent_o *)sub_1BCAFF8(&StringLiteral_13221/*"TALKRESUME_CONFIRM_CANCEL"*/, v3);
    byte_4B1B191 = 1;
  }
  ...
  v6 = LocalizationManager__Get((System_String_o *)StringLiteral_13221/*"TALKRESUME_CONFIRM_CANCEL"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B192 & 1) == 0 )
  {
    this = (TripleButtonDlgComponent_o *)sub_1BCAFF8(&Method_UnityEngine_Component_GetComponent_UIRect___, sprite);
    byte_4B1B192 = 1;
  }
  if ( !sprite )
    goto LABEL_8;
  this = (TripleButtonDlgComponent_o *)UnityEngine_Component__GetComponent_object_(
                                         ...
                                         (const MethodInfo_3011274 *)Method_UnityEngine_Component_GetComponent_UIRect___);
  if ( !this )
    goto LABEL_8;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B18C & 1) == 0 )
  {
    ...
    this = (TripleButtonDlgComponent_o *)sub_1BCAFF8(&UnityEngine_Object_TypeInfo, v6);
    byte_4B1B18C = 1;
  }
  if ( !buttonObj )
    goto LABEL_10;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B185 & 1) == 0 )
  {
    sub_1BCAFF8(&TripleButtonDlgComponent_CallbackFunc_TypeInfo, value);
    byte_4B1B185 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B18B & 1) == 0 )
  {
    sub_1BCAFF8(&Method_UnityEngine_GameObject_GetComponent_UICommonButton___, disabled);
...
LABEL_10:
    sub_1BCB254(middleBtn, disabled);
  }
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A14718;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A146D0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B194 & 1) == 0 )
  {
    sub_1BCAFF8(&TripleButtonDlgComponent_ResultClicked_TypeInfo, *(_QWORD *)&result);
    byte_4B1B194 = 1;
  }
  v9[1] = 0LL;
