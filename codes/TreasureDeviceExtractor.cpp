        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF0B4A & 1) == 0 )
  {
    sub_1C7BAE8(&TreasureDeviceExtractor__EnumerateTreasureDeviceData_d__0_TypeInfo);
    byte_4CF0B4A = 1;
  }
  v3 = sub_1C7BD34(TreasureDeviceExtractor__EnumerateTreasureDeviceData_d__0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.__7__wrap1, (int32_t)userSvt, v2, v3, v4, v5, v6, v7);
  _7__wrap2 = 0;
...
LABEL_17:
    ...
    {
      p__7__wrap1->klass = 0;
      sub_1C7BA8C(p__7__wrap1, 0, v2, v3, v4, v5, v6, v7);
      return 0;
    }
        ...
        const MethodInfo *method)
{
  ...
  {
    v10 = (TreasureDeviceExtractor__EnumerateTreasureDeviceData_d__0_o *)sub_1C7BD34(TreasureDeviceExtractor__EnumerateTreasureDeviceData_d__0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C7BAFC(&Method_TreasureDeviceExtractor__EnumerateTreasureDeviceData_d__0_System_Collections_IEnumerator_Reset__);
  sub_1C7BC10(v3, v4);
}
