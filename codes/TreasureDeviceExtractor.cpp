        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2FFD5 & 1) == 0 )
  {
    sub_1B761C0(&TreasureDeviceExtractor__EnumerateTreasureDeviceData_d__0_TypeInfo, method);
    byte_4A2FFD5 = 1;
  }
  v3 = sub_1B7640C(TreasureDeviceExtractor__EnumerateTreasureDeviceData_d__0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.__7__wrap1, (int32_t)userSvt, v2, v3);
  _7__wrap2 = 0;
        ...
        const MethodInfo *method)
{
  ...
  {
    v6 = (TreasureDeviceExtractor__EnumerateTreasureDeviceData_d__0_o *)sub_1B7640C(TreasureDeviceExtractor__EnumerateTreasureDeviceData_d__0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B761D4(&Method_TreasureDeviceExtractor__EnumerateTreasureDeviceData_d__0_System_Collections_IEnumerator_Reset__);
  sub_1B762E8(v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2FFD6 & 1) == 0 )
  {
    sub_1B761C0(&SimpleTreasureDeviceData_TypeInfo, method);
    byte_4A2FFD6 = 1;
  }
