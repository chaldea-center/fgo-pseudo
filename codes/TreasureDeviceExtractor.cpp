        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E79C15 & 1) == 0 )
  {
    sub_1D0F0B4(&TreasureDeviceExtractor__EnumerateTreasureDeviceData_d__0_TypeInfo);
    byte_4E79C15 = 1;
  }
  v3 = sub_1D0F300(TreasureDeviceExtractor__EnumerateTreasureDeviceData_d__0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.__7__wrap1, (int32_t)userSvt, v2, v3, v4, v5, v6, v7);
  _7__wrap2 = 0;
  for ( this->fields.__7__wrap2 = 0; ; this->fields.__7__wrap2 = _7__wrap2 )
  {
    ...
    if ( !_7__wrap1 )
LABEL_17:
      sub_1D0F30C(p__7__wrap1, method);
    max_length = _7__wrap1->max_length;
    if ( _7__wrap2 >= max_length )
    {
      p__7__wrap1->klass = 0;
      sub_1D0F058(p__7__wrap1, 0, v2, v3, v4, v5, v6, v7);
      return 0;
    }
    if ( _7__wrap2 >= (unsigned int)max_length )
      sub_1D0F314(p__7__wrap1);
        ...
        const MethodInfo *method)
{
  ...
  {
    v10 = (TreasureDeviceExtractor__EnumerateTreasureDeviceData_d__0_o *)sub_1D0F300(TreasureDeviceExtractor__EnumerateTreasureDeviceData_d__0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1D0F0C8(&Method_TreasureDeviceExtractor__EnumerateTreasureDeviceData_d__0_System_Collections_IEnumerator_Reset__);
  sub_1D0F1DC(v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E79C16 & 1) == 0 )
  {
    sub_1D0F0B4(&SimpleTreasureDeviceData_TypeInfo);
    byte_4E79C16 = 1;
  }
