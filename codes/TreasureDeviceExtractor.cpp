        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B46E84 & 1) == 0 )
  {
    sub_1BDB878(&TreasureDeviceExtractor__EnumerateTreasureDeviceData_d__0_TypeInfo, method);
    byte_4B46E84 = 1;
  }
  v3 = sub_1BDBAC4(TreasureDeviceExtractor__EnumerateTreasureDeviceData_d__0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.__7__wrap1, (int32_t)userSvt, v2, v3);
  _7__wrap2 = 0;
...
LABEL_17:
    ...
    if ( _7__wrap2 >= (int)max_length )
    {
      ...
      sub_1BDB81C(p__7__wrap1, 0, v2, v3);
      return 0;
    }
        ...
        const MethodInfo *method)
{
  ...
  {
    v6 = (TreasureDeviceExtractor__EnumerateTreasureDeviceData_d__0_o *)sub_1BDBAC4(TreasureDeviceExtractor__EnumerateTreasureDeviceData_d__0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BDB88C(&Method_TreasureDeviceExtractor__EnumerateTreasureDeviceData_d__0_System_Collections_IEnumerator_Reset__);
  sub_1BDB9A0(v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B46E85 & 1) == 0 )
  {
    sub_1BDB878(&SimpleTreasureDeviceData_TypeInfo, method);
    byte_4B46E85 = 1;
  }
