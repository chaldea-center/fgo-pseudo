        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5D2FB & 1) == 0 )
  {
    sub_1B885B0(&TreasureDeviceExtractor__EnumerateTreasureDeviceData_d__0_TypeInfo);
    byte_4A5D2FB = 1;
  }
  v3 = sub_1B887FC(TreasureDeviceExtractor__EnumerateTreasureDeviceData_d__0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.__7__wrap1, (int32_t)userSvt, v2, v3);
  _7__wrap2 = 0;
        ...
        const MethodInfo *method)
{
  ...
  {
    v6 = (TreasureDeviceExtractor__EnumerateTreasureDeviceData_d__0_o *)sub_1B887FC(TreasureDeviceExtractor__EnumerateTreasureDeviceData_d__0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B885C4(&Method_TreasureDeviceExtractor__EnumerateTreasureDeviceData_d__0_System_Collections_IEnumerator_Reset__);
  sub_1B886D8(v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5D2FC & 1) == 0 )
  {
    sub_1B885B0(&SimpleTreasureDeviceData_TypeInfo);
    byte_4A5D2FC = 1;
  }
