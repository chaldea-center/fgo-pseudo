        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B393A3 & 1) == 0 )
  {
    sub_1BD3458(&TreasureDeviceExtractor__EnumerateTreasureDeviceData_d__0_TypeInfo, method);
    byte_4B393A3 = 1;
  }
  v3 = sub_1BD36A4(TreasureDeviceExtractor__EnumerateTreasureDeviceData_d__0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.__7__wrap1, (int64_t)userSvt, v2, v3, v4, v5, v6, v7);
  _7__wrap2 = 0;
  for ( this->fields.__7__wrap2 = 0; ; this->fields.__7__wrap2 = _7__wrap2 )
  {
    ...
    if ( !_7__wrap1 )
LABEL_17:
      sub_1BD36B4(p__7__wrap1, method);
    max_length = _7__wrap1->max_length;
    if ( _7__wrap2 >= (int)max_length )
    {
      p__7__wrap1->klass = 0LL;
      sub_1BD33FC(p__7__wrap1, 0LL, v2, v3, v4, v5, v6, v7);
      return 0;
    }
    if ( _7__wrap2 >= max_length )
      sub_1BD36BC(p__7__wrap1, method);
        ...
        const MethodInfo *method)
{
  ...
  {
    v10 = (TreasureDeviceExtractor__EnumerateTreasureDeviceData_d__0_o *)sub_1BD36A4(TreasureDeviceExtractor__EnumerateTreasureDeviceData_d__0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BD346C(&Method_TreasureDeviceExtractor__EnumerateTreasureDeviceData_d__0_System_Collections_IEnumerator_Reset__);
  sub_1BD3580(v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B393A4 & 1) == 0 )
  {
    sub_1BD3458(&SimpleTreasureDeviceData_TypeInfo, method);
    byte_4B393A4 = 1;
  }
