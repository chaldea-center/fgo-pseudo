        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596DE55 & 1) == 0 )
  {
    sub_2213A60(&ListViewDropObject_TypeInfo);
    sub_2213A60(&UnityEngine_Object_TypeInfo);
    sub_2213A60(&SampleCardListViewDropObject_TypeInfo);
    this = (SampleCardUIDragDropListViewDrop_o *)sub_2213A60(&SampleCardListViewObject_TypeInfo);
    byte_596DE55 = 1;
  }
  ...
  if ( !this )
    goto LABEL_21;
  v9 = *(_QWORD *)&this->fields.mTarget.fields.z;
  if ( v9
    && (v10 = SampleCardListViewObject_TypeInfo->_2.naturalAligment,
        *(unsigned __int8 *)(*(_QWORD *)v9 + 304LL) >= (unsigned int)v10) )
  {
    if ( *(SampleCardListViewObject_c **)(*(_QWORD *)(*(_QWORD *)v9 + 200LL) + 8 * v10 - 8) == SampleCardListViewObject_TypeInfo )
      v11 = *(UnityEngine_Object_o **)&this->fields.mTarget.fields.z;
    else
      v11 = 0;
  }
  else
  ...
  if ( !*(&v12->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(v12, method, v8);
  this = (SampleCardUIDragDropListViewDrop_o *)UnityEngine_Object__op_Inequality(v11, 0, 0);
  if ( ((unsigned __int8)this & 1) != 0 )
  {
    if ( v11 )
    {
      SampleCardListViewObject__Init_44474520((SampleCardListViewObject_o *)v11, 6, v13);
      goto LABEL_20;
    }
LABEL_21:
...
LABEL_20:
  ...
  SampleCardListViewDropObject__Init_44461768(mListViewObject, 0, 0);
        ...
        const MethodInfo *method)
{
  ...
  __int64 v4; // x1
  UnityEngine_GameObject_o *dragObject; // x8
  ...
  if ( (byte_596DE54 & 1) == 0 )
  {
    sub_2213A60(&StringLiteral_4492/*"CardDragDumpEnd"*/);
    byte_596DE54 = 1;
  }
  v24.fields.r = 0.0;
  v24.fields.g = 0.0;
  v24.fields.b = 0.0;
  v24.fields.a = 0.0;
  transform = (UnityEngine_Transform_o *)TweenColor__Begin(this->fields.dragObject, 0.2, v24, 0);
  if ( !transform )
    goto LABEL_10;
  ...
  v23.fields.z = localPosition.fields.z + (float)(static_fields->downVector.fields.z * 50.0);
  v23.fields.x = localPosition.fields.x + (float)(static_fields->downVector.fields.x * 50.0);
  v23.fields.y = localPosition.fields.y + (float)(static_fields->downVector.fields.y * 50.0);
  transform = (UnityEngine_Transform_o *)TweenPosition__Begin(this->fields.dragObject, 0.2, v23, 0);
  if ( !transform )
LABEL_10:
  ...
  v15 = StringLiteral_4492/*"CardDragDumpEnd"*/;
  v7[3].fields.m_CachedPtr = StringLiteral_4492/*"CardDragDumpEnd"*/;
        ...
        const MethodInfo *method)
{
  ...
  SampleCardListViewDropObject__Init_44461768((SampleCardListViewDropObject_o *)mListViewObject, 6, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !dragObject
    ...
    || (v10 = (UnityEngine_Transform_o *)dragObject,
        (dragObject = (UnityEngine_GameObject_o *)UnityEngine_Component__get_transform(v8, 0)) == 0)
    || (position = UnityEngine_Transform__get_position((UnityEngine_Transform_o *)dragObject, 0), !v10)
    || (v27 = UnityEngine_Transform__InverseTransformPoint(v10, position, 0),
        (dragObject = (UnityEngine_GameObject_o *)TweenPosition__Begin(this->fields.dragObject, 0.2, v27, 0)) == 0) )
  {
        ...
        const MethodInfo *method)
{
  ...
  Il2CppClass **typeHierarchy; // x9
  __int64 v9; // x11
  MissionNaviTransitionBoardItem_o *p_dropObject; // x19
  ...
  if ( typeHierarchy[v7 - 1] != (Il2CppClass *)ListViewDropObject_TypeInfo
    ...
    || (SampleCardListViewDropObject__Init_44461768((SampleCardListViewDropObject_o *)mListViewObject, 6, 0),
        ...
        p_dropObject = (MissionNaviTransitionBoardItem_o *)&this->fields.dropObject,
        (klass = dropObject) == 0)
    || (SampleCardListViewDropObject__Init_44461768(klass, 8, 0),
        (klass = (SampleCardListViewDropObject_o *)p_dropObject->klass) == 0) )
  {
LABEL_11:
    sub_2213CDC(klass, v5);
  }
  SampleCardListViewDropObject__Init_44461768(klass, 6, 0);
  p_dropObject->klass = 0;
  sub_2213A04(p_dropObject, 0, v12, v13, v14, v15, v16, v17);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596DE57 & 1) == 0 )
  {
    sub_2213A60(&ListViewDropObject_TypeInfo);
    sub_2213A60(&SampleCardListViewDropObject_TypeInfo);
    this = (SampleCardUIDragDropListViewDrop_o *)sub_2213A60(&StringLiteral_4494/*"CardDragSwapEnd"*/);
    byte_596DE57 = 1;
  }
  mListViewObject = (SampleCardListViewDropObject_o *)v2->fields.mListViewObject;
  if ( !mListViewObject )
  ...
  if ( !v2->fields.dropObject )
    goto LABEL_13;
  v8 = this;
  Item = SampleCardListViewDropObject__GetItem(v2->fields.dropObject, 0);
  ((void (__fastcall *)(SampleCardListViewDropObject_o *, SampleCardListViewItem_o *, const MethodInfo *))mListViewObject->klass->vtable._5_SetItem.methodPtr)(
    ...
    Item,
    mListViewObject->klass->vtable._5_SetItem.method);
  SampleCardListViewDropObject__Init_44461768(mListViewObject, 2, 0);
  if ( !v8
    || (this = (SampleCardUIDragDropListViewDrop_o *)v2->fields.dropObject, BYTE4(v8->fields.dragObject) = 1, !this)
...
LABEL_13:
  ...
  SampleCardListViewDropObject__Init_44461768((SampleCardListViewDropObject_o *)this, 2, 0);
  UnityEngine_MonoBehaviour__Invoke((UnityEngine_MonoBehaviour_o *)v2, (System_String_o *)StringLiteral_4494/*"CardDragSwapEnd"*/, 0.05, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596DE56 & 1) == 0 )
  {
    ...
    sub_2213A60(&ListViewDropObject_TypeInfo);
    sub_2213A60(&SampleCardListViewDropObject_TypeInfo);
    sub_2213A60(&Method_SampleCardUIDragDropListViewDrop_CardDragSwapMove__);
    byte_596DE56 = 1;
  }
  ...
  if ( !v20 )
    goto LABEL_21;
  v25 = UnityEngine_Transform__InverseTransformPoint(v20, position, 0);
  ...
  if ( !dragObject
    || (dropObject = this->fields.dropObject,
        ...
        System_Action___ctor(v22, (Il2CppObject *)this, Method_SampleCardUIDragDropListViewDrop_CardDragSwapMove__, 0),
        !v17)
...
LABEL_21:
  ...
  SampleCardListViewDropObject__Init(dropObject, 7, v22, 0.0, v23, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  __int64 v12; // x10
  SampleCardUIDragDropListViewDrop_o *v13; // x22
  __int64 v14; // x1
  __int64 v15; // x2
  __int64 v16; // x1
  __int64 v17; // x2
  ...
  if ( (byte_596DE51 & 1) == 0 )
  {
    ...
    sub_2213A60(&UnityEngine_Object_TypeInfo);
    sub_2213A60(&SampleCardListViewDropObject_TypeInfo);
    this = (SampleCardUIDragDropListViewDrop_o *)sub_2213A60(&SampleCardListViewManager_TypeInfo);
    byte_596DE51 = 1;
  }
  ...
  if ( !manager )
    goto LABEL_31;
  klass = manager->klass;
  v12 = SampleCardListViewManager_TypeInfo->_2.naturalAligment;
  if ( manager->klass->_2.naturalAligment < (unsigned int)v12
    || (SampleCardListViewManager_c *)klass->_2.typeHierarchy[v12 - 1] != SampleCardListViewManager_TypeInfo )
  {
    goto LABEL_31;
  }
  v13 = this;
  ...
  if ( ((unsigned __int8)this & 1) == 0 || !v13 )
    goto LABEL_28;
  if ( !surface )
    goto LABEL_31;
  ...
  if ( !UnityEngine_Object__op_Inequality(Component_object, 0, 0)
    || (gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)v4, 0),
        v20 = (ListViewDropInfo_o *)sub_2213CCC(ListViewDropInfo_TypeInfo),
        ListViewDropInfo___ctor(v20, gameObject, surface, 0),
        this = (SampleCardUIDragDropListViewDrop_o *)SampleCardListViewManager__IsDropDropSurface(manager, v20, 0),
...
LABEL_28:
  ...
  if ( !*(&UnityEngine_Object_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo, surface, v21);
...
LABEL_31:
  ...
  if ( Item )
  {
    if ( Item != (SampleCardListViewItem_o *)v13 )
    {
      SampleCardUIDragDropListViewDrop__CardDragSwapStart(v4, (SampleCardListViewDropObject_o *)monitor, v24);
      return;
    }
    goto LABEL_28;
  }
