...
void ResolutionManager__SetResolutionType(int32_t type, const MethodInfo *method)
{
  ...
  else
  {
    ...
    if ( !System_Math_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
    v16 = System_Math__Round_65554328(v15, 0, 1, 0);
    if ( !byte_4CC6E1C )
    {
      sub_1C713B0(&ResolutionManager_TypeInfo);
      byte_4CC6E1C = 1;
    ...
    if ( !System_Math_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
    v20 = System_Math__Round_65554328(v19, 0, 1, 0);
    if ( v20 == INFINITY )
  ...
  UnityEngine_Screen__SetResolution_71567800(v12, DefaultScreenHeight_k__BackingField, fullScreen, 0);
}
