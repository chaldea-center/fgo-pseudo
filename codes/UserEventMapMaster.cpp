void __fastcall UserEventMapMaster___ctor(UserEventMapMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A2EB91 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_UserEventMapMaster__UserEventMapEntity__string___ctor__, method);
    byte_4A2EB91 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    350,
    (const MethodInfo_30FFA98 *)Method_DataMasterBase_UserEventMapMaster__UserEventMapEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EB8F & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_UserEventMapMaster__UserEventMapEntity__string__GetEntity__, userId);
    byte_4A2EB8F = 1;
  }
  ...
  return (UserEventMapEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                   (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                   PK,
                                   (const MethodInfo_30FFAD8 *)Method_DataMasterBase_UserEventMapMaster__UserEventMapEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EB93 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_System_Collections_Generic_List_UserEventMapEntity__Add__, v10);
    sub_1B761C0(&Method_System_Collections_Generic_List_UserEventMapEntity___ctor__, v11);
    sub_1B761C0(&System_Collections_Generic_List_UserEventMapEntity__TypeInfo, v12);
    sub_1B761C0(&UserEventMapEntity_TypeInfo, v13);
    byte_4A2EB93 = 1;
  }
  v14 = (System_Collections_Generic_List_object__o *)sub_1B7640C(System_Collections_Generic_List_UserEventMapEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v14,
    (const MethodInfo_34D6DA0 *)Method_System_Collections_Generic_List_UserEventMapEntity___ctor__);
...
LABEL_36:
      ...
      {
        if ( !v14 )
          sub_1B7641C(v27, UserEventMapEntity_TypeInfo);
...
// local variable allocation has failed, the output may be wrong!
UserEventMapEntity_o *__fastcall UserEventMapMaster__GetEntity_39900024(
        UserEventMapMaster_o *this,
        int32_t eventId,
        int32_t mapId,
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EB92 & 1) == 0 )
  {
    sub_1B761C0(&System_Collections_Generic_IReadOnlyDictionary_string__DataEntityBase__TypeInfo, *(_QWORD *)&eventId);
    sub_1B761C0(&NetworkManager_TypeInfo, v5);
    sub_1B761C0(&string___TypeInfo, v6);
    sub_1B761C0(&UserEventMapEntity_TypeInfo, v7);
    sub_1B761C0(&StringLiteral_1544/*":"*/, v8);
    byte_4A2EB92 = 1;
  }
  v33 = 0LL;
  v9 = sub_1B76268(string___TypeInfo, 5LL);
  ...
  if ( !*(_DWORD *)(v9 + 24) )
    goto LABEL_25;
  *(_QWORD *)(v9 + 32) = lookup;
  sub_1B76164((ServantStatusBattleListViewItem_o *)(v9 + 32), (int32_t)lookup, v12, v13);
  if ( *(_DWORD *)(v9 + 24) <= 1u )
    goto LABEL_25;
  v16 = StringLiteral_1544/*":"*/;
  *(_QWORD *)(v9 + 40) = StringLiteral_1544/*":"*/;
  sub_1B76164((ServantStatusBattleListViewItem_o *)(v9 + 40), v16, v14, v15);
  lookup = (__int64 *)System_Int32__ToString((int32_t)&v35, 0LL);
  if ( *(_DWORD *)(v9 + 24) <= 2u
    || (*(_QWORD *)(v9 + 48) = lookup,
        sub_1B76164((ServantStatusBattleListViewItem_o *)(v9 + 48), (int32_t)lookup, v17, v18),
        *(_DWORD *)(v9 + 24) <= 3u)
    || (v21 = StringLiteral_1544/*":"*/,
        *(_QWORD *)(v9 + 56) = StringLiteral_1544/*":"*/,
        sub_1B76164((ServantStatusBattleListViewItem_o *)(v9 + 56), v21, v19, v20),
        lookup = (__int64 *)System_Int32__ToString((int32_t)&v34, 0LL),
        *(_DWORD *)(v9 + 24) <= 4u) )
  {
LABEL_25:
    sub_1B76424(lookup, v11);
  }
  *(_QWORD *)(v9 + 64) = lookup;
  sub_1B76164((ServantStatusBattleListViewItem_o *)(v9 + 64), (int32_t)lookup, v22, v23);
  v24 = System_String__Concat_61548588((System_String_array *)v9, 0LL);
...
LABEL_26:
  ...
  {
LABEL_16:
    v29 = sub_1BC81A0(lookup, System_Collections_Generic_IReadOnlyDictionary_string__DataEntityBase__TypeInfo, 1LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EB90 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_UserEventMapMaster__UserEventMapEntity__string__TryGetEntity__, entity);
    byte_4A2EB90 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_30FFB28 *)Method_DataMasterBase_UserEventMapMaster__UserEventMapEntity__string__TryGetEntity__);
}