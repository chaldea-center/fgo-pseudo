        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A23008 & 1) == 0 )
  {
    sub_1B715CC(&CoinRoomUtility_TypeInfo, *(_QWORD *)&beforePoint);
    sub_1B715CC(&iTween_EaseType_TypeInfo, v7);
    sub_1B715CC(&System_Collections_Hashtable_TypeInfo, v8);
    sub_1B715CC(&iTween_LoopType_TypeInfo, v9);
    sub_1B715CC(&float_TypeInfo, v10);
    sub_1B715CC(&StringLiteral_15134/*"UpdateGauge"*/, v11);
    sub_1B715CC(&StringLiteral_22228/*"onupdatetarget"*/, v12);
    sub_1B715CC(&StringLiteral_19605/*"from"*/, v13);
    sub_1B715CC(&StringLiteral_21163/*"loopType"*/, v14);
    ...
    sub_1B715CC(&StringLiteral_6671/*"FinishGauge"*/, v19);
    sub_1B715CC(&StringLiteral_18703/*"easeType"*/, v20);
    sub_1B715CC(&StringLiteral_22218/*"oncomplete"*/, v21);
  ...
  if ( !this->fields.state )
  {
    ...
    v26 = (System_Collections_Hashtable_o *)sub_1B71818(System_Collections_Hashtable_TypeInfo);
    System_Collections_Hashtable___ctor_62084936(v26, 0LL);
    v61 = v25;
    ...
    ((void (__fastcall *)(System_Collections_Hashtable_o *, __int64, __int64, Il2CppMethodPointer))v26->klass->vtable._23_Add.method)(
      v26,
      StringLiteral_21163/*"loopType"*/,
      v53,
      v26->klass->vtable._24_Clear.methodPtr);
    ((void (__fastcall *)(System_Collections_Hashtable_o *, __int64, __int64, Il2CppMethodPointer))v26->klass->vtable._23_Add.method)(
      v26,
      StringLiteral_22226/*"onupdate"*/,
      StringLiteral_15134/*"UpdateGauge"*/,
      v26->klass->vtable._24_Clear.methodPtr);
    ((void (__fastcall *)(System_Collections_Hashtable_o *, __int64, __int64, Il2CppMethodPointer))v26->klass->vtable._23_Add.method)(
      v26,
      StringLiteral_22218/*"oncomplete"*/,
      StringLiteral_6671/*"FinishGauge"*/,
      v26->klass->vtable._24_Clear.methodPtr);
    ...
    ((void (__fastcall *)(System_Collections_Hashtable_o *, __int64, UnityEngine_GameObject_o *, Il2CppMethodPointer))v26->klass->vtable._23_Add.method)(
      v26,
      StringLiteral_22228/*"onupdatetarget"*/,
      gameObject,
      v26->klass->vtable._24_Clear.methodPtr);
