        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A3147E & 1) == 0 )
  {
    sub_1B761C0(&CoinRoomUtility_TypeInfo, *(_QWORD *)&beforePoint);
    sub_1B761C0(&iTween_EaseType_TypeInfo, v7);
    sub_1B761C0(&System_Collections_Hashtable_TypeInfo, v8);
    sub_1B761C0(&iTween_LoopType_TypeInfo, v9);
    sub_1B761C0(&float_TypeInfo, v10);
    sub_1B761C0(&StringLiteral_15177/*"UpdateGauge"*/, v11);
    sub_1B761C0(&StringLiteral_22274/*"onupdatetarget"*/, v12);
    sub_1B761C0(&StringLiteral_19650/*"from"*/, v13);
    sub_1B761C0(&StringLiteral_21208/*"loopType"*/, v14);
    ...
    sub_1B761C0(&StringLiteral_6693/*"FinishGauge"*/, v19);
    sub_1B761C0(&StringLiteral_18748/*"easeType"*/, v20);
    sub_1B761C0(&StringLiteral_22264/*"oncomplete"*/, v21);
  ...
  if ( !this->fields.state )
  {
    ...
    v26 = (System_Collections_Hashtable_o *)sub_1B7640C(System_Collections_Hashtable_TypeInfo);
    System_Collections_Hashtable___ctor_62114492(v26, 0LL);
    v61 = v25;
    ...
    ((void (__fastcall *)(System_Collections_Hashtable_o *, __int64, __int64, Il2CppMethodPointer))v26->klass->vtable._23_Add.method)(
      v26,
      StringLiteral_21208/*"loopType"*/,
      v53,
      v26->klass->vtable._24_Clear.methodPtr);
    ((void (__fastcall *)(System_Collections_Hashtable_o *, __int64, __int64, Il2CppMethodPointer))v26->klass->vtable._23_Add.method)(
      v26,
      StringLiteral_22272/*"onupdate"*/,
      StringLiteral_15177/*"UpdateGauge"*/,
      v26->klass->vtable._24_Clear.methodPtr);
    ((void (__fastcall *)(System_Collections_Hashtable_o *, __int64, __int64, Il2CppMethodPointer))v26->klass->vtable._23_Add.method)(
      v26,
      StringLiteral_22264/*"oncomplete"*/,
      StringLiteral_6693/*"FinishGauge"*/,
      v26->klass->vtable._24_Clear.methodPtr);
    ...
    ((void (__fastcall *)(System_Collections_Hashtable_o *, __int64, UnityEngine_GameObject_o *, Il2CppMethodPointer))v26->klass->vtable._23_Add.method)(
      v26,
      StringLiteral_22274/*"onupdatetarget"*/,
      gameObject,
      v26->klass->vtable._24_Clear.methodPtr);
