void __fastcall FriendPointNoticeDlgComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48E49DF & 1) == 0 )
  {
    sub_1B00CCC(&FriendPointNoticeDlgComponent_TypeInfo, v1);
    byte_48E49DF = 1;
  }
...
void __fastcall FriendPointNoticeDlgComponent__Close(FriendPointNoticeDlgComponent_o *this, const MethodInfo *method)
{
  ...
  FriendPointNoticeDlgComponent__Close_41121952(this, 0LL, v2);
}


void __fastcall FriendPointNoticeDlgComponent__Close_41121952(
        FriendPointNoticeDlgComponent_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E49DA & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_FriendPointNoticeDlgComponent_EndClose__, v5);
    byte_48E49DA = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E49DD & 1) == 0 )
  {
    sub_1B00CCC(&Method_FriendPointNoticeDlgComponent_OnClickCancel__, method);
    byte_48E49DD = 1;
  }
  ...
  if ( (*((_BYTE *)Method_FriendPointNoticeDlgComponent_OnClickCancel__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B00CE4(Method_FriendPointNoticeDlgComponent_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E49DC & 1) == 0 )
  {
    sub_1B00CCC(&Method_FriendPointNoticeDlgComponent_OnClickMiddle__, method);
    byte_48E49DC = 1;
  }
  ...
  if ( (*((_BYTE *)Method_FriendPointNoticeDlgComponent_OnClickMiddle__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B00CE4(Method_FriendPointNoticeDlgComponent_OnClickMiddle__);
  v4 = (System_Reflection_MethodBase_o *)sub_1B00CB0(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E49DB & 1) == 0 )
  {
    sub_1B00CCC(&Method_FriendPointNoticeDlgComponent_OnClickRight__, method);
    byte_48E49DB = 1;
  }
  ...
  if ( (*((_BYTE *)Method_FriendPointNoticeDlgComponent_OnClickRight__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B00CE4(Method_FriendPointNoticeDlgComponent_OnClickRight__);
  v4 = (System_Reflection_MethodBase_o *)sub_1B00CB0(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E49D5 & 1) == 0 )
  {
    sub_1B00CCC(&System_Action_TypeInfo, mLoginResult);
    sub_1B00CCC(&BalanceConfig_TypeInfo, v7);
    sub_1B00CCC(&Method_DataManager_GetMaster_ServantExceedMaster___, v8);
    sub_1B00CCC(&Method_DataManager_GetMaster_ServantLimitMaster___, v9);
    sub_1B00CCC(&Method_DataManager_GetMaster_ServantMaster___, v10);
    sub_1B00CCC(&Method_DataManager_GetMaster_TblUserMaster___, v11);
    sub_1B00CCC(&Method_DataManager_GetMaster_UserServantMaster___, v12);
    sub_1B00CCC(&DataManager_TypeInfo, v13);
    sub_1B00CCC(&Method_FriendPointNoticeDlgComponent_EndOpen__, v14);
    sub_1B00CCC(&FriendPointNoticeDlgComponent_TypeInfo, v15);
    sub_1B00CCC(&int_TypeInfo, v16);
    sub_1B00CCC(&LocalizationManager_TypeInfo, v17);
    sub_1B00CCC(&NetworkManager_TypeInfo, v18);
    sub_1B00CCC(&StringLiteral_6841/*"GET_FRIEND_POINT_SERVANT_TITLE"*/, v19);
    sub_1B00CCC(&StringLiteral_6838/*"GET_FRIEND_POINT_NO_DATA"*/, v20);
    sub_1B00CCC(&StringLiteral_6837/*"GET_FRIEND_POINT_NOW_POINT"*/, v21);
    sub_1B00CCC(&StringLiteral_6842/*"GET_FRIEND_POINT_SUPPORT_BTN"*/, v22);
    sub_1B00CCC(&StringLiteral_116/*"  "*/, v23);
    sub_1B00CCC(&StringLiteral_6835/*"GET_FRIEND_POINT_FP_NORMAL"*/, v24);
    sub_1B00CCC(&StringLiteral_3715/*"COMMON_CONFIRM_CLOSE"*/, v25);
    sub_1B00CCC(&StringLiteral_6834/*"GET_FRIEND_POINT_FP_FOLLOW"*/, v26);
    sub_1B00CCC(&StringLiteral_6832/*"GET_FRIEND_POINT_CAPTION_EVENT"*/, v27);
    sub_1B00CCC(&StringLiteral_1/*""*/, v28);
    sub_1B00CCC(&StringLiteral_6836/*"GET_FRIEND_POINT_GACHA_BTN"*/, v29);
    sub_1B00CCC(&StringLiteral_6843/*"GET_FRIEND_POINT_TITLE"*/, v30);
    sub_1B00CCC(&StringLiteral_6831/*"GET_FRIEND_POINT_AT_LIMIT"*/, v31);
    sub_1B00CCC(&StringLiteral_6833/*"GET_FRIEND_POINT_CAPTION_NORMAL"*/, v32);
    byte_48E49D5 = 1;
  }
  ...
  *(_QWORD *)&this->fields.rightSeNo = 0x800000008LL;
  ...
  DataManager__GetMaster_object_((const MethodInfo_2D62BBC *)Method_DataManager_GetMaster_ServantMaster___);
  DataManager__GetMaster_object_((const MethodInfo_2D62BBC *)Method_DataManager_GetMaster_UserServantMaster___);
  DataManager__GetMaster_object_((const MethodInfo_2D62BBC *)Method_DataManager_GetMaster_ServantLimitMaster___);
  DataManager__GetMaster_object_((const MethodInfo_2D62BBC *)Method_DataManager_GetMaster_ServantExceedMaster___);
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  gameObject = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_6843/*"GET_FRIEND_POINT_TITLE"*/, 0LL);
  if ( !titleLabel )
    goto LABEL_102;
  ...
  if ( mLoginResult->fields.addFriendPoint >= 1 )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v41 = LocalizationManager__Get((System_String_o *)StringLiteral_6835/*"GET_FRIEND_POINT_FP_NORMAL"*/, 0LL);
    ...
    v47 = System_String__Concat_60325748(mText, v46, 0LL);
  ...
  if ( mLoginResult->fields.addFollowFriendPoint >= 1 )
  {
    if ( mLoginResult->fields.addFriendPoint >= 1 )
    {
      ...
      if ( !v48 )
        goto LABEL_102;
      v49 = System_String__Concat_60325748(v48->fields.mText, (System_String_o *)StringLiteral_116/*"  "*/, 0LL);
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v52 = LocalizationManager__Get((System_String_o *)StringLiteral_6834/*"GET_FRIEND_POINT_FP_FOLLOW"*/, 0LL);
    ...
    v58 = System_String__Concat_60325748(v51, v57, 0LL);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  gameObject = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_6841/*"GET_FRIEND_POINT_SERVANT_TITLE"*/, 0LL);
  ...
  gameObject = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_6833/*"GET_FRIEND_POINT_CAPTION_NORMAL"*/, 0LL);
  ...
  gameObject = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_6832/*"GET_FRIEND_POINT_CAPTION_EVENT"*/, 0LL);
...
LABEL_61:
  if ( mLoginResult->fields.addFriendPoint > 0 || mLoginResult->fields.addFollowFriendPoint >= 1 )
  {
    ...
    if ( !UnityEngine_GameObject__get_activeSelf((UnityEngine_GameObject_o *)gameObject, 0LL) )
    {
      ...
      if ( !UnityEngine_GameObject__get_activeSelf((UnityEngine_GameObject_o *)gameObject, 0LL) )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        gameObject = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_6838/*"GET_FRIEND_POINT_NO_DATA"*/, 0LL);
        if ( !noDataLabel )
          goto LABEL_102;
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2D62BBC *)Method_DataManager_GetMaster_TblUserMaster___);
  ...
  if ( v74 >= v75->static_fields->FriendPointMax )
  {
    ...
    if ( gameObject )
    {
      ...
      if ( gameObject )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        gameObject = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_6831/*"GET_FRIEND_POINT_AT_LIMIT"*/, 0LL);
...
LABEL_92:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v80 = LocalizationManager__Get((System_String_o *)StringLiteral_6837/*"GET_FRIEND_POINT_NOW_POINT"*/, 0LL);
  v90 = *(_DWORD *)(v73 + 24);
  ...
  gameObject = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_3715/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
  if ( !closeBtnLb )
    goto LABEL_102;
  UILabel__set_text(closeBtnLb, (System_String_o *)gameObject, 0LL);
  middleBtnLb = this->fields.middleBtnLb;
  gameObject = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_6842/*"GET_FRIEND_POINT_SUPPORT_BTN"*/, 0LL);
  if ( !middleBtnLb )
    goto LABEL_102;
  UILabel__set_text(middleBtnLb, (System_String_o *)gameObject, 0LL);
  rightBtnLb = this->fields.rightBtnLb;
  gameObject = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_6836/*"GET_FRIEND_POINT_GACHA_BTN"*/, 0LL);
  if ( !rightBtnLb )
    goto LABEL_102;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E49D9 & 1) == 0 )
  {
    ...
    this = (FriendPointNoticeDlgComponent_o *)sub_1B00CCC(&UnityEngine_Object_TypeInfo, v6);
    byte_48E49D9 = 1;
  }
  if ( !buttonObj )
    goto LABEL_10;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E49D2 & 1) == 0 )
  {
    sub_1B00CCC(&FriendPointNoticeDlgComponent_CallbackFunc_TypeInfo, value);
    byte_48E49D2 = 1;
  }
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_194D094;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)&loc_194D04C;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E49E0 & 1) == 0 )
  {
    sub_1B00CCC(&FriendPointNoticeDlgComponent_ResultClicked_TypeInfo, *(_QWORD *)&result);
    byte_48E49E0 = 1;
  }
  v9[1] = 0LL;
