void UITouchPress___ctor(UITouchPress_o *this, const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.onPress, (int32_t)v6, v7, v8);
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.onLongPress, (int32_t)v9, v10, v11);
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.onLongRelease, (int32_t)v12, v13, v14);
...
void UITouchPress__OnCheckLongPress(UITouchPress_o *this, const MethodInfo *method)
{
  ...
  *(_WORD *)&this->fields.isLongPressCheck = 256;
  ...
  if ( !EventDelegate_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(EventDelegate_TypeInfo);
  EventDelegate__Execute_49220500(onLongPress, 0);
}
...
void UITouchPress__OnDrag(UITouchPress_o *this, UnityEngine_Vector2_o v, const MethodInfo *method)
{
  ...
  if ( (byte_4C44939 & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_9837/*"OnCheckLongPress"*/);
    byte_4C44939 = 1;
  }
    ...
    if ( releaseRange >= 0.0 )
    {
        ...
        || v7 < (float)-releaseRange )
      {
        ...
        UnityEngine_MonoBehaviour__CancelInvoke_71251632(
          ...
          (System_String_o *)StringLiteral_9837/*"OnCheckLongPress"*/,
          0);
      }
    }
  }
...
LABEL_26:
          if ( !EventDelegate_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(EventDelegate_TypeInfo);
          EventDelegate__Execute_49220500(onLongRelease, 0);
        }
      }
    }
  }
