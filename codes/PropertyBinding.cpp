...
void PropertyBinding__OnValidate(PropertyBinding_o *this, const MethodInfo *method)
{
  ...
  if ( source )
  {
    ...
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&source->fields.mField, 0, v2, v3, v4, v5, v6, v7);
    source->fields.mProperty = 0;
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&source->fields.mProperty, 0, v10, v11, v12, v13, v14, v15);
  }
  target = this->fields.target;
  if ( target )
  {
    target->fields.mField = 0;
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&target->fields.mField, 0, v2, v3, v4, v5, v6, v7);
    target->fields.mProperty = 0;
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&target->fields.mProperty, 0, v17, v18, v19, v20, v21, v22);
  }
}
      ...
      if ( direction == 1 )
      {
        ...
        if ( target )
        {
          ...
          if ( v7 )
          {
            ...
            target = v7;
LABEL_30:
            PropertyReference__Set_50477116(target, v9, v8);
            return;
          }
        }
        goto LABEL_32;
