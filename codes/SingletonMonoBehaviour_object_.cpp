void SingletonMonoBehaviour_object____ctor(SingletonMonoBehaviour_T__o *this, const MethodInfo_3B5522C *method)
{
  UnityEngine_MonoBehaviour___ctor((UnityEngine_MonoBehaviour_o *)this, 0);
}


void SingletonMonoBehaviour_object___Awake(SingletonMonoBehaviour_T__o *this, const MethodInfo_3B55068 *method)
{
  SingletonMonoBehaviour_object___CheckInstance(
    this,
    (const MethodInfo_3B550B0 *)method->klass->rgctx_data->_4_SingletonMonoBehaviour_T__CheckInstance);
}


bool SingletonMonoBehaviour_object___CheckInstance(SingletonMonoBehaviour_T__o *this, const MethodInfo_3B550B0 *method)
{
  ...
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)method->klass->rgctx_data->_5_SingletonMonoBehaviour_T__get_Instance);
...
void SingletonMonoBehaviour_object___DoCallbackAfterNotNullChecked(
        ...
        const MethodInfo_3B5515C *method)
{
  __int64 klass; // x0
  ...
  if ( (*(_BYTE *)(klass + 309) & 1) == 0 )
    klass = sub_1CBC788();
  Instance = SingletonMonoBehaviour_object___get_Instance(*(const MethodInfo_3B54D44 **)(*(_QWORD *)(klass + 192) + 40LL));
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)Instance, 0, 0) )
  {
    ...
    if ( (*(_BYTE *)(v8 + 309) & 1) == 0 )
      v8 = sub_1CBC788();
    ActionExtensions__Call_object_(callback, Instance, *(const MethodInfo_3149A44 **)(*(_QWORD *)(v8 + 192) + 56LL));
  }
  else
  {
...
Il2CppObject *SingletonMonoBehaviour_object___getInstance(const MethodInfo_3B55078 *method)
{
  __int64 klass; // x0
  __int64 v2; // x0
...
Il2CppObject *SingletonMonoBehaviour_object___get_Instance(const MethodInfo_3B54D44 *method)
{
  __int64 klass; // x0
  __int64 v3; // x0
  ...
  if ( (byte_4E0B3E0 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_25539/*"{0} is nothing"*/);
    byte_4E0B3E0 = 1;
  }
  klass = (__int64)method->klass;
  if ( (*(_BYTE *)(klass + 309) & 1) == 0 )
  ...
  if ( !v7 )
  {
    ...
    if ( v20 )
    {
      v22 = (GrandQuestFolderBoardItem_o *)sub_1CE683C(v20, v21);
      if ( !v22 )
        goto LABEL_38;
    }
    else
    ...
    **(_QWORD **)(v24 + 184) = v22;
    ...
    if ( !v20 )
      goto LABEL_39;
    v29 = sub_1CE683C(v20, v28);
    v30 = v29;
    if ( v29 )
    {
LABEL_40:
      sub_1CE66A4(v22, v30, v13, v14, v15, v16, v17, v18);
      ...
      if ( UnityEngine_Object__op_Equality(**(UnityEngine_Object_o ***)(v32 + 184), 0, 0) )
      {
        ...
        v37 = (Il2CppObject *)System_String__Format((System_String_o *)StringLiteral_25539/*"{0} is nothing"*/, v36, 0);
