...
void SetSvtRandOptionControl__Init(SetSvtRandOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596B5D5 & 1) == 0 )
  {
    ...
    sub_2213A60(&StringLiteral_10111/*"OPTION_SVT_RAND_DISP"*/);
    sub_2213A60(&StringLiteral_10110/*"OPTION_SVT_EXPLANATION"*/);
    byte_596B5D5 = 1;
  }
  svtRandDispTitle = this->fields.svtRandDispTitle;
  if ( !*(&LocalizationManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, method, v2);
  v5 = LocalizationManager__Get((System_String_o *)StringLiteral_10111/*"OPTION_SVT_RAND_DISP"*/, 0);
  if ( !svtRandDispTitle
    || (UILabel__set_text(svtRandDispTitle, v5, 0),
        svtRandDispInfoLb = this->fields.svtRandDispInfoLb,
        v5 = LocalizationManager__Get((System_String_o *)StringLiteral_10110/*"OPTION_SVT_EXPLANATION"*/, 0),
        !svtRandDispInfoLb) )
  {
    sub_2213CDC(v5, v6);
  }
...
void SetSvtRandOptionControl__OnChangeBtn(SetSvtRandOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596B5D8 & 1) == 0 )
  {
    sub_2213A60(&Method_SetSvtRandOptionControl_OnChangeBtn__);
    byte_596B5D8 = 1;
  }
  v3 = Method_SetSvtRandOptionControl_OnChangeBtn__;
  if ( (*((_BYTE *)Method_SetSvtRandOptionControl_OnChangeBtn__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_2213A78(Method_SetSvtRandOptionControl_OnChangeBtn__);
...
LABEL_9:
    sub_2213CDC(svtRandDispBtn, method);
  }
  if ( !svtRandDispBtn )
    goto LABEL_9;
