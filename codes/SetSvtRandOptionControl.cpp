...
void __fastcall SetSvtRandOptionControl__Init(SetSvtRandOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4356310 & 1) == 0 )
  {
    ...
    sub_B70694(&StringLiteral_9938/*"OPTION_SVT_RAND_DISP"*/);
    sub_B70694(&StringLiteral_9937/*"OPTION_SVT_EXPLANATION"*/);
    byte_4356310 = 1;
  }
  ...
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9938/*"OPTION_SVT_RAND_DISP"*/, 0LL);
  if ( !svtRandDispBtn
    || (UILabel__set_text(svtRandDispBtn, v4, 0LL),
        v6 = *(UILabel_o **)&this->fields.isSvtRand,
        v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9937/*"OPTION_SVT_EXPLANATION"*/, 0LL),
        !v6) )
  {
    sub_B7076C(v4, v5);
  }
