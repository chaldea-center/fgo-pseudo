...
void SetSvtRandOptionControl__Init(SetSvtRandOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC2405 & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_9714/*"OPTION_SVT_RAND_DISP"*/);
    sub_1C713B0(&StringLiteral_9713/*"OPTION_SVT_EXPLANATION"*/);
    byte_4CC2405 = 1;
  }
  svtRandDispTitle = this->fields.svtRandDispTitle;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9714/*"OPTION_SVT_RAND_DISP"*/, 0);
  if ( !svtRandDispTitle
    || (UILabel__set_text(svtRandDispTitle, v4, 0),
        svtRandDispInfoLb = this->fields.svtRandDispInfoLb,
        v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9713/*"OPTION_SVT_EXPLANATION"*/, 0),
        !svtRandDispInfoLb) )
  {
    sub_1C71608(v4, v5);
  }
...
void SetSvtRandOptionControl__OnChangeBtn(SetSvtRandOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC2408 & 1) == 0 )
  {
    sub_1C713B0(&Method_SetSvtRandOptionControl_OnChangeBtn__);
    byte_4CC2408 = 1;
  }
  v3 = Method_SetSvtRandOptionControl_OnChangeBtn__;
  if ( (*((_BYTE *)Method_SetSvtRandOptionControl_OnChangeBtn__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C713C8(Method_SetSvtRandOptionControl_OnChangeBtn__);
