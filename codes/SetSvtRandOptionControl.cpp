...
void __fastcall SetSvtRandOptionControl__Init(SetSvtRandOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4967F & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_9562/*"OPTION_SVT_RAND_DISP"*/, v4);
    sub_1B863B8(&StringLiteral_9561/*"OPTION_SVT_EXPLANATION"*/, v5);
    byte_4A4967F = 1;
  }
  svtRandDispTitle = this->fields.svtRandDispTitle;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v7 = LocalizationManager__Get((System_String_o *)StringLiteral_9562/*"OPTION_SVT_RAND_DISP"*/, 0LL);
  if ( !svtRandDispTitle
    || (UILabel__set_text(svtRandDispTitle, v7, 0LL),
        svtRandDispInfoLb = this->fields.svtRandDispInfoLb,
        v7 = LocalizationManager__Get((System_String_o *)StringLiteral_9561/*"OPTION_SVT_EXPLANATION"*/, 0LL),
        !svtRandDispInfoLb) )
  {
    sub_1B86614(v7, v8);
  }
...
void __fastcall SetSvtRandOptionControl__OnChangeBtn(SetSvtRandOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A49682 & 1) == 0 )
  {
    sub_1B863B8(&Method_SetSvtRandOptionControl_OnChangeBtn__, method);
    byte_4A49682 = 1;
  }
  v3 = Method_SetSvtRandOptionControl_OnChangeBtn__;
  if ( (*((_BYTE *)Method_SetSvtRandOptionControl_OnChangeBtn__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B863D0(Method_SetSvtRandOptionControl_OnChangeBtn__);
