...
int32_t __fastcall CriWare_Common__CRIWARE0F286CE1(const MethodInfo *method)
{
  ...
  v1 = (const MethodInfo *)qword_49F9288;
  if ( !qword_49F9288 )
  {
    v4 = 0;
...
CriWare_Common_CpuUsage_o __fastcall CriWare_Common__GetAtomCpuUsage(const MethodInfo *method)
{
  ...
  if ( (byte_49F9286 & 1) == 0 )
  {
    sub_1B64870(&CriAtomPlugin_TypeInfo, v1);
    byte_49F9286 = 1;
  }
...
uint32_t __fastcall CriWare_Common__GetFsMemoryUsage(const MethodInfo *method)
{
  ...
  if ( (byte_49F9283 & 1) == 0 )
  {
    sub_1B64870(&CriFsPlugin_TypeInfo, v1);
    byte_49F9283 = 1;
  }
...
uint32_t __fastcall CriWare_Common__GetManaMemoryUsage(const MethodInfo *method)
{
  ...
  if ( (byte_49F9285 & 1) == 0 )
  {
    sub_1B64870(&CriManaPlugin_TypeInfo, v1);
    byte_49F9285 = 1;
  }
...
System_String_o *__fastcall CriWare_Common__GetScriptVersionString(const MethodInfo *method)
{
  ...
  if ( (byte_49F9282 & 1) == 0 )
  {
    sub_1B64870(&StringLiteral_1270/*"1.01.04 (2.38.28h4-VolumeForCueInfo)"*/, v1);
    byte_49F9282 = 1;
  }
...
{
  _BOOL8 IsPathRooted_61649432; // x0
  __int64 v4; // x1
  _BOOL4 v5; // w0
  ...
  IsPathRooted_61649432 = System_IO_Path__IsPathRooted_61649432(path, 0LL);
  if ( IsPathRooted_61649432 )
  {
    LOBYTE(v5) = 0;
  }
  else
  {
    if ( !path )
      sub_1B64ACC(IsPathRooted_61649432, v4);
...
void __fastcall CriWare_Common__criWareUnity_SetRenderingEventOffsetForMana(int32_t offset, const MethodInfo *method)
{
  ...
  v2 = (void (__fastcall *)(_QWORD, const MethodInfo *))qword_49F9290;
  if ( !qword_49F9290 )
  {
...
UnityEngine_GameObject_o *__fastcall CriWare_Common__get_managerObject(const MethodInfo *method)
{
  ...
  if ( (byte_49F9281 & 1) == 0 )
  {
    sub_1B64870(&CriWare_Common_TypeInfo, v1);
    sub_1B64870(&UnityEngine_GameObject_TypeInfo, v2);
    sub_1B64870(&UnityEngine_Object_TypeInfo, v3);
    sub_1B64870(&StringLiteral_3917/*"CRIWARE"*/, v4);
    sub_1B64870(&StringLiteral_1155/*"/CRIWARE"*/, v5);
    byte_49F9281 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Equality(managerObject, 0LL, 0LL) )
  {
    CriWare_Common_TypeInfo->static_fields->_managerObject = UnityEngine_GameObject__Find(
                                                               ...
                                                               0LL);
    sub_1B64814(CriWare_Common_TypeInfo->static_fields);
    ...
    if ( UnityEngine_Object__op_Equality(v7, 0LL, 0LL) )
    {
      ...
      UnityEngine_GameObject___ctor(v8, (System_String_o *)StringLiteral_3917/*"CRIWARE"*/, 0LL);
