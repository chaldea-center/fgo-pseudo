...
int32_t __fastcall CriWare_Common__CRIWARE0F286CE1(const MethodInfo *method)
{
  ...
  v1 = (const MethodInfo *)qword_48DDA78;
  if ( !qword_48DDA78 )
  {
    v4 = 0;
...
CriWare_Common_CpuUsage_o __fastcall CriWare_Common__GetAtomCpuUsage(const MethodInfo *method)
{
  ...
  if ( (byte_48DDA76 & 1) == 0 )
  {
    sub_1B00CCC(&CriAtomPlugin_TypeInfo, v1);
    byte_48DDA76 = 1;
  }
...
uint32_t __fastcall CriWare_Common__GetFsMemoryUsage(const MethodInfo *method)
{
  ...
  if ( (byte_48DDA73 & 1) == 0 )
  {
    sub_1B00CCC(&CriFsPlugin_TypeInfo, v1);
    byte_48DDA73 = 1;
  }
...
uint32_t __fastcall CriWare_Common__GetManaMemoryUsage(const MethodInfo *method)
{
  ...
  if ( (byte_48DDA75 & 1) == 0 )
  {
    sub_1B00CCC(&CriManaPlugin_TypeInfo, v1);
    byte_48DDA75 = 1;
  }
...
System_String_o *__fastcall CriWare_Common__GetScriptVersionString(const MethodInfo *method)
{
  ...
  if ( (byte_48DDA72 & 1) == 0 )
  {
    sub_1B00CCC(&StringLiteral_1264/*"1.01.04 (2.38.28h4-VolumeForCueInfo)"*/, v1);
    byte_48DDA72 = 1;
  }
  return (System_String_o *)StringLiteral_1264/*"1.01.04 (2.38.28h4-VolumeForCueInfo)"*/;
}


bool __fastcall CriWare_Common__IsStreamingAssetsPath(System_String_o *path, const MethodInfo *method)
{
  _BOOL8 IsPathRooted_60591472; // x0
  __int64 v4; // x1
  _BOOL4 v5; // w0
  ...
  IsPathRooted_60591472 = System_IO_Path__IsPathRooted_60591472(path, 0LL);
  if ( IsPathRooted_60591472 )
  {
    LOBYTE(v5) = 0;
  }
  else
  {
    if ( !path )
      sub_1B00F28(IsPathRooted_60591472, v4);
...
void __fastcall CriWare_Common__criWareUnity_SetRenderingEventOffsetForMana(int32_t offset, const MethodInfo *method)
{
  ...
  v2 = (void (__fastcall *)(_QWORD, const MethodInfo *))qword_48DDA80;
  if ( !qword_48DDA80 )
  {
...
UnityEngine_GameObject_o *__fastcall CriWare_Common__get_managerObject(const MethodInfo *method)
{
  ...
  if ( (byte_48DDA71 & 1) == 0 )
  {
    sub_1B00CCC(&CriWare_Common_TypeInfo, v1);
    sub_1B00CCC(&UnityEngine_GameObject_TypeInfo, v2);
    sub_1B00CCC(&UnityEngine_Object_TypeInfo, v3);
    sub_1B00CCC(&StringLiteral_3897/*"CRIWARE"*/, v4);
    sub_1B00CCC(&StringLiteral_1151/*"/CRIWARE"*/, v5);
    byte_48DDA71 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Equality(managerObject, 0LL, 0LL) )
  {
    CriWare_Common_TypeInfo->static_fields->_managerObject = UnityEngine_GameObject__Find(
                                                               (System_String_o *)StringLiteral_1151/*"/CRIWARE"*/,
                                                               0LL);
    sub_1B00C70(CriWare_Common_TypeInfo->static_fields);
    ...
    if ( UnityEngine_Object__op_Equality(v7, 0LL, 0LL) )
    {
      ...
      UnityEngine_GameObject___ctor(v8, (System_String_o *)StringLiteral_3897/*"CRIWARE"*/, 0LL);
