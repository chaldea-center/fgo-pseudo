...
int32_t __fastcall CriWare_Common__CRIWARE0F286CE1(const MethodInfo *method)
{
  ...
  v1 = (const MethodInfo *)qword_4C1C598;
  if ( !qword_4C1C598 )
  {
    v4 = 0;
...
CriWare_Common_CpuUsage_o __fastcall CriWare_Common__GetAtomCpuUsage(const MethodInfo *method)
{
  ...
  if ( (byte_4C1C596 & 1) == 0 )
  {
    sub_1C3B764(&CriAtomPlugin_TypeInfo, v1);
    byte_4C1C596 = 1;
  }
...
uint32_t __fastcall CriWare_Common__GetFsMemoryUsage(const MethodInfo *method)
{
  ...
  if ( (byte_4C1C593 & 1) == 0 )
  {
    sub_1C3B764(&CriFsPlugin_TypeInfo, v1);
    byte_4C1C593 = 1;
  }
...
uint32_t __fastcall CriWare_Common__GetManaMemoryUsage(const MethodInfo *method)
{
  ...
  if ( (byte_4C1C595 & 1) == 0 )
  {
    sub_1C3B764(&CriManaPlugin_TypeInfo, v1);
    byte_4C1C595 = 1;
  }
...
System_String_o *__fastcall CriWare_Common__GetScriptVersionString(const MethodInfo *method)
{
  ...
  if ( (byte_4C1C592 & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_1247/*"1.2.840.113549.1.9.1"*/, v1);
    byte_4C1C592 = 1;
  }
  return (System_String_o *)StringLiteral_1247/*"1.2.840.113549.1.9.1"*/;
}


bool __fastcall CriWare_Common__IsStreamingAssetsPath(System_String_o *path, const MethodInfo *method)
{
  _BOOL8 IsPathRooted_63634804; // x0
  __int64 v4; // x1
  _BOOL4 v5; // w0
  ...
  IsPathRooted_63634804 = System_IO_Path__IsPathRooted_63634804(path, 0LL);
  if ( IsPathRooted_63634804 )
  {
    LOBYTE(v5) = 0;
  }
  else
  {
    if ( !path )
      sub_1C3B9C0(IsPathRooted_63634804, v4);
...
void __fastcall CriWare_Common__criWareUnity_SetRenderingEventOffsetForMana(int32_t offset, const MethodInfo *method)
{
  ...
  v2 = (void (__fastcall *)(_QWORD, const MethodInfo *))qword_4C1C5A0;
  if ( !qword_4C1C5A0 )
  {
...
UnityEngine_GameObject_o *__fastcall CriWare_Common__get_managerObject(const MethodInfo *method)
{
  ...
  if ( (byte_4C1C591 & 1) == 0 )
  {
    sub_1C3B764(&CriWare_Common_TypeInfo, v1);
    sub_1C3B764(&UnityEngine_GameObject_TypeInfo, v2);
    sub_1C3B764(&UnityEngine_Object_TypeInfo, v3);
    sub_1C3B764(&StringLiteral_4020/*"Cannot call Delete inside an OnRowDeleting event.  Throw an exception to cancel this delete."*/, v4);
    sub_1C3B764(&StringLiteral_1133/*"/usr/share"*/, v5);
    byte_4C1C591 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Equality(managerObject, 0LL, 0LL) )
  {
    CriWare_Common_TypeInfo->static_fields->_managerObject = UnityEngine_GameObject__Find(
                                                               (System_String_o *)StringLiteral_1133/*"/usr/share"*/,
                                                               0LL);
    sub_1C3B708(CriWare_Common_TypeInfo->static_fields);
    ...
    if ( UnityEngine_Object__op_Equality(v7, 0LL, 0LL) )
    {
      ...
      UnityEngine_GameObject___ctor(v8, (System_String_o *)StringLiteral_4020/*"Cannot call Delete inside an OnRowDeleting event.  Throw an exception to cancel this delete."*/, 0LL);
