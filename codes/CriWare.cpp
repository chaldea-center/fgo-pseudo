...
int32_t __fastcall CriWare_Common__CRIWARE0F286CE1(const MethodInfo *method)
{
  ...
  v1 = (const MethodInfo *)qword_42B4A68;
  if ( !qword_42B4A68 )
  {
...
System_String_o *__fastcall CriWare_Common__GetScriptVersionString(const MethodInfo *method)
{
  if ( (byte_42B4A5D & 1) == 0 )
  {
    sub_B52984(&StringLiteral_1025/*"1.01.04 (2.38.28h4-VolumeForCueInfo)"*/);
    byte_42B4A5D = 1;
  }
  return (System_String_o *)StringLiteral_1025/*"1.01.04 (2.38.28h4-VolumeForCueInfo)"*/;
}
...
void __fastcall CriWare_Common__criWareUnity_SetRenderingEventOffsetForMana(int32_t offset, const MethodInfo *method)
{
  ...
  v2 = (void (__fastcall *)(_QWORD, const MethodInfo *))qword_42B4A70;
  if ( !qword_42B4A70 )
  {
...
UnityEngine_GameObject_o *__fastcall CriWare_Common__get_managerObject(const MethodInfo *method)
{
  ...
  if ( (byte_42B4A5C & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_3476/*"CRIWARE"*/);
    sub_B52984(&StringLiteral_914/*"/CRIWARE"*/);
    byte_42B4A5C = 1;
  }
  v1 = CriWare_Common_TypeInfo;
  if ( (BYTE3(CriWare_Common_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
  ...
  {
    v3 = UnityEngine_GameObject__Find((System_String_o *)StringLiteral_914/*"/CRIWARE"*/, 0LL);
    ...
    sub_B52920(static_fields, v11, v4, v5, v6, v7, v8, v9);
    ...
    {
      v14 = (UnityEngine_GameObject_o *)sub_B52A54(UnityEngine_GameObject_TypeInfo);
      UnityEngine_GameObject___ctor(v14, (System_String_o *)StringLiteral_3476/*"CRIWARE"*/, 0LL);
      ...
      sub_B52920(v22, (System_Int32_array **)v14, v15, v16, v17, v18, v19, v20);
    }
