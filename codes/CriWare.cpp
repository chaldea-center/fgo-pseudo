...
int32_t __fastcall CriWare_Common__CRIWARE0F286CE1(const MethodInfo *method)
{
  ...
  v1 = (const MethodInfo *)qword_4BAEE28;
  if ( !qword_4BAEE28 )
  {
    v4 = 0;
...
CriWare_Common_CpuUsage_o __fastcall CriWare_Common__GetAtomCpuUsage(const MethodInfo *method)
{
  ...
  if ( (byte_4BAEE26 & 1) == 0 )
  {
    sub_1C13D24(&CriAtomPlugin_TypeInfo, v1);
    byte_4BAEE26 = 1;
  }
...
uint32_t __fastcall CriWare_Common__GetFsMemoryUsage(const MethodInfo *method)
{
  ...
  if ( (byte_4BAEE23 & 1) == 0 )
  {
    sub_1C13D24(&CriFsPlugin_TypeInfo, v1);
    byte_4BAEE23 = 1;
  }
...
uint32_t __fastcall CriWare_Common__GetManaMemoryUsage(const MethodInfo *method)
{
  ...
  if ( (byte_4BAEE25 & 1) == 0 )
  {
    sub_1C13D24(&CriManaPlugin_TypeInfo, v1);
    byte_4BAEE25 = 1;
  }
...
System_String_o *__fastcall CriWare_Common__GetScriptVersionString(const MethodInfo *method)
{
  ...
  if ( (byte_4BAEE22 & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_1268/*"1.0.1"*/, v1);
    byte_4BAEE22 = 1;
  }
  return (System_String_o *)StringLiteral_1268/*"1.0.1"*/;
}


bool __fastcall CriWare_Common__IsStreamingAssetsPath(System_String_o *path, const MethodInfo *method)
{
  _BOOL8 IsPathRooted_63234136; // x0
  __int64 v4; // x1
  _BOOL4 v5; // w0
  ...
  IsPathRooted_63234136 = System_IO_Path__IsPathRooted_63234136(path, 0LL);
  if ( IsPathRooted_63234136 )
  {
    LOBYTE(v5) = 0;
  }
  else
  {
    if ( !path )
      sub_1C13F80(IsPathRooted_63234136, v4);
...
void __fastcall CriWare_Common__criWareUnity_SetRenderingEventOffsetForMana(int32_t offset, const MethodInfo *method)
{
  ...
  v2 = (void (__fastcall *)(_QWORD, const MethodInfo *))qword_4BAEE30;
  if ( !qword_4BAEE30 )
  {
...
UnityEngine_GameObject_o *__fastcall CriWare_Common__get_managerObject(const MethodInfo *method)
{
  ...
  if ( (byte_4BAEE21 & 1) == 0 )
  {
    sub_1C13D24(&CriWare_Common_TypeInfo, v1);
    sub_1C13D24(&UnityEngine_GameObject_TypeInfo, v2);
    sub_1C13D24(&UnityEngine_Object_TypeInfo, v3);
    sub_1C13D24(&StringLiteral_4020/*"CRITICAL_RATE_PER_STAR"*/, v4);
    sub_1C13D24(&StringLiteral_1154/*"/CRIWARE"*/, v5);
    byte_4BAEE21 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Equality(managerObject, 0LL, 0LL) )
  {
    CriWare_Common_TypeInfo->static_fields->_managerObject = UnityEngine_GameObject__Find(
                                                               ...
                                                               0LL);
    sub_1C13CC8(CriWare_Common_TypeInfo->static_fields);
    ...
    if ( UnityEngine_Object__op_Equality(v7, 0LL, 0LL) )
    {
      ...
      UnityEngine_GameObject___ctor(v8, (System_String_o *)StringLiteral_4020/*"CRITICAL_RATE_PER_STAR"*/, 0LL);
