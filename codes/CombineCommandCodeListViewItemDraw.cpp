        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_41888D5 & 1) == 0 )
  {
    sub_B2C35C(&StringLiteral_1006/*"1"*/, item);
    byte_41888D5 = 1;
  }
  if ( item )
  {
    ...
    if ( item->fields.isSelect )
    {
      ...
      if ( selectImgObj )
      {
        UILabel__set_text((UILabel_o *)selectImgObj, (System_String_o *)StringLiteral_1006/*"1"*/, 0LL);
        return;
      }
LABEL_10:
      sub_B2C434(selectImgObj, item);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_41888D4 & 1) == 0 )
  {
    ...
    sub_B2C35C(&StringLiteral_9348/*"NOT_SELECT_MAX_EQUIP"*/, v7);
  ...
  if ( item && mode )
  {
    ...
    if ( item->fields.isMaxEquiped || item->fields.isReplaceSource )
    {
      ...
      if ( item->fields.isMaxEquiped )
      {
        ...
        icon = (ServantFaceIconComponent_o *)LocalizationManager__Get((System_String_o *)StringLiteral_9348/*"NOT_SELECT_MAX_EQUIP"*/, 0LL);
        if ( !maskLabel )
          goto LABEL_33;
    ...
    if ( item->fields.isSelect )
    {
      ...
      if ( icon )
      {
        ...
        if ( icon )
        {
          UILabel__set_text((UILabel_o *)icon, (System_String_o *)StringLiteral_1006/*"1"*/, 0LL);
          return;
        }
      }
LABEL_33:
      sub_B2C434(icon, item);
    }
  }
}