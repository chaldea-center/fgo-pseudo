        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A021CC & 1) == 0 )
  {
    sub_1B64A00(&StringLiteral_1267/*"1"*/, item);
    byte_4A021CC = 1;
  }
  if ( item )
  {
    ...
    if ( item->fields.isSelect )
    {
      ...
      if ( selectImgObj )
      {
        UILabel__set_text((UILabel_o *)selectImgObj, (System_String_o *)StringLiteral_1267/*"1"*/, 0LL);
        return;
      }
LABEL_10:
      sub_1B64C5C(selectImgObj, item);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A021CB & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_9253/*"NOT_SELECT_MAX_EQUIP"*/, v7);
  ...
  if ( item && mode )
  {
    ...
    if ( item->fields.isMaxEquiped || item->fields.isReplaceSource )
    {
      ...
      if ( item->fields.isMaxEquiped )
      {
        ...
        icon = (ServantFaceIconComponent_o *)LocalizationManager__Get((System_String_o *)StringLiteral_9253/*"NOT_SELECT_MAX_EQUIP"*/, 0LL);
        if ( !maskLabel )
          goto LABEL_38;
    ...
    if ( item->fields.isSelect )
    {
      ...
      if ( icon )
      {
        ...
        if ( icon )
        {
          UILabel__set_text((UILabel_o *)icon, (System_String_o *)StringLiteral_1267/*"1"*/, 0LL);
          return;
        }
      }
LABEL_38:
      sub_1B64C5C(icon, item);
    }
  }
}