void __fastcall UserServantNewManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B174C5 & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&UserServantNewManager_TypeInfo, v10, v11);
    sub_1BCA7E0(&StringLiteral_6754/*"Fgo_20150511_1"*/, v12, v13);
    byte_4B174C5 = 1;
  }
  UserServantNewManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6754/*"Fgo_20150511_1"*/;
  sub_1BCA784(
    (PartyOrganizationUtility_o *)UserServantNewManager_TypeInfo->static_fields,
...
void __fastcall UserServantNewManager__ClearSaveDataList(const MethodInfo *method)
{
  ...
  if ( (byte_4B174BE & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&UserServantNewManager_TypeInfo, v5, v6);
    byte_4B174BE = 1;
  }
  v7 = UserServantNewManager_TypeInfo;
  if ( !UserServantNewManager_TypeInfo->_2.cctor_finished )
  {
    j_il2cpp_runtime_class_init_0(UserServantNewManager_TypeInfo, v1);
    v7 = UserServantNewManager_TypeInfo;
  }
...
void __fastcall UserServantNewManager__CreateContinueDeviceSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4B174BC & 1) == 0 )
  {
    sub_1BCA7E0(&UserServantNewManager_TypeInfo, v1, v2);
    byte_4B174BC = 1;
  }
  v3 = UserServantNewManager_TypeInfo;
  if ( !UserServantNewManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UserServantNewManager_TypeInfo, v1);
  UserServantNewManager__DeleteSaveData((const MethodInfo *)v3);
  UserServantNewManager__ClearSaveDataList(v4);
...
void __fastcall UserServantNewManager__DeleteSaveData(const MethodInfo *method)
{
  ...
  if ( !UserServantNewManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UserServantNewManager_TypeInfo, v1);
  SaveFileName = UserServantNewManager__getSaveFileName((const MethodInfo *)v3);
...
void __fastcall UserServantNewManager__Initialize(const MethodInfo *method)
{
  ...
  if ( !UserServantNewManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UserServantNewManager_TypeInfo, v1);
  UserServantNewManager__ReadData((const MethodInfo *)v3);
}
...
bool __fastcall UserServantNewManager__IsNew(int64_t userSvtId, const MethodInfo *method)
{
  ...
  if ( !UserServantNewManager_TypeInfo->_2.cctor_finished )
  {
    j_il2cpp_runtime_class_init_0(UserServantNewManager_TypeInfo, method);
    v8 = UserServantNewManager_TypeInfo;
  }
  ...
  if ( size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      v8 = (UserServantNewManager_c *)v8->static_fields->oldList;
      if ( !v8 )
        break;
...
void __fastcall UserServantNewManager__LoginProcess(const MethodInfo *method)
{
  ...
  UserServantStorageMaster_o *v13; // x20
  __int64 v14; // x1
  ...
  if ( (byte_4B174BF & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&Method_DataManager_GetMasterData_UserServantStorageMaster___, v3, v4);
    sub_1BCA7E0(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v5, v6);
    sub_1BCA7E0(&UserServantNewManager_TypeInfo, v7, v8);
    byte_4B174BF = 1;
  }
  ...
  if ( v9->static_fields->isContinueDevice )
  {
    ...
    if ( !Instance
      ...
      || (Instance = DataManager__GetMasterData_object_(
          ...
          !MasterData_object)
      || (v13 = (UserServantStorageMaster_o *)Instance,
          UserServantMaster__continueDeviceUserServant((UserServantMaster_o *)MasterData_object, 0LL),
          !v13) )
    {
      sub_1BCAA3C(Instance, v11);
    }
    UserServantStorageMaster__continueDeviceUserServant(v13, 0LL);
    v15 = (const MethodInfo *)UserServantNewManager_TypeInfo;
    if ( !UserServantNewManager_TypeInfo->_2.cctor_finished )
    {
      j_il2cpp_runtime_class_init_0(UserServantNewManager_TypeInfo, v14);
      v15 = (const MethodInfo *)UserServantNewManager_TypeInfo;
    }
    *((_WORD *)v15[2].virtualMethodPointer + 4) = 1;
    UserServantNewManager__WriteData(v15);
  }
}
...
bool __fastcall UserServantNewManager__ReadData(const MethodInfo *method)
{
  ...
  __int64 v43; // x0
  UserServantNewManager_c *v44; // x0
  ...
  if ( (byte_4B174C3 & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&UserServantNewManager_TypeInfo, v9, v10);
    byte_4B174C3 = 1;
  }
  ...
  if ( !v12->static_fields->UseMock )
  {
    ...
    if ( !UserServantNewManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UserServantNewManager_TypeInfo, v1);
    SaveFileName = UserServantNewManager__getSaveFileName((const MethodInfo *)v14);
    if ( System_IO_File__Exists(SaveFileName, 0LL) )
    {
      v17 = UserServantNewManager_TypeInfo;
      if ( !UserServantNewManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UserServantNewManager_TypeInfo, v16);
      UserServantNewManager__ClearSaveDataList((const MethodInfo *)v17);
      ...
      if ( !UserServantNewManager_TypeInfo->_2.cctor_finished )
      {
        j_il2cpp_runtime_class_init_0(UserServantNewManager_TypeInfo, v25);
        v27 = UserServantNewManager_TypeInfo;
      }
      ...
      else
      {
        ...
        if ( !UserServantNewManager_TypeInfo->_2.cctor_finished )
        {
          j_il2cpp_runtime_class_init_0(UserServantNewManager_TypeInfo, v29);
          v31 = UserServantNewManager_TypeInfo;
        }
        ...
        if ( v32 >= 1 )
        {
          do
          {
            v34 = ((__int64 (__fastcall *)(System_IO_BinaryReader_o *, Il2CppMethodPointer))v22->klass->vtable._17_ReadInt64.method)(
                    v22,
                    v22->klass->vtable._18_ReadUInt64.methodPtr);
            v35 = UserServantNewManager_TypeInfo;
            if ( !UserServantNewManager_TypeInfo->_2.cctor_finished )
            {
              j_il2cpp_runtime_class_init_0(UserServantNewManager_TypeInfo, v33);
              v35 = UserServantNewManager_TypeInfo;
            }
            ...
            if ( (unsigned int)size >= items->max_length )
            {
              System_Collections_Generic_List_long___AddWithResize(
                oldList,
                v34,
                *(const MethodInfo_3589C90 **)(*(_QWORD *)(v38[4] + 192LL) + 112LL));
            }
            else
            {
...
LABEL_35:
    ...
    {
      v44 = UserServantNewManager_TypeInfo;
      if ( !UserServantNewManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UserServantNewManager_TypeInfo, v16);
      UserServantNewManager__ClearSaveDataList((const MethodInfo *)v44);
    }
    return 0;
  }
  return 1;
...
void __fastcall UserServantNewManager__SetOld(int64_t userSvtId, const MethodInfo *method)
{
  ...
  if ( (byte_4B174C1 & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&UserServantNewManager_TypeInfo, v8, v9);
    byte_4B174C1 = 1;
  }
  ...
  while ( 1 )
  {
    ...
    v10 = (UserServantNewManager_c *)static_fields->oldList;
    if ( !v10 )
      goto LABEL_19;
    if ( v13 == v12 )
      break;
...
void __fastcall UserServantNewManager__SetOld_41308244(System_Int64_array *userSvtList, const MethodInfo *method)
{
  __int64 v2; // x2
  __int64 v4; // x1
  __int64 v5; // x2
  ...
  if ( userSvtList )
  {
    v10 = *(_QWORD *)&userSvtList->max_length;
    if ( (int)v10 >= 1 )
    {
...
LABEL_35:
        ...
        while ( 1 )
        {
          ...
          while ( 1 )
          {
            if ( userSvtList->max_length == v15 )
              goto LABEL_35;
            v16 = &userSvtList->obj.klass + v15;
            v18 = v16[4];
            v17 = v16 + 4;
...
bool __fastcall UserServantNewManager__WriteData(const MethodInfo *method)
{
  ...
  struct UserServantNewManager_StaticFields *v25; // x8
  ...
  if ( (byte_4B174C4 & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&UserServantNewManager_TypeInfo, v11, v12);
    byte_4B174C4 = 1;
  }
  ...
  if ( !v15->static_fields->UseMock )
  {
    ...
    if ( !UserServantNewManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UserServantNewManager_TypeInfo, v1);
    SaveFileName = UserServantNewManager__getSaveFileName((const MethodInfo *)v16);
    ...
    if ( !UserServantNewManager_TypeInfo->_2.cctor_finished )
    {
      j_il2cpp_runtime_class_init_0(UserServantNewManager_TypeInfo, v23);
      v24 = UserServantNewManager_TypeInfo;
    }
