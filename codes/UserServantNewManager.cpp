void __fastcall UserServantNewManager___cctor(const MethodInfo *method)
{
  ...
  UserServantNewManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6804/*"Fgo_20150511_1"*/;
  sub_1C21DDC(
  ...
  if ( size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( System_Collections_Generic_List_long___get_Item(
             ...
             v6 - 1,
             (const MethodInfo_3636DF8 *)Method_System_Collections_Generic_List_long__get_Item__) == userSvtId )
        return !v7;
      v7 = v6 < size;
      if ( size == v6 )
        return !v7;
...
void __fastcall UserServantNewManager__SetOld_41853964(System_Int64_array *userSvtList, const MethodInfo *method)
{
  __int64 v3; // x22
  int64_t oldList; // x0
  __int64 v5; // x8
