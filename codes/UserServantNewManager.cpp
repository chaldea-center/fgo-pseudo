void UserServantNewManager___cctor(const MethodInfo *method)
{
  ...
  UserServantNewManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6954/*"Fgo_20150511_1"*/;
  sub_2213A04(
  ...
  if ( size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( System_Collections_Generic_List_long___get_Item(
             ...
             v7,
             (const MethodInfo_446BFA8 *)Method_System_Collections_Generic_List_long__get_Item__) != userSvtId )
      {
        v6 = ++v7 >= size;
        if ( size != v7 )
          continue;
...
void UserServantNewManager__SetOld_50659480(System_Int64_array *userSvtList, const MethodInfo *method)
{
  __int64 v3; // x22
  int64_t oldList; // x0
  __int64 v5; // x8
