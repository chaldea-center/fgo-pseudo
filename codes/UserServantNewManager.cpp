void __fastcall UserServantNewManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BB5A03 & 1) == 0 )
  {
    ...
    sub_1C13D24(&UserServantNewManager_TypeInfo, v9);
    sub_1C13D24(&StringLiteral_6791/*"Feed20NodeName"*/, v10);
    byte_4BB5A03 = 1;
  }
  UserServantNewManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6791/*"Feed20NodeName"*/;
  sub_1C13CC8(
...
void __fastcall UserServantNewManager__ClearSaveDataList(const MethodInfo *method)
{
  ...
  if ( (byte_4BB59FC & 1) == 0 )
  {
    ...
    sub_1C13D24(&UserServantNewManager_TypeInfo, v3);
    byte_4BB59FC = 1;
  }
...
void __fastcall UserServantNewManager__CreateContinueDeviceSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4BB59FA & 1) == 0 )
  {
    sub_1C13D24(&UserServantNewManager_TypeInfo, v1);
    byte_4BB59FA = 1;
  }
...
bool __fastcall UserServantNewManager__IsNew(int64_t userSvtId, const MethodInfo *method)
{
  ...
  if ( (byte_4BB59FE & 1) == 0 )
  {
    ...
    sub_1C13D24(&UserServantNewManager_TypeInfo, v4);
    byte_4BB59FE = 1;
  }
  ...
  if ( size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( System_Collections_Generic_List_long___get_Item(
             ...
             v8 - 1,
             (const MethodInfo_3614F10 *)Method_System_Collections_Generic_List_long__get_Item__) == userSvtId )
        return !v9;
      v9 = v8 < size;
      if ( size == v8 )
        return !v9;
...
void __fastcall UserServantNewManager__LoginProcess(const MethodInfo *method)
{
  ...
  if ( (byte_4BB59FD & 1) == 0 )
  {
    sub_1C13D24(&Method_DataManager_GetMasterData_UserServantMaster___, v1);
    sub_1C13D24(&Method_DataManager_GetMasterData_UserServantStorageMaster___, v2);
...
bool __fastcall UserServantNewManager__ReadData(const MethodInfo *method)
{
  ...
  if ( (byte_4BB5A01 & 1) == 0 )
  {
    ...
    sub_1C13D24(&UserServantNewManager_TypeInfo, v5);
    byte_4BB5A01 = 1;
  }
          ...
          do
          {
            ...
            if ( (unsigned int)size >= items->max_length )
            {
              System_Collections_Generic_List_long___AddWithResize(
                oldList,
                v23,
                *(const MethodInfo_3615200 **)(*(_QWORD *)(v27[4] + 192LL) + 112LL));
            }
            else
            {
...
void __fastcall UserServantNewManager__SetOld_41744504(System_Int64_array *userSvtList, const MethodInfo *method)
{
  __int64 v3; // x1
  __int64 v4; // x1
  __int64 v5; // x1
...
bool __fastcall UserServantNewManager__WriteData(const MethodInfo *method)
{
  ...
  if ( (byte_4BB5A02 & 1) == 0 )
  {
    ...
    sub_1C13D24(&UserServantNewManager_TypeInfo, v6);
    byte_4BB5A02 = 1;
  }
