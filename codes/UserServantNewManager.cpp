void __fastcall UserServantNewManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A20D55 & 1) == 0 )
  {
    sub_1B715CC(&Method_System_Collections_Generic_List_long___ctor__, v1);
    sub_1B715CC(&System_Collections_Generic_List_long__TypeInfo, v4);
    sub_1B715CC(&UserServantNewManager_TypeInfo, v5);
    sub_1B715CC(&StringLiteral_6613/*"Fgo_20150511_1"*/, v6);
    byte_4A20D55 = 1;
  }
  UserServantNewManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6613/*"Fgo_20150511_1"*/;
  sub_1B71570(
  ...
  *(_WORD *)&UserServantNewManager_TypeInfo->static_fields->isModfiy = 0;
  v7 = (System_Collections_Generic_List_long__o *)sub_1B71818(System_Collections_Generic_List_long__TypeInfo);
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&static_fields->oldList, (int32_t)v7, v9, v10);
}
...
void __fastcall UserServantNewManager__ClearSaveDataList(const MethodInfo *method)
{
  ...
  if ( (byte_4A20D4E & 1) == 0 )
  {
    sub_1B715CC(&Method_System_Collections_Generic_List_long__Clear__, v1);
    sub_1B715CC(&Method_System_Collections_Generic_List_long__get_Count__, v2);
    sub_1B715CC(&UserServantNewManager_TypeInfo, v3);
    byte_4A20D4E = 1;
  }
...
void __fastcall UserServantNewManager__CreateContinueDeviceSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4A20D4C & 1) == 0 )
  {
    sub_1B715CC(&UserServantNewManager_TypeInfo, v1);
    byte_4A20D4C = 1;
  }
...
bool __fastcall UserServantNewManager__IsNew(int64_t userSvtId, const MethodInfo *method)
{
  ...
  if ( (byte_4A20D50 & 1) == 0 )
  {
    ...
    sub_1B715CC(&UserServantNewManager_TypeInfo, v4);
    byte_4A20D50 = 1;
  }
  ...
  if ( size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( System_Collections_Generic_List_long___get_Item(
             ...
             v8 - 1,
             (const MethodInfo_34B7FA4 *)Method_System_Collections_Generic_List_long__get_Item__) == userSvtId )
        return !v9;
      v9 = v8 < size;
      if ( size == v8 )
        return !v9;
...
void __fastcall UserServantNewManager__LoginProcess(const MethodInfo *method)
{
  ...
  if ( (byte_4A20D4F & 1) == 0 )
  {
    sub_1B715CC(&Method_DataManager_GetMasterData_UserServantMaster___, v1);
    sub_1B715CC(&Method_DataManager_GetMasterData_UserServantStorageMaster___, v2);
...
bool __fastcall UserServantNewManager__ReadData(const MethodInfo *method)
{
  ...
  if ( !v7->static_fields->UseMock )
  {
    ...
    if ( System_IO_File__Exists(SaveFileName, 0LL) )
    {
          ...
          do
          {
            ...
            if ( (unsigned int)size >= items->max_length )
            {
              System_Collections_Generic_List_long___AddWithResize(
                oldList,
                v23,
                *(const MethodInfo_34B8294 **)(*(_QWORD *)(v27[4] + 192LL) + 112LL));
            }
            else
            {
      ...
      {
LABEL_35:
        v32 = sub_1BC35AC(v13, System_IDisposable_TypeInfo, 0LL);
      }
...
void __fastcall UserServantNewManager__SetOld(int64_t userSvtId, const MethodInfo *method)
{
  ...
  if ( (byte_4A20D51 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_System_Collections_Generic_List_long__get_Count__, v3);
    sub_1B715CC(&Method_System_Collections_Generic_List_long__get_Item__, v4);
    sub_1B715CC(&UserServantNewManager_TypeInfo, v5);
    byte_4A20D51 = 1;
  }
  v6 = UserServantNewManager_TypeInfo;
...
LABEL_19:
  ...
  if ( (unsigned int)namespaze_low >= *((_DWORD *)name + 6) )
  {
    System_Collections_Generic_List_long___AddWithResize(
      (System_Collections_Generic_List_long__o *)v6,
      userSvtId,
      *(const MethodInfo_34B8294 **)(*(_QWORD *)(v12[4] + 192LL) + 112LL));
    static_fields = UserServantNewManager_TypeInfo->static_fields;
  }
  else
  {
...
void __fastcall UserServantNewManager__SetOld_40357000(System_Int64_array *userSvtList, const MethodInfo *method)
{
  __int64 v3; // x1
  __int64 v4; // x1
  __int64 v5; // x1
            ...
            if ( m_Items[v15] >= 1 )
            {
              ...
              if ( (unsigned int)v21 >= *(_DWORD *)(v19 + 24) )
              {
                System_Collections_Generic_List_long___AddWithResize(
                  ...
                  (int64_t)method,
                  *(const MethodInfo_34B8294 **)(*(_QWORD *)(v20[4] + 192LL) + 112LL));
                static_fields = UserServantNewManager_TypeInfo->static_fields;
              }
              else
              {
...
bool __fastcall UserServantNewManager__WriteData(const MethodInfo *method)
{
  ...
  if ( (byte_4A20D54 & 1) == 0 )
  {
    ...
    sub_1B715CC(&UserServantNewManager_TypeInfo, v6);
    byte_4A20D54 = 1;
  }
