void UserServantNewManager___cctor(const MethodInfo *method)
{
  ...
  UserServantNewManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6664/*"Fgo_20150511_1"*/;
  sub_1C2D434((CGThumbnailListItem_o *)UserServantNewManager_TypeInfo->static_fields, StringLiteral_6664/*"Fgo_20150511_1"*/, v1, v2);
  ...
  if ( size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( System_Collections_Generic_List_long___get_Item(
             ...
             v6 - 1,
             (const MethodInfo_37718C8 *)Method_System_Collections_Generic_List_long__get_Item__) == userSvtId )
        return !v7;
      v7 = v6 < size;
      if ( size == v6 )
        return !v7;
          ...
          do
          {
            ...
            if ( (unsigned int)size >= LODWORD(items->max_length) )
            {
              System_Collections_Generic_List_long___AddWithResize(
                oldList,
                v18,
                *(const MethodInfo_3771BB8 **)(*(_QWORD *)(v22[4] + 192LL) + 112LL));
            }
            else
            {
...
LABEL_19:
  ...
  if ( (unsigned int)namespaze_low >= *((_DWORD *)name + 6) )
  {
    System_Collections_Generic_List_long___AddWithResize(
      (System_Collections_Generic_List_long__o *)v3,
      userSvtId,
      *(const MethodInfo_3771BB8 **)(*(_QWORD *)(v9[4] + 192LL) + 112LL));
    static_fields = UserServantNewManager_TypeInfo->static_fields;
  }
  else
  {
...
void UserServantNewManager__SetOld_43329660(System_Int64_array *userSvtList, const MethodInfo *method)
{
  __int64 v2; // x2
  ...
  if ( userSvtList )
  {
    ...
    if ( (int)max_length >= 1 )
    {
      ...
      v6 = *(_QWORD *)(*(_QWORD *)(oldList + 184) + 16LL);
      if ( v6 )
      {
        v7 = *(_DWORD *)(v6 + 24);
        if ( v7 < 1 )
...
LABEL_21:
          ...
          while ( 1 )
          {
            ...
            if ( m_Items[v13] >= 1 )
            {
              ...
              if ( !oldList )
                goto LABEL_36;
              method = (const MethodInfo *)m_Items[v13];
...
LABEL_35:
        ...
        while ( 1 )
        {
          ...
          while ( 1 )
          {
            if ( LODWORD(userSvtList->max_length) == v9 )
              goto LABEL_35;
            v10 = &userSvtList->obj.klass + v9;
            v12 = v10[4];
            v11 = v10 + 4;
            if ( (Il2CppClass *)oldList == v12 )
              break;
