void __fastcall UserServantNewManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B67ED8 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&UserServantNewManager_TypeInfo, v9);
    sub_1BE4ACC(&StringLiteral_6771/*"Fgo_20150511_1"*/, v10);
    byte_4B67ED8 = 1;
  }
  UserServantNewManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6771/*"Fgo_20150511_1"*/;
  sub_1BE4A70(
...
void __fastcall UserServantNewManager__ClearSaveDataList(const MethodInfo *method)
{
  ...
  if ( (byte_4B67ED1 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&UserServantNewManager_TypeInfo, v3);
    byte_4B67ED1 = 1;
  }
...
void __fastcall UserServantNewManager__CreateContinueDeviceSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4B67ECF & 1) == 0 )
  {
    sub_1BE4ACC(&UserServantNewManager_TypeInfo, v1);
    byte_4B67ECF = 1;
  }
...
bool __fastcall UserServantNewManager__IsNew(int64_t userSvtId, const MethodInfo *method)
{
  ...
  if ( (byte_4B67ED3 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&UserServantNewManager_TypeInfo, v4);
    byte_4B67ED3 = 1;
  }
  ...
  if ( size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( System_Collections_Generic_List_long___get_Item(
             ...
             v8 - 1,
             (const MethodInfo_35D3F68 *)Method_System_Collections_Generic_List_long__get_Item__) == userSvtId )
        return !v9;
      v9 = v8 < size;
      if ( size == v8 )
        return !v9;
...
void __fastcall UserServantNewManager__LoginProcess(const MethodInfo *method)
{
  ...
  if ( (byte_4B67ED2 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_DataManager_GetMasterData_UserServantMaster___, v1);
    sub_1BE4ACC(&Method_DataManager_GetMasterData_UserServantStorageMaster___, v2);
...
bool __fastcall UserServantNewManager__ReadData(const MethodInfo *method)
{
  ...
  if ( (byte_4B67ED6 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&UserServantNewManager_TypeInfo, v5);
    byte_4B67ED6 = 1;
  }
          ...
          do
          {
            ...
            if ( (unsigned int)size >= items->max_length )
            {
              System_Collections_Generic_List_long___AddWithResize(
                oldList,
                v23,
                *(const MethodInfo_35D4258 **)(*(_QWORD *)(v27[4] + 192LL) + 112LL));
            }
            else
            {
...
void __fastcall UserServantNewManager__SetOld_41547608(System_Int64_array *userSvtList, const MethodInfo *method)
{
  __int64 v3; // x1
  __int64 v4; // x1
  __int64 v5; // x1
...
bool __fastcall UserServantNewManager__WriteData(const MethodInfo *method)
{
  ...
  if ( (byte_4B67ED7 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&UserServantNewManager_TypeInfo, v6);
    byte_4B67ED7 = 1;
  }
