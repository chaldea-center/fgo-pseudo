void __fastcall EventEquipSkillReleaseMaster___ctor(EventEquipSkillReleaseMaster_o *this, const MethodInfo *method)
{
  ...
  DataMasterBase_object__object__object____ctor(
    ...
    273,
    (const MethodInfo_32E45D0 *)Method_DataMasterBase_EventEquipSkillReleaseMaster__EventEquipSkillReleaseEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (EventEquipSkillReleaseEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                             (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                             PK,
                                             (const MethodInfo_32E68F4 *)Method_DataMasterBase_EventEquipSkillReleaseMaster__EventEquipSkillReleaseEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_32E6940 *)Method_DataMasterBase_EventEquipSkillReleaseMaster__EventEquipSkillReleaseEntity__string__TryGetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B449F1 & 1) == 0 )
  {
    ...
    sub_1BDB878(&System_Collections_Generic_IEnumerator_EventEquipSkillReleaseEntity__TypeInfo, v8);
    sub_1BDB878(&System_Collections_IEnumerator_TypeInfo, v9);
    byte_4B449F1 = 1;
  }
  *outEnt = 0LL;
  sub_1BDB81C((CGThumbnailListItem_o *)outEnt, 0, (int32_t)outEnt, method);
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
    sub_1BDBAD4(0LL, v10);
  Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                 list,
                 (const MethodInfo_327DBFC *)Method_System_Collections_ObjectModel_Collection_EventEquipSkillReleaseEntity__GetEnumerator__);
  if ( !Enumerator )
    sub_1BDBAD4(0LL, v12);
  priority = -1;
  while ( 1 )
...
LABEL_10:
    ...
    {
LABEL_17:
      v22 = sub_1C2C00C(Enumerator, System_Collections_Generic_IEnumerator_EventEquipSkillReleaseEntity__TypeInfo, 0LL);
    }
    ...
    {
      *outEnt = v25;
      sub_1BDB81C((CGThumbnailListItem_o *)outEnt, (int32_t)v25, v26, v27);
      priority = v25->fields.priority;
    }
  }
