...
int32_t __fastcall BgmEntity__GetPriorityBgm(BgmEntity_o *this, const MethodInfo *method)
{
  if ( (byte_49BAB00 & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_22330/*"priorityBgm"*/, method);
    byte_49BAB00 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_22330/*"priorityBgm"*/, 0, 0LL);
}
