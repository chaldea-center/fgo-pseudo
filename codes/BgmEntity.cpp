...
int32_t __fastcall BgmEntity__GetPriorityBgm(BgmEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4A1F784 & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_22546/*"priorityBgm"*/, method);
    byte_4A1F784 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_22546/*"priorityBgm"*/, 0, 0LL);
}
