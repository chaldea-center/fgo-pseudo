void __fastcall MapUpdateScheduleMaster___ctor(MapUpdateScheduleMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4B1C9EE & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataMasterBase_MapUpdateScheduleMaster__MapUpdateScheduleEntity__string___ctor__, method);
    byte_4B1C9EE = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    496,
    (const MethodInfo_32CA594 *)Method_DataMasterBase_MapUpdateScheduleMaster__MapUpdateScheduleEntity__string___ctor__);
}
...
bool __fastcall MapUpdateScheduleMaster__Any(MapUpdateScheduleMaster_o *this, int32_t warId, const MethodInfo *method)
{
  ...
  if ( (byte_4B1C9EC & 1) == 0 )
  {
    sub_1BCAFF8(&Method_System_Linq_Enumerable_Any_MapUpdateScheduleEntity___, *(_QWORD *)&warId);
    sub_1BCAFF8(&System_Func_MapUpdateScheduleEntity__bool__TypeInfo, v5);
    sub_1BCAFF8(&Method_MapUpdateScheduleMaster___c__DisplayClass0_0__Any_b__0__, v6);
    sub_1BCAFF8(&MapUpdateScheduleMaster___c__DisplayClass0_0_TypeInfo, v7);
    byte_4B1C9EC = 1;
  }
  v8 = sub_1BCB244(MapUpdateScheduleMaster___c__DisplayClass0_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v8, 0LL);
  if ( !v8 )
    sub_1BCB254(v9, v10);
  *(_DWORD *)(v8 + 16) = warId;
  list = this->fields.list;
  v12 = (System_Func_object__bool__o *)sub_1BCB244(System_Func_MapUpdateScheduleEntity__bool__TypeInfo);
  ...
  return System_Linq_Enumerable__Any_object__50496752(
           ...
           (const MethodInfo_30284F0 *)Method_System_Linq_Enumerable_Any_MapUpdateScheduleEntity___);
}
        ...
        const MethodInfo *method)
{
  ...
  return (MapUpdateScheduleEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                        (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                        PK,
                                        (const MethodInfo_32CC8B8 *)Method_DataMasterBase_MapUpdateScheduleMaster__MapUpdateScheduleEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1C9ED & 1) == 0 )
  {
    sub_1BCAFF8(&Method_System_Collections_ObjectModel_Collection_MapUpdateScheduleEntity__GetEnumerator__, warInfo);
    sub_1BCAFF8(&System_IDisposable_TypeInfo, v5);
    sub_1BCAFF8(&System_Collections_Generic_IEnumerator_MapUpdateScheduleEntity__TypeInfo, v6);
  ...
  Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                 Time,
                 (const MethodInfo_3263BC0 *)Method_System_Collections_ObjectModel_Collection_MapUpdateScheduleEntity__GetEnumerator__);
  if ( !Enumerator )
    sub_1BCB254(0LL, v14);
  while ( 1 )
  {
...
LABEL_12:
    ...
    {
LABEL_19:
      v24 = sub_1C1B560(Enumerator, System_Collections_Generic_IEnumerator_MapUpdateScheduleEntity__TypeInfo, 0LL);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1C9F0 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataMasterBase_MapUpdateScheduleMaster__MapUpdateScheduleEntity__string__TryGetEntity__, entity);
    byte_4B1C9F0 = 1;
  }
  PK = (Il2CppObject *)MapUpdateScheduleEntity__CreatePK(warId, mapUpdatedAt, 0LL);
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_32CC904 *)Method_DataMasterBase_MapUpdateScheduleMaster__MapUpdateScheduleEntity__string__TryGetEntity__);
}
