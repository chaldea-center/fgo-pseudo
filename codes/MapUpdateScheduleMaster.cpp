void __fastcall MapUpdateScheduleMaster___ctor(MapUpdateScheduleMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4C2230B & 1) == 0 )
  {
    sub_1C3B764(&Method_DataMasterBase_MapUpdateScheduleMaster__MapUpdateScheduleEntity__string___ctor__, method);
    byte_4C2230B = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    496,
    (const MethodInfo_329D5DC *)Method_DataMasterBase_MapUpdateScheduleMaster__MapUpdateScheduleEntity__string___ctor__);
}
...
bool __fastcall MapUpdateScheduleMaster__Any(MapUpdateScheduleMaster_o *this, int32_t warId, const MethodInfo *method)
{
  ...
  if ( (byte_4C22309 & 1) == 0 )
  {
    sub_1C3B764(&Method_System_Linq_Enumerable_Any_MapUpdateScheduleEntity___, *(_QWORD *)&warId);
    sub_1C3B764(&System_Func_MapUpdateScheduleEntity__bool__TypeInfo, v5);
    sub_1C3B764(&Method_MapUpdateScheduleMaster___c__DisplayClass0_0__Any_b__0__, v6);
    sub_1C3B764(&MapUpdateScheduleMaster___c__DisplayClass0_0_TypeInfo, v7);
    byte_4C22309 = 1;
  }
  v8 = sub_1C3B9B0(MapUpdateScheduleMaster___c__DisplayClass0_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v8, 0LL);
  if ( !v8 )
    sub_1C3B9C0(v9, v10);
  *(_DWORD *)(v8 + 16) = warId;
  list = this->fields.list;
  v12 = (System_Func_object__bool__o *)sub_1C3B9B0(System_Func_MapUpdateScheduleEntity__bool__TypeInfo);
  ...
  return System_Linq_Enumerable__Any_object__50322132(
           ...
           (const MethodInfo_2FFDAD4 *)Method_System_Linq_Enumerable_Any_MapUpdateScheduleEntity___);
}
        ...
        const MethodInfo *method)
{
  ...
  return (MapUpdateScheduleEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                        (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                        PK,
                                        (const MethodInfo_329F900 *)Method_DataMasterBase_MapUpdateScheduleMaster__MapUpdateScheduleEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2230A & 1) == 0 )
  {
    sub_1C3B764(&Method_System_Collections_ObjectModel_Collection_MapUpdateScheduleEntity__GetEnumerator__, warInfo);
    sub_1C3B764(&System_IDisposable_TypeInfo, v5);
    sub_1C3B764(&System_Collections_Generic_IEnumerator_MapUpdateScheduleEntity__TypeInfo, v6);
  ...
  Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                 Time,
                 (const MethodInfo_32357CC *)Method_System_Collections_ObjectModel_Collection_MapUpdateScheduleEntity__GetEnumerator__);
  if ( !Enumerator )
    sub_1C3B9C0(0LL, v14);
  while ( 1 )
  {
...
LABEL_12:
    ...
    {
LABEL_19:
      v24 = sub_1C8D744(Enumerator, System_Collections_Generic_IEnumerator_MapUpdateScheduleEntity__TypeInfo, 0LL);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2230D & 1) == 0 )
  {
    sub_1C3B764(&Method_DataMasterBase_MapUpdateScheduleMaster__MapUpdateScheduleEntity__string__TryGetEntity__, entity);
    byte_4C2230D = 1;
  }
  PK = (Il2CppObject *)MapUpdateScheduleEntity__CreatePK(warId, mapUpdatedAt, 0LL);
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_329F94C *)Method_DataMasterBase_MapUpdateScheduleMaster__MapUpdateScheduleEntity__string__TryGetEntity__);
}
