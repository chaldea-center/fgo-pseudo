void __fastcall MapUpdateScheduleMaster___ctor(MapUpdateScheduleMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A2E2B9 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_MapUpdateScheduleMaster__MapUpdateScheduleEntity__string___ctor__, method);
    byte_4A2E2B9 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    489,
    (const MethodInfo_30FFA98 *)Method_DataMasterBase_MapUpdateScheduleMaster__MapUpdateScheduleEntity__string___ctor__);
}
...
bool __fastcall MapUpdateScheduleMaster__Any(MapUpdateScheduleMaster_o *this, int32_t warId, const MethodInfo *method)
{
  ...
  if ( (byte_4A2E2B7 & 1) == 0 )
  {
    sub_1B761C0(&Method_System_Linq_Enumerable_Any_DataEntityBase____75944576, *(_QWORD *)&warId);
    sub_1B761C0(&System_Func_DataEntityBase__bool__TypeInfo, v5);
    sub_1B761C0(&Method_MapUpdateScheduleMaster___c__DisplayClass0_0__Any_b__0__, v6);
    sub_1B761C0(&MapUpdateScheduleMaster___c__DisplayClass0_0_TypeInfo, v7);
    byte_4A2E2B7 = 1;
  }
  v8 = sub_1B7640C(MapUpdateScheduleMaster___c__DisplayClass0_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v8, 0LL);
  if ( !v8 )
    sub_1B7641C(v9, v10);
  *(_DWORD *)(v8 + 16) = warId;
  list = this->fields.list;
  v12 = (System_Func_object__bool__o *)sub_1B7640C(System_Func_DataEntityBase__bool__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  return (MapUpdateScheduleEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                        (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                        PK,
                                        (const MethodInfo_30FFAD8 *)Method_DataMasterBase_MapUpdateScheduleMaster__MapUpdateScheduleEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E2B8 & 1) == 0 )
  {
    sub_1B761C0(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__GetEnumerator__, warInfo);
    ...
    sub_1B761C0(&MapUpdateScheduleEntity_TypeInfo, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E2BB & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_MapUpdateScheduleMaster__MapUpdateScheduleEntity__string__TryGetEntity__, entity);
    byte_4A2E2BB = 1;
  }
  PK = (Il2CppObject *)MapUpdateScheduleEntity__CreatePK(warId, mapUpdatedAt, 0LL);
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_30FFB28 *)Method_DataMasterBase_MapUpdateScheduleMaster__MapUpdateScheduleEntity__string__TryGetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E2BC & 1) == 0 )
  {
    this = (MapUpdateScheduleMaster___c__DisplayClass0_0_o *)sub_1B761C0(&MapUpdateScheduleEntity_TypeInfo, n);
    byte_4A2E2BC = 1;
  }
  if ( !n )
LABEL_8:
