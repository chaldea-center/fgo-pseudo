...
void __fastcall SubmarineMapPanelComponent__Initialize(SubmarineMapPanelComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields._OnClickPanel_k__BackingField, 0LL, v2, v3, v4, v5, v6, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC45CD & 1) == 0 )
  {
    sub_1C1ABD4(&Method_UnityEngine_GameObject_GetComponent_UITexture___, objDomain);
...
LABEL_17:
    sub_1C1AE30(closedPanel, objDomain);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  SubmarineMapPanelComponent__SetSize_34644636(
    this,
...
void __fastcall SubmarineMapPanelComponent__SetSize_34644636(
        SubmarineMapPanelComponent_o *this,
        float width,
        float height,
        const MethodInfo *method)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC45CE & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_GameObjectExtensions_SafeGetComponent_TweenAlpha___, v4);
    sub_1C1ABD4(&Method_System_Collections_Generic_List_EventDelegate__Add__, v5);
    sub_1C1ABD4(&Method_SubmarineMapPanelComponent_OnPanelFadeOutFinished__, v6);
    byte_4BC45CE = 1;
  }
  Component_object = GameObjectExtensions__SafeGetComponent_object_(
                       this->fields.closedPanel,
  ...
  EventDelegate_Callback___ctor(
    ...
    0LL);
  v12 = (EventDelegate_o *)sub_1C1AE20(EventDelegate_TypeInfo);
  EventDelegate___ctor_47893424(v12, v11, 0LL);
  if ( !onFinished
