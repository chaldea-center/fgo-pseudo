...
void SubmarineMapPanelComponent__Initialize(SubmarineMapPanelComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields._OnClickPanel_k__BackingField, 0, v2, v3, v4, v5, v6, v7);
}
...
LABEL_17:
    sub_1C942F0(closedPanel, objDomain);
  }
}
        ...
        const MethodInfo *method)
{
  if ( !objDomain )
    sub_1C942F0(this, 0);
  SubmarineMapPanelComponent__SetSize_36602248(
    this,
...
void SubmarineMapPanelComponent__SetSize_36602248(
        SubmarineMapPanelComponent_o *this,
        float width,
        float height,
        const MethodInfo *method)
...
void SubmarineMapPanelComponent__ShowOpenPanelAnim(SubmarineMapPanelComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D29034 & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_SubmarineMapPanelComponent_OnPanelFadeOutFinished__);
    byte_4D29034 = 1;
  }
  Component_object = GameObjectExtensions__SafeGetComponent_object_(
                       this->fields.closedPanel,
  ...
  EventDelegate___ctor_49964596(v8, v7, 0);
  if ( !onFinished
