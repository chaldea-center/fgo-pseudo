...
void SubmarineMapPanelComponent__Initialize(SubmarineMapPanelComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields._OnClickPanel_k__BackingField, 0, v2, v3, v4, v5, v6, v7);
}
...
LABEL_17:
    sub_1C7BD40(closedPanel, objDomain);
  }
}
        ...
        const MethodInfo *method)
{
  if ( !objDomain )
    sub_1C7BD40(this, 0);
  SubmarineMapPanelComponent__SetSize_36411400(
    this,
...
void SubmarineMapPanelComponent__SetSize_36411400(
        SubmarineMapPanelComponent_o *this,
        float width,
        float height,
        const MethodInfo *method)
...
void SubmarineMapPanelComponent__ShowOpenPanelAnim(SubmarineMapPanelComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEAE8E & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_SubmarineMapPanelComponent_OnPanelFadeOutFinished__);
    byte_4CEAE8E = 1;
  }
  Component_object = GameObjectExtensions__SafeGetComponent_object_(
                       this->fields.closedPanel,
  ...
  EventDelegate___ctor_49792828(v8, v7, 0);
  if ( !onFinished
