...
void __fastcall SubmarineMapPanelComponent__Initialize(SubmarineMapPanelComponent_o *this, const MethodInfo *method)
{
  ...
  sub_B52920((BattleServantConfConponent_o *)&this->fields._OnClickPanel_k__BackingField, 0LL, v2, v3, v4, v5, v6, v7);
}
...
LABEL_19:
    sub_B52A5C(closedPanel, objDomain);
  }
}
        ...
        const MethodInfo *method)
{
  if ( !objDomain )
    sub_B52A5C(this, 0LL);
  SubmarineMapPanelComponent__SetSize_23156740(
    this,
...
void __fastcall SubmarineMapPanelComponent__SetSize_23156740(
        SubmarineMapPanelComponent_o *this,
        float width,
        float height,
        const MethodInfo *method)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AEE65 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_SubmarineMapPanelComponent_OnPanelFadeOutFinished__);
    byte_42AEE65 = 1;
  }
  Component_UIWidget = GameObjectExtensions__SafeGetComponent_UIWidget_(
                         this->fields.closedPanel,
  ...
  *(_QWORD *)&Component_UIWidget->fields.mRootSet = 1065353216LL;
  ...
  EventDelegate___ctor_29649660(v8, v7, 0LL);
  if ( !onFinished )
LABEL_6:
    sub_B52A5C(Component_UIWidget, v4);
