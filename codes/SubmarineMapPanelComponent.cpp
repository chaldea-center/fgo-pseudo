...
void SubmarineMapPanelComponent__Initialize(SubmarineMapPanelComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields._OnClickPanel_k__BackingField, 0, v2, v3);
}
...
LABEL_17:
    sub_1C2D6EC(closedPanel, objDomain);
  }
}
        ...
        const MethodInfo *method)
{
  if ( !objDomain )
    sub_1C2D6EC(this, 0);
  SubmarineMapPanelComponent__SetSize_35806608(
    this,
...
void SubmarineMapPanelComponent__SetSize_35806608(
        SubmarineMapPanelComponent_o *this,
        float width,
        float height,
        const MethodInfo *method)
...
void SubmarineMapPanelComponent__ShowOpenPanelAnim(SubmarineMapPanelComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C23C2E & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_SubmarineMapPanelComponent_OnPanelFadeOutFinished__);
    byte_4C23C2E = 1;
  }
  Component_object = GameObjectExtensions__SafeGetComponent_object_(
                       this->fields.closedPanel,
  ...
  EventDelegate___ctor_49170772(v8, v7, 0);
  if ( !onFinished
        ...
        const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields._OnClickPanel_k__BackingField, (int32_t)value, (int32_t)method, v3);
}