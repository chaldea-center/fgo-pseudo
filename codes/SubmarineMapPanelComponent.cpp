...
void __fastcall SubmarineMapPanelComponent__Initialize(SubmarineMapPanelComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields._OnClickPanel_k__BackingField, 0, v2, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB291C & 1) == 0 )
  {
    sub_1BAB41C(&Method_UnityEngine_GameObject_GetComponent_UITexture___, objDomain);
...
LABEL_17:
    sub_1BAB678(closedPanel, objDomain);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  SubmarineMapPanelComponent__SetSize_33908108(
    this,
...
void __fastcall SubmarineMapPanelComponent__SetSize_33908108(
        SubmarineMapPanelComponent_o *this,
        float width,
        float height,
        const MethodInfo *method)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB291D & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_GameObjectExtensions_SafeGetComponent_TweenAlpha___, v4);
    sub_1BAB41C(&Method_System_Collections_Generic_List_EventDelegate__Add__, v5);
    sub_1BAB41C(&Method_SubmarineMapPanelComponent_OnPanelFadeOutFinished__, v6);
    byte_4AB291D = 1;
  }
  Component_object = GameObjectExtensions__SafeGetComponent_object_(
                       this->fields.closedPanel,
  ...
  EventDelegate_Callback___ctor(
    ...
    0LL);
  v12 = (EventDelegate_o *)sub_1BAB668(EventDelegate_TypeInfo);
  EventDelegate___ctor_47033092(v12, v11, 0LL);
  if ( !onFinished
