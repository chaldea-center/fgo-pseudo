        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B65EEF & 1) == 0 )
  {
    sub_1BE4ACC(&Method_BasicHelper_Any_EventGroupEntity___, method);
    sub_1BE4ACC(&Method_DataManager_GetMasterData_ServantFilterMaster___, v3);
    sub_1BE4ACC(&Method_DataManager_GetMaster_EventCampaignMaster___, v4);
    sub_1BE4ACC(&Method_DataManager_GetMaster_EventGroupMaster___, v5);
    sub_1BE4ACC(&DataManager_TypeInfo, v6);
    sub_1BE4ACC(&System_Func_EventGroupEntity__bool__TypeInfo, v7);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_EventGroupEntity__get_Count__, v8);
    sub_1BE4ACC(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, v9);
    sub_1BE4ACC(&Method_ServantCharaGraphFilterLogic__IsEventUpValShow_b__11_0__, v10);
    this = (ServantCharaGraphFilterLogic_o *)sub_1BE4ACC(
...
LABEL_34:
  ...
  switch ( sort->fields.bonusKind2 )
  {
    case 0:
      ...
      Master_object = DataManager__GetMaster_object_((const MethodInfo_2F590BC *)Method_DataManager_GetMaster_EventGroupMaster___);
...
LABEL_33:
    ...
    case 3:
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      v20 = DataManager__GetMaster_object_((const MethodInfo_2F590BC *)Method_DataManager_GetMaster_EventCampaignMaster___);
    ...
    case 5:
      ...
      return UserServantEntity__getEventUpVal_41168560(
               ...
               0LL);
    case 7:
      this = (ServantCharaGraphFilterLogic_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( !this )
        goto LABEL_34;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B65EEC & 1) == 0 )
  {
    sub_1BE4ACC(&ServantEventBonusFilterController_TypeInfo, method);
    byte_4B65EEC = 1;
  }
  sort = this->fields.sort;
  if ( !sort )
        ...
        const MethodInfo *method)
{
  ...
  if ( ListViewSort__CheckSvtEquipEffectFilterDefaultAll((ListViewSort_o *)sort, 0LL) )
    return 1;
  v5 = this->fields.sort;
  sort = (void *)sub_1BE4B74(ListViewSort_FilterKind___TypeInfo, 1LL);
  if ( !sort )
    goto LABEL_22;
  ...
  *((_DWORD *)sort + 8) = 50;
  if ( !v5
    || (IsUnSelectedAllTargetFilters = ListViewSort__IsUnSelectedAllTargetFilters(
        ...
        (sort = (void *)sub_1BE4B74(ListViewSort_FilterKind___TypeInfo, 1LL)) == 0LL) )
  {
LABEL_22:
    sub_1BE4D28(sort, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  v12 = DataManager__GetMaster_object_((const MethodInfo_2F590BC *)Method_DataManager_GetMaster_ServantFilterMaster___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B65EE7 & 1) == 0 )
  {
    sub_1BE4ACC(&CharaGraphServantListViewItem_TypeInfo, method);
    byte_4B65EE7 = 1;
  }
