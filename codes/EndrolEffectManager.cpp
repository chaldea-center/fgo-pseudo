void EndrolEffectManager___cctor(const MethodInfo *method)
{
  if ( (byte_596A496 & 1) == 0 )
  {
    sub_2213A60(&EndrolEffectManager_TypeInfo);
    byte_596A496 = 1;
  }
...
void EndrolEffectManager___ctor(EndrolEffectManager_o *this, const MethodInfo *method)
{
  if ( (byte_596A495 & 1) == 0 )
  {
    sub_2213A60(&Method_SingletonMonoBehaviour_EndrolEffectManager___ctor__);
    byte_596A495 = 1;
  }
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_47A2F28 *)Method_SingletonMonoBehaviour_EndrolEffectManager___ctor__);
}
...
void EndrolEffectManager__CalcGridPoint(EndrolEffectManager_o *this, const MethodInfo *method)
{
  ...
  v3 = (System_Collections_Generic_List_Vector2__o *)sub_2213CCC(System_Collections_Generic_List_Vector2__TypeInfo);
  ...
  sub_2213A04((MissionNaviTransitionBoardItem_o *)p_bgGridPointList, (int32_t)v3, v5, v6, v7, v8, v9, v10);
  for ( i = 0; i != 26; ++i )
  {
    for ( j = 0; j != 46; ++j )
    {
...
LABEL_15:
          ...
          if ( (unsigned int)size >= LODWORD(items->max_length) )
          {
            ...
            System_Collections_Generic_List_Vector2___AddWithResize(
              v18,
              v23,
              *(const MethodInfo_44E0CFC **)(*(_QWORD *)(v20[4] + 192LL) + 112LL));
          }
          else
          {
...
int32_t EndrolEffectManager__CheckOverlap(EndrolEffectManager_o *this, double checkTime, const MethodInfo *method)
{
  ...
  if ( (byte_596A493 & 1) == 0 )
  {
    sub_2213A60(&Method_System_Collections_Generic_List_Enumerator_double__Dispose__);
    sub_2213A60(&Method_System_Collections_Generic_List_Enumerator_double__MoveNext__);
    sub_2213A60(&Method_System_Collections_Generic_List_Enumerator_double__get_Current__);
    sub_2213A60(&Method_System_Collections_Generic_List_double__GetEnumerator__);
    byte_596A493 = 1;
  }
  ...
  System_Collections_Generic_List_double___GetEnumerator(
    ...
    (const MethodInfo_44587B0 *)Method_System_Collections_Generic_List_double__GetEnumerator__);
  v6 = 0;
  while ( System_Collections_Generic_List_Enumerator_double___MoveNext(
            &v8,
            (const MethodInfo_40F2BBC *)Method_System_Collections_Generic_List_Enumerator_double__MoveNext__) )
  {
  ...
  System_Collections_Generic_List_Enumerator_double___Dispose(
    &v8,
    (const MethodInfo_40F2BB8 *)Method_System_Collections_Generic_List_Enumerator_double__Dispose__);
  return v6;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596A492 & 1) == 0 )
  {
    sub_2213A60(&Method_UnityEngine_GameObject_AddComponent_EndrolEffectItem___);
    sub_2213A60(&Method_UnityEngine_Object_Instantiate_GameObject___);
    this = (EndrolEffectManager_o *)sub_2213A60(&UnityEngine_Object_TypeInfo);
    byte_596A492 = 1;
  }
  effectObject = v5->fields.effectObject;
  if ( !effectObject )
    goto LABEL_15;
  v7 = UnityEngine_Random__Range_83400680(0, effectObject->max_length, 0);
  ...
  if ( !byte_5969AE5 )
  {
    this = (EndrolEffectManager_o *)sub_2213A60(&UnityEngine_Vector3_TypeInfo);
    byte_5969AE5 = 1;
  }
  if ( !v14 )
LABEL_15:
  ...
  UnityEngine_GameObject__AddComponent_object_(
    ...
    (const MethodInfo_38B6EB0 *)Method_UnityEngine_GameObject_AddComponent_EndrolEffectItem___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596A490 & 1) == 0 )
  {
    sub_2213A60(&Method_System_Collections_Generic_List_double__Add__);
    sub_2213A60(&Method_System_Collections_Generic_List_double__Sort__);
    sub_2213A60(&Method_System_Collections_Generic_List_double___ctor__);
    sub_2213A60(&System_Collections_Generic_List_double__TypeInfo);
    byte_596A490 = 1;
  }
  v17 = (System_Collections_Generic_List_double__o *)sub_2213CCC(System_Collections_Generic_List_double__TypeInfo);
  System_Collections_Generic_List_double____ctor(
    v17,
    (const MethodInfo_445746C *)Method_System_Collections_Generic_List_double___ctor__);
  ...
  if ( v36 >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      v41 = UnityEngine_Random__Range_83400680(miny, maxy + 1, 0);
      if ( v41 >= 1 )
        break;
LABEL_26:
      if ( ++v37 == v36 )
    ...
    while ( 1 )
    {
      ...
      if ( (unsigned int)size >= LODWORD(items->max_length) )
      {
        System_Collections_Generic_List_double___AddWithResize(
          v45,
          v49,
          *(const MethodInfo_4457D00 **)(*(_QWORD *)(v47[4] + 192LL) + 112LL));
      }
      else
      {
...
LABEL_27:
  ...
  System_Collections_Generic_List_double___Sort(
    v45,
    (const MethodInfo_4459604 *)Method_System_Collections_Generic_List_double__Sort__);
...
void EndrolEffectManager__Update(EndrolEffectManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596A48F & 1) == 0 )
  {
    sub_2213A60(&Method_System_Collections_Generic_List_Vector2__Remove__);
    sub_2213A60(&Method_System_Collections_Generic_List_double__get_Count__);
    ...
    this = (EndrolEffectManager_o *)sub_2213A60(&Method_System_Collections_Generic_List_double__get_Item__);
    byte_596A48F = 1;
  }
    ...
    if ( passageTime <= v2->fields.totalTime && !v2->fields.isForceEnd )
    {
      ...
      if ( truncateTime != v7 )
      {
        ...
        if ( System_Collections_Generic_List_double___get_Item(
               ...
               (const MethodInfo_4457A04 *)Method_System_Collections_Generic_List_double__get_Item__) == v2->fields.truncateTime )
        {
          ...
          if ( (int)this >= 1 )
          {
            ...
            while ( 1 )
            {
              ...
              if ( !bgGridPointList )
                break;
              this = (EndrolEffectManager_o *)UnityEngine_Random__Range_83400680(0, bgGridPointList->fields._size, 0);
              ...
              this = (EndrolEffectManager_o *)System_Collections_Generic_List_Vector2___Remove(
                                                v13,
                                                v15,
                                                (const MethodInfo_44E21FC *)Method_System_Collections_Generic_List_Vector2__Remove__);
              --v9;
              ++v2->fields.nowPlayEffectNumber;
              if ( !v9 )
                return;
