void EndrolEffectManager___cctor(const MethodInfo *method)
{
  if ( (byte_4CC1541 & 1) == 0 )
  {
    sub_1C713B0(&EndrolEffectManager_TypeInfo);
    byte_4CC1541 = 1;
  }
...
void EndrolEffectManager___ctor(EndrolEffectManager_o *this, const MethodInfo *method)
{
  if ( (byte_4CC1540 & 1) == 0 )
  {
    sub_1C713B0(&Method_SingletonMonoBehaviour_EndrolEffectManager___ctor__);
    byte_4CC1540 = 1;
  }
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_3A5F640 *)Method_SingletonMonoBehaviour_EndrolEffectManager___ctor__);
}
...
void EndrolEffectManager__CalcGridPoint(EndrolEffectManager_o *this, const MethodInfo *method)
{
  ...
  v3 = (System_Collections_Generic_List_Vector2__o *)sub_1C715FC(System_Collections_Generic_List_Vector2__TypeInfo);
  ...
  sub_1C71354(p_bgGridPointList, v3);
  for ( i = 0; i != 26; ++i )
  {
    for ( j = 0; j != 46; ++j )
    {
...
LABEL_15:
          ...
          if ( (unsigned int)size >= LODWORD(items->max_length) )
          {
            ...
            System_Collections_Generic_List_Vector2___AddWithResize(
              v11,
              v16,
              *(const MethodInfo_3890364 **)(*(_QWORD *)(v13[4] + 192LL) + 112LL));
          }
          else
          {
...
int32_t EndrolEffectManager__CheckOverlap(EndrolEffectManager_o *this, double checkTime, const MethodInfo *method)
{
  ...
  if ( (byte_4CC153E & 1) == 0 )
  {
    sub_1C713B0(&Method_System_Collections_Generic_List_Enumerator_double__Dispose__);
    sub_1C713B0(&Method_System_Collections_Generic_List_Enumerator_double__MoveNext__);
    sub_1C713B0(&Method_System_Collections_Generic_List_Enumerator_double__get_Current__);
    sub_1C713B0(&Method_System_Collections_Generic_List_double__GetEnumerator__);
    byte_4CC153E = 1;
  }
  ...
  System_Collections_Generic_List_double___GetEnumerator(
    ...
    (const MethodInfo_37E72BC *)Method_System_Collections_Generic_List_double__GetEnumerator__);
  v6 = 0;
  v9 = v8;
  while ( System_Collections_Generic_List_Enumerator_double___MoveNext(
            &v9,
            (const MethodInfo_35911E4 *)Method_System_Collections_Generic_List_Enumerator_double__MoveNext__) )
  {
  ...
  System_Collections_Generic_List_Enumerator_double___Dispose(
    &v9,
    (const MethodInfo_35911E0 *)Method_System_Collections_Generic_List_Enumerator_double__Dispose__);
  return v6;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC153D & 1) == 0 )
  {
    sub_1C713B0(&Method_UnityEngine_GameObject_AddComponent_EndrolEffectItem___);
    sub_1C713B0(&Method_UnityEngine_Object_Instantiate_GameObject___);
    this = (EndrolEffectManager_o *)sub_1C713B0(&UnityEngine_Object_TypeInfo);
    byte_4CC153D = 1;
  }
  effectObject = v5->fields.effectObject;
  if ( !effectObject )
    goto LABEL_15;
  v7 = UnityEngine_Random__Range_71684320(0, effectObject->max_length, 0);
  ...
  if ( !byte_4CC0D0E )
  {
    this = (EndrolEffectManager_o *)sub_1C713B0(&UnityEngine_Vector3_TypeInfo);
    byte_4CC0D0E = 1;
  }
  if ( !v12 )
LABEL_15:
  ...
  UnityEngine_GameObject__AddComponent_object_(
    ...
    (const MethodInfo_31A2DE8 *)Method_UnityEngine_GameObject_AddComponent_EndrolEffectItem___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC153B & 1) == 0 )
  {
    sub_1C713B0(&Method_System_Collections_Generic_List_double__Add__);
    sub_1C713B0(&Method_System_Collections_Generic_List_double__Sort__);
    sub_1C713B0(&Method_System_Collections_Generic_List_double___ctor__);
    sub_1C713B0(&System_Collections_Generic_List_double__TypeInfo);
    byte_4CC153B = 1;
  }
  v17 = (System_Collections_Generic_List_double__o *)sub_1C715FC(System_Collections_Generic_List_double__TypeInfo);
  System_Collections_Generic_List_double____ctor(
    v17,
    (const MethodInfo_37E5F88 *)Method_System_Collections_Generic_List_double___ctor__);
  this->fields.effectOccurrenceTime = v17;
  p_effectOccurrenceTime = &this->fields.effectOccurrenceTime;
  sub_1C71354(&this->fields.effectOccurrenceTime, v17);
  this->fields.objectParent = parent;
  sub_1C71354(&this->fields.objectParent, parent);
  ...
  if ( v23 >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      v29 = UnityEngine_Random__Range_71684320(miny, v25, 0);
      if ( v29 >= 1 )
        break;
LABEL_26:
      if ( ++v24 == v23 )
    ...
    while ( 1 )
    {
      ...
      if ( (unsigned int)size >= LODWORD(items->max_length) )
      {
        System_Collections_Generic_List_double___AddWithResize(
          v33,
          v37,
          *(const MethodInfo_37E67E4 **)(*(_QWORD *)(v35[4] + 192LL) + 112LL));
      }
      else
      {
...
LABEL_27:
  ...
  System_Collections_Generic_List_double___Sort(
    v33,
    (const MethodInfo_37E8128 *)Method_System_Collections_Generic_List_double__Sort__);
...
void EndrolEffectManager__Update(EndrolEffectManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC153A & 1) == 0 )
  {
    sub_1C713B0(&Method_System_Collections_Generic_List_Vector2__Remove__);
    sub_1C713B0(&Method_System_Collections_Generic_List_double__get_Count__);
    ...
    this = (EndrolEffectManager_o *)sub_1C713B0(&Method_System_Collections_Generic_List_double__get_Item__);
    byte_4CC153A = 1;
  }
    ...
    if ( passageTime <= v2->fields.totalTime && !v2->fields.isForceEnd )
    {
      ...
      if ( truncateTime != v7 )
      {
        ...
        Item = System_Collections_Generic_List_double___get_Item(
                 ...
                 (const MethodInfo_37E64EC *)Method_System_Collections_Generic_List_double__get_Item__);
        ...
        if ( Item == v10 )
        {
          ...
          if ( (int)this >= 1 )
          {
            ...
            while ( 1 )
            {
              ...
              if ( !bgGridPointList )
                break;
              this = (EndrolEffectManager_o *)UnityEngine_Random__Range_71684320(0, bgGridPointList->fields._size, 0);
              ...
              this = (EndrolEffectManager_o *)System_Collections_Generic_List_Vector2___Remove(
                                                v15,
                                                v17,
                                                (const MethodInfo_38918AC *)Method_System_Collections_Generic_List_Vector2__Remove__);
              --v11;
              ++v2->fields.nowPlayEffectNumber;
              if ( !v11 )
                return;
