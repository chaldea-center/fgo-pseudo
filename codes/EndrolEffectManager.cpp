void __fastcall EndrolEffectManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B6A9E3 & 1) == 0 )
  {
    sub_1BE4ACC(&EndrolEffectManager_TypeInfo, v1);
    byte_4B6A9E3 = 1;
  }
...
void __fastcall EndrolEffectManager___ctor(EndrolEffectManager_o *this, const MethodInfo *method)
{
  if ( (byte_4B6A9E2 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_SingletonMonoBehaviour_EndrolEffectManager___ctor__, method);
    byte_4B6A9E2 = 1;
  }
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_38291E0 *)Method_SingletonMonoBehaviour_EndrolEffectManager___ctor__);
}
...
void __fastcall EndrolEffectManager__CalcGridPoint(EndrolEffectManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6A9DE & 1) == 0 )
  {
    sub_1BE4ACC(&EndrolEffectManager_TypeInfo, method);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Vector2__Add__, v3);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Vector2___ctor__, v4);
    sub_1BE4ACC(&System_Collections_Generic_List_Vector2__TypeInfo, v5);
    byte_4B6A9DE = 1;
  }
  v6 = (System_Collections_Generic_List_Vector2__o *)sub_1BE4D18(System_Collections_Generic_List_Vector2__TypeInfo);
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)p_bgGridPointList, (int64_t)v6, v8, v9, v10, v11, v12, v13);
  for ( i = 0; i != 26; ++i )
  {
    for ( j = 0; j != 46; ++j )
    {
...
LABEL_15:
          ...
          if ( (unsigned int)size >= items->max_length )
          {
            ...
            System_Collections_Generic_List_Vector2___AddWithResize(
              v20,
              v25,
              *(const MethodInfo_363FCA8 **)(*(_QWORD *)(v22[4] + 192LL) + 112LL));
          }
          else
          {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A9E0 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Enumerator_double__Dispose__, method);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Enumerator_double__MoveNext__, v5);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Enumerator_double__get_Current__, v6);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_double__GetEnumerator__, v7);
    byte_4B6A9E0 = 1;
  }
  ...
  System_Collections_Generic_List_double___GetEnumerator(
    ...
    (const MethodInfo_35C2DC8 *)Method_System_Collections_Generic_List_double__GetEnumerator__);
  v9 = 0;
  v12 = v11;
  while ( System_Collections_Generic_List_Enumerator_double___MoveNext(
            &v12,
            (const MethodInfo_335C948 *)Method_System_Collections_Generic_List_Enumerator_double__MoveNext__) )
  {
  ...
  System_Collections_Generic_List_Enumerator_double___Dispose(
    &v12,
    (const MethodInfo_335C944 *)Method_System_Collections_Generic_List_Enumerator_double__Dispose__);
  return v9;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A9DF & 1) == 0 )
  {
    sub_1BE4ACC(&Method_UnityEngine_GameObject_AddComponent_EndrolEffectItem___, method);
    sub_1BE4ACC(&Method_UnityEngine_Object_Instantiate_GameObject___, v6);
    this = (EndrolEffectManager_o *)sub_1BE4ACC(&UnityEngine_Object_TypeInfo, v7);
    byte_4B6A9DF = 1;
  }
  effectObject = v5->fields.effectObject;
  if ( !effectObject )
    goto LABEL_15;
  v9 = UnityEngine_Random__Range_70411740(0, effectObject->max_length, 0LL);
  ...
  if ( !byte_4B612E6 )
  {
    this = (EndrolEffectManager_o *)sub_1BE4ACC(&UnityEngine_Vector3_TypeInfo, method);
    byte_4B612E6 = 1;
  }
  if ( !v15 )
LABEL_15:
  ...
  UnityEngine_GameObject__AddComponent_object_(
    ...
    (const MethodInfo_2FA96B4 *)Method_UnityEngine_GameObject_AddComponent_EndrolEffectItem___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A9DD & 1) == 0 )
  {
    sub_1BE4ACC(&Method_System_Collections_Generic_List_double__Add__, *(_QWORD *)&miny);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_double__Sort__, v17);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_double___ctor__, v18);
    sub_1BE4ACC(&System_Collections_Generic_List_double__TypeInfo, v19);
    byte_4B6A9DD = 1;
  }
  v20 = (System_Collections_Generic_List_double__o *)sub_1BE4D18(System_Collections_Generic_List_double__TypeInfo);
  System_Collections_Generic_List_double____ctor(
    v20,
    (const MethodInfo_35C1A94 *)Method_System_Collections_Generic_List_double___ctor__);
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.objectParent, (int64_t)parent, v28, v29, v30, v31, v32, v33);
  this->fields.totalTime = allTime;
  v35 = x - z;
  if ( !byte_4B6195E )
  {
    sub_1BE4ACC(&System_Math_TypeInfo, v34);
    byte_4B6195E = 1;
  }
  v36 = allTime / v35;
  ...
  if ( v38 >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      v44 = UnityEngine_Random__Range_70411740(miny, v40, 0LL);
      if ( v44 >= 1 )
        break;
LABEL_26:
      if ( ++v39 == v38 )
    ...
    while ( 1 )
    {
      ...
      if ( (unsigned int)size >= items->max_length )
      {
        System_Collections_Generic_List_double___AddWithResize(
          v48,
          v52,
          *(const MethodInfo_35C22F0 **)(*(_QWORD *)(v50[4] + 192LL) + 112LL));
      }
      else
      {
...
LABEL_27:
  ...
  System_Collections_Generic_List_double___Sort(
    v48,
    (const MethodInfo_35C3C34 *)Method_System_Collections_Generic_List_double__Sort__);
...
void __fastcall EndrolEffectManager__Update(EndrolEffectManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6A9DC & 1) == 0 )
  {
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Vector2__Remove__, method);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_double__get_Count__, v3);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Vector2__get_Count__, v4);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Vector2__get_Item__, v5);
    this = (EndrolEffectManager_o *)sub_1BE4ACC(&Method_System_Collections_Generic_List_double__get_Item__, v6);
    byte_4B6A9DC = 1;
  }
    ...
    if ( passageTime <= v2->fields.totalTime && !v2->fields.isForceEnd )
    {
      ...
      if ( truncateTime != v11 )
      {
        ...
        Item = System_Collections_Generic_List_double___get_Item(
                 ...
                 (const MethodInfo_35C1FF8 *)Method_System_Collections_Generic_List_double__get_Item__);
        ...
        if ( Item == v14 )
        {
          ...
          if ( (int)this >= 1 )
          {
            ...
            while ( 1 )
            {
              ...
              if ( !bgGridPointList )
                break;
              this = (EndrolEffectManager_o *)UnityEngine_Random__Range_70411740(0, bgGridPointList->fields._size, 0LL);
              ...
              this = (EndrolEffectManager_o *)System_Collections_Generic_List_Vector2___Remove(
                                                v19,
                                                v21,
                                                (const MethodInfo_36411F0 *)Method_System_Collections_Generic_List_Vector2__Remove__);
              --v15;
              ++v2->fields.nowPlayEffectNumber;
              if ( !v15 )
                return;
