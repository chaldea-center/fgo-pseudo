...
void MyRoomHelpMenu__Close(MyRoomHelpMenu_o *this, MyRoomHelpMenu_CallbackFunc_o *callback, const MethodInfo *method)
{
  ...
  if ( (byte_4CB8661 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_MyRoomHelpMenu_endClose__);
    byte_4CB8661 = 1;
  }
...
void MyRoomHelpMenu__OnEnable(MyRoomHelpMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB865E & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_9224/*"MyRoomHelpListPanel/BaseWindow/UpperCloseButton"*/);
    byte_4CB865E = 1;
  }
  transform = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0);
  if ( !transform )
    goto LABEL_9;
  v5 = (UnityEngine_Object_o *)UnityEngine_Transform__Find(transform, (System_String_o *)StringLiteral_9224/*"MyRoomHelpListPanel/BaseWindow/UpperCloseButton"*/, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB865F & 1) == 0 )
  {
    sub_1C6BA08(&MyRoomHelpMenu_CallbackFunc_TypeInfo);
    byte_4CB865F = 1;
  }
...
void MyRoomHelpMenu__endClose(MyRoomHelpMenu_o *this, const MethodInfo *method)
{
  ...
  struct MyRoomHelpMenu_CallbackFunc_o *v6; // x20
  struct MyRoomHelpMenu_CallbackFunc_o *callbackFunc; // t1
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1AA3E68;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1AA3E28;
}
