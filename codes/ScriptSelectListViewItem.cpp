        ...
        const MethodInfo *method)
{
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.message, (int32_t)message, v8, v9);
  this->fields.fontType = fontType;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.fontType, (int32_t)fontType, v10, v11);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4A2FB94 & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_21389/*"message "*/, method);
    byte_4A2FB94 = 1;
  }
  return System_String__Concat_61535060((System_String_o *)StringLiteral_21389/*"message "*/, this->fields.message, 0LL);
}
