        ...
        const MethodInfo *method)
{
  ...
  sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.message, (int64_t)message, v8, v9, v10, v11, v12, v13);
  this->fields.fontType = fontType;
  sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.fontType, (int64_t)fontType, v14, v15, v16, v17, v18, v19);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4BFF4CA & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_21792/*"message "*/, method);
    byte_4BFF4CA = 1;
  }
  return System_String__Concat_63235584((System_String_o *)StringLiteral_21792/*"message "*/, this->fields.message, 0LL);
}
