        ...
        const MethodInfo *method)
{
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.message, (int32_t)message, v8, v9);
  this->fields.fontType = fontType;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.fontType, (int32_t)fontType, v10, v11);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4A0A8A7 & 1) == 0 )
  {
    sub_1B686D4(&StringLiteral_21325/*"message "*/, method);
    byte_4A0A8A7 = 1;
  }
  return System_String__Concat_61419468((System_String_o *)StringLiteral_21325/*"message "*/, this->fields.message, 0LL);
}
