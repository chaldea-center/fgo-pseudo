        ...
        const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.message, (int32_t)message, v8, v9);
  this->fields.fontType = fontType;
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.fontType, (int32_t)fontType, v10, v11);
}
...
System_String_o *ScriptSelectListViewItem__ToString(ScriptSelectListViewItem_o *this, const MethodInfo *method)
{
  if ( (byte_4C44FDF & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_21540/*"message "*/);
    byte_4C44FDF = 1;
  }
  return System_String__Concat_63561656((System_String_o *)StringLiteral_21540/*"message "*/, this->fields.message, 0);
}
