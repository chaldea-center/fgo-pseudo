        ...
        const MethodInfo *method)
{
  ...
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.message, (int32_t)message, v8, v9, v10, v11, v12, v13);
  this->fields.fontType = fontType;
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.fontType, (int32_t)fontType, v14, v15, v16, v17, v18, v19);
}
...
System_String_o *ScriptSelectListViewItem__ToString(ScriptSelectListViewItem_o *this, const MethodInfo *method)
{
  if ( (byte_4D2E8FC & 1) == 0 )
  {
    sub_1C94098(&StringLiteral_21746/*"message "*/);
    byte_4D2E8FC = 1;
  }
  return System_String__Concat_64417744((System_String_o *)StringLiteral_21746/*"message "*/, this->fields.message, 0);
}
