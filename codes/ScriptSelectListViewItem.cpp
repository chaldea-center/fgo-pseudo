        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EE2F4 & 1) == 0 )
  {
    sub_B5D5C4(&StringLiteral_20734/*"message "*/, (_DWORD)method, v2, v3);
    byte_42EE2F4 = 1;
  }
  return System_String__Concat_44577788((System_String_o *)StringLiteral_20734/*"message "*/, this->fields.message, 0LL);
}
