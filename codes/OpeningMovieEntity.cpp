...
int32_t __fastcall OpeningMovieEntity__GetGroupId(OpeningMovieEntity_o *this, const MethodInfo *method)
{
  ...
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_19848/*"groupId"*/, 0, 0LL);
}
...
System_String_o *__fastcall OpeningMovieEntity__GetMoviePlayTime(OpeningMovieEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2E32D & 1) == 0 )
  {
    ...
    sub_1B761C0(&System_TimeSpan_TypeInfo, v3);
    sub_1B761C0(&StringLiteral_25105/*"{0}分{1}秒"*/, v4);
    sub_1B761C0(&StringLiteral_25107/*"{0}秒"*/, v5);
    byte_4A2E32D = 1;
  }
  v23 = 0LL;
  ...
  System_TimeSpan___ctor_62439924(v24, 0, 0, moviePlayTime, 0LL);
  ...
  if ( Minutes < 1 )
  {
    ...
    return System_String__Format((System_String_o *)StringLiteral_25107/*"{0}秒"*/, v20, 0LL);
  }
  else
  {
    ...
    return System_String__Format_61549432((System_String_o *)StringLiteral_25105/*"{0}分{1}秒"*/, v11, v15, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E329 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMasterData_CommonReleaseMaster___, nowTime);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E32A & 1) == 0 )
  {
    sub_1B761C0(&NetworkManager_TypeInfo, nowTime);
    byte_4A2E32A = 1;
  }
  if ( !Time )
  {
