...
int32_t __fastcall OpeningMovieEntity__GetGroupId(OpeningMovieEntity_o *this, const MethodInfo *method)
{
  ...
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_19881/*"groupId"*/, 0, 0LL);
}
...
System_String_o *__fastcall OpeningMovieEntity__GetMoviePlayTime(OpeningMovieEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A70258 & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_25158/*"{0}分{1}秒"*/, v4);
    sub_1B90010(&StringLiteral_25160/*"{0}秒"*/, v5);
    byte_4A70258 = 1;
  }
  v23 = 0LL;
  ...
  System_TimeSpan___ctor_62691956(v24, 0, 0, moviePlayTime, 0LL);
  ...
  if ( Minutes < 1 )
  {
    ...
    return System_String__Format((System_String_o *)StringLiteral_25160/*"{0}秒"*/, v20, 0LL);
  }
  else
  {
    ...
    return System_String__Format_61801464((System_String_o *)StringLiteral_25158/*"{0}分{1}秒"*/, v11, v15, 0LL);
  }
}
...
int32_t __fastcall OpeningMovieEntity__GetTargetTiming(OpeningMovieEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4A70259 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_23991/*"timing"*/, method);
    byte_4A70259 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_23991/*"timing"*/, 0, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A70254 & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMasterData_CommonReleaseMaster___, nowTime);
...
bool __fastcall OpeningMovieEntity__IsRegisterMaterial(OpeningMovieEntity_o *this, const MethodInfo *method)
{
  ...
  Instance = (CommonReleaseEntity_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_374C890 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_10;
