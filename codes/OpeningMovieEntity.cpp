...
int32_t __fastcall OpeningMovieEntity__GetGroupId(OpeningMovieEntity_o *this, const MethodInfo *method)
{
  ...
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_19718/*"groupId"*/, 0, 0LL);
}
...
System_String_o *__fastcall OpeningMovieEntity__GetMoviePlayTime(OpeningMovieEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B02496 & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_24976/*"{0}分{1}秒"*/, v4);
    sub_1BC3008(&StringLiteral_24978/*"{0}秒"*/, v5);
    byte_4B02496 = 1;
  }
  v23 = 0LL;
  ...
  System_TimeSpan___ctor_63959392(v24, 0, 0, moviePlayTime, 0LL);
  ...
  if ( Minutes < 1 )
  {
    ...
    return System_String__Format((System_String_o *)StringLiteral_24978/*"{0}秒"*/, v20, 0LL);
  }
  else
  {
    ...
    return System_String__Format_62389940((System_String_o *)StringLiteral_24976/*"{0}分{1}秒"*/, v11, v15, 0LL);
  }
}
...
int32_t __fastcall OpeningMovieEntity__GetTargetTiming(OpeningMovieEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4B02497 & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_23855/*"timing"*/, method);
    byte_4B02497 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_23855/*"timing"*/, 0, 0LL);
}
...
int32_t __fastcall OpeningMovieEntity__GetTargetWarId(OpeningMovieEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4B0249A & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_24515/*"warId"*/, method);
    byte_4B0249A = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_24515/*"warId"*/, 0, 0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4B02498 & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_16567/*"afterTransitionParam"*/, method);
    byte_4B02498 = 1;
  }
  return EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_16567/*"afterTransitionParam"*/, 0LL, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B02492 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMasterData_CommonReleaseMaster___, nowTime);
...
bool __fastcall OpeningMovieEntity__IsGrand(OpeningMovieEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4B02499 & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_20720/*"isGrand"*/, method);
    byte_4B02499 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_20720/*"isGrand"*/, 0, 0LL) > 0;
}
...
bool __fastcall OpeningMovieEntity__IsRegisterMaterial(OpeningMovieEntity_o *this, const MethodInfo *method)
{
  ...
  Instance = (CommonReleaseEntity_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38DFD48 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_10;
