...
int32_t __fastcall OpeningMovieEntity__GetGroupId(OpeningMovieEntity_o *this, const MethodInfo *method)
{
  ...
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_20203/*"groupId"*/, 0, 0LL);
}
...
System_String_o *__fastcall OpeningMovieEntity__GetMoviePlayTime(OpeningMovieEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDC970 & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_25565/*"{0}分{1}秒"*/);
    sub_1C21E38(&StringLiteral_25567/*"{0}秒"*/);
    byte_4BDC970 = 1;
  }
  v20 = 0LL;
  ...
  System_TimeSpan___ctor_64020928(v21, 0, 0, moviePlayTime, 0LL);
  ...
  if ( Minutes < 1 )
  {
    ...
    return System_String__Format((System_String_o *)StringLiteral_25567/*"{0}秒"*/, v17, 0LL);
  }
  else
  {
    ...
    return System_String__Format_63129848((System_String_o *)StringLiteral_25565/*"{0}分{1}秒"*/, v8, v12, 0LL);
  }
}
...
int32_t __fastcall OpeningMovieEntity__GetTargetTiming(OpeningMovieEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4BDC971 & 1) == 0 )
  {
    sub_1C21E38(&StringLiteral_24385/*"timing"*/);
    byte_4BDC971 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_24385/*"timing"*/, 0, 0LL);
}
