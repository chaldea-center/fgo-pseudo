...
int32_t __fastcall OpeningMovieEntity__GetGroupId(OpeningMovieEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4BFDB7C & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_20214/*"groupId"*/, method);
    byte_4BFDB7C = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_20214/*"groupId"*/, 0, 0LL);
}
...
System_String_o *__fastcall OpeningMovieEntity__GetMoviePlayTime(OpeningMovieEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFDB7D & 1) == 0 )
  {
    ...
    sub_1C2E12C(&System_TimeSpan_TypeInfo, v3);
    sub_1C2E12C(&StringLiteral_25591/*"{0}分{1}秒"*/, v4);
    sub_1C2E12C(&StringLiteral_25593/*"{0}秒"*/, v5);
    byte_4BFDB7D = 1;
  }
  v23 = 0LL;
  ...
  System_TimeSpan___ctor_64141036(v24, 0, 0, moviePlayTime, 0LL);
  ...
  if ( Minutes < 1 )
  {
    ...
    return System_String__Format((System_String_o *)StringLiteral_25593/*"{0}秒"*/, v20, 0LL);
  }
  else
  {
    ...
    return System_String__Format_63249956((System_String_o *)StringLiteral_25591/*"{0}分{1}秒"*/, v11, v15, 0LL);
  }
}
...
int32_t __fastcall OpeningMovieEntity__GetTargetTiming(OpeningMovieEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4BFDB7E & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_24408/*"timing"*/, method);
    byte_4BFDB7E = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_24408/*"timing"*/, 0, 0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4BFDB7F & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_17004/*"afterTransitionParam"*/, method);
    byte_4BFDB7F = 1;
  }
  return EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_17004/*"afterTransitionParam"*/, 0LL, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFDB79 & 1) == 0 )
  {
    sub_1C2E12C(&Method_DataManager_GetMasterData_CommonReleaseMaster___, nowTime);
...
bool __fastcall OpeningMovieEntity__IsRegisterMaterial(OpeningMovieEntity_o *this, const MethodInfo *method)
{
  ...
  Instance = (CommonReleaseEntity_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38A7F90 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_10;
