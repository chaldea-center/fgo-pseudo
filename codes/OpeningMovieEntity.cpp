...
int32_t __fastcall OpeningMovieEntity__GetGroupId(OpeningMovieEntity_o *this, const MethodInfo *method)
{
  ...
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_19884/*"groupId"*/, 0, 0LL);
}
...
System_String_o *__fastcall OpeningMovieEntity__GetMoviePlayTime(OpeningMovieEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB6144 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&System_TimeSpan_TypeInfo, v3);
    sub_1BAB41C(&StringLiteral_25161/*"{0}分{1}秒"*/, v4);
    sub_1BAB41C(&StringLiteral_25163/*"{0}秒"*/, v5);
    byte_4AB6144 = 1;
  }
  v23 = 0LL;
  ...
  System_TimeSpan___ctor_62952992(v24, 0, 0, moviePlayTime, 0LL);
  ...
  if ( Minutes < 1 )
  {
    ...
    return System_String__Format((System_String_o *)StringLiteral_25163/*"{0}秒"*/, v20, 0LL);
  }
  else
  {
    ...
    return System_String__Format_62062500((System_String_o *)StringLiteral_25161/*"{0}分{1}秒"*/, v11, v15, 0LL);
  }
}
...
int32_t __fastcall OpeningMovieEntity__GetTargetTiming(OpeningMovieEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4AB6145 & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_23993/*"timing"*/, method);
    byte_4AB6145 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_23993/*"timing"*/, 0, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB6140 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMasterData_CommonReleaseMaster___, nowTime);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB6141 & 1) == 0 )
  {
    sub_1BAB41C(&NetworkManager_TypeInfo, nowTime);
    byte_4AB6141 = 1;
  }
  if ( !Time )
  {
...
bool __fastcall OpeningMovieEntity__IsRegisterMaterial(OpeningMovieEntity_o *this, const MethodInfo *method)
{
  ...
  Instance = (CommonReleaseEntity_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_378A22C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_10;
