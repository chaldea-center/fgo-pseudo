...
{
  *(_OWORD *)&this->fields.TITLE_FONT_SIZE = xmmword_BAA490;
...
LABEL_8:
  ...
  ShiningIconComponent__Set_38029736((ShiningIconComponent_o *)this, v7, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1B604 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_17478/*"btn_playmusic_on"*/, v6);
    sub_1B715CC(&StringLiteral_20419/*"img_soundplayer_listoff01"*/, v7);
    sub_1B715CC(&StringLiteral_12140/*"SOUNDPLAYER_SOUND_NAME"*/, v8);
    sub_1B715CC(&StringLiteral_17477/*"btn_playmusic_off"*/, v9);
    sub_1B715CC(&StringLiteral_1/*""*/, v10);
    this = (SoundPlayerListViewItemDraw_o *)sub_1B715CC(&StringLiteral_20420/*"img_soundplayer_listoff02"*/, v11);
    byte_4A1B604 = 1;
  }
  if ( !item )
    goto LABEL_64;
  ...
  if ( item->fields._isPlaySound_k__BackingField )
    v12 = (System_String_o **)&StringLiteral_17478/*"btn_playmusic_on"*/;
  else
    v12 = (System_String_o **)&StringLiteral_17477/*"btn_playmusic_off"*/;
      ...
      if ( this )
      {
        ...
        if ( this )
        {
          ...
          if ( this )
          {
            ...
            if ( this )
            {
              UISprite__set_spriteName((UISprite_o *)this, (System_String_o *)StringLiteral_20420/*"img_soundplayer_listoff02"*/, 0LL);
              this = (SoundPlayerListViewItemDraw_o *)v4->fields.blackMask;
              if ( this )
              {
        ...
        if ( this )
        {
          ...
          if ( this )
          {
            ...
            if ( item->fields._isShop_k__BackingField )
            {
              ...
              if ( !this )
                goto LABEL_64;
              UISprite__set_spriteName((UISprite_o *)this, (System_String_o *)StringLiteral_20419/*"img_soundplayer_listoff01"*/, 0LL);
              this = (SoundPlayerListViewItemDraw_o *)v4->fields.blackMask;
              if ( !this )
                goto LABEL_64;
            ...
            v31 = LocalizationManager__Get((System_String_o *)StringLiteral_12140/*"SOUNDPLAYER_SOUND_NAME"*/, 0LL);
            if ( (byte_4A1B5FE & 1) == 0 )
            {
...
LABEL_64:
    ...
    case 0:
      ...
      if ( this )
      {
        ShiningIconComponent__Set_38029736((ShiningIconComponent_o *)this, item->fields._isNew_k__BackingField, 0LL);
        this = (SoundPlayerListViewItemDraw_o *)v4->fields.blackMask;
        if ( this )
        {
          this = (SoundPlayerListViewItemDraw_o *)UnityEngine_Component__get_gameObject(
          ...
          if ( this )
          {
            ...
            if ( this )
            {
              ...
              if ( this )
              {
                ...
                if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                  j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                v20 = LocalizationManager__Get((System_String_o *)StringLiteral_12140/*"SOUNDPLAYER_SOUND_NAME"*/, 0LL);
                if ( (byte_4A1B5FE & 1) == 0 )
                {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1B603 & 1) == 0 )
  {
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponent_CommonEffectComponent___, item);
    this = (SoundPlayerListViewItemDraw_o *)sub_1B715CC(&UnityEngine_Object_TypeInfo, v5);
    byte_4A1B603 = 1;
  }
  if ( !item )
    goto LABEL_11;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1B605 & 1) == 0 )
  {
    sub_1B715CC(&Method_System_Collections_Generic_List_SoundPlayerShopItemComponent__get_Count__, item);
    sub_1B715CC(&Method_System_Collections_Generic_List_SoundPlayerShopItemComponent__get_Item__, v5);
  ...
  if ( size >= 1 )
  {
    ...
    do
    {
      shopItemList = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___get_Item(
                                                                    shopItemList,
                                                                    v9,
                                                                    (const MethodInfo_34CFF90 *)Method_System_Collections_Generic_List_SoundPlayerShopItemComponent__get_Item__);
      if ( !shopItemList )
        break;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1B606 & 1) == 0 )
  {
    sub_1B715CC(&System_Action_TypeInfo, mgr);
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponent_SoundPlayerOpenEffectComponent___, v9);
    sub_1B715CC(&Method_UnityEngine_Object_Instantiate_GameObject___, v10);
    sub_1B715CC(&UnityEngine_Object_TypeInfo, v11);
    sub_1B715CC(&Method_SoundPlayerListViewItemDraw___c__DisplayClass21_0__startOpenAnim_b__0__, v12);
    sub_1B715CC(&Method_SoundPlayerListViewItemDraw___c__DisplayClass21_0__startOpenAnim_b__1__, v13);
    sub_1B715CC(&SoundPlayerListViewItemDraw___c__DisplayClass21_0_TypeInfo, v14);
    sub_1B715CC(&StringLiteral_18803/*"ef_soundopen"*/, v15);
    byte_4A1B606 = 1;
  }
  v16 = (Il2CppObject *)sub_1B71818(SoundPlayerListViewItemDraw___c__DisplayClass21_0_TypeInfo);
  ...
  if ( ((unsigned __int8)v17 & 1) != 0 )
  {
    ...
    EffetData = (Il2CppObject *)SoundPlayerListViewManager__getEffetData(
                                  mgr,
                                  (System_String_o *)StringLiteral_18803/*"ef_soundopen"*/,
                                  v21);
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    ...
    sub_1B71570(&this->fields.openEffect);
    GameObjectExtensions__SafeSetParent_33535352(this->fields.openEffect, this->fields.openEffectAttachObj, 0LL);
  }
  v17 = *p_openEffect;
  if ( !*p_openEffect
    || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                             v17,
                             (const MethodInfo_2EAA998 *)Method_UnityEngine_GameObject_GetComponent_SoundPlayerOpenEffectComponent___),
...
LABEL_14:
  ...
  sub_1B71570(&Component_object[13]);
  ...
  sub_1B71570(&Component_object[13].monitor);
  Component_object[14].klass = (Il2CppClass *)endCallback;
  sub_1B71570(&Component_object[14]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1B607 & 1) == 0 )
  {
    this = (SoundPlayerListViewItemDraw___c__DisplayClass21_0_o *)sub_1B715CC(
  ...
  if ( !_4__this
    ...
    || (this = (SoundPlayerListViewItemDraw___c__DisplayClass21_0_o *)UnityEngine_Component__GetComponent_object_(
                                                                        (UnityEngine_Component_o *)this,
                                                                        (const MethodInfo_2E51E8C *)Method_UnityEngine_Component_GetComponent_TweenScale___)) == 0LL )
  {
