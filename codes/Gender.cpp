void __fastcall Gender___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B00F3B & 1) == 0 )
  {
    sub_1BC3008(&Gender_TypeInfo, v1);
    sub_1BC3008(&string___TypeInfo, v2);
    sub_1BC3008(&StringLiteral_6344/*"FEMALE"*/, v3);
    sub_1BC3008(&StringLiteral_9648/*"OTHER"*/, v4);
    sub_1BC3008(&StringLiteral_8452/*"MALE"*/, v5);
    byte_4B00F3B = 1;
  }
  ...
  v10 = v6;
  if ( !*(_DWORD *)(v6 + 24)
    || (v11 = StringLiteral_8452/*"MALE"*/,
        *(_QWORD *)(v6 + 32) = StringLiteral_8452/*"MALE"*/,
        sub_1BC2FAC((CGThumbnailListItem_o *)(v6 + 32), v11, v8, v9),
        *(_DWORD *)(v10 + 24) <= 1u)
    || (v13 = StringLiteral_6344/*"FEMALE"*/,
        *(_QWORD *)(v10 + 40) = StringLiteral_6344/*"FEMALE"*/,
        sub_1BC2FAC((CGThumbnailListItem_o *)(v10 + 40), v13, v8, v12),
        *(_DWORD *)(v10 + 24) <= 2u) )
  {
    sub_1BC326C(v6, v7, v8);
  }
  v15 = StringLiteral_9648/*"OTHER"*/;
  *(_QWORD *)(v10 + 48) = StringLiteral_9648/*"OTHER"*/;
  sub_1BC2FAC((CGThumbnailListItem_o *)(v10 + 48), v15, v8, v14);
  Gender_TypeInfo->static_fields->nameList = (struct System_String_array *)v10;
  sub_1BC2FAC((CGThumbnailListItem_o *)Gender_TypeInfo->static_fields, v10, v16, v17);
}
...
void __fastcall Gender___ctor_39465172(Gender_o *this, int32_t type, const MethodInfo *method)
{
  System_Object___ctor((Il2CppObject *)this, 0LL);
...
void __fastcall Gender___ctor_39465212(Gender_o *this, System_String_o *name, const MethodInfo *method)
{
  const MethodInfo *v5; // x1

  if ( (byte_4B00F38 & 1) == 0 )
  {
    sub_1BC3008(&Gender_TypeInfo, name);
    byte_4B00F38 = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
...
int32_t __fastcall Gender__GetTreasureDeviceSequenceGenderType(int32_t genderSelectType, const MethodInfo *method)
{
  ...
  switch ( genderSelectType )
  {
    ...
    case 3:
      return UnityEngine_Random__Range_69994520(1, 3, 0LL);
    case 4:
...
int32_t __fastcall Gender__Parse(System_String_o *name, const MethodInfo *method)
{
  ...
  if ( (byte_4B00F36 & 1) == 0 )
  {
    sub_1BC3008(&Gender_TypeInfo, method);
    byte_4B00F36 = 1;
  }
  v4 = 0;
  while ( 1 )
...
LABEL_16:
    ...
    if ( !v5 )
      goto LABEL_16;
    ++v4;
    if ( System_String__Equals_62383952((System_String_o *)v5, name, 0LL) )
      return v4;
  }
}
...
void __fastcall Gender__Set_39465456(Gender_o *this, System_String_o *name, const MethodInfo *method)
{
  if ( (byte_4B00F3A & 1) == 0 )
  {
    sub_1BC3008(&Gender_TypeInfo, name);
