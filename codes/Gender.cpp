void __fastcall Gender___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A2CF39 & 1) == 0 )
  {
    sub_1B761C0(&Gender_TypeInfo, v1);
    sub_1B761C0(&string___TypeInfo, v2);
    sub_1B761C0(&StringLiteral_6361/*"FEMALE"*/, v3);
    sub_1B761C0(&StringLiteral_9727/*"OTHER"*/, v4);
    sub_1B761C0(&StringLiteral_8503/*"MALE"*/, v5);
    byte_4A2CF39 = 1;
  }
  v6 = sub_1B76268(string___TypeInfo, 3LL);
  if ( !v6 )
    sub_1B7641C(0LL, v7);
  v10 = v6;
  if ( !*(_DWORD *)(v6 + 24)
    || (v11 = StringLiteral_8503/*"MALE"*/,
        *(_QWORD *)(v6 + 32) = StringLiteral_8503/*"MALE"*/,
        sub_1B76164((ServantStatusBattleListViewItem_o *)(v6 + 32), v11, v8, v9),
        *(_DWORD *)(v10 + 24) <= 1u)
    || (v14 = StringLiteral_6361/*"FEMALE"*/,
        *(_QWORD *)(v10 + 40) = StringLiteral_6361/*"FEMALE"*/,
        sub_1B76164((ServantStatusBattleListViewItem_o *)(v10 + 40), v14, v12, v13),
        *(_DWORD *)(v10 + 24) <= 2u) )
  {
    sub_1B76424(v6, v7);
  }
  v17 = StringLiteral_9727/*"OTHER"*/;
  *(_QWORD *)(v10 + 48) = StringLiteral_9727/*"OTHER"*/;
  sub_1B76164((ServantStatusBattleListViewItem_o *)(v10 + 48), v17, v15, v16);
  Gender_TypeInfo->static_fields->nameList = (struct System_String_array *)v10;
  sub_1B76164((ServantStatusBattleListViewItem_o *)Gender_TypeInfo->static_fields, v10, v18, v19);
}
...
void __fastcall Gender___ctor_37508828(Gender_o *this, int32_t type, const MethodInfo *method)
{
  System_Object___ctor((Il2CppObject *)this, 0LL);
...
void __fastcall Gender___ctor_37508868(Gender_o *this, System_String_o *name, const MethodInfo *method)
{
  const MethodInfo *v5; // x1

  if ( (byte_4A2CF36 & 1) == 0 )
  {
    sub_1B761C0(&Gender_TypeInfo, name);
    byte_4A2CF36 = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
...
int32_t __fastcall Gender__Parse(System_String_o *name, const MethodInfo *method)
{
  ...
  if ( (byte_4A2CF34 & 1) == 0 )
  {
    sub_1B761C0(&Gender_TypeInfo, method);
    byte_4A2CF34 = 1;
  }
  v3 = 0;
  while ( 1 )
...
LABEL_16:
    ...
    if ( !v4 )
      goto LABEL_16;
    ++v3;
    if ( System_String__Equals_61543376((System_String_o *)v4, name, 0LL) )
      return v3;
  }
}
...
void __fastcall Gender__Set_37509112(Gender_o *this, System_String_o *name, const MethodInfo *method)
{
  if ( (byte_4A2CF38 & 1) == 0 )
  {
    sub_1B761C0(&Gender_TypeInfo, name);
