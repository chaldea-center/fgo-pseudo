void Gender___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4D2B70E & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_6406/*"FEMALE"*/);
    sub_1C94098(&StringLiteral_9755/*"OTHER"*/);
    sub_1C94098(&StringLiteral_8553/*"MALE"*/);
    byte_4D2B70E = 1;
  }
  ...
  v9 = v1;
  if ( !*(_DWORD *)(v1 + 24)
    || (v10 = StringLiteral_8553/*"MALE"*/,
        *(_QWORD *)(v1 + 32) = StringLiteral_8553/*"MALE"*/,
        sub_1C9403C((GrandQuestFolderBoardItem_o *)(v1 + 32), v10, v3, v4, v5, v6, v7, v8),
        *(_DWORD *)(v9 + 24) <= 1u)
    || (v17 = StringLiteral_6406/*"FEMALE"*/,
        *(_QWORD *)(v9 + 40) = StringLiteral_6406/*"FEMALE"*/,
        sub_1C9403C((GrandQuestFolderBoardItem_o *)(v9 + 40), v17, v11, v12, v13, v14, v15, v16),
        *(_DWORD *)(v9 + 24) <= 2u) )
  {
    sub_1C942F8(v1);
  }
  v24 = StringLiteral_9755/*"OTHER"*/;
  *(_QWORD *)(v9 + 48) = StringLiteral_9755/*"OTHER"*/;
  ...
  sub_1C9403C((GrandQuestFolderBoardItem_o *)Gender_TypeInfo->static_fields, v9, v25, v26, v27, v28, v29, v30);
}
...
void Gender___ctor_41174616(Gender_o *this, int32_t type, const MethodInfo *method)
{
  System_Object___ctor((Il2CppObject *)this, 0);
...
void Gender___ctor_41174656(Gender_o *this, System_String_o *name, const MethodInfo *method)
{
...
int32_t Gender__GetGenderTypeBySelectType(int32_t genderSelectType, const MethodInfo *method)
{
  ...
  switch ( genderSelectType )
  {
    ...
    case 3:
      return UnityEngine_Random__Range_72070684(1, 3, 0);
    case 4:
...
LABEL_16:
    ...
    if ( !v4 )
      goto LABEL_16;
    ++v3;
    if ( System_String__Equals_64453064((System_String_o *)v4, name, 0) )
      return v3;
  }
}
...
void Gender__Set_41174900(Gender_o *this, System_String_o *name, const MethodInfo *method)
{
  if ( (byte_4D2B70D & 1) == 0 )
  {
    sub_1C94098(&Gender_TypeInfo);
