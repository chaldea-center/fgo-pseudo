void __fastcall Gender___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BDB4E6 & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_6533/*"FEMALE"*/);
    sub_1C21E38(&StringLiteral_9927/*"OTHER"*/);
    sub_1C21E38(&StringLiteral_8688/*"MALE"*/);
    byte_4BDB4E6 = 1;
  }
  ...
  v9 = v1;
  if ( !*(_DWORD *)(v1 + 24)
    || (v10 = StringLiteral_8688/*"MALE"*/,
        *(_QWORD *)(v1 + 32) = StringLiteral_8688/*"MALE"*/,
        sub_1C21DDC((PartyOrganizationUtility_o *)(v1 + 32), v10, v3, v4, v5, v6, v7, v8),
        *(_DWORD *)(v9 + 24) <= 1u)
    || (v17 = StringLiteral_6533/*"FEMALE"*/,
        *(_QWORD *)(v9 + 40) = StringLiteral_6533/*"FEMALE"*/,
        sub_1C21DDC((PartyOrganizationUtility_o *)(v9 + 40), v17, v11, v12, v13, v14, v15, v16),
        *(_DWORD *)(v9 + 24) <= 2u) )
  {
    sub_1C2209C(v1, v2);
  }
  v24 = StringLiteral_9927/*"OTHER"*/;
  *(_QWORD *)(v9 + 48) = StringLiteral_9927/*"OTHER"*/;
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)Gender_TypeInfo->static_fields, v9, v25, v26, v27, v28, v29, v30);
}
...
void __fastcall Gender___ctor_38929572(Gender_o *this, int32_t type, const MethodInfo *method)
{
  System_Object___ctor((Il2CppObject *)this, 0LL);
...
void __fastcall Gender___ctor_38929612(Gender_o *this, System_String_o *name, const MethodInfo *method)
{
...
int32_t __fastcall Gender__GetTreasureDeviceSequenceGenderType(int32_t genderSelectType, const MethodInfo *method)
{
  ...
  switch ( genderSelectType )
  {
    ...
    case 3:
      return UnityEngine_Random__Range_70829352(1, 3, 0LL);
    case 4:
...
LABEL_16:
    ...
    if ( !v4 )
      goto LABEL_16;
    ++v3;
    if ( System_String__Equals_63123792((System_String_o *)v4, name, 0LL) )
      return v3;
  }
}
...
void __fastcall Gender__Set_38929856(Gender_o *this, System_String_o *name, const MethodInfo *method)
{
  if ( (byte_4BDB4E5 & 1) == 0 )
  {
    sub_1C21E38(&Gender_TypeInfo);
