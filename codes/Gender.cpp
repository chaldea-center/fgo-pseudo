void __fastcall Gender___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A07C66 & 1) == 0 )
  {
    sub_1B686D4(&Gender_TypeInfo, v1);
    sub_1B686D4(&string___TypeInfo, v2);
    sub_1B686D4(&StringLiteral_6336/*"FEMALE"*/, v3);
    sub_1B686D4(&StringLiteral_9689/*"OTHER"*/, v4);
    sub_1B686D4(&StringLiteral_8469/*"MALE"*/, v5);
    byte_4A07C66 = 1;
  }
  ...
  v10 = v6;
  if ( !*(_DWORD *)(v6 + 24)
    || (v11 = StringLiteral_8469/*"MALE"*/,
        *(_QWORD *)(v6 + 32) = StringLiteral_8469/*"MALE"*/,
        sub_1B68678((ServantStatusBattleListViewItem_o *)(v6 + 32), v11, v8, v9),
        *(_DWORD *)(v10 + 24) <= 1u)
    || (v14 = StringLiteral_6336/*"FEMALE"*/,
        *(_QWORD *)(v10 + 40) = StringLiteral_6336/*"FEMALE"*/,
        sub_1B68678((ServantStatusBattleListViewItem_o *)(v10 + 40), v14, v12, v13),
        *(_DWORD *)(v10 + 24) <= 2u) )
  {
    sub_1B68938(v6, v7);
  }
  v17 = StringLiteral_9689/*"OTHER"*/;
  *(_QWORD *)(v10 + 48) = StringLiteral_9689/*"OTHER"*/;
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)Gender_TypeInfo->static_fields, v10, v18, v19);
}
...
void __fastcall Gender___ctor_37437544(Gender_o *this, int32_t type, const MethodInfo *method)
{
  System_Object___ctor((Il2CppObject *)this, 0LL);
...
void __fastcall Gender___ctor_37437584(Gender_o *this, System_String_o *name, const MethodInfo *method)
{
  const MethodInfo *v5; // x1

  if ( (byte_4A07C63 & 1) == 0 )
  {
    sub_1B686D4(&Gender_TypeInfo, name);
    byte_4A07C63 = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
...
int32_t __fastcall Gender__Parse(System_String_o *name, const MethodInfo *method)
{
  ...
  if ( (byte_4A07C61 & 1) == 0 )
  {
    sub_1B686D4(&Gender_TypeInfo, method);
    byte_4A07C61 = 1;
  }
  v3 = 0;
  while ( 1 )
...
LABEL_16:
    ...
    if ( !v4 )
      goto LABEL_16;
    ++v3;
    if ( System_String__Equals_61427784((System_String_o *)v4, name, 0LL) )
      return v3;
  }
}
...
void __fastcall Gender__Set_37437828(Gender_o *this, System_String_o *name, const MethodInfo *method)
{
  if ( (byte_4A07C65 & 1) == 0 )
  {
    sub_1B686D4(&Gender_TypeInfo, name);
