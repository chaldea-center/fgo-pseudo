void __fastcall Gender___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B65B61 & 1) == 0 )
  {
    sub_1BE4ACC(&Gender_TypeInfo, v1);
    sub_1BE4ACC(&string___TypeInfo, v2);
    sub_1BE4ACC(&StringLiteral_6501/*"FEMALE"*/, v3);
    sub_1BE4ACC(&StringLiteral_9886/*"OTHER"*/, v4);
    sub_1BE4ACC(&StringLiteral_8650/*"MALE"*/, v5);
    byte_4B65B61 = 1;
  }
  v6 = sub_1BE4B74(string___TypeInfo, 3LL);
  if ( !v6 )
    sub_1BE4D28(0LL, v7);
  v14 = v6;
  if ( !*(_DWORD *)(v6 + 24)
    || (v15 = StringLiteral_8650/*"MALE"*/,
        *(_QWORD *)(v6 + 32) = StringLiteral_8650/*"MALE"*/,
        sub_1BE4A70((PartyOrganizationUtility_o *)(v6 + 32), v15, v8, v9, v10, v11, v12, v13),
        *(_DWORD *)(v14 + 24) <= 1u)
    || (v22 = StringLiteral_6501/*"FEMALE"*/,
        *(_QWORD *)(v14 + 40) = StringLiteral_6501/*"FEMALE"*/,
        sub_1BE4A70((PartyOrganizationUtility_o *)(v14 + 40), v22, v16, v17, v18, v19, v20, v21),
        *(_DWORD *)(v14 + 24) <= 2u) )
  {
    sub_1BE4D30(v6, v7);
  }
  v29 = StringLiteral_9886/*"OTHER"*/;
  *(_QWORD *)(v14 + 48) = StringLiteral_9886/*"OTHER"*/;
  sub_1BE4A70((PartyOrganizationUtility_o *)(v14 + 48), v29, v23, v24, v25, v26, v27, v28);
  Gender_TypeInfo->static_fields->nameList = (struct System_String_array *)v14;
  sub_1BE4A70((PartyOrganizationUtility_o *)Gender_TypeInfo->static_fields, v14, v30, v31, v32, v33, v34, v35);
}
...
void __fastcall Gender___ctor_38592476(Gender_o *this, int32_t type, const MethodInfo *method)
{
  System_Object___ctor((Il2CppObject *)this, 0LL);
...
void __fastcall Gender___ctor_38592516(Gender_o *this, System_String_o *name, const MethodInfo *method)
{
  const MethodInfo *v5; // x1

  if ( (byte_4B65B5E & 1) == 0 )
  {
    sub_1BE4ACC(&Gender_TypeInfo, name);
    byte_4B65B5E = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
...
int32_t __fastcall Gender__GetTreasureDeviceSequenceGenderType(int32_t genderSelectType, const MethodInfo *method)
{
  ...
  switch ( genderSelectType )
  {
    ...
    case 3:
      return UnityEngine_Random__Range_70411740(1, 3, 0LL);
    case 4:
...
int32_t __fastcall Gender__Parse(System_String_o *name, const MethodInfo *method)
{
  ...
  if ( (byte_4B65B5C & 1) == 0 )
  {
    sub_1BE4ACC(&Gender_TypeInfo, method);
    byte_4B65B5C = 1;
  }
  v3 = 0;
  while ( 1 )
...
LABEL_16:
    ...
    if ( !v4 )
      goto LABEL_16;
    ++v3;
    if ( System_String__Equals_62707124((System_String_o *)v4, name, 0LL) )
      return v3;
  }
}
...
void __fastcall Gender__Set_38592760(Gender_o *this, System_String_o *name, const MethodInfo *method)
{
  if ( (byte_4B65B60 & 1) == 0 )
  {
    sub_1BE4ACC(&Gender_TypeInfo, name);
