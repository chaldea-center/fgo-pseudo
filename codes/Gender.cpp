void __fastcall Gender___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FD517 & 1) == 0 )
  {
    sub_1B64870(&Gender_TypeInfo, v1);
    sub_1B64870(&string___TypeInfo, v2);
    sub_1B64870(&StringLiteral_6334/*"FEMALE"*/, v3);
    sub_1B64870(&StringLiteral_9686/*"OTHER"*/, v4);
    sub_1B64870(&StringLiteral_8466/*"MALE"*/, v5);
    byte_49FD517 = 1;
  }
  ...
  v10 = v6;
  if ( !*(_DWORD *)(v6 + 24)
    || (v11 = StringLiteral_8466/*"MALE"*/,
        *(_QWORD *)(v6 + 32) = StringLiteral_8466/*"MALE"*/,
  ...
  v17 = StringLiteral_9686/*"OTHER"*/;
  *(_QWORD *)(v10 + 48) = StringLiteral_9686/*"OTHER"*/;
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)Gender_TypeInfo->static_fields, v10, v18, v19);
}
...
void __fastcall Gender___ctor_37379960(Gender_o *this, int32_t type, const MethodInfo *method)
{
  System_Object___ctor((Il2CppObject *)this, 0LL);
...
void __fastcall Gender___ctor_37380000(Gender_o *this, System_String_o *name, const MethodInfo *method)
{
  const MethodInfo *v5; // x1

  if ( (byte_49FD514 & 1) == 0 )
  {
    sub_1B64870(&Gender_TypeInfo, name);
    byte_49FD514 = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
...
int32_t __fastcall Gender__Parse(System_String_o *name, const MethodInfo *method)
{
  ...
  if ( (byte_49FD512 & 1) == 0 )
  {
    sub_1B64870(&Gender_TypeInfo, method);
    byte_49FD512 = 1;
  }
  v3 = 0;
  while ( 1 )
...
LABEL_16:
    ...
    if ( !v4 )
      goto LABEL_16;
    ++v3;
    if ( System_String__Equals_61391892((System_String_o *)v4, name, 0LL) )
      return v3;
  }
}
...
void __fastcall Gender__Set_37380244(Gender_o *this, System_String_o *name, const MethodInfo *method)
{
  if ( (byte_49FD516 & 1) == 0 )
  {
    sub_1B64870(&Gender_TypeInfo, name);
