        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDF26 & 1) == 0 )
  {
    sub_1B64A00(&CharaGraphListViewItemDrawPatternDefault_TypeInfo, method);
    byte_49FDF26 = 1;
  }
  v2 = (Il2CppObject *)sub_1B64C4C(CharaGraphListViewItemDrawPatternDefault_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDF27 & 1) == 0 )
  {
    sub_1B64A00(&CharaGraphDefine_CharaGraphItemBulkModifyArgs_TypeInfo, method);
    byte_49FDF27 = 1;
  }
  v2 = (CharaGraphDefine_CharaGraphItemBulkModifyArgs_o *)sub_1B64C4C(CharaGraphDefine_CharaGraphItemBulkModifyArgs_TypeInfo);
...
Il2CppObject *__fastcall CharaGraphListViewPatternBase__GetMaster_object_(const MethodInfo_2E2F9E0 *method)
{
  __int64 v1; // x1
  ...
  return DataManager__GetMaster_object_((const MethodInfo_2E3BC8C *)method->rgctx_data->_0_DataManager_GetMaster_T_);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !itemBulkModifyArgs )
  {
    ...
    sub_1B649A4((ServantStatusBattleListViewItem_o *)p_itemBulkModifyArgs, (int32_t)itemBulkModifyArgs, v5, v6);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !itemDrawPattern )
  {
    ...
    sub_1B649A4((ServantStatusBattleListViewItem_o *)p_itemDrawPattern, (int32_t)itemDrawPattern, v5, v6);
  }
