        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3654A & 1) == 0 )
  {
    sub_1BD3458(&CharaGraphListViewItemDrawPatternDefault_TypeInfo, method);
    byte_4B3654A = 1;
  }
  v2 = (Il2CppObject *)sub_1BD36A4(CharaGraphListViewItemDrawPatternDefault_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3654B & 1) == 0 )
  {
    sub_1BD3458(&CharaGraphDefine_CharaGraphItemBulkModifyArgs_TypeInfo, method);
    byte_4B3654B = 1;
  }
  v2 = (CharaGraphDefine_CharaGraphItemBulkModifyArgs_o *)sub_1BD36A4(CharaGraphDefine_CharaGraphItemBulkModifyArgs_TypeInfo);
...
Il2CppObject *__fastcall CharaGraphListViewPatternBase__GetMaster_object_(const MethodInfo_2F25100 *method)
{
  __int64 v1; // x1

  if ( !method->rgctx_data )
  {
    sub_1BD3458(&DataManager_TypeInfo, v1);
    if ( !method->rgctx_data )
      sub_1C25390(method);
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  return DataManager__GetMaster_object_((const MethodInfo_2F31630 *)method->rgctx_data->_0_DataManager_GetMaster_T_);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !itemDrawPattern )
  {
    ...
    sub_1BD33FC((PartyOrganizationUtility_o *)p_itemDrawPattern, (int64_t)itemDrawPattern, v5, v6, v7, v8, v9, v10);
  }
