        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C422CF & 1) == 0 )
  {
    sub_1C37058(&CharaGraphListViewItemDrawPatternDefault_TypeInfo);
    byte_4C422CF = 1;
  }
  v2 = (Il2CppObject *)sub_1C372A4(CharaGraphListViewItemDrawPatternDefault_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v2 = (CharaGraphDefine_CharaGraphItemBulkModifyArgs_o *)sub_1C372A4(CharaGraphDefine_CharaGraphItemBulkModifyArgs_TypeInfo);
...
Il2CppObject *CharaGraphListViewPatternBase__GetMaster_object_(const MethodInfo_30DB3D8 *method)
{
  ...
  return DataManager__GetMaster_object_((const MethodInfo_30E7C04 *)method->rgctx_data->_0_DataManager_GetMaster_T_);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !itemBulkModifyArgs )
  {
    ...
    sub_1C36FFC((CGThumbnailListItem_o *)p_itemBulkModifyArgs, (int32_t)itemBulkModifyArgs, v5, v6);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !itemDrawPattern )
  {
    ...
    sub_1C36FFC((CGThumbnailListItem_o *)p_itemDrawPattern, (int32_t)itemDrawPattern, v5, v6);
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields._RootInfo_k__BackingField, (int32_t)value, (int32_t)method, v3);
}
