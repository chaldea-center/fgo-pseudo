        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6E53 & 1) == 0 )
  {
    sub_1C1ABD4(&CharaGraphListViewItemDrawPatternDefault_TypeInfo, method);
    byte_4BC6E53 = 1;
  }
  v2 = (Il2CppObject *)sub_1C1AE20(CharaGraphListViewItemDrawPatternDefault_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6E54 & 1) == 0 )
  {
    sub_1C1ABD4(&CharaGraphDefine_CharaGraphItemBulkModifyArgs_TypeInfo, method);
    byte_4BC6E54 = 1;
  }
  v2 = (CharaGraphDefine_CharaGraphItemBulkModifyArgs_o *)sub_1C1AE20(CharaGraphDefine_CharaGraphItemBulkModifyArgs_TypeInfo);
...
Il2CppObject *__fastcall CharaGraphListViewPatternBase__GetMaster_object_(const MethodInfo_2F92F0C *method)
{
  __int64 v1; // x1
  ...
  return DataManager__GetMaster_object_((const MethodInfo_2F9F43C *)method->rgctx_data->_0_DataManager_GetMaster_T_);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !itemDrawPattern )
  {
    ...
    sub_1C1AB78((PartyOrganizationUtility_o *)p_itemDrawPattern, (int64_t)itemDrawPattern, v5, v6, v7, v8, v9, v10);
  }
