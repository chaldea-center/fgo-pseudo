        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6F24B & 1) == 0 )
  {
    sub_1B90010(&CharaGraphListViewItemDrawPatternDefault_TypeInfo, method);
    byte_4A6F24B = 1;
  }
  v2 = (Il2CppObject *)sub_1B9025C(CharaGraphListViewItemDrawPatternDefault_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6F24C & 1) == 0 )
  {
    sub_1B90010(&CharaGraphDefine_CharaGraphItemBulkModifyArgs_TypeInfo, method);
    byte_4A6F24C = 1;
  }
  v2 = (CharaGraphDefine_CharaGraphItemBulkModifyArgs_o *)sub_1B9025C(CharaGraphDefine_CharaGraphItemBulkModifyArgs_TypeInfo);
...
Il2CppObject *__fastcall CharaGraphListViewPatternBase__GetMaster_object_(const MethodInfo_2E81F1C *method)
{
  __int64 v1; // x1

  if ( !method->rgctx_data )
  {
    sub_1B90010(&DataManager_TypeInfo, v1);
    if ( !method->rgctx_data )
      sub_1BE1F48(method);
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  return DataManager__GetMaster_object_((const MethodInfo_2E8E1C8 *)method->rgctx_data->_0_DataManager_GetMaster_T_);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !itemBulkModifyArgs )
  {
    ...
    sub_1B8FFB4((ServantStatusBattleListViewItem_o *)p_itemBulkModifyArgs, (int32_t)itemBulkModifyArgs, v5, v6);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !itemDrawPattern )
  {
    ...
    sub_1B8FFB4((ServantStatusBattleListViewItem_o *)p_itemDrawPattern, (int32_t)itemDrawPattern, v5, v6);
  }
