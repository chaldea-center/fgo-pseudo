        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E769BE & 1) == 0 )
  {
    sub_1D0F0B4(&CharaGraphListViewItemDrawPatternDefault_TypeInfo);
    byte_4E769BE = 1;
  }
  v2 = (Il2CppObject *)sub_1D0F300(CharaGraphListViewItemDrawPatternDefault_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v2 = (CharaGraphDefine_CharaGraphItemBulkModifyArgs_o *)sub_1D0F300(CharaGraphDefine_CharaGraphItemBulkModifyArgs_TypeInfo);
...
Il2CppObject *CharaGraphListViewPatternBase__GetMaster_object_(const MethodInfo_3242828 *method)
{
  ...
  return DataManager__GetMaster_object_((const MethodInfo_324F164 *)method->rgctx_data->_0_DataManager_GetMaster_T_);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !itemDrawPattern )
  {
    ...
    sub_1D0F058((GrandQuestFolderBoardItem_o *)p_itemDrawPattern, (int32_t)itemDrawPattern, v5, v6, v7, v8, v9, v10);
  }
