        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB3A85 & 1) == 0 )
  {
    sub_1C13D24(&CharaGraphListViewItemDrawPatternDefault_TypeInfo, method);
    byte_4BB3A85 = 1;
  }
  v2 = (Il2CppObject *)sub_1C13F70(CharaGraphListViewItemDrawPatternDefault_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB3A86 & 1) == 0 )
  {
    sub_1C13D24(&CharaGraphDefine_CharaGraphItemBulkModifyArgs_TypeInfo, method);
    byte_4BB3A86 = 1;
  }
  v2 = (CharaGraphDefine_CharaGraphItemBulkModifyArgs_o *)sub_1C13F70(CharaGraphDefine_CharaGraphItemBulkModifyArgs_TypeInfo);
...
Il2CppObject *__fastcall CharaGraphListViewPatternBase__GetMaster_object_(const MethodInfo_2F82EE8 *method)
{
  __int64 v1; // x1
  ...
  return DataManager__GetMaster_object_((const MethodInfo_2F8F418 *)method->rgctx_data->_0_DataManager_GetMaster_T_);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !itemDrawPattern )
  {
    ...
    sub_1C13CC8((PartyOrganizationUtility_o *)p_itemDrawPattern, (int64_t)itemDrawPattern, v5, v6, v7, v8, v9, v10);
  }
