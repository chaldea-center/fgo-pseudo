        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1EEBD & 1) == 0 )
  {
    sub_1B715CC(&CharaGraphListViewItemDrawPatternDefault_TypeInfo, method);
    byte_4A1EEBD = 1;
  }
  v2 = (Il2CppObject *)sub_1B71818(CharaGraphListViewItemDrawPatternDefault_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1EEBE & 1) == 0 )
  {
    sub_1B715CC(&CharaGraphDefine_CharaGraphItemBulkModifyArgs_TypeInfo, method);
    byte_4A1EEBE = 1;
  }
  v2 = (CharaGraphDefine_CharaGraphItemBulkModifyArgs_o *)sub_1B71818(CharaGraphDefine_CharaGraphItemBulkModifyArgs_TypeInfo);
...
Il2CppObject *__fastcall CharaGraphListViewPatternBase__GetMaster_object_(const MethodInfo_2E4F0E8 *method)
{
  __int64 v1; // x1
  ...
  return DataManager__GetMaster_object_((const MethodInfo_2E5B394 *)method->rgctx_data->_0_DataManager_GetMaster_T_);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !itemBulkModifyArgs )
  {
    ...
    sub_1B71570((ServantStatusBattleListViewItem_o *)p_itemBulkModifyArgs, (int32_t)itemBulkModifyArgs, v5, v6);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !itemDrawPattern )
  {
    ...
    sub_1B71570((ServantStatusBattleListViewItem_o *)p_itemDrawPattern, (int32_t)itemDrawPattern, v5, v6);
  }
