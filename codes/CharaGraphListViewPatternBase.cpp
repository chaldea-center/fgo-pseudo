        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C212FC & 1) == 0 )
  {
    sub_1C3B764(&CharaGraphListViewItemDrawPatternDefault_TypeInfo, method);
    byte_4C212FC = 1;
  }
  v2 = (Il2CppObject *)sub_1C3B9B0(CharaGraphListViewItemDrawPatternDefault_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C212FD & 1) == 0 )
  {
    sub_1C3B764(&CharaGraphDefine_CharaGraphItemBulkModifyArgs_TypeInfo, method);
    byte_4C212FD = 1;
  }
  v2 = (CharaGraphDefine_CharaGraphItemBulkModifyArgs_o *)sub_1C3B9B0(CharaGraphDefine_CharaGraphItemBulkModifyArgs_TypeInfo);
...
Il2CppObject *__fastcall CharaGraphListViewPatternBase__GetMaster_object_(const MethodInfo_2FE3BE4 *method)
{
  __int64 v1; // x1

  if ( !method->rgctx_data )
  {
    sub_1C3B764(&DataManager_TypeInfo, v1);
    if ( !method->rgctx_data )
      sub_1C8D69C(method);
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  return DataManager__GetMaster_object_((const MethodInfo_2FF01B0 *)method->rgctx_data->_0_DataManager_GetMaster_T_);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !itemDrawPattern )
  {
    ...
    sub_1C3B708((PartyOrganizationUtility_o *)p_itemDrawPattern, (int64_t)itemDrawPattern, v5, v6, v7, v8, v9, v10);
  }
