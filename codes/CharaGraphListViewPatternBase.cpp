        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A543 & 1) == 0 )
  {
    sub_1B885B0(&CharaGraphListViewItemDrawPatternDefault_TypeInfo);
    byte_4A5A543 = 1;
  }
  v2 = (Il2CppObject *)sub_1B887FC(CharaGraphListViewItemDrawPatternDefault_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v2 = (CharaGraphDefine_CharaGraphItemBulkModifyArgs_o *)sub_1B887FC(CharaGraphDefine_CharaGraphItemBulkModifyArgs_TypeInfo);
...
Il2CppObject *__fastcall CharaGraphListViewPatternBase__GetMaster_object_(const MethodInfo_2E73608 *method)
{
  ...
  return DataManager__GetMaster_object_((const MethodInfo_2E7F8B4 *)method->rgctx_data->_0_DataManager_GetMaster_T_);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !itemBulkModifyArgs )
  {
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)p_itemBulkModifyArgs, (int32_t)itemBulkModifyArgs, v5, v6);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !itemDrawPattern )
  {
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)p_itemDrawPattern, (int32_t)itemDrawPattern, v5, v6);
  }
