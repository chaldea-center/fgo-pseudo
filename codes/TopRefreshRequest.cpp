...
System_String_o *TopRefreshRequest__getURL(TopRefreshRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_5972504 & 1) == 0 )
  {
    ...
    sub_2213A60(&StringLiteral_24203/*"refresh/top"*/);
    byte_5972504 = 1;
  }
  if ( !*(&NetworkManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_75651716(BaseUrl, (System_String_o *)StringLiteral_24203/*"refresh/top"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  v7 = ResponseCommandKind__SearchData(5, responseList, 0);
