...
void __fastcall SetMessageDispOptionControl__Init(SetMessageDispOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1B094 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_9628/*"OPTION_FRIEND_MESSAGE_DISP"*/, v4);
    sub_1B715CC(&StringLiteral_9629/*"OPTION_FRIEND_MESSAGE_EXPLANATION"*/, v5);
    byte_4A1B094 = 1;
  }
  dispTitle = this->fields.dispTitle;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v7 = LocalizationManager__Get((System_String_o *)StringLiteral_9628/*"OPTION_FRIEND_MESSAGE_DISP"*/, 0LL);
  if ( !dispTitle
    || (UILabel__set_text(dispTitle, v7, 0LL),
        infoLb = this->fields.infoLb,
        v7 = LocalizationManager__Get((System_String_o *)StringLiteral_9629/*"OPTION_FRIEND_MESSAGE_EXPLANATION"*/, 0LL),
        !infoLb) )
  {
    sub_1B71828(v7, v8);
  }
...
void __fastcall SetMessageDispOptionControl__OnChangeBtn(SetMessageDispOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1B097 & 1) == 0 )
  {
    sub_1B715CC(&Method_SetMessageDispOptionControl_OnChangeBtn__, method);
    byte_4A1B097 = 1;
  }
  v3 = Method_SetMessageDispOptionControl_OnChangeBtn__;
  if ( (*((_BYTE *)Method_SetMessageDispOptionControl_OnChangeBtn__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B715E4(Method_SetMessageDispOptionControl_OnChangeBtn__);
