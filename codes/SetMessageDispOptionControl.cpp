...
void __fastcall SetMessageDispOptionControl__Init(SetMessageDispOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BAFA6D & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_9843/*"OPTION_BGM"*/, v4);
    sub_1C13D24(&StringLiteral_9844/*"OPTION_BLACKLIST_EXPLANATION"*/, v5);
    byte_4BAFA6D = 1;
  }
  dispTitle = this->fields.dispTitle;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v7 = LocalizationManager__Get((System_String_o *)StringLiteral_9843/*"OPTION_BGM"*/, 0LL);
  if ( !dispTitle
    || (UILabel__set_text(dispTitle, v7, 0LL),
        infoLb = this->fields.infoLb,
        v7 = LocalizationManager__Get((System_String_o *)StringLiteral_9844/*"OPTION_BLACKLIST_EXPLANATION"*/, 0LL),
        !infoLb) )
  {
    sub_1C13F80(v7, v8);
  }
...
void __fastcall SetMessageDispOptionControl__OnChangeBtn(SetMessageDispOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BAFA70 & 1) == 0 )
  {
    sub_1C13D24(&Method_SetMessageDispOptionControl_OnChangeBtn__, method);
    byte_4BAFA70 = 1;
  }
  v3 = Method_SetMessageDispOptionControl_OnChangeBtn__;
  if ( (*((_BYTE *)Method_SetMessageDispOptionControl_OnChangeBtn__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C13D3C(Method_SetMessageDispOptionControl_OnChangeBtn__);
