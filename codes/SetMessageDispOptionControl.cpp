...
void SetMessageDispOptionControl__Init(SetMessageDispOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596B592 & 1) == 0 )
  {
    ...
    sub_2213A60(&StringLiteral_10066/*"OPTION_FRIEND_MESSAGE_DISP"*/);
    sub_2213A60(&StringLiteral_10067/*"OPTION_FRIEND_MESSAGE_EXPLANATION"*/);
    byte_596B592 = 1;
  }
  dispTitle = this->fields.dispTitle;
  if ( !*(&LocalizationManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, method, v2);
  v5 = LocalizationManager__Get((System_String_o *)StringLiteral_10066/*"OPTION_FRIEND_MESSAGE_DISP"*/, 0);
  if ( !dispTitle
    || (UILabel__set_text(dispTitle, v5, 0),
        infoLb = this->fields.infoLb,
        v5 = LocalizationManager__Get((System_String_o *)StringLiteral_10067/*"OPTION_FRIEND_MESSAGE_EXPLANATION"*/, 0),
        !infoLb) )
  {
    sub_2213CDC(v5, v6);
  }
...
void SetMessageDispOptionControl__OnChangeBtn(SetMessageDispOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596B595 & 1) == 0 )
  {
    sub_2213A60(&Method_SetMessageDispOptionControl_OnChangeBtn__);
    byte_596B595 = 1;
  }
  v3 = Method_SetMessageDispOptionControl_OnChangeBtn__;
  if ( (*((_BYTE *)Method_SetMessageDispOptionControl_OnChangeBtn__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_2213A78(Method_SetMessageDispOptionControl_OnChangeBtn__);
