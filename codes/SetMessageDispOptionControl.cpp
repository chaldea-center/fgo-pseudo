...
void SetMessageDispOptionControl__Init(SetMessageDispOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3DFF6 & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_9668/*"OPTION_FRIEND_MESSAGE_DISP"*/);
    sub_1C37058(&StringLiteral_9669/*"OPTION_FRIEND_MESSAGE_EXPLANATION"*/);
    byte_4C3DFF6 = 1;
  }
...
void SetMessageDispOptionControl__OnChangeBtn(SetMessageDispOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3DFF9 & 1) == 0 )
  {
    sub_1C37058(&Method_SetMessageDispOptionControl_OnChangeBtn__);
    byte_4C3DFF9 = 1;
  }
  v3 = Method_SetMessageDispOptionControl_OnChangeBtn__;
  if ( (*((_BYTE *)Method_SetMessageDispOptionControl_OnChangeBtn__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C37070(Method_SetMessageDispOptionControl_OnChangeBtn__);
