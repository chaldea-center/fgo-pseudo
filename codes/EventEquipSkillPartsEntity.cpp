        ...
        const MethodInfo *method)
{
  if ( (byte_4C56CD7 & 1) == 0 )
  {
    sub_1C3E564(&StringLiteral_11336/*"RenoPartsName"*/);
    byte_4C56CD7 = 1;
  }
  return EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_11336/*"RenoPartsName"*/, 0, 0);
}
