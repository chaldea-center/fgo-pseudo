        ...
        const MethodInfo *method)
{
  if ( (byte_4D30968 & 1) == 0 )
  {
    sub_1C93AD4(&StringLiteral_11420/*"RenoPartsName"*/);
    byte_4D30968 = 1;
  }
  return EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_11420/*"RenoPartsName"*/, 0, 0);
}
