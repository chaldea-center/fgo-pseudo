        ...
        const MethodInfo *method)
{
  if ( (byte_4CC7368 & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_11339/*"RenoPartsName"*/);
    byte_4CC7368 = 1;
  }
  return EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_11339/*"RenoPartsName"*/, 0, 0);
}
