        ...
        const MethodInfo *method)
{
  if ( (byte_4B01F8E & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_11219/*"RenoPartsName"*/, method);
    byte_4B01F8E = 1;
  }
  return EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_11219/*"RenoPartsName"*/, 0LL, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B01F91 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMaster_SkillLvMaster___, method);
