        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C26FB2 & 1) == 0 )
  {
    sub_1C2D490(&Method_BuffConvertEntity_GetParamFromIndex_int___);
    sub_1C2D490(&StringLiteral_10077/*"OverwritePopupColor"*/);
    byte_4C26FB2 = 1;
  }
  result = BuffConvertEntity__GetParamFromIndex_int_(
             this,
             (System_String_o *)StringLiteral_10077/*"OverwritePopupColor"*/,
             index,
             def,
             (const MethodInfo_30C0710 *)Method_BuffConvertEntity_GetParamFromIndex_int___);
  if ( !result )
    return def;
  return result;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C26FB1 & 1) == 0 )
  {
    sub_1C2D490(&Method_BuffConvertEntity_GetParamFromIndex_string___);
    sub_1C2D490(&StringLiteral_10078/*"OverwritePopupText"*/);
    byte_4C26FB1 = 1;
  }
  ParamFromIndex_object = BuffConvertEntity__GetParamFromIndex_object_(
                            this,
                            (System_String_o *)StringLiteral_10078/*"OverwritePopupText"*/,
                            index,
                            (Il2CppObject *)def,
                            (const MethodInfo_30C097C *)Method_BuffConvertEntity_GetParamFromIndex_string___);
...
Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_o BuffConvertEntity__GetParamFromIndex___Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_30C0B5C *method)
{
  void *monitor; // x19
  Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_c *klass; // x23
  const MethodInfo_30C0B5C_RGCTXs *rgctx_data; // x8
  ...
  Il2CppObject *v27; // x0
  long double v28; // q0
  const MethodInfo_30C0B5C_RGCTXs *v29; // x8
...
LABEL_11:
  ...
  v27 = System_Convert__ChangeType_64534428(Item, TypeFromHandle, 0);
  v29 = method->rgctx_data;
  v30 = v27;
  _0_T = (__int64)v29->_0_T;
  if ( (*(&v29->_0_T->_2.bitflags2 + 2) & 1) == 0 )
    _0_T = sub_1C7DBA4(v28);
  v20 = (char *)sub_1C2D5DC(v30, _0_T, (char *)v34 - ((actualSize + 15) & 0x1FFFFFFF0LL));
  v19 = monitor;
LABEL_28:
...
int32_t BuffConvertEntity__GetParamFromIndex_int_(
        ...
        int32_t index,
        int32_t def,
        const MethodInfo_30C0710 *method)
{
  Il2CppObject *ScriptObject; // x0
  __int64 naturalAligment; // x10
  ...
  __int64 v20; // x3
  long double v21; // q0
  const MethodInfo_30C0710_RGCTXs *v22; // x8
  __int64 v23; // x19
  ...
  long double v29; // q0
  const MethodInfo_30C0710_RGCTXs *rgctx_data; // x8
  BuffConvertEntity_o *v31; // x0
  System_String_o *v32; // x1
  int32_t v33; // w2
  Il2CppObject *v34; // x3
  const MethodInfo_30C097C *v35; // x4
  ...
  if ( LODWORD(v12[1].monitor) != 1 )
  {
    ...
    if ( !System_Convert_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(System_Convert_TypeInfo);
    IsNullOrEmpty = (__int64)System_Convert__ChangeType_64534428(Item, TypeFromHandle, 0);
    rgctx_data = method->rgctx_data;
    v23 = IsNullOrEmpty;
    _0_T = (__int64)rgctx_data->_0_T;
    if ( (*(&rgctx_data->_0_T->_2.bitflags2 + 2) & 1) == 0 )
    {
      IsNullOrEmpty = sub_1C7DBA4(v29);
      _0_T = IsNullOrEmpty;
    }
    if ( v23 )
      goto LABEL_20;
LABEL_32:
    sub_1C2D6EC(IsNullOrEmpty, _0_T);
  }
  ...
  if ( !System_Convert_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Convert_TypeInfo);
  IsNullOrEmpty = (__int64)System_Convert__ChangeType_64534428(v15, v18, 0);
  v22 = method->rgctx_data;
  v23 = IsNullOrEmpty;
  _0_T = (__int64)v22->_0_T;
  if ( (*(&v22->_0_T->_2.bitflags2 + 2) & 1) == 0 )
  {
    IsNullOrEmpty = sub_1C7DBA4(v21);
    _0_T = IsNullOrEmpty;
  }
  if ( !v23 )
    goto LABEL_32;
...
Il2CppObject *BuffConvertEntity__GetParamFromIndex_object_(
        ...
        int32_t index,
        Il2CppObject *def,
        const MethodInfo_30C097C *method)
{
  Il2CppObject *ScriptObject; // x0
  __int64 naturalAligment; // x10
  Il2CppObject *v12; // x22
  ...
  if ( !IsNullOrEmpty )
  {
    ...
    if ( !System_Convert_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(System_Convert_TypeInfo);
    v21 = System_Convert__ChangeType_64534428(Item, TypeFromHandle, 0);
    _0_T = method->rgctx_data->_0_T;
    if ( (*(&_0_T->_2.bitflags2 + 2) & 1) == 0 )
      _0_T = (Il2CppClass *)sub_1C7DBA4(v22);
    if ( !v21 )
      return 0;
    def = (Il2CppObject *)sub_1C2D5CC(v21, _0_T);
    if ( !def )
    {
      sub_1C2D9AC(v21);
      return 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C26FAE & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_BuffConvertEntity___c__DisplayClass13_0__TryGetConvertBuffIndex_b__0__);
    sub_1C2D490(&BuffConvertEntity___c__DisplayClass13_0_TypeInfo);
    byte_4C26FAE = 1;
  }
  v9 = sub_1C2D6DC(BuffConvertEntity___c__DisplayClass13_0_TypeInfo);
  ...
  while ( 1 )
  {
    ...
    if ( !*v21 )
    {
      ...
      System_Func_int__bool____ctor(
        ...
        0);
      *(_QWORD *)(v9 + 32) = v22;
      sub_1C2D434((CGThumbnailListItem_o *)(v9 + 32), (int32_t)v22, v23, v24);
    }
    BuffEntity = (System_Int32_array **)BasicHelper__Any_int__51083888(
                                          v19,
        ...
        const MethodInfo *method)
{
  ...
  if ( (unsigned int)i >= LODWORD(targetIds->max_length) )
    sub_1C2D6F4(this, *(_QWORD *)&sf, method);
