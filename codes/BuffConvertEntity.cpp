        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B17F8 & 1) == 0 )
  {
    sub_B52984(&Method_BuffConvertEntity_GetParamFromIndex_int___);
    sub_B52984(&StringLiteral_10257/*"OverwritePopupColor"*/);
    byte_42B17F8 = 1;
  }
  result = BuffConvertEntity__GetParamFromIndex_int_(
             this,
             (System_String_o *)StringLiteral_10257/*"OverwritePopupColor"*/,
             index,
             def,
             (const MethodInfo_1A46B38 *)Method_BuffConvertEntity_GetParamFromIndex_int___);
  if ( !result )
    return def;
  return result;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B17F7 & 1) == 0 )
  {
    sub_B52984(&Method_BuffConvertEntity_GetParamFromIndex_string___);
    sub_B52984(&StringLiteral_10258/*"OverwritePopupText"*/);
    byte_42B17F7 = 1;
  }
  ParamFromIndex_string = BuffConvertEntity__GetParamFromIndex_string_(
                            this,
                            (System_String_o *)StringLiteral_10258/*"OverwritePopupText"*/,
                            index,
                            def,
                            (const MethodInfo_1A46D80 *)Method_BuffConvertEntity_GetParamFromIndex_string___);
...
int32_t __fastcall BuffConvertEntity__GetParamFromIndex_int_(
        ...
        int32_t index,
        int32_t def,
        const MethodInfo_1A46B38 *method)
{
  ...
  const MethodInfo_1A46D80 *v26; // x4
  ...
  if ( (byte_42B15CC & 1) == 0 )
  {
    ...
    this = (BuffConvertEntity_o *)sub_B52984(&System_Type_TypeInfo);
    byte_42B15CC = 1;
  }
  if ( !v9 )
    goto LABEL_32;
  ScriptObject = BuffConvertEntity__GetScriptObject(v9, key, 0LL);
  v11 = sub_B52A44(ScriptObject, System_Collections_Generic_List_object__TypeInfo);
  ...
  if ( v12 == 1 )
  {
    ...
    this = (BuffConvertEntity_o *)System_Convert__ChangeType_42675812(v13, TypeFromHandle, 0LL);
    v16 = this;
    _1_T = method->rgctx_data->_1_T;
    if ( (BYTE2(_1_T->vtable[0].methodPtr) & 1) == 0 )
      this = (BuffConvertEntity_o *)sub_AEB684(_1_T);
    if ( v16 )
      goto LABEL_16;
LABEL_32:
    sub_B52A5C(this, key);
  ...
  this = (BuffConvertEntity_o *)System_Convert__ChangeType_42675812(v19, v21, 0LL);
  v16 = this;
  _1_T = method->rgctx_data->_1_T;
  if ( (BYTE2(_1_T->vtable[0].methodPtr) & 1) == 0 )
    this = (BuffConvertEntity_o *)sub_AEB684(_1_T);
...
LABEL_16:
  ...
  v22 = (BuffConvertEntity_o *)sub_B52D50(v16);
...
System_String_o *__fastcall BuffConvertEntity__GetParamFromIndex_string_(
        ...
        int32_t index,
        System_String_o *def,
        const MethodInfo_1A46D80 *method)
{
  BuffConvertEntity_o *v9; // x23
  Il2CppObject *ScriptObject; // x0
  __int64 v11; // x22
...
LABEL_26:
  ...
  v17 = System_Convert__ChangeType_42675812(v14, TypeFromHandle, 0LL);
  _1_T = method->rgctx_data->_1_T;
  if ( (BYTE2(_1_T->vtable[0].methodPtr) & 1) == 0 )
    sub_AEB684(_1_T);
  if ( !v17 )
    return 0LL;
  def = (System_String_o *)sub_B52A44(v17, _1_T);
  if ( !def )
  {
    sub_B52D50(v17);
    return 0LL;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B17F4 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_BuffConvertEntity___c__DisplayClass13_0__TryGetConvertBuffIndex_b__0__);
    sub_B52984(&BuffConvertEntity___c__DisplayClass13_0_TypeInfo);
    byte_42B17F4 = 1;
  }
  v9 = sub_B52A54(BuffConvertEntity___c__DisplayClass13_0_TypeInfo);
...
LABEL_15:
  ...
  while ( 1 )
  {
    ...
    if ( !*v25 )
    {
      ...
      *(_QWORD *)(v9 + 32) = v26;
      sub_B52920((BattleServantConfConponent_o *)(v9 + 32), (System_Int32_array **)v26, v27, v28, v29, v30, v31, v32);
    }
    BuffEntity = (System_Int32_array **)BasicHelper__Any_int__27531732(
                                          v23,
