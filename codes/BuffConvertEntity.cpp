        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB5A69 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMaster_BuffMaster___, *(_QWORD *)&buffId);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB5A68 & 1) == 0 )
  {
    sub_1BAB41C(&int___TypeInfo, defs);
    byte_4AB5A68 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB5A6B & 1) == 0 )
  {
    sub_1BAB41C(&Method_BuffConvertEntity_GetParamFromIndex_int___, *(_QWORD *)&index);
    sub_1BAB41C(&StringLiteral_10115/*"OverwritePopupColor"*/, v7);
    byte_4AB5A6B = 1;
  }
  result = BuffConvertEntity__GetParamFromIndex_int_(
             ...
             index,
             def,
             (const MethodInfo_2EB6908 *)Method_BuffConvertEntity_GetParamFromIndex_int___);
  if ( !result )
    return def;
  return result;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB5A6A & 1) == 0 )
  {
    sub_1BAB41C(&Method_BuffConvertEntity_GetParamFromIndex_string___, *(_QWORD *)&index);
    sub_1BAB41C(&StringLiteral_10116/*"OverwritePopupText"*/, v7);
    byte_4AB5A6A = 1;
  }
  ParamFromIndex_object = BuffConvertEntity__GetParamFromIndex_object_(
                            ...
                            index,
                            (Il2CppObject *)def,
                            (const MethodInfo_2EB6B74 *)Method_BuffConvertEntity_GetParamFromIndex_string___);
...
Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_o __fastcall BuffConvertEntity__GetParamFromIndex___Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_2EB6D54 *method)
{
  void *monitor; // x19
  Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_c *klass; // x23
  const MethodInfo_2EB6D54_RGCTXs *rgctx_data; // x8
  __int64 v12; // x1
  __int64 v13; // x1
  __int64 v14; // x1
  __int64 v15; // x1
  ...
  Il2CppObject *v30; // x0
  long double v31; // q0
  const MethodInfo_2EB6D54_RGCTXs *v32; // x8
  ...
  if ( !rgctx_data )
  {
    ...
    sub_1BAB41C(&System_Type_TypeInfo, v15);
    rgctx_data = method->rgctx_data;
    if ( !rgctx_data )
    {
      sub_1BFD354(method);
...
LABEL_11:
  ...
  v30 = System_Convert__ChangeType_62691740(Item, TypeFromHandle, 0LL);
  v32 = method->rgctx_data;
  v33 = v30;
  _0_T = (__int64)v32->_0_T;
  if ( (BYTE5(v32->_0_T->vtable[0].methodPtr) & 1) == 0 )
    _0_T = sub_1BFD2F8(v31);
  v24 = (char *)sub_1BAB568(v33, _0_T, (char *)v37 - ((native_size + 15) & 0x1FFFFFFF0LL));
  v23 = monitor;
LABEL_28:
...
int32_t __fastcall BuffConvertEntity__GetParamFromIndex_int_(
        ...
        int32_t index,
        int32_t def,
        const MethodInfo_2EB6908 *method)
{
  __int64 v10; // x1
  __int64 v11; // x1
  __int64 v12; // x1
  ...
  __int64 v23; // x3
  long double v24; // q0
  const MethodInfo_2EB6908_RGCTXs *v25; // x8
  __int64 v26; // x19
  Il2CppObject *Item; // x20
  Il2CppType *_1_T; // x21
  System_Type_o *TypeFromHandle; // x21
  long double v31; // q0
  const MethodInfo_2EB6908_RGCTXs *rgctx_data; // x8
  BuffConvertEntity_o *v33; // x0
  System_String_o *v34; // x1
  int32_t v35; // w2
  Il2CppObject *v36; // x3
  const MethodInfo_2EB6B74 *v37; // x4
  System_RuntimeTypeHandle_o v38; // 0:w0.4
  ...
  {
    sub_1BAB41C(&System_Convert_TypeInfo, key);
    sub_1BAB41C(&Method_System_Collections_Generic_List_object__get_Count__, v10);
    sub_1BAB41C(&Method_System_Collections_Generic_List_object__get_Item__, v11);
  ...
  if ( LODWORD(v16[1].monitor) != 1 )
  {
    ...
    if ( !System_Convert_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(System_Convert_TypeInfo);
    IsNullOrEmpty = (__int64)System_Convert__ChangeType_62691740(Item, TypeFromHandle, 0LL);
    rgctx_data = method->rgctx_data;
    v26 = IsNullOrEmpty;
    _0_T = (__int64)rgctx_data->_0_T;
    if ( (BYTE5(rgctx_data->_0_T->vtable[0].methodPtr) & 1) == 0 )
    {
      IsNullOrEmpty = sub_1BFD2F8(v31);
      _0_T = IsNullOrEmpty;
    }
    if ( v26 )
      goto LABEL_20;
LABEL_32:
    sub_1BAB678(IsNullOrEmpty, _0_T);
  }
  ...
  if ( !System_Convert_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Convert_TypeInfo);
  IsNullOrEmpty = (__int64)System_Convert__ChangeType_62691740(v19, v21, 0LL);
  v25 = method->rgctx_data;
  v26 = IsNullOrEmpty;
  _0_T = (__int64)v25->_0_T;
  if ( (BYTE5(v25->_0_T->vtable[0].methodPtr) & 1) == 0 )
  {
    IsNullOrEmpty = sub_1BFD2F8(v24);
    _0_T = IsNullOrEmpty;
  }
  if ( !v26 )
    goto LABEL_32;
...
Il2CppObject *__fastcall BuffConvertEntity__GetParamFromIndex_object_(
        ...
        int32_t index,
        Il2CppObject *def,
        const MethodInfo_2EB6B74 *method)
{
  __int64 v10; // x1
  __int64 v11; // x1
  __int64 v12; // x1
  ...
  if ( !IsNullOrEmpty )
  {
    ...
    if ( !System_Convert_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(System_Convert_TypeInfo);
    v24 = System_Convert__ChangeType_62691740(Item, TypeFromHandle, 0LL);
    _0_T = method->rgctx_data->_0_T;
    if ( (BYTE5(_0_T->vtable[0].methodPtr) & 1) == 0 )
      _0_T = (Il2CppClass *)sub_1BFD2F8(v25);
    if ( !v24 )
      return 0LL;
    def = (Il2CppObject *)sub_1BAB558(v24, _0_T);
    if ( !def )
    {
      sub_1BAB938(v24);
      return 0LL;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB5A67 & 1) == 0 )
  {
    sub_1BAB41C(&Method_System_Array_IndexOf_int___, convertBuffIndex);
    sub_1BAB41C(&Method_BasicHelper_Any_int____76454352, v9);
    sub_1BAB41C(&System_Func_int__bool__TypeInfo, v10);
    sub_1BAB41C(&Method_BuffConvertEntity___c__DisplayClass13_0__TryGetConvertBuffIndex_b__0__, v11);
    sub_1BAB41C(&BuffConvertEntity___c__DisplayClass13_0_TypeInfo, v12);
    byte_4AB5A67 = 1;
  }
  v13 = sub_1BAB668(BuffConvertEntity___c__DisplayClass13_0_TypeInfo);
  ...
  while ( 1 )
  {
    ...
    if ( !*v25 )
    {
      ...
      System_Func_int__bool____ctor(
        ...
        0LL);
      *(_QWORD *)(v13 + 32) = v26;
      sub_1BAB3C0((ServantStatusBattleListViewItem_o *)(v13 + 32), (int32_t)v26, v27, v28);
    }
    BuffEntity = (System_Int32_array **)BasicHelper__Any_int__48952508(
                                          v23,
