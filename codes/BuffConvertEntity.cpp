        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2DC5D & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMaster_BuffMaster___, *(_QWORD *)&buffId);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2DC5C & 1) == 0 )
  {
    sub_1B761C0(&int___TypeInfo, defs);
    byte_4A2DC5C = 1;
  }
  if ( this->fields.effectId )
  {
    v5 = sub_1B76268(int___TypeInfo, 1LL);
    if ( !v5 )
      sub_1B7641C(0LL, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2DC5F & 1) == 0 )
  {
    sub_1B761C0(&Method_BuffConvertEntity_GetParamFromIndex_int___, *(_QWORD *)&index);
    sub_1B761C0(&StringLiteral_10106/*"OverwritePopupColor"*/, v7);
    byte_4A2DC5F = 1;
  }
  result = BuffConvertEntity__GetParamFromIndex_int_(
             this,
             (System_String_o *)StringLiteral_10106/*"OverwritePopupColor"*/,
             index,
             def,
             (const MethodInfo_2E5499C *)Method_BuffConvertEntity_GetParamFromIndex_int___);
  if ( !result )
    return def;
  return result;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2DC5E & 1) == 0 )
  {
    sub_1B761C0(&Method_BuffConvertEntity_GetParamFromIndex_string___, *(_QWORD *)&index);
    sub_1B761C0(&StringLiteral_10107/*"OverwritePopupText"*/, v7);
    byte_4A2DC5E = 1;
  }
  ParamFromIndex_object = BuffConvertEntity__GetParamFromIndex_object_(
                            this,
                            (System_String_o *)StringLiteral_10107/*"OverwritePopupText"*/,
                            index,
                            (Il2CppObject *)def,
                            (const MethodInfo_2E54C08 *)Method_BuffConvertEntity_GetParamFromIndex_string___);
...
Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_o __fastcall BuffConvertEntity__GetParamFromIndex___Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_2E54DE8 *method)
{
  void *monitor; // x19
  Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_c *klass; // x23
  const MethodInfo_2E54DE8_RGCTXs *rgctx_data; // x8
  __int64 v12; // x1
  __int64 v13; // x1
  __int64 v14; // x1
  __int64 v15; // x1
  ...
  Il2CppObject *v30; // x0
  const MethodInfo_2E54DE8_RGCTXs *v31; // x8
  ...
  if ( !rgctx_data )
  {
    ...
    sub_1B761C0(&System_Type_TypeInfo, v15);
    rgctx_data = method->rgctx_data;
    if ( !rgctx_data )
    {
      sub_1BC80F8(method);
...
LABEL_11:
  ...
  v30 = System_Convert__ChangeType_62178672(Item, TypeFromHandle, 0LL);
  v31 = method->rgctx_data;
  v32 = v30;
  _0_T = (__int64)v31->_0_T;
  if ( (BYTE5(v31->_0_T->vtable[0].methodPtr) & 1) == 0 )
    _0_T = sub_1BC809C(_0_T);
  v24 = (char *)sub_1B7630C(v32, _0_T, (char *)v36 - ((native_size + 15) & 0x1FFFFFFF0LL));
  v23 = monitor;
LABEL_28:
...
int32_t __fastcall BuffConvertEntity__GetParamFromIndex_int_(
        ...
        int32_t index,
        int32_t def,
        const MethodInfo_2E5499C *method)
{
  __int64 v10; // x1
  __int64 v11; // x1
  __int64 v12; // x1
  ...
  __int64 v22; // x2
  __int64 v23; // x3
  const MethodInfo_2E5499C_RGCTXs *v24; // x8
  Il2CppObject *v25; // x19
  Il2CppObject *Item; // x20
  Il2CppType *_1_T; // x21
  System_Type_o *TypeFromHandle; // x21
  const MethodInfo_2E5499C_RGCTXs *rgctx_data; // x8
  BuffConvertEntity_o *v31; // x0
  System_String_o *v32; // x1
  int32_t v33; // w2
  Il2CppObject *v34; // x3
  const MethodInfo_2E54C08 *v35; // x4
  ...
  {
    sub_1B761C0(&System_Convert_TypeInfo, key);
    sub_1B761C0(&Method_System_Collections_Generic_List_object__get_Count__, v10);
    sub_1B761C0(&Method_System_Collections_Generic_List_object__get_Item__, v11);
  ...
  if ( LODWORD(v16[1].monitor) != 1 )
  {
    ...
    if ( !System_Convert_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(System_Convert_TypeInfo);
    IsNullOrEmpty = System_Convert__ChangeType_62178672(Item, TypeFromHandle, 0LL);
    rgctx_data = method->rgctx_data;
    v25 = IsNullOrEmpty;
    _0_T = rgctx_data->_0_T;
    if ( (BYTE5(rgctx_data->_0_T->vtable[0].methodPtr) & 1) == 0 )
    {
      IsNullOrEmpty = (Il2CppObject *)sub_1BC809C(_0_T);
      _0_T = (Il2CppClass *)IsNullOrEmpty;
    }
    if ( v25 )
      goto LABEL_20;
LABEL_32:
    sub_1B7641C(IsNullOrEmpty, _0_T);
  }
  ...
  if ( !System_Convert_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Convert_TypeInfo);
  IsNullOrEmpty = System_Convert__ChangeType_62178672(v19, v21, 0LL);
...
Il2CppObject *__fastcall BuffConvertEntity__GetParamFromIndex_object_(
        ...
        int32_t index,
        Il2CppObject *def,
        const MethodInfo_2E54C08 *method)
{
  __int64 v10; // x1
  __int64 v11; // x1
  __int64 v12; // x1
  ...
  if ( !IsNullOrEmpty )
  {
    ...
    if ( !System_Convert_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(System_Convert_TypeInfo);
    v24 = System_Convert__ChangeType_62178672(Item, TypeFromHandle, 0LL);
    _0_T = method->rgctx_data->_0_T;
    if ( (BYTE5(_0_T->vtable[0].methodPtr) & 1) == 0 )
      _0_T = (Il2CppClass *)sub_1BC809C(_0_T);
    if ( !v24 )
      return 0LL;
    def = (Il2CppObject *)sub_1B762FC(v24, _0_T);
    if ( !def )
    {
      sub_1B766DC(v24);
      return 0LL;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2DC5B & 1) == 0 )
  {
    sub_1B761C0(&Method_System_Array_IndexOf_int___, convertBuffIndex);
    sub_1B761C0(&Method_BasicHelper_Any_int____75906672, v9);
    sub_1B761C0(&System_Func_int__bool__TypeInfo, v10);
    sub_1B761C0(&Method_BuffConvertEntity___c__DisplayClass13_0__TryGetConvertBuffIndex_b__0__, v11);
    sub_1B761C0(&BuffConvertEntity___c__DisplayClass13_0_TypeInfo, v12);
    byte_4A2DC5B = 1;
  }
  v13 = sub_1B7640C(BuffConvertEntity___c__DisplayClass13_0_TypeInfo);
  ...
  while ( 1 )
  {
    ...
    if ( !*v25 )
    {
      ...
      System_Func_int__bool____ctor(
        ...
        0LL);
      *(_QWORD *)(v13 + 32) = v26;
      sub_1B76164((ServantStatusBattleListViewItem_o *)(v13 + 32), (int32_t)v26, v27, v28);
    }
    BuffEntity = (System_Int32_array **)BasicHelper__Any_int__48551248(
                                          v23,
