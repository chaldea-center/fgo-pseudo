void __fastcall MyRoomRootComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B179AE & 1) == 0 )
  {
    sub_1BCAFF8(&MyRoomRootComponent_TypeInfo, v1);
    sub_1BCAFF8(&StringLiteral_8118/*"JumpNewMaterial"*/, v4);
    byte_4B179AE = 1;
  }
  MyRoomRootComponent_TypeInfo->static_fields->MYROOM_STATE_NEW_MATERIAL = (struct System_String_o *)StringLiteral_8118/*"JumpNewMaterial"*/;
  sub_1BCAF9C((CGThumbnailListItem_o *)MyRoomRootComponent_TypeInfo->static_fields, StringLiteral_8118/*"JumpNewMaterial"*/, v2, v3);
}
...
void __fastcall MyRoomRootComponent__beginFinish(MyRoomRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B179AD & 1) == 0 )
  {
    sub_1BCAFF8(&Method_UnityEngine_GameObject_GetComponent_MyRoomControl___, method);
  ...
  else
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                               gameObject,
                                               (const MethodInfo_306E710 *)Method_UnityEngine_GameObject_GetComponent_MyRoomControl___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B179AC & 1) == 0 )
  {
    sub_1BCAFF8(&BattleSetupInfo_TypeInfo, data);
    this = (MyRoomRootComponent_o *)sub_1BCAFF8(&StringLiteral_11043/*"RETURN_BLACKLIST"*/, v6);
    byte_4B179AC = 1;
  }
  klass = v5[1].klass;
  if ( !klass )
  ...
  sub_1BCAF9C(p_interfaces_count, v11, (int32_t)method, v3);
  v13 = v5[1].klass;
  if ( !v13 )
    goto LABEL_24;
...
LABEL_24:
  ...
  {
    SceneRootComponent__beginFinish(v5, 0LL);
    SceneRootComponent__sendMessage(v5, (System_String_o *)StringLiteral_11043/*"RETURN_BLACKLIST"*/, 0LL);
    goto LABEL_22;
  }
  SceneRootComponent__beginResume_40656880(v5, 0LL);
}
  ...
  if ( ((unsigned __int8)v8 & 1) != 0 )
  {
    ...
    if ( !v12
      || (v12->fields.sceneJumpInfo = (struct SceneJumpInfo_o *)v3,
          sub_1BCAF9C((CGThumbnailListItem_o *)&v12->fields.sceneJumpInfo, (int32_t)v3, v10, v11),
