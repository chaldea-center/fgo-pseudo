void __fastcall MyRoomRootComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A49AA3 & 1) == 0 )
  {
    sub_1B863B8(&MyRoomRootComponent_TypeInfo, v1);
    sub_1B863B8(&StringLiteral_8037/*"JumpNewMaterial"*/, v4);
    byte_4A49AA3 = 1;
  }
  MyRoomRootComponent_TypeInfo->static_fields->MYROOM_STATE_NEW_MATERIAL = (struct System_String_o *)StringLiteral_8037/*"JumpNewMaterial"*/;
  sub_1B8635C((CGThumbnailListItem_o *)MyRoomRootComponent_TypeInfo->static_fields, StringLiteral_8037/*"JumpNewMaterial"*/, v2, v3);
}
...
void __fastcall MyRoomRootComponent__beginFinish(MyRoomRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A49AA2 & 1) == 0 )
  {
    sub_1B863B8(&Method_UnityEngine_GameObject_GetComponent_MyRoomControl___, method);
  ...
  else
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                               gameObject,
                                               (const MethodInfo_2FC0DF0 *)Method_UnityEngine_GameObject_GetComponent_MyRoomControl___);
        ...
        const MethodInfo *method)
{
  ...
  int32_t v11; // w1
  CGThumbnailListItem_o *p_interfaces_count; // x0
  ...
  if ( (byte_4A49AA1 & 1) == 0 )
  {
    sub_1B863B8(&BattleSetupInfo_TypeInfo, data);
    this = (MyRoomRootComponent_o *)sub_1B863B8(&StringLiteral_10960/*"RETURN_BLACKLIST"*/, v6);
    byte_4A49AA1 = 1;
  }
  klass = v5[1].klass;
  if ( !klass )
  ...
  if ( data )
  {
    ...
    *(_QWORD *)&klass->_2.interfaces_count = v10;
    p_interfaces_count = (CGThumbnailListItem_o *)&klass->_2.interfaces_count;
    if ( LOBYTE(data->klass->vtable[0].methodPtr) >= (unsigned int)methodPtr_low )
  ...
  sub_1B8635C(p_interfaces_count, v11, (int32_t)method, v3);
  v13 = v5[1].klass;
  if ( !v13 )
    goto LABEL_24;
...
LABEL_24:
  ...
  {
    SceneRootComponent__beginFinish(v5, 0LL);
    SceneRootComponent__sendMessage(v5, (System_String_o *)StringLiteral_10960/*"RETURN_BLACKLIST"*/, 0LL);
    goto LABEL_22;
  }
  SceneRootComponent__beginResume_39636164(v5, 0LL);
}
  ...
  if ( ((unsigned __int8)v8 & 1) != 0 )
  {
    ...
    if ( !v12
      || (v12->fields.sceneJumpInfo = (struct SceneJumpInfo_o *)v3,
          sub_1B8635C((CGThumbnailListItem_o *)&v12->fields.sceneJumpInfo, (int32_t)v3, v10, v11),
