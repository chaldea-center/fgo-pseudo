void __fastcall MyRoomRootComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A045B3 & 1) == 0 )
  {
    sub_1B686D4(&MyRoomRootComponent_TypeInfo, v1);
    sub_1B686D4(&StringLiteral_8127/*"JumpNewMaterial"*/, v2);
    byte_4A045B3 = 1;
  }
  MyRoomRootComponent_TypeInfo->static_fields->MYROOM_STATE_NEW_MATERIAL = (struct System_String_o *)StringLiteral_8127/*"JumpNewMaterial"*/;
  sub_1B68678(MyRoomRootComponent_TypeInfo->static_fields);
}
...
void __fastcall MyRoomRootComponent__beginFinish(MyRoomRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A045B2 & 1) == 0 )
  {
    sub_1B686D4(&Method_UnityEngine_GameObject_GetComponent_MyRoomControl___, method);
  ...
  else
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                               gameObject,
                                               (const MethodInfo_2E98950 *)Method_UnityEngine_GameObject_GetComponent_MyRoomControl___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A045B1 & 1) == 0 )
  {
    sub_1B686D4(&BattleSetupInfo_TypeInfo, data);
    this = (MyRoomRootComponent_o *)sub_1B686D4(&StringLiteral_11064/*"RETURN_BLACKLIST"*/, v5);
    byte_4A045B1 = 1;
  }
  klass = v4[1].klass;
  if ( !klass )
  ...
  this = (MyRoomRootComponent_o *)sub_1B68678(p_field_count);
  v10 = v4[1].klass;
  if ( !v10 )
    goto LABEL_20;
...
LABEL_20:
  ...
  {
    SceneRootComponent__beginFinish(v4, 0LL);
    SceneRootComponent__sendMessage(v4, (System_String_o *)StringLiteral_11064/*"RETURN_BLACKLIST"*/, 0LL);
    goto LABEL_18;
  }
  SceneRootComponent__beginResume_38338696(v4, 0LL);
}
  ...
  if ( ((unsigned __int8)v8 & 1) != 0 )
  {
    ...
    if ( !v10
      || (v10->fields.sceneJumpInfo = (struct SceneJumpInfo_o *)v3,
          sub_1B68678(&v10->fields.sceneJumpInfo),
