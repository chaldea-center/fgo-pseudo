void __fastcall MyRoomRootComponent___cctor(const MethodInfo *method)
{
  if ( (byte_4BD7D04 & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_8339/*"JumpNewMaterial"*/);
    byte_4BD7D04 = 1;
  }
  MyRoomRootComponent_TypeInfo->static_fields->MYROOM_STATE_NEW_MATERIAL = (struct System_String_o *)StringLiteral_8339/*"JumpNewMaterial"*/;
  sub_1C21DDC(MyRoomRootComponent_TypeInfo->static_fields, StringLiteral_8339/*"JumpNewMaterial"*/);
}
...
void __fastcall MyRoomRootComponent__beginFinish(MyRoomRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD7D03 & 1) == 0 )
  {
    sub_1C21E38(&Method_UnityEngine_GameObject_GetComponent_MyRoomControl___);
  ...
  else
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                               gameObject,
                                               (const MethodInfo_3000534 *)Method_UnityEngine_GameObject_GetComponent_MyRoomControl___);
...
LABEL_11:
  ...
  MyRoomControl__HideExchangeSvtCoinMenu(v6, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD7D02 & 1) == 0 )
  {
    ...
    this = (MyRoomRootComponent_o *)sub_1C21E38(&StringLiteral_11327/*"RETURN_BLACKLIST"*/);
    byte_4BD7D02 = 1;
  }
  klass = v4[1].klass;
  if ( !klass )
  ...
  this = (MyRoomRootComponent_o *)sub_1C21DDC(p_interfaces_count, v9);
  v11 = v4[1].klass;
  if ( !v11 )
    goto LABEL_24;
  if ( *(_QWORD *)&v11->_2.interfaces_count )
  {
...
LABEL_24:
  ...
  {
    SceneRootComponent__beginFinish(v4, 0LL);
    SceneRootComponent__sendMessage(v4, (System_String_o *)StringLiteral_11327/*"RETURN_BLACKLIST"*/, 0LL);
    goto LABEL_22;
  }
  SceneRootComponent__beginResume_39920572(v4, 0LL);
}
  ...
  if ( ((unsigned __int8)v7 & 1) != 0 )
  {
    ...
    if ( !v9
      || (v9->fields.sceneJumpInfo = (struct SceneJumpInfo_o *)data,
          sub_1C21DDC(&v9->fields.sceneJumpInfo, data),
