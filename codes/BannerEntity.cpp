...
int32_t __fastcall BannerEntity__GetBannerId(BannerEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A088D4 & 1) == 0 )
  {
    sub_1B686D4(&Method_DataManager_GetMaster_BannerAddMaster___, method);
    sub_1B686D4(&DataManager_TypeInfo, v3);
    byte_4A088D4 = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2E49CFC *)Method_DataManager_GetMaster_BannerAddMaster___);
  if ( !Master_object )
    sub_1B68930(0LL, v5);
