...
int32_t __fastcall BannerEntity__GetBannerId(BannerEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFD393 & 1) == 0 )
  {
    sub_1C2E12C(&Method_DataManager_GetMaster_BannerAddMaster___, method);
    sub_1C2E12C(&DataManager_TypeInfo, v3);
    byte_4BFD393 = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2FD17DC *)Method_DataManager_GetMaster_BannerAddMaster___);
  if ( !Master_object )
    sub_1C2E388(0LL, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFD394 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&StringLiteral_5392/*"DetailScrollDialog"*/, v3);
    byte_4BFD394 = 1;
  }
  return (System_Collections_Generic_Dictionary_string__object__o *)BasicHelper__GetValue_object_(
                                                                      this->fields.script,
                                                                      (System_String_o *)StringLiteral_5392/*"DetailScrollDialog"*/,
                                                                      0LL,
...
bool __fastcall BannerEntity__IsExchangeSvtCoin(BannerEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4BFD395 & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_6413/*"ExchangeSvtCoin"*/, method);
    byte_4BFD395 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_6413/*"ExchangeSvtCoin"*/, 0, 0LL) > 0;
}