...
int32_t __fastcall BannerEntity__GetBannerId(BannerEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B36DF4 & 1) == 0 )
  {
    sub_1BD3458(&Method_DataManager_GetMaster_BannerAddMaster___, method);
    sub_1BD3458(&DataManager_TypeInfo, v3);
    byte_4B36DF4 = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2F31630 *)Method_DataManager_GetMaster_BannerAddMaster___);
  if ( !Master_object )
    sub_1BD36B4(0LL, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B36DF5 & 1) == 0 )
  {
    sub_1BD3458(&Method_BasicHelper_GetValue_Dictionary_string__object____, method);
    sub_1BD3458(&StringLiteral_5377/*"DetailScrollDialog"*/, v3);
    byte_4B36DF5 = 1;
  }
  return (System_Collections_Generic_Dictionary_string__object__o *)BasicHelper__GetValue_object_(
                                                                      this->fields.script,
                                                                      (System_String_o *)StringLiteral_5377/*"DetailScrollDialog"*/,
                                                                      0LL,
...
bool __fastcall BannerEntity__IsExchangeSvtCoin(BannerEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4B36DF6 & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_6387/*"ExchangeSvtCoin"*/, method);
    byte_4B36DF6 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_6387/*"ExchangeSvtCoin"*/, 0, 0LL) > 0;
}