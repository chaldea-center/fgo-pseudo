...
int32_t BannerEntity__GetBannerId(BannerEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C42BBA & 1) == 0 )
  {
    sub_1C37058(&Method_DataManager_GetMaster_BannerAddMaster___);
    sub_1C37058(&DataManager_TypeInfo);
    byte_4C42BBA = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_30E7C04 *)Method_DataManager_GetMaster_BannerAddMaster___);
  if ( !Master_object )
    sub_1C372B4(0);
        ...
        const MethodInfo *method)
{
  if ( (byte_4C42BBB & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_5257/*"DetailScrollDialog"*/);
    byte_4C42BBB = 1;
  }
...
bool BannerEntity__IsExchangeSvtCoin(BannerEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4C42BBC & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_6292/*"ExchangeSvtCoin"*/);
    byte_4C42BBC = 1;
  }
