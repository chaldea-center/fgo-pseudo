...
int32_t BannerEntity__GetBannerId(BannerEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C375C7 & 1) == 0 )
  {
    sub_1C32C20(&Method_DataManager_GetMaster_BannerAddMaster___);
    sub_1C32C20(&DataManager_TypeInfo);
    byte_4C375C7 = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_30DD39C *)Method_DataManager_GetMaster_BannerAddMaster___);
  if ( !Master_object )
    sub_1C32E7C(0);
  result = BannerAddMaster__getOverwriteBannerId((BannerAddMaster_o *)Master_object, this->fields.bannerId, 1, v4);
  if ( result == -1 )
        ...
        const MethodInfo *method)
{
  if ( (byte_4C375C8 & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_5256/*"DetailScrollDialog"*/);
    byte_4C375C8 = 1;
  }
  return (System_Collections_Generic_Dictionary_string__object__o *)BasicHelper__GetValue_object_(
                                                                      this->fields.script,
                                                                      (System_String_o *)StringLiteral_5256/*"DetailScrollDialog"*/,
                                                                      0,
...
bool BannerEntity__IsExchangeSvtCoin(BannerEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4C375C9 & 1) == 0 )
  {
    sub_1C32C20(&StringLiteral_6291/*"ExchangeSvtCoin"*/);
    byte_4C375C9 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_6291/*"ExchangeSvtCoin"*/, 0, 0) > 0;
}