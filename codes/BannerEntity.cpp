...
int32_t __fastcall BannerEntity__GetBannerId(BannerEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FE7A0 & 1) == 0 )
  {
    sub_1B64A00(&Method_DataManager_GetMaster_BannerAddMaster___, method);
    sub_1B64A00(&DataManager_TypeInfo, v3);
    byte_49FE7A0 = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2E3BC8C *)Method_DataManager_GetMaster_BannerAddMaster___);
  if ( !Master_object )
    sub_1B64C5C(0LL, v5);
