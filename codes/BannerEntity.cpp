...
int32_t __fastcall BannerEntity__GetBannerId(BannerEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B01C4D & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMaster_BannerAddMaster___, method);
    sub_1BC3008(&DataManager_TypeInfo, v3);
    byte_4B01C4D = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_3001E10 *)Method_DataManager_GetMaster_BannerAddMaster___);
  if ( !Master_object )
    sub_1BC3264(0LL, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B01C4E & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_5211/*"DetailScrollDialog"*/, v3);
    byte_4B01C4E = 1;
  }
  return (System_Collections_Generic_Dictionary_string__object__o *)BasicHelper__GetValue_object_(
                                                                      this->fields.script,
                                                                      (System_String_o *)StringLiteral_5211/*"DetailScrollDialog"*/,
                                                                      0LL,
...
bool __fastcall BannerEntity__IsExchangeSvtCoin(BannerEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4B01C4F & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_6237/*"ExchangeSvtCoin"*/, method);
    byte_4B01C4F = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_6237/*"ExchangeSvtCoin"*/, 0, 0LL) > 0;
}