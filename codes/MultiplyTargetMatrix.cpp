...
void __fastcall MultiplyTargetMatrix__Start(MultiplyTargetMatrix_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(targetObj, 0LL, 0LL) && this->fields.targetObjPath )
  {
    ...
    v8 = UnityEngine_Transform__Find((UnityEngine_Transform_o *)gameObject, this->fields.targetObjPath, 0LL);
    this->fields.targetObj = v8;
    sub_1BCA784((PartyOrganizationUtility_o *)&this->fields.targetObj, (int64_t)v8, v9, v10, v11, v12, v13, v14);
  }
  MultiplyTargetMatrix__UpdateMatrix(this, v5);
}
...
LABEL_30:
      ...
      MultiplyTargetMatrix__updateMatrix(this, v20, v9);
    }
  }
}
