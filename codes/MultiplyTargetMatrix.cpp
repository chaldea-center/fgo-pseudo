...
void __fastcall MultiplyTargetMatrix__Start(MultiplyTargetMatrix_o *this, const MethodInfo *method)
{
  ...
  __int64 v8; // x1
  struct UnityEngine_Transform_o *v9; // x0
  ...
  if ( UnityEngine_Object__op_Equality(targetObj, 0LL, 0LL) && this->fields.targetObjPath )
  {
    ...
    v9 = UnityEngine_Transform__Find((UnityEngine_Transform_o *)gameObject, this->fields.targetObjPath, 0LL);
    this->fields.targetObj = v9;
    sub_B5D560(
      (BattleServantConfConponent_o *)&this->fields.targetObj,
  ...
  MultiplyTargetMatrix__UpdateMatrix(this, v6);
}
...
LABEL_32:
      ...
      MultiplyTargetMatrix__updateMatrix(this, v23, v12);
    }
  }
}
