void __fastcall OnClickEvent___ctor(OnClickEvent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3AF38 & 1) == 0 )
  {
    sub_1BD3458(&Method_System_Collections_Generic_List_EventDelegate___ctor__, method);
    sub_1BD3458(&System_Collections_Generic_List_EventDelegate__TypeInfo, v3);
    byte_4B3AF38 = 1;
  }
  v4 = (System_Collections_Generic_List_object__o *)sub_1BD36A4(System_Collections_Generic_List_EventDelegate__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v4,
    (const MethodInfo_35C055C *)Method_System_Collections_Generic_List_EventDelegate___ctor__);
  this->fields.onSingleClick = (struct System_Collections_Generic_List_EventDelegate__o *)v4;
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.onSingleClick, (int64_t)v4, v5, v6, v7, v8, v9, v10);
  v11 = (System_Collections_Generic_List_object__o *)sub_1BD36A4(System_Collections_Generic_List_EventDelegate__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v11,
    (const MethodInfo_35C055C *)Method_System_Collections_Generic_List_EventDelegate___ctor__);
  this->fields.onDoubleClick = (struct System_Collections_Generic_List_EventDelegate__o *)v11;
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.onDoubleClick, (int64_t)v11, v12, v13, v14, v15, v16, v17);
...
void __fastcall OnClickEvent__OnDoubleClick(OnClickEvent_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.clickFlag )
  {
    ...
    EventDelegate__Execute_47448748(onDoubleClick, 0LL);
  }
}
...
void __fastcall OnClickEvent__Update(OnClickEvent_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.clickFlag && UnityEngine_Time__get_time(0LL) > (float)(this->fields.clickTime + 0.36) )
  {
    ...
    if ( !EventDelegate_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(EventDelegate_TypeInfo);
    EventDelegate__Execute_47448748(onSingleClick, 0LL);
    this->fields.clickFlag = 0;
