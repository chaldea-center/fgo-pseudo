void __fastcall OnClickEvent___ctor(OnClickEvent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BEDA8 & 1) == 0 )
  {
    sub_1B4CF90(&Method_System_Collections_Generic_List_EventDelegate___ctor__, method);
    sub_1B4CF90(&System_Collections_Generic_List_EventDelegate__TypeInfo, v3);
    byte_49BEDA8 = 1;
  }
  v4 = (System_Collections_Generic_List_object__o *)sub_1B4D1DC(System_Collections_Generic_List_EventDelegate__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v4,
    (const MethodInfo_357F9A8 *)Method_System_Collections_Generic_List_EventDelegate___ctor__);
  this->fields.onSingleClick = (struct System_Collections_Generic_List_EventDelegate__o *)v4;
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.onSingleClick, (int32_t)v4, v5, v6);
  v7 = (System_Collections_Generic_List_object__o *)sub_1B4D1DC(System_Collections_Generic_List_EventDelegate__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v7,
    (const MethodInfo_357F9A8 *)Method_System_Collections_Generic_List_EventDelegate___ctor__);
  this->fields.onDoubleClick = (struct System_Collections_Generic_List_EventDelegate__o *)v7;
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.onDoubleClick, (int32_t)v7, v8, v9);
...
void __fastcall OnClickEvent__OnDoubleClick(OnClickEvent_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.clickFlag )
  {
    ...
    EventDelegate__Execute_47323476(onDoubleClick, 0LL);
  }
}
...
void __fastcall OnClickEvent__Update(OnClickEvent_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.clickFlag && UnityEngine_Time__get_time(0LL) > (float)(this->fields.clickTime + 0.36) )
  {
    ...
    if ( !EventDelegate_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(EventDelegate_TypeInfo);
    EventDelegate__Execute_47323476(onSingleClick, 0LL);
    this->fields.clickFlag = 0;
