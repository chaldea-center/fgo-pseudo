void __fastcall EventMuralMaster___ctor(EventMuralMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A6FEBD & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_EventMuralMaster__EventMuralEntity__int___ctor__, method);
    byte_4A6FEBD = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    459,
    (const MethodInfo_312C568 *)Method_DataMasterBase_EventMuralMaster__EventMuralEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  _BOOL8 IsQuestPhaseClear_37702780; // x0
  __int64 v41; // x1
  int32_t v42; // w2
  int32_t v43; // w3
  ...
  if ( (byte_4A6FEBB & 1) == 0 )
  {
    ...
    sub_1B90010(&EventMuralEntity___TypeInfo, v11);
    sub_1B90010(&EventMuralEntity_TypeInfo, v12);
    ...
    sub_1B90010(&Method_System_Collections_Generic_List_EventMuralEntity__Add__, v16);
    sub_1B90010(&Method_System_Collections_Generic_List_EventMuralEntity__ToArray__, v17);
    sub_1B90010(&Method_System_Collections_Generic_List_EventMuralEntity___ctor__, v18);
    sub_1B90010(&System_Collections_Generic_List_EventMuralEntity__TypeInfo, v19);
    byte_4A6FEBB = 1;
  }
  *total = 0;
  *dispNum = 0;
  ...
  {
    return (EventMuralEntity_array *)sub_1B900B8(EventMuralEntity___TypeInfo, 0LL);
  }
  v21 = (System_Collections_Generic_List_object__o *)sub_1B9025C(System_Collections_Generic_List_EventMuralEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v21,
    (const MethodInfo_351018C *)Method_System_Collections_Generic_List_EventMuralEntity___ctor__);
...
LABEL_44:
    ...
    if ( LODWORD(v34[2].monitor) == eventId )
    {
      ...
      IsQuestPhaseClear_37702780 = CondType__IsQuestPhaseClear_37702780(v38, klass_high, -1, 0, 0LL);
      if ( IsQuestPhaseClear_37702780 )
      {
        if ( !v21 )
          sub_1B9026C(IsQuestPhaseClear_37702780, v41);
        ...
        else
        {
          ...
          sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v47 + 4), (int32_t)v36, v42, v43);
        }
...
LABEL_47:
  ...
  return (EventMuralEntity_array *)System_Collections_Generic_List_object___ToArray(
                                     v21,
                                     (const MethodInfo_3512518 *)Method_System_Collections_Generic_List_EventMuralEntity__ToArray__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FEBC & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_DataMasterBase_EventMuralMaster__EventMuralEntity__int__TryGetEntity__, v9);
    sub_1B90010(&EventMuralEntity___TypeInfo, v10);
    byte_4A6FEBC = 1;
  }
  entity = 0LL;
  *total = 0;
