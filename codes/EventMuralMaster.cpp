void __fastcall EventMuralMaster___ctor(EventMuralMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A1FB27 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataMasterBase_EventMuralMaster__EventMuralEntity__int___ctor__, method);
    byte_4A1FB27 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    459,
    (const MethodInfo_30F8720 *)Method_DataMasterBase_EventMuralMaster__EventMuralEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  _BOOL8 IsQuestPhaseClear_37448924; // x0
  __int64 v41; // x1
  int32_t v42; // w2
  int32_t v43; // w3
  ...
  if ( (byte_4A1FB25 & 1) == 0 )
  {
    ...
    sub_1B715CC(&EventMuralEntity___TypeInfo, v11);
    sub_1B715CC(&EventMuralEntity_TypeInfo, v12);
    ...
    sub_1B715CC(&Method_System_Collections_Generic_List_EventMuralEntity__Add__, v16);
    sub_1B715CC(&Method_System_Collections_Generic_List_EventMuralEntity__ToArray__, v17);
    sub_1B715CC(&Method_System_Collections_Generic_List_EventMuralEntity___ctor__, v18);
    sub_1B715CC(&System_Collections_Generic_List_EventMuralEntity__TypeInfo, v19);
    byte_4A1FB25 = 1;
  }
  *total = 0;
  *dispNum = 0;
  ...
  {
    return (EventMuralEntity_array *)sub_1B71674(EventMuralEntity___TypeInfo, 0LL);
  }
  v21 = (System_Collections_Generic_List_object__o *)sub_1B71818(System_Collections_Generic_List_EventMuralEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v21,
    (const MethodInfo_34CFA2C *)Method_System_Collections_Generic_List_EventMuralEntity___ctor__);
...
LABEL_44:
    ...
    if ( LODWORD(v34[2].monitor) == eventId )
    {
      ...
      IsQuestPhaseClear_37448924 = CondType__IsQuestPhaseClear_37448924(v38, klass_high, -1, 0, 0LL);
      if ( IsQuestPhaseClear_37448924 )
      {
        if ( !v21 )
          sub_1B71828(IsQuestPhaseClear_37448924, v41);
        ...
        else
        {
          ...
          sub_1B71570((ServantStatusBattleListViewItem_o *)(v47 + 4), (int32_t)v36, v42, v43);
        }
...
LABEL_47:
  ...
  return (EventMuralEntity_array *)System_Collections_Generic_List_object___ToArray(
                                     v21,
                                     (const MethodInfo_34D1DB8 *)Method_System_Collections_Generic_List_EventMuralEntity__ToArray__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1FB26 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_DataMasterBase_EventMuralMaster__EventMuralEntity__int__TryGetEntity__, v9);
    sub_1B715CC(&EventMuralEntity___TypeInfo, v10);
    byte_4A1FB26 = 1;
  }
  entity = 0LL;
  *total = 0;
