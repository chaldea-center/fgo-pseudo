        ...
        const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&v9->fields._SvtData_k__BackingField, (int32_t)svtData, v10, v11);
  v9->fields._NpcAi_k__BackingField = npcAi;
  v9 = (NpcServantAiActArgument_o *)((char *)v9 + 56);
  LOBYTE(v9[-1].fields._NpcAi_k__BackingField) = 0;
  sub_1C36FFC((CGThumbnailListItem_o *)v9, (int32_t)npcAi, v12, v13);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C46017 & 1) == 0 )
  {
    sub_1C37058(&BattleActionData___TypeInfo);
    byte_4C46017 = 1;
  }
  ServantAiActArgument__InitCommonTask((ServantAiActArgument_o *)this, task, method);
  v5 = sub_1C37100(BattleActionData___TypeInfo, 2);
  ...
  {
    LoadNpcPreStepInAction = sub_1C37194(LoadNpcPreStepInAction, v7->obj.klass->_1.element_class);
    if ( !LoadNpcPreStepInAction )
    {
LABEL_17:
      v18 = sub_1C372D8(LoadNpcPreStepInAction);
      sub_1C37180(v18, 0);
    }
  }
  if ( !LODWORD(v7->max_length) )
    goto LABEL_16;
  v7->m_Items[0] = v11;
  sub_1C36FFC((CGThumbnailListItem_o *)v7->m_Items, (int32_t)v11, v9, v10);
  ...
  {
LABEL_15:
    sub_1C372B4(LoadNpcPreStepInAction);
  }
...
LABEL_16:
    sub_1C372BC(LoadNpcPreStepInAction);
  v7->m_Items[1] = v17;
        ...
        const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields._NpcAi_k__BackingField, (int32_t)value, (int32_t)method, v3);
}