        ...
        const MethodInfo *method)
{
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&v9->fields._SvtData_k__BackingField, (int32_t)svtData, v10, v11);
  v9->fields._NpcAi_k__BackingField = npcAi;
  v9 = (NpcServantAiActArgument_o *)((char *)v9 + 56);
  LOBYTE(v9[-1].fields._NpcAi_k__BackingField) = 0;
  sub_1B4CF34((CGThumbnailListItem_o *)v9, (int32_t)npcAi, v12, v13);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BDBF6 & 1) == 0 )
  {
    sub_1B4CF90(&BattleActionData___TypeInfo, task);
    byte_49BDBF6 = 1;
  }
  ServantAiActArgument__InitCommonTask((ServantAiActArgument_o *)this, task, method);
  v5 = sub_1B4D038(BattleActionData___TypeInfo, 2LL);
  ...
  {
    LoadNpcPreStepInAction = sub_1B4D0CC(LoadNpcPreStepInAction, v7->obj.klass->_1.element_class);
    if ( !LoadNpcPreStepInAction )
    {
LABEL_17:
      v21 = sub_1B4D210(LoadNpcPreStepInAction);
      sub_1B4D0B8(v21, 0LL);
    }
  }
  if ( !v7->max_length )
    goto LABEL_16;
  v7->m_Items[0] = v12;
  sub_1B4CF34((CGThumbnailListItem_o *)v7->m_Items, (int32_t)v12, v10, v11);
  ...
  {
LABEL_15:
    sub_1B4D1EC(LoadNpcPreStepInAction, v9);
  }
  ...
  if ( v7->max_length <= 1 )
LABEL_16:
    sub_1B4D1F4(LoadNpcPreStepInAction, v9);
  v7->m_Items[1] = v18;
  sub_1B4CF34((CGThumbnailListItem_o *)&v7->m_Items[1], (int32_t)v18, v16, v17);
  if ( !task )
    goto LABEL_15;
  task->fields.interruptActions = v7;
  sub_1B4CF34((CGThumbnailListItem_o *)&task->fields.interruptActions, (int32_t)v7, v19, v20);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields._NpcAi_k__BackingField, (int32_t)value, (int32_t)method, v3);
}