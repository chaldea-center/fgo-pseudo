        ...
        const MethodInfo *method)
{
  ...
  sub_1C9403C((GrandQuestFolderBoardItem_o *)v9, (int32_t)npcAi, v16, v17, v18, v19, v20, v21);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2F95E & 1) == 0 )
  {
    sub_1C94098(&BattleActionData___TypeInfo);
    byte_4D2F95E = 1;
  }
  ServantAiActArgument__InitCommonTask((ServantAiActArgument_o *)this, task, method);
  v5 = sub_1C94140(BattleActionData___TypeInfo, 2);
  ...
  {
    LoadNpcPreStepInAction = sub_1C941D4(LoadNpcPreStepInAction, v7->obj.klass->_1.element_class);
    if ( !LoadNpcPreStepInAction )
    {
LABEL_17:
      v27 = sub_1C94314(LoadNpcPreStepInAction);
      sub_1C941C0(v27, 0);
    }
  }
  if ( !LODWORD(v7->max_length) )
    goto LABEL_16;
  v7->m_Items[0] = v16;
  sub_1C9403C((GrandQuestFolderBoardItem_o *)v7->m_Items, (int32_t)v16, v10, v11, v12, v13, v14, v15);
  ...
  {
LABEL_15:
    sub_1C942F0(LoadNpcPreStepInAction, v9);
  }
...
LABEL_16:
    sub_1C942F8(LoadNpcPreStepInAction);
  v7->m_Items[1] = v26;
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&v7->m_Items[1], (int32_t)v26, v20, v21, v22, v23, v24, v25);
  if ( !task )
    goto LABEL_15;
