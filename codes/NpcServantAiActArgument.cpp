        ...
        const MethodInfo *method)
{
  ...
  sub_1C3B708((PartyOrganizationUtility_o *)v9, (int64_t)npcAi, v16, v17, v18, v19, v20, v21);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24CBC & 1) == 0 )
  {
    sub_1C3B764(&BattleActionData___TypeInfo, task);
    byte_4C24CBC = 1;
  }
  ServantAiActArgument__InitCommonTask((ServantAiActArgument_o *)this, task, method);
  v5 = sub_1C3B80C(BattleActionData___TypeInfo, 2LL);
  ...
  {
    LoadNpcPreStepInAction = sub_1C3B8A0(LoadNpcPreStepInAction, v7->obj.klass->_1.element_class);
    if ( !LoadNpcPreStepInAction )
    {
LABEL_17:
      v33 = sub_1C3B9E4(LoadNpcPreStepInAction);
      sub_1C3B88C(v33, 0LL);
    }
  }
  if ( !v7->max_length )
  ...
  sub_1C3B708((PartyOrganizationUtility_o *)v7->m_Items, v16, v10, v11, v12, v13, v14, v15);
  ...
  {
LABEL_15:
    sub_1C3B9C0(LoadNpcPreStepInAction, v9);
  }
  ...
  if ( v7->max_length <= 1 )
LABEL_16:
    sub_1C3B9C8(LoadNpcPreStepInAction, v9);
  v7->m_Items[1] = (BattleActionData_o *)v26;
  sub_1C3B708((PartyOrganizationUtility_o *)&v7->m_Items[1], v26, v20, v21, v22, v23, v24, v25);
  if ( !task )
    goto LABEL_15;
  task->fields.interruptActions = v7;
  sub_1C3B708((PartyOrganizationUtility_o *)&task->fields.interruptActions, (int64_t)v7, v27, v28, v29, v30, v31, v32);
}
