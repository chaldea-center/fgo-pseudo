...
void MapFogAttacher__Attach(MapFogAttacher_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3FAC9 & 1) == 0 )
  {
    sub_1C37058(&Method_SingletonMonoBehaviour_MapFogManager__get_Instance__);
    byte_4C3FAC9 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39ED16C *)Method_SingletonMonoBehaviour_MapFogManager__get_Instance__);
  if ( Instance )
...
void MapFogAttacher__OnDestroy(MapFogAttacher_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3FAC8 & 1) == 0 )
  {
    ...
    this = (MapFogAttacher_o *)sub_1C37058(&Method_SingletonMonoBehaviour_MapFogManager__get_Instance__);
    byte_4C3FAC8 = 1;
  }
