...
void __fastcall MapFogAttacher__Attach(MapFogAttacher_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC47AA & 1) == 0 )
  {
    sub_1C1ABD4(&Method_SingletonMonoBehaviour_MapFogManager__get_Instance__, method);
    byte_4BC47AA = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_387A8A8 *)Method_SingletonMonoBehaviour_MapFogManager__get_Instance__);
  if ( Instance )
...
void __fastcall MapFogAttacher__OnDestroy(MapFogAttacher_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC47A9 & 1) == 0 )
  {
    ...
    this = (MapFogAttacher_o *)sub_1C1ABD4(&Method_SingletonMonoBehaviour_MapFogManager__get_Instance__, v3);
    byte_4BC47A9 = 1;
  }
