...
void MapFogAttacher__Attach(MapFogAttacher_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2D426 & 1) == 0 )
  {
    sub_1C93AD4(&Method_SingletonMonoBehaviour_MapFogManager__get_Instance__);
    byte_4D2D426 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3AC52FC *)Method_SingletonMonoBehaviour_MapFogManager__get_Instance__);
  if ( Instance )
...
void MapFogAttacher__OnDestroy(MapFogAttacher_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2D425 & 1) == 0 )
  {
    ...
    this = (MapFogAttacher_o *)sub_1C93AD4(&Method_SingletonMonoBehaviour_MapFogManager__get_Instance__);
    byte_4D2D425 = 1;
  }
