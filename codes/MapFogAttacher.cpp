...
void __fastcall MapFogAttacher__Attach(MapFogAttacher_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B300D & 1) == 0 )
  {
    sub_B52984(&Method_SingletonMonoBehaviour_MapFogManager__get_Instance__);
    byte_42B300D = 1;
  }
  Instance = SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_MapFogManager__get_Instance__);
  if ( Instance )
...
void __fastcall MapFogAttacher__OnDestroy(MapFogAttacher_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B300C & 1) == 0 )
  {
    ...
    this = (MapFogAttacher_o *)sub_B52984(&Method_SingletonMonoBehaviour_MapFogManager__get_Instance__);
    byte_42B300C = 1;
  }
