...
void MapFogAttacher__Attach(MapFogAttacher_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C53864 & 1) == 0 )
  {
    sub_1C3E564(&Method_SingletonMonoBehaviour_MapFogManager__get_Instance__);
    byte_4C53864 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39FF5A8 *)Method_SingletonMonoBehaviour_MapFogManager__get_Instance__);
  if ( Instance )
...
void MapFogAttacher__OnDestroy(MapFogAttacher_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C53863 & 1) == 0 )
  {
    ...
    this = (MapFogAttacher_o *)sub_1C3E564(&Method_SingletonMonoBehaviour_MapFogManager__get_Instance__);
    byte_4C53863 = 1;
  }
