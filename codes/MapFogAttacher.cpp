...
void MapFogAttacher__Attach(MapFogAttacher_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596D0E8 & 1) == 0 )
  {
    sub_2213A60(&Method_SingletonMonoBehaviour_MapFogManager__get_Instance__);
    byte_596D0E8 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_47A29F8 *)Method_SingletonMonoBehaviour_MapFogManager__get_Instance__);
  if ( Instance )
...
void MapFogAttacher__OnDestroy(MapFogAttacher_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596D0E7 & 1) == 0 )
  {
    ...
    this = (MapFogAttacher_o *)sub_2213A60(&Method_SingletonMonoBehaviour_MapFogManager__get_Instance__);
    byte_596D0E7 = 1;
  }
