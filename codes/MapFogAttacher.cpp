...
void MapFogAttacher__Attach(MapFogAttacher_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C344DF & 1) == 0 )
  {
    sub_1C32C20(&Method_SingletonMonoBehaviour_MapFogManager__get_Instance__);
    byte_4C344DF = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39E2904 *)Method_SingletonMonoBehaviour_MapFogManager__get_Instance__);
  if ( Instance )
...
void MapFogAttacher__OnDestroy(MapFogAttacher_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C344DE & 1) == 0 )
  {
    ...
    this = (MapFogAttacher_o *)sub_1C32C20(&Method_SingletonMonoBehaviour_MapFogManager__get_Instance__);
    byte_4C344DE = 1;
  }
