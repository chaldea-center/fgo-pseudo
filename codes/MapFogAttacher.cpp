...
void __fastcall MapFogAttacher__Attach(MapFogAttacher_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB2AFB & 1) == 0 )
  {
    sub_1BAB41C(&Method_SingletonMonoBehaviour_MapFogManager__get_Instance__, method);
    byte_4AB2AFB = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_378A22C *)Method_SingletonMonoBehaviour_MapFogManager__get_Instance__);
  if ( Instance )
...
void __fastcall MapFogAttacher__OnDestroy(MapFogAttacher_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB2AFA & 1) == 0 )
  {
    ...
    this = (MapFogAttacher_o *)sub_1BAB41C(&Method_SingletonMonoBehaviour_MapFogManager__get_Instance__, v3);
    byte_4AB2AFA = 1;
  }
