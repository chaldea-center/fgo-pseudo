...
void __fastcall MapFogAttacher__Attach(MapFogAttacher_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FB9DD & 1) == 0 )
  {
    sub_1B64A00(&Method_SingletonMonoBehaviour_MapFogManager__get_Instance__, method);
    byte_49FB9DD = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE930 *)Method_SingletonMonoBehaviour_MapFogManager__get_Instance__);
  if ( Instance )
...
void __fastcall MapFogAttacher__OnDestroy(MapFogAttacher_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FB9DC & 1) == 0 )
  {
    ...
    this = (MapFogAttacher_o *)sub_1B64A00(&Method_SingletonMonoBehaviour_MapFogManager__get_Instance__, v3);
    byte_49FB9DC = 1;
  }
