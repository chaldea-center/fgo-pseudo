...
void __fastcall MapFogAttacher__Attach(MapFogAttacher_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB13F0 & 1) == 0 )
  {
    sub_1C13D24(&Method_SingletonMonoBehaviour_MapFogManager__get_Instance__, method);
    byte_4BB13F0 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3869BD8 *)Method_SingletonMonoBehaviour_MapFogManager__get_Instance__);
  if ( Instance )
...
void __fastcall MapFogAttacher__OnDestroy(MapFogAttacher_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB13EF & 1) == 0 )
  {
    ...
    this = (MapFogAttacher_o *)sub_1C13D24(&Method_SingletonMonoBehaviour_MapFogManager__get_Instance__, v3);
    byte_4BB13EF = 1;
  }
