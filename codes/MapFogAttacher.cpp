...
void __fastcall MapFogAttacher__Attach(MapFogAttacher_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B33EF1 & 1) == 0 )
  {
    sub_1BD3458(&Method_SingletonMonoBehaviour_MapFogManager__get_Instance__, method);
    byte_4B33EF1 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37FDC48 *)Method_SingletonMonoBehaviour_MapFogManager__get_Instance__);
  if ( Instance )
...
void __fastcall MapFogAttacher__OnDestroy(MapFogAttacher_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B33EF0 & 1) == 0 )
  {
    ...
    this = (MapFogAttacher_o *)sub_1BD3458(&Method_SingletonMonoBehaviour_MapFogManager__get_Instance__, v3);
    byte_4B33EF0 = 1;
  }
