...
void __fastcall MapFogAttacher__Attach(MapFogAttacher_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD9239 & 1) == 0 )
  {
    sub_1C21E38(&Method_SingletonMonoBehaviour_MapFogManager__get_Instance__);
    byte_4BD9239 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_388D058 *)Method_SingletonMonoBehaviour_MapFogManager__get_Instance__);
  if ( Instance )
...
void __fastcall MapFogAttacher__OnDestroy(MapFogAttacher_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD9238 & 1) == 0 )
  {
    ...
    this = (MapFogAttacher_o *)sub_1C21E38(&Method_SingletonMonoBehaviour_MapFogManager__get_Instance__);
    byte_4BD9238 = 1;
  }
