        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C46A & 1) == 0 )
  {
    sub_1B715CC(&Method_System_Array_IndexOf_int___, deckDataList);
    sub_1B715CC(&Method_System_Collections_Generic_List_ListViewItem__Add__, v9);
    sub_1B715CC(&SupportSelectDeckListViewItem_TypeInfo, v10);
    byte_4A1C46A = 1;
  }
  if ( deckDataList )
  {
    ...
    if ( (int)deckDataList->max_length >= 1 )
    {
      ...
      do
      {
        ...
        v16 = v13;
        v17 = sub_1B71818(SupportSelectDeckListViewItem_TypeInfo);
        ListViewItem___ctor_40493632((ListViewItem_o *)v17, v11, 0LL);
        *(_QWORD *)(v17 + 112) = v15;
        sub_1B71570((ServantStatusBattleListViewItem_o *)(v17 + 112), (int32_t)v15, v18, v19);
        *(_BYTE *)(v17 + 120) = v12 >= 0;
        *(_BYTE *)(v17 + 121) = v16 < 0;
        ...
        else
        {
          ...
          sub_1B71570((ServantStatusBattleListViewItem_o *)(v27 + 4), v17, v21, v22);
        }
        ++v11;
      }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C46C & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponent_SupportSelectDeckListViewObject___, v5);
    sub_1B715CC(&Method_System_Collections_Generic_List_SupportSelectDeckListViewObject__Add__, v6);
    sub_1B715CC(&Method_System_Collections_Generic_List_GameObject__GetEnumerator__, v7);
    sub_1B715CC(&Method_System_Collections_Generic_List_SupportSelectDeckListViewObject___ctor__, v8);
    sub_1B715CC(&System_Collections_Generic_List_SupportSelectDeckListViewObject__TypeInfo, v9);
    sub_1B715CC(&UnityEngine_Object_TypeInfo, v10);
    byte_4A1C46C = 1;
  }
  memset(&v27, 0, sizeof(v27));
  v11 = (System_Collections_Generic_List_object__o *)sub_1B71818(System_Collections_Generic_List_SupportSelectDeckListViewObject__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v11,
    (const MethodInfo_34CFA2C *)Method_System_Collections_Generic_List_SupportSelectDeckListViewObject___ctor__);
            ...
            (const MethodInfo_324F8B8 *)Method_System_Collections_Generic_List_Enumerator_GameObject__MoveNext__) )
  {
    ...
    if ( v15 )
    {
      ...
      Component_object = UnityEngine_GameObject__GetComponent_object_(
                           ...
                           (const MethodInfo_2EAA998 *)Method_UnityEngine_GameObject_GetComponent_SupportSelectDeckListViewObject___);
        ...
        const MethodInfo *method)
{
  ...
  SupportSelectDeckListViewManager__SetMode_33037144(this, mode, 0LL, v3);
}


// local variable allocation has failed, the output may be wrong!
void __fastcall SupportSelectDeckListViewManager__SetMode_33037144(
        SupportSelectDeckListViewManager_o *this,
        int32_t mode,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C46B & 1) == 0 )
  {
    sub_1B715CC(
      ...
      *(_QWORD *)&mode);
    sub_1B715CC(&Method_System_Collections_Generic_List_Enumerator_SupportSelectDeckListViewObject__MoveNext__, v7);
    sub_1B715CC(&Method_System_Collections_Generic_List_Enumerator_SupportSelectDeckListViewObject__get_Current__, v8);
    sub_1B715CC(&Method_System_Collections_Generic_List_SupportSelectDeckListViewObject__GetEnumerator__, v9);
    sub_1B715CC(&UnityEngine_Object_TypeInfo, v10);
    byte_4A1C46B = 1;
  }
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    ObjectList,
    (const MethodInfo_34D0D58 *)Method_System_Collections_Generic_List_SupportSelectDeckListViewObject__GetEnumerator__);
  while ( System_Collections_Generic_List_Enumerator_object___MoveNext(
            &v21,
            (const MethodInfo_324F8B8 *)Method_System_Collections_Generic_List_Enumerator_SupportSelectDeckListViewObject__MoveNext__) )
  {
    ...
    if ( v16 )
    {
      ...
      sub_1B71570((ServantStatusBattleListViewItem_o *)&current[8], (int32_t)v20, v18, v19);
  ...
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v21,
    (const MethodInfo_324F8B4 *)Method_System_Collections_Generic_List_Enumerator_SupportSelectDeckListViewObject__Dispose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C46D & 1) == 0 )
  {
    this = (SupportSelectDeckListViewManager_o *)sub_1B715CC(&SupportSelectDeckListViewObject_TypeInfo, obj);
    byte_4A1C46D = 1;
  }
  if ( !obj )
LABEL_8:
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&obj[1].monitor, (int32_t)onSelectDeck, v9, v10);
