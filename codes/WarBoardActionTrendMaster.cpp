void __fastcall WarBoardActionTrendMaster___ctor(WarBoardActionTrendMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A4F531 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataMasterBase_WarBoardActionTrendMaster__WarBoardActionTrendEntity__int___ctor__, method);
    byte_4A4F531 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    330,
    (const MethodInfo_3211F5C *)Method_DataMasterBase_WarBoardActionTrendMaster__WarBoardActionTrendEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4F533 & 1) == 0 )
  {
    sub_1B863B8(
      ...
      futureTrendMaster);
    *(_QWORD *)&futureTrendId = sub_1B863B8(&WarBoardActionTrendEntity_TypeInfo, v7);
    byte_4A4F533 = 1;
  }
  if ( !futureTrendMaster )
    sub_1B86614(*(_QWORD *)&futureTrendId, futureTrendMaster);
  result = (WarBoardActionTrendEntity_o *)DataMasterBase_object__object__int___GetEntity(
                                            ...
                                            v6,
                                            (const MethodInfo_3214280 *)Method_DataMasterBase_WarBoardFutureActionTrendMaster__WarBoardFutureActionTrendEntity__int__GetEntity__);
  if ( result )
  {
    v9 = result;
    v10 = (WarBoardActionTrendEntity_o *)sub_1B86604(WarBoardActionTrendEntity_TypeInfo);
    WarBoardActionTrendEntity___ctor_41365376(v10, (WarBoardFutureActionTrendEntity_o *)v9, baseTrendEntity, v11);
    return v10;
  }
  return result;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4F532 & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Array_Empty_WarBoardActionTrendEntity___, baseTrendEntity);
    sub_1B863B8(&Method_DataManager_GetMaster_WarBoardFutureActionTrendMaster___, v4);
    sub_1B863B8(&DataManager_TypeInfo, v5);
    sub_1B863B8(&Method_System_Linq_Enumerable_Select_int__WarBoardActionTrendEntity___, v6);
    sub_1B863B8(&Method_System_Linq_Enumerable_ToArray_WarBoardActionTrendEntity___, v7);
    sub_1B863B8(&System_Func_int__WarBoardActionTrendEntity__TypeInfo, v8);
    sub_1B863B8(&Method_WarBoardActionTrendMaster___c__DisplayClass1_0__GetFutureActionTrendEntityArray_b__0__, v9);
    sub_1B863B8(&WarBoardActionTrendMaster___c__DisplayClass1_0_TypeInfo, v10);
    byte_4A4F532 = 1;
  }
  v11 = sub_1B86604(WarBoardActionTrendMaster___c__DisplayClass1_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v11, 0LL);
  if ( !v11 )
    goto LABEL_19;
  *(_QWORD *)(v11 + 24) = baseTrendEntity;
  sub_1B8635C((CGThumbnailListItem_o *)(v11 + 24), (int32_t)baseTrendEntity, v14, v15);
  v16 = *(_QWORD *)(v11 + 24);
  if ( !v16 )
    goto LABEL_19;
  if ( !BasicHelper__IsNullOrEmpty(*(System_Collections_ICollection_o **)(v16 + 56), 0LL) )
  {
    ...
    Master_object = DataManager__GetMaster_object_((const MethodInfo_2F6DC64 *)Method_DataManager_GetMaster_WarBoardFutureActionTrendMaster___);
    *(_QWORD *)(v11 + 16) = Master_object;
    sub_1B8635C((CGThumbnailListItem_o *)(v11 + 16), (int32_t)Master_object, v24, v25);
    v26 = *(_QWORD *)(v11 + 24);
    if ( v26 )
    {
      v27 = *(System_Collections_Generic_IEnumerable_TSource__o **)(v26 + 56);
      v28 = (System_Func_T__TResult__o *)sub_1B86604(System_Func_int__WarBoardActionTrendEntity__TypeInfo);
      ...
      v29 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_int__object_(
                                                                   ...
                                                                   (const MethodInfo_2F9EBA0 *)Method_System_Linq_Enumerable_Select_int__WarBoardActionTrendEntity___);
      return (WarBoardActionTrendEntity_array *)System_Linq_Enumerable__ToArray_object_(
                                                  v29,
                                                  (const MethodInfo_2FA98D8 *)Method_System_Linq_Enumerable_ToArray_WarBoardActionTrendEntity___);
    }
LABEL_19:
    sub_1B86614(v12, v13);
  }
  ...
  if ( !v19 )
  {
    sub_1BD6AA4(Method_System_Array_Empty_WarBoardActionTrendEntity___);
    v19 = v18[7];
  }
  v20 = *(_QWORD *)(v19 + 16);
