        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C4041D & 1) == 0 )
  {
    sub_1C37058(&BackViewListViewItem_TypeInfo);
    this = (BackViewListViewManager_o *)sub_1C37058(&Method_System_Collections_Generic_List_ListViewItem__Add__);
    byte_4C4041D = 1;
  }
  if ( !list )
    goto LABEL_15;
  ...
  if ( (int)max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      if ( v6 >= LODWORD(list->max_length) )
        sub_1C372BC(this);
      v8 = list->m_Items[v6];
      v9 = sub_1C372A4(BackViewListViewItem_TypeInfo);
      ListViewItem___ctor_43804668((ListViewItem_o *)v9, v6, 0);
      *(_QWORD *)(v9 + 120) = v8;
      ...
      else
      {
        ...
        *(_QWORD *)(v17 + 32) = v9;
        sub_1C36FFC((CGThumbnailListItem_o *)(v17 + 32), v9, v12, v13);
      }
      if ( v7 == ++v6 )
        goto LABEL_13;
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C40420 & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_BackViewListViewManager_OnMoveEnd__);
    sub_1C37058(&Method_System_Collections_Generic_List_Enumerator_BackViewListViewObject__Dispose__);
    sub_1C37058(&Method_System_Collections_Generic_List_Enumerator_BackViewListViewObject__MoveNext__);
    sub_1C37058(&Method_System_Collections_Generic_List_Enumerator_BackViewListViewObject__get_Current__);
    sub_1C37058(&Method_System_Collections_Generic_List_BackViewListViewObject__GetEnumerator__);
    sub_1C37058(&Method_System_Collections_Generic_List_BackViewListViewObject__get_Count__);
  ...
  else
  {
    ...
    System_Collections_Generic_List_object___GetEnumerator(
      ...
      ObjectList,
      (const MethodInfo_37A3B1C *)Method_System_Collections_Generic_List_BackViewListViewObject__GetEnumerator__);
    while ( System_Collections_Generic_List_Enumerator_object___MoveNext(
              &v13,
              (const MethodInfo_352D810 *)Method_System_Collections_Generic_List_Enumerator_BackViewListViewObject__MoveNext__) )
    {
      ...
      if ( !current )
        sub_1C372B4(v11);
      BackViewListViewObject__Init_37325976((BackViewListViewObject_o *)current, mode, v10, delay, v12);
    }
    System_Collections_Generic_List_Enumerator_object___Dispose(
      &v13,
      (const MethodInfo_352D80C *)Method_System_Collections_Generic_List_Enumerator_BackViewListViewObject__Dispose__);
  }
}


// local variable allocation has failed, the output may be wrong!
void BackViewListViewManager__RequestListObject_37324948(
        BackViewListViewManager_o *this,
        int32_t mode,
        const MethodInfo *method)
{
  ...
  else
  {
              ...
              (const MethodInfo_352D810 *)Method_System_Collections_Generic_List_Enumerator_BackViewListViewObject__MoveNext__) )
    {
      ...
      if ( !current )
        sub_1C372B4(v9);
      BackViewListViewObject__Init_37326060((BackViewListViewObject_o *)current, mode, v8, v10);
    }
    System_Collections_Generic_List_Enumerator_object___Dispose(
      &v11,
      (const MethodInfo_352D80C *)Method_System_Collections_Generic_List_Enumerator_BackViewListViewObject__Dispose__);
...
void BackViewListViewManager__SetMode(BackViewListViewManager_o *this, int32_t mode, const MethodInfo *method)
{
  ...
  BackViewListViewManager__SetMode_37324828(this, mode, 0, v3);
}


void BackViewListViewManager__SetMode_37324828(
        BackViewListViewManager_o *this,
        int32_t mode,
        ...
        const MethodInfo *method)
{
  ...
  if ( mode == 1 )
  {
    ...
    BackViewListViewManager__RequestListObject_37324948(this, 3, v6);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C4041F & 1) == 0 )
  {
    this = (BackViewListViewManager_o *)sub_1C37058(&BackViewListViewObject_TypeInfo);
    byte_4C4041F = 1;
  }
  if ( !obj
  ...
  if ( v5->fields.initMode == 1 )
    ...
    v7 = 2;
  BackViewListViewObject__Init_37324748((BackViewListViewObject_o *)obj, v7, (const MethodInfo *)item);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C4041C & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_UnityEngine_GameObject_GetComponent_BackViewListViewObject___);
    sub_1C37058(&Method_System_Collections_Generic_List_BackViewListViewObject__Add__);
    sub_1C37058(&Method_System_Collections_Generic_List_GameObject__GetEnumerator__);
    sub_1C37058(&Method_System_Collections_Generic_List_BackViewListViewObject___ctor__);
    sub_1C37058(&System_Collections_Generic_List_BackViewListViewObject__TypeInfo);
    sub_1C37058(&UnityEngine_Object_TypeInfo);
    byte_4C4041C = 1;
  }
  memset(&v17, 0, sizeof(v17));
  v3 = (System_Collections_Generic_List_object__o *)sub_1C372A4(System_Collections_Generic_List_BackViewListViewObject__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v3,
    (const MethodInfo_37A27F0 *)Method_System_Collections_Generic_List_BackViewListViewObject___ctor__);
            ...
            (const MethodInfo_352D810 *)Method_System_Collections_Generic_List_Enumerator_GameObject__MoveNext__) )
  {
    ...
    if ( v6 )
    {
      ...
      Component_object = UnityEngine_GameObject__GetComponent_object_(
                           ...
                           (const MethodInfo_313F1D8 *)Method_UnityEngine_GameObject_GetComponent_BackViewListViewObject___);
