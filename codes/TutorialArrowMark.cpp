        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFC38C & 1) == 0 )
  {
    ...
    sub_1C2E12C(&StringLiteral_13710/*"TUTORIAL_ARROW_MARK_MESSAGE"*/, v8);
    byte_4BFC38C = 1;
  }
  ...
  messageLabel = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_13710/*"TUTORIAL_ARROW_MARK_MESSAGE"*/, 0LL);
  if ( !v10 )
    goto LABEL_17;
