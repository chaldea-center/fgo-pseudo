...
void TutorialArrowMark__Init(TutorialArrowMark_o *this, UnityEngine_Vector2_o pos, float way, const MethodInfo *method)
{
  ...
  if ( (byte_4CC600C & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_13546/*"TUTORIAL_ARROW_MARK_MESSAGE"*/);
    byte_4CC600C = 1;
  }
  ...
  messageLabel = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_13546/*"TUTORIAL_ARROW_MARK_MESSAGE"*/, 0);
  if ( !v9 )
    goto LABEL_17;
