        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4D1AA & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_13312/*"TUTORIAL_ARROW_MARK_MESSAGE"*/, v8);
    byte_4A4D1AA = 1;
  }
  ...
  messageLabel = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_13312/*"TUTORIAL_ARROW_MARK_MESSAGE"*/, 0LL);
  if ( !v10 )
    goto LABEL_17;
