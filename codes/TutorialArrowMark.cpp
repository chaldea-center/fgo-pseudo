        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD1D5 & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_13379/*"TUTORIAL_ARROW_MARK_MESSAGE"*/, v8);
    byte_49FD1D5 = 1;
  }
  ...
  messageLabel = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_13379/*"TUTORIAL_ARROW_MARK_MESSAGE"*/, 0LL);
  if ( !v10 )
    goto LABEL_17;
