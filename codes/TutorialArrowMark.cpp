        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2CBF3 & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_13438/*"TUTORIAL_ARROW_MARK_MESSAGE"*/, v8);
    byte_4A2CBF3 = 1;
  }
  ...
  messageLabel = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_13438/*"TUTORIAL_ARROW_MARK_MESSAGE"*/, 0LL);
  if ( !v10 )
    goto LABEL_17;
