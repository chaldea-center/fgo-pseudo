...
void TutorialArrowMark__Init(TutorialArrowMark_o *this, UnityEngine_Vector2_o pos, float way, const MethodInfo *method)
{
  ...
  if ( (byte_596F3E3 & 1) == 0 )
  {
    ...
    sub_2213A60(&StringLiteral_14094/*"TUTORIAL_ARROW_MARK_MESSAGE"*/);
    byte_596F3E3 = 1;
  }
  ...
  messageLabel = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_14094/*"TUTORIAL_ARROW_MARK_MESSAGE"*/, 0);
  if ( !v11 )
    goto LABEL_17;
