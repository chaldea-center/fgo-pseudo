        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B65809 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_13644/*"TUTORIAL_ARROW_MARK_MESSAGE"*/, v8);
    byte_4B65809 = 1;
  }
  ...
  messageLabel = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_13644/*"TUTORIAL_ARROW_MARK_MESSAGE"*/, 0LL);
  if ( !v10 )
    goto LABEL_17;
