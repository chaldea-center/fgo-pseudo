        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B198 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_13422/*"TUTORIAL_ARROW_MARK_MESSAGE"*/, v8);
    byte_4B1B198 = 1;
  }
  ...
  messageLabel = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_13422/*"TUTORIAL_ARROW_MARK_MESSAGE"*/, 0LL);
  if ( !v10 )
    goto LABEL_17;
