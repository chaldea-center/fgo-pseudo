void __fastcall RestrictionWholeMaster___ctor(RestrictionWholeMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A7047C & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_RestrictionWholeMaster__RestrictionWholeEntity__string___ctor__, method);
    byte_4A7047C = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    449,
    (const MethodInfo_312C8C0 *)Method_DataMasterBase_RestrictionWholeMaster__RestrictionWholeEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A7047B & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_System_Collections_Generic_List_RestrictionWholeEntity__Add__, v8);
    sub_1B90010(&Method_System_Collections_Generic_List_RestrictionWholeEntity__ToArray__, v9);
    sub_1B90010(&Method_System_Collections_Generic_List_RestrictionWholeEntity___ctor__, v10);
    sub_1B90010(&System_Collections_Generic_List_RestrictionWholeEntity__TypeInfo, v11);
    sub_1B90010(&RestrictionWholeEntity_TypeInfo, v12);
    byte_4A7047B = 1;
  }
  v13 = (System_Collections_Generic_List_object__o *)sub_1B9025C(System_Collections_Generic_List_RestrictionWholeEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v13,
    (const MethodInfo_351018C *)Method_System_Collections_Generic_List_RestrictionWholeEntity___ctor__);
...
LABEL_36:
    ...
    {
      if ( !v13 )
        sub_1B9026C(v26, RestrictionWholeEntity_TypeInfo);
...
LABEL_39:
  ...
  return (RestrictionWholeEntity_array *)System_Collections_Generic_List_object___ToArray(
                                           v13,
                                           (const MethodInfo_3512518 *)Method_System_Collections_Generic_List_RestrictionWholeEntity__ToArray__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (RestrictionWholeEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                       (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                       PK,
                                       (const MethodInfo_312C900 *)Method_DataMasterBase_RestrictionWholeMaster__RestrictionWholeEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A7047E & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_RestrictionWholeMaster__RestrictionWholeEntity__string__TryGetEntity__, entity);
    byte_4A7047E = 1;
  }
  PK = (Il2CppObject *)RestrictionWholeEntity__CreatePK(id, idx, 0LL);
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_312C950 *)Method_DataMasterBase_RestrictionWholeMaster__RestrictionWholeEntity__string__TryGetEntity__);
}