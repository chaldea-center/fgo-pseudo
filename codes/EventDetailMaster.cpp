void EventDetailMaster___ctor(EventDetailMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4E04985 & 1) == 0 )
  {
    sub_1CE6700(&Method_DataMasterBase_EventDetailMaster__EventDetailEntity__int___ctor__);
    byte_4E04985 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    126,
    (const MethodInfo_34E6CE4 *)Method_DataMasterBase_EventDetailMaster__EventDetailEntity__int___ctor__);
}
...
System_Int32_array *EventDetailMaster__GetEventIdsByMission(EventDetailMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E04986 & 1) == 0 )
  {
    sub_1CE6700(&Method_DataMasterBase_EventDetailMaster__EventDetailEntity__int__getEntityList__);
    sub_1CE6700(&Method_System_Linq_Enumerable_Distinct_int___);
    sub_1CE6700(&Method_System_Linq_Enumerable_Select_EventDetailEntity__int___);
    sub_1CE6700(&Method_System_Linq_Enumerable_ToArray_int___);
    sub_1CE6700(&Method_System_Linq_Enumerable_Where_EventDetailEntity___);
    sub_1CE6700(&System_Func_EventDetailEntity__int__TypeInfo);
    sub_1CE6700(&System_Func_EventDetailEntity__bool__TypeInfo);
    sub_1CE6700(&Method_EventDetailMaster___c__GetEventIdsByMission_b__1_0__);
    sub_1CE6700(&Method_EventDetailMaster___c__GetEventIdsByMission_b__1_1__);
    sub_1CE6700(&EventDetailMaster___c_TypeInfo);
    byte_4E04986 = 1;
  }
  ...
  if ( !_9__1_0 )
  {
    ...
    _9__1_0 = (System_Func_object__bool__o *)sub_1CE694C(System_Func_EventDetailEntity__bool__TypeInfo);
  ...
  v14 = System_Linq_Enumerable__Where_object_(
          ...
          (const MethodInfo_324B214 *)Method_System_Linq_Enumerable_Where_EventDetailEntity___);
  ...
  if ( !_9__1_1 )
  {
    ...
    _9__1_1 = (System_Func_object__int__o *)sub_1CE694C(System_Func_EventDetailEntity__int__TypeInfo);
    ...
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&v19->__9__1_1, (int32_t)_9__1_1, v20, v21, v22, v23, v24, v25);
  }
  v26 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_object__int_(
                                                               ...
                                                               (const MethodInfo_3239D60 *)Method_System_Linq_Enumerable_Select_EventDetailEntity__int___);
        ...
        const MethodInfo *method)
{
  ...
  *grandWarId = 0;
  ...
  if ( !Master_object )
LABEL_25:
    sub_1CE6958(Master_object, MasterKind_k__BackingField);
  ...
  if ( EnableExistEventRewardEntityList )
  {
    ...
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    Master_object = (EventMaster_o *)DataManager__GetMaster_object_((const MethodInfo_3204354 *)Method_DataManager_GetMaster_CommonReleaseMaster___);
...
void EventDetailMaster___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1CE694C(EventDetailMaster___c_TypeInfo);
