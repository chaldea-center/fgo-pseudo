        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B60D3 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_9459/*"OPTION_AUTO_SELECT_PARTY_INFO"*/, v4);
    sub_1B4CF90(&StringLiteral_9458/*"OPTION_AUTO_SELECT_PARTY"*/, v5);
    byte_49B60D3 = 1;
  }
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v7 = LocalizationManager__Get((System_String_o *)StringLiteral_9458/*"OPTION_AUTO_SELECT_PARTY"*/, 0LL);
  if ( !titleLabel
    || (UILabel__set_text(titleLabel, v7, 0LL),
        infoLabel = this->fields.infoLabel,
        v7 = LocalizationManager__Get((System_String_o *)StringLiteral_9459/*"OPTION_AUTO_SELECT_PARTY_INFO"*/, 0LL),
        !infoLabel) )
  {
    sub_1B4D1EC(v7, v8);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B60D5 & 1) == 0 )
  {
    sub_1B4CF90(&Method_SetAutoSelectPartyOptionControl_OnClickButton__, method);
    byte_49B60D5 = 1;
  }
  klass = this->klass;
  this->fields.flag ^= 1u;
  ...
  if ( (*((_BYTE *)Method_SetAutoSelectPartyOptionControl_OnClickButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1B4CFA8(Method_SetAutoSelectPartyOptionControl_OnClickButton__);
