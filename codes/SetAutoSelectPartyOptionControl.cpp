        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B11616 & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&StringLiteral_9788/*"OPTION_AUTO_SELECT_PARTY_INFO"*/, v6, v7);
    sub_1BCA7E0(&StringLiteral_9787/*"OPTION_AUTO_SELECT_PARTY"*/, v8, v9);
    byte_4B11616 = 1;
  }
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, method);
  v11 = LocalizationManager__Get((System_String_o *)StringLiteral_9787/*"OPTION_AUTO_SELECT_PARTY"*/, 0LL);
  if ( !titleLabel
    || (UILabel__set_text(titleLabel, v11, 0LL),
        infoLabel = this->fields.infoLabel,
        v11 = LocalizationManager__Get((System_String_o *)StringLiteral_9788/*"OPTION_AUTO_SELECT_PARTY_INFO"*/, 0LL),
        !infoLabel) )
  {
    sub_1BCAA3C(v11, v12);
  }
  ...
  SetAutoSelectPartyOptionControl__RefreshDisplay(this, v15);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B11618 & 1) == 0 )
  {
    sub_1BCA7E0(&Method_SetAutoSelectPartyOptionControl_OnClickButton__, method, v2);
    byte_4B11618 = 1;
  }
  klass = this->klass;
  this->fields.flag ^= 1u;
  ...
  if ( (*((_BYTE *)Method_SetAutoSelectPartyOptionControl_OnClickButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1BCA7F8(Method_SetAutoSelectPartyOptionControl_OnClickButton__);
