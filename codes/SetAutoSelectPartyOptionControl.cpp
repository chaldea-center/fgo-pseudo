...
void SetAutoSelectPartyOptionControl__Init(SetAutoSelectPartyOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E72553 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_9778/*"OPTION_AUTO_SELECT_PARTY_INFO"*/);
    sub_1D0F0B4(&StringLiteral_9777/*"OPTION_AUTO_SELECT_PARTY"*/);
    byte_4E72553 = 1;
  }
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9777/*"OPTION_AUTO_SELECT_PARTY"*/, 0);
  if ( !titleLabel
    || (UILabel__set_text(titleLabel, v4, 0),
        infoLabel = this->fields.infoLabel,
        v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9778/*"OPTION_AUTO_SELECT_PARTY_INFO"*/, 0),
        !infoLabel) )
  {
    sub_1D0F30C(v4, v5);
  }
...
void SetAutoSelectPartyOptionControl__OnClickButton(SetAutoSelectPartyOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E72555 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_SetAutoSelectPartyOptionControl_OnClickButton__);
    byte_4E72555 = 1;
  }
  klass = this->klass;
  this->fields.flag ^= 1u;
  ...
  if ( (*((_BYTE *)Method_SetAutoSelectPartyOptionControl_OnClickButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1D0F0CC(Method_SetAutoSelectPartyOptionControl_OnClickButton__);
