...
void SetAutoSelectPartyOptionControl__Init(SetAutoSelectPartyOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C32A00 & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_9660/*"OPTION_AUTO_SELECT_PARTY_INFO"*/);
    sub_1C32C20(&StringLiteral_9659/*"OPTION_AUTO_SELECT_PARTY"*/);
    byte_4C32A00 = 1;
  }
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9659/*"OPTION_AUTO_SELECT_PARTY"*/, 0);
  if ( !titleLabel
    || (UILabel__set_text(titleLabel, v4, 0),
        infoLabel = this->fields.infoLabel,
        v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9660/*"OPTION_AUTO_SELECT_PARTY_INFO"*/, 0),
        !infoLabel) )
  {
    sub_1C32E7C(v4);
  }
...
void SetAutoSelectPartyOptionControl__OnClickButton(SetAutoSelectPartyOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C32A02 & 1) == 0 )
  {
    sub_1C32C20(&Method_SetAutoSelectPartyOptionControl_OnClickButton__);
    byte_4C32A02 = 1;
  }
  klass = this->klass;
  this->fields.flag ^= 1u;
  ...
  if ( (*((_BYTE *)Method_SetAutoSelectPartyOptionControl_OnClickButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1C32C38(Method_SetAutoSelectPartyOptionControl_OnClickButton__);
