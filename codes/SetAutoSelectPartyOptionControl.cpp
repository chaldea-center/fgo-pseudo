...
void SetAutoSelectPartyOptionControl__Init(SetAutoSelectPartyOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C51D6A & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_9661/*"OPTION_AUTO_SELECT_PARTY_INFO"*/);
    sub_1C3E564(&StringLiteral_9660/*"OPTION_AUTO_SELECT_PARTY"*/);
    byte_4C51D6A = 1;
  }
...
void SetAutoSelectPartyOptionControl__OnClickButton(SetAutoSelectPartyOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C51D6C & 1) == 0 )
  {
    sub_1C3E564(&Method_SetAutoSelectPartyOptionControl_OnClickButton__);
    byte_4C51D6C = 1;
  }
  klass = this->klass;
  this->fields.flag ^= 1u;
  ...
  if ( (*((_BYTE *)Method_SetAutoSelectPartyOptionControl_OnClickButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1C3E57C(Method_SetAutoSelectPartyOptionControl_OnClickButton__);
