...
void SetAutoSelectPartyOptionControl__Init(SetAutoSelectPartyOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_5933479 & 1) == 0 )
  {
    ...
    sub_21FFC50(&StringLiteral_10046/*"OPTION_AUTO_SELECT_PARTY_INFO"*/);
    sub_21FFC50(&StringLiteral_10045/*"OPTION_AUTO_SELECT_PARTY"*/);
    byte_5933479 = 1;
  }
  titleLabel = this->fields.titleLabel;
  if ( !*(&LocalizationManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, method, v2);
  v5 = LocalizationManager__Get((System_String_o *)StringLiteral_10045/*"OPTION_AUTO_SELECT_PARTY"*/, 0);
  if ( !titleLabel
    || (UILabel__set_text(titleLabel, v5, 0),
        infoLabel = this->fields.infoLabel,
        v5 = LocalizationManager__Get((System_String_o *)StringLiteral_10046/*"OPTION_AUTO_SELECT_PARTY_INFO"*/, 0),
        !infoLabel) )
  {
    sub_21FFECC(v5, v6);
  }
...
void SetAutoSelectPartyOptionControl__OnClickButton(SetAutoSelectPartyOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_593347B & 1) == 0 )
  {
    sub_21FFC50(&Method_SetAutoSelectPartyOptionControl_OnClickButton__);
    byte_593347B = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetAutoSelectPartyOptionControl_OnClickButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_21FFC68(Method_SetAutoSelectPartyOptionControl_OnClickButton__);
