        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B2F3A & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_9836/*"OPTION_AUTO_SELECT_PARTY_INFO"*/);
    sub_B52984(&StringLiteral_9835/*"OPTION_AUTO_SELECT_PARTY"*/);
    byte_42B2F3A = 1;
  }
  ...
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9835/*"OPTION_AUTO_SELECT_PARTY"*/, 0LL);
  if ( !infoLabel
    || (UILabel__set_text(infoLabel, v4, 0LL),
        switchButton = (UILabel_o *)this->fields.switchButton,
        v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9836/*"OPTION_AUTO_SELECT_PARTY_INFO"*/, 0LL),
        !switchButton) )
  {
    sub_B52A5C(v4, v5);
  }
