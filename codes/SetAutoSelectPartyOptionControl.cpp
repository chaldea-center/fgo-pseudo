        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB1228 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_9661/*"OPTION_AUTO_SELECT_PARTY_INFO"*/, v4);
    sub_1BAB41C(&StringLiteral_9660/*"OPTION_AUTO_SELECT_PARTY"*/, v5);
    byte_4AB1228 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB122A & 1) == 0 )
  {
    sub_1BAB41C(&Method_SetAutoSelectPartyOptionControl_OnClickButton__, method);
    byte_4AB122A = 1;
  }
  klass = this->klass;
  this->fields.flag ^= 1u;
  ...
  if ( (*((_BYTE *)Method_SetAutoSelectPartyOptionControl_OnClickButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1BAB434(Method_SetAutoSelectPartyOptionControl_OnClickButton__);
