...
void SetAutoSelectPartyOptionControl__Init(SetAutoSelectPartyOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CE9593 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_9686/*"OPTION_AUTO_SELECT_PARTY_INFO"*/);
    sub_1C7BAE8(&StringLiteral_9685/*"OPTION_AUTO_SELECT_PARTY"*/);
    byte_4CE9593 = 1;
  }
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9685/*"OPTION_AUTO_SELECT_PARTY"*/, 0);
  if ( !titleLabel
    || (UILabel__set_text(titleLabel, v4, 0),
        infoLabel = this->fields.infoLabel,
        v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9686/*"OPTION_AUTO_SELECT_PARTY_INFO"*/, 0),
        !infoLabel) )
  {
    sub_1C7BD40(v4, v5);
  }
...
void SetAutoSelectPartyOptionControl__OnClickButton(SetAutoSelectPartyOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CE9595 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_SetAutoSelectPartyOptionControl_OnClickButton__);
    byte_4CE9595 = 1;
  }
  klass = this->klass;
  this->fields.flag ^= 1u;
  ...
  if ( (*((_BYTE *)Method_SetAutoSelectPartyOptionControl_OnClickButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1C7BB00(Method_SetAutoSelectPartyOptionControl_OnClickButton__);
