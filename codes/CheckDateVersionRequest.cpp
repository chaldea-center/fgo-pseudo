System_String_o *__fastcall CheckDateVersionRequest__getURL(CheckDateVersionRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B17A3C & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&StringLiteral_18121/*"checkDateVersion/check"*/, v3, v4);
    byte_4B17A3C = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62401220(BaseUrl, (System_String_o *)StringLiteral_18121/*"checkDateVersion/check"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v9 = ResponseCommandKind__SearchData(106, responseList, 0LL);
