System_String_o *__fastcall CheckDateVersionRequest__getURL(CheckDateVersionRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A212D7 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_17888/*"checkDateVersion/check"*/, v2);
    byte_4A212D7 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61505504(BaseUrl, (System_String_o *)StringLiteral_17888/*"checkDateVersion/check"*/, 0LL);
}
