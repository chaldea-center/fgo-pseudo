...
System_String_o *CheckDateVersionRequest__getURL(CheckDateVersionRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C28D56 & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_17938/*"checkDateVersion/check"*/);
    byte_4C28D56 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63457864(BaseUrl, (System_String_o *)StringLiteral_17938/*"checkDateVersion/check"*/, 0);
}
