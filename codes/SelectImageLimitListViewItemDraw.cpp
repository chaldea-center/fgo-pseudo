        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B621FF & 1) == 0 )
  {
    sub_1BE4ACC(&Method_DataManager_GetMaster_ServantCostumeMaster___, item);
    sub_1BE4ACC(&DataManager_TypeInfo, v5);
    sub_1BE4ACC(&LocalizationManager_TypeInfo, v6);
    sub_1BE4ACC(&StringLiteral_12055/*"SERVANT_STATUS_IMAGE_LIMIT_COUNT_LEVEL_"*/, v7);
  ...
  Master_object = (ServantCostumeMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2F590BC *)Method_DataManager_GetMaster_ServantCostumeMaster___);
...
LABEL_23:
  ...
  if ( item->fields.limitCount <= 3 )
  {
    ...
    v15 = System_String__Concat_62698808((System_String_o *)StringLiteral_12055/*"SERVANT_STATUS_IMAGE_LIMIT_COUNT_LEVEL_"*/, v14, 0LL);
...
LABEL_38:
  ...
  if ( !Master_object )
    goto LABEL_43;
  if ( item->fields.isSelected )
    v24 = &StringLiteral_17700/*"btn_bg_21"*/;
  else
    v24 = &StringLiteral_17699/*"btn_bg_20"*/;
