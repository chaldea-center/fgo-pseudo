...
void CostumeListViewObject__Awake(CostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D34CC8 & 1) == 0 )
  {
    sub_1C93AD4(&Method_UnityEngine_GameObject_GetComponent_CostumeListViewItemDraw___);
    byte_4D34CC8 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_31FC084 *)Method_UnityEngine_GameObject_GetComponent_CostumeListViewItemDraw___);
...
CostumeListViewItem_o *CostumeListViewObject__GetItem(CostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D34CC9 & 1) == 0 )
  {
    sub_1C93AD4(&CostumeListViewItem_TypeInfo);
    byte_4D34CC9 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    v30 = *((_DWORD *)&xmmword_D00E00 + v11);
    this->fields.state = dword_D00810[v11];
...
void CostumeListViewObject__Init_49610064(CostumeListViewObject_o *this, int32_t initMode, const MethodInfo *method)
{
...
void CostumeListViewObject__Init_49610660(
        CostumeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void CostumeListViewObject__Init_49612648(
        CostumeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
void CostumeListViewObject__OnClickSelect(CostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C93AD4(&CostumeListViewItem_TypeInfo);
    sub_1C93AD4(&Method_CostumeListViewObject_OnClickSelect__);
    this = (CostumeListViewObject_o *)sub_1C93AD4(&StringLiteral_9923/*"OnClickSelectListView"*/);
    byte_4D34CCE = 1;
  }
      ...
      && (CostumeListViewItem_c *)linkItem->klass->_2.typeHierarchy[naturalAligment - 1] == CostumeListViewItem_TypeInfo )
    {
      if ( HIBYTE(linkItem[1].fields.index) || LOBYTE(linkItem[1].fields.sortIndex) )
      {
        ...
        if ( (*((_BYTE *)Method_CostumeListViewObject_OnClickSelect__ + 83) & 2) != 0 )
          v5 = (_QWORD *)sub_1C93AEC(Method_CostumeListViewObject_OnClickSelect__);
...
void CostumeListViewObject__SetItem_49611736(
        CostumeListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
System_String_o *CostumeListViewObject__ToString(CostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D34CCD & 1) == 0 )
  {
    sub_1C93AD4(&CostumeListViewItemDraw_DispMode_TypeInfo);
