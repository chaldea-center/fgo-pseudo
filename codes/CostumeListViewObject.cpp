...
void CostumeListViewObject__Awake(CostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C5AF43 & 1) == 0 )
  {
    sub_1C3E564(&Method_UnityEngine_GameObject_GetComponent_CostumeListViewItemDraw___);
    byte_4C5AF43 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_31510CC *)Method_UnityEngine_GameObject_GetComponent_CostumeListViewItemDraw___);
...
CostumeListViewItem_o *CostumeListViewObject__GetItem(CostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C5AF44 & 1) == 0 )
  {
    sub_1C3E564(&CostumeListViewItem_TypeInfo);
    byte_4C5AF44 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    v22 = *((_DWORD *)&xmmword_C123E0 + v11);
    this->fields.state = dword_C11DF0[v11];
...
void CostumeListViewObject__Init_48846960(CostumeListViewObject_o *this, int32_t initMode, const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void CostumeListViewObject__Init_48847556(
        CostumeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void CostumeListViewObject__Init_48849544(
        CostumeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
void CostumeListViewObject__OnClickSelect(CostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C3E564(&CostumeListViewItem_TypeInfo);
    sub_1C3E564(&Method_CostumeListViewObject_OnClickSelect__);
    this = (CostumeListViewObject_o *)sub_1C3E564(&StringLiteral_9868/*"OnClickSelectListView"*/);
    byte_4C5AF49 = 1;
  }
      ...
      && (CostumeListViewItem_c *)linkItem->klass->_2.typeHierarchy[naturalAligment - 1] == CostumeListViewItem_TypeInfo )
    {
      if ( HIBYTE(linkItem[1].fields.index) || LOBYTE(linkItem[1].fields.sortIndex) )
      {
        ...
        if ( (*((_BYTE *)Method_CostumeListViewObject_OnClickSelect__ + 83) & 2) != 0 )
          v5 = (_QWORD *)sub_1C3E57C(Method_CostumeListViewObject_OnClickSelect__);
...
void CostumeListViewObject__SetItem_48848632(
        CostumeListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
System_String_o *CostumeListViewObject__ToString(CostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C5AF48 & 1) == 0 )
  {
    sub_1C3E564(&CostumeListViewItemDraw_DispMode_TypeInfo);
