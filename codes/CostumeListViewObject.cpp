...
void CostumeListViewObject__Awake(CostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2663D & 1) == 0 )
  {
    sub_1C94098(&Method_UnityEngine_GameObject_GetComponent_CostumeListViewItemDraw___);
    byte_4D2663D = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_31F4790 *)Method_UnityEngine_GameObject_GetComponent_CostumeListViewItemDraw___);
...
CostumeListViewItem_o *CostumeListViewObject__GetItem(CostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2663E & 1) == 0 )
  {
    sub_1C94098(&CostumeListViewItem_TypeInfo);
    byte_4D2663E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    v18 = *((_DWORD *)&xmmword_CFEF30 + v11);
    this->fields.state = dword_CFE930[v11];
    this->fields.dispMode = v18;
  }
  if ( !state || dispMode != this->fields.dispMode )
    CostumeListViewObject__SetupDisp(this, v17);
  v19 = *p_callbackFunc;
  if ( *p_callbackFunc )
  {
    *p_callbackFunc = 0;
...
void CostumeListViewObject__Init_31862276(CostumeListViewObject_o *this, int32_t initMode, const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void CostumeListViewObject__Init_31862872(
        CostumeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void CostumeListViewObject__Init_31864860(
        CostumeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
void CostumeListViewObject__OnClickSelect(CostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C94098(&CostumeListViewItem_TypeInfo);
    sub_1C94098(&Method_CostumeListViewObject_OnClickSelect__);
    this = (CostumeListViewObject_o *)sub_1C94098(&StringLiteral_9889/*"OnClickSelectListView"*/);
    byte_4D26643 = 1;
  }
      ...
      && (CostumeListViewItem_c *)linkItem->klass->_2.typeHierarchy[naturalAligment - 1] == CostumeListViewItem_TypeInfo )
    {
      if ( HIBYTE(linkItem[1].fields.index) || LOBYTE(linkItem[1].fields.sortIndex) )
      {
        ...
        if ( (*((_BYTE *)Method_CostumeListViewObject_OnClickSelect__ + 83) & 2) != 0 )
          v5 = (_QWORD *)sub_1C940B0(Method_CostumeListViewObject_OnClickSelect__);
...
void CostumeListViewObject__SetItem_31863948(
        CostumeListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
System_String_o *CostumeListViewObject__ToString(CostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D26642 & 1) == 0 )
  {
    sub_1C94098(&CostumeListViewItemDraw_DispMode_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v11 = (CostumeListViewObject_o *)sub_1C9468C(v8);
