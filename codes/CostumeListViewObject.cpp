...
void __fastcall CostumeListViewObject__Awake(CostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BEBC0 & 1) == 0 )
  {
    sub_1B4CF90(&Method_UnityEngine_GameObject_GetComponent_CostumeListViewItemDraw___, method);
    byte_49BEBC0 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2F53444 *)Method_UnityEngine_GameObject_GetComponent_CostumeListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BEBC1 & 1) == 0 )
  {
    sub_1B4CF90(&CostumeListViewItem_TypeInfo, method);
    byte_49BEBC1 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BEBC3 & 1) == 0 )
  {
    sub_1B4CF90(&CostumeListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_49BEBC3 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CostumeListViewObject__Init_45997220(
        CostumeListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CostumeListViewObject__Init_45997816(
        CostumeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CostumeListViewObject__Init_45999804(
        CostumeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
void __fastcall CostumeListViewObject__OnClickSelect(CostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B4CF90(&CostumeListViewItem_TypeInfo, method);
    sub_1B4CF90(&Method_CostumeListViewObject_OnClickSelect__, v3);
    this = (CostumeListViewObject_o *)sub_1B4CF90(&StringLiteral_9664/*"OnClickSelectListView"*/, v4);
    byte_49BEBC6 = 1;
  }
      ...
      && (CostumeListViewItem_c *)linkItem->klass->_2.typeHierarchy[methodPtr_low - 1] == CostumeListViewItem_TypeInfo )
    {
      if ( HIBYTE(linkItem[1].fields.index) || LOBYTE(linkItem[1].fields.sortIndex) )
      {
        ...
        if ( (*((_BYTE *)Method_CostumeListViewObject_OnClickSelect__ + 83) & 2) != 0 )
          v7 = (_QWORD *)sub_1B4CFA8(Method_CostumeListViewObject_OnClickSelect__);
...
void __fastcall CostumeListViewObject__SetInput(CostumeListViewObject_o *this, bool isInput, const MethodInfo *method)
{
  ...
  if ( (byte_49BEBC2 & 1) == 0 )
  {
    sub_1B4CF90(&CostumeListViewItem_TypeInfo, isInput);
...
void __fastcall CostumeListViewObject__SetItem_45998892(
        CostumeListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
System_String_o *__fastcall CostumeListViewObject__ToString(CostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BEBC5 & 1) == 0 )
  {
    sub_1B4CF90(&CostumeListViewItemDraw_DispMode_TypeInfo, method);
