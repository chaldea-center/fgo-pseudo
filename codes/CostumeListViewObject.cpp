...
void __fastcall CostumeListViewObject__Awake(CostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B1F22 & 1) == 0 )
  {
    sub_B52984(&Method_UnityEngine_GameObject_GetComponent_CostumeListViewItemDraw___);
    byte_42B1F22 = 1;
  }
  ...
  Component_srcLineSprite = (struct CostumeListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                                  dispObject,
                                                                  (const MethodInfo_1B7B1B8 *)Method_UnityEngine_GameObject_GetComponent_CostumeListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( v13 <= 3 )
  {
    v30 = dword_32788A0[v13];
    this->fields.state = dword_327C138[v13];
...
void __fastcall CostumeListViewObject__Init_28623952(
        CostumeListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CostumeListViewObject__Init_28624576(
        CostumeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CostumeListViewObject__Init_28626640(
        CostumeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
void __fastcall CostumeListViewObject__OnClickSelect(CostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B1F28 & 1) == 0 )
  {
    ...
    this = (CostumeListViewObject_o *)sub_B52984(&StringLiteral_10034/*"OnClickSelectListView"*/);
    byte_42B1F28 = 1;
  }
  ...
  if ( linkItem )
  {
    v4 = *(&CostumeListViewItem_TypeInfo->_2.bitflags2 + 1);
    if ( *(&linkItem->klass->_2.bitflags2 + 1) >= (unsigned int)v4
      && (CostumeListViewItem_c *)linkItem->klass->_2.typeHierarchy[v4 - 1] == CostumeListViewItem_TypeInfo )
    {
...
void __fastcall CostumeListViewObject__SetInput(CostumeListViewObject_o *this, bool isInput, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(itemDraw, 0LL, 0LL) )
  {
    ...
    {
      if ( (CostumeListViewItem_c *)linkItem->klass->_2.typeHierarchy[v8 - 1] == CostumeListViewItem_TypeInfo )
...
void __fastcall CostumeListViewObject__SetItem_28625680(
        CostumeListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
System_String_o *__fastcall CostumeListViewObject__ToString(CostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B1F27 & 1) == 0 )
  {
    sub_B52984(&CostumeListViewItemDraw_DispMode_TypeInfo);
    sub_B52984(&StringLiteral_81/*" "*/);
    byte_42B1F27 = 1;
  }
  v13 = 0.0;
  v12 = 0LL;
  v3 = j_il2cpp_value_box_0(CostumeListViewItemDraw_DispMode_TypeInfo, &this->fields.dispMode);
  if ( !v3 )
    sub_B52A5C(0LL, v4);
  v5 = v3;
        ...
        const MethodInfo *method)
{
  ...
  v11 = (CostumeListViewObject_o *)sub_B52D50(v8);
