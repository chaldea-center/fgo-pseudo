...
void __fastcall CostumeListViewObject__Awake(CostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42EA7C7 & 1) == 0 )
  {
    sub_B5D5C4(&Method_UnityEngine_GameObject_GetComponent_CostumeListViewItemDraw___, (_DWORD)method, v2, v3);
    byte_42EA7C7 = 1;
  }
  ...
  Component_srcLineSprite = (struct CostumeListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                                  dispObject,
                                                                  (const MethodInfo_1CC439C *)Method_UnityEngine_GameObject_GetComponent_CostumeListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EA7C8 & 1) == 0 )
  {
    sub_B5D5C4(&CostumeListViewItem_TypeInfo, (_DWORD)method, v2, v3);
    byte_42EA7C8 = 1;
  }
  ...
  if ( *(&linkItem->klass->_2.bitflags2 + 1) < (unsigned int)v6 )
    return 0LL;
  if ( (CostumeListViewItem_c *)linkItem->klass->_2.typeHierarchy[v6 - 1] == CostumeListViewItem_TypeInfo )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EA7CA & 1) == 0 )
  {
    sub_B5D5C4(&CostumeListViewItem_TypeInfo, initMode, (_DWORD)callbackFunc, method);
    byte_42EA7CA = 1;
  }
  linkItem = this->fields.linkItem;
...
void __fastcall CostumeListViewObject__Init_28770648(
        CostumeListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CostumeListViewObject__Init_28771272(
        CostumeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CostumeListViewObject__Init_28773336(
        CostumeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
void __fastcall CostumeListViewObject__OnClickSelect(CostumeListViewObject_o *this, const MethodInfo *method)
{
  int v2; // w2
  __int64 v3; // x3
  CostumeListViewObject_o *v4; // x19
  int v5; // w1
  int v6; // w2
  __int64 v7; // x3
  int v8; // w1
  ...
  if ( (byte_42EA7CD & 1) == 0 )
  {
    ...
    this = (CostumeListViewObject_o *)sub_B5D5C4(&StringLiteral_10076/*"OnClickSelectListView"*/, v8, v9, v10);
    byte_42EA7CD = 1;
  }
  ...
  if ( linkItem )
  {
    ...
    if ( *(&linkItem->klass->_2.bitflags2 + 1) >= (unsigned int)v12
      && (CostumeListViewItem_c *)linkItem->klass->_2.typeHierarchy[v12 - 1] == CostumeListViewItem_TypeInfo )
    {
      ...
      this = (CostumeListViewObject_o *)v4->fields.manager;
      if ( this )
      {
...
void __fastcall CostumeListViewObject__SetInput(CostumeListViewObject_o *this, bool isInput, const MethodInfo *method)
{
  ...
  CostumeListViewItemDraw_o *v14; // x0

  if ( (byte_42EA7C9 & 1) == 0 )
  {
    sub_B5D5C4(&CostumeListViewItem_TypeInfo, isInput, (_DWORD)method, v3);
  ...
  if ( UnityEngine_Object__op_Inequality(itemDraw, 0LL, 0LL) )
  {
    ...
    if ( !v14 )
      sub_B5D69C(0LL, v13);
    CostumeListViewItemDraw__SetInput(v14, (CostumeListViewItem_o *)v13, v10);
  }
}
...
void __fastcall CostumeListViewObject__SetItem_28772376(
        CostumeListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall CostumeListViewObject__SetupDisp(CostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( linkItem )
  {
    ...
    if ( *(&linkItem->klass->_2.bitflags2 + 1) >= (unsigned int)v9
      && (CostumeListViewItem_c *)linkItem->klass->_2.typeHierarchy[v9 - 1] == CostumeListViewItem_TypeInfo )
    {
...
LABEL_8:
  ...
  if ( UnityEngine_Object__op_Inequality(itemDraw, 0LL, 0LL) )
  {
    ...
    if ( !v14 )
      sub_B5D69C(0LL, v12);
    CostumeListViewItemDraw__SetItem(v14, (CostumeListViewItem_o *)linkItem, this->fields.dispMode, v13);
  }
}
...
System_String_o *__fastcall CostumeListViewObject__ToString(CostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42EA7CC & 1) == 0 )
  {
    sub_B5D5C4(&CostumeListViewItemDraw_DispMode_TypeInfo, (_DWORD)method, v2, v3);
    sub_B5D5C4(&StringLiteral_81/*" "*/, v5, v6, v7);
    byte_42EA7CC = 1;
  }
  v18 = 0.0;
  v17 = 0LL;
  v8 = j_il2cpp_value_box_0(CostumeListViewItemDraw_DispMode_TypeInfo, &this->fields.dispMode);
  if ( !v8 )
    sub_B5D69C(0LL, v9);
  v10 = v8;
        ...
        const MethodInfo *method)
{
  ...
  __int64 v10; // x0
  bool v11; // zf
  CostumeListViewObject_o *v12; // x0
  ...
  v12 = (CostumeListViewObject_o *)sub_B5D990(v9);
  CostumeListViewObject__remove_callbackFunc(v12, v13, v14);
}
        ...
        const MethodInfo *method)
{
  ...
  v12 = (CostumeListViewObject_o *)sub_B5D990(v9);
  CostumeListViewObject__Awake(v12, v13);
}