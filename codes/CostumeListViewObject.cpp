...
void __fastcall CostumeListViewObject__Awake(CostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B19D62 & 1) == 0 )
  {
    sub_1BCA7E0(&Method_UnityEngine_GameObject_GetComponent_CostumeListViewItemDraw___, method, v2);
    byte_4B19D62 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2F626D0 *)Method_UnityEngine_GameObject_GetComponent_CostumeListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B19D63 & 1) == 0 )
  {
    sub_1BCA7E0(&CostumeListViewItem_TypeInfo, method, v2);
    byte_4B19D63 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B19D65 & 1) == 0 )
  {
    sub_1BCA7E0(&CostumeListViewItem_TypeInfo, *(_QWORD *)&initMode, callbackFunc);
    byte_4B19D65 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CostumeListViewObject__Init_45996436(
        CostumeListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CostumeListViewObject__Init_45997032(
        CostumeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CostumeListViewObject__Init_45999016(
        CostumeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
{
  __int64 v2; // x2
  CostumeListViewObject_o *v3; // x19
  __int64 v4; // x1
  __int64 v5; // x2
  __int64 v6; // x1
  __int64 v7; // x2
  ...
  {
    sub_1BCA7E0(&CostumeListViewItem_TypeInfo, method, v2);
    sub_1BCA7E0(&Method_CostumeListViewObject_OnClickSelect__, v4, v5);
    this = (CostumeListViewObject_o *)sub_1BCA7E0(&StringLiteral_9997/*"OnClickSelectListView"*/, v6, v7);
    byte_4B19D68 = 1;
  }
...
void __fastcall CostumeListViewObject__SetInput(CostumeListViewObject_o *this, bool isInput, const MethodInfo *method)
{
  ...
  CostumeListViewItemDraw_o *v13; // x0

  if ( (byte_4B19D64 & 1) == 0 )
  {
    sub_1BCA7E0(&CostumeListViewItem_TypeInfo, isInput, method);
  ...
  if ( UnityEngine_Object__op_Inequality(itemDraw, 0LL, 0LL) )
  {
    ...
    if ( !v13 )
      sub_1BCAA3C(0LL, v12);
    CostumeListViewItemDraw__SetInput(v13, (CostumeListViewItem_o *)v12, v9);
  }
}
...
void __fastcall CostumeListViewObject__SetItem_45998104(
        CostumeListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
LABEL_8:
  ...
  if ( UnityEngine_Object__op_Inequality(itemDraw, 0LL, 0LL) )
  {
    ...
    if ( !v13 )
      sub_1BCAA3C(0LL, v11);
    CostumeListViewItemDraw__SetItem(v13, (CostumeListViewItem_o *)linkItem, this->fields.dispMode, v12);
  }
}
...
System_String_o *__fastcall CostumeListViewObject__ToString(CostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B19D67 & 1) == 0 )
  {
    sub_1BCA7E0(&CostumeListViewItemDraw_DispMode_TypeInfo, method, v2);
    sub_1BCA7E0(&StringLiteral_116/*" "*/, v4, v5);
    byte_4B19D67 = 1;
  }
  v14 = 0.0;
  v13 = 0LL;
  v11.klass = (System_Enum_c *)CostumeListViewItemDraw_DispMode_TypeInfo;
