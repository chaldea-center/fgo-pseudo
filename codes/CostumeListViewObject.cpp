...
void CostumeListViewObject__Awake(CostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CF28D8 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_UnityEngine_GameObject_GetComponent_CostumeListViewItemDraw___);
    byte_4CF28D8 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_31C70C8 *)Method_UnityEngine_GameObject_GetComponent_CostumeListViewItemDraw___);
...
CostumeListViewItem_o *CostumeListViewObject__GetItem(CostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CF28D9 & 1) == 0 )
  {
    sub_1C7BAE8(&CostumeListViewItem_TypeInfo);
    byte_4CF28D9 = 1;
  }
...
void CostumeListViewObject__Init_49405916(CostumeListViewObject_o *this, int32_t initMode, const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void CostumeListViewObject__Init_49406512(
        CostumeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void CostumeListViewObject__Init_49408500(
        CostumeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
void CostumeListViewObject__OnClickSelect(CostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C7BAE8(&CostumeListViewItem_TypeInfo);
    sub_1C7BAE8(&Method_CostumeListViewObject_OnClickSelect__);
    this = (CostumeListViewObject_o *)sub_1C7BAE8(&StringLiteral_9893/*"OnClickSelectListView"*/);
    byte_4CF28DE = 1;
  }
      ...
      && (CostumeListViewItem_c *)linkItem->klass->_2.typeHierarchy[naturalAligment - 1] == CostumeListViewItem_TypeInfo )
    {
      if ( HIBYTE(linkItem[1].fields.index) || LOBYTE(linkItem[1].fields.sortIndex) )
      {
        ...
        if ( (*((_BYTE *)Method_CostumeListViewObject_OnClickSelect__ + 83) & 2) != 0 )
          v5 = (_QWORD *)sub_1C7BB00(Method_CostumeListViewObject_OnClickSelect__);
...
void CostumeListViewObject__SetItem_49407588(
        CostumeListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
System_String_o *CostumeListViewObject__ToString(CostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CF28DD & 1) == 0 )
  {
    sub_1C7BAE8(&CostumeListViewItemDraw_DispMode_TypeInfo);
