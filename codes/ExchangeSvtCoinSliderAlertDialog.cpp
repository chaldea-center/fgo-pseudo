...
void ExchangeSvtCoinSliderAlertDialog__Close(ExchangeSvtCoinSliderAlertDialog_o *this, const MethodInfo *method)
{
  ...
  ExchangeSvtCoinSliderAlertDialog__Close_33586288(this, 0, v2);
}


void ExchangeSvtCoinSliderAlertDialog__Close_33586288(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2B768 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_ExchangeSvtCoinSliderAlertDialog_EndClose__);
    byte_4D2B768 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2B76A & 1) == 0 )
  {
    sub_1C93AD4(&Method_ExchangeSvtCoinSliderAlertDialog_OnClickCancel__);
    byte_4D2B76A = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_ExchangeSvtCoinSliderAlertDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C93AEC(Method_ExchangeSvtCoinSliderAlertDialog_OnClickCancel__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C93AB8(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0, 0);
    ExchangeSvtCoinSliderAlertDialog__Close_33586288(this, 0, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2B769 & 1) == 0 )
  {
    sub_1C93AD4(&Method_ExchangeSvtCoinSliderAlertDialog_OnClickDecide__);
    byte_4D2B769 = 1;
  }
  if ( this->fields.state == 1 && this->fields.onDecide )
  {
    ...
    if ( (*((_BYTE *)Method_ExchangeSvtCoinSliderAlertDialog_OnClickDecide__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1C93AEC(Method_ExchangeSvtCoinSliderAlertDialog_OnClickDecide__);
    ...
    ExchangeSvtCoinSliderAlertDialog__Close_33586288(this, 0, v7);
    onDecide = this->fields.onDecide;
    this->fields.onDecide = 0;
    sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.onDecide, 0, v9, v10, v11, v12, v13, v14);
    if ( !onDecide )
LABEL_13:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2B766 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_ExchangeSvtCoinSliderAlertDialog_OnSliderDragFinished__);
    sub_1C93AD4(&int_TypeInfo);
    sub_1C93AD4(&LocalizationManager_TypeInfo);
    sub_1C93AD4(&NetworkManager_TypeInfo);
    sub_1C93AD4(&UIProgressBar_OnDragFinished_TypeInfo);
    sub_1C93AD4(&StringLiteral_5805/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_DETAIL_1"*/);
    sub_1C93AD4(&StringLiteral_5809/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_TITLE"*/);
    sub_1C93AD4(&StringLiteral_5804/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_DECIDE_BUTTON"*/);
    sub_1C93AD4(&StringLiteral_5808/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_NEED_COUNT_TEXT"*/);
    sub_1C93AD4(&StringLiteral_5802/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_BUY_COUNT_NAME"*/);
    sub_1C93AD4(&StringLiteral_5803/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_BUY_COUNT_TEXT"*/);
    sub_1C93AD4(&StringLiteral_3706/*"COMMON_CONFIRM_CANCEL"*/);
    sub_1C93AD4(&StringLiteral_5806/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_DETAIL_2"*/);
    sub_1C93AD4(&StringLiteral_5807/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_NEED_COUNT_NAME"*/);
    byte_4D2B766 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    checkSlider = LocalizationManager__Get((System_String_o *)StringLiteral_5809/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_TITLE"*/, 0);
    if ( !titleLabel )
      goto LABEL_31;
    UILabel__set_text(titleLabel, checkSlider, 0);
    decideButtonLabel = this->fields.decideButtonLabel;
    checkSlider = LocalizationManager__Get((System_String_o *)StringLiteral_5804/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_DECIDE_BUTTON"*/, 0);
    if ( !decideButtonLabel )
      goto LABEL_31;
    UILabel__set_text(decideButtonLabel, checkSlider, 0);
    cancelButtonLabel = this->fields.cancelButtonLabel;
    checkSlider = LocalizationManager__Get((System_String_o *)StringLiteral_3706/*"COMMON_CONFIRM_CANCEL"*/, 0);
    if ( !cancelButtonLabel )
      goto LABEL_31;
    UILabel__set_text(cancelButtonLabel, checkSlider, 0);
    detailLabel_1 = this->fields.detailLabel_1;
    checkSlider = LocalizationManager__Get((System_String_o *)StringLiteral_5805/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_DETAIL_1"*/, 0);
    if ( !detailLabel_1 )
      goto LABEL_31;
    UILabel__set_text(detailLabel_1, checkSlider, 0);
    detailLabel_2 = this->fields.detailLabel_2;
    checkSlider = LocalizationManager__Get((System_String_o *)StringLiteral_5806/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_DETAIL_2"*/, 0);
    if ( !detailLabel_2 )
      goto LABEL_31;
    UILabel__set_text(detailLabel_2, checkSlider, 0);
    needCountNameLabel = this->fields.needCountNameLabel;
    checkSlider = LocalizationManager__Get((System_String_o *)StringLiteral_5807/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_NEED_COUNT_NAME"*/, 0);
    if ( !needCountNameLabel )
      goto LABEL_31;
    UILabel__set_text(needCountNameLabel, checkSlider, 0);
    v28 = LocalizationManager__Get((System_String_o *)StringLiteral_5808/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_NEED_COUNT_TEXT"*/, 0);
    ...
    checkSlider = LocalizationManager__Get((System_String_o *)StringLiteral_5802/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_BUY_COUNT_NAME"*/, 0);
    if ( !buyCountNameLabel )
      goto LABEL_31;
    UILabel__set_text(buyCountNameLabel, checkSlider, 0);
    v33 = LocalizationManager__Get((System_String_o *)StringLiteral_5803/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_BUY_COUNT_TEXT"*/, 0);
    ...
    v37 = (UIProgressBar_OnDragFinished_o *)sub_1C93D20(UIProgressBar_OnDragFinished_TypeInfo);
    ...
    sub_1C93A78((GrandQuestFolderBoardItem_o *)&v36->fields.onDragFinished, (int32_t)v37, v38, v39, v40, v41, v42, v43);
