...
void ExchangeSvtCoinSliderAlertDialog__Close(ExchangeSvtCoinSliderAlertDialog_o *this, const MethodInfo *method)
{
  ...
  ExchangeSvtCoinSliderAlertDialog__Close_39781004(this, 0, v2);
}


void ExchangeSvtCoinSliderAlertDialog__Close_39781004(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596B486 & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_ExchangeSvtCoinSliderAlertDialog_EndClose__);
    byte_596B486 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596B488 & 1) == 0 )
  {
    sub_2213A60(&Method_ExchangeSvtCoinSliderAlertDialog_OnClickCancel__);
    byte_596B488 = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_ExchangeSvtCoinSliderAlertDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_2213A78(Method_ExchangeSvtCoinSliderAlertDialog_OnClickCancel__);
    v4 = (System_Reflection_MethodBase_o *)sub_2213A44(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0, 0);
    ExchangeSvtCoinSliderAlertDialog__Close_39781004(this, 0, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596B487 & 1) == 0 )
  {
    sub_2213A60(&Method_ExchangeSvtCoinSliderAlertDialog_OnClickDecide__);
    byte_596B487 = 1;
  }
    ...
    if ( checkSlider )
    {
      ...
      if ( value < 1.0 )
      {
        if ( (*((_BYTE *)Method_ExchangeSvtCoinSliderAlertDialog_OnClickDecide__ + 83) & 2) != 0 )
          v5 = (_QWORD *)sub_2213A78(Method_ExchangeSvtCoinSliderAlertDialog_OnClickDecide__);
      ...
      ExchangeSvtCoinSliderAlertDialog__Close_39781004(this, 0, v8);
      onDecide = this->fields.onDecide;
      this->fields.onDecide = 0;
      sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields.onDecide, 0, v10, v11, v12, v13, v14, v15);
      if ( onDecide )
      {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596B484 & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_ExchangeSvtCoinSliderAlertDialog_OnSliderDragFinished__);
    sub_2213A60(&LocalizationManager_TypeInfo);
    sub_2213A60(&NetworkManager_TypeInfo);
    sub_2213A60(&UIProgressBar_OnDragFinished_TypeInfo);
    sub_2213A60(&StringLiteral_6010/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_DETAIL_1"*/);
    sub_2213A60(&StringLiteral_6014/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_TITLE"*/);
    sub_2213A60(&StringLiteral_6009/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_DECIDE_BUTTON"*/);
    sub_2213A60(&StringLiteral_6013/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_NEED_COUNT_TEXT"*/);
    sub_2213A60(&StringLiteral_6007/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_BUY_COUNT_NAME"*/);
    sub_2213A60(&StringLiteral_6008/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_BUY_COUNT_TEXT"*/);
    sub_2213A60(&StringLiteral_3827/*"COMMON_CONFIRM_CANCEL"*/);
    sub_2213A60(&StringLiteral_6011/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_DETAIL_2"*/);
    sub_2213A60(&StringLiteral_6012/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_NEED_COUNT_NAME"*/);
    byte_596B484 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    checkSlider = LocalizationManager__Get((System_String_o *)StringLiteral_6014/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_TITLE"*/, 0);
    if ( !titleLabel )
      goto LABEL_31;
    UILabel__set_text(titleLabel, checkSlider, 0);
    decideButtonLabel = this->fields.decideButtonLabel;
    checkSlider = LocalizationManager__Get((System_String_o *)StringLiteral_6009/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_DECIDE_BUTTON"*/, 0);
    if ( !decideButtonLabel )
      goto LABEL_31;
    UILabel__set_text(decideButtonLabel, checkSlider, 0);
    cancelButtonLabel = this->fields.cancelButtonLabel;
    checkSlider = LocalizationManager__Get((System_String_o *)StringLiteral_3827/*"COMMON_CONFIRM_CANCEL"*/, 0);
    if ( !cancelButtonLabel )
      goto LABEL_31;
    UILabel__set_text(cancelButtonLabel, checkSlider, 0);
    detailLabel_1 = this->fields.detailLabel_1;
    checkSlider = LocalizationManager__Get((System_String_o *)StringLiteral_6010/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_DETAIL_1"*/, 0);
    if ( !detailLabel_1 )
      goto LABEL_31;
    UILabel__set_text(detailLabel_1, checkSlider, 0);
    detailLabel_2 = this->fields.detailLabel_2;
    checkSlider = LocalizationManager__Get((System_String_o *)StringLiteral_6011/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_DETAIL_2"*/, 0);
    if ( !detailLabel_2 )
      goto LABEL_31;
    UILabel__set_text(detailLabel_2, checkSlider, 0);
    needCountNameLabel = this->fields.needCountNameLabel;
    checkSlider = LocalizationManager__Get((System_String_o *)StringLiteral_6012/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_NEED_COUNT_NAME"*/, 0);
    if ( !needCountNameLabel )
      goto LABEL_31;
    UILabel__set_text(needCountNameLabel, checkSlider, 0);
    v30 = LocalizationManager__Get((System_String_o *)StringLiteral_6013/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_NEED_COUNT_TEXT"*/, 0);
    needCountLabel = this->fields.needCountLabel;
    v55 = needCount;
    v32 = (Il2CppObject *)j_il2cpp_value_box_0(qword_5984348, &v55);
    ...
    checkSlider = LocalizationManager__Get((System_String_o *)StringLiteral_6007/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_BUY_COUNT_NAME"*/, 0);
    if ( !buyCountNameLabel )
      goto LABEL_31;
    UILabel__set_text(buyCountNameLabel, checkSlider, 0);
    v34 = LocalizationManager__Get((System_String_o *)StringLiteral_6008/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_BUY_COUNT_TEXT"*/, 0);
    buyCountLabel = this->fields.buyCountLabel;
    v54 = buyCount;
    v36 = (Il2CppObject *)j_il2cpp_value_box_0(qword_5984348, &v54);
    ...
    v38 = (UIProgressBar_OnDragFinished_o *)sub_2213CCC(UIProgressBar_OnDragFinished_TypeInfo);
