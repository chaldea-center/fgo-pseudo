        ...
        const MethodInfo *method)
{
  ...
  if ( this->fields.isBonusFilterDefaultActive )
  {
    ...
    if ( !bonusFilterKindButton
      ...
      || !bonusFilterKindButton )
    {
      sub_1B68930(bonusFilterKindButton, sort);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0807D & 1) == 0 )
  {
    sub_1B686D4(&StringLiteral_17446/*"btn_filter_on"*/, sort);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0807E & 1) == 0 )
  {
    sub_1B686D4(&StringLiteral_17476/*"btn_sort_up"*/, sort);
    sub_1B686D4(&StringLiteral_17563/*"btn_txt_up"*/, v7);
    sub_1B686D4(&StringLiteral_17519/*"btn_txt_new"*/, v8);
    sub_1B686D4(&StringLiteral_17509/*"btn_txt_down"*/, v9);
    sub_1B686D4(&StringLiteral_17526/*"btn_txt_old"*/, v10);
    sub_1B686D4(&StringLiteral_17473/*"btn_sort_down"*/, v11);
    byte_4A0807E = 1;
  }
  ...
  if ( CharaGraphSortButtonGroup__IsActive((UnityEngine_Component_o *)this->fields.sortOrderSprite, v13) )
  {
    ...
    if ( ((unsigned __int8)IsActive & 1) != 0 )
    {
      ...
      if ( sortKind == 11 || sortKind == 1 )
      {
        ...
        if ( !IsActive )
          goto LABEL_34;
        v16 = (System_String_o **)(sort->fields.isAscendingOrder ? &StringLiteral_17526/*"btn_txt_old"*/ : &StringLiteral_17519/*"btn_txt_new"*/);
      ...
      else
      {
        ...
        if ( !IsActive )
          goto LABEL_34;
        v20 = (System_String_o **)(sort->fields.isAscendingOrder ? &StringLiteral_17563/*"btn_txt_up"*/ : &StringLiteral_17509/*"btn_txt_down"*/);
