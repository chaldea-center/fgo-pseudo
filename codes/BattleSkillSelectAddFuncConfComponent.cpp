        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3B0DA & 1) == 0 )
  {
    sub_1C32C20(&Method_BattleSkillSelectAddFuncConfComponent_ClickSelected__);
    byte_4C3B0DA = 1;
  }
  if ( BattleSkillSelectAddFuncConfComponent__IsEnableBtn(this, index, method) )
  {
    if ( !this->fields.isPlayedSe )
    {
      ...
      if ( (*((_BYTE *)Method_BattleSkillSelectAddFuncConfComponent_ClickSelected__ + 83) & 2) != 0 )
        v6 = (_QWORD *)sub_1C32C38(Method_BattleSkillSelectAddFuncConfComponent_ClickSelected__);
  ...
  else
  {
    ...
    if ( (*((_BYTE *)Method_BattleSkillSelectAddFuncConfComponent_ClickSelected__ + 83) & 2) != 0 )
      v8 = (_QWORD *)sub_1C32C38(Method_BattleSkillSelectAddFuncConfComponent_ClickSelected__);
        ...
        const MethodInfo *method)
{
  ...
  if ( !labelDescription
    || (labelDescription = (UnityEngine_Component_o *)UnityEngine_Component__GetComponent_object_(
                                                        labelDescription,
                                                        (const MethodInfo_30D3BC0 *)Method_UnityEngine_Component_GetComponent_BoxCollider___)) == 0 )
  {
    sub_1C32E7C(labelDescription);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3B0DC & 1) == 0 )
  {
    sub_1C32C20(&BattleSkillSelectAddFuncConfComponent__CoroutineOnSelected_d__33_TypeInfo);
    byte_4C3B0DC = 1;
  }
  v5 = sub_1C32E6C(BattleSkillSelectAddFuncConfComponent__CoroutineOnSelected_d__33_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    v8 = LocalizationManager__Get((System_String_o *)StringLiteral_8260/*"LEVEL_DETAIL_INFO"*/, 0);
    v19 = skillLv;
        ...
        const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields._Data_k__BackingField, (int32_t)data, (int32_t)method, v3);
...
LABEL_17:
      ...
      sub_1C32BC4((CGThumbnailListItem_o *)&v7->fields.currentBtnLayout, (int32_t)v10, btnLayoutType, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3B0D6 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_DataManager_GetMaster_SkillLvMaster___);
    sub_1C32C20(&DataManager_TypeInfo);
    sub_1C32C20(&Method_System_Enum_TryParse_BattleSkillSelectAddFuncConfComponent_BtnLayoutType___);
    sub_1C32C20(&System_Enum_TypeInfo);
    sub_1C32C20(&StringLiteral_17427/*"btnLayoutType"*/);
    sub_1C32C20(&StringLiteral_17426/*"btn"*/);
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (System_String_o *)DataManager__GetMaster_object_((const MethodInfo_30DD39C *)Method_DataManager_GetMaster_SkillLvMaster___);
  if ( !skillInfo )
    goto LABEL_14;
  ...
  *(_WORD *)&this->fields.isPlayedSe = 0;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields._SkillInfo_k__BackingField, (int32_t)skillInfo, v7, v8);
  labelTitle = this->fields.labelTitle;
  Master_object = (System_String_o *)BasicHelper__GetValue_object_(
                                       SelectAddFuncInfo,
                                       (System_String_o *)StringLiteral_24094/*"title"*/,
...
LABEL_14:
  ...
  Value_object = BasicHelper__GetValue_object_(
                   SelectAddFuncInfo,
                   (System_String_o *)StringLiteral_18597/*"detail"*/,
                   (Il2CppObject *)StringLiteral_1/*""*/,
                   (const MethodInfo_30CAD64 *)Method_BasicHelper_GetValue_string___);
  ...
  v17 = BasicHelper__GetValue_object_(
          SelectAddFuncInfo,
          (System_String_o *)StringLiteral_17427/*"btnLayoutType"*/,
          (Il2CppObject *)StringLiteral_1/*""*/,
          (const MethodInfo_30CAD64 *)Method_BasicHelper_GetValue_string___);
  ...
  System_Enum__TryParse_Int32Enum_(
    (System_String_o *)v17,
    &result,
    (const MethodInfo_30E3F34 *)Method_System_Enum_TryParse_BattleSkillSelectAddFuncConfComponent_BtnLayoutType___);
  v18 = BasicHelper__GetValue_object_(
          SelectAddFuncInfo,
          (System_String_o *)StringLiteral_17426/*"btn"*/,
          0,
        ...
        const MethodInfo *method)
{
  if ( (byte_4C3B0DE & 1) == 0 )
  {
    sub_1C32C20(&StringLiteral_17470/*"btn_close"*/);
    byte_4C3B0DE = 1;
  }
  return (System_String_o *)StringLiteral_17470/*"btn_close"*/;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3B0DB & 1) == 0 )
  {
    sub_1C32C20(&Method_BattleSkillSelectAddFuncConfComponent_onClickCancel__);
    byte_4C3B0DB = 1;
  }
  if ( !this->fields.isPlayedSe )
  {
    ...
    if ( (*((_BYTE *)Method_BattleSkillSelectAddFuncConfComponent_onClickCancel__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1C32C38(Method_BattleSkillSelectAddFuncConfComponent_onClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields._SkillInfo_k__BackingField, (int32_t)value, (int32_t)method, v3);
}
...
LABEL_17:
  this->fields.extra_arg = (intptr_t)sub_1A7AFD4;
}
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C32C34(&Method_BattleSkillSelectAddFuncConfComponent__CoroutineOnSelected_d__33_System_Collections_IEnumerator_Reset__);
  sub_1C32D48(v3, v4);
}
