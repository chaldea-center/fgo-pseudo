        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF1E59 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_BattleSkillSelectAddFuncConfComponent_ClickSelected__);
    byte_4CF1E59 = 1;
  }
  if ( BattleSkillSelectAddFuncConfComponent__IsEnableBtn(this, index, method) )
  {
    if ( !this->fields.isPlayedSe )
    {
      ...
      if ( (*((_BYTE *)Method_BattleSkillSelectAddFuncConfComponent_ClickSelected__ + 83) & 2) != 0 )
        v6 = (_QWORD *)sub_1C7BB00(Method_BattleSkillSelectAddFuncConfComponent_ClickSelected__);
  ...
  else
  {
    ...
    if ( (*((_BYTE *)Method_BattleSkillSelectAddFuncConfComponent_ClickSelected__ + 83) & 2) != 0 )
      v8 = (_QWORD *)sub_1C7BB00(Method_BattleSkillSelectAddFuncConfComponent_ClickSelected__);
        ...
        const MethodInfo *method)
{
  ...
  if ( !labelDescription
    || (labelDescription = (UnityEngine_Component_o *)UnityEngine_Component__GetComponent_object_(
                                                        labelDescription,
                                                        (const MethodInfo_3166BC4 *)Method_UnityEngine_Component_GetComponent_BoxCollider___)) == 0 )
  {
    sub_1C7BD40(labelDescription, v3);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF1E5B & 1) == 0 )
  {
    sub_1C7BAE8(&BattleSkillSelectAddFuncConfComponent__CoroutineOnSelected_d__33_TypeInfo);
    byte_4CF1E5B = 1;
  }
  v5 = sub_1C7BD34(BattleSkillSelectAddFuncConfComponent__CoroutineOnSelected_d__33_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    v8 = LocalizationManager__Get((System_String_o *)StringLiteral_8284/*"LEVEL_DETAIL_INFO"*/, 0);
    v14 = skillLv;
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_14:
    sub_1C7BD40(gameObject, description);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF1E55 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_DataManager_GetMaster_SkillLvMaster___);
    sub_1C7BAE8(&DataManager_TypeInfo);
    sub_1C7BAE8(&Method_System_Enum_TryParse_BattleSkillSelectAddFuncConfComponent_BtnLayoutType___);
    sub_1C7BAE8(&System_Enum_TypeInfo);
    sub_1C7BAE8(&StringLiteral_17516/*"btnLayoutType"*/);
    sub_1C7BAE8(&StringLiteral_17515/*"btn"*/);
    sub_1C7BAE8(&StringLiteral_18706/*"detail"*/);
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (System_String_o *)DataManager__GetMaster_object_((const MethodInfo_31703A0 *)Method_DataManager_GetMaster_SkillLvMaster___);
  if ( !skillInfo )
    goto LABEL_14;
  ...
  *(_WORD *)&this->fields.isPlayedSe = 0;
  ...
  Master_object = (System_String_o *)BasicHelper__GetValue_object_(
                                       SelectAddFuncInfo,
                                       (System_String_o *)StringLiteral_24335/*"title"*/,
...
LABEL_14:
  ...
  v22 = BasicHelper__GetValue_object_(
          SelectAddFuncInfo,
          (System_String_o *)StringLiteral_17516/*"btnLayoutType"*/,
          (Il2CppObject *)StringLiteral_1/*""*/,
          (const MethodInfo_315DCFC *)Method_BasicHelper_GetValue_string___);
  ...
  System_Enum__TryParse_Int32Enum_(
    (System_String_o *)v22,
    &result,
    (const MethodInfo_3176F38 *)Method_System_Enum_TryParse_BattleSkillSelectAddFuncConfComponent_BtnLayoutType___);
  v23 = BasicHelper__GetValue_object_(
          SelectAddFuncInfo,
          (System_String_o *)StringLiteral_17515/*"btn"*/,
          0,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF1E5A & 1) == 0 )
  {
    sub_1C7BAE8(&Method_BattleSkillSelectAddFuncConfComponent_onClickCancel__);
    byte_4CF1E5A = 1;
  }
  if ( !this->fields.isPlayedSe )
  {
    ...
    if ( (*((_BYTE *)Method_BattleSkillSelectAddFuncConfComponent_onClickCancel__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1C7BB00(Method_BattleSkillSelectAddFuncConfComponent_onClickCancel__);
...
LABEL_17:
  this->fields.extra_arg = (intptr_t)sub_1AB56DC;
}
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C7BAFC(&Method_BattleSkillSelectAddFuncConfComponent__CoroutineOnSelected_d__33_System_Collections_IEnumerator_Reset__);
  sub_1C7BC10(v3, v4);
}
