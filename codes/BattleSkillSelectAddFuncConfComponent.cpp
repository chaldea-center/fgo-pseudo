void __fastcall BattleSkillSelectAddFuncConfComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FF44A & 1) == 0 )
  {
    sub_1B640C8(&BattleSkillSelectAddFuncConfComponent_TypeInfo, v1);
    byte_49FF44A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF445 & 1) == 0 )
  {
    sub_1B640C8(&Method_BattleSkillSelectAddFuncConfComponent_ClickSelected__, *(_QWORD *)&index);
    byte_49FF445 = 1;
  }
  if ( BattleSkillSelectAddFuncConfComponent__IsEnableBtn(this, index, method) )
  {
    if ( !this->fields.isPlayedSe )
    {
      ...
      if ( (*((_BYTE *)Method_BattleSkillSelectAddFuncConfComponent_ClickSelected__ + 83) & 2) != 0 )
        v6 = (_QWORD *)sub_1B640E0(Method_BattleSkillSelectAddFuncConfComponent_ClickSelected__);
  ...
  else
  {
    ...
    if ( (*((_BYTE *)Method_BattleSkillSelectAddFuncConfComponent_ClickSelected__ + 83) & 2) != 0 )
      v8 = (_QWORD *)sub_1B640E0(Method_BattleSkillSelectAddFuncConfComponent_ClickSelected__);
        ...
        const MethodInfo *method)
{
  ...
  if ( !labelDescription
    || (labelDescription = (UnityEngine_Component_o *)UnityEngine_Component__GetComponent_object_(
                                                        labelDescription,
                                                        (const MethodInfo_2E2FE90 *)Method_UnityEngine_Component_GetComponent_BoxCollider___)) == 0LL )
  {
    sub_1B64324(labelDescription);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF447 & 1) == 0 )
  {
    sub_1B640C8(&BattleSkillSelectAddFuncConfComponent__CoroutineOnSelected_d__34_TypeInfo, *(_QWORD *)&index);
    byte_49FF447 = 1;
  }
  v5 = sub_1B64314(BattleSkillSelectAddFuncConfComponent__CoroutineOnSelected_d__34_TypeInfo, *(_QWORD *)&index, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF443 & 1) == 0 )
  {
    sub_1B640C8(&Method_DataManager_GetMaster_SkillLvMaster___, str);
    sub_1B640C8(&DataManager_TypeInfo, v8);
    sub_1B640C8(&int_TypeInfo, v9);
    sub_1B640C8(&LocalizationManager_TypeInfo, v10);
    sub_1B640C8(&StringLiteral_8196/*"LEVEL_DETAIL_INFO"*/, v11);
  ...
  else
  {
    ...
    v13 = LocalizationManager__Get((System_String_o *)StringLiteral_8196/*"LEVEL_DETAIL_INFO"*/, 0LL);
    v18 = skillLv;
  ...
  if ( System_String__IsNullOrEmpty(Detail, 0LL) )
  {
    ...
    Master_object = (SkillLvMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2E39398 *)Method_DataManager_GetMaster_SkillLvMaster___);
    if ( !Master_object )
      goto LABEL_19;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF442 & 1) == 0 )
  {
    sub_1B640C8(&BattleSkillSelectAddFuncConfComponent_TypeInfo, description);
    sub_1B640C8(&Method_UnityEngine_Component_GetComponent_BoxCollider___, v5);
    byte_49FF442 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  BattleSkillSelectAddFuncConfComponent_o *v23; // x0
  ...
  if ( (byte_49FF441 & 1) == 0 )
  {
    sub_1B640C8(&Method_BasicHelper_GetValue_List_object____, skillInfo);
    sub_1B640C8(&Method_BasicHelper_GetValue_string___, v5);
    sub_1B640C8(&Method_DataManager_GetMaster_SkillLvMaster___, v6);
    sub_1B640C8(&DataManager_TypeInfo, v7);
    sub_1B640C8(&Method_System_Enum_TryParse_BattleSkillSelectAddFuncConfComponent_BtnLayoutType___, v8);
    sub_1B640C8(&System_Enum_TypeInfo, v9);
    sub_1B640C8(&StringLiteral_17391/*"btnLayoutType"*/, v10);
    sub_1B640C8(&StringLiteral_17390/*"btn"*/, v11);
    sub_1B640C8(&StringLiteral_18526/*"detail"*/, v12);
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (System_String_o *)DataManager__GetMaster_object_((const MethodInfo_2E39398 *)Method_DataManager_GetMaster_SkillLvMaster___);
  if ( !skillInfo )
    goto LABEL_14;
  v16 = (SkillLvMaster_o *)Master_object;
  ...
  if ( !v16 )
    goto LABEL_14;
  SelectAddFuncInfo = SkillLvMaster__GetSelectAddFuncInfo(v16, (int32_t)Master_object, skillInfo->fields.skilllv, 0LL);
  ...
  *(_WORD *)&this->fields.isPlayedSe = 0;
  ...
  Master_object = (System_String_o *)BasicHelper__GetValue_object_(
                                       SelectAddFuncInfo,
                                       (System_String_o *)StringLiteral_23858/*"title"*/,
...
LABEL_14:
  ...
  Value_object = BasicHelper__GetValue_object_(
                   SelectAddFuncInfo,
                   (System_String_o *)StringLiteral_18526/*"detail"*/,
                   (Il2CppObject *)StringLiteral_1/*""*/,
                   (const MethodInfo_2E27808 *)Method_BasicHelper_GetValue_string___);
  v23 = (BattleSkillSelectAddFuncConfComponent_o *)((__int64 (__fastcall *)(BattleSkillInfoData_o *, Il2CppMethodPointer))skillInfo->klass->vtable._5_get_skillId.method)(
                                                     skillInfo,
                                                     skillInfo->klass->vtable._6_get_IndividualityArray.methodPtr);
  EmbedLvDescription = BattleSkillSelectAddFuncConfComponent__GetEmbedLvDescription(
                         ...
                         v24);
  BattleSkillSelectAddFuncConfComponent__InitDescription(this, EmbedLvDescription, v26);
  v27 = BasicHelper__GetValue_object_(
          SelectAddFuncInfo,
          (System_String_o *)StringLiteral_17391/*"btnLayoutType"*/,
          (Il2CppObject *)StringLiteral_1/*""*/,
          (const MethodInfo_2E27808 *)Method_BasicHelper_GetValue_string___);
  ...
  System_Enum__TryParse_Int32Enum_(
    (System_String_o *)v27,
    &result,
    (const MethodInfo_2E42464 *)Method_System_Enum_TryParse_BattleSkillSelectAddFuncConfComponent_BtnLayoutType___);
  v28 = BasicHelper__GetValue_object_(
          SelectAddFuncInfo,
          (System_String_o *)StringLiteral_17390/*"btn"*/,
          0LL,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF446 & 1) == 0 )
  {
    sub_1B640C8(&Method_BattleSkillSelectAddFuncConfComponent_onClickCancel__, method);
    byte_49FF446 = 1;
  }
  if ( !this->fields.isPlayedSe )
  {
    ...
    if ( (*((_BYTE *)Method_BattleSkillSelectAddFuncConfComponent_onClickCancel__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1B640E0(Method_BattleSkillSelectAddFuncConfComponent_onClickCancel__);
  ...
  else
  {
    if ( v8 == 1 )
    {
      if ( LOBYTE(this[1].fields.method_ptr) )
      {
        ...
        {
          if ( (v11 & 1) != 0 )
            v9 = (Il2CppObject *)sub_19AF9C8;
          else
            v9 = (Il2CppObject *)sub_19AF97C;
        }
        else if ( (v11 & 1) != 0 )
        {
          v9 = (Il2CppObject *)sub_19AF8F0;
        }
        else
        {
          v9 = (Il2CppObject *)sub_19AF8C0;
        }
      }
      else
      {
        v9 = (Il2CppObject *)sub_19AF888;
      }
      goto LABEL_16;
    }
    if ( !object )
...
LABEL_17:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19AF830;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF44B & 1) == 0 )
  {
    sub_1B640C8(&int_TypeInfo, skillInfo);
    byte_49FF44B = 1;
  }
  v11[2] = 0LL;
        ...
        const MethodInfo *method)
{
  ...
  v6 = sub_1B640DC(&Method_BattleSkillSelectAddFuncConfComponent__CoroutineOnSelected_d__34_System_Collections_IEnumerator_Reset__);
  sub_1B641F0(v5, v6);
}
