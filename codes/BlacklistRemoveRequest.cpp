...
System_String_o *__fastcall BlacklistRemoveRequest__getURL(BlacklistRemoveRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB5F6C & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_17592/*"bit_vs_gauge_part_1"*/, v2);
    byte_4BB5F6C = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62967944(BaseUrl, (System_String_o *)StringLiteral_17592/*"bit_vs_gauge_part_1"*/, 0LL);
}
