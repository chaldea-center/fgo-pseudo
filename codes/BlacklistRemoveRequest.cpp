...
System_String_o *__fastcall BlacklistRemoveRequest__getURL(BlacklistRemoveRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_41875EE & 1) == 0 )
  {
    ...
    sub_B2C35C(&StringLiteral_16859/*"blacklist/remove"*/, v2);
    byte_41875EE = 1;
  }
  ...
  return System_String__Concat_44305532(BaseUrl, (System_String_o *)StringLiteral_16859/*"blacklist/remove"*/, 0LL);
}
