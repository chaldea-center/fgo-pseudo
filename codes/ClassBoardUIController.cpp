        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C1AE30(effectListBtnSprite, value);
  }
...
void __fastcall ClassBoardUIController__Init(ClassBoardUIController_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BCB0DA & 1) == 0 )
  {
    this = (ClassBoardUIController_o *)sub_1C1ABD4(&StringLiteral_17794/*"btn_list"*/, method);
    byte_4BCB0DA = 1;
  }
  ...
  AtlasManagerUnit__SetUI(
    ...
    (System_String_o *)StringLiteral_17794/*"btn_list"*/,
    0LL);
...
void __fastcall ClassBoardUIController__OnClickBack(ClassBoardUIController_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BCB0DF & 1) == 0 )
  {
    sub_1C1ABD4(&Method_ClassBoardUIController_OnClickBack__, method);
    byte_4BCB0DF = 1;
  }
  v3 = Method_ClassBoardUIController_OnClickBack__;
  if ( (*((_BYTE *)Method_ClassBoardUIController_OnClickBack__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C1ABEC(Method_ClassBoardUIController_OnClickBack__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCB0DD & 1) == 0 )
  {
    sub_1C1ABD4(&Method_ClassBoardUIController_OnClickEffectListButton__, method);
    byte_4BCB0DD = 1;
  }
  ...
  if ( (*((_BYTE *)Method_ClassBoardUIController_OnClickEffectListButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C1ABEC(Method_ClassBoardUIController_OnClickEffectListButton__);
  v4 = (System_Reflection_MethodBase_o *)sub_1C1ABB8(v3, v3[4]);
...
void __fastcall ClassBoardUIController__OnClickHelp(ClassBoardUIController_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BCB0DE & 1) == 0 )
  {
    sub_1C1ABD4(&Method_ClassBoardUIController_OnClickHelp__, method);
    byte_4BCB0DE = 1;
  }
  v3 = Method_ClassBoardUIController_OnClickHelp__;
  if ( (*((_BYTE *)Method_ClassBoardUIController_OnClickHelp__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C1ABEC(Method_ClassBoardUIController_OnClickHelp__);
  v4 = (System_Reflection_MethodBase_o *)sub_1C1ABB8(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCB0E1 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_3551/*"CLASS_BOARD_MISSION_CLEAR_MESSAGE"*/, v6);
    byte_4BCB0E1 = 1;
  }
  ...
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_3551/*"CLASS_BOARD_MISSION_CLEAR_MESSAGE"*/, 0LL);
  if ( !Instance )
    sub_1C1AE30(v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( v6 )
  {
    ...
    if ( !byte_4BCB0FE )
    {
      v7 = sub_1C1ABD4(&ClassBoardPageSwitcher_TypeInfo, v8);
      byte_4BCB0FE = 1;
    }
    if ( !v9 )
      sub_1C1AE30(v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCB0DB & 1) == 0 )
  {
    this = (ClassBoardUIController_o *)sub_1C1ABD4(&StringLiteral_20641/*"img_commonbg_11"*/, atlasManagerUnit);
    byte_4BCB0DB = 1;
  }
  if ( !atlasManagerUnit
    || (AtlasManagerUnit__SetUI(
          ...
          (System_String_o *)StringLiteral_20641/*"img_commonbg_11"*/,
          0LL),
        (this = (ClassBoardUIController_o *)v6->fields.headerMessageLabel) == 0LL) )
  {
    sub_1C1AE30(this, atlasManagerUnit);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCB0DC & 1) == 0 )
  {
    this = (ClassBoardUIController_o *)sub_1C1ABD4(&StringLiteral_20677/*"img_item_bg"*/, dispItemIds);
    byte_4BCB0DC = 1;
  }
  if ( !dispItemIds )
    goto LABEL_22;
...
LABEL_23:
        ...
        this = (ClassBoardUIController_o *)AtlasManagerUnit__SetUI(
                                             atlasManagerUnit,
                                             v12->fields.baseSp,
                                             (System_String_o *)StringLiteral_20677/*"img_item_bg"*/,
                                             0LL);
