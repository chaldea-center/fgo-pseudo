        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BDBAD4(effectListBtnSprite, value);
  }
...
void __fastcall ClassBoardUIController__Init(ClassBoardUIController_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B48379 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_17545/*"btn_to_grand_scoreboard"*/, v3);
    sub_1BDB878(&StringLiteral_17506/*"btn_list"*/, v4);
    sub_1BDB878(&StringLiteral_17523/*"btn_regression_hourglass"*/, v5);
    this = (ClassBoardUIController_o *)sub_1BDB878(&StringLiteral_17544/*"btn_to_crown_formation"*/, v6);
    byte_4B48379 = 1;
  }
  ...
  AtlasManagerUnit__SetUI(
    ...
    (System_String_o *)StringLiteral_17506/*"btn_list"*/,
    0LL);
  toGrandServantListBtnSprite = (UnityEngine_Object_o *)v2->fields.toGrandServantListBtnSprite;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  v10 = UnityEngine_Object__op_Inequality(toGrandServantListBtnSprite, 0LL, 0LL);
  if ( v10 )
  {
    ...
    AtlasManagerUnit__SetUI(
      ...
      (System_String_o *)StringLiteral_17544/*"btn_to_crown_formation"*/,
      0LL);
  }
  grandScoreBtnSprite = (UnityEngine_Object_o *)v2->fields.grandScoreBtnSprite;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  v12 = UnityEngine_Object__op_Inequality(grandScoreBtnSprite, 0LL, 0LL);
  if ( v12 )
  {
    ...
    AtlasManagerUnit__SetUI(
      ...
      (System_String_o *)StringLiteral_17545/*"btn_to_grand_scoreboard"*/,
      0LL);
  }
  shop18BtnSprite = (UnityEngine_Object_o *)v2->fields.shop18BtnSprite;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  v14 = UnityEngine_Object__op_Inequality(shop18BtnSprite, 0LL, 0LL);
  if ( v14 )
  {
    ...
    if ( UiAtlasManagerUnit )
    {
      AtlasManagerUnit__SetUI(
        UiAtlasManagerUnit,
        v2->fields.shop18BtnSprite,
        (System_String_o *)StringLiteral_17523/*"btn_regression_hourglass"*/,
        0LL);
      goto LABEL_19;
    }
LABEL_20:
    sub_1BDBAD4(UiAtlasManagerUnit, v8);
  }
LABEL_19:
  AndroidBackKeyManager__AddBackBtn(v2->fields.backBtn, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48386 & 1) == 0 )
  {
    sub_1BDB878(&CondType_TypeInfo, *(_QWORD *)&baseId);
    sub_1BDB878(&Method_DataManager_GetMaster_ClassBoardBaseMaster___, v6);
    sub_1BDB878(&DataManager_TypeInfo, v7);
    sub_1BDB878(&Method_DataMasterBase_ClassBoardBaseMaster__ClassBoardBaseEntity__int__TryGetEntity__, v8);
    byte_4B48386 = 1;
  }
  entity = 0LL;
  *questId = 0;
...
void __fastcall ClassBoardUIController__OnClickBack(ClassBoardUIController_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B48382 & 1) == 0 )
  {
    sub_1BDB878(&Method_ClassBoardUIController_OnClickBack__, method);
    byte_4B48382 = 1;
  }
  v3 = Method_ClassBoardUIController_OnClickBack__;
  if ( (*((_BYTE *)Method_ClassBoardUIController_OnClickBack__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1BDB890(Method_ClassBoardUIController_OnClickBack__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4837E & 1) == 0 )
  {
    sub_1BDB878(&Method_ClassBoardUIController_OnClickEffectListButton__, method);
    byte_4B4837E = 1;
  }
  ...
  if ( (*((_BYTE *)Method_ClassBoardUIController_OnClickEffectListButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1BDB890(Method_ClassBoardUIController_OnClickEffectListButton__);
  v4 = (System_Reflection_MethodBase_o *)sub_1BDB85C(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48380 & 1) == 0 )
  {
    sub_1BDB878(&Method_ClassBoardUIController_OnClickGrandScoreButton__, method);
    this = (ClassBoardUIController_o *)sub_1BDB878(&StringLiteral_17546/*"btn_to_grand_scoreboard_blackout"*/, v3);
    byte_4B48380 = 1;
  }
  grandScoreBtnSprite = v2->fields.grandScoreBtnSprite;
  if ( !grandScoreBtnSprite )
    sub_1BDBAD4(this, method);
  v5 = System_String__op_Equality(grandScoreBtnSprite->fields.mSpriteName, (System_String_o *)StringLiteral_17546/*"btn_to_grand_scoreboard_blackout"*/, 0LL);
  ...
  if ( (*((_BYTE *)Method_ClassBoardUIController_OnClickGrandScoreButton__ + 83) & 2) != 0 )
    v6 = (_QWORD *)sub_1BDB890(Method_ClassBoardUIController_OnClickGrandScoreButton__);
...
void __fastcall ClassBoardUIController__OnClickHelp(ClassBoardUIController_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B4837F & 1) == 0 )
  {
    sub_1BDB878(&Method_ClassBoardUIController_OnClickHelp__, method);
    byte_4B4837F = 1;
  }
  v3 = Method_ClassBoardUIController_OnClickHelp__;
  if ( (*((_BYTE *)Method_ClassBoardUIController_OnClickHelp__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1BDB890(Method_ClassBoardUIController_OnClickHelp__);
  v4 = (System_Reflection_MethodBase_o *)sub_1BDB85C(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
...
void __fastcall ClassBoardUIController__OnClickShop18Button(ClassBoardUIController_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B48381 & 1) == 0 )
  {
    sub_1BDB878(&Method_ClassBoardUIController_OnClickShop18Button__, method);
    byte_4B48381 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_ClassBoardUIController_OnClickShop18Button__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1BDB890(Method_ClassBoardUIController_OnClickShop18Button__);
  v4 = (System_Reflection_MethodBase_o *)sub_1BDB85C(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48383 & 1) == 0 )
  {
    sub_1BDB878(&Method_ClassBoardUIController_OnClickToGrandServantList__, method);
    byte_4B48383 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_ClassBoardUIController_OnClickToGrandServantList__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1BDB890(Method_ClassBoardUIController_OnClickToGrandServantList__);
  v4 = (System_Reflection_MethodBase_o *)sub_1BDB85C(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48385 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_3449/*"CLASS_BOARD_MISSION_CLEAR_MESSAGE"*/, v6);
    byte_4B48385 = 1;
  }
  ...
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_3449/*"CLASS_BOARD_MISSION_CLEAR_MESSAGE"*/, 0LL);
  if ( !Instance )
    sub_1BDBAD4(v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( v6 )
  {
    ...
    if ( !byte_4B483D7 )
    {
      v7 = sub_1BDB878(&ClassBoardPageSwitcher_TypeInfo, v8);
      byte_4B483D7 = 1;
    }
    if ( !v9 )
      sub_1BDBAD4(v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4837D & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMaster_ClassBoardBaseMaster___, *(_QWORD *)&grandBaseId);
    sub_1BDB878(&DataManager_TypeInfo, v7);
    sub_1BDB878(&Method_DataMasterBase_ClassBoardBaseMaster__ClassBoardBaseEntity__int__GetEntity__, v8);
    sub_1BDB878(&StringLiteral_17545/*"btn_to_grand_scoreboard"*/, v9);
    sub_1BDB878(&StringLiteral_17546/*"btn_to_grand_scoreboard_blackout"*/, v10);
    byte_4B4837D = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  ...
  Entity = DataMasterBase_object__object__int___GetEntity(
             (DataMasterBase_TMaster__TEntity__PKType__o *)Master_object,
             grandBaseId,
             (const MethodInfo_32E1E3C *)Method_DataMasterBase_ClassBoardBaseMaster__ClassBoardBaseEntity__int__GetEntity__);
  if ( !Entity )
    return;
...
LABEL_12:
  ...
  v15 = &StringLiteral_17545/*"btn_to_grand_scoreboard"*/;
  if ( ((unsigned __int8)Master_object & 1) == 0 )
    v15 = &StringLiteral_17546/*"btn_to_grand_scoreboard_blackout"*/;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4837B & 1) == 0 )
  {
    sub_1BDB878(&UnityEngine_Object_TypeInfo, atlasManagerUnit);
    sub_1BDB878(&StringLiteral_20383/*"img_commonbg_11"*/, v11);
    byte_4B4837B = 1;
  }
  ...
  if ( (v14 & isGrand & isSettedGrandSvt & 1) == 0 )
  {
    ...
    if ( atlasManagerUnit )
    {
      AtlasManagerUnit__SetUI(
        ...
        (System_String_o *)StringLiteral_20383/*"img_commonbg_11"*/,
        0LL);
...
LABEL_18:
    sub_1BDBAD4(headerMessageBgSprite, atlasManagerUnit);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4837C & 1) == 0 )
  {
    sub_1BDB878(&UnityEngine_Object_TypeInfo, dispItemIds);
    this = (ClassBoardUIController_o *)sub_1BDB878(&StringLiteral_20432/*"img_item_bg"*/, v9);
    byte_4B4837C = 1;
  }
...
LABEL_44:
          sub_1BDBADC(this, dispItemIds, atlasManagerUnit);
        v15 = m_Items[v12];
        ...
        this = (ClassBoardUIController_o *)AtlasManagerUnit__SetUI(
                                             atlasManagerUnit,
                                             v15->fields.baseSp,
                                             (System_String_o *)StringLiteral_20432/*"img_item_bg"*/,
                                             0LL);
        if ( v12 >= headerItemComponentList->max_length )
          goto LABEL_44;
        this = (ClassBoardUIController_o *)m_Items[v12];
        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.onClickBack, (int32_t)action, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.onClickEffectList, (int32_t)action, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.onClickGrandScoreButton, (int32_t)action, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.onClickHelp, (int32_t)action, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.onClickShop18Button, (int32_t)action, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      if ( v5 >= max_length )
LABEL_16:
        sub_1BDBADC(this, isGrand, method);
