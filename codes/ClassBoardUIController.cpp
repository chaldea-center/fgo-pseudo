        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C93D2C(effectListBtnSprite, value);
  }
...
void ClassBoardUIController__Init(ClassBoardUIController_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C93AD4(&UnityEngine_Object_TypeInfo);
    sub_1C93AD4(&StringLiteral_17666/*"btn_to_grand_scoreboard"*/);
    sub_1C93AD4(&StringLiteral_17663/*"btn_to_class_scoreboard"*/);
    sub_1C93AD4(&StringLiteral_17624/*"btn_list"*/);
    sub_1C93AD4(&StringLiteral_17641/*"btn_regression_hourglass"*/);
    sub_1C93AD4(&StringLiteral_17665/*"btn_to_crown_formation"*/);
    this = (ClassBoardUIController_o *)sub_1C93AD4(&StringLiteral_17667/*"btn_to_grand_scoreboard_2"*/);
    byte_4D346F7 = 1;
  }
  ...
  if ( !UiAtlasManagerUnit )
    goto LABEL_37;
  AtlasManagerUnit__SetUI(UiAtlasManagerUnit, v2->fields.effectListBtnSprite, (System_String_o *)StringLiteral_17624/*"btn_list"*/, 0);
  ...
  if ( v6 )
  {
    ...
    AtlasManagerUnit__SetUI(
      ...
      (System_String_o *)StringLiteral_17665/*"btn_to_crown_formation"*/,
      0);
  }
  ...
  if ( v8 )
  {
    ...
    AtlasManagerUnit__SetUI(
      ...
      (System_String_o *)StringLiteral_17666/*"btn_to_grand_scoreboard"*/,
      0);
  }
  ...
  if ( v10 )
  {
    ...
    AtlasManagerUnit__SetUI(
      ...
      (System_String_o *)StringLiteral_17663/*"btn_to_class_scoreboard"*/,
      0);
  }
  ...
  if ( v12 )
  {
    ...
    AtlasManagerUnit__SetUI(
      ...
      (System_String_o *)StringLiteral_17641/*"btn_regression_hourglass"*/,
      0);
  }
  ...
  if ( v16 )
  {
    ...
    AtlasManagerUnit__SetUI(
      ...
      (System_String_o *)StringLiteral_17667/*"btn_to_grand_scoreboard_2"*/,
      0);
  }
  ...
  {
LABEL_37:
    sub_1C93D2C(UiAtlasManagerUnit, v4);
  }
...
void ClassBoardUIController__OnClickBack(ClassBoardUIController_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D34702 & 1) == 0 )
  {
    sub_1C93AD4(&Method_ClassBoardUIController_OnClickBack__);
    byte_4D34702 = 1;
  }
  v3 = Method_ClassBoardUIController_OnClickBack__;
  if ( (*((_BYTE *)Method_ClassBoardUIController_OnClickBack__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C93AEC(Method_ClassBoardUIController_OnClickBack__);
...
void ClassBoardUIController__OnClickClassBoardResetButton(ClassBoardUIController_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D34701 & 1) == 0 )
  {
    sub_1C93AD4(&Method_ClassBoardUIController_OnClickClassBoardResetButton__);
    byte_4D34701 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_ClassBoardUIController_OnClickClassBoardResetButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C93AEC(Method_ClassBoardUIController_OnClickClassBoardResetButton__);
  v4 = (System_Reflection_MethodBase_o *)sub_1C93AB8(v3, v3[4]);
...
void ClassBoardUIController__OnClickClassBoardSelectButton(ClassBoardUIController_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D34703 & 1) == 0 )
  {
    sub_1C93AD4(&Method_ClassBoardUIController_OnClickClassBoardSelectButton__);
    byte_4D34703 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_ClassBoardUIController_OnClickClassBoardSelectButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C93AEC(Method_ClassBoardUIController_OnClickClassBoardSelectButton__);
  v4 = (System_Reflection_MethodBase_o *)sub_1C93AB8(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0, 0);
...
void ClassBoardUIController__OnClickClassScoreButton(ClassBoardUIController_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D34700 & 1) == 0 )
  {
    sub_1C93AD4(&Method_ClassBoardUIController_OnClickClassScoreButton__);
    this = (ClassBoardUIController_o *)sub_1C93AD4(&StringLiteral_17664/*"btn_to_class_scoreboard_blackout"*/);
    byte_4D34700 = 1;
  }
  classScoreBtnSprite = v2->fields.classScoreBtnSprite;
  if ( !classScoreBtnSprite )
    sub_1C93D2C(this, method);
  v4 = System_String__op_Equality(classScoreBtnSprite->fields.mSpriteName, (System_String_o *)StringLiteral_17664/*"btn_to_class_scoreboard_blackout"*/, 0);
  ...
  if ( (*((_BYTE *)Method_ClassBoardUIController_OnClickClassScoreButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1C93AEC(Method_ClassBoardUIController_OnClickClassScoreButton__);
...
void ClassBoardUIController__OnClickEffectListButton(ClassBoardUIController_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D346FD & 1) == 0 )
  {
    sub_1C93AD4(&Method_ClassBoardUIController_OnClickEffectListButton__);
    byte_4D346FD = 1;
  }
  ...
  if ( (*((_BYTE *)Method_ClassBoardUIController_OnClickEffectListButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C93AEC(Method_ClassBoardUIController_OnClickEffectListButton__);
  v4 = (System_Reflection_MethodBase_o *)sub_1C93AB8(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
...
void ClassBoardUIController__OnClickGrandScoreButton(ClassBoardUIController_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D346FF & 1) == 0 )
  {
    sub_1C93AD4(&Method_ClassBoardUIController_OnClickGrandScoreButton__);
    this = (ClassBoardUIController_o *)sub_1C93AD4(&StringLiteral_17668/*"btn_to_grand_scoreboard_blackout"*/);
    byte_4D346FF = 1;
  }
  grandScoreBtnSprite = v2->fields.grandScoreBtnSprite;
  if ( !grandScoreBtnSprite )
    sub_1C93D2C(this, method);
  v4 = System_String__op_Equality(grandScoreBtnSprite->fields.mSpriteName, (System_String_o *)StringLiteral_17668/*"btn_to_grand_scoreboard_blackout"*/, 0);
  ...
  if ( (*((_BYTE *)Method_ClassBoardUIController_OnClickGrandScoreButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1C93AEC(Method_ClassBoardUIController_OnClickGrandScoreButton__);
  v7 = (System_Reflection_MethodBase_o *)sub_1C93AB8(v5, v5[4]);
  if ( v6 )
  {
    OverwriteAssetSoundName__PlaySystemSe(v7, 2, 0, 0);
...
void ClassBoardUIController__OnClickHelp(ClassBoardUIController_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D346FE & 1) == 0 )
  {
    sub_1C93AD4(&Method_ClassBoardUIController_OnClickHelp__);
    byte_4D346FE = 1;
  }
  v3 = Method_ClassBoardUIController_OnClickHelp__;
  if ( (*((_BYTE *)Method_ClassBoardUIController_OnClickHelp__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C93AEC(Method_ClassBoardUIController_OnClickHelp__);
  v4 = (System_Reflection_MethodBase_o *)sub_1C93AB8(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
...
void ClassBoardUIController__OnClickToGrandServantList(ClassBoardUIController_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D34704 & 1) == 0 )
  {
    sub_1C93AD4(&Method_ClassBoardUIController_OnClickToGrandServantList__);
    byte_4D34704 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_ClassBoardUIController_OnClickToGrandServantList__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C93AEC(Method_ClassBoardUIController_OnClickToGrandServantList__);
  v4 = (System_Reflection_MethodBase_o *)sub_1C93AB8(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D34706 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_3431/*"CLASS_BOARD_MISSION_CLEAR_MESSAGE"*/);
    byte_4D34706 = 1;
  }
  ...
  v6 = LocalizationManager__Get((System_String_o *)StringLiteral_3431/*"CLASS_BOARD_MISSION_CLEAR_MESSAGE"*/, 0);
  if ( !Instance )
    sub_1C93D2C(v6, v7);
...
void ClassBoardUIController__SetCameraWorkBlock(ClassBoardUIController_o *this, bool value, const MethodInfo *method)
{
  ...
  if ( v6 )
  {
    ...
    if ( !byte_4D34752 )
    {
      v7 = sub_1C93AD4(&ClassBoardPageSwitcher_TypeInfo);
      byte_4D34752 = 1;
    }
    if ( !v9 )
      sub_1C93D2C(v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D346FC & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_17663/*"btn_to_class_scoreboard"*/);
    sub_1C93AD4(&StringLiteral_17664/*"btn_to_class_scoreboard_blackout"*/);
    byte_4D346FC = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
...
LABEL_16:
  ...
  if ( ((unsigned __int8)Master_object & 1) != 0 )
    v12 = &StringLiteral_17663/*"btn_to_class_scoreboard"*/;
  else
    v12 = &StringLiteral_17664/*"btn_to_class_scoreboard_blackout"*/;
  ...
  if ( ClassBoardBaseEntity__IsOpen(v11, 0) )
    v14 = &StringLiteral_17663/*"btn_to_class_scoreboard"*/;
  else
    v14 = &StringLiteral_17664/*"btn_to_class_scoreboard_blackout"*/;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D346FB & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_DataMasterBase_ClassBoardBaseMaster__ClassBoardBaseEntity__int__GetEntity__);
    sub_1C93AD4(&StringLiteral_17666/*"btn_to_grand_scoreboard"*/);
    sub_1C93AD4(&StringLiteral_17668/*"btn_to_grand_scoreboard_blackout"*/);
    sub_1C93AD4(&StringLiteral_17669/*"btn_to_grand_scoreboard_blackout_2"*/);
    sub_1C93AD4(&StringLiteral_17667/*"btn_to_grand_scoreboard_2"*/);
    byte_4D346FB = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
...
LABEL_15:
    sub_1C93D2C(Master_object, v8);
  v12 = &StringLiteral_17666/*"btn_to_grand_scoreboard"*/;
  if ( ((unsigned __int8)Master_object & 1) == 0 )
    v12 = &StringLiteral_17668/*"btn_to_grand_scoreboard_blackout"*/;
  ...
  if ( ClassBoardBaseEntity__IsOpen(v11, 0) )
    v14 = (System_String_o **)&StringLiteral_17667/*"btn_to_grand_scoreboard_2"*/;
  else
    v14 = (System_String_o **)&StringLiteral_17669/*"btn_to_grand_scoreboard_blackout_2"*/;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C93AD4(&UnityEngine_Object_TypeInfo);
    sub_1C93AD4(&StringLiteral_20595/*"img_commonbg_11"*/);
    byte_4D346F9 = 1;
  }
  ...
  if ( (v13 & isGrand & isSettedGrandSvt & 1) == 0 )
  {
    ...
    if ( atlasManagerUnit )
    {
      AtlasManagerUnit__SetUI(
        ...
        (System_String_o *)StringLiteral_20595/*"img_commonbg_11"*/,
        0);
...
LABEL_18:
    sub_1C93D2C(headerMessageBgSprite, atlasManagerUnit);
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C93AD4(&UnityEngine_Object_TypeInfo);
    this = (ClassBoardUIController_o *)sub_1C93AD4(&StringLiteral_20648/*"img_item_bg"*/);
    byte_4D346FA = 1;
  }
...
LABEL_44:
        ...
        this = (ClassBoardUIController_o *)AtlasManagerUnit__SetUI(
                                             atlasManagerUnit,
                                             v14->fields.baseSp,
                                             (System_String_o *)StringLiteral_20648/*"img_item_bg"*/,
                                             0);
        if ( v11 >= LODWORD(headerItemComponentList->max_length) )
          goto LABEL_44;
        this = (ClassBoardUIController_o *)m_Items[v11];
