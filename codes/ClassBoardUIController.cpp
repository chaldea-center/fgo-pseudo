        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C13F80(effectListBtnSprite, value);
  }
...
void __fastcall ClassBoardUIController__Init(ClassBoardUIController_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB7CE6 & 1) == 0 )
  {
    this = (ClassBoardUIController_o *)sub_1C13D24(&StringLiteral_17780/*"btn_completecheck_bg"*/, method);
    byte_4BB7CE6 = 1;
  }
...
void __fastcall ClassBoardUIController__OnClickBack(ClassBoardUIController_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB7CEB & 1) == 0 )
  {
    sub_1C13D24(&Method_ClassBoardUIController_OnClickBack__, method);
    byte_4BB7CEB = 1;
  }
  v3 = Method_ClassBoardUIController_OnClickBack__;
  if ( (*((_BYTE *)Method_ClassBoardUIController_OnClickBack__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C13D3C(Method_ClassBoardUIController_OnClickBack__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB7CE9 & 1) == 0 )
  {
    sub_1C13D24(&Method_ClassBoardUIController_OnClickEffectListButton__, method);
    byte_4BB7CE9 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_ClassBoardUIController_OnClickEffectListButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C13D3C(Method_ClassBoardUIController_OnClickEffectListButton__);
  v4 = (System_Reflection_MethodBase_o *)sub_1C13D08(v3, v3[4]);
...
void __fastcall ClassBoardUIController__OnClickHelp(ClassBoardUIController_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB7CEA & 1) == 0 )
  {
    sub_1C13D24(&Method_ClassBoardUIController_OnClickHelp__, method);
    byte_4BB7CEA = 1;
  }
  v3 = Method_ClassBoardUIController_OnClickHelp__;
  if ( (*((_BYTE *)Method_ClassBoardUIController_OnClickHelp__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C13D3C(Method_ClassBoardUIController_OnClickHelp__);
  v4 = (System_Reflection_MethodBase_o *)sub_1C13D08(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB7CED & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_3548/*"CLASS_BOARD_LOCK_RELEASE_CONDITION_DIALOG_TITLE"*/, v6);
    byte_4BB7CED = 1;
  }
  ...
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_3548/*"CLASS_BOARD_LOCK_RELEASE_CONDITION_DIALOG_TITLE"*/, 0LL);
  if ( !Instance )
    sub_1C13F80(v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( v6 )
  {
    ...
    if ( !byte_4BB7D11 )
    {
      v7 = sub_1C13D24(&ClassBoardPageSwitcher_TypeInfo, v8);
      byte_4BB7D11 = 1;
    }
    if ( !v9 )
      sub_1C13F80(v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB7CE7 & 1) == 0 )
  {
    this = (ClassBoardUIController_o *)sub_1C13D24(&StringLiteral_20627/*"img_combine_14"*/, atlasManagerUnit);
    byte_4BB7CE7 = 1;
  }
  if ( !atlasManagerUnit
    || (AtlasManagerUnit__SetUI(
          ...
          (System_String_o *)StringLiteral_20627/*"img_combine_14"*/,
          0LL),
        (this = (ClassBoardUIController_o *)v6->fields.headerMessageLabel) == 0LL) )
  {
    sub_1C13F80(this, atlasManagerUnit);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB7CE8 & 1) == 0 )
  {
    this = (ClassBoardUIController_o *)sub_1C13D24(&StringLiteral_20663/*"img_frames_mask13"*/, dispItemIds);
    byte_4BB7CE8 = 1;
  }
  if ( !dispItemIds )
    goto LABEL_22;
...
LABEL_23:
        ...
        this = (ClassBoardUIController_o *)AtlasManagerUnit__SetUI(
                                             atlasManagerUnit,
                                             v12->fields.baseSp,
                                             (System_String_o *)StringLiteral_20663/*"img_frames_mask13"*/,
                                             0LL);
