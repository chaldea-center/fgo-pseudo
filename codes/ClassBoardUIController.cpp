        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B64C5C(effectListBtnSprite, value);
  }
...
void __fastcall ClassBoardUIController__Init(ClassBoardUIController_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A01F53 & 1) == 0 )
  {
    this = (ClassBoardUIController_o *)sub_1B64A00(&StringLiteral_17447/*"btn_list"*/, method);
    byte_4A01F53 = 1;
  }
  ...
  AtlasManagerUnit__SetUI(
    ...
    (System_String_o *)StringLiteral_17447/*"btn_list"*/,
    0LL);
...
void __fastcall ClassBoardUIController__OnClickBack(ClassBoardUIController_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A01F58 & 1) == 0 )
  {
    sub_1B64A00(&Method_ClassBoardUIController_OnClickBack__, method);
    byte_4A01F58 = 1;
  }
  v3 = Method_ClassBoardUIController_OnClickBack__;
  if ( (*((_BYTE *)Method_ClassBoardUIController_OnClickBack__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B64A18(Method_ClassBoardUIController_OnClickBack__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01F56 & 1) == 0 )
  {
    sub_1B64A00(&Method_ClassBoardUIController_OnClickEffectListButton__, method);
    byte_4A01F56 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_ClassBoardUIController_OnClickEffectListButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B64A18(Method_ClassBoardUIController_OnClickEffectListButton__);
  v4 = (System_Reflection_MethodBase_o *)sub_1B649E4(v3, v3[4]);
...
void __fastcall ClassBoardUIController__OnClickHelp(ClassBoardUIController_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A01F57 & 1) == 0 )
  {
    sub_1B64A00(&Method_ClassBoardUIController_OnClickHelp__, method);
    byte_4A01F57 = 1;
  }
  v3 = Method_ClassBoardUIController_OnClickHelp__;
  if ( (*((_BYTE *)Method_ClassBoardUIController_OnClickHelp__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B64A18(Method_ClassBoardUIController_OnClickHelp__);
  v4 = (System_Reflection_MethodBase_o *)sub_1B649E4(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01F5A & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_3488/*"CLASS_BOARD_MISSION_CLEAR_MESSAGE"*/, v6);
    byte_4A01F5A = 1;
  }
  ...
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_3488/*"CLASS_BOARD_MISSION_CLEAR_MESSAGE"*/, 0LL);
  if ( !Instance )
    sub_1B64C5C(v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( v6 )
  {
    ...
    if ( !byte_4A01FAE )
    {
      v7 = sub_1B64A00(&ClassBoardPageSwitcher_TypeInfo, v8);
      byte_4A01FAE = 1;
    }
    if ( !v9 )
      sub_1B64C5C(v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01F54 & 1) == 0 )
  {
    this = (ClassBoardUIController_o *)sub_1B64A00(&StringLiteral_20218/*"img_commonbg_11"*/, atlasManagerUnit);
    byte_4A01F54 = 1;
  }
  if ( !atlasManagerUnit
    || (AtlasManagerUnit__SetUI(
  ...
  {
    sub_1B64C5C(this, atlasManagerUnit);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01F55 & 1) == 0 )
  {
    this = (ClassBoardUIController_o *)sub_1B64A00(&StringLiteral_20251/*"img_item_bg"*/, dispItemIds);
    byte_4A01F55 = 1;
  }
  if ( !dispItemIds )
    goto LABEL_22;
        ...
        const MethodInfo *method)
{
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.onClickBack, (int32_t)action, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.onClickHelp, (int32_t)action, (int32_t)method, v3);
}
