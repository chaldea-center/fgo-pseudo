        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5BB2F & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_EventInfoHappinessCounterControl___c__DisplayClass22_0__Initialization_b__0__);
    sub_1B885B0(&EventInfoHappinessCounterControl___c__DisplayClass22_0_TypeInfo);
    byte_4A5BB2F = 1;
  }
  v5 = sub_1B887FC(EventInfoHappinessCounterControl___c__DisplayClass22_0_TypeInfo);
  EventInfoHappinessCounterControl___c__DisplayClass22_0___ctor(
    (EventInfoHappinessCounterControl___c__DisplayClass22_0_o *)v5,
    0LL);
  if ( !v5 )
    goto LABEL_6;
  *(_QWORD *)(v5 + 16) = this;
  ...
  *(_QWORD *)(v5 + 24) = entity;
  sub_1B88554((ServantStatusBattleListViewItem_o *)(v5 + 24), (int32_t)entity, v10, v11);
  EventInfoUIBase__Initialization((EventInfoUIBase_o *)this, *(EventUiEntity_o **)(v5 + 24), 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5BB34 & 1) == 0 )
  {
    ...
    this = (EventInfoHappinessCounterControl_o *)sub_1B885B0(&StringLiteral_19160/*"event_counter_number_"*/);
    byte_4A5BB34 = 1;
  }
  v23 = 0;
  DigitNumber = 0LL;
  if ( sprites )
  {
    ...
    if ( (int)v8 >= 1 )
    {
      ...
      do
      {
        if ( v10 >= sprites->max_length )
LABEL_19:
          sub_1B88814(v8, v9);
        v14 = (UnityEngine_Object_o *)m_Items[v10];
        if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
        v8 = (EventInfoHappinessCounterControl_o *)UnityEngine_Object__op_Equality(v14, 0LL, 0LL);
        if ( ((unsigned __int8)v8 & 1) == 0 )
        {
          ...
          if ( (__int64)v10 <= v12 )
          {
            ...
            v20 = System_String__Concat_61707032((System_String_o *)StringLiteral_19160/*"event_counter_number_"*/, v19, 0LL);
            v8 = (EventInfoHappinessCounterControl_o *)EventInfoUIBase__SetSpriteByLocalAtlas(v6, v16, v20, 0LL);
            if ( v10 >= sprites->max_length )
              goto LABEL_19;
            v21 = m_Items[v10];
            if ( !v21 )
          ...
          else
          {
            ...
            v18 = System_String__Concat_61707032((System_String_o *)StringLiteral_19160/*"event_counter_number_"*/, v17, 0LL);
            EventInfoUIBase__SetSpriteByLocalAtlas(v6, v16, v18, 0LL);
          }
          ++v11;
        }
        ++v10;
        ...
        const MethodInfo *method)
{
  ...
  {
    v4 = this->fields.eventPointLabel;
    ...
    if ( !v4 )
      goto LABEL_24;
    UILabel__set_text(v4, NumberFormatLong, 0LL);
    ...
    NumberFormatLong = (System_String_o *)DataManager__GetMaster_object_((const MethodInfo_2E7F8B4 *)Method_DataManager_GetMaster_EventUiMaster___);
    if ( !NumberFormatLong )
      goto LABEL_24;
    ...
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    NumberFormatLong = (System_String_o *)DataManager__GetMaster_object_((const MethodInfo_2E7F8B4 *)Method_DataManager_GetMaster_EventUiReleaseMaster___);
    if ( !NumberFormatLong
      ...
      || (v13 = (char)NumberFormatLong,
          (NumberFormatLong = (System_String_o *)UnityEngine_Component__get_gameObject(eventPointLabelRoot, 0LL)) == 0LL) )
    {
LABEL_24:
      sub_1B8880C(NumberFormatLong, v7);
    }
    UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)NumberFormatLong, v13 & 1, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B885B0(&UnityEngine_Object_TypeInfo);
    sub_1B885B0(&StringLiteral_19205/*"event_point_base"*/);
    byte_4A5BB30 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(eventPointBgSprite, 0LL, 0LL) )
  {
    EventInfoUIBase__SetSpriteByLocalAtlas(
      ...
      (System_String_o *)StringLiteral_19205/*"event_point_base"*/,
      0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B885B0(&UnityEngine_Object_TypeInfo);
    sub_1B885B0(&StringLiteral_19158/*"event_counter_base_first"*/);
    sub_1B885B0(&StringLiteral_19159/*"event_counter_base_max"*/);
    byte_4A5BB32 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(happinessCounterBgSpriteFirst, 0LL, 0LL) )
  {
    ...
    if ( !UnityEngine_Object__op_Equality(happinessCounterBgSpriteMax, 0LL, 0LL) )
    {
      EventInfoUIBase__SetSpriteByLocalAtlas(
        ...
        (System_String_o *)StringLiteral_19158/*"event_counter_base_first"*/,
        0LL);
      EventInfoUIBase__SetSpriteByLocalAtlas(
        (EventInfoUIBase_o *)this,
        this->fields.happinessCounterBgSpriteMax,
        (System_String_o *)StringLiteral_19159/*"event_counter_base_max"*/,
        0LL);
