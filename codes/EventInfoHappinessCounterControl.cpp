        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EAAE & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_EventInfoHappinessCounterControl___c__DisplayClass22_0__Initialization_b__0__, v5);
    sub_1B761C0(&EventInfoHappinessCounterControl___c__DisplayClass22_0_TypeInfo, v6);
    byte_4A2EAAE = 1;
  }
  v7 = sub_1B7640C(EventInfoHappinessCounterControl___c__DisplayClass22_0_TypeInfo);
  ...
  *(_QWORD *)(v7 + 24) = entity;
  sub_1B76164((ServantStatusBattleListViewItem_o *)(v7 + 24), (int32_t)entity, v12, v13);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EAB3 & 1) == 0 )
  {
    sub_1B761C0(&Method_System_Linq_Enumerable_Count_UISprite___, number);
    sub_1B761C0(&UnityEngine_Object_TypeInfo, v7);
    this = (EventInfoHappinessCounterControl_o *)sub_1B761C0(&StringLiteral_19154/*"event_counter_number_"*/, v8);
    byte_4A2EAB3 = 1;
  }
  v25 = 0;
  DigitNumber = 0LL;
...
LABEL_19:
        ...
        if ( ((unsigned __int8)v10 & 1) == 0 )
        {
          ...
          if ( (__int64)v12 <= v14 )
          {
            ...
            v22 = System_String__Concat_61535060((System_String_o *)StringLiteral_19154/*"event_counter_number_"*/, v21, 0LL);
          ...
          else
          {
            ...
            v20 = System_String__Concat_61535060((System_String_o *)StringLiteral_19154/*"event_counter_number_"*/, v19, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EAB0 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMaster_EventUiMaster___, method);
    sub_1B761C0(&Method_DataManager_GetMaster_EventUiReleaseMaster___, v3);
  ...
  if ( !UnityEngine_Object__op_Equality(eventPointLabel, 0LL, 0LL) )
  {
    ...
    NumberFormatLong = (System_String_o *)DataManager__GetMaster_object_((const MethodInfo_2E623B4 *)Method_DataManager_GetMaster_EventUiMaster___);
    if ( !NumberFormatLong )
      goto LABEL_24;
    ...
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    NumberFormatLong = (System_String_o *)DataManager__GetMaster_object_((const MethodInfo_2E623B4 *)Method_DataManager_GetMaster_EventUiReleaseMaster___);
    if ( !NumberFormatLong
    ...
    {
LABEL_24:
      sub_1B7641C(NumberFormatLong, v11);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EAAF & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_19199/*"event_point_base"*/, v3);
    byte_4A2EAAF = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(eventPointBgSprite, 0LL, 0LL) )
  {
    EventInfoUIBase__SetSpriteByLocalAtlas(
      ...
      (System_String_o *)StringLiteral_19199/*"event_point_base"*/,
      0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B761C0(&UnityEngine_Object_TypeInfo, method);
    sub_1B761C0(&StringLiteral_19152/*"event_counter_base_first"*/, v3);
    sub_1B761C0(&StringLiteral_19153/*"event_counter_base_max"*/, v4);
    byte_4A2EAB1 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(happinessCounterBgSpriteFirst, 0LL, 0LL) )
  {
    ...
    if ( !UnityEngine_Object__op_Equality(happinessCounterBgSpriteMax, 0LL, 0LL) )
    {
      EventInfoUIBase__SetSpriteByLocalAtlas(
        ...
        (System_String_o *)StringLiteral_19152/*"event_counter_base_first"*/,
        0LL);
      EventInfoUIBase__SetSpriteByLocalAtlas(
        (EventInfoUIBase_o *)this,
        this->fields.happinessCounterBgSpriteMax,
        (System_String_o *)StringLiteral_19153/*"event_counter_base_max"*/,
        0LL);
