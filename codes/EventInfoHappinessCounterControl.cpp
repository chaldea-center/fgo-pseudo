        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC8927 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_EventInfoHappinessCounterControl___c__DisplayClass22_0__Initialization_b__0__);
    sub_1C713B0(&EventInfoHappinessCounterControl___c__DisplayClass22_0_TypeInfo);
    byte_4CC8927 = 1;
  }
  v5 = sub_1C715FC(EventInfoHappinessCounterControl___c__DisplayClass22_0_TypeInfo);
  ...
  *(_QWORD *)(v5 + 24) = entity;
  sub_1C71354((GrandQuestFolderBoardItem_o *)(v5 + 24), (int32_t)entity, v14, v15, v16, v17, v18, v19);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC892C & 1) == 0 )
  {
    ...
    this = (EventInfoHappinessCounterControl_o *)sub_1C713B0(&StringLiteral_19235/*"event_counter_number_"*/);
    byte_4CC892C = 1;
  }
  v23 = 0;
  DigitNumber = 0;
...
LABEL_19:
        ...
        if ( ((unsigned __int8)v8 & 1) == 0 )
        {
          ...
          if ( (__int64)v9 <= v11 )
          {
            ...
            v19 = System_String__Concat_64031724((System_String_o *)StringLiteral_19235/*"event_counter_number_"*/, v18, 0);
          ...
          else
          {
            ...
            v17 = System_String__Concat_64031724((System_String_o *)StringLiteral_19235/*"event_counter_number_"*/, v16, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( !UnityEngine_Object__op_Equality(eventPointLabel, 0, 0) )
  {
    ...
    Master_object = (System_String_o *)DataManager__GetMaster_object_((const MethodInfo_314B0B8 *)Method_DataManager_GetMaster_EventUiMaster___);
    if ( Master_object )
    {
        ...
        if ( v6 )
        {
          ...
          if ( Master_object )
          {
            ...
            if ( Master_object )
            {
              ...
              if ( !DataManager_TypeInfo->_2.cctor_finished )
                j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
              Master_object = (System_String_o *)DataManager__GetMaster_object_((const MethodInfo_314B0B8 *)Method_DataManager_GetMaster_EventUiReleaseMaster___);
              if ( Master_object )
              {
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C713B0(&UnityEngine_Object_TypeInfo);
    sub_1C713B0(&StringLiteral_19286/*"event_point_base"*/);
    byte_4CC8928 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(eventPointBgSprite, 0, 0) )
  {
    EventInfoUIBase__SetSpriteByLocalAtlas(
      ...
      (System_String_o *)StringLiteral_19286/*"event_point_base"*/,
      0);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C713B0(&UnityEngine_Object_TypeInfo);
    sub_1C713B0(&StringLiteral_19233/*"event_counter_base_first"*/);
    sub_1C713B0(&StringLiteral_19234/*"event_counter_base_max"*/);
    byte_4CC892A = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(happinessCounterBgSpriteFirst, 0, 0) )
  {
    ...
    if ( !UnityEngine_Object__op_Equality(happinessCounterBgSpriteMax, 0, 0) )
    {
      EventInfoUIBase__SetSpriteByLocalAtlas(
        ...
        (System_String_o *)StringLiteral_19233/*"event_counter_base_first"*/,
        0);
      EventInfoUIBase__SetSpriteByLocalAtlas(
        (EventInfoUIBase_o *)this,
        this->fields.happinessCounterBgSpriteMax,
        (System_String_o *)StringLiteral_19234/*"event_counter_base_max"*/,
        0);
