        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73E0A & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_1/*""*/, randomMissionEnt);
    byte_4A73E0A = 1;
  }
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.eventMissionEnt, (int32_t)missionData, v11, v12);
  if ( !missionData )
    goto LABEL_9;
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.condMsg, v18, v15, v16);
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.progTxt, v19, v20, v21);
  ...
  *(_QWORD *)&this->fields.progStatus = 0x400000000LL;
  ...
  {
LABEL_9:
    sub_1B9026C(eventMissionEnt, v14);
  }
...
LABEL_9:
    sub_1B9026C(eventRandomMissionEnt, sort);
  }
  return (unsigned __int8)eventRandomMissionEnt & 1;
}
