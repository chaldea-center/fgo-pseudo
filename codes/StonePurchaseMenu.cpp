...
void __fastcall StonePurchaseMenu__BackBuyBankItemConfirm(StonePurchaseMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B42728 & 1) == 0 )
  {
    sub_1BDB878(&StonePurchaseListViewManager_CallbackFunc_TypeInfo, method);
    sub_1BDB878(&Method_StonePurchaseMenu_OnSelectBuyItem__, v3);
    byte_4B42728 = 1;
  }
  ...
  if ( this->fields.state == 5 )
  {
    ...
    if ( !buyItemMask
      || (UnityEngine_GameObject__SetActive(buyItemMask, 0, 0LL),
          ...
          v7 = (StonePurchaseListViewManager_CallbackFunc_o *)sub_1BDBAC4(StonePurchaseListViewManager_CallbackFunc_TypeInfo),
          ...
          !ItemListViewManager) )
    {
      sub_1BDBAD4(buyItemMask, v4);
    }
    ItemListViewManager->fields.callbackFunc = v7;
    sub_1BDB81C((CGThumbnailListItem_o *)&ItemListViewManager->fields.callbackFunc, (int32_t)v7, v9, v10);
    StonePurchaseListViewManager__SetMode_37227744(ItemListViewManager, 1, v11);
    this->fields.state = 2;
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B42721 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_StonePurchaseMenu_OnMoveEnd__, v7);
    byte_4B42721 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4272C & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_StonePurchaseMenu___c__DisplayClass38_0__CloseStonePurchaseWarningDialog_b__0__, v6);
    sub_1BDB878(&StonePurchaseMenu___c__DisplayClass38_0_TypeInfo, v7);
    byte_4B4272C = 1;
  }
  v8 = sub_1BDBAC4(StonePurchaseMenu___c__DisplayClass38_0_TypeInfo);
...
void __fastcall StonePurchaseMenu__EndSpendLimit(StonePurchaseMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&StonePurchaseListViewManager_CallbackFunc_TypeInfo, method);
    sub_1BDB878(&Method_StonePurchaseMenu_OnSelectBuyItem__, v4);
    byte_4B42724 = 1;
  }
  spendLimitMenu = this->fields.spendLimitMenu;
  if ( !spendLimitMenu
    || (SpendLimitMenu__Close_37220152(spendLimitMenu, 0LL, v2),
        ItemListViewManager = this->fields.ItemListViewManager,
        v7 = (StonePurchaseListViewManager_CallbackFunc_o *)sub_1BDBAC4(StonePurchaseListViewManager_CallbackFunc_TypeInfo),
        StonePurchaseListViewManager_CallbackFunc___ctor(
          v7,
        ...
        !ItemListViewManager) )
  {
    sub_1BDBAD4(spendLimitMenu, method);
  }
  ItemListViewManager->fields.callbackFunc = v7;
  sub_1BDB81C((CGThumbnailListItem_o *)&ItemListViewManager->fields.callbackFunc, (int32_t)v7, v9, v10);
  StonePurchaseListViewManager__SetMode_37227744(ItemListViewManager, 1, v11);
...
void __fastcall StonePurchaseMenu__Init(StonePurchaseMenu_o *this, const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.refreshCallbackFunc, 0, v5, v6);
...
void __fastcall StonePurchaseMenu__OnClickBack(StonePurchaseMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B4272D & 1) == 0 )
  {
    sub_1BDB878(&Method_StonePurchaseMenu_OnClickBack__, method);
    byte_4B4272D = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_StonePurchaseMenu_OnClickBack__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BDB890(Method_StonePurchaseMenu_OnClickBack__);
...
void __fastcall StonePurchaseMenu__OnClickExplanation(StonePurchaseMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B4272E & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_StonePurchaseMenu_OnClickExplanation__, v5);
    sub_1BDB878(&Method_StonePurchaseMenu_OnEndWebView__, v6);
    sub_1BDB878(&WebViewManager_TypeInfo, v7);
    sub_1BDB878(&StringLiteral_15527/*"WEB_VIEW_TITLE_STONE_PURCHASE"*/, v8);
    byte_4B4272E = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_StonePurchaseMenu_OnClickExplanation__ + 83) & 2) != 0 )
      v9 = (_QWORD *)sub_1BDB890(Method_StonePurchaseMenu_OnClickExplanation__);
    ...
    WebViewAddress_40380348 = NetworkManager__getWebViewAddress_40380348(8, 0LL);
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v12 = LocalizationManager__Get((System_String_o *)StringLiteral_15527/*"WEB_VIEW_TITLE_STONE_PURCHASE"*/, 0LL);
    ...
    WebViewManager__OpenView(v12, WebViewAddress_40380348, v13, 0LL);
  }
}
...
void __fastcall StonePurchaseMenu__OnClickHistory(StonePurchaseMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B4272F & 1) == 0 )
  {
    sub_1BDB878(&Method_NetworkManager_getRequest_PaymentHistoryRequest___, method);
    sub_1BDB878(&NetworkManager_TypeInfo, v3);
    sub_1BDB878(&NetworkManager_ResultCallbackFunc_TypeInfo, v4);
    sub_1BDB878(&Method_StonePurchaseMenu_OnClickHistory__, v5);
    sub_1BDB878(&Method_StonePurchaseMenu__OnClickHistory_b__42_0__, v6);
    byte_4B4272F = 1;
  }
  v7 = Method_StonePurchaseMenu_OnClickHistory__;
  if ( (*((_BYTE *)Method_StonePurchaseMenu_OnClickHistory__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1BDB890(Method_StonePurchaseMenu_OnClickHistory__);
  ...
  Request_object = NetworkManager__getRequest_object_(
                     v9,
                     (const MethodInfo_30BC7D4 *)Method_NetworkManager_getRequest_PaymentHistoryRequest___);
  if ( !Request_object )
    sub_1BDBAD4(0LL, v11);
...
void __fastcall StonePurchaseMenu__OnMoveEnd(StonePurchaseMenu_o *this, const MethodInfo *method)
{
  ...
  if ( state <= 3 )
  {
    if ( state == 1 )
    {
      this->fields.state = 2;
      ItemListViewManager = this->fields.ItemListViewManager;
      v12 = (StonePurchaseListViewManager_CallbackFunc_o *)sub_1BDBAC4(StonePurchaseListViewManager_CallbackFunc_TypeInfo);
      StonePurchaseListViewManager_CallbackFunc___ctor(
        v12,
        (Il2CppObject *)this,
        (intptr_t)Method_StonePurchaseMenu_OnSelectBuyItem__,
      ...
      sub_1BDB81C((CGThumbnailListItem_o *)&ItemListViewManager->fields.callbackFunc, (int32_t)v12, v16, v17);
      StonePurchaseListViewManager__SetMode_37227744(ItemListViewManager, 1, v18);
    }
    else if ( state == 3 )
    {
      ...
      if ( closeCallbackFunc )
      {
        ...
        sub_1BDB81C(p_closeCallbackFunc, 0, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B42729 & 1) == 0 )
  {
    sub_1BDB878(&StonePurchaseListViewManager_CallbackFunc_TypeInfo, *(_QWORD *)&result);
    sub_1BDB878(&Method_StonePurchaseMenu_OnSelectBuyItem__, v5);
    byte_4B42729 = 1;
  }
  state = this->fields.state;
  if ( state == 9 )
  {
    ...
    {
      AgeVerificationMenu__Close_37216200(ageVerificationMenu, 0LL, method);
      if ( result < 1 )
      {
      ...
      ItemListViewManager = this->fields.ItemListViewManager;
      v10 = (StonePurchaseListViewManager_CallbackFunc_o *)sub_1BDBAC4(StonePurchaseListViewManager_CallbackFunc_TypeInfo);
      StonePurchaseListViewManager_CallbackFunc___ctor(
        v10,
        (Il2CppObject *)this,
        (intptr_t)Method_StonePurchaseMenu_OnSelectBuyItem__,
      ...
      if ( ItemListViewManager )
      {
        ...
        sub_1BDB81C((CGThumbnailListItem_o *)&ItemListViewManager->fields.callbackFunc, (int32_t)v10, v12, v13);
        StonePurchaseListViewManager__SetMode_37227744(ItemListViewManager, 1, v14);
        return;
      }
    }
    sub_1BDBAD4(ageVerificationMenu, *(_QWORD *)&result);
  }
  if ( state == 7 )
  {
    this->fields.state = 9;
...
void __fastcall StonePurchaseMenu__OnSelectBuyItem(StonePurchaseMenu_o *this, int32_t n, const MethodInfo *method)
{
  ...
  if ( (byte_4B4272B & 1) == 0 )
  {
    sub_1BDB878(&CommonConfirmDialog_ClickDelegate_TypeInfo, *(_QWORD *)&n);
    ...
    sub_1BDB878(&Method_StonePurchaseMenu_CloseStonePurchaseWarningDialog__, v8);
    sub_1BDB878(&Method_StonePurchaseMenu_OnSelectBuyItem__, v9);
    sub_1BDB878(&StringLiteral_12336/*"STONE_PURCHASE_CONFIRM_CANCEL"*/, v10);
    sub_1BDB878(&StringLiteral_12338/*"STONE_PURCHASE_CONFIRM_MESSAGE"*/, v11);
    sub_1BDB878(&StringLiteral_12337/*"STONE_PURCHASE_CONFIRM_DECIDE"*/, v12);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_StonePurchaseMenu_OnSelectBuyItem__ + 83) & 2) != 0 )
      v14 = (_QWORD *)sub_1BDB890(Method_StonePurchaseMenu_OnSelectBuyItem__);
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v21 = LocalizationManager__Get((System_String_o *)StringLiteral_12338/*"STONE_PURCHASE_CONFIRM_MESSAGE"*/, 0LL);
    v35 = chargeStone;
    ...
    v30 = System_String__Format_62613552(v21, v25, v29, 0LL);
    v31 = LocalizationManager__Get((System_String_o *)StringLiteral_12337/*"STONE_PURCHASE_CONFIRM_DECIDE"*/, 0LL);
    v32 = LocalizationManager__Get((System_String_o *)StringLiteral_12336/*"STONE_PURCHASE_CONFIRM_CANCEL"*/, 0LL);
    v33 = (CommonConfirmDialog_ClickDelegate_o *)sub_1BDBAC4(CommonConfirmDialog_ClickDelegate_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B42720 & 1) == 0 )
  {
    ...
    sub_1BDB878(&AgeVerificationMenu_TypeInfo, v8);
    sub_1BDB878(&AgeVerificationMenu_CallbackFunc_TypeInfo, v9);
    sub_1BDB878(&StonePurchaseListViewManager_CallbackFunc_TypeInfo, v10);
    sub_1BDB878(&LocalizationManager_TypeInfo, v11);
    sub_1BDB878(&PurchaseBehaviour_TypeInfo, v12);
    sub_1BDB878(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v13);
    sub_1BDB878(&Method_StonePurchaseMenu_OnMoveEnd__, v14);
    sub_1BDB878(&Method_StonePurchaseMenu_OnSelectAgeVerification__, v15);
    sub_1BDB878(&Method_StonePurchaseMenu_OnSelectBuyItem__, v16);
    sub_1BDB878(&Method_StonePurchaseMenu__Open_b__21_0__, v17);
    byte_4B42720 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( gameObject )
    {
      ...
      sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.refreshCallbackFunc, (int32_t)refreshCallback, v22, v23);
          ...
          if ( stoneDataLabel )
          {
            ...
            if ( gameObject )
            {
              ...
              if ( AgeVerificationMenu__IsConcent((const MethodInfo *)v29) )
              {
                this->fields.state = 2;
                ItemListViewManager = this->fields.ItemListViewManager;
                v31 = (StonePurchaseListViewManager_CallbackFunc_o *)sub_1BDBAC4(StonePurchaseListViewManager_CallbackFunc_TypeInfo);
                StonePurchaseListViewManager_CallbackFunc___ctor(
                  v31,
                  (Il2CppObject *)this,
                  (intptr_t)Method_StonePurchaseMenu_OnSelectBuyItem__,
                ...
                sub_1BDB81C((CGThumbnailListItem_o *)&ItemListViewManager->fields.callbackFunc, (int32_t)v31, v33, v34);
                StonePurchaseListViewManager__SetMode_37227744(ItemListViewManager, 1, v35);
              }
              else
              {
                this->fields.state = 7;
                ageVerificationMenu = this->fields.ageVerificationMenu;
                v37 = (AgeVerificationMenu_CallbackFunc_o *)sub_1BDBAC4(AgeVerificationMenu_CallbackFunc_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B42727 & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Collections_Generic_List_string__Contains__, *(_QWORD *)&shopId);
    sub_1BDB878(&Method_NetworkManager_getRequest_CancelPurchaseByBankRequest___, v5);
    ...
    sub_1BDB878(&Method_StonePurchaseMenu___c__DisplayClass29_0__RequestCancelPurchaseByBank_b__0__, v9);
    sub_1BDB878(&StonePurchaseMenu___c__DisplayClass29_0_TypeInfo, v10);
    byte_4B42727 = 1;
  }
  v11 = sub_1BDBAC4(StonePurchaseMenu___c__DisplayClass29_0_TypeInfo);
...
LABEL_13:
    sub_1BDBAD4(Request_object, v13);
  }
...
void __fastcall StonePurchaseMenu__SelectBuyBankItemConfirm(StonePurchaseMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B42723 & 1) == 0 )
  {
    ...
    sub_1BDB878(&PurchaseLogic_ProductFinishedAction_TypeInfo, v6);
    sub_1BDB878(&PurchaseBehaviour_TypeInfo, v7);
    sub_1BDB878(&Method_StonePurchaseMenu_SelectedBuyBankItemConfirm___77181944, v8);
    byte_4B42723 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( PurchaseBehaviour__IsPurchasingFrameworkAvailable(0LL) )
    {
      ...
      if ( ((unsigned __int8)ItemListViewManager & 1) != 0 )
      {
        if ( Item )
        {
          ...
          v14 = (PurchaseLogic_ProductFinishedAction_o *)sub_1BDBAC4(PurchaseLogic_ProductFinishedAction_TypeInfo);
          PurchaseLogic_ProductFinishedAction___ctor(
            v14,
            (Il2CppObject *)this,
            (intptr_t)Method_StonePurchaseMenu_SelectedBuyBankItemConfirm___77181944,
            0LL);
          if ( Instance )
          {
...
LABEL_22:
        sub_1BDBAD4(ItemListViewManager, method);
      }
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B42725 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_StonePurchaseMenu_BackBuyBankItemConfirm__, v15);
    sub_1BDB878(&Method_StonePurchaseMenu_EndBuyBankItemNotificationSuccess__, v16);
    sub_1BDB878(&Method_StonePurchaseMenu_SelectedBuyBankItemConfirm___77181944, v17);
    sub_1BDB878(&Method_StonePurchaseMenu___c__DisplayClass27_0__SelectedBuyBankItemConfirm_b__0__, v18);
    sub_1BDB878(&Method_StonePurchaseMenu___c__DisplayClass27_0__SelectedBuyBankItemConfirm_b__1__, v19);
    sub_1BDB878(&Method_StonePurchaseMenu___c__DisplayClass27_0__SelectedBuyBankItemConfirm_b__2__, v20);
    sub_1BDB878(&Method_StonePurchaseMenu___c__DisplayClass27_0__SelectedBuyBankItemConfirm_b__3__, v21);
    sub_1BDB878(&Method_StonePurchaseMenu___c__DisplayClass27_0__SelectedBuyBankItemConfirm_b__4__, v22);
    sub_1BDB878(&Method_StonePurchaseMenu___c__DisplayClass27_0__SelectedBuyBankItemConfirm_b__5__, v23);
    sub_1BDB878(&Method_StonePurchaseMenu___c__DisplayClass27_0__SelectedBuyBankItemConfirm_b__6__, v24);
    sub_1BDB878(&Method_StonePurchaseMenu___c__DisplayClass27_0__SelectedBuyBankItemConfirm_b__7__, v25);
    sub_1BDB878(&Method_StonePurchaseMenu___c__DisplayClass27_0__SelectedBuyBankItemConfirm_b__8__, v26);
    sub_1BDB878(&StonePurchaseMenu___c__DisplayClass27_0_TypeInfo, v27);
    byte_4B42725 = 1;
  }
  v28 = sub_1BDBAC4(StonePurchaseMenu___c__DisplayClass27_0_TypeInfo);
...
LABEL_41:
  ...
  *(_DWORD *)(v28 + 28) = perMonthAmount;
  ...
  {
    case 2:
      v42 = Method_StonePurchaseMenu_SelectedBuyBankItemConfirm___77181944;
      if ( (*((_BYTE *)Method_StonePurchaseMenu_SelectedBuyBankItemConfirm___77181944 + 83) & 2) != 0 )
        v42 = (_QWORD *)sub_1BDB890(Method_StonePurchaseMenu_SelectedBuyBankItemConfirm___77181944);
    ...
    case 4:
      break;
    case 5:
      v48 = Method_StonePurchaseMenu_SelectedBuyBankItemConfirm___77181944;
      if ( (*((_BYTE *)Method_StonePurchaseMenu_SelectedBuyBankItemConfirm___77181944 + 83) & 2) != 0 )
        v48 = (_QWORD *)sub_1BDB890(Method_StonePurchaseMenu_SelectedBuyBankItemConfirm___77181944);
      ...
      goto LABEL_36;
    case 6:
      v50 = Method_StonePurchaseMenu_SelectedBuyBankItemConfirm___77181944;
      if ( (*((_BYTE *)Method_StonePurchaseMenu_SelectedBuyBankItemConfirm___77181944 + 83) & 2) != 0 )
        v50 = (_QWORD *)sub_1BDB890(Method_StonePurchaseMenu_SelectedBuyBankItemConfirm___77181944);
      ...
      goto LABEL_36;
    case 8:
      v52 = Method_StonePurchaseMenu_SelectedBuyBankItemConfirm___77181944;
      if ( (*((_BYTE *)Method_StonePurchaseMenu_SelectedBuyBankItemConfirm___77181944 + 83) & 2) != 0 )
        v52 = (_QWORD *)sub_1BDB890(Method_StonePurchaseMenu_SelectedBuyBankItemConfirm___77181944);
    ...
    case 11:
    case 12:
      v37 = Method_StonePurchaseMenu_SelectedBuyBankItemConfirm___77181944;
      if ( (*((_BYTE *)Method_StonePurchaseMenu_SelectedBuyBankItemConfirm___77181944 + 83) & 2) != 0 )
        v37 = (_QWORD *)sub_1BDB890(Method_StonePurchaseMenu_SelectedBuyBankItemConfirm___77181944);
      ...
      goto LABEL_36;
    case 13:
      v56 = Method_StonePurchaseMenu_SelectedBuyBankItemConfirm___77181944;
      if ( (*((_BYTE *)Method_StonePurchaseMenu_SelectedBuyBankItemConfirm___77181944 + 83) & 2) != 0 )
        v56 = (_QWORD *)sub_1BDB890(Method_StonePurchaseMenu_SelectedBuyBankItemConfirm___77181944);
      ...
      goto LABEL_36;
    case 14:
      v58 = Method_StonePurchaseMenu_SelectedBuyBankItemConfirm___77181944;
      if ( (*((_BYTE *)Method_StonePurchaseMenu_SelectedBuyBankItemConfirm___77181944 + 83) & 2) != 0 )
        v58 = (_QWORD *)sub_1BDB890(Method_StonePurchaseMenu_SelectedBuyBankItemConfirm___77181944);
      ...
      goto LABEL_36;
    case 15:
      v60 = Method_StonePurchaseMenu_SelectedBuyBankItemConfirm___77181944;
      if ( (*((_BYTE *)Method_StonePurchaseMenu_SelectedBuyBankItemConfirm___77181944 + 83) & 2) != 0 )
        v60 = (_QWORD *)sub_1BDB890(Method_StonePurchaseMenu_SelectedBuyBankItemConfirm___77181944);
    ...
    case 17:
      ...
      goto LABEL_37;
    default:
      v46 = Method_StonePurchaseMenu_SelectedBuyBankItemConfirm___77181944;
      if ( (*((_BYTE *)Method_StonePurchaseMenu_SelectedBuyBankItemConfirm___77181944 + 83) & 2) != 0 )
        v46 = (_QWORD *)sub_1BDB890(Method_StonePurchaseMenu_SelectedBuyBankItemConfirm___77181944);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall StonePurchaseMenu__SelectedBuyBankItemConfirm_37238444(
        StonePurchaseMenu_o *this,
        int32_t result,
        int32_t perMonthAmount,
        const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&System_Action_TypeInfo, *(_QWORD *)&result);
    sub_1BDB878(&SpendLimitMenu_CallbackFunc_TypeInfo, v7);
    sub_1BDB878(&ErrorDialog_ClickDelegate_TypeInfo, v8);
    sub_1BDB878(&LocalizationManager_TypeInfo, v9);
    sub_1BDB878(&Method_StonePurchaseMenu_EndBuyBankItemNotificationCancel__, v10);
    sub_1BDB878(&Method_StonePurchaseMenu_EndBuyBankItemNotificationSuccess__, v11);
    sub_1BDB878(&Method_StonePurchaseMenu_EndBuyBankItemNotificationSuspend__, v12);
    sub_1BDB878(&Method_StonePurchaseMenu_EndBuyBankItemNotificationWait__, v13);
    sub_1BDB878(&Method_StonePurchaseMenu_EndSpendLimit__, v14);
    sub_1BDB878(&Method_StonePurchaseMenu_SelectedBuyBankItemConfirm__, v15);
    sub_1BDB878(&StringLiteral_12349/*"STONE_PURCHASE_RESULT_WAIT"*/, v16);
    byte_4B42726 = 1;
  }
  ...
  switch ( result )
  {
    case 2:
      ...
      if ( (*((_BYTE *)Method_StonePurchaseMenu_SelectedBuyBankItemConfirm__ + 83) & 2) != 0 )
        v18 = (_QWORD *)sub_1BDB890(Method_StonePurchaseMenu_SelectedBuyBankItemConfirm__);
    ...
    case 3:
      ...
      if ( (*((_BYTE *)Method_StonePurchaseMenu_SelectedBuyBankItemConfirm__ + 83) & 2) != 0 )
        v32 = (_QWORD *)sub_1BDB890(Method_StonePurchaseMenu_SelectedBuyBankItemConfirm__);
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v35 = LocalizationManager__Get((System_String_o *)StringLiteral_12349/*"STONE_PURCHASE_RESULT_WAIT"*/, 0LL);
      v36 = (ErrorDialog_ClickDelegate_o *)sub_1BDBAC4(ErrorDialog_ClickDelegate_TypeInfo);
      ...
      *(_QWORD *)&v51.fields.hasValue = 0LL;
      ...
      ErrorDialog__Open_41383240(warningDialog, 0LL, v35, v36, 1, -1.0, 1, v51, 0LL);
      goto LABEL_32;
    case 4:
      v37 = Method_StonePurchaseMenu_SelectedBuyBankItemConfirm__;
      if ( (*((_BYTE *)Method_StonePurchaseMenu_SelectedBuyBankItemConfirm__ + 83) & 2) != 0 )
        v37 = (_QWORD *)sub_1BDB890(Method_StonePurchaseMenu_SelectedBuyBankItemConfirm__);
      v38 = (System_Reflection_MethodBase_o *)sub_1BDB85C(v37, v37[4]);
    ...
    case 6:
      ...
      if ( (*((_BYTE *)Method_StonePurchaseMenu_SelectedBuyBankItemConfirm__ + 83) & 2) != 0 )
        v44 = (_QWORD *)sub_1BDB890(Method_StonePurchaseMenu_SelectedBuyBankItemConfirm__);
    ...
    case 8:
      this->fields.state = 10;
      spendLimitMenu = this->fields.spendLimitMenu;
      v47 = (SpendLimitMenu_CallbackFunc_o *)sub_1BDBAC4(SpendLimitMenu_CallbackFunc_TypeInfo);
    ...
    default:
      ...
      if ( (*((_BYTE *)Method_StonePurchaseMenu_SelectedBuyBankItemConfirm__ + 83) & 2) != 0 )
        v41 = (_QWORD *)sub_1BDB890(Method_StonePurchaseMenu_SelectedBuyBankItemConfirm__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4271D & 1) == 0 )
  {
    sub_1BDB878(&StonePurchaseMenu_CallbackFunc_TypeInfo, value);
    byte_4B4271D = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A2407C;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A24034;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B42D9F & 1) == 0 )
  {
    sub_1BDB878(&StonePurchaseMenu_Result_TypeInfo, *(_QWORD *)&result);
    byte_4B42D9F = 1;
  }
  v9[1] = 0LL;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&System_Action_TypeInfo, method);
    this = (StonePurchaseMenu___c__DisplayClass27_0_o *)sub_1BDB878(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B42DA1 & 1) == 0 )
  {
    ...
    sub_1BDB878(&LocalizationManager_TypeInfo, v3);
    sub_1BDB878(&Method_StonePurchaseMenu_EndBuyBankItemNotificationWait__, v4);
    this = (StonePurchaseMenu___c__DisplayClass27_0_o *)sub_1BDB878(&StringLiteral_12349/*"STONE_PURCHASE_RESULT_WAIT"*/, v5);
    byte_4B42DA1 = 1;
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v8 = LocalizationManager__Get((System_String_o *)StringLiteral_12349/*"STONE_PURCHASE_RESULT_WAIT"*/, 0LL);
  v9 = (Il2CppObject *)v2->fields.__4__this;
  v10 = v8;
  v11 = (ErrorDialog_ClickDelegate_o *)sub_1BDBAC4(ErrorDialog_ClickDelegate_TypeInfo);
...
LABEL_8:
  ...
  *(_QWORD *)&v12.fields.hasValue = 0LL;
  ...
  ErrorDialog__Open_41383240(warningDialog, 0LL, v10, v11, 1, -1.0, 1, v12, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B42DA4 & 1) == 0 )
  {
    sub_1BDB878(&SpendLimitMenu_CallbackFunc_TypeInfo, method);
    this = (StonePurchaseMenu___c__DisplayClass27_0_o *)sub_1BDB878(&Method_StonePurchaseMenu_EndSpendLimit__, v3);
    byte_4B42DA4 = 1;
  }
  _4__this = (Il2CppObject *)v2->fields.__4__this;
  if ( !_4__this
    || (klass = (SpendLimitMenu_o *)_4__this[9].klass,
        ...
        v7 = (SpendLimitMenu_CallbackFunc_o *)sub_1BDBAC4(SpendLimitMenu_CallbackFunc_TypeInfo),
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&StonePurchaseListViewManager_CallbackFunc_TypeInfo, method);
    this = (StonePurchaseMenu___c__DisplayClass38_0_o *)sub_1BDB878(&Method_StonePurchaseMenu_OnSelectBuyItem__, v3);
    byte_4B42DA9 = 1;
  }
  _4__this = v2->fields.__4__this;
  if ( !_4__this )
  ...
  v6 = (StonePurchaseListViewManager_CallbackFunc_o *)sub_1BDBAC4(StonePurchaseListViewManager_CallbackFunc_TypeInfo);
  StonePurchaseListViewManager_CallbackFunc___ctor(
    v6,
