void __fastcall ScriptSelectDialog___ctor(ScriptSelectDialog_o *this, const MethodInfo *method)
{
  ...
  v3 = sub_1C21EE0(UnityEngine_Vector3___TypeInfo, 6LL);
  v11 = v3;
  if ( !byte_4BD6BB1 )
  {
    v3 = sub_1C21E38(&UnityEngine_Vector3_TypeInfo);
    byte_4BD6BB1 = 1;
  }
  if ( !v11 )
    goto LABEL_21;
...
LABEL_20:
  ...
  *(_DWORD *)(v11 + 100) = 0;
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.BASE_VIEW_POSITIONS, v11, v5, v6, v7, v8, v9, v10);
  v3 = sub_1C21EE0(UnityEngine_Vector2___TypeInfo, 6LL);
  if ( !v3 )
LABEL_21:
    sub_1C22094(v3, v4);
  v27 = *(_DWORD *)(v3 + 24);
  ...
  *(_QWORD *)(v3 + 72) = 0xC29A000000000000LL;
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.LIST_VIEW_ITEM_SEED_PITCH, v3, v21, v22, v23, v24, v25, v26);
  ...
  if ( this->fields.isOpen )
  {
    ...
    if ( !listViewManager
      || (listViewManager->fields.clickFunc = 0LL,
          sub_1C21DDC((PartyOrganizationUtility_o *)&listViewManager->fields.clickFunc, 0LL, v2, v3, v4, v5, v6, v7),
    ...
    sub_1C21DDC((PartyOrganizationUtility_o *)&v9->fields.callbackFunc, 0LL, v10, v11, v12, v13, v14, v15);
    ...
    if ( limitTimeLoopSe )
    {
      if ( !v16->fields.isStop )
      {
        ...
        sub_1C21DDC(p_limitTimeLoopSe, 0LL, v19, v20, v21, v22, v23, v24);
      }
    }
  }
}
...
void __fastcall ScriptSelectDialog__InitLimitTimeUI(ScriptSelectDialog_o *this, const MethodInfo *method)
{
  ...
  v5 = (struct System_Single_array *)sub_1C21EE0(float___TypeInfo, 2LL);
  this->fields.changeGaugeTimes = v5;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.changeGaugeTimes, (int64_t)v5, v6, v7, v8, v9, v10, v11);
...
LABEL_22:
  ...
  if ( v17 < 1.0 )
    v16 = 1.0;
  changeGaugeTimes->m_Items[2] = v16;
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_13:
    sub_1C22094(this, itemCount);
  }
  if ( v5 >= v7->max_length )
LABEL_14:
    sub_1C2209C(this, itemCount);
...
void __fastcall ScriptSelectDialog__OnClickSelect(ScriptSelectDialog_o *this, int32_t index, const MethodInfo *method)
{
  ...
  if ( this->fields.limitTimeMode )
  {
    ...
    sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.limitTimeLoopSe, 0LL, v6, v7, v8, v9, v10, v11);
  }
  callbackFunc = this->fields.callbackFunc;
  if ( callbackFunc )
    ((void (__fastcall *)(struct System_Reflection_MethodInfo_o *, _QWORD, _QWORD))callbackFunc->fields.m_target)(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDE27E & 1) == 0 )
  {
    sub_1C21E38(&ScriptSelectListViewManager_ClickDelegate_TypeInfo);
    sub_1C21E38(&Method_ScriptSelectDialog_OnClickSelect__);
    byte_4BDE27E = 1;
  }
  ...
  if ( !selectMessageList
    || (ScriptSelectDialog__InitListViewManagerUI(this, selectMessageList->max_length, v16),
        listViewManager = this->fields.listViewManager,
        v18 = (ScriptSelectListViewManager_ClickDelegate_o *)sub_1C22084(ScriptSelectListViewManager_ClickDelegate_TypeInfo),
  ...
  {
LABEL_8:
    sub_1C22094(rootObject, selectMessageList);
  }
  ScriptSelectListViewManager__SetMode((ScriptSelectListViewManager_o *)rootObject, 2, 0, 0LL, v21);
  this->fields.limitTimeMode = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( !selectMessageList
    || (ScriptSelectDialog__InitListViewManagerUI(this, selectMessageList->max_length, v18),
        listViewManager = this->fields.listViewManager,
        v20 = (ScriptSelectListViewManager_ClickDelegate_o *)sub_1C22084(ScriptSelectListViewManager_ClickDelegate_TypeInfo),
        ScriptSelectListViewManager_ClickDelegate___ctor(
          v20,
          (Il2CppObject *)this,
          Method_ScriptSelectDialog_OnClickSelect__,
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C21E38(&ScriptSelectListViewManager_ClickDelegate_TypeInfo);
    sub_1C21E38(&Method_System_Linq_Enumerable_Take_string___);
    sub_1C21E38(&Method_System_Linq_Enumerable_ToArray_string___);
    sub_1C21E38(&Method_ScriptSelectDialog_OnClickSelect__);
    sub_1C21E38(&Method_ScriptSelectDialog_OpenLimitTime__);
    byte_4BDE280 = 1;
  }
  rootObject = this->fields.rootObject;
  if ( !rootObject )
  ...
  this->fields.callbackFunc = callback;
  this->fields.isOpen = 1;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.callbackFunc, (int64_t)callback, v14, v15, v16, v17, v18, v19);
  if ( !selectMessageList )
    goto LABEL_11;
  v20 = System_Linq_Enumerable__Take_object_(
          ...
          (const MethodInfo_2FE8598 *)Method_System_Linq_Enumerable_Take_string___);
  ...
  if ( !rootObject
    || (v22 = (System_String_array *)rootObject,
        ...
        listViewManager = this->fields.listViewManager,
        v24 = (ScriptSelectListViewManager_ClickDelegate_o *)sub_1C22084(ScriptSelectListViewManager_ClickDelegate_TypeInfo),
        ScriptSelectListViewManager_ClickDelegate___ctor(
          v24,
          (Il2CppObject *)this,
          Method_ScriptSelectDialog_OnClickSelect__,
...
LABEL_11:
  ...
  if ( (*((_BYTE *)Method_ScriptSelectDialog_OpenLimitTime__ + 83) & 2) != 0 )
    v30 = (_QWORD *)sub_1C21E50(Method_ScriptSelectDialog_OpenLimitTime__);
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.limitTimeLoopSe, (int64_t)v32, v33, v34, v35, v36, v37, v38);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDE281 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_UnityEngine_GameObject_GetComponent_TweenAlpha___);
    sub_1C21E38(&Method_ScriptSelectDialog_EndSelectDecide__);
    byte_4BDE281 = 1;
  }
...
LABEL_10:
    sub_1C22094(rootLimitTimeObject, v14);
  }
}
...
void __fastcall ScriptSelectDialog__UpdateLimitTimeUI(ScriptSelectDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDE283 & 1) == 0 )
  {
    sub_1C21E38(&StringLiteral_20851/*"img_timer_meter_yellow"*/);
    sub_1C21E38(&StringLiteral_20849/*"img_timer_meter_blue"*/);
    this = (ScriptSelectDialog_o *)sub_1C21E38(&StringLiteral_20850/*"img_timer_meter_red"*/);
    byte_4BDE283 = 1;
  }
...
LABEL_23:
  ...
  if ( limitTimeSeconds > changeGaugeTimes->m_Items[1] )
  {
    if ( max_length > 1 )
    {
      ...
      v7 = (System_String_o **)&StringLiteral_20851/*"img_timer_meter_yellow"*/;
      if ( limitTimeSeconds > v6 )
        v7 = (System_String_o **)&StringLiteral_20849/*"img_timer_meter_blue"*/;
      goto LABEL_13;
    }
LABEL_24:
  ...
  if ( !this )
    goto LABEL_23;
  v7 = (System_String_o **)&StringLiteral_20850/*"img_timer_meter_red"*/;
LABEL_13:
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A64B10;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A64AC8;
}
