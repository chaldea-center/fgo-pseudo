void ScriptSelectDialog___ctor(ScriptSelectDialog_o *this, const MethodInfo *method)
{
  ...
  v3 = sub_1C6BAB0(UnityEngine_Vector3___TypeInfo, 6);
  v7 = v3;
  if ( !byte_4CAFC09 )
  {
...
LABEL_20:
  ...
  *(_DWORD *)(v7 + 100) = 0;
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.BASE_VIEW_POSITIONS, v7, v5, v6);
  v3 = sub_1C6BAB0(UnityEngine_Vector2___TypeInfo, 6);
  if ( !v3 )
LABEL_21:
    sub_1C6BC60(v3, v4);
  v19 = *(_DWORD *)(v3 + 24);
  ...
  *(_QWORD *)(v3 + 72) = 0xC29A000000000000LL;
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.LIST_VIEW_ITEM_SEED_PITCH, v3, v17, v18);
...
void ScriptSelectDialog__Close(ScriptSelectDialog_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.isOpen )
  {
    ...
    sub_1C6B9AC((CGThumbnailListItem_o *)&v5->fields.callbackFunc, 0, v6, v7);
    ...
    if ( limitTimeLoopSe )
    {
      if ( !v8->fields.isStop )
      {
        ...
        sub_1C6B9AC(p_limitTimeLoopSe, 0, v11, v12);
      }
    }
  }
}
...
void ScriptSelectDialog__InitLimitTimeUI(ScriptSelectDialog_o *this, const MethodInfo *method)
{
  ...
  v5 = (struct System_Single_array *)sub_1C6BAB0(float___TypeInfo, 2);
  this->fields.changeGaugeTimes = v5;
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.changeGaugeTimes, (int32_t)v5, v6, v7);
...
void ScriptSelectDialog__OnClickSelect(ScriptSelectDialog_o *this, int32_t index, const MethodInfo *method)
{
  ...
  if ( this->fields.limitTimeMode )
  {
    ...
    sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.limitTimeLoopSe, 0, v6, v7);
  }
  callbackFunc = this->fields.callbackFunc;
  if ( callbackFunc )
    ((void (__fastcall *)(intptr_t, _QWORD, intptr_t))callbackFunc->fields.invoke_impl)(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB8323 & 1) == 0 )
  {
    sub_1C6BA08(&ScriptSelectListViewManager_ClickDelegate_TypeInfo);
    sub_1C6BA08(&Method_ScriptSelectDialog_OnClickSelect__);
    byte_4CB8323 = 1;
  }
  ...
  if ( !selectMessageList
    || (ScriptSelectDialog__InitListViewManagerUI(this, selectMessageList->max_length, v12),
        listViewManager = this->fields.listViewManager,
        v14 = (ScriptSelectListViewManager_ClickDelegate_o *)sub_1C6BC54(ScriptSelectListViewManager_ClickDelegate_TypeInfo),
  ...
  {
LABEL_8:
    sub_1C6BC60(rootObject, selectMessageList);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !selectMessageList
    || (ScriptSelectDialog__InitListViewManagerUI(this, selectMessageList->max_length, v14),
        listViewManager = this->fields.listViewManager,
        v16 = (ScriptSelectListViewManager_ClickDelegate_o *)sub_1C6BC54(ScriptSelectListViewManager_ClickDelegate_TypeInfo),
        ScriptSelectListViewManager_ClickDelegate___ctor(
          v16,
          (Il2CppObject *)this,
          Method_ScriptSelectDialog_OnClickSelect__,
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C6BA08(&ScriptSelectListViewManager_ClickDelegate_TypeInfo);
    sub_1C6BA08(&Method_System_Linq_Enumerable_Take_string___);
    sub_1C6BA08(&Method_System_Linq_Enumerable_ToArray_string___);
    sub_1C6BA08(&Method_ScriptSelectDialog_OnClickSelect__);
    sub_1C6BA08(&Method_ScriptSelectDialog_OpenLimitTime__);
    byte_4CB8325 = 1;
  }
  rootObject = this->fields.rootObject;
  if ( !rootObject )
  ...
  this->fields.callbackFunc = callback;
  this->fields.isOpen = 1;
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.callbackFunc, (int32_t)callback, v14, v15);
  if ( !selectMessageList )
    goto LABEL_11;
  v16 = System_Linq_Enumerable__Take_object_(
          ...
          (const MethodInfo_3179B34 *)Method_System_Linq_Enumerable_Take_string___);
  ...
  if ( !rootObject
    || (v18 = (System_String_array *)rootObject,
        ...
        listViewManager = this->fields.listViewManager,
        v20 = (ScriptSelectListViewManager_ClickDelegate_o *)sub_1C6BC54(ScriptSelectListViewManager_ClickDelegate_TypeInfo),
        ScriptSelectListViewManager_ClickDelegate___ctor(
          v20,
          (Il2CppObject *)this,
          Method_ScriptSelectDialog_OnClickSelect__,
...
LABEL_11:
  ...
  if ( (*((_BYTE *)Method_ScriptSelectDialog_OpenLimitTime__ + 83) & 2) != 0 )
    v26 = (_QWORD *)sub_1C6BA20(Method_ScriptSelectDialog_OpenLimitTime__);
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.limitTimeLoopSe, (int32_t)v28, v29, v30);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB8326 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_UnityEngine_GameObject_GetComponent_TweenAlpha___);
    sub_1C6BA08(&Method_ScriptSelectDialog_EndSelectDecide__);
    byte_4CB8326 = 1;
  }
...
LABEL_10:
    sub_1C6BC60(rootLimitTimeObject, v10);
  }
}
...
void ScriptSelectDialog__UpdateLimitTimeUI(ScriptSelectDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB8328 & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_20664/*"img_timer_meter_yellow"*/);
    sub_1C6BA08(&StringLiteral_20662/*"img_timer_meter_blue"*/);
    this = (ScriptSelectDialog_o *)sub_1C6BA08(&StringLiteral_20663/*"img_timer_meter_red"*/);
    byte_4CB8328 = 1;
  }
...
LABEL_23:
  ...
  if ( limitTimeSeconds > changeGaugeTimes->m_Items[0] )
  {
    if ( max_length > 1 )
    {
      ...
      v7 = (System_String_o **)&StringLiteral_20664/*"img_timer_meter_yellow"*/;
      if ( limitTimeSeconds > v6 )
        v7 = (System_String_o **)&StringLiteral_20662/*"img_timer_meter_blue"*/;
      goto LABEL_13;
    }
LABEL_24:
    sub_1C6BC68(this);
  ...
  if ( !this )
    goto LABEL_23;
  v7 = (System_String_o **)&StringLiteral_20663/*"img_timer_meter_red"*/;
LABEL_13:
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1AA3C88;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1AA3C40;
}
