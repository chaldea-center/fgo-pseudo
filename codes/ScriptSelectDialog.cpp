void ScriptSelectDialog___ctor(ScriptSelectDialog_o *this, const MethodInfo *method)
{
  ...
  v3 = sub_2213B20(UnityEngine_Vector3___TypeInfo, 6);
  v11 = v3;
  if ( !byte_5969AE0 )
  {
...
LABEL_20:
  ...
  *(_DWORD *)(v11 + 100) = 0;
  ...
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields.BASE_VIEW_POSITIONS, v11, v5, v6, v7, v8, v9, v10);
  v3 = sub_2213B20(UnityEngine_Vector2___TypeInfo, 6);
  if ( !v3 )
LABEL_21:
    sub_2213CDC(v3, v4);
  v27 = *(_DWORD *)(v3 + 24);
...
void ScriptSelectDialog__Close(ScriptSelectDialog_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.isOpen )
  {
    ...
    sub_2213A04((MissionNaviTransitionBoardItem_o *)&v9->fields.callbackFunc, 0, v10, v11, v12, v13, v14, v15);
    ...
    if ( limitTimeLoopSe )
    {
      if ( !v16->fields.isStop )
      {
        ...
        sub_2213A04(p_limitTimeLoopSe, 0, v19, v20, v21, v22, v23, v24);
      }
    }
  }
}
...
void ScriptSelectDialog__InitLimitTimeUI(ScriptSelectDialog_o *this, const MethodInfo *method)
{
  ...
  v5 = (struct System_Single_array *)sub_2213B20(float___TypeInfo, 2);
  this->fields.changeGaugeTimes = v5;
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields.changeGaugeTimes, (int32_t)v5, v6, v7, v8, v9, v10, v11);
...
void ScriptSelectDialog__InitListViewManagerUI(ScriptSelectDialog_o *this, int32_t itemCount, const MethodInfo *method)
{
  ...
  {
LABEL_13:
    sub_2213CDC(this, *(_QWORD *)&itemCount);
  }
...
void ScriptSelectDialog__OnClickSelect(ScriptSelectDialog_o *this, int32_t index, const MethodInfo *method)
{
  ...
  if ( this->fields.limitTimeMode )
  {
    ...
    sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields.limitTimeLoopSe, 0, v6, v7, v8, v9, v10, v11);
  }
  callbackFunc = this->fields.callbackFunc;
  if ( callbackFunc )
    ((void (__fastcall *)(intptr_t, _QWORD, intptr_t))callbackFunc->fields.invoke_impl)(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_59728F7 & 1) == 0 )
  {
    sub_2213A60(&ScriptSelectListViewManager_ClickDelegate_TypeInfo);
    sub_2213A60(&Method_ScriptSelectDialog_OnClickSelect__);
    byte_59728F7 = 1;
  }
  ...
  if ( !selectMessageList
    || (ScriptSelectDialog__InitListViewManagerUI(this, selectMessageList->max_length, v16),
        listViewManager = this->fields.listViewManager,
        v18 = (ScriptSelectListViewManager_ClickDelegate_o *)sub_2213CCC(ScriptSelectListViewManager_ClickDelegate_TypeInfo),
  ...
  {
LABEL_8:
    sub_2213CDC(rootObject, selectMessageList);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !selectMessageList
    || (ScriptSelectDialog__InitListViewManagerUI(this, selectMessageList->max_length, v18),
        listViewManager = this->fields.listViewManager,
        v20 = (ScriptSelectListViewManager_ClickDelegate_o *)sub_2213CCC(ScriptSelectListViewManager_ClickDelegate_TypeInfo),
        ScriptSelectListViewManager_ClickDelegate___ctor(
          v20,
          (Il2CppObject *)this,
          Method_ScriptSelectDialog_OnClickSelect__,
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_2213A60(&ScriptSelectListViewManager_ClickDelegate_TypeInfo);
    sub_2213A60(&Method_System_Linq_Enumerable_Take_string___);
    sub_2213A60(&Method_System_Linq_Enumerable_ToArray_string___);
    sub_2213A60(&Method_ScriptSelectDialog_OnClickSelect__);
    sub_2213A60(&Method_ScriptSelectDialog_OpenLimitTime__);
    byte_59728F9 = 1;
  }
  rootObject = this->fields.rootObject;
  if ( !rootObject )
  ...
  v20 = System_Linq_Enumerable__Take_object_(
          ...
          (const MethodInfo_389A270 *)Method_System_Linq_Enumerable_Take_string___);
  ...
  if ( !rootObject
    || (v22 = (System_String_array *)rootObject,
        ...
        listViewManager = this->fields.listViewManager,
        v24 = (ScriptSelectListViewManager_ClickDelegate_o *)sub_2213CCC(ScriptSelectListViewManager_ClickDelegate_TypeInfo),
        ScriptSelectListViewManager_ClickDelegate___ctor(
          v24,
          (Il2CppObject *)this,
          Method_ScriptSelectDialog_OnClickSelect__,
...
LABEL_11:
  ...
  if ( (*((_BYTE *)Method_ScriptSelectDialog_OpenLimitTime__ + 83) & 2) != 0 )
    v30 = (_QWORD *)sub_2213A78(Method_ScriptSelectDialog_OpenLimitTime__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_59728FA & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_UnityEngine_GameObject_GetComponent_TweenAlpha___);
    sub_2213A60(&Method_ScriptSelectDialog_EndSelectDecide__);
    byte_59728FA = 1;
  }
...
LABEL_10:
    sub_2213CDC(rootLimitTimeObject, v14);
  }
}
...
void ScriptSelectDialog__UpdateLimitTimeUI(ScriptSelectDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_59728FC & 1) == 0 )
  {
    sub_2213A60(&StringLiteral_21593/*"img_timer_meter_yellow"*/);
    sub_2213A60(&StringLiteral_21591/*"img_timer_meter_blue"*/);
    this = (ScriptSelectDialog_o *)sub_2213A60(&StringLiteral_21592/*"img_timer_meter_red"*/);
    byte_59728FC = 1;
  }
...
LABEL_24:
  ...
  if ( limitTimeSeconds <= changeGaugeTimes->m_Items[0] )
  {
    ...
    if ( !this )
      goto LABEL_24;
    v6 = &StringLiteral_21592/*"img_timer_meter_red"*/;
    goto LABEL_14;
  }
  if ( max_length == 1 )
LABEL_25:
  ...
  if ( limitTimeSeconds <= changeGaugeTimes->m_Items[1] )
  {
    if ( !this )
      goto LABEL_24;
    v6 = &StringLiteral_21593/*"img_timer_meter_yellow"*/;
  }
  else
  {
    if ( !this )
      goto LABEL_24;
    v6 = &StringLiteral_21591/*"img_timer_meter_blue"*/;
  }
LABEL_14:
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_2010074;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_201002C;
}
