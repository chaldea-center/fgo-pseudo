void ScriptSelectDialog___ctor(ScriptSelectDialog_o *this, const MethodInfo *method)
{
  ...
  v3 = sub_1C93B7C(UnityEngine_Vector3___TypeInfo, 6);
  v11 = v3;
  if ( !byte_4D2A139 )
  {
    v3 = sub_1C93AD4(&UnityEngine_Vector3_TypeInfo);
    byte_4D2A139 = 1;
  }
  if ( !v11 )
    goto LABEL_21;
...
LABEL_20:
  ...
  *(_DWORD *)(v11 + 100) = 0;
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.BASE_VIEW_POSITIONS, v11, v5, v6, v7, v8, v9, v10);
  v3 = sub_1C93B7C(UnityEngine_Vector2___TypeInfo, 6);
  if ( !v3 )
LABEL_21:
    sub_1C93D2C(v3, v4);
  v27 = *(_DWORD *)(v3 + 24);
  ...
  *(_QWORD *)(v3 + 72) = 0xC29A000000000000LL;
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.LIST_VIEW_ITEM_SEED_PITCH, v3, v21, v22, v23, v24, v25, v26);
...
void ScriptSelectDialog__Close(ScriptSelectDialog_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.isOpen )
  {
    ...
    sub_1C93A78((GrandQuestFolderBoardItem_o *)&v9->fields.callbackFunc, 0, v10, v11, v12, v13, v14, v15);
    ...
    if ( limitTimeLoopSe )
    {
      if ( !v16->fields.isStop )
      {
        ...
        sub_1C93A78(p_limitTimeLoopSe, 0, v19, v20, v21, v22, v23, v24);
      }
    }
  }
}
...
void ScriptSelectDialog__InitLimitTimeUI(ScriptSelectDialog_o *this, const MethodInfo *method)
{
  ...
  v5 = (struct System_Single_array *)sub_1C93B7C(float___TypeInfo, 2);
  this->fields.changeGaugeTimes = v5;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.changeGaugeTimes, (int32_t)v5, v6, v7, v8, v9, v10, v11);
...
void ScriptSelectDialog__OnClickSelect(ScriptSelectDialog_o *this, int32_t index, const MethodInfo *method)
{
  ...
  if ( this->fields.limitTimeMode )
  {
    ...
    sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.limitTimeLoopSe, 0, v6, v7, v8, v9, v10, v11);
  }
  callbackFunc = this->fields.callbackFunc;
  if ( callbackFunc )
    ((void (__fastcall *)(intptr_t, _QWORD, intptr_t))callbackFunc->fields.invoke_impl)(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D329FA & 1) == 0 )
  {
    sub_1C93AD4(&ScriptSelectListViewManager_ClickDelegate_TypeInfo);
    sub_1C93AD4(&Method_ScriptSelectDialog_OnClickSelect__);
    byte_4D329FA = 1;
  }
  ...
  if ( !selectMessageList
    || (ScriptSelectDialog__InitListViewManagerUI(this, selectMessageList->max_length, v16),
        listViewManager = this->fields.listViewManager,
        v18 = (ScriptSelectListViewManager_ClickDelegate_o *)sub_1C93D20(ScriptSelectListViewManager_ClickDelegate_TypeInfo),
  ...
  {
LABEL_8:
    sub_1C93D2C(rootObject, selectMessageList);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !selectMessageList
    || (ScriptSelectDialog__InitListViewManagerUI(this, selectMessageList->max_length, v18),
        listViewManager = this->fields.listViewManager,
        v20 = (ScriptSelectListViewManager_ClickDelegate_o *)sub_1C93D20(ScriptSelectListViewManager_ClickDelegate_TypeInfo),
        ScriptSelectListViewManager_ClickDelegate___ctor(
          v20,
          (Il2CppObject *)this,
          Method_ScriptSelectDialog_OnClickSelect__,
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C93AD4(&ScriptSelectListViewManager_ClickDelegate_TypeInfo);
    sub_1C93AD4(&Method_System_Linq_Enumerable_Take_string___);
    sub_1C93AD4(&Method_System_Linq_Enumerable_ToArray_string___);
    sub_1C93AD4(&Method_ScriptSelectDialog_OnClickSelect__);
    sub_1C93AD4(&Method_ScriptSelectDialog_OpenLimitTime__);
    byte_4D329FC = 1;
  }
  rootObject = this->fields.rootObject;
  if ( !rootObject )
  ...
  v20 = System_Linq_Enumerable__Take_object_(
          ...
          (const MethodInfo_31E2604 *)Method_System_Linq_Enumerable_Take_string___);
  ...
  if ( !rootObject
    || (v22 = (System_String_array *)rootObject,
        ...
        listViewManager = this->fields.listViewManager,
        v24 = (ScriptSelectListViewManager_ClickDelegate_o *)sub_1C93D20(ScriptSelectListViewManager_ClickDelegate_TypeInfo),
        ScriptSelectListViewManager_ClickDelegate___ctor(
          v24,
          (Il2CppObject *)this,
          Method_ScriptSelectDialog_OnClickSelect__,
...
LABEL_11:
  ...
  if ( (*((_BYTE *)Method_ScriptSelectDialog_OpenLimitTime__ + 83) & 2) != 0 )
    v30 = (_QWORD *)sub_1C93AEC(Method_ScriptSelectDialog_OpenLimitTime__);
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.limitTimeLoopSe, (int32_t)v32, v33, v34, v35, v36, v37, v38);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D329FD & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_UnityEngine_GameObject_GetComponent_TweenAlpha___);
    sub_1C93AD4(&Method_ScriptSelectDialog_EndSelectDecide__);
    byte_4D329FD = 1;
  }
...
LABEL_10:
    sub_1C93D2C(rootLimitTimeObject, v14);
  }
}
...
void ScriptSelectDialog__UpdateLimitTimeUI(ScriptSelectDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D329FF & 1) == 0 )
  {
    sub_1C93AD4(&StringLiteral_20832/*"img_timer_meter_yellow"*/);
    sub_1C93AD4(&StringLiteral_20830/*"img_timer_meter_blue"*/);
    this = (ScriptSelectDialog_o *)sub_1C93AD4(&StringLiteral_20831/*"img_timer_meter_red"*/);
    byte_4D329FF = 1;
  }
...
LABEL_23:
  ...
  if ( limitTimeSeconds > changeGaugeTimes->m_Items[0] )
  {
    if ( max_length > 1 )
    {
      ...
      v7 = (System_String_o **)&StringLiteral_20832/*"img_timer_meter_yellow"*/;
      if ( limitTimeSeconds > v6 )
        v7 = (System_String_o **)&StringLiteral_20830/*"img_timer_meter_blue"*/;
      goto LABEL_13;
    }
LABEL_24:
    sub_1C93D34(this);
  ...
  if ( !this )
    goto LABEL_23;
  v7 = (System_String_o **)&StringLiteral_20831/*"img_timer_meter_red"*/;
LABEL_13:
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1ACA964;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1ACA91C;
}
