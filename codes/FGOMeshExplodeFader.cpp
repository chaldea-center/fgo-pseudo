        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0327 & 1) == 0 )
  {
    sub_B52984(&FGOMeshExplodeFader__FadeOut_d__2_TypeInfo);
    byte_42B0327 = 1;
  }
  v3 = sub_B52A54(FGOMeshExplodeFader__FadeOut_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42ACE07 & 1) == 0 )
  {
    ...
    this = (FGOMeshExplodeFader__FadeOut_d__2_o *)sub_B52984(&UnityEngine_Object_TypeInfo);
    byte_42ACE07 = 1;
  }
...
LABEL_15:
  ...
  v2->fields.__1__state = -1;
  v5 = t_5__2 + UnityEngine_Time__get_deltaTime(0LL);
  v2->fields._t_5__2 = v5;
  if ( !_4__this )
    goto LABEL_15;
LABEL_8:
  if ( v5 >= *(float *)&_4__this[1].klass )
  {
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_B52988(&Method_FGOMeshExplodeFader__FadeOut_d__2_System_Collections_IEnumerator_Reset__);
  sub_B52A28(v3, v4);
}
