        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B9CCB & 1) == 0 )
  {
    sub_1B4CF90(&FGOMeshExplodeFader__FadeOut_d__2_TypeInfo, method);
    byte_49B9CCB = 1;
  }
  v3 = sub_1B4D1DC(FGOMeshExplodeFader__FadeOut_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B9CCC & 1) == 0 )
  {
    ...
    this = (FGOMeshExplodeFader__FadeOut_d__2_o *)sub_1B4CF90(&UnityEngine_Object_TypeInfo, v3);
    byte_49B9CCC = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B4CFA4(&Method_FGOMeshExplodeFader__FadeOut_d__2_System_Collections_IEnumerator_Reset__);
  sub_1B4D0B8(v3, v4);
}
