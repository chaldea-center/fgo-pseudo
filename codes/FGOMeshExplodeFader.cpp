...
System_Collections_IEnumerator_o *FGOMeshExplodeFader__FadeOut(FGOMeshExplodeFader_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596F52A & 1) == 0 )
  {
    sub_2213A60(&FGOMeshExplodeFader__FadeOut_d__2_TypeInfo);
    byte_596F52A = 1;
  }
  v3 = sub_2213CCC(FGOMeshExplodeFader__FadeOut_d__2_TypeInfo);
...
bool FGOMeshExplodeFader__FadeOut_d__2__MoveNext(FGOMeshExplodeFader__FadeOut_d__2_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596F52B & 1) == 0 )
  {
    ...
    this = (FGOMeshExplodeFader__FadeOut_d__2_o *)sub_2213A60(&UnityEngine_Object_TypeInfo);
    byte_596F52B = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_2213A74(&Method_FGOMeshExplodeFader__FadeOut_d__2_System_Collections_IEnumerator_Reset__);
  sub_2213BA0(v3, v4);
}
