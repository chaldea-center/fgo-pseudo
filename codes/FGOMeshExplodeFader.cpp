...
System_Collections_IEnumerator_o *FGOMeshExplodeFader__FadeOut(FGOMeshExplodeFader_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C41D3C & 1) == 0 )
  {
    sub_1C37058(&FGOMeshExplodeFader__FadeOut_d__2_TypeInfo);
    byte_4C41D3C = 1;
  }
  v3 = sub_1C372A4(FGOMeshExplodeFader__FadeOut_d__2_TypeInfo);
...
bool FGOMeshExplodeFader__FadeOut_d__2__MoveNext(FGOMeshExplodeFader__FadeOut_d__2_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C41D3D & 1) == 0 )
  {
    ...
    this = (FGOMeshExplodeFader__FadeOut_d__2_o *)sub_1C37058(&UnityEngine_Object_TypeInfo);
    byte_4C41D3D = 1;
  }
...
LABEL_8:
  if ( v7 < _4__this->fields.fadeTime )
  {
    ...
    sub_1C36FFC(p__2__current, 0, v5, v6);
    result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C3706C(&Method_FGOMeshExplodeFader__FadeOut_d__2_System_Collections_IEnumerator_Reset__);
  sub_1C37180(v3, v4);
}
