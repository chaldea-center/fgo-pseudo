        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C20DB9 & 1) == 0 )
  {
    sub_1C3B764(&FGOMeshExplodeFader__FadeOut_d__2_TypeInfo, method);
    byte_4C20DB9 = 1;
  }
  v3 = sub_1C3B9B0(FGOMeshExplodeFader__FadeOut_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C20DBA & 1) == 0 )
  {
    ...
    this = (FGOMeshExplodeFader__FadeOut_d__2_o *)sub_1C3B764(&UnityEngine_Object_TypeInfo, v3);
    byte_4C20DBA = 1;
  }
...
LABEL_14:
  ...
  v12 = 0.0;
LABEL_8:
  if ( v12 < _4__this->fields.fadeTime )
  {
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C3B778(&Method_FGOMeshExplodeFader__FadeOut_d__2_System_Collections_IEnumerator_Reset__);
  sub_1C3B88C(v3, v4);
}
