...
System_Collections_IEnumerator_o *FGOMeshExplodeFader__FadeOut(FGOMeshExplodeFader_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC615A & 1) == 0 )
  {
    sub_1C713B0(&FGOMeshExplodeFader__FadeOut_d__2_TypeInfo);
    byte_4CC615A = 1;
  }
  v3 = sub_1C715FC(FGOMeshExplodeFader__FadeOut_d__2_TypeInfo);
...
bool FGOMeshExplodeFader__FadeOut_d__2__MoveNext(FGOMeshExplodeFader__FadeOut_d__2_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC615B & 1) == 0 )
  {
    ...
    this = (FGOMeshExplodeFader__FadeOut_d__2_o *)sub_1C713B0(&UnityEngine_Object_TypeInfo);
    byte_4CC615B = 1;
  }
...
LABEL_8:
  if ( v11 < _4__this->fields.fadeTime )
  {
    ...
    sub_1C71354(p__2__current, 0, v5, v6, v7, v8, v9, v10);
    result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C713C4(&Method_FGOMeshExplodeFader__FadeOut_d__2_System_Collections_IEnumerator_Reset__);
  sub_1C714D8(v3, v4);
}
