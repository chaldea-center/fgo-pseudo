        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B2E4 & 1) == 0 )
  {
    sub_1BCAFF8(&FGOMeshExplodeFader__FadeOut_d__2_TypeInfo, method);
    byte_4B1B2E4 = 1;
  }
  v3 = sub_1BCB244(FGOMeshExplodeFader__FadeOut_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B2E5 & 1) == 0 )
  {
    ...
    this = (FGOMeshExplodeFader__FadeOut_d__2_o *)sub_1BCAFF8(&UnityEngine_Object_TypeInfo, v3);
    byte_4B1B2E5 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BCB00C(&Method_FGOMeshExplodeFader__FadeOut_d__2_System_Collections_IEnumerator_Reset__);
  sub_1BCB120(v3, v4);
}
