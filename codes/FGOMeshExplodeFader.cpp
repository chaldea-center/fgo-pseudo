        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFC5AB & 1) == 0 )
  {
    sub_1C2E12C(&FGOMeshExplodeFader__FadeOut_d__2_TypeInfo, method);
    byte_4BFC5AB = 1;
  }
  v3 = sub_1C2E378(FGOMeshExplodeFader__FadeOut_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFC5AC & 1) == 0 )
  {
    ...
    this = (FGOMeshExplodeFader__FadeOut_d__2_o *)sub_1C2E12C(&UnityEngine_Object_TypeInfo, v3);
    byte_4BFC5AC = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C2E140(&Method_FGOMeshExplodeFader__FadeOut_d__2_System_Collections_IEnumerator_Reset__);
  sub_1C2E254(v3, v4);
}
