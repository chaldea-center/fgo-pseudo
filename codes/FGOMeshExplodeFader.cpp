...
System_Collections_IEnumerator_o *FGOMeshExplodeFader__FadeOut(FGOMeshExplodeFader_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB503B & 1) == 0 )
  {
    sub_1C6BA08(&FGOMeshExplodeFader__FadeOut_d__2_TypeInfo);
    byte_4CB503B = 1;
  }
  v3 = sub_1C6BC54(FGOMeshExplodeFader__FadeOut_d__2_TypeInfo);
...
bool FGOMeshExplodeFader__FadeOut_d__2__MoveNext(FGOMeshExplodeFader__FadeOut_d__2_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB503C & 1) == 0 )
  {
    ...
    this = (FGOMeshExplodeFader__FadeOut_d__2_o *)sub_1C6BA08(&UnityEngine_Object_TypeInfo);
    byte_4CB503C = 1;
  }
...
LABEL_8:
  if ( v7 < _4__this->fields.fadeTime )
  {
    ...
    sub_1C6B9AC(p__2__current, 0, v5, v6);
    result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C6BA1C(&Method_FGOMeshExplodeFader__FadeOut_d__2_System_Collections_IEnumerator_Reset__);
  sub_1C6BB30(v3, v4);
}
