...
System_Collections_IEnumerator_o *FGOMeshExplodeFader__FadeOut(FGOMeshExplodeFader_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C55ADE & 1) == 0 )
  {
    sub_1C3E564(&FGOMeshExplodeFader__FadeOut_d__2_TypeInfo);
    byte_4C55ADE = 1;
  }
  v3 = sub_1C3E7B0(FGOMeshExplodeFader__FadeOut_d__2_TypeInfo);
...
bool FGOMeshExplodeFader__FadeOut_d__2__MoveNext(FGOMeshExplodeFader__FadeOut_d__2_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C55ADF & 1) == 0 )
  {
    ...
    this = (FGOMeshExplodeFader__FadeOut_d__2_o *)sub_1C3E564(&UnityEngine_Object_TypeInfo);
    byte_4C55ADF = 1;
  }
...
LABEL_8:
  if ( v7 < _4__this->fields.fadeTime )
  {
    ...
    sub_1C3E508(p__2__current, 0, v5, v6);
    result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C3E578(&Method_FGOMeshExplodeFader__FadeOut_d__2_System_Collections_IEnumerator_Reset__);
  sub_1C3E68C(v3, v4);
}
