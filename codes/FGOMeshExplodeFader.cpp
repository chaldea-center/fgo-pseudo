...
System_Collections_IEnumerator_o *FGOMeshExplodeFader__FadeOut(FGOMeshExplodeFader_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_59373CF & 1) == 0 )
  {
    sub_21FFC50(&FGOMeshExplodeFader__FadeOut_d__2_TypeInfo);
    byte_59373CF = 1;
  }
  v3 = sub_21FFEBC(FGOMeshExplodeFader__FadeOut_d__2_TypeInfo);
...
bool FGOMeshExplodeFader__FadeOut_d__2__MoveNext(FGOMeshExplodeFader__FadeOut_d__2_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_59373D0 & 1) == 0 )
  {
    ...
    this = (FGOMeshExplodeFader__FadeOut_d__2_o *)sub_21FFC50(&UnityEngine_Object_TypeInfo);
    byte_59373D0 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_21FFC64(&Method_FGOMeshExplodeFader__FadeOut_d__2_System_Collections_IEnumerator_Reset__);
  sub_21FFD90(v3, v4);
}
