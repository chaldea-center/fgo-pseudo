        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCA64A & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_16450/*"_Contrast"*/, v7);
  ...
  UnityEngine_Material__SetFloat(material, (System_String_o *)StringLiteral_16450/*"_Contrast"*/, this->fields.contrast, 0LL);
