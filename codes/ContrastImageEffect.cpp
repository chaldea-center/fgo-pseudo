        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BDAE6 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_15875/*"_Contrast"*/, v7);
  ...
  UnityEngine_Material__SetFloat(material, (System_String_o *)StringLiteral_15875/*"_Contrast"*/, this->fields.contrast, 0LL);
