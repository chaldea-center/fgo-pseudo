        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1F322 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_16044/*"_Contrast"*/, v7);
  ...
  UnityEngine_Material__SetFloat(material, (System_String_o *)StringLiteral_16044/*"_Contrast"*/, this->fields.contrast, 0LL);
