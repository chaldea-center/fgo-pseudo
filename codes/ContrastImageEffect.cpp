        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4189648 & 1) == 0 )
  {
    ...
    sub_B2C35C(&StringLiteral_15958/*"_Contrast"*/, v7);
  ...
  UnityEngine_Material__SetFloat(material, (System_String_o *)StringLiteral_15958/*"_Contrast"*/, this->fields.contrast, 0LL);
