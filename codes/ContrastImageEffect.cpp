        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_438CCFD & 1) == 0 )
  {
    ...
    sub_B775C4(&StringLiteral_16253/*"_Contrast"*/);
  ...
  UnityEngine_Material__SetFloat(material, (System_String_o *)StringLiteral_16253/*"_Contrast"*/, this->fields.contrast, 0LL);
