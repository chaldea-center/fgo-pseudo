        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0147B & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_16119/*"_Contrast"*/, v7);
  ...
  UnityEngine_Material__SetFloat(material, (System_String_o *)StringLiteral_16119/*"_Contrast"*/, this->fields.contrast, 0LL);
