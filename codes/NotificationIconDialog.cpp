...
void NotificationIconDialog__Close(NotificationIconDialog_o *this, const MethodInfo *method)
{
  ...
  NotificationIconDialog__Close_31564104(this, 0, v2);
}


void NotificationIconDialog__Close_31564104(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC12D5 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_NotificationIconDialog_EndClose__);
    byte_4CC12D5 = 1;
  }
...
void NotificationIconDialog__OnClickOk(NotificationIconDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC12D6 & 1) == 0 )
  {
    sub_1C713B0(&Method_NotificationIconDialog_OnClickOk__);
  ...
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_NotificationIconDialog_OnClickOk__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C713C8(Method_NotificationIconDialog_OnClickOk__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC12D4 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_NotificationIconDialog_EndOpen__);
    sub_1C713B0(&UnityEngine_Object_TypeInfo);
  ...
  if ( UnityEngine_Object__op_Inequality(okBtnLabel, 0, 0) )
  {
    ...
    v15 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3680/*"COMMON_CONFIRM_CLOSE"*/, 0);
    if ( !v20 )
      goto LABEL_32;
  ...
  if ( UnityEngine_Object__op_Inequality(itemIconComponent, 0, 0) )
  {
    ...
    if ( v15 )
    {
      ItemIconComponent__SetGift_41196280((ItemIconComponent_o *)v15, type, objectId, -1, 0, 0);
      goto LABEL_31;
    }
LABEL_32:
    sub_1C71608(v15, v14);
