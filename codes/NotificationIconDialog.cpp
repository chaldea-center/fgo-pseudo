...
void __fastcall NotificationIconDialog__Close(NotificationIconDialog_o *this, const MethodInfo *method)
{
  ...
  NotificationIconDialog__Close_30953504(this, 0LL, v2);
}


void __fastcall NotificationIconDialog__Close_30953504(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3EEF6 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_NotificationIconDialog_EndClose__, v5);
    byte_4B3EEF6 = 1;
  }
...
void __fastcall NotificationIconDialog__OnClickOk(NotificationIconDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3EEF7 & 1) == 0 )
  {
    sub_1BDB878(&Method_NotificationIconDialog_OnClickOk__, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3EEF5 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_NotificationIconDialog_EndOpen__, v14);
    sub_1BDB878(&UnityEngine_Object_TypeInfo, v15);
    sub_1BDB878(&StringLiteral_3717/*"COMMON_CONFIRM_CLOSE"*/, v16);
  ...
  if ( UnityEngine_Object__op_Inequality(okBtnLabel, 0LL, 0LL) )
  {
    ...
    v20 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3717/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
    if ( !v25 )
      goto LABEL_32;
  ...
  if ( UnityEngine_Object__op_Inequality(itemIconComponent, 0LL, 0LL) )
  {
    ...
    if ( v20 )
    {
      ItemIconComponent__SetGift_39935088((ItemIconComponent_o *)v20, type, objectId, -1, 0, 0LL);
      goto LABEL_31;
    }
LABEL_32:
    sub_1BDBAD4(v20, v19);
