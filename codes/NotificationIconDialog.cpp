...
void __fastcall NotificationIconDialog__Close(NotificationIconDialog_o *this, const MethodInfo *method)
{
  ...
  NotificationIconDialog__Close_46237908(this, 0LL, v2);
}


void __fastcall NotificationIconDialog__Close_46237908(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A779 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_NotificationIconDialog_EndClose__, v10);
    byte_4B6A779 = 1;
  }
...
void __fastcall NotificationIconDialog__OnClickOk(NotificationIconDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6A77A & 1) == 0 )
  {
    sub_1BE4ACC(&Method_NotificationIconDialog_OnClickOk__, method);
  ...
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_NotificationIconDialog_OnClickOk__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1BE4AE4(Method_NotificationIconDialog_OnClickOk__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A778 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_NotificationIconDialog_EndOpen__, v15);
    sub_1BE4ACC(&UnityEngine_Object_TypeInfo, v16);
    sub_1BE4ACC(&StringLiteral_3796/*"COMMON_CONFIRM_CLOSE"*/, v17);
  ...
  if ( UnityEngine_Object__op_Inequality(okBtnLabel, 0LL, 0LL) )
  {
    ...
    v21 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3796/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
    if ( !v26 )
      goto LABEL_32;
  ...
  if ( UnityEngine_Object__op_Inequality(itemIconComponent, 0LL, 0LL) )
  {
    ...
    if ( v21 )
    {
      ItemIconComponent__SetGift_39048172((ItemIconComponent_o *)v21, type, objectId, -1, 0, 0LL);
      goto LABEL_31;
    }
LABEL_32:
    sub_1BE4D28(v21, v20);
