...
void NotificationIconDialog__Close(NotificationIconDialog_o *this, const MethodInfo *method)
{
  ...
  NotificationIconDialog__Close_32101188(this, 0, v2);
}


void NotificationIconDialog__Close_32101188(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFE6E2 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_NotificationIconDialog_EndClose__);
    byte_4DFE6E2 = 1;
  }
...
void NotificationIconDialog__OnClickOk(NotificationIconDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFE6E3 & 1) == 0 )
  {
    sub_1CE6700(&Method_NotificationIconDialog_OnClickOk__);
  ...
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_NotificationIconDialog_OnClickOk__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_NotificationIconDialog_OnClickOk__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFE6E1 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_NotificationIconDialog_EndOpen__);
    sub_1CE6700(&UnityEngine_Object_TypeInfo);
  ...
  if ( UnityEngine_Object__op_Inequality(okBtnLabel, 0, 0) )
  {
    ...
    v15 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3714/*"COMMON_CONFIRM_CLOSE"*/, 0);
    if ( !v20 )
      goto LABEL_32;
  ...
  if ( UnityEngine_Object__op_Inequality(itemIconComponent, 0, 0) )
  {
    ...
    if ( v15 )
    {
      ItemIconComponent__SetGift_42064732((ItemIconComponent_o *)v15, type, objectId, -1, 0, 0);
      goto LABEL_31;
    }
LABEL_32:
    sub_1CE6958(v15, v14);
