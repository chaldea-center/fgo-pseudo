...
void __fastcall NotificationIconDialog__Close(NotificationIconDialog_o *this, const MethodInfo *method)
{
  ...
  NotificationIconDialog__Close_46452092(this, 0LL, v2);
}


void __fastcall NotificationIconDialog__Close_46452092(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB82CE & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_NotificationIconDialog_EndClose__, v10);
    byte_4BB82CE = 1;
  }
...
void __fastcall NotificationIconDialog__OnClickOk(NotificationIconDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB82CF & 1) == 0 )
  {
    sub_1C13D24(&Method_NotificationIconDialog_OnClickOk__, method);
  ...
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_NotificationIconDialog_OnClickOk__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1C13D3C(Method_NotificationIconDialog_OnClickOk__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB82CD & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_NotificationIconDialog_EndOpen__, v15);
  ...
  if ( UnityEngine_Object__op_Inequality(okBtnLabel, 0LL, 0LL) )
  {
    ...
    v21 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3799/*"COMMNAD_SPELL_RECV_TXT"*/, 0LL);
    if ( !v26 )
      goto LABEL_32;
  ...
  if ( UnityEngine_Object__op_Inequality(itemIconComponent, 0LL, 0LL) )
  {
    ...
    if ( v21 )
    {
      ItemIconComponent__SetGift_39286592((ItemIconComponent_o *)v21, type, objectId, -1, 0, 0LL);
      goto LABEL_31;
    }
LABEL_32:
    sub_1C13F80(v21, v20);
