...
void __fastcall NotificationIconDialog__Close(NotificationIconDialog_o *this, const MethodInfo *method)
{
  ...
  NotificationIconDialog__Close_26258312(this, 0LL, v2);
}


void __fastcall NotificationIconDialog__Close_26258312(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_438BAB5 & 1) == 0 )
  {
    ...
    sub_B775C4(&Method_NotificationIconDialog_EndClose__);
    byte_438BAB5 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_438BAB4 & 1) == 0 )
  {
    ...
    sub_B775C4(&Method_NotificationIconDialog_EndOpen__);
    sub_B775C4(&UnityEngine_Object_TypeInfo);
  ...
  if ( UnityEngine_Object__op_Inequality(okBtnLabel, 0LL, 0LL) )
  {
    ...
    v16 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3387/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
    if ( !v21 )
      goto LABEL_37;
