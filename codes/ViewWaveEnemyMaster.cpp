void __fastcall ViewWaveEnemyMaster___ctor(ViewWaveEnemyMaster_o *this, const MethodInfo *method)
{
  if ( (byte_418D2C3 & 1) == 0 )
  {
    sub_B2C35C(&Method_DataMasterBase_ViewWaveEnemyMaster__ViewWaveEnemyEntity__string___ctor__, method);
    byte_418D2C3 = 1;
  }
  DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string____ctor(
    (DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string__o *)this,
    458,
    (const MethodInfo_24E4484 *)Method_DataMasterBase_ViewWaveEnemyMaster__ViewWaveEnemyEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_418D2C1 & 1) == 0 )
  {
    sub_B2C35C(
      ...
      *(_QWORD *)&questId);
    sub_B2C35C(&ViewWaveEnemyEntity_TypeInfo, v7);
    byte_418D2C1 = 1;
  }
  ...
  return (ViewWaveEnemyEntity_o *)DataMasterBase_WarGroupMaster__WarGroupEntity__string___GetEntity(
                                    ...
                                    PK,
                                    (const MethodInfo_24E4520 *)Method_DataMasterBase_ViewWaveEnemyMaster__ViewWaveEnemyEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_418D2C4 & 1) == 0 )
  {
    ...
    sub_B2C35C(&Method_System_Collections_Generic_List_ViewWaveEnemyEntity__Add__, v12);
    sub_B2C35C(&Method_System_Collections_Generic_List_ViewWaveEnemyEntity__ToArray__, v13);
    ...
    sub_B2C35C(&ViewWaveEnemyEntity_TypeInfo, v18);
    byte_418D2C4 = 1;
  }
  entity = 0LL;
  ...
  v24 = (System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData__o *)sub_B2C42C(System_Collections_Generic_List_ViewWaveEnemyEntity__TypeInfo);
...
LABEL_28:
    ...
    if ( !v37 )
      goto LABEL_48;
    v40 = ViewWaveEnemyEntity_TypeInfo;
    v41 = *(&ViewWaveEnemyEntity_TypeInfo->_2.bitflags2 + 1);
    if ( *(unsigned __int8 *)(*(_QWORD *)v37 + 300LL) < (unsigned int)v41
      || *(ViewWaveEnemyEntity_c **)(*(_QWORD *)(*(_QWORD *)v37 + 200LL) + 8 * v41 - 8) != ViewWaveEnemyEntity_TypeInfo )
    {
      sub_B2C728(v37);
LABEL_48:
      sub_B2C434(v37, v38);
    ...
    if ( *(_DWORD *)(v37 + 16) == questId )
    {
      if ( !EnemyInfoDispNpcSvtIdList )
        sub_B2C434(v37, ViewWaveEnemyEntity_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_418D2C2 & 1) == 0 )
  {
    sub_B2C35C(&Method_DataMasterBase_ViewWaveEnemyMaster__ViewWaveEnemyEntity__string__TryGetEntity__, entity);
    sub_B2C35C(&ViewWaveEnemyEntity_TypeInfo, v9);
    byte_418D2C2 = 1;
  }
  if ( (BYTE3(ViewWaveEnemyEntity_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !ViewWaveEnemyEntity_TypeInfo->_2.cctor_finished )
  ...
  return DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string___TryGetEntity(
           ...
           PK,
           (const MethodInfo_24E4578 *)Method_DataMasterBase_ViewWaveEnemyMaster__ViewWaveEnemyEntity__string__TryGetEntity__);
}