void __fastcall ViewWaveEnemyMaster___ctor(ViewWaveEnemyMaster_o *this, const MethodInfo *method)
{
  if ( (byte_49FD2EF & 1) == 0 )
  {
    sub_1B640C8(&Method_DataMasterBase_ViewWaveEnemyMaster__ViewWaveEnemyEntity__string___ctor__, method);
    byte_49FD2EF = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    460,
    (const MethodInfo_30D41BC *)Method_DataMasterBase_ViewWaveEnemyMaster__ViewWaveEnemyEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD2ED & 1) == 0 )
  {
    sub_1B640C8(
      ...
      *(_QWORD *)&questId);
    sub_1B640C8(&ViewWaveEnemyEntity_TypeInfo, v7);
    byte_49FD2ED = 1;
  }
  ...
  return (ViewWaveEnemyEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                    PK,
                                    (const MethodInfo_30D41FC *)Method_DataMasterBase_ViewWaveEnemyMaster__ViewWaveEnemyEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD2F0 & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_System_Collections_Generic_List_ViewWaveEnemyEntity__Add__, v12);
    sub_1B640C8(&Method_System_Collections_Generic_List_ViewWaveEnemyEntity__ToArray__, v13);
    ...
    sub_1B640C8(&ViewWaveEnemyEntity_TypeInfo, v17);
    byte_49FD2F0 = 1;
  }
  entity = 0LL;
...
LABEL_47:
    ...
    if ( *(_DWORD *)(v34 + 16) == questId )
    {
            ...
            (v34 & 1) != 0) )
      {
        ...
        v40 = Method_System_Collections_Generic_List_ViewWaveEnemyEntity__Add__;
        ++v24->fields._version;
        if ( !items )
          sub_1B64324(v34);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD2EE & 1) == 0 )
  {
    sub_1B640C8(&Method_DataMasterBase_ViewWaveEnemyMaster__ViewWaveEnemyEntity__string__TryGetEntity__, entity);
    sub_1B640C8(&ViewWaveEnemyEntity_TypeInfo, v9);
    byte_49FD2EE = 1;
  }
  if ( !ViewWaveEnemyEntity_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(ViewWaveEnemyEntity_TypeInfo);
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_30D424C *)Method_DataMasterBase_ViewWaveEnemyMaster__ViewWaveEnemyEntity__string__TryGetEntity__);
}