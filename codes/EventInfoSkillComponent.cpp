        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC9224 & 1) == 0 )
  {
    sub_1C713B0(&Method_GameObjectHelper_Instantiate_EventInfoSkillDialog___);
  ...
  v8 = GameObjectHelper__Instantiate_object_(
         ...
         0,
         (const MethodInfo_31A4AF4 *)Method_GameObjectHelper_Instantiate_EventInfoSkillDialog___);
  if ( v8 )
...
void EventInfoSkillComponent__OnClick(EventInfoSkillComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC9223 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_EventInfoSkillComponent_OnClick__);
    sub_1C713B0(&Method_EventInfoSkillComponent__OnClick_b__5_0__);
    byte_4CC9223 = 1;
  }
  ...
  if ( ((unsigned __int8)v3 & 1) == 0 )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoSkillComponent_OnClick__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1C713C8(Method_EventInfoSkillComponent_OnClick__);
