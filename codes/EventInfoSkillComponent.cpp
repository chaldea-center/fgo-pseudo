        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFEE1A & 1) == 0 )
  {
    sub_1C2E12C(&Method_GameObjectHelper_Instantiate_EventInfoSkillDialog___, onClosed);
  ...
  v9 = GameObjectHelper__Instantiate_object_(
         ...
         0,
         (const MethodInfo_3024730 *)Method_GameObjectHelper_Instantiate_EventInfoSkillDialog___);
  if ( v9 )
...
void __fastcall EventInfoSkillComponent__OnClick(EventInfoSkillComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFEE19 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_EventInfoSkillComponent_OnClick__, v3);
    sub_1C2E12C(&Method_EventInfoSkillComponent__OnClick_b__5_0__, v4);
    byte_4BFEE19 = 1;
  }
  ...
  if ( ((unsigned __int8)v5 & 1) == 0 )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoSkillComponent_OnClick__ + 83) & 2) != 0 )
      v7 = (_QWORD *)sub_1C2E144(Method_EventInfoSkillComponent_OnClick__);
