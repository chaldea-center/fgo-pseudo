...
LABEL_52:
          if ( !v25 )
          {
            memcpy((void *)(a1 + 5584), &unk_F7DDE2, 0x80u);
            memcpy((void *)(a1 + 5712), &unk_F7DE62, 0x100u);
            *(_OWORD *)(a1 + 5968) = unk_BB0537;
            *(_OWORD *)(a1 + 6009) = *(__int128 *)((char *)&xmmword_BB0557 + 9);
            *(_OWORD *)(a1 + 6000) = xmmword_BB0557;
            *(_OWORD *)(a1 + 5984) = unk_BB0547;
...
LABEL_73:
        ...
        while ( 1 )
        {
          while ( 1 )
          {
            while ( 1 )
            {
              while ( (unsigned int)sub_1B5C868(a1, a5, a6, a7) )
                ;
              if ( *(_QWORD *)(a1 + 6512) )
                return 1LL;
              if ( *(_QWORD *)(a1 + 168) == *(_QWORD *)(a1 + 256) )
                break;
              result = sub_1B5C990(a1, 0LL, 1LL, a1 + 6512, a1 + 6504);
              if ( !(_DWORD)result )
                return result;
            }
            if ( *(_DWORD *)(a1 + 6548) == 3 )
...
LABEL_96:
  ...
  if ( v52 < 2 )
  {
    ...
    if ( v52 == 1 )
    {
      ...
      if ( v53 >= 0x20000 && !v55 )
      {
        *(_QWORD *)(a1 + 6488) = sub_1B73824(v127, 0x80000LL);
        v56 = sub_1B73824(v127, 0x20000LL);
        v57 = *(_QWORD *)(a1 + 6488);
        LODWORD(v126) = v56;
        *(_QWORD *)(a1 + 6496) = v56;
        if ( v57 )
...
LABEL_188:
            ...
            {
              sub_1B73848(v127, v123);
              sub_1B73848(v127, v124);
            ...
            v128 = *a5;
            if ( 2 * v111 + 503 > *a5 )
              v115 = (_BYTE *)sub_1B5F79C(a1);
            else
              v115 = *a6;
            *v115 = *(_BYTE *)(a1 + 352);
            v116 = v110 && v112;
            v115[1] = *(_BYTE *)(a1 + 353);
            v117 = sub_1B5F7F0(a1, *(unsigned int *)(a1 + 4), v111, v132);
            v118 = (void *)*a4;
            if ( *(_DWORD *)(a1 + 4) )
              sub_1B3767C(v127, v118, v111, v116, v125, v126, v117, v132[0], (__int64)&v133);
            else
              sub_1B42C0C(
                v127,
                v118,
...
LABEL_185:
        v125 = sub_1B73824(v127, 4 * v54);
        v126 = sub_1B73824(v127, v54);
        v123 = v125;
        v124 = v126;
        goto LABEL_188;
      }
    ...
    while ( 1 )
    {
      while ( 1 )
      {
        ...
        if ( v66 || v68 >= *(unsigned int *)(a1 + 184) )
        {
          ...
          {
            v77 = (_BYTE *)sub_1B73824(v58, v76 + 2 + 7LL);
        ...
        {
          *(_DWORD *)(a1 + 196) = v68;
          v69 = (_BYTE *)sub_1B73824(v58, (unsigned int)(v68 + 2) + 7LL);
      ...
      if ( !(unsigned int)sub_1B5C868(a1, a5, a6, a7) )
        break;
...
LABEL_218:
    ...
    result = sub_1B5C990(a1, (v131 == 2) & (unsigned __int8)v94, v96, v130, a1 + 6504);
    if ( !(_DWORD)result )
      return result;
    if ( (v95 & 1) != 0 || v96 )
    {
