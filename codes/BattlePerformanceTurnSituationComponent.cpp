void __fastcall BattlePerformanceTurnSituationComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A30ECB & 1) == 0 )
  {
    sub_1B761C0(&BattlePerformanceTurnSituationComponent_TypeInfo, v1);
    sub_1B761C0(&StringLiteral_3001/*"BATTLE_TURN_SITUATTION_LABEL_WITH_RAIDNAME_{0}"*/, v4);
    byte_4A30ECB = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A30ECA & 1) == 0 )
  {
    sub_1B761C0(&BattlePerformanceTurnSituationComponent_TypeInfo, *(_QWORD *)&situationNo);
  ...
  v21 = System_String__Format_61549432(v16, (Il2CppObject *)bossName, v20, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A30EC9 & 1) == 0 )
  {
    sub_1B761C0(&Method_UnityEngine_Component_GetComponent_UILabel___, message);
