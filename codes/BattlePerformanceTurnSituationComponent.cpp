void __fastcall BattlePerformanceTurnSituationComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A0BBCC & 1) == 0 )
  {
    sub_1B686D4(&BattlePerformanceTurnSituationComponent_TypeInfo, v1);
    sub_1B686D4(&StringLiteral_2979/*"BATTLE_TURN_SITUATTION_LABEL_WITH_RAIDNAME_{0}"*/, v4);
    byte_4A0BBCC = 1;
  }
  BattlePerformanceTurnSituationComponent_TypeInfo->static_fields->LABEL_WITH_RAIDNAME_KEY = (struct System_String_o *)StringLiteral_2979/*"BATTLE_TURN_SITUATTION_LABEL_WITH_RAIDNAME_{0}"*/;
  sub_1B68678(
    (ServantStatusBattleListViewItem_o *)BattlePerformanceTurnSituationComponent_TypeInfo->static_fields,
    StringLiteral_2979/*"BATTLE_TURN_SITUATTION_LABEL_WITH_RAIDNAME_{0}"*/,
    v2,
    v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0BBCB & 1) == 0 )
  {
    sub_1B686D4(&BattlePerformanceTurnSituationComponent_TypeInfo, *(_QWORD *)&situationNo);
  ...
  v21 = System_String__Format_61433840(v16, (Il2CppObject *)bossName, v20, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0BBCA & 1) == 0 )
  {
    sub_1B686D4(&Method_UnityEngine_Component_GetComponent_UILabel___, message);
