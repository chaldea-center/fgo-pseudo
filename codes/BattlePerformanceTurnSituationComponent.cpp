void __fastcall BattlePerformanceTurnSituationComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B3A21F & 1) == 0 )
  {
    sub_1BD3458(&BattlePerformanceTurnSituationComponent_TypeInfo, v1);
    sub_1BD3458(&StringLiteral_3029/*"BATTLE_TURN_SITUATTION_LABEL_WITH_RAIDNAME_{0}"*/, v8);
    byte_4B3A21F = 1;
  }
  BattlePerformanceTurnSituationComponent_TypeInfo->static_fields->LABEL_WITH_RAIDNAME_KEY = (struct System_String_o *)StringLiteral_3029/*"BATTLE_TURN_SITUATTION_LABEL_WITH_RAIDNAME_{0}"*/;
  sub_1BD33FC(
    (PartyOrganizationUtility_o *)BattlePerformanceTurnSituationComponent_TypeInfo->static_fields,
    StringLiteral_3029/*"BATTLE_TURN_SITUATTION_LABEL_WITH_RAIDNAME_{0}"*/,
    v2,
    v3,
    v4,
    v5,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3A21E & 1) == 0 )
  {
    sub_1BD3458(&BattlePerformanceTurnSituationComponent_TypeInfo, *(_QWORD *)&situationNo);
  ...
  v21 = System_String__Format_62539620(v16, (Il2CppObject *)bossName, v20, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3A21D & 1) == 0 )
  {
    sub_1BD3458(&Method_UnityEngine_Component_GetComponent_UILabel___, message);
