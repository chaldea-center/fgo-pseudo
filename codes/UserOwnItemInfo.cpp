...
void UserOwnItemInfo___ctor_43314684(
...
bool UserOwnItemInfo__IsExpired(UserOwnItemInfo_o *this, System_Nullable_long__o time, const MethodInfo *method)
{
  ...
  if ( !ItemEntity_k__BackingField )
    sub_1C2D6EC(0, *(_QWORD *)&time.fields.hasValue);
  return !ItemEntity__IsEnable_42043280(ItemEntity_k__BackingField, value, 0);
}
...
void UserOwnItemInfo__set_ItemEntity(UserOwnItemInfo_o *this, ItemEntity_o *value, const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields._ItemEntity_k__BackingField, (int32_t)value, (int32_t)method, v3);
}
