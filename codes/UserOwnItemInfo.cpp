...
void __fastcall UserOwnItemInfo___ctor_40556160(
        ...
        const MethodInfo *method)
{
  ...
  if ( !ItemEntity_k__BackingField )
    sub_1B8880C(0LL, *(_QWORD *)&time.fields.hasValue);
  return !ItemEntity__IsEnable_39383924(ItemEntity_k__BackingField, value, 0LL);
}
