...
void __fastcall UserOwnItemInfo___ctor_40370752(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F1A6 & 1) == 0 )
  {
    sub_1B761C0(&NetworkManager_TypeInfo, *(_QWORD *)&time.fields.hasValue);
    sub_1B761C0(&Method_System_Nullable_long__GetValueOrDefault__, v6);
    sub_1B761C0(&Method_System_Nullable_long__get_HasValue__, v7);
    byte_4A2F1A6 = 1;
  }
  if ( !hasValue )
  {
  ...
  if ( !ItemEntity_k__BackingField )
    sub_1B7641C(0LL, *(_QWORD *)&time.fields.hasValue);
  return !ItemEntity__IsEnable_39203120(ItemEntity_k__BackingField, value, 0LL);
}
