...
void __fastcall UserOwnItemInfo___ctor_42519900(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B03445 & 1) == 0 )
  {
    sub_1BC3008(&NetworkManager_TypeInfo, *(_QWORD *)&time.fields.hasValue);
    sub_1BC3008(&Method_System_Nullable_long__GetValueOrDefault__, v6);
    sub_1BC3008(&Method_System_Nullable_long__get_HasValue__, v7);
    byte_4B03445 = 1;
  }
  if ( !hasValue )
  {
  ...
  if ( !ItemEntity_k__BackingField )
    sub_1BC3264(0LL, *(_QWORD *)&time.fields.hasValue);
  return !ItemEntity__IsEnable_41271428(ItemEntity_k__BackingField, value, 0LL);
}
...
void __fastcall UserOwnItemInfo__set_ItemEntity(UserOwnItemInfo_o *this, ItemEntity_o *value, const MethodInfo *method)
{
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields._ItemEntity_k__BackingField, (int32_t)value, (int32_t)method, v3);
}
