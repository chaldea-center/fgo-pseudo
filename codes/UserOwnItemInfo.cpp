...
void __fastcall UserOwnItemInfo___ctor_40343320(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20D32 & 1) == 0 )
  {
    sub_1B715CC(&NetworkManager_TypeInfo, *(_QWORD *)&time.fields.hasValue);
    sub_1B715CC(&Method_System_Nullable_long__GetValueOrDefault__, v6);
    sub_1B715CC(&Method_System_Nullable_long__get_HasValue__, v7);
    byte_4A20D32 = 1;
  }
  if ( !hasValue )
  {
  ...
  if ( !ItemEntity_k__BackingField )
    sub_1B71828(0LL, *(_QWORD *)&time.fields.hasValue);
  return !ItemEntity__IsEnable_39177740(ItemEntity_k__BackingField, value, 0LL);
}
