...
void __fastcall UserOwnItemInfo___ctor_41925048(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFEA9F & 1) == 0 )
  {
    sub_1C2E12C(&NetworkManager_TypeInfo, *(_QWORD *)&time.fields.hasValue);
    sub_1C2E12C(&Method_System_Nullable_long__GetValueOrDefault__, v6);
    sub_1C2E12C(&Method_System_Nullable_long__get_HasValue__, v7);
    byte_4BFEA9F = 1;
  }
  if ( !hasValue )
  {
  ...
  if ( !ItemEntity_k__BackingField )
    sub_1C2E388(0LL, *(_QWORD *)&time.fields.hasValue);
  return !ItemEntity__IsEnable_40719892(ItemEntity_k__BackingField, value, 0LL);
}
