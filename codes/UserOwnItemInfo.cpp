...
void __fastcall UserOwnItemInfo___ctor_41730824(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB59E0 & 1) == 0 )
  {
    sub_1C13D24(&NetworkManager_TypeInfo, *(_QWORD *)&time.fields.hasValue);
    sub_1C13D24(&Method_System_Nullable_long__GetValueOrDefault__, v6);
    sub_1C13D24(&Method_System_Nullable_long__get_HasValue__, v7);
    byte_4BB59E0 = 1;
  }
  if ( !hasValue )
  {
  ...
  if ( !ItemEntity_k__BackingField )
    sub_1C13F80(0LL, *(_QWORD *)&time.fields.hasValue);
  return !ItemEntity__IsEnable_40545072(ItemEntity_k__BackingField, value, 0LL);
}
