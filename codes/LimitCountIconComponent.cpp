        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEDB7E & 1) == 0 )
  {
    sub_1C7BAE8(&StringLiteral_20374/*"icon_limit_on"*/);
    this = (LimitCountIconComponent_o *)sub_1C7BAE8(&StringLiteral_20373/*"icon_limit_off"*/);
    byte_4CEDB7E = 1;
  }
  if ( limitMax <= 0 )
  {
    ...
    if ( max_length >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( !this )
          break;
        if ( v9 >= limitCount )
          v11 = (System_String_o **)&StringLiteral_20373/*"icon_limit_off"*/;
        else
          v11 = (System_String_o **)&StringLiteral_20374/*"icon_limit_on"*/;
...
void LimitCountIconComponent__Set_41610324(
        LimitCountIconComponent_o *this,
...
LABEL_15:
    sub_1C7BD40(this, limitCountIcon);
  }
}