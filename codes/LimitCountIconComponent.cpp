        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2FED7 & 1) == 0 )
  {
    sub_1C93AD4(&StringLiteral_20433/*"icon_limit_on"*/);
    this = (LimitCountIconComponent_o *)sub_1C93AD4(&StringLiteral_20432/*"icon_limit_off"*/);
    byte_4D2FED7 = 1;
  }
  if ( limitMax <= 0 )
  {
    ...
    if ( max_length >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( !this )
          break;
        if ( v9 >= limitCount )
          v11 = (System_String_o **)&StringLiteral_20432/*"icon_limit_off"*/;
        else
          v11 = (System_String_o **)&StringLiteral_20433/*"icon_limit_on"*/;
...
void LimitCountIconComponent__Set_41763552(
        LimitCountIconComponent_o *this,
...
LABEL_15:
    sub_1C93D2C(this, limitCountIcon);
  }
}