        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FAD7B & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_WaveBattleWaveServantInfoItem_EndCloseShowServant__, v6);
    byte_49FAD7B = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE930 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FAD7C & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_WaveBattleWaveServantInfoItem_EndShowEquip__, v7);
    this = (WaveBattleWaveServantInfoItem_o *)sub_1B64A00(&Method_WaveBattleWaveServantInfoItem_OpenEquipDetail__, v8);
    byte_49FAD7C = 1;
  }
  entity = 0LL;
  ...
  if ( *(__int64 *)(v10 + 32) > 0 )
  {
    ...
    this = (WaveBattleWaveServantInfoItem_o *)DataManager__GetMaster_object_((const MethodInfo_2E3BC8C *)Method_DataManager_GetMaster_UserServantMaster___);
    v11 = v2[7].monitor;
    if ( !v11 )
      goto LABEL_26;
    v12 = v11[5];
    ...
    if ( (*((_BYTE *)Method_WaveBattleWaveServantInfoItem_OpenEquipDetail__ + 83) & 2) != 0 )
      v14 = (_QWORD *)sub_1B64A18(Method_WaveBattleWaveServantInfoItem_OpenEquipDetail__);
    v16 = (System_Reflection_MethodBase_o *)sub_1B649E4(v14, v14[4]);
    if ( v15 )
    {
      OverwriteAssetSoundName__PlaySystemSe(v16, 0, 0LL);
      this = (WaveBattleWaveServantInfoItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE930 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
      v17 = v2[7].monitor;
      if ( !v17 )
        goto LABEL_26;
      v18 = v17[5];
...
LABEL_22:
    ...
    if ( (*((_BYTE *)Method_WaveBattleWaveServantInfoItem_OpenEquipDetail__ + 83) & 2) != 0 )
      v22 = (_QWORD *)sub_1B64A18(Method_WaveBattleWaveServantInfoItem_OpenEquipDetail__);
    v16 = (System_Reflection_MethodBase_o *)sub_1B649E4(v22, v22[4]);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FAD7A & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v6);
    sub_1B64A00(&Method_WaveBattleWaveServantInfoItem_EndShowServant__, v7);
    this = (WaveBattleWaveServantInfoItem_o *)sub_1B64A00(&Method_WaveBattleWaveServantInfoItem_OpenServantDetail__, v8);
    byte_49FAD7A = 1;
  }
  entity = 0LL;
  monitor = v2[7].monitor;
           ...
           (const MethodInfo_30D6998 *)Method_DataMasterBase_UserServantMaster__UserServantEntity__long__TryGetEntity__) )
    {
      ...
      if ( entity )
      {
        ...
        if ( (*((_BYTE *)Method_WaveBattleWaveServantInfoItem_OpenServantDetail__ + 83) & 2) != 0 )
          v13 = (_QWORD *)sub_1B64A18(Method_WaveBattleWaveServantInfoItem_OpenServantDetail__);
        ...
        if ( v15 )
        {
          ...
          v19 = (CommonUI_o *)this;
          v20 = (ServantStatusDialog_EndIndividualityDelegate_o *)sub_1B64C4C(ServantStatusDialog_EndIndividualityDelegate_TypeInfo);
          ...
          if ( v19 )
          {
            CommonUI__OpenServantStatusDialog_30358608(v19, 1, (UserServantEntity_o *)v17, v16, klass, v20, 1, 0LL);
            return;
          }
        }
      }
...
LABEL_12:
  ...
  if ( (*((_BYTE *)Method_WaveBattleWaveServantInfoItem_OpenServantDetail__ + 83) & 2) != 0 )
    v11 = (_QWORD *)sub_1B64A18(Method_WaveBattleWaveServantInfoItem_OpenServantDetail__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FAD78 & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_DataManager_GetMaster_UserServantCollectionMaster___, v18);
    sub_1B64A00(&Method_DataManager_GetMaster_UserServantMaster___, v19);
    sub_1B64A00(&DataManager_TypeInfo, v20);
    sub_1B64A00(&Method_DataMasterBase_UserServantMaster__UserServantEntity__long__TryGetEntity__, v21);
    sub_1B64A00(&long___TypeInfo, v22);
    sub_1B64A00(&LocalizationManager_TypeInfo, v23);
    sub_1B64A00(&NetworkManager_TypeInfo, v24);
    sub_1B64A00(&string_TypeInfo, v25);
    sub_1B64A00(&UserServantEntity_TypeInfo, v26);
    sub_1B64A00(&StringLiteral_19504/*"formation_select_small"*/, v27);
    sub_1B64A00(&StringLiteral_15442/*"WAVE_BATTLE_DISAPPEAR_SERVANT_SMALL"*/, v28);
    this = (WaveBattleWaveServantInfoItem_o *)sub_1B64A00(&StringLiteral_21307/*"member_txt_"*/, v29);
    byte_49FAD78 = 1;
  }
  entity = 0LL;
  v82 = 0LL;
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&v16->fields.servantData, (int32_t)v30, v32, v33);
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&v16->fields.callbackFunc, (int32_t)callback, v36, v37);
  ...
  this = (WaveBattleWaveServantInfoItem_o *)System_String__Concat_61385136(
                                              (System_String_o *)StringLiteral_21307/*"member_txt_"*/,
                                              v39,
                                              0LL);
  if ( !numberSprite )
    goto LABEL_89;
  ...
  this = (WaveBattleWaveServantInfoItem_o *)DataManager__GetMaster_object_((const MethodInfo_2E3BC8C *)Method_DataManager_GetMaster_UserServantCollectionMaster___);
  if ( !*p_servantData )
    goto LABEL_89;
        ...
        if ( this )
        {
          ...
          if ( !isSelectWaveFlag )
          {
            ...
            this = (WaveBattleWaveServantInfoItem_o *)AtlasManager__SetPartyOrganizationImage(
                                                        servantSetSprite,
                                                        (System_String_o *)StringLiteral_19504/*"formation_select_small"*/,
                                                        0LL);
          }
          v60 = *p_servantData;
          if ( *p_servantData )
          {
            ...
            v64 = sub_1B64AA8(long___TypeInfo, (unsigned int)v63->static_fields->SvtEquipMax);
            p_userSvtEquipIds->klass = (ServantStatusBattleListViewItem_c *)v64;
            sub_1B649A4(p_userSvtEquipIds, v64, v65, v66);
            v60 = *p_servantData;
            if ( *p_servantData )
            {
LABEL_93:
...
LABEL_89:
    ...
    else
    {
      ...
      v74 = sub_1B64AA8(long___TypeInfo, (unsigned int)v73->static_fields->SvtEquipMax);
      v54->klass = (ServantStatusBattleListViewItem_c *)v74;
      sub_1B649A4(v54, v74, v75, v76);
      if ( !*p_servantData )
        goto LABEL_89;
    ...
    v78 = v82;
    v79 = (UserServantEntity_o *)sub_1B64C4C(UserServantEntity_TypeInfo);
    UserServantEntity___ctor_39864044(v79, v78, 0LL);
  ...
  if ( !v47 || (v48 = *(_QWORD *)&v45->max_length) == 0 )
  {
    ...
    v69 = sub_1B64AA8(long___TypeInfo, (unsigned int)v68->static_fields->SvtEquipMax);
    v46->klass = (ServantStatusBattleListViewItem_c *)v69;
    sub_1B649A4(v46, v69, v70, v71);
LABEL_65:
    if ( !*p_servantData )
      goto LABEL_89;
...
LABEL_80:
    ...
    if ( this )
    {
      ...
      this = (WaveBattleWaveServantInfoItem_o *)LocalizationManager__Get((System_String_o *)StringLiteral_15442/*"WAVE_BATTLE_DISAPPEAR_SERVANT_SMALL"*/, 0LL);
      if ( maskServantLabel )
      {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FAD79 & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_15440/*"WAVE_BATTLE_DISAPPEAR_EQUIP"*/, v19);
    sub_1B64A00(&StringLiteral_20238/*"img_frames_mask14"*/, v20);
    byte_49FAD79 = 1;
  }
  entity = 0LL;
  ...
  if ( !v21 )
    goto LABEL_32;
  IconLabelInfo__Set_37830092(v21, 2, lv, LevelMax, 0, 0, 0, 0, 0LL);
  ...
  if ( isSetEquip )
  {
    ...
    {
      v29 = entity;
      v30 = (UserServantEntity_o *)sub_1B64C4C(UserServantEntity_TypeInfo);
      UserServantEntity___ctor_39864044(v30, v29, 0LL);
      LevelMax = (int64_t)this->fields.servantFaceIcon;
      if ( LevelMax )
      {
        ...
        if ( LevelMax )
        {
          ...
          if ( !AtlasManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
          AtlasManager__SetEventSprite(maskEquipSprite, (System_String_o *)StringLiteral_20238/*"img_frames_mask14"*/, 0LL);
          maskEquipLabel = this->fields.maskEquipLabel;
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          LevelMax = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_15440/*"WAVE_BATTLE_DISAPPEAR_EQUIP"*/, 0LL);
          if ( maskEquipLabel )
          {
...
LABEL_32:
      sub_1B64C5C(LevelMax, v23);
    }
  }
LABEL_25:
  LevelMax = (int64_t)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE930 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !LevelMax )
    goto LABEL_32;
  ...
  *(_QWORD *)&v38.fields.fakeValue = v34;
  LevelMax = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46182092(v38, 0LL);
  if ( !v36 )
    goto LABEL_32;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FAD76 & 1) == 0 )
  {
    sub_1B64A00(&WaveBattleWaveServantInfoItem_CallbackFunc_TypeInfo, value);
    byte_49FAD76 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  ...
  v11 = (WaveBattleWaveServantInfoItem_o *)sub_1B64F1C(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19A7B94;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19A7B3C;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FAD7E & 1) == 0 )
  {
    ...
    sub_1B64A00(&WaveBattlePartyOrganizationMenu_ResultKind_TypeInfo, v9);
    byte_49FAD7E = 1;
  }
  v14[2] = 0LL;
