        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1830B & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_WaveBattleWaveServantInfoItem_EndCloseShowServant__, v6);
    byte_4B1830B = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38F8AD8 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1830C & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_WaveBattleWaveServantInfoItem_EndShowEquip__, v8);
    this = (WaveBattleWaveServantInfoItem_o *)sub_1BCAFF8(&Method_WaveBattleWaveServantInfoItem_OpenEquipDetail__, v9);
    byte_4B1830C = 1;
  }
  entity = 0LL;
  ...
  if ( *(__int64 *)(v11 + 32) > 0 )
  {
    ...
    this = (WaveBattleWaveServantInfoItem_o *)DataManager__GetMaster_object_((const MethodInfo_301AA50 *)Method_DataManager_GetMaster_UserServantMaster___);
    v12 = v3[7].monitor;
    if ( !v12 )
      goto LABEL_26;
    v13 = v12[5];
    ...
    if ( (*((_BYTE *)Method_WaveBattleWaveServantInfoItem_OpenEquipDetail__ + 83) & 2) != 0 )
      v15 = (_QWORD *)sub_1BCB010(Method_WaveBattleWaveServantInfoItem_OpenEquipDetail__);
    v17 = (System_Reflection_MethodBase_o *)sub_1BCAFDC(v15, v15[4]);
    if ( v16 )
    {
      OverwriteAssetSoundName__PlaySystemSe(v17, 0, 0, 0LL);
      this = (WaveBattleWaveServantInfoItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38F8AD8 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
      v18 = v3[7].monitor;
      if ( !v18 )
        goto LABEL_26;
      v19 = v18[5];
      ...
      if ( *(_DWORD *)(v19 + 24) )
      {
        ...
        if ( v21 )
        {
          CommonUI__OpenServantEquipStatusDialog(v21, 11, v20, 1, v22, 0LL, 0, 0LL);
          return;
        }
LABEL_26:
...
LABEL_22:
    ...
    if ( (*((_BYTE *)Method_WaveBattleWaveServantInfoItem_OpenEquipDetail__ + 83) & 2) != 0 )
      v23 = (_QWORD *)sub_1BCB010(Method_WaveBattleWaveServantInfoItem_OpenEquipDetail__);
    v17 = (System_Reflection_MethodBase_o *)sub_1BCAFDC(v23, v23[4]);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1830A & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&ServantStatusDialog_EndIndividualityDelegate_TypeInfo, v5);
    sub_1BCAFF8(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v6);
    sub_1BCAFF8(&Method_WaveBattleWaveServantInfoItem_EndShowServant__, v7);
    this = (WaveBattleWaveServantInfoItem_o *)sub_1BCAFF8(&Method_WaveBattleWaveServantInfoItem_OpenServantDetail__, v8);
    byte_4B1830A = 1;
  }
  entity = 0LL;
           ...
           (const MethodInfo_32CA3A8 *)Method_DataMasterBase_UserServantMaster__UserServantEntity__long__TryGetEntity__) )
    {
      ...
      if ( entity )
      {
        ...
        if ( (*((_BYTE *)Method_WaveBattleWaveServantInfoItem_OpenServantDetail__ + 83) & 2) != 0 )
          v13 = (_QWORD *)sub_1BCB010(Method_WaveBattleWaveServantInfoItem_OpenServantDetail__);
        ...
        if ( v15 )
        {
          ...
          v19 = (CommonUI_o *)this;
          v20 = (ServantStatusDialog_EndIndividualityDelegate_o *)sub_1BCB244(ServantStatusDialog_EndIndividualityDelegate_TypeInfo);
...
LABEL_12:
  ...
  if ( (*((_BYTE *)Method_WaveBattleWaveServantInfoItem_OpenServantDetail__ + 83) & 2) != 0 )
    v11 = (_QWORD *)sub_1BCB010(Method_WaveBattleWaveServantInfoItem_OpenServantDetail__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18308 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&BalanceConfig_TypeInfo, v17);
    sub_1BCAFF8(&Method_DataManager_GetMaster_UserServantCollectionMaster___, v18);
    sub_1BCAFF8(&Method_DataManager_GetMaster_UserServantMaster___, v19);
    sub_1BCAFF8(&DataManager_TypeInfo, v20);
    sub_1BCAFF8(&Method_DataMasterBase_UserServantMaster__UserServantEntity__long__TryGetEntity__, v21);
    sub_1BCAFF8(&long___TypeInfo, v22);
    sub_1BCAFF8(&LocalizationManager_TypeInfo, v23);
    sub_1BCAFF8(&NetworkManager_TypeInfo, v24);
    sub_1BCAFF8(&string_TypeInfo, v25);
    sub_1BCAFF8(&UserServantEntity_TypeInfo, v26);
    sub_1BCAFF8(&StringLiteral_19441/*"formation_select_small"*/, v27);
    sub_1BCAFF8(&StringLiteral_15372/*"WAVE_BATTLE_DISAPPEAR_SERVANT_SMALL"*/, v28);
    this = (WaveBattleWaveServantInfoItem_o *)sub_1BCAFF8(&StringLiteral_21338/*"member_txt_"*/, v29);
    byte_4B18308 = 1;
  }
  entity = 0LL;
  v83 = 0LL;
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&v16->fields.servantData, (int32_t)v30, v32, v33);
  v16->fields.questRestrictionInfo = questRestrictionInfo;
  sub_1BCAF9C((CGThumbnailListItem_o *)&v16->fields.questRestrictionInfo, (int32_t)questRestrictionInfo, v34, v35);
  v16->fields.callbackFunc = callback;
  sub_1BCAF9C((CGThumbnailListItem_o *)&v16->fields.callbackFunc, (int32_t)callback, v36, v37);
  ...
  this = (WaveBattleWaveServantInfoItem_o *)System_String__Concat_62450424(
                                              (System_String_o *)StringLiteral_21338/*"member_txt_"*/,
                                              v39,
                                              0LL);
  if ( !numberSprite )
    goto LABEL_93;
  ...
  this = (WaveBattleWaveServantInfoItem_o *)DataManager__GetMaster_object_((const MethodInfo_301AA50 *)Method_DataManager_GetMaster_UserServantCollectionMaster___);
  if ( !*p_servantData )
    goto LABEL_93;
...
LABEL_37:
    ...
    if ( !byte_4B165D1 )
    {
      sub_1BCAFF8(&NetworkManager_TypeInfo, *(_QWORD *)&idx);
      byte_4B165D1 = 1;
    }
        ...
        if ( this )
        {
          ...
          if ( !isSelectWaveFlag )
          {
            ...
            this = (WaveBattleWaveServantInfoItem_o *)AtlasManager__SetPartyOrganizationImage(
                                                        servantSetSprite,
                                                        (System_String_o *)StringLiteral_19441/*"formation_select_small"*/,
                                                        0LL);
          }
          v61 = *p_servantData;
          if ( *p_servantData )
          {
            ...
            v65 = sub_1BCB0A0(long___TypeInfo, (unsigned int)v64->static_fields->SvtEquipMax);
            p_userSvtEquipIds->klass = (CGThumbnailListItem_c *)v65;
            sub_1BCAF9C(p_userSvtEquipIds, v65, v66, v67);
            v61 = *p_servantData;
            if ( *p_servantData )
            {
LABEL_97:
...
LABEL_93:
    ...
    else
    {
      ...
      v75 = sub_1BCB0A0(long___TypeInfo, (unsigned int)v74->static_fields->SvtEquipMax);
      v55->klass = (CGThumbnailListItem_c *)v75;
      sub_1BCAF9C(v55, v75, v76, v77);
      if ( !*p_servantData )
        goto LABEL_93;
    ...
    v79 = v83;
    v80 = (UserServantEntity_o *)sub_1BCB244(UserServantEntity_TypeInfo);
    UserServantEntity___ctor_42294904(v80, v79, 0LL);
  ...
  if ( !v48 || (v49 = *(_QWORD *)&v46->max_length) == 0 )
  {
    ...
    v70 = sub_1BCB0A0(long___TypeInfo, (unsigned int)v69->static_fields->SvtEquipMax);
    v47->klass = (CGThumbnailListItem_c *)v70;
    sub_1BCAF9C(v47, v70, v71, v72);
LABEL_69:
    if ( !*p_servantData )
      goto LABEL_93;
...
LABEL_94:
    sub_1BCB25C(this, *(_QWORD *)&idx, v43);
  }
  if ( !(_DWORD)v49 )
    goto LABEL_94;
  v50 = v46->m_Items[0];
...
LABEL_84:
    ...
    if ( this )
    {
      ...
      this = (WaveBattleWaveServantInfoItem_o *)LocalizationManager__Get((System_String_o *)StringLiteral_15372/*"WAVE_BATTLE_DISAPPEAR_SERVANT_SMALL"*/, 0LL);
      if ( maskServantLabel )
      {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18309 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&UserServantEntity_TypeInfo, v18);
    sub_1BCAFF8(&StringLiteral_15370/*"WAVE_BATTLE_DISAPPEAR_EQUIP"*/, v19);
    sub_1BCAFF8(&StringLiteral_20219/*"img_frames_mask14"*/, v20);
    byte_4B18309 = 1;
  }
  entity = 0LL;
  ...
  if ( !v21 )
    goto LABEL_36;
  IconLabelInfo__Set_40103972(v21, 2, lv, (int32_t)LevelMax, 0, 0, 0, 0, 0, 0LL);
  ...
  if ( isSetEquip )
  {
    ...
    {
      v30 = entity;
      v31 = (UserServantEntity_o *)sub_1BCB244(UserServantEntity_TypeInfo);
      UserServantEntity___ctor_42294904(v31, v30, 0LL);
      LevelMax = this->fields.servantFaceIcon;
      if ( LevelMax )
      {
        ...
        if ( LevelMax )
        {
          ...
          if ( !AtlasManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
          AtlasManager__SetEventSprite(maskEquipSprite, (System_String_o *)StringLiteral_20219/*"img_frames_mask14"*/, 0LL);
          maskEquipLabel = this->fields.maskEquipLabel;
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          LevelMax = LocalizationManager__Get((System_String_o *)StringLiteral_15370/*"WAVE_BATTLE_DISAPPEAR_EQUIP"*/, 0LL);
          if ( maskEquipLabel )
          {
...
LABEL_36:
      sub_1BCB254(LevelMax, v23);
    }
  }
LABEL_29:
  LevelMax = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38F8AD8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !LevelMax )
    goto LABEL_36;
  ...
  *(_QWORD *)&v39.fields.fakeValue = v35;
  LevelMax = (void *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48125176(v39, 0LL);
  if ( !v37 )
    goto LABEL_36;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18306 & 1) == 0 )
  {
    sub_1BCAFF8(&WaveBattleWaveServantInfoItem_CallbackFunc_TypeInfo, value);
    byte_4B18306 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  ...
  v11 = (WaveBattleWaveServantInfoItem_o *)sub_1BCB514(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A103F4;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A1039C;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1830E & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&WaveBattlePartyOrganizationMenu_ResultKind_TypeInfo, v9);
    byte_4B1830E = 1;
  }
  v14[2] = 0LL;
