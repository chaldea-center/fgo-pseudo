        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C52B8B & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1C3E564(&Method_WaveBattleWaveServantInfoItem_EndCloseShowServant__);
    byte_4C52B8B = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39FF5A8 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
...
void WaveBattleWaveServantInfoItem__OpenEquipDetail(WaveBattleWaveServantInfoItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C52B8C & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1C3E564(&Method_WaveBattleWaveServantInfoItem_EndShowEquip__);
    this = (WaveBattleWaveServantInfoItem_o *)sub_1C3E564(&Method_WaveBattleWaveServantInfoItem_OpenEquipDetail__);
    byte_4C52B8C = 1;
  }
  entity = 0;
  ...
  if ( *(__int64 *)(v4 + 32) > 0 )
  {
    ...
    this = (WaveBattleWaveServantInfoItem_o *)DataManager__GetMaster_object_((const MethodInfo_30F9A1C *)Method_DataManager_GetMaster_UserServantMaster___);
    v5 = v2[7].monitor;
    if ( !v5 )
      goto LABEL_26;
    v6 = v5[5];
    ...
    if ( (*((_BYTE *)Method_WaveBattleWaveServantInfoItem_OpenEquipDetail__ + 83) & 2) != 0 )
      v8 = (_QWORD *)sub_1C3E57C(Method_WaveBattleWaveServantInfoItem_OpenEquipDetail__);
    v10 = (System_Reflection_MethodBase_o *)sub_1C3E548(v8, v8[4]);
    if ( v9 )
    {
      OverwriteAssetSoundName__PlaySystemSe(v10, 0, 0, 0);
      this = (WaveBattleWaveServantInfoItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39FF5A8 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
      v11 = v2[7].monitor;
      if ( !v11 )
        goto LABEL_26;
      v12 = v11[5];
...
LABEL_22:
    ...
    if ( (*((_BYTE *)Method_WaveBattleWaveServantInfoItem_OpenEquipDetail__ + 83) & 2) != 0 )
      v16 = (_QWORD *)sub_1C3E57C(Method_WaveBattleWaveServantInfoItem_OpenEquipDetail__);
    v10 = (System_Reflection_MethodBase_o *)sub_1C3E548(v16, v16[4]);
  }
...
void WaveBattleWaveServantInfoItem__OpenServantDetail(WaveBattleWaveServantInfoItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C52B8A & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1C3E564(&Method_WaveBattleWaveServantInfoItem_EndShowServant__);
    this = (WaveBattleWaveServantInfoItem_o *)sub_1C3E564(&Method_WaveBattleWaveServantInfoItem_OpenServantDetail__);
    byte_4C52B8A = 1;
  }
  entity = 0;
  monitor = v2[7].monitor;
           ...
           (const MethodInfo_33B5500 *)Method_DataMasterBase_UserServantMaster__UserServantEntity__long__TryGetEntity__) )
    {
      ...
      if ( entity )
      {
        ...
        if ( (*((_BYTE *)Method_WaveBattleWaveServantInfoItem_OpenServantDetail__ + 83) & 2) != 0 )
          v7 = (_QWORD *)sub_1C3E57C(Method_WaveBattleWaveServantInfoItem_OpenServantDetail__);
        ...
        if ( v9 )
        {
          ...
          v13 = (CommonUI_o *)this;
          v14 = (ServantStatusDialog_EndIndividualityDelegate_o *)sub_1C3E7B0(ServantStatusDialog_EndIndividualityDelegate_TypeInfo);
...
LABEL_12:
  ...
  if ( (*((_BYTE *)Method_WaveBattleWaveServantInfoItem_OpenServantDetail__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1C3E57C(Method_WaveBattleWaveServantInfoItem_OpenServantDetail__);
        ...
        const MethodInfo *method)
{
  ...
  if ( !isSelectWaveFlag )
  {
    ...
    servantSetSprite = (UnityEngine_Component_o *)AtlasManager__SetPartyOrganizationImage(
                                                    v6,
                                                    (System_String_o *)StringLiteral_19633/*"formation_select_small"*/,
                                                    0);
  }
  ...
  if ( !userSvtEquipIds || !userSvtEquipIds->max_length )
  {
    ...
    v11 = sub_1C3E60C(long___TypeInfo, (unsigned int)v10->static_fields->SvtEquipMax);
    p_userSvtEquipIds->klass = (CGThumbnailListItem_c *)v11;
    sub_1C3E508(p_userSvtEquipIds, v11, v12, v13);
    servantData = this->fields.servantData;
    if ( !servantData )
      goto LABEL_22;
  }
  ...
  if ( !LODWORD(v14->max_length) )
    sub_1C3E7C8(servantSetSprite, isSelectWaveFlag);
  v14->m_Items[0] = 0;
  ...
  {
LABEL_22:
    sub_1C3E7C0(servantSetSprite, isSelectWaveFlag);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C52B87 & 1) == 0 )
  {
    ...
    this = (WaveBattleWaveServantInfoItem_o *)sub_1C3E564(&StringLiteral_21549/*"member_txt_"*/);
    byte_4C52B87 = 1;
  }
  entity = 0;
  v63 = 0;
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&v16->fields.servantData, (int32_t)v17, v19, v20);
  v16->fields.questRestrictionInfo = questRestrictionInfo;
  sub_1C3E508((CGThumbnailListItem_o *)&v16->fields.questRestrictionInfo, (int32_t)questRestrictionInfo, v21, v22);
  v16->fields.callbackFunc = callback;
  sub_1C3E508((CGThumbnailListItem_o *)&v16->fields.callbackFunc, (int32_t)callback, v23, v24);
  ...
  this = (WaveBattleWaveServantInfoItem_o *)System_String__Concat_63636468(
                                              (System_String_o *)StringLiteral_21549/*"member_txt_"*/,
                                              v26,
                                              0);
  if ( !numberSprite )
    goto LABEL_84;
  ...
  this = (WaveBattleWaveServantInfoItem_o *)DataManager__GetMaster_object_((const MethodInfo_30F9A1C *)Method_DataManager_GetMaster_UserServantCollectionMaster___);
  if ( !*p_servantData )
    goto LABEL_84;
      ...
      if ( v38->fields.userSvtId >= 1 && v38->fields.svtId >= 1 )
      {
               ...
               0) )
        {
          ...
          else
          {
            ...
            v52 = sub_1C3E60C(long___TypeInfo, (unsigned int)v51->static_fields->SvtEquipMax);
            p_userSvtEquipIds->klass = (CGThumbnailListItem_c *)v52;
            sub_1C3E508(p_userSvtEquipIds, v52, v53, v54);
            if ( !*p_servantData )
              goto LABEL_84;
          ...
          if ( !DataManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
          this = (WaveBattleWaveServantInfoItem_o *)DataManager__GetMaster_object_((const MethodInfo_30F9A1C *)Method_DataManager_GetMaster_UserServantStorageMaster___);
          if ( !this )
            goto LABEL_84;
          if ( DataMasterBase_object__object__long___TryGetEntity(
                 (DataMasterBase_TMaster__TEntity__PKType__o *)this,
          ...
          {
            v58 = v61;
            v57 = (Il2CppObject *)sub_1C3E7B0(UserServantEntity_TypeInfo);
            UserServantEntity___ctor_43211008((UserServantEntity_o *)v57, v58, 1, 0);
          }
          entity = v57;
...
LABEL_50:
  ...
  if ( !v34 || (v35 = v32->max_length) == 0 )
  {
    ...
    v47 = sub_1C3E60C(long___TypeInfo, (unsigned int)v46->static_fields->SvtEquipMax);
    v33->klass = (CGThumbnailListItem_c *)v47;
    sub_1C3E508(v33, v47, v48, v49);
LABEL_54:
    if ( !*p_servantData )
      goto LABEL_84;
...
LABEL_75:
    ...
    if ( this )
    {
      ...
      this = (WaveBattleWaveServantInfoItem_o *)LocalizationManager__Get((System_String_o *)StringLiteral_15506/*"WAVE_BATTLE_DISAPPEAR_SERVANT_SMALL"*/, 0);
      if ( maskServantLabel )
      {
        ...
        const MethodInfo *method)
{
  ...
  if ( !v9 )
    goto LABEL_36;
  IconLabelInfo__Set_40964356(v9, 2, lv, (int32_t)LevelMax, 0, 0, 0, 0, 0, 0);
  servantData = this->fields.servantData;
  if ( !servantData )
    goto LABEL_36;
  ...
  if ( isSetEquip )
  {
    ...
    {
      v17 = entity;
      v18 = (UserServantEntity_o *)sub_1C3E7B0(UserServantEntity_TypeInfo);
      UserServantEntity___ctor_43211008(v18, v17, 0, 0);
      LevelMax = this->fields.servantFaceIcon;
      if ( LevelMax )
      {
        ...
        if ( LevelMax )
        {
          ...
          if ( !AtlasManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
          AtlasManager__SetEventSprite(maskEquipSprite, (System_String_o *)StringLiteral_20422/*"img_frames_mask14"*/, 0);
          maskEquipLabel = this->fields.maskEquipLabel;
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          LevelMax = LocalizationManager__Get((System_String_o *)StringLiteral_15504/*"WAVE_BATTLE_DISAPPEAR_EQUIP"*/, 0);
          if ( maskEquipLabel )
          {
...
LABEL_36:
      sub_1C3E7C0(LevelMax, v11);
    }
  }
LABEL_29:
  LevelMax = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39FF5A8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !LevelMax )
    goto LABEL_36;
  ...
  *(_QWORD *)&v26.fields.fakeValue = v22;
  LevelMax = (void *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49004136(v26, 0);
  if ( !v24 )
    goto LABEL_36;
        ...
        const MethodInfo *method)
{
  ...
  v11 = (WaveBattleWaveServantInfoItem_o *)sub_1C3EA80(v8);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1A7DD70;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A7DD18;
}
