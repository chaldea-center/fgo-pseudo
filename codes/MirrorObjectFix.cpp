void __fastcall MirrorObjectFix___ctor(MirrorObjectFix_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42AFA2E & 1) == 0 )
  {
    sub_B52984(&StringLiteral_20222/*"joint_all_Base/joint_all"*/);
    byte_42AFA2E = 1;
  }
  v12.fields.y = 0.78;
  v13.fields.x = 0.2;
  ...
  *(_OWORD *)&this->fields.mirrorBounds.fields.m_Center.fields.y = v3;
  v4 = (System_Int32_array **)StringLiteral_20222/*"joint_all_Base/joint_all"*/;
  this->fields.rootTransformPath = (struct System_String_o *)StringLiteral_20222/*"joint_all_Base/joint_all"*/;
  sub_B52920((BattleServantConfConponent_o *)&this->fields.rootTransformPath, v4, v5, v6, v7, v8, v9, v10);
