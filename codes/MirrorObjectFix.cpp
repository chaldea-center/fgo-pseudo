void __fastcall MirrorObjectFix___ctor(MirrorObjectFix_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C006C7 & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_21338/*"joint_all_Base/joint_all"*/, method);
    byte_4C006C7 = 1;
  }
  *(_OWORD *)&this->fields.mirrorBounds.fields.m_Center.fields.x = xmmword_C058A0;
  *(_QWORD *)&this->fields.mirrorBounds.fields.m_Extents.fields.y = 0x3E99999A3F333333LL;
  v9 = StringLiteral_21338/*"joint_all_Base/joint_all"*/;
  this->fields.rootTransformPath = (struct System_String_o *)StringLiteral_21338/*"joint_all_Base/joint_all"*/;
  sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.rootTransformPath, v9, v2, v3, v4, v5, v6, v7);
...
LABEL_14:
    ...
    *p_cacheRootTransform = v12;
    sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.cacheRootTransform, (int64_t)v12, v6, v7, v8, v9, v10, v11);
    goto LABEL_14;
  }
  return *p_cacheRootTransform;
}