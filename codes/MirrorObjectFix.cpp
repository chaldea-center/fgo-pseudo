void __fastcall MirrorObjectFix___ctor(MirrorObjectFix_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FF073 & 1) == 0 )
  {
    sub_1B640C8(&StringLiteral_20868/*"joint_all_Base/joint_all"*/, method);
    byte_49FF073 = 1;
  }
  *(_OWORD *)&this->fields.mirrorBounds.fields.m_Center.fields.x = xmmword_BA24E0;
  *(_QWORD *)&this->fields.mirrorBounds.fields.m_Extents.fields.y = 0x3E99999A3F333333LL;
  v5 = StringLiteral_20868/*"joint_all_Base/joint_all"*/;
  this->fields.rootTransformPath = (struct System_String_o *)StringLiteral_20868/*"joint_all_Base/joint_all"*/;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.rootTransformPath, v5, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  v10.fields.y = y;
  v10.fields.z = z;
  retstr->fields.m_Center = UnityEngine_Transform__TransformPoint(RootTransform, v10, 0LL);
...
LABEL_14:
    ...
    *p_cacheRootTransform = v8;
    sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.cacheRootTransform, (int32_t)v8, v6, v7);
    goto LABEL_14;
  }
  return *p_cacheRootTransform;
}