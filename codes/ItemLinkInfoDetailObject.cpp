  ...
  if ( itemEnt )
  {
    ...
    if ( !itemDetailLabel
      || (UILabel__set_text(itemDetailLabel, itemEnt->fields.detail, 0LL),
          ...
          !itemIcon) )
    {
      sub_1B68930(itemDetailLabel, itemEnt);
    }
...
void __fastcall ItemLinkInfoDetailObject__SetupStoneDetail(ItemLinkInfoDetailObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0AE86 & 1) == 0 )
  {
    sub_1B686D4(&Method_DataManager_GetMaster_UserExternalPaymentStoneMaster___, method);
  ...
  if ( UserGameMaster__TryGetSelfUserGame(&entity, 0LL) )
  {
    ...
    Master_object = DataManager__GetMaster_object_((const MethodInfo_2E49CFC *)Method_DataManager_GetMaster_UserExternalPaymentStoneMaster___);
