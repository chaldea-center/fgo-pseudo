...
void __fastcall ItemLinkInfoDetailObject__SetupStoneDetail(ItemLinkInfoDetailObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1EE73 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMaster_UserExternalPaymentStoneMaster___, method);
  ...
  if ( UserGameMaster__TryGetSelfUserGame(&entity, 0LL) )
  {
    ...
    Master_object = DataManager__GetMaster_object_((const MethodInfo_301AA50 *)Method_DataManager_GetMaster_UserExternalPaymentStoneMaster___);
