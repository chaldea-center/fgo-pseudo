        ...
        const MethodInfo *method)
{
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.assetPath, (int32_t)assetPath, v7, v8);
  this->fields.loadWrapper = loadWrapper;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.loadWrapper, (int32_t)loadWrapper, v9, v10);
  this->fields.atlasList = 0LL;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.atlasList, 0, v11, v12);
  this->fields.assetData = 0LL;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.assetData, 0, v13, v14);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4D65B & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_System_Collections_Generic_List_UIAtlas__Add__, v5);
    sub_1B863B8(&Method_System_Collections_Generic_List_UIAtlas__ToArray__, v6);
    sub_1B863B8(&Method_System_Collections_Generic_List_UIAtlas___ctor__, v7);
    sub_1B863B8(&System_Collections_Generic_List_UIAtlas__TypeInfo, v8);
    this = (AtlasManagerUnit_o *)sub_1B863B8(&UnityEngine_Object_TypeInfo, v9);
    byte_4A4D65B = 1;
  }
  if ( !assetData )
    goto LABEL_22;
    ...
    while ( 1 )
    {
      ...
      if ( ((unsigned __int8)this & 1) == 0 )
      {
        ...
        else
        {
          ...
          sub_1B8635C((CGThumbnailListItem_o *)(v21 + 4), (int32_t)Component_object, v16, v17);
        }
      }
      max_length = v11->max_length;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4D658 & 1) == 0 )
  {
    sub_1B863B8(&System_Action_TypeInfo, finishCallback);
    sub_1B863B8(&AssetManager_TypeInfo, v7);
    sub_1B863B8(&Method_AtlasManagerUnit_LoadEnd__, v8);
...
LABEL_9:
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.LoadFinishCallback, (int32_t)v12, v13, v14);
...
void __fastcall AtlasManagerUnit__LoadEnd(AtlasManagerUnit_o *this, AssetData_o *assetData, const MethodInfo *method)
{
  ...
  if ( this->fields.IsLoading )
  {
    ...
    sub_1B8635C((CGThumbnailListItem_o *)&this->fields.assetData, (int32_t)assetData, (int32_t)method, v3);
    ...
    sub_1B8635C((CGThumbnailListItem_o *)&this->fields.atlasList, (int32_t)UIAtlasListFromAssetData, v9, v10);
  }
  ...
  if ( LoadFinishCallback )
  {
    ...
    sub_1B8635C(p_LoadFinishCallback, 0, (int32_t)method, v3);
...
void __fastcall AtlasManagerUnit__Release(AtlasManagerUnit_o *this, const MethodInfo *method)
{
  ...
  this->fields.atlasList = 0LL;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.atlasList, 0, (int32_t)v2, v3);
  this->fields.assetData = 0LL;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.assetData, 0, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4D65A & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Linq_Enumerable_Select_UIAtlas__string___, spriteName);
    sub_1B863B8(&System_Func_UIAtlas__string__TypeInfo, v5);
    sub_1B863B8(&Method_AtlasManagerUnit___c__ValidateLoadSprite_b__11_0__, v6);
    sub_1B863B8(&AtlasManagerUnit___c_TypeInfo, v7);
    sub_1B863B8(&StringLiteral_817/*","*/, v8);
    byte_4A4D65A = 1;
  }
  IsNullOrEmpty = (UISpriteData_o *)System_String__IsNullOrEmpty(spriteName, 0LL);
...
LABEL_12:
    ...
    v17 = (System_String_o *)StringLiteral_817/*","*/;
    if ( !_9__11_0 )
    {
      ...
      _9__11_0 = (System_Func_object__object__o *)sub_1B86604(System_Func_UIAtlas__string__TypeInfo);
      ...
      sub_1B8635C((CGThumbnailListItem_o *)&static_fields->__9__11_0, (int32_t)_9__11_0, v20, v21);
    }
    v22 = (System_Collections_Generic_IEnumerable_string__o *)System_Linq_Enumerable__Select_object__object_(
                                                                ...
                                                                (const MethodInfo_2FA1274 *)Method_System_Linq_Enumerable_Select_UIAtlas__string___);
    System_String__Join_61687752(v17, v22, 0LL);
    return 0;
  }
  v13 = 0LL;
  while ( 1 )
...
void __fastcall AtlasManagerUnit___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A4D65C & 1) == 0 )
  {
    sub_1B863B8(&AtlasManagerUnit___c_TypeInfo, v1);
    byte_4A4D65C = 1;
  }
  v2 = (Il2CppObject *)sub_1B86604(AtlasManagerUnit___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  AtlasManagerUnit___c_TypeInfo->static_fields->__9 = (struct AtlasManagerUnit___c_o *)v2;
  sub_1B8635C((CGThumbnailListItem_o *)AtlasManagerUnit___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
