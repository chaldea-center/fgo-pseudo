        ...
        const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.assetPath, (int32_t)assetPath, v7, v8);
  this->fields.loadWrapper = loadWrapper;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.loadWrapper, (int32_t)loadWrapper, v9, v10);
  this->fields.atlasList = 0;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.atlasList, 0, v11, v12);
  this->fields.assetData = 0;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.assetData, 0, v13, v14);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C36ADF & 1) == 0 )
  {
    ...
    this = (AtlasManagerUnit_o *)sub_1C32C20(&UnityEngine_Object_TypeInfo);
    byte_4C36ADF = 1;
  }
  if ( !assetData )
    goto LABEL_22;
    ...
    while ( 1 )
    {
      ...
      if ( ((unsigned __int8)this & 1) == 0 )
      {
        ...
        else
        {
          ...
          sub_1C32BC4((CGThumbnailListItem_o *)(v15 + 4), (int32_t)Component_object, v10, v11);
        }
      }
      max_length = v5->max_length;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C36ADC & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_AtlasManagerUnit_LoadEnd__);
...
LABEL_9:
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.LoadFinishCallback, (int32_t)v9, v10, v11);
...
void AtlasManagerUnit__LoadEnd(AtlasManagerUnit_o *this, AssetData_o *assetData, const MethodInfo *method)
{
  ...
  if ( this->fields.IsLoading )
  {
    ...
    sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.assetData, (int32_t)assetData, (int32_t)method, v3);
    ...
    sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.atlasList, (int32_t)UIAtlasListFromAssetData, v9, v10);
  }
  ...
  if ( LoadFinishCallback )
  {
    ...
    sub_1C32BC4(p_LoadFinishCallback, 0, (int32_t)method, v3);
...
void AtlasManagerUnit__Release(AtlasManagerUnit_o *this, const MethodInfo *method)
{
  ...
  this->fields.atlasList = 0;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.atlasList, 0, v2, v3);
  this->fields.assetData = 0;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.assetData, 0, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C36ADE & 1) == 0 )
  {
    sub_1C32C20(&Method_System_Linq_Enumerable_Select_UIAtlas__string___);
    sub_1C32C20(&System_Func_UIAtlas__string__TypeInfo);
    sub_1C32C20(&Method_AtlasManagerUnit___c__ValidateLoadSprite_b__11_0__);
    sub_1C32C20(&AtlasManagerUnit___c_TypeInfo);
...
LABEL_12:
    ...
    if ( !_9__11_0 )
    {
      ...
      _9__11_0 = (System_Func_object__object__o *)sub_1C32E6C(System_Func_UIAtlas__string__TypeInfo);
      ...
      sub_1C32BC4((CGThumbnailListItem_o *)&static_fields->__9__11_0, (int32_t)_9__11_0, v15, v16);
    }
    v17 = (System_Collections_Generic_IEnumerable_string__o *)System_Linq_Enumerable__Select_object__object_(
                                                                ...
                                                                (const MethodInfo_3113ABC *)Method_System_Linq_Enumerable_Select_UIAtlas__string___);
    System_String__Join_63561120(v12, v17, 0);
    return 0;
  }
  v8 = 0;
  while ( 1 )
...
void AtlasManagerUnit___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C32E6C(AtlasManagerUnit___c_TypeInfo);
  System_Object___ctor(v1, 0);
  AtlasManagerUnit___c_TypeInfo->static_fields->__9 = (struct AtlasManagerUnit___c_o *)v1;
  sub_1C32BC4((CGThumbnailListItem_o *)AtlasManagerUnit___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
