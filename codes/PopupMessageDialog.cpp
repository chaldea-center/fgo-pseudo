...
void __fastcall PopupMessageDialog__OnClickClose(PopupMessageDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3EEFB & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_PopupMessageDialog_EndClose__, v3);
    sub_1BDB878(&Method_PopupMessageDialog_OnClickClose__, v4);
    byte_4B3EEFB = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3EEFA & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_PopupMessageDialog_EndOpen__, v7);
    sub_1BDB878(&UICamera_TypeInfo, v8);
  ...
  *(UnityEngine_Vector3_o *)&v19 = UnityEngine_Camera__ScreenToWorldPoint_70090032(this->fields.dialogCamera, v45, 0LL);
  baseWindow = this->fields.baseWindow;
  if ( !baseWindow )
    goto LABEL_66;
  v22 = v19;
  ...
  *(UnityEngine_Vector3_o *)(&v39 - 2) = UnityEngine_Transform__get_localPosition(
  ...
  {
LABEL_66:
    sub_1BDBAD4(baseWindow, message);
  }
