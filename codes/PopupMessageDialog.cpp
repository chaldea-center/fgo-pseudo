...
void PopupMessageDialog__OnClickClose(PopupMessageDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFE6E7 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_PopupMessageDialog_EndClose__);
    sub_1CE6700(&Method_PopupMessageDialog_OnClickClose__);
    byte_4DFE6E7 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_PopupMessageDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_PopupMessageDialog_OnClickClose__);
...
void PopupMessageDialog__Open(PopupMessageDialog_o *this, System_String_o *message, const MethodInfo *method)
{
  ...
  if ( (byte_4DFE6E6 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_PopupMessageDialog_EndOpen__);
  ...
  v37 = UnityEngine_Camera__ScreenToWorldPoint_72722736(this->fields.dialogCamera, v36, 0);
  baseWindow = this->fields.baseWindow;
  if ( !baseWindow )
    goto LABEL_66;
  x = v37.fields.x;
  ...
  {
LABEL_66:
    sub_1CE6958(baseWindow, message);
  }
