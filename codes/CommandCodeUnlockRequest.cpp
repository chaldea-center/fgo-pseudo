        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5C9A9 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_18153/*"commandCode/unlock"*/);
    byte_4A5C9A9 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61707032(BaseUrl, (System_String_o *)StringLiteral_18153/*"commandCode/unlock"*/, 0LL);
}
