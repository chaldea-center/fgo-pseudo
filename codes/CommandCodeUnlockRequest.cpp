        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0131 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_17723/*"commandCode/unlock"*/);
    byte_42B0131 = 1;
  }
  ...
  return System_String__Concat_44568316(BaseUrl, (System_String_o *)StringLiteral_17723/*"commandCode/unlock"*/, 0LL);
}
