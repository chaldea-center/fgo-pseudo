        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4214869 & 1) == 0 )
  {
    ...
    sub_B0D8A4(&StringLiteral_17654/*"commandCode/unlock"*/, v2);
    byte_4214869 = 1;
  }
  ...
  return System_String__Concat_43849904(BaseUrl, (System_String_o *)StringLiteral_17654/*"commandCode/unlock"*/, 0LL);
}
