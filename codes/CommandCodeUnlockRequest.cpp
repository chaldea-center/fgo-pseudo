        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC93A0 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_18448/*"commandCode/unlock"*/, v2);
    byte_4BC93A0 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63040368(BaseUrl, (System_String_o *)StringLiteral_18448/*"commandCode/unlock"*/, 0LL);
}
