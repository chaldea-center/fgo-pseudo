        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB759F & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_18183/*"commandCode/unlock"*/, v2);
    byte_4AB759F = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62048128(BaseUrl, (System_String_o *)StringLiteral_18183/*"commandCode/unlock"*/, 0LL);
}
