void __fastcall RandomLimitCountManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A4A17A & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Collections_Generic_Dictionary_string__int___ctor__, v1);
    sub_1B863B8(&System_Collections_Generic_Dictionary_string__int__TypeInfo, v2);
  ...
  sub_1B8635C((CGThumbnailListItem_o *)RandomLimitCountManager_TypeInfo->static_fields, (int32_t)v4, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A176 & 1) == 0 )
  {
    sub_1B863B8(&string___TypeInfo, userSvtId);
    sub_1B863B8(&StringLiteral_1468/*":"*/, v4);
    byte_4A4A176 = 1;
  }
  v5 = sub_1B86460(string___TypeInfo, 5LL);
  ...
  *(_QWORD *)(v5 + 40) = StringLiteral_1468/*":"*/;
  sub_1B8635C((CGThumbnailListItem_o *)(v5 + 40), v12, v10, v11);
  v6 = System_Int64__ToString((int64_t)&v22, 0LL);
  if ( *(_DWORD *)(v5 + 24) <= 2u
    || (*(_QWORD *)(v5 + 48) = v6,
        sub_1B8635C((CGThumbnailListItem_o *)(v5 + 48), (int32_t)v6, v13, v14),
        *(_DWORD *)(v5 + 24) <= 3u)
    || (v17 = StringLiteral_1468/*":"*/,
        *(_QWORD *)(v5 + 56) = StringLiteral_1468/*":"*/,
        sub_1B8635C((CGThumbnailListItem_o *)(v5 + 56), v17, v15, v16),
...
LABEL_10:
  ...
  *(_QWORD *)(v5 + 64) = v6;
  sub_1B8635C((CGThumbnailListItem_o *)(v5 + 64), (int32_t)v6, v18, v19);
  return System_String__Concat_61685692((System_String_array *)v5, 0LL);
}
...
int32_t __fastcall RandomLimitCountManager__GetChoiceLimitCount(UserServantEntity_o *entity, const MethodInfo *method)
{
  ...
  __int64 v61; // x25
  int32_t v62; // w0
  System_Int32_array *CostumeList_41213564; // x0
  ...
  if ( (byte_4A4A178 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_DataManager_GetMaster_ServantCostumeMaster___, v5);
    sub_1B863B8(&Method_DataManager_GetMaster_ServantLimitAddMaster___, v6);
    sub_1B863B8(&DataManager_TypeInfo, v7);
    sub_1B863B8(&Method_System_Collections_Generic_Dictionary_string__int__Add__, v8);
    ...
    sub_1B863B8(&RandomLimitCountManager_TypeInfo, v18);
  ...
  if ( entity )
  {
    ...
    *(_QWORD *)&v93.fields.fakeValue = v20;
    if ( CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47434244(v93, 0LL) )
    {
      ...
      *(_QWORD *)&v94.fields.fakeValue = v22;
      ...
      v25 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47434244(v94, 0LL);
      ...
      if ( v25 <= v26->static_fields->ServantLimitMax )
      {
        ...
        *(_QWORD *)&v96.fields.fakeValue = v37;
        v40 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47434244(v96, 0LL);
      ...
      else
      {
        ...
        *(_QWORD *)&v95.fields.fakeValue = v30;
        v33 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47434244(v95, 0LL);
        Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47434244(
                                      entity->fields.dispLimitCount,
                                      0LL);
        if ( !v32 )
...
LABEL_28:
          ...
          *(_OWORD *)&v90.fields.fakeValue = v41;
          ...
          v89 = v90;
          v42 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_47437768(&v89, 0LL);
          ...
          *(_OWORD *)&v88.fields.fakeValue = v43;
          v46 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_47437768(&v88, 0LL);
          ...
          *(_OWORD *)&v90.fields.fakeValue = v51;
          if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
          v87 = v90;
          v53 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_47437768(&v87, 0LL);
          ...
          *(_QWORD *)&v97.fields.fakeValue = v54;
          Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47434244(v97, 0LL);
          if ( !v52 )
            goto LABEL_89;
          ...
          if ( EntityDefinitely )
          {
            ...
            *(_QWORD *)&v98.fields.fakeValue = v60;
            v62 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47434244(v98, 0LL);
            CostumeList_41213564 = UserServantCollectionEntity__getCostumeList_41213564(v58, lv, v62, 0LL);
          }
          else
          {
            CostumeList_41213564 = (System_Int32_array *)sub_1B86460(int___TypeInfo, 0LL);
          }
          RandomLimitCountList = UserServantEntity__GetRandomLimitCountList(entity, CostumeList_41213564, 0LL);
          if ( !DataManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
          v85 = Key;
          v65 = DataManager__GetMaster_object_((const MethodInfo_2F6DC64 *)Method_DataManager_GetMaster_ServantCostumeMaster___);
          v66 = DataManager__GetMaster_object_((const MethodInfo_2F6DC64 *)Method_DataManager_GetMaster_ServantLimitAddMaster___);
...
LABEL_78:
            ...
            *(_QWORD *)&v101.fields.fakeValue = v80;
            Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47434244(v101, 0LL);
            if ( (_DWORD)Instance )
            {
              if ( !v67 )
                goto LABEL_89;
              v82 = UnityEngine_Random__Range_69316044(0, v67->fields._size, 0LL);
          ...
          while ( 1 )
          {
            ...
            if ( v70 <= v71->static_fields->ServantLimitMax )
            {
              ...
              *(_QWORD *)&v100.fields.fakeValue = v75;
              Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47434244(v100, 0LL);
              if ( !v66 )
                goto LABEL_89;
              v24 = v72;
...
LABEL_72:
                ...
                if ( (unsigned int)size >= items->max_length )
                {
                  System_Collections_Generic_List_int___AddWithResize(
                    v67,
                    v70,
                    *(const MethodInfo_35DF934 **)(*(_QWORD *)(v78[4] + 192LL) + 112LL));
                }
                else
                {
            ...
            else
            {
              ...
              *(_QWORD *)&v99.fields.fakeValue = v73;
              Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47434244(v99, 0LL);
              if ( !v65 )
                goto LABEL_89;
...
int32_t __fastcall RandomLimitCountManager__GetChoiceLimitCount_32776820(
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B863B8(&BalanceConfig_TypeInfo, method);
    sub_1B863B8(&Method_DataManager_GetMasterData_ServantLimitSpoilerProtectionMaster___, v4);
    ...
    sub_1B863B8(&RandomLimitCountManager_TypeInfo, v13);
...
LABEL_43:
  ...
  if ( !v28 )
    goto LABEL_49;
  v36 = UnityEngine_Random__Range_69316044(0, v28->fields._size, 0LL);
  Item = System_Collections_Generic_List_int___get_Item(
           v28,
           v36,
           (const MethodInfo_35DF644 *)Method_System_Collections_Generic_List_int__get_Item__);
...
bool __fastcall RandomLimitCountManager__get_EnableRandomLimitCount(const MethodInfo *method)
{
  ...
  if ( (byte_4A4A175 & 1) == 0 )
  {
    sub_1B863B8(&RandomLimitCountManager_TypeInfo, v1);
    byte_4A4A175 = 1;
  }
