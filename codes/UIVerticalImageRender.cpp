void UIVerticalImageRender___cctor(const MethodInfo *method)
{
  ...
  *(_OWORD *)&static_fields->MAIN_SIZE_X = xmmword_CEF990;
  *(_OWORD *)&static_fields->OVERLAP_V = xmmword_CF0510;
  *(_QWORD *)&static_fields->BOTTOM_Y = 0xFFFFF2C2FFFFFA42LL;
  *(_OWORD *)&static_fields->BODY_U = xmmword_CEE750;
...
void UIVerticalImageRender__SetLayer(UIVerticalImageRender_o *this, int32_t layer, const MethodInfo *method)
{
  ...
  {
    transform = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0);
    UIVerticalImageRender__SetLayer_44417924(this, transform, layer, v8);
  }
}


void UIVerticalImageRender__SetLayer_44417924(
        UIVerticalImageRender_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC8DC7 & 1) == 0 )
  {
    ...
    this = (UIVerticalImageRender_o *)sub_1C713B0(&UnityEngine_Transform_TypeInfo);
    byte_4CC8DC7 = 1;
  }
  if ( !tf
...
LABEL_17:
    ...
    UIVerticalImageRender__SetLayer_44417924(v6, v17, layer, v18);
  }
