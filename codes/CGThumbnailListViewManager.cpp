        ...
        const MethodInfo *method)
{
  ...
  struct ListViewSort_o *v14; // x19
  CGThumbnailListViewManager___c_c *v15; // x0
  ...
  CGThumbnailListViewManager_o *v20; // x21
  ...
  _9__26_0 = (System_Func_object__int__o *)v15->static_fields->__9__26_0;
  if ( !_9__26_0 )
  {
  ...
  *(_QWORD *)(v10 + 16) = Int;
  ...
  v25 = thumbnailPathList->fields._version + 1;
  thumbnailPathList->fields._size = 0;
  thumbnailPathList->fields._version = v25;
  if ( size >= 1 )
    System_Array__Clear((System_Array_o *)thumbnailPathList->fields._items, 0, size, 0);
  unloadTargetPathList = v20->fields.unloadTargetPathList;
  if ( !unloadTargetPathList )
    goto LABEL_77;
  v27 = unloadTargetPathList->fields._size;
  v28 = unloadTargetPathList->fields._version + 1;
  unloadTargetPathList->fields._size = 0;
  unloadTargetPathList->fields._version = v28;
  if ( v27 >= 1 )
    System_Array__Clear((System_Array_o *)unloadTargetPathList->fields._items, 0, v27, 0);
        ...
        const MethodInfo *method)
{
  ...
  System_Converter_TInput__TOutput__o *v10; // x22
    ...
    if ( gameObject )
    {
      ...
      if ( gameObject )
      {
        ...
        if ( v8 )
        {
          ...
          v10 = *(System_Converter_TInput__TOutput__o **)(*((_QWORD *)gameObject + 23) + 48LL);
          if ( !v10 )
          {
        ...
        const MethodInfo *method)
{
  ...
  System_Action_object__object__o *v9; // x23
  __int64 v10; // x0
  ...
  else
  {
              ...
              (const MethodInfo_352D810 *)Method_System_Collections_Generic_List_Enumerator_CGThumbnailObject__MoveNext__) )
    {
      ...
      CGThumbnailObject__Init(
        ...
        mode,
        scaleType,
        (System_Action_string__string__o *)v9,
        v11);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( initMode == 2 )
    ...
    v12 = 1;
  CGThumbnailObject__Init((CGThumbnailObject_o *)obj, v12, scaleType, (System_Action_string__string__o *)v9, v11);
}
...
LABEL_23:
  ...
  if ( thumbnailPathList->fields._size >= 101 )
    CGThumbnailListViewManager__UnloadTargetTextureAsset(this, v14);
}
...
void CGThumbnailListViewManager__UnloadTextureAsset(CGThumbnailListViewManager_o *this, const MethodInfo *method)
{
  ...
  if ( !thumbnailPathList )
    goto LABEL_14;
  size = thumbnailPathList->fields._size;
  v8 = thumbnailPathList->fields._version + 1;
  thumbnailPathList->fields._size = 0;
  thumbnailPathList->fields._version = v8;
  if ( size >= 1 )
    System_Array__Clear((System_Array_o *)thumbnailPathList->fields._items, 0, size, 0);
  unloadTargetPathList = this->fields.unloadTargetPathList;
  if ( !unloadTargetPathList )
LABEL_14:
  ...
  unloadTargetPathList->fields._size = 0;
  unloadTargetPathList->fields._version = v11;
  if ( v10 >= 1 )
    System_Array__Clear((System_Array_o *)unloadTargetPathList->fields._items, 0, v10, 0);
}
