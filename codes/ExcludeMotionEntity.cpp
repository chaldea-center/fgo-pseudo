        ...
        const MethodInfo *method)
{
  if ( (byte_4B02255 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataEntityBase_CreateMultiplePK_int__int__int__string__int___, *(_QWORD *)&targetId);
    byte_4B02255 = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__int__object__int_(
           ...
           weaponGroup,
           (const MethodInfo_3000FD8 *)Method_DataEntityBase_CreateMultiplePK_int__int__int__string__int___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B02256 & 1) == 0 )
  {
    sub_1BC3008(&Method_BasicHelper_Any_int____76812400, *(_QWORD *)&currentPhase);
    sub_1BC3008(&System_Func_int__bool__TypeInfo, v5);
    sub_1BC3008(&Method_ExcludeMotionEntity___c__DisplayClass12_0__IsSatisfyPhaseCond_b__0__, v6);
    sub_1BC3008(&ExcludeMotionEntity___c__DisplayClass12_0_TypeInfo, v7);
    byte_4B02256 = 1;
  }
  v8 = sub_1BC3254(ExcludeMotionEntity___c__DisplayClass12_0_TypeInfo);
