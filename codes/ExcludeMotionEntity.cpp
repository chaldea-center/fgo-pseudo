        ...
        const MethodInfo *method)
{
  if ( (byte_4AB5F6F & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataEntityBase_CreateMultiplePK_int__int__int__string__int___, *(_QWORD *)&targetId);
    byte_4AB5F6F = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__int__object__int_(
           ...
           weaponGroup,
           (const MethodInfo_2EC473C *)Method_DataEntityBase_CreateMultiplePK_int__int__int__string__int___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB5F70 & 1) == 0 )
  {
    sub_1BAB41C(&Method_BasicHelper_Any_int____76454352, *(_QWORD *)&currentPhase);
    sub_1BAB41C(&System_Func_int__bool__TypeInfo, v5);
    sub_1BAB41C(&Method_ExcludeMotionEntity___c__DisplayClass12_0__IsSatisfyPhaseCond_b__0__, v6);
    sub_1BAB41C(&ExcludeMotionEntity___c__DisplayClass12_0_TypeInfo, v7);
    byte_4AB5F70 = 1;
  }
  v8 = sub_1BAB668(ExcludeMotionEntity___c__DisplayClass12_0_TypeInfo);
