        ...
        const MethodInfo *method)
{
  if ( (byte_4BB48FE & 1) == 0 )
  {
    sub_1C13D24(&Method_DataEntityBase_CreateMultiplePK_int__int__int__string__int___, *(_QWORD *)&targetId);
    byte_4BB48FE = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__int__object__int_(
           ...
           weaponGroup,
           (const MethodInfo_2F8E5E0 *)Method_DataEntityBase_CreateMultiplePK_int__int__int__string__int___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB48FF & 1) == 0 )
  {
    sub_1C13D24(&Method_BasicHelper_Any_int____77470256, *(_QWORD *)&currentPhase);
    sub_1C13D24(&System_Func_int__bool__TypeInfo, v5);
    sub_1C13D24(&Method_ExcludeMotionEntity___c__DisplayClass12_0__IsSatisfyPhaseCond_b__0__, v6);
    sub_1C13D24(&ExcludeMotionEntity___c__DisplayClass12_0_TypeInfo, v7);
    byte_4BB48FF = 1;
  }
  v8 = sub_1C13F70(ExcludeMotionEntity___c__DisplayClass12_0_TypeInfo);
