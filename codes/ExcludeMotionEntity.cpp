        ...
        const MethodInfo *method)
{
  if ( (byte_4B66DE7 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_DataEntityBase_CreateMultiplePK_int__int__int__string__int___, *(_QWORD *)&targetId);
    byte_4B66DE7 = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__int__object__int_(
           ...
           weaponGroup,
           (const MethodInfo_2F58284 *)Method_DataEntityBase_CreateMultiplePK_int__int__int__string__int___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B66DE8 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_BasicHelper_Any_int____77161864, *(_QWORD *)&currentPhase);
    sub_1BE4ACC(&System_Func_int__bool__TypeInfo, v5);
    sub_1BE4ACC(&Method_ExcludeMotionEntity___c__DisplayClass12_0__IsSatisfyPhaseCond_b__0__, v6);
    sub_1BE4ACC(&ExcludeMotionEntity___c__DisplayClass12_0_TypeInfo, v7);
    byte_4B66DE8 = 1;
  }
  v8 = sub_1BE4D18(ExcludeMotionEntity___c__DisplayClass12_0_TypeInfo);
