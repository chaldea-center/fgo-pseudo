        ...
        const MethodInfo *method)
{
  if ( (byte_42AF034 & 1) == 0 )
  {
    sub_B52984(&Method_DataEntityBase_CreateMultiplePK_int__string__int___);
    byte_42AF034 = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__string__int_(
           ...
           stateName,
           weaponGroup,
           (const MethodInfo_1A4E570 *)Method_DataEntityBase_CreateMultiplePK_int__string__int___);
}
...
bool __fastcall ExcludeMotionEntity__IsSatisfyExcludeCond(ExcludeMotionEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42AF035 & 1) == 0 )
  {
    this = (ExcludeMotionEntity_o *)sub_B52984(&TerminalPramsManager_TypeInfo);
    byte_42AF035 = 1;
  }
