...
void ShopTopListViewObject__Awake(ShopTopListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEA93A & 1) == 0 )
  {
    sub_1C7BAE8(&Method_UnityEngine_GameObject_GetComponent_ShopTopListViewItemDraw___);
    byte_4CEA93A = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_31C70C8 *)Method_UnityEngine_GameObject_GetComponent_ShopTopListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEA93E & 1) == 0 )
  {
    sub_1C7BAE8(&Method_UnityEngine_GameObject_GetComponent_ShopTopListViewObject___);
    byte_4CEA93E = 1;
  }
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_31C70C8 *)Method_UnityEngine_GameObject_GetComponent_ShopTopListViewObject___)) == 0) )
  {
...
ShopTopListViewItem_o *ShopTopListViewObject__GetItem(ShopTopListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEA93C & 1) == 0 )
  {
    sub_1C7BAE8(&ShopTopListViewItem_TypeInfo);
    byte_4CEA93C = 1;
  }
