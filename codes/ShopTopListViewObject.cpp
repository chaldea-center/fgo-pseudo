...
void __fastcall ShopTopListViewObject__Awake(ShopTopListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4A8D7 & 1) == 0 )
  {
    sub_1B863B8(&Method_UnityEngine_GameObject_GetComponent_ShopTopListViewItemDraw___, method);
    byte_4A4A8D7 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2FC0DF0 *)Method_UnityEngine_GameObject_GetComponent_ShopTopListViewItemDraw___);
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_2FC0DF0 *)Method_UnityEngine_GameObject_GetComponent_ShopTopListViewObject___)) == 0LL) )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A8DE & 1) == 0 )
  {
    sub_1B863B8(&Method_UnityEngine_GameObject_GetComponent_ShopTopListViewObject___, *(_QWORD *)&initMode);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A8D9 & 1) == 0 )
  {
    sub_1B863B8(&ShopTopListViewItem_TypeInfo, method);
    byte_4A4A8D9 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A8DC & 1) == 0 )
  {
    sub_1B863B8(&ShopTopListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4A4A8DC = 1;
  }
  linkItem = this->fields.linkItem;
...
void __fastcall ShopTopListViewObject__SetInput(ShopTopListViewObject_o *this, bool isInput, const MethodInfo *method)
{
  ...
  if ( (byte_4A4A8DA & 1) == 0 )
  {
    ...
    sub_1B863B8(&ShopTopListViewItem_TypeInfo, v5);
    byte_4A4A8DA = 1;
  }
...
void __fastcall ShopTopListViewObject__SetupDisp(ShopTopListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4A8DD & 1) == 0 )
  {
    ...
    sub_1B863B8(&ShopTopListViewItem_TypeInfo, v3);
    sub_1B863B8(&ShopTopListViewManager_TypeInfo, v4);
    byte_4A4A8DD = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
