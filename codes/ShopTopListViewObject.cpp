...
void ShopTopListViewObject__Awake(ShopTopListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E738B5 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_UnityEngine_GameObject_GetComponent_ShopTopListViewItemDraw___);
    byte_4E738B5 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_32A8444 *)Method_UnityEngine_GameObject_GetComponent_ShopTopListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E738B9 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_UnityEngine_GameObject_GetComponent_ShopTopListViewObject___);
    byte_4E738B9 = 1;
  }
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_32A8444 *)Method_UnityEngine_GameObject_GetComponent_ShopTopListViewObject___)) == 0) )
  {
...
ShopTopListViewItem_o *ShopTopListViewObject__GetItem(ShopTopListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E738B7 & 1) == 0 )
  {
    sub_1D0F0B4(&ShopTopListViewItem_TypeInfo);
    byte_4E738B7 = 1;
  }
