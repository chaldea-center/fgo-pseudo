...
void __fastcall SoundInfo__OnGUI(SoundInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FDAC4 & 1) == 0 )
  {
    ...
    sub_1B64870(&UnityEngine_GUI_TypeInfo, v4);
    sub_1B64870(&int_TypeInfo, v5);
    sub_1B64870(&SoundLogger_TypeInfo, v6);
    sub_1B64870(&string___TypeInfo, v7);
    sub_1B64870(&StringLiteral_15312/*"Volume Detail:{0}"*/, v8);
    sub_1B64870(&StringLiteral_47/*"\n\n\n[BGM Volume]\n"*/, v9);
    sub_1B64870(&StringLiteral_15838/*"[BGM]\n"*/, v10);
    sub_1B64870(&StringLiteral_1841/*"<size="*/, v11);
    sub_1B64870(&StringLiteral_45/*"\n\n\n"*/, v12);
    sub_1B64870(&StringLiteral_15311/*"Volume Detail: OFF"*/, v13);
    sub_1B64870(&StringLiteral_65/*"\n[SE]\n"*/, v14);
    sub_1B64870(&StringLiteral_1/*""*/, v15);
    sub_1B64870(&StringLiteral_1629/*"</size>"*/, v16);
    sub_1B64870(&StringLiteral_66/*"\n[VOICE]\n"*/, v17);
    sub_1B64870(&StringLiteral_1862/*">"*/, v18);
    byte_49FDAC4 = 1;
  }
  ...
  if ( UnityEngine_Application__get_isPlaying(0LL) )
  {
    ...
    v23 = System_String__Concat_61383576((System_String_o *)StringLiteral_15838/*"[BGM]\n"*/, LogBgm, 0LL);
    if ( (bgmVolumeIndex & 0x80000000) != 0 )
    {
      ...
      v29 = System_String__Concat_61394836(v23, (System_String_o *)StringLiteral_47/*"\n\n\n[BGM Volume]\n"*/, LogBgmVolumeSimple, 0LL);
      LogVoice = SoundLogger__getLogVoice((const MethodInfo *)v29);
      v23 = System_String__Concat_61394836(v29, (System_String_o *)StringLiteral_66/*"\n[VOICE]\n"*/, LogVoice, 0LL);
    ...
    v31 = System_String__Concat_61394836(v23, (System_String_o *)*v26, LogSe, 0LL);
    ...
    v33 = (System_String_o *)sub_1B64918(string___TypeInfo, 5LL);
    if ( v33 )
    {
      v37 = v33;
      ...
      sub_1B64814((ServantStatusBattleListViewItem_o *)&v33[1].monitor, v38, v35, v36);
      v74[0] = v32 * 18.0;
      v33 = System_Single__ToString(18.0, (const MethodInfo *)v74);
      if ( LODWORD(v37[1].klass) <= 1 )
        goto LABEL_40;
      v37[1].fields = (System_String_Fields)v33;
      sub_1B64814((ServantStatusBattleListViewItem_o *)&v37[1].fields, (int32_t)v33, v39, v40);
      if ( LODWORD(v37[1].klass) <= 2 )
        goto LABEL_40;
      v43 = StringLiteral_1862/*">"*/;
      v37[2].klass = (System_String_c *)StringLiteral_1862/*">"*/;
      sub_1B64814((ServantStatusBattleListViewItem_o *)&v37[2], v43, v41, v42);
      if ( LODWORD(v37[1].klass) <= 3 )
        goto LABEL_40;
      v37[2].monitor = v31;
      sub_1B64814((ServantStatusBattleListViewItem_o *)&v37[2].monitor, (int32_t)v31, v44, v45);
      if ( LODWORD(v37[1].klass) <= 4 )
        goto LABEL_40;
      v48 = StringLiteral_1629/*"</size>"*/;
      v37[2].fields = (System_String_Fields)StringLiteral_1629/*"</size>"*/;
      sub_1B64814((ServantStatusBattleListViewItem_o *)&v37[2].fields, v48, v46, v47);
      v49 = System_String__Concat_61397104((System_String_array *)v37, 0LL);
      ...
      if ( (bgmVolumeIndex & 0x80000000) != 0 )
      {
        v54 = (System_String_o *)StringLiteral_15311/*"Volume Detail: OFF"*/;
      }
      else
      {
        v73 = this->fields.bgmVolumeIndex;
        v53 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v73, v50, v51, v52);
        v54 = System_String__Format((System_String_o *)StringLiteral_15312/*"Volume Detail:{0}"*/, v53, 0LL);
      }
      v33 = (System_String_o *)sub_1B64918(string___TypeInfo, 5LL);
      if ( v33 )
      {
        ...
        if ( LODWORD(v33[1].klass) )
        {
          ...
          v33[1].monitor = (void *)StringLiteral_1841/*"<size="*/;
          sub_1B64814((ServantStatusBattleListViewItem_o *)&v33[1].monitor, v58, v55, v56);
          v74[0] = v32 * 18.0;
          v33 = System_Single__ToString(v59, (const MethodInfo *)v74);
          if ( LODWORD(v57[1].klass) > 1 )
          {
            v57[1].fields = (System_String_Fields)v33;
            sub_1B64814((ServantStatusBattleListViewItem_o *)&v57[1].fields, (int32_t)v33, v60, v61);
            if ( LODWORD(v57[1].klass) > 2 )
            {
              v64 = StringLiteral_1862/*">"*/;
              v57[2].klass = (System_String_c *)StringLiteral_1862/*">"*/;
              sub_1B64814((ServantStatusBattleListViewItem_o *)&v57[2], v64, v62, v63);
              if ( LODWORD(v57[1].klass) > 3 )
              {
                v57[2].monitor = v54;
                sub_1B64814((ServantStatusBattleListViewItem_o *)&v57[2].monitor, (int32_t)v54, v65, v66);
                if ( LODWORD(v57[1].klass) > 4 )
                {
                  v69 = StringLiteral_1629/*"</size>"*/;
                  v57[2].fields = (System_String_Fields)StringLiteral_1629/*"</size>"*/;
                  sub_1B64814((ServantStatusBattleListViewItem_o *)&v57[2].fields, v69, v67, v68);
                  v70 = System_String__Concat_61397104((System_String_array *)v57, 0LL);
                  if ( !UnityEngine_GUI_TypeInfo->_2.cctor_finished )
                    j_il2cpp_runtime_class_init_0(UnityEngine_GUI_TypeInfo);
