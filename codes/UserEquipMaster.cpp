void __fastcall UserEquipMaster___ctor(UserEquipMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4188B07 & 1) == 0 )
  {
    sub_B2C35C(&Method_DataMasterBase_UserEquipMaster__UserEquipEntity__long___ctor__, method);
    byte_4188B07 = 1;
  }
  DataMasterBase_UserSubEquipMaster__UserSubEquipEntity__long____ctor(
    (DataMasterBase_UserSubEquipMaster__UserSubEquipEntity__long__o *)this,
    48,
    (const MethodInfo_24E425C *)Method_DataMasterBase_UserEquipMaster__UserEquipEntity__long___ctor__);
}
...
void __fastcall UserEquipMaster__continueDeviceEquipLvInfo(UserEquipMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4188B09 & 1) == 0 )
  {
    ...
    sub_B2C35C(&UserEquipEntity_TypeInfo, v5);
      ...
      if ( Item )
      {
          ...
          && (UserEquipEntity_c *)Item->klass->_2.typeHierarchy[v13 - 1] == UserEquipEntity_TypeInfo )
        {
          ...
          *(_QWORD *)&v20.fields.fakeValue = monitor;
          v16 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_44758064(v20, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4188B08 & 1) == 0 )
  {
    ...
    sub_B2C35C(&Method_System_Collections_Generic_List_UserEquipEntity__Add__, v6);
    sub_B2C35C(&Method_System_Collections_Generic_List_UserEquipEntity__ToArray__, v7);
    sub_B2C35C(&Method_System_Collections_Generic_List_UserEquipEntity___ctor__, v8);
    sub_B2C35C(&System_Collections_Generic_List_UserEquipEntity__TypeInfo, v9);
    sub_B2C35C(&UserEquipEntity_TypeInfo, v10);
    byte_4188B08 = 1;
  }
  list = (System_Collections_ObjectModel_Collection_UnicastIPAddressInformation__o *)this->fields.list;
  if ( !list )
  ...
  Count = System_Collections_ObjectModel_Collection_UnicastIPAddressInformation___get_Count(
            list,
            (const MethodInfo_2A0E2E8 *)Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__);
  v13 = (System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData__o *)sub_B2C42C(System_Collections_Generic_List_UserEquipEntity__TypeInfo);
  ...
  if ( Count >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        userId = (int64_t)list;
        v15 = *(&UserEquipEntity_TypeInfo->_2.bitflags2 + 1);
        if ( *(&list->klass->_2.bitflags2 + 1) >= (unsigned int)v15
          && (UserEquipEntity_c *)list->klass->_2.typeHierarchy[v15 - 1] == UserEquipEntity_TypeInfo
...
LABEL_14:
  ...
  return (UserEquipEntity_array *)System_Collections_Generic_List_WarBoardUiData_SaveData___ToArray(
                                    ...
                                    (const MethodInfo_2EF65AC *)Method_System_Collections_Generic_List_UserEquipEntity__ToArray__);
}