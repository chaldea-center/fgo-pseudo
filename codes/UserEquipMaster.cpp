void __fastcall UserEquipMaster___ctor(UserEquipMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4B37DDE & 1) == 0 )
  {
    sub_1BD3458(&Method_DataMasterBase_UserEquipMaster__UserEquipEntity__long___ctor__, method);
    byte_4B37DDE = 1;
  }
  DataMasterBase_object__object__long____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    50,
    (const MethodInfo_31D205C *)Method_DataMasterBase_UserEquipMaster__UserEquipEntity__long___ctor__);
}
...
void __fastcall UserEquipMaster__continueDeviceEquipLvInfo(UserEquipMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B37DE0 & 1) == 0 )
  {
    ...
    sub_1BD3458(&UserEquipEntity_TypeInfo, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B37DDF & 1) == 0 )
  {
    ...
    sub_1BD3458(&Method_System_Collections_Generic_List_UserEquipEntity__Add__, v6);
    sub_1BD3458(&Method_System_Collections_Generic_List_UserEquipEntity__ToArray__, v7);
    sub_1BD3458(&Method_System_Collections_Generic_List_UserEquipEntity___ctor__, v8);
    sub_1BD3458(&System_Collections_Generic_List_UserEquipEntity__TypeInfo, v9);
    sub_1BD3458(&UserEquipEntity_TypeInfo, v10);
    byte_4B37DDF = 1;
  }
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
  ...
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            list,
            (const MethodInfo_316E4C0 *)Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__);
  v13 = (System_Collections_Generic_List_object__o *)sub_1BD36A4(System_Collections_Generic_List_UserEquipEntity__TypeInfo);
...
LABEL_17:
  ...
  return (UserEquipEntity_array *)System_Collections_Generic_List_object___ToArray(
                                    v13,
                                    (const MethodInfo_35C28E8 *)Method_System_Collections_Generic_List_UserEquipEntity__ToArray__);
}