void __fastcall UserEquipMaster___ctor(UserEquipMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A206CA & 1) == 0 )
  {
    sub_1B715CC(&Method_DataMasterBase_UserEquipMaster__UserEquipEntity__long___ctor__, method);
    byte_4A206CA = 1;
  }
  DataMasterBase_object__object__long____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    50,
    (const MethodInfo_30F88CC *)Method_DataMasterBase_UserEquipMaster__UserEquipEntity__long___ctor__);
}
...
void __fastcall UserEquipMaster__continueDeviceEquipLvInfo(UserEquipMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A206CC & 1) == 0 )
  {
    ...
    sub_1B715CC(&UserEquipEntity_TypeInfo, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A206CB & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_System_Collections_Generic_List_UserEquipEntity__Add__, v6);
    sub_1B715CC(&Method_System_Collections_Generic_List_UserEquipEntity__ToArray__, v7);
    sub_1B715CC(&Method_System_Collections_Generic_List_UserEquipEntity___ctor__, v8);
    sub_1B715CC(&System_Collections_Generic_List_UserEquipEntity__TypeInfo, v9);
    sub_1B715CC(&UserEquipEntity_TypeInfo, v10);
    byte_4A206CB = 1;
  }
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
  ...
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            list,
            (const MethodInfo_3095AA8 *)Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__);
  v13 = (System_Collections_Generic_List_object__o *)sub_1B71818(System_Collections_Generic_List_UserEquipEntity__TypeInfo);
...
LABEL_17:
  ...
  return (UserEquipEntity_array *)System_Collections_Generic_List_object___ToArray(
                                    v13,
                                    (const MethodInfo_34D1DB8 *)Method_System_Collections_Generic_List_UserEquipEntity__ToArray__);
}