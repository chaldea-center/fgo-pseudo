void __fastcall UserEquipMaster___ctor(UserEquipMaster_o *this, const MethodInfo *method)
{
  if ( (byte_42B14F4 & 1) == 0 )
  {
    sub_B52984(&Method_DataMasterBase_UserEquipMaster__UserEquipEntity__long___ctor__);
    byte_42B14F4 = 1;
  }
  DataMasterBase_UserSubEquipMaster__UserSubEquipEntity__long____ctor(
    (DataMasterBase_UserSubEquipMaster__UserSubEquipEntity__long__o *)this,
    49,
    (const MethodInfo_23E2464 *)Method_DataMasterBase_UserEquipMaster__UserEquipEntity__long___ctor__);
}
...
void __fastcall UserEquipMaster__continueDeviceEquipLvInfo(UserEquipMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B14F6 & 1) == 0 )
  {
    ...
    sub_B52984(&UserEquipEntity_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B14F5 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_System_Collections_Generic_List_UserEquipEntity__ToArray__);
...
LABEL_14:
  ...
  return (UserEquipEntity_array *)System_Collections_Generic_List_WarBoardUiData_SaveData___ToArray(
                                    ...
                                    (const MethodInfo_2FF3750 *)Method_System_Collections_Generic_List_UserEquipEntity__ToArray__);
}