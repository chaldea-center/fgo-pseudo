void UserEquipMaster___ctor(UserEquipMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4C28063 & 1) == 0 )
  {
    sub_1C2D490(&Method_DataMasterBase_UserEquipMaster__UserEquipEntity__long___ctor__);
    byte_4C28063 = 1;
  }
  DataMasterBase_object__object__long____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    54,
    (const MethodInfo_3387FD0 *)Method_DataMasterBase_UserEquipMaster__UserEquipEntity__long___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C28066 & 1) == 0 )
  {
    sub_1C2D490(&Method_ObservableCollectionExtensions_Find_UserEquipEntity___);
    sub_1C2D490(&System_Predicate_UserEquipEntity__TypeInfo);
    sub_1C2D490(&Method_UserEquipMaster___c__DisplayClass3_0__TryGetEntityByEquipId_b__0__);
    sub_1C2D490(&UserEquipMaster___c__DisplayClass3_0_TypeInfo);
    byte_4C28066 = 1;
  }
  v7 = sub_1C2D6DC(UserEquipMaster___c__DisplayClass3_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v7, 0);
  if ( !v7 )
    sub_1C2D6EC(v8, v9);
  *(_DWORD *)(v7 + 16) = equipId;
  list = (System_Collections_ObjectModel_ObservableCollection_T__o *)this->fields.list;
  v11 = (System_Predicate_object__o *)sub_1C2D6DC(System_Predicate_UserEquipEntity__TypeInfo);
  ...
  object = ObservableCollectionExtensions__Find_object_(
             ...
             (const MethodInfo_315B8EC *)Method_ObservableCollectionExtensions_Find_UserEquipEntity___);
  *userEquipEntity = (UserEquipEntity_o *)object;
  sub_1C2D434((CGThumbnailListItem_o *)userEquipEntity, (int32_t)object, v13, v14);
...
void UserEquipMaster__continueDeviceEquipLvInfo(UserEquipMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C28065 & 1) == 0 )
  {
    sub_1C2D490(&Method_System_Collections_ObjectModel_Collection_UserEquipEntity__get_Count__);
    sub_1C2D490(&Method_System_Collections_ObjectModel_Collection_UserEquipEntity__get_Item__);
  ...
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            list,
            (const MethodInfo_3321208 *)Method_System_Collections_ObjectModel_Collection_UserEquipEntity__get_Count__);
  if ( Count >= 1 )
  {
    v5 = Count;
    v6 = 0;
    while ( 1 )
    {
      ...
      Item = System_Collections_ObjectModel_Collection_object___get_Item(
               list,
               v6,
               (const MethodInfo_3321298 *)Method_System_Collections_ObjectModel_Collection_UserEquipEntity__get_Item__);
      if ( Item )
      {
        v8 = Item;
        klass = Item[2].klass;
...
UserEquipEntity_array *UserEquipMaster__getList(UserEquipMaster_o *this, int64_t userId, const MethodInfo *method)
{
  ...
  if ( (byte_4C28064 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_System_Collections_Generic_List_UserEquipEntity__ToArray__);
...
LABEL_15:
  ...
  return (UserEquipEntity_array *)System_Collections_Generic_List_object___ToArray(
                                    v7,
                                    (const MethodInfo_378B6DC *)Method_System_Collections_Generic_List_UserEquipEntity__ToArray__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C28067 & 1) == 0 )
  {
    this = (UserEquipMaster___c__DisplayClass3_0_o *)sub_1C2D490(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    byte_4C28067 = 1;
  }
  if ( !x )
    sub_1C2D6EC(this, x);
  ...
  *(_QWORD *)&v8.fields.fakeValue = v5;
  return CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v8, 0) == v4->fields.equipId;
}