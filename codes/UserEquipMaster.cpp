void __fastcall UserEquipMaster___ctor(UserEquipMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4B67818 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_DataMasterBase_UserEquipMaster__UserEquipEntity__long___ctor__, method);
    byte_4B67818 = 1;
  }
  DataMasterBase_object__object__long____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    54,
    (const MethodInfo_31FD930 *)Method_DataMasterBase_UserEquipMaster__UserEquipEntity__long___ctor__);
}
...
void __fastcall UserEquipMaster__continueDeviceEquipLvInfo(UserEquipMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6781A & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&UserEquipEntity_TypeInfo, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67819 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_System_Collections_Generic_List_UserEquipEntity__Add__, v6);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_UserEquipEntity__ToArray__, v7);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_UserEquipEntity___ctor__, v8);
    sub_1BE4ACC(&System_Collections_Generic_List_UserEquipEntity__TypeInfo, v9);
    sub_1BE4ACC(&UserEquipEntity_TypeInfo, v10);
    byte_4B67819 = 1;
  }
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
  ...
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            list,
            (const MethodInfo_3199D94 *)Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__);
  v13 = (System_Collections_Generic_List_object__o *)sub_1BE4D18(System_Collections_Generic_List_UserEquipEntity__TypeInfo);
    ...
    while ( 1 )
    {
      ...
      if ( list )
      {
          ...
          && list[1].klass == (System_Collections_ObjectModel_Collection_T__c *)v3 )
        {
          ...
          v23 = Method_System_Collections_Generic_List_UserEquipEntity__Add__;
          ++v13->fields._version;
          if ( !items )
            break;
...
LABEL_17:
  ...
  return (UserEquipEntity_array *)System_Collections_Generic_List_object___ToArray(
                                    v13,
                                    (const MethodInfo_35EDD7C *)Method_System_Collections_Generic_List_UserEquipEntity__ToArray__);
}