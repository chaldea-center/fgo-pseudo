...
uint32_t __fastcall Crc32__Compute(System_Byte_array *buffer, const MethodInfo *method)
{
  ...
  if ( (byte_49FBADE & 1) == 0 )
  {
    buffer = (System_Byte_array *)sub_1B640C8(&Crc32_TypeInfo, method);
    byte_49FBADE = 1;
  }
  if ( !v2 )
LABEL_15:
...
uint32_t __fastcall Crc32__Compute_38055732(System_Byte_array *buffer, int32_t length, const MethodInfo *method)
{
  int32_t v3; // w20
  ...
  if ( (byte_49FBADF & 1) == 0 )
  {
    buffer = (System_Byte_array *)sub_1B640C8(&Crc32_TypeInfo, *(_QWORD *)&length);
    byte_49FBADF = 1;
  }
  if ( !v4 )
LABEL_17:
  ...
  do
  {
    ...
    if ( v9 >= *(_DWORD *)(v8 + 24) )
LABEL_16:
      sub_1B6432C(buffer, *(_QWORD *)&length);
    ++v6;
...
// local variable allocation has failed, the output may be wrong!
uint32_t __fastcall Crc32__Compute_38055956(
