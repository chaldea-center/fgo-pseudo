...
uint32_t __fastcall Crc32__Compute(System_Byte_array *buffer, const MethodInfo *method)
{
  ...
  if ( (byte_4AB53E4 & 1) == 0 )
  {
    buffer = (System_Byte_array *)sub_1BAB41C(&Crc32_TypeInfo, method);
    byte_4AB53E4 = 1;
  }
  if ( !v2 )
LABEL_15:
    sub_1BAB678(buffer, method);
...
uint32_t __fastcall Crc32__Compute_38749280(System_Byte_array *buffer, int32_t length, const MethodInfo *method)
{
  int32_t v3; // w20
  ...
  if ( (byte_4AB53E5 & 1) == 0 )
  {
    buffer = (System_Byte_array *)sub_1BAB41C(&Crc32_TypeInfo, *(_QWORD *)&length);
    byte_4AB53E5 = 1;
  }
  if ( !v4 )
LABEL_17:
    sub_1BAB678(buffer, *(_QWORD *)&length);
  ...
  do
  {
    ...
    if ( v9 >= *(_DWORD *)(v8 + 24) )
LABEL_16:
      sub_1BAB680(buffer, *(_QWORD *)&length);
    ++v6;
...
// local variable allocation has failed, the output may be wrong!
uint32_t __fastcall Crc32__Compute_38749504(
