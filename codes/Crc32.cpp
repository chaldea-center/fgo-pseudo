void __fastcall Crc32___cctor(const MethodInfo *method)
{
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&static_fields->CrcTable, (int32_t)v5, v7, v8);
}
...
uint32_t __fastcall Crc32__Compute(System_Byte_array *buffer, const MethodInfo *method)
{
  ...
  if ( (byte_48E1EFD & 1) == 0 )
  {
    buffer = (System_Byte_array *)sub_1B00CCC(&Crc32_TypeInfo, method);
    byte_48E1EFD = 1;
  }
  if ( !v2 )
LABEL_15:
    sub_1B00F28(buffer, method);
...
uint32_t __fastcall Crc32__Compute_37155164(System_Byte_array *buffer, int32_t length, const MethodInfo *method)
{
  int32_t v3; // w20
  ...
  if ( (byte_48E1EFE & 1) == 0 )
  {
    buffer = (System_Byte_array *)sub_1B00CCC(&Crc32_TypeInfo, *(_QWORD *)&length);
    byte_48E1EFE = 1;
  }
  if ( !v4 )
LABEL_17:
    sub_1B00F28(buffer, *(_QWORD *)&length);
  ...
  do
  {
    ...
    if ( v9 >= *(_DWORD *)(v8 + 24) )
LABEL_16:
      sub_1B00F30(buffer, *(_QWORD *)&length);
    ++v6;
...
// local variable allocation has failed, the output may be wrong!
uint32_t __fastcall Crc32__Compute_37155388(
