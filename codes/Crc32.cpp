void Crc32___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_596FE77 & 1) == 0 )
  {
    ...
    sub_2213A60(&Field__PrivateImplementationDetails__12F3E0576D447EB37B36D82BA0C1C5481B8F0D12FDC70347CE4A076B229D4C86);
    sub_2213A60(&uint___TypeInfo);
    byte_596FE77 = 1;
  }
  v1 = uint___TypeInfo;
...
uint32_t Crc32__Compute(System_Byte_array *buffer, const MethodInfo *method)
{
  ...
  if ( (byte_596FE74 & 1) == 0 )
  {
    buffer = (System_Byte_array *)sub_2213A60(&Crc32_TypeInfo);
    byte_596FE74 = 1;
  }
  if ( !v2 )
LABEL_15:
    sub_2213CDC(buffer, method);
...
uint32_t Crc32__Compute_48218036(System_Byte_array *buffer, int32_t length, const MethodInfo *method)
{
  int32_t v3; // w20
  ...
  if ( !v4 )
LABEL_17:
    sub_2213CDC(buffer, *(_QWORD *)&length);
...
// local variable allocation has failed, the output may be wrong!
uint32_t Crc32__Compute_48218256(System_Byte_array *buffer, int32_t length, uint32_t crc, const MethodInfo *method)
{
  int32_t v5; // w21
