...
void TouchDetectorBase__CheckUpdateCurrentTouchCount(TouchDetectorBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEADF2 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_ActionExtensions_Call_int__int___);
    byte_4CEADF2 = 1;
  }
  ...
  if ( (_DWORD)CurrentTouchInfo_k__BackingField != currentTouchCountCache )
  {
    ...
    ActionExtensions__Call_int__int_(
      ...
      TouchCount,
      (const MethodInfo_30B967C *)Method_ActionExtensions_Call_int__int___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEADF6 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_System_Collections_Generic_List_Vector2__AddRange__);
  ...
  System_Object___ctor((Il2CppObject *)this, 0);
  v8 = (System_Collections_Generic_List_Vector2__o *)sub_1C7BD34(System_Collections_Generic_List_Vector2__TypeInfo);
  ...
  if ( (unsigned int)size >= LODWORD(items->max_length) )
  {
    ...
    System_Collections_Generic_List_Vector2___AddWithResize(
      v8,
      v22,
      *(const MethodInfo_38BC4C4 **)(*(_QWORD *)(v18[4] + 192LL) + 112LL));
  }
  else
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEADF5 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_System_Collections_Generic_List_Enumerator_Vector2__Dispose__);
    sub_1C7BAE8(&Method_System_Collections_Generic_List_Enumerator_Vector2__MoveNext__);
    sub_1C7BAE8(&Method_System_Collections_Generic_List_Enumerator_Vector2__get_Current__);
    sub_1C7BAE8(&Method_System_Collections_Generic_List_Vector2__GetEnumerator__);
    byte_4CEADF5 = 1;
  }
  memset(&i, 0, sizeof(i));
  if ( !byte_4CE7D39 )
  ...
  System_Collections_Generic_List_Vector2___GetEnumerator(
    ...
    (const MethodInfo_38BCFDC *)Method_System_Collections_Generic_List_Vector2__GetEnumerator__);
  for ( i = v9;
        System_Collections_Generic_List_Enumerator_Vector2___MoveNext(
          &i,
          (const MethodInfo_35C485C *)Method_System_Collections_Generic_List_Enumerator_Vector2__MoveNext__);
  ...
  System_Collections_Generic_List_Enumerator_Vector2___Dispose(
    &i,
    (const MethodInfo_35C4858 *)Method_System_Collections_Generic_List_Enumerator_Vector2__Dispose__);
...
int32_t TouchDetectorBase_TouchInfo__get_TouchCount(TouchDetectorBase_TouchInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEADF3 & 1) == 0 )
  {
    this = (TouchDetectorBase_TouchInfo_o *)sub_1C7BAE8(&Method_System_Collections_Generic_List_Vector2__get_Count__);
    byte_4CEADF3 = 1;
  }
...
float TouchDetectorBase_TouchInfo__get_TouchInterval(TouchDetectorBase_TouchInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEADF4 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_System_Nullable_float__get_Value__);
    byte_4CEADF4 = 1;
  }
...
LABEL_9:
    ...
    v14.fields._list = 0;
    System_Nullable_float____ctor(v11, *(float *)&v2, (const MethodInfo_3967354 *)Method_System_Nullable_float___ctor__);
  ...
  return System_Nullable_float___get_Value(
           ...
           (const MethodInfo_396736C *)Method_System_Nullable_float__get_Value__);
}
