...
void __fastcall TouchDetectorBase__CheckUpdateCurrentTouchCount(TouchDetectorBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1C68B & 1) == 0 )
  {
    sub_1B715CC(&Method_ActionExtensions_Call_int__int___, method);
    byte_4A1C68B = 1;
  }
  ...
  if ( (_DWORD)CurrentTouchInfo_k__BackingField != currentTouchCountCache )
  {
    ...
    ActionExtensions__Call_int__int_(
      ...
      TouchCount,
      (const MethodInfo_2DB306C *)Method_ActionExtensions_Call_int__int___);
...
void __fastcall TouchDetectorBase__ClearTouchInfo(TouchDetectorBase_o *this, const MethodInfo *method)
{
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields._CurrentTouchInfo_k__BackingField, 0, v5, v6);
  this->fields._PrevTouchInfo_k__BackingField = 0LL;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields._PrevTouchInfo_k__BackingField, 0, v7, v8);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C68F & 1) == 0 )
  {
    sub_1B715CC(&Method_System_Collections_Generic_List_Vector2__AddRange__, optionalTouchPosArray);
    sub_1B715CC(&Method_System_Collections_Generic_List_Vector2__Add__, v8);
    sub_1B715CC(&Method_System_Collections_Generic_List_Vector2___ctor__, v9);
    sub_1B715CC(&System_Collections_Generic_List_Vector2__TypeInfo, v10);
    byte_4A1C68F = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
  v11 = (System_Collections_Generic_List_Vector2__o *)sub_1B71818(System_Collections_Generic_List_Vector2__TypeInfo);
  ...
  if ( (unsigned int)size >= items->max_length )
  {
    ...
    System_Collections_Generic_List_Vector2___AddWithResize(
      v11,
      v21,
      *(const MethodInfo_3523CE4 **)(*(_QWORD *)(v17[4] + 192LL) + 112LL));
  }
  else
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C68E & 1) == 0 )
  {
    sub_1B715CC(&Method_System_Collections_Generic_List_Enumerator_Vector2__Dispose__, method);
    sub_1B715CC(&Method_System_Collections_Generic_List_Enumerator_Vector2__MoveNext__, v3);
    sub_1B715CC(&Method_System_Collections_Generic_List_Enumerator_Vector2__get_Current__, v4);
    sub_1B715CC(&Method_System_Collections_Generic_List_Vector2__GetEnumerator__, v5);
    byte_4A1C68E = 1;
  }
  memset(&i, 0, sizeof(i));
  if ( !byte_4A1A64A )
  ...
  System_Collections_Generic_List_Vector2___GetEnumerator(
    ...
    (const MethodInfo_35247FC *)Method_System_Collections_Generic_List_Vector2__GetEnumerator__);
  for ( i = v12;
        System_Collections_Generic_List_Enumerator_Vector2___MoveNext(
          &i,
          (const MethodInfo_3256180 *)Method_System_Collections_Generic_List_Enumerator_Vector2__MoveNext__);
  ...
  System_Collections_Generic_List_Enumerator_Vector2___Dispose(
    &i,
    (const MethodInfo_325617C *)Method_System_Collections_Generic_List_Enumerator_Vector2__Dispose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C68C & 1) == 0 )
  {
    this = (TouchDetectorBase_TouchInfo_o *)sub_1B715CC(
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B715CC(&Method_System_Collections_Generic_List_Enumerator_Vector2__Dispose__, method);
    sub_1B715CC(&Method_System_Collections_Generic_List_Enumerator_Vector2__MoveNext__, v4);
    sub_1B715CC(&Method_System_Collections_Generic_List_Enumerator_Vector2__get_Current__, v5);
    sub_1B715CC(&Method_System_Collections_Generic_List_Vector2__GetEnumerator__, v6);
    sub_1B715CC(&Method_System_Nullable_float___ctor__, v7);
    sub_1B715CC(&Method_System_Nullable_float__get_HasValue__, v8);
    sub_1B715CC(&Method_System_Nullable_float__get_Value__, v9);
    byte_4A1C68D = 1;
  }
...
LABEL_9:
    ...
    System_Nullable_float____ctor(v22, *(float *)&v2, (const MethodInfo_35EF1A0 *)Method_System_Nullable_float___ctor__);
  ...
  return System_Nullable_float___get_Value(
           ...
           (const MethodInfo_35EF1B8 *)Method_System_Nullable_float__get_Value__);
}
