...
void __fastcall ContinueDeviceDispMenu__Close(ContinueDeviceDispMenu_o *this, const MethodInfo *method)
{
  ...
  ContinueDeviceDispMenu__Close_31952420(this, 0LL, v2);
}


void __fastcall ContinueDeviceDispMenu__Close_31952420(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD77CF & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_ContinueDeviceDispMenu_EndClose__);
    byte_4BD77CF = 1;
  }
  ...
  System_Action___ctor(v5, (Il2CppObject *)this, Method_ContinueDeviceDispMenu_EndClose__, 0LL);
...
void __fastcall ContinueDeviceDispMenu__OnClickCancel(ContinueDeviceDispMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD77D3 & 1) == 0 )
  {
    sub_1C21E38(&Method_ContinueDeviceDispMenu_OnClickCancel__);
    byte_4BD77D3 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ContinueDeviceDispMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_ContinueDeviceDispMenu_OnClickCancel__);
...
void __fastcall ContinueDeviceDispMenu__OnClickCopy(ContinueDeviceDispMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD77D0 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_ContinueDeviceDispMenu_EndCopyDialog__);
    sub_1C21E38(&Method_ContinueDeviceDispMenu_OnClickCopy__);
    sub_1C21E38(&UnityEngine_GUIUtility_TypeInfo);
    sub_1C21E38(&LocalizationManager_TypeInfo);
    sub_1C21E38(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1C21E38(&StringLiteral_3920/*"CONTINUE_DEVICE_DIALOG_MESSAGE1"*/);
    byte_4BD77D0 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ContinueDeviceDispMenu_OnClickCopy__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_ContinueDeviceDispMenu_OnClickCopy__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C21E1C(v3, v3[4]);
    ...
    v7 = LocalizationManager__Get((System_String_o *)StringLiteral_3920/*"CONTINUE_DEVICE_DIALOG_MESSAGE1"*/, 0LL);
...
void __fastcall ContinueDeviceDispMenu__OnClickDecide(ContinueDeviceDispMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD77D2 & 1) == 0 )
  {
    sub_1C21E38(&Method_ContinueDeviceDispMenu_OnClickDecide__);
    byte_4BD77D2 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ContinueDeviceDispMenu_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_ContinueDeviceDispMenu_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C21E1C(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C21E38(&System_Action_TypeInfo);
    sub_1C21E38(&Method_ContinueDeviceDispMenu_EndOpen__);
    sub_1C21E38(&LocalizationManager_TypeInfo);
    sub_1C21E38(&StringLiteral_43/*"\n"*/);
    sub_1C21E38(&StringLiteral_3925/*"CONTINUE_DEVICE_DISP_TITLE"*/);
    sub_1C21E38(&StringLiteral_3921/*"CONTINUE_DEVICE_DISP_CANCEL"*/);
    sub_1C21E38(&StringLiteral_3924/*"CONTINUE_DEVICE_DISP_EXPLANATIOIN2"*/);
    sub_1C21E38(&StringLiteral_3923/*"CONTINUE_DEVICE_DISP_DECIDE"*/);
    sub_1C21E38(&StringLiteral_3922/*"CONTINUE_DEVICE_DISP_COPY"*/);
    sub_1C21E38(&StringLiteral_3938/*"CONTINUE_DEVICE_WARNING_MESSAGE"*/);
    byte_4BD77CE = 1;
  }
  ...
  else if ( !state )
  {
    ...
    sub_1C21DDC(&this->fields.code, code);
    this->fields.callbackFunc = callback;
    sub_1C21DDC(&this->fields.callbackFunc, callback);
    titleLabel = this->fields.titleLabel;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    continueCodeLabel = LocalizationManager__Get((System_String_o *)StringLiteral_3925/*"CONTINUE_DEVICE_DISP_TITLE"*/, 0LL);
    if ( !titleLabel )
      goto LABEL_16;
    UILabel__set_text(titleLabel, continueCodeLabel, 0LL);
    explanation2Label = this->fields.explanation2Label;
    v12 = LocalizationManager__Get((System_String_o *)StringLiteral_3924/*"CONTINUE_DEVICE_DISP_EXPLANATIOIN2"*/, 0LL);
    v13 = LocalizationManager__Get((System_String_o *)StringLiteral_3938/*"CONTINUE_DEVICE_WARNING_MESSAGE"*/, 0LL);
    continueCodeLabel = System_String__Concat_63126736(v12, (System_String_o *)StringLiteral_43/*"\n"*/, v13, 0LL);
    if ( !explanation2Label )
      goto LABEL_16;
    UILabel__set_text(explanation2Label, continueCodeLabel, 0LL);
    copyLabel = this->fields.copyLabel;
    continueCodeLabel = LocalizationManager__Get((System_String_o *)StringLiteral_3922/*"CONTINUE_DEVICE_DISP_COPY"*/, 0LL);
    if ( !copyLabel )
      goto LABEL_16;
    UILabel__set_text(copyLabel, continueCodeLabel, 0LL);
    decideLabel = this->fields.decideLabel;
    continueCodeLabel = LocalizationManager__Get((System_String_o *)StringLiteral_3923/*"CONTINUE_DEVICE_DISP_DECIDE"*/, 0LL);
    if ( !decideLabel
      || (UILabel__set_text(decideLabel, continueCodeLabel, 0LL),
          cancelLabel = this->fields.cancelLabel,
          continueCodeLabel = LocalizationManager__Get((System_String_o *)StringLiteral_3921/*"CONTINUE_DEVICE_DISP_CANCEL"*/, 0LL),
          !cancelLabel)
      || (UILabel__set_text(cancelLabel, continueCodeLabel, 0LL),
          (continueCodeLabel = (System_String_o *)this->fields.continueCodeLabel) == 0LL) )
    {
LABEL_16:
      sub_1C22094(continueCodeLabel, v10);
    }
    UILabel__set_text((UILabel_o *)continueCodeLabel, this->fields.code, 0LL);
    this->fields.state = 1;
    v17 = (System_Action_o *)sub_1C22084(System_Action_TypeInfo);
    System_Action___ctor(v17, (Il2CppObject *)this, Method_ContinueDeviceDispMenu_EndOpen__, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  v11 = (ContinueDeviceDispMenu_o *)sub_1C22354(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A5BD18;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A5BCD0;
}
