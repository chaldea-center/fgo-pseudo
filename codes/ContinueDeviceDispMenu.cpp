...
void __fastcall ContinueDeviceDispMenu__Close(ContinueDeviceDispMenu_o *this, const MethodInfo *method)
{
  ...
  ContinueDeviceDispMenu__Close_31018124(this, 0LL, v2);
}


void __fastcall ContinueDeviceDispMenu__Close_31018124(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5666D & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_ContinueDeviceDispMenu_EndClose__);
    byte_4A5666D = 1;
  }
...
void __fastcall ContinueDeviceDispMenu__OnClickCancel(ContinueDeviceDispMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A56671 & 1) == 0 )
  {
    sub_1B885B0(&Method_ContinueDeviceDispMenu_OnClickCancel__);
    byte_4A56671 = 1;
  }
...
void __fastcall ContinueDeviceDispMenu__OnClickCopy(ContinueDeviceDispMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5666E & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_ContinueDeviceDispMenu_EndCopyDialog__);
    sub_1B885B0(&Method_ContinueDeviceDispMenu_OnClickCopy__);
    sub_1B885B0(&UnityEngine_GUIUtility_TypeInfo);
    sub_1B885B0(&LocalizationManager_TypeInfo);
    sub_1B885B0(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1B885B0(&StringLiteral_3862/*"CONTINUE_DEVICE_DIALOG_MESSAGE1"*/);
    byte_4A5666E = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    v7 = LocalizationManager__Get((System_String_o *)StringLiteral_3862/*"CONTINUE_DEVICE_DIALOG_MESSAGE1"*/, 0LL);
...
void __fastcall ContinueDeviceDispMenu__OnClickDecide(ContinueDeviceDispMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A56670 & 1) == 0 )
  {
    sub_1B885B0(&Method_ContinueDeviceDispMenu_OnClickDecide__);
    byte_4A56670 = 1;
  }
  if ( this->fields.state == 2 )
  {
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B885B0(&System_Action_TypeInfo);
    sub_1B885B0(&Method_ContinueDeviceDispMenu_EndOpen__);
    sub_1B885B0(&LocalizationManager_TypeInfo);
    sub_1B885B0(&StringLiteral_43/*"\n"*/);
    sub_1B885B0(&StringLiteral_3867/*"CONTINUE_DEVICE_DISP_TITLE"*/);
    sub_1B885B0(&StringLiteral_3863/*"CONTINUE_DEVICE_DISP_CANCEL"*/);
    sub_1B885B0(&StringLiteral_3866/*"CONTINUE_DEVICE_DISP_EXPLANATIOIN2"*/);
    sub_1B885B0(&StringLiteral_3865/*"CONTINUE_DEVICE_DISP_DECIDE"*/);
    sub_1B885B0(&StringLiteral_3864/*"CONTINUE_DEVICE_DISP_COPY"*/);
    sub_1B885B0(&StringLiteral_3880/*"CONTINUE_DEVICE_WARNING_MESSAGE"*/);
    byte_4A5666C = 1;
  }
  ...
  else if ( !state )
  {
    ...
    sub_1B88554(&this->fields.code, code);
    this->fields.callbackFunc = callback;
    sub_1B88554(&this->fields.callbackFunc, callback);
    titleLabel = this->fields.titleLabel;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    continueCodeLabel = LocalizationManager__Get((System_String_o *)StringLiteral_3867/*"CONTINUE_DEVICE_DISP_TITLE"*/, 0LL);
    if ( !titleLabel )
      goto LABEL_16;
    UILabel__set_text(titleLabel, continueCodeLabel, 0LL);
    explanation2Label = this->fields.explanation2Label;
    v12 = LocalizationManager__Get((System_String_o *)StringLiteral_3866/*"CONTINUE_DEVICE_DISP_EXPLANATIOIN2"*/, 0LL);
    v13 = LocalizationManager__Get((System_String_o *)StringLiteral_3880/*"CONTINUE_DEVICE_WARNING_MESSAGE"*/, 0LL);
    continueCodeLabel = System_String__Concat_61718292(v12, (System_String_o *)StringLiteral_43/*"\n"*/, v13, 0LL);
    if ( !explanation2Label )
      goto LABEL_16;
    UILabel__set_text(explanation2Label, continueCodeLabel, 0LL);
    copyLabel = this->fields.copyLabel;
    continueCodeLabel = LocalizationManager__Get((System_String_o *)StringLiteral_3864/*"CONTINUE_DEVICE_DISP_COPY"*/, 0LL);
    if ( !copyLabel )
      goto LABEL_16;
    UILabel__set_text(copyLabel, continueCodeLabel, 0LL);
    decideLabel = this->fields.decideLabel;
    continueCodeLabel = LocalizationManager__Get((System_String_o *)StringLiteral_3865/*"CONTINUE_DEVICE_DISP_DECIDE"*/, 0LL);
    if ( !decideLabel
      || (UILabel__set_text(decideLabel, continueCodeLabel, 0LL),
          cancelLabel = this->fields.cancelLabel,
          continueCodeLabel = LocalizationManager__Get((System_String_o *)StringLiteral_3863/*"CONTINUE_DEVICE_DISP_CANCEL"*/, 0LL),
          !cancelLabel)
      || (UILabel__set_text(cancelLabel, continueCodeLabel, 0LL),
          (continueCodeLabel = (System_String_o *)this->fields.continueCodeLabel) == 0LL) )
    {
LABEL_16:
      sub_1B8880C(continueCodeLabel, v10);
    }
        ...
        const MethodInfo *method)
{
  ...
  v11 = (ContinueDeviceDispMenu_o *)sub_1B88ACC(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19C7634;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19C75EC;
}
