...
void __fastcall ContinueDeviceDispMenu__Close(ContinueDeviceDispMenu_o *this, const MethodInfo *method)
{
  ...
  ContinueDeviceDispMenu__Close_31889472(this, 0LL, v2);
}


void __fastcall ContinueDeviceDispMenu__Close_31889472(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAF9A5 & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_ContinueDeviceDispMenu_EndClose__, v5);
    byte_4BAF9A5 = 1;
  }
...
void __fastcall ContinueDeviceDispMenu__OnClickCancel(ContinueDeviceDispMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BAF9A9 & 1) == 0 )
  {
    sub_1C13D24(&Method_ContinueDeviceDispMenu_OnClickCancel__, method);
    byte_4BAF9A9 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ContinueDeviceDispMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C13D3C(Method_ContinueDeviceDispMenu_OnClickCancel__);
...
void __fastcall ContinueDeviceDispMenu__OnClickCopy(ContinueDeviceDispMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BAF9A6 & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_ContinueDeviceDispMenu_EndCopyDialog__, v3);
    sub_1C13D24(&Method_ContinueDeviceDispMenu_OnClickCopy__, v4);
    sub_1C13D24(&UnityEngine_GUIUtility_TypeInfo, v5);
    sub_1C13D24(&LocalizationManager_TypeInfo, v6);
    sub_1C13D24(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v7);
    sub_1C13D24(&StringLiteral_3908/*"CONTINUECOUNT"*/, v8);
    byte_4BAF9A6 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ContinueDeviceDispMenu_OnClickCopy__ + 83) & 2) != 0 )
      v9 = (_QWORD *)sub_1C13D3C(Method_ContinueDeviceDispMenu_OnClickCopy__);
    ...
    v13 = LocalizationManager__Get((System_String_o *)StringLiteral_3908/*"CONTINUECOUNT"*/, 0LL);
    v14 = (NotificationDialog_ClickDelegate_o *)sub_1C13F70(NotificationDialog_ClickDelegate_TypeInfo);
...
void __fastcall ContinueDeviceDispMenu__OnClickDecide(ContinueDeviceDispMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BAF9A8 & 1) == 0 )
  {
    sub_1C13D24(&Method_ContinueDeviceDispMenu_OnClickDecide__, method);
    byte_4BAF9A8 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ContinueDeviceDispMenu_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C13D3C(Method_ContinueDeviceDispMenu_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C13D08(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAF9A4 & 1) == 0 )
  {
    sub_1C13D24(&System_Action_TypeInfo, code);
    sub_1C13D24(&Method_ContinueDeviceDispMenu_EndOpen__, v7);
    sub_1C13D24(&LocalizationManager_TypeInfo, v8);
    sub_1C13D24(&StringLiteral_43/*"\n"*/, v9);
    sub_1C13D24(&StringLiteral_3913/*"CONTINUE_DEVICE_DISP_COPY"*/, v10);
    sub_1C13D24(&StringLiteral_3909/*"CONTINUE_BATTLE_SAVEKEY"*/, v11);
    sub_1C13D24(&StringLiteral_3912/*"CONTINUE_DEVICE_DISP_CANCEL"*/, v12);
    sub_1C13D24(&StringLiteral_3911/*"CONTINUE_DEVICE_DIALOG_MESSAGE1"*/, v13);
    sub_1C13D24(&StringLiteral_3910/*"CONTINUE_DEVICE_CONFIRM_MESSAGE2"*/, v14);
    sub_1C13D24(&StringLiteral_3926/*"CONTINUE_DEVICE_TAKEOVER_EXPLANATIOIN1"*/, v15);
    byte_4BAF9A4 = 1;
  }
  ...
  else if ( !state )
  {
    ...
    v21 = LocalizationManager__Get((System_String_o *)StringLiteral_3912/*"CONTINUE_DEVICE_DISP_CANCEL"*/, 0LL);
    v22 = LocalizationManager__Get((System_String_o *)StringLiteral_3926/*"CONTINUE_DEVICE_TAKEOVER_EXPLANATIOIN1"*/, 0LL);
    continueCodeLabel = System_String__Concat_62979204(v21, (System_String_o *)StringLiteral_43/*"\n"*/, v22, 0LL);
    if ( !explanation2Label )
      goto LABEL_16;
    UILabel__set_text(explanation2Label, continueCodeLabel, 0LL);
    copyLabel = this->fields.copyLabel;
    continueCodeLabel = LocalizationManager__Get((System_String_o *)StringLiteral_3910/*"CONTINUE_DEVICE_CONFIRM_MESSAGE2"*/, 0LL);
    if ( !copyLabel )
      goto LABEL_16;
    UILabel__set_text(copyLabel, continueCodeLabel, 0LL);
    decideLabel = this->fields.decideLabel;
    continueCodeLabel = LocalizationManager__Get((System_String_o *)StringLiteral_3911/*"CONTINUE_DEVICE_DIALOG_MESSAGE1"*/, 0LL);
    if ( !decideLabel
      || (UILabel__set_text(decideLabel, continueCodeLabel, 0LL),
          cancelLabel = this->fields.cancelLabel,
          continueCodeLabel = LocalizationManager__Get((System_String_o *)StringLiteral_3909/*"CONTINUE_BATTLE_SAVEKEY"*/, 0LL),
          !cancelLabel)
      || (UILabel__set_text(cancelLabel, continueCodeLabel, 0LL),
          (continueCodeLabel = (System_String_o *)this->fields.continueCodeLabel) == 0LL) )
    {
LABEL_16:
      sub_1C13F80(continueCodeLabel, v19);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAF9A1 & 1) == 0 )
  {
    sub_1C13D24(&ContinueDeviceDispMenu_CallbackFunc_TypeInfo, value);
    byte_4BAF9A1 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (ContinueDeviceDispMenu_o *)sub_1C14240(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A4DFD4;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A4DF8C;
}
