...
void __fastcall ContinueDeviceDispMenu__Close(ContinueDeviceDispMenu_o *this, const MethodInfo *method)
{
  ...
  ContinueDeviceDispMenu__Close_31049484(this, 0LL, v2);
}


void __fastcall ContinueDeviceDispMenu__Close_31049484(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B34D & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_ContinueDeviceDispMenu_EndClose__, v5);
    byte_4A6B34D = 1;
  }
...
void __fastcall ContinueDeviceDispMenu__OnClickCancel(ContinueDeviceDispMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B351 & 1) == 0 )
  {
    sub_1B90010(&Method_ContinueDeviceDispMenu_OnClickCancel__, method);
    byte_4A6B351 = 1;
  }
...
void __fastcall ContinueDeviceDispMenu__OnClickCopy(ContinueDeviceDispMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B34E & 1) == 0 )
  {
    sub_1B90010(&NotificationDialog_ClickDelegate_TypeInfo, method);
    sub_1B90010(&Method_ContinueDeviceDispMenu_EndCopyDialog__, v3);
    sub_1B90010(&Method_ContinueDeviceDispMenu_OnClickCopy__, v4);
    sub_1B90010(&UnityEngine_GUIUtility_TypeInfo, v5);
    sub_1B90010(&LocalizationManager_TypeInfo, v6);
    sub_1B90010(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v7);
    sub_1B90010(&StringLiteral_3863/*"CONTINUE_DEVICE_DIALOG_MESSAGE1"*/, v8);
    byte_4A6B34E = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    v13 = LocalizationManager__Get((System_String_o *)StringLiteral_3863/*"CONTINUE_DEVICE_DIALOG_MESSAGE1"*/, 0LL);
    v14 = (NotificationDialog_ClickDelegate_o *)sub_1B9025C(NotificationDialog_ClickDelegate_TypeInfo);
...
void __fastcall ContinueDeviceDispMenu__OnClickDecide(ContinueDeviceDispMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B350 & 1) == 0 )
  {
    sub_1B90010(&Method_ContinueDeviceDispMenu_OnClickDecide__, method);
    byte_4A6B350 = 1;
  }
  if ( this->fields.state == 2 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B34C & 1) == 0 )
  {
    sub_1B90010(&System_Action_TypeInfo, code);
    sub_1B90010(&Method_ContinueDeviceDispMenu_EndOpen__, v7);
    sub_1B90010(&LocalizationManager_TypeInfo, v8);
    sub_1B90010(&StringLiteral_43/*"\n"*/, v9);
    sub_1B90010(&StringLiteral_3868/*"CONTINUE_DEVICE_DISP_TITLE"*/, v10);
    sub_1B90010(&StringLiteral_3864/*"CONTINUE_DEVICE_DISP_CANCEL"*/, v11);
    sub_1B90010(&StringLiteral_3867/*"CONTINUE_DEVICE_DISP_EXPLANATIOIN2"*/, v12);
    sub_1B90010(&StringLiteral_3866/*"CONTINUE_DEVICE_DISP_DECIDE"*/, v13);
    sub_1B90010(&StringLiteral_3865/*"CONTINUE_DEVICE_DISP_COPY"*/, v14);
    sub_1B90010(&StringLiteral_3881/*"CONTINUE_DEVICE_WARNING_MESSAGE"*/, v15);
    byte_4A6B34C = 1;
  }
  ...
  else if ( !state )
  {
    ...
    sub_1B8FFB4(&this->fields.code);
    this->fields.callbackFunc = callback;
    sub_1B8FFB4(&this->fields.callbackFunc);
    titleLabel = this->fields.titleLabel;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    continueCodeLabel = LocalizationManager__Get((System_String_o *)StringLiteral_3868/*"CONTINUE_DEVICE_DISP_TITLE"*/, 0LL);
    if ( !titleLabel )
      goto LABEL_16;
    UILabel__set_text(titleLabel, continueCodeLabel, 0LL);
    explanation2Label = this->fields.explanation2Label;
    v21 = LocalizationManager__Get((System_String_o *)StringLiteral_3867/*"CONTINUE_DEVICE_DISP_EXPLANATIOIN2"*/, 0LL);
    v22 = LocalizationManager__Get((System_String_o *)StringLiteral_3881/*"CONTINUE_DEVICE_WARNING_MESSAGE"*/, 0LL);
    continueCodeLabel = System_String__Concat_61798352(v21, (System_String_o *)StringLiteral_43/*"\n"*/, v22, 0LL);
    if ( !explanation2Label )
      goto LABEL_16;
    UILabel__set_text(explanation2Label, continueCodeLabel, 0LL);
    copyLabel = this->fields.copyLabel;
    continueCodeLabel = LocalizationManager__Get((System_String_o *)StringLiteral_3865/*"CONTINUE_DEVICE_DISP_COPY"*/, 0LL);
    if ( !copyLabel )
      goto LABEL_16;
    UILabel__set_text(copyLabel, continueCodeLabel, 0LL);
    decideLabel = this->fields.decideLabel;
    continueCodeLabel = LocalizationManager__Get((System_String_o *)StringLiteral_3866/*"CONTINUE_DEVICE_DISP_DECIDE"*/, 0LL);
    if ( !decideLabel
      || (UILabel__set_text(decideLabel, continueCodeLabel, 0LL),
          cancelLabel = this->fields.cancelLabel,
          continueCodeLabel = LocalizationManager__Get((System_String_o *)StringLiteral_3864/*"CONTINUE_DEVICE_DISP_CANCEL"*/, 0LL),
          !cancelLabel)
      || (UILabel__set_text(cancelLabel, continueCodeLabel, 0LL),
          (continueCodeLabel = (System_String_o *)this->fields.continueCodeLabel) == 0LL) )
    {
LABEL_16:
      sub_1B9026C(continueCodeLabel, v19);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B349 & 1) == 0 )
  {
    sub_1B90010(&ContinueDeviceDispMenu_CallbackFunc_TypeInfo, value);
    byte_4A6B349 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (ContinueDeviceDispMenu_o *)sub_1B9052C(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19CE9EC;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19CE9A4;
}
