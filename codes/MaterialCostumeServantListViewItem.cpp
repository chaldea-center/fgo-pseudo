        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A043BD & 1) == 0 )
  {
    sub_1B686D4(&Method_DataManager_GetMasterData_ServantCostumeReleaseMaster___, svtCostumeEntity);
    sub_1B686D4(&Method_DataManager_GetMasterData_ServantLimitMaster___, v7);
  ...
  sub_1B68678(&this->fields._svtCostumeEntity_k__BackingField);
  ...
  Instance = sub_1B68678(&this->fields._userSvtCollectionEntity_k__BackingField);
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      *(_QWORD *)&v42.fields.fakeValue = data;
      Instance = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46239416(v42, 0LL);
...
LABEL_55:
    ...
    *p_userSvtCollectionEntity_k__BackingField = *v23;
    sub_1B68678(&this->fields._userSvtCollectionEntity_k__BackingField);
  }
LABEL_16:
  ...
  *(_QWORD *)&v43.fields.fakeValue = v29;
  Instance = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46239416(v43, 0LL);
  if ( !v28 )
    goto LABEL_54;
  ...
  if ( (v7 & 1) != 0 )
  {
    ...
    if ( sort->fields.sortKind == 27 )
    {
      ...
      if ( svtCostumeEntity_k__BackingField )
      {
        ...
        if ( iconLabelInfo )
        {
          IconLabelInfo__Set_37887348(iconLabelInfo, 57, costumeCollectionNo, 0, 0, 0, 0, 0, 0LL);
LABEL_12:
