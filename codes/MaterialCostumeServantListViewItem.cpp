        ...
        const MethodInfo *method)
{
  ...
  sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.iconLabelInfo, (int32_t)v7, v9, v10, v11, v12, v13, v14);
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      *(_QWORD *)&v72.fields.fakeValue = data;
      Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49297952(v72, 0);
...
LABEL_16:
  ...
  *(_QWORD *)&v73.fields.fakeValue = v49;
  ...
  sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.servantEntity, (int32_t)Entity, v52, v53, v54, v55, v56, v57);
  ...
  v61 = (ServantOverwriteStatus_o *)sub_1C715FC(ServantOverwriteStatus_TypeInfo);
  ServantOverwriteStatus___ctor_33652792(v61, v59, id, 0);
  if ( !v61 )
    goto LABEL_56;
  ...
  if ( (v7 & 1) != 0 )
  {
    ...
    if ( sort->fields.sortKind == 27 )
    {
      ...
      if ( svtCostumeEntity_k__BackingField )
      {
        ...
        if ( iconLabelInfo )
        {
          IconLabelInfo__Set_41192248(iconLabelInfo, 57, costumeCollectionNo, 0, 0, 0, 0, 0, 0, 0);
LABEL_12:
