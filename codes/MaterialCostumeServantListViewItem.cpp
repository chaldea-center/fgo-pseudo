  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      *(_QWORD *)&v71.fields.fakeValue = data;
      Instance = (void *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_44786420(v71, 0LL);
...
LABEL_17:
  ...
  *(_QWORD *)&v72.fields.fakeValue = v47;
  Instance = (void *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_44786420(v72, 0LL);
  if ( !v46 )
    goto LABEL_56;
