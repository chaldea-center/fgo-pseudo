...
void BankStatusRequest__beginRequest(BankStatusRequest_o *this, const MethodInfo *method)
{
  if ( (byte_4C587C0 & 1) == 0 )
  {
    sub_1C3E564(&StringLiteral_22730/*"platformType"*/);
    byte_4C587C0 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22730/*"platformType"*/, 2, 0);
...
System_String_o *BankStatusRequest__getURL(BankStatusRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C587BF & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_23454/*"shop/bankStatus"*/);
    byte_4C587BF = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63636468(BaseUrl, (System_String_o *)StringLiteral_23454/*"shop/bankStatus"*/, 0);
}
