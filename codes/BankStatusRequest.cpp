...
void __fastcall BankStatusRequest__beginRequest(BankStatusRequest_o *this, const MethodInfo *method)
{
  if ( (byte_40F6ED7 & 1) == 0 )
  {
    sub_B16FFC(&StringLiteral_21393/*"platformType"*/, method);
    byte_40F6ED7 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21393/*"platformType"*/, 2, 0LL);
...
System_String_o *__fastcall BankStatusRequest__getURL(BankStatusRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_40F6ED6 & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_22011/*"shop/bankStatus"*/, v2);
    byte_40F6ED6 = 1;
  }
  ...
  return System_String__Concat_43743732(BaseUrl, (System_String_o *)StringLiteral_22011/*"shop/bankStatus"*/, 0LL);
}
