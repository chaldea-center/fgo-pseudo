void __fastcall BankStatusRequest__beginRequest(BankStatusRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5C91E & 1) == 0 )
  {
    sub_1B885B0(&StringLiteral_22544/*"platformType"*/);
    byte_4A5C91E = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22544/*"platformType"*/, 2, v2);
...
System_String_o *__fastcall BankStatusRequest__getURL(BankStatusRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5C91D & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_23263/*"shop/bankStatus"*/);
    byte_4A5C91D = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61707032(BaseUrl, (System_String_o *)StringLiteral_23263/*"shop/bankStatus"*/, 0LL);
}
