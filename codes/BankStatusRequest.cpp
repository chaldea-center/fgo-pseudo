void __fastcall BankStatusRequest__beginRequest(BankStatusRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A71632 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_22577/*"platformType"*/, method);
    byte_4A71632 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22577/*"platformType"*/, 2, v2);
...
System_String_o *__fastcall BankStatusRequest__getURL(BankStatusRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A71631 & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_23298/*"shop/bankStatus"*/, v2);
    byte_4A71631 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61787092(BaseUrl, (System_String_o *)StringLiteral_23298/*"shop/bankStatus"*/, 0LL);
}
