...
void __fastcall BankStatusRequest__beginRequest(BankStatusRequest_o *this, const MethodInfo *method)
{
  if ( (byte_4211624 & 1) == 0 )
  {
    sub_B0D8A4(&StringLiteral_21555/*"platformType"*/, method);
    byte_4211624 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21555/*"platformType"*/, 2, 0LL);
...
System_String_o *__fastcall BankStatusRequest__getURL(BankStatusRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4211623 & 1) == 0 )
  {
    ...
    sub_B0D8A4(&StringLiteral_22178/*"shop/bankStatus"*/, v2);
    byte_4211623 = 1;
  }
  ...
  return System_String__Concat_43849904(BaseUrl, (System_String_o *)StringLiteral_22178/*"shop/bankStatus"*/, 0LL);
}
