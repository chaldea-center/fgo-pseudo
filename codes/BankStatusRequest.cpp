...
void __fastcall BankStatusRequest__beginRequest(BankStatusRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42E6613 & 1) == 0 )
  {
    sub_B5D5C4(&StringLiteral_21774/*"platformType"*/, (_DWORD)method, v2, v3);
    byte_42E6613 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21774/*"platformType"*/, 2, 0LL);
...
System_String_o *__fastcall BankStatusRequest__getURL(BankStatusRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42E6612 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&StringLiteral_22405/*"shop/bankStatus"*/, v4, v5, v6);
    byte_42E6612 = 1;
  }
  ...
  return System_String__Concat_44577788(BaseUrl, (System_String_o *)StringLiteral_22405/*"shop/bankStatus"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v12 = ResponseCommandKind__SearchData(61, responseList, 0LL);
  if ( v12
