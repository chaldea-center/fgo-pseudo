...
void BankStatusRequest__beginRequest(BankStatusRequest_o *this, const MethodInfo *method)
{
  if ( (byte_597231B & 1) == 0 )
  {
    sub_2213A60(&StringLiteral_23882/*"platformType"*/);
    byte_597231B = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23882/*"platformType"*/, 2, 0);
...
System_String_o *BankStatusRequest__getURL(BankStatusRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_597231A & 1) == 0 )
  {
    ...
    sub_2213A60(&StringLiteral_24663/*"shop/bankStatus"*/);
    byte_597231A = 1;
  }
  if ( !*(&NetworkManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_75651716(BaseUrl, (System_String_o *)StringLiteral_24663/*"shop/bankStatus"*/, 0);
}
