...
void BankStatusRequest__beginRequest(BankStatusRequest_o *this, const MethodInfo *method)
{
  if ( (byte_4CF0070 & 1) == 0 )
  {
    sub_1C7BAE8(&StringLiteral_22926/*"platformType"*/);
    byte_4CF0070 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22926/*"platformType"*/, 2, 0);
...
System_String_o *BankStatusRequest__getURL(BankStatusRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CF006F & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_23654/*"shop/bankStatus"*/);
    byte_4CF006F = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64176912(BaseUrl, (System_String_o *)StringLiteral_23654/*"shop/bankStatus"*/, 0);
}
