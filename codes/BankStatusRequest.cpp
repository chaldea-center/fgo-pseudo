...
void BankStatusRequest__beginRequest(BankStatusRequest_o *this, const MethodInfo *method)
{
  if ( (byte_593A13E & 1) == 0 )
  {
    sub_21FFC50(&StringLiteral_23835/*"platformType"*/);
    byte_593A13E = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23835/*"platformType"*/, 2, 0);
...
System_String_o *BankStatusRequest__getURL(BankStatusRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_593A13D & 1) == 0 )
  {
    ...
    sub_21FFC50(&StringLiteral_24615/*"shop/bankStatus"*/);
    byte_593A13D = 1;
  }
  if ( !*(&NetworkManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_75438412(BaseUrl, (System_String_o *)StringLiteral_24615/*"shop/bankStatus"*/, 0);
}
