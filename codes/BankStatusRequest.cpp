void __fastcall BankStatusRequest__beginRequest(BankStatusRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B389A8 & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_22820/*"platformType"*/, method);
    byte_4B389A8 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22820/*"platformType"*/, 2, v2);
...
System_String_o *__fastcall BankStatusRequest__getURL(BankStatusRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B389A7 & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_23544/*"shop/bankStatus"*/, v2);
    byte_4B389A7 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62525248(BaseUrl, (System_String_o *)StringLiteral_23544/*"shop/bankStatus"*/, 0LL);
}
