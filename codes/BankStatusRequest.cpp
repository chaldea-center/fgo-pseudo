...
void __fastcall BankStatusRequest__beginRequest(BankStatusRequest_o *this, const MethodInfo *method)
{
  if ( (byte_42ACEEE & 1) == 0 )
  {
    sub_B52984(&StringLiteral_21661/*"platformType"*/);
    byte_42ACEEE = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21661/*"platformType"*/, 2, 0LL);
...
System_String_o *__fastcall BankStatusRequest__getURL(BankStatusRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42ACEED & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_22290/*"shop/bankStatus"*/);
    byte_42ACEED = 1;
  }
  ...
  return System_String__Concat_44568316(BaseUrl, (System_String_o *)StringLiteral_22290/*"shop/bankStatus"*/, 0LL);
}
