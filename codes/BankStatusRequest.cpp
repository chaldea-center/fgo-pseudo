...
void __fastcall BankStatusRequest__beginRequest(BankStatusRequest_o *this, const MethodInfo *method)
{
  if ( (byte_4A0A339 & 1) == 0 )
  {
    sub_1B686D4(&StringLiteral_22467/*"platformType"*/, method);
    byte_4A0A339 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22467/*"platformType"*/, 2, 0LL);
...
System_String_o *__fastcall BankStatusRequest__getURL(BankStatusRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0A338 & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_23183/*"shop/bankStatus"*/, v2);
    byte_4A0A338 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61419468(BaseUrl, (System_String_o *)StringLiteral_23183/*"shop/bankStatus"*/, 0LL);
}
