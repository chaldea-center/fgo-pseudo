void __fastcall BankStatusRequest__beginRequest(BankStatusRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B179DC & 1) == 0 )
  {
    sub_1BCA7E0(&StringLiteral_22786/*"platformType"*/, method, v2);
    byte_4B179DC = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22786/*"platformType"*/, 2, v3);
  RequestBase__beginRequest((RequestBase_o *)this, v5);
}
...
System_String_o *__fastcall BankStatusRequest__getURL(BankStatusRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B179DB & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&StringLiteral_23509/*"shop/bankStatus"*/, v3, v4);
    byte_4B179DB = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62401220(BaseUrl, (System_String_o *)StringLiteral_23509/*"shop/bankStatus"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v9 = ResponseCommandKind__SearchData(61, responseList, 0LL);
  if ( v9
