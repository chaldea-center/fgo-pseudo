...
void __fastcall ScriptBranchMenu__Close(ScriptBranchMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C1AE30(serverSettingRootObject, method);
  }
...
void __fastcall ScriptBranchMenu__CreateList(ScriptBranchMenu_o *this, int32_t sorttype, const MethodInfo *method)
{
  ...
  if ( (byte_4BC51DE & 1) == 0 )
  {
    sub_1C1ABD4(&System_Action_TypeInfo, *(_QWORD *)&sorttype);
    sub_1C1ABD4(&Method_ScriptBranchMenu_OnClickItem__, v6);
    byte_4BC51DE = 1;
  }
  ...
  {
    sub_1C1AE30(listViewManager, *(_QWORD *)&sorttype);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
  {
    ...
    {
      sub_1C1AE30(listViewManager, v16);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC51DC & 1) == 0 )
  {
    sub_1C1ABD4(&ScriptBranchMenu_CallbackFunc_TypeInfo, value);
    byte_4BC51DC = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A593EC;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A593A4;
}
