...
void ScriptBranchMenu__CreateList(ScriptBranchMenu_o *this, int32_t sorttype, const MethodInfo *method)
{
  ...
  if ( (byte_4C34F80 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_ScriptBranchMenu_OnClickItem__);
    byte_4C34F80 = 1;
  }
...
void ScriptBranchMenu__OnClickItem(ScriptBranchMenu_o *this, const MethodInfo *method)
{
  ...
  ScriptBranchListViewItem_o *v6; // x19
  bool v7; // w1
  ...
  if ( this->fields.state == 1 )
  {
    ...
    if ( (callbackIndex & 0x80000000) == 0 )
    {
      ...
      if ( listViewManager )
      {
        v6 = (ScriptBranchListViewItem_o *)listViewManager;
        v7 = !ScriptBranchListViewItem__get_IsFlagOn((ScriptBranchListViewItem_o *)listViewManager, v5);
        ScriptBranchListViewItem__ChangeFlag(v6, v7, v8);
        return;
      }
LABEL_7:
      sub_1C32E7C(listViewManager);
        ...
        const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
  {
    ...
    sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.listObject, (int32_t)list, (int32_t)callback, method);
    ...
    ScriptBranchMenu__CreateList(this, this->fields.sortType, v9);
    this->fields.state = 1;
  }
}
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1A74704;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A746BC;
}
