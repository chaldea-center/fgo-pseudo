...
void ScriptBranchMenu__Close(ScriptBranchMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_2213CDC(serverSettingRootObject, method);
  }
...
void ScriptBranchMenu__CreateList(ScriptBranchMenu_o *this, int32_t sorttype, const MethodInfo *method)
{
  ...
  if ( (byte_596DCE7 & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_ScriptBranchMenu_OnClickItem__);
    byte_596DCE7 = 1;
  }
  ...
  {
    sub_2213CDC(listViewManager, *(_QWORD *)&sorttype);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
  {
    ...
    {
      sub_2213CDC(listViewManager, v16);
    }
        ...
        const MethodInfo *method)
{
  ...
  sub_221405C(v8, ScriptBranchMenu_CallbackFunc_TypeInfo, v9, v10);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_20085BC;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_2008574;
}
