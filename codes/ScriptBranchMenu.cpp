...
void ScriptBranchMenu__Close(ScriptBranchMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1CE6958(serverSettingRootObject, method);
  }
...
void ScriptBranchMenu__CreateList(ScriptBranchMenu_o *this, int32_t sorttype, const MethodInfo *method)
{
  ...
  if ( (byte_4E01FA6 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_ScriptBranchMenu_OnClickItem__);
    byte_4E01FA6 = 1;
  }
  ...
  {
    sub_1CE6958(listViewManager, *(_QWORD *)&sorttype);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
  {
    ...
    {
      sub_1CE6958(listViewManager, v16);
    }
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1B148A4;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1B1485C;
}
