...
void __fastcall ScriptBranchMenu__Close(ScriptBranchMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BC3264(serverSettingRootObject, method);
  }
...
void __fastcall ScriptBranchMenu__CreateList(ScriptBranchMenu_o *this, int32_t sorttype, const MethodInfo *method)
{
  ...
  if ( (byte_4AFF652 & 1) == 0 )
  {
    sub_1BC3008(&System_Action_TypeInfo, *(_QWORD *)&sorttype);
    sub_1BC3008(&Method_ScriptBranchMenu_OnClickItem__, v6);
    byte_4AFF652 = 1;
  }
  ...
  {
    sub_1BC3264(listViewManager, *(_QWORD *)&sorttype);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
  {
    ...
    sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.listObject, (int32_t)list, (int32_t)callback, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFF650 & 1) == 0 )
  {
    sub_1BC3008(&ScriptBranchMenu_CallbackFunc_TypeInfo, value);
    byte_4AFF650 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A0A844;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A0A7FC;
}
