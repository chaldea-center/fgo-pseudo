void __fastcall MovieConfirmDialog___ctor(MovieConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.PLAY_MAIN_LABEL_Y = xmmword_327A8A0;
...
void __fastcall MovieConfirmDialog__Close(MovieConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  MovieConfirmDialog__Close_22444392(this, 0LL, v2);
}


void __fastcall MovieConfirmDialog__Close_22444392(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AE85B & 1) == 0 )
  {
    ...
    sub_B52984(&Method_MovieConfirmDialog_EndClose__);
    byte_42AE85B = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AE860 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_11036/*"QUEST_MESSAGE_DLG_MOVIE_DOWNLOAD_SUB_MESSAGE"*/);
    sub_B52984(&StringLiteral_11038/*"QUEST_MESSAGE_DLG_MOVIE_PLAY_SUB_MESSAGE"*/);
    byte_42AE860 = 1;
  }
  if ( mode == 1 )
  {
    ...
    *subY = this->fields.DOWNLOAD_SUB_LABEL_Y;
    ...
    v11 = &StringLiteral_11036/*"QUEST_MESSAGE_DLG_MOVIE_DOWNLOAD_SUB_MESSAGE"*/;
  }
  else
  {
    ...
    *subY = this->fields.PLAY_SUB_LABEL_Y;
    ...
    v11 = &StringLiteral_11038/*"QUEST_MESSAGE_DLG_MOVIE_PLAY_SUB_MESSAGE"*/;
  }
  v12 = LocalizationManager__Get((System_String_o *)*v11, 0LL);
  *subMessage = v12;
  sub_B52920((BattleServantConfConponent_o *)subMessage, (System_Int32_array **)v12, v13, v14, v15, v16, v17, v18);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AE85A & 1) == 0 )
  {
    sub_B52984(&System_Action_TypeInfo);
    sub_B52984(&LocalizationManager_TypeInfo);
    sub_B52984(&Method_MovieConfirmDialog_EndOpen__);
    sub_B52984(&UnityEngine_Object_TypeInfo);
    sub_B52984(&StringLiteral_26/*"\n"*/);
    sub_B52984(&StringLiteral_11035/*"QUEST_MESSAGE_DLG_MOVIE_DOWNLOAD_DECIDE"*/);
    sub_B52984(&StringLiteral_11030/*"QUEST_MESSAGE_DLG_CANCEL"*/);
    sub_B52984(&StringLiteral_15960/*"\\n"*/);
    sub_B52984(&StringLiteral_1/*""*/);
    byte_42AE85A = 1;
  }
  v32 = 0LL;
  ...
  if ( ((unsigned __int8)v18 & 1) != 0 )
  {
    if ( !message )
      goto LABEL_52;
    v18 = (UILabel_o *)System_String__Replace_44575552(
                         message,
  ...
  if ( UnityEngine_Object__op_Inequality(buttonDecideLabel, 0LL, 0LL) )
  {
    ...
    v18 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11035/*"QUEST_MESSAGE_DLG_MOVIE_DOWNLOAD_DECIDE"*/, 0LL);
    if ( !v28 )
      goto LABEL_52;
  ...
  if ( UnityEngine_Object__op_Inequality(buttonCancelLabel, 0LL, 0LL) )
  {
    ...
    v18 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11030/*"QUEST_MESSAGE_DLG_CANCEL"*/, 0LL);
    if ( v30 )
    {
