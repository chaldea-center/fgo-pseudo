void __fastcall MovieConfirmDialog___ctor(MovieConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.PLAY_MAIN_LABEL_Y = xmmword_BFD850;
...
void __fastcall MovieConfirmDialog__Close(MovieConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  MovieConfirmDialog__Close_46567140(this, 0LL, v2);
}


void __fastcall MovieConfirmDialog__Close_46567140(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BE0168 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_MovieConfirmDialog_EndClose__);
    byte_4BE0168 = 1;
  }
  ...
  System_Action___ctor(v10, (Il2CppObject *)this, Method_MovieConfirmDialog_EndClose__, 0LL);
...
void __fastcall MovieConfirmDialog__OnClickCancel(MovieConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BE016B & 1) == 0 )
  {
    sub_1C21E38(&Method_MovieConfirmDialog_OnClickCancel__);
    byte_4BE016B = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_MovieConfirmDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_MovieConfirmDialog_OnClickCancel__);
...
void __fastcall MovieConfirmDialog__OnClickClose(MovieConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BE016C & 1) == 0 )
  {
    sub_1C21E38(&Method_MovieConfirmDialog_OnClickClose__);
    byte_4BE016C = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_MovieConfirmDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_MovieConfirmDialog_OnClickClose__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C21E1C(v3, v3[4]);
...
void __fastcall MovieConfirmDialog__OnClickDecide(MovieConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BE0169 & 1) == 0 )
  {
    sub_1C21E38(&Method_MovieConfirmDialog_OnClickDecide__);
    byte_4BE0169 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_MovieConfirmDialog_OnClickDecide__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1C21E50(Method_MovieConfirmDialog_OnClickDecide__);
...
void __fastcall MovieConfirmDialog__OnClickDecide2(MovieConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BE016A & 1) == 0 )
  {
    sub_1C21E38(&Method_MovieConfirmDialog_OnClickDecide2__);
    byte_4BE016A = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_MovieConfirmDialog_OnClickDecide2__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_MovieConfirmDialog_OnClickDecide2__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C21E1C(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BE016D & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_11101/*"QUEST_MESSAGE_DLG_MOVIE_DOWNLOAD_SUB_MESSAGE"*/);
    sub_1C21E38(&StringLiteral_11103/*"QUEST_MESSAGE_DLG_MOVIE_PLAY_SUB_MESSAGE"*/);
    byte_4BE016D = 1;
  }
  if ( mode == 1 )
  {
    ...
    *subY = this->fields.DOWNLOAD_SUB_LABEL_Y;
    ...
    v11 = &StringLiteral_11101/*"QUEST_MESSAGE_DLG_MOVIE_DOWNLOAD_SUB_MESSAGE"*/;
  }
  else
  {
    ...
    *subY = this->fields.PLAY_SUB_LABEL_Y;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v11 = &StringLiteral_11103/*"QUEST_MESSAGE_DLG_MOVIE_PLAY_SUB_MESSAGE"*/;
  }
  v12 = LocalizationManager__Get((System_String_o *)*v11, 0LL);
  *subMessage = v12;
  sub_1C21DDC((PartyOrganizationUtility_o *)subMessage, (int64_t)v12, v13, v14, v15, v16, v17, v18);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BE0167 & 1) == 0 )
  {
    sub_1C21E38(&System_Action_TypeInfo);
    sub_1C21E38(&LocalizationManager_TypeInfo);
    sub_1C21E38(&Method_MovieConfirmDialog_EndOpen__);
    sub_1C21E38(&UnityEngine_Object_TypeInfo);
    sub_1C21E38(&StringLiteral_43/*"\n"*/);
    sub_1C21E38(&StringLiteral_11100/*"QUEST_MESSAGE_DLG_MOVIE_DOWNLOAD_DECIDE"*/);
    sub_1C21E38(&StringLiteral_11095/*"QUEST_MESSAGE_DLG_CANCEL"*/);
    sub_1C21E38(&StringLiteral_16328/*"\\n"*/);
    sub_1C21E38(&StringLiteral_1/*""*/);
    byte_4BE0167 = 1;
  }
  v32 = 0LL;
  ...
  if ( ((unsigned __int8)v18 & 1) != 0 )
  {
    if ( !message )
      goto LABEL_45;
    v18 = (UILabel_o *)System_String__Replace_63135104(
                         message,
                         (System_String_o *)StringLiteral_16328/*"\\n"*/,
    ...
    WrapControlText__textAdjust(this->fields.mainLabel, v22, v21->fields.mFontSize, 0, 0LL);
  ...
  if ( UnityEngine_Object__op_Inequality(subLabel, 0LL, 0LL) )
  {
    ...
    WrapControlText__textAdjust(v18, v25, v18->fields.mFontSize, 0, 0LL);
    v18 = this->fields.subLabel;
    if ( !v18 )
      goto LABEL_45;
  ...
  if ( UnityEngine_Object__op_Inequality(buttonDecideLabel, 0LL, 0LL) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v18 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11100/*"QUEST_MESSAGE_DLG_MOVIE_DOWNLOAD_DECIDE"*/, 0LL);
    if ( !v28 )
      goto LABEL_45;
  ...
  if ( UnityEngine_Object__op_Inequality(buttonCancelLabel, 0LL, 0LL) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v18 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11095/*"QUEST_MESSAGE_DLG_CANCEL"*/, 0LL);
    if ( v30 )
    {
