void MovieConfirmDialog___ctor(MovieConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.PLAY_MAIN_LABEL_Y = xmmword_D34AA0;
...
void MovieConfirmDialog__Close(MovieConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  MovieConfirmDialog__Close_32246196(this, 0, v2);
}


void MovieConfirmDialog__Close_32246196(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E712A8 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_MovieConfirmDialog_EndClose__);
    byte_4E712A8 = 1;
  }
...
void MovieConfirmDialog__OnClickCancel(MovieConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E712AB & 1) == 0 )
  {
    sub_1D0F0B4(&Method_MovieConfirmDialog_OnClickCancel__);
    byte_4E712AB = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_MovieConfirmDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1D0F0CC(Method_MovieConfirmDialog_OnClickCancel__);
...
void MovieConfirmDialog__OnClickClose(MovieConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E712AC & 1) == 0 )
  {
    sub_1D0F0B4(&Method_MovieConfirmDialog_OnClickClose__);
    byte_4E712AC = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_MovieConfirmDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1D0F0CC(Method_MovieConfirmDialog_OnClickClose__);
    v4 = (System_Reflection_MethodBase_o *)sub_1D0F098(v3, v3[4]);
...
void MovieConfirmDialog__OnClickDecide(MovieConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E712A9 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_MovieConfirmDialog_OnClickDecide__);
    byte_4E712A9 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_MovieConfirmDialog_OnClickDecide__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1D0F0CC(Method_MovieConfirmDialog_OnClickDecide__);
...
void MovieConfirmDialog__OnClickDecide2(MovieConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E712AA & 1) == 0 )
  {
    sub_1D0F0B4(&Method_MovieConfirmDialog_OnClickDecide2__);
    byte_4E712AA = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_MovieConfirmDialog_OnClickDecide2__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1D0F0CC(Method_MovieConfirmDialog_OnClickDecide2__);
    v4 = (System_Reflection_MethodBase_o *)sub_1D0F098(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E712AD & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_11047/*"QUEST_MESSAGE_DLG_MOVIE_DOWNLOAD_SUB_MESSAGE"*/);
    sub_1D0F0B4(&StringLiteral_11049/*"QUEST_MESSAGE_DLG_MOVIE_PLAY_SUB_MESSAGE"*/);
    byte_4E712AD = 1;
  }
  if ( mode == 1 )
  {
    ...
    *subY = this->fields.DOWNLOAD_SUB_LABEL_Y;
    ...
    v11 = &StringLiteral_11047/*"QUEST_MESSAGE_DLG_MOVIE_DOWNLOAD_SUB_MESSAGE"*/;
  }
  else
  {
    ...
    *subY = this->fields.PLAY_SUB_LABEL_Y;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v11 = &StringLiteral_11049/*"QUEST_MESSAGE_DLG_MOVIE_PLAY_SUB_MESSAGE"*/;
  }
  v12 = LocalizationManager__Get((System_String_o *)*v11, 0);
  *subMessage = v12;
  sub_1D0F058(subMessage, v12);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E712A7 & 1) == 0 )
  {
    sub_1D0F0B4(&System_Action_TypeInfo);
    sub_1D0F0B4(&LocalizationManager_TypeInfo);
    sub_1D0F0B4(&Method_MovieConfirmDialog_EndOpen__);
    sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    sub_1D0F0B4(&StringLiteral_43/*"\n"*/);
    sub_1D0F0B4(&StringLiteral_11046/*"QUEST_MESSAGE_DLG_MOVIE_DOWNLOAD_DECIDE"*/);
  ...
  if ( ((unsigned __int8)v18 & 1) != 0 )
  {
    if ( !message )
      goto LABEL_45;
    v18 = (UILabel_o *)System_String__Replace_65609336(
                         message,
  ...
  if ( UnityEngine_Object__op_Inequality(buttonDecideLabel, 0, 0) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v18 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11046/*"QUEST_MESSAGE_DLG_MOVIE_DOWNLOAD_DECIDE"*/, 0);
    if ( !v28 )
      goto LABEL_45;
  ...
  if ( UnityEngine_Object__op_Inequality(buttonCancelLabel, 0, 0) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v18 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11041/*"QUEST_MESSAGE_DLG_CANCEL"*/, 0);
    if ( v30 )
    {
