void MovieConfirmDialog___ctor(MovieConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.PLAY_MAIN_LABEL_Y = xmmword_C0DFC0;
...
void MovieConfirmDialog__Close(MovieConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  MovieConfirmDialog__Close_47971892(this, 0, v2);
}


void MovieConfirmDialog__Close_47971892(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C46A46 & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_MovieConfirmDialog_EndClose__);
    byte_4C46A46 = 1;
  }
...
void MovieConfirmDialog__OnClickCancel(MovieConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C46A49 & 1) == 0 )
  {
    sub_1C37058(&Method_MovieConfirmDialog_OnClickCancel__);
    byte_4C46A49 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_MovieConfirmDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C37070(Method_MovieConfirmDialog_OnClickCancel__);
...
void MovieConfirmDialog__OnClickClose(MovieConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C46A4A & 1) == 0 )
  {
    sub_1C37058(&Method_MovieConfirmDialog_OnClickClose__);
    byte_4C46A4A = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_MovieConfirmDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C37070(Method_MovieConfirmDialog_OnClickClose__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C3703C(v3, v3[4]);
...
void MovieConfirmDialog__OnClickDecide(MovieConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C46A47 & 1) == 0 )
  {
    sub_1C37058(&Method_MovieConfirmDialog_OnClickDecide__);
    byte_4C46A47 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_MovieConfirmDialog_OnClickDecide__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1C37070(Method_MovieConfirmDialog_OnClickDecide__);
...
void MovieConfirmDialog__OnClickDecide2(MovieConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C46A48 & 1) == 0 )
  {
    sub_1C37058(&Method_MovieConfirmDialog_OnClickDecide2__);
    byte_4C46A48 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_MovieConfirmDialog_OnClickDecide2__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C37070(Method_MovieConfirmDialog_OnClickDecide2__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C3703C(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C46A4B & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_10890/*"QUEST_MESSAGE_DLG_MOVIE_DOWNLOAD_SUB_MESSAGE"*/);
    sub_1C37058(&StringLiteral_10892/*"QUEST_MESSAGE_DLG_MOVIE_PLAY_SUB_MESSAGE"*/);
    byte_4C46A4B = 1;
  }
  if ( mode == 1 )
  {
  ...
  *subMessage = v12;
  sub_1C36FFC((CGThumbnailListItem_o *)subMessage, (int32_t)v12, v13, v14);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C46A45 & 1) == 0 )
  {
    sub_1C37058(&System_Action_TypeInfo);
    sub_1C37058(&LocalizationManager_TypeInfo);
    sub_1C37058(&Method_MovieConfirmDialog_EndOpen__);
    sub_1C37058(&UnityEngine_Object_TypeInfo);
    sub_1C37058(&StringLiteral_43/*"\n"*/);
    sub_1C37058(&StringLiteral_10889/*"QUEST_MESSAGE_DLG_MOVIE_DOWNLOAD_DECIDE"*/);
  ...
  if ( ((unsigned __int8)v17 & 1) != 0 )
  {
    if ( !message )
      goto LABEL_45;
    v17 = (UILabel_o *)System_String__Replace_63608204(
                         message,
  ...
  if ( UnityEngine_Object__op_Inequality(buttonDecideLabel, 0, 0) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v17 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10889/*"QUEST_MESSAGE_DLG_MOVIE_DOWNLOAD_DECIDE"*/, 0);
    if ( !v27 )
      goto LABEL_45;
  ...
  if ( UnityEngine_Object__op_Inequality(buttonCancelLabel, 0, 0) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v17 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10884/*"QUEST_MESSAGE_DLG_CANCEL"*/, 0);
    if ( v29 )
    {
