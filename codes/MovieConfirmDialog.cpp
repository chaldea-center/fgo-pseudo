void MovieConfirmDialog___ctor(MovieConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.PLAY_MAIN_LABEL_Y = xmmword_C08C80;
...
void MovieConfirmDialog__Close(MovieConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  MovieConfirmDialog__Close_47866796(this, 0, v2);
}


void MovieConfirmDialog__Close_47866796(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2AE8D & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_MovieConfirmDialog_EndClose__);
    byte_4C2AE8D = 1;
  }
...
void MovieConfirmDialog__OnClickCancel(MovieConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2AE90 & 1) == 0 )
  {
    sub_1C2D490(&Method_MovieConfirmDialog_OnClickCancel__);
    byte_4C2AE90 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_MovieConfirmDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2D4A8(Method_MovieConfirmDialog_OnClickCancel__);
...
void MovieConfirmDialog__OnClickClose(MovieConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2AE91 & 1) == 0 )
  {
    sub_1C2D490(&Method_MovieConfirmDialog_OnClickClose__);
    byte_4C2AE91 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_MovieConfirmDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2D4A8(Method_MovieConfirmDialog_OnClickClose__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C2D474(v3, v3[4]);
...
void MovieConfirmDialog__OnClickDecide(MovieConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2AE8E & 1) == 0 )
  {
    sub_1C2D490(&Method_MovieConfirmDialog_OnClickDecide__);
    byte_4C2AE8E = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_MovieConfirmDialog_OnClickDecide__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1C2D4A8(Method_MovieConfirmDialog_OnClickDecide__);
...
void MovieConfirmDialog__OnClickDecide2(MovieConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2AE8F & 1) == 0 )
  {
    sub_1C2D490(&Method_MovieConfirmDialog_OnClickDecide2__);
    byte_4C2AE8F = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_MovieConfirmDialog_OnClickDecide2__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2D4A8(Method_MovieConfirmDialog_OnClickDecide2__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C2D474(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2AE92 & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_10883/*"QUEST_MESSAGE_DLG_MOVIE_DOWNLOAD_SUB_MESSAGE"*/);
    sub_1C2D490(&StringLiteral_10885/*"QUEST_MESSAGE_DLG_MOVIE_PLAY_SUB_MESSAGE"*/);
    byte_4C2AE92 = 1;
  }
  if ( mode == 1 )
  {
    ...
    *subY = this->fields.DOWNLOAD_SUB_LABEL_Y;
    ...
    v11 = &StringLiteral_10883/*"QUEST_MESSAGE_DLG_MOVIE_DOWNLOAD_SUB_MESSAGE"*/;
  }
  else
  {
    ...
    *subY = this->fields.PLAY_SUB_LABEL_Y;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v11 = &StringLiteral_10885/*"QUEST_MESSAGE_DLG_MOVIE_PLAY_SUB_MESSAGE"*/;
  }
  v12 = LocalizationManager__Get((System_String_o *)*v11, 0);
  *subMessage = v12;
  sub_1C2D434((CGThumbnailListItem_o *)subMessage, (int32_t)v12, v13, v14);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2AE8C & 1) == 0 )
  {
    sub_1C2D490(&System_Action_TypeInfo);
    sub_1C2D490(&LocalizationManager_TypeInfo);
    sub_1C2D490(&Method_MovieConfirmDialog_EndOpen__);
    sub_1C2D490(&UnityEngine_Object_TypeInfo);
    sub_1C2D490(&StringLiteral_43/*"\n"*/);
    sub_1C2D490(&StringLiteral_10882/*"QUEST_MESSAGE_DLG_MOVIE_DOWNLOAD_DECIDE"*/);
    sub_1C2D490(&StringLiteral_10877/*"QUEST_MESSAGE_DLG_CANCEL"*/);
    sub_1C2D490(&StringLiteral_16041/*"\\n"*/);
    sub_1C2D490(&StringLiteral_1/*""*/);
    byte_4C2AE8C = 1;
  }
  v32 = 0;
  ...
  if ( ((unsigned __int8)v18 & 1) != 0 )
  {
    if ( !message )
      goto LABEL_45;
    v18 = (UILabel_o *)System_String__Replace_63504412(
                         message,
  ...
  if ( UnityEngine_Object__op_Inequality(buttonDecideLabel, 0, 0) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v18 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10882/*"QUEST_MESSAGE_DLG_MOVIE_DOWNLOAD_DECIDE"*/, 0);
    if ( !v28 )
      goto LABEL_45;
  ...
  if ( UnityEngine_Object__op_Inequality(buttonCancelLabel, 0, 0) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v18 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10877/*"QUEST_MESSAGE_DLG_CANCEL"*/, 0);
    if ( v30 )
    {
...
LABEL_44:
  *(_WORD *)&this->fields.isButtonEnable = 256;
  ...
  BaseDialog__Open((BaseDialog_o *)this, v31, maskType, 0);
}
