void MovieConfirmDialog___ctor(MovieConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.PLAY_MAIN_LABEL_Y = xmmword_C0C040;
...
void MovieConfirmDialog__Close(MovieConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  MovieConfirmDialog__Close_47949236(this, 0, v2);
}


void MovieConfirmDialog__Close_47949236(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3B501 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_MovieConfirmDialog_EndClose__);
    byte_4C3B501 = 1;
  }
...
void MovieConfirmDialog__OnClickCancel(MovieConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3B504 & 1) == 0 )
  {
    sub_1C32C20(&Method_MovieConfirmDialog_OnClickCancel__);
    byte_4C3B504 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_MovieConfirmDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C32C38(Method_MovieConfirmDialog_OnClickCancel__);
...
void MovieConfirmDialog__OnClickClose(MovieConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3B505 & 1) == 0 )
  {
    sub_1C32C20(&Method_MovieConfirmDialog_OnClickClose__);
    byte_4C3B505 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_MovieConfirmDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C32C38(Method_MovieConfirmDialog_OnClickClose__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C32C04(v3, v3[4]);
...
void MovieConfirmDialog__OnClickDecide(MovieConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3B502 & 1) == 0 )
  {
    sub_1C32C20(&Method_MovieConfirmDialog_OnClickDecide__);
    byte_4C3B502 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_MovieConfirmDialog_OnClickDecide__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1C32C38(Method_MovieConfirmDialog_OnClickDecide__);
...
void MovieConfirmDialog__OnClickDecide2(MovieConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3B503 & 1) == 0 )
  {
    sub_1C32C20(&Method_MovieConfirmDialog_OnClickDecide2__);
    byte_4C3B503 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_MovieConfirmDialog_OnClickDecide2__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C32C38(Method_MovieConfirmDialog_OnClickDecide2__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C32C04(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3B506 & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_10889/*"QUEST_MESSAGE_DLG_MOVIE_DOWNLOAD_SUB_MESSAGE"*/);
    sub_1C32C20(&StringLiteral_10891/*"QUEST_MESSAGE_DLG_MOVIE_PLAY_SUB_MESSAGE"*/);
    byte_4C3B506 = 1;
  }
  if ( mode == 1 )
  {
    ...
    *subY = this->fields.DOWNLOAD_SUB_LABEL_Y;
    ...
    v11 = &StringLiteral_10889/*"QUEST_MESSAGE_DLG_MOVIE_DOWNLOAD_SUB_MESSAGE"*/;
  }
  else
  {
    ...
    *subY = this->fields.PLAY_SUB_LABEL_Y;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v11 = &StringLiteral_10891/*"QUEST_MESSAGE_DLG_MOVIE_PLAY_SUB_MESSAGE"*/;
  }
  v12 = LocalizationManager__Get((System_String_o *)*v11, 0);
  *subMessage = v12;
  sub_1C32BC4((CGThumbnailListItem_o *)subMessage, (int32_t)v12, v13, v14);
}
        ...
        const MethodInfo *method)
{
  ...
  System_String_o *v31; // [xsp+0h] [xbp-60h] BYREF
  ...
  if ( (byte_4C3B500 & 1) == 0 )
  {
    sub_1C32C20(&System_Action_TypeInfo);
    sub_1C32C20(&LocalizationManager_TypeInfo);
    sub_1C32C20(&Method_MovieConfirmDialog_EndOpen__);
    sub_1C32C20(&UnityEngine_Object_TypeInfo);
    sub_1C32C20(&StringLiteral_43/*"\n"*/);
    sub_1C32C20(&StringLiteral_10888/*"QUEST_MESSAGE_DLG_MOVIE_DOWNLOAD_DECIDE"*/);
  ...
  MovieConfirmDialog__SetModeParam(this, mode, (float *)&subY + 1, (float *)&subY, &v31, v15);
  titleLabel = (UnityEngine_Object_o *)this->fields.titleLabel;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  if ( UnityEngine_Object__op_Inequality(titleLabel, 0, 0) )
  ...
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  v17 = (UILabel_o *)UnityEngine_Object__op_Inequality(mainLabel, 0, 0);
  if ( ((unsigned __int8)v17 & 1) != 0 )
  {
    if ( !message )
      goto LABEL_45;
    v17 = (UILabel_o *)System_String__Replace_63565092(
                         message,
                         (System_String_o *)StringLiteral_16042/*"\\n"*/,
                         (System_String_o *)StringLiteral_43/*"\n"*/,
                         0);
    v20 = this->fields.mainLabel;
    if ( !v20 )
      goto LABEL_45;
    v21 = v17 ? (System_String_o *)v17 : (System_String_o *)StringLiteral_1/*""*/;
    WrapControlText__textAdjust(this->fields.mainLabel, v21, v20->fields.mFontSize, 0, 0);
    v17 = this->fields.mainLabel;
    if ( !v17 )
      goto LABEL_45;
  ...
  if ( UnityEngine_Object__op_Inequality(subLabel, 0, 0) )
  {
    ...
    if ( !v17 )
      goto LABEL_45;
    v24 = v31 ? v31 : (System_String_o *)StringLiteral_1/*""*/;
    WrapControlText__textAdjust(v17, v24, v17->fields.mFontSize, 0, 0);
    v17 = this->fields.subLabel;
    if ( !v17 )
      goto LABEL_45;
    v25 = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)v17, 0);
    GameObjectExtensions__SetLocalPositionY(v25, *(float *)&subY, 0);
  }
  buttonDecideLabel = (UnityEngine_Object_o *)this->fields.buttonDecideLabel;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  if ( UnityEngine_Object__op_Inequality(buttonDecideLabel, 0, 0) )
  {
    v27 = this->fields.buttonDecideLabel;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v17 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10888/*"QUEST_MESSAGE_DLG_MOVIE_DOWNLOAD_DECIDE"*/, 0);
    if ( !v27 )
      goto LABEL_45;
    UILabel__set_text(v27, (System_String_o *)v17, 0);
  }
  buttonCancelLabel = (UnityEngine_Object_o *)this->fields.buttonCancelLabel;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  if ( UnityEngine_Object__op_Inequality(buttonCancelLabel, 0, 0) )
  {
    v29 = this->fields.buttonCancelLabel;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v17 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10883/*"QUEST_MESSAGE_DLG_CANCEL"*/, 0);
    if ( v29 )
    {
      UILabel__set_text(v29, (System_String_o *)v17, 0);
      goto LABEL_44;
    }
LABEL_45:
    sub_1C32E7C(v17);
...
LABEL_44:
  *(_WORD *)&this->fields.isButtonEnable = 256;
  ...
  System_Action___ctor(v30, (Il2CppObject *)this, Method_MovieConfirmDialog_EndOpen__, 0);
  BaseDialog__Open((BaseDialog_o *)this, v30, maskType, 0, 0);
}
