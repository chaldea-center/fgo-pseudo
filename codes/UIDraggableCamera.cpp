          ...
          if ( this->fields.mCam )
          {
            ...
            if ( this->fields.mCam )
            {
              ...
              if ( this->fields.mCam )
              {
                ...
                v30.fields.z = 0.0;
                z = 0.0;
                v31 = UnityEngine_Camera__ScreenToWorldPoint_71529204(this->fields.mCam, v30, 0);
                mCam = this->fields.mCam;
                if ( mCam )
                {
                  x = v31.fields.x;
                  ...
                  v32.fields.z = 0.0;
                  v33 = UnityEngine_Camera__ScreenToWorldPoint_71529204(mCam, v32, 0);
...
void UIDraggableCamera__Start(UIDraggableCamera_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CCBAAF & 1) == 0 )
  {
    ...
    sub_1C713B0(&NGUITools_TypeInfo);
    sub_1C713B0(&UnityEngine_Object_TypeInfo);
    sub_1C713B0(&StringLiteral_280/*" needs the 'Root For Bounds' parameter to be set"*/);
    byte_4CCBAAF = 1;
  }
  Component_object = UnityEngine_Component__GetComponent_object_(
                       (UnityEngine_Component_o *)this,
  ...
  sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.mRoot, (int32_t)v18, v19, v20, v21, v22, v23, v24);
  rootForBounds = (UnityEngine_Object_o *)this->fields.rootForBounds;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  if ( UnityEngine_Object__op_Equality(rootForBounds, 0, 0) )
  {
    ...
    v28 = (Il2CppObject *)System_String__Concat_64031724(Hierarchy, (System_String_o *)StringLiteral_280/*" needs the 'Root For Bounds' parameter to be set"*/, 0);
    if ( !UnityEngine_Debug_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Debug_TypeInfo);
    UnityEngine_Debug__LogError_71536300(v28, (UnityEngine_Object_o *)this, 0);
...
LABEL_22:
      this->fields.mScroll = 0.0;
      NGUIMath__SpringDampen_49668288(&this->fields.mMomentum, 9.0, deltaTime, 0);
      return;
    }
LABEL_23:
    sub_1C71608(v5, v6);
  ...
  this->fields.mScroll = NGUIMath__SpringLerp_49605660(mScroll, 0.0, 20.0, deltaTime, 0);
  if ( !byte_4CC0D0A )
  {
  ...
  v14 = NGUIMath__SpringDampen_49668288(&this->fields.mMomentum, 9.0, deltaTime, 0);
