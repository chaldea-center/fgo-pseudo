void __fastcall EventMissionCondDetailMaster___ctor(EventMissionCondDetailMaster_o *this, const MethodInfo *method)
{
  if ( (byte_42B04C9 & 1) == 0 )
  {
    sub_B52984(&Method_DataMasterBase_EventMissionCondDetailMaster__EventMissionCondDetailEntity__int___ctor__);
    byte_42B04C9 = 1;
  }
  DataMasterBase_WarMaster__WarEntity__int____ctor(
    (DataMasterBase_WarMaster__WarEntity__int__o *)this,
    135,
    (const MethodInfo_23E223C *)Method_DataMasterBase_EventMissionCondDetailMaster__EventMissionCondDetailEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B04CB & 1) == 0 )
  {
    ...
    sub_B52984(&Method_System_Collections_Generic_List_EventMissionCondDetailEntity__Add__);
    sub_B52984(&Method_System_Collections_Generic_List_EventMissionConditionEntity__GetEnumerator__);
    sub_B52984(&Method_System_Collections_Generic_List_EventMissionCondDetailEntity___ctor__);
    sub_B52984(&System_Collections_Generic_List_EventMissionCondDetailEntity__TypeInfo);
    byte_42B04CB = 1;
  }
  entity = 0LL;
  memset(&v19, 0, sizeof(v19));
  v5 = (System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData__o *)sub_B52A54(System_Collections_Generic_List_EventMissionCondDetailEntity__TypeInfo);
  System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData____ctor(
    v5,
    (const MethodInfo_2FF0940 *)Method_System_Collections_Generic_List_EventMissionCondDetailEntity___ctor__);
  if ( (BYTE3(DataManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0 && !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_WarQuestSelectionMaster = (EventMissionConditionMaster_o *)DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1A4F124 *)Method_DataManager_GetMaster_EventMissionConditionMaster___);
          ...
          do
          {
            ...
            if ( v12 )
            {
              ...
              System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData___Add(
                ...
                (const MethodInfo_2FF1604 *)Method_System_Collections_Generic_List_EventMissionCondDetailEntity__Add__);
            }
        ...
        const MethodInfo *method)
{
  ...
  EventMissionCondDetailEntity_c *v21; // x1
  __int64 v22; // x10
  ...
  if ( (byte_42B04CA & 1) == 0 )
  {
    ...
    sub_B52984(&EventMissionCondDetailEntity_TypeInfo);
...
LABEL_16:
    ...
    if ( v20 )
    {
      v21 = EventMissionCondDetailEntity_TypeInfo;
      v22 = *(&EventMissionCondDetailEntity_TypeInfo->_2.bitflags2 + 1);
      if ( *(&v20->klass->_2.bitflags2 + 1) < (unsigned int)v22
        || (EventMissionCondDetailEntity_c *)v20->klass->_2.typeHierarchy[v22 - 1] != EventMissionCondDetailEntity_TypeInfo )
      {
        v20 = (EventMissionProgressRequest_Argument_ProgressData_o *)sub_B52D50(v20);
LABEL_32:
        sub_B52A5C(v20, v21);
      }
      if ( v20->fields.missionConditionDetailId == missionTargetId )
      {
        if ( !v5 )
          goto LABEL_32;
        System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData___Add(
