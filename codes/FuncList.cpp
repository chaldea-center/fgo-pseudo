...
int32_t __fastcall FuncList__getRate_39446784(int32_t type, System_Int32_array *vals, const MethodInfo *method)
{
  if ( vals && (int)vals->max_length >= 1 )
    return vals->m_Items[1];
  else
...
int32_t __fastcall FuncList__getValueFronIndex(System_Int32_array *vals, int32_t index, const MethodInfo *method)
{
  ...
  if ( vals )
  {
    ...
    {
      if ( max_length <= index )
        sub_1BDBADC(vals, *(_QWORD *)&index, method);
...
bool __fastcall FuncList__isDamage(int32_t funcType, const MethodInfo *method)
{
  ...
  if ( (byte_4B439A9 & 1) == 0 )
  {
    sub_1BDB878(&FuncList_TYPE_TypeInfo, method);
    sub_1BDB878(&StringLiteral_4997/*"DAMAGE"*/, v3);
    byte_4B439A9 = 1;
  }
  ...
  if ( !v4 )
    sub_1BDBAD4(0LL, v5);
  return System_String__Contains(v4, (System_String_o *)StringLiteral_4997/*"DAMAGE"*/, 0LL);
}
