...
int32_t __fastcall FuncList__getRate_38828824(int32_t type, System_Int32_array *vals, const MethodInfo *method)
{
  if ( vals && (int)vals->max_length >= 1 )
    return vals->m_Items[1];
  else
...
bool __fastcall FuncList__isDamage(int32_t funcType, const MethodInfo *method)
{
  ...
  if ( (byte_4BB367D & 1) == 0 )
  {
    sub_1C13D24(&FuncList_TYPE_TypeInfo, method);
    sub_1C13D24(&StringLiteral_5087/*"DAILY_DROP_UP_COUNT"*/, v3);
    byte_4BB367D = 1;
  }
  ...
  if ( !v4 )
    sub_1C13F80(0LL, v5);
  return System_String__Contains(v4, (System_String_o *)StringLiteral_5087/*"DAILY_DROP_UP_COUNT"*/, 0LL);
}
