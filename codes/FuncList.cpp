...
int32_t __fastcall FuncList__getRate_38881980(int32_t type, System_Int32_array *vals, const MethodInfo *method)
{
  if ( vals && (int)vals->max_length >= 1 )
    return vals->m_Items[1];
  else
...
bool __fastcall FuncList__isDamage(int32_t funcType, const MethodInfo *method)
{
  ...
  if ( (byte_4BC6A49 & 1) == 0 )
  {
    sub_1C1ABD4(&FuncList_TYPE_TypeInfo, method);
    sub_1C1ABD4(&StringLiteral_5090/*"DAMAGE"*/, v3);
    byte_4BC6A49 = 1;
  }
  ...
  if ( !v4 )
    sub_1C1AE30(0LL, v5);
  return System_String__Contains(v4, (System_String_o *)StringLiteral_5090/*"DAMAGE"*/, 0LL);
}
