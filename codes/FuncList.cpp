...
int32_t __fastcall FuncList__getRate_37685908(int32_t type, System_Int32_array *vals, const MethodInfo *method)
{
  if ( vals && (int)vals->max_length >= 1 )
    return vals->m_Items[1];
  else
...
bool __fastcall FuncList__isDamage(int32_t funcType, const MethodInfo *method)
{
  ...
  if ( (byte_4A5A14C & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_4993/*"DAMAGE"*/);
    byte_4A5A14C = 1;
  }
  v6.klass = (System_Enum_c *)FuncList_TYPE_TypeInfo;
  v6.monitor = (void *)-1LL;
  v7 = funcType;
  v3 = System_Enum__ToString(&v6, 0LL);
  if ( !v3 )
    sub_1B8880C(0LL, v4);
  return System_String__Contains(v3, (System_String_o *)StringLiteral_4993/*"DAMAGE"*/, 0LL);
}
