...
int32_t __fastcall FuncList__getRate_37378764(int32_t type, System_Int32_array *vals, const MethodInfo *method)
{
  if ( vals && (int)vals->max_length >= 1 )
    return vals->m_Items[1];
  else
...
bool __fastcall FuncList__isDamage(int32_t funcType, const MethodInfo *method)
{
  ...
  if ( (byte_49FD510 & 1) == 0 )
  {
    sub_1B64870(&FuncList_TYPE_TypeInfo, method);
    sub_1B64870(&StringLiteral_4970/*"DAMAGE"*/, v3);
    byte_49FD510 = 1;
  }
