...
void __fastcall QuestInformationListViewItem___ctor_35371160(
        QuestInformationListViewItem_o *this,
        int32_t index,
        ...
        const MethodInfo *method)
{
  ...
  if ( viewEnemyEnt )
  {
    ...
    if ( isUnknown )
    {
      ...
      *(_QWORD *)&this->fields.dispType = 0LL;
      sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.nameText, 0LL, v14, v15, v16, v17, v18, v19);
  ...
  else
  {
    ...
    *(_QWORD *)&this->fields.dispType = 0LL;
    *(_QWORD *)&this->fields.iconId = 0LL;
    sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.nameText, 0LL, v8, v9, v10, v11, v12, v13);
