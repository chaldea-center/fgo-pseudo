...
void __fastcall QuestInformationListViewItem___ctor_35552968(
        QuestInformationListViewItem_o *this,
        int32_t index,
        ...
        const MethodInfo *method)
{
  ...
  if ( viewEnemyEnt )
  {
    ...
    if ( isUnknown )
    {
      ...
      *(_QWORD *)&this->fields.dispType = 0LL;
      sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.nameText, 0, v10, v11);
    ...
    else
    {
      *(int8x16_t *)&this->fields.targetId = vextq_s8(
      ...
      sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.nameText, (int32_t)BattleName, v14, v15);
  ...
  else
  {
    ...
    *(_QWORD *)&this->fields.dispType = 0LL;
    *(_QWORD *)&this->fields.iconId = 0LL;
    sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.nameText, 0, v8, v9);
...
bool __fastcall QuestInformationListViewItem__get_IsGrand(
        QuestInformationListViewItem_o *this,
        const MethodInfo *method)
{
...
void __fastcall QuestInformationListViewItem__set_IsGrand(
        QuestInformationListViewItem_o *this,
        bool value,
        const MethodInfo *method)
{
