...
void QuestInformationListViewItem___ctor_36547288(
        QuestInformationListViewItem_o *this,
        int32_t index,
        ...
        const MethodInfo *method)
{
  ...
  if ( !viewEnemyEnt )
  {
    ...
    *(_QWORD *)&this->fields.iconId = 0;
    sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.nameText, 0, v9, v10);
  ...
  if ( isUnknown )
  {
    ...
    *(_QWORD *)&this->fields.iconId = 0;
    *(_QWORD *)&this->fields.dispType = 0;
    sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.nameText, 0, v11, v12);
...
LABEL_7:
  ...
  *(int8x16_t *)&this->fields.targetId = vextq_s8(
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.nameText, (int32_t)BattleName, v23, v24);
  ...
  Master_object = (NpcServantDisplayTypeDetailMaster_o *)DataManager__GetMaster_object_((const MethodInfo_30E7C04 *)Method_DataManager_GetMaster_NpcServantDisplayTypeDetailMaster___);
  if ( !Master_object )
    goto LABEL_26;
