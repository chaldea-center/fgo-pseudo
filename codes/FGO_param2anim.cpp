...
void __fastcall FGO_param2anim__Start(FGO_param2anim_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E174C & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_16354/*"_twoValue0"*/, v3);
    sub_1B00CCC(&StringLiteral_16355/*"_twoValue1"*/, v4);
    byte_48E174C = 1;
  }
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields._renderer, (int32_t)Component_object, v7, v8);
  ...
  if ( !renderer )
    goto LABEL_12;
  UnityEngine_Material__EnableKeyword((UnityEngine_Material_o *)renderer, (System_String_o *)StringLiteral_16354/*"_twoValue0"*/, 0LL);
  renderer = *p_renderer;
  if ( !*p_renderer
    ...
    || (UnityEngine_Material__EnableKeyword(
          ...
          (System_String_o *)StringLiteral_16355/*"_twoValue1"*/,
          0LL),
        (renderer = *p_renderer) == 0LL)
    || (renderer = (UnityEngine_Renderer_o *)UnityEngine_Renderer__get_material(renderer, 0LL)) == 0LL
    || (UnityEngine_Material__SetFloat(
          (UnityEngine_Material_o *)renderer,
          (System_String_o *)StringLiteral_16354/*"_twoValue0"*/,
...
void __fastcall FGO_param2anim__Update(FGO_param2anim_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E174D & 1) == 0 )
  {
    sub_1B00CCC(&StringLiteral_16354/*"_twoValue0"*/, method);
    sub_1B00CCC(&StringLiteral_16355/*"_twoValue1"*/, v3);
    byte_48E174D = 1;
  }
  renderer = this->fields._renderer;
  if ( !renderer
