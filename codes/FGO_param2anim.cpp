...
void __fastcall FGO_param2anim__Start(FGO_param2anim_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB3564 & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_16842/*"_strDefault"*/, v3);
    sub_1C13D24(&StringLiteral_16843/*"_target"*/, v4);
    byte_4BB3564 = 1;
  }
  ...
  if ( !renderer )
    goto LABEL_12;
  UnityEngine_Material__EnableKeyword((UnityEngine_Material_o *)renderer, (System_String_o *)StringLiteral_16842/*"_strDefault"*/, 0LL);
  renderer = *p_renderer;
  if ( !*p_renderer
    ...
    || (UnityEngine_Material__SetFloat(
          (UnityEngine_Material_o *)renderer,
          (System_String_o *)StringLiteral_16842/*"_strDefault"*/,
...
void __fastcall FGO_param2anim__Update(FGO_param2anim_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB3565 & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_16842/*"_strDefault"*/, method);
    sub_1C13D24(&StringLiteral_16843/*"_target"*/, v3);
    byte_4BB3565 = 1;
  }
  renderer = this->fields._renderer;
  if ( !renderer
