...
void __fastcall FGO_param2anim__Start(FGO_param2anim_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB4C01 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_16619/*"_twoValue0"*/, v3);
    sub_1BAB41C(&StringLiteral_16620/*"_twoValue1"*/, v4);
    byte_4AB4C01 = 1;
  }
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields._renderer, (int32_t)Component_object, v7, v8);
  ...
  if ( !renderer )
    goto LABEL_12;
  UnityEngine_Material__EnableKeyword((UnityEngine_Material_o *)renderer, (System_String_o *)StringLiteral_16619/*"_twoValue0"*/, 0LL);
  renderer = *p_renderer;
  if ( !*p_renderer
    ...
    || (UnityEngine_Material__EnableKeyword(
          ...
          (System_String_o *)StringLiteral_16620/*"_twoValue1"*/,
          0LL),
        (renderer = *p_renderer) == 0LL)
    || (renderer = (UnityEngine_Renderer_o *)UnityEngine_Renderer__get_material(renderer, 0LL)) == 0LL
    || (UnityEngine_Material__SetFloat(
          (UnityEngine_Material_o *)renderer,
          (System_String_o *)StringLiteral_16619/*"_twoValue0"*/,
...
void __fastcall FGO_param2anim__Update(FGO_param2anim_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB4C02 & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_16619/*"_twoValue0"*/, method);
    sub_1BAB41C(&StringLiteral_16620/*"_twoValue1"*/, v3);
    byte_4AB4C02 = 1;
  }
  renderer = this->fields._renderer;
  if ( !renderer
