...
void __fastcall StoneShopDetailDialog__Close(StoneShopDetailDialog_o *this, const MethodInfo *method)
{
  ...
  StoneShopDetailDialog__Close_32720928(this, 0LL, v2);
}


void __fastcall StoneShopDetailDialog__Close_32720928(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FACAD & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_StoneShopDetailDialog_EndClose__, v6);
    byte_49FACAD = 1;
  }
...
void __fastcall StoneShopDetailDialog__OnClickClose(StoneShopDetailDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FACAE & 1) == 0 )
  {
    sub_1B64870(&Method_StoneShopDetailDialog_OnClickClose__, method);
    byte_49FACAE = 1;
  }
  v3 = Method_StoneShopDetailDialog_OnClickClose__;
  if ( (*((_BYTE *)Method_StoneShopDetailDialog_OnClickClose__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B64888(Method_StoneShopDetailDialog_OnClickClose__);
  ...
  if ( clickFunc )
  {
    ...
    sub_1B64814(p_clickFunc, 0, (int32_t)v5, v6);
  ...
  {
    StoneShopDetailDialog__Close_32720928(this, 0LL, v5);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FACAC & 1) == 0 )
  {
    sub_1B64870(&Method_DataManager_GetMaster_ItemMaster___, bankShop);
    ...
    sub_1B64870(&StringLiteral_3733/*"COMMON_CONFIRM_CLOSE"*/, v11);
    sub_1B64870(&StringLiteral_12242/*"STONE_SHOP_EXTRA_ITEM_TITLE"*/, v12);
    sub_1B64870(&StringLiteral_12239/*"STONE_SHOP_DETAIL_TITLE"*/, v13);
    sub_1B64870(&StringLiteral_12244/*"STONE_SHOP_STONE_INFO_TEMPLATE"*/, v14);
    sub_1B64870(&StringLiteral_12245/*"STONE_SHOP_STONE_INFO_TITLE"*/, v15);
    byte_49FACAC = 1;
  }
  entity = 0LL;
  StoneShopDetailDialog__Init(this, (const MethodInfo *)bankShop);
  this->fields.clickFunc = func;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.clickFunc, (int32_t)func, v16, v17);
  if ( bankShop )
  {
      ...
      if ( stoneShopDetailListViewManager )
      {
        ...
        if ( stoneShopDetailListViewManager )
        {
          ...
          stoneShopDetailListViewManager = (StoneShopDetailListViewManager_o *)LocalizationManager__Get(
                                                                                 (System_String_o *)StringLiteral_12239/*"STONE_SHOP_DETAIL_TITLE"*/,
                                                                                 0LL);
          if ( titleLabel )
          {
            ...
            if ( stoneShopDetailListViewManager )
            {
              ...
              stoneShopDetailListViewManager = (StoneShopDetailListViewManager_o *)LocalizationManager__Get(
                                                                                     (System_String_o *)StringLiteral_12245/*"STONE_SHOP_STONE_INFO_TITLE"*/,
                                                                                     0LL);
              if ( stoneInfoTitleLabel )
              {
                ...
                v28 = LocalizationManager__Get((System_String_o *)StringLiteral_12244/*"STONE_SHOP_STONE_INFO_TEMPLATE"*/, 0LL);
                ...
                stoneShopDetailListViewManager = (StoneShopDetailListViewManager_o *)System_String__Format_61398016(
                                                                                       v28,
                                                                                       v32,
                                                                                       v36,
                                                                                       v40,
                ...
                if ( stoneInfoDetailLabel )
                {
                  ...
                  stoneShopDetailListViewManager = (StoneShopDetailListViewManager_o *)DataManager__GetMaster_object_((const MethodInfo_2E3B674 *)Method_DataManager_GetMaster_ItemMaster___);
                  if ( stoneShopDetailListViewManager )
                  {
                      ...
                      if ( stoneShopDetailListViewManager )
                      {
                        ...
                        if ( stoneShopDetailListViewManager )
                        {
                          ...
                          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                          stoneShopDetailListViewManager = (StoneShopDetailListViewManager_o *)LocalizationManager__Get(
                                                                                                 (System_String_o *)StringLiteral_12242/*"STONE_SHOP_EXTRA_ITEM_TITLE"*/,
                                                                                                 0LL);
...
LABEL_35:
    sub_1B64ACC(stoneShopDetailListViewManager, v18);
  }
LABEL_34:
