...
void StoneShopDetailDialog__Close(StoneShopDetailDialog_o *this, const MethodInfo *method)
{
  ...
  StoneShopDetailDialog__Close_35461736(this, 0, v2);
}


void StoneShopDetailDialog__Close_35461736(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C53149 & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_StoneShopDetailDialog_EndClose__);
    byte_4C53149 = 1;
  }
...
void StoneShopDetailDialog__OnClickClose(StoneShopDetailDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C5314A & 1) == 0 )
  {
    sub_1C3E564(&Method_StoneShopDetailDialog_OnClickClose__);
    byte_4C5314A = 1;
  }
  v3 = Method_StoneShopDetailDialog_OnClickClose__;
  if ( (*((_BYTE *)Method_StoneShopDetailDialog_OnClickClose__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C3E57C(Method_StoneShopDetailDialog_OnClickClose__);
  ...
  {
    p_clickFunc->klass = 0;
    sub_1C3E508(p_clickFunc, 0, (int32_t)v5, v6);
  ...
  {
    StoneShopDetailDialog__Close_35461736(this, 0, v5);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C53148 & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_12397/*"STONE_SHOP_EXTRA_ITEM_TITLE"*/);
    sub_1C3E564(&StringLiteral_12394/*"STONE_SHOP_DETAIL_TITLE"*/);
    sub_1C3E564(&StringLiteral_12399/*"STONE_SHOP_STONE_INFO_TEMPLATE"*/);
    sub_1C3E564(&StringLiteral_12400/*"STONE_SHOP_STONE_INFO_TITLE"*/);
    byte_4C53148 = 1;
  }
  entity = 0;
  StoneShopDetailDialog__Init(this, (const MethodInfo *)bankShop);
  this->fields.clickFunc = func;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.clickFunc, (int32_t)func, v7, v8);
  if ( bankShop )
  {
      ...
      if ( stoneShopDetailListViewManager )
      {
        ...
        if ( stoneShopDetailListViewManager )
        {
          ...
          stoneShopDetailListViewManager = (StoneShopDetailListViewManager_o *)LocalizationManager__Get(
                                                                                 (System_String_o *)StringLiteral_12394/*"STONE_SHOP_DETAIL_TITLE"*/,
                                                                                 0);
          if ( titleLabel )
          {
            ...
            if ( stoneShopDetailListViewManager )
            {
              ...
              stoneShopDetailListViewManager = (StoneShopDetailListViewManager_o *)LocalizationManager__Get(
                                                                                     (System_String_o *)StringLiteral_12400/*"STONE_SHOP_STONE_INFO_TITLE"*/,
                                                                                     0);
              if ( stoneInfoTitleLabel )
              {
                ...
                v19 = LocalizationManager__Get((System_String_o *)StringLiteral_12399/*"STONE_SHOP_STONE_INFO_TEMPLATE"*/, 0);
                ...
                stoneShopDetailListViewManager = (StoneShopDetailListViewManager_o *)System_String__Format_63677828(
                                                                                       v19,
                                                                                       v26,
                                                                                       v33,
                                                                                       v40,
                ...
                if ( stoneInfoDetailLabel )
                {
                  ...
                  stoneShopDetailListViewManager = (StoneShopDetailListViewManager_o *)DataManager__GetMaster_object_((const MethodInfo_30F9A1C *)Method_DataManager_GetMaster_ItemMaster___);
                  if ( stoneShopDetailListViewManager )
                  {
                      ...
                      if ( stoneShopDetailListViewManager )
                      {
                        ...
                        if ( stoneShopDetailListViewManager )
                        {
                          ...
                          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                          stoneShopDetailListViewManager = (StoneShopDetailListViewManager_o *)LocalizationManager__Get(
                                                                                                 (System_String_o *)StringLiteral_12397/*"STONE_SHOP_EXTRA_ITEM_TITLE"*/,
                                                                                                 0);
...
LABEL_35:
    sub_1C3E7C0(stoneShopDetailListViewManager, v9);
  }
LABEL_34:
