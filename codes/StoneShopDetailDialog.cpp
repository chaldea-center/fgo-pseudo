...
void __fastcall StoneShopDetailDialog__Close(StoneShopDetailDialog_o *this, const MethodInfo *method)
{
  ...
  StoneShopDetailDialog__Close_32719892(this, 0LL, v2);
}


void __fastcall StoneShopDetailDialog__Close_32719892(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F8BBE & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_StoneShopDetailDialog_EndClose__, v6);
    byte_49F8BBE = 1;
  }
  ...
  System_Action___ctor(v9, (Il2CppObject *)this, Method_StoneShopDetailDialog_EndClose__, 0LL);
...
void __fastcall StoneShopDetailDialog__OnClickClose(StoneShopDetailDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49F8BBF & 1) == 0 )
  {
    sub_1B640C8(&Method_StoneShopDetailDialog_OnClickClose__, method);
    byte_49F8BBF = 1;
  }
  v3 = Method_StoneShopDetailDialog_OnClickClose__;
  if ( (*((_BYTE *)Method_StoneShopDetailDialog_OnClickClose__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B640E0(Method_StoneShopDetailDialog_OnClickClose__);
  ...
  if ( clickFunc )
  {
    ...
    sub_1B6406C(p_clickFunc, 0, (int32_t)v5, v6);
  ...
  {
    StoneShopDetailDialog__Close_32719892(this, 0LL, v5);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F8BBD & 1) == 0 )
  {
    sub_1B640C8(&Method_DataManager_GetMaster_ItemMaster___, bankShop);
    ...
    sub_1B640C8(&StringLiteral_12239/*"STONE_SHOP_EXTRA_ITEM_TITLE"*/, v12);
    sub_1B640C8(&StringLiteral_12236/*"STONE_SHOP_DETAIL_TITLE"*/, v13);
    sub_1B640C8(&StringLiteral_12241/*"STONE_SHOP_STONE_INFO_TEMPLATE"*/, v14);
    sub_1B640C8(&StringLiteral_12242/*"STONE_SHOP_STONE_INFO_TITLE"*/, v15);
    byte_49F8BBD = 1;
  }
  entity = 0LL;
  StoneShopDetailDialog__Init(this, (const MethodInfo *)bankShop);
  this->fields.clickFunc = func;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.clickFunc, (int32_t)func, v16, v17);
  if ( bankShop )
  {
    stoneShopDetailListViewManager = this->fields.stoneShopDetailListViewManager;
    if ( stoneShopDetailListViewManager )
    {
      StoneShopDetailListViewManager__CreateList(stoneShopDetailListViewManager, bankShop, v18);
      stoneShopDetailListViewManager = this->fields.stoneShopDetailListViewManager;
      if ( stoneShopDetailListViewManager )
      {
        ListViewHeight = StoneShopDetailListViewManager__get_ListViewHeight(stoneShopDetailListViewManager, v20);
        stoneShopDetailListViewManager = this->fields.stoneShopDetailListViewManager;
        if ( stoneShopDetailListViewManager )
        {
          v22 = ListViewHeight;
          ...
          stoneShopDetailListViewManager = (StoneShopDetailListViewManager_o *)LocalizationManager__Get(
                                                                                 (System_String_o *)StringLiteral_12236/*"STONE_SHOP_DETAIL_TITLE"*/,
                                                                                 0LL);
          if ( titleLabel )
          {
            ...
            if ( stoneShopDetailListViewManager )
            {
              ...
              stoneShopDetailListViewManager = (StoneShopDetailListViewManager_o *)LocalizationManager__Get(
                                                                                     (System_String_o *)StringLiteral_12242/*"STONE_SHOP_STONE_INFO_TITLE"*/,
                                                                                     0LL);
              if ( stoneInfoTitleLabel )
              {
                ...
                v28 = LocalizationManager__Get((System_String_o *)StringLiteral_12241/*"STONE_SHOP_STONE_INFO_TEMPLATE"*/, 0LL);
                ...
                stoneShopDetailListViewManager = (StoneShopDetailListViewManager_o *)System_String__Format_61389836(
                                                                                       v28,
                                                                                       v29,
                                                                                       v30,
                                                                                       v31,
                ...
                if ( stoneInfoDetailLabel )
                {
                  ...
                  stoneShopDetailListViewManager = (StoneShopDetailListViewManager_o *)DataManager__GetMaster_object_((const MethodInfo_2E39398 *)Method_DataManager_GetMaster_ItemMaster___);
                  if ( stoneShopDetailListViewManager )
                  {
                      ...
                      if ( stoneShopDetailListViewManager )
                      {
                        ...
                        if ( stoneShopDetailListViewManager )
                        {
                          v36 = UnityEngine_Component__get_gameObject(
                                  (UnityEngine_Component_o *)stoneShopDetailListViewManager,
                                  0LL);
                          GameObjectExtensions__SetLocalPositionY(v36, v22 + this->fields.extraItemOffset, 0LL);
                          extraItemTitleLabel = this->fields.extraItemTitleLabel;
                          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                          stoneShopDetailListViewManager = (StoneShopDetailListViewManager_o *)LocalizationManager__Get(
                                                                                                 (System_String_o *)StringLiteral_12239/*"STONE_SHOP_EXTRA_ITEM_TITLE"*/,
                                                                                                 0LL);
...
LABEL_35:
    sub_1B64324(stoneShopDetailListViewManager);
  }
LABEL_34:
