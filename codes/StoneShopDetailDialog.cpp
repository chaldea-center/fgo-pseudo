...
void __fastcall StoneShopDetailDialog__Close(StoneShopDetailDialog_o *this, const MethodInfo *method)
{
  ...
  StoneShopDetailDialog__Close_33281092(this, 0LL, v2);
}


void __fastcall StoneShopDetailDialog__Close_33281092(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB23AD & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_StoneShopDetailDialog_EndClose__, v6);
    byte_4AB23AD = 1;
  }
...
void __fastcall StoneShopDetailDialog__OnClickClose(StoneShopDetailDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB23AE & 1) == 0 )
  {
    sub_1BAB41C(&Method_StoneShopDetailDialog_OnClickClose__, method);
    byte_4AB23AE = 1;
  }
  v3 = Method_StoneShopDetailDialog_OnClickClose__;
  if ( (*((_BYTE *)Method_StoneShopDetailDialog_OnClickClose__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1BAB434(Method_StoneShopDetailDialog_OnClickClose__);
  ...
  if ( clickFunc )
  {
    ...
    sub_1BAB3C0(p_clickFunc, 0, (int32_t)v5, v6);
  ...
  {
    StoneShopDetailDialog__Close_33281092(this, 0LL, v5);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB23AC & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMaster_ItemMaster___, bankShop);
    ...
    sub_1BAB41C(&StringLiteral_12321/*"STONE_SHOP_EXTRA_ITEM_TITLE"*/, v12);
    sub_1BAB41C(&StringLiteral_12318/*"STONE_SHOP_DETAIL_TITLE"*/, v13);
    sub_1BAB41C(&StringLiteral_12323/*"STONE_SHOP_STONE_INFO_TEMPLATE"*/, v14);
    sub_1BAB41C(&StringLiteral_12324/*"STONE_SHOP_STONE_INFO_TITLE"*/, v15);
    byte_4AB23AC = 1;
  }
  entity = 0LL;
  StoneShopDetailDialog__Init(this, (const MethodInfo *)bankShop);
  this->fields.clickFunc = func;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.clickFunc, (int32_t)func, v16, v17);
  if ( bankShop )
  {
      ...
      if ( stoneShopDetailListViewManager )
      {
        ...
        if ( stoneShopDetailListViewManager )
        {
          ...
          stoneShopDetailListViewManager = (StoneShopDetailListViewManager_o *)LocalizationManager__Get(
                                                                                 (System_String_o *)StringLiteral_12318/*"STONE_SHOP_DETAIL_TITLE"*/,
                                                                                 0LL);
          if ( titleLabel )
          {
            ...
            if ( stoneShopDetailListViewManager )
            {
              ...
              stoneShopDetailListViewManager = (StoneShopDetailListViewManager_o *)LocalizationManager__Get(
                                                                                     (System_String_o *)StringLiteral_12324/*"STONE_SHOP_STONE_INFO_TITLE"*/,
                                                                                     0LL);
              if ( stoneInfoTitleLabel )
              {
                ...
                v28 = LocalizationManager__Get((System_String_o *)StringLiteral_12323/*"STONE_SHOP_STONE_INFO_TEMPLATE"*/, 0LL);
                ...
                stoneShopDetailListViewManager = (StoneShopDetailListViewManager_o *)System_String__Format_62062568(
                                                                                       v28,
                                                                                       v32,
                                                                                       v36,
                                                                                       v40,
                ...
                if ( stoneInfoDetailLabel )
                {
                  ...
                  stoneShopDetailListViewManager = (StoneShopDetailListViewManager_o *)DataManager__GetMaster_object_((const MethodInfo_2EC5574 *)Method_DataManager_GetMaster_ItemMaster___);
                  if ( stoneShopDetailListViewManager )
                  {
                      ...
                      if ( stoneShopDetailListViewManager )
                      {
                        ...
                        if ( stoneShopDetailListViewManager )
                        {
                          ...
                          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                          stoneShopDetailListViewManager = (StoneShopDetailListViewManager_o *)LocalizationManager__Get(
                                                                                                 (System_String_o *)StringLiteral_12321/*"STONE_SHOP_EXTRA_ITEM_TITLE"*/,
                                                                                                 0LL);
...
LABEL_35:
    sub_1BAB678(stoneShopDetailListViewManager, v18);
  }
LABEL_34:
