...
bool __fastcall ServantCostumeEntity__IsEventCombineCostume(ServantCostumeEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_2F8F46C *)Method_DataManager_GetMasterData_EventCombineCostumeMaster___)) == 0LL )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB4DDC & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_17438/*"beige"*/, param);
    byte_4BB4DDC = 1;
  }
  return ServantCostumeEntity__checkScript(this, (System_String_o *)StringLiteral_17438/*"beige"*/, param, v3);
}
