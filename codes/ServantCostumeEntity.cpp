...
bool __fastcall ServantCostumeEntity__IsEventCombineCostume(ServantCostumeEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_2E5B3E8 *)Method_DataManager_GetMasterData_EventCombineCostumeMaster___)) == 0LL )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2017A & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_17125/*"bgmId"*/, param);
    byte_4A2017A = 1;
  }
  return ServantCostumeEntity__checkScript(this, (System_String_o *)StringLiteral_17125/*"bgmId"*/, param, v3);
}
