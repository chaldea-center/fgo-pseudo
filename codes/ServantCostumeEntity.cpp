...
bool ServantCostumeEntity__IsEventCombineCostume(ServantCostumeEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_31A4A3C *)Method_DataManager_GetMasterData_EventCombineCostumeMaster___)) == 0 )
  {
...
bool ServantCostumeEntity__checkBgmId(ServantCostumeEntity_o *this, int32_t *param, const MethodInfo *method)
{
  ...
  if ( (byte_4D312A9 & 1) == 0 )
  {
    sub_1C93AD4(&StringLiteral_17275/*"bgmId"*/);
    byte_4D312A9 = 1;
  }
  return ServantCostumeEntity__checkScript(this, (System_String_o *)StringLiteral_17275/*"bgmId"*/, param, v3);
}
