...
bool __fastcall ServantCostumeEntity__IsEventCombineCostume(ServantCostumeEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_2E62408 *)Method_DataManager_GetMasterData_EventCombineCostumeMaster___)) == 0LL )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E5EC & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_17169/*"bgmId"*/, param);
    byte_4A2E5EC = 1;
  }
  return ServantCostumeEntity__checkScript(this, (System_String_o *)StringLiteral_17169/*"bgmId"*/, param, v3);
}
