        ...
        const MethodInfo *method)
{
  ...
  if ( !layout
    ...
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_2FAFE04 *)Method_DataManager_GetMasterData_WarBoardTreasureMaster___)) == 0LL )
  {
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)p_treasureEntity, (int64_t)Entity, v16, v17, v18, v19, v20, v21);
...
void __fastcall WarBoardTreasureData_SaveData___ctor_36723580(
        ...
        const MethodInfo *method)
{
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.owner, (int64_t)Treasure, v5, v6, v7, v8, v9, v10);
  owner = this->fields.owner;
  if ( owner )
  {
