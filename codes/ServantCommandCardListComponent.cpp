void ServantCommandCardListComponent___ctor(ServantCommandCardListComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.cardSpriteList, (int32_t)v3, v4, v5, v6, v7, v8, v9);
  v10 = (struct UISprite_array *)sub_1CE67A8(UISprite___TypeInfo, 5);
  this->fields.grantSpriteList = v10;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.grantSpriteList, (int32_t)v10, v11, v12, v13, v14, v15, v16);
  v17 = (struct UISprite_array *)sub_1CE67A8(UISprite___TypeInfo, 5);
  this->fields.cardRankSpriteList = v17;
  sub_1CE66A4(
    (GrandQuestFolderBoardItem_o *)&this->fields.cardRankSpriteList,
    (int32_t)v17,
    v18,
    v19,
    v20,
  ...
  this->fields.COMMAND_CARD_GRAY_OUT = (struct UnityEngine_Color_o)xmmword_D24700;
...
void ServantCommandCardListComponent__Clear(ServantCommandCardListComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E03F64 & 1) == 0 )
  {
    this = (ServantCommandCardListComponent_o *)sub_1CE6700(&UnityEngine_Object_TypeInfo);
    byte_4E03F64 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    ServantCommandCardListComponent__Set_42224372(this, (UserServantEntity_o *)Entity, cardIconType, v12);
  }
}
...
void ServantCommandCardListComponent__SetHide(ServantCommandCardListComponent_o *this, const MethodInfo *method)
{
  ...
  ServantCommandCardListComponent__Set_42223068(this, 0, 0, 0, 4, 1, 0, v2);
}


void ServantCommandCardListComponent__Set_42223068(
        ServantCommandCardListComponent_o *this,
...
void ServantCommandCardListComponent__Set_42224372(
        ServantCommandCardListComponent_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( userSvtEntity )
  {
    ...
    *(_QWORD *)&v14.fields.fakeValue = v7;
    v9 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_50038008(v14, 0);
...
void ServantCommandCardListComponent__Set_42224604(
        ServantCommandCardListComponent_o *this,
        int32_t baseSvtId,
        int32_t svtId,
        System_Int32_array *cardParams,
        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    ServantCommandCardListComponent__Set_42223068(
      this,
...
// local variable allocation has failed, the output may be wrong!
void ServantCommandCardListComponent__Set_42224868(
        ServantCommandCardListComponent_o *this,
        int32_t baseSvtId,
        int32_t svtId,
        System_Int32_array *codeIds,
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&Method_DataManager_GetMaster_ServantMaster___);
    sub_1CE6700(&Method_DataManager_GetMaster_UserServantCommandCardMaster___);
    sub_1CE6700(&DataManager_TypeInfo);
    sub_1CE6700(&Method_DataMasterBase_ServantMaster__ServantEntity__int__GetEntity__);
    sub_1CE6700(&NetworkManager_TypeInfo);
    byte_4E03F67 = 1;
  ...
  if ( baseSvtId > 0 )
  {
    ...
    if ( Master_object )
    {
      ...
      v16 = DataManager__GetMaster_object_((const MethodInfo_3204354 *)Method_DataManager_GetMaster_UserServantCommandCardMaster___);
      if ( !NetworkManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
      if ( !byte_4DFE4CA )
      {
