        ...
        const MethodInfo *method)
{
  ...
  sub_1B4CF34(&this->fields.animation);
  this->fields.animationName = animationName;
  sub_1B4CF34(&this->fields.animationName);
  this->fields.SkipCond = skipCond;
  sub_1B4CF34(&this->fields.SkipCond);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B5B37 & 1) == 0 )
  {
    sub_1B4CF90(&DiggingSchedulerTaskAnimationSkippable__Execute_d__6_TypeInfo, method);
    byte_49B5B37 = 1;
  }
  v3 = sub_1B4D1DC(DiggingSchedulerTaskAnimationSkippable__Execute_d__6_TypeInfo);
          ...
          *(_QWORD *)&SkipCond->fields.extra_arg) & 1) == 0 )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(animation, 0LL, 0LL) )
    {
      ...
      if ( !v6 || (UnityEngine_Animation__Rewind(v6, 0LL), (v6 = this->fields.animation) == 0LL) )
        sub_1B4D1EC(v6, v5);
      if ( UnityEngine_Animation__Play_68548868(v6, this->fields.animationName, 0LL) )
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B4CFA4(&Method_DiggingSchedulerTaskAnimationSkippable__Execute_d__6_System_Collections_IEnumerator_Reset__);
  sub_1B4D0B8(v3, v4);
}
