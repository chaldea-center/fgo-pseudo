        ...
        const MethodInfo *method)
{
  ...
  sub_1B8635C(&this->fields.animation);
  this->fields.animationName = animationName;
  sub_1B8635C(&this->fields.animationName);
  this->fields.SkipCond = skipCond;
  sub_1B8635C(&this->fields.SkipCond);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4909B & 1) == 0 )
  {
    sub_1B863B8(&DiggingSchedulerTaskAnimationSkippable__Execute_d__6_TypeInfo, method);
    byte_4A4909B = 1;
  }
  v3 = sub_1B86604(DiggingSchedulerTaskAnimationSkippable__Execute_d__6_TypeInfo);
          ...
          *(_QWORD *)&SkipCond->fields.extra_arg) & 1) == 0 )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(animation, 0LL, 0LL) )
    {
      ...
      if ( !v6 || (UnityEngine_Animation__Rewind(v6, 0LL), (v6 = this->fields.animation) == 0LL) )
        sub_1B86614(v6, v5);
      if ( UnityEngine_Animation__Play_69099832(v6, this->fields.animationName, 0LL) )
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B863CC(&Method_DiggingSchedulerTaskAnimationSkippable__Execute_d__6_System_Collections_IEnumerator_Reset__);
  sub_1B864E0(v3, v4);
}
