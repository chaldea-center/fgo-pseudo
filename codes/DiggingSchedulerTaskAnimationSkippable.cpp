        ...
        const MethodInfo *method)
{
  ...
  sub_1C13CC8(&this->fields.animation);
  this->fields.animationName = animationName;
  sub_1C13CC8(&this->fields.animationName);
  this->fields.SkipCond = skipCond;
  sub_1C13CC8(&this->fields.SkipCond);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAF54F & 1) == 0 )
  {
    sub_1C13D24(&DiggingSchedulerTaskAnimationSkippable__Execute_d__6_TypeInfo, method);
    byte_4BAF54F = 1;
  }
  v3 = sub_1C13F70(DiggingSchedulerTaskAnimationSkippable__Execute_d__6_TypeInfo);
          ...
          *(_QWORD *)&SkipCond->fields.extra_arg) & 1) == 0 )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(animation, 0LL, 0LL) )
    {
      ...
      if ( !v6 || (UnityEngine_Animation__Rewind(v6, 0LL), (v6 = this->fields.animation) == 0LL) )
        sub_1C13F80(v6, v5);
      if ( UnityEngine_Animation__Play_70466396(v6, this->fields.animationName, 0LL) )
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C13D38(&Method_DiggingSchedulerTaskAnimationSkippable__Execute_d__6_System_Collections_IEnumerator_Reset__);
  sub_1C13E4C(v3, v4);
}
