        ...
        const MethodInfo *method)
{
  ...
  sub_1C21DDC(&this->fields.animation, animation);
  this->fields.animationName = animationName;
  sub_1C21DDC(&this->fields.animationName, animationName);
  this->fields.SkipCond = skipCond;
  sub_1C21DDC(&this->fields.SkipCond, skipCond);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD736E & 1) == 0 )
  {
    sub_1C21E38(&DiggingSchedulerTaskAnimationSkippable__Execute_d__6_TypeInfo);
    byte_4BD736E = 1;
  }
  v3 = sub_1C22084(DiggingSchedulerTaskAnimationSkippable__Execute_d__6_TypeInfo);
          ...
          *(_QWORD *)&SkipCond->fields.extra_arg) & 1) == 0 )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(animation, 0LL, 0LL) )
    {
      ...
      if ( !v6 || (UnityEngine_Animation__Rewind(v6, 0LL), (v6 = this->fields.animation) == 0LL) )
        sub_1C22094(v6, v5);
      if ( UnityEngine_Animation__Play_70614020(v6, this->fields.animationName, 0LL) )
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C21E4C(&Method_DiggingSchedulerTaskAnimationSkippable__Execute_d__6_System_Collections_IEnumerator_Reset__);
  sub_1C21F60(v3, v4);
}
