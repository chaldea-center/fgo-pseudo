        ...
        const MethodInfo *method)
{
  ...
  sub_1C6B9AC(&this->fields.animation, animation);
  this->fields.animationName = animationName;
  sub_1C6B9AC(&this->fields.animationName, animationName);
  this->fields.SkipCond = skipCond;
  sub_1C6B9AC(&this->fields.SkipCond, skipCond);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB0A76 & 1) == 0 )
  {
    sub_1C6BA08(&DiggingSchedulerTaskAnimationSkippable__Execute_d__6_TypeInfo);
    byte_4CB0A76 = 1;
  }
  v3 = sub_1C6BC54(DiggingSchedulerTaskAnimationSkippable__Execute_d__6_TypeInfo);
      ...
      & 1) == 0 )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(animation, 0, 0) )
    {
      ...
      if ( !v6 || (UnityEngine_Animation__Rewind(v6, 0), (v6 = this->fields.animation) == 0) )
        sub_1C6BC60(v6, v5);
      if ( UnityEngine_Animation__Play_71403152(v6, this->fields.animationName, 0) )
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C6BA1C(&Method_DiggingSchedulerTaskAnimationSkippable__Execute_d__6_System_Collections_IEnumerator_Reset__);
  sub_1C6BB30(v3, v4);
}
