        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B10FEB & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&Method_ServantEquipFramePurchaseMenu_EndCloseBuyFrameConfirmCancel__, v6, v7);
    byte_4B10FEB = 1;
  }
  if ( isDecide )
  {
  ...
  else
  {
    ...
    if ( !purchaseConfirmMenu )
      sub_1BCAA3C(v10, v11);
    ServantEquipFramePurchaseConfirmMenu__Close_30925832(purchaseConfirmMenu, v9, v12);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BCA7E0(&System_Action_TypeInfo, isDecide, method);
    sub_1BCA7E0(&Method_ServantEquipFramePurchaseMenu_EndCloseBuyFrameConfirmPurchase__, v5, v6);
    byte_4B10FEE = 1;
  }
  purchaseConfirmMenu = this->fields.purchaseConfirmMenu;
  ...
  if ( !purchaseConfirmMenu )
    sub_1BCAA3C(v9, v10);
  ServantEquipFramePurchaseConfirmMenu__Close_30925832(purchaseConfirmMenu, v8, v11);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B10FE9 & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&Method_ServantEquipFramePurchaseMenu_SelectedBuyBankItemConfirm__, v5, v6);
...
LABEL_8:
  ...
  if ( !purchaseConfirmMenu )
    goto LABEL_8;
  ServantEquipFramePurchaseConfirmMenu__Close_30925832(purchaseConfirmMenu, 0LL, method);
        ...
        const MethodInfo *method)
{
  ...
  __int64 v5; // x2
  ServantEquipFramePurchaseConfirmMenu_o *purchaseConfirmMenu; // x0
  ServantEquipFramePurchaseConfirmMenu_o *v7; // x20
  ...
  if ( (byte_4B10FED & 1) == 0 )
  {
    sub_1BCA7E0(&ServantEquipFramePurchaseConfirmMenu_CallbackFunc_TypeInfo, result, method);
    sub_1BCA7E0(&Method_ServantEquipFramePurchaseMenu_EndBuyFrameResultConfirm__, v4, v5);
    byte_4B10FED = 1;
  }
  purchaseConfirmMenu = this->fields.purchaseConfirmMenu;
  this->fields.state = 7;
  if ( !purchaseConfirmMenu
    || (ServantEquipFramePurchaseConfirmMenu__Init(purchaseConfirmMenu, (const MethodInfo *)result),
        ...
        v12 = (ServantEquipFramePurchaseConfirmMenu_CallbackFunc_o *)sub_1BCAA2C(
  ...
  ServantEquipFramePurchaseConfirmMenu__Open(v7, 2, stoneShopEntity, v12, v14);
        ...
        const MethodInfo *method)
{
  ...
  struct ServantEquipFramePurchaseConfirmMenu_o *v32; // x20
  ServantEquipFramePurchaseConfirmMenu_CallbackFunc_o *v33; // x22
  const MethodInfo *v34; // x3
  const MethodInfo *v35; // x4
  int32_t v36; // w1
  ServantEquipFramePurchaseConfirmMenu_o *v37; // x0
  struct ServantEquipFramePurchaseConfirmMenu_o *v38; // x20
  ServantEquipFramePurchaseConfirmMenu_CallbackFunc_o *v39; // x21
  const MethodInfo *v40; // x3
  const MethodInfo *v41; // x3
  StoneShopEntity_o *v42; // x2
  ServantEquipFramePurchaseConfirmMenu_CallbackFunc_o *v43; // x3
  ...
  if ( (byte_4B10FE8 & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&ServantEquipFramePurchaseConfirmMenu_CallbackFunc_TypeInfo, v7, v8);
    sub_1BCA7E0(&Method_DataManager_GetMasterData_StoneShopMaster___, v9, v10);
    sub_1BCA7E0(&Method_ServantEquipFramePurchaseMenu_EndBuyFrameConfirm__, v11, v12);
    sub_1BCA7E0(&Method_ServantEquipFramePurchaseMenu_EndBuyStoneConfirm__, v13, v14);
    sub_1BCA7E0(&Method_ServantEquipFramePurchaseMenu_EndMaxFrameConfirm__, v15, v16);
    sub_1BCA7E0(&Method_ServantEquipFramePurchaseMenu_EndNoShopConfirm__, v17, v18);
  ...
  if ( !this->fields.state )
  {
    ...
    if ( !gameObject )
      goto LABEL_27;
    gameObject = StoneShopMaster__GetEnableEntitiyList_40724432((StoneShopMaster_o *)gameObject, 13, 0LL);
    if ( !gameObject )
      goto LABEL_27;
      ...
      if ( svtEquipKeep < *(_DWORD *)(*((_QWORD *)gameObject + 23) + 140LL) )
      {
        ...
        if ( stoneShopEntity )
        {
          if ( SelfUserGame->fields.stone >= stoneShopEntity->fields.price )
          {
            this->fields.state = 3;
            purchaseConfirmMenu = this->fields.purchaseConfirmMenu;
            v33 = (ServantEquipFramePurchaseConfirmMenu_CallbackFunc_o *)sub_1BCAA2C(
                                                                           ServantEquipFramePurchaseConfirmMenu_CallbackFunc_TypeInfo,
                                                                           v22,
                                                                           v28,
                                                                           v29);
...
LABEL_27:
      ...
      v39 = (ServantEquipFramePurchaseConfirmMenu_CallbackFunc_o *)sub_1BCAA2C(
                                                                     ServantEquipFramePurchaseConfirmMenu_CallbackFunc_TypeInfo,
                                                                     v22,
                                                                     v28,
                                                                     v29);
    ...
    v43 = v39;
LABEL_26:
    ServantEquipFramePurchaseConfirmMenu__Open(v37, v36, v42, v43, v35);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B10FEC & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&Method_ServantEquipFramePurchaseMenu_EndRequestServantEquipFramePurchase__, v9, v10);
    byte_4B10FEC = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  __int64 v17; // x2
  __int64 v18; // x3
  ServantEquipFramePurchaseConfirmMenu_CallbackFunc_o *v19; // x22
  ...
  int32_t v25; // w1
  ServantEquipFramePurchaseMenu_o *v26; // x0
  ...
  if ( (byte_4B10FEA & 1) == 0 )
  {
    sub_1BCA7E0(&ServantEquipFramePurchaseConfirmMenu_CallbackFunc_TypeInfo, *(_QWORD *)&result, method);
    sub_1BCA7E0(&Method_ServantEquipFramePurchaseMenu_EndBuyFrameConfirm__, v5, v6);
    sub_1BCA7E0(&Method_ServantEquipFramePurchaseMenu_EndBuyStoneConfirm__, v7, v8);
...
LABEL_15:
  ...
  switch ( result )
  {
    ...
    case 4:
      ...
      if ( !Instance )
        goto LABEL_15;
      ServantEquipFramePurchaseConfirmMenu__Init((ServantEquipFramePurchaseConfirmMenu_o *)Instance, v12);
      purchaseConfirmMenu = this->fields.purchaseConfirmMenu;
      stoneShopEntity = this->fields.stoneShopEntity;
      v19 = (ServantEquipFramePurchaseConfirmMenu_CallbackFunc_o *)sub_1BCAA2C(
                                                                     ServantEquipFramePurchaseConfirmMenu_CallbackFunc_TypeInfo,
                                                                     v16,
                                                                     v17,
                                                                     v18);
    ...
    case 2:
      ...
      v24 = v28;
LABEL_12:
      ServantEquipFramePurchaseConfirmMenu__Open(v23, v22, v24, v19, v21);
      break;
    case 3:
      v26 = this;
      v25 = 0;
LABEL_14:
      ServantEquipFramePurchaseMenu__Callback(v26, v25, v13);
      break;
    default:
      return;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B10FE6 & 1) == 0 )
  {
    sub_1BCA7E0(&ServantEquipFramePurchaseMenu_CallbackFunc_TypeInfo, value, method);
    byte_4B10FE6 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (ServantEquipFramePurchaseMenu_o *)sub_1BCACFC(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A05144;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A050FC;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B10FEF & 1) == 0 )
  {
    sub_1BCA7E0(&ServantEquipFramePurchaseMenu_Result_TypeInfo, *(_QWORD *)&result, callback);
    byte_4B10FEF = 1;
  }
  v9[1] = 0LL;
