...
void __fastcall ServantEquipFramePurchaseMenu__Close(ServantEquipFramePurchaseMenu_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.state )
  {
    ...
    if ( !purchaseConfirmMenu
      || (ServantEquipFramePurchaseConfirmMenu__Init(purchaseConfirmMenu, method),
          (purchaseConfirmMenu = (ServantEquipFramePurchaseConfirmMenu_o *)UnityEngine_Component__get_gameObject(
                                                                             ...
                                                                             0LL)) == 0LL) )
    {
      sub_1C3B9C0(purchaseConfirmMenu, method);
    }
    ...
    sub_1C3B708(p_refreshCallbackFunc);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1CBA7 & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_ServantEquipFramePurchaseMenu_EndCloseBuyFrameConfirmCancel__, v5);
    byte_4C1CBA7 = 1;
  }
  if ( isDecide )
  {
  ...
  else
  {
    ...
    if ( !purchaseConfirmMenu )
      sub_1C3B9C0(v8, v9);
    ServantEquipFramePurchaseConfirmMenu__Close_31420736(purchaseConfirmMenu, v7, v10);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C3B764(&System_Action_TypeInfo, isDecide);
    sub_1C3B764(&Method_ServantEquipFramePurchaseMenu_EndCloseBuyFrameConfirmPurchase__, v4);
    byte_4C1CBAA = 1;
  }
  purchaseConfirmMenu = this->fields.purchaseConfirmMenu;
  ...
  if ( !purchaseConfirmMenu )
    sub_1C3B9C0(v7, v8);
  ServantEquipFramePurchaseConfirmMenu__Close_31420736(purchaseConfirmMenu, v6, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1CBA5 & 1) == 0 )
  {
    sub_1C3B764(&StonePurchaseMenu_CallbackFunc_TypeInfo, isDecide);
    sub_1C3B764(&Method_ServantEquipFramePurchaseMenu_SelectedBuyBankItemConfirm__, v5);
  ...
  if ( isDecide )
  {
    ...
    v8 = (StonePurchaseMenu_CallbackFunc_o *)sub_1C3B9B0(StonePurchaseMenu_CallbackFunc_TypeInfo);
...
LABEL_8:
    sub_1C3B9C0(purchaseConfirmMenu, isDecide);
  }
  purchaseConfirmMenu = this->fields.purchaseConfirmMenu;
  if ( !purchaseConfirmMenu )
    goto LABEL_8;
  ServantEquipFramePurchaseConfirmMenu__Close_31420736(purchaseConfirmMenu, 0LL, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1CBA9 & 1) == 0 )
  {
    sub_1C3B764(&ServantEquipFramePurchaseConfirmMenu_CallbackFunc_TypeInfo, result);
    sub_1C3B764(&Method_ServantEquipFramePurchaseMenu_EndBuyFrameResultConfirm__, v4);
    byte_4C1CBA9 = 1;
  }
  purchaseConfirmMenu = this->fields.purchaseConfirmMenu;
  this->fields.state = 7;
  if ( !purchaseConfirmMenu
    || (ServantEquipFramePurchaseConfirmMenu__Init(purchaseConfirmMenu, (const MethodInfo *)result),
        ...
        v8 = (ServantEquipFramePurchaseConfirmMenu_CallbackFunc_o *)sub_1C3B9B0(ServantEquipFramePurchaseConfirmMenu_CallbackFunc_TypeInfo),
        ...
        !v6) )
  {
    sub_1C3B9C0(purchaseConfirmMenu, result);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1CBA4 & 1) == 0 )
  {
    ...
    sub_1C3B764(&ServantEquipFramePurchaseConfirmMenu_CallbackFunc_TypeInfo, v7);
    sub_1C3B764(&Method_DataManager_GetMasterData_StoneShopMaster___, v8);
    sub_1C3B764(&Method_ServantEquipFramePurchaseMenu_EndBuyFrameConfirm__, v9);
    sub_1C3B764(&Method_ServantEquipFramePurchaseMenu_EndBuyStoneConfirm__, v10);
    sub_1C3B764(&Method_ServantEquipFramePurchaseMenu_EndMaxFrameConfirm__, v11);
    sub_1C3B764(&Method_ServantEquipFramePurchaseMenu_EndNoShopConfirm__, v12);
  ...
  if ( !this->fields.state )
  {
    ...
    sub_1C3B708(&this->fields.refreshCallbackFunc);
    ...
    if ( !gameObject )
      goto LABEL_27;
    gameObject = StoneShopMaster__GetEnableEntitiyList_41465676((StoneShopMaster_o *)gameObject, 13, 0LL);
    if ( !gameObject )
      goto LABEL_27;
    ...
    {
      if ( !(_DWORD)v19 )
        sub_1C3B9C8(gameObject, v15, v17, v18);
      this->fields.stoneShopEntity = (struct StoneShopEntity_o *)*((_QWORD *)gameObject + 4);
      gameObject = (void *)sub_1C3B708(&this->fields.stoneShopEntity);
      if ( !SelfUserGame )
        goto LABEL_27;
      ...
      if ( svtEquipKeep < *(_DWORD *)(*((_QWORD *)gameObject + 23) + 140LL) )
      {
        ...
        if ( stoneShopEntity )
        {
          if ( SelfUserGame->fields.stone >= stoneShopEntity->fields.price )
          {
            this->fields.state = 3;
            purchaseConfirmMenu = this->fields.purchaseConfirmMenu;
            v23 = (ServantEquipFramePurchaseConfirmMenu_CallbackFunc_o *)sub_1C3B9B0(ServantEquipFramePurchaseConfirmMenu_CallbackFunc_TypeInfo);
            ServantEquipFramePurchaseConfirmMenu_CallbackFunc___ctor(
              v23,
              (Il2CppObject *)this,
...
LABEL_27:
      ...
      v29 = (ServantEquipFramePurchaseConfirmMenu_CallbackFunc_o *)sub_1C3B9B0(ServantEquipFramePurchaseConfirmMenu_CallbackFunc_TypeInfo);
      ServantEquipFramePurchaseConfirmMenu_CallbackFunc___ctor(
        v29,
        (Il2CppObject *)this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1CBA8 & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_ServantEquipFramePurchaseMenu_EndRequestServantEquipFramePurchase__, v6);
    byte_4C1CBA8 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1CBA6 & 1) == 0 )
  {
    sub_1C3B764(&ServantEquipFramePurchaseConfirmMenu_CallbackFunc_TypeInfo, *(_QWORD *)&result);
    sub_1C3B764(&Method_ServantEquipFramePurchaseMenu_EndBuyFrameConfirm__, v5);
    sub_1C3B764(&Method_ServantEquipFramePurchaseMenu_EndBuyStoneConfirm__, v6);
...
LABEL_15:
  ...
  switch ( result )
  {
    ...
    case 4:
      ...
      purchaseConfirmMenu = this->fields.purchaseConfirmMenu;
      stoneShopEntity = this->fields.stoneShopEntity;
      v13 = (ServantEquipFramePurchaseConfirmMenu_CallbackFunc_o *)sub_1C3B9B0(ServantEquipFramePurchaseConfirmMenu_CallbackFunc_TypeInfo);
      ServantEquipFramePurchaseConfirmMenu_CallbackFunc___ctor(
        v13,
        (Il2CppObject *)this,
        Method_ServantEquipFramePurchaseMenu_EndBuyStoneConfirm__,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1CBA2 & 1) == 0 )
  {
    sub_1C3B764(&ServantEquipFramePurchaseMenu_CallbackFunc_TypeInfo, value);
    byte_4C1CBA2 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (ServantEquipFramePurchaseMenu_o *)sub_1C3BC80(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A74968;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A74920;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1CBAB & 1) == 0 )
  {
    sub_1C3B764(&ServantEquipFramePurchaseMenu_Result_TypeInfo, *(_QWORD *)&result);
    byte_4C1CBAB = 1;
  }
  v9[1] = 0LL;
