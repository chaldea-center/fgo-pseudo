        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EB987 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&Method_ServantEquipFramePurchaseMenu_EndCloseBuyFrameConfirmCancel__, v6, v7, v8);
    byte_42EB987 = 1;
  }
  if ( isDecide )
  {
  ...
  else
  {
    ...
    if ( !purchaseConfirmMenu )
      sub_B5D69C(v11, v12);
    ServantEquipFramePurchaseConfirmMenu__Close_30829480(purchaseConfirmMenu, v10, v13);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B5D5C4(&System_Action_TypeInfo, isDecide, (_DWORD)method, v3);
    sub_B5D5C4(&Method_ServantEquipFramePurchaseMenu_EndCloseBuyFrameConfirmPurchase__, v5, v6, v7);
    byte_42EB98A = 1;
  }
  purchaseConfirmMenu = this->fields.purchaseConfirmMenu;
  ...
  if ( !purchaseConfirmMenu )
    sub_B5D69C(v10, v11);
  ServantEquipFramePurchaseConfirmMenu__Close_30829480(purchaseConfirmMenu, v9, v12);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EB985 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&Method_ServantEquipFramePurchaseMenu_SelectedBuyBankItemConfirm__, v6, v7, v8);
...
LABEL_8:
  ...
  if ( !purchaseConfirmMenu )
    goto LABEL_8;
  ServantEquipFramePurchaseConfirmMenu__Close_30829480(purchaseConfirmMenu, 0LL, method);
  ServantEquipFramePurchaseMenu__Callback(this, 0, v15);
}
        ...
        const MethodInfo *method)
{
  ...
  __int64 v7; // x3
  ServantEquipFramePurchaseConfirmMenu_o *purchaseConfirmMenu; // x0
  ServantEquipFramePurchaseConfirmMenu_o *v9; // x20
  StoneShopEntity_o *stoneShopEntity; // x21
  ServantEquipFramePurchaseConfirmMenu_CallbackFunc_o *v11; // x22
  const MethodInfo *v12; // x4
  System_Action_o *refreshCallbackFunc; // x0

  if ( (byte_42EB989 & 1) == 0 )
  {
    sub_B5D5C4(&ServantEquipFramePurchaseConfirmMenu_CallbackFunc_TypeInfo, (_DWORD)result, (_DWORD)method, v3);
    sub_B5D5C4(&Method_ServantEquipFramePurchaseMenu_EndBuyFrameResultConfirm__, v5, v6, v7);
    byte_42EB989 = 1;
  }
  purchaseConfirmMenu = this->fields.purchaseConfirmMenu;
  this->fields.state = 7;
  if ( !purchaseConfirmMenu
    || (ServantEquipFramePurchaseConfirmMenu__Init(purchaseConfirmMenu, (const MethodInfo *)result),
        ...
        v11 = (ServantEquipFramePurchaseConfirmMenu_CallbackFunc_o *)sub_B5D694(ServantEquipFramePurchaseConfirmMenu_CallbackFunc_TypeInfo),
  ...
  ServantEquipFramePurchaseConfirmMenu__Open(v9, 2, stoneShopEntity, v11, v12);
        ...
        const MethodInfo *method)
{
  ...
  struct ServantEquipFramePurchaseConfirmMenu_o *v51; // x20
  ServantEquipFramePurchaseConfirmMenu_CallbackFunc_o *v52; // x22
  const MethodInfo *v53; // x4
  int32_t v54; // w1
  ServantEquipFramePurchaseConfirmMenu_o *v55; // x0
  struct ServantEquipFramePurchaseConfirmMenu_o *v56; // x20
  ServantEquipFramePurchaseConfirmMenu_CallbackFunc_o *v57; // x21
  StoneShopEntity_o *v58; // x2
  ServantEquipFramePurchaseConfirmMenu_CallbackFunc_o *v59; // x3
  ...
  if ( (byte_42EB984 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&ServantEquipFramePurchaseConfirmMenu_CallbackFunc_TypeInfo, v11, v12, v13);
    sub_B5D5C4(&Method_DataManager_GetMasterData_StoneShopMaster___, v14, v15, v16);
    sub_B5D5C4(&Method_ServantEquipFramePurchaseMenu_EndBuyFrameConfirm__, v17, v18, v19);
    sub_B5D5C4(&Method_ServantEquipFramePurchaseMenu_EndBuyStoneConfirm__, v20, v21, v22);
    sub_B5D5C4(&Method_ServantEquipFramePurchaseMenu_EndMaxFrameConfirm__, v23, v24, v25);
    sub_B5D5C4(&Method_ServantEquipFramePurchaseMenu_EndNoShopConfirm__, v26, v27, v28);
  ...
  if ( !this->fields.state )
  {
    ...
    if ( !gameObject )
      goto LABEL_28;
    gameObject = StoneShopMaster__GetEnableEntitiyList_23586212((StoneShopMaster_o *)gameObject, 13, 0LL);
    if ( !gameObject )
      goto LABEL_28;
      ...
      if ( svtEquipKeep < *(_DWORD *)(*((_QWORD *)gameObject + 23) + 140LL) )
      {
        ...
        if ( stoneShopEntity )
        {
          if ( SelfUserGame->fields.stone >= stoneShopEntity->fields.price )
          {
            this->fields.state = 3;
            purchaseConfirmMenu = this->fields.purchaseConfirmMenu;
            v52 = (ServantEquipFramePurchaseConfirmMenu_CallbackFunc_o *)sub_B5D694(ServantEquipFramePurchaseConfirmMenu_CallbackFunc_TypeInfo);
            ServantEquipFramePurchaseConfirmMenu_CallbackFunc___ctor(
              v52,
              (Il2CppObject *)this,
...
LABEL_28:
      ...
      v57 = (ServantEquipFramePurchaseConfirmMenu_CallbackFunc_o *)sub_B5D694(ServantEquipFramePurchaseConfirmMenu_CallbackFunc_TypeInfo);
      ServantEquipFramePurchaseConfirmMenu_CallbackFunc___ctor(
        v57,
        (Il2CppObject *)this,
    ...
    v59 = v57;
LABEL_27:
    ServantEquipFramePurchaseConfirmMenu__Open(v55, v54, v58, v59, v53);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EB988 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&Method_ServantEquipFramePurchaseMenu_EndRequestServantEquipFramePurchase__, v11, v12, v13);
    byte_42EB988 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  struct ServantEquipFramePurchaseConfirmMenu_o *purchaseConfirmMenu; // x20
  struct StoneShopEntity_o *stoneShopEntity; // x21
  ServantEquipFramePurchaseConfirmMenu_CallbackFunc_o *v20; // x22
  const MethodInfo *v21; // x4
  int32_t v22; // w1
  ServantEquipFramePurchaseConfirmMenu_o *v23; // x0
  StoneShopEntity_o *v24; // x2
  ServantEquipFramePurchaseMenu_o *v25; // x0
  int32_t v26; // w1
  struct ServantEquipFramePurchaseConfirmMenu_o *v27; // x21
  struct StoneShopEntity_o *v28; // x20

  if ( (byte_42EB986 & 1) == 0 )
  {
    sub_B5D5C4(&ServantEquipFramePurchaseConfirmMenu_CallbackFunc_TypeInfo, result, (_DWORD)method, v3);
    sub_B5D5C4(&Method_ServantEquipFramePurchaseMenu_EndBuyFrameConfirm__, v6, v7, v8);
    sub_B5D5C4(&Method_ServantEquipFramePurchaseMenu_EndBuyStoneConfirm__, v9, v10, v11);
...
LABEL_15:
  ...
  switch ( result )
  {
    ...
    case 4:
      ...
      if ( !Instance )
        goto LABEL_15;
      ServantEquipFramePurchaseConfirmMenu__Init((ServantEquipFramePurchaseConfirmMenu_o *)Instance, v16);
      purchaseConfirmMenu = this->fields.purchaseConfirmMenu;
      stoneShopEntity = this->fields.stoneShopEntity;
      v20 = (ServantEquipFramePurchaseConfirmMenu_CallbackFunc_o *)sub_B5D694(ServantEquipFramePurchaseConfirmMenu_CallbackFunc_TypeInfo);
      ServantEquipFramePurchaseConfirmMenu_CallbackFunc___ctor(
        v20,
        (Il2CppObject *)this,
        Method_ServantEquipFramePurchaseMenu_EndBuyStoneConfirm__,
    ...
    case 2:
      ...
      v24 = v28;
LABEL_14:
      ServantEquipFramePurchaseConfirmMenu__Open(v23, v22, v24, v20, v21);
      break;
    case 3:
      v25 = this;
      v26 = 0;
LABEL_10:
      ServantEquipFramePurchaseMenu__Callback(v25, v26, v17);
      break;
    default:
      return;
  }
        ...
        const MethodInfo *method)
{
  ...
  __int64 v10; // x0
  bool v11; // zf
  ServantEquipFramePurchaseMenu_o *v12; // x0
  ServantEquipFramePurchaseMenu_CallbackFunc_o *v13; // x1
  const MethodInfo *v14; // x2

  if ( (byte_42EB982 & 1) == 0 )
  {
    sub_B5D5C4(&ServantEquipFramePurchaseMenu_CallbackFunc_TypeInfo, (_DWORD)value, (_DWORD)method, v3);
    byte_42EB982 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  ...
  while ( 1 )
  {
    ...
    if ( v9 )
    {
      if ( (ServantEquipFramePurchaseMenu_CallbackFunc_c *)v9->klass != ServantEquipFramePurchaseMenu_CallbackFunc_TypeInfo )
        break;
    }
  ...
  sub_B5D990(v9);
  ServantEquipFramePurchaseMenu__remove_callbackFunc(v12, v13, v14);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_B5D990(v9);
  ServantEquipFramePurchaseMenu__Open(v12, v13, v14, v15);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42E5D54 & 1) == 0 )
  {
    sub_B5D5C4(&ServantEquipFramePurchaseMenu_Result_TypeInfo, result, (_DWORD)callback, object);
    byte_42E5D54 = 1;
  }
  v9[1] = 0LL;
        ...
        const MethodInfo *method)
{
  ...
  ServantEquipFramePurchaseMenu_CallbackFunc_o *v19; // x8
  __int64 *v20; // x21
  __int64 v21; // x22
  ...
  ServantEquipFramePurchaseMenu_CallbackFunc_o *v33; // [xsp+8h] [xbp-48h] BYREF
