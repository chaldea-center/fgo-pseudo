...
void __fastcall ServantEquipFramePurchaseMenu__Close(ServantEquipFramePurchaseMenu_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.state )
  {
    ...
    if ( !purchaseConfirmMenu
      || (ServantEquipFramePurchaseConfirmMenu__Init(purchaseConfirmMenu, 0LL),
          (purchaseConfirmMenu = (ServantEquipFramePurchaseConfirmMenu_o *)UnityEngine_Component__get_gameObject(
                                                                             ...
                                                                             0LL)) == 0LL) )
    {
      sub_1B71828(purchaseConfirmMenu, method);
    }
    ...
    sub_1B71570(p_refreshCallbackFunc);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1AD08 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_ServantEquipFramePurchaseMenu_EndCloseBuyFrameConfirmCancel__, v5);
    byte_4A1AD08 = 1;
  }
  if ( isDecide )
  {
  ...
  else
  {
    ...
    if ( !purchaseConfirmMenu )
      sub_1B71828(v8, v9);
    ServantEquipFramePurchaseConfirmMenu__Close_45168920(purchaseConfirmMenu, v7, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B715CC(&System_Action_TypeInfo, isDecide);
    sub_1B715CC(&Method_ServantEquipFramePurchaseMenu_EndCloseBuyFrameConfirmPurchase__, v4);
    byte_4A1AD0B = 1;
  }
  purchaseConfirmMenu = this->fields.purchaseConfirmMenu;
  ...
  if ( !purchaseConfirmMenu )
    sub_1B71828(v7, v8);
  ServantEquipFramePurchaseConfirmMenu__Close_45168920(purchaseConfirmMenu, v6, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1AD06 & 1) == 0 )
  {
    sub_1B715CC(&StonePurchaseMenu_CallbackFunc_TypeInfo, isDecide);
    sub_1B715CC(&Method_ServantEquipFramePurchaseMenu_SelectedBuyBankItemConfirm__, v5);
  ...
  if ( isDecide )
  {
    ...
    v8 = (StonePurchaseMenu_CallbackFunc_o *)sub_1B71818(StonePurchaseMenu_CallbackFunc_TypeInfo);
...
LABEL_8:
    sub_1B71828(purchaseConfirmMenu, isDecide);
  }
  purchaseConfirmMenu = this->fields.purchaseConfirmMenu;
  if ( !purchaseConfirmMenu )
    goto LABEL_8;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1AD0A & 1) == 0 )
  {
    sub_1B715CC(&ServantEquipFramePurchaseConfirmMenu_CallbackFunc_TypeInfo, result);
    sub_1B715CC(&Method_ServantEquipFramePurchaseMenu_EndBuyFrameResultConfirm__, v4);
    byte_4A1AD0A = 1;
  }
  purchaseConfirmMenu = this->fields.purchaseConfirmMenu;
  this->fields.state = 7;
  if ( !purchaseConfirmMenu
    || (ServantEquipFramePurchaseConfirmMenu__Init(purchaseConfirmMenu, 0LL),
        ...
        v8 = (ServantEquipFramePurchaseConfirmMenu_CallbackFunc_o *)sub_1B71818(ServantEquipFramePurchaseConfirmMenu_CallbackFunc_TypeInfo),
        ...
        !v6) )
  {
    sub_1B71828(purchaseConfirmMenu, result);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1AD05 & 1) == 0 )
  {
    ...
    sub_1B715CC(&ServantEquipFramePurchaseConfirmMenu_CallbackFunc_TypeInfo, v7);
    sub_1B715CC(&Method_DataManager_GetMasterData_StoneShopMaster___, v8);
    sub_1B715CC(&Method_ServantEquipFramePurchaseMenu_EndBuyFrameConfirm__, v9);
    sub_1B715CC(&Method_ServantEquipFramePurchaseMenu_EndBuyStoneConfirm__, v10);
    sub_1B715CC(&Method_ServantEquipFramePurchaseMenu_EndMaxFrameConfirm__, v11);
    sub_1B715CC(&Method_ServantEquipFramePurchaseMenu_EndNoShopConfirm__, v12);
  ...
  if ( !this->fields.state )
  {
    ...
    sub_1B71570(&this->fields.refreshCallbackFunc);
    ...
    if ( !gameObject )
      goto LABEL_27;
    gameObject = StoneShopMaster__GetEnableEntitiyList_39696636((StoneShopMaster_o *)gameObject, 13, 0LL);
    if ( !gameObject )
      goto LABEL_27;
    ...
    {
      if ( !(_DWORD)v19 )
        sub_1B71830(gameObject, v15, v17, v18);
      this->fields.stoneShopEntity = (struct StoneShopEntity_o *)*((_QWORD *)gameObject + 4);
      gameObject = (void *)sub_1B71570(&this->fields.stoneShopEntity);
      if ( !SelfUserGame )
        goto LABEL_27;
      ...
      if ( svtEquipKeep < *(_DWORD *)(*((_QWORD *)gameObject + 23) + 140LL) )
      {
        ...
        if ( stoneShopEntity )
        {
          if ( SelfUserGame->fields.stone >= stoneShopEntity->fields.price )
          {
            this->fields.state = 3;
            purchaseConfirmMenu = this->fields.purchaseConfirmMenu;
            v23 = (ServantEquipFramePurchaseConfirmMenu_CallbackFunc_o *)sub_1B71818(ServantEquipFramePurchaseConfirmMenu_CallbackFunc_TypeInfo);
            ServantEquipFramePurchaseConfirmMenu_CallbackFunc___ctor(
              v23,
              (Il2CppObject *)this,
...
LABEL_27:
      ...
      v28 = (ServantEquipFramePurchaseConfirmMenu_CallbackFunc_o *)sub_1B71818(ServantEquipFramePurchaseConfirmMenu_CallbackFunc_TypeInfo);
      ServantEquipFramePurchaseConfirmMenu_CallbackFunc___ctor(
        v28,
        (Il2CppObject *)this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1AD09 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_ServantEquipFramePurchaseMenu_EndRequestServantEquipFramePurchase__, v6);
    byte_4A1AD09 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1AD07 & 1) == 0 )
  {
    sub_1B715CC(&ServantEquipFramePurchaseConfirmMenu_CallbackFunc_TypeInfo, *(_QWORD *)&result);
    sub_1B715CC(&Method_ServantEquipFramePurchaseMenu_EndBuyFrameConfirm__, v5);
    sub_1B715CC(&Method_ServantEquipFramePurchaseMenu_EndBuyStoneConfirm__, v6);
...
LABEL_15:
  ...
  switch ( result )
  {
    ...
    case 4:
      ...
      purchaseConfirmMenu = this->fields.purchaseConfirmMenu;
      stoneShopEntity = this->fields.stoneShopEntity;
      v13 = (ServantEquipFramePurchaseConfirmMenu_CallbackFunc_o *)sub_1B71818(ServantEquipFramePurchaseConfirmMenu_CallbackFunc_TypeInfo);
      ServantEquipFramePurchaseConfirmMenu_CallbackFunc___ctor(
        v13,
        (Il2CppObject *)this,
        Method_ServantEquipFramePurchaseMenu_EndBuyStoneConfirm__,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1AD03 & 1) == 0 )
  {
    sub_1B715CC(&ServantEquipFramePurchaseMenu_CallbackFunc_TypeInfo, value);
    byte_4A1AD03 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (ServantEquipFramePurchaseMenu_o *)sub_1B71AE8(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19B1780;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19B1738;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1AD0C & 1) == 0 )
  {
    sub_1B715CC(&ServantEquipFramePurchaseMenu_Result_TypeInfo, *(_QWORD *)&result);
    byte_4A1AD0C = 1;
  }
  v9[1] = 0LL;
