...
void ServantEquipFramePurchaseMenu__Close(ServantEquipFramePurchaseMenu_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.state )
  {
    ...
    if ( !purchaseConfirmMenu
      || (ServantEquipFramePurchaseConfirmMenu__Init(purchaseConfirmMenu, method),
          (purchaseConfirmMenu = (ServantEquipFramePurchaseConfirmMenu_o *)UnityEngine_Component__get_gameObject(
                                                                             ...
                                                                             0)) == 0) )
    {
      sub_1C2D6EC(purchaseConfirmMenu, method);
    }
    ...
    sub_1C2D434(p_refreshCallbackFunc);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21451 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_ServantEquipFramePurchaseMenu_EndCloseBuyFrameConfirmCancel__);
    byte_4C21451 = 1;
  }
  if ( isDecide )
  {
  ...
  else
  {
    ...
    if ( !purchaseConfirmMenu )
      sub_1C2D6EC(v7, v8);
    ServantEquipFramePurchaseConfirmMenu__Close_31365136(purchaseConfirmMenu, v6, v9);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C2D490(&System_Action_TypeInfo);
    sub_1C2D490(&Method_ServantEquipFramePurchaseMenu_EndCloseBuyFrameConfirmPurchase__);
    byte_4C21454 = 1;
  }
  purchaseConfirmMenu = this->fields.purchaseConfirmMenu;
  ...
  if ( !purchaseConfirmMenu )
    sub_1C2D6EC(v6, v7);
  ServantEquipFramePurchaseConfirmMenu__Close_31365136(purchaseConfirmMenu, v5, v8);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2144F & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_ServantEquipFramePurchaseMenu_SelectedBuyBankItemConfirm__);
...
LABEL_8:
    sub_1C2D6EC(purchaseConfirmMenu, isDecide);
  }
  purchaseConfirmMenu = this->fields.purchaseConfirmMenu;
  if ( !purchaseConfirmMenu )
    goto LABEL_8;
  ServantEquipFramePurchaseConfirmMenu__Close_31365136(purchaseConfirmMenu, 0, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21453 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_ServantEquipFramePurchaseMenu_EndBuyFrameResultConfirm__);
    byte_4C21453 = 1;
  }
  purchaseConfirmMenu = this->fields.purchaseConfirmMenu;
  this->fields.state = 7;
  if ( !purchaseConfirmMenu
    || (ServantEquipFramePurchaseConfirmMenu__Init(purchaseConfirmMenu, (const MethodInfo *)result),
        ...
        v7 = (ServantEquipFramePurchaseConfirmMenu_CallbackFunc_o *)sub_1C2D6DC(ServantEquipFramePurchaseConfirmMenu_CallbackFunc_TypeInfo),
        ...
        !v5) )
  {
    sub_1C2D6EC(purchaseConfirmMenu, result);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2144E & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_ServantEquipFramePurchaseMenu_EndBuyFrameConfirm__);
    sub_1C2D490(&Method_ServantEquipFramePurchaseMenu_EndBuyStoneConfirm__);
    sub_1C2D490(&Method_ServantEquipFramePurchaseMenu_EndMaxFrameConfirm__);
    sub_1C2D490(&Method_ServantEquipFramePurchaseMenu_EndNoShopConfirm__);
  ...
  if ( !this->fields.state )
  {
    ...
    sub_1C2D434(&this->fields.refreshCallbackFunc);
    ...
    if ( !gameObject )
      goto LABEL_27;
    gameObject = StoneShopMaster__GetEnableEntitiyList_42714548((StoneShopMaster_o *)gameObject, 13, 0);
    if ( !gameObject )
      goto LABEL_27;
    v12 = *((_QWORD *)gameObject + 3);
    if ( v12 )
    {
      if ( !(_DWORD)v12 )
        sub_1C2D6F4(gameObject, v8, v10, v11);
      this->fields.stoneShopEntity = (struct StoneShopEntity_o *)*((_QWORD *)gameObject + 4);
      gameObject = (void *)sub_1C2D434(&this->fields.stoneShopEntity);
      if ( !SelfUserGame )
        goto LABEL_27;
      ...
      if ( svtEquipKeep < *(_DWORD *)(*((_QWORD *)gameObject + 23) + 156LL) )
      {
        ...
        if ( stoneShopEntity )
        {
          if ( SelfUserGame->fields.stone >= stoneShopEntity->fields.price )
          {
            this->fields.state = 3;
            purchaseConfirmMenu = this->fields.purchaseConfirmMenu;
            v16 = (ServantEquipFramePurchaseConfirmMenu_CallbackFunc_o *)sub_1C2D6DC(ServantEquipFramePurchaseConfirmMenu_CallbackFunc_TypeInfo);
            ServantEquipFramePurchaseConfirmMenu_CallbackFunc___ctor(
              v16,
              (Il2CppObject *)this,
...
LABEL_27:
      ...
      v22 = (ServantEquipFramePurchaseConfirmMenu_CallbackFunc_o *)sub_1C2D6DC(ServantEquipFramePurchaseConfirmMenu_CallbackFunc_TypeInfo);
      ServantEquipFramePurchaseConfirmMenu_CallbackFunc___ctor(
        v22,
        (Il2CppObject *)this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21452 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_ServantEquipFramePurchaseMenu_EndRequestServantEquipFramePurchase__);
    byte_4C21452 = 1;
  }
...
LABEL_15:
  ...
  switch ( result )
  {
    ...
    case 4:
      ...
      purchaseConfirmMenu = this->fields.purchaseConfirmMenu;
      stoneShopEntity = this->fields.stoneShopEntity;
      v10 = (ServantEquipFramePurchaseConfirmMenu_CallbackFunc_o *)sub_1C2D6DC(ServantEquipFramePurchaseConfirmMenu_CallbackFunc_TypeInfo);
      ServantEquipFramePurchaseConfirmMenu_CallbackFunc___ctor(
        v10,
        (Il2CppObject *)this,
        Method_ServantEquipFramePurchaseMenu_EndBuyStoneConfirm__,
        ...
        const MethodInfo *method)
{
  ...
  v11 = (ServantEquipFramePurchaseMenu_o *)sub_1C2D9AC(v8);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1A69210;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A691C8;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21455 & 1) == 0 )
  {
    sub_1C2D490(&ServantEquipFramePurchaseMenu_Result_TypeInfo);
    byte_4C21455 = 1;
  }
  v9[1] = 0;
