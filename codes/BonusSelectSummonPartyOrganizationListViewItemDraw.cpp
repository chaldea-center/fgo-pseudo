        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB0CD7 & 1) == 0 )
  {
    sub_1C13D24(&string_TypeInfo, classIconId);
    sub_1C13D24(&StringLiteral_16816/*"_keyPairExported"*/, v8);
    sub_1C13D24(&StringLiteral_20444/*"icon_class_off006"*/, v9);
    sub_1C13D24(&StringLiteral_16814/*"_keyPairArray"*/, v10);
    byte_4BB0CD7 = 1;
  }
  if ( System_String__IsNullOrEmpty(classIconId, 0LL) )
    return string_TypeInfo->static_fields->Empty;
  v12 = StringLiteral_20444/*"icon_class_off006"*/;
  if ( isUpper )
  {
    v13 = (System_String_o **)&StringLiteral_16816/*"_keyPairExported"*/;
    if ( !isUpperOn )
      v13 = (System_String_o **)&StringLiteral_16814/*"_keyPairArray"*/;
    v14 = (Il2CppObject *)System_String__Format(*v13, (Il2CppObject *)classIconId, 0LL);
    v15 = (System_String_o *)v12;
  }
  else
  {
    v15 = (System_String_o *)StringLiteral_20444/*"icon_class_off006"*/;
...
LABEL_16:
    sub_1C13F80(restrictionClassSprite, item);
  }
LABEL_14:
  restrictionClassSprite = (UnityEngine_Component_o *)this->fields.restrictionClassSprite;
  if ( !restrictionClassSprite )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB0CD5 & 1) == 0 )
  {
    this = (BonusSelectSummonPartyOrganizationListViewItemDraw_o *)sub_1C13D24(&AtlasManager_TypeInfo, item);
    byte_4BB0CD5 = 1;
  }
  if ( !item )
    goto LABEL_12;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB0CD3 & 1) == 0 )
  {
    ...
    sub_1C13D24(&Rarity_TypeInfo, v6);
    sub_1C13D24(&StringLiteral_17435/*"beginMethod"*/, v7);
    this = (BonusSelectSummonPartyOrganizationListViewItemDraw_o *)sub_1C13D24(&StringLiteral_17621/*"blue"*/, v8);
    byte_4BB0CD3 = 1;
  }
  tdInfo = 0LL;
  if ( !item )
...
LABEL_26:
  ...
  if ( !treasureDeviceIconLabel )
    goto LABEL_26;
  UIIconLabel__Set_39380320(treasureDeviceIconLabel, 33, tdLevel, (int32_t)this, 0, 0LL, 0, 0, 0, 0LL);
LABEL_23:
  treasureDeviceIconBg = v4->fields.treasureDeviceIconBg;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetPartyOrganizationImage(treasureDeviceIconBg, (System_String_o *)StringLiteral_17435/*"beginMethod"*/, 0LL);
  ...
  v34 = System_String__Format((System_String_o *)StringLiteral_17621/*"blue"*/, v33, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( !servantNarrowTexture )
LABEL_12:
    sub_1C13F80(servantNarrowTexture, item);
