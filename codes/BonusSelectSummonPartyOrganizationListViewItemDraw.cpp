        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A578D6 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_16562/*"_on{0}"*/);
    sub_1B885B0(&StringLiteral_20124/*"icon_class{0}"*/);
    sub_1B885B0(&StringLiteral_16560/*"_off{0}"*/);
    byte_4A578D6 = 1;
  }
  if ( System_String__IsNullOrEmpty(classIconId, 0LL) )
    return string_TypeInfo->static_fields->Empty;
  v9 = StringLiteral_20124/*"icon_class{0}"*/;
  if ( isUpper )
  {
    v10 = (System_String_o **)&StringLiteral_16562/*"_on{0}"*/;
    if ( !isUpperOn )
      v10 = (System_String_o **)&StringLiteral_16560/*"_off{0}"*/;
    v11 = (Il2CppObject *)System_String__Format(*v10, (Il2CppObject *)classIconId, 0LL);
    v12 = (System_String_o *)v9;
  }
  else
  {
    v12 = (System_String_o *)StringLiteral_20124/*"icon_class{0}"*/;
...
LABEL_16:
    sub_1B8880C(restrictionClassSprite, item);
  }
LABEL_14:
  restrictionClassSprite = (UnityEngine_Component_o *)this->fields.restrictionClassSprite;
  if ( !restrictionClassSprite )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A578D4 & 1) == 0 )
  {
    this = (BonusSelectSummonPartyOrganizationListViewItemDraw_o *)sub_1B885B0(&AtlasManager_TypeInfo);
    byte_4A578D4 = 1;
  }
  if ( !item )
    goto LABEL_12;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A578D2 & 1) == 0 )
  {
    ...
    this = (BonusSelectSummonPartyOrganizationListViewItemDraw_o *)sub_1B885B0(&StringLiteral_17362/*"bonus_select_frame_{0}"*/);
    byte_4A578D2 = 1;
  }
  tdInfo = 0LL;
  if ( !item )
...
LABEL_26:
  ...
  if ( !treasureDeviceIconLabel )
    goto LABEL_26;
  UIIconLabel__Set_38235604(treasureDeviceIconLabel, 33, tdLevel, (int32_t)this, 0, 0LL, 0, 0, 0, 0LL);
LABEL_23:
  treasureDeviceIconBg = v4->fields.treasureDeviceIconBg;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetPartyOrganizationImage(treasureDeviceIconBg, (System_String_o *)StringLiteral_17172/*"bg_white"*/, 0LL);
  ...
  v30 = System_String__Format((System_String_o *)StringLiteral_17362/*"bonus_select_frame_{0}"*/, v29, 0LL);
  AtlasManager__SetEventSprite(base2Sprite, v30, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !servantNarrowTexture )
LABEL_12:
    sub_1B8880C(servantNarrowTexture, item);
