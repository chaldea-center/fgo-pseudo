        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A6CB & 1) == 0 )
  {
    sub_1B761C0(&string_TypeInfo, classIconId);
    sub_1B761C0(&StringLiteral_16556/*"_on{0}"*/, v8);
    sub_1B761C0(&StringLiteral_20117/*"icon_class{0}"*/, v9);
    sub_1B761C0(&StringLiteral_16554/*"_off{0}"*/, v10);
    byte_4A2A6CB = 1;
  }
  if ( System_String__IsNullOrEmpty(classIconId, 0LL) )
    return string_TypeInfo->static_fields->Empty;
  v12 = StringLiteral_20117/*"icon_class{0}"*/;
  if ( isUpper )
  {
    v13 = (System_String_o **)&StringLiteral_16556/*"_on{0}"*/;
    if ( !isUpperOn )
      v13 = (System_String_o **)&StringLiteral_16554/*"_off{0}"*/;
    v14 = (Il2CppObject *)System_String__Format(*v13, (Il2CppObject *)classIconId, 0LL);
    v15 = (System_String_o *)v12;
  }
  else
  {
    v15 = (System_String_o *)StringLiteral_20117/*"icon_class{0}"*/;
...
LABEL_16:
    sub_1B7641C(restrictionClassSprite, item);
  }
LABEL_14:
  restrictionClassSprite = (UnityEngine_Component_o *)this->fields.restrictionClassSprite;
  if ( !restrictionClassSprite )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A6C9 & 1) == 0 )
  {
    this = (BonusSelectSummonPartyOrganizationListViewItemDraw_o *)sub_1B761C0(&AtlasManager_TypeInfo, item);
    byte_4A2A6C9 = 1;
  }
  if ( !item )
    goto LABEL_12;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A6C7 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Rarity_TypeInfo, v6);
    sub_1B761C0(&StringLiteral_17166/*"bg_white"*/, v7);
    this = (BonusSelectSummonPartyOrganizationListViewItemDraw_o *)sub_1B761C0(&StringLiteral_17356/*"bonus_select_frame_{0}"*/, v8);
    byte_4A2A6C7 = 1;
  }
  tdInfo = 0LL;
  if ( !item )
...
LABEL_26:
  ...
  if ( !treasureDeviceIconLabel )
    goto LABEL_26;
  UIIconLabel__Set_38055956(treasureDeviceIconLabel, 33, tdLevel, (int32_t)this, 0, 0LL, 0, 0, 0, 0LL);
LABEL_23:
  treasureDeviceIconBg = v4->fields.treasureDeviceIconBg;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetPartyOrganizationImage(treasureDeviceIconBg, (System_String_o *)StringLiteral_17166/*"bg_white"*/, 0LL);
  ...
  v34 = System_String__Format((System_String_o *)StringLiteral_17356/*"bonus_select_frame_{0}"*/, v33, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( !servantNarrowTexture )
LABEL_12:
    sub_1B7641C(servantNarrowTexture, item);
