        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFE472 & 1) == 0 )
  {
    sub_1BC3008(&string_TypeInfo, classIconId);
    sub_1BC3008(&StringLiteral_16422/*"_on{0}"*/, v8);
    sub_1BC3008(&StringLiteral_19974/*"icon_class{0}"*/, v9);
    sub_1BC3008(&StringLiteral_16420/*"_off{0}"*/, v10);
    byte_4AFE472 = 1;
  }
  if ( System_String__IsNullOrEmpty(classIconId, 0LL) )
    return string_TypeInfo->static_fields->Empty;
  v12 = StringLiteral_19974/*"icon_class{0}"*/;
  if ( isUpper )
  {
    v13 = (System_String_o **)&StringLiteral_16422/*"_on{0}"*/;
    if ( !isUpperOn )
      v13 = (System_String_o **)&StringLiteral_16420/*"_off{0}"*/;
    v14 = (Il2CppObject *)System_String__Format(*v13, (Il2CppObject *)classIconId, 0LL);
    v15 = (System_String_o *)v12;
  }
  else
  {
    v15 = (System_String_o *)StringLiteral_19974/*"icon_class{0}"*/;
...
LABEL_16:
    sub_1BC3264(restrictionClassSprite, item);
  }
LABEL_14:
  restrictionClassSprite = (UnityEngine_Component_o *)this->fields.restrictionClassSprite;
  if ( !restrictionClassSprite )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFE470 & 1) == 0 )
  {
    this = (BonusSelectSummonPartyOrganizationListViewItemDraw_o *)sub_1BC3008(&AtlasManager_TypeInfo, item);
    byte_4AFE470 = 1;
  }
  if ( !item )
    goto LABEL_12;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFE46E & 1) == 0 )
  {
    ...
    sub_1BC3008(&Rarity_TypeInfo, v6);
    sub_1BC3008(&StringLiteral_16993/*"bg_white"*/, v7);
    this = (BonusSelectSummonPartyOrganizationListViewItemDraw_o *)sub_1BC3008(&StringLiteral_17179/*"bonus_select_frame_{0}"*/, v8);
    byte_4AFE46E = 1;
  }
  tdInfo = 0LL;
  if ( !item )
  ...
  if ( !servantClassIcon )
    goto LABEL_26;
  ServantClassIconComponent__SetImage(servantClassIcon, classId, (int32_t)this, 0, 0, 0, 0LL);
...
LABEL_26:
  ...
  if ( !treasureDeviceIconLabel )
    goto LABEL_26;
  UIIconLabel__Set_40054380(treasureDeviceIconLabel, 33, tdLevel, (int32_t)this, 0, 0LL, 0, 0, 0, 0, 0LL);
LABEL_23:
  treasureDeviceIconBg = v4->fields.treasureDeviceIconBg;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetPartyOrganizationImage(treasureDeviceIconBg, (System_String_o *)StringLiteral_16993/*"bg_white"*/, 0LL);
  baseSprite = v4->fields.baseSprite;
  FrameType = BonusSelectSummonPartyOrganizationListViewItem__get_FrameType(item, v26);
  AtlasManager__SetFormationBase(baseSprite, FrameType, v4->fields.partyOrganizationAtlas, 0, 0, 0LL);
  base2Sprite = v4->fields.base2Sprite;
  v35 = BonusSelectSummonPartyOrganizationListViewItem__get_FrameType(item, v29);
  v33 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v35, v30, v31, v32);
  v34 = System_String__Format((System_String_o *)StringLiteral_17179/*"bonus_select_frame_{0}"*/, v33, 0LL);
  AtlasManager__SetEventSprite(base2Sprite, v34, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetFormationBase(baseSprite, 9, partyOrganizationAtlas, 0, 0, 0LL);
  servantNarrowTexture = (UINarrowFigureTexture_o *)this->fields.base2Sprite;
  if ( !servantNarrowTexture )
LABEL_12:
    sub_1BC3264(servantNarrowTexture, item);
