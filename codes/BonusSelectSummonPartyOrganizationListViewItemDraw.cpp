        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC37F4 & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_16572/*"_on{0}"*/);
    sub_1C713B0(&StringLiteral_20244/*"icon_class{0}"*/);
    sub_1C713B0(&StringLiteral_16570/*"_off{0}"*/);
    byte_4CC37F4 = 1;
  }
  if ( System_String__IsNullOrEmpty(classIconId, 0) )
    return string_TypeInfo->static_fields->Empty;
  v9 = StringLiteral_20244/*"icon_class{0}"*/;
  if ( isUpper )
  {
    v10 = (System_String_o **)&StringLiteral_16572/*"_on{0}"*/;
    if ( !isUpperOn )
      v10 = (System_String_o **)&StringLiteral_16570/*"_off{0}"*/;
    v11 = (Il2CppObject *)System_String__Format(*v10, (Il2CppObject *)classIconId, 0);
    v12 = (System_String_o *)v9;
  }
  else
  {
    v12 = (System_String_o *)StringLiteral_20244/*"icon_class{0}"*/;
...
LABEL_16:
    sub_1C71608(restrictionClassSprite, item);
  }
LABEL_14:
  restrictionClassSprite = (UnityEngine_Component_o *)this->fields.restrictionClassSprite;
  if ( !restrictionClassSprite )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC37F2 & 1) == 0 )
  {
    this = (BonusSelectSummonPartyOrganizationListViewItemDraw_o *)sub_1C713B0(&AtlasManager_TypeInfo);
    byte_4CC37F2 = 1;
  }
  if ( !item )
    goto LABEL_12;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC37F0 & 1) == 0 )
  {
    ...
    this = (BonusSelectSummonPartyOrganizationListViewItemDraw_o *)sub_1C713B0(&StringLiteral_17351/*"bonus_select_frame_{0}"*/);
    byte_4CC37F0 = 1;
  }
  tdInfo = 0;
  if ( !item )
...
LABEL_26:
  ...
  if ( !treasureDeviceIconLabel )
    goto LABEL_26;
  UIIconLabel__Set_41387288(treasureDeviceIconLabel, 33, tdLevel, (int32_t)this, 0, 0, 0, 0, 0, 0, 0);
LABEL_23:
  treasureDeviceIconBg = v4->fields.treasureDeviceIconBg;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetPartyOrganizationImage(treasureDeviceIconBg, (System_String_o *)StringLiteral_17165/*"bg_white"*/, 0);
  ...
  v27 = System_String__Format((System_String_o *)StringLiteral_17351/*"bonus_select_frame_{0}"*/, v26, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( !servantNarrowTexture )
LABEL_12:
    sub_1C71608(servantNarrowTexture, item);
