void __fastcall UserEventPointMaster___ctor(UserEventPointMaster_o *this, const MethodInfo *method)
{
  if ( (byte_48E3400 & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataMasterBase_UserEventPointMaster__UserEventPointEntity__string___ctor__, method);
    byte_48E3400 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    153,
    (const MethodInfo_2FE6D64 *)Method_DataMasterBase_UserEventPointMaster__UserEventPointEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E33FE & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataMasterBase_UserEventPointMaster__UserEventPointEntity__string__GetEntity__, userId);
    byte_48E33FE = 1;
  }
  ...
  return (UserEventPointEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                     (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                     PK,
                                     (const MethodInfo_2FE6DA4 *)Method_DataMasterBase_UserEventPointMaster__UserEventPointEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3401 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&UserEventPointEntity_TypeInfo, v9);
    byte_48E3401 = 1;
  }
...
LABEL_8:
  ...
  {
    v23 = (UserEventPointEntity_o *)sub_1B00F18(UserEventPointEntity_TypeInfo);
    UserEventPointEntity___ctor_38818168(v23, userId, eventId, groupId, v24);
    return v23;
  }
  lookup = DataMasterBase__get_lookup((DataMasterBase_o *)this, 0LL);
  if ( !lookup )
LABEL_25:
    sub_1B00F28(lookup, v12);
  v18 = lookup->klass;
  v19 = lookup;
  ...
  {
LABEL_16:
    v22 = sub_1B52CAC(lookup, System_Collections_Generic_IReadOnlyDictionary_string__DataEntityBase__TypeInfo, 2LL);
  }
...
int64_t __fastcall UserEventPointMaster__GetEventActivityPoint(int32_t eventId, const MethodInfo *method)
{
  ...
  if ( (byte_48E3405 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_DataManager_GetMasterData_UserEventPointMaster___, v3);
...
LABEL_12:
  ...
  return System_Math__Min_61144596(v13, UserEventActivityPointMax, 0LL);
}
...
int64_t __fastcall UserEventPointMaster__GetEventPoint(int32_t eventId, int32_t groupId, const MethodInfo *method)
{
  ...
  if ( (byte_48E3404 & 1) == 0 )
  {
    sub_1B00CCC(&BalanceConfig_TypeInfo, *(_QWORD *)&groupId);
...
LABEL_12:
  ...
  if ( !System_Math_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
  return System_Math__Min_61144596(v15, UserPointEventMax, 0LL);
}
...
LABEL_12:
  ...
  if ( !System_Math_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
  return System_Math__Min_61144596(v13, UserPointEventMax, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3402 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Item__, v10);
    sub_1B00CCC(&System_Math_TypeInfo, v11);
    sub_1B00CCC(&UserEventPointEntity_TypeInfo, v12);
    byte_48E3402 = 1;
  }
...
LABEL_18:
        ...
        if ( v21 && v20 )
        {
          ...
          if ( !System_Math_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
          v16 += System_Math__Min_61144596(monitor, UserPointEventMax, 0LL);
        }
      }
      if ( v15 == ++v17 )
        return v16;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E33FF & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataMasterBase_UserEventPointMaster__UserEventPointEntity__string__TryGetEntity__, entity);
    byte_48E33FF = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_2FE6DF4 *)Method_DataMasterBase_UserEventPointMaster__UserEventPointEntity__string__TryGetEntity__);
}