...
void OverwriteBattleBgmData___ctor_48111864(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7A745 & 1) == 0 )
  {
    sub_1D0F0B4(&OverwriteBattleBgmData_SaveData_TypeInfo);
    byte_4E7A745 = 1;
  }
  if ( !bgmData )
    return 0;
  v3 = (OverwriteBattleBgmData_SaveData_o *)sub_1D0F300(OverwriteBattleBgmData_SaveData_TypeInfo);
  OverwriteBattleBgmData_SaveData___ctor_48112620(v3, bgmData, v4);
  return v3;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7A744 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_DataManager_GetMaster_BgmMaster___);
    sub_1D0F0B4(&DataManager_TypeInfo);
    sub_1D0F0B4(&OverwriteBattleBgmData_TypeInfo);
    sub_1D0F0B4(&StringLiteral_1/*""*/);
    byte_4E7A744 = 1;
  }
  if ( !sv )
    return 0;
  v3 = sub_1D0F300(OverwriteBattleBgmData_TypeInfo);
  ...
  if ( *(int *)(v3 + 20) >= 1 && System_String__IsNullOrEmpty(*(System_String_o **)(v3 + 24), 0) )
  {
    ...
    if ( Master_object )
    {
      ...
      *(_QWORD *)(v3 + 24) = BgmFileName;
      sub_1D0F058((GrandQuestFolderBoardItem_o *)(v3 + 24), (int32_t)BgmFileName, v14, v15, v16, v17, v18, v19);
...
void OverwriteBattleBgmData_SaveData___ctor_48112620(
        ...
        const MethodInfo *method)
{
  ...
  System_Object___ctor((Il2CppObject *)this, 0);
  v5 = sub_1D0F15C(int___TypeInfo, 3);
  if ( !bgmData )
    goto LABEL_12;
  v6 = v5;
  if ( !v5 )
...
LABEL_11:
  ...
  *(_DWORD *)(v5 + 40) = bgmData->fields.allowSubBgmPlayingRawValue;
  ...
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields, v5, v7, v8, v9, v10, v11, v12);
...
LABEL_12:
  ...
  *(_QWORD *)(v5 + 32) = BgmName_k__BackingField;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)(v5 + 32), (int32_t)BgmName_k__BackingField, v14, v15, v16, v17, v18, v19);
  this->fields.strParamArray = v20;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.strParamArray, (int32_t)v20, v22, v23, v24, v25, v26, v27);
}


void OverwriteBattleBgmData_SaveData___ctor_48113064(
        OverwriteBattleBgmData_SaveData_o *this,
        ...
        const MethodInfo *method)
{
  ...
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields, (int32_t)overrideBgmData, v7, v8, v9, v10, v11, v12);
