...
void __fastcall OverwriteBattleBgmData___ctor_44037512(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BDAFA & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataManager_GetMaster_BgmMaster___, *(_QWORD *)&waveCount);
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields._BgmName_k__BackingField, (int32_t)bgmName, v13, v14);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BDAFC & 1) == 0 )
  {
    sub_1B4CF90(&OverwriteBattleBgmData_SaveData_TypeInfo, method);
    byte_49BDAFC = 1;
  }
  if ( !bgmData )
    return 0LL;
  v3 = (OverwriteBattleBgmData_SaveData_o *)sub_1B4D1DC(OverwriteBattleBgmData_SaveData_TypeInfo);
  OverwriteBattleBgmData_SaveData___ctor_44038268(v3, bgmData, v4);
  return v3;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BDAFB & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_BasicHelper_IndexValue_string___, v3);
    sub_1B4CF90(&Method_DataManager_GetMaster_BgmMaster___, v4);
    sub_1B4CF90(&DataManager_TypeInfo, v5);
    sub_1B4CF90(&OverwriteBattleBgmData_TypeInfo, v6);
    sub_1B4CF90(&StringLiteral_1/*""*/, v7);
    byte_49BDAFB = 1;
  }
  if ( !sv )
    return 0LL;
  v8 = sub_1B4D1DC(OverwriteBattleBgmData_TypeInfo);
  ...
  *(_QWORD *)(v8 + 24) = v11;
  sub_1B4CF34((CGThumbnailListItem_o *)(v8 + 24), (int32_t)v11, v12, v13);
  if ( *(int *)(v8 + 20) >= 1 && System_String__IsNullOrEmpty(*(System_String_o **)(v8 + 24), 0LL) )
  {
    ...
    if ( Master_object )
    {
      ...
      *(_QWORD *)(v8 + 24) = BgmFileName;
      sub_1B4CF34((CGThumbnailListItem_o *)(v8 + 24), (int32_t)BgmFileName, v15, v16);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields._BgmName_k__BackingField, (int32_t)value, (int32_t)method, v3);
}
...
void __fastcall OverwriteBattleBgmData_SaveData___ctor_44038268(
        OverwriteBattleBgmData_SaveData_o *this,
        OverwriteBattleBgmData_o *bgmData,
        const MethodInfo *method)
{
  ...
  if ( (byte_49BDAFD & 1) == 0 )
  {
    sub_1B4CF90(&int___TypeInfo, bgmData);
    sub_1B4CF90(&string___TypeInfo, v5);
    byte_49BDAFD = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
  v6 = sub_1B4D038(int___TypeInfo, 3LL);
  if ( !bgmData )
    goto LABEL_12;
  v7 = v6;
  if ( !v6 )
...
LABEL_11:
  ...
  *(_DWORD *)(v6 + 40) = bgmData->fields.allowSubBgmPlayingRawValue;
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields, v6, v8, v9);
  v6 = sub_1B4D038(string___TypeInfo, 1LL);
  if ( !v6 )
LABEL_12:
    sub_1B4D1EC(v6, v7);
  ...
  *(_QWORD *)(v6 + 32) = BgmName_k__BackingField;
  sub_1B4CF34((CGThumbnailListItem_o *)(v6 + 32), (int32_t)BgmName_k__BackingField, v11, v12);
  this->fields.strParamArray = v13;
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.strParamArray, (int32_t)v13, v15, v16);
}


void __fastcall OverwriteBattleBgmData_SaveData___ctor_44038532(
        OverwriteBattleBgmData_SaveData_o *this,
        ...
        const MethodInfo *method)
{
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields, (int32_t)overrideBgmData, v7, v8);
  overrideStrBgmData = sv->fields.overrideStrBgmData;
  this->fields.strParamArray = overrideStrBgmData;
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.strParamArray, (int32_t)overrideStrBgmData, v11, v12);
}