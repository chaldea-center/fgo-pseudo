...
void OverwriteBattleBgmData___ctor_46355724(
        ...
        const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields._BgmName_k__BackingField, (int32_t)bgmName, v11, v12);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2A1D7 & 1) == 0 )
  {
    sub_1C2D490(&OverwriteBattleBgmData_SaveData_TypeInfo);
    byte_4C2A1D7 = 1;
  }
  if ( !bgmData )
    return 0;
  v3 = (OverwriteBattleBgmData_SaveData_o *)sub_1C2D6DC(OverwriteBattleBgmData_SaveData_TypeInfo);
  OverwriteBattleBgmData_SaveData___ctor_46356480(v3, bgmData, v4);
  return v3;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2A1D6 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_DataManager_GetMaster_BgmMaster___);
    sub_1C2D490(&DataManager_TypeInfo);
    sub_1C2D490(&OverwriteBattleBgmData_TypeInfo);
    sub_1C2D490(&StringLiteral_1/*""*/);
    byte_4C2A1D6 = 1;
  }
  if ( !sv )
    return 0;
  v3 = sub_1C2D6DC(OverwriteBattleBgmData_TypeInfo);
  ...
  if ( *(int *)(v3 + 20) >= 1 && System_String__IsNullOrEmpty(*(System_String_o **)(v3 + 24), 0) )
  {
    ...
    if ( Master_object )
    {
      ...
      *(_QWORD *)(v3 + 24) = BgmFileName;
      sub_1C2D434((CGThumbnailListItem_o *)(v3 + 24), (int32_t)BgmFileName, v10, v11);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields._BgmName_k__BackingField, (int32_t)value, (int32_t)method, v3);
}
...
void OverwriteBattleBgmData_SaveData___ctor_46356480(
        ...
        const MethodInfo *method)
{
  ...
  System_Object___ctor((Il2CppObject *)this, 0);
  v5 = sub_1C2D538(int___TypeInfo, 3);
  if ( !bgmData )
    goto LABEL_12;
  v6 = v5;
  if ( !v5 )
...
LABEL_11:
  ...
  *(_DWORD *)(v5 + 40) = bgmData->fields.allowSubBgmPlayingRawValue;
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields, v5, v7, v8);
...
LABEL_12:
  ...
  *(_QWORD *)(v5 + 32) = BgmName_k__BackingField;
  sub_1C2D434((CGThumbnailListItem_o *)(v5 + 32), (int32_t)BgmName_k__BackingField, v7, v10);
  this->fields.strParamArray = v11;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.strParamArray, (int32_t)v11, v13, v14);
}


void OverwriteBattleBgmData_SaveData___ctor_46356744(
        OverwriteBattleBgmData_SaveData_o *this,
        ...
        const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields, (int32_t)overrideBgmData, v7, v8);
  overrideStrBgmData = sv->fields.overrideStrBgmData;
  this->fields.strParamArray = overrideStrBgmData;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.strParamArray, (int32_t)overrideStrBgmData, v11, v12);
}