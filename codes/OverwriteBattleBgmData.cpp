...
void OverwriteBattleBgmData___ctor_46497288(
        ...
        const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields._BgmName_k__BackingField, (int32_t)bgmName, v11, v12);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3A8EA & 1) == 0 )
  {
    sub_1C32C20(&OverwriteBattleBgmData_SaveData_TypeInfo);
    byte_4C3A8EA = 1;
  }
  if ( !bgmData )
    return 0;
  v3 = (OverwriteBattleBgmData_SaveData_o *)sub_1C32E6C(OverwriteBattleBgmData_SaveData_TypeInfo);
  OverwriteBattleBgmData_SaveData___ctor_46498044(v3, bgmData, v4);
  return v3;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3A8E9 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_DataManager_GetMaster_BgmMaster___);
    sub_1C32C20(&DataManager_TypeInfo);
    sub_1C32C20(&OverwriteBattleBgmData_TypeInfo);
    sub_1C32C20(&StringLiteral_1/*""*/);
    byte_4C3A8E9 = 1;
  }
  if ( !sv )
    return 0;
  v3 = sub_1C32E6C(OverwriteBattleBgmData_TypeInfo);
  ...
  if ( *(int *)(v3 + 20) >= 1 && System_String__IsNullOrEmpty(*(System_String_o **)(v3 + 24), 0) )
  {
    ...
    if ( Master_object )
    {
      ...
      *(_QWORD *)(v3 + 24) = BgmFileName;
      sub_1C32BC4((CGThumbnailListItem_o *)(v3 + 24), (int32_t)BgmFileName, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields._BgmName_k__BackingField, (int32_t)value, (int32_t)method, v3);
}
...
void OverwriteBattleBgmData_SaveData___ctor_46498044(
        ...
        const MethodInfo *method)
{
  ...
  System_Object___ctor((Il2CppObject *)this, 0);
  v5 = sub_1C32CC8(int___TypeInfo, 3);
  if ( !bgmData || !v5 )
    goto LABEL_12;
  v8 = *(_DWORD *)(v5 + 24);
  if ( !v8
...
LABEL_11:
  ...
  *(_DWORD *)(v5 + 40) = bgmData->fields.allowSubBgmPlayingRawValue;
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields, v5, v6, v7);
...
LABEL_12:
  ...
  *(_QWORD *)(v5 + 32) = BgmName_k__BackingField;
  sub_1C32BC4((CGThumbnailListItem_o *)(v5 + 32), (int32_t)BgmName_k__BackingField, v9, v10);
  this->fields.strParamArray = v11;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.strParamArray, (int32_t)v11, v13, v14);
}


void OverwriteBattleBgmData_SaveData___ctor_46498308(
        OverwriteBattleBgmData_SaveData_o *this,
        ...
        const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields, (int32_t)overrideBgmData, v6, v7);
  overrideStrBgmData = sv->fields.overrideStrBgmData;
  this->fields.strParamArray = overrideStrBgmData;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.strParamArray, (int32_t)overrideStrBgmData, v10, v11);
}