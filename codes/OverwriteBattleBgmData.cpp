...
void __fastcall OverwriteBattleBgmData___ctor_42942384(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0B5E6 & 1) == 0 )
  {
    sub_1B686D4(&Method_DataManager_GetMaster_BgmMaster___, *(_QWORD *)&waveCount);
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields._BgmName_k__BackingField, (int32_t)bgmName, v13, v14);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0B5E8 & 1) == 0 )
  {
    sub_1B686D4(&OverwriteBattleBgmData_SaveData_TypeInfo, method);
    byte_4A0B5E8 = 1;
  }
  if ( !bgmData )
    return 0LL;
  v3 = (OverwriteBattleBgmData_SaveData_o *)sub_1B68920(OverwriteBattleBgmData_SaveData_TypeInfo);
  OverwriteBattleBgmData_SaveData___ctor_42943140(v3, bgmData, v4);
  return v3;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0B5E7 & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_BasicHelper_IndexValue_string___, v3);
    sub_1B686D4(&Method_DataManager_GetMaster_BgmMaster___, v4);
    sub_1B686D4(&DataManager_TypeInfo, v5);
    sub_1B686D4(&OverwriteBattleBgmData_TypeInfo, v6);
    sub_1B686D4(&StringLiteral_1/*""*/, v7);
    byte_4A0B5E7 = 1;
  }
  if ( !sv )
    return 0LL;
  v8 = sub_1B68920(OverwriteBattleBgmData_TypeInfo);
  ...
  *(_QWORD *)(v8 + 24) = v11;
  sub_1B68678((ServantStatusBattleListViewItem_o *)(v8 + 24), (int32_t)v11, v12, v13);
  if ( *(int *)(v8 + 20) >= 1 && System_String__IsNullOrEmpty(*(System_String_o **)(v8 + 24), 0LL) )
  {
    ...
    if ( Master_object )
    {
      ...
      *(_QWORD *)(v8 + 24) = BgmFileName;
      sub_1B68678((ServantStatusBattleListViewItem_o *)(v8 + 24), (int32_t)BgmFileName, v15, v16);
...
void __fastcall OverwriteBattleBgmData_SaveData___ctor_42943140(
        OverwriteBattleBgmData_SaveData_o *this,
        OverwriteBattleBgmData_o *bgmData,
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0B5E9 & 1) == 0 )
  {
    sub_1B686D4(&int___TypeInfo, bgmData);
    sub_1B686D4(&string___TypeInfo, v5);
    byte_4A0B5E9 = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
  v6 = sub_1B6877C(int___TypeInfo, 3LL);
  if ( !bgmData )
    goto LABEL_12;
  v7 = v6;
  if ( !v6 )
...
LABEL_11:
  ...
  *(_DWORD *)(v6 + 40) = bgmData->fields.allowSubBgmPlayingRawValue;
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields, v6, v8, v9);
  v6 = sub_1B6877C(string___TypeInfo, 1LL);
  if ( !v6 )
LABEL_12:
    sub_1B68930(v6, v7);
  ...
  *(_QWORD *)(v6 + 32) = BgmName_k__BackingField;
  sub_1B68678((ServantStatusBattleListViewItem_o *)(v6 + 32), (int32_t)BgmName_k__BackingField, v11, v12);
  this->fields.strParamArray = v13;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.strParamArray, (int32_t)v13, v15, v16);
}


void __fastcall OverwriteBattleBgmData_SaveData___ctor_42943404(
        OverwriteBattleBgmData_SaveData_o *this,
        ...
        const MethodInfo *method)
{
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)overrideBgmData, v7, v8);
  overrideStrBgmData = sv->fields.overrideStrBgmData;
  this->fields.strParamArray = overrideStrBgmData;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.strParamArray, (int32_t)overrideStrBgmData, v11, v12);
}