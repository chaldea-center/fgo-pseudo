...
void OverwriteBattleBgmData___ctor_53664664(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_59738B1 & 1) == 0 )
  {
    sub_2213A60(&OverwriteBattleBgmData_SaveData_TypeInfo);
    byte_59738B1 = 1;
  }
  if ( !bgmData )
    return 0;
  v3 = (OverwriteBattleBgmData_SaveData_o *)sub_2213CCC(OverwriteBattleBgmData_SaveData_TypeInfo);
  OverwriteBattleBgmData_SaveData___ctor_53665432(v3, bgmData, v4);
  return v3;
}
        ...
        const MethodInfo *method)
{
  ...
  const MethodInfo_3814BE4 *v7; // x3
  int32_t v8; // w0
  System_Int32_array *v9; // x8
  const MethodInfo_3814BE4 *v10; // x3
  int32_t v11; // w0
  struct System_String_array *strParamArray; // x8
  Il2CppObject *v13; // x2
  const MethodInfo_3814CA8 *v14; // x3
  Il2CppObject *v15; // x0
  ...
  if ( (byte_59738B0 & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_DataManager_GetMaster_BgmMaster___);
    sub_2213A60(&DataManager_TypeInfo);
    sub_2213A60(&OverwriteBattleBgmData_TypeInfo);
    sub_2213A60(&StringLiteral_1/*""*/);
    byte_59738B0 = 1;
  }
  if ( !sv )
    return 0;
  v3 = sub_2213CCC(OverwriteBattleBgmData_TypeInfo);
  ...
  if ( *(int *)(v3 + 20) >= 1 && System_String__IsNullOrEmpty(*(System_String_o **)(v3 + 24), 0) )
  {
    ...
    if ( Master_object )
    {
      ...
      *(_QWORD *)(v3 + 24) = BgmFileName;
      sub_2213A04((MissionNaviTransitionBoardItem_o *)(v3 + 24), (int32_t)BgmFileName, v24, v25, v26, v27, v28, v29);
...
void OverwriteBattleBgmData_SaveData___ctor_53665432(
        ...
        const MethodInfo *method)
{
  ...
  System_Object___ctor((Il2CppObject *)this, 0);
  v5 = sub_2213B20(int___TypeInfo, 3);
  if ( !bgmData )
    goto LABEL_12;
  v6 = v5;
  if ( !v5 )
...
LABEL_11:
  ...
  *(_DWORD *)(v5 + 40) = allowSubBgmPlayingRawValue;
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields, v5, v7, v8, v9, v10, v11, v12);
...
void OverwriteBattleBgmData_SaveData___ctor_53665876(
        OverwriteBattleBgmData_SaveData_o *this,
        ...
        const MethodInfo *method)
{
  ...
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields, (int32_t)overrideBgmData, v7, v8, v9, v10, v11, v12);
