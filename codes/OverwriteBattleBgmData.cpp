...
void __fastcall OverwriteBattleBgmData___ctor_23692600(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_438A34A & 1) == 0 )
  {
    sub_B775C4(&OverwriteBattleBgmData_SaveData_TypeInfo);
    byte_438A34A = 1;
  }
  if ( !bgmData )
    return 0LL;
  v3 = (OverwriteBattleBgmData_SaveData_o *)sub_B77694(OverwriteBattleBgmData_SaveData_TypeInfo);
  OverwriteBattleBgmData_SaveData___ctor_23447672(v3, bgmData, 0LL);
  return v3;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_438A349 & 1) == 0 )
  {
    ...
    sub_B775C4(&Method_DataManager_GetMaster_BgmMaster___);
    sub_B775C4(&DataManager_TypeInfo);
    sub_B775C4(&OverwriteBattleBgmData_TypeInfo);
    sub_B775C4(&StringLiteral_1/*""*/);
    byte_438A349 = 1;
  }
  if ( !sv )
    return 0LL;
  v3 = sub_B77694(OverwriteBattleBgmData_TypeInfo);
  ...
  if ( *(int *)(v3 + 20) >= 1 && System_String__IsNullOrEmpty(*(System_String_o **)(v3 + 24), 0LL) )
  {
    ...
    if ( Master_WarQuestSelectionMaster )
    {
      ...
      *(_QWORD *)(v3 + 24) = BgmFileName;
      sub_B77560((BattleServantConfConponent_o *)(v3 + 24), BgmFileName, v14, v15, v16, v17, v18, v19);
...
void __fastcall OverwriteBattleBgmData_SaveData___ctor_23447672(
        OverwriteBattleBgmData_SaveData_o *this,
        OverwriteBattleBgmData_o *bgmData,
        const MethodInfo *method)
{
  ...
  System_Object___ctor((Il2CppObject *)this, 0LL);
  v5 = (struct System_Int32_array *)sub_B775DC(int___TypeInfo, 3LL);
  if ( !bgmData )
    goto LABEL_14;
  v6 = v5;
  if ( !v5 )
  ...
  v5 = (struct System_Int32_array *)sub_B775DC(string___TypeInfo, 1LL);
  if ( !v5 )
LABEL_14:
    sub_B7769C(v5, v6);
  ...
  {
    v5 = (struct System_Int32_array *)sub_B77684(BgmName_k__BackingField, v5->obj.klass->_1.element_class);
    if ( !v5 )
    {
      v29 = sub_B776BC(0LL);
      sub_B77668(v29, 0LL);
...
LABEL_13:
  ...
  *(_QWORD *)&v21->m_Items[1] = BgmName_k__BackingField;
  sub_B77560((BattleServantConfConponent_o *)&v21->m_Items[1], BgmName_k__BackingField, v14, v15, v16, v17, v18, v19);
...
void __fastcall OverwriteBattleBgmData_SaveData___ctor_23447980(
        OverwriteBattleBgmData_SaveData_o *this,
        ...
        const MethodInfo *method)
{
  ...
  sub_B77560((BattleServantConfConponent_o *)&p_fields->strParamArray, overrideStrBgmData, v16, v17, v18, v19, v20, v21);
}