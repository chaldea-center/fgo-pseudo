...
void __fastcall OverwriteBattleBgmData___ctor_42864968(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FED69 & 1) == 0 )
  {
    sub_1B640C8(&Method_DataManager_GetMaster_BgmMaster___, *(_QWORD *)&waveCount);
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields._BgmName_k__BackingField, (int32_t)bgmName, v13, v14);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FED6B & 1) == 0 )
  {
    sub_1B640C8(&OverwriteBattleBgmData_SaveData_TypeInfo, method);
    byte_49FED6B = 1;
  }
  if ( !bgmData )
    return 0LL;
  v4 = (OverwriteBattleBgmData_SaveData_o *)sub_1B64314(OverwriteBattleBgmData_SaveData_TypeInfo, method, v2);
  OverwriteBattleBgmData_SaveData___ctor_42865724(v4, bgmData, v5);
  return v4;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FED6A & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_BasicHelper_IndexValue_string___, v4);
    sub_1B640C8(&Method_DataManager_GetMaster_BgmMaster___, v5);
    sub_1B640C8(&DataManager_TypeInfo, v6);
    sub_1B640C8(&OverwriteBattleBgmData_TypeInfo, v7);
    sub_1B640C8(&StringLiteral_1/*""*/, v8);
    byte_49FED6A = 1;
  }
  if ( !sv )
    return 0LL;
  v9 = sub_1B64314(OverwriteBattleBgmData_TypeInfo, method, v2);
  ...
  if ( !v9 )
    goto LABEL_13;
  *(_DWORD *)(v9 + 16) = (_DWORD)Master_object;
  ...
  *(_QWORD *)(v9 + 24) = v11;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)(v9 + 24), (int32_t)v11, v12, v13);
  if ( *(int *)(v9 + 20) >= 1 && System_String__IsNullOrEmpty(*(System_String_o **)(v9 + 24), 0LL) )
  {
    ...
    if ( Master_object )
    {
      ...
      *(_QWORD *)(v9 + 24) = BgmFileName;
      sub_1B6406C((ServantStatusBattleListViewItem_o *)(v9 + 24), (int32_t)BgmFileName, v15, v16);
...
void __fastcall OverwriteBattleBgmData_SaveData___ctor_42865724(
        OverwriteBattleBgmData_SaveData_o *this,
        OverwriteBattleBgmData_o *bgmData,
        const MethodInfo *method)
{
  ...
  if ( (byte_49FED6C & 1) == 0 )
  {
    sub_1B640C8(&int___TypeInfo, bgmData);
    sub_1B640C8(&string___TypeInfo, v5);
    byte_49FED6C = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
  v6 = sub_1B64170(int___TypeInfo, 3LL);
  if ( !bgmData )
    goto LABEL_12;
  v9 = v6;
  if ( !v6 )
...
LABEL_11:
  ...
  *(_DWORD *)(v6 + 40) = bgmData->fields.allowSubBgmPlayingRawValue;
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields, v6, v7, v8);
  v6 = sub_1B64170(string___TypeInfo, 1LL);
  if ( !v6 )
LABEL_12:
    sub_1B64324(v6);
  ...
  *(_QWORD *)(v6 + 32) = BgmName_k__BackingField;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)(v6 + 32), (int32_t)BgmName_k__BackingField, v11, v12);
  this->fields.strParamArray = v13;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.strParamArray, (int32_t)v13, v15, v16);
}


void __fastcall OverwriteBattleBgmData_SaveData___ctor_42865988(
        OverwriteBattleBgmData_SaveData_o *this,
        ...
        const MethodInfo *method)
{
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)overrideBgmData, v6, v7);
  overrideStrBgmData = sv->fields.overrideStrBgmData;
  this->fields.strParamArray = overrideStrBgmData;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.strParamArray, (int32_t)overrideStrBgmData, v10, v11);
}