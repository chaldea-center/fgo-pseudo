...
void __fastcall CRIMovieControl__Awake(CRIMovieControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C25E52 & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_924/*"--sorted-ascending"*/, method);
    byte_4C25E52 = 1;
  }
  nowTime = this->fields.nowTime;
  if ( !nowTime )
    goto LABEL_11;
  UILabel__set_text(nowTime, (System_String_o *)StringLiteral_924/*"--sorted-ascending"*/, 0LL);
  ...
  if ( !byte_4C1C516 )
  {
    nowTime = (UILabel_o *)sub_1C3B764(&UnityEngine_Vector3_TypeInfo, method);
    byte_4C1C516 = 1;
  }
  if ( !v4 )
LABEL_11:
    sub_1C3B9C0(nowTime, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C25E53 & 1) == 0 )
  {
    sub_1C3B764(&int_TypeInfo, *(_QWORD *)&frame);
    this = (CRIMovieControl_o *)sub_1C3B764(&StringLiteral_25588, v5);
    byte_4C25E53 = 1;
  }
  ...
  return System_String__Format_63382984((System_String_o *)StringLiteral_25588, v11, v15, 0LL);
}
