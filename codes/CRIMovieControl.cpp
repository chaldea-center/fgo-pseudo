...
void CRIMovieControl__Awake(CRIMovieControl_o *this, const MethodInfo *method)
{
  ...
  if ( !byte_4D2A13E )
  {
    nowTime = (UILabel_o *)sub_1C93AD4(&UnityEngine_Vector3_TypeInfo);
    byte_4D2A13E = 1;
  }
  if ( !v4 )
    goto LABEL_22;
...
System_String_o *CRIMovieControl__FrameToTimeString(CRIMovieControl_o *this, int32_t frame, const MethodInfo *method)
{
  ...
  if ( (byte_4D2A99B & 1) == 0 )
  {
    ...
    this = (CRIMovieControl_o *)sub_1C93AD4(&StringLiteral_25500/*"{0}:{1:00}"*/);
    byte_4D2A99B = 1;
  }
  ...
  return System_String__Format_64467032((System_String_o *)StringLiteral_25500/*"{0}:{1:00}"*/, v7, v8, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C93A78(&this->fields.enableControlCallBack, action);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C93A78(&this->fields.endFullScreenAction, action);
}
...
void CRIMovieControl__Update(CRIMovieControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2A998 & 1) == 0 )
  {
    this = (CRIMovieControl_o *)sub_1C93AD4(&UnityEngine_Object_TypeInfo);
    byte_4D2A998 = 1;
  }
