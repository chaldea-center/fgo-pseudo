...
void __fastcall CRIMovieControl__Awake(CRIMovieControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B185D & 1) == 0 )
  {
    sub_B52984(&StringLiteral_783/*"--:--"*/);
    byte_42B185D = 1;
  }
  nowTime = this->fields.nowTime;
  if ( !nowTime )
    goto LABEL_9;
  UILabel__set_text(nowTime, (System_String_o *)StringLiteral_783/*"--:--"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B185E & 1) == 0 )
  {
    ...
    this = (CRIMovieControl_o *)sub_B52984(&StringLiteral_23819/*"{0}:{1:00}"*/);
    byte_42B185E = 1;
  }
  ...
  {
    sub_B52A5C(this, *(_QWORD *)&frame);
  }
  v6 = 1000LL * frame / (unsigned __int64)this->fields.nowTime;
  v11 = (int)v6 / 60;
  v7 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v11);
  v10 = (int)v6 % 60;
  v8 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v10);
  return System_String__Format_44563852((System_String_o *)StringLiteral_23819/*"{0}:{1:00}"*/, v7, v8, 0LL);
}
