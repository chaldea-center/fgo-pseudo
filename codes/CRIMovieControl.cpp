...
void __fastcall CRIMovieControl__Awake(CRIMovieControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6A9C2 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_942/*"--:--"*/, method);
    byte_4B6A9C2 = 1;
  }
  ...
  if ( !byte_4B612E6 )
  {
    nowTime = (UILabel_o *)sub_1BE4ACC(&UnityEngine_Vector3_TypeInfo, method);
    byte_4B612E6 = 1;
  }
  if ( !v4 )
LABEL_11:
    sub_1BE4D28(nowTime, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A9C3 & 1) == 0 )
  {
    sub_1BE4ACC(&int_TypeInfo, *(_QWORD *)&frame);
    this = (CRIMovieControl_o *)sub_1BE4ACC(&StringLiteral_25418/*"{0}:{1:00}"*/, v5);
    byte_4B6A9C3 = 1;
  }
  ...
  return System_String__Format_62713180((System_String_o *)StringLiteral_25418/*"{0}:{1:00}"*/, v11, v15, 0LL);
}
