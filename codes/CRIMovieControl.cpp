...
void __fastcall CRIMovieControl__Awake(CRIMovieControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C01624 & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_924/*"--:--"*/, method);
    byte_4C01624 = 1;
  }
  nowTime = this->fields.nowTime;
  if ( !nowTime )
    goto LABEL_11;
  UILabel__set_text(nowTime, (System_String_o *)StringLiteral_924/*"--:--"*/, 0LL);
  ...
  if ( !byte_4BF7D96 )
  {
    nowTime = (UILabel_o *)sub_1C2E12C(&UnityEngine_Vector3_TypeInfo, method);
    byte_4BF7D96 = 1;
  }
  if ( !v4 )
LABEL_11:
    sub_1C2E388(nowTime, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C01625 & 1) == 0 )
  {
    sub_1C2E12C(&int_TypeInfo, *(_QWORD *)&frame);
    this = (CRIMovieControl_o *)sub_1C2E12C(&StringLiteral_25544/*"{0}:{1:00}"*/, v5);
    byte_4C01625 = 1;
  }
  ...
  return System_String__Format_63249956((System_String_o *)StringLiteral_25544/*"{0}:{1:00}"*/, v11, v15, 0LL);
}
