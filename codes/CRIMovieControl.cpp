...
void __fastcall CRIMovieControl__Awake(CRIMovieControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B0618D & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_881/*"--:--"*/, method);
    byte_4B0618D = 1;
  }
  ...
  if ( !byte_4AFBDB6 )
  {
    nowTime = (UILabel_o *)sub_1BC3008(&UnityEngine_Vector3_TypeInfo, method);
    byte_4AFBDB6 = 1;
  }
  if ( !v4 )
LABEL_11:
    sub_1BC3264(nowTime, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B06190 & 1) == 0 )
  {
    sub_1BC3008(&int_TypeInfo, *(_QWORD *)&frame);
    this = (CRIMovieControl_o *)sub_1BC3008(&StringLiteral_24934/*"{0}:{1:00}"*/, v5);
    byte_4B06190 = 1;
  }
  ...
  return System_String__Format_62389940((System_String_o *)StringLiteral_24934/*"{0}:{1:00}"*/, v11, v15, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.enableControlCallBack, (int32_t)action, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.endFullScreenAction, (int32_t)action, (int32_t)method, v3);
}
