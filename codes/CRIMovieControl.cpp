...
void __fastcall CRIMovieControl__Awake(CRIMovieControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB84CF & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_945/*"--:--"*/, method);
    byte_4BB84CF = 1;
  }
  ...
  if ( !byte_4BAEDA6 )
  {
    nowTime = (UILabel_o *)sub_1C13D24(&UnityEngine_Vector3_TypeInfo, method);
    byte_4BAEDA6 = 1;
  }
  if ( !v4 )
LABEL_11:
    sub_1C13F80(nowTime, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB84D0 & 1) == 0 )
  {
    sub_1C13D24(&int_TypeInfo, *(_QWORD *)&frame);
    this = (CRIMovieControl_o *)sub_1C13D24(&StringLiteral_25474/*"{0}/{1:D2}/{2:D2} {3:D2}:{4:D2}"*/, v5);
    byte_4BB84D0 = 1;
  }
  ...
  return System_String__Format_62982316((System_String_o *)StringLiteral_25474/*"{0}/{1:D2}/{2:D2} {3:D2}:{4:D2}"*/, v11, v15, 0LL);
}
