...
void __fastcall CRIMovieControl__Awake(CRIMovieControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3AF29 & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_942/*"--:--"*/, method);
    byte_4B3AF29 = 1;
  }
  ...
  if ( !byte_4B31946 )
  {
    nowTime = (UILabel_o *)sub_1BD3458(&UnityEngine_Vector3_TypeInfo, method);
    byte_4B31946 = 1;
  }
  if ( !v4 )
LABEL_11:
    sub_1BD36B4(nowTime, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3AF2A & 1) == 0 )
  {
    sub_1BD3458(&int_TypeInfo, *(_QWORD *)&frame);
    this = (CRIMovieControl_o *)sub_1BD3458(&StringLiteral_25364/*"{0}:{1:00}"*/, v5);
    byte_4B3AF2A = 1;
  }
  ...
  return System_String__Format_62539620((System_String_o *)StringLiteral_25364/*"{0}:{1:00}"*/, v11, v15, 0LL);
}
