...
void __fastcall CRIMovieControl__Awake(CRIMovieControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A31B70 & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_946/*"--:--"*/, method);
    byte_4A31B70 = 1;
  }
  ...
  if ( !byte_4A28BB6 )
  {
    nowTime = (UILabel_o *)sub_1B761C0(&UnityEngine_Vector3_TypeInfo, method);
    byte_4A28BB6 = 1;
  }
  if ( !v4 )
LABEL_11:
    sub_1B7641C(nowTime, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31B71 & 1) == 0 )
  {
    sub_1B761C0(&int_TypeInfo, *(_QWORD *)&frame);
    this = (CRIMovieControl_o *)sub_1B761C0(&StringLiteral_25061/*"{0}:{1:00}"*/, v5);
    byte_4A31B71 = 1;
  }
  ...
  return System_String__Format_61549432((System_String_o *)StringLiteral_25061/*"{0}:{1:00}"*/, v11, v15, 0LL);
}
