...
void CRIMovieControl__Awake(CRIMovieControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CE86C3 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_884/*"--:--"*/);
    byte_4CE86C3 = 1;
  }
  nowTime = this->fields.nowTime;
  if ( !nowTime )
    goto LABEL_22;
  UILabel__set_text(nowTime, (System_String_o *)StringLiteral_884/*"--:--"*/, 0);
  ...
  if ( !byte_4CE7E5E )
  {
    nowTime = (UILabel_o *)sub_1C7BAE8(&UnityEngine_Vector3_TypeInfo);
    byte_4CE7E5E = 1;
  }
  if ( !v4 )
    goto LABEL_22;
...
System_String_o *CRIMovieControl__FrameToTimeString(CRIMovieControl_o *this, int32_t frame, const MethodInfo *method)
{
  ...
  if ( (byte_4CE86C7 & 1) == 0 )
  {
    ...
    this = (CRIMovieControl_o *)sub_1C7BAE8(&StringLiteral_25431/*"{0}:{1:00}"*/);
    byte_4CE86C7 = 1;
  }
  ...
  return System_String__Format_64218220((System_String_o *)StringLiteral_25431/*"{0}:{1:00}"*/, v7, v8, 0);
}
...
bool CRIMovieControl__IsEnableSkipButton(CRIMovieControl_o *this, const MethodInfo *method)
{
  ...
  if ( !v6 )
    sub_1C7BD40(v4, v5);
  if ( !v6->fields._IsEnableSkipButton_k__BackingField )
    return 0;
  skipButton = (UnityEngine_Object_o *)this->fields.skipButton;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
...
void CRIMovieControl__OnClickSkipButton(CRIMovieControl_o *this, const MethodInfo *method)
{
  ...
  if ( ((unsigned __int8)v4 & 1) != 0 )
  {
    ...
    if ( !v6 )
      goto LABEL_13;
    player_k__BackingField = v6->fields._player_k__BackingField;
    if ( player_k__BackingField && CriMana_Player__get_status(player_k__BackingField, 0) == 5 && v6->fields.isPlaying )
    {
      v4 = this->fields.player;
      if ( v4 )
      {
...
void CRIMovieControl__OnClickTouch(CRIMovieControl_o *this, const MethodInfo *method)
{
  ...
  if ( ((unsigned __int8)v4 & 1) != 0 )
  {
    ...
    if ( v6 )
    {
      ...
      if ( CRIMovieControl__IsEnableSkipButton(this, v8) )
      {
        ...
        const MethodInfo *method)
{
  ...
  sub_1C7BA8C(&this->fields.enableControlCallBack, action);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C7BA8C(&this->fields.endFullScreenAction, action);
}
...
void CRIMovieControl__Update(CRIMovieControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CE86C4 & 1) == 0 )
  {
    this = (CRIMovieControl_o *)sub_1C7BAE8(&UnityEngine_Object_TypeInfo);
    byte_4CE86C4 = 1;
  }
