...
void CRIMovieControl__Awake(CRIMovieControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFE9B9 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_885/*"--:--"*/);
    byte_4DFE9B9 = 1;
  }
  nowTime = this->fields.nowTime;
  if ( !nowTime )
    goto LABEL_22;
  UILabel__set_text(nowTime, (System_String_o *)StringLiteral_885/*"--:--"*/, 0);
  ...
  if ( !byte_4DFE0AE )
  {
    nowTime = (UILabel_o *)sub_1CE6700(&UnityEngine_Vector3_TypeInfo);
    byte_4DFE0AE = 1;
  }
  if ( !v4 )
    goto LABEL_22;
...
System_String_o *CRIMovieControl__FrameToTimeString(CRIMovieControl_o *this, int32_t frame, const MethodInfo *method)
{
  ...
  if ( (byte_4DFE9BD & 1) == 0 )
  {
    ...
    this = (CRIMovieControl_o *)sub_1CE6700(&StringLiteral_25588/*"{0}:{1:00}"*/);
    byte_4DFE9BD = 1;
  }
  ...
  return System_String__Format_65164136((System_String_o *)StringLiteral_25588/*"{0}:{1:00}"*/, v7, v8, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1CE66A4(&this->fields.enableControlCallBack, action);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1CE66A4(&this->fields.endFullScreenAction, action);
}
...
void CRIMovieControl__Update(CRIMovieControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFE9BA & 1) == 0 )
  {
    this = (CRIMovieControl_o *)sub_1CE6700(&UnityEngine_Object_TypeInfo);
    byte_4DFE9BA = 1;
  }
