...
void __fastcall CRIMovieControl__Awake(CRIMovieControl_o *this, const MethodInfo *method)
{
  ...
  if ( !byte_4A55CE6 )
  {
    nowTime = (UILabel_o *)sub_1B885B0(&UnityEngine_Vector3_TypeInfo);
    byte_4A55CE6 = 1;
  }
  if ( !v4 )
LABEL_11:
    sub_1B8880C(nowTime, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5EDCA & 1) == 0 )
  {
    ...
    this = (CRIMovieControl_o *)sub_1B885B0(&StringLiteral_25074/*"{0}:{1:00}"*/);
    byte_4A5EDCA = 1;
  }
  ...
  return System_String__Format_61721404((System_String_o *)StringLiteral_25074/*"{0}:{1:00}"*/, v10, v14, 0LL);
}
