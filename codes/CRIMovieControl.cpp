...
void __fastcall CRIMovieControl__Awake(CRIMovieControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A73AE2 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_946/*"--:--"*/, method);
    byte_4A73AE2 = 1;
  }
  ...
  if ( !byte_4A6A9C6 )
  {
    nowTime = (UILabel_o *)sub_1B90010(&UnityEngine_Vector3_TypeInfo, method);
    byte_4A6A9C6 = 1;
  }
  if ( !v4 )
LABEL_11:
    sub_1B9026C(nowTime, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73AE3 & 1) == 0 )
  {
    sub_1B90010(&int_TypeInfo, *(_QWORD *)&frame);
    this = (CRIMovieControl_o *)sub_1B90010(&StringLiteral_25114/*"{0}:{1:00}"*/, v5);
    byte_4A73AE3 = 1;
  }
  ...
  return System_String__Format_61801464((System_String_o *)StringLiteral_25114/*"{0}:{1:00}"*/, v11, v15, 0LL);
}
