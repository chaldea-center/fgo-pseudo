...
void __fastcall CRIMovieControl__Awake(CRIMovieControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A236F6 & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_946/*"--:--"*/, method);
    byte_4A236F6 = 1;
  }
  ...
  if ( !byte_4A1A756 )
  {
    nowTime = (UILabel_o *)sub_1B715CC(&UnityEngine_Vector3_TypeInfo, method);
    byte_4A1A756 = 1;
  }
  if ( !v4 )
LABEL_11:
    sub_1B71828(nowTime, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A236F7 & 1) == 0 )
  {
    sub_1B715CC(&int_TypeInfo, *(_QWORD *)&frame);
    this = (CRIMovieControl_o *)sub_1B715CC(&StringLiteral_25015/*"{0}:{1:00}"*/, v5);
    byte_4A236F7 = 1;
  }
  ...
  return System_String__Format_61519876((System_String_o *)StringLiteral_25015/*"{0}:{1:00}"*/, v11, v15, 0LL);
}
