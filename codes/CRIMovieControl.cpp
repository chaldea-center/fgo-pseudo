...
void __fastcall CRIMovieControl__Awake(CRIMovieControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B48BB3 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_896/*"--:--"*/, method);
    byte_4B48BB3 = 1;
  }
  nowTime = this->fields.nowTime;
  if ( !nowTime )
    goto LABEL_11;
  UILabel__set_text(nowTime, (System_String_o *)StringLiteral_896/*"--:--"*/, 0LL);
  ...
  if ( !byte_4B3E916 )
  {
    nowTime = (UILabel_o *)sub_1BDB878(&UnityEngine_Vector3_TypeInfo, method);
    byte_4B3E916 = 1;
  }
  if ( !v4 )
LABEL_11:
    sub_1BDBAD4(nowTime, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48BB6 & 1) == 0 )
  {
    sub_1BDB878(&int_TypeInfo, *(_QWORD *)&frame);
    this = (CRIMovieControl_o *)sub_1BDB878(&StringLiteral_25263/*"{0}:{1:00}"*/, v5);
    byte_4B48BB6 = 1;
  }
  ...
  return System_String__Format_62613552((System_String_o *)StringLiteral_25263/*"{0}:{1:00}"*/, v11, v15, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.enableControlCallBack, (int32_t)action, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.endFullScreenAction, (int32_t)action, (int32_t)method, v3);
}
