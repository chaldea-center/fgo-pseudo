void ServantReactTaskCreator___ctor(ServantReactTaskCreator_o *this, int32_t procState, const MethodInfo *method)
{
  ...
  if ( (byte_4C46202 & 1) == 0 )
  {
    sub_1C37058(&ServantReactTaskCreator_ExecOrder___TypeInfo);
    byte_4C46202 = 1;
  }
  v5 = sub_1C37100(ServantReactTaskCreator_ExecOrder___TypeInfo, 3);
  if ( !v5 )
    sub_1C372B4(0);
  v8 = *(_DWORD *)(v5 + 24);
  ...
  *(_DWORD *)(v5 + 40) = 1;
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.execOrders, v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  v4 = (BattleLogicTask_o *)sub_1C372A4(BattleLogicTask_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C4620A & 1) == 0 )
  {
    sub_1C37058(&Method_BasicHelper_Any_ReactTaskTarget___);
    sub_1C37058(&System_Func_ReactTaskTarget__bool__TypeInfo);
    ...
    sub_1C37058(&ServantRepeatTask_TypeInfo);
    sub_1C37058(&Method_ServantReactTaskCreator___c__DisplayClass20_0__CreateTasks_b__0__);
    sub_1C37058(&ServantReactTaskCreator___c__DisplayClass20_0_TypeInfo);
    byte_4C4620A = 1;
  }
  v5 = sub_1C372A4(ServantReactTaskCreator___c__DisplayClass20_0_TypeInfo);
  ...
  *(_QWORD *)(v5 + 24) = logic;
  sub_1C36FFC((CGThumbnailListItem_o *)(v5 + 24), (int32_t)logic, v9, v10);
  ...
  *(_DWORD *)(v5 + 32) = v12;
  ...
  if ( (int)max_length >= 1 )
  {
    ...
    do
    {
      ...
      if ( !*v18 )
      {
        v20 = (System_Func_object__bool__o *)sub_1C372A4(System_Func_ReactTaskTarget__bool__TypeInfo);
        System_Func_object__bool____ctor(
          ...
          0);
        *(_QWORD *)(v5 + 40) = v20;
        sub_1C36FFC((CGThumbnailListItem_o *)(v5 + 40), (int32_t)v20, v22, v23);
      }
      v6 = BasicHelper__Any_object__51187876(
             v21,
             (System_Func_T__bool__o *)v20,
             (const MethodInfo_30D10A4 *)Method_BasicHelper_Any_ReactTaskTarget___);
      if ( v6 )
      {
        v24 = *(_DWORD *)(v5 + 32);
        v25 = (ServantRepeatTask_o *)sub_1C372A4(ServantRepeatTask_TypeInfo);
...
ReactTaskTarget_o *ServantReactTaskCreator__MakeEnemyTarget(ServantReactTaskCreator_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C46208 & 1) == 0 )
  {
    sub_1C37058(&ReactTaskTargetEnemy_TypeInfo);
    byte_4C46208 = 1;
  }
  TargetFilter_k__BackingField = this->fields._TargetFilter_k__BackingField;
  v4 = (ReactTaskTarget_o *)sub_1C372A4(ReactTaskTargetEnemy_TypeInfo);
...
ReactTaskTarget_o *ServantReactTaskCreator__MakeNpcTarget(ServantReactTaskCreator_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C46209 & 1) == 0 )
  {
    sub_1C37058(&ReactTaskTargetNpc_TypeInfo);
    byte_4C46209 = 1;
  }
  v2 = (ReactTaskTarget_o *)sub_1C372A4(ReactTaskTargetNpc_TypeInfo);
...
ReactTaskTarget_o *ServantReactTaskCreator__MakePlayerTarget(ServantReactTaskCreator_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C46207 & 1) == 0 )
  {
    sub_1C37058(&ReactTaskTargetPlayer_TypeInfo);
    byte_4C46207 = 1;
  }
  v2 = (ReactTaskTarget_o *)sub_1C372A4(ReactTaskTargetPlayer_TypeInfo);
  ReactTaskTarget___ctor(v2, 0, v3);
  return v2;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C46206 & 1) == 0 )
  {
    sub_1C37058(&ReactTaskTarget___TypeInfo);
    byte_4C46206 = 1;
  }
  if ( execOrder == 2 )
  {
    v5 = sub_1C37100(ReactTaskTarget___TypeInfo, 1);
  ...
  {
    if ( execOrder )
      return (ReactTaskTarget_array *)sub_1C37100(ReactTaskTarget___TypeInfo, 0);
    v5 = sub_1C37100(ReactTaskTarget___TypeInfo, 1);
  ...
  if ( !LODWORD(v8->max_length) )
    sub_1C372BC(v9);
  v8->m_Items[0] = v12;
  sub_1C36FFC((CGThumbnailListItem_o *)v8->m_Items, (int32_t)v12, v10, v11);
  return v8;
}
...
ServantReactTaskCreator_o *ServantReactTaskCreator__OrderE(ServantReactTaskCreator_o *this, const MethodInfo *method)
{
  ...
  v3 = sub_1C37100(ServantReactTaskCreator_ExecOrder___TypeInfo, 1);
  if ( !v3 )
    sub_1C372B4(0);
  if ( !*(_DWORD *)(v3 + 24) )
    sub_1C372BC(v3);
  *(_DWORD *)(v3 + 32) = 1;
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.execOrders, v3, v4, v5);
  return this;
}
...
ServantReactTaskCreator_o *ServantReactTaskCreator__OrderNEP(ServantReactTaskCreator_o *this, const MethodInfo *method)
{
  ...
  v3 = sub_1C37100(ServantReactTaskCreator_ExecOrder___TypeInfo, 3);
  if ( !v3 )
    sub_1C372B4(0);
  v6 = *(_DWORD *)(v3 + 24);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.execOrders, (int32_t)orders, (int32_t)method, v3);
  return this;
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields._TargetFilter_k__BackingField, (int32_t)value, (int32_t)method, v3);
}
