void ServantReactTaskCreator___ctor(ServantReactTaskCreator_o *this, int32_t procState, const MethodInfo *method)
{
  ...
  if ( (byte_4E7AA78 & 1) == 0 )
  {
    sub_1D0F0B4(&ServantReactTaskCreator_ExecOrder___TypeInfo);
    byte_4E7AA78 = 1;
  }
  v5 = sub_1D0F15C(ServantReactTaskCreator_ExecOrder___TypeInfo, 3);
  if ( !v5 )
    sub_1D0F30C(0, v6);
  v13 = *(_DWORD *)(v5 + 24);
  ...
  *(_DWORD *)(v5 + 40) = 1;
  ...
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.execOrders, v5, v7, v8, v9, v10, v11, v12);
        ...
        const MethodInfo *method)
{
  ...
  v4 = (BattleLogicTask_o *)sub_1D0F300(BattleLogicTask_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7AA80 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_BasicHelper_Any_ReactTaskTarget___);
    sub_1D0F0B4(&System_Func_ReactTaskTarget__bool__TypeInfo);
    ...
    sub_1D0F0B4(&ServantRepeatTask_TypeInfo);
    sub_1D0F0B4(&Method_ServantReactTaskCreator___c__DisplayClass20_0__CreateTasks_b__0__);
    sub_1D0F0B4(&ServantReactTaskCreator___c__DisplayClass20_0_TypeInfo);
    byte_4E7AA80 = 1;
  }
  v5 = sub_1D0F300(ServantReactTaskCreator___c__DisplayClass20_0_TypeInfo);
  ...
  *(_QWORD *)(v5 + 24) = logic;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)(v5 + 24), (int32_t)logic, v14, v15, v16, v17, v18, v19);
  ...
  *(_DWORD *)(v5 + 32) = v21;
  v22 = (System_Collections_Generic_List_object__o *)sub_1D0F300(System_Collections_Generic_List_BattleLogicTask__TypeInfo);
  ...
  if ( (int)max_length >= 1 )
  {
    ...
    do
    {
      ...
      if ( !*v27 )
      {
        v29 = (System_Func_object__bool__o *)sub_1D0F300(System_Func_ReactTaskTarget__bool__TypeInfo);
        System_Func_object__bool____ctor(
          ...
          0);
        *(_QWORD *)(v5 + 40) = v29;
        sub_1D0F058((GrandQuestFolderBoardItem_o *)(v5 + 40), (int32_t)v29, v31, v32, v33, v34, v35, v36);
      }
      v6 = BasicHelper__Any_object__52659096(
             v30,
             (System_Func_T__bool__o *)v29,
             (const MethodInfo_3238398 *)Method_BasicHelper_Any_ReactTaskTarget___);
      if ( v6 )
      {
        v37 = *(_DWORD *)(v5 + 32);
        v38 = (ServantRepeatTask_o *)sub_1D0F300(ServantRepeatTask_TypeInfo);
...
ReactTaskTarget_o *ServantReactTaskCreator__MakeEnemyTarget(ServantReactTaskCreator_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E7AA7E & 1) == 0 )
  {
    sub_1D0F0B4(&ReactTaskTargetEnemy_TypeInfo);
    byte_4E7AA7E = 1;
  }
  TargetFilter_k__BackingField = this->fields._TargetFilter_k__BackingField;
  v4 = (ReactTaskTarget_o *)sub_1D0F300(ReactTaskTargetEnemy_TypeInfo);
...
ReactTaskTarget_o *ServantReactTaskCreator__MakeNpcTarget(ServantReactTaskCreator_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E7AA7F & 1) == 0 )
  {
    sub_1D0F0B4(&ReactTaskTargetNpc_TypeInfo);
    byte_4E7AA7F = 1;
  }
  v2 = (ReactTaskTarget_o *)sub_1D0F300(ReactTaskTargetNpc_TypeInfo);
...
ReactTaskTarget_o *ServantReactTaskCreator__MakePlayerTarget(ServantReactTaskCreator_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E7AA7D & 1) == 0 )
  {
    sub_1D0F0B4(&ReactTaskTargetPlayer_TypeInfo);
    byte_4E7AA7D = 1;
  }
  v2 = (ReactTaskTarget_o *)sub_1D0F300(ReactTaskTargetPlayer_TypeInfo);
  ReactTaskTarget___ctor(v2, 0, v3);
  return v2;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7AA7C & 1) == 0 )
  {
    sub_1D0F0B4(&ReactTaskTarget___TypeInfo);
    byte_4E7AA7C = 1;
  }
  if ( execOrder == 2 )
  {
    v5 = sub_1D0F15C(ReactTaskTarget___TypeInfo, 1);
  ...
  {
    if ( execOrder )
      return (ReactTaskTarget_array *)sub_1D0F15C(ReactTaskTarget___TypeInfo, 0);
    v5 = sub_1D0F15C(ReactTaskTarget___TypeInfo, 1);
  ...
  if ( v9 )
  {
    v9 = sub_1D0F1F0(v9, v8->obj.klass->_1.element_class);
    if ( !v9 )
    {
      v19 = sub_1D0F330(0);
      sub_1D0F1DC(v19, 0);
  ...
  if ( !LODWORD(v8->max_length) )
    sub_1D0F314(v9);
  v8->m_Items[0] = v17;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)v8->m_Items, (int32_t)v17, v11, v12, v13, v14, v15, v16);
  return v8;
}
...
ServantReactTaskCreator_o *ServantReactTaskCreator__OrderE(ServantReactTaskCreator_o *this, const MethodInfo *method)
{
  ...
  v3 = sub_1D0F15C(ServantReactTaskCreator_ExecOrder___TypeInfo, 1);
  if ( !v3 )
    sub_1D0F30C(0, v4);
  if ( !*(_DWORD *)(v3 + 24) )
    sub_1D0F314(v3);
  *(_DWORD *)(v3 + 32) = 1;
  ...
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.execOrders, v3, v5, v6, v7, v8, v9, v10);
  return this;
}
...
ServantReactTaskCreator_o *ServantReactTaskCreator__OrderNEP(ServantReactTaskCreator_o *this, const MethodInfo *method)
{
  ...
  v3 = sub_1D0F15C(ServantReactTaskCreator_ExecOrder___TypeInfo, 3);
  if ( !v3 )
    sub_1D0F30C(0, v4);
  v11 = *(_DWORD *)(v3 + 24);
