void ServantReactTaskCreator___ctor(ServantReactTaskCreator_o *this, int32_t procState, const MethodInfo *method)
{
  ...
  if ( (byte_4CB95B7 & 1) == 0 )
  {
    sub_1C6BA08(&ServantReactTaskCreator_ExecOrder___TypeInfo);
    byte_4CB95B7 = 1;
  }
  v5 = sub_1C6BAB0(ServantReactTaskCreator_ExecOrder___TypeInfo, 3);
  if ( !v5 )
    sub_1C6BC60(0, v6);
  v9 = *(_DWORD *)(v5 + 24);
  ...
  *(_DWORD *)(v5 + 40) = 1;
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.execOrders, v5, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  v4 = (BattleLogicTask_o *)sub_1C6BC54(BattleLogicTask_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB95BF & 1) == 0 )
  {
    sub_1C6BA08(&Method_BasicHelper_Any_ReactTaskTarget___);
    sub_1C6BA08(&System_Func_ReactTaskTarget__bool__TypeInfo);
    ...
    sub_1C6BA08(&Method_ServantReactTaskCreator___c__DisplayClass20_0__CreateTasks_b__0__);
    sub_1C6BA08(&ServantReactTaskCreator___c__DisplayClass20_0_TypeInfo);
    byte_4CB95BF = 1;
  }
  v5 = sub_1C6BC54(ServantReactTaskCreator___c__DisplayClass20_0_TypeInfo);
  ...
  *(_DWORD *)(v5 + 32) = v13;
  ...
  if ( (int)max_length >= 1 )
  {
    ...
    do
    {
      ...
      if ( !*v19 )
      {
        v21 = (System_Func_object__bool__o *)sub_1C6BC54(System_Func_ReactTaskTarget__bool__TypeInfo);
        System_Func_object__bool____ctor(
          ...
          0);
        *(_QWORD *)(v5 + 40) = v21;
        sub_1C6B9AC((CGThumbnailListItem_o *)(v5 + 40), (int32_t)v21, v23, v24);
      }
      v6 = BasicHelper__Any_object__51528924(
             v22,
             (System_Func_T__bool__o *)v21,
             (const MethodInfo_31244DC *)Method_BasicHelper_Any_ReactTaskTarget___);
      if ( v6 )
      {
        v25 = *(_DWORD *)(v5 + 32);
        v26 = (ServantRepeatTask_o *)sub_1C6BC54(ServantRepeatTask_TypeInfo);
...
ReactTaskTarget_o *ServantReactTaskCreator__MakeEnemyTarget(ServantReactTaskCreator_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB95BD & 1) == 0 )
  {
    sub_1C6BA08(&ReactTaskTargetEnemy_TypeInfo);
    byte_4CB95BD = 1;
  }
  TargetFilter_k__BackingField = this->fields._TargetFilter_k__BackingField;
  v4 = (ReactTaskTarget_o *)sub_1C6BC54(ReactTaskTargetEnemy_TypeInfo);
...
ReactTaskTarget_o *ServantReactTaskCreator__MakeNpcTarget(ServantReactTaskCreator_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB95BE & 1) == 0 )
  {
    sub_1C6BA08(&ReactTaskTargetNpc_TypeInfo);
    byte_4CB95BE = 1;
  }
  v2 = (ReactTaskTarget_o *)sub_1C6BC54(ReactTaskTargetNpc_TypeInfo);
...
ReactTaskTarget_o *ServantReactTaskCreator__MakePlayerTarget(ServantReactTaskCreator_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB95BC & 1) == 0 )
  {
    sub_1C6BA08(&ReactTaskTargetPlayer_TypeInfo);
    byte_4CB95BC = 1;
  }
  v2 = (ReactTaskTarget_o *)sub_1C6BC54(ReactTaskTargetPlayer_TypeInfo);
  ReactTaskTarget___ctor(v2, 0, v3);
  return v2;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB95BB & 1) == 0 )
  {
    sub_1C6BA08(&ReactTaskTarget___TypeInfo);
    byte_4CB95BB = 1;
  }
  if ( execOrder == 2 )
  {
    v5 = sub_1C6BAB0(ReactTaskTarget___TypeInfo, 1);
  ...
  {
    if ( execOrder )
      return (ReactTaskTarget_array *)sub_1C6BAB0(ReactTaskTarget___TypeInfo, 0);
    v5 = sub_1C6BAB0(ReactTaskTarget___TypeInfo, 1);
  ...
  if ( v9 )
  {
    v9 = sub_1C6BB44(v9, v8->obj.klass->_1.element_class);
    if ( !v9 )
    {
      v15 = sub_1C6BC84(0);
      sub_1C6BB30(v15, 0);
  ...
  if ( !LODWORD(v8->max_length) )
    sub_1C6BC68(v9);
  v8->m_Items[0] = v13;
  sub_1C6B9AC((CGThumbnailListItem_o *)v8->m_Items, (int32_t)v13, v11, v12);
  return v8;
}
...
ServantReactTaskCreator_o *ServantReactTaskCreator__OrderE(ServantReactTaskCreator_o *this, const MethodInfo *method)
{
  ...
  v3 = sub_1C6BAB0(ServantReactTaskCreator_ExecOrder___TypeInfo, 1);
  if ( !v3 )
    sub_1C6BC60(0, v4);
  if ( !*(_DWORD *)(v3 + 24) )
    sub_1C6BC68(v3);
  *(_DWORD *)(v3 + 32) = 1;
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.execOrders, v3, v5, v6);
  return this;
}
...
ServantReactTaskCreator_o *ServantReactTaskCreator__OrderNEP(ServantReactTaskCreator_o *this, const MethodInfo *method)
{
  ...
  v3 = sub_1C6BAB0(ServantReactTaskCreator_ExecOrder___TypeInfo, 3);
  if ( !v3 )
    sub_1C6BC60(0, v4);
  v7 = *(_DWORD *)(v3 + 24);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.execOrders, (int32_t)orders, (int32_t)method, v3);
  return this;
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields._TargetFilter_k__BackingField, (int32_t)value, (int32_t)method, v3);
}
