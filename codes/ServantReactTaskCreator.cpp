void ServantReactTaskCreator___ctor(ServantReactTaskCreator_o *this, int32_t procState, const MethodInfo *method)
{
  ...
  if ( (byte_593BAD9 & 1) == 0 )
  {
    sub_21FFC50(&ServantReactTaskCreator_ExecOrder___TypeInfo);
    byte_593BAD9 = 1;
  }
  v5 = sub_21FFD10(ServantReactTaskCreator_ExecOrder___TypeInfo, 3);
  if ( !v5 )
    sub_21FFECC(0, v6);
  v13 = *(_DWORD *)(v5 + 24);
  ...
  *(_DWORD *)(v5 + 40) = 1;
  ...
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&this->fields.execOrders, v5, v7, v8, v9, v10, v11, v12);
        ...
        const MethodInfo *method)
{
  ...
  v4 = (BattleLogicTask_o *)sub_21FFEBC(BattleLogicTask_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_593BAE1 & 1) == 0 )
  {
    sub_21FFC50(&Method_BasicHelper_Any_ReactTaskTarget___);
    sub_21FFC50(&System_Func_ReactTaskTarget__bool__TypeInfo);
    ...
    sub_21FFC50(&ServantRepeatTask_TypeInfo);
    sub_21FFC50(&Method_ServantReactTaskCreator___c__DisplayClass20_0__CreateTasks_b__0__);
    sub_21FFC50(&ServantReactTaskCreator___c__DisplayClass20_0_TypeInfo);
    byte_593BAE1 = 1;
  }
  v5 = sub_21FFEBC(ServantReactTaskCreator___c__DisplayClass20_0_TypeInfo);
  ...
  *(_QWORD *)(v5 + 24) = logic;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)(v5 + 24), (int32_t)logic, v14, v15, v16, v17, v18, v19);
  ...
  v24 = v23 ? 2 : 0;
  *(_DWORD *)(v5 + 32) = v24;
  v25 = (System_Collections_Generic_List_object__o *)sub_21FFEBC(v21);
  ...
  if ( (int)max_length >= 1 )
  {
    ...
    do
    {
      ...
      if ( !v31 )
      {
        v31 = (System_Func_object__bool__o *)sub_21FFEBC(System_Func_ReactTaskTarget__bool__TypeInfo);
        System_Func_object__bool____ctor(
          ...
          0);
        *(_QWORD *)(v5 + 40) = v31;
        sub_21FFBF4((MissionNaviTransitionBoardItem_o *)(v5 + 40), (int32_t)v31, v33, v34, v35, v36, v37, v38);
      }
      v6 = BasicHelper__Any_object__58575580(
             v32,
             (System_Func_T__bool__o *)v31,
             (const MethodInfo_37DCADC *)Method_BasicHelper_Any_ReactTaskTarget___);
      if ( v6 )
      {
        v39 = *(_DWORD *)(v5 + 32);
        v40 = (ServantRepeatTask_o *)sub_21FFEBC(ServantRepeatTask_TypeInfo);
...
ReactTaskTarget_o *ServantReactTaskCreator__MakeEnemyTarget(ServantReactTaskCreator_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_593BADF & 1) == 0 )
  {
    sub_21FFC50(&ReactTaskTargetEnemy_TypeInfo);
    byte_593BADF = 1;
  }
  TargetFilter_k__BackingField = this->fields._TargetFilter_k__BackingField;
  v4 = (ReactTaskTarget_o *)sub_21FFEBC(ReactTaskTargetEnemy_TypeInfo);
...
ReactTaskTarget_o *ServantReactTaskCreator__MakeNpcTarget(ServantReactTaskCreator_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_593BAE0 & 1) == 0 )
  {
    sub_21FFC50(&ReactTaskTargetNpc_TypeInfo);
    byte_593BAE0 = 1;
  }
  v2 = (ReactTaskTarget_o *)sub_21FFEBC(ReactTaskTargetNpc_TypeInfo);
...
ReactTaskTarget_o *ServantReactTaskCreator__MakePlayerTarget(ServantReactTaskCreator_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_593BADE & 1) == 0 )
  {
    sub_21FFC50(&ReactTaskTargetPlayer_TypeInfo);
    byte_593BADE = 1;
  }
  v2 = (ReactTaskTarget_o *)sub_21FFEBC(ReactTaskTargetPlayer_TypeInfo);
  ReactTaskTarget___ctor(v2, 0, v3);
  return v2;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_593BADD & 1) == 0 )
  {
    sub_21FFC50(&ReactTaskTarget___TypeInfo);
    byte_593BADD = 1;
  }
  if ( execOrder == 2 )
  {
    v5 = sub_21FFD10(ReactTaskTarget___TypeInfo, 1);
  ...
  {
    if ( execOrder )
      return (ReactTaskTarget_array *)sub_21FFD10(ReactTaskTarget___TypeInfo, 0);
    v5 = sub_21FFD10(ReactTaskTarget___TypeInfo, 1);
  ...
  if ( v9 )
  {
    v9 = sub_21FFDA4(v9, v8->obj.klass->_1.element_class);
    if ( !v9 )
    {
...
ServantReactTaskCreator_o *ServantReactTaskCreator__OrderE(ServantReactTaskCreator_o *this, const MethodInfo *method)
{
  ...
  v3 = sub_21FFD10(ServantReactTaskCreator_ExecOrder___TypeInfo, 1);
  if ( !v3 )
    sub_21FFECC(0, v4);
  if ( !*(_DWORD *)(v3 + 24) )
    sub_21FFED4(v3);
  *(_DWORD *)(v3 + 32) = 1;
  ...
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&this->fields.execOrders, v3, v5, v6, v7, v8, v9, v10);
  return this;
}
...
ServantReactTaskCreator_o *ServantReactTaskCreator__OrderNEP(ServantReactTaskCreator_o *this, const MethodInfo *method)
{
  ...
  v3 = sub_21FFD10(ServantReactTaskCreator_ExecOrder___TypeInfo, 3);
  if ( !v3 )
    sub_21FFECC(0, v4);
  v11 = *(_DWORD *)(v3 + 24);
