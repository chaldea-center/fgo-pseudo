void ByteCompressor___ctor(ByteCompressor_o *this, System_Byte_array *inputBytes, const MethodInfo *method)
{
  ...
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields, (int32_t)inputBytes, v5, v6, v7, v8, v9, v10);
}


void ByteCompressor___ctor_45330948(ByteCompressor_o *this, System_String_o *inputStr, const MethodInfo *method)
{
  System_String_o *v5; // x2
  System_String_o *v6; // x3
  int32_t v7; // w4
...
ByteCompressor_o *ByteCompressor__AsGzipToBytes(ByteCompressor_o *this, const MethodInfo *method)
{
  ...
  {
    v4 = (System_IO_MemoryStream_o *)sub_2213CCC(System_IO_MemoryStream_TypeInfo);
    System_IO_MemoryStream___ctor_76876544(v4, Bytes_k__BackingField, 0);
    v5 = (System_IO_Compression_GZipStream_o *)sub_2213CCC(System_IO_Compression_GZipStream_TypeInfo);
    System_IO_Compression_GZipStream___ctor(v5, (System_IO_Stream_o *)v4, 0, 0);
    v6 = (System_IO_MemoryStream_o *)sub_2213CCC(System_IO_MemoryStream_TypeInfo);
...
ByteCompressor_o *ByteCompressor__ImportMiniMessagePack___Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_381C240 *method)
{
  _QWORD *monitor; // x19
  ...
  v6 = (MiniMessagePack_MiniMessagePacker_o *)sub_2213CCC(MiniMessagePack_MiniMessagePacker_TypeInfo);
  ...
  v12 = (ByteCompressor_o *)sub_2213CCC(ByteCompressor_TypeInfo);
...
ByteCompressor_o *ByteCompressor__ImportMiniMessagePack_object_(
        ...
        const MethodInfo_381C19C *method)
{
  ...
  v3 = (MiniMessagePack_MiniMessagePacker_o *)sub_2213CCC(MiniMessagePack_MiniMessagePacker_TypeInfo);
  MiniMessagePack_MiniMessagePacker___ctor(v3, 0);
  if ( !v3 )
    sub_2213CDC(v4, v5);
  v6 = MiniMessagePack_MiniMessagePacker__PackClass(v3, miniMessagePackData, 0);
  v7 = (ByteCompressor_o *)sub_2213CCC(ByteCompressor_TypeInfo);
...
ByteCompressor_o *ByteCompressor__ToGzip(ByteCompressor_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields._Bytes_k__BackingField )
  {
    ...
    v5 = (System_IO_Compression_GZipStream_o *)sub_2213CCC(System_IO_Compression_GZipStream_TypeInfo);
    System_IO_Compression_GZipStream___ctor_82470116(v5, (System_IO_Stream_o *)v4, 0, 0);
    Bytes_k__BackingField = p_fields->_Bytes_k__BackingField;
    if ( !p_fields->_Bytes_k__BackingField || !v5 )
      sub_2213CDC(v6, Bytes_k__BackingField);
    ...
    {
LABEL_10:
      v11 = sub_224BC3C(v5, System_IDisposable_TypeInfo, 0);
    }
    ...
    sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields, v13, v14, v15, v16, v17, v18, v19);
    v20 = v4->klass;
    ...
    {
LABEL_20:
      v23 = sub_224BC3C(v4, System_IDisposable_TypeInfo, 0);
    }
...
Il2CppObject *ByteCompressor__UnpackMiniMessagePack_object_(ByteCompressor_o *this, const MethodInfo_381C38C *method)
{
  ...
  return MiniMessagePack_MiniMessagePacker__UnpackClass_object_(
           ...
           (const MethodInfo_38ED1B8 *)method->rgctx_data->_0_MiniMessagePack_MiniMessagePacker_UnpackClass_T_);
}
