void ByteCompressor___ctor(ByteCompressor_o *this, System_Byte_array *inputBytes, const MethodInfo *method)
{
  ...
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&this->fields, (int32_t)inputBytes, v5, v6, v7, v8, v9, v10);
}


void ByteCompressor___ctor_45306684(ByteCompressor_o *this, System_String_o *inputStr, const MethodInfo *method)
{
  System_String_o *v5; // x2
  System_String_o *v6; // x3
  int32_t v7; // w4
  ...
  sub_21FFBF4(
    (MissionNaviTransitionBoardItem_o *)&this->fields._Str_k__BackingField,
    (int32_t)inputStr,
    v5,
    v6,
    v7,
...
ByteCompressor_o *ByteCompressor__AsBase64StrToBytes(ByteCompressor_o *this, const MethodInfo *method)
{
  ...
  if ( Str_k__BackingField )
  {
    ...
    v5 = System_Convert__FromBase64String(Str_k__BackingField, 0);
    this->fields._Bytes_k__BackingField = v5;
...
ByteCompressor_o *ByteCompressor__AsGzipToBytes(ByteCompressor_o *this, const MethodInfo *method)
{
  ...
  {
    v4 = (System_IO_MemoryStream_o *)sub_21FFEBC(System_IO_MemoryStream_TypeInfo);
    System_IO_MemoryStream___ctor_76663240(v4, Bytes_k__BackingField, 0);
    v5 = (System_IO_Compression_GZipStream_o *)sub_21FFEBC(System_IO_Compression_GZipStream_TypeInfo);
    System_IO_Compression_GZipStream___ctor(v5, (System_IO_Stream_o *)v4, 0, 0);
    v6 = (System_IO_MemoryStream_o *)sub_21FFEBC(System_IO_MemoryStream_TypeInfo);
    ...
    if ( (int)v7 >= 1 )
    {
      ...
      while ( v6 )
      {
        ((void (__fastcall *)(System_IO_MemoryStream_o *, __int64, _QWORD, __int64, const MethodInfo *))v6->klass->vtable._34_Write.methodPtr)(
          v6,
          v9,
          0,
          v10,
          v6->klass->vtable._34_Write.method);
        v7 = ((__int64 (__fastcall *)(System_IO_Compression_GZipStream_o *, __int64, _QWORD, _QWORD, const MethodInfo *))v5->klass->vtable._31_Read.methodPtr)(
               v5,
               v9,
               0,
...
LABEL_10:
    if ( !v6 )
      goto LABEL_13;
    v11 = (struct System_Byte_array *)((__int64 (__fastcall *)(System_IO_MemoryStream_o *, const MethodInfo *))v6->klass->vtable._40_ToArray.methodPtr)(
                                        v6,
                                        v6->klass->vtable._40_ToArray.method);
...
ByteCompressor_o *ByteCompressor__ImportMiniMessagePack___Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_37E8E90 *method)
{
  _QWORD *monitor; // x19
  ...
  v6 = (MiniMessagePack_MiniMessagePacker_o *)sub_21FFEBC(MiniMessagePack_MiniMessagePacker_TypeInfo);
  ...
  v12 = (ByteCompressor_o *)sub_21FFEBC(ByteCompressor_TypeInfo);
...
ByteCompressor_o *ByteCompressor__ImportMiniMessagePack_object_(
        ...
        const MethodInfo_37E8DEC *method)
{
  ...
  v3 = (MiniMessagePack_MiniMessagePacker_o *)sub_21FFEBC(MiniMessagePack_MiniMessagePacker_TypeInfo);
  MiniMessagePack_MiniMessagePacker___ctor(v3, 0);
  if ( !v3 )
    sub_21FFECC(v4, v5);
  v6 = MiniMessagePack_MiniMessagePacker__PackClass(v3, miniMessagePackData, 0);
  v7 = (ByteCompressor_o *)sub_21FFEBC(ByteCompressor_TypeInfo);
...
ByteCompressor_o *ByteCompressor__ToBase64Str(ByteCompressor_o *this, const MethodInfo *method)
{
  ...
  if ( Bytes_k__BackingField )
  {
    if ( !*(&System_Convert_TypeInfo->_2.cctor_finished + 1) )
      j_il2cpp_runtime_class_init_0(System_Convert_TypeInfo, method, v2);
    v5 = System_Convert__ToBase64String(Bytes_k__BackingField, 0);
    this->fields._Str_k__BackingField = v5;
    sub_21FFBF4(
      (MissionNaviTransitionBoardItem_o *)&this->fields._Str_k__BackingField,
      (int32_t)v5,
      v6,
...
{
  ByteCompressor_Fields *p_fields; // x20
  System_IO_MemoryStream_o *v4; // x22
  System_IO_Compression_GZipStream_o *v5; // x21
  __int64 v6; // x0
  ...
  bool v18; // w6
  bool v19; // w7
  System_IO_MemoryStream_c *v20; // x8
  __int64 v21; // x9
  int32_t *v22; // x10
  __int64 v23; // x0
  ...
  if ( this->fields._Bytes_k__BackingField )
  {
    ...
    v5 = (System_IO_Compression_GZipStream_o *)sub_21FFEBC(System_IO_Compression_GZipStream_TypeInfo);
    System_IO_Compression_GZipStream___ctor_82256812(v5, (System_IO_Stream_o *)v4, 0, 0);
    Bytes_k__BackingField = p_fields->_Bytes_k__BackingField;
    if ( !p_fields->_Bytes_k__BackingField || !v5 )
      sub_21FFECC(v6, Bytes_k__BackingField);
    ...
    {
LABEL_10:
      v11 = sub_2237E2C(v5, System_IDisposable_TypeInfo, 0);
    }
    (*(void (__fastcall **)(System_IO_Compression_GZipStream_o *, _QWORD))v11)(v5, *(_QWORD *)(v11 + 8));
    if ( !v4 )
      sub_21FFECC(0, v12);
    v13 = ((__int64 (__fastcall *)(System_IO_MemoryStream_o *, const MethodInfo *))v4->klass->vtable._40_ToArray.methodPtr)(
            v4,
            v4->klass->vtable._40_ToArray.method);
    p_fields->_Bytes_k__BackingField = (struct System_Byte_array *)v13;
    sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&this->fields, v13, v14, v15, v16, v17, v18, v19);
    v20 = v4->klass;
    v21 = *(unsigned __int16 *)&v4->klass->_2.rank;
    ...
    {
LABEL_20:
      v23 = sub_2237E2C(v4, System_IDisposable_TypeInfo, 0);
    }
    (*(void (__fastcall **)(System_IO_MemoryStream_o *, _QWORD))v23)(v4, *(_QWORD *)(v23 + 8));
  }
  return this;
}


Il2CppObject *ByteCompressor__UnpackMiniMessagePack_object_(ByteCompressor_o *this, const MethodInfo_37E8FDC *method)
{
  ...
  return MiniMessagePack_MiniMessagePacker__UnpackClass_object_(
           ...
           (const MethodInfo_38B9CF0 *)method->rgctx_data->_0_MiniMessagePack_MiniMessagePacker_UnpackClass_T_);
}
