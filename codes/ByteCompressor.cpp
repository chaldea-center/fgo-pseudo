void __fastcall ByteCompressor___ctor(ByteCompressor_o *this, System_Byte_array *inputBytes, const MethodInfo *method)
{
  ...
  sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields, (int64_t)inputBytes, v5, v6, v7, v8, v9, v10);
}


void __fastcall ByteCompressor___ctor_37091900(
...
ByteCompressor_o *__fastcall ByteCompressor__AsGzipToBytes(ByteCompressor_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFB6E3 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&System_IO_Compression_GZipStream_TypeInfo, v3);
    sub_1C2E12C(&System_IO_MemoryStream_TypeInfo, v4);
    byte_4BFB6E3 = 1;
  }
  Bytes_k__BackingField = this->fields._Bytes_k__BackingField;
  if ( Bytes_k__BackingField )
  {
    v6 = (System_IO_MemoryStream_o *)sub_1C2E378(System_IO_MemoryStream_TypeInfo);
    System_IO_MemoryStream___ctor_63379596(v6, Bytes_k__BackingField, 0LL);
    v7 = (System_IO_Compression_GZipStream_o *)sub_1C2E378(System_IO_Compression_GZipStream_TypeInfo);
    System_IO_Compression_GZipStream___ctor(v7, (System_IO_Stream_o *)v6, 0, 0LL);
    v8 = (System_IO_MemoryStream_o *)sub_1C2E378(System_IO_MemoryStream_TypeInfo);
    System_IO_MemoryStream___ctor(v8, 0LL);
    v9 = sub_1C2E1D4(byte___TypeInfo, 1024LL);
    if ( !v9
      || !v7
      || (v11 = v9,
    ...
    sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields, (int64_t)v14, v15, v16, v17, v18, v19, v20);
  }
  return this;
}
...
ByteCompressor_o *__fastcall ByteCompressor__ImportMiniMessagePack___Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_2FC4284 *method)
{
  _QWORD *monitor; // x20
  ...
  if ( !v4 )
  {
    sub_1C2E12C(&ByteCompressor_TypeInfo, miniMessagePackData.monitor);
  ...
  v16 = (ByteCompressor_o *)sub_1C2E378(ByteCompressor_TypeInfo);
...
ByteCompressor_o *__fastcall ByteCompressor__ImportMiniMessagePack_object_(
        ...
        const MethodInfo_2FC41E0 *method)
{
  __int64 v3; // x1
  ...
  if ( (byte_4C03453 & 1) == 0 )
  {
    sub_1C2E12C(&ByteCompressor_TypeInfo, method);
    sub_1C2E12C(&MiniMessagePack_MiniMessagePacker_TypeInfo, v3);
    byte_4C03453 = 1;
  }
  v4 = (MiniMessagePack_MiniMessagePacker_o *)sub_1C2E378(MiniMessagePack_MiniMessagePacker_TypeInfo);
  ...
  v8 = (ByteCompressor_o *)sub_1C2E378(ByteCompressor_TypeInfo);
...
ByteCompressor_o *__fastcall ByteCompressor__ToBase64Str(ByteCompressor_o *this, const MethodInfo *method)
{
  ...
  if ( Bytes_k__BackingField )
  {
    ...
    sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields._Str_k__BackingField, (int64_t)v4, v5, v6, v7, v8, v9, v10);
  }
  return this;
}
...
ByteCompressor_o *__fastcall ByteCompressor__ToGzip(ByteCompressor_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFB6E2 & 1) == 0 )
  {
    sub_1C2E12C(&System_IO_Compression_GZipStream_TypeInfo, method);
  ...
  if ( this->fields._Bytes_k__BackingField )
  {
    ...
    v7 = (System_IO_Compression_GZipStream_o *)sub_1C2E378(System_IO_Compression_GZipStream_TypeInfo);
    System_IO_Compression_GZipStream___ctor_70437396(v7, (System_IO_Stream_o *)v6, 0, 0LL);
    Bytes_k__BackingField = p_fields->_Bytes_k__BackingField;
    if ( !p_fields->_Bytes_k__BackingField )
      sub_1C2E388(v8, 0LL);
    if ( !v7 )
      sub_1C2E388(v8, Bytes_k__BackingField);
    ...
    {
LABEL_10:
      v13 = sub_1C8010C(v7, System_IDisposable_TypeInfo, 0LL);
    }
    ...
    sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields, v16, v17, v18, v19, v20, v21, v22);
    v23 = v6->klass;
    ...
    {
LABEL_17:
      v26 = sub_1C8010C(v6, System_IDisposable_TypeInfo, 0LL);
    }
...
Il2CppObject *__fastcall ByteCompressor__UnpackMiniMessagePack_object_(
        ByteCompressor_o *this,
        const MethodInfo_2FC43C0 *method)
{
  ...
  {
    sub_1C2E12C(&MiniMessagePack_MiniMessagePacker_TypeInfo, method);
    if ( !method->rgctx_data )
      sub_1C80064(method);
  }
  v4 = (MiniMessagePack_MiniMessagePacker_o *)sub_1C2E378(MiniMessagePack_MiniMessagePacker_TypeInfo);
  ...
  return MiniMessagePack_MiniMessagePacker__UnpackClass_object_(
           ...
           (const MethodInfo_30519C0 *)method->rgctx_data->_0_MiniMessagePack_MiniMessagePacker_UnpackClass_T_);
}
