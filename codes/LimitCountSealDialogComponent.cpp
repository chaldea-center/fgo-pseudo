        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FC24E & 1) == 0 )
  {
    ...
    sub_B16FFC(&Method_LimitCountSealDialogComponent_EndClose__, v10);
    byte_40FC24E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FC24A & 1) == 0 )
  {
    sub_B16FFC(&LimitCountSealDialogComponent_CallbackFunc_TypeInfo, value);
    byte_40FC24A = 1;
  }
  callbackFunc = this->fields.callbackFunc;
        ...
        const MethodInfo *method)
{
  ...
  LimitCountSealDialogComponent_CallbackFunc_o *v17; // x8
  __int64 *v18; // x20
  __int64 v19; // x21
  ...
  _DWORD *v27; // x11
  LimitCountSealDialogComponent_CallbackFunc_o *v28; // [xsp+8h] [xbp-38h] BYREF
