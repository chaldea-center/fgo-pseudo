        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AF1D9 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_LimitCountSealDialogComponent_EndClose__);
    byte_42AF1D9 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v11 = (LimitCountSealDialogComponent_o *)sub_B52D50(v8);
        ...
        const MethodInfo *method)
{
  ...
  LimitCountSealDialogComponent_CallbackFunc_o *v19; // x8
  __int64 *v20; // x20
  __int64 v21; // x21
  ...
  _DWORD *v30; // x11
  LimitCountSealDialogComponent_CallbackFunc_o *v31; // [xsp+8h] [xbp-38h] BYREF
