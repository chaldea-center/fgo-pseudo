        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B20414 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_LimitCountSealDialogComponent_EndClose__, v6);
    byte_4B20414 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B20410 & 1) == 0 )
  {
    sub_1BCAFF8(&LimitCountSealDialogComponent_CallbackFunc_TypeInfo, value);
    byte_4B20410 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A19DD4;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A19D94;
}
