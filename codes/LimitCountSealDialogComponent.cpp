        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A646 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_LimitCountSealDialogComponent_EndClose__, v10);
    byte_4B6A646 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A642 & 1) == 0 )
  {
    sub_1BE4ACC(&LimitCountSealDialogComponent_CallbackFunc_TypeInfo, value);
    byte_4B6A642 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A2B340;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A2B300;
}
