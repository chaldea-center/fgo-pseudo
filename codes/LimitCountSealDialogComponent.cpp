        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A023A7 & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_LimitCountSealDialogComponent_EndClose__, v6);
    byte_4A023A7 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A023A3 & 1) == 0 )
  {
    sub_1B64A00(&LimitCountSealDialogComponent_CallbackFunc_TypeInfo, value);
    byte_4A023A3 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19B0F80;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19B0F40;
}
