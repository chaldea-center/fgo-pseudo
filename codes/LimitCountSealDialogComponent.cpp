        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C25AEB & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_LimitCountSealDialogComponent_EndClose__, v10);
    byte_4C25AEB = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C25AE7 & 1) == 0 )
  {
    sub_1C3B764(&LimitCountSealDialogComponent_CallbackFunc_TypeInfo, value);
    byte_4C25AE7 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A80ED0;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A80E90;
}
