        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0C4FF & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_LimitCountSealDialogComponent_EndClose__, v6);
    byte_4A0C4FF = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0C4FB & 1) == 0 )
  {
    sub_1B686D4(&LimitCountSealDialogComponent_CallbackFunc_TypeInfo, value);
    byte_4A0C4FB = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19B4BE8;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19B4BA8;
}
