        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B488F9 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_LimitCountSealDialogComponent_EndClose__, v6);
    byte_4B488F9 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B488F5 & 1) == 0 )
  {
    sub_1BDB878(&LimitCountSealDialogComponent_CallbackFunc_TypeInfo, value);
    byte_4B488F5 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A29A38;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A299F8;
}
