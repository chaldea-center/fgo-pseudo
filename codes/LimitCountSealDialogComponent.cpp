        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A52214 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_LimitCountSealDialogComponent_EndClose__, v6);
    byte_4A52214 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A52210 & 1) == 0 )
  {
    sub_1B863B8(&LimitCountSealDialogComponent_CallbackFunc_TypeInfo, value);
    byte_4A52210 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19D735C;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19D731C;
}
