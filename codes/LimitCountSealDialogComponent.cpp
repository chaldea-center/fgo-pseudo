        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C012BD & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_LimitCountSealDialogComponent_EndClose__, v10);
    byte_4C012BD = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C012B9 & 1) == 0 )
  {
    sub_1C2E12C(&LimitCountSealDialogComponent_CallbackFunc_TypeInfo, value);
    byte_4C012B9 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A73E18;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A73DD8;
}
