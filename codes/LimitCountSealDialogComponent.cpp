        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05ED2 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_LimitCountSealDialogComponent_EndClose__, v6);
    byte_4B05ED2 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05ECE & 1) == 0 )
  {
    sub_1BC3008(&LimitCountSealDialogComponent_CallbackFunc_TypeInfo, value);
    byte_4B05ECE = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A11F78;
LABEL_6:
