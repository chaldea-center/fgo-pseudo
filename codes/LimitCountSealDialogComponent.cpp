        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2339B & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_LimitCountSealDialogComponent_EndClose__, v6);
    byte_4A2339B = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A23397 & 1) == 0 )
  {
    sub_1B715CC(&LimitCountSealDialogComponent_CallbackFunc_TypeInfo, value);
    byte_4A23397 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19BD798;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19BD758;
}
