        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BEA30 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_LimitCountSealDialogComponent_EndClose__, v6);
    byte_49BEA30 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BEA2C & 1) == 0 )
  {
    sub_1B4CF90(&LimitCountSealDialogComponent_CallbackFunc_TypeInfo, value);
    byte_49BEA2C = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19A0C94;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19A0C54;
}
