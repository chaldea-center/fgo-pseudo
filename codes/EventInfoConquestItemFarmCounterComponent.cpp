        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E05DDD & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_5600/*"EVENT_CONQUEST_FARM_ITEM_FORMAT"*/);
    sub_1CE6700(&StringLiteral_5601/*"EVENT_CONQUEST_FARM_PRODUCT_FORMAT"*/);
    byte_4E05DDD = 1;
  }
  itemNumLabel = this->fields.itemNumLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v10 = LocalizationManager__Get((System_String_o *)StringLiteral_5600/*"EVENT_CONQUEST_FARM_ITEM_FORMAT"*/, 0);
  v18 = itemNum;
  ...
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_5601/*"EVENT_CONQUEST_FARM_PRODUCT_FORMAT"*/, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(itemNumTitleLabel, 0, 0) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v5 = LocalizationManager__Get((System_String_o *)StringLiteral_5600/*"EVENT_CONQUEST_FARM_ITEM_FORMAT"*/, 0);
    if ( !v4 )
      goto LABEL_20;
  ...
  if ( UnityEngine_Object__op_Inequality(productNumTitleLabel, 0, 0) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v5 = LocalizationManager__Get((System_String_o *)StringLiteral_5601/*"EVENT_CONQUEST_FARM_PRODUCT_FORMAT"*/, 0);
    if ( v8 )
    {
