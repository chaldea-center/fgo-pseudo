void __fastcall QuestRewardHeelPortraitAction___ctor(QuestRewardHeelPortraitAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A05CFE & 1) == 0 )
  {
    sub_1B686D4(&StringLiteral_6202/*"EventUI/Prefabs/"*/, method);
    byte_4A05CFE = 1;
  }
  *(_QWORD *)&this->fields.screenTouchInfoPosY = 0x40000000FFFFFF23LL;
  v5 = StringLiteral_6202/*"EventUI/Prefabs/"*/;
  this->fields.loadAssetName = (struct System_String_o *)StringLiteral_6202/*"EventUI/Prefabs/"*/;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.loadAssetName, v5, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A05CFA & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_QuestRewardHeelPortraitAction___c__DisplayClass14_0__LoadEventUI_b__0__, v6);
    sub_1B686D4(&QuestRewardHeelPortraitAction___c__DisplayClass14_0_TypeInfo, v7);
    byte_4A05CFA = 1;
  }
  v8 = sub_1B68920(QuestRewardHeelPortraitAction___c__DisplayClass14_0_TypeInfo);
  ...
  *(_QWORD *)(v8 + 24) = callback;
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)(v8 + 24), (int32_t)callback, v14, v15);
  ...
  else
  {
    ...
    v19 = System_String__Concat_61419468(loadAssetName, v18, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A05CFD & 1) == 0 )
  {
    sub_1B686D4(&QuestRewardHeelPortraitAction__Play_d__17_TypeInfo, endAction);
    byte_4A05CFD = 1;
  }
  v5 = sub_1B68920(QuestRewardHeelPortraitAction__Play_d__17_TypeInfo);
  System_Object___ctor((Il2CppObject *)v5, 0LL);
  *(_DWORD *)(v5 + 16) = 0;
  *(_QWORD *)(v5 + 32) = this;
  sub_1B68678((ServantStatusBattleListViewItem_o *)(v5 + 32), (int32_t)this, v6, v7);
  *(_QWORD *)(v5 + 40) = endAction;
  sub_1B68678((ServantStatusBattleListViewItem_o *)(v5 + 40), (int32_t)endAction, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.eventUIAssetData, 0, v4, v5);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A05CFC & 1) == 0 )
  {
    sub_1B686D4(&Method_System_Array_Sort_QuestRewardInfo___, infos);
    sub_1B686D4(&AtlasManager_TypeInfo, v5);
    sub_1B686D4(&System_Comparison_QuestRewardInfo__TypeInfo, v6);
    sub_1B686D4(&Method_UnityEngine_Component_GetComponent_UIGrid___, v7);
    sub_1B686D4(&System_Convert_TypeInfo, v8);
    sub_1B686D4(&Method_DataManager_GetMaster_HeelPortraitMaster___, v9);
    sub_1B686D4(&DataManager_TypeInfo, v10);
    sub_1B686D4(&Method_DataMasterBase_HeelPortraitMaster__HeelPortraitEntity__int__TryGetEntity__, v11);
    sub_1B686D4(&Method_UnityEngine_GameObject_GetComponent_ScreenTouchInformationComponent___, v12);
    ...
    sub_1B686D4(&Method_QuestRewardHeelPortraitAction___c__Setup_b__16_0__, v17);
    sub_1B686D4(&QuestRewardHeelPortraitAction___c_TypeInfo, v18);
    byte_4A05CFC = 1;
  }
  ...
  if ( !_9__16_0 )
  {
    ...
    _9__16_0 = (System_Comparison_T__o *)sub_1B68920(System_Comparison_QuestRewardInfo__TypeInfo);
    ...
    sub_1B68678((ServantStatusBattleListViewItem_o *)&static_fields->__9__16_0, (int32_t)_9__16_0, v23, v24);
  }
  System_Array__Sort_object__48332392(
    (System_Object_array *)infos,
    _9__16_0,
    (const MethodInfo_2E17E68 *)Method_System_Array_Sort_QuestRewardInfo___);
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (__int64)DataManager__GetMaster_object_((const MethodInfo_2E49CFC *)Method_DataManager_GetMaster_HeelPortraitMaster___);
  if ( !infos )
    goto LABEL_49;
  ...
  if ( (int)v27 >= 1 )
  {
    ...
    do
    {
      ...
      if ( v31 && v31->fields.type == 15 )
      {
        ...
        if ( !byte_4A03901 )
        {
          Master_object = sub_1B686D4(&UnityEngine_Vector3_TypeInfo, v26);
          byte_4A03901 = 1;
        }
        if ( !v34 )
          goto LABEL_49;
        ...
        Master_object = DataMasterBase_object__object__int___TryGetEntity(
                          ...
                          &entity,
                          v31->fields.objectId,
                          (const MethodInfo_30E4514 *)Method_DataMasterBase_HeelPortraitMaster__HeelPortraitEntity__int__TryGetEntity__);
        if ( (Master_object & 1) != 0 )
        {
          ...
          v39 = System_Convert__ToString_62085048(klass, 0LL);
          if ( !AtlasManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
          AtlasManager__SetEventUI_37606672(eventId, v36, v39, 0LL);
          this = v47;
        }
...
void __fastcall QuestRewardHeelPortraitAction__Update(QuestRewardHeelPortraitAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A05CF9 & 1) == 0 )
  {
    ...
    sub_1B686D4(&CTouch_TypeInfo, v4);
    sub_1B686D4(&Method_QuestRewardHeelPortraitAction__Update_b__11_0__, v5);
    sub_1B686D4(&Method_QuestRewardHeelPortraitAction_Update__, v6);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( CTouch__isTouchPush(0LL) )
    {
      ...
      if ( (*((_BYTE *)Method_QuestRewardHeelPortraitAction_Update__ + 83) & 2) != 0 )
        v10 = (_QWORD *)sub_1B686EC(Method_QuestRewardHeelPortraitAction_Update__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A05D01 & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_QuestRewardHeelPortraitAction__Play_d__17_MoveNext__, v6);
    sub_1B686D4(&UnityEngine_WaitForSeconds_TypeInfo, v7);
    this = (QuestRewardHeelPortraitAction__Play_d__17_o *)sub_1B686D4(&StringLiteral_16813/*"ar236"*/, v8);
    byte_4A05D01 = 1;
  }
  ...
  else
  {
    if ( !_1__state )
    {
      ...
      if ( _4__this )
      {
        ...
        sub_1B68678((ServantStatusBattleListViewItem_o *)&_4__this->fields.endAct, (int32_t)endAction, v2, v3);
        this = (QuestRewardHeelPortraitAction__Play_d__17_o *)UnityEngine_Component__get_gameObject(
        ...
        if ( this )
        {
          ...
          if ( (*((_BYTE *)Method_QuestRewardHeelPortraitAction__Play_d__17_MoveNext__ + 83) & 2) != 0 )
            v12 = (_QWORD *)sub_1B686EC(Method_QuestRewardHeelPortraitAction__Play_d__17_MoveNext__);
          v13 = (System_Reflection_MethodBase_o *)sub_1B686B8(v12, v12[4]);
          OverwriteAssetSoundName__PlaySe(v13, (System_String_o *)StringLiteral_16813/*"ar236"*/, 0LL);
          this = (QuestRewardHeelPortraitAction__Play_d__17_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36F769C *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
          v14 = (CommonUI_o *)this;
          if ( !AvalonSceneManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AvalonSceneManager_TypeInfo);
          if ( v14 )
          {
            ...
            v16 = (UnityEngine_WaitForSeconds_o *)sub_1B68920(UnityEngine_WaitForSeconds_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B686E8(&Method_QuestRewardHeelPortraitAction__Play_d__17_System_Collections_IEnumerator_Reset__);
  sub_1B687FC(v3, v4);
}
...
void __fastcall QuestRewardHeelPortraitAction___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A05CFF & 1) == 0 )
  {
    sub_1B686D4(&QuestRewardHeelPortraitAction___c_TypeInfo, v1);
    byte_4A05CFF = 1;
  }
  v2 = (Il2CppObject *)sub_1B68920(QuestRewardHeelPortraitAction___c_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A05D00 & 1) == 0 )
  {
    ...
    this = (QuestRewardHeelPortraitAction___c__DisplayClass14_0_o *)sub_1B686D4(
