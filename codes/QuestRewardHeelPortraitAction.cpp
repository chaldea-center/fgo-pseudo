void __fastcall QuestRewardHeelPortraitAction___ctor(QuestRewardHeelPortraitAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49F94DA & 1) == 0 )
  {
    sub_1B640C8(&StringLiteral_6201/*"EventUI/Prefabs/"*/, method);
    byte_49F94DA = 1;
  }
  *(_QWORD *)&this->fields.screenTouchInfoPosY = 0x40000000FFFFFF23LL;
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.loadAssetName, v5, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F94D6 & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_QuestRewardHeelPortraitAction___c__DisplayClass14_0__LoadEventUI_b__0__, v6);
    sub_1B640C8(&QuestRewardHeelPortraitAction___c__DisplayClass14_0_TypeInfo, v7);
    byte_49F94D6 = 1;
  }
  v8 = sub_1B64314(QuestRewardHeelPortraitAction___c__DisplayClass14_0_TypeInfo, callback, method);
  ...
  *(_QWORD *)(v8 + 24) = callback;
  v12 = (System_Action_o **)(v8 + 24);
  sub_1B6406C((ServantStatusBattleListViewItem_o *)(v8 + 24), (int32_t)callback, v13, v14);
  ...
  else
  {
    ...
    v17 = System_Int32__ToString((int)this + 88, 0LL);
    v18 = System_String__Concat_61375396(loadAssetName, v17, 0LL);
    ...
    AssetManager__loadAssetStorage(v18, v21, 1, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F94D9 & 1) == 0 )
  {
    sub_1B640C8(&QuestRewardHeelPortraitAction__Play_d__17_TypeInfo, endAction);
    byte_49F94D9 = 1;
  }
  v5 = sub_1B64314(QuestRewardHeelPortraitAction__Play_d__17_TypeInfo, endAction, method);
  System_Object___ctor((Il2CppObject *)v5, 0LL);
  *(_DWORD *)(v5 + 16) = 0;
  *(_QWORD *)(v5 + 32) = this;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)(v5 + 32), (int32_t)this, v6, v7);
  *(_QWORD *)(v5 + 40) = endAction;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)(v5 + 40), (int32_t)endAction, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.eventUIAssetData, 0, v4, v5);
}
        ...
        const MethodInfo *method)
{
  ...
  int32_t v47; // w3
  UnityEngine_GameObject_o *gameObject; // x0
  QuestRewardHeelPortraitAction_o *v49; // [xsp+8h] [xbp-78h]
  ...
  if ( (byte_49F94D8 & 1) == 0 )
  {
    ...
    sub_1B640C8(&System_Comparison_QuestRewardInfo__TypeInfo, v6);
    sub_1B640C8(&Method_UnityEngine_Component_GetComponent_UIGrid___, v7);
    sub_1B640C8(&System_Convert_TypeInfo, v8);
    sub_1B640C8(&Method_DataManager_GetMaster_HeelPortraitMaster___, v9);
    sub_1B640C8(&DataManager_TypeInfo, v10);
    sub_1B640C8(&Method_DataMasterBase_HeelPortraitMaster__HeelPortraitEntity__int__TryGetEntity__, v11);
    sub_1B640C8(&Method_UnityEngine_GameObject_GetComponent_ScreenTouchInformationComponent___, v12);
    sub_1B640C8(&Method_UnityEngine_GameObject_GetComponent_UISprite___, v13);
    ...
    sub_1B640C8(&Method_QuestRewardHeelPortraitAction___c__Setup_b__16_0__, v17);
    sub_1B640C8(&QuestRewardHeelPortraitAction___c_TypeInfo, v18);
    byte_49F94D8 = 1;
  }
  ...
  if ( !_9__16_0 )
  {
    ...
    _9__16_0 = (System_Comparison_T__o *)sub_1B64314(System_Comparison_QuestRewardInfo__TypeInfo, infos, method);
    ...
    sub_1B6406C((ServantStatusBattleListViewItem_o *)&static_fields->__9__16_0, (int32_t)_9__16_0, v23, v24);
  }
  ...
  Master_object = (__int64)DataManager__GetMaster_object_((const MethodInfo_2E39398 *)Method_DataManager_GetMaster_HeelPortraitMaster___);
  if ( !infos )
    goto LABEL_49;
  ...
  if ( (int)v27 >= 1 )
  {
    ...
    do
    {
      ...
      if ( v31 && v31->fields.type == 15 )
      {
        ...
        if ( !byte_49F7111 )
        {
          Master_object = sub_1B640C8(&UnityEngine_Vector3_TypeInfo, v34);
          byte_49F7111 = 1;
        }
        if ( !v35 )
          goto LABEL_49;
        ...
        Master_object = (__int64)UnityEngine_GameObject__get_transform(v33, 0LL);
        v37 = (UnityEngine_Transform_o *)Master_object;
        if ( !byte_49F7116 )
        {
          Master_object = sub_1B640C8(&UnityEngine_Vector3_TypeInfo, v36);
          byte_49F7116 = 1;
        }
        if ( !v37 )
          goto LABEL_49;
        ...
        if ( !v28 )
          goto LABEL_49;
        v38 = (UISprite_o *)Master_object;
        Master_object = DataMasterBase_object__object__int___TryGetEntity(
                          v28,
                          &entity,
                          v31->fields.objectId,
                          (const MethodInfo_30D3EF8 *)Method_DataMasterBase_HeelPortraitMaster__HeelPortraitEntity__int__TryGetEntity__);
        if ( (Master_object & 1) != 0 )
        {
          ...
          v41 = System_Convert__ToString_62040968(klass, 0LL);
          if ( !AtlasManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
...
void __fastcall QuestRewardHeelPortraitAction__Update(QuestRewardHeelPortraitAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49F94D5 & 1) == 0 )
  {
    ...
    sub_1B640C8(&CTouch_TypeInfo, v4);
    sub_1B640C8(&Method_QuestRewardHeelPortraitAction__Update_b__11_0__, v5);
    sub_1B640C8(&Method_QuestRewardHeelPortraitAction_Update__, v6);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( CTouch__isTouchPush(0LL) )
    {
      ...
      if ( (*((_BYTE *)Method_QuestRewardHeelPortraitAction_Update__ + 83) & 2) != 0 )
        v9 = (_QWORD *)sub_1B640E0(Method_QuestRewardHeelPortraitAction_Update__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F94DD & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_QuestRewardHeelPortraitAction__Play_d__17_MoveNext__, v6);
    sub_1B640C8(&UnityEngine_WaitForSeconds_TypeInfo, v7);
    this = (QuestRewardHeelPortraitAction__Play_d__17_o *)sub_1B640C8(&StringLiteral_16810/*"ar236"*/, v8);
    byte_49F94DD = 1;
  }
  ...
  else
  {
    if ( !_1__state )
    {
      ...
      if ( _4__this )
      {
        ...
        sub_1B6406C((ServantStatusBattleListViewItem_o *)&_4__this->fields.endAct, (int32_t)endAction, v2, v3);
        this = (QuestRewardHeelPortraitAction__Play_d__17_o *)UnityEngine_Component__get_gameObject(
        ...
        if ( this )
        {
          ...
          if ( (*((_BYTE *)Method_QuestRewardHeelPortraitAction__Play_d__17_MoveNext__ + 83) & 2) != 0 )
            v12 = (_QWORD *)sub_1B640E0(Method_QuestRewardHeelPortraitAction__Play_d__17_MoveNext__);
          v13 = (System_Reflection_MethodBase_o *)sub_1B640AC(v12, v12[4]);
          OverwriteAssetSoundName__PlaySe(v13, (System_String_o *)StringLiteral_16810/*"ar236"*/, 0LL);
          this = (QuestRewardHeelPortraitAction__Play_d__17_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EC03C *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
          v14 = (CommonUI_o *)this;
          if ( !AvalonSceneManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AvalonSceneManager_TypeInfo);
          if ( v14 )
          {
            ...
            v18 = (UnityEngine_WaitForSeconds_o *)sub_1B64314(UnityEngine_WaitForSeconds_TypeInfo, v16, v17);
            UnityEngine_WaitForSeconds___ctor(v18, dispTouchWaitTime, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  v6 = sub_1B640DC(&Method_QuestRewardHeelPortraitAction__Play_d__17_System_Collections_IEnumerator_Reset__);
  sub_1B641F0(v5, v6);
}
...
void __fastcall QuestRewardHeelPortraitAction___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49F94DB & 1) == 0 )
  {
    sub_1B640C8(&QuestRewardHeelPortraitAction___c_TypeInfo, v1);
    byte_49F94DB = 1;
  }
  v3 = (Il2CppObject *)sub_1B64314(QuestRewardHeelPortraitAction___c_TypeInfo, v1, v2);
  System_Object___ctor(v3, 0LL);
  QuestRewardHeelPortraitAction___c_TypeInfo->static_fields->__9 = (struct QuestRewardHeelPortraitAction___c_o *)v3;
  sub_1B6406C(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F94DC & 1) == 0 )
  {
    ...
    this = (QuestRewardHeelPortraitAction___c__DisplayClass14_0_o *)sub_1B640C8(
  ...
  if ( !_9__1 )
  {
    _9__1 = (System_Action_o *)sub_1B64314(System_Action_TypeInfo, assetData, method);
