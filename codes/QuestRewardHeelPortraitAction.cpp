void __fastcall QuestRewardHeelPortraitAction___ctor(QuestRewardHeelPortraitAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B192E9 & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_6217/*"EventUI/Prefabs/"*/, method);
    byte_4B192E9 = 1;
  }
  *(_QWORD *)&this->fields.screenTouchInfoPosY = 0x40000000FFFFFF23LL;
  v5 = StringLiteral_6217/*"EventUI/Prefabs/"*/;
  this->fields.loadAssetName = (struct System_String_o *)StringLiteral_6217/*"EventUI/Prefabs/"*/;
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.loadAssetName, v5, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B192E5 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_QuestRewardHeelPortraitAction___c__DisplayClass14_0__LoadEventUI_b__0__, v6);
    sub_1BCAFF8(&QuestRewardHeelPortraitAction___c__DisplayClass14_0_TypeInfo, v7);
    byte_4B192E5 = 1;
  }
  v8 = sub_1BCB244(QuestRewardHeelPortraitAction___c__DisplayClass14_0_TypeInfo);
  ...
  *(_QWORD *)(v8 + 24) = callback;
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)(v8 + 24), (int32_t)callback, v14, v15);
  ...
  else
  {
    ...
    v19 = System_String__Concat_62450424(loadAssetName, v18, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B192E8 & 1) == 0 )
  {
    sub_1BCAFF8(&QuestRewardHeelPortraitAction__Play_d__17_TypeInfo, endAction);
    byte_4B192E8 = 1;
  }
  v5 = sub_1BCB244(QuestRewardHeelPortraitAction__Play_d__17_TypeInfo);
  System_Object___ctor((Il2CppObject *)v5, 0LL);
  *(_DWORD *)(v5 + 16) = 0;
  *(_QWORD *)(v5 + 32) = this;
  sub_1BCAF9C((CGThumbnailListItem_o *)(v5 + 32), (int32_t)this, v6, v7);
  *(_QWORD *)(v5 + 40) = endAction;
  sub_1BCAF9C((CGThumbnailListItem_o *)(v5 + 40), (int32_t)endAction, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.eventUIAssetData, 0, v4, v5);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B192E7 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_System_Array_Sort_QuestRewardInfo___, infos);
    sub_1BCAFF8(&AtlasManager_TypeInfo, v5);
    sub_1BCAFF8(&System_Comparison_QuestRewardInfo__TypeInfo, v6);
    sub_1BCAFF8(&Method_UnityEngine_Component_GetComponent_UIGrid___, v7);
    sub_1BCAFF8(&System_Convert_TypeInfo, v8);
    sub_1BCAFF8(&Method_DataManager_GetMaster_HeelPortraitMaster___, v9);
    sub_1BCAFF8(&DataManager_TypeInfo, v10);
    sub_1BCAFF8(&Method_DataMasterBase_HeelPortraitMaster__HeelPortraitEntity__int__TryGetEntity__, v11);
    sub_1BCAFF8(&Method_UnityEngine_GameObject_GetComponent_ScreenTouchInformationComponent___, v12);
    ...
    sub_1BCAFF8(&Method_QuestRewardHeelPortraitAction___c__Setup_b__16_0__, v17);
    sub_1BCAFF8(&QuestRewardHeelPortraitAction___c_TypeInfo, v18);
    byte_4B192E7 = 1;
  }
  ...
  if ( !_9__16_0 )
  {
    ...
    _9__16_0 = (System_Comparison_T__o *)sub_1BCB244(System_Comparison_QuestRewardInfo__TypeInfo);
    ...
    sub_1BCAF9C((CGThumbnailListItem_o *)&static_fields->__9__16_0, (int32_t)_9__16_0, v23, v24);
  }
  System_Array__Sort_object__50232124(
    (System_Object_array *)infos,
    _9__16_0,
    (const MethodInfo_2FE7B3C *)Method_System_Array_Sort_QuestRewardInfo___);
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (__int64)DataManager__GetMaster_object_((const MethodInfo_301AA50 *)Method_DataManager_GetMaster_HeelPortraitMaster___);
  if ( !infos )
    goto LABEL_49;
  ...
  if ( (int)v28 >= 1 )
  {
    ...
    do
    {
      if ( v30 >= (unsigned int)v28 )
        sub_1BCB25C(Master_object, v26, v27);
      v32 = m_Items[v30];
      if ( v32 && v32->fields.type == 15 )
      {
        ...
        if ( !byte_4B16191 )
        {
          Master_object = sub_1BCAFF8(&UnityEngine_Vector3_TypeInfo, v26);
          byte_4B16191 = 1;
        }
        if ( !v35 )
          goto LABEL_49;
        ...
        Master_object = DataMasterBase_object__object__int___TryGetEntity(
                          ...
                          &entity,
                          v32->fields.objectId,
                          (const MethodInfo_32C7E4C *)Method_DataMasterBase_HeelPortraitMaster__HeelPortraitEntity__int__TryGetEntity__);
        if ( (Master_object & 1) != 0 )
        {
          ...
          v40 = System_Convert__ToString_63544936(klass, 0LL);
          if ( !AtlasManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
          AtlasManager__SetEventUI_39794720(eventId, v37, v40, 0LL);
          this = v48;
        }
    ...
    if ( Instance )
    {
      ...
      if ( Master_object )
      {
        ...
        *p_screenTouchInfo = (struct ScreenTouchInformationComponent_o *)Component_object;
        sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.screenTouchInfo, (int32_t)Component_object, v45, v46);
        goto LABEL_45;
      }
    }
LABEL_49:
...
void __fastcall QuestRewardHeelPortraitAction__Update(QuestRewardHeelPortraitAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B192E4 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&CTouch_TypeInfo, v4);
    sub_1BCAFF8(&Method_QuestRewardHeelPortraitAction__Update_b__11_0__, v5);
    sub_1BCAFF8(&Method_QuestRewardHeelPortraitAction_Update__, v6);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( CTouch__isTouchPush(0LL) )
    {
      ...
      if ( (*((_BYTE *)Method_QuestRewardHeelPortraitAction_Update__ + 83) & 2) != 0 )
        v10 = (_QWORD *)sub_1BCB010(Method_QuestRewardHeelPortraitAction_Update__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B192EC & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_QuestRewardHeelPortraitAction__Play_d__17_MoveNext__, v6);
    sub_1BCAFF8(&UnityEngine_WaitForSeconds_TypeInfo, v7);
    this = (QuestRewardHeelPortraitAction__Play_d__17_o *)sub_1BCAFF8(&StringLiteral_16721/*"ar236"*/, v8);
    byte_4B192EC = 1;
  }
  ...
  else
  {
    if ( !_1__state )
    {
      ...
      if ( _4__this )
      {
        ...
        sub_1BCAF9C((CGThumbnailListItem_o *)&_4__this->fields.endAct, (int32_t)endAction, v2, v3);
        this = (QuestRewardHeelPortraitAction__Play_d__17_o *)UnityEngine_Component__get_gameObject(
        ...
        if ( this )
        {
          ...
          if ( (*((_BYTE *)Method_QuestRewardHeelPortraitAction__Play_d__17_MoveNext__ + 83) & 2) != 0 )
            v12 = (_QWORD *)sub_1BCB010(Method_QuestRewardHeelPortraitAction__Play_d__17_MoveNext__);
          v13 = (System_Reflection_MethodBase_o *)sub_1BCAFDC(v12, v12[4]);
          OverwriteAssetSoundName__PlaySe(v13, (System_String_o *)StringLiteral_16721/*"ar236"*/, 0, 0LL);
          this = (QuestRewardHeelPortraitAction__Play_d__17_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38F8AD8 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
          v14 = (CommonUI_o *)this;
          if ( !AvalonSceneManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AvalonSceneManager_TypeInfo);
          if ( v14 )
          {
            ...
            v16 = (UnityEngine_WaitForSeconds_o *)sub_1BCB244(UnityEngine_WaitForSeconds_TypeInfo);
            UnityEngine_WaitForSeconds___ctor(v16, dispTouchWaitTime, 0LL);
            v4->fields.__2__current = (Il2CppObject *)v16;
            p__2__current = (CGThumbnailListItem_o *)&v4->fields.__2__current;
            sub_1BCAF9C(p__2__current, (int32_t)v16, v18, v19);
            result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BCB00C(&Method_QuestRewardHeelPortraitAction__Play_d__17_System_Collections_IEnumerator_Reset__);
  sub_1BCB120(v3, v4);
}
...
void __fastcall QuestRewardHeelPortraitAction___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B192EA & 1) == 0 )
  {
    sub_1BCAFF8(&QuestRewardHeelPortraitAction___c_TypeInfo, v1);
    byte_4B192EA = 1;
  }
  v2 = (Il2CppObject *)sub_1BCB244(QuestRewardHeelPortraitAction___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  QuestRewardHeelPortraitAction___c_TypeInfo->static_fields->__9 = (struct QuestRewardHeelPortraitAction___c_o *)v2;
  sub_1BCAF9C((CGThumbnailListItem_o *)QuestRewardHeelPortraitAction___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B192EB & 1) == 0 )
  {
    ...
    this = (QuestRewardHeelPortraitAction___c__DisplayClass14_0_o *)sub_1BCAFF8(
  ...
  if ( !_9__1 )
  {
    ...
    sub_1BCAF9C((CGThumbnailListItem_o *)&v3->fields.__9__1, (int32_t)_9__1, v9, v10);
  }
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
