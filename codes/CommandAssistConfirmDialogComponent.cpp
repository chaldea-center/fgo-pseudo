        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D26322 & 1) == 0 )
  {
    sub_1C94098(&Method_CommandAssistConfirmDialogComponent_OnClickCloseButton__);
    byte_4D26322 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CommandAssistConfirmDialogComponent_OnClickCloseButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C940B0(Method_CommandAssistConfirmDialogComponent_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D26321 & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_CommandAssistConfirmDialogComponent__Open_b__11_0__);
    sub_1C94098(&LocalizationManager_TypeInfo);
    sub_1C94098(&UnityEngine_Object_TypeInfo);
    sub_1C94098(&StringLiteral_5556/*"EVENT_COMMAND_ASSIST_CONFIRM_DIALOG_MESSAGE"*/);
    sub_1C94098(&StringLiteral_3690/*"COMMON_CONFIRM_CLOSE"*/);
    sub_1C94098(&StringLiteral_5557/*"EVENT_COMMAND_ASSIST_CONFIRM_DIALOG_TITLE"*/);
    byte_4D26321 = 1;
  }
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5557/*"EVENT_COMMAND_ASSIST_CONFIRM_DIALOG_TITLE"*/, 0);
  if ( !titleLabel )
    goto LABEL_15;
  UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0);
  messageLabel = this->fields.messageLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5556/*"EVENT_COMMAND_ASSIST_CONFIRM_DIALOG_MESSAGE"*/, 0);
  if ( !messageLabel )
    goto LABEL_15;
