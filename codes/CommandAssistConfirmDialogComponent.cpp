        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B7641C(titleLabel, v3);
  }
  UILabel__set_text(titleLabel, (System_String_o *)StringLiteral_1/*""*/, 0LL);
  this->fields.closeCallback = 0LL;
  sub_1B76164(&this->fields.closeCallback);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A28FD2 & 1) == 0 )
  {
    sub_1B761C0(&Method_CommandAssistConfirmDialogComponent_OnClickCloseButton__, method);
    byte_4A28FD2 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A28FD1 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_CommandAssistConfirmDialogComponent__Open_b__11_0__, v7);
    sub_1B761C0(&LocalizationManager_TypeInfo, v8);
    sub_1B761C0(&UnityEngine_Object_TypeInfo, v9);
    sub_1B761C0(&StringLiteral_5575/*"EVENT_COMMAND_ASSIST_CONFIRM_DIALOG_MESSAGE"*/, v10);
    sub_1B761C0(&StringLiteral_3755/*"COMMON_CONFIRM_CLOSE"*/, v11);
    sub_1B761C0(&StringLiteral_5576/*"EVENT_COMMAND_ASSIST_CONFIRM_DIALOG_TITLE"*/, v12);
    byte_4A28FD1 = 1;
  }
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5576/*"EVENT_COMMAND_ASSIST_CONFIRM_DIALOG_TITLE"*/, 0LL);
  if ( !titleLabel )
    goto LABEL_15;
  UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL);
  messageLabel = this->fields.messageLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5575/*"EVENT_COMMAND_ASSIST_CONFIRM_DIALOG_MESSAGE"*/, 0LL);
  if ( !messageLabel )
    goto LABEL_15;
