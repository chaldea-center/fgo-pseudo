        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A1BA & 1) == 0 )
  {
    sub_1B761C0(&Method_System_Linq_Enumerable_Contains_int___, method);
    sub_1B761C0(&Method_RecommendSupportSelectControl_GetDialog_RecommendSupportMessageSelectDialog___, v3);
  ...
  if ( !Instance
    || (Instance = RecommendSupportSelectControl__GetDialog_object_(
                     ...
                     (const MethodInfo_2EF30D8 *)Method_RecommendSupportSelectControl_GetDialog_RecommendSupportMessageSelectDialog___)) == 0LL
