...
void __fastcall DeckListViewObject__Awake(DeckListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42E44C6 & 1) == 0 )
  {
    sub_B5D5C4(&Method_UnityEngine_GameObject_GetComponent_DeckListViewItemDraw___, (_DWORD)method, v2, v3);
    byte_42E44C6 = 1;
  }
  ...
  this->fields.itemDraw = (struct DeckListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                             dispObject,
                                                             (const MethodInfo_1CC439C *)Method_UnityEngine_GameObject_GetComponent_DeckListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  DeckListViewObject_o *v8; // x20
  const MethodInfo *v9; // x3
  UnityEngine_Vector3_o zero; // 0:s0.4,4:s1.4,8:s2.4 OVERLAPPED

  if ( (byte_42E44C9 & 1) == 0 )
  {
    sub_B5D5C4(&Method_UnityEngine_GameObject_GetComponent_DeckListViewObject___, (_DWORD)method, v2, v3);
    byte_42E44C9 = 1;
  }
  ...
  if ( !DragObject
    || (v7 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                    DragObject,
                                                    (const MethodInfo_1CC439C *)Method_UnityEngine_GameObject_GetComponent_DeckListViewObject___)) == 0LL) )
  {
    sub_B5D69C(DragObject, v6);
  }
  v8 = (DeckListViewObject_o *)DragObject;
  zero = UnityEngine_Vector3__get_zero(0LL);
  DeckListViewObject__Init(v8, 2, 0LL, zero.fields.x, *(UnityEngine_Vector3_o *)&zero.fields.y, v9);
  return v7;
}
...
DeckListViewItem_o *__fastcall DeckListViewObject__GetItem(DeckListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42E44C8 & 1) == 0 )
  {
    sub_B5D5C4(&DeckListViewItem_TypeInfo, (_DWORD)method, v2, v3);
    byte_42E44C8 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
    return 0LL;
  v6 = *(&DeckListViewItem_TypeInfo->_2.bitflags2 + 1);
  if ( *(&linkItem->klass->_2.bitflags2 + 1) < (unsigned int)v6 )
    return 0LL;
  if ( (DeckListViewItem_c *)linkItem->klass->_2.typeHierarchy[v6 - 1] == DeckListViewItem_TypeInfo )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42E44CA & 1) == 0 )
  {
    sub_B5D5C4(&DeckListViewItem_TypeInfo, initMode, (_DWORD)callbackFunc, method);
    byte_42E44CA = 1;
  }
  linkItem = this->fields.linkItem;
...
// local variable allocation has failed, the output may be wrong!
void __fastcall DeckListViewObject__Init_16943396(
        DeckListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall DeckListViewObject__Init_16944640(
        DeckListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall DeckListViewObject__Init_16944704(
        DeckListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall DeckListViewObject__SetupDisp(DeckListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( linkItem )
  {
    v9 = *(&DeckListViewItem_TypeInfo->_2.bitflags2 + 1);
    if ( BYTE4((*linkItem)[1].fields.viewObject) >= (unsigned int)v9
      && *((DeckListViewItem_c **)(*linkItem)[1].monitor + v9 - 1) == DeckListViewItem_TypeInfo )
    {
...
LABEL_8:
  ...
  if ( UnityEngine_Object__op_Inequality(itemDraw, 0LL, 0LL) )
  {
    ...
    if ( !v14 || !linkItem )
      sub_B5D69C(v14, v12);
    DeckListViewItemDraw__SetItem_16939768(v14, linkItem[14], this->fields.dispMode, v13);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  v12 = (DeckListViewObject_o *)sub_B5D990(v9);
  DeckListViewObject__remove_callbackFunc(v12, v13, v14);
}
        ...
        const MethodInfo *method)
{
  ...
  v12 = (DeckListViewObject_o *)sub_B5D990(v9);
  DeckListViewObject__Awake(v12, v13);
}