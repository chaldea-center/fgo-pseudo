...
void __fastcall DeckListViewObject__Awake(DeckListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFD927 & 1) == 0 )
  {
    sub_1BC3008(&Method_UnityEngine_GameObject_GetComponent_DeckListViewItemDraw___, method);
    byte_4AFD927 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_3055998 *)Method_UnityEngine_GameObject_GetComponent_DeckListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFD92A & 1) == 0 )
  {
    sub_1BC3008(&Method_UnityEngine_GameObject_GetComponent_DeckListViewObject___, method);
    byte_4AFD92A = 1;
  }
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_3055998 *)Method_UnityEngine_GameObject_GetComponent_DeckListViewObject___)) == 0LL) )
  {
    sub_1BC3264(DragObject, v4);
  }
  DeckListViewObject__Init_33124232((DeckListViewObject_o *)DragObject, 2, v6);
  return v5;
}
...
DeckListViewItem_o *__fastcall DeckListViewObject__GetItem(DeckListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFD929 & 1) == 0 )
  {
    sub_1BC3008(&DeckListViewItem_TypeInfo, method);
    byte_4AFD929 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFD92B & 1) == 0 )
  {
    sub_1BC3008(&DeckListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4AFD92B = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall DeckListViewObject__Init_33124232(
        DeckListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall DeckListViewObject__Init_33125540(
        DeckListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall DeckListViewObject__Init_33125624(
        DeckListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall DeckListViewObject__SetupDisp(DeckListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !linkItem )
    goto LABEL_7;
  methodPtr_low = LOBYTE(DeckListViewItem_TypeInfo->vtable._0_Equals.methodPtr);
  if ( LOBYTE((*linkItem)[1].fields.basePosition.fields.y) < (unsigned int)methodPtr_low
    || *((DeckListViewItem_c **)(*linkItem)->fields.duplicatedEquipmentUserSvtIdList + methodPtr_low - 1) != DeckListViewItem_TypeInfo )
  {
    linkItem = 0LL;
LABEL_7:
    v6 = 0;
...
LABEL_8:
  ...
  if ( UnityEngine_Object__op_Inequality(itemDraw, 0LL, 0LL) )
  {
    ...
    if ( !v10 || !linkItem )
      sub_1BC3264(v10, v8);
    DeckListViewItemDraw__SetItem_33120356(v10, linkItem[14], this->fields.dispMode, v9);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  v11 = (DeckListViewObject_o *)sub_1BC3524(v8);
