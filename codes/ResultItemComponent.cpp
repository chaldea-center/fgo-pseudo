...
LABEL_16:
  ...
  if ( count < 1 )
    ...
    v8 = count;
  ItemIconComponent__SetGift_39935088((ItemIconComponent_o *)this, v4->fields.type, v4->fields.objectId, v8, 0, 0LL);
}
  ...
  else
  {
    ...
    if ( !baseObject
      || (UnityEngine_GameObject__SetActive(baseObject, 1, 0LL),
          (baseObject = (UnityEngine_GameObject_o *)this->fields.itemIcon) == 0LL) )
    {
      sub_1BDBAD4(baseObject, *(_QWORD *)&imgId);
    }
    ItemIconComponent__SetItemImage_39932756((ItemIconComponent_o *)baseObject, imgId, bgId, -1, -1, 1, 0LL);
  }
}
...
void __fastcall ResultItemComponent__SetRareItem(ResultItemComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BDBAD4(bonusSprite, method);
  }
