...
void __fastcall ScriptFilePlayerMenu__EndPlayScriptSelectObject(ScriptFilePlayerMenu_o *this, const MethodInfo *method)
{
  ...
  __int64 v11; // x2
  __int64 v12; // x3
  ScriptPlayListViewMenu_CallbackFunc_o *v13; // x23
  ...
  if ( (byte_4B139AD & 1) == 0 )
  {
    sub_1BCA7E0(&ScriptPlayListViewMenu_CallbackFunc_TypeInfo, method, v2);
    sub_1BCA7E0(&Method_ScriptFilePlayerMenu_OnEndSelectObject__, v4, v5);
    byte_4B139AD = 1;
  }
  ...
  if ( !jumpLineObjectInput
    || (scriptPlayListViewMenu = this->fields.scriptPlayListViewMenu,
        ...
        v13 = (ScriptPlayListViewMenu_CallbackFunc_o *)sub_1BCAA2C(
                                                         ScriptPlayListViewMenu_CallbackFunc_TypeInfo,
                                                         v10,
                                                         v11,
                                                         v12),
  ...
  ScriptPlayListViewMenu__Open(scriptPlayListViewMenu, selectPlayerFilePath, v15, Text, v13, v16);
}
...
void __fastcall ScriptFilePlayerMenu__OnClickDecide(ScriptFilePlayerMenu_o *this, const MethodInfo *method)
{
  ...
  ScriptConnectData_o v57; // [xsp+0h] [xbp-A0h] BYREF
  ScriptConnectData_o v58; // [xsp+30h] [xbp-70h] BYREF

  if ( (byte_4B139AE & 1) == 0 )
  {
    sub_1BCA7E0(&System_Action_TypeInfo, method, v2);
    sub_1BCA7E0(&Gender_TypeInfo, v4, v5);
    sub_1BCA7E0(&Method_ScriptFilePlayerMenu_EndPlayScript__, v6, v7);
        ...
        if ( genderInput )
        {
          ...
          if ( startModeInput )
          {
            ...
            if ( dataScriptPathInput )
            {
              ...
              v47 = this->fields.selectPlayerFilePath;
              v48 = this->fields.selectObjectPath;
              v49 = (System_Action_o *)sub_1BCAA2C(System_Action_TypeInfo, v43, v44, v45);
              System_Action___ctor(v49, (Il2CppObject *)this, Method_ScriptFilePlayerMenu_EndPlayScript__, 0LL);
              v53 = (System_Action_o *)sub_1BCAA2C(System_Action_TypeInfo, v50, v51, v52);
              System_Action___ctor(v53, (Il2CppObject *)this, Method_ScriptFilePlayerMenu_EndPlayScript__, 0LL);
              JumpLine = ScriptFilePlayerMenu__GetJumpLine(this, v54);
              memset(&v58, 0, sizeof(v58));
              ScriptConnectData___ctor(&v58, v47, v48, v49, v53, JumpLine, 0, v56);
              if ( debugTestRootComponent )
              {
                v57 = v58;
                DebugTestRootComponent__StartFileScript(debugTestRootComponent, &v57, 0LL);
                return;
              }
            }
          }
...
void __fastcall ScriptFilePlayerMenu__OnClickSelect(ScriptFilePlayerMenu_o *this, const MethodInfo *method)
{
  ...
  __int64 v30; // x2
  __int64 v31; // x3
  ScriptPlayListViewMenu_CallbackFunc_o *v32; // x23
  ...
  if ( (byte_4B139AB & 1) == 0 )
  {
    sub_1BCA7E0(&ScriptPlayListViewMenu_CallbackFunc_TypeInfo, method, v2);
    sub_1BCA7E0(&Gender_TypeInfo, v4, v5);
    sub_1BCA7E0(&Method_ScriptFilePlayerMenu_OnEndSelectObject__, v6, v7);
    byte_4B139AB = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( !dataScriptPathInput
      || (scriptPlayListViewMenu = this->fields.scriptPlayListViewMenu,
          ...
          v32 = (ScriptPlayListViewMenu_CallbackFunc_o *)sub_1BCAA2C(
                                                           ScriptPlayListViewMenu_CallbackFunc_TypeInfo,
                                                           v29,
                                                           v30,
                                                           v31),
...
LABEL_13:
    ...
    ScriptPlayListViewMenu__Open(scriptPlayListViewMenu, selectPlayerFilePath, v34, v28, v32, v35);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B139AC & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&Method_ScriptFilePlayerMenu_EndPlayScriptSelectObject__, v13, v14);
            ...
            if ( scriptPlayListViewMenu )
            {
              ...
              if ( dataScriptObjectInput )
              {
                ...
                if ( v21 )
                {
                  ...
                  this->fields.state = 5;
                  debugTestRootComponent = this->fields.debugTestRootComponent;
                  v33 = this->fields.selectPlayerFilePath;
                  ...
                  System_Action___ctor(
                    ...
                    Method_ScriptFilePlayerMenu_EndPlayScriptSelectObject__,
                    0LL);
                  JumpLine = ScriptFilePlayerMenu__GetJumpLine(this, v40);
                  memset(&v44, 0, sizeof(v44));
                  ScriptConnectData___ctor(&v44, v33, v34, v35, v39, JumpLine, result == 3, v42);
                  if ( debugTestRootComponent )
                  {
                    v43 = v44;
                    DebugTestRootComponent__StartFileScript(debugTestRootComponent, &v43, 0LL);
                    return;
                  }
                }
              }
        ...
        const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
  {
    ...
    scriptPlayerPathSettingAddress = v25->static_fields->scriptPlayerPathSettingAddress;
    ...
    scriptPlayerObjectSettingAddress = v34->static_fields->scriptPlayerObjectSettingAddress;
    ...
    UIInput__set_value(v48, this->fields.selectPlayerFilePath, 0LL);
    if ( !v49 )
      goto LABEL_51;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B139A6 & 1) == 0 )
  {
    sub_1BCA7E0(&ScriptFilePlayerMenu_CallbackFunc_TypeInfo, value, method);
    byte_4B139A6 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A0A380;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A0A338;
}
