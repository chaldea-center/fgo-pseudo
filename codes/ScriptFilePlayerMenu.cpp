...
void __fastcall ScriptFilePlayerMenu__EndPlayScriptSelectObject(ScriptFilePlayerMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B42105 & 1) == 0 )
  {
    sub_1BDB878(&ScriptPlayListViewMenu_CallbackFunc_TypeInfo, method);
    sub_1BDB878(&Method_ScriptFilePlayerMenu_OnEndSelectObject__, v3);
    byte_4B42105 = 1;
  }
  ...
  if ( !jumpLineObjectInput
    || (scriptPlayListViewMenu = this->fields.scriptPlayListViewMenu,
        ...
        v8 = (ScriptPlayListViewMenu_CallbackFunc_o *)sub_1BDBAC4(ScriptPlayListViewMenu_CallbackFunc_TypeInfo),
...
void __fastcall ScriptFilePlayerMenu__OnClickDecide(ScriptFilePlayerMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B42106 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_ScriptFilePlayerMenu_EndPlayScript__, v4);
  ...
  if ( this->fields.state == 1 )
  {
    ...
    if ( dataScriptPathInput )
    {
      ...
      sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.selectPlayerFilePath, (int32_t)Text, v9, v10);
...
void __fastcall ScriptFilePlayerMenu__OnClickSelect(ScriptFilePlayerMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B42103 & 1) == 0 )
  {
    sub_1BDB878(&ScriptPlayListViewMenu_CallbackFunc_TypeInfo, method);
    sub_1BDB878(&Gender_TypeInfo, v3);
    sub_1BDB878(&Method_ScriptFilePlayerMenu_OnEndSelectObject__, v4);
    byte_4B42103 = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    Text = UILineInput__GetText(dataScriptPathInput, 0LL);
    this->fields.selectPlayerFilePath = Text;
    sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.selectPlayerFilePath, (int32_t)Text, v7, v8);
    genderInput = this->fields.genderInput;
    if ( !genderInput )
      goto LABEL_13;
    mSelectedItem = genderInput->fields.mSelectedItem;
    ...
    if ( !dataScriptPathInput
      || (scriptPlayListViewMenu = this->fields.scriptPlayListViewMenu,
          ...
          v18 = (ScriptPlayListViewMenu_CallbackFunc_o *)sub_1BDBAC4(ScriptPlayListViewMenu_CallbackFunc_TypeInfo),
          ScriptPlayListViewMenu_CallbackFunc___ctor(
            v18,
            (Il2CppObject *)this,
            Method_ScriptFilePlayerMenu_OnEndSelectObject__,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B42104 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_ScriptFilePlayerMenu_EndPlayScriptSelectObject__, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B420FE & 1) == 0 )
  {
    sub_1BDB878(&ScriptFilePlayerMenu_CallbackFunc_TypeInfo, value);
    byte_4B420FE = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A226E4;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A2269C;
}
