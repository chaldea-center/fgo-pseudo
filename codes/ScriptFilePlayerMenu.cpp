...
void __fastcall ScriptFilePlayerMenu__EndPlayScriptSelectObject(ScriptFilePlayerMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC5219 & 1) == 0 )
  {
    sub_1C1ABD4(&ScriptPlayListViewMenu_CallbackFunc_TypeInfo, method);
    sub_1C1ABD4(&Method_ScriptFilePlayerMenu_OnEndSelectObject__, v3);
    byte_4BC5219 = 1;
  }
  ...
  if ( !jumpLineObjectInput
    || (scriptPlayListViewMenu = this->fields.scriptPlayListViewMenu,
        ...
        v8 = (ScriptPlayListViewMenu_CallbackFunc_o *)sub_1C1AE20(ScriptPlayListViewMenu_CallbackFunc_TypeInfo),
...
void __fastcall ScriptFilePlayerMenu__OnClickDecide(ScriptFilePlayerMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC521A & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_ScriptFilePlayerMenu_EndPlayScript__, v4);
...
void __fastcall ScriptFilePlayerMenu__OnClickSelect(ScriptFilePlayerMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC5217 & 1) == 0 )
  {
    sub_1C1ABD4(&ScriptPlayListViewMenu_CallbackFunc_TypeInfo, method);
    sub_1C1ABD4(&Gender_TypeInfo, v3);
    sub_1C1ABD4(&Method_ScriptFilePlayerMenu_OnEndSelectObject__, v4);
    byte_4BC5217 = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( !dataScriptPathInput
      || (scriptPlayListViewMenu = this->fields.scriptPlayListViewMenu,
          ...
          v26 = (ScriptPlayListViewMenu_CallbackFunc_o *)sub_1C1AE20(ScriptPlayListViewMenu_CallbackFunc_TypeInfo),
          ScriptPlayListViewMenu_CallbackFunc___ctor(
            v26,
            (Il2CppObject *)this,
            Method_ScriptFilePlayerMenu_OnEndSelectObject__,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC5218 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_ScriptFilePlayerMenu_EndPlayScriptSelectObject__, v12);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC5212 & 1) == 0 )
  {
    sub_1C1ABD4(&ScriptFilePlayerMenu_CallbackFunc_TypeInfo, value);
    byte_4BC5212 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A597CC;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A59784;
}
