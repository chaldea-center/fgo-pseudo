...
void ServantCheckEquipListViewObject__Awake(ServantCheckEquipListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E734A7 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_UnityEngine_GameObject_GetComponent_ServantCheckEquipListViewItemDraw___);
    byte_4E734A7 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_32A8444 *)Method_UnityEngine_GameObject_GetComponent_ServantCheckEquipListViewItemDraw___);
...
void ServantCheckEquipListViewObject__Init_36078872(
        ServantCheckEquipListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void ServantCheckEquipListViewObject__Init_36079360(
        ServantCheckEquipListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void ServantCheckEquipListViewObject__Init_36082660(
        ServantCheckEquipListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
void ServantCheckEquipListViewObject__SetItem_36081832(
        ServantCheckEquipListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E734AC & 1) == 0 )
  {
    sub_1D0F0B4(&ServantCheckEquipListViewItemDraw_DispMode_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v11 = (ServantCheckEquipListViewObject_o *)sub_1D0F6A8(v8);
