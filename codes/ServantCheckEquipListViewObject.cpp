...
void ServantCheckEquipListViewObject__Awake(ServantCheckEquipListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C232EF & 1) == 0 )
  {
    sub_1C2D490(&Method_UnityEngine_GameObject_GetComponent_ServantCheckEquipListViewItemDraw___);
    byte_4C232EF = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_3125ED0 *)Method_UnityEngine_GameObject_GetComponent_ServantCheckEquipListViewItemDraw___);
...
void ServantCheckEquipListViewObject__Init_34739876(
        ServantCheckEquipListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void ServantCheckEquipListViewObject__Init_34740364(
        ServantCheckEquipListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void ServantCheckEquipListViewObject__Init_34742680(
        ServantCheckEquipListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
void ServantCheckEquipListViewObject__SetItem_34741852(
        ServantCheckEquipListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C232F4 & 1) == 0 )
  {
    sub_1C2D490(&ServantCheckEquipListViewItemDraw_DispMode_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v11 = (ServantCheckEquipListViewObject_o *)sub_1C2D9AC(v8);
