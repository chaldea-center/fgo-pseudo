        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4352F67 & 1) == 0 )
  {
    sub_B70694(&Method_UnityEngine_GameObject_GetComponent_ServantCheckEquipListViewItemDraw___);
    byte_4352F67 = 1;
  }
  ...
  Component_srcLineSprite = (struct ServantCheckEquipListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                                            dispObject,
                                                                            (const MethodInfo_1D4AE28 *)Method_UnityEngine_GameObject_GetComponent_ServantCheckEquipListViewItemDraw___);
...
void __fastcall ServantCheckEquipListViewObject__Init_27412700(
        ServantCheckEquipListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantCheckEquipListViewObject__Init_27413324(
        ServantCheckEquipListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantCheckEquipListViewObject__Init_27415536(
        ServantCheckEquipListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
void __fastcall ServantCheckEquipListViewObject__SetItem_27414660(
        ServantCheckEquipListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4352F6C & 1) == 0 )
  {
    sub_B70694(&ServantCheckEquipListViewItemDraw_DispMode_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v11 = (ServantCheckEquipListViewObject_o *)sub_B70A60(v8);
