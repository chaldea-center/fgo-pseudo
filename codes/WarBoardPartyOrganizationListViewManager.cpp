        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2BDFF & 1) == 0 )
  {
    sub_1B761C0(&Method_System_Collections_Generic_List_ListViewItem__Add__, memberItemList);
    byte_4A2BDFF = 1;
  }
    ...
    if ( (int)v11 >= 1 )
    {
      ...
      do
      {
        ...
        else
        {
          ...
          sub_1B76164((ServantStatusBattleListViewItem_o *)(v17 + 4), (int32_t)v8, v9, v10);
        }
        ...
        const MethodInfo *method)
{
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.onTapMember, 0, v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2BE03 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_UnityEngine_GameObject_GetComponent_WarBoardPartyListViewObject___, v5);
    sub_1B761C0(&Method_System_Collections_Generic_List_WarBoardPartyListViewObject__Add__, v6);
    sub_1B761C0(&Method_System_Collections_Generic_List_GameObject__GetEnumerator__, v7);
    sub_1B761C0(&Method_System_Collections_Generic_List_WarBoardPartyListViewObject___ctor__, v8);
    sub_1B761C0(&System_Collections_Generic_List_WarBoardPartyListViewObject__TypeInfo, v9);
    sub_1B761C0(&UnityEngine_Object_TypeInfo, v10);
    byte_4A2BE03 = 1;
  }
  memset(&v28, 0, sizeof(v28));
  v11 = (System_Collections_Generic_List_object__o *)sub_1B7640C(System_Collections_Generic_List_WarBoardPartyListViewObject__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v11,
    (const MethodInfo_34D6DA0 *)Method_System_Collections_Generic_List_WarBoardPartyListViewObject___ctor__);
            ...
            (const MethodInfo_32568D8 *)Method_System_Collections_Generic_List_Enumerator_GameObject__MoveNext__) )
  {
    ...
    if ( v15 )
    {
      ...
      Component_object = UnityEngine_GameObject__GetComponent_object_(
                           ...
                           (const MethodInfo_2EB19B8 *)Method_UnityEngine_GameObject_GetComponent_WarBoardPartyListViewObject___);
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      ...
      if ( v18 )
      {
        ...
        else
        {
          ...
          sub_1B76164((ServantStatusBattleListViewItem_o *)(v25 + 4), (int32_t)Component_object, v20, v21);
        }
      }
    }
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2BE01 & 1) == 0 )
  {
    sub_1B761C0(
      ...
      *(_QWORD *)&mode);
    sub_1B761C0(&Method_System_Collections_Generic_List_Enumerator_WarBoardPartyListViewObject__MoveNext__, v6);
    sub_1B761C0(&Method_System_Collections_Generic_List_Enumerator_WarBoardPartyListViewObject__get_Current__, v7);
    sub_1B761C0(&Method_System_Collections_Generic_List_WarBoardPartyListViewObject__GetEnumerator__, v8);
    byte_4A2BE01 = 1;
  }
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    ObjectList,
    (const MethodInfo_34D80CC *)Method_System_Collections_Generic_List_WarBoardPartyListViewObject__GetEnumerator__);
  while ( System_Collections_Generic_List_Enumerator_object___MoveNext(
            &v13,
            (const MethodInfo_32568D8 *)Method_System_Collections_Generic_List_Enumerator_WarBoardPartyListViewObject__MoveNext__) )
  {
  ...
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v13,
    (const MethodInfo_32568D4 *)Method_System_Collections_Generic_List_Enumerator_WarBoardPartyListViewObject__Dispose__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2BE02 & 1) == 0 )
  {
    this = (WarBoardPartyOrganizationListViewManager_o *)sub_1B761C0(&WarBoardPartyListViewObject_TypeInfo, obj);
    byte_4A2BE02 = 1;
  }
  if ( !obj
