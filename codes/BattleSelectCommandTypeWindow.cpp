        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E077C0 & 1) == 0 )
  {
    sub_1CE6700(&Method_BattleSelectCommandTypeWindow_onCloseButton__);
  ...
  v6 = (BattleWindowOuterClickComponent_OuterClickCall_o *)sub_1CE694C(BattleWindowOuterClickComponent_OuterClickCall_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E077C3 & 1) == 0 )
  {
    sub_1CE6700(&Method_BasicHelper_IndexValue_SelectTreasureDeviceInfo_TdChangeParam___);
    sub_1CE6700(&Method_BattleSelectCommandTypeWindow_SelectServant__);
    byte_4E077C3 = 1;
  }
  if ( !this->fields.isSelected )
  {
      ...
      && (treasureDevices = (System_Object_array *)SelectTreasureDeviceInfo_k__BackingField->fields.treasureDevices) != 0 )
    {
      v8 = BasicHelper__IndexValue_object_(
             ...
             index - 1,
             0,
             (const MethodInfo_31F26DC *)Method_BasicHelper_IndexValue_SelectTreasureDeviceInfo_TdChangeParam___);
    }
    else
    {
      v8 = 0;
    ...
    if ( (*((_BYTE *)Method_BattleSelectCommandTypeWindow_SelectServant__ + 83) & 2) != 0 )
      v9 = (_QWORD *)sub_1CE6718(Method_BattleSelectCommandTypeWindow_SelectServant__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E077C1 & 1) == 0 )
  {
    sub_1CE6700(&Method_BasicHelper_IndexValue_SelecCommandWindowCommandCard___);
    sub_1CE6700(&Method_BasicHelper_IndexValue_SelectTreasureDeviceInfo_TdChangeParam___);
  ...
  v23 = BasicHelper__IndexValue_object_(
          ...
          v22,
          0,
          (const MethodInfo_31F26DC *)Method_BasicHelper_IndexValue_SelecCommandWindowCommandCard___);
  ...
  if ( (controller & 1) != 0 )
  {
    ...
    if ( !byte_4DFE0AE )
    {
      controller = sub_1CE6700(&UnityEngine_Vector3_TypeInfo);
      byte_4DFE0AE = 1;
    }
    if ( !v31 )
      goto LABEL_58;
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1B1A7A0;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1B1A748;
}
