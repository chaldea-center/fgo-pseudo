void ViewEnemyMaster___ctor(ViewEnemyMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4E7878B & 1) == 0 )
  {
    sub_1D0F0B4(&Method_DataMasterBase_ViewEnemyMaster__ViewEnemyEntity__string___ctor__);
    byte_4E7878B = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    82,
    (const MethodInfo_3538564 *)Method_DataMasterBase_ViewEnemyMaster__ViewEnemyEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E78789 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_DataMasterBase_ViewEnemyMaster__ViewEnemyEntity__string__GetEntity__);
  ...
  return (ViewEnemyEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                PK,
                                (const MethodInfo_353AADC *)Method_DataMasterBase_ViewEnemyMaster__ViewEnemyEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7878C & 1) == 0 )
  {
    sub_1D0F0B4(&Method_System_Collections_ObjectModel_Collection_ViewEnemyEntity__GetEnumerator__);
    ...
    sub_1D0F0B4(&System_Collections_Generic_IEnumerator_ViewEnemyEntity__TypeInfo);
    sub_1D0F0B4(&System_Collections_IEnumerator_TypeInfo);
    sub_1D0F0B4(&int___TypeInfo);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_ViewEnemyEntity__Add__);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_ViewEnemyEntity__ToArray__);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_ViewEnemyEntity___ctor__);
    sub_1D0F0B4(&System_Collections_Generic_List_ViewEnemyEntity__TypeInfo);
  ...
  v10 = (System_Collections_Generic_List_object__o *)sub_1D0F300(System_Collections_Generic_List_ViewEnemyEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v10,
    (const MethodInfo_395BBDC *)Method_System_Collections_Generic_List_ViewEnemyEntity___ctor__);
  Instance = (clsQuestCheck_o *)this->fields.list;
  if ( !Instance )
    goto LABEL_48;
  Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                 (System_Collections_ObjectModel_Collection_T__o *)Instance,
                 (const MethodInfo_34CD418 *)Method_System_Collections_ObjectModel_Collection_ViewEnemyEntity__GetEnumerator__);
  if ( !Enumerator )
    sub_1D0F30C(0, v11);
  while ( 1 )
  {
...
LABEL_17:
    ...
    {
LABEL_24:
      v20 = sub_1CE5430(Enumerator, System_Collections_Generic_IEnumerator_ViewEnemyEntity__TypeInfo, 0);
    }
...
LABEL_48:
  ...
  return (ViewEnemyEntity_array *)System_Collections_Generic_List_object___ToArray(
                                    v10,
                                    (const MethodInfo_395DF68 *)Method_System_Collections_Generic_List_ViewEnemyEntity__ToArray__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7878A & 1) == 0 )
  {
    sub_1D0F0B4(&Method_DataMasterBase_ViewEnemyMaster__ViewEnemyEntity__string__TryGetEntity__);
    sub_1D0F0B4(&ViewEnemyEntity_TypeInfo);
    byte_4E7878A = 1;
  }
  if ( !ViewEnemyEntity_TypeInfo->_2.cctor_finished )
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_353AB28 *)Method_DataMasterBase_ViewEnemyMaster__ViewEnemyEntity__string__TryGetEntity__);
}