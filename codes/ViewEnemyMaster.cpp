void __fastcall ViewEnemyMaster___ctor(ViewEnemyMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A2EE21 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_ViewEnemyMaster__ViewEnemyEntity__string___ctor__, method);
    byte_4A2EE21 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    78,
    (const MethodInfo_30FFA98 *)Method_DataMasterBase_ViewEnemyMaster__ViewEnemyEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EE1F & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_ViewEnemyMaster__ViewEnemyEntity__string__GetEntity__, *(_QWORD *)&questId);
    sub_1B761C0(&ViewEnemyEntity_TypeInfo, v7);
    byte_4A2EE1F = 1;
  }
  ...
  return (ViewEnemyEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                PK,
                                (const MethodInfo_30FFAD8 *)Method_DataMasterBase_ViewEnemyMaster__ViewEnemyEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EE22 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_System_Linq_Enumerable_Contains_int___, v7);
    ...
    sub_1B761C0(&Method_System_Collections_Generic_List_ViewEnemyEntity__Add__, v12);
    sub_1B761C0(&Method_System_Collections_Generic_List_ViewEnemyEntity__ToArray__, v13);
    sub_1B761C0(&Method_System_Collections_Generic_List_ViewEnemyEntity___ctor__, v14);
    sub_1B761C0(&System_Collections_Generic_List_ViewEnemyEntity__TypeInfo, v15);
    sub_1B761C0(&Method_SingletonTemplate_clsQuestCheck__get_Instance__, v16);
    sub_1B761C0(&ViewEnemyEntity_TypeInfo, v17);
    byte_4A2EE22 = 1;
  }
  entity = 0LL;
  EnemyInfoDispNpcSvtIdList = (System_Collections_Generic_IEnumerable_TSource__o *)sub_1B76268(int___TypeInfo, 0LL);
  Instance = (clsQuestCheck_o *)SingletonTemplate_object___get_Instance((const MethodInfo_371299C *)Method_SingletonTemplate_clsQuestCheck__get_Instance__);
  if ( !Instance )
    goto LABEL_51;
  ...
  Instance = (clsQuestCheck_o *)DataManager__GetMaster_object_((const MethodInfo_2E623B4 *)Method_DataManager_GetMaster_QuestPhaseMaster___);
  if ( !Instance )
    goto LABEL_51;
  ...
  v23 = (System_Collections_Generic_List_object__o *)sub_1B7640C(System_Collections_Generic_List_ViewEnemyEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v23,
    (const MethodInfo_34D6DA0 *)Method_System_Collections_Generic_List_ViewEnemyEntity___ctor__);
...
LABEL_47:
    ...
    if ( *(_DWORD *)(v34 + 16) == questId )
    {
      if ( !EnemyInfoDispNpcSvtIdList )
        sub_1B7641C(v34, ViewEnemyEntity_TypeInfo);
            ...
            (v34 & 1) != 0) )
      {
        ...
        else
        {
          ...
          sub_1B76164((ServantStatusBattleListViewItem_o *)(v44 + 4), (int32_t)v38, v36, v37);
        }
      }
    }
  }
  ...
  {
LABEL_42:
    v48 = sub_1BC81A0(Enumerator, System_IDisposable_TypeInfo, 0LL);
  }
...
LABEL_51:
  ...
  return (ViewEnemyEntity_array *)System_Collections_Generic_List_object___ToArray(
                                    v23,
                                    (const MethodInfo_34D912C *)Method_System_Collections_Generic_List_ViewEnemyEntity__ToArray__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EE20 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_ViewEnemyMaster__ViewEnemyEntity__string__TryGetEntity__, entity);
    sub_1B761C0(&ViewEnemyEntity_TypeInfo, v9);
    byte_4A2EE20 = 1;
  }
  if ( !ViewEnemyEntity_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(ViewEnemyEntity_TypeInfo);
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_30FFB28 *)Method_DataMasterBase_ViewEnemyMaster__ViewEnemyEntity__string__TryGetEntity__);
}