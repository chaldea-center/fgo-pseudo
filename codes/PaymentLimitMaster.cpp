void __fastcall PaymentLimitMaster___ctor(PaymentLimitMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A1FEE6 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataMasterBase_PaymentLimitMaster__PaymentLimitEntity__int___ctor__, method);
    byte_4A1FEE6 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    508,
    (const MethodInfo_30F8720 *)Method_DataMasterBase_PaymentLimitMaster__PaymentLimitEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1FEE5 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataManager_GetMaster_UserPaymentLimitMaster___, *(_QWORD *)&limitId);
    sub_1B715CC(&DataManager_TypeInfo, v5);
    sub_1B715CC(&Method_DataMasterBase_PaymentLimitMaster__PaymentLimitEntity__int__TryGetEntity__, v6);
  ...
  if ( !limitId
    || !DataMasterBase_object__object__int___TryGetEntity(
          ...
          &entity,
          limitId,
          (const MethodInfo_30F87B4 *)Method_DataMasterBase_PaymentLimitMaster__PaymentLimitEntity__int__TryGetEntity__) )
  {
    LODWORD(UserId) = -1;
    return UserId;
  }
  ...
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2E5B394 *)Method_DataManager_GetMaster_UserPaymentLimitMaster___);
