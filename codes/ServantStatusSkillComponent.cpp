void __fastcall ServantStatusSkillComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A063E0 & 1) == 0 )
  {
    sub_1B686D4(&ServantStatusSkillComponent_TypeInfo, v1);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A063DF & 1) == 0 )
  {
    sub_1B686D4(&ServantStatusSkillComponent_TypeInfo, *(_QWORD *)&num);
  ...
  if ( num > 9 )
  {
    ...
    titleNumSecondSprite = System_String__Concat_61419468(SKILL_NO_FILE_PREFIX, v18, 0LL);
...
LABEL_29:
  ...
  titleNumSecondSprite = System_String__Concat_61419468(v27, v28, 0LL);
  if ( !v26 )
    goto LABEL_29;
