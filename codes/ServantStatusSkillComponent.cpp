void ServantStatusSkillComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4D2E5C7 & 1) == 0 )
  {
    sub_1C93AD4(&ServantStatusSkillComponent_TypeInfo);
  ...
  v8 = StringLiteral_20810/*"img_skillclass_0"*/;
  static_fields->SKILL_NO_FILE_PREFIX = (struct System_String_o *)StringLiteral_20810/*"img_skillclass_0"*/;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&static_fields->SKILL_NO_FILE_PREFIX, v8, v1, v2, v3, v4, v5, v6);
}
