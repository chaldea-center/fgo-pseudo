void __fastcall ServantStatusSkillComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BB2179 & 1) == 0 )
  {
    sub_1C13D24(&ServantStatusSkillComponent_TypeInfo, v1);
  ...
  v10 = StringLiteral_20803/*"img_shop_17"*/;
  static_fields->SKILL_NO_FILE_PREFIX = (struct System_String_o *)StringLiteral_20803/*"img_shop_17"*/;
  sub_1C13CC8((PartyOrganizationUtility_o *)&static_fields->SKILL_NO_FILE_PREFIX, v10, v2, v3, v4, v5, v6, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB2178 & 1) == 0 )
  {
    sub_1C13D24(&ServantStatusSkillComponent_TypeInfo, *(_QWORD *)&num);
