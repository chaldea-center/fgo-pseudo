void __fastcall ServantStatusSkillComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB393A & 1) == 0 )
  {
    sub_1BAB41C(&ServantStatusSkillComponent_TypeInfo, v1);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB3939 & 1) == 0 )
  {
    sub_1BAB41C(&ServantStatusSkillComponent_TypeInfo, *(_QWORD *)&num);
  ...
  if ( num > 9 )
  {
    ...
    titleNumSecondSprite = System_String__Concat_62048128(SKILL_NO_FILE_PREFIX, v18, 0LL);
...
LABEL_29:
  ...
  titleNumSecondSprite = System_String__Concat_62048128(v27, v28, 0LL);
  if ( !v26 )
    goto LABEL_29;
