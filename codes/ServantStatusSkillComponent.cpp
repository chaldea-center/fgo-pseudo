void __fastcall ServantStatusSkillComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FC35A & 1) == 0 )
  {
    sub_1B64A00(&ServantStatusSkillComponent_TypeInfo, v1);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC359 & 1) == 0 )
  {
    sub_1B64A00(&ServantStatusSkillComponent_TypeInfo, *(_QWORD *)&num);
  ...
  if ( num > 9 )
  {
    ...
    titleNumSecondSprite = System_String__Concat_61385136(SKILL_NO_FILE_PREFIX, v18, 0LL);
...
LABEL_29:
  ...
  titleNumSecondSprite = System_String__Concat_61385136(v27, v28, 0LL);
  if ( !v26 )
    goto LABEL_29;
