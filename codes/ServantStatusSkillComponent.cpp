void __fastcall ServantStatusSkillComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B6465F & 1) == 0 )
  {
    sub_1BE4ACC(&ServantStatusSkillComponent_TypeInfo, v1);
  ...
  v10 = StringLiteral_20755/*"img_skillclass_0"*/;
  static_fields->SKILL_NO_FILE_PREFIX = (struct System_String_o *)StringLiteral_20755/*"img_skillclass_0"*/;
  sub_1BE4A70((PartyOrganizationUtility_o *)&static_fields->SKILL_NO_FILE_PREFIX, v10, v2, v3, v4, v5, v6, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6465E & 1) == 0 )
  {
    sub_1BE4ACC(&ServantStatusSkillComponent_TypeInfo, *(_QWORD *)&num);
