void __fastcall ServantStatusSkillComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BC5537 & 1) == 0 )
  {
    sub_1C1ABD4(&ServantStatusSkillComponent_TypeInfo, v1);
  ...
  v10 = StringLiteral_20817/*"img_skillclass_0"*/;
  static_fields->SKILL_NO_FILE_PREFIX = (struct System_String_o *)StringLiteral_20817/*"img_skillclass_0"*/;
  sub_1C1AB78((PartyOrganizationUtility_o *)&static_fields->SKILL_NO_FILE_PREFIX, v10, v2, v3, v4, v5, v6, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC5536 & 1) == 0 )
  {
    sub_1C1ABD4(&ServantStatusSkillComponent_TypeInfo, *(_QWORD *)&num);
