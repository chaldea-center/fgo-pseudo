...
{
  *(_OWORD *)&this->fields.slideInStartedPosition.fields.x = xmmword_BC3630;
        ...
        const MethodInfo *method)
{
  ...
  sub_1BAB3C0(p_endCallbackAction, 0, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB64FE & 1) == 0 )
  {
    sub_1BAB41C(&EventDelegate_TypeInfo, endCallbackAction);
    sub_1BAB41C(&Method_UnityEngine_GameObject_AddComponent_TweenPosition___, v6);
    sub_1BAB41C(&Method_System_Collections_Generic_List_EventDelegate__Add__, v7);
    sub_1BAB41C(&StringLiteral_6000/*"EndSlideDown"*/, v8);
    byte_4AB64FE = 1;
  }
  ...
  if ( !byte_4AB0691 )
  {
    gameObject = (UnityEngine_GameObject_o *)sub_1BAB41C(&UnityEngine_Vector3_TypeInfo, v10);
    byte_4AB0691 = 1;
  }
  if ( !v11 )
    goto LABEL_12;
  ...
  *(_QWORD *)(&v11[5].fields + 1) = v14;
  ...
  EventDelegate___ctor_47033580(v17, (UnityEngine_MonoBehaviour_o *)this, (System_String_o *)StringLiteral_6000/*"EndSlideDown"*/, 0LL);
  if ( !klass
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BAB41C(&EventDelegate_TypeInfo, endCallbackAction);
    sub_1BAB41C(&Method_UnityEngine_GameObject_AddComponent_TweenPosition___, v5);
    sub_1BAB41C(&Method_System_Collections_Generic_List_EventDelegate__Add__, v6);
    sub_1BAB41C(&UnityEngine_Object_TypeInfo, v7);
    sub_1BAB41C(&StringLiteral_6001/*"EndSlideIn"*/, v8);
    byte_4AB64FF = 1;
  }
  infoObject = (UnityEngine_Object_o *)this->fields.infoObject;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  else
  {
    ...
    *((float *)&v14[6].klass + 1) = z;
    ...
    EventDelegate___ctor_47033580(v19, (UnityEngine_MonoBehaviour_o *)this, (System_String_o *)StringLiteral_6001/*"EndSlideIn"*/, 0LL);
    if ( !klass
      || (items = klass->fields._items,
