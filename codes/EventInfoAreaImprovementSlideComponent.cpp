...
{
  *(_OWORD *)&this->fields.slideInStartedPosition.fields.x = xmmword_BA36A0;
        ...
        const MethodInfo *method)
{
  ...
  sub_1B64814(p_endCallbackAction, 0, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF009 & 1) == 0 )
  {
    sub_1B64870(&EventDelegate_TypeInfo, endCallbackAction);
    ...
    sub_1B64870(&StringLiteral_5970/*"EndSlideDown"*/, v8);
    byte_49FF009 = 1;
  }
  ...
  if ( !byte_49F9201 )
  {
    gameObject = (UnityEngine_GameObject_o *)sub_1B64870(&UnityEngine_Vector3_TypeInfo, v10);
    byte_49F9201 = 1;
  }
  if ( !v11 )
    goto LABEL_12;
  ...
  *(_QWORD *)(&v11[5].fields + 1) = v14;
  ...
  EventDelegate___ctor_46517956(v17, (UnityEngine_MonoBehaviour_o *)this, (System_String_o *)StringLiteral_5970/*"EndSlideDown"*/, 0LL);
  if ( !klass
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B64870(&EventDelegate_TypeInfo, endCallbackAction);
    sub_1B64870(&Method_UnityEngine_GameObject_AddComponent_TweenPosition___, v5);
    sub_1B64870(&Method_System_Collections_Generic_List_EventDelegate__Add__, v6);
    sub_1B64870(&UnityEngine_Object_TypeInfo, v7);
    sub_1B64870(&StringLiteral_5971/*"EndSlideIn"*/, v8);
    byte_49FF00A = 1;
  }
  infoObject = (UnityEngine_Object_o *)this->fields.infoObject;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  else
  {
    ...
    *((float *)&v14[6].klass + 1) = z;
    ...
    EventDelegate___ctor_46517956(v19, (UnityEngine_MonoBehaviour_o *)this, (System_String_o *)StringLiteral_5971/*"EndSlideIn"*/, 0LL);
    if ( !klass
      || (items = klass->fields._items,
