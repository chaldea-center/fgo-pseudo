...
{
  *(_OWORD *)&this->fields.slideInStartedPosition.fields.x = xmmword_BE2250;
        ...
        const MethodInfo *method)
{
  ...
  sub_1BE4A70(p_endCallbackAction, 0LL, v2, v3, v4, v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67360 & 1) == 0 )
  {
    sub_1BE4ACC(&EventDelegate_TypeInfo, endCallbackAction);
    sub_1BE4ACC(&Method_UnityEngine_GameObject_AddComponent_TweenPosition___, v10);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_EventDelegate__Add__, v11);
    sub_1BE4ACC(&StringLiteral_6123/*"EndSlideDown"*/, v12);
    byte_4B67360 = 1;
  }
  ...
  *(_QWORD *)(&v15[5].fields + 1) = v18;
  ...
  v21 = (EventDelegate_o *)sub_1BE4D18(EventDelegate_TypeInfo);
  EventDelegate___ctor_47636792(v21, (UnityEngine_MonoBehaviour_o *)this, (System_String_o *)StringLiteral_6123/*"EndSlideDown"*/, 0LL);
  if ( !klass
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BE4ACC(&EventDelegate_TypeInfo, endCallbackAction);
    sub_1BE4ACC(&Method_UnityEngine_GameObject_AddComponent_TweenPosition___, v5);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_EventDelegate__Add__, v6);
    sub_1BE4ACC(&UnityEngine_Object_TypeInfo, v7);
    sub_1BE4ACC(&StringLiteral_6124/*"EndSlideIn"*/, v8);
    byte_4B67361 = 1;
  }
  infoObject = (UnityEngine_Object_o *)this->fields.infoObject;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  else
  {
    ...
    *((float *)&v18[6].klass + 1) = z;
    v23 = (EventDelegate_o *)sub_1BE4D18(EventDelegate_TypeInfo);
    EventDelegate___ctor_47636792(v23, (UnityEngine_MonoBehaviour_o *)this, (System_String_o *)StringLiteral_6124/*"EndSlideIn"*/, 0LL);
    if ( !klass
      || (items = klass->fields._items,
