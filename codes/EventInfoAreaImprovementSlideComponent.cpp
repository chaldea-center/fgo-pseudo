...
{
  *(_OWORD *)&this->fields.slideInStartedPosition.fields.x = xmmword_BAD3B0;
        ...
        const MethodInfo *method)
{
  ...
  sub_1B76164(p_endCallbackAction, 0, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E9F8 & 1) == 0 )
  {
    sub_1B761C0(&EventDelegate_TypeInfo, endCallbackAction);
    ...
    sub_1B761C0(&StringLiteral_5995/*"EndSlideDown"*/, v8);
    byte_4A2E9F8 = 1;
  }
  ...
  if ( !byte_4A28BB1 )
  {
    gameObject = (UnityEngine_GameObject_o *)sub_1B761C0(&UnityEngine_Vector3_TypeInfo, v10);
    byte_4A28BB1 = 1;
  }
  if ( !v11 )
    goto LABEL_12;
  ...
  *(_QWORD *)(&v11[5].fields + 1) = v14;
  ...
  EventDelegate___ctor_46674396(v17, (UnityEngine_MonoBehaviour_o *)this, (System_String_o *)StringLiteral_5995/*"EndSlideDown"*/, 0LL);
  if ( !klass
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B761C0(&EventDelegate_TypeInfo, endCallbackAction);
    sub_1B761C0(&Method_UnityEngine_GameObject_AddComponent_TweenPosition___, v5);
    sub_1B761C0(&Method_System_Collections_Generic_List_EventDelegate__Add__, v6);
    sub_1B761C0(&UnityEngine_Object_TypeInfo, v7);
    sub_1B761C0(&StringLiteral_5996/*"EndSlideIn"*/, v8);
    byte_4A2E9F9 = 1;
  }
  infoObject = (UnityEngine_Object_o *)this->fields.infoObject;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  else
  {
    ...
    *((float *)&v14[6].klass + 1) = z;
    ...
    EventDelegate___ctor_46674396(v19, (UnityEngine_MonoBehaviour_o *)this, (System_String_o *)StringLiteral_5996/*"EndSlideIn"*/, 0LL);
    if ( !klass
      || (items = klass->fields._items,
