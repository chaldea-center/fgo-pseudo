...
{
  *(_OWORD *)&this->fields.slideInStartedPosition.fields.x = xmmword_D25170;
        ...
        const MethodInfo *method)
{
  ...
  sub_1CE66A4(p_endCallbackAction, 0, v2, v3, v4, v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E04C3D & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_6075/*"EndSlideDown"*/);
    byte_4E04C3D = 1;
  }
  ...
  *(intptr_t *)((char *)&v12[5].fields.m_CachedPtr + 4) = v15;
  ...
  v18 = (EventDelegate_o *)sub_1CE694C(EventDelegate_TypeInfo);
  EventDelegate___ctor_50381648(v18, (UnityEngine_MonoBehaviour_o *)this, (System_String_o *)StringLiteral_6075/*"EndSlideDown"*/, 0);
  if ( !klass
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E04C3E & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_System_Collections_Generic_List_EventDelegate__Add__);
    sub_1CE6700(&UnityEngine_Object_TypeInfo);
    sub_1CE6700(&StringLiteral_6076/*"EndSlideIn"*/);
    byte_4E04C3E = 1;
  }
  infoObject = (UnityEngine_Object_o *)this->fields.infoObject;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  else
  {
    ...
    *((float *)&v14[6].klass + 1) = z;
    v19 = (EventDelegate_o *)sub_1CE694C(EventDelegate_TypeInfo);
    EventDelegate___ctor_50381648(v19, (UnityEngine_MonoBehaviour_o *)this, (System_String_o *)StringLiteral_6076/*"EndSlideIn"*/, 0);
    if ( !klass
      || (items = klass->fields._items,
