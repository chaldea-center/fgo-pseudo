...
{
  *(_OWORD *)&this->fields.slideInStartedPosition.fields.x = xmmword_BEB0A0;
        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C(p_endCallbackAction, 0, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45086 & 1) == 0 )
  {
    sub_1BDB878(&EventDelegate_TypeInfo, endCallbackAction);
    sub_1BDB878(&Method_UnityEngine_GameObject_AddComponent_TweenPosition___, v6);
    sub_1BDB878(&Method_System_Collections_Generic_List_EventDelegate__Add__, v7);
    sub_1BDB878(&StringLiteral_6042/*"EndSlideDown"*/, v8);
    byte_4B45086 = 1;
  }
  this->fields.endCallbackAction = endCallbackAction;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.endCallbackAction, (int32_t)endCallbackAction, (int32_t)method, v3);
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  if ( !gameObject )
    goto LABEL_12;
  ...
  if ( !byte_4B3E911 )
  {
    gameObject = (UnityEngine_GameObject_o *)sub_1BDB878(&UnityEngine_Vector3_TypeInfo, v10);
    byte_4B3E911 = 1;
  }
  if ( !v11 )
    goto LABEL_12;
  ...
  *(_QWORD *)(&v11[5].fields + 1) = v14;
  ...
  EventDelegate___ctor_48569040(v17, (UnityEngine_MonoBehaviour_o *)this, (System_String_o *)StringLiteral_6042/*"EndSlideDown"*/, 0LL);
  if ( !klass
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&EventDelegate_TypeInfo, endCallbackAction);
    sub_1BDB878(&Method_UnityEngine_GameObject_AddComponent_TweenPosition___, v5);
    sub_1BDB878(&Method_System_Collections_Generic_List_EventDelegate__Add__, v6);
    sub_1BDB878(&UnityEngine_Object_TypeInfo, v7);
    sub_1BDB878(&StringLiteral_6043/*"EndSlideIn"*/, v8);
    byte_4B45087 = 1;
  }
  infoObject = (UnityEngine_Object_o *)this->fields.infoObject;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  {
    this->fields.endCallbackAction = endCallbackAction;
    sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.endCallbackAction, (int32_t)endCallbackAction, v10, v11);
    ...
    *((float *)&v14[6].klass + 1) = z;
    ...
    EventDelegate___ctor_48569040(v19, (UnityEngine_MonoBehaviour_o *)this, (System_String_o *)StringLiteral_6043/*"EndSlideIn"*/, 0LL);
    if ( !klass
      || (items = klass->fields._items,
