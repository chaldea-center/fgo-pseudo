...
{
  *(_OWORD *)&this->fields.slideInStartedPosition.fields.x = xmmword_BD8120;
        ...
        const MethodInfo *method)
{
  ...
  sub_1BD33FC(p_endCallbackAction, 0LL, v2, v3, v4, v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B37943 & 1) == 0 )
  {
    sub_1BD3458(&EventDelegate_TypeInfo, endCallbackAction);
    sub_1BD3458(&Method_UnityEngine_GameObject_AddComponent_TweenPosition___, v10);
    sub_1BD3458(&Method_System_Collections_Generic_List_EventDelegate__Add__, v11);
    sub_1BD3458(&StringLiteral_6120/*"EndSlideDown"*/, v12);
    byte_4B37943 = 1;
  }
  ...
  *(_QWORD *)(&v15[5].fields + 1) = v18;
  ...
  v21 = (EventDelegate_o *)sub_1BD36A4(EventDelegate_TypeInfo);
  EventDelegate___ctor_47474348(v21, (UnityEngine_MonoBehaviour_o *)this, (System_String_o *)StringLiteral_6120/*"EndSlideDown"*/, 0LL);
  if ( !klass
...
LABEL_12:
  ...
  else
  {
    ...
    sub_1BD33FC((PartyOrganizationUtility_o *)(v31 + 4), (int64_t)v21, v22, v23, v24, v25, v26, v27);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BD3458(&EventDelegate_TypeInfo, endCallbackAction);
    sub_1BD3458(&Method_UnityEngine_GameObject_AddComponent_TweenPosition___, v5);
    sub_1BD3458(&Method_System_Collections_Generic_List_EventDelegate__Add__, v6);
    sub_1BD3458(&UnityEngine_Object_TypeInfo, v7);
    sub_1BD3458(&StringLiteral_6121/*"EndSlideIn"*/, v8);
    byte_4B37944 = 1;
  }
  infoObject = (UnityEngine_Object_o *)this->fields.infoObject;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  else
  {
    ...
    *((float *)&v18[6].klass + 1) = z;
    v23 = (EventDelegate_o *)sub_1BD36A4(EventDelegate_TypeInfo);
    EventDelegate___ctor_47474348(v23, (UnityEngine_MonoBehaviour_o *)this, (System_String_o *)StringLiteral_6121/*"EndSlideIn"*/, 0LL);
    if ( !klass
      || (items = klass->fields._items,
