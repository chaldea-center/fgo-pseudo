...
{
  *(_OWORD *)&this->fields.slideInStartedPosition.fields.x = xmmword_BDE9E0;
        ...
        const MethodInfo *method)
{
  ...
  sub_1BC2FAC(p_endCallbackAction, 0, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B02598 & 1) == 0 )
  {
    sub_1BC3008(&EventDelegate_TypeInfo, endCallbackAction);
    ...
    sub_1BC3008(&StringLiteral_5977/*"EndSlideDown"*/, v8);
    byte_4B02598 = 1;
  }
  this->fields.endCallbackAction = endCallbackAction;
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.endCallbackAction, (int32_t)endCallbackAction, (int32_t)method, v3);
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  if ( !gameObject )
    goto LABEL_12;
  ...
  if ( !byte_4AFBDB1 )
  {
    gameObject = (UnityEngine_GameObject_o *)sub_1BC3008(&UnityEngine_Vector3_TypeInfo, v10);
    byte_4AFBDB1 = 1;
  }
  if ( !v11 )
    goto LABEL_12;
  ...
  *(_QWORD *)(&v11[5].fields + 1) = v14;
  ...
  EventDelegate___ctor_48365952(v17, (UnityEngine_MonoBehaviour_o *)this, (System_String_o *)StringLiteral_5977/*"EndSlideDown"*/, 0LL);
  if ( !klass
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BC3008(&EventDelegate_TypeInfo, endCallbackAction);
    sub_1BC3008(&Method_UnityEngine_GameObject_AddComponent_TweenPosition___, v5);
    sub_1BC3008(&Method_System_Collections_Generic_List_EventDelegate__Add__, v6);
    sub_1BC3008(&UnityEngine_Object_TypeInfo, v7);
    sub_1BC3008(&StringLiteral_5978/*"EndSlideIn"*/, v8);
    byte_4B02599 = 1;
  }
  infoObject = (UnityEngine_Object_o *)this->fields.infoObject;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  {
    this->fields.endCallbackAction = endCallbackAction;
    sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.endCallbackAction, (int32_t)endCallbackAction, v10, v11);
    ...
    *((float *)&v14[6].klass + 1) = z;
    ...
    EventDelegate___ctor_48365952(v19, (UnityEngine_MonoBehaviour_o *)this, (System_String_o *)StringLiteral_5978/*"EndSlideIn"*/, 0LL);
    if ( !klass
      || (items = klass->fields._items,
