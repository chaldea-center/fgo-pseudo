        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A52168 & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_24476/*"war_"*/, v4);
    sub_1B863B8(&StringLiteral_18921/*"event_"*/, v5);
...
LABEL_12:
    v13 = (_DWORD)v9 + 16;
    v14 = &StringLiteral_24476/*"war_"*/;
  }
  else
  {
    v13 = (_DWORD)v9 + 96;
    v14 = &StringLiteral_18921/*"event_"*/;
  }
  v15 = System_Int32__ToString(v13, 0LL);
  return System_String__Concat_61645176((System_String_o *)*v14, v15, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A52164 & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_20139/*"img_list_bg03"*/, v3);
    byte_4A52164 = 1;
  }
  baseSprite = this->fields.baseSprite;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetBanner(baseSprite, (System_String_o *)StringLiteral_20139/*"img_list_bg03"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A52166 & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_23133/*"shortcut_board_icon_"*/, v7);
    sub_1B863B8(&StringLiteral_23140/*"shortcut_board_icon_mainquest"*/, v8);
    sub_1B863B8(&StringLiteral_23150/*"shortcut_board_icon_war_"*/, v9);
    sub_1B863B8(&StringLiteral_1/*""*/, v10);
    sub_1B863B8(&StringLiteral_23135/*"shortcut_board_icon_event_"*/, v11);
    this = (MissionNaviTransitionBoardItemDraw_o *)sub_1B863B8(&StringLiteral_23136/*"shortcut_board_icon_freequest"*/, v12);
    byte_4A52166 = 1;
  }
  if ( !item )
    goto LABEL_27;
  ...
  if ( questInfo && item->fields._BoardType_k__BackingField == 1 )
  {
    ...
    if ( QuestType == 1 )
    {
      v14 = &StringLiteral_23140/*"shortcut_board_icon_mainquest"*/;
      goto LABEL_14;
    }
    if ( QuestType == 2 )
    {
      v14 = &StringLiteral_23136/*"shortcut_board_icon_freequest"*/;
LABEL_14:
    ...
    if ( this )
    {
      ...
      if ( this )
      {
        ...
        if ( WarEntity__IsEvent((WarEntity_o *)this, 0LL) )
        {
          ...
          v22 = &StringLiteral_23135/*"shortcut_board_icon_event_"*/;
        }
        else
        {
          v21 = System_Int32__ToString(v20 + 16, 0LL);
          v22 = &StringLiteral_23150/*"shortcut_board_icon_war_"*/;
        }
        v19 = System_String__Concat_61645176((System_String_o *)*v22, v21, 0LL);
LABEL_21:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A52162 & 1) == 0 )
  {
    sub_1B863B8(&LocalizationManager_TypeInfo, boardItem);
    ...
    sub_1B863B8(&StringLiteral_13208/*"TIME_REST_QUEST_BOARD_QUEST"*/, v11);
    sub_1B863B8(&StringLiteral_8532/*"MISSION_NAVI_BOARD_TIME_DISABLE_COLOR"*/, v12);
    byte_4A52162 = 1;
  }
  endedAt = 0LL;
  infoText = 0LL;
  if ( boardItem )
  {
    ...
    sub_1B8635C((CGThumbnailListItem_o *)&this->fields.naviListViewManager, (int32_t)listViewManager, v13, v14);
...
LABEL_22:
        ...
        Instance = (UILabel_o *)SingletonTemplate_object___get_Instance((const MethodInfo_3839AA0 *)Method_SingletonTemplate_QuestTree__get_Instance__);
        if ( !Instance )
LABEL_72:
...
LABEL_51:
        if ( !System_String__IsNullOrEmpty((System_String_o *)Empty, 0LL) )
        {
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          Instance = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8532/*"MISSION_NAVI_BOARD_TIME_DISABLE_COLOR"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetBanner(enableMask, (System_String_o *)StringLiteral_20139/*"img_list_bg03"*/, 0LL);
