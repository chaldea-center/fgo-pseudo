        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BEB30 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_24351/*"war_"*/, v4);
    sub_1B4CF90(&StringLiteral_18837/*"event_"*/, v5);
...
LABEL_12:
    v13 = (_DWORD)v9 + 16;
    v14 = &StringLiteral_24351/*"war_"*/;
  }
  else
  {
    v13 = (_DWORD)v9 + 96;
    v14 = &StringLiteral_18837/*"event_"*/;
  }
  v15 = System_Int32__ToString(v13, 0LL);
  return System_String__Concat_61093468((System_String_o *)*v14, v15, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BEB2C & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_20040/*"img_list_bg03"*/, v3);
    byte_49BEB2C = 1;
  }
  baseSprite = this->fields.baseSprite;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetBanner(baseSprite, (System_String_o *)StringLiteral_20040/*"img_list_bg03"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BEB2E & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_23009/*"shortcut_board_icon_"*/, v7);
    sub_1B4CF90(&StringLiteral_23016/*"shortcut_board_icon_mainquest"*/, v8);
    sub_1B4CF90(&StringLiteral_23026/*"shortcut_board_icon_war_"*/, v9);
    sub_1B4CF90(&StringLiteral_1/*""*/, v10);
    sub_1B4CF90(&StringLiteral_23011/*"shortcut_board_icon_event_"*/, v11);
    this = (MissionNaviTransitionBoardItemDraw_o *)sub_1B4CF90(&StringLiteral_23012/*"shortcut_board_icon_freequest"*/, v12);
    byte_49BEB2E = 1;
  }
  if ( !item )
    goto LABEL_27;
  ...
  if ( questInfo && item->fields._BoardType_k__BackingField == 1 )
  {
    ...
    if ( QuestType == 1 )
    {
      v14 = &StringLiteral_23016/*"shortcut_board_icon_mainquest"*/;
      goto LABEL_14;
    }
    if ( QuestType == 2 )
    {
      v14 = &StringLiteral_23012/*"shortcut_board_icon_freequest"*/;
LABEL_14:
    ...
    if ( this )
    {
      ...
      if ( this )
      {
        ...
        if ( WarEntity__IsEvent((WarEntity_o *)this, 0LL) )
        {
          ...
          v22 = &StringLiteral_23011/*"shortcut_board_icon_event_"*/;
        }
        else
        {
          v21 = System_Int32__ToString(v20 + 16, 0LL);
          v22 = &StringLiteral_23026/*"shortcut_board_icon_war_"*/;
        }
        v19 = System_String__Concat_61093468((System_String_o *)*v22, v21, 0LL);
LABEL_21:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BEB2A & 1) == 0 )
  {
    sub_1B4CF90(&LocalizationManager_TypeInfo, boardItem);
    ...
    sub_1B4CF90(&StringLiteral_13135/*"TIME_REST_QUEST_BOARD_QUEST"*/, v11);
    sub_1B4CF90(&StringLiteral_8488/*"MISSION_NAVI_BOARD_TIME_DISABLE_COLOR"*/, v12);
    byte_49BEB2A = 1;
  }
  endedAt = 0LL;
  infoText = 0LL;
  if ( boardItem )
  {
    ...
    sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.naviListViewManager, (int32_t)listViewManager, v13, v14);
...
LABEL_22:
        ...
        Instance = (UILabel_o *)SingletonTemplate_object___get_Instance((const MethodInfo_37B4830 *)Method_SingletonTemplate_QuestTree__get_Instance__);
        if ( !Instance )
LABEL_72:
...
LABEL_51:
        if ( !System_String__IsNullOrEmpty((System_String_o *)Empty, 0LL) )
        {
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          Instance = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8488/*"MISSION_NAVI_BOARD_TIME_DISABLE_COLOR"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetBanner(enableMask, (System_String_o *)StringLiteral_20040/*"img_list_bg03"*/, 0LL);
