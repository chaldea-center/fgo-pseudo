        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01E69 & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_24543/*"war_"*/, v4);
    sub_1B64A00(&StringLiteral_19075/*"event_"*/, v5);
...
LABEL_12:
  ...
  {
    v13 = (_DWORD)v9 + 96;
    v14 = &StringLiteral_19075/*"event_"*/;
  }
  v15 = System_Int32__ToString(v13, 0LL);
  return System_String__Concat_61385136((System_String_o *)*v14, v15, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01E65 & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_20257/*"img_list_bg03"*/, v3);
    byte_4A01E65 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01E67 & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_23188/*"shortcut_board_icon_"*/, v7);
    sub_1B64A00(&StringLiteral_23195/*"shortcut_board_icon_mainquest"*/, v8);
    sub_1B64A00(&StringLiteral_23205/*"shortcut_board_icon_war_"*/, v9);
    sub_1B64A00(&StringLiteral_1/*""*/, v10);
    sub_1B64A00(&StringLiteral_23190/*"shortcut_board_icon_event_"*/, v11);
    this = (MissionNaviTransitionBoardItemDraw_o *)sub_1B64A00(&StringLiteral_23191/*"shortcut_board_icon_freequest"*/, v12);
    byte_4A01E67 = 1;
  }
  if ( !item )
    goto LABEL_27;
...
LABEL_14:
    ...
    if ( this )
    {
      ...
      if ( this )
      {
        ...
        v19 = System_String__Concat_61385136((System_String_o *)*v22, v21, 0LL);
LABEL_21:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01E63 & 1) == 0 )
  {
    sub_1B64A00(&LocalizationManager_TypeInfo, boardItem);
    ...
    sub_1B64A00(&StringLiteral_13282/*"TIME_REST_QUEST_BOARD_QUEST"*/, v10);
    sub_1B64A00(&StringLiteral_8617/*"MISSION_NAVI_BOARD_TIME_DISABLE_COLOR"*/, v11);
    byte_4A01E63 = 1;
  }
  if ( boardItem )
  {
...
LABEL_64:
      ...
      if ( v28 >= 1 )
      {
        ...
        if ( !QuestEntity__HasFlag((QuestEntity_o *)Instance, 32LL, 0LL) )
        {
          ...
          v29 = LocalizationManager__Get((System_String_o *)StringLiteral_8617/*"MISSION_NAVI_BOARD_TIME_DISABLE_COLOR"*/, 0LL);
          v30 = LocalizationManager__Get((System_String_o *)StringLiteral_13282/*"TIME_REST_QUEST_BOARD_QUEST"*/, 0LL);
