        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BC2B9 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_CharaWipeEffectComponent_EndCreateEffect__, v7);
  ...
  if ( !figure
    || (UIStandFigureRender__SetSharder(figure, (System_String_o *)StringLiteral_4878/*"Custom/Sprite-ScriptActionFigureWipe"*/, 0LL), !data)
...
LABEL_21:
    ...
    && !System_String__IsNullOrEmpty(this->fields.subEffectName, 0LL) )
  {
    ...
    v21 = System_String__Concat_61093468((System_String_o *)StringLiteral_13331/*"Talk/"*/, this->fields.subEffectName, 0LL);
    v22 = (CommonEffectLoadComponent_LoadEndHandler_o *)sub_1B4D1DC(CommonEffectLoadComponent_LoadEndHandler_TypeInfo);
    ...
    CommonEffectManager__Create_41236180(v20, v21, v22, 0, 0, 0, v24);
  }
  else
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BC2B8 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_CharaWipeEffectComponent_EndLoadWipe__, v6);
  ...
  if ( isSkip )
  {
    ...
    sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.figure, 0, v13, v14);
    gameObject = (UnityEngine_Object_o *)UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    UnityEngine_Object__Destroy_68804456(gameObject, 0LL);
  ...
  {
    v16 = System_String__Concat_61093468((System_String_o *)StringLiteral_15360/*"Wipe/"*/, this->fields.wipeName, 0LL);
