        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AFDFD & 1) == 0 )
  {
    ...
    sub_B52984(&Method_CharaWipeEffectComponent_EndCreateEffect__);
...
LABEL_24:
    ...
    && !System_String__IsNullOrEmpty(this->fields.subEffectName, 0LL) )
  {
    ...
    v18 = System_String__Concat_44568316((System_String_o *)StringLiteral_13651/*"Talk/"*/, this->fields.subEffectName, 0LL);
    v19 = (CommonEffectLoadComponent_LoadEndHandler_o *)sub_B52A54(CommonEffectLoadComponent_LoadEndHandler_TypeInfo);
    ...
    CommonEffectManager__Create_18107188(v17, v18, v19, 0, 0, 0, 0LL);
  }
  else
  {
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B52984(&AssetManager_TypeInfo);
    sub_B52984(&Method_CharaWipeEffectComponent_EndLoadWipe__);
