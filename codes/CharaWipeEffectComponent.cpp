void CharaWipeEffectComponent___ctor(CharaWipeEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEFC6D & 1) == 0 )
  {
    sub_1C7BAE8(&StringLiteral_18062/*"circleOut"*/);
    byte_4CEFC6D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEFC68 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_CharaWipeEffectComponent_EndCreateEffect__);
    ...
    sub_1C7BAE8(&StringLiteral_4942/*"Custom/Sprite-ScriptActionFigureWipe"*/);
    byte_4CEFC68 = 1;
  }
  ...
  if ( !figure
    || (UIStandFigureRender__SetSharder(figure, (System_String_o *)StringLiteral_4942/*"Custom/Sprite-ScriptActionFigureWipe"*/, 0), !data)
...
LABEL_21:
    ...
    && !System_String__IsNullOrEmpty(this->fields.subEffectName, 0) )
  {
    ...
    v18 = System_String__Concat_64176912((System_String_o *)StringLiteral_13687/*"Talk/"*/, this->fields.subEffectName, 0);
    v19 = (CommonEffectLoadComponent_LoadEndHandler_o *)sub_1C7BD34(CommonEffectLoadComponent_LoadEndHandler_TypeInfo);
    ...
    CommonEffectManager__Create_44231468(v17, v18, v19, 0, 0, 0, v21);
  }
  else
  {
...
void CharaWipeEffectComponent__OnDestroy(CharaWipeEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( wipeData )
  {
    ...
    sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.wipeData, 0, v4, v5, v6, v7, v8, v9);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(figure, 0, 0) )
  {
    ...
    {
      sub_1C7BD40(klass, v11);
    }
    UIStandFigureRender__SetAlpha(klass, 0.0, 0);
    p_figure->klass = 0;
    sub_1C7BA8C(p_figure, 0, v14, v15, v16, v17, v18, v19);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C7BAE8(&AssetManager_TypeInfo);
    sub_1C7BAE8(&Method_CharaWipeEffectComponent_EndLoadWipe__);
