        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67F71 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_CharaWipeEffectComponent_EndCreateEffect__, v11);
  ...
  if ( !figure
    || (UIStandFigureRender__SetSharder(figure, (System_String_o *)StringLiteral_5057/*"Custom/Sprite-ScriptActionFigureWipe"*/, 0LL), !data)
...
LABEL_21:
    ...
    && !System_String__IsNullOrEmpty(this->fields.subEffectName, 0LL) )
  {
    ...
    v25 = System_String__Concat_62698808((System_String_o *)StringLiteral_13736/*"Talk/"*/, this->fields.subEffectName, 0LL);
    v26 = (CommonEffectLoadComponent_LoadEndHandler_o *)sub_1BE4D18(CommonEffectLoadComponent_LoadEndHandler_TypeInfo);
    ...
    CommonEffectManager__Create_41600480(v24, v25, v26, 0, 0, 0, v28);
  }
  else
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67F70 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_CharaWipeEffectComponent_EndLoadWipe__, v10);
  ...
  if ( isSkip )
  {
    ...
    sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.figure, 0LL, v17, v18, v19, v20, v21, v22);
    gameObject = (UnityEngine_Object_o *)UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    UnityEngine_Object__Destroy_70452000(gameObject, 0LL);
  ...
  {
    v24 = System_String__Concat_62698808((System_String_o *)StringLiteral_15867/*"Wipe/"*/, this->fields.wipeName, 0LL);
