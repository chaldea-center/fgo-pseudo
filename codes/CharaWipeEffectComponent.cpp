        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2DEFC & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_CharaWipeEffectComponent_EndCreateEffect__);
  ...
  if ( !figure
    || (UIStandFigureRender__SetSharder(figure, (System_String_o *)StringLiteral_4941/*"Custom/Sprite-ScriptActionFigureWipe"*/, 0), !data)
...
LABEL_21:
    ...
    && !System_String__IsNullOrEmpty(this->fields.subEffectName, 0) )
  {
    ...
    v18 = System_String__Concat_64417744((System_String_o *)StringLiteral_13685/*"Talk/"*/, this->fields.subEffectName, 0);
    v19 = (CommonEffectLoadComponent_LoadEndHandler_o *)sub_1C942E4(CommonEffectLoadComponent_LoadEndHandler_TypeInfo);
    ...
    CommonEffectManager__Create_44542236(v17, v18, v19, 0, 0, 0, 0);
  }
  else
  {
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C94098(&AssetManager_TypeInfo);
    sub_1C94098(&Method_CharaWipeEffectComponent_EndLoadWipe__);
