        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDD923 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_CharaWipeEffectComponent_EndCreateEffect__);
  ...
  if ( !figure
    || (UIStandFigureRender__SetSharder(figure, (System_String_o *)StringLiteral_5079/*"Custom/Sprite-ScriptActionFigureWipe"*/, 0LL), !data)
...
LABEL_21:
    ...
    && !System_String__IsNullOrEmpty(this->fields.subEffectName, 0LL) )
  {
    ...
    v18 = System_String__Concat_63115476((System_String_o *)StringLiteral_13792/*"Talk/"*/, this->fields.subEffectName, 0LL);
    v19 = (CommonEffectLoadComponent_LoadEndHandler_o *)sub_1C22084(CommonEffectLoadComponent_LoadEndHandler_TypeInfo);
    ...
    CommonEffectManager__Create_41906916(v17, v18, v19, 0, 0, 0, v21);
  }
  else
  {
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C21E38(&AssetManager_TypeInfo);
    sub_1C21E38(&Method_CharaWipeEffectComponent_EndLoadWipe__);
  ...
  if ( isSkip )
  {
    ...
    sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.figure, 0LL, v13, v14, v15, v16, v17, v18);
    gameObject = (UnityEngine_Object_o *)UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    UnityEngine_Object__Destroy_70869612(gameObject, 0LL);
  ...
  {
    v20 = System_String__Concat_63115476((System_String_o *)StringLiteral_15928/*"Wipe/"*/, this->fields.wipeName, 0LL);
