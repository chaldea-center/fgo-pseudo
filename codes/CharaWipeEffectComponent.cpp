        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB7936 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_CharaWipeEffectComponent_EndCreateEffect__);
  ...
  if ( !figure
    || (UIStandFigureRender__SetSharder(figure, (System_String_o *)StringLiteral_4928/*"Custom/Sprite-ScriptActionFigureWipe"*/, 0), !data)
...
LABEL_21:
    ...
    && !System_String__IsNullOrEmpty(this->fields.subEffectName, 0) )
  {
    ...
    v14 = System_String__Concat_63966792((System_String_o *)StringLiteral_13632/*"Talk/"*/, this->fields.subEffectName, 0);
    v15 = (CommonEffectLoadComponent_LoadEndHandler_o *)sub_1C6BC54(CommonEffectLoadComponent_LoadEndHandler_TypeInfo);
    ...
    CommonEffectManager__Create_43999448(v13, v14, v15, 0, 0, 0, 0);
  }
  else
  {
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C6BA08(&AssetManager_TypeInfo);
    sub_1C6BA08(&Method_CharaWipeEffectComponent_EndLoadWipe__);
