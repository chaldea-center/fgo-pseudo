        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20DEC & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_CharaWipeEffectComponent_EndCreateEffect__, v7);
  ...
  if ( !figure
    || (UIStandFigureRender__SetSharder(figure, (System_String_o *)StringLiteral_4954/*"Custom/Sprite-ScriptActionFigureWipe"*/, 0LL), !data)
...
LABEL_21:
    ...
    && !System_String__IsNullOrEmpty(this->fields.subEffectName, 0LL) )
  {
    ...
    v21 = System_String__Concat_61505504((System_String_o *)StringLiteral_13488/*"Talk/"*/, this->fields.subEffectName, 0LL);
    v22 = (CommonEffectLoadComponent_LoadEndHandler_o *)sub_1B71818(CommonEffectLoadComponent_LoadEndHandler_TypeInfo);
    ...
    CommonEffectManager__Create_40407624(v20, v21, v22, 0, 0, 0, v24);
  }
  else
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20DEB & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_CharaWipeEffectComponent_EndLoadWipe__, v6);
  ...
  if ( isSkip )
  {
    ...
    sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.figure, 0, v13, v14);
    gameObject = (UnityEngine_Object_o *)UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    UnityEngine_Object__Destroy_69257852(gameObject, 0LL);
  ...
  {
    v16 = System_String__Concat_61505504((System_String_o *)StringLiteral_15610/*"Wipe/"*/, this->fields.wipeName, 0LL);
