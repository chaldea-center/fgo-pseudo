void __fastcall CharaWipeEffectComponent___ctor(CharaWipeEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4354A93 & 1) == 0 )
  {
    sub_B70694(&StringLiteral_17697/*"circleOut"*/);
    byte_4354A93 = 1;
  }
  this->fields.wipeColor = UnityEngine_Color__get_clear(0LL);
  v3 = (System_Int32_array **)StringLiteral_17697/*"circleOut"*/;
  this->fields.wipeName = (struct System_String_o *)StringLiteral_17697/*"circleOut"*/;
  sub_B70630((BattleServantConfConponent_o *)&this->fields.wipeName, v3, v4, v5, v6, v7, v8, v9);
...
void __fastcall CharaWipeEffectComponent__EffectResume(CharaWipeEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4354A8F & 1) == 0 )
  {
    sub_B70694(&StringLiteral_10122/*"OnEndEffect"*/);
    byte_4354A8F = 1;
  }
  klass = this->klass;
  ...
  sub_B70630((BattleServantConfConponent_o *)&v7->fields.eventReceiver, v8, v9, v10, v11, v12, v13, v14);
  v15 = (System_Int32_array **)StringLiteral_10122/*"OnEndEffect"*/;
  v7->fields.callWhenFinished = (struct System_String_o *)StringLiteral_10122/*"OnEndEffect"*/;
  sub_B70630((BattleServantConfConponent_o *)&v7->fields.callWhenFinished, v15, v16, v17, v18, v19, v20, v21);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4354A8E & 1) == 0 )
  {
    ...
    sub_B70694(&Method_CharaWipeEffectComponent_EndCreateEffect__);
    ...
    sub_B70694(&StringLiteral_4617/*"Custom/Sprite-ScriptActionFigureWipe"*/);
    byte_4354A8E = 1;
  }
  ...
  if ( !figure
    || (UIStandFigureRender__SetSharder(figure, (System_String_o *)StringLiteral_4617/*"Custom/Sprite-ScriptActionFigureWipe"*/, 0LL), !data)
...
LABEL_24:
    ...
    && !System_String__IsNullOrEmpty(this->fields.subEffectName, 0LL) )
  {
    ...
    v18 = System_String__Concat_44758168((System_String_o *)StringLiteral_13738/*"Talk/"*/, this->fields.subEffectName, 0LL);
    v19 = (CommonEffectLoadComponent_LoadEndHandler_o *)sub_B70764(CommonEffectLoadComponent_LoadEndHandler_TypeInfo);
    ...
    CommonEffectManager__Create_17853304(v17, v18, v19, 0, 0, 0, 0LL);
  }
  else
  {
    CharaWipeEffectComponent__EndCreateEffect(this, 0LL, v16);
  }
}
...
void __fastcall CharaWipeEffectComponent__OnDestroy(CharaWipeEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(figure, 0LL, 0LL) )
  {
    ...
    p_figure->klass = 0LL;
    sub_B70630(p_figure, 0LL, v14, v15, v16, v17, v18, v19);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B70694(&AssetManager_TypeInfo);
    sub_B70694(&Method_CharaWipeEffectComponent_EndLoadWipe__);
  ...
  if ( isSkip )
  {
    ...
    sub_B70630((BattleServantConfConponent_o *)&this->fields.figure, 0LL, v13, v14, v15, v16, v17, v18);
    gameObject = (UnityEngine_Object_o *)UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
    if ( (BYTE3(UnityEngine_Object_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
      && !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    {
  ...
  {
    v20 = System_String__Concat_44758168((System_String_o *)StringLiteral_15717/*"Wipe/"*/, this->fields.wipeName, 0LL);
    v21 = (AssetLoader_LoadEndDataHandler_o *)sub_B70764(AssetLoader_LoadEndDataHandler_TypeInfo);
    AssetLoader_LoadEndDataHandler___ctor(v21, (Il2CppObject *)this, Method_CharaWipeEffectComponent_EndLoadWipe__, 0LL);
    if ( (BYTE3(AssetManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
      && !AssetManager_TypeInfo->_2.cctor_finished )
    {
      j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
