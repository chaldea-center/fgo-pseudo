        ...
        const MethodInfo *method)
{
  ...
  GameObjectExtensions__SafeSetParent_32091088(gameObject, parent, 0LL);
    ...
    if ( ((unsigned __int8)mZoom & 1) == 0 )
    {
      ...
      if ( !v6
        ...
        || (ZoomSize = MapZoom__GetZoomSize(mZoom, 0LL),
            gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL),
            GameObjectExtensions__SetLocalScale_32087280(gameObject, ZoomSize, ZoomSize, 0LL),
      ...
      v13.fields.y = v11;
      GameObjectExtensions__SetLocalPosition_32084952(v12, v13, 0LL);
    }
  }
}
