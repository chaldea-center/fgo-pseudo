        ...
        const MethodInfo *method)
{
  ...
  GameObjectExtensions__SafeSetParent_36750960(gameObject, parent, 0);
  this->fields.mapCamera = mapCamera;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.mapCamera, (int32_t)mapCamera, v8, v9, v10, v11, v12, v13);
}
    ...
    if ( ((unsigned __int8)mCamera & 1) == 0 )
    {
      ...
      if ( !v6
        ...
        || (orthographicSize = UnityEngine_Camera__get_orthographicSize(mCamera, 0),
            gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0),
            GameObjectExtensions__SetLocalScale_36747236(gameObject, orthographicSize, orthographicSize, 0),
            (v10 = this->fields.mapCamera) == 0)
        || (mCamera = (UnityEngine_Camera_o *)v10->fields.mScrl) == 0 )
      {
        sub_1C93D2C(mCamera, v5);
      }
      ScrlPosVec3 = (unsigned __int64)MapScroll__GetScrlPosVec3((MapScroll_o *)mCamera, v5);
      v11 = *((float *)&ScrlPosVec3 + 1) + this->fields._OffestPositionY_k__BackingField;
      v12 = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0);
      LODWORD(v14.fields.x) = ScrlPosVec3;
      v14.fields.y = v11;
      GameObjectExtensions__SetLocalPosition_36745064(v12, v14, 0);
    }
  }
}
