        ...
        const MethodInfo *method)
{
  ...
  GameObjectExtensions__SafeSetParent_33535352(gameObject, parent, v8);
  this->fields.mapCamera = mapCamera;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.mapCamera, (int32_t)mapCamera, v9, v10);
}
    ...
    if ( ((unsigned __int8)mZoom & 1) == 0 )
    {
      ...
      if ( !v6
        ...
        || (ZoomSize = MapZoom__GetZoomSize(mZoom, 0LL),
            gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL),
            GameObjectExtensions__SetLocalScale_33531584(gameObject, ZoomSize, ZoomSize, v9),
      ...
      v15.fields.y = v12;
      GameObjectExtensions__SetLocalPosition_33529300(v13, v15, v14);
    }
  }
}
