        ...
        const MethodInfo *method)
{
  ...
  GameObjectExtensions__SafeSetParent_34075504(gameObject, parent, v8);
  this->fields.mapCamera = mapCamera;
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.mapCamera, (int32_t)mapCamera, v9, v10);
}
    ...
    if ( ((unsigned __int8)mZoom & 1) == 0 )
    {
      ...
      if ( !v6
        ...
        || (ZoomSize = MapZoom__GetZoomSize(mZoom, 0LL),
            gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL),
            GameObjectExtensions__SetLocalScale_34071736(gameObject, ZoomSize, ZoomSize, v9),
      ...
      v15.fields.y = v12;
      GameObjectExtensions__SetLocalPosition_34069452(v13, v15, v14);
    }
  }
}
