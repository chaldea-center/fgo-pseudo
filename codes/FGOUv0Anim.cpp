void __fastcall FGOUv0Anim___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B15090 & 1) == 0 )
  {
    sub_1BCA7E0(&FGOUv0Anim_TypeInfo, v1, v2);
    sub_1BCA7E0(&StringLiteral_16431/*"_MainTex"*/, v3, v4);
    byte_4B15090 = 1;
  }
...
void __fastcall FGOUv0Anim__UpdateUV(FGOUv0Anim_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1508F & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&FGOUv0Anim_TypeInfo, v4, v5);
  ...
  if ( !FGOUv0Anim_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(FGOUv0Anim_TypeInfo, v12);
  if ( !v18 )
LABEL_28:
    sub_1BCAA3C(gameObject, v12);
  if ( UnityEngine_Material__HasProperty(v18, FGOUv0Anim_TypeInfo->static_fields->mainTexID, 0LL) )
  {
    v20 = FGOUv0Anim_TypeInfo;
    if ( !FGOUv0Anim_TypeInfo->_2.cctor_finished )
    {
      j_il2cpp_runtime_class_init_0(FGOUv0Anim_TypeInfo, v19);
      v20 = FGOUv0Anim_TypeInfo;
    }
    UnityEngine_Material__SetTextureOffset_70019752(v18, v20->static_fields->mainTexID, this->fields.m_Offset, 0LL);
  }
  if ( !UnityEngine_Application_TypeInfo->_2.cctor_finished )
