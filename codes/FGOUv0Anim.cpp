void __fastcall FGOUv0Anim___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48E1742 & 1) == 0 )
  {
    sub_1B00CCC(&FGOUv0Anim_TypeInfo, v1);
    sub_1B00CCC(&StringLiteral_16030/*"_MainTex"*/, v2);
    byte_48E1742 = 1;
  }
...
void __fastcall FGOUv0Anim__UpdateUV(FGOUv0Anim_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E1741 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&FGOUv0Anim_TypeInfo, v3);
    sub_1B00CCC(&Method_UnityEngine_GameObject_GetComponent_Renderer___, v4);
  ...
  else
  {
    ...
    UnityEngine_Material___ctor_67941016(v11, v10, 0LL);
  }
...
LABEL_28:
  ...
  if ( UnityEngine_Material__HasProperty(v11, FGOUv0Anim_TypeInfo->static_fields->mainTexID, 0LL) )
  {
    ...
    UnityEngine_Material__SetTextureOffset_67943252(v11, v12->static_fields->mainTexID, this->fields.m_Offset, 0LL);
  }
  if ( !UnityEngine_Application_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Application_TypeInfo);
  if ( !UnityEngine_Application__get_isPlaying(0LL) )
