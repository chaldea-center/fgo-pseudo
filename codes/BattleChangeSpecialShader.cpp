void BattleChangeSpecialShader___ctor(BattleChangeSpecialShader_o *this, const MethodInfo *method)
{
  ...
  v3 = (System_Collections_Generic_List_object__o *)sub_1C6BC54(System_Collections_Generic_List_Renderer__TypeInfo);
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.targetRendererList, (int32_t)v3, v4, v5);
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.shadowAuraList, (int32_t)v6, v7, v8);
...
void BattleChangeSpecialShader__ChangeShader(BattleChangeSpecialShader_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB7905 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_BattleChangeSpecialShader___c__ChangeShader_b__13_0__);
    sub_1C6BA08(&BattleChangeSpecialShader___c_TypeInfo);
  ...
  if ( ((unsigned __int8)monitor & 1) == 0 )
  {
    ...
    if ( BattleActorControl__isShadowServant((BattleActorControl_o *)v3, 0) )
    {
      ...
      if ( ((unsigned __int8)monitor & 1) != 0 )
      {
        ...
        if ( !_9__13_0 )
        {
          ...
          _9__13_0 = (System_Func_object__object__o *)sub_1C6BC54(System_Func_SkinnedMeshRenderer__IEnumerable_Material___TypeInfo);
      ...
      else
      {
        ...
        if ( !monitor )
          goto LABEL_65;
        v41 = 0;
        while ( v41 < monitor->fields.uniqueId )
        {
          ...
          if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)Item, 0, 0) )
          {
            if ( Item )
            {
                ...
                && (UnityEngine_SkinnedMeshRenderer_c *)Item->klass->_2.typeHierarchy[naturalAligment - 1] == UnityEngine_SkinnedMeshRenderer_TypeInfo )
              {
                ...
                v45 = (UnityEngine_Material_o *)monitor;
      ...
      if ( this->fields.isCreateShadowAura )
      {
        ...
        if ( !BattleEffectUtility_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(BattleEffectUtility_TypeInfo);
        monitor = (BattleServantData_o *)BattleEffectUtility__CreateShadowEffectAndAttachForEachNodes(v30, v29, 0);
        if ( !shadowAuraList )
          goto LABEL_65;
    ...
    {
      v31 = UnityEngine_Shader__Find((System_String_o *)StringLiteral_4904/*"Custom/SoftEdgeUnlitCutZ_Choco"*/, 0);
      ...
      {
        v33 = (UnityEngine_Texture_o *)monitor;
        v34 = 0;
        while ( 1 )
        {
          ...
          if ( monitor )
          {
            ...
            if ( monitor->klass->_2.naturalAligment >= (unsigned int)v35
              && (UnityEngine_SkinnedMeshRenderer_c *)monitor->klass->_2.typeHierarchy[v35 - 1] == UnityEngine_SkinnedMeshRenderer_TypeInfo )
            {
...
LABEL_48:
        ...
        while ( 1 )
        {
          ...
          v47.fields.b = 1.0;
          v47.fields.a = 1.0;
          UnityEngine_Material__SetColor(v40, (System_String_o *)StringLiteral_16166/*"_Color"*/, v47, 0);
          v48.fields.r = 0.0;
          v48.fields.g = 0.0;
          v48.fields.b = 0.0;
          v48.fields.a = 0.0;
          UnityEngine_Material__SetColor(v40, (System_String_o *)StringLiteral_16114/*"_AddColor"*/, v48, 0);
          UnityEngine_Material__SetTexture(v40, (System_String_o *)StringLiteral_16147/*"_ChocoTex"*/, v33, 0);
...
void BattleChangeSpecialShader___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C6BC54(BattleChangeSpecialShader___c_TypeInfo);
  System_Object___ctor(v1, 0);
  BattleChangeSpecialShader___c_TypeInfo->static_fields->__9 = (struct BattleChangeSpecialShader___c_o *)v1;
  sub_1C6B9AC((CGThumbnailListItem_o *)BattleChangeSpecialShader___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
