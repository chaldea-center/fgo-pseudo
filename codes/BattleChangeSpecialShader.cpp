void __fastcall BattleChangeSpecialShader___ctor(BattleChangeSpecialShader_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FD6E1 & 1) == 0 )
  {
    ...
    sub_1B640C8(&System_Collections_Generic_List_Renderer__TypeInfo, v4);
    byte_49FD6E1 = 1;
  }
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.targetRendererList, (int32_t)v5, v6, v7);
...
void __fastcall BattleChangeSpecialShader__ChangeShader(BattleChangeSpecialShader_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FD6DF & 1) == 0 )
  {
    sub_1B640C8(&Method_System_Collections_Generic_List_Renderer__get_Count__, method);
    sub_1B640C8(&Method_System_Collections_Generic_List_Renderer__get_Item__, v3);
    ...
    sub_1B640C8(&UnityEngine_SkinnedMeshRenderer_TypeInfo, v7);
    sub_1B640C8(&StringLiteral_16110/*"_Color"*/, v8);
    sub_1B640C8(&StringLiteral_16091/*"_ChocoTex"*/, v9);
    sub_1B640C8(&StringLiteral_4930/*"Custom/SoftEdgeUnlitCutZ_Choco"*/, v10);
  ...
  if ( ((unsigned __int8)Instance & 1) == 0 )
  {
    ...
    {
      v23 = UnityEngine_Shader__Find((System_String_o *)StringLiteral_4930/*"Custom/SoftEdgeUnlitCutZ_Choco"*/, 0LL);
      ...
      {
        v25 = (UnityEngine_Texture_o *)Instance;
        v26 = 0;
        while ( 1 )
        {
          if ( v26 >= targetRendererList->fields._size )
            return;
          ...
          if ( Instance )
          {
            v27 = LOBYTE(UnityEngine_SkinnedMeshRenderer_TypeInfo->vtable._0_Equals.methodPtr);
            if ( *(unsigned __int8 *)(*(_QWORD *)Instance + 304LL) >= (unsigned int)v27
              && *(UnityEngine_SkinnedMeshRenderer_c **)(*(_QWORD *)(*(_QWORD *)Instance + 200LL) + 8 * v27 - 8) == UnityEngine_SkinnedMeshRenderer_TypeInfo )
            {
...
LABEL_42:
        ...
        while ( 1 )
        {
          ...
          if ( !v33 )
            break;
          UnityEngine_Material__set_shader(*((UnityEngine_Material_o **)v32 + 4), v23, 0LL);
          v36.fields.r = 1.0;
          v36.fields.g = 1.0;
          v36.fields.b = 1.0;
          v36.fields.a = 1.0;
          UnityEngine_Material__SetColor(v33, (System_String_o *)StringLiteral_16110/*"_Color"*/, v36, 0LL);
          v37.fields.r = 0.0;
          v37.fields.g = 0.0;
          v37.fields.b = 0.0;
          v37.fields.a = 0.0;
          UnityEngine_Material__SetColor(v33, (System_String_o *)StringLiteral_16066/*"_AddColor"*/, v37, 0LL);
          UnityEngine_Material__SetTexture(v33, (System_String_o *)StringLiteral_16091/*"_ChocoTex"*/, v25, 0LL);
          v29 = v30[6];
          if ( (int)++v31 >= v29 )
            goto LABEL_42;
        }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD6E0 & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_UnityEngine_Object_FindObjectsOfType_BattleActorControl___, v3);
    sub_1B640C8(&UnityEngine_Object_TypeInfo, v4);
  ...
  {
    Instance = (System_Object_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EC03C *)Method_SingletonMonoBehaviour_BattleSequenceManager__get_Instance__);
    if ( Instance )
    {
...
LABEL_20:
  ...
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  Instance = UnityEngine_Object__FindObjectsOfType_object_((const MethodInfo_2EBBB44 *)Method_UnityEngine_Object_FindObjectsOfType_BattleActorControl___);
  if ( !Instance )
    goto LABEL_20;
