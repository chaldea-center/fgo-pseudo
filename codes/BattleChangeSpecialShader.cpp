void __fastcall BattleChangeSpecialShader___ctor(BattleChangeSpecialShader_o *this, const MethodInfo *method)
{
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.targetRendererList, (int64_t)v3, v4, v5, v6, v7, v8, v9);
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.shadowAuraList, (int64_t)v10, v11, v12, v13, v14, v15, v16);
...
void __fastcall BattleChangeSpecialShader__ChangeShader(BattleChangeSpecialShader_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDD8F2 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_BattleChangeSpecialShader___c__ChangeShader_b__13_0__);
    sub_1C21E38(&BattleChangeSpecialShader___c_TypeInfo);
  ...
  klass = (BattleServantData_o *)UnityEngine_Object__op_Equality(v3, 0LL, 0LL);
  if ( ((unsigned __int8)klass & 1) == 0 )
  {
    ...
    {
      klass = (BattleServantData_o *)v3[19].klass;
      if ( !klass )
        goto LABEL_65;
      ...
      if ( ((unsigned __int8)klass & 1) != 0 )
      {
        ...
        if ( !_9__13_0 )
        {
          ...
          _9__13_0 = (System_Func_object__object__o *)sub_1C22084(System_Func_SkinnedMeshRenderer__IEnumerable_Material___TypeInfo);
        ...
        BattleEffectUtility__SetShadowServantColorToMaterials(v20, v19, 0LL);
      }
      else
      {
        ...
        if ( !klass )
          goto LABEL_65;
        v45 = 0;
        while ( v45 < klass->fields.uniqueId )
        {
          ...
          if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)Item, 0LL, 0LL) )
          {
            if ( Item )
            {
                ...
                && (UnityEngine_SkinnedMeshRenderer_c *)Item->klass->_2.typeHierarchy[methodPtr_low - 1] == UnityEngine_SkinnedMeshRenderer_TypeInfo )
              {
                ...
                v49 = (UnityEngine_Material_o *)klass;
                ...
                if ( !v49 )
                  goto LABEL_65;
                UnityEngine_Material__set_color(v49, v48->static_fields->ShadowServantDefaultColor, 0LL);
              }
            }
          }
          klass = (BattleServantData_o *)this->fields.targetRendererList;
      ...
      if ( this->fields.isCreateShadowAura )
      {
        ...
        v30 = (Il2CppObject *)UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0LL);
        ...
        if ( !BattleEffectUtility_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(BattleEffectUtility_TypeInfo);
        klass = (BattleServantData_o *)BattleEffectUtility__CreateShadowEffectAndAttachForEachNodes(v34, v33, 0LL);
        if ( !shadowAuraList )
          goto LABEL_65;
    ...
    {
      v35 = UnityEngine_Shader__Find((System_String_o *)StringLiteral_5055/*"Custom/SoftEdgeUnlitCutZ_Choco"*/, 0LL);
      ...
      {
        v37 = (UnityEngine_Texture_o *)klass;
        v38 = 0;
        while ( 1 )
        {
          ...
          if ( klass )
          {
            v39 = LOBYTE(UnityEngine_SkinnedMeshRenderer_TypeInfo->vtable._0_Equals.methodPtr);
            if ( LOBYTE(klass->klass->vtable._0_Equals.methodPtr) >= (unsigned int)v39
              && (UnityEngine_SkinnedMeshRenderer_c *)klass->klass->_2.typeHierarchy[v39 - 1] == UnityEngine_SkinnedMeshRenderer_TypeInfo )
            {
...
LABEL_48:
        ...
        {
          if ( v42 >= uniqueId )
            sub_1C2209C(klass, v5);
          v43 = &v41->klass + (int)v42;
          v44 = (UnityEngine_Material_o *)v43[4];
          if ( !v44 )
            break;
          UnityEngine_Material__set_shader((UnityEngine_Material_o *)v43[4], v35, 0LL);
          v51.fields.r = 1.0;
          v51.fields.g = 1.0;
          v51.fields.b = 1.0;
          v51.fields.a = 1.0;
          UnityEngine_Material__SetColor(v44, (System_String_o *)StringLiteral_16455/*"_Color"*/, v51, 0LL);
          v52.fields.r = 0.0;
          v52.fields.g = 0.0;
          v52.fields.b = 0.0;
          v52.fields.a = 0.0;
          UnityEngine_Material__SetColor(v44, (System_String_o *)StringLiteral_16411/*"_AddColor"*/, v52, 0LL);
          UnityEngine_Material__SetTexture(v44, (System_String_o *)StringLiteral_16436/*"_ChocoTex"*/, v37, 0LL);
...
void __fastcall BattleChangeSpecialShader___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C22084(BattleChangeSpecialShader___c_TypeInfo);
