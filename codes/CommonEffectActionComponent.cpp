...
void CommonEffectActionComponent__Awake(CommonEffectActionComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEFC7C & 1) == 0 )
  {
    sub_1C7BAE8(&Method_System_Collections_Generic_Dictionary_int__Action___ctor__);
    sub_1C7BAE8(&System_Collections_Generic_Dictionary_int__Action__TypeInfo);
    byte_4CEFC7C = 1;
  }
  v3 = (System_Collections_Generic_Dictionary_int__object__o *)sub_1C7BD34(System_Collections_Generic_Dictionary_int__Action__TypeInfo);
  System_Collections_Generic_Dictionary_int__object____ctor(
    v3,
    (const MethodInfo_3486D3C *)Method_System_Collections_Generic_Dictionary_int__Action___ctor__);
  this->fields.eventActionList = (struct System_Collections_Generic_Dictionary_int__Action__o *)v3;
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.eventActionList, (int32_t)v3, v4, v5, v6, v7, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEFC7E & 1) == 0 )
  {
    sub_1C7BAE8(&Method_System_Collections_Generic_Dictionary_int__Action__ContainsKey__);
    sub_1C7BAE8(&Method_System_Collections_Generic_Dictionary_int__Action__get_Item__);
    byte_4CEFC7E = 1;
  }
  ...
  if ( eventActionList
    && System_Collections_Generic_Dictionary_int__object___ContainsKey(
         ...
         key,
         (const MethodInfo_3487904 *)Method_System_Collections_Generic_Dictionary_int__Action__ContainsKey__) )
  {
    ...
    Item = System_Collections_Generic_Dictionary_int__object___get_Item(
             ...
             key,
             (const MethodInfo_3487670 *)Method_System_Collections_Generic_Dictionary_int__Action__get_Item__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEFC7D & 1) == 0 )
  {
    sub_1C7BAE8(&Method_System_Collections_Generic_Dictionary_int__Action__set_Item__);
    byte_4CEFC7D = 1;
  }
  eventActionList = this->fields.eventActionList;
  if ( eventActionList )
    System_Collections_Generic_Dictionary_int__object___set_Item(
      ...
      key,
      (Il2CppObject *)action,
      (const MethodInfo_34876FC *)Method_System_Collections_Generic_Dictionary_int__Action__set_Item__);
}
