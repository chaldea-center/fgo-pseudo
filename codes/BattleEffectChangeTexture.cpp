void __fastcall BattleEffectChangeTexture___ctor(BattleEffectChangeTexture_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42AECFA & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_16996/*"body_level"*/);
    byte_42AECFA = 1;
  }
  LODWORD(this->fields.sourceServantIds) = -1;
  LOBYTE(this->fields.searchMeshWord) = 1;
  v9 = (System_Int32_array **)StringLiteral_16996/*"body_level"*/;
  this->fields.targetRendererList = (struct System_Collections_Generic_List_Renderer__o *)StringLiteral_16996/*"body_level"*/;
  sub_B52920((BattleServantConfConponent_o *)&this->fields.targetRendererList, v9, v2, v3, v4, v5, v6, v7);
  v10 = (System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData__o *)sub_B52A54(System_Collections_Generic_List_Renderer__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (servantId & 0x80000000) == 0 )
  {
    ...
    if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)v5, 0LL, 0LL) )
      BattleEffectChangeTexture__ChangeTexture_22994680(this, v5, v6);
  }
}


void __fastcall BattleEffectChangeTexture__ChangeTexture_22994680(
        BattleEffectChangeTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AECF8 & 1) == 0 )
  {
    ...
    this = (BattleEffectChangeTexture_o *)sub_B52984(&StringLiteral_16022/*"_AddColor"*/);
    byte_42AECF8 = 1;
  }
  ...
  if ( sourceServantIds >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        ...
        if ( !this )
          break;
        this = (BattleEffectChangeTexture_o *)System_String__IndexOf_44640664(
  ...
  if ( *(_QWORD *)&v4->fields.isCreateShadowAura )
  {
    ...
    if ( ((unsigned __int8)this & 1) != 0 )
    {
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        ...
        {
          this = (BattleEffectChangeTexture_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_ServantAssetLoadManager__get_Instance__);
          if ( !this )
            goto LABEL_71;
      ...
      {
        v26 = UnityEngine_Shader__Find((System_String_o *)StringLiteral_4555/*"Custom/SoftEdgeUnlitCutZ_Choco"*/, 0LL);
          ...
          while ( 1 )
          {
            ...
            if ( v30 )
            {
                ...
                && (UnityEngine_SkinnedMeshRenderer_c *)v30->klass->_2.typeHierarchy[v31 - 1] == UnityEngine_SkinnedMeshRenderer_TypeInfo )
              {
                ...
                {
                  v47 = (BattleEffectChangeTexture_o *)sub_B52D50(v30);
                ...
                if ( v41 >= 1 )
                {
                  ...
                  while ( v43 < v41 )
                  {
                    ...
                    v56.fields.b = b;
                    v56.fields.a = a;
                    UnityEngine_Material__SetColor(v45, (System_String_o *)StringLiteral_16061/*"_Color"*/, v56, 0LL);
                    *(_QWORD *)&v57.fields.r = methoda.methodPointer;
                    *(_QWORD *)&v57.fields.b = methoda.invoker_method;
                    UnityEngine_Material__SetColor(v45, (System_String_o *)StringLiteral_16022/*"_AddColor"*/, v57, 0LL);
                    UnityEngine_Material__SetTexture(v45, (System_String_o *)StringLiteral_16045/*"_ChocoTex"*/, v28, 0LL);
  ...
  if ( v4 && *(int *)(v4 + 24) >= 1 )
  {
    if ( BYTE1(this->fields.searchMeshWord) )
    {
      ...
      if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)Component_srcLineSprite, 0LL, 0LL) )
        BattleEffectChangeTexture__ChangeTexture_22994680(this, Component_srcLineSprite, v8);
    }
    else
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      if ( v9 >= max_length )
      {
        v13 = sub_B52A88(ObjectsOfType_object);
        sub_B52A28(v13, 0LL);
      }
...
LABEL_17:
    sub_B52A5C(ObjectsOfType_object, v6);
  }
  return 0LL;
}
