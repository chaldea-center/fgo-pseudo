void BattleEffectChangeTexture___ctor(BattleEffectChangeTexture_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB790E & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_17340/*"body_level"*/);
    byte_4CB790E = 1;
  }
  this->fields.sourceServantId = -1;
  this->fields.isCheckUniqueId = 1;
  v5 = StringLiteral_17340/*"body_level"*/;
  this->fields.searchMeshWord = (struct System_String_o *)StringLiteral_17340/*"body_level"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.searchMeshWord, v5, v2, v3);
  v6 = (System_Collections_Generic_List_object__o *)sub_1C6BC54(System_Collections_Generic_List_Renderer__TypeInfo);
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.targetRendererList, (int32_t)v6, v7, v8);
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.shadowAuraList, (int32_t)v9, v10, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( (servantId & 0x80000000) == 0 )
  {
    ...
    if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)v5, 0, 0) )
      BattleEffectChangeTexture__ChangeTexture_43953660(this, v5, v6);
  }
}


void BattleEffectChangeTexture__ChangeTexture_43953660(
        BattleEffectChangeTexture_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB790C & 1) == 0 )
  {
    sub_1C6BA08(&Method_System_Array_Empty_Transform___);
    sub_1C6BA08(&Method_BasicHelper_ExcludeNull_Transform___);
    ...
    sub_1C6BA08(&Method_System_Linq_Enumerable_Append_Transform___);
    sub_1C6BA08(&Method_System_Linq_Enumerable_DefaultIfEmpty_Transform___);
    sub_1C6BA08(&Method_System_Linq_Enumerable_OfType_SkinnedMeshRenderer___);
    sub_1C6BA08(&Method_System_Linq_Enumerable_SelectMany_SkinnedMeshRenderer__Material___);
    sub_1C6BA08(&System_Func_SkinnedMeshRenderer__IEnumerable_Material___TypeInfo);
    ...
    sub_1C6BA08(&Method_BattleEffectChangeTexture___c__ChangeTexture_b__16_0__);
    sub_1C6BA08(&BattleEffectChangeTexture___c_TypeInfo);
    ...
    this = (BattleEffectChangeTexture_o *)sub_1C6BA08(&StringLiteral_16114/*"_AddColor"*/);
    byte_4CB790C = 1;
  }
  entity = 0;
  if ( !actor )
  ...
  if ( m_CancellationTokenSource >= 1 )
  {
    ...
    while ( v7 < m_CancellationTokenSource )
    {
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        ...
        if ( !this )
          goto LABEL_85;
        this = (BattleEffectChangeTexture_o *)System_String__IndexOf_64025184(
...
LABEL_14:
  if ( v4->fields.targetRendererList )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(v9, 0, 0) )
    {
      ...
      if ( BattleActorControl__isShadowServant(actor, 0) )
      {
        ...
        if ( ((unsigned __int8)this & 1) != 0 )
        {
          ...
          v13 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__OfType_object_(
                                                                       ...
                                                                       (const MethodInfo_316A620 *)Method_System_Linq_Enumerable_OfType_SkinnedMeshRenderer___);
          ...
          if ( !_9__16_0 )
          {
            ...
            _9__16_0 = (System_Func_object__object__o *)sub_1C6BC54(System_Func_SkinnedMeshRenderer__IEnumerable_Material___TypeInfo);
            ...
            sub_1C6B9AC((CGThumbnailListItem_o *)&static_fields->__9__16_0, (int32_t)_9__16_0, v18, v19);
          }
          v20 = System_Linq_Enumerable__SelectMany_object__object_(
                  v13,
                  (System_Func_TSource__IEnumerable_TResult___o *)_9__16_0,
                  (const MethodInfo_3174900 *)Method_System_Linq_Enumerable_SelectMany_SkinnedMeshRenderer__Material___);
          v21 = entity;
        ...
        if ( v4->fields.isCreateShadowAura )
        {
          ...
          if ( !shadowAuraNodeTransformArray )
          {
            ...
            if ( !v25 )
            {
              sub_1C41AF8(Method_System_Array_Empty_Transform___);
              v25 = v24[7];
            }
            v26 = *(_QWORD *)(v25 + 16);
          ...
          appended = (System_Collections_Generic_IEnumerable_T__o *)System_Linq_Enumerable__Append_object_(
                                                                      ...
                                                                      NodeFromName,
                                                                      (const MethodInfo_3149554 *)Method_System_Linq_Enumerable_Append_Transform___);
          v31 = BasicHelper__ExcludeNull_object_(
                  appended,
                  (const MethodInfo_3124D84 *)Method_BasicHelper_ExcludeNull_Transform___);
          ...
          v33 = System_Linq_Enumerable__DefaultIfEmpty_object_(
                  ...
                  v32,
                  (const MethodInfo_315E2C8 *)Method_System_Linq_Enumerable_DefaultIfEmpty_Transform___);
      ...
      {
        v37 = UnityEngine_Shader__Find((System_String_o *)StringLiteral_4904/*"Custom/SoftEdgeUnlitCutZ_Choco"*/, 0);
...
LABEL_68:
          ...
          while ( v44 < v42 )
          {
            ...
            v53.fields.b = 1.0;
            v53.fields.a = 1.0;
            UnityEngine_Material__SetColor(v46, (System_String_o *)StringLiteral_16166/*"_Color"*/, v53, 0);
            v54.fields.r = 0.0;
            v54.fields.g = 0.0;
            v54.fields.b = 0.0;
            v54.fields.a = 0.0;
            UnityEngine_Material__SetColor(v46, (System_String_o *)StringLiteral_16114/*"_AddColor"*/, v54, 0);
...
void BattleEffectChangeTexture__Execute(BattleEffectChangeTexture_o *this, const MethodInfo *method)
{
  ...
  if ( targetRendererList && targetRendererList->fields._size >= 1 )
  {
    ...
    {
      Instance = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A4F3B4 *)Method_SingletonMonoBehaviour_BattleSequenceManager__get_Instance__);
      ...
      if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)Component_object, 0, 0) )
        BattleEffectChangeTexture__ChangeTexture_43953660(this, (BattleActorControl_o *)Component_object, v8);
    }
    else
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB790D & 1) == 0 )
  {
    sub_1C6BA08(&Method_UnityEngine_Object_FindObjectsOfType_BattleActorControl___);
    sub_1C6BA08(&UnityEngine_Object_TypeInfo);
    byte_4CB790D = 1;
  }
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  ObjectsOfType_object = UnityEngine_Object__FindObjectsOfType_object_((const MethodInfo_31C7DB8 *)Method_UnityEngine_Object_FindObjectsOfType_BattleActorControl___);
...
LABEL_17:
    sub_1C6BC60(ObjectsOfType_object, v6);
  }
  return 0;
}
...
void BattleEffectChangeTexture__OnDestroy(BattleEffectChangeTexture_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB7909 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_UnityEngine_Object_Destroy__);
    byte_4CB7909 = 1;
  }
  ...
  v4 = (System_Action_object__o *)sub_1C6BC54(System_Action_GameObject__TypeInfo);
...
void BattleEffectChangeTexture___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C6BC54(BattleEffectChangeTexture___c_TypeInfo);
  System_Object___ctor(v1, 0);
  BattleEffectChangeTexture___c_TypeInfo->static_fields->__9 = (struct BattleEffectChangeTexture___c_o *)v1;
  sub_1C6B9AC((CGThumbnailListItem_o *)BattleEffectChangeTexture___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
