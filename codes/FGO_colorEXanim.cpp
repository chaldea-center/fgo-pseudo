void __fastcall FGO_colorEXanim___ctor(FGO_colorEXanim_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49B9CE0 & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_16304/*"_xxxColor"*/, method);
    byte_49B9CE0 = 1;
  }
  __asm { FMOV            V0.4S, #1.0 }
  this->fields.customColor = _Q0;
  v10 = StringLiteral_16304/*"_xxxColor"*/;
  this->fields.targetColorName = (struct System_String_o *)StringLiteral_16304/*"_xxxColor"*/;
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.targetColorName, v10, v2, v3);
...
void __fastcall FGO_colorEXanim__Start(FGO_colorEXanim_o *this, const MethodInfo *method)
{
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields._renderer, (int32_t)Component_object, v4, v5);
