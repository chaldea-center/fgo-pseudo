void __fastcall FGO_colorEXanim___ctor(FGO_colorEXanim_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1B2F9 & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_16481/*"_xxxColor"*/, method);
    byte_4B1B2F9 = 1;
  }
  __asm { FMOV            V0.4S, #1.0 }
  this->fields.customColor = _Q0;
  v10 = StringLiteral_16481/*"_xxxColor"*/;
  this->fields.targetColorName = (struct System_String_o *)StringLiteral_16481/*"_xxxColor"*/;
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.targetColorName, v10, v2, v3);
...
void __fastcall FGO_colorEXanim__Start(FGO_colorEXanim_o *this, const MethodInfo *method)
{
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields._renderer, (int32_t)Component_object, v4, v5);
