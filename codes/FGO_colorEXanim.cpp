void __fastcall FGO_colorEXanim___ctor(FGO_colorEXanim_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5A039 & 1) == 0 )
  {
    sub_1B885B0(&StringLiteral_16607/*"_xxxColor"*/);
    byte_4A5A039 = 1;
  }
  __asm { FMOV            V0.4S, #1.0 }
  this->fields.customColor = _Q0;
  v10 = StringLiteral_16607/*"_xxxColor"*/;
  this->fields.targetColorName = (struct System_String_o *)StringLiteral_16607/*"_xxxColor"*/;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.targetColorName, v10, v2, v3);
