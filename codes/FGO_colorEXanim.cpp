void __fastcall FGO_colorEXanim___ctor(FGO_colorEXanim_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFC5C0 & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_16899/*"_xxxColor"*/, method);
    byte_4BFC5C0 = 1;
  }
  __asm { FMOV            V0.4S, #1.0 }
  this->fields.customColor = _Q0;
  v14 = StringLiteral_16899/*"_xxxColor"*/;
  this->fields.targetColorName = (struct System_String_o *)StringLiteral_16899/*"_xxxColor"*/;
  sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.targetColorName, v14, v2, v3, v4, v5, v6, v7);
...
void __fastcall FGO_colorEXanim__Start(FGO_colorEXanim_o *this, const MethodInfo *method)
{
  ...
  sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields._renderer, (int64_t)Component_object, v4, v5, v6, v7, v8, v9);
