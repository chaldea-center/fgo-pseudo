...
void ViewEnemyEntity___ctor_43548080(ViewEnemyEntity_o *this, ViewEnemyEntity_o *old, const MethodInfo *method)
{
  __int64 v5; // x0
  __int64 v6; // x1
  int32_t v7; // w2
...
int32_t ViewEnemyEntity__GetColorType(ViewEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  return EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_18082/*"colorType"*/, 0, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC84D7 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_System_Collections_Generic_List_Enumerator_EventMissionCondDetailEntity__Dispose__);
    sub_1C713B0(&Method_System_Collections_Generic_List_Enumerator_EventMissionCondDetailEntity__MoveNext__);
    sub_1C713B0(&Method_System_Collections_Generic_List_Enumerator_EventMissionCondDetailEntity__get_Current__);
    sub_1C713B0(&Method_System_Collections_Generic_List_EventMissionCondDetailEntity__GetEnumerator__);
    sub_1C713B0(&Method_System_Collections_Generic_List_EventMissionCondDetailEntity__get_Count__);
...
LABEL_36:
            ...
            if ( Instance && SLODWORD(Instance->fields.m_CancellationTokenSource) >= 1 )
            {
              System_Collections_Generic_List_object___GetEnumerator(
                ...
                (const MethodInfo_3811210 *)Method_System_Collections_Generic_List_EventMissionCondDetailEntity__GetEnumerator__);
              v36 = v35;
              while ( 1 )
              {
                v25 = System_Collections_Generic_List_Enumerator_object___MoveNext(
                        &v36,
                        (const MethodInfo_35962C8 *)Method_System_Collections_Generic_List_Enumerator_EventMissionCondDetailEntity__MoveNext__);
                if ( !v25 )
                  break;
                       ...
                       (const MethodInfo_3168198 *)Method_System_Linq_Enumerable_Contains_int___) )
                {
                  System_Collections_Generic_List_Enumerator_object___Dispose(
                    &v36,
                    (const MethodInfo_35962C4 *)Method_System_Collections_Generic_List_Enumerator_EventMissionCondDetailEntity__Dispose__);
                  goto LABEL_47;
                }
              }
              System_Collections_Generic_List_Enumerator_object___Dispose(
...
int32_t ViewEnemyEntity__getEnemyNameEffect(ViewEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  return ViewEnemyEntity__getScript(this, (System_String_o *)StringLiteral_19097/*"enemyNameEffect"*/, 0, v2);
}
