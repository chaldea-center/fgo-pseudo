void __fastcall WarBoardMessageMaster___ctor(WarBoardMessageMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A2EEF6 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_WarBoardMessageMaster__WarBoardMessageEntity__string___ctor__, method);
    byte_4A2EEF6 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    413,
    (const MethodInfo_30FFA98 *)Method_DataMasterBase_WarBoardMessageMaster__WarBoardMessageEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EEF7 & 1) == 0 )
  {
    sub_1B761C0(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__GetEnumerator__, *(_QWORD *)&stageId);
    sub_1B761C0(&Method_System_Linq_Enumerable_Any_WarBoardMessageEntity___, v11);
    ...
    sub_1B761C0(&Method_System_Collections_Generic_List_WarBoardMessageEntity__Add__, v15);
    sub_1B761C0(&Method_System_Collections_Generic_List_WarBoardMessageEntity___ctor__, v16);
    sub_1B761C0(&Method_System_Collections_Generic_List_WarBoardTaskBase___ctor__, v17);
    sub_1B761C0(&System_Collections_Generic_List_WarBoardTaskBase__TypeInfo, v18);
    sub_1B761C0(&System_Collections_Generic_List_WarBoardMessageEntity__TypeInfo, v19);
    sub_1B761C0(&WarBoardMessageEntity_TypeInfo, v20);
    byte_4A2EEF7 = 1;
  }
  v21 = (System_Collections_Generic_List_object__o *)sub_1B7640C(System_Collections_Generic_List_WarBoardMessageEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v21,
    (const MethodInfo_34D6DA0 *)Method_System_Collections_Generic_List_WarBoardMessageEntity___ctor__);
    ...
    if ( *(_DWORD *)(v35 + 16) == stageId && *(_DWORD *)(v35 + 20) == type )
    {
      ...
      if ( v40 )
      {
        ...
        else
        {
          ...
          sub_1B76164((ServantStatusBattleListViewItem_o *)(v47 + 4), (int32_t)v38, v42, v43);
        }
      }
    }
  }
...
LABEL_34:
  ...
  v52 = System_Linq_Enumerable__Any_object_(
          ...
          (const MethodInfo_2E6FDDC *)Method_System_Linq_Enumerable_Any_WarBoardMessageEntity___);
  if ( v52 )
  {
  ...
  {
    v57 = (System_Collections_Generic_List_object__o *)sub_1B7640C(System_Collections_Generic_List_WarBoardTaskBase__TypeInfo);
    System_Collections_Generic_List_object____ctor(
      v57,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EEF9 & 1) == 0 )
  {
    sub_1B761C0(&Method_System_Collections_Generic_List_WarBoardTaskBase__Add__, result);
    sub_1B761C0(&Method_System_Collections_Generic_List_WarBoardTaskBase___ctor__, v4);
    sub_1B761C0(&System_Collections_Generic_List_WarBoardTaskBase__TypeInfo, v5);
    sub_1B761C0(&WarBoardFaceMessagePerformance_TypeInfo, v6);
    byte_4A2EEF9 = 1;
  }
  v7 = (System_Collections_Generic_List_object__o *)sub_1B7640C(System_Collections_Generic_List_WarBoardTaskBase__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v7,
    (const MethodInfo_34D6DA0 *)Method_System_Collections_Generic_List_WarBoardTaskBase___ctor__);
  if ( !result )
  ...
  if ( (int)v11 >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      v16 = (WarBoardFaceMessagePerformance_o *)sub_1B7640C(WarBoardFaceMessagePerformance_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EEF8 & 1) == 0 )
  {
    sub_1B761C0(&Method_System_Linq_Enumerable_Any_WarBoardMessageEntity___, entities);
    sub_1B761C0(&Method_System_Linq_Enumerable_Select_WarBoardMessageEntity__int___, v4);
    sub_1B761C0(&Method_System_Linq_Enumerable_ToArray_int___, v5);
    sub_1B761C0(&System_Func_WarBoardMessageEntity__int__TypeInfo, v6);
    sub_1B761C0(&Method_System_Collections_Generic_List_WarBoardMessageEntity__get_Item__, v7);
    sub_1B761C0(&Method_WarBoardMessageMaster___c__Lottery_b__4_0__, v8);
    sub_1B761C0(&WarBoardMessageMaster___c_TypeInfo, v9);
    byte_4A2EEF8 = 1;
  }
  ...
  if ( !_9__4_0 )
  {
    ...
    _9__4_0 = (System_Func_object__int__o *)sub_1B7640C(System_Func_WarBoardMessageEntity__int__TypeInfo);
  ...
  v16 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_object__int_(
                                                               ...
                                                               (const MethodInfo_2E92630 *)Method_System_Linq_Enumerable_Select_WarBoardMessageEntity__int___);
  ...
  if ( !entities )
    sub_1B7641C(RandomRangeIndex, v19);
  return (WarBoardMessageEntity_o *)System_Collections_Generic_List_object___get_Item(
                                      ...
                                      RandomRangeIndex,
                                      (const MethodInfo_34D7304 *)Method_System_Collections_Generic_List_WarBoardMessageEntity__get_Item__);
}
...
void __fastcall WarBoardMessageMaster___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A2EEFA & 1) == 0 )
  {
    sub_1B761C0(&WarBoardMessageMaster___c_TypeInfo, v1);
    byte_4A2EEFA = 1;
  }
  v2 = (Il2CppObject *)sub_1B7640C(WarBoardMessageMaster___c_TypeInfo);
