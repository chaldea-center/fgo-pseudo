        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3DF5 & 1) == 0 )
  {
    self = (UnityEngine_GameObject_o *)sub_1B00CCC(&SceneList_TypeInfo, *(_QWORD *)&sceneType);
    byte_48E3DF5 = 1;
  }
  if ( !v4 )
    sub_1B00F28(self, *(_QWORD *)&sceneType);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3DF4 & 1) == 0 )
  {
    sub_1B00CCC(&Method_UnityEngine_Component_GetComponent_UIWidget___, *(_QWORD *)&depth);
    ...
    self = (UnityEngine_GameObject_o *)sub_1B00CCC(&UnityEngine_Transform_TypeInfo, v10);
    byte_48E3DF4 = 1;
  }
  if ( !v6 || (self = (UnityEngine_GameObject_o *)UnityEngine_GameObject__get_transform(v6, 0LL)) == 0LL )
    sub_1B00F28(self, *(_QWORD *)&depth);
