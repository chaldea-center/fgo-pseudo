Il2CppObject *__fastcall GameObjectHelper__GetOrAddComponent_object_(
        ...
        const MethodInfo_3024654 *method)
{
  _BOOL8 v4; // x0
  __int64 v5; // x1
  ...
  if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)Component_object, 0LL, 0LL) )
    ...
    return UnityEngine_GameObject__AddComponent_object_(
             self,
             (const MethodInfo_3022A24 *)method->rgctx_data->_2_UnityEngine_GameObject_AddComponent_T_);
}
...
Il2CppObject *__fastcall GameObjectHelper__Instantiate_object_(
        ...
        const MethodInfo_3024730 *method)
{
  __int64 v8; // x1
  ...
  if ( !method->rgctx_data )
  {
    sub_1C2E12C(&Method_UnityEngine_Object_Instantiate_GameObject____77847112, parent);
  ...
  if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)self, 0LL, 0LL) )
  {
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    v10 = UnityEngine_Object__Instantiate_object__50692144(
            (Il2CppObject *)self,
            parent,
            worldPositionStays,
    ...
    if ( !v11 )
    {
      ...
      if ( UnityEngine_Object__op_Equality((UnityEngine_Object_o *)Component_object, 0LL, 0LL) )
      {
        if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
        UnityEngine_Object__Destroy_70989720((UnityEngine_Object_o *)v10, 0LL);
        return 0LL;
      }
    }
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFEFC8 & 1) == 0 )
  {
    self = (UnityEngine_GameObject_o *)sub_1C2E12C(&SceneList_TypeInfo, *(_QWORD *)&sceneType);
    byte_4BFEFC8 = 1;
  }
  if ( !v4 )
    sub_1C2E388(self, *(_QWORD *)&sceneType);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFEFC7 & 1) == 0 )
  {
    sub_1C2E12C(&Method_UnityEngine_Component_GetComponent_UIWidget___, *(_QWORD *)&depth);
    ...
    self = (UnityEngine_GameObject_o *)sub_1C2E12C(&UnityEngine_Transform_TypeInfo, v10);
    byte_4BFEFC7 = 1;
  }
  if ( !v6 || (self = (UnityEngine_GameObject_o *)UnityEngine_GameObject__get_transform(v6, 0LL)) == 0LL )
    sub_1C2E388(self, *(_QWORD *)&depth);
