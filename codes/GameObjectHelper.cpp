        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A001B7 & 1) == 0 )
  {
    self = (UnityEngine_GameObject_o *)sub_1B64A00(&SceneList_TypeInfo, *(_QWORD *)&sceneType);
    byte_4A001B7 = 1;
  }
  if ( !v4 )
    sub_1B64C5C(self, *(_QWORD *)&sceneType);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A001B6 & 1) == 0 )
  {
    sub_1B64A00(&Method_UnityEngine_Component_GetComponent_UIWidget___, *(_QWORD *)&depth);
    ...
    self = (UnityEngine_GameObject_o *)sub_1B64A00(&UnityEngine_Transform_TypeInfo, v10);
    byte_4A001B6 = 1;
  }
  if ( !v6 || (self = (UnityEngine_GameObject_o *)UnityEngine_GameObject__get_transform(v6, 0LL)) == 0LL )
    sub_1B64C5C(self, *(_QWORD *)&depth);
