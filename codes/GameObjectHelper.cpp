        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A21244 & 1) == 0 )
  {
    self = (UnityEngine_GameObject_o *)sub_1B715CC(&SceneList_TypeInfo, *(_QWORD *)&sceneType);
    byte_4A21244 = 1;
  }
  if ( !v4 )
    sub_1B71828(self, *(_QWORD *)&sceneType);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A21243 & 1) == 0 )
  {
    sub_1B715CC(&Method_UnityEngine_Component_GetComponent_UIWidget___, *(_QWORD *)&depth);
    ...
    self = (UnityEngine_GameObject_o *)sub_1B715CC(&UnityEngine_Transform_TypeInfo, v10);
    byte_4A21243 = 1;
  }
  if ( !v6 || (self = (UnityEngine_GameObject_o *)UnityEngine_GameObject__get_transform(v6, 0LL)) == 0LL )
    sub_1B71828(self, *(_QWORD *)&depth);
