Il2CppObject *GameObjectHelper__GetOrAddComponent_object_(
        ...
        const MethodInfo_31FDBCC *method)
{
  _BOOL8 v4; // x0
  __int64 v5; // x1
  ...
  if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)Component_object, 0, 0) )
    ...
    return UnityEngine_GameObject__AddComponent_object_(
             self,
             (const MethodInfo_31FBF9C *)method->rgctx_data->_2_UnityEngine_GameObject_AddComponent_T_);
}
...
Il2CppObject *GameObjectHelper__Instantiate_object_(
        ...
        const MethodInfo_31FDCA8 *method)
{
  ...
  if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)self, 0, 0) )
  {
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    v9 = UnityEngine_Object__Instantiate_object__52629512(
           (Il2CppObject *)self,
           parent,
           worldPositionStays,
...
bool GameObjectHelper__IsInScene(UnityEngine_GameObject_o *self, int32_t sceneType, const MethodInfo *method)
{
  ...
  if ( (byte_4D323BD & 1) == 0 )
  {
    self = (UnityEngine_GameObject_o *)sub_1C93AD4(&SceneList_TypeInfo);
    byte_4D323BD = 1;
  }
  if ( !v4 )
    sub_1C93D2C(self, *(_QWORD *)&sceneType);
...
void GameObjectHelper__addNguiDepth(UnityEngine_GameObject_o *self, int32_t depth, bool flg, const MethodInfo *method)
{
  ...
  if ( (byte_4D323BC & 1) == 0 )
  {
    ...
    sub_1C93AD4(&UnityEngine_Object_TypeInfo);
    self = (UnityEngine_GameObject_o *)sub_1C93AD4(&UnityEngine_Transform_TypeInfo);
    byte_4D323BC = 1;
  }
  if ( !v6 || (self = (UnityEngine_GameObject_o *)UnityEngine_GameObject__get_transform(v6, 0)) == 0 )
    sub_1C93D2C(self, *(_QWORD *)&depth);
