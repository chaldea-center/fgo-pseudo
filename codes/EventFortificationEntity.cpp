        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B44A1F & 1) == 0 )
  {
    sub_1BDB878(&Method_BasicHelper_Any_SetSvtInfo___, method);
    sub_1BDB878(&Method_DataManager_GetMaster_EventFortificationDetailMaster___, v3);
    sub_1BDB878(&Method_DataManager_GetMaster_UserEventFortificationMaster___, v4);
    sub_1BDB878(&DataManager_TypeInfo, v5);
    sub_1BDB878(&System_Func_SetSvtInfo__bool__TypeInfo, v6);
    sub_1BDB878(&NetworkManager_TypeInfo, v7);
    sub_1BDB878(&Method_EventFortificationEntity___c__IsOpenFortificationWarningDialog_b__14_0__, v8);
    sub_1BDB878(&EventFortificationEntity___c_TypeInfo, v9);
    byte_4B44A1F = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  entity = 0LL;
  Master_object = DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_UserEventFortificationMaster___);
  ...
  UserEventFortificationMaster__TryGetEntity(
    ...
    this->fields.idx,
    0LL);
  EntitiesByOpend = (EventFortificationDetailMaster_o *)DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_EventFortificationDetailMaster___);
  if ( !EntitiesByOpend )
    goto LABEL_26;
  ...
  if ( !EntitiesByOpend )
LABEL_26:
    sub_1BDBAD4(EntitiesByOpend, v10);
  ...
  if ( !_9__14_0 )
  {
    ...
    _9__14_0 = (System_Func_object__bool__o *)sub_1BDBAC4(System_Func_SetSvtInfo__bool__TypeInfo);
    ...
    sub_1BDB81C((CGThumbnailListItem_o *)&static_fields->__9__14_0, (int32_t)_9__14_0, v21, v22);
  }
  return BasicHelper__Any_object__50450088(
           setSvtInfos,
           (System_Func_T__bool__o *)_9__14_0,
           (const MethodInfo_301CEA8 *)Method_BasicHelper_Any_SetSvtInfo___);
}
...
void __fastcall EventFortificationEntity___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B44A21 & 1) == 0 )
  {
    sub_1BDB878(&EventFortificationEntity___c_TypeInfo, v1);
    byte_4B44A21 = 1;
  }
  v2 = (Il2CppObject *)sub_1BDBAC4(EventFortificationEntity___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  EventFortificationEntity___c_TypeInfo->static_fields->__9 = (struct EventFortificationEntity___c_o *)v2;
  sub_1BDB81C((CGThumbnailListItem_o *)EventFortificationEntity___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
