void WarQuestSelectionMaster___ctor(WarQuestSelectionMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4CEF8C0 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string___ctor__);
    byte_4CEF8C0 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    422,
    (const MethodInfo_3430A90 *)Method_DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEF8C2 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string__getEntitys__);
    sub_1C7BAE8(&Method_System_Linq_Enumerable_Distinct_int___);
    sub_1C7BAE8(&Method_System_Linq_Enumerable_Select_WarQuestSelectionEntity__int___);
    sub_1C7BAE8(&Method_System_Linq_Enumerable_ToList_int___);
    sub_1C7BAE8(&System_Func_WarQuestSelectionEntity__int__TypeInfo);
    sub_1C7BAE8(&Method_WarQuestSelectionMaster___c__GetAllRegisteredWarIds_b__2_0__);
    sub_1C7BAE8(&WarQuestSelectionMaster___c_TypeInfo);
    byte_4CEF8C2 = 1;
  }
  result = (System_Collections_Generic_List_int__o *)DataMasterBase_object__object__object___getEntitys(
                                                       (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                                       (const MethodInfo_3432038 *)Method_DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string__getEntitys__);
  if ( result )
  {
    v4 = result;
    ...
    if ( !_9__2_0 )
    {
      ...
      _9__2_0 = (System_Func_object__int__o *)sub_1C7BD34(System_Func_WarQuestSelectionEntity__int__TypeInfo);
    ...
    v15 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_object__int_(
                                                                 ...
                                                                 (const MethodInfo_31A5664 *)Method_System_Linq_Enumerable_Select_WarQuestSelectionEntity__int___);
  ...
  while ( 1 )
  {
    ...
    if ( Entity )
    {
      ...
      if ( ((unsigned __int8)Entity & 1) != 0 )
      {
        ...
        if ( !Instance )
          sub_1C7BD40(0, v16);
        Entity = (Il2CppObject *)QuestTree__IsActiveEventWar_37063740((QuestTree_o *)Instance, v14, 0);
        if ( ((unsigned __int8)Entity & 1) == 0 )
          continue;
      }
    }
    if ( !v5 )
      sub_1C7BD40(Entity, v12);
...
bool WarQuestSelectionMaster__HasWar(WarQuestSelectionMaster_o *this, int32_t warId, const MethodInfo *method)
{
  ...
  if ( (byte_4CEF8C4 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_System_Collections_ObjectModel_Collection_WarQuestSelectionEntity__get_Count__);
    sub_1C7BAE8(&Method_System_Collections_ObjectModel_Collection_WarQuestSelectionEntity__get_Item__);
    byte_4CEF8C4 = 1;
  }
  ...
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            list,
            (const MethodInfo_33C6990 *)Method_System_Collections_ObjectModel_Collection_WarQuestSelectionEntity__get_Count__);
  if ( Count >= 1 )
  {
    v7 = Count;
    v8 = 0;
    ...
    while ( 1 )
    {
      ...
      Item = System_Collections_ObjectModel_Collection_object___get_Item(
               list,
               v8,
               (const MethodInfo_33C6A20 *)Method_System_Collections_ObjectModel_Collection_WarQuestSelectionEntity__get_Item__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEF8C1 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string__TryGetEntity__);
    byte_4CEF8C1 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_3432E00 *)Method_DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string__TryGetEntity__);
}
...
void WarQuestSelectionMaster___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C7BD34(WarQuestSelectionMaster___c_TypeInfo);
