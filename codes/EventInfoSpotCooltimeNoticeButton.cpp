        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC9147 & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_12425/*"SPOT_COOLTIME_NOTICE_BUTTON_TITLE_"*/, method);
    byte_4BC9147 = 1;
  }
  v9 = StringLiteral_12425/*"SPOT_COOLTIME_NOTICE_BUTTON_TITLE_"*/;
  this->fields.SPOT_COOLTIME_NOTICE_BUTTON_TITLE = (struct System_String_o *)StringLiteral_12425/*"SPOT_COOLTIME_NOTICE_BUTTON_TITLE_"*/;
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.SPOT_COOLTIME_NOTICE_BUTTON_TITLE, v9, v2, v3, v4, v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  v15 = System_String__Concat_63040368(SPOT_COOLTIME_NOTICE_BUTTON_TITLE, v14, 0LL);
  ...
  if ( LocalizationManager__ContainsKey(v15, 0LL) )
  {
    ...
    UILabel__SetCondensedScale((UILabel_o *)v17, this->fields.buttonTextMaxWidth, 0, 0LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC9145 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_EventInfoSpotCooltimeNoticeButton_OnClickButton__, method);
    byte_4BC9145 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_EventInfoSpotCooltimeNoticeButton_OnClickButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1C1ABEC(Method_EventInfoSpotCooltimeNoticeButton_OnClickButton__);
