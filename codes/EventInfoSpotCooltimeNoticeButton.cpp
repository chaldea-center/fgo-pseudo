void EventInfoSpotCooltimeNoticeButton___ctor(EventInfoSpotCooltimeNoticeButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB810A & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_12280/*"SPOT_COOLTIME_NOTICE_BUTTON_TITLE_"*/);
    byte_4CB810A = 1;
  }
  v5 = StringLiteral_12280/*"SPOT_COOLTIME_NOTICE_BUTTON_TITLE_"*/;
  this->fields.SPOT_COOLTIME_NOTICE_BUTTON_TITLE = (struct System_String_o *)StringLiteral_12280/*"SPOT_COOLTIME_NOTICE_BUTTON_TITLE_"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.SPOT_COOLTIME_NOTICE_BUTTON_TITLE, v5, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  v13 = System_String__Concat_63966792(SPOT_COOLTIME_NOTICE_BUTTON_TITLE, v12, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB8108 & 1) == 0 )
  {
    sub_1C6BA08(&Method_EventInfoSpotCooltimeNoticeButton_OnClickButton__);
    byte_4CB8108 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_EventInfoSpotCooltimeNoticeButton_OnClickButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1C6BA20(Method_EventInfoSpotCooltimeNoticeButton_OnClickButton__);
