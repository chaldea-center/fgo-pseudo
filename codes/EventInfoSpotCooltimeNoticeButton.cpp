        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F65F & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_12193/*"SPOT_COOLTIME_NOTICE_BUTTON_TITLE_"*/, method);
    byte_4A2F65F = 1;
  }
  v5 = StringLiteral_12193/*"SPOT_COOLTIME_NOTICE_BUTTON_TITLE_"*/;
  this->fields.SPOT_COOLTIME_NOTICE_BUTTON_TITLE = (struct System_String_o *)StringLiteral_12193/*"SPOT_COOLTIME_NOTICE_BUTTON_TITLE_"*/;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.SPOT_COOLTIME_NOTICE_BUTTON_TITLE, v5, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  v15 = System_String__Concat_61535060(SPOT_COOLTIME_NOTICE_BUTTON_TITLE, v14, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F65D & 1) == 0 )
  {
    sub_1B761C0(&Method_EventInfoSpotCooltimeNoticeButton_OnClickButton__, method);
    byte_4A2F65D = 1;
  }
  ...
  if ( (*((_BYTE *)Method_EventInfoSpotCooltimeNoticeButton_OnClickButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1B761D8(Method_EventInfoSpotCooltimeNoticeButton_OnClickButton__);
