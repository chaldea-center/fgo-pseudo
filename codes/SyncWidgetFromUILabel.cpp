        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20F6F & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_SyncWidgetFromUILabel__ConvertTypeToAction_b__3_0__, v5);
    sub_1B715CC(&Method_SyncWidgetFromUILabel__ConvertTypeToAction_b__3_1__, v6);
    byte_4A20F6F = 1;
  }
  if ( type == 5 )
  {
...
void __fastcall SyncWidgetFromUILabel__InitSync(SyncWidgetFromUILabel_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A20F6D & 1) == 0 )
  {
    sub_1B715CC(&UILabel_TypeInfo, method);
    byte_4A20F6D = 1;
  }
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)p_syncFromLabel, v9, v2, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B71828(syncFromLabel, method);
  }
