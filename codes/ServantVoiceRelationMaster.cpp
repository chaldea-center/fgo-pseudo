void __fastcall ServantVoiceRelationMaster___ctor(ServantVoiceRelationMaster_o *this, const MethodInfo *method)
{
  if ( (byte_49FED82 & 1) == 0 )
  {
    sub_1B64870(&Method_DataMasterBase_ServantVoiceRelationMaster__ServantVoiceRelationEntity__string___ctor__, method);
    byte_49FED82 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    177,
    (const MethodInfo_30D6498 *)Method_DataMasterBase_ServantVoiceRelationMaster__ServantVoiceRelationEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (ServantVoiceRelationEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                           (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                           PK,
                                           (const MethodInfo_30D64D8 *)Method_DataMasterBase_ServantVoiceRelationMaster__ServantVoiceRelationEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FED86 & 1) == 0 )
  {
    ...
    sub_1B64870(&ServantVoiceRelationEntity_TypeInfo, v11);
    byte_49FED86 = 1;
  }
...
LABEL_28:
    sub_1B64ACC(list, *(_QWORD *)&relationSvtId);
  }
LABEL_21:
  if ( !v14 )
    goto LABEL_28;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FED83 & 1) == 0 )
  {
    sub_1B64870(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__, relationList);
    sub_1B64870(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Item__, v6);
    sub_1B64870(&System_Comparison_ServantVoiceRelationEntity__TypeInfo, v7);
    sub_1B64870(&Method_System_Collections_Generic_List_ServantVoiceRelationEntity__Add__, v8);
    sub_1B64870(&Method_System_Collections_Generic_List_ServantVoiceRelationEntity__Sort__, v9);
    sub_1B64870(&Method_System_Collections_Generic_List_ServantVoiceRelationEntity__ToArray__, v10);
    sub_1B64870(&Method_System_Collections_Generic_List_ServantVoiceRelationEntity___ctor__, v11);
    sub_1B64870(&System_Collections_Generic_List_ServantVoiceRelationEntity__TypeInfo, v12);
    sub_1B64870(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, v13);
    sub_1B64870(&ServantVoiceRelationEntity_TypeInfo, v14);
    sub_1B64870(&Method_ServantVoiceRelationMaster___c__GetRelationList_b__3_0__, v15);
    sub_1B64870(&ServantVoiceRelationMaster___c_TypeInfo, v16);
    byte_49FED83 = 1;
  }
  ...
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            ...
            (const MethodInfo_3072DE4 *)Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__);
  v19 = (System_Collections_Generic_List_object__o *)sub_1B64ABC(System_Collections_Generic_List_ServantVoiceRelationEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v19,
    (const MethodInfo_34AF17C *)Method_System_Collections_Generic_List_ServantVoiceRelationEntity___ctor__);
  if ( Count >= 1 )
  {
    v20 = 0;
    while ( 1 )
      ...
      if ( Item )
      {
          ...
          && (ServantVoiceRelationEntity_c *)Item->klass->_2.typeHierarchy[methodPtr_low - 1] == ServantVoiceRelationEntity_TypeInfo )
        {
          ...
          *(_QWORD *)&v41.fields.fakeValue = monitor;
          list = (void *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46180532(v41, 0LL);
...
LABEL_19:
  ...
  if ( !v32 )
  {
    ...
    v32 = (System_Comparison_T__o *)sub_1B64ABC(System_Comparison_ServantVoiceRelationEntity__TypeInfo);
    ...
    sub_1B64814((ServantStatusBattleListViewItem_o *)&static_fields->__9__3_0, (int32_t)v32, v35, v36);
  }
  if ( !v19 )
    goto LABEL_27;
  System_Collections_Generic_List_object___Sort_55252244(
    v19,
    v32,
    (const MethodInfo_34B1514 *)Method_System_Collections_Generic_List_ServantVoiceRelationEntity__Sort__);
  v37 = System_Collections_Generic_List_object___ToArray(
          v19,
          (const MethodInfo_34B15A8 *)Method_System_Collections_Generic_List_ServantVoiceRelationEntity__ToArray__);
  *relationList = (ServantVoiceRelationEntity_array *)v37;
  sub_1B64814((ServantStatusBattleListViewItem_o *)relationList, (int32_t)v37, v38, v39);
}


void __fastcall ServantVoiceRelationMaster__GetRelationList_39469600(
        ServantVoiceRelationMaster_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FED84 & 1) == 0 )
  {
    sub_1B64870(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__, beforeRelationList);
    sub_1B64870(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Item__, v7);
    sub_1B64870(&System_Comparison_ServantVoiceRelationEntity__TypeInfo, v8);
    sub_1B64870(&Method_System_Collections_Generic_List_ServantVoiceRelationEntity__Add__, v9);
    sub_1B64870(&Method_System_Collections_Generic_List_ServantVoiceRelationEntity__Sort__, v10);
    sub_1B64870(&Method_System_Collections_Generic_List_ServantVoiceRelationEntity__ToArray__, v11);
    sub_1B64870(&Method_System_Collections_Generic_List_ServantVoiceRelationEntity___ctor__, v12);
    sub_1B64870(&System_Collections_Generic_List_ServantVoiceRelationEntity__TypeInfo, v13);
    sub_1B64870(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, v14);
    sub_1B64870(&ServantVoiceRelationEntity_TypeInfo, v15);
    sub_1B64870(&Method_ServantVoiceRelationMaster___c__GetRelationList_b__4_0__, v16);
    sub_1B64870(&Method_ServantVoiceRelationMaster___c__GetRelationList_b__4_1__, v17);
    sub_1B64870(&ServantVoiceRelationMaster___c_TypeInfo, v18);
    byte_49FED84 = 1;
  }
  list = this->fields.list;
  if ( !list )
  ...
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            (System_Collections_ObjectModel_Collection_T__o *)list,
            (const MethodInfo_3072DE4 *)Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__);
  v21 = (System_Collections_Generic_List_object__o *)sub_1B64ABC(System_Collections_Generic_List_ServantVoiceRelationEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v21,
    (const MethodInfo_34AF17C *)Method_System_Collections_Generic_List_ServantVoiceRelationEntity___ctor__);
  v22 = (System_Collections_Generic_List_object__o *)sub_1B64ABC(System_Collections_Generic_List_ServantVoiceRelationEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v22,
    (const MethodInfo_34AF17C *)Method_System_Collections_Generic_List_ServantVoiceRelationEntity___ctor__);
  v23 = (System_Collections_Generic_List_object__o *)sub_1B64ABC(System_Collections_Generic_List_ServantVoiceRelationEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v23,
    (const MethodInfo_34AF17C *)Method_System_Collections_Generic_List_ServantVoiceRelationEntity___ctor__);
  if ( Count >= 1 )
      ...
      if ( Item )
      {
          ...
          && (ServantVoiceRelationEntity_c *)Item->klass->_2.typeHierarchy[methodPtr_low - 1] == ServantVoiceRelationEntity_TypeInfo )
        {
          ...
          *(_QWORD *)&v68.fields.fakeValue = monitor;
          list = (void *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46180532(v68, 0LL);
          if ( (_DWORD)list == svtId )
          {
            v32 = (int)v26[3].klass;
            if ( (v32 & 0x80000000) != 0 )
...
LABEL_31:
            ...
            sub_1B64814((ServantStatusBattleListViewItem_o *)(v36 + 4), (int32_t)v26, v30, v31);
          }
        }
      }
    }
  ...
  if ( !v45 )
  {
    ...
    v45 = (System_Comparison_T__o *)sub_1B64ABC(System_Comparison_ServantVoiceRelationEntity__TypeInfo);
    ...
    sub_1B64814((ServantStatusBattleListViewItem_o *)&static_fields->__9__4_0, (int32_t)v45, v48, v49);
  }
  if ( !v21 )
    goto LABEL_49;
  System_Collections_Generic_List_object___Sort_55252244(
  ...
  *beforeRelationList = (ServantVoiceRelationEntity_array *)v50;
  sub_1B64814((ServantStatusBattleListViewItem_o *)beforeRelationList, (int32_t)v50, v51, v52);
  if ( !v22 )
    goto LABEL_49;
  ...
  *sameRelationList = (ServantVoiceRelationEntity_array *)v53;
  sub_1B64814((ServantStatusBattleListViewItem_o *)sameRelationList, (int32_t)v53, v54, v55);
  list = ServantVoiceRelationMaster___c_TypeInfo;
  if ( !ServantVoiceRelationMaster___c_TypeInfo->_2.cctor_finished )
  {
    j_il2cpp_runtime_class_init_0(ServantVoiceRelationMaster___c_TypeInfo);
  ...
  if ( !v56 )
  {
    ...
    v56 = (System_Comparison_T__o *)sub_1B64ABC(System_Comparison_ServantVoiceRelationEntity__TypeInfo);
    ...
    sub_1B64814((ServantStatusBattleListViewItem_o *)&v58->__9__4_1, (int32_t)v56, v59, v60);
  }
  if ( !v23 )
LABEL_49:
    sub_1B64ACC(list, beforeRelationList);
  System_Collections_Generic_List_object___Sort_55252244(
    v23,
    v56,
    (const MethodInfo_34B1514 *)Method_System_Collections_Generic_List_ServantVoiceRelationEntity__Sort__);
  ...
  *afterRelationList = (ServantVoiceRelationEntity_array *)v61;
  sub_1B64814((ServantStatusBattleListViewItem_o *)afterRelationList, (int32_t)v61, v62, v63);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FED85 & 1) == 0 )
  {
    ...
    sub_1B64870(&ServantVoiceRelationEntity_TypeInfo, v9);
    byte_49FED85 = 1;
  }
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
        ...
        const MethodInfo *method)
{
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_30D6528 *)Method_DataMasterBase_ServantVoiceRelationMaster__ServantVoiceRelationEntity__string__TryGetEntity__);
}
...
void __fastcall ServantVoiceRelationMaster___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FED87 & 1) == 0 )
  {
    sub_1B64870(&ServantVoiceRelationMaster___c_TypeInfo, v1);
    byte_49FED87 = 1;
  }
  v2 = (Il2CppObject *)sub_1B64ABC(ServantVoiceRelationMaster___c_TypeInfo);
