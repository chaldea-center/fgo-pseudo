...
System_Collections_IEnumerator_o *WarBoardCallbackTask__Execute(WarBoardCallbackTask_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2E615 & 1) == 0 )
  {
    sub_1C93AD4(&WarBoardCallbackTask__Execute_d__2_TypeInfo);
    byte_4D2E615 = 1;
  }
  v3 = sub_1C93D20(WarBoardCallbackTask__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C93AE8(&Method_WarBoardCallbackTask__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1C93BFC(v3, v4);
}
