        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A590D5 & 1) == 0 )
  {
    sub_1B885B0(&WarBoardCallbackTask__Execute_d__2_TypeInfo);
    byte_4A590D5 = 1;
  }
  v3 = sub_1B887FC(WarBoardCallbackTask__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B885C4(&Method_WarBoardCallbackTask__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1B886D8(v3, v4);
}
