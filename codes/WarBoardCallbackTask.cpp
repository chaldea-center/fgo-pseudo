        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B34FF6 & 1) == 0 )
  {
    sub_1BD3458(&WarBoardCallbackTask__Execute_d__2_TypeInfo, method);
    byte_4B34FF6 = 1;
  }
  v3 = sub_1BD36A4(WarBoardCallbackTask__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BD346C(&Method_WarBoardCallbackTask__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1BD3580(v3, v4);
}
