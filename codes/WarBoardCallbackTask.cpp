        ...
        const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.waitYieldInstruction, (int32_t)waitYieldInstruction, v5, v6);
}
...
System_Collections_IEnumerator_o *WarBoardCallbackTask__Execute(WarBoardCallbackTask_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C40C25 & 1) == 0 )
  {
    sub_1C37058(&WarBoardCallbackTask__Execute_d__2_TypeInfo);
    byte_4C40C25 = 1;
  }
  v3 = sub_1C372A4(WarBoardCallbackTask__Execute_d__2_TypeInfo);
...
bool WarBoardCallbackTask__Execute_d__2__MoveNext(WarBoardCallbackTask__Execute_d__2_o *this, const MethodInfo *method)
{
  ...
  else
  {
    ...
    else
    {
      ...
      sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.__2__current, (int32_t)waitYieldInstruction, v2, v3);
      result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C3706C(&Method_WarBoardCallbackTask__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1C37180(v3, v4);
}
