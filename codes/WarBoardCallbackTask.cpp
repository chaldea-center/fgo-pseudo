        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC58C3 & 1) == 0 )
  {
    sub_1C1ABD4(&WarBoardCallbackTask__Execute_d__2_TypeInfo, method);
    byte_4BC58C3 = 1;
  }
  v3 = sub_1C1AE20(WarBoardCallbackTask__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C1ABE8(&Method_WarBoardCallbackTask__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1C1ACFC(v3, v4);
}
