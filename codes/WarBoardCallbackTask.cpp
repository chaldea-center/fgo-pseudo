        ...
        const MethodInfo *method)
{
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.waitYieldInstruction, (int32_t)waitYieldInstruction, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFFD32 & 1) == 0 )
  {
    sub_1BC3008(&WarBoardCallbackTask__Execute_d__2_TypeInfo, method);
    byte_4AFFD32 = 1;
  }
  v3 = sub_1BC3254(WarBoardCallbackTask__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    else
    {
      ...
      sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.__2__current, (int32_t)waitYieldInstruction, v2, v3);
      result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BC301C(&Method_WarBoardCallbackTask__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1BC3130(v3, v4);
}
