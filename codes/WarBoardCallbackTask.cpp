...
System_Collections_IEnumerator_o *WarBoardCallbackTask__Execute(WarBoardCallbackTask_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E02637 & 1) == 0 )
  {
    sub_1CE6700(&WarBoardCallbackTask__Execute_d__2_TypeInfo);
    byte_4E02637 = 1;
  }
  v3 = sub_1CE694C(WarBoardCallbackTask__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1CE6714(&Method_WarBoardCallbackTask__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1CE6828(v3, v4);
}
