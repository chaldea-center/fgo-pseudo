        ...
        const MethodInfo *method)
{
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.waitYieldInstruction, (int32_t)waitYieldInstruction, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B8C54 & 1) == 0 )
  {
    sub_1B4CF90(&WarBoardCallbackTask__Execute_d__2_TypeInfo, method);
    byte_49B8C54 = 1;
  }
  v3 = sub_1B4D1DC(WarBoardCallbackTask__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    else
    {
      ...
      sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.__2__current, (int32_t)waitYieldInstruction, v2, v3);
      result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B4CFA4(&Method_WarBoardCallbackTask__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1B4D0B8(v3, v4);
}
