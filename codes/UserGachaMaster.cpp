void __fastcall UserGachaMaster___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49BBC55 & 1) == 0 )
  {
    sub_1B4CF90(&UserGachaMaster_TypeInfo, v1);
    byte_49BBC55 = 1;
  }
...
void __fastcall UserGachaMaster___ctor(UserGachaMaster_o *this, const MethodInfo *method)
{
  if ( (byte_49BBC52 & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataMasterBase_UserGachaMaster__UserGachaEntity__string___ctor__, method);
    byte_49BBC52 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    34,
    (const MethodInfo_31A0130 *)Method_DataMasterBase_UserGachaMaster__UserGachaEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BBC54 & 1) == 0 )
  {
    sub_1B4CF90(&BalanceConfig_TypeInfo, remainNum);
    sub_1B4CF90(&Method_DataManager_GetMasterData_EventCampaignMaster___, v7);
    sub_1B4CF90(&Method_DataManager_GetMasterData_UserFriendPointGachaFreeDrawCampaignLogMaster___, v8);
    sub_1B4CF90(&Method_DataManager_GetMasterData_UserGachaMaster___, v9);
    sub_1B4CF90(&Method_DataManager_GetMaster_GachaMaster___, v10);
    sub_1B4CF90(&DataManager_TypeInfo, v11);
    sub_1B4CF90(&Method_DataMasterBase_GachaMaster__GachaEntity__int__TryGetEntity__, v12);
    sub_1B4CF90(&System_DateTime_TypeInfo, v13);
    ...
    sub_1B4CF90(&Method_System_Collections_Generic_List_EventCampaignEntity__get_Count__, v18);
    sub_1B4CF90(&NetworkManager_TypeInfo, v19);
    sub_1B4CF90(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v20);
    sub_1B4CF90(&System_TimeSpan_TypeInfo, v21);
    sub_1B4CF90(&UserGachaMaster_TypeInfo, v22);
    byte_49BBC54 = 1;
  }
  entity = 0LL;
  dateData = 0LL;
  ...
  *maxNum = 1;
  ...
  if ( (Master_object & 1) != 0 )
  {
    ...
    if ( !NetworkManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
    dateData = NetworkManager__getServerDateTime_39105304(freeDrawAt + v32, 0LL).fields._dateData;
    v51 = NetworkManager__getServerDateTime_39105304(v29 + v32, 0LL).fields._dateData;
    ...
    ticks = System_DateTime__op_Subtraction_62500356(v57, v61, 0LL).fields._ticks;
  ...
  if ( FriendPointSummonMultipleFreeCampaign && FriendPointSummonMultipleFreeCampaign->fields._size >= 1 )
  {
    ...
    if ( Master_object )
    {
      Master_object = (int64_t)DataManager__GetMasterData_object_(
                                 (DataManager_o *)Master_object,
                                 (const MethodInfo_2F01B24 *)Method_DataManager_GetMasterData_UserFriendPointGachaFreeDrawCampaignLogMaster___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BBC50 & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataMasterBase_UserGachaMaster__UserGachaEntity__string__GetEntity__, userId);
    byte_49BBC50 = 1;
  }
  ...
  return (UserGachaEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                PK,
                                (const MethodInfo_31A2454 *)Method_DataMasterBase_UserGachaMaster__UserGachaEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BBC51 & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataMasterBase_UserGachaMaster__UserGachaEntity__string__TryGetEntity__, entity);
    byte_49BBC51 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_31A24A0 *)Method_DataMasterBase_UserGachaMaster__UserGachaEntity__string__TryGetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BBC53 & 1) == 0 )
  {
    sub_1B4CF90(&Method_System_Collections_ObjectModel_Collection_UserGachaEntity__get_Count__, *(_QWORD *)&gachaId);
    sub_1B4CF90(&Method_System_Collections_ObjectModel_Collection_UserGachaEntity__get_Item__, v5);
    byte_49BBC53 = 1;
  }
  ...
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            list,
            (const MethodInfo_313AEE4 *)Method_System_Collections_ObjectModel_Collection_UserGachaEntity__get_Count__);
  if ( Count >= 1 )
  {
    v8 = Count;
    v9 = 0;
    ...
    while ( 1 )
    {
      ...
      Item = System_Collections_ObjectModel_Collection_object___get_Item(
               list,
               v9,
               (const MethodInfo_313AF74 *)Method_System_Collections_ObjectModel_Collection_UserGachaEntity__get_Item__);
...
LABEL_14:
    sub_1B4D1EC(list, *(_QWORD *)&gachaId);
  }
  return 0;
}