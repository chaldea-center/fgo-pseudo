void __fastcall UserGachaMaster___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B67926 & 1) == 0 )
  {
    sub_1BE4ACC(&UserGachaMaster_TypeInfo, v1);
    byte_4B67926 = 1;
  }
...
void __fastcall UserGachaMaster___ctor(UserGachaMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4B67923 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_DataMasterBase_UserGachaMaster__UserGachaEntity__string___ctor__, method);
    byte_4B67923 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    34,
    (const MethodInfo_31FDADC *)Method_DataMasterBase_UserGachaMaster__UserGachaEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67925 & 1) == 0 )
  {
    sub_1BE4ACC(&BalanceConfig_TypeInfo, remainNum);
    sub_1BE4ACC(&Method_DataManager_GetMasterData_EventCampaignMaster___, v7);
    sub_1BE4ACC(&Method_DataManager_GetMasterData_UserFriendPointGachaFreeDrawCampaignLogMaster___, v8);
    sub_1BE4ACC(&Method_DataManager_GetMasterData_UserGachaMaster___, v9);
    sub_1BE4ACC(&Method_DataManager_GetMaster_GachaMaster___, v10);
    sub_1BE4ACC(&DataManager_TypeInfo, v11);
    sub_1BE4ACC(&Method_DataMasterBase_GachaMaster__GachaEntity__int__TryGetEntity__, v12);
    sub_1BE4ACC(&System_DateTime_TypeInfo, v13);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Enumerator_EventCampaignEntity__Dispose__, v14);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Enumerator_EventCampaignEntity__MoveNext__, v15);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Enumerator_EventCampaignEntity__get_Current__, v16);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_EventCampaignEntity__GetEnumerator__, v17);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_EventCampaignEntity__get_Count__, v18);
    sub_1BE4ACC(&NetworkManager_TypeInfo, v19);
    sub_1BE4ACC(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v20);
    sub_1BE4ACC(&System_TimeSpan_TypeInfo, v21);
    sub_1BE4ACC(&UserGachaMaster_TypeInfo, v22);
    byte_4B67925 = 1;
  }
  entity = 0LL;
  dateData = 0LL;
  ...
  *maxNum = 1;
  ...
  Master_object = (int64_t)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Master_object )
    goto LABEL_57;
  ...
  if ( (Master_object & 1) != 0 )
  {
    ...
    if ( !NetworkManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
    dateData = NetworkManager__getServerDateTime_39466056(freeDrawAt + v32, 0LL).fields._dateData;
    v51 = NetworkManager__getServerDateTime_39466056(v29 + v32, 0LL).fields._dateData;
    ...
    ticks = System_DateTime__op_Subtraction_63392028(v57, v61, 0LL).fields._ticks;
  ...
  if ( FriendPointSummonMultipleFreeCampaign && FriendPointSummonMultipleFreeCampaign->fields._size >= 1 )
  {
    ...
    if ( Master_object )
    {
      Master_object = (int64_t)DataManager__GetMasterData_object_(
                                 (DataManager_o *)Master_object,
                                 (const MethodInfo_2F59110 *)Method_DataManager_GetMasterData_UserFriendPointGachaFreeDrawCampaignLogMaster___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67921 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_DataMasterBase_UserGachaMaster__UserGachaEntity__string__GetEntity__, userId);
    byte_4B67921 = 1;
  }
  ...
  return (UserGachaEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                PK,
                                (const MethodInfo_31FDB1C *)Method_DataMasterBase_UserGachaMaster__UserGachaEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67922 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_DataMasterBase_UserGachaMaster__UserGachaEntity__string__TryGetEntity__, entity);
    byte_4B67922 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_31FDB6C *)Method_DataMasterBase_UserGachaMaster__UserGachaEntity__string__TryGetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67924 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&UserGachaEntity_TypeInfo, v6);
    byte_4B67924 = 1;
  }
