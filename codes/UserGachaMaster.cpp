void __fastcall UserGachaMaster___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB6A7C & 1) == 0 )
  {
    sub_1BAB41C(&UserGachaMaster_TypeInfo, v1);
    byte_4AB6A7C = 1;
  }
...
void __fastcall UserGachaMaster___ctor(UserGachaMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4AB6A79 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataMasterBase_UserGachaMaster__UserGachaEntity__string___ctor__, method);
    byte_4AB6A79 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    34,
    (const MethodInfo_31640A8 *)Method_DataMasterBase_UserGachaMaster__UserGachaEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB6A7B & 1) == 0 )
  {
    sub_1BAB41C(&BalanceConfig_TypeInfo, remainNum);
    sub_1BAB41C(&Method_DataManager_GetMasterData_EventCampaignMaster___, v7);
    sub_1BAB41C(&Method_DataManager_GetMasterData_UserFriendPointGachaFreeDrawCampaignLogMaster___, v8);
    sub_1BAB41C(&Method_DataManager_GetMasterData_UserGachaMaster___, v9);
    sub_1BAB41C(&Method_DataManager_GetMaster_GachaMaster___, v10);
    sub_1BAB41C(&DataManager_TypeInfo, v11);
    sub_1BAB41C(&Method_DataMasterBase_GachaMaster__GachaEntity__int__TryGetEntity__, v12);
    sub_1BAB41C(&System_DateTime_TypeInfo, v13);
    sub_1BAB41C(&Method_System_Collections_Generic_List_Enumerator_EventCampaignEntity__Dispose__, v14);
    sub_1BAB41C(&Method_System_Collections_Generic_List_Enumerator_EventCampaignEntity__MoveNext__, v15);
    sub_1BAB41C(&Method_System_Collections_Generic_List_Enumerator_EventCampaignEntity__get_Current__, v16);
    sub_1BAB41C(&Method_System_Collections_Generic_List_EventCampaignEntity__GetEnumerator__, v17);
    sub_1BAB41C(&Method_System_Collections_Generic_List_EventCampaignEntity__get_Count__, v18);
    sub_1BAB41C(&NetworkManager_TypeInfo, v19);
    sub_1BAB41C(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v20);
    sub_1BAB41C(&System_TimeSpan_TypeInfo, v21);
    sub_1BAB41C(&UserGachaMaster_TypeInfo, v22);
    byte_4AB6A7B = 1;
  }
  entity = 0LL;
  dateData = 0LL;
  ...
  *maxNum = 1;
  ...
  if ( (Master_object & 1) != 0 )
  {
    ...
    if ( !NetworkManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
    dateData = NetworkManager__getServerDateTime_38939020(freeDrawAt + v32, 0LL).fields._dateData;
    v51 = NetworkManager__getServerDateTime_38939020(v29 + v32, 0LL).fields._dateData;
    ...
    ticks = System_DateTime__op_Subtraction_62741020(v57, v61, 0LL).fields._ticks;
  ...
  if ( FriendPointSummonMultipleFreeCampaign && FriendPointSummonMultipleFreeCampaign->fields._size >= 1 )
  {
    ...
    if ( Master_object )
    {
      Master_object = (int64_t)DataManager__GetMasterData_object_(
                                 (DataManager_o *)Master_object,
                                 (const MethodInfo_2EC55C8 *)Method_DataManager_GetMasterData_UserFriendPointGachaFreeDrawCampaignLogMaster___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB6A77 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataMasterBase_UserGachaMaster__UserGachaEntity__string__GetEntity__, userId);
    byte_4AB6A77 = 1;
  }
  ...
  return (UserGachaEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                PK,
                                (const MethodInfo_31640E8 *)Method_DataMasterBase_UserGachaMaster__UserGachaEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB6A78 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataMasterBase_UserGachaMaster__UserGachaEntity__string__TryGetEntity__, entity);
    byte_4AB6A78 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_3164138 *)Method_DataMasterBase_UserGachaMaster__UserGachaEntity__string__TryGetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB6A7A & 1) == 0 )
  {
    ...
    sub_1BAB41C(&UserGachaEntity_TypeInfo, v6);
    byte_4AB6A7A = 1;
  }
...
LABEL_16:
    sub_1BAB678(list, *(_QWORD *)&gachaId);
  }
  return 0;
}