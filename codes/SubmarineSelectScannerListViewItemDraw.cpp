        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B79C3 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_SubmarineSelectScannerListViewItemDraw___c__DisplayClass14_0__LoadEventUIAssetData_b__0__, v8);
    sub_1B4CF90(&SubmarineSelectScannerListViewItemDraw___c__DisplayClass14_0_TypeInfo, v9);
    byte_49B79C3 = 1;
  }
  v10 = sub_1B4D1DC(SubmarineSelectScannerListViewItemDraw___c__DisplayClass14_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B79C6 & 1) == 0 )
  {
    ...
    this = (SubmarineSelectScannerListViewItemDraw_o *)sub_1B4CF90(&StringLiteral_5280/*"DownloadEventUIAtlas{0}{1}"*/, v12);
    byte_49B79C6 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B79C5 & 1) == 0 )
  {
    this = (SubmarineSelectScannerListViewItemDraw_o *)sub_1B4CF90(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B79C1 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_DataManager_GetMasterData_EventPanelScanMaster___, v5);
    sub_1B4CF90(&Method_DataMasterBase_EventPanelScanMaster__EventPanelScanEntity__int__GetEntity__, v6);
    sub_1B4CF90(&LocalizationManager_TypeInfo, v7);
    sub_1B4CF90(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v8);
    sub_1B4CF90(&Method_SubmarineSelectScannerListViewItemDraw___c__DisplayClass11_0__UpdateUi_b__0__, v9);
    sub_1B4CF90(&SubmarineSelectScannerListViewItemDraw___c__DisplayClass11_0_TypeInfo, v10);
    sub_1B4CF90(&StringLiteral_5625/*"EVENT_SUBMARINE_SELECT_SCAN_METHOD_PREFIX"*/, v11);
    sub_1B4CF90(&StringLiteral_5628/*"EVENT_SUBMARINE_UNKNOWN_VALUE"*/, v12);
    byte_49B79C1 = 1;
  }
  v13 = sub_1B4D1DC(SubmarineSelectScannerListViewItemDraw___c__DisplayClass11_0_TypeInfo);
  ...
  *(_QWORD *)(v13 + 24) = item;
  ...
  v28 = (System_String_o **)((v26 & 1) != 0 ? &StringLiteral_5625/*"EVENT_SUBMARINE_SELECT_SCAN_METHOD_PREFIX"*/ : &StringLiteral_5628/*"EVENT_SUBMARINE_UNKNOWN_VALUE"*/);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B4CF90(&int_TypeInfo, method);
    sub_1B4CF90(&StringLiteral_22744/*"scan_icon_{0}"*/, v4);
    this = (SubmarineSelectScannerListViewItemDraw___c__DisplayClass11_0_o *)sub_1B4CF90(&StringLiteral_20039/*"img_list_bg02"*/, v5);
    byte_49B79CA = 1;
  }
  item = v3->fields.item;
  if ( !item
    ...
    || (this = (SubmarineSelectScannerListViewItemDraw___c__DisplayClass11_0_o *)SubmarineSelectScannerListViewItemDraw__SetSpriteByLocalAtlas(
                                                                                   ...
                                                                                   (System_String_o *)StringLiteral_20039/*"img_list_bg02"*/,
                                                                                   v7),
  ...
  v15 = System_String__Format((System_String_o *)StringLiteral_22744/*"scan_icon_{0}"*/, v14, 0LL);
