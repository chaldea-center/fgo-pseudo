        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB299C & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_SubmarineSelectScannerListViewItemDraw___c__DisplayClass14_0__LoadEventUIAssetData_b__0__, v8);
    sub_1BAB41C(&SubmarineSelectScannerListViewItemDraw___c__DisplayClass14_0_TypeInfo, v9);
    byte_4AB299C = 1;
  }
  v10 = sub_1BAB668(SubmarineSelectScannerListViewItemDraw___c__DisplayClass14_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB299F & 1) == 0 )
  {
    ...
    this = (SubmarineSelectScannerListViewItemDraw_o *)sub_1BAB41C(&StringLiteral_5381/*"DownloadEventUIAtlas{0}{1}"*/, v12);
    byte_4AB299F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB299E & 1) == 0 )
  {
    this = (SubmarineSelectScannerListViewItemDraw_o *)sub_1BAB41C(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB299A & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_DataManager_GetMasterData_EventPanelScanMaster___, v5);
    sub_1BAB41C(&Method_DataMasterBase_EventPanelScanMaster__EventPanelScanEntity__int__GetEntity__, v6);
    sub_1BAB41C(&LocalizationManager_TypeInfo, v7);
    sub_1BAB41C(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v8);
    sub_1BAB41C(&Method_SubmarineSelectScannerListViewItemDraw___c__DisplayClass11_0__UpdateUi_b__0__, v9);
    sub_1BAB41C(&SubmarineSelectScannerListViewItemDraw___c__DisplayClass11_0_TypeInfo, v10);
    sub_1BAB41C(&StringLiteral_5724/*"EVENT_SUBMARINE_SELECT_SCAN_METHOD_PREFIX"*/, v11);
    sub_1BAB41C(&StringLiteral_5727/*"EVENT_SUBMARINE_UNKNOWN_VALUE"*/, v12);
    byte_4AB299A = 1;
  }
  v13 = sub_1BAB668(SubmarineSelectScannerListViewItemDraw___c__DisplayClass11_0_TypeInfo);
  ...
  *(_QWORD *)(v13 + 24) = item;
  ...
  v28 = (System_String_o **)((v26 & 1) != 0 ? &StringLiteral_5724/*"EVENT_SUBMARINE_SELECT_SCAN_METHOD_PREFIX"*/ : &StringLiteral_5727/*"EVENT_SUBMARINE_UNKNOWN_VALUE"*/);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BAB41C(&int_TypeInfo, method);
    sub_1BAB41C(&StringLiteral_23055/*"scan_icon_{0}"*/, v4);
    this = (SubmarineSelectScannerListViewItemDraw___c__DisplayClass11_0_o *)sub_1BAB41C(&StringLiteral_20364/*"img_list_bg02"*/, v5);
    byte_4AB29A3 = 1;
  }
  item = v3->fields.item;
  if ( !item
    ...
    || (this = (SubmarineSelectScannerListViewItemDraw___c__DisplayClass11_0_o *)SubmarineSelectScannerListViewItemDraw__SetSpriteByLocalAtlas(
                                                                                   ...
                                                                                   (System_String_o *)StringLiteral_20364/*"img_list_bg02"*/,
                                                                                   v7),
  ...
  v15 = System_String__Format((System_String_o *)StringLiteral_23055/*"scan_icon_{0}"*/, v14, 0LL);
