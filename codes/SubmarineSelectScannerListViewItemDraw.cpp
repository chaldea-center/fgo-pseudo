        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEAEFD & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_SubmarineSelectScannerListViewItemDraw___c__DisplayClass14_0__LoadEventUIAssetData_b__0__);
    sub_1C7BAE8(&SubmarineSelectScannerListViewItemDraw___c__DisplayClass14_0_TypeInfo);
    byte_4CEAEFD = 1;
  }
  v7 = sub_1C7BD34(SubmarineSelectScannerListViewItemDraw___c__DisplayClass14_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEAF00 & 1) == 0 )
  {
    ...
    this = (SubmarineSelectScannerListViewItemDraw_o *)sub_1C7BAE8(&StringLiteral_5350/*"DownloadEventUIAtlas{0}{1}"*/);
    byte_4CEAF00 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEAEFF & 1) == 0 )
  {
    this = (SubmarineSelectScannerListViewItemDraw_o *)sub_1C7BAE8(&Method_System_Collections_Generic_List_UIAtlas__Clear__);
    byte_4CEAEFF = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEAEFB & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_SubmarineSelectScannerListViewItemDraw___c__DisplayClass11_0__UpdateUi_b__0__);
    sub_1C7BAE8(&SubmarineSelectScannerListViewItemDraw___c__DisplayClass11_0_TypeInfo);
    sub_1C7BAE8(&StringLiteral_5735/*"EVENT_SUBMARINE_SELECT_SCAN_METHOD_PREFIX"*/);
    sub_1C7BAE8(&StringLiteral_5738/*"EVENT_SUBMARINE_UNKNOWN_VALUE"*/);
    byte_4CEAEFB = 1;
  }
  v5 = sub_1C7BD34(SubmarineSelectScannerListViewItemDraw___c__DisplayClass11_0_TypeInfo);
  ...
  *(_QWORD *)(v5 + 24) = item;
  v14 = v5 + 24;
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)(v5 + 24), (int32_t)item, v15, v16, v17, v18, v19, v20);
  if ( !*(_QWORD *)(v5 + 24) )
    goto LABEL_20;
  ...
  v28 = (System_String_o **)((v26 & 1) != 0 ? &StringLiteral_5735/*"EVENT_SUBMARINE_SELECT_SCAN_METHOD_PREFIX"*/ : &StringLiteral_5738/*"EVENT_SUBMARINE_UNKNOWN_VALUE"*/);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C7BAE8(&int_TypeInfo);
    sub_1C7BAE8(&StringLiteral_23423/*"scan_icon_{0}"*/);
    this = (SubmarineSelectScannerListViewItemDraw___c__DisplayClass11_0_o *)sub_1C7BAE8(&StringLiteral_20595/*"img_list_bg02"*/);
    byte_4CEAF04 = 1;
  }
  item = v3->fields.item;
  if ( !item
    ...
    || (this = (SubmarineSelectScannerListViewItemDraw___c__DisplayClass11_0_o *)SubmarineSelectScannerListViewItemDraw__SetSpriteByLocalAtlas(
                                                                                   ...
                                                                                   (System_String_o *)StringLiteral_20595/*"img_list_bg02"*/,
                                                                                   v5),
  ...
  v10 = System_String__Format((System_String_o *)StringLiteral_23423/*"scan_icon_{0}"*/, v9, 0);
