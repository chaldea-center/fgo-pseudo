        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C791 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_SubmarineSelectScannerListViewItemDraw___c__DisplayClass14_0__LoadEventUIAssetData_b__0__, v8);
    sub_1B715CC(&SubmarineSelectScannerListViewItemDraw___c__DisplayClass14_0_TypeInfo, v9);
    byte_4A1C791 = 1;
  }
  v10 = sub_1B71818(SubmarineSelectScannerListViewItemDraw___c__DisplayClass14_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C794 & 1) == 0 )
  {
    ...
    this = (SubmarineSelectScannerListViewItemDraw_o *)sub_1B715CC(&StringLiteral_5361/*"DownloadEventUIAtlas{0}{1}"*/, v12);
    byte_4A1C794 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C793 & 1) == 0 )
  {
    this = (SubmarineSelectScannerListViewItemDraw_o *)sub_1B715CC(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C78F & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_DataManager_GetMasterData_EventPanelScanMaster___, v5);
    sub_1B715CC(&Method_DataMasterBase_EventPanelScanMaster__EventPanelScanEntity__int__GetEntity__, v6);
    sub_1B715CC(&LocalizationManager_TypeInfo, v7);
    sub_1B715CC(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v8);
    sub_1B715CC(&Method_SubmarineSelectScannerListViewItemDraw___c__DisplayClass11_0__UpdateUi_b__0__, v9);
    sub_1B715CC(&SubmarineSelectScannerListViewItemDraw___c__DisplayClass11_0_TypeInfo, v10);
    sub_1B715CC(&StringLiteral_5702/*"EVENT_SUBMARINE_SELECT_SCAN_METHOD_PREFIX"*/, v11);
    sub_1B715CC(&StringLiteral_5705/*"EVENT_SUBMARINE_UNKNOWN_VALUE"*/, v12);
    byte_4A1C78F = 1;
  }
  v13 = sub_1B71818(SubmarineSelectScannerListViewItemDraw___c__DisplayClass11_0_TypeInfo);
  ...
  *(_QWORD *)(v13 + 24) = item;
  ...
  v28 = (System_String_o **)((v26 & 1) != 0 ? &StringLiteral_5702/*"EVENT_SUBMARINE_SELECT_SCAN_METHOD_PREFIX"*/ : &StringLiteral_5705/*"EVENT_SUBMARINE_UNKNOWN_VALUE"*/);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B715CC(&int_TypeInfo, method);
    sub_1B715CC(&StringLiteral_22960/*"scan_icon_{0}"*/, v4);
    this = (SubmarineSelectScannerListViewItemDraw___c__DisplayClass11_0_o *)sub_1B715CC(&StringLiteral_20281/*"img_list_bg02"*/, v5);
    byte_4A1C798 = 1;
  }
  item = v3->fields.item;
  if ( !item
    ...
    || (this = (SubmarineSelectScannerListViewItemDraw___c__DisplayClass11_0_o *)SubmarineSelectScannerListViewItemDraw__SetSpriteByLocalAtlas(
                                                                                   ...
                                                                                   (System_String_o *)StringLiteral_20281/*"img_list_bg02"*/,
                                                                                   v7),
  ...
  v15 = System_String__Format((System_String_o *)StringLiteral_22960/*"scan_icon_{0}"*/, v14, 0LL);
