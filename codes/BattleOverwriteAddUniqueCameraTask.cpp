        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D33D87 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&BattleActionWaitCond_UntilAddUniqueCameraLoadComplete_TypeInfo);
    byte_4D33D87 = 1;
  }
  overwriteAddUniqueCameraIds = this->fields.overwriteAddUniqueCameraIds;
  v5 = (BattleActionWaitCond_UntilAddUniqueCameraLoadComplete_o *)sub_1C93D20(BattleActionWaitCond_UntilAddUniqueCameraLoadComplete_TypeInfo);
