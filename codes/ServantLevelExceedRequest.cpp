        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B24A5 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_17335/*"card/combineExceed"*/);
    byte_42B24A5 = 1;
  }
  ...
  return System_String__Concat_44568316(BaseUrl, (System_String_o *)StringLiteral_17335/*"card/combineExceed"*/, 0LL);
}
