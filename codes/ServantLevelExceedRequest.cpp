        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4353C94 & 1) == 0 )
  {
    ...
    sub_B70694(&StringLiteral_17476/*"card/combineExceed"*/);
    byte_4353C94 = 1;
  }
  ...
  return System_String__Concat_44758168(BaseUrl, (System_String_o *)StringLiteral_17476/*"card/combineExceed"*/, 0LL);
}
