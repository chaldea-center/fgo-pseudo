        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4189FEA & 1) == 0 )
  {
    ...
    sub_B2C35C(&StringLiteral_17216/*"card/combineExceed"*/, v2);
    byte_4189FEA = 1;
  }
  ...
  return System_String__Concat_44305532(BaseUrl, (System_String_o *)StringLiteral_17216/*"card/combineExceed"*/, 0LL);
}
