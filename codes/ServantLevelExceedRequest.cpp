        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FC7C6 & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_17150/*"card/combineExceed"*/, v2);
    byte_40FC7C6 = 1;
  }
  ...
  return System_String__Concat_43743732(BaseUrl, (System_String_o *)StringLiteral_17150/*"card/combineExceed"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v7 = ResponseCommandKind__SearchData(54, responseList, 0LL);
