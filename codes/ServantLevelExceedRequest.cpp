...
System_String_o *ServantLevelExceedRequest__getURL(ServantLevelExceedRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2E4AB & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_17837/*"card/combineExceed"*/);
    byte_4D2E4AB = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64417744(BaseUrl, (System_String_o *)StringLiteral_17837/*"card/combineExceed"*/, 0);
}
