        ...
        const MethodInfo *method)
{
  ...
  if ( !defaultValue )
    defaultValue = (System_Int32_array *)sub_1CE67A8(int___TypeInfo, 2);
         ...
         (const MethodInfo_35B4B84 *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
  {
    ...
    if ( v12 != System_Collections_Generic_List_object__TypeInfo )
      return defaultValue;
    v9 = (struct System_Collections_Generic_Dictionary_string__object__o *)sub_1CE67A8(int___TypeInfo, 2);
    if ( !v13 )
      goto LABEL_22;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E05655 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_23100/*"positionCenter"*/);
    byte_4E05655 = 1;
  }
  return StaffPhotoCostumeEntity__GetExtendOffset(this, (System_String_o *)StringLiteral_23100/*"positionCenter"*/, defaultValue, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E05657 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_23103/*"positionLeft"*/);
    byte_4E05657 = 1;
  }
  return StaffPhotoCostumeEntity__GetExtendOffset(this, (System_String_o *)StringLiteral_23103/*"positionLeft"*/, defaultValue, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E05656 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_23104/*"positionRight"*/);
    byte_4E05656 = 1;
  }
  return StaffPhotoCostumeEntity__GetExtendOffset(this, (System_String_o *)StringLiteral_23104/*"positionRight"*/, defaultValue, v3);
}