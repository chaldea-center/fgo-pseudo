        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B02BE3 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_System_Collections_Generic_List_object__get_Item__, v10);
    sub_1BC3008(&System_Collections_Generic_List_object__TypeInfo, v11);
    byte_4B02BE3 = 1;
  }
  if ( !defaultValue )
    defaultValue = (System_Int32_array *)sub_1BC30B0(int___TypeInfo, 2LL);
         ...
         (const MethodInfo_336D1DC *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
  {
    ...
    if ( v17 != System_Collections_Generic_List_object__TypeInfo )
      return defaultValue;
    v14 = (struct System_Collections_Generic_Dictionary_string__object__o *)sub_1BC30B0(int___TypeInfo, 2LL);
    if ( !v18 )
      goto LABEL_22;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B02BE4 & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_22514/*"positionCenter"*/, defaultValue);
    byte_4B02BE4 = 1;
  }
  return StaffPhotoCostumeEntity__GetExtendOffset(this, (System_String_o *)StringLiteral_22514/*"positionCenter"*/, defaultValue, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B02BE6 & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_22517/*"positionLeft"*/, defaultValue);
    byte_4B02BE6 = 1;
  }
  return StaffPhotoCostumeEntity__GetExtendOffset(this, (System_String_o *)StringLiteral_22517/*"positionLeft"*/, defaultValue, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B02BE5 & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_22518/*"positionRight"*/, defaultValue);
    byte_4B02BE5 = 1;
  }
  return StaffPhotoCostumeEntity__GetExtendOffset(this, (System_String_o *)StringLiteral_22518/*"positionRight"*/, defaultValue, v3);
}