        ...
        const MethodInfo *method)
{
  ...
  const MethodInfo_4483994 *v15; // x2
  Il2CppObject *v16; // x0
  ...
  if ( !defaultValue )
    defaultValue = (System_Int32_array *)sub_2213B20(int___TypeInfo, 2);
...
LABEL_18:
    ...
    if ( !LODWORD(defaultValue->max_length)
      || (v15 = (const MethodInfo_4483994 *)Method_System_Collections_Generic_List_object__get_Item__,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_59714E2 & 1) == 0 )
  {
    sub_2213A60(&StringLiteral_23918/*"positionCenter"*/);
    byte_59714E2 = 1;
  }
  return StaffPhotoCostumeEntity__GetExtendOffset(this, (System_String_o *)StringLiteral_23918/*"positionCenter"*/, defaultValue, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_59714E4 & 1) == 0 )
  {
    sub_2213A60(&StringLiteral_23921/*"positionLeft"*/);
    byte_59714E4 = 1;
  }
  return StaffPhotoCostumeEntity__GetExtendOffset(this, (System_String_o *)StringLiteral_23921/*"positionLeft"*/, defaultValue, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_59714E3 & 1) == 0 )
  {
    sub_2213A60(&StringLiteral_23922/*"positionRight"*/);
    byte_59714E3 = 1;
  }
  return StaffPhotoCostumeEntity__GetExtendOffset(this, (System_String_o *)StringLiteral_23922/*"positionRight"*/, defaultValue, v3);
}