        ...
        const MethodInfo *method)
{
  ...
  if ( !defaultValue )
    defaultValue = (System_Int32_array *)sub_1D0F15C(int___TypeInfo, 2);
         ...
         (const MethodInfo_36017D8 *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
  {
    ...
    if ( v12 != System_Collections_Generic_List_object__TypeInfo )
      return defaultValue;
    v9 = (struct System_Collections_Generic_Dictionary_string__object__o *)sub_1D0F15C(int___TypeInfo, 2);
    if ( !v13 )
      goto LABEL_22;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E782F4 & 1) == 0 )
  {
    sub_1D0F0B4(&StringLiteral_23202/*"positionCenter"*/);
    byte_4E782F4 = 1;
  }
  return StaffPhotoCostumeEntity__GetExtendOffset(this, (System_String_o *)StringLiteral_23202/*"positionCenter"*/, defaultValue, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E782F6 & 1) == 0 )
  {
    sub_1D0F0B4(&StringLiteral_23205/*"positionLeft"*/);
    byte_4E782F6 = 1;
  }
  return StaffPhotoCostumeEntity__GetExtendOffset(this, (System_String_o *)StringLiteral_23205/*"positionLeft"*/, defaultValue, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E782F5 & 1) == 0 )
  {
    sub_1D0F0B4(&StringLiteral_23206/*"positionRight"*/);
    byte_4E782F5 = 1;
  }
  return StaffPhotoCostumeEntity__GetExtendOffset(this, (System_String_o *)StringLiteral_23206/*"positionRight"*/, defaultValue, v3);
}