        ...
        const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.eventUiEntity, (int32_t)entity, v5, v6);
}
...
void EventInfoRepairComponent__OnClick(EventInfoRepairComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C38F4E & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_EventInfoRepairComponent_OnClick__);
    sub_1C32C20(&Method_EventInfoRepairComponent__OnClick_b__7_0__);
      ...
      & 1) == 0 )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoRepairComponent_OnClick__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C32C38(Method_EventInfoRepairComponent_OnClick__);
...
void EventInfoRepairComponent__Redisplay(EventInfoRepairComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C38F4D & 1) == 0 )
  {
    sub_1C32C20(&Method_UnityEngine_Component_GetComponentsInChildren_EventInfoAssistSkillIconComponent___);
    byte_4C38F4D = 1;
  }
  ComponentsInChildren_object__51202152 = UnityEngine_Component__GetComponentsInChildren_object__51202152(
                                            (UnityEngine_Component_o *)this,
                                            (const MethodInfo_30D4868 *)Method_UnityEngine_Component_GetComponentsInChildren_EventInfoAssistSkillIconComponent___);
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      ComponentsInChildren_object__51202152 = (System_Object_array *)v5->m_Items[v6];
      if ( !ComponentsInChildren_object__51202152 )
        break;
      EventInfoAssistSkillIconComponent__Redisplay(
        (EventInfoAssistSkillIconComponent_o *)ComponentsInChildren_object__51202152,
        0);
