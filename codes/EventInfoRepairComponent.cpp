...
void EventInfoRepairComponent__OnClick(EventInfoRepairComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D327D7 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_EventInfoRepairComponent_OnClick__);
    sub_1C93AD4(&Method_EventInfoRepairComponent__OnClick_b__7_0__);
      ...
      & 1) == 0 )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoRepairComponent_OnClick__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C93AEC(Method_EventInfoRepairComponent_OnClick__);
...
void EventInfoRepairComponent__Redisplay(EventInfoRepairComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D327D6 & 1) == 0 )
  {
    sub_1C93AD4(&Method_UnityEngine_Component_GetComponentsInChildren_EventInfoAssistSkillIconComponent___);
    byte_4D327D6 = 1;
  }
  ComponentsInChildren_object__52018868 = UnityEngine_Component__GetComponentsInChildren_object__52018868(
                                            (UnityEngine_Component_o *)this,
                                            (const MethodInfo_319BEB4 *)Method_UnityEngine_Component_GetComponentsInChildren_EventInfoAssistSkillIconComponent___);
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      ComponentsInChildren_object__52018868 = (System_Object_array *)v6->m_Items[v7];
      if ( !ComponentsInChildren_object__52018868 )
        break;
      EventInfoAssistSkillIconComponent__Redisplay(
        (EventInfoAssistSkillIconComponent_o *)ComponentsInChildren_object__52018868,
        0);
