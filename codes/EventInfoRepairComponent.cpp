        ...
        const MethodInfo *method)
{
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.eventUiEntity, (int32_t)entity, v5, v6);
}
...
void EventInfoRepairComponent__OnClick(EventInfoRepairComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB787E & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_EventInfoRepairComponent_OnClick__);
    sub_1C6BA08(&Method_EventInfoRepairComponent__OnClick_b__7_0__);
      ...
      & 1) == 0 )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoRepairComponent_OnClick__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C6BA20(Method_EventInfoRepairComponent_OnClick__);
...
void EventInfoRepairComponent__Redisplay(EventInfoRepairComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB787D & 1) == 0 )
  {
    sub_1C6BA08(&Method_UnityEngine_Component_GetComponentsInChildren_EventInfoAssistSkillIconComponent___);
    byte_4CB787D = 1;
  }
  ComponentsInChildren_object__51587040 = UnityEngine_Component__GetComponentsInChildren_object__51587040(
                                            (UnityEngine_Component_o *)this,
                                            (const MethodInfo_31327E0 *)Method_UnityEngine_Component_GetComponentsInChildren_EventInfoAssistSkillIconComponent___);
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      ComponentsInChildren_object__51587040 = (System_Object_array *)v6->m_Items[v7];
      if ( !ComponentsInChildren_object__51587040 )
        break;
      EventInfoAssistSkillIconComponent__Redisplay(
        (EventInfoAssistSkillIconComponent_o *)ComponentsInChildren_object__51587040,
        0);
