...
void __fastcall MissionListViewItem__CheckEventMissionAdd(MissionListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A22DE3 & 1) == 0 )
  {
    sub_1B715CC(&System_Comparison_EventMissionAddEntity__TypeInfo, method);
    sub_1B715CC(&CondType_TypeInfo, v3);
    sub_1B715CC(&Method_DataManager_GetMasterData_EventMissionAddMaster___, v4);
    sub_1B715CC(&Method_System_Linq_Enumerable_Any_EventMissionAddEntity___, v5);
    sub_1B715CC(&Method_System_Collections_Generic_List_Enumerator_EventMissionAddEntity__Dispose__, v6);
    sub_1B715CC(&Method_System_Collections_Generic_List_Enumerator_EventMissionAddEntity__MoveNext__, v7);
    sub_1B715CC(&Method_System_Collections_Generic_List_Enumerator_EventMissionAddEntity__get_Current__, v8);
    sub_1B715CC(&Method_System_Collections_Generic_List_EventMissionAddEntity__GetEnumerator__, v9);
    sub_1B715CC(&Method_System_Collections_Generic_List_EventMissionAddEntity__Sort__, v10);
    sub_1B715CC(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v11);
    sub_1B715CC(&Method_MissionListViewItem___c__CheckEventMissionAdd_b__32_0__, v12);
    sub_1B715CC(&MissionListViewItem___c_TypeInfo, v13);
    byte_4A22DE3 = 1;
  }
  ...
  if ( !System_Linq_Enumerable__Any_object_(
          ...
          (const MethodInfo_2E68DBC *)Method_System_Linq_Enumerable_Any_EventMissionAddEntity___) )
    return;
  ...
  if ( !v17 )
  {
    ...
    v17 = (System_Comparison_T__o *)sub_1B71818(System_Comparison_EventMissionAddEntity__TypeInfo);
    ...
    sub_1B71570((ServantStatusBattleListViewItem_o *)&static_fields->__9__32_0, (int32_t)v17, v20, v21);
  }
    ...
    if ( CondType__IsOpen(monitor_high, klass, klass_high, 0, 0LL, 0LL) )
    {
      ...
      if ( monitor == 2 )
      {
        if ( !System_String__IsNullOrEmpty((System_String_o *)current[3].klass, 0LL) )
        {
          ...
          sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.condMsg, (int32_t)v31, v29, v30);
        }
      }
      else if ( monitor == 1 )
      {
        ...
        const MethodInfo *method)
{
  ...
  *progTxt = v4;
  sub_1B71570((ServantStatusBattleListViewItem_o *)progTxt, (int32_t)v4, (int32_t)barExp, (int32_t)method);
  result = 1;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22DE6 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataManager_GetMasterData_EventMissionConditionMaster___, *(_QWORD *)&flag);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22DE5 & 1) == 0 )
  {
    sub_1B715CC(&UserMissionProgressManager_TypeInfo, isRecieveReward);
    byte_4A22DE5 = 1;
  }
...
void __fastcall MissionListViewItem__SetMissionCondMsg(MissionListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_2E5B3E8 *)Method_DataManager_GetMasterData_EventMissionConditionMaster___)) == 0LL )
  {
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.condMsg, (int32_t)ConditionMessage, v10, v11);
  ClosedMessage = MissionInfoMaker__GetClosedMessage(MissionCondListByType, v12);
  this->fields.closedMessage = ClosedMessage;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.closedMessage, (int32_t)ClosedMessage, v14, v15);
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.progTxt, (int32_t)ProgressText, v18, v19);
...
void __fastcall MissionListViewItem__SetRewardInfo(MissionListViewItem_o *this, const MethodInfo *method)
{
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.subGiftEntity, 0, v2, v3);
  eventMissionEnt = this->fields.eventMissionEnt;
  if ( !eventMissionEnt )
    sub_1B71828(0LL, v5);
  ...
  if ( rewardType == 3 )
  {
    ...
    if ( SetRewardData )
    {
      ...
      sub_1B71570((ServantStatusBattleListViewItem_o *)p_nameTxt, (int32_t)name, v17, v18);
      *((_DWORD *)p_nameTxt + 2) = v20->fields.iconId;
      detail = v20->fields.detail;
      p_nameTxt[2] = detail;
      sub_1B71570((ServantStatusBattleListViewItem_o *)(p_nameTxt + 2), (int32_t)detail, v23, v24);
    }
  }
  else if ( rewardType == 1 )
  {
    ...
    sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.giftEnts, (int32_t)GiftData, v9, v10);
    giftEnts = this->fields.giftEnts;
    if ( !MissionInfoMaker_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(MissionInfoMaker_TypeInfo);
    SubGiftEntity = MissionInfoMaker__GetSubGiftEntity(giftEnts, v11);
    this->fields.subGiftEntity = SubGiftEntity;
    sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.subGiftEntity, (int32_t)SubGiftEntity, v14, v15);
...
void __fastcall MissionListViewItem___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A22DE9 & 1) == 0 )
  {
    sub_1B715CC(&MissionListViewItem___c_TypeInfo, v1);
    byte_4A22DE9 = 1;
  }
  v2 = (Il2CppObject *)sub_1B71818(MissionListViewItem___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  MissionListViewItem___c_TypeInfo->static_fields->__9 = (struct MissionListViewItem___c_o *)v2;
  sub_1B71570((ServantStatusBattleListViewItem_o *)MissionListViewItem___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
