...
System_String_o *UserPresentHistoryEntity__ToString(UserPresentHistoryEntity_o *this, const MethodInfo *method)
{
  ...
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_10526/*"PRESENT_INFO"*/, 0);
  if ( !v3 )
    sub_1C93D2C(v4, v5);
  return System_String__Format_64467032(v4, (Il2CppObject *)v3->fields.name, (Il2CppObject *)v3->fields.count, 0);
}