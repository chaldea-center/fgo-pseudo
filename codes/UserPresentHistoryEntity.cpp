        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C22D7F & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_10673/*"Quechua (Bolivia)"*/, v3);
    byte_4C22D7F = 1;
  }
  v4 = GiftName_GiftNameFactory__Create(this->fields.giftType, this->fields.objectId, this->fields.num, 0LL);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v5 = LocalizationManager__Get((System_String_o *)StringLiteral_10673/*"Quechua (Bolivia)"*/, 0LL);
  if ( !v4 )
    sub_1C3B9C0(v5, v6);
  return System_String__Format_63382984(v5, (Il2CppObject *)v4->fields.name, (Il2CppObject *)v4->fields.count, 0LL);
}