        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BBCAD & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_10246/*"PRESENT_INFO"*/, v3);
    byte_49BBCAD = 1;
  }
  v4 = GiftName_GiftNameFactory__Create(this->fields.giftType, this->fields.objectId, this->fields.num, 0LL);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v5 = LocalizationManager__Get((System_String_o *)StringLiteral_10246/*"PRESENT_INFO"*/, 0LL);
  if ( !v4 )
    sub_1B4D1EC(v5, v6);
  return System_String__Format_61134760(v5, (Il2CppObject *)v4->fields.name, (Il2CppObject *)v4->fields.count, 0LL);
}