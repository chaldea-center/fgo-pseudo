void __fastcall EventInfoCommandBuffPointComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48E3333 & 1) == 0 )
  {
    sub_1B00CCC(&EventInfoCommandBuffPointComponent_TypeInfo, v1);
    byte_48E3333 = 1;
  }
  *EventInfoCommandBuffPointComponent_TypeInfo->static_fields = (struct EventInfoCommandBuffPointComponent_StaticFields)xmmword_B713E0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3332 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_DataManager_GetMasterData_EventPointBuffMaster___, v12);
    sub_1B00CCC(&Method_System_Collections_Generic_List_Enumerator_EventPointBuffEntity__Dispose__, v13);
    sub_1B00CCC(&Method_System_Collections_Generic_List_Enumerator_EventPointBuffEntity__MoveNext__, v14);
    sub_1B00CCC(&Method_System_Collections_Generic_List_Enumerator_EventPointBuffEntity__get_Current__, v15);
    sub_1B00CCC(&Method_System_Collections_Generic_List_EventPointBuffEntity__GetEnumerator__, v16);
    sub_1B00CCC(&Method_System_Collections_Generic_List_EventPointBuffEntity__Sort__, v17);
    sub_1B00CCC(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v18);
    sub_1B00CCC(&Method_EventInfoCommandBuffPointComponent___c__GetEnableEventPointBuffEntity_b__18_0__, v19);
    sub_1B00CCC(&EventInfoCommandBuffPointComponent___c_TypeInfo, v20);
    byte_48E3332 = 1;
  }
  ...
  if ( !_9__18_0 )
  {
    ...
    _9__18_0 = (System_Comparison_T__o *)sub_1B00F18(System_Comparison_EventPointBuffEntity__TypeInfo);
    ...
    sub_1B00C70((ServantStatusBattleListViewItem_o *)&static_fields->__9__18_0, (int32_t)_9__18_0, v28, v29);
  }
  if ( !v24 )
LABEL_20:
  ...
  *nowEventPointBuff = 0LL;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)nowEventPointBuff, 0, v30, v31);
  *nextEventPointBuff = 0LL;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)nextEventPointBuff, 0, v32, v33);
  ...
  while ( 1 )
  {
    ...
    if ( EventPointBuffEntity__IsEnable((EventPointBuffEntity_o *)v39.fields._current, userPoint, 0LL) )
    {
      *nowEventPointBuff = (EventPointBuffEntity_o *)current;
      sub_1B00C70((ServantStatusBattleListViewItem_o *)nowEventPointBuff, (int32_t)current, v37, v38);
      break;
    }
    *nextEventPointBuff = (EventPointBuffEntity_o *)current;
    sub_1B00C70((ServantStatusBattleListViewItem_o *)nextEventPointBuff, (int32_t)current, v37, v38);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3331 & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataManager_GetMasterData_UserEventPointMaster___, *(_QWORD *)&eventId);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E332F & 1) == 0 )
  {
    sub_1B00CCC(&AtlasManager_TypeInfo, eventUiEntity);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3330 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&EventInfoCommandBuffPointComponent_TypeInfo, v4);
    ...
    sub_1B00CCC(&StringLiteral_5585/*"EVENT_POINT_COMMON_FORMAT"*/, v9);
    sub_1B00CCC(&StringLiteral_5525/*"EVENT_COMMAND_BUFF_POINT_COUNT_STOP"*/, v10);
    this = (EventInfoCommandBuffPointComponent_o *)sub_1B00CCC(&StringLiteral_1/*""*/, v11);
    byte_48E3330 = 1;
  }
  nowEventPointBuff = 0LL;
  nextEventPointBuff = 0LL;
  ...
  if ( UnityEngine_Object__op_Inequality(pointLabel, 0LL, 0LL) )
  {
    ...
    v20 = LocalizationManager__Get((System_String_o *)StringLiteral_5585/*"EVENT_POINT_COMMON_FORMAT"*/, 0LL);
    ...
    v47 = System_Math__Min_61144596(point, UserPointEventMax, 0LL);
  ...
  if ( UnityEngine_Object__op_Inequality(needPointLabel, 0LL, 0LL) )
  {
    if ( nextEventPointBuff )
    {
      ...
      if ( !System_Math_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
      v39 = System_Math__Max_61144268(v37, USER_EVENT_POINT_REST_MIN, 0LL);
      v40 = v3->fields.needPointLabel;
      v41 = v39;
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v42 = LocalizationManager__Get((System_String_o *)StringLiteral_5585/*"EVENT_POINT_COMMON_FORMAT"*/, 0LL);
      v47 = System_Math__Min_61144596(
              v41,
...
LABEL_39:
    ...
    else
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      EventPointInfo = LocalizationManager__Get((System_String_o *)StringLiteral_5525/*"EVENT_COMMAND_BUFF_POINT_COUNT_STOP"*/, 0LL);
      if ( v40 )
        goto LABEL_39;
    }
LABEL_44:
    sub_1B00F28(EventPointInfo, v30);
  }
}
...
void __fastcall EventInfoCommandBuffPointComponent___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48E3334 & 1) == 0 )
  {
    sub_1B00CCC(&EventInfoCommandBuffPointComponent___c_TypeInfo, v1);
    byte_48E3334 = 1;
  }
  v2 = (Il2CppObject *)sub_1B00F18(EventInfoCommandBuffPointComponent___c_TypeInfo);
