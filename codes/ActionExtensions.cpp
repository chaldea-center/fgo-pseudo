...
void __fastcall ActionExtensions__Call_BlankEarth_QAARotateEarthResponse_(
        ...
        const MethodInfo_2D65B10 *method)
{
  if ( action )
...
void __fastcall ActionExtensions__Call_ShowAllEx_DamageFuncArgument_(
        ...
        const MethodInfo_2D65B40 *method)
{
  __int128 v3; // q0
  const MethodInfo_2D65B40_RGCTXs *rgctx_data; // x8
...
void __fastcall ActionExtensions__Call_bool_(System_Action_T__o *action, bool arg, const MethodInfo_2D65ADC *method)
{
  if ( action )
...
void __fastcall ActionExtensions__Call_bool__bool_(
        ...
        bool arg1,
        bool arg2,
        const MethodInfo_2D65B94 *method)
{
  if ( action )
...
void __fastcall ActionExtensions__Call_float_(System_Action_T__o *action, float arg, const MethodInfo_2D65B28 *method)
{
  if ( action )
...
void __fastcall ActionExtensions__Call_int_(System_Action_T__o *action, int32_t arg, const MethodInfo_2D65AF8 *method)
{
  if ( action )
...
void __fastcall ActionExtensions__Call_int__bool_(
        ...
        int32_t arg1,
        bool arg2,
        const MethodInfo_2D65BB4 *method)
{
  if ( action )
...
void __fastcall ActionExtensions__Call_int__bool__bool_(
        ...
        bool arg2,
        bool arg3,
        const MethodInfo_2D65C18 *method)
{
  if ( action )
...
void __fastcall ActionExtensions__Call_int__int_(
        ...
        int32_t arg1,
        int32_t arg2,
        const MethodInfo_2D65BD0 *method)
{
  if ( action )
...
void __fastcall ActionExtensions__Call_object__int_(
        ...
        Il2CppObject *arg1,
        int32_t arg2,
        const MethodInfo_2D65BE8 *method)
{
  if ( action )
...
void __fastcall ActionExtensions__Call_object__object_(
        ...
        Il2CppObject *arg1,
        Il2CppObject *arg2,
        const MethodInfo_2D65C00 *method)
{
  if ( action )
...
void __fastcall ActionExtensions__Call_object__object__object_(
        ...
        Il2CppObject *arg2,
        Il2CppObject *arg3,
        const MethodInfo_2D65C38 *method)
{
  if ( action )
