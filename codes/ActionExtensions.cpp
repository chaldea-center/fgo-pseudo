...
void ActionExtensions__Call_Int32Enum_(System_Action_T__o *action, int32_t arg, const MethodInfo_30E58D0 *method)
{
...
void ActionExtensions__Call_Int32Enum__object_(
        ...
        int32_t arg1,
        Il2CppObject *arg2,
        const MethodInfo_30E5C64 *method)
{
  if ( method->rgctx_data )
  {
    if ( !action )
...
void ActionExtensions__Call_ShowAllEx_DamageFuncArgument_(
        ...
        const MethodInfo_30E5A98 *method)
{
  ...
  v9 = v7;
  invoke_impl(method_code, &v8, action->fields.method);
}
...
void ActionExtensions__Call___Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_30E59C0 *method)
{
  ...
  if ( action )
  {
    ...
    if ( (*(_DWORD *)(*(_QWORD *)(v5 + 8) + 40LL) & 0x80000000) == 0 )
      v9 = (_QWORD *)*v9;
    v15[0] = v9;
    ((void (__fastcall *)(__int64, __int64 *, System_Action_T__o *, _QWORD *, _QWORD *))v11[2])(
      v12,
      v11,
      action,
      v15,
...
void ActionExtensions__Call___Il2CppFullySharedGenericType____Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_30E5DC4 *method)
{
  void **monitor; // x22
  ...
  klass = arg1.klass;
  v21[2] = *(_QWORD *)(_ReadStatusReg(TPIDR_EL0) + 40);
  v19 = arg1.monitor;
  v20 = arg1.klass;
  ...
  if ( action )
  {
    ...
    v21[0] = v12;
    v21[1] = v13;
    ((void (__fastcall *)(__int64, __int64 *, System_Action_T1__T2__o *, _QWORD *, _QWORD *))v16[2])(
      v17,
      v16,
      action,
      v21,
...
void ActionExtensions__Call___Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_30E6038 *method)
{
  Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_c *klass; // x23
  void **monitor; // x24
  ...
  _QWORD v28[4]; // [xsp+20h] [xbp-20h] BYREF

  klass = arg2.klass;
  monitor = (void **)arg1.monitor;
  v7 = arg1.klass;
  v28[3] = *(_QWORD *)(_ReadStatusReg(TPIDR_EL0) + 40);
  v26 = arg1.monitor;
  v27 = arg1.klass;
  v25 = arg2.klass;
  ...
  if ( action )
  {
    ...
    v28[1] = v16;
    v28[2] = v17;
    ((void (__fastcall *)(__int64, __int64 *, System_Action_T1__T2__T3__o *, _QWORD *, _QWORD *))v22[2])(
      v23,
      v22,
      v24,
      v28,
...
void ActionExtensions__Call_bool_(System_Action_T__o *action, bool arg, const MethodInfo_30E5830 *method)
{
  if ( method->rgctx_data )
  {
    if ( !action )
...
void ActionExtensions__Call_bool__bool_(
        ...
        bool arg1,
        bool arg2,
        const MethodInfo_30E5B04 *method)
{
  if ( method->rgctx_data )
  {
    if ( !action )
...
void ActionExtensions__Call_bool__int_(
        ...
        bool arg1,
        int32_t arg2,
        const MethodInfo_30E5B5C *method)
{
  if ( method->rgctx_data )
  {
    if ( !action )
...
void ActionExtensions__Call_bool__int__object_(
        ...
        int32_t arg2,
        Il2CppObject *arg3,
        const MethodInfo_30E5EF4 *method)
{
  if ( method->rgctx_data )
  {
    if ( !action )
...
void ActionExtensions__Call_float_(System_Action_T__o *action, float arg, const MethodInfo_30E5970 *method)
{
  long double v3; // q8
...
void ActionExtensions__Call_int_(System_Action_T__o *action, int32_t arg, const MethodInfo_30E5880 *method)
{
  if ( method->rgctx_data )
  {
    if ( !action )
...
void ActionExtensions__Call_int__bool_(
        ...
        int32_t arg1,
        bool arg2,
        const MethodInfo_30E5BB4 *method)
{
  if ( method->rgctx_data )
  {
    if ( !action )
...
void ActionExtensions__Call_int__bool__bool_(
        ...
        bool arg2,
        bool arg3,
        const MethodInfo_30E5F60 *method)
{
  if ( method->rgctx_data )
  {
    if ( !action )
...
void ActionExtensions__Call_int__int_(
        ...
        int32_t arg1,
        int32_t arg2,
        const MethodInfo_30E5C0C *method)
{
  if ( method->rgctx_data )
  {
    if ( !action )
...
void ActionExtensions__Call_long__int_(
        System_Action_T1__T2__o *action,
        int64_t arg1,
        int32_t arg2,
        const MethodInfo_30E5CBC *method)
{
  if ( method->rgctx_data )
  {
    if ( !action )
  ...
  if ( action )
LABEL_3:
    ((void (__fastcall *)(intptr_t, int64_t, _QWORD, intptr_t))action->fields.invoke_impl)(
      action->fields.method_code,
      arg1,
      (unsigned int)arg2,
      action->fields.method);
...
void ActionExtensions__Call_object_(System_Action_T__o *action, Il2CppObject *arg, const MethodInfo_30E5920 *method)
{
  if ( method->rgctx_data )
  {
    if ( !action )
...
void ActionExtensions__Call_object__int_(
        ...
        Il2CppObject *arg1,
        int32_t arg2,
        const MethodInfo_30E5D14 *method)
{
  if ( method->rgctx_data )
  {
    if ( !action )
...
void ActionExtensions__Call_object__int__bool_(
        ...
        int32_t arg2,
        bool arg3,
        const MethodInfo_30E5FCC *method)
{
  if ( method->rgctx_data )
  {
    if ( !action )
...
void ActionExtensions__Call_object__object_(
        ...
        Il2CppObject *arg1,
        Il2CppObject *arg2,
        const MethodInfo_30E5D6C *method)
{
  if ( method->rgctx_data )
  {
    if ( !action )
