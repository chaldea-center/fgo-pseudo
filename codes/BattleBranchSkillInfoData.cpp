        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C29FFC & 1) == 0 )
  {
    sub_1C2D490(&StringLiteral_9528/*"None"*/);
    sub_1C2D490(&StringLiteral_7618/*"Individuality"*/);
    sub_1C2D490(&StringLiteral_8062/*"IsSelfTarget"*/);
    byte_4C29FFC = 1;
  }
  ...
  *(_QWORD *)&this->fields.condBranchType = condValue;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.condBranchType, (int32_t)condValue, v10, v11);
  condType = condBranchSkillInfoData->fields.condType;
  if ( System_String__op_Equality(condType, (System_String_o *)StringLiteral_8062/*"IsSelfTarget"*/, 0) )
  {
    v16 = 1;
LABEL_8:
    *((_DWORD *)&this->fields.hasAddBattlePointFunc + 1) = v16;
    goto LABEL_9;
  }
  if ( System_String__op_Equality(condType, (System_String_o *)StringLiteral_7618/*"Individuality"*/, 0) )
  {
    v16 = 2;
    goto LABEL_8;
  }
  if ( System_String__op_Equality(condType, (System_String_o *)StringLiteral_9528/*"None"*/, 0)
...
LABEL_9:
  ...
  *(_QWORD *)&this->fields.isAnd = detailText;
  ...
  sub_1C2D434((CGThumbnailListItem_o *)p_isAnd, (int32_t)detailText, v14, v15);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C29FFD & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_Individuality_IsPartialMatchArray__);
    this = (BattleBranchSkillInfoData_o *)sub_1C2D490(&Individuality_TypeInfo);
    byte_4C29FFD = 1;
  }
  ...
  if ( v7 == 2 )
  {
    ...
    v12 = (System_Func_T1__T2__TResult__o *)sub_1C2D6DC(System_Func_int____int____bool__TypeInfo);
    ...
    if ( condValue_low )
    {
      ...
      v14 = (System_Func_T1__T2__TResult__o *)sub_1C2D6DC(System_Func_int____int____bool__TypeInfo);
    ...
    else
    {
      ...
      v15 = (System_Func_T1__T2__TResult__o *)sub_1C2D6DC(System_Func_int____int____bool__TypeInfo);
  ...
  else if ( v7 == 1 )
  {
    ...
    if ( !v9 )
      sub_1C2D6EC(this, isSelfTarget);
    if ( !*(_DWORD *)(v9 + 24) )
      sub_1C2D6F4(this, isSelfTarget, targetIndv);
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.isAnd = value;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.isAnd, (int32_t)value, (int32_t)method, v3);
}
