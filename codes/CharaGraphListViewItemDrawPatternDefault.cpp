        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6F21C & 1) == 0 )
  {
    sub_1B90010(&Method_UnityEngine_Component_GetComponent_Collider___, itemDraw);
    this = (CharaGraphListViewItemDrawPatternDefault_o *)sub_1B90010(&UnityEngine_Object_TypeInfo, v9);
    byte_4A6F21C = 1;
  }
  if ( !itemDraw )
    goto LABEL_12;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B9026C(servantFaceIcon, v12);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6F21E & 1) == 0 )
  {
    sub_1B90010(&CharaGraphCommandCodeListViewItem_TypeInfo, itemDraw);
    sub_1B90010(&CharaGraphServantCollectionListViewItem_TypeInfo, v6);
    this = (CharaGraphListViewItemDrawPatternDefault_o *)sub_1B90010(&CharaGraphServantListViewItem_TypeInfo, v7);
    byte_4A6F21E = 1;
  }
  if ( item )
  {
    ...
    else
    {
        ...
        && (CharaGraphCommandCodeListViewItem_c *)klass->_2.typeHierarchy[v11 - 1] == CharaGraphCommandCodeListViewItem_TypeInfo )
      {
        if ( itemDraw )
        {
          ...
          if ( this )
          {
            ServantFaceIconComponent__Set_38278404(
              (ServantFaceIconComponent_o *)this,
      ...
      else
      {
        ...
        if ( itemDraw )
        {
          ...
          if ( this )
          {
            ServantFaceIconComponent__Set_38274940(
              (ServantFaceIconComponent_o *)this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6F222 & 1) == 0 )
  {
    sub_1B90010(&AtlasManager_TypeInfo, itemDraw);
    sub_1B90010(&UnityEngine_Object_TypeInfo, v6);
    this = (CharaGraphListViewItemDrawPatternDefault_o *)sub_1B90010(&StringLiteral_22971/*"ribbon_noblephantasmup_01"*/, v7);
    byte_4A6F222 = 1;
  }
  if ( !itemDraw )
    goto LABEL_15;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6F21F & 1) == 0 )
  {
    sub_1B90010(&CharaGraphPartyServantListViewItem_TypeInfo, itemDraw);
    this = (CharaGraphListViewItemDrawPatternDefault_o *)sub_1B90010(&UnityEngine_Object_TypeInfo, v6);
    byte_4A6F21F = 1;
  }
  if ( !v5 )
    goto LABEL_17;
  ...
  if ( !UnityEngine_Object__op_Equality(partyIcon, 0LL, 0LL) )
  {
    ...
    else
    {
      ...
      if ( this )
      {
        LOBYTE(itemDraw) = 0;
LABEL_12:
        FlashingIconComponent__Set_38177124((FlashingIconComponent_o *)this, (bool)itemDraw, 0LL);
        return;
      }
    }
LABEL_17:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6F220 & 1) == 0 )
  {
    sub_1B90010(&CharaGraphCommandCodeListViewItem_TypeInfo, itemDraw);
    sub_1B90010(&UnityEngine_Object_TypeInfo, v6);
    sub_1B90010(&StringLiteral_20167/*"icon_equip"*/, v7);
    this = (CharaGraphListViewItemDrawPatternDefault_o *)sub_1B90010(&StringLiteral_20168/*"icon_equip_cc"*/, v8);
    byte_4A6F220 = 1;
  }
  if ( !itemDraw )
    goto LABEL_15;
  ...
  if ( ((unsigned __int8)this & 1) == 0 )
  {
    ...
    if ( item->fields._IsUse_k__BackingField )
    {
      ...
      v12 = &StringLiteral_20167/*"icon_equip"*/;
      ...
      {
        v12 = &StringLiteral_20168/*"icon_equip_cc"*/;
      }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6F221 & 1) == 0 )
  {
    sub_1B90010(&LocalizationManager_TypeInfo, itemDraw);
    sub_1B90010(&StringLiteral_11503/*"SELECT_CANNOT"*/, v7);
    sub_1B90010(&StringLiteral_11527/*"SELECT_SERVANT_EVENT_JOIN"*/, v8);
    this = (CharaGraphListViewItemDrawPatternDefault_o *)sub_1B90010(&StringLiteral_1/*""*/, v9);
    byte_4A6F221 = 1;
  }
  if ( !itemDraw )
    goto LABEL_18;
