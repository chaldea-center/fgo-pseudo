        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B65F33 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_UnityEngine_Component_GetComponent_Collider___, itemDraw);
    this = (CharaGraphListViewItemDrawPatternDefault_o *)sub_1BE4ACC(&UnityEngine_Object_TypeInfo, v9);
    byte_4B65F33 = 1;
  }
  if ( !itemDraw )
    goto LABEL_12;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BE4D28(servantFaceIcon, v12);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B65F35 & 1) == 0 )
  {
    sub_1BE4ACC(&CharaGraphCommandCodeListViewItem_TypeInfo, itemDraw);
    sub_1BE4ACC(&CharaGraphServantCollectionListViewItem_TypeInfo, v6);
    this = (CharaGraphListViewItemDrawPatternDefault_o *)sub_1BE4ACC(&CharaGraphServantListViewItem_TypeInfo, v7);
    byte_4B65F35 = 1;
  }
  if ( item )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B65F39 & 1) == 0 )
  {
    sub_1BE4ACC(&AtlasManager_TypeInfo, itemDraw);
    sub_1BE4ACC(&UnityEngine_Object_TypeInfo, v6);
    this = (CharaGraphListViewItemDrawPatternDefault_o *)sub_1BE4ACC(&StringLiteral_23262/*"ribbon_noblephantasmup_01"*/, v7);
    byte_4B65F39 = 1;
  }
  if ( !itemDraw )
    goto LABEL_15;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B65F36 & 1) == 0 )
  {
    sub_1BE4ACC(&CharaGraphPartyServantListViewItem_TypeInfo, itemDraw);
    this = (CharaGraphListViewItemDrawPatternDefault_o *)sub_1BE4ACC(&UnityEngine_Object_TypeInfo, v6);
    byte_4B65F36 = 1;
  }
  if ( !v5 )
    goto LABEL_17;
  ...
  if ( !UnityEngine_Object__op_Equality(partyIcon, 0LL, 0LL) )
  {
    ...
    else
    {
      ...
      if ( this )
      {
        LOBYTE(itemDraw) = 0;
LABEL_12:
        FlashingIconComponent__Set_39029432((FlashingIconComponent_o *)this, (bool)itemDraw, 0LL);
        return;
      }
    }
LABEL_17:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B65F37 & 1) == 0 )
  {
    sub_1BE4ACC(&CharaGraphCommandCodeListViewItem_TypeInfo, itemDraw);
    sub_1BE4ACC(&UnityEngine_Object_TypeInfo, v6);
    sub_1BE4ACC(&StringLiteral_20421/*"icon_equip"*/, v7);
    this = (CharaGraphListViewItemDrawPatternDefault_o *)sub_1BE4ACC(&StringLiteral_20422/*"icon_equip_cc"*/, v8);
    byte_4B65F37 = 1;
  }
  if ( !itemDraw )
    goto LABEL_15;
  ...
  if ( ((unsigned __int8)this & 1) == 0 )
  {
    ...
    if ( item->fields._IsUse_k__BackingField )
    {
      ...
      v12 = &StringLiteral_20421/*"icon_equip"*/;
      ...
      {
        v12 = &StringLiteral_20422/*"icon_equip_cc"*/;
      }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B65F38 & 1) == 0 )
  {
    sub_1BE4ACC(&LocalizationManager_TypeInfo, itemDraw);
    sub_1BE4ACC(&StringLiteral_11666/*"SELECT_CANNOT"*/, v7);
    sub_1BE4ACC(&StringLiteral_11690/*"SELECT_SERVANT_EVENT_JOIN"*/, v8);
    this = (CharaGraphListViewItemDrawPatternDefault_o *)sub_1BE4ACC(&StringLiteral_1/*""*/, v9);
    byte_4B65F38 = 1;
  }
  if ( !itemDraw )
    goto LABEL_18;
