        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB96A3 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMasterData_TreasureDvcLvMaster___, *(_QWORD *)&treasureDvcId);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BAB41C(&Method_DataManager_GetMasterData_TreasureDvcLvMaster___, *(_QWORD *)&treasureDvcId);
    sub_1BAB41C(&Method_DataManager_GetMasterData_TreasureDvcMaster___, v7);
