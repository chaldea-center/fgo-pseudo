        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCB556 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataManager_GetMasterData_TreasureDvcLvMaster___, *(_QWORD *)&treasureDvcId);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C1ABD4(&Method_DataManager_GetMasterData_TreasureDvcLvMaster___, *(_QWORD *)&treasureDvcId);
    sub_1C1ABD4(&Method_DataManager_GetMasterData_TreasureDvcMaster___, v7);
