        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C012B7 & 1) == 0 )
  {
    sub_1C2E12C(&Method_DataManager_GetMasterData_TreasureDvcLvMaster___, *(_QWORD *)&treasureDvcId);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C2E12C(&Method_DataManager_GetMasterData_TreasureDvcLvMaster___, *(_QWORD *)&treasureDvcId);
    sub_1C2E12C(&Method_DataManager_GetMasterData_TreasureDvcMaster___, v7);
