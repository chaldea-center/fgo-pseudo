        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A640 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_DataManager_GetMasterData_TreasureDvcLvMaster___, *(_QWORD *)&treasureDvcId);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BE4ACC(&Method_DataManager_GetMasterData_TreasureDvcLvMaster___, *(_QWORD *)&treasureDvcId);
    sub_1BE4ACC(&Method_DataManager_GetMasterData_TreasureDvcMaster___, v7);
