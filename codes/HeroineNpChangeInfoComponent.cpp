        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BEA2A & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataManager_GetMasterData_TreasureDvcLvMaster___, *(_QWORD *)&treasureDvcId);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B4CF90(&Method_DataManager_GetMasterData_TreasureDvcLvMaster___, *(_QWORD *)&treasureDvcId);
    sub_1B4CF90(&Method_DataManager_GetMasterData_TreasureDvcMaster___, v7);
