        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3ABA8 & 1) == 0 )
  {
    sub_1BD3458(&Method_DataManager_GetMasterData_TreasureDvcLvMaster___, *(_QWORD *)&treasureDvcId);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BD3458(&Method_DataManager_GetMasterData_TreasureDvcLvMaster___, *(_QWORD *)&treasureDvcId);
    sub_1BD3458(&Method_DataManager_GetMasterData_TreasureDvcMaster___, v7);
