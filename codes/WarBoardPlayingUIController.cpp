...
void WarBoardPlayingUIController__Awake(WarBoardPlayingUIController_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E75369 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_6877/*"Fonts/FGO-NumberFont-02"*/);
    byte_4E75369 = 1;
  }
  object = UnityEngine_Resources__Load_object_(
             (System_String_o *)StringLiteral_6877/*"Fonts/FGO-NumberFont-02"*/,
  ...
  if ( (nextTurnObject & 1) != 0 )
  {
    ...
    if ( !byte_4E70B79 )
    {
      nextTurnObject = sub_1D0F0B4(&UnityEngine_Vector2_TypeInfo);
      byte_4E70B79 = 1;
    }
    if ( !Child )
LABEL_39:
      sub_1D0F30C(nextTurnObject, v5);
    v33.fields.z = 0.0;
...
void WarBoardPlayingUIController__CallbackRetireButton(WarBoardPlayingUIController_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E75377 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    sub_1D0F0B4(&Method_WarBoardPlayingUIController___c__CallbackRetireButton_b__40_0__);
    sub_1D0F0B4(&WarBoardPlayingUIController___c_TypeInfo);
    byte_4E75377 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3BAC684 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  ...
  if ( !_9__40_0 )
  {
    ...
    _9__40_0 = (System_Action_o *)sub_1D0F300(System_Action_TypeInfo);
...
void WarBoardPlayingUIController__CallbackSuspendButton(WarBoardPlayingUIController_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E75375 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_NetworkManager_getRequest_WarBoardResumeRequest___);
    sub_1D0F0B4(&NetworkManager_TypeInfo);
    sub_1D0F0B4(&NetworkManager_ResultCallbackFunc_TypeInfo);
    sub_1D0F0B4(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    sub_1D0F0B4(&Method_WarBoardPlayingUIController_SuspendResponse__);
    byte_4E75375 = 1;
  }
  ...
  Request_object = NetworkManager__getRequest_object_(
                     v3,
                     (const MethodInfo_32DC000 *)Method_NetworkManager_getRequest_WarBoardResumeRequest___);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3BAC684 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
...
void WarBoardPlayingUIController__NondispTurn(WarBoardPlayingUIController_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1D0F30C(playerTurnRoot, method);
  }
...
void WarBoardPlayingUIController__OnClickNextTurn(WarBoardPlayingUIController_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E7536E & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    sub_1D0F0B4(&Method_WarBoardPlayingUIController___c__DisplayClass26_0__OnClickNextTurn_b__0__);
    sub_1D0F0B4(&WarBoardPlayingUIController___c__DisplayClass26_0_TypeInfo);
    sub_1D0F0B4(&Method_WarBoardPlayingUIController_OnClickNextTurn__);
    byte_4E7536E = 1;
  }
  v2 = sub_1D0F300(WarBoardPlayingUIController___c__DisplayClass26_0_TypeInfo);
  ...
  *(_QWORD *)(v2 + 16) = Instance;
  ...
  sub_1D0F058((GrandQuestFolderBoardItem_o *)(v2 + 16), (int32_t)Instance, v5, v6, v7, v8, v9, v10);
  ...
  if ( (*((_BYTE *)Method_WarBoardPlayingUIController_OnClickNextTurn__ + 83) & 2) != 0 )
    v13 = (_QWORD *)sub_1D0F0CC(Method_WarBoardPlayingUIController_OnClickNextTurn__);
  v15 = (System_Reflection_MethodBase_o *)sub_1D0F098(v13, v13[4]);
  if ( v14 )
  {
    OverwriteAssetSoundName__PlaySystemSe(v15, 0, 0, 0);
    v16 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3BAC684 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    v17 = (System_Action_bool__o *)sub_1D0F300(System_Action_bool__TypeInfo);
...
void WarBoardPlayingUIController__OnClickReturnButton(WarBoardPlayingUIController_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1D0F0B4(&System_Action_TypeInfo);
    sub_1D0F0B4(&Method_UnityEngine_GameObject_GetComponent_WarBoardBackMenuComponent___);
    sub_1D0F0B4(&Method_UnityEngine_Object_Instantiate_GameObject___);
    sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    sub_1D0F0B4(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    sub_1D0F0B4(&Method_WarBoardPlayingUIController_CallbackBackButton__);
    sub_1D0F0B4(&Method_WarBoardPlayingUIController_CallbackRetireButton__);
    sub_1D0F0B4(&Method_WarBoardPlayingUIController_CallbackSuspendButton__);
    sub_1D0F0B4(&Method_WarBoardPlayingUIController_OnClickReturnButton__);
    byte_4E75374 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_WarBoardPlayingUIController_OnClickReturnButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1D0F0CC(Method_WarBoardPlayingUIController_OnClickReturnButton__);
  ...
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0);
  GameObjectExtensions__SafeSetParent_37349004((UnityEngine_GameObject_o *)v8, gameObject, 0);
  ...
  if ( !v8
    || (Instance = UnityEngine_GameObject__GetComponent_object_(
                     ...
                     (const MethodInfo_32A8444 *)Method_UnityEngine_GameObject_GetComponent_WarBoardBackMenuComponent___)) == 0 )
  {
LABEL_12:
    sub_1D0F30C(Instance, v6);
  }
...
void WarBoardPlayingUIController__OnClickTreasureButton(WarBoardPlayingUIController_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1D0F0B4(&System_Action_TypeInfo);
    sub_1D0F0B4(&Method_UnityEngine_GameObject_GetComponent_WarBoardTreasureListComponent___);
    sub_1D0F0B4(&Method_UnityEngine_Object_Instantiate_GameObject___);
    sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    sub_1D0F0B4(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    sub_1D0F0B4(&Method_WarBoardPlayingUIController_CallbackBackButton__);
    sub_1D0F0B4(&Method_WarBoardPlayingUIController_OnClickTreasureButton__);
    byte_4E75373 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3BAC684 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  ...
  if ( (*((_BYTE *)Method_WarBoardPlayingUIController_OnClickTreasureButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1D0F0CC(Method_WarBoardPlayingUIController_OnClickTreasureButton__);
  ...
  v10 = UnityEngine_Object__Instantiate_object_(
          ...
          (const MethodInfo_32DD2D0 *)Method_UnityEngine_Object_Instantiate_GameObject___);
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0);
  GameObjectExtensions__SafeSetParent_37349004((UnityEngine_GameObject_o *)v10, gameObject, 0);
  GameObjectExtensions__ResetLocalScale((UnityEngine_GameObject_o *)v10, 0);
  if ( !v10
    || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                             (UnityEngine_GameObject_o *)v10,
                             (const MethodInfo_32A8444 *)Method_UnityEngine_GameObject_GetComponent_WarBoardTreasureListComponent___)) == 0
...
void WarBoardPlayingUIController__OnDestroy(WarBoardPlayingUIController_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(v4, 0, 0) )
  {
    ...
    sub_1D0F058(p_nextTurnButtonBlink, 0, v7, v8, v9, v10, v11, v12);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7536C & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    sub_1D0F0B4(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    sub_1D0F0B4(&StringLiteral_15614/*"WARBOARD_PARTY_ORGANIZATION_COST_SPLIT"*/);
    sub_1D0F0B4(&StringLiteral_1/*""*/);
    sub_1D0F0B4(&StringLiteral_15613/*"WARBOARD_PARTY_ORGANIZATION_COST_OVER_COLOR"*/);
    byte_4E7536C = 1;
  }
  ...
  if ( !this
    || (WarBoardPlayingUIController__SetBlinkNextTurnButton(this, v6, v7),
        (Instance = (WarBoardManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3BAC684 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__)) == 0) )
  {
LABEL_43:
    sub_1D0F30C(Instance, v6);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(splitAPLabel, 0, 0) )
  {
    ...
    Instance = (WarBoardManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_15614/*"WARBOARD_PARTY_ORGANIZATION_COST_SPLIT"*/, 0);
    if ( !v9 )
      goto LABEL_43;
  ...
  if ( UnityEngine_Object__op_Inequality(currentAPLabel, 0, 0) )
  {
    ...
    if ( Instance )
    {
      ...
      else
      {
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        v14 = LocalizationManager__Get((System_String_o *)StringLiteral_15613/*"WARBOARD_PARTY_ORGANIZATION_COST_OVER_COLOR"*/, 0);
      }
      v15 = System_Int32__ToString((int32_t)&v17, 0);
      Instance = (WarBoardManager_o *)System_String__Concat_65562772(v14, v15, 0);
      if ( v13 )
      {
...
void WarBoardPlayingUIController__SetNPCTurn(WarBoardPlayingUIController_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(nextTurnButton, 0, 0) )
  {
    ...
    sub_1D0F058((GrandQuestFolderBoardItem_o *)&v5->fields.tweenTargets, 0, v6, v7, v8, v9, v10, v11);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7536F & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&LocalizationManager_TypeInfo);
    sub_1D0F0B4(&StringLiteral_15638/*"WARBOARD_TURN_BASE"*/);
    byte_4E7536F = 1;
  }
  playerTurnRoot = this->fields.playerTurnRoot;
  if ( !playerTurnRoot )
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v8 = LocalizationManager__Get((System_String_o *)StringLiteral_15638/*"WARBOARD_TURN_BASE"*/, 0);
  v11 = turnCount;
  ...
  {
LABEL_10:
    sub_1D0F30C(playerTurnRoot, isPlayer);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !System_String__op_Equality(response, (System_String_o *)StringLiteral_22648/*"ng"*/, 0) )
  {
...
void WarBoardPlayingUIController__Update(WarBoardPlayingUIController_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E75372 & 1) == 0 )
  {
    sub_1D0F0B4(&int_TypeInfo);
    sub_1D0F0B4(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    sub_1D0F0B4(&StringLiteral_20567/*"icon_drop_item_{0:00}"*/);
    byte_4E75372 = 1;
  }
  ...
  if ( !getTreasureLabel
    ...
    || (getTreasureIcon = this->fields.getTreasureIcon,
        ...
        Instance = (WarBoardData_o *)System_String__Format((System_String_o *)StringLiteral_20567/*"icon_drop_item_{0:00}"*/, v9, 0),
        !getTreasureIcon) )
  {
LABEL_11:
    sub_1D0F30C(Instance, v4);
...
void WarBoardPlayingUIController___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1D0F300(WarBoardPlayingUIController___c_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7537C & 1) == 0 )
  {
    sub_1D0F0B4(&System_Action_TypeInfo);
    sub_1D0F0B4(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    sub_1D0F0B4(&Method_WarBoardPlayingUIController___c__DisplayClass26_1__OnClickNextTurn_b__1__);
    sub_1D0F0B4(&WarBoardPlayingUIController___c__DisplayClass26_1_TypeInfo);
    byte_4E7537C = 1;
  }
  v5 = sub_1D0F300(WarBoardPlayingUIController___c__DisplayClass26_1_TypeInfo);
