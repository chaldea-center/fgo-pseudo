System_String_o *__fastcall TopGameDataRequest__getMockData(TopGameDataRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E3FC2 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_9006/*"MockTopGameDataRequest"*/, v2);
    byte_48E3FC2 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  return NetworkManager__getMockFile((System_String_o *)StringLiteral_9006/*"MockTopGameDataRequest"*/, 0LL);
}
...
System_String_o *__fastcall TopGameDataRequest__getMockURL(TopGameDataRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B00CCC(&NetworkManager_TypeInfo, method);
    sub_1B00CCC(&StringLiteral_9007/*"MockTopGameDataRequest.txt"*/, v2);
    byte_48E3FC3 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  ...
  return System_String__Concat_60325748(
           ...
           (System_String_o *)StringLiteral_9007/*"MockTopGameDataRequest.txt"*/,
           0LL);
}
...
System_String_o *__fastcall TopGameDataRequest__getURL(TopGameDataRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B00CCC(&NetworkManager_TypeInfo, method);
    sub_1B00CCC(&StringLiteral_19434/*"gamedata/top"*/, v2);
    byte_48E3FC1 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_60325748(BaseUrl, (System_String_o *)StringLiteral_19434/*"gamedata/top"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  System_Collections_Generic_Dictionary_string__object__o *Dictionary_36947652; // x0
  ...
  if ( (byte_48E3FC4 & 1) == 0 )
  {
    sub_1B00CCC(&CatAndMouseGame_TypeInfo, responseList);
    ...
    sub_1B00CCC(&StringLiteral_22804/*"serverHash"*/, v12);
    sub_1B00CCC(&StringLiteral_18236/*"dateVer"*/, v13);
    sub_1B00CCC(&StringLiteral_21923/*"ok"*/, v14);
    sub_1B00CCC(&StringLiteral_18221/*"dataVer"*/, v15);
    sub_1B00CCC(&StringLiteral_16704/*"assetbundleKey"*/, v16);
    sub_1B00CCC(&StringLiteral_21007/*"master"*/, v17);
    sub_1B00CCC(&StringLiteral_21754/*"ng"*/, v18);
    sub_1B00CCC(&StringLiteral_16702/*"assetbundle"*/, v19);
    sub_1B00CCC(&StringLiteral_24311/*"webview"*/, v20);
    sub_1B00CCC(&StringLiteral_16548/*"animalName"*/, v21);
    sub_1B00CCC(&StringLiteral_19233/*"folderName"*/, v22);
    sub_1B00CCC(&StringLiteral_24546/*"zooName"*/, v23);
    sub_1B00CCC(&StringLiteral_1207/*"0"*/, v24);
    byte_48E3FC4 = 1;
  }
    ...
    if ( ResponseData__checkError(v27, v27->fields.resCode, v28) )
    {
      ...
      if ( success )
      {
        if ( System_Collections_Generic_Dictionary_object__object___ContainsKey(
               success,
               (Il2CppObject *)StringLiteral_18221/*"dataVer"*/,
               (const MethodInfo_308DC3C *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
        {
          ...
          v34 = (System_String_o *)StringLiteral_1207/*"0"*/;
          if ( System_Collections_Generic_Dictionary_object__object___ContainsKey(
                 success,
                 (Il2CppObject *)StringLiteral_18236/*"dateVer"*/,
                 (const MethodInfo_308DC3C *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
          {
            Item = System_Collections_Generic_Dictionary_object__object___get_Item(
                     success,
        ...
        if ( System_Collections_Generic_Dictionary_object__object___ContainsKey(
               success,
               (Il2CppObject *)StringLiteral_16702/*"assetbundle"*/,
               (const MethodInfo_308DC3C *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
        {
          Item = System_Collections_Generic_Dictionary_object__object___get_Item(
                   success,
          ...
          Dictionary_36947652 = JsonManager__getDictionary_36947652(v40, 0LL);
          if ( Dictionary_36947652 )
          {
            v42 = (System_Collections_Generic_Dictionary_object__object__o *)Dictionary_36947652;
            if ( System_Collections_Generic_Dictionary_object__object___ContainsKey(
                   (System_Collections_Generic_Dictionary_object__object__o *)Dictionary_36947652,
                   (Il2CppObject *)StringLiteral_19233/*"folderName"*/,
                   (const MethodInfo_308DC3C *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
            {
              Item = System_Collections_Generic_Dictionary_object__object___get_Item(
                       v42,
            ...
            if ( System_Collections_Generic_Dictionary_object__object___ContainsKey(
                   v42,
                   (Il2CppObject *)StringLiteral_16548/*"animalName"*/,
                   (const MethodInfo_308DC3C *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
            {
              Item = System_Collections_Generic_Dictionary_object__object___get_Item(
                       v42,
            ...
            if ( System_Collections_Generic_Dictionary_object__object___ContainsKey(
                   v42,
                   (Il2CppObject *)StringLiteral_24546/*"zooName"*/,
                   (const MethodInfo_308DC3C *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
            {
              Item = System_Collections_Generic_Dictionary_object__object___get_Item(
                       v42,
        ...
        if ( System_Collections_Generic_Dictionary_object__object___ContainsKey(
               success,
               (Il2CppObject *)StringLiteral_16704/*"assetbundleKey"*/,
               (const MethodInfo_308DC3C *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
        {
          Item = System_Collections_Generic_Dictionary_object__object___get_Item(
                   success,
        ...
        if ( System_Collections_Generic_Dictionary_object__object___ContainsKey(
               success,
               (Il2CppObject *)StringLiteral_24311/*"webview"*/,
               (const MethodInfo_308DC3C *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
        {
          v49 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_35FBBF0 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
          Item = System_Collections_Generic_Dictionary_object__object___get_Item(
                   success,
                   (Il2CppObject *)StringLiteral_24311/*"webview"*/,
                   (const MethodInfo_308D9C8 *)Method_System_Collections_Generic_Dictionary_string__object__get_Item__);
        ...
        if ( !System_Collections_Generic_Dictionary_object__object___ContainsKey(
                success,
                (Il2CppObject *)StringLiteral_22804/*"serverHash"*/,
                (const MethodInfo_308DC3C *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
          goto LABEL_4;
        v50 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_35FBBF0 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
        Item = System_Collections_Generic_Dictionary_object__object___get_Item(
                 success,
                 (Il2CppObject *)StringLiteral_22804/*"serverHash"*/,
                 (const MethodInfo_308D9C8 *)Method_System_Collections_Generic_Dictionary_string__object__get_Item__);
