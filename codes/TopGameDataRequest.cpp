System_String_o *__fastcall TopGameDataRequest__getMockData(TopGameDataRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FFE46 & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_9069/*"MockTopGameDataRequest"*/, v2);
    byte_49FFE46 = 1;
  }
...
System_String_o *__fastcall TopGameDataRequest__getMockURL(TopGameDataRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B64870(&NetworkManager_TypeInfo, method);
    sub_1B64870(&StringLiteral_9070/*"MockTopGameDataRequest.txt"*/, v2);
    byte_49FFE47 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
...
System_String_o *__fastcall TopGameDataRequest__getURL(TopGameDataRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B64870(&NetworkManager_TypeInfo, method);
    sub_1B64870(&StringLiteral_19629/*"gamedata/top"*/, v2);
    byte_49FFE45 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61383576(BaseUrl, (System_String_o *)StringLiteral_19629/*"gamedata/top"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  System_Collections_Generic_Dictionary_string__object__o *Dictionary_37846680; // x0
  ...
  if ( (byte_49FFE48 & 1) == 0 )
  {
    sub_1B64870(&CatAndMouseGame_TypeInfo, responseList);
    ...
    sub_1B64870(&ResponseCommandKind_TypeInfo, v10);
    sub_1B64870(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v11);
    sub_1B64870(&StringLiteral_23033/*"serverHash"*/, v12);
    sub_1B64870(&StringLiteral_18416/*"dateVer"*/, v13);
    sub_1B64870(&StringLiteral_22140/*"ok"*/, v14);
    sub_1B64870(&StringLiteral_18401/*"dataVer"*/, v15);
    sub_1B64870(&StringLiteral_16871/*"assetbundleKey"*/, v16);
    sub_1B64870(&StringLiteral_21211/*"master"*/, v17);
    sub_1B64870(&StringLiteral_21971/*"ng"*/, v18);
    sub_1B64870(&StringLiteral_16869/*"assetbundle"*/, v19);
    sub_1B64870(&StringLiteral_24580/*"webview"*/, v20);
    sub_1B64870(&StringLiteral_16715/*"animalName"*/, v21);
    sub_1B64870(&StringLiteral_19418/*"folderName"*/, v22);
    sub_1B64870(&StringLiteral_24815/*"zooName"*/, v23);
    sub_1B64870(&StringLiteral_1213/*"0"*/, v24);
    byte_49FFE48 = 1;
  }
    ...
    if ( ResponseData__checkError(v27, v27->fields.resCode, v28) )
    {
      ...
      if ( success )
      {
        if ( System_Collections_Generic_Dictionary_object__object___ContainsKey(
               success,
               (Il2CppObject *)StringLiteral_18401/*"dataVer"*/,
               (const MethodInfo_317B8C8 *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
        {
          ...
          if ( System_Collections_Generic_Dictionary_object__object___ContainsKey(
                 success,
                 (Il2CppObject *)StringLiteral_18416/*"dateVer"*/,
                 (const MethodInfo_317B8C8 *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
          {
            Item = System_Collections_Generic_Dictionary_object__object___get_Item(
                     success,
        ...
        if ( System_Collections_Generic_Dictionary_object__object___ContainsKey(
               success,
               (Il2CppObject *)StringLiteral_16869/*"assetbundle"*/,
               (const MethodInfo_317B8C8 *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
        {
          Item = System_Collections_Generic_Dictionary_object__object___get_Item(
                   success,
          ...
          Dictionary_37846680 = JsonManager__getDictionary_37846680(v40, 0LL);
          if ( Dictionary_37846680 )
          {
            v42 = (System_Collections_Generic_Dictionary_object__object__o *)Dictionary_37846680;
            if ( System_Collections_Generic_Dictionary_object__object___ContainsKey(
                   (System_Collections_Generic_Dictionary_object__object__o *)Dictionary_37846680,
            ...
            if ( System_Collections_Generic_Dictionary_object__object___ContainsKey(
                   v42,
                   (Il2CppObject *)StringLiteral_16715/*"animalName"*/,
                   (const MethodInfo_317B8C8 *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
            {
              Item = System_Collections_Generic_Dictionary_object__object___get_Item(
                       v42,
        ...
        if ( System_Collections_Generic_Dictionary_object__object___ContainsKey(
               success,
               (Il2CppObject *)StringLiteral_16871/*"assetbundleKey"*/,
               (const MethodInfo_317B8C8 *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
        {
          Item = System_Collections_Generic_Dictionary_object__object___get_Item(
                   success,
        ...
        if ( !System_Collections_Generic_Dictionary_object__object___ContainsKey(
                ...
                (const MethodInfo_317B8C8 *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
          goto LABEL_4;
        v50 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE318 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
        Item = System_Collections_Generic_Dictionary_object__object___get_Item(
                 success,
                 (Il2CppObject *)StringLiteral_23033/*"serverHash"*/,
                 (const MethodInfo_317B654 *)Method_System_Collections_Generic_Dictionary_string__object__get_Item__);
