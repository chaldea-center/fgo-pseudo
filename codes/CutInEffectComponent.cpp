        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F2CC & 1) == 0 )
  {
    sub_1B761C0(&UnityEngine_Object_TypeInfo, *(_QWORD *)&functionIndex);
    byte_4A2F2CC = 1;
  }
  ...
  if ( voiceStrs )
  {
    ...
    if ( max_length > idx )
    {
      if ( max_length > (unsigned int)idx )
      {
        ...
        {
          CommonEffectComponent__PlayVoice_40462984((CommonEffectComponent_o *)this, v8->m_Items[idx], 0LL, v7);
          return;
        }
      }
      sub_1B76424(this, *(_QWORD *)&idx);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.voiceStrs, (int32_t)voiceStrs, (int32_t)method, v3);
}