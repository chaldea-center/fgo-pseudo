        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3ACB & 1) == 0 )
  {
    sub_1B00CCC(&UnityEngine_Object_TypeInfo, *(_QWORD *)&functionIndex);
    byte_48E3ACB = 1;
  }
  ...
  if ( voiceStrs )
  {
    ...
    if ( max_length > idx )
    {
      if ( max_length > (unsigned int)idx )
      {
        ...
        {
          CommonEffectComponent__PlayVoice_39357164((CommonEffectComponent_o *)this, v8->m_Items[idx], 0LL, v7);
          return;
        }
      }
      sub_1B00F30(this, *(_QWORD *)&idx);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.voiceStrs, (int32_t)voiceStrs, (int32_t)method, v3);
}