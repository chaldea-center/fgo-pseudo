        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20E58 & 1) == 0 )
  {
    sub_1B715CC(&UnityEngine_Object_TypeInfo, *(_QWORD *)&functionIndex);
    byte_4A20E58 = 1;
  }
  ...
  if ( voiceStrs )
  {
    ...
    if ( max_length > idx )
    {
      if ( max_length > (unsigned int)idx )
      {
        ...
        {
          CommonEffectComponent__PlayVoice_40435552((CommonEffectComponent_o *)this, v8->m_Items[idx], 0LL, v7);
          return;
        }
      }
      sub_1B71830(this, *(_QWORD *)&idx);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.voiceStrs, (int32_t)voiceStrs, (int32_t)method, v3);
}