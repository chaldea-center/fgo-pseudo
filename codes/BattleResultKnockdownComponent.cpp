void __fastcall BattleResultKnockdownComponent___ctor(BattleResultKnockdownComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B69FFD & 1) == 0 )
  {
    sub_1BE4ACC(&UnityEngine_Color___TypeInfo, method);
    byte_4B69FFD = 1;
  }
  v3 = sub_1BE4B74(UnityEngine_Color___TypeInfo, 2LL);
  if ( !v3 )
    goto LABEL_11;
  v11 = *(_DWORD *)(v3 + 24);
  v12 = v3;
...
LABEL_10:
  ...
  *(_OWORD *)(v3 + 48) = _Q0;
  ...
  v25 = _Q0;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.battleColor, v3, v5, v6, v7, v8, v9, v10);
  v3 = sub_1BE4B74(UnityEngine_Color___TypeInfo, 2LL);
  if ( !v3 )
LABEL_11:
    sub_1BE4D28(v3, v4);
  ...
  *(_OWORD *)(v3 + 32) = v25;
  if ( v24 == 1 )
    goto LABEL_10;
  *(_OWORD *)(v3 + 48) = xmmword_BE28A0;
  this->fields.recordColor = (struct UnityEngine_Color_array *)v3;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.recordColor, v3, v18, v19, v20, v21, v22, v23);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69FFC & 1) == 0 )
  {
    sub_1BE4ACC(&LocalizationManager_TypeInfo, labelArray);
    sub_1BE4ACC(&StringLiteral_2942/*"BATTLE_KNOCKDOWN_COUNT_NAME"*/, v11);
    this = (BattleResultKnockdownComponent_o *)sub_1BE4ACC(&StringLiteral_423/*"#,#"*/, v12);
    byte_4B69FFC = 1;
  }
  if ( !v10 )
    goto LABEL_28;
  ...
  if ( info->fields.knockdownNum <= 0 )
    ...
    v14 = System_Int64__ToString_63509592((int64_t)p_fields, (System_String_o *)StringLiteral_423/*"#,#"*/, 0LL);
  ...
  this = (BattleResultKnockdownComponent_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2942/*"BATTLE_KNOCKDOWN_COUNT_NAME"*/, 0LL);
  if ( !v16 )
    goto LABEL_28;
  ...
  if ( totalDamage <= 0 )
    ...
    v14 = System_Int64__ToString_63509592((int64_t)p_totalDamage, (System_String_o *)StringLiteral_423/*"#,#"*/, 0LL);
  labelArray = (UILabel_array *)v14;
  if ( v10->max_length <= 2 )
    goto LABEL_29;
