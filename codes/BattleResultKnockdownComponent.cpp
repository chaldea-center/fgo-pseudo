void __fastcall BattleResultKnockdownComponent___ctor(BattleResultKnockdownComponent_o *this, const MethodInfo *method)
{
  ...
  v3 = sub_1C21EE0(UnityEngine_Color___TypeInfo, 2LL);
  if ( !v3 )
    goto LABEL_11;
  v11 = *(_DWORD *)(v3 + 24);
  v12 = v3;
...
LABEL_10:
  ...
  *(_OWORD *)(v3 + 48) = _Q0;
  ...
  v25 = _Q0;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.battleColor, v3, v5, v6, v7, v8, v9, v10);
  v3 = sub_1C21EE0(UnityEngine_Color___TypeInfo, 2LL);
  if ( !v3 )
LABEL_11:
    sub_1C22094(v3, v4);
  ...
  *(_OWORD *)(v3 + 32) = v25;
  if ( v24 == 1 )
    goto LABEL_10;
  *(_OWORD *)(v3 + 48) = xmmword_BFEC80;
  this->fields.recordColor = (struct UnityEngine_Color_array *)v3;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.recordColor, v3, v18, v19, v20, v21, v22, v23);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDF9C7 & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_2955/*"BATTLE_KNOCKDOWN_COUNT_NAME"*/);
    this = (BattleResultKnockdownComponent_o *)sub_1C21E38(&StringLiteral_425/*"#,#"*/);
    byte_4BDF9C7 = 1;
  }
  if ( !v10 )
    goto LABEL_28;
  ...
  if ( info->fields.knockdownNum <= 0 )
    ...
    v12 = System_Int64__ToString_63926260((int64_t)p_fields, (System_String_o *)StringLiteral_425/*"#,#"*/, 0LL);
  ...
  this = (BattleResultKnockdownComponent_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2955/*"BATTLE_KNOCKDOWN_COUNT_NAME"*/, 0LL);
  if ( !v14 )
    goto LABEL_28;
  ...
  if ( totalDamage <= 0 )
    ...
    v12 = System_Int64__ToString_63926260((int64_t)p_totalDamage, (System_String_o *)StringLiteral_425/*"#,#"*/, 0LL);
  labelArray = (UILabel_array *)v12;
  if ( v10->max_length <= 2 )
    goto LABEL_29;
...
LABEL_22:
  if ( max_length >= 1 )
  {
    ...
    while ( (unsigned int)v17 < max_length )
    {
      ...
      v18.fields.b = b;
      v18.fields.a = a;
      UIWidget__set_color((UIWidget_o *)this, v18, 0LL);
      max_length = v10->max_length;
      if ( (int)++v17 >= max_length )
        return;
    }
LABEL_29:
    sub_1C2209C(v12, labelArray);
  }
}