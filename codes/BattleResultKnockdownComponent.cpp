void BattleResultKnockdownComponent___ctor(BattleResultKnockdownComponent_o *this, const MethodInfo *method)
{
  ...
  v3 = sub_1C71458(UnityEngine_Color___TypeInfo, 2);
  if ( !v3 )
    goto LABEL_11;
  v11 = *(_DWORD *)(v3 + 24);
  if ( !v11 )
...
LABEL_10:
  ...
  *(_OWORD *)(v3 + 48) = _Q0;
  ...
  v24 = _Q0;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.battleColor, v3, v5, v6, v7, v8, v9, v10);
  v3 = sub_1C71458(UnityEngine_Color___TypeInfo, 2);
  if ( !v3 )
LABEL_11:
    sub_1C71608(v3, v4);
  ...
  *(_OWORD *)(v3 + 32) = v24;
  if ( v23 == 1 )
    goto LABEL_10;
  *(_OWORD *)(v3 + 48) = xmmword_CEFAE0;
  this->fields.recordColor = (struct UnityEngine_Color_array *)v3;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.recordColor, v3, v17, v18, v19, v20, v21, v22);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CCAD98 & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_2792/*"BATTLE_KNOCKDOWN_COUNT_NAME"*/);
    this = (BattleResultKnockdownComponent_o *)sub_1C713B0(&StringLiteral_395/*"#,#"*/);
    byte_4CCAD98 = 1;
  }
  if ( !v10 )
    goto LABEL_28;
  ...
  if ( info->fields.knockdownNum <= 0 )
    ...
    v12 = System_Int64__ToString_65545396((int64_t)p_fields, (System_String_o *)StringLiteral_395/*"#,#"*/, 0);
  ...
  this = (BattleResultKnockdownComponent_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2792/*"BATTLE_KNOCKDOWN_COUNT_NAME"*/, 0);
  if ( !v14 )
    goto LABEL_28;
  ...
  if ( totalDamage <= 0 )
    ...
    v12 = System_Int64__ToString_65545396((int64_t)p_totalDamage, (System_String_o *)StringLiteral_395/*"#,#"*/, 0);
  labelArray = (UILabel_array *)v12;
