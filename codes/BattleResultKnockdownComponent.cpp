void BattleResultKnockdownComponent___ctor(BattleResultKnockdownComponent_o *this, const MethodInfo *method)
{
  ...
  v3 = sub_1C32CC8(UnityEngine_Color___TypeInfo, 2);
  if ( !v3 )
    goto LABEL_11;
  v6 = *(_DWORD *)(v3 + 24);
  if ( !v6 )
...
LABEL_10:
  ...
  *(_OWORD *)(v3 + 48) = _Q0;
  ...
  v15 = _Q0;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.battleColor, v3, v4, v5);
  v3 = sub_1C32CC8(UnityEngine_Color___TypeInfo, 2);
  if ( !v3 )
LABEL_11:
    sub_1C32E7C(v3);
  ...
  *(_OWORD *)(v3 + 32) = v15;
  if ( v14 == 1 )
    goto LABEL_10;
  *(_OWORD *)(v3 + 48) = xmmword_C0D5F0;
  this->fields.recordColor = (struct UnityEngine_Color_array *)v3;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.recordColor, v3, v12, v13);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3B26B & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_2798/*"BATTLE_KNOCKDOWN_COUNT_NAME"*/);
    this = (BattleResultKnockdownComponent_o *)sub_1C32C20(&StringLiteral_396/*"#,#"*/);
    byte_4C3B26B = 1;
  }
  if ( !labelArray )
    goto LABEL_28;
  ...
  if ( info->fields.knockdownNum <= 0 )
    ...
    v12 = System_Int64__ToString_65033828((int64_t)p_fields, (System_String_o *)StringLiteral_396/*"#,#"*/, 0);
  v13 = v12;
  ...
  if ( totalDamage <= 0 )
    ...
    v12 = System_Int64__ToString_65033828((int64_t)p_totalDamage, (System_String_o *)StringLiteral_396/*"#,#"*/, 0);
  v18 = v12;
