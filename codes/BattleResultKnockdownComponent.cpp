void __fastcall BattleResultKnockdownComponent___ctor(BattleResultKnockdownComponent_o *this, const MethodInfo *method)
{
  ...
  v3 = sub_1B6877C(UnityEngine_Color___TypeInfo, 2LL);
  if ( !v3 )
    goto LABEL_11;
  v7 = *(_DWORD *)(v3 + 24);
  v8 = v3;
...
LABEL_10:
  ...
  *(_OWORD *)(v3 + 48) = _Q0;
  ...
  v17 = _Q0;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.battleColor, v3, v5, v6);
  v3 = sub_1B6877C(UnityEngine_Color___TypeInfo, 2LL);
  if ( !v3 )
LABEL_11:
    sub_1B68930(v3, v4);
  ...
  *(_OWORD *)(v3 + 32) = v17;
  if ( v16 == 1 )
    goto LABEL_10;
  *(_OWORD *)(v3 + 48) = xmmword_BA6E00;
  this->fields.recordColor = (struct UnityEngine_Color_array *)v3;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.recordColor, v3, v14, v15);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0BE24 & 1) == 0 )
  {
    sub_1B686D4(&LocalizationManager_TypeInfo, labelArray);
    sub_1B686D4(&StringLiteral_2893/*"BATTLE_KNOCKDOWN_COUNT_NAME"*/, v11);
    this = (BattleResultKnockdownComponent_o *)sub_1B686D4(&StringLiteral_428/*"#,#"*/, v12);
    byte_4A0BE24 = 1;
  }
  if ( !v10 )
    goto LABEL_28;
  ...
  if ( info->fields.knockdownNum <= 0 )
    ...
    v14 = System_Int64__ToString_62229924((int64_t)p_fields, (System_String_o *)StringLiteral_428/*"#,#"*/, 0LL);
  ...
  this = (BattleResultKnockdownComponent_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2893/*"BATTLE_KNOCKDOWN_COUNT_NAME"*/, 0LL);
  if ( !v16 )
    goto LABEL_28;
  ...
  if ( totalDamage <= 0 )
    ...
    v14 = System_Int64__ToString_62229924((int64_t)p_totalDamage, (System_String_o *)StringLiteral_428/*"#,#"*/, 0LL);
  labelArray = (UILabel_array *)v14;
  if ( v10->max_length <= 2 )
    goto LABEL_29;
