void __fastcall BattleResultKnockdownComponent___ctor(BattleResultKnockdownComponent_o *this, const MethodInfo *method)
{
  ...
  v3 = sub_1C13DCC(UnityEngine_Color___TypeInfo, 2LL);
  if ( !v3 )
    goto LABEL_11;
  v11 = *(_DWORD *)(v3 + 24);
  v12 = v3;
...
LABEL_10:
  ...
  *(_OWORD *)(v3 + 48) = _Q0;
  ...
  v25 = _Q0;
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.battleColor, v3, v5, v6, v7, v8, v9, v10);
  v3 = sub_1C13DCC(UnityEngine_Color___TypeInfo, 2LL);
  if ( !v3 )
LABEL_11:
    sub_1C13F80(v3, v4);
  ...
  *(_OWORD *)(v3 + 32) = v25;
  if ( v24 == 1 )
    goto LABEL_10;
  *(_OWORD *)(v3 + 48) = xmmword_BF70C0;
  this->fields.recordColor = (struct UnityEngine_Color_array *)v3;
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.recordColor, v3, v18, v19, v20, v21, v22, v23);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB7B1F & 1) == 0 )
  {
    sub_1C13D24(&LocalizationManager_TypeInfo, labelArray);
    sub_1C13D24(&StringLiteral_2945/*"BATTLE_ITEM_DISP_COLUMN"*/, v11);
    this = (BattleResultKnockdownComponent_o *)sub_1C13D24(&StringLiteral_425/*"#,#"*/, v12);
    byte_4BB7B1F = 1;
  }
  if ( !v10 )
    goto LABEL_28;
  ...
  if ( info->fields.knockdownNum <= 0 )
    ...
    v14 = System_Int64__ToString_63778728((int64_t)p_fields, (System_String_o *)StringLiteral_425/*"#,#"*/, 0LL);
  ...
  this = (BattleResultKnockdownComponent_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2945/*"BATTLE_ITEM_DISP_COLUMN"*/, 0LL);
  if ( !v16 )
    goto LABEL_28;
  ...
  if ( totalDamage <= 0 )
    ...
    v14 = System_Int64__ToString_63778728((int64_t)p_totalDamage, (System_String_o *)StringLiteral_425/*"#,#"*/, 0LL);
  labelArray = (UILabel_array *)v14;
  if ( v10->max_length <= 2 )
    goto LABEL_29;
