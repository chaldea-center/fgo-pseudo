        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FEFEC & 1) == 0 )
  {
    sub_1B64870(&Method_DataManager_GetMaster_UserEventCooltimeRewardMaster___, *(_QWORD *)&eventId);
    sub_1B64870(&DataManager_TypeInfo, v8);
    byte_49FEFEC = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (UserEventCooltimeRewardMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2E3B674 *)Method_DataManager_GetMaster_UserEventCooltimeRewardMaster___);
  if ( !Master_object )
    goto LABEL_11;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FEFEA & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_5505/*"EVENT_AREA_IMPROVE_CONFIRM_DIALOG_CONSUME_ITEM_TITLE"*/, v3);
    sub_1B64870(&StringLiteral_5509/*"EVENT_AREA_IMPROVE_DECIDE_BUTTON"*/, v4);
    sub_1B64870(&StringLiteral_3732/*"COMMON_CONFIRM_CANCEL"*/, v5);
    sub_1B64870(&StringLiteral_5504/*"EVENT_AREA_IMPROVE_CONFIRM_DIALOG_CAUTION"*/, v6);
    sub_1B64870(&StringLiteral_5506/*"EVENT_AREA_IMPROVE_CONFIRM_DIALOG_MESSAGE"*/, v7);
    sub_1B64870(&StringLiteral_1/*""*/, v8);
    sub_1B64870(&StringLiteral_5507/*"EVENT_AREA_IMPROVE_CONFIRM_DIALOG_SUBTITLE"*/, v9);
    byte_49FEFEA = 1;
  }
  ...
  titleLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3732/*"COMMON_CONFIRM_CANCEL"*/, 0LL);
  if ( !cancelLabel )
    goto LABEL_13;
  ...
  {
LABEL_13:
    sub_1B64ACC(titleLabel, v10);
  }
  UILabel__set_text(consumeItemTitle, (System_String_o *)titleLabel, 0LL);
  this->fields.callback = 0LL;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.callback, 0, v18, v19);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FEFEE & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_EventInfoAreaImproveConfirmDialog_OnClickCancelButton__, v3);
    sub_1B64870(&Method_EventInfoAreaImproveConfirmDialog__OnClickCancelButton_b__17_0__, v4);
    byte_49FEFEE = 1;
  }
  if ( !this->fields.isClose )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoAreaImproveConfirmDialog_OnClickCancelButton__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B64888(Method_EventInfoAreaImproveConfirmDialog_OnClickCancelButton__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B64870(&System_Action_TypeInfo, method);
    sub_1B64870(&Method_EventInfoAreaImproveConfirmDialog_OnClickDecideButton__, v5);
    sub_1B64870(&Method_EventInfoAreaImproveConfirmDialog__OnClickDecideButton_b__16_0__, v6);
  ...
  if ( !this->fields.isClose )
  {
    ...
    sub_1B64814(p_eventAreaImproveResultInfo, (int32_t)tempAreaImproveResultInfo, v2, v3);
    ...
    if ( (*((_BYTE *)Method_EventInfoAreaImproveConfirmDialog_OnClickDecideButton__ + 83) & 2) != 0 )
      v11 = (_QWORD *)sub_1B64888(Method_EventInfoAreaImproveConfirmDialog_OnClickDecideButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FEFEB & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_DataManager_GetMaster_EventCooltimeRewardMaster___, v9);
    sub_1B64870(&Method_DataManager_GetMaster_QuestMaster___, v10);
    sub_1B64870(&DataManager_TypeInfo, v11);
    sub_1B64870(&Method_DataMasterBase_QuestMaster__QuestEntity__int__GetEntity__, v12);
    sub_1B64870(&EventAreaImproveResultInfo_TypeInfo, v13);
    sub_1B64870(&LocalizationManager_TypeInfo, v14);
    sub_1B64870(&Method_EventInfoAreaImproveConfirmDialog___c__DisplayClass14_0__Open_b__0__, v15);
    sub_1B64870(&EventInfoAreaImproveConfirmDialog___c__DisplayClass14_0_TypeInfo, v16);
    sub_1B64870(&StringLiteral_5508/*"EVENT_AREA_IMPROVE_CONFIRM_DIALOG_TITLE"*/, v17);
    byte_49FEFEB = 1;
  }
  v18 = sub_1B64ABC(EventInfoAreaImproveConfirmDialog___c__DisplayClass14_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v18, 0LL);
  if ( !v18 )
    goto LABEL_16;
  *(_QWORD *)(v18 + 16) = callback;
  v23 = (struct CommonConfirmDialog_ClickDelegate_o **)(v18 + 16);
  sub_1B64814((ServantStatusBattleListViewItem_o *)(v18 + 16), (int32_t)callback, v21, v22);
  ...
  if ( AvailableMaxLevelEntity )
  {
    ...
    CurrentSpotLevel = EventInfoAreaImproveConfirmDialog__GetCurrentSpotLevel(
                         ...
                         v29);
    v32 = (EventAreaImproveResultInfo_o *)sub_1B64ABC(EventAreaImproveResultInfo_TypeInfo);
    EventAreaImproveResultInfo___ctor(v32, eventId, v27, CurrentSpotLevel, 0LL);
    this->fields.tempAreaImproveResultInfo = v32;
    sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.tempAreaImproveResultInfo, (int32_t)v32, v33, v34);
    BaseDialog__Open((BaseDialog_o *)this, 0LL, 0, 0LL);
    titleLabel = this->fields.titleLabel;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v36 = LocalizationManager__Get((System_String_o *)StringLiteral_5508/*"EVENT_AREA_IMPROVE_CONFIRM_DIALOG_TITLE"*/, 0LL);
    ...
    if ( titleLabel )
    {
      ...
      if ( questDialogIconImageComponent )
      {
        ...
        sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.callback, (int32_t)v38, v39, v40);
        return;
      }
    }
LABEL_16:
