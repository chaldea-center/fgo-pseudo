void __fastcall ParticleDisconnector___ctor(ParticleDisconnector_o *this, const MethodInfo *method)
{
  if ( (byte_42ADC0E & 1) == 0 )
  {
    sub_B52984(&UnityEngine_ParticleSystem___TypeInfo);
    byte_42ADC0E = 1;
  }
  this->fields.particles = (struct UnityEngine_ParticleSystem_array *)sub_B5299C(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42ADC11 & 1) == 0 )
  {
    globalParent = (UnityEngine_Transform_o *)sub_B52984(&Method_UnityEngine_GameObject_AddComponent_ParticleDisconnector___);
    byte_42ADC11 = 1;
  }
  if ( !v4
    ...
    || (globalParent = (UnityEngine_Transform_o *)UnityEngine_GameObject__AddComponent_UnitySynchronizationContext_SynchronizationContextBehavoir_(
                                                    ...
                                                    (const MethodInfo_1B7B0BC *)Method_UnityEngine_GameObject_AddComponent_ParticleDisconnector___)) == 0LL )
  {
    sub_B52A5C(globalParent, obj);
  }
  v6 = globalParent;
...
void __fastcall ParticleDisconnector__HideAll(ParticleDisconnector_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42ADC10 & 1) == 0 )
  {
    sub_B52984(&Method_System_Action_ParticleSystem___ctor__);
    sub_B52984(&System_Action_ParticleSystem__TypeInfo);
    sub_B52984(&Method_BasicHelper_ExcludeNull_ParticleSystem___);
    sub_B52984(&Method_BasicHelper_ForEach_ParticleSystem___);
    sub_B52984(&Method_ParticleDisconnector___c__HideAll_b__3_0__);
    sub_B52984(&ParticleDisconnector___c_TypeInfo);
    byte_42ADC10 = 1;
  }
  if ( !BasicHelper__IsNullOrEmpty((System_Collections_ICollection_o *)this->fields.particles, 0LL) )
  {
    v3 = BasicHelper__ExcludeNull_BlankEarthSpotAnimStateManager_SpotStateData_(
           ...
           (const MethodInfo_1A42004 *)Method_BasicHelper_ExcludeNull_ParticleSystem___);
    ...
    if ( !_9__3_0 )
    {
      ...
      _9__3_0 = (System_Action_DrawLotsDisplayMessage_DisplayedInGroup_SaveData__o *)sub_B52A54(System_Action_ParticleSystem__TypeInfo);
      System_Action_DrawLotsDisplayMessage_DisplayedInGroup_SaveData____ctor(
        _9__3_0,
        v7,
        Method_ParticleDisconnector___c__HideAll_b__3_0__,
        (const MethodInfo_2627780 *)Method_System_Action_ParticleSystem___ctor__);
      v8 = ParticleDisconnector___c_TypeInfo->static_fields;
      v8->__9__3_0 = (struct System_Action_ParticleSystem__o *)_9__3_0;
      sub_B52920(&v8->__9__3_0);
    }
    BasicHelper__ForEach_DrawLotsDisplayMessage_DisplayedInGroup_SaveData_(
      v3,
      (System_Action_T__o *)_9__3_0,
      (const MethodInfo_1A43210 *)Method_BasicHelper_ForEach_ParticleSystem___);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42ADC0F & 1) == 0 )
  {
    this = (ParticleDisconnector_o *)sub_B52984(&Method_UnityEngine_Component_GetComponentsInChildren_ParticleSystem____68597888);
    byte_42ADC0F = 1;
  }
  m_ParticleSystem = 0LL;
  if ( !obj )
    goto LABEL_16;
  v4[1].klass = (UnityEngine_Component_c *)UnityEngine_Component__GetComponentsInChildren_WarBoardControlPlayTalkUiComponent_(
  ...
  if ( namespaze >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      v8 = &klass->_1.image + (int)v7;
      v9 = (UnityEngine_Component_o *)v8[4];
      if ( !v9 )
        break;
      this = (ParticleDisconnector_o *)UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)v8[4], 0LL);
      if ( !this )
        break;
      if ( !UnityEngine_GameObject__get_activeInHierarchy((UnityEngine_GameObject_o *)this, 0LL) )
      {
        this = (ParticleDisconnector_o *)UnityEngine_Component__get_gameObject(v9, 0LL);
        if ( !this )
          break;
      ...
      UnityEngine_ParticleSystem_MainModule__set_cullingMode(v13, 3, 0LL);
      ...
      UnityEngine_ParticleSystem__Stop_51150288((UnityEngine_ParticleSystem_o *)v9, 0LL);
      namespaze = (int)klass->_1.namespaze;
      if ( (int)++v7 >= namespaze )
        return;
    }
...
void __fastcall ParticleDisconnector__OnDestroy(ParticleDisconnector_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42ADC13 & 1) == 0 )
  {
    this = (ParticleDisconnector_o *)sub_B52984(&UnityEngine_Object_TypeInfo);
    byte_42ADC13 = 1;
  }
...
LABEL_30:
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        if ( !v6 )
          goto LABEL_31;
        UnityEngine_ParticleSystem__Stop_51150288((UnityEngine_ParticleSystem_o *)v6, 0LL);
      }
...
LABEL_26:
    ...
    UnityEngine_Object__Destroy_35616956(v2, 0LL);
  }
}
...
void __fastcall ParticleDisconnector___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_B52A54(ParticleDisconnector___c_TypeInfo);
  System_Object___ctor(v1, 0LL);
  static_fields = ParticleDisconnector___c_TypeInfo->static_fields;
  static_fields->__9 = (struct ParticleDisconnector___c_o *)v1;
