void __fastcall ParticleDisconnector___ctor(ParticleDisconnector_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B660B7 & 1) == 0 )
  {
    sub_1BE4ACC(&UnityEngine_ParticleSystem___TypeInfo, method);
    byte_4B660B7 = 1;
  }
  v3 = (struct UnityEngine_ParticleSystem_array *)sub_1BE4B74(UnityEngine_ParticleSystem___TypeInfo, 0LL);
  this->fields.particles = v3;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.particles, (int64_t)v3, v4, v5, v6, v7, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B660BA & 1) == 0 )
  {
    globalParent = (UnityEngine_Transform_o *)sub_1BE4ACC(
  ...
  if ( !v4
    ...
    || (globalParent = (UnityEngine_Transform_o *)UnityEngine_GameObject__AddComponent_object_(
                                                    ...
                                                    (const MethodInfo_2FA96B4 *)Method_UnityEngine_GameObject_AddComponent_ParticleDisconnector___)) == 0LL )
  {
    sub_1BE4D28(globalParent, obj);
  }
...
void __fastcall ParticleDisconnector__HideAll(ParticleDisconnector_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B660B9 & 1) == 0 )
  {
    sub_1BE4ACC(&System_Action_ParticleSystem__TypeInfo, method);
    sub_1BE4ACC(&Method_BasicHelper_ExcludeNull_ParticleSystem___, v3);
    sub_1BE4ACC(&Method_BasicHelper_ForEach_ParticleSystem___, v4);
    sub_1BE4ACC(&Method_ParticleDisconnector___c__HideAll_b__3_0__, v5);
    sub_1BE4ACC(&ParticleDisconnector___c_TypeInfo, v6);
    byte_4B660B9 = 1;
  }
  if ( !BasicHelper__IsNullOrEmpty((System_Collections_ICollection_o *)this->fields.particles, 0LL) )
  {
    v7 = BasicHelper__ExcludeNull_object_(
           ...
           (const MethodInfo_2F449D0 *)Method_BasicHelper_ExcludeNull_ParticleSystem___);
    ...
    if ( !_9__3_0 )
    {
      ...
      _9__3_0 = (System_Action_object__o *)sub_1BE4D18(System_Action_ParticleSystem__TypeInfo);
    ...
    BasicHelper__ForEach_object_(
      ...
      (const MethodInfo_2F4606C *)Method_BasicHelper_ForEach_ParticleSystem___);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B660B8 & 1) == 0 )
  {
    this = (ParticleDisconnector_o *)sub_1BE4ACC(
                                       &Method_UnityEngine_Component_GetComponentsInChildren_ParticleSystem____77181000,
                                       obj);
    byte_4B660B8 = 1;
  }
  ...
  ComponentsInChildren_object = UnityEngine_Component__GetComponentsInChildren_object_(
                                  ...
                                  1,
                                  (const MethodInfo_2F506A0 *)Method_UnityEngine_Component_GetComponentsInChildren_ParticleSystem____77181000);
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      UnityEngine_ParticleSystem__Stop_70732448((UnityEngine_ParticleSystem_o *)v16, 0LL);
      max_length = particles->max_length;
...
void __fastcall ParticleDisconnector__OnDestroy(ParticleDisconnector_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B660BC & 1) == 0 )
  {
    this = (ParticleDisconnector_o *)sub_1BE4ACC(&UnityEngine_Object_TypeInfo, method);
    byte_4B660BC = 1;
  }
...
LABEL_27:
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        if ( !v6 )
          goto LABEL_28;
        UnityEngine_ParticleSystem__Stop_70732448((UnityEngine_ParticleSystem_o *)v6, 0LL);
      }
...
LABEL_31:
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    UnityEngine_Object__Destroy_70452000(v2, 0LL);
  }
}
...
void __fastcall ParticleDisconnector___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B660BD & 1) == 0 )
  {
    sub_1BE4ACC(&ParticleDisconnector___c_TypeInfo, v1);
    byte_4B660BD = 1;
  }
  v2 = (Il2CppObject *)sub_1BE4D18(ParticleDisconnector___c_TypeInfo);
