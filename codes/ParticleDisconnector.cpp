void __fastcall ParticleDisconnector___ctor(ParticleDisconnector_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1B9C6 & 1) == 0 )
  {
    sub_1BCAFF8(&UnityEngine_ParticleSystem___TypeInfo, method);
    byte_4B1B9C6 = 1;
  }
  v3 = (struct UnityEngine_ParticleSystem_array *)sub_1BCB0A0(UnityEngine_ParticleSystem___TypeInfo, 0LL);
  this->fields.particles = v3;
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.particles, (int32_t)v3, v4, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B9C9 & 1) == 0 )
  {
    globalParent = (UnityEngine_Transform_o *)sub_1BCAFF8(
  ...
  if ( !v4
    ...
    || (globalParent = (UnityEngine_Transform_o *)UnityEngine_GameObject__AddComponent_object_(
                                                    ...
                                                    (const MethodInfo_306E628 *)Method_UnityEngine_GameObject_AddComponent_ParticleDisconnector___)) == 0LL )
  {
    sub_1BCB254(globalParent, obj);
  }
...
void __fastcall ParticleDisconnector__HideAll(ParticleDisconnector_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1B9C8 & 1) == 0 )
  {
    sub_1BCAFF8(&System_Action_ParticleSystem__TypeInfo, method);
    sub_1BCAFF8(&Method_BasicHelper_ExcludeNull_ParticleSystem___, v3);
    sub_1BCAFF8(&Method_BasicHelper_ForEach_ParticleSystem___, v4);
    sub_1BCAFF8(&Method_ParticleDisconnector___c__HideAll_b__3_0__, v5);
    sub_1BCAFF8(&ParticleDisconnector___c_TypeInfo, v6);
    byte_4B1B9C8 = 1;
  }
  if ( !BasicHelper__IsNullOrEmpty((System_Collections_ICollection_o *)this->fields.particles, 0LL) )
  {
    ...
    if ( !_9__3_0 )
    {
      ...
      _9__3_0 = (System_Action_object__o *)sub_1BCB244(System_Action_ParticleSystem__TypeInfo);
    ...
    BasicHelper__ForEach_object_(
      ...
      (const MethodInfo_3006B3C *)Method_BasicHelper_ForEach_ParticleSystem___);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B9C7 & 1) == 0 )
  {
    this = (ParticleDisconnector_o *)sub_1BCAFF8(
                                       &Method_UnityEngine_Component_GetComponentsInChildren_ParticleSystem____76937488,
                                       obj);
    byte_4B1B9C7 = 1;
  }
  ...
  ComponentsInChildren_object = UnityEngine_Component__GetComponentsInChildren_object_(
                                  ...
                                  1,
                                  (const MethodInfo_3011F98 *)Method_UnityEngine_Component_GetComponentsInChildren_ParticleSystem____76937488);
  v4->fields.particles = (struct UnityEngine_ParticleSystem_array *)ComponentsInChildren_object;
  sub_1BCAF9C((CGThumbnailListItem_o *)&v4->fields.particles, (int32_t)ComponentsInChildren_object, v6, v7);
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      UnityEngine_ParticleSystem__Stop_70419836((UnityEngine_ParticleSystem_o *)v13, 0LL);
      max_length = particles->max_length;
...
void __fastcall ParticleDisconnector__OnDestroy(ParticleDisconnector_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1B9CB & 1) == 0 )
  {
    this = (ParticleDisconnector_o *)sub_1BCAFF8(&UnityEngine_Object_TypeInfo, method);
    byte_4B1B9CB = 1;
  }
...
LABEL_27:
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        if ( !v7 )
          goto LABEL_28;
        UnityEngine_ParticleSystem__Stop_70419836((UnityEngine_ParticleSystem_o *)v7, 0LL);
      }
...
LABEL_31:
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    UnityEngine_Object__Destroy_70136076(v3, 0LL);
  }
}
...
void __fastcall ParticleDisconnector___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B1B9CC & 1) == 0 )
  {
    sub_1BCAFF8(&ParticleDisconnector___c_TypeInfo, v1);
    byte_4B1B9CC = 1;
  }
  v2 = (Il2CppObject *)sub_1BCB244(ParticleDisconnector___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  ParticleDisconnector___c_TypeInfo->static_fields->__9 = (struct ParticleDisconnector___c_o *)v2;
  sub_1BCAF9C((CGThumbnailListItem_o *)ParticleDisconnector___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
