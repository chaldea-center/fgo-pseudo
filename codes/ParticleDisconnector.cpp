void ParticleDisconnector___ctor(ParticleDisconnector_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C36E43 & 1) == 0 )
  {
    sub_1C32C20(&UnityEngine_ParticleSystem___TypeInfo);
    byte_4C36E43 = 1;
  }
  v3 = (struct UnityEngine_ParticleSystem_array *)sub_1C32CC8(UnityEngine_ParticleSystem___TypeInfo, 0);
  this->fields.particles = v3;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.particles, (int32_t)v3, v4, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C36E46 & 1) == 0 )
  {
    globalParent = (UnityEngine_Transform_o *)sub_1C32C20(&Method_UnityEngine_GameObject_AddComponent_ParticleDisconnector___);
    byte_4C36E46 = 1;
  }
  if ( !v4
    ...
    || (globalParent = (UnityEngine_Transform_o *)UnityEngine_GameObject__AddComponent_object_(
                                                    ...
                                                    (const MethodInfo_3134888 *)Method_UnityEngine_GameObject_AddComponent_ParticleDisconnector___)) == 0 )
  {
    sub_1C32E7C(globalParent);
  }
...
void ParticleDisconnector__HideAll(ParticleDisconnector_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C36E45 & 1) == 0 )
  {
    sub_1C32C20(&System_Action_ParticleSystem__TypeInfo);
    sub_1C32C20(&Method_BasicHelper_ExcludeNull_ParticleSystem___);
    sub_1C32C20(&Method_BasicHelper_ForEach_ParticleSystem___);
    sub_1C32C20(&Method_ParticleDisconnector___c__HideAll_b__3_0__);
    sub_1C32C20(&ParticleDisconnector___c_TypeInfo);
    byte_4C36E45 = 1;
  }
  if ( !BasicHelper__IsNullOrEmpty((System_Collections_ICollection_o *)this->fields.particles, 0) )
  {
    ...
    if ( !_9__3_0 )
    {
      ...
      _9__3_0 = (System_Action_object__o *)sub_1C32E6C(System_Action_ParticleSystem__TypeInfo);
    ...
    BasicHelper__ForEach_object_(
      ...
      (const MethodInfo_30C93B0 *)Method_BasicHelper_ForEach_ParticleSystem___);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C36E44 & 1) == 0 )
  {
    this = (ParticleDisconnector_o *)sub_1C32C20(&Method_UnityEngine_Component_GetComponentsInChildren_ParticleSystem____78081880);
    byte_4C36E44 = 1;
  }
  m_ParticleSystem = 0;
  if ( !obj )
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&v4->fields.particles, (int32_t)ComponentsInChildren_object, v6, v7);
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      UnityEngine_ParticleSystem__Stop_71507400((UnityEngine_ParticleSystem_o *)v12, 0);
      max_length = particles->max_length;
...
void ParticleDisconnector__OnDestroy(ParticleDisconnector_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C36E48 & 1) == 0 )
  {
    this = (ParticleDisconnector_o *)sub_1C32C20(&UnityEngine_Object_TypeInfo);
    byte_4C36E48 = 1;
  }
...
LABEL_27:
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        if ( !v6 )
          goto LABEL_28;
        UnityEngine_ParticleSystem__Stop_71507400((UnityEngine_ParticleSystem_o *)v6, 0);
      }
...
void ParticleDisconnector___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C32E6C(ParticleDisconnector___c_TypeInfo);
  System_Object___ctor(v1, 0);
  ParticleDisconnector___c_TypeInfo->static_fields->__9 = (struct ParticleDisconnector___c_o *)v1;
  sub_1C32BC4((CGThumbnailListItem_o *)ParticleDisconnector___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
