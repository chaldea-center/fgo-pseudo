void __fastcall ParticleDisconnector___ctor(ParticleDisconnector_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5A699 & 1) == 0 )
  {
    sub_1B885B0(&UnityEngine_ParticleSystem___TypeInfo);
    byte_4A5A699 = 1;
  }
  v3 = (struct UnityEngine_ParticleSystem_array *)sub_1B88658(UnityEngine_ParticleSystem___TypeInfo, 0LL);
  this->fields.particles = v3;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.particles, (int32_t)v3, v4, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A69C & 1) == 0 )
  {
    globalParent = (UnityEngine_Transform_o *)sub_1B885B0(&Method_UnityEngine_GameObject_AddComponent_ParticleDisconnector___);
    byte_4A5A69C = 1;
  }
  if ( !v4
    ...
    || (globalParent = (UnityEngine_Transform_o *)UnityEngine_GameObject__AddComponent_object_(
                                                    ...
                                                    (const MethodInfo_2ECEDD0 *)Method_UnityEngine_GameObject_AddComponent_ParticleDisconnector___)) == 0LL )
  {
    sub_1B8880C(globalParent, obj);
  }
...
void __fastcall ParticleDisconnector__HideAll(ParticleDisconnector_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5A69B & 1) == 0 )
  {
    sub_1B885B0(&System_Action_ParticleSystem__TypeInfo);
    sub_1B885B0(&Method_BasicHelper_ExcludeNull_ParticleSystem___);
    sub_1B885B0(&Method_BasicHelper_ForEach_ParticleSystem___);
    sub_1B885B0(&Method_ParticleDisconnector___c__HideAll_b__3_0__);
    sub_1B885B0(&ParticleDisconnector___c_TypeInfo);
    byte_4A5A69B = 1;
  }
  if ( !BasicHelper__IsNullOrEmpty((System_Collections_ICollection_o *)this->fields.particles, 0LL) )
  {
    ...
    if ( !_9__3_0 )
    {
      ...
      _9__3_0 = (System_Action_object__o *)sub_1B887FC(System_Action_ParticleSystem__TypeInfo);
    ...
    BasicHelper__ForEach_object_(
      ...
      (const MethodInfo_2E6CCC0 *)Method_BasicHelper_ForEach_ParticleSystem___);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A69A & 1) == 0 )
  {
    this = (ParticleDisconnector_o *)sub_1B885B0(&Method_UnityEngine_Component_GetComponentsInChildren_ParticleSystem____76107576);
    byte_4A5A69A = 1;
  }
  ...
  ComponentsInChildren_object = UnityEngine_Component__GetComponentsInChildren_object_(
                                  ...
                                  1,
                                  (const MethodInfo_2E76E98 *)Method_UnityEngine_Component_GetComponentsInChildren_ParticleSystem____76107576);
  v4->fields.particles = (struct UnityEngine_ParticleSystem_array *)ComponentsInChildren_object;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v4->fields.particles, (int32_t)ComponentsInChildren_object, v6, v7);
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      UnityEngine_ParticleSystem__Stop_69739868((UnityEngine_ParticleSystem_o *)v12, 0LL);
      max_length = particles->max_length;
...
void __fastcall ParticleDisconnector__OnDestroy(ParticleDisconnector_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5A69E & 1) == 0 )
  {
    this = (ParticleDisconnector_o *)sub_1B885B0(&UnityEngine_Object_TypeInfo);
    byte_4A5A69E = 1;
  }
...
LABEL_27:
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        if ( !v6 )
          goto LABEL_28;
        UnityEngine_ParticleSystem__Stop_69739868((UnityEngine_ParticleSystem_o *)v6, 0LL);
      }
...
LABEL_31:
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    UnityEngine_Object__Destroy_69459380(v2, 0LL);
  }
}
...
void __fastcall ParticleDisconnector___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1B887FC(ParticleDisconnector___c_TypeInfo);
