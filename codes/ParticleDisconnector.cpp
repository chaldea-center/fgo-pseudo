void ParticleDisconnector___ctor(ParticleDisconnector_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E76BC0 & 1) == 0 )
  {
    sub_1D0F0B4(&UnityEngine_ParticleSystem___TypeInfo);
    byte_4E76BC0 = 1;
  }
  v3 = (struct UnityEngine_ParticleSystem_array *)sub_1D0F15C(UnityEngine_ParticleSystem___TypeInfo, 0);
  this->fields.particles = v3;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.particles, (int32_t)v3, v4, v5, v6, v7, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E76BC3 & 1) == 0 )
  {
    globalParent = (UnityEngine_Transform_o *)sub_1D0F0B4(&Method_UnityEngine_GameObject_AddComponent_ParticleDisconnector___);
    byte_4E76BC3 = 1;
  }
  if ( !v4
    ...
    || (globalParent = (UnityEngine_Transform_o *)UnityEngine_GameObject__AddComponent_object_(
                                                    ...
                                                    (const MethodInfo_32A835C *)Method_UnityEngine_GameObject_AddComponent_ParticleDisconnector___)) == 0 )
  {
    sub_1D0F30C(globalParent, obj);
  }
...
void ParticleDisconnector__HideAll(ParticleDisconnector_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E76BC2 & 1) == 0 )
  {
    sub_1D0F0B4(&System_Action_ParticleSystem__TypeInfo);
    sub_1D0F0B4(&Method_BasicHelper_ExcludeNull_ParticleSystem___);
    sub_1D0F0B4(&Method_BasicHelper_ForEach_ParticleSystem___);
    sub_1D0F0B4(&Method_ParticleDisconnector___c__HideAll_b__3_0__);
    sub_1D0F0B4(&ParticleDisconnector___c_TypeInfo);
    byte_4E76BC2 = 1;
  }
  if ( !BasicHelper__IsNullOrEmpty((System_Collections_ICollection_o *)this->fields.particles, 0) )
  {
    v3 = BasicHelper__ExcludeNull_object_(
           ...
           (const MethodInfo_3238C40 *)Method_BasicHelper_ExcludeNull_ParticleSystem___);
    ...
    if ( !_9__3_0 )
    {
      ...
      _9__3_0 = (System_Action_object__o *)sub_1D0F300(System_Action_ParticleSystem__TypeInfo);
    ...
    BasicHelper__ForEach_object_(
      ...
      (const MethodInfo_323AF0C *)Method_BasicHelper_ForEach_ParticleSystem___);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E76BC1 & 1) == 0 )
  {
    this = (ParticleDisconnector_o *)sub_1D0F0B4(&Method_UnityEngine_Component_GetComponentsInChildren_ParticleSystem____80392936);
    byte_4E76BC1 = 1;
  }
  m_ParticleSystem = 0;
  if ( !obj )
  ...
  ComponentsInChildren_object = UnityEngine_Component__GetComponentsInChildren_object_(
                                  ...
                                  1,
                                  (const MethodInfo_32466AC *)Method_UnityEngine_Component_GetComponentsInChildren_ParticleSystem____80392936);
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      UnityEngine_ParticleSystem__Stop_73645592((UnityEngine_ParticleSystem_o *)v16, 0);
      max_length = particles->max_length;
...
void ParticleDisconnector__OnDestroy(ParticleDisconnector_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E76BC5 & 1) == 0 )
  {
    this = (ParticleDisconnector_o *)sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    byte_4E76BC5 = 1;
  }
...
LABEL_27:
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        if ( !v6 )
          goto LABEL_28;
        UnityEngine_ParticleSystem__Stop_73645592((UnityEngine_ParticleSystem_o *)v6, 0);
      }
...
void ParticleDisconnector___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1D0F300(ParticleDisconnector___c_TypeInfo);
