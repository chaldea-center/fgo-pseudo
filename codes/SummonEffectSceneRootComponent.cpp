...
void SummonEffectSceneRootComponent__beginStartUp(SummonEffectSceneRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2E09B & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_12413/*"START_EFFECT"*/);
    byte_4D2E09B = 1;
  }
  ...
  {
    sub_1C93D2C(summonInstance, v3);
  }
  PlayMakerFSM__SendEvent((PlayMakerFSM_o *)summonInstance, (System_String_o *)StringLiteral_12413/*"START_EFFECT"*/, 0);
}