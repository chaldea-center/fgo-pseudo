...
void SummonEffectSceneRootComponent__beginStartUp(SummonEffectSceneRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E020D8 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_12448/*"START_EFFECT"*/);
    byte_4E020D8 = 1;
  }
  ...
  {
    sub_1CE6958(summonInstance, v3);
  }
  PlayMakerFSM__SendEvent((PlayMakerFSM_o *)summonInstance, (System_String_o *)StringLiteral_12448/*"START_EFFECT"*/, 0);
}