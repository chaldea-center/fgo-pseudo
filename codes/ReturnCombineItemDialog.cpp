...
void ReturnCombineItemDialog__ClearItemList(ReturnCombineItemDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D34BEE & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_ReturnCombineItemDialog___c__ClearItemList_b__9_0__);
    sub_1C93AD4(&ReturnCombineItemDialog___c_TypeInfo);
    byte_4D34BEE = 1;
  }
  ...
  if ( !_9__9_0 )
  {
    ...
    _9__9_0 = (System_Action_object__o *)sub_1C93D20(System_Action_GameObject__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D34BF1 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_ReturnCombineItemDialog_OnCloseEnd__);
    byte_4D34BF1 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !BasicHelper__IsNullOrEmpty((System_Collections_ICollection_o *)svtIds, 0) )
  {
    ...
    Entity = (__int64)DataManager__GetMaster_object_((const MethodInfo_31A49E8 *)Method_DataManager_GetMaster_UserServantMaster___);
    if ( !svtIds )
LABEL_40:
...
LABEL_23:
      ...
      Entity = (__int64)UnityEngine_Object__Instantiate_object__52629400(
                          itemIconPrefab,
                          listRoot,
      ...
      if ( !byte_4D2A139 )
      {
        Entity = sub_1C93AD4(&UnityEngine_Vector3_TypeInfo);
        byte_4D2A139 = 1;
      }
      if ( !v20 )
        goto LABEL_40;
      ...
      if ( !Entity )
        goto LABEL_40;
      v34.fields.x = this->fields.ItemIconScale;
      v34.fields.y = v34.fields.x;
      v34.fields.z = v34.fields.x;
      UnityEngine_Transform__set_localScale((UnityEngine_Transform_o *)Entity, v34, 0);
      ...
      ItemIconComponent__SetGift_41640856((ItemIconComponent_o *)Entity, v13, monitor, v16, 0, 0);
      ...
      {
        v32 = v29 + 8 * v31;
        *(_DWORD *)(Entity + 24) = v31 + 1;
        *(_QWORD *)(v32 + 32) = v19;
        sub_1C93A78((GrandQuestFolderBoardItem_o *)(v32 + 32), (int32_t)v19, v23, v24, v25, v26, v27, v28);
      }
      goto LABEL_38;
    }
  }
...
void ReturnCombineItemDialog__OnClickClose(ReturnCombineItemDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D34BF2 & 1) == 0 )
  {
    sub_1C93AD4(&Method_ReturnCombineItemDialog_OnClickClose__);
  ...
  if ( this->fields.baseState == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ReturnCombineItemDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C93AEC(Method_ReturnCombineItemDialog_OnClickClose__);
...
void ReturnCombineItemDialog__OnEnable(ReturnCombineItemDialog_o *this, const MethodInfo *method)
{
  ...
  AndroidBackKeyManager__AddBackBtn_45665756(transform, (System_String_o *)StringLiteral_3090/*"BaseWindow/CloseButton"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D34BF0 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_11225/*"RETURN_COMBINE_ITEM_DIALOG_TITLE"*/);
    sub_1C93AD4(&StringLiteral_11224/*"RETURN_COMBINE_ITEM_DIALOG_BUTTON_TEXT"*/);
    byte_4D34BF0 = 1;
  }
  ...
  v8 = LocalizationManager__Get((System_String_o *)StringLiteral_11225/*"RETURN_COMBINE_ITEM_DIALOG_TITLE"*/, 0);
  if ( !titleLabel
    || (UILabel__set_text(titleLabel, v8, 0),
        closeButtonLabel = this->fields.closeButtonLabel,
        v8 = LocalizationManager__Get((System_String_o *)StringLiteral_11224/*"RETURN_COMBINE_ITEM_DIALOG_BUTTON_TEXT"*/, 0),
        !closeButtonLabel) )
  {
    sub_1C93D2C(v8, v9);
  }
...
void ReturnCombineItemDialog___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C93D20(ReturnCombineItemDialog___c_TypeInfo);
  System_Object___ctor(v1, 0);
  ReturnCombineItemDialog___c_TypeInfo->static_fields->__9 = (struct ReturnCombineItemDialog___c_o *)v1;
  sub_1C93A78(
    (GrandQuestFolderBoardItem_o *)ReturnCombineItemDialog___c_TypeInfo->static_fields,
    (int32_t)v1,
    v2,
    v3,
    v4,
