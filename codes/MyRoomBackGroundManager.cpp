...
{
  this->fields.DISP_RECT = (struct UnityEngine_Rect_o)xmmword_BB88D0;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B90010(&Method_DataManager_GetMasterData_MyRoomAddMaster___, method);
    sub_1B90010(&int_TypeInfo, v2);
    sub_1B90010(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v3);
    sub_1B90010(&StringLiteral_3134/*"Back/back{0}"*/, v4);
    byte_4A6B312 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_374C890 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance
  ...
  return System_String__Format((System_String_o *)StringLiteral_3134/*"Back/back{0}"*/, v12, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B316 & 1) == 0 )
  {
    sub_1B90010(&MyRoomBackGroundManager__LoadBackGround_d__21_TypeInfo, callback);
    byte_4A6B316 = 1;
  }
  v5 = sub_1B9025C(MyRoomBackGroundManager__LoadBackGround_d__21_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B315 & 1) == 0 )
  {
    sub_1B90010(&MyRoomBackGroundManager__LoadBackGroundByLoadType_d__20_TypeInfo, callback);
    byte_4A6B315 = 1;
  }
  v5 = sub_1B9025C(MyRoomBackGroundManager__LoadBackGroundByLoadType_d__20_TypeInfo);
  System_Object___ctor((Il2CppObject *)v5, 0LL);
  *(_DWORD *)(v5 + 16) = 0;
  *(_QWORD *)(v5 + 32) = this;
  sub_1B8FFB4(v5 + 32);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B317 & 1) == 0 )
  {
    sub_1B90010(&MyRoomBackGroundManager__LoadBackObject_d__22_TypeInfo, callback);
    byte_4A6B317 = 1;
  }
  v5 = sub_1B9025C(MyRoomBackGroundManager__LoadBackObject_d__22_TypeInfo);
  System_Object___ctor((Il2CppObject *)v5, 0LL);
  *(_DWORD *)(v5 + 16) = 0;
  *(_QWORD *)(v5 + 32) = this;
  sub_1B8FFB4(v5 + 32);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B314 & 1) == 0 )
  {
    sub_1B90010(&Method_UnityEngine_GameObject_GetComponentsInChildren_Animation___, method);
    sub_1B90010(&Method_UnityEngine_GameObject_GetComponentsInChildren_SimpleAnimation___, v3);
  ...
  if ( backObject )
  {
    ...
    if ( ((unsigned __int8)ComponentsInChildren_object__49144716 & 1) != 0 )
    {
      ...
      if ( !v9 )
        goto LABEL_24;
      ComponentsInChildren_object__49144716 = v9->fields.instanceObject;
      ...
      ComponentsInChildren_object__49144716 = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponentsInChildren_object__49144716(
                                                                            ...
                                                                            (const MethodInfo_2EDE38C *)Method_UnityEngine_GameObject_GetComponentsInChildren_SimpleAnimation___);
      if ( !ComponentsInChildren_object__49144716 )
        goto LABEL_24;
      ...
      if ( klass >= 1 )
      {
        ...
        while ( v12 < klass )
        {
          ...
          ComponentsInChildren_object__49144716 = (UnityEngine_GameObject_o *)SimpleAnimation__Play(v14, 0LL);
          klass = (int)v11[1].klass;
          if ( (int)++v12 >= klass )
            goto LABEL_15;
        }
LABEL_25:
        sub_1B90274(ComponentsInChildren_object__49144716, v8);
      }
LABEL_15:
      v15 = this->fields.backObject;
      if ( !v15
        || (ComponentsInChildren_object__49144716 = v15->fields.instanceObject) == 0LL
        || (ComponentsInChildren_object__49144716 = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponentsInChildren_object__49144716(
                                                                                  ComponentsInChildren_object__49144716,
                                                                                  (const MethodInfo_2EDE38C *)Method_UnityEngine_GameObject_GetComponentsInChildren_Animation___)) == 0LL )
      {
LABEL_24:
        sub_1B9026C(ComponentsInChildren_object__49144716, v8);
      }
      v16 = (int)ComponentsInChildren_object__49144716[1].klass;
      v17 = ComponentsInChildren_object__49144716;
      if ( v16 >= 1 )
      {
        v18 = 0;
        while ( v18 < v16 )
        {
          ...
          ComponentsInChildren_object__49144716 = (UnityEngine_GameObject_o *)UnityEngine_Animation__Play(v20, 0LL);
          v16 = (int)v17[1].klass;
          if ( (int)++v18 >= v16 )
            return;
        }
        ...
        const MethodInfo *method)
{
  ...
  UnityEngine_MonoBehaviour__StartCoroutine_69524712((UnityEngine_MonoBehaviour_o *)this, BackGroundByLoadType, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B318 & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_9199/*"MyRoom/BackObject/{0}"*/, v5);
    byte_4A6B318 = 1;
  }
  ...
  this->fields.assetName = System_String__Format((System_String_o *)StringLiteral_9199/*"MyRoom/BackObject/{0}"*/, v9, 0LL);
  sub_1B8FFB4(&this->fields.assetName);
  this->fields.instanceObject = 0LL;
  sub_1B8FFB4(&this->fields.instanceObject);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B31C & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_MyRoomBackGroundManager___c__DisplayClass20_0__LoadBackGroundByLoadType_b__0__, v5);
    sub_1B90010(&Method_MyRoomBackGroundManager___c__DisplayClass20_0__LoadBackGroundByLoadType_b__1__, v6);
    sub_1B90010(&Method_MyRoomBackGroundManager___c__DisplayClass20_0__LoadBackGroundByLoadType_b__2__, v7);
    sub_1B90010(&MyRoomBackGroundManager___c__DisplayClass20_0_TypeInfo, v8);
    sub_1B90010(&UnityEngine_WaitWhile_TypeInfo, v9);
    byte_4A6B31C = 1;
  }
  ...
  v12 = sub_1B9025C(MyRoomBackGroundManager___c__DisplayClass20_0_TypeInfo);
  ...
  if ( (loadType & 1) != 0 )
  {
    ...
    UnityEngine_MonoBehaviour__StartCoroutine_69524712((UnityEngine_MonoBehaviour_o *)_4__this, BackGround, 0LL);
    loadType = _4__this->fields.loadType;
  }
  if ( (loadType & 2) != 0 )
  {
    ...
    UnityEngine_MonoBehaviour__StartCoroutine_69524712((UnityEngine_MonoBehaviour_o *)_4__this, BackObject, 0LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B90024(&Method_MyRoomBackGroundManager__LoadBackGroundByLoadType_d__20_System_Collections_IEnumerator_Reset__);
  sub_1B90138(v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B31B & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_MyRoomBackGroundManager___c__DisplayClass21_0__LoadBackGround_b__0__, v5);
    sub_1B90010(&Method_MyRoomBackGroundManager___c__DisplayClass21_0__LoadBackGround_b__1__, v6);
    sub_1B90010(&Method_MyRoomBackGroundManager___c__DisplayClass21_0__LoadBackGround_b__2__, v7);
    sub_1B90010(&MyRoomBackGroundManager___c__DisplayClass21_0_TypeInfo, v8);
    sub_1B90010(&UnityEngine_WaitWhile_TypeInfo, v9);
    byte_4A6B31B = 1;
  }
  _1__state = this->fields.__1__state;
  ...
  this->fields.__1__state = -1;
  _4__this = this->fields.__4__this;
  v12 = sub_1B9025C(MyRoomBackGroundManager___c__DisplayClass21_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v12, 0LL);
  if ( !v12 )
    goto LABEL_16;
  ...
  *(_BYTE *)(v12 + 16) = 1;
  ...
  System_Action___ctor(
    ...
    0LL);
  *(_QWORD *)(v12 + 40) = v15;
  backTexture = (UnityEngine_Component_o *)sub_1B8FFB4(v12 + 40);
  if ( !_4__this
...
LABEL_16:
  ...
  v19 = (System_Func_bool__o *)sub_1B9025C(System_Func_bool__TypeInfo);
  System_Func_bool____ctor(
    v19,
    (Il2CppObject *)v12,
    Method_MyRoomBackGroundManager___c__DisplayClass21_0__LoadBackGround_b__2__,
    0LL);
  v20 = (UnityEngine_WaitWhile_o *)sub_1B9025C(UnityEngine_WaitWhile_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v3 = (System_NotSupportedException_o *)sub_1B9025C(v2);
  System_NotSupportedException___ctor(v3, 0LL);
  v4 = sub_1B90024(&Method_MyRoomBackGroundManager__LoadBackGround_d__21_System_Collections_IEnumerator_Reset__);
  sub_1B90138(v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B90010(&AssetManager_TypeInfo, method);
    sub_1B90010(&MyRoomBackGroundManager_BackObject_TypeInfo, v3);
    sub_1B90010(&System_Func_bool__TypeInfo, v4);
    sub_1B90010(&AssetLoader_LoadEndDataHandler_TypeInfo, v5);
    sub_1B90010(&Method_MyRoomBackGroundManager___c__DisplayClass22_0__LoadBackObject_b__0__, v6);
    sub_1B90010(&Method_MyRoomBackGroundManager___c__DisplayClass22_0__LoadBackObject_b__1__, v7);
    sub_1B90010(&MyRoomBackGroundManager___c__DisplayClass22_0_TypeInfo, v8);
    this = (MyRoomBackGroundManager__LoadBackObject_d__22_o *)sub_1B90010(&UnityEngine_WaitWhile_TypeInfo, v9);
    byte_4A6B31D = 1;
  }
  ...
  if ( _1__state )
    return 0;
  v2->fields.__1__state = -1;
  v12 = sub_1B9025C(MyRoomBackGroundManager___c__DisplayClass22_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v12, 0LL);
  if ( !v12 )
    goto LABEL_22;
  *(_QWORD *)(v12 + 16) = v2->fields.__4__this;
  this = (MyRoomBackGroundManager__LoadBackObject_d__22_o *)sub_1B8FFB4(v12 + 16);
  *(_BYTE *)(v12 + 24) = 0;
  if ( !_4__this )
    goto LABEL_22;
  ...
  {
    v14 = BackObjectId;
    v15 = (MyRoomBackGroundManager_BackObject_o *)sub_1B9025C(MyRoomBackGroundManager_BackObject_TypeInfo);
    ...
    this = (MyRoomBackGroundManager__LoadBackObject_d__22_o *)sub_1B8FFB4(p_backObject);
    if ( !*p_backObject )
      goto LABEL_22;
    assetName = (*p_backObject)->fields.assetName;
    if ( !AssetManager_TypeInfo->_2.cctor_finished )
...
LABEL_21:
  v23 = (System_Func_bool__o *)sub_1B9025C(System_Func_bool__TypeInfo);
  System_Func_bool____ctor(
    v23,
    (Il2CppObject *)v12,
    Method_MyRoomBackGroundManager___c__DisplayClass22_0__LoadBackObject_b__1__,
    0LL);
  v24 = (UnityEngine_WaitWhile_o *)sub_1B9025C(UnityEngine_WaitWhile_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v3 = (System_NotSupportedException_o *)sub_1B9025C(v2);
  System_NotSupportedException___ctor(v3, 0LL);
  v4 = sub_1B90024(&Method_MyRoomBackGroundManager__LoadBackObject_d__22_System_Collections_IEnumerator_Reset__);
  sub_1B90138(v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B319 & 1) == 0 )
  {
    ...
    this = (MyRoomBackGroundManager___c__DisplayClass21_0_o *)sub_1B90010(&StringLiteral_3134/*"Back/back{0}"*/, v4);
    byte_4A6B319 = 1;
  }
  _4__this = v2->fields.__4__this;
  if ( !_4__this )
  ...
  v2->fields.imgName = System_String__Format((System_String_o *)StringLiteral_3134/*"Back/back{0}"*/, v10, 0LL);
  this = (MyRoomBackGroundManager___c__DisplayClass21_0_o *)sub_1B8FFB4(&v2->fields.imgName);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B31A & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_9203/*"MyRoomBackObj"*/, v7);
    byte_4A6B31A = 1;
  }
  if ( assetData )
  {
    Object_object__48695184 = AssetData__GetObject_object__48695184(
                                assetData,
                                (System_String_o *)StringLiteral_9203/*"MyRoomBackObj"*/,
...
LABEL_15:
      ...
      sub_1B8FFB4(&_4__this[1].monitor);
    }
  }
  this->fields.wait = 0;
}
