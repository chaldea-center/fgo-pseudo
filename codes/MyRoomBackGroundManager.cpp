...
{
  this->fields.DISP_RECT = (struct UnityEngine_Rect_o)xmmword_BABEF0;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B715CC(&Method_DataManager_GetMasterData_MyRoomAddMaster___, method);
    sub_1B715CC(&int_TypeInfo, v2);
    sub_1B715CC(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v3);
    sub_1B715CC(&StringLiteral_3118/*"Back/back{0}"*/, v4);
    byte_4A1AFC5 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance
  ...
  return System_String__Format((System_String_o *)StringLiteral_3118/*"Back/back{0}"*/, v12, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1AFC9 & 1) == 0 )
  {
    sub_1B715CC(&MyRoomBackGroundManager__LoadBackGround_d__21_TypeInfo, callback);
    byte_4A1AFC9 = 1;
  }
  v5 = sub_1B71818(MyRoomBackGroundManager__LoadBackGround_d__21_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1AFC8 & 1) == 0 )
  {
    sub_1B715CC(&MyRoomBackGroundManager__LoadBackGroundByLoadType_d__20_TypeInfo, callback);
    byte_4A1AFC8 = 1;
  }
  v5 = sub_1B71818(MyRoomBackGroundManager__LoadBackGroundByLoadType_d__20_TypeInfo);
  System_Object___ctor((Il2CppObject *)v5, 0LL);
  *(_DWORD *)(v5 + 16) = 0;
  *(_QWORD *)(v5 + 32) = this;
  sub_1B71570(v5 + 32);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1AFCA & 1) == 0 )
  {
    sub_1B715CC(&MyRoomBackGroundManager__LoadBackObject_d__22_TypeInfo, callback);
    byte_4A1AFCA = 1;
  }
  v5 = sub_1B71818(MyRoomBackGroundManager__LoadBackObject_d__22_TypeInfo);
  System_Object___ctor((Il2CppObject *)v5, 0LL);
  *(_DWORD *)(v5 + 16) = 0;
  *(_QWORD *)(v5 + 32) = this;
  sub_1B71570(v5 + 32);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1AFC7 & 1) == 0 )
  {
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponentsInChildren_Animation___, method);
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponentsInChildren_SimpleAnimation___, v3);
  ...
  if ( backObject )
  {
    ...
    if ( ((unsigned __int8)ComponentsInChildren_object__48936380 & 1) != 0 )
    {
      ...
      if ( !v9 )
        goto LABEL_24;
      ComponentsInChildren_object__48936380 = v9->fields.instanceObject;
      ...
      ComponentsInChildren_object__48936380 = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponentsInChildren_object__48936380(
                                                                            ...
                                                                            (const MethodInfo_2EAB5BC *)Method_UnityEngine_GameObject_GetComponentsInChildren_SimpleAnimation___);
      if ( !ComponentsInChildren_object__48936380 )
        goto LABEL_24;
      ...
      if ( klass >= 1 )
      {
        ...
        while ( v12 < klass )
        {
          ...
          ComponentsInChildren_object__48936380 = (UnityEngine_GameObject_o *)SimpleAnimation__Play(v14, 0LL);
          klass = (int)v11[1].klass;
          if ( (int)++v12 >= klass )
            goto LABEL_15;
        }
LABEL_25:
        sub_1B71830(ComponentsInChildren_object__48936380, v8);
      }
LABEL_15:
      v15 = this->fields.backObject;
      if ( !v15
        || (ComponentsInChildren_object__48936380 = v15->fields.instanceObject) == 0LL
        || (ComponentsInChildren_object__48936380 = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponentsInChildren_object__48936380(
                                                                                  ComponentsInChildren_object__48936380,
                                                                                  (const MethodInfo_2EAB5BC *)Method_UnityEngine_GameObject_GetComponentsInChildren_Animation___)) == 0LL )
      {
LABEL_24:
        sub_1B71828(ComponentsInChildren_object__48936380, v8);
      }
      v16 = (int)ComponentsInChildren_object__48936380[1].klass;
      v17 = ComponentsInChildren_object__48936380;
      if ( v16 >= 1 )
      {
        v18 = 0;
        while ( v18 < v16 )
        {
          ...
          ComponentsInChildren_object__48936380 = (UnityEngine_GameObject_o *)UnityEngine_Animation__Play(v20, 0LL);
          v16 = (int)v17[1].klass;
          if ( (int)++v18 >= v16 )
            return;
        }
        ...
        const MethodInfo *method)
{
  ...
  UnityEngine_MonoBehaviour__StartCoroutine_69243124((UnityEngine_MonoBehaviour_o *)this, BackGroundByLoadType, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1AFCB & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_9163/*"MyRoom/BackObject/{0}"*/, v5);
    byte_4A1AFCB = 1;
  }
  ...
  this->fields.assetName = System_String__Format((System_String_o *)StringLiteral_9163/*"MyRoom/BackObject/{0}"*/, v9, 0LL);
  sub_1B71570(&this->fields.assetName);
  this->fields.instanceObject = 0LL;
  sub_1B71570(&this->fields.instanceObject);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1AFCF & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_MyRoomBackGroundManager___c__DisplayClass20_0__LoadBackGroundByLoadType_b__0__, v5);
    sub_1B715CC(&Method_MyRoomBackGroundManager___c__DisplayClass20_0__LoadBackGroundByLoadType_b__1__, v6);
    sub_1B715CC(&Method_MyRoomBackGroundManager___c__DisplayClass20_0__LoadBackGroundByLoadType_b__2__, v7);
    sub_1B715CC(&MyRoomBackGroundManager___c__DisplayClass20_0_TypeInfo, v8);
    sub_1B715CC(&UnityEngine_WaitWhile_TypeInfo, v9);
    byte_4A1AFCF = 1;
  }
  ...
  v12 = sub_1B71818(MyRoomBackGroundManager___c__DisplayClass20_0_TypeInfo);
  ...
  if ( (loadType & 1) != 0 )
  {
    ...
    UnityEngine_MonoBehaviour__StartCoroutine_69243124((UnityEngine_MonoBehaviour_o *)_4__this, BackGround, 0LL);
    loadType = _4__this->fields.loadType;
  }
  if ( (loadType & 2) != 0 )
  {
    ...
    UnityEngine_MonoBehaviour__StartCoroutine_69243124((UnityEngine_MonoBehaviour_o *)_4__this, BackObject, 0LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B715E0(&Method_MyRoomBackGroundManager__LoadBackGroundByLoadType_d__20_System_Collections_IEnumerator_Reset__);
  sub_1B716F4(v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1AFCE & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_MyRoomBackGroundManager___c__DisplayClass21_0__LoadBackGround_b__0__, v5);
    sub_1B715CC(&Method_MyRoomBackGroundManager___c__DisplayClass21_0__LoadBackGround_b__1__, v6);
    sub_1B715CC(&Method_MyRoomBackGroundManager___c__DisplayClass21_0__LoadBackGround_b__2__, v7);
    sub_1B715CC(&MyRoomBackGroundManager___c__DisplayClass21_0_TypeInfo, v8);
    sub_1B715CC(&UnityEngine_WaitWhile_TypeInfo, v9);
    byte_4A1AFCE = 1;
  }
  _1__state = this->fields.__1__state;
  ...
  this->fields.__1__state = -1;
  _4__this = this->fields.__4__this;
  v12 = sub_1B71818(MyRoomBackGroundManager___c__DisplayClass21_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v12, 0LL);
  if ( !v12 )
    goto LABEL_16;
  ...
  *(_BYTE *)(v12 + 16) = 1;
  ...
  System_Action___ctor(
    ...
    0LL);
  *(_QWORD *)(v12 + 40) = v15;
  backTexture = (UnityEngine_Component_o *)sub_1B71570(v12 + 40);
  if ( !_4__this
...
LABEL_16:
  ...
  v19 = (System_Func_bool__o *)sub_1B71818(System_Func_bool__TypeInfo);
  System_Func_bool____ctor(
    v19,
    (Il2CppObject *)v12,
    Method_MyRoomBackGroundManager___c__DisplayClass21_0__LoadBackGround_b__2__,
    0LL);
  v20 = (UnityEngine_WaitWhile_o *)sub_1B71818(UnityEngine_WaitWhile_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v3 = (System_NotSupportedException_o *)sub_1B71818(v2);
  System_NotSupportedException___ctor(v3, 0LL);
  v4 = sub_1B715E0(&Method_MyRoomBackGroundManager__LoadBackGround_d__21_System_Collections_IEnumerator_Reset__);
  sub_1B716F4(v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B715CC(&AssetManager_TypeInfo, method);
    sub_1B715CC(&MyRoomBackGroundManager_BackObject_TypeInfo, v3);
    sub_1B715CC(&System_Func_bool__TypeInfo, v4);
    sub_1B715CC(&AssetLoader_LoadEndDataHandler_TypeInfo, v5);
    sub_1B715CC(&Method_MyRoomBackGroundManager___c__DisplayClass22_0__LoadBackObject_b__0__, v6);
    sub_1B715CC(&Method_MyRoomBackGroundManager___c__DisplayClass22_0__LoadBackObject_b__1__, v7);
    sub_1B715CC(&MyRoomBackGroundManager___c__DisplayClass22_0_TypeInfo, v8);
    this = (MyRoomBackGroundManager__LoadBackObject_d__22_o *)sub_1B715CC(&UnityEngine_WaitWhile_TypeInfo, v9);
    byte_4A1AFD0 = 1;
  }
  ...
  if ( _1__state )
    return 0;
  v2->fields.__1__state = -1;
  v12 = sub_1B71818(MyRoomBackGroundManager___c__DisplayClass22_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v12, 0LL);
  if ( !v12 )
    goto LABEL_22;
  *(_QWORD *)(v12 + 16) = v2->fields.__4__this;
  this = (MyRoomBackGroundManager__LoadBackObject_d__22_o *)sub_1B71570(v12 + 16);
  *(_BYTE *)(v12 + 24) = 0;
  if ( !_4__this )
    goto LABEL_22;
  ...
  {
    v14 = BackObjectId;
    v15 = (MyRoomBackGroundManager_BackObject_o *)sub_1B71818(MyRoomBackGroundManager_BackObject_TypeInfo);
    ...
    this = (MyRoomBackGroundManager__LoadBackObject_d__22_o *)sub_1B71570(p_backObject);
    if ( !*p_backObject )
      goto LABEL_22;
    assetName = (*p_backObject)->fields.assetName;
    if ( !AssetManager_TypeInfo->_2.cctor_finished )
...
LABEL_21:
  v23 = (System_Func_bool__o *)sub_1B71818(System_Func_bool__TypeInfo);
  System_Func_bool____ctor(
    v23,
    (Il2CppObject *)v12,
    Method_MyRoomBackGroundManager___c__DisplayClass22_0__LoadBackObject_b__1__,
    0LL);
  v24 = (UnityEngine_WaitWhile_o *)sub_1B71818(UnityEngine_WaitWhile_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v3 = (System_NotSupportedException_o *)sub_1B71818(v2);
  System_NotSupportedException___ctor(v3, 0LL);
  v4 = sub_1B715E0(&Method_MyRoomBackGroundManager__LoadBackObject_d__22_System_Collections_IEnumerator_Reset__);
  sub_1B716F4(v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1AFCC & 1) == 0 )
  {
    ...
    this = (MyRoomBackGroundManager___c__DisplayClass21_0_o *)sub_1B715CC(&StringLiteral_3118/*"Back/back{0}"*/, v4);
    byte_4A1AFCC = 1;
  }
  _4__this = v2->fields.__4__this;
  if ( !_4__this )
  ...
  v2->fields.imgName = System_String__Format((System_String_o *)StringLiteral_3118/*"Back/back{0}"*/, v10, 0LL);
  this = (MyRoomBackGroundManager___c__DisplayClass21_0_o *)sub_1B71570(&v2->fields.imgName);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1AFCD & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_9167/*"MyRoomBackObj"*/, v7);
    byte_4A1AFCD = 1;
  }
  if ( assetData )
  {
    Object_object__48486748 = AssetData__GetObject_object__48486748(
                                assetData,
                                (System_String_o *)StringLiteral_9167/*"MyRoomBackObj"*/,
...
LABEL_15:
      ...
      sub_1B71570(&_4__this[1].monitor);
    }
  }
  this->fields.wait = 0;
}
