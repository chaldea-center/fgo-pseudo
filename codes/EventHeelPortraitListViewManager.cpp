...
void EventHeelPortraitListViewManager__CreateList(EventHeelPortraitListViewManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB07FA & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_System_Collections_Generic_List_HeelPortraitEntity__get_Count__);
    sub_1C6BA08(&Method_System_Collections_Generic_List_HeelPortraitEntity__get_Item__);
    byte_4CB07FA = 1;
  }
  entity = 0;
  ...
  DispEntity = (System_Collections_Generic_List_object__o *)HeelPortraitMaster__GetDispEntity(
                                                              ...
                                                              this->fields.eventId,
                                                              0);
  Master_object = (__int64)DataManager__GetMaster_object_((const MethodInfo_313B314 *)Method_DataManager_GetMaster_UserHeelPortraitMaster___);
  if ( !Master_object )
    goto LABEL_26;
      ...
      for ( i = 0; i != size; ++i )
      {
        if ( (v7 & 1) != 0 )
        {
          ...
          Master_object = (__int64)System_Collections_Generic_List_object___get_Item(
                                     DispEntity,
                                     i,
                                     (const MethodInfo_38006A4 *)Method_System_Collections_Generic_List_HeelPortraitEntity__get_Item__);
          if ( !Master_object )
            goto LABEL_26;
        ...
        v16 = sub_1C6BC54(EventHeelPortraitListViewItem_TypeInfo);
        ListViewItem___ctor_44050768((ListViewItem_o *)v16, i, 0);
        *(_QWORD *)(v16 + 120) = v14;
        Master_object = sub_1C6B9AC(v16 + 120, v14);
        *(_BYTE *)(v16 + 128) = v10;
        *(_BYTE *)(v16 + 129) = v15;
        if ( !itemList )
          goto LABEL_26;
        ...
        else
        {
          ...
          Master_object = sub_1C6B9AC(v20 + 4, v16);
        }
      }
    }
  }
...
void EventHeelPortraitListViewManager__DestroyList(EventHeelPortraitListViewManager_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(heelPortraitDetailDialog, 0, 0) )
  {
    ...
    *p_heelPortraitDetailDialog = 0;
    sub_1C6B9AC(p_heelPortraitDetailDialog, 0);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB07FD & 1) == 0 )
  {
    sub_1C6BA08(&EventHeelPortraitListViewManager_HeelPortraitSaveData_TypeInfo);
    sub_1C6BA08(&Method_UnityEngine_JsonUtility_FromJson_EventHeelPortraitListViewManager_HeelPortraitSaveData___);
    byte_4CB07FD = 1;
  }
  ...
  if ( !System_String__IsNullOrEmpty(HeelPortraitDetailDialogState, 0) )
    return (EventHeelPortraitListViewManager_HeelPortraitSaveData_o *)UnityEngine_JsonUtility__FromJson_object_(
                                                                        ...
                                                                        (const MethodInfo_31ABEC4 *)Method_UnityEngine_JsonUtility_FromJson_EventHeelPortraitListViewManager_HeelPortraitSaveData___);
  v4 = (EventHeelPortraitListViewManager_HeelPortraitSaveData_o *)sub_1C6BC54(EventHeelPortraitListViewManager_HeelPortraitSaveData_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB07F9 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&EventHeelPortraitAssetManager_TypeInfo);
    sub_1C6BA08(&Method_EventHeelPortraitListViewManager___c__DisplayClass7_0__Init_b__0__);
    sub_1C6BA08(&EventHeelPortraitListViewManager___c__DisplayClass7_0_TypeInfo);
    byte_4CB07F9 = 1;
  }
  v5 = sub_1C6BC54(EventHeelPortraitListViewManager___c__DisplayClass7_0_TypeInfo);
  ...
  *(_DWORD *)(v5 + 16) = eventId;
  ...
  sub_1C6B9AC(&this->fields.saveData, SaveData);
  assetManager = this->fields.assetManager;
  if ( !assetManager )
  {
    p_assetManager = &this->fields.assetManager;
    v12 = (EventHeelPortraitAssetManager_o *)sub_1C6BC54(EventHeelPortraitAssetManager_TypeInfo);
    EventHeelPortraitAssetManager___ctor(v12, v13);
    *p_assetManager = v12;
    sub_1C6B9AC(p_assetManager, v12);
...
void EventHeelPortraitListViewManager__InitDialog(EventHeelPortraitListViewManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB07FB & 1) == 0 )
  {
    sub_1C6BA08(&Method_UnityEngine_GameObject_GetComponent_HeelPortraitDetailDialogComponent___);
  ...
  if ( (transform & 1) != 0 )
  {
    ...
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    transform = (__int64)UnityEngine_Object__Instantiate_object__52199488(
    ...
    Component_object = UnityEngine_GameObject__GetComponent_object_(
                         ...
                         (const MethodInfo_319312C *)Method_UnityEngine_GameObject_GetComponent_HeelPortraitDetailDialogComponent___);
    *p_heelPortraitDetailDialog = (struct HeelPortraitDetailDialogComponent_o *)Component_object;
    sub_1C6B9AC(p_heelPortraitDetailDialog, Component_object);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C6BA08(&System_Action_TypeInfo);
    sub_1C6BA08(&Method_EventHeelPortraitListViewManager_OnClickListView__);
    sub_1C6BA08(&Method_EventHeelPortraitListViewManager___c__DisplayClass11_0__OnClickListView_b__0__);
    sub_1C6BA08(&EventHeelPortraitListViewManager___c__DisplayClass11_0_TypeInfo);
    byte_4CB07FC = 1;
  }
  v5 = (Il2CppObject *)sub_1C6BC54(EventHeelPortraitListViewManager___c__DisplayClass11_0_TypeInfo);
  ...
  if ( monitor->fields._isHavePortrait_k__BackingField )
  {
    ...
    if ( (*((_BYTE *)Method_EventHeelPortraitListViewManager_OnClickListView__ + 83) & 2) != 0 )
      v9 = (_QWORD *)sub_1C6BA20(Method_EventHeelPortraitListViewManager_OnClickListView__);
    ...
    if ( *p_monitor )
    {
      ...
      monitor = (EventHeelPortraitListViewItem_o *)sub_1C6B9AC(&v5[2], Item);
      klass = v5[2].klass;
      if ( klass )
      {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB0800 & 1) == 0 )
  {
    this = (EventHeelPortraitListViewManager___c__DisplayClass11_0_o *)sub_1C6BA08(&Method_System_Collections_Generic_List_int__Add__);
    byte_4CB0800 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB0801 & 1) == 0 )
  {
    ...
    this = (EventHeelPortraitListViewManager___c__DisplayClass7_0_o *)sub_1C6BA08(&StringLiteral_22826/*"portrait_back"*/);
    byte_4CB0801 = 1;
  }
  _4__this = v2->fields.__4__this;
  if ( !_4__this )
  ...
  AtlasManager__SetEventUI_40837804(eventId, bg, (System_String_o *)StringLiteral_22826/*"portrait_back"*/, 0);
