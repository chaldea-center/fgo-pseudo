...
void EventHeelPortraitListViewManager__CreateList(EventHeelPortraitListViewManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3D532 & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_System_Collections_Generic_List_HeelPortraitEntity__get_Count__);
    sub_1C37058(&Method_System_Collections_Generic_List_HeelPortraitEntity__get_Item__);
    byte_4C3D532 = 1;
  }
  entity = 0;
  ...
  Master_object = (__int64)DataManager__GetMaster_object_((const MethodInfo_30E7C04 *)Method_DataManager_GetMaster_HeelPortraitMaster___);
  if ( !Master_object )
    goto LABEL_26;
  DispEntity = (System_Collections_Generic_List_object__o *)HeelPortraitMaster__GetDispEntity(
                                                              ...
                                                              this->fields.eventId,
                                                              0);
  Master_object = (__int64)DataManager__GetMaster_object_((const MethodInfo_30E7C04 *)Method_DataManager_GetMaster_UserHeelPortraitMaster___);
  if ( !Master_object )
    goto LABEL_26;
      ...
      for ( i = 0; i != size; ++i )
      {
        if ( (v6 & 1) != 0 )
        {
          ...
          Master_object = (__int64)System_Collections_Generic_List_object___get_Item(
                                     DispEntity,
                                     i,
                                     (const MethodInfo_37A2D54 *)Method_System_Collections_Generic_List_HeelPortraitEntity__get_Item__);
          if ( !Master_object )
            goto LABEL_26;
        ...
        v15 = sub_1C372A4(EventHeelPortraitListViewItem_TypeInfo);
        ListViewItem___ctor_43804668((ListViewItem_o *)v15, i, 0);
        *(_QWORD *)(v15 + 120) = v13;
        Master_object = sub_1C36FFC(v15 + 120, v13);
        *(_BYTE *)(v15 + 128) = v9;
        *(_BYTE *)(v15 + 129) = v14;
        if ( !itemList )
          goto LABEL_26;
        ...
        else
        {
          ...
          Master_object = sub_1C36FFC(v19 + 4, v15);
        }
      }
    }
  }
...
void EventHeelPortraitListViewManager__DestroyList(EventHeelPortraitListViewManager_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(heelPortraitDetailDialog, 0, 0) )
  {
    ...
    *p_heelPortraitDetailDialog = 0;
    sub_1C36FFC(p_heelPortraitDetailDialog, 0);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3D535 & 1) == 0 )
  {
    sub_1C37058(&EventHeelPortraitListViewManager_HeelPortraitSaveData_TypeInfo);
    sub_1C37058(&Method_UnityEngine_JsonUtility_FromJson_EventHeelPortraitListViewManager_HeelPortraitSaveData___);
    byte_4C3D535 = 1;
  }
  ...
  if ( !System_String__IsNullOrEmpty(HeelPortraitDetailDialogState, 0) )
    return (EventHeelPortraitListViewManager_HeelPortraitSaveData_o *)UnityEngine_JsonUtility__FromJson_object_(
                                                                        ...
                                                                        (const MethodInfo_3157F70 *)Method_UnityEngine_JsonUtility_FromJson_EventHeelPortraitListViewManager_HeelPortraitSaveData___);
  v4 = (EventHeelPortraitListViewManager_HeelPortraitSaveData_o *)sub_1C372A4(EventHeelPortraitListViewManager_HeelPortraitSaveData_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3D531 & 1) == 0 )
  {
    ...
    sub_1C37058(&EventHeelPortraitAssetManager_TypeInfo);
    sub_1C37058(&Method_EventHeelPortraitListViewManager___c__DisplayClass7_0__Init_b__0__);
    sub_1C37058(&EventHeelPortraitListViewManager___c__DisplayClass7_0_TypeInfo);
    byte_4C3D531 = 1;
  }
  v5 = sub_1C372A4(EventHeelPortraitListViewManager___c__DisplayClass7_0_TypeInfo);
  ...
  *(_DWORD *)(v5 + 16) = eventId;
  ...
  sub_1C36FFC(&this->fields.saveData, SaveData);
  assetManager = this->fields.assetManager;
  if ( !assetManager )
  {
    p_assetManager = &this->fields.assetManager;
    v11 = (EventHeelPortraitAssetManager_o *)sub_1C372A4(EventHeelPortraitAssetManager_TypeInfo);
    EventHeelPortraitAssetManager___ctor(v11, v12);
    *p_assetManager = v11;
    sub_1C36FFC(p_assetManager, v11);
...
void EventHeelPortraitListViewManager__InitDialog(EventHeelPortraitListViewManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3D533 & 1) == 0 )
  {
    sub_1C37058(&Method_UnityEngine_GameObject_GetComponent_HeelPortraitDetailDialogComponent___);
  ...
  if ( ((unsigned __int8)transform & 1) != 0 )
  {
    ...
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    transform = (UnityEngine_GameObject_o *)UnityEngine_Object__Instantiate_object__51855596(
    ...
    Component_object = UnityEngine_GameObject__GetComponent_object_(
                         transform,
                         (const MethodInfo_313F1D8 *)Method_UnityEngine_GameObject_GetComponent_HeelPortraitDetailDialogComponent___);
    *p_heelPortraitDetailDialog = (struct HeelPortraitDetailDialogComponent_o *)Component_object;
    sub_1C36FFC(p_heelPortraitDetailDialog, Component_object);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C37058(&System_Action_TypeInfo);
    sub_1C37058(&Method_EventHeelPortraitListViewManager_OnClickListView__);
    sub_1C37058(&Method_EventHeelPortraitListViewManager___c__DisplayClass11_0__OnClickListView_b__0__);
    sub_1C37058(&EventHeelPortraitListViewManager___c__DisplayClass11_0_TypeInfo);
    byte_4C3D534 = 1;
  }
  v5 = (Il2CppObject *)sub_1C372A4(EventHeelPortraitListViewManager___c__DisplayClass11_0_TypeInfo);
  ...
  if ( monitor->fields._isHavePortrait_k__BackingField )
  {
    ...
    if ( (*((_BYTE *)Method_EventHeelPortraitListViewManager_OnClickListView__ + 83) & 2) != 0 )
      v9 = (_QWORD *)sub_1C37070(Method_EventHeelPortraitListViewManager_OnClickListView__);
    ...
    if ( *p_monitor )
    {
      ...
      monitor = (EventHeelPortraitListViewItem_o *)sub_1C36FFC(&v5[2], Item);
      klass = v5[2].klass;
      if ( klass )
      {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3D538 & 1) == 0 )
  {
    this = (EventHeelPortraitListViewManager___c__DisplayClass11_0_o *)sub_1C37058(&Method_System_Collections_Generic_List_int__Add__);
    byte_4C3D538 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3D539 & 1) == 0 )
  {
    ...
    this = (EventHeelPortraitListViewManager___c__DisplayClass7_0_o *)sub_1C37058(&StringLiteral_22737/*"portrait_back"*/);
    byte_4C3D539 = 1;
  }
  _4__this = v2->fields.__4__this;
  if ( !_4__this )
  ...
  AtlasManager__SetEventUI_40606984(eventId, bg, (System_String_o *)StringLiteral_22737/*"portrait_back"*/, 0);
