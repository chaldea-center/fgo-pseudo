...
bool GalleryEntity__IsEnableGallery(GalleryEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2CC5A & 1) == 0 )
  {
    sub_1C94098(&Method_System_Linq_Enumerable_Any_GalleryResourceEntity___);
    byte_4D2CC5A = 1;
  }
  ...
  return System_Linq_Enumerable__Any_object_(
           ...
           (const MethodInfo_31A7F44 *)Method_System_Linq_Enumerable_Any_GalleryResourceEntity___);
}