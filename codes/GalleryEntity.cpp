        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B02305 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMaster_GalleryResourceMaster___, method);
...
bool __fastcall GalleryEntity__IsEnableGallery(GalleryEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B02306 & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Linq_Enumerable_Any_GalleryResourceEntity___, method);
    byte_4B02306 = 1;
  }
  ...
  return System_Linq_Enumerable__Any_object_(
           ...
           (const MethodInfo_300D9DC *)Method_System_Linq_Enumerable_Any_GalleryResourceEntity___);
}