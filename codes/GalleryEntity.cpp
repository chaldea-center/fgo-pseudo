...
bool GalleryEntity__IsEnableGallery(GalleryEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C432B9 & 1) == 0 )
  {
    sub_1C37058(&Method_System_Linq_Enumerable_Any_GalleryResourceEntity___);
    byte_4C432B9 = 1;
  }
  ...
  return System_Linq_Enumerable__Any_object_(
           ...
           (const MethodInfo_30F37D0 *)Method_System_Linq_Enumerable_Any_GalleryResourceEntity___);
}