...
bool GalleryEntity__IsEnableGallery(GalleryEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC76FF & 1) == 0 )
  {
    sub_1C713B0(&Method_System_Linq_Enumerable_Any_GalleryResourceEntity___);
    byte_4CC76FF = 1;
  }
  ...
  return System_Linq_Enumerable__Any_object_(
           ...
           (const MethodInfo_3156C84 *)Method_System_Linq_Enumerable_Any_GalleryResourceEntity___);
}