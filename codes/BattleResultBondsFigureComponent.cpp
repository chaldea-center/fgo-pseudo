        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C467A6 & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_BattleResultBondsFigureComponent_CreateEndCallback__);
...
LABEL_36:
  ...
  while ( 1 )
  {
    ...
    if ( commonPosition && SLODWORD(commonPosition->max_length) >= 2 )
    {
      ...
      if ( !max_length )
        sub_1C372BC(gameObject);
      GameObjectExtensions__AddLocalPosition_36133328(gameObject, (float)v31->m_Items[0], (float)v31->m_Items[1], 0);
    }
    v33 = (System_Collections_Generic_List_object__o *)this->fields.figureCollectList;
    v34 = (StandFigureCollect_o *)sub_1C372A4(StandFigureCollect_TypeInfo);
