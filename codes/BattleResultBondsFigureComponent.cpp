        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CCACBE & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_BattleResultBondsFigureComponent_CreateEndCallback__);
...
LABEL_36:
  ...
  while ( 1 )
  {
    ...
    if ( commonPosition && SLODWORD(commonPosition->max_length) >= 2 )
    {
      ...
      if ( !max_length )
        sub_1C71610(gameObject);
      GameObjectExtensions__AddLocalPosition_36390912(gameObject, (float)v43->m_Items[0], (float)v43->m_Items[1], 0);
    }
