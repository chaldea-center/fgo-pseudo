        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF1F15 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_BattleResultBondsFigureComponent_CreateEndCallback__);
...
LABEL_36:
  ...
  while ( 1 )
  {
    ...
    if ( commonPosition && SLODWORD(commonPosition->max_length) >= 2 )
    {
      ...
      if ( !max_length )
        sub_1C7BD48(gameObject);
      GameObjectExtensions__AddLocalPosition_36524260(gameObject, (float)v43->m_Items[0], (float)v43->m_Items[1], 0);
    }
