  ...
  if ( v5 >= createNumMax )
  {
    ...
    *(_QWORD *)&p_createCallback[-1].fields.isMine = 0LL;
    if ( createCallback )
    {
      ...
      sub_1B00C70(p_createCallback, 0, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E57E9 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_BattleResultBondsFigureComponent_CreateEndCallback__, v15);
    sub_1B00CCC(&Method_DataManager_GetMasterData_ServantLimitImageMaster___, v16);
    sub_1B00CCC(&Method_DataManager_GetMasterData_SvtMultiPortraitMaster___, v17);
    ...
    sub_1B00CCC(&Method_System_Collections_Generic_List_StandFigureCollect__Add__, v22);
    ...
    sub_1B00CCC(&StandFigureCollect_TypeInfo, v25);
    byte_48E57E9 = 1;
  }
  ...
  *(_QWORD *)&this->fields.createNumMax = 0LL;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.createCallback, (int32_t)callBack, v30, v31);
...
LABEL_36:
  ...
  while ( 1 )
  {
    ...
    if ( commonPosition && (int)commonPosition->max_length >= 2 )
    {
      ...
      if ( !max_length )
        sub_1B00F30(gameObject, v45);
      GameObjectExtensions__AddLocalPosition_32536400(gameObject, (float)v46->m_Items[1], (float)v46->m_Items[2], 0LL);
    }
    v48 = (System_Collections_Generic_List_object__o *)this->fields.figureCollectList;
    v49 = (StandFigureCollect_o *)sub_1B00F18(StandFigureCollect_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( !v18 )
LABEL_22:
    sub_1B00F28(figureCollectList, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E57E8 & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataManager_GetMasterData_ServantLimitImageMaster___, parent);
