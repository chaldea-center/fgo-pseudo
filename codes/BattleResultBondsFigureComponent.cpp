  ...
  if ( v5 >= createNumMax )
  {
    ...
    *(_QWORD *)&p_createCallback[-1].fields.isMine = 0LL;
    if ( createCallback )
    {
      ...
      sub_1B76164(p_createCallback, 0, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31056 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_BattleResultBondsFigureComponent_CreateEndCallback__, v15);
    sub_1B761C0(&Method_DataManager_GetMasterData_ServantLimitImageMaster___, v16);
    sub_1B761C0(&Method_DataManager_GetMasterData_SvtMultiPortraitMaster___, v17);
    ...
    sub_1B761C0(&Method_System_Collections_Generic_List_StandFigureCollect__Add__, v22);
    ...
    sub_1B761C0(&StandFigureCollect_TypeInfo, v25);
    byte_4A31056 = 1;
  }
  ...
  *(_QWORD *)&this->fields.createNumMax = 0LL;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.createCallback, (int32_t)callBack, v30, v31);
...
LABEL_36:
  ...
  while ( 1 )
  {
    ...
    if ( commonPosition && (int)commonPosition->max_length >= 2 )
    {
      ...
      if ( !max_length )
        sub_1B76424(gameObject, v45);
      GameObjectExtensions__AddLocalPosition_33552984(gameObject, (float)v46->m_Items[1], (float)v46->m_Items[2], 0LL);
    }
    v48 = (System_Collections_Generic_List_object__o *)this->fields.figureCollectList;
    v49 = (StandFigureCollect_o *)sub_1B7640C(StandFigureCollect_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( !v18 )
LABEL_22:
    sub_1B7641C(figureCollectList, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31055 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMasterData_ServantLimitImageMaster___, parent);
