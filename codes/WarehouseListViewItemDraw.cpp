        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1DBAF & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_22879/*"ribbon_noblephantasmup_01"*/, v8);
    byte_4A1DBAF = 1;
  }
  ...
  if ( ((unsigned __int8)gameObject & 1) != 0 )
  {
    ...
    if ( item->fields.isMaterialTdSvt )
    {
      ...
      gameObject = (UnityEngine_Component_o *)AtlasManager__SetEventSprite(
                                                v21,
                                                (System_String_o *)StringLiteral_22879/*"ribbon_noblephantasmup_01"*/,
                                                0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( v7 && mode )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(partyIcon, 0LL, 0LL) )
    {
      ...
      FlashingIconComponent__Set_37921456((FlashingIconComponent_o *)servantFaceIcon, (bool)item, 0LL);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1DBAD & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_11461/*"SELECT_FAVORITE"*/, v7);
    sub_1B715CC(&StringLiteral_12368/*"SUPPORT_MEMBER"*/, v8);
    sub_1B715CC(&StringLiteral_3753/*"COMMON_FATIGURE_RECOVERY"*/, v9);
    ...
    sub_1B715CC(&StringLiteral_11475/*"SELECT_PARTY"*/, v13);
    sub_1B715CC(&StringLiteral_11476/*"SELECT_PARTY_EQUIP"*/, v14);
    sub_1B715CC(&StringLiteral_12353/*"SUPPORT_EQUIP"*/, v15);
    sub_1B715CC(&StringLiteral_10977/*"RECOMMEND_SUPPORT_MEMBER"*/, v16);
    sub_1B715CC(&StringLiteral_3752/*"COMMON_EQUIP_USED"*/, v17);
    sub_1B715CC(&StringLiteral_1/*""*/, v18);
    sub_1B715CC(&StringLiteral_11477/*"SELECT_PROTECTED_EVENT_SVT"*/, v19);
    sub_1B715CC(&StringLiteral_10975/*"RECOMMEND_SUPPORT_EQUIP"*/, v20);
    byte_4A1DBAD = 1;
  }
...
LABEL_10:
      ...
      v25 = &StringLiteral_3753/*"COMMON_FATIGURE_RECOVERY"*/;
      goto LABEL_33;
    }
...
LABEL_33:
  ...
  if ( item->fields.isPush )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v25 = &StringLiteral_11478/*"SELECT_PUSH"*/;
    goto LABEL_33;
  }
  ...
  if ( item->fields.isFavorite )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v25 = &StringLiteral_11461/*"SELECT_FAVORITE"*/;
    goto LABEL_33;
  }
  if ( item->fields.isPartyEquip )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v25 = &StringLiteral_11476/*"SELECT_PARTY_EQUIP"*/;
    goto LABEL_33;
  }
  if ( (item->fields.partyIndex & 0x80000000) == 0 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v25 = &StringLiteral_11475/*"SELECT_PARTY"*/;
    goto LABEL_33;
  }
  if ( item->fields.isUseRecommendSupport )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(v29, 0LL, 0LL) )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v31 = &StringLiteral_10977/*"RECOMMEND_SUPPORT_MEMBER"*/;
LABEL_62:
  ...
  else if ( item->fields.isUseRecommendSupportEquip )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(v32, 0LL, 0LL) )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v31 = &StringLiteral_10975/*"RECOMMEND_SUPPORT_EQUIP"*/;
      goto LABEL_62;
    }
  }
  else
  {
    if ( item->fields.isUseSupport )
    {
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v25 = &StringLiteral_12368/*"SUPPORT_MEMBER"*/;
      goto LABEL_33;
    }
    if ( item->fields.isUseSupportEquip )
    {
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v25 = &StringLiteral_12353/*"SUPPORT_EQUIP"*/;
      goto LABEL_33;
    }
    if ( item->fields.isUse )
    {
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v25 = &StringLiteral_3752/*"COMMON_EQUIP_USED"*/;
      goto LABEL_33;
    }
    if ( item->fields.isFatigueRecovery )
      goto LABEL_10;
    if ( item->fields.isFortification )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      warningLabel = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6425/*"FORTIFICATION_APPOINTMENT"*/, 0LL);
    ...
    else
    {
        ...
        && UserServantEntity__IsProtectedEventServant(userServantEntity, 0LL) )
      {
        ...
        {
          v25 = &StringLiteral_11477/*"SELECT_PROTECTED_EVENT_SVT"*/;
          goto LABEL_33;
        }
        goto LABEL_32;
      }
