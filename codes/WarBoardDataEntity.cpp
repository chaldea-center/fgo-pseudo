        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67B8E & 1) == 0 )
  {
    sub_1BE4ACC(&Method_JsonManager_Deserialize_WarBoardDataEntity___, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67B8C & 1) == 0 )
  {
    sub_1BE4ACC(&Method_BasicHelper_Find_WarBoardUserServantData___, *(_QWORD *)&stageBossIndex);
    sub_1BE4ACC(&System_Func_WarBoardUserServantData__bool__TypeInfo, v5);
    sub_1BE4ACC(&Method_WarBoardDataEntity___c__DisplayClass26_0__GetStageBossData_b__0__, v6);
    sub_1BE4ACC(&WarBoardDataEntity___c__DisplayClass26_0_TypeInfo, v7);
    byte_4B67B8C = 1;
  }
  v8 = sub_1BE4D18(WarBoardDataEntity___c__DisplayClass26_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v8, 0LL);
  if ( !v8 )
    sub_1BE4D28(v9, v10);
  *(_DWORD *)(v8 + 16) = stageBossIndex;
  svtInfo = (System_Object_array *)this->fields.svtInfo;
  v12 = (System_Func_object__bool__o *)sub_1BE4D18(System_Func_WarBoardUserServantData__bool__TypeInfo);
