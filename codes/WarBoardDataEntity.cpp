        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5C0D3 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_WarBoardDataEntity___c__DisplayClass26_0__GetStageBossData_b__0__);
    sub_1B885B0(&WarBoardDataEntity___c__DisplayClass26_0_TypeInfo);
    byte_4A5C0D3 = 1;
  }
  v5 = sub_1B887FC(WarBoardDataEntity___c__DisplayClass26_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v5, 0LL);
  if ( !v5 )
    sub_1B8880C(v6, v7);
  *(_DWORD *)(v5 + 16) = stageBossIndex;
  svtInfo = (System_Object_array *)this->fields.svtInfo;
  v9 = (System_Func_object__bool__o *)sub_1B887FC(System_Func_WarBoardUserServantData__bool__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.originData, (int32_t)data, (int32_t)method, v3);
}
