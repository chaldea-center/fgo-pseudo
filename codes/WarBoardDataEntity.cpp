        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45B5A & 1) == 0 )
  {
    sub_1BDB878(&Method_JsonManager_Deserialize_WarBoardDataEntity___, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45B58 & 1) == 0 )
  {
    sub_1BDB878(&Method_BasicHelper_Find_WarBoardUserServantData___, *(_QWORD *)&stageBossIndex);
    sub_1BDB878(&System_Func_WarBoardUserServantData__bool__TypeInfo, v5);
    sub_1BDB878(&Method_WarBoardDataEntity___c__DisplayClass26_0__GetStageBossData_b__0__, v6);
    sub_1BDB878(&WarBoardDataEntity___c__DisplayClass26_0_TypeInfo, v7);
    byte_4B45B58 = 1;
  }
  v8 = sub_1BDBAC4(WarBoardDataEntity___c__DisplayClass26_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v8, 0LL);
  if ( !v8 )
    sub_1BDBAD4(v9, v10);
  *(_DWORD *)(v8 + 16) = stageBossIndex;
  svtInfo = (System_Object_array *)this->fields.svtInfo;
  v12 = (System_Func_object__bool__o *)sub_1BDBAC4(System_Func_WarBoardUserServantData__bool__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.originData, (int32_t)data, (int32_t)method, v3);
}
