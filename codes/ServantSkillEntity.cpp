        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B02A19 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMaster_SkillLvMaster___, *(_QWORD *)&skillLv);
...
int32_t __fastcall ServantSkillEntity__GetStrengthStatusReleaseId(ServantSkillEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4B02A1B & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_23500/*"strengthStatusReleaseId"*/, method);
    byte_4B02A1B = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_23500/*"strengthStatusReleaseId"*/, 0, 0LL);
}
...
bool __fastcall ServantSkillEntity__IsForceReleaseSkillRankUp(ServantSkillEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4B02A1D & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_20718/*"isForceReleaseSkillRankUp"*/, method);
    byte_4B02A1D = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_20718/*"isForceReleaseSkillRankUp"*/, 0, 0LL) == 1;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B02A17 & 1) == 0 )
  {
    sub_1BC3008(&CondType_TypeInfo, title);
    sub_1BC3008(&Method_DataManager_GetMasterData_SkillMaster___, v7);
    ...
    sub_1BC3008(&StringLiteral_3698/*"COND_TYPE_TITLE"*/, v12);
    sub_1BC3008(&StringLiteral_3688/*"COND_TYPE_NONE"*/, v13);
  ...
  if ( !Entity )
  {
    ...
    *title = unknownNameText;
    sub_1BC2FAC((CGThumbnailListItem_o *)title, (int32_t)unknownNameText, v19, v20);
  ...
  *title = EffectTitle;
  sub_1BC2FAC((CGThumbnailListItem_o *)title, (int32_t)EffectTitle, v22, v23);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v24 = LocalizationManager__Get((System_String_o *)StringLiteral_3698/*"COND_TYPE_TITLE"*/, 0LL);
  *explanation = v24;
  sub_1BC2FAC((CGThumbnailListItem_o *)explanation, (int32_t)v24, v25, v26);
  if ( this->fields.condLv >= 1 )
  {
    if ( System_String__op_Inequality(*explanation, (System_String_o *)StringLiteral_1/*""*/, 0LL) )
    {
      v27 = System_String__Concat_62348648(*explanation, (System_String_o *)StringLiteral_43/*"\n"*/, 0LL);
      *explanation = v27;
      sub_1BC2FAC((CGThumbnailListItem_o *)explanation, (int32_t)v27, v28, v29);
    }
    v30 = *explanation;
    ...
    v33 = System_String__Concat_62348648(v30, v32, 0LL);
    *explanation = v33;
    sub_1BC2FAC((CGThumbnailListItem_o *)explanation, (int32_t)v33, v34, v35);
  }
  if ( this->fields.condLimitCount >= 1 )
  {
    if ( System_String__op_Inequality(*explanation, (System_String_o *)StringLiteral_1/*""*/, 0LL) )
    {
      v36 = System_String__Concat_62348648(*explanation, (System_String_o *)StringLiteral_43/*"\n"*/, 0LL);
      *explanation = v36;
      sub_1BC2FAC((CGThumbnailListItem_o *)explanation, (int32_t)v36, v37, v38);
    }
    v39 = *explanation;
    ...
    v42 = System_String__Concat_62348648(v39, v41, 0LL);
    *explanation = v42;
    sub_1BC2FAC((CGThumbnailListItem_o *)explanation, (int32_t)v42, v43, v44);
  }
  if ( this->fields.condQuestId >= 1 )
  {
    if ( System_String__op_Inequality(*explanation, (System_String_o *)StringLiteral_1/*""*/, 0LL) )
    {
      v45 = System_String__Concat_62348648(*explanation, (System_String_o *)StringLiteral_43/*"\n"*/, 0LL);
      *explanation = v45;
      sub_1BC2FAC((CGThumbnailListItem_o *)explanation, (int32_t)v45, v46, v47);
    }
    v48 = *explanation;
    ...
    v51 = System_String__Concat_62348648(v48, v50, 0LL);
    *explanation = v51;
    sub_1BC2FAC((CGThumbnailListItem_o *)explanation, (int32_t)v51, v52, v53);
  }
  if ( System_String__op_Equality(*explanation, (System_String_o *)StringLiteral_1/*""*/, 0LL) )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v54 = LocalizationManager__Get((System_String_o *)StringLiteral_3688/*"COND_TYPE_NONE"*/, 0LL);
    v57 = (int)v54;
    *explanation = v54;
LABEL_37:
    sub_1BC2FAC((CGThumbnailListItem_o *)explanation, v57, v55, v56);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B02A16 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMasterData_SkillMaster___, charge);
  ...
  if ( Entity )
  {
    ...
    *title = EffectTitle;
    sub_1BC2FAC((CGThumbnailListItem_o *)title, (int32_t)EffectTitle, v32, v33);
  ...
  else
  {
    ...
    *title = unknownNameText;
    sub_1BC2FAC((CGThumbnailListItem_o *)title, (int32_t)unknownNameText, v21, v22);
    *explanation = (System_String_o *)StringLiteral_1/*""*/;
    v30 = (int)StringLiteral_1/*""*/;
  }
  sub_1BC2FAC((CGThumbnailListItem_o *)explanation, v30, v28, v29);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B02A1A & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMasterData_SkillLvMaster___, *(_QWORD *)&skillLv);
...
bool __fastcall ServantSkillEntity__isEnable(ServantSkillEntity_o *this, bool isFinishedAt, const MethodInfo *method)
{
  ...
  if ( (byte_4B02A14 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMasterData_EventMaster___, isFinishedAt);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B02A15 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_DataManager_GetMasterData_ServantSkillReleaseMaster___, v17);
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_3001E64 *)Method_DataManager_GetMasterData_ServantSkillReleaseMaster___)) == 0LL )
  {
