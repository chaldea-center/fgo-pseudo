...
// local variable allocation has failed, the output may be wrong!
System_Nullable_ValueTuple_FuncList_TYPE__int___o __fastcall ServantSkillEntity__GetFriendPointUpTypeVal(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45464 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMaster_SkillLvMaster___, *(_QWORD *)&skillLv);
  ...
  *(_QWORD *)&result.fields.hasValue = SkillLvMaster__GetEntity(
  ...
  if ( *(_QWORD *)&result.fields.hasValue )
    return SkillLvEntity__GetFriendPointUpTypeVal(*(SkillLvEntity_o **)&result.fields.hasValue, 0LL);
  return result;
}
...
int32_t __fastcall ServantSkillEntity__GetStrengthStatusReleaseId(ServantSkillEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4B45466 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_23765/*"strengthStatusReleaseId"*/, method);
    byte_4B45466 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_23765/*"strengthStatusReleaseId"*/, 0, 0LL);
}
...
bool __fastcall ServantSkillEntity__IsForceReleaseSkillRankUp(ServantSkillEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4B45468 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_20931/*"isForceReleaseSkillRankUp"*/, method);
    byte_4B45468 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_20931/*"isForceReleaseSkillRankUp"*/, 0, 0LL) == 1;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45462 & 1) == 0 )
  {
    sub_1BDB878(&CondType_TypeInfo, title);
    sub_1BDB878(&Method_DataManager_GetMasterData_SkillMaster___, v7);
    ...
    sub_1BDB878(&StringLiteral_3767/*"COND_TYPE_TITLE"*/, v12);
    sub_1BDB878(&StringLiteral_3757/*"COND_TYPE_NONE"*/, v13);
  ...
  if ( !Entity )
  {
    ...
    *title = unknownNameText;
    sub_1BDB81C((CGThumbnailListItem_o *)title, (int32_t)unknownNameText, v19, v20);
  ...
  *title = EffectTitle;
  sub_1BDB81C((CGThumbnailListItem_o *)title, (int32_t)EffectTitle, v22, v23);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v24 = LocalizationManager__Get((System_String_o *)StringLiteral_3767/*"COND_TYPE_TITLE"*/, 0LL);
  *explanation = v24;
  sub_1BDB81C((CGThumbnailListItem_o *)explanation, (int32_t)v24, v25, v26);
  if ( this->fields.condLv >= 1 )
  {
    if ( System_String__op_Inequality(*explanation, (System_String_o *)StringLiteral_1/*""*/, 0LL) )
    {
      v27 = System_String__Concat_62572260(*explanation, (System_String_o *)StringLiteral_43/*"\n"*/, 0LL);
      *explanation = v27;
      sub_1BDB81C((CGThumbnailListItem_o *)explanation, (int32_t)v27, v28, v29);
    }
    v30 = *explanation;
    ...
    v33 = System_String__Concat_62572260(v30, v32, 0LL);
    *explanation = v33;
    sub_1BDB81C((CGThumbnailListItem_o *)explanation, (int32_t)v33, v34, v35);
  }
  if ( this->fields.condLimitCount >= 1 )
  {
    if ( System_String__op_Inequality(*explanation, (System_String_o *)StringLiteral_1/*""*/, 0LL) )
    {
      v36 = System_String__Concat_62572260(*explanation, (System_String_o *)StringLiteral_43/*"\n"*/, 0LL);
      *explanation = v36;
      sub_1BDB81C((CGThumbnailListItem_o *)explanation, (int32_t)v36, v37, v38);
    }
    v39 = *explanation;
    ...
    v42 = System_String__Concat_62572260(v39, v41, 0LL);
    *explanation = v42;
    sub_1BDB81C((CGThumbnailListItem_o *)explanation, (int32_t)v42, v43, v44);
  }
  if ( this->fields.condQuestId >= 1 )
  {
    if ( System_String__op_Inequality(*explanation, (System_String_o *)StringLiteral_1/*""*/, 0LL) )
    {
      v45 = System_String__Concat_62572260(*explanation, (System_String_o *)StringLiteral_43/*"\n"*/, 0LL);
      *explanation = v45;
      sub_1BDB81C((CGThumbnailListItem_o *)explanation, (int32_t)v45, v46, v47);
    }
    v48 = *explanation;
    ...
    v51 = System_String__Concat_62572260(v48, v50, 0LL);
    *explanation = v51;
    sub_1BDB81C((CGThumbnailListItem_o *)explanation, (int32_t)v51, v52, v53);
  }
  if ( System_String__op_Equality(*explanation, (System_String_o *)StringLiteral_1/*""*/, 0LL) )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v54 = LocalizationManager__Get((System_String_o *)StringLiteral_3757/*"COND_TYPE_NONE"*/, 0LL);
    v57 = (int)v54;
    *explanation = v54;
LABEL_37:
    sub_1BDB81C((CGThumbnailListItem_o *)explanation, v57, v55, v56);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45461 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMasterData_SkillMaster___, charge);
  ...
  if ( Entity )
  {
    ...
    *title = EffectTitle;
    sub_1BDB81C((CGThumbnailListItem_o *)title, (int32_t)EffectTitle, v32, v33);
  ...
  else
  {
    ...
    *title = unknownNameText;
    sub_1BDB81C((CGThumbnailListItem_o *)title, (int32_t)unknownNameText, v21, v22);
    *explanation = (System_String_o *)StringLiteral_1/*""*/;
    v30 = (int)StringLiteral_1/*""*/;
  }
  sub_1BDB81C((CGThumbnailListItem_o *)explanation, v30, v28, v29);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45465 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMasterData_SkillLvMaster___, *(_QWORD *)&skillLv);
...
bool __fastcall ServantSkillEntity__isEnable(ServantSkillEntity_o *this, bool isFinishedAt, const MethodInfo *method)
{
  ...
  if ( (byte_4B4545F & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMasterData_EventMaster___, isFinishedAt);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45460 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_DataManager_GetMasterData_ServantSkillReleaseMaster___, v17);
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_303395C *)Method_DataManager_GetMasterData_ServantSkillReleaseMaster___)) == 0LL )
  {
