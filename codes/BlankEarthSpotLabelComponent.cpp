...
void BlankEarthSpotLabelComponent__SetupNameBgSprite(BlankEarthSpotLabelComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D28F70 & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_20762/*"img_spotname_bg"*/);
    byte_4D28F70 = 1;
  }
  nameBgSprite = this->fields.nameBgSprite;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetEventUI(nameBgSprite, (System_String_o *)StringLiteral_20762/*"img_spotname_bg"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !nameLabel
    ...
    || (nameLabel = (UILabel_o *)this->fields.nameBgSprite, v10 = v9->fields.mWidth + (v9->fields.mWidth < 0),
                                                            !nameLabel) )
  {
    sub_1C942F0(nameLabel, spotNameText);
  }
  v11 = v10 >> 1;
  if ( v11 <= -10 )
    v11 = -10;
