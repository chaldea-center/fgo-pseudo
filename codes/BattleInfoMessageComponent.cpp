        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BDEC8 & 1) == 0 )
  {
    sub_1B4CF90(&Method_UnityEngine_GameObject_GetComponent_BattleCommandComponent___, command);
  ...
  if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)command, 0LL, 0LL) )
  {
    ...
    sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.battleCommand, (int32_t)Object, v14, v15);
...
LABEL_21:
    ...
    BattleCommandComponent__SetCommandCodeView_43790476(v16, data->fields.commandCodeId, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BDEC6 & 1) == 0 )
  {
    ...
    this = (BattleInfoMessageComponent_o *)sub_1B4CF90(&StringLiteral_2883/*"BATTLE_SKILL_NAME_LEVEL"*/, v6);
    byte_49BDEC6 = 1;
  }
  ...
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_2883/*"BATTLE_SKILL_NAME_LEVEL"*/, 0LL);
  v10 = (Il2CppObject *)System_Int32__ToString((int32_t)&v11, 0LL);
  this = (BattleInfoMessageComponent_o *)System_String__Format_61134760(v9, (Il2CppObject *)str, v10, 0LL);
  if ( !v8 )
LABEL_9:
...
void __fastcall BattleInfoMessageComponent__setText_44549684(
        BattleInfoMessageComponent_o *this,
        System_String_o *str,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BDEC5 & 1) == 0 )
  {
    this = (BattleInfoMessageComponent_o *)sub_1B4CF90(&UnityEngine_Object_TypeInfo, str);
    byte_49BDEC5 = 1;
  }
