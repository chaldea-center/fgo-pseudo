        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69AF8 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_UnityEngine_GameObject_GetComponent_BattleCommandComponent___, command);
...
LABEL_21:
    ...
    BattleCommandComponent__SetCommandCodeView_44097600(v20, data->fields.commandCodeId, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69AF6 & 1) == 0 )
  {
    ...
    this = (BattleInfoMessageComponent_o *)sub_1BE4ACC(&StringLiteral_3020/*"BATTLE_SKILL_NAME_LEVEL"*/, v6);
    byte_4B69AF6 = 1;
  }
  ...
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_3020/*"BATTLE_SKILL_NAME_LEVEL"*/, 0LL);
  v10 = (Il2CppObject *)System_Int32__ToString((int32_t)&v11, 0LL);
  this = (BattleInfoMessageComponent_o *)System_String__Format_62713180(v9, (Il2CppObject *)str, v10, 0LL);
  if ( !v8 )
LABEL_9:
...
void __fastcall BattleInfoMessageComponent__setText_44843292(
        BattleInfoMessageComponent_o *this,
        System_String_o *str,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69AF5 & 1) == 0 )
  {
    this = (BattleInfoMessageComponent_o *)sub_1BE4ACC(&UnityEngine_Object_TypeInfo, str);
    byte_4B69AF5 = 1;
  }
