        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A228AB & 1) == 0 )
  {
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponent_BattleCommandComponent___, command);
  ...
  if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)command, 0LL, 0LL) )
  {
    ...
    sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.battleCommand, (int32_t)Object, v14, v15);
...
LABEL_21:
    ...
    BattleCommandComponent__SetCommandCodeView_42853104(v16, data->fields.commandCodeId, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A228A9 & 1) == 0 )
  {
    ...
    this = (BattleInfoMessageComponent_o *)sub_1B715CC(&StringLiteral_2976/*"BATTLE_SKILL_NAME_LEVEL"*/, v6);
    byte_4A228A9 = 1;
  }
  ...
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_2976/*"BATTLE_SKILL_NAME_LEVEL"*/, 0LL);
  v10 = (Il2CppObject *)System_Int32__ToString((int32_t)&v11, 0LL);
  this = (BattleInfoMessageComponent_o *)System_String__Format_61519876(v9, (Il2CppObject *)str, v10, 0LL);
  if ( !v8 )
LABEL_9:
...
void __fastcall BattleInfoMessageComponent__setText_43568256(
        BattleInfoMessageComponent_o *this,
        System_String_o *str,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A228A8 & 1) == 0 )
  {
    this = (BattleInfoMessageComponent_o *)sub_1B715CC(&UnityEngine_Object_TypeInfo, str);
    byte_4A228A8 = 1;
  }
