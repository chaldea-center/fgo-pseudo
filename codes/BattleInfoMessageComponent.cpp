        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3A073 & 1) == 0 )
  {
    sub_1BD3458(&Method_UnityEngine_GameObject_GetComponent_BattleCommandComponent___, command);
...
LABEL_21:
    ...
    BattleCommandComponent__SetCommandCodeView_43949772(v20, data->fields.commandCodeId, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3A071 & 1) == 0 )
  {
    ...
    this = (BattleInfoMessageComponent_o *)sub_1BD3458(&StringLiteral_3019/*"BATTLE_SKILL_NAME_LEVEL"*/, v6);
    byte_4B3A071 = 1;
  }
  ...
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_3019/*"BATTLE_SKILL_NAME_LEVEL"*/, 0LL);
  v10 = (Il2CppObject *)System_Int32__ToString((int32_t)&v11, 0LL);
  this = (BattleInfoMessageComponent_o *)System_String__Format_62539620(v9, (Il2CppObject *)str, v10, 0LL);
  if ( !v8 )
LABEL_9:
...
void __fastcall BattleInfoMessageComponent__setText_44688060(
        BattleInfoMessageComponent_o *this,
        System_String_o *str,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3A070 & 1) == 0 )
  {
    this = (BattleInfoMessageComponent_o *)sub_1BD3458(&UnityEngine_Object_TypeInfo, str);
    byte_4B3A070 = 1;
  }
