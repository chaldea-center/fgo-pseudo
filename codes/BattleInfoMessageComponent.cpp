        ...
        const MethodInfo *method)
{
  ...
  if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)command, 0, 0) )
  {
    ...
    sub_1C2D434((CGThumbnailListItem_o *)&this->fields.battleCommand, (int32_t)Object, v13, v14);
    ...
    BattleCommandComponent__resetAddObject(v15, 0);
    v16 = svtData ? svtData : 0LL;
    BattleCommandComponent__updateClassMag(v15, v16, 0);
    data = v11->fields.data;
    *(_WORD *)&v15->fields.isCodeTextureView = 256;
    if ( !data )
LABEL_21:
      sub_1C2D6EC(Component_object, v9);
    BattleCommandComponent__SetCommandCodeView_46182964(v15, data->fields.commandCodeId, 0);
    BattleCommandComponent__SetCommandAssistView(v15, data->fields.commandAssistId, 0);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2A6C7 & 1) == 0 )
  {
    ...
    this = (BattleInfoMessageComponent_o *)sub_1C2D490(&StringLiteral_2879/*"BATTLE_SKILL_NAME_LEVEL"*/);
    byte_4C2A6C7 = 1;
  }
  ...
  if ( !LODWORD(textLabel->max_length) )
    sub_1C2D6F4(this, str, *(_QWORD *)&skillLevel);
  v7 = textLabel->m_Items[0];
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v8 = LocalizationManager__Get((System_String_o *)StringLiteral_2879/*"BATTLE_SKILL_NAME_LEVEL"*/, 0);
  v9 = (Il2CppObject *)System_Int32__ToString((int32_t)&v10, 0);
  this = (BattleInfoMessageComponent_o *)System_String__Format_63499156(v8, (Il2CppObject *)str, v9, 0);
  if ( !v7 )
LABEL_9:
...
void BattleInfoMessageComponent__setText_47004720(
        BattleInfoMessageComponent_o *this,
        System_String_o *str,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2A6C6 & 1) == 0 )
  {
    this = (BattleInfoMessageComponent_o *)sub_1C2D490(&UnityEngine_Object_TypeInfo);
    byte_4C2A6C6 = 1;
  }
