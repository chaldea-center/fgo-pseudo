        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AFB66 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_PresentBoxNotificationMenu_OnMoveEnd__);
    byte_42AFB66 = 1;
  }
...
void __fastcall PresentBoxNotificationMenu__Init(PresentBoxNotificationMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_B52A5C(message1Label, method);
  }
...
void __fastcall PresentBoxNotificationMenu__OnMoveEnd(PresentBoxNotificationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42AFB68 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_PresentBoxNotificationMenu_OnSelectBuyItem__);
    byte_42AFB68 = 1;
  }
  switch ( this->fields.state )
  {
    ...
    case 3:
      ...
      v5 = (PresentBoxNotificationListViewManager_CallbackFunc_o *)sub_B52A54(PresentBoxNotificationListViewManager_CallbackFunc_TypeInfo);
      ...
      sub_B52920(
        ...
        v12,
        v13);
      PresentBoxNotificationListViewManager__SetMode_24667356(ItemListViewManager, 1, v14);
      break;
    case 5:
      v3 = 6;
LABEL_6:
    ...
    case 6:
      ...
      if ( closeCallbackFunc )
      {
        ...
        sub_B52920(p_closeCallbackFunc, 0LL, v15, v16, v17, v18, v19, v20);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AFB65 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_PresentBoxNotificationMenu_OnMoveEnd__);
    sub_B52984(&StringLiteral_10565/*"PRESENT_BOX_NOTIFICATION_MESSAGE2"*/);
    sub_B52984(&StringLiteral_10564/*"PRESENT_BOX_NOTIFICATION_MESSAGE1"*/);
    sub_B52984(&StringLiteral_10563/*"PRESENT_BOX_NOTIFICATION_CLOSE"*/);
    byte_42AFB65 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10564/*"PRESENT_BOX_NOTIFICATION_MESSAGE1"*/, 0LL);
    if ( !message1Label )
      goto LABEL_14;
    UILabel__set_text(message1Label, (System_String_o *)gameObject, 0LL);
    message2Label = this->fields.message2Label;
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10565/*"PRESENT_BOX_NOTIFICATION_MESSAGE2"*/, 0LL);
    if ( !message2Label
      || (UILabel__set_text(message2Label, (System_String_o *)gameObject, 0LL),
          closeLabel = this->fields.closeLabel,
          gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10563/*"PRESENT_BOX_NOTIFICATION_CLOSE"*/, 0LL),
          !closeLabel)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AFB62 & 1) == 0 )
  {
    sub_B52984(&PresentBoxNotificationMenu_CallbackFunc_TypeInfo);
    byte_42AFB62 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  ...
  v11 = (PresentBoxNotificationMenu_o *)sub_B52D50(v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AD440 & 1) == 0 )
  {
    sub_B52984(&PresentBoxNotificationMenu_Result_TypeInfo);
    byte_42AD440 = 1;
  }
  v9[1] = 0LL;
