        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFC3BA & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_PresentBoxNotificationMenu_OnMoveEnd__, v5);
    byte_4AFC3BA = 1;
  }
...
void __fastcall PresentBoxNotificationMenu__Init(PresentBoxNotificationMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BC3264(message1Label, method);
  }
...
void __fastcall PresentBoxNotificationMenu__OnClickClose(PresentBoxNotificationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFC3BD & 1) == 0 )
  {
    sub_1BC3008(&Method_PresentBoxNotificationMenu_OnClickClose__, method);
    byte_4AFC3BD = 1;
  }
...
void __fastcall PresentBoxNotificationMenu__OnMoveEnd(PresentBoxNotificationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFC3BC & 1) == 0 )
  {
    sub_1BC3008(&PresentBoxNotificationListViewManager_CallbackFunc_TypeInfo, method);
    sub_1BC3008(&Method_PresentBoxNotificationMenu_OnSelectBuyItem__, v3);
    byte_4AFC3BC = 1;
  }
  switch ( this->fields.state )
  {
    ...
    case 3:
      ...
      v6 = (PresentBoxNotificationListViewManager_CallbackFunc_o *)sub_1BC3254(PresentBoxNotificationListViewManager_CallbackFunc_TypeInfo);
      ...
      sub_1BC2FAC(&ItemListViewManager->fields.callbackFunc);
      PresentBoxNotificationListViewManager__SetMode_30857940(ItemListViewManager, 1, v10);
      break;
    case 5:
      v4 = 6;
LABEL_6:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFC3B9 & 1) == 0 )
  {
    sub_1BC3008(&System_Action_TypeInfo, presentList);
    sub_1BC3008(&LocalizationManager_TypeInfo, v7);
    sub_1BC3008(&Method_PresentBoxNotificationMenu_OnMoveEnd__, v8);
    sub_1BC3008(&StringLiteral_10344/*"PRESENT_BOX_NOTIFICATION_MESSAGE2"*/, v9);
    sub_1BC3008(&StringLiteral_10343/*"PRESENT_BOX_NOTIFICATION_MESSAGE1"*/, v10);
    sub_1BC3008(&StringLiteral_10342/*"PRESENT_BOX_NOTIFICATION_CLOSE"*/, v11);
    byte_4AFC3B9 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10343/*"PRESENT_BOX_NOTIFICATION_MESSAGE1"*/, 0LL);
    if ( !message1Label )
      goto LABEL_13;
    UILabel__set_text(message1Label, (System_String_o *)gameObject, 0LL);
    message2Label = this->fields.message2Label;
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10344/*"PRESENT_BOX_NOTIFICATION_MESSAGE2"*/, 0LL);
    if ( !message2Label
      || (UILabel__set_text(message2Label, (System_String_o *)gameObject, 0LL),
          closeLabel = this->fields.closeLabel,
          gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10342/*"PRESENT_BOX_NOTIFICATION_CLOSE"*/, 0LL),
          !closeLabel)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFC3B6 & 1) == 0 )
  {
    sub_1BC3008(&PresentBoxNotificationMenu_CallbackFunc_TypeInfo, value);
    byte_4AFC3B6 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (PresentBoxNotificationMenu_o *)sub_1BC3524(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A04870;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A04828;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFC3C0 & 1) == 0 )
  {
    sub_1BC3008(&PresentBoxNotificationMenu_Result_TypeInfo, *(_QWORD *)&result);
    byte_4AFC3C0 = 1;
  }
  v9[1] = 0LL;
