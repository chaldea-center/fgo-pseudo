        ...
        const MethodInfo *method)
{
  if ( (byte_4BC2737 & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_10123/*"OnMoveEnd"*/, method);
    byte_4BC2737 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC2736 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_PresentBoxNotificationMenu_OnMoveEnd__, v5);
    byte_4BC2736 = 1;
  }
...
void __fastcall PresentBoxNotificationMenu__Init(PresentBoxNotificationMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C1AE30(message1Label, method);
  }
...
void __fastcall PresentBoxNotificationMenu__OnClickClose(PresentBoxNotificationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC2739 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_PresentBoxNotificationMenu_OnClickClose__, method);
    byte_4BC2739 = 1;
  }
...
void __fastcall PresentBoxNotificationMenu__OnMoveEnd(PresentBoxNotificationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC2738 & 1) == 0 )
  {
    sub_1C1ABD4(&PresentBoxNotificationListViewManager_CallbackFunc_TypeInfo, method);
    sub_1C1ABD4(&Method_PresentBoxNotificationMenu_OnSelectBuyItem__, v3);
    byte_4BC2738 = 1;
  }
  switch ( this->fields.state )
  {
    ...
    case 3:
      ...
      v6 = (PresentBoxNotificationListViewManager_CallbackFunc_o *)sub_1C1AE20(PresentBoxNotificationListViewManager_CallbackFunc_TypeInfo);
      ...
      PresentBoxNotificationListViewManager__SetMode_31218892(ItemListViewManager, 1, v10);
      break;
    case 5:
      v4 = 6;
LABEL_6:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC2735 & 1) == 0 )
  {
    sub_1C1ABD4(&System_Action_TypeInfo, presentList);
    sub_1C1ABD4(&LocalizationManager_TypeInfo, v7);
    sub_1C1ABD4(&Method_PresentBoxNotificationMenu_OnMoveEnd__, v8);
    sub_1C1ABD4(&StringLiteral_10630/*"PRESENT_BOX_NOTIFICATION_MESSAGE2"*/, v9);
    sub_1C1ABD4(&StringLiteral_10629/*"PRESENT_BOX_NOTIFICATION_MESSAGE1"*/, v10);
    sub_1C1ABD4(&StringLiteral_10628/*"PRESENT_BOX_NOTIFICATION_CLOSE"*/, v11);
    byte_4BC2735 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10629/*"PRESENT_BOX_NOTIFICATION_MESSAGE1"*/, 0LL);
    if ( !message1Label )
      goto LABEL_13;
    UILabel__set_text(message1Label, (System_String_o *)gameObject, 0LL);
    message2Label = this->fields.message2Label;
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10630/*"PRESENT_BOX_NOTIFICATION_MESSAGE2"*/, 0LL);
    if ( !message2Label
      || (UILabel__set_text(message2Label, (System_String_o *)gameObject, 0LL),
          closeLabel = this->fields.closeLabel,
          gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10628/*"PRESENT_BOX_NOTIFICATION_CLOSE"*/, 0LL),
          !closeLabel)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC2732 & 1) == 0 )
  {
    sub_1C1ABD4(&PresentBoxNotificationMenu_CallbackFunc_TypeInfo, value);
    byte_4BC2732 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (PresentBoxNotificationMenu_o *)sub_1C1B0F0(v8);
        ...
        const MethodInfo *method)
{
  if ( (byte_4BC273A & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_9007/*"MainPanel/BaseView/CloseButton"*/, method);
    byte_4BC273A = 1;
  }
  return (System_String_o *)StringLiteral_9007/*"MainPanel/BaseView/CloseButton"*/;
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A54228;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A541E0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC273C & 1) == 0 )
  {
    sub_1C1ABD4(&PresentBoxNotificationMenu_Result_TypeInfo, *(_QWORD *)&result);
    byte_4BC273C = 1;
  }
  v9[1] = 0LL;
