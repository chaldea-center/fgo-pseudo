        ...
        const MethodInfo *method)
{
  if ( (byte_4A48DDA & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_9791/*"OnMoveEnd"*/, method);
    byte_4A48DDA = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A48DD9 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_PresentBoxNotificationMenu_OnMoveEnd__, v5);
    byte_4A48DD9 = 1;
  }
...
void __fastcall PresentBoxNotificationMenu__Init(PresentBoxNotificationMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B86614(message1Label, method);
  }
...
void __fastcall PresentBoxNotificationMenu__OnClickClose(PresentBoxNotificationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A48DDC & 1) == 0 )
  {
    sub_1B863B8(&Method_PresentBoxNotificationMenu_OnClickClose__, method);
    byte_4A48DDC = 1;
  }
...
void __fastcall PresentBoxNotificationMenu__OnMoveEnd(PresentBoxNotificationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A48DDB & 1) == 0 )
  {
    sub_1B863B8(&PresentBoxNotificationListViewManager_CallbackFunc_TypeInfo, method);
    sub_1B863B8(&Method_PresentBoxNotificationMenu_OnSelectBuyItem__, v3);
    byte_4A48DDB = 1;
  }
  switch ( this->fields.state )
  {
    ...
    case 3:
      ...
      v6 = (PresentBoxNotificationListViewManager_CallbackFunc_o *)sub_1B86604(PresentBoxNotificationListViewManager_CallbackFunc_TypeInfo);
      ...
      sub_1B8635C(&ItemListViewManager->fields.callbackFunc);
      PresentBoxNotificationListViewManager__SetMode_30603520(ItemListViewManager, 1, v10);
      break;
    case 5:
      v4 = 6;
LABEL_6:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A48DD8 & 1) == 0 )
  {
    sub_1B863B8(&System_Action_TypeInfo, presentList);
    sub_1B863B8(&LocalizationManager_TypeInfo, v7);
    sub_1B863B8(&Method_PresentBoxNotificationMenu_OnMoveEnd__, v8);
    sub_1B863B8(&StringLiteral_10281/*"PRESENT_BOX_NOTIFICATION_MESSAGE2"*/, v9);
    sub_1B863B8(&StringLiteral_10280/*"PRESENT_BOX_NOTIFICATION_MESSAGE1"*/, v10);
    sub_1B863B8(&StringLiteral_10279/*"PRESENT_BOX_NOTIFICATION_CLOSE"*/, v11);
    byte_4A48DD8 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10280/*"PRESENT_BOX_NOTIFICATION_MESSAGE1"*/, 0LL);
    if ( !message1Label )
      goto LABEL_13;
    UILabel__set_text(message1Label, (System_String_o *)gameObject, 0LL);
    message2Label = this->fields.message2Label;
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10281/*"PRESENT_BOX_NOTIFICATION_MESSAGE2"*/, 0LL);
    if ( !message2Label
      || (UILabel__set_text(message2Label, (System_String_o *)gameObject, 0LL),
          closeLabel = this->fields.closeLabel,
          gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10279/*"PRESENT_BOX_NOTIFICATION_CLOSE"*/, 0LL),
          !closeLabel)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A48DD5 & 1) == 0 )
  {
    sub_1B863B8(&PresentBoxNotificationMenu_CallbackFunc_TypeInfo, value);
    byte_4A48DD5 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (PresentBoxNotificationMenu_o *)sub_1B868D4(v8);
        ...
        const MethodInfo *method)
{
  if ( (byte_4A48DDD & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_8719/*"MainPanel/BaseView/CloseButton"*/, method);
    byte_4A48DDD = 1;
  }
  return (System_String_o *)StringLiteral_8719/*"MainPanel/BaseView/CloseButton"*/;
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19CA368;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19CA320;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A48DDF & 1) == 0 )
  {
    sub_1B863B8(&PresentBoxNotificationMenu_Result_TypeInfo, *(_QWORD *)&result);
    byte_4A48DDF = 1;
  }
  v9[1] = 0LL;
