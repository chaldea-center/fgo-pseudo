        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5EC2F & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_PresentBoxNotificationMenu_OnMoveEnd__);
    byte_4A5EC2F = 1;
  }
...
void __fastcall PresentBoxNotificationMenu__Init(PresentBoxNotificationMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B8880C(message1Label, method);
  }
...
void __fastcall PresentBoxNotificationMenu__OnClickClose(PresentBoxNotificationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5EC32 & 1) == 0 )
  {
    sub_1B885B0(&Method_PresentBoxNotificationMenu_OnClickClose__);
    byte_4A5EC32 = 1;
  }
  v3 = Method_PresentBoxNotificationMenu_OnClickClose__;
  if ( (*((_BYTE *)Method_PresentBoxNotificationMenu_OnClickClose__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B885C8(Method_PresentBoxNotificationMenu_OnClickClose__);
...
void __fastcall PresentBoxNotificationMenu__OnMoveEnd(PresentBoxNotificationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5EC31 & 1) == 0 )
  {
    sub_1B885B0(&PresentBoxNotificationListViewManager_CallbackFunc_TypeInfo);
    sub_1B885B0(&Method_PresentBoxNotificationMenu_OnSelectBuyItem__);
    byte_4A5EC31 = 1;
  }
  switch ( this->fields.state )
  {
    ...
    case 3:
      ...
      v5 = (PresentBoxNotificationListViewManager_CallbackFunc_o *)sub_1B887FC(PresentBoxNotificationListViewManager_CallbackFunc_TypeInfo);
      ...
      sub_1B88554((ServantStatusBattleListViewItem_o *)&ItemListViewManager->fields.callbackFunc, (int32_t)v5, v9, v10);
      PresentBoxNotificationListViewManager__SetMode_45260660(ItemListViewManager, 1, v11);
      break;
    case 5:
      v3 = 6;
LABEL_6:
    ...
    case 6:
      ...
      if ( closeCallbackFunc )
      {
        ...
        sub_1B88554(p_closeCallbackFunc, 0, v12, v13);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5EC2E & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_PresentBoxNotificationMenu_OnMoveEnd__);
    sub_1B885B0(&StringLiteral_10436/*"PRESENT_BOX_NOTIFICATION_MESSAGE2"*/);
    sub_1B885B0(&StringLiteral_10435/*"PRESENT_BOX_NOTIFICATION_MESSAGE1"*/);
    sub_1B885B0(&StringLiteral_10434/*"PRESENT_BOX_NOTIFICATION_CLOSE"*/);
    byte_4A5EC2E = 1;
  }
  if ( !this->fields.state )
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10435/*"PRESENT_BOX_NOTIFICATION_MESSAGE1"*/, 0LL);
    if ( !message1Label )
      goto LABEL_13;
    UILabel__set_text(message1Label, (System_String_o *)gameObject, 0LL);
    message2Label = this->fields.message2Label;
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10436/*"PRESENT_BOX_NOTIFICATION_MESSAGE2"*/, 0LL);
    if ( !message2Label
      || (UILabel__set_text(message2Label, (System_String_o *)gameObject, 0LL),
          closeLabel = this->fields.closeLabel,
          gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10434/*"PRESENT_BOX_NOTIFICATION_CLOSE"*/, 0LL),
          !closeLabel)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5EC2B & 1) == 0 )
  {
    sub_1B885B0(&PresentBoxNotificationMenu_CallbackFunc_TypeInfo);
    byte_4A5EC2B = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19D3048;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19D3000;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5EC35 & 1) == 0 )
  {
    sub_1B885B0(&PresentBoxNotificationMenu_Result_TypeInfo);
    byte_4A5EC35 = 1;
  }
  v9[1] = 0LL;
