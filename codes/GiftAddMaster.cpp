void __fastcall GiftAddMaster___ctor(GiftAddMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4215C5A & 1) == 0 )
  {
    sub_B0D8A4(&Method_DataMasterBase_GiftAddMaster__GiftAddEntity__string___ctor__, method);
    byte_4215C5A = 1;
  }
  DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string____ctor(
    (DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string__o *)this,
    24,
    (const MethodInfo_2669F88 *)Method_DataMasterBase_GiftAddMaster__GiftAddEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4215C58 & 1) == 0 )
  {
    sub_B0D8A4(&Method_DataMasterBase_GiftAddMaster__GiftAddEntity__string__GetEntity__, *(_QWORD *)&giftId);
    byte_4215C58 = 1;
  }
  ...
  return (GiftAddEntity_o *)DataMasterBase_WarGroupMaster__WarGroupEntity__string___GetEntity(
                              ...
                              PK,
                              (const MethodInfo_266A024 *)Method_DataMasterBase_GiftAddMaster__GiftAddEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4215C5B & 1) == 0 )
  {
    sub_B0D8A4(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__GetEnumerator__, *(_QWORD *)&giftId);
    sub_B0D8A4(&GiftAddEntity_TypeInfo, v5);
...
LABEL_10:
    ...
    {
      v16 = (GiftAddEntity_o *)sub_B0DC70(v16);
LABEL_36:
      sub_B0D97C(v16);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4215C59 & 1) == 0 )
  {
    sub_B0D8A4(&Method_DataMasterBase_GiftAddMaster__GiftAddEntity__string__TryGetEntity__, entity);
    byte_4215C59 = 1;
  }
  ...
  return DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string___TryGetEntity(
           ...
           PK,
           (const MethodInfo_266A07C *)Method_DataMasterBase_GiftAddMaster__GiftAddEntity__string__TryGetEntity__);
}