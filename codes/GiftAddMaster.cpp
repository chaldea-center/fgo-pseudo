void GiftAddMaster___ctor(GiftAddMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4C5708C & 1) == 0 )
  {
    sub_1C3E564(&Method_DataMasterBase_GiftAddMaster__GiftAddEntity__string___ctor__);
    byte_4C5708C = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    25,
    (const MethodInfo_33B56EC *)Method_DataMasterBase_GiftAddMaster__GiftAddEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C5708A & 1) == 0 )
  {
    sub_1C3E564(&Method_DataMasterBase_GiftAddMaster__GiftAddEntity__string__GetEntity__);
    byte_4C5708A = 1;
  }
  ...
  return (GiftAddEntity_o *)DataMasterBase_object__object__object___GetEntity(
                              (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                              PK,
                              (const MethodInfo_33B7A10 *)Method_DataMasterBase_GiftAddMaster__GiftAddEntity__string__GetEntity__);
}
...
GiftAddEntity_o *GiftAddMaster__GetValidPriorDataById(GiftAddMaster_o *this, int32_t giftId, const MethodInfo *method)
{
  ...
  if ( (byte_4C5708D & 1) == 0 )
  {
    sub_1C3E564(&Method_System_Collections_ObjectModel_Collection_GiftAddEntity__GetEnumerator__);
    sub_1C3E564(&System_IDisposable_TypeInfo);
    sub_1C3E564(&System_Collections_Generic_IEnumerator_GiftAddEntity__TypeInfo);
    sub_1C3E564(&System_Collections_IEnumerator_TypeInfo);
    byte_4C5708D = 1;
  }
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
    sub_1C3E7C0(0, *(_QWORD *)&giftId);
  Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                 list,
                 (const MethodInfo_334C9A0 *)Method_System_Collections_ObjectModel_Collection_GiftAddEntity__GetEnumerator__);
  if ( !Enumerator )
    sub_1C3E7C0(0, v6);
  v8 = 0;
LABEL_6:
...
LABEL_11:
    ...
    {
LABEL_18:
      v17 = sub_1C8ED7C(Enumerator, System_Collections_Generic_IEnumerator_GiftAddEntity__TypeInfo, 0);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C5708B & 1) == 0 )
  {
    sub_1C3E564(&Method_DataMasterBase_GiftAddMaster__GiftAddEntity__string__TryGetEntity__);
    byte_4C5708B = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_33B7A5C *)Method_DataMasterBase_GiftAddMaster__GiftAddEntity__string__TryGetEntity__);
}