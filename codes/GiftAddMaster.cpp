void __fastcall GiftAddMaster___ctor(GiftAddMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4B02324 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataMasterBase_GiftAddMaster__GiftAddEntity__string___ctor__, method);
    byte_4B02324 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    25,
    (const MethodInfo_32B1804 *)Method_DataMasterBase_GiftAddMaster__GiftAddEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B02322 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataMasterBase_GiftAddMaster__GiftAddEntity__string__GetEntity__, *(_QWORD *)&giftId);
    byte_4B02322 = 1;
  }
  ...
  return (GiftAddEntity_o *)DataMasterBase_object__object__object___GetEntity(
                              (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                              PK,
                              (const MethodInfo_32B3B28 *)Method_DataMasterBase_GiftAddMaster__GiftAddEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B02325 & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Collections_ObjectModel_Collection_GiftAddEntity__GetEnumerator__, *(_QWORD *)&giftId);
    sub_1BC3008(&System_IDisposable_TypeInfo, v5);
    sub_1BC3008(&System_Collections_Generic_IEnumerator_GiftAddEntity__TypeInfo, v6);
    sub_1BC3008(&System_Collections_IEnumerator_TypeInfo, v7);
    byte_4B02325 = 1;
  }
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
    sub_1BC3264(0LL, *(_QWORD *)&giftId);
  Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                 list,
                 (const MethodInfo_324AE30 *)Method_System_Collections_ObjectModel_Collection_GiftAddEntity__GetEnumerator__);
  if ( !Enumerator )
    sub_1BC3264(0LL, v9);
  v11 = 0LL;
LABEL_6:
...
LABEL_11:
    ...
    {
LABEL_18:
      v20 = sub_1C13570(Enumerator, System_Collections_Generic_IEnumerator_GiftAddEntity__TypeInfo, 0LL);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B02323 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataMasterBase_GiftAddMaster__GiftAddEntity__string__TryGetEntity__, entity);
    byte_4B02323 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_32B3B74 *)Method_DataMasterBase_GiftAddMaster__GiftAddEntity__string__TryGetEntity__);
}