...
void CostSpriteListManager__ClearAllList(CostSpriteListManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E01E82 & 1) == 0 )
  {
    this = (CostSpriteListManager_o *)sub_1CE6700(&Method_System_Collections_Generic_List_int__Clear__);
    byte_4E01E82 = 1;
  }
...
void CostSpriteListManager__CreateList(CostSpriteListManager_o *this, int32_t type, const MethodInfo *method)
{
  ...
  if ( (byte_4E01E7F & 1) == 0 )
  {
    ...
    this = (CostSpriteListManager_o *)sub_1CE6700(&Method_System_Collections_Generic_List_int__get_Item__);
    byte_4E01E7F = 1;
  }
  klass = v4[1].klass;
  if ( !klass )
  ...
  if ( size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      v11 = sub_1CE694C(CostSpriteViewItem_TypeInfo);
...
void CostSpriteListManager__Init(CostSpriteListManager_o *this, const MethodInfo *method)
{
  ...
  v3 = (struct System_Collections_Generic_List_int__array *)sub_1CE67A8(
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.bannerIdAllList, (int32_t)v3, v5, v6, v7, v8, v9, v10);
  v11 = -3;
  v12 = 8;
  do
  {
...
void CostSpriteListManager__Load(CostSpriteListManager_o *this, const MethodInfo *method)
{
  ...
  v7 = DataManager__GetMasterData_object_(v5, (const MethodInfo_32043A8 *)Method_DataManager_GetMasterData_MapMaster___);
  ...
  v10 = (UISprite_o *)sub_1CE694C(UISprite_TypeInfo);
...
LABEL_12:
    ...
    {
LABEL_19:
      v22 = sub_1CBCA7C(v13, System_Collections_Generic_IEnumerator_WarEntity__TypeInfo, 0);
    }
        ...
        while ( 1 )
        {
          ...
          do
          {
            ...
            while ( 1 )
            {
              ...
              {
LABEL_42:
                v40 = sub_1CBCA7C(v36, System_Collections_IEnumerator_TypeInfo, 0);
              }
              ...
              {
LABEL_49:
                v44 = sub_1CBCA7C(v36, System_Collections_Generic_IEnumerator_QuestEntity__TypeInfo, 0);
              }
              ...
              if ( QuestEntity__getSpotId(v45, 0) == v34 )
              {
                        ...
                        (const MethodInfo_38E92BC *)Method_System_Collections_Generic_List_int__Contains__) )
                {
                  ...
                  if ( AtlasManager__SetEventUI(v10, ApSpriteFileName, 0) )
                  {
                    ...
                    if ( !v64 )
                      sub_1CE6958(successBannerIdList, v63);
...
LABEL_68:
                    System_Collections_Generic_List_int___AddWithResize(
                      successBannerIdList,
                      v63,
                      *(const MethodInfo_38E8F44 **)(*(_QWORD *)(v65[4] + 192LL) + 112LL));
                  }
                }
              }
            }
            ...
            {
LABEL_78:
              v71 = sub_1CBCA7C(v36, System_IDisposable_TypeInfo, 0);
            }
...
LABEL_91:
  ...
  if ( v13 )
  {
    ...
    {
LABEL_98:
      v75 = sub_1CBCA7C(v13, System_IDisposable_TypeInfo, 0);
    }
...
void CostSpriteListManager__SortAllList(CostSpriteListManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E01E81 & 1) == 0 )
  {
    this = (CostSpriteListManager_o *)sub_1CE6700(&Method_System_Collections_Generic_List_int__Sort__);
    byte_4E01E81 = 1;
  }
  bannerIdAllList = v2->fields.bannerIdAllList;
  if ( !bannerIdAllList )
