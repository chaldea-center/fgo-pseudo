...
bool QuestResetEntity__IsShowConfirmMessage(QuestResetEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4E051A0 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_22583/*"noConfirmMsg"*/);
    byte_4E051A0 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_22583/*"noConfirmMsg"*/, 0, 0) == 0;
}