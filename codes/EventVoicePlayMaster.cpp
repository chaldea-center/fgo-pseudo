void __fastcall EventVoicePlayMaster___ctor(EventVoicePlayMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A1FCEF & 1) == 0 )
  {
    sub_1B715CC(&Method_DataMasterBase_EventVoicePlayMaster__EventVoicePlayEntity__string___ctor__, method);
    byte_4A1FCEF = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    186,
    (const MethodInfo_30F8A78 *)Method_DataMasterBase_EventVoicePlayMaster__EventVoicePlayEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (EventVoicePlayEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                     (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                     PK,
                                     (const MethodInfo_30F8AB8 *)Method_DataMasterBase_EventVoicePlayMaster__EventVoicePlayEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( ValidEventVoicePlayEntity )
  {
    ...
    *eventVoicePlayEntity = ValidEventVoicePlayEntity;
    sub_1B71570((ServantStatusBattleListViewItem_o *)eventVoicePlayEntity, (int32_t)ValidEventVoicePlayEntity, v11, v12);
    return EventVoicePlayEntity__GetEventRewardVoiceRandList(v13, svtId, svtLimitCnt, v14);
  }
  else
  {
    *eventVoicePlayEntity = 0LL;
    sub_1B71570((ServantStatusBattleListViewItem_o *)eventVoicePlayEntity, 0, v11, v12);
    return 0LL;
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1FCF1 & 1) == 0 )
  {
    ...
    sub_1B715CC(&EventVoicePlayEntity_TypeInfo, v6);
    sub_1B715CC(&Method_System_Collections_Generic_List_EventVoicePlayEntity__Add__, v7);
    sub_1B715CC(&Method_System_Collections_Generic_List_EventVoicePlayEntity__ToArray__, v8);
    sub_1B715CC(&Method_System_Collections_Generic_List_EventVoicePlayEntity___ctor__, v9);
    sub_1B715CC(&System_Collections_Generic_List_EventVoicePlayEntity__TypeInfo, v10);
    byte_4A1FCF1 = 1;
  }
  v11 = (System_Collections_Generic_List_object__o *)sub_1B71818(System_Collections_Generic_List_EventVoicePlayEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v11,
    (const MethodInfo_34CFA2C *)Method_System_Collections_Generic_List_EventVoicePlayEntity___ctor__);
...
LABEL_17:
  ...
  return (EventVoicePlayEntity_array *)System_Collections_Generic_List_object___ToArray(
                                         v11,
                                         (const MethodInfo_34D1DB8 *)Method_System_Collections_Generic_List_EventVoicePlayEntity__ToArray__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1FCF2 & 1) == 0 )
  {
    ...
    sub_1B715CC(&System_Comparison_EventVoicePlayEntity__TypeInfo, v9);
    sub_1B715CC(&EventVoicePlayEntity_TypeInfo, v10);
    sub_1B715CC(&Method_System_Collections_Generic_List_EventVoicePlayEntity__Add__, v11);
    sub_1B715CC(&Method_System_Collections_Generic_List_EventVoicePlayEntity__Sort__, v12);
    sub_1B715CC(&Method_System_Collections_Generic_List_EventVoicePlayEntity___ctor__, v13);
    sub_1B715CC(&Method_System_Collections_Generic_List_EventVoicePlayEntity__get_Count__, v14);
    sub_1B715CC(&Method_System_Collections_Generic_List_EventVoicePlayEntity__get_Item__, v15);
    sub_1B715CC(&System_Collections_Generic_List_EventVoicePlayEntity__TypeInfo, v16);
    sub_1B715CC(&NetworkManager_TypeInfo, v17);
    sub_1B715CC(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, v18);
    sub_1B715CC(&Method_EventVoicePlayMaster___c__GetValidEventVoicePlayEntity_b__6_0__, v19);
    sub_1B715CC(&EventVoicePlayMaster___c_TypeInfo, v20);
    byte_4A1FCF2 = 1;
  }
  v21 = (System_Collections_Generic_List_object__o *)sub_1B71818(System_Collections_Generic_List_EventVoicePlayEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v21,
    (const MethodInfo_34CFA2C *)Method_System_Collections_Generic_List_EventVoicePlayEntity___ctor__);
  v22 = (System_Collections_Generic_List_object__o *)sub_1B71818(System_Collections_Generic_List_EventVoicePlayEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v22,
    (const MethodInfo_34CFA2C *)Method_System_Collections_Generic_List_EventVoicePlayEntity___ctor__);
    ...
    while ( 1 )
    {
      ...
      if ( *(_DWORD *)(list + 16) == eventId && *(_DWORD *)(list + 20) == slot )
      {
        ...
        else
        {
          ...
          sub_1B71570((ServantStatusBattleListViewItem_o *)(v34 + 4), v23, v28, v29);
        }
      }
      if ( Count == ++v27 )
        goto LABEL_20;
...
LABEL_20:
  ...
  if ( v21->fields._size >= 1 )
  {
    ...
    do
    {
      list = (int64_t)System_Collections_Generic_List_object___get_Item(
                        v21,
                        v35,
                        (const MethodInfo_34CFF90 *)Method_System_Collections_Generic_List_EventVoicePlayEntity__get_Item__);
      if ( !list )
        goto LABEL_46;
      ...
      if ( *(_QWORD *)(list + 72) <= v26 && v26 <= *(_QWORD *)(list + 80) && *(_DWORD *)(list + 48) == eventId )
      {
        ...
        *(_QWORD *)&v52.fields.fakeValue = v38;
        list = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46308268(v52, 0LL);
        if ( (_DWORD)list == svtId )
        {
          ...
          else
          {
            ...
            sub_1B71570((ServantStatusBattleListViewItem_o *)(v44 + 4), (int32_t)v36, v39, v40);
          }
        }
      }
    }
  ...
  if ( !v45 )
  {
    ...
    v45 = (System_Comparison_T__o *)sub_1B71818(System_Comparison_EventVoicePlayEntity__TypeInfo);
    ...
    sub_1B71570((ServantStatusBattleListViewItem_o *)&static_fields->__9__6_0, (int32_t)v45, v48, v49);
  }
  if ( !v22 )
    goto LABEL_46;
  System_Collections_Generic_List_object___Sort_55385380(
    v22,
    v45,
    (const MethodInfo_34D1D24 *)Method_System_Collections_Generic_List_EventVoicePlayEntity__Sort__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1FCEE & 1) == 0 )
  {
    sub_1B715CC(&Method_DataMasterBase_EventVoicePlayMaster__EventVoicePlayEntity__string__TryGetEntity__, entity);
    byte_4A1FCEE = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_30F8B08 *)Method_DataMasterBase_EventVoicePlayMaster__EventVoicePlayEntity__string__TryGetEntity__);
}
...
void __fastcall EventVoicePlayMaster___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A1FCF3 & 1) == 0 )
  {
    sub_1B715CC(&EventVoicePlayMaster___c_TypeInfo, v1);
    byte_4A1FCF3 = 1;
  }
  v2 = (Il2CppObject *)sub_1B71818(EventVoicePlayMaster___c_TypeInfo);
