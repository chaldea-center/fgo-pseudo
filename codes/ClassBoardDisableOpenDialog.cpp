void __fastcall ClassBoardDisableOpenDialog___ctor(ClassBoardDisableOpenDialog_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.itemLabelForEffect.fields.y = xmmword_BD8050;
  *(_OWORD *)&this->fields.descriptionPosForEffect.fields.z = xmmword_BD7910;
  *(_OWORD *)&this->fields.itemInfoWindowBtnPosForEffect.fields.x = xmmword_BD7820;
  *(_OWORD *)&this->fields.itemObjForLock.fields.y = xmmword_BD8350;
  *(_OWORD *)&this->fields.itemLabelForLock.fields.z = xmmword_BD7B50;
  *(_OWORD *)&this->fields.closeBtnPosForLock.fields.x = xmmword_BD8060;
...
void __fastcall ClassBoardDisableOpenDialog__Close(ClassBoardDisableOpenDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3A674 & 1) == 0 )
  {
    ...
    sub_1BD3458(&Method_ClassBoardDisableOpenDialog_EndClose__, v3);
    byte_4B3A674 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3A673 & 1) == 0 )
  {
    sub_1BD3458(&Method_ClassBoardDisableOpenDialog_OnClickClose__, method);
    byte_4B3A673 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_ClassBoardDisableOpenDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BD3470(Method_ClassBoardDisableOpenDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BD3458(&System_Action_TypeInfo, method);
    sub_1BD3458(&Method_ClassBoardDisableOpenDialog__OnClickItemInfoListWindow_b__25_0__, v3);
    byte_4B3A676 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3A672 & 1) == 0 )
  {
    ...
    sub_1BD3458(&Method_ClassBoardDisableOpenDialog_EndOpen__, v11);
    sub_1BD3458(&ClassBoardLock_TypeInfo, v12);
    sub_1BD3458(&IClassBoardLockModel_TypeInfo, v13);
    sub_1BD3458(&IClassBoardSquareModel_TypeInfo, v14);
    sub_1BD3458(&LocalizationManager_TypeInfo, v15);
    sub_1BD3458(&StringLiteral_3522/*"CLASS_BOARD_DISABLE_OPEN_DIALOG_DETAIL"*/, v16);
    sub_1BD3458(&StringLiteral_3524/*"CLASS_BOARD_DISABLE_OPEN_DIALOG_TITLE_LOCK"*/, v17);
    sub_1BD3458(&StringLiteral_3521/*"CLASS_BOARD_DISABLE_OPEN_DIALOG_CLOSE"*/, v18);
    sub_1BD3458(&StringLiteral_3523/*"CLASS_BOARD_DISABLE_OPEN_DIALOG_TITLE_EFFECT"*/, v19);
    byte_4B3A672 = 1;
  }
  v72 = 0;
  v71 = 0LL;
  ...
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.closeFunc, (int64_t)closeFunc, v20, v21, v22, v23, v24, v25);
  if ( square
  ...
  if ( !v27 )
  {
    itemListObj = LocalizationManager__Get((System_String_o *)StringLiteral_3523/*"CLASS_BOARD_DISABLE_OPEN_DIALOG_TITLE_EFFECT"*/, 0LL);
    if ( titleLabel )
    {
...
LABEL_59:
    sub_1BD36B4(itemListObj, v30);
  }
  itemListObj = LocalizationManager__Get((System_String_o *)StringLiteral_3524/*"CLASS_BOARD_DISABLE_OPEN_DIALOG_TITLE_LOCK"*/, 0LL);
  if ( !titleLabel )
    goto LABEL_59;
  UILabel__set_text(titleLabel, itemListObj, 0LL);
  ...
  {
LABEL_18:
    v36 = sub_1C25438(itemListObj, IClassBoardLockModel_TypeInfo, 0LL);
  }
  ...
  *(_QWORD *)&v73.fields.Type = &v71;
  ...
  if ( ((unsigned __int8)itemListObj & 1) != 0 )
  {
    ...
    {
LABEL_34:
      v48 = sub_1C25438(itemListObj, IClassBoardLockModel_TypeInfo, 0LL);
    }
  ...
  {
LABEL_48:
    v63 = sub_1C25438(v59, IClassBoardSquareModel_TypeInfo, 6LL);
  }
...
LABEL_54:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  itemListObj = LocalizationManager__Get((System_String_o *)StringLiteral_3522/*"CLASS_BOARD_DISABLE_OPEN_DIALOG_DETAIL"*/, 0LL);
  if ( !descriptionLabel )
    goto LABEL_59;
  UILabel__set_text(descriptionLabel, itemListObj, 0LL);
  closeBtnLabel = this->fields.closeBtnLabel;
  itemListObj = LocalizationManager__Get((System_String_o *)StringLiteral_3521/*"CLASS_BOARD_DISABLE_OPEN_DIALOG_CLOSE"*/, 0LL);
  if ( !closeBtnLabel )
    goto LABEL_59;
