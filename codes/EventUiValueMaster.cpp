void __fastcall EventUiValueMaster___ctor(EventUiValueMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A2E14E & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_EventUiValueMaster__EventUiValueEntity__string___ctor__, method);
    byte_4A2E14E = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    273,
    (const MethodInfo_30FFA98 *)Method_DataMasterBase_EventUiValueMaster__EventUiValueEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E14F & 1) == 0 )
  {
    sub_1B761C0(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__, *(_QWORD *)&objectId);
    sub_1B761C0(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Item__, v5);
    sub_1B761C0(&EventUiValueEntity_TypeInfo, v6);
    sub_1B761C0(&Method_System_Collections_Generic_List_EventUiValueEntity__Add__, v7);
    sub_1B761C0(&Method_System_Collections_Generic_List_EventUiValueEntity__ToArray__, v8);
    sub_1B761C0(&Method_System_Collections_Generic_List_EventUiValueEntity___ctor__, v9);
    sub_1B761C0(&System_Collections_Generic_List_EventUiValueEntity__TypeInfo, v10);
    byte_4A2E14F = 1;
  }
  v11 = (System_Collections_Generic_List_object__o *)sub_1B7640C(System_Collections_Generic_List_EventUiValueEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v11,
    (const MethodInfo_34D6DA0 *)Method_System_Collections_Generic_List_EventUiValueEntity___ctor__);
...
LABEL_20:
  ...
  return (EventUiValueEntity_array *)System_Collections_Generic_List_object___ToArray(
                                       v11,
                                       (const MethodInfo_34D912C *)Method_System_Collections_Generic_List_EventUiValueEntity__ToArray__);
}