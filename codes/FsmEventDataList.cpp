...
void __fastcall FsmEventDataList__set_Length(FsmEventDataList_o *this, int32_t value, const MethodInfo *method)
{
  ...
  if ( (byte_4B6802E & 1) == 0 )
  {
    sub_1BE4ACC(&FsmEventData___TypeInfo, *(_QWORD *)&value);
    sub_1BE4ACC(&FsmEventData_TypeInfo, v5);
    byte_4B6802E = 1;
  }
  eventDataList = this->fields.eventDataList;
  ...
  if ( max_length != value )
  {
    v10 = sub_1BE4B74(FsmEventData___TypeInfo, (unsigned int)value);
    ...
    if ( value >= 1 )
    {
      ...
      do
      {
        if ( (__int64)v19 >= v20 )
        {
          v24 = (FsmEventData_o *)sub_1BE4D18(FsmEventData_TypeInfo);
...
LABEL_21:
        ...
        if ( v24 )
        {
          v10 = sub_1BE4C08(v24, *(_QWORD *)(*(_QWORD *)v18 + 64LL));
          if ( !v10 )
          {
            v26 = sub_1BE4D4C(0LL);
            sub_1BE4BF4(v26, 0LL);
        ...
        sub_1BE4A70(v22, (int64_t)v24, v12, v13, v14, v15, v16, v17);
        ++v19;
    ...
    sub_1BE4A70(p_eventDataList, (int64_t)v18, v12, v13, v14, v15, v16, v17);
  }
}
