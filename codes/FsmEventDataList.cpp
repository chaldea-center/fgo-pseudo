...
void __fastcall FsmEventDataList__set_Length(FsmEventDataList_o *this, int32_t value, const MethodInfo *method)
{
  ...
  if ( (byte_4AB7159 & 1) == 0 )
  {
    sub_1BAB41C(&FsmEventData___TypeInfo, *(_QWORD *)&value);
    sub_1BAB41C(&FsmEventData_TypeInfo, v5);
    byte_4AB7159 = 1;
  }
  eventDataList = this->fields.eventDataList;
  ...
  if ( max_length != value )
  {
    v10 = sub_1BAB4C4(FsmEventData___TypeInfo, (unsigned int)value);
    ...
    if ( value >= 1 )
    {
      ...
      do
      {
        if ( (__int64)v15 >= v16 )
        {
          v20 = (FsmEventData_o *)sub_1BAB668(FsmEventData_TypeInfo);
...
LABEL_21:
        ...
        if ( v20 )
        {
          v10 = sub_1BAB558(v20, *(_QWORD *)(*(_QWORD *)v14 + 64LL));
          if ( !v10 )
          {
            v22 = sub_1BAB69C(0LL);
            sub_1BAB544(v22, 0LL);
        ...
        sub_1BAB3C0(v18, (int32_t)v20, v12, v13);
        ++v15;
    ...
    sub_1BAB3C0(p_eventDataList, (int32_t)v14, v12, v13);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.targetFSM, (int32_t)value, (int32_t)method, v3);
}