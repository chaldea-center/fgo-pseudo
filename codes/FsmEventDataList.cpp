...
void FsmEventDataList__set_Length(FsmEventDataList_o *this, int32_t value, const MethodInfo *method)
{
  ...
  if ( (byte_4D320BC & 1) == 0 )
  {
    sub_1C93AD4(&FsmEventData___TypeInfo);
    sub_1C93AD4(&FsmEventData_TypeInfo);
    byte_4D320BC = 1;
  }
  eventDataList = this->fields.eventDataList;
  ...
  if ( max_length != value )
  {
    v9 = sub_1C93B7C(FsmEventData___TypeInfo, (unsigned int)value);
    v17 = (unsigned int *)v9;
    if ( value >= 1 )
    {
      v18 = 0;
      ...
      do
      {
        if ( (__int64)v18 >= v19 )
        {
          v23 = (FsmEventData_o *)sub_1C93D20(FsmEventData_TypeInfo);
...
LABEL_21:
        ...
        if ( v23 )
        {
          v9 = sub_1C93C10(v23, *(_QWORD *)(*(_QWORD *)v17 + 64LL));
          if ( !v9 )
          {
            v25 = sub_1C93D50(0);
            sub_1C93BFC(v25, 0);
        ...
        sub_1C93A78(v21, (int32_t)v23, v11, v12, v13, v14, v15, v16);
        ++v18;
    ...
    sub_1C93A78(p_eventDataList, (int32_t)v17, v11, v12, v13, v14, v15, v16);
  }
}
