...
void FsmEventDataList__set_Length(FsmEventDataList_o *this, int32_t value, const MethodInfo *method)
{
  ...
  if ( (byte_4CB7A05 & 1) == 0 )
  {
    sub_1C6BA08(&FsmEventData___TypeInfo);
    sub_1C6BA08(&FsmEventData_TypeInfo);
    byte_4CB7A05 = 1;
  }
  eventDataList = this->fields.eventDataList;
  ...
  if ( max_length != value )
  {
    v9 = sub_1C6BAB0(FsmEventData___TypeInfo, (unsigned int)value);
    v13 = (unsigned int *)v9;
    if ( value >= 1 )
    {
      v14 = 0;
      ...
      do
      {
        if ( (__int64)v14 >= v15 )
        {
          v19 = (FsmEventData_o *)sub_1C6BC54(FsmEventData_TypeInfo);
...
LABEL_21:
        ...
        if ( v19 )
        {
          v9 = sub_1C6BB44(v19, *(_QWORD *)(*(_QWORD *)v13 + 64LL));
          if ( !v9 )
          {
            v21 = sub_1C6BC84(0);
            sub_1C6BB30(v21, 0);
        ...
        sub_1C6B9AC(v17, (int32_t)v19, v11, v12);
        ++v14;
    ...
    sub_1C6B9AC(p_eventDataList, (int32_t)v13, v11, v12);
  }
}
...
void FsmEventDataList__set_TargetFSM(FsmEventDataList_o *this, PlayMakerFSM_o *value, const MethodInfo *method)
{
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.targetFSM, (int32_t)value, (int32_t)method, v3);
}