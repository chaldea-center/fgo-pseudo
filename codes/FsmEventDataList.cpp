...
void __fastcall FsmEventDataList__SendEvent(FsmEventDataList_o *this, int32_t index, const MethodInfo *method)
{
  ...
  if ( ((unsigned __int8)v6 & 1) != 0 )
  {
    ...
    if ( !v10 || (v6 = this->fields.targetFSM) == 0LL )
LABEL_12:
      sub_1BC3264(v6, v7);
    PlayMakerFSM__SendEvent(v6, v10->fields.eventData, 0LL);
  }
}
...
void __fastcall FsmEventDataList__set_Length(FsmEventDataList_o *this, int32_t value, const MethodInfo *method)
{
  ...
  if ( (byte_4B036B1 & 1) == 0 )
  {
    sub_1BC3008(&FsmEventData___TypeInfo, *(_QWORD *)&value);
    sub_1BC3008(&FsmEventData_TypeInfo, v5);
    byte_4B036B1 = 1;
  }
  eventDataList = this->fields.eventDataList;
  ...
  if ( max_length != value )
  {
    v10 = sub_1BC30B0(FsmEventData___TypeInfo, (unsigned int)value);
    ...
    if ( value >= 1 )
    {
      ...
      v18 = (CGThumbnailListItem_o *)(v10 + 32);
      do
      {
        if ( (__int64)v15 >= v16 )
        {
          v20 = (FsmEventData_o *)sub_1BC3254(FsmEventData_TypeInfo);
...
LABEL_21:
        ...
        if ( v20 )
        {
          v10 = sub_1BC3144(v20, *(_QWORD *)(*(_QWORD *)v14 + 64LL));
          if ( !v10 )
          {
            v22 = sub_1BC3288(0LL);
            sub_1BC3130(v22, 0LL);
        ...
        if ( v15 >= v14[6] )
          goto LABEL_21;
        v18->klass = (CGThumbnailListItem_c *)v20;
        sub_1BC2FAC(v18, (int32_t)v20, v12, v13);
        ++v15;
        v18 = (CGThumbnailListItem_o *)((char *)v18 + 8);
      }
      while ( v17 != v15 );
    }
    p_eventDataList->klass = (CGThumbnailListItem_c *)v14;
    sub_1BC2FAC(p_eventDataList, (int32_t)v14, v12, v13);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.targetFSM, (int32_t)value, (int32_t)method, v3);
}