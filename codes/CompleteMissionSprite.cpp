        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B09A & 1) == 0 )
  {
    ...
    this = (CompleteMissionSprite_o *)sub_1BCAFF8(&UnityEngine_Object_TypeInfo, v8);
    byte_4B1B09A = 1;
  }
  if ( !assetData )
    goto LABEL_12;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B094 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_CompleteMissionSprite___c__DisplayClass12_0__InitBtn_b__0__, v5);
    sub_1BCAFF8(&CompleteMissionSprite___c__DisplayClass12_0_TypeInfo, v6);
    byte_4B1B094 = 1;
  }
  v7 = sub_1BCB244(CompleteMissionSprite___c__DisplayClass12_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BCAFF8(&System_Action_TypeInfo, *(_QWORD *)&eventId);
    sub_1BCAFF8(&Method_CompleteMissionSprite___c__DisplayClass13_0__InitFrame_b__0__, v5);
    sub_1BCAFF8(&CompleteMissionSprite___c__DisplayClass13_0_TypeInfo, v6);
    byte_4B1B095 = 1;
  }
  v7 = sub_1BCB244(CompleteMissionSprite___c__DisplayClass13_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v7, 0LL);
  if ( !v7 )
    sub_1BCB254(v8, v9);
  *(_QWORD *)(v7 + 16) = this;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BCAFF8(&System_Action_TypeInfo, *(_QWORD *)&eventId);
    sub_1BCAFF8(&Method_CompleteMissionSprite___c__DisplayClass14_0__InitPanel_b__0__, v9);
    sub_1BCAFF8(&CompleteMissionSprite___c__DisplayClass14_0_TypeInfo, v10);
    byte_4B1B096 = 1;
  }
  v11 = sub_1BCB244(CompleteMissionSprite___c__DisplayClass14_0_TypeInfo);
  ...
  *(_QWORD *)(v11 + 40) = listBgSprite;
  sub_1BCAF9C((CGThumbnailListItem_o *)(v11 + 40), (int32_t)listBgSprite, v16, v17);
  v18 = *(_DWORD *)(v11 + 16);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BCAFF8(&System_Action_TypeInfo, *(_QWORD *)&eventId);
    sub_1BCAFF8(&Method_CompleteMissionSprite__InitTarget_b__15_0__, v5);
    byte_4B1B097 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B098 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_CompleteMissionSprite_LoadEventUIEnd__, v10);
    sub_1BCAFF8(&int_TypeInfo, v11);
    sub_1BCAFF8(&AssetLoader_LoadEndDataHandler_TypeInfo, v12);
    sub_1BCAFF8(&StringLiteral_6223/*"EventUI/Prefabs/{0}"*/, v13);
    byte_4B1B098 = 1;
  }
...
LABEL_9:
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.eventUILoadCallbackFunc, (int32_t)v17, v18, v19);
  if ( !this->fields.isEventUILoad )
  {
    ...
    v25 = System_String__Format((System_String_o *)StringLiteral_6223/*"EventUI/Prefabs/{0}"*/, v24, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B099 & 1) == 0 )
  {
    sub_1BCAFF8(&int_TypeInfo, assetData);
    sub_1BCAFF8(&StringLiteral_5302/*"DownloadEventUIAtlas{0}01"*/, v6);
    byte_4B1B099 = 1;
  }
  if ( this->fields.isEventUILoad )
  {
    ...
    v11 = (CompleteMissionSprite_o *)System_String__Format((System_String_o *)StringLiteral_5302/*"DownloadEventUIAtlas{0}01"*/, v10, 0LL);
    ...
    sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.eventUIDownloadAtlas, (int32_t)UIAtlasFromAssetData, v14, v15);
  }
...
void __fastcall CompleteMissionSprite__ReleaseEventUI(CompleteMissionSprite_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.isEventUILoad )
  {
    ...
    v9 = System_String__Format((System_String_o *)StringLiteral_6223/*"EventUI/Prefabs/{0}"*/, v8, 0LL);
    if ( !AssetManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.eventUIAssetData, 0, v11, v12);
}
...
void __fastcall CompleteMissionSprite___InitTarget_b__15_0(CompleteMissionSprite_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1B09D & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_20540/*"img_txt_target_panel"*/, method);
    byte_4B1B09D = 1;
  }
  CompleteMissionSprite__SetEventUI(this, this->fields.sprite, (System_String_o *)StringLiteral_20540/*"img_txt_target_panel"*/, v2);
}
...
void __fastcall CompleteMissionSprite___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B1B09E & 1) == 0 )
  {
    sub_1BCAFF8(&CompleteMissionSprite___c_TypeInfo, v1);
    byte_4B1B09E = 1;
  }
  v2 = (Il2CppObject *)sub_1BCB244(CompleteMissionSprite___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  CompleteMissionSprite___c_TypeInfo->static_fields->__9 = (struct CompleteMissionSprite___c_o *)v2;
  sub_1BCAF9C((CGThumbnailListItem_o *)CompleteMissionSprite___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B09F & 1) == 0 )
  {
    ...
    this = (CompleteMissionSprite___c__DisplayClass12_0_o *)sub_1BCAFF8(&StringLiteral_17505/*"button_mission_{0}"*/, v6);
    byte_4B1B09F = 1;
  }
  ...
  v10 = System_String__Format((System_String_o *)StringLiteral_17505/*"button_mission_{0}"*/, v9, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BCAFF8(&int_TypeInfo, method);
    this = (CompleteMissionSprite___c__DisplayClass13_0_o *)sub_1BCAFF8(&StringLiteral_20206/*"img_flame_{0}"*/, v6);
    byte_4B1B0A0 = 1;
  }
  _4__this = v5->fields.__4__this;
  if ( !_4__this )
  ...
  eventId = v5->fields.eventId;
  v9 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &eventId, v2, v3, v4);
  v10 = System_String__Format((System_String_o *)StringLiteral_20206/*"img_flame_{0}"*/, v9, 0LL);
  CompleteMissionSprite__SetEventUI(_4__this, sprite, v10, v11);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B0A1 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_UnityEngine_Component_GetComponent_UISprite___, v7);
    sub_1BCAFF8(&int_TypeInfo, v8);
    sub_1BCAFF8(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v9);
    sub_1BCAFF8(&Method_CompleteMissionSprite___c__InitPanel_b__14_1__, v10);
    sub_1BCAFF8(&CompleteMissionSprite___c_TypeInfo, v11);
    sub_1BCAFF8(&StringLiteral_21418/*"mission_bg_{0}"*/, v12);
    sub_1BCAFF8(&StringLiteral_21430/*"mission_on_{0}"*/, v13);
    this = (CompleteMissionSprite___c__DisplayClass14_0_o *)sub_1BCAFF8(&StringLiteral_19120/*"event_tab_type5_0"*/, v14);
    byte_4B1B0A1 = 1;
  }
  if ( v5->fields.panelCount >= 1 )
  {
    ...
    while ( 1 )
    {
      this = (CompleteMissionSprite___c__DisplayClass14_0_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38F8AD8 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
      if ( !this )
        break;
      ...
      this = (CompleteMissionSprite___c__DisplayClass14_0_o *)System_String__Format(
                                                                (System_String_o *)StringLiteral_21430/*"mission_on_{0}"*/,
                                                                v22,
                                                                0LL);
      if ( !_4__this )
        break;
...
LABEL_12:
  ...
  v27 = System_String__Format((System_String_o *)StringLiteral_21418/*"mission_bg_{0}"*/, v26, 0LL);
  ...
  CompleteMissionSprite__SetEventUI(
    ...
    (System_String_o *)StringLiteral_19120/*"event_tab_type5_0"*/,
    v29);
  this = (CompleteMissionSprite___c__DisplayClass14_0_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38F8AD8 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !this )
    goto LABEL_25;
  ...
  if ( !monitor )
  {
    ...
    sub_1BCAF9C((CGThumbnailListItem_o *)&static_fields->__9__14_1, (int32_t)monitor, v37, v38);
  }
  if ( !v32 )
    goto LABEL_25;
