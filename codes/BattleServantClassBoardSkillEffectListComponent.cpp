void BattleServantClassBoardSkillEffectListComponent___cctor(const MethodInfo *method)
{
  if ( (byte_593BF6A & 1) == 0 )
  {
    sub_21FFC50(&BattleServantClassBoardSkillEffectListComponent_TypeInfo);
    byte_593BF6A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_593BF68 & 1) == 0 )
  {
    ...
    sub_21FFC50(&Method_BattleServantClassBoardSkillEffectListComponent__Init_b__2_0__);
  ...
  v4 = (ClassBoardResourceCatalogAssetBundle_o *)sub_21FFEBC(v3);
  ...
  v8 = (AtlasManagerUnit_o *)sub_21FFEBC(AtlasManagerUnit_TypeInfo);
  ...
  sub_21FFBF4(
    ...
    v13,
    v14);
  v15 = sub_21FFD10(System_Action_Action____TypeInfo, 1);
  ...
  *(_QWORD *)(v15 + 32) = v16;
  ...
  v23 = (ChainableActionParallel_o *)sub_21FFEBC(ChainableActionParallel_TypeInfo);
  ChainableActionParallel___ctor_55903544(v23, (System_Action_Action__array *)v15, 0);
  if ( !v23 )
LABEL_8:
    sub_21FFECC(v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  BattleServantClassBoardSkillEffectListComponent_o *v60; // [xsp+8h] [xbp-D8h]
  ...
  if ( (byte_593BF69 & 1) == 0 )
  {
    ...
    sub_21FFC50(&Method_UnityEngine_GameObject_GetComponent_ClassBoardEffectListDialogSkillDetailComponent___);
    sub_21FFC50(&Method_UnityEngine_GameObject_GetComponentsInChildren_ClassBoardEffectListDialogSkillDetailComponent___);
    sub_21FFC50(&Method_System_Collections_Generic_List_ClassBoardEffectListDialogSkillListComponent_SkillDispData__AddRange__);
  ...
  if ( !skillListParent )
    goto LABEL_64;
  skillListParent = UnityEngine_GameObject__GetComponentsInChildren_object__59262092(
                      (UnityEngine_GameObject_o *)skillListParent,
                      (const MethodInfo_388448C *)Method_UnityEngine_GameObject_GetComponentsInChildren_ClassBoardEffectListDialogSkillDetailComponent___);
  if ( !skillListParent )
    goto LABEL_64;
...
LABEL_64:
    sub_21FFECC(skillListParent, svtData);
  }
LABEL_11:
  if ( !svtData )
    return 0;
  ...
  skillListParent = DataManager__GetMaster_object_((const MethodInfo_3822E50 *)Method_DataManager_GetMaster_ClassBoardClassMaster___);
  if ( !skillListParent )
    goto LABEL_64;
  if ( !ClassBoardClassMaster__TryGetEntityListFromClassId(
    ...
    return 0;
  v60 = this;
  v15 = (System_Collections_Generic_List_object__o *)sub_21FFEBC(System_Collections_Generic_List_ClassBoardEffectListDialogSkillListComponent_SkillDispData__TypeInfo);
  ...
  *(_QWORD *)&v63.fields._index = &v65;
  ...
  while ( 1 )
  {
    ...
    if ( !current )
      sub_21FFECC(IsForceToApplyBoardSquareIds, v22);
    ...
    OpenSkillList = (System_Collections_Generic_IEnumerable_T__o *)ClassBoardEffectListDialogSkillListComponent__GetOpenSkillList(
                                                                     ...
                                                                     0);
    if ( !v15 )
      sub_21FFECC(OpenSkillList, OpenSkillList);
    System_Collections_Generic_List_object___AddRange(
      v15,
      OpenSkillList,
      (const MethodInfo_444FD3C *)Method_System_Collections_Generic_List_ClassBoardEffectListDialogSkillListComponent_SkillDispData__AddRange__);
  }
  ...
  *(_QWORD *)&v63.fields._index = &v64;
  while ( 1 )
  {
    ...
    if ( (int)v29 >= (int)v33 )
    {
      v36 = v60->fields.skillListParent;
      if ( !v36 )
        sub_21FFECC(0, v32);
      skillInfoPrefab = v60->fields.skillInfoPrefab;
      transform = UnityEngine_GameObject__get_transform(v36, 0);
      Object = BaseMonoBehaviour__createObject((BaseMonoBehaviour_o *)v60, skillInfoPrefab, transform, 0, 0);
      if ( !Object )
        sub_21FFECC(0, v40);
      Component_object = UnityEngine_GameObject__GetComponent_object_(
                           Object,
                           (const MethodInfo_3883A78 *)Method_UnityEngine_GameObject_GetComponent_ClassBoardEffectListDialogSkillDetailComponent___);
    }
    else
    {
      if ( v29 >= v33 )
    ...
    if ( !v41 )
    {
      ...
      if ( !byte_5931945 )
      {
        v47 = sub_21FFC50(&UnityEngine_Vector3_TypeInfo);
        byte_5931945 = 1;
      }
      if ( !v49 )
        sub_21FFECC(v47, v48);
      ...
      if ( !byte_5931946 )
      {
        v50 = sub_21FFC50(&UnityEngine_Quaternion_TypeInfo);
        byte_5931946 = 1;
      }
      if ( !v52 )
        sub_21FFECC(v50, v51);
      ...
      v55 = (Il2CppObject *)j_il2cpp_value_box_0(qword_594C070, &monitor);
      v56 = System_String__Format((System_String_o *)StringLiteral_24719/*"skill_{0:D5}"*/, v55, 0);
      ClassBoardEffectListDialogSkillDetailComponent__SetIconFromBattleServantWindow(
        (ClassBoardEffectListDialogSkillDetailComponent_o *)Component_object,
        v60->fields.atlasManagerUnit,
        v56,
        0);
      ++v29;
    }
  ...
  p_DefaultSkillOffset = &v58->static_fields->DefaultSkillOffset;
  result = 1;
  v60->fields.skillOffset = v30 + *p_DefaultSkillOffset;
  return result;
}
