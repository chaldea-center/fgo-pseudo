void BattleServantClassBoardSkillEffectListComponent___cctor(const MethodInfo *method)
{
  if ( (byte_4CB99CA & 1) == 0 )
  {
    sub_1C6BA08(&BattleServantClassBoardSkillEffectListComponent_TypeInfo);
    byte_4CB99CA = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB99C8 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_BattleServantClassBoardSkillEffectListComponent__Init_b__2_0__);
  ...
  v3 = (ClassBoardResourceCatalogAssetBundle_o *)sub_1C6BC54(ClassBoardResourceCatalogAssetBundle_TypeInfo);
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.atlasManagerUnit, (int32_t)v7, v8, v9);
  v10 = sub_1C6BAB0(System_Action_Action____TypeInfo, 1);
  ...
  *(_QWORD *)(v10 + 32) = v11;
  ...
  v14 = (ChainableActionParallel_o *)sub_1C6BC54(ChainableActionParallel_TypeInfo);
  ChainableActionParallel___ctor_49344196(v14, (System_Action_Action__array *)v10, 0);
  if ( !v14 )
LABEL_8:
    sub_1C6BC60(v4, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB99C9 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_UnityEngine_GameObject_GetComponentsInChildren_ClassBoardEffectListDialogSkillDetailComponent___);
  ...
  if ( !skillListParent )
    goto LABEL_64;
  skillListParent = UnityEngine_GameObject__GetComponentsInChildren_object__51985744(
                      (UnityEngine_GameObject_o *)skillListParent,
                      (const MethodInfo_3193D50 *)Method_UnityEngine_GameObject_GetComponentsInChildren_ClassBoardEffectListDialogSkillDetailComponent___);
  if ( !skillListParent )
    goto LABEL_64;
...
LABEL_64:
    sub_1C6BC60(skillListParent, svtData);
  }
LABEL_11:
  if ( !svtData )
    return 0;
  ...
  skillListParent = DataManager__GetMaster_object_((const MethodInfo_313B314 *)Method_DataManager_GetMaster_ClassBoardClassMaster___);
  if ( !skillListParent )
    goto LABEL_64;
  if ( !ClassBoardClassMaster__TryGetEntityListFromClassId(
          ...
          0) )
    return 0;
  v14 = (System_Collections_Generic_List_object__o *)sub_1C6BC54(System_Collections_Generic_List_ClassBoardEffectListDialogSkillListComponent_SkillDispData__TypeInfo);
  ...
  while ( 1 )
  {
    ...
    if ( !current )
      sub_1C6BC60(IsForceToApplyBoardSquareIds, v21);
    ...
    OpenSkillList = (System_Collections_Generic_IEnumerable_T__o *)ClassBoardEffectListDialogSkillListComponent__GetOpenSkillList(
                                                                     ...
                                                                     0);
    if ( !v14 )
      sub_1C6BC60(OpenSkillList, OpenSkillList);
  ...
  while ( 1 )
  {
    ...
    if ( !v39 )
    {
      ...
      if ( !byte_4CAFC0E )
      {
        v45 = sub_1C6BA08(&UnityEngine_Vector3_TypeInfo);
        byte_4CAFC0E = 1;
      }
      if ( !v47 )
        sub_1C6BC60(v45, v46);
      ...
      if ( !byte_4CAFC0F )
      {
        v48 = sub_1C6BA08(&UnityEngine_Quaternion_TypeInfo);
        byte_4CAFC0F = 1;
      }
      if ( !v50 )
        sub_1C6BC60(v48, v49);
      ...
      v54 = System_String__Format((System_String_o *)StringLiteral_23617/*"skill_{0:D5}"*/, v53, 0);
