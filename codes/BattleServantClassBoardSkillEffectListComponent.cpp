        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5189A & 1) == 0 )
  {
    sub_1B863B8(&System_Action_Action____TypeInfo, method);
    sub_1B863B8(&System_Action_Action__TypeInfo, v3);
    sub_1B863B8(&AtlasManagerUnit_TypeInfo, v4);
    sub_1B863B8(&Method_BattleServantClassBoardSkillEffectListComponent__Init_b__1_0__, v5);
    sub_1B863B8(&ChainableActionParallel_TypeInfo, v6);
    sub_1B863B8(&ClassBoardResourceCatalogAssetBundle_TypeInfo, v7);
    byte_4A5189A = 1;
  }
  v8 = (ClassBoardResourceCatalogAssetBundle_o *)sub_1B86604(ClassBoardResourceCatalogAssetBundle_TypeInfo);
  ...
  v12 = (AtlasManagerUnit_o *)sub_1B86604(AtlasManagerUnit_TypeInfo);
  AtlasManagerUnit___ctor(v12, IconAtlasPath, 0LL, 0LL);
  this->fields.atlasManagerUnit = v12;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.atlasManagerUnit, (int32_t)v12, v13, v14);
  v15 = sub_1B86460(System_Action_Action____TypeInfo, 1LL);
  v16 = (System_Action_object__o *)sub_1B86604(System_Action_Action__TypeInfo);
  ...
  if ( !*(_DWORD *)(v15 + 24) )
    sub_1B8661C(v9, v10);
  *(_QWORD *)(v15 + 32) = v16;
  sub_1B8635C((CGThumbnailListItem_o *)(v15 + 32), (int32_t)v16, v17, v18);
  v19 = (ChainableActionParallel_o *)sub_1B86604(ChainableActionParallel_TypeInfo);
  ChainableActionParallel___ctor_47544852(v19, (System_Action_Action__array *)v15, 0LL);
  if ( !v19 )
LABEL_8:
    sub_1B86614(v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5189B & 1) == 0 )
  {
    sub_1B863B8(&ClassBoardEffectListDialogSkillListComponent_TypeInfo, svtData);
    sub_1B863B8(&Method_DataManager_GetMaster_ClassBoardClassMaster___, v5);
    sub_1B863B8(&DataManager_TypeInfo, v6);
    sub_1B863B8(&Method_System_Collections_Generic_List_Enumerator_ClassBoardClassEntity__Dispose__, v7);
    sub_1B863B8(
      &Method_System_Collections_Generic_List_Enumerator_ClassBoardEffectListDialogSkillListComponent_SkillDispData__Dispose__,
      v8);
    sub_1B863B8(&Method_System_Collections_Generic_List_Enumerator_ClassBoardClassEntity__MoveNext__, v9);
    sub_1B863B8(
      &Method_System_Collections_Generic_List_Enumerator_ClassBoardEffectListDialogSkillListComponent_SkillDispData__MoveNext__,
      v10);
    sub_1B863B8(&Method_System_Collections_Generic_List_Enumerator_ClassBoardClassEntity__get_Current__, v11);
    sub_1B863B8(
      ...
      v12);
    sub_1B863B8(&Method_UnityEngine_GameObject_GetComponent_ClassBoardEffectListDialogSkillDetailComponent___, v13);
    sub_1B863B8(
    ...
    sub_1B863B8(
      ...
      v17);
    sub_1B863B8(&Method_System_Collections_Generic_List_ClassBoardClassEntity__GetEnumerator__, v18);
    sub_1B863B8(
    ...
    sub_1B863B8(&StringLiteral_23203/*"skill_{0:D5}"*/, v22);
    byte_4A5189B = 1;
  }
  entityList = 0LL;
  ...
  if ( !skillListParent )
    goto LABEL_52;
  skillListParent = UnityEngine_GameObject__GetComponentsInChildren_object__50076180(
                      (UnityEngine_GameObject_o *)skillListParent,
                      (const MethodInfo_2FC1A14 *)Method_UnityEngine_GameObject_GetComponentsInChildren_ClassBoardEffectListDialogSkillDetailComponent___);
  if ( !skillListParent )
    goto LABEL_52;
  ...
  if ( v24 >= 1 )
  {
    ...
    {
      if ( v26 >= v24 )
        sub_1B8661C(skillListParent, svtData);
...
LABEL_52:
    sub_1B86614(skillListParent, svtData);
  }
LABEL_11:
  if ( svtData )
  {
    ...
    if ( ClassBoardClassMaster__TryGetEntityListFromClassId(
           ...
           0LL) )
    {
      v28 = (System_Collections_Generic_List_object__o *)sub_1B86604(System_Collections_Generic_List_ClassBoardEffectListDialogSkillListComponent_SkillDispData__TypeInfo);
                ...
                (const MethodInfo_3398634 *)Method_System_Collections_Generic_List_Enumerator_ClassBoardClassEntity__MoveNext__) )
      {
        ...
        OpenSkillList = (System_Collections_Generic_IEnumerable_T__o *)ClassBoardEffectListDialogSkillListComponent__GetOpenSkillList(
                                                                         ...
                                                                         0LL);
        if ( !v28 )
          sub_1B86614(OpenSkillList, OpenSkillList);
        System_Collections_Generic_List_object___AddRange(
          v28,
          OpenSkillList,
          (const MethodInfo_35FCB64 *)Method_System_Collections_Generic_List_ClassBoardEffectListDialogSkillListComponent_SkillDispData__AddRange__);
      }
      ...
      while ( 1 )
      {
        ...
        if ( (int)v35 >= (int)v39 )
        {
          ...
          Component_object = UnityEngine_GameObject__GetComponent_object_(
                               Object,
                               (const MethodInfo_2FC0DF0 *)Method_UnityEngine_GameObject_GetComponent_ClassBoardEffectListDialogSkillDetailComponent___);
        }
        else
        {
          if ( v35 >= v39 )
        ...
        if ( !byte_4A487E6 )
        {
          v53 = sub_1B863B8(&UnityEngine_Vector3_TypeInfo, v54);
          byte_4A487E6 = 1;
        }
        if ( !v55 )
          sub_1B86614(v53, v54);
        ...
        if ( !byte_4A487E7 )
        {
          v56 = sub_1B863B8(&UnityEngine_Quaternion_TypeInfo, v57);
          byte_4A487E7 = 1;
        }
        if ( !v58 )
          sub_1B86614(v56, v57);
        ...
        v66 = System_String__Format((System_String_o *)StringLiteral_23203/*"skill_{0:D5}"*/, v65, 0LL);
