        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5D1AD & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_14834/*"USER_FRIEND_CODE"*/);
    sub_1B885B0(&StringLiteral_14835/*"USER_FRIEND_CODE_HIDDEN"*/);
  ...
  switch ( state )
  {
    case 2:
      ...
      v11 = LocalizationManager__Get((System_String_o *)StringLiteral_14834/*"USER_FRIEND_CODE"*/, 0LL);
...
LABEL_16:
    ...
    case 1:
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v15 = LocalizationManager__Get((System_String_o *)StringLiteral_14834/*"USER_FRIEND_CODE"*/, 0LL);
      v16 = (Il2CppObject *)LocalizationManager__Get((System_String_o *)StringLiteral_14835/*"USER_FRIEND_CODE_HIDDEN"*/, 0LL);
...
void __fastcall FriendCodeComponent__OnClickFriendCode(FriendCodeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5D1AC & 1) == 0 )
  {
    sub_1B885B0(&Method_FriendCodeComponent_OnClickFriendCode__);
    byte_4A5D1AC = 1;
  }
  if ( this->fields.dispState )
  {
    ...
    if ( (*((_BYTE *)Method_FriendCodeComponent_OnClickFriendCode__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B885C8(Method_FriendCodeComponent_OnClickFriendCode__);
...
void __fastcall FriendCodeComponent__Setup(FriendCodeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5D1AB & 1) == 0 )
  {
    ...
    this = (FriendCodeComponent_o *)sub_1B885B0(&TitleRootComponent_TypeInfo);
    byte_4A5D1AB = 1;
  }
  ...
  v7 = friendCode != 0LL;
  v2->fields.dispState = v7;
  FriendCodeComponent__ChangeDispState(v2, v7, friendCode, v8);
...
void __fastcall FriendCodeComponent__UpdateFriendCode(FriendCodeComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.friendCode, (int32_t)DispFriendCode, v6, v7);
  friendCode = this->fields.friendCode;
  v9 = friendCode != 0LL;
