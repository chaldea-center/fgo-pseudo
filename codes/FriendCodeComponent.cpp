        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB7CE4 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_14864/*"USER_FRIEND_CODE"*/, v7);
    sub_1BAB41C(&StringLiteral_14865/*"USER_FRIEND_CODE_HIDDEN"*/, v8);
  ...
  switch ( state )
  {
    case 2:
      ...
      v14 = LocalizationManager__Get((System_String_o *)StringLiteral_14864/*"USER_FRIEND_CODE"*/, 0LL);
...
LABEL_16:
    ...
    case 1:
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v18 = LocalizationManager__Get((System_String_o *)StringLiteral_14864/*"USER_FRIEND_CODE"*/, 0LL);
      v19 = (Il2CppObject *)LocalizationManager__Get((System_String_o *)StringLiteral_14865/*"USER_FRIEND_CODE_HIDDEN"*/, 0LL);
...
void __fastcall FriendCodeComponent__OnClickFriendCode(FriendCodeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB7CE3 & 1) == 0 )
  {
    sub_1BAB41C(&Method_FriendCodeComponent_OnClickFriendCode__, method);
    byte_4AB7CE3 = 1;
  }
  if ( this->fields.dispState )
  {
    ...
    if ( (*((_BYTE *)Method_FriendCodeComponent_OnClickFriendCode__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BAB434(Method_FriendCodeComponent_OnClickFriendCode__);
...
void __fastcall FriendCodeComponent__Setup(FriendCodeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB7CE2 & 1) == 0 )
  {
    sub_1BAB41C(&SceneList_TypeInfo, method);
    this = (FriendCodeComponent_o *)sub_1BAB41C(&TitleRootComponent_TypeInfo, v3);
    byte_4AB7CE2 = 1;
  }
...
void __fastcall FriendCodeComponent__UpdateFriendCode(FriendCodeComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.friendCode, (int32_t)DispFriendCode, v6, v7);
  friendCode = this->fields.friendCode;
  v9 = friendCode != 0LL;
