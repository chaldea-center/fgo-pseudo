        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7AA0B & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_System_Linq_Enumerable_Select_RestockServantLogicByMoveToSubMember__int___);
    ...
    sub_1D0F0B4(&System_Func_RestockServantLogicByMoveToSubMember__int__TypeInfo);
    sub_1D0F0B4(&Method_RestockServantLogicByMoveToSubMember___c__ChoiceRestockServant_b__5_1__);
    sub_1D0F0B4(&Method_RestockServantLogicByMoveToSubMember___c__DisplayClass5_0__ChoiceRestockServant_b__0__);
    sub_1D0F0B4(&Method_RestockServantLogicByMoveToSubMember___c__DisplayClass5_0__ChoiceRestockServant_b__2__);
    sub_1D0F0B4(&RestockServantLogicByMoveToSubMember___c__DisplayClass5_0_TypeInfo);
    sub_1D0F0B4(&RestockServantLogicByMoveToSubMember___c_TypeInfo);
    byte_4E7AA0B = 1;
  }
  v5 = sub_1D0F300(RestockServantLogicByMoveToSubMember___c__DisplayClass5_0_TypeInfo);
  ...
  *(_QWORD *)(v5 + 16) = this;
  ...
  v16 = (System_Func_object__bool__o *)sub_1D0F300(System_Func_RestockServantLogicByMoveToSubMember__bool__TypeInfo);
  ...
  if ( !_9__5_1 )
  {
    ...
    _9__5_1 = (System_Func_object__int__o *)sub_1D0F300(System_Func_RestockServantLogicByMoveToSubMember__int__TypeInfo);
    ...
    sub_1D0F058((GrandQuestFolderBoardItem_o *)&static_fields->__9__5_1, (int32_t)_9__5_1, v23, v24, v25, v26, v27, v28);
  }
  v29 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_object__int_(
                                                               ...
                                                               (const MethodInfo_3285DC8 *)Method_System_Linq_Enumerable_Select_RestockServantLogicByMoveToSubMember__int___);
  v30 = System_Linq_Enumerable__ToArray_int_(
          v29,
          (const MethodInfo_328FC50 *)Method_System_Linq_Enumerable_ToArray_int___);
  *(_QWORD *)(v5 + 24) = v30;
  v31 = (__int64 *)(v5 + 24);
  sub_1D0F058((GrandQuestFolderBoardItem_o *)(v5 + 24), (int32_t)v30, v32, v33, v34, v35, v36, v37);
  v38 = (System_Func_object__bool__o *)sub_1D0F300(System_Func_BattleServantData__bool__TypeInfo);
  System_Func_object__bool____ctor(
    v38,
    (Il2CppObject *)v5,
  ...
  if ( ServantData->max_length )
    return RestockServantLogic__ChoiceRestockServant_48488284((RestockServantLogic_o *)this, ServantData, v40);
  v42 = *v31;
  if ( !*v31 )
LABEL_25:
    sub_1D0F30C(ServantData, v7);
  v43 = *(_QWORD *)(v42 + 24);
  if ( (int)v43 < 1 )
    return 0;
  v44 = 0;
...
void RestockServantLogicByMoveToSubMember___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1D0F300(RestockServantLogicByMoveToSubMember___c_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7AA0D & 1) == 0 )
  {
    this = (RestockServantLogicByMoveToSubMember___c__DisplayClass5_0_o *)sub_1D0F0B4(&Method_System_Array_IndexOf_int___);
    byte_4E7AA0D = 1;
  }
  if ( !x )
    sub_1D0F30C(this, x);
