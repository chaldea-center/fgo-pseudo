        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C59EAE & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_System_Linq_Enumerable_Select_RestockServantLogicByMoveToSubMember__int___);
    ...
    sub_1C3E564(&System_Func_RestockServantLogicByMoveToSubMember__int__TypeInfo);
    sub_1C3E564(&Method_RestockServantLogicByMoveToSubMember___c__ChoiceRestockServant_b__5_1__);
    sub_1C3E564(&Method_RestockServantLogicByMoveToSubMember___c__DisplayClass5_0__ChoiceRestockServant_b__0__);
    sub_1C3E564(&Method_RestockServantLogicByMoveToSubMember___c__DisplayClass5_0__ChoiceRestockServant_b__2__);
    sub_1C3E564(&RestockServantLogicByMoveToSubMember___c__DisplayClass5_0_TypeInfo);
    sub_1C3E564(&RestockServantLogicByMoveToSubMember___c_TypeInfo);
    byte_4C59EAE = 1;
  }
  v5 = sub_1C3E7B0(RestockServantLogicByMoveToSubMember___c__DisplayClass5_0_TypeInfo);
  ...
  *(_QWORD *)(v5 + 16) = this;
  ...
  v12 = (System_Func_object__bool__o *)sub_1C3E7B0(System_Func_RestockServantLogicByMoveToSubMember__bool__TypeInfo);
  ...
  if ( !_9__5_1 )
  {
    ...
    _9__5_1 = (System_Func_object__int__o *)sub_1C3E7B0(System_Func_RestockServantLogicByMoveToSubMember__int__TypeInfo);
    ...
    sub_1C3E508((CGThumbnailListItem_o *)&static_fields->__9__5_1, (int32_t)_9__5_1, v19, v20);
  }
  v21 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_object__int_(
                                                               ...
                                                               (const MethodInfo_312F93C *)Method_System_Linq_Enumerable_Select_RestockServantLogicByMoveToSubMember__int___);
  v22 = System_Linq_Enumerable__ToArray_int_(
          v21,
          (const MethodInfo_3139050 *)Method_System_Linq_Enumerable_ToArray_int___);
  *(_QWORD *)(v5 + 24) = v22;
  v23 = (__int64 *)(v5 + 24);
  sub_1C3E508((CGThumbnailListItem_o *)(v5 + 24), (int32_t)v22, v24, v25);
  v26 = (System_Func_object__bool__o *)sub_1C3E7B0(System_Func_BattleServantData__bool__TypeInfo);
  System_Func_object__bool____ctor(
    v26,
    (Il2CppObject *)v5,
  ...
  if ( ServantData->max_length )
    return RestockServantLogic__ChoiceRestockServant_46942012((RestockServantLogic_o *)this, ServantData, v28);
  v30 = *v23;
  if ( !*v23 )
LABEL_25:
    sub_1C3E7C0(ServantData, v7);
  v31 = *(_QWORD *)(v30 + 24);
  if ( (int)v31 < 1 )
    return 0;
  v32 = 0;
...
void RestockServantLogicByMoveToSubMember___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C3E7B0(RestockServantLogicByMoveToSubMember___c_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C59EB0 & 1) == 0 )
  {
    this = (RestockServantLogicByMoveToSubMember___c__DisplayClass5_0_o *)sub_1C3E564(&Method_System_Array_IndexOf_int___);
    byte_4C59EB0 = 1;
  }
  if ( !x )
    sub_1C3E7C0(this, x);
