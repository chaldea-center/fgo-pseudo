        ...
        const MethodInfo *method)
{
  ...
  isChangeName = 0;
  return NpcServantFollowerEntity__GetFollowerName_39487592(this, followerId, questId, questPhase, &isChangeName, v5);
}


System_String_o *__fastcall NpcServantFollowerEntity__GetFollowerName_39487592(
        NpcServantFollowerEntity_o *this,
        int64_t followerId,
        int32_t questId,
        int32_t questPhase,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A70247 & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMasterData_ServantChangeMaster___, followerId);
    ...
    sub_1B90010(&StringLiteral_11625/*"SERVANT_HIDE_NAME"*/, v16);
    sub_1B90010(&StringLiteral_9255/*"NONE"*/, v17);
    this = (NpcServantFollowerEntity_o *)sub_1B90010(&StringLiteral_1/*""*/, v18);
    byte_4A70247 = 1;
  }
  *isChangeName = 1;
  if ( (v10->fields.flag & 2) == 0 )
  {
    ...
    if ( name && System_String__op_Inequality(name, (System_String_o *)StringLiteral_9255/*"NONE"*/, 0LL) )
...
LABEL_23:
  ...
  return LocalizationManager__Get((System_String_o *)StringLiteral_11625/*"SERVANT_HIDE_NAME"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B90010(&Method_DataManager_GetMasterData_ServantChangeMaster___, followerId);
    sub_1B90010(&Method_DataManager_GetMaster_ServantOverwriteMaster___, v9);
    sub_1B90010(&DataManager_TypeInfo, v10);
    this = (NpcServantFollowerEntity_o *)sub_1B90010(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v11);
    byte_4A70248 = 1;
  }
  ...
  if ( NpcFollowerEntity )
  {
    ...
    if ( NpcFollowerEntity__IsOverwriteTreasureDevice(v14, v15) )
    {
      ...
      Instance = DataManager__GetMaster_object_((const MethodInfo_2E8E1C8 *)Method_DataManager_GetMaster_ServantOverwriteMaster___);
      if ( Instance )
      {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A70249 & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMasterData_NpcFollowerMaster___, followerId);
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_2E8E21C *)Method_DataManager_GetMasterData_NpcFollowerMaster___)) == 0LL )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A7024C & 1) == 0 )
  {
    sub_1B90010(&Method_System_Linq_Enumerable_Select_string__int___, method);
    sub_1B90010(&Method_System_Linq_Enumerable_ToArray_int___, v3);
    sub_1B90010(&System_Func_string__int__TypeInfo, v4);
    sub_1B90010(&Method_System_Int32_Parse__, v5);
  ...
  if ( !individuality
    || (individuality = System_String__Replace_61806720(
                          individuality,
        ...
        const MethodInfo *method)
{
  ...
  return System_String__op_Inequality(this->fields.individuality, (System_String_o *)StringLiteral_9255/*"NONE"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  int v57; // w8
  System_String_o *FollowerName_39487592; // x0
  int32_t v59; // w2
  int32_t v60; // w3
  __int64 v61; // x0
  int32_t v62; // w2
  ...
  if ( (byte_4A7024A & 1) == 0 )
  {
    sub_1B90010(&AppendPassiveSkillInfo___TypeInfo, followerId);
    sub_1B90010(&AppendPassiveSkillInfo_TypeInfo, v14);
    sub_1B90010(&Method_DataManager_GetMasterData_UserServantCollectionMaster___, v15);
    sub_1B90010(&FollowerInfo_TypeInfo, v16);
    ...
    sub_1B90010(&ServantLeaderInfo___TypeInfo, v20);
    sub_1B90010(&ServantLeaderInfo_TypeInfo, v21);
  ...
  idList = 0LL;
  explanationList = 0LL;
  v23 = sub_1B9025C(FollowerInfo_TypeInfo);
  FollowerInfo___ctor((FollowerInfo_o *)v23, 0LL);
  v24 = sub_1B9025C(ServantLeaderInfo_TypeInfo);
...
LABEL_23:
    *(_QWORD *)(v24 + 120) = passiveSkill;
    sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v24 + 120), (int32_t)passiveSkill, v29, v30);
    goto LABEL_24;
  }
  if ( !idList )
    goto LABEL_23;
  ...
  if ( !v33 )
    goto LABEL_23;
  v34 = sub_1B900B8(int___TypeInfo, (unsigned int)(v33 + v32));
  *(_QWORD *)(v24 + 120) = v34;
  v35 = (System_Array_o **)(v24 + 120);
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v24 + 120), v34, v36, v37);
...
LABEL_24:
  ...
  *(_DWORD *)(v24 + 192) = this->fields.flag | 1;
  ...
  if ( !appendPassiveSkillIds )
    goto LABEL_37;
  Instance = sub_1B900B8(AppendPassiveSkillInfo___TypeInfo, appendPassiveSkillIds->max_length);
  ...
  while ( 1 )
  {
    ...
    if ( v49 - 8 >= (int)v46->max_length )
      break;
    v51 = (AppendPassiveSkillInfo_o *)sub_1B9025C(AppendPassiveSkillInfo_TypeInfo);
    ...
    if ( !v47 )
      goto LABEL_37;
    Instance = sub_1B9014C(v51, *(_QWORD *)(*(_QWORD *)v47 + 64LL));
    if ( !Instance )
      goto LABEL_50;
    if ( v50 >= v47[6] )
      goto LABEL_49;
    v48->klass = (ServantStatusBattleListViewItem_c *)v51;
    sub_1B8FFB4(v48, (int32_t)v51, v54, v55);
    v46 = this->fields.appendPassiveSkillIds;
    ++v49;
  ...
  *(_QWORD *)(v24 + 216) = v47;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v24 + 216), (int32_t)v47, v44, v45);
  if ( !v23 )
    goto LABEL_37;
  *(_QWORD *)(v23 + 16) = v40;
  ...
  *(_DWORD *)(v23 + 36) = v57;
  isChangeName = 0;
  FollowerName_39487592 = NpcServantFollowerEntity__GetFollowerName_39487592(
                            this,
                            v40,
                            questIda,
                            v41,
                            &isChangeName,
                            v56);
  *(_QWORD *)(v23 + 24) = FollowerName_39487592;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v23 + 24), (int32_t)FollowerName_39487592, v59, v60);
  *(_DWORD *)(v23 + 32) = 0;
  v61 = sub_1B900B8(ServantLeaderInfo___TypeInfo, 1LL);
  *(_QWORD *)(v23 + 40) = v61;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v23 + 40), v61, v62, v63);
  v64 = *(_QWORD *)(v23 + 40);
  if ( !v64 )
    goto LABEL_37;
  Instance = sub_1B9014C(v24, *(_QWORD *)(*(_QWORD *)v64 + 64LL));
  if ( !Instance )
    goto LABEL_50;
  if ( !*(_DWORD *)(v64 + 24) )
    goto LABEL_49;
  *(_QWORD *)(v64 + 32) = v24;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v64 + 32), v24, v65, v66);
  v67 = sub_1B900B8(ServantLeaderInfo___TypeInfo, 1LL);
  *(_QWORD *)(v23 + 48) = v67;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v23 + 48), v67, v68, v69);
  v70 = *(_QWORD *)(v23 + 48);
  if ( !v70 )
LABEL_37:
    sub_1B9026C(Instance, v26);
  Instance = sub_1B9014C(v24, *(_QWORD *)(*(_QWORD *)v70 + 64LL));
  if ( !Instance )
  {
LABEL_50:
    v75 = sub_1B90290(Instance);
    sub_1B90138(v75, 0LL);
  }
  if ( !*(_DWORD *)(v70 + 24) )
LABEL_49:
  ...
  *(_QWORD *)(v70 + 32) = v24;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v70 + 32), v24, v71, v72);
  id = this->fields.id;
