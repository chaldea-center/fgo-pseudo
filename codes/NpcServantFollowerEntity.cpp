        ...
        const MethodInfo *method)
{
  ...
  isChangeName = 0;
  return NpcServantFollowerEntity__GetFollowerName_42663112(this, followerId, questId, questPhase, &isChangeName, v5);
}


System_String_o *NpcServantFollowerEntity__GetFollowerName_42663112(
        NpcServantFollowerEntity_o *this,
        int64_t followerId,
        int32_t questId,
        int32_t questPhase,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB684F & 1) == 0 )
  {
    ...
    this = (NpcServantFollowerEntity_o *)sub_1C6BA08(&StringLiteral_1/*""*/);
    byte_4CB684F = 1;
  }
  *isChangeName = 1;
  if ( (v10->fields.flag & 2) == 0 )
  {
    ...
    if ( NpcFollowerEntity )
    {
      ...
      if ( NpcFollowerEntity__IsExistSvtChangeParam(v13, v15) )
      {
        ...
        Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_313B368 *)Method_DataManager_GetMasterData_ServantChangeMaster___);
        if ( !Instance )
          goto LABEL_23;
    ...
    if ( name && System_String__op_Inequality(name, (System_String_o *)StringLiteral_9273/*"NONE"*/, 0) )
...
LABEL_23:
  ...
  return LocalizationManager__Get((System_String_o *)StringLiteral_11650/*"SERVANT_HIDE_NAME"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C6BA08(&Method_DataManager_GetMasterData_ServantChangeMaster___);
    sub_1C6BA08(&Method_DataManager_GetMaster_ServantOverwriteMaster___);
    sub_1C6BA08(&DataManager_TypeInfo);
    this = (NpcServantFollowerEntity_o *)sub_1C6BA08(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4CB6850 = 1;
  }
  ...
  if ( NpcFollowerEntity )
  {
    ...
    if ( NpcFollowerEntity__IsOverwriteTreasureDevice(v11, v12) )
    {
      ...
      Instance = DataManager__GetMaster_object_((const MethodInfo_313B314 *)Method_DataManager_GetMaster_ServantOverwriteMaster___);
      if ( Instance )
      {
        ...
        const MethodInfo *method)
{
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_313B368 *)Method_DataManager_GetMasterData_NpcFollowerMaster___)) == 0 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( !individuality
    || (individuality = System_String__Replace_64013356(
                          individuality,
    ...
    || (individuality = System_String__Replace_64013356(
                          ...
                          0)) == 0 )
  {
    sub_1C6BC60(individuality, v3);
  }
  v5 = (System_Collections_Generic_IEnumerable_TSource__o *)System_String__Split(individuality, 0x2Cu, 0, 0);
  v6 = (System_Func_object__int__o *)sub_1C6BC54(System_Func_string__int__TypeInfo);
...
bool NpcServantFollowerEntity__IsOverwriteIndividuality(NpcServantFollowerEntity_o *this, const MethodInfo *method)
{
  ...
  return System_String__op_Inequality(this->fields.individuality, (System_String_o *)StringLiteral_9273/*"NONE"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  CGThumbnailListItem_o *v38; // x29
  __int64 v39; // x25
  unsigned __int64 v40; // x26
  AppendPassiveSkillInfo_o *v41; // x19
  ...
  int v47; // w8
  System_String_o *FollowerName_42663112; // x0
  int32_t v49; // w2
  ...
  if ( (byte_4CB6852 & 1) == 0 )
  {
    sub_1C6BA08(&AppendPassiveSkillInfo___TypeInfo);
    sub_1C6BA08(&AppendPassiveSkillInfo_TypeInfo);
    sub_1C6BA08(&Method_DataManager_GetMasterData_UserServantCollectionMaster___);
    sub_1C6BA08(&FollowerInfo_TypeInfo);
  ...
  idList = 0;
  explanationList = 0;
  v14 = sub_1C6BC54(FollowerInfo_TypeInfo);
  FollowerInfo___ctor((FollowerInfo_o *)v14, 0);
  v15 = sub_1C6BC54(ServantLeaderInfo_TypeInfo);
...
LABEL_27:
    *(_QWORD *)(v15 + 120) = passiveSkill;
    sub_1C6B9AC((CGThumbnailListItem_o *)(v15 + 120), (int32_t)passiveSkill, v20, v21);
    goto LABEL_28;
  }
  if ( !idList )
    goto LABEL_27;
  v24 = idList->max_length;
  if ( !v24 )
    goto LABEL_27;
  v25 = sub_1C6BAB0(int___TypeInfo, (unsigned int)(v24 + max_length));
  *(_QWORD *)(v15 + 120) = v25;
  v26 = (System_Array_o **)(v15 + 120);
  sub_1C6B9AC((CGThumbnailListItem_o *)(v15 + 120), v25, v27, v28);
  Instance = (__int64)idList;
  if ( !idList )
    goto LABEL_41;
  System_Array__CopyTo((System_Array_o *)idList, *v26, 0, 0);
  if ( !idList )
    goto LABEL_41;
  Instance = (__int64)this->fields.passiveSkill;
  if ( !Instance )
    goto LABEL_41;
  System_Array__CopyTo((System_Array_o *)Instance, *v26, idList->max_length, 0);
LABEL_28:
  v30 = followerId;
  questIda = questId;
  v31 = questPhase;
  Instance = NpcServantFollowerEntity__GetFollowerTreasureDeviceId(this, followerId, questId, questPhase, v29);
  ...
  *(_DWORD *)(v15 + 272) = this->fields.flag | 1;
  ...
  if ( !appendPassiveSkillIds )
    goto LABEL_41;
  Instance = sub_1C6BAB0(AppendPassiveSkillInfo___TypeInfo, LODWORD(appendPassiveSkillIds->max_length));
  v36 = this->fields.appendPassiveSkillIds;
  if ( !v36 )
    goto LABEL_41;
  v37 = (unsigned int *)Instance;
  v38 = (CGThumbnailListItem_o *)(Instance + 32);
  v39 = 8;
  while ( 1 )
  {
    v40 = v39 - 8;
    if ( v39 - 8 >= SLODWORD(v36->max_length) )
      break;
    v41 = (AppendPassiveSkillInfo_o *)sub_1C6BC54(AppendPassiveSkillInfo_TypeInfo);
    AppendPassiveSkillInfo___ctor(v41, 0);
    v42 = this->fields.appendPassiveSkillIds;
    if ( !v42 )
      goto LABEL_41;
    ...
    if ( !v41 )
      goto LABEL_41;
    v41->fields.skillId = *((_DWORD *)&v42->obj.klass + v39);
    appendPassiveSkillLvs = this->fields.appendPassiveSkillLvs;
    if ( !appendPassiveSkillLvs )
      goto LABEL_41;
    if ( v40 >= LODWORD(appendPassiveSkillLvs->max_length) )
      goto LABEL_53;
    v41->fields.skillLv = *((_DWORD *)&appendPassiveSkillLvs->obj.klass + v39);
    if ( !v37 )
      goto LABEL_41;
    Instance = sub_1C6BB44(v41, *(_QWORD *)(*(_QWORD *)v37 + 64LL));
    if ( !Instance )
      goto LABEL_54;
    if ( v40 >= v37[6] )
      goto LABEL_53;
    v38->klass = (CGThumbnailListItem_c *)v41;
    sub_1C6B9AC(v38, (int32_t)v41, v44, v45);
    v36 = this->fields.appendPassiveSkillIds;
    ++v39;
    v38 = (CGThumbnailListItem_o *)((char *)v38 + 8);
    if ( !v36 )
      goto LABEL_41;
  }
  *(_QWORD *)(v15 + 224) = v37;
  sub_1C6B9AC((CGThumbnailListItem_o *)(v15 + 224), (int32_t)v37, v34, v35);
  if ( !v14 )
    goto LABEL_41;
  *(_QWORD *)(v14 + 16) = v30;
  v47 = (*(_DWORD *)(v15 + 272) & 4) != 0 ? 4 : 3;
  *(_DWORD *)(v14 + 36) = v47;
  isChangeName = 0;
  FollowerName_42663112 = NpcServantFollowerEntity__GetFollowerName_42663112(
                            this,
                            v30,
                            questIda,
                            v31,
                            &isChangeName,
                            v46);
  *(_QWORD *)(v14 + 24) = FollowerName_42663112;
  sub_1C6B9AC((CGThumbnailListItem_o *)(v14 + 24), (int32_t)FollowerName_42663112, v49, v50);
  *(_DWORD *)(v14 + 32) = 0;
  v51 = sub_1C6BAB0(ServantLeaderInfo___TypeInfo, 1);
  *(_QWORD *)(v14 + 40) = v51;
  sub_1C6B9AC((CGThumbnailListItem_o *)(v14 + 40), v51, v52, v53);
  v54 = *(_QWORD *)(v14 + 40);
  if ( !v54 )
    goto LABEL_41;
  Instance = sub_1C6BB44(v15, *(_QWORD *)(*(_QWORD *)v54 + 64LL));
  if ( !Instance )
    goto LABEL_54;
  if ( !*(_DWORD *)(v54 + 24) )
    goto LABEL_53;
  *(_QWORD *)(v54 + 32) = v15;
  sub_1C6B9AC((CGThumbnailListItem_o *)(v54 + 32), v15, v55, v56);
  v57 = sub_1C6BAB0(ServantLeaderInfo___TypeInfo, 1);
  *(_QWORD *)(v14 + 48) = v57;
  sub_1C6B9AC((CGThumbnailListItem_o *)(v14 + 48), v57, v58, v59);
  v60 = *(_QWORD *)(v14 + 48);
  if ( !v60 )
LABEL_41:
    sub_1C6BC60(Instance, v17);
  Instance = sub_1C6BB44(v15, *(_QWORD *)(*(_QWORD *)v60 + 64LL));
  if ( !Instance )
  {
LABEL_54:
    v65 = sub_1C6BC84(Instance);
    sub_1C6BB30(v65, 0);
  }
  if ( !*(_DWORD *)(v60 + 24) )
LABEL_53:
  ...
  *(_QWORD *)(v60 + 32) = v15;
  sub_1C6B9AC((CGThumbnailListItem_o *)(v60 + 32), v15, v61, v62);
  id = this->fields.id;
