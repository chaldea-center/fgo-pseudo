        ...
        const MethodInfo *method)
{
  ...
  isChangeName = 0;
  return NpcServantFollowerEntity__GetFollowerName_41576312(this, followerId, questId, questPhase, &isChangeName, v5);
}


System_String_o *__fastcall NpcServantFollowerEntity__GetFollowerName_41576312(
        NpcServantFollowerEntity_o *this,
        int64_t followerId,
        int32_t questId,
        int32_t questPhase,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1CA67 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_ServantChangeMaster___, followerId);
    ...
    sub_1BCAFF8(&StringLiteral_11546/*"SERVANT_HIDE_NAME"*/, v16);
    sub_1BCAFF8(&StringLiteral_9205/*"NONE"*/, v17);
    this = (NpcServantFollowerEntity_o *)sub_1BCAFF8(&StringLiteral_1/*""*/, v18);
    byte_4B1CA67 = 1;
  }
  *isChangeName = 1;
  if ( (v10->fields.flag & 2) == 0 )
  {
    ...
    if ( name && System_String__op_Inequality(name, (System_String_o *)StringLiteral_9205/*"NONE"*/, 0LL) )
...
LABEL_23:
  ...
  return LocalizationManager__Get((System_String_o *)StringLiteral_11546/*"SERVANT_HIDE_NAME"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_ServantChangeMaster___, followerId);
    sub_1BCAFF8(&Method_DataManager_GetMaster_ServantOverwriteMaster___, v9);
    sub_1BCAFF8(&DataManager_TypeInfo, v10);
    this = (NpcServantFollowerEntity_o *)sub_1BCAFF8(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v11);
    byte_4B1CA68 = 1;
  }
  ...
  if ( NpcFollowerEntity )
  {
    ...
    if ( NpcFollowerEntity__IsOverwriteTreasureDevice(v14, v15) )
    {
      ...
      Instance = DataManager__GetMaster_object_((const MethodInfo_301AA50 *)Method_DataManager_GetMaster_ServantOverwriteMaster___);
      if ( Instance )
      {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1CA69 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_NpcFollowerMaster___, followerId);
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_301AAA4 *)Method_DataManager_GetMasterData_NpcFollowerMaster___)) == 0LL )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1CA6C & 1) == 0 )
  {
    sub_1BCAFF8(&Method_System_Linq_Enumerable_Select_string__int___, method);
    sub_1BCAFF8(&Method_System_Linq_Enumerable_ToArray_int___, v3);
    sub_1BCAFF8(&System_Func_string__int__TypeInfo, v4);
    sub_1BCAFF8(&Method_System_Int32_Parse__, v5);
  ...
  if ( !individuality
    || (individuality = System_String__Replace_62496972(
                          individuality,
        ...
        const MethodInfo *method)
{
  ...
  return System_String__op_Inequality(this->fields.individuality, (System_String_o *)StringLiteral_9205/*"NONE"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  int v56; // w8
  System_String_o *FollowerName_41576312; // x0
  int32_t v58; // w2
  ...
  if ( (byte_4B1CA6A & 1) == 0 )
  {
    sub_1BCAFF8(&AppendPassiveSkillInfo___TypeInfo, followerId);
    sub_1BCAFF8(&AppendPassiveSkillInfo_TypeInfo, v14);
    sub_1BCAFF8(&Method_DataManager_GetMasterData_UserServantCollectionMaster___, v15);
    sub_1BCAFF8(&FollowerInfo_TypeInfo, v16);
    ...
    sub_1BCAFF8(&ServantLeaderInfo___TypeInfo, v20);
    sub_1BCAFF8(&ServantLeaderInfo_TypeInfo, v21);
  ...
  idList = 0LL;
  explanationList = 0LL;
  v23 = sub_1BCB244(FollowerInfo_TypeInfo);
  FollowerInfo___ctor((FollowerInfo_o *)v23, 0LL);
  v24 = sub_1BCB244(ServantLeaderInfo_TypeInfo);
...
LABEL_27:
    *(_QWORD *)(v24 + 120) = passiveSkill;
    sub_1BCAF9C((CGThumbnailListItem_o *)(v24 + 120), (int32_t)passiveSkill, v29, v30);
    goto LABEL_28;
  }
  if ( !idList )
    goto LABEL_27;
  ...
  if ( !v33 )
    goto LABEL_27;
  v34 = sub_1BCB0A0(int___TypeInfo, (unsigned int)(v33 + v32));
  *(_QWORD *)(v24 + 120) = v34;
  v35 = (System_Array_o **)(v24 + 120);
  sub_1BCAF9C((CGThumbnailListItem_o *)(v24 + 120), v34, v36, v37);
...
LABEL_28:
  ...
  *(_DWORD *)(v24 + 272) = this->fields.flag | 1;
  ...
  if ( !appendPassiveSkillIds )
    goto LABEL_41;
  Instance = sub_1BCB0A0(AppendPassiveSkillInfo___TypeInfo, appendPassiveSkillIds->max_length);
  ...
  while ( 1 )
  {
    ...
    if ( v48 - 8 >= (int)v45->max_length )
      break;
    v50 = (AppendPassiveSkillInfo_o *)sub_1BCB244(AppendPassiveSkillInfo_TypeInfo);
    ...
    if ( !v46 )
      goto LABEL_41;
    Instance = sub_1BCB134(v50, *(_QWORD *)(*(_QWORD *)v46 + 64LL));
    if ( !Instance )
      goto LABEL_54;
    if ( v49 >= v46[6] )
      goto LABEL_53;
    v47->klass = (CGThumbnailListItem_c *)v50;
    sub_1BCAF9C(v47, (int32_t)v50, v51, v54);
    v45 = this->fields.appendPassiveSkillIds;
    ++v48;
  ...
  *(_QWORD *)(v24 + 224) = v46;
  sub_1BCAF9C((CGThumbnailListItem_o *)(v24 + 224), (int32_t)v46, v43, v44);
  if ( !v23 )
    goto LABEL_41;
  *(_QWORD *)(v23 + 16) = v39;
  ...
  *(_DWORD *)(v23 + 36) = v56;
  isChangeName = 0;
  FollowerName_41576312 = NpcServantFollowerEntity__GetFollowerName_41576312(
                            this,
                            v39,
                            questIda,
                            v40,
                            &isChangeName,
                            v55);
  *(_QWORD *)(v23 + 24) = FollowerName_41576312;
  sub_1BCAF9C((CGThumbnailListItem_o *)(v23 + 24), (int32_t)FollowerName_41576312, v58, v59);
  *(_DWORD *)(v23 + 32) = 0;
  v60 = sub_1BCB0A0(ServantLeaderInfo___TypeInfo, 1LL);
  *(_QWORD *)(v23 + 40) = v60;
  sub_1BCAF9C((CGThumbnailListItem_o *)(v23 + 40), v60, v61, v62);
  v63 = *(_QWORD *)(v23 + 40);
  if ( !v63 )
    goto LABEL_41;
  Instance = sub_1BCB134(v24, *(_QWORD *)(*(_QWORD *)v63 + 64LL));
  if ( !Instance )
    goto LABEL_54;
  if ( !*(_DWORD *)(v63 + 24) )
    goto LABEL_53;
  *(_QWORD *)(v63 + 32) = v24;
  sub_1BCAF9C((CGThumbnailListItem_o *)(v63 + 32), v24, v51, v64);
  v65 = sub_1BCB0A0(ServantLeaderInfo___TypeInfo, 1LL);
  *(_QWORD *)(v23 + 48) = v65;
  sub_1BCAF9C((CGThumbnailListItem_o *)(v23 + 48), v65, v66, v67);
  v68 = *(_QWORD *)(v23 + 48);
  if ( !v68 )
LABEL_41:
    sub_1BCB254(Instance, v26);
  Instance = sub_1BCB134(v24, *(_QWORD *)(*(_QWORD *)v68 + 64LL));
  if ( !Instance )
  {
LABEL_54:
    v72 = sub_1BCB278(Instance);
    sub_1BCB120(v72, 0LL);
  }
  if ( !*(_DWORD *)(v68 + 24) )
LABEL_53:
    sub_1BCB25C(Instance, v26, v51);
  *(_QWORD *)(v68 + 32) = v24;
  sub_1BCAF9C((CGThumbnailListItem_o *)(v68 + 32), v24, v51, v69);
  id = this->fields.id;
