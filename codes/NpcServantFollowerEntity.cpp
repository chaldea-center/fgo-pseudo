        ...
        const MethodInfo *method)
{
  ...
  isChangeName = 0;
  return NpcServantFollowerEntity__GetFollowerName_39115028(this, followerId, questId, questPhase, &isChangeName, v5);
}


System_String_o *__fastcall NpcServantFollowerEntity__GetFollowerName_39115028(
        NpcServantFollowerEntity_o *this,
        int64_t followerId,
        int32_t questId,
        int32_t questPhase,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE8D7 & 1) == 0 )
  {
    sub_1B64870(&Method_DataManager_GetMasterData_ServantChangeMaster___, followerId);
    ...
    sub_1B64870(&StringLiteral_11566/*"SERVANT_HIDE_NAME"*/, v16);
    sub_1B64870(&StringLiteral_9211/*"NONE"*/, v17);
    this = (NpcServantFollowerEntity_o *)sub_1B64870(&StringLiteral_1/*""*/, v18);
    byte_49FE8D7 = 1;
  }
  *isChangeName = 1;
  if ( (v10->fields.flag & 2) == 0 )
  {
    ...
    if ( name && System_String__op_Inequality(name, (System_String_o *)StringLiteral_9211/*"NONE"*/, 0LL) )
...
LABEL_23:
  ...
  return LocalizationManager__Get((System_String_o *)StringLiteral_11566/*"SERVANT_HIDE_NAME"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B64870(&Method_DataManager_GetMasterData_ServantChangeMaster___, followerId);
    sub_1B64870(&Method_DataManager_GetMaster_ServantOverwriteMaster___, v9);
    sub_1B64870(&DataManager_TypeInfo, v10);
    this = (NpcServantFollowerEntity_o *)sub_1B64870(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v11);
    byte_49FE8D8 = 1;
  }
  ...
  if ( NpcFollowerEntity )
  {
    ...
    if ( NpcFollowerEntity__IsOverwriteTreasureDevice(v14, v15) )
    {
      ...
      Instance = DataManager__GetMaster_object_((const MethodInfo_2E3B674 *)Method_DataManager_GetMaster_ServantOverwriteMaster___);
      if ( Instance )
      {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE8D9 & 1) == 0 )
  {
    sub_1B64870(&Method_DataManager_GetMasterData_NpcFollowerMaster___, followerId);
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_2E3B6C8 *)Method_DataManager_GetMasterData_NpcFollowerMaster___)) == 0LL )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE8DC & 1) == 0 )
  {
    sub_1B64870(&Method_System_Linq_Enumerable_Select_string__int___, method);
    sub_1B64870(&Method_System_Linq_Enumerable_ToArray_int___, v3);
    sub_1B64870(&System_Func_string__int__TypeInfo, v4);
    sub_1B64870(&Method_System_Int32_Parse__, v5);
  ...
  if ( !individuality
    || (individuality = System_String__Replace_61403196(
                          individuality,
    ...
    || (individuality = System_String__Replace_61403196(
                          ...
                          0LL)) == 0LL )
  {
    sub_1B64ACC(individuality, v9);
  }
  v11 = (System_Collections_Generic_IEnumerable_TSource__o *)System_String__Split(individuality, 0x2Cu, 0, 0LL);
  v12 = (System_Func_object__int__o *)sub_1B64ABC(System_Func_string__int__TypeInfo);
        ...
        const MethodInfo *method)
{
  if ( (byte_49FE8DB & 1) == 0 )
  {
    sub_1B64870(&StringLiteral_9211/*"NONE"*/, method);
    byte_49FE8DB = 1;
  }
  return System_String__op_Inequality(this->fields.individuality, (System_String_o *)StringLiteral_9211/*"NONE"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  int v57; // w8
  System_String_o *FollowerName_39115028; // x0
  int32_t v59; // w2
  int32_t v60; // w3
  __int64 v61; // x0
  int32_t v62; // w2
  ...
  if ( (byte_49FE8DA & 1) == 0 )
  {
    sub_1B64870(&AppendPassiveSkillInfo___TypeInfo, followerId);
    sub_1B64870(&AppendPassiveSkillInfo_TypeInfo, v14);
    sub_1B64870(&Method_DataManager_GetMasterData_UserServantCollectionMaster___, v15);
    sub_1B64870(&FollowerInfo_TypeInfo, v16);
    ...
    sub_1B64870(&ServantLeaderInfo___TypeInfo, v20);
    sub_1B64870(&ServantLeaderInfo_TypeInfo, v21);
  ...
  idList = 0LL;
  explanationList = 0LL;
  v23 = sub_1B64ABC(FollowerInfo_TypeInfo);
  FollowerInfo___ctor((FollowerInfo_o *)v23, 0LL);
  v24 = sub_1B64ABC(ServantLeaderInfo_TypeInfo);
...
LABEL_22:
    *(_QWORD *)(v24 + 120) = passiveSkill;
    sub_1B64814((ServantStatusBattleListViewItem_o *)(v24 + 120), (int32_t)passiveSkill, v29, v30);
    goto LABEL_23;
  }
  if ( !idList )
    goto LABEL_22;
  ...
  if ( !v33 )
    goto LABEL_22;
  v34 = sub_1B64918(int___TypeInfo, (unsigned int)(v33 + v32));
  *(_QWORD *)(v24 + 120) = v34;
  v35 = (System_Array_o **)(v24 + 120);
  sub_1B64814((ServantStatusBattleListViewItem_o *)(v24 + 120), v34, v36, v37);
...
LABEL_23:
  ...
  *(_DWORD *)(v24 + 192) = this->fields.flag | 1;
  ...
  if ( !appendPassiveSkillIds )
    goto LABEL_36;
  Instance = sub_1B64918(AppendPassiveSkillInfo___TypeInfo, appendPassiveSkillIds->max_length);
  ...
  while ( 1 )
  {
    ...
    if ( v49 - 8 >= (int)v46->max_length )
      break;
    v51 = (AppendPassiveSkillInfo_o *)sub_1B64ABC(AppendPassiveSkillInfo_TypeInfo);
    ...
    if ( !v47 )
      goto LABEL_36;
    Instance = sub_1B649AC(v51, *(_QWORD *)(*(_QWORD *)v47 + 64LL));
    if ( !Instance )
      goto LABEL_49;
    if ( v50 >= v47[6] )
      goto LABEL_48;
    v48->klass = (ServantStatusBattleListViewItem_c *)v51;
    sub_1B64814(v48, (int32_t)v51, v54, v55);
    v46 = this->fields.appendPassiveSkillIds;
    ++v49;
  ...
  *(_QWORD *)(v24 + 216) = v47;
  sub_1B64814((ServantStatusBattleListViewItem_o *)(v24 + 216), (int32_t)v47, v44, v45);
  if ( !v23 )
    goto LABEL_36;
  *(_QWORD *)(v23 + 16) = v40;
  ...
  *(_DWORD *)(v23 + 36) = v57;
  isChangeName = 0;
  FollowerName_39115028 = NpcServantFollowerEntity__GetFollowerName_39115028(
                            this,
                            v40,
                            questIda,
                            v41,
                            &isChangeName,
                            v56);
  *(_QWORD *)(v23 + 24) = FollowerName_39115028;
  sub_1B64814((ServantStatusBattleListViewItem_o *)(v23 + 24), (int32_t)FollowerName_39115028, v59, v60);
  *(_DWORD *)(v23 + 32) = 0;
  v61 = sub_1B64918(ServantLeaderInfo___TypeInfo, 1LL);
  *(_QWORD *)(v23 + 40) = v61;
  sub_1B64814((ServantStatusBattleListViewItem_o *)(v23 + 40), v61, v62, v63);
  v64 = *(_QWORD *)(v23 + 40);
  if ( !v64 )
    goto LABEL_36;
  Instance = sub_1B649AC(v24, *(_QWORD *)(*(_QWORD *)v64 + 64LL));
  if ( !Instance )
    goto LABEL_49;
  if ( !*(_DWORD *)(v64 + 24) )
    goto LABEL_48;
  *(_QWORD *)(v64 + 32) = v24;
  sub_1B64814((ServantStatusBattleListViewItem_o *)(v64 + 32), v24, v65, v66);
  v67 = sub_1B64918(ServantLeaderInfo___TypeInfo, 1LL);
  *(_QWORD *)(v23 + 48) = v67;
  sub_1B64814((ServantStatusBattleListViewItem_o *)(v23 + 48), v67, v68, v69);
  v70 = *(_QWORD *)(v23 + 48);
  if ( !v70 )
LABEL_36:
    sub_1B64ACC(Instance, v26);
  Instance = sub_1B649AC(v24, *(_QWORD *)(*(_QWORD *)v70 + 64LL));
  if ( !Instance )
  {
LABEL_49:
    v75 = sub_1B64AF0(Instance);
    sub_1B64998(v75, 0LL);
  }
  if ( !*(_DWORD *)(v70 + 24) )
LABEL_48:
  ...
  *(_QWORD *)(v70 + 32) = v24;
  sub_1B64814((ServantStatusBattleListViewItem_o *)(v70 + 32), v24, v71, v72);
  id = this->fields.id;
