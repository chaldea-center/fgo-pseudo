        ...
        const MethodInfo *method)
{
  ...
  isChangeName = 0;
  return NpcServantFollowerEntity__GetFollowerName_40433660(this, followerId, questId, questPhase, &isChangeName, v5);
}


System_String_o *__fastcall NpcServantFollowerEntity__GetFollowerName_40433660(
        NpcServantFollowerEntity_o *this,
        int64_t followerId,
        int32_t questId,
        int32_t questPhase,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4E8E4 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataManager_GetMasterData_ServantChangeMaster___, followerId);
    ...
    sub_1B863B8(&StringLiteral_11446/*"SERVANT_HIDE_NAME"*/, v16);
    sub_1B863B8(&StringLiteral_9128/*"NONE"*/, v17);
    this = (NpcServantFollowerEntity_o *)sub_1B863B8(&StringLiteral_1/*""*/, v18);
    byte_4A4E8E4 = 1;
  }
  *isChangeName = 1;
  if ( (v10->fields.flag & 2) == 0 )
  {
    ...
    if ( name && System_String__op_Inequality(name, (System_String_o *)StringLiteral_9128/*"NONE"*/, 0LL) )
...
LABEL_23:
  ...
  return LocalizationManager__Get((System_String_o *)StringLiteral_11446/*"SERVANT_HIDE_NAME"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B863B8(&Method_DataManager_GetMasterData_ServantChangeMaster___, followerId);
    sub_1B863B8(&Method_DataManager_GetMaster_ServantOverwriteMaster___, v9);
    sub_1B863B8(&DataManager_TypeInfo, v10);
    this = (NpcServantFollowerEntity_o *)sub_1B863B8(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v11);
    byte_4A4E8E5 = 1;
  }
  ...
  if ( NpcFollowerEntity )
  {
    ...
    if ( NpcFollowerEntity__IsOverwriteTreasureDevice(v14, v15) )
    {
      ...
      Instance = DataManager__GetMaster_object_((const MethodInfo_2F6DC64 *)Method_DataManager_GetMaster_ServantOverwriteMaster___);
      if ( Instance )
      {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4E8E6 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataManager_GetMasterData_NpcFollowerMaster___, followerId);
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_2F6DCB8 *)Method_DataManager_GetMasterData_NpcFollowerMaster___)) == 0LL )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4E8E9 & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Linq_Enumerable_Select_string__int___, method);
    sub_1B863B8(&Method_System_Linq_Enumerable_ToArray_int___, v3);
    sub_1B863B8(&System_Func_string__int__TypeInfo, v4);
    sub_1B863B8(&Method_System_Int32_Parse__, v5);
  ...
  if ( !individuality
    || (individuality = System_String__Replace_61691724(
                          individuality,
    ...
    || (individuality = System_String__Replace_61691724(
                          ...
                          0LL)) == 0LL )
  {
    sub_1B86614(individuality, v9);
  }
  v11 = (System_Collections_Generic_IEnumerable_TSource__o *)System_String__Split(individuality, 0x2Cu, 0, 0LL);
  v12 = (System_Func_object__int__o *)sub_1B86604(System_Func_string__int__TypeInfo);
        ...
        const MethodInfo *method)
{
  if ( (byte_4A4E8E8 & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_9128/*"NONE"*/, method);
    byte_4A4E8E8 = 1;
  }
  return System_String__op_Inequality(this->fields.individuality, (System_String_o *)StringLiteral_9128/*"NONE"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  int v56; // w8
  System_String_o *FollowerName_40433660; // x0
  int32_t v58; // w2
  ...
  if ( (byte_4A4E8E7 & 1) == 0 )
  {
    sub_1B863B8(&AppendPassiveSkillInfo___TypeInfo, followerId);
    sub_1B863B8(&AppendPassiveSkillInfo_TypeInfo, v14);
    sub_1B863B8(&Method_DataManager_GetMasterData_UserServantCollectionMaster___, v15);
    sub_1B863B8(&FollowerInfo_TypeInfo, v16);
    ...
    sub_1B863B8(&ServantLeaderInfo___TypeInfo, v20);
    sub_1B863B8(&ServantLeaderInfo_TypeInfo, v21);
  ...
  idList = 0LL;
  explanationList = 0LL;
  v23 = sub_1B86604(FollowerInfo_TypeInfo);
  FollowerInfo___ctor((FollowerInfo_o *)v23, 0LL);
  v24 = sub_1B86604(ServantLeaderInfo_TypeInfo);
...
LABEL_27:
    *(_QWORD *)(v24 + 120) = passiveSkill;
    sub_1B8635C((CGThumbnailListItem_o *)(v24 + 120), (int32_t)passiveSkill, v29, v30);
    goto LABEL_28;
  }
  if ( !idList )
    goto LABEL_27;
  ...
  if ( !v33 )
    goto LABEL_27;
  v34 = sub_1B86460(int___TypeInfo, (unsigned int)(v33 + v32));
  *(_QWORD *)(v24 + 120) = v34;
  v35 = (System_Array_o **)(v24 + 120);
  sub_1B8635C((CGThumbnailListItem_o *)(v24 + 120), v34, v36, v37);
...
LABEL_28:
  ...
  *(_DWORD *)(v24 + 192) = this->fields.flag | 1;
  ...
  if ( !appendPassiveSkillIds )
    goto LABEL_41;
  Instance = sub_1B86460(AppendPassiveSkillInfo___TypeInfo, appendPassiveSkillIds->max_length);
  ...
  while ( 1 )
  {
    ...
    if ( v48 - 8 >= (int)v45->max_length )
      break;
    v50 = (AppendPassiveSkillInfo_o *)sub_1B86604(AppendPassiveSkillInfo_TypeInfo);
    AppendPassiveSkillInfo___ctor(v50, 0LL);
    v51 = this->fields.appendPassiveSkillIds;
    if ( !v51 )
      goto LABEL_41;
    ...
    if ( !v50 )
      goto LABEL_41;
    v50->fields.skillId = *((_DWORD *)&v51->obj.klass + v48);
    ...
    if ( !v46 )
      goto LABEL_41;
    Instance = sub_1B864F4(v50, *(_QWORD *)(*(_QWORD *)v46 + 64LL));
    if ( !Instance )
      goto LABEL_54;
    if ( v49 >= v46[6] )
      goto LABEL_53;
    v47->klass = (CGThumbnailListItem_c *)v50;
    sub_1B8635C(v47, (int32_t)v50, v53, v54);
    v45 = this->fields.appendPassiveSkillIds;
    ++v48;
  ...
  *(_QWORD *)(v24 + 216) = v46;
  sub_1B8635C((CGThumbnailListItem_o *)(v24 + 216), (int32_t)v46, v43, v44);
  if ( !v23 )
    goto LABEL_41;
  *(_QWORD *)(v23 + 16) = v39;
  v56 = (*(_DWORD *)(v24 + 192) & 4) != 0 ? 4 : 3;
  *(_DWORD *)(v23 + 36) = v56;
  isChangeName = 0;
  FollowerName_40433660 = NpcServantFollowerEntity__GetFollowerName_40433660(
                            this,
                            v39,
                            questIda,
                            v40,
                            &isChangeName,
                            v55);
  *(_QWORD *)(v23 + 24) = FollowerName_40433660;
  sub_1B8635C((CGThumbnailListItem_o *)(v23 + 24), (int32_t)FollowerName_40433660, v58, v59);
  *(_DWORD *)(v23 + 32) = 0;
  v60 = sub_1B86460(ServantLeaderInfo___TypeInfo, 1LL);
  *(_QWORD *)(v23 + 40) = v60;
  sub_1B8635C((CGThumbnailListItem_o *)(v23 + 40), v60, v61, v62);
  v63 = *(_QWORD *)(v23 + 40);
  if ( !v63 )
    goto LABEL_41;
  Instance = sub_1B864F4(v24, *(_QWORD *)(*(_QWORD *)v63 + 64LL));
  if ( !Instance )
    goto LABEL_54;
  if ( !*(_DWORD *)(v63 + 24) )
    goto LABEL_53;
  *(_QWORD *)(v63 + 32) = v24;
  sub_1B8635C((CGThumbnailListItem_o *)(v63 + 32), v24, v64, v65);
  v66 = sub_1B86460(ServantLeaderInfo___TypeInfo, 1LL);
  *(_QWORD *)(v23 + 48) = v66;
  sub_1B8635C((CGThumbnailListItem_o *)(v23 + 48), v66, v67, v68);
  v69 = *(_QWORD *)(v23 + 48);
  if ( !v69 )
LABEL_41:
    sub_1B86614(Instance, v26);
  Instance = sub_1B864F4(v24, *(_QWORD *)(*(_QWORD *)v69 + 64LL));
  if ( !Instance )
  {
LABEL_54:
    v74 = sub_1B86638(Instance);
    sub_1B864E0(v74, 0LL);
  }
  if ( !*(_DWORD *)(v69 + 24) )
LABEL_53:
  ...
  *(_QWORD *)(v69 + 32) = v24;
  sub_1B8635C((CGThumbnailListItem_o *)(v69 + 32), v24, v70, v71);
  id = this->fields.id;
