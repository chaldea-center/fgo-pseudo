        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC860D & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_24168/*"text_effect_colors"*/);
    byte_4CC860D = 1;
  }
  StringValue = EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_24168/*"text_effect_colors"*/, 0, 0);
