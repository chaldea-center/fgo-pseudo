        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C23038 & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_24405/*"wuD6keVr"*/, v3);
    byte_4C23038 = 1;
  }
  StringValue = EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_24405/*"wuD6keVr"*/, 0LL, 0LL);
