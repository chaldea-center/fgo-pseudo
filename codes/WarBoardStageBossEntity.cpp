        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B381F2 & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_24192/*"text_effect_colors"*/, v3);
    byte_4B381F2 = 1;
  }
  StringValue = EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_24192/*"text_effect_colors"*/, 0LL, 0LL);
