        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C441AE & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_24050/*"text_effect_colors"*/);
    byte_4C441AE = 1;
  }
  StringValue = EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_24050/*"text_effect_colors"*/, 0, 0);
