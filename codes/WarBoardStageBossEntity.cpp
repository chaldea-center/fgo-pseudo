        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20AD2 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_23849/*"text_effect_colors"*/, v3);
    byte_4A20AD2 = 1;
  }
  StringValue = EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_23849/*"text_effect_colors"*/, 0LL, 0LL);
