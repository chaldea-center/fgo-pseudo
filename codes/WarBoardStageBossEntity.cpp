        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E788B9 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_24545/*"text_effect_colors"*/);
    byte_4E788B9 = 1;
  }
  StringValue = EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_24545/*"text_effect_colors"*/, 0, 0);
