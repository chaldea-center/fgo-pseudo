void FsmEventData___ctor(FsmEventData_o *this, const MethodInfo *method)
{
  ...
  v5 = StringLiteral_22356/*"none"*/;
  this->fields.eventData = (struct System_String_o *)StringLiteral_22356/*"none"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields, v5, v2, v3);
  v6 = StringLiteral_1/*""*/;
  this->fields.title = (struct System_String_o *)StringLiteral_1/*""*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.title, v6, v7, v8);
...
void FsmEventData__set_Title(FsmEventData_o *this, System_String_o *value, const MethodInfo *method)
{
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.title, (int32_t)value, (int32_t)method, v3);
}