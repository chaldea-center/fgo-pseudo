...
void EventFortificationListViewObject__Awake(EventFortificationListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB0609 & 1) == 0 )
  {
    sub_1C6BA08(&Method_UnityEngine_GameObject_GetComponent_EventFortificationListViewItemDraw___);
    byte_4CB0609 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_319312C *)Method_UnityEngine_GameObject_GetComponent_EventFortificationListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( v11 <= 4 )
  {
    v20 = dword_D1E9C8[v11];
    this->fields.dispMode = dword_D1E9B4[v11];
...
void EventFortificationListViewObject__Init_32004028(
        EventFortificationListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void EventFortificationListViewObject__Init_32004676(
        EventFortificationListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void EventFortificationListViewObject__Init_32021828(
        EventFortificationListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB060E & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_EventFortificationListViewObject_OnClickSelect__);
    sub_1C6BA08(&StringLiteral_9866/*"OnClickSelectObject"*/);
    sub_1C6BA08(&StringLiteral_9867/*"OnClickSelectPush"*/);
    byte_4CB060E = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem )
  {
    ...
    if ( monitor_high == 2 )
    {
      ...
      if ( (*((_BYTE *)Method_EventFortificationListViewObject_OnClickSelect__ + 83) & 2) != 0 )
        v11 = (_QWORD *)sub_1C6BA20(Method_EventFortificationListViewObject_OnClickSelect__);
...
LABEL_35:
    ...
    if ( monitor_high == 1 )
    {
      ...
      if ( (*((_BYTE *)Method_EventFortificationListViewObject_OnClickSelect__ + 83) & 2) != 0 )
        v9 = (_QWORD *)sub_1C6BA20(Method_EventFortificationListViewObject_OnClickSelect__);
...
LABEL_34:
    ...
    if ( (*((_BYTE *)Method_EventFortificationListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v14 = (_QWORD *)sub_1C6BA20(Method_EventFortificationListViewObject_OnClickSelect__);
...
void EventFortificationListViewObject__OnLongPush(EventFortificationListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C6BA08(&EventFortificationListViewItem_TypeInfo);
    sub_1C6BA08(&Method_EventFortificationListViewObject_OnLongPush__);
    sub_1C6BA08(&StringLiteral_9924/*"OnLongPushListView"*/);
    this = (EventFortificationListViewObject_o *)sub_1C6BA08(&StringLiteral_9942/*"OnPressCancel"*/);
    byte_4CB060F = 1;
  }
      ...
      && (EventFortificationListViewItem_c *)linkItem->klass->_2.typeHierarchy[naturalAligment - 1] == EventFortificationListViewItem_TypeInfo )
    {
      if ( BYTE3(linkItem[1].fields.sortValue2B) )
      {
        ...
        if ( (*((_BYTE *)Method_EventFortificationListViewObject_OnLongPush__ + 83) & 2) != 0 )
          v5 = (_QWORD *)sub_1C6BA20(Method_EventFortificationListViewObject_OnLongPush__);
...
void EventFortificationListViewObject__SetItem_32021128(
        EventFortificationListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void EventFortificationListViewObject__Start(EventFortificationListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    EventFortificationListViewObject__Init_32004028(this, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB060D & 1) == 0 )
  {
    sub_1C6BA08(&EventFortificationListViewItemDraw_DispMode_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v11 = (EventFortificationListViewObject_o *)sub_1C6BFFC(v8);
