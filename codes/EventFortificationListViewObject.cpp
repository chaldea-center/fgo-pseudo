...
void EventFortificationListViewObject__Awake(EventFortificationListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CE88C1 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_UnityEngine_GameObject_GetComponent_EventFortificationListViewItemDraw___);
    byte_4CE88C1 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_31C70C8 *)Method_UnityEngine_GameObject_GetComponent_EventFortificationListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( v11 <= 4 )
  {
    v20 = dword_D28074[v11];
    this->fields.dispMode = dword_D28060[v11];
...
void EventFortificationListViewObject__Init_32189076(
        EventFortificationListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void EventFortificationListViewObject__Init_32189724(
        EventFortificationListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void EventFortificationListViewObject__Init_32206876(
        EventFortificationListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CE88C6 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_EventFortificationListViewObject_OnClickSelect__);
    sub_1C7BAE8(&StringLiteral_9895/*"OnClickSelectObject"*/);
    sub_1C7BAE8(&StringLiteral_9896/*"OnClickSelectPush"*/);
    byte_4CE88C6 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem )
  {
    ...
    if ( monitor_high == 2 )
    {
      ...
      if ( (*((_BYTE *)Method_EventFortificationListViewObject_OnClickSelect__ + 83) & 2) != 0 )
        v11 = (_QWORD *)sub_1C7BB00(Method_EventFortificationListViewObject_OnClickSelect__);
...
LABEL_35:
    ...
    if ( monitor_high == 1 )
    {
      ...
      if ( (*((_BYTE *)Method_EventFortificationListViewObject_OnClickSelect__ + 83) & 2) != 0 )
        v9 = (_QWORD *)sub_1C7BB00(Method_EventFortificationListViewObject_OnClickSelect__);
...
LABEL_23:
    ...
    if ( monitor_high == 3 )
    {
      if ( !EventFortificationListViewItem__get_IsCanNotSelectPush(v5, method) )
      {
        ...
        if ( !manager )
          goto LABEL_35;
        v13 = &StringLiteral_9896/*"OnClickSelectPush"*/;
        goto LABEL_34;
      }
    }
    else if ( !v5->fields.isCanNotSelect )
    {
      v13 = &StringLiteral_9895/*"OnClickSelectObject"*/;
LABEL_34:
    ...
    if ( (*((_BYTE *)Method_EventFortificationListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v14 = (_QWORD *)sub_1C7BB00(Method_EventFortificationListViewObject_OnClickSelect__);
...
void EventFortificationListViewObject__OnLongPush(EventFortificationListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C7BAE8(&EventFortificationListViewItem_TypeInfo);
    sub_1C7BAE8(&Method_EventFortificationListViewObject_OnLongPush__);
    sub_1C7BAE8(&StringLiteral_9954/*"OnLongPushListView"*/);
    this = (EventFortificationListViewObject_o *)sub_1C7BAE8(&StringLiteral_9972/*"OnPressCancel"*/);
    byte_4CE88C7 = 1;
  }
      ...
      && (EventFortificationListViewItem_c *)linkItem->klass->_2.typeHierarchy[naturalAligment - 1] == EventFortificationListViewItem_TypeInfo )
    {
      if ( BYTE3(linkItem[1].fields.sortValue1B) )
      {
        ...
        if ( (*((_BYTE *)Method_EventFortificationListViewObject_OnLongPush__ + 83) & 2) != 0 )
          v5 = (_QWORD *)sub_1C7BB00(Method_EventFortificationListViewObject_OnLongPush__);
...
void EventFortificationListViewObject__SetItem_32206176(
        EventFortificationListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void EventFortificationListViewObject__Start(EventFortificationListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    EventFortificationListViewObject__Init_32189076(this, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CE88C5 & 1) == 0 )
  {
    sub_1C7BAE8(&EventFortificationListViewItemDraw_DispMode_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v11 = (EventFortificationListViewObject_o *)sub_1C7C0DC(v8);
