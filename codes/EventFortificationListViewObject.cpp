        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_418909E & 1) == 0 )
  {
    sub_B2C35C(&Method_UnityEngine_GameObject_GetComponent_EventFortificationListViewItemDraw___, method);
    byte_418909E = 1;
  }
  ...
  Component_srcLineSprite = (struct EventFortificationListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                                             dispObject,
                                                                             (const MethodInfo_1AA78DC *)Method_UnityEngine_GameObject_GetComponent_EventFortificationListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_418909F & 1) == 0 )
  {
    sub_B2C35C(&EventFortificationListViewItem_TypeInfo, method);
    byte_418909F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_41890A0 & 1) == 0 )
  {
    sub_B2C35C(&EventFortificationListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_41890A0 = 1;
  }
  linkItem = this->fields.linkItem;
...
LABEL_18:
  ...
  {
    v34 = dword_31A3720[v16];
    this->fields.dispMode = dword_31A3700[v16];
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventFortificationListViewObject__Init_27546832(
        EventFortificationListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventFortificationListViewObject__Init_27547512(
        EventFortificationListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventFortificationListViewObject__Init_27561600(
        EventFortificationListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B2C35C(&EventFortificationListViewItem_TypeInfo, method);
    sub_B2C35C(&EventFortificationListViewManager_TypeInfo, v3);
    sub_B2C35C(&SoundManager_TypeInfo, v4);
    sub_B2C35C(&StringLiteral_9972/*"OnClickSelectObject"*/, v5);
    sub_B2C35C(&StringLiteral_9973/*"OnClickSelectPush"*/, v6);
    byte_41890A3 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem )
...
LABEL_25:
    ...
    if ( klass_high == 3 )
    {
      if ( !EventFortificationListViewItem__get_IsCanNotSelectPush(v9, 0LL) )
      {
        ...
        if ( !manager )
          goto LABEL_38;
        v14 = &StringLiteral_9973/*"OnClickSelectPush"*/;
        goto LABEL_37;
      }
    }
    else if ( !v9->fields.isCanNotSelect )
    {
      v14 = &StringLiteral_9972/*"OnClickSelectObject"*/;
LABEL_37:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_41890A4 & 1) == 0 )
  {
    ...
    this = (EventFortificationListViewObject_o *)sub_B2C35C(&StringLiteral_10041/*"OnPressCancel"*/, v5);
    byte_41890A4 = 1;
  }
...
void __fastcall EventFortificationListViewObject__SetItem_27560744(
        EventFortificationListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_41890A2 & 1) == 0 )
  {
    sub_B2C35C(&EventFortificationListViewItemDraw_DispMode_TypeInfo, method);
        ...
        const MethodInfo *method)
{
  ...
  v11 = (EventFortificationListViewObject_o *)sub_B2C728(v8);
