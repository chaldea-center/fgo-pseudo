        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FB662 & 1) == 0 )
  {
    sub_B16FFC(&Method_UnityEngine_GameObject_GetComponent_EventFortificationListViewItemDraw___, method);
    byte_40FB662 = 1;
  }
  ...
  Component_srcLineSprite = (struct EventFortificationListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                                             dispObject,
                                                                             (const MethodInfo_19D14E0 *)Method_UnityEngine_GameObject_GetComponent_EventFortificationListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FB664 & 1) == 0 )
  {
    sub_B16FFC(&EventFortificationListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_40FB664 = 1;
  }
  linkItem = this->fields.linkItem;
...
LABEL_18:
  ...
  {
    v34 = dword_3137350[v16];
    this->fields.dispMode = dword_3137330[v16];
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventFortificationListViewObject__Init_27743480(
        EventFortificationListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventFortificationListViewObject__Init_27744160(
        EventFortificationListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventFortificationListViewObject__Init_27758248(
        EventFortificationListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
void __fastcall EventFortificationListViewObject__SetItem_27757392(
        EventFortificationListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
        ...
        const MethodInfo *method)
{
  ...
  v11 = (EventFortificationListViewObject_o *)sub_B173C8(v8);
