...
void EventFortificationListViewObject__Awake(EventFortificationListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC170C & 1) == 0 )
  {
    sub_1C713B0(&Method_UnityEngine_GameObject_GetComponent_EventFortificationListViewItemDraw___);
    byte_4CC170C = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_31A2ED0 *)Method_UnityEngine_GameObject_GetComponent_EventFortificationListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( v11 <= 4 )
  {
    v20 = dword_D21608[v11];
    this->fields.dispMode = dword_D215F4[v11];
...
void EventFortificationListViewObject__Init_32027100(
        EventFortificationListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void EventFortificationListViewObject__Init_32027748(
        EventFortificationListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void EventFortificationListViewObject__Init_32044900(
        EventFortificationListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC1711 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_EventFortificationListViewObject_OnClickSelect__);
    sub_1C713B0(&StringLiteral_9871/*"OnClickSelectObject"*/);
    sub_1C713B0(&StringLiteral_9872/*"OnClickSelectPush"*/);
    byte_4CC1711 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem )
  {
    ...
    if ( monitor_high == 2 )
    {
      ...
      if ( (*((_BYTE *)Method_EventFortificationListViewObject_OnClickSelect__ + 83) & 2) != 0 )
        v11 = (_QWORD *)sub_1C713C8(Method_EventFortificationListViewObject_OnClickSelect__);
...
LABEL_35:
    ...
    if ( monitor_high == 1 )
    {
      ...
      if ( (*((_BYTE *)Method_EventFortificationListViewObject_OnClickSelect__ + 83) & 2) != 0 )
        v9 = (_QWORD *)sub_1C713C8(Method_EventFortificationListViewObject_OnClickSelect__);
...
LABEL_23:
    ...
    if ( monitor_high == 3 )
    {
      if ( !EventFortificationListViewItem__get_IsCanNotSelectPush(v5, method) )
      {
        ...
        if ( !manager )
          goto LABEL_35;
        v13 = &StringLiteral_9872/*"OnClickSelectPush"*/;
        goto LABEL_34;
      }
    }
    else if ( !v5->fields.isCanNotSelect )
    {
      v13 = &StringLiteral_9871/*"OnClickSelectObject"*/;
LABEL_34:
    ...
    if ( (*((_BYTE *)Method_EventFortificationListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v14 = (_QWORD *)sub_1C713C8(Method_EventFortificationListViewObject_OnClickSelect__);
...
void EventFortificationListViewObject__OnLongPush(EventFortificationListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C713B0(&EventFortificationListViewItem_TypeInfo);
    sub_1C713B0(&Method_EventFortificationListViewObject_OnLongPush__);
    sub_1C713B0(&StringLiteral_9929/*"OnLongPushListView"*/);
    this = (EventFortificationListViewObject_o *)sub_1C713B0(&StringLiteral_9947/*"OnPressCancel"*/);
    byte_4CC1712 = 1;
  }
      ...
      && (EventFortificationListViewItem_c *)linkItem->klass->_2.typeHierarchy[naturalAligment - 1] == EventFortificationListViewItem_TypeInfo )
    {
      if ( BYTE3(linkItem[1].fields.sortValue2B) )
      {
        ...
        if ( (*((_BYTE *)Method_EventFortificationListViewObject_OnLongPush__ + 83) & 2) != 0 )
          v5 = (_QWORD *)sub_1C713C8(Method_EventFortificationListViewObject_OnLongPush__);
...
void EventFortificationListViewObject__SetItem_32044200(
        EventFortificationListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void EventFortificationListViewObject__Start(EventFortificationListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    EventFortificationListViewObject__Init_32027100(this, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC1710 & 1) == 0 )
  {
    sub_1C713B0(&EventFortificationListViewItemDraw_DispMode_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v11 = (EventFortificationListViewObject_o *)sub_1C719A4(v8);
