        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3B0EE & 1) == 0 )
  {
    sub_1BD3458(&Method_UnityEngine_GameObject_GetComponent_EventFortificationListViewItemDraw___, method);
    byte_4B3B0EE = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2F81A7C *)Method_UnityEngine_GameObject_GetComponent_EventFortificationListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3B0EF & 1) == 0 )
  {
    sub_1BD3458(&EventFortificationListViewItem_TypeInfo, method);
    byte_4B3B0EF = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3B0F0 & 1) == 0 )
  {
    sub_1BD3458(&EventFortificationListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4B3B0F0 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventFortificationListViewObject__Init_46587840(
        EventFortificationListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventFortificationListViewObject__Init_46588488(
        EventFortificationListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventFortificationListViewObject__Init_46605896(
        EventFortificationListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BD3458(&EventFortificationListViewItem_TypeInfo, method);
    sub_1BD3458(&EventFortificationListViewManager_TypeInfo, v3);
    sub_1BD3458(&Method_EventFortificationListViewObject_OnClickSelect__, v4);
    sub_1BD3458(&StringLiteral_10013/*"OnClickSelectObject"*/, v5);
    sub_1BD3458(&StringLiteral_10014/*"OnClickSelectPush"*/, v6);
    byte_4B3B0F3 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem )
  {
    ...
    if ( monitor_high == 2 )
    {
      ...
      if ( (*((_BYTE *)Method_EventFortificationListViewObject_OnClickSelect__ + 83) & 2) != 0 )
        v16 = (_QWORD *)sub_1BD3470(Method_EventFortificationListViewObject_OnClickSelect__);
...
LABEL_35:
    ...
    if ( monitor_high == 1 )
    {
      ...
      if ( (*((_BYTE *)Method_EventFortificationListViewObject_OnClickSelect__ + 83) & 2) != 0 )
        v13 = (_QWORD *)sub_1BD3470(Method_EventFortificationListViewObject_OnClickSelect__);
...
LABEL_34:
    ...
    if ( (*((_BYTE *)Method_EventFortificationListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v19 = (_QWORD *)sub_1BD3470(Method_EventFortificationListViewObject_OnClickSelect__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BD3458(&EventFortificationListViewItem_TypeInfo, method);
    sub_1BD3458(&Method_EventFortificationListViewObject_OnLongPush__, v3);
    sub_1BD3458(&StringLiteral_10069/*"OnLongPushListView"*/, v4);
    this = (EventFortificationListViewObject_o *)sub_1BD3458(&StringLiteral_10087/*"OnPressCancel"*/, v5);
    byte_4B3B0F4 = 1;
  }
      ...
      && (EventFortificationListViewItem_c *)linkItem->klass->_2.typeHierarchy[methodPtr_low - 1] == EventFortificationListViewItem_TypeInfo )
    {
      if ( BYTE3(linkItem[1].fields.sortValue2B) )
      {
        ...
        if ( (*((_BYTE *)Method_EventFortificationListViewObject_OnLongPush__ + 83) & 2) != 0 )
          v8 = (_QWORD *)sub_1BD3470(Method_EventFortificationListViewObject_OnLongPush__);
...
void __fastcall EventFortificationListViewObject__SetItem_46605196(
        EventFortificationListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
        ...
        const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    EventFortificationListViewObject__Init_46587840(this, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3B0F2 & 1) == 0 )
  {
    sub_1BD3458(&EventFortificationListViewItemDraw_DispMode_TypeInfo, method);
