        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73C23 & 1) == 0 )
  {
    sub_1B90010(&Method_UnityEngine_GameObject_GetComponent_EventFortificationListViewItemDraw___, method);
    byte_4A73C23 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2EDD768 *)Method_UnityEngine_GameObject_GetComponent_EventFortificationListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73C24 & 1) == 0 )
  {
    sub_1B90010(&EventFortificationListViewItem_TypeInfo, method);
    byte_4A73C24 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73C25 & 1) == 0 )
  {
    sub_1B90010(&EventFortificationListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4A73C25 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.CallbackFunc, (int32_t)callbackFunc, v19, v20);
  if ( v11 <= 4 )
  {
    v24 = dword_BF2888[v11];
    this->fields.dispMode = dword_BF2874[v11];
  ...
  if ( p_CallbackFunc->klass )
  {
    ...
    sub_1B8FFB4(p_CallbackFunc, 0, v22, v23);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventFortificationListViewObject__Init_45654424(
        EventFortificationListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventFortificationListViewObject__Init_45655072(
        EventFortificationListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventFortificationListViewObject__Init_45670356(
        EventFortificationListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B90010(&EventFortificationListViewItem_TypeInfo, method);
    sub_1B90010(&EventFortificationListViewManager_TypeInfo, v3);
    sub_1B90010(&Method_EventFortificationListViewObject_OnClickSelect__, v4);
    sub_1B90010(&StringLiteral_9872/*"OnClickSelectObject"*/, v5);
    sub_1B90010(&StringLiteral_9873/*"OnClickSelectPush"*/, v6);
    byte_4A73C28 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem )
  {
    ...
    if ( monitor_high == 2 )
    {
      ...
      if ( (*((_BYTE *)Method_EventFortificationListViewObject_OnClickSelect__ + 83) & 2) != 0 )
        v15 = (_QWORD *)sub_1B90028(Method_EventFortificationListViewObject_OnClickSelect__);
...
LABEL_35:
    ...
    if ( monitor_high == 1 )
    {
      ...
      if ( (*((_BYTE *)Method_EventFortificationListViewObject_OnClickSelect__ + 83) & 2) != 0 )
        v13 = (_QWORD *)sub_1B90028(Method_EventFortificationListViewObject_OnClickSelect__);
...
LABEL_23:
    ...
    if ( monitor_high == 3 )
    {
      if ( !EventFortificationListViewItem__get_IsCanNotSelectPush(v9, method) )
      {
        ...
        if ( !manager )
          goto LABEL_35;
        v17 = &StringLiteral_9873/*"OnClickSelectPush"*/;
        goto LABEL_34;
      }
    }
    else if ( !v9->fields.isCanNotSelect )
    {
      v17 = &StringLiteral_9872/*"OnClickSelectObject"*/;
LABEL_34:
    ...
    if ( (*((_BYTE *)Method_EventFortificationListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v18 = (_QWORD *)sub_1B90028(Method_EventFortificationListViewObject_OnClickSelect__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B90010(&EventFortificationListViewItem_TypeInfo, method);
    sub_1B90010(&Method_EventFortificationListViewObject_OnLongPush__, v3);
    sub_1B90010(&StringLiteral_9927/*"OnLongPushListView"*/, v4);
    this = (EventFortificationListViewObject_o *)sub_1B90010(&StringLiteral_9946/*"OnPressCancel"*/, v5);
    byte_4A73C29 = 1;
  }
      ...
      && (EventFortificationListViewItem_c *)linkItem->klass->_2.typeHierarchy[methodPtr_low - 1] == EventFortificationListViewItem_TypeInfo )
    {
      if ( BYTE3(linkItem[1].fields.sortValue2B) )
      {
        ...
        if ( (*((_BYTE *)Method_EventFortificationListViewObject_OnLongPush__ + 83) & 2) != 0 )
          v8 = (_QWORD *)sub_1B90028(Method_EventFortificationListViewObject_OnLongPush__);
...
void __fastcall EventFortificationListViewObject__SetItem_45669656(
        EventFortificationListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
        ...
        const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    EventFortificationListViewObject__Init_45654424(this, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73C27 & 1) == 0 )
  {
    sub_1B90010(&EventFortificationListViewItemDraw_DispMode_TypeInfo, method);
