        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9B4A & 1) == 0 )
  {
    sub_1BAB41C(&Method_UnityEngine_GameObject_GetComponent_EventFortificationListViewItemDraw___, method);
    byte_4AB9B4A = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2F13970 *)Method_UnityEngine_GameObject_GetComponent_EventFortificationListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9B4B & 1) == 0 )
  {
    sub_1BAB41C(&EventFortificationListViewItem_TypeInfo, method);
    byte_4AB9B4B = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9B4C & 1) == 0 )
  {
    sub_1BAB41C(&EventFortificationListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4AB9B4C = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.CallbackFunc, (int32_t)callbackFunc, v19, v20);
  if ( v11 <= 4 )
  {
    v24 = dword_BFBD00[v11];
    this->fields.dispMode = dword_BFBCEC[v11];
  ...
  if ( p_CallbackFunc->klass )
  {
    ...
    sub_1BAB3C0(p_CallbackFunc, 0, v22, v23);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventFortificationListViewObject__Init_46025068(
        EventFortificationListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventFortificationListViewObject__Init_46025716(
        EventFortificationListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventFortificationListViewObject__Init_46041000(
        EventFortificationListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BAB41C(&EventFortificationListViewItem_TypeInfo, method);
    sub_1BAB41C(&EventFortificationListViewManager_TypeInfo, v3);
    sub_1BAB41C(&Method_EventFortificationListViewObject_OnClickSelect__, v4);
    sub_1BAB41C(&StringLiteral_9872/*"OnClickSelectObject"*/, v5);
    sub_1BAB41C(&StringLiteral_9873/*"OnClickSelectPush"*/, v6);
    byte_4AB9B4F = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem )
  {
    ...
    if ( monitor_high == 2 )
    {
      ...
      if ( (*((_BYTE *)Method_EventFortificationListViewObject_OnClickSelect__ + 83) & 2) != 0 )
        v15 = (_QWORD *)sub_1BAB434(Method_EventFortificationListViewObject_OnClickSelect__);
...
LABEL_35:
    ...
    if ( monitor_high == 1 )
    {
      ...
      if ( (*((_BYTE *)Method_EventFortificationListViewObject_OnClickSelect__ + 83) & 2) != 0 )
        v13 = (_QWORD *)sub_1BAB434(Method_EventFortificationListViewObject_OnClickSelect__);
...
LABEL_34:
    ...
    if ( (*((_BYTE *)Method_EventFortificationListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v18 = (_QWORD *)sub_1BAB434(Method_EventFortificationListViewObject_OnClickSelect__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BAB41C(&EventFortificationListViewItem_TypeInfo, method);
    sub_1BAB41C(&Method_EventFortificationListViewObject_OnLongPush__, v3);
    sub_1BAB41C(&StringLiteral_9928/*"OnLongPushListView"*/, v4);
    this = (EventFortificationListViewObject_o *)sub_1BAB41C(&StringLiteral_9946/*"OnPressCancel"*/, v5);
    byte_4AB9B50 = 1;
  }
      ...
      && (EventFortificationListViewItem_c *)linkItem->klass->_2.typeHierarchy[methodPtr_low - 1] == EventFortificationListViewItem_TypeInfo )
    {
      if ( BYTE3(linkItem[1].fields.sortValue2B) )
      {
        ...
        if ( (*((_BYTE *)Method_EventFortificationListViewObject_OnLongPush__ + 83) & 2) != 0 )
          v8 = (_QWORD *)sub_1BAB434(Method_EventFortificationListViewObject_OnLongPush__);
...
void __fastcall EventFortificationListViewObject__SetItem_46040300(
        EventFortificationListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
        ...
        const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    EventFortificationListViewObject__Init_46025068(this, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9B4E & 1) == 0 )
  {
    sub_1BAB41C(&EventFortificationListViewItemDraw_DispMode_TypeInfo, method);
