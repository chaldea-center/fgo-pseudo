void VoicePlayCondMaster___cctor(const MethodInfo *method)
{
  if ( (byte_4E05B34 & 1) == 0 )
  {
    sub_1CE6700(&VoicePlayCondMaster_TypeInfo);
    byte_4E05B34 = 1;
  }
...
void VoicePlayCondMaster___ctor(VoicePlayCondMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4E05B2F & 1) == 0 )
  {
    sub_1CE6700(&Method_DataMasterBase_VoicePlayCondMaster__VoicePlayCondEntity__string___ctor__);
    byte_4E05B2F = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    228,
    (const MethodInfo_34EBC44 *)Method_DataMasterBase_VoicePlayCondMaster__VoicePlayCondEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E05B33 & 1) == 0 )
  {
    sub_1CE6700(&Method_System_Collections_ObjectModel_Collection_VoicePlayCondEntity__get_Count__);
    sub_1CE6700(&Method_System_Collections_ObjectModel_Collection_VoicePlayCondEntity__get_Item__);
    sub_1CE6700(&Method_System_Collections_Generic_List_VoicePlayCondEntity__Add__);
    sub_1CE6700(&Method_System_Collections_Generic_List_VoicePlayCondEntity___ctor__);
    sub_1CE6700(&System_Collections_Generic_List_VoicePlayCondEntity__TypeInfo);
    byte_4E05B33 = 1;
  }
  v5 = (System_Collections_Generic_List_object__o *)sub_1CE694C(System_Collections_Generic_List_VoicePlayCondEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v5,
    (const MethodInfo_3905734 *)Method_System_Collections_Generic_List_VoicePlayCondEntity___ctor__);
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
    goto LABEL_16;
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            list,
            (const MethodInfo_3480AB0 *)Method_System_Collections_ObjectModel_Collection_VoicePlayCondEntity__get_Count__);
  if ( Count >= 1 )
  {
    v9 = Count;
    v10 = 0;
    while ( 1 )
    {
      ...
      list = (System_Collections_ObjectModel_Collection_T__o *)System_Collections_ObjectModel_Collection_object___get_Item(
                                                                 list,
                                                                 v10,
                                                                 (const MethodInfo_3480B40 *)Method_System_Collections_ObjectModel_Collection_VoicePlayCondEntity__get_Item__);
      if ( !list )
        break;
      v6 = list;
  ...
  while ( 1 )
  {
    ...
    if ( Item )
    {
      ...
      *(_QWORD *)&v20.fields.fakeValue = monitor;
      if ( CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_50038008(v20, 0) == svtId )
      {
  ...
  while ( 1 )
  {
    ...
    if ( Item )
    {
      ...
      *(_QWORD *)&v21.fields.fakeValue = monitor;
      if ( CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_50038008(v21, 0) == svtId )
      {
        ...
        const MethodInfo *method)
{
  ...
  return VoicePlayCondMaster__isVoicePlay_44417472(
           this,
           svtId,
           voiceId,
           &condEntity,
...
// local variable allocation has failed, the output may be wrong!
bool VoicePlayCondMaster__isVoicePlay_44417472(
        VoicePlayCondMaster_o *this,
        int32_t svtId,
        System_String_o *voiceId,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E05B30 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_DataMasterBase_VoicePlayCondMaster__VoicePlayCondEntity__string__get_lookup__);
    sub_1CE6700(&System_Collections_Generic_IReadOnlyDictionary_string__VoicePlayCondEntity__TypeInfo);
    sub_1CE6700(&Method_System_Collections_Generic_List_CondType_Kind__Contains__);
    sub_1CE6700(&VoicePlayCondMaster_TypeInfo);
    byte_4E05B30 = 1;
  }
  *condEntity = 0;
...
LABEL_50:
  ...
  while ( 1 )
  {
    ...
    lookup = DataMasterBase_object__object__object___get_lookup(
               (DataMasterBase_TMaster__TEntity__PKType__o *)this,
               (const MethodInfo_34EBD5C *)Method_DataMasterBase_VoicePlayCondMaster__VoicePlayCondEntity__string__get_lookup__);
    if ( !lookup )
      goto LABEL_50;
    v26 = *(_DWORD **)lookup;
    v27 = lookup;
    ...
    {
LABEL_20:
      v30 = sub_1CBCA7C(lookup, System_Collections_Generic_IReadOnlyDictionary_string__VoicePlayCondEntity__TypeInfo, 0);
    }
    ...
    {
LABEL_28:
      v35 = sub_1CBCA7C(lookup, System_Collections_Generic_IReadOnlyDictionary_string__VoicePlayCondEntity__TypeInfo, 2);
    }
    v36 = (VoicePlayCondEntity_o *)(*(__int64 (__fastcall **)(void *, System_String_o *, _QWORD))v35)(
                                     ...
                                     *(_QWORD *)(v35 + 8));
    *condEntity = v36;
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)condEntity, (int32_t)v36, v37, v38, v39, v40, v41, v42);
    if ( !v36 )
      goto LABEL_50;
    ++v21;
...
LABEL_35:
      ...
      if ( !disableCondTypeList
        || (v44 = System_Collections_Generic_List_Int32Enum___Contains(
                    ...
                    v43,
                    (const MethodInfo_38EBAE8 *)Method_System_Collections_Generic_List_CondType_Kind__Contains__),
            IsOpen = 1,
            !v44) )
      {
        if ( userSvtId < 0 )
