...
void VoicePlayCondMaster___ctor(VoicePlayCondMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4C38ACF & 1) == 0 )
  {
    sub_1C32C20(&Method_DataMasterBase_VoicePlayCondMaster__VoicePlayCondEntity__string___ctor__);
    byte_4C38ACF = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    228,
    (const MethodInfo_3398FCC *)Method_DataMasterBase_VoicePlayCondMaster__VoicePlayCondEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C38AD3 & 1) == 0 )
  {
    sub_1C32C20(&Method_System_Collections_ObjectModel_Collection_VoicePlayCondEntity__get_Count__);
    sub_1C32C20(&Method_System_Collections_ObjectModel_Collection_VoicePlayCondEntity__get_Item__);
    sub_1C32C20(&Method_System_Collections_Generic_List_VoicePlayCondEntity__Add__);
    sub_1C32C20(&Method_System_Collections_Generic_List_VoicePlayCondEntity___ctor__);
    sub_1C32C20(&System_Collections_Generic_List_VoicePlayCondEntity__TypeInfo);
    byte_4C38AD3 = 1;
  }
  v5 = (System_Collections_Generic_List_object__o *)sub_1C32E6C(System_Collections_Generic_List_VoicePlayCondEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v5,
    (const MethodInfo_3797F88 *)Method_System_Collections_Generic_List_VoicePlayCondEntity___ctor__);
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
    goto LABEL_16;
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            list,
            (const MethodInfo_332FCA8 *)Method_System_Collections_ObjectModel_Collection_VoicePlayCondEntity__get_Count__);
  if ( Count >= 1 )
  {
    v8 = Count;
    v9 = 0;
    while ( 1 )
    {
      ...
      list = (System_Collections_ObjectModel_Collection_T__o *)System_Collections_ObjectModel_Collection_object___get_Item(
                                                                 list,
                                                                 v9,
                                                                 (const MethodInfo_332FD38 *)Method_System_Collections_ObjectModel_Collection_VoicePlayCondEntity__get_Item__);
      if ( !list )
        break;
      v12 = list;
  ...
  while ( 1 )
  {
    ...
    if ( Item )
    {
      ...
      *(_QWORD *)&v20.fields.fakeValue = monitor;
      if ( CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48887784(v20, 0) == svtId )
      {
  ...
  while ( 1 )
  {
    ...
    if ( Item )
    {
      ...
      *(_QWORD *)&v21.fields.fakeValue = monitor;
      if ( CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48887784(v21, 0) == svtId )
      {
        ...
        const MethodInfo *method)
{
  ...
  return VoicePlayCondMaster__isVoicePlay_43184680(
           this,
           svtId,
           voiceId,
           &condEntity,
...
bool VoicePlayCondMaster__isVoicePlay_43184680(
        VoicePlayCondMaster_o *this,
        int32_t svtId,
        System_String_o *voiceId,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C38AD0 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_DataMasterBase_VoicePlayCondMaster__VoicePlayCondEntity__string__get_lookup__);
    sub_1C32C20(&System_Collections_Generic_IReadOnlyDictionary_string__VoicePlayCondEntity__TypeInfo);
    sub_1C32C20(&Method_System_Collections_Generic_List_CondType_Kind__Contains__);
    sub_1C32C20(&UnityEngine_Object_TypeInfo);
    sub_1C32C20(&VoicePlayCondMaster_TypeInfo);
    byte_4C38AD0 = 1;
  }
  *condEntity = 0;
  sub_1C32BC4((CGThumbnailListItem_o *)condEntity, 0, (int32_t)voiceId, (const MethodInfo *)condEntity);
...
LABEL_67:
  ...
  while ( 1 )
  {
    ...
    lookup = DataMasterBase_object__object__object___get_lookup(
               (DataMasterBase_TMaster__TEntity__PKType__o *)this,
               (const MethodInfo_33990E4 *)Method_DataMasterBase_VoicePlayCondMaster__VoicePlayCondEntity__string__get_lookup__);
    if ( !lookup )
      goto LABEL_67;
    v27 = *(_DWORD **)lookup;
    v28 = lookup;
    ...
    {
LABEL_20:
      v31 = sub_1C83438(lookup, System_Collections_Generic_IReadOnlyDictionary_string__VoicePlayCondEntity__TypeInfo, 0);
    }
    ...
    {
LABEL_28:
      v36 = sub_1C83438(lookup, System_Collections_Generic_IReadOnlyDictionary_string__VoicePlayCondEntity__TypeInfo, 2);
    }
    v37 = (VoicePlayCondEntity_o *)(*(__int64 (__fastcall **)(void *, System_String_o *, _QWORD))v36)(
                                     ...
                                     *(_QWORD *)(v36 + 8));
    *condEntity = v37;
    sub_1C32BC4((CGThumbnailListItem_o *)condEntity, (int32_t)v37, v38, v39);
    if ( !v37 )
      goto LABEL_67;
    ++v22;
...
LABEL_35:
      ...
      if ( !disableCondTypeList
        || (v42 = System_Collections_Generic_List_Int32Enum___Contains(
                    ...
                    condType,
                    (const MethodInfo_377E33C *)Method_System_Collections_Generic_List_CondType_Kind__Contains__),
            IsStartingMember = 1,
            !v42) )
      {
        if ( userSvtId < 0 )
