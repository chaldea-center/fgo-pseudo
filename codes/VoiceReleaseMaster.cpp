void __fastcall VoiceReleaseMaster___ctor(VoiceReleaseMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A70DAC & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_VoiceReleaseMaster__VoiceReleaseEntity__string___ctor__, method);
    byte_4A70DAC = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    169,
    (const MethodInfo_312C8C0 *)Method_DataMasterBase_VoiceReleaseMaster__VoiceReleaseEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A70DAD & 1) == 0 )
  {
    sub_1B90010(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__, voiceId);
    sub_1B90010(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Item__, v5);
    sub_1B90010(&Method_System_Collections_Generic_List_VoiceReleaseEntity__Add__, v6);
    sub_1B90010(&Method_System_Collections_Generic_List_VoiceReleaseEntity__ToArray__, v7);
    sub_1B90010(&Method_System_Collections_Generic_List_VoiceReleaseEntity___ctor__, v8);
    sub_1B90010(&System_Collections_Generic_List_VoiceReleaseEntity__TypeInfo, v9);
    sub_1B90010(&CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo, v10);
    sub_1B90010(&VoiceReleaseEntity_TypeInfo, v11);
    byte_4A70DAD = 1;
  }
  ...
  v14 = (System_Collections_Generic_List_object__o *)sub_1B9025C(System_Collections_Generic_List_VoiceReleaseEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v14,
    (const MethodInfo_351018C *)Method_System_Collections_Generic_List_VoiceReleaseEntity___ctor__);
  if ( Count >= 1 )
  {
    v15 = 0;
    while ( 1 )
          ...
          && (VoiceReleaseEntity_c *)list->klass->_2.typeHierarchy[methodPtr_low - 1] == VoiceReleaseEntity_TypeInfo )
        {
          ...
          if ( ((unsigned __int8)list & 1) != 0 )
          {
            ...
            else
            {
              ...
              sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v25 + 4), (int32_t)v16, v20, v21);
            }
          }
        }
      }
...
LABEL_19:
  ...
  return (VoiceReleaseEntity_array *)System_Collections_Generic_List_object___ToArray(
                                       v14,
                                       (const MethodInfo_3512518 *)Method_System_Collections_Generic_List_VoiceReleaseEntity__ToArray__);
}
