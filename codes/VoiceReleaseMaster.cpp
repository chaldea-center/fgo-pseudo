void __fastcall VoiceReleaseMaster___ctor(VoiceReleaseMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A4F506 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataMasterBase_VoiceReleaseMaster__VoiceReleaseEntity__string___ctor__, method);
    byte_4A4F506 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    173,
    (const MethodInfo_3216A14 *)Method_DataMasterBase_VoiceReleaseMaster__VoiceReleaseEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4F507 & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Collections_ObjectModel_Collection_VoiceReleaseEntity__get_Count__, voiceId);
    sub_1B863B8(&Method_System_Collections_ObjectModel_Collection_VoiceReleaseEntity__get_Item__, v5);
    sub_1B863B8(&Method_System_Collections_Generic_List_VoiceReleaseEntity__Add__, v6);
    sub_1B863B8(&Method_System_Collections_Generic_List_VoiceReleaseEntity__ToArray__, v7);
    sub_1B863B8(&Method_System_Collections_Generic_List_VoiceReleaseEntity___ctor__, v8);
    sub_1B863B8(&System_Collections_Generic_List_VoiceReleaseEntity__TypeInfo, v9);
  ...
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            list,
            (const MethodInfo_31B0908 *)Method_System_Collections_ObjectModel_Collection_VoiceReleaseEntity__get_Count__);
  v13 = (System_Collections_Generic_List_object__o *)sub_1B86604(System_Collections_Generic_List_VoiceReleaseEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v13,
    (const MethodInfo_35FC124 *)Method_System_Collections_Generic_List_VoiceReleaseEntity___ctor__);
  if ( Count >= 1 )
  {
    v14 = 0;
    while ( 1 )
    {
      ...
      list = (System_Collections_ObjectModel_Collection_T__o *)System_Collections_ObjectModel_Collection_object___get_Item(
                                                                 list,
                                                                 v14,
                                                                 (const MethodInfo_31B0998 *)Method_System_Collections_ObjectModel_Collection_VoiceReleaseEntity__get_Item__);
      if ( list )
      {
...
LABEL_17:
  ...
  return (VoiceReleaseEntity_array *)System_Collections_Generic_List_object___ToArray(
                                       v13,
                                       (const MethodInfo_35FE4B0 *)Method_System_Collections_Generic_List_VoiceReleaseEntity__ToArray__);
}
