void __fastcall VoiceReleaseMaster___ctor(VoiceReleaseMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4B45B20 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataMasterBase_VoiceReleaseMaster__VoiceReleaseEntity__string___ctor__, method);
    byte_4B45B20 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    173,
    (const MethodInfo_32E45D0 *)Method_DataMasterBase_VoiceReleaseMaster__VoiceReleaseEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45B21 & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Collections_ObjectModel_Collection_VoiceReleaseEntity__get_Count__, voiceId);
    sub_1BDB878(&Method_System_Collections_ObjectModel_Collection_VoiceReleaseEntity__get_Item__, v5);
    sub_1BDB878(&Method_System_Collections_Generic_List_VoiceReleaseEntity__Add__, v6);
    sub_1BDB878(&Method_System_Collections_Generic_List_VoiceReleaseEntity__ToArray__, v7);
    sub_1BDB878(&Method_System_Collections_Generic_List_VoiceReleaseEntity___ctor__, v8);
    sub_1BDB878(&System_Collections_Generic_List_VoiceReleaseEntity__TypeInfo, v9);
  ...
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            list,
            (const MethodInfo_327D624 *)Method_System_Collections_ObjectModel_Collection_VoiceReleaseEntity__get_Count__);
  v13 = (System_Collections_Generic_List_object__o *)sub_1BDBAC4(System_Collections_Generic_List_VoiceReleaseEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v13,
    (const MethodInfo_36D5590 *)Method_System_Collections_Generic_List_VoiceReleaseEntity___ctor__);
  if ( Count >= 1 )
  {
    v14 = 0;
    while ( 1 )
    {
      ...
      list = (System_Collections_ObjectModel_Collection_T__o *)System_Collections_ObjectModel_Collection_object___get_Item(
                                                                 list,
                                                                 v14,
                                                                 (const MethodInfo_327D6B4 *)Method_System_Collections_ObjectModel_Collection_VoiceReleaseEntity__get_Item__);
      if ( list )
      {
...
LABEL_17:
  ...
  return (VoiceReleaseEntity_array *)System_Collections_Generic_List_object___ToArray(
                                       v13,
                                       (const MethodInfo_36D791C *)Method_System_Collections_Generic_List_VoiceReleaseEntity__ToArray__);
}
  ...
  if ( (int)v8 >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v10++ >= v9->max_length )
        sub_1BDBADC(IsCondEnable, v6, v7);
    }
LABEL_12:
