...
int32_t __fastcall FunctionGroupEntity__GetCheckEventQuest(FunctionGroupEntity_o *this, const MethodInfo *method)
{
  if ( (byte_49FE753 & 1) == 0 )
  {
    sub_1B64870(&StringLiteral_17872/*"checkEventQuest"*/, method);
    byte_49FE753 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_17872/*"checkEventQuest"*/, 0, 0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_49FE752 & 1) == 0 )
  {
    sub_1B64870(&StringLiteral_20003/*"iconDetailText"*/, method);
    byte_49FE752 = 1;
  }
