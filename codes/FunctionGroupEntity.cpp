...
int32_t __fastcall FunctionGroupEntity__GetCheckEventQuest(FunctionGroupEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4B02285 & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_17782/*"checkEventQuest"*/, method);
    byte_4B02285 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_17782/*"checkEventQuest"*/, 0, 0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4B02284 & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_19928/*"iconDetailText"*/, method);
    byte_4B02284 = 1;
  }
  return EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_19928/*"iconDetailText"*/, 0LL, 0LL);
}