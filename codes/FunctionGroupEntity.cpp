...
System_String_o *__fastcall FunctionGroupEntity__CreatePK(int32_t funcId, int32_t eventId, const MethodInfo *method)
{
  if ( (byte_4AB5F99 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&eventId);
    byte_4AB5F99 = 1;
  }
...
int32_t __fastcall FunctionGroupEntity__GetCheckEventQuest(FunctionGroupEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4AB5F9B & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_17971/*"checkEventQuest"*/, method);
    byte_4AB5F9B = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_17971/*"checkEventQuest"*/, 0, 0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4AB5F9A & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_20109/*"iconDetailText"*/, method);
    byte_4AB5F9A = 1;
  }
  return EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_20109/*"iconDetailText"*/, 0LL, 0LL);
}