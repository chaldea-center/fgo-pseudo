...
int32_t __fastcall FunctionGroupEntity__GetCheckEventQuest(FunctionGroupEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4BFD99C & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_18257/*"checkEventQuest"*/, method);
    byte_4BFD99C = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_18257/*"checkEventQuest"*/, 0, 0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4BFD99B & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_20439/*"iconDetailText"*/, method);
    byte_4BFD99B = 1;
  }
  return EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_20439/*"iconDetailText"*/, 0LL, 0LL);
}