...
int32_t __fastcall FunctionGroupEntity__GetCheckEventQuest(FunctionGroupEntity_o *this, const MethodInfo *method)
{
  if ( (byte_49BB0C3 & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_17637/*"checkEventQuest"*/, method);
    byte_49BB0C3 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_17637/*"checkEventQuest"*/, 0, 0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_49BB0C2 & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_19771/*"iconDetailText"*/, method);
    byte_49BB0C2 = 1;
  }
  return EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_19771/*"iconDetailText"*/, 0LL, 0LL);
}