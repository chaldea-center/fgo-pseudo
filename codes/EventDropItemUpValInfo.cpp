        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B36D33 & 1) == 0 )
  {
    sub_1BD3458(&Method_DataManager_GetMasterData_FunctionGroupMaster___, *(_QWORD *)&member);
  ...
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.funcEntity, (int64_t)funcEntity, v12, v13, v14, v15, v16, v17);
  ...
  Instance = DataManager__GetMasterData_object_(
               ...
               (const MethodInfo_2F31684 *)Method_DataManager_GetMasterData_FunctionGroupMaster___);
...
LABEL_24:
    sub_1BD36B4(Instance, funcGroupEntity);
  }
LABEL_23:
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventDropItemUpValInfo___ctor_39680612(
        EventDropItemUpValInfo_o *this,
        int32_t member,
        EventDropUpValInfo_o *dropInfo,
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.baseFuncType = funcType;
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.itemEntity, (int64_t)itemEntity, v20, v21, v22, v23, v24, v25);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37FDC48 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_18;
  Instance = DataManager__GetMasterData_object_(
