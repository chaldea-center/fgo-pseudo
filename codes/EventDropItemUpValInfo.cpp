        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FBFCA & 1) == 0 )
  {
    sub_1B640C8(&Method_DataManager_GetMasterData_FunctionGroupMaster___, *(_QWORD *)&member);
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.funcEntity, (int32_t)funcEntity, v11, v12);
  ...
  Instance = DataManager__GetMasterData_object_(
               ...
               (const MethodInfo_2E393EC *)Method_DataManager_GetMasterData_FunctionGroupMaster___);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventDropItemUpValInfo___ctor_38571828(
        EventDropItemUpValInfo_o *this,
        int32_t member,
        EventDropUpValInfo_o *dropInfo,
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.baseFuncType = funcType;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.itemEntity, (int32_t)itemEntity, v15, v16);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EC03C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_18;
  Instance = DataManager__GetMasterData_object_(
  ...
  p_funcGroupEntity = &this->fields.funcGroupEntity;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.funcGroupEntity, (int32_t)Entity, v22, v23);
