...
void __fastcall ServantWaveTurnEvent___ctor_45330484(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24ED5 & 1) == 0 )
  {
    sub_1C3B764(&ServantWaveTurnEvent_SaveData_TypeInfo, method);
    byte_4C24ED5 = 1;
  }
  v3 = sub_1C3B9B0(ServantWaveTurnEvent_SaveData_TypeInfo);
