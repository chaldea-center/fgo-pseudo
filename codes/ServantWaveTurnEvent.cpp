...
void __fastcall ServantWaveTurnEvent___ctor_44993840(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDF362 & 1) == 0 )
  {
    sub_1C21E38(&ServantWaveTurnEvent_SaveData_TypeInfo);
    byte_4BDF362 = 1;
  }
  v3 = sub_1C22084(ServantWaveTurnEvent_SaveData_TypeInfo);
