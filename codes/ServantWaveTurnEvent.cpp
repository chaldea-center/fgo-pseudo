...
void __fastcall ServantWaveTurnEvent___ctor_44056280(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB8A57 & 1) == 0 )
  {
    sub_1BAB41C(&ServantWaveTurnEvent_SaveData_TypeInfo, method);
    byte_4AB8A57 = 1;
  }
  v3 = sub_1BAB668(ServantWaveTurnEvent_SaveData_TypeInfo);
