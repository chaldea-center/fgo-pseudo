...
void __fastcall ServantWaveTurnEvent___ctor_45819656(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B0507B & 1) == 0 )
  {
    sub_1BC3008(&ServantWaveTurnEvent_SaveData_TypeInfo, method);
    byte_4B0507B = 1;
  }
  v3 = sub_1BC3254(ServantWaveTurnEvent_SaveData_TypeInfo);
