...
void __fastcall ServantWaveTurnEvent___ctor_45857112(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47B67 & 1) == 0 )
  {
    sub_1BDB878(&ServantWaveTurnEvent_SaveData_TypeInfo, method);
    byte_4B47B67 = 1;
  }
  v3 = sub_1BDBAC4(ServantWaveTurnEvent_SaveData_TypeInfo);
