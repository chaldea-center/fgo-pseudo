...
void __fastcall ServantWaveTurnEvent___ctor_44955824(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A51508 & 1) == 0 )
  {
    sub_1B863B8(&ServantWaveTurnEvent_SaveData_TypeInfo, method);
    byte_4A51508 = 1;
  }
  v3 = sub_1B86604(ServantWaveTurnEvent_SaveData_TypeInfo);
