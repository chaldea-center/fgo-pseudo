...
void __fastcall ServantWaveTurnEvent___ctor_44464728(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BDE10 & 1) == 0 )
  {
    sub_1B4CF90(&ServantWaveTurnEvent_SaveData_TypeInfo, method);
    byte_49BDE10 = 1;
  }
  v3 = sub_1B4D1DC(ServantWaveTurnEvent_SaveData_TypeInfo);
