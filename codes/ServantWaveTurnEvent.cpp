...
void __fastcall ServantWaveTurnEvent___ctor_45207140(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C006A7 & 1) == 0 )
  {
    sub_1C2E12C(&ServantWaveTurnEvent_SaveData_TypeInfo, method);
    byte_4C006A7 = 1;
  }
  v3 = sub_1C2E378(ServantWaveTurnEvent_SaveData_TypeInfo);
