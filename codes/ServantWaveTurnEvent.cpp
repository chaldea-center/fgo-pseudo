...
void __fastcall ServantWaveTurnEvent___ctor_44679544(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6999A & 1) == 0 )
  {
    sub_1BE4ACC(&ServantWaveTurnEvent_SaveData_TypeInfo, method);
    byte_4B6999A = 1;
  }
  v3 = sub_1BE4D18(ServantWaveTurnEvent_SaveData_TypeInfo);
