void RoadmapBoardListViewManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C21412 & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_22735/*"prefab_roadmap_"*/);
    sub_1C2D490(&StringLiteral_20532/*"img_roadmap_"*/);
    byte_4C21412 = 1;
  }
  RoadmapBoardListViewManager_TypeInfo->static_fields->PREFAB_NAME_PREFIX_BOARD_PREFAB = (struct System_String_o *)StringLiteral_22735/*"prefab_roadmap_"*/;
  sub_1C2D434(RoadmapBoardListViewManager_TypeInfo->static_fields);
  static_fields = RoadmapBoardListViewManager_TypeInfo->static_fields;
  static_fields->SPRITE_NAME_PREFIX_BOARD_SPRITE = (struct System_String_o *)StringLiteral_20532/*"img_roadmap_"*/;
  sub_1C2D434(&static_fields->SPRITE_NAME_PREFIX_BOARD_SPRITE);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2140F & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_System_Linq_Enumerable_Zip_RoadmapEntity__UIAtlas__ValueTuple_RoadmapEntity__UIAtlas____);
    sub_1C2D490(&System_Func_RoadmapEntity__UIAtlas__ValueTuple_RoadmapEntity__UIAtlas___TypeInfo);
    sub_1C2D490(&System_IDisposable_TypeInfo);
    sub_1C2D490(&System_Collections_Generic_IEnumerable_ValueTuple_RoadmapEntity__UIAtlas___TypeInfo);
    sub_1C2D490(&System_Collections_Generic_IEnumerator_ValueTuple_RoadmapEntity__UIAtlas___TypeInfo);
    ...
    sub_1C2D490(&RoadmapBoardListViewManager_TypeInfo);
    sub_1C2D490(&Method_RoadmapBoardListViewManager___c__CreateList_b__2_0__);
    sub_1C2D490(&RoadmapBoardListViewManager___c_TypeInfo);
  ...
  Master_object = (RoadmapMaster_o *)DataManager__GetMaster_object_((const MethodInfo_30CE8FC *)Method_DataManager_GetMaster_RoadmapMaster___);
  if ( !Master_object )
    goto LABEL_69;
  v8 = Master_object;
  ...
  if ( !_9__2_0 )
  {
    ...
    _9__2_0 = (System_Func_T1__T2__TResult__o *)sub_1C2D6DC(System_Func_RoadmapEntity__UIAtlas__ValueTuple_RoadmapEntity__UIAtlas___TypeInfo);
    ...
    sub_1C2D434(&static_fields->__9__2_0);
  }
  Master_object = (RoadmapMaster_o *)System_Linq_Enumerable__Zip_object__object__ValueTuple_object__object__(
                                       ...
                                       (const MethodInfo_3115FDC *)Method_System_Linq_Enumerable_Zip_RoadmapEntity__UIAtlas__ValueTuple_RoadmapEntity__UIAtlas____);
  if ( !Master_object )
    goto LABEL_69;
...
LABEL_25:
    ...
    {
LABEL_32:
      v31 = sub_1C7DCA8(v22, System_Collections_Generic_IEnumerator_ValueTuple_RoadmapEntity__UIAtlas___TypeInfo, 0);
    }
    ...
    if ( (IsDispBoard & 1) != 0 )
    {
      ...
      {
        if ( !v32 )
          sub_1C2D6EC(IsDispAchieved, v36);
      ...
      v43 = UnityEngine_Object__op_Equality(v34, 0, 0);
      v80 = this;
      index = v23;
      ...
      if ( v43 )
      {
        ...
        v51 = PrefabById;
        v52 = (RoadmapBoardListViewItem_o *)sub_1C2D6DC(RoadmapBoardListViewItem_TypeInfo);
        RoadmapBoardListViewItem___ctor_31338776(v52, index, tabGroup, groupIndex, v46, v51, v53);
        if ( !itemList )
          sub_1C2D6EC(v54, v55);
      ...
      else
      {
        ...
        v63 = System_String__Format_63499156(
        ...
        v66 = v63;
        v67 = (RoadmapBoardListViewItem_o *)sub_1C2D6DC(RoadmapBoardListViewItem_TypeInfo);
  ...
  {
LABEL_64:
    v78 = sub_1C7DCA8(v22, System_IDisposable_TypeInfo, 0);
  }
        ...
        const MethodInfo *method)
{
  ...
  v10 = System_String__Format_63499156((System_String_o *)StringLiteral_25185/*"{0}{1}"*/, SPRITE_NAME_PREFIX_BOARD_SPRITE, v9, 0);
  if ( !roadmapAtlasList )
    sub_1C2D6EC(v10, v11);
  v12 = v10;
  ...
  while ( 1 )
  {
    ...
    if ( !v18.fields._current )
      sub_1C2D6EC(v13, v14);
    if ( UIAtlas__GetSprite((UIAtlas_o *)v18.fields._current, v12, 0) )
      goto LABEL_12;
  }
  current = 0;
LABEL_12:
        ...
        const MethodInfo *method)
{
  ...
  v10 = System_String__Format_63499156((System_String_o *)StringLiteral_25185/*"{0}{1}"*/, PREFAB_NAME_PREFIX_BOARD_PREFAB, v9, 0);
  if ( !roadmapAssetData )
    sub_1C2D6EC(v10, v11);
...
void RoadmapBoardListViewManager___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C2D6DC(RoadmapBoardListViewManager___c_TypeInfo);
  System_Object___ctor(v1, 0);
  RoadmapBoardListViewManager___c_TypeInfo->static_fields->__9 = (struct RoadmapBoardListViewManager___c_o *)v1;
  sub_1C2D434(RoadmapBoardListViewManager___c_TypeInfo->static_fields);
}
...
System_ValueTuple_RoadmapEntity__UIAtlas__o RoadmapBoardListViewManager___c___CreateList_b__2_0(
        ...
        const MethodInfo *method)
{
  const MethodInfo_3AE98C8 *v4; // x4
  ...
  if ( (byte_4C21414 & 1) == 0 )
  {
    sub_1C2D490(&Method_System_ValueTuple_RoadmapEntity__UIAtlas___ctor__);
    byte_4C21414 = 1;
  }
