void __fastcall RoadmapBoardListViewManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A31AB5 & 1) == 0 )
  {
    sub_1B761C0(&RoadmapBoardListViewManager_TypeInfo, v1);
    sub_1B761C0(&StringLiteral_22574/*"prefab_roadmap_"*/, v4);
    sub_1B761C0(&StringLiteral_20432/*"img_roadmap_"*/, v5);
    byte_4A31AB5 = 1;
  }
  RoadmapBoardListViewManager_TypeInfo->static_fields->PREFAB_NAME_PREFIX_BOARD_PREFAB = (struct System_String_o *)StringLiteral_22574/*"prefab_roadmap_"*/;
  sub_1B76164(
    (ServantStatusBattleListViewItem_o *)RoadmapBoardListViewManager_TypeInfo->static_fields,
    StringLiteral_22574/*"prefab_roadmap_"*/,
    v2,
    v3);
  v6 = StringLiteral_20432/*"img_roadmap_"*/;
  static_fields = RoadmapBoardListViewManager_TypeInfo->static_fields;
  static_fields->SPRITE_NAME_PREFIX_BOARD_SPRITE = (struct System_String_o *)StringLiteral_20432/*"img_roadmap_"*/;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&static_fields->SPRITE_NAME_PREFIX_BOARD_SPRITE, v6, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31AB2 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMaster_RoadmapMaster___, roadmapAssetData);
    sub_1B761C0(&DataManager_TypeInfo, v6);
    sub_1B761C0(&Method_System_Linq_Enumerable_Zip_RoadmapEntity__UIAtlas__ValueTuple_RoadmapEntity__UIAtlas____, v7);
    sub_1B761C0(&System_Func_RoadmapEntity__UIAtlas__ValueTuple_RoadmapEntity__UIAtlas___TypeInfo, v8);
    sub_1B761C0(&System_IDisposable_TypeInfo, v9);
    sub_1B761C0(&System_Collections_Generic_IEnumerable_ValueTuple_RoadmapEntity__UIAtlas___TypeInfo, v10);
    sub_1B761C0(&System_Collections_Generic_IEnumerator_ValueTuple_RoadmapEntity__UIAtlas___TypeInfo, v11);
    ...
    sub_1B761C0(&RoadmapBoardListViewItem_TypeInfo, v16);
    sub_1B761C0(&RoadmapBoardListViewManager_TypeInfo, v17);
    sub_1B761C0(&Method_RoadmapBoardListViewManager___c__CreateList_b__2_0__, v18);
    sub_1B761C0(&RoadmapBoardListViewManager___c_TypeInfo, v19);
    sub_1B761C0(&StringLiteral_25093/*"{0}{1}"*/, v20);
    byte_4A31AB2 = 1;
  }
  ListViewManager__CreateList((ListViewManager_o *)this, 0, 0LL);
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (RoadmapMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2E623B4 *)Method_DataManager_GetMaster_RoadmapMaster___);
  if ( !Master_object )
    goto LABEL_69;
  v23 = Master_object;
  ...
  if ( !_9__2_0 )
  {
    ...
    _9__2_0 = (System_Func_T1__T2__TResult__o *)sub_1B7640C(System_Func_RoadmapEntity__UIAtlas__ValueTuple_RoadmapEntity__UIAtlas___TypeInfo);
    ...
    sub_1B76164((ServantStatusBattleListViewItem_o *)&static_fields->__9__2_0, (int32_t)_9__2_0, v30, v31);
  }
  Master_object = (RoadmapMaster_o *)System_Linq_Enumerable__Zip_object__object__ValueTuple_object__object__(
                                       ...
                                       (const MethodInfo_2EA177C *)Method_System_Linq_Enumerable_Zip_RoadmapEntity__UIAtlas__ValueTuple_RoadmapEntity__UIAtlas____);
  if ( !Master_object )
    goto LABEL_69;
...
LABEL_17:
  ...
  while ( 1 )
  {
    ...
    {
LABEL_25:
      v44 = sub_1BC81A0(v39, System_Collections_IEnumerator_TypeInfo, 0LL);
    }
    ...
    {
LABEL_32:
      v48 = sub_1BC81A0(v39, System_Collections_Generic_IEnumerator_ValueTuple_RoadmapEntity__UIAtlas___TypeInfo, 0LL);
    }
    ...
    if ( (IsDispBoard & 1) != 0 )
    {
      ...
      {
        if ( !v49 )
          sub_1B7641C(IsDispAchieved, v53);
      ...
      if ( v60 )
      {
        ...
        v68 = PrefabById;
        v69 = (RoadmapBoardListViewItem_o *)sub_1B7640C(RoadmapBoardListViewItem_TypeInfo);
        RoadmapBoardListViewItem___ctor_45174724(v69, index, tabGroup, groupIndex, v63, v68, v70);
        if ( !itemList )
          sub_1B7641C(v71, v72);
      ...
      else
      {
        ...
        v82 = System_String__Format_61549432(
        ...
        v85 = v82;
        v86 = (RoadmapBoardListViewItem_o *)sub_1B7640C(RoadmapBoardListViewItem_TypeInfo);
        ...
        else
        {
          ...
          sub_1B76164((ServantStatusBattleListViewItem_o *)(v95 + 4), (int32_t)v86, v90, v91);
        }
      }
      this = v101;
      v40 = index + 1;
  ...
  {
LABEL_64:
    v99 = sub_1BC81A0(v39, System_IDisposable_TypeInfo, 0LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31AB4 & 1) == 0 )
  {
    sub_1B761C0(&Method_System_Collections_Generic_List_Enumerator_UIAtlas__Dispose__, roadmapAtlasList);
    ...
    sub_1B761C0(&RoadmapBoardListViewManager_TypeInfo, v11);
    sub_1B761C0(&StringLiteral_25093/*"{0}{1}"*/, v12);
    byte_4A31AB4 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31AB3 & 1) == 0 )
  {
    sub_1B761C0(&Method_AssetData_GetObject_GameObject____75903216, roadmapAssetData);
    sub_1B761C0(&int_TypeInfo, v7);
    sub_1B761C0(&RoadmapBoardListViewManager_TypeInfo, v8);
  ...
  v13 = System_String__Format_61549432(
          (System_String_o *)StringLiteral_25093/*"{0}{1}"*/,
...
void __fastcall RoadmapBoardListViewManager___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A31AB6 & 1) == 0 )
  {
    sub_1B761C0(&RoadmapBoardListViewManager___c_TypeInfo, v1);
    byte_4A31AB6 = 1;
  }
  v2 = (Il2CppObject *)sub_1B7640C(RoadmapBoardListViewManager___c_TypeInfo);
...
System_ValueTuple_RoadmapEntity__UIAtlas__o __fastcall RoadmapBoardListViewManager___c___CreateList_b__2_0(
        ...
        const MethodInfo *method)
{
  const MethodInfo_3823908 *v4; // x4
  ...
  if ( (byte_4A31AB7 & 1) == 0 )
  {
    sub_1B761C0(&Method_System_ValueTuple_RoadmapEntity__UIAtlas___ctor__, roadmapEntity);
    byte_4A31AB7 = 1;
  }
