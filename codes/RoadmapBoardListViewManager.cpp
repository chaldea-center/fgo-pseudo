void RoadmapBoardListViewManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CC135F & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_22864/*"prefab_roadmap_"*/);
    sub_1C713B0(&StringLiteral_20625/*"img_roadmap_"*/);
    byte_4CC135F = 1;
  }
  RoadmapBoardListViewManager_TypeInfo->static_fields->PREFAB_NAME_PREFIX_BOARD_PREFAB = (struct System_String_o *)StringLiteral_22864/*"prefab_roadmap_"*/;
  sub_1C71354(RoadmapBoardListViewManager_TypeInfo->static_fields, StringLiteral_22864/*"prefab_roadmap_"*/);
  v1 = StringLiteral_20625/*"img_roadmap_"*/;
  static_fields = RoadmapBoardListViewManager_TypeInfo->static_fields;
  static_fields->SPRITE_NAME_PREFIX_BOARD_SPRITE = (struct System_String_o *)StringLiteral_20625/*"img_roadmap_"*/;
  sub_1C71354(&static_fields->SPRITE_NAME_PREFIX_BOARD_SPRITE, v1);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC135C & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_System_Linq_Enumerable_Zip_RoadmapEntity__UIAtlas__ValueTuple_RoadmapEntity__UIAtlas____);
    sub_1C713B0(&System_Func_RoadmapEntity__UIAtlas__ValueTuple_RoadmapEntity__UIAtlas___TypeInfo);
    sub_1C713B0(&System_IDisposable_TypeInfo);
    sub_1C713B0(&System_Collections_Generic_IEnumerable_ValueTuple_RoadmapEntity__UIAtlas___TypeInfo);
    sub_1C713B0(&System_Collections_Generic_IEnumerator_ValueTuple_RoadmapEntity__UIAtlas___TypeInfo);
    ...
    sub_1C713B0(&RoadmapBoardListViewManager_TypeInfo);
    sub_1C713B0(&Method_RoadmapBoardListViewManager___c__CreateList_b__2_0__);
    sub_1C713B0(&RoadmapBoardListViewManager___c_TypeInfo);
  ...
  Master_object = (RoadmapMaster_o *)DataManager__GetMaster_object_((const MethodInfo_314B0B8 *)Method_DataManager_GetMaster_RoadmapMaster___);
  if ( !Master_object )
    goto LABEL_69;
  v8 = Master_object;
  ...
  if ( !_9__2_0 )
  {
    ...
    _9__2_0 = (System_Func_T1__T2__TResult__o *)sub_1C715FC(System_Func_RoadmapEntity__UIAtlas__ValueTuple_RoadmapEntity__UIAtlas___TypeInfo);
    ...
    sub_1C71354(&static_fields->__9__2_0, _9__2_0);
  }
  Master_object = (RoadmapMaster_o *)System_Linq_Enumerable__Zip_object__object__ValueTuple_object__object__(
                                       ...
                                       (const MethodInfo_3192FDC *)Method_System_Linq_Enumerable_Zip_RoadmapEntity__UIAtlas__ValueTuple_RoadmapEntity__UIAtlas____);
  if ( !Master_object )
    goto LABEL_69;
...
LABEL_17:
  ...
  while ( 1 )
  {
    ...
    {
LABEL_25:
      v27 = sub_1C47738(v22, System_Collections_IEnumerator_TypeInfo, 0);
    }
    ...
    {
LABEL_32:
      v31 = sub_1C47738(v22, System_Collections_Generic_IEnumerator_ValueTuple_RoadmapEntity__UIAtlas___TypeInfo, 0);
    }
    ...
    if ( (IsDispBoard & 1) != 0 )
    {
      ...
      {
        if ( !v32 )
          sub_1C71608(IsDispAchieved, v36);
      ...
      if ( v41 )
      {
        ...
        v49 = PrefabById;
        v50 = (RoadmapBoardListViewItem_o *)sub_1C715FC(RoadmapBoardListViewItem_TypeInfo);
        RoadmapBoardListViewItem___ctor_31613572(v50, index, tabGroup, groupIndex, v44, v49, v51);
        if ( !itemList )
          sub_1C71608(v52, v53);
        ...
        else
        {
          ...
          IsDispBoard = sub_1C71354(v57 + 4, v50);
        }
      }
      else
      {
        ...
        v61 = System_String__Format_64073032(
        ...
        v64 = v61;
        v65 = (RoadmapBoardListViewItem_o *)sub_1C715FC(RoadmapBoardListViewItem_TypeInfo);
        ...
        else
        {
          ...
          IsDispBoard = sub_1C71354(v72 + 4, v65);
        }
      }
      this = v78;
      v23 = index + 1;
  ...
  {
LABEL_64:
    v76 = sub_1C47738(v22, System_IDisposable_TypeInfo, 0);
  }
        ...
        const MethodInfo *method)
{
  ...
  v8 = System_String__Format_64073032((System_String_o *)StringLiteral_25338/*"{0}{1}"*/, SPRITE_NAME_PREFIX_BOARD_SPRITE, v7, 0);
  if ( !roadmapAtlasList )
    sub_1C71608(v8, v9);
  v10 = v8;
        ...
        const MethodInfo *method)
{
  ...
  v8 = System_String__Format_64073032((System_String_o *)StringLiteral_25338/*"{0}{1}"*/, PREFAB_NAME_PREFIX_BOARD_PREFAB, v7, 0);
  if ( !roadmapAssetData )
    sub_1C71608(v8, v9);
...
void RoadmapBoardListViewManager___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C715FC(RoadmapBoardListViewManager___c_TypeInfo);
  System_Object___ctor(v1, 0);
  RoadmapBoardListViewManager___c_TypeInfo->static_fields->__9 = (struct RoadmapBoardListViewManager___c_o *)v1;
  sub_1C71354(RoadmapBoardListViewManager___c_TypeInfo->static_fields, v1);
}
...
System_ValueTuple_RoadmapEntity__UIAtlas__o RoadmapBoardListViewManager___c___CreateList_b__2_0(
        ...
        const MethodInfo *method)
{
  const MethodInfo_3B76D88 *v4; // x4
  ...
  if ( (byte_4CC1361 & 1) == 0 )
  {
    sub_1C713B0(&Method_System_ValueTuple_RoadmapEntity__UIAtlas___ctor__);
    byte_4CC1361 = 1;
  }
