void __fastcall RoadmapBoardListViewManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BAF3E5 & 1) == 0 )
  {
    sub_1C13D24(&RoadmapBoardListViewManager_TypeInfo, v1);
    sub_1C13D24(&StringLiteral_22957/*"pointer"*/, v2);
    sub_1C13D24(&StringLiteral_20776/*"img_questloop_on"*/, v3);
    byte_4BAF3E5 = 1;
  }
  RoadmapBoardListViewManager_TypeInfo->static_fields->PREFAB_NAME_PREFIX_BOARD_PREFAB = (struct System_String_o *)StringLiteral_22957/*"pointer"*/;
  sub_1C13CC8(RoadmapBoardListViewManager_TypeInfo->static_fields);
  static_fields = RoadmapBoardListViewManager_TypeInfo->static_fields;
  static_fields->SPRITE_NAME_PREFIX_BOARD_SPRITE = (struct System_String_o *)StringLiteral_20776/*"img_questloop_on"*/;
  sub_1C13CC8(&static_fields->SPRITE_NAME_PREFIX_BOARD_SPRITE);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAF3E2 & 1) == 0 )
  {
    sub_1C13D24(&Method_DataManager_GetMaster_RoadmapMaster___, roadmapAssetData);
    sub_1C13D24(&DataManager_TypeInfo, v6);
    sub_1C13D24(&Method_System_Linq_Enumerable_Zip_RoadmapEntity__UIAtlas__ValueTuple_RoadmapEntity__UIAtlas____, v7);
    sub_1C13D24(&System_Func_RoadmapEntity__UIAtlas__ValueTuple_RoadmapEntity__UIAtlas___TypeInfo, v8);
    sub_1C13D24(&System_IDisposable_TypeInfo, v9);
    sub_1C13D24(&System_Collections_Generic_IEnumerable_ValueTuple_RoadmapEntity__UIAtlas___TypeInfo, v10);
    sub_1C13D24(&System_Collections_Generic_IEnumerator_ValueTuple_RoadmapEntity__UIAtlas___TypeInfo, v11);
    ...
    sub_1C13D24(&RoadmapBoardListViewItem_TypeInfo, v16);
    sub_1C13D24(&RoadmapBoardListViewManager_TypeInfo, v17);
    sub_1C13D24(&Method_RoadmapBoardListViewManager___c__CreateList_b__2_0__, v18);
    sub_1C13D24(&RoadmapBoardListViewManager___c_TypeInfo, v19);
    sub_1C13D24(&StringLiteral_25509/*"{0}:{1}:{2}:{3}:{4}:{5}:{6}:{7}"*/, v20);
    byte_4BAF3E2 = 1;
  }
  ListViewManager__CreateList((ListViewManager_o *)this, 0, 0LL);
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (RoadmapMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2F8F418 *)Method_DataManager_GetMaster_RoadmapMaster___);
  if ( !Master_object )
    goto LABEL_69;
  v23 = Master_object;
  ...
  if ( !_9__2_0 )
  {
    ...
    _9__2_0 = (System_Func_T1__T2__TResult__o *)sub_1C13F70(System_Func_RoadmapEntity__UIAtlas__ValueTuple_RoadmapEntity__UIAtlas___TypeInfo);
    ...
    sub_1C13CC8(&static_fields->__9__2_0);
  }
  Master_object = (RoadmapMaster_o *)System_Linq_Enumerable__Zip_object__object__ValueTuple_object__object__(
                                       ...
                                       (const MethodInfo_2FCF7C0 *)Method_System_Linq_Enumerable_Zip_RoadmapEntity__UIAtlas__ValueTuple_RoadmapEntity__UIAtlas____);
  if ( !Master_object )
    goto LABEL_69;
...
LABEL_25:
    ...
    {
LABEL_32:
      v46 = sub_1C65D04(v37, System_Collections_Generic_IEnumerator_ValueTuple_RoadmapEntity__UIAtlas___TypeInfo, 0LL);
    }
    ...
    if ( (IsDispBoard & 1) != 0 )
    {
      ...
      {
        if ( !v47 )
          sub_1C13F80(IsDispAchieved, v51);
      ...
      if ( v58 )
      {
        ...
        v66 = PrefabById;
        v67 = (RoadmapBoardListViewItem_o *)sub_1C13F70(RoadmapBoardListViewItem_TypeInfo);
        RoadmapBoardListViewItem___ctor_31228012(v67, index, tabGroup, groupIndex, v61, v66, v68);
        if ( !itemList )
          sub_1C13F80(v69, v70);
      ...
      else
      {
        ...
        v81 = v78;
        v82 = (RoadmapBoardListViewItem_o *)sub_1C13F70(RoadmapBoardListViewItem_TypeInfo);
  ...
  {
LABEL_64:
    v93 = sub_1C65D04(v37, System_IDisposable_TypeInfo, 0LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAF3E4 & 1) == 0 )
  {
    sub_1C13D24(&Method_System_Collections_Generic_List_Enumerator_UIAtlas__Dispose__, roadmapAtlasList);
    ...
    sub_1C13D24(&RoadmapBoardListViewManager_TypeInfo, v11);
    sub_1C13D24(&StringLiteral_25509/*"{0}:{1}:{2}:{3}:{4}:{5}:{6}:{7}"*/, v12);
    byte_4BAF3E4 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAF3E3 & 1) == 0 )
  {
    sub_1C13D24(&Method_AssetData_GetObject_GameObject____77466800, roadmapAssetData);
    sub_1C13D24(&int_TypeInfo, v7);
    sub_1C13D24(&RoadmapBoardListViewManager_TypeInfo, v8);
    sub_1C13D24(&StringLiteral_25509/*"{0}:{1}:{2}:{3}:{4}:{5}:{6}:{7}"*/, v9);
    byte_4BAF3E3 = 1;
  }
  ...
  v13 = System_String__Format_62982316(
          (System_String_o *)StringLiteral_25509/*"{0}:{1}:{2}:{3}:{4}:{5}:{6}:{7}"*/,
...
void __fastcall RoadmapBoardListViewManager___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BAF3E6 & 1) == 0 )
  {
    sub_1C13D24(&RoadmapBoardListViewManager___c_TypeInfo, v1);
    byte_4BAF3E6 = 1;
  }
  v2 = (Il2CppObject *)sub_1C13F70(RoadmapBoardListViewManager___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  RoadmapBoardListViewManager___c_TypeInfo->static_fields->__9 = (struct RoadmapBoardListViewManager___c_o *)v2;
  sub_1C13CC8(RoadmapBoardListViewManager___c_TypeInfo->static_fields);
}
...
System_ValueTuple_RoadmapEntity__UIAtlas__o __fastcall RoadmapBoardListViewManager___c___CreateList_b__2_0(
        ...
        const MethodInfo *method)
{
  const MethodInfo_3980F78 *v4; // x4
  ...
  if ( (byte_4BAF3E7 & 1) == 0 )
  {
    sub_1C13D24(&Method_System_ValueTuple_RoadmapEntity__UIAtlas___ctor__, roadmapEntity);
    byte_4BAF3E7 = 1;
  }
