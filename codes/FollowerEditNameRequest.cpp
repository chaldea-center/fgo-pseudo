        ...
        const MethodInfo *method)
{
  ...
  RequestBase__addField_44246844((RequestBase_o *)this, (System_String_o *)StringLiteral_23849/*"supportDeckId"*/, supportDeckId, 0);
...
System_String_o *FollowerEditNameRequest__getURL(FollowerEditNameRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C44AEB & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_19521/*"follower/editName"*/);
    byte_4C44AEB = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63561656(BaseUrl, (System_String_o *)StringLiteral_19521/*"follower/editName"*/, 0);
}
