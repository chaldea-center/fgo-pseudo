        ...
        const MethodInfo *method)
{
  ...
  RequestBase__addField_44008608((RequestBase_o *)this, (System_String_o *)StringLiteral_23827/*"supportDeckId"*/, supportDeckId, 0);
...
System_String_o *FollowerEditNameRequest__getURL(FollowerEditNameRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C28DE8 & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_19506/*"follower/editName"*/);
    byte_4C28DE8 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63457864(BaseUrl, (System_String_o *)StringLiteral_19506/*"follower/editName"*/, 0);
}
