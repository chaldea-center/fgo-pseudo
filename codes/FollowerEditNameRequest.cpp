        ...
        const MethodInfo *method)
{
  ...
  RequestBase__addField_42421084((RequestBase_o *)this, (System_String_o *)StringLiteral_24117/*"supportDeckId"*/, supportDeckId, method);
...
System_String_o *__fastcall FollowerEditNameRequest__getURL(FollowerEditNameRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDDEB1 & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_19833/*"follower/editName"*/);
    byte_4BDDEB1 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63115476(BaseUrl, (System_String_o *)StringLiteral_19833/*"follower/editName"*/, 0LL);
}
