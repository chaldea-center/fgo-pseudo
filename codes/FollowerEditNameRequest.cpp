        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C23921 & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_24182/*"verCode"*/, supportDeckId);
    sub_1C3B764(&StringLiteral_18882/*"event_raid_num_"*/, v7);
    byte_4C23921 = 1;
  }
  RequestBase__addField_42628192((RequestBase_o *)this, (System_String_o *)StringLiteral_24182/*"verCode"*/, supportDeckId, method);
...
System_String_o *__fastcall FollowerEditNameRequest__getURL(FollowerEditNameRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2391F & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_19887/*"ignoretimescale"*/, v2);
    byte_4C2391F = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63368612(BaseUrl, (System_String_o *)StringLiteral_19887/*"ignoretimescale"*/, 0LL);
}
