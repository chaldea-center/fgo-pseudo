        ...
        const MethodInfo *method)
{
  ...
  RequestBase__addField_44144740((RequestBase_o *)this, (System_String_o *)StringLiteral_23845/*"supportDeckId"*/, supportDeckId, 0);
...
System_String_o *FollowerEditNameRequest__getURL(FollowerEditNameRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C394F1 & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_19518/*"follower/editName"*/);
    byte_4C394F1 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63518544(BaseUrl, (System_String_o *)StringLiteral_19518/*"follower/editName"*/, 0);
}
