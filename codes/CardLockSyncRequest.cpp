        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C5881A & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_21349/*"lockUserSvtIds"*/);
    sub_1C3E564(&StringLiteral_24440/*"unlockUserSvtIds"*/);
    byte_4C5881A = 1;
  }
  if ( lockUserSvtIds && lockUserSvtIds->max_length )
  {
    ...
    RequestBase__addField_44302832((RequestBase_o *)this, (System_String_o *)StringLiteral_21349/*"lockUserSvtIds"*/, v9, 0);
  }
  if ( unlockUserSvtIds && unlockUserSvtIds->max_length )
  {
    ...
    RequestBase__addField_44302832((RequestBase_o *)this, (System_String_o *)StringLiteral_24440/*"unlockUserSvtIds"*/, v10, 0);
  }
  if ( isStorage )
...
System_String_o *CardLockSyncRequest__getURL(CardLockSyncRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C3E564(&NetworkManager_TypeInfo);
    sub_1C3E564(&StringLiteral_17771/*"card/lockSync"*/);
    byte_4C58818 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63636468(BaseUrl, (System_String_o *)StringLiteral_17771/*"card/lockSync"*/, 0);
}
