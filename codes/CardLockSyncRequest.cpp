        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C28D4C & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_21316/*"lockUserSvtIds"*/);
    sub_1C2D490(&StringLiteral_24398/*"unlockUserSvtIds"*/);
    byte_4C28D4C = 1;
  }
  if ( lockUserSvtIds && lockUserSvtIds->max_length )
  {
    ...
    RequestBase__addField_44009064((RequestBase_o *)this, (System_String_o *)StringLiteral_21316/*"lockUserSvtIds"*/, v9, 0);
  }
  if ( unlockUserSvtIds && unlockUserSvtIds->max_length )
  {
    ...
    RequestBase__addField_44009064((RequestBase_o *)this, (System_String_o *)StringLiteral_24398/*"unlockUserSvtIds"*/, v10, 0);
  }
  if ( isStorage )
...
System_String_o *CardLockSyncRequest__getURL(CardLockSyncRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C2D490(&NetworkManager_TypeInfo);
    sub_1C2D490(&StringLiteral_17748/*"card/lockSync"*/);
    byte_4C28D4A = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63457864(BaseUrl, (System_String_o *)StringLiteral_17748/*"card/lockSync"*/, 0);
}
