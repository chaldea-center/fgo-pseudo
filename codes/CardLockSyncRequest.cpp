        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF00CD & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_21530/*"lockUserSvtIds"*/);
    sub_1C7BAE8(&StringLiteral_24663/*"unlockUserSvtIds"*/);
    byte_4CF00CD = 1;
  }
  if ( lockUserSvtIds && lockUserSvtIds->max_length )
  {
    ...
    RequestBase__addField_44748720((RequestBase_o *)this, (System_String_o *)StringLiteral_21530/*"lockUserSvtIds"*/, v9, 0);
  }
  if ( unlockUserSvtIds && unlockUserSvtIds->max_length )
  {
    ...
    RequestBase__addField_44748720((RequestBase_o *)this, (System_String_o *)StringLiteral_24663/*"unlockUserSvtIds"*/, v10, 0);
  }
  if ( isStorage )
...
System_String_o *CardLockSyncRequest__getURL(CardLockSyncRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C7BAE8(&NetworkManager_TypeInfo);
    sub_1C7BAE8(&StringLiteral_17849/*"card/lockSync"*/);
    byte_4CF00CB = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64176912(BaseUrl, (System_String_o *)StringLiteral_17849/*"card/lockSync"*/, 0);
}
