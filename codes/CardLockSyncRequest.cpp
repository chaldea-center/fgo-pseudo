        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC8EBD & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_21430/*"lockUserSvtIds"*/);
    sub_1C713B0(&StringLiteral_24542/*"unlockUserSvtIds"*/);
    byte_4CC8EBD = 1;
  }
  if ( lockUserSvtIds && lockUserSvtIds->max_length )
  {
    ...
    RequestBase__addField_44518324((RequestBase_o *)this, (System_String_o *)StringLiteral_21430/*"lockUserSvtIds"*/, v9, 0);
  }
  if ( unlockUserSvtIds && unlockUserSvtIds->max_length )
  {
    ...
    RequestBase__addField_44518324((RequestBase_o *)this, (System_String_o *)StringLiteral_24542/*"unlockUserSvtIds"*/, v10, 0);
  }
  if ( isStorage )
...
System_String_o *CardLockSyncRequest__getURL(CardLockSyncRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C713B0(&NetworkManager_TypeInfo);
    sub_1C713B0(&StringLiteral_17781/*"card/lockSync"*/);
    byte_4CC8EBB = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64031724(BaseUrl, (System_String_o *)StringLiteral_17781/*"card/lockSync"*/, 0);
}
