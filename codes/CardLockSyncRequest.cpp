        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB756A & 1) == 0 )
  {
    sub_1BAB41C(&JsonManager_TypeInfo, lockUserSvtIds);
    sub_1BAB41C(&StringLiteral_20855/*"isStorage"*/, v9);
    sub_1BAB41C(&StringLiteral_21224/*"lockUserSvtIds"*/, v10);
    sub_1BAB41C(&StringLiteral_24331/*"unlockUserSvtIds"*/, v11);
    byte_4AB756A = 1;
  }
  if ( lockUserSvtIds && *(_QWORD *)&lockUserSvtIds->max_length )
  {
    ...
    RequestBase__addField_41516464((RequestBase_o *)this, (System_String_o *)StringLiteral_21224/*"lockUserSvtIds"*/, v12, v13);
  }
  if ( unlockUserSvtIds && *(_QWORD *)&unlockUserSvtIds->max_length )
  {
    ...
    RequestBase__addField_41516464((RequestBase_o *)this, (System_String_o *)StringLiteral_24331/*"unlockUserSvtIds"*/, v14, v15);
  }
  if ( isStorage )
    RequestBase__addField(
      (RequestBase_o *)this,
      (System_String_o *)StringLiteral_20855/*"isStorage"*/,
      1,
...
System_String_o *__fastcall CardLockSyncRequest__getURL(CardLockSyncRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BAB41C(&NetworkManager_TypeInfo, method);
    sub_1BAB41C(&StringLiteral_17787/*"card/lockSync"*/, v2);
    byte_4AB7568 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62048128(BaseUrl, (System_String_o *)StringLiteral_17787/*"card/lockSync"*/, 0LL);
}
