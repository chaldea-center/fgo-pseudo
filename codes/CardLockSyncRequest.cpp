        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17A32 & 1) == 0 )
  {
    sub_1BCA7E0(&JsonManager_TypeInfo, lockUserSvtIds, unlockUserSvtIds);
    sub_1BCA7E0(&StringLiteral_21049/*"isStorage"*/, v9, v10);
    sub_1BCA7E0(&StringLiteral_21418/*"lockUserSvtIds"*/, v11, v12);
    sub_1BCA7E0(&StringLiteral_24543/*"unlockUserSvtIds"*/, v13, v14);
    byte_4B17A32 = 1;
  }
  if ( lockUserSvtIds && *(_QWORD *)&lockUserSvtIds->max_length )
  {
    ...
    v15 = JsonManager__toJson(&lockUserSvtIds->obj, 0, 0, 0LL);
    RequestBase__addField_41862348((RequestBase_o *)this, (System_String_o *)StringLiteral_21418/*"lockUserSvtIds"*/, v15, v16);
  }
  if ( unlockUserSvtIds && *(_QWORD *)&unlockUserSvtIds->max_length )
  {
    if ( !JsonManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(JsonManager_TypeInfo, lockUserSvtIds);
    v17 = JsonManager__toJson(&unlockUserSvtIds->obj, 0, 0, 0LL);
    RequestBase__addField_41862348((RequestBase_o *)this, (System_String_o *)StringLiteral_24543/*"unlockUserSvtIds"*/, v17, v18);
  }
  if ( isStorage )
    RequestBase__addField(
      (RequestBase_o *)this,
      (System_String_o *)StringLiteral_21049/*"isStorage"*/,
      1,
...
System_String_o *__fastcall CardLockSyncRequest__getURL(CardLockSyncRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BCA7E0(&NetworkManager_TypeInfo, method, v2);
    sub_1BCA7E0(&StringLiteral_17938/*"card/lockSync"*/, v3, v4);
    byte_4B17A30 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62401220(BaseUrl, (System_String_o *)StringLiteral_17938/*"card/lockSync"*/, 0LL);
}
