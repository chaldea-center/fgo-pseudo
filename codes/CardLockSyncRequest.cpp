        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_418A0AE & 1) == 0 )
  {
    sub_B2C35C(&JsonManager_TypeInfo, lockUserSvtIds);
    sub_B2C35C(&StringLiteral_19957/*"isStorage"*/, v9);
    sub_B2C35C(&StringLiteral_20302/*"lockUserSvtIds"*/, v10);
    sub_B2C35C(&StringLiteral_22923/*"unlockUserSvtIds"*/, v11);
    byte_418A0AE = 1;
  }
  if ( lockUserSvtIds && *(_QWORD *)&lockUserSvtIds->max_length )
  {
    ...
    RequestBase__addField_31051928((RequestBase_o *)this, (System_String_o *)StringLiteral_20302/*"lockUserSvtIds"*/, v12, 0LL);
  }
  if ( unlockUserSvtIds && *(_QWORD *)&unlockUserSvtIds->max_length )
  {
    ...
    RequestBase__addField_31051928((RequestBase_o *)this, (System_String_o *)StringLiteral_22923/*"unlockUserSvtIds"*/, v13, 0LL);
  }
  if ( isStorage )
...
System_String_o *__fastcall CardLockSyncRequest__getURL(CardLockSyncRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_B2C35C(&NetworkManager_TypeInfo, method);
    sub_B2C35C(&StringLiteral_17224/*"card/lockSync"*/, v2);
    byte_418A0AC = 1;
  }
  if ( (BYTE3(NetworkManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !NetworkManager_TypeInfo->_2.cctor_finished )
  ...
  return System_String__Concat_44305532(BaseUrl, (System_String_o *)StringLiteral_17224/*"card/lockSync"*/, 0LL);
}
