        ...
        const MethodInfo *method)
{
  if ( (byte_43540BA & 1) == 0 )
  {
    sub_B70694(&Method_DataMasterBase_FriendshipQuestDialogInfoMaster__FriendshipQuestDialogInfoEntity__string___ctor__);
    byte_43540BA = 1;
  }
  DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string____ctor(
    (DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string__o *)this,
    353,
    (const MethodInfo_21C07F4 *)Method_DataMasterBase_FriendshipQuestDialogInfoMaster__FriendshipQuestDialogInfoEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_43540B8 & 1) == 0 )
  {
    sub_B70694(&Method_DataMasterBase_FriendshipQuestDialogInfoMaster__FriendshipQuestDialogInfoEntity__string__GetEntity__);
    byte_43540B8 = 1;
  }
  ...
  return (FriendshipQuestDialogInfoEntity_o *)DataMasterBase_WarMessageMaster__WarMessageEntity__string___GetEntity(
                                                ...
                                                PK,
                                                (const MethodInfo_21C0890 *)Method_DataMasterBase_FriendshipQuestDialogInfoMaster__FriendshipQuestDialogInfoEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_43540BB & 1) == 0 )
  {
    ...
    sub_B70694(&FriendshipQuestDialogInfoEntity_TypeInfo);
                 ...
                 (const MethodInfo_2C85F70 *)Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__) )
  {
    ...
    if ( Item )
    {
        ...
        && (FriendshipQuestDialogInfoEntity_c *)Item->klass->_2.typeHierarchy[v11 - 1] == FriendshipQuestDialogInfoEntity_TypeInfo )
      {
        ...
        *svtId = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_45179984(v15, 0LL);
        result = 1;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_43540B9 & 1) == 0 )
  {
    sub_B70694(&Method_DataMasterBase_FriendshipQuestDialogInfoMaster__FriendshipQuestDialogInfoEntity__string__TryGetEntity__);
    byte_43540B9 = 1;
  }
  ...
  return DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string___TryGetEntity(
           ...
           PK,
           (const MethodInfo_21C08E8 *)Method_DataMasterBase_FriendshipQuestDialogInfoMaster__FriendshipQuestDialogInfoEntity__string__TryGetEntity__);
}