...
void __fastcall PartyOrganizationQuestInfoMenu__Close_32795080(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B120B1 & 1) == 0 )
  {
    sub_1BCA7E0(&System_Action_TypeInfo, onFinishedClose, method);
    sub_1BCA7E0(&Method_PartyOrganizationQuestInfoMenu_EndClose__, v5, v6);
    byte_4B120B1 = 1;
  }
  this->fields.onfinishedClose = onFinishedClose;
  sub_1BCA784(&this->fields.onfinishedClose, onFinishedClose);
  v10 = (System_Action_o *)sub_1BCAA2C(System_Action_TypeInfo, v7, v8, v9);
  System_Action___ctor(v10, (Il2CppObject *)this, Method_PartyOrganizationQuestInfoMenu_EndClose__, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B120AF & 1) == 0 )
  {
    sub_1BCA7E0(&System_Action_TypeInfo, *(_QWORD *)&questId, callback);
    sub_1BCA7E0(&Method_PartyOrganizationQuestInfoMenu_Close__, v7, v8);
    sub_1BCA7E0(&Method_PartyOrganizationQuestInfoMenu_Open__, v9, v10);
    byte_4B120AF = 1;
  }
  ...
  System_Action___ctor(v17, (Il2CppObject *)this, Method_PartyOrganizationQuestInfoMenu_Open__, 0LL);
  v21 = (System_Action_o *)sub_1BCAA2C(System_Action_TypeInfo, v18, v19, v20);
  System_Action___ctor(v21, (Il2CppObject *)this, Method_PartyOrganizationQuestInfoMenu_Close__, 0LL);
  if ( !questInfoWindow )
    goto LABEL_9;
  if ( QuestInformationComponent__Setup(questInfoWindow, questId, 2, v17, v21, 0LL) )
  {
...
void __fastcall PartyOrganizationQuestInfoMenu__Open_32794900(
        PartyOrganizationQuestInfoMenu_o *this,
        const MethodInfo *method)
{
  __int64 v2; // x2
  ...
  if ( (byte_4B120B0 & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&Method_PartyOrganizationQuestInfoMenu_EndOpen__, v5, v6);
    byte_4B120B0 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B120AD & 1) == 0 )
  {
    sub_1BCA7E0(&PartyOrganizationQuestInfoMenu_CallbackFunc_TypeInfo, value, method);
    byte_4B120AD = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  ...
  v11 = (PartyOrganizationQuestInfoMenu_o *)sub_1BCACFC(v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B120B2 & 1) == 0 )
  {
    sub_1BCA7E0(&StringLiteral_11059/*"QuestInfoWindowPrefab/QuestInfo/BgSp/CloseButton"*/, method, v2);
    byte_4B120B2 = 1;
  }
  return (System_String_o *)StringLiteral_11059/*"QuestInfoWindowPrefab/QuestInfo/BgSp/CloseButton"*/;
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A07600;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A075B8;
}
