  ...
  if ( (flag & 4) != 0 )
  {
    ...
    if ( questInfo && Instance )
    {
      if ( !QuestTree__IsActiveWar((QuestTree_o *)Instance, questInfo->fields.warId, 0) )
        goto LABEL_19;
      v9 = SingletonTemplate_object___get_Instance((const MethodInfo_47A2F30 *)Method_SingletonTemplate_QuestTree__get_Instance__);
        ...
        const MethodInfo *method)
{
  ...
  *challengeIconName = iconName;
  sub_2213A04((MissionNaviTransitionBoardItem_o *)challengeIconName, (int32_t)iconName, v11, v12, v13, v14, v15, v16);
  return 1;
}
