...
System_String_o *__fastcall MissionNaviQuestEntity__CreatePK(int32_t id, int32_t questId, const MethodInfo *method)
{
  if ( (byte_4B66F5E & 1) == 0 )
  {
    sub_1BE4ACC(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&questId);
    byte_4B66F5E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B66F5C & 1) == 0 )
  {
    sub_1BE4ACC(&Method_SingletonTemplate_QuestTree__get_Instance__, questInfo);
    byte_4B66F5C = 1;
  }
  ...
  if ( (flag & 4) != 0 )
  {
    ...
    if ( questInfo && Instance )
    {
      if ( !QuestTree__IsActiveWar((QuestTree_o *)Instance, questInfo->fields.warId, 0LL) )
        goto LABEL_19;
      v9 = SingletonTemplate_object___get_Instance((const MethodInfo_38291E8 *)Method_SingletonTemplate_QuestTree__get_Instance__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B66F5D & 1) == 0 )
  {
    sub_1BE4ACC(&Method_SingletonTemplate_clsQuestCheck__get_Instance__, questInfo);
    byte_4B66F5D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B66F5B & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_116/*" "*/, challengeIconName);
  ...
  *challengeIconName = iconName;
  sub_1BE4A70((PartyOrganizationUtility_o *)challengeIconName, (int64_t)iconName, v11, v12, v13, v14, v15, v16);
  return 1;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B66F5A & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_116/*" "*/, challengeNaviName);
    sub_1BE4ACC(&StringLiteral_1/*""*/, v10);
    byte_4B66F5A = 1;
  }
  ...
  *challengeNaviName = title;
  sub_1BE4A70((PartyOrganizationUtility_o *)challengeNaviName, (int64_t)title, v11, v12, v13, v14, v15, v16);
  return 1;
}