  ...
  if ( (flag & 4) != 0 )
  {
    ...
    if ( questInfo && Instance )
    {
      if ( !QuestTree__IsActiveWar((QuestTree_o *)Instance, questInfo->fields.warId, 0) )
        goto LABEL_19;
      v9 = SingletonTemplate_object___get_Instance((const MethodInfo_3B55234 *)Method_SingletonTemplate_QuestTree__get_Instance__);
        ...
        const MethodInfo *method)
{
  ...
  *challengeIconName = (System_String_o *)StringLiteral_1/*""*/;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)challengeIconName, StringLiteral_1/*""*/, (int32_t)method, v3, v4, v5, v6, v7);
  ...
  *challengeIconName = iconName;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)challengeIconName, (int32_t)iconName, v10, v11, v12, v13, v14, v15);
  return 1;
}
        ...
        const MethodInfo *method)
{
  ...
  *challengeNaviName = (System_String_o *)StringLiteral_1/*""*/;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)challengeNaviName, StringLiteral_1/*""*/, (int32_t)method, v3, v4, v5, v6, v7);
  ...
  *challengeNaviName = title;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)challengeNaviName, (int32_t)title, v10, v11, v12, v13, v14, v15);
  return 1;
}