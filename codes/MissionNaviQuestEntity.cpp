...
System_String_o *__fastcall MissionNaviQuestEntity__CreatePK(int32_t id, int32_t questId, const MethodInfo *method)
{
  if ( (byte_4A4E87A & 1) == 0 )
  {
    sub_1B863B8(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&questId);
    byte_4A4E87A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4E878 & 1) == 0 )
  {
    sub_1B863B8(&Method_SingletonTemplate_QuestTree__get_Instance__, questInfo);
    byte_4A4E878 = 1;
  }
  ...
  if ( (flag & 4) != 0 )
  {
    ...
    if ( questInfo && Instance )
    {
      if ( !QuestTree__IsActiveWar((QuestTree_o *)Instance, questInfo->fields.warId, 0LL) )
        goto LABEL_19;
      v9 = SingletonTemplate_object___get_Instance((const MethodInfo_3839AA0 *)Method_SingletonTemplate_QuestTree__get_Instance__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4E879 & 1) == 0 )
  {
    sub_1B863B8(&Method_SingletonTemplate_clsQuestCheck__get_Instance__, questInfo);
    byte_4A4E879 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4E877 & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_115/*" "*/, challengeIconName);
    sub_1B863B8(&StringLiteral_1/*""*/, v6);
    byte_4A4E877 = 1;
  }
  *challengeIconName = (System_String_o *)StringLiteral_1/*""*/;
  sub_1B8635C((CGThumbnailListItem_o *)challengeIconName, (int32_t)StringLiteral_1/*""*/, (int32_t)method, v3);
  ...
  *challengeIconName = iconName;
  sub_1B8635C((CGThumbnailListItem_o *)challengeIconName, (int32_t)iconName, v7, v8);
  return 1;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4E876 & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_115/*" "*/, challengeNaviName);
    sub_1B863B8(&StringLiteral_1/*""*/, v6);
    byte_4A4E876 = 1;
  }
  *challengeNaviName = (System_String_o *)StringLiteral_1/*""*/;
  sub_1B8635C((CGThumbnailListItem_o *)challengeNaviName, (int32_t)StringLiteral_1/*""*/, (int32_t)method, v3);
  ...
  *challengeNaviName = title;
  sub_1B8635C((CGThumbnailListItem_o *)challengeNaviName, (int32_t)title, v7, v8);
  return 1;
}