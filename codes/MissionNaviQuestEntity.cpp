        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1C9FB & 1) == 0 )
  {
    sub_1BCAFF8(&Method_SingletonTemplate_QuestTree__get_Instance__, questInfo);
    byte_4B1C9FB = 1;
  }
  ...
  if ( (flag & 4) != 0 )
  {
    ...
    if ( questInfo && Instance )
    {
      if ( !QuestTree__IsActiveWar((QuestTree_o *)Instance, questInfo->fields.warId, 0LL) )
        goto LABEL_19;
      v9 = SingletonTemplate_object___get_Instance((const MethodInfo_38F8EF8 *)Method_SingletonTemplate_QuestTree__get_Instance__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1C9FC & 1) == 0 )
  {
    sub_1BCAFF8(&Method_SingletonTemplate_clsQuestCheck__get_Instance__, questInfo);
    byte_4B1C9FC = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1C9FA & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_113/*" "*/, challengeIconName);
    sub_1BCAFF8(&StringLiteral_1/*""*/, v6);
    byte_4B1C9FA = 1;
  }
  *challengeIconName = (System_String_o *)StringLiteral_1/*""*/;
  sub_1BCAF9C((CGThumbnailListItem_o *)challengeIconName, (int32_t)StringLiteral_1/*""*/, (int32_t)method, v3);
  ...
  *challengeIconName = iconName;
  sub_1BCAF9C((CGThumbnailListItem_o *)challengeIconName, (int32_t)iconName, v7, v8);
  return 1;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1C9F9 & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_113/*" "*/, challengeNaviName);
    sub_1BCAFF8(&StringLiteral_1/*""*/, v6);
    byte_4B1C9F9 = 1;
  }
  *challengeNaviName = (System_String_o *)StringLiteral_1/*""*/;
  sub_1BCAF9C((CGThumbnailListItem_o *)challengeNaviName, (int32_t)StringLiteral_1/*""*/, (int32_t)method, v3);
  ...
  *challengeNaviName = title;
  sub_1BCAF9C((CGThumbnailListItem_o *)challengeNaviName, (int32_t)title, v7, v8);
  return 1;
}