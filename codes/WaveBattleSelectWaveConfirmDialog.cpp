        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62C2A & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_WaveBattleSelectWaveConfirmDialog_EndClose__, v3);
    byte_4B62C2A = 1;
  }
  this->fields.state = 2;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62C2B & 1) == 0 )
  {
    sub_1BE4ACC(&Method_WaveBattleSelectWaveConfirmDialog_OnClickCancel__, method);
    byte_4B62C2B = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_WaveBattleSelectWaveConfirmDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BE4AE4(Method_WaveBattleSelectWaveConfirmDialog_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62C2C & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_WaveBattleSelectWaveConfirmDialog_OnClickResumeNotSelectWave__, v3);
    byte_4B62C2C = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_WaveBattleSelectWaveConfirmDialog_OnClickResumeNotSelectWave__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1BE4AE4(Method_WaveBattleSelectWaveConfirmDialog_OnClickResumeNotSelectWave__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62C2D & 1) == 0 )
  {
    sub_1BE4ACC(&WaveBattleSelectWaveDialog_CloseDelegate_TypeInfo, method);
    sub_1BE4ACC(&Method_UnityEngine_GameObject_GetComponent_WaveBattleSelectWaveDialog___, v3);
    sub_1BE4ACC(&Method_UnityEngine_Object_Instantiate_GameObject___, v4);
    sub_1BE4ACC(&UnityEngine_Object_TypeInfo, v5);
    sub_1BE4ACC(&TerminalSceneComponent_TypeInfo, v6);
    sub_1BE4ACC(&Method_WaveBattleSelectWaveConfirmDialog___c__DisplayClass33_0__OnClickResumeSelectWave_b__0__, v7);
    sub_1BE4ACC(&WaveBattleSelectWaveConfirmDialog___c__DisplayClass33_0_TypeInfo, v8);
    sub_1BE4ACC(&Method_WaveBattleSelectWaveConfirmDialog_OnClickResumeSelectWave__, v9);
    byte_4B62C2D = 1;
  }
  v10 = sub_1BE4D18(WaveBattleSelectWaveConfirmDialog___c__DisplayClass33_0_TypeInfo);
  ...
  *(_QWORD *)(v10 + 32) = this;
  ...
  if ( this->fields.state == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_WaveBattleSelectWaveConfirmDialog_OnClickResumeSelectWave__ + 83) & 2) != 0 )
      v19 = (_QWORD *)sub_1BE4AE4(Method_WaveBattleSelectWaveConfirmDialog_OnClickResumeSelectWave__);
    ...
    *(_QWORD *)(v10 + 24) = v23;
    v24 = (void **)(v10 + 24);
    sub_1BE4A70((PartyOrganizationUtility_o *)(v10 + 24), (int64_t)v23, v25, v26, v27, v28, v29, v30);
    ...
    if ( transform )
    {
      ...
      if ( *v24 )
      {
        ...
        *(_QWORD *)(v10 + 16) = Component_object;
        sub_1BE4A70((PartyOrganizationUtility_o *)(v10 + 16), (int64_t)Component_object, v34, v35, v36, v37, v38, v39);
        ...
        if ( transform )
        {
          ...
          if ( v40 )
          {
            ...
            if ( transform )
            {
              ...
              v47 = (WaveBattleSelectWaveDialog_CloseDelegate_o *)sub_1BE4D18(WaveBattleSelectWaveDialog_CloseDelegate_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62C29 & 1) == 0 )
  {
    sub_1BE4ACC(&System_Action_TypeInfo, *(_QWORD *)&qId);
    sub_1BE4ACC(&Method_DataManager_GetMaster_QuestGroupMaster___, v14);
    sub_1BE4ACC(&Method_DataManager_GetMaster_StageMaster___, v15);
    sub_1BE4ACC(&Method_DataManager_GetMaster_UserEventDeckMaster___, v16);
    sub_1BE4ACC(&DataManager_TypeInfo, v17);
    sub_1BE4ACC(&LocalizationManager_TypeInfo, v18);
    sub_1BE4ACC(&NetworkManager_TypeInfo, v19);
    sub_1BE4ACC(&QuestRestrictionInfo_TypeInfo, v20);
    sub_1BE4ACC(&Method_WaveBattleSelectWaveConfirmDialog_EndOpen__, v21);
    sub_1BE4ACC(&StringLiteral_15738/*"WAVE_BATTLE_RESTART_CONFIRM_DIALOG_TITLE"*/, v22);
    sub_1BE4ACC(&StringLiteral_15735/*"WAVE_BATTLE_RESTART_CONFIRM_DIALOG_MESSAGE"*/, v23);
    sub_1BE4ACC(&StringLiteral_15737/*"WAVE_BATTLE_RESTART_CONFIRM_DIALOG_RESUME_SELECT_WAVE_BUTTON"*/, v24);
    sub_1BE4ACC(&StringLiteral_15734/*"WAVE_BATTLE_RESTART_CONFIRM_DIALOG_CANCEL_BUTTON"*/, v25);
    sub_1BE4ACC(&StringLiteral_15736/*"WAVE_BATTLE_RESTART_CONFIRM_DIALOG_RESUME_NOT_SELECT_WAVE_BUTTON"*/, v26);
    sub_1BE4ACC(&StringLiteral_1217/*"00"*/, v27);
    byte_4B62C29 = 1;
  }
  ...
  Master_object = LocalizationManager__Get((System_String_o *)StringLiteral_15738/*"WAVE_BATTLE_RESTART_CONFIRM_DIALOG_TITLE"*/, 0LL);
  if ( !titleLabel )
    goto LABEL_24;
  UILabel__set_text(titleLabel, (System_String_o *)Master_object, 0LL);
  messageLabel = this->fields.messageLabel;
  v32 = LocalizationManager__Get((System_String_o *)StringLiteral_15735/*"WAVE_BATTLE_RESTART_CONFIRM_DIALOG_MESSAGE"*/, 0LL);
  v33 = (Il2CppObject *)System_Int32__ToString_63504416((int32_t)&v56, (System_String_o *)StringLiteral_1217/*"00"*/, 0LL);
  Master_object = System_String__Format(v32, v33, 0LL);
  if ( !messageLabel )
    goto LABEL_24;
  UILabel__set_text(messageLabel, (System_String_o *)Master_object, 0LL);
  cancelLabel = this->fields.cancelLabel;
  Master_object = LocalizationManager__Get((System_String_o *)StringLiteral_15734/*"WAVE_BATTLE_RESTART_CONFIRM_DIALOG_CANCEL_BUTTON"*/, 0LL);
  if ( !cancelLabel )
    goto LABEL_24;
  ...
  Master_object = LocalizationManager__Get((System_String_o *)StringLiteral_15736/*"WAVE_BATTLE_RESTART_CONFIRM_DIALOG_RESUME_NOT_SELECT_WAVE_BUTTON"*/, 0LL);
  ...
  Master_object = LocalizationManager__Get((System_String_o *)StringLiteral_15737/*"WAVE_BATTLE_RESTART_CONFIRM_DIALOG_RESUME_SELECT_WAVE_BUTTON"*/, 0LL);
  if ( !resumeSelectWaveLabel )
    goto LABEL_24;
  UILabel__set_text(resumeSelectWaveLabel, (System_String_o *)Master_object, 0LL);
  v37 = DataManager__GetMaster_object_((const MethodInfo_2F590BC *)Method_DataManager_GetMaster_UserEventDeckMaster___);
  ...
  if ( !*((_DWORD *)Master_object + 6) )
    sub_1BE4D30(Master_object, v29);
  v44 = (struct UserEventDeckEntity_o *)*((_QWORD *)Master_object + 4);
  this->fields.deckEntity = v44;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.deckEntity, (int64_t)v44, v38, v39, v40, v41, v42, v43);
  questId = this->fields.questId;
  eventId = this->fields.eventId;
  questPhase = this->fields.questPhase;
  v48 = (QuestRestrictionInfo_o *)sub_1BE4D18(QuestRestrictionInfo_TypeInfo);
  QuestRestrictionInfo___ctor_41390840(v48, eventId, questId, questPhase, 0LL);
  ...
  sub_1BE4A70(
    ...
    v53,
    v54);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2F590BC *)Method_DataManager_GetMaster_StageMaster___);
  if ( !Master_object )
LABEL_24:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62C2F & 1) == 0 )
  {
    sub_1BE4ACC(&BattleSetupInfo_TypeInfo, *(_QWORD *)&restartWaveNum);
    sub_1BE4ACC(&Method_DataManager_GetMaster_QuestGroupMaster___, v5);
  ...
  v10 = sub_1BE4D18(BattleSetupInfo_TypeInfo);
  ...
  *(_QWORD *)(v10 + 112) = SelectableQuests;
  sub_1BE4A70((PartyOrganizationUtility_o *)(v10 + 112), (int64_t)SelectableQuests, v12, v13, v14, v15, v16, v17);
  Master_object = (QuestPhaseMaster_o *)entity;
  if ( !entity )
    goto LABEL_16;
  ...
  *(_DWORD *)(v10 + 24) = questPhase;
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.battleSetupinfo, v10, v20, v21, v22, v23, v24, v25);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62C26 & 1) == 0 )
  {
    sub_1BE4ACC(&WaveBattleSelectWaveConfirmDialog_CloseDelegate_TypeInfo, value);
    byte_4B62C26 = 1;
  }
  CloseFunc = this->fields.CloseFunc;
  ...
  v11 = (WaveBattleSelectWaveConfirmDialog_o *)sub_1BE4FE8(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A21B0C;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A21AC4;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62C33 & 1) == 0 )
  {
    ...
    this = (WaveBattleSelectWaveConfirmDialog___c__DisplayClass33_0_o *)sub_1BE4ACC(
  ...
  WaveBattleSelectWaveDialog__Close_33184036(resumeNotSelectWaveDialog, _9__1, method);
}
