void UIMessageButton___ctor(UIMessageButton_o *this, const MethodInfo *method)
{
  ...
  this->fields.disabledColor = (struct UnityEngine_Color_o)xmmword_CF5380;
...
void UIMessageButton__OnClick(UIMessageButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEFF0D & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&UIMessageButton_TypeInfo);
    byte_4CEFF0D = 1;
  }
      ...
      & 1) != 0 )
  {
    ...
    sub_1C7BA8C((GrandQuestFolderBoardItem_o *)UIMessageButton_TypeInfo->static_fields, 0, v10, v11, v12, v13, v14, v15);
  }
}
