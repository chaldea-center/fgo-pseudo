void UIMessageButton___ctor(UIMessageButton_o *this, const MethodInfo *method)
{
  ...
  this->fields.disabledColor = (struct UnityEngine_Color_o)xmmword_D34FA0;
  ...
  this->fields.hover = (struct UnityEngine_Color_o)xmmword_D357B0;
  this->fields.pressed = (struct UnityEngine_Color_o)xmmword_D35C70;
...
void UIMessageButton__OnClick(UIMessageButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E78F83 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&UIMessageButton_TypeInfo);
    byte_4E78F83 = 1;
  }
      ...
      & 1) != 0 )
  {
    ...
    sub_1D0F058((GrandQuestFolderBoardItem_o *)UIMessageButton_TypeInfo->static_fields, 0, v10, v11, v12, v13, v14, v15);
  }
}
