__int64 __fastcall DllGetActivationFactory(__int64 a1, __int64 *a2)
{
  ...
  *(_QWORD *)v34 = a1;
  if ( a1 && a2 )
  {
    sub_1B48F60(v33, &dword_4A0E5A0);
    if ( (byte_4A0E5F0 & 1) == 0 )
    {
      if ( (sub_1BA0618("IL2CPP Root Domain") & 1) == 0 )
      {
        v2 = -2146233082;
LABEL_23:
        sub_1B49010(v33);
    ...
    v4 = (__int64 *)sub_1B77414(&qword_4A0E588, v34);
    if ( v4 == &qword_4A0E590 )
    {
      sub_1BD019C(v34[0], (int)&v32, v5, v6, v7, v8, v9, v10, v18, v19, v20, v21, v22);
      LODWORD(v22) = v28;
      std::string::basic_string(v23, v29);
      v26 = v31;
      if ( (unsigned int)sub_1BD4B34(&v22) )
      {
        v17 = sub_1B73FB0(&v22);
      ...
      if ( ((unsigned __int8)v22 & 1) != 0 )
        ...
        v12 = (char *)&v22 + 1;
      v13 = (__int64 (*)(void))sub_1B4CFC8(v12);
      if ( v13 )
      {
        v2 = sub_1B7A8D8(*(_QWORD *)v34, &v21);
        if ( (v2 & 0x80000000) == 0 )
        {
          v14 = v13();
          v18 = v21;
          v19 = v14;
          v20 = v21;
          v15 = *(_QWORD *)(sub_1B77620(&qword_4A0E588, &v18, &v18) + 40);
