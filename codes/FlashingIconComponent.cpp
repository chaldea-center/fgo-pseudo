...
void FlashingIconComponent__Clear(FlashingIconComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Behaviour__get_enabled(widget, 0) )
  {
    ...
    {
      widget = (UnityEngine_Behaviour_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3AC52FC *)Method_SingletonMonoBehaviour_FlashingIconManager__get_Instance__);
      if ( widget )
      {
...
void FlashingIconComponent__SetFast_41620420(FlashingIconComponent_o *this, bool isDisp, const MethodInfo *method)
{
  if ( isDisp )
...
// local variable allocation has failed, the output may be wrong!
void FlashingIconComponent__Set_41619952(FlashingIconComponent_o *this, bool isDisp, const MethodInfo *method)
{
  if ( isDisp )
...
void FlashingIconComponent__Set_41619964(FlashingIconComponent_o *this, float cycleTime, const MethodInfo *method)
{
  UnityEngine_Behaviour_o *widget; // x0
  Il2CppObject *Instance; // x20
