...
void FlashingIconComponent__Clear(FlashingIconComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Behaviour__get_enabled(widget, 0) )
  {
    ...
    {
      widget = (UnityEngine_Behaviour_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39ED16C *)Method_SingletonMonoBehaviour_FlashingIconManager__get_Instance__);
      if ( widget )
      {
...
void FlashingIconComponent__SetFast_40901508(FlashingIconComponent_o *this, bool isDisp, const MethodInfo *method)
{
  if ( isDisp )
...
// local variable allocation has failed, the output may be wrong!
void FlashingIconComponent__Set_40901040(FlashingIconComponent_o *this, bool isDisp, const MethodInfo *method)
{
  if ( isDisp )
...
void FlashingIconComponent__Set_40901052(FlashingIconComponent_o *this, float cycleTime, const MethodInfo *method)
{
  UnityEngine_Behaviour_o *widget; // x0
  Il2CppObject *Instance; // x20
