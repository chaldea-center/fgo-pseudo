void CriMonoBehaviourManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CC0BAC & 1) == 0 )
  {
    sub_1C713B0(&CriMonoBehaviourManager_TypeInfo);
    sub_1C713B0(&Method_System_Collections_Generic_List_CriMonoBehaviour___ctor__);
    sub_1C713B0(&System_Collections_Generic_List_CriMonoBehaviour__TypeInfo);
    byte_4CC0BAC = 1;
  }
  CriMonoBehaviourManager_TypeInfo->static_fields->_instance = 0;
  sub_1C71354(CriMonoBehaviourManager_TypeInfo->static_fields, 0);
  v1 = (System_Collections_Generic_List_object__o *)sub_1C715FC(System_Collections_Generic_List_CriMonoBehaviour__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v1,
    (const MethodInfo_380FEE4 *)Method_System_Collections_Generic_List_CriMonoBehaviour___ctor__);
  ...
  sub_1C71354(&static_fields->criMonoBehaviourList, v1);
}
...
void CriMonoBehaviourManager__Awake(CriMonoBehaviourManager_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(instance, 0, 0) )
  {
    ...
    sub_1C71354(CriMonoBehaviourManager_TypeInfo->static_fields, this);
  }
  else
  {
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
...
void CriMonoBehaviourManager__CreateInstance(const MethodInfo *method)
{
  ...
  {
    sub_1C713B0(&CriMonoBehaviourManager_TypeInfo);
    sub_1C713B0(&Method_UnityEngine_GameObject_AddComponent_CriMonoBehaviourManager___);
    sub_1C713B0(&UnityEngine_Object_TypeInfo);
    byte_4CC0BA5 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Equality(instance, 0, 0) )
  {
    ...
    UnityEngine_GameObject__AddComponent_object_(
      managerObject,
      (const MethodInfo_31A2DE8 *)Method_UnityEngine_GameObject_AddComponent_CriMonoBehaviourManager___);
  }
}
...
int32_t CriMonoBehaviourManager__GetIndex(CriMonoBehaviour_o *criMonoBehaviour, const MethodInfo *method)
{
  ...
  {
    sub_1C713B0(&CriMonoBehaviourManager_TypeInfo);
    sub_1C713B0(&Method_System_Collections_Generic_List_CriMonoBehaviour__get_Count__);
    sub_1C713B0(&Method_System_Collections_Generic_List_CriMonoBehaviour__get_Item__);
    byte_4CC0BA6 = 1;
  }
  for ( i = 0; ; ++i )
  {
...
LABEL_16:
    ...
    inited = System_Collections_Generic_List_object___get_Item(
               ...
               i,
               (const MethodInfo_3810448 *)Method_System_Collections_Generic_List_CriMonoBehaviour__get_Item__);
...
void CriMonoBehaviourManager__LateUpdate(CriMonoBehaviourManager_o *this, const MethodInfo *method)
{
  ...
  lockTaken = 0;
  System_Threading_Monitor__Enter_65959364(criMonoBehaviourList, &lockTaken, 0);
  for ( i = 0; ; ++i )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC0BA7 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_System_Collections_Generic_List_CriMonoBehaviour__Add__);
    sub_1C713B0(&StringLiteral_15903/*"[CRIWARE] Internal: Duplicated CriMonoBehaviour GUID"*/);
    byte_4CC0BA7 = 1;
  }
  ...
  if ( CriMonoBehaviourManager__GetIndex(criMonoBehaviour, v6) < 0 )
  {
    ...
    else
    {
      ...
      sub_1C71354(v14 + 4, criMonoBehaviour);
    }
    v8 = 1;
  }
  else
  {
    ...
    UnityEngine_Debug__LogWarning((Il2CppObject *)StringLiteral_15903/*"[CRIWARE] Internal: Duplicated CriMonoBehaviour GUID"*/, 0);
    v8 = 0;
  }
  if ( lockTaken )
    System_Threading_Monitor__Exit(criMonoBehaviourList, 0);
...
bool CriMonoBehaviourManager__UnRegister(CriMonoBehaviour_o *criMonoBehaviour, const MethodInfo *method)
{
  ...
  {
    sub_1C713B0(&CriMonoBehaviourManager_TypeInfo);
    sub_1C713B0(&Method_System_Collections_Generic_List_CriMonoBehaviour__RemoveAt__);
    byte_4CC0BA8 = 1;
  }
  v3 = CriMonoBehaviourManager_TypeInfo;
  if ( !CriMonoBehaviourManager_TypeInfo->_2.cctor_finished )
  ...
  else
  {
    ...
    System_Collections_Generic_List_object___RemoveAt(
      v9,
      Index,
      (const MethodInfo_3811EEC *)Method_System_Collections_Generic_List_CriMonoBehaviour__RemoveAt__);
    v10 = 1;
  }
  if ( lockTaken )
    System_Threading_Monitor__Exit(criMonoBehaviourList, 0);
