void CriMonoBehaviourManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CAFAAC & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_System_Collections_Generic_List_CriMonoBehaviour___ctor__);
    sub_1C6BA08(&System_Collections_Generic_List_CriMonoBehaviour__TypeInfo);
    byte_4CAFAAC = 1;
  }
  CriMonoBehaviourManager_TypeInfo->static_fields->_instance = 0;
  sub_1C6B9AC(CriMonoBehaviourManager_TypeInfo->static_fields, 0);
  v1 = (System_Collections_Generic_List_object__o *)sub_1C6BC54(System_Collections_Generic_List_CriMonoBehaviour__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v1,
    (const MethodInfo_3800140 *)Method_System_Collections_Generic_List_CriMonoBehaviour___ctor__);
  ...
  sub_1C6B9AC(&static_fields->criMonoBehaviourList, v1);
}
...
void CriMonoBehaviourManager__Awake(CriMonoBehaviourManager_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(instance, 0, 0) )
  {
    ...
    sub_1C6B9AC(CriMonoBehaviourManager_TypeInfo->static_fields, this);
  }
  else
  {
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
...
void CriMonoBehaviourManager__CreateInstance(const MethodInfo *method)
{
  ...
  {
    sub_1C6BA08(&CriMonoBehaviourManager_TypeInfo);
    sub_1C6BA08(&Method_UnityEngine_GameObject_AddComponent_CriMonoBehaviourManager___);
    sub_1C6BA08(&UnityEngine_Object_TypeInfo);
    byte_4CAFAA5 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Equality(instance, 0, 0) )
  {
    ...
    UnityEngine_GameObject__AddComponent_object_(
      managerObject,
      (const MethodInfo_3193044 *)Method_UnityEngine_GameObject_AddComponent_CriMonoBehaviourManager___);
  }
}
...
int32_t CriMonoBehaviourManager__GetIndex(CriMonoBehaviour_o *criMonoBehaviour, const MethodInfo *method)
{
  ...
  {
    sub_1C6BA08(&CriMonoBehaviourManager_TypeInfo);
    sub_1C6BA08(&Method_System_Collections_Generic_List_CriMonoBehaviour__get_Count__);
    sub_1C6BA08(&Method_System_Collections_Generic_List_CriMonoBehaviour__get_Item__);
    byte_4CAFAA6 = 1;
  }
  for ( i = 0; ; ++i )
  {
...
LABEL_16:
    ...
    inited = System_Collections_Generic_List_object___get_Item(
               ...
               i,
               (const MethodInfo_38006A4 *)Method_System_Collections_Generic_List_CriMonoBehaviour__get_Item__);
...
void CriMonoBehaviourManager__LateUpdate(CriMonoBehaviourManager_o *this, const MethodInfo *method)
{
  ...
  lockTaken = 0;
  System_Threading_Monitor__Enter_65894432(criMonoBehaviourList, &lockTaken, 0);
  for ( i = 0; ; ++i )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CAFAA7 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_System_Collections_Generic_List_CriMonoBehaviour__Add__);
    sub_1C6BA08(&StringLiteral_15896/*"[CRIWARE] Internal: Duplicated CriMonoBehaviour GUID"*/);
    byte_4CAFAA7 = 1;
  }
  ...
  if ( CriMonoBehaviourManager__GetIndex(criMonoBehaviour, v6) < 0 )
  {
    ...
    else
    {
      ...
      sub_1C6B9AC(v14 + 4, criMonoBehaviour);
    }
    v8 = 1;
  }
  else
  {
    ...
    UnityEngine_Debug__LogWarning((Il2CppObject *)StringLiteral_15896/*"[CRIWARE] Internal: Duplicated CriMonoBehaviour GUID"*/, 0);
    v8 = 0;
  }
  if ( lockTaken )
    System_Threading_Monitor__Exit(criMonoBehaviourList, 0);
...
bool CriMonoBehaviourManager__UnRegister(CriMonoBehaviour_o *criMonoBehaviour, const MethodInfo *method)
{
  ...
  {
    sub_1C6BA08(&CriMonoBehaviourManager_TypeInfo);
    sub_1C6BA08(&Method_System_Collections_Generic_List_CriMonoBehaviour__RemoveAt__);
    byte_4CAFAA8 = 1;
  }
  v3 = CriMonoBehaviourManager_TypeInfo;
  if ( !CriMonoBehaviourManager_TypeInfo->_2.cctor_finished )
  ...
  else
  {
    ...
    System_Collections_Generic_List_object___RemoveAt(
      v9,
      Index,
      (const MethodInfo_3802148 *)Method_System_Collections_Generic_List_CriMonoBehaviour__RemoveAt__);
    v10 = 1;
  }
  if ( lockTaken )
    System_Threading_Monitor__Exit(criMonoBehaviourList, 0);
