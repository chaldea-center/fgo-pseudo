void __fastcall ServantExpMaster___ctor(ServantExpMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A2E649 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_ServantExpMaster__ServantExpEntity__string___ctor__, method);
    byte_4A2E649 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    87,
    (const MethodInfo_30FFA98 *)Method_DataMasterBase_ServantExpMaster__ServantExpEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E647 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_ServantExpMaster__ServantExpEntity__string__GetEntity__, *(_QWORD *)&type);
    byte_4A2E647 = 1;
  }
  ...
  return (ServantExpEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                 (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                 PK,
                                 (const MethodInfo_30FFAD8 *)Method_DataMasterBase_ServantExpMaster__ServantExpEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E648 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_ServantExpMaster__ServantExpEntity__string__TryGetEntity__, entity);
    byte_4A2E648 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_30FFB28 *)Method_DataMasterBase_ServantExpMaster__ServantExpEntity__string__TryGetEntity__);
}
