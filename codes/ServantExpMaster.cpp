void ServantExpMaster___ctor(ServantExpMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4CEEFA1 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_DataMasterBase_ServantExpMaster__ServantExpEntity__string___ctor__);
    byte_4CEEFA1 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    91,
    (const MethodInfo_3430A90 *)Method_DataMasterBase_ServantExpMaster__ServantExpEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEEF9F & 1) == 0 )
  {
    sub_1C7BAE8(&Method_DataMasterBase_ServantExpMaster__ServantExpEntity__string__GetEntity__);
    byte_4CEEF9F = 1;
  }
  ...
  return (ServantExpEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                 (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                 PK,
                                 (const MethodInfo_3432DB4 *)Method_DataMasterBase_ServantExpMaster__ServantExpEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEEFA0 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_DataMasterBase_ServantExpMaster__ServantExpEntity__string__TryGetEntity__);
    byte_4CEEFA0 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_3432E00 *)Method_DataMasterBase_ServantExpMaster__ServantExpEntity__string__TryGetEntity__);
}
