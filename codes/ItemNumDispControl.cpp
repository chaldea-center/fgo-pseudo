void __fastcall ItemNumDispControl___cctor(const MethodInfo *method)
{
  if ( (byte_42AF188 & 1) == 0 )
  {
    sub_B52984(&ItemNumDispControl_TypeInfo);
    byte_42AF188 = 1;
  }
...
bool __fastcall ItemNumDispControl__IsEventInfoGroups(ItemNumDispControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42AF184 & 1) == 0 )
  {
    this = (ItemNumDispControl_o *)sub_B52984(&Method_System_Collections_Generic_List_GameObject__get_Count__);
    byte_42AF184 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_22:
    sub_B52A5C(SetAlphaDispInfoGroup, *(_QWORD *)&group_id);
  }
...
void __fastcall ItemNumDispControl__UpdateEventAlphaAnim(ItemNumDispControl_o *this, const MethodInfo *method)
{
  ...
  if ( ((unsigned __int8)IsEventInfoGroups & 1) != 0 )
  {
    ...
    {
      IsEventInfoGroups = (CommonUI_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
...
LABEL_30:
    sub_B52A5C(IsEventInfoGroups, v4);
  }
