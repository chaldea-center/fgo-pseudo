void __fastcall ItemNumDispControl___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B3B24E & 1) == 0 )
  {
    sub_1BD3458(&ItemNumDispControl_TypeInfo, v1);
    byte_4B3B24E = 1;
  }
...
void __fastcall ItemNumDispControl___ctor(ItemNumDispControl_o *this, const MethodInfo *method)
{
  ...
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.SetAlphaDispInfoGroup, (int64_t)v4, v5, v6, v7, v8, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3B249 & 1) == 0 )
  {
    sub_1BD3458(&Method_System_Collections_Generic_List_Enumerator_GameObject__Dispose__, infoList);
...
bool __fastcall ItemNumDispControl__IsEventInfoGroups(ItemNumDispControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3B24A & 1) == 0 )
  {
    this = (ItemNumDispControl_o *)sub_1BD3458(&Method_System_Collections_Generic_List_GameObject__get_Count__, method);
    byte_4B3B24A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3B24B & 1) == 0 )
  {
    sub_1BD3458(&Method_System_Collections_Generic_List_Enumerator_GameObject__Dispose__, *(_QWORD *)&group_id);
  ...
  if ( !SetAlphaDispInfoGroup
    || (SetAlphaDispInfoGroup = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___get_Item(
                                                                               ...
                                                                               (const MethodInfo_35C0AC0 *)Method_System_Collections_Generic_List_GameObject__get_Item__)) == 0LL
  ...
  {
LABEL_20:
    sub_1BD36B4(SetAlphaDispInfoGroup, *(_QWORD *)&group_id);
  }
...
void __fastcall ItemNumDispControl__UpdateEventAlphaAnim(ItemNumDispControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3B24C & 1) == 0 )
  {
    ...
    sub_1BD3458(&ItemNumDispControl_TypeInfo, v5);
  ...
  if ( ((unsigned __int8)IsEventInfoGroups & 1) != 0 )
  {
    ...
    {
      IsEventInfoGroups = (CommonUI_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37FDC48 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
...
LABEL_28:
    sub_1BD36B4(IsEventInfoGroups, v9);
  }
