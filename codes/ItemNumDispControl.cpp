void ItemNumDispControl___cctor(const MethodInfo *method)
{
  if ( (byte_596A7C8 & 1) == 0 )
  {
    sub_2213A60(&ItemNumDispControl_TypeInfo);
    byte_596A7C8 = 1;
  }
...
bool ItemNumDispControl__IsEventInfoGroups(ItemNumDispControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596A7C4 & 1) == 0 )
  {
    this = (ItemNumDispControl_o *)sub_2213A60(&Method_System_Collections_Generic_List_GameObject__get_Count__);
    byte_596A7C4 = 1;
  }
...
void ItemNumDispControl__SetDispEventInfoGroup(ItemNumDispControl_o *this, int32_t group_id, const MethodInfo *method)
{
  ...
  if ( !SetAlphaDispInfoGroup
    || (SetAlphaDispInfoGroup = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___get_Item(
                                                                               ...
                                                                               (const MethodInfo_4483994 *)Method_System_Collections_Generic_List_GameObject__get_Item__)) == 0
  ...
  {
LABEL_20:
    sub_2213CDC(SetAlphaDispInfoGroup, *(_QWORD *)&group_id);
  }
...
void ItemNumDispControl__UpdateEventAlphaAnim(ItemNumDispControl_o *this, const MethodInfo *method)
{
  ...
  if ( IsEventInfoGroups )
  {
    ...
    {
      alphaAnimRoot = (CommonUI_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_47A29F8 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
      if ( !alphaAnimRoot )
        goto LABEL_29;
