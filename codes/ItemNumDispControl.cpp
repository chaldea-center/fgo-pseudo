void __fastcall ItemNumDispControl___cctor(const MethodInfo *method)
{
  if ( (byte_4A5F06B & 1) == 0 )
  {
    sub_1B885B0(&ItemNumDispControl_TypeInfo);
    byte_4A5F06B = 1;
  }
...
void __fastcall ItemNumDispControl___ctor(ItemNumDispControl_o *this, const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.SetAlphaDispInfoGroup, (int32_t)v3, v4, v5);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B88554(
    ...
    (int32_t)method,
    v3);
  if ( ItemNumDispControl__IsEventInfoGroups(this, v7) )
  {
    ItemNumDispControl__SetDispEventInfoGroup(this, 0, v9);
...
bool __fastcall ItemNumDispControl__IsEventInfoGroups(ItemNumDispControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5F067 & 1) == 0 )
  {
    this = (ItemNumDispControl_o *)sub_1B885B0(&Method_System_Collections_Generic_List_GameObject__get_Count__);
    byte_4A5F067 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !SetAlphaDispInfoGroup
    || (SetAlphaDispInfoGroup = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___get_Item(
                                                                               ...
                                                                               (const MethodInfo_34FD564 *)Method_System_Collections_Generic_List_GameObject__get_Item__)) == 0LL
  ...
  {
LABEL_20:
    sub_1B8880C(SetAlphaDispInfoGroup, *(_QWORD *)&group_id);
  }
...
void __fastcall ItemNumDispControl__UpdateEventAlphaAnim(ItemNumDispControl_o *this, const MethodInfo *method)
{
  ...
  if ( ((unsigned __int8)IsEventInfoGroups & 1) != 0 )
  {
    ...
    {
      IsEventInfoGroups = (CommonUI_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
...
LABEL_28:
    sub_1B8880C(IsEventInfoGroups, v4);
  }
