void __fastcall DropAutoSellDlgComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B17E32 & 1) == 0 )
  {
    sub_1BCAFF8(&DropAutoSellDlgComponent_TypeInfo, v1);
  ...
  v5 = (System_Array_o *)sub_1BCB0A0(int___TypeInfo, 4LL);
  ...
  System_Runtime_CompilerServices_RuntimeHelpers__InitializeArray_63149500(v5, v14, 0LL);
  DropAutoSellDlgComponent_TypeInfo->static_fields->settingKinds = v6;
  sub_1BCAF9C((CGThumbnailListItem_o *)DropAutoSellDlgComponent_TypeInfo->static_fields, (int32_t)v6, v7, v8);
  v9 = (System_Array_o *)sub_1BCB0A0(int___TypeInfo, 4LL);
  v15.fields.value = Field__PrivateImplementationDetails__01DE6A7D9D19E08202A552CCAB4AF80ECBBA6F323968DB42D518815A6D2A42E1;
  v10 = v9;
  System_Runtime_CompilerServices_RuntimeHelpers__InitializeArray_63149500(v9, v15, 0LL);
  static_fields = DropAutoSellDlgComponent_TypeInfo->static_fields;
  static_fields->settingMasks = (struct System_Int32_array *)v10;
  sub_1BCAF9C((CGThumbnailListItem_o *)&static_fields->settingMasks, (int32_t)v10, v12, v13);
}
...
void __fastcall DropAutoSellDlgComponent___ctor(DropAutoSellDlgComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.enableList, (int32_t)v5, v6, v7);
...
void __fastcall DropAutoSellDlgComponent__Close(DropAutoSellDlgComponent_o *this, const MethodInfo *method)
{
  ...
  DropAutoSellDlgComponent__Close_33276532(this, 0LL, v2);
}


void __fastcall DropAutoSellDlgComponent__Close_33276532(
        DropAutoSellDlgComponent_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17E27 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_DropAutoSellDlgComponent_EndClose__, v6);
    byte_4B17E27 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17E2F & 1) == 0 )
  {
    sub_1BCAFF8(&Method_BasicHelper_Any_int___, method);
    sub_1BCAFF8(&DropAutoSellDlgComponent_TypeInfo, v3);
    ...
    sub_1BCAFF8(&Method_DropAutoSellDlgComponent___c__DisplayClass40_0__GetDisableList_b__0__, v7);
    this = (DropAutoSellDlgComponent_o *)sub_1BCAFF8(&DropAutoSellDlgComponent___c__DisplayClass40_0_TypeInfo, v8);
    byte_4B17E2F = 1;
  }
  ...
  if ( size != 4 )
  {
    v11 = (System_Int32_array *)sub_1BCB0A0(int___TypeInfo, (unsigned int)(4 - size));
    v12 = 0LL;
    v13 = 0;
    while ( 1 )
    {
      v14 = sub_1BCB244(DropAutoSellDlgComponent___c__DisplayClass40_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17E2A & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DropAutoSellDlgComponent_OnClickButton__, *(_QWORD *)&kind);
    byte_4B17E2A = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_DropAutoSellDlgComponent_OnClickButton__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1BCB010(Method_DropAutoSellDlgComponent_OnClickButton__);
...
void __fastcall DropAutoSellDlgComponent__OnClickCancel(DropAutoSellDlgComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B17E29 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DropAutoSellDlgComponent_OnClickCancel__, method);
    byte_4B17E29 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_DropAutoSellDlgComponent_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BCB010(Method_DropAutoSellDlgComponent_OnClickCancel__);
...
void __fastcall DropAutoSellDlgComponent__OnClickDecide(DropAutoSellDlgComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B17E28 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DropAutoSellDlgComponent_OnClickDecide__, method);
    byte_4B17E28 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_DropAutoSellDlgComponent_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BCB010(Method_DropAutoSellDlgComponent_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BCAFDC(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BCAFF8(&System_Action_TypeInfo, callback);
    sub_1BCAFF8(&Method_DropAutoSellDlgComponent_EndOpen__, v5);
    sub_1BCAFF8(&DropAutoSellDlgComponent_TypeInfo, v6);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_int__Add__, v7);
    sub_1BCAFF8(&LocalizationManager_TypeInfo, v8);
    sub_1BCAFF8(&StringLiteral_4992/*"DROP_AUTOSELL_MSG"*/, v9);
    ...
    sub_1BCAFF8(&StringLiteral_4993/*"DROP_AUTOSELL_TITLE"*/, v15);
    sub_1BCAFF8(&StringLiteral_11699/*"SERVANT_SORT_FILTER_RARITY_RARE"*/, v16);
    sub_1BCAFF8(&StringLiteral_4991/*"DROP_AUTOSELL_EXP_TXT"*/, v17);
    byte_4B17E26 = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  if ( !gameObject )
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_4993/*"DROP_AUTOSELL_TITLE"*/, 0LL);
  if ( !titleLabel )
    goto LABEL_44;
  UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL);
  msgLabel = this->fields.msgLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_4992/*"DROP_AUTOSELL_MSG"*/, 0LL);
  if ( !msgLabel )
    goto LABEL_44;
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_4991/*"DROP_AUTOSELL_EXP_TXT"*/, 0LL);
  if ( !expTitleLb )
    goto LABEL_44;
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11698/*"SERVANT_SORT_FILTER_RARITY_COMMON"*/, 0LL);
  if ( !v29 )
    goto LABEL_44;
  ...
  if ( v30->max_length <= 1 )
    goto LABEL_45;
  v31 = v30->m_Items[1];
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11702/*"SERVANT_SORT_FILTER_RARITY_UNCOMMON"*/, 0LL);
  if ( !v31 )
    goto LABEL_44;
  ...
  if ( v32->max_length <= 2 )
    goto LABEL_45;
  v33 = v32->m_Items[2];
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11699/*"SERVANT_SORT_FILTER_RARITY_RARE"*/, 0LL);
  if ( !v33
...
LABEL_44:
  ...
  if ( v34->max_length <= 3 )
LABEL_45:
    sub_1BCB25C(gameObject, v19, v27);
  v35 = v34->m_Items[3];
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11700/*"SERVANT_SORT_FILTER_RARITY_SRARE"*/, 0LL);
  if ( !v35 )
    goto LABEL_44;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17E2D & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DropAutoSellDlgComponent_callbackUsetStatusFlagSet__, method);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_int__ToArray__, v3);
    sub_1BCAFF8(&Method_NetworkManager_getRequest_UserStatusFlagSetRequest___, v4);
...
LABEL_9:
  ...
  for ( i = 0LL; i != 4; ++i )
  {
    ...
    if ( i >= settingButton->max_length )
      sub_1BCB25C(decideButton, isEnable, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17E2B & 1) == 0 )
  {
    sub_1BCAFF8(&Method_BasicHelper_Any_int___, *(_QWORD *)&kind);
    sub_1BCAFF8(&System_Func_int__bool__TypeInfo, v5);
    sub_1BCAFF8(&Method_DropAutoSellDlgComponent___c__DisplayClass35_0__SetButtonSelect_b__0__, v6);
    sub_1BCAFF8(&DropAutoSellDlgComponent___c__DisplayClass35_0_TypeInfo, v7);
    sub_1BCAFF8(&Method_DropAutoSellDlgComponent___c__DisplayClass35_1__SetButtonSelect_b__1__, v8);
    sub_1BCAFF8(&DropAutoSellDlgComponent___c__DisplayClass35_1_TypeInfo, v9);
    sub_1BCAFF8(&StringLiteral_17299/*"btn_bg_04"*/, v10);
    sub_1BCAFF8(&StringLiteral_17298/*"btn_bg_03"*/, v11);
    byte_4B17E2B = 1;
  }
  v12 = sub_1BCB244(DropAutoSellDlgComponent___c__DisplayClass35_0_TypeInfo);
  ...
  *(_DWORD *)(v12 + 16) = kind;
  if ( kind == 4 )
  {
    v16 = sub_1BCB244(DropAutoSellDlgComponent___c__DisplayClass35_1_TypeInfo);
      ...
      *(_DWORD *)(v16 + 16) = 0;
      ...
      while ( 1 )
      {
        ...
        if ( !v20 )
          break;
        if ( v13 )
          v22 = &StringLiteral_17298/*"btn_bg_03"*/;
        else
          v22 = &StringLiteral_17299/*"btn_bg_04"*/;
...
LABEL_22:
  ...
  if ( !v27 )
    goto LABEL_21;
  v29 = &StringLiteral_17298/*"btn_bg_03"*/;
  if ( !v13 )
    v29 = &StringLiteral_17299/*"btn_bg_04"*/;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BCAFF8(&Method_BasicHelper_Any_int___, *(_QWORD *)&kind);
    sub_1BCAFF8(&DropAutoSellDlgComponent_TypeInfo, v5);
    sub_1BCAFF8(&System_Func_int__bool__TypeInfo, v6);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_int__Add__, v7);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_int__Remove__, v8);
    sub_1BCAFF8(&Method_DropAutoSellDlgComponent___c__DisplayClass37_0__SwitchSelect_b__0__, v9);
    sub_1BCAFF8(&DropAutoSellDlgComponent___c__DisplayClass37_0_TypeInfo, v10);
    byte_4B17E2C = 1;
  }
  v11 = sub_1BCB244(DropAutoSellDlgComponent___c__DisplayClass37_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17E23 & 1) == 0 )
  {
    sub_1BCAFF8(&DropAutoSellDlgComponent_CallbackFunc_TypeInfo, value);
    byte_4B17E23 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  ...
  v11 = (DropAutoSellDlgComponent_o *)sub_1BCB514(v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17E2E & 1) == 0 )
  {
    this = (DropAutoSellDlgComponent_o *)sub_1BCAFF8(&StringLiteral_22181/*"ok"*/, result);
    byte_4B17E2E = 1;
  }
  if ( !result )
    sub_1BCB254(this, result);
  v5 = System_String__Equals_62485728(result, (System_String_o *)StringLiteral_22181/*"ok"*/, 0LL);
  v4->fields.state = 4;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A0F46C;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A0F424;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17E34 & 1) == 0 )
  {
    sub_1BCAFF8(&DropAutoSellDlgComponent_TypeInfo, *(_QWORD *)&x);
    byte_4B17E34 = 1;
  }
  ...
  if ( !settingKinds )
    sub_1BCB254(v5, *(_QWORD *)&x);
  kind = this->fields.kind;
  if ( (unsigned int)kind >= settingKinds->max_length )
    sub_1BCB25C(v5, *(_QWORD *)&x, method);
