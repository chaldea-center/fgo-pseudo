        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40F60ED & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_18392/*"event/receiveCooltimeReward"*/, v2);
    byte_40F60ED = 1;
  }
  ...
  return System_String__Concat_43743732(BaseUrl, (System_String_o *)StringLiteral_18392/*"event/receiveCooltimeReward"*/, 0LL);
}
