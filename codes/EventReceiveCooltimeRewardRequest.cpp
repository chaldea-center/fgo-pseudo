        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4214A45 & 1) == 0 )
  {
    ...
    sub_B0D8A4(&StringLiteral_18518/*"event/receiveCooltimeReward"*/, v2);
    byte_4214A45 = 1;
  }
  ...
  return System_String__Concat_43849904(BaseUrl, (System_String_o *)StringLiteral_18518/*"event/receiveCooltimeReward"*/, 0LL);
}
