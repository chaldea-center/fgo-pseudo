        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_438BDB6 & 1) == 0 )
  {
    ...
    sub_B775C4(&StringLiteral_18828/*"event/receiveCooltimeReward"*/);
    byte_438BDB6 = 1;
  }
  ...
  return System_String__Concat_44901936(BaseUrl, (System_String_o *)StringLiteral_18828/*"event/receiveCooltimeReward"*/, 0LL);
}
