        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_59723FE & 1) == 0 )
  {
    ...
    sub_2213A60(&StringLiteral_20024/*"event/receiveCooltimeReward"*/);
    byte_59723FE = 1;
  }
  if ( !*(&NetworkManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_75651716(BaseUrl, (System_String_o *)StringLiteral_20024/*"event/receiveCooltimeReward"*/, 0);
}
