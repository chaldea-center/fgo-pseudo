        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB7E14 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_19182/*"event/receiveCooltimeReward"*/);
    byte_4CB7E14 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63966792(BaseUrl, (System_String_o *)StringLiteral_19182/*"event/receiveCooltimeReward"*/, 0);
}
