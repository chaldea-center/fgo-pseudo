        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BC832 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_18811/*"event/receiveCooltimeReward"*/, v2);
    byte_49BC832 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61093468(BaseUrl, (System_String_o *)StringLiteral_18811/*"event/receiveCooltimeReward"*/, 0LL);
}
