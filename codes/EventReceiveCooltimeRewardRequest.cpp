        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A71708 & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_19146/*"event/receiveCooltimeReward"*/, v2);
    byte_4A71708 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61787092(BaseUrl, (System_String_o *)StringLiteral_19146/*"event/receiveCooltimeReward"*/, 0LL);
}
