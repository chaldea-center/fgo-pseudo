void __fastcall SoundLogger___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FDABE & 1) == 0 )
  {
    sub_1B64870(&SoundLogger_TypeInfo, v1);
    sub_1B64870(&StringLiteral_1576/*":NG"*/, v4);
    byte_49FDABE = 1;
  }
  SoundLogger_TypeInfo->static_fields->WORD_NG = (struct System_String_o *)StringLiteral_1576/*":NG"*/;
  sub_1B64814((ServantStatusBattleListViewItem_o *)SoundLogger_TypeInfo->static_fields, StringLiteral_1576/*":NG"*/, v2, v3);
}
...
void __fastcall SoundLogger___ctor(SoundLogger_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FDAB3 & 1) == 0 )
  {
    ...
    sub_1B64870(&SoundLogger_BgmVolumeInfo___TypeInfo, v3);
    sub_1B64870(&SoundLogger_BgmVolumeInfo_TypeInfo, v4);
    sub_1B64870(&SoundLogger_Info_TypeInfo, v5);
    byte_49FDAB3 = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
  v6 = (SoundLogger_Info_o *)sub_1B64ABC(SoundLogger_Info_TypeInfo);
  SoundLogger_Info___ctor(v6, 2, v7);
  this->fields.bgmLog = v6;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)v6, v8, v9);
  v10 = (SoundLogger_Info_o *)sub_1B64ABC(SoundLogger_Info_TypeInfo);
  SoundLogger_Info___ctor(v10, 5, v11);
  this->fields.voiceLog = v10;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.voiceLog, (int32_t)v10, v12, v13);
  v14 = (SoundLogger_Info_o *)sub_1B64ABC(SoundLogger_Info_TypeInfo);
  SoundLogger_Info___ctor(v14, 16, v15);
  this->fields.seLog = v14;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.seLog, (int32_t)v14, v16, v17);
  ...
  v19 = (struct SoundLogger_BgmVolumeInfo_array *)sub_1B64918(
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)p_bgmVolumeLogs, (int32_t)v19, v21, v22);
  v25 = *p_bgmVolumeLogs;
  if ( !*p_bgmVolumeLogs )
LABEL_13:
    sub_1B64ACC(v23, v24);
  ...
  {
    v28 = (SoundLogger_BgmVolumeInfo_o *)sub_1B64ABC(SoundLogger_BgmVolumeInfo_TypeInfo);
    ...
    if ( *p_bgmVolumeLogs )
    {
      if ( v28 )
      {
        v23 = sub_1B649AC(v28, *(_QWORD *)(*(_QWORD *)v32 + 64LL));
        if ( !v23 )
        {
          v33 = sub_1B64AF0(0LL);
          sub_1B64998(v33, 0LL);
      ...
      *(_QWORD *)&v32[2 * v26 + 8] = v28;
      sub_1B64814((ServantStatusBattleListViewItem_o *)&v32[v27], (int32_t)v28, v30, v31);
      v25 = *p_bgmVolumeLogs;
      ++v26;
      v27 += 2LL;
      if ( *p_bgmVolumeLogs )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDAB8 & 1) == 0 )
  {
    sub_1B64870(&SoundLogger_TypeInfo, bgmName);
    byte_49FDAB8 = 1;
  }
...
System_String_o *__fastcall SoundLogger__GetLogBgmVolumeDetail(int32_t index, const MethodInfo *method)
{
  ...
  if ( (byte_49FDABD & 1) == 0 )
  {
    sub_1B64870(&SoundLogger_TypeInfo, method);
    sub_1B64870(&StringLiteral_25286/*"秒:ミリ秒  音量1  音量2  BGM名\n"*/, v3);
    ...
    if ( max_length > index )
    {
      ...
      if ( v10 )
      {
        ...
        if ( Instance )
        {
          ...
          return System_String__Concat_61383576((System_String_o *)StringLiteral_25286/*"秒:ミリ秒  音量1  音量2  BGM名\n"*/, v11, 0LL);
        }
      }
LABEL_15:
...
LABEL_12:
  ...
  while ( 1 )
  {
    ...
    if ( v10 )
    {
      result = System_String__Concat_61383576(result, *(System_String_o **)(v10 + 32), 0LL);
      fields = v7[1].fields;
      ++v8;
      if ( fields )
        continue;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDAB4 & 1) == 0 )
  {
    sub_1B64870(&SoundLogger_TypeInfo, info);
    sub_1B64870(&StringLiteral_1/*""*/, v10);
    sub_1B64870(&StringLiteral_24959/*"{0}/{1} {2}"*/, v11);
    byte_49FDAB4 = 1;
  }
  ...
  v15 = System_String__Format_61398016(v12, (Il2CppObject *)cueSheet, (Il2CppObject *)cueName, *static_fields, 0LL);
  if ( !info )
    sub_1B64ACC(v15, v16);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDAB5 & 1) == 0 )
  {
    sub_1B64870(&SoundLogger_TypeInfo, cueName);
    byte_49FDAB5 = 1;
  }
...
SoundLogger_o *__fastcall SoundLogger__get_Instance(const MethodInfo *method)
{
  ...
  {
    v3 = (SoundLogger_o *)sub_1B64ABC(v2);
    ...
    sub_1B64814((ServantStatusBattleListViewItem_o *)&static_fields->instance, (int32_t)v3, v5, v6);
    v2 = SoundLogger_TypeInfo;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDAC2 & 1) == 0 )
  {
    sub_1B64870(&SoundLogger_Info_TypeInfo, *(_QWORD *)&index);
    sub_1B64870(&int_TypeInfo, v5);
    sub_1B64870(&StringLiteral_24965/*"{0}:\n"*/, v6);
    byte_49FDAC2 = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
  this->fields.index = index;
  v7 = (SoundLogger_Info_o *)sub_1B64ABC(SoundLogger_Info_TypeInfo);
  SoundLogger_Info___ctor(v7, 40, v8);
  this->fields.log = v7;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.log, (int32_t)v7, v9, v10);
  v18 = index;
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.last, (int32_t)v15, v16, v17);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDAC3 & 1) == 0 )
  {
    sub_1B64870(&System_DateTime_TypeInfo, bgmName);
    sub_1B64870(&int_TypeInfo, v11);
    sub_1B64870(&float_TypeInfo, v12);
    sub_1B64870(&StringLiteral_117/*" "*/, v13);
    sub_1B64870(&StringLiteral_352/*" {1} {2}{0}"*/, v14);
    sub_1B64870(&StringLiteral_1/*""*/, v15);
    sub_1B64870(&StringLiteral_23377/*"ss:fff"*/, v16);
    sub_1B64870(&StringLiteral_24980/*"{0}:{1}\n"*/, v17);
    byte_49FDAC3 = 1;
  }
  dateData = 0LL;
  if ( bgmName )
    v18 = (Il2CppObject *)System_String__Concat_61383576((System_String_o *)StringLiteral_117/*" "*/, bgmName, 0LL);
  else
  ...
  v24 = System_String__Format_61398016((System_String_o *)StringLiteral_352/*" {1} {2}{0}"*/, v18, v19, v23, 0LL);
  log = this->fields.log;
  v26 = v24;
  ...
  v27 = System_DateTime__ToString_62074212(v42, (System_String_o *)StringLiteral_23377/*"ss:fff"*/, 0LL);
  if ( !v27
    || (v29 = System_String__PadRight(v27, 6, 0x30u, 0LL), v27 = System_String__Concat_61383576(v29, v26, 0LL), !log) )
  {
    sub_1B64ACC(v27, v28);
  }
  ...
  v35 = System_String__Format_61397948((System_String_o *)StringLiteral_24980/*"{0}:{1}\n"*/, v34, (Il2CppObject *)v26, 0LL);
  this->fields.last = v35;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.last, (int32_t)v35, v36, v37);
}
...
void __fastcall SoundLogger_Info___ctor(SoundLogger_Info_o *this, int32_t maxBuff, const MethodInfo *method)
{
  ...
  if ( (byte_49FDABF & 1) == 0 )
  {
    sub_1B64870(&System_Text_StringBuilder_TypeInfo, *(_QWORD *)&maxBuff);
    sub_1B64870(&string___TypeInfo, v5);
    sub_1B64870(&StringLiteral_937/*"--------"*/, v6);
    byte_49FDABF = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
  this->fields.maxNum = maxBuff;
  v7 = (struct System_String_array *)sub_1B64918(string___TypeInfo, (unsigned int)maxBuff);
  this->fields.buff = v7;
  p_fields = &this->fields;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)v7, v9, v10);
  if ( maxBuff >= 1 )
  {
    v15 = 0LL;
    v16 = 32LL;
    do
    {
      ...
      *(Il2CppClass **)((char *)&buff->obj.klass + v16) = (Il2CppClass *)StringLiteral_937/*"--------"*/;
      sub_1B64814((ServantStatusBattleListViewItem_o *)((char *)buff + v16), v18, v13, v14);
      ++v15;
      v16 += 8LL;
    }
    while ( maxBuff != v15 );
  ...
  this->fields.sb = v19;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.sb, (int32_t)v19, v20, v21);
}
...
System_String_o *__fastcall SoundLogger_Info__ToString(SoundLogger_Info_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FDAC0 & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_937/*"--------"*/, v4);
    sub_1B64870(&StringLiteral_1862/*">"*/, v5);
    byte_49FDAC0 = 1;
  }
  ...
  if ( currentIndex > currentIndex - maxNum )
  {
    ...
    while ( 1 )
    {
      ...
      sb = System_Text_StringBuilder__Append_60545472(sb, *v10, 0LL);
      buff = this->fields.buff;
      if ( !buff )
        break;
      v12 = (maxNum & (v9 >> 31)) + v9;
      if ( v12 >= buff->max_length )
        sub_1B64AD4(sb, method);
      sb = this->fields.sb;
      if ( !sb )
        break;
      System_Text_StringBuilder__Append_60545472(sb, buff->m_Items[v12], 0LL);
      sb = this->fields.sb;
      if ( !sb )
        break;
      System_Text_StringBuilder__Append_60545472(sb, (System_String_o *)StringLiteral_43/*"\n"*/, 0LL);
      currentIndex = this->fields.currentIndex;
      maxNum = this->fields.maxNum;
...
void __fastcall SoundLogger_Info__add(SoundLogger_Info_o *this, System_String_o *name, const MethodInfo *method)
{
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)(v6 + 4), (int32_t)name, (int32_t)method, v3);
}
...
bool __fastcall SoundLogger_Info__checkPlayLogLatest(SoundLogger_Info_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FDAC1 & 1) == 0 )
  {
    this = (SoundLogger_Info_o *)sub_1B64870(&SoundLogger_TypeInfo, method);
    byte_49FDAC1 = 1;
  }
...
LABEL_11:
  ...
  return System_String__LastIndexOf_61416908(v5, SoundLogger_TypeInfo->static_fields->WORD_NG, 0LL) == -1;
}