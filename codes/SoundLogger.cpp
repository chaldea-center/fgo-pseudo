void SoundLogger___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CB585A & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_1480/*":NG"*/);
    byte_4CB585A = 1;
  }
  SoundLogger_TypeInfo->static_fields->WORD_NG = (struct System_String_o *)StringLiteral_1480/*":NG"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)SoundLogger_TypeInfo->static_fields, StringLiteral_1480/*":NG"*/, v1, v2);
}
...
void SoundLogger___ctor(SoundLogger_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB584F & 1) == 0 )
  {
    sub_1C6BA08(&SoundLogger_BgmDetailInfo___TypeInfo);
    sub_1C6BA08(&SoundLogger_BgmDetailInfo_TypeInfo);
    sub_1C6BA08(&BgmManager_TypeInfo);
    sub_1C6BA08(&SoundLogger_Info_TypeInfo);
    byte_4CB584F = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0);
  v3 = (SoundLogger_Info_o *)sub_1C6BC54(SoundLogger_Info_TypeInfo);
  SoundLogger_Info___ctor(v3, 2, v4);
  this->fields.bgmLog = v3;
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields, (int32_t)v3, v5, v6);
  v7 = (SoundLogger_Info_o *)sub_1C6BC54(SoundLogger_Info_TypeInfo);
  SoundLogger_Info___ctor(v7, 5, v8);
  this->fields.voiceLog = v7;
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.voiceLog, (int32_t)v7, v9, v10);
  v11 = (SoundLogger_Info_o *)sub_1C6BC54(SoundLogger_Info_TypeInfo);
  SoundLogger_Info___ctor(v11, 16, v12);
  this->fields.seLog = v11;
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.seLog, (int32_t)v11, v13, v14);
  ...
  v16 = (struct SoundLogger_BgmDetailInfo_array *)sub_1C6BAB0(
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)p_bgmDetailLogs, (int32_t)v16, v18, v19);
  v22 = *p_bgmDetailLogs;
  if ( !*p_bgmDetailLogs )
LABEL_13:
    sub_1C6BC60(v20, v21);
  ...
  {
    v25 = (SoundLogger_BgmDetailInfo_o *)sub_1C6BC54(SoundLogger_BgmDetailInfo_TypeInfo);
    ...
    if ( *p_bgmDetailLogs )
    {
      if ( v25 )
      {
        v20 = sub_1C6BB44(v25, *(_QWORD *)(*(_QWORD *)v29 + 64LL));
        if ( !v20 )
        {
          v30 = sub_1C6BC84(0);
          sub_1C6BB30(v30, 0);
      ...
      *(_QWORD *)&v29[2 * v23 + 8] = v25;
      sub_1C6B9AC((CGThumbnailListItem_o *)&v29[v24], (int32_t)v25, v27, v28);
      v22 = *p_bgmDetailLogs;
      ++v23;
      v24 += 2;
      if ( *p_bgmDetailLogs )
...
System_String_o *SoundLogger__GetLogBgmDetail(int32_t index, const MethodInfo *method)
{
  ...
  {
    sub_1C6BA08(&SoundLogger_TypeInfo);
    sub_1C6BA08(&StringLiteral_25612/*"秒(切り捨て)  操作      内容\n"*/);
    ...
    if ( max_length > index )
    {
      ...
      if ( v8 )
      {
        ...
        if ( Instance )
        {
          ...
          return System_String__Concat_63966792((System_String_o *)StringLiteral_25612/*"秒(切り捨て)  操作      内容\n"*/, v9, 0);
        }
      }
LABEL_15:
...
LABEL_12:
  ...
  while ( 1 )
  {
    ...
    if ( v8 )
    {
      result = System_String__Concat_63966792(result, *(System_String_o **)(v8 + 32), 0);
      fields = v5[1].fields;
      ++v6;
      if ( fields )
        continue;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB5850 & 1) == 0 )
  {
    sub_1C6BA08(&SoundLogger_TypeInfo);
    sub_1C6BA08(&StringLiteral_1/*""*/);
    sub_1C6BA08(&StringLiteral_25267/*"{0}/{1} {2}"*/);
    byte_4CB5850 = 1;
  }
  v10 = (System_String_o *)StringLiteral_25267/*"{0}/{1} {2}"*/;
  if ( isValid )
  {
  ...
  v13 = System_String__Format_64008168(v10, (Il2CppObject *)cueSheet, (Il2CppObject *)cueName, *static_fields, 0);
  if ( !info )
    sub_1C6BC60(v13, v14);
...
SoundLogger_o *SoundLogger__get_Instance(const MethodInfo *method)
{
  ...
  {
    v2 = (SoundLogger_o *)sub_1C6BC54(v1);
...
void SoundLogger_BgmDetailInfo___ctor(SoundLogger_BgmDetailInfo_o *this, int32_t index, const MethodInfo *method)
{
  ...
  if ( (byte_4CB585E & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_25273/*"{0}:\n"*/);
    byte_4CB585E = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0);
  this->fields.index = index;
  v5 = (SoundLogger_Info_o *)sub_1C6BC54(SoundLogger_Info_TypeInfo);
  SoundLogger_Info___ctor(v5, 40, v6);
  this->fields.log = v5;
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.log, (int32_t)v5, v7, v8);
  v13 = index;
  v9 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v13);
  v10 = System_String__Format((System_String_o *)StringLiteral_25273/*"{0}:\n"*/, v9, 0);
  this->fields.last = v10;
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.last, (int32_t)v10, v11, v12);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C6BA08(&int_TypeInfo);
    sub_1C6BA08(&StringLiteral_25279/*"{0}: {1}\n"*/);
    this = (SoundLogger_BgmDetailInfo_o *)sub_1C6BA08(&StringLiteral_25243/*"{0} {1}"*/);
    byte_4CB585F = 1;
  }
  ...
  if ( opt )
  {
    ...
    v5 = System_String__Concat_63966792(v10, opt, 0);
  }
  log = v6->fields.log;
  TimeString = System_String__Format_64008100((System_String_o *)StringLiteral_25243/*"{0} {1}"*/, v9, (Il2CppObject *)v5, 0);
  if ( !log )
LABEL_8:
    sub_1C6BC60(TimeString, v8);
  SoundLogger_Info__add(log, TimeString, v12);
  index = v6->fields.index;
  v13 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &index);
  v14 = System_String__Format_64008100((System_String_o *)StringLiteral_25279/*"{0}: {1}\n"*/, v13, (Il2CppObject *)v5, 0);
  v6->fields.last = v14;
  sub_1C6B9AC((CGThumbnailListItem_o *)&v6->fields.last, (int32_t)v14, v15, v16);
}
...
System_String_o *SoundLogger_BgmDetailInfo__GetTimeString(SoundLogger_BgmDetailInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB5860 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_25169/*"{0:00.000}"*/);
    byte_4CB5860 = 1;
  }
  unscaledTime = UnityEngine_Time__get_unscaledTime(0);
  v2 = (Il2CppObject *)j_il2cpp_value_box_0(float_TypeInfo, &unscaledTime);
  result = System_String__Format((System_String_o *)StringLiteral_25169/*"{0:00.000}"*/, v2, 0);
  if ( !result )
    sub_1C6BC60(0, v4);
  stringLength = result->fields._stringLength;
  if ( stringLength >= 7 )
    return System_String__Substring_64012732(result, stringLength - 6, 6, 0);
  return result;
}
  ...
  if ( maxBuff >= 1 )
  {
    ...
    do
    {
      ...
      if ( v13 >= LODWORD(buff->max_length) )
        sub_1C6BC68(v9);
      v16 = StringLiteral_874/*"--------"*/;
      *(Il2CppClass **)((char *)&buff->obj.klass + v14) = (Il2CppClass *)StringLiteral_874/*"--------"*/;
      sub_1C6B9AC((CGThumbnailListItem_o *)((char *)buff + v14), v16, v11, v12);
      ++v13;
      v14 += 8;
    }
    while ( maxBuff != v13 );
...
bool SoundLogger_Info__checkPlayLogLatest(SoundLogger_Info_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB585D & 1) == 0 )
  {
    this = (SoundLogger_Info_o *)sub_1C6BA08(&SoundLogger_TypeInfo);
    byte_4CB585D = 1;
  }
...
LABEL_11:
  ...
  return System_String__LastIndexOf_64026948(v5, SoundLogger_TypeInfo->static_fields->WORD_NG, 0) == -1;
}