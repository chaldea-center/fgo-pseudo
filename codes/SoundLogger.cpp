void SoundLogger___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4D2BDDF & 1) == 0 )
  {
    sub_1C94098(&SoundLogger_TypeInfo);
    sub_1C94098(&StringLiteral_1481/*":NG"*/);
    byte_4D2BDDF = 1;
  }
  SoundLogger_TypeInfo->static_fields->WORD_NG = (struct System_String_o *)StringLiteral_1481/*":NG"*/;
  sub_1C9403C(
    (GrandQuestFolderBoardItem_o *)SoundLogger_TypeInfo->static_fields,
    StringLiteral_1481/*":NG"*/,
    v1,
    v2,
    v3,
    v4,
...
void SoundLogger___ctor(SoundLogger_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2BDD4 & 1) == 0 )
  {
    sub_1C94098(&SoundLogger_BgmDetailInfo___TypeInfo);
    sub_1C94098(&SoundLogger_BgmDetailInfo_TypeInfo);
    sub_1C94098(&BgmManager_TypeInfo);
    sub_1C94098(&SoundLogger_Info_TypeInfo);
    byte_4D2BDD4 = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0);
  v3 = (SoundLogger_Info_o *)sub_1C942E4(SoundLogger_Info_TypeInfo);
  ...
  v11 = (SoundLogger_Info_o *)sub_1C942E4(SoundLogger_Info_TypeInfo);
  SoundLogger_Info___ctor(v11, 5, v12);
  this->fields.voiceLog = v11;
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.voiceLog, (int32_t)v11, v13, v14, v15, v16, v17, v18);
  v19 = (SoundLogger_Info_o *)sub_1C942E4(SoundLogger_Info_TypeInfo);
  SoundLogger_Info___ctor(v19, 16, v20);
  this->fields.seLog = v19;
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.seLog, (int32_t)v19, v21, v22, v23, v24, v25, v26);
  ...
  v28 = (struct SoundLogger_BgmDetailInfo_array *)sub_1C94140(
  ...
  sub_1C9403C((GrandQuestFolderBoardItem_o *)p_bgmDetailLogs, (int32_t)v28, v30, v31, v32, v33, v34, v35);
  v38 = *p_bgmDetailLogs;
  if ( !*p_bgmDetailLogs )
LABEL_13:
    sub_1C942F0(v36, v37);
  ...
  {
    v41 = (SoundLogger_BgmDetailInfo_o *)sub_1C942E4(SoundLogger_BgmDetailInfo_TypeInfo);
    ...
    if ( *p_bgmDetailLogs )
    {
      if ( v41 )
      {
        v36 = sub_1C941D4(v41, *(_QWORD *)(*(_QWORD *)v49 + 64LL));
        if ( !v36 )
        {
          v50 = sub_1C94314(0);
          sub_1C941C0(v50, 0);
      ...
      *(_QWORD *)&v49[2 * v39 + 8] = v41;
      sub_1C9403C((GrandQuestFolderBoardItem_o *)&v49[v40], (int32_t)v41, v43, v44, v45, v46, v47, v48);
      v38 = *p_bgmDetailLogs;
      ++v39;
      v40 += 2;
      if ( *p_bgmDetailLogs )
...
System_String_o *SoundLogger__GetLogBgmDetail(int32_t index, const MethodInfo *method)
{
  ...
  {
    sub_1C94098(&SoundLogger_TypeInfo);
    sub_1C94098(&StringLiteral_25755/*"秒(切り捨て)  操作      内容\n"*/);
    ...
    if ( max_length > index )
    {
      ...
      if ( v8 )
      {
        ...
        if ( Instance )
        {
          ...
          return System_String__Concat_64417744((System_String_o *)StringLiteral_25755/*"秒(切り捨て)  操作      内容\n"*/, v9, 0);
        }
      }
LABEL_15:
...
LABEL_12:
  ...
  while ( 1 )
  {
    ...
    if ( v8 )
    {
      result = System_String__Concat_64417744(result, *(System_String_o **)(v8 + 32), 0);
      fields = v5[1].fields;
      ++v6;
      if ( fields )
        continue;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2BDD5 & 1) == 0 )
  {
    sub_1C94098(&SoundLogger_TypeInfo);
    sub_1C94098(&StringLiteral_1/*""*/);
    sub_1C94098(&StringLiteral_25410/*"{0}/{1} {2}"*/);
    byte_4D2BDD5 = 1;
  }
  v10 = (System_String_o *)StringLiteral_25410/*"{0}/{1} {2}"*/;
  if ( isValid )
  {
  ...
  v13 = System_String__Format_64459120(v10, (Il2CppObject *)cueSheet, (Il2CppObject *)cueName, *static_fields, 0);
  if ( !info )
    sub_1C942F0(v13, v14);
...
SoundLogger_o *SoundLogger__get_Instance(const MethodInfo *method)
{
  ...
  {
    v2 = (SoundLogger_o *)sub_1C942E4(v1);
    ...
    sub_1C9403C((GrandQuestFolderBoardItem_o *)&static_fields->instance, (int32_t)v2, v4, v5, v6, v7, v8, v9);
    v1 = SoundLogger_TypeInfo;
  }
...
void SoundLogger_BgmDetailInfo___ctor(SoundLogger_BgmDetailInfo_o *this, int32_t index, const MethodInfo *method)
{
  ...
  if ( (byte_4D2BDE3 & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_25416/*"{0}:\n"*/);
    byte_4D2BDE3 = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0);
  this->fields.index = index;
  v5 = (SoundLogger_Info_o *)sub_1C942E4(SoundLogger_Info_TypeInfo);
  SoundLogger_Info___ctor(v5, 40, v6);
  this->fields.log = v5;
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.log, (int32_t)v5, v7, v8, v9, v10, v11, v12);
  v21 = index;
  v13 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v21);
  v14 = System_String__Format((System_String_o *)StringLiteral_25416/*"{0}:\n"*/, v13, 0);
  this->fields.last = v14;
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.last, (int32_t)v14, v15, v16, v17, v18, v19, v20);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C94098(&int_TypeInfo);
    sub_1C94098(&StringLiteral_25422/*"{0}: {1}\n"*/);
    this = (SoundLogger_BgmDetailInfo_o *)sub_1C94098(&StringLiteral_25386/*"{0} {1}"*/);
    byte_4D2BDE4 = 1;
  }
  ...
  if ( opt )
  {
    ...
    v5 = System_String__Concat_64417744(v10, opt, 0);
  }
  log = v6->fields.log;
  TimeString = System_String__Format_64459052((System_String_o *)StringLiteral_25386/*"{0} {1}"*/, v9, (Il2CppObject *)v5, 0);
  if ( !log )
LABEL_8:
    sub_1C942F0(TimeString, v8);
  SoundLogger_Info__add(log, TimeString, v12);
  index = v6->fields.index;
  v13 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &index);
  v14 = System_String__Format_64459052((System_String_o *)StringLiteral_25422/*"{0}: {1}\n"*/, v13, (Il2CppObject *)v5, 0);
  v6->fields.last = v14;
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&v6->fields.last, (int32_t)v14, v15, v16, v17, v18, v19, v20);
}
...
System_String_o *SoundLogger_BgmDetailInfo__GetTimeString(SoundLogger_BgmDetailInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2BDE5 & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_25311/*"{0:00.000}"*/);
    byte_4D2BDE5 = 1;
  }
  unscaledTime = UnityEngine_Time__get_unscaledTime(0);
  v2 = (Il2CppObject *)j_il2cpp_value_box_0(float_TypeInfo, &unscaledTime);
  result = System_String__Format((System_String_o *)StringLiteral_25311/*"{0:00.000}"*/, v2, 0);
  if ( !result )
    sub_1C942F0(0, v4);
  stringLength = result->fields._stringLength;
  if ( stringLength >= 7 )
    return System_String__Substring_64463684(result, stringLength - 6, 6, 0);
  return result;
}
...
void SoundLogger_Info___ctor(SoundLogger_Info_o *this, int32_t maxBuff, const MethodInfo *method)
{
  ...
  if ( (byte_4D2BDE0 & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_874/*"--------"*/);
    byte_4D2BDE0 = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0);
  this->fields.maxNum = maxBuff;
  v5 = (struct System_String_array *)sub_1C94140(string___TypeInfo, (unsigned int)maxBuff);
  this->fields.buff = v5;
  ...
  if ( maxBuff >= 1 )
  {
    ...
    do
    {
      ...
      if ( v21 >= LODWORD(buff->max_length) )
        sub_1C942F8(v13);
      v24 = StringLiteral_874/*"--------"*/;
      *(Il2CppClass **)((char *)&buff->obj.klass + v22) = (Il2CppClass *)StringLiteral_874/*"--------"*/;
      sub_1C9403C((GrandQuestFolderBoardItem_o *)((char *)buff + v22), v24, v15, v16, v17, v18, v19, v20);
      ++v21;
      v22 += 8;
    }
    while ( maxBuff != v21 );
  ...
  this->fields.sb = v25;
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.sb, (int32_t)v25, v26, v27, v28, v29, v30, v31);
}
...
System_String_o *SoundLogger_Info__ToString(SoundLogger_Info_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.currentIndex == -1 )
    return (System_String_o *)StringLiteral_874/*"--------"*/;
  sb = this->fields.sb;
  if ( !sb )
    goto LABEL_19;
  ...
  if ( currentIndex > currentIndex - maxNum )
  {
    ...
    while ( 1 )
    {
      ...
      sb = System_Text_StringBuilder__Append_64501704(sb, *v7, 0);
      ...
      if ( !sb )
        break;
      System_Text_StringBuilder__Append_64501704(sb, buff->m_Items[v9], 0);
      sb = this->fields.sb;
      if ( !sb )
        break;
      System_Text_StringBuilder__Append_64501704(sb, (System_String_o *)StringLiteral_43/*"\n"*/, 0);
      currentIndex = this->fields.currentIndex;
      maxNum = this->fields.maxNum;
...
void SoundLogger_Info__add(SoundLogger_Info_o *this, System_String_o *name, const MethodInfo *method)
{
  ...
  sub_1C9403C((GrandQuestFolderBoardItem_o *)(v10 + 4), (int32_t)name, (int32_t)method, v3, v4, v5, v6, v7);
}
...
bool SoundLogger_Info__checkPlayLogLatest(SoundLogger_Info_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2BDE2 & 1) == 0 )
  {
    this = (SoundLogger_Info_o *)sub_1C94098(&SoundLogger_TypeInfo);
    byte_4D2BDE2 = 1;
  }
...
LABEL_11:
  ...
  return System_String__LastIndexOf_64477900(v5, SoundLogger_TypeInfo->static_fields->WORD_NG, 0) == -1;
}