void SoundLogger___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C562F3 & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_1487/*":NG"*/);
    byte_4C562F3 = 1;
  }
  SoundLogger_TypeInfo->static_fields->WORD_NG = (struct System_String_o *)StringLiteral_1487/*":NG"*/;
  sub_1C3E508((CGThumbnailListItem_o *)SoundLogger_TypeInfo->static_fields, StringLiteral_1487/*":NG"*/, v1, v2);
}
...
void SoundLogger___ctor(SoundLogger_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C562E8 & 1) == 0 )
  {
    sub_1C3E564(&SoundLogger_BgmDetailInfo___TypeInfo);
    sub_1C3E564(&SoundLogger_BgmDetailInfo_TypeInfo);
    sub_1C3E564(&BgmManager_TypeInfo);
    sub_1C3E564(&SoundLogger_Info_TypeInfo);
    byte_4C562E8 = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0);
  v3 = (SoundLogger_Info_o *)sub_1C3E7B0(SoundLogger_Info_TypeInfo);
  SoundLogger_Info___ctor(v3, 2, v4);
  this->fields.bgmLog = v3;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields, (int32_t)v3, v5, v6);
  v7 = (SoundLogger_Info_o *)sub_1C3E7B0(SoundLogger_Info_TypeInfo);
  SoundLogger_Info___ctor(v7, 5, v8);
  this->fields.voiceLog = v7;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.voiceLog, (int32_t)v7, v9, v10);
  v11 = (SoundLogger_Info_o *)sub_1C3E7B0(SoundLogger_Info_TypeInfo);
  SoundLogger_Info___ctor(v11, 16, v12);
  this->fields.seLog = v11;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.seLog, (int32_t)v11, v13, v14);
  ...
  v16 = (struct SoundLogger_BgmDetailInfo_array *)sub_1C3E60C(
  ...
  sub_1C3E508((CGThumbnailListItem_o *)p_bgmDetailLogs, (int32_t)v16, v18, v19);
  v22 = *p_bgmDetailLogs;
  if ( !*p_bgmDetailLogs )
LABEL_13:
    sub_1C3E7C0(v20, v21);
  ...
  {
    v25 = (SoundLogger_BgmDetailInfo_o *)sub_1C3E7B0(SoundLogger_BgmDetailInfo_TypeInfo);
    ...
    if ( *p_bgmDetailLogs )
    {
      if ( v25 )
      {
        v20 = sub_1C3E6A0(v25, *(_QWORD *)(*(_QWORD *)v29 + 64LL));
        if ( !v20 )
        {
          v30 = sub_1C3E7E4(0);
          sub_1C3E68C(v30, 0);
      ...
      *(_QWORD *)&v29[2 * v23 + 8] = v25;
      sub_1C3E508((CGThumbnailListItem_o *)&v29[v24], (int32_t)v25, v27, v28);
      v22 = *p_bgmDetailLogs;
      ++v23;
      v24 += 2;
      if ( *p_bgmDetailLogs )
...
System_String_o *SoundLogger__GetLogBgmDetail(int32_t index, const MethodInfo *method)
{
  ...
  {
    sub_1C3E564(&SoundLogger_TypeInfo);
    sub_1C3E564(&StringLiteral_25522/*"秒(切り捨て)  操作      内容\n"*/);
    ...
    if ( max_length > index )
    {
      ...
      if ( v8 )
      {
        ...
        if ( Instance )
        {
          ...
          return System_String__Concat_63636468((System_String_o *)StringLiteral_25522/*"秒(切り捨て)  操作      内容\n"*/, v9, 0);
        }
      }
LABEL_15:
...
LABEL_12:
  ...
  while ( 1 )
  {
    ...
    if ( v8 )
    {
      result = System_String__Concat_63636468(result, *(System_String_o **)(v8 + 32), 0);
      fields = v5[1].fields;
      ++v6;
      if ( fields )
        continue;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C562E9 & 1) == 0 )
  {
    sub_1C3E564(&SoundLogger_TypeInfo);
    sub_1C3E564(&StringLiteral_1/*""*/);
    sub_1C3E564(&StringLiteral_25177/*"{0}/{1} {2}"*/);
    byte_4C562E9 = 1;
  }
  v10 = (System_String_o *)StringLiteral_25177/*"{0}/{1} {2}"*/;
  if ( isValid )
  {
  ...
  v13 = System_String__Format_63677828(v10, (Il2CppObject *)cueSheet, (Il2CppObject *)cueName, *static_fields, 0);
  if ( !info )
    sub_1C3E7C0(v13, v14);
...
SoundLogger_o *SoundLogger__get_Instance(const MethodInfo *method)
{
  ...
  {
    v2 = (SoundLogger_o *)sub_1C3E7B0(v1);
    ...
    sub_1C3E508((CGThumbnailListItem_o *)&static_fields->instance, (int32_t)v2, v4, v5);
    v1 = SoundLogger_TypeInfo;
  }
...
void SoundLogger_BgmDetailInfo___ctor(SoundLogger_BgmDetailInfo_o *this, int32_t index, const MethodInfo *method)
{
  ...
  if ( (byte_4C562F7 & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_25183/*"{0}:\n"*/);
    byte_4C562F7 = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0);
  this->fields.index = index;
  v5 = (SoundLogger_Info_o *)sub_1C3E7B0(SoundLogger_Info_TypeInfo);
  SoundLogger_Info___ctor(v5, 40, v6);
  this->fields.log = v5;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.log, (int32_t)v5, v7, v8);
  v19 = index;
  v15 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v19, v9, v10, v11, v12, v13, v14);
  v16 = System_String__Format((System_String_o *)StringLiteral_25183/*"{0}:\n"*/, v15, 0);
  this->fields.last = v16;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.last, (int32_t)v16, v17, v18);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C3E564(&int_TypeInfo);
    sub_1C3E564(&StringLiteral_25189/*"{0}: {1}\n"*/);
    this = (SoundLogger_BgmDetailInfo_o *)sub_1C3E564(&StringLiteral_25153/*"{0} {1}"*/);
    byte_4C562F8 = 1;
  }
  ...
  if ( opt )
  {
    ...
    v5 = System_String__Concat_63636468(v10, opt, 0);
  }
  log = v6->fields.log;
  TimeString = System_String__Format_63677760((System_String_o *)StringLiteral_25153/*"{0} {1}"*/, v9, (Il2CppObject *)v5, 0);
  if ( !log )
LABEL_8:
    sub_1C3E7C0(TimeString, v8);
  SoundLogger_Info__add(log, TimeString, v12);
  index = v6->fields.index;
  v19 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &index, v13, v14, v15, v16, v17, v18);
  v20 = System_String__Format_63677760((System_String_o *)StringLiteral_25189/*"{0}: {1}\n"*/, v19, (Il2CppObject *)v5, 0);
  v6->fields.last = v20;
  sub_1C3E508((CGThumbnailListItem_o *)&v6->fields.last, (int32_t)v20, v21, v22);
}
...
System_String_o *SoundLogger_BgmDetailInfo__GetTimeString(SoundLogger_BgmDetailInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C562F9 & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_25079/*"{0:00.000}"*/);
    byte_4C562F9 = 1;
  }
  ...
  result = System_String__Format((System_String_o *)StringLiteral_25079/*"{0:00.000}"*/, v8, 0);
  if ( !result )
    sub_1C3E7C0(0, v10);
  stringLength = result->fields._stringLength;
  if ( stringLength >= 7 )
    return System_String__Substring_63682392(result, stringLength - 6, 6, 0);
  return result;
}
...
void SoundLogger_Info___ctor(SoundLogger_Info_o *this, int32_t maxBuff, const MethodInfo *method)
{
  ...
  if ( (byte_4C562F4 & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_877/*"--------"*/);
    byte_4C562F4 = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0);
  this->fields.maxNum = maxBuff;
  v5 = (struct System_String_array *)sub_1C3E60C(string___TypeInfo, (unsigned int)maxBuff);
  this->fields.buff = v5;
  ...
  if ( maxBuff >= 1 )
  {
    ...
    do
    {
      ...
      *(Il2CppClass **)((char *)&buff->obj.klass + v14) = (Il2CppClass *)StringLiteral_877/*"--------"*/;
      sub_1C3E508((CGThumbnailListItem_o *)((char *)buff + v14), v16, v11, v12);
      ++v13;
      v14 += 8;
    }
    while ( maxBuff != v13 );
  ...
  v17 = (System_Text_StringBuilder_o *)sub_1C3E7B0(System_Text_StringBuilder_TypeInfo);
  System_Text_StringBuilder___ctor(v17, 0);
  this->fields.sb = v17;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.sb, (int32_t)v17, v18, v19);
}
...
System_String_o *SoundLogger_Info__ToString(SoundLogger_Info_o *this, const MethodInfo *method)
{
  ...
  if ( currentIndex > currentIndex - maxNum )
  {
    ...
    while ( 1 )
    {
      ...
      sb = System_Text_StringBuilder__Append_63721532(sb, *v7, 0);
      buff = this->fields.buff;
      if ( !buff )
        break;
      v9 = (maxNum & (v6 >> 31)) + v6;
      if ( v9 >= LODWORD(buff->max_length) )
        sub_1C3E7C8(sb, method);
      sb = this->fields.sb;
      if ( !sb )
        break;
      System_Text_StringBuilder__Append_63721532(sb, buff->m_Items[v9], 0);
      sb = this->fields.sb;
      if ( !sb )
        break;
      System_Text_StringBuilder__Append_63721532(sb, (System_String_o *)StringLiteral_43/*"\n"*/, 0);
      currentIndex = this->fields.currentIndex;
      maxNum = this->fields.maxNum;
...
void SoundLogger_Info__add(SoundLogger_Info_o *this, System_String_o *name, const MethodInfo *method)
{
  ...
  sub_1C3E508((CGThumbnailListItem_o *)(v6 + 4), (int32_t)name, (int32_t)method, v3);
}
...
bool SoundLogger_Info__checkPlayLogLatest(SoundLogger_Info_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C562F6 & 1) == 0 )
  {
    this = (SoundLogger_Info_o *)sub_1C3E564(&SoundLogger_TypeInfo);
    byte_4C562F6 = 1;
  }
...
LABEL_11:
  ...
  return System_String__LastIndexOf_63696608(v5, SoundLogger_TypeInfo->static_fields->WORD_NG, 0) == -1;
}