void SoundLogger___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CC697B & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_1481/*":NG"*/);
    byte_4CC697B = 1;
  }
...
void SoundLogger___ctor(SoundLogger_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC6970 & 1) == 0 )
  {
    sub_1C713B0(&SoundLogger_BgmDetailInfo___TypeInfo);
    sub_1C713B0(&SoundLogger_BgmDetailInfo_TypeInfo);
    sub_1C713B0(&BgmManager_TypeInfo);
    sub_1C713B0(&SoundLogger_Info_TypeInfo);
    byte_4CC6970 = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0);
  v3 = (SoundLogger_Info_o *)sub_1C715FC(SoundLogger_Info_TypeInfo);
  ...
  v11 = (SoundLogger_Info_o *)sub_1C715FC(SoundLogger_Info_TypeInfo);
  SoundLogger_Info___ctor(v11, 5, v12);
  this->fields.voiceLog = v11;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.voiceLog, (int32_t)v11, v13, v14, v15, v16, v17, v18);
  v19 = (SoundLogger_Info_o *)sub_1C715FC(SoundLogger_Info_TypeInfo);
  SoundLogger_Info___ctor(v19, 16, v20);
  this->fields.seLog = v19;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.seLog, (int32_t)v19, v21, v22, v23, v24, v25, v26);
  ...
  v28 = (struct SoundLogger_BgmDetailInfo_array *)sub_1C71458(
  ...
  sub_1C71354((GrandQuestFolderBoardItem_o *)p_bgmDetailLogs, (int32_t)v28, v30, v31, v32, v33, v34, v35);
  v38 = *p_bgmDetailLogs;
  if ( !*p_bgmDetailLogs )
LABEL_13:
    sub_1C71608(v36, v37);
  ...
  {
    v41 = (SoundLogger_BgmDetailInfo_o *)sub_1C715FC(SoundLogger_BgmDetailInfo_TypeInfo);
    ...
    if ( *p_bgmDetailLogs )
    {
      if ( v41 )
      {
        v36 = sub_1C714EC(v41, *(_QWORD *)(*(_QWORD *)v49 + 64LL));
        if ( !v36 )
        {
          v50 = sub_1C7162C(0);
          sub_1C714D8(v50, 0);
      ...
      *(_QWORD *)&v49[2 * v39 + 8] = v41;
      sub_1C71354((GrandQuestFolderBoardItem_o *)&v49[v40], (int32_t)v41, v43, v44, v45, v46, v47, v48);
      v38 = *p_bgmDetailLogs;
      ++v39;
      v40 += 2;
      if ( *p_bgmDetailLogs )
...
System_String_o *SoundLogger__GetLogBgmDetail(int32_t index, const MethodInfo *method)
{
  ...
  {
    sub_1C713B0(&SoundLogger_TypeInfo);
    sub_1C713B0(&StringLiteral_25632/*"秒(切り捨て)  操作      内容\n"*/);
    ...
    if ( max_length > index )
    {
      ...
      if ( v8 )
      {
        ...
        if ( Instance )
        {
          ...
          return System_String__Concat_64031724((System_String_o *)StringLiteral_25632/*"秒(切り捨て)  操作      内容\n"*/, v9, 0);
        }
      }
LABEL_15:
...
LABEL_12:
  ...
  while ( 1 )
  {
    ...
    if ( v8 )
    {
      result = System_String__Concat_64031724(result, *(System_String_o **)(v8 + 32), 0);
      fields = v5[1].fields;
      ++v6;
      if ( fields )
        continue;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC6971 & 1) == 0 )
  {
    sub_1C713B0(&SoundLogger_TypeInfo);
    sub_1C713B0(&StringLiteral_1/*""*/);
    sub_1C713B0(&StringLiteral_25287/*"{0}/{1} {2}"*/);
    byte_4CC6971 = 1;
  }
  v10 = (System_String_o *)StringLiteral_25287/*"{0}/{1} {2}"*/;
  if ( isValid )
  {
  ...
  v13 = System_String__Format_64073100(v10, (Il2CppObject *)cueSheet, (Il2CppObject *)cueName, *static_fields, 0);
  if ( !info )
    sub_1C71608(v13, v14);
...
SoundLogger_o *SoundLogger__get_Instance(const MethodInfo *method)
{
  ...
  {
    v2 = (SoundLogger_o *)sub_1C715FC(v1);
...
void SoundLogger_BgmDetailInfo___ctor(SoundLogger_BgmDetailInfo_o *this, int32_t index, const MethodInfo *method)
{
  ...
  if ( (byte_4CC697F & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_25293/*"{0}:\n"*/);
    byte_4CC697F = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0);
  this->fields.index = index;
  v5 = (SoundLogger_Info_o *)sub_1C715FC(SoundLogger_Info_TypeInfo);
  SoundLogger_Info___ctor(v5, 40, v6);
  this->fields.log = v5;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.log, (int32_t)v5, v7, v8, v9, v10, v11, v12);
  v21 = index;
  v13 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v21);
  v14 = System_String__Format((System_String_o *)StringLiteral_25293/*"{0}:\n"*/, v13, 0);
  this->fields.last = v14;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.last, (int32_t)v14, v15, v16, v17, v18, v19, v20);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C713B0(&int_TypeInfo);
    sub_1C713B0(&StringLiteral_25299/*"{0}: {1}\n"*/);
    this = (SoundLogger_BgmDetailInfo_o *)sub_1C713B0(&StringLiteral_25263/*"{0} {1}"*/);
    byte_4CC6980 = 1;
  }
  ...
  if ( opt )
  {
    ...
    v5 = System_String__Concat_64031724(v10, opt, 0);
  }
  log = v6->fields.log;
  TimeString = System_String__Format_64073032((System_String_o *)StringLiteral_25263/*"{0} {1}"*/, v9, (Il2CppObject *)v5, 0);
  if ( !log )
LABEL_8:
    sub_1C71608(TimeString, v8);
  SoundLogger_Info__add(log, TimeString, v12);
  index = v6->fields.index;
  v13 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &index);
  v14 = System_String__Format_64073032((System_String_o *)StringLiteral_25299/*"{0}: {1}\n"*/, v13, (Il2CppObject *)v5, 0);
  v6->fields.last = v14;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&v6->fields.last, (int32_t)v14, v15, v16, v17, v18, v19, v20);
}
...
System_String_o *SoundLogger_BgmDetailInfo__GetTimeString(SoundLogger_BgmDetailInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC6981 & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_25189/*"{0:00.000}"*/);
    byte_4CC6981 = 1;
  }
  unscaledTime = UnityEngine_Time__get_unscaledTime(0);
  v2 = (Il2CppObject *)j_il2cpp_value_box_0(float_TypeInfo, &unscaledTime);
  result = System_String__Format((System_String_o *)StringLiteral_25189/*"{0:00.000}"*/, v2, 0);
  if ( !result )
    sub_1C71608(0, v4);
  stringLength = result->fields._stringLength;
  if ( stringLength >= 7 )
    return System_String__Substring_64077664(result, stringLength - 6, 6, 0);
  return result;
}
  ...
  if ( maxBuff >= 1 )
  {
    ...
    do
    {
      ...
      *(Il2CppClass **)((char *)&buff->obj.klass + v22) = (Il2CppClass *)StringLiteral_874/*"--------"*/;
      sub_1C71354((GrandQuestFolderBoardItem_o *)((char *)buff + v22), v24, v15, v16, v17, v18, v19, v20);
      ++v21;
      v22 += 8;
    }
    while ( maxBuff != v21 );
...
bool SoundLogger_Info__checkPlayLogLatest(SoundLogger_Info_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC697E & 1) == 0 )
  {
    this = (SoundLogger_Info_o *)sub_1C713B0(&SoundLogger_TypeInfo);
    byte_4CC697E = 1;
  }
...
LABEL_11:
  ...
  return System_String__LastIndexOf_64091880(v5, SoundLogger_TypeInfo->static_fields->WORD_NG, 0) == -1;
}