void __fastcall SoundLogger___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B6612B & 1) == 0 )
  {
    sub_1BE4ACC(&SoundLogger_TypeInfo, v1);
    sub_1BE4ACC(&StringLiteral_1573/*":NG"*/, v8);
    byte_4B6612B = 1;
  }
  SoundLogger_TypeInfo->static_fields->WORD_NG = (struct System_String_o *)StringLiteral_1573/*":NG"*/;
  sub_1BE4A70(
    (PartyOrganizationUtility_o *)SoundLogger_TypeInfo->static_fields,
    StringLiteral_1573/*":NG"*/,
    v2,
    v3,
    v4,
    v5,
...
void __fastcall SoundLogger___ctor(SoundLogger_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B66120 & 1) == 0 )
  {
    sub_1BE4ACC(&SoundLogger_BgmDetailInfo___TypeInfo, method);
    sub_1BE4ACC(&SoundLogger_BgmDetailInfo_TypeInfo, v3);
    sub_1BE4ACC(&BgmManager_TypeInfo, v4);
    sub_1BE4ACC(&SoundLogger_Info_TypeInfo, v5);
    byte_4B66120 = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
  v6 = (SoundLogger_Info_o *)sub_1BE4D18(SoundLogger_Info_TypeInfo);
  SoundLogger_Info___ctor(v6, 2, v7);
  this->fields.bgmLog = v6;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields, (int64_t)v6, v8, v9, v10, v11, v12, v13);
  v14 = (SoundLogger_Info_o *)sub_1BE4D18(SoundLogger_Info_TypeInfo);
  SoundLogger_Info___ctor(v14, 5, v15);
  this->fields.voiceLog = v14;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.voiceLog, (int64_t)v14, v16, v17, v18, v19, v20, v21);
  v22 = (SoundLogger_Info_o *)sub_1BE4D18(SoundLogger_Info_TypeInfo);
  SoundLogger_Info___ctor(v22, 16, v23);
  this->fields.seLog = v22;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.seLog, (int64_t)v22, v24, v25, v26, v27, v28, v29);
  ...
  v31 = (struct SoundLogger_BgmDetailInfo_array *)sub_1BE4B74(
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)p_bgmDetailLogs, (int64_t)v31, v33, v34, v35, v36, v37, v38);
  v41 = *p_bgmDetailLogs;
  if ( !*p_bgmDetailLogs )
LABEL_13:
    sub_1BE4D28(v39, v40);
  ...
  {
    v44 = (SoundLogger_BgmDetailInfo_o *)sub_1BE4D18(SoundLogger_BgmDetailInfo_TypeInfo);
    ...
    if ( *p_bgmDetailLogs )
    {
      if ( v44 )
      {
        v39 = sub_1BE4C08(v44, *(_QWORD *)(*(_QWORD *)v52 + 64LL));
        if ( !v39 )
        {
          v53 = sub_1BE4D4C(0LL);
          sub_1BE4BF4(v53, 0LL);
      ...
      *(_QWORD *)&v52[2 * v42 + 8] = v44;
      sub_1BE4A70((PartyOrganizationUtility_o *)&v52[v43], (int64_t)v44, v46, v47, v48, v49, v50, v51);
      v41 = *p_bgmDetailLogs;
      ++v42;
      v43 += 2LL;
      if ( *p_bgmDetailLogs )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B66125 & 1) == 0 )
  {
    sub_1BE4ACC(&SoundLogger_TypeInfo, actionName);
    byte_4B66125 = 1;
  }
...
System_String_o *__fastcall SoundLogger__GetLogBgmDetail(int32_t index, const MethodInfo *method)
{
  ...
  if ( (byte_4B6612A & 1) == 0 )
  {
    sub_1BE4ACC(&SoundLogger_TypeInfo, method);
    sub_1BE4ACC(&StringLiteral_25733/*"秒(切り捨て)  操作      内容\n"*/, v3);
    ...
    if ( max_length > index )
    {
      ...
      if ( v10 )
      {
        ...
        if ( Instance )
        {
          ...
          return System_String__Concat_62698808((System_String_o *)StringLiteral_25733/*"秒(切り捨て)  操作      内容\n"*/, v11, 0LL);
        }
      }
LABEL_15:
...
LABEL_12:
  ...
  while ( 1 )
  {
    ...
    if ( v10 )
    {
      result = System_String__Concat_62698808(result, *(System_String_o **)(v10 + 32), 0LL);
      fields = v7[1].fields;
      ++v8;
      if ( fields )
        continue;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B66121 & 1) == 0 )
  {
    sub_1BE4ACC(&SoundLogger_TypeInfo, info);
    sub_1BE4ACC(&StringLiteral_1/*""*/, v10);
    sub_1BE4ACC(&StringLiteral_25399/*"{0}/{1} {2}"*/, v11);
    byte_4B66121 = 1;
  }
  v12 = (System_String_o *)StringLiteral_25399/*"{0}/{1} {2}"*/;
  if ( isValid )
  {
  ...
  v15 = System_String__Format_62713248(v12, (Il2CppObject *)cueSheet, (Il2CppObject *)cueName, *static_fields, 0LL);
  if ( !info )
    sub_1BE4D28(v15, v16);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B66122 & 1) == 0 )
  {
    sub_1BE4ACC(&SoundLogger_TypeInfo, cueName);
    byte_4B66122 = 1;
  }
  v7 = SoundLogger_TypeInfo;
  if ( !SoundLogger_TypeInfo->_2.cctor_finished )
...
SoundLogger_o *__fastcall SoundLogger__get_Instance(const MethodInfo *method)
{
  ...
  {
    v3 = (SoundLogger_o *)sub_1BE4D18(v2);
    ...
    sub_1BE4A70((PartyOrganizationUtility_o *)&static_fields->instance, (int64_t)v3, v5, v6, v7, v8, v9, v10);
    v2 = SoundLogger_TypeInfo;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6612F & 1) == 0 )
  {
    sub_1BE4ACC(&SoundLogger_Info_TypeInfo, *(_QWORD *)&index);
    sub_1BE4ACC(&int_TypeInfo, v5);
    sub_1BE4ACC(&StringLiteral_25405/*"{0}:\n"*/, v6);
    byte_4B6612F = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
  this->fields.index = index;
  v7 = (SoundLogger_Info_o *)sub_1BE4D18(SoundLogger_Info_TypeInfo);
  SoundLogger_Info___ctor(v7, 40, v8);
  this->fields.log = v7;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.log, (int64_t)v7, v9, v10, v11, v12, v13, v14);
  v26 = index;
  v18 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v26, v15, v16, v17);
  v19 = System_String__Format((System_String_o *)StringLiteral_25405/*"{0}:\n"*/, v18, 0LL);
  this->fields.last = v19;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.last, (int64_t)v19, v20, v21, v22, v23, v24, v25);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B66130 & 1) == 0 )
  {
    sub_1BE4ACC(&int_TypeInfo, actionName);
    sub_1BE4ACC(&StringLiteral_25411/*"{0}: {1}\n"*/, v7);
    this = (SoundLogger_BgmDetailInfo_o *)sub_1BE4ACC(&StringLiteral_25361/*"{0} {1}"*/, v8);
    byte_4B66130 = 1;
  }
  ...
  if ( opt )
  {
    ...
    v5 = System_String__Concat_62698808(v12, opt, 0LL);
  }
  log = v6->fields.log;
  TimeString = System_String__Format_62713180((System_String_o *)StringLiteral_25361/*"{0} {1}"*/, v11, (Il2CppObject *)v5, 0LL);
  if ( !log )
LABEL_8:
    sub_1BE4D28(TimeString, v10);
  ...
  v19 = System_String__Format_62713180((System_String_o *)StringLiteral_25411/*"{0}: {1}\n"*/, v18, (Il2CppObject *)v5, 0LL);
  v6->fields.last = v19;
  sub_1BE4A70((PartyOrganizationUtility_o *)&v6->fields.last, (int64_t)v19, v20, v21, v22, v23, v24, v25);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B66131 & 1) == 0 )
  {
    sub_1BE4ACC(&float_TypeInfo, method);
    sub_1BE4ACC(&StringLiteral_25283/*"{0:00.000}"*/, v2);
    byte_4B66131 = 1;
  }
  unscaledTime = UnityEngine_Time__get_unscaledTime(0LL);
  v6 = (Il2CppObject *)j_il2cpp_value_box_0(float_TypeInfo, &unscaledTime, v3, v4, v5);
  result = System_String__Format((System_String_o *)StringLiteral_25283/*"{0:00.000}"*/, v6, 0LL);
  if ( !result )
    sub_1BE4D28(0LL, v8);
  stringLength = result->fields._stringLength;
  if ( stringLength >= 7 )
    return System_String__Substring_62717812(result, stringLength - 6, 6, 0LL);
  return result;
}
...
void __fastcall SoundLogger_Info___ctor(SoundLogger_Info_o *this, int32_t maxBuff, const MethodInfo *method)
{
  ...
  if ( (byte_4B6612C & 1) == 0 )
  {
    sub_1BE4ACC(&System_Text_StringBuilder_TypeInfo, *(_QWORD *)&maxBuff);
    sub_1BE4ACC(&string___TypeInfo, v5);
    sub_1BE4ACC(&StringLiteral_932/*"--------"*/, v6);
    byte_4B6612C = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
  this->fields.maxNum = maxBuff;
  v7 = (struct System_String_array *)sub_1BE4B74(string___TypeInfo, (unsigned int)maxBuff);
  this->fields.buff = v7;
  p_fields = &this->fields;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields, (int64_t)v7, v9, v10, v11, v12, v13, v14);
  if ( maxBuff >= 1 )
  {
    v23 = 0LL;
    v24 = 32LL;
    do
    {
      ...
      *(Il2CppClass **)((char *)&buff->obj.klass + v24) = (Il2CppClass *)StringLiteral_932/*"--------"*/;
      sub_1BE4A70((PartyOrganizationUtility_o *)((char *)buff + v24), v26, v17, v18, v19, v20, v21, v22);
      ++v23;
      v24 += 8LL;
    }
    while ( maxBuff != v23 );
  ...
  v27 = (System_Text_StringBuilder_o *)sub_1BE4D18(System_Text_StringBuilder_TypeInfo);
  System_Text_StringBuilder___ctor(v27, 0LL);
  this->fields.sb = v27;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.sb, (int64_t)v27, v28, v29, v30, v31, v32, v33);
}
...
System_String_o *__fastcall SoundLogger_Info__ToString(SoundLogger_Info_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6612D & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_932/*"--------"*/, v4);
    sub_1BE4ACC(&StringLiteral_1867/*">"*/, v5);
    byte_4B6612D = 1;
  }
  ...
  if ( currentIndex > currentIndex - maxNum )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !sb )
        break;
      v10 = v9 == currentIndex ? (System_String_o **)&StringLiteral_1867/*">"*/ : (System_String_o **)&StringLiteral_116/*" "*/;
      sb = System_Text_StringBuilder__Append_61859960(sb, *v10, 0LL);
      buff = this->fields.buff;
      if ( !buff )
        break;
      v12 = (maxNum & (v9 >> 31)) + v9;
      if ( v12 >= buff->max_length )
        sub_1BE4D30(sb, method);
      sb = this->fields.sb;
      if ( !sb )
        break;
      System_Text_StringBuilder__Append_61859960(sb, buff->m_Items[v12], 0LL);
      sb = this->fields.sb;
      if ( !sb )
        break;
      System_Text_StringBuilder__Append_61859960(sb, (System_String_o *)StringLiteral_43/*"\n"*/, 0LL);
      currentIndex = this->fields.currentIndex;
      maxNum = this->fields.maxNum;
...
void __fastcall SoundLogger_Info__add(SoundLogger_Info_o *this, System_String_o *name, const MethodInfo *method)
{
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)(v10 + 4), (int64_t)name, (int64_t)method, v3, v4, v5, v6, v7);
}
...
bool __fastcall SoundLogger_Info__checkPlayLogLatest(SoundLogger_Info_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6612E & 1) == 0 )
  {
    this = (SoundLogger_Info_o *)sub_1BE4ACC(&SoundLogger_TypeInfo, method);
    byte_4B6612E = 1;
  }
...
LABEL_11:
  ...
  return System_String__LastIndexOf_62732148(v5, SoundLogger_TypeInfo->static_fields->WORD_NG, 0LL) == -1;
}