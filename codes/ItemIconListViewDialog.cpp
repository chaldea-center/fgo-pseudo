void ItemIconListViewDialog___ctor(ItemIconListViewDialog_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.TitlePosDefault.fields.x = xmmword_E9D830;
...
void ItemIconListViewDialog__ClearItemList(ItemIconListViewDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_5973B0E & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_ItemIconListViewDialog___c__ClearItemList_b__15_0__);
    sub_2213A60(&ItemIconListViewDialog___c_TypeInfo);
    byte_5973B0E = 1;
  }
  ...
  if ( !_9__15_0 )
  {
    ...
    _9__15_0 = (System_Action_object__o *)sub_2213CCC(System_Action_GameObject__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5973B11 & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_ItemIconListViewDialog_OnCloseEnd__);
    byte_5973B11 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( itemList )
  {
    ...
    v6 = DataManager__GetMaster_object_((const MethodInfo_3856318 *)Method_DataManager_GetMaster_UserItemMaster___);
    ...
    *(_QWORD *)&v49.fields._version = &v52;
    while ( 1 )
    {
             ...
             (const MethodInfo_3F10B80 *)Method_DataMasterBase_ItemMaster__ItemEntity__int__TryGetEntity__) )
      {
        ...
        if ( !entity )
          sub_2213CDC(Component_object, v22);
        ...
        else
        {
          ...
          sub_2213A04((MissionNaviTransitionBoardItem_o *)(v48 + 4), (int32_t)v15, v38, v39, v40, v41, v42, v43);
        }
      }
    }
...
void ItemIconListViewDialog__OnClickClose(ItemIconListViewDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_5973B12 & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_ItemIconListViewDialog_OnClickClose__);
  ...
  if ( this->fields.baseState == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ItemIconListViewDialog_OnClickClose__ + 83) & 2) != 0 )
      v6 = (_QWORD *)sub_2213A78(Method_ItemIconListViewDialog_OnClickClose__);
    v7 = (System_Reflection_MethodBase_o *)sub_2213A44(v6, v6[4]);
    OverwriteAssetSoundName__PlaySystemSe(v7, 0, 0, 0);
    objectList = (System_Collections_Generic_List_object__o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_47A29F8 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    if ( !objectList )
LABEL_9:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5973B10 & 1) == 0 )
  {
    ...
    sub_2213A60(&StringLiteral_7841/*"ITEM_ICON_LIST_VIEW_DIALOG_CLOSE_BTN_TEXT"*/);
    byte_5973B10 = 1;
  }
  ...
  IsNullOrEmpty = (UnityEngine_Transform_o *)LocalizationManager__Get((System_String_o *)StringLiteral_7841/*"ITEM_ICON_LIST_VIEW_DIALOG_CLOSE_BTN_TEXT"*/, 0);
  if ( !closeButtonLabel )
LABEL_19:
...
void ItemIconListViewDialog___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_2213CCC(ItemIconListViewDialog___c_TypeInfo);
