void BattleRankUpSkillInfoData___ctor(BattleRankUpSkillInfoData_o *this, const MethodInfo *method)
{
  ...
  v3 = (System_Collections_Generic_List_object__o *)sub_1C2D6DC(System_Collections_Generic_List_BattleSkillInfoData__TypeInfo);
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.rankUpList, (int32_t)v3, v4, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C29FF8 & 1) == 0 )
  {
    sub_1C2D490(&Method_System_Collections_Generic_List_BattleSkillInfoData__ToArray__);
    byte_4C29FF8 = 1;
  }
  ...
  return (BattleSkillInfoData_array *)System_Collections_Generic_List_object___ToArray(
                                        rankUpList,
                                        (const MethodInfo_378B6DC *)Method_System_Collections_Generic_List_BattleSkillInfoData__ToArray__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C29FF7 & 1) == 0 )
  {
    sub_1C2D490(&Method_BasicHelper_IndexValue_BattleSkillInfoData___);
    byte_4C29FF7 = 1;
  }
  ...
  return (BattleSkillInfoData_o *)BasicHelper__IndexValue_object__51105396(
                                    rankUpList,
                                    FixRank,
                                    0,
                                    (const MethodInfo_30BCE74 *)Method_BasicHelper_IndexValue_BattleSkillInfoData___);
}
...
int32_t BattleRankUpSkillInfoData__get_FixRank(BattleRankUpSkillInfoData_o *this, const MethodInfo *method)
{
  ...
  return System_Math__Min_64982368(RankUpCount_k__BackingField, RankUpLimit, 0);
}
...
int32_t BattleRankUpSkillInfoData__get_RankUpLimit(BattleRankUpSkillInfoData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C29FF5 & 1) == 0 )
  {
    this = (BattleRankUpSkillInfoData_o *)sub_1C2D490(&Method_System_Collections_Generic_List_BattleSkillInfoData__get_Count__);
    byte_4C29FF5 = 1;
  }
