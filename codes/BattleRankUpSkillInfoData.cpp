void __fastcall BattleRankUpSkillInfoData___ctor(BattleRankUpSkillInfoData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C00114 & 1) == 0 )
  {
    sub_1C2E12C(&Method_System_Collections_Generic_List_BattleSkillInfoData___ctor__, method);
    sub_1C2E12C(&System_Collections_Generic_List_BattleSkillInfoData__TypeInfo, v3);
    byte_4C00114 = 1;
  }
  v4 = (System_Collections_Generic_List_object__o *)sub_1C2E378(System_Collections_Generic_List_BattleSkillInfoData__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v4,
    (const MethodInfo_366B078 *)Method_System_Collections_Generic_List_BattleSkillInfoData___ctor__);
  this->fields.rankUpList = (struct System_Collections_Generic_List_BattleSkillInfoData__o *)v4;
  sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.rankUpList, (int64_t)v4, v5, v6, v7, v8, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C00113 & 1) == 0 )
  {
    sub_1C2E12C(&Method_System_Collections_Generic_List_BattleSkillInfoData__ToArray__, method);
    byte_4C00113 = 1;
  }
  ...
  return (BattleSkillInfoData_array *)System_Collections_Generic_List_object___ToArray(
                                        rankUpList,
                                        (const MethodInfo_366D404 *)Method_System_Collections_Generic_List_BattleSkillInfoData__ToArray__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C00112 & 1) == 0 )
  {
    sub_1C2E12C(&Method_BasicHelper_IndexValue_BattleSkillInfoData___, method);
    byte_4C00112 = 1;
  }
  rankUpList = (System_Collections_Generic_List_T__o *)this->fields.rankUpList;
  FixRank = BattleRankUpSkillInfoData__get_FixRank(this, method);
  return (BattleSkillInfoData_o *)BasicHelper__IndexValue_object__50069800(
                                    rankUpList,
                                    FixRank,
                                    0LL,
                                    (const MethodInfo_2FC0128 *)Method_BasicHelper_IndexValue_BattleSkillInfoData___);
}
...
int32_t __fastcall BattleRankUpSkillInfoData__get_FixRank(BattleRankUpSkillInfoData_o *this, const MethodInfo *method)
{
  ...
  return System_Math__Min_64055056(RankUpCount_k__BackingField, RankUpLimit, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C00110 & 1) == 0 )
  {
    this = (BattleRankUpSkillInfoData_o *)sub_1C2E12C(
