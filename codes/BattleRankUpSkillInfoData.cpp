void __fastcall BattleRankUpSkillInfoData___ctor(BattleRankUpSkillInfoData_o *this, const MethodInfo *method)
{
  ...
  v3 = (System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData__o *)sub_B70764(System_Collections_Generic_List_BattleSkillInfoData__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4351DAB & 1) == 0 )
  {
    sub_B70694(&Method_BasicHelper_IndexValue_BattleSkillInfoData___);
    byte_4351DAB = 1;
  }
  ...
  return (BattleSkillInfoData_o *)BasicHelper__IndexValue_WarBoardAIRoute_RouteData_(
                                    ...
                                    FixRank,
                                    0LL,
                                    (const MethodInfo_1BDED70 *)Method_BasicHelper_IndexValue_BattleSkillInfoData___);
}
...
int32_t __fastcall BattleRankUpSkillInfoData__get_FixRank(BattleRankUpSkillInfoData_o *this, const MethodInfo *method)
{
  ...
  return System_Math__Min_45556056(RankUpCount_k__BackingField, RankUpLimit, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4351DA9 & 1) == 0 )
  {
    this = (BattleRankUpSkillInfoData_o *)sub_B70694(&Method_System_Collections_Generic_List_BattleSkillInfoData__get_Count__);
    byte_4351DA9 = 1;
  }
