void __fastcall BattleRankUpSkillInfoData___ctor(BattleRankUpSkillInfoData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDEE9A & 1) == 0 )
  {
    sub_1C21E38(&Method_System_Collections_Generic_List_BattleSkillInfoData___ctor__);
    sub_1C21E38(&System_Collections_Generic_List_BattleSkillInfoData__TypeInfo);
    byte_4BDEE9A = 1;
  }
  v3 = (System_Collections_Generic_List_object__o *)sub_1C22084(System_Collections_Generic_List_BattleSkillInfoData__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v3,
    (const MethodInfo_364E880 *)Method_System_Collections_Generic_List_BattleSkillInfoData___ctor__);
  this->fields.rankUpList = (struct System_Collections_Generic_List_BattleSkillInfoData__o *)v3;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.rankUpList, (int64_t)v3, v4, v5, v6, v7, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDEE99 & 1) == 0 )
  {
    sub_1C21E38(&Method_System_Collections_Generic_List_BattleSkillInfoData__ToArray__);
    byte_4BDEE99 = 1;
  }
  ...
  return (BattleSkillInfoData_array *)System_Collections_Generic_List_object___ToArray(
                                        rankUpList,
                                        (const MethodInfo_3650C0C *)Method_System_Collections_Generic_List_BattleSkillInfoData__ToArray__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDEE98 & 1) == 0 )
  {
    sub_1C21E38(&Method_BasicHelper_IndexValue_BattleSkillInfoData___);
    byte_4BDEE98 = 1;
  }
  rankUpList = (System_Collections_Generic_List_T__o *)this->fields.rankUpList;
  FixRank = BattleRankUpSkillInfoData__get_FixRank(this, method);
  return (BattleSkillInfoData_o *)BasicHelper__IndexValue_object__49932624(
                                    rankUpList,
                                    FixRank,
                                    0LL,
                                    (const MethodInfo_2F9E950 *)Method_BasicHelper_IndexValue_BattleSkillInfoData___);
}
...
int32_t __fastcall BattleRankUpSkillInfoData__get_FixRank(BattleRankUpSkillInfoData_o *this, const MethodInfo *method)
{
  ...
  return System_Math__Min_63934948(RankUpCount_k__BackingField, RankUpLimit, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDEE96 & 1) == 0 )
  {
    this = (BattleRankUpSkillInfoData_o *)sub_1C21E38(&Method_System_Collections_Generic_List_BattleSkillInfoData__get_Count__);
    byte_4BDEE96 = 1;
  }
