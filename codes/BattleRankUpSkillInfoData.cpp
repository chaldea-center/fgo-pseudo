void __fastcall BattleRankUpSkillInfoData___ctor(BattleRankUpSkillInfoData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A00CCA & 1) == 0 )
  {
    sub_1B64870(&Method_System_Collections_Generic_List_BattleSkillInfoData___ctor__, method);
    sub_1B64870(&System_Collections_Generic_List_BattleSkillInfoData__TypeInfo, v3);
    byte_4A00CCA = 1;
  }
  v4 = (System_Collections_Generic_List_object__o *)sub_1B64ABC(System_Collections_Generic_List_BattleSkillInfoData__TypeInfo);
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.rankUpList, (int32_t)v4, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A00CC9 & 1) == 0 )
  {
    sub_1B64870(&Method_System_Collections_Generic_List_BattleSkillInfoData__ToArray__, method);
    byte_4A00CC9 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A00CC8 & 1) == 0 )
  {
    sub_1B64870(&Method_BasicHelper_IndexValue_BattleSkillInfoData___, method);
    byte_4A00CC8 = 1;
  }
  rankUpList = (System_Collections_Generic_List_T__o *)this->fields.rankUpList;
  FixRank = BattleRankUpSkillInfoData__get_FixRank(this, method);
  return (BattleSkillInfoData_o *)BasicHelper__IndexValue_object__48407704(
                                    rankUpList,
                                    FixRank,
                                    0LL,
                                    (const MethodInfo_2E2A498 *)Method_BasicHelper_IndexValue_BattleSkillInfoData___);
}
...
int32_t __fastcall BattleRankUpSkillInfoData__get_FixRank(BattleRankUpSkillInfoData_o *this, const MethodInfo *method)
{
  ...
  return System_Math__Min_62202544(RankUpCount_k__BackingField, RankUpLimit, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A00CC6 & 1) == 0 )
  {
    this = (BattleRankUpSkillInfoData_o *)sub_1B64870(
