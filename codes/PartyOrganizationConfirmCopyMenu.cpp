        ...
        const MethodInfo *method)
{
  ...
  PartyOrganizationConfirmCopyMenu__Close_32956360(this, 0LL, v2);
}


void __fastcall PartyOrganizationConfirmCopyMenu__Close_32956360(
        PartyOrganizationConfirmCopyMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD8173 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_PartyOrganizationConfirmCopyMenu_EndClose__);
    byte_4BD8173 = 1;
  }
  ...
  System_Action___ctor(v5, (Il2CppObject *)this, Method_PartyOrganizationConfirmCopyMenu_EndClose__, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD8175 & 1) == 0 )
  {
    sub_1C21E38(&Method_PartyOrganizationConfirmCopyMenu_OnClickCancel__);
    byte_4BD8175 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationConfirmCopyMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_PartyOrganizationConfirmCopyMenu_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD8174 & 1) == 0 )
  {
    sub_1C21E38(&Method_PartyOrganizationConfirmCopyMenu_OnClickDecide__);
    byte_4BD8174 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationConfirmCopyMenu_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_PartyOrganizationConfirmCopyMenu_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C21E1C(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD8172 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_PartyOrganizationConfirmCopyMenu_EndOpen__);
    sub_1C21E38(&StringLiteral_10347/*"PARTY_ORGANIZATION_CONFIRM_COPY_FROM_PARTY_TITLE"*/);
    sub_1C21E38(&StringLiteral_10349/*"PARTY_ORGANIZATION_CONFIRM_COPY_TITLE"*/);
    sub_1C21E38(&StringLiteral_10345/*"PARTY_ORGANIZATION_CONFIRM_COPY_CANCEL"*/);
    sub_1C21E38(&StringLiteral_10348/*"PARTY_ORGANIZATION_CONFIRM_COPY_MESSAGE"*/);
    sub_1C21E38(&StringLiteral_10346/*"PARTY_ORGANIZATION_CONFIRM_COPY_DECIDE"*/);
    sub_1C21E38(&StringLiteral_10350/*"PARTY_ORGANIZATION_CONFIRM_COPY_TO_PARTY_TITLE"*/);
    byte_4BD8172 = 1;
  }
      ...
      if ( gameObject )
      {
        ...
        if ( gameObject )
        {
          ...
          if ( gameObject )
          {
            ...
            if ( gameObject )
            {
              DeckListViewItemDraw__SetItem_32796788((DeckListViewItemDraw_o *)gameObject, basePartyItem, 2, 0LL);
              gameObject = (UnityEngine_GameObject_o *)this->fields.editDeckObject;
              if ( gameObject )
              {
                DeckListViewItemDraw__SetItem_32796788((DeckListViewItemDraw_o *)gameObject, editPartyItem, 2, 0LL);
                baseDeckTitleLabel = this->fields.baseDeckTitleLabel;
                if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                  j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                           (System_String_o *)StringLiteral_10347/*"PARTY_ORGANIZATION_CONFIRM_COPY_FROM_PARTY_TITLE"*/,
                                                           0LL);
                if ( baseDeckTitleLabel )
                {
                  ...
                  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                             (System_String_o *)StringLiteral_10350/*"PARTY_ORGANIZATION_CONFIRM_COPY_TO_PARTY_TITLE"*/,
                                                             0LL);
                  if ( editDeckTitleLabel )
                  {
                    ...
                    if ( !kind )
                    {
                      ...
                      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                 (System_String_o *)StringLiteral_10349/*"PARTY_ORGANIZATION_CONFIRM_COPY_TITLE"*/,
                                                                 0LL);
                      if ( !titleLabel )
                        goto LABEL_27;
                      ...
                      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                 (System_String_o *)StringLiteral_10348/*"PARTY_ORGANIZATION_CONFIRM_COPY_MESSAGE"*/,
                                                                 0LL);
                      if ( !messageLabel )
                        goto LABEL_27;
                      ...
                      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                 (System_String_o *)StringLiteral_10346/*"PARTY_ORGANIZATION_CONFIRM_COPY_DECIDE"*/,
                                                                 0LL);
                      if ( !decideLabel )
                        goto LABEL_27;
                      ...
                      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                 (System_String_o *)StringLiteral_10345/*"PARTY_ORGANIZATION_CONFIRM_COPY_CANCEL"*/,
                                                                 0LL);
                      if ( !cancelLabel )
                        goto LABEL_27;
                    ...
                    if ( gameObject )
                    {
                      ...
                      AndroidBackKeyManager__AddBackBtn(v20, 0LL);
                      this->fields.state = 1;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD816F & 1) == 0 )
  {
    sub_1C21E38(&PartyOrganizationConfirmCopyMenu_CallbackFunc_TypeInfo);
    byte_4BD816F = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (PartyOrganizationConfirmCopyMenu_o *)sub_1C22354(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A5D488;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A5D440;
}
