        ...
        const MethodInfo *method)
{
  ...
  PartyOrganizationConfirmCopyMenu__Close_32921000(this, 0LL, v2);
}


void __fastcall PartyOrganizationConfirmCopyMenu__Close_32921000(
        PartyOrganizationConfirmCopyMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC36F2 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_PartyOrganizationConfirmCopyMenu_EndClose__, v5);
    byte_4BC36F2 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC36F4 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_PartyOrganizationConfirmCopyMenu_OnClickCancel__, method);
    byte_4BC36F4 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationConfirmCopyMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C1ABEC(Method_PartyOrganizationConfirmCopyMenu_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC36F3 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_PartyOrganizationConfirmCopyMenu_OnClickDecide__, method);
    byte_4BC36F3 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationConfirmCopyMenu_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C1ABEC(Method_PartyOrganizationConfirmCopyMenu_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C1ABB8(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC36F1 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_PartyOrganizationConfirmCopyMenu_EndOpen__, v12);
    sub_1C1ABD4(&StringLiteral_10337/*"PARTY_ORGANIZATION_CONFIRM_COPY_FROM_PARTY_TITLE"*/, v13);
    sub_1C1ABD4(&StringLiteral_10339/*"PARTY_ORGANIZATION_CONFIRM_COPY_TITLE"*/, v14);
    sub_1C1ABD4(&StringLiteral_10335/*"PARTY_ORGANIZATION_CONFIRM_COPY_CANCEL"*/, v15);
    sub_1C1ABD4(&StringLiteral_10338/*"PARTY_ORGANIZATION_CONFIRM_COPY_MESSAGE"*/, v16);
    sub_1C1ABD4(&StringLiteral_10336/*"PARTY_ORGANIZATION_CONFIRM_COPY_DECIDE"*/, v17);
    sub_1C1ABD4(&StringLiteral_10340/*"PARTY_ORGANIZATION_CONFIRM_COPY_TO_PARTY_TITLE"*/, v18);
    byte_4BC36F1 = 1;
  }
      ...
      if ( gameObject )
      {
        ...
        if ( gameObject )
        {
          ...
          if ( gameObject )
          {
            ...
            if ( gameObject )
            {
              DeckListViewItemDraw__SetItem_32761428((DeckListViewItemDraw_o *)gameObject, basePartyItem, 2, 0LL);
              gameObject = (UnityEngine_GameObject_o *)this->fields.editDeckObject;
              if ( gameObject )
              {
                DeckListViewItemDraw__SetItem_32761428((DeckListViewItemDraw_o *)gameObject, editPartyItem, 2, 0LL);
                baseDeckTitleLabel = this->fields.baseDeckTitleLabel;
                if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                  j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                           (System_String_o *)StringLiteral_10337/*"PARTY_ORGANIZATION_CONFIRM_COPY_FROM_PARTY_TITLE"*/,
                                                           0LL);
                if ( baseDeckTitleLabel )
                {
                  ...
                  if ( editDeckTitleLabel )
                  {
                    ...
                    if ( !kind )
                    {
                      ...
                      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                 (System_String_o *)StringLiteral_10338/*"PARTY_ORGANIZATION_CONFIRM_COPY_MESSAGE"*/,
                                                                 0LL);
                      if ( !messageLabel )
                        goto LABEL_27;
                      ...
                      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                 (System_String_o *)StringLiteral_10336/*"PARTY_ORGANIZATION_CONFIRM_COPY_DECIDE"*/,
                                                                 0LL);
                      if ( !decideLabel )
                        goto LABEL_27;
                      ...
                      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                 (System_String_o *)StringLiteral_10335/*"PARTY_ORGANIZATION_CONFIRM_COPY_CANCEL"*/,
                                                                 0LL);
                      if ( !cancelLabel )
                        goto LABEL_27;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC36EE & 1) == 0 )
  {
    sub_1C1ABD4(&PartyOrganizationConfirmCopyMenu_CallbackFunc_TypeInfo, value);
    byte_4BC36EE = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (PartyOrganizationConfirmCopyMenu_o *)sub_1C1B0F0(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A564E0;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A56498;
}
