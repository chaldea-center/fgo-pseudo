        ...
        const MethodInfo *method)
{
  ...
  PartyOrganizationConfirmCopyMenu__Close_31810340(this, 0LL, v2);
}


void __fastcall PartyOrganizationConfirmCopyMenu__Close_31810340(
        PartyOrganizationConfirmCopyMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1B9A3 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_PartyOrganizationConfirmCopyMenu_EndClose__, v6);
    byte_4A1B9A3 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1B9A5 & 1) == 0 )
  {
    sub_1B715CC(&Method_PartyOrganizationConfirmCopyMenu_OnClickCancel__, method);
    byte_4A1B9A5 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationConfirmCopyMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B715E4(Method_PartyOrganizationConfirmCopyMenu_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1B9A4 & 1) == 0 )
  {
    sub_1B715CC(&Method_PartyOrganizationConfirmCopyMenu_OnClickDecide__, method);
    byte_4A1B9A4 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationConfirmCopyMenu_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B715E4(Method_PartyOrganizationConfirmCopyMenu_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B715B0(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1B9A2 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_PartyOrganizationConfirmCopyMenu_EndOpen__, v12);
    sub_1B715CC(&StringLiteral_10112/*"PARTY_ORGANIZATION_CONFIRM_COPY_FROM_PARTY_TITLE"*/, v13);
    sub_1B715CC(&StringLiteral_10114/*"PARTY_ORGANIZATION_CONFIRM_COPY_TITLE"*/, v14);
    sub_1B715CC(&StringLiteral_10110/*"PARTY_ORGANIZATION_CONFIRM_COPY_CANCEL"*/, v15);
    sub_1B715CC(&StringLiteral_10113/*"PARTY_ORGANIZATION_CONFIRM_COPY_MESSAGE"*/, v16);
    sub_1B715CC(&StringLiteral_10111/*"PARTY_ORGANIZATION_CONFIRM_COPY_DECIDE"*/, v17);
    sub_1B715CC(&StringLiteral_10115/*"PARTY_ORGANIZATION_CONFIRM_COPY_TO_PARTY_TITLE"*/, v18);
    byte_4A1B9A2 = 1;
  }
      ...
      if ( gameObject )
      {
        ...
        if ( gameObject )
        {
          ...
          if ( gameObject )
          {
            ...
            if ( gameObject )
            {
              DeckListViewItemDraw__SetItem_31659644((DeckListViewItemDraw_o *)gameObject, basePartyItem, 2, 0LL);
              gameObject = (UnityEngine_GameObject_o *)this->fields.editDeckObject;
              if ( gameObject )
              {
                DeckListViewItemDraw__SetItem_31659644((DeckListViewItemDraw_o *)gameObject, editPartyItem, 2, 0LL);
                baseDeckTitleLabel = this->fields.baseDeckTitleLabel;
                if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                  j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                           (System_String_o *)StringLiteral_10112/*"PARTY_ORGANIZATION_CONFIRM_COPY_FROM_PARTY_TITLE"*/,
                                                           0LL);
                if ( baseDeckTitleLabel )
                {
                  ...
                  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                             (System_String_o *)StringLiteral_10115/*"PARTY_ORGANIZATION_CONFIRM_COPY_TO_PARTY_TITLE"*/,
                                                             0LL);
                  if ( editDeckTitleLabel )
                  {
                    ...
                    if ( !kind )
                    {
                      ...
                      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                 (System_String_o *)StringLiteral_10114/*"PARTY_ORGANIZATION_CONFIRM_COPY_TITLE"*/,
                                                                 0LL);
                      if ( !titleLabel )
                        goto LABEL_27;
                      ...
                      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                 (System_String_o *)StringLiteral_10113/*"PARTY_ORGANIZATION_CONFIRM_COPY_MESSAGE"*/,
                                                                 0LL);
                      if ( !messageLabel )
                        goto LABEL_27;
                      ...
                      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                 (System_String_o *)StringLiteral_10111/*"PARTY_ORGANIZATION_CONFIRM_COPY_DECIDE"*/,
                                                                 0LL);
                      if ( !decideLabel )
                        goto LABEL_27;
                      ...
                      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                 (System_String_o *)StringLiteral_10110/*"PARTY_ORGANIZATION_CONFIRM_COPY_CANCEL"*/,
                                                                 0LL);
                      if ( !cancelLabel )
                        goto LABEL_27;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1B99F & 1) == 0 )
  {
    sub_1B715CC(&PartyOrganizationConfirmCopyMenu_CallbackFunc_TypeInfo, value);
    byte_4A1B99F = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (PartyOrganizationConfirmCopyMenu_o *)sub_1B71AE8(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19B3828;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19B37E0;
}
