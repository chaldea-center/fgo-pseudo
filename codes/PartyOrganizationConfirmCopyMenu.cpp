        ...
        const MethodInfo *method)
{
  ...
  PartyOrganizationConfirmCopyMenu__Close_32267600(this, 0LL, v2);
}


void __fastcall PartyOrganizationConfirmCopyMenu__Close_32267600(
        PartyOrganizationConfirmCopyMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB1AD8 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_PartyOrganizationConfirmCopyMenu_EndClose__, v6);
    byte_4AB1AD8 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB1ADA & 1) == 0 )
  {
    sub_1BAB41C(&Method_PartyOrganizationConfirmCopyMenu_OnClickCancel__, method);
    byte_4AB1ADA = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationConfirmCopyMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BAB434(Method_PartyOrganizationConfirmCopyMenu_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB1AD9 & 1) == 0 )
  {
    sub_1BAB41C(&Method_PartyOrganizationConfirmCopyMenu_OnClickDecide__, method);
    byte_4AB1AD9 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationConfirmCopyMenu_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BAB434(Method_PartyOrganizationConfirmCopyMenu_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BAB400(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB1AD7 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_PartyOrganizationConfirmCopyMenu_EndOpen__, v12);
    sub_1BAB41C(&StringLiteral_10155/*"PARTY_ORGANIZATION_CONFIRM_COPY_FROM_PARTY_TITLE"*/, v13);
    sub_1BAB41C(&StringLiteral_10157/*"PARTY_ORGANIZATION_CONFIRM_COPY_TITLE"*/, v14);
    sub_1BAB41C(&StringLiteral_10153/*"PARTY_ORGANIZATION_CONFIRM_COPY_CANCEL"*/, v15);
    sub_1BAB41C(&StringLiteral_10156/*"PARTY_ORGANIZATION_CONFIRM_COPY_MESSAGE"*/, v16);
    sub_1BAB41C(&StringLiteral_10154/*"PARTY_ORGANIZATION_CONFIRM_COPY_DECIDE"*/, v17);
    sub_1BAB41C(&StringLiteral_10158/*"PARTY_ORGANIZATION_CONFIRM_COPY_TO_PARTY_TITLE"*/, v18);
    byte_4AB1AD7 = 1;
  }
      ...
      if ( gameObject )
      {
        ...
        if ( gameObject )
        {
          ...
          if ( gameObject )
          {
            ...
            if ( gameObject )
            {
              DeckListViewItemDraw__SetItem_32116892((DeckListViewItemDraw_o *)gameObject, basePartyItem, 2, 0LL);
              gameObject = (UnityEngine_GameObject_o *)this->fields.editDeckObject;
              if ( gameObject )
              {
                DeckListViewItemDraw__SetItem_32116892((DeckListViewItemDraw_o *)gameObject, editPartyItem, 2, 0LL);
                baseDeckTitleLabel = this->fields.baseDeckTitleLabel;
                if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                  j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                           (System_String_o *)StringLiteral_10155/*"PARTY_ORGANIZATION_CONFIRM_COPY_FROM_PARTY_TITLE"*/,
                                                           0LL);
                if ( baseDeckTitleLabel )
                {
                  ...
                  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                             (System_String_o *)StringLiteral_10158/*"PARTY_ORGANIZATION_CONFIRM_COPY_TO_PARTY_TITLE"*/,
                                                             0LL);
                  if ( editDeckTitleLabel )
                  {
                    ...
                    if ( !kind )
                    {
                      ...
                      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                 (System_String_o *)StringLiteral_10157/*"PARTY_ORGANIZATION_CONFIRM_COPY_TITLE"*/,
                                                                 0LL);
                      if ( !titleLabel )
                        goto LABEL_27;
                      ...
                      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                 (System_String_o *)StringLiteral_10156/*"PARTY_ORGANIZATION_CONFIRM_COPY_MESSAGE"*/,
                                                                 0LL);
                      if ( !messageLabel )
                        goto LABEL_27;
                      ...
                      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                 (System_String_o *)StringLiteral_10154/*"PARTY_ORGANIZATION_CONFIRM_COPY_DECIDE"*/,
                                                                 0LL);
                      if ( !decideLabel )
                        goto LABEL_27;
                      ...
                      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                 (System_String_o *)StringLiteral_10153/*"PARTY_ORGANIZATION_CONFIRM_COPY_CANCEL"*/,
                                                                 0LL);
                      if ( !cancelLabel )
                        goto LABEL_27;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB1AD4 & 1) == 0 )
  {
    sub_1BAB41C(&PartyOrganizationConfirmCopyMenu_CallbackFunc_TypeInfo, value);
    byte_4AB1AD4 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (PartyOrganizationConfirmCopyMenu_o *)sub_1BAB938(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19E9218;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19E91D0;
}
