        ...
        const MethodInfo *method)
{
  ...
  v4 = System_Convert__ToInt32_62373836(value, 16, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5B041 & 1) == 0 )
  {
    sub_1B885B0(&StringLiteral_18284/*"count_format"*/);
...
int32_t __fastcall EventBossStatusUiEntity__GetGaugeId(EventBossStatusUiEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5B040 & 1) == 0 )
  {
    sub_1B885B0(&StringLiteral_19706/*"gauge_id"*/);
    byte_4A5B040 = 1;
  }
  return EventBossStatusUiEntity__GetScriptIntParam(this, (System_String_o *)StringLiteral_19706/*"gauge_id"*/, -1, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5B045 & 1) == 0 )
  {
    sub_1B885B0(&StringLiteral_21043/*"lastbattle_icon_id"*/);
    byte_4A5B045 = 1;
  }
  return EventBossStatusUiEntity__GetScriptIntParam(this, (System_String_o *)StringLiteral_21043/*"lastbattle_icon_id"*/, -1, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !System_Convert_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Convert_TypeInfo);
  return System_Convert__ToInt32_62373836(v8, 16, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5B03D & 1) == 0 )
  {
    sub_1B885B0(&StringLiteral_23525/*"status_battle_color"*/);
    byte_4A5B03D = 1;
  }
  ScriptObj = EventBossStatusUiEntity__GetScriptObj(this, (System_String_o *)StringLiteral_23525/*"status_battle_color"*/, v3);
  if ( ScriptObj )
  {
...
int32_t __fastcall EventBossStatusUiEntity__GetStatusHeight(EventBossStatusUiEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5B042 & 1) == 0 )
  {
    sub_1B885B0(&StringLiteral_23526/*"status_height"*/);
    byte_4A5B042 = 1;
  }
  return EventBossStatusUiEntity__GetScriptIntParam(this, (System_String_o *)StringLiteral_23526/*"status_height"*/, -1, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5B03E & 1) == 0 )
  {
    sub_1B885B0(&StringLiteral_23527/*"status_last_color"*/);
    byte_4A5B03E = 1;
  }
  ScriptObj = EventBossStatusUiEntity__GetScriptObj(this, (System_String_o *)StringLiteral_23527/*"status_last_color"*/, v3);
  if ( ScriptObj )
  {
    v10 = (EventBossStatusUiEntity_o *)((__int64 (__fastcall *)(Il2CppObject *, Il2CppMethodPointer))ScriptObj->klass->vtable[3].method)(
                                         ScriptObj,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5B03F & 1) == 0 )
  {
    sub_1B885B0(&StringLiteral_23534/*"status_win_color"*/);
    byte_4A5B03F = 1;
  }
  ScriptObj = EventBossStatusUiEntity__GetScriptObj(this, (System_String_o *)StringLiteral_23534/*"status_win_color"*/, v3);
  if ( ScriptObj )
  {
    v10 = (EventBossStatusUiEntity_o *)((__int64 (__fastcall *)(Il2CppObject *, Il2CppMethodPointer))ScriptObj->klass->vtable[3].method)(
                                         ScriptObj,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5B03C & 1) == 0 )
  {
    sub_1B885B0(&StringLiteral_23907/*"text_effect_color"*/);
    byte_4A5B03C = 1;
  }
  ScriptObj = EventBossStatusUiEntity__GetScriptObj(this, (System_String_o *)StringLiteral_23907/*"text_effect_color"*/, v3);
  if ( ScriptObj )
  {
    v10 = (EventBossStatusUiEntity_o *)((__int64 (__fastcall *)(Il2CppObject *, Il2CppMethodPointer))ScriptObj->klass->vtable[3].method)(
                                         ScriptObj,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5B043 & 1) == 0 )
  {
    sub_1B885B0(&StringLiteral_19852/*"grid_pos"*/);
    byte_4A5B043 = 1;
  }
  v5 = (System_String_o *)StringLiteral_19852/*"grid_pos"*/;
  if ( !byte_4A55CE1 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5B044 & 1) == 0 )
  {
    sub_1B885B0(&StringLiteral_19970/*"hp_bar_pos"*/);
    byte_4A5B044 = 1;
  }
  v5 = (System_String_o *)StringLiteral_19970/*"hp_bar_pos"*/;
  if ( !byte_4A55CE1 )
  {
    sub_1B885B0(&UnityEngine_Vector3_TypeInfo);
    byte_4A55CE1 = 1;
