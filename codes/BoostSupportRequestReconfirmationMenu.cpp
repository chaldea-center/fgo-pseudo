        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C50A80 & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_BoostSupportRequestReconfirmationMenu__Callback_b__24_0__);
        ...
        const MethodInfo *method)
{
  ...
  BoostSupportRequestReconfirmationMenu__Close_31186472(this, 0, v2);
}


void BoostSupportRequestReconfirmationMenu__Close_31186472(
        BoostSupportRequestReconfirmationMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C3E564(&System_Action_TypeInfo);
    sub_1C3E564(&Method_BoostSupportRequestReconfirmationMenu_EndClose__);
    byte_4C50A7F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C50A81 & 1) == 0 )
  {
    sub_1C3E564(&Method_BoostSupportRequestReconfirmationMenu_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C50A82 & 1) == 0 )
  {
    sub_1C3E564(&Method_BoostSupportRequestReconfirmationMenu_OnClickDecide__);
    sub_1C3E564(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4C50A82 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C50A7D & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_2961/*"BOOST_ITEM_USE_CONFIRM_DECIDE"*/);
    sub_1C3E564(&StringLiteral_2979/*"BOOST_SUPPORT_REQUEST_USE_RECONFIRMATION_MENU_TITLE"*/);
  ...
  sub_1C3E508(&this->fields.serectBoostEntity, boostEntity);
  if ( !OptionManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(OptionManager_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = callbackFunc;
  *p_callbackFunc = 0;
  v6 = sub_1C3E508(p_callbackFunc, 0);
  if ( callbackFunc )
  {
        ...
        const MethodInfo *method)
{
  ...
  v11 = (BoostSupportRequestReconfirmationMenu_o *)sub_1C3EA80(v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( commonConsumeEntityList && commonConsumeEntityList->max_length )
  {
    ...
    if ( (int)max_length >= 1 )
    {
      ...
      while ( (int)++v8 - 4 < (int)max_length );
    }
    v20 = this->fields.itemIcon;
    if ( !v20 )
      goto LABEL_53;
    v21 = 8LL * (int)max_length + 32;
    while ( 1 )
    {
      v22 = v20->max_length;
      if ( (int)max_length >= (int)v22 )
        break;
...
LABEL_54:
        sub_1C3E7C8(consumeItem, commonConsumeEntityList, v6);
      v28 = v27->m_Items[0];
      if ( !v28 )
LABEL_53:
        sub_1C3E7C0(consumeItem, commonConsumeEntityList);
    ...
    + (float)((float)(consumeItemIconGrid->fields.cellWidth * 0.5)
            * (float)((int)v22 - LODWORD(commonConsumeEntityList->max_length))),
      0);
