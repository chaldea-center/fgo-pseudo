        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C317B0 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_BoostSupportRequestReconfirmationMenu__Callback_b__24_0__);
        ...
        const MethodInfo *method)
{
  ...
  BoostSupportRequestReconfirmationMenu__Close_31139036(this, 0, v2);
}


void BoostSupportRequestReconfirmationMenu__Close_31139036(
        BoostSupportRequestReconfirmationMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C32C20(&System_Action_TypeInfo);
    sub_1C32C20(&Method_BoostSupportRequestReconfirmationMenu_EndClose__);
    byte_4C317AF = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C317B1 & 1) == 0 )
  {
    sub_1C32C20(&Method_BoostSupportRequestReconfirmationMenu_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C317B2 & 1) == 0 )
  {
    sub_1C32C20(&Method_BoostSupportRequestReconfirmationMenu_OnClickDecide__);
    sub_1C32C20(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4C317B2 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C317AD & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_2961/*"BOOST_ITEM_USE_CONFIRM_DECIDE"*/);
    sub_1C32C20(&StringLiteral_2979/*"BOOST_SUPPORT_REQUEST_USE_RECONFIRMATION_MENU_TITLE"*/);
  ...
  sub_1C32BC4(&this->fields.serectBoostEntity, boostEntity);
  if ( !OptionManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(OptionManager_TypeInfo);
  ...
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_2979/*"BOOST_SUPPORT_REQUEST_USE_RECONFIRMATION_MENU_TITLE"*/, 0);
  if ( !titleLabel )
    goto LABEL_28;
  ...
  if ( Entity )
  {
    ...
    Instance = SkillEntity__getEffectExplanation(v11, 0, 0);
    if ( !skillDetailLabel )
      goto LABEL_28;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_3694/*"COMMON_CONSUME_DESCRIPTION_TITLE"*/, 0);
  if ( !consumptionLabel )
    goto LABEL_28;
  ...
  IdEntityList = CommonConsumeMaster__GetIdEntityList(
                   ...
                   0);
  BoostSupportRequestReconfirmationMenu__setConsumeItemIconList(this, IdEntityList, v15);
  decideLabel = this->fields.decideLabel;
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_2961/*"BOOST_ITEM_USE_CONFIRM_DECIDE"*/, 0);
  if ( !decideLabel
    || (UILabel__set_text(decideLabel, Instance, 0),
        cancelLabel = this->fields.cancelLabel,
        Instance = LocalizationManager__Get((System_String_o *)StringLiteral_2959/*"BOOST_ITEM_USE_CANCEL"*/, 0),
        !cancelLabel)
...
LABEL_28:
  ...
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)Instance, 1, 0);
  BaseDialog__Open((BaseDialog_o *)this, 0, 1, 0, v18);
}
        ...
        const MethodInfo *method)
{
  ...
  v4 = callbackFunc;
  *p_callbackFunc = 0;
  v6 = sub_1C32BC4(p_callbackFunc, 0);
  if ( callbackFunc )
  {
        ...
        const MethodInfo *method)
{
  ...
  v11 = (BoostSupportRequestReconfirmationMenu_o *)sub_1C3313C(v8);
...
LABEL_54:
        sub_1C32E84(consumeItem);
      v27 = v26->m_Items[0];
      if ( !v27 )
LABEL_53:
        sub_1C32E7C(consumeItem);
