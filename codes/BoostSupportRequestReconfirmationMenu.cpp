        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1656F & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_BoostSupportRequestReconfirmationMenu__Callback_b__24_0__, v3);
        ...
        const MethodInfo *method)
{
  ...
  BoostSupportRequestReconfirmationMenu__Close_30712496(this, 0LL, v2);
}


void __fastcall BoostSupportRequestReconfirmationMenu__Close_30712496(
        BoostSupportRequestReconfirmationMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1656E & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_BoostSupportRequestReconfirmationMenu_EndClose__, v5);
    byte_4B1656E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B16570 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_BoostSupportRequestReconfirmationMenu_OnClickCancel__, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B16571 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_BoostSupportRequestReconfirmationMenu_OnClickDecide__, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1656C & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_CommonConsumeMaster___, boostEntity);
    ...
    sub_1BCAFF8(&StringLiteral_2942/*"BOOST_ITEM_USE_CONFIRM_DECIDE"*/, v12);
    sub_1BCAFF8(&StringLiteral_2960/*"BOOST_SUPPORT_REQUEST_USE_RECONFIRMATION_MENU_TITLE"*/, v13);
    sub_1BCAFF8(&StringLiteral_2940/*"BOOST_ITEM_USE_CANCEL"*/, v14);
    sub_1BCAFF8(&StringLiteral_3659/*"COMMON_CONSUME_DESCRIPTION_TITLE"*/, v15);
    byte_4B1656C = 1;
  }
  this->fields.callbackFunc = callback;
  sub_1BCAF9C(&this->fields.callbackFunc);
  this->fields.serectBoostEntity = boostEntity;
  sub_1BCAF9C(&this->fields.serectBoostEntity);
  if ( !OptionManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(OptionManager_TypeInfo);
  ...
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_2960/*"BOOST_SUPPORT_REQUEST_USE_RECONFIRMATION_MENU_TITLE"*/, 0LL);
  if ( !titleLabel )
    goto LABEL_28;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_3659/*"COMMON_CONSUME_DESCRIPTION_TITLE"*/, 0LL);
  if ( !consumptionLabel )
    goto LABEL_28;
  ...
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_2942/*"BOOST_ITEM_USE_CONFIRM_DECIDE"*/, 0LL);
  if ( !decideLabel
    || (UILabel__set_text(decideLabel, Instance, 0LL),
        cancelLabel = this->fields.cancelLabel,
        Instance = LocalizationManager__Get((System_String_o *)StringLiteral_2940/*"BOOST_ITEM_USE_CANCEL"*/, 0LL),
        !cancelLabel)
        ...
        const MethodInfo *method)
{
  ...
  v11 = (BoostSupportRequestReconfirmationMenu_o *)sub_1BCB514(v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1656D & 1) == 0 )
  {
    sub_1BCAFF8(&AtlasManager_TypeInfo, commonConsumeEntityList);
  ...
  if ( commonConsumeEntityList && *(_QWORD *)&commonConsumeEntityList->max_length )
  {
    ...
    if ( v32 <= 9 )
    {
      ...
      if ( !v29->max_length )
LABEL_54:
        sub_1BCB25C(consumeItem, commonConsumeEntityList, v7, v8);
      v30 = v29->m_Items[0];
      if ( !v30 )
LABEL_53:
        sub_1BCB254(consumeItem, commonConsumeEntityList);
