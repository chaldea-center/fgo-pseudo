        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DDDC8 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_BoostSupportRequestReconfirmationMenu__Callback_b__24_0__, v3);
        ...
        const MethodInfo *method)
{
  ...
  BoostSupportRequestReconfirmationMenu__Close_29889372(this, 0LL, v2);
}


void __fastcall BoostSupportRequestReconfirmationMenu__Close_29889372(
        BoostSupportRequestReconfirmationMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DDDC7 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_BoostSupportRequestReconfirmationMenu_EndClose__, v5);
    byte_48DDDC7 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DDDC9 & 1) == 0 )
  {
    sub_1B00CCC(&Method_BoostSupportRequestReconfirmationMenu_OnClickCancel__, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DDDCA & 1) == 0 )
  {
    sub_1B00CCC(&Method_BoostSupportRequestReconfirmationMenu_OnClickDecide__, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DDDC5 & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataManager_GetMasterData_CommonConsumeMaster___, boostEntity);
    ...
    sub_1B00CCC(&StringLiteral_3028/*"BOOST_ITEM_USE_CONFIRM_DECIDE"*/, v12);
    sub_1B00CCC(&StringLiteral_3045/*"BOOST_SUPPORT_REQUEST_USE_RECONFIRMATION_MENU_TITLE"*/, v13);
    sub_1B00CCC(&StringLiteral_3026/*"BOOST_ITEM_USE_CANCEL"*/, v14);
    sub_1B00CCC(&StringLiteral_3722/*"COMMON_CONSUME_DESCRIPTION_TITLE"*/, v15);
    byte_48DDDC5 = 1;
  }
  this->fields.callbackFunc = callback;
  sub_1B00C70(&this->fields.callbackFunc);
  this->fields.serectBoostEntity = boostEntity;
  sub_1B00C70(&this->fields.serectBoostEntity);
  if ( !OptionManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(OptionManager_TypeInfo);
  ...
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_3045/*"BOOST_SUPPORT_REQUEST_USE_RECONFIRMATION_MENU_TITLE"*/, 0LL);
  if ( !titleLabel )
    goto LABEL_28;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_3722/*"COMMON_CONSUME_DESCRIPTION_TITLE"*/, 0LL);
  if ( !consumptionLabel )
    goto LABEL_28;
  ...
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_3028/*"BOOST_ITEM_USE_CONFIRM_DECIDE"*/, 0LL);
  if ( !decideLabel
    || (UILabel__set_text(decideLabel, Instance, 0LL),
        cancelLabel = this->fields.cancelLabel,
        Instance = LocalizationManager__Get((System_String_o *)StringLiteral_3026/*"BOOST_ITEM_USE_CANCEL"*/, 0LL),
        !cancelLabel)
        ...
        const MethodInfo *method)
{
  ...
  v11 = (BoostSupportRequestReconfirmationMenu_o *)sub_1B011E8(v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DDDC6 & 1) == 0 )
  {
    sub_1B00CCC(&AtlasManager_TypeInfo, commonConsumeEntityList);
  ...
  if ( commonConsumeEntityList && *(_QWORD *)&commonConsumeEntityList->max_length )
  {
    ...
    if ( v32 <= 9 )
    {
      ...
      if ( !v29->max_length )
LABEL_54:
        sub_1B00F30(consumeItem, commonConsumeEntityList, v7, v8);
      v30 = v29->m_Items[0];
      if ( !v30 )
LABEL_53:
        sub_1B00F28(consumeItem, commonConsumeEntityList);
