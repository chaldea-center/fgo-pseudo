void UIScriptHorizontalImage___ctor(UIScriptHorizontalImage_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2E994 & 1) == 0 )
  {
    sub_1C94098(&UIHorizontalImageM___TypeInfo);
    sub_1C94098(&UIScriptChara_TypeInfo);
    byte_4D2E994 = 1;
  }
  v3 = (struct UIHorizontalImageM_array *)sub_1C94140(UIHorizontalImageM___TypeInfo, 2);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2E98E & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_UIScriptHorizontalImage_UpdateChange__);
    byte_4D2E98E = 1;
  }
...
void UIScriptHorizontalImage__UpdateChange(UIScriptHorizontalImage_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2E98F & 1) == 0 )
  {
    ...
    this = (UIScriptHorizontalImage_o *)sub_1C94098(&StringLiteral_4702/*"ContinueChangeFade"*/);
    byte_4D2E98F = 1;
  }
