void UIScriptHorizontalImage___ctor(UIScriptHorizontalImage_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_5972994 & 1) == 0 )
  {
    sub_2213A60(&UIHorizontalImageM___TypeInfo);
    sub_2213A60(&UIScriptChara_TypeInfo);
    byte_5972994 = 1;
  }
  v3 = (struct UIHorizontalImageM_array *)sub_2213B20(UIHorizontalImageM___TypeInfo, 2);
        ...
        const MethodInfo *method)
{
  ...
  Il2CppClass **v21; // x9
  UIHorizontalImageRender_o *v22; // x22
  UIHorizontalImageRender_o *v23; // x23
  System_Action_o *v24; // x23

  if ( (byte_597298E & 1) == 0 )
  {
    sub_2213A60(&System_Action_TypeInfo);
    sub_2213A60(&Method_UIScriptHorizontalImage_UpdateChange__);
    byte_597298E = 1;
  }
  ...
  v22 = (UIHorizontalImageRender_o *)v21[4];
  v23 = (UIHorizontalImageRender_o *)imageList->m_Items[backIndex];
  if ( !v22
    || (UIHorizontalImageRender__SetActive((UIHorizontalImageRender_o *)v21[4], 1, 0),
        UIHorizontalImageRender__SetAlpha(v22, 0.0, 0),
        UIHorizontalImageRender__SetDepth(v22, 0.1, 0),
        !v23) )
  {
LABEL_9:
    sub_2213CDC(v15, v16);
  }
  UIHorizontalImageRender__SetDepth(v23, 0.0, 0);
  UIHorizontalImageRender__SetShadow(v22, this->fields.isShadow, 0);
  v24 = (System_Action_o *)sub_2213CCC(System_Action_TypeInfo);
  System_Action___ctor(v24, (Il2CppObject *)this, Method_UIScriptHorizontalImage_UpdateChange__, 0);
  UIHorizontalImageM__SetCharacter((UIHorizontalImageM_o *)v22, imageName, faceType, v24, 0);
}
...
LABEL_6:
  ...
  result.fields.x = v7 + OFFSET_IMAGE_X;
  result.fields.y = v9 + OFFSET_IMAGE_Y;
  return result;
}
...
void UIScriptHorizontalImage__SetDepth(UIScriptHorizontalImage_o *this, int32_t d, const MethodInfo *method)
{
  ...
  if ( !this
    || (v7 = (UIHorizontalImageRender_o *)imageList->m_Items[mainIndex],
...
LABEL_7:
  ...
  UIHorizontalImageRender__SetDepth(v7, 0.1, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  float g; // s10
  float r; // s11
  UIHorizontalImageRender_o *v15; // x0
  __int64 v16; // x1
  ...
  *((float *)p_filterName + 5) = a;
  ...
  if ( (unsigned int)mainIndex >= LODWORD(v17[1].klass) )
    sub_2213CE4(v15);
  v15 = (UIHorizontalImageRender_o *)*((_QWORD *)&v17[1].monitor + mainIndex);
  if ( !v15 )
LABEL_5:
    sub_2213CDC(v15, v16);
  v19.fields.b = b;
  ...
  v19.fields.r = r;
  v19.fields.g = g;
  UIHorizontalImageRender__SetFilter(v15, *p_filterName, v19, 0);
}
...
void UIScriptHorizontalImage__SetOverlap(UIScriptHorizontalImage_o *this, float a, const MethodInfo *method)
{
  ...
  unsigned int max_length; // w11
  __int64 backIndex; // x10
  UIHorizontalImageRender_o *v8; // x19
  ...
  this = (UIScriptHorizontalImage_o *)imageList->m_Items[mainIndex];
  if ( !this
    || (v8 = (UIHorizontalImageRender_o *)imageList->m_Items[backIndex],
        UIHorizontalImageRender__SetAlpha((UIHorizontalImageRender_o *)this, a, 0),
        !v8) )
  {
LABEL_7:
  ...
  UIHorizontalImageRender__SetAlpha(v8, 1.0 - a, 0);
}
...
void UIScriptHorizontalImage__UpdateChange(UIScriptHorizontalImage_o *this, const MethodInfo *method)
{
  ...
  UIHorizontalImageRender_o *v8; // x20
  ...
  if ( (byte_597298F & 1) == 0 )
  {
    ...
    this = (UIScriptHorizontalImage_o *)sub_2213A60(&StringLiteral_4878/*"ContinueChangeFade"*/);
    byte_597298F = 1;
  }
...
LABEL_22:
    ...
    if ( this )
    {
      v8 = (UIHorizontalImageRender_o *)imageList->m_Items[mainIndex];
