...
uint32_t CriFsPlugin__CRIWARE05FCC2E5(const MethodInfo *method)
{
  ...
  v1 = (const MethodInfo *)off_4D29D48;
  if ( !off_4D29D48 )
  {
    v4 = 0;
    v3[0] = "cri_ware_unity";
  ...
  return ((uint32_t (__fastcall *)(const MethodInfo *))v1)(method);
}
...
bool CriFsPlugin__CRIWARE9F3B52BA(const MethodInfo *method)
{
  ...
  v1 = (const MethodInfo *)off_4D29D38;
  if ( !off_4D29D38 )
  {
    v4 = 0;
    v3[0] = "cri_ware_unity";
...
uint32_t CriFsPlugin__criFsLoader_GetRetryCount(const MethodInfo *method)
{
  ...
  v1 = (const MethodInfo *)off_4D29D50;
  if ( !off_4D29D50 )
  {
    v4 = 0;
    v3[0] = "cri_ware_unity";
...
int32_t CriFsPlugin__criFs_GetNumBinds(int32_t *cur, int32_t *max, int32_t *limit, const MethodInfo *method)
{
  ...
  return ((int32_t (__fastcall *)(int32_t *, int32_t *, int32_t *, const MethodInfo *))v4)(cur, max, limit, method);
}
...
int32_t CriFsPlugin__criFs_SetReadDeviceEnabled(int32_t device_id, bool enabled, const MethodInfo *method)
{
  ...
  return ((int32_t (__fastcall *)(_QWORD, bool, const MethodInfo *))v3)((unsigned int)device_id, enabled, method);
}
