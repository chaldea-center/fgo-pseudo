void GachaSubMaster___ctor(GachaSubMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4E04E14 & 1) == 0 )
  {
    sub_1CE6700(&Method_DataMasterBase_GachaSubMaster__GachaSubEntity__string___ctor__);
    byte_4E04E14 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    191,
    (const MethodInfo_34EBC44 *)Method_DataMasterBase_GachaSubMaster__GachaSubEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E04E15 & 1) == 0 )
  {
    sub_1CE6700(&Method_DataMasterBase_GachaSubMaster__GachaSubEntity__string__GetEntity__);
    byte_4E04E15 = 1;
  }
  ...
  return (GachaSubEntity_o *)DataMasterBase_object__object__object___GetEntity(
                               (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                               PK,
                               (const MethodInfo_34EE1BC *)Method_DataMasterBase_GachaSubMaster__GachaSubEntity__string__GetEntity__);
}
...
GachaSubEntity_o *GachaSubMaster__GetFriendPointGachaImageInfo(
        ...
        const MethodInfo *method)
{
  return GachaSubMaster__GetOpenEntity_43471304(this, gachaId, nowTime, method);
}
...
GachaSubEntity_o *GachaSubMaster__GetOpenEntity(GachaSubMaster_o *this, int32_t gachaId, const MethodInfo *method)
{
  ...
  return GachaSubMaster__GetOpenEntity_43471304(this, gachaId, Time, v6);
}


GachaSubEntity_o *GachaSubMaster__GetOpenEntity_43471304(
        GachaSubMaster_o *this,
        int32_t gachaId,
        int64_t checkTime,
        const MethodInfo *method)
{
  ...
  if ( (byte_4E04E13 & 1) == 0 )
  {
    sub_1CE6700(&Method_System_Collections_ObjectModel_Collection_GachaSubEntity__get_Count__);
    sub_1CE6700(&Method_System_Collections_ObjectModel_Collection_GachaSubEntity__get_Item__);
  ...
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            ...
            (const MethodInfo_3480AB0 *)Method_System_Collections_ObjectModel_Collection_GachaSubEntity__get_Count__);
  if ( Count >= 1 )
  {
    v11 = Count;
    v12 = 0;
    ...
    while ( 1 )
    {
      ...
      Instance = (DataManager_o *)System_Collections_ObjectModel_Collection_object___get_Item(
                                    ...
                                    v13,
                                    (const MethodInfo_3480B40 *)Method_System_Collections_ObjectModel_Collection_GachaSubEntity__get_Item__);
      if ( !Instance )
        break;
...
LABEL_22:
    sub_1CE6958(Instance, saveNameList_low);
  }
  return 0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E04E16 & 1) == 0 )
  {
    sub_1CE6700(&Method_DataMasterBase_GachaSubMaster__GachaSubEntity__string__TryGetEntity__);
    byte_4E04E16 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_34EE208 *)Method_DataMasterBase_GachaSubMaster__GachaSubEntity__string__TryGetEntity__);
}