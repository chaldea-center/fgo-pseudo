void __fastcall GachaSubMaster___ctor(GachaSubMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A70121 & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_GachaSubMaster__GachaSubEntity__string___ctor__, method);
    byte_4A70121 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    187,
    (const MethodInfo_312C8C0 *)Method_DataMasterBase_GachaSubMaster__GachaSubEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A7011F & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_GachaSubMaster__GachaSubEntity__string__GetEntity__, *(_QWORD *)&gachaId);
    byte_4A7011F = 1;
  }
  ...
  return (GachaSubEntity_o *)DataMasterBase_object__object__object___GetEntity(
                               (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                               PK,
                               (const MethodInfo_312C900 *)Method_DataMasterBase_GachaSubMaster__GachaSubEntity__string__GetEntity__);
}
...
GachaSubEntity_o *__fastcall GachaSubMaster__GetFriendPointGachaImageInfo(
        ...
        const MethodInfo *method)
{
  return GachaSubMaster__GetOpenEntity_39415024(this, gachaId, nowTime, method);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A70122 & 1) == 0 )
  {
    sub_1B90010(&NetworkManager_TypeInfo, *(_QWORD *)&gachaId);
    byte_4A70122 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  Time = NetworkManager__getTime(0LL);
  return GachaSubMaster__GetOpenEntity_39415024(this, gachaId, Time, v6);
}


// local variable allocation has failed, the output may be wrong!
GachaSubEntity_o *__fastcall GachaSubMaster__GetOpenEntity_39415024(
        GachaSubMaster_o *this,
        int32_t gachaId,
        int64_t checkTime,
        const MethodInfo *method)
{
  ...
  if ( (byte_4A70123 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_DataManager_GetMasterData_CommonReleaseMaster___, v8);
    sub_1B90010(&GachaSubEntity_TypeInfo, v9);
...
LABEL_24:
    sub_1B9026C(Instance, masterDataBytes_low);
  }
  return 0LL;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A70120 & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_GachaSubMaster__GachaSubEntity__string__TryGetEntity__, entity);
    byte_4A70120 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_312C950 *)Method_DataMasterBase_GachaSubMaster__GachaSubEntity__string__TryGetEntity__);
}