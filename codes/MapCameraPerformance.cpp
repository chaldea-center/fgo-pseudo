        ...
        const MethodInfo *method)
{
  ...
  sub_1B71570(v13, (int32_t)mapCamera, v14, v15);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A214A9 & 1) == 0 )
  {
    sub_1B715CC(&MapCameraPerformance__Execute_d__6_TypeInfo, method);
    byte_4A214A9 = 1;
  }
  v3 = sub_1B71818(MapCameraPerformance__Execute_d__6_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A214AA & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_System_Nullable_Vector2__GetValueOrDefault__, v4);
    sub_1B715CC(&Method_System_Nullable_Vector3___ctor__, v5);
    sub_1B715CC(&Method_System_Nullable_Vector2__get_HasValue__, v6);
    sub_1B715CC(&UnityEngine_Object_TypeInfo, v7);
    sub_1B715CC(&Method_MapCameraPerformance___c__DisplayClass6_0__Execute_b__0__, v8);
    sub_1B715CC(&Method_MapCameraPerformance___c__DisplayClass6_0__Execute_b__1__, v9);
    sub_1B715CC(&MapCameraPerformance___c__DisplayClass6_0_TypeInfo, v10);
    sub_1B715CC(&UnityEngine_WaitUntil_TypeInfo, v11);
    byte_4A214AA = 1;
  }
  ...
  else
  {
    ...
    v14 = sub_1B71818(MapCameraPerformance___c__DisplayClass6_0_TypeInfo);
...
LABEL_17:
    ...
    *(_QWORD *)&v36.fields.value.fields.y = v22;
    ...
    sub_1B71570((ServantStatusBattleListViewItem_o *)p__2__current, (int32_t)v28, v30, v31);
    result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B715E0(&Method_MapCameraPerformance__Execute_d__6_System_Collections_IEnumerator_Reset__);
  sub_1B716F4(v3, v4);
}
