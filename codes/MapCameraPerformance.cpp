        ...
        const MethodInfo *method)
{
  ...
  sub_1B00C70(v13, (int32_t)mapCamera, v14, v15);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E411B & 1) == 0 )
  {
    sub_1B00CCC(&MapCameraPerformance__Execute_d__6_TypeInfo, method);
    byte_48E411B = 1;
  }
  v3 = sub_1B00F18(MapCameraPerformance__Execute_d__6_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E411C & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_System_Nullable_Vector2__GetValueOrDefault__, v4);
    sub_1B00CCC(&Method_System_Nullable_Vector3___ctor__, v5);
    sub_1B00CCC(&Method_System_Nullable_Vector2__get_HasValue__, v6);
    sub_1B00CCC(&UnityEngine_Object_TypeInfo, v7);
    sub_1B00CCC(&Method_MapCameraPerformance___c__DisplayClass6_0__Execute_b__0__, v8);
    sub_1B00CCC(&Method_MapCameraPerformance___c__DisplayClass6_0__Execute_b__1__, v9);
    sub_1B00CCC(&MapCameraPerformance___c__DisplayClass6_0_TypeInfo, v10);
    sub_1B00CCC(&UnityEngine_WaitUntil_TypeInfo, v11);
    byte_48E411C = 1;
  }
  ...
  else
  {
    ...
    v14 = sub_1B00F18(MapCameraPerformance___c__DisplayClass6_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B00CE0(&Method_MapCameraPerformance__Execute_d__6_System_Collections_IEnumerator_Reset__);
  sub_1B00DF4(v3, v4);
}
