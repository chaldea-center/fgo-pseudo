        ...
        const MethodInfo *method)
{
  ...
  sub_1D0F058(v13, (int32_t)mapCamera, v14, v15, v16, v17, v18, v19);
...
System_Collections_IEnumerator_o *MapCameraPerformance__Execute(MapCameraPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E7933A & 1) == 0 )
  {
    sub_1D0F0B4(&MapCameraPerformance__Execute_d__6_TypeInfo);
    byte_4E7933A = 1;
  }
  v3 = sub_1D0F300(MapCameraPerformance__Execute_d__6_TypeInfo);
...
bool MapCameraPerformance__Execute_d__6__MoveNext(MapCameraPerformance__Execute_d__6_o *this, const MethodInfo *method)
{
  ...
  const MethodInfo_3A88EAC *v9; // x2
  bool result; // w0
  MapCamera_o *v11; // x21
  float v12; // s8
  __int64 v13; // x22
  ...
  if ( (byte_4E7933B & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_System_Nullable_Vector2__GetValueOrDefault__);
    sub_1D0F0B4(&Method_System_Nullable_Vector3___ctor__);
    sub_1D0F0B4(&Method_System_Nullable_Vector2__get_HasValue__);
    sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    sub_1D0F0B4(&Method_MapCameraPerformance___c__DisplayClass6_0__Execute_b__0__);
    sub_1D0F0B4(&Method_MapCameraPerformance___c__DisplayClass6_0__Execute_b__1__);
    sub_1D0F0B4(&MapCameraPerformance___c__DisplayClass6_0_TypeInfo);
  ...
  else
  {
    ...
    v5 = sub_1D0F300(MapCameraPerformance___c__DisplayClass6_0_TypeInfo);
...
LABEL_17:
    ...
    *(_QWORD *)&v31.fields.value.fields.y = v13;
    ...
    v19 = (System_Func_bool__o *)sub_1D0F300(System_Func_bool__TypeInfo);
    System_Func_bool____ctor(
      v19,
      (Il2CppObject *)v5,
      Method_MapCameraPerformance___c__DisplayClass6_0__Execute_b__1__,
      0);
    v20 = (UnityEngine_WaitUntil_o *)sub_1D0F300(UnityEngine_WaitUntil_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1D0F0C8(&Method_MapCameraPerformance__Execute_d__6_System_Collections_IEnumerator_Reset__);
  sub_1D0F1DC(v3, v4);
}
