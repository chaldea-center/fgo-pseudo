...
void __fastcall CharaGraphSortOwnerBase__DeleteContinueData(CharaGraphSortOwnerBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFCB0C & 1) == 0 )
  {
    sub_1C2E12C(&System_Action_CharaGraphSortManageUnitBase__TypeInfo, method);
    sub_1C2E12C(&Method_BasicHelper_ForEach_CharaGraphSortManageUnitBase___, v3);
    sub_1C2E12C(&Method_CharaGraphSortOwnerBase__DeleteContinueData_b__24_0__, v4);
    sub_1C2E12C(&Method_CharaGraphSortOwnerBase___c__DeleteContinueData_b__24_1__, v5);
    sub_1C2E12C(&CharaGraphSortOwnerBase___c_TypeInfo, v6);
    byte_4BFCB0C = 1;
  }
  ...
  if ( !System_String__IsNullOrEmpty(v7, 0LL) )
  {
    SortManageUnitArray = (System_Collections_Generic_IEnumerable_T__o *)CharaGraphSortOwnerBase__GetSortManageUnitArray(
                                                                           this,
                                                                           v8);
    v10 = (System_Action_object__o *)sub_1C2E378(System_Action_CharaGraphSortManageUnitBase__TypeInfo);
    ...
    BasicHelper__ForEach_object_(
      ...
      (const MethodInfo_2FBE538 *)Method_BasicHelper_ForEach_CharaGraphSortManageUnitBase___);
    ...
    if ( !_9__24_1 )
    {
      ...
      _9__24_1 = (System_Action_object__o *)sub_1C2E378(System_Action_CharaGraphSortManageUnitBase__TypeInfo);
...
void __fastcall CharaGraphSortOwnerBase__DeleteContinueData_39363168(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFCB0B & 1) == 0 )
  {
    sub_1C2E12C(&CharaGraphSortManageUnitBase___TypeInfo, method);
    byte_4BFCB0B = 1;
  }
  v3 = sub_1C2E1D4(CharaGraphSortManageUnitBase___TypeInfo, 4LL);
  if ( !v3 )
    sub_1C2E388(0LL, v4);
  ...
  {
    v3 = sub_1C2E268(this->fields._ServantSortManageUnit_k__BackingField, *(_QWORD *)(*(_QWORD *)v3 + 64LL));
    if ( !v3 )
      goto LABEL_18;
  }
  if ( !v12->max_length )
  ...
  {
    v3 = sub_1C2E268(this->fields._ServantEquipSortManageUnit_k__BackingField, v12->obj.klass->_1.element_class);
    if ( !v3 )
      goto LABEL_18;
  }
  if ( v12->max_length <= 1 )
  ...
  {
    v3 = sub_1C2E268(this->fields._CommandCodeSortManageUnit_k__BackingField, v12->obj.klass->_1.element_class);
    if ( !v3 )
      goto LABEL_18;
  }
  if ( v12->max_length <= 2 )
  ...
  {
    v3 = sub_1C2E268(ServantCollectionSortManageUnit_k__BackingField, v12->obj.klass->_1.element_class);
    if ( !v3 )
    {
LABEL_18:
      v35 = sub_1C2E3AC(v3);
...
void __fastcall CharaGraphSortOwnerBase__Save(CharaGraphSortOwnerBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFCB0D & 1) == 0 )
  {
    sub_1C2E12C(&System_Action_CharaGraphSortManageUnitBase__TypeInfo, method);
    sub_1C2E12C(&Method_BasicHelper_ForEach_CharaGraphSortManageUnitBase___, v3);
    sub_1C2E12C(&Method_CharaGraphSortOwnerBase__Save_b__25_0__, v4);
    sub_1C2E12C(&Method_CharaGraphSortOwnerBase___c__Save_b__25_1__, v5);
    sub_1C2E12C(&CharaGraphSortOwnerBase___c_TypeInfo, v6);
    byte_4BFCB0D = 1;
  }
  v7 = (System_String_o *)((__int64 (__fastcall *)(CharaGraphSortOwnerBase_o *, const char *))this->klass[1]._1.gc_desc)(
  ...
  if ( !System_String__IsNullOrEmpty(v7, 0LL) )
  {
    ...
    if ( !_9__25_1 )
    {
      ...
      v13 = (Il2CppObject *)v11->static_fields->__9;
      _9__25_1 = (System_Action_object__o *)sub_1C2E378(System_Action_CharaGraphSortManageUnitBase__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( x )
  {
    ...
    sub_1C2E0D0((PartyOrganizationUtility_o *)&x->fields, (int64_t)v4, v5, v6, v7, v8, v9, v10);
  }
}
...
void __fastcall CharaGraphSortOwnerBase___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BFCB0E & 1) == 0 )
  {
    sub_1C2E12C(&CharaGraphSortOwnerBase___c_TypeInfo, v1);
    byte_4BFCB0E = 1;
  }
  v2 = (Il2CppObject *)sub_1C2E378(CharaGraphSortOwnerBase___c_TypeInfo);
