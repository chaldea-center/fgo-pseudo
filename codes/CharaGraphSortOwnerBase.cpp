...
void CharaGraphSortOwnerBase__DeleteContinueData(CharaGraphSortOwnerBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C56090 & 1) == 0 )
  {
    sub_1C3E564(&System_Action_CharaGraphSortManageUnitBase__TypeInfo);
    sub_1C3E564(&Method_BasicHelper_ForEach_CharaGraphSortManageUnitBase___);
    sub_1C3E564(&Method_CharaGraphSortOwnerBase___c__DeleteContinueData_b__26_0__);
    sub_1C3E564(&CharaGraphSortOwnerBase___c_TypeInfo);
    byte_4C56090 = 1;
  }
  ...
  if ( !System_String__IsNullOrEmpty(v3, 0) )
  {
    ...
    if ( !_9__26_0 )
    {
      ...
      _9__26_0 = (System_Action_object__o *)sub_1C3E7B0(System_Action_CharaGraphSortManageUnitBase__TypeInfo);
      ...
      sub_1C3E508((CGThumbnailListItem_o *)&static_fields->__9__26_0, (int32_t)_9__26_0, v10, v11);
    }
    BasicHelper__ForEach_object_(
      SortManageUnitArray,
      (System_Action_T__o *)_9__26_0,
      (const MethodInfo_30E5A30 *)Method_BasicHelper_ForEach_CharaGraphSortManageUnitBase___);
  }
}


void CharaGraphSortOwnerBase__DeleteContinueData_40868832(
        ...
        const MethodInfo *method)
{
  ...
  CharaGraphSortManageUnitBase_o *v11; // x21
  int32_t v12; // w2
  const MethodInfo *v13; // x3
  CharaGraphSortManageUnitBase_o *v14; // x21
  int32_t v15; // w2
  const MethodInfo *v16; // x3
  CharaGraphSortManageUnitBase_o *v17; // x20
  __int64 v19; // x0

  if ( (byte_4C5608E & 1) == 0 )
  {
    sub_1C3E564(&CharaGraphSortManageUnitBase___TypeInfo);
    byte_4C5608E = 1;
  }
  v3 = (CharaGraphSortManageUnitBase_array *)sub_1C3E60C(CharaGraphSortManageUnitBase___TypeInfo, 4);
  ...
  if ( v4 )
  {
    v4 = sub_1C3E6A0(v4, v3->obj.klass->_1.element_class);
    if ( !v4 )
      goto LABEL_18;
  }
  if ( !LODWORD(v3->max_length) )
    goto LABEL_17;
  v3->m_Items[0] = v8;
  sub_1C3E508((CGThumbnailListItem_o *)v3->m_Items, (int32_t)v8, v6, v7);
  ...
  v11 = (CharaGraphSortManageUnitBase_o *)v4;
  if ( v4 )
  {
    v4 = sub_1C3E6A0(v4, v3->obj.klass->_1.element_class);
    if ( !v4 )
  ...
  if ( LODWORD(v3->max_length) <= 1 )
    goto LABEL_17;
  v3->m_Items[1] = v11;
  sub_1C3E508((CGThumbnailListItem_o *)&v3->m_Items[1], (int32_t)v11, v9, v10);
  ...
  if ( LODWORD(v3->max_length) <= 2 )
    goto LABEL_17;
  v3->m_Items[2] = v14;
  sub_1C3E508((CGThumbnailListItem_o *)&v3->m_Items[2], (int32_t)v14, v12, v13);
  ...
  v17 = (CharaGraphSortManageUnitBase_o *)v4;
  if ( v4 )
  {
    v4 = sub_1C3E6A0(v4, v3->obj.klass->_1.element_class);
    if ( !v4 )
...
LABEL_17:
    sub_1C3E7C8(v4, v5);
  v3->m_Items[3] = v17;
  sub_1C3E508((CGThumbnailListItem_o *)&v3->m_Items[3], (int32_t)v17, v15, v16);
  return v3;
}
...
void CharaGraphSortOwnerBase__Save(CharaGraphSortOwnerBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C56091 & 1) == 0 )
  {
    sub_1C3E564(&System_Action_CharaGraphSortManageUnitBase__TypeInfo);
    sub_1C3E564(&Method_BasicHelper_ForEach_CharaGraphSortManageUnitBase___);
    sub_1C3E564(&Method_CharaGraphSortOwnerBase___c__Save_b__27_0__);
    sub_1C3E564(&CharaGraphSortOwnerBase___c_TypeInfo);
    byte_4C56091 = 1;
  }
  v3 = (System_String_o *)((__int64 (__fastcall *)(CharaGraphSortOwnerBase_o *, const MethodInfo *))this->klass->vtable._4_unknown.methodPtr)(
  ...
  if ( !System_String__IsNullOrEmpty(v3, 0) )
  {
    ...
    if ( !_9__27_0 )
    {
      ...
      v8 = (Il2CppObject *)v6->static_fields->__9;
      _9__27_0 = (System_Action_object__o *)sub_1C3E7B0(System_Action_CharaGraphSortManageUnitBase__TypeInfo);
      ...
      sub_1C3E508((CGThumbnailListItem_o *)&static_fields->__9__27_0, (int32_t)_9__27_0, v10, v11);
    }
    BasicHelper__ForEach_object_(
      SortManageUnitArray,
...
void CharaGraphSortOwnerBase__SetSortSaveKeyPrefix(CharaGraphSortOwnerBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C5608F & 1) == 0 )
  {
    sub_1C3E564(&System_Action_CharaGraphSortManageUnitBase__TypeInfo);
    sub_1C3E564(&Method_BasicHelper_ForEach_CharaGraphSortManageUnitBase___);
    sub_1C3E564(&Method_CharaGraphSortOwnerBase__SetSortSaveKeyPrefix_b__24_0__);
    byte_4C5608F = 1;
  }
  SortManageUnitArray = (System_Collections_Generic_IEnumerable_T__o *)CharaGraphSortOwnerBase__GetSortManageUnitArray(
                                                                         this,
                                                                         method);
  v4 = (System_Action_object__o *)sub_1C3E7B0(System_Action_CharaGraphSortManageUnitBase__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields._CurrentSortManageUnit_k__BackingField, (int32_t)v4, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( x )
  {
    ...
    sub_1C3E508((CGThumbnailListItem_o *)&x->fields, (int32_t)v4, v5, v6);
  }
}
...
void CharaGraphSortOwnerBase___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C3E7B0(CharaGraphSortOwnerBase___c_TypeInfo);
  System_Object___ctor(v1, 0);
  CharaGraphSortOwnerBase___c_TypeInfo->static_fields->__9 = (struct CharaGraphSortOwnerBase___c_o *)v1;
  sub_1C3E508((CGThumbnailListItem_o *)CharaGraphSortOwnerBase___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
