...
void CharaGraphSortOwnerBase__DeleteContinueData(CharaGraphSortOwnerBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C26626 & 1) == 0 )
  {
    sub_1C2D490(&System_Action_CharaGraphSortManageUnitBase__TypeInfo);
    sub_1C2D490(&Method_BasicHelper_ForEach_CharaGraphSortManageUnitBase___);
    sub_1C2D490(&Method_CharaGraphSortOwnerBase___c__DeleteContinueData_b__26_0__);
    sub_1C2D490(&CharaGraphSortOwnerBase___c_TypeInfo);
    byte_4C26626 = 1;
  }
  ...
  if ( !System_String__IsNullOrEmpty(v3, 0) )
  {
    ...
    if ( !_9__26_0 )
    {
      ...
      _9__26_0 = (System_Action_object__o *)sub_1C2D6DC(System_Action_CharaGraphSortManageUnitBase__TypeInfo);
      ...
      sub_1C2D434((CGThumbnailListItem_o *)&static_fields->__9__26_0, (int32_t)_9__26_0, v10, v11);
    }
    BasicHelper__ForEach_object_(
      SortManageUnitArray,
      (System_Action_T__o *)_9__26_0,
      (const MethodInfo_30BA910 *)Method_BasicHelper_ForEach_CharaGraphSortManageUnitBase___);
  }
}


void CharaGraphSortOwnerBase__DeleteContinueData_40600764(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C26624 & 1) == 0 )
  {
    sub_1C2D490(&CharaGraphSortManageUnitBase___TypeInfo);
    byte_4C26624 = 1;
  }
  v3 = (CharaGraphSortManageUnitBase_array *)sub_1C2D538(CharaGraphSortManageUnitBase___TypeInfo, 4);
  ...
  if ( v4 )
  {
    v4 = sub_1C2D5CC(v4, v3->obj.klass->_1.element_class);
    if ( !v4 )
      goto LABEL_18;
  }
  if ( !LODWORD(v3->max_length) )
    goto LABEL_17;
  v3->m_Items[0] = v8;
  sub_1C2D434((CGThumbnailListItem_o *)v3->m_Items, (int32_t)v8, v6, v7);
  ...
  if ( LODWORD(v3->max_length) <= 1 )
    goto LABEL_17;
  v3->m_Items[1] = v10;
  sub_1C2D434((CGThumbnailListItem_o *)&v3->m_Items[1], (int32_t)v10, v6, v9);
  ...
  if ( LODWORD(v3->max_length) <= 2 )
    goto LABEL_17;
  v3->m_Items[2] = v12;
  sub_1C2D434((CGThumbnailListItem_o *)&v3->m_Items[2], (int32_t)v12, v6, v11);
...
LABEL_17:
  ...
  v3->m_Items[3] = v14;
  sub_1C2D434((CGThumbnailListItem_o *)&v3->m_Items[3], (int32_t)v14, v6, v13);
  return v3;
}
...
void CharaGraphSortOwnerBase__Save(CharaGraphSortOwnerBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C26627 & 1) == 0 )
  {
    sub_1C2D490(&System_Action_CharaGraphSortManageUnitBase__TypeInfo);
    sub_1C2D490(&Method_BasicHelper_ForEach_CharaGraphSortManageUnitBase___);
    sub_1C2D490(&Method_CharaGraphSortOwnerBase___c__Save_b__27_0__);
    sub_1C2D490(&CharaGraphSortOwnerBase___c_TypeInfo);
    byte_4C26627 = 1;
  }
  v3 = (System_String_o *)((__int64 (__fastcall *)(CharaGraphSortOwnerBase_o *, const MethodInfo *))this->klass->vtable._4_unknown.methodPtr)(
  ...
  if ( !System_String__IsNullOrEmpty(v3, 0) )
  {
    ...
    if ( !_9__27_0 )
    {
      ...
      v8 = (Il2CppObject *)v6->static_fields->__9;
      _9__27_0 = (System_Action_object__o *)sub_1C2D6DC(System_Action_CharaGraphSortManageUnitBase__TypeInfo);
      ...
      sub_1C2D434((CGThumbnailListItem_o *)&static_fields->__9__27_0, (int32_t)_9__27_0, v10, v11);
    }
    BasicHelper__ForEach_object_(
      SortManageUnitArray,
...
void CharaGraphSortOwnerBase__SetSortSaveKeyPrefix(CharaGraphSortOwnerBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C26625 & 1) == 0 )
  {
    sub_1C2D490(&System_Action_CharaGraphSortManageUnitBase__TypeInfo);
    sub_1C2D490(&Method_BasicHelper_ForEach_CharaGraphSortManageUnitBase___);
    sub_1C2D490(&Method_CharaGraphSortOwnerBase__SetSortSaveKeyPrefix_b__24_0__);
    byte_4C26625 = 1;
  }
  SortManageUnitArray = (System_Collections_Generic_IEnumerable_T__o *)CharaGraphSortOwnerBase__GetSortManageUnitArray(
                                                                         this,
                                                                         method);
  v4 = (System_Action_object__o *)sub_1C2D6DC(System_Action_CharaGraphSortManageUnitBase__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields._CurrentSortManageUnit_k__BackingField, (int32_t)v4, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( x )
  {
    ...
    sub_1C2D434((CGThumbnailListItem_o *)&x->fields, (int32_t)v4, v5, v6);
  }
}
...
void CharaGraphSortOwnerBase___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C2D6DC(CharaGraphSortOwnerBase___c_TypeInfo);
  System_Object___ctor(v1, 0);
  CharaGraphSortOwnerBase___c_TypeInfo->static_fields->__9 = (struct CharaGraphSortOwnerBase___c_o *)v1;
  sub_1C2D434((CGThumbnailListItem_o *)CharaGraphSortOwnerBase___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
