...
void __fastcall CharaGraphSortOwnerBase__DeleteContinueData(CharaGraphSortOwnerBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5A561 & 1) == 0 )
  {
    sub_1B885B0(&System_Action_CharaGraphSortManageUnitBase__TypeInfo);
    sub_1B885B0(&Method_BasicHelper_ForEach_CharaGraphSortManageUnitBase___);
    sub_1B885B0(&Method_CharaGraphSortOwnerBase__DeleteContinueData_b__24_0__);
    sub_1B885B0(&Method_CharaGraphSortOwnerBase___c__DeleteContinueData_b__24_1__);
    sub_1B885B0(&CharaGraphSortOwnerBase___c_TypeInfo);
    byte_4A5A561 = 1;
  }
  ...
  if ( !System_String__IsNullOrEmpty(v3, 0LL) )
  {
    SortManageUnitArray = (System_Collections_Generic_IEnumerable_T__o *)CharaGraphSortOwnerBase__GetSortManageUnitArray(
                                                                           this,
                                                                           v4);
    v6 = (System_Action_object__o *)sub_1B887FC(System_Action_CharaGraphSortManageUnitBase__TypeInfo);
    ...
    BasicHelper__ForEach_object_(
      ...
      (const MethodInfo_2E6CCC0 *)Method_BasicHelper_ForEach_CharaGraphSortManageUnitBase___);
    ...
    if ( !_9__24_1 )
    {
      ...
      _9__24_1 = (System_Action_object__o *)sub_1B887FC(System_Action_CharaGraphSortManageUnitBase__TypeInfo);
      ...
      sub_1B88554((ServantStatusBattleListViewItem_o *)&static_fields->__9__24_1, (int32_t)_9__24_1, v11, v12);
    }
    BasicHelper__ForEach_object_(
      SortManageUnitArray,
...
void __fastcall CharaGraphSortOwnerBase__DeleteContinueData_38045608(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A560 & 1) == 0 )
  {
    sub_1B885B0(&CharaGraphSortManageUnitBase___TypeInfo);
    byte_4A5A560 = 1;
  }
  v3 = sub_1B88658(CharaGraphSortManageUnitBase___TypeInfo, 4LL);
  if ( !v3 )
    sub_1B8880C(0LL, v4);
  ...
  {
    v3 = sub_1B886EC(this->fields._ServantSortManageUnit_k__BackingField, *(_QWORD *)(*(_QWORD *)v3 + 64LL));
    if ( !v3 )
      goto LABEL_18;
  }
  if ( !v8->max_length )
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)v8->m_Items, (int32_t)ServantSortManageUnit_k__BackingField, v5, v6);
  ...
  {
    v3 = sub_1B886EC(this->fields._ServantEquipSortManageUnit_k__BackingField, v8->obj.klass->_1.element_class);
    if ( !v3 )
      goto LABEL_18;
  }
  if ( v8->max_length <= 1 )
  ...
  {
    v3 = sub_1B886EC(this->fields._CommandCodeSortManageUnit_k__BackingField, v8->obj.klass->_1.element_class);
    if ( !v3 )
      goto LABEL_18;
  }
  if ( v8->max_length <= 2 )
  ...
  {
    v3 = sub_1B886EC(ServantCollectionSortManageUnit_k__BackingField, v8->obj.klass->_1.element_class);
    if ( !v3 )
    {
LABEL_18:
      v19 = sub_1B88830(v3);
...
void __fastcall CharaGraphSortOwnerBase__Save(CharaGraphSortOwnerBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5A562 & 1) == 0 )
  {
    sub_1B885B0(&System_Action_CharaGraphSortManageUnitBase__TypeInfo);
    sub_1B885B0(&Method_BasicHelper_ForEach_CharaGraphSortManageUnitBase___);
    sub_1B885B0(&Method_CharaGraphSortOwnerBase__Save_b__25_0__);
    sub_1B885B0(&Method_CharaGraphSortOwnerBase___c__Save_b__25_1__);
    sub_1B885B0(&CharaGraphSortOwnerBase___c_TypeInfo);
    byte_4A5A562 = 1;
  }
  v3 = (System_String_o *)((__int64 (__fastcall *)(CharaGraphSortOwnerBase_o *, const char *))this->klass[1]._1.gc_desc)(
  ...
  if ( !System_String__IsNullOrEmpty(v3, 0LL) )
  {
    ...
    if ( !_9__25_1 )
    {
      ...
      v9 = (Il2CppObject *)v7->static_fields->__9;
      _9__25_1 = (System_Action_object__o *)sub_1B887FC(System_Action_CharaGraphSortManageUnitBase__TypeInfo);
      ...
      sub_1B88554((ServantStatusBattleListViewItem_o *)&static_fields->__9__25_1, (int32_t)_9__25_1, v11, v12);
    }
    BasicHelper__ForEach_object_(
      SortManageUnitArray,
        ...
        const MethodInfo *method)
{
  ...
  if ( x )
  {
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)&x->fields, (int32_t)v4, v5, v6);
  }
}
...
void __fastcall CharaGraphSortOwnerBase___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1B887FC(CharaGraphSortOwnerBase___c_TypeInfo);
