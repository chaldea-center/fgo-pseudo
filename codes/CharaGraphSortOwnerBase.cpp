...
void __fastcall CharaGraphSortOwnerBase__DeleteContinueData(CharaGraphSortOwnerBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1B884 & 1) == 0 )
  {
    sub_1BCAFF8(&System_Action_CharaGraphSortManageUnitBase__TypeInfo, method);
    sub_1BCAFF8(&Method_BasicHelper_ForEach_CharaGraphSortManageUnitBase___, v3);
    sub_1BCAFF8(&Method_CharaGraphSortOwnerBase___c__DeleteContinueData_b__26_0__, v4);
    sub_1BCAFF8(&CharaGraphSortOwnerBase___c_TypeInfo, v5);
    byte_4B1B884 = 1;
  }
  ...
  if ( !System_String__IsNullOrEmpty(v6, 0LL) )
  {
    ...
    if ( !_9__26_0 )
    {
      ...
      _9__26_0 = (System_Action_object__o *)sub_1BCB244(System_Action_CharaGraphSortManageUnitBase__TypeInfo);
      ...
      sub_1BCAF9C((CGThumbnailListItem_o *)&static_fields->__9__26_0, (int32_t)_9__26_0, v13, v14);
    }
    BasicHelper__ForEach_object_(
      SortManageUnitArray,
      (System_Action_T__o *)_9__26_0,
      (const MethodInfo_3006B3C *)Method_BasicHelper_ForEach_CharaGraphSortManageUnitBase___);
  }
}


void __fastcall CharaGraphSortOwnerBase__DeleteContinueData_40009012(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B882 & 1) == 0 )
  {
    sub_1BCAFF8(&CharaGraphSortManageUnitBase___TypeInfo, method);
    byte_4B1B882 = 1;
  }
  v3 = (CharaGraphSortManageUnitBase_array *)sub_1BCB0A0(CharaGraphSortManageUnitBase___TypeInfo, 4LL);
  ...
  if ( v4 )
  {
    v4 = sub_1BCB134(v4, v3->obj.klass->_1.element_class);
    if ( !v4 )
      goto LABEL_18;
  }
  if ( !v3->max_length )
    goto LABEL_17;
  v3->m_Items[0] = v8;
  sub_1BCAF9C((CGThumbnailListItem_o *)v3->m_Items, (int32_t)v8, v6, v7);
  ...
  if ( v3->max_length <= 1 )
    goto LABEL_17;
  v3->m_Items[1] = v10;
  sub_1BCAF9C((CGThumbnailListItem_o *)&v3->m_Items[1], (int32_t)v10, v6, v9);
  ...
  if ( v3->max_length <= 2 )
    goto LABEL_17;
  v3->m_Items[2] = v12;
  sub_1BCAF9C((CGThumbnailListItem_o *)&v3->m_Items[2], (int32_t)v12, v6, v11);
...
LABEL_17:
  ...
  v3->m_Items[3] = v14;
  sub_1BCAF9C((CGThumbnailListItem_o *)&v3->m_Items[3], (int32_t)v14, v6, v13);
  return v3;
}
...
void __fastcall CharaGraphSortOwnerBase__Save(CharaGraphSortOwnerBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1B885 & 1) == 0 )
  {
    sub_1BCAFF8(&System_Action_CharaGraphSortManageUnitBase__TypeInfo, method);
    sub_1BCAFF8(&Method_BasicHelper_ForEach_CharaGraphSortManageUnitBase___, v3);
    sub_1BCAFF8(&Method_CharaGraphSortOwnerBase___c__Save_b__27_0__, v4);
    sub_1BCAFF8(&CharaGraphSortOwnerBase___c_TypeInfo, v5);
    byte_4B1B885 = 1;
  }
  v6 = (System_String_o *)((__int64 (__fastcall *)(CharaGraphSortOwnerBase_o *, Il2CppMethodPointer))this->klass->vtable._4_unknown.method)(
  ...
  if ( !System_String__IsNullOrEmpty(v6, 0LL) )
  {
    ...
    if ( !_9__27_0 )
    {
      ...
      v11 = (Il2CppObject *)v9->static_fields->__9;
      _9__27_0 = (System_Action_object__o *)sub_1BCB244(System_Action_CharaGraphSortManageUnitBase__TypeInfo);
      ...
      sub_1BCAF9C((CGThumbnailListItem_o *)&static_fields->__9__27_0, (int32_t)_9__27_0, v13, v14);
    }
    BasicHelper__ForEach_object_(
      SortManageUnitArray,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B883 & 1) == 0 )
  {
    sub_1BCAFF8(&System_Action_CharaGraphSortManageUnitBase__TypeInfo, method);
    sub_1BCAFF8(&Method_BasicHelper_ForEach_CharaGraphSortManageUnitBase___, v3);
    sub_1BCAFF8(&Method_CharaGraphSortOwnerBase__SetSortSaveKeyPrefix_b__24_0__, v4);
    byte_4B1B883 = 1;
  }
  SortManageUnitArray = (System_Collections_Generic_IEnumerable_T__o *)CharaGraphSortOwnerBase__GetSortManageUnitArray(
                                                                         this,
                                                                         method);
  v6 = (System_Action_object__o *)sub_1BCB244(System_Action_CharaGraphSortManageUnitBase__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields._CurrentSortManageUnit_k__BackingField, (int32_t)v4, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( x )
  {
    ...
    sub_1BCAF9C((CGThumbnailListItem_o *)&x->fields, (int32_t)v4, v5, v6);
  }
}
...
void __fastcall CharaGraphSortOwnerBase___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B1B886 & 1) == 0 )
  {
    sub_1BCAFF8(&CharaGraphSortOwnerBase___c_TypeInfo, v1);
    byte_4B1B886 = 1;
  }
  v2 = (Il2CppObject *)sub_1BCB244(CharaGraphSortOwnerBase___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  CharaGraphSortOwnerBase___c_TypeInfo->static_fields->__9 = (struct CharaGraphSortOwnerBase___c_o *)v2;
  sub_1BCAF9C((CGThumbnailListItem_o *)CharaGraphSortOwnerBase___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
