void __fastcall UserEventBoardGameTokenMaster___ctor(UserEventBoardGameTokenMaster_o *this, const MethodInfo *method)
{
  ...
  DataMasterBase_object__object__object____ctor(
    ...
    309,
    (const MethodInfo_30F8A78 *)Method_DataMasterBase_UserEventBoardGameTokenMaster__UserEventBoardGameTokenEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (UserEventBoardGameTokenEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                              (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                              PK,
                                              (const MethodInfo_30F8AB8 *)Method_DataMasterBase_UserEventBoardGameTokenMaster__UserEventBoardGameTokenEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A206DB & 1) == 0 )
  {
    sub_1B715CC(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__GetEnumerator__, userId);
    ...
    sub_1B715CC(&Method_System_Collections_Generic_List_UserEventBoardGameTokenEntity__Add__, v8);
    sub_1B715CC(&Method_System_Collections_Generic_List_UserEventBoardGameTokenEntity__ToArray__, v9);
    sub_1B715CC(&Method_System_Collections_Generic_List_UserEventBoardGameTokenEntity___ctor__, v10);
    sub_1B715CC(&System_Collections_Generic_List_UserEventBoardGameTokenEntity__TypeInfo, v11);
    sub_1B715CC(&UserEventBoardGameTokenEntity_TypeInfo, v12);
    byte_4A206DB = 1;
  }
  v13 = (System_Collections_Generic_List_object__o *)sub_1B71818(System_Collections_Generic_List_UserEventBoardGameTokenEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v13,
    (const MethodInfo_34CFA2C *)Method_System_Collections_Generic_List_UserEventBoardGameTokenEntity___ctor__);
...
LABEL_36:
      ...
      if ( v26[1].klass == (Il2CppClass *)userId )
      {
        ...
        else
        {
          ...
          sub_1B71570((ServantStatusBattleListViewItem_o *)(v35 + 4), (int32_t)v29, v27, v28);
        }
      }
    }
  }
...
LABEL_38:
  ...
  return (UserEventBoardGameTokenEntity_array *)System_Collections_Generic_List_object___ToArray(
                                                  v13,
                                                  (const MethodInfo_34D1DB8 *)Method_System_Collections_Generic_List_UserEventBoardGameTokenEntity__ToArray__);
}


UserEventBoardGameTokenEntity_array *__fastcall UserEventBoardGameTokenMaster__GetList_39856528(
        UserEventBoardGameTokenMaster_o *this,
        const MethodInfo *method)
{
  int64_t UserId; // x1
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A206DE & 1) == 0 )
  {
    sub_1B715CC(&Method_DataManager_GetMasterData_EventBoardGameTokenMaster___, *(_QWORD *)&gameFlagVal);
  ...
  Instance = UserEventBoardGameTokenMaster__GetList_39856528(this, v11);
  if ( !Instance )
    goto LABEL_16;
        ...
        const MethodInfo *method)
{
  ...
  System_Object_array *List_39856528; // x19
  System_Func_object__bool__o *v12; // x20

  if ( (byte_4A206DD & 1) == 0 )
  {
    sub_1B715CC(&Method_BasicHelper_Any_UserEventBoardGameTokenEntity___, *(_QWORD *)&tokenId);
    sub_1B715CC(&System_Func_UserEventBoardGameTokenEntity__bool__TypeInfo, v5);
    sub_1B715CC(&Method_UserEventBoardGameTokenMaster___c__DisplayClass5_0__IsHavingToken_b__0__, v6);
    sub_1B715CC(&UserEventBoardGameTokenMaster___c__DisplayClass5_0_TypeInfo, v7);
    byte_4A206DD = 1;
  }
  v8 = sub_1B71818(UserEventBoardGameTokenMaster___c__DisplayClass5_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v8, 0LL);
  if ( !v8 )
    sub_1B71828(v9, v10);
  *(_DWORD *)(v8 + 16) = tokenId;
  List_39856528 = (System_Object_array *)UserEventBoardGameTokenMaster__GetList_39856528(this, v10);
  v12 = (System_Func_object__bool__o *)sub_1B71818(System_Func_UserEventBoardGameTokenEntity__bool__TypeInfo);
  ...
  return BasicHelper__Any_object__48523356(
           ...
           (const MethodInfo_2E4685C *)Method_BasicHelper_Any_UserEventBoardGameTokenEntity___);
}
        ...
        const MethodInfo *method)
{
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_30F8B08 *)Method_DataMasterBase_UserEventBoardGameTokenMaster__UserEventBoardGameTokenEntity__string__TryGetEntity__);
}
