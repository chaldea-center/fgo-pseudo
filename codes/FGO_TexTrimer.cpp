void __fastcall FGO_TexTrimer___ctor(FGO_TexTrimer_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B65A4D & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_16764/*"_mainTex"*/, method);
    byte_4B65A4D = 1;
  }
  v9 = StringLiteral_16764/*"_mainTex"*/;
  this->fields.targetTexName = (struct System_String_o *)StringLiteral_16764/*"_mainTex"*/;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.targetTexName, v9, v2, v3, v4, v5, v6, v7);
...
void __fastcall FGO_TexTrimer__OnDestroy(FGO_TexTrimer_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(change_texture, 0LL, 0LL) )
  {
    ...
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    UnityEngine_Object__DestroyImmediate_70452188(v4, 0LL);
  }
}
...
void __fastcall FGO_TexTrimer__Start(FGO_TexTrimer_o *this, const MethodInfo *method)
{
  ...
  UnityEngine_Color_array *Pixels_70342752; // x22
  __int64 v10; // x0
  ...
  if ( (byte_4B65A4B & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&UnityEngine_Color_TypeInfo, v3);
    sub_1BE4ACC(&Method_UnityEngine_Component_GetComponent_Renderer___, v4);
  ...
  {
    Pixels_70342752 = UnityEngine_Texture2D__GetPixels_70342752((UnityEngine_Texture2D_o *)Component_object, 0LL);
    v10 = sub_1BE4B74(
      ...
      do
      {
        ...
        if ( StartXpx < EndXpx )
        {
          do
          {
            ...
            if ( v20 >= Pixels_70342752->max_length )
              sub_1BE4D30(Component_object, v7);
            v33 = *(_OWORD *)&Pixels_70342752->m_Items[v20].fields.g;
            Component_object = j_il2cpp_value_box_0(UnityEngine_Color_TypeInfo, &v33, v17, v18, v19);
            if ( !v13 )
              goto LABEL_24;
            System_Array__SetValue_63653312(v13, (Il2CppObject *)Component_object, v15, 0LL);
            EndXpx = this->fields.EndXpx;
            ++StartXpx;
            ++v15;
          }
    ...
    v22 = (UnityEngine_Texture2D_o *)sub_1BE4D18(UnityEngine_Texture2D_TypeInfo);
    UnityEngine_Texture2D___ctor_70340176(v22, EndXpx - v21, EndYpx - StartYpx, 4, 0, 0LL);
    this->fields.change_texture = v22;
    p_change_texture = &this->fields.change_texture;
    sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.change_texture, (int64_t)v22, v24, v25, v26, v27, v28, v29);
    ...
    if ( change_texture )
    {
      ...
      if ( *p_change_texture )
      {
        UnityEngine_Texture2D__SetPixels_70341256(
        ...
        if ( *p_change_texture )
        {
          UnityEngine_Texture2D__Apply_70342028((UnityEngine_Texture2D_o *)Component_object, 0LL);
          Component_object = (__int64)UnityEngine_Component__GetComponent_object_(
                                        (UnityEngine_Component_o *)this,
                                        (const MethodInfo_2F4FBB4 *)Method_UnityEngine_Component_GetComponent_Renderer___);
          if ( Component_object )
