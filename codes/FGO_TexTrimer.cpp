void FGO_TexTrimer___ctor(FGO_TexTrimer_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E037D9 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_16721/*"_mainTex"*/);
    byte_4E037D9 = 1;
  }
  v9 = StringLiteral_16721/*"_mainTex"*/;
  this->fields.targetTexName = (struct System_String_o *)StringLiteral_16721/*"_mainTex"*/;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.targetTexName, v9, v2, v3, v4, v5, v6, v7);
...
void FGO_TexTrimer__OnDestroy(FGO_TexTrimer_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(change_texture, 0, 0) )
  {
    ...
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    UnityEngine_Object__DestroyImmediate_72918728(v4, 0);
  }
}
...
void FGO_TexTrimer__Start(FGO_TexTrimer_o *this, const MethodInfo *method)
{
  ...
  UnityEngine_Color_array *Pixels_72808700; // x22
  __int64 v7; // x0
  ...
  {
    Pixels_72808700 = UnityEngine_Texture2D__GetPixels_72808700((UnityEngine_Texture2D_o *)Component_object, 0);
    v7 = sub_1CE67A8(
      ...
      do
      {
        ...
        if ( StartXpx < EndXpx )
        {
          do
          {
            ...
            if ( v14 >= LODWORD(Pixels_72808700->max_length) )
              sub_1CE6960(Component_object);
            v27 = Pixels_72808700->m_Items[v14];
            Component_object = j_il2cpp_value_box_0(UnityEngine_Color_TypeInfo, &v27);
            if ( !v10 )
              goto LABEL_24;
            System_Array__SetValue_66781948(v10, (Il2CppObject *)Component_object, v12, 0);
            EndXpx = this->fields.EndXpx;
            ++StartXpx;
            ++v12;
          }
    ...
    v16 = (UnityEngine_Texture2D_o *)sub_1CE694C(UnityEngine_Texture2D_TypeInfo);
    UnityEngine_Texture2D___ctor_72806124(v16, EndXpx - v15, EndYpx - StartYpx, 4, 0, 0);
    this->fields.change_texture = v16;
    p_change_texture = &this->fields.change_texture;
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.change_texture, (int32_t)v16, v18, v19, v20, v21, v22, v23);
    ...
    if ( change_texture )
    {
      ...
      if ( *p_change_texture )
      {
        UnityEngine_Texture2D__SetPixels_72807204(
        ...
        if ( *p_change_texture )
        {
          UnityEngine_Texture2D__Apply_72807976((UnityEngine_Texture2D_o *)Component_object, 0);
          Component_object = (__int64)UnityEngine_Component__GetComponent_object_(
                                        (UnityEngine_Component_o *)this,
                                        (const MethodInfo_31FAB78 *)Method_UnityEngine_Component_GetComponent_Renderer___);
          if ( Component_object )
