void __fastcall FGO_TexTrimer___ctor(FGO_TexTrimer_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E1758 & 1) == 0 )
  {
    sub_1B00CCC(&StringLiteral_16320/*"_mainTex"*/, method);
    byte_48E1758 = 1;
  }
  v5 = StringLiteral_16320/*"_mainTex"*/;
  this->fields.targetTexName = (struct System_String_o *)StringLiteral_16320/*"_mainTex"*/;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.targetTexName, v5, v2, v3);
...
void __fastcall FGO_TexTrimer__OnDestroy(FGO_TexTrimer_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(change_texture, 0LL, 0LL) )
  {
    ...
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    UnityEngine_Object__DestroyImmediate_68077844(v4, 0LL);
  }
}
...
void __fastcall FGO_TexTrimer__Start(FGO_TexTrimer_o *this, const MethodInfo *method)
{
  ...
  UnityEngine_Color_array *Pixels_67968496; // x22
  __int64 v10; // x0
  ...
  if ( (byte_48E1756 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&UnityEngine_Color_TypeInfo, v3);
    sub_1B00CCC(&Method_UnityEngine_Component_GetComponent_Renderer___, v4);
  ...
  {
    Pixels_67968496 = UnityEngine_Texture2D__GetPixels_67968496((UnityEngine_Texture2D_o *)Component_object, 0LL);
    v10 = sub_1B00D74(
      ...
      do
      {
        ...
        if ( StartXpx < EndXpx )
        {
          do
          {
            ...
            if ( v20 >= Pixels_67968496->max_length )
              sub_1B00F30(Component_object, v7);
            v29 = *(_OWORD *)&Pixels_67968496->m_Items[v20].fields.g;
            Component_object = j_il2cpp_value_box_0(UnityEngine_Color_TypeInfo, &v29, v17, v18, v19);
            if ( !v13 )
              goto LABEL_24;
            System_Array__SetValue_61279316(v13, (Il2CppObject *)Component_object, v15, 0LL);
            EndXpx = this->fields.EndXpx;
            ++StartXpx;
            ++v15;
          }
    ...
    v22 = (UnityEngine_Texture2D_o *)sub_1B00F18(UnityEngine_Texture2D_TypeInfo);
    UnityEngine_Texture2D___ctor_67965920(v22, EndXpx - v21, EndYpx - StartYpx, 4, 0, 0LL);
    this->fields.change_texture = v22;
    p_change_texture = &this->fields.change_texture;
    sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.change_texture, (int32_t)v22, v24, v25);
    ...
    if ( change_texture )
    {
      ...
      if ( *p_change_texture )
      {
        UnityEngine_Texture2D__SetPixels_67967000(
        ...
        if ( *p_change_texture )
        {
          UnityEngine_Texture2D__Apply_67967772((UnityEngine_Texture2D_o *)Component_object, 0LL);
          Component_object = (__int64)UnityEngine_Component__GetComponent_object_(
                                        (UnityEngine_Component_o *)this,
                                        (const MethodInfo_2D596B4 *)Method_UnityEngine_Component_GetComponent_Renderer___);
          if ( Component_object )
