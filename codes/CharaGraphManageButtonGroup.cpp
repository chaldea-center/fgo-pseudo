void CharaGraphManageButtonGroup___ctor(CharaGraphManageButtonGroup_o *this, const MethodInfo *method)
{
  ...
  this->fields._MainButtonOnSpriteName_k__BackingField = (struct System_String_o *)StringLiteral_17850/*"button_select_reg"*/;
  sub_1CE66A4(
    ...
    v6,
    v7);
  v10 = StringLiteral_17851/*"button_select_unreg"*/;
  this->fields._MainButtonOffSpriteName_k__BackingField = (struct System_String_o *)StringLiteral_17851/*"button_select_unreg"*/;
  sub_1CE66A4(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E03D6B & 1) == 0 )
  {
    ...
    this = (CharaGraphManageButtonGroup_o *)sub_1CE6700(&StringLiteral_17835/*"button_allchoice_unreg"*/);
    byte_4E03D6B = 1;
  }
  v8 = isInit;
  ...
  CharaGraphManageButtonGroup__SetupButton(
    ...
    selectedModeKind == 2,
    (System_String_o *)StringLiteral_17836/*"button_alllock_reg"*/,
    (System_String_o *)StringLiteral_17837/*"button_alllock_unreg"*/,
    v8,
    v10);
  CharaGraphManageButtonGroup__SetupButton(
    v11,
    ...
    selectedModeKind == 3,
    (System_String_o *)StringLiteral_17834/*"button_allchoice_reg"*/,
    (System_String_o *)StringLiteral_17835/*"button_allchoice_unreg"*/,
    v8,
    v12);
  CharaGraphManageButtonGroup__SetupButton(
    v13,
    ...
    selectedModeKind == 4,
    (System_String_o *)StringLiteral_17848/*"button_push_reg"*/,
    (System_String_o *)StringLiteral_17849/*"button_push_unreg"*/,
    v8,
    v14);
}
