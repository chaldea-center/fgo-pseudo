void CharaGraphManageButtonGroup___ctor(CharaGraphManageButtonGroup_o *this, const MethodInfo *method)
{
  ...
  v5 = StringLiteral_17673/*"button_select_reg"*/;
  this->fields._MainButtonOnSpriteName_k__BackingField = (struct System_String_o *)StringLiteral_17673/*"button_select_reg"*/;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields._MainButtonOnSpriteName_k__BackingField, v5, v2, v3);
  v6 = StringLiteral_17674/*"button_select_unreg"*/;
  this->fields._MainButtonOffSpriteName_k__BackingField = (struct System_String_o *)StringLiteral_17674/*"button_select_unreg"*/;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields._MainButtonOffSpriteName_k__BackingField, v6, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C56096 & 1) == 0 )
  {
    ...
    this = (CharaGraphManageButtonGroup_o *)sub_1C3E564(&StringLiteral_17658/*"button_allchoice_unreg"*/);
    byte_4C56096 = 1;
  }
  v8 = isInit;
  ...
  CharaGraphManageButtonGroup__SetupButton(
    ...
    selectedModeKind == 2,
    (System_String_o *)StringLiteral_17659/*"button_alllock_reg"*/,
    (System_String_o *)StringLiteral_17660/*"button_alllock_unreg"*/,
    v8,
    v10);
  CharaGraphManageButtonGroup__SetupButton(
    v11,
    ...
    selectedModeKind == 3,
    (System_String_o *)StringLiteral_17657/*"button_allchoice_reg"*/,
    (System_String_o *)StringLiteral_17658/*"button_allchoice_unreg"*/,
    v8,
    v12);
  CharaGraphManageButtonGroup__SetupButton(
    v13,
    ...
    selectedModeKind == 4,
    (System_String_o *)StringLiteral_17671/*"button_push_reg"*/,
    (System_String_o *)StringLiteral_17672/*"button_push_unreg"*/,
    v8,
    v14);
}
