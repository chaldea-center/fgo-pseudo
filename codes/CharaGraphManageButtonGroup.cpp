void __fastcall CharaGraphManageButtonGroup___ctor(CharaGraphManageButtonGroup_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FD92D & 1) == 0 )
  {
    sub_1B64870(&StringLiteral_17595/*"button_select_reg"*/, method);
    sub_1B64870(&StringLiteral_17596/*"button_select_unreg"*/, v5);
    byte_49FD92D = 1;
  }
  v6 = StringLiteral_17595/*"button_select_reg"*/;
  this->fields._MainButtonOnSpriteName_k__BackingField = (struct System_String_o *)StringLiteral_17595/*"button_select_reg"*/;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields._MainButtonOnSpriteName_k__BackingField, v6, v2, v3);
  v7 = StringLiteral_17596/*"button_select_unreg"*/;
  this->fields._MainButtonOffSpriteName_k__BackingField = (struct System_String_o *)StringLiteral_17596/*"button_select_unreg"*/;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields._MainButtonOffSpriteName_k__BackingField, v7, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD92A & 1) == 0 )
  {
    sub_1B64870(&StringLiteral_17593/*"button_push_reg"*/, *(_QWORD *)&selectedModeKind);
    sub_1B64870(&StringLiteral_17594/*"button_push_unreg"*/, v8);
    sub_1B64870(&StringLiteral_17579/*"button_allchoice_reg"*/, v9);
    sub_1B64870(&StringLiteral_17582/*"button_alllock_unreg"*/, v10);
    sub_1B64870(&StringLiteral_17581/*"button_alllock_reg"*/, v11);
    this = (CharaGraphManageButtonGroup_o *)sub_1B64870(&StringLiteral_17580/*"button_allchoice_unreg"*/, v12);
    byte_49FD92A = 1;
  }
  v13 = isInit;
  ...
  CharaGraphManageButtonGroup__SetupButton(
    ...
    selectedModeKind == 2,
    (System_String_o *)StringLiteral_17581/*"button_alllock_reg"*/,
    (System_String_o *)StringLiteral_17582/*"button_alllock_unreg"*/,
    v13,
    v15);
  CharaGraphManageButtonGroup__SetupButton(
    v16,
    ...
    selectedModeKind == 3,
    (System_String_o *)StringLiteral_17579/*"button_allchoice_reg"*/,
    (System_String_o *)StringLiteral_17580/*"button_allchoice_unreg"*/,
    v13,
    v17);
  CharaGraphManageButtonGroup__SetupButton(
    v18,
    ...
    selectedModeKind == 4,
    (System_String_o *)StringLiteral_17593/*"button_push_reg"*/,
    (System_String_o *)StringLiteral_17594/*"button_push_unreg"*/,
    v13,
    v19);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B64814(
    (ServantStatusBattleListViewItem_o *)&this->fields._MainButtonOffSpriteName_k__BackingField,
    (int32_t)value,
    (int32_t)method,
    v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B64814(
    (ServantStatusBattleListViewItem_o *)&this->fields._MainButtonOnSpriteName_k__BackingField,
    (int32_t)value,
    (int32_t)method,
    v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B64814(
    (ServantStatusBattleListViewItem_o *)&this->fields._OnClickScaleChange_k__BackingField,
    (int32_t)value,
    (int32_t)method,
    v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B64814(
    (ServantStatusBattleListViewItem_o *)&this->fields._OnClickTabChoice_k__BackingField,
    (int32_t)value,
    (int32_t)method,
    v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B64814(
    (ServantStatusBattleListViewItem_o *)&this->fields._OnClickTabLock_k__BackingField,
    (int32_t)value,
    (int32_t)method,
    v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B64814(
    (ServantStatusBattleListViewItem_o *)&this->fields._OnClickTabMain_k__BackingField,
    (int32_t)value,
    (int32_t)method,
    v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B64814(
    (ServantStatusBattleListViewItem_o *)&this->fields._OnClickTabPush_k__BackingField,
    (int32_t)value,
    (int32_t)method,
    v3);
}