        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45E97 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMaster_UserSvtCoinMaster___, itemEntity);
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields._ItemEntity_k__BackingField, (int32_t)itemEntity, v8, v9);
