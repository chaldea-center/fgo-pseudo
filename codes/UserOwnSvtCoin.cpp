        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4F872 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataManager_GetMaster_UserSvtCoinMaster___, itemEntity);
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields._ItemEntity_k__BackingField, (int32_t)itemEntity, v8, v9);
