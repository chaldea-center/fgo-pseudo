void ServantExceedEntity___ctor(ServantExceedEntity_o *this, const MethodInfo *method)
{
  ...
  v3 = sub_1D0F15C(string___TypeInfo, 8);
  if ( !v3 )
    sub_1D0F30C(0, v4);
  v11 = v3;
  if ( !*(_DWORD *)(v3 + 24) )
    goto LABEL_13;
  v12 = StringLiteral_18272/*"class_n_"*/;
  *(_QWORD *)(v3 + 32) = StringLiteral_18272/*"class_n_"*/;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)(v3 + 32), v12, v5, v6, v7, v8, v9, v10);
  if ( *(_DWORD *)(v11 + 24) <= 1u )
    goto LABEL_13;
  v19 = StringLiteral_18267/*"class_b_"*/;
  *(_QWORD *)(v11 + 40) = StringLiteral_18267/*"class_b_"*/;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)(v11 + 40), v19, v13, v14, v15, v16, v17, v18);
  if ( *(_DWORD *)(v11 + 24) <= 2u )
    goto LABEL_13;
  v26 = StringLiteral_18273/*"class_s_"*/;
  *(_QWORD *)(v11 + 48) = StringLiteral_18273/*"class_s_"*/;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)(v11 + 48), v26, v20, v21, v22, v23, v24, v25);
  if ( *(_DWORD *)(v11 + 24) <= 3u )
    goto LABEL_13;
  v33 = StringLiteral_18271/*"class_g_"*/;
  *(_QWORD *)(v11 + 56) = StringLiteral_18271/*"class_g_"*/;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)(v11 + 56), v33, v27, v28, v29, v30, v31, v32);
  if ( *(_DWORD *)(v11 + 24) <= 4u )
    goto LABEL_13;
  v40 = StringLiteral_18271/*"class_g_"*/;
  *(_QWORD *)(v11 + 64) = StringLiteral_18271/*"class_g_"*/;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)(v11 + 64), v40, v34, v35, v36, v37, v38, v39);
  if ( *(_DWORD *)(v11 + 24) <= 5u
    || (v47 = StringLiteral_18271/*"class_g_"*/,
        *(_QWORD *)(v11 + 72) = StringLiteral_18271/*"class_g_"*/,
        sub_1D0F058((GrandQuestFolderBoardItem_o *)(v11 + 72), v47, v41, v42, v43, v44, v45, v46),
        *(_DWORD *)(v11 + 24) <= 6u)
    || (v54 = StringLiteral_18272/*"class_n_"*/,
        *(_QWORD *)(v11 + 80) = StringLiteral_18272/*"class_n_"*/,
...
LABEL_13:
  ...
  v61 = StringLiteral_18272/*"class_n_"*/;
  *(_QWORD *)(v11 + 88) = StringLiteral_18272/*"class_n_"*/;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)(v11 + 88), v61, v55, v56, v57, v58, v59, v60);
  this->fields.frameCardFileList = (struct System_String_array *)v11;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields, v11, v62, v63, v64, v65, v66, v67);
