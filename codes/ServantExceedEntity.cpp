void __fastcall ServantExceedEntity___ctor(ServantExceedEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFDFBB & 1) == 0 )
  {
    ...
    sub_1C2E12C(&StringLiteral_18309/*"class_b_"*/, v4);
    sub_1C2E12C(&StringLiteral_18313/*"class_g_"*/, v5);
    sub_1C2E12C(&StringLiteral_18314/*"class_n_"*/, v6);
    sub_1C2E12C(&StringLiteral_18315/*"class_s_"*/, v7);
    byte_4BFDFBB = 1;
  }
  v8 = sub_1C2E1D4(string___TypeInfo, 8LL);
  if ( !v8 )
    sub_1C2E388(0LL, v9);
  v16 = v8;
  if ( !*(_DWORD *)(v8 + 24) )
    goto LABEL_13;
  v17 = StringLiteral_18314/*"class_n_"*/;
  *(_QWORD *)(v8 + 32) = StringLiteral_18314/*"class_n_"*/;
  sub_1C2E0D0((PartyOrganizationUtility_o *)(v8 + 32), v17, v10, v11, v12, v13, v14, v15);
  if ( *(_DWORD *)(v16 + 24) <= 1u )
    goto LABEL_13;
  v24 = StringLiteral_18309/*"class_b_"*/;
  *(_QWORD *)(v16 + 40) = StringLiteral_18309/*"class_b_"*/;
  sub_1C2E0D0((PartyOrganizationUtility_o *)(v16 + 40), v24, v18, v19, v20, v21, v22, v23);
  if ( *(_DWORD *)(v16 + 24) <= 2u )
    goto LABEL_13;
  v31 = StringLiteral_18315/*"class_s_"*/;
  *(_QWORD *)(v16 + 48) = StringLiteral_18315/*"class_s_"*/;
  sub_1C2E0D0((PartyOrganizationUtility_o *)(v16 + 48), v31, v25, v26, v27, v28, v29, v30);
  if ( *(_DWORD *)(v16 + 24) <= 3u )
    goto LABEL_13;
  v38 = StringLiteral_18313/*"class_g_"*/;
  *(_QWORD *)(v16 + 56) = StringLiteral_18313/*"class_g_"*/;
  sub_1C2E0D0((PartyOrganizationUtility_o *)(v16 + 56), v38, v32, v33, v34, v35, v36, v37);
  if ( *(_DWORD *)(v16 + 24) <= 4u )
    goto LABEL_13;
  v45 = StringLiteral_18313/*"class_g_"*/;
  *(_QWORD *)(v16 + 64) = StringLiteral_18313/*"class_g_"*/;
  sub_1C2E0D0((PartyOrganizationUtility_o *)(v16 + 64), v45, v39, v40, v41, v42, v43, v44);
  if ( *(_DWORD *)(v16 + 24) <= 5u
    || (v52 = StringLiteral_18313/*"class_g_"*/,
        *(_QWORD *)(v16 + 72) = StringLiteral_18313/*"class_g_"*/,
        sub_1C2E0D0((PartyOrganizationUtility_o *)(v16 + 72), v52, v46, v47, v48, v49, v50, v51),
        *(_DWORD *)(v16 + 24) <= 6u)
    || (v59 = StringLiteral_18314/*"class_n_"*/,
        *(_QWORD *)(v16 + 80) = StringLiteral_18314/*"class_n_"*/,
        sub_1C2E0D0((PartyOrganizationUtility_o *)(v16 + 80), v59, v53, v54, v55, v56, v57, v58),
        *(_DWORD *)(v16 + 24) <= 7u) )
  {
LABEL_13:
    sub_1C2E390(v8, v9);
  }
  v66 = StringLiteral_18314/*"class_n_"*/;
  *(_QWORD *)(v16 + 88) = StringLiteral_18314/*"class_n_"*/;
  sub_1C2E0D0((PartyOrganizationUtility_o *)(v16 + 88), v66, v60, v61, v62, v63, v64, v65);
  this->fields.frameCardFileList = (struct System_String_array *)v16;
  sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields, v16, v67, v68, v69, v70, v71, v72);
        ...
        const MethodInfo *method)
{
  if ( (byte_4BFDFBA & 1) == 0 )
  {
    sub_1C2E12C(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&exceedCount);
    byte_4BFDFBA = 1;
  }
