        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A514F6 & 1) == 0 )
  {
    sub_1B863B8(&BattleLogicTask_TypeInfo, logic);
    this = (PlayBackStepLogicTask_o *)sub_1B863B8(&BattlePerformance_TypeInfo, v5);
    byte_4A514F6 = 1;
  }
  if ( !logic )
    goto LABEL_15;
  ...
  if ( ServantData && !ServantData->fields.isDeadAnime )
  {
    ...
    if ( this )
    {
      ...
      v8 = (BattleLogicTask_o *)sub_1B86604(BattleLogicTask_TypeInfo);
