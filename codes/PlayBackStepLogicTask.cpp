        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05069 & 1) == 0 )
  {
    sub_1BC3008(&BattleLogicTask_TypeInfo, logic);
    this = (PlayBackStepLogicTask_o *)sub_1BC3008(&BattlePerformance_TypeInfo, v5);
    byte_4B05069 = 1;
  }
  if ( !logic )
    goto LABEL_15;
  ...
  if ( ServantData && !ServantData->fields.isDeadAnime )
  {
    ...
    if ( this )
    {
      ...
      v8 = (BattleLogicTask_o *)sub_1BC3254(BattleLogicTask_TypeInfo);
