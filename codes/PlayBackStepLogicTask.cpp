        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BDDFE & 1) == 0 )
  {
    sub_1B4CF90(&BattleLogicTask_TypeInfo, logic);
    this = (PlayBackStepLogicTask_o *)sub_1B4CF90(&BattlePerformance_TypeInfo, v5);
    byte_49BDDFE = 1;
  }
  if ( !logic )
    goto LABEL_15;
  ...
  if ( ServantData && !ServantData->fields.isDeadAnime )
  {
    ...
    if ( this )
    {
      ...
      v8 = (BattleLogicTask_o *)sub_1B4D1DC(BattleLogicTask_TypeInfo);
