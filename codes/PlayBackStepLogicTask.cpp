        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69989 & 1) == 0 )
  {
    sub_1BE4ACC(&BattleLogicTask_TypeInfo, logic);
    this = (PlayBackStepLogicTask_o *)sub_1BE4ACC(&BattlePerformance_TypeInfo, v5);
    byte_4B69989 = 1;
  }
  if ( !logic )
    goto LABEL_15;
  ...
  if ( ServantData && !ServantData->fields.isDeadAnime )
  {
    ...
    if ( this )
    {
      ...
      v8 = (BattleLogicTask_o *)sub_1BE4D18(BattleLogicTask_TypeInfo);
