        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47B55 & 1) == 0 )
  {
    sub_1BDB878(&BattleLogicTask_TypeInfo, logic);
    this = (PlayBackStepLogicTask_o *)sub_1BDB878(&BattlePerformance_TypeInfo, v5);
    byte_4B47B55 = 1;
  }
  if ( !logic )
    goto LABEL_15;
  ...
  if ( ServantData && !ServantData->fields.isDeadAnime )
  {
    ...
    if ( this )
    {
      ...
      v8 = (BattleLogicTask_o *)sub_1BDBAC4(BattleLogicTask_TypeInfo);
