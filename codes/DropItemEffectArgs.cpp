        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2FE1C & 1) == 0 )
  {
    sub_1C94098(&BattleDropPositionRandom_TypeInfo);
  ...
  {
    v7 = (BattleDropPositionRandom_o *)sub_1C942E4(BattleDropPositionRandom_TypeInfo);
    ...
    sub_1C9403C((GrandQuestFolderBoardItem_o *)p_dropPositionRandomData, (int32_t)v7, v9, v10, v11, v12, v13, v14);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2FE1B & 1) == 0 )
  {
    sub_1C94098(&BattleDropTimingAdjustment_TypeInfo);
    sub_1C94098(&UnityEngine_Object_TypeInfo);
    byte_4D2FE1B = 1;
  }
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)scriptableObject, 0, 0)
    && !BasicHelper__IsNullOrEmpty((System_Collections_ICollection_o *)dropInfoArray, 0) )
  {
    v7 = (BattleDropTimingAdjustment_o *)sub_1C942E4(BattleDropTimingAdjustment_TypeInfo);
    BattleDropTimingAdjustment___ctor(v7, 0);
    this->fields.dropTimingAdjustmentData = v7;
    p_fields = &this->fields;
    sub_1C9403C((GrandQuestFolderBoardItem_o *)p_fields, (int32_t)v7, v9, v10, v11, v12, v13, v14);
