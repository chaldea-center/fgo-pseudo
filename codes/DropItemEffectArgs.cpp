        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF1BA1 & 1) == 0 )
  {
    sub_1C7BAE8(&BattleDropPositionRandom_TypeInfo);
  ...
  {
    v7 = (BattleDropPositionRandom_o *)sub_1C7BD34(BattleDropPositionRandom_TypeInfo);
    ...
    sub_1C7BA8C((GrandQuestFolderBoardItem_o *)p_dropPositionRandomData, (int32_t)v7, v9, v10, v11, v12, v13, v14);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF1BA0 & 1) == 0 )
  {
    sub_1C7BAE8(&BattleDropTimingAdjustment_TypeInfo);
    sub_1C7BAE8(&UnityEngine_Object_TypeInfo);
    byte_4CF1BA0 = 1;
  }
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)scriptableObject, 0, 0)
    && !BasicHelper__IsNullOrEmpty((System_Collections_ICollection_o *)dropInfoArray, 0) )
  {
    v7 = (BattleDropTimingAdjustment_o *)sub_1C7BD34(BattleDropTimingAdjustment_TypeInfo);
    BattleDropTimingAdjustment___ctor(v7, 0);
    this->fields.dropTimingAdjustmentData = v7;
    p_fields = &this->fields;
    sub_1C7BA8C((GrandQuestFolderBoardItem_o *)p_fields, (int32_t)v7, v9, v10, v11, v12, v13, v14);
