...
void CostSpriteViewObject__Awake(CostSpriteViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E74AD5 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_UnityEngine_GameObject_GetComponent_CostSpriteViewItemDraw___);
    byte_4E74AD5 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_32A8444 *)Method_UnityEngine_GameObject_GetComponent_CostSpriteViewItemDraw___);
...
void CostSpriteViewObject__SetupDisp(CostSpriteViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E74AD7 & 1) == 0 )
  {
    sub_1D0F0B4(&CostSpriteViewItem_TypeInfo);
    sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    byte_4E74AD7 = 1;
  }
