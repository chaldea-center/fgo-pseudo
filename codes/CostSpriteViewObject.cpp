...
void CostSpriteViewObject__Awake(CostSpriteViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D29C9F & 1) == 0 )
  {
    sub_1C94098(&Method_UnityEngine_GameObject_GetComponent_CostSpriteViewItemDraw___);
    byte_4D29C9F = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_31F4790 *)Method_UnityEngine_GameObject_GetComponent_CostSpriteViewItemDraw___);
...
void CostSpriteViewObject__SetupDisp(CostSpriteViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D29CA1 & 1) == 0 )
  {
    sub_1C94098(&CostSpriteViewItem_TypeInfo);
    sub_1C94098(&UnityEngine_Object_TypeInfo);
    byte_4D29CA1 = 1;
  }
