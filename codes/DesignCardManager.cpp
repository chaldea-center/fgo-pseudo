void __fastcall DesignCardManager___ctor(DesignCardManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1F1AD & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_SingletonMonoBehaviour_DesignCardManager___ctor__, v3);
    byte_4A1F1AD = 1;
  }
  ...
  SingletonMonoBehaviour_object____ctor(
    ...
    (const MethodInfo_370B620 *)Method_SingletonMonoBehaviour_DesignCardManager___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1F1AA & 1) == 0 )
  {
    sub_1B715CC(&Rarity_TypeInfo, *(_QWORD *)&imageId);
    sub_1B715CC(&StringLiteral_18217/*"cord_b"*/, v5);
    sub_1B715CC(&StringLiteral_18216/*"cord"*/, v6);
    sub_1B715CC(&StringLiteral_17934/*"class"*/, v7);
    sub_1B715CC(&StringLiteral_4599/*"CommandCord/"*/, v8);
    sub_1B715CC(&StringLiteral_18218/*"cord_n"*/, v9);
    byte_4A1F1AA = 1;
  }
  ...
  if ( !DesignCardPrefix
    || (DesignCardPrefix = System_String__Replace_61525132(
                             DesignCardPrefix,
                             (System_String_o *)StringLiteral_17934/*"class"*/,
                             (System_String_o *)StringLiteral_18216/*"cord"*/,
                             0LL)) == 0LL )
  {
    sub_1B71828(DesignCardPrefix, v11);
  }
  v12 = System_String__Replace_61525132(
          DesignCardPrefix,
          (System_String_o *)StringLiteral_18218/*"cord_n"*/,
          (System_String_o *)StringLiteral_18217/*"cord_b"*/,
          0LL);
  v13 = System_Int32__ToString((int32_t)&v15, 0LL);
  return System_String__Concat_61516764((System_String_o *)StringLiteral_4599/*"CommandCord/"*/, v12, v13, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B715CC(&Rarity_TypeInfo, *(_QWORD *)&imageId);
    sub_1B715CC(&StringLiteral_4494/*"ClassCard/"*/, v7);
    byte_4A1F1A9 = 1;
  }
  if ( !Rarity_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(Rarity_TypeInfo);
  ...
  return System_String__Concat_61516764((System_String_o *)StringLiteral_4494/*"ClassCard/"*/, DesignCardPrefix, v10, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1F1AB & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_4494/*"ClassCard/"*/, *(_QWORD *)&imageId);
    byte_4A1F1AB = 1;
  }
  if ( this->fields.SVT_EQ_IMAGE_ID == imageId )
    v7 = 1;
  ...
  return System_String__Concat_61516764((System_String_o *)StringLiteral_4494/*"ClassCard/"*/, prefix, v8, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1F1A6 & 1) == 0 )
  {
    sub_1B715CC(&AssetManager_TypeInfo, *(_QWORD *)&imageId);
    sub_1B715CC(&AssetLoader_LoadEndDataHandler_TypeInfo, v9);
    sub_1B715CC(&Method_DesignCardManager___c__DisplayClass2_0__LoadDesignCardTexture_b__0__, v10);
    sub_1B715CC(&DesignCardManager___c__DisplayClass2_0_TypeInfo, v11);
    byte_4A1F1A6 = 1;
  }
  v12 = sub_1B71818(DesignCardManager___c__DisplayClass2_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1F1AC & 1) == 0 )
  {
    sub_1B715CC(&Method_AssetData_GetObject_Texture2D___, d);
    this = (DesignCardManager_o *)sub_1B715CC(&Method_UnityEngine_Component_GetComponent_UITexture___, v9);
    byte_4A1F1AC = 1;
  }
  if ( !d
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1F1A8 & 1) == 0 )
  {
    sub_1B715CC(&System_Action_Texture2D__TypeInfo, *(_QWORD *)&imageId);
    sub_1B715CC(&Method_DesignCardManager___c__DisplayClass4_0__SetupDesignCard_b__0__, v11);
    sub_1B715CC(&DesignCardManager___c__DisplayClass4_0_TypeInfo, v12);
    byte_4A1F1A8 = 1;
  }
  v13 = sub_1B71818(DesignCardManager___c__DisplayClass4_0_TypeInfo);
  ...
  *(_QWORD *)(v13 + 32) = target;
  sub_1B71570((ServantStatusBattleListViewItem_o *)(v13 + 32), (int32_t)target, v18, v19);
  *(_QWORD *)(v13 + 40) = callback;
  sub_1B71570((ServantStatusBattleListViewItem_o *)(v13 + 40), (int32_t)callback, v20, v21);
  v22 = *(_DWORD *)(v13 + 24);
  v23 = (System_Action_object__o *)sub_1B71818(System_Action_Texture2D__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B71828(this, *(_QWORD *)&imageId);
  }
  if ( cardTextureSize->max_length <= 1 )
    sub_1B71830(this, *(_QWORD *)&imageId);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1F1AE & 1) == 0 )
  {
    this = (DesignCardManager___c__DisplayClass2_0_o *)sub_1B715CC(&Method_AssetData_GetObject_Texture2D___, data);
    byte_4A1F1AE = 1;
  }
  if ( !data )
