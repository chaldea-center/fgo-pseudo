void __fastcall DesignCardManager___ctor(DesignCardManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4DBD7 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_SingletonMonoBehaviour_DesignCardManager___ctor__, v3);
    byte_4A4DBD7 = 1;
  }
  ...
  SingletonMonoBehaviour_object____ctor(
    ...
    (const MethodInfo_3839A98 *)Method_SingletonMonoBehaviour_DesignCardManager___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4DBD4 & 1) == 0 )
  {
    sub_1B863B8(&Rarity_TypeInfo, *(_QWORD *)&imageId);
    sub_1B863B8(&StringLiteral_18038/*"cord_b"*/, v5);
    sub_1B863B8(&StringLiteral_18037/*"cord"*/, v6);
    sub_1B863B8(&StringLiteral_17748/*"class"*/, v7);
    sub_1B863B8(&StringLiteral_4560/*"CommandCord/"*/, v8);
    sub_1B863B8(&StringLiteral_18039/*"cord_n"*/, v9);
    byte_4A4DBD4 = 1;
  }
  ...
  if ( !DesignCardPrefix
    || (DesignCardPrefix = System_String__Replace_61691724(
                             DesignCardPrefix,
                             (System_String_o *)StringLiteral_17748/*"class"*/,
                             (System_String_o *)StringLiteral_18037/*"cord"*/,
                             0LL)) == 0LL )
  {
    sub_1B86614(DesignCardPrefix, v11);
  }
  v12 = System_String__Replace_61691724(
          DesignCardPrefix,
          (System_String_o *)StringLiteral_18039/*"cord_n"*/,
          (System_String_o *)StringLiteral_18038/*"cord_b"*/,
          0LL);
  v13 = System_Int32__ToString((int32_t)&v15, 0LL);
  return System_String__Concat_61683424((System_String_o *)StringLiteral_4560/*"CommandCord/"*/, v12, v13, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B863B8(&Rarity_TypeInfo, *(_QWORD *)&imageId);
    sub_1B863B8(&StringLiteral_4456/*"ClassCard/"*/, v7);
    byte_4A4DBD3 = 1;
  }
  if ( !Rarity_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(Rarity_TypeInfo);
  ...
  return System_String__Concat_61683424((System_String_o *)StringLiteral_4456/*"ClassCard/"*/, DesignCardPrefix, v10, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4DBD5 & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_4456/*"ClassCard/"*/, *(_QWORD *)&imageId);
    byte_4A4DBD5 = 1;
  }
  if ( this->fields.SVT_EQ_IMAGE_ID == imageId )
    v7 = 1;
  ...
  return System_String__Concat_61683424((System_String_o *)StringLiteral_4456/*"ClassCard/"*/, prefix, v8, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4DBD0 & 1) == 0 )
  {
    sub_1B863B8(&AssetManager_TypeInfo, *(_QWORD *)&imageId);
    sub_1B863B8(&AssetLoader_LoadEndDataHandler_TypeInfo, v9);
    sub_1B863B8(&Method_DesignCardManager___c__DisplayClass2_0__LoadDesignCardTexture_b__0__, v10);
    sub_1B863B8(&DesignCardManager___c__DisplayClass2_0_TypeInfo, v11);
    byte_4A4DBD0 = 1;
  }
  v12 = sub_1B86604(DesignCardManager___c__DisplayClass2_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4DBD6 & 1) == 0 )
  {
    sub_1B863B8(&Method_AssetData_GetObject_Texture2D___, d);
    this = (DesignCardManager_o *)sub_1B863B8(&Method_UnityEngine_Component_GetComponent_UITexture___, v9);
    byte_4A4DBD6 = 1;
  }
  if ( !d
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4DBD2 & 1) == 0 )
  {
    sub_1B863B8(&System_Action_Texture2D__TypeInfo, *(_QWORD *)&imageId);
    sub_1B863B8(&Method_DesignCardManager___c__DisplayClass4_0__SetupDesignCard_b__0__, v11);
    sub_1B863B8(&DesignCardManager___c__DisplayClass4_0_TypeInfo, v12);
    byte_4A4DBD2 = 1;
  }
  v13 = sub_1B86604(DesignCardManager___c__DisplayClass4_0_TypeInfo);
  ...
  *(_QWORD *)(v13 + 32) = target;
  sub_1B8635C((CGThumbnailListItem_o *)(v13 + 32), (int32_t)target, v18, v19);
  *(_QWORD *)(v13 + 40) = callback;
  sub_1B8635C((CGThumbnailListItem_o *)(v13 + 40), (int32_t)callback, v20, v21);
  v22 = *(_DWORD *)(v13 + 24);
  v23 = (System_Action_object__o *)sub_1B86604(System_Action_Texture2D__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4DBD8 & 1) == 0 )
  {
    this = (DesignCardManager___c__DisplayClass2_0_o *)sub_1B863B8(&Method_AssetData_GetObject_Texture2D___, data);
    byte_4A4DBD8 = 1;
  }
  if ( !data )
