        ...
        const MethodInfo *method)
{
  ...
  if ( !gameObject
    || (Component_object = UnityEngine_GameObject__GetComponent_object_(
        ...
        sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.mBoxCollider, (int32_t)Component_object, v6, v7),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3FDBD & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_GameObjectExtensions_SafeGetComponent_SlideFadeObject___, v6);
    sub_1BDB878(&TerminalPramsManager_TypeInfo, v7);
    sub_1BDB878(&Method_MaterialEventLogServantListViewManager___c__DisplayClass18_0__RequestListObject_b__0__, v8);
    sub_1BDB878(&Method_MaterialEventLogServantListViewManager___c__DisplayClass18_0__RequestListObject_b__1__, v9);
    sub_1BDB878(&MaterialEventLogServantListViewManager___c__DisplayClass18_0_TypeInfo, v10);
    byte_4B3FDBD = 1;
  }
  v11 = sub_1BDBAC4(MaterialEventLogServantListViewManager___c__DisplayClass18_0_TypeInfo);
  ...
  *(_QWORD *)(v11 + 24) = end_act;
  ...
  if ( initMode == 4 )
  {
    ...
    if ( !Component_object )
      goto LABEL_17;
    SlideFadeObject__SlideOut_35227484((SlideFadeObject_o *)Component_object, 580.0, IntpTime_AutoResume, 0.0, v26, 0LL);
  }
  else
  {
    if ( initMode == 3 )
    {
      ...
      if ( gameObject )
      {
        ...
        if ( v20 )
        {
          SlideFadeObject__SlideIn_35226540((SlideFadeObject_o *)v20, 580.0, v21, 0.0, v22, 0LL);
          return;
        }
      }
LABEL_17:
        ...
        const MethodInfo *method)
{
  ...
  if ( v8 )
    v10 = (System_String_o **)&StringLiteral_423/*"#FE4545"*/;
  else
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3FDBF & 1) == 0 )
  {
    ...
    this = (MaterialEventLogServantListViewManager___c__DisplayClass18_0_o *)sub_1BDB878(
