        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD7A99 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_MaterialEventLogServantListViewManager___c__DisplayClass18_0__RequestListObject_b__0__);
    sub_1C21E38(&Method_MaterialEventLogServantListViewManager___c__DisplayClass18_0__RequestListObject_b__1__);
    sub_1C21E38(&MaterialEventLogServantListViewManager___c__DisplayClass18_0_TypeInfo);
    byte_4BD7A99 = 1;
  }
  v6 = sub_1C22084(MaterialEventLogServantListViewManager___c__DisplayClass18_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v6, 0LL);
  if ( !v6 )
    goto LABEL_17;
  *(_QWORD *)(v6 + 16) = this;
  sub_1C21DDC(v6 + 16, this);
  *(_QWORD *)(v6 + 24) = end_act;
  sub_1C21DDC(v6 + 24, end_act);
  ...
  if ( initMode == 4 )
  {
    ...
    if ( !Component_object )
      goto LABEL_17;
    SlideFadeObject__SlideOut_34814208((SlideFadeObject_o *)Component_object, 580.0, IntpTime_AutoResume, 0.0, v17, 0LL);
  }
  else
  {
    if ( initMode == 3 )
    {
      ...
      if ( gameObject )
      {
        ...
        if ( v11 )
        {
          SlideFadeObject__SlideIn_34813264((SlideFadeObject_o *)v11, 580.0, v12, 0.0, v13, 0LL);
          return;
        }
      }
LABEL_17:
        ...
        const MethodInfo *method)
{
  ...
  if ( v5 )
    v7 = (System_String_o **)&StringLiteral_450/*"#FE4545"*/;
  else
    v7 = (System_String_o **)&StringLiteral_433/*"#000000"*/;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C21E38(&System_Action_TypeInfo);
    this = (MaterialEventLogServantListViewManager___c__DisplayClass18_0_o *)sub_1C21E38(&Method_MaterialEventLogServantListViewManager___c__DisplayClass18_0__RequestListObject_b__2__);
    byte_4BD7A9B = 1;
  }
