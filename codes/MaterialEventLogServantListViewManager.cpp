        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7275C & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_MaterialEventLogServantListViewManager___c__DisplayClass18_0__RequestListObject_b__0__);
    sub_1D0F0B4(&Method_MaterialEventLogServantListViewManager___c__DisplayClass18_0__RequestListObject_b__1__);
    sub_1D0F0B4(&MaterialEventLogServantListViewManager___c__DisplayClass18_0_TypeInfo);
    byte_4E7275C = 1;
  }
  v6 = sub_1D0F300(MaterialEventLogServantListViewManager___c__DisplayClass18_0_TypeInfo);
  ...
  *(_QWORD *)(v6 + 24) = end_act;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)(v6 + 24), (int32_t)end_act, v15, v16, v17, v18, v19, v20);
  ...
  if ( initMode == 4 )
  {
    ...
    if ( !Component_object )
      goto LABEL_17;
    SlideFadeObject__SlideOut_37359592((SlideFadeObject_o *)Component_object, 580.0, IntpTime_AutoResume, 0.0, v29, 0);
  }
  else
  {
    if ( initMode == 3 )
    {
      ...
      if ( gameObject )
      {
        ...
        if ( v23 )
        {
          SlideFadeObject__SlideIn_37358648((SlideFadeObject_o *)v23, 580.0, v24, 0.0, v25, 0);
          return;
        }
      }
LABEL_17:
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1D0F0B4(&System_Action_TypeInfo);
    this = (MaterialEventLogServantListViewManager___c__DisplayClass18_0_o *)sub_1D0F0B4(&Method_MaterialEventLogServantListViewManager___c__DisplayClass18_0__RequestListObject_b__2__);
    byte_4E7275E = 1;
  }
