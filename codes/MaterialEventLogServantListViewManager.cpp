        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFFB5D & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_MaterialEventLogServantListViewManager___c__DisplayClass18_0__RequestListObject_b__0__);
    sub_1CE6700(&Method_MaterialEventLogServantListViewManager___c__DisplayClass18_0__RequestListObject_b__1__);
    sub_1CE6700(&MaterialEventLogServantListViewManager___c__DisplayClass18_0_TypeInfo);
    byte_4DFFB5D = 1;
  }
  v6 = sub_1CE694C(MaterialEventLogServantListViewManager___c__DisplayClass18_0_TypeInfo);
  ...
  *(_QWORD *)(v6 + 24) = end_act;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)(v6 + 24), (int32_t)end_act, v15, v16, v17, v18, v19, v20);
  ...
  if ( initMode == 4 )
  {
    ...
    if ( !Component_object )
      goto LABEL_17;
    SlideFadeObject__SlideOut_37177548((SlideFadeObject_o *)Component_object, 580.0, IntpTime_AutoResume, 0.0, v29, 0);
  }
  else
  {
    if ( initMode == 3 )
    {
      ...
      if ( gameObject )
      {
        ...
        if ( v23 )
        {
          SlideFadeObject__SlideIn_37176604((SlideFadeObject_o *)v23, 580.0, v24, 0.0, v25, 0);
          return;
        }
      }
LABEL_17:
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&System_Action_TypeInfo);
    this = (MaterialEventLogServantListViewManager___c__DisplayClass18_0_o *)sub_1CE6700(&Method_MaterialEventLogServantListViewManager___c__DisplayClass18_0__RequestListObject_b__2__);
    byte_4DFFB5F = 1;
  }
