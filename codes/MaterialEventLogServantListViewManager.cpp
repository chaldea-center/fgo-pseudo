        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62180 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_GameObjectExtensions_SafeGetComponent_SlideFadeObject___, v6);
    sub_1BE4ACC(&TerminalPramsManager_TypeInfo, v7);
    sub_1BE4ACC(&Method_MaterialEventLogServantListViewManager___c__DisplayClass18_0__RequestListObject_b__0__, v8);
    sub_1BE4ACC(&Method_MaterialEventLogServantListViewManager___c__DisplayClass18_0__RequestListObject_b__1__, v9);
    sub_1BE4ACC(&MaterialEventLogServantListViewManager___c__DisplayClass18_0_TypeInfo, v10);
    byte_4B62180 = 1;
  }
  v11 = sub_1BE4D18(MaterialEventLogServantListViewManager___c__DisplayClass18_0_TypeInfo);
  ...
  *(_QWORD *)(v11 + 24) = end_act;
  ...
  if ( initMode == 4 )
  {
    ...
    if ( !Component_object )
      goto LABEL_17;
    SlideFadeObject__SlideOut_34503332((SlideFadeObject_o *)Component_object, 580.0, IntpTime_AutoResume, 0.0, v22, 0LL);
  }
  else
  {
    if ( initMode == 3 )
    {
      ...
      if ( gameObject )
      {
        ...
        if ( v16 )
        {
          SlideFadeObject__SlideIn_34502388((SlideFadeObject_o *)v16, 580.0, v17, 0.0, v18, 0LL);
          return;
        }
      }
LABEL_17:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62182 & 1) == 0 )
  {
    ...
    this = (MaterialEventLogServantListViewManager___c__DisplayClass18_0_o *)sub_1BE4ACC(
