void __fastcall PartyListViewItemDraw___ctor(PartyListViewItemDraw_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA3C1 & 1) == 0 )
  {
    sub_1B64870(&PartyOrganizationListViewItemDraw___TypeInfo, method);
    byte_49FA3C1 = 1;
  }
  v3 = (struct PartyOrganizationListViewItemDraw_array *)sub_1B64918(PartyOrganizationListViewItemDraw___TypeInfo, 6LL);
  this->fields.itemDrawList = v3;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.itemDrawList, (int32_t)v3, v4, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA3BF & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_19595/*"func_group_icon_1009_starting"*/, v10);
    sub_1B64870(&StringLiteral_12174/*"STARTING_MEMBER_FRIENDSHIP_UP_TITLE"*/, v11);
    sub_1B64870(&StringLiteral_19506/*"formation_support_bg"*/, v12);
    sub_1B64870(&StringLiteral_19503/*"formation_member_bg"*/, v13);
    byte_49FA3BF = 1;
  }
  if ( item && mode )
  {
    ...
    if ( !baseSprite )
      goto LABEL_51;
    v16 = (System_String_o **)&StringLiteral_19506/*"formation_support_bg"*/;
    if ( ((unsigned __int8)questRestrictionInfo & 1) == 0 )
      v16 = (System_String_o **)&StringLiteral_19503/*"formation_member_bg"*/;
    UISprite__set_spriteName(baseSprite, *v16, 0LL);
    questRestrictionInfo = SingletonTemplate_object___get_Instance((const MethodInfo_36EE738 *)Method_SingletonTemplate_PartyOrganizationUtility__get_Instance__);
    if ( !questRestrictionInfo )
      goto LABEL_51;
    *((_QWORD *)questRestrictionInfo + 11) = item;
    sub_1B64814((ServantStatusBattleListViewItem_o *)((char *)questRestrictionInfo + 88), (int32_t)item, v17, v18);
    if ( mode == 4 )
    {
      for ( i = 0; ; ++i )
      {
    ...
    else
    {
      for ( j = 0; ; ++j )
      {
        ...
        if ( j >= v24->max_length )
LABEL_52:
          sub_1B64AD4(questRestrictionInfo, item);
        v25 = v24->m_Items[j];
    ...
    if ( !this->fields.startingMemberFriendshipUpSprite )
      goto LABEL_51;
    v26 = *(_DWORD *)(*((_QWORD *)questRestrictionInfo + 23) + 1088LL);
        ...
        if ( questRestrictionInfo )
        {
          ...
          if ( questRestrictionInfo )
          {
            ...
            if ( questRestrictionInfo )
            {
              ...
              AtlasManager__SetEventUI(startingMemberFriendshipUpSprite, (System_String_o *)StringLiteral_19595/*"func_group_icon_1009_starting"*/, 0LL);
              startingMemberFriendshipUpLabel = this->fields.startingMemberFriendshipUpLabel;
              if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
              questRestrictionInfo = LocalizationManager__Get((System_String_o *)StringLiteral_12174/*"STARTING_MEMBER_FRIENDSHIP_UP_TITLE"*/, 0LL);
...
LABEL_51:
      sub_1B64ACC(questRestrictionInfo, item);
    }
    UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)questRestrictionInfo, 0, 0LL);
    questRestrictionInfo = this->fields.startingMemberFriendshipUpLabel;
    if ( !questRestrictionInfo )
