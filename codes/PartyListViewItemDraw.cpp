void __fastcall PartyListViewItemDraw___ctor(PartyListViewItemDraw_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B17F09 & 1) == 0 )
  {
    sub_1BCAFF8(&PartyOrganizationListViewItemDraw___TypeInfo, method);
    byte_4B17F09 = 1;
  }
  v3 = (struct PartyOrganizationListViewItemDraw_array *)sub_1BCB0A0(PartyOrganizationListViewItemDraw___TypeInfo, 6LL);
  this->fields.itemDrawList = v3;
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.itemDrawList, (int32_t)v3, v4, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17F08 & 1) == 0 )
  {
    sub_1BCAFF8(&System_Action_PartyOrganizationListViewItemDraw__TypeInfo, flag);
    sub_1BCAFF8(&Method_BasicHelper_ForEach_PartyOrganizationListViewItemDraw___, v5);
    sub_1BCAFF8(&Method_PartyListViewItemDraw___c__DisplayClass12_0__SetActiveGrandEffect_b__0__, v6);
    sub_1BCAFF8(&PartyListViewItemDraw___c__DisplayClass12_0_TypeInfo, v7);
    byte_4B17F08 = 1;
  }
  v8 = sub_1BCB244(PartyListViewItemDraw___c__DisplayClass12_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v8, 0LL);
  if ( !v8 )
    sub_1BCB254(v9, v10);
  *(_BYTE *)(v8 + 16) = flag;
  itemDrawList = (System_Collections_Generic_IEnumerable_T__o *)this->fields.itemDrawList;
  v12 = (System_Action_object__o *)sub_1BCB244(System_Action_PartyOrganizationListViewItemDraw__TypeInfo);
  ...
  BasicHelper__ForEach_object_(
    ...
    (const MethodInfo_3006B3C *)Method_BasicHelper_ForEach_PartyOrganizationListViewItemDraw___);
}
  ...
  if ( item )
  {
    for ( i = 0; ; ++i )
    {
      ...
      if ( i >= itemDrawList->max_length )
        sub_1BCB25C(Component_object, v10, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17F06 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_19540/*"func_group_icon_1009_starting"*/, v10);
    sub_1BCAFF8(&StringLiteral_12205/*"STARTING_MEMBER_FRIENDSHIP_UP_TITLE"*/, v11);
    sub_1BCAFF8(&StringLiteral_19443/*"formation_support_bg"*/, v12);
    sub_1BCAFF8(&StringLiteral_19440/*"formation_member_bg"*/, v13);
    byte_4B17F06 = 1;
  }
  if ( item && mode )
  {
    ...
    if ( !baseSprite )
      goto LABEL_49;
    v17 = (System_String_o **)&StringLiteral_19443/*"formation_support_bg"*/;
    if ( ((unsigned __int8)IsSupportOnly & 1) == 0 )
      v17 = (System_String_o **)&StringLiteral_19440/*"formation_member_bg"*/;
    UISprite__set_spriteName(baseSprite, *v17, 0LL);
    IsSupportOnly = SingletonTemplate_object___get_Instance((const MethodInfo_38F8EF8 *)Method_SingletonTemplate_PartyOrganizationUtility__get_Instance__);
    if ( !IsSupportOnly )
      goto LABEL_49;
    *((_QWORD *)IsSupportOnly + 12) = item;
    sub_1BCAF9C((CGThumbnailListItem_o *)((char *)IsSupportOnly + 96), (int32_t)item, v18, v19);
    if ( mode == 4 )
    {
      for ( i = 0; ; ++i )
      {
    ...
    else
    {
      for ( j = 0; ; ++j )
      {
        ...
        if ( j >= v25->max_length )
LABEL_50:
          sub_1BCB25C(IsSupportOnly, v16, v20);
        v26 = v25->m_Items[j];
        ...
        if ( IsSupportOnly )
        {
          ...
          if ( IsSupportOnly )
          {
            ...
            if ( IsSupportOnly )
            {
              ...
              AtlasManager__SetEventUI(startingMemberFriendshipUpSprite, (System_String_o *)StringLiteral_19540/*"func_group_icon_1009_starting"*/, 0LL);
              startingMemberFriendshipUpLabel = this->fields.startingMemberFriendshipUpLabel;
              if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
              IsSupportOnly = LocalizationManager__Get((System_String_o *)StringLiteral_12205/*"STARTING_MEMBER_FRIENDSHIP_UP_TITLE"*/, 0LL);
