void PartyListViewItemDraw___ctor(PartyListViewItemDraw_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E002B7 & 1) == 0 )
  {
    sub_1CE6700(&PartyOrganizationListViewItemDraw___TypeInfo);
    byte_4E002B7 = 1;
  }
  v3 = (struct PartyOrganizationListViewItemDraw_array *)sub_1CE67A8(PartyOrganizationListViewItemDraw___TypeInfo, 6);
  this->fields.itemDrawList = v3;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.itemDrawList, (int32_t)v3, v4, v5, v6, v7, v8, v9);
...
{
  int32_t i; // w20
  PartyOrganizationListViewItemDraw_o *v4; // x0
  ...
  for ( i = 0; ; ++i )
  {
    v4 = (PartyOrganizationListViewItemDraw_o *)BalanceConfig_TypeInfo;
    if ( !BalanceConfig_TypeInfo->_2.cctor_finished )
    {
      j_il2cpp_runtime_class_init_0(BalanceConfig_TypeInfo);
      v4 = (PartyOrganizationListViewItemDraw_o *)BalanceConfig_TypeInfo;
    }
    if ( i >= v4->fields.noneEquipSprite->fields.mHeight )
      break;
    ...
    if ( (unsigned int)i >= LODWORD(itemDrawList->max_length) )
      sub_1CE6960(v4);
    v4 = itemDrawList->m_Items[i];
    if ( !v4 )
LABEL_12:
      sub_1CE6958(v4, method);
    PartyOrganizationListViewItemDraw__ClearItem(v4, 0);
  }
}
...
void PartyListViewItemDraw__SetActiveGrandEffect(PartyListViewItemDraw_o *this, bool flag, const MethodInfo *method)
{
  ...
  if ( (byte_4E002B5 & 1) == 0 )
  {
    sub_1CE6700(&System_Action_PartyOrganizationListViewItemDraw__TypeInfo);
    sub_1CE6700(&Method_BasicHelper_ForEach_PartyOrganizationListViewItemDraw___);
    sub_1CE6700(&Method_PartyListViewItemDraw___c__DisplayClass12_0__SetActiveGrandEffect_b__0__);
    sub_1CE6700(&PartyListViewItemDraw___c__DisplayClass12_0_TypeInfo);
    byte_4E002B5 = 1;
  }
  v5 = sub_1CE694C(PartyListViewItemDraw___c__DisplayClass12_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v5, 0);
  if ( !v5 )
    sub_1CE6958(v6, v7);
  *(_BYTE *)(v5 + 16) = flag;
  itemDrawList = (System_Collections_Generic_IEnumerable_T__o *)this->fields.itemDrawList;
  v9 = (System_Action_object__o *)sub_1CE694C(System_Action_PartyOrganizationListViewItemDraw__TypeInfo);
  ...
  BasicHelper__ForEach_object_(
    ...
    (const MethodInfo_31F00FC *)Method_BasicHelper_ForEach_PartyOrganizationListViewItemDraw___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E002B3 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_19893/*"formation_support_bg"*/);
    sub_1CE6700(&StringLiteral_19890/*"formation_member_bg"*/);
    byte_4E002B3 = 1;
  }
  if ( item && mode )
  {
    ...
    if ( !baseSprite )
      goto LABEL_49;
    v10 = (System_String_o **)&StringLiteral_19893/*"formation_support_bg"*/;
    if ( ((unsigned __int8)IsSupportOnly & 1) == 0 )
      v10 = (System_String_o **)&StringLiteral_19890/*"formation_member_bg"*/;
    UISprite__set_spriteName(baseSprite, *v10, 0);
    IsSupportOnly = SingletonTemplate_object___get_Instance((const MethodInfo_3B55234 *)Method_SingletonTemplate_PartyOrganizationUtility__get_Instance__);
    if ( !IsSupportOnly )
      goto LABEL_49;
    *((_QWORD *)IsSupportOnly + 15) = item;
    sub_1CE66A4(
      (GrandQuestFolderBoardItem_o *)((char *)IsSupportOnly + 120),
      (int32_t)item,
      v11,
      v12,
      v13,
...
LABEL_50:
    ...
    if ( !this->fields.startingMemberFriendshipUpSprite )
      goto LABEL_49;
    v23 = *(_DWORD *)(*((_QWORD *)IsSupportOnly + 23) + 1144LL);
        ...
        if ( IsSupportOnly )
        {
          ...
          if ( IsSupportOnly )
          {
            ...
            if ( IsSupportOnly )
            {
              ...
              AtlasManager__SetEventUI(startingMemberFriendshipUpSprite, (System_String_o *)StringLiteral_19990/*"func_group_icon_1009_starting"*/, 0);
              startingMemberFriendshipUpLabel = this->fields.startingMemberFriendshipUpLabel;
              if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
              IsSupportOnly = LocalizationManager__Get((System_String_o *)StringLiteral_12434/*"STARTING_MEMBER_FRIENDSHIP_UP_TITLE"*/, 0);
