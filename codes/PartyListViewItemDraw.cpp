void __fastcall PartyListViewItemDraw___ctor(PartyListViewItemDraw_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A56F97 & 1) == 0 )
  {
    sub_1B885B0(&PartyOrganizationListViewItemDraw___TypeInfo);
    byte_4A56F97 = 1;
  }
  v3 = (struct PartyOrganizationListViewItemDraw_array *)sub_1B88658(PartyOrganizationListViewItemDraw___TypeInfo, 6LL);
  this->fields.itemDrawList = v3;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.itemDrawList, (int32_t)v3, v4, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A56F95 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_19581/*"formation_support_bg"*/);
    sub_1B885B0(&StringLiteral_19578/*"formation_member_bg"*/);
    byte_4A56F95 = 1;
  }
  if ( item && mode )
  {
    ...
    if ( !baseSprite )
      goto LABEL_51;
    v9 = (System_String_o **)&StringLiteral_19581/*"formation_support_bg"*/;
    if ( ((unsigned __int8)questRestrictionInfo & 1) == 0 )
      v9 = (System_String_o **)&StringLiteral_19578/*"formation_member_bg"*/;
    UISprite__set_spriteName(baseSprite, *v9, 0LL);
    questRestrictionInfo = SingletonTemplate_object___get_Instance((const MethodInfo_3739B38 *)Method_SingletonTemplate_PartyOrganizationUtility__get_Instance__);
    if ( !questRestrictionInfo )
      goto LABEL_51;
    *((_QWORD *)questRestrictionInfo + 11) = item;
    sub_1B88554((ServantStatusBattleListViewItem_o *)((char *)questRestrictionInfo + 88), (int32_t)item, v10, v11);
    if ( mode == 4 )
    {
      for ( i = 0; ; ++i )
      {
        ...
        questRestrictionInfo = PartyListViewItem__GetMember(item, i, v12);
        if ( !v15 )
          goto LABEL_51;
    ...
    else
    {
      for ( j = 0; ; ++j )
      {
        ...
        if ( j >= v17->max_length )
LABEL_52:
          sub_1B88814(questRestrictionInfo, item);
        v18 = v17->m_Items[j];
        questRestrictionInfo = PartyListViewItem__GetMember(item, j, v12);
        if ( !v18 )
          goto LABEL_51;
        PartyOrganizationListViewItemDraw__SetItem(
          v18,
    ...
    if ( !this->fields.startingMemberFriendshipUpSprite )
      goto LABEL_51;
    v19 = *(_DWORD *)(*((_QWORD *)questRestrictionInfo + 23) + 1072LL);
        ...
        if ( questRestrictionInfo )
        {
          ...
          if ( questRestrictionInfo )
          {
            ...
            if ( questRestrictionInfo )
            {
              ...
              AtlasManager__SetEventUI(startingMemberFriendshipUpSprite, (System_String_o *)StringLiteral_19671/*"func_group_icon_1009_starting"*/, 0LL);
              startingMemberFriendshipUpLabel = this->fields.startingMemberFriendshipUpLabel;
              if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
              questRestrictionInfo = LocalizationManager__Get((System_String_o *)StringLiteral_12226/*"STARTING_MEMBER_FRIENDSHIP_UP_TITLE"*/, 0LL);
...
LABEL_51:
      sub_1B8880C(questRestrictionInfo, item);
    }
    UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)questRestrictionInfo, 0, 0LL);
    questRestrictionInfo = this->fields.startingMemberFriendshipUpLabel;
    if ( !questRestrictionInfo )
