void __fastcall PartyListViewItemDraw___ctor(PartyListViewItemDraw_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1B928 & 1) == 0 )
  {
    sub_1B715CC(&PartyOrganizationListViewItemDraw___TypeInfo, method);
    byte_4A1B928 = 1;
  }
  v3 = (struct PartyOrganizationListViewItemDraw_array *)sub_1B71674(PartyOrganizationListViewItemDraw___TypeInfo, 6LL);
  this->fields.itemDrawList = v3;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.itemDrawList, (int32_t)v3, v4, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1B926 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_19620/*"func_group_icon_1009_starting"*/, v10);
    sub_1B715CC(&StringLiteral_12185/*"STARTING_MEMBER_FRIENDSHIP_UP_TITLE"*/, v11);
    sub_1B715CC(&StringLiteral_19530/*"formation_support_bg"*/, v12);
    sub_1B715CC(&StringLiteral_19527/*"formation_member_bg"*/, v13);
    byte_4A1B926 = 1;
  }
  if ( item && mode )
  {
    ...
    if ( !baseSprite )
      goto LABEL_51;
    v16 = (System_String_o **)&StringLiteral_19530/*"formation_support_bg"*/;
    if ( ((unsigned __int8)questRestrictionInfo & 1) == 0 )
      v16 = (System_String_o **)&StringLiteral_19527/*"formation_member_bg"*/;
    UISprite__set_spriteName(baseSprite, *v16, 0LL);
    questRestrictionInfo = SingletonTemplate_object___get_Instance((const MethodInfo_370B628 *)Method_SingletonTemplate_PartyOrganizationUtility__get_Instance__);
    if ( !questRestrictionInfo )
      goto LABEL_51;
    *((_QWORD *)questRestrictionInfo + 11) = item;
    sub_1B71570((ServantStatusBattleListViewItem_o *)((char *)questRestrictionInfo + 88), (int32_t)item, v17, v18);
    if ( mode == 4 )
    {
      for ( i = 0; ; ++i )
      {
    ...
    else
    {
      for ( j = 0; ; ++j )
      {
        ...
        if ( j >= v24->max_length )
LABEL_52:
          sub_1B71830(questRestrictionInfo, item);
        v25 = v24->m_Items[j];
        ...
        if ( questRestrictionInfo )
        {
          ...
          if ( questRestrictionInfo )
          {
            ...
            if ( questRestrictionInfo )
            {
              ...
              AtlasManager__SetEventUI(startingMemberFriendshipUpSprite, (System_String_o *)StringLiteral_19620/*"func_group_icon_1009_starting"*/, 0LL);
              startingMemberFriendshipUpLabel = this->fields.startingMemberFriendshipUpLabel;
              if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
              questRestrictionInfo = LocalizationManager__Get((System_String_o *)StringLiteral_12185/*"STARTING_MEMBER_FRIENDSHIP_UP_TITLE"*/, 0LL);
...
LABEL_51:
      sub_1B71828(questRestrictionInfo, item);
    }
    UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)questRestrictionInfo, 0, 0LL);
    questRestrictionInfo = this->fields.startingMemberFriendshipUpLabel;
    if ( !questRestrictionInfo )
