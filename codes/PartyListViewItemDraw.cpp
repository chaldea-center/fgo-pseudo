void __fastcall PartyListViewItemDraw___ctor(PartyListViewItemDraw_o *this, const MethodInfo *method)
{
  if ( (byte_4BF92A5 & 1) == 0 )
  {
    sub_1C2E12C(&PartyOrganizationListViewItemDraw___TypeInfo, method);
    byte_4BF92A5 = 1;
  }
  this->fields.itemDrawList = (struct PartyOrganizationListViewItemDraw_array *)sub_1C2E1D4(
                                                                                  PartyOrganizationListViewItemDraw___TypeInfo,
                                                                                  6LL);
  sub_1C2E0D0(&this->fields.itemDrawList);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF92A3 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&StringLiteral_20029/*"func_group_icon_1009_starting"*/, v10);
    sub_1C2E12C(&StringLiteral_12473/*"STARTING_MEMBER_FRIENDSHIP_UP_TITLE"*/, v11);
    sub_1C2E12C(&StringLiteral_19934/*"formation_support_bg"*/, v12);
    sub_1C2E12C(&StringLiteral_19931/*"formation_member_bg"*/, v13);
    byte_4BF92A3 = 1;
  }
  if ( item && mode )
  {
    ...
    if ( !baseSprite )
      goto LABEL_51;
    v16 = (System_String_o **)&StringLiteral_19934/*"formation_support_bg"*/;
    if ( ((unsigned __int8)questRestrictionInfo & 1) == 0 )
      v16 = (System_String_o **)&StringLiteral_19931/*"formation_member_bg"*/;
    UISprite__set_spriteName(baseSprite, *v16, 0LL);
    questRestrictionInfo = (QuestRestrictionInfo_o *)SingletonTemplate_object___get_Instance((const MethodInfo_38A83B0 *)Method_SingletonTemplate_PartyOrganizationUtility__get_Instance__);
    if ( !questRestrictionInfo )
      goto LABEL_51;
    questRestrictionInfo->fields.positionsList = (struct System_Collections_Generic_List_bool____o *)item;
    sub_1C2E0D0(&questRestrictionInfo->fields.positionsList);
    if ( mode == 4 )
    {
      for ( i = 0; ; ++i )
      {
    ...
    else
    {
      for ( j = 0; ; ++j )
      {
        ...
        if ( j >= v22->max_length )
LABEL_52:
          sub_1C2E390(questRestrictionInfo, item);
        v23 = v22->m_Items[j];
        ...
        if ( questRestrictionInfo )
        {
          ...
          if ( questRestrictionInfo )
          {
            ...
            if ( questRestrictionInfo )
            {
              ...
              AtlasManager__SetEventUI(startingMemberFriendshipUpSprite, (System_String_o *)StringLiteral_20029/*"func_group_icon_1009_starting"*/, 0LL);
...
LABEL_51:
      sub_1C2E388(questRestrictionInfo, item);
    }
    UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)questRestrictionInfo, 0, 0LL);
    questRestrictionInfo = (QuestRestrictionInfo_o *)this->fields.startingMemberFriendshipUpLabel;
    if ( !questRestrictionInfo )
