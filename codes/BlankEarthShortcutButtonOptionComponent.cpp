void __fastcall BlankEarthShortcutButtonOptionComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B413AF & 1) == 0 )
  {
    sub_1BDB878(&BlankEarthShortcutButtonOptionComponent_TypeInfo, v1);
    byte_4B413AF = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B413AE & 1) == 0 )
  {
    sub_1BDB878(&BlankEarthShortcutButtonOptionComponent_TypeInfo, ent);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B413AD & 1) == 0 )
  {
    sub_1BDB878(&LocalizationManager_TypeInfo, ent);
