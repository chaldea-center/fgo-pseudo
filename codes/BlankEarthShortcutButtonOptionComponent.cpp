void __fastcall BlankEarthShortcutButtonOptionComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB2863 & 1) == 0 )
  {
    sub_1BAB41C(&BlankEarthShortcutButtonOptionComponent_TypeInfo, v1);
    byte_4AB2863 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB2862 & 1) == 0 )
  {
    sub_1BAB41C(&BlankEarthShortcutButtonOptionComponent_TypeInfo, ent);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB2861 & 1) == 0 )
  {
    sub_1BAB41C(&LocalizationManager_TypeInfo, ent);
