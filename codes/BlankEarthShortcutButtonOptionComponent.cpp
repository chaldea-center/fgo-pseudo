void __fastcall BlankEarthShortcutButtonOptionComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A6C9C6 & 1) == 0 )
  {
    sub_1B90010(&BlankEarthShortcutButtonOptionComponent_TypeInfo, v1);
    byte_4A6C9C6 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6C9C5 & 1) == 0 )
  {
    sub_1B90010(&BlankEarthShortcutButtonOptionComponent_TypeInfo, ent);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6C9C4 & 1) == 0 )
  {
    sub_1B90010(&LocalizationManager_TypeInfo, ent);
