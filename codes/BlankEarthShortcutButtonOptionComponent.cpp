void __fastcall BlankEarthShortcutButtonOptionComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AFE921 & 1) == 0 )
  {
    sub_1BC3008(&BlankEarthShortcutButtonOptionComponent_TypeInfo, v1);
    byte_4AFE921 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFE920 & 1) == 0 )
  {
    sub_1BC3008(&BlankEarthShortcutButtonOptionComponent_TypeInfo, ent);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFE91F & 1) == 0 )
  {
    sub_1BC3008(&LocalizationManager_TypeInfo, ent);
