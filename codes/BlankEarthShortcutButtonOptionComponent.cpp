void __fastcall BlankEarthShortcutButtonOptionComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B33C59 & 1) == 0 )
  {
    sub_1BD3458(&BlankEarthShortcutButtonOptionComponent_TypeInfo, v1);
    byte_4B33C59 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B33C58 & 1) == 0 )
  {
    sub_1BD3458(&BlankEarthShortcutButtonOptionComponent_TypeInfo, ent);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B33C57 & 1) == 0 )
  {
    sub_1BD3458(&LocalizationManager_TypeInfo, ent);
