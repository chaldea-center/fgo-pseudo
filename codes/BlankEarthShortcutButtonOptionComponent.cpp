void __fastcall BlankEarthShortcutButtonOptionComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B18E09 & 1) == 0 )
  {
    sub_1BCAFF8(&BlankEarthShortcutButtonOptionComponent_TypeInfo, v1);
    byte_4B18E09 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18E08 & 1) == 0 )
  {
    sub_1BCAFF8(&BlankEarthShortcutButtonOptionComponent_TypeInfo, ent);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18E07 & 1) == 0 )
  {
    sub_1BCAFF8(&LocalizationManager_TypeInfo, ent);
