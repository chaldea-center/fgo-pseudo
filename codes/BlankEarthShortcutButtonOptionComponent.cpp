void __fastcall BlankEarthShortcutButtonOptionComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BC4514 & 1) == 0 )
  {
    sub_1C1ABD4(&BlankEarthShortcutButtonOptionComponent_TypeInfo, v1);
    byte_4BC4514 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC4513 & 1) == 0 )
  {
    sub_1C1ABD4(&BlankEarthShortcutButtonOptionComponent_TypeInfo, ent);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC4512 & 1) == 0 )
  {
    sub_1C1ABD4(&LocalizationManager_TypeInfo, ent);
