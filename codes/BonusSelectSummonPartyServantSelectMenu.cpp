        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E00D12 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_BonusSelectSummonPartyServantSelectMenu__Close_b__14_0__);
    this = (BonusSelectSummonPartyServantSelectMenu_o *)sub_1CE6700(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4E00D12 = 1;
  }
  if ( !item )
    goto LABEL_14;
  ...
  if ( (_DWORD)servantEntity )
    ...
    BonusSelectSummonPartyOrganizationListViewItem__Modify(
      ...
      item,
      method);
  this = (BonusSelectSummonPartyServantSelectMenu_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !this )
LABEL_14:
        ...
        const MethodInfo *method)
{
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.organizationItem, 0, v4, v5, v6, v7, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&System_Action_TypeInfo);
    sub_1CE6700(&Method_BonusSelectSummonPartyServantSelectMenu_OnClickCancel__);
    sub_1CE6700(&Method_BonusSelectSummonPartyServantSelectMenu__OnClickCancel_b__15_0__);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_BonusSelectSummonPartyServantSelectMenu_OnClickCancel__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1CE6718(Method_BonusSelectSummonPartyServantSelectMenu_OnClickCancel__);
    v5 = (System_Reflection_MethodBase_o *)sub_1CE66E4(v4, v4[4]);
    OverwriteAssetSoundName__PlaySystemSe(v5, 1, 0, 0);
    partyServantListViewManager = (ListViewManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    if ( partyServantListViewManager )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E00D14 & 1) == 0 )
  {
    sub_1CE6700(&Method_BonusSelectSummonPartyServantSelectMenu_OnClickScaleChange__);
    byte_4E00D14 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_BonusSelectSummonPartyServantSelectMenu_OnClickScaleChange__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_BonusSelectSummonPartyServantSelectMenu_OnClickScaleChange__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&System_Action_TypeInfo);
    sub_1CE6700(&Method_BonusSelectSummonPartyServantSelectMenu__Open_b__13_0__);
    sub_1CE6700(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4E00D11 = 1;
  }
  ...
  if ( !scaleChangeTabSprite
    ...
    || (UILabel__set_text(guideMsgLabel, (System_String_o *)titleInfo, 0),
        (titleInfo = (TitleInfoControl_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__)) == 0) )
  {
LABEL_15:
    sub_1CE6958(titleInfo, v19);
  }
