        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E53B & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_BonusSelectSummonPartyServantSelectMenu__Close_b__14_0__, v5);
    this = (BonusSelectSummonPartyServantSelectMenu_o *)sub_1C3B764(
  ...
  if ( (_DWORD)servantEntity )
    ...
    BonusSelectSummonPartyOrganizationListViewItem__Modify(
      ...
      item,
      method);
  this = (BonusSelectSummonPartyServantSelectMenu_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !this )
LABEL_14:
        ...
        const MethodInfo *method)
{
  ...
  sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.organizationItem, 0LL, v4, v5, v6, v7, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E53C & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_BonusSelectSummonPartyServantSelectMenu_OnClickCancel__, v3);
    sub_1C3B764(&Method_BonusSelectSummonPartyServantSelectMenu__OnClickCancel_b__15_0__, v4);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_BonusSelectSummonPartyServantSelectMenu_OnClickCancel__ + 83) & 2) != 0 )
      v7 = (_QWORD *)sub_1C3B77C(Method_BonusSelectSummonPartyServantSelectMenu_OnClickCancel__);
    v8 = (System_Reflection_MethodBase_o *)sub_1C3B748(v7, v7[4]);
    OverwriteAssetSoundName__PlaySystemSe(v8, 1, 0, 0LL);
    partyServantListViewManager = (ListViewManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    if ( partyServantListViewManager )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E53D & 1) == 0 )
  {
    sub_1C3B764(&Method_BonusSelectSummonPartyServantSelectMenu_OnClickScaleChange__, method);
    byte_4C1E53D = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_BonusSelectSummonPartyServantSelectMenu_OnClickScaleChange__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3B77C(Method_BonusSelectSummonPartyServantSelectMenu_OnClickScaleChange__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E53A & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_BonusSelectSummonPartyServantSelectMenu__Open_b__13_0__, v12);
    sub_1C3B764(&LocalizationManager_TypeInfo, v13);
    sub_1C3B764(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v14);
    sub_1C3B764(&StringLiteral_12606/*"Sound"*/, v15);
    byte_4C1E53A = 1;
  }
  ...
  titleInfo = (TitleInfoControl_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12606/*"Sound"*/, 0LL);
  if ( !guideMsgLabel
    || (UILabel__set_text(guideMsgLabel, (System_String_o *)titleInfo, 0LL),
        (titleInfo = (TitleInfoControl_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__)) == 0LL) )
  {
LABEL_16:
    sub_1C3B9C0(titleInfo, v22);
  }
