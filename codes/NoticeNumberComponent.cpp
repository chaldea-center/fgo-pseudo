void __fastcall NoticeNumberComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A4AFF7 & 1) == 0 )
  {
    sub_1B863B8(&NoticeNumberComponent_TypeInfo, v1);
    byte_4A4AFF7 = 1;
  }
...
void __fastcall NoticeNumberComponent__Awake(NoticeNumberComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.mWidget, (int32_t)Component_object, v6, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4AFF6 & 1) == 0 )
  {
    ...
    sub_1B863B8(&NoticeNumberComponent_TypeInfo, v2);
    byte_4A4AFF6 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4AFF5 & 1) == 0 )
  {
    sub_1B863B8(&Method_TransitionCalculator_float__get_Current__, is_disp);
    byte_4A4AFF5 = 1;
  }
  WidgetAlphaCalculator = NoticeNumberComponent__get_WidgetAlphaCalculator(this, (const MethodInfo *)is_disp);
  if ( !WidgetAlphaCalculator )
...
LABEL_10:
    sub_1B86614(WidgetAlphaCalculator, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4AFF4 & 1) == 0 )
  {
    sub_1B863B8(&NoticeNumberComponent_TypeInfo, *(_QWORD *)&number);
    sub_1B863B8(&StringLiteral_809/*"+"*/, v5);
    byte_4A4AFF4 = 1;
  }
  v14 = 0;
  ...
  else
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)System_String__Concat_61645176(
                                               v13,
...
UIWidget_o *__fastcall NoticeNumberComponent__get_MyWidget(NoticeNumberComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(mWidget, 0LL, 0LL) )
  {
    ...
    *p_mWidget = (UIWidget_o *)Component_object;
    sub_1B8635C((CGThumbnailListItem_o *)&this->fields.mWidget, (int32_t)Component_object, v9, v10);
  }
  return *p_mWidget;
}
