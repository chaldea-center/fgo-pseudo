void NoticeNumberComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CC3E22 & 1) == 0 )
  {
    sub_1C713B0(&NoticeNumberComponent_TypeInfo);
    byte_4CC3E22 = 1;
  }
...
void NoticeNumberComponent__Awake(NoticeNumberComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.mWidget, (int32_t)Component_object, v6, v7, v8, v9, v10, v11);
}
...
LABEL_10:
    sub_1C71608(WidgetAlphaCalculator, v6);
