void __fastcall NoticeNumberComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B415A5 & 1) == 0 )
  {
    sub_1BDB878(&NoticeNumberComponent_TypeInfo, v1);
    byte_4B415A5 = 1;
  }
...
void __fastcall NoticeNumberComponent__Awake(NoticeNumberComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.mWidget, (int32_t)Component_object, v6, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B415A4 & 1) == 0 )
  {
    ...
    sub_1BDB878(&NoticeNumberComponent_TypeInfo, v2);
    byte_4B415A4 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B415A3 & 1) == 0 )
  {
    sub_1BDB878(&Method_TransitionCalculator_float__get_Current__, is_disp);
    byte_4B415A3 = 1;
  }
  WidgetAlphaCalculator = NoticeNumberComponent__get_WidgetAlphaCalculator(this, (const MethodInfo *)is_disp);
  if ( !WidgetAlphaCalculator )
...
LABEL_10:
    sub_1BDBAD4(WidgetAlphaCalculator, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B415A2 & 1) == 0 )
  {
    sub_1BDB878(&NoticeNumberComponent_TypeInfo, *(_QWORD *)&number);
    sub_1BDB878(&StringLiteral_812/*"+"*/, v5);
    byte_4B415A2 = 1;
  }
  v14 = 0;
  ...
  else
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)System_String__Concat_62572260(
                                               v13,
...
UIWidget_o *__fastcall NoticeNumberComponent__get_MyWidget(NoticeNumberComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(mWidget, 0LL, 0LL) )
  {
    ...
    *p_mWidget = (UIWidget_o *)Component_object;
    sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.mWidget, (int32_t)Component_object, v9, v10);
  }
  return *p_mWidget;
}
