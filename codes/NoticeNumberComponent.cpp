void __fastcall NoticeNumberComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BFA387 & 1) == 0 )
  {
    sub_1C2E12C(&NoticeNumberComponent_TypeInfo, v1);
    byte_4BFA387 = 1;
  }
...
void __fastcall NoticeNumberComponent__Awake(NoticeNumberComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.mWidget, (int64_t)Component_object, v6, v7, v8, v9, v10, v11);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFA386 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&NoticeNumberComponent_TypeInfo, v2);
    byte_4BFA386 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFA385 & 1) == 0 )
  {
    sub_1C2E12C(&Method_TransitionCalculator_float__get_Current__, is_disp);
    byte_4BFA385 = 1;
  }
  WidgetAlphaCalculator = NoticeNumberComponent__get_WidgetAlphaCalculator(this, (const MethodInfo *)is_disp);
  if ( !WidgetAlphaCalculator )
...
LABEL_10:
    sub_1C2E388(WidgetAlphaCalculator, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFA384 & 1) == 0 )
  {
    sub_1C2E12C(&NoticeNumberComponent_TypeInfo, *(_QWORD *)&number);
    sub_1C2E12C(&StringLiteral_837/*"+"*/, v5);
    byte_4BFA384 = 1;
  }
  v14 = 0;
  ...
  else
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)System_String__Concat_63235584(
                                               v13,
