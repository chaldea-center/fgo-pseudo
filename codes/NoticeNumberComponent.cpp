void __fastcall NoticeNumberComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48DF69A & 1) == 0 )
  {
    sub_1B00CCC(&NoticeNumberComponent_TypeInfo, v1);
    byte_48DF69A = 1;
  }
...
void __fastcall NoticeNumberComponent__Awake(NoticeNumberComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.mWidget, (int32_t)Component_object, v6, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DF699 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&NoticeNumberComponent_TypeInfo, v2);
    byte_48DF699 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DF698 & 1) == 0 )
  {
    sub_1B00CCC(&Method_TransitionCalculator_float__get_Current__, is_disp);
    byte_48DF698 = 1;
  }
  WidgetAlphaCalculator = NoticeNumberComponent__get_WidgetAlphaCalculator(this, (const MethodInfo *)is_disp);
  if ( !WidgetAlphaCalculator )
...
LABEL_10:
    sub_1B00F28(WidgetAlphaCalculator, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DF697 & 1) == 0 )
  {
    sub_1B00CCC(&NoticeNumberComponent_TypeInfo, *(_QWORD *)&number);
    sub_1B00CCC(&StringLiteral_857/*"+"*/, v5);
    byte_48DF697 = 1;
  }
  v14 = 0;
...
void __fastcall NoticeNumberComponent__Update(NoticeNumberComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48DF695 & 1) == 0 )
  {
    sub_1B00CCC(&Method_TransitionCalculator_float__Update__, method);
    byte_48DF695 = 1;
  }
...
UIWidget_o *__fastcall NoticeNumberComponent__get_MyWidget(NoticeNumberComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(mWidget, 0LL, 0LL) )
  {
    ...
    *p_mWidget = (UIWidget_o *)Component_object;
    sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.mWidget, (int32_t)Component_object, v9, v10);
  }
  return *p_mWidget;
}
