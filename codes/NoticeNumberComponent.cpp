void __fastcall NoticeNumberComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49F91DC & 1) == 0 )
  {
    sub_1B640C8(&NoticeNumberComponent_TypeInfo, v1);
    byte_49F91DC = 1;
  }
...
void __fastcall NoticeNumberComponent__Awake(NoticeNumberComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.mWidget, (int32_t)Component_object, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F91DB & 1) == 0 )
  {
    ...
    sub_1B640C8(&NoticeNumberComponent_TypeInfo, v2);
    byte_49F91DB = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F91DA & 1) == 0 )
  {
    sub_1B640C8(&Method_TransitionCalculator_float__get_Current__, is_disp);
    byte_49F91DA = 1;
  }
  WidgetAlphaCalculator = NoticeNumberComponent__get_WidgetAlphaCalculator(this, (const MethodInfo *)is_disp);
  if ( !WidgetAlphaCalculator )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F91D9 & 1) == 0 )
  {
    sub_1B640C8(&NoticeNumberComponent_TypeInfo, *(_QWORD *)&number);
    sub_1B640C8(&StringLiteral_861/*"+"*/, v5);
    byte_49F91D9 = 1;
  }
  v13 = 0;
...
void __fastcall NoticeNumberComponent__Update(NoticeNumberComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49F91D7 & 1) == 0 )
  {
    sub_1B640C8(&Method_TransitionCalculator_float__Update__, method);
    byte_49F91D7 = 1;
  }
...
UIWidget_o *__fastcall NoticeNumberComponent__get_MyWidget(NoticeNumberComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(mWidget, 0LL, 0LL) )
  {
    ...
    *p_mWidget = (UIWidget_o *)Component_object;
    sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.mWidget, (int32_t)Component_object, v8, v9);
  }
  return *p_mWidget;
}
