void NoticeNumberComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E013B2 & 1) == 0 )
  {
    sub_1CE6700(&NoticeNumberComponent_TypeInfo);
    byte_4E013B2 = 1;
  }
...
void NoticeNumberComponent__Awake(NoticeNumberComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.mWidget, (int32_t)Component_object, v6, v7, v8, v9, v10, v11);
}
...
LABEL_10:
    sub_1CE6958(WidgetAlphaCalculator, v6);
