void __fastcall NoticeNumberComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A2AD10 & 1) == 0 )
  {
    sub_1B761C0(&NoticeNumberComponent_TypeInfo, v1);
    byte_4A2AD10 = 1;
  }
...
void __fastcall NoticeNumberComponent__Awake(NoticeNumberComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.mWidget, (int32_t)Component_object, v6, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2AD0F & 1) == 0 )
  {
    ...
    sub_1B761C0(&NoticeNumberComponent_TypeInfo, v2);
    byte_4A2AD0F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2AD0E & 1) == 0 )
  {
    sub_1B761C0(&Method_TransitionCalculator_float__get_Current__, is_disp);
    byte_4A2AD0E = 1;
  }
  WidgetAlphaCalculator = NoticeNumberComponent__get_WidgetAlphaCalculator(this, (const MethodInfo *)is_disp);
  if ( !WidgetAlphaCalculator )
...
LABEL_10:
    sub_1B7641C(WidgetAlphaCalculator, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2AD0D & 1) == 0 )
  {
    sub_1B761C0(&NoticeNumberComponent_TypeInfo, *(_QWORD *)&number);
    sub_1B761C0(&StringLiteral_860/*"+"*/, v5);
    byte_4A2AD0D = 1;
  }
  v14 = 0;
...
void __fastcall NoticeNumberComponent__Update(NoticeNumberComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2AD0B & 1) == 0 )
  {
    sub_1B761C0(&Method_TransitionCalculator_float__Update__, method);
    byte_4A2AD0B = 1;
  }
...
UIWidget_o *__fastcall NoticeNumberComponent__get_MyWidget(NoticeNumberComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(mWidget, 0LL, 0LL) )
  {
    ...
    *p_mWidget = (UIWidget_o *)Component_object;
    sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.mWidget, (int32_t)Component_object, v9, v10);
  }
  return *p_mWidget;
}
