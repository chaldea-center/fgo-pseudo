void NoticeNumberComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4D291F6 & 1) == 0 )
  {
    sub_1C94098(&NoticeNumberComponent_TypeInfo);
    byte_4D291F6 = 1;
  }
...
void NoticeNumberComponent__Awake(NoticeNumberComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.mWidget, (int32_t)Component_object, v6, v7, v8, v9, v10, v11);
}
...
LABEL_10:
    sub_1C942F0(WidgetAlphaCalculator, v6);
