void __fastcall NoticeNumberComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B19000 & 1) == 0 )
  {
    sub_1BCAFF8(&NoticeNumberComponent_TypeInfo, v1);
    byte_4B19000 = 1;
  }
...
void __fastcall NoticeNumberComponent__Awake(NoticeNumberComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.mWidget, (int32_t)Component_object, v6, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18FFF & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&NoticeNumberComponent_TypeInfo, v2);
    byte_4B18FFF = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18FFE & 1) == 0 )
  {
    sub_1BCAFF8(&Method_TransitionCalculator_float__get_Current__, is_disp);
    byte_4B18FFE = 1;
  }
  WidgetAlphaCalculator = NoticeNumberComponent__get_WidgetAlphaCalculator(this, (const MethodInfo *)is_disp);
  if ( !WidgetAlphaCalculator )
...
LABEL_10:
    sub_1BCB254(WidgetAlphaCalculator, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18FFD & 1) == 0 )
  {
    sub_1BCAFF8(&NoticeNumberComponent_TypeInfo, *(_QWORD *)&number);
    sub_1BCAFF8(&StringLiteral_798/*"+"*/, v5);
    byte_4B18FFD = 1;
  }
  v14 = 0;
  ...
  else
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)System_String__Concat_62450424(
                                               v13,
...
UIWidget_o *__fastcall NoticeNumberComponent__get_MyWidget(NoticeNumberComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(mWidget, 0LL, 0LL) )
  {
    ...
    *p_mWidget = (UIWidget_o *)Component_object;
    sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.mWidget, (int32_t)Component_object, v9, v10);
  }
  return *p_mWidget;
}
