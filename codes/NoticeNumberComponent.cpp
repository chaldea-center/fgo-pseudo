void __fastcall NoticeNumberComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB2A61 & 1) == 0 )
  {
    sub_1BAB41C(&NoticeNumberComponent_TypeInfo, v1);
    byte_4AB2A61 = 1;
  }
...
void __fastcall NoticeNumberComponent__Awake(NoticeNumberComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.mWidget, (int32_t)Component_object, v6, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB2A60 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&NoticeNumberComponent_TypeInfo, v2);
    byte_4AB2A60 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB2A5F & 1) == 0 )
  {
    sub_1BAB41C(&Method_TransitionCalculator_float__get_Current__, is_disp);
    byte_4AB2A5F = 1;
  }
  WidgetAlphaCalculator = NoticeNumberComponent__get_WidgetAlphaCalculator(this, (const MethodInfo *)is_disp);
  if ( !WidgetAlphaCalculator )
...
LABEL_10:
    sub_1BAB678(WidgetAlphaCalculator, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB2A5E & 1) == 0 )
  {
    sub_1BAB41C(&NoticeNumberComponent_TypeInfo, *(_QWORD *)&number);
    sub_1BAB41C(&StringLiteral_855/*"+"*/, v5);
    byte_4AB2A5E = 1;
  }
  v14 = 0;
...
void __fastcall NoticeNumberComponent__Update(NoticeNumberComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB2A5C & 1) == 0 )
  {
    sub_1BAB41C(&Method_TransitionCalculator_float__Update__, method);
    byte_4AB2A5C = 1;
  }
...
UIWidget_o *__fastcall NoticeNumberComponent__get_MyWidget(NoticeNumberComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(mWidget, 0LL, 0LL) )
  {
    ...
    *p_mWidget = (UIWidget_o *)Component_object;
    sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.mWidget, (int32_t)Component_object, v9, v10);
  }
  return *p_mWidget;
}
