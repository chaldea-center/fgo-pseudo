void __fastcall NoticeNumberComponent___cctor(const MethodInfo *method)
{
  if ( (byte_42B069B & 1) == 0 )
  {
    sub_B52984(&NoticeNumberComponent_TypeInfo);
    byte_42B069B = 1;
  }
...
LABEL_10:
    sub_B52A5C(WidgetAlphaCalculator, v6);
        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)System_String__Concat_44568316(
                                               v12,
        ...
        const MethodInfo *method)
{
  ...
  if ( !result )
  {
    ...
    sub_B52920(p_widgetAlphaCalculator, WidgetAlphaCalculator, v5, v6, v7, v8, v9, v10);
