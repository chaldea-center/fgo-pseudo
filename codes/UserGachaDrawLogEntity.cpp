        ...
        const MethodInfo *method)
{
  if ( (byte_4B37ED0 & 1) == 0 )
  {
    sub_1BD3458(&Method_DataEntityBase_CreateMultiplePK_int__int__long___, *(_QWORD *)&idx);
    byte_4B37ED0 = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__long_(
           ...
           idx,
           drawAt,
           (const MethodInfo_2F2FDCC *)Method_DataEntityBase_CreateMultiplePK_int__int__long___);
}
