        ...
        const MethodInfo *method)
{
  if ( (byte_4BB542F & 1) == 0 )
  {
    sub_1C13D24(&Method_DataEntityBase_CreateMultiplePK_int__int__long___, *(_QWORD *)&idx);
    byte_4BB542F = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__long_(
           ...
           idx,
           drawAt,
           (const MethodInfo_2F8DBB4 *)Method_DataEntityBase_CreateMultiplePK_int__int__long___);
}
