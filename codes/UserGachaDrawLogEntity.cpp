        ...
        const MethodInfo *method)
{
  if ( (byte_4B458AB & 1) == 0 )
  {
    sub_1BDB878(&Method_DataEntityBase_CreateMultiplePK_int__int__long___, *(_QWORD *)&idx);
    byte_4B458AB = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__long_(
           ...
           idx,
           drawAt,
           (const MethodInfo_3032008 *)Method_DataEntityBase_CreateMultiplePK_int__int__long___);
}
