        ...
        const MethodInfo *method)
{
  if ( (byte_4A09945 & 1) == 0 )
  {
    sub_1B686D4(&Method_DataEntityBase_CreateMultiplePK_int__int__long___, *(_QWORD *)&idx);
    byte_4A09945 = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__long_(
           ...
           idx,
           drawAt,
           (const MethodInfo_2E48498 *)Method_DataEntityBase_CreateMultiplePK_int__int__long___);
}
