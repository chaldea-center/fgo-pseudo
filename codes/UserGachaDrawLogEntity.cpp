        ...
        const MethodInfo *method)
{
  if ( (byte_4BC880E & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataEntityBase_CreateMultiplePK_int__int__long___, *(_QWORD *)&idx);
    byte_4BC880E = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__long_(
           ...
           idx,
           drawAt,
           (const MethodInfo_2F9DBD8 *)Method_DataEntityBase_CreateMultiplePK_int__int__long___);
}
