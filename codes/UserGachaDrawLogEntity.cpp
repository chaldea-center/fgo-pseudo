        ...
        const MethodInfo *method)
{
  if ( (byte_4BFE4E7 & 1) == 0 )
  {
    sub_1C2E12C(&Method_DataEntityBase_CreateMultiplePK_int__int__long___, *(_QWORD *)&idx);
    byte_4BFE4E7 = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__long_(
           ...
           idx,
           drawAt,
           (const MethodInfo_2FCFF78 *)Method_DataEntityBase_CreateMultiplePK_int__int__long___);
}
