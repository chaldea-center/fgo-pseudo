        ...
        const MethodInfo *method)
{
  if ( (byte_4B6790A & 1) == 0 )
  {
    sub_1BE4ACC(&Method_DataEntityBase_CreateMultiplePK_int__int__long___, *(_QWORD *)&idx);
    byte_4B6790A = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__long_(
           ...
           idx,
           drawAt,
           (const MethodInfo_2F57858 *)Method_DataEntityBase_CreateMultiplePK_int__int__long___);
}
