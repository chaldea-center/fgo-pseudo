        ...
        const MethodInfo *method)
{
  if ( (byte_49FD0E5 & 1) == 0 )
  {
    sub_1B640C8(&Method_DataEntityBase_CreateMultiplePK_int__int__long___, *(_QWORD *)&idx);
    byte_49FD0E5 = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__long_(
           ...
           idx,
           drawAt,
           (const MethodInfo_2E37B34 *)Method_DataEntityBase_CreateMultiplePK_int__int__long___);
}
