        ...
        const MethodInfo *method)
{
  if ( (byte_4A207BC & 1) == 0 )
  {
    sub_1B715CC(&Method_DataEntityBase_CreateMultiplePK_int__int__long___, *(_QWORD *)&idx);
    byte_4A207BC = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__long_(
           ...
           idx,
           drawAt,
           (const MethodInfo_2E59B30 *)Method_DataEntityBase_CreateMultiplePK_int__int__long___);
}
