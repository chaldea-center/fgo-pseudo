        ...
        const MethodInfo *method)
{
  if ( (byte_4A4F2A9 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataEntityBase_CreateMultiplePK_int__int__long___, *(_QWORD *)&idx);
    byte_4A4F2A9 = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__long_(
           ...
           idx,
           drawAt,
           (const MethodInfo_2F6C364 *)Method_DataEntityBase_CreateMultiplePK_int__int__long___);
}
