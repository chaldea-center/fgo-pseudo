        ...
        const MethodInfo *method)
{
  ...
  __int128 v69; // q0
  UserServantCollectionMaster_o *v70; // x23
  ...
  CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_o v147; // [xsp+10h] [xbp-120h] BYREF
  CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_o v148; // [xsp+30h] [xbp-100h] BYREF
  CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_o v149; // [xsp+50h] [xbp-E0h] BYREF
  CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_o v150; // [xsp+70h] [xbp-C0h] BYREF
  CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_o v151; // [xsp+90h] [xbp-A0h] BYREF
  CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_o v152; // [xsp+B0h] [xbp-80h]
  ...
  if ( (byte_48E08F3 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_DataManager_GetMasterData_ServantClassMaster___, v17);
    sub_1B00CCC(&Method_DataManager_GetMasterData_ServantLimitMaster___, v18);
    ...
    sub_1B00CCC(&Method_DataManager_GetMasterData_UserServantLeaderMaster___, v21);
    sub_1B00CCC(&Method_DataManager_GetMaster_UserServantStorageMaster___, v22);
  ...
  *(_QWORD *)&v153.fields.currentCryptoKey = v50;
  *(_QWORD *)&v153.fields.fakeValue = v49;
  this->fields.svtId = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_45313044(v153, 0LL);
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.servantEntity, (int32_t)Entity, v53, v54);
  Instance = (int64_t)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_35FBBF0 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_161;
  Instance = (int64_t)DataManager__GetMasterData_object_(
  ...
  Instance = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_45313044(v55->fields.limitCount, 0LL);
  if ( !v56 )
    goto LABEL_161;
  Instance = (int64_t)ServantLimitMaster__GetEntity(v56, svtId, Instance, 0LL);
  if ( !*p_servantEntity )
    goto LABEL_161;
  ...
  *(_OWORD *)&v152.fields.currentCryptoKey = *(_OWORD *)&v59->fields.id.fields.currentCryptoKey;
  *(_OWORD *)&v152.fields.fakeValue = v60;
  if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
  v151 = v152;
  Instance = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_45316568(&v151, 0LL);
  servantEntity = this->fields.servantEntity;
  this->fields.isPush = v61 == Instance;
...
LABEL_26:
  ...
  if ( !v64 )
    goto LABEL_161;
  IsChoice = UserServantEntity__IsChoice(v64, 0LL);
  Instance = (int64_t)this->fields.userServantEntity;
  ...
  *(_QWORD *)&this->fields.bonusKind = 1LL;
  ...
  if ( !v66 )
    goto LABEL_161;
  Instance = UserServantEntity__IsChocolateSvtEquip(v66, 0LL);
  v67 = this->fields.userServantEntity;
  this->fields.isChocolateSvtEquip = Instance & 1;
  if ( !v67 )
    goto LABEL_161;
  this->fields.isMaterialTdSvt = UserServantEntity__IsMaterialTd(v67, 0LL);
  Instance = (int64_t)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_35FBBF0 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_161;
  Instance = (int64_t)DataManager__GetMasterData_object_(
  ...
  *(_OWORD *)&v152.fields.currentCryptoKey = *(_OWORD *)&v68->fields.userId.fields.currentCryptoKey;
  *(_OWORD *)&v152.fields.fakeValue = v69;
  if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
  v150 = v152;
  Instance = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_45316568(&v150, 0LL);
  ...
  if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
  *(_QWORD *)&v154.fields.currentCryptoKey = v74;
  *(_QWORD *)&v154.fields.fakeValue = v73;
  Instance = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_45313044(v154, 0LL);
  if ( !v70 )
    goto LABEL_161;
  Instance = (int64_t)UserServantCollectionMaster__GetEntityDefinitely(v70, v72, Instance, 0LL);
  if ( !Instance )
    goto LABEL_161;
  ...
  *(_OWORD *)&v149.fields.currentCryptoKey = *(_OWORD *)&v75->fields.id.fields.currentCryptoKey;
  *(_OWORD *)&v149.fields.fakeValue = v76;
  v77 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_45316568(&v149, 0LL);
  ...
  if ( (Instance & 1) != 0 )
  {
    ...
    if ( max_length >= 1 )
    {
      ...
      while ( 1 )
      {
        if ( max_length == v79 )
          goto LABEL_163;
        if ( v77 == partyUserEquipList->m_Items[v79] )
          break;
        if ( max_length == ++v79 )
          goto LABEL_58;
      }
...
LABEL_58:
    ...
    while ( 1 )
    {
      ...
      v85 = *(unsigned __int16 *)(&Enumerator->klass->_2.bitflags2 + 3);
...
LABEL_66:
      ...
      if ( *(_WORD *)(&Enumerator->klass->_2.bitflags2 + 3) )
      {
        ...
        while ( *((System_Collections_Generic_IEnumerator_DataEntityBase__c **)v90 - 1) != System_Collections_Generic_IEnumerator_DataEntityBase__TypeInfo )
        {
          --v89;
          v90 += 4;
          if ( !v89 )
      ...
      {
LABEL_73:
        v91 = sub_1B52CAC(Enumerator, System_Collections_Generic_IEnumerator_DataEntityBase__TypeInfo, 0LL);
      }
      v92 = (_QWORD *)(*(__int64 (__fastcall **)(System_Collections_Generic_IEnumerator_T__o *, _QWORD))v91)(
                        Enumerator,
                        *(_QWORD *)(v91 + 8));
      if ( !v92 )
        goto LABEL_165;
      methodPtr_low = LOBYTE(UserServantLeaderEntity_TypeInfo->vtable._0_Equals.methodPtr);
      if ( *(unsigned __int8 *)(*v92 + 304LL) < (unsigned int)methodPtr_low
        || *(UserServantLeaderEntity_c **)(*(_QWORD *)(*v92 + 200LL) + 8 * methodPtr_low - 8) != UserServantLeaderEntity_TypeInfo )
      {
        break;
      }
      v95 = v92[4];
      ...
      {
        v96 = *(_OWORD *)(v95 + 40);
        *(_OWORD *)&v152.fields.currentCryptoKey = *(_OWORD *)(v95 + 24);
        *(_OWORD *)&v152.fields.fakeValue = v96;
        if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
        v148 = v152;
        if ( CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_45316568(&v148, 0LL) == v77 )
        {
...
LABEL_83:
          ...
          {
LABEL_87:
            v100 = sub_1B52CAC(Enumerator, System_IDisposable_TypeInfo, 0LL);
          }
          ...
          Instance = (int64_t)DataManager__GetMaster_object_((const MethodInfo_2D62BBC *)Method_DataManager_GetMaster_UserServantStorageMaster___);
          if ( Instance )
          {
            Instance = (int64_t)UserServantStorageMaster__getList((UserServantStorageMaster_o *)Instance, 0LL);
            if ( Instance )
            {
              v129 = *(_QWORD *)(Instance + 24);
              v130 = Instance;
              if ( (int)v129 >= 1 )
              {
                v131 = 0LL;
                while ( 1 )
                {
                  ...
                  {
                    v133 = *(_OWORD *)(v132 + 32);
                    *(_OWORD *)&v152.fields.currentCryptoKey = *(_OWORD *)(v132 + 16);
                    *(_OWORD *)&v152.fields.fakeValue = v133;
                    if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo->_2.cctor_finished )
                      j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
                    v147 = v152;
...
LABEL_163:
  ...
  if ( !partyUserServantList )
    goto LABEL_161;
  v80 = partyUserServantList->max_length;
  if ( v80 >= 1 )
  {
    v81 = 0;
    while ( 1 )
    {
      if ( v80 == v81 )
        goto LABEL_163;
      if ( v77 == partyUserServantList->m_Items[v81] )
        break;
      if ( v80 == ++v81 )
        goto LABEL_89;
    }
...
LABEL_89:
  ...
  while ( 1 )
  {
    ...
    {
LABEL_97:
      v106 = sub_1B52CAC(v102, System_Collections_IEnumerator_TypeInfo, 0LL);
    }
    ...
    {
LABEL_104:
      v110 = sub_1B52CAC(v102, System_Collections_Generic_IEnumerator_DataEntityBase__TypeInfo, 0LL);
    }
    ...
    v113 = LOBYTE(UserServantLeaderEntity_TypeInfo->vtable._0_Equals.methodPtr);
    if ( *(unsigned __int8 *)(*v111 + 304LL) < (unsigned int)v113
      || *(UserServantLeaderEntity_c **)(*(_QWORD *)(*v111 + 200LL) + 8 * v113 - 8) != UserServantLeaderEntity_TypeInfo )
    {
      sub_1B011E8(v111);
LABEL_165:
      sub_1B00F28(v92, v93);
  ...
  v114 = v102->klass;
  v115 = *(unsigned __int16 *)(&v102->klass->_2.bitflags2 + 3);
  if ( *(_WORD *)(&v102->klass->_2.bitflags2 + 3) )
  {
  ...
  {
LABEL_115:
    v117 = sub_1B52CAC(v102, System_IDisposable_TypeInfo, 0LL);
  }
  (*(void (__fastcall **)(System_Collections_Generic_IEnumerator_T__o *, _QWORD))v117)(v102, *(_QWORD *)(v117 + 8));
  Instance = (int64_t)*p_userServantEntity;
  if ( !*p_userServantEntity )
    goto LABEL_161;
  v118 = *(_DWORD *)(Instance + 276);
  ...
  this->fields.hpReinforceValue = static_fields->StatusUpAdjustHp * v118;
  if ( !Instance )
    goto LABEL_161;
  ...
  if ( !v121 )
    goto LABEL_161;
  SkillCategoryIdList = UserServantEntity__GetSkillCategoryIdList(v121, -1, 0LL);
...
LABEL_142:
  sub_1B00C70((ServantStatusBattleListViewItem_o *)p_equipCategoryIdList, (int32_t)EquipCategoryIdList, v126, v127);
  this->fields.isFatigueRecovery = 0;
  if ( recoverySvtList )
  {
    v134 = recoverySvtList->max_length;
    if ( v134 >= 1 )
    {
      v135 = 0LL;
      while ( 1 )
      {
        if ( (unsigned int)v135 >= v134 )
          goto LABEL_163;
        if ( recoverySvtList->m_Items[v135] == v77 )
          break;
        if ( (int)++v135 >= v134 )
          goto LABEL_150;
      }
...
LABEL_150:
  UserSvtId = WarehouseListViewItem__get_UserSvtId(this, v47);
  ...
  if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
  *(_QWORD *)&v155.fields.currentCryptoKey = v144;
  *(_QWORD *)&v155.fields.fakeValue = v143;
...
// local variable allocation has failed, the output may be wrong!
void __fastcall WarehouseListViewItem__Modify_34661036(
        WarehouseListViewItem_o *this,
        bool isFavorite,
        bool isPush,
        const MethodInfo *method)
{
  ...
  if ( !userServantEntity
    || (userServantEntity = (UserServantEntity_o *)UserServantEntity__IsLock(userServantEntity, 0LL),
        ...
        !v6) )
  {
    sub_1B00F28(userServantEntity, isFavorite);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E08F4 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_DataManager_GetMasterData_EventGroupMaster___, v7);
    sub_1B00CCC(&Method_DataManager_GetMasterData_EventMaster___, v8);
    sub_1B00CCC(&Method_DataManager_GetMasterData_ServantFilterMaster___, v9);
    sub_1B00CCC(&Method_DataManager_GetMaster_EventCampaignMaster___, v10);
    sub_1B00CCC(&Method_DataManager_GetMaster_EventGroupMaster___, v11);
    sub_1B00CCC(&DataManager_TypeInfo, v12);
    sub_1B00CCC(&Method_DataMasterBase_EventMaster__EventEntity__int__TryGetEntity__, v13);
    sub_1B00CCC(&System_Func_int__bool__TypeInfo, v14);
    sub_1B00CCC(&System_Func_EventGroupEntity__bool__TypeInfo, v15);
    sub_1B00CCC(&Method_System_Collections_Generic_List_EventGroupEntity__get_Count__, v16);
    ...
    sub_1B00CCC(&Method_WarehouseListViewItem__SetSortValue_b__62_0__, v21);
    sub_1B00CCC(&Method_WarehouseListViewItem__SetSortValue_b__62_1__, v22);
    sub_1B00CCC(&Method_WarehouseListViewItem__SetSortValue_b__62_2__, v23);
    sub_1B00CCC(&Method_WarehouseListViewItem__SetSortValue_b__62_3__, v24);
    this = (WarehouseListViewItem_o *)sub_1B00CCC(&WarehouseListViewManager_TypeInfo, v25);
    byte_48E08F4 = 1;
  }
  entity = 0LL;
  tdMaxLv = 0LL;
  ...
  if ( !setupInfo->fields.isQuestStart )
  {
    ...
    switch ( bonusKind2 )
    {
      case 0:
        ...
        if ( !DataManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
        this = (WarehouseListViewItem_o *)DataManager__GetMaster_object_((const MethodInfo_2D62BBC *)Method_DataManager_GetMaster_EventGroupMaster___);
        if ( !this )
          goto LABEL_205;
        ...
        {
          v39 = (System_Func_object__bool__o *)sub_1B00F18(System_Func_EventGroupEntity__bool__TypeInfo);
          System_Func_object__bool____ctor(
            v39,
            (Il2CppObject *)v4,
            Method_WarehouseListViewItem__SetSortValue_b__62_2__,
            0LL);
      ...
      case 8:
        ...
        this = (WarehouseListViewItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_35FBBF0 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
        if ( !this )
          goto LABEL_205;
        ...
        OtherEventEquipIdList = EventBonusFilterMaster__GetOtherEventEquipIdList(
                                  ...
                                  eventIdList,
                                  0LL);
        v47 = (System_Func_int__bool__o *)sub_1B00F18(System_Func_int__bool__TypeInfo);
        v48 = &Method_WarehouseListViewItem__SetSortValue_b__62_3__;
        goto LABEL_76;
      default:
        goto LABEL_83;
    }
...
LABEL_67:
    ...
    if ( !v51 )
      goto LABEL_205;
    EventUpVal_38925380 = ServantFilterMaster__IsEnableServant(v51, v52, v4->fields.bonusKindId, 0LL);
    goto LABEL_82;
  }
  if ( !bonusKind )
  {
...
LABEL_52:
      ...
      if ( this )
      {
        ...
        if ( ((unsigned __int8)this & 1) == 0 )
        {
          ...
          {
            v44 = (System_Func_object__bool__o *)sub_1B00F18(System_Func_EventGroupEntity__bool__TypeInfo);
            System_Func_object__bool____ctor(
              v44,
              (Il2CppObject *)v4,
              Method_WarehouseListViewItem__SetSortValue_b__62_0__,
              0LL);
...
LABEL_59:
  ...
  if ( v3->fields.bonusKind2 == 8 )
  {
    ...
    v47 = (System_Func_int__bool__o *)sub_1B00F18(System_Func_int__bool__TypeInfo);
    v48 = &Method_WarehouseListViewItem__SetSortValue_b__62_1__;
LABEL_76:
    v54 = (System_Func_T__bool__o *)v47;
    System_Func_int__bool____ctor(v47, (Il2CppObject *)v4, *v48, 0LL);
    EventUpVal_38925380 = BasicHelper__Any_int__47506688(
...
LABEL_78:
    ...
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    this = (WarehouseListViewItem_o *)DataManager__GetMaster_object_((const MethodInfo_2D62BBC *)Method_DataManager_GetMaster_EventCampaignMaster___);
    if ( !this )
      goto LABEL_205;
    EventUpVal_38925380 = EventCampaignMaster__IsEnableServant(
...
LABEL_102:
  if ( isChoice && v3->fields.isChoiceSort )
    *(_OWORD *)p_sortValue0 = xmmword_B705A0;
LABEL_104:
  ...
  switch ( v3->fields.sortKind )
  {
    case 1:
      ...
      *(_OWORD *)&v97.fields.fakeValue = v59;
      if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
      v96 = v97;
      this = (WarehouseListViewItem_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_45316568(&v96, 0LL);
      ...
      if ( !iconLabelInfo2 )
        goto LABEL_205;
      IconLabelInfo__Set_36930772(iconLabelInfo2, 2, v62, (int32_t)this, 0, 0, 0, 0, 0LL);
      this = (WarehouseListViewItem_o *)v4->fields.userServantEntity;
      if ( !this )
        goto LABEL_205;
    ...
    case 3:
      ...
      if ( !iconLabelInfo1 )
        goto LABEL_205;
      IconLabelInfo__Set_36930772(iconLabelInfo1, 2, v81, (int32_t)this, 0, 0, 0, 0, 0LL);
      goto LABEL_195;
    case 4:
      this = (WarehouseListViewItem_o *)v4->fields.userServantEntity;
      if ( !this )
    ...
    case 6:
      ...
      v67 = 5;
LABEL_154:
      IconLabelInfo__Set_36930772((IconLabelInfo_o *)this, v67, hp, adjustHp, 0, 0, 0, 0, 0LL);
      this = (WarehouseListViewItem_o *)v4->fields.userServantEntity;
      if ( !this )
        goto LABEL_205;
...
LABEL_169:
    ...
    case 0x10:
      ...
      v70 = 45;
LABEL_174:
      IconLabelInfo__Set_36930772((IconLabelInfo_o *)this, v70, friendship, friendshipMax, 0, 0, 0, 0, 0LL);
LABEL_175:
      this = (WarehouseListViewItem_o *)v4->fields.userServantEntity;
      if ( !this )
        goto LABEL_205;
      ...
      if ( !v92 )
        goto LABEL_205;
      IconLabelInfo__Set_36930772(v92, 2, v93, (int32_t)this, 0, 0, 0, 0, 0LL);
      this = (WarehouseListViewItem_o *)v4->fields.servantEntity;
      if ( !this )
        goto LABEL_205;
...
LABEL_189:
      ...
      this = (WarehouseListViewItem_o *)DataManager__GetMasterData_object_(
                                          (DataManager_o *)this,
                                          (const MethodInfo_2D62C10 *)Method_DataManager_GetMasterData_EventGroupMaster___);
      ...
      if ( (*(_BYTE *)(v77 + 309) & 1) == 0 )
        v77 = sub_1B52BA8(*((_QWORD *)Method_SingletonMonoBehaviour_DataManager__getInstance__ + 4));
...
LABEL_193:
      ...
      if ( !v84 )
        goto LABEL_205;
      IconLabelInfo__Set_36930772(v84, 2, lv, (int32_t)this, 0, 0, 0, 0, 0LL);
LABEL_195:
      LOBYTE(this) = 1;
      return (char)this;
    default:
        ...
        const MethodInfo *method)
{
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  v10 = DataManager__GetMaster_object_((const MethodInfo_2D62BBC *)Method_DataManager_GetMaster_ServantFilterMaster___);
  svtId = this->fields.svtId;
...
bool __fastcall WarehouseListViewItem___SetSortValue_b__62_2(
        WarehouseListViewItem_o *this,
        EventGroupEntity_o *entity,
        const MethodInfo *method)
{
...
bool __fastcall WarehouseListViewItem___SetSortValue_b__62_3(
        WarehouseListViewItem_o *this,
        int32_t x,
        const MethodInfo *method)
{
...
int64_t __fastcall WarehouseListViewItem__get_UserSvtId(WarehouseListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E08F7 & 1) == 0 )
  {
    this = (WarehouseListViewItem_o *)sub_1B00CCC(&CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo, method);
    byte_48E08F7 = 1;
  }
