...
void __fastcall TermsOfUseDlg__Close(TermsOfUseDlg_o *this, const MethodInfo *method)
{
  ...
  TermsOfUseDlg__Close_18730408(this, 0LL, v2);
}


void __fastcall TermsOfUseDlg__Close_18730408(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4387A2D & 1) == 0 )
  {
    ...
    sub_B775C4(&Method_TermsOfUseDlg_EndClose__);
    byte_4387A2D = 1;
  }
...
void __fastcall TermsOfUseDlg__OnClickShow(TermsOfUseDlg_o *this, const MethodInfo *method)
{
  ...
  System_String_o *WebViewAddress_26221564; // x21
  ...
  if ( (byte_4387A2E & 1) == 0 )
  {
    ...
    sub_B775C4(&SoundManager_TypeInfo);
    sub_B775C4(&Method_TermsOfUseDlg_OnEndShowWebView__);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    WebViewAddress_26221564 = NetworkManager__getWebViewAddress_26221564(wvAddress, 0LL);
    ...
    WebViewManager__OpenView(wvTitle, WebViewAddress_26221564, v6, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B775C4(&System_Action_TypeInfo);
    sub_B775C4(&Method_TermsOfUseDlg_EndOpen__);
    byte_4387A2C = 1;
  }
...
LABEL_11:
    ...
    sub_B77560(&this->fields.wvTitle);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4387A29 & 1) == 0 )
  {
    sub_B775C4(&TermsOfUseDlg_CallbackFunc_TypeInfo);
    byte_4387A29 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (TermsOfUseDlg_o *)sub_B77990(v8);
