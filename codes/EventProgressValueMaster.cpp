void __fastcall EventProgressValueMaster___ctor(EventProgressValueMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A6FF06 & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_EventProgressValueMaster__EventProgressValueEntity__string___ctor__, method);
    byte_4A6FF06 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    394,
    (const MethodInfo_312C8C0 *)Method_DataMasterBase_EventProgressValueMaster__EventProgressValueEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FF08 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_System_Collections_Generic_List_EventProgressValueEntity__get_Count__, v5);
    sub_1B90010(&Method_System_Collections_Generic_List_EventProgressValueEntity__get_Item__, v6);
    byte_4A6FF08 = 1;
  }
...
LABEL_13:
    sub_1B9026C(EntityListByEventId, v8);
  ...
  for ( i = EntityListByEventId->fields._size - 1; (i & 0x80000000) == 0; --i )
  {
    EntityListByEventId = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___get_Item(
                                                                         v9,
                                                                         i,
                                                                         (const MethodInfo_35106F0 *)Method_System_Collections_Generic_List_EventProgressValueEntity__get_Item__);
    if ( !EntityListByEventId )
      goto LABEL_13;
        ...
        const MethodInfo *method)
{
  ...
  return (EventProgressValueEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                         (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                         PK,
                                         (const MethodInfo_312C900 *)Method_DataMasterBase_EventProgressValueMaster__EventProgressValueEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FF07 & 1) == 0 )
  {
    ...
    sub_1B90010(&EventProgressValueEntity_TypeInfo, v6);
    sub_1B90010(&Method_System_Collections_Generic_List_EventProgressValueEntity__Add__, v7);
    sub_1B90010(&Method_System_Collections_Generic_List_EventProgressValueEntity___ctor__, v8);
    sub_1B90010(&System_Collections_Generic_List_EventProgressValueEntity__TypeInfo, v9);
    byte_4A6FF07 = 1;
  }
  v10 = (System_Collections_Generic_List_object__o *)sub_1B9025C(System_Collections_Generic_List_EventProgressValueEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v10,
    (const MethodInfo_351018C *)Method_System_Collections_Generic_List_EventProgressValueEntity___ctor__);
        ...
        const MethodInfo *method)
{
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_312C950 *)Method_DataMasterBase_EventProgressValueMaster__EventProgressValueEntity__string__TryGetEntity__);
}