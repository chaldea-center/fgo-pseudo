        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C374EE & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_System_Collections_Generic_List_int_____ctor__);
    sub_1C32C20(&System_Collections_Generic_List_int____TypeInfo);
    sub_1C32C20(&Method_EntityScriptValueConvertLogic___c__ObjectListTo2DimensionalIntArray_b__3_0__);
    sub_1C32C20(&EntityScriptValueConvertLogic___c_TypeInfo);
    byte_4C374EE = 1;
  }
  v5 = (System_Collections_Generic_List_object__o *)sub_1C32E6C(System_Collections_Generic_List_int____TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v5,
    (const MethodInfo_3797F88 *)Method_System_Collections_Generic_List_int_____ctor__);
  ...
  if ( (int)max_length >= 1 )
  {
    ...
    do
    {
      ...
      if ( !_9__3_0 )
      {
        ...
        _9__3_0 = (System_Func_object__int__o *)sub_1C32E6C(System_Func_string__int__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C374EF & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_System_Collections_Generic_List_Enumerator_object__MoveNext__);
    sub_1C32C20(&Method_System_Collections_Generic_List_Enumerator_object__get_Current__);
    sub_1C32C20(&Method_System_Collections_Generic_List_string____Add__);
    sub_1C32C20(&Method_System_Collections_Generic_List_object__GetEnumerator__);
    sub_1C32C20(&Method_System_Collections_Generic_List_string____ToArray__);
    sub_1C32C20(&Method_System_Collections_Generic_List_string_____ctor__);
    sub_1C32C20(&System_Collections_Generic_List_string____TypeInfo);
    byte_4C374EF = 1;
  }
  memset(&v18, 0, sizeof(v18));
  v5 = (System_Collections_Generic_List_object__o *)sub_1C32E6C(System_Collections_Generic_List_string____TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v5,
    (const MethodInfo_3797F88 *)Method_System_Collections_Generic_List_string_____ctor__);
  if ( !rawValue )
    goto LABEL_19;
  System_Collections_Generic_List_object___GetEnumerator(
    (System_Collections_Generic_List_Enumerator_T__o *)&v17,
...
LABEL_19:
  ...
  return (System_String_array_array *)System_Collections_Generic_List_object___ToArray(
                                        v5,
                                        (const MethodInfo_379A314 *)Method_System_Collections_Generic_List_string____ToArray__);
}
    ...
    if ( v6 )
    {
      ...
      if ( (unsigned int)size >= LODWORD(items->max_length) )
      {
        System_Collections_Generic_List_float___AddWithResize(
          v3,
          v7,
          *(const MethodInfo_37BE338 **)(*(_QWORD *)(v9[4] + 192LL) + 112LL));
      }
      else
      {
        v3->fields._size = size + 1;
        ...
        const MethodInfo *method)
{
  ...
  sub_1C3313C(v20.fields._current);
  v15 = v14;
  v17 = v16;
  __cxa_end_catch();
  if ( v17 != 1 )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C374EC & 1) == 0 )
  {
    sub_1C32C20(&Method_System_Linq_Enumerable_Select_object__string___);
    sub_1C32C20(&Method_System_Linq_Enumerable_ToArray_string___);
    sub_1C32C20(&System_Func_object__string__TypeInfo);
    sub_1C32C20(&Method_EntityScriptValueConvertLogic___c__ObjectListToStringArray_b__1_0__);
    sub_1C32C20(&EntityScriptValueConvertLogic___c_TypeInfo);
    byte_4C374EC = 1;
  }
  ...
  if ( !_9__1_0 )
  {
    ...
    _9__1_0 = (System_Func_object__object__o *)sub_1C32E6C(System_Func_object__string__TypeInfo);
    ...
    sub_1C32BC4((CGThumbnailListItem_o *)&static_fields->__9__1_0, (int32_t)_9__1_0, v7, v8);
  }
  v9 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_object__object_(
                                                              ...
                                                              (const MethodInfo_3113ABC *)Method_System_Linq_Enumerable_Select_object__string___);
...
void EntityScriptValueConvertLogic___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C32E6C(EntityScriptValueConvertLogic___c_TypeInfo);
  System_Object___ctor(v1, 0);
  EntityScriptValueConvertLogic___c_TypeInfo->static_fields->__9 = (struct EntityScriptValueConvertLogic___c_o *)v1;
  sub_1C32BC4((CGThumbnailListItem_o *)EntityScriptValueConvertLogic___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
