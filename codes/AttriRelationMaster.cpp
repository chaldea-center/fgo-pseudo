void __fastcall AttriRelationMaster___ctor(AttriRelationMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4B1C12B & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataMasterBase_AttriRelationMaster__AttriRelationEntity__string___ctor__, method);
    byte_4B1C12B = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    112,
    (const MethodInfo_32CA594 *)Method_DataMasterBase_AttriRelationMaster__AttriRelationEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (AttriRelationEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                    PK,
                                    (const MethodInfo_32CC8B8 *)Method_DataMasterBase_AttriRelationMaster__AttriRelationEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1C12A & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataMasterBase_AttriRelationMaster__AttriRelationEntity__string__TryGetEntity__, entity);
    byte_4B1C12A = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_32CC904 *)Method_DataMasterBase_AttriRelationMaster__AttriRelationEntity__string__TryGetEntity__);
}
...
float __fastcall AttriRelationMaster__getRate(int32_t atk, int32_t def, const MethodInfo *method)
{
  ...
  if ( (byte_4B1C12C & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_AttriRelationMaster___, *(_QWORD *)&def);
  ...
  MasterData_object = DataManager__GetMasterData_object_(
                        ...
                        (const MethodInfo_301AAA4 *)Method_DataManager_GetMasterData_AttriRelationMaster___);
  v10 = 1.0;
