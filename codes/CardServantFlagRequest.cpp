        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFF05D & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_24158/*"svtId"*/, *(_QWORD *)&svtId);
    sub_1C2E12C(&StringLiteral_19809/*"flagId"*/, v7);
    byte_4BFF05D = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_24158/*"svtId"*/, svtId, method);
...
System_String_o *__fastcall CardServantFlagRequest__getURL(CardServantFlagRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFF05B & 1) == 0 )
  {
    ...
    sub_1C2E12C(&StringLiteral_18075/*"card/svtFlag"*/, v2);
    byte_4BFF05B = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63235584(BaseUrl, (System_String_o *)StringLiteral_18075/*"card/svtFlag"*/, 0LL);
}
