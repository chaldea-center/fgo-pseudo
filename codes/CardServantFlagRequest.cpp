        ...
        const MethodInfo *method)
{
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_24099/*"svtId"*/, svtId, 0);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19633/*"flagId"*/, flagId, 0);
...
System_String_o *CardServantFlagRequest__getURL(CardServantFlagRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CF00CF & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_17851/*"card/svtFlag"*/);
    byte_4CF00CF = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64176912(BaseUrl, (System_String_o *)StringLiteral_17851/*"card/svtFlag"*/, 0);
}
