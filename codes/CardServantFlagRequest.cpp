        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FCF32 & 1) == 0 )
  {
    sub_B16FFC(&StringLiteral_22376, *(_QWORD *)&svtId);
    sub_B16FFC(&StringLiteral_18685, v7);
    byte_40FCF32 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22376, svtId, 0LL);
...
System_String_o *__fastcall CardServantFlagRequest__getURL(CardServantFlagRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_40FCF30 & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_17160, v2);
    byte_40FCF30 = 1;
  }
  ...
  return System_String__Concat_43743732(BaseUrl, (System_String_o *)StringLiteral_17160, 0LL);
}
