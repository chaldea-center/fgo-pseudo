void UserEquipNewManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4D2DE05 & 1) == 0 )
  {
    sub_1C94098(&Method_System_Collections_Generic_List_UserEquipNewManager_UserEquipLvInfo___ctor__);
    sub_1C94098(&System_Collections_Generic_List_UserEquipNewManager_UserEquipLvInfo__TypeInfo);
    sub_1C94098(&UserEquipNewManager_TypeInfo);
    sub_1C94098(&StringLiteral_6677/*"Fgo_20150511_1"*/);
    byte_4D2DE05 = 1;
  }
  UserEquipNewManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6677/*"Fgo_20150511_1"*/;
  sub_1C9403C(
  ...
  *(_WORD *)&UserEquipNewManager_TypeInfo->static_fields->isModfiy = 0;
  v7 = (System_Collections_Generic_List_object__o *)sub_1C942E4(System_Collections_Generic_List_UserEquipNewManager_UserEquipLvInfo__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v7,
    (const MethodInfo_386A600 *)Method_System_Collections_Generic_List_UserEquipNewManager_UserEquipLvInfo___ctor__);
  ...
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&static_fields->openList, (int32_t)v7, v9, v10, v11, v12, v13, v14);
}
...
void UserEquipNewManager__ClearSaveDataList(const MethodInfo *method)
{
  ...
  if ( (byte_4D2DDFF & 1) == 0 )
  {
    sub_1C94098(&Method_System_Collections_Generic_List_UserEquipNewManager_UserEquipLvInfo__Clear__);
    sub_1C94098(&Method_System_Collections_Generic_List_UserEquipNewManager_UserEquipLvInfo__get_Count__);
    sub_1C94098(&UserEquipNewManager_TypeInfo);
    byte_4D2DDFF = 1;
  }
...
bool UserEquipNewManager__IsNew(int32_t equipId, int32_t lv, const MethodInfo *method)
{
  ...
  {
    sub_1C94098(&Method_System_Collections_Generic_List_UserEquipNewManager_UserEquipLvInfo__get_Count__);
    sub_1C94098(&Method_System_Collections_Generic_List_UserEquipNewManager_UserEquipLvInfo__get_Item__);
    sub_1C94098(&UserEquipNewManager_TypeInfo);
    byte_4D2DE01 = 1;
  }
  ...
  if ( v7 >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      Item = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___get_Item(
                                                            Item,
                                                            v8 - 1,
                                                            (const MethodInfo_386AB64 *)Method_System_Collections_Generic_List_UserEquipNewManager_UserEquipLvInfo__get_Item__);
      if ( !Item )
        break;
...
bool UserEquipNewManager__ReadData(const MethodInfo *method)
{
  ...
  if ( (byte_4D2DE03 & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_System_Collections_Generic_List_UserEquipNewManager_UserEquipLvInfo__Add__);
    sub_1C94098(&ManagerConfig_TypeInfo);
    sub_1C94098(&UserEquipNewManager_UserEquipLvInfo_TypeInfo);
    sub_1C94098(&UserEquipNewManager_TypeInfo);
    byte_4D2DE03 = 1;
  }
  v1 = UserEquipNewManager_TypeInfo;
        ...
        if ( v16 >= 1 )
        {
          do
          {
            ...
            v18 = ((__int64 (__fastcall *)(System_IO_BinaryReader_o *, const MethodInfo *))v8->klass->vtable._15_ReadInt32.methodPtr)(
                    v8,
                    v8->klass->vtable._15_ReadInt32.method);
            v19 = sub_1C942E4(UserEquipNewManager_UserEquipLvInfo_TypeInfo);
...
void UserEquipNewManager__SetOld(int32_t equipId, int32_t lv, const MethodInfo *method)
{
  ...
  {
LABEL_15:
    v10 = sub_1C942E4(UserEquipNewManager_UserEquipLvInfo_TypeInfo);
...
LABEL_29:
    sub_1C942F0(openList, *(_QWORD *)&lv);
  }
  for ( i = 0; ; ++i )
  {
