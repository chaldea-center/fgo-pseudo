void __fastcall UserEquipNewManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A710C7 & 1) == 0 )
  {
    sub_1B90010(&Method_System_Collections_Generic_List_UserEquipNewManager_UserEquipLvInfo___ctor__, v1);
    sub_1B90010(&System_Collections_Generic_List_UserEquipNewManager_UserEquipLvInfo__TypeInfo, v4);
    sub_1B90010(&UserEquipNewManager_TypeInfo, v5);
    sub_1B90010(&StringLiteral_6636/*"Fgo_20150511_1"*/, v6);
    byte_4A710C7 = 1;
  }
  UserEquipNewManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6636/*"Fgo_20150511_1"*/;
  sub_1B8FFB4(
    (ServantStatusBattleListViewItem_o *)UserEquipNewManager_TypeInfo->static_fields,
    StringLiteral_6636/*"Fgo_20150511_1"*/,
    v2,
    v3);
  *(_WORD *)&UserEquipNewManager_TypeInfo->static_fields->isModfiy = 0;
  v7 = (System_Collections_Generic_List_object__o *)sub_1B9025C(System_Collections_Generic_List_UserEquipNewManager_UserEquipLvInfo__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v7,
    (const MethodInfo_351018C *)Method_System_Collections_Generic_List_UserEquipNewManager_UserEquipLvInfo___ctor__);
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&static_fields->openList, (int32_t)v7, v9, v10);
}
...
void __fastcall UserEquipNewManager__ClearSaveDataList(const MethodInfo *method)
{
  ...
  if ( (byte_4A710C1 & 1) == 0 )
  {
    sub_1B90010(&Method_System_Collections_Generic_List_UserEquipNewManager_UserEquipLvInfo__Clear__, v1);
    sub_1B90010(&Method_System_Collections_Generic_List_UserEquipNewManager_UserEquipLvInfo__get_Count__, v2);
    sub_1B90010(&UserEquipNewManager_TypeInfo, v3);
    byte_4A710C1 = 1;
  }
...
void __fastcall UserEquipNewManager__CreateContinueDeviceSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4A710BF & 1) == 0 )
  {
    sub_1B90010(&UserEquipNewManager_TypeInfo, v1);
    byte_4A710BF = 1;
  }
...
bool __fastcall UserEquipNewManager__IsNew(int32_t equipId, int32_t lv, const MethodInfo *method)
{
  ...
  if ( (byte_4A710C3 & 1) == 0 )
  {
    sub_1B90010(
      ...
      *(_QWORD *)&lv);
    sub_1B90010(&Method_System_Collections_Generic_List_UserEquipNewManager_UserEquipLvInfo__get_Item__, v5);
  ...
  if ( v9 >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      Item = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___get_Item(
                                                            Item,
                                                            v10 - 1,
                                                            (const MethodInfo_35106F0 *)Method_System_Collections_Generic_List_UserEquipNewManager_UserEquipLvInfo__get_Item__);
      if ( !Item )
        break;
...
void __fastcall UserEquipNewManager__LoginProcess(const MethodInfo *method)
{
  ...
  if ( (byte_4A710C2 & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMasterData_UserEquipMaster___, v1);
  ...
  if ( v4->static_fields->isContinueDevice )
  {
    ...
    if ( !Instance
      || (Instance = DataManager__GetMasterData_object_(
                       ...
                       (const MethodInfo_2E8E21C *)Method_DataManager_GetMasterData_UserEquipMaster___)) == 0LL )
    {
...
bool __fastcall UserEquipNewManager__ReadData(const MethodInfo *method)
{
  ...
  if ( (byte_4A710C5 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_System_Collections_Generic_List_UserEquipNewManager_UserEquipLvInfo__Add__, v3);
    sub_1B90010(&ManagerConfig_TypeInfo, v4);
    sub_1B90010(&UserEquipNewManager_UserEquipLvInfo_TypeInfo, v5);
    sub_1B90010(&UserEquipNewManager_TypeInfo, v6);
    byte_4A710C5 = 1;
  }
  ...
  if ( !v8->static_fields->UseMock )
  {
    ...
    if ( System_IO_File__Exists(SaveFileName, 0LL) )
    {
        ...
        if ( v22 >= 1 )
        {
          do
          {
            ...
            v24 = ((__int64 (__fastcall *)(System_IO_BinaryReader_o *, Il2CppMethodPointer))v14->klass->vtable._15_ReadInt32.method)(
                    v14,
                    v14->klass->vtable._16_ReadUInt32.methodPtr);
            v25 = sub_1B9025C(UserEquipNewManager_UserEquipLvInfo_TypeInfo);
      ...
      {
LABEL_36:
        v39 = sub_1BE1FF0(v14, System_IDisposable_TypeInfo, 0LL);
      }
...
void __fastcall UserEquipNewManager__SetOld(int32_t equipId, int32_t lv, const MethodInfo *method)
{
  ...
  if ( (byte_4A710C4 & 1) == 0 )
  {
    sub_1B90010(&Method_System_Collections_Generic_List_UserEquipNewManager_UserEquipLvInfo__Add__, *(_QWORD *)&lv);
    sub_1B90010(&Method_System_Collections_Generic_List_UserEquipNewManager_UserEquipLvInfo__get_Count__, v5);
    sub_1B90010(&Method_System_Collections_Generic_List_UserEquipNewManager_UserEquipLvInfo__get_Item__, v6);
    sub_1B90010(&UserEquipNewManager_UserEquipLvInfo_TypeInfo, v7);
    sub_1B90010(&UserEquipNewManager_TypeInfo, v8);
    byte_4A710C4 = 1;
  }
  ...
  {
LABEL_15:
    v14 = sub_1B9025C(UserEquipNewManager_UserEquipLvInfo_TypeInfo);
      ...
      if ( openList )
      {
        ...
        if ( items )
        {
          ...
          else
          {
            ...
            openList->fields._size = size + 1;
            *(_QWORD *)(v21 + 32) = v14;
            sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v21 + 32), v14, v15, v16);
          }
          goto LABEL_23;
        }
      }
...
LABEL_29:
    sub_1B9026C(openList, *(_QWORD *)&lv);
  }
  for ( i = 0; ; ++i )
  {
...
bool __fastcall UserEquipNewManager__WriteData(const MethodInfo *method)
{
  ...
  if ( (byte_4A710C6 & 1) == 0 )
  {
    ...
    sub_1B90010(&System_IDisposable_TypeInfo, v2);
    sub_1B90010(&Method_System_Collections_Generic_List_UserEquipNewManager_UserEquipLvInfo__get_Count__, v3);
    sub_1B90010(&Method_System_Collections_Generic_List_UserEquipNewManager_UserEquipLvInfo__get_Item__, v4);
