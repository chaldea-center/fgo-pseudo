  ...
  else
  {
    if ( !v8 )
    {
      if ( LOBYTE(this[1].fields.method_ptr) )
      {
        ...
        {
          if ( (v12 & 1) != 0 )
            v9 = (Il2CppObject *)sub_19C8538;
          else
            v9 = (Il2CppObject *)sub_19C84FC;
        }
        else if ( (v12 & 1) != 0 )
        {
          v9 = (Il2CppObject *)sub_19C8478;
        }
        else
        {
          v9 = (Il2CppObject *)sub_19C844C;
        }
      }
      else
      {
        v9 = (Il2CppObject *)sub_19C841C;
      }
      goto LABEL_16;
    }
    if ( !object )
...
LABEL_17:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19C83D4;
}
