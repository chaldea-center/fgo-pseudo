        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B36E1A & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_22670/*"overwriteMasterBackgroundId"*/, method);
    byte_4B36E1A = 1;
  }
  return BattleMasterImageEntity__getScript(this, (System_String_o *)StringLiteral_22670/*"overwriteMasterBackgroundId"*/, 0, v2);
}
