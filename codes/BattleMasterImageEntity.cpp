        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FAF4 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_22429/*"overwriteMasterBackgroundId"*/, method);
    byte_4A6FAF4 = 1;
  }
  return BattleMasterImageEntity__getScript(this, (System_String_o *)StringLiteral_22429/*"overwriteMasterBackgroundId"*/, 0, v2);
}
