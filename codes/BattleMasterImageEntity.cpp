        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B446D0 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_22580/*"overwriteMasterBackgroundId"*/, method);
    byte_4B446D0 = 1;
  }
  return BattleMasterImageEntity__getScript(this, (System_String_o *)StringLiteral_22580/*"overwriteMasterBackgroundId"*/, 0, v2);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4B446D1 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_22590/*"overwriteResultPosition"*/, method);
    byte_4B446D1 = 1;
  }
  return EntityScriptUtil__GetIntArray(this->fields.script, (System_String_o *)StringLiteral_22590/*"overwriteResultPosition"*/, 0LL, 0LL);
}
