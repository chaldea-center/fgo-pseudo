        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFD3B9 & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_22818/*"overwriteMasterBackgroundId"*/, method);
    byte_4BFD3B9 = 1;
  }
  return BattleMasterImageEntity__getScript(this, (System_String_o *)StringLiteral_22818/*"overwriteMasterBackgroundId"*/, 0, v2);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4BFD3BA & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_22827/*"overwriteResultPosition"*/, method);
    byte_4BFD3BA = 1;
  }
  return EntityScriptUtil__GetIntArray(this->fields.script, (System_String_o *)StringLiteral_22827/*"overwriteResultPosition"*/, 0LL, 0LL);
}
