        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21BC8 & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_22857/*"setOnEventTrackingFailedListener"*/, method);
    byte_4C21BC8 = 1;
  }
  return BattleMasterImageEntity__getScript(this, (System_String_o *)StringLiteral_22857/*"setOnEventTrackingFailedListener"*/, 0, v2);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4C21BC9 & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_22866/*"setProcessName"*/, method);
    byte_4C21BC9 = 1;
  }
  return EntityScriptUtil__GetIntArray(this->fields.script, (System_String_o *)StringLiteral_22866/*"setProcessName"*/, 0LL, 0LL);
}
