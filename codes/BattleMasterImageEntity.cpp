        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BAADB & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_22116/*"overwriteMasterBackgroundId"*/, method);
    byte_49BAADB = 1;
  }
  return BattleMasterImageEntity__getScript(this, (System_String_o *)StringLiteral_22116/*"overwriteMasterBackgroundId"*/, 0, v2);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_49BAADC & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_22125/*"overwriteResultPosition"*/, method);
    byte_49BAADC = 1;
  }
  return EntityScriptUtil__GetIntArray(this->fields.script, (System_String_o *)StringLiteral_22125/*"overwriteResultPosition"*/, 0LL, 0LL);
}
