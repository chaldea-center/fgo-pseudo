        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D3430C & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_25546/*"{0}（＋{1}）"*/);
  ...
  if ( this->fields.resultBuddyPointInfo )
  {
    ...
    v4 = System_String__Format_64467032((System_String_o *)StringLiteral_25546/*"{0}（＋{1}）"*/, v11, v12, 0);
    if ( !buddyPointLabel
        ...
        const MethodInfo *method)
{
  ...
  if ( !resultBuddyPointInfo || !rankMaster )
    sub_1C93D2C(rankMaster, *(_QWORD *)&buddyPoint);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D3430D & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_5881/*"Effect/BattleResult/{0}"*/);
    sub_1C93AD4(&StringLiteral_17307/*"bit_buddy_rankup"*/);
    sub_1C93AD4(&StringLiteral_2707/*"BATTLE_BUDDY_POINT_RANK_{0}"*/);
    byte_4D3430D = 1;
  }
  ...
  v5 = System_String__Format((System_String_o *)StringLiteral_5881/*"Effect/BattleResult/{0}"*/, v4, 0);
  ...
  Object_object__51927708 = AssetData__GetObject_object__51927708(
                              ...
                              (System_String_o *)StringLiteral_17307/*"bit_buddy_rankup"*/,
  ...
  else
  {
    ...
    if ( ((unsigned __int8)buddyPointRankUpObject & 1) != 0 )
    {
      if ( !v10 )
        goto LABEL_29;
      SimpleAnimation__Play_67370764((SimpleAnimation_o *)v10, (System_String_o *)StringLiteral_17307/*"bit_buddy_rankup"*/, 0);
    }
  }
  beforeBuddyRank = this->fields.beforeBuddyRank;
  v11 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &beforeBuddyRank);
  v12 = System_String__Format((System_String_o *)StringLiteral_2707/*"BATTLE_BUDDY_POINT_RANK_{0}"*/, v11, 0);
  ...
  {
LABEL_29:
    sub_1C93D2C(buddyPointRankUpObject, method);
  }
...
LABEL_14:
    sub_1C93D2C(buddyPointRankUpObject, buddyPointInfo);
  EnableEntity = EventServantPointRankMaster__GetEnableEntity(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D34309 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_6762/*"FinishUpdateBuddyPoint"*/);
    sub_1C93AD4(&StringLiteral_22702/*"oncomplete"*/);
    sub_1C93AD4(&StringLiteral_15283/*"UpdateBuddyPointInfo"*/);
    sub_1C93AD4(&iTween_TypeInfo);
    byte_4D34309 = 1;
  }
  if ( this->fields.resultBuddyPointInfo )
      ...
      *(_QWORD *)(v12 + 48) = v28;
      ...
      if ( !v13 || (v13 = sub_1C93C10(v13, *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
      {
        ...
        *(_QWORD *)(v12 + 64) = v42;
        ...
        v13 = StringLiteral_15283/*"UpdateBuddyPointInfo"*/;
        if ( StringLiteral_15283/*"UpdateBuddyPointInfo"*/ )
        {
          v13 = sub_1C93C10(StringLiteral_15283/*"UpdateBuddyPointInfo"*/, *(_QWORD *)(*(_QWORD *)v12 + 64LL));
          if ( !v13 )
            goto LABEL_54;
          v49 = StringLiteral_15283/*"UpdateBuddyPointInfo"*/;
        }
        else
        {
          v49 = 0;
        ...
        *(_QWORD *)(v12 + 80) = v56;
        ...
        v13 = StringLiteral_6762/*"FinishUpdateBuddyPoint"*/;
        if ( StringLiteral_6762/*"FinishUpdateBuddyPoint"*/ )
        {
          v13 = sub_1C93C10(StringLiteral_6762/*"FinishUpdateBuddyPoint"*/, *(_QWORD *)(*(_QWORD *)v12 + 64LL));
          if ( !v13 )
            goto LABEL_54;
          v63 = StringLiteral_6762/*"FinishUpdateBuddyPoint"*/;
        }
        else
        {
          v63 = 0;
    ...
    if ( v8 )
    {
      ...
      if ( buddyPointLabel )
      {
        ...
        if ( gameObject )
        {
          ...
          v17 = System_String__Format((System_String_o *)StringLiteral_2707/*"BATTLE_BUDDY_POINT_RANK_{0}"*/, v16, 0);
          buddyPointRankLabel = this->fields.buddyPointRankLabel;
          v19 = v17;
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
