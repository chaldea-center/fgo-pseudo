        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_43520EE & 1) == 0 )
  {
    ...
    sub_B70694(&StringLiteral_24053/*"{0}（＋{1}）"*/);
  ...
  if ( this->fields.resultBuddyPointInfo )
  {
    ...
    v4 = System_String__Format_44753704((System_String_o *)StringLiteral_24053/*"{0}（＋{1}）"*/, v12, v14, 0LL);
    if ( !buddyPointLabel
        ...
        const MethodInfo *method)
{
  ...
  if ( !rankMaster )
  {
    ...
    Master_WarQuestSelectionMaster = (System_Int32_array **)DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1CA3540 *)Method_DataManager_GetMaster_EventServantPointRankMaster___);
  ...
  if ( !resultBuddyPointInfo || !rankMaster )
    sub_B7076C(rankMaster, *(_QWORD *)&buddyPoint);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_43520EF & 1) == 0 )
  {
    ...
    sub_B70694(&StringLiteral_5905/*"Effect/BattleResult/{0}"*/);
    sub_B70694(&StringLiteral_16987/*"bit_buddy_rankup"*/);
    sub_B70694(&StringLiteral_2420/*"BATTLE_BUDDY_POINT_RANK_{0}"*/);
    byte_43520EF = 1;
  }
  ...
  v6 = System_String__Format((System_String_o *)StringLiteral_5905/*"Effect/BattleResult/{0}"*/, v5, 0LL);
  ...
  Object_WarBoardWaitTimeSetting = (UnityEngine_UI_Dropdown_DropdownItem_o *)AssetData__GetObject_WarBoardWaitTimeSetting_(
                                                                               ...
                                                                               (System_String_o *)StringLiteral_16987/*"bit_buddy_rankup"*/,
  ...
  else
  {
    ...
    if ( ((unsigned __int8)buddyPointRankUpObject & 1) != 0 )
    {
      if ( !v11 )
        goto LABEL_29;
      SimpleAnimation__Play_16672920((SimpleAnimation_o *)v11, (System_String_o *)StringLiteral_16987/*"bit_buddy_rankup"*/, 0LL);
    }
  }
  beforeBuddyRank = this->fields.beforeBuddyRank;
  v13 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &beforeBuddyRank, v12);
  v14 = System_String__Format((System_String_o *)StringLiteral_2420/*"BATTLE_BUDDY_POINT_RANK_{0}"*/, v13, 0LL);
  ...
  {
LABEL_29:
    sub_B7076C(buddyPointRankUpObject, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (BYTE3(DataManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0 && !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_WarQuestSelectionMaster = (struct EventServantPointRankMaster_o *)DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1CA3540 *)Method_DataManager_GetMaster_EventServantPointRankMaster___);
...
LABEL_15:
    sub_B7076C(buddyPointRankUpObject, buddyPointInfo);
  EnableEntity = EventServantPointRankMaster__GetEnableEntity(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_43520EB & 1) == 0 )
  {
    ...
    sub_B70694(&StringLiteral_6773/*"FinishUpdateBuddyPoint"*/);
    sub_B70694(&StringLiteral_21605/*"oncomplete"*/);
    sub_B70694(&StringLiteral_15245/*"UpdateBuddyPointInfo"*/);
    sub_B70694(&iTween_TypeInfo);
    byte_43520EB = 1;
  }
  if ( this->fields.resultBuddyPointInfo )
  {
    ...
    if ( !v13 || (v13 = sub_B70754(v13, v12->obj.klass->_1.element_class)) != 0 )
    {
      ...
      if ( !v13 || (v13 = sub_B70754(v13, v12->obj.klass->_1.element_class)) != 0 )
      {
        ...
        v13 = StringLiteral_15245/*"UpdateBuddyPointInfo"*/;
        if ( StringLiteral_15245/*"UpdateBuddyPointInfo"*/ )
        {
          v13 = sub_B70754(StringLiteral_15245/*"UpdateBuddyPointInfo"*/, v12->obj.klass->_1.element_class);
          if ( !v13 )
            goto LABEL_55;
          v51 = (System_Int32_array **)StringLiteral_15245/*"UpdateBuddyPointInfo"*/;
        }
        else
        {
          v51 = 0LL;
        ...
        v13 = StringLiteral_6773/*"FinishUpdateBuddyPoint"*/;
        if ( StringLiteral_6773/*"FinishUpdateBuddyPoint"*/ )
        {
          v13 = sub_B70754(StringLiteral_6773/*"FinishUpdateBuddyPoint"*/, v12->obj.klass->_1.element_class);
          if ( !v13 )
            goto LABEL_55;
          v65 = (System_Int32_array **)StringLiteral_6773/*"FinishUpdateBuddyPoint"*/;
        }
        else
        {
          v65 = 0LL;
  ...
  if ( resultBuddyPointInfo )
  {
    ...
    if ( v8 )
    {
      ...
      gameObject = (UnityEngine_GameObject_o *)System_String__Format_44753704(
                                                 (System_String_o *)StringLiteral_24053/*"{0}（＋{1}）"*/,
                                                 v15,
                                                 v17,
                                                 0LL);
      if ( buddyPointLabel )
      {
        ...
        if ( gameObject )
        {
          ...
          v20 = System_String__Format((System_String_o *)StringLiteral_2420/*"BATTLE_BUDDY_POINT_RANK_{0}"*/, v19, 0LL);
          buddyPointRankLabel = this->fields.buddyPointRankLabel;
          v22 = v20;
          if ( (BYTE3(LocalizationManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
            && !LocalizationManager_TypeInfo->_2.cctor_finished )
