        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E08455 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_25634/*"{0}（＋{1}）"*/);
  ...
  if ( this->fields.resultBuddyPointInfo )
  {
    ...
    v4 = System_String__Format_65164136((System_String_o *)StringLiteral_25634/*"{0}（＋{1}）"*/, v11, v12, 0);
    if ( !buddyPointLabel
        ...
        const MethodInfo *method)
{
  ...
  if ( !resultBuddyPointInfo || !rankMaster )
    sub_1CE6958(rankMaster, *(_QWORD *)&buddyPoint);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E08456 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_5895/*"Effect/BattleResult/{0}"*/);
    sub_1CE6700(&StringLiteral_17362/*"bit_buddy_rankup"*/);
    sub_1CE6700(&StringLiteral_2712/*"BATTLE_BUDDY_POINT_RANK_{0}"*/);
    byte_4E08456 = 1;
  }
  ...
  v5 = System_String__Format((System_String_o *)StringLiteral_5895/*"Effect/BattleResult/{0}"*/, v4, 0);
  ...
  Object_object__52317288 = AssetData__GetObject_object__52317288(
                              ...
                              (System_String_o *)StringLiteral_17362/*"bit_buddy_rankup"*/,
  ...
  else
  {
    ...
    if ( ((unsigned __int8)buddyPointRankUpObject & 1) != 0 )
    {
      if ( !v10 )
        goto LABEL_29;
      SimpleAnimation__Play_68069172((SimpleAnimation_o *)v10, (System_String_o *)StringLiteral_17362/*"bit_buddy_rankup"*/, 0);
    }
  }
  beforeBuddyRank = this->fields.beforeBuddyRank;
  v11 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &beforeBuddyRank);
  v12 = System_String__Format((System_String_o *)StringLiteral_2712/*"BATTLE_BUDDY_POINT_RANK_{0}"*/, v11, 0);
  ...
  {
LABEL_29:
    sub_1CE6958(buddyPointRankUpObject, method);
  }
...
LABEL_14:
    sub_1CE6958(buddyPointRankUpObject, buddyPointInfo);
  EnableEntity = EventServantPointRankMaster__GetEnableEntity(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E08452 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_6778/*"FinishUpdateBuddyPoint"*/);
    sub_1CE6700(&StringLiteral_22775/*"oncomplete"*/);
    sub_1CE6700(&StringLiteral_15332/*"UpdateBuddyPointInfo"*/);
    sub_1CE6700(&iTween_TypeInfo);
    byte_4E08452 = 1;
  }
  if ( this->fields.resultBuddyPointInfo )
      ...
      *(_QWORD *)(v12 + 48) = v28;
      ...
      if ( !v13 || (v13 = sub_1CE683C(v13, *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
      {
        ...
        *(_QWORD *)(v12 + 64) = v42;
        ...
        v13 = StringLiteral_15332/*"UpdateBuddyPointInfo"*/;
        if ( StringLiteral_15332/*"UpdateBuddyPointInfo"*/ )
        {
          v13 = sub_1CE683C(StringLiteral_15332/*"UpdateBuddyPointInfo"*/, *(_QWORD *)(*(_QWORD *)v12 + 64LL));
          if ( !v13 )
            goto LABEL_54;
          v49 = StringLiteral_15332/*"UpdateBuddyPointInfo"*/;
        }
        else
        {
          v49 = 0;
        ...
        *(_QWORD *)(v12 + 80) = v56;
        ...
        v13 = StringLiteral_6778/*"FinishUpdateBuddyPoint"*/;
        if ( StringLiteral_6778/*"FinishUpdateBuddyPoint"*/ )
        {
          v13 = sub_1CE683C(StringLiteral_6778/*"FinishUpdateBuddyPoint"*/, *(_QWORD *)(*(_QWORD *)v12 + 64LL));
          if ( !v13 )
            goto LABEL_54;
          v63 = StringLiteral_6778/*"FinishUpdateBuddyPoint"*/;
        }
        else
        {
          v63 = 0;
  ...
  if ( resultBuddyPointInfo )
  {
    ...
    if ( v8 )
    {
      ...
      gameObject = (UnityEngine_GameObject_o *)System_String__Format_65164136(
                                                 (System_String_o *)StringLiteral_25634/*"{0}（＋{1}）"*/,
                                                 v14,
                                                 v15,
                                                 0);
      if ( buddyPointLabel )
      {
        ...
        if ( gameObject )
        {
          ...
          v17 = System_String__Format((System_String_o *)StringLiteral_2712/*"BATTLE_BUDDY_POINT_RANK_{0}"*/, v16, 0);
          buddyPointRankLabel = this->fields.buddyPointRankLabel;
          v19 = v17;
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
