...
System_String_o *__fastcall EventDailyPointRequest__getURL(EventDailyPointRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42EB169 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&StringLiteral_18684/*"event/dailyPoint"*/, v4, v5, v6);
    byte_42EB169 = 1;
  }
  ...
  return System_String__Concat_44577788(BaseUrl, (System_String_o *)StringLiteral_18684/*"event/dailyPoint"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v12 = ResponseCommandKind__SearchData(83, responseList, 0LL);
  if ( v12
