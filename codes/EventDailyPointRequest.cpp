        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17A95 & 1) == 0 )
  {
    sub_1BCA7E0(&StringLiteral_19329/*"eventId"*/, *(_QWORD *)&eventId, method);
    byte_4B17A95 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19329/*"eventId"*/, eventId, v3);
...
System_String_o *__fastcall EventDailyPointRequest__getURL(EventDailyPointRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B17A94 & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&StringLiteral_19310/*"event/dailyPoint"*/, v3, v4);
    byte_4B17A94 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62401220(BaseUrl, (System_String_o *)StringLiteral_19310/*"event/dailyPoint"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v9 = ResponseCommandKind__SearchData(83, responseList, 0LL);
  if ( v9
