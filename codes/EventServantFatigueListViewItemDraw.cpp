        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B3487 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_11837/*"SERVANT_RECOVER_CAN_NOT_SELECT"*/);
    sub_B52984(&StringLiteral_11839/*"SERVANT_SELECT_NO_SORTIE_FATIGURE"*/);
    sub_B52984(&StringLiteral_11840/*"SERVANT_SELECT_NO_SORTIE_FATIGURE_RECOVER"*/);
    sub_B52984(&StringLiteral_11707/*"SELECT_CANNOT"*/);
    sub_B52984(&StringLiteral_11725/*"SELECT_NO_SORTIE_TITLE"*/);
    sub_B52984(&StringLiteral_11745/*"SERVANT_ALREADY_RECOVER_NOT_SELECT"*/);
...
LABEL_75:
    ...
    if ( item->fields.isFatigueRecover )
    {
      ...
      if ( item->fields.isCanNotSelect )
      {
        ...
        v9 = &StringLiteral_11837/*"SERVANT_RECOVER_CAN_NOT_SELECT"*/;
        goto LABEL_24;
      }
...
LABEL_60:
        ...
        else
        {
          ...
          statusLabel = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11837/*"SERVANT_RECOVER_CAN_NOT_SELECT"*/, 0LL);
          if ( !v31 )
            goto LABEL_75;
        ...
        statusLabel = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11745/*"SERVANT_ALREADY_RECOVER_NOT_SELECT"*/, 0LL);
        if ( !statusLabelTime )
          goto LABEL_75;
        goto LABEL_74;
      }
      ...
      statusLabel = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11725/*"SELECT_NO_SORTIE_TITLE"*/, 0LL);
      if ( !v26 )
        goto LABEL_75;
      UILabel__set_text(v26, (System_String_o *)statusLabel, 0LL);
      statusLabelTime = this->fields.statusLabelTime;
      v21 = &StringLiteral_11840/*"SERVANT_SELECT_NO_SORTIE_FATIGURE_RECOVER"*/;
LABEL_55:
...
LABEL_74:
    ...
    if ( (v14 & 0x8000000000000000LL) == 0 )
    {
      ...
      if ( v14 - NetworkManager__getTime(0LL) >= 1 )
      {
        ...
        statusLabelTime = this->fields.statusLabelTime;
        v21 = &StringLiteral_11839/*"SERVANT_SELECT_NO_SORTIE_FATIGURE"*/;
        goto LABEL_55;
      }
    }
    statusLabel = (UnityEngine_Component_o *)this->fields.fatigueMaskObject;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B3486 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_11834/*"SERVANT_RECOVERY_FATIGUE_LIST_INDIVIDUALITY"*/);
    byte_42B3486 = 1;
  }
  if ( item && mode )
  {
            ...
            if ( lockImg )
            {
              ...
              if ( lockImg )
              {
                ...
                lockImg = (UnityEngine_Component_o *)LocalizationManager__Get(
                                                       (System_String_o *)StringLiteral_11834/*"SERVANT_RECOVERY_FATIGUE_LIST_INDIVIDUALITY"*/,
                                                       0LL);
                        ...
                        if ( lockImg )
                        {
                          ...
                          if ( userServantEntity )
                          {
                            ...
                            *(_QWORD *)&v22.fields.fakeValue = v14;
                            lockImg = (UnityEngine_Component_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_44786420(
                                                                   v22,
                                                                   0LL);
