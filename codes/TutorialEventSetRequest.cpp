        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1E0D1 & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_18977/*"eventId"*/, *(_QWORD *)&flagId);
    sub_1BCAFF8(&StringLiteral_19305/*"flagId"*/, v7);
    byte_4B1E0D1 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19305/*"flagId"*/, flagId, method);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18977/*"eventId"*/, eventId, v8);
...
System_String_o *__fastcall TutorialEventSetRequest__getURL(TutorialEventSetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1E0CF & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_24017/*"tutorial/eventFlagSet"*/, v2);
    byte_4B1E0CF = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62450424(BaseUrl, (System_String_o *)StringLiteral_24017/*"tutorial/eventFlagSet"*/, 0LL);
}
