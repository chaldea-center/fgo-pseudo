        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EAD3C & 1) == 0 )
  {
    sub_B5D5C4(&StringLiteral_18701/*"eventId"*/, flagId, eventId, method);
...
System_String_o *__fastcall TutorialEventSetRequest__getURL(TutorialEventSetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42EAD3A & 1) == 0 )
  {
    ...
    sub_B5D5C4(&StringLiteral_23129/*"tutorial/eventFlagSet"*/, v4, v5, v6);
    byte_42EAD3A = 1;
  }
  ...
  return System_String__Concat_44577788(BaseUrl, (System_String_o *)StringLiteral_23129/*"tutorial/eventFlagSet"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v16 = ResponseCommandKind__SearchData(57, responseList, 0LL);
