        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A71814 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_19159/*"eventId"*/, *(_QWORD *)&flagId);
    sub_1B90010(&StringLiteral_19483/*"flagId"*/, v7);
    byte_4A71814 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19483/*"flagId"*/, flagId, 0LL);
...
System_String_o *__fastcall TutorialEventSetRequest__getURL(TutorialEventSetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A71812 & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_24136/*"tutorial/eventFlagSet"*/, v2);
    byte_4A71812 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61787092(BaseUrl, (System_String_o *)StringLiteral_24136/*"tutorial/eventFlagSet"*/, 0LL);
}
