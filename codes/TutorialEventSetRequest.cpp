        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B03BC6 & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_18963/*"eventId"*/, *(_QWORD *)&flagId);
    sub_1BC3008(&StringLiteral_19291/*"flagId"*/, v7);
    byte_4B03BC6 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19291/*"flagId"*/, flagId, method);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18963/*"eventId"*/, eventId, v8);
...
System_String_o *__fastcall TutorialEventSetRequest__getURL(TutorialEventSetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B03BC4 & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_23995/*"tutorial/eventFlagSet"*/, v2);
    byte_4B03BC4 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62348648(BaseUrl, (System_String_o *)StringLiteral_23995/*"tutorial/eventFlagSet"*/, 0LL);
}
