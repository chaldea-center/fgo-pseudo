        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F8C9 & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_19126/*"eventId"*/, *(_QWORD *)&flagId);
    sub_1B761C0(&StringLiteral_19450/*"flagId"*/, v7);
    byte_4A2F8C9 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19450/*"flagId"*/, flagId, 0LL);
...
System_String_o *__fastcall TutorialEventSetRequest__getURL(TutorialEventSetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2F8C7 & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_24084/*"tutorial/eventFlagSet"*/, v2);
    byte_4A2F8C7 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61535060(BaseUrl, (System_String_o *)StringLiteral_24084/*"tutorial/eventFlagSet"*/, 0LL);
}
