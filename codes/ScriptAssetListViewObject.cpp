...
void __fastcall ScriptAssetListViewObject__Awake(ScriptAssetListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB34C1 & 1) == 0 )
  {
    sub_1BAB41C(&Method_UnityEngine_GameObject_GetComponent_ScriptAssetListViewItemDraw___, method);
    byte_4AB34C1 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2F13970 *)Method_UnityEngine_GameObject_GetComponent_ScriptAssetListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB34C4 & 1) == 0 )
  {
    sub_1BAB41C(&Method_UnityEngine_GameObject_GetComponent_ScriptAssetListViewObject___, method);
    byte_4AB34C4 = 1;
  }
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_2F13970 *)Method_UnityEngine_GameObject_GetComponent_ScriptAssetListViewObject___)) == 0LL) )
  {
    sub_1BAB678(DragObject, v4);
  }
  ScriptAssetListViewObject__Init_35196044((ScriptAssetListViewObject_o *)DragObject, 2, v6);
  return v5;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB34C3 & 1) == 0 )
  {
    sub_1BAB41C(&ScriptAssetListViewItem_TypeInfo, method);
    byte_4AB34C3 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB34C5 & 1) == 0 )
  {
    sub_1BAB41C(&ScriptAssetListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4AB34C5 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ScriptAssetListViewObject__Init_35196044(
        ScriptAssetListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ScriptAssetListViewObject__Init_35197272(
        ScriptAssetListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ScriptAssetListViewObject__Init_35197356(
        ScriptAssetListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall ScriptAssetListViewObject__SetupDisp(ScriptAssetListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB34C6 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&ScriptAssetListViewItem_TypeInfo, v3);
    byte_4AB34C6 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
...
void __fastcall ScriptAssetListViewObject__Start(ScriptAssetListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    ScriptAssetListViewObject__Init_35196044(this, 2, v2);
}
