...
void __fastcall ScriptAssetListViewObject__Awake(ScriptAssetListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42ED12A & 1) == 0 )
  {
    sub_B5D5C4(&Method_UnityEngine_GameObject_GetComponent_ScriptAssetListViewItemDraw___, (_DWORD)method, v2, v3);
    byte_42ED12A = 1;
  }
  ...
  Component_srcLineSprite = UnityEngine_GameObject__GetComponent_srcLineSprite_(
                              dispObject,
                              (const MethodInfo_1CC439C *)Method_UnityEngine_GameObject_GetComponent_ScriptAssetListViewItemDraw___);
  this->fields.itemDraw = (struct ScriptAssetListViewItemDraw_o *)Component_srcLineSprite;
  sub_B5D560(
        ...
        const MethodInfo *method)
{
  ...
  ScriptAssetListViewObject_o *v8; // x20
  const MethodInfo *v9; // x3
  UnityEngine_Vector3_o zero; // 0:s0.4,4:s1.4,8:s2.4 OVERLAPPED

  if ( (byte_42ED12D & 1) == 0 )
  {
    sub_B5D5C4(&Method_UnityEngine_GameObject_GetComponent_ScriptAssetListViewObject___, (_DWORD)method, v2, v3);
    byte_42ED12D = 1;
  }
  ...
  if ( !DragObject
    || (v7 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                    DragObject,
                                                    (const MethodInfo_1CC439C *)Method_UnityEngine_GameObject_GetComponent_ScriptAssetListViewObject___)) == 0LL) )
  {
    sub_B5D69C(DragObject, v6);
  }
  v8 = (ScriptAssetListViewObject_o *)DragObject;
  zero = UnityEngine_Vector3__get_zero(0LL);
  ScriptAssetListViewObject__Init(v8, 2, 0LL, zero.fields.x, *(UnityEngine_Vector3_o *)&zero.fields.y, v9);
  return v7;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42ED12C & 1) == 0 )
  {
    sub_B5D5C4(&ScriptAssetListViewItem_TypeInfo, (_DWORD)method, v2, v3);
    byte_42ED12C = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
    return 0LL;
  v6 = *(&ScriptAssetListViewItem_TypeInfo->_2.bitflags2 + 1);
  if ( *(&linkItem->klass->_2.bitflags2 + 1) < (unsigned int)v6 )
    return 0LL;
  if ( (ScriptAssetListViewItem_c *)linkItem->klass->_2.typeHierarchy[v6 - 1] == ScriptAssetListViewItem_TypeInfo )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42ED12E & 1) == 0 )
  {
    sub_B5D5C4(&ScriptAssetListViewItem_TypeInfo, initMode, (_DWORD)callbackFunc, method);
    byte_42ED12E = 1;
  }
  linkItem = this->fields.linkItem;
  ...
  if ( linkItem
    && (v12 = *(&ScriptAssetListViewItem_TypeInfo->_2.bitflags2 + 1),
        *(&linkItem->klass->_2.bitflags2 + 1) >= (unsigned int)v12) )
  {
    if ( (ScriptAssetListViewItem_c *)linkItem->klass->_2.typeHierarchy[v12 - 1] == ScriptAssetListViewItem_TypeInfo )
      v13 = initMode;
    else
      v13 = 0;
  }
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ScriptAssetListViewObject__Init_34139024(
        ScriptAssetListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
  ...
  zero = UnityEngine_Vector3__get_zero(0LL);
  ScriptAssetListViewObject__Init(this, initMode, 0LL, zero.fields.x, *(UnityEngine_Vector3_o *)&zero.fields.y, v5);
}


// local variable allocation has failed, the output may be wrong!
void __fastcall ScriptAssetListViewObject__Init_34140176(
        ScriptAssetListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ScriptAssetListViewObject__Init_34140240(
        ScriptAssetListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall ScriptAssetListViewObject__SetupDisp(ScriptAssetListViewObject_o *this, const MethodInfo *method)
{
  ...
  ScriptAssetListViewItemDraw_o *v14; // x0

  if ( (byte_42ED12F & 1) == 0 )
  {
    sub_B5D5C4(&UnityEngine_Object_TypeInfo, (_DWORD)method, v2, v3);
    sub_B5D5C4(&ScriptAssetListViewItem_TypeInfo, v5, v6, v7);
    byte_42ED12F = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem )
  {
    ...
    if ( *(&linkItem->klass->_2.bitflags2 + 1) >= (unsigned int)v9
      && (ScriptAssetListViewItem_c *)linkItem->klass->_2.typeHierarchy[v9 - 1] == ScriptAssetListViewItem_TypeInfo )
    {
...
LABEL_8:
  ...
  if ( UnityEngine_Object__op_Inequality(itemDraw, 0LL, 0LL) )
  {
    ...
    if ( !v14 )
      sub_B5D69C(0LL, v12);
    ScriptAssetListViewItemDraw__SetItem(v14, (ScriptAssetListViewItem_o *)linkItem, this->fields.dispMode, v13);
  }
}
...
void __fastcall ScriptAssetListViewObject__Start(ScriptAssetListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    zero = UnityEngine_Vector3__get_zero(0LL);
    ScriptAssetListViewObject__Init(this, 2, 0LL, zero.fields.x, *(UnityEngine_Vector3_o *)&zero.fields.y, v3);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  __int64 v10; // x0
  bool v11; // zf
  ScriptAssetListViewObject_o *v12; // x0
  ...
  sub_B5D990(v9);
  ScriptAssetListViewObject__remove_callbackFunc(v12, v13, v14);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_B5D990(v9);
  ScriptAssetListViewObject__Awake(v12, v13);
}