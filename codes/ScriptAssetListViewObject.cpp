...
void __fastcall ScriptAssetListViewObject__Awake(ScriptAssetListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFF62E & 1) == 0 )
  {
    sub_1BC3008(&Method_UnityEngine_GameObject_GetComponent_ScriptAssetListViewItemDraw___, method);
    byte_4AFF62E = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_3055998 *)Method_UnityEngine_GameObject_GetComponent_ScriptAssetListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFF631 & 1) == 0 )
  {
    sub_1BC3008(&Method_UnityEngine_GameObject_GetComponent_ScriptAssetListViewObject___, method);
    byte_4AFF631 = 1;
  }
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_3055998 *)Method_UnityEngine_GameObject_GetComponent_ScriptAssetListViewObject___)) == 0LL) )
  {
    sub_1BC3264(DragObject, v4);
  }
  ScriptAssetListViewObject__Init_36485008((ScriptAssetListViewObject_o *)DragObject, 2, v6);
  return v5;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFF630 & 1) == 0 )
  {
    sub_1BC3008(&ScriptAssetListViewItem_TypeInfo, method);
    byte_4AFF630 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFF632 & 1) == 0 )
  {
    sub_1BC3008(&ScriptAssetListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4AFF632 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ScriptAssetListViewObject__Init_36485008(
        ScriptAssetListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ScriptAssetListViewObject__Init_36486164(
        ScriptAssetListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ScriptAssetListViewObject__Init_36486248(
        ScriptAssetListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall ScriptAssetListViewObject__SetupDisp(ScriptAssetListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFF633 & 1) == 0 )
  {
    ...
    sub_1BC3008(&ScriptAssetListViewItem_TypeInfo, v3);
    byte_4AFF633 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
...
void __fastcall ScriptAssetListViewObject__Start(ScriptAssetListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    ScriptAssetListViewObject__Init_36485008(this, 2, v2);
}
