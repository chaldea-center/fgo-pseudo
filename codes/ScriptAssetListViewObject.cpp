...
void __fastcall ScriptAssetListViewObject__Awake(ScriptAssetListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1393D & 1) == 0 )
  {
    sub_1BCA7E0(&Method_UnityEngine_GameObject_GetComponent_ScriptAssetListViewItemDraw___, method, v2);
    byte_4B1393D = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2F626D0 *)Method_UnityEngine_GameObject_GetComponent_ScriptAssetListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B13940 & 1) == 0 )
  {
    sub_1BCA7E0(&Method_UnityEngine_GameObject_GetComponent_ScriptAssetListViewObject___, method, v2);
    byte_4B13940 = 1;
  }
  ...
  if ( !DragObject
    || (v6 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_2F626D0 *)Method_UnityEngine_GameObject_GetComponent_ScriptAssetListViewObject___)) == 0LL) )
  {
    sub_1BCAA3C(DragObject, v5);
  }
  ScriptAssetListViewObject__Init_35513880((ScriptAssetListViewObject_o *)DragObject, 2, v7);
  return v6;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1393F & 1) == 0 )
  {
    sub_1BCA7E0(&ScriptAssetListViewItem_TypeInfo, method, v2);
    byte_4B1393F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B13941 & 1) == 0 )
  {
    sub_1BCA7E0(&ScriptAssetListViewItem_TypeInfo, *(_QWORD *)&initMode, callbackFunc);
    byte_4B13941 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ScriptAssetListViewObject__Init_35513880(
        ScriptAssetListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ScriptAssetListViewObject__Init_35515108(
        ScriptAssetListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ScriptAssetListViewObject__Init_35515192(
        ScriptAssetListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall ScriptAssetListViewObject__SetupDisp(ScriptAssetListViewObject_o *this, const MethodInfo *method)
{
  ...
  ScriptAssetListViewItemDraw_o *v13; // x0

  if ( (byte_4B13942 & 1) == 0 )
  {
    sub_1BCA7E0(&UnityEngine_Object_TypeInfo, method, v2);
    sub_1BCA7E0(&ScriptAssetListViewItem_TypeInfo, v4, v5);
    byte_4B13942 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
...
LABEL_8:
  ...
  if ( UnityEngine_Object__op_Inequality(itemDraw, 0LL, 0LL) )
  {
    ...
    if ( !v13 )
      sub_1BCAA3C(0LL, v11);
    ScriptAssetListViewItemDraw__SetItem(v13, (ScriptAssetListViewItem_o *)linkItem, this->fields.dispMode, v12);
  }
}
...
void __fastcall ScriptAssetListViewObject__Start(ScriptAssetListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    ScriptAssetListViewObject__Init_35513880(this, 2, v2);
}
