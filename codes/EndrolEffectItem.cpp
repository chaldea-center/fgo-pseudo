...
void __fastcall EndrolEffectItem__LateUpdate(EndrolEffectItem_o *this, const MethodInfo *method)
{
  ...
  if ( !UnityEngine_ParticleSystem__IsAlive_70568932(particle, 0LL) )
  {
...
void __fastcall EndrolEffectItem__Start(EndrolEffectItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B48BCF & 1) == 0 )
  {
    sub_1BDB878(&Method_UnityEngine_GameObject_GetComponentInChildren_ParticleSystem___, method);
    byte_4B48BCF = 1;
  }
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.particle, (int32_t)ComponentInChildren_object, v6, v7);
}