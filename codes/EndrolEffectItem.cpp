...
void __fastcall EndrolEffectItem__LateUpdate(EndrolEffectItem_o *this, const MethodInfo *method)
{
  ...
  if ( !UnityEngine_ParticleSystem__IsAlive_70420104(particle, 0LL) )
  {
...
void __fastcall EndrolEffectItem__Start(EndrolEffectItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B206F8 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_UnityEngine_GameObject_GetComponentInChildren_ParticleSystem___, method);
    byte_4B206F8 = 1;
  }
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.particle, (int32_t)ComponentInChildren_object, v6, v7);
}