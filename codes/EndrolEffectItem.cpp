...
void __fastcall EndrolEffectItem__LateUpdate(EndrolEffectItem_o *this, const MethodInfo *method)
{
  ...
  if ( !UnityEngine_ParticleSystem__IsAlive_69452572(particle, 0LL) )
  {
...
void __fastcall EndrolEffectItem__Start(EndrolEffectItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0C872 & 1) == 0 )
  {
    sub_1B686D4(&Method_UnityEngine_GameObject_GetComponentInChildren_ParticleSystem___, method);
    byte_4A0C872 = 1;
  }
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.particle, (int32_t)ComponentInChildren_object, v6, v7);
}