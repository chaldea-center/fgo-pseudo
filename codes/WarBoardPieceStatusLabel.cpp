        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1D627 & 1) == 0 )
  {
    sub_1B715CC(&LocalizationManager_TypeInfo, pieceData);
    sub_1B715CC(&StringLiteral_15384/*"WARBOARD_SERVANT_STATUS_PERMANENT_SLEEP"*/, v5);
    ...
    && BattleServantData__HasAvailablePermanentSleepBuff(battleServant_k__BackingField, 0LL) )
  {
    ...
    label = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_15384/*"WARBOARD_SERVANT_STATUS_PERMANENT_SLEEP"*/, 0LL);
    if ( v9 )
    {
