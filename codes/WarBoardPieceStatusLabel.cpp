        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC69B & 1) == 0 )
  {
    sub_1B64A00(&LocalizationManager_TypeInfo, pieceData);
    sub_1B64A00(&StringLiteral_15369/*"WARBOARD_SERVANT_STATUS_PERMANENT_SLEEP"*/, v5);
    ...
    && BattleServantData__HasAvailablePermanentSleepBuff(battleServant_k__BackingField, 0LL) )
  {
    ...
    label = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_15369/*"WARBOARD_SERVANT_STATUS_PERMANENT_SLEEP"*/, 0LL);
    if ( v9 )
    {
