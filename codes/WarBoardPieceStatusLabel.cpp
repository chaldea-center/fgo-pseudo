        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A067C3 & 1) == 0 )
  {
    sub_1B686D4(&LocalizationManager_TypeInfo, pieceData);
    sub_1B686D4(&StringLiteral_15368/*"WARBOARD_SERVANT_STATUS_PERMANENT_SLEEP"*/, v5);
