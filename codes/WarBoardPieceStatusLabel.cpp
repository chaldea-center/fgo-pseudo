        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFB0E3 & 1) == 0 )
  {
    sub_1C2E12C(&LocalizationManager_TypeInfo, pieceData);
    sub_1C2E12C(&StringLiteral_15712/*"WARBOARD_SERVANT_STATUS_PERMANENT_SLEEP"*/, v5);
    ...
    && BattleServantData__HasAvailablePermanentSleepBuff(battleServant_k__BackingField, 0LL) )
  {
    ...
    label = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_15712/*"WARBOARD_SERVANT_STATUS_PERMANENT_SLEEP"*/, 0LL);
    if ( v9 )
    {
