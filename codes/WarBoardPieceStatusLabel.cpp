        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B88C3 & 1) == 0 )
  {
    sub_1B4CF90(&LocalizationManager_TypeInfo, pieceData);
    sub_1B4CF90(&StringLiteral_15133/*"WARBOARD_SERVANT_STATUS_PERMANENT_SLEEP"*/, v5);
    ...
    && BattleServantData__HasAvailablePermanentSleepBuff(battleServant_k__BackingField, 0LL) )
  {
    ...
    label = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_15133/*"WARBOARD_SERVANT_STATUS_PERMANENT_SLEEP"*/, 0LL);
    if ( v9 )
    {
