        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC5465 & 1) == 0 )
  {
    sub_1C1ABD4(&LocalizationManager_TypeInfo, pieceData);
    sub_1C1ABD4(&StringLiteral_15689/*"WARBOARD_SERVANT_STATUS_PERMANENT_SLEEP"*/, v5);
    ...
    && BattleServantData__HasAvailablePermanentSleepBuff(battleServant_k__BackingField, 0LL) )
  {
    ...
    label = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_15689/*"WARBOARD_SERVANT_STATUS_PERMANENT_SLEEP"*/, 0LL);
    if ( v9 )
    {
