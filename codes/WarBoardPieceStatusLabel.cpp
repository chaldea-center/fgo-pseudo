        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB20A7 & 1) == 0 )
  {
    sub_1C13D24(&LocalizationManager_TypeInfo, pieceData);
    sub_1C13D24(&StringLiteral_15677/*"WARBOARD_PARTY_ORGANIZATION_COST_OVER_COLOR"*/, v5);
    ...
    && BattleServantData__HasAvailablePermanentSleepBuff(battleServant_k__BackingField, 0LL) )
  {
    ...
    label = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_15677/*"WARBOARD_PARTY_ORGANIZATION_COST_OVER_COLOR"*/, 0LL);
    if ( v9 )
    {
