        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2BA90 & 1) == 0 )
  {
    sub_1B761C0(&LocalizationManager_TypeInfo, pieceData);
    sub_1B761C0(&StringLiteral_15428/*"WARBOARD_SERVANT_STATUS_PERMANENT_SLEEP"*/, v5);
    ...
    && BattleServantData__HasAvailablePermanentSleepBuff(battleServant_k__BackingField, 0LL) )
  {
    ...
    label = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_15428/*"WARBOARD_SERVANT_STATUS_PERMANENT_SLEEP"*/, 0LL);
    if ( v9 )
    {
