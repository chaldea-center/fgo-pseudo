        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1F9B7 & 1) == 0 )
  {
    sub_1C3B764(&LocalizationManager_TypeInfo, pieceData);
    sub_1C3B764(&StringLiteral_15740/*"] index: "*/, v5);
    ...
    && BattleServantData__HasAvailablePermanentSleepBuff(battleServant_k__BackingField, 0LL) )
  {
    ...
    label = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_15740/*"] index: "*/, 0LL);
    if ( v9 )
    {
