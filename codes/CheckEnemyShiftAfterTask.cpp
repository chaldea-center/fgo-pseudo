        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69940 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_System_Collections_Generic_List_BattleLogicTask__AddRange__, logic);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_BattleLogicTask__ToArray__, v4);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_BattleLogicTask___ctor__, v5);
    sub_1BE4ACC(&System_Collections_Generic_List_BattleLogicTask__TypeInfo, v6);
    byte_4B69940 = 1;
  }
  v7 = (System_Collections_Generic_List_object__o *)sub_1BE4D18(System_Collections_Generic_List_BattleLogicTask__TypeInfo);
