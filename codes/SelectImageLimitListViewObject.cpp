...
void SelectImageLimitListViewObject__Awake(SelectImageLimitListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC273A & 1) == 0 )
  {
    sub_1C713B0(&Method_UnityEngine_GameObject_GetComponent_SelectImageLimitListViewItemDraw___);
    byte_4CC273A = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_31A2ED0 *)Method_UnityEngine_GameObject_GetComponent_SelectImageLimitListViewItemDraw___);
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_31A2ED0 *)Method_UnityEngine_GameObject_GetComponent_SelectImageLimitListViewObject___)) == 0) )
  {
    sub_1C71608(DragObject, v4);
  }
  SelectImageLimitListViewObject__Init_33727268((SelectImageLimitListViewObject_o *)DragObject, 2, v6);
  return v5;
}
...
void SelectImageLimitListViewObject__Init_33727268(
        SelectImageLimitListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void SelectImageLimitListViewObject__Init_33728576(
        SelectImageLimitListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void SelectImageLimitListViewObject__Init_33728660(
        SelectImageLimitListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void SelectImageLimitListViewObject__SetItem_33729916(
        SelectImageLimitListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
        ...
        const MethodInfo *method)
{
  ...
  v11 = (SelectImageLimitListViewObject_o *)sub_1C719A4(v8);
