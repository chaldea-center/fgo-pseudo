void RecommendedSvtEquipConfigSaveData___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4D308F5 & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_11056/*"RECOMMENDED_SVT_EQUIP_CONFIG"*/);
    byte_4D308F5 = 1;
  }
  RecommendedSvtEquipConfigSaveData_TypeInfo->static_fields->SAVE_KEY = (struct System_String_o *)StringLiteral_11056/*"RECOMMENDED_SVT_EQUIP_CONFIG"*/;
  sub_1C9403C(
    (GrandQuestFolderBoardItem_o *)RecommendedSvtEquipConfigSaveData_TypeInfo->static_fields,
    StringLiteral_11056/*"RECOMMENDED_SVT_EQUIP_CONFIG"*/,
    v1,
    v2,
    v3,
    v4,
...
RecommendedSvtEquipConfigSaveData_o *RecommendedSvtEquipConfigSaveData__LoadConfigSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4D308F2 & 1) == 0 )
  {
    sub_1C94098(&Method_UnityEngine_JsonUtility_FromJson_RecommendedSvtEquipConfigSaveData___);
    sub_1C94098(&RecommendedSvtEquipConfigSaveData_TypeInfo);
    byte_4D308F2 = 1;
  }
  ...
  return (RecommendedSvtEquipConfigSaveData_o *)UnityEngine_JsonUtility__FromJson_object_(
                                                  String_72069276,
                                                  (const MethodInfo_320D528 *)Method_UnityEngine_JsonUtility_FromJson_RecommendedSvtEquipConfigSaveData___);
}
