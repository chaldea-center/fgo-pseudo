void RecommendedSvtEquipConfigSaveData___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C46EF7 & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_11015/*"RECOMMENDED_SVT_EQUIP_CONFIG"*/);
    byte_4C46EF7 = 1;
  }
  RecommendedSvtEquipConfigSaveData_TypeInfo->static_fields->SAVE_KEY = (struct System_String_o *)StringLiteral_11015/*"RECOMMENDED_SVT_EQUIP_CONFIG"*/;
  sub_1C36FFC(
    (CGThumbnailListItem_o *)RecommendedSvtEquipConfigSaveData_TypeInfo->static_fields,
    StringLiteral_11015/*"RECOMMENDED_SVT_EQUIP_CONFIG"*/,
    v1,
    v2);
}
...
void RecommendedSvtEquipConfigSaveData___ctor(RecommendedSvtEquipConfigSaveData_o *this, const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.selectRarityList, (int32_t)v6, v7, v8);
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.selectCombineStatusList, (int32_t)v9, v10, v11);
...
RecommendedSvtEquipConfigSaveData_o *RecommendedSvtEquipConfigSaveData__LoadConfigSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4C46EF4 & 1) == 0 )
  {
    sub_1C37058(&Method_UnityEngine_JsonUtility_FromJson_RecommendedSvtEquipConfigSaveData___);
    sub_1C37058(&RecommendedSvtEquipConfigSaveData_TypeInfo);
    byte_4C46EF4 = 1;
  }
  ...
  String_71225564 = UnityEngine_PlayerPrefs__GetString_71225564(v1->static_fields->SAVE_KEY, 0);
  return (RecommendedSvtEquipConfigSaveData_o *)UnityEngine_JsonUtility__FromJson_object_(
                                                  String_71225564,
                                                  (const MethodInfo_3157F70 *)Method_UnityEngine_JsonUtility_FromJson_RecommendedSvtEquipConfigSaveData___);
}
