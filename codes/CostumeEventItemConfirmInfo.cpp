        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9822 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMasterData_EventMaster___, ent);
    ...
    sub_1BAB41C(&StringLiteral_5570/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG"*/, v11);
    sub_1BAB41C(&StringLiteral_5573/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_TITLE"*/, v12);
    sub_1BAB41C(&StringLiteral_3825/*"CONFIRM_TITLE_COSTUME_COMBINE"*/, v13);
    sub_1BAB41C(&StringLiteral_24976/*"{0:#,0}"*/, v14);
    sub_1BAB41C(&StringLiteral_5571/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_HAVE"*/, v15);
    sub_1BAB41C(&StringLiteral_5572/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_REQ"*/, v16);
    sub_1BAB41C(&StringLiteral_5569/*"EVENT_COMBINE_COSTUME_ITEM"*/, v17);
    byte_4AB9822 = 1;
  }
  entity = 0LL;
  v49 = 0;
  ...
  Instance = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_3825/*"CONFIRM_TITLE_COSTUME_COMBINE"*/, 0LL);
  if ( !title )
    goto LABEL_31;
  UILabel__set_text(title, (System_String_o *)Instance, 0LL);
  subTitle = this->fields.subTitle;
  v22 = LocalizationManager__Get((System_String_o *)StringLiteral_5573/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_TITLE"*/, 0LL);
  v23 = (Il2CppObject *)LocalizationManager__Get((System_String_o *)StringLiteral_5569/*"EVENT_COMBINE_COSTUME_ITEM"*/, 0LL);
  ...
  v25 = LocalizationManager__Get((System_String_o *)StringLiteral_5572/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_REQ"*/, 0LL);
  v26 = (Il2CppObject *)LocalizationManager__Get((System_String_o *)StringLiteral_5569/*"EVENT_COMBINE_COSTUME_ITEM"*/, 0LL);
  ...
  v28 = LocalizationManager__Get((System_String_o *)StringLiteral_5571/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_HAVE"*/, 0LL);
  v29 = (Il2CppObject *)LocalizationManager__Get((System_String_o *)StringLiteral_5569/*"EVENT_COMBINE_COSTUME_ITEM"*/, 0LL);
  Instance = (int64_t)System_String__Format(v28, v29, 0LL);
  if ( !haveItemLabel )
    goto LABEL_31;
  UILabel__set_text(haveItemLabel, (System_String_o *)Instance, 0LL);
  msg = this->fields.msg;
  v31 = LocalizationManager__Get((System_String_o *)StringLiteral_5570/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG"*/, 0LL);
  v32 = (Il2CppObject *)LocalizationManager__Get((System_String_o *)StringLiteral_5569/*"EVENT_COMBINE_COSTUME_ITEM"*/, 0LL);
  ...
  Instance = (int64_t)System_String__Format((System_String_o *)StringLiteral_24976/*"{0:#,0}"*/, v38, 0LL);
  ...
  if ( !entity
    || (v45 = this->fields.haveItemCountLabel,
        ...
        Instance = (int64_t)System_String__Format((System_String_o *)StringLiteral_24976/*"{0:#,0}"*/, v46, 0LL),
        !v45) )
  {
LABEL_31:
