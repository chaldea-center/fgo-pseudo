        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2B404 & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_5535/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG"*/);
    sub_1C2D490(&StringLiteral_5538/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_TITLE"*/);
    sub_1C2D490(&StringLiteral_3760/*"CONFIRM_TITLE_COSTUME_COMBINE"*/);
    sub_1C2D490(&StringLiteral_25029/*"{0:#,0}"*/);
    sub_1C2D490(&StringLiteral_5536/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_HAVE"*/);
    sub_1C2D490(&StringLiteral_5537/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_REQ"*/);
  ...
  Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3760/*"CONFIRM_TITLE_COSTUME_COMBINE"*/, 0);
  if ( !title )
    goto LABEL_35;
  UILabel__set_text(title, (System_String_o *)Instance, 0);
  subTitle = this->fields.subTitle;
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_5538/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_TITLE"*/, 0);
  v10 = (Il2CppObject *)LocalizationManager__Get((System_String_o *)StringLiteral_5534/*"EVENT_COMBINE_COSTUME_ITEM"*/, 0);
  ...
  v12 = LocalizationManager__Get((System_String_o *)StringLiteral_5537/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_REQ"*/, 0);
  v13 = (Il2CppObject *)LocalizationManager__Get((System_String_o *)StringLiteral_5534/*"EVENT_COMBINE_COSTUME_ITEM"*/, 0);
  ...
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_5536/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_HAVE"*/, 0);
  v16 = (Il2CppObject *)LocalizationManager__Get((System_String_o *)StringLiteral_5534/*"EVENT_COMBINE_COSTUME_ITEM"*/, 0);
  Instance = (DataManager_o *)System_String__Format(v15, v16, 0);
  if ( !haveItemLabel )
    goto LABEL_35;
  UILabel__set_text(haveItemLabel, (System_String_o *)Instance, 0);
  msg = this->fields.msg;
  v18 = LocalizationManager__Get((System_String_o *)StringLiteral_5535/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG"*/, 0);
  v19 = (Il2CppObject *)LocalizationManager__Get((System_String_o *)StringLiteral_5534/*"EVENT_COMBINE_COSTUME_ITEM"*/, 0);
  ...
  v35 = 0;
  Instance = (DataManager_o *)System_Int32__ToString((int32_t)&v35, 0);
  ...
  if ( ((unsigned __int8)Instance & 1) == 0 )
    goto LABEL_31;
  if ( !entity
    || (v31 = this->fields.haveItemCountLabel,
        num = entity->fields.num,
        v32 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &num, v20, v29, v30),
        Instance = (DataManager_o *)System_String__Format((System_String_o *)StringLiteral_25029/*"{0:#,0}"*/, v32, 0),
        !v31) )
  {
LABEL_35:
...
LABEL_31:
  v33 = ent->fields.itemIds;
  if ( !v33 )
    goto LABEL_35;
  if ( !LODWORD(v33->max_length) )
LABEL_36:
    sub_1C2D6F4(Instance, v6, v20);
  Instance = (DataManager_o *)this->fields.itemIcon;
  if ( !Instance )
    goto LABEL_35;
  LimitCntUpItemComponent__SetItemIcon((LimitCntUpItemComponent_o *)Instance, v33->m_Items[0], 0);
}