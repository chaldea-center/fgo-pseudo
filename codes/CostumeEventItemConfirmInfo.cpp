        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D26628 & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_5548/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG"*/);
    sub_1C94098(&StringLiteral_5551/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_TITLE"*/);
    sub_1C94098(&StringLiteral_3772/*"CONFIRM_TITLE_COSTUME_COMBINE"*/);
    sub_1C94098(&StringLiteral_25304/*"{0:#,0}"*/);
    sub_1C94098(&StringLiteral_5549/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_HAVE"*/);
    sub_1C94098(&StringLiteral_5550/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_REQ"*/);
  ...
  Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3772/*"CONFIRM_TITLE_COSTUME_COMBINE"*/, 0);
  if ( !title )
    goto LABEL_35;
  UILabel__set_text(title, (System_String_o *)Instance, 0);
  subTitle = this->fields.subTitle;
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_5551/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_TITLE"*/, 0);
  v10 = (Il2CppObject *)LocalizationManager__Get((System_String_o *)StringLiteral_5547/*"EVENT_COMBINE_COSTUME_ITEM"*/, 0);
  ...
  v12 = LocalizationManager__Get((System_String_o *)StringLiteral_5550/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_REQ"*/, 0);
  v13 = (Il2CppObject *)LocalizationManager__Get((System_String_o *)StringLiteral_5547/*"EVENT_COMBINE_COSTUME_ITEM"*/, 0);
  ...
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_5549/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_HAVE"*/, 0);
  v16 = (Il2CppObject *)LocalizationManager__Get((System_String_o *)StringLiteral_5547/*"EVENT_COMBINE_COSTUME_ITEM"*/, 0);
  Instance = (DataManager_o *)System_String__Format(v15, v16, 0);
  if ( !haveItemLabel )
    goto LABEL_35;
  UILabel__set_text(haveItemLabel, (System_String_o *)Instance, 0);
  msg = this->fields.msg;
  v18 = LocalizationManager__Get((System_String_o *)StringLiteral_5548/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG"*/, 0);
  ...
  Instance = (DataManager_o *)System_String__Format((System_String_o *)StringLiteral_25304/*"{0:#,0}"*/, v22, 0);
  ...
  if ( !entity
    || (v26 = this->fields.haveItemCountLabel,
        ...
        Instance = (DataManager_o *)System_String__Format((System_String_o *)StringLiteral_25304/*"{0:#,0}"*/, v27, 0),
        !v26) )
  {
LABEL_35:
