        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CCB65E & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_5537/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG"*/);
    sub_1C713B0(&StringLiteral_5540/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_TITLE"*/);
    sub_1C713B0(&StringLiteral_3762/*"CONFIRM_TITLE_COSTUME_COMBINE"*/);
    sub_1C713B0(&StringLiteral_25182/*"{0:#,0}"*/);
    sub_1C713B0(&StringLiteral_5538/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_HAVE"*/);
    sub_1C713B0(&StringLiteral_5539/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_REQ"*/);
  ...
  Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3762/*"CONFIRM_TITLE_COSTUME_COMBINE"*/, 0);
  if ( !title )
    goto LABEL_35;
  UILabel__set_text(title, (System_String_o *)Instance, 0);
  subTitle = this->fields.subTitle;
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_5540/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_TITLE"*/, 0);
  v10 = (Il2CppObject *)LocalizationManager__Get((System_String_o *)StringLiteral_5536/*"EVENT_COMBINE_COSTUME_ITEM"*/, 0);
  ...
  v12 = LocalizationManager__Get((System_String_o *)StringLiteral_5539/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_REQ"*/, 0);
  v13 = (Il2CppObject *)LocalizationManager__Get((System_String_o *)StringLiteral_5536/*"EVENT_COMBINE_COSTUME_ITEM"*/, 0);
  ...
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_5538/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_HAVE"*/, 0);
  v16 = (Il2CppObject *)LocalizationManager__Get((System_String_o *)StringLiteral_5536/*"EVENT_COMBINE_COSTUME_ITEM"*/, 0);
  Instance = (DataManager_o *)System_String__Format(v15, v16, 0);
  if ( !haveItemLabel )
    goto LABEL_35;
  UILabel__set_text(haveItemLabel, (System_String_o *)Instance, 0);
  msg = this->fields.msg;
  v18 = LocalizationManager__Get((System_String_o *)StringLiteral_5537/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG"*/, 0);
  v19 = (Il2CppObject *)LocalizationManager__Get((System_String_o *)StringLiteral_5536/*"EVENT_COMBINE_COSTUME_ITEM"*/, 0);
  ...
  Instance = (DataManager_o *)System_String__Format((System_String_o *)StringLiteral_25182/*"{0:#,0}"*/, v22, 0);
  ...
  if ( !entity
    || (v26 = this->fields.haveItemCountLabel,
        ...
        Instance = (DataManager_o *)System_String__Format((System_String_o *)StringLiteral_25182/*"{0:#,0}"*/, v27, 0),
        !v26) )
  {
LABEL_35:
