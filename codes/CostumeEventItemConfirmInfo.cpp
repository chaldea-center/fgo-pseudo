        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A318D0 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMasterData_EventMaster___, ent);
    ...
    sub_1B761C0(&StringLiteral_5567/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG"*/, v11);
    sub_1B761C0(&StringLiteral_5570/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_TITLE"*/, v12);
    sub_1B761C0(&StringLiteral_3826/*"CONFIRM_TITLE_COSTUME_COMBINE"*/, v13);
    sub_1B761C0(&StringLiteral_24920/*"{0:#,0}"*/, v14);
    sub_1B761C0(&StringLiteral_5568/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_HAVE"*/, v15);
    sub_1B761C0(&StringLiteral_5569/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_REQ"*/, v16);
    sub_1B761C0(&StringLiteral_5566/*"EVENT_COMBINE_COSTUME_ITEM"*/, v17);
    byte_4A318D0 = 1;
  }
  entity = 0LL;
  v49 = 0;
  ...
  Instance = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_3826/*"CONFIRM_TITLE_COSTUME_COMBINE"*/, 0LL);
  if ( !title )
    goto LABEL_31;
  UILabel__set_text(title, (System_String_o *)Instance, 0LL);
  subTitle = this->fields.subTitle;
  v22 = LocalizationManager__Get((System_String_o *)StringLiteral_5570/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_TITLE"*/, 0LL);
  v23 = (Il2CppObject *)LocalizationManager__Get((System_String_o *)StringLiteral_5566/*"EVENT_COMBINE_COSTUME_ITEM"*/, 0LL);
  ...
  v25 = LocalizationManager__Get((System_String_o *)StringLiteral_5569/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_REQ"*/, 0LL);
  v26 = (Il2CppObject *)LocalizationManager__Get((System_String_o *)StringLiteral_5566/*"EVENT_COMBINE_COSTUME_ITEM"*/, 0LL);
  ...
  v28 = LocalizationManager__Get((System_String_o *)StringLiteral_5568/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_HAVE"*/, 0LL);
  v29 = (Il2CppObject *)LocalizationManager__Get((System_String_o *)StringLiteral_5566/*"EVENT_COMBINE_COSTUME_ITEM"*/, 0LL);
  Instance = (int64_t)System_String__Format(v28, v29, 0LL);
  if ( !haveItemLabel )
    goto LABEL_31;
  UILabel__set_text(haveItemLabel, (System_String_o *)Instance, 0LL);
  msg = this->fields.msg;
  v31 = LocalizationManager__Get((System_String_o *)StringLiteral_5567/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG"*/, 0LL);
  v32 = (Il2CppObject *)LocalizationManager__Get((System_String_o *)StringLiteral_5566/*"EVENT_COMBINE_COSTUME_ITEM"*/, 0LL);
  ...
  Instance = (int64_t)System_String__Format((System_String_o *)StringLiteral_24920/*"{0:#,0}"*/, v38, 0LL);
  ...
  if ( !entity
    || (v45 = this->fields.haveItemCountLabel,
        ...
        Instance = (int64_t)System_String__Format((System_String_o *)StringLiteral_24920/*"{0:#,0}"*/, v46, 0LL),
        !v45) )
  {
LABEL_31:
