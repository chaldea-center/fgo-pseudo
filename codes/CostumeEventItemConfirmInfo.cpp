        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_438CD18 & 1) == 0 )
  {
    ...
    sub_B775C4(&StringLiteral_5719/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG"*/);
    sub_B775C4(&StringLiteral_5722/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_TITLE"*/);
    sub_B775C4(&StringLiteral_3456/*"CONFIRM_TITLE_COSTUME_COMBINE"*/);
    sub_B775C4(&StringLiteral_23975/*"{0:#,0}"*/);
    sub_B775C4(&StringLiteral_5720/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_HAVE"*/);
    sub_B775C4(&StringLiteral_5721/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_REQ"*/);
  ...
  Instance = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_3456/*"CONFIRM_TITLE_COSTUME_COMBINE"*/, 0LL);
  if ( !title )
    goto LABEL_33;
  UILabel__set_text(title, (System_String_o *)Instance, 0LL);
  subTitle = this->fields.subTitle;
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_5722/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_TITLE"*/, 0LL);
  v10 = (Il2CppObject *)LocalizationManager__Get((System_String_o *)StringLiteral_5718/*"EVENT_COMBINE_COSTUME_ITEM"*/, 0LL);
  ...
  v12 = LocalizationManager__Get((System_String_o *)StringLiteral_5721/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_REQ"*/, 0LL);
  v13 = (Il2CppObject *)LocalizationManager__Get((System_String_o *)StringLiteral_5718/*"EVENT_COMBINE_COSTUME_ITEM"*/, 0LL);
  ...
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_5720/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG_HAVE"*/, 0LL);
  v16 = (Il2CppObject *)LocalizationManager__Get((System_String_o *)StringLiteral_5718/*"EVENT_COMBINE_COSTUME_ITEM"*/, 0LL);
  Instance = (int64_t)System_String__Format(v15, v16, 0LL);
  if ( !haveItemLabel )
    goto LABEL_33;
  UILabel__set_text(haveItemLabel, (System_String_o *)Instance, 0LL);
  msg = this->fields.msg;
  v18 = LocalizationManager__Get((System_String_o *)StringLiteral_5719/*"EVENT_COMBINE_COSTUME_ITEM_CONFIRM_DIALOG"*/, 0LL);
  v19 = (Il2CppObject *)LocalizationManager__Get((System_String_o *)StringLiteral_5718/*"EVENT_COMBINE_COSTUME_ITEM"*/, 0LL);
  ...
  Instance = (int64_t)System_String__Format((System_String_o *)StringLiteral_23975/*"{0:#,0}"*/, v23, 0LL);
  ...
  if ( !entity
    || (v28 = this->fields.haveItemCountLabel,
        ...
        Instance = (int64_t)System_String__Format((System_String_o *)StringLiteral_23975/*"{0:#,0}"*/, v29, 0LL),
        !v28) )
  {
LABEL_33:
