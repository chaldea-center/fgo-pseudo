...
TweenHeight_o *TweenHeight__Begin(UIWidget_o *widget, float duration, int32_t height, const MethodInfo *method)
{
  ...
  if ( (byte_4E0929C & 1) == 0 )
  {
    widget = (UIWidget_o *)sub_1CE6700(&Method_UITweener_Begin_TweenHeight___);
    byte_4E0929C = 1;
  }
  if ( !v6
    || (gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)v6, 0),
        (widget = (UIWidget_o *)UITweener__Begin_object_(
                                  gameObject,
                                  duration,
                                  (const MethodInfo_32DA710 *)Method_UITweener_Begin_TweenHeight___)) == 0) )
  {
    sub_1CE6958(widget, *(_QWORD *)&height);
  }
...
void TweenHeight__OnUpdate(TweenHeight_o *this, float factor, bool isFinished, const MethodInfo *method)
{
  ...
  if ( (byte_4E0929B & 1) == 0 )
  {
    sub_1CE6700(&Method_NGUITools_FindInParents_UITable___);
...
LABEL_17:
  ...
  if ( this->fields.updateTable )
  {
    ...
    v20 = NGUITools__FindInParents_object_(
            gameObject,
            (const MethodInfo_328EB80 *)Method_NGUITools_FindInParents_UITable___);
    *p_mTable = (UITable_o *)v20;
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.mTable, (int32_t)v20, v21, v22, v23, v24, v25, v26);
