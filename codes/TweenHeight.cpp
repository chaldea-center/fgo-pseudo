...
TweenHeight_o *TweenHeight__Begin(UIWidget_o *widget, float duration, int32_t height, const MethodInfo *method)
{
  ...
  if ( (byte_4D352BC & 1) == 0 )
  {
    widget = (UIWidget_o *)sub_1C93AD4(&Method_UITweener_Begin_TweenHeight___);
    byte_4D352BC = 1;
  }
  if ( !v6
    || (gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)v6, 0),
        (widget = (UIWidget_o *)UITweener__Begin_object_(
                                  gameObject,
                                  duration,
                                  (const MethodInfo_327A3AC *)Method_UITweener_Begin_TweenHeight___)) == 0) )
  {
    sub_1C93D2C(widget, *(_QWORD *)&height);
  }
...
void TweenHeight__OnUpdate(TweenHeight_o *this, float factor, bool isFinished, const MethodInfo *method)
{
  ...
  if ( (byte_4D352BB & 1) == 0 )
  {
    sub_1C93AD4(&Method_NGUITools_FindInParents_UITable___);
...
LABEL_17:
  ...
  if ( this->fields.updateTable )
  {
    ...
    v20 = NGUITools__FindInParents_object_(
            gameObject,
            (const MethodInfo_322EDC8 *)Method_NGUITools_FindInParents_UITable___);
    *p_mTable = (UITable_o *)v20;
    sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.mTable, (int32_t)v20, v21, v22, v23, v24, v25, v26);
