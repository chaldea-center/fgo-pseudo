...
void TitleEffect__Start(TitleEffect_o *this, const MethodInfo *method)
{
  ...
  if ( !titlePsLeft
    || (UnityEngine_ParticleSystem__Play_73204236(titlePsLeft, 0), (titlePsLeft = this->fields.titlePsRight) == 0) )
  {
    sub_1CE6958(titlePsLeft, method);
  }
  UnityEngine_ParticleSystem__Play_73204236(titlePsLeft, 0);
}