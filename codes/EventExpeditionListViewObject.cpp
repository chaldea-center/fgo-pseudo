...
void __fastcall EventExpeditionListViewObject__Awake(EventExpeditionListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A00098 & 1) == 0 )
  {
    sub_1B640C8(&Method_UnityEngine_GameObject_GetComponent_EventExpeditionListViewItemDraw___, method);
    byte_4A00098 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2E87ED8 *)Method_UnityEngine_GameObject_GetComponent_EventExpeditionListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0009A & 1) == 0 )
  {
    sub_1B640C8(&EventExpeditionListViewItem_TypeInfo, method);
    byte_4A0009A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  EventExpeditionListViewObject_c *v14; // x8
  int32_t v15; // w9
  EventExpeditionListViewObject_c *klass; // x8
  bool v17; // w21
  EventExpeditionListViewObject_o *v18; // x0
  ...
  if ( (byte_4A0009B & 1) == 0 )
  {
    sub_1B640C8(&EventExpeditionListViewItem_TypeInfo, callbackFunc);
    byte_4A0009B = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.callbackFunc, (int32_t)callbackFunc, v10, v11);
  ...
  else
  {
    ...
    {
      if ( EventExpeditionListViewObject__IsAllUserItemEnough(v18, v7->fields.commonConsumeEntity, v19) )
      {
        v20 = this->klass;
        v17 = 1;
        this->fields.dispMode = 1;
        ((void (__fastcall *)(EventExpeditionListViewObject_o *, __int64, Il2CppMethodPointer))v20->vtable._9_SetInput.method)(
          this,
          1LL,
  ...
  v17 = 1;
  ((void (__fastcall *)(EventExpeditionListViewObject_o *, __int64, Il2CppMethodPointer))v14->vtable._9_SetInput.method)(
    this,
    1LL,
    v14->vtable._10_Invalidation.methodPtr);
LABEL_22:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0009D & 1) == 0 )
  {
    sub_1B640C8(&Method_DataManager_GetMasterData_UserItemMaster___, consumeList);
    sub_1B640C8(&NetworkManager_TypeInfo, v4);
    this = (EventExpeditionListViewObject_o *)sub_1B640C8(
...
LABEL_19:
  ...
  {
    if ( v7 >= max_length )
      sub_1B6432C(this, consumeList);
    v8 = consumeList->m_Items[v7];
    this = (EventExpeditionListViewObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EC03C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !this )
      goto LABEL_19;
