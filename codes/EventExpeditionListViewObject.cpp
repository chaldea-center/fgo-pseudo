...
void EventExpeditionListViewObject__Awake(EventExpeditionListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D269BA & 1) == 0 )
  {
    sub_1C94098(&Method_UnityEngine_GameObject_GetComponent_EventExpeditionListViewItemDraw___);
    byte_4D269BA = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_31F4790 *)Method_UnityEngine_GameObject_GetComponent_EventExpeditionListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D269BF & 1) == 0 )
  {
    ...
    this = (EventExpeditionListViewObject_o *)sub_1C94098(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4D269BF = 1;
  }
  entity = 0;
  if ( !consumeList )
LABEL_23:
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      this = (EventExpeditionListViewObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3ABA574 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( !this )
        goto LABEL_23;
        ...
        const MethodInfo *method)
{
  ...
  v11 = (EventExpeditionListViewObject_o *)sub_1C9468C(v8);
