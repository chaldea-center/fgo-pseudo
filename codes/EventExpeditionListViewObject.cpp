...
void __fastcall EventExpeditionListViewObject__Awake(EventExpeditionListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B48CF5 & 1) == 0 )
  {
    sub_1BDB878(&Method_UnityEngine_GameObject_GetComponent_EventExpeditionListViewItemDraw___, method);
    byte_4B48CF5 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_3088520 *)Method_UnityEngine_GameObject_GetComponent_EventExpeditionListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48CF7 & 1) == 0 )
  {
    sub_1BDB878(&EventExpeditionListViewItem_TypeInfo, method);
    byte_4B48CF7 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48CF8 & 1) == 0 )
  {
    sub_1BDB878(&EventExpeditionListViewItem_TypeInfo, callbackFunc);
    byte_4B48CF8 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.callbackFunc, (int32_t)callbackFunc, v11, v12);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48CFA & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMasterData_UserItemMaster___, consumeList);
    sub_1BDB878(&NetworkManager_TypeInfo, v4);
    this = (EventExpeditionListViewObject_o *)sub_1BDB878(
...
LABEL_23:
  ...
  if ( max_length >= 1 )
  {
    ...
    {
      if ( v8 >= max_length )
        sub_1BDBADC(this, consumeList, method);
      v9 = consumeList->m_Items[v8];
      this = (EventExpeditionListViewObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( !this )
        goto LABEL_23;
      ...
      if ( !byte_4B3ED56 )
      {
        sub_1BDB878(&NetworkManager_TypeInfo, consumeList);
        byte_4B3ED56 = 1;
      }
