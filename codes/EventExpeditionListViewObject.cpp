...
void EventExpeditionListViewObject__Awake(EventExpeditionListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CE883A & 1) == 0 )
  {
    sub_1C7BAE8(&Method_UnityEngine_GameObject_GetComponent_EventExpeditionListViewItemDraw___);
    byte_4CE883A = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_31C70C8 *)Method_UnityEngine_GameObject_GetComponent_EventExpeditionListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CE883F & 1) == 0 )
  {
    ...
    this = (EventExpeditionListViewObject_o *)sub_1C7BAE8(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4CE883F = 1;
  }
  entity = 0;
  if ( !consumeList )
LABEL_23:
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      this = (EventExpeditionListViewObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A8C5A8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( !this )
        goto LABEL_23;
        ...
        const MethodInfo *method)
{
  ...
  v11 = (EventExpeditionListViewObject_o *)sub_1C7C0DC(v8);
