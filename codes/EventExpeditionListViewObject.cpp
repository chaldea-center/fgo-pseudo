...
void __fastcall EventExpeditionListViewObject__Awake(EventExpeditionListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B062F5 & 1) == 0 )
  {
    sub_1BC3008(&Method_UnityEngine_GameObject_GetComponent_EventExpeditionListViewItemDraw___, method);
    byte_4B062F5 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_3055998 *)Method_UnityEngine_GameObject_GetComponent_EventExpeditionListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B062F7 & 1) == 0 )
  {
    sub_1BC3008(&EventExpeditionListViewItem_TypeInfo, method);
    byte_4B062F7 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B062F8 & 1) == 0 )
  {
    sub_1BC3008(&EventExpeditionListViewItem_TypeInfo, callbackFunc);
    byte_4B062F8 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.callbackFunc, (int32_t)callbackFunc, v11, v12);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B062FA & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMasterData_UserItemMaster___, consumeList);
    sub_1BC3008(&NetworkManager_TypeInfo, v4);
    this = (EventExpeditionListViewObject_o *)sub_1BC3008(
...
LABEL_23:
  ...
  if ( max_length >= 1 )
  {
    ...
    {
      if ( v8 >= max_length )
        sub_1BC326C(this, consumeList, method);
      v9 = consumeList->m_Items[v8];
      this = (EventExpeditionListViewObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38DFD48 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( !this )
        goto LABEL_23;
      ...
      entity = 0LL;
      v11 = (UserItemMaster_o *)MasterData_object;
      if ( !NetworkManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
      if ( !byte_4AFC1F1 )
      {
        sub_1BC3008(&NetworkManager_TypeInfo, consumeList);
        byte_4AFC1F1 = 1;
      }
      ...
      if ( !entity )
        goto LABEL_23;
      if ( v9->fields.num > entity->fields.num )
        return 0;
      max_length = consumeList->max_length;
