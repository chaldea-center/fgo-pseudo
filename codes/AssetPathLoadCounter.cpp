        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2D059 & 1) == 0 )
  {
    sub_1B761C0(&Method_System_Collections_Generic_Dictionary_string__int__ContainsKey__, path);
  ...
  if ( !v8 )
LABEL_9:
    sub_1B7641C(pathToCountMap, path);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2D058 & 1) == 0 )
  {
    ...
    sub_1B761C0(&System_Collections_Generic_Dictionary_Enumerator_string__int__TypeInfo, v3);
    byte_4A2D058 = 1;
  }
  pathToCountMap = this->fields.pathToCountMap;
  if ( !pathToCountMap )
