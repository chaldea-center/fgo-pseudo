        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B65C94 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_System_Collections_Generic_Dictionary_string__int__ContainsKey__, path);
    sub_1BE4ACC(&Method_System_Collections_Generic_Dictionary_string__int__get_Item__, v5);
    sub_1BE4ACC(&Method_System_Collections_Generic_Dictionary_string__int__set_Item__, v6);
    byte_4B65C94 = 1;
  }
  ...
  if ( !v8 )
LABEL_9:
    sub_1BE4D28(pathToCountMap, path);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B65C93 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&System_Collections_Generic_Dictionary_Enumerator_string__int__TypeInfo, v3);
    byte_4B65C93 = 1;
  }
  pathToCountMap = this->fields.pathToCountMap;
  if ( !pathToCountMap )
