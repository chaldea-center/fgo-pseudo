        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDC58 & 1) == 0 )
  {
    sub_1B64A00(&Method_System_Collections_Generic_Dictionary_string__int__ContainsKey__, path);
  ...
  if ( !v8 )
LABEL_9:
    sub_1B64C5C(pathToCountMap, path);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDC57 & 1) == 0 )
  {
    ...
    sub_1B64A00(&System_Collections_Generic_Dictionary_Enumerator_string__int__TypeInfo, v3);
    byte_49FDC57 = 1;
  }
  pathToCountMap = this->fields.pathToCountMap;
  if ( !pathToCountMap )
