        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6B83 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_System_Collections_Generic_Dictionary_string__int__ContainsKey__, path);
  ...
  if ( !v8 )
LABEL_9:
    sub_1C1AE30(pathToCountMap, path);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6B82 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&System_Collections_Generic_Dictionary_Enumerator_string__int__TypeInfo, v3);
    byte_4BC6B82 = 1;
  }
  pathToCountMap = this->fields.pathToCountMap;
  if ( !pathToCountMap )
