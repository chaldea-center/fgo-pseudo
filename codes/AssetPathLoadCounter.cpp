        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6EF7F & 1) == 0 )
  {
    sub_1B90010(&Method_System_Collections_Generic_Dictionary_string__int__ContainsKey__, path);
  ...
  if ( !v8 )
LABEL_9:
    sub_1B9026C(pathToCountMap, path);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6EF7E & 1) == 0 )
  {
    ...
    sub_1B90010(&System_Collections_Generic_Dictionary_Enumerator_string__int__TypeInfo, v3);
    byte_4A6EF7E = 1;
  }
  pathToCountMap = this->fields.pathToCountMap;
  if ( !pathToCountMap )
