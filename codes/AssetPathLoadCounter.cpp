        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB4E47 & 1) == 0 )
  {
    sub_1BAB41C(&Method_System_Collections_Generic_Dictionary_string__int__ContainsKey__, path);
  ...
  if ( !v8 )
LABEL_9:
    sub_1BAB678(pathToCountMap, path);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB4E46 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&System_Collections_Generic_Dictionary_Enumerator_string__int__TypeInfo, v3);
    byte_4AB4E46 = 1;
  }
  pathToCountMap = this->fields.pathToCountMap;
  if ( !pathToCountMap )
