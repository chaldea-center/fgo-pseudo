        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B9F3A & 1) == 0 )
  {
    sub_1B4CF90(&Method_System_Collections_Generic_Dictionary_string__int__ContainsKey__, path);
    sub_1B4CF90(&Method_System_Collections_Generic_Dictionary_string__int__get_Item__, v5);
    sub_1B4CF90(&Method_System_Collections_Generic_Dictionary_string__int__set_Item__, v6);
    byte_49B9F3A = 1;
  }
  ...
  if ( !v8 )
LABEL_9:
    sub_1B4D1EC(pathToCountMap, path);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B9F39 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&System_Collections_Generic_Dictionary_Enumerator_string__int__TypeInfo, v3);
    byte_49B9F39 = 1;
  }
  pathToCountMap = this->fields.pathToCountMap;
  if ( !pathToCountMap )
