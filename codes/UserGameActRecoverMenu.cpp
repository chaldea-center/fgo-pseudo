        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4377C & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_UserGameActRecoverMenu_EndCloseBuyStoneConfirm__, v7);
    sub_1BDB878(&Method_UserGameActRecoverMenu_SelectedBuyBankItemConfirm__, v8);
    byte_4B4377C = 1;
  }
  if ( isDecide )
  {
...
LABEL_8:
  ...
  if ( !recoverConfirmMenu )
    goto LABEL_8;
  UserGameActRecoverConfirmMenu__Close_39189260(recoverConfirmMenu, v14, v15);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&System_Action_TypeInfo, isDecide);
    sub_1BDB878(&Method_UserGameActRecoverMenu_EndCloseMaxFrameConfirm__, v4);
    byte_4B4377B = 1;
  }
  recoverConfirmMenu = this->fields.recoverConfirmMenu;
  ...
  if ( !recoverConfirmMenu )
    sub_1BDBAD4(v7, v8);
  UserGameActRecoverConfirmMenu__Close_39189260(recoverConfirmMenu, v6, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&System_Action_TypeInfo, isDecide);
    sub_1BDB878(&Method_UserGameActRecoverMenu_EndCloseNoShopConfirm__, v4);
    byte_4B4377A = 1;
  }
  recoverConfirmMenu = this->fields.recoverConfirmMenu;
  v6 = (System_Action_o *)sub_1BDBAC4(System_Action_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&System_Action_TypeInfo, isDecide);
    sub_1BDB878(&Method_UserGameActRecoverMenu_EndCloseRecoverUserGameActConfirm__, v5);
    byte_4B4377E = 1;
  }
  if ( isDecide )
  {
  ...
  else
  {
    ...
    if ( !recoverConfirmMenu )
      sub_1BDBAD4(v8, v9);
    UserGameActRecoverConfirmMenu__Close_39189260(recoverConfirmMenu, v7, v10);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&System_Action_TypeInfo, isDecide);
    sub_1BDB878(&Method_UserGameActRecoverMenu_EndCloseRecoverUserGameActResultConfirm__, v4);
    byte_4B43781 = 1;
  }
  recoverConfirmMenu = this->fields.recoverConfirmMenu;
  v6 = (System_Action_o *)sub_1BDBAC4(System_Action_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43780 & 1) == 0 )
  {
    sub_1BDB878(&UserGameActRecoverConfirmMenu_CallbackFunc_TypeInfo, result);
    sub_1BDB878(&Method_UserGameActRecoverMenu_EndRecoverUserGameActResultConfirm__, v4);
    byte_4B43780 = 1;
  }
  recoverConfirmMenu = this->fields.recoverConfirmMenu;
  this->fields.state = 7;
  if ( !recoverConfirmMenu
    || (UserGameActRecoverConfirmMenu__Init(recoverConfirmMenu, (const MethodInfo *)result),
        ...
        v8 = (UserGameActRecoverConfirmMenu_CallbackFunc_o *)sub_1BDBAC4(UserGameActRecoverConfirmMenu_CallbackFunc_TypeInfo),
        ...
        !v6) )
  {
    sub_1BDBAD4(recoverConfirmMenu, result);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43779 & 1) == 0 )
  {
    sub_1BDB878(&UserGameActRecoverConfirmMenu_CallbackFunc_TypeInfo, callback);
    sub_1BDB878(&Method_DataManager_GetMasterData_StoneShopMaster___, v7);
    sub_1BDB878(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v8);
    sub_1BDB878(&Method_UserGameActRecoverMenu_EndBuyStoneConfirm__, v9);
    sub_1BDB878(&Method_UserGameActRecoverMenu_EndMaxFrameConfirm__, v10);
    sub_1BDB878(&Method_UserGameActRecoverMenu_EndNoShopConfirm__, v11);
    sub_1BDB878(&Method_UserGameActRecoverMenu_EndRecoverUserGameActConfirm__, v12);
  ...
  if ( !this->fields.state )
  {
    ...
    sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.refreshCallbackFunc, (int32_t)refreshCallback, v14, v15);
    ...
    if ( !gameObject )
      goto LABEL_25;
    gameObject = (UnityEngine_GameObject_o *)StoneShopMaster__GetEnableEntitiyList_41891716(
    ...
    {
      if ( !(_DWORD)klass )
        sub_1BDBADC(gameObject, v17, v19);
      monitor = (struct StoneShopEntity_o *)gameObject[1].monitor;
      this->fields.stoneShopEntity = monitor;
      sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.stoneShopEntity, (int32_t)monitor, v19, v20);
      if ( !SelfUserGame )
        goto LABEL_25;
      ...
      if ( ((unsigned __int8)gameObject & 1) != 0 )
      {
        ...
        if ( stoneShopEntity )
        {
          if ( SelfUserGame->fields.stone >= stoneShopEntity->fields.price )
          {
            this->fields.state = 3;
            recoverConfirmMenu = this->fields.recoverConfirmMenu;
            v25 = (UserGameActRecoverConfirmMenu_CallbackFunc_o *)sub_1BDBAC4(UserGameActRecoverConfirmMenu_CallbackFunc_TypeInfo);
            UserGameActRecoverConfirmMenu_CallbackFunc___ctor(
              v25,
              (Il2CppObject *)this,
...
LABEL_25:
      ...
      v31 = (UserGameActRecoverConfirmMenu_CallbackFunc_o *)sub_1BDBAC4(UserGameActRecoverConfirmMenu_CallbackFunc_TypeInfo);
      UserGameActRecoverConfirmMenu_CallbackFunc___ctor(
        v31,
        (Il2CppObject *)this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4377F & 1) == 0 )
  {
    sub_1BDB878(&Method_NetworkManager_getRequest_PurchaseByStoneRequest___, method);
    sub_1BDB878(&NetworkManager_TypeInfo, v4);
    sub_1BDB878(&NetworkManager_ResultCallbackFunc_TypeInfo, v5);
    sub_1BDB878(&Method_UserGameActRecoverMenu_EndRequestUserGameActRecover__, v6);
    byte_4B4377F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4377D & 1) == 0 )
  {
    sub_1BDB878(&UserGameActRecoverConfirmMenu_CallbackFunc_TypeInfo, *(_QWORD *)&result);
    sub_1BDB878(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v5);
    sub_1BDB878(&Method_UserGameActRecoverMenu_EndBuyStoneConfirm__, v6);
    sub_1BDB878(&Method_UserGameActRecoverMenu_EndRecoverUserGameActConfirm__, v7);
    byte_4B4377D = 1;
  }
...
LABEL_15:
  ...
  switch ( result )
  {
    ...
    case 4:
      ...
      recoverConfirmMenu = this->fields.recoverConfirmMenu;
      stoneShopEntity = this->fields.stoneShopEntity;
      v13 = (UserGameActRecoverConfirmMenu_CallbackFunc_o *)sub_1BDBAC4(UserGameActRecoverConfirmMenu_CallbackFunc_TypeInfo);
      UserGameActRecoverConfirmMenu_CallbackFunc___ctor(
        v13,
        (Il2CppObject *)this,
        Method_UserGameActRecoverMenu_EndBuyStoneConfirm__,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43777 & 1) == 0 )
  {
    sub_1BDB878(&UserGameActRecoverMenu_CallbackFunc_TypeInfo, value);
    byte_4B43777 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A24494;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A2444C;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43782 & 1) == 0 )
  {
    sub_1BDB878(&UserGameActRecoverMenu_Result_TypeInfo, *(_QWORD *)&result);
    byte_4B43782 = 1;
  }
  v9[1] = 0LL;
