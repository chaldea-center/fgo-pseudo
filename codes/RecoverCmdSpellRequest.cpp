        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB7673 & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_18186/*"commandSpellId"*/, *(_QWORD *)&itemId);
    byte_4AB7673 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18186/*"commandSpellId"*/, itemId, v3);
...
System_String_o *__fastcall RecoverCmdSpellRequest__getURL(RecoverCmdSpellRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB7672 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_18185/*"commandSpell/use"*/, v2);
    byte_4AB7672 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62048128(BaseUrl, (System_String_o *)StringLiteral_18185/*"commandSpell/use"*/, 0LL);
}
