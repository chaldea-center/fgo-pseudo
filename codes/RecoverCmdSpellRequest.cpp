        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B38B0D & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_18368/*"commandSpellId"*/, *(_QWORD *)&itemId);
    byte_4B38B0D = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18368/*"commandSpellId"*/, itemId, v3);
...
System_String_o *__fastcall RecoverCmdSpellRequest__getURL(RecoverCmdSpellRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B38B0C & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_18367/*"commandSpell/use"*/, v2);
    byte_4B38B0C = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62525248(BaseUrl, (System_String_o *)StringLiteral_18367/*"commandSpell/use"*/, 0LL);
}
