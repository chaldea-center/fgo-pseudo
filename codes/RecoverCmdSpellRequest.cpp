        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFF165 & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_18477/*"commandSpellId"*/, *(_QWORD *)&itemId);
    byte_4BFF165 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18477/*"commandSpellId"*/, itemId, v3);
...
System_String_o *__fastcall RecoverCmdSpellRequest__getURL(RecoverCmdSpellRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFF164 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&StringLiteral_18476/*"commandSpell/use"*/, v2);
    byte_4BFF164 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63235584(BaseUrl, (System_String_o *)StringLiteral_18476/*"commandSpell/use"*/, 0LL);
}
