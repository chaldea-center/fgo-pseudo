        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB6095 & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_18437/*"combine_fodder013"*/, *(_QWORD *)&itemId);
    byte_4BB6095 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18437/*"combine_fodder013"*/, itemId, v3);
...
System_String_o *__fastcall RecoverCmdSpellRequest__getURL(RecoverCmdSpellRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB6094 & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_18436/*"combine_fodder012"*/, v2);
    byte_4BB6094 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62967944(BaseUrl, (System_String_o *)StringLiteral_18436/*"combine_fodder012"*/, 0LL);
}
