        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6855C & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_18393/*"commandSpellId"*/, *(_QWORD *)&itemId);
    byte_4B6855C = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18393/*"commandSpellId"*/, itemId, v3);
...
System_String_o *__fastcall RecoverCmdSpellRequest__getURL(RecoverCmdSpellRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6855B & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_18392/*"commandSpell/use"*/, v2);
    byte_4B6855B = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62698808(BaseUrl, (System_String_o *)StringLiteral_18392/*"commandSpell/use"*/, 0LL);
}
