        ...
        const MethodInfo *method)
{
  if ( (byte_40F82F1 & 1) == 0 )
  {
    sub_B16FFC(&StringLiteral_17534/*"commandSpellId"*/, *(_QWORD *)&itemId);
    byte_40F82F1 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_17534/*"commandSpellId"*/, itemId, 0LL);
...
System_String_o *__fastcall RecoverCmdSpellRequest__getURL(RecoverCmdSpellRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_40F82F0 & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_17533/*"commandSpell/use"*/, v2);
    byte_40F82F0 = 1;
  }
  ...
  return System_String__Concat_43743732(BaseUrl, (System_String_o *)StringLiteral_17533/*"commandSpell/use"*/, 0LL);
}
