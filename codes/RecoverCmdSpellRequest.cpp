        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F849 & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_18150/*"commandSpellId"*/, *(_QWORD *)&itemId);
    byte_4A2F849 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18150/*"commandSpellId"*/, itemId, v3);
...
System_String_o *__fastcall RecoverCmdSpellRequest__getURL(RecoverCmdSpellRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2F848 & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_18149/*"commandSpell/use"*/, v2);
    byte_4A2F848 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61535060(BaseUrl, (System_String_o *)StringLiteral_18149/*"commandSpell/use"*/, 0LL);
}
