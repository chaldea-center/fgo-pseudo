        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3F6C & 1) == 0 )
  {
    sub_1B00CCC(&StringLiteral_17910/*"commandSpellId"*/, *(_QWORD *)&itemId);
    byte_48E3F6C = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_17910/*"commandSpellId"*/, itemId, v3);
...
System_String_o *__fastcall RecoverCmdSpellRequest__getURL(RecoverCmdSpellRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E3F6B & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_17909/*"commandSpell/use"*/, v2);
    byte_48E3F6B = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_60325748(BaseUrl, (System_String_o *)StringLiteral_17909/*"commandSpell/use"*/, 0LL);
}
