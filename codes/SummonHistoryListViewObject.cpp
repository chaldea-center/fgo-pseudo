...
void __fastcall SummonHistoryListViewObject__Awake(SummonHistoryListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3382E & 1) == 0 )
  {
    sub_1BD3458(&Method_UnityEngine_GameObject_GetComponent_SummonHistoryListViewItemDraw___, method);
    byte_4B3382E = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2F81A7C *)Method_UnityEngine_GameObject_GetComponent_SummonHistoryListViewItemDraw___);
...
void __fastcall SummonHistoryListViewObject__SetupDisp(SummonHistoryListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3382F & 1) == 0 )
  {
    ...
    sub_1BD3458(&SummonHistoryListViewItem_TypeInfo, v3);
    byte_4B3382F = 1;
  }
