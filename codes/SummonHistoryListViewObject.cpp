...
void __fastcall SummonHistoryListViewObject__Awake(SummonHistoryListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1899B & 1) == 0 )
  {
    sub_1BCAFF8(&Method_UnityEngine_GameObject_GetComponent_SummonHistoryListViewItemDraw___, method);
    byte_4B1899B = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_306E710 *)Method_UnityEngine_GameObject_GetComponent_SummonHistoryListViewItemDraw___);
...
void __fastcall SummonHistoryListViewObject__SetupDisp(SummonHistoryListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1899C & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&SummonHistoryListViewItem_TypeInfo, v3);
    byte_4B1899C = 1;
  }
