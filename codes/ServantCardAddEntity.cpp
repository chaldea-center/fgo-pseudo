...
float __fastcall ServantCardAddEntity__GetAttackNpRate(ServantCardAddEntity_o *this, const MethodInfo *method)
{
  if ( (byte_438C557 & 1) == 0 )
  {
    sub_B775C4(&StringLiteral_16832/*"attackNpRate"*/);
    byte_438C557 = 1;
  }
  return EntityScriptUtil__GetMillesimal(this->fields.script, (System_String_o *)StringLiteral_16832/*"attackNpRate"*/, 1.0, 0LL);
}
...
float __fastcall ServantCardAddEntity__GetDamageRate(ServantCardAddEntity_o *this, const MethodInfo *method)
{
  if ( (byte_438C556 & 1) == 0 )
  {
    sub_B775C4(&StringLiteral_18219/*"damageRate"*/);
    byte_438C556 = 1;
  }
  return EntityScriptUtil__GetMillesimal(this->fields.script, (System_String_o *)StringLiteral_18219/*"damageRate"*/, 1.0, 0LL);
}
...
float __fastcall ServantCardAddEntity__GetDefenseNpRate(ServantCardAddEntity_o *this, const MethodInfo *method)
{
  if ( (byte_438C558 & 1) == 0 )
  {
    sub_B775C4(&StringLiteral_18303/*"defenseNpRate"*/);
    byte_438C558 = 1;
  }
  return EntityScriptUtil__GetMillesimal(this->fields.script, (System_String_o *)StringLiteral_18303/*"defenseNpRate"*/, 1.0, 0LL);
}
...
float __fastcall ServantCardAddEntity__GetDropStarRate(ServantCardAddEntity_o *this, const MethodInfo *method)
{
  if ( (byte_438C559 & 1) == 0 )
  {
    sub_B775C4(&StringLiteral_18413/*"dropStarRate"*/);
    byte_438C559 = 1;
  }
  return EntityScriptUtil__GetMillesimal(this->fields.script, (System_String_o *)StringLiteral_18413/*"dropStarRate"*/, 1.0, 0LL);
}
