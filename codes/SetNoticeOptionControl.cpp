...
void SetNoticeOptionControl__Init(SetNoticeOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C22341 & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_9665/*"OPTION_NOTICE_ELSE"*/);
    sub_1C2D490(&StringLiteral_9664/*"OPTION_NOTICE_AP"*/);
    sub_1C2D490(&StringLiteral_9667/*"OPTION_NOTICE_RP_EXPLANATION"*/);
    sub_1C2D490(&StringLiteral_9666/*"OPTION_NOTICE_RP"*/);
    byte_4C22341 = 1;
  }
  apNoticeTitle = this->fields.apNoticeTitle;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9664/*"OPTION_NOTICE_AP"*/, 0);
  if ( !apNoticeTitle )
    goto LABEL_12;
  UILabel__set_text(apNoticeTitle, v4, 0);
  rpNoticeTitle = this->fields.rpNoticeTitle;
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9666/*"OPTION_NOTICE_RP"*/, 0);
  if ( !rpNoticeTitle
    || (UILabel__set_text(rpNoticeTitle, v4, 0),
        sysNoticeTitle = this->fields.sysNoticeTitle,
        v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9665/*"OPTION_NOTICE_ELSE"*/, 0),
        !sysNoticeTitle)
    || (UILabel__set_text(sysNoticeTitle, v4, 0),
        rpExplanationTxt = this->fields.rpExplanationTxt,
        v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9667/*"OPTION_NOTICE_RP_EXPLANATION"*/, 0),
        !rpExplanationTxt) )
  {
LABEL_12:
    sub_1C2D6EC(v4, v5);
...
void SetNoticeOptionControl__OnApNoticeChangeBtn(SetNoticeOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C22346 & 1) == 0 )
  {
    sub_1C2D490(&Method_SetNoticeOptionControl_OnApNoticeChangeBtn__);
  ...
  if ( (*((_BYTE *)Method_SetNoticeOptionControl_OnApNoticeChangeBtn__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C2D4A8(Method_SetNoticeOptionControl_OnApNoticeChangeBtn__);
...
void SetNoticeOptionControl__OnGameNoticeChangeBtn(SetNoticeOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C22348 & 1) == 0 )
  {
    sub_1C2D490(&Method_SetNoticeOptionControl_OnGameNoticeChangeBtn__);
    sub_1C2D490(&StringLiteral_17501/*"btn_on"*/);
    sub_1C2D490(&StringLiteral_17500/*"btn_off"*/);
    byte_4C22348 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetNoticeOptionControl_OnGameNoticeChangeBtn__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C2D4A8(Method_SetNoticeOptionControl_OnGameNoticeChangeBtn__);
  v5 = (System_Reflection_MethodBase_o *)sub_1C2D474(v3, v3[4]);
  if ( !isGameNotice )
  {
    OverwriteAssetSoundName__PlaySystemSe(v5, 0, 0, 0);
...
void SetNoticeOptionControl__OnRpNoticeChangeBtn(SetNoticeOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C22347 & 1) == 0 )
  {
    sub_1C2D490(&Method_SetNoticeOptionControl_OnRpNoticeChangeBtn__);
    sub_1C2D490(&StringLiteral_17501/*"btn_on"*/);
    sub_1C2D490(&StringLiteral_17500/*"btn_off"*/);
    byte_4C22347 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetNoticeOptionControl_OnRpNoticeChangeBtn__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C2D4A8(Method_SetNoticeOptionControl_OnRpNoticeChangeBtn__);
  v5 = (System_Reflection_MethodBase_o *)sub_1C2D474(v3, v3[4]);
  if ( !isRpNotice )
  {
    OverwriteAssetSoundName__PlaySystemSe(v5, 0, 0, 0);
