...
void __fastcall SetNoticeOptionControl__Init(SetNoticeOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B61F82 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_9821/*"OPTION_NOTICE_ELSE"*/, v4);
    sub_1BE4ACC(&StringLiteral_9820/*"OPTION_NOTICE_AP"*/, v5);
    sub_1BE4ACC(&StringLiteral_9823/*"OPTION_NOTICE_RP_EXPLANATION"*/, v6);
    sub_1BE4ACC(&StringLiteral_9822/*"OPTION_NOTICE_RP"*/, v7);
    byte_4B61F82 = 1;
  }
  apNoticeTitle = this->fields.apNoticeTitle;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_9820/*"OPTION_NOTICE_AP"*/, 0LL);
  if ( !apNoticeTitle )
    goto LABEL_12;
  UILabel__set_text(apNoticeTitle, v9, 0LL);
  rpNoticeTitle = this->fields.rpNoticeTitle;
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_9822/*"OPTION_NOTICE_RP"*/, 0LL);
  if ( !rpNoticeTitle
    || (UILabel__set_text(rpNoticeTitle, v9, 0LL),
        sysNoticeTitle = this->fields.sysNoticeTitle,
        v9 = LocalizationManager__Get((System_String_o *)StringLiteral_9821/*"OPTION_NOTICE_ELSE"*/, 0LL),
        !sysNoticeTitle)
    || (UILabel__set_text(sysNoticeTitle, v9, 0LL),
        rpExplanationTxt = this->fields.rpExplanationTxt,
        v9 = LocalizationManager__Get((System_String_o *)StringLiteral_9823/*"OPTION_NOTICE_RP_EXPLANATION"*/, 0LL),
        !rpExplanationTxt) )
  {
LABEL_12:
    sub_1BE4D28(v9, v10);
...
void __fastcall SetNoticeOptionControl__OnApNoticeChangeBtn(SetNoticeOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B61F87 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_SetNoticeOptionControl_OnApNoticeChangeBtn__, method);
  ...
  if ( (*((_BYTE *)Method_SetNoticeOptionControl_OnApNoticeChangeBtn__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1BE4AE4(Method_SetNoticeOptionControl_OnApNoticeChangeBtn__);
...
void __fastcall SetNoticeOptionControl__OnGameNoticeChangeBtn(SetNoticeOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B61F89 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_SetNoticeOptionControl_OnGameNoticeChangeBtn__, method);
    sub_1BE4ACC(&StringLiteral_17750/*"btn_on"*/, v3);
    sub_1BE4ACC(&StringLiteral_17749/*"btn_off"*/, v4);
    byte_4B61F89 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetNoticeOptionControl_OnGameNoticeChangeBtn__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1BE4AE4(Method_SetNoticeOptionControl_OnGameNoticeChangeBtn__);
  v7 = (System_Reflection_MethodBase_o *)sub_1BE4AB0(v5, v5[4]);
  if ( !isGameNotice )
  {
    OverwriteAssetSoundName__PlaySystemSe(v7, 0, 0LL);
...
void __fastcall SetNoticeOptionControl__OnRpNoticeChangeBtn(SetNoticeOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B61F88 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_SetNoticeOptionControl_OnRpNoticeChangeBtn__, method);
    sub_1BE4ACC(&StringLiteral_17750/*"btn_on"*/, v3);
    sub_1BE4ACC(&StringLiteral_17749/*"btn_off"*/, v4);
    byte_4B61F88 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetNoticeOptionControl_OnRpNoticeChangeBtn__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1BE4AE4(Method_SetNoticeOptionControl_OnRpNoticeChangeBtn__);
  v7 = (System_Reflection_MethodBase_o *)sub_1BE4AB0(v5, v5[4]);
  if ( !isRpNotice )
  {
    OverwriteAssetSoundName__PlaySystemSe(v7, 0, 0LL);
