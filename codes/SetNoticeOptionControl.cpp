...
void __fastcall SetNoticeOptionControl__Init(SetNoticeOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B3E4 & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_9671/*"OPTION_NOTICE_ELSE"*/, v4);
    sub_1B90010(&StringLiteral_9670/*"OPTION_NOTICE_AP"*/, v5);
    sub_1B90010(&StringLiteral_9673/*"OPTION_NOTICE_RP_EXPLANATION"*/, v6);
    sub_1B90010(&StringLiteral_9672/*"OPTION_NOTICE_RP"*/, v7);
    byte_4A6B3E4 = 1;
  }
...
void __fastcall SetNoticeOptionControl__OnApNoticeChangeBtn(SetNoticeOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B3E9 & 1) == 0 )
  {
    sub_1B90010(&Method_SetNoticeOptionControl_OnApNoticeChangeBtn__, method);
  ...
  if ( (*((_BYTE *)Method_SetNoticeOptionControl_OnApNoticeChangeBtn__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1B90028(Method_SetNoticeOptionControl_OnApNoticeChangeBtn__);
...
void __fastcall SetNoticeOptionControl__OnGameNoticeChangeBtn(SetNoticeOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B3EB & 1) == 0 )
  {
    sub_1B90010(&Method_SetNoticeOptionControl_OnGameNoticeChangeBtn__, method);
    sub_1B90010(&StringLiteral_17551/*"btn_on"*/, v3);
    sub_1B90010(&StringLiteral_17550/*"btn_off"*/, v4);
    byte_4A6B3EB = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetNoticeOptionControl_OnGameNoticeChangeBtn__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1B90028(Method_SetNoticeOptionControl_OnGameNoticeChangeBtn__);
  v7 = (System_Reflection_MethodBase_o *)sub_1B8FFF4(v5, v5[4]);
  if ( !isGameNotice )
  {
    OverwriteAssetSoundName__PlaySystemSe(v7, 0, 0LL);
...
void __fastcall SetNoticeOptionControl__OnRpNoticeChangeBtn(SetNoticeOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B3EA & 1) == 0 )
  {
    sub_1B90010(&Method_SetNoticeOptionControl_OnRpNoticeChangeBtn__, method);
    sub_1B90010(&StringLiteral_17551/*"btn_on"*/, v3);
    sub_1B90010(&StringLiteral_17550/*"btn_off"*/, v4);
    byte_4A6B3EA = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetNoticeOptionControl_OnRpNoticeChangeBtn__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1B90028(Method_SetNoticeOptionControl_OnRpNoticeChangeBtn__);
  v7 = (System_Reflection_MethodBase_o *)sub_1B8FFF4(v5, v5[4]);
  if ( !isRpNotice )
  {
    OverwriteAssetSoundName__PlaySystemSe(v7, 0, 0LL);
