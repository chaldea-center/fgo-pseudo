...
void __fastcall SetNoticeOptionControl__Init(SetNoticeOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1D1FB & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_9858/*"P1Y"*/, v4);
    sub_1C3B764(&StringLiteral_9857/*"P1W"*/, v5);
    sub_1C3B764(&StringLiteral_9860/*"P3P"*/, v6);
    sub_1C3B764(&StringLiteral_9859/*"P3M"*/, v7);
    byte_4C1D1FB = 1;
  }
  apNoticeTitle = this->fields.apNoticeTitle;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_9857/*"P1W"*/, 0LL);
  if ( !apNoticeTitle )
    goto LABEL_12;
  UILabel__set_text(apNoticeTitle, v9, 0LL);
  rpNoticeTitle = this->fields.rpNoticeTitle;
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_9859/*"P3M"*/, 0LL);
  if ( !rpNoticeTitle
    || (UILabel__set_text(rpNoticeTitle, v9, 0LL),
        sysNoticeTitle = this->fields.sysNoticeTitle,
        v9 = LocalizationManager__Get((System_String_o *)StringLiteral_9858/*"P1Y"*/, 0LL),
        !sysNoticeTitle)
    || (UILabel__set_text(sysNoticeTitle, v9, 0LL),
        rpExplanationTxt = this->fields.rpExplanationTxt,
        v9 = LocalizationManager__Get((System_String_o *)StringLiteral_9860/*"P3P"*/, 0LL),
        !rpExplanationTxt) )
  {
LABEL_12:
    sub_1C3B9C0(v9, v10);
...
void __fastcall SetNoticeOptionControl__OnApNoticeChangeBtn(SetNoticeOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1D200 & 1) == 0 )
  {
    sub_1C3B764(&Method_SetNoticeOptionControl_OnApNoticeChangeBtn__, method);
  ...
  if ( (*((_BYTE *)Method_SetNoticeOptionControl_OnApNoticeChangeBtn__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1C3B77C(Method_SetNoticeOptionControl_OnApNoticeChangeBtn__);
...
void __fastcall SetNoticeOptionControl__OnGameNoticeChangeBtn(SetNoticeOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1D202 & 1) == 0 )
  {
    sub_1C3B764(&Method_SetNoticeOptionControl_OnGameNoticeChangeBtn__, method);
    sub_1C3B764(&StringLiteral_17864/*"confirm_subscription_price_change"*/, v3);
    sub_1C3B764(&StringLiteral_17863/*"confidence"*/, v4);
    byte_4C1D202 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetNoticeOptionControl_OnGameNoticeChangeBtn__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1C3B77C(Method_SetNoticeOptionControl_OnGameNoticeChangeBtn__);
  v7 = (System_Reflection_MethodBase_o *)sub_1C3B748(v5, v5[4]);
  if ( !isGameNotice )
  {
    OverwriteAssetSoundName__PlaySystemSe(v7, 0, 0, 0LL);
...
void __fastcall SetNoticeOptionControl__OnRpNoticeChangeBtn(SetNoticeOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1D201 & 1) == 0 )
  {
    sub_1C3B764(&Method_SetNoticeOptionControl_OnRpNoticeChangeBtn__, method);
    sub_1C3B764(&StringLiteral_17864/*"confirm_subscription_price_change"*/, v3);
    sub_1C3B764(&StringLiteral_17863/*"confidence"*/, v4);
    byte_4C1D201 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetNoticeOptionControl_OnRpNoticeChangeBtn__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1C3B77C(Method_SetNoticeOptionControl_OnRpNoticeChangeBtn__);
  v7 = (System_Reflection_MethodBase_o *)sub_1C3B748(v5, v5[4]);
  if ( !isRpNotice )
  {
    OverwriteAssetSoundName__PlaySystemSe(v7, 0, 0, 0LL);
