...
void __fastcall SetNoticeOptionControl__Init(SetNoticeOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BAFA71 & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_9846/*"OPTION_FRIEND_COSTUME_DISP"*/, v4);
    sub_1C13D24(&StringLiteral_9845/*"OPTION_FIREND_DISP"*/, v5);
    sub_1C13D24(&StringLiteral_9848/*"OPTION_FRIEND_DISP_EXPLANATION"*/, v6);
    sub_1C13D24(&StringLiteral_9847/*"OPTION_FRIEND_COSTUME_DISP_EXPLANATION"*/, v7);
    byte_4BAFA71 = 1;
  }
  apNoticeTitle = this->fields.apNoticeTitle;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_9845/*"OPTION_FIREND_DISP"*/, 0LL);
  if ( !apNoticeTitle )
    goto LABEL_12;
  UILabel__set_text(apNoticeTitle, v9, 0LL);
  rpNoticeTitle = this->fields.rpNoticeTitle;
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_9847/*"OPTION_FRIEND_COSTUME_DISP_EXPLANATION"*/, 0LL);
  if ( !rpNoticeTitle
    || (UILabel__set_text(rpNoticeTitle, v9, 0LL),
        sysNoticeTitle = this->fields.sysNoticeTitle,
        v9 = LocalizationManager__Get((System_String_o *)StringLiteral_9846/*"OPTION_FRIEND_COSTUME_DISP"*/, 0LL),
        !sysNoticeTitle)
    || (UILabel__set_text(sysNoticeTitle, v9, 0LL),
        rpExplanationTxt = this->fields.rpExplanationTxt,
        v9 = LocalizationManager__Get((System_String_o *)StringLiteral_9848/*"OPTION_FRIEND_DISP_EXPLANATION"*/, 0LL),
        !rpExplanationTxt) )
  {
LABEL_12:
    sub_1C13F80(v9, v10);
...
void __fastcall SetNoticeOptionControl__OnApNoticeChangeBtn(SetNoticeOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BAFA76 & 1) == 0 )
  {
    sub_1C13D24(&Method_SetNoticeOptionControl_OnApNoticeChangeBtn__, method);
  ...
  if ( (*((_BYTE *)Method_SetNoticeOptionControl_OnApNoticeChangeBtn__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1C13D3C(Method_SetNoticeOptionControl_OnApNoticeChangeBtn__);
...
void __fastcall SetNoticeOptionControl__OnGameNoticeChangeBtn(SetNoticeOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BAFA78 & 1) == 0 )
  {
    sub_1C13D24(&Method_SetNoticeOptionControl_OnGameNoticeChangeBtn__, method);
    sub_1C13D24(&StringLiteral_17792/*"btn_getreward"*/, v3);
    sub_1C13D24(&StringLiteral_17791/*"btn_filter_on"*/, v4);
    byte_4BAFA78 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetNoticeOptionControl_OnGameNoticeChangeBtn__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1C13D3C(Method_SetNoticeOptionControl_OnGameNoticeChangeBtn__);
  v7 = (System_Reflection_MethodBase_o *)sub_1C13D08(v5, v5[4]);
  if ( !isGameNotice )
  {
    OverwriteAssetSoundName__PlaySystemSe(v7, 0, 0, 0LL);
...
void __fastcall SetNoticeOptionControl__OnRpNoticeChangeBtn(SetNoticeOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BAFA77 & 1) == 0 )
  {
    sub_1C13D24(&Method_SetNoticeOptionControl_OnRpNoticeChangeBtn__, method);
    sub_1C13D24(&StringLiteral_17792/*"btn_getreward"*/, v3);
    sub_1C13D24(&StringLiteral_17791/*"btn_filter_on"*/, v4);
    byte_4BAFA77 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetNoticeOptionControl_OnRpNoticeChangeBtn__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1C13D3C(Method_SetNoticeOptionControl_OnRpNoticeChangeBtn__);
  v7 = (System_Reflection_MethodBase_o *)sub_1C13D08(v5, v5[4]);
  if ( !isRpNotice )
  {
    OverwriteAssetSoundName__PlaySystemSe(v7, 0, 0, 0LL);
