...
void SetNoticeOptionControl__Init(SetNoticeOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596B596 & 1) == 0 )
  {
    ...
    sub_2213A60(&StringLiteral_10069/*"OPTION_NOTICE_ELSE"*/);
    sub_2213A60(&StringLiteral_10068/*"OPTION_NOTICE_AP"*/);
    sub_2213A60(&StringLiteral_10071/*"OPTION_NOTICE_RP_EXPLANATION"*/);
    sub_2213A60(&StringLiteral_10070/*"OPTION_NOTICE_RP"*/);
    byte_596B596 = 1;
  }
  apNoticeTitle = this->fields.apNoticeTitle;
  if ( !*(&LocalizationManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, method, v2);
  v5 = LocalizationManager__Get((System_String_o *)StringLiteral_10068/*"OPTION_NOTICE_AP"*/, 0);
  if ( !apNoticeTitle )
    goto LABEL_12;
  UILabel__set_text(apNoticeTitle, v5, 0);
  rpNoticeTitle = this->fields.rpNoticeTitle;
  v5 = LocalizationManager__Get((System_String_o *)StringLiteral_10070/*"OPTION_NOTICE_RP"*/, 0);
  if ( !rpNoticeTitle
    || (UILabel__set_text(rpNoticeTitle, v5, 0),
        sysNoticeTitle = this->fields.sysNoticeTitle,
        v5 = LocalizationManager__Get((System_String_o *)StringLiteral_10069/*"OPTION_NOTICE_ELSE"*/, 0),
        !sysNoticeTitle)
    || (UILabel__set_text(sysNoticeTitle, v5, 0),
        rpExplanationTxt = this->fields.rpExplanationTxt,
        v5 = LocalizationManager__Get((System_String_o *)StringLiteral_10071/*"OPTION_NOTICE_RP_EXPLANATION"*/, 0),
        !rpExplanationTxt) )
  {
LABEL_12:
    sub_2213CDC(v5, v6);
...
void SetNoticeOptionControl__OnApNoticeChangeBtn(SetNoticeOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596B59B & 1) == 0 )
  {
    sub_2213A60(&Method_SetNoticeOptionControl_OnApNoticeChangeBtn__);
  ...
  if ( !this->fields.isApNotice )
  {
    if ( (*((_BYTE *)Method_SetNoticeOptionControl_OnApNoticeChangeBtn__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_2213A78(Method_SetNoticeOptionControl_OnApNoticeChangeBtn__);
...
void SetNoticeOptionControl__OnGameNoticeChangeBtn(SetNoticeOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596B59D & 1) == 0 )
  {
    sub_2213A60(&Method_SetNoticeOptionControl_OnGameNoticeChangeBtn__);
    sub_2213A60(&StringLiteral_18275/*"btn_on"*/);
    sub_2213A60(&StringLiteral_18274/*"btn_off"*/);
    byte_596B59D = 1;
  }
  ...
  if ( !this->fields.isGameNotice )
  {
    if ( (*((_BYTE *)Method_SetNoticeOptionControl_OnGameNoticeChangeBtn__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_2213A78(Method_SetNoticeOptionControl_OnGameNoticeChangeBtn__);
    v9 = (System_Reflection_MethodBase_o *)sub_2213A44(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v9, 0, 0, 0);
...
void SetNoticeOptionControl__OnRpNoticeChangeBtn(SetNoticeOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596B59C & 1) == 0 )
  {
    sub_2213A60(&Method_SetNoticeOptionControl_OnRpNoticeChangeBtn__);
    sub_2213A60(&StringLiteral_18275/*"btn_on"*/);
    sub_2213A60(&StringLiteral_18274/*"btn_off"*/);
    byte_596B59C = 1;
  }
  ...
  if ( !this->fields.isRpNotice )
  {
    if ( (*((_BYTE *)Method_SetNoticeOptionControl_OnRpNoticeChangeBtn__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_2213A78(Method_SetNoticeOptionControl_OnRpNoticeChangeBtn__);
    v9 = (System_Reflection_MethodBase_o *)sub_2213A44(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v9, 0, 0, 0);
...
LABEL_9:
    sub_2213CDC(apNoticeBtn, method);
  }
  if ( !apNoticeBtn )
    goto LABEL_9;
...
LABEL_9:
    sub_2213CDC(sysNoticeBtn, method);
  }
  if ( !sysNoticeBtn )
    goto LABEL_9;
  v4 = &StringLiteral_18275/*"btn_on"*/;
...
LABEL_9:
    sub_2213CDC(rpNoticeBtn, method);
  }
  if ( !rpNoticeBtn )
    goto LABEL_9;
  v4 = &StringLiteral_18275/*"btn_on"*/;
