        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B039D9 & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_24257/*"usedTurnList"*/, v13);
    sub_1BC3008(&StringLiteral_18085/*"continueNum"*/, v14);
    sub_1BC3008(&StringLiteral_17997/*"commandSpellId"*/, v15);
    sub_1BC3008(&StringLiteral_16927/*"battleId"*/, v16);
    byte_4B039D9 = 1;
  }
  RequestBase__addField_43183652((RequestBase_o *)this, (System_String_o *)StringLiteral_16927/*"battleId"*/, battleId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_17997/*"commandSpellId"*/, commandSpellId, 0LL);
  RequestBase__addField_43193604(
    (RequestBase_o *)this,
    (System_String_o *)StringLiteral_24257/*"usedTurnList"*/,
    &usedTurnArray->obj,
    0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18085/*"continueNum"*/, continueCount, 0LL);
  if ( bt_continue )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B039D8 & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_9048/*"MockBattleCommandSpellRequest"*/, v2);
    byte_4B039D8 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  return NetworkManager__getMockFile((System_String_o *)StringLiteral_9048/*"MockBattleCommandSpellRequest"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BC3008(&NetworkManager_TypeInfo, method);
    sub_1BC3008(&StringLiteral_16904/*"battle/commandSpell"*/, v2);
    byte_4B039D7 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62348648(BaseUrl, (System_String_o *)StringLiteral_16904/*"battle/commandSpell"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( v7 && (v8 = v7, ResponseData__checkError_43184840(v7, 0LL)) && v8->fields.success )
    v9 = &StringLiteral_22163/*"ok"*/;
  else
    v9 = &StringLiteral_21997/*"ng"*/;
