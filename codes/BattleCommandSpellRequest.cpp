        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0A33D & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_24284/*"usedTurnList"*/, v13);
    sub_1B686D4(&StringLiteral_18178/*"continueNum"*/, v14);
    sub_1B686D4(&StringLiteral_18091/*"commandSpellId"*/, v15);
    sub_1B686D4(&StringLiteral_17048/*"battleId"*/, v16);
    byte_4A0A33D = 1;
  }
  RequestBase__addField_40919284((RequestBase_o *)this, (System_String_o *)StringLiteral_17048/*"battleId"*/, battleId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18091/*"commandSpellId"*/, commandSpellId, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0A33C & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_9062/*"MockBattleCommandSpellRequest"*/, v2);
    byte_4A0A33C = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  return NetworkManager__getMockFile((System_String_o *)StringLiteral_9062/*"MockBattleCommandSpellRequest"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B686D4(&NetworkManager_TypeInfo, method);
    sub_1B686D4(&StringLiteral_17026/*"battle/commandSpell"*/, v2);
    byte_4A0A33B = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61419468(BaseUrl, (System_String_o *)StringLiteral_17026/*"battle/commandSpell"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( v7 && (v8 = v7, ResponseData__checkError_40916448(v7, 0LL)) && v8->fields.success )
    v9 = &StringLiteral_22150/*"ok"*/;
  else
    v9 = &StringLiteral_21981/*"ng"*/;
