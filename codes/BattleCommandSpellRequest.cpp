        ...
        const MethodInfo *method)
{
  if ( (byte_4CF0074 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_18258/*"commandSpellId"*/);
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18258/*"commandSpellId"*/, commandSpellId, 0);
...
System_String_o *BattleCommandSpellRequest__getMockData(BattleCommandSpellRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C7BAE8(&NetworkManager_TypeInfo);
    sub_1C7BAE8(&StringLiteral_9154/*"MockBattleCommandSpellRequest"*/);
    byte_4CF0073 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  return NetworkManager__getMockFile((System_String_o *)StringLiteral_9154/*"MockBattleCommandSpellRequest"*/, 0);
}
...
System_String_o *BattleCommandSpellRequest__getURL(BattleCommandSpellRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C7BAE8(&NetworkManager_TypeInfo);
    sub_1C7BAE8(&StringLiteral_17134/*"battle/commandSpell"*/);
    byte_4CF0072 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64176912(BaseUrl, (System_String_o *)StringLiteral_17134/*"battle/commandSpell"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( v5 && (v6 = v5, ResponseData__checkError_44743216(v5, 0)) && v6->fields.success )
    v7 = &StringLiteral_22590/*"ok"*/;
  else
    v7 = &StringLiteral_22419/*"ng"*/;
