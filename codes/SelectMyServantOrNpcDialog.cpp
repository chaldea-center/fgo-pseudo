...
void __fastcall SelectMyServantOrNpcDialog__Close(SelectMyServantOrNpcDialog_o *this, const MethodInfo *method)
{
  ...
  SelectMyServantOrNpcDialog__Close_32102736(this, 0LL, v2);
}


void __fastcall SelectMyServantOrNpcDialog__Close_32102736(
        SelectMyServantOrNpcDialog_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA6D2 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_SelectMyServantOrNpcDialog_EndClose__, v6);
    byte_49FA6D2 = 1;
  }
...
void __fastcall SelectMyServantOrNpcDialog__OnClickCancel(SelectMyServantOrNpcDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA6D5 & 1) == 0 )
  {
    sub_1B64870(&Method_SelectMyServantOrNpcDialog_OnClickCancel__, method);
    byte_49FA6D5 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SelectMyServantOrNpcDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B64888(Method_SelectMyServantOrNpcDialog_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA6D3 & 1) == 0 )
  {
    sub_1B64870(&Method_SelectMyServantOrNpcDialog_OnClickMyServant__, method);
    byte_49FA6D3 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SelectMyServantOrNpcDialog_OnClickMyServant__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B64888(Method_SelectMyServantOrNpcDialog_OnClickMyServant__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B64854(v3, v3[4]);
...
void __fastcall SelectMyServantOrNpcDialog__OnClickNpc(SelectMyServantOrNpcDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA6D4 & 1) == 0 )
  {
    sub_1B64870(&Method_SelectMyServantOrNpcDialog_OnClickNpc__, method);
    byte_49FA6D4 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SelectMyServantOrNpcDialog_OnClickNpc__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B64888(Method_SelectMyServantOrNpcDialog_OnClickNpc__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B64854(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA6D1 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_SelectMyServantOrNpcDialog_EndOpen__, v15);
    sub_1B64870(&StringLiteral_10291/*"PARTY_ORGANIZATION_SERVANT_SELECT_MY_SERVANT_OR_SUPPORT_DIALOG_MESSAGE"*/, v16);
    sub_1B64870(&StringLiteral_3732/*"COMMON_CONFIRM_CANCEL"*/, v17);
    sub_1B64870(&StringLiteral_10288/*"PARTY_ORGANIZATION_SERVANT_SELECT_MY_SERVANT_OR_NPC_DAIALOG_MY_SERVANT_BUTTON"*/, v18);
    sub_1B64870(&StringLiteral_10287/*"PARTY_ORGANIZATION_SERVANT_SELECT_MY_SERVANT_OR_NPC_DAIALOG_MESSAGE"*/, v19);
    sub_1B64870(&StringLiteral_10289/*"PARTY_ORGANIZATION_SERVANT_SELECT_MY_SERVANT_OR_NPC_DAIALOG_NPC_BUTTON"*/, v20);
    sub_1B64870(&StringLiteral_10292/*"PARTY_ORGANIZATION_SERVANT_SELECT_MY_SERVANT_OR_SUPPORT_FREE_DIALOG_MESSAGE"*/, v21);
    sub_1B64870(&StringLiteral_10290/*"PARTY_ORGANIZATION_SERVANT_SELECT_MY_SERVANT_OR_NPC_DAIALOG_TITLE"*/, v22);
    byte_49FA6D1 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(titleLabel, 0LL, 0LL) )
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10290/*"PARTY_ORGANIZATION_SERVANT_SELECT_MY_SERVANT_OR_NPC_DAIALOG_TITLE"*/, 0LL);
    if ( !v28 )
      goto LABEL_46;
...
LABEL_16:
      if ( isNotIndividuality )
        v31 = &StringLiteral_10292/*"PARTY_ORGANIZATION_SERVANT_SELECT_MY_SERVANT_OR_SUPPORT_FREE_DIALOG_MESSAGE"*/;
      else
        v31 = &StringLiteral_10291/*"PARTY_ORGANIZATION_SERVANT_SELECT_MY_SERVANT_OR_SUPPORT_DIALOG_MESSAGE"*/;
  ...
  v32 = LocalizationManager__Get((System_String_o *)StringLiteral_10287/*"PARTY_ORGANIZATION_SERVANT_SELECT_MY_SERVANT_OR_NPC_DAIALOG_MESSAGE"*/, 0LL);
...
LABEL_24:
  ...
  if ( UnityEngine_Object__op_Inequality(myServantBtnLabel, 0LL, 0LL) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10288/*"PARTY_ORGANIZATION_SERVANT_SELECT_MY_SERVANT_OR_NPC_DAIALOG_MY_SERVANT_BUTTON"*/, 0LL);
    if ( !v36 )
      goto LABEL_46;
  ...
  if ( UnityEngine_Object__op_Inequality(npcBtnLabel, 0LL, 0LL) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10289/*"PARTY_ORGANIZATION_SERVANT_SELECT_MY_SERVANT_OR_NPC_DAIALOG_NPC_BUTTON"*/, 0LL);
    if ( v38 )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA6CE & 1) == 0 )
  {
    sub_1B64870(&SelectMyServantOrNpcDialog_CallbackFunc_TypeInfo, value);
    byte_49FA6CE = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  ...
  v11 = (SelectMyServantOrNpcDialog_o *)sub_1B64D8C(v8);
...
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19A7588;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA6D7 & 1) == 0 )
  {
    sub_1B64870(&SelectMyServantOrNpcDialog_ResultClicked_TypeInfo, *(_QWORD *)&result);
    byte_49FA6D7 = 1;
  }
  v9[1] = 0LL;
