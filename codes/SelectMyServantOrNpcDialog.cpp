...
void SelectMyServantOrNpcDialog__Close(SelectMyServantOrNpcDialog_o *this, const MethodInfo *method)
{
  ...
  SelectMyServantOrNpcDialog__Close_35117992(this, 0, v2);
}


void SelectMyServantOrNpcDialog__Close_35117992(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEA2D1 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_SelectMyServantOrNpcDialog_EndClose__);
    byte_4CEA2D1 = 1;
  }
...
void SelectMyServantOrNpcDialog__OnClickCancel(SelectMyServantOrNpcDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEA2D4 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_SelectMyServantOrNpcDialog_OnClickCancel__);
    byte_4CEA2D4 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SelectMyServantOrNpcDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C7BB00(Method_SelectMyServantOrNpcDialog_OnClickCancel__);
...
void SelectMyServantOrNpcDialog__OnClickMyServant(SelectMyServantOrNpcDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEA2D2 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_SelectMyServantOrNpcDialog_OnClickMyServant__);
    byte_4CEA2D2 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SelectMyServantOrNpcDialog_OnClickMyServant__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C7BB00(Method_SelectMyServantOrNpcDialog_OnClickMyServant__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C7BACC(v3, v3[4]);
...
void SelectMyServantOrNpcDialog__OnClickNpc(SelectMyServantOrNpcDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEA2D3 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_SelectMyServantOrNpcDialog_OnClickNpc__);
    byte_4CEA2D3 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SelectMyServantOrNpcDialog_OnClickNpc__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C7BB00(Method_SelectMyServantOrNpcDialog_OnClickNpc__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C7BACC(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEA2D0 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_SelectMyServantOrNpcDialog_EndOpen__);
    sub_1C7BAE8(&StringLiteral_10358/*"PARTY_ORGANIZATION_SERVANT_SELECT_MY_SERVANT_OR_SUPPORT_DIALOG_NOT_HAVE_GRAND_MESSAGE"*/);
    sub_1C7BAE8(&StringLiteral_10357/*"PARTY_ORGANIZATION_SERVANT_SELECT_MY_SERVANT_OR_SUPPORT_DIALOG_MESSAGE"*/);
    sub_1C7BAE8(&StringLiteral_3690/*"COMMON_CONFIRM_CANCEL"*/);
    sub_1C7BAE8(&StringLiteral_10354/*"PARTY_ORGANIZATION_SERVANT_SELECT_MY_SERVANT_OR_NPC_DAIALOG_MY_SERVANT_BUTTON"*/);
    sub_1C7BAE8(&StringLiteral_10353/*"PARTY_ORGANIZATION_SERVANT_SELECT_MY_SERVANT_OR_NPC_DAIALOG_MESSAGE"*/);
    sub_1C7BAE8(&StringLiteral_10355/*"PARTY_ORGANIZATION_SERVANT_SELECT_MY_SERVANT_OR_NPC_DAIALOG_NPC_BUTTON"*/);
    sub_1C7BAE8(&StringLiteral_10359/*"PARTY_ORGANIZATION_SERVANT_SELECT_MY_SERVANT_OR_SUPPORT_FREE_DIALOG_MESSAGE"*/);
    sub_1C7BAE8(&StringLiteral_10356/*"PARTY_ORGANIZATION_SERVANT_SELECT_MY_SERVANT_OR_NPC_DAIALOG_TITLE"*/);
    byte_4CEA2D0 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(titleLabel, 0, 0) )
  {
    ...
    if ( ((unsigned __int8)gameObject & 1) != 0 )
    {
      ...
      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10356/*"PARTY_ORGANIZATION_SERVANT_SELECT_MY_SERVANT_OR_NPC_DAIALOG_TITLE"*/, 0);
...
LABEL_19:
      if ( isNotIndividuality )
        v31 = &StringLiteral_10359/*"PARTY_ORGANIZATION_SERVANT_SELECT_MY_SERVANT_OR_SUPPORT_FREE_DIALOG_MESSAGE"*/;
      else
        v31 = &StringLiteral_10357/*"PARTY_ORGANIZATION_SERVANT_SELECT_MY_SERVANT_OR_SUPPORT_DIALOG_MESSAGE"*/;
  ...
  v32 = LocalizationManager__Get((System_String_o *)StringLiteral_10353/*"PARTY_ORGANIZATION_SERVANT_SELECT_MY_SERVANT_OR_NPC_DAIALOG_MESSAGE"*/, 0);
...
LABEL_29:
  ...
  if ( isGrandRestriction && !haveCanOrganizationServant )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v35 = LocalizationManager__Get((System_String_o *)StringLiteral_10358/*"PARTY_ORGANIZATION_SERVANT_SELECT_MY_SERVANT_OR_SUPPORT_DIALOG_NOT_HAVE_GRAND_MESSAGE"*/, 0);
    v36 = System_String__Concat_64176912(mText, v35, 0);
...
LABEL_35:
  ...
  if ( UnityEngine_Object__op_Inequality(myServantBtnLabel, 0, 0) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10354/*"PARTY_ORGANIZATION_SERVANT_SELECT_MY_SERVANT_OR_NPC_DAIALOG_MY_SERVANT_BUTTON"*/, 0);
    if ( !v40 )
      goto LABEL_74;
  ...
  if ( UnityEngine_Object__op_Inequality(npcBtnLabel, 0, 0) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10355/*"PARTY_ORGANIZATION_SERVANT_SELECT_MY_SERVANT_OR_NPC_DAIALOG_NPC_BUTTON"*/, 0);
    if ( !v42 )
      goto LABEL_74;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEA2CD & 1) == 0 )
  {
    sub_1C7BAE8(&SelectMyServantOrNpcDialog_CallbackFunc_TypeInfo);
    byte_4CEA2CD = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  ...
  v11 = (SelectMyServantOrNpcDialog_o *)sub_1C7C0DC(v8);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1AABF84;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1AABF3C;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEA2D6 & 1) == 0 )
  {
    sub_1C7BAE8(&SelectMyServantOrNpcDialog_ResultClicked_TypeInfo);
    byte_4CEA2D6 = 1;
  }
  v9[1] = 0;
