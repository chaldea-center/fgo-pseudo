...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK___Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_2FADF34 *method)
{
  long double v2; // q0
  _QWORD *monitor; // x20
  ...
  if ( *(int *)(*v5 + 40) >= 0 )
    ...
    v11 = (__int64 *)klass;
  sub_1C228A0(v6, v5[1], (int)v9, v11);
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK___Il2CppFullySharedGenericType____Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_2FAE340 *method)
{
  Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_c *klass; // x19
  void **monitor; // x22
  ...
  __int64 v19[3]; // [xsp+18h] [xbp-28h] BYREF
  ...
  if ( !v6 )
  {
    sub_1C21E38(&Cysharp_Text_ZString_TypeInfo);
  ...
  if ( (*(_DWORD *)(v6[1] + 40LL) & 0x80000000) == 0 )
    v10 = (_QWORD *)*v10;
  v19[0] = StringLiteral_25520/*"{0}:{1}"*/;
  v19[1] = (__int64)v9;
  v19[2] = (__int64)v10;
  ((void (__fastcall *)(__int64, __int64 *, _QWORD, __int64 *, __int64 *))v13[2])(v14, v13, 0LL, v19, v20);
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK___Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_2FAE79C *method)
{
  _QWORD *monitor; // x19
  ...
  __int64 v25[4]; // [xsp+20h] [xbp-30h] BYREF
  __int64 v26[2]; // [xsp+40h] [xbp-10h] BYREF
  ...
  {
    sub_1C21E38(&Cysharp_Text_ZString_TypeInfo);
    sub_1C21E38(&StringLiteral_25525/*"{0}:{1}:{2}"*/);
    v7 = (_QWORD *)monitor[7];
    if ( !v7 )
    {
      sub_1C73D70();
  ...
  if ( (*(_DWORD *)(v7[2] + 40LL) & 0x80000000) == 0 )
    v14 = (_QWORD *)*v14;
  v25[0] = StringLiteral_25525/*"{0}:{1}:{2}"*/;
  v25[1] = (__int64)v12;
  v25[2] = (__int64)v13;
  v25[3] = (__int64)v14;
  ((void (__fastcall *)(__int64, __int64 *, _QWORD, __int64 *, __int64 *))v18[2])(v19, v18, 0LL, v25, v26);
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK___Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_2FAEBE8 *method)
{
  Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_c *klass; // x19
  void **monitor; // x26
  ...
  __int64 v36[5]; // [xsp+48h] [xbp-38h] BYREF
  __int64 v37[2]; // [xsp+70h] [xbp-10h] BYREF
  ...
  {
    sub_1C21E38(&Cysharp_Text_ZString_TypeInfo);
    sub_1C21E38(&StringLiteral_25527/*"{0}:{1}:{2}:{3}"*/);
  ...
  if ( (*(_DWORD *)(v8[3] + 40LL) & 0x80000000) == 0 )
    v20 = (_QWORD *)*v20;
  v36[0] = StringLiteral_25527/*"{0}:{1}:{2}:{3}"*/;
  v36[1] = (__int64)v17;
  v36[2] = (__int64)v18;
  v36[3] = (__int64)v19;
  v36[4] = (__int64)v20;
  ((void (__fastcall *)(__int64, __int64 *, _QWORD, __int64 *, __int64 *))v25[2])(v26, v25, 0LL, v36, v37);
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK___Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_2FAF024 *method)
{
  _QWORD *monitor; // x19
  _QWORD *v7; // x22
  ...
  __int64 v43[6]; // [xsp+60h] [xbp-40h] BYREF
  __int64 v44[2]; // [xsp+90h] [xbp-10h] BYREF
  ...
  if ( !v7 )
  {
    v8 = arg1.klass;
    sub_1C21E38(&Cysharp_Text_ZString_TypeInfo);
    sub_1C21E38(&StringLiteral_25528/*"{0}:{1}:{2}:{3}:{4}"*/);
    v7 = (_QWORD *)monitor[7];
    arg1.klass = v8;
    if ( !v7 )
    {
  ...
  if ( (*(_DWORD *)(v7[4] + 40LL) & 0x80000000) == 0 )
    v23 = (_QWORD *)*v23;
  v43[0] = StringLiteral_25528/*"{0}:{1}:{2}:{3}:{4}"*/;
  v43[1] = (__int64)v19;
  v43[2] = (__int64)v20;
  v43[3] = (__int64)v21;
  v43[4] = (__int64)v22;
  v43[5] = (__int64)v23;
  ((void (__fastcall *)(__int64, __int64 *, _QWORD, __int64 *, __int64 *))v29[2])(v30, v29, 0LL, v43, v44);
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK___Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_2FAF370 *method)
{
  Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_c *klass; // x19
  ...
  __int64 v53[7]; // [xsp+80h] [xbp-50h] BYREF
  __int64 v54[3]; // [xsp+B8h] [xbp-18h] BYREF
  ...
  if ( !v9 )
  {
    v10 = arg1.klass;
    sub_1C21E38(&Cysharp_Text_ZString_TypeInfo);
    sub_1C21E38(&StringLiteral_25529/*"{0}:{1}:{2}:{3}:{4}:{5}"*/);
  ...
  if ( (*(_DWORD *)(v9[5] + 40LL) & 0x80000000) == 0 )
    v25 = (_QWORD *)*v25;
  v53[0] = StringLiteral_25529/*"{0}:{1}:{2}:{3}:{4}:{5}"*/;
  v53[1] = (__int64)v34;
  v53[2] = (__int64)v35;
  v53[3] = (__int64)v22;
  v53[4] = (__int64)v23;
  v53[5] = (__int64)v24;
  v53[6] = (__int64)v25;
  ((void (__fastcall *)(__int64, __int64 *, _QWORD, __int64 *, __int64 *))v36[2])(v37, v36, 0LL, v53, v54);
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK___Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_2FAF678 *method)
{
  _QWORD *monitor; // x19
  ...
  __int64 *v38; // x1
  __int64 v39; // x0
  __int64 v41; // [xsp+0h] [xbp-F0h] BYREF
  __int64 v42; // [xsp+8h] [xbp-E8h]
  __int64 v43; // [xsp+10h] [xbp-E0h]
  ...
  __int64 v58[8]; // [xsp+98h] [xbp-58h] BYREF
  __int64 v59[3]; // [xsp+D8h] [xbp-18h] BYREF
  ...
  if ( !v10 )
  {
    v11 = arg1.klass;
    sub_1C21E38(&Cysharp_Text_ZString_TypeInfo);
    sub_1C21E38(&StringLiteral_25530/*"{0}:{1}:{2}:{3}:{4}:{5}:{6}"*/);
  ...
  v42 = v16;
  v43 = v17;
  v20 = (__int64 *)((char *)&v41 - ((v19 + 15) & 0x1FFFFFFF0LL));
  v21 = (__int64 *)((char *)&v41 - ((v14 + 15) & 0x1FFFFFFF0LL));
  v22 = (__int64 *)((char *)&v41 - ((v15 + 15) & 0x1FFFFFFF0LL));
  v23 = (__int64 *)((char *)&v41 - ((v16 + 15) & 0x1FFFFFFF0LL));
  v24 = (__int64 *)((char *)&v41 - ((v17 + 15) & 0x1FFFFFFF0LL));
  LODWORD(v12) = *(_DWORD *)(v12 + 40);
  v49 = (__int64 *)((char *)&v41 - ((v13 + 15) & 0x1FFFFFFF0LL));
  if ( (int)v12 >= 0 )
    v25 = &v57;
  else
  ...
  if ( (*(_DWORD *)(v35[6] + 40LL) & 0x80000000) == 0 )
    v24 = (_QWORD *)*v24;
  v58[0] = StringLiteral_25530/*"{0}:{1}:{2}:{3}:{4}:{5}:{6}"*/;
  v58[1] = (__int64)v36;
  v58[2] = (__int64)v37;
  v58[3] = (__int64)v20;
  v58[4] = (__int64)v21;
  ...
  v58[6] = (__int64)v23;
  v58[7] = (__int64)v24;
  ((void (__fastcall *)(__int64, __int64 *, _QWORD, __int64 *, __int64 *, long double))v38[2])(
    v39,
    v38,
    0LL,
    v58,
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK___Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_2FAF9DC *method)
{
  ...
  __int64 v47; // [xsp+8h] [xbp-118h]
  __int64 v48; // [xsp+10h] [xbp-110h]
  __int64 v49; // [xsp+18h] [xbp-108h]
  __int64 v50; // [xsp+20h] [xbp-100h]
  __int64 v51; // [xsp+28h] [xbp-F8h]
  ...
  __int64 v67[9]; // [xsp+C0h] [xbp-60h] BYREF
  __int64 v68[2]; // [xsp+108h] [xbp-18h] BYREF
  ...
  if ( !v10 )
  {
    v11 = arg1.klass;
    sub_1C21E38(&Cysharp_Text_ZString_TypeInfo);
    sub_1C21E38(&StringLiteral_25531/*"{0}:{1}:{2}:{3}:{4}:{5}:{6}:{7}"*/);
    v10 = *(_QWORD **)&arg5.klass->_1.this_arg.bits;
    klass = v11;
    if ( !v10 )
    {
  ...
  if ( (*(_DWORD *)(v40[7] + 40LL) & 0x80000000) == 0 )
    v28 = (_QWORD *)*v28;
  v67[0] = StringLiteral_25531/*"{0}:{1}:{2}:{3}:{4}:{5}:{6}:{7}"*/;
  v67[1] = (__int64)v41;
  v67[2] = (__int64)v42;
  v67[3] = (__int64)v23;
  v67[4] = (__int64)v24;
  ...
  v67[7] = (__int64)v27;
  v67[8] = (__int64)v28;
  ((void (__fastcall *)(__int64, __int64 *, _QWORD, __int64 *, __int64 *, long double))v43[2])(
    v44,
    v43,
    0LL,
    v67,
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_int_(int32_t arg1, const MethodInfo_2FADEBC *method)
{
  const MethodInfo_2FADEBC_RGCTXs *rgctx_data; // x8
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_int__int_(
        int32_t arg1,
        int32_t arg2,
        const MethodInfo_2FAE028 *method)
{
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_int__int__int_(
        ...
        int32_t arg2,
        int32_t arg3,
        const MethodInfo_2FAE4B8 *method)
{
  if ( !method->rgctx_data )
  {
    sub_1C21E38(&Cysharp_Text_ZString_TypeInfo);
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_int__int__int__int_(
        ...
        int32_t arg3,
        int32_t arg4,
        const MethodInfo_2FAE978 *method)
{
  if ( !method->rgctx_data )
  {
    sub_1C21E38(&Cysharp_Text_ZString_TypeInfo);
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_int__int__int__int__int_(
        ...
        int32_t arg4,
        int32_t arg5,
        const MethodInfo_2FAEE20 *method)
{
  if ( !method->rgctx_data )
  {
    sub_1C21E38(&Cysharp_Text_ZString_TypeInfo);
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_int__int__int__int__long_(
        ...
        int32_t arg4,
        int64_t arg5,
        const MethodInfo_2FAEECC *method)
{
  if ( !method->rgctx_data )
  {
    sub_1C21E38(&Cysharp_Text_ZString_TypeInfo);
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_int__int__int__long_(
        ...
        int32_t arg3,
        int64_t arg4,
        const MethodInfo_2FAEA14 *method)
{
  if ( !method->rgctx_data )
  {
    sub_1C21E38(&Cysharp_Text_ZString_TypeInfo);
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_int__int__int__object__int_(
        ...
        Il2CppObject *arg4,
        int32_t arg5,
        const MethodInfo_2FAEF78 *method)
{
  if ( !method->rgctx_data )
  {
    sub_1C21E38(&Cysharp_Text_ZString_TypeInfo);
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_int__int__long_(
        ...
        int32_t arg2,
        int64_t arg3,
        const MethodInfo_2FAE54C *method)
{
  if ( !method->rgctx_data )
  {
    sub_1C21E38(&Cysharp_Text_ZString_TypeInfo);
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_int__int__object_(
        ...
        int32_t arg2,
        Il2CppObject *arg3,
        const MethodInfo_2FAE5E0 *method)
{
  if ( !method->rgctx_data )
  {
    sub_1C21E38(&Cysharp_Text_ZString_TypeInfo);
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_int__long_(
        int32_t arg1,
        int64_t arg2,
        const MethodInfo_2FAE0AC *method)
{
  if ( !method->rgctx_data )
  {
    sub_1C21E38(&Cysharp_Text_ZString_TypeInfo);
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_long_(int64_t arg1, const MethodInfo_2FADEF8 *method)
{
  const MethodInfo_2FADEF8_RGCTXs *rgctx_data; // x8
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_long__int_(
        int64_t arg1,
        int32_t arg2,
        const MethodInfo_2FAE130 *method)
{
  if ( !method->rgctx_data )
  {
    sub_1C21E38(&Cysharp_Text_ZString_TypeInfo);
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_long__int__int_(
        ...
        int32_t arg2,
        int32_t arg3,
        const MethodInfo_2FAE674 *method)
{
  if ( !method->rgctx_data )
  {
    sub_1C21E38(&Cysharp_Text_ZString_TypeInfo);
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_long__int__int__int_(
        ...
        int32_t arg3,
        int32_t arg4,
        const MethodInfo_2FAEAB0 *method)
{
  if ( !method->rgctx_data )
  {
    sub_1C21E38(&Cysharp_Text_ZString_TypeInfo);
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_long__long_(
        int64_t arg1,
        int64_t arg2,
        const MethodInfo_2FAE1B4 *method)
{
  if ( !method->rgctx_data )
  {
    sub_1C21E38(&Cysharp_Text_ZString_TypeInfo);
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_long__long__object_(
        ...
        int64_t arg2,
        Il2CppObject *arg3,
        const MethodInfo_2FAE708 *method)
{
  if ( !method->rgctx_data )
  {
    sub_1C21E38(&Cysharp_Text_ZString_TypeInfo);
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_long__long__object__long_(
        ...
        Il2CppObject *arg3,
        int64_t arg4,
        const MethodInfo_2FAEB4C *method)
{
  if ( !method->rgctx_data )
  {
    sub_1C21E38(&Cysharp_Text_ZString_TypeInfo);
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_long__long__object__long__long__long_(
        ...
        int64_t arg5,
        int64_t arg6,
        const MethodInfo_2FAF2BC *method)
{
  if ( !method->rgctx_data )
  {
    sub_1C21E38(&Cysharp_Text_ZString_TypeInfo);
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_object__int_(
        Il2CppObject *arg1,
        int32_t arg2,
        const MethodInfo_2FAE238 *method)
{
  if ( !method->rgctx_data )
  {
    sub_1C21E38(&Cysharp_Text_ZString_TypeInfo);
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_object__long_(
        Il2CppObject *arg1,
        int64_t arg2,
        const MethodInfo_2FAE2BC *method)
{
  if ( !method->rgctx_data )
  {
    sub_1C21E38(&Cysharp_Text_ZString_TypeInfo);
