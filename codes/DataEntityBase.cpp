...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK___Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_2EFFBB8 *method)
{
  long double v2; // q0
  _QWORD *monitor; // x20
  ...
  if ( *(int *)(*v5 + 40) >= 0 )
    ...
    v11 = (__int64 *)klass;
  sub_1B4D9F8(v6, v5[1], (int)v9, v11);
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK___Il2CppFullySharedGenericType____Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_2EFFFC4 *method)
{
  Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_c *klass; // x19
  void **monitor; // x22
  ...
  if ( !v6 )
  {
    sub_1B4CF90(&Cysharp_Text_ZString_TypeInfo, arg1.monitor);
    sub_1B4CF90(&StringLiteral_24780/*"{0}:{1}"*/, v7);
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK___Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_2F00420 *method)
{
  _QWORD *monitor; // x19
  ...
  {
    sub_1B4CF90(&Cysharp_Text_ZString_TypeInfo, arg1.monitor);
    sub_1B4CF90(&StringLiteral_24785/*"{0}:{1}:{2}"*/, v9);
    v7 = (_QWORD *)monitor[7];
    if ( !v7 )
    {
      sub_1B9D67C();
  ...
  if ( (*(_DWORD *)(v7[2] + 40LL) & 0x80000000) == 0 )
    v15 = (_QWORD *)*v15;
  v26[0] = StringLiteral_24785/*"{0}:{1}:{2}"*/;
  v26[1] = (__int64)v13;
  v26[2] = (__int64)v14;
  v26[3] = (__int64)v15;
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK___Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_2F00908 *method)
{
  Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_c *klass; // x19
  void **monitor; // x26
  ...
  {
    sub_1B4CF90(&Cysharp_Text_ZString_TypeInfo, arg1.monitor);
    sub_1B4CF90(&StringLiteral_24787/*"{0}:{1}:{2}:{3}"*/, v9);
  ...
  if ( (*(_DWORD *)(v8[3] + 40LL) & 0x80000000) == 0 )
    v21 = (_QWORD *)*v21;
  v37[0] = StringLiteral_24787/*"{0}:{1}:{2}:{3}"*/;
  v37[1] = (__int64)v18;
  v37[2] = (__int64)v19;
  v37[3] = (__int64)v20;
  v37[4] = (__int64)v21;
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK___Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_2F00D44 *method)
{
  _QWORD *monitor; // x19
  _QWORD *v7; // x22
  ...
  if ( !v7 )
  {
    v8 = arg1.klass;
    sub_1B4CF90(&Cysharp_Text_ZString_TypeInfo, arg1.monitor);
    sub_1B4CF90(&StringLiteral_24788/*"{0}:{1}:{2}:{3}:{4}"*/, v9);
    v7 = (_QWORD *)monitor[7];
    arg1.klass = v8;
    if ( !v7 )
    {
  ...
  if ( (*(_DWORD *)(v7[4] + 40LL) & 0x80000000) == 0 )
    v24 = (_QWORD *)*v24;
  v44[0] = StringLiteral_24788/*"{0}:{1}:{2}:{3}:{4}"*/;
  v44[1] = (__int64)v20;
  v44[2] = (__int64)v21;
  v44[3] = (__int64)v22;
  v44[4] = (__int64)v23;
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK___Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_2F01090 *method)
{
  Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_c *klass; // x19
  ...
  if ( !v9 )
  {
    v10 = arg1.klass;
    sub_1B4CF90(&Cysharp_Text_ZString_TypeInfo, arg1.monitor);
    sub_1B4CF90(&StringLiteral_24789/*"{0}:{1}:{2}:{3}:{4}:{5}"*/, v11);
  ...
  if ( (*(_DWORD *)(v9[5] + 40LL) & 0x80000000) == 0 )
    v26 = (_QWORD *)*v26;
  v54[0] = StringLiteral_24789/*"{0}:{1}:{2}:{3}:{4}:{5}"*/;
  v54[1] = (__int64)v35;
  v54[2] = (__int64)v36;
  v54[3] = (__int64)v23;
  v54[4] = (__int64)v24;
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK___Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_2F01398 *method)
{
  _QWORD *monitor; // x19
  ...
  if ( !v10 )
  {
    v11 = arg1.klass;
    sub_1B4CF90(&Cysharp_Text_ZString_TypeInfo, arg1.monitor);
    sub_1B4CF90(&StringLiteral_24790/*"{0}:{1}:{2}:{3}:{4}:{5}:{6}"*/, v12);
  ...
  if ( (*(_DWORD *)(v36[6] + 40LL) & 0x80000000) == 0 )
    v25 = (_QWORD *)*v25;
  v59[0] = StringLiteral_24790/*"{0}:{1}:{2}:{3}:{4}:{5}:{6}"*/;
  v59[1] = (__int64)v37;
  v59[2] = (__int64)v38;
  v59[3] = (__int64)v21;
  v59[4] = (__int64)v22;
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK___Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType____Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_2F016FC *method)
{
  ...
  if ( !v10 )
  {
    v11 = arg1.klass;
    sub_1B4CF90(&Cysharp_Text_ZString_TypeInfo, arg1.monitor);
    sub_1B4CF90(&StringLiteral_24791/*"{0}:{1}:{2}:{3}:{4}:{5}:{6}:{7}"*/, v12);
    v10 = *(_QWORD **)&arg5.klass->_1.this_arg.bits;
    klass = v11;
    if ( !v10 )
    {
  ...
  if ( (*(_DWORD *)(v41[7] + 40LL) & 0x80000000) == 0 )
    v29 = (_QWORD *)*v29;
  v68[0] = StringLiteral_24791/*"{0}:{1}:{2}:{3}:{4}:{5}:{6}:{7}"*/;
  v68[1] = (__int64)v42;
  v68[2] = (__int64)v43;
  v68[3] = (__int64)v24;
  v68[4] = (__int64)v25;
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_int_(int32_t arg1, const MethodInfo_2EFFB40 *method)
{
  const MethodInfo_2EFFB40_RGCTXs *rgctx_data; // x8
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_int__int_(
        int32_t arg1,
        int32_t arg2,
        const MethodInfo_2EFFCAC *method)
{
  __int64 v6; // x1

  if ( !method->rgctx_data )
  {
    sub_1B4CF90(&Cysharp_Text_ZString_TypeInfo, *(_QWORD *)&arg2);
    sub_1B4CF90(&StringLiteral_24780/*"{0}:{1}"*/, v6);
    if ( !method->rgctx_data )
      sub_1B9D67C();
  }
  if ( !Cysharp_Text_ZString_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(Cysharp_Text_ZString_TypeInfo);
  return (System_String_o *)sub_2F098B0(
                              StringLiteral_24780/*"{0}:{1}"*/,
                              (unsigned int)arg1,
                              (unsigned int)arg2,
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_int__int__int_(
        ...
        int32_t arg2,
        int32_t arg3,
        const MethodInfo_2F0013C *method)
{
  __int64 v5; // x1
  ...
  {
    sub_1B4CF90(&Cysharp_Text_ZString_TypeInfo, *(_QWORD *)&arg2);
    sub_1B4CF90(&StringLiteral_24785/*"{0}:{1}:{2}"*/, v5);
    if ( !method->rgctx_data )
      sub_1B9D67C();
  }
  if ( !Cysharp_Text_ZString_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo_2F005FC *method)
{
  ...
  {
    sub_1B4CF90(&Cysharp_Text_ZString_TypeInfo, *(_QWORD *)&arg2);
    sub_1B4CF90(&StringLiteral_24787/*"{0}:{1}:{2}:{3}"*/, v6);
    if ( !method->rgctx_data )
      sub_1B9D67C();
  }
  if ( !Cysharp_Text_ZString_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo_2F00B40 *method)
{
  ...
  {
    sub_1B4CF90(&Cysharp_Text_ZString_TypeInfo, *(_QWORD *)&arg2);
    sub_1B4CF90(&StringLiteral_24788/*"{0}:{1}:{2}:{3}:{4}"*/, v7);
    if ( !method->rgctx_data )
      sub_1B9D67C();
  }
  if ( !Cysharp_Text_ZString_TypeInfo->_2.cctor_finished )
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_int__int__int__int__long_(
        ...
        int32_t arg4,
        int64_t arg5,
        const MethodInfo_2F00BEC *method)
{
  __int64 v7; // x1
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_int__int__int__long_(
        ...
        int32_t arg3,
        int64_t arg4,
        const MethodInfo_2F00698 *method)
{
  __int64 v6; // x1
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_int__int__int__object__int_(
        ...
        Il2CppObject *arg4,
        int32_t arg5,
        const MethodInfo_2F00C98 *method)
{
  __int64 v7; // x1
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_int__int__long_(
        ...
        int32_t arg2,
        int64_t arg3,
        const MethodInfo_2F001D0 *method)
{
  __int64 v5; // x1
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_int__int__object_(
        ...
        int32_t arg2,
        Il2CppObject *arg3,
        const MethodInfo_2F00264 *method)
{
  __int64 v5; // x1
...
// local variable allocation has failed, the output may be wrong!
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_int__int__object__object_(
        int32_t arg1,
        int32_t arg2,
        Il2CppObject *arg3,
        Il2CppObject *arg4,
        const MethodInfo_2F00734 *method)
{
  __int64 v6; // x1
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_int__long_(
        int32_t arg1,
        int64_t arg2,
        const MethodInfo_2EFFD30 *method)
{
  __int64 v4; // x1

  if ( !method->rgctx_data )
  {
    sub_1B4CF90(&Cysharp_Text_ZString_TypeInfo, arg2);
    sub_1B4CF90(&StringLiteral_24780/*"{0}:{1}"*/, v4);
    if ( !method->rgctx_data )
      sub_1B9D67C();
  }
  if ( !Cysharp_Text_ZString_TypeInfo->_2.cctor_finished )
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_long_(int64_t arg1, const MethodInfo_2EFFB7C *method)
{
  const MethodInfo_2EFFB7C_RGCTXs *rgctx_data; // x8
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_long__int_(
        int64_t arg1,
        int32_t arg2,
        const MethodInfo_2EFFDB4 *method)
{
  __int64 v4; // x1
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_long__int__int_(
        ...
        int32_t arg2,
        int32_t arg3,
        const MethodInfo_2F002F8 *method)
{
  __int64 v5; // x1
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_long__int__int__int_(
        ...
        int32_t arg3,
        int32_t arg4,
        const MethodInfo_2F007D0 *method)
{
  __int64 v6; // x1
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_long__long_(
        int64_t arg1,
        int64_t arg2,
        const MethodInfo_2EFFE38 *method)
{
  __int64 v4; // x1
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_long__long__object_(
        ...
        int64_t arg2,
        Il2CppObject *arg3,
        const MethodInfo_2F0038C *method)
{
  __int64 v5; // x1
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_long__long__object__long_(
        ...
        Il2CppObject *arg3,
        int64_t arg4,
        const MethodInfo_2F0086C *method)
{
  __int64 v6; // x1
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_long__long__object__long__long__long_(
        ...
        int64_t arg5,
        int64_t arg6,
        const MethodInfo_2F00FDC *method)
{
  __int64 v8; // x1
  ...
  {
    sub_1B4CF90(&Cysharp_Text_ZString_TypeInfo, arg2);
    sub_1B4CF90(&StringLiteral_24789/*"{0}:{1}:{2}:{3}:{4}:{5}"*/, v8);
    if ( !method->rgctx_data )
      sub_1B9D67C();
  }
  if ( !Cysharp_Text_ZString_TypeInfo->_2.cctor_finished )
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_object__int_(
        Il2CppObject *arg1,
        int32_t arg2,
        const MethodInfo_2EFFEBC *method)
{
  __int64 v4; // x1
...
System_String_o *__fastcall DataEntityBase__CreateMultiplePK_object__long_(
        Il2CppObject *arg1,
        int64_t arg2,
        const MethodInfo_2EFFF40 *method)
{
  __int64 v4; // x1
