void __fastcall CriWareInitializer___ctor(CriWareInitializer_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC1F2D & 1) == 0 )
  {
    sub_1C1ABD4(&CriAtomConfig_TypeInfo, method);
    sub_1C1ABD4(&CriFsConfig_TypeInfo, v3);
    sub_1C1ABD4(&CriManaConfig_TypeInfo, v4);
    sub_1C1ABD4(&CriWareDecrypterConfig_TypeInfo, v5);
    byte_4BC1F2D = 1;
  }
  this->fields.initializesFileSystem = 1;
  v6 = (CriFsConfig_o *)sub_1C1AE20(CriFsConfig_TypeInfo);
  CriFsConfig___ctor(v6, v7);
  this->fields.fileSystemConfig = v6;
  sub_1C1AB78(&this->fields.fileSystemConfig);
  this->fields.initializesAtom = 1;
  v8 = (CriAtomConfig_o *)sub_1C1AE20(CriAtomConfig_TypeInfo);
  CriAtomConfig___ctor(v8, v9);
  this->fields.atomConfig = v8;
  sub_1C1AB78(&this->fields.atomConfig);
  this->fields.initializesMana = 1;
  v10 = (CriManaConfig_o *)sub_1C1AE20(CriManaConfig_TypeInfo);
  CriManaConfig___ctor(v10, v11);
  this->fields.manaConfig = v10;
  sub_1C1AB78(&this->fields.manaConfig);
  v12 = (CriWareDecrypterConfig_o *)sub_1C1AE20(CriWareDecrypterConfig_TypeInfo);
  CriWareDecrypterConfig___ctor(v12, v13);
  this->fields.decrypterConfig = v12;
  sub_1C1AB78(&this->fields.decrypterConfig);
...
void __fastcall CriWareInitializer__AddAudioEffectInterface(intptr_t effect_interface, const MethodInfo *method)
{
  ...
  if ( (byte_4BC1F29 & 1) == 0 )
  {
    sub_1C1ABD4(&CriAtomPlugin_TypeInfo, method);
    sub_1C1ABD4(&Method_System_Collections_Generic_List_IntPtr__Add__, v3);
    byte_4BC1F29 = 1;
  }
  ...
  if ( CriAtomPlugin__GetAudioEffectInterfaceList(&effect_interface_list, 0LL) )
  {
    ...
    if ( (unsigned int)size >= items->max_length )
    {
      System_Collections_Generic_List_IntPtr___AddWithResize(
        v5,
        v2,
        *(const MethodInfo_36270F0 **)(*(_QWORD *)(v7[4] + 192LL) + 112LL));
    }
    else
    {
...
void __fastcall CriWareInitializer__Initialize(CriWareInitializer_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C1ABD4(&CriAtomPlugin_TypeInfo, method);
    sub_1C1ABD4(&CriFsPlugin_TypeInfo, v3);
    sub_1C1ABD4(&CriManaPlugin_TypeInfo, v4);
    sub_1C1ABD4(&CriWareInitializer_TypeInfo, v5);
    sub_1C1ABD4(&UnityEngine_Debug_TypeInfo, v6);
...
LABEL_76:
  ...
  if ( this->fields.useDecrypter )
    ...
    CriWareDecrypter__Initialize_30748876(
...
LABEL_73:
    sub_1C1AE30(IsLibraryInitialized, v15);
  }
}
...
bool __fastcall CriWareInitializer__InitializeAtom(CriAtomConfig_o *config, const MethodInfo *method)
{
  ...
  if ( (byte_4BC1F2B & 1) == 0 )
  {
    sub_1C1ABD4(&CriAtomEx_TypeInfo, method);
    sub_1C1ABD4(&CriAtomPlugin_TypeInfo, v3);
    sub_1C1ABD4(&CriAtomServer_TypeInfo, v4);
    sub_1C1ABD4(&System_DateTime_TypeInfo, v5);
    sub_1C1ABD4(&System_Math_TypeInfo, v6);
    sub_1C1ABD4(&System_IO_Path_TypeInfo, v7);
    byte_4BC1F2B = 1;
  }
  dateData = 0LL;
  if ( !CriAtomPlugin_TypeInfo->_2.cctor_finished )
  ...
  if ( ((unsigned __int8)IsLibraryInitialized & 1) == 0 )
  {
    ...
    IsLibraryInitialized = (CriAtomEx_c *)System_Math__Max_63859512(maxVirtualVoices, RequiredMaxVirtualVoices, 0LL);
    ...
    v18 = System_Math__Max_63859512(config->fields.iosBufferingTime, 16, 0LL);
    ...
    if ( !acfFileName )
LABEL_54:
      sub_1C1AE30(IsLibraryInitialized, v9);
...
bool __fastcall CriWareInitializer__InitializeFileSystem(CriFsConfig_o *config, const MethodInfo *method)
{
  ...
  if ( (byte_4BC1F2A & 1) == 0 )
  {
    sub_1C1ABD4(&CriFsPlugin_TypeInfo, method);
    byte_4BC1F2A = 1;
  }
  inited = CriFsPlugin_TypeInfo;
  if ( !CriFsPlugin_TypeInfo->_2.cctor_finished )
  ...
  if ( ((unsigned __int8)IsLibraryInitialized & 1) == 0 )
  {
    ...
    if ( !IsLibraryInitialized )
LABEL_17:
      sub_1C1AE30(IsLibraryInitialized, v5);
...
bool __fastcall CriWareInitializer__InitializeMana(CriManaConfig_o *config, const MethodInfo *method)
{
  ...
  if ( (byte_4BC1F2C & 1) == 0 )
  {
    sub_1C1ABD4(&CriManaPlugin_TypeInfo, method);
    sub_1C1ABD4(&StringLiteral_4026/*"CRI_LINEAR_COLORSPACE"*/, v3);
    byte_4BC1F2C = 1;
  }
  ...
  {
    if ( !config )
      sub_1C1AE30(IsLibraryInitialized, v6);
    ...
    if ( UnityEngine_QualitySettings__get_activeColorSpace(0LL) == 1 )
      UnityEngine_Shader__EnableKeyword((System_String_o *)StringLiteral_4026/*"CRI_LINEAR_COLORSPACE"*/, 0LL);
  }
  return !v8;
}
...
bool __fastcall CriWareInitializer__IsInitialized(const MethodInfo *method)
{
  ...
  if ( (byte_4BC1F28 & 1) == 0 )
  {
    sub_1C1ABD4(&CriWareInitializer_TypeInfo, v1);
    byte_4BC1F28 = 1;
  }
