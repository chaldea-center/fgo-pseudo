void __fastcall CriWareInitializer___ctor(CriWareInitializer_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD699D & 1) == 0 )
  {
    sub_1C21E38(&CriAtomConfig_TypeInfo);
    sub_1C21E38(&CriFsConfig_TypeInfo);
    sub_1C21E38(&CriManaConfig_TypeInfo);
    sub_1C21E38(&CriWareDecrypterConfig_TypeInfo);
    byte_4BD699D = 1;
  }
  this->fields.initializesFileSystem = 1;
  v3 = (CriFsConfig_o *)sub_1C22084(CriFsConfig_TypeInfo);
  CriFsConfig___ctor(v3, v4);
  this->fields.fileSystemConfig = v3;
  sub_1C21DDC(&this->fields.fileSystemConfig, v3);
  this->fields.initializesAtom = 1;
  v5 = (CriAtomConfig_o *)sub_1C22084(CriAtomConfig_TypeInfo);
  CriAtomConfig___ctor(v5, v6);
  this->fields.atomConfig = v5;
  sub_1C21DDC(&this->fields.atomConfig, v5);
  this->fields.initializesMana = 1;
  v7 = (CriManaConfig_o *)sub_1C22084(CriManaConfig_TypeInfo);
  CriManaConfig___ctor(v7, v8);
  this->fields.manaConfig = v7;
  sub_1C21DDC(&this->fields.manaConfig, v7);
  v9 = (CriWareDecrypterConfig_o *)sub_1C22084(CriWareDecrypterConfig_TypeInfo);
  CriWareDecrypterConfig___ctor(v9, v10);
  this->fields.decrypterConfig = v9;
  sub_1C21DDC(&this->fields.decrypterConfig, v9);
...
void __fastcall CriWareInitializer__AddAudioEffectInterface(intptr_t effect_interface, const MethodInfo *method)
{
  ...
  if ( (byte_4BD6999 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_System_Collections_Generic_List_IntPtr__Add__);
    byte_4BD6999 = 1;
  }
  ...
  if ( CriAtomPlugin__GetAudioEffectInterfaceList(&effect_interface_list, 0LL) )
  {
    ...
    if ( (unsigned int)size >= items->max_length )
    {
      System_Collections_Generic_List_IntPtr___AddWithResize(
        v4,
        v2,
        *(const MethodInfo_3639914 **)(*(_QWORD *)(v6[4] + 192LL) + 112LL));
    }
    else
    {
...
void __fastcall CriWareInitializer__Initialize(CriWareInitializer_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD6996 & 1) == 0 )
  {
    ...
    sub_1C21E38(&CriWareInitializer_TypeInfo);
...
LABEL_76:
  ...
  if ( this->fields.useDecrypter )
    ...
    CriWareDecrypter__Initialize_30778168(
...
LABEL_73:
    sub_1C22094(IsLibraryInitialized, v8);
  }
}
...
bool __fastcall CriWareInitializer__InitializeAtom(CriAtomConfig_o *config, const MethodInfo *method)
{
  ...
  if ( (byte_4BD699B & 1) == 0 )
  {
    sub_1C21E38(&CriAtomEx_TypeInfo);
    sub_1C21E38(&CriAtomPlugin_TypeInfo);
    sub_1C21E38(&CriAtomServer_TypeInfo);
  ...
  if ( ((unsigned __int8)IsLibraryInitialized & 1) == 0 )
  {
    ...
    IsLibraryInitialized = (CriAtomEx_c *)System_Math__Max_63934620(maxVirtualVoices, RequiredMaxVirtualVoices, 0LL);
    ...
    v13 = System_Math__Max_63934620(config->fields.iosBufferingTime, 16, 0LL);
    CriAtomPlugin__SetConfigAdditionalParameters_IOS(iosEnableSonicSync, v13, config->fields.iosOverrideIPodMusic, 0LL);
    ...
    if ( config->fields.useRandomSeedWithTime )
    {
      ...
      Ticks = System_DateTime__get_Ticks(v42, 0LL);
      if ( !CriAtomEx_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(CriAtomEx_TypeInfo);
    ...
    if ( !acfFileName )
LABEL_54:
      sub_1C22094(IsLibraryInitialized, v4);
...
bool __fastcall CriWareInitializer__InitializeFileSystem(CriFsConfig_o *config, const MethodInfo *method)
{
  ...
  if ( ((unsigned __int8)IsLibraryInitialized & 1) == 0 )
  {
    ...
    if ( !IsLibraryInitialized )
LABEL_17:
      sub_1C22094(IsLibraryInitialized, v5);
...
bool __fastcall CriWareInitializer__InitializeMana(CriManaConfig_o *config, const MethodInfo *method)
{
  ...
  {
    sub_1C21E38(&CriManaPlugin_TypeInfo);
    sub_1C21E38(&StringLiteral_4035/*"CRI_LINEAR_COLORSPACE"*/);
    byte_4BD699C = 1;
  }
  ...
  if ( !IsLibraryInitialized )
  {
    ...
    if ( UnityEngine_QualitySettings__get_activeColorSpace(0LL) == 1 )
      UnityEngine_Shader__EnableKeyword((System_String_o *)StringLiteral_4035/*"CRI_LINEAR_COLORSPACE"*/, 0LL);
  }
  return !v7;
}
