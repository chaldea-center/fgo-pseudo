        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B42866 & 1) == 0 )
  {
    sub_1BDB878(&Method_WarBoardPartyBuffHelpButton_OnClickButton__, method);
    byte_4B42866 = 1;
  }
  v3 = Method_WarBoardPartyBuffHelpButton_OnClickButton__;
  if ( (*((_BYTE *)Method_WarBoardPartyBuffHelpButton_OnClickButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1BDB890(Method_WarBoardPartyBuffHelpButton_OnClickButton__);
        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.onButtonClickCallback, (int32_t)callback, (int32_t)method, v3);
}
