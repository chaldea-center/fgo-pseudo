        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4C23D & 1) == 0 )
  {
    sub_1B863B8(&Method_WarBoardPartyBuffHelpButton_OnClickButton__, method);
    byte_4A4C23D = 1;
  }
  v3 = Method_WarBoardPartyBuffHelpButton_OnClickButton__;
  if ( (*((_BYTE *)Method_WarBoardPartyBuffHelpButton_OnClickButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B863D0(Method_WarBoardPartyBuffHelpButton_OnClickButton__);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.onButtonClickCallback, (int32_t)callback, (int32_t)method, v3);
}
