        ...
        const MethodInfo *method)
{
  ...
  *targets = LogicTargetIds;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)targets, (int32_t)LogicTargetIds, v18, v19);
  ...
  *ptTargets = v22;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)ptTargets, (int32_t)v22, v23, v24);
  return 1;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB88FB & 1) == 0 )
  {
    ...
    sub_1BAB41C(&BattleLogicServantAiTask_TypeInfo, v11);
    sub_1BAB41C(&Method_System_Collections_Generic_List_BattleLogicTask__AddRange__, v12);
    sub_1BAB41C(&Method_System_Collections_Generic_List_BattleLogicTask__Add__, v13);
    sub_1BAB41C(&Method_System_Collections_Generic_List_BattleLogicTask__ForEach__, v14);
    sub_1BAB41C(&Method_System_Collections_Generic_List_BattleLogicTask__ToArray__, v15);
    sub_1BAB41C(&Method_System_Collections_Generic_List_BattleLogicTask___ctor__, v16);
    sub_1BAB41C(&System_Collections_Generic_List_BattleLogicTask__TypeInfo, v17);
    sub_1BAB41C(&Method_BattleLogicServantAi___c__DisplayClass4_0__MakeTaskAiTargetAct_b__0__, v18);
    sub_1BAB41C(&BattleLogicServantAi___c__DisplayClass4_0_TypeInfo, v19);
    byte_4AB88FB = 1;
  }
  info = 0LL;
  v20 = sub_1BAB668(BattleLogicServantAi___c__DisplayClass4_0_TypeInfo);
  ...
  *(_DWORD *)(v20 + 16) = timingPriority;
  ...
  logic = this->fields.logic;
  v27 = (BattleLogicServantAiTask_o *)sub_1BAB668(BattleLogicServantAiTask_TypeInfo);
  ...
  {
LABEL_18:
    sub_1BAB678(AiStateManager, v22);
  }
  ...
  v34 = (System_Action_object__o *)sub_1BAB668(System_Action_BattleLogicTask__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BAB678(TaskAiTargetAct, v8);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB88FA & 1) == 0 )
  {
    sub_1BAB41C(&ServantAiActArgument_TypeInfo, svtData);
    byte_4AB88FA = 1;
  }
  if ( currentCryptoKey )
  {
  ...
  *svtData = currentCryptoKey;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)svtData, (int32_t)currentCryptoKey, (int32_t)arg, (int32_t)method);
