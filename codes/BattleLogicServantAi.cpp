        ...
        const MethodInfo *method)
{
  ...
  *targets = LogicTargetIds;
  sub_1C6B9AC((CGThumbnailListItem_o *)targets, (int32_t)LogicTargetIds, v18, v19);
  ...
  *ptTargets = v22;
  sub_1C6B9AC((CGThumbnailListItem_o *)ptTargets, (int32_t)v22, v23, v24);
  return 1;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB9352 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&BattleLogicServantAiTask_TypeInfo);
    ...
    sub_1C6BA08(&Method_BattleLogicServantAi___c__DisplayClass4_0__MakeTaskAiTargetAct_b__0__);
    sub_1C6BA08(&BattleLogicServantAi___c__DisplayClass4_0_TypeInfo);
    byte_4CB9352 = 1;
  }
  info = 0;
  v11 = sub_1C6BC54(BattleLogicServantAi___c__DisplayClass4_0_TypeInfo);
  ...
  *(_DWORD *)(v11 + 16) = timingPriority;
  ...
  logic = this->fields.logic;
  v18 = (BattleLogicServantAiTask_o *)sub_1C6BC54(BattleLogicServantAiTask_TypeInfo);
  ...
  {
LABEL_18:
    sub_1C6BC60(AiStateManager, v13);
  }
  ...
  v25 = (System_Action_object__o *)sub_1C6BC54(System_Action_BattleLogicTask__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C6BC60(TaskAiTargetAct, v8);
  }
        ...
        const MethodInfo *method)
{
  ...
  *svtData = hiddenValue;
  sub_1C6B9AC((CGThumbnailListItem_o *)svtData, (int32_t)hiddenValue, (int32_t)arg, method);
