void __fastcall EventInfoSkillExplanationDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B460ED & 1) == 0 )
  {
    sub_1BDB878(&EventInfoSkillExplanationDialog_TypeInfo, v1);
    sub_1BDB878(&StringLiteral_5646/*"EVENT_INFO_SKILL_EXPLANATION_DIALOG_TEXT_{0}"*/, v4);
    sub_1BDB878(&StringLiteral_5645/*"EVENT_INFO_SKILL_EXPLANATIOIN_MESSAGE_02"*/, v5);
    byte_4B460ED = 1;
  }
  EventInfoSkillExplanationDialog_TypeInfo->static_fields->Message01LocalizationKey = (struct System_String_o *)StringLiteral_5646/*"EVENT_INFO_SKILL_EXPLANATION_DIALOG_TEXT_{0}"*/;
  sub_1BDB81C(
    (CGThumbnailListItem_o *)EventInfoSkillExplanationDialog_TypeInfo->static_fields,
    StringLiteral_5646/*"EVENT_INFO_SKILL_EXPLANATION_DIALOG_TEXT_{0}"*/,
    v2,
    v3);
  v6 = StringLiteral_5645/*"EVENT_INFO_SKILL_EXPLANATIOIN_MESSAGE_02"*/;
  static_fields = EventInfoSkillExplanationDialog_TypeInfo->static_fields;
  static_fields->Message02LocalizationKey = (struct System_String_o *)StringLiteral_5645/*"EVENT_INFO_SKILL_EXPLANATIOIN_MESSAGE_02"*/;
  sub_1BDB81C((CGThumbnailListItem_o *)&static_fields->Message02LocalizationKey, v6, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  LOBYTE(v2->monitor) = 0;
  sub_1BDB81C((CGThumbnailListItem_o *)v2, 0, v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B460EA & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_EventInfoSkillExplanationDialog_OnClickCancelButton__, v3);
    sub_1BDB878(&Method_EventInfoSkillExplanationDialog__OnClickCancelButton_b__16_0__, v4);
    byte_4B460EA = 1;
  }
  if ( !this->fields.isClose )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoSkillExplanationDialog_OnClickCancelButton__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1BDB890(Method_EventInfoSkillExplanationDialog_OnClickCancelButton__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&System_Action_TypeInfo, method);
    sub_1BDB878(&Method_EventInfoSkillExplanationDialog_OnClickDecideButton__, v3);
    sub_1BDB878(&Method_EventInfoSkillExplanationDialog__OnClickDecideButton_b__15_0__, v4);
    byte_4B460E9 = 1;
  }
  if ( !this->fields.isClose )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoSkillExplanationDialog_OnClickDecideButton__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1BDB890(Method_EventInfoSkillExplanationDialog_OnClickDecideButton__);
    v6 = (System_Reflection_MethodBase_o *)sub_1BDB85C(v5, v5[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B460E8 & 1) == 0 )
  {
    sub_1BDB878(&System_Action_TypeInfo, imagePartsGroupEntity);
    sub_1BDB878(&AtlasManager_TypeInfo, v7);
    sub_1BDB878(&Method_DataManager_GetMaster_QuestMaster___, v8);
    sub_1BDB878(&Method_DataManager_GetMaster_SkillLvMaster___, v9);
    sub_1BDB878(&DataManager_TypeInfo, v10);
    sub_1BDB878(&EventInfoSkillExplanationDialog_TypeInfo, v11);
    sub_1BDB878(&int_TypeInfo, v12);
    sub_1BDB878(&LocalizationManager_TypeInfo, v13);
    sub_1BDB878(&Method_EventInfoSkillExplanationDialog___c__DisplayClass14_0__Open_b__0__, v14);
    sub_1BDB878(&EventInfoSkillExplanationDialog___c__DisplayClass14_0_TypeInfo, v15);
    sub_1BDB878(&StringLiteral_10881/*"QUEST_MESSAGE_DLG_DECIDE"*/, v16);
    sub_1BDB878(&StringLiteral_10880/*"QUEST_MESSAGE_DLG_CANCEL"*/, v17);
    byte_4B460E8 = 1;
  }
  entity = 0LL;
  v18 = sub_1BDBAC4(EventInfoSkillExplanationDialog___c__DisplayClass14_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v18, 0LL);
  if ( !v18 )
    goto LABEL_30;
  *(_QWORD *)(v18 + 16) = clickCallback;
  v23 = (struct CommonConfirmDialog_ClickDelegate_o **)(v18 + 16);
  sub_1BDB81C((CGThumbnailListItem_o *)(v18 + 16), (int32_t)clickCallback, v21, v22);
  BaseDialog__Init((BaseDialog_o *)this, 0LL);
  this->fields.callback = 0LL;
  this->fields.isClose = 0;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.callback, 0, v24, v25);
  v26 = sub_1BDBAC4(System_Action_TypeInfo);
  System_Action___ctor(
    (System_Action_o *)v26,
    (Il2CppObject *)v18,
  ...
  if ( imagePartsGroupEntity )
  {
    ...
    if ( ((unsigned __int8)SkillLv & 1) != 0 )
    {
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      SkillLv = (QuestMaster_o *)DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_QuestMaster___);
      if ( SkillLv )
      {
              ...
              if ( skillName )
              {
                ...
                if ( entity )
                {
                  ...
                  if ( skillExplanationLabel )
                  {
                    ...
                    SkillLv = (QuestMaster_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10881/*"QUEST_MESSAGE_DLG_DECIDE"*/, 0LL);
                    if ( decideLabel )
                    {
                      UILabel__set_text(decideLabel, (System_String_o *)SkillLv, 0LL);
                      cancelLabel = this->fields.cancelLabel;
                      SkillLv = (QuestMaster_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10880/*"QUEST_MESSAGE_DLG_CANCEL"*/, 0LL);
                      if ( cancelLabel )
                      {
                        UILabel__set_text(cancelLabel, (System_String_o *)SkillLv, 0LL);
                        v49 = *v23;
                        this->fields.callback = *v23;
                        sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.callback, (int32_t)v49, v50, v51);
        ...
        const MethodInfo *method)
{
  ...
  this->fields.isClose = 0;
  this->fields.callback = 0LL;
  sub_1BDB81C((CGThumbnailListItem_o *)p_callback, 0, v5, v6);
}
