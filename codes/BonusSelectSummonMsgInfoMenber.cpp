...
void __fastcall BonusSelectSummonMsgInfoMenber__Init(BonusSelectSummonMsgInfoMenber_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BC3264(upperClassSprite, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  __int64 v21; // x1
  int32_t FrameType_41670196; // w21
  int32_t ClassId; // w22
  ...
  if ( (byte_4AFE464 & 1) == 0 )
  {
    sub_1BC3008(&AtlasManager_TypeInfo, servantEntity);
    sub_1BC3008(&Method_DataManager_GetMaster_ServantExceedMaster___, v5);
    sub_1BC3008(&Method_DataManager_GetMaster_ServantTreasureDvcMaster___, v6);
    ...
    sub_1BC3008(&System_Func_UserServantEntity__int__TypeInfo, v11);
    sub_1BC3008(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, v12);
    sub_1BC3008(&SvtClassAttri_TypeInfo, v13);
    sub_1BC3008(&Method_BonusSelectSummonMsgInfoMenber___c__Set_b__4_0__, v14);
    sub_1BC3008(&BonusSelectSummonMsgInfoMenber___c_TypeInfo, v15);
    byte_4AFE464 = 1;
  }
  rarity = 0;
  tdInfo = 0LL;
  ...
  if ( servantEntity )
  {
    ...
    *(_QWORD *)&v46.fields.fakeValue = v17;
    TreasureDeviceInfo = (UIIconLabel_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48024060(v46, 0LL);
    if ( !v19 )
      goto LABEL_45;
    ...
    AtlasManager__SetClass(upperClassSprite, ClassId, FrameType_41670196, 0, 0LL);
    ...
    *(_QWORD *)&v47.fields.fakeValue = v26;
    TreasureDeviceInfo = (UIIconLabel_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48024060(v47, 0LL);
    if ( !servantFace )
      goto LABEL_45;
    ...
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    v28 = DataManager__GetMaster_object_((const MethodInfo_3001E10 *)Method_DataManager_GetMaster_UserServantMaster___);
    TreasureDeviceInfo = (UIIconLabel_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48024060(
           ...
           0LL) )
    {
      ...
      if ( !_9__4_0 )
      {
        ...
        _9__4_0 = (System_Func_object__int__o *)sub_1BC3254(System_Func_UserServantEntity__int__TypeInfo);
        ...
        sub_1BC2FAC((CGThumbnailListItem_o *)&static_fields->__9__4_0, (int32_t)_9__4_0, v34, v35);
      }
...
LABEL_45:
        sub_1BC3264(TreasureDeviceInfo, v21);
      }
    }
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    v38 = DataManager__GetMaster_object_((const MethodInfo_3001E10 *)Method_DataManager_GetMaster_ServantTreasureDvcMaster___);
    ...
    *(_QWORD *)&v48.fields.fakeValue = v40;
    TreasureDeviceInfo = (UIIconLabel_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48024060(v48, 0LL);
    if ( !v42 )
      goto LABEL_45;
    ...
    if ( !treasureDeviceIconLabel )
      goto LABEL_45;
    UIIconLabel__Set_40054380(treasureDeviceIconLabel, 33, 1, (int32_t)TreasureDeviceInfo, 0, 0LL, 0, 0, 0, 0, 0LL);
  }
}
...
void __fastcall BonusSelectSummonMsgInfoMenber___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AFE465 & 1) == 0 )
  {
    sub_1BC3008(&BonusSelectSummonMsgInfoMenber___c_TypeInfo, v1);
    byte_4AFE465 = 1;
  }
  v2 = (Il2CppObject *)sub_1BC3254(BonusSelectSummonMsgInfoMenber___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  BonusSelectSummonMsgInfoMenber___c_TypeInfo->static_fields->__9 = (struct BonusSelectSummonMsgInfoMenber___c_o *)v2;
  sub_1BC2FAC((CGThumbnailListItem_o *)BonusSelectSummonMsgInfoMenber___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
