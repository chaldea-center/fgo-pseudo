...
void BonusSelectSummonMsgInfoMenber__Init(BonusSelectSummonMsgInfoMenber_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1D0F30C(upperClassSprite, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  __int64 v10; // x1
  int32_t FrameType_44061996; // w21
  int32_t ClassId; // w0
  ...
  if ( (byte_4E738FD & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_BonusSelectSummonMsgInfoMenber___c__Set_b__4_0__);
    sub_1D0F0B4(&BonusSelectSummonMsgInfoMenber___c_TypeInfo);
    byte_4E738FD = 1;
  }
  rarity = 0;
  tdInfo = 0;
  ...
  if ( servantEntity )
  {
    ...
    *(_QWORD *)&v38.fields.fakeValue = v6;
    TreasureDeviceInfo = (UIIconLabel_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_50331200(v38, 0);
    if ( !v8 )
      goto LABEL_33;
    FrameType_44061996 = ServantExceedMaster__GetFrameType_44061996(v8, &rarity, (int32_t)TreasureDeviceInfo, 0, 0, 0);
    ClassId = ServantEntity__GetClassId(servantEntity, 1, 0, 0);
    upperClassSprite = this->fields.upperClassSprite;
    v14 = ClassId;
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetClass(upperClassSprite, v14, FrameType_44061996, 0, 0);
    servantFace = this->fields.servantFace;
    TreasureDeviceInfo = (UIIconLabel_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_50331200(
    ...
    ServantFaceIconComponent__Set_42458076(
      ...
      1,
      0);
    v16 = DataManager__GetMaster_object_((const MethodInfo_324F164 *)Method_DataManager_GetMaster_UserServantMaster___);
    TreasureDeviceInfo = (UIIconLabel_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_50331200(
                                            servantEntity->fields.id,
                                            0);
    if ( !v16 )
           ...
           0) )
    {
      ...
      if ( !_9__4_0 )
      {
        ...
        _9__4_0 = (System_Func_object__int__o *)sub_1D0F300(System_Func_UserServantEntity__int__TypeInfo);
...
LABEL_33:
    ...
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    v30 = DataManager__GetMaster_object_((const MethodInfo_324F164 *)Method_DataManager_GetMaster_ServantTreasureDvcMaster___);
    ...
    *(_QWORD *)&v39.fields.fakeValue = v32;
    TreasureDeviceInfo = (UIIconLabel_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_50331200(v39, 0);
    if ( !v34 )
      goto LABEL_33;
    ...
    if ( !treasureDeviceIconLabel )
      goto LABEL_33;
    UIIconLabel__Set_42477084(treasureDeviceIconLabel, 33, 1, (int32_t)TreasureDeviceInfo, 0, 0, 0, 0, 0, 0, 0);
  }
}
...
void BonusSelectSummonMsgInfoMenber___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1D0F300(BonusSelectSummonMsgInfoMenber___c_TypeInfo);
