...
void __fastcall BonusSelectSummonMsgInfoMenber__Init(BonusSelectSummonMsgInfoMenber_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B71828(upperClassSprite, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C257 & 1) == 0 )
  {
    sub_1B715CC(&AtlasManager_TypeInfo, servantEntity);
    sub_1B715CC(&Method_DataManager_GetMaster_ServantExceedMaster___, v5);
    sub_1B715CC(&Method_DataManager_GetMaster_ServantTreasureDvcMaster___, v6);
    ...
    sub_1B715CC(&System_Func_UserServantEntity__int__TypeInfo, v11);
    sub_1B715CC(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, v12);
    sub_1B715CC(&SvtClassAttri_TypeInfo, v13);
    sub_1B715CC(&Method_BonusSelectSummonMsgInfoMenber___c__Set_b__4_0__, v14);
    sub_1B715CC(&BonusSelectSummonMsgInfoMenber___c_TypeInfo, v15);
    byte_4A1C257 = 1;
  }
  rarity = 0;
  tdInfo = 0LL;
  ...
  if ( servantEntity )
  {
    ...
    *(_QWORD *)&v46.fields.fakeValue = v17;
    TreasureDeviceInfo = (UIIconLabel_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46308268(v46, 0LL);
    if ( !v19 )
      goto LABEL_45;
    ...
    AtlasManager__SetClass(upperClassSprite, ClassId, FrameType_39458076, 0LL);
    ...
    *(_QWORD *)&v47.fields.fakeValue = v26;
    TreasureDeviceInfo = (UIIconLabel_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46308268(v47, 0LL);
    if ( !servantFace )
      goto LABEL_45;
    ...
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    v28 = DataManager__GetMaster_object_((const MethodInfo_2E5B394 *)Method_DataManager_GetMaster_UserServantMaster___);
    TreasureDeviceInfo = (UIIconLabel_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46308268(
           ...
           0LL) )
    {
      ...
      if ( !_9__4_0 )
      {
        ...
        _9__4_0 = (System_Func_object__int__o *)sub_1B71818(System_Func_UserServantEntity__int__TypeInfo);
        ...
        sub_1B71570((ServantStatusBattleListViewItem_o *)&static_fields->__9__4_0, (int32_t)_9__4_0, v34, v35);
      }
...
LABEL_45:
        sub_1B71828(TreasureDeviceInfo, v21);
      }
    }
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    v38 = DataManager__GetMaster_object_((const MethodInfo_2E5B394 *)Method_DataManager_GetMaster_ServantTreasureDvcMaster___);
    ...
    *(_QWORD *)&v48.fields.fakeValue = v40;
    TreasureDeviceInfo = (UIIconLabel_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46308268(v48, 0LL);
    if ( !v42 )
      goto LABEL_45;
    ...
    if ( !treasureDeviceIconLabel )
      goto LABEL_45;
    UIIconLabel__Set_38031016(treasureDeviceIconLabel, 33, 1, (int32_t)TreasureDeviceInfo, 0, 0LL, 0, 0, 0, 0LL);
  }
}
...
void __fastcall BonusSelectSummonMsgInfoMenber___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A1C258 & 1) == 0 )
  {
    sub_1B715CC(&BonusSelectSummonMsgInfoMenber___c_TypeInfo, v1);
    byte_4A1C258 = 1;
  }
  v2 = (Il2CppObject *)sub_1B71818(BonusSelectSummonMsgInfoMenber___c_TypeInfo);
