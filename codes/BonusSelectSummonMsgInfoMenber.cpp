...
void __fastcall BonusSelectSummonMsgInfoMenber__Init(BonusSelectSummonMsgInfoMenber_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C13F80(upperClassSprite, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  __int64 v21; // x1
  int32_t FrameType_40831136; // w21
  int32_t ClassId; // w22
  ...
  if ( (byte_4BB0CC9 & 1) == 0 )
  {
    sub_1C13D24(&AtlasManager_TypeInfo, servantEntity);
    sub_1C13D24(&Method_DataManager_GetMaster_ServantExceedMaster___, v5);
    sub_1C13D24(&Method_DataManager_GetMaster_ServantTreasureDvcMaster___, v6);
    ...
    sub_1C13D24(&System_Func_UserServantEntity__int__TypeInfo, v11);
    sub_1C13D24(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, v12);
    sub_1C13D24(&SvtClassAttri_TypeInfo, v13);
    sub_1C13D24(&Method_BonusSelectSummonMsgInfoMenber___c__Set_b__4_0__, v14);
    sub_1C13D24(&BonusSelectSummonMsgInfoMenber___c_TypeInfo, v15);
    byte_4BB0CC9 = 1;
  }
  rarity = 0;
  tdInfo = 0LL;
  ...
  if ( servantEntity )
  {
    ...
    *(_QWORD *)&v50.fields.fakeValue = v17;
    TreasureDeviceInfo = (UIIconLabel_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47490608(v50, 0LL);
    if ( !v19 )
      goto LABEL_45;
    ...
    AtlasManager__SetClass(upperClassSprite, ClassId, FrameType_40831136, 0LL);
    ...
    *(_QWORD *)&v51.fields.fakeValue = v26;
    TreasureDeviceInfo = (UIIconLabel_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47490608(v51, 0LL);
    if ( !servantFace )
      goto LABEL_45;
    ...
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    v28 = DataManager__GetMaster_object_((const MethodInfo_2F8F418 *)Method_DataManager_GetMaster_UserServantMaster___);
    TreasureDeviceInfo = (UIIconLabel_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47490608(
           ...
           0LL) )
    {
      ...
      if ( !_9__4_0 )
      {
        ...
        _9__4_0 = (System_Func_object__int__o *)sub_1C13F70(System_Func_UserServantEntity__int__TypeInfo);
...
LABEL_45:
        sub_1C13F80(TreasureDeviceInfo, v21);
      }
    }
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    v42 = DataManager__GetMaster_object_((const MethodInfo_2F8F418 *)Method_DataManager_GetMaster_ServantTreasureDvcMaster___);
    ...
    *(_QWORD *)&v52.fields.fakeValue = v44;
    TreasureDeviceInfo = (UIIconLabel_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47490608(v52, 0LL);
    if ( !v46 )
      goto LABEL_45;
    ...
    if ( !treasureDeviceIconLabel )
      goto LABEL_45;
    UIIconLabel__Set_39380320(treasureDeviceIconLabel, 33, 1, (int32_t)TreasureDeviceInfo, 0, 0LL, 0, 0, 0, 0LL);
  }
}
...
void __fastcall BonusSelectSummonMsgInfoMenber___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BB0CCA & 1) == 0 )
  {
    sub_1C13D24(&BonusSelectSummonMsgInfoMenber___c_TypeInfo, v1);
    byte_4BB0CCA = 1;
  }
  v2 = (Il2CppObject *)sub_1C13F70(BonusSelectSummonMsgInfoMenber___c_TypeInfo);
