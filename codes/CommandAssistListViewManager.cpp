        ...
        const MethodInfo *method)
{
  ...
  ValidEntityList = DataManager__GetMaster_object_((const MethodInfo_314B0B8 *)Method_DataManager_GetMaster_EventCommandAssistMaster___);
  if ( !ValidEntityList )
    goto LABEL_22;
    ...
    while ( 1 )
    {
      ...
      Entity = SkillLvMaster__GetEntity(
                 ...
                 *((_DWORD *)ValidEntityList + 14),
                 0);
      if ( !Entity || (Empty = SkillLvEntity__getDetail_43166404(Entity, Entity->fields.lv, 0, 0)) == 0 )
      ...
      v17 = (CommandAssistListViewItem_o *)sub_1C715FC(CommandAssistListViewItem_TypeInfo);
...
LABEL_22:
    sub_1C71608(ValidEntityList, v5);
  }
LABEL_20:
