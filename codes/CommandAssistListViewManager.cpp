        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CE826B & 1) == 0 )
  {
    sub_1C7BAE8(&CommandAssistListViewItem_TypeInfo);
  ...
  ValidEntityList = DataManager__GetMaster_object_((const MethodInfo_31703A0 *)Method_DataManager_GetMaster_EventCommandAssistMaster___);
  if ( !ValidEntityList )
    goto LABEL_22;
    ...
    while ( 1 )
    {
      ...
      Entity = SkillLvMaster__GetEntity(
                 ...
                 *((_DWORD *)ValidEntityList + 14),
                 0);
      if ( !Entity || (Empty = SkillLvEntity__getDetail_43426300(Entity, Entity->fields.lv, 0, 0)) == 0 )
      ...
      v17 = (CommandAssistListViewItem_o *)sub_1C7BD34(CommandAssistListViewItem_TypeInfo);
      ...
      else
      {
        ...
        sub_1C7BA8C(v21 + 4, v17);
      }
      if ( v6 == ++v8 )
        goto LABEL_20;
    }
LABEL_22:
    sub_1C7BD40(ValidEntityList, v5);
  }
LABEL_20:
