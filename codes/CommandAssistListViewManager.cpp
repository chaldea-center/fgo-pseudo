        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0084 & 1) == 0 )
  {
    sub_B52984(&CommandAssistListViewItem_TypeInfo);
  ...
  ValidEntityList = DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1A4F124 *)Method_DataManager_GetMaster_EventCommandAssistMaster___);
  if ( !ValidEntityList )
    goto LABEL_22;
  ...
  if ( v19 >= 1 )
  {
    ...
    for ( i = 0LL; ; ++i )
    {
      ...
      if ( !Entity || (Empty = SkillLvEntity__getDetail_26526320(Entity, Entity->fields.lv, 0, 0LL)) == 0LL )
      ...
      v16 = *((_DWORD *)v6 + 6);
      v17 = (CommandAssistListViewItem_o *)sub_B52A54(CommandAssistListViewItem_TypeInfo);
