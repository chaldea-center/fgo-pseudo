        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B165C0 & 1) == 0 )
  {
    sub_1BCAFF8(&CommandAssistListViewItem_TypeInfo, *(_QWORD *)&eventId);
    sub_1BCAFF8(&Method_DataManager_GetMaster_EventCommandAssistMaster___, v3);
    ...
    sub_1BCAFF8(&Method_System_Collections_Generic_List_EventCommandAssistEntity__get_Count__, v7);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_EventCommandAssistEntity__get_Item__, v8);
  ...
  ValidEntityList = DataManager__GetMaster_object_((const MethodInfo_301AA50 *)Method_DataManager_GetMaster_EventCommandAssistMaster___);
  if ( !ValidEntityList )
    goto LABEL_22;
    ...
    while ( 1 )
    {
      ...
      Entity = SkillLvMaster__GetEntity(
                 ...
                 *((_DWORD *)ValidEntityList + 14),
                 0LL);
      if ( !Entity || (Empty = SkillLvEntity__getDetail_42023016(Entity, Entity->fields.lv, 0, 0LL)) == 0LL )
      ...
      v24 = (CommandAssistListViewItem_o *)sub_1BCB244(CommandAssistListViewItem_TypeInfo);
...
LABEL_22:
    sub_1BCB254(ValidEntityList, v12);
  }
LABEL_20:
