        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E710AE & 1) == 0 )
  {
    sub_1D0F0B4(&CommandAssistListViewItem_TypeInfo);
  ...
  ValidEntityList = DataManager__GetMaster_object_((const MethodInfo_324F164 *)Method_DataManager_GetMaster_EventCommandAssistMaster___);
  if ( !ValidEntityList )
    goto LABEL_22;
    ...
    while ( 1 )
    {
      ...
      Entity = SkillLvMaster__GetEntity(
                 ...
                 *((_DWORD *)ValidEntityList + 14),
                 0);
      if ( !Entity || (Empty = SkillLvEntity__getDetail_44251960(Entity, Entity->fields.lv, 0, 0)) == 0 )
      ...
      v17 = (CommandAssistListViewItem_o *)sub_1D0F300(CommandAssistListViewItem_TypeInfo);
...
LABEL_22:
    sub_1D0F30C(ValidEntityList, v5);
  }
LABEL_20:
