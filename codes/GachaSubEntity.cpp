...
System_String_o *GachaSubEntity__GetSummonConfirmMessage(GachaSubEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4C432A8 & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_13169/*"SummonConfirmMessage"*/);
    byte_4C432A8 = 1;
  }
  return EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_13169/*"SummonConfirmMessage"*/, 0, 0);
}
...
int32_t GachaSubEntity__GetSummonConfirmMessageSpacingX(GachaSubEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4C432AA & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_12941/*"SpacingX"*/);
    byte_4C432AA = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_12941/*"SpacingX"*/, -1, 0);
}
...
int32_t GachaSubEntity__GetSummonConfirmMessageSpacingY(GachaSubEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4C432A9 & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_12942/*"SpacingY"*/);
    byte_4C432A9 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_12942/*"SpacingY"*/, -1, 0);
}