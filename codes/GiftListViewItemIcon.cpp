...
LABEL_17:
    sub_1C22094(IsServant, gifttype);
  }
  ...
  else
  {
    ...
    else
    {
      if ( !v15 || !IsServant )
        goto LABEL_17;
      ItemIconComponent__SetGift_39386620(IsServant, gifttype, v15->fields.objectId, v15->fields.num, 0, 0LL);
    }
  }
}
  ...
  else
  {
    if ( !v12 )
    {
      if ( LOBYTE(this[1].fields.method_ptr) )
      {
        ...
        {
          if ( (v16 & 1) != 0 )
            v13 = (Il2CppObject *)sub_1A652F8;
          else
            v13 = (Il2CppObject *)sub_1A652BC;
        }
        else if ( (v16 & 1) != 0 )
        {
          v13 = (Il2CppObject *)sub_1A65238;
        }
        else
        {
          v13 = (Il2CppObject *)sub_1A6520C;
        }
      }
      else
      {
        v13 = (Il2CppObject *)sub_1A651DC;
      }
      goto LABEL_16;
    }
    if ( !object )
...
LABEL_17:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A65194;
}
