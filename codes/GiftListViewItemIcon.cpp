...
LABEL_17:
    sub_1C942F0(IsServant, gifttype);
  }
  ...
  else
  {
    ...
    else
    {
      if ( !v15 || !IsServant )
        goto LABEL_17;
      ItemIconComponent__SetGift_41674460(IsServant, gifttype, v15->fields.objectId, v15->fields.num, 0, 0);
    }
  }
}
...
LABEL_17:
  this->fields.extra_arg = (intptr_t)sub_1ACAE0C;
}
