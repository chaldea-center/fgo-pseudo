...
LABEL_17:
    sub_1BD36B4(IsServant, gifttype);
  }
  ...
  else
  {
    ...
    else
    {
      if ( !v15 || !IsServant )
        goto LABEL_17;
      ItemIconComponent__SetGift_38924152(IsServant, gifttype, v15->fields.objectId, v15->fields.num, 0, 0LL);
    }
  }
}
  ...
  else
  {
    if ( !v12 )
    {
      if ( LOBYTE(this[1].fields.method_ptr) )
      {
        ...
        {
          if ( (v16 & 1) != 0 )
            v13 = (Il2CppObject *)sub_1A1786C;
          else
            v13 = (Il2CppObject *)sub_1A17830;
        }
        else if ( (v16 & 1) != 0 )
        {
          v13 = (Il2CppObject *)sub_1A177AC;
        }
        else
        {
          v13 = (Il2CppObject *)sub_1A17780;
        }
      }
      else
      {
        v13 = (Il2CppObject *)sub_1A17750;
      }
      goto LABEL_16;
    }
    if ( !object )
...
LABEL_17:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A17708;
}
