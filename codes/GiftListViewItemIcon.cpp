...
LABEL_17:
    sub_1C2D6EC(IsServant, gifttype);
  }
  ...
  else
  {
    ...
    else
    {
      if ( !v11 || !IsServant )
        goto LABEL_17;
      ItemIconComponent__SetGift_40700316(IsServant, gifttype, v11->fields.objectId, v11->fields.num, 0, 0);
    }
  }
}
...
LABEL_17:
  this->fields.extra_arg = (intptr_t)sub_1A74248;
}
