...
LABEL_17:
    sub_1BCB254(IsServant, gifttype);
  }
  ...
  else
  {
    ...
    else
    {
      if ( !v11 || !IsServant )
        goto LABEL_17;
      ItemIconComponent__SetGift_40107980(IsServant, gifttype, v11->fields.objectId, v11->fields.num, 0, 0LL);
    }
  }
}
  ...
  else
  {
    if ( !v8 )
    {
      if ( LOBYTE(this[1].fields.method_ptr) )
      {
        ...
        {
          if ( (v12 & 1) != 0 )
            v9 = (Il2CppObject *)sub_1A17B1C;
          else
            v9 = (Il2CppObject *)sub_1A17AE0;
        }
        else if ( (v12 & 1) != 0 )
        {
          v9 = (Il2CppObject *)sub_1A17A5C;
        }
        else
        {
          v9 = (Il2CppObject *)sub_1A17A30;
        }
      }
      else
      {
        v9 = (Il2CppObject *)sub_1A17A00;
      }
      goto LABEL_16;
    }
    if ( !object )
...
LABEL_17:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A179B8;
}
