...
LABEL_17:
    sub_1C93D2C(IsServant, gifttype);
  }
  ...
  else
  {
    ...
    else
    {
      if ( !v15 || !IsServant )
        goto LABEL_17;
      ItemIconComponent__SetGift_41640856(IsServant, gifttype, v15->fields.objectId, v15->fields.num, 0, 0);
    }
  }
}
...
LABEL_17:
  this->fields.extra_arg = (intptr_t)sub_1ACB100;
}
