...
LABEL_17:
    sub_1C1AE30(IsServant, gifttype);
  }
  ...
  else
  {
    ...
    if ( (_DWORD)gifttype == 2 )
    {
      if ( !v15 || !IsServant )
        goto LABEL_17;
      ItemIconComponent__SetItem(IsServant, v15->fields.objectId, v15->fields.num, 1, 0LL);
    }
    else
    {
      if ( !v15 || !IsServant )
        goto LABEL_17;
      ItemIconComponent__SetGift_39340176(IsServant, gifttype, v15->fields.objectId, v15->fields.num, 0, 0LL);
    }
  }
}
  ...
  else
  {
    if ( !v12 )
    {
      if ( LOBYTE(this[1].fields.method_ptr) )
      {
        ...
        {
          if ( (v16 & 1) != 0 )
            v13 = (Il2CppObject *)sub_1A5E350;
          else
            v13 = (Il2CppObject *)sub_1A5E314;
        }
        else if ( (v16 & 1) != 0 )
        {
          v13 = (Il2CppObject *)sub_1A5E290;
        }
        else
        {
          v13 = (Il2CppObject *)sub_1A5E264;
        }
      }
      else
      {
        v13 = (Il2CppObject *)sub_1A5E234;
      }
      goto LABEL_16;
    }
    if ( !object )
...
LABEL_17:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A5E1EC;
}
