...
LABEL_17:
    sub_21FFECC(IsServant, gifttype);
  }
  ...
  else
  {
    if ( !v14 || !IsServant )
      goto LABEL_17;
    ItemIconComponent__SetGift_47936840(IsServant, gifttype, v14->fields.objectId, v14->fields.num, 0, 0);
  }
}
...
LABEL_17:
  this->fields.extra_arg = (intptr_t)sub_1FFDD2C;
}
