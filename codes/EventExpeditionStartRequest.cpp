        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EB20B & 1) == 0 )
  {
    sub_B5D5C4(&StringLiteral_18701/*"eventId"*/, eventId, expeditionIdx, *(_QWORD *)&pieceIdx);
    sub_B5D5C4(&StringLiteral_18865/*"expeditionIdx"*/, v9, v10, v11);
    sub_B5D5C4(&StringLiteral_21762/*"pieceIdx"*/, v12, v13, v14);
    byte_42EB20B = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18701/*"eventId"*/, eventId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18865/*"expeditionIdx"*/, expeditionIdx, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21762/*"pieceIdx"*/, pieceIdx, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EB20A & 1) == 0 )
  {
    ...
    sub_B5D5C4(&StringLiteral_18687/*"event/expeditionStart"*/, v4, v5, v6);
    byte_42EB20A = 1;
  }
  ...
  return System_String__Concat_44577788(BaseUrl, (System_String_o *)StringLiteral_18687/*"event/expeditionStart"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v9 = ResponseCommandKind__SearchData(116, responseList, 0LL);
