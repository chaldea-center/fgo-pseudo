        ...
        const MethodInfo *method)
{
  if ( (byte_593A211 & 1) == 0 )
  {
    ...
    sub_21FFC50(&StringLiteral_20183/*"expeditionIdx"*/);
    sub_21FFC50(&StringLiteral_23818/*"pieceIdx"*/);
    byte_593A211 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19995/*"eventId"*/, eventId, 0);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_20183/*"expeditionIdx"*/, expeditionIdx, 0);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23818/*"pieceIdx"*/, pieceIdx, 0);
...
System_String_o *EventExpeditionStartRequest__getURL(EventExpeditionStartRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_593A210 & 1) == 0 )
  {
    ...
    sub_21FFC50(&StringLiteral_19979/*"event/expeditionStart"*/);
    byte_593A210 = 1;
  }
  if ( !*(&NetworkManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_75438412(BaseUrl, (System_String_o *)StringLiteral_19979/*"event/expeditionStart"*/, 0);
}
