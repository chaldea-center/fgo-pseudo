        ...
        const MethodInfo *method)
{
  if ( (byte_59723EE & 1) == 0 )
  {
    ...
    sub_2213A60(&StringLiteral_20225/*"expeditionIdx"*/);
    sub_2213A60(&StringLiteral_23865/*"pieceIdx"*/);
    byte_59723EE = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_20037/*"eventId"*/, eventId, 0);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_20225/*"expeditionIdx"*/, expeditionIdx, 0);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23865/*"pieceIdx"*/, pieceIdx, 0);
...
System_String_o *EventExpeditionStartRequest__getURL(EventExpeditionStartRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_59723ED & 1) == 0 )
  {
    ...
    sub_2213A60(&StringLiteral_20021/*"event/expeditionStart"*/);
    byte_59723ED = 1;
  }
  if ( !*(&NetworkManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_75651716(BaseUrl, (System_String_o *)StringLiteral_20021/*"event/expeditionStart"*/, 0);
}
