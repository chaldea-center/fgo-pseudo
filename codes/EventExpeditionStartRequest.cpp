        ...
        const MethodInfo *method)
{
  if ( (byte_4C28DBC & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_19317/*"expeditionIdx"*/);
    sub_1C2D490(&StringLiteral_22678/*"pieceIdx"*/);
    byte_4C28DBC = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19133/*"eventId"*/, eventId, 0);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19317/*"expeditionIdx"*/, expeditionIdx, 0);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22678/*"pieceIdx"*/, pieceIdx, 0);
...
System_String_o *EventExpeditionStartRequest__getURL(EventExpeditionStartRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C28DBB & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_19117/*"event/expeditionStart"*/);
    byte_4C28DBB = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63457864(BaseUrl, (System_String_o *)StringLiteral_19117/*"event/expeditionStart"*/, 0);
}
