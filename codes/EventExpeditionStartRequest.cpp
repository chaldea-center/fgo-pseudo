        ...
        const MethodInfo *method)
{
  if ( (byte_4C394C5 & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_19328/*"expeditionIdx"*/);
    sub_1C32C20(&StringLiteral_22695/*"pieceIdx"*/);
    byte_4C394C5 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19143/*"eventId"*/, eventId, 0);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19328/*"expeditionIdx"*/, expeditionIdx, 0);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22695/*"pieceIdx"*/, pieceIdx, 0);
...
System_String_o *EventExpeditionStartRequest__getURL(EventExpeditionStartRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C394C4 & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_19127/*"event/expeditionStart"*/);
    byte_4C394C4 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63518544(BaseUrl, (System_String_o *)StringLiteral_19127/*"event/expeditionStart"*/, 0);
}
