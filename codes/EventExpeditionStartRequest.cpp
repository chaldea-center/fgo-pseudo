        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1DFAA & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_19159/*"expeditionIdx"*/, v9);
    sub_1BCAFF8(&StringLiteral_22491/*"pieceIdx"*/, v10);
    byte_4B1DFAA = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18977/*"eventId"*/, eventId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19159/*"expeditionIdx"*/, expeditionIdx, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22491/*"pieceIdx"*/, pieceIdx, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1DFA9 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_18961/*"event/expeditionStart"*/, v2);
    byte_4B1DFA9 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62450424(BaseUrl, (System_String_o *)StringLiteral_18961/*"event/expeditionStart"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    v7 = v6;
    v8 = ResponseData__checkError_43347888(v6, 0LL);
    v9 = 0LL;
    if ( v8 )
    {
