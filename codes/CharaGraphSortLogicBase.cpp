void __fastcall CharaGraphSortLogicBase___ctor(CharaGraphSortLogicBase_o *this, const MethodInfo *method)
{
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields._IconInfo1_k__BackingField, (int32_t)v3, v4, v5);
  v7 = CharaGraphSortLogicBase__ClearedIcon(v6);
  this->fields._IconInfo2_k__BackingField = v7;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields._IconInfo2_k__BackingField, (int32_t)v7, v8, v9);
...
IconLabelInfo_o *__fastcall CharaGraphSortLogicBase__ClearedIcon(const MethodInfo *method)
{
  ...
  if ( (byte_4A4D865 & 1) == 0 )
  {
    sub_1B863B8(&IconLabelInfo_TypeInfo, v1);
    byte_4A4D865 = 1;
  }
  v2 = (IconLabelInfo_o *)sub_1B86604(IconLabelInfo_TypeInfo);
...
void __fastcall CharaGraphSortLogicBase__InitSortValue(CharaGraphSortLogicBase_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields._SortValue2_k__BackingField = 0u;
  ...
  {
    sub_1B86614(IconInfo1_k__BackingField, method);
  }
  IconLabelInfo__Clear(IconInfo1_k__BackingField, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.item, (int32_t)inputItem, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields, (int32_t)inputSort, (int32_t)method, v3);
}
