...
IconLabelInfo_o *__fastcall CharaGraphSortLogicBase__ClearedIcon(const MethodInfo *method)
{
  ...
  if ( (byte_4BC6E81 & 1) == 0 )
  {
    sub_1C1ABD4(&IconLabelInfo_TypeInfo, v1);
    byte_4BC6E81 = 1;
  }
  v2 = (IconLabelInfo_o *)sub_1C1AE20(IconLabelInfo_TypeInfo);
...
void __fastcall CharaGraphSortLogicBase__InitSortValue(CharaGraphSortLogicBase_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields._SortValue2_k__BackingField = 0u;
  ...
  {
    sub_1C1AE30(IconInfo1_k__BackingField, method);
  }
  IconLabelInfo__Clear(IconInfo1_k__BackingField, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.item, (int64_t)inputItem, (int64_t)method, v3, v4, v5, v6, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields, (int64_t)inputSort, (int64_t)method, v3, v4, v5, v6, v7);
}
