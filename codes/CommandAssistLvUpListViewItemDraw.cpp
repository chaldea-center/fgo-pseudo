        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC19F9 & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_5552/*"EVENT_COMMAND_ASSIST_LEVEL_UP_FORMAT"*/);
    byte_4CC19F9 = 1;
  }
  ...
  Master_object = (EventCommandAssistMaster_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5552/*"EVENT_COMMAND_ASSIST_LEVEL_UP_FORMAT"*/, 0);
  if ( !v9 )
    goto LABEL_18;
  ...
  v17 = LocalizationManager__Get((System_String_o *)StringLiteral_8264/*"LEVEL_INFO"*/, 0);
  v33 = v9->fields.lv - 1;
  ...
  v27 = LocalizationManager__Get((System_String_o *)StringLiteral_8264/*"LEVEL_INFO"*/, 0);
  v31 = v9->fields.lv - 1;
