        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFC7B9 & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_5510/*"EVENT_COMMAND_ASSIST_LEVEL_UP_FORMAT"*/, v10);
    byte_4AFC7B9 = 1;
  }
  ...
  Master_object = (EventCommandAssistMaster_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5510/*"EVENT_COMMAND_ASSIST_LEVEL_UP_FORMAT"*/, 0LL);
  if ( !v15 )
    goto LABEL_18;
  ...
  v26 = LocalizationManager__Get((System_String_o *)StringLiteral_8183/*"LEVEL_INFO"*/, 0LL);
  v51 = v15->fields.lv - 1;
  ...
  v33 = LocalizationManager__Get((System_String_o *)StringLiteral_8183/*"LEVEL_INFO"*/, 0LL);
  v50 = v15->fields.lv;
  ...
  v42 = LocalizationManager__Get((System_String_o *)StringLiteral_8183/*"LEVEL_INFO"*/, 0LL);
  v49 = v15->fields.lv - 1;
