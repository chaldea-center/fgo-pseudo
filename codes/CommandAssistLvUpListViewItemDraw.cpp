        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02B06 & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_5558/*"EVENT_COMMAND_ASSIST_LEVEL_UP_FORMAT"*/, v10);
    byte_4A02B06 = 1;
  }
  ...
  v26 = LocalizationManager__Get((System_String_o *)StringLiteral_8200/*"LEVEL_INFO"*/, 0LL);
  v51 = v15->fields.lv - 1;
  ...
  v33 = LocalizationManager__Get((System_String_o *)StringLiteral_8200/*"LEVEL_INFO"*/, 0LL);
  v50 = v15->fields.lv;
  ...
  v42 = LocalizationManager__Get((System_String_o *)StringLiteral_8200/*"LEVEL_INFO"*/, 0LL);
  v49 = v15->fields.lv - 1;
