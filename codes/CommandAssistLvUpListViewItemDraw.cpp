        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB8965 & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_5685/*"EVENT_COMMAND_ASSIST_DIALOG_MAX_LEVEL_FORMAT"*/, v10);
    byte_4BB8965 = 1;
  }
  ...
  Master_object = (EventCommandAssistMaster_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5685/*"EVENT_COMMAND_ASSIST_DIALOG_MAX_LEVEL_FORMAT"*/, 0LL);
  if ( !v15 )
    goto LABEL_18;
  ...
  v26 = LocalizationManager__Get((System_String_o *)StringLiteral_8402/*"LEVELUP_NOTICE_TITLE"*/, 0LL);
  v51 = v15->fields.lv - 1;
  ...
  v33 = LocalizationManager__Get((System_String_o *)StringLiteral_8402/*"LEVELUP_NOTICE_TITLE"*/, 0LL);
  v50 = v15->fields.lv;
  ...
  v42 = LocalizationManager__Get((System_String_o *)StringLiteral_8402/*"LEVELUP_NOTICE_TITLE"*/, 0LL);
  v49 = v15->fields.lv - 1;
