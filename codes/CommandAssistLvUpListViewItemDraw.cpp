        ...
        const MethodInfo *method)
{
  ...
  int32_t v32; // [xsp+10h] [xbp-50h] BYREF
  int v33; // [xsp+14h] [xbp-4Ch] BYREF
  ...
  if ( (byte_42B008A & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_5633/*"EVENT_COMMAND_ASSIST_LEVEL_UP_FORMAT"*/);
    byte_42B008A = 1;
  }
  ...
  Master_WarQuestSelectionMaster = (EventCommandAssistMaster_o *)LocalizationManager__Get(
                                                                   (System_String_o *)StringLiteral_5633/*"EVENT_COMMAND_ASSIST_LEVEL_UP_FORMAT"*/,
                                                                   0LL);
  if ( !v9 )
    goto LABEL_21;
  ...
  Master_WarQuestSelectionMaster = (EventCommandAssistMaster_o *)System_String__Format(v14, v15, 0LL);
  if ( !levelLabel )
    goto LABEL_21;
  ...
  Master_WarQuestSelectionMaster = (EventCommandAssistMaster_o *)System_String__Format(v17, v18, 0LL);
  if ( !beforeLevelLabel )
    goto LABEL_21;
  ...
  v27 = LocalizationManager__Get((System_String_o *)StringLiteral_8424/*"LEVEL_INFO"*/, 0LL);
  v31 = v9->fields.lv - 1;
  v28 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v31);
  v29 = (Il2CppObject *)System_String__Format(v27, v28, 0LL);
  v30 = System_String__Format(BeforeDetail_k__BackingField, v29, 0LL);
  WrapControlText__textAdjust(beforeDetailLabel, v30, 16, 0, 0, 0LL);
