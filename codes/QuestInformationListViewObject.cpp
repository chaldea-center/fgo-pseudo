...
void __fastcall QuestInformationListViewObject__Awake(QuestInformationListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A581AE & 1) == 0 )
  {
    sub_1B885B0(&Method_UnityEngine_GameObject_GetComponent_QuestInformationListViewItemDraw___);
    byte_4A581AE = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2ECEEB8 *)Method_UnityEngine_GameObject_GetComponent_QuestInformationListViewItemDraw___);
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_2ECEEB8 *)Method_UnityEngine_GameObject_GetComponent_QuestInformationListViewObject___)) == 0LL) )
  {
    sub_1B8880C(DragObject, v4);
  }
  QuestInformationListViewObject__Init_34063612((QuestInformationListViewObject_o *)DragObject, 3, v6);
  return v5;
}
...
void __fastcall QuestInformationListViewObject__Init_34063612(
        QuestInformationListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall QuestInformationListViewObject__Init_34067244(
        QuestInformationListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall QuestInformationListViewObject__Init_34067328(
        QuestInformationListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall QuestInformationListViewObject__Start(QuestInformationListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    QuestInformationListViewObject__Init_34063612(this, 3, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A581B4 & 1) == 0 )
  {
    sub_1B885B0(&QuestInformationListViewItemDraw_DispMode_TypeInfo);
    sub_1B885B0(&UnityEngine_Vector3_TypeInfo);
  ...
  return System_String__Concat_61718044(v6, (Il2CppObject *)StringLiteral_117/*" "*/, v11, 0LL);
}
