...
void __fastcall QuestInformationListViewObject__Awake(QuestInformationListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B13165 & 1) == 0 )
  {
    sub_1BCA7E0(&Method_UnityEngine_GameObject_GetComponent_QuestInformationListViewItemDraw___, method, v2);
    byte_4B13165 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2F626D0 *)Method_UnityEngine_GameObject_GetComponent_QuestInformationListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B13168 & 1) == 0 )
  {
    sub_1BCA7E0(&Method_UnityEngine_GameObject_GetComponent_QuestInformationListViewObject___, method, v2);
    byte_4B13168 = 1;
  }
  ...
  if ( !DragObject
    || (v6 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_2F626D0 *)Method_UnityEngine_GameObject_GetComponent_QuestInformationListViewObject___)) == 0LL) )
  {
    sub_1BCAA3C(DragObject, v5);
  }
  QuestInformationListViewObject__Init_34675520((QuestInformationListViewObject_o *)DragObject, 3, v7);
  return v6;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B13167 & 1) == 0 )
  {
    sub_1BCA7E0(&QuestInformationListViewItem_TypeInfo, method, v2);
    byte_4B13167 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B13169 & 1) == 0 )
  {
    sub_1BCA7E0(&QuestInformationListViewItem_TypeInfo, *(_QWORD *)&initMode, callbackFunc);
    byte_4B13169 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall QuestInformationListViewObject__Init_34675520(
        QuestInformationListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall QuestInformationListViewObject__Init_34679120(
        QuestInformationListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall QuestInformationListViewObject__Init_34679204(
        QuestInformationListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
        ...
        const MethodInfo *method)
{
  ...
  QuestInformationListViewItemDraw_o *v13; // x0

  if ( (byte_4B1316A & 1) == 0 )
  {
    sub_1BCA7E0(&UnityEngine_Object_TypeInfo, method, v2);
    sub_1BCA7E0(&QuestInformationListViewItem_TypeInfo, v4, v5);
    byte_4B1316A = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
...
void __fastcall QuestInformationListViewObject__Start(QuestInformationListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    QuestInformationListViewObject__Init_34675520(this, 3, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1316B & 1) == 0 )
  {
    sub_1BCA7E0(&QuestInformationListViewItemDraw_DispMode_TypeInfo, method, v2);
    sub_1BCA7E0(&UnityEngine_Vector3_TypeInfo, v4, v5);
    sub_1BCA7E0(&StringLiteral_116/*" "*/, v6, v7);
    byte_4B1316B = 1;
  }
  dispMode = this->fields.dispMode;
  v8 = (Il2CppObject *)j_il2cpp_value_box_0(QuestInformationListViewItemDraw_DispMode_TypeInfo, &dispMode);
  v9 = *(_QWORD *)&this->fields.basePosition.fields.x;
  z = this->fields.basePosition.fields.z;
  v12 = v9;
  v10 = (Il2CppObject *)j_il2cpp_value_box_0(UnityEngine_Vector3_TypeInfo, &v12);
  return System_String__Concat_62412232(v8, (Il2CppObject *)StringLiteral_116/*" "*/, v10, 0LL);
}
