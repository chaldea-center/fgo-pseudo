...
int32_t EventBulletinBoardEntity__GetFollowId(EventBulletinBoardEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_5938553 & 1) == 0 )
  {
    sub_21FFC50(&Method_System_Linq_Enumerable_FirstOrDefault_EventBulletinBoardEntity_BulletinBoardInfo___);
  ...
  if ( script )
  {
    script = (struct EventBulletinBoardEntity_BulletinBoardInfo_array *)System_Linq_Enumerable__FirstOrDefault_object_(
                                                                          ...
                                                                          (const MethodInfo_384E0B0 *)Method_System_Linq_Enumerable_FirstOrDefault_EventBulletinBoardEntity_BulletinBoardInfo___);
    if ( script )
    {
      v4 = (int32_t)script->m_Items[1];
      v5 = (System_Nullable_int__o)&v7;
      v7 = 0;
      System_Nullable_int____ctor(v5, v4, (const MethodInfo_45B01D4 *)Method_System_Nullable_int___ctor__);
        ...
        const MethodInfo *method)
{
  ...
  if ( script
    && (v6 = System_Linq_Enumerable__FirstOrDefault_object_(
               script,
               (const MethodInfo_384E0B0 *)Method_System_Linq_Enumerable_FirstOrDefault_EventBulletinBoardEntity_BulletinBoardInfo___)) != 0 )
  {
    monitor_high = HIDWORD(v6[2].monitor);
    v8 = (System_Nullable_int__o)&v12;
    v12 = 0;
    System_Nullable_int____ctor(v8, monitor_high, (const MethodInfo_45B01D4 *)Method_System_Nullable_int___ctor__);
    v9 = HIDWORD(v12);
  }
  else
  {
