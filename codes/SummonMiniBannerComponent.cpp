        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FAE78 & 1) == 0 )
  {
    sub_1B64870(&Method_UnityEngine_GameObject_GetComponent_UIAtlas___, info);
    sub_1B64870(&UnityEngine_Object_TypeInfo, v17);
    byte_49FAE78 = 1;
  }
  this->fields.info = info;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.info, (int32_t)info, idx, moveIdx);
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.scrollPanel, (int32_t)parent, v20, v21);
  ...
  if ( ((unsigned __int8)Component_object & 1) == 0 )
  {
    ...
    {
      sub_1B64ACC(Component_object, v23);
    }
...
void __fastcall SummonMiniBannerComponent__Update(SummonMiniBannerComponent_o *this, const MethodInfo *method)
{
  ...
  GameObjectExtensions__SetLocalScale_33378564(v8, v7, v7, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FAE76 & 1) == 0 )
  {
    sub_1B64870(&SummonMiniBannerComponent_CallbackFunc_TypeInfo, value);
    byte_49FAE76 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19A8D6C;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19A8D24;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FAE7A & 1) == 0 )
  {
    sub_1B64870(&int_TypeInfo, *(_QWORD *)&moveIndex);
    byte_49FAE7A = 1;
  }
  v9[1] = 0LL;
