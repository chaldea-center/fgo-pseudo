        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC422A & 1) == 0 )
  {
    sub_1C1ABD4(&Method_UnityEngine_GameObject_GetComponent_UIAtlas___, info);
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.scrollPanel, (int64_t)parent, v24, v25, v26, v27, v28, v29);
  ...
  if ( ((unsigned __int8)Component_object & 1) == 0 )
  {
    ...
    {
      sub_1C1AE30(Component_object, v31);
    }
...
void __fastcall SummonMiniBannerComponent__Update(SummonMiniBannerComponent_o *this, const MethodInfo *method)
{
  ...
  GameObjectExtensions__SetLocalScale_34758488(v8, v7, v7, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC4228 & 1) == 0 )
  {
    sub_1C1ABD4(&SummonMiniBannerComponent_CallbackFunc_TypeInfo, value);
    byte_4BC4228 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A58510;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A584B8;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC422C & 1) == 0 )
  {
    sub_1C1ABD4(&bool_TypeInfo, *(_QWORD *)&moveIndex);
