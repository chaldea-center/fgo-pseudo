        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C3E8 & 1) == 0 )
  {
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponent_UIAtlas___, info);
    sub_1B715CC(&UnityEngine_Object_TypeInfo, v17);
    byte_4A1C3E8 = 1;
  }
  this->fields.info = info;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.info, (int32_t)info, idx, moveIdx);
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.scrollPanel, (int32_t)parent, v20, v21);
  ...
  if ( ((unsigned __int8)Component_object & 1) == 0 )
  {
    ...
    {
      sub_1B71828(Component_object, v23);
    }
...
void __fastcall SummonMiniBannerComponent__Update(SummonMiniBannerComponent_o *this, const MethodInfo *method)
{
  ...
  GameObjectExtensions__SetLocalScale_33531584(v8, v7, v7, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C3E6 & 1) == 0 )
  {
    sub_1B715CC(&SummonMiniBannerComponent_CallbackFunc_TypeInfo, value);
    byte_4A1C3E6 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19B5714;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19B56CC;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C3EA & 1) == 0 )
  {
    sub_1B715CC(&int_TypeInfo, *(_QWORD *)&moveIndex);
    byte_4A1C3EA = 1;
  }
  v9[1] = 0LL;
