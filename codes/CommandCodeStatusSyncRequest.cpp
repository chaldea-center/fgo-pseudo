        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFC52 & 1) == 0 )
  {
    sub_1B64870(&JsonManager_TypeInfo, changeCommandCodeIds);
    sub_1B64870(&StringLiteral_17739/*"changeCommandCodeIds"*/, v11);
    sub_1B64870(&StringLiteral_22834/*"revokeCommandCodeIds"*/, v12);
    sub_1B64870(&StringLiteral_20720/*"isLock"*/, v13);
    this = (CommandCodeStatusSyncRequest_o *)sub_1B64870(&StringLiteral_20705/*"isChoice"*/, v14);
    byte_49FFC52 = 1;
  }
  if ( changeCommandCodeIds && *(_QWORD *)&changeCommandCodeIds->max_length )
  {
    ...
    RequestBase__addField_40856068(v10, (System_String_o *)StringLiteral_17739/*"changeCommandCodeIds"*/, v15, 0LL);
  }
  if ( revokeCommandCodeIds && *(_QWORD *)&revokeCommandCodeIds->max_length )
  {
    ...
    RequestBase__addField_40856068(v10, (System_String_o *)StringLiteral_22834/*"revokeCommandCodeIds"*/, v16, 0LL);
  }
  if ( !v10 )
    sub_1B64ACC(this, changeCommandCodeIds);
  RequestBase__addField(v10, (System_String_o *)StringLiteral_20720/*"isLock"*/, isLock, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B64870(&NetworkManager_TypeInfo, method);
    sub_1B64870(&StringLiteral_18084/*"commandCode/statusSync"*/, v2);
    byte_49FFC50 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61383576(BaseUrl, (System_String_o *)StringLiteral_18084/*"commandCode/statusSync"*/, 0LL);
}
