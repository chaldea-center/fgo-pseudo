        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2E391 & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_17898/*"changeCommandCodeIds"*/);
    sub_1C94098(&StringLiteral_23333/*"revokeCommandCodeIds"*/);
    sub_1C94098(&StringLiteral_21113/*"isLock"*/);
    this = (CommandCodeStatusSyncRequest_o *)sub_1C94098(&StringLiteral_21088/*"isChoice"*/);
    byte_4D2E391 = 1;
  }
  if ( changeCommandCodeIds && changeCommandCodeIds->max_length )
  {
    ...
    RequestBase__addField_45016480(v10, (System_String_o *)StringLiteral_17898/*"changeCommandCodeIds"*/, v11, 0);
  }
  if ( revokeCommandCodeIds && revokeCommandCodeIds->max_length )
  {
    ...
    RequestBase__addField_45016480(v10, (System_String_o *)StringLiteral_23333/*"revokeCommandCodeIds"*/, v12, 0);
  }
  if ( !v10 )
    sub_1C942F0(this, changeCommandCodeIds);
  RequestBase__addField(v10, (System_String_o *)StringLiteral_21113/*"isLock"*/, isLock, 0);
  RequestBase__addField(v10, (System_String_o *)StringLiteral_21088/*"isChoice"*/, isChoice, 0);
...
System_String_o *CommandCodeStatusSyncRequest__getURL(CommandCodeStatusSyncRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C94098(&NetworkManager_TypeInfo);
    sub_1C94098(&StringLiteral_18254/*"commandCode/statusSync"*/);
    byte_4D2E38F = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64417744(BaseUrl, (System_String_o *)StringLiteral_18254/*"commandCode/statusSync"*/, 0);
}
