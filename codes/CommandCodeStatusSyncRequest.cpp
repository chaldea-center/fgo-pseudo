        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_43874C4 & 1) == 0 )
  {
    ...
    sub_B775C4(&StringLiteral_17617/*"changeCommandCodeIds"*/);
    sub_B775C4(&StringLiteral_22283/*"revokeCommandCodeIds"*/);
    sub_B775C4(&StringLiteral_20346/*"isLock"*/);
    this = (CommandCodeStatusSyncRequest_o *)sub_B775C4(&StringLiteral_20331/*"isChoice"*/);
    byte_43874C4 = 1;
  }
  if ( changeCommandCodeIds && *(_QWORD *)&changeCommandCodeIds->max_length )
  {
    ...
    RequestBase__addField_32565392(v10, (System_String_o *)StringLiteral_17617/*"changeCommandCodeIds"*/, v11, 0LL);
  }
  if ( revokeCommandCodeIds && *(_QWORD *)&revokeCommandCodeIds->max_length )
  {
    ...
    RequestBase__addField_32565392(v10, (System_String_o *)StringLiteral_22283/*"revokeCommandCodeIds"*/, v12, 0LL);
  }
  if ( !v10 )
    sub_B7769C(this, changeCommandCodeIds);
  RequestBase__addField(v10, (System_String_o *)StringLiteral_20346/*"isLock"*/, isLock, 0LL);
  RequestBase__addField(v10, (System_String_o *)StringLiteral_20331/*"isChoice"*/, isChoice, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B775C4(&NetworkManager_TypeInfo);
    sub_B775C4(&StringLiteral_17951/*"commandCode/statusSync"*/);
    byte_43874C2 = 1;
  }
  if ( (BYTE3(NetworkManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !NetworkManager_TypeInfo->_2.cctor_finished )
  ...
  return System_String__Concat_44901936(BaseUrl, (System_String_o *)StringLiteral_17951/*"commandCode/statusSync"*/, 0LL);
}
