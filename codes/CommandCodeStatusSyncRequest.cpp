        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDB57 & 1) == 0 )
  {
    sub_1B640C8(&JsonManager_TypeInfo, changeCommandCodeIds);
    sub_1B640C8(&StringLiteral_17737/*"changeCommandCodeIds"*/, v11);
    sub_1B640C8(&StringLiteral_22831/*"revokeCommandCodeIds"*/, v12);
    sub_1B640C8(&StringLiteral_20717/*"isLock"*/, v13);
    this = (CommandCodeStatusSyncRequest_o *)sub_1B640C8(&StringLiteral_20702/*"isChoice"*/, v14);
    byte_49FDB57 = 1;
  }
  if ( changeCommandCodeIds && *(_QWORD *)&changeCommandCodeIds->max_length )
  {
    ...
    RequestBase__addField_40850936(v10, (System_String_o *)StringLiteral_17737/*"changeCommandCodeIds"*/, v15, 0LL);
  }
  if ( revokeCommandCodeIds && *(_QWORD *)&revokeCommandCodeIds->max_length )
  {
    ...
    RequestBase__addField_40850936(v10, (System_String_o *)StringLiteral_22831/*"revokeCommandCodeIds"*/, v16, 0LL);
  }
  if ( !v10 )
    sub_1B64324(this);
  RequestBase__addField(v10, (System_String_o *)StringLiteral_20717/*"isLock"*/, isLock, 0LL);
  RequestBase__addField(v10, (System_String_o *)StringLiteral_20702/*"isChoice"*/, isChoice, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B640C8(&NetworkManager_TypeInfo, method);
    sub_1B640C8(&StringLiteral_18082/*"commandCode/statusSync"*/, v2);
    byte_49FDB55 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61375396(BaseUrl, (System_String_o *)StringLiteral_18082/*"commandCode/statusSync"*/, 0LL);
}
