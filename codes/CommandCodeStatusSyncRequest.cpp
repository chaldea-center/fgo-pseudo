        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FA5D8 & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_17206, v11);
    sub_B16FFC(&StringLiteral_21726, v12);
    sub_B16FFC(&StringLiteral_19857, v13);
    sub_B16FFC(&StringLiteral_19843, v14);
    byte_40FA5D8 = 1;
  }
  if ( changeCommandCodeIds && *(_QWORD *)&changeCommandCodeIds->max_length )
  {
    ...
    RequestBase__addField_30957164((RequestBase_o *)this, (System_String_o *)StringLiteral_17206, v15, 0LL);
  }
  if ( revokeCommandCodeIds && *(_QWORD *)&revokeCommandCodeIds->max_length )
  {
    ...
    RequestBase__addField_30957164((RequestBase_o *)this, (System_String_o *)StringLiteral_21726, v16, 0LL);
  }
  if ( !this )
    sub_B170D4();
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B16FFC(&NetworkManager_TypeInfo, method);
    sub_B16FFC(&StringLiteral_17530, v2);
    byte_40FA5D6 = 1;
  }
  if ( (BYTE3(NetworkManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !NetworkManager_TypeInfo->_2.cctor_finished )
  ...
  return System_String__Concat_43743732(BaseUrl, (System_String_o *)StringLiteral_17530, 0LL);
}
