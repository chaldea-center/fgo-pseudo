        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB7DC7 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_17823/*"changeCommandCodeIds"*/);
    sub_1C6BA08(&StringLiteral_23199/*"revokeCommandCodeIds"*/);
    sub_1C6BA08(&StringLiteral_20996/*"isLock"*/);
    this = (CommandCodeStatusSyncRequest_o *)sub_1C6BA08(&StringLiteral_20974/*"isChoice"*/);
    byte_4CB7DC7 = 1;
  }
  if ( changeCommandCodeIds && changeCommandCodeIds->max_length )
  {
    ...
    RequestBase__addField_44471996(v10, (System_String_o *)StringLiteral_17823/*"changeCommandCodeIds"*/, v11, 0);
  }
  if ( revokeCommandCodeIds && revokeCommandCodeIds->max_length )
  {
    ...
    RequestBase__addField_44471996(v10, (System_String_o *)StringLiteral_23199/*"revokeCommandCodeIds"*/, v12, 0);
  }
  if ( !v10 )
    sub_1C6BC60(this, changeCommandCodeIds);
  RequestBase__addField(v10, (System_String_o *)StringLiteral_20996/*"isLock"*/, isLock, 0);
  RequestBase__addField(v10, (System_String_o *)StringLiteral_20974/*"isChoice"*/, isChoice, 0);
...
System_String_o *CommandCodeStatusSyncRequest__getURL(CommandCodeStatusSyncRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C6BA08(&NetworkManager_TypeInfo);
    sub_1C6BA08(&StringLiteral_18179/*"commandCode/statusSync"*/);
    byte_4CB7DC5 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63966792(BaseUrl, (System_String_o *)StringLiteral_18179/*"commandCode/statusSync"*/, 0);
}
