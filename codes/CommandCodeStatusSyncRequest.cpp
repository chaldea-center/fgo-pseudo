        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A00273 & 1) == 0 )
  {
    sub_1B64A00(&JsonManager_TypeInfo, changeCommandCodeIds);
    sub_1B64A00(&StringLiteral_17740/*"changeCommandCodeIds"*/, v11);
    sub_1B64A00(&StringLiteral_22834/*"revokeCommandCodeIds"*/, v12);
    sub_1B64A00(&StringLiteral_20720/*"isLock"*/, v13);
    this = (CommandCodeStatusSyncRequest_o *)sub_1B64A00(&StringLiteral_20705/*"isChoice"*/, v14);
    byte_4A00273 = 1;
  }
  if ( changeCommandCodeIds && *(_QWORD *)&changeCommandCodeIds->max_length )
  {
    ...
    RequestBase__addField_40856580(v10, (System_String_o *)StringLiteral_17740/*"changeCommandCodeIds"*/, v15, 0LL);
  }
  if ( revokeCommandCodeIds && *(_QWORD *)&revokeCommandCodeIds->max_length )
  {
    ...
    RequestBase__addField_40856580(v10, (System_String_o *)StringLiteral_22834/*"revokeCommandCodeIds"*/, v16, 0LL);
  }
  if ( !v10 )
    sub_1B64C5C(this, changeCommandCodeIds);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B64A00(&NetworkManager_TypeInfo, method);
    sub_1B64A00(&StringLiteral_18085/*"commandCode/statusSync"*/, v2);
    byte_4A00271 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61385136(BaseUrl, (System_String_o *)StringLiteral_18085/*"commandCode/statusSync"*/, 0LL);
}
