        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3EAE & 1) == 0 )
  {
    sub_1B00CCC(&JsonManager_TypeInfo, changeCommandCodeIds);
    sub_1B00CCC(&StringLiteral_17563/*"changeCommandCodeIds"*/, v11);
    sub_1B00CCC(&StringLiteral_22609/*"revokeCommandCodeIds"*/, v12);
    sub_1B00CCC(&StringLiteral_20517/*"isLock"*/, v13);
    this = (CommandCodeStatusSyncRequest_o *)sub_1B00CCC(&StringLiteral_20502/*"isChoice"*/, v14);
    byte_48E3EAE = 1;
  }
  if ( changeCommandCodeIds && *(_QWORD *)&changeCommandCodeIds->max_length )
  {
    ...
    RequestBase__addField_39752868(v10, (System_String_o *)StringLiteral_17563/*"changeCommandCodeIds"*/, v15, v16);
  }
  if ( revokeCommandCodeIds && *(_QWORD *)&revokeCommandCodeIds->max_length )
  {
    ...
    RequestBase__addField_39752868(v10, (System_String_o *)StringLiteral_22609/*"revokeCommandCodeIds"*/, v17, v18);
  }
  if ( !v10 )
    sub_1B00F28(this, changeCommandCodeIds);
  RequestBase__addField(v10, (System_String_o *)StringLiteral_20517/*"isLock"*/, isLock, (const MethodInfo *)isLock);
  RequestBase__addField(v10, (System_String_o *)StringLiteral_20502/*"isChoice"*/, isChoice, v19);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B00CCC(&NetworkManager_TypeInfo, method);
    sub_1B00CCC(&StringLiteral_17906/*"commandCode/statusSync"*/, v2);
    byte_48E3EAC = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_60325748(BaseUrl, (System_String_o *)StringLiteral_17906/*"commandCode/statusSync"*/, 0LL);
}
