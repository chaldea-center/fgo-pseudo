        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B68483 & 1) == 0 )
  {
    sub_1BE4ACC(&JsonManager_TypeInfo, changeCommandCodeIds);
    sub_1BE4ACC(&StringLiteral_18041/*"changeCommandCodeIds"*/, v11);
    sub_1BE4ACC(&StringLiteral_23252/*"revokeCommandCodeIds"*/, v12);
    sub_1BE4ACC(&StringLiteral_21096/*"isLock"*/, v13);
    this = (CommandCodeStatusSyncRequest_o *)sub_1BE4ACC(&StringLiteral_21079/*"isChoice"*/, v14);
    byte_4B68483 = 1;
  }
  if ( changeCommandCodeIds && *(_QWORD *)&changeCommandCodeIds->max_length )
  {
    ...
    RequestBase__addField_42104408(v10, (System_String_o *)StringLiteral_18041/*"changeCommandCodeIds"*/, v15, v16);
  }
  if ( revokeCommandCodeIds && *(_QWORD *)&revokeCommandCodeIds->max_length )
  {
    ...
    RequestBase__addField_42104408(v10, (System_String_o *)StringLiteral_23252/*"revokeCommandCodeIds"*/, v17, v18);
  }
  if ( !v10 )
    sub_1BE4D28(this, changeCommandCodeIds);
  RequestBase__addField(v10, (System_String_o *)StringLiteral_21096/*"isLock"*/, isLock, (const MethodInfo *)isLock);
  RequestBase__addField(v10, (System_String_o *)StringLiteral_21079/*"isChoice"*/, isChoice, v19);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BE4ACC(&NetworkManager_TypeInfo, method);
    sub_1BE4ACC(&StringLiteral_18389/*"commandCode/statusSync"*/, v2);
    byte_4B68481 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62698808(BaseUrl, (System_String_o *)StringLiteral_18389/*"commandCode/statusSync"*/, 0LL);
}
