...
void FollowAssignRequest__beginRequest(FollowAssignRequest_o *this, int64_t targetUserId, const MethodInfo *method)
{
  ...
  RequestBase__addField_44144740((RequestBase_o *)this, (System_String_o *)StringLiteral_19515/*"followId"*/, targetUserId, 0);
...
System_String_o *FollowAssignRequest__getURL(FollowAssignRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C394ED & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_19513/*"follow/assign"*/);
    byte_4C394ED = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63518544(BaseUrl, (System_String_o *)StringLiteral_19513/*"follow/assign"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C394EF & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_FollowAssignRequest_requestErrorDialog__);
