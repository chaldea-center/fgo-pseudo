        ...
        const MethodInfo *method)
{
  if ( (byte_41869CC & 1) == 0 )
  {
    sub_B2C35C(&StringLiteral_18781/*"followId"*/, targetUserId);
    byte_41869CC = 1;
  }
  RequestBase__addField_31051460((RequestBase_o *)this, (System_String_o *)StringLiteral_18781/*"followId"*/, targetUserId, 0LL);
...
System_String_o *__fastcall FollowAssignRequest__getURL(FollowAssignRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_41869CB & 1) == 0 )
  {
    ...
    sub_B2C35C(&StringLiteral_18779/*"follow/assign"*/, v2);
    byte_41869CB = 1;
  }
  ...
  return System_String__Concat_44305532(BaseUrl, (System_String_o *)StringLiteral_18779/*"follow/assign"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_41869CD & 1) == 0 )
  {
    ...
    sub_B2C35C(&Method_FollowAssignRequest_requestErrorDialog__, v7);
...
LABEL_20:
  ...
  if ( ((unsigned __int8)v20 & 1) != 0 )
  {
    ...
    if ( (System_String_c *)v20->klass == string_TypeInfo )
      goto LABEL_26;
    v20 = (UnityEngine_Purchasing_IStoreExtension_o *)sub_B2C728(v20);
  }
