        ...
        const MethodInfo *method)
{
  if ( (byte_42AE9EF & 1) == 0 )
  {
    sub_B52984(&StringLiteral_18922/*"followId"*/);
    byte_42AE9EF = 1;
  }
  RequestBase__addField_32020452((RequestBase_o *)this, (System_String_o *)StringLiteral_18922/*"followId"*/, targetUserId, 0LL);
...
System_String_o *__fastcall FollowAssignRequest__getURL(FollowAssignRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42AE9EE & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_18920/*"follow/assign"*/);
    byte_42AE9EE = 1;
  }
  ...
  return System_String__Concat_44568316(BaseUrl, (System_String_o *)StringLiteral_18920/*"follow/assign"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AE9F0 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_FollowAssignRequest_requestErrorDialog__);
...
LABEL_20:
  ...
  if ( ((unsigned __int8)v7 & 1) != 0 )
  {
    ...
    if ( (System_String_c *)v7->klass == string_TypeInfo )
      goto LABEL_26;
    v7 = (UnityEngine_Purchasing_IStoreExtension_o *)sub_B52D50(v7);
  }
