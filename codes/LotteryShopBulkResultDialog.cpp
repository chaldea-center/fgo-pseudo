void LotteryShopBulkResultDialog___cctor(const MethodInfo *method)
{
  if ( (byte_4CE8E9F & 1) == 0 )
  {
    sub_1C7BAE8(&LotteryShopBulkResultDialog_TypeInfo);
    byte_4CE8E9F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CE8E9C & 1) == 0 )
  {
    this = (LotteryShopBulkResultDialog_o *)sub_1C7BAE8(&UnityEngine_Object_TypeInfo);
    byte_4CE8E9C = 1;
  }
  if ( !grid )
    goto LABEL_13;
...
void LotteryShopBulkResultDialog__OnClickCloseButton(LotteryShopBulkResultDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CE8E9B & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_LotteryShopBulkResultDialog_OnClickCloseButton__);
    sub_1C7BAE8(&Method_LotteryShopBulkResultDialog__OnClickCloseButton_b__12_0__);
    byte_4CE8E9B = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( (*((_BYTE *)Method_LotteryShopBulkResultDialog_OnClickCloseButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C7BB00(Method_LotteryShopBulkResultDialog_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CE8E9A & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_UnityEngine_GameObject_GetComponent_LotteryShopResultItem___);
    ...
    sub_1C7BAE8(&LocalizationManager_TypeInfo);
    sub_1C7BAE8(&Method_LotteryShopBulkResultDialog__Open_b__11_0__);
    sub_1C7BAE8(&LotteryShopBulkResultDialog_TypeInfo);
    sub_1C7BAE8(&StringLiteral_3691/*"COMMON_CONFIRM_CLOSE"*/);
    sub_1C7BAE8(&StringLiteral_8364/*"LOTTERY_SHOP_BULK_BUY_RESULT_TITLE"*/);
    sub_1C7BAE8(&StringLiteral_8363/*"LOTTERY_SHOP_BULK_BUY_RESULT_MESSAGE"*/);
    byte_4CE8E9A = 1;
  }
  memset(&v29, 0, 32);
  this->fields.closeAction = onClose;
  sub_1C7BA8C(&this->fields.closeAction, onClose);
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  resultemPrefab = LocalizationManager__Get((System_String_o *)StringLiteral_8364/*"LOTTERY_SHOP_BULK_BUY_RESULT_TITLE"*/, 0);
  if ( !titleLabel )
    goto LABEL_30;
  UILabel__set_text(titleLabel, resultemPrefab, 0);
  messageLabel = this->fields.messageLabel;
  resultemPrefab = LocalizationManager__Get((System_String_o *)StringLiteral_8363/*"LOTTERY_SHOP_BULK_BUY_RESULT_MESSAGE"*/, 0);
  if ( !messageLabel )
    goto LABEL_30;
  UILabel__set_text(messageLabel, resultemPrefab, 0);
  closeLabel = this->fields.closeLabel;
  resultemPrefab = LocalizationManager__Get((System_String_o *)StringLiteral_3691/*"COMMON_CONFIRM_CLOSE"*/, 0);
  if ( !closeLabel )
    goto LABEL_30;
  UILabel__set_text(closeLabel, resultemPrefab, 0);
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  DataManager__GetMaster_object_((const MethodInfo_31703A0 *)Method_DataManager_GetMaster_GiftMaster___);
  ...
  Count = System_Collections_Generic_Dictionary_int__bool___get_Count(
            dataDic,
            (const MethodInfo_3478B5C *)Method_System_Collections_Generic_Dictionary_int__bool__get_Count__);
  ...
  *(_OWORD *)&v29.fields._dictionary = v28[0];
  ...
  while ( 1 )
  {
    ...
    Component_object = UnityEngine_GameObject__GetComponent_object_(
                         Object,
                         (const MethodInfo_31C70C8 *)Method_UnityEngine_GameObject_GetComponent_LotteryShopResultItem___);
    if ( !Component_object )
      sub_1C7BD40(0, v25);
