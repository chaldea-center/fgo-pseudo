void LotteryShopBulkResultDialog___cctor(const MethodInfo *method)
{
  if ( (byte_4CC1BFB & 1) == 0 )
  {
    sub_1C713B0(&LotteryShopBulkResultDialog_TypeInfo);
    byte_4CC1BFB = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC1BF8 & 1) == 0 )
  {
    this = (LotteryShopBulkResultDialog_o *)sub_1C713B0(&UnityEngine_Object_TypeInfo);
    byte_4CC1BF8 = 1;
  }
  if ( !grid )
    goto LABEL_13;
...
void LotteryShopBulkResultDialog__OnClickCloseButton(LotteryShopBulkResultDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC1BF7 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_LotteryShopBulkResultDialog_OnClickCloseButton__);
    sub_1C713B0(&Method_LotteryShopBulkResultDialog__OnClickCloseButton_b__12_0__);
    byte_4CC1BF7 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( (*((_BYTE *)Method_LotteryShopBulkResultDialog_OnClickCloseButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C713C8(Method_LotteryShopBulkResultDialog_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC1BF6 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_UnityEngine_GameObject_GetComponent_LotteryShopResultItem___);
    ...
    sub_1C713B0(&LocalizationManager_TypeInfo);
    sub_1C713B0(&Method_LotteryShopBulkResultDialog__Open_b__11_0__);
    sub_1C713B0(&LotteryShopBulkResultDialog_TypeInfo);
    sub_1C713B0(&StringLiteral_3680/*"COMMON_CONFIRM_CLOSE"*/);
    sub_1C713B0(&StringLiteral_8341/*"LOTTERY_SHOP_BULK_BUY_RESULT_TITLE"*/);
    sub_1C713B0(&StringLiteral_8340/*"LOTTERY_SHOP_BULK_BUY_RESULT_MESSAGE"*/);
    byte_4CC1BF6 = 1;
  }
  memset(&v29, 0, 32);
  this->fields.closeAction = onClose;
  sub_1C71354(&this->fields.closeAction, onClose);
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  resultemPrefab = LocalizationManager__Get((System_String_o *)StringLiteral_8341/*"LOTTERY_SHOP_BULK_BUY_RESULT_TITLE"*/, 0);
  if ( !titleLabel )
    goto LABEL_30;
  UILabel__set_text(titleLabel, resultemPrefab, 0);
  messageLabel = this->fields.messageLabel;
  resultemPrefab = LocalizationManager__Get((System_String_o *)StringLiteral_8340/*"LOTTERY_SHOP_BULK_BUY_RESULT_MESSAGE"*/, 0);
  if ( !messageLabel )
    goto LABEL_30;
  UILabel__set_text(messageLabel, resultemPrefab, 0);
  closeLabel = this->fields.closeLabel;
  resultemPrefab = LocalizationManager__Get((System_String_o *)StringLiteral_3680/*"COMMON_CONFIRM_CLOSE"*/, 0);
  if ( !closeLabel )
    goto LABEL_30;
  UILabel__set_text(closeLabel, resultemPrefab, 0);
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  DataManager__GetMaster_object_((const MethodInfo_314B0B8 *)Method_DataManager_GetMaster_GiftMaster___);
  ...
  Count = System_Collections_Generic_Dictionary_int__bool___get_Count(
            dataDic,
            (const MethodInfo_34536E0 *)Method_System_Collections_Generic_Dictionary_int__bool__get_Count__);
  ...
  *(_OWORD *)&v29.fields._dictionary = v28[0];
  ...
  while ( 1 )
  {
    ...
    Component_object = UnityEngine_GameObject__GetComponent_object_(
                         Object,
                         (const MethodInfo_31A2ED0 *)Method_UnityEngine_GameObject_GetComponent_LotteryShopResultItem___);
    if ( !Component_object )
      sub_1C71608(0, v25);
