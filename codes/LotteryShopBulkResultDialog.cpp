void __fastcall LotteryShopBulkResultDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A005C0 & 1) == 0 )
  {
    sub_1B640C8(&LotteryShopBulkResultDialog_TypeInfo, v1);
    byte_4A005C0 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A005BD & 1) == 0 )
  {
    this = (LotteryShopBulkResultDialog_o *)sub_1B640C8(&UnityEngine_Object_TypeInfo, grid);
    byte_4A005BD = 1;
  }
  if ( !grid )
    goto LABEL_13;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A005BC & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_LotteryShopBulkResultDialog_OnClickCloseButton__, v3);
    sub_1B640C8(&Method_LotteryShopBulkResultDialog__OnClickCloseButton_b__12_0__, v4);
    byte_4A005BC = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( (*((_BYTE *)Method_LotteryShopBulkResultDialog_OnClickCloseButton__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B640E0(Method_LotteryShopBulkResultDialog_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  int32_t Count; // w0
  LotteryShopBulkResultDialog_c *v28; // x8
  int32_t v29; // w21
  __int64 v30; // x8
  ...
  __int128 v42[2]; // [xsp+0h] [xbp-90h] BYREF
  System_Collections_Generic_Dictionary_Enumerator_TKey__TValue__o v43; // [xsp+20h] [xbp-70h] BYREF

  if ( (byte_4A005BB & 1) == 0 )
  {
    sub_1B640C8(&System_Action_TypeInfo, dataDic);
    ...
    sub_1B640C8(&Method_System_Collections_Generic_Dictionary_Enumerator_int__bool__Dispose__, v11);
    sub_1B640C8(&Method_System_Collections_Generic_Dictionary_Enumerator_int__bool__MoveNext__, v12);
    sub_1B640C8(&Method_System_Collections_Generic_Dictionary_Enumerator_int__bool__get_Current__, v13);
    sub_1B640C8(&Method_UnityEngine_GameObject_GetComponent_LotteryShopResultItem___, v14);
    sub_1B640C8(&Method_System_Collections_Generic_KeyValuePair_int__bool__get_Key__, v15);
    sub_1B640C8(&Method_System_Collections_Generic_KeyValuePair_int__bool__get_Value__, v16);
    sub_1B640C8(&LocalizationManager_TypeInfo, v17);
    sub_1B640C8(&Method_LotteryShopBulkResultDialog__Open_b__11_0__, v18);
    sub_1B640C8(&LotteryShopBulkResultDialog_TypeInfo, v19);
    sub_1B640C8(&StringLiteral_3734/*"COMMON_CONFIRM_CLOSE"*/, v20);
    sub_1B640C8(&StringLiteral_8274/*"LOTTERY_SHOP_BULK_BUY_RESULT_TITLE"*/, v21);
    sub_1B640C8(&StringLiteral_8273/*"LOTTERY_SHOP_BULK_BUY_RESULT_MESSAGE"*/, v22);
    byte_4A005BB = 1;
  }
  memset(&v43, 0, 32);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  resultemPrefab = LocalizationManager__Get((System_String_o *)StringLiteral_8274/*"LOTTERY_SHOP_BULK_BUY_RESULT_TITLE"*/, 0LL);
  if ( !titleLabel )
    goto LABEL_30;
  UILabel__set_text(titleLabel, resultemPrefab, 0LL);
  messageLabel = this->fields.messageLabel;
  resultemPrefab = LocalizationManager__Get((System_String_o *)StringLiteral_8273/*"LOTTERY_SHOP_BULK_BUY_RESULT_MESSAGE"*/, 0LL);
  if ( !messageLabel )
    goto LABEL_30;
  ...
  DataManager__GetMaster_object_((const MethodInfo_2E39398 *)Method_DataManager_GetMaster_GiftMaster___);
  ...
  Count = System_Collections_Generic_Dictionary_int__bool___get_Count(
            dataDic,
            (const MethodInfo_3114DA8 *)Method_System_Collections_Generic_Dictionary_int__bool__get_Count__);
  v28 = LotteryShopBulkResultDialog_TypeInfo;
  v29 = Count;
  ...
  v30 = v29 <= v28->static_fields->newLineItemCount ? 120LL : 128LL;
  v31 = *(UnityEngine_Component_o **)((char *)&this->klass + v30);
  ...
  *(_OWORD *)&v43.fields._dictionary = v42[0];
  v43.fields._current = (struct System_Collections_Generic_KeyValuePair_TKey__TValue__o)v42[1];
  while ( 1 )
  {
    v32 = System_Collections_Generic_Dictionary_Enumerator_int__bool___MoveNext(
            &v43,
    ...
    v34 = this->fields.resultemPrefab;
    ...
    Component_object = UnityEngine_GameObject__GetComponent_object_(
                         Object,
                         (const MethodInfo_2E87ED8 *)Method_UnityEngine_GameObject_GetComponent_LotteryShopResultItem___);
    if ( !Component_object )
      sub_1B64324(0LL);
  ...
  {
LABEL_30:
    sub_1B64324(resultemPrefab);
  }
  UIGrid__set_repositionNow((UIGrid_o *)resultemPrefab, 1, 0LL);
  v41 = (System_Action_o *)sub_1B64314(System_Action_TypeInfo, v39, v40);
  System_Action___ctor(v41, (Il2CppObject *)this, Method_LotteryShopBulkResultDialog__Open_b__11_0__, 0LL);
