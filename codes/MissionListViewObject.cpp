...
void __fastcall MissionListViewObject__Awake(MissionListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B20067 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_UnityEngine_GameObject_GetComponent_MissionListViewItemDraw___, method);
    byte_4B20067 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_306E710 *)Method_UnityEngine_GameObject_GetComponent_MissionListViewItemDraw___);
...
void __fastcall MissionListViewObject__CommonEventMoveEnd(MissionListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( onCompleteMoveAction )
  {
    ...
    sub_1BCAF9C(p_onCompleteMoveAction, 0, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B2006A & 1) == 0 )
  {
    sub_1BCAFF8(&Method_UnityEngine_GameObject_GetComponent_MissionListViewObject___, method);
    byte_4B2006A = 1;
  }
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_306E710 *)Method_UnityEngine_GameObject_GetComponent_MissionListViewObject___)) == 0LL) )
  {
...
void __fastcall MissionListViewObject__EventExitMove(MissionListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B20072 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_9802/*"OnCompleteEventExitMove"*/, v4);
    byte_4B20072 = 1;
  }
...
LABEL_15:
    ...
    sub_1BCAF9C((CGThumbnailListItem_o *)&v17[3].monitor, (int32_t)gameObject, v19, v20);
    v21 = StringLiteral_9802/*"OnCompleteEventExitMove"*/;
    *(_QWORD *)&v17[3].fields.m_CachedPtr = StringLiteral_9802/*"OnCompleteEventExitMove"*/;
    sub_1BCAF9C((CGThumbnailListItem_o *)&v17[3].fields, v21, v22, v23);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B20071 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_6164/*"EventExitMove"*/, v7);
    byte_4B20071 = 1;
  }
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.dragObject, (int32_t)v8, v9, v10);
  dragObject = this->fields.dragObject;
  if ( !dragObject )
    goto LABEL_10;
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dragObject,
                       (const MethodInfo_306E710 *)Method_UnityEngine_GameObject_GetComponent_MissionListViewObject___);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
...
void __fastcall MissionListViewObject__EventIntoMove(MissionListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BCAFF8(&ListViewObject_TypeInfo, method);
    sub_1BCAFF8(&StringLiteral_9803/*"OnCompleteEventIntoMove"*/, v3);
    byte_4B2006F = 1;
  }
  dragObject = this->fields.dragObject;
  if ( !dragObject )
...
LABEL_11:
  ...
  v18 = StringLiteral_9803/*"OnCompleteEventIntoMove"*/;
  *(_QWORD *)&v14[3].fields.m_CachedPtr = StringLiteral_9803/*"OnCompleteEventIntoMove"*/;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BCAFF8(&Method_UnityEngine_GameObject_GetComponent_MissionListViewObject___, method);
    sub_1BCAFF8(&StringLiteral_6175/*"EventIntoMove"*/, v6);
    byte_4B2006E = 1;
  }
  this->fields.isBusy = 1;
  this->fields.dispMode = 0;
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.dragObject, (int32_t)v7, v9, v10);
  dragObject = this->fields.dragObject;
  if ( !dragObject
    || (dragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                   dragObject,
    ...
    || (transform = UnityEngine_GameObject__get_transform(dragObject, 0LL),
        (dragObject = (UnityEngine_GameObject_o *)UnityEngine_Component__get_transform(
                                                    ...
                                                    0LL)) == 0LL)
    || (*(UnityEngine_Vector3_o *)&v15 = UnityEngine_Transform__TransformPoint_70162676(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B2006C & 1) == 0 )
  {
    sub_1BCAFF8(&MissionListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4B2006C = 1;
  }
  ...
  p_onCompleteMoveAction = (CGThumbnailListItem_o *)&this->fields.onCompleteMoveAction;
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.onCompleteMoveAction, (int32_t)onCompleteMove, v19, v20);
  v24 = 1;
  switch ( v13 )
  {
    case 0:
...
LABEL_20:
      ...
      {
        p_onCompleteMoveAction->klass = 0LL;
        sub_1BCAF9C(p_onCompleteMoveAction, 0, (int32_t)v22, v23);
...
void __fastcall MissionListViewObject__Init_47192200(
        MissionListViewObject_o *this,
        int32_t initMode,
        bool isColliderEnable,
        const MethodInfo *method)
...
void __fastcall MissionListViewObject__Init_47193980(
        MissionListViewObject_o *this,
        int32_t initMode,
        System_Action_o *onCompleteMove,
        bool isColliderEnable,
...
void __fastcall MissionListViewObject__OnClickReward(MissionListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B20075 & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_9789/*"OnClickRewardIcon"*/, method);
    byte_4B20075 = 1;
  }
  manager = (UnityEngine_Component_o *)this->fields.manager;
  if ( !manager )
    sub_1BCB254(0LL, method);
  UnityEngine_Component__SendMessage(manager, (System_String_o *)StringLiteral_9789/*"OnClickRewardIcon"*/, (Il2CppObject *)this, 0LL);
}
...
void __fastcall MissionListViewObject__OnLongPressReward(MissionListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B20076 & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_9845/*"OnLongPressRewardIcon"*/, method);
    byte_4B20076 = 1;
  }
  manager = (UnityEngine_Component_o *)this->fields.manager;
  if ( !manager )
    sub_1BCB254(0LL, method);
  UnityEngine_Component__SendMessage(manager, (System_String_o *)StringLiteral_9845/*"OnLongPressRewardIcon"*/, (Il2CppObject *)this, 0LL);
}
...
void __fastcall MissionListViewObject__RedispResTime(MissionListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B2006B & 1) == 0 )
  {
    sub_1BCAFF8(&MissionListViewItem_TypeInfo, method);
...
void __fastcall MissionListViewObject__SetInput(MissionListViewObject_o *this, bool isInput, const MethodInfo *method)
{
  ...
  if ( (byte_4B20069 & 1) == 0 )
  {
    sub_1BCAFF8(&MissionListViewItem_TypeInfo, isInput);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B2006D & 1) == 0 )
  {
    sub_1BCAFF8(&MissionListViewItem_TypeInfo, isColliderEnable);
    sub_1BCAFF8(&UnityEngine_Object_TypeInfo, v5);
    byte_4B2006D = 1;
  }
  linkItem = this->fields.linkItem;
  ...
  if ( UnityEngine_Object__op_Inequality(itemDraw, 0LL, 0LL) )
  {
    sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.manager, (int32_t)this->fields.manager, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  while ( 1 )
  {
    ...
    v9 = sub_1C05088(p_onCompleteMoveAction, v8, v6);
