        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD234 & 1) == 0 )
  {
    this = (UserNameEntryComponent_o *)sub_1B64870(
  ...
  if ( !centerChild
    ...
    || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                             ...
                             (const MethodInfo_2E8A1B4 *)Method_UnityEngine_GameObject_GetComponent_GenderSelectControl___),
        v2->fields.genderSel = (struct GenderSelectControl_o *)Component_object,
        sub_1B64814((ServantStatusBattleListViewItem_o *)&v2->fields.genderSel, (int32_t)Component_object, v5, v6),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD233 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_UserNameEntryComponent__callbackUserNameChange_b__33_0__, v8);
  ...
  if ( System_String__op_Equality(result, (System_String_o *)StringLiteral_22140/*"ok"*/, 0LL) )
  {
    ...
    {
      v13 = SelfUserGame;
      Instance = (NetworkManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE318 *)Method_SingletonMonoBehaviour_NetworkManager__get_Instance__);
      if ( !Instance )
        goto LABEL_15;
...
void __fastcall UserNameEntryComponent__close(UserNameEntryComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FD22C & 1) == 0 )
  {
    this = (UserNameEntryComponent_o *)sub_1B64870(&UnityEngine_Object_TypeInfo, method);
    byte_49FD22C = 1;
  }
  ...
  if ( masterFigureList )
  {
    ...
    sub_1B64814(p_masterFigureList, 0, v2, v3);
  }
}
...
void __fastcall UserNameEntryComponent__endConfirm(UserNameEntryComponent_o *this, bool res, const MethodInfo *method)
{
  ...
  if ( (byte_49FD231 & 1) == 0 )
  {
    sub_1B64870(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, res);
    byte_49FD231 = 1;
  }
  if ( res )
...
void __fastcall UserNameEntryComponent__onChangeInput(UserNameEntryComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (System_String__IndexOf_61415144(Text, (System_String_o *)StringLiteral_43/*"\n"*/, 0LL) & 0x80000000) != 0 )
  {
...
LABEL_22:
    sub_1B64ACC(entryNameInput, method);
  }
LABEL_12:
  IsNullOrEmpty = 1;
LABEL_13:
...
void __fastcall UserNameEntryComponent__onClickInput(UserNameEntryComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FD22F & 1) == 0 )
  {
    sub_1B64870(&Method_UserNameEntryComponent_onClickInput__, method);
    byte_49FD22F = 1;
  }
  v3 = Method_UserNameEntryComponent_onClickInput__;
  if ( (*((_BYTE *)Method_UserNameEntryComponent_onClickInput__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B64888(Method_UserNameEntryComponent_onClickInput__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD22B & 1) == 0 )
  {
    sub_1B64870(&System_Action_TypeInfo, closed_act);
    sub_1B64870(&AvalonSceneManager_TypeInfo, v6);
    sub_1B64870(&Method_DataManager_GetMasterData_EquipMaster___, v7);
    sub_1B64870(&Method_DataMasterBase_EquipMaster__EquipEntity__int__GetEntity__, v8);
    sub_1B64870(&Method_EmojiUtility_ValidateNameText__, v9);
    sub_1B64870(&Method_UnityEngine_GameObject_GetComponent_ScrollArrowComponent___, v10);
    ...
    sub_1B64870(&UIInput_OnValidate_TypeInfo, v15);
    ...
    sub_1B64870(&Method_UserNameEntryComponent___c__open_b__25_0__, v18);
    sub_1B64870(&UserNameEntryComponent___c_TypeInfo, v19);
    sub_1B64870(&UIMasterFullFigureTexture___TypeInfo, v20);
    sub_1B64870(&StringLiteral_7351/*"INPUT_NAME_INFO"*/, v21);
    sub_1B64870(&StringLiteral_7350/*"INPUT_NAME_ANNOUNCE"*/, v22);
    sub_1B64870(&StringLiteral_11451/*"SELECT_FIGURE_INFO"*/, v23);
    sub_1B64870(&StringLiteral_7352/*"INPUT_NAME_LIMIT_NUM"*/, v24);
    byte_49FD22B = 1;
  }
  this->fields.mClosedAct = closed_act;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.mClosedAct, (int32_t)closed_act, (int32_t)method, v3);
  UnityEngine_Input__set_imeCompositionMode(1, 0LL);
  mInput = this->fields.mInput;
  v26 = (UIInput_OnValidate_o *)sub_1B64ABC(UIInput_OnValidate_TypeInfo);
  UIInput_OnValidate___ctor(v26, 0LL, Method_EmojiUtility_ValidateNameText__, 0LL);
  if ( !mInput )
    goto LABEL_58;
  mInput->fields.onValidate = v26;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&mInput->fields.onValidate, (int32_t)v26, v29, v30);
  ...
  entryNameInput = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_11451/*"SELECT_FIGURE_INFO"*/, 0LL);
  if ( !mInfoLabelFlick )
    goto LABEL_58;
  ...
  if ( UnityEngine_Object__op_Equality(mScrollArrowRight, 0LL, 0LL) )
  {
    ...
    GameObjectExtensions__SafeSetParent_33382288((UnityEngine_GameObject_o *)v37, this->fields.mArrowRightRoot, 0LL);
    if ( !v37 )
      goto LABEL_58;
    Component_object = UnityEngine_GameObject__GetComponent_object_(
                         (UnityEngine_GameObject_o *)v37,
                         (const MethodInfo_2E8A1B4 *)Method_UnityEngine_GameObject_GetComponent_ScrollArrowComponent___);
  ...
  if ( UnityEngine_Object__op_Equality(mScrollArrowLeft, 0LL, 0LL) )
  {
    ...
    v44 = UnityEngine_Object__Instantiate_object_(
            mArrowLeftPrefab,
            (const MethodInfo_2EBDF7C *)Method_UnityEngine_Object_Instantiate_GameObject___);
    GameObjectExtensions__SafeSetParent_33382288((UnityEngine_GameObject_o *)v44, this->fields.mArrowLeftRoot, 0LL);
    if ( !v44 )
      goto LABEL_58;
    ...
    sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.mScrollArrowLeft, (int32_t)v45, v46, v47);
  }
  ...
  if ( !this->fields.masterFigureList )
  {
    ...
    if ( !masterFigureBaseList )
      goto LABEL_58;
    v63 = (struct UIMasterFullFigureTexture_array *)sub_1B64918(
                                                      UIMasterFullFigureTexture___TypeInfo,
                                                      masterFigureBaseList->max_length);
    this->fields.masterFigureList = v63;
    sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.masterFigureList, (int32_t)v63, v64, v65);
    ...
    while ( 1 )
    {
      ...
      if ( (v67 & 1) != 0 )
        ...
        v71 = 2;
      entryNameInput = (__int64)MasterFullFigureManager__CreatePrefab_37610636(
                                  v66->m_Items[v67],
                                  0,
                                  v71,
                                  0,
      ...
      if ( masterFigureList )
      {
        ...
        if ( entryNameInput )
        {
          entryNameInput = sub_1B649AC(entryNameInput, masterFigureList->obj.klass->_1.element_class);
          if ( !entryNameInput )
          {
            v75 = sub_1B64AF0(0LL);
            sub_1B64998(v75, 0LL);
...
LABEL_59:
          sub_1B64AD4(entryNameInput, v28);
        *(Il2CppClass **)((char *)&masterFigureList->obj.klass + v68) = v74;
        sub_1B64814((ServantStatusBattleListViewItem_o *)((char *)masterFigureList + v68), (int32_t)v74, v72, v73);
        v66 = this->fields.masterFigureBaseList;
        ++v67;
        v68 += 8LL;
        if ( v66 )
  ...
  entryNameInput = (__int64)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE318 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !entryNameInput )
    goto LABEL_58;
  ...
  *(_QWORD *)&v76.fields.fakeValue = v50;
  entryNameInput = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46180532(v76, 0LL);
  ...
  entryNameInput = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46180532(v48[7], 0LL);
  if ( !cmdSpellIconMale )
    goto LABEL_58;
  ...
  if ( !v57 )
  {
    ...
    sub_1B64814((ServantStatusBattleListViewItem_o *)&static_fields->__9__25_0, (int32_t)v57, v60, v61);
  }
  if ( !v55 )
LABEL_58:
    sub_1B64ACC(entryNameInput, v28);
...
void __fastcall UserNameEntryComponent__openConfirm(UserNameEntryComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FD230 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_UserNameEntryComponent_endConfirm__, v5);
    sub_1B64870(&StringLiteral_5477/*"ENTRY_GENDER_MAN"*/, v6);
    sub_1B64870(&StringLiteral_3808/*"CONFIRM_TITLE_MESSAGE"*/, v7);
    sub_1B64870(&StringLiteral_3799/*"CONFIRM_INFO_MESSAGE"*/, v8);
    sub_1B64870(&StringLiteral_5478/*"ENTRY_GENDER_WOMAN"*/, v9);
    byte_49FD230 = 1;
  }
  entryNameInput = this->fields.entryNameInput;
  if ( !entryNameInput )
  ...
  v18 = System_String__Format_61397948(v17, v16, v14, 0LL);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE318 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  v20 = LocalizationManager__Get((System_String_o *)StringLiteral_3808/*"CONFIRM_TITLE_MESSAGE"*/, 0LL);
  v21 = (CommonConfirmDialog_ClickDelegate_o *)sub_1B64ABC(CommonConfirmDialog_ClickDelegate_TypeInfo);
...
void __fastcall UserNameEntryComponent__requestUserNameChange(UserNameEntryComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FD232 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_NetworkManager_getRequest_UserNameChangeRequest___, v4);
    sub_1B64870(&NetworkManager_TypeInfo, v5);
    sub_1B64870(&NetworkManager_ResultCallbackFunc_TypeInfo, v6);
    sub_1B64870(&Method_SingletonMonoBehaviour_NetworkManager__get_Instance__, v7);
    sub_1B64870(&Method_UserNameEntryComponent_callbackUserNameChange__, v8);
    sub_1B64870(&StringLiteral_22140/*"ok"*/, v9);
    sub_1B64870(&StringLiteral_1/*""*/, v10);
    byte_49FD232 = 1;
  }
  ...
  if ( !v15->static_fields->UseMock )
  {
    ...
    if ( v18->static_fields->isLogin )
    {
      ...
      entryNameInput = (UILineInput_o *)NetworkManager__getRequest_object_(
                                          v19,
                                          (const MethodInfo_2EBCCAC *)Method_NetworkManager_getRequest_UserNameChangeRequest___);
      if ( entryNameInput )
      {
...
LABEL_27:
  ...
  entryNameInput = (UILineInput_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE318 *)Method_SingletonMonoBehaviour_NetworkManager__get_Instance__);
  if ( !entryNameInput )
    goto LABEL_27;
...
LABEL_11:
    ...
    sub_1B64ACC(cmdSpellIconFemale, *(_QWORD *)&gtype);
  }
}
...
void __fastcall UserNameEntryComponent__setEntry(UserNameEntryComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FD22D & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_UnityEngine_GameObject_GetComponent_GenderSelectControl___, v3);
    sub_1B64870(&UnityEngine_Object_TypeInfo, v4);
    sub_1B64870(&SpringPanel_OnFinished_TypeInfo, v5);
    this = (UserNameEntryComponent_o *)sub_1B64870(&Method_UserNameEntryComponent_OnCenterOnChildFinished__, v6);
    byte_49FD22D = 1;
  }
  ...
  if ( ((unsigned __int8)this & 1) != 0 )
  {
    ...
    *p_centerChild = (__int64)v10;
    sub_1B64814((ServantStatusBattleListViewItem_o *)&v2->fields.centerChild, (int32_t)v10, v11, v12);
  }
  v13 = *p_centerChild;
  if ( !v13 )
    goto LABEL_27;
  ...
  v16 = (SpringPanel_OnFinished_o *)sub_1B64ABC(SpringPanel_OnFinished_TypeInfo);
...
LABEL_15:
  ...
  sub_1B64814(v14, (int32_t)v20, v18, v19);
  this = (UserNameEntryComponent_o *)v2->fields.loopCtr;
  if ( !this )
    goto LABEL_27;
  ...
  if ( childCount >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      *p_genderSel = (struct GenderSelectControl_o *)Component_object;
      sub_1B64814((ServantStatusBattleListViewItem_o *)&v2->fields.genderSel, (int32_t)Component_object, v27, v28);
      if ( !*p_genderSel )
        break;
...
void __fastcall UserNameEntryComponent___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FD236 & 1) == 0 )
  {
    sub_1B64870(&UserNameEntryComponent___c_TypeInfo, v1);
    byte_49FD236 = 1;
  }
  v2 = (Il2CppObject *)sub_1B64ABC(UserNameEntryComponent___c_TypeInfo);
