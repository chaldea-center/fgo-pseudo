...
void UserNameEntryComponent__OnCenterOnChildFinished(UserNameEntryComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C559FB & 1) == 0 )
  {
    this = (UserNameEntryComponent_o *)sub_1C3E564(&Method_UnityEngine_GameObject_GetComponent_GenderSelectControl___);
    byte_4C559FB = 1;
  }
  ...
  if ( !centerChild
    ...
    || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                             ...
                             (const MethodInfo_31510CC *)Method_UnityEngine_GameObject_GetComponent_GenderSelectControl___),
        v2->fields.genderSel = (struct GenderSelectControl_o *)Component_object,
        sub_1C3E508((CGThumbnailListItem_o *)&v2->fields.genderSel, (int32_t)Component_object, v5, v6),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C559FA & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_UserNameEntryComponent__callbackUserNameChange_b__33_0__);
...
void UserNameEntryComponent__close(UserNameEntryComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C559F3 & 1) == 0 )
  {
    this = (UserNameEntryComponent_o *)sub_1C3E564(&UnityEngine_Object_TypeInfo);
    byte_4C559F3 = 1;
  }
  ...
  if ( masterFigureList )
  {
    ...
    sub_1C3E508(p_masterFigureList, 0, v2, v3);
  }
}
...
LABEL_22:
    sub_1C3E7C0(entryNameInput, method);
  }
LABEL_12:
  IsNullOrEmpty = 1;
LABEL_13:
...
void UserNameEntryComponent__onClickInput(UserNameEntryComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C559F6 & 1) == 0 )
  {
    sub_1C3E564(&Method_UserNameEntryComponent_onClickInput__);
    byte_4C559F6 = 1;
  }
  v3 = Method_UserNameEntryComponent_onClickInput__;
  if ( (*((_BYTE *)Method_UserNameEntryComponent_onClickInput__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C3E57C(Method_UserNameEntryComponent_onClickInput__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C559F2 & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_UnityEngine_GameObject_GetComponent_ScrollArrowComponent___);
    sub_1C3E564(&LocalizationManager_TypeInfo);
    ...
    sub_1C3E564(&Method_UserNameEntryComponent___c__open_b__25_0__);
    sub_1C3E564(&UserNameEntryComponent___c_TypeInfo);
    sub_1C3E564(&UIMasterFullFigureTexture___TypeInfo);
    sub_1C3E564(&StringLiteral_7470/*"INPUT_NAME_INFO"*/);
    sub_1C3E564(&StringLiteral_7469/*"INPUT_NAME_ANNOUNCE"*/);
    sub_1C3E564(&StringLiteral_11531/*"SELECT_FIGURE_INFO"*/);
    sub_1C3E564(&StringLiteral_7471/*"INPUT_NAME_LIMIT_NUM"*/);
    byte_4C559F2 = 1;
  }
  this->fields.mClosedAct = closed_act;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.mClosedAct, (int32_t)closed_act, (int32_t)method, v3);
  UnityEngine_Input__set_imeCompositionMode(1, 0);
  mInput = (CGThumbnailListItem_o *)this->fields.mInput;
  v7 = (UIInput_OnValidate_o *)sub_1C3E7B0(UIInput_OnValidate_TypeInfo);
  UIInput_OnValidate___ctor(v7, 0, Method_EmojiUtility_ValidateNameText__, 0);
  if ( !mInput )
    goto LABEL_58;
  mInput[1].klass = (CGThumbnailListItem_c *)v7;
  sub_1C3E508(mInput + 1, (int32_t)v7, v10, v11);
  ...
  entryNameInput = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_11531/*"SELECT_FIGURE_INFO"*/, 0);
  if ( !mInfoLabelFlick )
    goto LABEL_58;
  ...
  if ( UnityEngine_Object__op_Equality(mScrollArrowRight, 0, 0) )
  {
    ...
    GameObjectExtensions__SafeSetParent_36182084((UnityEngine_GameObject_o *)v18, this->fields.mArrowRightRoot, 0);
    if ( !v18 )
      goto LABEL_58;
    Component_object = UnityEngine_GameObject__GetComponent_object_(
                         (UnityEngine_GameObject_o *)v18,
                         (const MethodInfo_31510CC *)Method_UnityEngine_GameObject_GetComponent_ScrollArrowComponent___);
    this->fields.mScrollArrowRight = (struct ScrollArrowComponent_o *)Component_object;
    sub_1C3E508((CGThumbnailListItem_o *)&this->fields.mScrollArrowRight, (int32_t)Component_object, v20, v21);
  }
  ...
  if ( UnityEngine_Object__op_Equality(mScrollArrowLeft, 0, 0) )
  {
    ...
    v25 = UnityEngine_Object__Instantiate_object_(
            mArrowLeftPrefab,
            (const MethodInfo_3185EB4 *)Method_UnityEngine_Object_Instantiate_GameObject___);
    GameObjectExtensions__SafeSetParent_36182084((UnityEngine_GameObject_o *)v25, this->fields.mArrowLeftRoot, 0);
    if ( !v25 )
      goto LABEL_58;
    ...
    sub_1C3E508((CGThumbnailListItem_o *)&this->fields.mScrollArrowLeft, (int32_t)v26, v27, v28);
  }
  ...
  if ( !this->fields.masterFigureList )
  {
    ...
    if ( !masterFigureBaseList )
      goto LABEL_58;
    v44 = (struct UIMasterFullFigureTexture_array *)sub_1C3E60C(
                                                      UIMasterFullFigureTexture___TypeInfo,
                                                      LODWORD(masterFigureBaseList->max_length));
    this->fields.masterFigureList = v44;
    sub_1C3E508((CGThumbnailListItem_o *)&this->fields.masterFigureList, (int32_t)v44, v45, v46);
    ...
    while ( 1 )
    {
      ...
      if ( (v48 & 1) != 0 )
        ...
        v52 = 2;
      entryNameInput = (__int64)MasterFullFigureManager__CreatePrefab_40720988(v47->m_Items[v48], 0, v52, 0, 1, 0, 0);
      if ( masterFigureList )
      {
        v55 = entryNameInput;
        if ( entryNameInput )
        {
          entryNameInput = sub_1C3E6A0(entryNameInput, *(_QWORD *)(*(_QWORD *)masterFigureList + 64LL));
          if ( !entryNameInput )
          {
            v56 = sub_1C3E7E4(0);
            sub_1C3E68C(v56, 0);
...
LABEL_59:
          sub_1C3E7C8(entryNameInput, v9);
        *(_QWORD *)&masterFigureList[v49] = v55;
        sub_1C3E508((CGThumbnailListItem_o *)&masterFigureList[v49], v55, v53, v54);
        v47 = this->fields.masterFigureBaseList;
        ++v48;
        v49 += 2;
        if ( v47 )
  ...
  entryNameInput = (__int64)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39FF5A8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !entryNameInput )
    goto LABEL_58;
  ...
  *(_QWORD *)&v57.fields.fakeValue = v31;
  entryNameInput = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49004136(v57, 0);
  ...
  entryNameInput = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49004136(v29[7], 0);
  if ( !cmdSpellIconMale )
    goto LABEL_58;
  ...
  if ( !v38 )
  {
    ...
    sub_1C3E508((CGThumbnailListItem_o *)&static_fields->__9__25_0, (int32_t)v38, v41, v42);
  }
  if ( !v36 )
LABEL_58:
    sub_1C3E7C0(entryNameInput, v9);
...
void UserNameEntryComponent__openConfirm(UserNameEntryComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C559F7 & 1) == 0 )
  {
    ...
    sub_1C3E564(&LocalizationManager_TypeInfo);
    sub_1C3E564(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1C3E564(&Method_UserNameEntryComponent_endConfirm__);
    sub_1C3E564(&StringLiteral_5471/*"ENTRY_GENDER_MAN"*/);
    sub_1C3E564(&StringLiteral_3771/*"CONFIRM_TITLE_MESSAGE"*/);
    sub_1C3E564(&StringLiteral_3758/*"CONFIRM_INFO_MESSAGE"*/);
    sub_1C3E564(&StringLiteral_5472/*"ENTRY_GENDER_WOMAN"*/);
    byte_4C559F7 = 1;
  }
  entryNameInput = this->fields.entryNameInput;
  if ( !entryNameInput )
  ...
  v11 = System_String__Format_63677760(v10, v9, v7, 0);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39FF5A8 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
...
void UserNameEntryComponent__requestUserNameChange(UserNameEntryComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C559F9 & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_NetworkManager_getRequest_UserNameChangeRequest___);
    sub_1C3E564(&NetworkManager_TypeInfo);
    sub_1C3E564(&NetworkManager_ResultCallbackFunc_TypeInfo);
    sub_1C3E564(&Method_SingletonMonoBehaviour_NetworkManager__get_Instance__);
    sub_1C3E564(&Method_UserNameEntryComponent_callbackUserNameChange__);
    sub_1C3E564(&StringLiteral_22400/*"ok"*/);
    sub_1C3E564(&StringLiteral_1/*""*/);
    byte_4C559F9 = 1;
  }
  ...
  if ( !v6->static_fields->UseMock )
  {
    ...
    if ( v9->static_fields->isLogin )
    {
      ...
      entryNameInput = (UILineInput_o *)NetworkManager__getRequest_object_(
                                          v10,
                                          (const MethodInfo_3184BE4 *)Method_NetworkManager_getRequest_UserNameChangeRequest___);
      if ( entryNameInput )
      {
...
LABEL_27:
  ...
  entryNameInput = (UILineInput_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39FF5A8 *)Method_SingletonMonoBehaviour_NetworkManager__get_Instance__);
  if ( !entryNameInput )
    goto LABEL_27;
  ...
  UserNameEntryComponent__callbackUserNameChange(this, (System_String_o *)StringLiteral_22400/*"ok"*/, v8);
LABEL_23:
  entryNameInput = (UILineInput_o *)this->fields.confirmBtn;
  if ( !entryNameInput )
    goto LABEL_27;
...
LABEL_11:
    ...
    sub_1C3E7C0(cmdSpellIconFemale, *(_QWORD *)&gtype);
  }
}
...
void UserNameEntryComponent__setEntry(UserNameEntryComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C559F4 & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_UnityEngine_GameObject_GetComponent_GenderSelectControl___);
    sub_1C3E564(&UnityEngine_Object_TypeInfo);
    sub_1C3E564(&SpringPanel_OnFinished_TypeInfo);
    this = (UserNameEntryComponent_o *)sub_1C3E564(&Method_UserNameEntryComponent_OnCenterOnChildFinished__);
    byte_4C559F4 = 1;
  }
  ...
  if ( ((unsigned __int8)this & 1) != 0 )
  {
    ...
    *p_centerChild = (__int64)v6;
    sub_1C3E508((CGThumbnailListItem_o *)&v2->fields.centerChild, (int32_t)v6, v7, v8);
  }
  v9 = *p_centerChild;
  if ( !v9 )
    goto LABEL_27;
  ...
  v12 = (SpringPanel_OnFinished_o *)sub_1C3E7B0(SpringPanel_OnFinished_TypeInfo);
...
LABEL_15:
  ...
  sub_1C3E508(v10, (int32_t)v16, v14, v15);
  this = (UserNameEntryComponent_o *)v2->fields.loopCtr;
  if ( !this )
    goto LABEL_27;
  ...
  if ( childCount >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      *p_genderSel = (struct GenderSelectControl_o *)Component_object;
      sub_1C3E508((CGThumbnailListItem_o *)&v2->fields.genderSel, (int32_t)Component_object, v23, v24);
      if ( !*p_genderSel )
        break;
...
void UserNameEntryComponent___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C3E7B0(UserNameEntryComponent___c_TypeInfo);
  System_Object___ctor(v1, 0);
  UserNameEntryComponent___c_TypeInfo->static_fields->__9 = (struct UserNameEntryComponent___c_o *)v1;
  sub_1C3E508((CGThumbnailListItem_o *)UserNameEntryComponent___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
