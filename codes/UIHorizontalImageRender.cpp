void UIHorizontalImageRender___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C4483B & 1) == 0 )
  {
    sub_1C37058(&UIHorizontalImageRender_TypeInfo);
    byte_4C4483B = 1;
  }
  static_fields = UIHorizontalImageRender_TypeInfo->static_fields;
  *(_OWORD *)&static_fields->MAIN_SIZE_X = xmmword_C100F0;
  *(_OWORD *)&static_fields->OVERLAP_U = xmmword_C0F000;
  *(_QWORD *)&static_fields->TOP_Y = 0xFFFFFE02000001FFLL;
  *(_OWORD *)&static_fields->BODY_U = xmmword_C0E1C0;
...
System_String_array *UIHorizontalImageRender__GetAssetNameList(System_String_o *imageName, const MethodInfo *method)
{
  ...
  if ( (byte_4C44829 & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_7570/*"Image/00001"*/);
    imageName = (System_String_o *)sub_1C37058(&StringLiteral_7569/*"Image/"*/);
    byte_4C44829 = 1;
  }
  if ( !v2 )
    goto LABEL_13;
  if ( !System_String__StartsWith(v2, (System_String_o *)StringLiteral_7569/*"Image/"*/, 0) )
    v2 = System_String__Concat_63561656((System_String_o *)StringLiteral_7569/*"Image/"*/, v2, 0);
...
void UIHorizontalImageRender__SetCharacterRender(UIHorizontalImageRender_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C4482E & 1) == 0 )
  {
    ...
    sub_1C37058(&UnityEngine_Object_TypeInfo);
    sub_1C37058(&Field__PrivateImplementationDetails__D34B481CF7365656E79A8F13CBD15BBF6B12B11B23727F2345088914BFC15F80);
    sub_1C37058(&UIHorizontalImageRender_TypeInfo);
  ...
  filterName = this->fields.filterName;
  v10 = v8;
  v11 = System_String__op_Equality(filterName, (System_String_o *)StringLiteral_23501/*"silhouette"*/, 0);
  if ( v10 )
  {
    if ( v11 )
    {
  ...
  v17 = (UnityEngine_Mesh_o *)sub_1C372A4(UnityEngine_Mesh_TypeInfo);
  UnityEngine_Mesh___ctor(v17, 0);
  bodyRenderer = (char *)sub_1C37100(UnityEngine_Vector3___TypeInfo, 8);
  ...
  *((float *)v19 + 9) = (float)TOP_Y;
  ...
  RIGHT_X = v24->RIGHT_X;
  *((_DWORD *)v19 + 13) = 0;
  *((float *)v19 + 11) = (float)RIGHT_X;
  *((float *)v19 + 12) = (float)v25;
  if ( v20 <= 2 )
    goto LABEL_69;
  ...
  *((float *)v19 + 15) = (float)BOTTOM_Y;
  ...
  v32 = v30->RIGHT_X;
  *((_DWORD *)v19 + 19) = 0;
  *((float *)v19 + 17) = (float)v32;
  *((float *)v19 + 18) = (float)v31;
  if ( v20 <= 4 )
    goto LABEL_69;
  ...
  v35 = v33->RIGHT_X;
  *((_DWORD *)v19 + 22) = 0;
  *((float *)v19 + 20) = (float)v35;
  *((float *)v19 + 21) = (float)v34;
  if ( v20 == 5 )
    goto LABEL_69;
...
LABEL_70:
  ...
  *((float *)v43 + 31) = v60;
  ...
  bodyRenderer = (char *)sub_1C37100(UnityEngine_Vector2___TypeInfo, 8);
  if ( !bodyRenderer )
    goto LABEL_70;
...
LABEL_69:
  ...
  *((_QWORD *)bodyRenderer + 11) = v94;
  ...
  v95 = (System_Array_o *)sub_1C37100(int___TypeInfo, 12);
  ...
  System_Runtime_CompilerServices_RuntimeHelpers__InitializeArray_64262432(v95, v96, 0);
...
void UIHorizontalImageRender__SetLayer(UIHorizontalImageRender_o *this, int32_t layer, const MethodInfo *method)
{
  ...
  {
    transform = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0);
    UIHorizontalImageRender__SetLayer_43978952(this, transform, layer, v7);
  }
}


void UIHorizontalImageRender__SetLayer_43978952(
        UIHorizontalImageRender_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C44838 & 1) == 0 )
  {
    ...
    this = (UIHorizontalImageRender_o *)sub_1C37058(&UnityEngine_Transform_TypeInfo);
    byte_4C44838 = 1;
  }
  if ( !tf
...
LABEL_17:
    ...
    UIHorizontalImageRender__SetLayer_43978952(v6, v16, layer, v17);
  }
