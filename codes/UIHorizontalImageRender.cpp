void UIHorizontalImageRender___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4D2E143 & 1) == 0 )
  {
    sub_1C94098(&UIHorizontalImageRender_TypeInfo);
    byte_4D2E143 = 1;
  }
  static_fields = UIHorizontalImageRender_TypeInfo->static_fields;
  *(_OWORD *)&static_fields->MAIN_SIZE_X = xmmword_D002D0;
  *(_OWORD *)&static_fields->OVERLAP_U = xmmword_CFF1E0;
  *(_QWORD *)&static_fields->TOP_Y = 0xFFFFFE02000001FFLL;
  *(_OWORD *)&static_fields->BODY_U = xmmword_CFE3A0;
    ...
    if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)v28, 0, 0) )
    {
      ...
      if ( v28 )
      {
        ...
        sub_1C9403C(
          ...
          v35,
          v36);
        v37 = StringLiteral_6015/*"EndMoveAlpha"*/;
        v28->fields.callWhenFinished = (struct System_String_o *)StringLiteral_6015/*"EndMoveAlpha"*/;
        sub_1C9403C((GrandQuestFolderBoardItem_o *)&v28->fields.callWhenFinished, v37, v38, v39, v40, v41, v42, v43);
        return;
      }
LABEL_19:
...
void UIHorizontalImageRender__SetLayer(UIHorizontalImageRender_o *this, int32_t layer, const MethodInfo *method)
{
  ...
  {
    transform = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0);
    UIHorizontalImageRender__SetLayer_44771260(this, transform, layer, v8);
  }
}


void UIHorizontalImageRender__SetLayer_44771260(
        UIHorizontalImageRender_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2E140 & 1) == 0 )
  {
    ...
    this = (UIHorizontalImageRender_o *)sub_1C94098(&UnityEngine_Transform_TypeInfo);
    byte_4D2E140 = 1;
  }
  if ( !tf
...
LABEL_17:
    ...
    UIHorizontalImageRender__SetLayer_44771260(v6, v17, layer, v18);
  }
