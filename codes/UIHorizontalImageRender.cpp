void UIHorizontalImageRender___cctor(const MethodInfo *method)
{
  ...
  *(_OWORD *)&static_fields->MAIN_SIZE_X = xmmword_E9C080;
  *(_OWORD *)&static_fields->OVERLAP_U = xmmword_E9D920;
  *(_QWORD *)&static_fields->TOP_Y = 0xFFFFFE02000001FFLL;
  *(_OWORD *)&static_fields->BODY_U = xmmword_E9C130;
...
LABEL_16:
  ...
  ((void (__fastcall *)(UIHorizontalImageRender_o *, const MethodInfo *, float, float, float, float))this->klass->vtable._39_SetTweenColor.methodPtr)(
    this,
    this->klass->vtable._39_SetTweenColor.method,
...
LABEL_19:
  ...
  ((void (__fastcall *)(UIHorizontalImageRender_o *, const MethodInfo *, float, float, float, float))this->klass->vtable._39_SetTweenColor.methodPtr)(
    ...
    this->fields.mColor.fields.b,
    alpha);
  UIHorizontalImageRender__EndMoveAlpha(this, v46);
}
...
void UIHorizontalImageRender__ReleaseCharacter(UIHorizontalImageRender_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(bodyRenderer, 0, 0) )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(gameObject, 0, 0) )
      UIHorizontalImageRender__SetActive(this, 0, v8);
    bodyFilter = (UnityEngine_Component_o *)this->fields.bodyRenderer;
    if ( !bodyFilter )
      goto LABEL_30;
...
void UIHorizontalImageRender__SetCharacterRender(UIHorizontalImageRender_o *this, const MethodInfo *method)
{
  ...
  UIHorizontalImageRender_c *v19; // x8
  char *v20; // x21
  unsigned int v21; // w9
  struct UIHorizontalImageRender_StaticFields *static_fields; // x8
  int LEFT_X; // s0
  int TOP_Y; // s1
  struct UIHorizontalImageRender_StaticFields *v25; // x8
  int RIGHT_X; // s0
  int v27; // s1
  struct UIHorizontalImageRender_StaticFields *v28; // x8
  int v29; // s0
  int BOTTOM_Y; // s1
  struct UIHorizontalImageRender_StaticFields *v31; // x8
  int v32; // s0
  int v33; // s1
  struct UIHorizontalImageRender_StaticFields *v34; // x8
  int v35; // s0
  int v36; // s1
  int32x2_t v37; // d0
  struct UIHorizontalImageRender_StaticFields *v38; // x8
  int v39; // s0
  int v40; // s1
  struct UIHorizontalImageRender_StaticFields *v41; // x8
  int RIGHT_X2; // s0
  int v43; // s1
  char *v44; // x21
  unsigned int v45; // w9
  ...
  float v61; // s1
  unsigned int v62; // w8
  struct UIHorizontalImageRender_StaticFields *v63; // x9
  float BODY_V; // s2
  struct UIHorizontalImageRender_StaticFields *v65; // x9
  float v66; // s0
  struct UIHorizontalImageRender_StaticFields *v67; // x9
  float32x2_t v68; // d0
  float32x2_t v69; // d1
  __int64 v70; // d2
  struct UIHorizontalImageRender_StaticFields *v71; // x9
  float BODY_V2; // s2
  struct UIHorizontalImageRender_StaticFields *v73; // x9
  float v74; // s0
  struct UIHorizontalImageRender_StaticFields *v75; // x8
  float32x2_t v76; // d0
  float32x2_t v77; // d1
  __int64 v78; // d2
  unsigned int v79; // w8
  struct UIHorizontalImageRender_StaticFields *v80; // x9
  float v81; // s2
  struct UIHorizontalImageRender_StaticFields *v82; // x9
  float v83; // s0
  struct UIHorizontalImageRender_StaticFields *v84; // x9
  float32x2_t v85; // d0
  float32x2_t v86; // d1
  __int64 v87; // d2
  struct UIHorizontalImageRender_StaticFields *v88; // x9
  float v89; // s2
  struct UIHorizontalImageRender_StaticFields *v90; // x9
  float v91; // s0
  struct UIHorizontalImageRender_StaticFields *v92; // x8
  float32x2_t v93; // d0
  float32x2_t v94; // d1
  __int64 v95; // d2
  System_Array_o *v96; // x0
  ...
  bodyRenderer = (char *)UIHorizontalImageRender_TypeInfo;
  if ( !*(&UIHorizontalImageRender_TypeInfo->_2.cctor_finished + 1) )
  {
    j_il2cpp_runtime_class_init_0(UIHorizontalImageRender_TypeInfo, method);
    bodyRenderer = (char *)UIHorizontalImageRender_TypeInfo;
  }
  v4 = *(_DWORD *)(*((_QWORD *)bodyRenderer + 23) + 32LL);
  this->fields.dispTop.fields.x = 0.0;
  this->fields.dispTop.fields.y = (float)-v4;
  v5 = *(_DWORD *)(*((_QWORD *)bodyRenderer + 23) + 32LL);
  ...
  bodyRenderer = (char *)sub_2213B20(UnityEngine_Vector3___TypeInfo, 8);
  v19 = UIHorizontalImageRender_TypeInfo;
  v20 = bodyRenderer;
  if ( !*(&UIHorizontalImageRender_TypeInfo->_2.cctor_finished + 1) )
  {
    j_il2cpp_runtime_class_init_0(UIHorizontalImageRender_TypeInfo, method);
  ...
  *((float *)v20 + 9) = (float)TOP_Y;
  if ( v21 == 1 )
    goto LABEL_69;
  v25 = UIHorizontalImageRender_TypeInfo->static_fields;
  RIGHT_X = v25->RIGHT_X;
  v27 = v25->TOP_Y;
  *((_DWORD *)v20 + 13) = 0;
  *((float *)v20 + 11) = (float)RIGHT_X;
  *((float *)v20 + 12) = (float)v27;
  if ( v21 <= 2 )
    goto LABEL_69;
  v28 = UIHorizontalImageRender_TypeInfo->static_fields;
  v29 = v28->LEFT_X;
  BOTTOM_Y = v28->BOTTOM_Y;
  *((_DWORD *)v20 + 16) = 0;
  *((float *)v20 + 14) = (float)v29;
  *((float *)v20 + 15) = (float)BOTTOM_Y;
  if ( v21 == 3 )
    goto LABEL_69;
  v31 = UIHorizontalImageRender_TypeInfo->static_fields;
  v32 = v31->RIGHT_X;
  v33 = v31->BOTTOM_Y;
  *((_DWORD *)v20 + 19) = 0;
  *((float *)v20 + 17) = (float)v32;
  *((float *)v20 + 18) = (float)v33;
  if ( v21 <= 4 )
    goto LABEL_69;
  v34 = UIHorizontalImageRender_TypeInfo->static_fields;
  v35 = v34->RIGHT_X;
  v36 = v34->TOP_Y;
  *((_DWORD *)v20 + 22) = 0;
  *((float *)v20 + 20) = (float)v35;
  *((float *)v20 + 21) = (float)v36;
  if ( v21 == 5 )
    goto LABEL_69;
  v37.n64_u64[0] = *(unsigned __int64 *)&UIHorizontalImageRender_TypeInfo->static_fields->RIGHT_X2;
  *((_DWORD *)v20 + 25) = 0;
  *(float32x2_t *)(v20 + 92) = vcvt_f32_s32(v37);
  if ( v21 <= 6 )
    goto LABEL_69;
  v38 = UIHorizontalImageRender_TypeInfo->static_fields;
  v39 = v38->RIGHT_X;
  v40 = v38->BOTTOM_Y;
  *((_DWORD *)v20 + 28) = 0;
  *((float *)v20 + 26) = (float)v39;
  *((float *)v20 + 27) = (float)v40;
  if ( v21 == 7 )
    goto LABEL_69;
  v41 = UIHorizontalImageRender_TypeInfo->static_fields;
  RIGHT_X2 = v41->RIGHT_X2;
  v43 = v41->BOTTOM_Y;
  *((_DWORD *)v20 + 31) = 0;
  *((float *)v20 + 29) = (float)RIGHT_X2;
  *((float *)v20 + 30) = (float)v43;
  if ( !v18 )
    goto LABEL_70;
...
LABEL_70:
  ...
  *((float32x2_t *)v44 + 4) = vneg_f32(v46[9]);
  *((float *)v44 + 10) = v47;
  if ( (v45 & 0xFFFFFFFE) == 0 )
    goto LABEL_69;
  ...
  *((float32x2_t *)v44 + 7) = vneg_f32(v50[9]);
  *((float *)v44 + 16) = v51;
  if ( (v45 & 0xFFFFFFFC) == 0 )
    goto LABEL_69;
  ...
  *((float32x2_t *)v44 + 10) = vneg_f32(v54[9]);
  *((float *)v44 + 22) = v55;
  if ( v45 == 5 )
    goto LABEL_69;
  ...
  *((float32x2_t *)v44 + 13) = vneg_f32(v58[9]);
  *((float *)v44 + 28) = v59;
  if ( (v45 & 0xFFFFFFF8) == 0 )
    goto LABEL_69;
  ...
  *((float *)v44 + 31) = v61;
  ...
  bodyRenderer = (char *)sub_2213B20(UnityEngine_Vector2___TypeInfo, 8);
  if ( !bodyRenderer )
    goto LABEL_70;
  v62 = *((_DWORD *)bodyRenderer + 6);
  if ( !v62 )
    goto LABEL_69;
  *((_QWORD *)bodyRenderer + 4) = *(_QWORD *)&UIHorizontalImageRender_TypeInfo->static_fields->BODY_U;
  if ( v62 == 1 )
    goto LABEL_69;
  v63 = UIHorizontalImageRender_TypeInfo->static_fields;
  BODY_V = v63->BODY_V;
  *((float *)bodyRenderer + 10) = v63->BODY_U + v63->BODY_W;
  *((float *)bodyRenderer + 11) = BODY_V;
  if ( v62 <= 2 )
    goto LABEL_69;
  v65 = UIHorizontalImageRender_TypeInfo->static_fields;
  v66 = v65->BODY_V - v65->BODY_H;
  *((_DWORD *)bodyRenderer + 12) = LODWORD(v65->BODY_U);
  *((float *)bodyRenderer + 13) = v66;
  if ( v62 == 3 )
    goto LABEL_69;
  v67 = UIHorizontalImageRender_TypeInfo->static_fields;
  ...
  *((_QWORD *)bodyRenderer + 7) = v70;
  if ( v62 <= 4 )
    goto LABEL_69;
  *((_QWORD *)bodyRenderer + 8) = *(_QWORD *)&UIHorizontalImageRender_TypeInfo->static_fields->BODY_U2;
  if ( v62 == 5 )
    goto LABEL_69;
  v71 = UIHorizontalImageRender_TypeInfo->static_fields;
  BODY_V2 = v71->BODY_V2;
  *((float *)bodyRenderer + 18) = v71->BODY_U2 + v71->BODY_W;
  *((float *)bodyRenderer + 19) = BODY_V2;
  if ( v62 <= 6 )
    goto LABEL_69;
  v73 = UIHorizontalImageRender_TypeInfo->static_fields;
  v74 = v73->BODY_V2 - v73->BODY_H;
  *((_DWORD *)bodyRenderer + 20) = LODWORD(v73->BODY_U2);
  *((float *)bodyRenderer + 21) = v74;
  if ( v62 == 7 )
    goto LABEL_69;
  v75 = UIHorizontalImageRender_TypeInfo->static_fields;
  ...
  *((_QWORD *)bodyRenderer + 11) = v78;
  UnityEngine_Mesh__set_uv(v18, (UnityEngine_Vector2_array *)bodyRenderer, 0);
  bodyRenderer = (char *)sub_2213B20(UnityEngine_Vector2___TypeInfo, 8);
  if ( !bodyRenderer )
    goto LABEL_70;
  v79 = *((_DWORD *)bodyRenderer + 6);
  if ( !v79 )
    goto LABEL_69;
  *((_QWORD *)bodyRenderer + 4) = *(_QWORD *)&UIHorizontalImageRender_TypeInfo->static_fields->BODY_U;
  if ( v79 == 1 )
    goto LABEL_69;
  v80 = UIHorizontalImageRender_TypeInfo->static_fields;
  v81 = v80->BODY_V;
  *((float *)bodyRenderer + 10) = v80->BODY_U + v80->BODY_W;
  *((float *)bodyRenderer + 11) = v81;
  if ( v79 <= 2 )
    goto LABEL_69;
  v82 = UIHorizontalImageRender_TypeInfo->static_fields;
  v83 = v82->BODY_V - v82->BODY_H;
  *((_DWORD *)bodyRenderer + 12) = LODWORD(v82->BODY_U);
  *((float *)bodyRenderer + 13) = v83;
  if ( v79 == 3 )
    goto LABEL_69;
  v84 = UIHorizontalImageRender_TypeInfo->static_fields;
  ...
  *((_QWORD *)bodyRenderer + 7) = v87;
  if ( v79 <= 4 )
    goto LABEL_69;
  *((_QWORD *)bodyRenderer + 8) = *(_QWORD *)&UIHorizontalImageRender_TypeInfo->static_fields->BODY_U2;
  if ( v79 == 5 )
    goto LABEL_69;
  v88 = UIHorizontalImageRender_TypeInfo->static_fields;
  v89 = v88->BODY_V2;
  *((float *)bodyRenderer + 18) = v88->BODY_U2 + v88->BODY_W;
  *((float *)bodyRenderer + 19) = v89;
  if ( v79 <= 6
    || (v90 = UIHorizontalImageRender_TypeInfo->static_fields,
        v91 = v90->BODY_V2 - v90->BODY_H,
        *((_DWORD *)bodyRenderer + 20) = LODWORD(v90->BODY_U2),
        *((float *)bodyRenderer + 21) = v91,
        v79 == 7) )
  {
LABEL_69:
    sub_2213CE4(bodyRenderer);
  }
  v92 = UIHorizontalImageRender_TypeInfo->static_fields;
  ...
  *((_QWORD *)bodyRenderer + 11) = v95;
  UnityEngine_Mesh__set_uv2(v18, (UnityEngine_Vector2_array *)bodyRenderer, 0);
  v96 = (System_Array_o *)sub_2213B20(int___TypeInfo, 12);
  v97.fields.value = Field__PrivateImplementationDetails__D34B481CF7365656E79A8F13CBD15BBF6B12B11B23727F2345088914BFC15F80;
  v98 = (System_Int32_array *)v96;
  System_Runtime_CompilerServices_RuntimeHelpers__InitializeArray_76340728(v96, v97, 0);
  UnityEngine_Mesh__set_triangles(v18, v98, 0);
  ...
  LODWORD(v99) = 1.0;
  *(float *)&v100 = this->fields.mColor.fields.a;
  v101 = !this->fields.isShadow;
  isTalkMask = this->fields.isTalkMask;
  this->fields.isBusyMoveAlpha = 0;
  if ( !v101 )
    *(float *)&v99 = 0.1;
  if ( isTalkMask )
    *(float *)&v99 = *(float *)&v99 * 0.5;
  ((void (__fastcall *)(UIHorizontalImageRender_o *, const MethodInfo *, long double, float, float, long double))this->klass->vtable._39_SetTweenColor.methodPtr)(
    this,
    this->klass->vtable._39_SetTweenColor.method,
    v99,
...
void UIHorizontalImageRender__SetLayer(UIHorizontalImageRender_o *this, int32_t layer, const MethodInfo *method)
{
  ...
  {
    transform = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0);
    UIHorizontalImageRender__SetLayer_50994748(this, transform, layer, v8);
  }
}


void UIHorizontalImageRender__SetLayer_50994748(
        UIHorizontalImageRender_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5972146 & 1) == 0 )
  {
    ...
    this = (UIHorizontalImageRender_o *)sub_2213A60(&UnityEngine_Transform_TypeInfo);
    byte_5972146 = 1;
  }
  if ( !tf
...
LABEL_34:
    ...
    UIHorizontalImageRender__SetLayer_50994748(v6, v17, layer, v19);
  }
...
void UIHorizontalImageRender__SetTalkMask(UIHorizontalImageRender_o *this, bool isMask, const MethodInfo *method)
{
  ...
  long double v4; // q3
  _BOOL4 isShadow; // w10
  UIHorizontalImageRender_c *klass; // x9
  ...
  *(float *)&v4 = this->fields.mColor.fields.a;
  ...
  if ( isMask )
    *(float *)&v3 = *(float *)&v3 * 0.5;
  ((void (__fastcall *)(UIHorizontalImageRender_o *, const MethodInfo *, long double, float, float, long double))klass->vtable._39_SetTweenColor.methodPtr)(
    this,
        ...
        const MethodInfo *method)
{
         ...
         0) )
  {
    ...
    if ( !*(&UIHorizontalImageRender_TypeInfo->_2.cctor_finished + 1) )
    {
      j_il2cpp_runtime_class_init_0(UIHorizontalImageRender_TypeInfo, texture);
      bodyRenderer = UIHorizontalImageRender_TypeInfo;
    }
