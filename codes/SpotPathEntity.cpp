...
int32_t __fastcall SpotPathEntity__GetMapGimmickEffectId(SpotPathEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BB9BD & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_20985/*"mapGimmickEffectId"*/, method);
    byte_49BB9BD = 1;
  }
...
int32_t __fastcall SpotPathEntity__GetMapGimmickId(SpotPathEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BB9BC & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_20986/*"mapGimmickId"*/, method);
    byte_49BB9BC = 1;
  }
...
bool __fastcall SpotPathEntity__IsStopRaidDeadTime(SpotPathEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BB9BB & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_23270/*"stopRaidDeadTime"*/, method);
    byte_49BB9BB = 1;
  }
  return SpotPathEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_23270/*"stopRaidDeadTime"*/, 0, v2) != 0;
}
