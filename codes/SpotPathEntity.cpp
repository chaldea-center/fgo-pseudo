...
int32_t __fastcall SpotPathEntity__GetMapGimmickEffectId(SpotPathEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDD046 & 1) == 0 )
  {
    sub_1C21E38(&StringLiteral_21655/*"mapGimmickEffectId"*/);
    byte_4BDD046 = 1;
  }
  return SpotPathEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_21655/*"mapGimmickEffectId"*/, 0, v2);
}
...
int32_t __fastcall SpotPathEntity__GetMapGimmickId(SpotPathEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDD045 & 1) == 0 )
  {
    sub_1C21E38(&StringLiteral_21656/*"mapGimmickId"*/);
    byte_4BDD045 = 1;
  }
  return SpotPathEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_21656/*"mapGimmickId"*/, 0, v2);
}
...
bool __fastcall SpotPathEntity__IsStopRaidDeadTime(SpotPathEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDD044 & 1) == 0 )
  {
    sub_1C21E38(&StringLiteral_23980/*"stopRaidDeadTime"*/);
    byte_4BDD044 = 1;
  }
  return SpotPathEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_23980/*"stopRaidDeadTime"*/, 0, v2) != 0;
}
