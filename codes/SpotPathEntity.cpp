...
int32_t __fastcall SpotPathEntity__GetMapGimmickEffectId(SpotPathEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFE27C & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_21666/*"mapGimmickEffectId"*/, method);
    byte_4BFE27C = 1;
  }
  return SpotPathEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_21666/*"mapGimmickEffectId"*/, 0, v2);
}
...
int32_t __fastcall SpotPathEntity__GetMapGimmickId(SpotPathEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFE27B & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_21667/*"mapGimmickId"*/, method);
    byte_4BFE27B = 1;
  }
  return SpotPathEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_21667/*"mapGimmickId"*/, 0, v2);
}
...
bool __fastcall SpotPathEntity__IsStopRaidDeadTime(SpotPathEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFE27A & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_24002/*"stopRaidDeadTime"*/, method);
    byte_4BFE27A = 1;
  }
  return SpotPathEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_24002/*"stopRaidDeadTime"*/, 0, v2) != 0;
}
