...
int32_t __fastcall SpotPathEntity__GetMapGimmickEffectId(SpotPathEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2047E & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_21216/*"mapGimmickEffectId"*/, method);
    byte_4A2047E = 1;
  }
  return SpotPathEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_21216/*"mapGimmickEffectId"*/, 0, v2);
}
...
int32_t __fastcall SpotPathEntity__GetMapGimmickId(SpotPathEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2047D & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_21217/*"mapGimmickId"*/, method);
    byte_4A2047D = 1;
  }
  return SpotPathEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_21217/*"mapGimmickId"*/, 0, v2);
}
...
bool __fastcall SpotPathEntity__IsStopRaidDeadTime(SpotPathEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2047C & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_23494/*"stopRaidDeadTime"*/, method);
    byte_4A2047C = 1;
  }
  return SpotPathEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_23494/*"stopRaidDeadTime"*/, 0, v2) != 0;
}
