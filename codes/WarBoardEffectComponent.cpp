        ...
        const MethodInfo *method)
{
  ...
  *((_QWORD *)effectData + 5) = this;
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)(effectData + 40), (int32_t)this, v12, v13, v14, v15, v16, v17);
  ...
  effectData = (char *)System_String__Format((System_String_o *)StringLiteral_25357/*"{0}"*/, v22, 0);
  if ( !effectIcon )
    goto LABEL_17;
  ...
  effectData = (char *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A8C5A8 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  ...
  if ( !v24
    ...
    || (UnityEngine_Transform__set_localPosition(transform, SquarePosition, 0),
        v25 = (UnityEngine_Transform_array *)sub_1C7BB90(UnityEngine_Transform___TypeInfo, 1),
        effectData = (char *)UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0),
        !v25) )
  {
LABEL_17:
    sub_1C7BD40(effectData, v11);
  }
  v32 = (UnityEngine_Transform_o *)effectData;
  if ( effectData )
  {
    effectData = (char *)sub_1C7BC24(effectData, v25->obj.klass->_1.element_class);
    if ( !effectData )
    {
      v34 = sub_1C7BD64();
      sub_1C7BC10(v34, 0);
...
void WarBoardEffectComponent__OnClick(WarBoardEffectComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C7BAE8(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    sub_1C7BAE8(&Method_WarBoardEffectComponent_OnClick__);
    byte_4CEBE5B = 1;
  }
  ...
  if ( WarBoardManager__get_isSelectedPiece(Instance, 0) && this->fields.isSelectable )
  {
    ...
    if ( (*((_BYTE *)Method_WarBoardEffectComponent_OnClick__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1C7BB00(Method_WarBoardEffectComponent_OnClick__);
...
LABEL_20:
  ...
  if ( (*((_BYTE *)Method_WarBoardEffectComponent_OnClick__ + 83) & 2) != 0 )
    v9 = (_QWORD *)sub_1C7BB00(Method_WarBoardEffectComponent_OnClick__);
...
void WarBoardEffectComponent__OnLongClick(WarBoardEffectComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C7BAE8(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    sub_1C7BAE8(&Method_WarBoardEffectComponent_OnLongClick__);
    byte_4CEBE5C = 1;
  }
  v3 = Method_WarBoardEffectComponent_OnLongClick__;
  if ( (*((_BYTE *)Method_WarBoardEffectComponent_OnLongClick__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C7BB00(Method_WarBoardEffectComponent_OnLongClick__);
  v4 = (System_Reflection_MethodBase_o *)sub_1C7BACC(v3, v3[4]);
  Instance = (UnityEngine_Transform_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A8C5A8 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !Instance
    || (klass = Instance[14].klass) == 0
    || (OverwriteAssetSoundName__PlaySe(v4, *(System_String_o **)&klass->_1.byval_arg.bits, 0, 0),
        v8 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A8C5A8 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__),
        effectData = this->fields.effectData,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEBE5D & 1) == 0 )
  {
    this = (WarBoardEffectComponent_o *)sub_1C7BAE8(&Method_UnityEngine_Component_GetComponentsInChildren_UIWidget____78814528);
    byte_4CEBE5D = 1;
  }
