        ...
        const MethodInfo *method)
{
  ...
  *((_QWORD *)effectData + 5) = this;
  sub_1B64814((ServantStatusBattleListViewItem_o *)(effectData + 40), (int32_t)this, v11, v12);
  ...
  effectData = (char *)System_String__Format((System_String_o *)StringLiteral_24887/*"{0}"*/, v20, 0LL);
  if ( !effectIcon )
    goto LABEL_17;
  ...
  effectData = (char *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE318 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  ...
  if ( !v22
    ...
    || (UnityEngine_Transform__set_localPosition(transform, *(UnityEngine_Vector3_o *)&v23, 0LL),
        v26 = (UnityEngine_Transform_array *)sub_1B64918(UnityEngine_Transform___TypeInfo, 1LL),
        effectData = (char *)UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0LL),
        !v26) )
  {
LABEL_17:
    sub_1B64ACC(effectData, v10);
  }
  v29 = (UnityEngine_Transform_o *)effectData;
  if ( effectData )
  {
    effectData = (char *)sub_1B649AC(effectData, v26->obj.klass->_1.element_class);
    if ( !effectData )
    {
      v31 = sub_1B64AF0(0LL);
      sub_1B64998(v31, 0LL);
...
void __fastcall WarBoardEffectComponent__OnClick(WarBoardEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FC02C & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_WarBoardEffectComponent_OnClick__, v3);
    byte_49FC02C = 1;
  }
  ...
  if ( WarBoardManager__get_isSelectedPiece(Instance, 0LL) && this->fields.isSelectable )
  {
    ...
    if ( (*((_BYTE *)Method_WarBoardEffectComponent_OnClick__ + 83) & 2) != 0 )
      v6 = (_QWORD *)sub_1B64888(Method_WarBoardEffectComponent_OnClick__);
...
LABEL_20:
  ...
  if ( (*((_BYTE *)Method_WarBoardEffectComponent_OnClick__ + 83) & 2) != 0 )
    v10 = (_QWORD *)sub_1B64888(Method_WarBoardEffectComponent_OnClick__);
  ...
  v13 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE318 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
...
void __fastcall WarBoardEffectComponent__OnLongClick(WarBoardEffectComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B64870(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__, method);
    sub_1B64870(&Method_WarBoardEffectComponent_OnLongClick__, v3);
    byte_49FC02D = 1;
  }
  v4 = Method_WarBoardEffectComponent_OnLongClick__;
  if ( (*((_BYTE *)Method_WarBoardEffectComponent_OnLongClick__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1B64888(Method_WarBoardEffectComponent_OnLongClick__);
  v5 = (System_Reflection_MethodBase_o *)sub_1B64854(v4, v4[4]);
  Instance = (UnityEngine_Transform_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE318 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !Instance
    || (klass = Instance[14].klass) == 0LL
    || (OverwriteAssetSoundName__PlaySe(v5, *(System_String_o **)&klass->_1.byval_arg.bits, 0LL),
        v9 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE318 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__),
        effectData = this->fields.effectData,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC02E & 1) == 0 )
  {
    this = (WarBoardEffectComponent_o *)sub_1B64870(
