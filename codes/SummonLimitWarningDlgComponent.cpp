...
void SummonLimitWarningDlgComponent__Close(SummonLimitWarningDlgComponent_o *this, const MethodInfo *method)
{
  ...
  SummonLimitWarningDlgComponent__Close_36577636(this, 0, v2);
}


void SummonLimitWarningDlgComponent__Close_36577636(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E00E77 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_SummonLimitWarningDlgComponent_EndClose__);
    byte_4E00E77 = 1;
  }
...
void SummonLimitWarningDlgComponent__OnClickCancel(SummonLimitWarningDlgComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E00E7A & 1) == 0 )
  {
    sub_1CE6700(&Method_SummonLimitWarningDlgComponent_OnClickCancel__);
    byte_4E00E7A = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SummonLimitWarningDlgComponent_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_SummonLimitWarningDlgComponent_OnClickCancel__);
...
void SummonLimitWarningDlgComponent__OnClickDecide(SummonLimitWarningDlgComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E00E78 & 1) == 0 )
  {
    sub_1CE6700(&Method_SummonLimitWarningDlgComponent_OnClickDecide__);
    byte_4E00E78 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SummonLimitWarningDlgComponent_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_SummonLimitWarningDlgComponent_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1CE66E4(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E00E79 & 1) == 0 )
  {
    sub_1CE6700(&Method_SummonLimitWarningDlgComponent_OnClickOtherScene__);
    byte_4E00E79 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SummonLimitWarningDlgComponent_OnClickOtherScene__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_SummonLimitWarningDlgComponent_OnClickOtherScene__);
    v4 = (System_Reflection_MethodBase_o *)sub_1CE66E4(v3, v3[4]);
...
void SummonLimitWarningDlgComponent__OnClickSetting(SummonLimitWarningDlgComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E00E7B & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_SummonLimitWarningDlgComponent_OnClickSetting__);
    sub_1CE6700(&Method_SummonLimitWarningDlgComponent_settingResult__);
    byte_4E00E7B = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SummonLimitWarningDlgComponent_OnClickSetting__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1CE6718(Method_SummonLimitWarningDlgComponent_OnClickSetting__);
  v4 = (System_Reflection_MethodBase_o *)sub_1CE66E4(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0);
  if ( !gameObject
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E00E75 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_SummonLimitWarningDlgComponent_EndOpen__);
    sub_1CE6700(&StringLiteral_12585/*"SUMMON_MANA_LIMIT_WARNING_DECIDE"*/);
    sub_1CE6700(&StringLiteral_12544/*"SUMMON_AUTOSALE_BUTTON"*/);
    sub_1CE6700(&StringLiteral_12586/*"SUMMON_MANA_LIMIT_WARNING_MSG"*/);
    sub_1CE6700(&StringLiteral_12581/*"SUMMON_LIMIT_WARNING_CANCEL"*/);
    sub_1CE6700(&StringLiteral_12587/*"SUMMON_MANA_LIMIT_WARNING_TITLE"*/);
    byte_4E00E75 = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0);
  if ( !gameObject )
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12587/*"SUMMON_MANA_LIMIT_WARNING_TITLE"*/, 0);
  if ( !titleLabel )
    goto LABEL_37;
  UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0);
  msgLabel = this->fields.msgLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12586/*"SUMMON_MANA_LIMIT_WARNING_MSG"*/, 0);
  if ( !v21 )
    goto LABEL_37;
  ...
  gameObject = (UnityEngine_GameObject_o *)System_String__Format_65164136(v24, v27, v28, 0);
  if ( !msgLabel )
    goto LABEL_37;
  UILabel__set_text(msgLabel, (System_String_o *)gameObject, 0);
  otherLabel = this->fields.otherLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12585/*"SUMMON_MANA_LIMIT_WARNING_DECIDE"*/, 0);
  if ( !otherLabel
    || (UILabel__set_text(otherLabel, (System_String_o *)gameObject, 0),
        cancelLabel = this->fields.cancelLabel,
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12581/*"SUMMON_LIMIT_WARNING_CANCEL"*/, 0),
        !cancelLabel)
    || (UILabel__set_text(cancelLabel, (System_String_o *)gameObject, 0),
        settingLabel = this->fields.settingLabel,
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12544/*"SUMMON_AUTOSALE_BUTTON"*/, 0),
        !settingLabel) )
  {
LABEL_37:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E00E74 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_SummonLimitWarningDlgComponent_EndOpen__);
    sub_1CE6700(&StringLiteral_12544/*"SUMMON_AUTOSALE_BUTTON"*/);
    sub_1CE6700(&StringLiteral_12594/*"SUMMON_QP_LIMIT_WARNING_MSG"*/);
    sub_1CE6700(&StringLiteral_12592/*"SUMMON_QP_LIMIT_WARNING_CONFIRM"*/);
    sub_1CE6700(&StringLiteral_3715/*"COMMON_CONFIRM_DECIDE"*/);
    sub_1CE6700(&StringLiteral_12597/*"SUMMON_QP_LIMIT_WARNING_WARNING"*/);
    sub_1CE6700(&StringLiteral_12581/*"SUMMON_LIMIT_WARNING_CANCEL"*/);
    sub_1CE6700(&StringLiteral_12595/*"SUMMON_QP_LIMIT_WARNING_TITLE"*/);
    sub_1CE6700(&StringLiteral_12593/*"SUMMON_QP_LIMIT_WARNING_DECIDE"*/);
    byte_4E00E74 = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0);
  if ( !gameObject )
  ...
  GameObjectExtensions__SetLocalPosition_37161168(v22, 8.0, 152.0, 0);
  gameObject = (UnityEngine_GameObject_o *)this->fields.warningLabel;
  if ( !gameObject )
    goto LABEL_43;
  v23 = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)gameObject, 0);
  GameObjectExtensions__SetLocalPosition_37161168(v23, 8.0, 87.0, 0);
  gameObject = (UnityEngine_GameObject_o *)this->fields.confirmLabel;
  if ( !gameObject )
    goto LABEL_43;
  v24 = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)gameObject, 0);
  GameObjectExtensions__SetLocalPosition_37161168(v24, 2.0, 49.0, 0);
  titleLabel2 = this->fields.titleLabel2;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12595/*"SUMMON_QP_LIMIT_WARNING_TITLE"*/, 0);
  if ( !titleLabel2 )
    goto LABEL_43;
  UILabel__set_text(titleLabel2, (System_String_o *)gameObject, 0);
  warningLabel = this->fields.warningLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12597/*"SUMMON_QP_LIMIT_WARNING_WARNING"*/, 0);
  if ( !warningLabel )
    goto LABEL_43;
  UILabel__set_text(warningLabel, (System_String_o *)gameObject, 0);
  confirmLabel = this->fields.confirmLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12592/*"SUMMON_QP_LIMIT_WARNING_CONFIRM"*/, 0);
  if ( !confirmLabel )
    goto LABEL_43;
  UILabel__set_text(confirmLabel, (System_String_o *)gameObject, 0);
  qpLabel = this->fields.qpLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12594/*"SUMMON_QP_LIMIT_WARNING_MSG"*/, 0);
  if ( !v21 )
    goto LABEL_43;
  ...
  gameObject = (UnityEngine_GameObject_o *)System_String__Format_65164136(v29, v32, v33, 0);
  if ( !qpLabel )
    goto LABEL_43;
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12593/*"SUMMON_QP_LIMIT_WARNING_DECIDE"*/, 0);
  if ( !otherLabel2
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E00E76 & 1) == 0 )
  {
    ...
    sub_1CE6700(&LocalizationManager_TypeInfo);
    sub_1CE6700(&Method_SummonLimitWarningDlgComponent_EndOpen__);
    sub_1CE6700(&StringLiteral_12598/*"SUMMON_QP_LIMIT_WARNING_WARNING2"*/);
    sub_1CE6700(&StringLiteral_12544/*"SUMMON_AUTOSALE_BUTTON"*/);
    sub_1CE6700(&StringLiteral_12594/*"SUMMON_QP_LIMIT_WARNING_MSG"*/);
    sub_1CE6700(&StringLiteral_12596/*"SUMMON_QP_LIMIT_WARNING_TITLE2"*/);
    sub_1CE6700(&StringLiteral_12592/*"SUMMON_QP_LIMIT_WARNING_CONFIRM"*/);
    sub_1CE6700(&StringLiteral_3715/*"COMMON_CONFIRM_DECIDE"*/);
    sub_1CE6700(&StringLiteral_12581/*"SUMMON_LIMIT_WARNING_CANCEL"*/);
    sub_1CE6700(&StringLiteral_12593/*"SUMMON_QP_LIMIT_WARNING_DECIDE"*/);
  ...
  if ( !gameObject )
    goto LABEL_43;
  v22 = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)gameObject, 0);
  GameObjectExtensions__SetLocalPosition_37161168(v22, 8.0, 140.0, 0);
  gameObject = (UnityEngine_GameObject_o *)this->fields.warningLabel;
  if ( !gameObject )
    goto LABEL_43;
  v23 = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)gameObject, 0);
  GameObjectExtensions__SetLocalPosition_37161168(v23, 8.0, 74.0, 0);
  gameObject = (UnityEngine_GameObject_o *)this->fields.confirmLabel;
  if ( !gameObject )
    goto LABEL_43;
  v24 = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)gameObject, 0);
  GameObjectExtensions__SetLocalPosition_37161168(v24, 3.0, 49.0, 0);
  titleLabel2 = this->fields.titleLabel2;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12596/*"SUMMON_QP_LIMIT_WARNING_TITLE2"*/, 0);
  if ( !titleLabel2 )
    goto LABEL_43;
  UILabel__set_text(titleLabel2, (System_String_o *)gameObject, 0);
  warningLabel = this->fields.warningLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12598/*"SUMMON_QP_LIMIT_WARNING_WARNING2"*/, 0);
  if ( !warningLabel )
    goto LABEL_43;
  UILabel__set_text(warningLabel, (System_String_o *)gameObject, 0);
  confirmLabel = this->fields.confirmLabel;
...
LABEL_8:
  ...
  if ( autoSaleDialogCloseCallbackFunc )
  {
    ...
    sub_1CE66A4(
      ...
      v17,
      v18);
    SummonLimitWarningDlgComponent__Close_36577636(this, 0, v19);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1B138DC;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1B13894;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E00E7D & 1) == 0 )
  {
    sub_1CE6700(&SummonLimitWarningDlgComponent_Result_TypeInfo);
    byte_4E00E7D = 1;
  }
  v9[1] = 0;
