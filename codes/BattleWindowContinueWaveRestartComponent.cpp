        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4187576 & 1) == 0 )
  {
    sub_B2C35C(&Method_BattleWindowContinueWaveRestartComponent_OnClickCancel__, method);
    byte_4187576 = 1;
  }
  ...
  if ( state > 4 || ((1 << state) & 0x16) == 0 )
  {
    ...
    if ( (*((_BYTE *)Method_BattleWindowContinueWaveRestartComponent_OnClickCancel__ + 75) & 2) != 0 )
      v4 = (_QWORD *)sub_B2C364(Method_BattleWindowContinueWaveRestartComponent_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4187575 & 1) == 0 )
  {
    sub_B2C35C(&Method_BattleWindowContinueWaveRestartComponent_OnClickDecide__, method);
    byte_4187575 = 1;
  }
  state = this->fields.state;
  if ( state > 4 || ((1 << state) & 0x16) == 0 )
  {
    ...
    if ( (*((_BYTE *)Method_BattleWindowContinueWaveRestartComponent_OnClickDecide__ + 75) & 2) != 0 )
      v4 = (_QWORD *)sub_B2C364(Method_BattleWindowContinueWaveRestartComponent_OnClickDecide__);
    v5 = (System_Reflection_MethodBase_o *)sub_B2C340(v4, v4[3]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4187574 & 1) == 0 )
  {
    sub_B2C35C(&LocalizationManager_TypeInfo, decideCall);
    sub_B2C35C(&StringLiteral_3388/*"CONTINUE_WAVE_RESTART_WINDOW_GIVE_UP_BUTTON"*/, v7);
    sub_B2C35C(&StringLiteral_3387/*"CONTINUE_WAVE_RESTART_WINDOW_DECIDE_BUTTON"*/, v8);
    sub_B2C35C(&StringLiteral_3389/*"CONTINUE_WAVE_RESTART_WINDOW_MESSAGE"*/, v9);
    sub_B2C35C(&StringLiteral_3390/*"CONTINUE_WAVE_RESTART_WINDOW_TITLE"*/, v10);
    byte_4187574 = 1;
  }
  ...
  v11 = LocalizationManager__Get((System_String_o *)StringLiteral_3390/*"CONTINUE_WAVE_RESTART_WINDOW_TITLE"*/, 0LL);
  v12 = LocalizationManager__Get((System_String_o *)StringLiteral_3389/*"CONTINUE_WAVE_RESTART_WINDOW_MESSAGE"*/, 0LL);
  v13 = LocalizationManager__Get((System_String_o *)StringLiteral_3387/*"CONTINUE_WAVE_RESTART_WINDOW_DECIDE_BUTTON"*/, 0LL);
  v14 = LocalizationManager__Get((System_String_o *)StringLiteral_3388/*"CONTINUE_WAVE_RESTART_WINDOW_GIVE_UP_BUTTON"*/, 0LL);
  BattleWindowContinueWaveRestartComponent__SetWindow_24701264(this, decideCall, cancelCall, v11, v12, v13, v14, v15);
}


void __fastcall BattleWindowContinueWaveRestartComponent__SetWindow_24701264(
        BattleWindowContinueWaveRestartComponent_o *this,
        System_Action_o *decideCall,
        System_Action_o *cancelCall,
