        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01570 & 1) == 0 )
  {
    sub_1B64870(&Method_BattleWindowContinueWaveRestartComponent_OnClickCancel__, method);
    byte_4A01570 = 1;
  }
    ...
    && !BattleWindowComponent__isOpening((BattleWindowComponent_o *)this, 0LL) )
  {
    ...
    if ( (*((_BYTE *)Method_BattleWindowContinueWaveRestartComponent_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B64888(Method_BattleWindowContinueWaveRestartComponent_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0156F & 1) == 0 )
  {
    sub_1B64870(&Method_BattleWindowContinueWaveRestartComponent_OnClickDecide__, method);
    byte_4A0156F = 1;
  }
  if ( !BattleWindowComponent__IsCloseorClosing((BattleWindowComponent_o *)this, 0LL)
    && !BattleWindowComponent__isOpening((BattleWindowComponent_o *)this, 0LL) )
  {
    ...
    if ( (*((_BYTE *)Method_BattleWindowContinueWaveRestartComponent_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B64888(Method_BattleWindowContinueWaveRestartComponent_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B64854(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0156E & 1) == 0 )
  {
    sub_1B64870(&LocalizationManager_TypeInfo, decideCall);
    sub_1B64870(&StringLiteral_3862/*"CONTINUE_WAVE_RESTART_WINDOW_GIVE_UP_BUTTON"*/, v7);
    sub_1B64870(&StringLiteral_3861/*"CONTINUE_WAVE_RESTART_WINDOW_DECIDE_BUTTON"*/, v8);
    sub_1B64870(&StringLiteral_3863/*"CONTINUE_WAVE_RESTART_WINDOW_MESSAGE"*/, v9);
    sub_1B64870(&StringLiteral_3864/*"CONTINUE_WAVE_RESTART_WINDOW_TITLE"*/, v10);
    byte_4A0156E = 1;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v11 = LocalizationManager__Get((System_String_o *)StringLiteral_3864/*"CONTINUE_WAVE_RESTART_WINDOW_TITLE"*/, 0LL);
  v12 = LocalizationManager__Get((System_String_o *)StringLiteral_3863/*"CONTINUE_WAVE_RESTART_WINDOW_MESSAGE"*/, 0LL);
  v13 = LocalizationManager__Get((System_String_o *)StringLiteral_3861/*"CONTINUE_WAVE_RESTART_WINDOW_DECIDE_BUTTON"*/, 0LL);
  v14 = LocalizationManager__Get((System_String_o *)StringLiteral_3862/*"CONTINUE_WAVE_RESTART_WINDOW_GIVE_UP_BUTTON"*/, 0LL);
  BattleWindowContinueWaveRestartComponent__SetWindow_43724512(this, decideCall, cancelCall, v11, v12, v13, v14, v15);
}


void __fastcall BattleWindowContinueWaveRestartComponent__SetWindow_43724512(
        BattleWindowContinueWaveRestartComponent_o *this,
        System_Action_o *decideCall,
        System_Action_o *cancelCall,
        ...
        const MethodInfo *method)
{
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.cancelCallback, (int32_t)cancelCall, v14, v15);
