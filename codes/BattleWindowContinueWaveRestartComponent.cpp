        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E082FE & 1) == 0 )
  {
    sub_1CE6700(&Method_BattleWindowContinueWaveRestartComponent_OnClickCancel__);
    byte_4E082FE = 1;
  }
    ...
    && !BattleWindowComponent__isOpening((BattleWindowComponent_o *)this, 0) )
  {
    ...
    if ( (*((_BYTE *)Method_BattleWindowContinueWaveRestartComponent_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_BattleWindowContinueWaveRestartComponent_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E082FD & 1) == 0 )
  {
    sub_1CE6700(&Method_BattleWindowContinueWaveRestartComponent_OnClickDecide__);
    byte_4E082FD = 1;
  }
  if ( !BattleWindowComponent__IsCloseorClosing((BattleWindowComponent_o *)this, 0)
    && !BattleWindowComponent__isOpening((BattleWindowComponent_o *)this, 0) )
  {
    ...
    if ( (*((_BYTE *)Method_BattleWindowContinueWaveRestartComponent_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_BattleWindowContinueWaveRestartComponent_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1CE66E4(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E082FC & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_3857/*"CONTINUE_WAVE_RESTART_WINDOW_GIVE_UP_BUTTON"*/);
  ...
  v7 = LocalizationManager__Get((System_String_o *)StringLiteral_3859/*"CONTINUE_WAVE_RESTART_WINDOW_TITLE"*/, 0);
  v8 = LocalizationManager__Get((System_String_o *)StringLiteral_3858/*"CONTINUE_WAVE_RESTART_WINDOW_MESSAGE"*/, 0);
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_3856/*"CONTINUE_WAVE_RESTART_WINDOW_DECIDE_BUTTON"*/, 0);
  v10 = LocalizationManager__Get((System_String_o *)StringLiteral_3857/*"CONTINUE_WAVE_RESTART_WINDOW_GIVE_UP_BUTTON"*/, 0);
  BattleWindowContinueWaveRestartComponent__SetWindow_48893188(this, decideCall, cancelCall, v7, v8, v9, v10, v11);
}


void BattleWindowContinueWaveRestartComponent__SetWindow_48893188(
        BattleWindowContinueWaveRestartComponent_o *this,
        System_Action_o *decideCall,
        System_Action_o *cancelCall,
