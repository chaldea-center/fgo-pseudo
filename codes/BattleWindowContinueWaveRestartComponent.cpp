        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C5A51E & 1) == 0 )
  {
    sub_1C3E564(&Method_BattleWindowContinueWaveRestartComponent_OnClickCancel__);
    byte_4C5A51E = 1;
  }
    ...
    && !BattleWindowComponent__isOpening((BattleWindowComponent_o *)this, 0) )
  {
    ...
    if ( (*((_BYTE *)Method_BattleWindowContinueWaveRestartComponent_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3E57C(Method_BattleWindowContinueWaveRestartComponent_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C5A51D & 1) == 0 )
  {
    sub_1C3E564(&Method_BattleWindowContinueWaveRestartComponent_OnClickDecide__);
    byte_4C5A51D = 1;
  }
  if ( !BattleWindowComponent__IsCloseorClosing((BattleWindowComponent_o *)this, 0)
    && !BattleWindowComponent__isOpening((BattleWindowComponent_o *)this, 0) )
  {
    ...
    if ( (*((_BYTE *)Method_BattleWindowContinueWaveRestartComponent_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3E57C(Method_BattleWindowContinueWaveRestartComponent_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C3E548(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C5A51C & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_3828/*"CONTINUE_WAVE_RESTART_WINDOW_GIVE_UP_BUTTON"*/);
  ...
  v7 = LocalizationManager__Get((System_String_o *)StringLiteral_3830/*"CONTINUE_WAVE_RESTART_WINDOW_TITLE"*/, 0);
  v8 = LocalizationManager__Get((System_String_o *)StringLiteral_3829/*"CONTINUE_WAVE_RESTART_WINDOW_MESSAGE"*/, 0);
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_3827/*"CONTINUE_WAVE_RESTART_WINDOW_DECIDE_BUTTON"*/, 0);
  v10 = LocalizationManager__Get((System_String_o *)StringLiteral_3828/*"CONTINUE_WAVE_RESTART_WINDOW_GIVE_UP_BUTTON"*/, 0);
  BattleWindowContinueWaveRestartComponent__SetWindow_47676656(this, decideCall, cancelCall, v7, v8, v9, v10, v11);
}


void BattleWindowContinueWaveRestartComponent__SetWindow_47676656(
        BattleWindowContinueWaveRestartComponent_o *this,
        System_Action_o *decideCall,
        System_Action_o *cancelCall,
        ...
        const MethodInfo *method)
{
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.cancelCallback, (int32_t)cancelCall, v14, v15);
