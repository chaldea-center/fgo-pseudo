        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF472 & 1) == 0 )
  {
    sub_1B640C8(&Method_BattleWindowContinueWaveRestartComponent_OnClickCancel__, method);
    byte_49FF472 = 1;
  }
    ...
    && !BattleWindowComponent__isOpening((BattleWindowComponent_o *)this, 0LL) )
  {
    ...
    if ( (*((_BYTE *)Method_BattleWindowContinueWaveRestartComponent_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B640E0(Method_BattleWindowContinueWaveRestartComponent_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF471 & 1) == 0 )
  {
    sub_1B640C8(&Method_BattleWindowContinueWaveRestartComponent_OnClickDecide__, method);
    byte_49FF471 = 1;
  }
  if ( !BattleWindowComponent__IsCloseorClosing((BattleWindowComponent_o *)this, 0LL)
    && !BattleWindowComponent__isOpening((BattleWindowComponent_o *)this, 0LL) )
  {
    ...
    if ( (*((_BYTE *)Method_BattleWindowContinueWaveRestartComponent_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B640E0(Method_BattleWindowContinueWaveRestartComponent_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B640AC(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF470 & 1) == 0 )
  {
    sub_1B640C8(&LocalizationManager_TypeInfo, decideCall);
    sub_1B640C8(&StringLiteral_3862/*"CONTINUE_WAVE_RESTART_WINDOW_GIVE_UP_BUTTON"*/, v7);
    sub_1B640C8(&StringLiteral_3861/*"CONTINUE_WAVE_RESTART_WINDOW_DECIDE_BUTTON"*/, v8);
    sub_1B640C8(&StringLiteral_3863/*"CONTINUE_WAVE_RESTART_WINDOW_MESSAGE"*/, v9);
    sub_1B640C8(&StringLiteral_3864/*"CONTINUE_WAVE_RESTART_WINDOW_TITLE"*/, v10);
    byte_49FF470 = 1;
  }
  ...
  BattleWindowContinueWaveRestartComponent__SetWindow_43717104(this, decideCall, cancelCall, v11, v12, v13, v14, v15);
}


void __fastcall BattleWindowContinueWaveRestartComponent__SetWindow_43717104(
        BattleWindowContinueWaveRestartComponent_o *this,
        System_Action_o *decideCall,
        System_Action_o *cancelCall,
        ...
        const MethodInfo *method)
{
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.cancelCallback, (int32_t)cancelCall, v14, v15);
