void UserEventServantPointEntity___cctor(const MethodInfo *method)
{
  if ( (byte_4D3182E & 1) == 0 )
  {
    sub_1C93AD4(&UserEventServantPointEntity_TypeInfo);
    byte_4D3182E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  *(_OWORD *)&v11.fields.fakeValue = v3;
  ...
  v10 = v11;
  v4 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_49657552(&v10, 0);
        ...
        const MethodInfo *method)
{
  ...
  v6 = System_Math__Min_65947884(maxValue, value, 0);
  if ( !System_Convert_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Convert_TypeInfo);
  return System_Convert__ToInt32_65510996(v6, 0);
}