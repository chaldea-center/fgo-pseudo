void __fastcall UserEventServantPointEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B45869 & 1) == 0 )
  {
    sub_1BDB878(&UserEventServantPointEntity_TypeInfo, v1);
    byte_4B45869 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45864 & 1) == 0 )
  {
    ...
    sub_1BDB878(&UserEventServantPointEntity_TypeInfo, v3);
    byte_4B45864 = 1;
  }
  ...
  *(_OWORD *)&v12.fields.fakeValue = v4;
  ...
  v11 = v12;
  v5 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_48231240(&v11, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45867 & 1) == 0 )
  {
    sub_1BDB878(&UserEventServantPointEntity_TypeInfo, method);
    byte_4B45867 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45866 & 1) == 0 )
  {
    sub_1BDB878(&System_Convert_TypeInfo, maxValue);
  ...
  v7 = System_Math__Min_64100920(v3, value, 0LL);
  if ( !System_Convert_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Convert_TypeInfo);
  return System_Convert__ToInt32_63645316(v7, 0LL);
}