void UserEventServantPointEntity___cctor(const MethodInfo *method)
{
  if ( (byte_4CEF4AD & 1) == 0 )
  {
    sub_1C7BAE8(&UserEventServantPointEntity_TypeInfo);
    byte_4CEF4AD = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  *(_OWORD *)&v11.fields.fakeValue = v3;
  ...
  v10 = v11;
  v4 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_49453300(&v10, 0);
        ...
        const MethodInfo *method)
{
  ...
  v6 = System_Math__Min_65699080(maxValue, value, 0);
  if ( !System_Convert_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Convert_TypeInfo);
  return System_Convert__ToInt32_65262184(v6, 0);
}