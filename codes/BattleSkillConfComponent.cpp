void __fastcall BattleSkillConfComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C00AE6 & 1) == 0 )
  {
    sub_1C2E12C(&BattleSkillConfComponent_TypeInfo, v1);
    byte_4C00AE6 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  System_String_o *Detail_41288576; // x26
  ...
  if ( (byte_4C00AE0 & 1) == 0 )
  {
    sub_1C2E12C(&BattleSkillConfComponent_TypeInfo, skillInfo);
    sub_1C2E12C(&Method_UnityEngine_Component_GetComponent_BoxCollider___, v12);
    sub_1C2E12C(&Method_DataManager_GetMasterData_SkillLvMaster___, v13);
    sub_1C2E12C(&Method_DataManager_GetMasterData_SkillMaster___, v14);
    sub_1C2E12C(&Method_DataMasterBase_SkillMaster__SkillEntity__int__GetEntity__, v15);
    sub_1C2E12C(&Method_UnityEngine_GameObject_GetComponent_Collider___, v16);
    sub_1C2E12C(&Method_UnityEngine_GameObject_GetComponent_ServantSkillStrengthStatus___, v17);
    sub_1C2E12C(&Method_UnityEngine_GameObject_GetComponent_UIButton___, v18);
    sub_1C2E12C(&int_TypeInfo, v19);
    sub_1C2E12C(&LocalizationManager_TypeInfo, v20);
    sub_1C2E12C(&UnityEngine_Object_TypeInfo, v21);
    sub_1C2E12C(&ServantSkillStrengthStatus_TypeInfo, v22);
    sub_1C2E12C(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v23);
    sub_1C2E12C(&StringLiteral_3019/*"BATTLE_SKILL_CONF_TITLE"*/, v24);
    sub_1C2E12C(&StringLiteral_25458/*"{0}  Lv.{1}"*/, v25);
  ...
  if ( UnityEngine_Object__op_Inequality(skillTitleLabel, 0LL, 0LL) )
  {
    ...
    data = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_3019/*"BATTLE_SKILL_CONF_TITLE"*/, 0LL);
    if ( !v29 )
      goto LABEL_159;
              ...
              if ( *p_skillInfo )
              {
                if ( v52 )
                {
                  ...
                  else
                  {
                    ...
                    data = (__int64)System_String__Format_63249956(
                                      (System_String_o *)StringLiteral_25458/*"{0}  Lv.{1}"*/,
                                      v60,
                                      v63,
                                      0LL);
                    if ( !skillNameLabel )
                  ...
                  if ( data )
                  {
                    ...
                    data = (__int64)BaseMonoBehaviour__createObject_39556320(
                        ...
                        if ( skillConfLabel )
                        {
                          ...
                          if ( v77 )
                          {
                            if ( v55 )
                            {
                              ...
                              Detail_41288576 = SkillLvEntity__getDetail_41288576(v55, v77->fields.skilllv, 0, 0LL);
                              if ( isSetMinSize )
                              {
                                        ...
                                        if ( data )
                                        {
                                          ...
                                          if ( data )
                                          {
                                            ...
                                            if ( UnityEngine_Object__op_Inequality(useCondSkillConfLabel, 0LL, 0LL) )
                                            {
                                              ...
                                              v91 = SkillLvEntity__getDetail_41288576(v55, v89->fields.skilllv, 0, 0LL);
                                              if ( isSetMinSize )
                                              {
...
void __fastcall BattleSkillConfComponent__SetUseCond(BattleSkillConfComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C00AE3 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_SingletonTemplate_BattleItemData__get_Instance__, v11);
    sub_1C2E12C(&string_TypeInfo, v12);
    sub_1C2E12C(&StringLiteral_21789/*"menu_txt_remaining"*/, v13);
    sub_1C2E12C(&StringLiteral_21790/*"menu_txt_spend"*/, v14);
    sub_1C2E12C(&StringLiteral_2943/*"BATTLE_MASTER_SKILL_ADD_NOT_OPEN_COND_COLOR"*/, v15);
    sub_1C2E12C(&StringLiteral_23798/*"skill_item_{0}"*/, v16);
    byte_4C00AE3 = 1;
  }
  entity = 0LL;
  CondItemNumber = 0;
  ...
  if ( !skillInfo )
    goto LABEL_92;
  UnityEngine_GameObject__SetActive(skillInfo, 1, 0LL);
  skillInfo = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38A7F90 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !skillInfo )
    goto LABEL_92;
  ...
  {
    skillInfo = (UnityEngine_GameObject_o *)SingletonTemplate_object___get_Instance((const MethodInfo_38A83B0 *)Method_SingletonTemplate_BattleItemData__get_Instance__);
    if ( !entity || !skillInfo )
      goto LABEL_92;
    ...
    if ( v28 )
    {
      if ( v29 )
      {
        ...
        if ( skillInfo )
        {
          ...
          v35 = System_String__Format((System_String_o *)StringLiteral_23798/*"skill_item_{0}"*/, v34, 0LL);
          if ( !AtlasManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    ...
    else
    {
      if ( v29 )
      {
        ...
        if ( skillInfo )
        {
          ...
          v42 = System_String__Format((System_String_o *)StringLiteral_23798/*"skill_item_{0}"*/, v41, 0LL);
          if ( !AtlasManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
...
LABEL_79:
  ...
  if ( UnityEngine_Object__op_Inequality(useCondItemLess, 0LL, 0LL) )
  {
    ...
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetEventSprite(v53, (System_String_o *)StringLiteral_21789/*"menu_txt_remaining"*/, 0LL);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(useCondItemConsume, 0LL, 0LL) )
  {
    ...
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetEventSprite(v55, (System_String_o *)StringLiteral_21790/*"menu_txt_spend"*/, 0LL);
  }
}
...
LABEL_12:
    sub_1C2E388(skillConfLabel, method);
  }
}
...
void __fastcall BattleSkillConfComponent__onClickCancel(BattleSkillConfComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C00AE1 & 1) == 0 )
  {
    sub_1C2E12C(&Method_UnityEngine_GameObject_GetComponent_BattlePerformanceMaster___, method);
    sub_1C2E12C(&Method_UnityEngine_GameObject_GetComponent_BattlePerformancePlayer___, v3);
  ...
  if ( !UnityEngine_Object__op_Equality(target, 0LL, 0LL) )
  {
    ...
    Component_object = UnityEngine_GameObject__GetComponent_object_(
                         v7,
                         (const MethodInfo_3022B0C *)Method_UnityEngine_GameObject_GetComponent_BattlePerformancePlayer___);
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
...
void __fastcall BattleSkillConfComponent__onClickOK(BattleSkillConfComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C00AE2 & 1) == 0 )
  {
    sub_1C2E12C(&Method_BattleSkillConfComponent_onClickOK__, method);
    sub_1C2E12C(&Method_UnityEngine_GameObject_GetComponent_BattlePerformanceMaster___, v3);
    sub_1C2E12C(&Method_UnityEngine_GameObject_GetComponent_BattlePerformancePlayer___, v4);
  ...
  if ( this->fields.isPlaySkill )
  {
    if ( !this->fields.isPlayedSe )
    {
      ...
      if ( (*((_BYTE *)Method_BattleSkillConfComponent_onClickOK__ + 83) & 2) != 0 )
        v6 = (_QWORD *)sub_1C2E144(Method_BattleSkillConfComponent_onClickOK__);
...
LABEL_27:
  ...
  else
  {
    ...
    if ( (*((_BYTE *)Method_BattleSkillConfComponent_onClickOK__ + 83) & 2) != 0 )
      v13 = (_QWORD *)sub_1C2E144(Method_BattleSkillConfComponent_onClickOK__);
