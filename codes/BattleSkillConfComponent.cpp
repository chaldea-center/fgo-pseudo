void __fastcall BattleSkillConfComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C25314 & 1) == 0 )
  {
    sub_1C3B764(&BattleSkillConfComponent_TypeInfo, v1);
    byte_4C25314 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  System_String_o *Detail_41399620; // x26
  ...
  if ( (byte_4C2530E & 1) == 0 )
  {
    sub_1C3B764(&BattleSkillConfComponent_TypeInfo, skillInfo);
    sub_1C3B764(&Method_UnityEngine_Component_GetComponent_BoxCollider___, v12);
    sub_1C3B764(&Method_DataManager_GetMasterData_SkillLvMaster___, v13);
    sub_1C3B764(&Method_DataManager_GetMasterData_SkillMaster___, v14);
    sub_1C3B764(&Method_DataMasterBase_SkillMaster__SkillEntity__int__GetEntity__, v15);
    sub_1C3B764(&Method_UnityEngine_GameObject_GetComponent_Collider___, v16);
    sub_1C3B764(&Method_UnityEngine_GameObject_GetComponent_ServantSkillStrengthStatus___, v17);
    sub_1C3B764(&Method_UnityEngine_GameObject_GetComponent_UIButton___, v18);
    sub_1C3B764(&int_TypeInfo, v19);
    sub_1C3B764(&LocalizationManager_TypeInfo, v20);
    sub_1C3B764(&UnityEngine_Object_TypeInfo, v21);
    sub_1C3B764(&ServantSkillStrengthStatus_TypeInfo, v22);
    sub_1C3B764(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v23);
    sub_1C3B764(&StringLiteral_3019/*"BZip2OutputStream position cannot be set"*/, v24);
    sub_1C3B764(&StringLiteral_25502, v25);
  ...
  if ( UnityEngine_Object__op_Inequality(skillTitleLabel, 0LL, 0LL) )
  {
    ...
    data = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_3019/*"BZip2OutputStream position cannot be set"*/, 0LL);
    if ( !v29 )
      goto LABEL_159;
              ...
              if ( *p_skillInfo )
              {
                if ( v52 )
                {
                  ...
                  else
                  {
                    ...
                    data = (__int64)System_String__Format_63382984(
                  ...
                  if ( data )
                  {
                    ...
                    data = (__int64)BaseMonoBehaviour__createObject_39665308(
                        ...
                        if ( skillConfLabel )
                        {
                          ...
                          if ( v77 )
                          {
                            if ( v55 )
                            {
                              ...
                              Detail_41399620 = SkillLvEntity__getDetail_41399620(v55, v77->fields.skilllv, 0, 0LL);
                              if ( isSetMinSize )
                              {
                                        ...
                                        if ( data )
                                        {
                                          ...
                                          if ( data )
                                          {
                                            ...
                                            if ( UnityEngine_Object__op_Inequality(useCondSkillConfLabel, 0LL, 0LL) )
                                            {
                                              ...
                                              v91 = SkillLvEntity__getDetail_41399620(v55, v89->fields.skilllv, 0, 0LL);
                                              if ( isSetMinSize )
                                              {
...
void __fastcall BattleSkillConfComponent__SetUseCond(BattleSkillConfComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C25311 & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_SingletonTemplate_BattleItemData__get_Instance__, v11);
    sub_1C3B764(&string_TypeInfo, v12);
    sub_1C3B764(&StringLiteral_21825/*"notUseRestrictionDialog"*/, v13);
    sub_1C3B764(&StringLiteral_21826/*"notation"*/, v14);
    sub_1C3B764(&StringLiteral_2943/*"BONUS_SELECT_GACHA"*/, v15);
    sub_1C3B764(&StringLiteral_23841/*"unique"*/, v16);
    byte_4C25311 = 1;
  }
  entity = 0LL;
  CondItemNumber = 0;
  ...
  if ( !skillInfo )
    goto LABEL_92;
  UnityEngine_GameObject__SetActive(skillInfo, 1, 0LL);
  skillInfo = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !skillInfo )
    goto LABEL_92;
  ...
  {
    skillInfo = (UnityEngine_GameObject_o *)SingletonTemplate_object___get_Instance((const MethodInfo_38C8B54 *)Method_SingletonTemplate_BattleItemData__get_Instance__);
    if ( !entity || !skillInfo )
      goto LABEL_92;
...
LABEL_28:
    ...
    if ( v28 )
    {
      if ( v29 )
      {
        ...
        if ( skillInfo )
        {
          ...
          v35 = System_String__Format((System_String_o *)StringLiteral_23841/*"unique"*/, v34, 0LL);
          if ( !AtlasManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    ...
    else
    {
      if ( v29 )
      {
        ...
        if ( skillInfo )
        {
          ...
          v42 = System_String__Format((System_String_o *)StringLiteral_23841/*"unique"*/, v41, 0LL);
          if ( !AtlasManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  ...
  if ( UnityEngine_Object__op_Inequality(useCondItemCount, 0LL, 0LL) )
  {
    ...
    else
    {
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v45 = LocalizationManager__Get((System_String_o *)StringLiteral_2943/*"BONUS_SELECT_GACHA"*/, 0LL);
      m_CachedPtr = num;
...
LABEL_79:
  ...
  if ( UnityEngine_Object__op_Inequality(useCondItemLess, 0LL, 0LL) )
  {
    ...
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetEventSprite(v53, (System_String_o *)StringLiteral_21825/*"notUseRestrictionDialog"*/, 0LL);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(useCondItemConsume, 0LL, 0LL) )
  {
    ...
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetEventSprite(v55, (System_String_o *)StringLiteral_21826/*"notation"*/, 0LL);
  }
}
...
LABEL_12:
    sub_1C3B9C0(skillConfLabel, method);
  }
}
...
void __fastcall BattleSkillConfComponent__onClickCancel(BattleSkillConfComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2530F & 1) == 0 )
  {
    sub_1C3B764(&Method_UnityEngine_GameObject_GetComponent_BattlePerformanceMaster___, method);
    sub_1C3B764(&Method_UnityEngine_GameObject_GetComponent_BattlePerformancePlayer___, v3);
  ...
  if ( !UnityEngine_Object__op_Equality(target, 0LL, 0LL) )
  {
    ...
    Component_object = UnityEngine_GameObject__GetComponent_object_(
                         v7,
                         (const MethodInfo_3041A18 *)Method_UnityEngine_GameObject_GetComponent_BattlePerformancePlayer___);
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
...
void __fastcall BattleSkillConfComponent__onClickOK(BattleSkillConfComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C25310 & 1) == 0 )
  {
    sub_1C3B764(&Method_BattleSkillConfComponent_onClickOK__, method);
    sub_1C3B764(&Method_UnityEngine_GameObject_GetComponent_BattlePerformanceMaster___, v3);
    sub_1C3B764(&Method_UnityEngine_GameObject_GetComponent_BattlePerformancePlayer___, v4);
  ...
  if ( this->fields.isPlaySkill )
  {
    if ( !this->fields.isPlayedSe )
    {
      ...
      if ( (*((_BYTE *)Method_BattleSkillConfComponent_onClickOK__ + 83) & 2) != 0 )
        v6 = (_QWORD *)sub_1C3B77C(Method_BattleSkillConfComponent_onClickOK__);
...
LABEL_27:
  ...
  else
  {
    ...
    if ( (*((_BYTE *)Method_BattleSkillConfComponent_onClickOK__ + 83) & 2) != 0 )
      v13 = (_QWORD *)sub_1C3B77C(Method_BattleSkillConfComponent_onClickOK__);
