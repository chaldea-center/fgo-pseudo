        ...
        const MethodInfo *method)
{
  if ( (byte_4BFD8AF & 1) == 0 )
  {
    sub_1C2E12C(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int___, *(_QWORD *)&statusId);
    byte_4BFD8AF = 1;
  }
...
int32_t __fastcall EventStatusQuestEntity__getPriority(EventStatusQuestEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFD8B0 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&StringLiteral_22556/*"notClearPriority"*/, v6);
    byte_4BFD8B0 = 1;
  }
  ...
  if ( !script
    || !System_Collections_Generic_Dictionary_object__object___ContainsKey(
          ...
          (Il2CppObject *)StringLiteral_22556/*"notClearPriority"*/,
  ...
  if ( CondType__IsQuestClear_38902436(questId, -1, 0, 0LL) )
  {
LABEL_8:
