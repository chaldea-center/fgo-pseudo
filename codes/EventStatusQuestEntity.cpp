...
int32_t __fastcall EventStatusQuestEntity__getPriority(EventStatusQuestEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_438ED20 & 1) == 0 )
  {
    ...
    sub_B775C4(&StringLiteral_21575/*"notClearPriority"*/);
    byte_438ED20 = 1;
  }
  ...
  if ( !script
    || !System_Collections_Generic_Dictionary_XmlQualifiedName__XmlSchemaObject___ContainsKey(
          ...
          (System_Xml_XmlQualifiedName_o *)StringLiteral_21575/*"notClearPriority"*/,
  ...
  if ( CondType__IsQuestClear_24699280(questId, -1, 0, 0LL) )
  {
LABEL_9:
  ...
  if ( !Item
    || (Item = (System_Collections_Generic_Dictionary_Type__IStoreExtension__o *)System_Collections_Generic_Dictionary_Type__IStoreExtension___get_Item(
                                                                                   Item,
                                                                                   (System_Type_o *)StringLiteral_21575/*"notClearPriority"*/,
