        ...
        const MethodInfo *method)
{
  if ( (byte_4A1FC44 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int___, *(_QWORD *)&statusId);
    byte_4A1FC44 = 1;
  }
...
int32_t __fastcall EventStatusQuestEntity__getPriority(EventStatusQuestEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1FC45 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_22085/*"notClearPriority"*/, v6);
    byte_4A1FC45 = 1;
  }
  ...
  if ( !script
    || !System_Collections_Generic_Dictionary_object__object___ContainsKey(
          ...
          (Il2CppObject *)StringLiteral_22085/*"notClearPriority"*/,
  ...
  if ( CondType__IsQuestClear_37394868(questId, -1, 0, 0LL) )
  {
LABEL_8:
