        ...
        const MethodInfo *method)
{
  if ( (byte_4B3730A & 1) == 0 )
  {
    sub_1BD3458(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int___, *(_QWORD *)&statusId);
    byte_4B3730A = 1;
  }
...
int32_t __fastcall EventStatusQuestEntity__getPriority(EventStatusQuestEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3730B & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_22412/*"notClearPriority"*/, v6);
    byte_4B3730B = 1;
  }
  ...
  if ( !script
    || !System_Collections_Generic_Dictionary_object__object___ContainsKey(
          ...
          (Il2CppObject *)StringLiteral_22412/*"notClearPriority"*/,
  ...
  if ( CondType__IsQuestClear_38374588(questId, -1, 0, 0LL) )
  {
LABEL_8:
