        ...
        const MethodInfo *method)
{
  if ( (byte_4A2E0B1 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int___, *(_QWORD *)&statusId);
    byte_4A2E0B1 = 1;
  }
...
int32_t __fastcall EventStatusQuestEntity__getPriority(EventStatusQuestEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2E0B2 & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_22131/*"notClearPriority"*/, v6);
    byte_4A2E0B2 = 1;
  }
  ...
  if ( !script
    || !System_Collections_Generic_Dictionary_object__object___ContainsKey(
          ...
          (Il2CppObject *)StringLiteral_22131/*"notClearPriority"*/,
  ...
  if ( CondType__IsQuestClear_37418488(questId, -1, 0, 0LL) )
  {
LABEL_8:
