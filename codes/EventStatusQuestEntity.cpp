        ...
        const MethodInfo *method)
{
  if ( (byte_4A4E606 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int___, *(_QWORD *)&statusId);
    byte_4A4E606 = 1;
  }
...
int32_t __fastcall EventStatusQuestEntity__getPriority(EventStatusQuestEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4E607 & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_21977/*"notClearPriority"*/, v6);
    byte_4A4E607 = 1;
  }
  ...
  if ( !script
    || !System_Collections_Generic_Dictionary_object__object___ContainsKey(
          ...
          (Il2CppObject *)StringLiteral_21977/*"notClearPriority"*/,
  ...
  if ( CondType__IsQuestClear_38542260(questId, -1, 0, 0LL) )
  {
LABEL_8:
