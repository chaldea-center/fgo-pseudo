void __fastcall BankShopMaster___ctor(BankShopMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4211620 & 1) == 0 )
  {
    sub_B0D8A4(&Method_DataMasterBase_BankShopMaster__BankShopEntity__int___ctor__, method);
    byte_4211620 = 1;
  }
  DataMasterBase_WarMaster__WarEntity__int____ctor(
    (DataMasterBase_WarMaster__WarEntity__int__o *)this,
    43,
    (const MethodInfo_2669B38 *)Method_DataMasterBase_BankShopMaster__BankShopEntity__int___ctor__);
}
...
BankShopEntity_array *__fastcall BankShopMaster__GetEnableEntitiyList(BankShopMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4211621 & 1) == 0 )
  {
    sub_B0D8A4(&BankShopEntity_TypeInfo, method);
    ...
    sub_B0D8A4(&Method_System_Collections_Generic_List_BankShopEntity__Add__, v5);
    sub_B0D8A4(&Method_System_Collections_Generic_List_BankShopEntity__ToArray__, v6);
    sub_B0D8A4(&Method_System_Collections_Generic_List_BankShopEntity___ctor__, v7);
    sub_B0D8A4(&System_Collections_Generic_List_BankShopEntity__TypeInfo, v8);
    ...
    while ( 1 )
    {
      ...
      if ( list )
      {
        ...
        if ( *(&list->klass->_2.bitflags2 + 1) >= (unsigned int)v17
          && (BankShopEntity_c *)list->klass->_2.typeHierarchy[v17 - 1] == BankShopEntity_TypeInfo
          ...
          && Time <= (__int64)list[3].fields.items )
        {
          ...
          System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData___Add(
            ...
            (const MethodInfo_2FC56E8 *)Method_System_Collections_Generic_List_BankShopEntity__Add__);
        }
      }
      if ( ++v16 >= v15 )
        goto LABEL_18;
...
LABEL_18:
  ...
  return (BankShopEntity_array *)System_Collections_Generic_List_WarBoardUiData_SaveData___ToArray(
                                   ...
                                   (const MethodInfo_2FC7834 *)Method_System_Collections_Generic_List_BankShopEntity__ToArray__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4211622 & 1) == 0 )
  {
    sub_B0D8A4(&BankShopEntity_TypeInfo, productId);
    ...
    while ( 1 )
    {
      ...
      if ( list )
      {
          ...
          && *(BankShopEntity_c **)(*(_QWORD *)(*(_QWORD *)list + 200LL) + 8 * v12 - 8) == BankShopEntity_TypeInfo )
        {
          if ( !productId )
            break;
          if ( System_String__Equals_43837244(productId, *((System_String_o **)list + 4), 0LL) )
            return v11;
        }
      }
      if ( ++v10 >= v9 )
