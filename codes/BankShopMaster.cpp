void BankShopMaster___ctor(BankShopMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4CC6FD9 & 1) == 0 )
  {
    sub_1C713B0(&Method_DataMasterBase_BankShopMaster__BankShopEntity__int___ctor__);
    byte_4CC6FD9 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    49,
    (const MethodInfo_3406B5C *)Method_DataMasterBase_BankShopMaster__BankShopEntity__int___ctor__);
}
...
BankShopEntity_array *BankShopMaster__GetBuyableEntitiyList(BankShopMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC6FDB & 1) == 0 )
  {
    sub_1C713B0(&Method_System_Collections_ObjectModel_Collection_BankShopEntity__get_Count__);
    sub_1C713B0(&Method_System_Collections_ObjectModel_Collection_BankShopEntity__get_Item__);
    sub_1C713B0(&System_Comparison_BankShopEntity__TypeInfo);
    sub_1C713B0(&Method_System_Collections_Generic_List_BankShopEntity__Add__);
    sub_1C713B0(&Method_System_Collections_Generic_List_BankShopEntity__Sort__);
    sub_1C713B0(&Method_System_Collections_Generic_List_BankShopEntity__ToArray__);
    ...
    sub_1C713B0(&Method_BankShopMaster___c__GetBuyableEntitiyList_b__2_0__);
    sub_1C713B0(&BankShopMaster___c_TypeInfo);
    byte_4CC6FDB = 1;
  }
  v3 = (System_Collections_Generic_List_object__o *)sub_1C715FC(System_Collections_Generic_List_BankShopEntity__TypeInfo);
  ...
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            ...
            (const MethodInfo_33A1C08 *)Method_System_Collections_ObjectModel_Collection_BankShopEntity__get_Count__);
  if ( Count >= 1 )
  {
    v7 = Count;
    v8 = 0;
    while ( 1 )
    {
      ...
      Item = System_Collections_ObjectModel_Collection_object___get_Item(
               (System_Collections_ObjectModel_Collection_T__o *)list,
               v8,
               (const MethodInfo_33A1C98 *)Method_System_Collections_ObjectModel_Collection_BankShopEntity__get_Item__);
      if ( Item )
      {
        v10 = Item;
...
LABEL_15:
  ...
  if ( !v21 )
  {
    ...
    v21 = (System_Comparison_T__o *)sub_1C715FC(System_Comparison_BankShopEntity__TypeInfo);
  ...
  System_Collections_Generic_List_object___Sort_58794460(
    v3,
    v21,
    (const MethodInfo_38121DC *)Method_System_Collections_Generic_List_BankShopEntity__Sort__);
  return (BankShopEntity_array *)System_Collections_Generic_List_object___ToArray(
                                   v3,
                                   (const MethodInfo_3812270 *)Method_System_Collections_Generic_List_BankShopEntity__ToArray__);
}
...
BankShopEntity_array *BankShopMaster__GetEnableEntitiyList(BankShopMaster_o *this, const MethodInfo *method)
{
  ...
  v4 = (System_Collections_Generic_List_object__o *)sub_1C715FC(System_Collections_Generic_List_BankShopEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v4,
    (const MethodInfo_380FEE4 *)Method_System_Collections_Generic_List_BankShopEntity___ctor__);
  ...
  if ( Count >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( list )
      {
        ...
        if ( System_String__Equals_64067044(productId, *((System_String_o **)list + 4), 0) )
          return v9;
      }
      if ( v7 == ++v8 )
        return 0;
...
void BankShopMaster___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C715FC(BankShopMaster___c_TypeInfo);
