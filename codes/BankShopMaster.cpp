void __fastcall BankShopMaster___ctor(BankShopMaster_o *this, const MethodInfo *method)
{
  if ( (byte_42ACEEA & 1) == 0 )
  {
    sub_B52984(&Method_DataMasterBase_BankShopMaster__BankShopEntity__int___ctor__);
    byte_42ACEEA = 1;
  }
  DataMasterBase_WarMaster__WarEntity__int____ctor(
    (DataMasterBase_WarMaster__WarEntity__int__o *)this,
    44,
    (const MethodInfo_23E223C *)Method_DataMasterBase_BankShopMaster__BankShopEntity__int___ctor__);
}
...
BankShopEntity_array *__fastcall BankShopMaster__GetEnableEntitiyList(BankShopMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42ACEEB & 1) == 0 )
  {
    sub_B52984(&BankShopEntity_TypeInfo);
    sub_B52984(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__);
    sub_B52984(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Item__);
    sub_B52984(&Method_System_Collections_Generic_List_BankShopEntity__Add__);
    sub_B52984(&Method_System_Collections_Generic_List_BankShopEntity__ToArray__);
  ...
  v4 = (System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData__o *)sub_B52A54(System_Collections_Generic_List_BankShopEntity__TypeInfo);
      ...
      if ( list )
      {
          ...
          && Time <= (__int64)list[3].fields.items )
        {
          ...
          System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData___Add(
            ...
            (const MethodInfo_2FF1604 *)Method_System_Collections_Generic_List_BankShopEntity__Add__);
        }
      }
      if ( ++v8 >= v7 )
        goto LABEL_18;
...
LABEL_18:
  ...
  return (BankShopEntity_array *)System_Collections_Generic_List_WarBoardUiData_SaveData___ToArray(
                                   ...
                                   (const MethodInfo_2FF3750 *)Method_System_Collections_Generic_List_BankShopEntity__ToArray__);
}
    ...
    while ( 1 )
    {
      ...
      if ( list )
      {
          ...
          && *(BankShopEntity_c **)(*(_QWORD *)(*(_QWORD *)list + 200LL) + 8 * v10 - 8) == BankShopEntity_TypeInfo )
        {
          if ( !productId )
            break;
          if ( System_String__Equals_44555656(productId, *((System_String_o **)list + 4), 0LL) )
            return v9;
        }
      }
      if ( ++v8 >= v7 )
