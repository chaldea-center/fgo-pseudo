void __fastcall BankShopMaster___ctor(BankShopMaster_o *this, const MethodInfo *method)
{
  if ( (byte_49FE172 & 1) == 0 )
  {
    sub_1B64870(&Method_DataMasterBase_BankShopMaster__BankShopEntity__int___ctor__, method);
    byte_49FE172 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    45,
    (const MethodInfo_30D6140 *)Method_DataMasterBase_BankShopMaster__BankShopEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE174 & 1) == 0 )
  {
    sub_1B64870(&BankShopEntity_TypeInfo, method);
    sub_1B64870(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__, v3);
    sub_1B64870(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Item__, v4);
    sub_1B64870(&System_Comparison_BankShopEntity__TypeInfo, v5);
    sub_1B64870(&Method_System_Collections_Generic_List_BankShopEntity__Add__, v6);
    sub_1B64870(&Method_System_Collections_Generic_List_BankShopEntity__Sort__, v7);
    sub_1B64870(&Method_System_Collections_Generic_List_BankShopEntity__ToArray__, v8);
    sub_1B64870(&Method_System_Collections_Generic_List_BankShopEntity___ctor__, v9);
    sub_1B64870(&System_Collections_Generic_List_BankShopEntity__TypeInfo, v10);
    sub_1B64870(&Method_BankShopMaster___c__GetBuyableEntitiyList_b__2_0__, v11);
    sub_1B64870(&BankShopMaster___c_TypeInfo, v12);
    byte_49FE174 = 1;
  }
  v13 = (System_Collections_Generic_List_object__o *)sub_1B64ABC(System_Collections_Generic_List_BankShopEntity__TypeInfo);
...
LABEL_17:
  ...
  if ( !v28 )
  {
    ...
    v28 = (System_Comparison_T__o *)sub_1B64ABC(System_Comparison_BankShopEntity__TypeInfo);
    ...
    sub_1B64814((ServantStatusBattleListViewItem_o *)&static_fields->__9__2_0, (int32_t)v28, v31, v32);
  }
  if ( !v13 )
    goto LABEL_25;
  System_Collections_Generic_List_object___Sort_55252244(
    v13,
    v28,
    (const MethodInfo_34B1514 *)Method_System_Collections_Generic_List_BankShopEntity__Sort__);
  return (BankShopEntity_array *)System_Collections_Generic_List_object___ToArray(
                                   v13,
                                   (const MethodInfo_34B15A8 *)Method_System_Collections_Generic_List_BankShopEntity__ToArray__);
}
...
BankShopEntity_array *__fastcall BankShopMaster__GetEnableEntitiyList(BankShopMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FE173 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__, v3);
    sub_1B64870(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Item__, v4);
    sub_1B64870(&Method_System_Collections_Generic_List_BankShopEntity__Add__, v5);
    sub_1B64870(&Method_System_Collections_Generic_List_BankShopEntity__ToArray__, v6);
    sub_1B64870(&Method_System_Collections_Generic_List_BankShopEntity___ctor__, v7);
    sub_1B64870(&System_Collections_Generic_List_BankShopEntity__TypeInfo, v8);
  ...
  v11 = (System_Collections_Generic_List_object__o *)sub_1B64ABC(System_Collections_Generic_List_BankShopEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v11,
    (const MethodInfo_34AF17C *)Method_System_Collections_Generic_List_BankShopEntity___ctor__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE175 & 1) == 0 )
  {
    sub_1B64870(&BankShopEntity_TypeInfo, productId);
    ...
    while ( 1 )
    {
      ...
      if ( list )
      {
          ...
          && *(BankShopEntity_c **)(*(_QWORD *)(*(_QWORD *)list + 200LL) + 8 * methodPtr_low - 8) == BankShopEntity_TypeInfo )
        {
          if ( !productId )
            break;
          if ( System_String__Equals_61391892(productId, *((System_String_o **)list + 4), 0LL) )
            return v11;
        }
      }
      if ( v9 == ++v10 )
...
void __fastcall BankShopMaster___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FE177 & 1) == 0 )
  {
    sub_1B64870(&BankShopMaster___c_TypeInfo, v1);
    byte_49FE177 = 1;
  }
  v2 = (Il2CppObject *)sub_1B64ABC(BankShopMaster___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  BankShopMaster___c_TypeInfo->static_fields->__9 = (struct BankShopMaster___c_o *)v2;
  sub_1B64814((ServantStatusBattleListViewItem_o *)BankShopMaster___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
