void __fastcall EventBoardGameDiceCounter___ctor(EventBoardGameDiceCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0C88E & 1) == 0 )
  {
    sub_1B686D4(&StringLiteral_19632/*"game1_count_"*/, method);
    byte_4A0C88E = 1;
  }
  v5 = StringLiteral_19632/*"game1_count_"*/;
  this->fields.spriteName = (struct System_String_o *)StringLiteral_19632/*"game1_count_"*/;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.spriteName, v5, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0C88D & 1) == 0 )
  {
    sub_1B686D4(&EventBoardGameDiceCounter__SetNum_d__7_TypeInfo, *(_QWORD *)&num);
    byte_4A0C88D = 1;
  }
  v5 = sub_1B68920(EventBoardGameDiceCounter__SetNum_d__7_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v7 = System_String__Concat_61419468(spriteName, v6, 0LL);
  if ( !counterSp )
    sub_1B68930(v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  else if ( !_1__state )
  {
    ...
    if ( _4__this )
    {
      ...
      sub_1B68678((ServantStatusBattleListViewItem_o *)p__2__current, (int32_t)v7, v9, v10);
      result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B686E8(&Method_EventBoardGameDiceCounter__SetNum_d__7_System_Collections_IEnumerator_Reset__);
  sub_1B687FC(v3, v4);
}
