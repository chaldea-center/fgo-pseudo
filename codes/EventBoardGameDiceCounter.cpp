void __fastcall EventBoardGameDiceCounter___ctor(EventBoardGameDiceCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3AF5D & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_19933/*"game1_count_"*/, method);
    byte_4B3AF5D = 1;
  }
  v9 = StringLiteral_19933/*"game1_count_"*/;
  this->fields.spriteName = (struct System_String_o *)StringLiteral_19933/*"game1_count_"*/;
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.spriteName, v9, v2, v3, v4, v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3AF5C & 1) == 0 )
  {
    sub_1BD3458(&EventBoardGameDiceCounter__SetNum_d__7_TypeInfo, *(_QWORD *)&num);
    byte_4B3AF5C = 1;
  }
  v5 = sub_1BD36A4(EventBoardGameDiceCounter__SetNum_d__7_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v7 = System_String__Concat_62525248(spriteName, v6, 0LL);
  if ( !counterSp )
    sub_1BD36B4(v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  else if ( !_1__state )
  {
    ...
    if ( _4__this )
    {
      ...
      sub_1BD33FC((PartyOrganizationUtility_o *)p__2__current, (int64_t)v7, v9, v10, v11, v12, v13, v14);
      result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BD346C(&Method_EventBoardGameDiceCounter__SetNum_d__7_System_Collections_IEnumerator_Reset__);
  sub_1BD3580(v3, v4);
}
