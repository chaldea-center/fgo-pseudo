void EventBoardGameDiceCounter___ctor(EventBoardGameDiceCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB0451 & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_19812/*"game1_count_"*/);
    byte_4CB0451 = 1;
  }
  v3 = StringLiteral_19812/*"game1_count_"*/;
  this->fields.spriteName = (struct System_String_o *)StringLiteral_19812/*"game1_count_"*/;
  sub_1C6B9AC(&this->fields.spriteName, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB0450 & 1) == 0 )
  {
    sub_1C6BA08(&EventBoardGameDiceCounter__SetNum_d__7_TypeInfo);
    byte_4CB0450 = 1;
  }
  v5 = sub_1C6BC54(EventBoardGameDiceCounter__SetNum_d__7_TypeInfo);
...
void EventBoardGameDiceCounter__SetNumSprite(EventBoardGameDiceCounter_o *this, int32_t num, const MethodInfo *method)
{
  ...
  v7 = System_String__Concat_63966792(spriteName, v6, 0);
  if ( !counterSp )
    sub_1C6BC60(v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C6BA1C(&Method_EventBoardGameDiceCounter__SetNum_d__7_System_Collections_IEnumerator_Reset__);
  sub_1C6BB30(v3, v4);
}
