void __fastcall EventBoardGameDiceCounter___ctor(EventBoardGameDiceCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB8503 & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_20015/*"gMonthDay"*/, method);
    byte_4BB8503 = 1;
  }
  v9 = StringLiteral_20015/*"gMonthDay"*/;
  this->fields.spriteName = (struct System_String_o *)StringLiteral_20015/*"gMonthDay"*/;
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.spriteName, v9, v2, v3, v4, v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB8502 & 1) == 0 )
  {
    sub_1C13D24(&EventBoardGameDiceCounter__SetNum_d__7_TypeInfo, *(_QWORD *)&num);
    byte_4BB8502 = 1;
  }
  v5 = sub_1C13F70(EventBoardGameDiceCounter__SetNum_d__7_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v7 = System_String__Concat_62967944(spriteName, v6, 0LL);
  if ( !counterSp )
    sub_1C13F80(v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  else if ( !_1__state )
  {
    ...
    if ( _4__this )
    {
      ...
      sub_1C13CC8((PartyOrganizationUtility_o *)p__2__current, (int64_t)v7, v9, v10, v11, v12, v13, v14);
      result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C13D38(&Method_EventBoardGameDiceCounter__SetNum_d__7_System_Collections_IEnumerator_Reset__);
  sub_1C13E4C(v3, v4);
}
