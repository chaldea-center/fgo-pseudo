void EventBoardGameDiceCounter___ctor(EventBoardGameDiceCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2688A & 1) == 0 )
  {
    sub_1C94098(&StringLiteral_19910/*"game1_count_"*/);
    byte_4D2688A = 1;
  }
  v3 = StringLiteral_19910/*"game1_count_"*/;
  this->fields.spriteName = (struct System_String_o *)StringLiteral_19910/*"game1_count_"*/;
  sub_1C9403C(&this->fields.spriteName, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D26889 & 1) == 0 )
  {
    sub_1C94098(&EventBoardGameDiceCounter__SetNum_d__7_TypeInfo);
    byte_4D26889 = 1;
  }
  v5 = sub_1C942E4(EventBoardGameDiceCounter__SetNum_d__7_TypeInfo);
...
void EventBoardGameDiceCounter__SetNumSprite(EventBoardGameDiceCounter_o *this, int32_t num, const MethodInfo *method)
{
  ...
  v7 = System_String__Concat_64417744(spriteName, v6, 0);
  if ( !counterSp )
    sub_1C942F0(v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C940AC(&Method_EventBoardGameDiceCounter__SetNum_d__7_System_Collections_IEnumerator_Reset__);
  sub_1C941C0(v3, v4);
}
