        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A51CBC & 1) == 0 )
  {
    sub_1B863B8(&ClassBoardLockUser_TypeInfo, entity);
    sub_1B863B8(&Method_DataManager_GetMaster_ClassBoardLockMaster___, v5);
    sub_1B863B8(&DataManager_TypeInfo, v6);
    sub_1B863B8(&Method_DataMasterBase_ClassBoardLockMaster__ClassBoardLockEntity__int__GetEntity__, v7);
    byte_4A51CBC = 1;
  }
  ...
  if ( !Master_object
    || (v10 = DataMasterBase_object__object__int___GetEntity(
                ...
                this->fields.lockId,
                (const MethodInfo_3214280 *)Method_DataMasterBase_ClassBoardLockMaster__ClassBoardLockEntity__int__GetEntity__),
        v11 = sub_1B86604(ClassBoardLockUser_TypeInfo),
        System_Object___ctor((Il2CppObject *)v11, 0LL),
        *(_QWORD *)(v11 + 24) = entity,
        sub_1B8635C((CGThumbnailListItem_o *)(v11 + 24), (int32_t)entity, v12, v13),
        this->fields.user = (struct IClassBoardSquareUser_o *)v11,
        sub_1B8635C((CGThumbnailListItem_o *)&this->fields.user, v11, v14, v15),
        !v10) )
  {
LABEL_9:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A51CBD & 1) == 0 )
  {
    sub_1B863B8(&IClassBoardItemModel_TypeInfo, checkedBlankIdHashSet);
    sub_1B863B8(&System_IDisposable_TypeInfo, v5);
    sub_1B863B8(&System_Collections_Generic_IEnumerable_IClassBoardItemModel__TypeInfo, v6);
    sub_1B863B8(&System_Collections_Generic_IEnumerator_IClassBoardItemModel__TypeInfo, v7);
  ...
  if ( (AcquireFlag & 1) == 0 )
  {
    ...
    *(_QWORD *)&CondData.fields.Type = &v41;
    ...
    {
LABEL_11:
      v18 = sub_1BD6B4C(itemList, System_Collections_Generic_IEnumerable_IClassBoardItemModel__TypeInfo, 0LL);
    }
...
LABEL_18:
      ...
      {
LABEL_25:
        v28 = sub_1BD6B4C(v20, System_Collections_Generic_IEnumerator_IClassBoardItemModel__TypeInfo, 0LL);
      }
      ...
      {
LABEL_32:
        v35 = sub_1BD6B4C(v29, IClassBoardItemModel_TypeInfo, 2LL);
      }
    ...
    {
LABEL_40:
      v39 = sub_1BD6B4C(v20, System_IDisposable_TypeInfo, 0LL);
    }
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v9.fields.Type = &v7;
  v8 = 0;
  v7 = 0LL;
  ClassBoardCondData___ctor_45801212(v9, v2, v3);
  v5 = v7;
  v6 = v8;
