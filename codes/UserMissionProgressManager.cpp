void __fastcall UserMissionProgressManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B67EAC & 1) == 0 )
  {
    sub_1BE4ACC(&Method_System_Collections_Generic_List_UserMissionProgressInfo___ctor__, v1);
    sub_1BE4ACC(&System_Collections_Generic_List_UserMissionProgressInfo__TypeInfo, v8);
    sub_1BE4ACC(&UserMissionProgressManager_TypeInfo, v9);
    sub_1BE4ACC(&StringLiteral_6773/*"Fgo_20160211_1"*/, v10);
    byte_4B67EAC = 1;
  }
  UserMissionProgressManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6773/*"Fgo_20160211_1"*/;
  sub_1BE4A70(
    (PartyOrganizationUtility_o *)UserMissionProgressManager_TypeInfo->static_fields,
    StringLiteral_6773/*"Fgo_20160211_1"*/,
    v2,
    v3,
    v4,
    v5,
  ...
  *(_WORD *)&UserMissionProgressManager_TypeInfo->static_fields->isModfiy = 0;
  v11 = (System_Collections_Generic_List_object__o *)sub_1BE4D18(System_Collections_Generic_List_UserMissionProgressInfo__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v11,
    (const MethodInfo_35EB9F0 *)Method_System_Collections_Generic_List_UserMissionProgressInfo___ctor__);
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&static_fields->missionProgList, (int64_t)v11, v13, v14, v15, v16, v17, v18);
}
...
void __fastcall UserMissionProgressManager__ClearSaveDataList(const MethodInfo *method)
{
  ...
  if ( (byte_4B67EA6 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_System_Collections_Generic_List_UserMissionProgressInfo__Clear__, v1);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_UserMissionProgressInfo__get_Count__, v2);
    sub_1BE4ACC(&UserMissionProgressManager_TypeInfo, v3);
    byte_4B67EA6 = 1;
  }
...
bool __fastcall UserMissionProgressManager__ReadData(const MethodInfo *method)
{
  ...
  if ( (byte_4B67EA7 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_System_Collections_Generic_List_UserMissionProgressInfo__Add__, v3);
    sub_1BE4ACC(&UserMissionProgressInfo_TypeInfo, v4);
    sub_1BE4ACC(&UserMissionProgressManager_TypeInfo, v5);
    byte_4B67EA7 = 1;
  }
  ...
  *((_BYTE *)v6[2].virtualMethodPointer + 8) = 0;
    ...
    if ( v18 >= 1 )
    {
      do
      {
        ...
        v25 = ((__int64 (__fastcall *)(System_IO_BinaryReader_o *, Il2CppMethodPointer))v10->klass->vtable._15_ReadInt32.method)(
                v10,
                v10->klass->vtable._16_ReadUInt32.methodPtr);
        v26 = sub_1BE4D18(UserMissionProgressInfo_TypeInfo);
        ...
        *(_DWORD *)(v26 + 48) = v25;
        ...
        if ( !items )
          sub_1BE4D28(missionProgList, v28);
        size = missionProgList->fields._size;
  ...
  {
LABEL_30:
    v44 = sub_1C36AAC(v10, System_IDisposable_TypeInfo, 0LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67EAA & 1) == 0 )
  {
    sub_1BE4ACC(
      ...
      *(_QWORD *)&progStatus);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Enumerator_UserMissionProgressInfo__MoveNext__, v5);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Enumerator_UserMissionProgressInfo__get_Current__, v6);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_UserMissionProgressInfo__GetEnumerator__, v7);
    sub_1BE4ACC(&UserMissionProgressManager_TypeInfo, v8);
    byte_4B67EAA = 1;
  }
  ...
  if ( !missionProgList )
    sub_1BE4D28(0LL, *(_QWORD *)&progStatus);
  System_Collections_Generic_List_object___GetEnumerator(
    (System_Collections_Generic_List_Enumerator_T__o *)&v14,
    missionProgList,
    (const MethodInfo_35ECD1C *)Method_System_Collections_Generic_List_UserMissionProgressInfo__GetEnumerator__);
  while ( 1 )
  {
    v11 = System_Collections_Generic_List_Enumerator_object___MoveNext(
            &v14,
            (const MethodInfo_3361CE0 *)Method_System_Collections_Generic_List_Enumerator_UserMissionProgressInfo__MoveNext__);
    if ( !v11 )
      break;
  ...
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v14,
    (const MethodInfo_3361CDC *)Method_System_Collections_Generic_List_Enumerator_UserMissionProgressInfo__Dispose__);
}
...
void __fastcall UserMissionProgressManager__SetMissionProgData(int32_t eventId, const MethodInfo *method)
{
  ...
  if ( (byte_4B67EA8 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&UserMissionProgressInfo_TypeInfo, v5);
    sub_1BE4ACC(&UserMissionProgressManager_TypeInfo, v6);
    byte_4B67EA8 = 1;
  }
    ...
    if ( max_length >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( !v12 )
          break;
        id = v12->fields.id;
        v14 = sub_1BE4D18(UserMissionProgressInfo_TypeInfo);
        ...
        *(_DWORD *)(v14 + 20) = id;
        ...
        else
        {
          ...
          sub_1BE4A70((PartyOrganizationUtility_o *)&v26[4], v14, v16, v17, v18, v19, v20, v21);
        }
...
bool __fastcall UserMissionProgressManager__WriteData(const MethodInfo *method)
{
  ...
  if ( (byte_4B67EA9 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&System_IDisposable_TypeInfo, v2);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_UserMissionProgressInfo__get_Count__, v3);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_UserMissionProgressInfo__get_Item__, v4);
  ...
  if ( size >= 1 )
  {
    for ( i = 0; i != size; ++i )
    {
      ...
      Item = System_Collections_Generic_List_object___get_Item(
               v23,
               i,
               (const MethodInfo_35EBF54 *)Method_System_Collections_Generic_List_UserMissionProgressInfo__get_Item__);
      v26 = Item;
      if ( !Item )
        sub_1BE4D28(0LL, v25);
      ((void (__fastcall *)(System_IO_BinaryWriter_o *, _QWORD, Il2CppMethodPointer))v14->klass->vtable._17_Write.method)(
...
System_String_o *__fastcall UserMissionProgressManager__getSaveFileName(const MethodInfo *method)
{
  ...
  if ( (byte_4B67EA2 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&UserMissionProgressManager_TypeInfo, v2);
    byte_4B67EA2 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  FileName_38587136 = DatFileName__getFileName_38587136(23, eventId, 0, 0LL);
  return System_String__Concat_62710068(DatFileSavePath, (System_String_o *)StringLiteral_1120/*"/"*/, FileName_38587136, 0LL);
}


// local variable allocation has failed, the output may be wrong!
System_String_o *__fastcall UserMissionProgressManager__getSaveFileNameByEvent_41529748(
        int32_t eventId,
        int32_t slot,
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67EA1 & 1) == 0 )
  {
    sub_1BE4ACC(&AndroidUtil_TypeInfo, *(_QWORD *)&slot);
  ...
  if ( !DatFileName_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DatFileName_TypeInfo);
  FileName_38587136 = DatFileName__getFileName_38587136(24, eventId, slot, 0LL);
  return System_String__Concat_62710068(DatFileSavePath, (System_String_o *)StringLiteral_1120/*"/"*/, FileName_38587136, 0LL);
}
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UserMissionProgressManager__setSaveFileName_41529348(
        int32_t eventId,
        int32_t slot,
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67E9F & 1) == 0 )
  {
    sub_1BE4ACC(&DatFileName_TypeInfo, *(_QWORD *)&slot);
    sub_1BE4ACC(&UserMissionProgressManager_TypeInfo, v5);
    sub_1BE4ACC(&StringLiteral_1120/*"/"*/, v6);
    byte_4B67E9F = 1;
  }
  if ( !DatFileName_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DatFileName_TypeInfo);
  FileName_38587136 = DatFileName__getFileName_38587136(24, eventId, slot, 0LL);
  v8 = System_String__Concat_62698808((System_String_o *)StringLiteral_1120/*"/"*/, FileName_38587136, 0LL);
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&static_fields->saveName, v16, v9, v10, v11, v12, v13, v14);
}