void __fastcall UserMissionProgressManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A710E4 & 1) == 0 )
  {
    sub_1B90010(&Method_System_Collections_Generic_List_UserMissionProgressInfo___ctor__, v1);
    sub_1B90010(&System_Collections_Generic_List_UserMissionProgressInfo__TypeInfo, v4);
    sub_1B90010(&UserMissionProgressManager_TypeInfo, v5);
    sub_1B90010(&StringLiteral_6638/*"Fgo_20160211_1"*/, v6);
    byte_4A710E4 = 1;
  }
  UserMissionProgressManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6638/*"Fgo_20160211_1"*/;
  sub_1B8FFB4(
    (ServantStatusBattleListViewItem_o *)UserMissionProgressManager_TypeInfo->static_fields,
    StringLiteral_6638/*"Fgo_20160211_1"*/,
    v2,
    v3);
  *(_WORD *)&UserMissionProgressManager_TypeInfo->static_fields->isModfiy = 0;
  v7 = (System_Collections_Generic_List_object__o *)sub_1B9025C(System_Collections_Generic_List_UserMissionProgressInfo__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v7,
    (const MethodInfo_351018C *)Method_System_Collections_Generic_List_UserMissionProgressInfo___ctor__);
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&static_fields->missionProgList, (int32_t)v7, v9, v10);
}
...
void __fastcall UserMissionProgressManager__ClearSaveDataList(const MethodInfo *method)
{
  ...
  if ( (byte_4A710DE & 1) == 0 )
  {
    sub_1B90010(&Method_System_Collections_Generic_List_UserMissionProgressInfo__Clear__, v1);
    sub_1B90010(&Method_System_Collections_Generic_List_UserMissionProgressInfo__get_Count__, v2);
    sub_1B90010(&UserMissionProgressManager_TypeInfo, v3);
    byte_4A710DE = 1;
  }
...
bool __fastcall UserMissionProgressManager__ReadData(const MethodInfo *method)
{
  ...
  if ( (byte_4A710DF & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_System_Collections_Generic_List_UserMissionProgressInfo__Add__, v3);
    sub_1B90010(&UserMissionProgressInfo_TypeInfo, v4);
    sub_1B90010(&UserMissionProgressManager_TypeInfo, v5);
    byte_4A710DF = 1;
  }
  ...
  *((_BYTE *)v6[2].virtualMethodPointer + 8) = 0;
    ...
    if ( v18 >= 1 )
    {
      do
      {
        ...
        v25 = ((__int64 (__fastcall *)(System_IO_BinaryReader_o *, Il2CppMethodPointer))v10->klass->vtable._15_ReadInt32.method)(
                v10,
                v10->klass->vtable._16_ReadUInt32.methodPtr);
        v26 = sub_1B9025C(UserMissionProgressInfo_TypeInfo);
        ...
        *(_DWORD *)(v26 + 48) = v25;
        ...
        if ( !items )
          sub_1B9026C(missionProgList, v28);
        size = missionProgList->fields._size;
  ...
  {
LABEL_30:
    v40 = sub_1BE1FF0(v10, System_IDisposable_TypeInfo, 0LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A710E2 & 1) == 0 )
  {
    sub_1B90010(
      ...
      *(_QWORD *)&progStatus);
    sub_1B90010(&Method_System_Collections_Generic_List_Enumerator_UserMissionProgressInfo__MoveNext__, v5);
    sub_1B90010(&Method_System_Collections_Generic_List_Enumerator_UserMissionProgressInfo__get_Current__, v6);
    sub_1B90010(&Method_System_Collections_Generic_List_UserMissionProgressInfo__GetEnumerator__, v7);
    sub_1B90010(&UserMissionProgressManager_TypeInfo, v8);
    byte_4A710E2 = 1;
  }
  ...
  if ( !missionProgList )
    sub_1B9026C(0LL, *(_QWORD *)&progStatus);
  System_Collections_Generic_List_object___GetEnumerator(
    (System_Collections_Generic_List_Enumerator_T__o *)&v14,
    missionProgList,
    (const MethodInfo_35114B8 *)Method_System_Collections_Generic_List_UserMissionProgressInfo__GetEnumerator__);
  while ( 1 )
  {
    v11 = System_Collections_Generic_List_Enumerator_object___MoveNext(
            &v14,
            (const MethodInfo_328A150 *)Method_System_Collections_Generic_List_Enumerator_UserMissionProgressInfo__MoveNext__);
    if ( !v11 )
      break;
  ...
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v14,
    (const MethodInfo_328A14C *)Method_System_Collections_Generic_List_Enumerator_UserMissionProgressInfo__Dispose__);
}
...
void __fastcall UserMissionProgressManager__SetMissionProgData(int32_t eventId, const MethodInfo *method)
{
  ...
  if ( (byte_4A710E0 & 1) == 0 )
  {
    ...
    sub_1B90010(&UserMissionProgressInfo_TypeInfo, v5);
    sub_1B90010(&UserMissionProgressManager_TypeInfo, v6);
    byte_4A710E0 = 1;
  }
    ...
    if ( max_length >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( !v12 )
          break;
        id = v12->fields.id;
        v14 = sub_1B9025C(UserMissionProgressInfo_TypeInfo);
        ...
        *(_DWORD *)(v14 + 20) = id;
        ...
        else
        {
          ...
          sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&v22[4], v14, v16, v17);
        }
...
bool __fastcall UserMissionProgressManager__WriteData(const MethodInfo *method)
{
  ...
  if ( (byte_4A710E1 & 1) == 0 )
  {
    ...
    sub_1B90010(&System_IDisposable_TypeInfo, v2);
    sub_1B90010(&Method_System_Collections_Generic_List_UserMissionProgressInfo__get_Count__, v3);
    sub_1B90010(&Method_System_Collections_Generic_List_UserMissionProgressInfo__get_Item__, v4);
  ...
  if ( size >= 1 )
  {
    for ( i = 0; i != size; ++i )
    {
      ...
      Item = System_Collections_Generic_List_object___get_Item(
               v23,
               i,
               (const MethodInfo_35106F0 *)Method_System_Collections_Generic_List_UserMissionProgressInfo__get_Item__);
      v26 = Item;
      if ( !Item )
        sub_1B9026C(0LL, v25);
      ((void (__fastcall *)(System_IO_BinaryWriter_o *, _QWORD, Il2CppMethodPointer))v14->klass->vtable._17_Write.method)(
...
System_String_o *__fastcall UserMissionProgressManager__getSaveFileName(const MethodInfo *method)
{
  ...
  if ( (byte_4A710DA & 1) == 0 )
  {
    ...
    sub_1B90010(&UserMissionProgressManager_TypeInfo, v2);
    byte_4A710DA = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  FileName_37733884 = DatFileName__getFileName_37733884(23, eventId, 0, 0LL);
  return System_String__Concat_61798352(DatFileSavePath, (System_String_o *)StringLiteral_1123/*"/"*/, FileName_37733884, 0LL);
}


// local variable allocation has failed, the output may be wrong!
System_String_o *__fastcall UserMissionProgressManager__getSaveFileNameByEvent_40606244(
        int32_t eventId,
        int32_t slot,
        const MethodInfo *method)
{
  ...
  if ( (byte_4A710D9 & 1) == 0 )
  {
    sub_1B90010(&AndroidUtil_TypeInfo, *(_QWORD *)&slot);
  ...
  if ( !DatFileName_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DatFileName_TypeInfo);
  FileName_37733884 = DatFileName__getFileName_37733884(24, eventId, slot, 0LL);
  return System_String__Concat_61798352(DatFileSavePath, (System_String_o *)StringLiteral_1123/*"/"*/, FileName_37733884, 0LL);
}
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UserMissionProgressManager__setSaveFileName_40605844(
        int32_t eventId,
        int32_t slot,
        const MethodInfo *method)
{
  ...
  if ( (byte_4A710D7 & 1) == 0 )
  {
    sub_1B90010(&DatFileName_TypeInfo, *(_QWORD *)&slot);
    sub_1B90010(&UserMissionProgressManager_TypeInfo, v5);
    sub_1B90010(&StringLiteral_1123/*"/"*/, v6);
    byte_4A710D7 = 1;
  }
  if ( !DatFileName_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DatFileName_TypeInfo);
  FileName_37733884 = DatFileName__getFileName_37733884(24, eventId, slot, 0LL);
  v8 = System_String__Concat_61787092((System_String_o *)StringLiteral_1123/*"/"*/, FileName_37733884, 0LL);
  v11 = UserMissionProgressManager_TypeInfo;
  v12 = v8;
  if ( !UserMissionProgressManager_TypeInfo->_2.cctor_finished )
  {
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&static_fields->saveName, (int32_t)v12, v9, v10);
}