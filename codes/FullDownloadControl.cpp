...
void FullDownloadControl__Init(FullDownloadControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C51D5B & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_6583/*"FULLDOWNLOAD_INFO_DETAIL_TXT"*/);
    sub_1C3E564(&StringLiteral_6584/*"FULLDOWNLOAD_INFO_TXT"*/);
    byte_4C51D5B = 1;
  }
...
void FullDownloadControl__OnClickFullDl(FullDownloadControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C51D5C & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_FullDownloadControl_OnClickFullDl__);
    sub_1C3E564(&Method_FullDownloadControl_closeDlg__);
    sub_1C3E564(&Method_FullDownloadControl_endDownLoad__);
    sub_1C3E564(&LocalizationManager_TypeInfo);
    ...
    sub_1C3E564(&StringLiteral_6580/*"FULLDOWNLOAD_CONFIRM_DECIDE"*/);
    sub_1C3E564(&StringLiteral_6581/*"FULLDOWNLOAD_CONFIRM_MSG"*/);
    sub_1C3E564(&StringLiteral_6582/*"FULLDOWNLOAD_CONFIRM_TITLE"*/);
  ...
  if ( (*((_BYTE *)Method_FullDownloadControl_OnClickFullDl__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C3E57C(Method_FullDownloadControl_OnClickFullDl__);
  ...
  downLoadBtn = (AssetManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39FF5A8 *)Method_SingletonMonoBehaviour_AssetManager__get_Instance__);
  if ( !downLoadBtn )
    goto LABEL_18;
  ...
  if ( DownloadSize >= 1 )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v9 = LocalizationManager__Get((System_String_o *)StringLiteral_6582/*"FULLDOWNLOAD_CONFIRM_TITLE"*/, 0);
    v10 = LocalizationManager__Get((System_String_o *)StringLiteral_6581/*"FULLDOWNLOAD_CONFIRM_MSG"*/, 0);
    downLoadBtn = (AssetManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39FF5A8 *)Method_SingletonMonoBehaviour_AssetManager__get_Instance__);
    if ( downLoadBtn )
    {
      v11 = (Il2CppObject *)AssetManager__ConvertDownloadSizeToString(downLoadBtn, (double)v8, 0);
      v12 = System_String__Format(v10, v11, 0);
      v13 = LocalizationManager__Get((System_String_o *)StringLiteral_6580/*"FULLDOWNLOAD_CONFIRM_DECIDE"*/, 0);
      v14 = LocalizationManager__Get((System_String_o *)StringLiteral_3684/*"COMMON_CONFIRM_CANCEL"*/, 0);
      Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39FF5A8 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
      v16 = (CommonConfirmDialog_ClickDelegate_o *)sub_1C3E7B0(CommonConfirmDialog_ClickDelegate_TypeInfo);
...
LABEL_18:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v18 = LocalizationManager__Get((System_String_o *)StringLiteral_3788/*"CONNECT_LATEST_MESSAGE"*/, 0);
...
void FullDownloadControl___checkDownLoadData_b__7_0(FullDownloadControl_o *this, const MethodInfo *method)
{
  ...
  UnityEngine_MonoBehaviour__StartCoroutine_71327136((UnityEngine_MonoBehaviour_o *)this, All, 0);
}
...
void FullDownloadControl__checkDownLoadData(FullDownloadControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C51D5E & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_FullDownloadControl__checkDownLoadData_b__7_0__);
    sub_1C3E564(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4C51D5E = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39FF5A8 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
...
void FullDownloadControl__closeDlg(FullDownloadControl_o *this, bool isRes, const MethodInfo *method)
{
  ...
  {
    sub_1C3E564(&System_Action_TypeInfo);
    sub_1C3E564(&Method_FullDownloadControl_checkDownLoadData__);
    sub_1C3E564(&Method_FullDownloadControl_endDownLoad__);
    sub_1C3E564(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4C51D5D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C51D5F & 1) == 0 )
  {
    sub_1C3E564(&FullDownloadControl__downLoadAll_d__8_TypeInfo);
    byte_4C51D5F = 1;
  }
  v3 = sub_1C3E7B0(FullDownloadControl__downLoadAll_d__8_TypeInfo);
...
void FullDownloadControl__endDownLoad(FullDownloadControl_o *this, const MethodInfo *method)
{
  ...
  Instance = (AssetManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39FF5A8 *)Method_SingletonMonoBehaviour_AssetManager__get_Instance__);
  if ( !Instance
...
LABEL_21:
  ...
  {
    this->fields.__1__state = -1;
    v4 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39FF5A8 *)Method_SingletonMonoBehaviour_AssetManager__get_Instance__);
    ...
    if ( v4 )
    {
      ...
      if ( Instance )
      {
        ...
        sub_1C3E508((CGThumbnailListItem_o *)&this->fields._wait_5__2, (int32_t)v7, v8, v9);
LABEL_12:
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C3E578(&Method_FullDownloadControl__downLoadAll_d__8_System_Collections_IEnumerator_Reset__);
  sub_1C3E68C(v3, v4);
}
