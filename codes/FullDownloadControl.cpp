...
void __fastcall FullDownloadControl__Init(FullDownloadControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B61F63 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_6685/*"FULLDOWNLOAD_INFO_DETAIL_TXT"*/, v3);
    sub_1BE4ACC(&StringLiteral_6686/*"FULLDOWNLOAD_INFO_TXT"*/, v4);
    byte_4B61F63 = 1;
  }
  infoLb = this->fields.infoLb;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  downLoadBtn = LocalizationManager__Get((System_String_o *)StringLiteral_6686/*"FULLDOWNLOAD_INFO_TXT"*/, 0LL);
  if ( !infoLb
    || (UILabel__set_text(infoLb, downLoadBtn, 0LL),
        infoDetailLb = this->fields.infoDetailLb,
        downLoadBtn = LocalizationManager__Get((System_String_o *)StringLiteral_6685/*"FULLDOWNLOAD_INFO_DETAIL_TXT"*/, 0LL),
        !infoDetailLb)
    || (UILabel__set_text(infoDetailLb, downLoadBtn, 0LL),
        (downLoadBtn = (System_String_o *)this->fields.downLoadBtn) == 0LL) )
  {
    sub_1BE4D28(downLoadBtn, v7);
  }
...
void __fastcall FullDownloadControl__OnClickFullDl(FullDownloadControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B61F64 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_FullDownloadControl_OnClickFullDl__, v4);
    sub_1BE4ACC(&Method_FullDownloadControl_closeDlg__, v5);
    sub_1BE4ACC(&Method_FullDownloadControl_endDownLoad__, v6);
    ...
    sub_1BE4ACC(&StringLiteral_3888/*"CONNECT_LATEST_MESSAGE"*/, v10);
    sub_1BE4ACC(&StringLiteral_6682/*"FULLDOWNLOAD_CONFIRM_DECIDE"*/, v11);
    sub_1BE4ACC(&StringLiteral_6683/*"FULLDOWNLOAD_CONFIRM_MSG"*/, v12);
    sub_1BE4ACC(&StringLiteral_6684/*"FULLDOWNLOAD_CONFIRM_TITLE"*/, v13);
  ...
  if ( (*((_BYTE *)Method_FullDownloadControl_OnClickFullDl__ + 83) & 2) != 0 )
    v16 = (_QWORD *)sub_1BE4AE4(Method_FullDownloadControl_OnClickFullDl__);
  ...
  downLoadBtn = (AssetManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_AssetManager__get_Instance__);
  if ( !downLoadBtn )
    goto LABEL_18;
  ...
  if ( DownloadSize >= 1 )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v22 = LocalizationManager__Get((System_String_o *)StringLiteral_6684/*"FULLDOWNLOAD_CONFIRM_TITLE"*/, 0LL);
    v23 = LocalizationManager__Get((System_String_o *)StringLiteral_6683/*"FULLDOWNLOAD_CONFIRM_MSG"*/, 0LL);
    downLoadBtn = (AssetManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_AssetManager__get_Instance__);
    if ( downLoadBtn )
    {
      ...
      v26 = LocalizationManager__Get((System_String_o *)StringLiteral_6682/*"FULLDOWNLOAD_CONFIRM_DECIDE"*/, 0LL);
      v27 = LocalizationManager__Get((System_String_o *)StringLiteral_3795/*"COMMON_CONFIRM_CANCEL"*/, 0LL);
      ...
      v29 = (CommonConfirmDialog_ClickDelegate_o *)sub_1BE4D18(CommonConfirmDialog_ClickDelegate_TypeInfo);
...
LABEL_18:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v31 = LocalizationManager__Get((System_String_o *)StringLiteral_3888/*"CONNECT_LATEST_MESSAGE"*/, 0LL);
...
void __fastcall FullDownloadControl___checkDownLoadData_b__7_0(FullDownloadControl_o *this, const MethodInfo *method)
{
  ...
  UnityEngine_MonoBehaviour__StartCoroutine_70437272((UnityEngine_MonoBehaviour_o *)this, All, 0LL);
}
...
void __fastcall FullDownloadControl__checkDownLoadData(FullDownloadControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B61F66 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_FullDownloadControl__checkDownLoadData_b__7_0__, v4);
...
void __fastcall FullDownloadControl__closeDlg(FullDownloadControl_o *this, bool isRes, const MethodInfo *method)
{
  ...
  if ( (byte_4B61F65 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_FullDownloadControl_checkDownLoadData__, v5);
    sub_1BE4ACC(&Method_FullDownloadControl_endDownLoad__, v6);
  ...
  if ( !Instance )
    sub_1BE4D28(v12, v13);
  CommonUI__CloseConfirmDialog_30874304((CommonUI_o *)Instance, v10, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B61F67 & 1) == 0 )
  {
    sub_1BE4ACC(&FullDownloadControl__downLoadAll_d__8_TypeInfo, method);
    byte_4B61F67 = 1;
  }
  v3 = sub_1BE4D18(FullDownloadControl__downLoadAll_d__8_TypeInfo);
...
void __fastcall FullDownloadControl__endDownLoad(FullDownloadControl_o *this, const MethodInfo *method)
{
  ...
  Instance = (AssetManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_AssetManager__get_Instance__);
  if ( !Instance
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B61F69 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&UnityEngine_WaitForEndOfFrame_TypeInfo, v6);
    byte_4B61F69 = 1;
  }
...
LABEL_21:
  ...
  {
    this->fields.__1__state = -1;
    v8 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_AssetManager__get_Instance__);
    ...
    if ( v8 )
    {
      ...
      if ( Instance )
      {
        ...
        sub_1BE4A70(&this->fields._wait_5__2);
LABEL_12:
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BE4AE0(&Method_FullDownloadControl__downLoadAll_d__8_System_Collections_IEnumerator_Reset__);
  sub_1BE4BF4(v3, v4);
}
