        ...
        const MethodInfo *method)
{
  if ( (byte_4A2ACB7 & 1) == 0 )
  {
    sub_1B761C0(&Method_System_Array_IndexOf_UICommonButton___, buttonObj);
    byte_4A2ACB7 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2ACB6 & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_17473/*"btn_bg_20"*/, v7);
    sub_1B761C0(&StringLiteral_17474/*"btn_bg_21"*/, v8);
    byte_4A2ACB6 = 1;
  }
...
LABEL_45:
        ...
        if ( !v20 )
          break;
        v30 = (System_String_o **)(v27 ? &StringLiteral_17474/*"btn_bg_21"*/ : &StringLiteral_17473/*"btn_bg_20"*/);
