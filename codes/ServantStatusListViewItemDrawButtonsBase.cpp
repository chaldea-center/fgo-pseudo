        ...
        const MethodInfo *method)
{
  if ( (byte_49B7C2B & 1) == 0 )
  {
    sub_1B4CF90(&Method_System_Array_IndexOf_UICommonButton___, buttonObj);
    byte_49B7C2B = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B7C2A & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_17162/*"btn_bg_21"*/, v8);
    byte_49B7C2A = 1;
  }
...
LABEL_45:
        ...
        if ( !v20 )
          break;
        v30 = (System_String_o **)(v27 ? &StringLiteral_17162/*"btn_bg_21"*/ : &StringLiteral_17161/*"btn_bg_20"*/);
