...
void __fastcall PhotoTargetSelectDialog__CloseDialog(PhotoTargetSelectDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD7E93 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_PhotoTargetSelectDialog_Init__);
    byte_4BD7E93 = 1;
  }
  this->fields.state = 4;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD7E91 & 1) == 0 )
  {
    sub_1C21E38(&Method_ActionExtensions_Call_MyRoomControl_PHOTOCAMPAIGNTYPE___);
    sub_1C21E38(&Method_PhotoTargetSelectDialog_OnClickDecideButton__);
    byte_4BD7E91 = 1;
  }
  this->fields.state = 3;
  ...
  if ( (*((_BYTE *)Method_PhotoTargetSelectDialog_OnClickDecideButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1C21E50(Method_PhotoTargetSelectDialog_OnClickDecideButton__);
  ...
  ActionExtensions__Call_Int32Enum_(
    decideCallBack,
    type,
    (const MethodInfo_2F025C0 *)Method_ActionExtensions_Call_MyRoomControl_PHOTOCAMPAIGNTYPE___);
}
...
void __fastcall PhotoTargetSelectDialog__OnclickCancelButton(PhotoTargetSelectDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD7E92 & 1) == 0 )
  {
    sub_1C21E38(&Method_PhotoTargetSelectDialog_OnclickCancelButton__);
    byte_4BD7E92 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PhotoTargetSelectDialog_OnclickCancelButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_PhotoTargetSelectDialog_OnclickCancelButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD7E90 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_PhotoTargetSelectDialog__Open_b__12_0__);
    sub_1C21E38(&StringLiteral_3810/*"COMMON_CONFIRM_CANCEL"*/);
    sub_1C21E38(&StringLiteral_10583/*"PHOTO_TARGET_SELECT_DIALOG_TITLE"*/);
    sub_1C21E38(&StringLiteral_10582/*"PHOTO_TARGET_SELECT_DIALOG_ONLY_SERVANT_BUTTON"*/);
    sub_1C21E38(&StringLiteral_10581/*"PHOTO_TARGET_SELECT_DIALOG_MESSAGE"*/);
    sub_1C21E38(&StringLiteral_10584/*"PHOTO_TARGET_SELECT_DIALOG_WITH_MASTER_BUTTON"*/);
    byte_4BD7E90 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    v6 = LocalizationManager__Get((System_String_o *)StringLiteral_10583/*"PHOTO_TARGET_SELECT_DIALOG_TITLE"*/, 0LL);
    if ( !titleLabel )
      goto LABEL_12;
    UILabel__set_text(titleLabel, v6, 0LL);
    messageLabel = this->fields.messageLabel;
    v6 = LocalizationManager__Get((System_String_o *)StringLiteral_10581/*"PHOTO_TARGET_SELECT_DIALOG_MESSAGE"*/, 0LL);
    if ( !messageLabel )
      goto LABEL_12;
    UILabel__set_text(messageLabel, v6, 0LL);
    onlyServantButtonLabel = this->fields.onlyServantButtonLabel;
    v6 = LocalizationManager__Get((System_String_o *)StringLiteral_10582/*"PHOTO_TARGET_SELECT_DIALOG_ONLY_SERVANT_BUTTON"*/, 0LL);
    if ( !onlyServantButtonLabel
      || (UILabel__set_text(onlyServantButtonLabel, v6, 0LL),
          ...
          v6 = LocalizationManager__Get((System_String_o *)StringLiteral_10584/*"PHOTO_TARGET_SELECT_DIALOG_WITH_MASTER_BUTTON"*/, 0LL),
          !withMasterButtonLabel)
      || (UILabel__set_text(withMasterButtonLabel, v6, 0LL),
          cancelButtonLabel = this->fields.cancelButtonLabel,
          v6 = LocalizationManager__Get((System_String_o *)StringLiteral_3810/*"COMMON_CONFIRM_CANCEL"*/, 0LL),
          !cancelButtonLabel) )
    {
LABEL_12:
      sub_1C22094(v6, v7);
    ...
    sub_1C21DDC(&this->fields.decideCallBack, callBack);
    this->fields.state = 1;
