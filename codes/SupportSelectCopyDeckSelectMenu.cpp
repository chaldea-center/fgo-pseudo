        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18B77 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_SupportSelectCopyDeckSelectMenu_OnFinishedClose__, v3);
    byte_4B18B77 = 1;
  }
  this->fields.currentState = 2;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18B79 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_SupportSelectCopyDeckSelectMenu_OnClickCancel__, method);
    byte_4B18B79 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectCopyDeckSelectMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BCB010(Method_SupportSelectCopyDeckSelectMenu_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.onSelected, 0, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18B76 & 1) == 0 )
  {
    sub_1BCAFF8(&SupportSelectDeckListViewObject_OnSelectEvent_TypeInfo, method);
    sub_1BCAFF8(&Method_SupportSelectCopyDeckSelectMenu_OnSelectedDeck__, v3);
    byte_4B18B76 = 1;
  }
  this->fields.currentState = 1;
  deckListViewManager = this->fields.deckListViewManager;
  v5 = (SupportSelectDeckListViewObject_OnSelectEvent_o *)sub_1BCB244(SupportSelectDeckListViewObject_OnSelectEvent_TypeInfo);
  ...
  if ( !deckListViewManager )
    sub_1BCB254(v7, v8);
  SupportSelectDeckListViewManager__SetMode_34841604(deckListViewManager, 2, v5, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18B78 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_SupportSelectCopyDeckSelectMenu_OnSelectedDeck__, *(_QWORD *)&deckId);
    byte_4B18B78 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectCopyDeckSelectMenu_OnSelectedDeck__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1BCB010(Method_SupportSelectCopyDeckSelectMenu_OnSelectedDeck__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18B75 & 1) == 0 )
  {
    sub_1BCAFF8(&System_Action_TypeInfo, targetDeckList);
    sub_1BCAFF8(&LocalizationManager_TypeInfo, v11);
    sub_1BCAFF8(&Method_SupportSelectCopyDeckSelectMenu_OnFinishedOpen__, v12);
    sub_1BCAFF8(&StringLiteral_12420/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_SELECT_MESSAGE"*/, v13);
    sub_1BCAFF8(&StringLiteral_12419/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_SELECT_CANCEL"*/, v14);
    sub_1BCAFF8(&StringLiteral_12421/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_SELECT_TITLE"*/, v15);
    byte_4B18B75 = 1;
  }
  if ( this->fields.currentState == 2 )
  {
    ...
    if ( !gameObject )
      goto LABEL_14;
    SupportSelectDeckListViewManager__SetMode_34841604((SupportSelectDeckListViewManager_o *)gameObject, 1, 0LL, v19);
...
LABEL_14:
    ...
    sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.onSelected, (int32_t)onSelected, v23, v24);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18B73 & 1) == 0 )
  {
    sub_1BCAFF8(&SupportSelectCopyDeckSelectMenu_OnSelectEvent_TypeInfo, value);
    byte_4B18B73 = 1;
  }
  onSelected = this->fields.onSelected;
  p_onSelected = &this->fields.onSelected;
  ...
  while ( 1 )
  {
    ...
    v9 = sub_1C05088(p_onSelected, v8, v6);
        ...
        const MethodInfo *method)
{
  if ( (byte_4B18B7A & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_3052/*"BaseWindow/CacnelButton"*/, method);
    byte_4B18B7A = 1;
  }
  return (System_String_o *)StringLiteral_3052/*"BaseWindow/CacnelButton"*/;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18B7C & 1) == 0 )
  {
    sub_1BCAFF8(&int_TypeInfo, *(_QWORD *)&selectDeckId);
    byte_4B18B7C = 1;
  }
  v9[1] = 0LL;
