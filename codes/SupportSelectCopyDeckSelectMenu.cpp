...
void SupportSelectCopyDeckSelectMenu__Close(SupportSelectCopyDeckSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596CC2D & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_SupportSelectCopyDeckSelectMenu_OnFinishedClose__);
    byte_596CC2D = 1;
  }
...
void SupportSelectCopyDeckSelectMenu__OnClickCancel(SupportSelectCopyDeckSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596CC2F & 1) == 0 )
  {
    sub_2213A60(&Method_SupportSelectCopyDeckSelectMenu_OnClickCancel__);
    byte_596CC2F = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectCopyDeckSelectMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_2213A78(Method_SupportSelectCopyDeckSelectMenu_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields.onSelected, 0, v2, v3, v4, v5, v6, v7);
...
void SupportSelectCopyDeckSelectMenu__OnFinishedOpen(SupportSelectCopyDeckSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596CC2C & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_SupportSelectCopyDeckSelectMenu_OnSelectedDeck__);
    byte_596CC2C = 1;
  }
  v3 = SupportSelectDeckListViewObject_OnSelectEvent_TypeInfo;
  deckListViewManager = this->fields.deckListViewManager;
  this->fields.currentState = 1;
  v5 = (SupportSelectDeckListViewObject_OnSelectEvent_o *)sub_2213CCC(v3);
  ...
  if ( !deckListViewManager )
    sub_2213CDC(v7, v8);
  SupportSelectDeckListViewManager__SetMode_42449640(deckListViewManager, 2, v5, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectCopyDeckSelectMenu_OnSelectedDeck__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_2213A78(Method_SupportSelectCopyDeckSelectMenu_OnSelectedDeck__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596CC2B & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_SupportSelectCopyDeckSelectMenu_OnFinishedOpen__);
    sub_2213A60(&StringLiteral_13054/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_SELECT_MESSAGE"*/);
    sub_2213A60(&StringLiteral_13053/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_SELECT_CANCEL"*/);
    sub_2213A60(&StringLiteral_13055/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_SELECT_TITLE"*/);
    byte_596CC2B = 1;
  }
  if ( this->fields.currentState == 2 )
  {
    ...
    if ( !gameObject )
      goto LABEL_14;
    SupportSelectDeckListViewManager__SetMode_42449640((SupportSelectDeckListViewManager_o *)gameObject, 1, 0, v14);
    titleLabel = this->fields.titleLabel;
    if ( !*(&LocalizationManager_TypeInfo->_2.cctor_finished + 1) )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, v15, v16);
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_13055/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_SELECT_TITLE"*/, 0);
    if ( !titleLabel
      || (UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0),
          messageLabel = this->fields.messageLabel,
          gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_13054/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_SELECT_MESSAGE"*/, 0),
          !messageLabel)
      || (UILabel__set_text(messageLabel, (System_String_o *)gameObject, 0),
          cancelButtonLabel = this->fields.cancelButtonLabel,
          gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_13053/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_SELECT_CANCEL"*/, 0),
          !cancelButtonLabel) )
    {
LABEL_14:
        ...
        const MethodInfo *method)
{
  ...
  sub_221405C(v8, SupportSelectCopyDeckSelectMenu_OnSelectEvent_TypeInfo, v9, v10);
        ...
        const MethodInfo *method)
{
  if ( (byte_596CC30 & 1) == 0 )
  {
    sub_2213A60(&StringLiteral_3193/*"BaseWindow/CacnelButton"*/);
    byte_596CC30 = 1;
  }
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_2007160;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_2007118;
}
