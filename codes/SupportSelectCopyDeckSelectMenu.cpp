        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E797 & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_SupportSelectCopyDeckSelectMenu_OnFinishedClose__, v3);
    byte_4C1E797 = 1;
  }
  this->fields.currentState = 2;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E799 & 1) == 0 )
  {
    sub_1C3B764(&Method_SupportSelectCopyDeckSelectMenu_OnClickCancel__, method);
    byte_4C1E799 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectCopyDeckSelectMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3B77C(Method_SupportSelectCopyDeckSelectMenu_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.onSelected, 0LL, v2, v3, v4, v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E796 & 1) == 0 )
  {
    sub_1C3B764(&SupportSelectDeckListViewObject_OnSelectEvent_TypeInfo, method);
    sub_1C3B764(&Method_SupportSelectCopyDeckSelectMenu_OnSelectedDeck__, v3);
    byte_4C1E796 = 1;
  }
  this->fields.currentState = 1;
  deckListViewManager = this->fields.deckListViewManager;
  v5 = (SupportSelectDeckListViewObject_OnSelectEvent_o *)sub_1C3B9B0(SupportSelectDeckListViewObject_OnSelectEvent_TypeInfo);
  ...
  if ( !deckListViewManager )
    sub_1C3B9C0(v7, v8);
  SupportSelectDeckListViewManager__SetMode_34535732(deckListViewManager, 2, v5, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E798 & 1) == 0 )
  {
    sub_1C3B764(&Method_SupportSelectCopyDeckSelectMenu_OnSelectedDeck__, *(_QWORD *)&deckId);
    byte_4C1E798 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectCopyDeckSelectMenu_OnSelectedDeck__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1C3B77C(Method_SupportSelectCopyDeckSelectMenu_OnSelectedDeck__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E795 & 1) == 0 )
  {
    sub_1C3B764(&System_Action_TypeInfo, targetDeckList);
    sub_1C3B764(&LocalizationManager_TypeInfo, v11);
    sub_1C3B764(&Method_SupportSelectCopyDeckSelectMenu_OnFinishedOpen__, v12);
    sub_1C3B764(&StringLiteral_12705/*"StandFigureM("*/, v13);
    sub_1C3B764(&StringLiteral_12704/*"StandFigureM"*/, v14);
    sub_1C3B764(&StringLiteral_12706/*"StandFigureR"*/, v15);
    byte_4C1E795 = 1;
  }
  if ( this->fields.currentState == 2 )
  {
    ...
    if ( !gameObject )
      goto LABEL_14;
    SupportSelectDeckListViewManager__SetMode_34535732((SupportSelectDeckListViewManager_o *)gameObject, 1, 0LL, v19);
    titleLabel = this->fields.titleLabel;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12706/*"StandFigureR"*/, 0LL);
    if ( !titleLabel
      || (UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL),
          messageLabel = this->fields.messageLabel,
          gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12705/*"StandFigureM("*/, 0LL),
          !messageLabel)
      || (UILabel__set_text(messageLabel, (System_String_o *)gameObject, 0LL),
          cancelButtonLabel = this->fields.cancelButtonLabel,
          gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12704/*"StandFigureM"*/, 0LL),
          !cancelButtonLabel) )
    {
LABEL_14:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E793 & 1) == 0 )
  {
    sub_1C3B764(&SupportSelectCopyDeckSelectMenu_OnSelectEvent_TypeInfo, value);
    byte_4C1E793 = 1;
  }
  onSelected = this->fields.onSelected;
  p_onSelected = &this->fields.onSelected;
  ...
  while ( 1 )
  {
    ...
    v9 = sub_1C76C54(p_onSelected, v8, v6);
        ...
        const MethodInfo *method)
{
  if ( (byte_4C1E79A & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_3227/*"BreakPoint_effect_{0}"*/, method);
    byte_4C1E79A = 1;
  }
  return (System_String_o *)StringLiteral_3227/*"BreakPoint_effect_{0}"*/;
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A78FCC;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A78F84;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E79C & 1) == 0 )
  {
    sub_1C3B764(&int_TypeInfo, *(_QWORD *)&selectDeckId);
    byte_4C1E79C = 1;
  }
  v9[1] = 0LL;
