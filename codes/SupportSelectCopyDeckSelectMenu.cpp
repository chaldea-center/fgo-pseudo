        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB25F8 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_SupportSelectCopyDeckSelectMenu_OnFinishedClose__, v3);
    byte_4AB25F8 = 1;
  }
  this->fields.currentState = 2;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB25FA & 1) == 0 )
  {
    sub_1BAB41C(&Method_SupportSelectCopyDeckSelectMenu_OnClickCancel__, method);
    byte_4AB25FA = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectCopyDeckSelectMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BAB434(Method_SupportSelectCopyDeckSelectMenu_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.onSelected, 0, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB25F7 & 1) == 0 )
  {
    sub_1BAB41C(&SupportSelectDeckListViewObject_OnSelectEvent_TypeInfo, method);
    sub_1BAB41C(&Method_SupportSelectCopyDeckSelectMenu_OnSelectedDeck__, v3);
    byte_4AB25F7 = 1;
  }
  this->fields.currentState = 1;
  deckListViewManager = this->fields.deckListViewManager;
  v5 = (SupportSelectDeckListViewObject_OnSelectEvent_o *)sub_1BAB668(SupportSelectDeckListViewObject_OnSelectEvent_TypeInfo);
  ...
  if ( !deckListViewManager )
    sub_1BAB678(v7, v8);
  SupportSelectDeckListViewManager__SetMode_33526732(deckListViewManager, 2, v5, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB25F9 & 1) == 0 )
  {
    sub_1BAB41C(&Method_SupportSelectCopyDeckSelectMenu_OnSelectedDeck__, *(_QWORD *)&deckId);
    byte_4AB25F9 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectCopyDeckSelectMenu_OnSelectedDeck__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1BAB434(Method_SupportSelectCopyDeckSelectMenu_OnSelectedDeck__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB25F6 & 1) == 0 )
  {
    sub_1BAB41C(&System_Action_TypeInfo, targetDeckList);
    sub_1BAB41C(&LocalizationManager_TypeInfo, v11);
    sub_1BAB41C(&Method_SupportSelectCopyDeckSelectMenu_OnFinishedOpen__, v12);
    sub_1BAB41C(&StringLiteral_12451/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_SELECT_MESSAGE"*/, v13);
    sub_1BAB41C(&StringLiteral_12450/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_SELECT_CANCEL"*/, v14);
    sub_1BAB41C(&StringLiteral_12452/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_SELECT_TITLE"*/, v15);
    byte_4AB25F6 = 1;
  }
  if ( this->fields.currentState == 2 )
  {
    ...
    if ( !gameObject )
      goto LABEL_14;
    SupportSelectDeckListViewManager__SetMode_33526732((SupportSelectDeckListViewManager_o *)gameObject, 1, 0LL, v19);
    titleLabel = this->fields.titleLabel;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12452/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_SELECT_TITLE"*/, 0LL);
    if ( !titleLabel
      || (UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL),
          messageLabel = this->fields.messageLabel,
          gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12451/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_SELECT_MESSAGE"*/, 0LL),
          !messageLabel)
      || (UILabel__set_text(messageLabel, (System_String_o *)gameObject, 0LL),
          cancelButtonLabel = this->fields.cancelButtonLabel,
          gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12450/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_COPY_SELECT_CANCEL"*/, 0LL),
          !cancelButtonLabel) )
    {
LABEL_14:
    ...
    sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.onSelected, (int32_t)onSelected, v23, v24);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB25F4 & 1) == 0 )
  {
    sub_1BAB41C(&SupportSelectCopyDeckSelectMenu_OnSelectEvent_TypeInfo, value);
    byte_4AB25F4 = 1;
  }
  onSelected = this->fields.onSelected;
  p_onSelected = &this->fields.onSelected;
  ...
  while ( 1 )
  {
    ...
    v9 = sub_1BE690C(p_onSelected, v8, v6);
        ...
        const MethodInfo *method)
{
  if ( (byte_4AB25FB & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_3189/*"BaseWindow/CacnelButton"*/, method);
    byte_4AB25FB = 1;
  }
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19EB46C;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19EB424;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB25FD & 1) == 0 )
  {
    sub_1BAB41C(&int_TypeInfo, *(_QWORD *)&selectDeckId);
    byte_4AB25FD = 1;
  }
  v9[1] = 0LL;
