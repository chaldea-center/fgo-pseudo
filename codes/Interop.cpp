        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C4A0E2 & 1) == 0 )
  {
    sub_1C37058(&Interop_Sys_TypeInfo);
    byte_4C4A0E2 = 1;
  }
  if ( result < 0 )
  {
    v10 = (const MethodInfo *)sub_1A834F4(Interop_Sys_TypeInfo, path, isDirectory, errorRewriter, method);
...
int32_t Interop__CheckIo_63475736(
        int32_t result,
        System_String_o *path,
        bool isDirectory,
        System_Func_Interop_ErrorInfo__Interop_ErrorInfo__o *errorRewriter,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C4A0E3 & 1) == 0 )
  {
    sub_1C37058(&System_ArgumentOutOfRangeException_TypeInfo);
    sub_1C37058(&System_IO_DirectoryNotFoundException_TypeInfo);
    sub_1C37058(&System_IO_FileNotFoundException_TypeInfo);
    sub_1C37058(&System_IO_IOException_TypeInfo);
    sub_1C37058(&System_OperationCanceledException_TypeInfo);
    sub_1C37058(&System_IO_PathTooLongException_TypeInfo);
    sub_1C37058(&System_UnauthorizedAccessException_TypeInfo);
    sub_1C37058(&StringLiteral_4785/*"Could not find file '{0}'."*/);
    sub_1C37058(&StringLiteral_24634/*"value"*/);
    sub_1C37058(&StringLiteral_14146/*"The process cannot access the file '{0}' because it is being used by another process."*/);
    sub_1C37058(&StringLiteral_14147/*"The process cannot access the file because it is being used by another process."*/);
    sub_1C37058(&StringLiteral_4782/*"Could not find a part of the path."*/);
    sub_1C37058(&StringLiteral_2110/*"Access to the path is denied."*/);
    sub_1C37058(&StringLiteral_14917/*"Unable to find the specified file."*/);
    sub_1C37058(&StringLiteral_14211/*"The specified file name or path is too long, or a component of the specified path is too long."*/);
    sub_1C37058(&StringLiteral_12976/*"Specified file length was too large for the file system."*/);
    sub_1C37058(&StringLiteral_2109/*"Access to the path '{0}' is denied."*/);
    sub_1C37058(&StringLiteral_14139/*"The path '{0}' is too long, or a component of the specified path is too long."*/);
    sub_1C37058(&StringLiteral_4781/*"Could not find a part of the path '{0}'."*/);
    sub_1C37058(&StringLiteral_14037/*"The file '{0}' already exists."*/);
    byte_4C4A0E3 = 1;
  }
  if ( errorInfo.fields._error > 65547 )
  {
    if ( errorInfo.fields._error > 65558 )
    {
      if ( errorInfo.fields._error == 65573 )
      {
        ...
        {
          v28 = (System_IO_PathTooLongException_o *)sub_1C372A4(System_IO_PathTooLongException_TypeInfo);
        ...
        System_IO_PathTooLongException___ctor_64395596(v28, v29, 0);
        return v10;
      }
      if ( errorInfo.fields._error != 65602 )
      {
        if ( errorInfo.fields._error == 65581 )
        {
          ...
          if ( isDirectory )
          {
            if ( IsNullOrEmpty )
            {
              v9 = (System_IO_DirectoryNotFoundException_o *)sub_1C372A4(System_IO_DirectoryNotFoundException_TypeInfo);
            ...
            System_IO_DirectoryNotFoundException___ctor_64380364(v9, v11, 0);
          }
          else if ( IsNullOrEmpty )
          {
            v10 = (System_Exception_o *)sub_1C372A4(System_IO_FileNotFoundException_TypeInfo);
            System_IO_FileNotFoundException___ctor_64382340(
              (System_IO_FileNotFoundException_o *)v10,
              (System_String_o *)StringLiteral_14917/*"Unable to find the specified file."*/,
              0);
          }
          else
          {
            ...
            v10 = (System_Exception_o *)sub_1C372A4(System_IO_FileNotFoundException_TypeInfo);
            System_IO_FileNotFoundException___ctor_64382376((System_IO_FileNotFoundException_o *)v10, v37, path, 0);
          }
          return v10;
        }
LABEL_27:
...
LABEL_22:
      ...
      if ( System_String__IsNullOrEmpty(path, 0) )
      {
        v22 = (System_UnauthorizedAccessException_o *)sub_1C372A4(System_UnauthorizedAccessException_TypeInfo);
      ...
      System_UnauthorizedAccessException___ctor_65205380(v22, v23, IOException, 0);
      return v10;
    }
    if ( errorInfo.fields._error != 65556 )
    {
      if ( errorInfo.fields._error != 65558 )
        goto LABEL_27;
      v10 = (System_Exception_o *)sub_1C372A4(System_ArgumentOutOfRangeException_TypeInfo);
      System_ArgumentOutOfRangeException___ctor_64588440(
        (System_ArgumentOutOfRangeException_o *)v10,
        (System_String_o *)StringLiteral_24634/*"value"*/,
        (System_String_o *)StringLiteral_12976/*"Specified file length was too large for the file system."*/,
        0);
      return v10;
    }
    if ( System_String__IsNullOrEmpty(path, 0) )
  ...
  if ( errorInfo.fields._error <= 65542 )
  {
    ...
    if ( System_String__IsNullOrEmpty(path, 0) )
    {
      ...
      v16 = (System_IO_IOException_o *)sub_1C372A4(System_IO_IOException_TypeInfo);
...
LABEL_33:
      System_IO_IOException___ctor_64383672(v16, v18, v17, 0);
      return v10;
    }
...
LABEL_32:
  ...
  if ( errorInfo.fields._error != 65547 )
    goto LABEL_27;
  v10 = (System_Exception_o *)sub_1C372A4(System_OperationCanceledException_TypeInfo);
...
System_Exception_o *Interop__GetIOException(Interop_ErrorInfo_o errorInfo, const MethodInfo *method)
{
  ...
  v7 = (System_IO_IOException_o *)sub_1C372A4(System_IO_IOException_TypeInfo);
  System_IO_IOException___ctor_64383672(v7, ErrorMessage, RawErrno, 0);
        ...
        const MethodInfo *method)
{
  ...
  v10 = sub_1C3706C(&Method_Interop_ThrowExceptionForIoErrno__);
  sub_1C37180(ExceptionForIoErrno, v10);
}
...
void Interop_ErrorInfo___ctor_63476432(Interop_ErrorInfo_o this, int32_t error, const MethodInfo *method)
{
...
System_String_o *Interop_ErrorInfo__ToString(Interop_ErrorInfo_o this, const MethodInfo *method)
{
  ...
  if ( (byte_4C4A0E9 & 1) == 0 )
  {
    sub_1C37058(&Interop_Error_TypeInfo);
    sub_1C37058(&int_TypeInfo);
    sub_1C37058(&StringLiteral_11194/*"RawErrno: {0} Error: {1} GetErrorMessage: {2}"*/);
    byte_4C4A0E9 = 1;
  }
  v3 = this;
  RawErrno = Interop_ErrorInfo__get_RawErrno(v3, method);
  ...
  return System_String__Format_63603016((System_String_o *)StringLiteral_11194/*"RawErrno: {0} Error: {1} GetErrorMessage: {2}"*/, v10, v17, ErrorMessage, 0);
}
...
void Interop_Sys___cctor(const MethodInfo *method)
{
  if ( (byte_4C4A0EF & 1) == 0 )
  {
    method = (const MethodInfo *)sub_1C37058(&Interop_Sys_TypeInfo);
    byte_4C4A0EF = 1;
  }
...
LABEL_10:
    ...
    sub_1C37180(exception_argument_null_0, 0);
  }
...
int32_t Interop_Sys__LStat(System_String_o *path, Interop_Sys_FileStatus_o *output, const MethodInfo *method)
{
  ...
  v8 = output;
  v9 = sub_1C37610((int)path, (int)output, (int)method, v3, v4, v5, v6, v7, v11, v12, v13, v14);
...
int32_t Interop_Sys__LStat_63478640(uint8_t *path, Interop_Sys_FileStatus_o *output, const MethodInfo *method)
{
  int32_t v3; // w19
...
int32_t Interop_Sys__LStat_63478668(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C4A0EE & 1) == 0 )
  {
    sub_1C37058(&Method_System_Runtime_InteropServices_MemoryMarshal_GetReference_byte____78186576);
    sub_1C37058(&Method_System_Span_byte___ctor___78092520);
    sub_1C37058(&Interop_Sys_TypeInfo);
    byte_4C4A0EE = 1;
  }
  ...
  *(_QWORD *)&v14.fields._length = v4;
  ...
  Reference_byte = System_Runtime_InteropServices_MemoryMarshal__GetReference_byte_(
                     v12,
                     (const MethodInfo_316C46C *)Method_System_Runtime_InteropServices_MemoryMarshal_GetReference_byte____78186576);
  if ( !Interop_Sys_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(Interop_Sys_TypeInfo);
...
int32_t Interop_Sys__Link(System_String_o *source, System_String_o *link, const MethodInfo *method)
{
  ...
  v8 = (int)link;
  v9 = (char *)sub_1C37610((int)source, (int)link, (int)method, v3, v4, v5, v6, v7, v20, v22, v24, v26);
  v17 = (char *)sub_1C37610(v8, v10, v11, v12, v13, v14, v15, v16, v21, v23, v25, v27);
...
int32_t Interop_Sys__MkDir(System_String_o *path, int32_t mode, const MethodInfo *method)
{
  ...
  v9 = (char *)sub_1C37610((int)path, mode, (int)method, v3, v4, v5, v6, v7, v12, v13, v14, v15);
...
intptr_t Interop_Sys__OpenDir(System_String_o *path, const MethodInfo *method)
{
  ...
  v8 = sub_1C37610((int)path, (int)method, v2, v3, v4, v5, v6, v7, v11, v12, v13, v14);
        ...
        const MethodInfo *method)
{
  ...
  v10 = sub_1C37610((int)path, (int)buffer, bufferSize, (int)method, v4, v5, v6, v7, v15, v16, v17, v18);
  if ( buffer )
...
System_String_o *Interop_Sys__ReadLink_63477088(System_String_o *path, const MethodInfo *method)
{
  unsigned int v3; // w20
  _QWORD *v4; // x21
  __int64 v5; // x0
  ...
  if ( (byte_4C4A0EC & 1) == 0 )
  {
    sub_1C37058(&Method_System_Buffers_ArrayPool_byte__get_Shared__);
    sub_1C37058(&System_Buffers_ArrayPool_byte__TypeInfo);
    sub_1C37058(&Interop_Sys_TypeInfo);
    byte_4C4A0EC = 1;
  }
  v3 = 256;
...
int32_t Interop_Sys__Rename(System_String_o *oldPath, System_String_o *newPath, const MethodInfo *method)
{
  ...
  v8 = (int)newPath;
  v9 = (char *)sub_1C37610((int)oldPath, (int)newPath, (int)method, v3, v4, v5, v6, v7, v20, v22, v24, v26);
  v17 = (char *)sub_1C37610(v8, v10, v11, v12, v13, v14, v15, v16, v21, v23, v25, v27);
...
int32_t Interop_Sys__RmDir(System_String_o *path, const MethodInfo *method)
{
  ...
  v8 = (char *)sub_1C37610((int)path, (int)method, v2, v3, v4, v5, v6, v7, v11, v12, v13, v14);
...
int32_t Interop_Sys__Stat(System_String_o *path, Interop_Sys_FileStatus_o *output, const MethodInfo *method)
{
  ...
  v8 = (char *)sub_1C37610((int)path, (int)output, (int)method, v3, v4, v5, v6, v7, v11, v12, v13, v14);
...
int32_t Interop_Sys__Stat_63478300(uint8_t *path, Interop_Sys_FileStatus_o *output, const MethodInfo *method)
{
  int32_t v3; // w19
...
int32_t Interop_Sys__Stat_63478328(
        System_ReadOnlySpan_char__o path,
        Interop_Sys_FileStatus_o *output,
        const MethodInfo *method)
{
...
System_String_o *Interop_Sys__StrError(int32_t platformErrno, const MethodInfo *method)
{
  ...
  if ( !v3 )
    v3 = v6;
  v4 = System_IntPtr__op_Explicit_65393196(v3, 0);
  if ( !System_Runtime_InteropServices_Marshal_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Runtime_InteropServices_Marshal_TypeInfo);
...
int32_t Interop_Sys__Symlink(System_String_o *target, System_String_o *linkPath, const MethodInfo *method)
{
  ...
  v8 = (int)linkPath;
  v9 = sub_1C37610((int)target, (int)linkPath, (int)method, v3, v4, v5, v6, v7, v20, v22, v24, v26);
  v17 = sub_1C37610(v8, v10, v11, v12, v13, v14, v15, v16, v21, v23, v25, v27);
...
int32_t Interop_Sys__Unlink(System_String_o *pathname, const MethodInfo *method)
{
  ...
  v8 = (char *)sub_1C37610((int)pathname, (int)method, v2, v3, v4, v5, v6, v7, v11, v12, v13, v14);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C4A0F0 & 1) == 0 )
  {
    sub_1C37058(&Method_System_MemoryExtensions_IndexOf_byte___);
    sub_1C37058(&Method_System_ReadOnlySpan_byte___ctor___78091056);
    sub_1C37058(&Method_System_Span_char__Slice___78092656);
    sub_1C37058(&Method_System_Span_char__op_Implicit__);
    byte_4C4A0F0 = 1;
  }
  v6 = *((_DWORD *)Name + 2);
  v7 = *(_QWORD *)Name;
  if ( v6 == -1 )
  {
    v6 = sub_3C9AD18(v7, 256, 0, Method_System_MemoryExtensions_IndexOf_byte___, method);
    if ( (v6 & 0x80000000) != 0 )
LABEL_5:
  ...
  if ( v9 > (unsigned int)value )
    System_ThrowHelper__ThrowArgumentOutOfRangeException(0);
  if ( (*(_BYTE *)(*((_QWORD *)Method_System_Span_char__Slice___78092656 + 4) + 309LL) & 1) == 0 )
    sub_1C8776C();
  *(_QWORD *)&v13.fields._length = v9;
  v13.fields._pointer.fields._value = v4;
  v12 = System_Span_char___op_Implicit(v13, (const MethodInfo_39FD0F4 *)Method_System_Span_char__op_Implicit__);
