        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A7122D & 1) == 0 )
  {
    sub_1B90010(&UnityEngine_Object_TypeInfo, isSkip);
    sub_1B90010(&StringLiteral_5812/*"Effect("*/, v16);
  ...
  transform = System_String__Concat_61798352(
                (System_String_o *)StringLiteral_5812/*"Effect("*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A7122E & 1) == 0 )
  {
    sub_1B90010(&System_IDisposable_TypeInfo, tf);
    sub_1B90010(&System_Collections_IEnumerator_TypeInfo, v7);
    this = (ProgramEffectComponent_o *)sub_1B90010(&UnityEngine_Transform_TypeInfo, v8);
    byte_4A7122E = 1;
  }
  if ( !tf
