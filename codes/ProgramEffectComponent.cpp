        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67FF8 & 1) == 0 )
  {
    sub_1BE4ACC(&UnityEngine_Object_TypeInfo, isSkip);
    sub_1BE4ACC(&StringLiteral_5936/*"Effect("*/, v16);
  ...
  transform = System_String__Concat_62710068(
                (System_String_o *)StringLiteral_5936/*"Effect("*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67FF9 & 1) == 0 )
  {
    ...
    this = (ProgramEffectComponent_o *)sub_1BE4ACC(&UnityEngine_Transform_TypeInfo, v8);
    byte_4B67FF9 = 1;
  }
  if ( !tf
