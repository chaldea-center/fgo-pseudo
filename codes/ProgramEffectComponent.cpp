        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B46000 & 1) == 0 )
  {
    sub_1BDB878(&UnityEngine_Object_TypeInfo, isSkip);
    sub_1BDB878(&StringLiteral_5859/*"Effect("*/, v16);
  ...
  transform = System_String__Concat_62610508(
                (System_String_o *)StringLiteral_5859/*"Effect("*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B46001 & 1) == 0 )
  {
    sub_1BDB878(&System_IDisposable_TypeInfo, tf);
    sub_1BDB878(&System_Collections_IEnumerator_TypeInfo, v7);
    this = (ProgramEffectComponent_o *)sub_1BDB878(&UnityEngine_Transform_TypeInfo, v8);
    byte_4B46001 = 1;
  }
  if ( !tf
