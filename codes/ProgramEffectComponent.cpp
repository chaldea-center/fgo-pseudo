        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC8F0B & 1) == 0 )
  {
    sub_1C1ABD4(&UnityEngine_Object_TypeInfo, isSkip);
    sub_1C1ABD4(&StringLiteral_5957/*"Effect("*/, v16);
  ...
  transform = System_String__Concat_63051628(
                (System_String_o *)StringLiteral_5957/*"Effect("*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC8F0C & 1) == 0 )
  {
    sub_1C1ABD4(&System_IDisposable_TypeInfo, tf);
    sub_1C1ABD4(&System_Collections_IEnumerator_TypeInfo, v7);
    this = (ProgramEffectComponent_o *)sub_1C1ABD4(&UnityEngine_Transform_TypeInfo, v8);
    byte_4BC8F0C = 1;
  }
  if ( !tf
