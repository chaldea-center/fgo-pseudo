        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F2E6 & 1) == 0 )
  {
    sub_1B761C0(&UnityEngine_Object_TypeInfo, isSkip);
    sub_1B761C0(&StringLiteral_5810/*"Effect("*/, v16);
  ...
  transform = System_String__Concat_61546320(
                (System_String_o *)StringLiteral_5810/*"Effect("*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F2E7 & 1) == 0 )
  {
    sub_1B761C0(&System_IDisposable_TypeInfo, tf);
    sub_1B761C0(&System_Collections_IEnumerator_TypeInfo, v7);
    this = (ProgramEffectComponent_o *)sub_1B761C0(&UnityEngine_Transform_TypeInfo, v8);
    byte_4A2F2E7 = 1;
  }
  if ( !tf
