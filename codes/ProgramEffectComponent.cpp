        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20E72 & 1) == 0 )
  {
    sub_1B715CC(&UnityEngine_Object_TypeInfo, isSkip);
    sub_1B715CC(&StringLiteral_5791/*"Effect("*/, v16);
  ...
  transform = System_String__Concat_61516764(
                (System_String_o *)StringLiteral_5791/*"Effect("*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20E73 & 1) == 0 )
  {
    sub_1B715CC(&System_IDisposable_TypeInfo, tf);
    sub_1B715CC(&System_Collections_IEnumerator_TypeInfo, v7);
    this = (ProgramEffectComponent_o *)sub_1B715CC(&UnityEngine_Transform_TypeInfo, v8);
    byte_4A20E73 = 1;
  }
  if ( !tf
