        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4F9D6 & 1) == 0 )
  {
    sub_1B863B8(&UnityEngine_Object_TypeInfo, isSkip);
    sub_1B863B8(&StringLiteral_5782/*"Effect("*/, v16);
  ...
  transform = System_String__Concat_61683424(
                (System_String_o *)StringLiteral_5782/*"Effect("*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4F9D7 & 1) == 0 )
  {
    sub_1B863B8(&System_IDisposable_TypeInfo, tf);
    sub_1B863B8(&System_Collections_IEnumerator_TypeInfo, v7);
    this = (ProgramEffectComponent_o *)sub_1B863B8(&UnityEngine_Transform_TypeInfo, v8);
    byte_4A4F9D7 = 1;
  }
  if ( !tf
