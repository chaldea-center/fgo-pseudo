        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB7123 & 1) == 0 )
  {
    sub_1BAB41C(&UnityEngine_Object_TypeInfo, isSkip);
    sub_1BAB41C(&StringLiteral_5813/*"Effect("*/, v16);
  ...
  transform = System_String__Concat_62059388(
                (System_String_o *)StringLiteral_5813/*"Effect("*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB7124 & 1) == 0 )
  {
    sub_1BAB41C(&System_IDisposable_TypeInfo, tf);
    sub_1BAB41C(&System_Collections_IEnumerator_TypeInfo, v7);
    this = (ProgramEffectComponent_o *)sub_1BAB41C(&UnityEngine_Transform_TypeInfo, v8);
    byte_4AB7124 = 1;
  }
  if ( !tf
