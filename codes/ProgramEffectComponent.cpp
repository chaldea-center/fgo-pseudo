        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A09FFD & 1) == 0 )
  {
    sub_1B686D4(&UnityEngine_Object_TypeInfo, isSkip);
    sub_1B686D4(&StringLiteral_5786/*"Effect("*/, v16);
  ...
  transform = System_String__Concat_61430728(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A09FFE & 1) == 0 )
  {
    sub_1B686D4(&System_IDisposable_TypeInfo, tf);
    sub_1B686D4(&System_Collections_IEnumerator_TypeInfo, v7);
    this = (ProgramEffectComponent_o *)sub_1B686D4(&UnityEngine_Transform_TypeInfo, v8);
    byte_4A09FFE = 1;
  }
  if ( !tf
