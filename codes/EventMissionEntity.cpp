...
GiftEntity_o *__fastcall EventMissionEntity__GetQpGiftEntity(EventMissionEntity_o *this, const MethodInfo *method)
{
  ...
  while ( 1 )
  {
    if ( (unsigned int)v7 >= max_length )
      sub_1BC326C(GiftData, v3, v4);
    v8 = v6->m_Items[v7];
    if ( !v8 )
      sub_1BC3264(GiftData, v3);
...
bool __fastcall EventMissionEntity__IsIgnoreUserProgressData(EventMissionEntity_o *this, const MethodInfo *method)
{
