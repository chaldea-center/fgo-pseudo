        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFEACE & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_System_Collections_Generic_List_AssistEntity__get_Item__);
    byte_4DFEACE = 1;
  }
  ...
  if ( assistList->fields._size >= 1 )
  {
    ...
    while ( 1 )
    {
      Item = (AssistEntity_o *)System_Collections_Generic_List_object___get_Item(
                                 ...
                                 v8,
                                 (const MethodInfo_3905C98 *)Method_System_Collections_Generic_List_AssistEntity__get_Item__);
      if ( !Item )
        break;
      ...
      v14 = Detail;
      v15 = (EventEquipSkillPartsAddPartsListViewItem_o *)sub_1CE694C(EventEquipSkillPartsAddPartsListViewItem_TypeInfo);
