        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2AAAC & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_System_Collections_Generic_List_AssistEntity__get_Item__);
    byte_4D2AAAC = 1;
  }
  ...
  if ( assistList->fields._size >= 1 )
  {
    ...
    while ( 1 )
    {
      Item = (AssistEntity_o *)System_Collections_Generic_List_object___get_Item(
                                 ...
                                 v8,
                                 (const MethodInfo_38796CC *)Method_System_Collections_Generic_List_AssistEntity__get_Item__);
      if ( !Item )
        break;
      ...
      v14 = Detail;
      v15 = (EventEquipSkillPartsAddPartsListViewItem_o *)sub_1C93D20(EventEquipSkillPartsAddPartsListViewItem_TypeInfo);
