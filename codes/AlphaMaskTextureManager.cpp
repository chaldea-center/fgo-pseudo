        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B051A0 & 1) == 0 )
  {
    sub_1BC3008(&Method_UnityEngine_Object_Instantiate_UIAlphaMaskTexture___, root);
  ...
  transform = (UnityEngine_Component_o *)UnityEngine_Object__Instantiate_object_(
                                           prefab,
                                           (const MethodInfo_308AE24 *)Method_UnityEngine_Object_Instantiate_UIAlphaMaskTexture___);
  if ( !transform )
    goto LABEL_15;
  v13 = transform;
  ...
  if ( !byte_4AFBDB1 )
  {
    transform = (UnityEngine_Component_o *)sub_1BC3008(&UnityEngine_Vector3_TypeInfo, v12);
    byte_4AFBDB1 = 1;
  }
  if ( !v15 )
    goto LABEL_15;
