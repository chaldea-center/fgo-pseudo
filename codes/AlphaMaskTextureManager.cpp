        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A227B6 & 1) == 0 )
  {
    sub_1B715CC(&Method_UnityEngine_Object_Instantiate_UIAlphaMaskTexture___, root);
  ...
  transform = (UnityEngine_Component_o *)UnityEngine_Object__Instantiate_object_(
                                           prefab,
                                           (const MethodInfo_2EDE770 *)Method_UnityEngine_Object_Instantiate_UIAlphaMaskTexture___);
  if ( !transform )
    goto LABEL_15;
  v13 = transform;
  ...
  if ( !byte_4A1A751 )
  {
    transform = (UnityEngine_Component_o *)sub_1B715CC(&UnityEngine_Vector3_TypeInfo, v12);
    byte_4A1A751 = 1;
  }
  if ( !v15 )
    goto LABEL_15;
