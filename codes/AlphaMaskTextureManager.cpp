        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A017D8 & 1) == 0 )
  {
    sub_1B64A00(&Method_UnityEngine_Object_Instantiate_UIAlphaMaskTexture___, root);
  ...
  transform = (UnityEngine_Component_o *)UnityEngine_Object__Instantiate_object_(
                                           prefab,
                                           (const MethodInfo_2EBE594 *)Method_UnityEngine_Object_Instantiate_UIAlphaMaskTexture___);
  if ( !transform )
    goto LABEL_15;
  v13 = transform;
  ...
  if ( !byte_49F9821 )
  {
    transform = (UnityEngine_Component_o *)sub_1B64A00(&UnityEngine_Vector3_TypeInfo, v12);
    byte_49F9821 = 1;
  }
  if ( !v15 )
    goto LABEL_15;
