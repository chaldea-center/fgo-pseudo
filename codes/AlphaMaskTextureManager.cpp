        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2A670 & 1) == 0 )
  {
    sub_1C2D490(&Method_UnityEngine_Object_Instantiate_UIAlphaMaskTexture___);
  ...
  transform = (UnityEngine_Component_o *)UnityEngine_Object__Instantiate_object_(
                                           prefab,
                                           (const MethodInfo_315ACB8 *)Method_UnityEngine_Object_Instantiate_UIAlphaMaskTexture___);
  if ( !transform )
    goto LABEL_15;
  v12 = transform;
