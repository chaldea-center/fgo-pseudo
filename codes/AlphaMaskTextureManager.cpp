        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A72B92 & 1) == 0 )
  {
    sub_1B90010(&Method_UnityEngine_Object_Instantiate_UIAlphaMaskTexture___, root);
  ...
  transform = (UnityEngine_Component_o *)UnityEngine_Object__Instantiate_object_(
                                           prefab,
                                           (const MethodInfo_2F121DC *)Method_UnityEngine_Object_Instantiate_UIAlphaMaskTexture___);
  if ( !transform )
    goto LABEL_15;
  v13 = transform;
  ...
  if ( !byte_4A6A9C1 )
  {
    transform = (UnityEngine_Component_o *)sub_1B90010(&UnityEngine_Vector3_TypeInfo, v12);
    byte_4A6A9C1 = 1;
  }
  if ( !v15 )
    goto LABEL_15;
