        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1F7C5 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_UnityEngine_Object_Instantiate_UIAlphaMaskTexture___, root);
  ...
  transform = (UnityEngine_Component_o *)UnityEngine_Object__Instantiate_object_(
                                           prefab,
                                           (const MethodInfo_30A3BB4 *)Method_UnityEngine_Object_Instantiate_UIAlphaMaskTexture___);
  if ( !transform )
    goto LABEL_15;
  v13 = transform;
  ...
  if ( !byte_4B16191 )
  {
    transform = (UnityEngine_Component_o *)sub_1BCAFF8(&UnityEngine_Vector3_TypeInfo, v12);
    byte_4B16191 = 1;
  }
  if ( !v15 )
    goto LABEL_15;
