        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0B931 & 1) == 0 )
  {
    sub_1B686D4(&Method_UnityEngine_Object_Instantiate_UIAlphaMaskTexture___, root);
  ...
  transform = (UnityEngine_Component_o *)UnityEngine_Object__Instantiate_object_(
                                           prefab,
                                           (const MethodInfo_2ECC718 *)Method_UnityEngine_Object_Instantiate_UIAlphaMaskTexture___);
  if ( !transform )
    goto LABEL_15;
  v13 = transform;
  ...
  if ( !byte_4A03901 )
  {
    transform = (UnityEngine_Component_o *)sub_1B686D4(&UnityEngine_Vector3_TypeInfo, v12);
    byte_4A03901 = 1;
  }
  if ( !v15 )
    goto LABEL_15;
