        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47BC9 & 1) == 0 )
  {
    sub_1BDB878(&Method_UnityEngine_Object_Instantiate_UIAlphaMaskTexture___, root);
  ...
  transform = (UnityEngine_Component_o *)UnityEngine_Object__Instantiate_object_(
                                           prefab,
                                           (const MethodInfo_30BDAA4 *)Method_UnityEngine_Object_Instantiate_UIAlphaMaskTexture___);
  if ( !transform )
    goto LABEL_15;
  v13 = transform;
  ...
  if ( !byte_4B3E911 )
  {
    transform = (UnityEngine_Component_o *)sub_1BDB878(&UnityEngine_Vector3_TypeInfo, v12);
    byte_4B3E911 = 1;
  }
  if ( !v15 )
    goto LABEL_15;
