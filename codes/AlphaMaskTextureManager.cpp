        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E07F41 & 1) == 0 )
  {
    sub_1CE6700(&Method_UnityEngine_Object_Instantiate_UIAlphaMaskTexture___);
  ...
  transform = (UnityEngine_Component_o *)UnityEngine_Object__Instantiate_object_(
                                           prefab,
                                           (const MethodInfo_3290C24 *)Method_UnityEngine_Object_Instantiate_UIAlphaMaskTexture___);
  if ( !transform )
    goto LABEL_15;
  v12 = transform;
  ...
  if ( !byte_4DFE0A9 )
  {
    transform = (UnityEngine_Component_o *)sub_1CE6700(&UnityEngine_Vector3_TypeInfo);
    byte_4DFE0A9 = 1;
  }
  if ( !v14 )
    goto LABEL_15;
