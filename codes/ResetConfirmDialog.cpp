void ResetConfirmDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C56270 & 1) == 0 )
  {
    sub_1C3E564(&ResetConfirmDialog_TypeInfo);
  ...
  sub_1C3E508((CGThumbnailListItem_o *)ResetConfirmDialog_TypeInfo->static_fields, StringLiteral_408/*"#494949"*/, v1, v2);
}
...
void ResetConfirmDialog__Close(ResetConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  ResetConfirmDialog__Close_41092192(this, 0, v2);
}


void ResetConfirmDialog__Close_41092192(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C5626B & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_ResetConfirmDialog_EndClose__);
    byte_4C5626B = 1;
  }
...
void ResetConfirmDialog__OnClickCancel(ResetConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C5626D & 1) == 0 )
  {
    sub_1C3E564(&Method_ResetConfirmDialog_OnClickCancel__);
    byte_4C5626D = 1;
  }
  if ( !this->fields.isEnd )
  {
    ...
    if ( (*((_BYTE *)Method_ResetConfirmDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3E57C(Method_ResetConfirmDialog_OnClickCancel__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C3E548(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0, 0);
    if ( this->fields.clickFunc )
    {
      ResetConfirmDialog__Close_41092192(this, 0, v5);
      ...
      sub_1C3E508((CGThumbnailListItem_o *)&this->fields.clickFunc, 0, v9, v10);
    }
  }
}
...
void ResetConfirmDialog__OnClickDecide(ResetConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C5626C & 1) == 0 )
  {
    sub_1C3E564(&Method_ResetConfirmDialog_OnClickDecide__);
    byte_4C5626C = 1;
  }
  ...
  if ( UIProgressBar__get_value(checkSlider, 0) < 1.0 )
  {
    ...
    if ( (*((_BYTE *)Method_ResetConfirmDialog_OnClickDecide__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1C3E57C(Method_ResetConfirmDialog_OnClickDecide__);
  ...
  if ( !this->fields.isEnd )
  {
    ...
    if ( (*((_BYTE *)Method_ResetConfirmDialog_OnClickDecide__ + 83) & 2) != 0 )
      v6 = (_QWORD *)sub_1C3E57C(Method_ResetConfirmDialog_OnClickDecide__);
    v7 = (System_Reflection_MethodBase_o *)sub_1C3E548(v6, v6[4]);
    OverwriteAssetSoundName__PlaySystemSe(v7, 8, 0, 0);
    if ( this->fields.clickFunc )
    {
      ResetConfirmDialog__Close_41092192(this, 0, v8);
      clickFunc = this->fields.clickFunc;
      if ( clickFunc )
      {
        ((void (__fastcall *)(intptr_t, __int64, intptr_t))clickFunc->fields.invoke_impl)(
          ...
          clickFunc->fields.method);
        this->fields.clickFunc = 0;
        sub_1C3E508((CGThumbnailListItem_o *)&this->fields.clickFunc, 0, v10, v11);
        return;
      }
LABEL_15:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C56269 & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_ResetConfirmDialog_OnSliderDragFinished__);
    sub_1C3E564(&StringLiteral_5590/*"EVENT_DATA_LOST_BATTLE_RESET_CONFIRM_CANCEL"*/);
    sub_1C3E564(&StringLiteral_5589/*"EVENT_DATA_LOST_BATTLE_RESET_CONFIRM_BACK"*/);
    sub_1C3E564(&StringLiteral_5591/*"EVENT_DATA_LOST_BATTLE_RESET_CONFIRM_DECIDE"*/);
    byte_4C56269 = 1;
  }
  titleLabel = this->fields.titleLabel;
...
LABEL_10:
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.clickFunc, (int32_t)func, v15, v16);
  ...
  v18 = (UIProgressBar_OnDragFinished_o *)sub_1C3E7B0(UIProgressBar_OnDragFinished_TypeInfo);
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&checkSlider->fields.onDragFinished, (int32_t)v18, v19, v20);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1A82D24;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A82CDC;
}
