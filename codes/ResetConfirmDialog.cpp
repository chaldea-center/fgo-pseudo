void ResetConfirmDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C36ED7 & 1) == 0 )
  {
    sub_1C32C20(&ResetConfirmDialog_TypeInfo);
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)ResetConfirmDialog_TypeInfo->static_fields, StringLiteral_408/*"#494949"*/, v1, v2);
}
...
void ResetConfirmDialog__Close(ResetConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  ResetConfirmDialog__Close_40944276(this, 0, v2);
}


void ResetConfirmDialog__Close_40944276(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C36ED2 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_ResetConfirmDialog_EndClose__);
    byte_4C36ED2 = 1;
  }
...
void ResetConfirmDialog__OnClickCancel(ResetConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C36ED4 & 1) == 0 )
  {
    sub_1C32C20(&Method_ResetConfirmDialog_OnClickCancel__);
    byte_4C36ED4 = 1;
  }
  if ( !this->fields.isEnd )
  {
    ...
    if ( (*((_BYTE *)Method_ResetConfirmDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C32C38(Method_ResetConfirmDialog_OnClickCancel__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C32C04(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0, 0);
    if ( this->fields.clickFunc )
    {
      ResetConfirmDialog__Close_40944276(this, 0, v5);
      ...
      sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.clickFunc, 0, v8, v9);
    }
  }
}
...
void ResetConfirmDialog__OnClickDecide(ResetConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C36ED3 & 1) == 0 )
  {
    sub_1C32C20(&Method_ResetConfirmDialog_OnClickDecide__);
    byte_4C36ED3 = 1;
  }
  ...
  if ( UIProgressBar__get_value(checkSlider, 0) < 1.0 )
  {
    ...
    if ( (*((_BYTE *)Method_ResetConfirmDialog_OnClickDecide__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1C32C38(Method_ResetConfirmDialog_OnClickDecide__);
  ...
  if ( !this->fields.isEnd )
  {
    ...
    if ( (*((_BYTE *)Method_ResetConfirmDialog_OnClickDecide__ + 83) & 2) != 0 )
      v6 = (_QWORD *)sub_1C32C38(Method_ResetConfirmDialog_OnClickDecide__);
    v7 = (System_Reflection_MethodBase_o *)sub_1C32C04(v6, v6[4]);
    OverwriteAssetSoundName__PlaySystemSe(v7, 8, 0, 0);
    if ( this->fields.clickFunc )
    {
      ResetConfirmDialog__Close_40944276(this, 0, v8);
      clickFunc = this->fields.clickFunc;
      if ( clickFunc )
      {
        ((void (__fastcall *)(intptr_t, __int64, intptr_t))clickFunc->fields.invoke_impl)(
          ...
          clickFunc->fields.method);
        this->fields.clickFunc = 0;
        sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.clickFunc, 0, v10, v11);
        return;
      }
LABEL_15:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C36ED0 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_ResetConfirmDialog_OnSliderDragFinished__);
    sub_1C32C20(&StringLiteral_5589/*"EVENT_DATA_LOST_BATTLE_RESET_CONFIRM_CANCEL"*/);
    sub_1C32C20(&StringLiteral_5588/*"EVENT_DATA_LOST_BATTLE_RESET_CONFIRM_BACK"*/);
    sub_1C32C20(&StringLiteral_5590/*"EVENT_DATA_LOST_BATTLE_RESET_CONFIRM_DECIDE"*/);
    byte_4C36ED0 = 1;
  }
  titleLabel = this->fields.titleLabel;
...
LABEL_17:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
  {
    ...
    if ( isBack )
      goto LABEL_7;
LABEL_9:
    v13 = &StringLiteral_5589/*"EVENT_DATA_LOST_BATTLE_RESET_CONFIRM_CANCEL"*/;
    goto LABEL_10;
  }
  if ( !isBack )
    goto LABEL_9;
LABEL_7:
  v13 = &StringLiteral_5588/*"EVENT_DATA_LOST_BATTLE_RESET_CONFIRM_BACK"*/;
LABEL_10:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  titleLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5590/*"EVENT_DATA_LOST_BATTLE_RESET_CONFIRM_DECIDE"*/, 0);
  if ( !decideButtonLabel )
    goto LABEL_17;
  UILabel__set_text(decideButtonLabel, (System_String_o *)titleLabel, 0);
  this->fields.clickFunc = func;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.clickFunc, (int32_t)func, v15, v16);
  ...
  v18 = (UIProgressBar_OnDragFinished_o *)sub_1C32E6C(UIProgressBar_OnDragFinished_TypeInfo);
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&checkSlider->fields.onDragFinished, (int32_t)v18, v19, v20);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1A7764C;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A77604;
}
