void ResetConfirmDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CC68F8 & 1) == 0 )
  {
    sub_1C713B0(&ResetConfirmDialog_TypeInfo);
...
void ResetConfirmDialog__Close(ResetConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  ResetConfirmDialog__Close_41320592(this, 0, v2);
}


void ResetConfirmDialog__Close_41320592(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC68F3 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_ResetConfirmDialog_EndClose__);
    byte_4CC68F3 = 1;
  }
...
void ResetConfirmDialog__OnClickCancel(ResetConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC68F5 & 1) == 0 )
  {
    sub_1C713B0(&Method_ResetConfirmDialog_OnClickCancel__);
    byte_4CC68F5 = 1;
  }
  if ( !this->fields.isEnd )
  {
    ...
    if ( (*((_BYTE *)Method_ResetConfirmDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C713C8(Method_ResetConfirmDialog_OnClickCancel__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C71394(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0, 0);
    if ( this->fields.clickFunc )
    {
      ResetConfirmDialog__Close_41320592(this, 0, v5);
      ...
      sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.clickFunc, 0, v9, v10, v11, v12, v13, v14);
    }
  }
}
...
void ResetConfirmDialog__OnClickDecide(ResetConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC68F4 & 1) == 0 )
  {
    sub_1C713B0(&Method_ResetConfirmDialog_OnClickDecide__);
    byte_4CC68F4 = 1;
  }
  ...
  if ( UIProgressBar__get_value(checkSlider, 0) < 1.0 )
  {
    ...
    if ( (*((_BYTE *)Method_ResetConfirmDialog_OnClickDecide__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1C713C8(Method_ResetConfirmDialog_OnClickDecide__);
  ...
  if ( !this->fields.isEnd )
  {
    ...
    if ( (*((_BYTE *)Method_ResetConfirmDialog_OnClickDecide__ + 83) & 2) != 0 )
      v6 = (_QWORD *)sub_1C713C8(Method_ResetConfirmDialog_OnClickDecide__);
    v7 = (System_Reflection_MethodBase_o *)sub_1C71394(v6, v6[4]);
    OverwriteAssetSoundName__PlaySystemSe(v7, 8, 0, 0);
    if ( this->fields.clickFunc )
    {
      ResetConfirmDialog__Close_41320592(this, 0, v8);
      clickFunc = this->fields.clickFunc;
      if ( clickFunc )
      {
        ((void (__fastcall *)(intptr_t, __int64, intptr_t))clickFunc->fields.invoke_impl)(
          ...
          clickFunc->fields.method);
        this->fields.clickFunc = 0;
        sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.clickFunc, 0, v10, v11, v12, v13, v14, v15);
        return;
      }
LABEL_15:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC68F1 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_ResetConfirmDialog_OnSliderDragFinished__);
    sub_1C713B0(&StringLiteral_5583/*"EVENT_DATA_LOST_BATTLE_RESET_CONFIRM_CANCEL"*/);
    sub_1C713B0(&StringLiteral_5582/*"EVENT_DATA_LOST_BATTLE_RESET_CONFIRM_BACK"*/);
    sub_1C713B0(&StringLiteral_5584/*"EVENT_DATA_LOST_BATTLE_RESET_CONFIRM_DECIDE"*/);
    byte_4CC68F1 = 1;
  }
  titleLabel = this->fields.titleLabel;
...
LABEL_17:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
  {
    ...
    if ( isBack )
      goto LABEL_7;
LABEL_9:
    v13 = &StringLiteral_5583/*"EVENT_DATA_LOST_BATTLE_RESET_CONFIRM_CANCEL"*/;
    goto LABEL_10;
  }
  if ( !isBack )
    goto LABEL_9;
LABEL_7:
  v13 = &StringLiteral_5582/*"EVENT_DATA_LOST_BATTLE_RESET_CONFIRM_BACK"*/;
LABEL_10:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  titleLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5584/*"EVENT_DATA_LOST_BATTLE_RESET_CONFIRM_DECIDE"*/, 0);
  if ( !decideButtonLabel )
    goto LABEL_17;
  UILabel__set_text(decideButtonLabel, (System_String_o *)titleLabel, 0);
  this->fields.clickFunc = func;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.clickFunc, (int32_t)func, v15, v16, v17, v18, v19, v20);
  ...
  v22 = (UIProgressBar_OnDragFinished_o *)sub_1C715FC(UIProgressBar_OnDragFinished_TypeInfo);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1AA71B4;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1AA716C;
}
