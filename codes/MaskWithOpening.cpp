        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C2A9 & 1) == 0 )
  {
    sub_1B715CC(&ManagerConfig_TypeInfo, *(_QWORD *)&depth);
    byte_4A1C2A9 = 1;
  }
...
void __fastcall MaskWithOpening__Start(MaskWithOpening_o *this, const MethodInfo *method)
{
  ...
  if ( !byte_4A1A756 )
  {
    gameObject = (UnityEngine_GameObject_o *)sub_1B715CC(&UnityEngine_Vector3_TypeInfo, v3);
    byte_4A1A756 = 1;
  }
  if ( !v4 )
LABEL_6:
