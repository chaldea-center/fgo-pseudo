        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB0D1C & 1) == 0 )
  {
    sub_1C13D24(&ManagerConfig_TypeInfo, *(_QWORD *)&depth);
    byte_4BB0D1C = 1;
  }
...
void __fastcall MaskWithOpening__Start(MaskWithOpening_o *this, const MethodInfo *method)
{
  ...
  if ( !byte_4BAEDA6 )
  {
    gameObject = (UnityEngine_GameObject_o *)sub_1C13D24(&UnityEngine_Vector3_TypeInfo, v3);
    byte_4BAEDA6 = 1;
  }
  if ( !v4 )
LABEL_6:
