        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6C615 & 1) == 0 )
  {
    sub_1B90010(&ManagerConfig_TypeInfo, *(_QWORD *)&depth);
    byte_4A6C615 = 1;
  }
...
void __fastcall MaskWithOpening__Start(MaskWithOpening_o *this, const MethodInfo *method)
{
  ...
  if ( !byte_4A6A9C6 )
  {
    gameObject = (UnityEngine_GameObject_o *)sub_1B90010(&UnityEngine_Vector3_TypeInfo, v3);
    byte_4A6A9C6 = 1;
  }
  if ( !v4 )
LABEL_6:
