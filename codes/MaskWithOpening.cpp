        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DF0B9 & 1) == 0 )
  {
    sub_1B00CCC(&ManagerConfig_TypeInfo, *(_QWORD *)&depth);
    byte_48DF0B9 = 1;
  }
...
void __fastcall MaskWithOpening__Start(MaskWithOpening_o *this, const MethodInfo *method)
{
  ...
  if ( !byte_48DD9F6 )
  {
    gameObject = (UnityEngine_GameObject_o *)sub_1B00CCC(&UnityEngine_Vector3_TypeInfo, v3);
    byte_48DD9F6 = 1;
  }
  if ( !v4 )
LABEL_6:
