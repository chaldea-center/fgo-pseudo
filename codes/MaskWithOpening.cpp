        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0544A & 1) == 0 )
  {
    sub_1B686D4(&ManagerConfig_TypeInfo, *(_QWORD *)&depth);
    byte_4A0544A = 1;
  }
...
void __fastcall MaskWithOpening__Start(MaskWithOpening_o *this, const MethodInfo *method)
{
  ...
  if ( !byte_4A03906 )
  {
    gameObject = (UnityEngine_GameObject_o *)sub_1B686D4(&UnityEngine_Vector3_TypeInfo, v3);
    byte_4A03906 = 1;
  }
  if ( !v4 )
LABEL_6:
