        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F8C4C & 1) == 0 )
  {
    sub_1B640C8(&ManagerConfig_TypeInfo, *(_QWORD *)&depth);
    byte_49F8C4C = 1;
  }
  ...
  v20.fields.x = 0.0;
  UnityEngine_BoxCollider__set_center((UnityEngine_BoxCollider_o *)mask1, v20, 0LL);
  mask1 = (UnityEngine_Collider_o *)this->fields.mask1;
  if ( !mask1 )
    goto LABEL_18;
  ...
  UnityEngine_BoxCollider__set_size((UnityEngine_BoxCollider_o *)mask1, v21, 0LL);
  mask1 = (UnityEngine_Collider_o *)this->fields.mask2;
  if ( !mask1 )
    goto LABEL_18;
  ...
  v22.fields.x = 0.0;
  v22.fields.z = 0.0;
  UnityEngine_BoxCollider__set_center((UnityEngine_BoxCollider_o *)mask1, v22, 0LL);
  mask1 = (UnityEngine_Collider_o *)this->fields.mask2;
  if ( !mask1 )
    goto LABEL_18;
  v23.fields.z = 0.0;
  ...
  UnityEngine_BoxCollider__set_size((UnityEngine_BoxCollider_o *)mask1, v23, 0LL);
  mask1 = (UnityEngine_Collider_o *)this->fields.mask3;
  if ( !mask1 )
    goto LABEL_18;
  v16 = v15 * 0.5;
  ...
  v24.fields.z = 0.0;
  v24.fields.y = v18;
  UnityEngine_BoxCollider__set_center((UnityEngine_BoxCollider_o *)mask1, v24, 0LL);
  mask1 = (UnityEngine_Collider_o *)this->fields.mask3;
  if ( !mask1 )
    goto LABEL_18;
  v25.fields.z = 0.0;
  ...
  UnityEngine_BoxCollider__set_size((UnityEngine_BoxCollider_o *)mask1, v25, 0LL);
  mask1 = (UnityEngine_Collider_o *)this->fields.mask4;
  if ( !mask1
    || (v19 = v16 - (float)(m_Width + m_XMin),
        ...
        v26.fields.z = 0.0,
        v26.fields.y = v18,
        UnityEngine_BoxCollider__set_center((UnityEngine_BoxCollider_o *)mask1, v26, 0LL),
...
LABEL_18:
  ...
  v27.fields.z = 0.0;
  UnityEngine_BoxCollider__set_size((UnityEngine_BoxCollider_o *)mask1, v27, 0LL);
}
...
void __fastcall MaskWithOpening__Start(MaskWithOpening_o *this, const MethodInfo *method)
{
  ...
  if ( !byte_49F7116 )
  {
    gameObject = (UnityEngine_GameObject_o *)sub_1B640C8(&UnityEngine_Vector3_TypeInfo, v3);
    byte_49F7116 = 1;
  }
  if ( !v4 )
LABEL_6:
