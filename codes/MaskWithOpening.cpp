        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF9D4A & 1) == 0 )
  {
    sub_1C2E12C(&ManagerConfig_TypeInfo, *(_QWORD *)&depth);
    byte_4BF9D4A = 1;
  }
...
void __fastcall MaskWithOpening__Start(MaskWithOpening_o *this, const MethodInfo *method)
{
  ...
  if ( !byte_4BF7D96 )
  {
    gameObject = (UnityEngine_GameObject_o *)sub_1C2E12C(&UnityEngine_Vector3_TypeInfo, v3);
    byte_4BF7D96 = 1;
  }
  if ( !v4 )
LABEL_6:
