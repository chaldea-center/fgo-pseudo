        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFE4B7 & 1) == 0 )
  {
    sub_1BC3008(&ManagerConfig_TypeInfo, *(_QWORD *)&depth);
    byte_4AFE4B7 = 1;
  }
...
void __fastcall MaskWithOpening__Start(MaskWithOpening_o *this, const MethodInfo *method)
{
  ...
  if ( !byte_4AFBDB6 )
  {
    gameObject = (UnityEngine_GameObject_o *)sub_1BC3008(&UnityEngine_Vector3_TypeInfo, v3);
    byte_4AFBDB6 = 1;
  }
  if ( !v4 )
LABEL_6:
