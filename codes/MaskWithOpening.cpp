        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FAD3B & 1) == 0 )
  {
    sub_1B64870(&ManagerConfig_TypeInfo, *(_QWORD *)&depth);
    byte_49FAD3B = 1;
  }
...
void __fastcall MaskWithOpening__Start(MaskWithOpening_o *this, const MethodInfo *method)
{
  ...
  if ( !byte_49F9206 )
  {
    gameObject = (UnityEngine_GameObject_o *)sub_1B64870(&UnityEngine_Vector3_TypeInfo, v3);
    byte_49F9206 = 1;
  }
  if ( !v4 )
LABEL_6:
