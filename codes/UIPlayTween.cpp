...
void UIPlayTween__Awake(UIPlayTween_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(eventReceiver, 0, 0) )
  {
    ...
    if ( EventDelegate__IsValid_49972204(onFinished, 0) )
    {
      ...
      sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.eventReceiver, 0, v5, v6, v7, v8, v9, v10);
      this->fields.callWhenFinished = 0;
      sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.callWhenFinished, 0, v11, v12, v13, v14, v15, v16);
    }
  }
}
...
void UIPlayTween__OnDisable(UIPlayTween_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D350EB & 1) == 0 )
  {
    ...
    sub_1C93AD4(&EventDelegate_TypeInfo);
    sub_1C93AD4(&UnityEngine_Object_TypeInfo);
    sub_1C93AD4(&Method_UIPlayTween_OnToggle__);
    byte_4D350EB = 1;
  }
...
void UIPlayTween__OnFinished(UIPlayTween_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D350EF & 1) == 0 )
  {
    sub_1C93AD4(&EventDelegate_TypeInfo);
    sub_1C93AD4(&UnityEngine_Object_TypeInfo);
    sub_1C93AD4(&UIPlayTween_TypeInfo);
    byte_4D350EF = 1;
  }
  ...
  if ( !v3 )
  {
    ...
    if ( UnityEngine_Object__op_Equality(current, 0, 0) )
    {
      ...
      *p_eventReceiver = 0;
      sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.eventReceiver, 0, v14, v15, v16, v17, v18, v19);
      UIPlayTween_TypeInfo->static_fields->current = 0;
      sub_1C93A78((GrandQuestFolderBoardItem_o *)UIPlayTween_TypeInfo->static_fields, 0, v21, v22, v23, v24, v25, v26);
    }
  }
}
...
void UIPlayTween__Play(UIPlayTween_o *this, bool forward, const MethodInfo *method)
{
  ...
  if ( (byte_4D350EE & 1) == 0 )
  {
    sub_1C93AD4(&EventDelegate_Callback_TypeInfo);
    sub_1C93AD4(&EventDelegate_TypeInfo);
    sub_1C93AD4(&Method_UnityEngine_GameObject_GetComponentsInChildren_UITweener___);
    sub_1C93AD4(&Method_UnityEngine_GameObject_GetComponents_UITweener___);
    sub_1C93AD4(&NGUITools_TypeInfo);
    sub_1C93AD4(&UnityEngine_Object_TypeInfo);
    sub_1C93AD4(&Method_UIPlayTween_OnFinished__);
    byte_4D350EE = 1;
  }
  ...
  v9 = (struct UITweener_array *)(this->fields.includeChildren
                                ? UnityEngine_GameObject__GetComponentsInChildren_object__52415656(
                                    gameObject,
                                    (const MethodInfo_31FCCA8 *)Method_UnityEngine_GameObject_GetComponentsInChildren_UITweener___)
                                : UnityEngine_GameObject__GetComponents_object_(
                                    gameObject,
                                    (const MethodInfo_31FC9E0 *)Method_UnityEngine_GameObject_GetComponents_UITweener___));
  this->fields.mTweens = v9;
  p_mTweens = &this->fields.mTweens;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.mTweens, (int32_t)v9, v10, v11, v12, v13, v14, v15);
  ...
  if ( max_length )
  {
    if ( (int)max_length >= 1 )
    {
      ...
      do
      {
        ...
        if ( v22->fields.tweenGroup == this->fields.tweenGroup )
        {
          ...
          if ( playDirection )
          {
            ...
            {
              UITweener__Play_50178768(v22, v21 & 1, 0);
            ...
            if ( !EventDelegate_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(EventDelegate_TypeInfo);
            EventDelegate__Add_50001840(onFinished, v25, 1, 0);
            UITweener__Play_50178768(v22, v21 & 1, 0);
          }
          else
          {
            v26 = v22->fields.onFinished;
            v27 = (EventDelegate_Callback_o *)sub_1C93D20(EventDelegate_Callback_TypeInfo);
            EventDelegate_Callback___ctor(v27, (Il2CppObject *)this, Method_UIPlayTween_OnFinished__, 0);
            if ( !EventDelegate_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(EventDelegate_TypeInfo);
            EventDelegate__Add_50001840(v26, v27, 1, 0);
      ...
      while ( *p_mTweens );
LABEL_55:
      sub_1C93D2C(Active_50071416, v8);
    }
  }
...
void UIPlayTween__Update(UIPlayTween_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D350ED & 1) == 0 )
  {
    this = (UIPlayTween_o *)sub_1C93AD4(&NGUITools_TypeInfo);
    byte_4D350ED = 1;
  }
...
LABEL_17:
      ...
      p_mTweens->klass = 0;
      sub_1C93A78(p_mTweens, 0, v2, v3, v4, v5, v6, v7);
    }
  }
}