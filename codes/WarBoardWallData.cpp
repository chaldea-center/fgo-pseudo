        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A58F8B & 1) == 0 )
  {
    sub_1B885B0(&Method_DataManager_GetMasterData_WarBoardStageWallMaster___);
  ...
  *(_QWORD *)&this->fields._stageId_k__BackingField = *(_QWORD *)&layout->fields.stageId;
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_2E7F908 *)Method_DataManager_GetMasterData_WarBoardStageWallMaster___)) == 0LL )
  {
LABEL_12:
         ...
         0LL) )
  {
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.wallEntity, v15, v13, v14);
  }
  if ( wallData )
  {
...
void __fastcall WarBoardWallData_SaveData___ctor_35540244(
        ...
        const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.owner, (int32_t)Wall, v5, v6);
  owner = this->fields.owner;
  if ( owner )
  {
