        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC988 & 1) == 0 )
  {
    sub_1B64A00(&Method_DataManager_GetMasterData_WarBoardStageWallMaster___, layout);
  ...
  *(_QWORD *)&this->fields._stageId_k__BackingField = *(_QWORD *)&layout->fields.stageId;
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_2E3BCE0 *)Method_DataManager_GetMasterData_WarBoardStageWallMaster___)) == 0LL )
  {
LABEL_12:
         ...
         0LL) )
  {
    ...
    sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.wallEntity, v16, v14, v15);
  }
  if ( wallData )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC98C & 1) == 0 )
  {
    sub_1B64A00(&Method_System_Collections_Generic_List_WarBoardTaskBase___ctor__, *(_QWORD *)&decPoint);
    sub_1B64A00(&System_Collections_Generic_List_WarBoardTaskBase__TypeInfo, v5);
    byte_49FC98C = 1;
  }
  v6 = (System_Collections_Generic_List_object__o *)sub_1B64C4C(System_Collections_Generic_List_WarBoardTaskBase__TypeInfo);
...
void __fastcall WarBoardWallData__SetBreakPoint(WarBoardWallData_o *this, int32_t point, const MethodInfo *method)
{
  if ( (byte_49FC98B & 1) == 0 )
  {
    sub_1B64A00(&AStarSearch_TypeInfo, *(_QWORD *)&point);
    byte_49FC98B = 1;
  }
...
void __fastcall WarBoardWallData_SaveData___ctor_35245604(
        ...
        const MethodInfo *method)
{
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.owner, (int32_t)Wall, v5, v6);
  owner = this->fields.owner;
  if ( owner )
  {
