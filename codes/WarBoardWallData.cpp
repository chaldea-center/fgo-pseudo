        ...
        const MethodInfo *method)
{
  ...
  WarBoardStageWallEntity_o *v23; // x1
  int32_t defeatPoint; // w8
  WarBoardStageWallEntity_o *entity; // [xsp+8h] [xbp-38h] BYREF

  if ( (byte_4BDA2AE & 1) == 0 )
  {
    sub_1C21E38(&Method_DataManager_GetMasterData_WarBoardStageWallMaster___);
  ...
  *(_QWORD *)&this->fields._stageId_k__BackingField = *(_QWORD *)&layout->fields.stageId;
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_2FAFE04 *)Method_DataManager_GetMasterData_WarBoardStageWallMaster___)) == 0LL )
  {
LABEL_12:
         ...
         0LL) )
  {
    ...
    sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.wallEntity, (int64_t)v23, v17, v18, v19, v20, v21, v22);
  }
  if ( wallData )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( breakPoint_k__BackingField - decPoint < 1 )
  {
    ...
    if ( component )
    {
      WarBoardWallComponent__OnDead(component, (System_Collections_Generic_List_WarBoardTaskBase__o *)v5, 0LL);
      this->fields._isDestroy_k__BackingField = 1;
      return (System_Collections_Generic_List_WarBoardTaskBase__o *)v5;
    }
LABEL_9:
    sub_1C22094(component, v6);
  }
  WarBoardWallComponent__OnBreak(
    component,
    breakPoint_k__BackingField,
...
void __fastcall WarBoardWallData_SaveData___ctor_36723696(
        ...
        const MethodInfo *method)
{
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.owner, (int64_t)Wall, v5, v6, v7, v8, v9, v10);
  owner = this->fields.owner;
  if ( owner )
  {
