        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2BD7D & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMasterData_WarBoardStageWallMaster___, layout);
  ...
  *(_QWORD *)&this->fields._stageId_k__BackingField = *(_QWORD *)&layout->fields.stageId;
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_2E62408 *)Method_DataManager_GetMasterData_WarBoardStageWallMaster___)) == 0LL )
  {
LABEL_12:
         ...
         0LL) )
  {
    ...
    sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.wallEntity, v16, v14, v15);
  }
  if ( wallData )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2BD81 & 1) == 0 )
  {
    sub_1B761C0(&Method_System_Collections_Generic_List_WarBoardTaskBase___ctor__, *(_QWORD *)&decPoint);
    sub_1B761C0(&System_Collections_Generic_List_WarBoardTaskBase__TypeInfo, v5);
    byte_4A2BD81 = 1;
  }
  v6 = (System_Collections_Generic_List_object__o *)sub_1B7640C(System_Collections_Generic_List_WarBoardTaskBase__TypeInfo);
...
void __fastcall WarBoardWallData__SetBreakPoint(WarBoardWallData_o *this, int32_t point, const MethodInfo *method)
{
  if ( (byte_4A2BD80 & 1) == 0 )
  {
    sub_1B761C0(&AStarSearch_TypeInfo, *(_QWORD *)&point);
    byte_4A2BD80 = 1;
  }
...
void __fastcall WarBoardWallData_SaveData___ctor_35367180(
        ...
        const MethodInfo *method)
{
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.owner, (int32_t)Wall, v5, v6);
  owner = this->fields.owner;
  if ( owner )
  {
