        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E75203 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_DataManager_GetMasterData_WarBoardStageWallMaster___);
  ...
  *(_QWORD *)&this->fields._stageId_k__BackingField = *(_QWORD *)&layout->fields.stageId;
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_324F1B8 *)Method_DataManager_GetMasterData_WarBoardStageWallMaster___)) == 0 )
  {
LABEL_12:
         ...
         0) )
  {
    ...
    sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.wallEntity, v23, v17, v18, v19, v20, v21, v22);
  }
  if ( wallData )
  {
...
void WarBoardWallData_SaveData___ctor_39442532(
        ...
        const MethodInfo *method)
{
  ...
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.owner, (int32_t)Wall, v5, v6, v7, v8, v9, v10);
  owner = this->fields.owner;
  if ( owner )
  {
