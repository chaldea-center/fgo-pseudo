        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1FCA4 & 1) == 0 )
  {
    sub_1C3B764(&Method_DataManager_GetMasterData_WarBoardStageWallMaster___, layout);
  ...
  *(_QWORD *)&this->fields._stageId_k__BackingField = *(_QWORD *)&layout->fields.stageId;
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_2FF0204 *)Method_DataManager_GetMasterData_WarBoardStageWallMaster___)) == 0LL )
  {
LABEL_12:
         ...
         0LL) )
  {
    ...
    sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.wallEntity, (int64_t)v24, v18, v19, v20, v21, v22, v23);
  }
  if ( wallData )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1FCA8 & 1) == 0 )
  {
    sub_1C3B764(&Method_System_Collections_Generic_List_WarBoardTaskBase___ctor__, *(_QWORD *)&decPoint);
    sub_1C3B764(&System_Collections_Generic_List_WarBoardTaskBase__TypeInfo, v5);
    byte_4C1FCA8 = 1;
  }
  v6 = (System_Collections_Generic_List_object__o *)sub_1C3B9B0(System_Collections_Generic_List_WarBoardTaskBase__TypeInfo);
...
void __fastcall WarBoardWallData__SetBreakPoint(WarBoardWallData_o *this, int32_t point, const MethodInfo *method)
{
  if ( (byte_4C1FCA7 & 1) == 0 )
  {
    sub_1C3B764(&AStarSearch_TypeInfo, *(_QWORD *)&point);
    byte_4C1FCA7 = 1;
  }
...
void __fastcall WarBoardWallData_SaveData___ctor_36891344(
        ...
        const MethodInfo *method)
{
  ...
  sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.owner, (int64_t)Wall, v5, v6, v7, v8, v9, v10);
  owner = this->fields.owner;
  if ( owner )
  {
