void __fastcall TipsBattleMaster___ctor(TipsBattleMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4B67737 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_DataMasterBase_TipsBattleMaster__TipsBattleEntity__int___ctor__, method);
    byte_4B67737 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    134,
    (const MethodInfo_31FD784 *)Method_DataMasterBase_TipsBattleMaster__TipsBattleEntity__int___ctor__);
}
