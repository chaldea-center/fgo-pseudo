        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B0259D & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_EventInfoAreaImproveResultDialog_OnClickCloseButton__, v3);
    sub_1BC3008(&Method_EventInfoAreaImproveResultDialog__OnClickCloseButton_b__12_0__, v4);
    byte_4B0259D = 1;
  }
  if ( !this->fields.isClose )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoAreaImproveResultDialog_OnClickCloseButton__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1BC3020(Method_EventInfoAreaImproveResultDialog_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B0259B & 1) == 0 )
  {
    sub_1BC3008(&System_Action_TypeInfo, areaImproveResultInfo);
    sub_1BC3008(&Method_DataManager_GetMaster_EventCooltimeRewardMaster___, v7);
    sub_1BC3008(&DataManager_TypeInfo, v8);
    sub_1BC3008(&Method_EventInfoAreaImproveResultDialog__Open_b__9_0__, v9);
    byte_4B0259B = 1;
  }
  ...
  SelfUserGame = (EventCooltimeRewardMaster_o *)DataManager__GetMaster_object_((const MethodInfo_3001E10 *)Method_DataManager_GetMaster_EventCooltimeRewardMaster___);
  if ( !SelfUserGame )
LABEL_12:
  ...
  if ( Entity && (v21 = v19) != 0LL )
  {
    ...
    sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.closeAction, (int32_t)closeAction, v24, v25);
  }
  else
  {
...
LABEL_33:
      sub_1BC3264(this, beforeRewardEnt);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B0259C & 1) == 0 )
  {
    sub_1BC3008(&LocalizationManager_TypeInfo, areaName);
    sub_1BC3008(&StringLiteral_5468/*"EVENT_AREA_IMPROVE_RESULT_DIALOG_TITLE"*/, v5);
    byte_4B0259C = 1;
  }
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v7 = LocalizationManager__Get((System_String_o *)StringLiteral_5468/*"EVENT_AREA_IMPROVE_RESULT_DIALOG_TITLE"*/, 0LL);
