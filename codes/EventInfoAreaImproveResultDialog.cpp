        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDCCF8 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_EventInfoAreaImproveResultDialog_OnClickCloseButton__);
    sub_1C21E38(&Method_EventInfoAreaImproveResultDialog__OnClickCloseButton_b__12_0__);
    byte_4BDCCF8 = 1;
  }
  if ( !this->fields.isClose )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoAreaImproveResultDialog_OnClickCloseButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_EventInfoAreaImproveResultDialog_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDCCF6 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_EventInfoAreaImproveResultDialog__Open_b__9_0__);
    byte_4BDCCF6 = 1;
  }
  ...
  SelfUserGame = (EventCooltimeRewardMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2FAFDB0 *)Method_DataManager_GetMaster_EventCooltimeRewardMaster___);
  if ( !SelfUserGame )
LABEL_12:
...
LABEL_33:
      sub_1C22094(this, beforeRewardEnt);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C21E38(&LocalizationManager_TypeInfo);
    sub_1C21E38(&StringLiteral_5657/*"EVENT_AREA_IMPROVE_RESULT_DIALOG_TITLE"*/);
    byte_4BDCCF7 = 1;
  }
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v6 = LocalizationManager__Get((System_String_o *)StringLiteral_5657/*"EVENT_AREA_IMPROVE_RESULT_DIALOG_TITLE"*/, 0LL);
