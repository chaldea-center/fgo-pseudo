...
void UISpriteAltMat__ResetMaterial(UISpriteAltMat_o *this, const MethodInfo *method)
{
  ...
  UnityEngine_Object__Destroy_71266752(exMaterial, 0);
  p_exMaterial->klass = 0;
  sub_1C36FFC(p_exMaterial, 0, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.exMaterial, (int32_t)mat, v6, v7);
  ...
  UnityEngine_Material__SetTexture(v10, (System_String_o *)StringLiteral_16269/*"_MaskTex"*/, (UnityEngine_Texture_o *)material, 0);
}
