...
void UISpriteAltMat__ResetMaterial(UISpriteAltMat_o *this, const MethodInfo *method)
{
  ...
  UnityEngine_Object__Destroy_72918540(exMaterial, 0);
  p_exMaterial->klass = 0;
  sub_1CE66A4(p_exMaterial, 0, v5, v6, v7, v8, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.exMaterial, (int32_t)mat, v6, v7, v8, v9, v10, v11);
  ...
  if ( !material
    ...
    || (material = (UnityEngine_Material_o *)UnityEngine_Material__GetTexture(
        ...
        !v15) )
  {
    sub_1CE6958(material, v14);
  }
  UnityEngine_Material__SetTexture(v15, (System_String_o *)StringLiteral_16421/*"_MaskTex"*/, (UnityEngine_Texture_o *)material, 0);
}
