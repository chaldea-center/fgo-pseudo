...
void UISpriteAltMat__ResetMaterial(UISpriteAltMat_o *this, const MethodInfo *method)
{
  ...
  UnityEngine_Object__Destroy_71341564(exMaterial, 0);
  p_exMaterial->klass = 0;
  sub_1C3E508(p_exMaterial, 0, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.exMaterial, (int32_t)mat, v6, v7);
  ...
  if ( !material
    ...
    || (material = (UnityEngine_Material_o *)UnityEngine_Material__GetTexture(
        ...
        !v11) )
  {
    sub_1C3E7C0(material, v10);
  }
  UnityEngine_Material__SetTexture(v11, (System_String_o *)StringLiteral_16279/*"_MaskTex"*/, (UnityEngine_Texture_o *)material, 0);
}
