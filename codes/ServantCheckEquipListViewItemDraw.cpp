        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62E0E & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Rarity_TypeInfo, v8);
    sub_1BE4ACC(&StringLiteral_23262/*"ribbon_noblephantasmup_01"*/, v9);
    sub_1BE4ACC(&StringLiteral_20450/*"icon_reinforced"*/, v10);
    sub_1BE4ACC(&StringLiteral_20439/*"icon_noblephantasmup"*/, v11);
    this = (ServantCheckEquipListViewItemDraw_o *)sub_1BE4ACC(&StringLiteral_20449/*"icon_rarity5"*/, v12);
    byte_4B62E0E = 1;
  }
  if ( item && mode )
  {
    ...
    *(_OWORD *)&v26.fields.fakeValue = v14;
    ...
    v25 = v26;
    this = (ServantCheckEquipListViewItemDraw_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_47302584(
                                                    &v25,
                                                    0LL);
    if ( !servantEquipIcon
...
LABEL_48:
    ...
    switch ( item->fields.warningTextType )
    {
      ...
      case 1:
        ...
        if ( !this )
          goto LABEL_48;
        v22 = &StringLiteral_20450/*"icon_reinforced"*/;
        goto LABEL_34;
      case 2:
        this = (ServantCheckEquipListViewItemDraw_o *)v6->fields.equipSprite;
        if ( !this )
        ...
        if ( !this )
          goto LABEL_48;
        v22 = &StringLiteral_20449/*"icon_rarity5"*/;
LABEL_34:
...
LABEL_35:
      ...
      case 3:
        ...
        if ( !AtlasManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
        AtlasManager__SetEventSprite(v24, (System_String_o *)StringLiteral_20439/*"icon_noblephantasmup"*/, 0LL);
        this = (ServantCheckEquipListViewItemDraw_o *)v6->fields.materialTdSprite;
        if ( !this )
          goto LABEL_48;
        this = (ServantCheckEquipListViewItemDraw_o *)UnityEngine_Component__get_gameObject(
        ...
        if ( !this )
          goto LABEL_48;
        UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)this, 1, 0LL);
        AtlasManager__SetEventSprite(v6->fields.materialTdSprite, (System_String_o *)StringLiteral_23262/*"ribbon_noblephantasmup_01"*/, 0LL);
        return;
      default:
        return;
    }
