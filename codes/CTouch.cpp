void __fastcall CTouch___cctor(const MethodInfo *method)
{
  ...
  struct CTouch_StaticFields *v14; // x0
  int64_t v15; // x2
  int32_t v16; // w3
  ...
  struct CTouch_StaticFields *v21; // x8

  if ( (byte_4C01FD1 & 1) == 0 )
  {
    sub_1C2E12C(&CTouch_TypeInfo, v1);
    sub_1C2E12C(&Method_System_Collections_Generic_List_int___ctor__, v2);
    sub_1C2E12C(&System_Collections_Generic_List_int__TypeInfo, v3);
    sub_1C2E12C(&UnityEngine_Touch___TypeInfo, v4);
    byte_4C01FD1 = 1;
  }
  *(_QWORD *)&CTouch_TypeInfo->static_fields->FLICK_LEN = 0x4170000040A00000LL;
  v5 = sub_1C2E1D4(UnityEngine_Touch___TypeInfo, 1LL);
  static_fields = CTouch_TypeInfo->static_fields;
  static_fields->mTouch = (struct UnityEngine_Touch_array *)v5;
  sub_1C2E0D0((PartyOrganizationUtility_o *)&static_fields->mTouch, v5, v7, v8, v9, v10, v11, v12);
  ...
  v14 = CTouch_TypeInfo->static_fields;
  v14->ignoreFingerIDList = v13;
  sub_1C2E0D0((PartyOrganizationUtility_o *)&v14->ignoreFingerIDList, (int64_t)v13, v15, v16, v17, v18, v19, v20);
  v21 = CTouch_TypeInfo->static_fields;
  *(_WORD *)&v21->mIsTchNow = 0;
  v21->mState = 0;
  v21->mDragFrameCnt = -1;
  v21->mIsClassEnabled = 0;
}
...
UnityEngine_Vector2_o __fastcall CTouch__GetTouchPos(const MethodInfo *method)
{
  ...
  if ( !byte_4BF7C8A )
  {
    sub_1C2E12C(&UnityEngine_Vector2_TypeInfo, v1);
    byte_4BF7C8A = 1;
  }
  ...
  if ( UnityEngine_Input__get_touchCount(0LL) >= 1 )
  {
    ...
    if ( CTouch__GetValidTouchCount((const MethodInfo *)v5) == 1 )
    {
      ...
      if ( (CTouch__GetValidTouchLastID(1, v6) & 0x80000000) != 0 )
      {
        if ( !byte_4BF7C8A )
        {
          sub_1C2E12C(&UnityEngine_Vector2_TypeInfo, v7);
          byte_4BF7C8A = 1;
        }
...
int32_t __fastcall CTouch__GetValidTouchCount(const MethodInfo *method)
{
  ...
  {
    sub_1C2E12C(&CTouch_TypeInfo, v1);
    sub_1C2E12C(&Method_System_Collections_Generic_List_int__get_Count__, v2);
    byte_4C01FCE = 1;
  }
...
int32_t __fastcall CTouch__GetValidTouchLastID(bool isReverse, const MethodInfo *method)
{
  ...
  if ( (byte_4C01FD0 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_System_Collections_Generic_List_int__Contains__, v3);
    byte_4C01FD0 = 1;
  }
  v4 = CTouch_TypeInfo;
  if ( !CTouch_TypeInfo->_2.cctor_finished )
...
LABEL_28:
        sub_1C2E390(touches, v9);
      touches = (UnityEngine_Touch_array *)UnityEngine_Touch__get_fingerId(
                                             (UnityEngine_Touch_o *)((char *)touches + v10),
                                             0LL);
      if ( !v12 )
LABEL_27:
        sub_1C2E388(touches, v9);
      if ( !System_Collections_Generic_List_int___Contains(
              v12,
              (int32_t)touches,
              (const MethodInfo_364EC00 *)Method_System_Collections_Generic_List_int__Contains__) )
...
void __fastcall CTouch__add_MOnTouchPressEvent(CTouch_TouchEventHandler_o *value, const MethodInfo *method)
{
  ...
  {
    sub_1C2E12C(&CTouch_TypeInfo, method);
    sub_1C2E12C(&CTouch_TouchEventHandler_TypeInfo, v3);
    byte_4C01FAE = 1;
  }
  v4 = CTouch_TypeInfo;
  if ( !CTouch_TypeInfo->_2.cctor_finished )
  ...
  while ( 1 )
  {
    ...
    v9 = sub_1C6961C(&v8->static_fields->MOnTouchPressEvent, v7, MOnTouchPressEvent);
...
void __fastcall CTouch__add_MOnTouchReleaseEvent(CTouch_TouchEventHandler_o *value, const MethodInfo *method)
{
  ...
  while ( 1 )
  {
    ...
    v9 = sub_1C6961C(&v8->static_fields->MOnTouchReleaseEvent, v7, MOnTouchReleaseEvent);
...
int32_t __fastcall CTouch__getFlickDirX(const MethodInfo *method)
{
  ...
  if ( !byte_4BF7C8A )
  {
    sub_1C2E12C(&UnityEngine_Vector2_TypeInfo, v3);
    byte_4BF7C8A = 1;
  }
  v8 = -1.0;
...
UnityEngine_Vector2_o __fastcall CTouch__getScreenPosition_47877624(
        ...
        const MethodInfo *method)
{
  ...
  float v6; // s0
  float v7; // s1
  UnityEngine_Vector2_o ScreenPosition_47877736; // kr00_8
  ...
  if ( (byte_4C01FC6 & 1) == 0 )
  {
    sub_1C2E12C(&CTouch_TypeInfo, v2);
    byte_4C01FC6 = 1;
  }
  v5 = CTouch_TypeInfo;
  if ( !CTouch_TypeInfo->_2.cctor_finished )
  ...
  v9.fields.x = x;
  v9.fields.y = y;
  ScreenPosition_47877736 = CTouch__getScreenPosition_47877736(v9, v5->static_fields->mScreenCam, v2);
  v7 = ScreenPosition_47877736.fields.y;
  v6 = ScreenPosition_47877736.fields.x;
  result.fields.y = v7;
  result.fields.x = v6;
  return result;
}
...
// local variable allocation has failed, the output may be wrong!
UnityEngine_Vector2_o __fastcall CTouch__getScreenPosition_47877736(
        UnityEngine_Vector2_o tch_pos,
        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    v20.fields.x = x;
    v20.fields.y = y;
    UnityEngine_Camera__ScreenPointToRay_70796180(&v18, mScreenCam, v20, 0LL);
...
UnityEngine_Vector2_o __fastcall CTouch__getScreenPosition_47878128(
        UnityEngine_Camera_o *cam,
        const MethodInfo *method)
{
  CTouch_c *v2; // x0
  ...
  ScreenPosition_47877736 = CTouch__getScreenPosition_47877736(TouchPos, CTouch_TypeInfo->static_fields->mScreenCam, v3);
  y = ScreenPosition_47877736.fields.y;
  x = ScreenPosition_47877736.fields.x;
  result.fields.y = y;
  result.fields.x = x;
  return result;
}
...
bool __fastcall CTouch__isFlick(const MethodInfo *method)
{
  ...
  return CTouch__isFlick_47874952(v2->static_fields->FLICK_LEN, (const MethodInfo *)v2);
}


bool __fastcall CTouch__isFlick_47874952(float flickLen, const MethodInfo *method)
{
  __int64 v2; // x1
  CTouch_c *v4; // x0
  __int64 v5; // x1
...
void __fastcall CTouch__processSingleTouch(const MethodInfo *method)
{
  ...
  struct UnityEngine_Vector2_o ScreenPosition_47877624; // kr08_8
  CTouch_c *v13; // x0
  __int64 v14; // x8
...
LABEL_17:
    ...
    *(_QWORD *)((char *)v11[2].virtualMethodPointer + 68) = *(_QWORD *)((char *)v11[2].virtualMethodPointer + 52);
    ScreenPosition_47877624 = CTouch__getScreenPosition_47877624(
                                *(UnityEngine_Vector2_o *)((char *)v11[2].virtualMethodPointer + 32),
                                v11);
    v13 = CTouch_TypeInfo;
    CTouch_TypeInfo->static_fields->mScrPosNow = ScreenPosition_47877624;
...
LABEL_30:
      ...
      v20 = CTouch__getScreenPosition_47877624(v16->static_fields->mPosPush, touchCount);
      v21 = CTouch_TypeInfo;
      CTouch_TypeInfo->static_fields->mScrPosPush = v20;
      v21->static_fields->mScrPosOld = v21->static_fields->mScrPosNow;
      if ( !byte_4BF7C8A )
      {
        sub_1C2E12C(&UnityEngine_Vector2_TypeInfo, v19);
        v21 = CTouch_TypeInfo;
        byte_4BF7C8A = 1;
      }
...
LABEL_83:
        ...
        if ( v41 )
        {
          ...
          if ( (v44->mDragFrameCnt & 0x80000000) != 0 )
          {
            ...
            if ( !byte_4BF7D92 )
            {
              sub_1C2E12C(&System_Math_TypeInfo, v42);
              byte_4BF7D92 = 1;
            }
        ...
        if ( !byte_4BF7C8A )
        {
          sub_1C2E12C(&UnityEngine_Vector2_TypeInfo, v42);
          byte_4BF7C8A = 1;
        }
        ...
        const MethodInfo *method)
{
  ...
  if ( static_fields->mIsInitDone )
  {
    ...
    sub_1C2E0D0((PartyOrganizationUtility_o *)&v15->mScreenCam, (int64_t)screenCam, v4, v5, v6, v7, v8, v9);
  }
}
...
void __fastcall CTouch__setScreenCamera(UnityEngine_Camera_o *cam, const MethodInfo *method)
{
  ...
  sub_1C2E0D0((PartyOrganizationUtility_o *)&static_fields->mScreenCam, (int64_t)cam, v2, v3, v4, v5, v6, v7);
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A75F50;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A75F10;
}
