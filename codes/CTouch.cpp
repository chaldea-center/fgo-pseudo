void __fastcall CTouch___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A24335 & 1) == 0 )
  {
    sub_1B715CC(&CTouch_TypeInfo, v1);
    sub_1B715CC(&Method_System_Collections_Generic_List_int___ctor__, v2);
    sub_1B715CC(&System_Collections_Generic_List_int__TypeInfo, v3);
    sub_1B715CC(&UnityEngine_Touch___TypeInfo, v4);
    byte_4A24335 = 1;
  }
  *(_QWORD *)&CTouch_TypeInfo->static_fields->FLICK_LEN = 0x4170000040A00000LL;
  v5 = sub_1B71674(UnityEngine_Touch___TypeInfo, 1LL);
  static_fields = CTouch_TypeInfo->static_fields;
  static_fields->mTouch = (struct UnityEngine_Touch_array *)v5;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&static_fields->mTouch, v5, v7, v8);
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&v10->ignoreFingerIDList, (int32_t)v9, v11, v12);
...
UnityEngine_Vector2_o __fastcall CTouch__GetTouchPos(const MethodInfo *method)
{
  ...
  if ( !byte_4A1A64A )
  {
    sub_1B715CC(&UnityEngine_Vector2_TypeInfo, v1);
    byte_4A1A64A = 1;
  }
...
int32_t __fastcall CTouch__GetValidTouchCount(const MethodInfo *method)
{
  ...
  {
    sub_1B715CC(&CTouch_TypeInfo, v1);
    sub_1B715CC(&Method_System_Collections_Generic_List_int__get_Count__, v2);
    byte_4A24332 = 1;
  }
...
int32_t __fastcall CTouch__GetValidTouchLastID(bool isReverse, const MethodInfo *method)
{
  ...
  if ( (byte_4A24334 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_System_Collections_Generic_List_int__Contains__, v3);
    byte_4A24334 = 1;
  }
  v4 = CTouch_TypeInfo;
  if ( !CTouch_TypeInfo->_2.cctor_finished )
...
LABEL_28:
        sub_1B71830(touches, v9);
      touches = (UnityEngine_Touch_array *)UnityEngine_Touch__get_fingerId(
                                             (UnityEngine_Touch_o *)((char *)touches + v10),
                                             0LL);
      if ( !v12 )
LABEL_27:
        sub_1B71828(touches, v9);
      if ( !System_Collections_Generic_List_int___Contains(
              v12,
              (int32_t)touches,
              (const MethodInfo_34B35B4 *)Method_System_Collections_Generic_List_int__Contains__) )
...
void __fastcall CTouch__add_MOnTouchPressEvent(CTouch_TouchEventHandler_o *value, const MethodInfo *method)
{
  ...
  {
    sub_1B715CC(&CTouch_TypeInfo, method);
    sub_1B715CC(&CTouch_TouchEventHandler_TypeInfo, v3);
    byte_4A24312 = 1;
  }
  v4 = CTouch_TypeInfo;
  if ( !CTouch_TypeInfo->_2.cctor_finished )
  ...
  while ( 1 )
  {
    ...
    v9 = sub_1BACABC(&v8->static_fields->MOnTouchPressEvent, v7, MOnTouchPressEvent);
...
void __fastcall CTouch__add_MOnTouchReleaseEvent(CTouch_TouchEventHandler_o *value, const MethodInfo *method)
{
  ...
  while ( 1 )
  {
    ...
    v9 = sub_1BACABC(&v8->static_fields->MOnTouchReleaseEvent, v7, MOnTouchReleaseEvent);
...
int32_t __fastcall CTouch__getFlickDirX(const MethodInfo *method)
{
  ...
  if ( !byte_4A1A64A )
  {
    sub_1B715CC(&UnityEngine_Vector2_TypeInfo, v3);
    byte_4A1A64A = 1;
  }
  v8 = -1.0;
...
UnityEngine_Vector2_o __fastcall CTouch__getScreenPosition_46424052(
        ...
        const MethodInfo *method)
{
  ...
  float v6; // s0
  float v7; // s1
  UnityEngine_Vector2_o ScreenPosition_46424164; // kr00_8
  ...
  if ( (byte_4A2432A & 1) == 0 )
  {
    sub_1B715CC(&CTouch_TypeInfo, v2);
    byte_4A2432A = 1;
  }
  v5 = CTouch_TypeInfo;
  if ( !CTouch_TypeInfo->_2.cctor_finished )
  ...
  v9.fields.x = x;
  v9.fields.y = y;
  ScreenPosition_46424164 = CTouch__getScreenPosition_46424164(v9, v5->static_fields->mScreenCam, v2);
  v7 = ScreenPosition_46424164.fields.y;
  v6 = ScreenPosition_46424164.fields.x;
  result.fields.y = v7;
  result.fields.x = v6;
  return result;
}
...
// local variable allocation has failed, the output may be wrong!
UnityEngine_Vector2_o __fastcall CTouch__getScreenPosition_46424164(
        UnityEngine_Vector2_o tch_pos,
        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    v20.fields.x = x;
    v20.fields.y = y;
    UnityEngine_Camera__ScreenPointToRay_69064632(&v18, mScreenCam, v20, 0LL);
...
UnityEngine_Vector2_o __fastcall CTouch__getScreenPosition_46424556(
        UnityEngine_Camera_o *cam,
        const MethodInfo *method)
{
  CTouch_c *v2; // x0
  ...
  ScreenPosition_46424164 = CTouch__getScreenPosition_46424164(TouchPos, CTouch_TypeInfo->static_fields->mScreenCam, v3);
  y = ScreenPosition_46424164.fields.y;
  x = ScreenPosition_46424164.fields.x;
  result.fields.y = y;
  result.fields.x = x;
  return result;
}
...
bool __fastcall CTouch__isFlick(const MethodInfo *method)
{
  ...
  return CTouch__isFlick_46421380(v2->static_fields->FLICK_LEN, (const MethodInfo *)v2);
}


bool __fastcall CTouch__isFlick_46421380(float flickLen, const MethodInfo *method)
{
  __int64 v2; // x1
  CTouch_c *v4; // x0
  __int64 v5; // x1
...
void __fastcall CTouch__processSingleTouch(const MethodInfo *method)
{
  ...
  struct UnityEngine_Vector2_o ScreenPosition_46424052; // kr08_8
  CTouch_c *v13; // x0
  __int64 v14; // x8
...
LABEL_17:
    ...
    *(_QWORD *)((char *)v11[2].virtualMethodPointer + 68) = *(_QWORD *)((char *)v11[2].virtualMethodPointer + 52);
    ScreenPosition_46424052 = CTouch__getScreenPosition_46424052(
                                *(UnityEngine_Vector2_o *)((char *)v11[2].virtualMethodPointer + 32),
                                v11);
    v13 = CTouch_TypeInfo;
    CTouch_TypeInfo->static_fields->mScrPosNow = ScreenPosition_46424052;
...
LABEL_30:
      ...
      v20 = CTouch__getScreenPosition_46424052(v16->static_fields->mPosPush, touchCount);
      v21 = CTouch_TypeInfo;
      CTouch_TypeInfo->static_fields->mScrPosPush = v20;
      v21->static_fields->mScrPosOld = v21->static_fields->mScrPosNow;
      if ( !byte_4A1A64A )
      {
        sub_1B715CC(&UnityEngine_Vector2_TypeInfo, v19);
        v21 = CTouch_TypeInfo;
        byte_4A1A64A = 1;
      }
...
LABEL_83:
        ...
        if ( v41 )
        {
          ...
          if ( (v44->mDragFrameCnt & 0x80000000) != 0 )
          {
            ...
            if ( !byte_4A1A752 )
            {
              sub_1B715CC(&System_Math_TypeInfo, v42);
              byte_4A1A752 = 1;
            }
        ...
        if ( !byte_4A1A64A )
        {
          sub_1B715CC(&UnityEngine_Vector2_TypeInfo, v42);
          byte_4A1A64A = 1;
        }
        ...
        const MethodInfo *method)
{
  ...
  if ( static_fields->mIsInitDone )
  {
    ...
    sub_1B71570((ServantStatusBattleListViewItem_o *)&v11->mScreenCam, (int32_t)screenCam, v4, v5);
  }
}
...
void __fastcall CTouch__setScreenCamera(UnityEngine_Camera_o *cam, const MethodInfo *method)
{
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&static_fields->mScreenCam, (int32_t)cam, v2, v3);
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19BFD24;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19BFCE4;
}
