        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B338 & 1) == 0 )
  {
    dataVals = (DataVals_o *)sub_1BCAFF8(&System_Math_TypeInfo, *(_QWORD *)&kind);
    byte_4B1B338 = 1;
  }
  param = 0;
  ...
  {
    if ( !v6 )
      sub_1BCB254(dataVals, *(_QWORD *)&kind);
    ...
    else
    {
      ...
      if ( DataVals__TryGetParam(v6, 222, &param, 0LL) )
      {
        ...
        LODWORD(classStatisticsInfos) = System_Math__Min_63972800((int64_t)classStatisticsInfos, v10, 0LL);
      }
    }
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !classStatisticsInfos )
LABEL_11:
    sub_1BCB254(type, classStatisticsInfos);
  ...
  {
    if ( max_length == v5 )
      sub_1BCB25C(*(_QWORD *)&type, classStatisticsInfos, *(_QWORD *)&targetId);
        ...
        const MethodInfo *method)
{
  ...
  if ( v7 && param >= 1 )
  {
    ...
    if ( !System_Math_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
    v14 = System_Math__Min_63972800(v13, v12, 0LL);
    if ( v14 >= 1 )
    {
      v15 = v14;
      v16 = DataVals__GetParam(v6, 226, 0, 0LL);
      return BattleUtility__FloorToInt_45438932((double)v15 / (double)param * (double)v16, 0LL);
    }
    return 0;
  }
  return result;
