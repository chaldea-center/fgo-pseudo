        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB5B4B & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMasterData_SkillMaster___, title);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB5B4A & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMasterData_CommandCodeSkillReleaseMaster___, userId);
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_2EC55C8 *)Method_DataManager_GetMasterData_CommandCodeSkillReleaseMaster___)) == 0LL )
  {
