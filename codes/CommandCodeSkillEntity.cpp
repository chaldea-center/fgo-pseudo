        ...
        const MethodInfo *method)
{
  ...
  if ( Entity )
  {
    ...
    *title = EffectTitle;
    sub_1C93A78((GrandQuestFolderBoardItem_o *)title, (int32_t)EffectTitle, v20, v21, v22, v23, v24, v25);
  ...
  else
  {
    ...
    *title = unknownNameText;
    sub_1C93A78((GrandQuestFolderBoardItem_o *)title, (int32_t)unknownNameText, v12, v13, v14, v15, v16, v17);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D307CD & 1) == 0 )
  {
    sub_1C93AD4(&Method_DataManager_GetMasterData_CommandCodeSkillReleaseMaster___);
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_31A4A3C *)Method_DataManager_GetMasterData_CommandCodeSkillReleaseMaster___)) == 0 )
  {
