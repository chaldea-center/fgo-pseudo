        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1C2F9 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_SkillMaster___, title);
  ...
  if ( Entity )
  {
    ...
    *title = EffectTitle;
    sub_1BCAF9C((CGThumbnailListItem_o *)title, (int32_t)EffectTitle, v21, v22);
  ...
  else
  {
    ...
    *title = unknownNameText;
    sub_1BCAF9C((CGThumbnailListItem_o *)title, (int32_t)unknownNameText, v17, v18);
    *explanation = (System_String_o *)StringLiteral_1/*""*/;
    v26 = (int)StringLiteral_1/*""*/;
  }
  sub_1BCAF9C((CGThumbnailListItem_o *)explanation, v26, v24, v25);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1C2F8 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_CommandCodeSkillReleaseMaster___, userId);
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_301AAA4 *)Method_DataManager_GetMasterData_CommandCodeSkillReleaseMaster___)) == 0LL )
  {
