        ...
        const MethodInfo *method)
{
  ...
  if ( Entity )
  {
    ...
    *title = EffectTitle;
    sub_B77560((BattleServantConfConponent_o *)title, (System_Int32_array **)EffectTitle, v20, v21, v22, v23, v24, v25);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_438DF5D & 1) == 0 )
  {
    sub_B775C4(&Method_DataManager_GetMasterData_CommandCodeSkillReleaseMaster___);
  ...
  if ( !Instance
    || (Instance = (DataManager_o *)DataManager__GetMasterData_WarQuestSelectionMaster_(
                                      Instance,
                                      (const MethodInfo_1D183F0 *)Method_DataManager_GetMasterData_CommandCodeSkillReleaseMaster___)) == 0LL )
  {
