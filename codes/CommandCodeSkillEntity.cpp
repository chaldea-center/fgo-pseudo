        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B36F92 & 1) == 0 )
  {
    sub_1BD3458(&Method_DataManager_GetMasterData_SkillMaster___, title);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B36F91 & 1) == 0 )
  {
    sub_1BD3458(&Method_DataManager_GetMasterData_CommandCodeSkillReleaseMaster___, userId);
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_2F31684 *)Method_DataManager_GetMasterData_CommandCodeSkillReleaseMaster___)) == 0LL )
  {
