        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FC64 & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMasterData_SkillMaster___, title);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FC63 & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMasterData_CommandCodeSkillReleaseMaster___, userId);
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_2E8E21C *)Method_DataManager_GetMasterData_CommandCodeSkillReleaseMaster___)) == 0LL )
  {
