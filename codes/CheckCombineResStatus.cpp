    ...
    while ( 1 )
    {
      while ( 1 )
      {
        while ( 1 )
        {
          ...
          if ( HIDWORD(v32.fields._current[1].klass) == type )
          {
            ...
            if ( !klass )
              sub_1C22094(Time, v19);
            if ( Time <= (__int64)klass->_1.generic_class )
            {
              if ( !v14 )
                sub_1C22094(Time, v19);
              Data = EventCampaignMaster__getData((EventCampaignMaster_o *)v14, (int32_t)current[1].klass, 0LL);
              v23 = Data;
              if ( !Data )
                break;
              if ( !MasterData_object )
                sub_1C22094(Data, v22);
      ...
      if ( v26 && v26->_1.namespaze )
      {
        ...
        *(_QWORD *)&v34.fields.fakeValue = v27;
        v29 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47621364(v34, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDFEDC & 1) == 0 )
  {
    ...
    sub_1C21E38(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    this = (CheckCombineResStatus_o *)sub_1C21E38(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4BDFEDC = 1;
  }
  if ( !baseData )
    goto LABEL_22;
  ...
  *(_QWORD *)&v28.fields.fakeValue = v10;
  v12 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47621364(v28, 0LL);
  v13 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47621364(baseData->fields.limitCount, 0LL);
  this = (CheckCombineResStatus_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_388D058 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this )
    goto LABEL_22;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDFEDD & 1) == 0 )
  {
    this = (CheckCombineResStatus_o *)sub_1C21E38(&StringLiteral_1/*""*/);
    byte_4BDFEDD = 1;
  }
  idList = 0LL;
  skillNameList = 0LL;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDFEDE & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_System_Collections_Generic_List_ServantSkillEntity___ctor___77585744);
    sub_1C21E38(&Method_System_Collections_Generic_List_ServantSkillEntity__get_Count__);
    sub_1C21E38(&Method_System_Collections_Generic_List_ServantSkillEntity__get_Item__);
    sub_1C21E38(&System_Collections_Generic_List_ServantSkillEntity__TypeInfo);
    sub_1C21E38(&Method_CheckCombineResStatus___c__getSvtEqSkillByCombine_b__11_0__);
    sub_1C21E38(&CheckCombineResStatus___c_TypeInfo);
    this = (CheckCombineResStatus_o *)sub_1C21E38(&StringLiteral_1/*""*/);
    byte_4BDFEDE = 1;
  }
  if ( !baseData )
  ...
  UseSvtEqSkillInfo = (System_Collections_Generic_IEnumerable_T__o *)UserServantEntity__getUseSvtEqSkillInfo(
                                                                       ...
                                                                       limitCntSum,
                                                                       0LL);
  v10 = (System_Collections_Generic_List_object__o *)sub_1C22084(System_Collections_Generic_List_ServantSkillEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor_56945064(
    v10,
    UseSvtEqSkillInfo,
    (const MethodInfo_364E9A8 *)Method_System_Collections_Generic_List_ServantSkillEntity___ctor___77585744);
  if ( !v10 )
    goto LABEL_15;
  if ( v10->fields._size >= 1 )
  {
    ...
    if ( !_9__11_0 )
    {
      ...
      _9__11_0 = (System_Comparison_T__o *)sub_1C22084(System_Comparison_ServantSkillEntity__TypeInfo);
    ...
    this = (CheckCombineResStatus_o *)System_Collections_Generic_List_object___get_Item(
                                        v10,
                                        0,
                                        (const MethodInfo_364EDE4 *)Method_System_Collections_Generic_List_ServantSkillEntity__get_Item__);
    if ( this )
...
void __fastcall CheckCombineResStatus___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C22084(CheckCombineResStatus___c_TypeInfo);
