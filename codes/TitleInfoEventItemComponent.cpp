void __fastcall TitleInfoEventItemComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_42B4415 & 1) == 0 )
  {
    sub_B52984(&TitleInfoEventItemComponent_TypeInfo);
    sub_B52984(&StringLiteral_19774/*"img_shopbg06"*/);
    sub_B52984(&StringLiteral_19773/*"img_shopbg05"*/);
    sub_B52984(&StringLiteral_18661/*"event_item_title_"*/);
    byte_42B4415 = 1;
  }
  ...
  v8 = (System_Int32_array **)StringLiteral_18661/*"event_item_title_"*/;
  static_fields->TITLE_SP_ITEM_NAME_PREFIX = (struct System_String_o *)StringLiteral_18661/*"event_item_title_"*/;
  sub_B52920((BattleServantConfConponent_o *)&static_fields->TITLE_SP_ITEM_NAME_PREFIX, v8, v1, v2, v3, v4, v5, v6);
  v9 = TitleInfoEventItemComponent_TypeInfo->static_fields;
  v10 = (System_Int32_array **)StringLiteral_19773/*"img_shopbg05"*/;
  v9->EVENT_ITEM_VS_BASE_SP_NAME = (struct System_String_o *)StringLiteral_19773/*"img_shopbg05"*/;
  sub_B52920((BattleServantConfConponent_o *)&v9->EVENT_ITEM_VS_BASE_SP_NAME, v10, v11, v12, v13, v14, v15, v16);
  v17 = TitleInfoEventItemComponent_TypeInfo->static_fields;
  v18 = (System_Int32_array **)StringLiteral_19774/*"img_shopbg06"*/;
  v17->EVENT_GPOINT_VS_BASE_SP_NAME = (struct System_String_o *)StringLiteral_19774/*"img_shopbg06"*/;
  sub_B52920((BattleServantConfConponent_o *)&v17->EVENT_GPOINT_VS_BASE_SP_NAME, v18, v19, v20, v21, v22, v23, v24);
}
...
void __fastcall TitleInfoEventItemComponent__Destroy(TitleInfoEventItemComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B4413 & 1) == 0 )
  {
    this = (TitleInfoEventItemComponent_o *)sub_B52984(&UnityEngine_Object_TypeInfo);
    byte_42B4413 = 1;
  }
  klass = v8[1].klass;
    ...
    if ( (int)namespaze >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        *(void **)((char *)&v27->_1.image + v15) = 0LL;
        sub_B52920((BattleServantConfConponent_o *)((char *)v27 + v15), 0LL, v19, v20, v21, v22, v23, v24);
        if ( v14 - 3 >= v13 )
          goto LABEL_23;
        v9 = v10->klass;
        ++v14;
...
LABEL_23:
    v10->klass = 0LL;
    sub_B52920(v10, 0LL, v2, v3, v4, v5, v6, v7);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B4412 & 1) == 0 )
  {
    ...
    sub_B52984(&EventItemComponent___TypeInfo);
    sub_B52984(&Method_UnityEngine_GameObject_GetComponent_EventItemComponent___);
  ...
  if ( !mEventItemComponents )
    goto LABEL_103;
  v13 = (TitleInfoEventItemComponent_c *)sub_B5299C(EventItemComponent___TypeInfo, mEventItemComponents->max_length);
  this[1].klass = v13;
  v59 = this + 1;
  sub_B52920((BattleServantConfConponent_o *)&this[1], (System_Int32_array **)v13, v14, v15, v16, v17, v18, v19);
  ...
  if ( (v24 & 0x80000000) == 0 )
  {
    while ( 1 )
    {
      ...
      Instance = (__int64)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                            v27,
                            (const MethodInfo_1B7B1B8 *)Method_UnityEngine_GameObject_GetComponent_EventItemComponent___);
      if ( !disp_types )
        goto LABEL_103;
...
LABEL_64:
          GameObjectExtensions__SetLocalScale_32087216(v27, EVENT_ITEM_SCALE_VS, 0LL);
          klass = v59->klass;
          if ( !v59->klass )
            goto LABEL_103;
          if ( v29 )
          {
            Instance = sub_B52A44(v29, *((_QWORD *)klass->_1.image + 8));
            if ( !Instance )
            {
              v56 = sub_B52A7C(0LL);
              sub_B52A28(v56, 0LL);
...
LABEL_103:
  ...
  else
  {
    ...
    v48 = System_String__Concat_44568316(TITLE_SP_ITEM_NAME_PREFIX, v47, 0LL);
...
LABEL_97:
      ...
      GameObjectExtensions__SetLocalPosition_32085060(gameObject, 852.0, -26.0, 0LL);
    ...
    else
    {
      ...
      GameObjectExtensions__SetLocalPosition_32085060(v54, 865.0, -26.0, 0LL);
      v52 = *p_mItemObjParents;
      if ( !*p_mItemObjParents )
        goto LABEL_103;
      v53 = -1029701632;
