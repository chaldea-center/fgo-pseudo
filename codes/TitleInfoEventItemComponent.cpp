void TitleInfoEventItemComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4D2B0DB & 1) == 0 )
  {
    sub_1C94098(&TitleInfoEventItemComponent_TypeInfo);
    sub_1C94098(&StringLiteral_20752/*"img_shopbg06"*/);
    sub_1C94098(&StringLiteral_20751/*"img_shopbg05"*/);
    sub_1C94098(&StringLiteral_19358/*"event_item_title_"*/);
    byte_4D2B0DB = 1;
  }
  ...
  *(_QWORD *)&static_fields->EVENT_ITEM_SCALE_DEFAULT = 0x3F8000003F400000LL;
  v8 = StringLiteral_19358/*"event_item_title_"*/;
  static_fields->TITLE_SP_ITEM_NAME_PREFIX = (struct System_String_o *)StringLiteral_19358/*"event_item_title_"*/;
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&static_fields->TITLE_SP_ITEM_NAME_PREFIX, v8, v1, v2, v3, v4, v5, v6);
  v9 = StringLiteral_20751/*"img_shopbg05"*/;
  v10 = TitleInfoEventItemComponent_TypeInfo->static_fields;
  v10->EVENT_ITEM_VS_BASE_SP_NAME = (struct System_String_o *)StringLiteral_20751/*"img_shopbg05"*/;
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&v10->EVENT_ITEM_VS_BASE_SP_NAME, v9, v11, v12, v13, v14, v15, v16);
  v17 = StringLiteral_20752/*"img_shopbg06"*/;
  v18 = TitleInfoEventItemComponent_TypeInfo->static_fields;
  v18->EVENT_GPOINT_VS_BASE_SP_NAME = (struct System_String_o *)StringLiteral_20752/*"img_shopbg06"*/;
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&v18->EVENT_GPOINT_VS_BASE_SP_NAME, v17, v19, v20, v21, v22, v23, v24);
}
...
void TitleInfoEventItemComponent__Destroy(TitleInfoEventItemComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2B0D9 & 1) == 0 )
  {
    this = (TitleInfoEventItemComponent_o *)sub_1C94098(&UnityEngine_Object_TypeInfo);
    byte_4D2B0D9 = 1;
  }
  ...
  if ( mEventItemComponents )
  {
    if ( (int)v9->_1.namespaze >= 1 )
    {
      ...
      while ( v12 < LODWORD(v9->_1.namespaze) )
      {
        ...
        v25[4] = 0;
        sub_1C9403C((GrandQuestFolderBoardItem_o *)(v25 + 4), 0, v16, v17, v18, v19, v20, v21);
        if ( ++v12 == namespaze )
          goto LABEL_21;
...
LABEL_21:
    ...
    sub_1C9403C(p_mEventItemComponents, 0, v2, v3, v4, v5, v6, v7);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2B0D8 & 1) == 0 )
  {
    ...
    sub_1C94098(&EventItemComponent___TypeInfo);
    sub_1C94098(&Method_UnityEngine_GameObject_GetComponent_EventItemComponent___);
  ...
  if ( !mItemObjParents )
    goto LABEL_94;
  v14 = (struct EventItemComponent_array *)sub_1C94140(
  ...
  if ( (v25 & 0x80000000) == 0 )
  {
    while ( 1 )
    {
      ...
      GameObjectExtensions__SafeSetParent_36804604((UnityEngine_GameObject_o *)Instance, v28->m_Items[v26], 0);
      if ( !v29 )
        goto LABEL_94;
      Instance = (__int64)UnityEngine_GameObject__GetComponent_object_(
                            v29,
                            (const MethodInfo_31F4790 *)Method_UnityEngine_GameObject_GetComponent_EventItemComponent___);
      if ( !disp_types )
        goto LABEL_94;
...
LABEL_60:
          GameObjectExtensions__SetLocalScale_36800820(v29, *p_EVENT_ITEM_SCALE_VS, 0);
          v48 = *p_mEventItemComponents;
          if ( !*p_mEventItemComponents )
            goto LABEL_94;
          if ( v31 )
          {
            Instance = sub_1C941D4(v31, v48->obj.klass->_1.element_class);
            if ( !Instance )
            {
              v60 = sub_1C94314(0);
              sub_1C941C0(v60, 0);
          ...
          sub_1C9403C((GrandQuestFolderBoardItem_o *)(v49 + 4), (int32_t)v31, v42, v43, v44, v45, v46, v47);
          if ( (int)++v26 > v64 )
            goto LABEL_65;
          break;
        case 2:
...
LABEL_94:
  ...
  else
  {
    ...
    v54 = System_String__Concat_64417744(TITLE_SP_ITEM_NAME_PREFIX, v53, 0);
...
LABEL_95:
    ...
    if ( v55 == 4 )
    {
      ...
      GameObjectExtensions__SetLocalPosition_36798812(gameObject, 852.0, -26.0, 0);
      Instance = (__int64)this->fields.itemGrid;
      if ( !Instance )
        goto LABEL_94;
      v57 = -1025114112;
    ...
    else
    {
      ...
      GameObjectExtensions__SetLocalPosition_36798812(v56, 865.0, -26.0, 0);
      Instance = (__int64)this->fields.itemGrid;
      if ( !Instance )
        goto LABEL_94;
      v57 = -1029701632;
