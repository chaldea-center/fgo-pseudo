void __fastcall EventFactoryMaster___ctor(EventFactoryMaster_o *this, const MethodInfo *method)
{
  if ( (byte_49FE49B & 1) == 0 )
  {
    sub_1B64870(&Method_DataMasterBase_EventFactoryMaster__EventFactoryEntity__int___ctor__, method);
    byte_49FE49B = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    238,
    (const MethodInfo_30D6140 *)Method_DataMasterBase_EventFactoryMaster__EventFactoryEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE49C & 1) == 0 )
  {
    ...
    sub_1B64870(&EventFactoryEntity_TypeInfo, v6);
    sub_1B64870(&Method_System_Collections_Generic_List_EventFactoryEntity__Add__, v7);
    sub_1B64870(&Method_System_Collections_Generic_List_EventFactoryEntity__ToArray__, v8);
    sub_1B64870(&Method_System_Collections_Generic_List_EventFactoryEntity___ctor__, v9);
    sub_1B64870(&System_Collections_Generic_List_EventFactoryEntity__TypeInfo, v10);
    byte_49FE49C = 1;
  }
  v11 = (System_Collections_Generic_List_object__o *)sub_1B64ABC(System_Collections_Generic_List_EventFactoryEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v11,
    (const MethodInfo_34AF17C *)Method_System_Collections_Generic_List_EventFactoryEntity___ctor__);
...
LABEL_17:
  ...
  return (EventFactoryEntity_array *)System_Collections_Generic_List_object___ToArray(
                                       v11,
                                       (const MethodInfo_34B15A8 *)Method_System_Collections_Generic_List_EventFactoryEntity__ToArray__);
}