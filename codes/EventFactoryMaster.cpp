void __fastcall EventFactoryMaster___ctor(EventFactoryMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4AB5CE0 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataMasterBase_EventFactoryMaster__EventFactoryEntity__int___ctor__, method);
    byte_4AB5CE0 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    238,
    (const MethodInfo_3163D50 *)Method_DataMasterBase_EventFactoryMaster__EventFactoryEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB5CE1 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&EventFactoryEntity_TypeInfo, v6);
    sub_1BAB41C(&Method_System_Collections_Generic_List_EventFactoryEntity__Add__, v7);
    sub_1BAB41C(&Method_System_Collections_Generic_List_EventFactoryEntity__ToArray__, v8);
    sub_1BAB41C(&Method_System_Collections_Generic_List_EventFactoryEntity___ctor__, v9);
    sub_1BAB41C(&System_Collections_Generic_List_EventFactoryEntity__TypeInfo, v10);
    byte_4AB5CE1 = 1;
  }
  v11 = (System_Collections_Generic_List_object__o *)sub_1BAB668(System_Collections_Generic_List_EventFactoryEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v11,
    (const MethodInfo_354D088 *)Method_System_Collections_Generic_List_EventFactoryEntity___ctor__);
...
LABEL_17:
  ...
  return (EventFactoryEntity_array *)System_Collections_Generic_List_object___ToArray(
                                       v11,
                                       (const MethodInfo_354F414 *)Method_System_Collections_Generic_List_EventFactoryEntity__ToArray__);
}