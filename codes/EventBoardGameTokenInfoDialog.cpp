        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3D1B6 & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_EventBoardGameTokenInfoDialog_Close__);
    sub_1C37058(&Method_EventBoardGameTokenInfoDialog_EndClose__);
    byte_4C3D1B6 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_EventBoardGameTokenInfoDialog_Close__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1C37070(Method_EventBoardGameTokenInfoDialog_Close__);
...
void EventBoardGameTokenInfoDialog__Init(EventBoardGameTokenInfoDialog_o *this, const MethodInfo *method)
{
  ...
  sub_1C36FFC(&this->fields.eventAtlas, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3D1B5 & 1) == 0 )
  {
    sub_1C37058(&Method_UnityEngine_GameObject_GetComponentInChildren_EventBoardGameTokenItem___);
    sub_1C37058(&StringLiteral_24114/*"token_balloon"*/);
    byte_4C3D1B5 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( !gameObject
      ...
      || (UISprite__set_spriteName((UISprite_o *)gameObject, (System_String_o *)StringLiteral_24114/*"token_balloon"*/, 0), !item)
      ...
      || (gameObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponentInChildren_object_(
                                                     gameObject,
                                                     (const MethodInfo_313F43C *)Method_UnityEngine_GameObject_GetComponentInChildren_EventBoardGameTokenItem___)) == 0 )
    {
LABEL_12:
