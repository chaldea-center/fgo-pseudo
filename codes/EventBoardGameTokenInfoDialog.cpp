        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02762 & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_EventBoardGameTokenInfoDialog_Close__, v5);
    sub_1B64A00(&Method_EventBoardGameTokenInfoDialog_EndClose__, v6);
    byte_4A02762 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_EventBoardGameTokenInfoDialog_Close__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1B64A18(Method_EventBoardGameTokenInfoDialog_Close__);
...
void __fastcall EventBoardGameTokenInfoDialog__Init(EventBoardGameTokenInfoDialog_o *this, const MethodInfo *method)
{
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.eventAtlas, 0, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02761 & 1) == 0 )
  {
    sub_1B64A00(&Method_UnityEngine_GameObject_GetComponentInChildren_EventBoardGameTokenItem___, item);
    sub_1B64A00(&StringLiteral_23881/*"token_balloon"*/, v5);
    byte_4A02761 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( !gameObject
      ...
      || (gameObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponentInChildren_object_(
                                                     gameObject,
                                                     (const MethodInfo_2E8AA30 *)Method_UnityEngine_GameObject_GetComponentInChildren_EventBoardGameTokenItem___)) == 0LL )
    {
LABEL_12:
