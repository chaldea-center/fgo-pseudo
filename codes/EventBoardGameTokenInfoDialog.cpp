        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D268B7 & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_EventBoardGameTokenInfoDialog_Close__);
    sub_1C94098(&Method_EventBoardGameTokenInfoDialog_EndClose__);
    byte_4D268B7 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_EventBoardGameTokenInfoDialog_Close__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1C940B0(Method_EventBoardGameTokenInfoDialog_Close__);
...
void EventBoardGameTokenInfoDialog__Init(EventBoardGameTokenInfoDialog_o *this, const MethodInfo *method)
{
  ...
  sub_1C9403C(&this->fields.eventAtlas, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D268B6 & 1) == 0 )
  {
    sub_1C94098(&Method_UnityEngine_GameObject_GetComponentInChildren_EventBoardGameTokenItem___);
    sub_1C94098(&StringLiteral_24353/*"token_balloon"*/);
    byte_4D268B6 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( !gameObject
      ...
      || (UISprite__set_spriteName((UISprite_o *)gameObject, (System_String_o *)StringLiteral_24353/*"token_balloon"*/, 0), !item)
      ...
      || (gameObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponentInChildren_object_(
                                                     gameObject,
                                                     (const MethodInfo_31F49F4 *)Method_UnityEngine_GameObject_GetComponentInChildren_EventBoardGameTokenItem___)) == 0 )
    {
LABEL_12:
