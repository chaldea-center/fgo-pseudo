        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C214FD & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_EventBoardGameTokenInfoDialog_Close__);
    sub_1C2D490(&Method_EventBoardGameTokenInfoDialog_EndClose__);
    byte_4C214FD = 1;
  }
  ...
  if ( (*((_BYTE *)Method_EventBoardGameTokenInfoDialog_Close__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1C2D4A8(Method_EventBoardGameTokenInfoDialog_Close__);
...
void EventBoardGameTokenInfoDialog__Init(EventBoardGameTokenInfoDialog_o *this, const MethodInfo *method)
{
  ...
  sub_1C2D434(&this->fields.eventAtlas);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C214FC & 1) == 0 )
  {
    sub_1C2D490(&Method_UnityEngine_GameObject_GetComponentInChildren_EventBoardGameTokenItem___);
    sub_1C2D490(&StringLiteral_24092/*"token_balloon"*/);
    byte_4C214FC = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( !gameObject
      ...
      || (UISprite__set_spriteName((UISprite_o *)gameObject, (System_String_o *)StringLiteral_24092/*"token_balloon"*/, 0), !item)
      ...
      || (gameObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponentInChildren_object_(
                                                     gameObject,
                                                     (const MethodInfo_3126134 *)Method_UnityEngine_GameObject_GetComponentInChildren_EventBoardGameTokenItem___)) == 0 )
    {
LABEL_12:
