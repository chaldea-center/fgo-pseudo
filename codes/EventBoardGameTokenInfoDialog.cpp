        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB047E & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_EventBoardGameTokenInfoDialog_Close__);
    sub_1C6BA08(&Method_EventBoardGameTokenInfoDialog_EndClose__);
    byte_4CB047E = 1;
  }
  ...
  if ( (*((_BYTE *)Method_EventBoardGameTokenInfoDialog_Close__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1C6BA20(Method_EventBoardGameTokenInfoDialog_Close__);
...
void EventBoardGameTokenInfoDialog__Init(EventBoardGameTokenInfoDialog_o *this, const MethodInfo *method)
{
  ...
  sub_1C6B9AC(&this->fields.eventAtlas, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB047D & 1) == 0 )
  {
    sub_1C6BA08(&Method_UnityEngine_GameObject_GetComponentInChildren_EventBoardGameTokenItem___);
    sub_1C6BA08(&StringLiteral_24212/*"token_balloon"*/);
    byte_4CB047D = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( !gameObject
      ...
      || (UISprite__set_spriteName((UISprite_o *)gameObject, (System_String_o *)StringLiteral_24212/*"token_balloon"*/, 0), !item)
      ...
      || (gameObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponentInChildren_object_(
                                                     gameObject,
                                                     (const MethodInfo_3193390 *)Method_UnityEngine_GameObject_GetComponentInChildren_EventBoardGameTokenItem___)) == 0 )
    {
LABEL_12:
