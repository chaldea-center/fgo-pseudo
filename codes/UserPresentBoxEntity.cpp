        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C281C0 & 1) == 0 )
  {
    ...
    this = (UserPresentBoxEntity_o *)sub_1C2D490(&StringLiteral_25244/*"×"*/);
    byte_4C281C0 = 1;
  }
  if ( gType == 2 )
  {
  ...
  if ( !IsCountableWithPlus )
    v8 = &StringLiteral_25244/*"×"*/;
  v9 = (System_String_o *)*v8;
  v10 = System_Int32__ToString_64968716((int32_t)&v12, (System_String_o *)StringLiteral_9225/*"N0"*/, 0);
  return System_String__Concat_63457864(v9, v10, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  switch ( this->fields.giftType )
  {
    ...
    case 2:
      ...
      *nameText = v14;
      sub_1C2D434((CGThumbnailListItem_o *)nameText, (int32_t)v14, v12, v13);
    ...
    case 3:
      ...
      v21 = &StringLiteral_6514/*"FRIENDSHIP_NAME"*/;
      goto LABEL_18;
    case 4:
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v21 = &StringLiteral_14842/*"USER_EXP_NAME"*/;
LABEL_18:
    ...
    case 9:
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      Instance = LocalizationManager__Get((System_String_o *)StringLiteral_8704/*"MISSION_PEWARD_DETAIL_SVT_COSTUME"*/, 0);
      if ( !Entity )
        goto LABEL_47;
...
LABEL_41:
      ...
      Name = CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_48863712(v22, 0);
LABEL_44:
      *nameText = Name;
      sub_1C2D434((CGThumbnailListItem_o *)nameText, (int32_t)Name, v10, v11);
      giftType = this->fields.giftType;
      num = this->fields.num;
      v20 = 0;
LABEL_45:
...
LABEL_36:
  ...
  sub_1C2D434((CGThumbnailListItem_o *)countText, v30, v28, v29);
}
