void __fastcall ScriptFlagData___ctor(ScriptFlagData_o *this, System_String_o *name, const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)v4, (int32_t)name, v5, v6);
  v4->monitor = 0LL;
}


void __fastcall ScriptFlagData___ctor_41629808(
...
bool __fastcall ScriptFlagData__Comp_41629896(ScriptFlagData_o *this, const MethodInfo *method)
{
...
int64_t __fastcall ScriptFlagData__Conv(ScriptFlagData_o *this, System_String_o *vs, const MethodInfo *method)
{
  ...
  if ( (byte_4A5CD15 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_19377/*"false"*/);
    sub_1B885B0(&StringLiteral_24079/*"true"*/);
    byte_4A5CD15 = 1;
  }
  if ( System_String__op_Equality(vs, (System_String_o *)StringLiteral_24079/*"true"*/, 0LL)
    || System_String__op_Equality(vs, (System_String_o *)StringLiteral_22235/*"on"*/, 0LL) )
  {
    return 1LL;
  }
  if ( !vs )
    return 0LL;
  v5 = System_String__op_Equality(vs, (System_String_o *)StringLiteral_19377/*"false"*/, 0LL);
  result = 0LL;
  if ( !v5 )
  {
    v6 = System_String__op_Equality(vs, (System_String_o *)StringLiteral_22205/*"off"*/, 0LL);
    result = 0LL;
    if ( !v6 )
        ...
        const MethodInfo *method)
{
  ...
  v10 = UnityEngine_Random__Range_69419120(v7, v9 + 1, 0LL);
  if ( v9 < v10 )
    v10 = v9;
  this->fields.v = v10;
}
...
void __fastcall ScriptFlagData__Set_41629936(ScriptFlagData_o *this, int64_t v, const MethodInfo *method)
{
  this->fields.v = v;
}
