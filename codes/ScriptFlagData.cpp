void __fastcall ScriptFlagData___ctor(ScriptFlagData_o *this, System_String_o *name, const MethodInfo *method)
{
  ...
  sub_B77560((BattleServantConfConponent_o *)v4, (System_Int32_array **)name, v5, v6, v7, v8, v9, v10);
  v4->monitor = 0LL;
}


void __fastcall ScriptFlagData___ctor_34300184(
...
bool __fastcall ScriptFlagData__Comp_34300296(ScriptFlagData_o *this, const MethodInfo *method)
{
...
int64_t __fastcall ScriptFlagData__Conv(ScriptFlagData_o *this, System_String_o *vs, const MethodInfo *method)
{
  ...
  if ( (byte_438FBA8 & 1) == 0 )
  {
    sub_B775C4(&StringLiteral_21635/*"off"*/);
    sub_B775C4(&StringLiteral_21665/*"on"*/);
    sub_B775C4(&StringLiteral_19061/*"false"*/);
    sub_B775C4(&StringLiteral_23285/*"true"*/);
    byte_438FBA8 = 1;
  }
  if ( !vs )
    return 0LL;
  if ( System_String__op_Equality(vs, (System_String_o *)StringLiteral_23285/*"true"*/, 0LL)
    || System_String__op_Equality(vs, (System_String_o *)StringLiteral_21665/*"on"*/, 0LL) )
  {
    return 1LL;
  }
  v5 = System_String__op_Equality(vs, (System_String_o *)StringLiteral_19061/*"false"*/, 0LL);
  result = 0LL;
  if ( !v5 )
  {
    v6 = System_String__op_Equality(vs, (System_String_o *)StringLiteral_21635/*"off"*/, 0LL);
    result = 0LL;
    if ( !v6 )
        ...
        const MethodInfo *method)
{
  ...
  v10 = UnityEngine_Random__Range_36343764(v7, v9 + 1, 0LL);
  if ( v9 < v10 )
    v10 = v9;
  this->fields.v = v10;
}
...
void __fastcall ScriptFlagData__Set_34300348(ScriptFlagData_o *this, int64_t v, const MethodInfo *method)
{
  this->fields.v = v;
}
