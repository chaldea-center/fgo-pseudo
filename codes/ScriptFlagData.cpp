void __fastcall ScriptFlagData___ctor(ScriptFlagData_o *this, System_String_o *name, const MethodInfo *method)
{
  ...
  sub_1C21DDC(v4, (int64_t)name, v5, v6, v7, v8, v9, v10);
  v4->monitor = 0LL;
}


void __fastcall ScriptFlagData___ctor_42936028(
        ...
        const MethodInfo *method)
{
  ...
  sub_1C21DDC(v6, (int64_t)name, v7, v8, v9, v10, v11, v12);
  v6->monitor = (void *)v;
}
...
bool __fastcall ScriptFlagData__Comp_42936116(ScriptFlagData_o *this, const MethodInfo *method)
{
...
int64_t __fastcall ScriptFlagData__Conv(ScriptFlagData_o *this, System_String_o *vs, const MethodInfo *method)
{
  ...
  if ( (byte_4BDE1C1 & 1) == 0 )
  {
    sub_1C21E38(&StringLiteral_22612/*"off"*/);
    sub_1C21E38(&StringLiteral_22642/*"on"*/);
    sub_1C21E38(&StringLiteral_19711/*"false"*/);
    sub_1C21E38(&StringLiteral_24513/*"true"*/);
    byte_4BDE1C1 = 1;
  }
  if ( System_String__op_Equality(vs, (System_String_o *)StringLiteral_24513/*"true"*/, 0LL)
    || System_String__op_Equality(vs, (System_String_o *)StringLiteral_22642/*"on"*/, 0LL) )
  {
    return 1LL;
  }
  if ( !vs )
    return 0LL;
  v5 = System_String__op_Equality(vs, (System_String_o *)StringLiteral_19711/*"false"*/, 0LL);
  result = 0LL;
  if ( !v5 )
  {
    v6 = System_String__op_Equality(vs, (System_String_o *)StringLiteral_22612/*"off"*/, 0LL);
    result = 0LL;
    if ( !v6 )
        ...
        const MethodInfo *method)
{
  ...
  v10 = UnityEngine_Random__Range_70829352(v7, v9 + 1, 0LL);
  if ( v9 < v10 )
    v10 = v9;
  this->fields.v = v10;
}
...
void __fastcall ScriptFlagData__Set_42936156(ScriptFlagData_o *this, int64_t v, const MethodInfo *method)
{
  this->fields.v = v;
}
