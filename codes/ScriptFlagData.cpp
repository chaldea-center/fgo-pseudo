void __fastcall ScriptFlagData___ctor(ScriptFlagData_o *this, System_String_o *name, const MethodInfo *method)
{
  ...
  sub_B70630((BattleServantConfConponent_o *)v4, (System_Int32_array **)name, v5, v6, v7, v8, v9, v10);
  v4->monitor = 0LL;
}


void __fastcall ScriptFlagData___ctor_34151048(
...
bool __fastcall ScriptFlagData__Comp_34151160(ScriptFlagData_o *this, const MethodInfo *method)
{
...
int64_t __fastcall ScriptFlagData__Conv(ScriptFlagData_o *this, System_String_o *vs, const MethodInfo *method)
{
  ...
  if ( (byte_43565D5 & 1) == 0 )
  {
    sub_B70694(&StringLiteral_21538/*"off"*/);
    sub_B70694(&StringLiteral_21568/*"on"*/);
    sub_B70694(&StringLiteral_18973/*"false"*/);
    sub_B70694(&StringLiteral_23184/*"true"*/);
    byte_43565D5 = 1;
  }
  if ( !vs )
    return 0LL;
  if ( System_String__op_Equality(vs, (System_String_o *)StringLiteral_23184/*"true"*/, 0LL)
    || System_String__op_Equality(vs, (System_String_o *)StringLiteral_21568/*"on"*/, 0LL) )
  {
    return 1LL;
  }
  v5 = System_String__op_Equality(vs, (System_String_o *)StringLiteral_18973/*"false"*/, 0LL);
  result = 0LL;
  if ( !v5 )
  {
    v6 = System_String__op_Equality(vs, (System_String_o *)StringLiteral_21538/*"off"*/, 0LL);
    result = 0LL;
    if ( !v6 )
        ...
        const MethodInfo *method)
{
  ...
  v10 = UnityEngine_Random__Range_36100992(v7, v9 + 1, 0LL);
  if ( v9 < v10 )
    v10 = v9;
  this->fields.v = v10;
}
...
void __fastcall ScriptFlagData__Set_34151212(ScriptFlagData_o *this, int64_t v, const MethodInfo *method)
{
  this->fields.v = v;
}
