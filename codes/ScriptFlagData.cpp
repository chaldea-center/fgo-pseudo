void __fastcall ScriptFlagData___ctor(ScriptFlagData_o *this, System_String_o *name, const MethodInfo *method)
{
  ...
  sub_1C1AB78(v4, (int64_t)name, v5, v6, v7, v8, v9, v10);
  v4->monitor = 0LL;
}


void __fastcall ScriptFlagData___ctor_42882648(
        ...
        const MethodInfo *method)
{
  ...
  sub_1C1AB78(v6, (int64_t)name, v7, v8, v9, v10, v11, v12);
  v6->monitor = (void *)v;
}
...
bool __fastcall ScriptFlagData__Comp_42882736(ScriptFlagData_o *this, const MethodInfo *method)
{
...
int64_t __fastcall ScriptFlagData__Conv(ScriptFlagData_o *this, System_String_o *vs, const MethodInfo *method)
{
  ...
  if ( (byte_4BC9716 & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_22593/*"off"*/, vs);
    sub_1C1ABD4(&StringLiteral_22623/*"on"*/, v4);
    sub_1C1ABD4(&StringLiteral_19696/*"false"*/, v5);
    sub_1C1ABD4(&StringLiteral_24493/*"true"*/, v6);
    byte_4BC9716 = 1;
  }
  if ( System_String__op_Equality(vs, (System_String_o *)StringLiteral_24493/*"true"*/, 0LL)
    || System_String__op_Equality(vs, (System_String_o *)StringLiteral_22623/*"on"*/, 0LL) )
  {
    return 1LL;
  }
  if ( !vs )
    return 0LL;
  v8 = System_String__op_Equality(vs, (System_String_o *)StringLiteral_19696/*"false"*/, 0LL);
  result = 0LL;
  if ( !v8 )
  {
    v9 = System_String__op_Equality(vs, (System_String_o *)StringLiteral_22593/*"off"*/, 0LL);
    result = 0LL;
    if ( !v9 )
        ...
        const MethodInfo *method)
{
  ...
  v10 = UnityEngine_Random__Range_70754152(v7, v9 + 1, 0LL);
  if ( v9 < v10 )
    v10 = v9;
  this->fields.v = v10;
}
...
void __fastcall ScriptFlagData__Set_42882776(ScriptFlagData_o *this, int64_t v, const MethodInfo *method)
{
  this->fields.v = v;
}
