void __fastcall ClassBoardLineMaster___ctor(ClassBoardLineMaster_o *this, const MethodInfo *method)
{
  if ( (byte_49FE2A0 & 1) == 0 )
  {
    sub_1B64870(&Method_DataMasterBase_ClassBoardLineMaster__ClassBoardLineEntity__string___ctor__, method);
    byte_49FE2A0 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    427,
    (const MethodInfo_30D6498 *)Method_DataMasterBase_ClassBoardLineMaster__ClassBoardLineEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE29E & 1) == 0 )
  {
    sub_1B64870(&Method_System_Linq_Enumerable_ToArray_ClassBoardLineEntity___, *(_QWORD *)&baseId);
    byte_49FE29E = 1;
  }
  ...
  return (ClassBoardLineEntity_array *)System_Linq_Enumerable__ToArray_object_(
                                         ...
                                         (const MethodInfo_2E736A0 *)Method_System_Linq_Enumerable_ToArray_ClassBoardLineEntity___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE29F & 1) == 0 )
  {
    sub_1B64870(&Method_DataMasterBase_getEntitys_ClassBoardLineEntity___, *(_QWORD *)&baseId);
    sub_1B64870(&Method_System_Linq_Enumerable_Where_ClassBoardLineEntity___, v5);
    sub_1B64870(&System_Func_ClassBoardLineEntity__bool__TypeInfo, v6);
    sub_1B64870(&Method_ClassBoardLineMaster___c__DisplayClass1_0__GetAllEntityEnumerable_b__0__, v7);
    sub_1B64870(&ClassBoardLineMaster___c__DisplayClass1_0_TypeInfo, v8);
    byte_49FE29F = 1;
  }
  v9 = sub_1B64ABC(ClassBoardLineMaster___c__DisplayClass1_0_TypeInfo);
  ...
  *(_DWORD *)(v9 + 16) = baseId;
  Entitys_object = (System_Collections_Generic_IEnumerable_TSource__o *)DataMasterBase__getEntitys_object_(
                                                                          ...
                                                                          (const MethodInfo_2E3BF5C *)Method_DataMasterBase_getEntitys_ClassBoardLineEntity___);
  v13 = (System_Func_object__bool__o *)sub_1B64ABC(System_Func_ClassBoardLineEntity__bool__TypeInfo);
  ...
  return (System_Collections_Generic_IEnumerable_ClassBoardLineEntity__o *)System_Linq_Enumerable__Where_object_(
                                                                             ...
                                                                             (const MethodInfo_2E79378 *)Method_System_Linq_Enumerable_Where_ClassBoardLineEntity___);
}
        ...
        const MethodInfo *method)
{
  ...
  return (ClassBoardLineEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                     (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                     PK,
                                     (const MethodInfo_30D64D8 *)Method_DataMasterBase_ClassBoardLineMaster__ClassBoardLineEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE2A2 & 1) == 0 )
  {
    sub_1B64870(&Method_DataMasterBase_ClassBoardLineMaster__ClassBoardLineEntity__string__TryGetEntity__, entity);
    byte_49FE2A2 = 1;
  }
  PK = (Il2CppObject *)ClassBoardLineEntity__CreatePK(classBoardBaseId, id, 0LL);
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_30D6528 *)Method_DataMasterBase_ClassBoardLineMaster__ClassBoardLineEntity__string__TryGetEntity__);
}
