        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A49629 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_UnityEngine_Component_GetComponent_UITouchPress___, v5);
...
UIButton_o *__fastcall GameOptionToggleButton__get_Button(GameOptionToggleButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A49627 & 1) == 0 )
  {
    sub_1B863B8(&Method_UnityEngine_Component_GetComponent_UIButton___, method);
  ...
  if ( UnityEngine_Object__op_Equality(button, 0LL, 0LL) )
  {
    ...
    sub_1B8635C((CGThumbnailListItem_o *)&this->fields.button, (int32_t)Component_object, v6, v7);
  }
...
UILabel_o *__fastcall GameOptionToggleButton__get_Label(GameOptionToggleButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A49626 & 1) == 0 )
  {
    sub_1B863B8(&Method_UnityEngine_Component_GetComponentInChildren_UILabel___, method);
    sub_1B863B8(&UnityEngine_Object_TypeInfo, v3);
    byte_4A49626 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Equality(defaultLabel, 0LL, 0LL) )
  {
    ...
    this->fields.defaultLabel = (struct UILabel_o *)ComponentInChildren_object__49695012;
    sub_1B8635C(
