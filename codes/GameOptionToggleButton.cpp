        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DE15B & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_UnityEngine_Component_GetComponent_UITouchPress___, v5);
...
UIButton_o *__fastcall GameOptionToggleButton__get_Button(GameOptionToggleButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48DE159 & 1) == 0 )
  {
    sub_1B00CCC(&Method_UnityEngine_Component_GetComponent_UIButton___, method);
  ...
  if ( UnityEngine_Object__op_Equality(button, 0LL, 0LL) )
  {
    ...
    sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.button, (int32_t)Component_object, v6, v7);
  }
...
UILabel_o *__fastcall GameOptionToggleButton__get_Label(GameOptionToggleButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48DE158 & 1) == 0 )
  {
    sub_1B00CCC(&Method_UnityEngine_Component_GetComponentInChildren_UILabel___, method);
    sub_1B00CCC(&UnityEngine_Object_TypeInfo, v3);
    byte_48DE158 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Equality(defaultLabel, 0LL, 0LL) )
  {
    ...
    this->fields.defaultLabel = (struct UILabel_o *)ComponentInChildren_object__47552792;
    sub_1B00C70(
      (ServantStatusBattleListViewItem_o *)&this->fields.defaultLabel,
