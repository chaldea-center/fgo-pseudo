...
void __fastcall MaterialCostumeMenu__Close(MaterialCostumeMenu_o *this, const MethodInfo *method)
{
  ...
  MaterialCostumeMenu__Close_32132260(this, 0LL, v2);
}


void __fastcall MaterialCostumeMenu__Close_32132260(
...
void __fastcall MaterialCostumeMenu__EndCloseShowCostume(MaterialCostumeMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD7A13 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_MaterialCostumeMenu_OnSelectCostume__);
    byte_4BD7A13 = 1;
  }
  ...
  if ( !materialCostumeServantListViewManager
    || (MaterialCostumeServantListViewManager__RequestListObject_32142592(materialCostumeServantListViewManager, 4, v2),
        v5 = this->fields.materialCostumeServantListViewManager,
        v6 = (MaterialCostumeServantListViewManager_CallbackFunc_o *)sub_1C22084(MaterialCostumeServantListViewManager_CallbackFunc_TypeInfo),
        ...
        !v5) )
  {
    sub_1C22094(materialCostumeServantListViewManager, method);
  }
  v5->fields.callbackFunc = v6;
  sub_1C21DDC(&v5->fields.callbackFunc, v6);
  MaterialCostumeServantListViewManager__SetMode_32134032(v5, 2, v8);
}
...
void __fastcall MaterialCostumeMenu__EndOpen(MaterialCostumeMenu_o *this, const MethodInfo *method)
{
  ...
  this->fields.state = 2;
  materialCostumeServantListViewManager = this->fields.materialCostumeServantListViewManager;
  v4 = (MaterialCostumeServantListViewManager_CallbackFunc_o *)sub_1C22084(MaterialCostumeServantListViewManager_CallbackFunc_TypeInfo);
  MaterialCostumeServantListViewManager_CallbackFunc___ctor(
    v4,
    (Il2CppObject *)this,
    Method_MaterialCostumeMenu_OnSelectCostume__,
  ...
  sub_1C21DDC(&materialCostumeServantListViewManager->fields.callbackFunc, v4);
  MaterialCostumeServantListViewManager__SetMode_32134032(materialCostumeServantListViewManager, 2, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD7A12 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_MaterialCostumeMenu_EndCloseShowCostume__);
    sub_1C21E38(&Method_MaterialCostumeMenu_EndShowCostume__);
    byte_4BD7A12 = 1;
  }
  v4 = Method_MaterialCostumeMenu_EndShowCostume__;
  if ( (*((_BYTE *)Method_MaterialCostumeMenu_EndShowCostume__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1C21E50(Method_MaterialCostumeMenu_EndShowCostume__);
  ...
  if ( !itemDetailInfoComp )
    sub_1C22094(v8, v9);
  ItemDetailInfoComponent__Close_32046984(itemDetailInfoComp, v7, 0LL);
}
...
void __fastcall MaterialCostumeMenu__OnClickCancel(MaterialCostumeMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD7A10 & 1) == 0 )
  {
    sub_1C21E38(&Method_MaterialCostumeMenu_OnClickCancel__);
    byte_4BD7A10 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_MaterialCostumeMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_MaterialCostumeMenu_OnClickCancel__);
...
void __fastcall MaterialCostumeMenu__OnClickDecide(MaterialCostumeMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD7A0F & 1) == 0 )
  {
    sub_1C21E38(&Method_MaterialCostumeMenu_OnClickDecide__);
    byte_4BD7A0F = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_MaterialCostumeMenu_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_MaterialCostumeMenu_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C21E1C(v3, v3[4]);
...
void __fastcall MaterialCostumeMenu__OnClickScaleChange(MaterialCostumeMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD7A14 & 1) == 0 )
  {
    sub_1C21E38(&Method_MaterialCostumeMenu_OnClickScaleChange__);
    byte_4BD7A14 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_MaterialCostumeMenu_OnClickScaleChange__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_MaterialCostumeMenu_OnClickScaleChange__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C21E1C(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
    materialCostumeServantListViewManager = this->fields.materialCostumeServantListViewManager;
    if ( !materialCostumeServantListViewManager )
        ...
        const MethodInfo *method)
{
  ...
  if ( kind == 1 && this->fields.state == 2 )
  {
    ...
    if ( (unsigned int)(LODWORD(materialCostumeServantListViewManager->fields.dropList) - 1) <= 1 )
    {
      ...
      if ( clipRange )
      {
        v11 = *(System_String_o **)(*(_QWORD *)&clipRange + 32LL);
        v12 = *(System_String_o **)(*(_QWORD *)&clipRange + 48LL);
        itemDetailInfoComp = this->fields.itemDetailInfoComp;
        v14 = (ItemDetailInfoComponent_CallbackFunc_o *)sub_1C22084(ItemDetailInfoComponent_CallbackFunc_TypeInfo);
        ...
        if ( itemDetailInfoComp )
        {
          ItemDetailInfoComponent__OpenItemMsgInfo(itemDetailInfoComp, v11, v12, v14, 0LL);
          return;
        }
      }
LABEL_12:
      sub_1C22094(materialCostumeServantListViewManager, *(_QWORD *)&kind);
    }
  }
}
...
void __fastcall MaterialCostumeMenu__OnStartClose(MaterialCostumeMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C21E38(&System_Action_TypeInfo);
    sub_1C21E38(&Method_MaterialCostumeMenu_EndClose__);
    byte_4BD7A0E = 1;
  }
...
void __fastcall MaterialCostumeMenu__OnStartOpen(MaterialCostumeMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C21E38(&System_Action_TypeInfo);
    sub_1C21E38(&Method_MaterialCostumeMenu_EndOpen__);
    byte_4BD7A0B = 1;
  }
  v3 = (System_Action_o *)sub_1C22084(System_Action_TypeInfo);
...
LABEL_10:
    ...
    MaterialCostumeServantListViewManager__SetMode_32134032(
      (MaterialCostumeServantListViewManager_o *)gameObject,
      1,
      v11);
    UnityEngine_MonoBehaviour__Invoke(
        ...
        const MethodInfo *method)
{
  ...
  v11 = (MaterialCostumeMenu_o *)sub_1C22354(v8);
        ...
        const MethodInfo *method)
{
  ...
  v11 = (MaterialCostumeServantListViewManager_o *)sub_1C22354(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A5C364;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A5C324;
}
