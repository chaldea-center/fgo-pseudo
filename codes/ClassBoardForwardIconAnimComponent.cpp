        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0C025 & 1) == 0 )
  {
    sub_1B686D4(&StringLiteral_20204/*"img_class_{0}"*/, method);
    sub_1B686D4(&StringLiteral_17437/*"btn_class"*/, v5);
    byte_4A0C025 = 1;
  }
  v6 = StringLiteral_20204/*"img_class_{0}"*/;
  this->fields.spriteNameFormatIcon = (struct System_String_o *)StringLiteral_20204/*"img_class_{0}"*/;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.spriteNameFormatIcon, v6, v2, v3);
  v7 = StringLiteral_17437/*"btn_class"*/;
  this->fields.spriteNameButton = (struct System_String_o *)StringLiteral_17437/*"btn_class"*/;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.spriteNameButton, v7, v8, v9);
...
LABEL_12:
  ...
  {
LABEL_20:
    v28 = sub_1BBA6B4(resourceCatalog, IClassBoardResourceCatalog_TypeInfo, 0LL);
  }
