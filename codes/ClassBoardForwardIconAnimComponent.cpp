        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B482C9 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_20360/*"img_class_{0}"*/, method);
    sub_1BDB878(&StringLiteral_17487/*"btn_class"*/, v5);
    byte_4B482C9 = 1;
  }
  v6 = StringLiteral_20360/*"img_class_{0}"*/;
  this->fields.spriteNameFormatIcon = (struct System_String_o *)StringLiteral_20360/*"img_class_{0}"*/;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.spriteNameFormatIcon, v6, v2, v3);
  v7 = StringLiteral_17487/*"btn_class"*/;
  this->fields.spriteNameButton = (struct System_String_o *)StringLiteral_17487/*"btn_class"*/;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.spriteNameButton, v7, v8, v9);
...
LABEL_12:
  ...
  {
LABEL_20:
    v28 = sub_1C2C00C(resourceCatalog, IClassBoardResourceCatalog_TypeInfo, 0LL);
  }
