        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A51C19 & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_20065/*"img_class_{0}"*/, method);
    sub_1B863B8(&StringLiteral_17260/*"btn_class"*/, v5);
    byte_4A51C19 = 1;
  }
  v6 = StringLiteral_20065/*"img_class_{0}"*/;
  this->fields.spriteNameFormatIcon = (struct System_String_o *)StringLiteral_20065/*"img_class_{0}"*/;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.spriteNameFormatIcon, v6, v2, v3);
  v7 = StringLiteral_17260/*"btn_class"*/;
  this->fields.spriteNameButton = (struct System_String_o *)StringLiteral_17260/*"btn_class"*/;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.spriteNameButton, v7, v8, v9);
...
LABEL_12:
  ...
  revision = v14->fields.revision;
  v24 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &revision, v18, v19, v20);
  ...
  {
LABEL_20:
    v28 = sub_1BD6B4C(resourceCatalog, IClassBoardResourceCatalog_TypeInfo, 0LL);
  }
