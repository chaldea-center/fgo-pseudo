        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42E7D1C & 1) == 0 )
  {
    sub_B5D5C4(&StringLiteral_21449/*"num"*/, itemId, num, *(_QWORD *)&eventId);
    sub_B5D5C4(&StringLiteral_18701/*"eventId"*/, v9, v10, v11);
    sub_B5D5C4(&StringLiteral_23286/*"useItemId"*/, v12, v13, v14);
    byte_42E7D1C = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18701/*"eventId"*/, eventId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23286/*"useItemId"*/, itemId, 0LL);
...
System_String_o *__fastcall ItemUseRequest__getURL(ItemUseRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42E7D1B & 1) == 0 )
  {
    ...
    sub_B5D5C4(&StringLiteral_20267/*"item/use"*/, v4, v5, v6);
    byte_42E7D1B = 1;
  }
  ...
  return System_String__Concat_44577788(BaseUrl, (System_String_o *)StringLiteral_20267/*"item/use"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v12 = ResponseCommandKind__SearchData(44, responseList, 0LL);
  if ( v12 && (v13 = v12, ResponseData__checkError_29500464(v12, 0LL)) )
  {
    ...
    v16 = JsonManager__toJson(success, 0, 0, v14);
  }
  else
  {
    v16 = (System_String_o *)StringLiteral_21345/*"ng"*/;
  }
