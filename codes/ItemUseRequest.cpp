        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4FF2F & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_22017/*"num"*/, *(_QWORD *)&itemId);
    sub_1B863B8(&StringLiteral_18908/*"eventId"*/, v9);
    sub_1B863B8(&StringLiteral_24191/*"useItemId"*/, v10);
    byte_4A4FF2F = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18908/*"eventId"*/, eventId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_24191/*"useItemId"*/, itemId, 0LL);
...
System_String_o *__fastcall ItemUseRequest__getURL(ItemUseRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4FF2E & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_20699/*"item/use"*/, v2);
    byte_4A4FF2E = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61645176(BaseUrl, (System_String_o *)StringLiteral_20699/*"item/use"*/, 0LL);
}
