        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17B10 & 1) == 0 )
  {
    sub_1BCA7E0(&StringLiteral_22418/*"num"*/, *(_QWORD *)&itemId, *(_QWORD *)&num);
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_24610/*"useItemId"*/, itemId, v13);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22418/*"num"*/, num, v14);
...
System_String_o *__fastcall ItemUseRequest__getURL(ItemUseRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B17B0F & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&StringLiteral_21107/*"item/use"*/, v3, v4);
    byte_4B17B0F = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62401220(BaseUrl, (System_String_o *)StringLiteral_21107/*"item/use"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v9 = ResponseCommandKind__SearchData(44, responseList, 0LL);
