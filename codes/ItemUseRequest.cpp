...
System_String_o *__fastcall ItemUseRequest__getURL(ItemUseRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42AF194 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_20164/*"item/use"*/);
    byte_42AF194 = 1;
  }
  ...
  return System_String__Concat_44568316(BaseUrl, (System_String_o *)StringLiteral_20164/*"item/use"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    v9 = (System_String_o *)StringLiteral_21239/*"ng"*/;
  }
