        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FC20A & 1) == 0 )
  {
    sub_B16FFC(&StringLiteral_21083/*"num"*/, *(_QWORD *)&itemId);
    sub_B16FFC(&StringLiteral_18403/*"eventId"*/, v9);
    sub_B16FFC(&StringLiteral_22888/*"useItemId"*/, v10);
    byte_40FC20A = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18403/*"eventId"*/, eventId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22888/*"useItemId"*/, itemId, 0LL);
...
System_String_o *__fastcall ItemUseRequest__getURL(ItemUseRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_40FC209 & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_19931/*"item/use"*/, v2);
    byte_40FC209 = 1;
  }
  ...
  return System_String__Concat_43743732(BaseUrl, (System_String_o *)StringLiteral_19931/*"item/use"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    v11 = (System_String_o *)StringLiteral_20980/*"ng"*/;
  }
