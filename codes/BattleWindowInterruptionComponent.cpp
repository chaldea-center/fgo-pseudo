        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D3427F & 1) == 0 )
  {
    sub_1C93AD4(&Method_BattleWindowInterruptionComponent_OnClickCancel__);
    byte_4D3427F = 1;
  }
  if ( BattleWindowComponent__isOpen((BattleWindowComponent_o *)this, 0) )
  {
    ...
    if ( (*((_BYTE *)Method_BattleWindowInterruptionComponent_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C93AEC(Method_BattleWindowInterruptionComponent_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D34282 & 1) == 0 )
  {
    sub_1C93AD4(&Method_BattleWindowInterruptionComponent_OnClickInterruption__);
    byte_4D34282 = 1;
  }
  if ( BattleWindowComponent__isOpen((BattleWindowComponent_o *)this, 0) )
  {
    ...
    if ( (*((_BYTE *)Method_BattleWindowInterruptionComponent_OnClickInterruption__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C93AEC(Method_BattleWindowInterruptionComponent_OnClickInterruption__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C93AB8(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D34281 & 1) == 0 )
  {
    sub_1C93AD4(&Method_BattleWindowInterruptionComponent_OnClickSelectWaveRestart__);
    byte_4D34281 = 1;
  }
  if ( BattleWindowComponent__isOpen((BattleWindowComponent_o *)this, 0) )
  {
    ...
    if ( (*((_BYTE *)Method_BattleWindowInterruptionComponent_OnClickSelectWaveRestart__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C93AEC(Method_BattleWindowInterruptionComponent_OnClickSelectWaveRestart__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C93AB8(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D34280 & 1) == 0 )
  {
    sub_1C93AD4(&Method_BattleWindowInterruptionComponent_OnClickWaveRestart__);
    byte_4D34280 = 1;
  }
  if ( BattleWindowComponent__isOpen((BattleWindowComponent_o *)this, 0) && this->fields.canWaveRestart )
  {
    ...
    if ( (*((_BYTE *)Method_BattleWindowInterruptionComponent_OnClickWaveRestart__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C93AEC(Method_BattleWindowInterruptionComponent_OnClickWaveRestart__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C93AB8(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D3427E & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_2790/*"BATTLE_INTERRUPTION_WINDOW_CANCEL_BUTTON"*/);
    sub_1C93AD4(&StringLiteral_2796/*"BATTLE_INTERRUPTION_WINDOW_SELECT_WAVE_RESTART"*/);
    ...
    sub_1C93AD4(&StringLiteral_2793/*"BATTLE_INTERRUPTION_WINDOW_CURRENT_WAVE_RESTART"*/);
    sub_1C93AD4(&StringLiteral_415/*"#808080"*/);
    sub_1C93AD4(&StringLiteral_1/*""*/);
    sub_1C93AD4(&StringLiteral_2797/*"BATTLE_INTERRUPTION_WINDOW_TITLE"*/);
    sub_1C93AD4(&StringLiteral_2795/*"BATTLE_INTERRUPTION_WINDOW_MESSAGE"*/);
    byte_4D3427E = 1;
  }
  v33 = 0u;
  ...
  cancelButton = LocalizationManager__Get((System_String_o *)StringLiteral_2797/*"BATTLE_INTERRUPTION_WINDOW_TITLE"*/, 0);
  if ( !title )
    goto LABEL_27;
  UILabel__set_text(title, cancelButton, 0);
  message = this->fields.message;
  cancelButton = LocalizationManager__Get((System_String_o *)StringLiteral_2795/*"BATTLE_INTERRUPTION_WINDOW_MESSAGE"*/, 0);
  if ( !message )
    goto LABEL_27;
  UILabel__set_text(message, cancelButton, 0);
  cancelButtonLabel = this->fields.cancelButtonLabel;
  cancelButton = LocalizationManager__Get((System_String_o *)StringLiteral_2790/*"BATTLE_INTERRUPTION_WINDOW_CANCEL_BUTTON"*/, 0);
  ...
  cancelButton = LocalizationManager__Get((System_String_o *)StringLiteral_2793/*"BATTLE_INTERRUPTION_WINDOW_CURRENT_WAVE_RESTART"*/, 0);
  ...
  cancelButton = LocalizationManager__Get((System_String_o *)StringLiteral_2812/*"BATTLE_MENU_WAVE_RESTART_EXPLANATION_LABEL"*/, 0);
  ...
  *(_OWORD *)&cancelButton[2].klass = v33;
  ...
  cancelButton = LocalizationManager__Get((System_String_o *)StringLiteral_2796/*"BATTLE_INTERRUPTION_WINDOW_SELECT_WAVE_RESTART"*/, 0);
  ...
  cancelButton = LocalizationManager__Get((System_String_o *)StringLiteral_2794/*"BATTLE_INTERRUPTION_WINDOW_INTERRUPTION_BUTTON"*/, 0);
  ...
  if ( !cancelButton )
    goto LABEL_27;
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)cancelButton, !isFromBattleMenu, 0);
  v30 = (struct System_String_o **)(isFromBattleMenu ? &StringLiteral_15741/*"Window/CancelButton"*/ : &StringLiteral_1/*""*/);
  v31 = *v30;
  this->fields.closeButtonPath = *v30;
  p_closeButtonPath = &this->fields.closeButtonPath;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)p_closeButtonPath, (int32_t)v31, v24, v25, v26, v27, v28, v29);
  cancelButton = *(p_closeButtonPath - 5);
  if ( !cancelButton )
LABEL_27:
    sub_1C93D2C(cancelButton, v17);
