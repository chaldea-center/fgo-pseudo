        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E08300 & 1) == 0 )
  {
    sub_1CE6700(&Method_BattleWindowInterruptionComponent_OnClickCancel__);
    byte_4E08300 = 1;
  }
  if ( BattleWindowComponent__isOpen((BattleWindowComponent_o *)this, 0) )
  {
    ...
    if ( (*((_BYTE *)Method_BattleWindowInterruptionComponent_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_BattleWindowInterruptionComponent_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E08303 & 1) == 0 )
  {
    sub_1CE6700(&Method_BattleWindowInterruptionComponent_OnClickInterruption__);
    byte_4E08303 = 1;
  }
  if ( BattleWindowComponent__isOpen((BattleWindowComponent_o *)this, 0) )
  {
    ...
    if ( (*((_BYTE *)Method_BattleWindowInterruptionComponent_OnClickInterruption__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_BattleWindowInterruptionComponent_OnClickInterruption__);
    v4 = (System_Reflection_MethodBase_o *)sub_1CE66E4(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E08302 & 1) == 0 )
  {
    sub_1CE6700(&Method_BattleWindowInterruptionComponent_OnClickSelectWaveRestart__);
    byte_4E08302 = 1;
  }
  if ( BattleWindowComponent__isOpen((BattleWindowComponent_o *)this, 0) )
  {
    ...
    if ( (*((_BYTE *)Method_BattleWindowInterruptionComponent_OnClickSelectWaveRestart__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_BattleWindowInterruptionComponent_OnClickSelectWaveRestart__);
    v4 = (System_Reflection_MethodBase_o *)sub_1CE66E4(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E08301 & 1) == 0 )
  {
    sub_1CE6700(&Method_BattleWindowInterruptionComponent_OnClickWaveRestart__);
    byte_4E08301 = 1;
  }
  if ( BattleWindowComponent__isOpen((BattleWindowComponent_o *)this, 0) && this->fields.canWaveRestart )
  {
    ...
    if ( (*((_BYTE *)Method_BattleWindowInterruptionComponent_OnClickWaveRestart__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_BattleWindowInterruptionComponent_OnClickWaveRestart__);
    v4 = (System_Reflection_MethodBase_o *)sub_1CE66E4(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E082FF & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_2799/*"BATTLE_INTERRUPTION_WINDOW_INTERRUPTION_BUTTON"*/);
    sub_1CE6700(&StringLiteral_2795/*"BATTLE_INTERRUPTION_WINDOW_CANCEL_BUTTON"*/);
    sub_1CE6700(&StringLiteral_2801/*"BATTLE_INTERRUPTION_WINDOW_SELECT_WAVE_RESTART"*/);
    sub_1CE6700(&StringLiteral_2817/*"BATTLE_MENU_WAVE_RESTART_EXPLANATION_LABEL"*/);
    sub_1CE6700(&StringLiteral_15791/*"Window/CancelButton"*/);
    sub_1CE6700(&StringLiteral_2798/*"BATTLE_INTERRUPTION_WINDOW_CURRENT_WAVE_RESTART"*/);
    sub_1CE6700(&StringLiteral_415/*"#808080"*/);
    sub_1CE6700(&StringLiteral_1/*""*/);
    sub_1CE6700(&StringLiteral_2802/*"BATTLE_INTERRUPTION_WINDOW_TITLE"*/);
    sub_1CE6700(&StringLiteral_2800/*"BATTLE_INTERRUPTION_WINDOW_MESSAGE"*/);
    byte_4E082FF = 1;
  }
  v33 = 0u;
  ...
  cancelButton = LocalizationManager__Get((System_String_o *)StringLiteral_2802/*"BATTLE_INTERRUPTION_WINDOW_TITLE"*/, 0);
  if ( !title )
    goto LABEL_27;
  UILabel__set_text(title, cancelButton, 0);
  message = this->fields.message;
  cancelButton = LocalizationManager__Get((System_String_o *)StringLiteral_2800/*"BATTLE_INTERRUPTION_WINDOW_MESSAGE"*/, 0);
  if ( !message )
    goto LABEL_27;
  UILabel__set_text(message, cancelButton, 0);
  cancelButtonLabel = this->fields.cancelButtonLabel;
  cancelButton = LocalizationManager__Get((System_String_o *)StringLiteral_2795/*"BATTLE_INTERRUPTION_WINDOW_CANCEL_BUTTON"*/, 0);
  ...
  cancelButton = LocalizationManager__Get((System_String_o *)StringLiteral_2798/*"BATTLE_INTERRUPTION_WINDOW_CURRENT_WAVE_RESTART"*/, 0);
  ...
  cancelButton = LocalizationManager__Get((System_String_o *)StringLiteral_2817/*"BATTLE_MENU_WAVE_RESTART_EXPLANATION_LABEL"*/, 0);
  if ( !waveRestartExplanationLabel )
    goto LABEL_27;
  UILabel__set_text(waveRestartExplanationLabel, cancelButton, 0);
  UnityEngine_ColorUtility__TryParseHtmlString((System_String_o *)StringLiteral_415/*"#808080"*/, (UnityEngine_Color_o *)&v33, 0);
  ...
  *(_OWORD *)&cancelButton[2].klass = v33;
  ...
  cancelButton = LocalizationManager__Get((System_String_o *)StringLiteral_2801/*"BATTLE_INTERRUPTION_WINDOW_SELECT_WAVE_RESTART"*/, 0);
  ...
  cancelButton = LocalizationManager__Get((System_String_o *)StringLiteral_2799/*"BATTLE_INTERRUPTION_WINDOW_INTERRUPTION_BUTTON"*/, 0);
  ...
  if ( !cancelButton )
    goto LABEL_27;
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)cancelButton, !isFromBattleMenu, 0);
  v30 = (struct System_String_o **)(isFromBattleMenu ? &StringLiteral_15791/*"Window/CancelButton"*/ : &StringLiteral_1/*""*/);
  v31 = *v30;
  this->fields.closeButtonPath = *v30;
  p_closeButtonPath = &this->fields.closeButtonPath;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)p_closeButtonPath, (int32_t)v31, v24, v25, v26, v27, v28, v29);
  cancelButton = *(p_closeButtonPath - 5);
  if ( !cancelButton )
LABEL_27:
    sub_1CE6958(cancelButton, v17);
