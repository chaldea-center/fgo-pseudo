        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB9AEF & 1) == 0 )
  {
    sub_1C6BA08(&Method_BattleWindowInterruptionComponent_OnClickCancel__);
    byte_4CB9AEF = 1;
  }
  if ( BattleWindowComponent__isOpen((BattleWindowComponent_o *)this, 0) )
  {
    ...
    if ( (*((_BYTE *)Method_BattleWindowInterruptionComponent_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C6BA20(Method_BattleWindowInterruptionComponent_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB9AF2 & 1) == 0 )
  {
    sub_1C6BA08(&Method_BattleWindowInterruptionComponent_OnClickInterruption__);
    byte_4CB9AF2 = 1;
  }
  if ( BattleWindowComponent__isOpen((BattleWindowComponent_o *)this, 0) )
  {
    ...
    if ( (*((_BYTE *)Method_BattleWindowInterruptionComponent_OnClickInterruption__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C6BA20(Method_BattleWindowInterruptionComponent_OnClickInterruption__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C6B9EC(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB9AF1 & 1) == 0 )
  {
    sub_1C6BA08(&Method_BattleWindowInterruptionComponent_OnClickSelectWaveRestart__);
    byte_4CB9AF1 = 1;
  }
  if ( BattleWindowComponent__isOpen((BattleWindowComponent_o *)this, 0) )
  {
    ...
    if ( (*((_BYTE *)Method_BattleWindowInterruptionComponent_OnClickSelectWaveRestart__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C6BA20(Method_BattleWindowInterruptionComponent_OnClickSelectWaveRestart__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C6B9EC(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB9AF0 & 1) == 0 )
  {
    sub_1C6BA08(&Method_BattleWindowInterruptionComponent_OnClickWaveRestart__);
    byte_4CB9AF0 = 1;
  }
  if ( BattleWindowComponent__isOpen((BattleWindowComponent_o *)this, 0) && this->fields.canWaveRestart )
  {
    ...
    if ( (*((_BYTE *)Method_BattleWindowInterruptionComponent_OnClickWaveRestart__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C6BA20(Method_BattleWindowInterruptionComponent_OnClickWaveRestart__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C6B9EC(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.waveRestartButtonCallback, (int32_t)waveRestart, v10, v11);
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.interruptionButtonCallback, (int32_t)interruption, v14, v15);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB9AEE & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_2773/*"BATTLE_INTERRUPTION_WINDOW_CANCEL_BUTTON"*/);
    sub_1C6BA08(&StringLiteral_2779/*"BATTLE_INTERRUPTION_WINDOW_SELECT_WAVE_RESTART"*/);
    ...
    sub_1C6BA08(&StringLiteral_2776/*"BATTLE_INTERRUPTION_WINDOW_CURRENT_WAVE_RESTART"*/);
    sub_1C6BA08(&StringLiteral_414/*"#808080"*/);
    sub_1C6BA08(&StringLiteral_1/*""*/);
    sub_1C6BA08(&StringLiteral_2780/*"BATTLE_INTERRUPTION_WINDOW_TITLE"*/);
    sub_1C6BA08(&StringLiteral_2778/*"BATTLE_INTERRUPTION_WINDOW_MESSAGE"*/);
    byte_4CB9AEE = 1;
  }
  v29 = 0u;
  ...
  cancelButton = LocalizationManager__Get((System_String_o *)StringLiteral_2780/*"BATTLE_INTERRUPTION_WINDOW_TITLE"*/, 0);
  if ( !title )
    goto LABEL_27;
  UILabel__set_text(title, cancelButton, 0);
  message = this->fields.message;
  cancelButton = LocalizationManager__Get((System_String_o *)StringLiteral_2778/*"BATTLE_INTERRUPTION_WINDOW_MESSAGE"*/, 0);
  if ( !message )
    goto LABEL_27;
  UILabel__set_text(message, cancelButton, 0);
  cancelButtonLabel = this->fields.cancelButtonLabel;
  cancelButton = LocalizationManager__Get((System_String_o *)StringLiteral_2773/*"BATTLE_INTERRUPTION_WINDOW_CANCEL_BUTTON"*/, 0);
  ...
  cancelButton = LocalizationManager__Get((System_String_o *)StringLiteral_2776/*"BATTLE_INTERRUPTION_WINDOW_CURRENT_WAVE_RESTART"*/, 0);
  ...
  cancelButton = LocalizationManager__Get((System_String_o *)StringLiteral_2795/*"BATTLE_MENU_WAVE_RESTART_EXPLANATION_LABEL"*/, 0);
  if ( !waveRestartExplanationLabel )
    goto LABEL_27;
  UILabel__set_text(waveRestartExplanationLabel, cancelButton, 0);
  UnityEngine_ColorUtility__TryParseHtmlString((System_String_o *)StringLiteral_414/*"#808080"*/, (UnityEngine_Color_o *)&v29, 0);
  ...
  *(_OWORD *)&cancelButton[2].klass = v29;
  ...
  cancelButton = LocalizationManager__Get((System_String_o *)StringLiteral_2779/*"BATTLE_INTERRUPTION_WINDOW_SELECT_WAVE_RESTART"*/, 0);
  ...
  cancelButton = LocalizationManager__Get((System_String_o *)StringLiteral_2777/*"BATTLE_INTERRUPTION_WINDOW_INTERRUPTION_BUTTON"*/, 0);
  ...
  if ( !cancelButton )
    goto LABEL_27;
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)cancelButton, !isFromBattleMenu, 0);
  v26 = (struct System_String_o **)(isFromBattleMenu ? &StringLiteral_15638/*"Window/CancelButton"*/ : &StringLiteral_1/*""*/);
  v27 = *v26;
  this->fields.closeButtonPath = *v26;
  p_closeButtonPath = &this->fields.closeButtonPath;
  sub_1C6B9AC((CGThumbnailListItem_o *)p_closeButtonPath, (int32_t)v27, v24, v25);
  cancelButton = *(p_closeButtonPath - 5);
  if ( !cancelButton )
LABEL_27:
    sub_1C6BC60(cancelButton, v17);
