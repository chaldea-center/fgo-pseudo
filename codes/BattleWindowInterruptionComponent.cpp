        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF1E97 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_BattleWindowInterruptionComponent_OnClickCancel__);
    byte_4CF1E97 = 1;
  }
  if ( BattleWindowComponent__isOpen((BattleWindowComponent_o *)this, 0) )
  {
    ...
    if ( (*((_BYTE *)Method_BattleWindowInterruptionComponent_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C7BB00(Method_BattleWindowInterruptionComponent_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF1E9A & 1) == 0 )
  {
    sub_1C7BAE8(&Method_BattleWindowInterruptionComponent_OnClickInterruption__);
    byte_4CF1E9A = 1;
  }
  if ( BattleWindowComponent__isOpen((BattleWindowComponent_o *)this, 0) )
  {
    ...
    if ( (*((_BYTE *)Method_BattleWindowInterruptionComponent_OnClickInterruption__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C7BB00(Method_BattleWindowInterruptionComponent_OnClickInterruption__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C7BACC(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF1E99 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_BattleWindowInterruptionComponent_OnClickSelectWaveRestart__);
    byte_4CF1E99 = 1;
  }
  if ( BattleWindowComponent__isOpen((BattleWindowComponent_o *)this, 0) )
  {
    ...
    if ( (*((_BYTE *)Method_BattleWindowInterruptionComponent_OnClickSelectWaveRestart__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C7BB00(Method_BattleWindowInterruptionComponent_OnClickSelectWaveRestart__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C7BACC(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF1E98 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_BattleWindowInterruptionComponent_OnClickWaveRestart__);
    byte_4CF1E98 = 1;
  }
  if ( BattleWindowComponent__isOpen((BattleWindowComponent_o *)this, 0) && this->fields.canWaveRestart )
  {
    ...
    if ( (*((_BYTE *)Method_BattleWindowInterruptionComponent_OnClickWaveRestart__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C7BB00(Method_BattleWindowInterruptionComponent_OnClickWaveRestart__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C7BACC(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF1E96 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_2782/*"BATTLE_INTERRUPTION_WINDOW_INTERRUPTION_BUTTON"*/);
    sub_1C7BAE8(&StringLiteral_2778/*"BATTLE_INTERRUPTION_WINDOW_CANCEL_BUTTON"*/);
    sub_1C7BAE8(&StringLiteral_2784/*"BATTLE_INTERRUPTION_WINDOW_SELECT_WAVE_RESTART"*/);
    sub_1C7BAE8(&StringLiteral_2800/*"BATTLE_MENU_WAVE_RESTART_EXPLANATION_LABEL"*/);
    sub_1C7BAE8(&StringLiteral_15699/*"Window/CancelButton"*/);
    sub_1C7BAE8(&StringLiteral_2781/*"BATTLE_INTERRUPTION_WINDOW_CURRENT_WAVE_RESTART"*/);
    sub_1C7BAE8(&StringLiteral_415/*"#808080"*/);
    sub_1C7BAE8(&StringLiteral_1/*""*/);
    sub_1C7BAE8(&StringLiteral_2785/*"BATTLE_INTERRUPTION_WINDOW_TITLE"*/);
    sub_1C7BAE8(&StringLiteral_2783/*"BATTLE_INTERRUPTION_WINDOW_MESSAGE"*/);
    byte_4CF1E96 = 1;
  }
  v33 = 0u;
  ...
  *(_OWORD *)&cancelButton[2].klass = v33;
  ...
  if ( !cancelButton )
    goto LABEL_27;
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)cancelButton, !isFromBattleMenu, 0);
  v30 = (struct System_String_o **)(isFromBattleMenu ? &StringLiteral_15699/*"Window/CancelButton"*/ : &StringLiteral_1/*""*/);
  v31 = *v30;
  this->fields.closeButtonPath = *v30;
  p_closeButtonPath = &this->fields.closeButtonPath;
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)p_closeButtonPath, (int32_t)v31, v24, v25, v26, v27, v28, v29);
  cancelButton = *(p_closeButtonPath - 5);
  if ( !cancelButton )
LABEL_27:
    sub_1C7BD40(cancelButton, v17);
