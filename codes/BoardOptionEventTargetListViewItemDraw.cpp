void __fastcall BoardOptionEventTargetListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BFA1A6 & 1) == 0 )
  {
    sub_1C2E12C(&BoardOptionEventTargetListViewItemDraw_TypeInfo, v1);
    sub_1C2E12C(&StringLiteral_21879/*"missiontarget_bg"*/, v8);
    byte_4BFA1A6 = 1;
  }
  BoardOptionEventTargetListViewItemDraw_TypeInfo->static_fields->BASE_SPRITE_NAME = (struct System_String_o *)StringLiteral_21879/*"missiontarget_bg"*/;
  sub_1C2E0D0(
    (PartyOrganizationUtility_o *)BoardOptionEventTargetListViewItemDraw_TypeInfo->static_fields,
    StringLiteral_21879/*"missiontarget_bg"*/,
    v2,
    v3,
    v4,
    v5,
        ...
        const MethodInfo *method)
{
  if ( (byte_4BFA1A5 & 1) == 0 )
  {
    sub_1C2E12C(&QuestInformationListViewItemDraw_TypeInfo, method);
    byte_4BFA1A5 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFA1A2 & 1) == 0 )
  {
    sub_1C2E12C(&UnityEngine_Material_TypeInfo, *(_QWORD *)&dispTp);
    this = (BoardOptionEventTargetListViewItemDraw_o *)sub_1C2E12C(&QuestInformationListViewItemDraw_TypeInfo, v7);
    byte_4BFA1A2 = 1;
  }
  switch ( dispTp )
  {
    case 3:
      if ( sp )
      {
        ...
        if ( this )
        {
          ...
          UnityEngine_Material___ctor_70852992(v13, v12, 0LL);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall BoardOptionEventTargetListViewItemDraw__SetDispType_34672232(
        BoardOptionEventTargetListViewItemDraw_o *this,
        int32_t dispTp,
        UITexture_o *texture,
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFA1A3 & 1) == 0 )
  {
    sub_1C2E12C(&QuestInformationListViewItemDraw_TypeInfo, *(_QWORD *)&dispTp);
    this = (BoardOptionEventTargetListViewItemDraw_o *)sub_1C2E12C(&StringLiteral_16551/*"_MainTex"*/, v7);
    byte_4BFA1A3 = 1;
  }
  if ( dispTp == 3 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFA1A4 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&BoardOptionEventTargetListViewItemDraw_TypeInfo, v3);
    byte_4BFA1A4 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFA1A1 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&QuestInformationListViewItemDraw_TypeInfo, v8);
    sub_1C2E12C(&ServantAssetLoadManager_TypeInfo, v9);
    sub_1C2E12C(&TerminalSceneComponent_TypeInfo, v10);
    sub_1C2E12C(&Method_BoardOptionEventTargetListViewItemDraw___c__DisplayClass3_0__SetItem_b__0__, v11);
    sub_1C2E12C(&BoardOptionEventTargetListViewItemDraw___c__DisplayClass3_0_TypeInfo, v12);
    byte_4BFA1A1 = 1;
  }
  v13 = sub_1C2E378(BoardOptionEventTargetListViewItemDraw___c__DisplayClass3_0_TypeInfo);
...
LABEL_52:
    ...
    if ( QuestInformationListViewItem__isEnemyServant((QuestInformationListViewItem_o *)SvtImg, 0LL) )
    {
      ...
      *p_SvtImg = Manager__loadCommandCard;
      ...
      if ( !*(_QWORD *)v22 )
        goto LABEL_54;
      BoardOptionEventTargetListViewItemDraw__SetDispType_34672232(
        this,
