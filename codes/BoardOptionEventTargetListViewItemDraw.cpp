void __fastcall BoardOptionEventTargetListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A2AAD4 & 1) == 0 )
  {
    sub_1B761C0(&BoardOptionEventTargetListViewItemDraw_TypeInfo, v1);
    sub_1B761C0(&StringLiteral_21475/*"missiontarget_bg"*/, v4);
    byte_4A2AAD4 = 1;
  }
  BoardOptionEventTargetListViewItemDraw_TypeInfo->static_fields->BASE_SPRITE_NAME = (struct System_String_o *)StringLiteral_21475/*"missiontarget_bg"*/;
  sub_1B76164(
    (ServantStatusBattleListViewItem_o *)BoardOptionEventTargetListViewItemDraw_TypeInfo->static_fields,
    StringLiteral_21475/*"missiontarget_bg"*/,
    v2,
    v3);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4A2AAD3 & 1) == 0 )
  {
    sub_1B761C0(&QuestInformationListViewItemDraw_TypeInfo, method);
    byte_4A2AAD3 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2AAD0 & 1) == 0 )
  {
    sub_1B761C0(&UnityEngine_Material_TypeInfo, *(_QWORD *)&dispTp);
    this = (BoardOptionEventTargetListViewItemDraw_o *)sub_1B761C0(&QuestInformationListViewItemDraw_TypeInfo, v7);
    byte_4A2AAD0 = 1;
  }
  switch ( dispTp )
  {
    case 3:
      if ( sp )
      {
        ...
        if ( this )
        {
          ...
          UnityEngine_Material___ctor_69150768(v13, v12, 0LL);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall BoardOptionEventTargetListViewItemDraw__SetDispType_33298676(
        BoardOptionEventTargetListViewItemDraw_o *this,
        int32_t dispTp,
        UITexture_o *texture,
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2AAD1 & 1) == 0 )
  {
    sub_1B761C0(&QuestInformationListViewItemDraw_TypeInfo, *(_QWORD *)&dispTp);
    this = (BoardOptionEventTargetListViewItemDraw_o *)sub_1B761C0(&StringLiteral_16256/*"_MainTex"*/, v7);
    byte_4A2AAD1 = 1;
  }
  if ( dispTp == 3 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2AAD2 & 1) == 0 )
  {
    ...
    sub_1B761C0(&BoardOptionEventTargetListViewItemDraw_TypeInfo, v3);
    byte_4A2AAD2 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2AACF & 1) == 0 )
  {
    ...
    sub_1B761C0(&QuestInformationListViewItemDraw_TypeInfo, v8);
    sub_1B761C0(&ServantAssetLoadManager_TypeInfo, v9);
    sub_1B761C0(&TerminalSceneComponent_TypeInfo, v10);
    sub_1B761C0(&Method_BoardOptionEventTargetListViewItemDraw___c__DisplayClass3_0__SetItem_b__0__, v11);
    sub_1B761C0(&BoardOptionEventTargetListViewItemDraw___c__DisplayClass3_0_TypeInfo, v12);
    byte_4A2AACF = 1;
  }
  v13 = sub_1B7640C(BoardOptionEventTargetListViewItemDraw___c__DisplayClass3_0_TypeInfo);
...
LABEL_52:
    ...
    if ( QuestInformationListViewItem__isEnemyServant((QuestInformationListViewItem_o *)SvtImg, 0LL) )
    {
      ...
      *p_SvtImg = Manager__loadCommandCard;
      ...
      if ( !*(_QWORD *)v18 )
        goto LABEL_54;
      BoardOptionEventTargetListViewItemDraw__SetDispType_33298676(
        this,
