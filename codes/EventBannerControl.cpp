...
void __fastcall EventBannerControl__setBannerList(EventBannerControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B2659 & 1) == 0 )
  {
    sub_B52984(&Method_UnityEngine_GameObject_GetComponent_BannerComponent___);
    sub_B52984(&Method_System_Collections_Generic_List_GameObject__Add__);
    this = (EventBannerControl_o *)sub_B52984(&Method_System_Collections_Generic_List_int__Add__);
    byte_42B2659 = 1;
  }
        ...
        if ( (int)method >= 1 )
        {
          ...
          *(UnityEngine_Vector3_o *)&v13 = UnityEngine_Vector3__get_one(0LL);
          ...
          this = (EventBannerControl_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                           v11,
                                           (const MethodInfo_1B7B1B8 *)Method_UnityEngine_GameObject_GetComponent_BannerComponent___);
          if ( !this )
            break;
