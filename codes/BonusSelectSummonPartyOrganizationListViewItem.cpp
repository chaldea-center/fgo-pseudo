        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C236A6 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_BonusSelectSummonPartyOrganizationListViewItem___c___ctor_b__8_0__);
    sub_1C2D490(&BonusSelectSummonPartyOrganizationListViewItem___c_TypeInfo);
    byte_4C236A6 = 1;
  }
  userServantList = 0;
  ListViewItem___ctor_43566844((ListViewItem_o *)this, index, 0);
  this->fields.servantEntity = servantEntity;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.servantEntity, (int32_t)servantEntity, v9, v10);
  this->fields.gachaBonusSelectEntity = gachaBonusSelectEntity;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.gachaBonusSelectEntity, (int32_t)gachaBonusSelectEntity, v11, v12);
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.servantExceedMaster, (int32_t)Master_object, v14, v15);
  v16 = DataManager__GetMaster_object_((const MethodInfo_30CE8FC *)Method_DataManager_GetMaster_ServantLimitMaster___);
  this->fields.svtLimitMaster = (struct ServantLimitMaster_o *)v16;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.svtLimitMaster, (int32_t)v16, v17, v18);
  v19 = DataManager__GetMaster_object_((const MethodInfo_30CE8FC *)Method_DataManager_GetMaster_ServantTreasureDvcMaster___);
  this->fields.svtTdMaster = (struct ServantTreasureDvcMaster_o *)v19;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.svtTdMaster, (int32_t)v19, v20, v21);
  v22 = DataManager__GetMaster_object_((const MethodInfo_30CE8FC *)Method_DataManager_GetMaster_UserServantMaster___);
  this->fields.userServantMaster = (struct UserServantMaster_o *)v22;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.userServantMaster, (int32_t)v22, v23, v24);
  ...
  *(_QWORD *)&v43.fields.fakeValue = v26;
  v29 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v43, 0);
  ...
  if ( UserServantMaster__TryGetEntityListBySvtId(userServantMaster, &userServantList, v29, 1, 0) )
  {
    ...
    if ( !_9__8_0 )
    {
      ...
      _9__8_0 = (System_Func_object__int__o *)sub_1C2D6DC(System_Func_UserServantEntity__int__TypeInfo);
      ...
      sub_1C2D434((CGThumbnailListItem_o *)&static_fields->__9__8_0, (int32_t)_9__8_0, v36, v37);
    }
    ...
    sub_1C2D434((CGThumbnailListItem_o *)&this->fields.userServantEntity, (int32_t)v39, v40, v41);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.servantEntity, 0, v5, v6);
  this->fields.lineupEntity = 0;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.lineupEntity, 0, v7, v8);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !item )
    sub_1C2D6EC(this, 0);
  BonusSelectSummonPartyOrganizationListViewItem__Modify_35149072(
    this,
...
void BonusSelectSummonPartyOrganizationListViewItem__Modify_35141464(
        BonusSelectSummonPartyOrganizationListViewItem_o *this,
        int32_t gachaId,
        int32_t slot,
        int32_t giftId,
        const MethodInfo *method)
{
  ...
  void *EntityList; // x0
  __int64 v12; // x1
  ServantEntity_o *v13; // x2
  const MethodInfo *v14; // x3
  int max_length; // w9
  unsigned int v16; // w10
  __int64 v17; // x23
  GachaBonusSelectLineupEntity_o *v18; // x10
  ...
  EntityList = DataManager__GetMaster_object_((const MethodInfo_30CE8FC *)Method_DataManager_GetMaster_GachaBonusSelectMaster___);
  if ( !EntityList )
    goto LABEL_30;
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  EntityList = DataManager__GetMaster_object_((const MethodInfo_30CE8FC *)Method_DataManager_GetMaster_GachaBonusSelectLineupMaster___);
    ...
    if ( max_length >= 1 )
    {
      ...
      while ( 1 )
      {
        if ( v16 >= max_length )
          goto LABEL_31;
        v17 = (int)v16;
        v18 = gachaBonusSelectLineupEntities->m_Items[v16];
        if ( !v18 )
          goto LABEL_30;
      ...
      if ( Master_object )
      {
        ...
        if ( EntityList )
        {
          ...
          v13 = (ServantEntity_o *)EntityList;
        }
        else
        {
          v13 = 0;
        ...
        if ( gachaBonusSelectLineupEntities )
        {
          if ( (unsigned int)v17 >= LODWORD(gachaBonusSelectLineupEntities->max_length) )
LABEL_31:
            sub_1C2D6F4(EntityList, v12, v13);
          v19 = gachaBonusSelectLineupEntities->m_Items[v17];
          goto LABEL_20;
        }
      }
LABEL_30:
...
LABEL_19:
  ...
  v19 = 0;
LABEL_20:
  BonusSelectSummonPartyOrganizationListViewItem__Modify_35149072(this, v19, v13, v14);
}


void BonusSelectSummonPartyOrganizationListViewItem__Modify_35149072(
        BonusSelectSummonPartyOrganizationListViewItem_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C236A7 & 1) == 0 )
  {
    ...
    sub_1C2D490(&System_Func_UserServantEntity__int__TypeInfo);
    sub_1C2D490(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    sub_1C2D490(&Method_BonusSelectSummonPartyOrganizationListViewItem___c__Modify_b__10_0__);
    sub_1C2D490(&BonusSelectSummonPartyOrganizationListViewItem___c_TypeInfo);
    byte_4C236A7 = 1;
  }
  userServantList = 0;
  this->fields.lineupEntity = lineupEntity;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.lineupEntity, (int32_t)lineupEntity, (int32_t)svtEntity, method);
  this->fields.servantEntity = svtEntity;
  p_servantEntity = &this->fields.servantEntity;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.servantEntity, (int32_t)svtEntity, v8, v9);
  this->fields.userServantEntity = 0;
  p_userServantEntity = (CGThumbnailListItem_o *)&this->fields.userServantEntity;
  sub_1C2D434(p_userServantEntity, 0, v11, v12);
  v13 = *p_servantEntity;
  ...
  *(_QWORD *)&v32.fields.fakeValue = v16;
  v18 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v32, 0);
  if ( !sortStr1 )
    sub_1C2D6EC(v18, v19);
  if ( UserServantMaster__TryGetEntityListBySvtId(sortStr1, &userServantList, v18, 1, 0) )
  {
    ...
    if ( !_9__10_0 )
    {
      ...
      sub_1C2D434((CGThumbnailListItem_o *)&static_fields->__9__10_0, (int32_t)_9__10_0, v25, v26);
    }
    ...
    sub_1C2D434(p_userServantEntity, (int32_t)v28, v29, v30);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C236A9 & 1) == 0 )
  {
    this = (BonusSelectSummonPartyOrganizationListViewItem_o *)sub_1C2D490(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    byte_4C236A9 = 1;
  }
  ...
  *(_QWORD *)&v8.fields.fakeValue = v5;
  this = (BonusSelectSummonPartyOrganizationListViewItem_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(
                                                               v8,
                                                               0);
  if ( !servantExceedMaster )
LABEL_8:
    sub_1C2D6EC(this, method);
  return ServantExceedMaster__GetFrameType_42450052(servantExceedMaster, (int32_t)this, 0, 0, 0, 0);
}
...
void BonusSelectSummonPartyOrganizationListViewItem___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C2D6DC(BonusSelectSummonPartyOrganizationListViewItem___c_TypeInfo);
