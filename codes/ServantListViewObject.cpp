...
void __fastcall ServantListViewObject__Awake(ServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA96E & 1) == 0 )
  {
    sub_1B64870(&Method_UnityEngine_GameObject_GetComponent_ServantListViewItemDraw___, method);
    byte_49FA96E = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2E8A1B4 *)Method_UnityEngine_GameObject_GetComponent_ServantListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA972 & 1) == 0 )
  {
    sub_1B64870(&Method_UnityEngine_GameObject_GetComponent_ServantListViewObject___, method);
    byte_49FA972 = 1;
  }
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_2E8A1B4 *)Method_UnityEngine_GameObject_GetComponent_ServantListViewObject___)) == 0LL) )
  {
    sub_1B64ACC(DragObject, v4);
  }
  ServantListViewObject__Init_32354812((ServantListViewObject_o *)DragObject, 2, v6);
  return v5;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA970 & 1) == 0 )
  {
    sub_1B64870(&ServantListViewItem_TypeInfo, method);
    byte_49FA970 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA973 & 1) == 0 )
  {
    sub_1B64870(&ServantListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_49FA973 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantListViewObject__Init_32354812(
        ServantListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantListViewObject__Init_32356112(
        ServantListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantListViewObject__Init_32356196(
        ServantListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall ServantListViewObject__OnClickSelect(ServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B64870(&ServantListViewItem_TypeInfo, method);
    sub_1B64870(&Method_ServantListViewObject_OnClickSelect__, v3);
    sub_1B64870(&StringLiteral_9820/*"OnClickSelectListView"*/, v4);
    byte_49FA975 = 1;
  }
      ...
      && (ServantListViewItem_c *)linkItem->klass->_2.typeHierarchy[methodPtr_low - 1] == ServantListViewItem_TypeInfo )
    {
      if ( ServantListViewItem__get_IsCanNotSelect(linkItem, 0LL) )
      {
        ...
        if ( (*((_BYTE *)Method_ServantListViewObject_OnClickSelect__ + 83) & 2) != 0 )
          v7 = (_QWORD *)sub_1B64888(Method_ServantListViewObject_OnClickSelect__);
...
void __fastcall ServantListViewObject__SetItem_32362132(
        ServantListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall ServantListViewObject__SetupDisp(ServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA974 & 1) == 0 )
  {
    ...
    sub_1B64870(&ServantListViewItem_TypeInfo, v3);
    byte_49FA974 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
        ...
        const MethodInfo *method)
{
  ...
  v11 = (ServantListViewObject_o *)sub_1B64D8C(v8);
