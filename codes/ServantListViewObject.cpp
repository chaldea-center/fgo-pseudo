...
void __fastcall ServantListViewObject__Awake(ServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42EC6D9 & 1) == 0 )
  {
    sub_B5D5C4(&Method_UnityEngine_GameObject_GetComponent_ServantListViewItemDraw___, (_DWORD)method, v2, v3);
    byte_42EC6D9 = 1;
  }
  ...
  Component_srcLineSprite = (struct ServantListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                                  dispObject,
                                                                  (const MethodInfo_1CC439C *)Method_UnityEngine_GameObject_GetComponent_ServantListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  ServantListViewObject_o *v8; // x20
  const MethodInfo *v9; // x3
  UnityEngine_Vector3_o zero; // 0:s0.4,4:s1.4,8:s2.4 OVERLAPPED

  if ( (byte_42EC6DD & 1) == 0 )
  {
    sub_B5D5C4(&Method_UnityEngine_GameObject_GetComponent_ServantListViewObject___, (_DWORD)method, v2, v3);
    byte_42EC6DD = 1;
  }
  ...
  if ( !DragObject
    || (v7 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                    DragObject,
                                                    (const MethodInfo_1CC439C *)Method_UnityEngine_GameObject_GetComponent_ServantListViewObject___)) == 0LL) )
  {
    sub_B5D69C(DragObject, v6);
  }
  v8 = (ServantListViewObject_o *)DragObject;
  zero = UnityEngine_Vector3__get_zero(0LL);
  ServantListViewObject__Init(v8, 2, 0LL, zero.fields.x, *(UnityEngine_Vector3_o *)&zero.fields.y, v9);
  return v7;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EC6DB & 1) == 0 )
  {
    sub_B5D5C4(&ServantListViewItem_TypeInfo, (_DWORD)method, v2, v3);
    byte_42EC6DB = 1;
  }
  ...
  if ( *(&linkItem->klass->_2.bitflags2 + 1) < (unsigned int)v6 )
    return 0LL;
  if ( (ServantListViewItem_c *)linkItem->klass->_2.typeHierarchy[v6 - 1] == ServantListViewItem_TypeInfo )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EC6DE & 1) == 0 )
  {
    sub_B5D5C4(&ServantListViewItem_TypeInfo, initMode, (_DWORD)callbackFunc, method);
    byte_42EC6DE = 1;
  }
  linkItem = this->fields.linkItem;
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantListViewObject__Init_32483616(
        ServantListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantListViewObject__Init_32484876(
        ServantListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantListViewObject__Init_32484940(
        ServantListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall ServantListViewObject__OnClickSelect(ServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42EC6E0 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&StringLiteral_10076/*"OnClickSelectListView"*/, v8, v9, v10);
    byte_42EC6E0 = 1;
  }
  ...
  if ( linkItem )
  {
    ...
    if ( *(&linkItem->klass->_2.bitflags2 + 1) >= (unsigned int)v12
      && (ServantListViewItem_c *)linkItem->klass->_2.typeHierarchy[v12 - 1] == ServantListViewItem_TypeInfo )
    {
...
void __fastcall ServantListViewObject__SetInput(ServantListViewObject_o *this, bool isInput, const MethodInfo *method)
{
  ...
  ServantListViewItemDraw_o *v14; // x0
  ...
  if ( UnityEngine_Object__op_Inequality(itemDraw, 0LL, 0LL) )
  {
    ...
    if ( !v14 )
      sub_B5D69C(0LL, v13);
    ServantListViewItemDraw__SetInput(v14, (ServantListViewItem_o *)v13, isInput, v10);
  }
}
...
void __fastcall ServantListViewObject__SetItem_32490628(
        ServantListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall ServantListViewObject__SetupDisp(ServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42EC6DF & 1) == 0 )
  {
    ...
    sub_B5D5C4(&ServantListViewItem_TypeInfo, v5, v6, v7);
    byte_42EC6DF = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem )
  {
    ...
    if ( *(&linkItem->klass->_2.bitflags2 + 1) >= (unsigned int)v9
      && (ServantListViewItem_c *)linkItem->klass->_2.typeHierarchy[v9 - 1] == ServantListViewItem_TypeInfo )
    {
...
LABEL_8:
  ...
  if ( UnityEngine_Object__op_Inequality(itemDraw, 0LL, 0LL) )
  {
    ...
    if ( !v14 )
      sub_B5D69C(0LL, v12);
    ServantListViewItemDraw__SetItem(v14, (ServantListViewItem_o *)linkItem, this->fields.dispMode, v13);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  __int64 v10; // x0
  bool v11; // zf
  ServantListViewObject_o *v12; // x0
  ...
  sub_B5D990(v9);
  ServantListViewObject__remove_callbackFunc(v12, v13, v14);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_B5D990(v9);
  ServantListViewObject__Awake(v12, v13);
}