...
void __fastcall ServantListViewObject__Awake(ServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6C2A0 & 1) == 0 )
  {
    sub_1B90010(&Method_UnityEngine_GameObject_GetComponent_ServantListViewItemDraw___, method);
    byte_4A6C2A0 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2EDD768 *)Method_UnityEngine_GameObject_GetComponent_ServantListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6C2A4 & 1) == 0 )
  {
    sub_1B90010(&Method_UnityEngine_GameObject_GetComponent_ServantListViewObject___, method);
    byte_4A6C2A4 = 1;
  }
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_2EDD768 *)Method_UnityEngine_GameObject_GetComponent_ServantListViewObject___)) == 0LL) )
  {
    sub_1B9026C(DragObject, v4);
  }
  ServantListViewObject__Init_32717340((ServantListViewObject_o *)DragObject, 2, v6);
  return v5;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6C2A2 & 1) == 0 )
  {
    sub_1B90010(&ServantListViewItem_TypeInfo, method);
    byte_4A6C2A2 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6C2A5 & 1) == 0 )
  {
    sub_1B90010(&ServantListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4A6C2A5 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantListViewObject__Init_32717340(
        ServantListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantListViewObject__Init_32718640(
        ServantListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantListViewObject__Init_32718724(
        ServantListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall ServantListViewObject__OnClickSelect(ServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B90010(&ServantListViewItem_TypeInfo, method);
    sub_1B90010(&Method_ServantListViewObject_OnClickSelect__, v3);
    sub_1B90010(&StringLiteral_9870/*"OnClickSelectListView"*/, v4);
    byte_4A6C2A7 = 1;
  }
      ...
      && (ServantListViewItem_c *)linkItem->klass->_2.typeHierarchy[methodPtr_low - 1] == ServantListViewItem_TypeInfo )
    {
      if ( ServantListViewItem__get_IsCanNotSelect(linkItem, 0LL) )
      {
        ...
        if ( (*((_BYTE *)Method_ServantListViewObject_OnClickSelect__ + 83) & 2) != 0 )
          v7 = (_QWORD *)sub_1B90028(Method_ServantListViewObject_OnClickSelect__);
...
void __fastcall ServantListViewObject__SetItem_32724660(
        ServantListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall ServantListViewObject__SetupDisp(ServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6C2A6 & 1) == 0 )
  {
    ...
    sub_1B90010(&ServantListViewItem_TypeInfo, v3);
    byte_4A6C2A6 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
        ...
        const MethodInfo *method)
{
  ...
  v11 = (ServantListViewObject_o *)sub_1B9052C(v8);
