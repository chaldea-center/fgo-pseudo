void ScreenShot___ctor(ScreenShot_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_59729B3 & 1) == 0 )
  {
    sub_2213A60(&StringLiteral_13159/*"ScreenshotFolder"*/);
    sub_2213A60(&StringLiteral_1/*""*/);
    byte_59729B3 = 1;
  }
  v9 = StringLiteral_13159/*"ScreenshotFolder"*/;
  this->fields.folder = (struct System_String_o *)StringLiteral_13159/*"ScreenshotFolder"*/;
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields.folder, v9, v2, v3, v4, v5, v6, v7);
  v10 = (struct System_String_o *)StringLiteral_1/*""*/;
  this->fields.frameRate = 30;
  this->fields.realFolder = v10;
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields.realFolder, (int32_t)v10, v11, v12, v13, v14, v15, v16);
...
void ScreenShot__Start(ScreenShot_o *this, const MethodInfo *method)
{
  ...
  sub_2213A04(v2, sortValue0, v4, v5, v6, v7, v8, v9);
...
void ScreenShot__Update(ScreenShot_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_59729B2 & 1) == 0 )
  {
    sub_2213A60(&StringLiteral_26545/*"{0}/s{1:D04}.png"*/);
    byte_59729B2 = 1;
  }
  if ( UnityEngine_Time__get_time(0) > this->fields.waitTime )
  {
    ...
    v4 = (Il2CppObject *)j_il2cpp_value_box_0(qword_5984348, &frameNumber);
    v5 = System_String__Format_75697880((System_String_o *)StringLiteral_26545/*"{0}/s{1:D04}.png"*/, realFolder, v4, 0);
