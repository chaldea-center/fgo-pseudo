void ScreenShot___ctor(ScreenShot_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E06B05 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_12760/*"ScreenshotFolder"*/);
    sub_1CE6700(&StringLiteral_1/*""*/);
    byte_4E06B05 = 1;
  }
  v9 = StringLiteral_12760/*"ScreenshotFolder"*/;
  this->fields.folder = (struct System_String_o *)StringLiteral_12760/*"ScreenshotFolder"*/;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.folder, v9, v2, v3, v4, v5, v6, v7);
  this->fields.frameRate = 30;
  v10 = StringLiteral_1/*""*/;
  this->fields.realFolder = (struct System_String_o *)StringLiteral_1/*""*/;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.realFolder, v10, v11, v12, v13, v14, v15, v16);
...
void ScreenShot__Start(ScreenShot_o *this, const MethodInfo *method)
{
  ...
  sub_1CE66A4(v2, sortValue0, v4, v5, v6, v7, v8, v9);
...
void ScreenShot__Update(ScreenShot_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E06B04 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_25566/*"{0}/s{1:D04}.png"*/);
    byte_4E06B04 = 1;
  }
  if ( UnityEngine_Time__get_time(0) > this->fields.waitTime )
  {
    ...
    v5 = System_String__Format_65164136((System_String_o *)StringLiteral_25566/*"{0}/s{1:D04}.png"*/, realFolder, v4, 0);
