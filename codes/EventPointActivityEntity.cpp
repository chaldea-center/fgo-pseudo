        ...
        const MethodInfo *method)
{
  if ( (byte_4B02082 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int__long___, *(_QWORD *)&groupId);
    byte_4B02082 = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__int__int__long_(
           ...
           objectId,
           objectValue,
           (const MethodInfo_3000F2C *)Method_DataEntityBase_CreateMultiplePK_int__int__int__int__long___);
}
