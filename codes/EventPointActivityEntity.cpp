        ...
        const MethodInfo *method)
{
  if ( (byte_4A6FECB & 1) == 0 )
  {
    sub_1B90010(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int__long___, *(_QWORD *)&groupId);
    byte_4A6FECB = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__int__int__long_(
           ...
           objectId,
           objectValue,
           (const MethodInfo_2E8D2E4 *)Method_DataEntityBase_CreateMultiplePK_int__int__int__int__long___);
}
