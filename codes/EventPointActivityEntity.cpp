        ...
        const MethodInfo *method)
{
  if ( (byte_49FE569 & 1) == 0 )
  {
    sub_1B64870(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int__long___, *(_QWORD *)&groupId);
    byte_49FE569 = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__int__int__long_(
           ...
           objectId,
           objectValue,
           (const MethodInfo_2E3A790 *)Method_DataEntityBase_CreateMultiplePK_int__int__int__int__long___);
}
