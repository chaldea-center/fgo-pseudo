        ...
        const MethodInfo *method)
{
  if ( (byte_4A5B1C0 & 1) == 0 )
  {
    sub_1B885B0(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int__long___);
    byte_4A5B1C0 = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__int__int__long_(
           ...
           objectId,
           objectValue,
           (const MethodInfo_2E7E9D0 *)Method_DataEntityBase_CreateMultiplePK_int__int__int__int__long___);
}
