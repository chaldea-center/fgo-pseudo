        ...
        const MethodInfo *method)
{
  if ( (byte_4B44AD1 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int__long___, *(_QWORD *)&groupId);
    byte_4B44AD1 = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__int__int__long_(
           ...
           objectId,
           objectValue,
           (const MethodInfo_3032A24 *)Method_DataEntityBase_CreateMultiplePK_int__int__int__int__long___);
}
