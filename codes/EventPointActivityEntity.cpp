        ...
        const MethodInfo *method)
{
  if ( (byte_4C4301D & 1) == 0 )
  {
    sub_1C37058(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int__long___);
    byte_4C4301D = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__int__int__long_(
           ...
           objectId,
           objectValue,
           (const MethodInfo_30E6D20 *)Method_DataEntityBase_CreateMultiplePK_int__int__int__int__long___);
}
