        ...
        const MethodInfo *method)
{
  if ( (byte_49BAEC7 & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int__long___, *(_QWORD *)&groupId);
    byte_49BAEC7 = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__int__int__long_(
           ...
           objectId,
           objectValue,
           (const MethodInfo_2F00BEC *)Method_DataEntityBase_CreateMultiplePK_int__int__int__int__long___);
}
