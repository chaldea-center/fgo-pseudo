        ...
        const MethodInfo *method)
{
  if ( (byte_4A2DFA2 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int__long___, *(_QWORD *)&groupId);
    byte_4A2DFA2 = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__int__int__long_(
           ...
           objectId,
           objectValue,
           (const MethodInfo_2E614D0 *)Method_DataEntityBase_CreateMultiplePK_int__int__int__int__long___);
}
