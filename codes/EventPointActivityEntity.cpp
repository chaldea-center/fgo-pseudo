        ...
        const MethodInfo *method)
{
  if ( (byte_4C21FB4 & 1) == 0 )
  {
    sub_1C3B764(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int__long___, *(_QWORD *)&groupId);
    byte_4C21FB4 = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__int__int__long_(
           ...
           objectId,
           objectValue,
           (const MethodInfo_2FEF2CC *)Method_DataEntityBase_CreateMultiplePK_int__int__int__int__long___);
}
