        ...
        const MethodInfo *method)
{
  if ( (byte_40FAC09 & 1) == 0 )
  {
    sub_B16FFC(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int__long___, *(_QWORD *)&groupId);
    byte_40FAC09 = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__int__int__long_(
           ...
           objectId,
           objectValue,
           (const MethodInfo_18C2D40 *)Method_DataEntityBase_CreateMultiplePK_int__int__int__int__long___);
}
