        ...
        const MethodInfo *method)
{
  if ( (byte_49FEB89 & 1) == 0 )
  {
    sub_1B64A00(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int__long___, *(_QWORD *)&groupId);
    byte_49FEB89 = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__int__int__long_(
           ...
           objectId,
           objectValue,
           (const MethodInfo_2E3ADA8 *)Method_DataEntityBase_CreateMultiplePK_int__int__int__int__long___);
}
