        ...
        const MethodInfo *method)
{
  if ( (byte_49FC471 & 1) == 0 )
  {
    sub_1B640C8(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int__long___, *(_QWORD *)&groupId);
    byte_49FC471 = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__int__int__long_(
           ...
           objectId,
           objectValue,
           (const MethodInfo_2E384B4 *)Method_DataEntityBase_CreateMultiplePK_int__int__int__int__long___);
}
