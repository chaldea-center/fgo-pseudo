        ...
        const MethodInfo *method)
{
  if ( (byte_4BDC598 & 1) == 0 )
  {
    sub_1C21E38(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int__long___);
    byte_4BDC598 = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__int__int__long_(
           ...
           objectId,
           objectValue,
           (const MethodInfo_2FAEECC *)Method_DataEntityBase_CreateMultiplePK_int__int__int__int__long___);
}
