        ...
        const MethodInfo *method)
{
  if ( (byte_4BC7B01 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int__long___, *(_QWORD *)&groupId);
    byte_4BC7B01 = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__int__int__long_(
           ...
           objectId,
           objectValue,
           (const MethodInfo_2F9E558 *)Method_DataEntityBase_CreateMultiplePK_int__int__int__int__long___);
}
