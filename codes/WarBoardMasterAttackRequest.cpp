        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC9531 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_24262/*"targetGroupId"*/, v20);
    sub_1C1ABD4(&StringLiteral_24265/*"targetPieceIndex"*/, v21);
    sub_1C1ABD4(&StringLiteral_17426/*"befSquareIndex"*/, v22);
    sub_1C1ABD4(&StringLiteral_24261/*"targetForceId"*/, v23);
    sub_1C1ABD4(&StringLiteral_22925/*"pieceIndex"*/, v24);
    sub_1C1ABD4(&StringLiteral_20188/*"groupId"*/, v25);
    sub_1C1ABD4(&StringLiteral_19853/*"forceId"*/, v26);
    sub_1C1ABD4(&StringLiteral_16978/*"aftSquareIndex"*/, v27);
    byte_4BC9531 = 1;
  }
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_24261/*"targetForceId"*/, targetForceId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_24262/*"targetGroupId"*/, targetGroupId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_24265/*"targetPieceIndex"*/, targetPieceIndex, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C1ABD4(&NetworkManager_TypeInfo, method);
    sub_1C1ABD4(&StringLiteral_25037/*"warBoard/masterAttack"*/, v2);
    byte_4BC9530 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63040368(BaseUrl, (System_String_o *)StringLiteral_25037/*"warBoard/masterAttack"*/, 0LL);
}
