        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB772C & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_23891/*"targetGroupId"*/, v20);
    sub_1BAB41C(&StringLiteral_23894/*"targetPieceIndex"*/, v21);
    sub_1BAB41C(&StringLiteral_17184/*"befSquareIndex"*/, v22);
    sub_1BAB41C(&StringLiteral_23890/*"targetForceId"*/, v23);
    sub_1BAB41C(&StringLiteral_22571/*"pieceIndex"*/, v24);
    sub_1BAB41C(&StringLiteral_19884/*"groupId"*/, v25);
    sub_1BAB41C(&StringLiteral_19564/*"forceId"*/, v26);
    sub_1BAB41C(&StringLiteral_16739/*"aftSquareIndex"*/, v27);
    byte_4AB772C = 1;
  }
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23890/*"targetForceId"*/, targetForceId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23891/*"targetGroupId"*/, targetGroupId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23894/*"targetPieceIndex"*/, targetPieceIndex, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BAB41C(&NetworkManager_TypeInfo, method);
    sub_1BAB41C(&StringLiteral_24659/*"warBoard/masterAttack"*/, v2);
    byte_4AB772B = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62048128(BaseUrl, (System_String_o *)StringLiteral_24659/*"warBoard/masterAttack"*/, 0LL);
}
