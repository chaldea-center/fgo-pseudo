void __fastcall CaldeaFolderTutorial___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4354AF3 & 1) == 0 )
  {
    sub_B70694(&CaldeaFolderTutorial_TypeInfo);
    sub_B70694(&Method_System_Collections_Generic_Dictionary_int__CaldeaFolderTutorial_TutorialData__Add__);
    sub_B70694(&Method_System_Collections_Generic_Dictionary_int__CaldeaFolderTutorial_TutorialData___ctor__);
    sub_B70694(&System_Collections_Generic_Dictionary_int__CaldeaFolderTutorial_TutorialData__TypeInfo);
    sub_B70694(&TutorialFlag_ImageId___TypeInfo);
    sub_B70694(&CaldeaFolderTutorial_TutorialData_TypeInfo);
    byte_4354AF3 = 1;
  }
  ...
  v1 = (System_Collections_Generic_Dictionary_int__WarBoardEvalValueSquare_EvalValueSquare__o *)sub_B70764(System_Collections_Generic_Dictionary_int__CaldeaFolderTutorial_TutorialData__TypeInfo);
  System_Collections_Generic_Dictionary_int__WarBoardEvalValueSquare_EvalValueSquare____ctor(
    v1,
    (const MethodInfo_2FC59B4 *)Method_System_Collections_Generic_Dictionary_int__CaldeaFolderTutorial_TutorialData___ctor__);
  CALDEA_GATE_WAR_ID = CaldeaFolderTutorial_TypeInfo->static_fields->CALDEA_GATE_WAR_ID;
  v3 = sub_B706AC(TutorialFlag_ImageId___TypeInfo, 1LL);
  if ( !v3 )
    goto LABEL_11;
  ...
  if ( !*(_DWORD *)(v3 + 24) )
    goto LABEL_12;
  *(_DWORD *)(v3 + 32) = 21;
  v6 = (CaldeaFolderTutorial_TutorialData_o *)sub_B70764(CaldeaFolderTutorial_TutorialData_TypeInfo);
  ...
  System_Collections_Generic_Dictionary_int__WarBoardEvalValueSquare_EvalValueSquare___Add(
    ...
    (const MethodInfo_2FC6568 *)Method_System_Collections_Generic_Dictionary_int__CaldeaFolderTutorial_TutorialData__Add__);
  ...
  if ( !*(_DWORD *)(v3 + 24) )
    goto LABEL_12;
  *(_DWORD *)(v3 + 32) = 22;
  v9 = (CaldeaFolderTutorial_TutorialData_o *)sub_B70764(CaldeaFolderTutorial_TutorialData_TypeInfo);
...
LABEL_12:
  ...
  *(_DWORD *)(v3 + 32) = 33;
  v12 = (CaldeaFolderTutorial_TutorialData_o *)sub_B70764(CaldeaFolderTutorial_TutorialData_TypeInfo);
...
bool __fastcall CaldeaFolderTutorial__CheckTutorial(int32_t warId, System_Action_o *callback, const MethodInfo *method)
{
  ...
  {
    sub_B70694(&CaldeaFolderTutorial_TypeInfo);
    sub_B70694(&Method_System_Collections_Generic_Dictionary_int__CaldeaFolderTutorial_TutorialData__TryGetValue__);
  ...
  if ( !value )
LABEL_20:
    sub_B7076C(FolderTutorials, callback);
  eval = value->fields.eval;
  if ( (BYTE3(TutorialFlag_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0 && !TutorialFlag_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(TutorialFlag_TypeInfo);
  if ( !TutorialFlag__Get_29045252(SLODWORD(eval), 0LL) )
  {
    FolderTutorials = (System_Collections_Generic_Dictionary_int__WarBoardEvalValueSquare_CalcEval__o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2CE992C *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
...
void __fastcall CaldeaFolderTutorial__OnClickHelp(int32_t warId, const MethodInfo *method)
{
  ...
  if ( System_Collections_Generic_Dictionary_int__WarBoardEvalValueSquare_CalcEval___TryGetValue(
         ...
         warId,
         &value,
         (const MethodInfo_2FC828C *)Method_System_Collections_Generic_Dictionary_int__CaldeaFolderTutorial_TutorialData__TryGetValue__) )
  {
    FolderTutorials = (CommonUI_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2CE992C *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    if ( value && FolderTutorials )
    {
      CommonUI__OpenTutorialImageDialog(
        FolderTutorials,
