...
LABEL_55:
      sub_1C32E84(TreasureDeviceSpeedSelect);
    v13 = v12->m_Items[2];
    ...
    if ( max_length >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( !TreasureDeviceSpeedSelect )
          break;
        v31 = (System_String_o **)(v23 == v29 ? &StringLiteral_17446/*"btn_bg_21"*/ : &StringLiteral_17445/*"btn_bg_20"*/);
...
LABEL_54:
      sub_1C32E7C(TreasureDeviceSpeedSelect);
    }
  }
}