        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57E0D & 1) == 0 )
  {
    ...
    this = (ServantStatusListViewItemDrawTdSpeed_o *)sub_1B885B0(&StringLiteral_17480/*"btn_bg_21"*/);
    byte_4A57E0D = 1;
  }
  ...
  if ( item && mode )
  {
    ...
    this = (ServantStatusListViewItemDrawTdSpeed_o *)LocalizationManager__Get(
                                                       (System_String_o *)StringLiteral_11934/*"SERVANT_STATUS_TD_SPEED_FREE"*/,
                                                       0LL);
    if ( !v8 )
      goto LABEL_54;
    ...
    v10 = v9->m_Items[1];
    this = (ServantStatusListViewItemDrawTdSpeed_o *)LocalizationManager__Get(
                                                       (System_String_o *)StringLiteral_11930/*"SERVANT_STATUS_TD_SPEED_ACTUAL"*/,
                                                       0LL);
    if ( !v10 )
      goto LABEL_54;
...
LABEL_55:
    ...
    v12 = v11->m_Items[2];
    this = (ServantStatusListViewItemDrawTdSpeed_o *)LocalizationManager__Get(
                                                       (System_String_o *)StringLiteral_11936/*"SERVANT_STATUS_TD_SPEED_TWICE"*/,
                                                       0LL);
    if ( !v12 )
      goto LABEL_54;
    ...
    this = (ServantStatusListViewItemDrawTdSpeed_o *)LocalizationManager__Get(
                                                       (System_String_o *)StringLiteral_11935/*"SERVANT_STATUS_TD_SPEED_MESSAGE"*/,
                                                       0LL);
    if ( !explanationLabel )
      goto LABEL_54;
    ...
    if ( max_length >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( !this )
          break;
        v30 = (System_String_o **)(v22 == v28 ? &StringLiteral_17480/*"btn_bg_21"*/ : &StringLiteral_17479/*"btn_bg_20"*/);
