...
void FortuneBonusExecDialog__OnClickOkButton(FortuneBonusExecDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C5963F & 1) == 0 )
  {
    sub_1C3E564(&Method_FortuneBonusExecDialog_OnClickOkButton__);
    byte_4C5963F = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_FortuneBonusExecDialog_OnClickOkButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3E57C(Method_FortuneBonusExecDialog_OnClickOkButton__);
    ...
    p_clickFunc->klass = 0;
    sub_1C3E508(p_clickFunc, 0, v7, v8);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C5963E & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_FortuneBonusExecDialog_EndOpened__);
    sub_1C3E564(&LocalizationManager_TypeInfo);
    sub_1C3E564(&StringLiteral_6506/*"FORTUNE_BONUS_EXEC_BUTTON"*/);
    byte_4C5963E = 1;
  }
  ...
  if ( !okBtnLabel )
LABEL_10:
    sub_1C3E7C0(descriptionTexture, nextAction);
  UILabel__set_text(okBtnLabel, (System_String_o *)descriptionTexture, 0);
  this->fields.clickFunc = nextAction;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.clickFunc, (int32_t)nextAction, v7, v8);
