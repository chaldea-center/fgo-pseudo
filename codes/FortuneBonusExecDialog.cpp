...
void __fastcall FortuneBonusExecDialog__OnClickOkButton(FortuneBonusExecDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C24A2C & 1) == 0 )
  {
    sub_1C3B764(&Method_FortuneBonusExecDialog_OnClickOkButton__, method);
    byte_4C24A2C = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_FortuneBonusExecDialog_OnClickOkButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3B77C(Method_FortuneBonusExecDialog_OnClickOkButton__);
    ...
    sub_1C3B708(p_clickFunc, 0LL, v7, v8, v9, v10, v11, v12);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24A2B & 1) == 0 )
  {
    sub_1C3B764(&System_Action_TypeInfo, nextAction);
    sub_1C3B764(&Method_FortuneBonusExecDialog_EndOpened__, v5);
    sub_1C3B764(&LocalizationManager_TypeInfo, v6);
    sub_1C3B764(&StringLiteral_6635/*"Firebase.AppCheck.FirebaseAppCheck, Firebase.AppCheck"*/, v7);
    byte_4C24A2B = 1;
  }
  ...
  descriptionTexture = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6635/*"Firebase.AppCheck.FirebaseAppCheck, Firebase.AppCheck"*/, 0LL);
  if ( !okBtnLabel )
LABEL_10:
    sub_1C3B9C0(descriptionTexture, nextAction);
  UILabel__set_text(okBtnLabel, (System_String_o *)descriptionTexture, 0LL);
  this->fields.clickFunc = nextAction;
  sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.clickFunc, (int64_t)nextAction, v10, v11, v12, v13, v14, v15);
