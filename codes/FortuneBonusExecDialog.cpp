...
void FortuneBonusExecDialog__OnClickOkButton(FortuneBonusExecDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3A36F & 1) == 0 )
  {
    sub_1C32C20(&Method_FortuneBonusExecDialog_OnClickOkButton__);
    byte_4C3A36F = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_FortuneBonusExecDialog_OnClickOkButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C32C38(Method_FortuneBonusExecDialog_OnClickOkButton__);
    ...
    p_clickFunc->klass = 0;
    sub_1C32BC4(p_clickFunc, 0, v7, v8);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3A36E & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_FortuneBonusExecDialog_EndOpened__);
    sub_1C32C20(&LocalizationManager_TypeInfo);
    sub_1C32C20(&StringLiteral_6505/*"FORTUNE_BONUS_EXEC_BUTTON"*/);
    byte_4C3A36E = 1;
  }
  ...
  descriptionTexture = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6505/*"FORTUNE_BONUS_EXEC_BUTTON"*/, 0);
  if ( !okBtnLabel )
LABEL_10:
    sub_1C32E7C(descriptionTexture);
  UILabel__set_text(okBtnLabel, (System_String_o *)descriptionTexture, 0);
  this->fields.clickFunc = nextAction;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.clickFunc, (int32_t)nextAction, v7, v8);
