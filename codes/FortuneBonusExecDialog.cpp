...
void __fastcall FortuneBonusExecDialog__OnClickOkButton(FortuneBonusExecDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB70F2 & 1) == 0 )
  {
    sub_1C13D24(&Method_FortuneBonusExecDialog_OnClickOkButton__, method);
    byte_4BB70F2 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_FortuneBonusExecDialog_OnClickOkButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C13D3C(Method_FortuneBonusExecDialog_OnClickOkButton__);
    ...
    sub_1C13CC8(p_clickFunc, 0LL, v7, v8, v9, v10, v11, v12);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB70F1 & 1) == 0 )
  {
    sub_1C13D24(&System_Action_TypeInfo, nextAction);
    sub_1C13D24(&Method_FortuneBonusExecDialog_EndOpened__, v5);
    sub_1C13D24(&LocalizationManager_TypeInfo, v6);
    sub_1C13D24(&StringLiteral_6628/*"FORTIFICATION_WARNING_DIALOG_CHECKBOX"*/, v7);
    byte_4BB70F1 = 1;
  }
  ...
  descriptionTexture = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6628/*"FORTIFICATION_WARNING_DIALOG_CHECKBOX"*/, 0LL);
  if ( !okBtnLabel )
LABEL_10:
    sub_1C13F80(descriptionTexture, nextAction);
  UILabel__set_text(okBtnLabel, (System_String_o *)descriptionTexture, 0LL);
  this->fields.clickFunc = nextAction;
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.clickFunc, (int64_t)nextAction, v10, v11, v12, v13, v14, v15);
