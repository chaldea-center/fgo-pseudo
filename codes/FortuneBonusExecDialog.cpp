...
void __fastcall FortuneBonusExecDialog__OnClickOkButton(FortuneBonusExecDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B695A0 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_FortuneBonusExecDialog_OnClickOkButton__, method);
    byte_4B695A0 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_FortuneBonusExecDialog_OnClickOkButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BE4AE4(Method_FortuneBonusExecDialog_OnClickOkButton__);
    ...
    sub_1BE4A70(p_clickFunc, 0LL, v7, v8, v9, v10, v11, v12);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6959F & 1) == 0 )
  {
    sub_1BE4ACC(&System_Action_TypeInfo, nextAction);
    sub_1BE4ACC(&Method_FortuneBonusExecDialog_EndOpened__, v5);
    sub_1BE4ACC(&LocalizationManager_TypeInfo, v6);
    sub_1BE4ACC(&StringLiteral_6609/*"FORTUNE_BONUS_EXEC_BUTTON"*/, v7);
    byte_4B6959F = 1;
  }
  ...
  descriptionTexture = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6609/*"FORTUNE_BONUS_EXEC_BUTTON"*/, 0LL);
  if ( !okBtnLabel )
LABEL_10:
    sub_1BE4D28(descriptionTexture, nextAction);
  UILabel__set_text(okBtnLabel, (System_String_o *)descriptionTexture, 0LL);
  this->fields.clickFunc = nextAction;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.clickFunc, (int64_t)nextAction, v10, v11, v12, v13, v14, v15);
