...
void FortuneBonusExecDialog__OnClickOkButton(FortuneBonusExecDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_5973B2D & 1) == 0 )
  {
    sub_2213A60(&Method_FortuneBonusExecDialog_OnClickOkButton__);
    byte_5973B2D = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_FortuneBonusExecDialog_OnClickOkButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_2213A78(Method_FortuneBonusExecDialog_OnClickOkButton__);
    v4 = (System_Reflection_MethodBase_o *)sub_2213A44(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 8, 0, 0);
    ActionExtensions__Call(this->fields.clickFunc, 0);
    this->fields.clickFunc = 0;
    sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields.clickFunc, 0, v5, v6, v7, v8, v9, v10);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5973B2C & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_FortuneBonusExecDialog_EndOpened__);
    sub_2213A60(&LocalizationManager_TypeInfo);
    sub_2213A60(&StringLiteral_6791/*"FORTUNE_BONUS_EXEC_BUTTON"*/);
    byte_5973B2C = 1;
  }
  ...
  descriptionTexture = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6791/*"FORTUNE_BONUS_EXEC_BUTTON"*/, 0);
  if ( !okBtnLabel )
LABEL_10:
    sub_2213CDC(descriptionTexture, nextAction);
  ...
  System_Action___ctor(v14, (Il2CppObject *)this, Method_FortuneBonusExecDialog_EndOpened__, 0);
