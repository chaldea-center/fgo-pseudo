...
void __fastcall FortuneBonusExecDialog__OnClickOkButton(FortuneBonusExecDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B31A3 & 1) == 0 )
  {
    sub_B52984(&Method_FortuneBonusExecDialog_OnClickOkButton__);
    byte_42B31A3 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_FortuneBonusExecDialog_OnClickOkButton__ + 75) & 2) != 0 )
      v3 = (_QWORD *)sub_B5298C(Method_FortuneBonusExecDialog_OnClickOkButton__);
    ...
    sub_B52920(p_clickFunc, 0LL, v7, v8, v9, v10, v11, v12);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B31A2 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_FortuneBonusExecDialog_EndOpened__);
    sub_B52984(&LocalizationManager_TypeInfo);
    sub_B52984(&StringLiteral_6484/*"FORTUNE_BONUS_EXEC_BUTTON"*/);
    byte_42B31A2 = 1;
  }
  ...
  descriptionTexture = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6484/*"FORTUNE_BONUS_EXEC_BUTTON"*/, 0LL);
  if ( !okBtnLabel )
LABEL_11:
    sub_B52A5C(descriptionTexture, nextAction);
