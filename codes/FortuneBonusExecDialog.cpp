...
void __fastcall FortuneBonusExecDialog__OnClickOkButton(FortuneBonusExecDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A309C5 & 1) == 0 )
  {
    sub_1B761C0(&Method_FortuneBonusExecDialog_OnClickOkButton__, method);
    byte_4A309C5 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_FortuneBonusExecDialog_OnClickOkButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B761D8(Method_FortuneBonusExecDialog_OnClickOkButton__);
    ...
    sub_1B76164(p_clickFunc, 0, v7, v8);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A309C4 & 1) == 0 )
  {
    sub_1B761C0(&System_Action_TypeInfo, nextAction);
    sub_1B761C0(&Method_FortuneBonusExecDialog_EndOpened__, v5);
    sub_1B761C0(&LocalizationManager_TypeInfo, v6);
    sub_1B761C0(&StringLiteral_6473/*"FORTUNE_BONUS_EXEC_BUTTON"*/, v7);
    byte_4A309C4 = 1;
  }
  ...
  descriptionTexture = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6473/*"FORTUNE_BONUS_EXEC_BUTTON"*/, 0LL);
  if ( !okBtnLabel )
LABEL_10:
    sub_1B7641C(descriptionTexture, nextAction);
  UILabel__set_text(okBtnLabel, (System_String_o *)descriptionTexture, 0LL);
  this->fields.clickFunc = nextAction;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.clickFunc, (int32_t)nextAction, v10, v11);
