...
UnityEngine_Vector3_array *__fastcall BattleLogicUtilities__getShuffle_Vector3_(
        ...
        const MethodInfo_2E537A4 *method)
{
  ...
  const MethodInfo_2E53900 *v26; // x1

  if ( !method->rgctx_data )
  {
    sub_1B761C0(&System_Random_TypeInfo, method);
    if ( !method->rgctx_data )
      sub_1BC80F8(method);
  }
  v4 = (System_Random_o *)sub_1B7640C(System_Random_TypeInfo);
  ...
  {
    v5 = (Il2CppObject *)sub_1BC809C(method->rgctx_data->_0_T__);
    _0_T = (Il2CppClass *)v5;
  }
  if ( !v7 )
    goto LABEL_18;
  v5 = (Il2CppObject *)sub_1B762FC(v7, _0_T);
  if ( v5 )
  {
...
Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_array *__fastcall BattleLogicUtilities__getShuffle___Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_2E53900 *method)
{
  unsigned __int64 StatusReg; // x19
  const MethodInfo_2E53900_RGCTXs *rgctx_data; // x8
  ...
  v28 = (System_Random_o *)sub_1B7640C(System_Random_TypeInfo);
  ...
  if ( (BYTE5(_0_T->vtable[0].methodPtr) & 1) == 0 )
  {
    v8 = (Il2CppObject *)sub_1BC809C(method->rgctx_data->_0_T__);
    _0_T = (Il2CppClass *)v8;
  }
  v25[1] = StatusReg;
  if ( !v10 )
    goto LABEL_25;
  v8 = (Il2CppObject *)sub_1B762FC(v10, _0_T);
  if ( !v8 )
    sub_1B766DC(v10);
  ...
  if ( (int)monitor >= 2 )
  {
    if ( v28 )
    {
      ...
      do
      {
        ...
        if ( (_1_T[309] & 1) == 0 )
          _1_T = (_BYTE *)sub_1BC809C(_1_T);
        v22 = v26;
        if ( (unsigned int)v20 >= v13->max_length )
          goto LABEL_24;
        sub_1B76168(_1_T, (char *)v13->m_Items + v13->obj.klass->_2.thread_static_fields_size * v20, v7);
