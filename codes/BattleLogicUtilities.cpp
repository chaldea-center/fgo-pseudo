...
UnityEngine_Vector3_array *__fastcall BattleLogicUtilities__getShuffle_Vector3_(
        ...
        const MethodInfo_2FC26F4 *method)
{
  ...
  const MethodInfo_2FC2850 *v27; // x1

  if ( !method->rgctx_data )
  {
    sub_1C2E12C(&System_Random_TypeInfo, method);
    if ( !method->rgctx_data )
      sub_1C80064(method);
  }
  v4 = (System_Random_o *)sub_1C2E378(System_Random_TypeInfo);
  ...
  {
    v5 = (Il2CppObject *)sub_1C80008(v7);
    _0_T = (Il2CppClass *)v5;
  }
  if ( !v8 )
    goto LABEL_18;
  v5 = (Il2CppObject *)sub_1C2E268(v8, _0_T);
  if ( v5 )
  {
...
Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_array *__fastcall BattleLogicUtilities__getShuffle___Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_2FC2850 *method)
{
  unsigned __int64 StatusReg; // x19
  const MethodInfo_2FC2850_RGCTXs *rgctx_data; // x8
  ...
  v31 = (System_Random_o *)sub_1C2E378(System_Random_TypeInfo);
  ...
  if ( (BYTE5(_0_T->vtable[0].methodPtr) & 1) == 0 )
  {
    v8 = (Il2CppObject *)sub_1C80008(v10);
    _0_T = (Il2CppClass *)v8;
  }
  v28[1] = StatusReg;
  if ( !v11 )
    goto LABEL_25;
  v8 = (Il2CppObject *)sub_1C2E268(v11, _0_T);
  if ( !v8 )
    sub_1C2E648(v11);
  ...
  if ( (int)monitor >= 2 )
  {
    if ( v31 )
    {
      ...
      do
      {
        ...
        if ( (_1_T[309] & 1) == 0 )
          _1_T = (_BYTE *)sub_1C80008(v23);
        v24 = v29;
        if ( (unsigned int)v21 >= v14->max_length )
          goto LABEL_24;
        sub_1C2E0D4(_1_T, (char *)v14->m_Items + v14->obj.klass->_2.thread_static_fields_size * v21, v7);
        ...
        if ( (_1_T[309] & 1) == 0 )
        {
          _1_T = (_BYTE *)sub_1C80008(v26);
          v25 = v14->max_length;
        }
        if ( (unsigned int)monitor >= v25 )
LABEL_24:
          sub_1C2E390(_1_T, v18);
        sub_1C2E0D4(
          _1_T,
          (char *)v14->m_Items + v14->obj.klass->_2.thread_static_fields_size * (unsigned __int64)(unsigned int)monitor,
          v24);
