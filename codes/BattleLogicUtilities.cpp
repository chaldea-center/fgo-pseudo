...
UnityEngine_Vector3_array *__fastcall BattleLogicUtilities__getShuffle_Vector3_(
        ...
        const MethodInfo_2FF2A2C *method)
{
  ...
  const MethodInfo_2FF2B88 *v28; // x1

  if ( !method->rgctx_data )
  {
    sub_1BC3008(&System_Random_TypeInfo, method);
    if ( !method->rgctx_data )
      sub_1C134C8(method);
  }
  v4 = (System_Random_o *)sub_1BC3254(System_Random_TypeInfo);
  ...
  {
    v5 = (Il2CppObject *)sub_1C1346C(v7);
    _0_T = (Il2CppClass *)v5;
  }
  if ( !v8 )
    goto LABEL_18;
  v5 = (Il2CppObject *)sub_1BC3144(v8, _0_T);
  if ( v5 )
  {
...
Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_array *__fastcall BattleLogicUtilities__getShuffle___Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_2FF2B88 *method)
{
  unsigned __int64 StatusReg; // x19
  const MethodInfo_2FF2B88_RGCTXs *rgctx_data; // x8
  ...
  v32 = (System_Random_o *)sub_1BC3254(System_Random_TypeInfo);
  ...
  if ( (BYTE5(_0_T->vtable[0].methodPtr) & 1) == 0 )
  {
    v8 = (Il2CppObject *)sub_1C1346C(v10);
    _0_T = (Il2CppClass *)v8;
  }
  v29[1] = StatusReg;
  if ( !v11 )
    goto LABEL_25;
  v8 = (Il2CppObject *)sub_1BC3144(v11, _0_T);
  if ( !v8 )
    sub_1BC3524(v11);
  ...
  if ( (int)monitor >= 2 )
  {
    if ( v32 )
    {
      ...
      do
      {
        ...
        if ( (_1_T[309] & 1) == 0 )
          _1_T = (_BYTE *)sub_1C1346C(v24);
        v25 = v30;
        if ( (unsigned int)v22 >= v14->max_length )
          goto LABEL_24;
        sub_1BC2FB0(_1_T, (char *)v14->m_Items + v14->obj.klass->_2.thread_static_fields_size * v22, v7);
        ...
        if ( (_1_T[309] & 1) == 0 )
        {
          _1_T = (_BYTE *)sub_1C1346C(v27);
          v26 = v14->max_length;
        }
        if ( (unsigned int)monitor >= v26 )
LABEL_24:
          sub_1BC326C(_1_T, v18, v19);
        sub_1BC2FB0(
          _1_T,
          (char *)v14->m_Items + v14->obj.klass->_2.thread_static_fields_size * (unsigned __int64)(unsigned int)monitor,
          v25);
