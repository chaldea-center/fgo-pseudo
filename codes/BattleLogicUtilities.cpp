...
UnityEngine_Vector3_array *__fastcall BattleLogicUtilities__getShuffle_Vector3_(
        ...
        const MethodInfo_1A45CB0 *method)
{
  ...
  const MethodInfo_1A45E1C *v23; // x1
  ...
  if ( (BYTE2(_0_T->vtable[0].methodPtr) & 1) == 0 )
    v5 = (Il2CppObject *)sub_AEB684(method->rgctx_data->_0_T__);
  if ( !v7 )
    goto LABEL_17;
  v5 = (Il2CppObject *)sub_B52A44(v7, _0_T);
  if ( v5 )
  {
...
LABEL_17:
  ...
  v22 = (System_Int32_array *)sub_B52D50(v7);
...
System_Object_array *__fastcall BattleLogicUtilities__getShuffle_object_(
        ...
        const MethodInfo_1A45B40 *method)
{
  System_Random_o *v4; // x19
  Il2CppObject *v5; // x0
  __int64 v6; // x1
  ...
  const MethodInfo_1A45CB0 *v33; // x1
      ...
      do
      {
        ...
        if ( (unsigned int)v13 >= (unsigned int)v10[1].monitor
          ...
          || (klass = (System_Int32_array **)v12->klass,
              v13->klass = v12->klass,
              sub_B52920(v13, klass, v14, v15, v16, v17, v18, v19),
              v11 - 2 >= (unsigned __int64)LODWORD(v10[1].monitor)) )
        {
          v31 = sub_B52A88(v13);
          sub_B52A28(v31, 0LL);
        ...
        sub_B52920(v12, v21, v24, v25, v26, v27, v28, v29);
        --v11;
        --monitor;
...
LABEL_17:
  ...
  v32 = (UnityEngine_Vector3_array *)sub_B52D50(v7);
