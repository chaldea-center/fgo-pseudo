...
UnityEngine_Vector3_array *BattleLogicUtilities__getShuffle_Vector3_(
        ...
        const MethodInfo_30BF440 *method)
{
  ...
  const MethodInfo_30BF59C *v28; // x1
  ...
  {
    v5 = (Il2CppObject *)sub_1C7DBA4(v7);
    _0_T = (Il2CppClass *)v5;
  }
  if ( !v8 )
    goto LABEL_18;
  v5 = (Il2CppObject *)sub_1C2D5CC(v8, _0_T);
  if ( v5 )
  {
    ...
    if ( v4 )
    {
      ...
      do
      {
        ...
        v16 = (unsigned int)v11[1].monitor;
...
Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_array *BattleLogicUtilities__getShuffle___Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_30BF59C *method)
{
  unsigned __int64 StatusReg; // x19
  const MethodInfo_30BF59C_RGCTXs *rgctx_data; // x8
  ...
  v7 = v31;
  v34 = v31;
  memset(v31, 0, actualSize);
  v32 = (System_Random_o *)sub_1C2D6DC(System_Random_TypeInfo);
  System_Random___ctor(v32, 0);
  if ( !list )
    goto LABEL_25;
  ...
  if ( (*(&_0_T->_2.bitflags2 + 2) & 1) == 0 )
  {
    v8 = (Il2CppObject *)sub_1C7DBA4(v10);
    _0_T = (Il2CppClass *)v8;
  }
  v29[1] = StatusReg;
  if ( !v11 )
    goto LABEL_25;
  v8 = (Il2CppObject *)sub_1C2D5CC(v11, _0_T);
  if ( !v8 )
    sub_1C2D9AC(v11);
  ...
  if ( (int)monitor >= 2 )
  {
    if ( v32 )
    {
      ...
      do
      {
        v33 = v15;
        v16 = v7;
        _1_T = (_BYTE *)((__int64 (__fastcall *)(System_Random_o *, _QWORD, const MethodInfo *))v32->klass->vtable._7_Next.methodPtr)(
                          v32,
                          (unsigned int)monitor,
                          v32->klass->vtable._7_Next.method);
        ...
        LODWORD(monitor) = (_DWORD)monitor - 1;
        memcpy(v31, (char *)v14->m_Items + native_size * (int)_1_T, actualSize);
        _1_T = memcpy(v34, v21, actualSize);
        if ( (unsigned int)monitor >= max_length )
          goto LABEL_24;
        v7 = v16;
        _1_T = memcpy(v16, (char *)v14->m_Items + native_size * (unsigned int)monitor, actualSize);
        if ( (unsigned int)v22 >= LODWORD(v14->max_length) )
          goto LABEL_24;
        memcpy((char *)v14->m_Items + (unsigned int)v14->obj.klass->_2.native_size * v22, v16, actualSize);
        _1_T = method->rgctx_data->_1_T;
        if ( (_1_T[309] & 1) == 0 )
          _1_T = (_BYTE *)sub_1C7DBA4(v24);
        v25 = v30;
        if ( (unsigned int)v22 >= LODWORD(v14->max_length) )
          goto LABEL_24;
        sub_1C2D438(_1_T, (char *)v14->m_Items + (unsigned int)v14->obj.klass->_2.native_size * v22, v7);
        _1_T = memcpy(v25, v34, actualSize);
        v26 = v14->max_length;
        ...
        if ( (_1_T[309] & 1) == 0 )
        {
          _1_T = (_BYTE *)sub_1C7DBA4(v27);
          v26 = v14->max_length;
        }
        if ( (unsigned int)monitor >= v26 )
LABEL_24:
          sub_1C2D6F4(_1_T, v18, v19);
        sub_1C2D438(
          _1_T,
          (char *)v14->m_Items + (unsigned int)v14->obj.klass->_2.native_size * (unsigned __int64)(unsigned int)monitor,
          v25);
