        ...
        const MethodInfo *method)
{
  ...
  __int64 v18; // x0
  __int64 v19; // x1
  System_IO_FileInfo_array *Files_63438232; // x20
  ...
  if ( (byte_4B4213D & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_ScriptPlayListViewMenu_OnClickErrorDialog__, v11);
    sub_1BDB878(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v12);
    sub_1BDB878(&StringLiteral_22313/*"not find directory ["*/, v13);
    sub_1BDB878(&StringLiteral_4698/*"Connect Script Error"*/, v14);
    sub_1BDB878(&StringLiteral_808/*"*.txt"*/, v15);
    sub_1BDB878(&StringLiteral_16038/*"]"*/, v16);
    byte_4B4213D = 1;
  }
  v48[0] = 0;
  if ( System_IO_Directory__Exists(path, 0LL) )
  {
    v17 = (System_IO_DirectoryInfo_o *)sub_1BDBAC4(System_IO_DirectoryInfo_TypeInfo);
    System_IO_DirectoryInfo___ctor(v17, path, 0LL);
    if ( !v17 )
      sub_1BDBAD4(v18, v19);
    Files_63438232 = System_IO_DirectoryInfo__GetFiles_63438232(v17, (System_String_o *)StringLiteral_808/*"*.txt"*/, 0LL);
    v21 = (System_Collections_Generic_List_object__o *)sub_1BDBAC4(System_Collections_Generic_List_string__TypeInfo);
    ...
    if ( max_length >= 1 )
    {
      for ( i = 0; i < max_length; ++i )
      {
        ...
        v22 = System_Char__Equals_63622512((uint16_t)v48, 0x2Eu, 0LL);
        if ( !v22 )
        {
          v48[0] = System_String__get_Chars(v30, 0, 0LL);
          if ( !char_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(char_TypeInfo);
          v22 = System_Char__Equals_63622512((uint16_t)v48, 0x5Fu, 0LL);
          if ( !v22 )
          {
            if ( !v21 )
              sub_1BDBAD4(v22, v23);
            ...
            else
            {
              ...
              sub_1BDB81C((CGThumbnailListItem_o *)(v35 + 4), (int32_t)v30, v24, v31);
            }
          }
        }
        max_length = Files_63438232->max_length;
    ...
    sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.scriptFileList, (int32_t)v36, v37, v38);
  }
  else
  {
    v41 = System_String__Concat_62610508(
    ...
    if ( v41 )
    {
      ...
      v43 = (ErrorDialog_ClickDelegate_o *)sub_1BDBAC4(ErrorDialog_ClickDelegate_TypeInfo);
...
LABEL_39:
      sub_1BDBAD4(listViewManager, v39);
    }
  }
...
void __fastcall ScriptPlayListViewMenu__StartInput(ScriptPlayListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B4213E & 1) == 0 )
  {
    sub_1BDB878(&ScriptPlayListViewManager_CallbackFunc_TypeInfo, method);
    sub_1BDB878(&Method_ScriptPlayListViewMenu_OnClickItem__, v3);
    byte_4B4213E = 1;
  }
  this->fields.state = 3;
  listViewManager = this->fields.listViewManager;
  v5 = (ScriptPlayListViewManager_CallbackFunc_o *)sub_1BDBAC4(ScriptPlayListViewManager_CallbackFunc_TypeInfo);
  ScriptPlayListViewManager_CallbackFunc___ctor(
    ...
    v6);
  if ( !listViewManager
    || (ScriptPlayListViewManager__SetMode_36523396(listViewManager, 1, v5, v9),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4213A & 1) == 0 )
  {
    sub_1BDB878(&ScriptPlayListViewMenu_CallbackFunc_TypeInfo, value);
    byte_4B4213A = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A228D4;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A2287C;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4213F & 1) == 0 )
  {
    sub_1BDB878(&ScriptPlayListViewMenu_ResultKind_TypeInfo, *(_QWORD *)&result);
    byte_4B4213F = 1;
  }
  v11[2] = 0LL;
