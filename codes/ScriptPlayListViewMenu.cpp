        ...
        const MethodInfo *method)
{
  ...
  if ( callbackFunc )
  {
    ...
    sub_1BE4A70(p_callbackFunc, 0LL, (int64_t)objectName, (int32_t)method, v4, v5, v6, v7);
...
void __fastcall ScriptPlayListViewMenu__Close(ScriptPlayListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.scriptFileList )
  {
    ...
    sub_1BE4A70(p_scriptFileList, 0LL, v4, v5, v6, v7, v8, v9);
  }
...
void __fastcall ScriptPlayListViewMenu__OnClickUpdate(ScriptPlayListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.state == 3 )
  {
    ...
    sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.scriptFileList, 0LL, v5, v6, v7, v8, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B64378 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_UnityEngine_Component_GetComponent_UIInput___, path);
    byte_4B64378 = 1;
  }
...
LABEL_6:
      ...
      if ( !scriptTestDefaultNameLabel
        ...
        || (scriptTestObjectRootObject = (UnityEngine_GameObject_o *)UnityEngine_Component__GetComponent_object_(
                                                                       ...
                                                                       (const MethodInfo_2F4FBB4 *)Method_UnityEngine_Component_GetComponent_UIInput___)) == 0LL )
      {
LABEL_20:
        sub_1BE4D28(scriptTestObjectRootObject, v19);
      }
      UIInput__set_value((UIInput_o *)scriptTestObjectRootObject, jumpLine, 0LL);
      this->fields.state = 1;
      this->fields.scriptFileList = 0LL;
      sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.scriptFileList, 0LL, v24, v25, v26, v27, v28, v29);
        ...
        const MethodInfo *method)
{
  ...
  __int64 v18; // x0
  __int64 v19; // x1
  System_IO_FileInfo_array *Files_62887164; // x20
  ...
  if ( (byte_4B64379 & 1) == 0 )
  {
    sub_1BE4ACC(&char_TypeInfo, path);
    sub_1BE4ACC(&ErrorDialog_ClickDelegate_TypeInfo, v5);
    sub_1BE4ACC(&System_IO_DirectoryInfo_TypeInfo, v6);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_string__Add__, v7);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_string__ToArray__, v8);
    ...
    sub_1BE4ACC(&Method_ScriptPlayListViewMenu_OnClickErrorDialog__, v11);
    sub_1BE4ACC(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v12);
    sub_1BE4ACC(&StringLiteral_22454/*"not find directory ["*/, v13);
    sub_1BE4ACC(&StringLiteral_4768/*"Connect Script Error"*/, v14);
    sub_1BE4ACC(&StringLiteral_851/*"*.txt"*/, v15);
    sub_1BE4ACC(&StringLiteral_16276/*"]"*/, v16);
    byte_4B64379 = 1;
  }
  v56[0] = 0;
  if ( System_IO_Directory__Exists(path, 0LL) )
  {
    v17 = (System_IO_DirectoryInfo_o *)sub_1BE4D18(System_IO_DirectoryInfo_TypeInfo);
    System_IO_DirectoryInfo___ctor(v17, path, 0LL);
    if ( !v17 )
      sub_1BE4D28(v18, v19);
    Files_62887164 = System_IO_DirectoryInfo__GetFiles_62887164(v17, (System_String_o *)StringLiteral_851/*"*.txt"*/, 0LL);
    v21 = (System_Collections_Generic_List_object__o *)sub_1BE4D18(System_Collections_Generic_List_string__TypeInfo);
    System_Collections_Generic_List_object____ctor(
      v21,
      (const MethodInfo_35EB9F0 *)Method_System_Collections_Generic_List_string___ctor__);
    if ( !Files_62887164 )
      sub_1BE4D28(v22, v23);
    max_length = Files_62887164->max_length;
    if ( max_length >= 1 )
    {
      for ( i = 0; i < max_length; ++i )
      {
        ...
        v22 = System_Char__Equals_63330772((uint16_t)v56, 0x2Eu, 0LL);
        if ( !v22 )
        {
          v56[0] = System_String__get_Chars(v29, 0, 0LL);
          if ( !char_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(char_TypeInfo);
          v22 = System_Char__Equals_63330772((uint16_t)v56, 0x5Fu, 0LL);
          if ( !v22 )
          {
            if ( !v21 )
              sub_1BE4D28(v22, v23);
            ...
            else
            {
              ...
              sub_1BE4A70((PartyOrganizationUtility_o *)(v39 + 4), (int64_t)v29, v30, v31, v32, v33, v34, v35);
            }
          }
        }
        max_length = Files_62887164->max_length;
    ...
    sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.scriptFileList, (int64_t)v40, v41, v42, v43, v44, v45, v46);
  }
  else
  {
    v49 = System_String__Concat_62710068(
            (System_String_o *)StringLiteral_22454/*"not find directory ["*/,
            path,
    ...
    if ( v49 )
    {
      ...
      v51 = (ErrorDialog_ClickDelegate_o *)sub_1BE4D18(ErrorDialog_ClickDelegate_TypeInfo);
      ...
      if ( Instance )
      {
        *(_QWORD *)&effectDistance.fields.hasValue = 0LL;
        ...
        CommonUI__OpenWarningDialog(
          (CommonUI_o *)Instance,
          (System_String_o *)StringLiteral_4768/*"Connect Script Error"*/,
          v49,
          v51,
          1,
          0,
...
LABEL_39:
      sub_1BE4D28(listViewManager, v47);
    }
  }
...
void __fastcall ScriptPlayListViewMenu__StartInput(ScriptPlayListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6437A & 1) == 0 )
  {
    sub_1BE4ACC(&ScriptPlayListViewManager_CallbackFunc_TypeInfo, method);
    sub_1BE4ACC(&Method_ScriptPlayListViewMenu_OnClickItem__, v3);
    byte_4B6437A = 1;
  }
  this->fields.state = 3;
  listViewManager = this->fields.listViewManager;
  v5 = (ScriptPlayListViewManager_CallbackFunc_o *)sub_1BE4D18(ScriptPlayListViewManager_CallbackFunc_TypeInfo);
  ScriptPlayListViewManager_CallbackFunc___ctor(
    ...
    v6);
  if ( !listViewManager
    || (ScriptPlayListViewManager__SetMode_35747720(listViewManager, 1, v5, v9),
  ...
  {
    sub_1BE4D28(scriptTestObjectCancelButton, v8);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B64376 & 1) == 0 )
  {
    sub_1BE4ACC(&ScriptPlayListViewMenu_CallbackFunc_TypeInfo, value);
    byte_4B64376 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A24360;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A24308;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6437B & 1) == 0 )
  {
    sub_1BE4ACC(&ScriptPlayListViewMenu_ResultKind_TypeInfo, *(_QWORD *)&result);
    byte_4B6437B = 1;
  }
  v11[2] = 0LL;
