        ...
        const MethodInfo *method)
{
  ...
  __int64 v6; // x0
  __int64 v7; // x1
  System_IO_FileInfo_array *Files_65288580; // x20
  ...
  if ( (byte_4D2DFDC & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_ScriptPlayListViewMenu_OnClickErrorDialog__);
  ...
  {
    v5 = (System_IO_DirectoryInfo_o *)sub_1C93D20(System_IO_DirectoryInfo_TypeInfo);
    System_IO_DirectoryInfo___ctor(v5, path, 0);
    if ( !v5 )
      sub_1C93D2C(v6, v7);
    Files_65288580 = System_IO_DirectoryInfo__GetFiles_65288580(v5, (System_String_o *)StringLiteral_797/*"*.txt"*/, 0);
    ...
    if ( max_length >= 1 )
    {
      for ( i = 0; i < max_length; ++i )
      {
        ...
        v10 = System_Char__Equals_65488192((uint16_t)v44, 0x2Eu, 0);
        if ( !v10 )
        {
          v44[0] = System_String__get_Chars(v17, 0, 0);
          if ( !char_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(char_TypeInfo);
          v10 = System_Char__Equals_65488192((uint16_t)v44, 0x5Fu, 0);
          if ( !v10 )
          {
            if ( !v9 )
              sub_1C93D2C(v10, v11);
    ...
    sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.scriptFileList, (int32_t)v28, v29, v30, v31, v32, v33, v34);
  }
  else
  {
    ...
    if ( v37 )
    {
      ...
      v39 = (ErrorDialog_ClickDelegate_o *)sub_1C93D20(ErrorDialog_ClickDelegate_TypeInfo);
...
LABEL_39:
      sub_1C93D2C(listViewManager, v35);
    }
  }
...
void ScriptPlayListViewMenu__StartInput(ScriptPlayListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2DFDD & 1) == 0 )
  {
    sub_1C93AD4(&ScriptPlayListViewManager_CallbackFunc_TypeInfo);
    sub_1C93AD4(&Method_ScriptPlayListViewMenu_OnClickItem__);
    byte_4D2DFDD = 1;
  }
  this->fields.state = 3;
  listViewManager = this->fields.listViewManager;
  v4 = (ScriptPlayListViewManager_CallbackFunc_o *)sub_1C93D20(ScriptPlayListViewManager_CallbackFunc_TypeInfo);
  ScriptPlayListViewManager_CallbackFunc___ctor(
    ...
    v5);
  if ( !listViewManager
    || (ScriptPlayListViewManager__SetMode_38155592(listViewManager, 1, v4, v8),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2DFD9 & 1) == 0 )
  {
    sub_1C93AD4(&ScriptPlayListViewMenu_CallbackFunc_TypeInfo);
    byte_4D2DFD9 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1AC613C;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1AC60E4;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2DFDE & 1) == 0 )
  {
    sub_1C93AD4(&ScriptPlayListViewMenu_ResultKind_TypeInfo);
    byte_4D2DFDE = 1;
  }
  v11[2] = 0;
