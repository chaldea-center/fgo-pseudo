        ...
        const MethodInfo *method)
{
  ...
  __int64 v18; // x0
  __int64 v19; // x1
  System_IO_FileInfo_array *Files_63156300; // x20
  ...
  if ( (byte_4BB1E93 & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_ScriptPlayListViewMenu_OnClickErrorDialog__, v11);
    sub_1C13D24(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v12);
    sub_1C13D24(&StringLiteral_22506/*"noneSupportFriendPoint"*/, v13);
    sub_1C13D24(&StringLiteral_4771/*"Conflict"*/, v14);
    sub_1C13D24(&StringLiteral_854/*"*.txt"*/, v15);
    sub_1C13D24(&StringLiteral_16320/*"\\p{_xmlI}"*/, v16);
    byte_4BB1E93 = 1;
  }
  v56[0] = 0;
  if ( System_IO_Directory__Exists(path, 0LL) )
  {
    v17 = (System_IO_DirectoryInfo_o *)sub_1C13F70(System_IO_DirectoryInfo_TypeInfo);
    System_IO_DirectoryInfo___ctor(v17, path, 0LL);
    if ( !v17 )
      sub_1C13F80(v18, v19);
    Files_63156300 = System_IO_DirectoryInfo__GetFiles_63156300(v17, (System_String_o *)StringLiteral_854/*"*.txt"*/, 0LL);
    v21 = (System_Collections_Generic_List_object__o *)sub_1C13F70(System_Collections_Generic_List_string__TypeInfo);
    ...
    if ( max_length >= 1 )
    {
      for ( i = 0; i < max_length; ++i )
      {
        ...
        v22 = System_Char__Equals_63599908((uint16_t)v56, 0x2Eu, 0LL);
        if ( !v22 )
        {
          v56[0] = System_String__get_Chars(v29, 0, 0LL);
          if ( !char_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(char_TypeInfo);
          v22 = System_Char__Equals_63599908((uint16_t)v56, 0x5Fu, 0LL);
          if ( !v22 )
          {
            if ( !v21 )
              sub_1C13F80(v22, v23);
            ...
            else
            {
              ...
              sub_1C13CC8((PartyOrganizationUtility_o *)(v39 + 4), (int64_t)v29, v30, v31, v32, v33, v34, v35);
            }
          }
        }
        max_length = Files_63156300->max_length;
    ...
    sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.scriptFileList, (int64_t)v40, v41, v42, v43, v44, v45, v46);
  }
  else
  {
    v49 = System_String__Concat_62979204(
    ...
    if ( v49 )
    {
      ...
      v51 = (ErrorDialog_ClickDelegate_o *)sub_1C13F70(ErrorDialog_ClickDelegate_TypeInfo);
...
LABEL_39:
      sub_1C13F80(listViewManager, v47);
    }
  }
...
void __fastcall ScriptPlayListViewMenu__StartInput(ScriptPlayListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB1E94 & 1) == 0 )
  {
    sub_1C13D24(&ScriptPlayListViewManager_CallbackFunc_TypeInfo, method);
    sub_1C13D24(&Method_ScriptPlayListViewMenu_OnClickItem__, v3);
    byte_4BB1E94 = 1;
  }
  this->fields.state = 3;
  listViewManager = this->fields.listViewManager;
  v5 = (ScriptPlayListViewManager_CallbackFunc_o *)sub_1C13F70(ScriptPlayListViewManager_CallbackFunc_TypeInfo);
  ScriptPlayListViewManager_CallbackFunc___ctor(
    ...
    v6);
  if ( !listViewManager
    || (ScriptPlayListViewManager__SetMode_35977220(listViewManager, 1, v5, v9),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB1E90 & 1) == 0 )
  {
    sub_1C13D24(&ScriptPlayListViewMenu_CallbackFunc_TypeInfo, value);
    byte_4BB1E90 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A52BBC;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A52B64;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB1E95 & 1) == 0 )
  {
    sub_1C13D24(&ScriptPlayListViewMenu_ResultKind_TypeInfo, *(_QWORD *)&result);
    byte_4BB1E95 = 1;
  }
  v11[2] = 0LL;
