        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1D9C9 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_5573/*"EVENT_INFO_EQUIP_SKILL_PARTS_SKILL_NAME"*/, v9);
    sub_1BCAFF8(&StringLiteral_5572/*"EVENT_INFO_EQUIP_SKILL_PARTS_SKILL_CHARGE_TURN"*/, v10);
    byte_4B1D9C9 = 1;
  }
  ...
  v24 = LocalizationManager__Get((System_String_o *)StringLiteral_5573/*"EVENT_INFO_EQUIP_SKILL_PARTS_SKILL_NAME"*/, 0LL);
  v25 = (System_Object_array *)sub_1BCB0A0(object___TypeInfo, 2LL);
  ...
  if ( SkillName )
  {
    SkillName = sub_1BCB134(SkillName, v25->obj.klass->_1.element_class);
    if ( !SkillName )
      goto LABEL_30;
  }
  if ( !v25->max_length )
...
LABEL_30:
  ...
  if ( v25->max_length <= 1 )
    goto LABEL_29;
  v25->m_Items[1] = v33;
  sub_1BCAF9C((CGThumbnailListItem_o *)&v25->m_Items[1], (int32_t)v33, v26, v32);
  UILabelHelper__SetTextSafely_43284936(skillNameLabel, v24, v25, 0LL);
  skillChargeTurnLabel = this->fields.skillChargeTurnLabel;
  v35 = LocalizationManager__Get((System_String_o *)StringLiteral_5572/*"EVENT_INFO_EQUIP_SKILL_PARTS_SKILL_CHARGE_TURN"*/, 0LL);
  v36 = (System_Object_array *)sub_1BCB0A0(object___TypeInfo, 1LL);
  ...
  if ( !v36 )
LABEL_28:
    sub_1BCB254(SkillName, v13);
  v41 = (Il2CppObject *)SkillName;
  if ( SkillName )
  {
    SkillName = sub_1BCB134(SkillName, v36->obj.klass->_1.element_class);
    if ( !SkillName )
      goto LABEL_30;
  }
  if ( !v36->max_length )
LABEL_29:
    sub_1BCB25C(SkillName, v13, v26);
  v36->m_Items[0] = v41;
  sub_1BCAF9C((CGThumbnailListItem_o *)v36->m_Items, (int32_t)v41, v26, v40);
  UILabelHelper__SetTextSafely_43284936(skillChargeTurnLabel, v35, v36, 0LL);
