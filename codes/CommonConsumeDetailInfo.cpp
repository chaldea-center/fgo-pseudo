        ...
        const MethodInfo *method)
{
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields, (int32_t)commonConsumeEntity, v9, v10);
  this->fields.targetEntity = targetEntity;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.targetEntity, (int32_t)targetEntity, v11, v12);
  this->fields.userOwnStatusEntity = userOwnStatusEntity;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.userOwnStatusEntity, (int32_t)userOwnStatusEntity, v13, v14);
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields._Name_k__BackingField, (int32_t)TargetName, v19, v20);
...
bool CommonConsumeDetailInfo__CheckIsOwnedEnoughly(CommonConsumeDetailInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C567EE & 1) == 0 )
  {
    sub_1C3E564(&ItemEntity_TypeInfo);
