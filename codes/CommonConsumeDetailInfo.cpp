        ...
        const MethodInfo *method)
{
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)commonConsumeEntity, v9, v10);
  this->fields.targetEntity = targetEntity;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.targetEntity, (int32_t)targetEntity, v11, v12);
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields._Name_k__BackingField, (int32_t)TargetName, v19, v20);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2DA54 & 1) == 0 )
  {
    sub_1B761C0(&ItemEntity_TypeInfo, method);
    sub_1B761C0(&UserItemEntity_TypeInfo, v3);
    byte_4A2DA54 = 1;
  }
