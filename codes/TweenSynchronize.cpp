void __fastcall TweenSynchronize___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A51B35 & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Collections_Generic_List_UITweener___ctor__, v1);
    sub_1B863B8(&System_Collections_Generic_List_UITweener__TypeInfo, v2);
    sub_1B863B8(&TweenSynchronize_TypeInfo, v3);
    byte_4A51B35 = 1;
  }
  v4 = (System_Collections_Generic_List_object__o *)sub_1B86604(System_Collections_Generic_List_UITweener__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v4,
    (const MethodInfo_35FC124 *)Method_System_Collections_Generic_List_UITweener___ctor__);
  TweenSynchronize_TypeInfo->static_fields->tweenerList = (struct System_Collections_Generic_List_UITweener__o *)v4;
  sub_1B8635C((CGThumbnailListItem_o *)TweenSynchronize_TypeInfo->static_fields, (int32_t)v4, v5, v6);
}
...
void __fastcall TweenSynchronize__Awake(TweenSynchronize_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A51B32 & 1) == 0 )
  {
    sub_1B863B8(&Method_UnityEngine_Component_GetComponent_UITweener___, method);
    sub_1B863B8(&Method_System_Collections_Generic_List_UITweener__Add__, v3);
    sub_1B863B8(&Method_System_Collections_Generic_List_UITweener__Contains__, v4);
    sub_1B863B8(&TweenSynchronize_TypeInfo, v5);
    byte_4A51B32 = 1;
  }
  Component_object = UnityEngine_Component__GetComponent_object_(
                       (UnityEngine_Component_o *)this,
                       (const MethodInfo_2F646C0 *)Method_UnityEngine_Component_GetComponent_UITweener___);
  this->fields.tweener = (struct UITweener_o *)Component_object;
  p_tweener = &this->fields.tweener;
  sub_1B8635C((CGThumbnailListItem_o *)p_tweener, (int32_t)Component_object, v8, v9);
  ...
  if ( System_Collections_Generic_List_object___Contains(
         ...
         (const MethodInfo_35FCCE8 *)Method_System_Collections_Generic_List_UITweener__Contains__) )
  {
    return;
  }
...
LABEL_14:
  ...
  else
  {
    ...
    sub_1B8635C((CGThumbnailListItem_o *)(v19 + 4), (int32_t)v10, v13, v14);
  }
}
...
void __fastcall TweenSynchronize__OnDestroy(TweenSynchronize_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A51B33 & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Collections_Generic_List_UITweener__Remove__, method);
    sub_1B863B8(&TweenSynchronize_TypeInfo, v3);
    byte_4A51B33 = 1;
  }
  ...
  System_Collections_Generic_List_object___Remove(
    ...
    (const MethodInfo_35FDE80 *)Method_System_Collections_Generic_List_UITweener__Remove__);
}
...
void __fastcall TweenSynchronize__synchronize(TweenSynchronize_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A51B34 & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Collections_Generic_List_Enumerator_UITweener__Dispose__, method);
    sub_1B863B8(&Method_System_Collections_Generic_List_Enumerator_UITweener__MoveNext__, v3);
    sub_1B863B8(&Method_System_Collections_Generic_List_Enumerator_UITweener__get_Current__, v4);
    sub_1B863B8(&Method_System_Collections_Generic_List_UITweener__GetEnumerator__, v5);
    sub_1B863B8(&UnityEngine_Object_TypeInfo, v6);
    sub_1B863B8(&TweenSynchronize_TypeInfo, v7);
    byte_4A51B34 = 1;
  }
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    tweenerList,
    (const MethodInfo_35FD450 *)Method_System_Collections_Generic_List_UITweener__GetEnumerator__);
  v20 = v19;
  while ( 1 )
  {
    v10 = System_Collections_Generic_List_Enumerator_object___MoveNext(
            &v20,
            (const MethodInfo_3398634 *)Method_System_Collections_Generic_List_Enumerator_UITweener__MoveNext__);
    if ( !v10 )
      break;
  ...
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v20,
    (const MethodInfo_3398630 *)Method_System_Collections_Generic_List_Enumerator_UITweener__Dispose__);
}