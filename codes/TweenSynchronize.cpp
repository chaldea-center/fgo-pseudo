void TweenSynchronize___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E7B2AD & 1) == 0 )
  {
    sub_1D0F0B4(&Method_System_Collections_Generic_List_UITweener___ctor__);
    sub_1D0F0B4(&System_Collections_Generic_List_UITweener__TypeInfo);
    sub_1D0F0B4(&TweenSynchronize_TypeInfo);
    byte_4E7B2AD = 1;
  }
  v1 = (System_Collections_Generic_List_object__o *)sub_1D0F300(System_Collections_Generic_List_UITweener__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v1,
    (const MethodInfo_395BBDC *)Method_System_Collections_Generic_List_UITweener___ctor__);
...
void TweenSynchronize__Awake(TweenSynchronize_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E7B2AA & 1) == 0 )
  {
    sub_1D0F0B4(&Method_UnityEngine_Component_GetComponent_UITweener___);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_UITweener__Add__);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_UITweener__Contains__);
    sub_1D0F0B4(&TweenSynchronize_TypeInfo);
    byte_4E7B2AA = 1;
  }
  Component_object = UnityEngine_Component__GetComponent_object_(
                       (UnityEngine_Component_o *)this,
                       (const MethodInfo_3245988 *)Method_UnityEngine_Component_GetComponent_UITweener___);
  this->fields.tweener = (struct UITweener_o *)Component_object;
  p_tweener = &this->fields.tweener;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)p_tweener, (int32_t)Component_object, v5, v6, v7, v8, v9, v10);
  ...
  if ( System_Collections_Generic_List_object___Contains(
         ...
         (const MethodInfo_395C7A0 *)Method_System_Collections_Generic_List_UITweener__Contains__) )
  {
    return;
  }
...
void TweenSynchronize__OnDestroy(TweenSynchronize_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E7B2AB & 1) == 0 )
  {
    sub_1D0F0B4(&Method_System_Collections_Generic_List_UITweener__Remove__);
    sub_1D0F0B4(&TweenSynchronize_TypeInfo);
    byte_4E7B2AB = 1;
  }
  ...
  System_Collections_Generic_List_object___Remove(
    ...
    (const MethodInfo_395D938 *)Method_System_Collections_Generic_List_UITweener__Remove__);
}
...
void TweenSynchronize__synchronize(TweenSynchronize_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E7B2AC & 1) == 0 )
  {
    sub_1D0F0B4(&Method_System_Collections_Generic_List_Enumerator_UITweener__Dispose__);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_Enumerator_UITweener__MoveNext__);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_Enumerator_UITweener__get_Current__);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_UITweener__GetEnumerator__);
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    tweenerList,
    (const MethodInfo_395CF08 *)Method_System_Collections_Generic_List_UITweener__GetEnumerator__);
  v15 = v14;
  while ( 1 )
  {
    v5 = System_Collections_Generic_List_Enumerator_object___MoveNext(
           &v15,
           (const MethodInfo_36CDF88 *)Method_System_Collections_Generic_List_Enumerator_UITweener__MoveNext__);
    if ( !v5 )
      break;
  ...
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v15,
    (const MethodInfo_36CDF84 *)Method_System_Collections_Generic_List_Enumerator_UITweener__Dispose__);
}