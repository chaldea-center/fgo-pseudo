void WarBoardAIEntity___ctor(WarBoardAIEntity_o *this, const MethodInfo *method)
{
  ...
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields.actionTrendIds, (int32_t)v4, v5, v6, v7, v8, v9, v10);
  v11 = (struct System_Int32_array *)sub_2213B20(int___TypeInfo, 0);
...
System_Int32_array *WarBoardAIEntity__GetActionTrendIds(WarBoardAIEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_5971A15 & 1) == 0 )
  {
    sub_2213A60(&Method_DataManager_GetMaster_WarBoardActionTrendGroupMaster___);
    sub_2213A60(&DataManager_TypeInfo);
    sub_2213A60(&Method_DataMasterBase_WarBoardActionTrendGroupMaster__WarBoardActionTrendGroupEntity__int__TryGetEntity__);
  ...
  if ( ((unsigned __int8)IsNullOrEmpty & 1) == 0 )
  {
    ...
    if ( (int)max_length >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        IsNullOrEmpty = DataManager__GetMaster_object_((const MethodInfo_3856318 *)Method_DataManager_GetMaster_WarBoardActionTrendGroupMaster___);
        if ( !IsNullOrEmpty )
          break;
        IsNullOrEmpty = (Il2CppObject *)DataMasterBase_object__object__int___TryGetEntity(
                                          ...
                                          &entity,
                                          v10,
                                          (const MethodInfo_3F10B80 *)Method_DataMasterBase_WarBoardActionTrendGroupMaster__WarBoardActionTrendGroupEntity__int__TryGetEntity__);
        if ( ((unsigned __int8)IsNullOrEmpty & 1) != 0 )
        {
          if ( !entity || !v4 )
            break;
...
LABEL_16:
  if ( !v4 )
    goto LABEL_18;
  v11 = (System_Int32_array *)sub_2213B20(int___TypeInfo, (unsigned int)v4->fields._count);
...
System_Int32_array *WarBoardAIEntity__GetRatingOffsetIds(WarBoardAIEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_5971A16 & 1) == 0 )
  {
    sub_2213A60(&Method_DataManager_GetMaster_WarBoardRatingOffsetGroupMaster___);
    sub_2213A60(&DataManager_TypeInfo);
    sub_2213A60(&Method_DataMasterBase_WarBoardRatingOffsetGroupMaster__WarBoardRatingOffsetGroupEntity__int__TryGetEntity__);
    sub_2213A60(&Method_System_Collections_Generic_HashSet_int__CopyTo__);
    sub_2213A60(&Method_System_Collections_Generic_HashSet_int__UnionWith__);
    sub_2213A60(&Method_System_Collections_Generic_HashSet_int___ctor___91630040);
    sub_2213A60(&Method_System_Collections_Generic_HashSet_int__get_Count__);
  ...
  if ( ((unsigned __int8)IsNullOrEmpty & 1) == 0 )
  {
    ...
    if ( (int)max_length >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( !*(&DataManager_TypeInfo->_2.cctor_finished + 1) )
          j_il2cpp_runtime_class_init_0(DataManager_TypeInfo, v6);
        IsNullOrEmpty = DataManager__GetMaster_object_((const MethodInfo_3856318 *)Method_DataManager_GetMaster_WarBoardRatingOffsetGroupMaster___);
        if ( !IsNullOrEmpty )
          break;
        IsNullOrEmpty = (Il2CppObject *)DataMasterBase_object__object__int___TryGetEntity(
                                          (DataMasterBase_TMaster__TEntity__PKType__o *)IsNullOrEmpty,
                                          &entity,
                                          v10,
                                          (const MethodInfo_3F10B80 *)Method_DataMasterBase_WarBoardRatingOffsetGroupMaster__WarBoardRatingOffsetGroupEntity__int__TryGetEntity__);
        if ( ((unsigned __int8)IsNullOrEmpty & 1) != 0 )
        {
          if ( !entity || !v4 )
            break;
