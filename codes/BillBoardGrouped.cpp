...
void BillBoardGrouped__LateUpdate(BillBoardGrouped_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC6771 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_SingletonMonoBehaviour_BillBoardGroupManager__get_Instance__);
    byte_4CC6771 = 1;
  }
  ...
  if ( grouping != 1 )
  {
    if ( !grouping )
    {
      ...
      v9 = p_targetFov[6];
LABEL_21:
      v23 = UnityEngine_Quaternion__LookRotation_71662888(*(UnityEngine_Vector3_o *)&v7, 0);
      if ( mTrf )
      {
        v15 = mTrf;
        goto LABEL_23;
...
LABEL_24:
    ...
    Instance = (BillBoardGroupManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A5F158 *)Method_SingletonMonoBehaviour_BillBoardGroupManager__get_Instance__);
    if ( !Instance )
      goto LABEL_24;
...
LABEL_19:
  ...
  if ( !this->fields.enableRotationZ )
    v12 = 0.0;
  v23 = UnityEngine_Quaternion__LookRotation_71662888(*(UnityEngine_Vector3_o *)&v13, 0);
  if ( !v11 )
    goto LABEL_24;
  v15 = v11;
LABEL_23:
...
void BillBoardGrouped__Update(BillBoardGrouped_o *this, const MethodInfo *method)
{
  ...
  {
    Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A5F158 *)Method_SingletonMonoBehaviour_BillBoardGroupManager__get_Instance__);
    grouping = this->fields.grouping;
