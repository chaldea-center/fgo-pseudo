...
void __fastcall BillBoardGrouped__LateUpdate(BillBoardGrouped_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5A5BD & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_SingletonMonoBehaviour_BillBoardGroupManager__get_Instance__);
    byte_4A5A5BD = 1;
  }
  ...
  if ( grouping != 1 )
  {
    if ( !grouping )
    {
      ...
      v9 = p_targetFov[6];
LABEL_21:
      *(UnityEngine_Quaternion_o *)&v15 = UnityEngine_Quaternion__LookRotation_69397740(
...
LABEL_24:
    ...
    Instance = (BillBoardGroupManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_BillBoardGroupManager__get_Instance__);
    if ( !Instance )
      goto LABEL_24;
...
LABEL_19:
  ...
  if ( !this->fields.enableRotationZ )
    v12 = 0.0;
  *(UnityEngine_Quaternion_o *)&v15 = UnityEngine_Quaternion__LookRotation_69397740(*(UnityEngine_Vector3_o *)&v13, 0LL);
  if ( !v11 )
    goto LABEL_24;
  v19 = v11;
LABEL_23:
...
void __fastcall BillBoardGrouped__Update(BillBoardGrouped_o *this, const MethodInfo *method)
{
  ...
  {
    Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_BillBoardGroupManager__get_Instance__);
    grouping = this->fields.grouping;
