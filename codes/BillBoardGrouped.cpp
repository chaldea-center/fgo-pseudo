...
void __fastcall BillBoardGrouped__LateUpdate(BillBoardGrouped_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42AFCF7 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_SingletonMonoBehaviour_BillBoardGroupManager__get_Instance__);
    byte_42AFCF7 = 1;
  }
  ...
  if ( grouping != 1 )
  {
    if ( !grouping )
    {
      ...
      v9 = p_targetFov[6];
LABEL_20:
      *(UnityEngine_Quaternion_o *)&v15 = UnityEngine_Quaternion__LookRotation_35647968(
...
LABEL_23:
    ...
    Instance = (BillBoardGroupManager_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_BillBoardGroupManager__get_Instance__);
    if ( !Instance )
      goto LABEL_23;
...
LABEL_18:
  ...
  if ( !this->fields.enableRotationZ )
    v12 = 0.0;
  *(UnityEngine_Quaternion_o *)&v15 = UnityEngine_Quaternion__LookRotation_35647968(*(UnityEngine_Vector3_o *)&v13, 0LL);
  if ( !v11 )
    goto LABEL_23;
  v19 = v11;
LABEL_22:
...
void __fastcall BillBoardGrouped__Update(BillBoardGrouped_o *this, const MethodInfo *method)
{
  ...
  {
    Instance = SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_BillBoardGroupManager__get_Instance__);
    grouping = this->fields.grouping;
