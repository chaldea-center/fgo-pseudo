void __fastcall RetryConfirmItem___cctor(const MethodInfo *method)
{
  if ( (byte_4354368 & 1) == 0 )
  {
    sub_B70694(&RetryConfirmItem_TypeInfo);
    byte_4354368 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4354367 & 1) == 0 )
  {
    sub_B70694(&RetryConfirmItem__SetCondensedScalePossessionAmount_d__7_TypeInfo);
    byte_4354367 = 1;
  }
  v3 = sub_B70764(RetryConfirmItem__SetCondensedScalePossessionAmount_d__7_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_434F44B & 1) == 0 )
  {
    this = (RetryConfirmItem__SetCondensedScalePossessionAmount_d__7_o *)sub_B70694(&RetryConfirmItem_TypeInfo);
    byte_434F44B = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_B70698(&Method_RetryConfirmItem__SetCondensedScalePossessionAmount_d__7_System_Collections_IEnumerator_Reset__);
  sub_B70738(v3, v4);
}
