void __fastcall RetryConfirmItem___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A22CD9 & 1) == 0 )
  {
    sub_1B715CC(&RetryConfirmItem_TypeInfo, v1);
    byte_4A22CD9 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22CD8 & 1) == 0 )
  {
    sub_1B715CC(&RetryConfirmItem__SetCondensedScalePossessionAmount_d__7_TypeInfo, method);
    byte_4A22CD8 = 1;
  }
  v3 = sub_1B71818(RetryConfirmItem__SetCondensedScalePossessionAmount_d__7_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22CDA & 1) == 0 )
  {
    this = (RetryConfirmItem__SetCondensedScalePossessionAmount_d__7_o *)sub_1B715CC(&RetryConfirmItem_TypeInfo, method);
    byte_4A22CDA = 1;
  }
  ...
  else if ( !_1__state )
  {
    ...
    if ( _4__this )
    {
      ...
      if ( this )
      {
        ...
        sub_1B71570(p__2__current, 0, v6, v7);
        result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B715E0(&Method_RetryConfirmItem__SetCondensedScalePossessionAmount_d__7_System_Collections_IEnumerator_Reset__);
  sub_1B716F4(v3, v4);
}
