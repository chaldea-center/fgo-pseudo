        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CCADC9 & 1) == 0 )
  {
    sub_1C713B0(&RetryConfirmItem__SetCondensedScalePossessionAmount_d__8_TypeInfo);
    byte_4CCADC9 = 1;
  }
  v5 = isDispUseItemUI;
  v6 = sub_1C715FC(RetryConfirmItem__SetCondensedScalePossessionAmount_d__8_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C713C4(&Method_RetryConfirmItem__SetCondensedScalePossessionAmount_d__8_System_Collections_IEnumerator_Reset__);
  sub_1C714D8(v3, v4);
}
