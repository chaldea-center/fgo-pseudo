void __fastcall RetryConfirmItem___cctor(const MethodInfo *method)
{
  if ( (byte_4A5E480 & 1) == 0 )
  {
    sub_1B885B0(&RetryConfirmItem_TypeInfo);
    byte_4A5E480 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5E47F & 1) == 0 )
  {
    sub_1B885B0(&RetryConfirmItem__SetCondensedScalePossessionAmount_d__7_TypeInfo);
    byte_4A5E47F = 1;
  }
  v3 = sub_1B887FC(RetryConfirmItem__SetCondensedScalePossessionAmount_d__7_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5E481 & 1) == 0 )
  {
    this = (RetryConfirmItem__SetCondensedScalePossessionAmount_d__7_o *)sub_1B885B0(&RetryConfirmItem_TypeInfo);
    byte_4A5E481 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B885C4(&Method_RetryConfirmItem__SetCondensedScalePossessionAmount_d__7_System_Collections_IEnumerator_Reset__);
  sub_1B886D8(v3, v4);
}
