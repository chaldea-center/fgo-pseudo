        ...
        const MethodInfo *method)
{
  ...
  sub_1C93A78(
    ...
    v8);
  this->fields.after = b;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.after, (int32_t)b, v16, v17, v18, v19, v20, v21);
  this->fields.targetObject = c;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.targetObject, (int32_t)c, v22, v23, v24, v25, v26, v27);
  ...
  *(_QWORD *)&this->fields.offset2D.fields.offset.fields.x = v35;
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.adjustPosInScreenComp, 0, v28, v29, v30, v31, v32, v33);
  this->fields.adjustPosInScreenArg = 0;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.adjustPosInScreenArg, 0, v37, v38, v39, v40, v41, v42);
}
  ...
  if ( adjustArg )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(targetObject, 0, 0) )
    {
      ...
      if ( UnityEngine_Object__op_Inequality(before, 0, 0) )
      {
        ...
        v24.fields.x = position.fields.x + this->fields.addpos.fields.x;
        v24.fields.y = position.fields.y + this->fields.addpos.fields.y;
        v24.fields.z = position.fields.z + this->fields.addpos.fields.z;
        v16 = AdjustPopupPosInScreenArgument__Init(adjustArg, v15, v24, 0);
...
void TrackingMoveCtCComponent__upDatePos(TrackingMoveCtCComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(targetObject, 0, 0) )
  {
    ...
    if ( !before )
      goto LABEL_24;
    v17 = UnityEngine_Camera__WorldToViewportPoint_71924488(before, AdjustedPosInScreen, 0);
    ...
    if ( condition == 2 )
    {
      ...
      if ( !transform )
        goto LABEL_24;
      v20 = UnityEngine_Transform__get_position((UnityEngine_Transform_o *)transform, 0);
      if ( (float)(conditionValue * conditionValue) >= (float)((float)((float)(v19.fields.z - v20.fields.z)
                                                                     * (float)(v19.fields.z - v20.fields.z))
                                                             + (float)((float)((float)(v19.fields.x - v20.fields.x)
                                                                             * (float)(v19.fields.x - v20.fields.x))
                                                                     + (float)((float)(v19.fields.y - v20.fields.y)
                                                                             * (float)(v19.fields.y - v20.fields.y)))) )
        goto LABEL_14;
    }
    else if ( condition != 1 )
    {
LABEL_14:
      ...
      if ( transform )
      {
        ...
        v22.fields.y = v14;
        v22.fields.z = z;
        v18 = UnityEngine_Camera__ViewportToWorldPoint_71924496((UnityEngine_Camera_o *)transform, v22, 0);
        transform = (UnityEngine_GameObject_o *)UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0);
        if ( transform )
        {
          UnityEngine_Transform__set_position((UnityEngine_Transform_o *)transform, v18, 0);
          return;
        }
      }
LABEL_24:
