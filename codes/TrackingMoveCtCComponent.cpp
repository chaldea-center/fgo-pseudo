        ...
        const MethodInfo *method)
{
  ...
  x = d.fields.x;
  v13 = isLate;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.before, (int32_t)a, (int32_t)b, (int32_t)c);
  v7->fields.after = b;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&v7->fields.after, (int32_t)b, v14, v15);
  v7->fields.targetObject = c;
  v7 = (TrackingMoveCtCComponent_o *)((char *)v7 + 48);
  sub_1B649A4((ServantStatusBattleListViewItem_o *)v7, (int32_t)c, v16, v17);
  *(float *)&v7->monitor = x;
...
void __fastcall TrackingMoveCtCComponent__upDatePos(TrackingMoveCtCComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(targetObject, 0LL, 0LL) )
  {
    ...
    *(UnityEngine_Vector3_o *)&v10 = UnityEngine_Camera__WorldToViewportPoint_68943776(before, v22, 0LL);
    ...
    v23.fields.x = v13;
    v23.fields.z = v15;
    v24 = UnityEngine_Camera__ViewportToWorldPoint_68943784((UnityEngine_Camera_o *)transform, v23, 0LL);
    x = v24.fields.x;
    y = v24.fields.y;
    z = v24.fields.z;
