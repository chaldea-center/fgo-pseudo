        ...
        const MethodInfo *method)
{
  ...
  x = d.fields.x;
  v13 = isLate;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.before, (int32_t)a, (int32_t)b, (const MethodInfo *)c);
  this->fields.after = b;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.after, (int32_t)b, v14, v15);
  this->fields.targetObject = c;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.targetObject, (int32_t)c, v16, v17);
  ...
  *(_QWORD *)&this->fields.offset2D.fields.offset.fields.x = v22;
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.adjustPosInScreenComp, 0, v19, v20);
  this->fields.adjustPosInScreenArg = 0LL;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.adjustPosInScreenArg, 0, v24, v25);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4802F & 1) == 0 )
  {
    sub_1BDB878(&UnityEngine_Object_TypeInfo, adjustComp);
    byte_4B4802F = 1;
  }
  ...
  if ( adjustArg )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(targetObject, 0LL, 0LL) )
    {
      ...
      if ( UnityEngine_Object__op_Inequality(before, 0LL, 0LL) )
      {
        ...
        sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.adjustPosInScreenArg, (int32_t)v12, v13, v14);
      }
    }
  }
}
...
void __fastcall TrackingMoveCtCComponent__upDatePos(TrackingMoveCtCComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(targetObject, 0LL, 0LL) )
  {
    ...
    *(UnityEngine_Vector3_o *)&v8 = TrackingMoveCtCComponent__GetAdjustedPosInScreen(this, position, v7);
    if ( !before )
      goto LABEL_24;
    *(UnityEngine_Vector3_o *)&v11 = UnityEngine_Camera__WorldToViewportPoint_70090016(
                                       before,
...
LABEL_14:
      ...
      if ( transform )
      {
        ...
        v33.fields.y = v21;
        v33.fields.z = v16;
        v34 = UnityEngine_Camera__ViewportToWorldPoint_70090024((UnityEngine_Camera_o *)transform, v33, 0LL);
        x = v34.fields.x;
        y = v34.fields.y;
        z = v34.fields.z;
        transform = (UnityEngine_GameObject_o *)UnityEngine_Component__get_transform(
