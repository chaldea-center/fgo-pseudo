void __fastcall AssumedBattleAssetSearcherBase___ctor(AssumedBattleAssetSearcherBase_o *this, const MethodInfo *method)
{
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.assetPathList, (int32_t)v4, v5, v6);
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.audioPathList, (int32_t)v7, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B04427 & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Collections_Generic_List_string__Add__, path);
    byte_4B04427 = 1;
  }
  ...
  if ( !assetPathList
    || (items = assetPathList->fields._items,
        ...
        !items) )
  {
    sub_1BC3264(assetPathList, path);
  }
  ...
  else
  {
    ...
    sub_1BC2FAC((CGThumbnailListItem_o *)(v10 + 4), (int32_t)path, (int32_t)method, v3);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !audioPathList
    || (items = audioPathList->fields._items,
        ...
        !items) )
  {
    sub_1BC3264(audioPathList, path);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B0442B & 1) == 0 )
  {
    this = (AssumedBattleAssetSearcherBase_o *)sub_1BC3008(
