void __fastcall AssumedBattleAssetSearcherBase___ctor(AssumedBattleAssetSearcherBase_o *this, const MethodInfo *method)
{
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.assetPathList, (int32_t)v4, v5, v6);
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.audioPathList, (int32_t)v7, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A21B49 & 1) == 0 )
  {
    sub_1B715CC(&Method_System_Collections_Generic_List_string__Add__, path);
    byte_4A21B49 = 1;
  }
  ...
  if ( !assetPathList
    || (items = assetPathList->fields._items,
        ...
        !items) )
  {
    sub_1B71828(assetPathList, path);
  }
  ...
  else
  {
    ...
    sub_1B71570((ServantStatusBattleListViewItem_o *)(v10 + 4), (int32_t)path, (int32_t)method, v3);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !audioPathList
    || (items = audioPathList->fields._items,
        ...
        !items) )
  {
    sub_1B71828(audioPathList, path);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A21B4D & 1) == 0 )
  {
    this = (AssumedBattleAssetSearcherBase_o *)sub_1B715CC(
