void __fastcall AssumedBattleAssetSearcherBase___ctor(AssumedBattleAssetSearcherBase_o *this, const MethodInfo *method)
{
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.assetPathList, (int32_t)v4, v5, v6);
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.audioPathList, (int32_t)v7, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB7EEF & 1) == 0 )
  {
    sub_1BAB41C(&Method_System_Collections_Generic_List_string__Add__, path);
    byte_4AB7EEF = 1;
  }
  ...
  if ( !assetPathList
    || (items = assetPathList->fields._items,
        ...
        !items) )
  {
    sub_1BAB678(assetPathList, path);
  }
  ...
  else
  {
    ...
    sub_1BAB3C0((ServantStatusBattleListViewItem_o *)(v10 + 4), (int32_t)path, (int32_t)method, v3);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !audioPathList
    || (items = audioPathList->fields._items,
        ...
        !items) )
  {
    sub_1BAB678(audioPathList, path);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB7EF3 & 1) == 0 )
  {
    this = (AssumedBattleAssetSearcherBase_o *)sub_1BAB41C(
