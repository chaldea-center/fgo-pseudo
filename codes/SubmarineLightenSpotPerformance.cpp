        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C7A4 & 1) == 0 )
  {
    sub_1B715CC(&SubmarineLightenSpotPerformance__Execute_d__4_TypeInfo, method);
    byte_4A1C7A4 = 1;
  }
  v3 = sub_1B71818(SubmarineLightenSpotPerformance__Execute_d__4_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C7A3 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_SubmarineLightenSpotPerformance__OnStart_b__3_0__, v3);
    byte_4A1C7A3 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C7A5 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_SubmarineLightenSpotPerformance__Execute_b__4_0__, v3);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B715E0(&Method_SubmarineLightenSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_1B716F4(v3, v4);
}
