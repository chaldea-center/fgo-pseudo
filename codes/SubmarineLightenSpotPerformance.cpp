        ...
        const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.spot, (int32_t)spot, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C23CB0 & 1) == 0 )
  {
    sub_1C2D490(&SubmarineLightenSpotPerformance__Execute_d__4_TypeInfo);
    byte_4C23CB0 = 1;
  }
  v3 = sub_1C2D6DC(SubmarineLightenSpotPerformance__Execute_d__4_TypeInfo);
...
void SubmarineLightenSpotPerformance__OnStart(SubmarineLightenSpotPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C23CAF & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_SubmarineLightenSpotPerformance__OnStart_b__3_0__);
    byte_4C23CAF = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C23CB1 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_SubmarineLightenSpotPerformance__Execute_b__4_0__);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C2D4A4(&Method_SubmarineLightenSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_1C2D5B8(v3, v4);
}
