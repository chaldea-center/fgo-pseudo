        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB219 & 1) == 0 )
  {
    sub_1B64870(&SubmarineLightenSpotPerformance__Execute_d__4_TypeInfo, method);
    byte_49FB219 = 1;
  }
  v3 = sub_1B64ABC(SubmarineLightenSpotPerformance__Execute_d__4_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB218 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_SubmarineLightenSpotPerformance__OnStart_b__3_0__, v3);
    byte_49FB218 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB21A & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_SubmarineLightenSpotPerformance__Execute_b__4_0__, v3);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B64884(&Method_SubmarineLightenSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_1B64998(v3, v4);
}
