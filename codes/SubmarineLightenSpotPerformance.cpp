...
System_Collections_IEnumerator_o *__fastcall SubmarineLightenSpotPerformance__Execute(
        ...
        const MethodInfo *method)
{
  SubmarineLightenSpotPerformance__Execute_d__4_o *v3; // x20
  __int64 v4; // x0
  __int64 v5; // x1

  if ( (byte_41857A4 & 1) == 0 )
  {
    sub_B2C35C(&SubmarineLightenSpotPerformance__Execute_d__4_TypeInfo, method);
    byte_41857A4 = 1;
  }
  v3 = (SubmarineLightenSpotPerformance__Execute_d__4_o *)sub_B2C42C(SubmarineLightenSpotPerformance__Execute_d__4_TypeInfo);
  SubmarineLightenSpotPerformance__Execute_d__4___ctor(v3, 0, 0LL);
  if ( !v3 )
    sub_B2C434(v4, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_41857A3 & 1) == 0 )
  {
    ...
    sub_B2C35C(&Method_SubmarineLightenSpotPerformance__OnStart_b__3_0__, v3);
    byte_41857A3 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_418479B & 1) == 0 )
  {
    ...
    sub_B2C35C(&Method_SubmarineLightenSpotPerformance__Execute_b__4_0__, v4);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_B2C360(&Method_SubmarineLightenSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_B2C400(v3, v4);
}
