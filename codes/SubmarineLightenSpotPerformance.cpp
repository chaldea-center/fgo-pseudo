        ...
        const MethodInfo *method)
{
  ...
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.spot, (int32_t)spot, v5, v6, v7, v8, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D290B6 & 1) == 0 )
  {
    sub_1C94098(&SubmarineLightenSpotPerformance__Execute_d__4_TypeInfo);
    byte_4D290B6 = 1;
  }
  v3 = sub_1C942E4(SubmarineLightenSpotPerformance__Execute_d__4_TypeInfo);
...
void SubmarineLightenSpotPerformance__OnStart(SubmarineLightenSpotPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D290B5 & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_SubmarineLightenSpotPerformance__OnStart_b__3_0__);
    byte_4D290B5 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D290B7 & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_SubmarineLightenSpotPerformance__Execute_b__4_0__);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C940AC(&Method_SubmarineLightenSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_1C941C0(v3, v4);
}
