        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2AC0D & 1) == 0 )
  {
    sub_1B761C0(&SubmarineLightenSpotPerformance__Execute_d__4_TypeInfo, method);
    byte_4A2AC0D = 1;
  }
  v3 = sub_1B7640C(SubmarineLightenSpotPerformance__Execute_d__4_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2AC0C & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_SubmarineLightenSpotPerformance__OnStart_b__3_0__, v3);
    byte_4A2AC0C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2AC0E & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_SubmarineLightenSpotPerformance__Execute_b__4_0__, v3);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B761D4(&Method_SubmarineLightenSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_1B762E8(v3, v4);
}
