        ...
        const MethodInfo *method)
{
  ...
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.spot, (int32_t)spot, v5, v6, v7, v8, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEAF10 & 1) == 0 )
  {
    sub_1C7BAE8(&SubmarineLightenSpotPerformance__Execute_d__4_TypeInfo);
    byte_4CEAF10 = 1;
  }
  v3 = sub_1C7BD34(SubmarineLightenSpotPerformance__Execute_d__4_TypeInfo);
...
void SubmarineLightenSpotPerformance__OnStart(SubmarineLightenSpotPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEAF0F & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_SubmarineLightenSpotPerformance__OnStart_b__3_0__);
    byte_4CEAF0F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEAF11 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_SubmarineLightenSpotPerformance__Execute_b__4_0__);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C7BAFC(&Method_SubmarineLightenSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_1C7BC10(v3, v4);
}
