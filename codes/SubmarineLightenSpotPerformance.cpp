        ...
        const MethodInfo *method)
{
  ...
  sub_B52920((BattleServantConfConponent_o *)&this->fields.spot, (System_Int32_array **)spot, v5, v6, v7, v8, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AEE09 & 1) == 0 )
  {
    sub_B52984(&SubmarineLightenSpotPerformance__Execute_d__4_TypeInfo);
    byte_42AEE09 = 1;
  }
  v3 = sub_B52A54(SubmarineLightenSpotPerformance__Execute_d__4_TypeInfo);
  SubmarineLightenSpotPerformance__Execute_d__4___ctor((SubmarineLightenSpotPerformance__Execute_d__4_o *)v3, 0, 0LL);
  if ( !v3 )
    sub_B52A5C(v4, v5);
  *(_QWORD *)(v3 + 32) = this;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AEE08 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_SubmarineLightenSpotPerformance__OnStart_b__3_0__);
    byte_42AEE08 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  SubmarineLightenSpotPerformance_o *v4; // x19
  ...
  if ( !spot
    ...
    || (mMapCtrl_SpotInfo->fields.dispType = 1,
        v4 = this,
        (this = (SubmarineLightenSpotPerformance_o *)this->fields.spot) == 0LL) )
  {
    sub_B52A5C(this, method);
  }
  SrcSpotBasePrefab__SetTouchType((SrcSpotBasePrefab_o *)this, 1, 0LL);
  v4->fields.spotAnimFinished = 1;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42ADD77 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_SubmarineLightenSpotPerformance__Execute_b__4_0__);
  ...
  else
  {
    ...
    v7 = (UnityEngine_WaitUntil_o *)sub_B52A54(UnityEngine_WaitUntil_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_B52988(&Method_SubmarineLightenSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_B52A28(v3, v4);
}
