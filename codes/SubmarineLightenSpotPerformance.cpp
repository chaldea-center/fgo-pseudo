        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB2C59 & 1) == 0 )
  {
    sub_1C6BA08(&SubmarineLightenSpotPerformance__Execute_d__4_TypeInfo);
    byte_4CB2C59 = 1;
  }
  v3 = sub_1C6BC54(SubmarineLightenSpotPerformance__Execute_d__4_TypeInfo);
...
void SubmarineLightenSpotPerformance__OnStart(SubmarineLightenSpotPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB2C58 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_SubmarineLightenSpotPerformance__OnStart_b__3_0__);
    byte_4CB2C58 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB2C5A & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_SubmarineLightenSpotPerformance__Execute_b__4_0__);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C6BA1C(&Method_SubmarineLightenSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_1C6BB30(v3, v4);
}
