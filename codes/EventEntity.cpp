        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B280A & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_4642/*"DISP_TIMESTR_FORMAT"*/);
    byte_42B280A = 1;
  }
  dateData = 0LL;
  v5 = 96LL;
  ...
  dateData = NetworkManager__getServerDateTime_25742200(v6, 0LL).fields.dateData;
  if ( (BYTE3(LocalizationManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !LocalizationManager_TypeInfo->_2.cctor_finished )
  {
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  }
  v7 = LocalizationManager__Get((System_String_o *)StringLiteral_4642/*"DISP_TIMESTR_FORMAT"*/, 0LL);
  v8 = (System_Object_array *)sub_B5299C(object___TypeInfo, 5LL);
  v55.fields.dateData = (uint64_t)&dateData;
  Year = System_DateTime__get_Year(v55, 0LL);
  ...
  if ( v8->max_length <= 1 )
    goto LABEL_28;
  v8->m_Items[1] = (Il2CppObject *)v24;
  sub_B52920((BattleServantConfConponent_o *)&v8->m_Items[1], v24, v18, v19, v20, v21, v22, v23);
  v57.fields.dateData = (uint64_t)&dateData;
  Day = System_DateTime__get_Day(v57, 0LL);
  ...
  if ( v8->max_length <= 2 )
    goto LABEL_28;
  v8->m_Items[2] = (Il2CppObject *)v31;
  sub_B52920((BattleServantConfConponent_o *)&v8->m_Items[2], v31, v25, v26, v27, v28, v29, v30);
  v58.fields.dateData = (uint64_t)&dateData;
  Hour = System_DateTime__get_Hour(v58, 0LL);
  ...
  if ( v8->max_length <= 3 )
    goto LABEL_28;
  v8->m_Items[3] = (Il2CppObject *)v38;
  sub_B52920((BattleServantConfConponent_o *)&v8->m_Items[3], v38, v32, v33, v34, v35, v36, v37);
...
LABEL_28:
  ...
  v8->m_Items[4] = (Il2CppObject *)v45;
  sub_B52920((BattleServantConfConponent_o *)&v8->m_Items[4], v45, v39, v40, v41, v42, v43, v44);
  return System_String__Format_44647040(v7, v8, 0LL);
}
...
int64_t __fastcall EventEntity__GetRestTime(EventEntity_o *this, bool isFinishedAt, const MethodInfo *method)
{
  ...
  if ( isFinishedAt )
    v8 = 104LL;
  return EventEntity__GetRestTime_29664704(this, Time, *(int64_t *)((char *)&this->klass + v8), v7);
}


int64_t __fastcall EventEntity__GetRestTime_29664504(
        EventEntity_o *this,
        int64_t checkTime,
        bool isFinishedAt,
        const MethodInfo *method)
{
  ...
  if ( !this )
    sub_B52A5C(0LL, checkTime);
  v4 = 96LL;
  if ( isFinishedAt )
    v4 = 104LL;
  return EventEntity__GetRestTime_29664704(this, checkTime, *(int64_t *)((char *)&this->klass + v4), method);
}


int64_t __fastcall EventEntity__GetRestTime_29664704(
        EventEntity_o *this,
        int64_t checkTime,
        int64_t endTime,
        const MethodInfo *method)
...
bool __fastcall EventEntity__IsOpen_29664420(
        EventEntity_o *this,
        int64_t checkTime,
        bool isFinishedAt,
        const MethodInfo *method)
{
  ...
  return EventEntity__isPurchaseEventOpen(this, (const MethodInfo *)checkTime)
      || EventEntity__GetRestTime_29664504(this, checkTime, isFinishedAt, v7) > 0;
}
...
bool __fastcall EventEntity__IsReward_29665112(EventEntity_o *this, const MethodInfo *method)
{
...
System_String_o *__fastcall EventEntity__getEventName(EventEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B27FE & 1) == 0 )
  {
    sub_B52984(&Method_DataManager_GetMasterData_EventAddMaster___);
    sub_B52984(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_42B27FE = 1;
  }
  Instance = (DataManager_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance
    || (Instance = (DataManager_o *)DataManager__GetMasterData_WarQuestSelectionMaster_(
                                      Instance,
                                      (const MethodInfo_1A4F184 *)Method_DataManager_GetMasterData_EventAddMaster___)) == 0LL )
  {
    sub_B52A5C(Instance, v4);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( EventEntity__isPurchaseEventOpen(this, (const MethodInfo *)bannerName) )
    return System_String__Concat_44568316(bannerName, (System_String_o *)StringLiteral_21841/*"r"*/, 0LL);
  else
    return bannerName;
}
...
bool __fastcall EventEntity__isPurchaseEventOpen(EventEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !entity
    ...
    || (Instance = (int64_t)DataManager__GetMasterData_WarQuestSelectionMaster_(
                              (DataManager_o *)Instance,
                              (const MethodInfo_1A4F184 *)Method_DataManager_GetMasterData_EventDetailMaster___)) == 0 )
  {
LABEL_22:
    sub_B52A5C(Instance, v4);
  }
