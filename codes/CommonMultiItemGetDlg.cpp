...
void CommonMultiItemGetDlg__Close(CommonMultiItemGetDlg_o *this, System_Action_o *callback, const MethodInfo *method)
{
  ...
  if ( (byte_4CED030 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_CommonMultiItemGetDlg_endClose__);
    byte_4CED030 = 1;
  }
  ...
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.onEndClose, (int32_t)callback, v6, v7, v8, v9, v10, v11);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C7BAE8(&System_Action_TypeInfo);
    sub_1C7BAE8(&GiftListViewItemIcon_ClickDelegate_TypeInfo);
    sub_1C7BAE8(&Method_CommonMultiItemGetDlg_endOpen__);
    sub_1C7BAE8(&Method_CommonMultiItemGetDlg_setShowConf__);
    byte_4CED02B = 1;
  }
  ...
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.onclick, (int32_t)callback, v18, v19, v20, v21, v22, v23);
  itemWindow = this->fields.itemWindow;
  v25 = (GiftListViewItemIcon_ClickDelegate_o *)sub_1C7BD34(GiftListViewItemIcon_ClickDelegate_TypeInfo);
  ...
  {
LABEL_10:
    sub_1C7BD40(titleConfLabel, title);
  }
...
void CommonMultiItemGetDlg__itemDialogCallBack(CommonMultiItemGetDlg_o *this, bool flg, const MethodInfo *method)
{
  ...
  if ( (byte_4CED02F & 1) == 0 )
  {
    sub_1C7BAE8(&Method_CommonMultiItemGetDlg_itemDialogCallBack__);
    byte_4CED02F = 1;
  }
  v4 = Method_CommonMultiItemGetDlg_itemDialogCallBack__;
  if ( (*((_BYTE *)Method_CommonMultiItemGetDlg_itemDialogCallBack__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1C7BB00(Method_CommonMultiItemGetDlg_itemDialogCallBack__);
  v5 = (System_Reflection_MethodBase_o *)sub_1C7BACC(v4, v4[4]);
  OverwriteAssetSoundName__PlaySystemSe(v5, 0, 0, 0);
  itemDialog = this->fields.itemDialog;
  if ( !itemDialog )
    sub_1C7BD40(0, v6);
  ItemDetailInfoComponent__Close_33614792(itemDialog, 0, 0);
}
...
void CommonMultiItemGetDlg__setShowItemConf(CommonMultiItemGetDlg_o *this, int32_t itemId, const MethodInfo *method)
{
  ...
  if ( !Instance
    ...
    || (Entity = DataMasterBase_object__object__int___GetEntity(
        ...
        v10 = (ItemDetailInfoComponent_CallbackFunc_o *)sub_1C7BD34(ItemDetailInfoComponent_CallbackFunc_TypeInfo),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CED02C & 1) == 0 )
  {
    sub_1C7BAE8(&Method_CommonMultiItemGetDlg_DialogCallBack__);
  ...
  if ( !Instance )
    sub_1C7BD40(v7, v8);
  CommonUI__OpenServantStatusDialog_31496296((CommonUI_o *)Instance, 0, gift, v6, 0);
}
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1AB091C;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1AB08D4;
}
