        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFFC45 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMasterData_WarBoardItemMaster___, layout);
    sub_1BC3008(&Method_DataMasterBase_WarBoardItemMaster__WarBoardItemEntity__int__GetEntity__, v7);
  ...
  *(_QWORD *)&this->fields.pieceIndex = -1LL;
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.serverData, (int32_t)getItemData, v9, v10);
  if ( !layout
    ...
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_3001E64 *)Method_DataManager_GetMasterData_WarBoardItemMaster___)) == 0LL )
  {
  ...
  Entity = DataMasterBase_object__object__int___GetEntity(
             ...
             this->fields.itemId,
             (const MethodInfo_32AF070 *)Method_DataMasterBase_WarBoardItemMaster__WarBoardItemEntity__int__GetEntity__);
  this->fields.itemEntity = (struct WarBoardItemEntity_o *)Entity;
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.itemEntity, (int32_t)Entity, v17, v18);
...
void __fastcall WarBoardItemData__ResetItem(WarBoardItemData_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.forceId = -1LL;
  ...
  {
    sub_1BC3264(localSaveData, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.component, (int32_t)component, (int32_t)method, v3);
}
...
System_String_o *__fastcall WarBoardItemData__ToJson(WarBoardItemData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFFC4C & 1) == 0 )
  {
    ...
    sub_1BC3008(&WarBoardUserGetItemData_TypeInfo, v3);
    byte_4AFFC4C = 1;
  }
  ...
  if ( !serverData )
  {
    v6 = (Il2CppObject *)sub_1BC3254(WarBoardUserGetItemData_TypeInfo);
    System_Object___ctor(v6, 0LL);
    *p_serverData = (struct WarBoardUserGetItemData_o *)v6;
    sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.serverData, (int32_t)v6, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFFC4B & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Linq_Enumerable_FirstOrDefault_WarBoardUserGetItemData___, warBoardDataEnt);
    sub_1BC3008(&System_Func_WarBoardUserGetItemData__bool__TypeInfo, v5);
    sub_1BC3008(&Method_WarBoardItemData__UpdateFromServerData_b__60_0__, v6);
    byte_4AFFC4B = 1;
  }
  if ( warBoardDataEnt )
  {
    getItemInfo = (System_Collections_Generic_IEnumerable_TSource__o *)warBoardDataEnt->fields.getItemInfo;
    v8 = (System_Func_object__bool__o *)sub_1BC3254(System_Func_WarBoardUserGetItemData__bool__TypeInfo);
    System_Func_object__bool____ctor(
      v8,
      (Il2CppObject *)this,
      Method_WarBoardItemData__UpdateFromServerData_b__60_0__,
      0LL);
    v9 = System_Linq_Enumerable__FirstOrDefault_object__50493748(
           getItemInfo,
           (System_Func_TSource__bool__o *)v8,
           (const MethodInfo_3027934 *)Method_System_Linq_Enumerable_FirstOrDefault_WarBoardUserGetItemData___);
    this->fields.serverData = (struct WarBoardUserGetItemData_o *)v9;
    sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.serverData, (int32_t)v9, v10, v11);
    serverData = this->fields.serverData;
    if ( serverData )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFFC49 & 1) == 0 )
  {
    sub_1BC3008(&DataVals_TypeInfo, piece);
    sub_1BC3008(&WarBoardManager_ExecuteProcParam_TypeInfo, v9);
    ...
    sub_1BC3008(&WarBoardTaskBase_TaskCallback_TypeInfo, v12);
    sub_1BC3008(&Method_WarBoardItemData___c__DisplayClass54_0__Use_b__0__, v13);
    sub_1BC3008(&WarBoardItemData___c__DisplayClass54_0_TypeInfo, v14);
    sub_1BC3008(&WarBoardCallbackTask_TypeInfo, v15);
    sub_1BC3008(&WarBoardTaskBase___TypeInfo, v16);
    byte_4AFFC49 = 1;
  }
  v17 = sub_1BC3254(WarBoardItemData___c__DisplayClass54_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v17, 0LL);
  if ( !v17 )
    goto LABEL_31;
  *(_QWORD *)(v17 + 16) = piece;
  v22 = v17 + 16;
  sub_1BC2FAC((CGThumbnailListItem_o *)(v17 + 16), (int32_t)piece, v20, v21);
  v23 = *(_QWORD *)(v17 + 16);
  if ( !v23 )
    goto LABEL_31;
  if ( *(_DWORD *)(v23 + 16) == 1 )
  ...
  if ( !svals->max_length )
    goto LABEL_32;
  v27 = svals->m_Items[0];
  v28 = (DataVals_o *)sub_1BC3254(DataVals_TypeInfo);
  ...
  if ( !v29 )
    goto LABEL_31;
  v30 = *(_DWORD *)(v29 + 24);
  v31 = sub_1BC3254(WarBoardManager_ExecuteProcParam_TypeInfo);
  *(_BYTE *)(v31 + 64) = 1;
  System_Object___ctor((Il2CppObject *)v31, 0LL);
  v32 = *(_QWORD *)v22;
  *(_QWORD *)(v31 + 16) = *(_QWORD *)v22;
  sub_1BC2FAC((CGThumbnailListItem_o *)(v31 + 16), v32, v33, v34);
  *(_DWORD *)(v31 + 24) = v30;
  *(_DWORD *)(v31 + 28) = v30;
  ...
  *(_QWORD *)(v31 + 32) = funcId;
  sub_1BC2FAC((CGThumbnailListItem_o *)(v31 + 32), (int32_t)funcId, v35, v36);
  DataValsList = WarBoardItemData__getDataValsList(this, v39);
  *(_QWORD *)(v31 + 40) = DataValsList;
  sub_1BC2FAC((CGThumbnailListItem_o *)(v31 + 40), (int32_t)DataValsList, v41, v42);
  *(_BYTE *)(v31 + 64) = 0;
  component = (__int64)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38DFD48 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !component )
    goto LABEL_31;
  ...
  v45 = sub_1BC3254(WarBoardCallbackTask_TypeInfo);
  WarBoardCallbackTask___ctor((WarBoardCallbackTask_o *)v45, 0LL, 0LL);
  v46 = (WarBoardTaskBase_TaskCallback_o *)sub_1BC3254(WarBoardTaskBase_TaskCallback_TypeInfo);
  ...
  if ( !v45 )
    goto LABEL_31;
  *(_QWORD *)(v45 + 40) = v46;
  sub_1BC2FAC((CGThumbnailListItem_o *)(v45 + 40), (int32_t)v46, v47, v48);
  if ( taskList )
  {
    ...
    if ( items )
    {
      ...
      else
      {
        ...
        sub_1BC2FAC((CGThumbnailListItem_o *)(v54 + 4), v45, v49, v50);
      }
      return;
    }
LABEL_31:
    sub_1BC3264(component, v19);
  }
  ...
  component = sub_1BC30B0(WarBoardTaskBase___TypeInfo, 1LL);
  if ( !component )
    goto LABEL_31;
  v56 = component;
  component = sub_1BC3144(v45, *(_QWORD *)(*(_QWORD *)component + 64LL));
  if ( !component )
  {
    v58 = sub_1BC3288();
    sub_1BC3130(v58, 0LL);
  ...
  if ( !*(_DWORD *)(v56 + 24) )
LABEL_32:
    sub_1BC326C(component, v19, v24);
  *(_QWORD *)(v56 + 32) = v45;
  sub_1BC2FAC((CGThumbnailListItem_o *)(v56 + 32), v45, v24, v57);
  if ( !Instance )
    goto LABEL_31;
  if ( isInsertTask )
...
DataVals_array *__fastcall WarBoardItemData__getDataValsList(WarBoardItemData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFFC4A & 1) == 0 )
  {
    ...
    this = (WarBoardItemData_o *)sub_1BC3008(&StringLiteral_1/*""*/, v4);
    byte_4AFFC4A = 1;
  }
  ...
  if ( !svals )
  {
    v9 = (DataVals_array *)sub_1BC30B0(DataVals___TypeInfo, 1LL);
    ...
    if ( v9 )
    {
      if ( v16 )
      {
        this = (WarBoardItemData_o *)sub_1BC3144(v16, v9->obj.klass->_1.element_class);
        if ( !this )
        {
LABEL_22:
          v19 = sub_1BC3288();
      ...
      if ( !v9->max_length )
        goto LABEL_20;
      v9->m_Items[0] = v16;
      sub_1BC2FAC((CGThumbnailListItem_o *)v9->m_Items, (int32_t)v16, v7, v17);
      return v9;
    }
LABEL_21:
    sub_1BC3264(this, method);
  }
  this = (WarBoardItemData_o *)sub_1BC30B0(DataVals___TypeInfo, svals->max_length);
  ...
  if ( (int)v8 >= 1 )
  {
    ...
    {
      v13 = *m_Items;
      v14 = (DataVals_o *)sub_1BC3254(DataVals_TypeInfo);
      DataVals___ctor(v14, v13, 0LL);
      if ( !v9 )
        goto LABEL_21;
      if ( v14 )
      {
        this = (WarBoardItemData_o *)sub_1BC3144(v14, v9->obj.klass->_1.element_class);
        if ( !this )
          goto LABEL_22;
      }
      ...
      sub_1BC2FAC(p_forceId, (int32_t)v14, v7, v15);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFFC48 & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_22179/*"onBoard_itembase_{0}"*/, v6);
    sub_1BC3008(&StringLiteral_22178/*"onBoard_itembase"*/, v7);
    byte_4AFFC48 = 1;
  }
  itemEntity = this->fields.itemEntity;
  if ( !itemEntity )
    return (System_String_o *)StringLiteral_22178/*"onBoard_itembase"*/;
  baseImageId = itemEntity->fields.baseImageId;
  if ( baseImageId <= 0 )
    return (System_String_o *)StringLiteral_22178/*"onBoard_itembase"*/;
  v12 = baseImageId;
  v10 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v12, v2, v3, v4);
  return System_String__Format((System_String_o *)StringLiteral_22179/*"onBoard_itembase_{0}"*/, v10, 0LL);
}
...
void __fastcall WarBoardItemData_SaveData___ctor_37200116(
        ...
        const MethodInfo *method)
{
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.owner, (int32_t)owner, v5, v6);
  WarBoardItemData_SaveData__Save(this, v7);
  v11 = this->fields.owner;
  if ( !v11 )
    sub_1BC3264(0LL, v8);
  v11->fields.localSaveData = this;
  sub_1BC2FAC((CGThumbnailListItem_o *)&v11->fields.localSaveData, (int32_t)this, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.owner, (int32_t)Item, v5, v6);
  owner = this->fields.owner;
  if ( owner )
  {
    owner->fields.localSaveData = this;
    sub_1BC2FAC((CGThumbnailListItem_o *)&owner->fields.localSaveData, (int32_t)this, v7, v8);
  }
}
