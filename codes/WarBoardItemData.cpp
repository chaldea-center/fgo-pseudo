        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB3AF6 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMasterData_WarBoardItemMaster___, layout);
    sub_1BAB41C(&Method_DataMasterBase_WarBoardItemMaster__WarBoardItemEntity__int__GetEntity__, v7);
  ...
  *(_QWORD *)&this->fields.pieceIndex = -1LL;
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.serverData, (int32_t)getItemData, v9, v10);
  if ( !layout
    ...
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_2EC55C8 *)Method_DataManager_GetMasterData_WarBoardItemMaster___)) == 0LL )
  {
  ...
  Entity = DataMasterBase_object__object__int___GetEntity(
             ...
             this->fields.itemId,
             (const MethodInfo_3163D90 *)Method_DataMasterBase_WarBoardItemMaster__WarBoardItemEntity__int__GetEntity__);
  this->fields.itemEntity = (struct WarBoardItemEntity_o *)Entity;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.itemEntity, (int32_t)Entity, v17, v18);
...
void __fastcall WarBoardItemData__ResetItem(WarBoardItemData_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.forceId = -1LL;
  ...
  {
    sub_1BAB678(localSaveData, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.component, (int32_t)component, (int32_t)method, v3);
}
...
System_String_o *__fastcall WarBoardItemData__ToJson(WarBoardItemData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB3AFD & 1) == 0 )
  {
    ...
    sub_1BAB41C(&WarBoardUserGetItemData_TypeInfo, v3);
    byte_4AB3AFD = 1;
  }
  ...
  if ( !serverData )
  {
    v6 = (Il2CppObject *)sub_1BAB668(WarBoardUserGetItemData_TypeInfo);
    System_Object___ctor(v6, 0LL);
    *p_serverData = (struct WarBoardUserGetItemData_o *)v6;
    sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.serverData, (int32_t)v6, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB3AFC & 1) == 0 )
  {
    sub_1BAB41C(&Method_System_Linq_Enumerable_FirstOrDefault_WarBoardUserGetItemData___, warBoardDataEnt);
    sub_1BAB41C(&System_Func_WarBoardUserGetItemData__bool__TypeInfo, v5);
    sub_1BAB41C(&Method_WarBoardItemData__UpdateFromServerData_b__60_0__, v6);
    byte_4AB3AFC = 1;
  }
  if ( warBoardDataEnt )
  {
    getItemInfo = (System_Collections_Generic_IEnumerable_TSource__o *)warBoardDataEnt->fields.getItemInfo;
    v8 = (System_Func_object__bool__o *)sub_1BAB668(System_Func_WarBoardUserGetItemData__bool__TypeInfo);
    System_Func_object__bool____ctor(
      v8,
      (Il2CppObject *)this,
      Method_WarBoardItemData__UpdateFromServerData_b__60_0__,
      0LL);
    v9 = System_Linq_Enumerable__FirstOrDefault_object__49186032(
           getItemInfo,
           (System_Func_TSource__bool__o *)v8,
           (const MethodInfo_2EE84F0 *)Method_System_Linq_Enumerable_FirstOrDefault_WarBoardUserGetItemData___);
    this->fields.serverData = (struct WarBoardUserGetItemData_o *)v9;
    sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.serverData, (int32_t)v9, v10, v11);
    serverData = this->fields.serverData;
    if ( serverData )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB3AFA & 1) == 0 )
  {
    sub_1BAB41C(&DataVals_TypeInfo, piece);
    sub_1BAB41C(&WarBoardManager_ExecuteProcParam_TypeInfo, v9);
    ...
    sub_1BAB41C(&WarBoardTaskBase_TaskCallback_TypeInfo, v12);
    sub_1BAB41C(&Method_WarBoardItemData___c__DisplayClass54_0__Use_b__0__, v13);
    sub_1BAB41C(&WarBoardItemData___c__DisplayClass54_0_TypeInfo, v14);
    sub_1BAB41C(&WarBoardCallbackTask_TypeInfo, v15);
    sub_1BAB41C(&WarBoardTaskBase___TypeInfo, v16);
    byte_4AB3AFA = 1;
  }
  v17 = sub_1BAB668(WarBoardItemData___c__DisplayClass54_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v17, 0LL);
  if ( !v17 )
    goto LABEL_31;
  *(_QWORD *)(v17 + 16) = piece;
  v22 = v17 + 16;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)(v17 + 16), (int32_t)piece, v20, v21);
  v23 = *(_QWORD *)(v17 + 16);
  if ( !v23 )
    goto LABEL_31;
  if ( *(_DWORD *)(v23 + 16) == 1 )
  ...
  if ( !svals->max_length )
    goto LABEL_32;
  v26 = svals->m_Items[0];
  v27 = (DataVals_o *)sub_1BAB668(DataVals_TypeInfo);
  ...
  if ( !v28 )
    goto LABEL_31;
  v29 = *(_DWORD *)(v28 + 24);
  v30 = sub_1BAB668(WarBoardManager_ExecuteProcParam_TypeInfo);
  *(_BYTE *)(v30 + 64) = 1;
  System_Object___ctor((Il2CppObject *)v30, 0LL);
  v31 = *(_QWORD *)v22;
  *(_QWORD *)(v30 + 16) = *(_QWORD *)v22;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)(v30 + 16), v31, v32, v33);
  *(_DWORD *)(v30 + 24) = v29;
  *(_DWORD *)(v30 + 28) = v29;
  ...
  *(_QWORD *)(v30 + 32) = funcId;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)(v30 + 32), (int32_t)funcId, v34, v35);
  DataValsList = WarBoardItemData__getDataValsList(this, v38);
  *(_QWORD *)(v30 + 40) = DataValsList;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)(v30 + 40), (int32_t)DataValsList, v40, v41);
  *(_BYTE *)(v30 + 64) = 0;
  component = (__int64)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_378A22C *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !component )
    goto LABEL_31;
  ...
  v44 = sub_1BAB668(WarBoardCallbackTask_TypeInfo);
  WarBoardCallbackTask___ctor((WarBoardCallbackTask_o *)v44, 0LL, 0LL);
  v45 = (WarBoardTaskBase_TaskCallback_o *)sub_1BAB668(WarBoardTaskBase_TaskCallback_TypeInfo);
  ...
  if ( !v44 )
    goto LABEL_31;
  *(_QWORD *)(v44 + 40) = v45;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)(v44 + 40), (int32_t)v45, v46, v47);
  if ( taskList )
  {
    ...
    if ( items )
    {
      ...
      else
      {
        ...
        sub_1BAB3C0((ServantStatusBattleListViewItem_o *)(v53 + 4), v44, v48, v49);
      }
      return;
    }
LABEL_31:
    sub_1BAB678(component, v19);
  }
  ...
  component = sub_1BAB4C4(WarBoardTaskBase___TypeInfo, 1LL);
  if ( !component )
    goto LABEL_31;
  v55 = component;
  component = sub_1BAB558(v44, *(_QWORD *)(*(_QWORD *)component + 64LL));
  if ( !component )
  {
    v58 = sub_1BAB69C(0LL);
    sub_1BAB544(v58, 0LL);
  ...
  if ( !*(_DWORD *)(v55 + 24) )
LABEL_32:
    sub_1BAB680(component, v19);
  *(_QWORD *)(v55 + 32) = v44;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)(v55 + 32), v44, v56, v57);
  if ( !Instance )
    goto LABEL_31;
  if ( isInsertTask )
...
DataVals_array *__fastcall WarBoardItemData__getDataValsList(WarBoardItemData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB3AFB & 1) == 0 )
  {
    ...
    this = (WarBoardItemData_o *)sub_1BAB41C(&StringLiteral_1/*""*/, v4);
    byte_4AB3AFB = 1;
  }
  ...
  if ( !svals )
  {
    v8 = (DataVals_array *)sub_1BAB4C4(DataVals___TypeInfo, 1LL);
    v16 = (DataVals_o *)sub_1BAB668(DataVals_TypeInfo);
    DataVals___ctor(v16, (System_String_o *)StringLiteral_1/*""*/, 0LL);
    if ( v8 )
    {
      if ( v16 )
      {
        this = (WarBoardItemData_o *)sub_1BAB558(v16, v8->obj.klass->_1.element_class);
        if ( !this )
        {
LABEL_22:
          v20 = sub_1BAB69C(this);
          sub_1BAB544(v20, 0LL);
        }
      }
      if ( !v8->max_length )
        goto LABEL_20;
      v8->m_Items[0] = v16;
      sub_1BAB3C0((ServantStatusBattleListViewItem_o *)v8->m_Items, (int32_t)v16, v17, v18);
      return v8;
    }
LABEL_21:
    sub_1BAB678(this, method);
  }
  this = (WarBoardItemData_o *)sub_1BAB4C4(DataVals___TypeInfo, svals->max_length);
  ...
  if ( (int)v7 >= 1 )
  {
    ...
    {
      v12 = *m_Items;
      v13 = (DataVals_o *)sub_1BAB668(DataVals_TypeInfo);
      DataVals___ctor(v13, v12, 0LL);
      if ( !v8 )
        goto LABEL_21;
      if ( v13 )
      {
        this = (WarBoardItemData_o *)sub_1BAB558(v13, v8->obj.klass->_1.element_class);
        if ( !this )
          goto LABEL_22;
      }
      if ( v9 >= v8->max_length )
      ...
      sub_1BAB3C0(p_forceId, (int32_t)v13, v14, v15);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB3AF9 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_22277/*"onBoard_itembase_{0}"*/, v6);
    sub_1BAB41C(&StringLiteral_22276/*"onBoard_itembase"*/, v7);
    byte_4AB3AF9 = 1;
  }
  itemEntity = this->fields.itemEntity;
  if ( !itemEntity )
    return (System_String_o *)StringLiteral_22276/*"onBoard_itembase"*/;
  baseImageId = itemEntity->fields.baseImageId;
  if ( baseImageId <= 0 )
    return (System_String_o *)StringLiteral_22276/*"onBoard_itembase"*/;
  v12 = baseImageId;
  v10 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v12, v2, v3, v4);
  return System_String__Format((System_String_o *)StringLiteral_22277/*"onBoard_itembase_{0}"*/, v10, 0LL);
}
...
void __fastcall WarBoardItemData_SaveData___ctor_35916476(
        ...
        const MethodInfo *method)
{
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.owner, (int32_t)owner, v5, v6);
  WarBoardItemData_SaveData__Save(this, v7);
  v11 = this->fields.owner;
  if ( !v11 )
    sub_1BAB678(0LL, v8);
  v11->fields.localSaveData = this;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&v11->fields.localSaveData, (int32_t)this, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.owner, (int32_t)Item, v5, v6);
  owner = this->fields.owner;
  if ( owner )
  {
    owner->fields.localSaveData = this;
    sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&owner->fields.localSaveData, (int32_t)this, v7, v8);
  }
}
