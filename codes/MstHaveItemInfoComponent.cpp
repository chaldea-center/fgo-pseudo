        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F9BE1 & 1) == 0 )
  {
    sub_1B64870(&System_Action_int__TypeInfo, *(_QWORD *)&imgId);
    ...
    sub_1B64870(&Method_MstHaveItemInfoComponent__setInfoTxt_b__4_0__, v11);
    sub_1B64870(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v12);
    sub_1B64870(&StringLiteral_20364/*"img_servant"*/, v13);
    sub_1B64870(&StringLiteral_20319/*"img_qp"*/, v14);
    sub_1B64870(&StringLiteral_3927/*"CURRENT_QP_UNIT"*/, v15);
    sub_1B64870(&StringLiteral_20228/*"img_fp"*/, v16);
    sub_1B64870(&StringLiteral_3925/*"CURRENT_FRIEND_POINT_UNIT"*/, v17);
    sub_1B64870(&StringLiteral_20224/*"img_craftessence"*/, v18);
    sub_1B64870(&StringLiteral_12324/*"SUM_INFO"*/, v19);
    sub_1B64870(&StringLiteral_20196/*"img_cc"*/, v20);
    sub_1B64870(&StringLiteral_20396/*"img_sq"*/, v21);
    sub_1B64870(&StringLiteral_20363/*"img_rp"*/, v22);
    sub_1B64870(&StringLiteral_20286/*"img_mp"*/, v23);
    byte_49F9BE1 = 1;
  }
...
LABEL_27:
    ...
    if ( Instance )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v26 = LocalizationManager__Get((System_String_o *)StringLiteral_12324/*"SUM_INFO"*/, 0LL);
      qp = Count;
      ...
      if ( info )
      {
        ...
        if ( !byte_49F9C6B )
        {
          sub_1B64870(&BalanceConfig_TypeInfo, *(_QWORD *)&imgId);
          byte_49F9C6B = 1;
        }
...
LABEL_69:
    sub_1B64ACC(Instance, *(_QWORD *)&imgId);
  }
  if ( imgId != 8008 )
    goto LABEL_44;
  Instance = (DataManager_o *)this->fields.itemNameImg;
...
LABEL_42:
  ...
  Instance = (DataManager_o *)System_String__Format_61397948(v26, v43, v48, 0LL);
  if ( !itemNumTxt )
    goto LABEL_69;
LABEL_43:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F9BE0 & 1) == 0 )
  {
    sub_1B64870(&AtlasManager_TypeInfo, *(_QWORD *)&itemImgId);
