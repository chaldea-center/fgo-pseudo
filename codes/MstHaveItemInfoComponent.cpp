        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3268C & 1) == 0 )
  {
    sub_1BD3458(&System_Action_int__TypeInfo, *(_QWORD *)&imgId);
    ...
    sub_1BD3458(&Method_MstHaveItemInfoComponent__setInfoTxt_b__4_0__, v11);
    sub_1BD3458(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v12);
    sub_1BD3458(&StringLiteral_20691/*"img_servant"*/, v13);
    sub_1BD3458(&StringLiteral_20645/*"img_qp"*/, v14);
    sub_1BD3458(&StringLiteral_4024/*"CURRENT_QP_UNIT"*/, v15);
    sub_1BD3458(&StringLiteral_20554/*"img_fp"*/, v16);
    sub_1BD3458(&StringLiteral_4022/*"CURRENT_FRIEND_POINT_UNIT"*/, v17);
    sub_1BD3458(&StringLiteral_20550/*"img_craftessence"*/, v18);
    sub_1BD3458(&StringLiteral_12551/*"SUM_INFO"*/, v19);
    sub_1BD3458(&StringLiteral_20518/*"img_cc"*/, v20);
    sub_1BD3458(&StringLiteral_20723/*"img_sq"*/, v21);
    sub_1BD3458(&StringLiteral_20690/*"img_rp"*/, v22);
    sub_1BD3458(&StringLiteral_20612/*"img_mp"*/, v23);
    byte_4B3268C = 1;
  }
    ...
    if ( imgId <= 18 )
    {
      switch ( imgId )
      {
        case 5:
          ...
          if ( !Instance )
            goto LABEL_69;
          UISprite__set_spriteName((UISprite_o *)Instance, (System_String_o *)StringLiteral_20645/*"img_qp"*/, 0LL);
          itemNumTxt = this->fields.itemNumTxt;
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_4024/*"CURRENT_QP_UNIT"*/, 0LL);
          if ( !info )
            goto LABEL_69;
        ...
        case 6:
          ...
          if ( !Instance )
            goto LABEL_69;
          UISprite__set_spriteName((UISprite_o *)Instance, (System_String_o *)StringLiteral_20723/*"img_sq"*/, 0LL);
          if ( !info )
            goto LABEL_69;
          ...
          v53 = (System_Action_int__o *)sub_1BD36A4(System_Action_int__TypeInfo);
        ...
        case 7:
          ...
          if ( !Instance )
            goto LABEL_69;
          UISprite__set_spriteName((UISprite_o *)Instance, (System_String_o *)StringLiteral_20612/*"img_mp"*/, 0LL);
          if ( !info )
            goto LABEL_69;
          itemNumTxt = this->fields.itemNumTxt;
        ...
        case 12:
          ...
          if ( !Instance )
            goto LABEL_69;
          UISprite__set_spriteName((UISprite_o *)Instance, (System_String_o *)StringLiteral_20554/*"img_fp"*/, 0LL);
          itemNumTxt = this->fields.itemNumTxt;
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_4022/*"CURRENT_FRIEND_POINT_UNIT"*/, 0LL);
          if ( !info )
            goto LABEL_69;
          v38 = (System_String_o *)Instance;
...
LABEL_68:
        ...
        default:
          ...
          if ( !Instance )
            goto LABEL_69;
          UISprite__set_spriteName((UISprite_o *)Instance, (System_String_o *)StringLiteral_20690/*"img_rp"*/, 0LL);
          if ( !info )
            goto LABEL_69;
          itemNumTxt = this->fields.itemNumTxt;
...
LABEL_27:
    ...
    if ( Instance )
    {
      UISprite__set_spriteName((UISprite_o *)Instance, (System_String_o *)StringLiteral_20518/*"img_cc"*/, 0LL);
      itemNumTxt = this->fields.itemNumTxt;
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v26 = LocalizationManager__Get((System_String_o *)StringLiteral_12551/*"SUM_INFO"*/, 0LL);
      qp = Count;
      ...
      if ( info )
      {
        ...
        if ( !byte_4B3225B )
        {
          sub_1BD3458(&BalanceConfig_TypeInfo, *(_QWORD *)&imgId);
          byte_4B3225B = 1;
        }
  ...
  if ( imgId == 8009 )
  {
    ...
    if ( Instance )
    {
      UISprite__set_spriteName((UISprite_o *)Instance, (System_String_o *)StringLiteral_20550/*"img_craftessence"*/, 0LL);
      itemNumTxt = this->fields.itemNumTxt;
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v26 = LocalizationManager__Get((System_String_o *)StringLiteral_12551/*"SUM_INFO"*/, 0LL);
...
LABEL_69:
    sub_1BD36B4(Instance, *(_QWORD *)&imgId);
  }
  if ( imgId != 8008 )
    goto LABEL_44;
  Instance = (DataManager_o *)this->fields.itemNameImg;
  if ( !Instance )
    goto LABEL_69;
  UISprite__set_spriteName((UISprite_o *)Instance, (System_String_o *)StringLiteral_20691/*"img_servant"*/, 0LL);
  itemNumTxt = this->fields.itemNumTxt;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v26 = LocalizationManager__Get((System_String_o *)StringLiteral_12551/*"SUM_INFO"*/, 0LL);
...
LABEL_42:
  ...
  Instance = (DataManager_o *)System_String__Format_62539620(v26, v43, v48, 0LL);
  if ( !itemNumTxt )
    goto LABEL_69;
LABEL_43:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3268B & 1) == 0 )
  {
    sub_1BD3458(&AtlasManager_TypeInfo, *(_QWORD *)&itemImgId);
