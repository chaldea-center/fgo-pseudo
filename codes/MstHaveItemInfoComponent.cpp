        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2B9F9 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&LocalizationManager_TypeInfo);
    sub_1C93AD4(&Method_MstHaveItemInfoComponent__setInfoTxt_b__4_0__);
    sub_1C93AD4(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    sub_1C93AD4(&StringLiteral_20785/*"img_servant"*/);
    sub_1C93AD4(&StringLiteral_20730/*"img_qp"*/);
    sub_1C93AD4(&StringLiteral_3959/*"CURRENT_QP_UNIT"*/);
    sub_1C93AD4(&StringLiteral_20619/*"img_fp"*/);
    sub_1C93AD4(&StringLiteral_3957/*"CURRENT_FRIEND_POINT_UNIT"*/);
    sub_1C93AD4(&StringLiteral_20612/*"img_craftessence"*/);
    sub_1C93AD4(&StringLiteral_12573/*"SUM_INFO"*/);
    sub_1C93AD4(&StringLiteral_20571/*"img_cc"*/);
    sub_1C93AD4(&StringLiteral_20819/*"img_sq"*/);
    sub_1C93AD4(&StringLiteral_20782/*"img_rp"*/);
    sub_1C93AD4(&StringLiteral_20692/*"img_mp"*/);
    byte_4D2B9F9 = 1;
  }
    ...
    if ( imgId <= 18 )
    {
      switch ( imgId )
      {
        case 5:
          ...
          if ( !Instance )
            goto LABEL_69;
          UISprite__set_spriteName((UISprite_o *)Instance, (System_String_o *)StringLiteral_20730/*"img_qp"*/, 0);
          itemNumTxt = this->fields.itemNumTxt;
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3959/*"CURRENT_QP_UNIT"*/, 0);
          if ( !info )
            goto LABEL_69;
        ...
        case 6:
          ...
          if ( !Instance )
            goto LABEL_69;
          UISprite__set_spriteName((UISprite_o *)Instance, (System_String_o *)StringLiteral_20819/*"img_sq"*/, 0);
          if ( !info )
            goto LABEL_69;
        ...
        case 7:
          ...
          if ( !Instance )
            goto LABEL_69;
          UISprite__set_spriteName((UISprite_o *)Instance, (System_String_o *)StringLiteral_20692/*"img_mp"*/, 0);
          if ( !info )
            goto LABEL_69;
          itemNumTxt = this->fields.itemNumTxt;
        ...
        case 12:
          ...
          if ( !Instance )
            goto LABEL_69;
          UISprite__set_spriteName((UISprite_o *)Instance, (System_String_o *)StringLiteral_20619/*"img_fp"*/, 0);
          itemNumTxt = this->fields.itemNumTxt;
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3957/*"CURRENT_FRIEND_POINT_UNIT"*/, 0);
          if ( !info )
            goto LABEL_69;
          v12 = (System_String_o *)Instance;
...
LABEL_68:
        ...
        default:
          ...
          if ( !Instance )
            goto LABEL_69;
          UISprite__set_spriteName((UISprite_o *)Instance, (System_String_o *)StringLiteral_20782/*"img_rp"*/, 0);
          if ( !info )
            goto LABEL_69;
          itemNumTxt = this->fields.itemNumTxt;
...
LABEL_27:
    ...
    if ( Instance )
    {
      UISprite__set_spriteName((UISprite_o *)Instance, (System_String_o *)StringLiteral_20571/*"img_cc"*/, 0);
      itemNumTxt = this->fields.itemNumTxt;
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v9 = LocalizationManager__Get((System_String_o *)StringLiteral_12573/*"SUM_INFO"*/, 0);
      LODWORD(qp) = Count;
  ...
  if ( imgId == 8009 )
  {
    ...
    if ( Instance )
    {
      UISprite__set_spriteName((UISprite_o *)Instance, (System_String_o *)StringLiteral_20612/*"img_craftessence"*/, 0);
      itemNumTxt = this->fields.itemNumTxt;
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v9 = LocalizationManager__Get((System_String_o *)StringLiteral_12573/*"SUM_INFO"*/, 0);
...
LABEL_69:
    sub_1C93D2C(Instance, *(_QWORD *)&imgId);
  }
  if ( imgId != 8008 )
    goto LABEL_44;
  Instance = (DataManager_o *)this->fields.itemNameImg;
  if ( !Instance )
    goto LABEL_69;
  UISprite__set_spriteName((UISprite_o *)Instance, (System_String_o *)StringLiteral_20785/*"img_servant"*/, 0);
  itemNumTxt = this->fields.itemNumTxt;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_12573/*"SUM_INFO"*/, 0);
...
LABEL_42:
  ...
  Instance = (DataManager_o *)System_String__Format_64467032(v9, v14, v16, 0);
  if ( !itemNumTxt )
    goto LABEL_69;
LABEL_43:
