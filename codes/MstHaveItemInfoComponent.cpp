        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB1370 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&LocalizationManager_TypeInfo);
    sub_1C6BA08(&Method_MstHaveItemInfoComponent__setInfoTxt_b__4_0__);
    sub_1C6BA08(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    sub_1C6BA08(&StringLiteral_20617/*"img_servant"*/);
    sub_1C6BA08(&StringLiteral_20562/*"img_qp"*/);
    sub_1C6BA08(&StringLiteral_3929/*"CURRENT_QP_UNIT"*/);
    sub_1C6BA08(&StringLiteral_20457/*"img_fp"*/);
    sub_1C6BA08(&StringLiteral_3927/*"CURRENT_FRIEND_POINT_UNIT"*/);
    sub_1C6BA08(&StringLiteral_20450/*"img_craftessence"*/);
    sub_1C6BA08(&StringLiteral_12483/*"SUM_INFO"*/);
    sub_1C6BA08(&StringLiteral_20409/*"img_cc"*/);
    sub_1C6BA08(&StringLiteral_20651/*"img_sq"*/);
    sub_1C6BA08(&StringLiteral_20614/*"img_rp"*/);
    sub_1C6BA08(&StringLiteral_20526/*"img_mp"*/);
    byte_4CB1370 = 1;
  }
    ...
    if ( imgId <= 18 )
    {
      switch ( imgId )
      {
        case 5:
          ...
          if ( !Instance )
            goto LABEL_69;
          UISprite__set_spriteName((UISprite_o *)Instance, (System_String_o *)StringLiteral_20562/*"img_qp"*/, 0);
          itemNumTxt = this->fields.itemNumTxt;
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3929/*"CURRENT_QP_UNIT"*/, 0);
          if ( !info )
            goto LABEL_69;
        ...
        case 6:
          ...
          if ( !Instance )
            goto LABEL_69;
          UISprite__set_spriteName((UISprite_o *)Instance, (System_String_o *)StringLiteral_20651/*"img_sq"*/, 0);
          if ( !info )
            goto LABEL_69;
          ...
          v21 = (System_Action_int__o *)sub_1C6BC54(System_Action_int__TypeInfo);
        ...
        case 7:
          ...
          if ( !Instance )
            goto LABEL_69;
          UISprite__set_spriteName((UISprite_o *)Instance, (System_String_o *)StringLiteral_20526/*"img_mp"*/, 0);
          if ( !info )
            goto LABEL_69;
          itemNumTxt = this->fields.itemNumTxt;
        ...
        case 12:
          ...
          if ( !Instance )
            goto LABEL_69;
          UISprite__set_spriteName((UISprite_o *)Instance, (System_String_o *)StringLiteral_20457/*"img_fp"*/, 0);
          itemNumTxt = this->fields.itemNumTxt;
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3927/*"CURRENT_FRIEND_POINT_UNIT"*/, 0);
          if ( !info )
            goto LABEL_69;
          v12 = (System_String_o *)Instance;
...
LABEL_68:
        ...
        default:
          ...
          if ( !Instance )
            goto LABEL_69;
          UISprite__set_spriteName((UISprite_o *)Instance, (System_String_o *)StringLiteral_20614/*"img_rp"*/, 0);
          if ( !info )
            goto LABEL_69;
          itemNumTxt = this->fields.itemNumTxt;
...
LABEL_27:
    ...
    if ( Instance )
    {
      UISprite__set_spriteName((UISprite_o *)Instance, (System_String_o *)StringLiteral_20409/*"img_cc"*/, 0);
      itemNumTxt = this->fields.itemNumTxt;
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v9 = LocalizationManager__Get((System_String_o *)StringLiteral_12483/*"SUM_INFO"*/, 0);
      LODWORD(qp) = Count;
  ...
  if ( imgId == 8009 )
  {
    ...
    if ( Instance )
    {
      UISprite__set_spriteName((UISprite_o *)Instance, (System_String_o *)StringLiteral_20450/*"img_craftessence"*/, 0);
      itemNumTxt = this->fields.itemNumTxt;
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v9 = LocalizationManager__Get((System_String_o *)StringLiteral_12483/*"SUM_INFO"*/, 0);
...
LABEL_69:
    sub_1C6BC60(Instance, *(_QWORD *)&imgId);
  }
  if ( imgId != 8008 )
    goto LABEL_44;
  Instance = (DataManager_o *)this->fields.itemNameImg;
  if ( !Instance )
    goto LABEL_69;
  UISprite__set_spriteName((UISprite_o *)Instance, (System_String_o *)StringLiteral_20617/*"img_servant"*/, 0);
  itemNumTxt = this->fields.itemNumTxt;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_12483/*"SUM_INFO"*/, 0);
...
LABEL_42:
  ...
  Instance = (DataManager_o *)System_String__Format_64008100(v9, v14, v16, 0);
  if ( !itemNumTxt )
    goto LABEL_69;
LABEL_43:
