        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A59083 & 1) == 0 )
  {
    ...
    this = (TitleInfoEventLeagueVsGaugeFlashEffect_o *)sub_1B885B0(&StringLiteral_17317/*"bit_vs_gauge_flash_"*/);
    byte_4A59083 = 1;
  }
  v11 = 0.5;
  v12 = 0.5;
  ...
  if ( v15->max_length <= 1 )
LABEL_30:
    sub_1B88814(this, *(_QWORD *)&joinGroupId);
  ...
  v20 = System_String__Concat((Il2CppObject *)StringLiteral_17317/*"bit_vs_gauge_flash_"*/, v19, 0LL);
  ...
  if ( !UnityEngine_Object__op_Inequality(gaugeSimpleAnim, 0LL, 0LL) )
  {
    ...
    if ( this )
    {
      ...
      if ( this )
      {
        UnityEngine_Animation__Play_69204472((UnityEngine_Animation_o *)this, v22, 0LL);
        goto LABEL_28;
      }
    }
LABEL_29:
    sub_1B8880C(this, *(_QWORD *)&joinGroupId);
  }
...
LABEL_25:
  ...
  if ( !this )
    goto LABEL_29;
  SimpleAnimation__Play_63844704((SimpleAnimation_o *)this, v22, 0LL);
LABEL_28:
  v10->fields.endCallBack = callback;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v10->fields.endCallBack, (int32_t)callback, v23, v24);
}