        ...
        const MethodInfo *method)
{
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_17034/*"bankShopId"*/, shopId, v5);
...
System_String_o *PreparePurchaseByBankRequest__getURL(PreparePurchaseByBankRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB7E83 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_23528/*"shop/preparePurchaseByBank"*/);
    byte_4CB7E83 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63966792(BaseUrl, (System_String_o *)StringLiteral_23528/*"shop/preparePurchaseByBank"*/, 0);
}
