        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFDD1 & 1) == 0 )
  {
    sub_1B64870(&PurchaseBehaviour_TypeInfo, *(_QWORD *)&shopId);
    sub_1B64870(&StringLiteral_16991/*"bankShopId"*/, v5);
    byte_49FFDD1 = 1;
  }
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_16991/*"bankShopId"*/, shopId, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFDD0 & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_23174/*"shop/preparePurchaseByBank"*/, v2);
    byte_49FFDD0 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61383576(BaseUrl, (System_String_o *)StringLiteral_23174/*"shop/preparePurchaseByBank"*/, 0LL);
}
