        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDCD6 & 1) == 0 )
  {
    sub_1B640C8(&PurchaseBehaviour_TypeInfo, *(_QWORD *)&shopId);
    sub_1B640C8(&StringLiteral_16989/*"bankShopId"*/, v5);
    byte_49FDCD6 = 1;
  }
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_16989/*"bankShopId"*/, shopId, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDCD5 & 1) == 0 )
  {
    ...
    sub_1B640C8(&StringLiteral_23171/*"shop/preparePurchaseByBank"*/, v2);
    byte_49FDCD5 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61375396(BaseUrl, (System_String_o *)StringLiteral_23171/*"shop/preparePurchaseByBank"*/, 0LL);
}
