        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A213B7 & 1) == 0 )
  {
    sub_1B715CC(&PurchaseBehaviour_TypeInfo, *(_QWORD *)&shopId);
    sub_1B715CC(&StringLiteral_17007/*"bankShopId"*/, v5);
    byte_4A213B7 = 1;
  }
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_17007/*"bankShopId"*/, shopId, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A213B6 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_23210/*"shop/preparePurchaseByBank"*/, v2);
    byte_4A213B6 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61505504(BaseUrl, (System_String_o *)StringLiteral_23210/*"shop/preparePurchaseByBank"*/, 0LL);
}
