        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB7654 & 1) == 0 )
  {
    sub_1BAB41C(&PurchaseBehaviour_TypeInfo, *(_QWORD *)&shopId);
    sub_1BAB41C(&StringLiteral_17090/*"bankShopId"*/, v5);
    byte_4AB7654 = 1;
  }
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_17090/*"bankShopId"*/, shopId, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB7653 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_23304/*"shop/preparePurchaseByBank"*/, v2);
    byte_4AB7653 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62048128(BaseUrl, (System_String_o *)StringLiteral_23304/*"shop/preparePurchaseByBank"*/, 0LL);
}
