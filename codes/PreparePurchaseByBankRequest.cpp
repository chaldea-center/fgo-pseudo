void __fastcall PreparePurchaseByBankRequest___ctor(PreparePurchaseByBankRequest_o *this, const MethodInfo *method)
{
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4FF3E & 1) == 0 )
  {
    sub_1B863B8(&PurchaseBehaviour_TypeInfo, *(_QWORD *)&shopId);
    sub_1B863B8(&StringLiteral_16811/*"bankShopId"*/, v5);
    byte_4A4FF3E = 1;
  }
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_16811/*"bankShopId"*/, shopId, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4FF3D & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_23117/*"shop/preparePurchaseByBank"*/, v2);
    byte_4A4FF3D = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61645176(BaseUrl, (System_String_o *)StringLiteral_23117/*"shop/preparePurchaseByBank"*/, 0LL);
}
