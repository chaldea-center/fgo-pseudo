...
void __fastcall ServantStatusListViewObject__Awake(ServantStatusListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1F8E0 & 1) == 0 )
  {
    sub_1C3B764(&Method_UnityEngine_GameObject_GetComponent_ServantStatusListViewItemDraw___, method);
    byte_4C1F8E0 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_3041A18 *)Method_UnityEngine_GameObject_GetComponent_ServantStatusListViewItemDraw___);
...
LABEL_17:
      ...
      {
        p_callbackFunc->klass = 0LL;
        sub_1C3B708(p_callbackFunc, 0LL, (int64_t)v21, v22, v23, v24, v25, v26);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantStatusListViewObject__Init_36447316(
        ServantStatusListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantStatusListViewObject__Init_36450184(
        ServantStatusListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantStatusListViewObject__Init_36450268(
        ServantStatusListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
        ...
        const MethodInfo *method)
{
  ...
  sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.mainInfo, (int64_t)item, (int64_t)method, v3, v4, v5, v6, v7);
  ServantStatusListViewObject__Init_36447316(this, 2, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !*((_DWORD *)p_manager + 12) )
    ServantStatusListViewObject__Init_36447316(this, 2, v10);
}
