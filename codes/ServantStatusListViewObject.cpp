...
void __fastcall ServantStatusListViewObject__Awake(ServantStatusListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFB187 & 1) == 0 )
  {
    sub_1C2E12C(&Method_UnityEngine_GameObject_GetComponent_ServantStatusListViewItemDraw___, method);
    byte_4BFB187 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_3022B0C *)Method_UnityEngine_GameObject_GetComponent_ServantStatusListViewItemDraw___);
...
LABEL_17:
      ...
      {
        p_callbackFunc->klass = 0LL;
        sub_1C2E0D0(p_callbackFunc, 0LL, (int64_t)v21, v22, v23, v24, v25, v26);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantStatusListViewObject__Init_36423956(
        ServantStatusListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantStatusListViewObject__Init_36426824(
        ServantStatusListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantStatusListViewObject__Init_36426908(
        ServantStatusListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
        ...
        const MethodInfo *method)
{
  ...
  sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.mainInfo, (int64_t)item, (int64_t)method, v3, v4, v5, v6, v7);
  ServantStatusListViewObject__Init_36423956(this, 2, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !*((_DWORD *)p_manager + 12) )
    ServantStatusListViewObject__Init_36423956(this, 2, v10);
}
