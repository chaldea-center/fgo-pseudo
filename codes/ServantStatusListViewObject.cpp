...
void __fastcall ServantStatusListViewObject__Awake(ServantStatusListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4C44E & 1) == 0 )
  {
    sub_1B863B8(&Method_UnityEngine_GameObject_GetComponent_ServantStatusListViewItemDraw___, method);
    byte_4A4C44E = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2FC0DF0 *)Method_UnityEngine_GameObject_GetComponent_ServantStatusListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  p_callbackFunc = (CGThumbnailListItem_o *)&this->fields.callbackFunc;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.callbackFunc, (int32_t)callbackFunc, v14, v15);
  switch ( initMode )
  {
    case 0:
    case 1:
...
LABEL_17:
      ...
      {
        p_callbackFunc->klass = 0LL;
        sub_1B8635C(p_callbackFunc, 0, (int32_t)v17, v18);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantStatusListViewObject__Init_36786468(
        ServantStatusListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantStatusListViewObject__Init_36789336(
        ServantStatusListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantStatusListViewObject__Init_36789420(
        ServantStatusListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
        ...
        const MethodInfo *method)
{
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.mainInfo, (int32_t)item, (int32_t)method, v3);
  ServantStatusListViewObject__Init_36786468(this, 2, v5);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !*((_DWORD *)p_manager + 12) )
    ServantStatusListViewObject__Init_36786468(this, 2, v6);
}
