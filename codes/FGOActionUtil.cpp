        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDA5D & 1) == 0 )
  {
    sub_1B640C8(&Method_UnityEngine_GameObject_GetComponent_BattleActorControl___, name);
    sub_1B640C8(&UnityEngine_GameObject_TypeInfo, v7);
    sub_1B640C8(&UnityEngine_Object_TypeInfo, v8);
    sub_1B640C8(&StringLiteral_3190/*"Battle/CommonEffects/"*/, v9);
    sub_1B640C8(&StringLiteral_18797/*"effect/"*/, v10);
    byte_49FDA5D = 1;
  }
  if ( folder == 2 )
  {
    v11 = &StringLiteral_18797/*"effect/"*/;
LABEL_8:
    v12 = System_String__Concat_61375396((System_String_o *)*v11, name, 0LL);
  ...
  v14 = UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)actorObject, 0LL, 0LL);
  result = 0LL;
  if ( v14 )
  {
    if ( !actorObject
      || (result = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                 actorObject,
                                                 (const MethodInfo_2E87ED8 *)Method_UnityEngine_GameObject_GetComponent_BattleActorControl___)) == 0LL )
    {
      sub_1B64324(result);
    }
