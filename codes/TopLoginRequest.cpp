...
void __fastcall TopLoginRequest__ResetAccesTime(const MethodInfo *method)
{
  ...
  if ( (byte_4A2143E & 1) == 0 )
  {
    sub_1B715CC(&TopLoginRequest_TypeInfo, v1);
    byte_4A2143E = 1;
  }
...
void __fastcall TopLoginRequest__beginRequest(TopLoginRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2143C & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_16887/*"assetbundleFolder"*/, v5);
    sub_1B715CC(&StringLiteral_24382/*"userState"*/, v6);
    sub_1B715CC(&StringLiteral_20989/*"lastAccessTime"*/, v7);
    sub_1B715CC(&StringLiteral_20769/*"isTerminalLogin"*/, v8);
    byte_4A2143C = 1;
  }
...
LABEL_17:
  ...
  Item = System_Collections_Generic_Dictionary_object__object___get_Item(
           ...
           (Il2CppObject *)StringLiteral_20989/*"lastAccessTime"*/,
  ...
  RequestBase__addField_40922716(
    (RequestBase_o *)this,
    (System_String_o *)StringLiteral_24382/*"userState"*/,
    v16 & v15 ^ (unsigned __int64)(v19 >> 2),
    0LL);
  RequestBase__addField_40916388((RequestBase_o *)this, (System_String_o *)StringLiteral_16887/*"assetbundleFolder"*/, dataServerFolder, 0LL);
  TerminalDispState = NetworkManager__GetTerminalDispState(0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_20769/*"isTerminalLogin"*/, TerminalDispState, 0LL);
...
bool __fastcall TopLoginRequest__checkExpirationDate(TopLoginRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2143B & 1) == 0 )
  {
    ...
    sub_1B715CC(&TopLoginRequest_TypeInfo, v2);
    byte_4A2143B = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
...
System_String_o *__fastcall TopLoginRequest__getURL(TopLoginRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B715CC(&NetworkManager_TypeInfo, method);
    sub_1B715CC(&StringLiteral_21151/*"login/top"*/, v2);
    byte_4A21439 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61505504(BaseUrl, (System_String_o *)StringLiteral_21151/*"login/top"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  int64_t NextDayTime_38272876; // x22
  int64_t v43; // x0
  int64_t v44; // x9
  ...
  if ( (byte_4A2143D & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_NetworkManager_getRequest_UserStatusFlagSetBackgroundRequest___, v9);
    sub_1B715CC(&NetworkManager_TypeInfo, v10);
    sub_1B715CC(&OtherUserNewManager_TypeInfo, v11);
    sub_1B715CC(&ResponseCommandKind_TypeInfo, v12);
    sub_1B715CC(&ResponseFailData_TypeInfo, v13);
    sub_1B715CC(&ServantCommentManager_TypeInfo, v14);
    sub_1B715CC(&ServantProfileEventJoinManager_TypeInfo, v15);
    sub_1B715CC(&ServantProfileLimitCountManager_TypeInfo, v16);
    sub_1B715CC(&Method_SingletonMonoBehaviour_CrashReporter__get_Instance__, v17);
    sub_1B715CC(&Method_SingletonMonoBehaviour_AdManager__get_Instance__, v18);
    sub_1B715CC(&Method_SingletonMonoBehaviour_NetworkManager__get_Instance__, v19);
    sub_1B715CC(&TopLoginRequest_TypeInfo, v20);
    sub_1B715CC(&UserCommandCodeCollectionManager_TypeInfo, v21);
    sub_1B715CC(&UserCommandCodeNewManager_TypeInfo, v22);
    sub_1B715CC(&UserEquipNewManager_TypeInfo, v23);
    sub_1B715CC(&UserServantCollectionManager_TypeInfo, v24);
    sub_1B715CC(&UserServantNewManager_TypeInfo, v25);
    sub_1B715CC(&StringLiteral_22000/*"ng"*/, v26);
    sub_1B715CC(&StringLiteral_18605/*"do_signup"*/, v27);
    byte_4A2143D = 1;
  }
  dateData = 0LL;
  if ( (byte_4A2142F & 1) == 0 )
  ...
  if ( !v28 )
    goto LABEL_68;
  v29 = v28;
  if ( !ResponseData__checkError_40915860(v28, 0LL) )
  {
    v49 = (ResponseFailData_o *)sub_1B71818(ResponseFailData_TypeInfo);
    ResponseFailData___ctor(v49, v29, 0LL);
    TopLoginRequest_TypeInfo->static_fields->accessTime = 0LL;
    if ( !v49 )
      goto LABEL_70;
    if ( System_String__op_Equality(v49->fields.action, (System_String_o *)StringLiteral_18605/*"do_signup"*/, 0LL) )
    {
      v48 = (System_String_o *)StringLiteral_18605/*"do_signup"*/;
      goto LABEL_69;
    }
LABEL_68:
    TopLoginRequest_TypeInfo->static_fields->accessTime = 0LL;
    v48 = (System_String_o *)StringLiteral_22000/*"ng"*/;
    goto LABEL_69;
  }
  ...
  if ( v32->static_fields->UseDebugCommand )
  {
    ...
    if ( !NetworkManager__ReadSignup((NetworkManager_o *)Instance, 0LL) )
    {
      ...
      v36 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_NetworkManager__get_Instance__);
      ...
      if ( !v39 )
        goto LABEL_70;
      NetworkManager__SetSignup_38262348(v39, name, genderType, Month, (int32_t)Instance, 0LL);
      Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_NetworkManager__get_Instance__);
      if ( !Instance )
        goto LABEL_70;
  ...
  NextDayTime_38272876 = NetworkManager__getNextDayTime_38272876(v41->static_fields->RequestTopLoginResetTime1, 0LL);
  v43 = NetworkManager__getNextDayTime_38272876(BalanceConfig_TypeInfo->static_fields->RequestTopLoginResetTime2, 0LL);
  if ( NextDayTime_38272876 <= v43 )
    v44 = NextDayTime_38272876;
  else
    v44 = v43;
  ...
  Request_object = NetworkManager__getRequest_object_(
                     0LL,
                     (const MethodInfo_2EDD4A0 *)Method_NetworkManager_getRequest_UserStatusFlagSetBackgroundRequest___);
