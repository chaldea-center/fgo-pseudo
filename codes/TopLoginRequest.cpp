...
LABEL_18:
        ...
        if ( System_String__IsNullOrEmpty(v7->static_fields->_AppCheckTokenError_k__BackingField, 0) )
        {
          RequestBase__addField_45365032(
            ...
            (System_String_o *)StringLiteral_14405/*"The token wasn't created in time"*/,
            v2);
          v8 = 0;
          goto LABEL_47;
        }
        ...
        v12 = &StringLiteral_16984/*"appCheckErrorMessage"*/;
    ...
    v12 = &StringLiteral_16986/*"appCheckToken"*/;
    AppCheckTokenError_k__BackingField = v11->static_fields->_AppCheckToken_k__BackingField;
LABEL_45:
    v9 = (System_String_o *)*v12;
    goto LABEL_46;
  }
  v9 = (System_String_o *)StringLiteral_16984/*"appCheckErrorMessage"*/;
  AppCheckTokenError_k__BackingField = (System_String_o *)StringLiteral_6796/*"Firebase wasn't available"*/;
LABEL_46:
  RequestBase__addField_45365032((RequestBase_o *)this, v9, AppCheckTokenError_k__BackingField, v2);
  v8 = 1;
LABEL_47:
  if ( !FirebaseScript_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(FirebaseScript_TypeInfo);
  ...
  if ( UnityEngine_PlayerPrefs__HasKey(v14->static_fields->_AppCheckPrevMessageKey_k__BackingField, 0) )
  {
    ...
    String_72876844 = UnityEngine_PlayerPrefs__GetString_72876844(
                        ...
                        0);
    RequestBase__addField_45365032((RequestBase_o *)this, AppCheckPrevMessageKey_k__BackingField, String_72876844, v18);
    if ( !byte_4E042CA )
    {
      sub_1CE6700(&FirebaseScript_TypeInfo);
      byte_4E042CA = 1;
...
void TopLoginRequest__beginRequest(TopLoginRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E06625 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_17088/*"assetbundleFolder"*/);
    sub_1CE6700(&StringLiteral_24975/*"userState"*/);
    sub_1CE6700(&StringLiteral_21498/*"lastAccessTime"*/);
    sub_1CE6700(&StringLiteral_21278/*"isTerminalLogin"*/);
    byte_4E06625 = 1;
  }
...
LABEL_21:
  ...
  Item = System_Collections_Generic_Dictionary_object__object___get_Item(
           ...
           (Il2CppObject *)StringLiteral_21498/*"lastAccessTime"*/,
  ...
  RequestBase__addField_45375920(
    (RequestBase_o *)this,
    (System_String_o *)StringLiteral_24975/*"userState"*/,
    (unsigned int)v11 & v10 ^ (unsigned __int64)(v15 >> 2),
    v14);
  RequestBase__addField_45365032((RequestBase_o *)this, (System_String_o *)StringLiteral_17088/*"assetbundleFolder"*/, dataServerFolder, v16);
  TerminalDispState = NetworkManager__GetTerminalDispState(0);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21278/*"isTerminalLogin"*/, TerminalDispState, v18);
...
System_String_o *TopLoginRequest__getURL(TopLoginRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&NetworkManager_TypeInfo);
    sub_1CE6700(&StringLiteral_21676/*"login/top"*/);
    byte_4E06622 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_65122828(BaseUrl, (System_String_o *)StringLiteral_21676/*"login/top"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  int64_t NextDayTime_42521756; // x21
  int64_t v25; // x0
  int64_t v26; // x9
    ...
    if ( SelfUserGame )
    {
      ...
      if ( v10->static_fields->UseDebugCommand )
      {
        ...
        if ( !NetworkManager__ReadSignup(Instance, 0) )
        {
          ...
          v14 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_NetworkManager__get_Instance__);
          name = v9->fields.name;
          ...
          if ( !v17 )
            goto LABEL_68;
          NetworkManager__SetSignup_42510652(v17, name, genderType, Month, (int32_t)Instance, 0);
          Instance = (NetworkManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_NetworkManager__get_Instance__);
          if ( !Instance )
            goto LABEL_68;
      ...
      Instance = (NetworkManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_AdManager__get_Instance__);
      if ( Instance )
      {
        ...
        if ( Instance )
        {
          ...
          Instance = (NetworkManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_CrashReporter__get_Instance__);
          if ( Instance )
          {
            p_fields = (int64_t)&v9->fields;
            CrashReporter__SetFriendCode((CrashReporter_o *)Instance, v9->fields.friendCode, 0);
            v22 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_CrashReporter__get_Instance__);
            ...
            if ( v22 )
            {
              ...
              NextDayTime_42521756 = NetworkManager__getNextDayTime_42521756(
                                       v23->static_fields->RequestTopLoginResetTime1,
                                       0);
              v25 = NetworkManager__getNextDayTime_42521756(
                      BalanceConfig_TypeInfo->static_fields->RequestTopLoginResetTime2,
                      0);
              if ( NextDayTime_42521756 <= v25 )
                v26 = NextDayTime_42521756;
              else
                v26 = v25;
...
LABEL_65:
  ...
  v31 = (ResponseFailData_o *)sub_1CE694C(ResponseFailData_TypeInfo);
  ResponseFailData___ctor(v31, v7, v32);
  TopLoginRequest_TypeInfo->static_fields->accessTime = 0;
  if ( !v31 )
    goto LABEL_68;
  if ( !System_String__op_Equality(v31->fields.action, (System_String_o *)StringLiteral_18883/*"do_signup"*/, 0) )
    goto LABEL_65;
  CallBack = this->fields.CallBack;
  if ( CallBack )
  {
    v30 = StringLiteral_18883/*"do_signup"*/;
    goto LABEL_64;
  }
}