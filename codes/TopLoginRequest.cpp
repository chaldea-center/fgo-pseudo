...
void __fastcall TopLoginRequest__AddAppCheckField(TopLoginRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BC92B & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_13961/*"The token wasn't created in time"*/, v3);
    sub_1B4CF90(&StringLiteral_16504/*"appCheckPrevMessage"*/, v4);
    sub_1B4CF90(&StringLiteral_16505/*"appCheckToken"*/, v5);
    sub_1B4CF90(&StringLiteral_16503/*"appCheckErrorMessage"*/, v6);
    sub_1B4CF90(&StringLiteral_6639/*"Firebase wasn't available"*/, v7);
    byte_49BC92B = 1;
  }
...
LABEL_18:
        if ( !byte_49BA786 )
        {
          sub_1B4CF90(&FirebaseScript_TypeInfo, v10);
          byte_49BA786 = 1;
        }
        ...
        if ( System_String__IsNullOrEmpty(v12->static_fields->_AppCheckTokenError_k__BackingField, 0LL) )
        {
          RequestBase__addField_41748396(
            (RequestBase_o *)this,
            (System_String_o *)StringLiteral_16503/*"appCheckErrorMessage"*/,
            (System_String_o *)StringLiteral_13961/*"The token wasn't created in time"*/,
            0LL);
          v15 = 0;
          goto LABEL_47;
        }
        ...
        if ( !byte_49BA786 )
        {
          sub_1B4CF90(&FirebaseScript_TypeInfo, v13);
          byte_49BA786 = 1;
        }
        ...
        v19 = &StringLiteral_16503/*"appCheckErrorMessage"*/;
    ...
    v19 = &StringLiteral_16505/*"appCheckToken"*/;
    AppCheckTokenError_k__BackingField = v18->static_fields->_AppCheckToken_k__BackingField;
LABEL_45:
    v16 = (System_String_o *)*v19;
    goto LABEL_46;
  }
  v16 = (System_String_o *)StringLiteral_16503/*"appCheckErrorMessage"*/;
  AppCheckTokenError_k__BackingField = (System_String_o *)StringLiteral_6639/*"Firebase wasn't available"*/;
LABEL_46:
  RequestBase__addField_41748396((RequestBase_o *)this, v16, AppCheckTokenError_k__BackingField, 0LL);
  v15 = 1;
LABEL_47:
  if ( !FirebaseScript_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(FirebaseScript_TypeInfo);
  if ( !byte_49BA782 )
  {
    sub_1B4CF90(&FirebaseScript_TypeInfo, v14);
    byte_49BA782 = 1;
  }
  ...
  v22 = (System_String_o *)StringLiteral_16504/*"appCheckPrevMessage"*/;
  if ( UnityEngine_PlayerPrefs__HasKey((System_String_o *)StringLiteral_16504/*"appCheckPrevMessage"*/, 0LL) )
  {
    String_68762736 = UnityEngine_PlayerPrefs__GetString_68762736(v22, 0LL);
    RequestBase__addField_41748396((RequestBase_o *)this, v22, String_68762736, 0LL);
...
void __fastcall TopLoginRequest__ResetAccesTime(const MethodInfo *method)
{
  ...
  if ( (byte_49BC92A & 1) == 0 )
  {
    sub_1B4CF90(&TopLoginRequest_TypeInfo, v1);
    byte_49BC92A = 1;
  }
...
void __fastcall TopLoginRequest__beginRequest(TopLoginRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BC928 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_16626/*"assetbundleFolder"*/, v5);
    sub_1B4CF90(&StringLiteral_24155/*"userState"*/, v6);
    sub_1B4CF90(&StringLiteral_20749/*"lastAccessTime"*/, v7);
    sub_1B4CF90(&StringLiteral_20537/*"isTerminalLogin"*/, v8);
    byte_49BC928 = 1;
  }
  ...
  if ( !UTF8 )
    goto LABEL_21;
  v14 = (System_Byte_array *)(*(__int64 (__fastcall **)(_QWORD *, System_String_o *, _QWORD))(*UTF8 + 600LL))(
                               UTF8,
                               dataServerFolder,
                               *(_QWORD *)(*UTF8 + 608LL));
...
LABEL_21:
  ...
  Item = System_Collections_Generic_Dictionary_object__object___get_Item(
           ...
           (Il2CppObject *)StringLiteral_20749/*"lastAccessTime"*/,
  ...
  RequestBase__addField_41754736(
    (RequestBase_o *)this,
    (System_String_o *)StringLiteral_24155/*"userState"*/,
    (unsigned int)v16 & v15 ^ (unsigned __int64)(v19 >> 2),
    0LL);
  RequestBase__addField_41748396((RequestBase_o *)this, (System_String_o *)StringLiteral_16626/*"assetbundleFolder"*/, dataServerFolder, 0LL);
  TerminalDispState = NetworkManager__GetTerminalDispState(0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_20537/*"isTerminalLogin"*/, TerminalDispState, 0LL);
...
bool __fastcall TopLoginRequest__checkExpirationDate(TopLoginRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BC927 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&TopLoginRequest_TypeInfo, v2);
    byte_49BC927 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
...
System_String_o *__fastcall TopLoginRequest__getURL(TopLoginRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B4CF90(&NetworkManager_TypeInfo, method);
    sub_1B4CF90(&StringLiteral_20908/*"login/top"*/, v2);
    byte_49BC925 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61093468(BaseUrl, (System_String_o *)StringLiteral_20908/*"login/top"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  int64_t NextDayTime_39106004; // x22
  int64_t v44; // x0
  int64_t v45; // x9
  ...
  if ( (byte_49BC929 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_NetworkManager_getRequest_UserStatusFlagSetBackgroundRequest___, v9);
    sub_1B4CF90(&NetworkManager_TypeInfo, v10);
    sub_1B4CF90(&OtherUserNewManager_TypeInfo, v11);
    sub_1B4CF90(&ResponseCommandKind_TypeInfo, v12);
    sub_1B4CF90(&ResponseFailData_TypeInfo, v13);
    sub_1B4CF90(&ServantCommentManager_TypeInfo, v14);
    sub_1B4CF90(&ServantProfileEventJoinManager_TypeInfo, v15);
    sub_1B4CF90(&ServantProfileLimitCountManager_TypeInfo, v16);
    sub_1B4CF90(&Method_SingletonMonoBehaviour_CrashReporter__get_Instance__, v17);
    sub_1B4CF90(&Method_SingletonMonoBehaviour_AdManager__get_Instance__, v18);
    sub_1B4CF90(&Method_SingletonMonoBehaviour_NetworkManager__get_Instance__, v19);
    sub_1B4CF90(&TopLoginRequest_TypeInfo, v20);
    sub_1B4CF90(&UserCommandCodeCollectionManager_TypeInfo, v21);
    sub_1B4CF90(&UserCommandCodeNewManager_TypeInfo, v22);
    sub_1B4CF90(&UserEquipNewManager_TypeInfo, v23);
    sub_1B4CF90(&UserServantCollectionManager_TypeInfo, v24);
    sub_1B4CF90(&UserServantNewManager_TypeInfo, v25);
    sub_1B4CF90(&StringLiteral_21779/*"ng"*/, v26);
    sub_1B4CF90(&StringLiteral_18348/*"do_signup"*/, v27);
    byte_49BC929 = 1;
  }
  dateData = 0LL;
  if ( (byte_49BC91B & 1) == 0 )
  ...
  {
    v50 = (ResponseFailData_o *)sub_1B4D1DC(ResponseFailData_TypeInfo);
    ResponseFailData___ctor(v50, v30, v51);
    TopLoginRequest_TypeInfo->static_fields->accessTime = 0LL;
    if ( !v50 )
      goto LABEL_70;
    if ( System_String__op_Equality(v50->fields.action, (System_String_o *)StringLiteral_18348/*"do_signup"*/, 0LL) )
    {
      v49 = (System_String_o *)StringLiteral_18348/*"do_signup"*/;
      goto LABEL_69;
    }
LABEL_68:
    TopLoginRequest_TypeInfo->static_fields->accessTime = 0LL;
    v49 = (System_String_o *)StringLiteral_21779/*"ng"*/;
    goto LABEL_69;
  }
  ...
  if ( v33->static_fields->UseDebugCommand )
  {
    ...
    if ( !NetworkManager__ReadSignup((NetworkManager_o *)Instance, 0LL) )
    {
      ...
      v37 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37B4410 *)Method_SingletonMonoBehaviour_NetworkManager__get_Instance__);
      ...
      if ( !v40 )
        goto LABEL_70;
      NetworkManager__SetSignup_39094900(v40, name, genderType, Month, (int32_t)Instance, 0LL);
      Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37B4410 *)Method_SingletonMonoBehaviour_NetworkManager__get_Instance__);
      if ( !Instance )
        goto LABEL_70;
  ...
  NextDayTime_39106004 = NetworkManager__getNextDayTime_39106004(v42->static_fields->RequestTopLoginResetTime1, 0LL);
  v44 = NetworkManager__getNextDayTime_39106004(BalanceConfig_TypeInfo->static_fields->RequestTopLoginResetTime2, 0LL);
  if ( NextDayTime_39106004 <= v44 )
    v45 = NextDayTime_39106004;
  else
    v45 = v44;
  ...
  Request_object = NetworkManager__getRequest_object_(
                     0LL,
                     (const MethodInfo_2F86AFC *)Method_NetworkManager_getRequest_UserStatusFlagSetBackgroundRequest___);
  Instance = (Il2CppObject *)sub_1B4D038(int___TypeInfo, 1LL);
  if ( !Instance )
    goto LABEL_70;
  v35 = Instance;
