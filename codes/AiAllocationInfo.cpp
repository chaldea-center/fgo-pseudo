void __fastcall AiAllocationInfo___ctor(AiAllocationInfo_o *this, Il2CppObject *obj, const MethodInfo *method)
{
  ...
  if ( (byte_4A1F5AE & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_EntityScriptUtil_GetScriptValue_List_object___List_int____, v5);
    sub_1B715CC(&Method_EntityScriptValueConvertLogic_ObjectListToIntList__, v6);
    sub_1B715CC(&System_Func_List_object___List_int___TypeInfo, v7);
    sub_1B715CC(&int___TypeInfo, v8);
    sub_1B715CC(&StringLiteral_16667/*"aiIds"*/, v9);
    sub_1B715CC(&StringLiteral_20591/*"individuality"*/, v10);
    sub_1B715CC(&StringLiteral_16798/*"applySvtType"*/, v11);
    byte_4A1F5AE = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
  v12 = (System_Func_object__object__o *)sub_1B71818(System_Func_List_object___List_int___TypeInfo);
  ...
  ScriptValue_object__object = EntityScriptUtil__GetScriptValue_object__object_(
                                 ...
                                 (System_String_o *)StringLiteral_16667/*"aiIds"*/,
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)ScriptValue_object__object, v15, v16);
  this->fields._ApplyType_k__BackingField = EntityScriptUtil__GetIntValue(
                                              (System_Collections_Generic_Dictionary_string__object__o *)obj,
                                              (System_String_o *)StringLiteral_16798/*"applySvtType"*/,
                                              0,
                                              0LL);
  IntValue = EntityScriptUtil__GetIntValue(
               (System_Collections_Generic_Dictionary_string__object__o *)obj,
               (System_String_o *)StringLiteral_20591/*"individuality"*/,
               0,
               0LL);
  if ( IntValue < 1 )
  {
  ...
  v20 = IntValue;
  v21 = sub_1B71674(int___TypeInfo, 1LL);
  if ( !v21 )
LABEL_13:
    sub_1B71828(v21, v22);
