void __fastcall AiAllocationInfo___ctor(AiAllocationInfo_o *this, Il2CppObject *obj, const MethodInfo *method)
{
  ...
  if ( (byte_49FDFF3 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_EntityScriptUtil_GetScriptValue_List_object___List_int____, v5);
    sub_1B64870(&Method_EntityScriptValueConvertLogic_ObjectListToIntList__, v6);
    sub_1B64870(&System_Func_List_object___List_int___TypeInfo, v7);
    sub_1B64870(&int___TypeInfo, v8);
    sub_1B64870(&StringLiteral_16650/*"aiIds"*/, v9);
    sub_1B64870(&StringLiteral_20565/*"individuality"*/, v10);
    sub_1B64870(&StringLiteral_16781/*"applySvtType"*/, v11);
    byte_49FDFF3 = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
  v12 = (System_Func_object__object__o *)sub_1B64ABC(System_Func_List_object___List_int___TypeInfo);
  ...
  ScriptValue_object__object = EntityScriptUtil__GetScriptValue_object__object_(
                                 ...
                                 (System_String_o *)StringLiteral_16650/*"aiIds"*/,
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)ScriptValue_object__object, v15, v16);
  this->fields._ApplyType_k__BackingField = EntityScriptUtil__GetIntValue(
                                              (System_Collections_Generic_Dictionary_string__object__o *)obj,
                                              (System_String_o *)StringLiteral_16781/*"applySvtType"*/,
                                              0,
                                              0LL);
  IntValue = EntityScriptUtil__GetIntValue(
               (System_Collections_Generic_Dictionary_string__object__o *)obj,
               (System_String_o *)StringLiteral_20565/*"individuality"*/,
               0,
               0LL);
  if ( IntValue < 1 )
  {
  ...
  v20 = IntValue;
  v21 = sub_1B64918(int___TypeInfo, 1LL);
  if ( !v21 )
LABEL_13:
    sub_1B64ACC(v21, v22);
