void __fastcall AiAllocationInfo___ctor(AiAllocationInfo_o *this, Il2CppObject *obj, const MethodInfo *method)
{
  ...
  if ( (byte_49FE613 & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_EntityScriptUtil_GetScriptValue_List_object___List_int____, v5);
    sub_1B64A00(&Method_EntityScriptValueConvertLogic_ObjectListToIntList__, v6);
    sub_1B64A00(&System_Func_List_object___List_int___TypeInfo, v7);
    sub_1B64A00(&int___TypeInfo, v8);
    sub_1B64A00(&StringLiteral_16651/*"aiIds"*/, v9);
    sub_1B64A00(&StringLiteral_20565/*"individuality"*/, v10);
    sub_1B64A00(&StringLiteral_16782/*"applySvtType"*/, v11);
    byte_49FE613 = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
  v12 = (System_Func_object__object__o *)sub_1B64C4C(System_Func_List_object___List_int___TypeInfo);
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)ScriptValue_object__object, v15, v16);
  ...
  v20 = IntValue;
  v21 = sub_1B64AA8(int___TypeInfo, 1LL);
  if ( !v21 )
LABEL_13:
    sub_1B64C5C(v21, v22);
