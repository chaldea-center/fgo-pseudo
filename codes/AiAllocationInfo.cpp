void __fastcall AiAllocationInfo___ctor(AiAllocationInfo_o *this, Il2CppObject *obj, const MethodInfo *method)
{
  ...
  if ( (byte_42ADFAA & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_16407/*"aiIds"*/);
    sub_B52984(&StringLiteral_19946/*"individuality"*/);
    sub_B52984(&StringLiteral_16525/*"applySvtType"*/);
    byte_42ADFAA = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
  v5 = (System_Func_WarBoardManager_WarBoardOnboardSkillTarget__WarBoardPieceData__o *)sub_B52A54(System_Func_List_object___List_int___TypeInfo);
  ...
  ScriptValue_object__object = EntityScriptUtil__GetScriptValue_object__object_(
                                 ...
                                 (System_String_o *)StringLiteral_16407/*"aiIds"*/,
  ...
  this->fields._ApplyType_k__BackingField = EntityScriptUtil__GetIntValue(
                                              (System_Collections_Generic_Dictionary_string__object__o *)obj,
                                              (System_String_o *)StringLiteral_16525/*"applySvtType"*/,
                                              0,
                                              0LL);
  IntValue = EntityScriptUtil__GetIntValue(
               (System_Collections_Generic_Dictionary_string__object__o *)obj,
               (System_String_o *)StringLiteral_19946/*"individuality"*/,
               0,
               0LL);
  if ( IntValue < 1 )
  {
  ...
  v21 = IntValue;
  v22 = sub_B5299C(int___TypeInfo, 1LL);
  if ( !v22 )
LABEL_13:
    sub_B52A5C(v22, v23);
