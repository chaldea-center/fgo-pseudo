void AiAllocationInfo___ctor(AiAllocationInfo_o *this, Il2CppObject *obj, const MethodInfo *method)
{
  ...
  if ( (byte_4C37417 & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_16827/*"applySvtType"*/);
    byte_4C37417 = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0);
  v5 = (System_Func_object__object__o *)sub_1C32E6C(System_Func_List_object___List_int___TypeInfo);
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields, (int32_t)ScriptValue_object__object, v8, v9);
  this->fields._ApplyType_k__BackingField = EntityScriptUtil__GetIntValue(
                                              (System_Collections_Generic_Dictionary_string__object__o *)obj,
                                              (System_String_o *)StringLiteral_16827/*"applySvtType"*/,
                                              0,
                                              0);
  IntValue = EntityScriptUtil__GetIntValue(
               (System_Collections_Generic_Dictionary_string__object__o *)obj,
               (System_String_o *)StringLiteral_20774/*"individuality"*/,
               0,
               0);
  if ( IntValue < 1 )
  {
  ...
  v13 = IntValue;
  v14 = sub_1C32CC8(int___TypeInfo, 1);
  if ( !v14 )
LABEL_13:
    sub_1C32E7C(v14);
...
LABEL_11:
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields._AiIndividuality_k__BackingField, (int32_t)v15, v11, v12);
}
