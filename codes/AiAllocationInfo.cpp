void __fastcall AiAllocationInfo___ctor(AiAllocationInfo_o *this, Il2CppObject *obj, const MethodInfo *method)
{
  ...
  if ( (byte_4B1BF9F & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_EntityScriptUtil_GetScriptValue_List_object___List_int____, v5);
    sub_1BCAFF8(&Method_EntityScriptValueConvertLogic_ObjectListToIntList__, v6);
    sub_1BCAFF8(&System_Func_List_object___List_int___TypeInfo, v7);
    sub_1BCAFF8(&int___TypeInfo, v8);
    sub_1BCAFF8(&StringLiteral_16586/*"aiIds"*/, v9);
    sub_1BCAFF8(&StringLiteral_20590/*"individuality"*/, v10);
    sub_1BCAFF8(&StringLiteral_16691/*"applySvtType"*/, v11);
    byte_4B1BF9F = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
  v12 = (System_Func_object__object__o *)sub_1BCB244(System_Func_List_object___List_int___TypeInfo);
  ...
  ScriptValue_object__object = EntityScriptUtil__GetScriptValue_object__object_(
                                 ...
                                 (System_String_o *)StringLiteral_16586/*"aiIds"*/,
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields, (int32_t)ScriptValue_object__object, v15, v16);
  this->fields._ApplyType_k__BackingField = EntityScriptUtil__GetIntValue(
                                              (System_Collections_Generic_Dictionary_string__object__o *)obj,
                                              (System_String_o *)StringLiteral_16691/*"applySvtType"*/,
                                              0,
                                              0LL);
  IntValue = EntityScriptUtil__GetIntValue(
               (System_Collections_Generic_Dictionary_string__object__o *)obj,
               (System_String_o *)StringLiteral_20590/*"individuality"*/,
               0,
               0LL);
  if ( IntValue < 1 )
  {
...
LABEL_13:
  ...
  if ( !*(_DWORD *)(v21 + 24) )
    sub_1BCB25C(v21, v21, v18);
  *(_DWORD *)(v21 + 32) = v20;
LABEL_11:
  this->fields._AiIndividuality_k__BackingField = v23;
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields._AiIndividuality_k__BackingField, (int32_t)v23, v18, v19);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1BFA0 & 1) == 0 )
  {
    sub_1BCAFF8(&Individuality_TypeInfo, svt);
    byte_4B1BFA0 = 1;
  }
