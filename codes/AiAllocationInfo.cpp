void AiAllocationInfo___ctor(AiAllocationInfo_o *this, Il2CppObject *obj, const MethodInfo *method)
{
  ...
  if ( (byte_4E77107 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_16967/*"aiIds"*/);
    sub_1D0F0B4(&StringLiteral_21169/*"individuality"*/);
    sub_1D0F0B4(&StringLiteral_17073/*"applySvtType"*/);
    byte_4E77107 = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0);
  v5 = (System_Func_object__object__o *)sub_1D0F300(System_Func_List_object___List_int___TypeInfo);
  ...
  ScriptValue_object__object = EntityScriptUtil__GetScriptValue_object__object_(
                                 ...
                                 (System_String_o *)StringLiteral_16967/*"aiIds"*/,
  ...
  this->fields._ApplyType_k__BackingField = EntityScriptUtil__GetIntValue(
                                              (System_Collections_Generic_Dictionary_string__object__o *)obj,
                                              (System_String_o *)StringLiteral_17073/*"applySvtType"*/,
                                              0,
                                              0);
  IntValue = EntityScriptUtil__GetIntValue(
               (System_Collections_Generic_Dictionary_string__object__o *)obj,
               (System_String_o *)StringLiteral_21169/*"individuality"*/,
               0,
               0);
  if ( IntValue < 1 )
  {
  ...
  v21 = IntValue;
  v22 = sub_1D0F15C(int___TypeInfo, 1);
  if ( !v22 )
LABEL_13:
    sub_1D0F30C(v22, v23);
