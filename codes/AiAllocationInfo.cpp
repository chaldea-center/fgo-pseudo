void AiAllocationInfo___ctor(AiAllocationInfo_o *this, Il2CppObject *obj, const MethodInfo *method)
{
  ...
  if ( (byte_4D30452 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_16950/*"applySvtType"*/);
    byte_4D30452 = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0);
  v5 = (System_Func_object__object__o *)sub_1C93D20(System_Func_List_object___List_int___TypeInfo);
  ...
  this->fields._ApplyType_k__BackingField = EntityScriptUtil__GetIntValue(
                                              (System_Collections_Generic_Dictionary_string__object__o *)obj,
                                              (System_String_o *)StringLiteral_16950/*"applySvtType"*/,
                                              0,
                                              0);
  IntValue = EntityScriptUtil__GetIntValue(
               (System_Collections_Generic_Dictionary_string__object__o *)obj,
               (System_String_o *)StringLiteral_21010/*"individuality"*/,
               0,
               0);
  if ( IntValue < 1 )
  {
  ...
  v21 = IntValue;
  v22 = sub_1C93B7C(int___TypeInfo, 1);
  if ( !v22 )
LABEL_13:
    sub_1C93D2C(v22, v23);
