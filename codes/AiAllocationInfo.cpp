void AiAllocationInfo___ctor(AiAllocationInfo_o *this, Il2CppObject *obj, const MethodInfo *method)
{
  ...
  if ( (byte_4C26D3F & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_20762/*"individuality"*/);
    sub_1C2D490(&StringLiteral_16824/*"applySvtType"*/);
    byte_4C26D3F = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0);
  v5 = (System_Func_object__object__o *)sub_1C2D6DC(System_Func_List_object___List_int___TypeInfo);
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields, (int32_t)ScriptValue_object__object, v8, v9);
  this->fields._ApplyType_k__BackingField = EntityScriptUtil__GetIntValue(
                                              (System_Collections_Generic_Dictionary_string__object__o *)obj,
                                              (System_String_o *)StringLiteral_16824/*"applySvtType"*/,
                                              0,
                                              0);
  IntValue = EntityScriptUtil__GetIntValue(
               (System_Collections_Generic_Dictionary_string__object__o *)obj,
               (System_String_o *)StringLiteral_20762/*"individuality"*/,
               0,
               0);
  if ( IntValue < 1 )
  {
...
LABEL_13:
  ...
  if ( !*(_DWORD *)(v14 + 24) )
    sub_1C2D6F4(v14, v14, v11);
  *(_DWORD *)(v14 + 32) = v13;
LABEL_11:
  this->fields._AiIndividuality_k__BackingField = v16;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields._AiIndividuality_k__BackingField, (int32_t)v16, v11, v12);
}
