void __fastcall AiAllocationInfo___ctor(AiAllocationInfo_o *this, Il2CppObject *obj, const MethodInfo *method)
{
  ...
  if ( (byte_4A4DF57 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_EntityScriptUtil_GetScriptValue_List_object___List_int____, v5);
    sub_1B863B8(&Method_EntityScriptValueConvertLogic_ObjectListToIntList__, v6);
    sub_1B863B8(&System_Func_List_object___List_int___TypeInfo, v7);
    sub_1B863B8(&int___TypeInfo, v8);
    sub_1B863B8(&StringLiteral_16486/*"aiIds"*/, v9);
    sub_1B863B8(&StringLiteral_20461/*"individuality"*/, v10);
    sub_1B863B8(&StringLiteral_16614/*"applySvtType"*/, v11);
    byte_4A4DF57 = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
  v12 = (System_Func_object__object__o *)sub_1B86604(System_Func_List_object___List_int___TypeInfo);
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields, (int32_t)ScriptValue_object__object, v15, v16);
  ...
  IntValue = EntityScriptUtil__GetIntValue(
               (System_Collections_Generic_Dictionary_string__object__o *)obj,
               (System_String_o *)StringLiteral_20461/*"individuality"*/,
               0,
               0LL);
  if ( IntValue < 1 )
  {
  ...
  v20 = IntValue;
  v21 = sub_1B86460(int___TypeInfo, 1LL);
  if ( !v21 )
LABEL_13:
    sub_1B86614(v21, v22);
...
LABEL_11:
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields._AiIndividuality_k__BackingField, (int32_t)v23, v18, v19);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4DF58 & 1) == 0 )
  {
    sub_1B863B8(&Individuality_TypeInfo, svt);
    byte_4A4DF58 = 1;
  }
