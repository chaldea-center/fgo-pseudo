...
LABEL_35:
  ...
  switch ( this->fields.sorting )
  {
    ...
    case 1:
      v20 = (System_Comparison_T__o *)sub_1C715FC(System_Comparison_Transform__TypeInfo);
...
void UITable__Reposition(UITable_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.keepWithinPanel )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(mPanel, 0, 0) )
    {
      ...
      if ( !ChildList )
        goto LABEL_28;
      UIPanel__ConstrainTargetToBounds_49486996((UIPanel_o *)ChildList, transform, 1, 0);
      ChildList = (System_Collections_Generic_List_Transform__o *)this->fields.mPanel;
      if ( !ChildList )
        goto LABEL_28;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CCBB76 & 1) == 0 )
  {
    sub_1C713B0(&UnityEngine_Bounds____TypeInfo);
    sub_1C713B0(&UnityEngine_Bounds___TypeInfo);
    ...
    this = (UITable_o *)sub_1C713B0(&UnityEngine_Object_TypeInfo);
    byte_4CCBB76 = 1;
  }
  ...
  *(_QWORD *)&v161.fields.m_Center.fields.z = columns;
  v7 = sub_1C71460(UnityEngine_Bounds____TypeInfo, &v161);
  v8 = sub_1C71458(UnityEngine_Bounds___TypeInfo, (unsigned int)columns);
  v9 = sub_1C71458(UnityEngine_Bounds___TypeInfo, (unsigned int)v6);
  ...
  if ( size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      this = (UITable_o *)NGUIMath__CalculateRelativeWidgetBounds_49666724(
                            &v161,
...
LABEL_77:
  ...
  if ( pivot )
  {
    ...
    NGUIMath__CalculateRelativeWidgetBounds_49666724(&v161, transform, transform, 0, 1, v143);
...
void UITable__Sort(UITable_o *this, System_Collections_Generic_List_Transform__o *list, const MethodInfo *method)
{
  ...
  v4 = (System_Comparison_T__o *)sub_1C715FC(System_Comparison_Transform__TypeInfo);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1AAE2F4;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1AAE2B4;
}
