void __fastcall EventInfoSkillGetDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BFEE2E & 1) == 0 )
  {
    sub_1C2E12C(&EventInfoSkillGetDialog_TypeInfo, v1);
    sub_1C2E12C(&StringLiteral_5747/*"EVENT_INFO_SKILL_GET_DIALOG_TEXT_{0}"*/, v8);
    byte_4BFEE2E = 1;
  }
  EventInfoSkillGetDialog_TypeInfo->static_fields->MessageLocalizationKey = (struct System_String_o *)StringLiteral_5747/*"EVENT_INFO_SKILL_GET_DIALOG_TEXT_{0}"*/;
  sub_1C2E0D0(
    (PartyOrganizationUtility_o *)EventInfoSkillGetDialog_TypeInfo->static_fields,
    StringLiteral_5747/*"EVENT_INFO_SKILL_GET_DIALOG_TEXT_{0}"*/,
    v2,
    v3,
    v4,
    v5,
...
void __fastcall EventInfoSkillGetDialog__OnClickCloseButton(EventInfoSkillGetDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFEE2B & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_EventInfoSkillGetDialog_OnClickCloseButton__, v3);
    sub_1C2E12C(&Method_EventInfoSkillGetDialog__OnClickCloseButton_b__13_0__, v4);
    byte_4BFEE2B = 1;
  }
  if ( !this->fields.isClose )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoSkillGetDialog_OnClickCloseButton__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1C2E144(Method_EventInfoSkillGetDialog_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFEE2A & 1) == 0 )
  {
    sub_1C2E12C(&AtlasManager_TypeInfo, imagePartsGroupEntity);
    ...
    sub_1C2E12C(&EventInfoSkillGetDialog_TypeInfo, v10);
    ...
    sub_1C2E12C(&StringLiteral_5746/*"EVENT_INFO_SKILL_GET_DIALOG_MESSAGE_SKILL_TITLE"*/, v14);
    byte_4BFEE2A = 1;
  }
  entity = 0LL;
  BaseDialog__Init((BaseDialog_o *)this, 0LL);
  this->fields.closeCallback = 0LL;
  sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.closeCallback, 0LL, v15, v16, v17, v18, v19, v20);
      ...
      if ( SkillLv )
      {
        ...
        if ( SkillLv )
        {
          ...
          if ( messageLabel )
          {
            ...
            SkillLv = (QuestMaster_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5746/*"EVENT_INFO_SKILL_GET_DIALOG_MESSAGE_SKILL_TITLE"*/, 0LL);
              ...
              if ( skillName )
              {
                ...
                if ( entity )
                {
                  ...
                  if ( skillExplanationLabel )
                  {
                    ...
                    SkillLv = (QuestMaster_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3799/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
                    if ( closeLabel )
                    {
        ...
        const MethodInfo *method)
{
  ...
  sub_1C2E0D0(p_closeCallback, 0LL, v4, v5, v6, v7, v8, v9);
  this->fields.isClose = 0;
}
