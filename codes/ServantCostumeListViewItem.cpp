        ...
        const MethodInfo *method)
{
  ...
  __int64 v54; // x9
  ServantCostumeItemInfo_o *v55; // x0
  int64_t v56; // x22
  struct ServantEntity_o *servantEntity; // x8
  struct IconLabelInfo_o **p_iconLabelInfo2; // [xsp+8h] [xbp-F8h]
  CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_o v59; // [xsp+10h] [xbp-F0h] BYREF
  CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_o v60; // [xsp+30h] [xbp-D0h] BYREF
  CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_o v61; // [xsp+50h] [xbp-B0h] BYREF
  CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_o v62; // [xsp+70h] [xbp-90h]
  UserServantCollectionEntity_o *entity; // [xsp+98h] [xbp-68h] BYREF

  if ( (byte_4B205F7 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_ServantClassMaster___, info);
    ...
    sub_1BCAFF8(&IconLabelInfo_TypeInfo, v13);
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.iconLabelInfo1, (int32_t)v17, v18, v19);
  v20 = (IconLabelInfo_o *)sub_1BCB244(IconLabelInfo_TypeInfo);
  IconLabelInfo___ctor(v20, 0LL);
  this->fields.iconLabelInfo2 = v20;
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.iconLabelInfo2, (int32_t)v20, v21, v22);
  ListViewItem___ctor((ListViewItem_o *)this, 0LL);
  this->fields.servantData = info;
  p_servantData = &this->fields.servantData;
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.servantData, (int32_t)info, v24, v25);
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.servantEntity, (int32_t)v29, v30, v31);
  ...
  if ( baseSvtEntity )
  {
    ...
    if ( userServantEntity )
    {
      ...
      *(_OWORD *)&v62.fields.fakeValue = v34;
      ...
      v61 = v62;
      v35 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_48128700(&v61, 0LL);
      v36 = *(_OWORD *)&baseSvtEntity->fields.id.fields.fakeValue;
      v37 = v35;
      *(_OWORD *)&v60.fields.currentCryptoKey = *(_OWORD *)&baseSvtEntity->fields.id.fields.currentCryptoKey;
...
LABEL_79:
        ...
        while ( 1 )
        {
          ...
          if ( v46 >= v48 )
            goto LABEL_79;
          v49 = *(_QWORD *)(v47 + 8LL * (int)v46 + 32);
          if ( v49 )
          {
            if ( *p_servantData )
            {
              v50 = (*p_servantData)->fields.userServantEntity;
              if ( v50 )
              {
                v51 = *(_OWORD *)&v50->fields.id.fields.fakeValue;
                v52 = *(_QWORD *)(v49 + 24);
                *(_OWORD *)&v62.fields.currentCryptoKey = *(_OWORD *)&v50->fields.id.fields.currentCryptoKey;
                *(_OWORD *)&v62.fields.fakeValue = v51;
                if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo->_2.cctor_finished )
                  j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
                v59 = v62;
                Instance = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_48128700(&v59, 0LL);
                if ( v52 == Instance )
  ...
  else
  {
    ...
    v55 = *p_servantData;
    v56 = *(_QWORD *)(v54 + 64);
    Instance = ServantCostumeItemInfo__get_SvtId(v55, v27);
    if ( !Master_object )
      goto LABEL_78;
        ...
        const MethodInfo *method)
{
  ...
  if ( !servantData
    || (*((_QWORD *)servantData + 2) = userSvtEntity,
        sub_1BCAF9C((CGThumbnailListItem_o *)(servantData + 16), (int32_t)userSvtEntity, (int32_t)method, v3),
        !userSvtEntity)
    || (this->fields.isLock = UserServantEntity__IsLock(userSvtEntity, 0LL),
        this->fields.isChoice = UserServantEntity__IsChoice(userSvtEntity, 0LL),
        (servantData = (char *)UserServantEntity__GetOverwriteStatus(userSvtEntity, 0LL, 0LL)) == 0LL) )
  {
    sub_1BCB254(servantData, userSvtEntity);
  }
    ...
    if ( sortKind > 3 )
    {
      switch ( sortKind )
      {
        case 19:
          ...
          if ( !iconLabelInfo2 )
            goto LABEL_58;
          IconLabelInfo__Set_40103972(iconLabelInfo2, 50, allCostumeNum, 0, 0, 0, 0, 0, 0, 0LL);
          goto LABEL_56;
        case 20:
        ...
        case 22:
          ...
          v25 = 53;
LABEL_46:
          IconLabelInfo__Set_40103972(iconLabelInfo2, v25, releaseCostumeNum, v24, 0, 0, 0, 0, 0, 0LL);
          goto LABEL_56;
        case 23:
          ...
          if ( !iconLabelInfo1 )
            goto LABEL_58;
          IconLabelInfo__Set_40103972(iconLabelInfo1, 54, v31, (int32_t)iconLabelInfo2, 0, 0, 0, 0, 0, 0LL);
          goto LABEL_56;
        default:
          if ( sortKind != 8 )
            goto LABEL_56;
...
LABEL_30:
      ...
      if ( !v18 )
        goto LABEL_58;
      IconLabelInfo__Set_40103972(v18, 2, v21, (int32_t)iconLabelInfo2, 0, 0, 0, 0, 0, 0LL);
    }
    else if ( sortKind == 3 )
    {
      iconLabelInfo2 = (IconLabelInfo_o *)this->fields.servantData;
      ...
      if ( v34 )
      {
        IconLabelInfo__Set_40103972(v34, 2, v33, (int32_t)iconLabelInfo2, 0, 0, 0, 0, 0, 0LL);
        goto LABEL_56;
      }
LABEL_58:
        ...
        const MethodInfo *method)
{
  ...
  servantData = this->fields.servantData;
  if ( !servantData )
    sub_1BCB254(0LL, userSvtEntity);
  servantData->fields.userServantEntity = userSvtEntity;
  sub_1BCAF9C((CGThumbnailListItem_o *)&servantData->fields, (int32_t)userSvtEntity, (int32_t)method, v3);
}
