void __fastcall ShopDetailMaster___ctor(ShopDetailMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A7071C & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_ShopDetailMaster__ShopDetailEntity__int___ctor__, method);
    byte_4A7071C = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    178,
    (const MethodInfo_312C568 *)Method_DataMasterBase_ShopDetailMaster__ShopDetailEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A7071D & 1) == 0 )
  {
    ...
    sub_1B90010(&ShopDetailEntity_TypeInfo, v6);
    byte_4A7071D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A7071E & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_System_Collections_Generic_List_ShopDetailEntity__Add__, v4);
    sub_1B90010(&Method_System_Collections_Generic_List_ShopDetailEntity__ToArray__, v5);
    sub_1B90010(&Method_System_Collections_Generic_List_ShopDetailEntity___ctor__, v6);
    sub_1B90010(&System_Collections_Generic_List_ShopDetailEntity__TypeInfo, v7);
    sub_1B90010(&ShopDetailEntity_TypeInfo, v8);
    byte_4A7071E = 1;
  }
  v9 = (System_Collections_Generic_List_object__o *)sub_1B9025C(System_Collections_Generic_List_ShopDetailEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v9,
    (const MethodInfo_351018C *)Method_System_Collections_Generic_List_ShopDetailEntity___ctor__);
  ...
  if ( (int)list >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      else
      {
        ...
        sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v20 + 4), (int32_t)v10, v14, v15);
      }
      if ( v12 == ++v13 )
        return (ShopDetailEntity_array *)System_Collections_Generic_List_object___ToArray(
                                           v9,
                                           (const MethodInfo_3512518 *)Method_System_Collections_Generic_List_ShopDetailEntity__ToArray__);
    }
LABEL_23:
