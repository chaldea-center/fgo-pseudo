void __fastcall ShopDetailMaster___ctor(ShopDetailMaster_o *this, const MethodInfo *method)
{
  if ( (byte_40FF83D & 1) == 0 )
  {
    sub_B16FFC(&Method_DataMasterBase_ShopDetailMaster__ShopDetailEntity__int___ctor__, method);
    byte_40FF83D = 1;
  }
  DataMasterBase_WarMaster__WarEntity__int____ctor(
    (DataMasterBase_WarMaster__WarEntity__int__o *)this,
    176,
    (const MethodInfo_266F2EC *)Method_DataMasterBase_ShopDetailMaster__ShopDetailEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FF83E & 1) == 0 )
  {
    ...
    sub_B16FFC(&ShopDetailEntity_TypeInfo, v6);
    byte_40FF83E = 1;
  }
  ...
  if ( Count >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !result )
        break;
      v13 = *(&ShopDetailEntity_TypeInfo->_2.bitflags2 + 1);
      if ( *(&result->klass->_2.bitflags2 + 1) < (unsigned int)v13
        || (ShopDetailEntity_c *)result->klass->_2.typeHierarchy[v13 - 1] != ShopDetailEntity_TypeInfo )
      {
        break;
      }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FF83F & 1) == 0 )
  {
    ...
    sub_B16FFC(&Method_System_Collections_Generic_List_ShopDetailEntity__Add__, v7);
    sub_B16FFC(&Method_System_Collections_Generic_List_ShopDetailEntity__ToArray__, v8);
    sub_B16FFC(&Method_System_Collections_Generic_List_ShopDetailEntity___ctor__, v9);
    sub_B16FFC(&System_Collections_Generic_List_ShopDetailEntity__TypeInfo, v10);
    sub_B16FFC(&ShopDetailEntity_TypeInfo, v11);
    byte_40FF83F = 1;
  }
  ...
  System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData____ctor(
    v12,
    (const MethodInfo_2F25014 *)Method_System_Collections_Generic_List_ShopDetailEntity___ctor__);
  list = (System_Collections_ObjectModel_Collection_UnicastIPAddressInformation__o *)this->fields.list;
  if ( !list )
    goto LABEL_19;
  Count = System_Collections_ObjectModel_Collection_UnicastIPAddressInformation___get_Count(
  ...
  if ( Count >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      Item = System_Collections_ObjectModel_Collection_UnicastIPAddressInformation___get_Item(
               ...
               (const MethodInfo_290DF28 *)Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Item__);
      if ( Item
        && (v19 = *(&ShopDetailEntity_TypeInfo->_2.bitflags2 + 1), *(&Item->klass->_2.bitflags2 + 1) >= (unsigned int)v19) )
      {
        if ( (ShopDetailEntity_c *)Item->klass->_2.typeHierarchy[v19 - 1] == ShopDetailEntity_TypeInfo )
      ...
      System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData___Add(
        v12,
        v20,
        (const MethodInfo_2F25CD8 *)Method_System_Collections_Generic_List_ShopDetailEntity__Add__);
      if ( ++v16 >= v15 )
        return (ShopDetailEntity_array *)System_Collections_Generic_List_WarBoardUiData_SaveData___ToArray(
                                           ...
                                           (const MethodInfo_2F27E24 *)Method_System_Collections_Generic_List_ShopDetailEntity__ToArray__);
    }
LABEL_19:
    sub_B170D4();
  }
