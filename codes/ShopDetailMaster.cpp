void __fastcall ShopDetailMaster___ctor(ShopDetailMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4391043 & 1) == 0 )
  {
    sub_B775C4(&Method_DataMasterBase_ShopDetailMaster__ShopDetailEntity__int___ctor__);
    byte_4391043 = 1;
  }
  DataMasterBase_WarMaster__WarEntity__int____ctor(
    (DataMasterBase_WarMaster__WarEntity__int__o *)this,
    177,
    (const MethodInfo_21FB7F8 *)Method_DataMasterBase_ShopDetailMaster__ShopDetailEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4391044 & 1) == 0 )
  {
    ...
    sub_B775C4(&ShopDetailEntity_TypeInfo);
    byte_4391044 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4391045 & 1) == 0 )
  {
    sub_B775C4(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__);
    sub_B775C4(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Item__);
    sub_B775C4(&Method_System_Collections_Generic_List_ShopDetailEntity__Add__);
    sub_B775C4(&Method_System_Collections_Generic_List_ShopDetailEntity__ToArray__);
    sub_B775C4(&Method_System_Collections_Generic_List_ShopDetailEntity___ctor__);
    sub_B775C4(&System_Collections_Generic_List_ShopDetailEntity__TypeInfo);
    sub_B775C4(&ShopDetailEntity_TypeInfo);
    byte_4391045 = 1;
  }
  v3 = (System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData__o *)sub_B77694(System_Collections_Generic_List_ShopDetailEntity__TypeInfo);
  System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData____ctor(
    v3,
    (const MethodInfo_30525D4 *)Method_System_Collections_Generic_List_ShopDetailEntity___ctor__);
  ...
  if ( (int)list >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData___Add(
        v3,
        v4,
        (const MethodInfo_3053298 *)Method_System_Collections_Generic_List_ShopDetailEntity__Add__);
      if ( ++v7 >= v6 )
        return (ShopDetailEntity_array *)System_Collections_Generic_List_WarBoardUiData_SaveData___ToArray(
                                           ...
                                           (const MethodInfo_30553E4 *)Method_System_Collections_Generic_List_ShopDetailEntity__ToArray__);
    }
LABEL_19:
    sub_B7769C(list, v4);
  }
