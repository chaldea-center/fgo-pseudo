        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31764 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_CombineHelpMenu_endClose__, v6);
    byte_4A31764 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31762 & 1) == 0 )
  {
    sub_1B761C0(&CombineHelpMenu_CallbackFunc_TypeInfo, value);
    byte_4A31762 = 1;
  }
...
System_String_o *__fastcall CombineHelpMenu__get_closeBtnPath(CombineHelpMenu_o *this, const MethodInfo *method)
{
  if ( (byte_4A31765 & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_4604/*"CombineHelpListPanel/BaseWindow/UpperCloseButton"*/, method);
    byte_4A31765 = 1;
  }
  return (System_String_o *)StringLiteral_4604/*"CombineHelpListPanel/BaseWindow/UpperCloseButton"*/;
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19C1AC0;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19C1A80;
}
