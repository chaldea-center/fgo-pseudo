        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4214469 & 1) == 0 )
  {
    ...
    sub_B0D8A4(&Method_CombineHelpMenu_endClose__, v10);
    byte_4214469 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4214467 & 1) == 0 )
  {
    sub_B0D8A4(&CombineHelpMenu_CallbackFunc_TypeInfo, value);
    byte_4214467 = 1;
  }
  ...
  v11 = (CombineHelpMenu_o *)sub_B0DC70(v8);
...
System_String_o *__fastcall CombineHelpMenu__get_closeBtnPath(CombineHelpMenu_o *this, const MethodInfo *method)
{
  if ( (byte_421446A & 1) == 0 )
  {
    sub_B0D8A4(&StringLiteral_4170/*"CombineHelpListPanel/BaseWindow/UpperCloseButton"*/, method);
    byte_421446A = 1;
  }
  return (System_String_o *)StringLiteral_4170/*"CombineHelpListPanel/BaseWindow/UpperCloseButton"*/;
}
...
void __fastcall CombineHelpMenu_CallbackFunc__Invoke(CombineHelpMenu_CallbackFunc_o *this, const MethodInfo *method)
{
  ...
  _DWORD *v28; // x11
  CombineHelpMenu_CallbackFunc_o *v29; // [xsp+8h] [xbp-38h] BYREF
