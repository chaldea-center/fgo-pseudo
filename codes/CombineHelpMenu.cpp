        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4881C & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_CombineHelpMenu_endClose__, v6);
    byte_4B4881C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4881A & 1) == 0 )
  {
    sub_1BDB878(&CombineHelpMenu_CallbackFunc_TypeInfo, value);
    byte_4B4881A = 1;
  }
...
System_String_o *__fastcall CombineHelpMenu__get_closeBtnPath(CombineHelpMenu_o *this, const MethodInfo *method)
{
  if ( (byte_4B4881D & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_4612/*"CombineHelpListPanel/BaseWindow/UpperCloseButton"*/, method);
    byte_4B4881D = 1;
  }
  return (System_String_o *)StringLiteral_4612/*"CombineHelpListPanel/BaseWindow/UpperCloseButton"*/;
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A29860;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A29820;
}
