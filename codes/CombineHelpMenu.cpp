        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B2BFB & 1) == 0 )
  {
    ...
    sub_B52984(&Method_CombineHelpMenu_endClose__);
    byte_42B2BFB = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B2BF9 & 1) == 0 )
  {
    sub_B52984(&CombineHelpMenu_CallbackFunc_TypeInfo);
    byte_42B2BF9 = 1;
  }
...
System_String_o *__fastcall CombineHelpMenu__get_closeBtnPath(CombineHelpMenu_o *this, const MethodInfo *method)
{
  if ( (byte_42B2BFC & 1) == 0 )
  {
    sub_B52984(&StringLiteral_4193/*"CombineHelpListPanel/BaseWindow/UpperCloseButton"*/);
    byte_42B2BFC = 1;
  }
  return (System_String_o *)StringLiteral_4193/*"CombineHelpListPanel/BaseWindow/UpperCloseButton"*/;
}
...
void __fastcall CombineHelpMenu_CallbackFunc__Invoke(CombineHelpMenu_CallbackFunc_o *this, const MethodInfo *method)
{
  ...
  __int64 v4; // x8
  __int64 v6; // x23
  CombineHelpMenu_CallbackFunc_o **v7; // x24
  __int64 v8; // x25
  unsigned int v9; // w22
  __int64 class_0; // x0
  __int64 v11; // x3
  ...
  CombineHelpMenu_CallbackFunc_o *v19; // x8
  __int64 *v20; // x20
  __int64 v21; // x21
  ...
  _DWORD *v30; // x11
  CombineHelpMenu_CallbackFunc_o *v31; // [xsp+8h] [xbp-38h] BYREF
  ...
  if ( v6 )
  {
    v7 = (CombineHelpMenu_CallbackFunc_o **)(v4 + 32);
LABEL_5:
    v8 = 0LL;
    while ( 1 )
    {
