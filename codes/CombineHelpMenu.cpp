        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CBA343 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_CombineHelpMenu_endClose__);
    byte_4CBA343 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CBA341 & 1) == 0 )
  {
    sub_1C6BA08(&CombineHelpMenu_CallbackFunc_TypeInfo);
    byte_4CBA341 = 1;
  }
...
System_String_o *CombineHelpMenu__get_closeBtnPath(CombineHelpMenu_o *this, const MethodInfo *method)
{
  if ( (byte_4CBA344 & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_4564/*"CombineHelpListPanel/BaseWindow/UpperCloseButton"*/);
    byte_4CBA344 = 1;
  }
  return (System_String_o *)StringLiteral_4564/*"CombineHelpListPanel/BaseWindow/UpperCloseButton"*/;
}
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1AA6834;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1AA67F4;
}
