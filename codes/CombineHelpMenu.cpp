        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D34AEB & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_CombineHelpMenu_endClose__);
    byte_4D34AEB = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D34AE9 & 1) == 0 )
  {
    sub_1C93AD4(&CombineHelpMenu_CallbackFunc_TypeInfo);
    byte_4D34AE9 = 1;
  }
...
System_String_o *CombineHelpMenu__get_closeBtnPath(CombineHelpMenu_o *this, const MethodInfo *method)
{
  if ( (byte_4D34AEC & 1) == 0 )
  {
    sub_1C93AD4(&StringLiteral_4594/*"CombineHelpListPanel/BaseWindow/UpperCloseButton"*/);
    byte_4D34AEC = 1;
  }
  return (System_String_o *)StringLiteral_4594/*"CombineHelpListPanel/BaseWindow/UpperCloseButton"*/;
}
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1ACD8E8;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1ACD8A8;
}
