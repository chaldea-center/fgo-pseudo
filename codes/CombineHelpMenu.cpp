        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB80B1 & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_CombineHelpMenu_endClose__, v10);
    byte_4BB80B1 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB80AF & 1) == 0 )
  {
    sub_1C13D24(&CombineHelpMenu_CallbackFunc_TypeInfo, value);
    byte_4BB80AF = 1;
  }
...
System_String_o *__fastcall CombineHelpMenu__get_closeBtnPath(CombineHelpMenu_o *this, const MethodInfo *method)
{
  if ( (byte_4BB80B2 & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_4686/*"Combine/ServantSkillCombine"*/, method);
    byte_4BB80B2 = 1;
  }
  return (System_String_o *)StringLiteral_4686/*"Combine/ServantSkillCombine"*/;
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A599C4;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A59984;
}
