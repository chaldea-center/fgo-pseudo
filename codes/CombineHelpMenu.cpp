        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_43519ED & 1) == 0 )
  {
    ...
    sub_B70694(&Method_CombineHelpMenu_endClose__);
    byte_43519ED = 1;
  }
  ...
  System_Action___ctor(v10, (Il2CppObject *)this, Method_CombineHelpMenu_endClose__, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_43519EB & 1) == 0 )
  {
    sub_B70694(&CombineHelpMenu_CallbackFunc_TypeInfo);
    byte_43519EB = 1;
  }
  ...
  v11 = (CombineHelpMenu_o *)sub_B70A60(v8);
...
System_String_o *__fastcall CombineHelpMenu__get_closeBtnPath(CombineHelpMenu_o *this, const MethodInfo *method)
{
  if ( (byte_43519EE & 1) == 0 )
  {
    sub_B70694(&StringLiteral_4235/*"CombineHelpListPanel/BaseWindow/UpperCloseButton"*/);
    byte_43519EE = 1;
  }
  return (System_String_o *)StringLiteral_4235/*"CombineHelpListPanel/BaseWindow/UpperCloseButton"*/;
}
...
void __fastcall CombineHelpMenu_CallbackFunc__Invoke(CombineHelpMenu_CallbackFunc_o *this, const MethodInfo *method)
{
  __int64 v2; // x8
  __int64 v4; // x23
  CombineHelpMenu_CallbackFunc_o **v5; // x24
  __int64 v6; // x25
  unsigned int v7; // w22
  __int64 class_0; // x0
  __int64 v9; // x8
  ...
  CombineHelpMenu_CallbackFunc_o *v16; // x8
  __int64 *v17; // x20
  __int64 v18; // x21
  ...
  _DWORD *v26; // x11
  CombineHelpMenu_CallbackFunc_o *v27; // [xsp+8h] [xbp-38h] BYREF
  ...
  if ( v4 )
  {
    v5 = (CombineHelpMenu_CallbackFunc_o **)(v2 + 32);
LABEL_5:
    v6 = 0LL;
    while ( 1 )
    {
