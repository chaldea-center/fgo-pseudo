        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D30977 & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_CombineHelpMenu_endClose__);
    byte_4D30977 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D30975 & 1) == 0 )
  {
    sub_1C94098(&CombineHelpMenu_CallbackFunc_TypeInfo);
    byte_4D30975 = 1;
  }
...
System_String_o *CombineHelpMenu__get_closeBtnPath(CombineHelpMenu_o *this, const MethodInfo *method)
{
  if ( (byte_4D30978 & 1) == 0 )
  {
    sub_1C94098(&StringLiteral_4577/*"CombineHelpListPanel/BaseWindow/UpperCloseButton"*/);
    byte_4D30978 = 1;
  }
  return (System_String_o *)StringLiteral_4577/*"CombineHelpListPanel/BaseWindow/UpperCloseButton"*/;
}
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1ACD5F4;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1ACD5B4;
}
