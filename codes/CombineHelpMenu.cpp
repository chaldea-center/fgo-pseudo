        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B20336 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_CombineHelpMenu_endClose__, v6);
    byte_4B20336 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B20334 & 1) == 0 )
  {
    sub_1BCAFF8(&CombineHelpMenu_CallbackFunc_TypeInfo, value);
    byte_4B20334 = 1;
  }
...
System_String_o *__fastcall CombineHelpMenu__get_closeBtnPath(CombineHelpMenu_o *this, const MethodInfo *method)
{
  if ( (byte_4B20337 & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_4536/*"CombineHelpListPanel/BaseWindow/UpperCloseButton"*/, method);
    byte_4B20337 = 1;
  }
  return (System_String_o *)StringLiteral_4536/*"CombineHelpListPanel/BaseWindow/UpperCloseButton"*/;
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A19BFC;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A19BBC;
}
