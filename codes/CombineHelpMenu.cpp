        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A58F & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_CombineHelpMenu_endClose__, v10);
    byte_4B6A58F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A58D & 1) == 0 )
  {
    sub_1BE4ACC(&CombineHelpMenu_CallbackFunc_TypeInfo, value);
    byte_4B6A58D = 1;
  }
...
System_String_o *__fastcall CombineHelpMenu__get_closeBtnPath(CombineHelpMenu_o *this, const MethodInfo *method)
{
  if ( (byte_4B6A590 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_4683/*"CombineHelpListPanel/BaseWindow/UpperCloseButton"*/, method);
    byte_4B6A590 = 1;
  }
  return (System_String_o *)StringLiteral_4683/*"CombineHelpListPanel/BaseWindow/UpperCloseButton"*/;
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A2B168;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A2B128;
}
