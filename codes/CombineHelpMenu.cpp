        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CCB49B & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_CombineHelpMenu_endClose__);
    byte_4CCB49B = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CCB499 & 1) == 0 )
  {
    sub_1C713B0(&CombineHelpMenu_CallbackFunc_TypeInfo);
    byte_4CCB499 = 1;
  }
...
System_String_o *CombineHelpMenu__get_closeBtnPath(CombineHelpMenu_o *this, const MethodInfo *method)
{
  if ( (byte_4CCB49C & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_4567/*"CombineHelpListPanel/BaseWindow/UpperCloseButton"*/);
    byte_4CCB49C = 1;
  }
  return (System_String_o *)StringLiteral_4567/*"CombineHelpListPanel/BaseWindow/UpperCloseButton"*/;
}
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1AABD3C;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1AABCFC;
}
