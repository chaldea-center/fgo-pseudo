...
int32_t EventRaidEntity__GetUiCommonReleaseId(EventRaidEntity_o *this, const MethodInfo *method)
{
  if ( (byte_597093C & 1) == 0 )
  {
    sub_2213A60(&StringLiteral_25594/*"uiCommonReleaseId"*/);
    byte_597093C = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_25594/*"uiCommonReleaseId"*/, 0, 0);
}
...
bool EventRaidEntity__IsGroupDeadQuestClear(EventRaidEntity_o *this, const MethodInfo *method)
{
  ...
  return CondType__IsQuestClear_47284152(v8, -1, 0, 0);
}
