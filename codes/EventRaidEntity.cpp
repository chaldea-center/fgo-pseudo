void __fastcall EventRaidEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48E28DA & 1) == 0 )
  {
    sub_1B00CCC(&EventRaidEntity_TypeInfo, v1);
    byte_48E28DA = 1;
  }
...
System_String_o *__fastcall EventRaidEntity__CreatePK(int32_t eventId, int32_t day, const MethodInfo *method)
{
  if ( (byte_48E28D2 & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&day);
    byte_48E28D2 = 1;
  }
...
System_String_o *__fastcall EventRaidEntity__CreatePrimaryKey(EventRaidEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E28D1 & 1) == 0 )
  {
    sub_1B00CCC(&EventRaidEntity_TypeInfo, method);
    byte_48E28D1 = 1;
  }
...
bool __fastcall EventRaidEntity__IsGroupDeadQuestClear(EventRaidEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E28D7 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_DataManager_GetMasterData_EventRaidMaster___, v3);
  ...
  return CondType__IsQuestClear_36399468(v9, -1, 0, 0LL);
}
...
bool __fastcall EventRaidEntity__IsOpenTime(EventRaidEntity_o *this, int64_t time, const MethodInfo *method)
{
  ...
  if ( (byte_48E28D8 & 1) == 0 )
  {
    sub_1B00CCC(&NetworkManager_TypeInfo, time);
    byte_48E28D8 = 1;
  }
  if ( !v3 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E28D3 & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataManager_GetMasterData_TotalEventRaidMaster___, method);
    sub_1B00CCC(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v3);
    byte_48E28D3 = 1;
  }
  entity = 0LL;
