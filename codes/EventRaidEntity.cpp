void __fastcall EventRaidEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BB479F & 1) == 0 )
  {
    sub_1C13D24(&EventRaidEntity_TypeInfo, v1);
    byte_4BB479F = 1;
  }
...
System_String_o *__fastcall EventRaidEntity__CreatePK(int32_t eventId, int32_t day, const MethodInfo *method)
{
  if ( (byte_4BB479D & 1) == 0 )
  {
    sub_1C13D24(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&day);
    byte_4BB479D = 1;
  }
...
System_String_o *__fastcall EventRaidEntity__CreatePrimaryKey(EventRaidEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB479C & 1) == 0 )
  {
    sub_1C13D24(&EventRaidEntity_TypeInfo, method);
    byte_4BB479C = 1;
  }
...
bool __fastcall EventRaidEntity__IsGroupDeadQuestClear(EventRaidEntity_o *this, const MethodInfo *method)
{
  ...
  return CondType__IsQuestClear_38735352(v9, -1, 0, 0LL);
}
...
bool __fastcall EventRaidEntity__IsJumbleSingleRaid(EventRaidEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB4799 & 1) == 0 )
  {
    sub_1C13D24(&Method_DataManager_GetMasterData_EventRaidMaster___, method);
...
bool __fastcall EventRaidEntity__IsOpenTime(EventRaidEntity_o *this, int64_t time, const MethodInfo *method)
{
  ...
  if ( (byte_4BB479B & 1) == 0 )
  {
    sub_1C13D24(&NetworkManager_TypeInfo, time);
    byte_4BB479B = 1;
  }
  if ( !v3 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB4796 & 1) == 0 )
  {
    sub_1C13D24(&Method_DataManager_GetMasterData_TotalEventRaidMaster___, method);
    sub_1C13D24(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v3);
    byte_4BB4796 = 1;
  }
  entity = 0LL;
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_2F8F46C *)Method_DataManager_GetMasterData_TotalEventRaidMaster___)) == 0LL )
  {
    sub_1C13F80(Instance, v5);
  }
