...
int32_t EventRaidEntity__GetUiCommonReleaseId(EventRaidEntity_o *this, const MethodInfo *method)
{
  if ( (byte_5938872 & 1) == 0 )
  {
    sub_21FFC50(&StringLiteral_25546/*"uiCommonReleaseId"*/);
    byte_5938872 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_25546/*"uiCommonReleaseId"*/, 0, 0);
}
...
bool EventRaidEntity__IsGroupDeadQuestClear(EventRaidEntity_o *this, const MethodInfo *method)
{
  ...
  return CondType__IsQuestClear_47254560(v8, -1, 0, 0);
}
...
bool EventRaidEntity__IsJustDefeated(EventRaidEntity_o *this, const MethodInfo *method)
{
  ...
  if ( TotalEventRaidEntity )
  {
    ...
    if ( Time > v8 )
    {
      ...
      LOBYTE(TotalEventRaidEntity) = v9 < v8 + *(int *)(TotalEventRaidEntity[23] + 292LL);
    }
    else
    {
LABEL_11:
