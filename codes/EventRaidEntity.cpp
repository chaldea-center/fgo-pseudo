void __fastcall EventRaidEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49BAF35 & 1) == 0 )
  {
    sub_1B4CF90(&EventRaidEntity_TypeInfo, v1);
    byte_49BAF35 = 1;
  }
...
System_String_o *__fastcall EventRaidEntity__CreatePK(int32_t eventId, int32_t day, const MethodInfo *method)
{
  if ( (byte_49BAF33 & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&day);
    byte_49BAF33 = 1;
  }
...
System_String_o *__fastcall EventRaidEntity__CreatePrimaryKey(EventRaidEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BAF32 & 1) == 0 )
  {
    sub_1B4CF90(&EventRaidEntity_TypeInfo, method);
    byte_49BAF32 = 1;
  }
...
bool __fastcall EventRaidEntity__IsGroupDeadQuestClear(EventRaidEntity_o *this, const MethodInfo *method)
{
  ...
  return CondType__IsQuestClear_38126524(v9, -1, 0, 0LL);
}
...
bool __fastcall EventRaidEntity__IsOpenTime(EventRaidEntity_o *this, int64_t time, const MethodInfo *method)
{
  ...
  if ( (byte_49BAF31 & 1) == 0 )
  {
    sub_1B4CF90(&NetworkManager_TypeInfo, time);
    byte_49BAF31 = 1;
  }
  if ( !v3 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BAF2C & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataManager_GetMasterData_TotalEventRaidMaster___, method);
    sub_1B4CF90(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v3);
    byte_49BAF2C = 1;
  }
  entity = 0LL;
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_2F01B24 *)Method_DataManager_GetMasterData_TotalEventRaidMaster___)) == 0LL )
  {
    sub_1B4D1EC(Instance, v5);
  }
