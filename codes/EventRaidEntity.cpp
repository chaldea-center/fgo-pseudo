void __fastcall EventRaidEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB5E1E & 1) == 0 )
  {
    sub_1BAB41C(&EventRaidEntity_TypeInfo, v1);
    byte_4AB5E1E = 1;
  }
...
System_String_o *__fastcall EventRaidEntity__CreatePK(int32_t eventId, int32_t day, const MethodInfo *method)
{
  if ( (byte_4AB5E16 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&day);
    byte_4AB5E16 = 1;
  }
...
System_String_o *__fastcall EventRaidEntity__CreatePrimaryKey(EventRaidEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB5E15 & 1) == 0 )
  {
    sub_1BAB41C(&EventRaidEntity_TypeInfo, method);
    byte_4AB5E15 = 1;
  }
...
bool __fastcall EventRaidEntity__IsGroupDeadQuestClear(EventRaidEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB5E1B & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_DataManager_GetMasterData_EventRaidMaster___, v3);
  ...
  return CondType__IsQuestClear_37980612(v9, -1, 0, 0LL);
}
...
bool __fastcall EventRaidEntity__IsJumbleSingleRaid(EventRaidEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB5E1A & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMasterData_EventRaidMaster___, method);
...
bool __fastcall EventRaidEntity__IsOpenTime(EventRaidEntity_o *this, int64_t time, const MethodInfo *method)
{
  ...
  if ( (byte_4AB5E1C & 1) == 0 )
  {
    sub_1BAB41C(&NetworkManager_TypeInfo, time);
    byte_4AB5E1C = 1;
  }
  if ( !v3 )
  {
...
bool __fastcall EventRaidEntity__IsValidDefeatedTime(EventRaidEntity_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BAB41C(&BalanceConfig_TypeInfo, method);
    sub_1BAB41C(&Method_DataManager_GetMasterData_WarMaster___, v3);
    sub_1BAB41C(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v4);
    byte_4AB5E18 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB5E17 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMasterData_TotalEventRaidMaster___, method);
    sub_1BAB41C(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v3);
    byte_4AB5E17 = 1;
  }
  entity = 0LL;
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_2EC55C8 *)Method_DataManager_GetMasterData_TotalEventRaidMaster___)) == 0LL )
  {
    sub_1BAB678(Instance, v5);
  }
