void __fastcall EventRaidEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FE5D9 & 1) == 0 )
  {
    sub_1B64870(&EventRaidEntity_TypeInfo, v1);
    byte_49FE5D9 = 1;
  }
...
System_String_o *__fastcall EventRaidEntity__CreatePrimaryKey(EventRaidEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FE5D0 & 1) == 0 )
  {
    sub_1B64870(&EventRaidEntity_TypeInfo, method);
    byte_49FE5D0 = 1;
  }
...
bool __fastcall EventRaidEntity__IsGroupDeadQuestClear(EventRaidEntity_o *this, const MethodInfo *method)
{
  ...
  return CondType__IsQuestClear_37290360(v9, -1, 0, 0LL);
}
...
bool __fastcall EventRaidEntity__IsOpenTime(EventRaidEntity_o *this, int64_t time, const MethodInfo *method)
{
  ...
  if ( (byte_49FE5D7 & 1) == 0 )
  {
    sub_1B64870(&NetworkManager_TypeInfo, time);
    byte_49FE5D7 = 1;
  }
  if ( !v3 )
  {
...
bool __fastcall EventRaidEntity__IsValidDefeatedTime(EventRaidEntity_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B64870(&BalanceConfig_TypeInfo, method);
    sub_1B64870(&Method_DataManager_GetMasterData_WarMaster___, v3);
    sub_1B64870(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v4);
    byte_49FE5D3 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_2E3B6C8 *)Method_DataManager_GetMasterData_TotalEventRaidMaster___)) == 0LL )
  {
    sub_1B64ACC(Instance, v5);
  }
