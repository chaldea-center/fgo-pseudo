void __fastcall EventRaidEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B020F1 & 1) == 0 )
  {
    sub_1BC3008(&EventRaidEntity_TypeInfo, v1);
    byte_4B020F1 = 1;
  }
...
System_String_o *__fastcall EventRaidEntity__CreatePrimaryKey(EventRaidEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B020EE & 1) == 0 )
  {
    sub_1BC3008(&EventRaidEntity_TypeInfo, method);
    byte_4B020EE = 1;
  }
...
bool __fastcall EventRaidEntity__HasFlag(EventRaidEntity_o *this, int64_t typeFlag, const MethodInfo *method)
{
...
bool __fastcall EventRaidEntity__IsGroupDeadQuestClear(EventRaidEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B020EC & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_DataManager_GetMasterData_EventRaidMaster___, v3);
  ...
  return CondType__IsQuestClear_39366056(v9, -1, 0, 0LL);
}


bool __fastcall EventRaidEntity__IsHideRaidSideStatus(EventRaidEntity_o *this, const MethodInfo *method)
{
...
bool __fastcall EventRaidEntity__IsJumbleSingleRaid(EventRaidEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B020EB & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMasterData_EventRaidMaster___, method);
...
bool __fastcall EventRaidEntity__IsJustDefeated(EventRaidEntity_o *this, const MethodInfo *method)
{
  ...
  if ( TotalEventRaidEntity )
  {
    ...
    if ( Time > v7 )
    {
      ...
      LOBYTE(TotalEventRaidEntity) = v8 < v7 + *(int *)(TotalEventRaidEntity[23] + 292LL);
    }
    else
    {
LABEL_11:
...
bool __fastcall EventRaidEntity__IsOpenTime(EventRaidEntity_o *this, int64_t time, const MethodInfo *method)
{
  ...
  if ( (byte_4B020ED & 1) == 0 )
  {
    sub_1BC3008(&NetworkManager_TypeInfo, time);
    byte_4B020ED = 1;
  }
  if ( !v3 )
  {
...
bool __fastcall EventRaidEntity__IsValidDefeatedTime(EventRaidEntity_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BC3008(&BalanceConfig_TypeInfo, method);
    sub_1BC3008(&Method_DataManager_GetMasterData_WarMaster___, v3);
    sub_1BC3008(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v4);
    byte_4B020E9 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B020E8 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMasterData_TotalEventRaidMaster___, method);
    sub_1BC3008(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v3);
    byte_4B020E8 = 1;
  }
  entity = 0LL;
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_3001E64 *)Method_DataManager_GetMasterData_TotalEventRaidMaster___)) == 0LL )
  {
    sub_1BC3264(Instance, v5);
  }
