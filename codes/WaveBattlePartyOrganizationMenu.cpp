        ...
        const MethodInfo *method)
{
  ...
  WaveBattlePartyOrganizationMenu__Close_32414080(this, 0LL, v2);
}


void __fastcall WaveBattlePartyOrganizationMenu__Close_32414080(
        WaveBattlePartyOrganizationMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6BFBD & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_WaveBattlePartyOrganizationMenu_EndClose__, v5);
    byte_4A6BFBD = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6BFBF & 1) == 0 )
  {
    sub_1B90010(&BalanceConfig_TypeInfo, deckItemList);
    sub_1B90010(&DeckServantData_TypeInfo, v4);
    ...
    sub_1B90010(&UserEventDeckEntity_TypeInfo, v10);
    byte_4A6BFBF = 1;
  }
  memset(&v65[1], 0, sizeof(CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_o));
  v11 = (UserEventDeckEntity_o *)sub_1B9025C(UserEventDeckEntity_TypeInfo);
...
LABEL_55:
  ...
  v17 = (DeckServant_o *)sub_1B9025C(DeckServant_TypeInfo);
  max_length = deckItemList->max_length;
  v61 = deckItemList;
  v19 = v17;
  DeckServant___ctor_38924516(v17, max_length, v16, userEquipId, 0LL);
  v60 = v11;
  v20 = v11;
  v21 = v61;
  v20->fields.deckInfo = v19;
  p_deckInfo = (ServantStatusBattleListViewItem_o *)&v20->fields.deckInfo;
  sub_1B8FFB4(p_deckInfo, (int32_t)v19, v23, v24);
  v25 = v61->max_length;
  if ( v25 >= 1 )
  {
    v26 = 0;
    ...
    while ( v27 < (unsigned int)v25 )
    {
      ...
      *(_DWORD *)(v30 + 16) = v27 + 1;
      ...
      while ( 1 )
      {
        ...
        v35 = sub_1B9025C(DeckServantData_TypeInfo);
        ...
        *(_DWORD *)(v35 + 16) = v33 + v32 + 1;
        ...
        if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
        v64 = v65[1];
        *(_QWORD *)(v35 + 24) = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_46509900(&v64, 0LL);
        ...
        if ( v38 )
        {
          ...
          *(_QWORD *)&v66.fields.fakeValue = v39;
          v41 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46506376(v66, 0LL);
        }
        else
        {
          v41 = 0;
        ...
        *(_QWORD *)(v35 + 40) = EquipList;
        sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v35 + 40), (int32_t)EquipList, v43, v44);
        v45 = sub_1B900B8(int___TypeInfo, 1LL);
        EquipSvtId = PartyOrganizationListViewItem__get_EquipSvtId(Member, 0LL);
        if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
        UserId = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46506376(EquipSvtId, 0LL);
        if ( !v45 )
          goto LABEL_55;
        if ( !*(_DWORD *)(v45 + 24) )
          goto LABEL_56;
        ...
        *(_QWORD *)(v35 + 48) = v45;
        sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v35 + 48), v45, v47, v48);
        ...
        *(_DWORD *)(v53 + 4 * v32 + 32) = *(_DWORD *)(v35 + 16);
        ...
        if ( !name )
          goto LABEL_55;
        UserId = sub_1B9014C(v35, *(_QWORD *)(*(_QWORD *)name + 64LL));
        if ( !UserId )
        {
          v59 = sub_1B90290();
          sub_1B90138(v59, 0LL);
        ...
        *((_QWORD *)v57 + 4) = v35;
        sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v57 + 32), v35, v55, v56);
        ++v32;
      }
      v21 = v61;
      v27 = v62;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6BFBB & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMaster_QuestHintMaster___, isEvery);
    sub_1B90010(&Method_DataManager_GetMaster_QuestPhaseMaster___, v5);
    this = (WaveBattlePartyOrganizationMenu_o *)sub_1B90010(&DataManager_TypeInfo, v6);
    byte_4A6BFBB = 1;
  }
  v13 = 0LL;
  entity = 0LL;
  *isEvery = 0;
  ...
  this = (WaveBattlePartyOrganizationMenu_o *)DataManager__GetMaster_object_((const MethodInfo_2E8E1C8 *)Method_DataManager_GetMaster_QuestHintMaster___);
  if ( !this )
    goto LABEL_19;
  ...
  if ( ((unsigned __int8)this & 1) == 0 )
  {
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    this = (WaveBattlePartyOrganizationMenu_o *)DataManager__GetMaster_object_((const MethodInfo_2E8E1C8 *)Method_DataManager_GetMaster_QuestPhaseMaster___);
    if ( this )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6BFC1 & 1) == 0 )
  {
    sub_1B90010(&Method_WaveBattlePartyOrganizationMenu_OnClickAutoOrganization__, method);
    byte_4A6BFC1 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_WaveBattlePartyOrganizationMenu_OnClickAutoOrganization__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B90028(Method_WaveBattlePartyOrganizationMenu_OnClickAutoOrganization__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6BFC4 & 1) == 0 )
  {
    sub_1B90010(&Method_WaveBattlePartyOrganizationMenu_OnClickAutoSell__, method);
    byte_4A6BFC4 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_WaveBattlePartyOrganizationMenu_OnClickAutoSell__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B90028(Method_WaveBattlePartyOrganizationMenu_OnClickAutoSell__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B8FFF4(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
    callbackFunc = this->fields.callbackFunc;
    if ( callbackFunc )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6BFC3 & 1) == 0 )
  {
    sub_1B90010(&Method_WaveBattlePartyOrganizationMenu_OnClickClassInfo__, method);
    byte_4A6BFC3 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_WaveBattlePartyOrganizationMenu_OnClickClassInfo__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B90028(Method_WaveBattlePartyOrganizationMenu_OnClickClassInfo__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B8FFF4(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
    callbackFunc = this->fields.callbackFunc;
    if ( callbackFunc )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6BFC8 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_WaveBattlePartyOrganizationMenu_OnClickFriendshipUpItemUseButton__, v3);
    byte_4A6BFC8 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_WaveBattlePartyOrganizationMenu_OnClickFriendshipUpItemUseButton__ + 83) & 2) != 0 )
    v6 = (_QWORD *)sub_1B90028(Method_WaveBattlePartyOrganizationMenu_OnClickFriendshipUpItemUseButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6BFC5 & 1) == 0 )
  {
    sub_1B90010(&Method_WaveBattlePartyOrganizationMenu_OnClickHintDialogButton__, method);
    byte_4A6BFC5 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_WaveBattlePartyOrganizationMenu_OnClickHintDialogButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B90028(Method_WaveBattlePartyOrganizationMenu_OnClickHintDialogButton__);
  v4 = (System_Reflection_MethodBase_o *)sub_1B8FFF4(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6BFC0 & 1) == 0 )
  {
    sub_1B90010(&Method_WaveBattlePartyOrganizationMenu_OnClickMasterFormation__, method);
    byte_4A6BFC0 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_WaveBattlePartyOrganizationMenu_OnClickMasterFormation__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B90028(Method_WaveBattlePartyOrganizationMenu_OnClickMasterFormation__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B8FFF4(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
    callbackFunc = this->fields.callbackFunc;
    if ( callbackFunc )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6BFC2 & 1) == 0 )
  {
    sub_1B90010(&Method_WaveBattlePartyOrganizationMenu_OnClickPartyEdit__, method);
    byte_4A6BFC2 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_WaveBattlePartyOrganizationMenu_OnClickPartyEdit__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B90028(Method_WaveBattlePartyOrganizationMenu_OnClickPartyEdit__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B8FFF4(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
    callbackFunc = this->fields.callbackFunc;
    if ( callbackFunc )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6BFBA & 1) == 0 )
  {
    sub_1B90010(&System_Action_TypeInfo, deckEntity);
    sub_1B90010(&AtlasManager_TypeInfo, v13);
    sub_1B90010(&WaveBattleWaveInfoListManager_CallbackFunc_TypeInfo, v14);
    sub_1B90010(&Method_DataManager_GetMasterData_UserEquipMaster___, v15);
    sub_1B90010(&Method_DataMasterBase_UserEquipMaster__UserEquipEntity__long__TryGetEntity__, v16);
    sub_1B90010(&QuestHintDialogOpenManager_TypeInfo, v17);
    sub_1B90010(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v18);
    sub_1B90010(&Method_WaveBattlePartyOrganizationMenu_EndOpen__, v19);
    sub_1B90010(&Method_WaveBattlePartyOrganizationMenu_OnSelectWavePartyList__, v20);
    sub_1B90010(&StringLiteral_17698/*"buttontxt_formation_21"*/, v21);
    sub_1B90010(&StringLiteral_17693/*"buttontxt_battlerestart"*/, v22);
    sub_1B90010(&StringLiteral_17697/*"buttontxt_formation_20"*/, v23);
    byte_4A6BFBA = 1;
  }
  entity = 0LL;
  isEvery = 0;
  ...
  if ( !this->fields.state )
  {
    ...
    sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.callbackFunc, (int32_t)callback, v25, v26);
    waveInfoListManager = this->fields.waveInfoListManager;
    v28 = (WaveBattleWaveInfoListManager_CallbackFunc_o *)sub_1B9025C(WaveBattleWaveInfoListManager_CallbackFunc_TypeInfo);
          ...
          if ( deckInfo )
          {
            if ( Instance )
            {
              if ( DataMasterBase_object__object__long___TryGetEntity(
                     ...
                     (const MethodInfo_312C7A8 *)Method_DataMasterBase_UserEquipMaster__UserEquipEntity__long__TryGetEntity__) )
              {
                  ...
                  if ( (v36 & 1) != 0 )
                  {
                    ...
                    if ( ((unsigned __int8)Instance & 1) == 0 )
                    {
                      ...
                      if ( ((unsigned __int8)Instance & 1) == 0 )
                      {
                        ...
                        if ( !byte_4A6BC48 )
                        {
                          sub_1B90010(&QuestHintDialogOpenManager_TypeInfo, v31);
                          byte_4A6BC48 = 1;
                        }
                  ...
                  if ( Instance )
                  {
                    ...
                    if ( Instance )
                    {
                      ...
                      AtlasManager__SetPartyOrganizationImage(
                        ...
                        (System_String_o *)StringLiteral_17698/*"buttontxt_formation_21"*/,
                        0LL);
                      ...
                      if ( Instance )
                      {
                        ...
                        AtlasManager__SetPartyOrganizationImage(
                          ...
                          (System_String_o *)StringLiteral_17693/*"buttontxt_battlerestart"*/,
                          0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6BFC6 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_WaveBattlePartyOrganizationMenu_CheckFriendshipUpItemTutorial__, v3);
    byte_4A6BFC6 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6BFBC & 1) == 0 )
  {
    ...
    this = (WaveBattlePartyOrganizationMenu_o *)sub_1B90010(&StringLiteral_1/*""*/, v6);
    byte_4A6BFBC = 1;
  }
  v13 = 0LL;
  entity = 0LL;
  ...
  if ( System_String__IsNullOrEmpty(message, 0LL) )
    return;
  this = (WaveBattlePartyOrganizationMenu_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_374C890 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !this )
LABEL_23:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6BFBE & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMasterData_UserEquipMaster___, deckEntity);
    sub_1B90010(&Method_DataMasterBase_UserEquipMaster__UserEquipEntity__long__TryGetEntity__, v5);
    sub_1B90010(&PartyOrganizationUtility_TypeInfo, v6);
  ...
  *(_QWORD *)genderImageId = 0LL;
  ...
  WaveBattleWaveInfoListManager__UpdateWaveServantInfo(
    ...
    v12);
  Instance = (DataManager_o *)SingletonTemplate_object___get_Instance((const MethodInfo_374D460 *)Method_SingletonTemplate_PartyOrganizationUtility__get_Instance__);
  if ( !Instance )
    goto LABEL_24;
  if ( PartyOrganizationUtility__IsAvailableFriendshipUpItem((PartyOrganizationUtility_o *)Instance, 0LL)
    && !this->fields.isInterruption )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6BFB8 & 1) == 0 )
  {
    sub_1B90010(&WaveBattlePartyOrganizationMenu_CallbackFunc_TypeInfo, value);
    byte_4A6BFB8 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  ...
  v11 = (WaveBattlePartyOrganizationMenu_o *)sub_1B9052C(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19D0B18;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19D0AB8;
}
