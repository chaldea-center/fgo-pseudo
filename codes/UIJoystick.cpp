...
LABEL_27:
    ...
    if ( sqrtf(vaddv_f32(vmul_f32(v19, v19)) + (float)(v18 * v18)) <= this->fields.deadZone )
    {
      ...
      v23 = (unsigned __int8)byte_5969AE0;
...
void UIJoystick__OnDrag(UIJoystick_o *this, UnityEngine_Vector2_o delta, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Behaviour__get_enabled((UnityEngine_Behaviour_o *)this, 0) )
  {
    ...
    if ( NGUITools__GetActive_56411004(gameObject, 0) )
    {
      ...
      UnityEngine_Camera__ScreenPointToRay_83198808(&v35, (UnityEngine_Camera_o *)target, v38, 0);
          ...
          *(_QWORD *)&this->fields.totalOffset.fields.x = *(_QWORD *)&static_fields->zeroVector.fields.x;
          ...
          if ( transform )
          {
            ...
            if ( transform )
            {
              ...
              v33.fields.z = v16;
              v33.fields.w = w;
              v31 = UnityEngine_Quaternion__op_Multiply_83371700(
                      v33,
