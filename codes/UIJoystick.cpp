...
void UIJoystick__OnDrag(UIJoystick_o *this, UnityEngine_Vector2_o delta, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Behaviour__get_enabled((UnityEngine_Behaviour_o *)this, 0) )
  {
    ...
    if ( NGUITools__GetActive_50748588(gameObject, 0) )
    {
      ...
      v32.fields.z = 0.0;
      UnityEngine_Camera__ScreenPointToRay_73163296(&v30, (UnityEngine_Camera_o *)target, v32, 0);
      v31 = v30;
          ...
          *(_QWORD *)&this->fields.totalOffset.fields.x = *(_QWORD *)&static_fields->zeroVector.fields.x;
          ...
          if ( transform )
          {
            ...
            if ( transform )
            {
              ...
              v28.fields.z = v13;
              v28.fields.w = w;
              v26 = UnityEngine_Quaternion__op_Multiply_73298220(
                      v28,
...
void UIJoystick__Start(UIJoystick_o *this, const MethodInfo *method)
{
  ...
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.target, (int32_t)transform, v4, v5, v6, v7, v8, v9);
}
