...
void __fastcall ScriptBranchListViewObject__Awake(ScriptBranchListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A58A0F & 1) == 0 )
  {
    sub_1B885B0(&Method_UnityEngine_GameObject_GetComponent_ScriptBranchListViewItemDraw___);
    byte_4A58A0F = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2ECEEB8 *)Method_UnityEngine_GameObject_GetComponent_ScriptBranchListViewItemDraw___);
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_2ECEEB8 *)Method_UnityEngine_GameObject_GetComponent_ScriptBranchListViewObject___)) == 0LL) )
  {
    sub_1B8880C(DragObject, v4);
  }
  ScriptBranchListViewObject__Init_34924776((ScriptBranchListViewObject_o *)DragObject, 2, 0LL, v6);
  return v5;
}
...
void __fastcall ScriptBranchListViewObject__Init_34924776(
        ScriptBranchListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
LABEL_8:
  ...
  if ( UnityEngine_Object__op_Inequality(itemDraw, 0LL, 0LL) )
  {
    ...
    if ( !v8 )
      sub_1B8880C(0LL, v7);
    ScriptBranchListViewItemDraw__SetItem(v8, (ScriptBranchListViewItem_o *)linkItem, this->fields.dispMode, 0LL);
  }
}
...
void __fastcall ScriptBranchListViewObject__Start(ScriptBranchListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    ScriptBranchListViewObject__Init_34924776(this, 2, 0LL, v2);
}
