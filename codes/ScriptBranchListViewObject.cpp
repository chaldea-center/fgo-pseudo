...
void __fastcall ScriptBranchListViewObject__Awake(ScriptBranchListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_418BE4C & 1) == 0 )
  {
    sub_B2C35C(&Method_UnityEngine_GameObject_GetComponent_ScriptBranchListViewItemDraw___, method);
    byte_418BE4C = 1;
  }
  ...
  Component_srcLineSprite = UnityEngine_GameObject__GetComponent_srcLineSprite_(
                              dispObject,
                              (const MethodInfo_1AA78DC *)Method_UnityEngine_GameObject_GetComponent_ScriptBranchListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  ScriptBranchListViewObject_o *v6; // x20
  const MethodInfo *v7; // x3
  UnityEngine_Vector3_o zero; // 0:s0.4,4:s1.4,8:s2.4 OVERLAPPED

  if ( (byte_418BE4E & 1) == 0 )
  {
    sub_B2C35C(&Method_UnityEngine_GameObject_GetComponent_ScriptBranchListViewObject___, method);
    byte_418BE4E = 1;
  }
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                    DragObject,
                                                    (const MethodInfo_1AA78DC *)Method_UnityEngine_GameObject_GetComponent_ScriptBranchListViewObject___)) == 0LL) )
  {
    sub_B2C434(DragObject, v4);
  }
  v6 = (ScriptBranchListViewObject_o *)DragObject;
  zero = UnityEngine_Vector3__get_zero(0LL);
  ScriptBranchListViewObject__Init(v6, 2, 0LL, zero.fields.x, *(UnityEngine_Vector3_o *)&zero.fields.y, v7);
  return v5;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_418BE4F & 1) == 0 )
  {
    sub_B2C35C(&ScriptBranchListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_418BE4F = 1;
  }
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ScriptBranchListViewObject__Init_33251148(
        ScriptBranchListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall ScriptBranchListViewObject__SetupDisp(ScriptBranchListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_418BE50 & 1) == 0 )
  {
    ...
    sub_B2C35C(&ScriptBranchListViewItem_TypeInfo, v3);
    byte_418BE50 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem )
