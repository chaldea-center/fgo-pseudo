...
void __fastcall ScriptBranchListViewObject__Awake(ScriptBranchListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4218C6F & 1) == 0 )
  {
    sub_B0D8A4(&Method_UnityEngine_GameObject_GetComponent_ScriptBranchListViewItemDraw___, method);
    byte_4218C6F = 1;
  }
  ...
  Component_srcLineSprite = UnityEngine_GameObject__GetComponent_srcLineSprite_(
                              dispObject,
                              (const MethodInfo_1B62BA8 *)Method_UnityEngine_GameObject_GetComponent_ScriptBranchListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  ScriptBranchListViewObject_o *v5; // x20
  const MethodInfo *v6; // x3
  UnityEngine_Vector3_o zero; // 0:s0.4,4:s1.4,8:s2.4 OVERLAPPED

  if ( (byte_4218C71 & 1) == 0 )
  {
    sub_B0D8A4(&Method_UnityEngine_GameObject_GetComponent_ScriptBranchListViewObject___, method);
    byte_4218C71 = 1;
  }
  ...
  if ( !DragObject
    || (v4 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                    DragObject,
                                                    (const MethodInfo_1B62BA8 *)Method_UnityEngine_GameObject_GetComponent_ScriptBranchListViewObject___)) == 0LL) )
  {
    sub_B0D97C(DragObject);
  }
  v5 = (ScriptBranchListViewObject_o *)DragObject;
  zero = UnityEngine_Vector3__get_zero(0LL);
  ScriptBranchListViewObject__Init(v5, 2, 0LL, zero.fields.x, *(UnityEngine_Vector3_o *)&zero.fields.y, v6);
  return v4;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4218C72 & 1) == 0 )
  {
    sub_B0D8A4(&ScriptBranchListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4218C72 = 1;
  }
  ...
  if ( !state || dispMode != this->fields.dispMode )
    ScriptBranchListViewObject__SetupDisp(this, v22);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ScriptBranchListViewObject__Init_32776016(
        ScriptBranchListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall ScriptBranchListViewObject__SetupDisp(ScriptBranchListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4218C73 & 1) == 0 )
  {
    ...
    sub_B0D8A4(&ScriptBranchListViewItem_TypeInfo, v3);
    byte_4218C73 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem )
  {
    v5 = *(&ScriptBranchListViewItem_TypeInfo->_2.bitflags2 + 1);
    if ( *(&linkItem->klass->_2.bitflags2 + 1) >= (unsigned int)v5
      && (ScriptBranchListViewItem_c *)linkItem->klass->_2.typeHierarchy[v5 - 1] == ScriptBranchListViewItem_TypeInfo )
    {
