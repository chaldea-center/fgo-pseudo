...
void __fastcall ScriptBranchListViewObject__Awake(ScriptBranchListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6D713 & 1) == 0 )
  {
    sub_1B90010(&Method_UnityEngine_GameObject_GetComponent_ScriptBranchListViewItemDraw___, method);
    byte_4A6D713 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2EDD768 *)Method_UnityEngine_GameObject_GetComponent_ScriptBranchListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6D715 & 1) == 0 )
  {
    sub_1B90010(&Method_UnityEngine_GameObject_GetComponent_ScriptBranchListViewObject___, method);
    byte_4A6D715 = 1;
  }
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_2EDD768 *)Method_UnityEngine_GameObject_GetComponent_ScriptBranchListViewObject___)) == 0LL) )
  {
    sub_1B9026C(DragObject, v4);
  }
  ScriptBranchListViewObject__Init_34974736((ScriptBranchListViewObject_o *)DragObject, 2, 0LL, v6);
  return v5;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6D716 & 1) == 0 )
  {
    sub_1B90010(&ScriptBranchListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4A6D716 = 1;
  }
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ScriptBranchListViewObject__Init_34974736(
        ScriptBranchListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall ScriptBranchListViewObject__SetupDisp(ScriptBranchListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6D717 & 1) == 0 )
  {
    ...
    sub_1B90010(&ScriptBranchListViewItem_TypeInfo, v3);
    byte_4A6D717 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
...
void __fastcall ScriptBranchListViewObject__Start(ScriptBranchListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    ScriptBranchListViewObject__Init_34974736(this, 2, 0LL, v2);
}
