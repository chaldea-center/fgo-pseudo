...
void __fastcall ScriptBranchListViewObject__Awake(ScriptBranchListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FBDEB & 1) == 0 )
  {
    sub_1B64870(&Method_UnityEngine_GameObject_GetComponent_ScriptBranchListViewItemDraw___, method);
    byte_49FBDEB = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2E8A1B4 *)Method_UnityEngine_GameObject_GetComponent_ScriptBranchListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FBDED & 1) == 0 )
  {
    sub_1B64870(&Method_UnityEngine_GameObject_GetComponent_ScriptBranchListViewObject___, method);
    byte_49FBDED = 1;
  }
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_2E8A1B4 *)Method_UnityEngine_GameObject_GetComponent_ScriptBranchListViewObject___)) == 0LL) )
  {
    sub_1B64ACC(DragObject, v4);
  }
  ScriptBranchListViewObject__Init_34627508((ScriptBranchListViewObject_o *)DragObject, 2, 0LL, v6);
  return v5;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FBDEE & 1) == 0 )
  {
    sub_1B64870(&ScriptBranchListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_49FBDEE = 1;
  }
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ScriptBranchListViewObject__Init_34627508(
        ScriptBranchListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall ScriptBranchListViewObject__SetupDisp(ScriptBranchListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FBDEF & 1) == 0 )
  {
    ...
    sub_1B64870(&ScriptBranchListViewItem_TypeInfo, v3);
    byte_49FBDEF = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
...
void __fastcall ScriptBranchListViewObject__Start(ScriptBranchListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    ScriptBranchListViewObject__Init_34627508(this, 2, 0LL, v2);
}
