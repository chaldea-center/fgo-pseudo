        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E49F1 & 1) == 0 )
  {
    sub_1B00CCC(&Method_System_Collections_Generic_List_ListViewItem__Add__, svtCoins);
    sub_1B00CCC(&ServantCoinConfirmListViewItem_TypeInfo, v5);
    byte_48E49F1 = 1;
  }
  ...
  if ( (int)v8 >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      v14 = (ListViewItem_o *)sub_1B00F18(ServantCoinConfirmListViewItem_TypeInfo);
      ListViewItem___ctor_39415512(v14, v10, 0LL);
      v14[1].klass = v13;
      if ( !itemList )
        break;
      ...
      if ( ++v10 >= svtCoins->max_length )
        sub_1B00F30(scrollView, v7);
    }
LABEL_17:
    sub_1B00F28(scrollView, v7);
  }
LABEL_15:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E49F2 & 1) == 0 )
  {
    this = (ServantCoinConfirmListViewManager_o *)sub_1B00CCC(&ServantCoinConfirmListViewObject_TypeInfo, obj);
    byte_48E49F2 = 1;
  }
  if ( !obj
