        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A309AF & 1) == 0 )
  {
    sub_1B761C0(&Method_System_Collections_Generic_List_ListViewItem__Add__, svtCoins);
    sub_1B761C0(&ServantCoinConfirmListViewItem_TypeInfo, v5);
    byte_4A309AF = 1;
  }
  ...
  if ( (int)v8 >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      v14 = (ListViewItem_o *)sub_1B7640C(ServantCoinConfirmListViewItem_TypeInfo);
      ListViewItem___ctor_40521064(v14, v10, 0LL);
      v14[1].klass = v13;
      if ( !itemList )
        break;
      ...
      if ( ++v10 >= svtCoins->max_length )
        sub_1B76424(scrollView, v7);
    }
LABEL_17:
    sub_1B7641C(scrollView, v7);
  }
LABEL_15:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A309B0 & 1) == 0 )
  {
    this = (ServantCoinConfirmListViewManager_o *)sub_1B761C0(&ServantCoinConfirmListViewObject_TypeInfo, obj);
    byte_4A309B0 = 1;
  }
  if ( !obj
