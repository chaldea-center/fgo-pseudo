        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47486 & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Collections_Generic_List_ListViewItem__Add__, svtCoins);
    sub_1BDB878(&ServantCoinConfirmListViewItem_TypeInfo, v5);
    byte_4B47486 = 1;
  }
  ...
  if ( (int)v8 >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      v14 = (ListViewItem_o *)sub_1BDBAC4(ServantCoinConfirmListViewItem_TypeInfo);
      ListViewItem___ctor_42734232(v14, v10, 0LL);
      v14[1].klass = v13;
      if ( !itemList )
        break;
      ...
      if ( ++v10 >= svtCoins->max_length )
        sub_1BDBADC(scrollView, v7, v21);
    }
LABEL_17:
    sub_1BDBAD4(scrollView, v7);
  }
LABEL_15:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47487 & 1) == 0 )
  {
    this = (ServantCoinConfirmListViewManager_o *)sub_1BDB878(&ServantCoinConfirmListViewObject_TypeInfo, obj);
    byte_4B47487 = 1;
  }
  if ( !obj
