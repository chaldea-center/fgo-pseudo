        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E79E7A & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&ServantCoinConfirmListViewItem_TypeInfo);
    byte_4E79E7A = 1;
  }
  ...
  if ( (int)max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      v13 = (ListViewItem_o *)sub_1D0F300(ServantCoinConfirmListViewItem_TypeInfo);
      ListViewItem___ctor_45157124(v13, v9, 0);
      v13[1].klass = v12;
      if ( !itemList )
        break;
      ...
      if ( (unsigned int)++v9 >= LODWORD(svtCoins->max_length) )
        sub_1D0F314(scrollView);
    }
LABEL_17:
    sub_1D0F30C(scrollView, v6);
  }
LABEL_15:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E79E7B & 1) == 0 )
  {
    this = (ServantCoinConfirmListViewManager_o *)sub_1D0F0B4(&ServantCoinConfirmListViewObject_TypeInfo);
    byte_4E79E7B = 1;
  }
  if ( !obj
