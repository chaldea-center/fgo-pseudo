        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E071CD & 1) == 0 )
  {
    ...
    sub_1CE6700(&ServantCoinConfirmListViewItem_TypeInfo);
    byte_4E071CD = 1;
  }
  ...
  if ( (int)max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      v13 = (ListViewItem_o *)sub_1CE694C(ServantCoinConfirmListViewItem_TypeInfo);
      ListViewItem___ctor_44921328(v13, v9, 0);
      v13[1].klass = v12;
      if ( !itemList )
        break;
      ...
      if ( (unsigned int)++v9 >= LODWORD(svtCoins->max_length) )
        sub_1CE6960(scrollView);
    }
LABEL_17:
    sub_1CE6958(scrollView, v6);
  }
LABEL_15:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E071CE & 1) == 0 )
  {
    this = (ServantCoinConfirmListViewManager_o *)sub_1CE6700(&ServantCoinConfirmListViewObject_TypeInfo);
    byte_4E071CE = 1;
  }
  if ( !obj
