        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A50F37 & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Collections_Generic_List_ListViewItem__Add__, svtCoins);
    sub_1B863B8(&ServantCoinConfirmListViewItem_TypeInfo, v5);
    byte_4A50F37 = 1;
  }
  ...
  if ( (int)v8 >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      v14 = (ListViewItem_o *)sub_1B86604(ServantCoinConfirmListViewItem_TypeInfo);
      ListViewItem___ctor_41775716(v14, v10, 0LL);
      v14[1].klass = v13;
      if ( !itemList )
        break;
      ...
      if ( ++v10 >= svtCoins->max_length )
        sub_1B8661C(scrollView, v7);
    }
LABEL_17:
    sub_1B86614(scrollView, v7);
  }
LABEL_15:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A50F38 & 1) == 0 )
  {
    this = (ServantCoinConfirmListViewManager_o *)sub_1B863B8(&ServantCoinConfirmListViewObject_TypeInfo, obj);
    byte_4A50F38 = 1;
  }
  if ( !obj
