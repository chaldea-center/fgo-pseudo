...
void __fastcall TerminalTransitionInfo__Init(TerminalTransitionInfo_o *this, const MethodInfo *method)
{
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.beforeActionVals, 0LL, v2, v3, v4, v5, v6, v7);
  this->fields.afterActionVals = 0LL;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.afterActionVals, 0LL, v9, v10, v11, v12, v13, v14);
  v15 = StringLiteral_1/*""*/;
  this->fields.voiceAssetName = (struct System_String_o *)StringLiteral_1/*""*/;
  p_voiceAssetName = &this->fields.voiceAssetName;
  sub_1BE4A70((PartyOrganizationUtility_o *)p_voiceAssetName, (int64_t)v15, v17, v18, v19, v20, v21, v22);
