...
void TerminalTransitionInfo__Init(TerminalTransitionInfo_o *this, const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.beforeActionVals, 0, v2, v3);
  this->fields.afterActionVals = 0;
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.afterActionVals, 0, v5, v6);
  v7 = StringLiteral_1/*""*/;
  this->fields.voiceAssetName = (struct System_String_o *)StringLiteral_1/*""*/;
  p_voiceAssetName = &this->fields.voiceAssetName;
  sub_1C36FFC((CGThumbnailListItem_o *)p_voiceAssetName, v7, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.voiceAssetName, (int32_t)voiceAssetName, (int32_t)method, v3);
}