...
void __fastcall TerminalTransitionInfo__Init(TerminalTransitionInfo_o *this, const MethodInfo *method)
{
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.beforeActionVals, 0, v2, v3);
  this->fields.afterActionVals = 0LL;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.afterActionVals, 0, v5, v6);
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)p_voiceAssetName, v7, v9, v10);
