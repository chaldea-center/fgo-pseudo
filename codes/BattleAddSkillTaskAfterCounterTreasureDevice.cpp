        ...
        const MethodInfo *method)
{
  ...
  ForceCreateComboEndSkillTask_o *v3; // x20
  __int64 v4; // x0
  __int64 v5; // x1
  ...
  if ( (byte_593B723 & 1) == 0 )
  {
    ...
    sub_21FFC50(&ForceCreateComboEndSkillTask_TypeInfo);
    byte_593B723 = 1;
  }
  v2 = (CreateSkillTaskFromBuffAction_array *)sub_21FFD10(CreateSkillTaskFromBuffAction___TypeInfo, 1);
  v3 = (ForceCreateComboEndSkillTask_o *)sub_21FFEBC(ForceCreateComboEndSkillTask_TypeInfo);
  ForceCreateComboEndSkillTask___ctor(v3, 0);
  if ( !v2 )
    sub_21FFECC(v4, v5);
  if ( v3 )
  {
