void ShortestDistanceFromEnemyMaster___ctor(ShortestDistanceFromEnemyMaster_o *this, const MethodInfo *method)
{
...
float ShortestDistanceFromEnemyMaster__GetRatingBase(
        ShortestDistanceFromEnemyMaster_o *this,
        int32_t forceId,
...
{
  ShortestDistanceFromEnemyMaster_o *v10; // x19
  ...
  if ( (byte_4CEBF31 & 1) == 0 )
  {
    ...
    this = (ShortestDistanceFromEnemyMaster_o *)sub_1C7BAE8(&WarBoardAIManager_TypeInfo);
    byte_4CEBF31 = 1;
  }
  if ( !targetSquare )
    goto LABEL_18;
  ...
  if ( EnemyPieceSquareIndex )
  {
    ...
    {
      this = (ShortestDistanceFromEnemyMaster_o *)WarBoardPieceData__get_isMaster(EnemyPieceSquareIndex, 0);
