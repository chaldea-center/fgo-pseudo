void __fastcall ProjectionMatrixCalc___ctor(ProjectionMatrixCalc_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C00B6C & 1) == 0 )
  {
    ...
    sub_1C2E12C(&System_Collections_Generic_List_Renderer__TypeInfo, v9);
    sub_1C2E12C(&StringLiteral_16597/*"_ProjectorMatrixVP"*/, v10);
    sub_1C2E12C(&StringLiteral_16598/*"_ProjectorPos"*/, v11);
    byte_4C00B6C = 1;
  }
  this->fields._orthographicSize = 1.0;
  *(_QWORD *)&this->fields._nearClipPlane = 0x42C800003C23D70ALL;
  v12 = StringLiteral_16597/*"_ProjectorMatrixVP"*/;
  this->fields._shaderPropertyName_MatrixVP = (struct System_String_o *)StringLiteral_16597/*"_ProjectorMatrixVP"*/;
  sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields._shaderPropertyName_MatrixVP, v12, v2, v3, v4, v5, v6, v7);
  v13 = StringLiteral_16598/*"_ProjectorPos"*/;
  this->fields._shaderPropertyName_Pos = (struct System_String_o *)StringLiteral_16598/*"_ProjectorPos"*/;
  sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields._shaderPropertyName_Pos, v13, v14, v15, v16, v17, v18, v19);
  this->fields._destroyRendererMaterial = 1;
  v20 = (System_Collections_Generic_List_object__o *)sub_1C2E378(System_Collections_Generic_List_Renderer__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v20,
    (const MethodInfo_366B078 *)Method_System_Collections_Generic_List_Renderer___ctor__);
  this->fields.workRenderers = (struct System_Collections_Generic_List_Renderer__o *)v20;
  sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.workRenderers, (int64_t)v20, v21, v22, v23, v24, v25, v26);
...
void __fastcall ProjectionMatrixCalc__LateUpdate(ProjectionMatrixCalc_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C00B6A & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_System_Collections_Generic_List_Renderer__GetEnumerator__, v5);
    sub_1C2E12C(&Method_System_Collections_Generic_List_Renderer__get_Count__, v6);
    byte_4C00B6A = 1;
  }
    ...
    if ( max_length >= 1 )
    {
      for ( i = 0; i < max_length; ++i )
      {
        if ( i >= (unsigned int)max_length )
          sub_1C2E390(materials, v22);
        shaderPropertyName_MatrixVP = this->fields._shaderPropertyName_MatrixVP;
        v27 = v23->m_Items[i];
        v34 = v36;
        if ( !v27 )
          sub_1C2E388(materials, shaderPropertyName_MatrixVP);
        v28 = v34;
...
void __fastcall ProjectionMatrixCalc__OnDisable(ProjectionMatrixCalc_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C00B69 & 1) == 0 )
  {
    this = (ProjectionMatrixCalc_o *)sub_1C2E12C(&Method_System_Collections_Generic_List_Renderer__Clear__, method);
    byte_4C00B69 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C00B6B & 1) == 0 )
  {
    sub_1C2E12C(&Method_System_Collections_Generic_List_Enumerator_Renderer__Dispose__, renderers);
    sub_1C2E12C(&Method_System_Collections_Generic_List_Enumerator_Renderer__MoveNext__, v6);
    sub_1C2E12C(&Method_System_Collections_Generic_List_Enumerator_Renderer__get_Current__, v7);
    sub_1C2E12C(&Method_System_Collections_Generic_List_Renderer__GetEnumerator__, v8);
    this = (ProjectionMatrixCalc_o *)sub_1C2E12C(&UnityEngine_Object_TypeInfo, v9);
    byte_4C00B6B = 1;
  }
  memset(&v48, 0, sizeof(v48));
  if ( !renderers )
    sub_1C2E388(this, renderers);
  System_Collections_Generic_List_object___GetEnumerator(
...
void __fastcall ProjectionMatrixCalc__updateWorkRenderers(ProjectionMatrixCalc_o *this, const MethodInfo *method)
{
  ...
  UnityEngine_Material_array *materials; // x0
  __int64 v34; // x1
  UnityEngine_Material_array *v35; // x21
  __int64 v36; // x8
  unsigned __int64 v37; // x23
  UnityEngine_Object_o *v38; // x22
  __int64 v39; // x1
  struct System_Collections_Generic_List_Renderer__o *v40; // x0
  Il2CppObject *v41; // x20
  _BOOL8 v42; // x0
  __int64 v43; // x1
  __int64 v44; // x1
  struct System_Collections_Generic_List_Renderer__o *v45; // x0
  __int64 v46; // x1
  int64_t v47; // x2
  int32_t v48; // w3
  ...
  if ( (byte_4C00B68 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_System_Collections_Generic_List_Enumerator_Renderer__MoveNext__, v3);
    sub_1C2E12C(&Method_System_Collections_Generic_List_Enumerator_Renderer__get_Current__, v4);
    sub_1C2E12C(&Method_System_Collections_Generic_List_Renderer__Add__, v5);
    sub_1C2E12C(&Method_System_Collections_Generic_List_Renderer__Contains__, v6);
    sub_1C2E12C(&Method_System_Collections_Generic_List_Renderer__GetEnumerator__, v7);
    sub_1C2E12C(&Method_System_Collections_Generic_List_Renderer__Remove__, v8);
    sub_1C2E12C(&Method_System_Collections_Generic_List_Renderer___ctor__, v9);
    sub_1C2E12C(&System_Collections_Generic_List_Renderer__TypeInfo, v10);
    sub_1C2E12C(&UnityEngine_Object_TypeInfo, v11);
    byte_4C00B68 = 1;
  }
  memset(&i, 0, sizeof(i));
  v12 = (System_Collections_Generic_List_object__o *)sub_1C2E378(System_Collections_Generic_List_Renderer__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v12,
    (const MethodInfo_366B078 *)Method_System_Collections_Generic_List_Renderer___ctor__);
  workRenderers = this->fields.workRenderers;
            ...
            (const MethodInfo_34001C4 *)Method_System_Collections_Generic_List_Enumerator_Renderer__MoveNext__) )
  {
    ...
    if ( !v18 )
    {
      ...
      if ( !v20 )
      {
        ...
        v29 = Method_System_Collections_Generic_List_Renderer__Add__;
        ++v12->fields._version;
        if ( !items )
          sub_1C2E388(v20, v21);
        ...
        else
        {
          ...
          sub_1C2E0D0((PartyOrganizationUtility_o *)(v31 + 4), (int64_t)current, v22, v23, v24, v25, v26, v27);
        }
      }
    }
  }
  ...
  if ( this->fields._destroyRendererMaterial )
  {
              ...
              (const MethodInfo_34001C4 *)Method_System_Collections_Generic_List_Enumerator_Renderer__MoveNext__) )
    {
      ...
      if ( !materials )
        sub_1C2E388(0LL, v34);
      v36 = *(_QWORD *)&materials->max_length;
      if ( (int)v36 >= 1 )
      {
        v37 = 0LL;
        do
        {
          if ( v37 >= (unsigned int)v36 )
            sub_1C2E390(materials, v34);
          v38 = (UnityEngine_Object_o *)v35->m_Items[v37];
          if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
          UnityEngine_Object__DestroyImmediate_70989908(v38, 0LL);
  ...
  for ( i = v58;
        ...
        System_Collections_Generic_List_object___Remove(
          ...
          i.fields._current,
          (const MethodInfo_366CDD4 *)Method_System_Collections_Generic_List_Renderer__Remove__) )
  {
    v40 = this->fields.workRenderers;
    if ( !v40 )
      sub_1C2E388(0LL, v39);
  }
  System_Collections_Generic_List_Enumerator_object___Dispose(
...
LABEL_60:
  ...
  while ( System_Collections_Generic_List_Enumerator_object___MoveNext(
            ...
            (const MethodInfo_34001C4 *)Method_System_Collections_Generic_List_Enumerator_Renderer__MoveNext__) )
  {
    v41 = i.fields._current;
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    v42 = UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)v41, 0LL, 0LL);
    if ( v42 )
    {
      if ( !v41 )
        sub_1C2E388(v42, v43);
      if ( UnityEngine_Renderer__get_enabled((UnityEngine_Renderer_o *)v41, 0LL) )
      {
        v45 = this->fields.workRenderers;
        if ( !v45 )
          sub_1C2E388(0LL, v44);
        if ( !System_Collections_Generic_List_object___Contains(
                ...
                (const MethodInfo_366BC3C *)Method_System_Collections_Generic_List_Renderer__Contains__) )
        {
          v53 = (System_Collections_Generic_List_object__o *)this->fields.workRenderers;
          if ( !v53 )
            sub_1C2E388(0LL, v46);
          v54 = v53->fields._items;
          v55 = Method_System_Collections_Generic_List_Renderer__Add__;
          ++v53->fields._version;
          if ( !v54 )
            sub_1C2E388(v53, v46);
          ...
          else
          {
            ...
            sub_1C2E0D0((PartyOrganizationUtility_o *)(v57 + 4), (int64_t)v41, v47, v48, v49, v50, v51, v52);
          }
        }
      }
    }
