void __fastcall UserCommandCodeMaster___ctor(UserCommandCodeMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4B37DB5 & 1) == 0 )
  {
    sub_1BD3458(&Method_DataMasterBase_UserCommandCodeMaster__UserCommandCodeEntity__long___ctor__, method);
    byte_4B37DB5 = 1;
  }
  DataMasterBase_object__object__long____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    252,
    (const MethodInfo_31D205C *)Method_DataMasterBase_UserCommandCodeMaster__UserCommandCodeEntity__long___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B37DB8 & 1) == 0 )
  {
    ...
    sub_1BD3458(&UserCommandCodeEntity_TypeInfo, v5);
    sub_1BD3458(&UserCommandCodeNewManager_TypeInfo, v6);
    byte_4B37DB8 = 1;
  }
      ...
      if ( Item )
      {
          ...
          && (UserCommandCodeEntity_c *)Item->klass->_2.typeHierarchy[methodPtr_low - 1] == UserCommandCodeEntity_TypeInfo )
        {
          ...
          *(Il2CppObject *)&v16.fields.fakeValue = v13;
          ...
          v15 = v16;
          v14 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_47140144(&v15, 0LL);
...
int32_t __fastcall UserCommandCodeMaster__getCount(UserCommandCodeMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B37DB7 & 1) == 0 )
  {
    sub_1BD3458(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__, method);
    sub_1BD3458(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Item__, v3);
    sub_1BD3458(&UserCommandCodeEntity_TypeInfo, v4);
    byte_4B37DB7 = 1;
  }
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B37DB6 & 1) == 0 )
  {
    sub_1BD3458(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__, method);
    sub_1BD3458(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Item__, v3);
    sub_1BD3458(&Method_System_Collections_Generic_List_UserCommandCodeEntity__Add__, v4);
    sub_1BD3458(&Method_System_Collections_Generic_List_UserCommandCodeEntity__ToArray__, v5);
    sub_1BD3458(&Method_System_Collections_Generic_List_UserCommandCodeEntity___ctor__, v6);
    sub_1BD3458(&System_Collections_Generic_List_UserCommandCodeEntity__TypeInfo, v7);
    sub_1BD3458(&UserCommandCodeEntity_TypeInfo, v8);
    byte_4B37DB6 = 1;
  }
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
  ...
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            list,
            (const MethodInfo_316E4C0 *)Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__);
  v11 = (System_Collections_Generic_List_object__o *)sub_1BD36A4(System_Collections_Generic_List_UserCommandCodeEntity__TypeInfo);
    ...
    while ( 1 )
    {
      ...
      if ( list )
      {
          ...
          && (UserCommandCodeEntity_c *)list->klass->_2.typeHierarchy[methodPtr_low - 1] == UserCommandCodeEntity_TypeInfo )
        {
          ...
          v21 = Method_System_Collections_Generic_List_UserCommandCodeEntity__Add__;
          ++v11->fields._version;
          if ( !items )
            break;
          ...
          else
          {
            ...
            sub_1BD33FC((PartyOrganizationUtility_o *)(v23 + 4), (int64_t)method, v13, v14, v15, v16, v17, v18);
          }
        }
      }
      if ( Count == ++v12 )
...
LABEL_16:
  ...
  return (UserCommandCodeEntity_array *)System_Collections_Generic_List_object___ToArray(
                                          v11,
                                          (const MethodInfo_35C28E8 *)Method_System_Collections_Generic_List_UserCommandCodeEntity__ToArray__);
}