        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B01306 & 1) == 0 )
  {
    sub_1BC3008(&UnityEngine_Object_TypeInfo, titleSprite);
    sub_1BC3008(&StringLiteral_17293/*"btn_bg_12"*/, v15);
    sub_1BC3008(&StringLiteral_17295/*"btn_bg_19"*/, v16);
    byte_4B01306 = 1;
  }
...
LABEL_20:
          sub_1BC3264(v17, v18);
        v22 = &StringLiteral_17295/*"btn_bg_19"*/;
        if ( !isSelectedTab )
          v22 = &StringLiteral_17293/*"btn_bg_12"*/;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B01305 & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_17402/*"btn_txt_craftessence_off"*/, *(_QWORD *)&iTabKind);
    sub_1BC3008(&StringLiteral_17442/*"btn_txt_servant_off"*/, v8);
    sub_1BC3008(&StringLiteral_17398/*"btn_txt_cc_off"*/, v9);
    sub_1BC3008(&StringLiteral_17399/*"btn_txt_cc_on"*/, v10);
    sub_1BC3008(&StringLiteral_17443/*"btn_txt_servant_on"*/, v11);
    sub_1BC3008(&StringLiteral_17403/*"btn_txt_craftessence_on"*/, v12);
    byte_4B01305 = 1;
  }
  v13 = isInit;
  CharaGraphKindTabButtonGroup__SetupTabButton(
    ...
    iTabKind == 0,
    (System_String_o *)StringLiteral_17443/*"btn_txt_servant_on"*/,
    (System_String_o *)StringLiteral_17442/*"btn_txt_servant_off"*/,
    v13,
    v4);
  CharaGraphKindTabButtonGroup__SetupTabButton(
    ...
    iTabKind == 1,
    (System_String_o *)StringLiteral_17403/*"btn_txt_craftessence_on"*/,
    (System_String_o *)StringLiteral_17402/*"btn_txt_craftessence_off"*/,
    v13,
    v14);
  CharaGraphKindTabButtonGroup__SetupTabButton(
    ...
    iTabKind == 2,
    (System_String_o *)StringLiteral_17399/*"btn_txt_cc_on"*/,
    (System_String_o *)StringLiteral_17398/*"btn_txt_cc_off"*/,
    v13,
    v15);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B01304 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMaster_UserCommandCodeMaster___, *(_QWORD *)&iTabKind);
    ...
    sub_1BC3008(&StringLiteral_3313/*"CHARA_GRAPH_TAB_COMMAND_CODE"*/, v9);
    sub_1BC3008(&StringLiteral_3314/*"CHARA_GRAPH_TAB_SERVANT"*/, v10);
    sub_1BC3008(&StringLiteral_3315/*"CHARA_GRAPH_TAB_SERVANT_EQUIP"*/, v11);
    byte_4B01304 = 1;
  }
  *(_QWORD *)servantEquipSum = 0LL;
  ...
  if ( !byte_4AFC909 )
  {
    sub_1BC3008(&LocalizationManager_TypeInfo, *(_QWORD *)&iTabKind);
    byte_4AFC909 = 1;
  }
  ...
  if ( CharaGraphKindTabButtonGroup__IsActive((UnityEngine_Component_o *)this->fields.servantTabButton, v26) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v29 = LocalizationManager__Get((System_String_o *)StringLiteral_3314/*"CHARA_GRAPH_TAB_SERVANT"*/, 0LL);
    ...
    Master_object = (UserServantMaster_o *)System_String__Format_62389940(v29, v36, v37, 0LL);
    if ( !servantTabLabel )
      goto LABEL_51;
  ...
  if ( CharaGraphKindTabButtonGroup__IsActive((UnityEngine_Component_o *)this->fields.servantEquipTabButton, v27) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v44 = LocalizationManager__Get((System_String_o *)StringLiteral_3315/*"CHARA_GRAPH_TAB_SERVANT_EQUIP"*/, 0LL);
    ...
    Master_object = (UserServantMaster_o *)System_String__Format_62389940(v44, v51, v52, 0LL);
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (UserServantMaster_o *)DataManager__GetMaster_object_((const MethodInfo_3001E10 *)Method_DataManager_GetMaster_UserCommandCodeMaster___);
  if ( !Master_object )
    goto LABEL_51;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v60 = LocalizationManager__Get((System_String_o *)StringLiteral_3313/*"CHARA_GRAPH_TAB_COMMAND_CODE"*/, 0LL);
  v71 = v59;
  ...
  if ( !byte_4AFC80E )
  {
    sub_1BC3008(&BalanceConfig_TypeInfo, v25);
    byte_4AFC80E = 1;
  }
  ...
  Master_object = (UserServantMaster_o *)System_String__Format_62389940(v60, v67, v69, 0LL);
