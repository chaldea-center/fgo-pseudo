...
LABEL_20:
          sub_1D0F30C(v15, v16);
        v20 = &StringLiteral_17706/*"btn_bg_19"*/;
        if ( !isSelectedTab )
          v20 = &StringLiteral_17704/*"btn_bg_12"*/;
        ...
        const MethodInfo *method)
{
  ...
  CharaGraphKindTabButtonGroup__SetupTabButton(
    ...
    iTabKind == 0,
    (System_String_o *)StringLiteral_17864/*"btn_txt_servant_on"*/,
    (System_String_o *)StringLiteral_17863/*"btn_txt_servant_off"*/,
    v8,
    v4);
  CharaGraphKindTabButtonGroup__SetupTabButton(
    ...
    iTabKind == 1,
    (System_String_o *)StringLiteral_17824/*"btn_txt_craftessence_on"*/,
    (System_String_o *)StringLiteral_17823/*"btn_txt_craftessence_off"*/,
    v8,
    v9);
  CharaGraphKindTabButtonGroup__SetupTabButton(
    ...
    iTabKind == 2,
    (System_String_o *)StringLiteral_17820/*"btn_txt_cc_on"*/,
    (System_String_o *)StringLiteral_17819/*"btn_txt_cc_off"*/,
    v8,
    v10);
}
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)servantEquipSum = 0;
  ...
  if ( CharaGraphKindTabButtonGroup__IsActive((UnityEngine_Component_o *)this->fields.servantTabButton, v19) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v22 = LocalizationManager__Get((System_String_o *)StringLiteral_3377/*"CHARA_GRAPH_TAB_SERVANT"*/, 0);
    ...
    Master_object = (UserServantMaster_o *)System_String__Format_65604080(v22, v23, v24, 0);
    if ( !servantTabLabel )
      goto LABEL_51;
  ...
  if ( CharaGraphKindTabButtonGroup__IsActive((UnityEngine_Component_o *)this->fields.servantEquipTabButton, v20) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v31 = LocalizationManager__Get((System_String_o *)StringLiteral_3378/*"CHARA_GRAPH_TAB_SERVANT_EQUIP"*/, 0);
    ...
    Master_object = (UserServantMaster_o *)System_String__Format_65604080(v31, v32, v33, 0);
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (UserServantMaster_o *)DataManager__GetMaster_object_((const MethodInfo_324F164 *)Method_DataManager_GetMaster_UserCommandCodeMaster___);
  if ( !Master_object )
    goto LABEL_51;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v41 = LocalizationManager__Get((System_String_o *)StringLiteral_3376/*"CHARA_GRAPH_TAB_COMMAND_CODE"*/, 0);
  v46 = v40;
  Master_object = (UserServantMaster_o *)j_il2cpp_value_box_0(int_TypeInfo, &v46);
  if ( !SelfUserGame )
    goto LABEL_51;
  ...
  Master_object = (UserServantMaster_o *)System_String__Format_65604080(v41, v42, v44, 0);
