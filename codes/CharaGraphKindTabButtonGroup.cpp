        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB50AB & 1) == 0 )
  {
    sub_1BAB41C(&UnityEngine_Object_TypeInfo, titleSprite);
    sub_1BAB41C(&StringLiteral_17506/*"btn_bg_12"*/, v15);
    sub_1BAB41C(&StringLiteral_17508/*"btn_bg_19"*/, v16);
    byte_4AB50AB = 1;
  }
...
LABEL_20:
          sub_1BAB678(v17, v18);
        v22 = &StringLiteral_17508/*"btn_bg_19"*/;
        if ( !isSelectedTab )
          v22 = &StringLiteral_17506/*"btn_bg_12"*/;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB50AA & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_17600/*"btn_txt_craftessence_off"*/, *(_QWORD *)&iTabKind);
    sub_1BAB41C(&StringLiteral_17640/*"btn_txt_servant_off"*/, v8);
    sub_1BAB41C(&StringLiteral_17596/*"btn_txt_cc_off"*/, v9);
    sub_1BAB41C(&StringLiteral_17597/*"btn_txt_cc_on"*/, v10);
    sub_1BAB41C(&StringLiteral_17641/*"btn_txt_servant_on"*/, v11);
    sub_1BAB41C(&StringLiteral_17601/*"btn_txt_craftessence_on"*/, v12);
    byte_4AB50AA = 1;
  }
  v13 = isInit;
  CharaGraphKindTabButtonGroup__SetupTabButton(
    ...
    iTabKind == 0,
    (System_String_o *)StringLiteral_17641/*"btn_txt_servant_on"*/,
    (System_String_o *)StringLiteral_17640/*"btn_txt_servant_off"*/,
    v13,
    v4);
  CharaGraphKindTabButtonGroup__SetupTabButton(
    ...
    iTabKind == 1,
    (System_String_o *)StringLiteral_17601/*"btn_txt_craftessence_on"*/,
    (System_String_o *)StringLiteral_17600/*"btn_txt_craftessence_off"*/,
    v13,
    v14);
  CharaGraphKindTabButtonGroup__SetupTabButton(
    ...
    iTabKind == 2,
    (System_String_o *)StringLiteral_17597/*"btn_txt_cc_on"*/,
    (System_String_o *)StringLiteral_17596/*"btn_txt_cc_off"*/,
    v13,
    v15);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB50A9 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMaster_UserCommandCodeMaster___, *(_QWORD *)&iTabKind);
    ...
    sub_1BAB41C(&StringLiteral_3450/*"CHARA_GRAPH_TAB_COMMAND_CODE"*/, v9);
    sub_1BAB41C(&StringLiteral_3451/*"CHARA_GRAPH_TAB_SERVANT"*/, v10);
    sub_1BAB41C(&StringLiteral_3452/*"CHARA_GRAPH_TAB_SERVANT_EQUIP"*/, v11);
    byte_4AB50A9 = 1;
  }
  *(_QWORD *)servantEquipSum = 0LL;
  ...
  if ( !byte_4AB0D26 )
  {
    sub_1BAB41C(&LocalizationManager_TypeInfo, *(_QWORD *)&iTabKind);
    byte_4AB0D26 = 1;
  }
  ...
  if ( CharaGraphKindTabButtonGroup__IsActive((UnityEngine_Component_o *)this->fields.servantTabButton, v26) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v29 = LocalizationManager__Get((System_String_o *)StringLiteral_3451/*"CHARA_GRAPH_TAB_SERVANT"*/, 0LL);
    ...
    Master_object = (UserServantMaster_o *)System_String__Format_62062500(v29, v36, v37, 0LL);
    if ( !servantTabLabel )
      goto LABEL_51;
  ...
  if ( CharaGraphKindTabButtonGroup__IsActive((UnityEngine_Component_o *)this->fields.servantEquipTabButton, v27) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v44 = LocalizationManager__Get((System_String_o *)StringLiteral_3452/*"CHARA_GRAPH_TAB_SERVANT_EQUIP"*/, 0LL);
    ...
    Master_object = (UserServantMaster_o *)System_String__Format_62062500(v44, v51, v52, 0LL);
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (UserServantMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2EC5574 *)Method_DataManager_GetMaster_UserCommandCodeMaster___);
  if ( !Master_object )
    goto LABEL_51;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v60 = LocalizationManager__Get((System_String_o *)StringLiteral_3450/*"CHARA_GRAPH_TAB_COMMAND_CODE"*/, 0LL);
  v71 = v59;
  ...
  if ( !byte_4AB0EC3 )
  {
    sub_1BAB41C(&BalanceConfig_TypeInfo, v25);
    byte_4AB0EC3 = 1;
  }
  ...
  Master_object = (UserServantMaster_o *)System_String__Format_62062500(v60, v67, v69, 0LL);
