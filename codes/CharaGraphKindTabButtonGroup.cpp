        ...
        const MethodInfo *method)
{
  ...
  CharaGraphKindTabButtonGroup__SetupTabButton(
    ...
    iTabKind == 0,
    (System_String_o *)StringLiteral_17790/*"btn_txt_servant_on"*/,
    (System_String_o *)StringLiteral_17789/*"btn_txt_servant_off"*/,
    v8,
    v4);
  CharaGraphKindTabButtonGroup__SetupTabButton(
    ...
    iTabKind == 1,
    (System_String_o *)StringLiteral_17750/*"btn_txt_craftessence_on"*/,
    (System_String_o *)StringLiteral_17749/*"btn_txt_craftessence_off"*/,
    v8,
    v9);
  CharaGraphKindTabButtonGroup__SetupTabButton(
    ...
    iTabKind == 2,
    (System_String_o *)StringLiteral_17746/*"btn_txt_cc_on"*/,
    (System_String_o *)StringLiteral_17745/*"btn_txt_cc_off"*/,
    v8,
    v10);
}
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)servantEquipSum = 0;
  ...
  if ( CharaGraphKindTabButtonGroup__IsActive((UnityEngine_Component_o *)this->fields.servantTabButton, v19) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v22 = LocalizationManager__Get((System_String_o *)StringLiteral_3367/*"CHARA_GRAPH_TAB_SERVANT"*/, 0);
    ...
    Master_object = (UserServantMaster_o *)System_String__Format_65164136(v22, v23, v24, 0);
    if ( !servantTabLabel )
      goto LABEL_51;
  ...
  if ( CharaGraphKindTabButtonGroup__IsActive((UnityEngine_Component_o *)this->fields.servantEquipTabButton, v20) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v31 = LocalizationManager__Get((System_String_o *)StringLiteral_3368/*"CHARA_GRAPH_TAB_SERVANT_EQUIP"*/, 0);
    ...
    Master_object = (UserServantMaster_o *)System_String__Format_65164136(v31, v32, v33, 0);
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (UserServantMaster_o *)DataManager__GetMaster_object_((const MethodInfo_3204354 *)Method_DataManager_GetMaster_UserCommandCodeMaster___);
  if ( !Master_object )
    goto LABEL_51;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v41 = LocalizationManager__Get((System_String_o *)StringLiteral_3366/*"CHARA_GRAPH_TAB_COMMAND_CODE"*/, 0);
  v46 = v40;
  Master_object = (UserServantMaster_o *)j_il2cpp_value_box_0(int_TypeInfo, &v46);
  if ( !SelfUserGame )
    goto LABEL_51;
  ...
  Master_object = (UserServantMaster_o *)System_String__Format_65164136(v41, v42, v44, 0);
