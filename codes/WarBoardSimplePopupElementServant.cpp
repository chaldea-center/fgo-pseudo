void WarBoardSimplePopupElementServant___ctor(WarBoardSimplePopupElementServant_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.positionActionPointDefault.fields.x = xmmword_D354D0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7532F & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_WarBoardSimplePopupElementServant_OnClickDetailButton__);
    byte_4E7532F = 1;
  }
  ...
  if ( (*((_BYTE *)Method_WarBoardSimplePopupElementServant_OnClickDetailButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1D0F0CC(Method_WarBoardSimplePopupElementServant_OnClickDetailButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7532B & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_15624/*"WARBOARD_SERVANT_INFO_ENEMY_ATK"*/);
  ...
  if ( isPlayerGroup )
  {
    ...
    v9 = System_String__Format((System_String_o *)StringLiteral_25574/*"{0:#,0}"*/, v8, 0);
    if ( atkValueLabel )
    {
...
LABEL_10:
  ...
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_15624/*"WARBOARD_SERVANT_INFO_ENEMY_ATK"*/, 0);
  if ( !atkValueLabel )
    goto LABEL_10;
  UILabel__set_text(atkValueLabel, v9, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7532D & 1) == 0 )
  {
    sub_1D0F0B4(&Method_UnityEngine_GameObject_GetComponent_WarBoardBreakPointComponent___);
    sub_1D0F0B4(&Method_UnityEngine_Object_Instantiate_GameObject____80459208);
    sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    sub_1D0F0B4(&WarBoardBreakPointComponent___TypeInfo);
    byte_4E7532D = 1;
  }
  v9 = (UnityEngine_GameObject_o *)sub_1D0F15C(WarBoardBreakPointComponent___TypeInfo, (unsigned int)breakPointMax);
  ...
  if ( breakPointMax >= 1 )
  {
    ...
    do
    {
      ...
      v9 = (UnityEngine_GameObject_o *)UnityEngine_Object__Instantiate_object__53335036(
                                         breakPointPrefab,
                                         transform,
      ...
      Component_object = (WarBoardBreakPointComponent_o *)UnityEngine_GameObject__GetComponent_object_(
                                                            v24,
                                                            (const MethodInfo_32A8444 *)Method_UnityEngine_GameObject_GetComponent_WarBoardBreakPointComponent___);
      ...
      if ( !v12 )
        break;
      v27 = sub_1D0F1F0(Component_object, *(_QWORD *)(*(_QWORD *)v12 + 64LL));
      if ( !v27 )
      {
        v35 = sub_1D0F330();
        sub_1D0F1DC(v35, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( buffData && !v6 )
  {
    ...
    if ( !v7 )
      sub_1D0F30C(ShowServantParam, v9);
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_24:
    sub_1D0F30C(hpLabel, *(_QWORD *)&dispType);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E75328 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    sub_1D0F0B4(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    sub_1D0F0B4(&StringLiteral_15593/*"WARBOARD_INFO_POPUP_SVT_HP"*/);
    ...
    sub_1D0F0B4(&StringLiteral_15592/*"WARBOARD_INFO_POPUP_SVT_DETAIL_BUTTON"*/);
    sub_1D0F0B4(&StringLiteral_15591/*"WARBOARD_INFO_POPUP_SVT_ATK"*/);
    sub_1D0F0B4(&StringLiteral_15589/*"WARBOARD_INFO_POPUP_SVT_ACTION_POINT"*/);
    sub_1D0F0B4(&StringLiteral_15594/*"WARBOARD_INFO_POPUP_SVT_LV"*/);
    sub_1D0F0B4(&StringLiteral_25577/*"{0:#,0} / {1:#,0}"*/);
    this = (WarBoardSimplePopupElementServant_o *)sub_1D0F0B4(&StringLiteral_15590/*"WARBOARD_INFO_POPUP_SVT_ACTION_POINT_COST"*/);
    byte_4E75328 = 1;
  }
  *(_QWORD *)svtId = 0;
  entity = 0;
  ...
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&v4->fields.pieceData, (int32_t)v3, v5, v6, v7, v8, v9, v10);
  battleServant_k__BackingField = v3->fields._battleServant_k__BackingField;
  atkLabel = v4->fields.atkLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  this = (WarBoardSimplePopupElementServant_o *)LocalizationManager__Get((System_String_o *)StringLiteral_15591/*"WARBOARD_INFO_POPUP_SVT_ATK"*/, 0);
  if ( !atkLabel )
    goto LABEL_162;
  UILabel__set_text(atkLabel, (System_String_o *)this, 0);
  hpLabel = v4->fields.hpLabel;
  this = (WarBoardSimplePopupElementServant_o *)LocalizationManager__Get((System_String_o *)StringLiteral_15593/*"WARBOARD_INFO_POPUP_SVT_HP"*/, 0);
  if ( !hpLabel )
    goto LABEL_162;
  UILabel__set_text(hpLabel, (System_String_o *)this, 0);
  detailButtonLabel = v4->fields.detailButtonLabel;
  this = (WarBoardSimplePopupElementServant_o *)LocalizationManager__Get((System_String_o *)StringLiteral_15592/*"WARBOARD_INFO_POPUP_SVT_DETAIL_BUTTON"*/, 0);
  ...
  if ( UnityEngine_Object__op_Inequality(servantLevel, 0, 0) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v19 = LocalizationManager__Get((System_String_o *)StringLiteral_15594/*"WARBOARD_INFO_POPUP_SVT_LV"*/, 0);
  ...
  this = (WarBoardSimplePopupElementServant_o *)System_String__Format_65604080(
                                                  (System_String_o *)StringLiteral_25577/*"{0:#,0} / {1:#,0}"*/,
                                                  v26,
                                                  v27,
                                                  0);
  if ( !hpValueLabel )
  ...
  {
    this = (WarBoardSimplePopupElementServant_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3BAC684 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    if ( !this )
      goto LABEL_162;
  ...
  this = (WarBoardSimplePopupElementServant_o *)System_String__Format((System_String_o *)StringLiteral_23768/*"servant_base_{0}"*/, v38, 0);
  if ( !frameSprite )
    goto LABEL_162;
    ...
    if ( UnityEngine_Object__op_Inequality(actionPointValueLabel, 0, 0) )
    {
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        ...
        this = (WarBoardSimplePopupElementServant_o *)System_String__Format(
                                                        (System_String_o *)StringLiteral_23768/*"servant_base_{0}"*/,
                                                        v45,
                                                        0);
        if ( !v44 )
          goto LABEL_162;
        ...
        this = (WarBoardSimplePopupElementServant_o *)LocalizationManager__Get(
                                                        (System_String_o *)StringLiteral_15589/*"WARBOARD_INFO_POPUP_SVT_ACTION_POINT"*/,
                                                        0);
        if ( !actionPointLabel )
          goto LABEL_162;
        ...
        v51 = LocalizationManager__Get((System_String_o *)StringLiteral_15590/*"WARBOARD_INFO_POPUP_SVT_ACTION_POINT_COST"*/, 0);
        MaxHp = v47;
        v52 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &MaxHp);
        v101 = v49;
        v53 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v101);
        this = (WarBoardSimplePopupElementServant_o *)System_String__Format_65604080(v51, v52, v53, 0);
        if ( !costDispLabel )
          goto LABEL_162;
  ...
  this = (WarBoardSimplePopupElementServant_o *)DataManager__GetMaster_object_((const MethodInfo_324F164 *)Method_DataManager_GetMaster_ServantLimitImageMaster___);
  if ( !this )
    goto LABEL_162;
...
LABEL_90:
    ...
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    if ( AtlasManager__SetEventUI_41967144(posAtkValueLabel, enemyIcon, v72, 0) )
      goto LABEL_97;
    v73 = (UISprite_o *)v4->fields.enemyIcon;
    v74 = System_Int32__ToString((int32_t)&svtId[1], 0);
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    if ( AtlasManager__SetEventUI_41967144(posAtkValueLabel, v73, v74, 0) )
LABEL_97:
      WarBoardPieceData__ApplyDisplayType(v3, v4->fields.enemyIcon, 0);
    enemyIconBg = v4->fields.enemyIconBg;
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetEventUI_41967144(posAtkValueLabel, enemyIconBg, (System_String_o *)StringLiteral_23366/*"questinfo_enemyface_bg"*/, 0);
    v66 = 0;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(equipIcon, 0, 0) )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(equipLimitCountSprite, 0, 0) )
    {
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      this = (WarBoardSimplePopupElementServant_o *)DataManager__GetMaster_object_((const MethodInfo_324F164 *)Method_DataManager_GetMaster_ServantMaster___);
      if ( !this )
        goto LABEL_162;
...
LABEL_127:
  ...
  if ( WarBoardPieceData__get_isEnemyServant(v3, 0) )
  {
    ...
    if ( !this )
      goto LABEL_162;
    UISprite__set_spriteName((UISprite_o *)this, (System_String_o *)StringLiteral_20400/*"hp_gauge_boss"*/, 0);
  }
  hpBar = (UIBasicSprite_o *)v4->fields.hpBar;
  CurrentHpProgress = WarBoardPieceData__get_CurrentHpProgress(v3, 0);
  if ( !hpBar )
LABEL_162:
    sub_1D0F30C(this, pieceData);
    ...
    if ( v100 )
    {
      if ( v100->fields.isEnemy && v3->fields._roleType_k__BackingField == 1 )
      {
        ...
        if ( this )
        {
          ...
          if ( this )
          {
            UISprite__set_spriteName((UISprite_o *)this, (System_String_o *)StringLiteral_20622/*"icon_strong_enemy"*/, 0);
            this = (WarBoardSimplePopupElementServant_o *)v4->fields.RoleTypeLabel;
            if ( this )
            {
              UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)this, 1, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E75329 & 1) == 0 )
  {
    sub_1D0F0B4(&System_Action_UIWidget__TypeInfo);
    sub_1D0F0B4(&Method_BasicHelper_ForEach_UIWidget___);
    sub_1D0F0B4(&Method_WarBoardSimplePopupElementServant___c__DisplayClass55_0__UpdateUiBrightnessByPieceStatus_b__0__);
    sub_1D0F0B4(&Method_WarBoardSimplePopupElementServant___c__DisplayClass55_0__UpdateUiBrightnessByPieceStatus_b__1__);
    sub_1D0F0B4(&WarBoardSimplePopupElementServant___c__DisplayClass55_0_TypeInfo);
    byte_4E75329 = 1;
  }
  v3 = sub_1D0F300(WarBoardSimplePopupElementServant___c__DisplayClass55_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v3, 0);
  pieceData = this->fields.pieceData;
  if ( !pieceData || (pieceData = (WarBoardPieceData_o *)WarBoardPieceData__HasIconDarkenBuff(pieceData, 0), !v3) )
    sub_1D0F30C(pieceData, v4);
  *(_BYTE *)(v3 + 16) = (unsigned __int8)pieceData & 1;
  ...
  {
    v7 = (System_Action_object__o *)sub_1D0F300(System_Action_UIWidget__TypeInfo);
    ...
    BasicHelper__ForEach_object_(
      ...
      (const MethodInfo_323AF0C *)Method_BasicHelper_ForEach_UIWidget___);
  }
  ...
  {
    v9 = (System_Action_object__o *)sub_1D0F300(System_Action_UIWidget__TypeInfo);
    System_Action_object____ctor(
      v9,
      (Il2CppObject *)v3,
