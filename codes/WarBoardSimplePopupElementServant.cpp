        ...
        const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.positionActionPointDefault.fields.x = xmmword_BAAAD0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1DA3B & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_WarBoardSimplePopupElementServant_OnClickDetailButton__, v3);
    byte_4A1DA3B = 1;
  }
  ...
  if ( (*((_BYTE *)Method_WarBoardSimplePopupElementServant_OnClickDetailButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1B715E4(Method_WarBoardSimplePopupElementServant_OnClickDetailButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1DA37 & 1) == 0 )
  {
    sub_1B715CC(&int_TypeInfo, *(_QWORD *)&atk);
    sub_1B715CC(&LocalizationManager_TypeInfo, v8);
    sub_1B715CC(&StringLiteral_15383/*"WARBOARD_SERVANT_INFO_ENEMY_ATK"*/, v9);
    sub_1B715CC(&StringLiteral_24874/*"{0:#,0}"*/, v10);
    byte_4A1DA37 = 1;
  }
  ...
  if ( isPlayerGroup )
  {
    ...
    v13 = System_String__Format((System_String_o *)StringLiteral_24874/*"{0:#,0}"*/, v12, 0LL);
    if ( atkValueLabel )
    {
...
LABEL_10:
  ...
  v13 = LocalizationManager__Get((System_String_o *)StringLiteral_15383/*"WARBOARD_SERVANT_INFO_ENEMY_ATK"*/, 0LL);
  if ( !atkValueLabel )
    goto LABEL_10;
  UILabel__set_text(atkValueLabel, v13, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1DA39 & 1) == 0 )
  {
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponent_WarBoardBreakPointComponent___, *(_QWORD *)&breakPoint);
    sub_1B715CC(&Method_UnityEngine_Object_Instantiate_GameObject____75933272, v9);
    sub_1B715CC(&UnityEngine_Object_TypeInfo, v10);
    sub_1B715CC(&WarBoardBreakPointComponent___TypeInfo, v11);
    byte_4A1DA39 = 1;
  }
  v12 = (UnityEngine_GameObject_o *)sub_1B71674(WarBoardBreakPointComponent___TypeInfo, (unsigned int)breakPointMax);
  ...
  if ( breakPointMax >= 1 )
  {
    ...
    do
    {
      ...
      v12 = (UnityEngine_GameObject_o *)UnityEngine_Object__Instantiate_object__49146012(
                                          breakPointPrefab,
                                          transform,
      ...
      Component_object = (WarBoardBreakPointComponent_o *)UnityEngine_GameObject__GetComponent_object_(
                                                            v27,
                                                            (const MethodInfo_2EAA998 *)Method_UnityEngine_GameObject_GetComponent_WarBoardBreakPointComponent___);
      ...
      if ( !v15 )
        break;
      v30 = sub_1B71708(Component_object, *(_QWORD *)(*(_QWORD *)v15 + 64LL));
      if ( !v30 )
      {
        v34 = sub_1B7184C(0LL);
        sub_1B716F4(v34, 0LL);
      ...
      if ( v17 >= v15[6]
        || (p_monitor[v17] = Component_object,
            sub_1B71570((ServantStatusBattleListViewItem_o *)&p_monitor[v16], (int32_t)Component_object, v31, v32),
            v17 >= v15[6]) )
      {
        sub_1B71830(v30, v13);
      }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1DA38 & 1) == 0 )
  {
    sub_1B715CC(&UnityEngine_Object_TypeInfo, buffData);
    byte_4A1DA38 = 1;
  }
  ...
  if ( buffData && !v6 )
  {
    ...
    if ( !v7 )
      sub_1B71828(ShowServantParam, v9);
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_24:
    sub_1B71828(hpLabel, *(_QWORD *)&dispType);
  }
  if ( posSkillRoot->max_length <= dispType )
LABEL_25:
    sub_1B71830(hpLabel, *(_QWORD *)&dispType);
  GameObjectExtensions__SetLocalPosition(
    (UnityEngine_GameObject_o *)hpLabel,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1DA34 & 1) == 0 )
  {
    sub_1B715CC(&AtlasManager_TypeInfo, pieceData);
    ...
    sub_1B715CC(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__, v13);
    sub_1B715CC(&StringLiteral_15352/*"WARBOARD_INFO_POPUP_SVT_HP"*/, v14);
    sub_1B715CC(&StringLiteral_20136/*"icon_strong_enemy"*/, v15);
    sub_1B715CC(&StringLiteral_22668/*"questinfo_enemyface_bg"*/, v16);
    sub_1B715CC(&StringLiteral_19926/*"hp_gauge_boss"*/, v17);
    sub_1B715CC(&StringLiteral_23060/*"servant_base_{0}"*/, v18);
    sub_1B715CC(&StringLiteral_15351/*"WARBOARD_INFO_POPUP_SVT_DETAIL_BUTTON"*/, v19);
    sub_1B715CC(&StringLiteral_15350/*"WARBOARD_INFO_POPUP_SVT_ATK"*/, v20);
    sub_1B715CC(&StringLiteral_15348/*"WARBOARD_INFO_POPUP_SVT_ACTION_POINT"*/, v21);
    sub_1B715CC(&StringLiteral_15353/*"WARBOARD_INFO_POPUP_SVT_LV"*/, v22);
    sub_1B715CC(&StringLiteral_24876/*"{0:#,0} / {1:#,0}"*/, v23);
    this = (WarBoardSimplePopupElementServant_o *)sub_1B715CC(&StringLiteral_15349/*"WARBOARD_INFO_POPUP_SVT_ACTION_POINT_COST"*/, v24);
    byte_4A1DA34 = 1;
  }
  entity = 0LL;
  v148 = 0LL;
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&v4->fields.pieceData, (int32_t)v3, v25, v26);
  battleServant_k__BackingField = v3->fields._battleServant_k__BackingField;
  atkLabel = v4->fields.atkLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  this = (WarBoardSimplePopupElementServant_o *)LocalizationManager__Get((System_String_o *)StringLiteral_15350/*"WARBOARD_INFO_POPUP_SVT_ATK"*/, 0LL);
  if ( !atkLabel )
    goto LABEL_165;
  UILabel__set_text(atkLabel, (System_String_o *)this, 0LL);
  hpLabel = v4->fields.hpLabel;
  this = (WarBoardSimplePopupElementServant_o *)LocalizationManager__Get((System_String_o *)StringLiteral_15352/*"WARBOARD_INFO_POPUP_SVT_HP"*/, 0LL);
  if ( !hpLabel )
    goto LABEL_165;
  UILabel__set_text(hpLabel, (System_String_o *)this, 0LL);
  detailButtonLabel = v4->fields.detailButtonLabel;
  this = (WarBoardSimplePopupElementServant_o *)LocalizationManager__Get((System_String_o *)StringLiteral_15351/*"WARBOARD_INFO_POPUP_SVT_DETAIL_BUTTON"*/, 0LL);
  ...
  if ( UnityEngine_Object__op_Inequality(servantLevel, 0LL, 0LL) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v35 = LocalizationManager__Get((System_String_o *)StringLiteral_15353/*"WARBOARD_INFO_POPUP_SVT_LV"*/, 0LL);
  ...
  this = (WarBoardSimplePopupElementServant_o *)System_String__Format_61519876(
                                                  (System_String_o *)StringLiteral_24876/*"{0:#,0} / {1:#,0}"*/,
                                                  v48,
                                                  v52,
                                                  0LL);
  if ( !hpValueLabel )
  ...
  {
    this = (WarBoardSimplePopupElementServant_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    if ( !this )
      goto LABEL_165;
  ...
  this = (WarBoardSimplePopupElementServant_o *)System_String__Format((System_String_o *)StringLiteral_23060/*"servant_base_{0}"*/, v66, 0LL);
  if ( !frameSprite )
    goto LABEL_165;
    ...
    if ( UnityEngine_Object__op_Inequality(actionPointValueLabel, 0LL, 0LL) )
    {
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        ...
        this = (WarBoardSimplePopupElementServant_o *)System_String__Format(
                                                        (System_String_o *)StringLiteral_23060/*"servant_base_{0}"*/,
                                                        v76,
                                                        0LL);
        if ( !v72 )
          goto LABEL_165;
        ...
        this = (WarBoardSimplePopupElementServant_o *)LocalizationManager__Get(
                                                        (System_String_o *)StringLiteral_15348/*"WARBOARD_INFO_POPUP_SVT_ACTION_POINT"*/,
                                                        0LL);
        if ( !actionPointLabel )
          goto LABEL_165;
        ...
        v82 = LocalizationManager__Get((System_String_o *)StringLiteral_15349/*"WARBOARD_INFO_POPUP_SVT_ACTION_POINT_COST"*/, 0LL);
        MaxHp = v78;
        ...
        this = (WarBoardSimplePopupElementServant_o *)System_String__Format_61519876(v82, v86, v90, 0LL);
        if ( !costDispLabel )
          goto LABEL_165;
  ...
  this = (WarBoardSimplePopupElementServant_o *)DataManager__GetMaster_object_((const MethodInfo_2E5B394 *)Method_DataManager_GetMaster_ServantLimitImageMaster___);
  if ( !this )
    goto LABEL_165;
...
LABEL_93:
    ...
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    if ( AtlasManager__SetEventUI_37654552(posAtkValueLabel, enemyIcon, v115, 0LL) )
      goto LABEL_100;
    v116 = (UISprite_o *)v4->fields.enemyIcon;
    v117 = System_Int32__ToString((int32_t)&v148 + 4, 0LL);
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    if ( AtlasManager__SetEventUI_37654552(posAtkValueLabel, v116, v117, 0LL) )
LABEL_100:
      WarBoardPieceData__ApplyDisplayType(v3, v4->fields.enemyIcon, 0LL);
    enemyIconBg = v4->fields.enemyIconBg;
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetEventUI_37654552(posAtkValueLabel, enemyIconBg, (System_String_o *)StringLiteral_22668/*"questinfo_enemyface_bg"*/, 0LL);
    v103 = 0;
  }
  else
  {
  ...
  if ( UnityEngine_Object__op_Inequality(equipIcon, 0LL, 0LL) )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(equipLimitCountSprite, 0LL, 0LL) )
    {
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      this = (WarBoardSimplePopupElementServant_o *)DataManager__GetMaster_object_((const MethodInfo_2E5B394 *)Method_DataManager_GetMaster_ServantMaster___);
      if ( !this )
        goto LABEL_165;
...
LABEL_130:
  ...
  if ( WarBoardPieceData__get_isEnemyServant(v3, 0LL) )
  {
    ...
    if ( !this )
      goto LABEL_165;
    UISprite__set_spriteName((UISprite_o *)this, (System_String_o *)StringLiteral_19926/*"hp_gauge_boss"*/, 0LL);
  }
  hpBar = (UIBasicSprite_o *)v4->fields.hpBar;
  CurrentHpProgress = WarBoardPieceData__get_CurrentHpProgress(v3, 0LL);
  if ( !hpBar )
LABEL_165:
    sub_1B71828(this, pieceData);
    ...
    if ( v143 )
    {
      if ( v143->fields.isEnemy && v3->fields._roleType_k__BackingField == 1 )
      {
        ...
        if ( this )
        {
          ...
          if ( this )
          {
            UISprite__set_spriteName((UISprite_o *)this, (System_String_o *)StringLiteral_20136/*"icon_strong_enemy"*/, 0LL);
            this = (WarBoardSimplePopupElementServant_o *)v4->fields.RoleTypeLabel;
            if ( this )
            {
              UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)this, 1, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1DA35 & 1) == 0 )
  {
    sub_1B715CC(&System_Action_UIWidget__TypeInfo, method);
    sub_1B715CC(&Method_BasicHelper_ForEach_UIWidget___, v3);
    sub_1B715CC(
    ...
    sub_1B715CC(
      ...
      v5);
    sub_1B715CC(&WarBoardSimplePopupElementServant___c__DisplayClass55_0_TypeInfo, v6);
    byte_4A1DA35 = 1;
  }
  v7 = sub_1B71818(WarBoardSimplePopupElementServant___c__DisplayClass55_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v7, 0LL);
  pieceData = this->fields.pieceData;
  if ( !pieceData || (pieceData = (WarBoardPieceData_o *)WarBoardPieceData__HasIconDarkenBuff(pieceData, 0LL), !v7) )
    sub_1B71828(pieceData, v8);
  *(_BYTE *)(v7 + 16) = (unsigned __int8)pieceData & 1;
  ...
  {
    v11 = (System_Action_object__o *)sub_1B71818(System_Action_UIWidget__TypeInfo);
    ...
    BasicHelper__ForEach_object_(
      ...
      (const MethodInfo_2E487A0 *)Method_BasicHelper_ForEach_UIWidget___);
  }
  ...
  {
    v13 = (System_Action_object__o *)sub_1B71818(System_Action_UIWidget__TypeInfo);
    System_Action_object____ctor(
      v13,
      (Il2CppObject *)v7,
      Method_WarBoardSimplePopupElementServant___c__DisplayClass55_0__UpdateUiBrightnessByPieceStatus_b__1__,
