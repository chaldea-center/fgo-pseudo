        ...
        const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.positionActionPointDefault.fields.x = xmmword_BA31D0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FCAAF & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_WarBoardSimplePopupElementServant_OnClickDetailButton__, v3);
    byte_49FCAAF = 1;
  }
  ...
  if ( (*((_BYTE *)Method_WarBoardSimplePopupElementServant_OnClickDetailButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1B64A18(Method_WarBoardSimplePopupElementServant_OnClickDetailButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FCAAB & 1) == 0 )
  {
    sub_1B64A00(&int_TypeInfo, *(_QWORD *)&atk);
    sub_1B64A00(&LocalizationManager_TypeInfo, v8);
    sub_1B64A00(&StringLiteral_15368/*"WARBOARD_SERVANT_INFO_ENEMY_ATK"*/, v9);
    sub_1B64A00(&StringLiteral_24838/*"{0:#,0}"*/, v10);
    byte_49FCAAB = 1;
  }
...
LABEL_10:
  ...
  v13 = LocalizationManager__Get((System_String_o *)StringLiteral_15368/*"WARBOARD_SERVANT_INFO_ENEMY_ATK"*/, 0LL);
  if ( !atkValueLabel )
    goto LABEL_10;
  UILabel__set_text(atkValueLabel, v13, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FCAAD & 1) == 0 )
  {
    sub_1B64A00(&Method_UnityEngine_GameObject_GetComponent_WarBoardBreakPointComponent___, *(_QWORD *)&breakPoint);
  ...
  v12 = (UnityEngine_GameObject_o *)sub_1B64AA8(WarBoardBreakPointComponent___TypeInfo, (unsigned int)breakPointMax);
  ...
  if ( breakPointMax >= 1 )
  {
    ...
    do
    {
      ...
      v12 = (UnityEngine_GameObject_o *)UnityEngine_Object__Instantiate_object__49014464(
                                          breakPointPrefab,
                                          transform,
      ...
      if ( !v15 )
        break;
      v30 = sub_1B64B3C(Component_object, *(_QWORD *)(*(_QWORD *)v15 + 64LL));
      if ( !v30 )
      {
        v34 = sub_1B64C80(0LL);
        sub_1B64B28(v34, 0LL);
      ...
      if ( v17 >= v15[6]
        || (p_monitor[v17] = Component_object,
            sub_1B649A4((ServantStatusBattleListViewItem_o *)&p_monitor[v16], (int32_t)Component_object, v31, v32),
            v17 >= v15[6]) )
      {
        sub_1B64C64(v30, v13);
      }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FCAAC & 1) == 0 )
  {
    sub_1B64A00(&UnityEngine_Object_TypeInfo, buffData);
    byte_49FCAAC = 1;
  }
  ...
  if ( buffData && !v6 )
  {
    ...
    if ( !v7 )
      sub_1B64C5C(ShowServantParam, v9);
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_24:
    sub_1B64C5C(hpLabel, *(_QWORD *)&dispType);
  }
  if ( posSkillRoot->max_length <= dispType )
LABEL_25:
    sub_1B64C64(hpLabel, *(_QWORD *)&dispType);
  GameObjectExtensions__SetLocalPosition(
    (UnityEngine_GameObject_o *)hpLabel,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FCAA8 & 1) == 0 )
  {
    sub_1B64A00(&AtlasManager_TypeInfo, pieceData);
    ...
    sub_1B64A00(&StringLiteral_15337/*"WARBOARD_INFO_POPUP_SVT_HP"*/, v14);
    sub_1B64A00(&StringLiteral_20111/*"icon_strong_enemy"*/, v15);
    sub_1B64A00(&StringLiteral_22634/*"questinfo_enemyface_bg"*/, v16);
    sub_1B64A00(&StringLiteral_19901/*"hp_gauge_boss"*/, v17);
    sub_1B64A00(&StringLiteral_23024/*"servant_base_{0}"*/, v18);
    sub_1B64A00(&StringLiteral_15336/*"WARBOARD_INFO_POPUP_SVT_DETAIL_BUTTON"*/, v19);
    sub_1B64A00(&StringLiteral_15335/*"WARBOARD_INFO_POPUP_SVT_ATK"*/, v20);
    sub_1B64A00(&StringLiteral_15333/*"WARBOARD_INFO_POPUP_SVT_ACTION_POINT"*/, v21);
    sub_1B64A00(&StringLiteral_15338/*"WARBOARD_INFO_POPUP_SVT_LV"*/, v22);
    sub_1B64A00(&StringLiteral_24840/*"{0:#,0} / {1:#,0}"*/, v23);
    this = (WarBoardSimplePopupElementServant_o *)sub_1B64A00(&StringLiteral_15334/*"WARBOARD_INFO_POPUP_SVT_ACTION_POINT_COST"*/, v24);
    byte_49FCAA8 = 1;
  }
  entity = 0LL;
  v148 = 0LL;
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&v4->fields.pieceData, (int32_t)v3, v25, v26);
  battleServant_k__BackingField = v3->fields._battleServant_k__BackingField;
  atkLabel = v4->fields.atkLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  this = (WarBoardSimplePopupElementServant_o *)LocalizationManager__Get((System_String_o *)StringLiteral_15335/*"WARBOARD_INFO_POPUP_SVT_ATK"*/, 0LL);
  if ( !atkLabel )
    goto LABEL_165;
  UILabel__set_text(atkLabel, (System_String_o *)this, 0LL);
  hpLabel = v4->fields.hpLabel;
  this = (WarBoardSimplePopupElementServant_o *)LocalizationManager__Get((System_String_o *)StringLiteral_15337/*"WARBOARD_INFO_POPUP_SVT_HP"*/, 0LL);
  if ( !hpLabel )
    goto LABEL_165;
  UILabel__set_text(hpLabel, (System_String_o *)this, 0LL);
  detailButtonLabel = v4->fields.detailButtonLabel;
  this = (WarBoardSimplePopupElementServant_o *)LocalizationManager__Get((System_String_o *)StringLiteral_15336/*"WARBOARD_INFO_POPUP_SVT_DETAIL_BUTTON"*/, 0LL);
  ...
  if ( UnityEngine_Object__op_Inequality(servantLevel, 0LL, 0LL) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v35 = LocalizationManager__Get((System_String_o *)StringLiteral_15338/*"WARBOARD_INFO_POPUP_SVT_LV"*/, 0LL);
  ...
  this = (WarBoardSimplePopupElementServant_o *)System_String__Format_61399508(
  ...
  {
    this = (WarBoardSimplePopupElementServant_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE930 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    if ( !this )
      goto LABEL_165;
    ...
    if ( UnityEngine_Object__op_Inequality(actionPointValueLabel, 0LL, 0LL) )
    {
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        ...
        this = (WarBoardSimplePopupElementServant_o *)LocalizationManager__Get(
                                                        (System_String_o *)StringLiteral_15333/*"WARBOARD_INFO_POPUP_SVT_ACTION_POINT"*/,
                                                        0LL);
        if ( !actionPointLabel )
          goto LABEL_165;
        ...
        v82 = LocalizationManager__Get((System_String_o *)StringLiteral_15334/*"WARBOARD_INFO_POPUP_SVT_ACTION_POINT_COST"*/, 0LL);
        MaxHp = v78;
        ...
        this = (WarBoardSimplePopupElementServant_o *)System_String__Format_61399508(v82, v86, v90, 0LL);
        if ( !costDispLabel )
          goto LABEL_165;
  ...
  this = (WarBoardSimplePopupElementServant_o *)DataManager__GetMaster_object_((const MethodInfo_2E3BC8C *)Method_DataManager_GetMaster_ServantLimitImageMaster___);
  if ( !this )
    goto LABEL_165;
...
LABEL_93:
    ...
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    if ( AtlasManager__SetEventUI_37549424(posAtkValueLabel, enemyIcon, v115, 0LL) )
      goto LABEL_100;
    v116 = (UISprite_o *)v4->fields.enemyIcon;
    v117 = System_Int32__ToString((int32_t)&v148 + 4, 0LL);
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    if ( AtlasManager__SetEventUI_37549424(posAtkValueLabel, v116, v117, 0LL) )
LABEL_100:
      WarBoardPieceData__ApplyDisplayType(v3, v4->fields.enemyIcon, 0LL);
    enemyIconBg = v4->fields.enemyIconBg;
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetEventUI_37549424(posAtkValueLabel, enemyIconBg, (System_String_o *)StringLiteral_22634/*"questinfo_enemyface_bg"*/, 0LL);
    v103 = 0;
  }
  else
  {
  ...
  if ( UnityEngine_Object__op_Inequality(equipIcon, 0LL, 0LL) )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(equipLimitCountSprite, 0LL, 0LL) )
    {
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      this = (WarBoardSimplePopupElementServant_o *)DataManager__GetMaster_object_((const MethodInfo_2E3BC8C *)Method_DataManager_GetMaster_ServantMaster___);
      if ( !this )
        goto LABEL_165;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FCAA9 & 1) == 0 )
  {
    ...
    sub_1B64A00(
      ...
      v5);
    sub_1B64A00(&WarBoardSimplePopupElementServant___c__DisplayClass55_0_TypeInfo, v6);
    byte_49FCAA9 = 1;
  }
  v7 = sub_1B64C4C(WarBoardSimplePopupElementServant___c__DisplayClass55_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v7, 0LL);
  pieceData = this->fields.pieceData;
  if ( !pieceData || (pieceData = (WarBoardPieceData_o *)WarBoardPieceData__HasIconDarkenBuff(pieceData, 0LL), !v7) )
    sub_1B64C5C(pieceData, v8);
  *(_BYTE *)(v7 + 16) = (unsigned __int8)pieceData & 1;
  ...
  {
    v11 = (System_Action_object__o *)sub_1B64C4C(System_Action_UIWidget__TypeInfo);
  ...
  {
    v13 = (System_Action_object__o *)sub_1B64C4C(System_Action_UIWidget__TypeInfo);
    System_Action_object____ctor(
      v13,
      (Il2CppObject *)v7,
      Method_WarBoardSimplePopupElementServant___c__DisplayClass55_0__UpdateUiBrightnessByPieceStatus_b__1__,
