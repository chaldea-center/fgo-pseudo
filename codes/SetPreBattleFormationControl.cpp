...
void SetPreBattleFormationControl__Init(SetPreBattleFormationControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB12CF & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_9672/*"OPTION_PREBATTLEFORMATION_DISP"*/);
    sub_1C6BA08(&StringLiteral_9673/*"OPTION_PREBATTLEFORMATION_INFO"*/);
    byte_4CB12CF = 1;
  }
  infoLabel = this->fields.infoLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9673/*"OPTION_PREBATTLEFORMATION_INFO"*/, 0);
  if ( !infoLabel
    || (UILabel__set_text(infoLabel, v4, 0),
        btnTitle = this->fields.btnTitle,
        v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9672/*"OPTION_PREBATTLEFORMATION_DISP"*/, 0),
        !btnTitle) )
  {
    sub_1C6BC60(v4, v5);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB12D2 & 1) == 0 )
  {
    sub_1C6BA08(&Method_SetPreBattleFormationControl_OnClickPreBattleFormation__);
    byte_4CB12D2 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetPreBattleFormationControl_OnClickPreBattleFormation__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C6BA20(Method_SetPreBattleFormationControl_OnClickPreBattleFormation__);
