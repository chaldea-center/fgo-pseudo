...
void __fastcall SetPreBattleFormationControl__Init(SetPreBattleFormationControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD78A8 & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_9867/*"OPTION_PREBATTLEFORMATION_DISP"*/);
    sub_1C21E38(&StringLiteral_9868/*"OPTION_PREBATTLEFORMATION_INFO"*/);
    byte_4BD78A8 = 1;
  }
  infoLabel = this->fields.infoLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9868/*"OPTION_PREBATTLEFORMATION_INFO"*/, 0LL);
  if ( !infoLabel
    || (UILabel__set_text(infoLabel, v4, 0LL),
        btnTitle = this->fields.btnTitle,
        v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9867/*"OPTION_PREBATTLEFORMATION_DISP"*/, 0LL),
        !btnTitle) )
  {
    sub_1C22094(v4, v5);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD78AB & 1) == 0 )
  {
    sub_1C21E38(&Method_SetPreBattleFormationControl_OnClickPreBattleFormation__);
    byte_4BD78AB = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetPreBattleFormationControl_OnClickPreBattleFormation__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C21E50(Method_SetPreBattleFormationControl_OnClickPreBattleFormation__);
