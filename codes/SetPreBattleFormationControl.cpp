...
void SetPreBattleFormationControl__Init(SetPreBattleFormationControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2B881 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_9731/*"OPTION_PREBATTLEFORMATION_DISP"*/);
    sub_1C93AD4(&StringLiteral_9732/*"OPTION_PREBATTLEFORMATION_INFO"*/);
    byte_4D2B881 = 1;
  }
  infoLabel = this->fields.infoLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9732/*"OPTION_PREBATTLEFORMATION_INFO"*/, 0);
  if ( !infoLabel
    || (UILabel__set_text(infoLabel, v4, 0),
        btnTitle = this->fields.btnTitle,
        v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9731/*"OPTION_PREBATTLEFORMATION_DISP"*/, 0),
        !btnTitle) )
  {
    sub_1C93D2C(v4, v5);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2B884 & 1) == 0 )
  {
    sub_1C93AD4(&Method_SetPreBattleFormationControl_OnClickPreBattleFormation__);
    byte_4D2B884 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetPreBattleFormationControl_OnClickPreBattleFormation__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C93AEC(Method_SetPreBattleFormationControl_OnClickPreBattleFormation__);
