...
void __fastcall SetPreBattleFormationControl__Init(SetPreBattleFormationControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A56711 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_9670/*"OPTION_PREBATTLEFORMATION_DISP"*/);
    sub_1B885B0(&StringLiteral_9671/*"OPTION_PREBATTLEFORMATION_INFO"*/);
    byte_4A56711 = 1;
  }
  infoLabel = this->fields.infoLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9671/*"OPTION_PREBATTLEFORMATION_INFO"*/, 0LL);
  if ( !infoLabel
    || (UILabel__set_text(infoLabel, v4, 0LL),
        btnTitle = this->fields.btnTitle,
        v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9670/*"OPTION_PREBATTLEFORMATION_DISP"*/, 0LL),
        !btnTitle) )
  {
    sub_1B8880C(v4, v5);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A56714 & 1) == 0 )
  {
    sub_1B885B0(&Method_SetPreBattleFormationControl_OnClickPreBattleFormation__);
    byte_4A56714 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetPreBattleFormationControl_OnClickPreBattleFormation__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B885C8(Method_SetPreBattleFormationControl_OnClickPreBattleFormation__);
