...
void SetPreBattleFormationControl__Init(SetPreBattleFormationControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CE95B0 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_9701/*"OPTION_PREBATTLEFORMATION_DISP"*/);
    sub_1C7BAE8(&StringLiteral_9702/*"OPTION_PREBATTLEFORMATION_INFO"*/);
    byte_4CE95B0 = 1;
  }
  infoLabel = this->fields.infoLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9702/*"OPTION_PREBATTLEFORMATION_INFO"*/, 0);
  if ( !infoLabel
    || (UILabel__set_text(infoLabel, v4, 0),
        btnTitle = this->fields.btnTitle,
        v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9701/*"OPTION_PREBATTLEFORMATION_DISP"*/, 0),
        !btnTitle) )
  {
    sub_1C7BD40(v4, v5);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CE95B3 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_SetPreBattleFormationControl_OnClickPreBattleFormation__);
    byte_4CE95B3 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetPreBattleFormationControl_OnClickPreBattleFormation__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C7BB00(Method_SetPreBattleFormationControl_OnClickPreBattleFormation__);
