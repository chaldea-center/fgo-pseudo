...
void __fastcall SetPreBattleFormationControl__Init(SetPreBattleFormationControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49F7A51 & 1) == 0 )
  {
    ...
    sub_1B640C8(&StringLiteral_9625/*"OPTION_PREBATTLEFORMATION_DISP"*/, v4);
    sub_1B640C8(&StringLiteral_9626/*"OPTION_PREBATTLEFORMATION_INFO"*/, v5);
    byte_49F7A51 = 1;
  }
  infoLabel = this->fields.infoLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v7 = LocalizationManager__Get((System_String_o *)StringLiteral_9626/*"OPTION_PREBATTLEFORMATION_INFO"*/, 0LL);
  if ( !infoLabel
    || (UILabel__set_text(infoLabel, v7, 0LL),
        btnTitle = this->fields.btnTitle,
        v7 = LocalizationManager__Get((System_String_o *)StringLiteral_9625/*"OPTION_PREBATTLEFORMATION_DISP"*/, 0LL),
        !btnTitle) )
  {
    sub_1B64324(v7);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F7A54 & 1) == 0 )
  {
    sub_1B640C8(&Method_SetPreBattleFormationControl_OnClickPreBattleFormation__, method);
    byte_49F7A54 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetPreBattleFormationControl_OnClickPreBattleFormation__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B640E0(Method_SetPreBattleFormationControl_OnClickPreBattleFormation__);
