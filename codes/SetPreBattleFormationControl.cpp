...
void __fastcall SetPreBattleFormationControl__Init(SetPreBattleFormationControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B325EC & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_9817/*"OPTION_PREBATTLEFORMATION_DISP"*/, v4);
    sub_1BD3458(&StringLiteral_9818/*"OPTION_PREBATTLEFORMATION_INFO"*/, v5);
    byte_4B325EC = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B325EF & 1) == 0 )
  {
    sub_1BD3458(&Method_SetPreBattleFormationControl_OnClickPreBattleFormation__, method);
    byte_4B325EF = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetPreBattleFormationControl_OnClickPreBattleFormation__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1BD3470(Method_SetPreBattleFormationControl_OnClickPreBattleFormation__);
