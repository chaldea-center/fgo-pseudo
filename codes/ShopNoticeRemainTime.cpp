        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields, (int32_t)monoBehaviour, v5, v6);
}
...
LABEL_10:
    sub_1BDBAD4(mostRecentTimeLimits, method);
  v6 = 0;
  while ( 1 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B40DF7 & 1) == 0 )
  {
    sub_1BDB878(&ShopNoticeRemainTime__ExecuteEverySecondLoop_d__12_TypeInfo, method);
    byte_4B40DF7 = 1;
  }
  v3 = sub_1BDBAC4(ShopNoticeRemainTime__ExecuteEverySecondLoop_d__12_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.onTimeUpAction, (int32_t)onTimeUpAction, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B40DF6 & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Collections_Generic_List_long__Add__, shopNotice);
  ...
  if ( !mostRecentTimeLimits )
  {
    ...
    sub_1BDB81C(p_mostRecentTimeLimits, (int32_t)v11, v12, v13);
...
void __fastcall ShopNoticeRemainTime__Start(ShopNoticeRemainTime_o *this, const MethodInfo *method)
{
  ...
  if ( !monoBehaviour )
    sub_1BDBAD4(v5, v6);
  started = UnityEngine_MonoBehaviour__StartCoroutine_70269772(monoBehaviour, v5, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B40DF9 & 1) == 0 )
  {
    ...
    this = (ShopNoticeRemainTime__ExecuteEverySecondLoop_d__12_o *)sub_1BDB878(&UnityEngine_WaitForSeconds_TypeInfo, v3);
    byte_4B40DF9 = 1;
  }
  ...
  if ( !_1__state )
  {
    ...
    sub_1BDB81C((CGThumbnailListItem_o *)&v2->fields._loopWait_5__2, (int32_t)v11, v12, v13);
    if ( _4__this )
      goto LABEL_11;
LABEL_14:
...
LABEL_11:
  if ( _4__this->fields.isLoop )
  {
    ...
    sub_1BDB81C(p__2__current, (int32_t)loopWait_5__2, v6, v7);
    result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BDB88C(&Method_ShopNoticeRemainTime__ExecuteEverySecondLoop_d__12_System_Collections_IEnumerator_Reset__);
  sub_1BDB9A0(v3, v4);
}
