        ...
        const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)monoBehaviour, v5, v6);
}
...
LABEL_10:
    sub_1B8880C(mostRecentTimeLimits, method);
  v4 = 0;
  while ( 1 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A577DC & 1) == 0 )
  {
    sub_1B885B0(&ShopNoticeRemainTime__ExecuteEverySecondLoop_d__12_TypeInfo);
    byte_4A577DC = 1;
  }
  v3 = sub_1B887FC(ShopNoticeRemainTime__ExecuteEverySecondLoop_d__12_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( !mostRecentTimeLimits )
  {
    ...
    p_mostRecentTimeLimits->klass = (ServantStatusBattleListViewItem_c *)v8;
    sub_1B88554(p_mostRecentTimeLimits, (int32_t)v8, v9, v10);
...
void __fastcall ShopNoticeRemainTime__Start(ShopNoticeRemainTime_o *this, const MethodInfo *method)
{
  ...
  if ( !monoBehaviour )
    sub_1B8880C(v5, v6);
  started = UnityEngine_MonoBehaviour__StartCoroutine_69444652(monoBehaviour, v5, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B885B0(&Method_System_Collections_Generic_List_long__Clear__);
    this = (ShopNoticeRemainTime__ExecuteEverySecondLoop_d__12_o *)sub_1B885B0(&UnityEngine_WaitForSeconds_TypeInfo);
    byte_4A577DE = 1;
  }
  ...
  if ( !_1__state )
  {
    ...
    v10 = (UnityEngine_WaitForSeconds_o *)sub_1B887FC(UnityEngine_WaitForSeconds_TypeInfo);
    UnityEngine_WaitForSeconds___ctor(v10, 1.0, 0LL);
    v2->fields._loopWait_5__2 = v10;
    sub_1B88554((ServantStatusBattleListViewItem_o *)&v2->fields._loopWait_5__2, (int32_t)v10, v11, v12);
    if ( _4__this )
      goto LABEL_11;
LABEL_14:
...
LABEL_11:
  if ( _4__this->fields.isLoop )
  {
    ...
    sub_1B88554(p__2__current, (int32_t)loopWait_5__2, v5, v6);
    result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B885C4(&Method_ShopNoticeRemainTime__ExecuteEverySecondLoop_d__12_System_Collections_IEnumerator_Reset__);
  sub_1B886D8(v3, v4);
}
