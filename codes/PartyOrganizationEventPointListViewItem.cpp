        ...
        const MethodInfo *method)
{
  ...
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.titleName, (int32_t)titleName, v10, v11, v12, v13, v14, v15);
  this->fields.isFollower = v9;
  this->fields.displayValueType = displayValueType;
}


void PartyOrganizationEventPointListViewItem___ctor_34620764(
        PartyOrganizationEventPointListViewItem_o *this,
        int32_t index,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CE9F7F & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_10263/*"PARTY_ORGANIZATION_EVENT_MEMBER_OFFSET"*/);
    byte_4CE9F7F = 1;
  }
  ...
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_10263/*"PARTY_ORGANIZATION_EVENT_MEMBER_OFFSET"*/, 0);
  return System_String__Concat_64215176(ColorString, EventUpString, v9, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CE9F7E & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_10267/*"PARTY_ORGANIZATION_EVENT_PARTY_SUM"*/);
    sub_1C7BAE8(&StringLiteral_1/*""*/);
  ...
  if ( !this->fields.margeItemInfo
    || (v10 = ColorString,
        ...
        ColorString = System_String__Concat_64176912(v10, NameTitleString, 0),
  ...
  v16 = System_String__Format_64218288(v12, v13, v14, TargetString, 0);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v19 = LocalizationManager__Get((System_String_o *)StringLiteral_10267/*"PARTY_ORGANIZATION_EVENT_PARTY_SUM"*/, 0);
  return System_String__Concat_64176912(v18, v19, 0);
}
