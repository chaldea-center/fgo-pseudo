        ...
        const MethodInfo *method)
{
  ...
  sub_1C13CC8(&this->fields.titleName);
  this->fields.isFollower = v9;
  this->fields.displayValueType = displayValueType;
}


void __fastcall PartyOrganizationEventPointListViewItem___ctor_32918408(
        PartyOrganizationEventPointListViewItem_o *this,
        int32_t index,
        ...
        const MethodInfo *method)
{
  ...
  sub_1C13CC8(&this->fields.margeItemInfo);
  this->fields.displayValueType = displayValueType;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB038B & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_10437/*"PARTY_ORGANIZATION_DECK_SELECT_NAME"*/, v4);
    byte_4BB038B = 1;
  }
  ...
  v11 = LocalizationManager__Get((System_String_o *)StringLiteral_10437/*"PARTY_ORGANIZATION_DECK_SELECT_NAME"*/, 0LL);
  return System_String__Concat_62979204(ColorString, EventUpString, v11, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB038A & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_10441/*"PARTY_ORGANIZATION_EVENT_MEMBER_MESSAGE_EMPTY"*/, v4);
    sub_1C13D24(&StringLiteral_1/*""*/, v5);
    sub_1C13D24(&StringLiteral_10433/*"PARTY_ORGANIZATION_DECIDE_WARNING_TITLE_COST_OVER"*/, v6);
    byte_4BB038A = 1;
  }
  if ( this->fields.titleName )
  {
    if ( this->fields.isFollower )
      v7 = (System_String_o **)&StringLiteral_10439/*"PARTY_ORGANIZATION_EVENT_MEMBER"*/;
    else
      v7 = (System_String_o **)&StringLiteral_10433/*"PARTY_ORGANIZATION_DECIDE_WARNING_TITLE_COST_OVER"*/;
    v8 = *v7;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  ...
  if ( !this->fields.margeItemInfo
    || (v14 = ColorString,
        ...
        ColorString = System_String__Concat_62967944(v14, NameTitleString, 0LL),
  ...
  v20 = System_String__Format_62982384(v16, v17, v18, TargetString, 0LL);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v23 = LocalizationManager__Get((System_String_o *)StringLiteral_10441/*"PARTY_ORGANIZATION_EVENT_MEMBER_MESSAGE_EMPTY"*/, 0LL);
  return System_String__Concat_62967944(v22, v23, 0LL);
}
