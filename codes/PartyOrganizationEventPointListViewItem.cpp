        ...
        const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.titleName, (int32_t)titleName, v10, v11);
  this->fields.isFollower = v9;
  this->fields.displayValueType = displayValueType;
}


void __fastcall PartyOrganizationEventPointListViewItem___ctor_32033304(
        PartyOrganizationEventPointListViewItem_o *this,
        int32_t index,
        ...
        const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.margeItemInfo, (int32_t)margeItemInfo, v8, v9);
  this->fields.displayValueType = displayValueType;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5705A & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_10255/*"PARTY_ORGANIZATION_EVENT_MEMBER_OFFSET"*/);
    byte_4A5705A = 1;
  }
  ...
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_10255/*"PARTY_ORGANIZATION_EVENT_MEMBER_OFFSET"*/, 0LL);
  return System_String__Concat_61718292(ColorString, EventUpString, v9, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57059 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_10259/*"PARTY_ORGANIZATION_EVENT_PARTY_SUM"*/);
    sub_1B885B0(&StringLiteral_1/*""*/);
  ...
  if ( !this->fields.margeItemInfo
    || (v10 = ColorString,
        ...
        ColorString = System_String__Concat_61707032(v10, NameTitleString, 0LL),
  ...
  v16 = System_String__Format_61721472(v12, v13, v14, TargetString, 0LL);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v19 = LocalizationManager__Get((System_String_o *)StringLiteral_10259/*"PARTY_ORGANIZATION_EVENT_PARTY_SUM"*/, 0LL);
  return System_String__Concat_61707032(v18, v19, 0LL);
}
