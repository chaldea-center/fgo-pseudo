        ...
        const MethodInfo *method)
{
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.titleName, (int32_t)titleName, v10, v11);
  this->fields.isFollower = v9;
  this->fields.displayValueType = displayValueType;
}


void __fastcall PartyOrganizationEventPointListViewItem___ctor_31774184(
        PartyOrganizationEventPointListViewItem_o *this,
        int32_t index,
        ...
        const MethodInfo *method)
{
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.margeItemInfo, (int32_t)margeItemInfo, v8, v9);
  this->fields.displayValueType = displayValueType;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FAAA3 & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_10208/*"PARTY_ORGANIZATION_EVENT_MEMBER_OFFSET"*/, v4);
    byte_49FAAA3 = 1;
  }
  ...
  v11 = LocalizationManager__Get((System_String_o *)StringLiteral_10208/*"PARTY_ORGANIZATION_EVENT_MEMBER_OFFSET"*/, 0LL);
  return System_String__Concat_61396396(ColorString, EventUpString, v11, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FAAA2 & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_10212/*"PARTY_ORGANIZATION_EVENT_PARTY_SUM"*/, v4);
    sub_1B64A00(&StringLiteral_1/*""*/, v5);
    sub_1B64A00(&StringLiteral_10204/*"PARTY_ORGANIZATION_EVENT_MEMBER"*/, v6);
    byte_49FAAA2 = 1;
  }
  if ( this->fields.titleName )
  {
    if ( this->fields.isFollower )
      v7 = (System_String_o **)&StringLiteral_10210/*"PARTY_ORGANIZATION_EVENT_MEMBER_SUPPORT"*/;
    else
      v7 = (System_String_o **)&StringLiteral_10204/*"PARTY_ORGANIZATION_EVENT_MEMBER"*/;
    v8 = *v7;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  ...
  if ( !this->fields.margeItemInfo
    || (v14 = ColorString,
        ...
        ColorString = System_String__Concat_61385136(v14, NameTitleString, 0LL),
  ...
  v20 = System_String__Format_61399576(v16, v17, v18, TargetString, 0LL);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v23 = LocalizationManager__Get((System_String_o *)StringLiteral_10212/*"PARTY_ORGANIZATION_EVENT_PARTY_SUM"*/, 0LL);
  return System_String__Concat_61385136(v22, v23, 0LL);
}
