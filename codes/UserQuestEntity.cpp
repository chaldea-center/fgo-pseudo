void __fastcall UserQuestEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B37F51 & 1) == 0 )
  {
    sub_1BD3458(&UserQuestEntity_TypeInfo, v1);
    byte_4B37F51 = 1;
  }
...
System_String_o *__fastcall UserQuestEntity__CreatePK(int64_t userId, int32_t questId, const MethodInfo *method)
{
  ...
  if ( (byte_4B37F4D & 1) == 0 )
  {
    sub_1BD3458(&UserQuestEntity_TypeInfo, *(_QWORD *)&questId);
  ...
  if ( static_fields->oldId != userId )
  {
    ...
    v8 = System_String__Concat_62525248(v7, (System_String_o *)StringLiteral_1541/*":"*/, 0LL);
    v9 = UserQuestEntity_TypeInfo->static_fields;
    v9->userIdString = v8;
    sub_1BD33FC((PartyOrganizationUtility_o *)&v9->userIdString, (int64_t)v8, v10, v11, v12, v13, v14, v15);
    v5 = UserQuestEntity_TypeInfo;
  }
  if ( !v5->_2.cctor_finished )
  {
  ...
  return System_String__Concat_62525248(userIdString, v17, 0LL);
}
...
System_String_o *__fastcall UserQuestEntity__CreatePrimaryKey(UserQuestEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B37F4C & 1) == 0 )
  {
    sub_1BD3458(&UserQuestEntity_TypeInfo, method);
    byte_4B37F4C = 1;
  }
...
bool __fastcall UserQuestEntity__HasStatus_40974892(UserQuestEntity_o *this, int32_t status, const MethodInfo *method)
{
