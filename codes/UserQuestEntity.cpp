void __fastcall UserQuestEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B02EE0 & 1) == 0 )
  {
    sub_1BC3008(&UserQuestEntity_TypeInfo, v1);
    byte_4B02EE0 = 1;
  }
...
System_String_o *__fastcall UserQuestEntity__CreatePK(int64_t userId, int32_t questId, const MethodInfo *method)
{
  ...
  if ( (byte_4B02EDC & 1) == 0 )
  {
    sub_1BC3008(&UserQuestEntity_TypeInfo, *(_QWORD *)&questId);
    sub_1BC3008(&StringLiteral_1447/*":"*/, v4);
    byte_4B02EDC = 1;
  }
  ...
  if ( static_fields->oldId != userId )
  {
    ...
    v8 = System_String__Concat_62348648(v7, (System_String_o *)StringLiteral_1447/*":"*/, 0LL);
    v9 = UserQuestEntity_TypeInfo->static_fields;
    v9->userIdString = v8;
    sub_1BC2FAC((CGThumbnailListItem_o *)&v9->userIdString, (int32_t)v8, v10, v11);
    v5 = UserQuestEntity_TypeInfo;
  }
  if ( !v5->_2.cctor_finished )
  {
  ...
  return System_String__Concat_62348648(userIdString, v13, 0LL);
}
...
System_String_o *__fastcall UserQuestEntity__CreatePrimaryKey(UserQuestEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B02EDB & 1) == 0 )
  {
    sub_1BC3008(&UserQuestEntity_TypeInfo, method);
    byte_4B02EDB = 1;
  }
...
bool __fastcall UserQuestEntity__HasStatus_42087632(UserQuestEntity_o *this, int32_t status, const MethodInfo *method)
{
