void __fastcall UserQuestEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B6798C & 1) == 0 )
  {
    sub_1BE4ACC(&UserQuestEntity_TypeInfo, v1);
    byte_4B6798C = 1;
  }
...
System_String_o *__fastcall UserQuestEntity__CreatePK(int64_t userId, int32_t questId, const MethodInfo *method)
{
  ...
  if ( (byte_4B67988 & 1) == 0 )
  {
    sub_1BE4ACC(&UserQuestEntity_TypeInfo, *(_QWORD *)&questId);
  ...
  if ( static_fields->oldId != userId )
  {
    ...
    v8 = System_String__Concat_62698808(v7, (System_String_o *)StringLiteral_1542/*":"*/, 0LL);
    v9 = UserQuestEntity_TypeInfo->static_fields;
    v9->userIdString = v8;
    sub_1BE4A70((PartyOrganizationUtility_o *)&v9->userIdString, (int64_t)v8, v10, v11, v12, v13, v14, v15);
    v5 = UserQuestEntity_TypeInfo;
  }
  if ( !v5->_2.cctor_finished )
  {
  ...
  return System_String__Concat_62698808(userIdString, v17, 0LL);
}
...
System_String_o *__fastcall UserQuestEntity__CreatePrimaryKey(UserQuestEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B67987 & 1) == 0 )
  {
    sub_1BE4ACC(&UserQuestEntity_TypeInfo, method);
    byte_4B67987 = 1;
  }
...
bool __fastcall UserQuestEntity__HasStatus_41110596(UserQuestEntity_o *this, int32_t status, const MethodInfo *method)
{
