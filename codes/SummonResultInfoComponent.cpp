...
void SummonResultInfoComponent__OnClickSvt(SummonResultInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEAB51 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_SummonResultInfoComponent_OnClickSvt__);
    byte_4CEAB51 = 1;
  }
  if ( this->fields.clickCallbackFunc )
  {
    ...
    if ( (*((_BYTE *)Method_SummonResultInfoComponent_OnClickSvt__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C7BB00(Method_SummonResultInfoComponent_OnClickSvt__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEAB50 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_DataManager_GetMasterData_SvtCoinMaster___);
    ...
    sub_1C7BAE8(&StringLiteral_12528/*"SUMMON_RESULT_COIN_FORMAT"*/);
    byte_4CEAB50 = 1;
  }
  entity = 0;
  v40 = 0;
  ...
  if ( !data->fields.userSvtId )
  {
    ...
    *(_QWORD *)&v42.fields.fakeValue = datalist;
    v27 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49449776(v42, 0);
    goto LABEL_24;
  }
  ...
  if ( ((unsigned __int8)Instance & 1) == 0 )
  {
    ...
    *(_QWORD *)&v43.fields.fakeValue = masterCheckName;
    v27 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49449776(v43, 0);
    v33 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49449776(v30[6], 0);
...
LABEL_25:
  ...
  if ( !Instance )
    goto LABEL_49;
  ServantFaceIconComponent__Set_41667648((ServantFaceIconComponent_o *)Instance, v26, isNew, 0, 0, 0);
  v27 = 0;
LABEL_27:
  Instance = (DataManager_o *)this->fields.svtFaceInfo;
  if ( !Instance )
  ...
  if ( !entity )
LABEL_49:
    sub_1C7BD40(Instance, sellMana);
  if ( ServantEntity__get_IsServant((ServantEntity_o *)entity, 0) && data->fields.svtCoinNum >= 1 )
  {
    Instance = (DataManager_o *)DataManager__GetMasterData_object_(
                                  v22,
                                  (const MethodInfo_31703F4 *)Method_DataManager_GetMasterData_SvtCoinMaster___);
    if ( Instance )
    {
      if ( !DataMasterBase_object__object__int___TryGetEntity(
              (DataMasterBase_TMaster__TEntity__PKType__o *)Instance,
      ...
      if ( Instance )
      {
        ...
        if ( v40 )
        {
          ...
          if ( Instance )
          {
            ...
            v37 = LocalizationManager__Get((System_String_o *)StringLiteral_12528/*"SUMMON_RESULT_COIN_FORMAT"*/, 0);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1AADAC0;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1AADA78;
}
