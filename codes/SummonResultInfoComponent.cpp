...
void __fastcall SummonResultInfoComponent__OnClickSvt(SummonResultInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B410B7 & 1) == 0 )
  {
    sub_1BDB878(&Method_SummonResultInfoComponent_OnClickSvt__, method);
    byte_4B410B7 = 1;
  }
  if ( this->fields.clickCallbackFunc )
  {
    ...
    if ( (*((_BYTE *)Method_SummonResultInfoComponent_OnClickSvt__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BDB890(Method_SummonResultInfoComponent_OnClickSvt__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B410B6 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMasterData_ServantMaster___, data);
    sub_1BDB878(&Method_DataManager_GetMasterData_SvtCoinMaster___, v13);
    sub_1BDB878(&Method_DataManager_GetMasterData_UserCommandCodeMaster___, v14);
    sub_1BDB878(&Method_DataManager_GetMasterData_UserServantMaster___, v15);
    sub_1BDB878(&Method_DataMasterBase_UserCommandCodeMaster__UserCommandCodeEntity__long__GetEntity__, v16);
    sub_1BDB878(&Method_DataMasterBase_ServantMaster__ServantEntity__int__GetEntity__, v17);
    sub_1BDB878(&Method_DataMasterBase_UserServantMaster__UserServantEntity__long__GetEntity__, v18);
    sub_1BDB878(&Method_DataMasterBase_ServantMaster__ServantEntity__int__TryGetEntity__, v19);
    sub_1BDB878(&Method_DataMasterBase_SvtCoinMaster__SvtCoinEntity__int__TryGetEntity__, v20);
    ...
    sub_1BDB878(&StringLiteral_12435/*"SUMMON_RESULT_COIN_FORMAT"*/, v25);
    byte_4B410B6 = 1;
  }
  entity = 0LL;
  v51 = 0LL;
  this->fields.resultData = data;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.resultData, (int32_t)data, isOverlap, (const MethodInfo *)callback);
  this->fields.clickCallbackFunc = callback;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.clickCallbackFunc, (int32_t)callback, v26, v27);
  ...
  if ( !data->fields.userSvtId )
  {
    ...
    *(_QWORD *)&v53.fields.fakeValue = datalist;
    v35 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48227716(v53, 0LL);
    goto LABEL_24;
  }
  ...
  if ( ((unsigned __int8)Instance & 1) == 0 )
  {
    ...
    *(_QWORD *)&v54.fields.fakeValue = masterCheckName;
    v35 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48227716(v54, 0LL);
    v41 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48227716(v38[6], 0LL);
...
LABEL_25:
  ...
  if ( !Instance )
    goto LABEL_49;
  ServantFaceIconComponent__Set_40027264((ServantFaceIconComponent_o *)Instance, v34, isNew, 0LL, 0LL, 0LL);
  v35 = 0;
LABEL_27:
  Instance = (DataManager_o *)this->fields.svtFaceInfo;
  if ( !Instance )
  ...
  if ( !entity )
LABEL_49:
    sub_1BDBAD4(Instance, sellMana);
  if ( ServantEntity__get_IsServant((ServantEntity_o *)entity, 0LL) && data->fields.svtCoinNum >= 1 )
  {
    Instance = (DataManager_o *)DataManager__GetMasterData_object_(
                                  v30,
                                  (const MethodInfo_303395C *)Method_DataManager_GetMasterData_SvtCoinMaster___);
    if ( Instance )
    {
      if ( !DataMasterBase_object__object__int___TryGetEntity(
              (DataMasterBase_TMaster__TEntity__PKType__o *)Instance,
      ...
      if ( Instance )
      {
        ...
        if ( v51 )
        {
          ...
          if ( Instance )
          {
            ...
            v45 = LocalizationManager__Get((System_String_o *)StringLiteral_12435/*"SUMMON_RESULT_COIN_FORMAT"*/, 0LL);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A2149C;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A21454;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B410B8 & 1) == 0 )
  {
    sub_1BDB878(&long_TypeInfo, usrSvtId);
    byte_4B410B8 = 1;
  }
  v9[1] = 0LL;
