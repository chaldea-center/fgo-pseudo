...
void __fastcall SummonResultInfoComponent__OnClickSvt(SummonResultInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B63373 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_SummonResultInfoComponent_OnClickSvt__, method);
    byte_4B63373 = 1;
  }
  if ( this->fields.clickCallbackFunc )
  {
    ...
    if ( (*((_BYTE *)Method_SummonResultInfoComponent_OnClickSvt__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BE4AE4(Method_SummonResultInfoComponent_OnClickSvt__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B63372 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_DataManager_GetMasterData_ServantMaster___, data);
    sub_1BE4ACC(&Method_DataManager_GetMasterData_SvtCoinMaster___, v14);
    ...
    sub_1BE4ACC(&Method_DataMasterBase_UserCommandCodeMaster__UserCommandCodeEntity__long__GetEntity__, v17);
    sub_1BE4ACC(&Method_DataMasterBase_ServantMaster__ServantEntity__int__GetEntity__, v18);
    sub_1BE4ACC(&Method_DataMasterBase_UserServantMaster__UserServantEntity__long__GetEntity__, v19);
    sub_1BE4ACC(&Method_DataMasterBase_ServantMaster__ServantEntity__int__TryGetEntity__, v20);
    sub_1BE4ACC(&Method_DataMasterBase_SvtCoinMaster__SvtCoinEntity__int__TryGetEntity__, v21);
    ...
    sub_1BE4ACC(&StringLiteral_12562/*"SUMMON_RESULT_COIN_FORMAT"*/, v26);
    byte_4B63372 = 1;
  }
  entity = 0LL;
  v56 = 0LL;
  ...
  if ( !data->fields.userSvtId )
  {
    ...
    *(_QWORD *)&v58.fields.fakeValue = datalist;
    v40 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47299060(v58, 0LL);
    goto LABEL_24;
  }
  ...
  if ( ((unsigned __int8)Instance & 1) == 0 )
  {
    ...
    *(_QWORD *)&v59.fields.fakeValue = masterCheckName;
    v40 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47299060(v59, 0LL);
    v46 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47299060(v43[6], 0LL);
...
LABEL_25:
  ...
  if ( !Instance )
    goto LABEL_49;
  ServantFaceIconComponent__Set_39133752((ServantFaceIconComponent_o *)Instance, v39, isNew, 0LL, 0LL, 0LL);
  v40 = 0;
LABEL_27:
  Instance = (DataManager_o *)this->fields.svtFaceInfo;
  if ( !Instance )
  ...
  if ( !entity )
LABEL_49:
    sub_1BE4D28(Instance, sellMana);
  if ( ServantEntity__get_IsServant((ServantEntity_o *)entity, 0LL) && data->fields.svtCoinNum >= 1 )
  {
    Instance = (DataManager_o *)DataManager__GetMasterData_object_(
                                  v35,
                                  (const MethodInfo_2F59110 *)Method_DataManager_GetMasterData_SvtCoinMaster___);
    if ( Instance )
    {
      if ( !DataMasterBase_object__object__int___TryGetEntity(
              (DataMasterBase_TMaster__TEntity__PKType__o *)Instance,
      ...
      if ( Instance )
      {
        ...
        if ( v56 )
        {
          ...
          if ( Instance )
          {
            ...
            v50 = LocalizationManager__Get((System_String_o *)StringLiteral_12562/*"SUMMON_RESULT_COIN_FORMAT"*/, 0LL);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A22F28;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A22EE0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B63374 & 1) == 0 )
  {
    sub_1BE4ACC(&long_TypeInfo, usrSvtId);
    byte_4B63374 = 1;
  }
  v9[1] = 0LL;
