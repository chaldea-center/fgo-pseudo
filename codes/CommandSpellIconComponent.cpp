void __fastcall CommandSpellIconComponent___ctor(CommandSpellIconComponent_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.ImageType = xmmword_BDE620;
...
void __fastcall CommandSpellIconComponent__Awake(CommandSpellIconComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B01405 & 1) == 0 )
  {
    sub_1BC3008(&Method_UnityEngine_Component_GetComponentInChildren_UITexture___, method);
  ...
  ComponentInChildren_object__50301080 = UnityEngine_Component__GetComponentInChildren_object__50301080(
                                           ...
                                           (const MethodInfo_2FF8898 *)Method_UnityEngine_Component_GetComponentInChildren_UITexture___);
  this->fields.myTexture = (struct UITexture_o *)ComponentInChildren_object__50301080;
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.myTexture, (int32_t)ComponentInChildren_object__50301080, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B0140A & 1) == 0 )
  {
    this = (CommandSpellIconComponent_o *)sub_1BC3008(&StringLiteral_4552/*"CommandSpell/"*/, *(_QWORD *)&tp);
    byte_4B0140A = 1;
  }
  SpellImageFileName = CommandSpellIconComponent__GetSpellImageFileName(this, tp, method);
  return System_String__Concat_62348648((System_String_o *)StringLiteral_4552/*"CommandSpell/"*/, SpellImageFileName, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B0140B & 1) == 0 )
  {
    sub_1BC3008(&int_TypeInfo, *(_QWORD *)&tp);
    sub_1BC3008(&StringLiteral_24819/*"{0:0000}"*/, v6);
    sub_1BC3008(&StringLiteral_18221/*"cs_"*/, v7);
    byte_4B0140B = 1;
  }
  v11 = tp;
  v8 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v11, method, v3, v4);
  v9 = System_String__Format((System_String_o *)StringLiteral_24819/*"{0:0000}"*/, v8, 0LL);
  return System_String__Concat_62348648((System_String_o *)StringLiteral_18221/*"cs_"*/, v9, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B0140F & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_UnityEngine_GameObject_GetComponent_UIAtlas___, v7);
    sub_1BC3008(&UnityEngine_Object_TypeInfo, v8);
    sub_1BC3008(&StringLiteral_18222/*"cs_txt_disable"*/, v9);
    ...
    if ( AssetStorage )
    {
      ...
      if ( AssetStorage )
      {
        ...
        if ( AssetStorage )
        {
          ...
          if ( AssetStorage )
          {
            UISprite__set_spriteName((UISprite_o *)AssetStorage, (System_String_o *)StringLiteral_18222/*"cs_txt_disable"*/, 0LL);
            AssetStorage = (AssetData_o *)this->fields.notUseCommandSpellSpr;
            if ( AssetStorage )
            {
...
void __fastcall CommandSpellIconComponent__ReleaseAll(CommandSpellIconComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B01404 & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_16121/*"_MaskTex"*/, v5);
    byte_4B01404 = 1;
  }
...
LABEL_27:
  ...
  if ( !v7 )
  {
    if ( v10 )
    {
      ...
      UnityEngine_Material__SetTexture((UnityEngine_Material_o *)v10, (System_String_o *)StringLiteral_16121/*"_MaskTex"*/, 0LL, 0LL);
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
...
LABEL_14:
      ...
      if ( assetData )
      {
        ...
        if ( UnityEngine_Object__op_Implicit(v15, 0LL) )
        {
          ...
          if ( !AssetManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
          AssetManager__releaseAsset_39571344(klass, 0LL);
        }
        p_assetData->klass = 0LL;
        sub_1BC2FAC(p_assetData, 0, v16, v17);
      }
      return;
    }
    goto LABEL_27;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B01408 & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_8527/*"MAX_COMMAND_SPELL"*/, *(_QWORD *)&cmdSpellImgId);
    byte_4B01408 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B01407 & 1) == 0 )
  {
    this = (CommandSpellIconComponent_o *)sub_1BC3008(&StringLiteral_8527/*"MAX_COMMAND_SPELL"*/, entity);
    byte_4B01407 = 1;
  }
  if ( !entity )
    sub_1BC3264(this, entity);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B0140C & 1) == 0 )
  {
    sub_1BC3008(&AssetManager_TypeInfo, *(_QWORD *)&tp);
    sub_1BC3008(&AssetLoader_LoadEndDataHandler_TypeInfo, v5);
    sub_1BC3008(&Method_CommandSpellIconComponent___c__DisplayClass23_0__SetImageType_b__0__, v6);
    sub_1BC3008(&CommandSpellIconComponent___c__DisplayClass23_0_TypeInfo, v7);
    byte_4B0140C = 1;
  }
  v8 = sub_1BC3254(CommandSpellIconComponent___c__DisplayClass23_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B01406 & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_18222/*"cs_txt_disable"*/, v11);
    byte_4B01406 = 1;
  }
  *(_QWORD *)result = 0LL;
  ...
  if ( !byte_4AFEB8E )
  {
    sub_1BC3008(&TerminalPramsManager_TypeInfo, entity);
    byte_4AFEB8E = 1;
  }
  ...
  if ( v12->static_fields->_DispState_k__BackingField == 2 )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(disableSp, 0LL, 0LL) )
    {
      ...
      AtlasManager__SetEventSprite(v17, (System_String_o *)StringLiteral_18222/*"cs_txt_disable"*/, 0LL);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B0140E & 1) == 0 )
  {
    ...
    this = (CommandSpellIconComponent_o *)sub_1BC3008(&StringLiteral_16121/*"_MaskTex"*/, v11);
    byte_4B0140E = 1;
  }
  if ( data )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(myTexture, 0LL, 0LL) )
    {
      ...
      v16 = System_String__Concat_62348648(v14, (System_String_o *)StringLiteral_16387/*"_alpha"*/, 0LL);
      ...
      {
        v21 = UnityEngine_Shader__Find((System_String_o *)StringLiteral_4899/*"Custom/SpriteWithMask"*/, 0LL);
        v20 = (UnityEngine_Object_o *)sub_1BC3254(UnityEngine_Material_TypeInfo);
...
LABEL_15:
      ...
      UnityEngine_Material__set_mainTexture(
        ...
        0LL);
      UnityEngine_Material__SetTexture((UnityEngine_Material_o *)v20, (System_String_o *)StringLiteral_16121/*"_MaskTex"*/, v19, 0LL);
    }
  }
}
