void __fastcall CommandSpellIconComponent___ctor(CommandSpellIconComponent_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.ImageType = xmmword_B70B40;
...
void __fastcall CommandSpellIconComponent__Awake(CommandSpellIconComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E1CC7 & 1) == 0 )
  {
    sub_1B00CCC(&Method_UnityEngine_Component_GetComponentInChildren_UITexture___, method);
  ...
  ComponentInChildren_object__47552792 = UnityEngine_Component__GetComponentInChildren_object__47552792(
                                           ...
                                           (const MethodInfo_2D59918 *)Method_UnityEngine_Component_GetComponentInChildren_UITexture___);
  this->fields.myTexture = (struct UITexture_o *)ComponentInChildren_object__47552792;
  sub_1B00C70(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E1CCC & 1) == 0 )
  {
    this = (CommandSpellIconComponent_o *)sub_1B00CCC(&StringLiteral_4573/*"CommandSpell/"*/, *(_QWORD *)&tp);
    byte_48E1CCC = 1;
  }
  SpellImageFileName = CommandSpellIconComponent__GetSpellImageFileName(this, tp, method);
  return System_String__Concat_60325748((System_String_o *)StringLiteral_4573/*"CommandSpell/"*/, SpellImageFileName, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E1CCD & 1) == 0 )
  {
    sub_1B00CCC(&int_TypeInfo, *(_QWORD *)&tp);
    sub_1B00CCC(&StringLiteral_24575/*"{0:0000}"*/, v6);
    sub_1B00CCC(&StringLiteral_18137/*"cs_"*/, v7);
    byte_48E1CCD = 1;
  }
  v11 = tp;
  v8 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v11, method, v3, v4);
  v9 = System_String__Format((System_String_o *)StringLiteral_24575/*"{0:0000}"*/, v8, 0LL);
  return System_String__Concat_60325748((System_String_o *)StringLiteral_18137/*"cs_"*/, v9, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E1CD1 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_18138/*"cs_txt_disable"*/, v9);
    ...
    if ( AssetStorage )
    {
      ...
      if ( AssetStorage )
      {
        ...
        if ( AssetStorage )
        {
          ...
          if ( AssetStorage )
          {
            UISprite__set_spriteName((UISprite_o *)AssetStorage, (System_String_o *)StringLiteral_18138/*"cs_txt_disable"*/, 0LL);
            AssetStorage = (AssetData_o *)this->fields.notUseCommandSpellSpr;
            if ( AssetStorage )
            {
...
void __fastcall CommandSpellIconComponent__ReleaseAll(CommandSpellIconComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E1CC6 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_16035/*"_MaskTex"*/, v5);
    byte_48E1CC6 = 1;
  }
...
LABEL_27:
  ...
  if ( !v7 )
  {
    if ( v9 )
    {
      ...
      UnityEngine_Material__SetTexture((UnityEngine_Material_o *)v9, (System_String_o *)StringLiteral_16035/*"_MaskTex"*/, 0LL, 0LL);
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
...
LABEL_14:
      ...
      if ( assetData )
      {
        ...
        if ( UnityEngine_Object__op_Implicit(v14, 0LL) )
        {
          ...
          if ( !AssetManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
          AssetManager__releaseAsset_36589816(klass, 0LL);
        }
        p_assetData->klass = 0LL;
        sub_1B00C70(p_assetData, 0, v15, v16);
      }
      return;
    }
    goto LABEL_27;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E1CCA & 1) == 0 )
  {
    sub_1B00CCC(&StringLiteral_8485/*"MAX_COMMAND_SPELL"*/, *(_QWORD *)&cmdSpellImgId);
    byte_48E1CCA = 1;
  }
  Value = ConstantMaster__getValue((System_String_o *)StringLiteral_8485/*"MAX_COMMAND_SPELL"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E1CC9 & 1) == 0 )
  {
    this = (CommandSpellIconComponent_o *)sub_1B00CCC(&StringLiteral_8485/*"MAX_COMMAND_SPELL"*/, entity);
    byte_48E1CC9 = 1;
  }
  if ( !entity )
    sub_1B00F28(this, entity);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E1CCE & 1) == 0 )
  {
    sub_1B00CCC(&AssetManager_TypeInfo, *(_QWORD *)&tp);
    sub_1B00CCC(&AssetLoader_LoadEndDataHandler_TypeInfo, v5);
    sub_1B00CCC(&Method_CommandSpellIconComponent___c__DisplayClass23_0__SetImageType_b__0__, v6);
    sub_1B00CCC(&CommandSpellIconComponent___c__DisplayClass23_0_TypeInfo, v7);
    byte_48E1CCE = 1;
  }
  v8 = sub_1B00F18(CommandSpellIconComponent___c__DisplayClass23_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E1CCF & 1) == 0 )
  {
    sub_1B00CCC(&UnityEngine_Object_TypeInfo, *(_QWORD *)&count);
    byte_48E1CCF = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E1CC8 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_18138/*"cs_txt_disable"*/, v11);
    byte_48E1CC8 = 1;
  }
  *(_QWORD *)result = 0LL;
  ...
  if ( !byte_48DF715 )
  {
    sub_1B00CCC(&TerminalPramsManager_TypeInfo, entity);
    byte_48DF715 = 1;
  }
  ...
  if ( v12->static_fields->_DispState_k__BackingField == 2 )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(disableSp, 0LL, 0LL) )
    {
      ...
      AtlasManager__SetEventSprite(v17, (System_String_o *)StringLiteral_18138/*"cs_txt_disable"*/, 0LL);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E1CD0 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&UnityEngine_Object_TypeInfo, v8);
    sub_1B00CCC(&StringLiteral_16292/*"_alpha"*/, v9);
    sub_1B00CCC(&StringLiteral_4921/*"Custom/SpriteWithMask"*/, v10);
    this = (CommandSpellIconComponent_o *)sub_1B00CCC(&StringLiteral_16035/*"_MaskTex"*/, v11);
    byte_48E1CD0 = 1;
  }
  if ( data )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(myTexture, 0LL, 0LL) )
    {
      ...
      v16 = System_String__Concat_60325748(v14, (System_String_o *)StringLiteral_16292/*"_alpha"*/, 0LL);
      v17 = AssetData__GetObject_object__47470892(
              data,
              v16,
              (const MethodInfo_2D4592C *)Method_AssetData_GetObject_Texture2D____74577960);
      if ( !myTexture )
      ...
      {
        v21 = UnityEngine_Shader__Find((System_String_o *)StringLiteral_4921/*"Custom/SpriteWithMask"*/, 0LL);
        v20 = (UnityEngine_Object_o *)sub_1B00F18(UnityEngine_Material_TypeInfo);
...
LABEL_15:
      ...
      UnityEngine_Material__set_mainTexture(
        ...
        0LL);
      UnityEngine_Material__SetTexture((UnityEngine_Material_o *)v20, (System_String_o *)StringLiteral_16035/*"_MaskTex"*/, v19, 0LL);
    }
  }
}
