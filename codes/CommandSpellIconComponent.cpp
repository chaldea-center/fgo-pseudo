void __fastcall CommandSpellIconComponent___ctor(CommandSpellIconComponent_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.ImageType = xmmword_BFA360;
...
void __fastcall CommandSpellIconComponent__Awake(CommandSpellIconComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC6EE6 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_UnityEngine_Component_GetComponentInChildren_UITexture___, method);
  ...
  ComponentInChildren_object__49897880 = UnityEngine_Component__GetComponentInChildren_object__49897880(
                                           ...
                                           (const MethodInfo_2F96198 *)Method_UnityEngine_Component_GetComponentInChildren_UITexture___);
  this->fields.myTexture = (struct UITexture_o *)ComponentInChildren_object__49897880;
  sub_1C1AB78(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6EEB & 1) == 0 )
  {
    this = (CommandSpellIconComponent_o *)sub_1C1ABD4(&StringLiteral_4706/*"CommandSpell/"*/, *(_QWORD *)&tp);
    byte_4BC6EEB = 1;
  }
  SpellImageFileName = CommandSpellIconComponent__GetSpellImageFileName(this, tp, method);
  return System_String__Concat_63040368((System_String_o *)StringLiteral_4706/*"CommandSpell/"*/, SpellImageFileName, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6EEC & 1) == 0 )
  {
    sub_1C1ABD4(&int_TypeInfo, *(_QWORD *)&tp);
    sub_1C1ABD4(&StringLiteral_25362/*"{0:0000}"*/, v6);
    sub_1C1ABD4(&StringLiteral_18681/*"cs_"*/, v7);
    byte_4BC6EEC = 1;
  }
  v11 = tp;
  v8 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v11, method, v3, v4);
  v9 = System_String__Format((System_String_o *)StringLiteral_25362/*"{0:0000}"*/, v8, 0LL);
  return System_String__Concat_63040368((System_String_o *)StringLiteral_18681/*"cs_"*/, v9, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6EF0 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_18682/*"cs_txt_disable"*/, v9);
    ...
    if ( AssetStorage )
    {
      ...
      if ( AssetStorage )
      {
        ...
        if ( AssetStorage )
        {
          ...
          if ( AssetStorage )
          {
            UISprite__set_spriteName((UISprite_o *)AssetStorage, (System_String_o *)StringLiteral_18682/*"cs_txt_disable"*/, 0LL);
            AssetStorage = (AssetData_o *)this->fields.notUseCommandSpellSpr;
            if ( AssetStorage )
            {
...
void __fastcall CommandSpellIconComponent__ReleaseAll(CommandSpellIconComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC6EE5 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_16534/*"_MaskTex"*/, v5);
    byte_4BC6EE5 = 1;
  }
...
LABEL_27:
    sub_1C1AE30(v7, v8);
  v10 = (UnityEngine_Object_o *)((__int64 (__fastcall *)(UnityEngine_Object_o *, Il2CppMethodPointer))myTexture->klass[1].vtable._1_Finalize.method)(
                                  myTexture,
                                  myTexture->klass[1].vtable._2_GetHashCode.methodPtr);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  v7 = UnityEngine_Object__op_Equality(v10, 0LL, 0LL);
  if ( !v7 )
  {
    if ( v10 )
    {
      UnityEngine_Material__set_mainTexture((UnityEngine_Material_o *)v10, 0LL, 0LL);
      UnityEngine_Material__SetTexture((UnityEngine_Material_o *)v10, (System_String_o *)StringLiteral_16534/*"_MaskTex"*/, 0LL, 0LL);
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
...
LABEL_14:
      ...
      if ( assetData )
      {
        ...
        if ( UnityEngine_Object__op_Implicit(v15, 0LL) )
        {
          ...
          if ( !AssetManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
          AssetManager__releaseAsset_38988476(klass, 0LL);
        }
        p_assetData->klass = 0LL;
        sub_1C1AB78(p_assetData, 0LL, v16, v17, v18, v19, v20, v21);
      }
      return;
    }
    goto LABEL_27;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6EE9 & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_8753/*"MAX_COMMAND_SPELL"*/, *(_QWORD *)&cmdSpellImgId);
    byte_4BC6EE9 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6EE8 & 1) == 0 )
  {
    this = (CommandSpellIconComponent_o *)sub_1C1ABD4(&StringLiteral_8753/*"MAX_COMMAND_SPELL"*/, entity);
    byte_4BC6EE8 = 1;
  }
  if ( !entity )
    sub_1C1AE30(this, entity);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6EED & 1) == 0 )
  {
    sub_1C1ABD4(&AssetManager_TypeInfo, *(_QWORD *)&tp);
    sub_1C1ABD4(&AssetLoader_LoadEndDataHandler_TypeInfo, v5);
    sub_1C1ABD4(&Method_CommandSpellIconComponent___c__DisplayClass23_0__SetImageType_b__0__, v6);
    sub_1C1ABD4(&CommandSpellIconComponent___c__DisplayClass23_0_TypeInfo, v7);
    byte_4BC6EED = 1;
  }
  v8 = sub_1C1AE20(CommandSpellIconComponent___c__DisplayClass23_0_TypeInfo);
  ...
  *(_DWORD *)(v8 + 24) = tp;
  if ( this->fields.ImageTypeOld != tp )
  {
    ...
    SpellImageAssetStorageName = CommandSpellIconComponent__GetSpellImageAssetStorageName(this, tp, v17);
    if ( !AssetManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6EEE & 1) == 0 )
  {
    sub_1C1ABD4(&UnityEngine_Object_TypeInfo, *(_QWORD *)&count);
    byte_4BC6EEE = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6EE7 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_18682/*"cs_txt_disable"*/, v11);
    byte_4BC6EE7 = 1;
  }
  *(_QWORD *)result = 0LL;
  ...
  if ( !byte_4BC47E6 )
  {
    sub_1C1ABD4(&TerminalPramsManager_TypeInfo, entity);
    byte_4BC47E6 = 1;
  }
  ...
  if ( v12->static_fields->_DispState_k__BackingField == 2 )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(disableSp, 0LL, 0LL) )
    {
      ...
      AtlasManager__SetEventSprite(v17, (System_String_o *)StringLiteral_18682/*"cs_txt_disable"*/, 0LL);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6EEF & 1) == 0 )
  {
    ...
    this = (CommandSpellIconComponent_o *)sub_1C1ABD4(&StringLiteral_16534/*"_MaskTex"*/, v11);
    byte_4BC6EEF = 1;
  }
  if ( data )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(myTexture, 0LL, 0LL) )
    {
      ...
      v16 = System_String__Concat_63040368(v14, (System_String_o *)StringLiteral_16794/*"_alpha"*/, 0LL);
      ...
      {
        v21 = UnityEngine_Shader__Find((System_String_o *)StringLiteral_5071/*"Custom/SpriteWithMask"*/, 0LL);
        v20 = (UnityEngine_Object_o *)sub_1C1AE20(UnityEngine_Material_TypeInfo);
...
LABEL_15:
      ...
      UnityEngine_Material__set_mainTexture(
        ...
        0LL);
      UnityEngine_Material__SetTexture((UnityEngine_Material_o *)v20, (System_String_o *)StringLiteral_16534/*"_MaskTex"*/, v19, 0LL);
    }
  }
}
