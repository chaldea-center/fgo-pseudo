void __fastcall CommandSpellIconComponent___ctor(CommandSpellIconComponent_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.ImageType = xmmword_BEACE0;
...
void __fastcall CommandSpellIconComponent__Awake(CommandSpellIconComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B43E76 & 1) == 0 )
  {
    sub_1BDB878(&Method_UnityEngine_Component_GetComponentInChildren_UITexture___, method);
  ...
  ComponentInChildren_object__50504592 = UnityEngine_Component__GetComponentInChildren_object__50504592(
                                           ...
                                           (const MethodInfo_302A390 *)Method_UnityEngine_Component_GetComponentInChildren_UITexture___);
  this->fields.myTexture = (struct UITexture_o *)ComponentInChildren_object__50504592;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.myTexture, (int32_t)ComponentInChildren_object__50504592, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43E7B & 1) == 0 )
  {
    this = (CommandSpellIconComponent_o *)sub_1BDB878(&StringLiteral_4630/*"CommandSpell/"*/, *(_QWORD *)&tp);
    byte_4B43E7B = 1;
  }
  SpellImageFileName = CommandSpellIconComponent__GetSpellImageFileName(this, tp, method);
  return System_String__Concat_62572260((System_String_o *)StringLiteral_4630/*"CommandSpell/"*/, SpellImageFileName, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43E7C & 1) == 0 )
  {
    sub_1BDB878(&int_TypeInfo, *(_QWORD *)&tp);
    sub_1BDB878(&StringLiteral_25134/*"{0:0000}"*/, v6);
    sub_1BDB878(&StringLiteral_18396/*"cs_"*/, v7);
    byte_4B43E7C = 1;
  }
  v11 = tp;
  v8 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v11, method, v3, v4);
  v9 = System_String__Format((System_String_o *)StringLiteral_25134/*"{0:0000}"*/, v8, 0LL);
  return System_String__Concat_62572260((System_String_o *)StringLiteral_18396/*"cs_"*/, v9, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43E80 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_18397/*"cs_txt_disable"*/, v9);
    ...
    if ( AssetStorage )
    {
      ...
      if ( AssetStorage )
      {
        ...
        if ( AssetStorage )
        {
          ...
          if ( AssetStorage )
          {
            UISprite__set_spriteName((UISprite_o *)AssetStorage, (System_String_o *)StringLiteral_18397/*"cs_txt_disable"*/, 0LL);
            AssetStorage = (AssetData_o *)this->fields.notUseCommandSpellSpr;
            if ( AssetStorage )
            {
...
void __fastcall CommandSpellIconComponent__ReleaseAll(CommandSpellIconComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B43E75 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_16248/*"_MaskTex"*/, v5);
    byte_4B43E75 = 1;
  }
...
LABEL_27:
  ...
  if ( !v7 )
  {
    if ( v10 )
    {
      ...
      UnityEngine_Material__SetTexture((UnityEngine_Material_o *)v10, (System_String_o *)StringLiteral_16248/*"_MaskTex"*/, 0LL, 0LL);
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
...
LABEL_14:
      ...
      if ( assetData )
      {
        ...
        sub_1BDB81C(p_assetData, 0, v16, v17);
      }
      return;
    }
    goto LABEL_27;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43E79 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_8600/*"MAX_COMMAND_SPELL"*/, *(_QWORD *)&cmdSpellImgId);
    byte_4B43E79 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43E78 & 1) == 0 )
  {
    this = (CommandSpellIconComponent_o *)sub_1BDB878(&StringLiteral_8600/*"MAX_COMMAND_SPELL"*/, entity);
    byte_4B43E78 = 1;
  }
  if ( !entity )
    sub_1BDBAD4(this, entity);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43E7D & 1) == 0 )
  {
    sub_1BDB878(&AssetManager_TypeInfo, *(_QWORD *)&tp);
    sub_1BDB878(&AssetLoader_LoadEndDataHandler_TypeInfo, v5);
    sub_1BDB878(&Method_CommandSpellIconComponent___c__DisplayClass23_0__SetImageType_b__0__, v6);
    sub_1BDB878(&CommandSpellIconComponent___c__DisplayClass23_0_TypeInfo, v7);
    byte_4B43E7D = 1;
  }
  v8 = sub_1BDBAC4(CommandSpellIconComponent___c__DisplayClass23_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43E7E & 1) == 0 )
  {
    sub_1BDB878(&UnityEngine_Object_TypeInfo, *(_QWORD *)&count);
    byte_4B43E7E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43E77 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_18397/*"cs_txt_disable"*/, v11);
    byte_4B43E77 = 1;
  }
  *(_QWORD *)result = 0LL;
  ...
  if ( !byte_4B41618 )
  {
    sub_1BDB878(&TerminalPramsManager_TypeInfo, entity);
    byte_4B41618 = 1;
  }
  ...
  if ( v12->static_fields->_DispState_k__BackingField == 2 )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(disableSp, 0LL, 0LL) )
    {
      ...
      AtlasManager__SetEventSprite(v17, (System_String_o *)StringLiteral_18397/*"cs_txt_disable"*/, 0LL);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43E7F & 1) == 0 )
  {
    ...
    this = (CommandSpellIconComponent_o *)sub_1BDB878(&StringLiteral_16248/*"_MaskTex"*/, v11);
    byte_4B43E7F = 1;
  }
  if ( data )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(myTexture, 0LL, 0LL) )
    {
      ...
      v16 = System_String__Concat_62572260(v14, (System_String_o *)StringLiteral_16514/*"_alpha"*/, 0LL);
      ...
      {
        v21 = UnityEngine_Shader__Find((System_String_o *)StringLiteral_4979/*"Custom/SpriteWithMask"*/, 0LL);
        v20 = (UnityEngine_Object_o *)sub_1BDBAC4(UnityEngine_Material_TypeInfo);
...
LABEL_15:
      ...
      UnityEngine_Material__set_mainTexture(
        ...
        0LL);
      UnityEngine_Material__SetTexture((UnityEngine_Material_o *)v20, (System_String_o *)StringLiteral_16248/*"_MaskTex"*/, v19, 0LL);
    }
  }
}
