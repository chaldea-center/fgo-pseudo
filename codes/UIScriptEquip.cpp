void __fastcall UIScriptEquip___ctor(UIScriptEquip_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0A91F & 1) == 0 )
  {
    sub_1B686D4(&UIEquipGraphM___TypeInfo, method);
    sub_1B686D4(&UIScriptChara_TypeInfo, v3);
    byte_4A0A91F = 1;
  }
  v4 = (struct UIEquipGraphM_array *)sub_1B6877C(UIEquipGraphM___TypeInfo, 2LL);
  this->fields.equipGraphList = v4;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.equipGraphList, (int32_t)v4, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0A91A & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_UIScriptEquip_UpdateChange__, v13);
    byte_4A0A91A = 1;
  }
  UIScriptChara__ChangeCharacter_41468276((UIScriptChara_o *)this, kind, speed, imageName, faceType, callback, method);
...
void __fastcall UIScriptEquip__ContinueChangeFade(UIScriptEquip_o *this, const MethodInfo *method)
{
  if ( (byte_4A0A91C & 1) == 0 )
  {
    sub_1B686D4(&StringLiteral_15115/*"UpdateChange"*/, method);
    byte_4A0A91C = 1;
  }
  UIScriptEquip__SetOverlap(this, 1.0, method);
  UnityEngine_MonoBehaviour__Invoke(
    (UnityEngine_MonoBehaviour_o *)this,
    (System_String_o *)StringLiteral_15115/*"UpdateChange"*/,
...
void __fastcall UIScriptEquip__EndChange(UIScriptEquip_o *this, const MethodInfo *method)
{
  ...
  int32_t v8; // w2
  int32_t v9; // w3
  ServantStatusBattleListViewItem_o *p_changeCallback; // x19
...
LABEL_9:
  ...
  p_changeCallback = (ServantStatusBattleListViewItem_o *)&v5->fields.changeCallback;
  v11 = changeCallback;
  p_changeCallback[-1].fields.dispLimitCount.fields.fakeValue = 0;
  if ( changeCallback )
  {
    p_changeCallback->klass = 0LL;
    sub_1B68678(p_changeCallback, 0, v8, v9);
...
LABEL_23:
  ...
  p_setCallback = (ServantStatusBattleListViewItem_o *)&v4->fields.setCallback;
  v19 = setCallback;
  if ( setCallback )
  {
    p_setCallback->klass = 0LL;
    sub_1B68678(p_setCallback, 0, v16, v17);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0A91D & 1) == 0 )
  {
    sub_1B686D4(&System_Action_TypeInfo, imageName);
    byte_4A0A91D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( max_length >= 1 )
  {
    ...
    {
      if ( v6 >= max_length )
        sub_1B68938(this, *(_QWORD *)&maskInteraction);
...
LABEL_9:
    sub_1B68930(this, *(_QWORD *)&maskInteraction);
  }
}
  ...
  if ( !v34 )
  {
    ...
    if ( v37 > 0x8D759330 )
    {
      if ( v37 > 0xD4B34506 )
      {
        ...
        {
          case 0xE7555186:
            v38 = &StringLiteral_24630/*"wipe"*/;
            break;
          case 0xEC9DA126:
            v38 = &StringLiteral_18375/*"darkWipe"*/;
            break;
          case 0xEE11C37F:
            v38 = &StringLiteral_16750/*"appearance"*/;
            break;
          default:
            return;
        }
      ...
      else
      {
        ...
        {
          case 0x8DA714B6:
            v38 = &StringLiteral_24636/*"wipeTimeRe"*/;
            break;
          case 0x9C7CDA94:
            v38 = &StringLiteral_19392/*"flashErasure"*/;
            break;
          case 0xD4B34506:
            v38 = &StringLiteral_18983/*"erasureReverse"*/;
            break;
          default:
            return;
        }
    ...
    else if ( v37 > 0x4A1132BE )
    {
      ...
      {
        case 0x8D759330:
          v38 = &StringLiteral_18982/*"erasure"*/;
          break;
        case 0x4DE5D9DEu:
          v38 = &StringLiteral_18951/*"enemyErasure"*/;
          break;
        case 0x50AF70CBu:
          v38 = &StringLiteral_16751/*"appearanceReverse"*/;
          break;
        default:
          return;
      }
    ...
    {
      v38 = &StringLiteral_24635/*"wipeTime"*/;
    }
    else
    {
      if ( v37 != 1242641086 )
        return;
      v38 = &StringLiteral_18374/*"darkEnemyErasure"*/;
    }
...
void __fastcall UIScriptEquip__UpdateChange(UIScriptEquip_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0A91B & 1) == 0 )
  {
    sub_1B686D4(&UIScriptChara_TypeInfo, method);
    sub_1B686D4(&StringLiteral_5923/*"EndChange"*/, v3);
    this = (UIScriptEquip_o *)sub_1B686D4(&StringLiteral_4711/*"ContinueChangeFade"*/, v4);
    byte_4A0A91B = 1;
  }
    ...
    if ( this )
    {
      ...
      if ( v18 )
      {
        UIEquipGraphRender__MoveAlpha(
          ...
          (System_String_o *)StringLiteral_5923/*"EndChange"*/,
          0LL);
        return;
      }
    }
LABEL_25:
  ...
  UnityEngine_MonoBehaviour__Invoke((UnityEngine_MonoBehaviour_o *)v2, (System_String_o *)StringLiteral_4711/*"ContinueChangeFade"*/, v17, 0LL);
}