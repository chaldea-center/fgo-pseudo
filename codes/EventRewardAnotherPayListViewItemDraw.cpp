        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21B19 & 1) == 0 )
  {
    ...
    this = (EventRewardAnotherPayListViewItemDraw_o *)sub_1C2D490(&StringLiteral_1961/*"ANOTHER_PAY_ITEM_MULTI_LIST_SKILL_NONE"*/);
    byte_4C21B19 = 1;
  }
  entity = 0;
  v15 = 0;
  ...
  if ( !this )
    goto LABEL_43;
  ItemIconComponent__SetItem_40696724((ItemIconComponent_o *)this, ItemEntity_k__BackingField, -1, 1, 0);
  ...
  if ( ItemEntity_k__BackingField->fields.type == 40 )
  {
    ...
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    v9 = DataManager__GetMaster_object_((const MethodInfo_30CE8FC *)Method_DataManager_GetMaster_SkillMaster___);
    this = (EventRewardAnotherPayListViewItemDraw_o *)DataManager__GetMaster_object_((const MethodInfo_30CE8FC *)Method_DataManager_GetMaster_SkillLvMaster___);
    if ( !v9 )
      goto LABEL_43;
