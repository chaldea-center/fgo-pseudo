        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F3F8 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMaster_SkillLvMaster___, item);
    sub_1BDB878(&Method_DataManager_GetMaster_SkillMaster___, v5);
    sub_1BDB878(&Method_DataManager_GetMaster_UserItemMaster___, v6);
    sub_1BDB878(&DataManager_TypeInfo, v7);
    sub_1BDB878(&Method_DataMasterBase_SkillMaster__SkillEntity__int__TryGetEntity__, v8);
    sub_1BDB878(&LocalizationManager_TypeInfo, v9);
    sub_1BDB878(&NetworkManager_TypeInfo, v10);
    sub_1BDB878(&string_TypeInfo, v11);
    this = (EventRewardAnotherPayListViewItemDraw_o *)sub_1BDB878(&StringLiteral_1985/*"ANOTHER_PAY_ITEM_MULTI_LIST_SKILL_NONE"*/, v12);
    byte_4B3F3F8 = 1;
  }
  entity = 0LL;
  v23 = 0LL;
  ...
  if ( !this )
    goto LABEL_43;
  ItemIconComponent__SetItem_39931520((ItemIconComponent_o *)this, ItemEntity_k__BackingField, -1, 1, 0LL);
  ...
  if ( ItemEntity_k__BackingField->fields.type == 40 )
  {
    ...
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    v17 = DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_SkillMaster___);
    this = (EventRewardAnotherPayListViewItemDraw_o *)DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_SkillLvMaster___);
    if ( !v17 )
      goto LABEL_43;
...
LABEL_43:
  ...
  else
  {
    ...
    this = (EventRewardAnotherPayListViewItemDraw_o *)LocalizationManager__Get(
                                                        (System_String_o *)StringLiteral_1985/*"ANOTHER_PAY_ITEM_MULTI_LIST_SKILL_NONE"*/,
                                                        0LL);
    if ( !v22 )
      goto LABEL_43;
