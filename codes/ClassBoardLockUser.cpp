        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0C0C9 & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_NetworkManager_getRequest_ClassBoardReleaseLockRequest___, v5);
  ...
  Request_object = NetworkManager__getRequest_object_(
                     v9,
                     (const MethodInfo_2ECB448 *)Method_NetworkManager_getRequest_ClassBoardReleaseLockRequest___);
