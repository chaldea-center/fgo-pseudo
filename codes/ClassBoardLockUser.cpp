        ...
        const MethodInfo *method)
{
  ...
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.squareEntity, (int32_t)masterEntity, v5, v6, v7, v8, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7B4D1 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_ClassBoardSquareUser_OnReleaseResponse__);
    sub_1D0F0B4(&Method_NetworkManager_getRequest_ClassBoardReleaseLockRequest___);
  ...
  Request_object = NetworkManager__getRequest_object_(
                     v5,
                     (const MethodInfo_32DC000 *)Method_NetworkManager_getRequest_ClassBoardReleaseLockRequest___);
