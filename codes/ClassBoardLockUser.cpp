        ...
        const MethodInfo *method)
{
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.squareEntity, (int32_t)masterEntity, v5, v6, v7, v8, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D3471F & 1) == 0 )
  {
    sub_1C93AD4(&Method_ClassBoardSquareUser_OnReleaseResponse__);
    sub_1C93AD4(&Method_NetworkManager_getRequest_ClassBoardReleaseLockRequest___);
  ...
  Request_object = NetworkManager__getRequest_object_(
                     v5,
                     (const MethodInfo_322FB9C *)Method_NetworkManager_getRequest_ClassBoardReleaseLockRequest___);
  ...
  ClassBoardReleaseLockRequest__beginRequest((ClassBoardReleaseLockRequest_o *)Request_object, data, 0);
}