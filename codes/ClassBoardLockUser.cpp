        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF2334 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_NetworkManager_getRequest_ClassBoardReleaseLockRequest___);
  ...
  Request_object = NetworkManager__getRequest_object_(
                     v5,
                     (const MethodInfo_31FABE0 *)Method_NetworkManager_getRequest_ClassBoardReleaseLockRequest___);
