        ...
        const MethodInfo *method)
{
  ...
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.squareEntity, (int32_t)masterEntity, v5, v6, v7, v8, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D305AD & 1) == 0 )
  {
    sub_1C94098(&Method_ClassBoardSquareUser_OnReleaseResponse__);
    sub_1C94098(&Method_NetworkManager_getRequest_ClassBoardReleaseLockRequest___);
  ...
  Request_object = NetworkManager__getRequest_object_(
                     v5,
                     (const MethodInfo_32282A8 *)Method_NetworkManager_getRequest_ClassBoardReleaseLockRequest___);
