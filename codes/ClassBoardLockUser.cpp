        ...
        const MethodInfo *method)
{
  ...
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.squareEntity, (int64_t)masterEntity, v5, v6, v7, v8, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3A748 & 1) == 0 )
  {
    sub_1BD3458(&Method_ClassBoardSquareUser_OnReleaseResponse__, callback);
    sub_1BD3458(&Method_NetworkManager_getRequest_ClassBoardReleaseLockRequest___, v5);
  ...
  Request_object = NetworkManager__getRequest_object_(
                     v9,
                     (const MethodInfo_2FB5954 *)Method_NetworkManager_getRequest_ClassBoardReleaseLockRequest___);
