        ...
        const MethodInfo *method)
{
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.squareEntity, (int32_t)masterEntity, v5, v6, v7, v8, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E0879F & 1) == 0 )
  {
    sub_1CE6700(&Method_ClassBoardSquareUser_OnReleaseResponse__);
    sub_1CE6700(&Method_NetworkManager_getRequest_ClassBoardReleaseLockRequest___);
  ...
  Request_object = NetworkManager__getRequest_object_(
                     v5,
                     (const MethodInfo_328F954 *)Method_NetworkManager_getRequest_ClassBoardReleaseLockRequest___);
