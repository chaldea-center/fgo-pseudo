void __fastcall BonusSelectSummonMsgInfo___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A2A6BA & 1) == 0 )
  {
    sub_1B761C0(&BonusSelectSummonMsgInfo_TypeInfo, v1);
    byte_4A2A6BA = 1;
  }
...
void __fastcall BonusSelectSummonMsgInfo___ctor(BonusSelectSummonMsgInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2A6B9 & 1) == 0 )
  {
    ...
    sub_1B761C0(&System_Collections_Generic_List_GameObject__TypeInfo, v3);
    byte_4A2A6B9 = 1;
  }
  v4 = (System_Collections_Generic_List_object__o *)sub_1B7640C(System_Collections_Generic_List_GameObject__TypeInfo);
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.menberList, (int32_t)v4, v5, v6);
...
void __fastcall BonusSelectSummonMsgInfo__Init(BonusSelectSummonMsgInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2A6B5 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_System_Collections_Generic_List_GameObject__GetEnumerator__, v5);
...
void __fastcall BonusSelectSummonMsgInfo__InitMsgLabel(BonusSelectSummonMsgInfo_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B7641C(msgLabelSplitTop, method);
  }
  UILabel__set_text(msgLabelSplitTop, string_TypeInfo->static_fields->Empty, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  __int64 v41; // x8
  __int64 v42; // [xsp+8h] [xbp-68h] BYREF

  if ( (byte_4A2A6B7 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMaster_GiftMaster___, *(_QWORD *)&gachaId);
    ...
    sub_1B761C0(&Method_UnityEngine_GameObject_GetComponent_BonusSelectSummonMsgInfoMenber___, v14);
    sub_1B761C0(&Method_System_Collections_Generic_List_GameObject__Add__, v15);
    sub_1B761C0(&LocalizationManager_TypeInfo, v16);
    sub_1B761C0(&Method_UnityEngine_Object_Instantiate_GameObject____75989608, v17);
    sub_1B761C0(&UnityEngine_Object_TypeInfo, v18);
    sub_1B761C0(&StringLiteral_3801/*"CONFIRM_BONUS_SELECT_SUMMON_INFO"*/, v19);
    byte_4A2A6B7 = 1;
  }
  v42 = 0LL;
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3801/*"CONFIRM_BONUS_SELECT_SUMMON_INFO"*/, 0LL);
  if ( !selectInfoLabel )
    goto LABEL_38;
          ...
          *(_QWORD *)&tryGetBonusSelectData->fields.extra_arg) & 1) != 0 )
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)DataManager__GetMaster_object_((const MethodInfo_2E623B4 *)Method_DataManager_GetMaster_ServantMaster___);
    if ( !v42 )
      goto LABEL_38;
    v25 = *(_QWORD *)(v42 + 24);
    if ( v25 )
    {
      ...
      if ( v26 >= 1 )
      {
        ...
        while ( 1 )
        {
          ...
          if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
          gameObject = (UnityEngine_GameObject_o *)UnityEngine_Object__Instantiate_object__49174716(
          ...
          gameObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                     gameObject,
                                                     (const MethodInfo_2EB19B8 *)Method_UnityEngine_GameObject_GetComponent_BonusSelectSummonMsgInfoMenber___);
          if ( !gameObject )
            break;
          ...
          else
          {
            ...
            *(_QWORD *)(v41 + 32) = v32;
            sub_1B76164((ServantStatusBattleListViewItem_o *)(v41 + 32), (int32_t)v32, v36, v37);
          }
          v26 = *(_DWORD *)(v25 + 24);
          if ( (int)++v28 >= v26 )
            goto LABEL_35;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A6B6 & 1) == 0 )
  {
    sub_1B761C0(&BonusSelectSummonMsgInfo_TypeInfo, *(_QWORD *)&gachaId);
    byte_4A2A6B6 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B7641C(msgLabelSplitTop, v13);
  }
...
LABEL_8:
  ...
  if ( v8 != 2 )
    goto LABEL_8;
  v9 = (Il2CppObject *)sub_19B93EC;
LABEL_6:
  this->fields.m_target = v9;
LABEL_9:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19B9364;
}
