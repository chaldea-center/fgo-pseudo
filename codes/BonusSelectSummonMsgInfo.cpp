void __fastcall BonusSelectSummonMsgInfo___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BB0CC6 & 1) == 0 )
  {
    sub_1C13D24(&BonusSelectSummonMsgInfo_TypeInfo, v1);
    byte_4BB0CC6 = 1;
  }
...
void __fastcall BonusSelectSummonMsgInfo___ctor(BonusSelectSummonMsgInfo_o *this, const MethodInfo *method)
{
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.menberList, (int64_t)v4, v5, v6, v7, v8, v9, v10);
...
void __fastcall BonusSelectSummonMsgInfo__InitMsgLabel(BonusSelectSummonMsgInfo_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C13F80(msgLabelSplitTop, method);
  }
  UILabel__set_text(msgLabelSplitTop, string_TypeInfo->static_fields->Empty, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB0CC3 & 1) == 0 )
  {
    sub_1C13D24(&Method_DataManager_GetMaster_GiftMaster___, *(_QWORD *)&gachaId);
    ...
    sub_1C13D24(&Method_UnityEngine_GameObject_GetComponent_BonusSelectSummonMsgInfoMenber___, v14);
    sub_1C13D24(&Method_System_Collections_Generic_List_GameObject__Add__, v15);
    sub_1C13D24(&LocalizationManager_TypeInfo, v16);
    sub_1C13D24(&Method_UnityEngine_Object_Instantiate_GameObject____77555680, v17);
    sub_1C13D24(&UnityEngine_Object_TypeInfo, v18);
    sub_1C13D24(&StringLiteral_3847/*"COND_TYPE_SERVANT_LEVEL"*/, v19);
    byte_4BB0CC3 = 1;
  }
  v46 = 0LL;
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3847/*"COND_TYPE_SERVANT_LEVEL"*/, 0LL);
  if ( !selectInfoLabel )
    goto LABEL_38;
          ...
          *(_QWORD *)&tryGetBonusSelectData->fields.extra_arg) & 1) != 0 )
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)DataManager__GetMaster_object_((const MethodInfo_2F8F418 *)Method_DataManager_GetMaster_ServantMaster___);
    if ( !v46 )
      goto LABEL_38;
    v25 = *(_QWORD *)(v46 + 24);
    if ( v25 )
      ...
      if ( v26 >= 1 )
      {
        ...
        while ( 1 )
        {
          ...
          gameObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                     gameObject,
                                                     (const MethodInfo_2FDF9FC *)Method_UnityEngine_GameObject_GetComponent_BonusSelectSummonMsgInfoMenber___);
          if ( !gameObject )
            break;
          ...
          else
          {
            ...
            *(_QWORD *)(v45 + 32) = v32;
            sub_1C13CC8((PartyOrganizationUtility_o *)(v45 + 32), (int64_t)v32, v36, v37, v38, v39, v40, v41);
          }
          v26 = *(_DWORD *)(v25 + 24);
          if ( (int)++v28 >= v26 )
            goto LABEL_35;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB0CC2 & 1) == 0 )
  {
    sub_1C13D24(&BonusSelectSummonMsgInfo_TypeInfo, *(_QWORD *)&gachaId);
    byte_4BB0CC2 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C13F80(msgLabelSplitTop, v13);
  }
...
LABEL_8:
  ...
  if ( v12 != 2 )
    goto LABEL_8;
  v13 = (Il2CppObject *)sub_1A50ED8;
LABEL_6:
  this->fields.m_target = v13;
LABEL_9:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A50E50;
}
