void __fastcall BonusSelectSummonMsgInfo___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BC407F & 1) == 0 )
  {
    sub_1C1ABD4(&BonusSelectSummonMsgInfo_TypeInfo, v1);
    byte_4BC407F = 1;
  }
...
void __fastcall BonusSelectSummonMsgInfo___ctor(BonusSelectSummonMsgInfo_o *this, const MethodInfo *method)
{
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.menberList, (int64_t)v4, v5, v6, v7, v8, v9, v10);
...
void __fastcall BonusSelectSummonMsgInfo__Init(BonusSelectSummonMsgInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC407A & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_System_Collections_Generic_List_GameObject__GetEnumerator__, v5);
...
void __fastcall BonusSelectSummonMsgInfo__InitMsgLabel(BonusSelectSummonMsgInfo_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C1AE30(msgLabelSplitTop, method);
  }
  UILabel__set_text(msgLabelSplitTop, string_TypeInfo->static_fields->Empty, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC407C & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataManager_GetMaster_GiftMaster___, *(_QWORD *)&gachaId);
    ...
    sub_1C1ABD4(&Method_UnityEngine_GameObject_GetComponent_BonusSelectSummonMsgInfoMenber___, v14);
    ...
    sub_1C1ABD4(&StringLiteral_3850/*"CONFIRM_BONUS_SELECT_SUMMON_INFO"*/, v19);
    byte_4BC407C = 1;
  }
  v46 = 0LL;
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3850/*"CONFIRM_BONUS_SELECT_SUMMON_INFO"*/, 0LL);
  if ( !selectInfoLabel )
    goto LABEL_38;
          ...
          *(_QWORD *)&tryGetBonusSelectData->fields.extra_arg) & 1) != 0 )
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)DataManager__GetMaster_object_((const MethodInfo_2F9F43C *)Method_DataManager_GetMaster_ServantMaster___);
    if ( !v46 )
      goto LABEL_38;
    v25 = *(_QWORD *)(v46 + 24);
    if ( v25 )
      ...
      if ( v26 >= 1 )
      {
        ...
        while ( 1 )
        {
          ...
          gameObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                     gameObject,
                                                     (const MethodInfo_2FEFBC0 *)Method_UnityEngine_GameObject_GetComponent_BonusSelectSummonMsgInfoMenber___);
          if ( !gameObject )
            break;
          ...
          else
          {
            ...
            *(_QWORD *)(v45 + 32) = v32;
            sub_1C1AB78((PartyOrganizationUtility_o *)(v45 + 32), (int64_t)v32, v36, v37, v38, v39, v40, v41);
          }
          v26 = *(_DWORD *)(v25 + 24);
          if ( (int)++v28 >= v26 )
            goto LABEL_35;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC407B & 1) == 0 )
  {
    sub_1C1ABD4(&BonusSelectSummonMsgInfo_TypeInfo, *(_QWORD *)&gachaId);
    byte_4BC407B = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C1AE30(msgLabelSplitTop, v13);
  }
...
LABEL_9:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A57C50;
}
