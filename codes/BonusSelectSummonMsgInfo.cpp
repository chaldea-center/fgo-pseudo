void __fastcall BonusSelectSummonMsgInfo___cctor(const MethodInfo *method)
{
  if ( (byte_4A578C5 & 1) == 0 )
  {
    sub_1B885B0(&BonusSelectSummonMsgInfo_TypeInfo);
    byte_4A578C5 = 1;
  }
...
void __fastcall BonusSelectSummonMsgInfo___ctor(BonusSelectSummonMsgInfo_o *this, const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.menberList, (int32_t)v3, v4, v5);
...
void __fastcall BonusSelectSummonMsgInfo__InitMsgLabel(BonusSelectSummonMsgInfo_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B8880C(msgLabelSplitTop, method);
  }
  UILabel__set_text(msgLabelSplitTop, string_TypeInfo->static_fields->Empty, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A578C2 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_UnityEngine_GameObject_GetComponent_BonusSelectSummonMsgInfoMenber___);
    ...
    sub_1B885B0(&UnityEngine_Object_TypeInfo);
    sub_1B885B0(&StringLiteral_3802/*"CONFIRM_BONUS_SELECT_SUMMON_INFO"*/);
    byte_4A578C2 = 1;
  }
  v33 = 0LL;
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3802/*"CONFIRM_BONUS_SELECT_SUMMON_INFO"*/, 0LL);
  if ( !selectInfoLabel )
    goto LABEL_38;
          ...
          *(_QWORD *)&tryGetBonusSelectData->fields.extra_arg) & 1) != 0 )
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)DataManager__GetMaster_object_((const MethodInfo_2E7F8B4 *)Method_DataManager_GetMaster_ServantMaster___);
    if ( !v33 )
      goto LABEL_38;
    v16 = *(_QWORD *)(v33 + 24);
    if ( v16 )
      ...
      if ( v17 >= 1 )
      {
        ...
        while ( 1 )
        {
          ...
          gameObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                     gameObject,
                                                     (const MethodInfo_2ECEEB8 *)Method_UnityEngine_GameObject_GetComponent_BonusSelectSummonMsgInfoMenber___);
          if ( !gameObject )
            break;
          ...
          else
          {
            ...
            *(_QWORD *)(v32 + 32) = v23;
            sub_1B88554((ServantStatusBattleListViewItem_o *)(v32 + 32), (int32_t)v23, v27, v28);
          }
          v17 = *(_DWORD *)(v16 + 24);
          if ( (int)++v19 >= v17 )
            goto LABEL_35;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B8880C(msgLabelSplitTop, v13);
  }
...
LABEL_8:
  ...
  if ( v8 != 2 )
    goto LABEL_8;
  v9 = (Il2CppObject *)sub_19CA590;
LABEL_6:
  this->fields.m_target = v9;
LABEL_9:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19CA508;
}
