        ...
        const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.svtEnt, 0, v7, v8);
  this->fields.itemEnt = 0;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.itemEnt, 0, v9, v10);
  this->fields.equipEnt = 0;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.equipEnt, 0, v11, v12);
  this->fields.commandCodeEnt = 0;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.commandCodeEnt, 0, v13, v14);
  this->fields.usrPresentEnt = presentData;
  this->fields.checkBoxed = 0;
  this->fields.checkCount = -1;
  this->fields.blocked = 0;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.usrPresentEnt, (int32_t)presentData, v15, v16);
  if ( !presentData )
LABEL_21:
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.presentMsg, (int32_t)message, v19, v20);
  ...
  sub_1C32BC4(p_svtEnt, v24, v22, v23);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C366F9 & 1) == 0 )
  {
    ...
    this = (UserPresentListViewItem_o *)sub_1C32C20(&UserPresentBoxMaster_TypeInfo);
    byte_4C366F9 = 1;
  }
  v4->fields.sortValue0 = 0;
  if ( !sort )
    goto LABEL_22;
  if ( ListViewSort__GetFilter_43764188(sort, 13, 0) )
  {
...
System_String_o *UserPresentListViewItem__get_NameText(UserPresentListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C366FA & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_8710/*"MISSION_PEWARD_DETAIL_SVT_COSTUME"*/);
    sub_1C32C20(&StringLiteral_19066/*"error"*/);
    byte_4C366FA = 1;
  }
  if ( this->fields.svtEnt && Gift__IsServant_40327796(this->fields.giftType, 0) )
  {
...
LABEL_16:
  ...
  svtEnt = (ServantEntity_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8710/*"MISSION_PEWARD_DETAIL_SVT_COSTUME"*/, 0);
...
void UserPresentListViewItem__setBlocked(UserPresentListViewItem_o *this, bool blocked, const MethodInfo *method)
{
  ...
  if ( (byte_4C366FC & 1) == 0 )
  {
    ...
    sub_1C32C20(&UserPresentListViewObject_TypeInfo);
    byte_4C366FC = 1;
  }
