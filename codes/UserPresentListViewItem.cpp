        ...
        const MethodInfo *method)
{
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.svtEnt, 0, v7, v8);
  this->fields.itemEnt = 0;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.itemEnt, 0, v9, v10);
  this->fields.equipEnt = 0;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.equipEnt, 0, v11, v12);
  this->fields.commandCodeEnt = 0;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.commandCodeEnt, 0, v13, v14);
  this->fields.usrPresentEnt = presentData;
  this->fields.checkBoxed = 0;
  this->fields.checkCount = -1;
  this->fields.blocked = 0;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.usrPresentEnt, (int32_t)presentData, v15, v16);
  if ( !presentData )
LABEL_21:
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.presentMsg, (int32_t)message, v20, v21);
  ...
  sub_1C3E508(p_svtEnt, v25, v23, v24);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C55A89 & 1) == 0 )
  {
    ...
    this = (UserPresentListViewItem_o *)sub_1C3E564(&UserPresentBoxMaster_TypeInfo);
    byte_4C55A89 = 1;
  }
  v4->fields.sortValue0 = 0;
  if ( !sort )
    goto LABEL_22;
  if ( ListViewSort__GetFilter_43921776(sort, 13, 0) )
  {
...
System_String_o *UserPresentListViewItem__get_NameText(UserPresentListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.svtEnt && Gift__IsServant_40473420(this->fields.giftType, 0) )
  {
    svtEnt = this->fields.svtEnt;
    if ( svtEnt )
      return ServantEntity__getName(svtEnt, 0, -1, 0, 0);
LABEL_26:
    sub_1C3E7C0(svtEnt, v3);
  }
...
bool UserPresentListViewItem__isItemLimitedPeriod(UserPresentListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( usrPresentEnt )
  {
    if ( usrPresentEnt->fields.giftType == 2 )
    {
      itemEnt = this->fields.itemEnt;
      if ( !itemEnt )
        sub_1C3E7C0(usrPresentEnt, method);
...
void UserPresentListViewItem__setBlocked(UserPresentListViewItem_o *this, bool blocked, const MethodInfo *method)
{
  ...
  if ( (byte_4C55A8C & 1) == 0 )
  {
    ...
    sub_1C3E564(&UserPresentListViewObject_TypeInfo);
    byte_4C55A8C = 1;
  }
