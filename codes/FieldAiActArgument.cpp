        ...
        const MethodInfo *method)
{
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)v8, (int32_t)fieldData, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&task->fields.motionMessage, (int32_t)infoText, (int32_t)method, v3);
}
