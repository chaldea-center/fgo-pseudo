void CheckCombineEnalbleControl___ctor(CheckCombineEnalbleControl_o *this, const MethodInfo *method)
{
  ...
  v3 = (System_Collections_Generic_Dictionary_int__object__o *)sub_1C32E6C(System_Collections_Generic_Dictionary_int__List_int___TypeInfo);
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.cachedUserServantNpLvDict, (int32_t)v3, v4, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3B7AF & 1) == 0 )
  {
    ...
    this = (CheckCombineEnalbleControl_o *)sub_1C32C20(&CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
    byte_4C3B7AF = 1;
  }
  if ( !userSvtEntity )
    goto LABEL_48;
  ...
  *(_QWORD *)&v41.fields.fakeValue = v6;
  this = (CheckCombineEnalbleControl_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48887784(v41, 0);
    ...
    if ( costumeSvtIdList )
    {
      if ( costumeSvtIdList->fields._size >= 1 )
      {
        ...
        *(_QWORD *)&v42.fields.fakeValue = v9;
        v11 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48887784(v42, 0);
               ...
               (const MethodInfo_377BB10 *)Method_System_Collections_Generic_List_int__Contains__) )
        {
          ...
          *(_QWORD *)&v43.fields.fakeValue = v13;
          this = (CheckCombineEnalbleControl_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48887784(
                                                   v43,
                                                   0);
          if ( !v12 )
            goto LABEL_48;
                ...
                *(_QWORD *)&v45.fields.fakeValue = v24;
                ...
                if ( ((unsigned __int8)this & 1) != 0 )
                {
                  ...
                  *(_QWORD *)&v46.fields.fakeValue = v28;
                  v31 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48887784(v46, 0);
                  if ( v30 )
                  {
                    ...
                    *(_OWORD *)&v40.fields.fakeValue = v32;
                    ...
                    v39 = v40;
                    this = (CheckCombineEnalbleControl_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_48891308(
                                                             &v39,
                                                             0);
                    if ( !v27 )
                      goto LABEL_48;
        ...
        const MethodInfo *method)
{
  ...
  while ( v7 < friendshipExceedSvtIdList->fields._size )
  {
    ...
    *(_QWORD *)&v36.fields.fakeValue = v8;
    isExceedFriendshipMax = (void *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48887784(v36, 0);
  ...
  *(_QWORD *)&v37.fields.fakeValue = v12;
  isExceedFriendshipMax = (void *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48887784(v37, 0);
  if ( !servantMaster )
    goto LABEL_19;
  ...
  *(_OWORD *)&v34.fields.fakeValue = v15;
  if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
  v33 = v34;
  v18 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_48891308(&v33, 0);
  isExceedFriendshipMax = (void *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48887784(
...
LABEL_59:
        sub_1C32E84(isExceedFriendshipMax);
      if ( !userItemMaster )
        goto LABEL_19;
  ...
  *(_QWORD *)&v38.fields.fakeValue = v28;
  isExceedFriendshipMax = (void *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48887784(v38, 0);
  if ( !v27
  ...
  {
LABEL_19:
    sub_1C32E7C(isExceedFriendshipMax);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3B7AC & 1) == 0 )
  {
    ...
    sub_1C32C20(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    sub_1C32C20(&CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
    this = (CheckCombineEnalbleControl_o *)sub_1C32C20(&Method_SingletonTemplate_clsQuestCheck__get_Instance__);
    byte_4C3B7AC = 1;
  }
  entity = 0;
  v45 = 0;
  ...
  *(_QWORD *)&v46.fields.fakeValue = v8;
  v11 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48887784(v46, 0);
  ...
  if ( v10 )
  {
    ...
    *(_QWORD *)&v47.fields.fakeValue = v14;
    this = (CheckCombineEnalbleControl_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48887784(v47, 0);
    if ( !v13 )
      goto LABEL_52;
    if ( ServantLimitImageMaster__IsServantLimitCountSeal(v13, (int32_t)this, v11, 0) )
    {
      ...
      *(_QWORD *)&v48.fields.fakeValue = v16;
      v18 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48887784(v48, 0);
      ...
      {
        this = (CheckCombineEnalbleControl_o *)SingletonTemplate_object___get_Instance((const MethodInfo_39E2DF4 *)Method_SingletonTemplate_clsQuestCheck__get_Instance__);
        if ( this )
        {
...
LABEL_42:
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  v31 = DataManager__GetMaster_object_((const MethodInfo_30DD39C *)Method_DataManager_GetMaster_CombineLimitReleaseMaster___);
  ...
  *(_QWORD *)&v49.fields.fakeValue = v32;
  v35 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48887784(v49, 0);
  ...
  *(_QWORD *)&v50.fields.currentCryptoKey = v36;
  this = (CheckCombineEnalbleControl_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48887784(v50, 0);
  if ( !v34 )
    goto LABEL_52;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3B7AE & 1) == 0 )
  {
    ...
    this = (CheckCombineEnalbleControl_o *)sub_1C32C20(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    byte_4C3B7AE = 1;
  }
  if ( !usrData )
    goto LABEL_36;
  ...
  *(_QWORD *)&v27.fields.fakeValue = v7;
  CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48887784(v27, 0);
  if ( UserServantEntity__IsHeroine(usrData, 0) )
  {
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  this = (CheckCombineEnalbleControl_o *)DataManager__GetMaster_object_((const MethodInfo_30DD39C *)Method_DataManager_GetMaster_CommonConsumeMaster___);
  if ( !this )
    goto LABEL_36;
  ...
  {
    v13 = IdEntityList;
    v14 = (System_Collections_Generic_HashSet_int__o *)sub_1C32E6C(System_Collections_Generic_HashSet_int__TypeInfo);
...
void CheckCombineEnalbleControl__SetCombineEnableInfo(CheckCombineEnalbleControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3B7AA & 1) == 0 )
  {
    sub_1C32C20(&CombineEnableData_TypeInfo);
    sub_1C32C20(&Method_DataMasterBase_ServantMaster__ServantEntity__int__GetEntity__);
    sub_1C32C20(&Method_System_Collections_Generic_Dictionary_int__List_int___Clear__);
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.costumeSvtIdList, (int32_t)CostumeSvtIdList, v6, v7);
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.friendshipExceedSvtIdList, (int32_t)v8, v9, v10);
  ...
  System_Collections_Generic_Dictionary_int__object___Clear(
    ...
    (const MethodInfo_33EFEA4 *)Method_System_Collections_Generic_Dictionary_int__List_int___Clear__);
  ...
  if ( v11 >= 1 )
  {
    ...
    while ( v13 < (unsigned int)v11 )
    {
      ...
      *(_QWORD *)&v43.fields.fakeValue = v23;
      SelfUserGame = (void *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48887784(v43, 0);
      if ( !servantMaster )
        goto LABEL_26;
...
LABEL_24:
  v36 = (CombineEnableData_o *)sub_1C32E6C(CombineEnableData_TypeInfo);
  CombineEnableData___ctor(v36, 0);
  this->fields.combineEnalbeInfo = v36;
  p_combineEnalbeInfo = &this->fields.combineEnalbeInfo;
  sub_1C32BC4((CGThumbnailListItem_o *)p_combineEnalbeInfo, (int32_t)v36, v38, v39);
...
void CheckCombineEnalbleControl__SetMasters(CheckCombineEnalbleControl_o *this, const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.servantMaster, (int32_t)MasterData_object, v5, v6);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39E2904 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_17;
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.userServantMaster, (int32_t)v7, v8, v9);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39E2904 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_17;
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.userServantStorageMaster, (int32_t)v10, v11, v12);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39E2904 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_17;
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.userServantCollectionMaster, (int32_t)v13, v14, v15);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39E2904 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_17;
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.combineLimitMaster, (int32_t)v16, v17, v18);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39E2904 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_17;
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.userItemMaster, (int32_t)v19, v20, v21);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39E2904 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_17;
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.skillMaster, (int32_t)v22, v23, v24);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39E2904 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_17;
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.combineSkillMaster, (int32_t)v25, v26, v27);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39E2904 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_17;
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.treasureDvcMaster, (int32_t)v28, v29, v30);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39E2904 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_17;
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.treasureDvcLvMaster, (int32_t)v31, v32, v33);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39E2904 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_17;
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.servantCostumeMaster, (int32_t)v34, v35, v36);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39E2904 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance
    || (v37 = DataManager__GetMasterData_object_(
        ...
        sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.cosReleaseMaster, (int32_t)v37, v38, v39),
...
LABEL_17:
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.friendshipMaster, (int32_t)v40, v41, v42);
}
