...
bool __fastcall ShopEntity__CheckEquipItem(ShopEntity_o *this, int32_t *imageId, const MethodInfo *method)
{
  ...
  if ( (byte_4A70752 & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMasterData_EquipMaster___, imageId);
    ...
    sub_1B90010(&Method_DataMasterBase_EquipMaster__EquipEntity__int__TryGetEntity__, v7);
    sub_1B90010(&Method_DataMasterBase_QuestMaster__QuestEntity__int__TryGetEntity__, v8);
...
LABEL_40:
        ...
        else if ( saveDataMapList_high == 1 )
        {
          ...
          *(_QWORD *)&v29.fields.fakeValue = v19;
          Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46506376(v29, 0LL);
          if ( (int)Instance >= 1 )
          {
            if ( entity )
            {
...
LABEL_34:
              ...
              *imageId = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46506376(v31, 0LL);
              goto LABEL_38;
            }
            goto LABEL_40;
          }
...
System_String_o *__fastcall ShopEntity__GetAddMessage(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A70757 & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_16694/*"addMessage"*/, v3);
  ...
  if ( !script
    || !System_Collections_Generic_Dictionary_object__object___TryGetValue(
          ...
          (Il2CppObject *)StringLiteral_16694/*"addMessage"*/,
          &value,
...
System_Int32_array *__fastcall ShopEntity__GetAnotherPayItemIds(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A70738 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_System_Collections_Generic_List_object__ConvertAll_int___, v4);
    ...
    sub_1B90010(&Method_ShopEntity___c__GetAnotherPayItemIds_b__58_0__, v7);
    sub_1B90010(&ShopEntity___c_TypeInfo, v8);
    sub_1B90010(&StringLiteral_16815/*"anotherItemIds"*/, v9);
    byte_4A70738 = 1;
  }
  value = 0LL;
  ...
  if ( result )
  {
    if ( System_Collections_Generic_Dictionary_object__object___TryGetValue(
           ...
           (Il2CppObject *)StringLiteral_16815/*"anotherItemIds"*/,
           &value,
           (const MethodInfo_31DA5C0 *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
    {
      v11 = value;
      if ( value )
      {
          ...
          && (System_Collections_Generic_List_object__c *)v11->klass->_2.typeHierarchy[methodPtr_low - 1] == System_Collections_Generic_List_object__TypeInfo )
        {
          ...
          if ( !_9__58_0 )
          {
            ...
            _9__58_0 = (System_Converter_object__int__o *)sub_1B9025C(System_Converter_object__int__TypeInfo);
            ...
            sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&static_fields->__9__58_0, (int32_t)_9__58_0, v17, v18);
          }
...
int32_t __fastcall ShopEntity__GetAnotherPayType(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B90010(&Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__, method);
    sub_1B90010(&PayType_Type_TypeInfo, v3);
    sub_1B90010(&StringLiteral_16818/*"anotherPayType"*/, v4);
    byte_4A70739 = 1;
  }
  value = 0LL;
  script = this->fields.script;
  if ( script )
  {
    if ( System_Collections_Generic_Dictionary_object__object___TryGetValue(
           (System_Collections_Generic_Dictionary_object__object__o *)script,
           (Il2CppObject *)StringLiteral_16818/*"anotherPayType"*/,
           &value,
           (const MethodInfo_31DA5C0 *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
    {
      if ( !value )
...
int32_t __fastcall ShopEntity__GetCommonConsumeBuyableCount(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  do
  {
    if ( (unsigned int)v6 >= (unsigned int)v4 )
      sub_1B90274(CommonConsumeEntities, v3);
    v8 = v5->m_Items[v6];
    if ( !v8 )
      sub_1B9026C(CommonConsumeEntities, v3);
    if ( v8->fields.num < 1 )
    {
      v9 = 0;
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A70759 & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMaster_CommonConsumeMaster___, method);
...
int32_t __fastcall ShopEntity__GetFreeShopCondId(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A7071F & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__, v3);
    sub_1B90010(&StringLiteral_19652/*"freeShopCondId"*/, v4);
    byte_4A7071F = 1;
  }
  value = 0LL;
  script = this->fields.script;
...
int64_t __fastcall ShopEntity__GetFreeShopReleaseDate(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A70720 & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_19655/*"freeShopReleaseDate"*/, v4);
    byte_4A70720 = 1;
  }
  value = 0LL;
  ...
  if ( result )
  {
    if ( System_Collections_Generic_Dictionary_object__object___TryGetValue(
           (System_Collections_Generic_Dictionary_object__object__o *)result,
           (Il2CppObject *)StringLiteral_19655/*"freeShopReleaseDate"*/,
           &value,
           (const MethodInfo_31DA5C0 *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
    {
      if ( !value )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A7073F & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMasterData_ItemMaster___, nameText);
    sub_1B90010(&Method_DataManager_GetMasterData_ServantMaster___, v9);
    sub_1B90010(&Method_DataMasterBase_ItemMaster__ItemEntity__int__GetEntity__, v10);
    ...
    sub_1B90010(&StringLiteral_14822/*"UNIT_INFO"*/, v15);
    sub_1B90010(&StringLiteral_11957/*"SERVANT_UNIT"*/, v16);
    sub_1B90010(&StringLiteral_5746/*"EXCEPT_SERVANT_UNIT"*/, v17);
    sub_1B90010(&StringLiteral_11609/*"SERVANT_EQUIP_UNIT"*/, v18);
    sub_1B90010(&StringLiteral_1/*""*/, v19);
    byte_4A7073F = 1;
  }
  name = this->fields.name;
  *nameText = name;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)nameText, (int32_t)name, (int32_t)countText, isSend);
  purchaseType = this->fields.purchaseType;
  switch ( purchaseType )
  {
    case 1:
    ...
    case 5:
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v24 = &StringLiteral_14822/*"UNIT_INFO"*/;
      goto LABEL_32;
    case 4:
      goto LABEL_9;
    case 6:
...
LABEL_41:
            ...
            || ServantEntity__get_IsServantMaterialTd(v36, 0LL) )
          {
            if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
            v24 = &StringLiteral_11957/*"SERVANT_UNIT"*/;
          }
          else
          {
            ...
            if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
            if ( IsServantEquip )
              v24 = &StringLiteral_11609/*"SERVANT_EQUIP_UNIT"*/;
            else
              v24 = &StringLiteral_5746/*"EXCEPT_SERVANT_UNIT"*/;
          }
LABEL_32:
          ...
          *countText = v42;
          sub_1B8FFB4((ServantStatusBattleListViewItem_o *)countText, (int32_t)v42, v43, v44);
          return;
        }
LABEL_10:
        v25 = (_DWORD)this + 64;
...
LABEL_16:
      v28 = countText;
LABEL_17:
      sub_1B8FFB4((ServantStatusBattleListViewItem_o *)v28, (int32_t)v27, v21, v22);
      return;
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A7072F & 1) == 0 )
  {
    sub_1B90010(&Method_System_Array_FindAll_UserPresentBoxEntity___, isWithoutPresents);
    ...
    sub_1B90010(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, v9);
    sub_1B90010(&System_Predicate_UserPresentBoxEntity__TypeInfo, v10);
    sub_1B90010(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v11);
    sub_1B90010(&Method_ShopEntity___c__GetIsAlreadyInPossession_b__49_0__, v12);
    sub_1B90010(&ShopEntity___c_TypeInfo, v13);
    byte_4A7072F = 1;
  }
  ...
  if ( !_9__49_0 )
  {
    ...
    _9__49_0 = (System_Predicate_object__o *)sub_1B9025C(System_Predicate_UserPresentBoxEntity__TypeInfo);
    ...
    sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&static_fields->__9__49_0, (int32_t)_9__49_0, v25, v26);
  }
  Instance = (int64_t)System_Array__FindAll_object_(
                        v21,
                        (System_Predicate_T__o *)_9__49_0,
                        (const MethodInfo_2F8734C *)Method_System_Array_FindAll_UserPresentBoxEntity___);
  if ( !v17
    ...
    if ( v38 >= 1 )
    {
      ...
      while ( v39 < v38 )
      {
        ...
        *(_QWORD *)&v49.fields.fakeValue = v41;
        Instance = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46506376(v49, 0LL);
    ...
    if ( v43 >= 1 )
    {
      ...
      while ( v44 < v43 )
      {
        ...
        *(_QWORD *)&v50.fields.fakeValue = v46;
        Instance = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46506376(v50, 0LL);
        if ( v34 == (_DWORD)Instance )
          return 1;
        v43 = *(_DWORD *)(v31 + 24);
        if ( (int)++v44 >= v43 )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A70741 & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMasterData_ServantMaster___, buyItemNum);
    sub_1B90010(&Method_DataManager_GetMasterData_SetItemMaster___, v13);
        ...
        const MethodInfo *method)
{
  if ( (byte_4A70755 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_22431/*"overwriteName"*/, defaultValue);
    byte_4A70755 = 1;
  }
  return EntityScriptUtil__GetStringValue(
           this->fields.script,
           (System_String_o *)StringLiteral_22431/*"overwriteName"*/,
           defaultValue,
           0LL);
}
...
int32_t __fastcall ShopEntity__GetPurchaseShop(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A7073D & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMasterData_ShopReleaseMaster___, method);
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_2E8E21C *)Method_DataManager_GetMasterData_ShopReleaseMaster___)) == 0LL )
  {
...
ServantEntity_o *__fastcall ShopEntity__GetRelateServantEntity(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A7074D & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_DataManager_GetMasterData_ShopReleaseMaster___, v3);
  ...
  if ( this->fields.purchaseType != 4 )
    return 0LL;
  Instance = (ShopReleaseEntity_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_374C890 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_17;
...
int32_t __fastcall ShopEntity__GetRemainDays(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B90010(&Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__, method);
    sub_1B90010(&StringLiteral_8243/*"LIMITED_SHOP_REMAIN_DAYS"*/, v3);
    sub_1B90010(&StringLiteral_8711/*"MONTHLY_SHOP_REMAIN_DAYS"*/, v4);
    sub_1B90010(&StringLiteral_22887/*"remainDays"*/, v5);
    byte_4A7073A = 1;
  }
  value = 0LL;
  script = this->fields.script;
  if ( !script
    || !System_Collections_Generic_Dictionary_object__object___TryGetValue(
          (System_Collections_Generic_Dictionary_object__object__o *)script,
          (Il2CppObject *)StringLiteral_22887/*"remainDays"*/,
          &value,
          (const MethodInfo_31DA5C0 *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
  {
    ...
    if ( (flag & 0x800) != 0 )
    {
      v11 = &StringLiteral_8243/*"LIMITED_SHOP_REMAIN_DAYS"*/;
    }
    else
    {
      if ( (flag & 0x1000) == 0 )
      ...
      v11 = &StringLiteral_8711/*"MONTHLY_SHOP_REMAIN_DAYS"*/;
    }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B90010(&Method_DataManager_GetMasterData_ServantMaster___, buyItemNum);
    sub_1B90010(&Method_DataManager_GetMasterData_SetItemMaster___, v15);
    sub_1B90010(&Method_DataManager_GetMasterData_ShopGroupMaster___, v16);
...
bool __fastcall ShopEntity__IsAnotherItemBuyable(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !*(_DWORD *)(AnotherPayItemIds + 24) )
    sub_1B90274(AnotherPayItemIds, v9);
  ...
  if ( !Master_object )
LABEL_24:
    sub_1B9026C(AnotherPayItemIds, v9);
...
LABEL_21:
  ...
  AnotherPayItemIds = (int64_t)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_374C890 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !AnotherPayItemIds )
    goto LABEL_24;
  MasterData_object = DataManager__GetMasterData_object_(
...
bool __fastcall ShopEntity__IsAnotherPayCommonReleaseOpen(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B90010(&System_Convert_TypeInfo, method);
    sub_1B90010(&Method_DataManager_GetMasterData_CommonReleaseMaster___, v3);
    sub_1B90010(&Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__, v4);
    sub_1B90010(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v5);
    sub_1B90010(&StringLiteral_24393/*"useAnotherPayCommonReleaseId"*/, v6);
    byte_4A70737 = 1;
  }
  value = 0LL;
  script = this->fields.script;
  if ( script
    && System_Collections_Generic_Dictionary_object__object___TryGetValue(
         (System_Collections_Generic_Dictionary_object__object__o *)script,
         (Il2CppObject *)StringLiteral_24393/*"useAnotherPayCommonReleaseId"*/,
         &value,
         (const MethodInfo_31DA5C0 *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
  {
    v8 = value;
...
bool __fastcall ShopEntity__IsCondType_39865376(ShopEntity_o *this, int64_t userId, const MethodInfo *method)
{
  __int64 v5; // x1
  DataManager_o *Instance; // x0
  __int64 v7; // x1
  ...
  if ( (byte_4A7073C & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMasterData_UserShopMaster___, userId);
    sub_1B90010(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v5);
    byte_4A7073C = 1;
  }
  Instance = (DataManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_374C890 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance
    || (Instance = (DataManager_o *)DataManager__GetMasterData_object_(
                                      Instance,
                                      (const MethodInfo_2E8E21C *)Method_DataManager_GetMasterData_UserShopMaster___)) == 0LL
...
bool __fastcall ShopEntity__IsEligibleForFreeFeaturesTheCostumeRelease(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A70725 & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMasterData_ServantCostumeReleaseMaster___, method);
    sub_1B90010(&Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__, v3);
    sub_1B90010(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v4);
    sub_1B90010(&StringLiteral_19652/*"freeShopCondId"*/, v5);
    byte_4A70725 = 1;
  }
  value = 0LL;
  *(_QWORD *)costumeId = 0LL;
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_2E8E21C *)Method_DataManager_GetMasterData_ServantCostumeReleaseMaster___)) == 0LL )
  {
...
bool __fastcall ShopEntity__IsEnable(ShopEntity_o *this, int64_t nowTime, const MethodInfo *method)
{
  ...
  if ( (byte_4A70726 & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMasterData_EventDetailMaster___, nowTime);
    sub_1B90010(&Method_DataManager_GetMasterData_ShopReleaseMaster___, v5);
    sub_1B90010(&Method_DataManager_GetMasterData_UserEventMaster___, v6);
...
bool __fastcall ShopEntity__IsEventQuest(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  while ( 1 )
  {
    ...
    {
LABEL_14:
      p_method = sub_1BE1FF0(v18, System_Collections_IEnumerator_TypeInfo, 0LL);
    }
    ...
    {
LABEL_21:
      v27 = sub_1BE1FF0(v18, System_Collections_Generic_IEnumerator_DataEntityBase__TypeInfo, 0LL);
    }
...
LABEL_36:
  ...
  {
LABEL_32:
    v33 = sub_1BE1FF0(v18, System_IDisposable_TypeInfo, 0LL);
  }
...
bool __fastcall ShopEntity__IsExchangeServantIconDisplayTarget(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B90010(&Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__, method);
    sub_1B90010(&StringLiteral_22887/*"remainDays"*/, v3);
    byte_4A70735 = 1;
  }
  value = 0LL;
  script = this->fields.script;
...
bool __fastcall ShopEntity__IsFulFilledFreeExchangeCondition(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !System_Collections_Generic_Dictionary_object__object___ContainsKey(
    ...
    return 0;
  script = (System_Collections_Generic_Dictionary_object__object__o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_374C890 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !script
    || (MasterData_object = DataManager__GetMasterData_object_(
...
bool __fastcall ShopEntity__IsNotClearNotShopPurchase(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B90010(&Method_DataManager_GetMasterData_ShopReleaseMaster___, method);
    sub_1B90010(&Method_System_Collections_Generic_List_Enumerator_ShopReleaseEntity__Dispose__, v3);
    sub_1B90010(&Method_System_Collections_Generic_List_Enumerator_ShopReleaseEntity__MoveNext__, v4);
    sub_1B90010(&Method_System_Collections_Generic_List_Enumerator_ShopReleaseEntity__get_Current__, v5);
    sub_1B90010(&Method_System_Collections_Generic_List_ShopReleaseEntity__GetEnumerator__, v6);
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    (const MethodInfo_35114B8 *)Method_System_Collections_Generic_List_ShopReleaseEntity__GetEnumerator__);
  while ( 1 )
  {
    v14 = System_Collections_Generic_List_Enumerator_object___MoveNext(
            &v18,
            (const MethodInfo_328A150 *)Method_System_Collections_Generic_List_Enumerator_ShopReleaseEntity__MoveNext__);
    v16 = v14;
    if ( !v14 )
      break;
...
LABEL_18:
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v18,
    (const MethodInfo_328A14C *)Method_System_Collections_Generic_List_Enumerator_ShopReleaseEntity__Dispose__);
  return v16 && v17 == 6;
}
...
bool __fastcall ShopEntity__IsPaidExchange(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  int32_t v82; // w2
  int32_t v83; // w3
  const MethodInfo_362E09C *v84; // x3
  bool v85; // w20
  ...
  if ( (byte_4A70724 & 1) == 0 )
  {
    sub_1B90010(&Method_BasicHelper_Any_UserQuestEntity___, method);
    sub_1B90010(&Method_DataManager_GetMasterData_CommonReleaseMaster___, v3);
    sub_1B90010(&Method_DataManager_GetMasterData_UserQuestMaster___, v4);
    ...
    sub_1B90010(&Method_System_Linq_Enumerable_Min_UserQuestEntity___, v7);
    sub_1B90010(&Method_System_Linq_Enumerable_ToArray_CommonReleaseEntity___, v8);
    sub_1B90010(&Method_System_Linq_Enumerable_Where_CommonReleaseEntity___, v9);
    sub_1B90010(&Method_System_Linq_Enumerable_Where_UserQuestEntity___, v10);
    sub_1B90010(&System_Func_UserQuestEntity__long__TypeInfo, v11);
    sub_1B90010(&System_Func_UserQuestEntity__bool__TypeInfo, v12);
    sub_1B90010(&System_Func_CommonReleaseEntity__bool__TypeInfo, v13);
    sub_1B90010(&long_TypeInfo, v14);
    sub_1B90010(&Method_System_Collections_Generic_List_UserQuestEntity__Add__, v15);
    sub_1B90010(&Method_System_Collections_Generic_List_UserQuestEntity___ctor__, v16);
    sub_1B90010(&Method_System_Collections_Generic_List_UserQuestEntity__get_Count__, v17);
    sub_1B90010(&System_Collections_Generic_List_UserQuestEntity__TypeInfo, v18);
    sub_1B90010(&NetworkManager_TypeInfo, v19);
    sub_1B90010(&Method_System_Nullable_long__GetValueOrDefault__, v20);
    sub_1B90010(&Method_System_Nullable_long___ctor__, v21);
    sub_1B90010(&Method_System_Nullable_long__get_HasValue__, v22);
    sub_1B90010(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v23);
    sub_1B90010(&Method_ShopEntity___c__IsPaidExchange_b__36_0__, v24);
    sub_1B90010(&Method_ShopEntity___c__IsPaidExchange_b__36_1__, v25);
    sub_1B90010(&Method_ShopEntity___c__IsPaidExchange_b__36_2__, v26);
    sub_1B90010(&Method_ShopEntity___c__IsPaidExchange_b__36_3__, v27);
    sub_1B90010(&ShopEntity___c_TypeInfo, v28);
    sub_1B90010(&StringLiteral_19655/*"freeShopReleaseDate"*/, v29);
    byte_4A70724 = 1;
  }
  v95 = 0LL;
  v96 = 0LL;
  ...
  if ( *(Il2CppClass **)(*(_QWORD *)Instance + 64LL) == long_TypeInfo->_1.element_class )
  {
    ...
    if ( List )
    {
      ...
      if ( !_9__36_0 )
      {
        ...
        _9__36_0 = (System_Func_object__bool__o *)sub_1B9025C(System_Func_CommonReleaseEntity__bool__TypeInfo);
        ...
        sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&static_fields->__9__36_0, (int32_t)_9__36_0, v49, v50);
      }
      ...
      v53 = (System_Collections_Generic_List_object__o *)sub_1B9025C(System_Collections_Generic_List_UserQuestEntity__TypeInfo);
        ...
        while ( 1 )
        {
          ...
          if ( Instance )
          {
            ...
            else
            {
              ...
              sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v63 + 4), v62, v57, v58);
            }
          }
          max_length = v52->max_length;
...
LABEL_39:
      ...
      if ( !_9__36_1 )
      {
        ...
        _9__36_1 = (System_Func_object__bool__o *)sub_1B9025C(System_Func_UserQuestEntity__bool__TypeInfo);
        ...
        sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&v67->__9__36_1, (int32_t)_9__36_1, v68, v69);
      }
      if ( !BasicHelper__Any_object_(
              (System_Collections_Generic_List_T__o *)v53,
              (System_Func_T__bool__o *)_9__36_1,
              (const MethodInfo_2E795E4 *)Method_BasicHelper_Any_UserQuestEntity___) )
        goto LABEL_62;
      ...
      if ( !_9__36_2 )
      {
        ...
        _9__36_2 = (System_Func_object__bool__o *)sub_1B9025C(System_Func_UserQuestEntity__bool__TypeInfo);
        ...
        sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&v73->__9__36_2, (int32_t)_9__36_2, v74, v75);
      }
      v76 = System_Linq_Enumerable__Where_object_(
              ...
              (const MethodInfo_2ECC92C *)Method_System_Linq_Enumerable_Where_UserQuestEntity___);
      ...
      if ( !_9__36_3 )
      {
        ...
        _9__36_3 = (System_Func_T__TResult__o *)sub_1B9025C(System_Func_UserQuestEntity__long__TypeInfo);
        ...
        sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&v81->__9__36_3, (int32_t)_9__36_3, v82, v83);
      }
      v97.fields.value = System_Linq_Enumerable__Min_object__48988608(
                           v78,
                           (System_Func_TSource__long__o *)_9__36_3,
                           (const MethodInfo_2EB81C0 *)Method_System_Linq_Enumerable_Min_UserQuestEntity___);
...
bool __fastcall ShopEntity__IsPossessionInfoDisp(ShopEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4A70756 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_20836/*"isPossessionInfoDisp"*/, method);
    byte_4A70756 = 1;
  }
  return EntityScriptUtil__ScriptHasKey(this->fields.script, (System_String_o *)StringLiteral_20836/*"isPossessionInfoDisp"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A7072A & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMasterData_ShopReleaseMaster___, message);
...
bool __fastcall ShopEntity__IsServantGet(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A70730 & 1) == 0 )
  {
    sub_1B90010(&Method_System_Array_FindAll_UserPresentBoxEntity___, method);
    sub_1B90010(&Method_DataManager_GetMaster_UserPresentBoxMaster___, v3);
    sub_1B90010(&Method_DataManager_GetMaster_UserServantCollectionMaster___, v4);
    sub_1B90010(&DataManager_TypeInfo, v5);
    sub_1B90010(&NetworkManager_TypeInfo, v6);
    sub_1B90010(&System_Predicate_UserPresentBoxEntity__TypeInfo, v7);
    sub_1B90010(&Method_ShopEntity___c__IsServantGet_b__50_0__, v8);
    sub_1B90010(&ShopEntity___c_TypeInfo, v9);
    byte_4A70730 = 1;
  }
  entity = 0LL;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
  ...
  v11 = DataManager__GetMaster_object_((const MethodInfo_2E8E1C8 *)Method_DataManager_GetMaster_UserPresentBoxMaster___);
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  ...
  if ( !_9__50_0 )
  {
    ...
    _9__50_0 = (System_Predicate_object__o *)sub_1B9025C(System_Predicate_UserPresentBoxEntity__TypeInfo);
    ...
    sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&static_fields->__9__50_0, (int32_t)_9__50_0, v20, v21);
  }
...
bool __fastcall ShopEntity__IsSetStrikethrough(ShopEntity_o *this, bool isInPreparation, const MethodInfo *method)
{
  ...
  if ( (byte_4A70723 & 1) == 0 )
  {
    sub_1B90010(&Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__, isInPreparation);
    sub_1B90010(&StringLiteral_19652/*"freeShopCondId"*/, v5);
    byte_4A70723 = 1;
  }
  value = 0LL;
...
LABEL_5:
  ...
  v8 = System_String__Substring_61806096((System_String_o *)this, 0, this->fields.id - 2, 0LL);
...
System_String_o *__fastcall ShopEntity__getName(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B90010(&Method_DataManager_GetMasterData_ServantMaster___, method);
    sub_1B90010(&Method_DataManager_GetMaster_ItemMaster___, v3);
    sub_1B90010(&DataManager_TypeInfo, v4);
...
bool __fastcall ShopEntity__isMaxOver(ShopEntity_o *this, int64_t buyCount, int32_t *check, const MethodInfo *method)
{
  ...
  if ( (byte_4A70753 & 1) == 0 )
  {
    sub_1B90010(&BalanceConfig_TypeInfo, buyCount);
...
bool __fastcall ShopEntity__isNotQuestClear(ShopEntity_o *this, int32_t type, const MethodInfo *method)
{
  ...
  if ( (byte_4A70749 & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMasterData_ShopReleaseMaster___, *(_QWORD *)&type);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A70745 & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMasterData_ShopReleaseMaster___, questId);
    sub_1B90010(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v6);
    byte_4A70745 = 1;
  }
  *questId = 0;
...
bool __fastcall ShopEntity__isQuestNotClearItemClosed(ShopEntity_o *this, bool checkExpired, const MethodInfo *method)
{
  ...
  if ( (byte_4A70747 & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMasterData_ShopReleaseMaster___, checkExpired);
    sub_1B90010(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v5);
    byte_4A70747 = 1;
  }
  questId = 0;
...
void __fastcall ShopEntity___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A7075B & 1) == 0 )
  {
    sub_1B90010(&ShopEntity___c_TypeInfo, v1);
    byte_4A7075B = 1;
  }
  v2 = (Il2CppObject *)sub_1B9025C(ShopEntity___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  ShopEntity___c_TypeInfo->static_fields->__9 = (struct ShopEntity___c_o *)v2;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)ShopEntity___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
