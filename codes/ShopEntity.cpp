...
bool __fastcall ShopEntity__CheckEquipItem(ShopEntity_o *this, int32_t *imageId, const MethodInfo *method)
{
  ...
  if ( (byte_4B1CFFE & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_EquipMaster___, imageId);
    ...
    sub_1BCAFF8(&Method_DataMasterBase_EquipMaster__EquipEntity__int__TryGetEntity__, v7);
    sub_1BCAFF8(&Method_DataMasterBase_QuestMaster__QuestEntity__int__TryGetEntity__, v8);
...
LABEL_40:
        ...
        else if ( saveDataMapList_high == 1 )
        {
          ...
          *(_QWORD *)&v29.fields.fakeValue = v19;
          Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48125176(v29, 0LL);
          if ( (int)Instance >= 1 )
          {
            if ( entity )
            {
...
LABEL_34:
              ...
              *imageId = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48125176(v31, 0LL);
              goto LABEL_38;
            }
            goto LABEL_40;
          }
...
System_String_o *__fastcall ShopEntity__GetAddMessage(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1D003 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_16539/*"addMessage"*/, v3);
  ...
  if ( !script
    || !System_Collections_Generic_Dictionary_object__object___TryGetValue(
          ...
          (Il2CppObject *)StringLiteral_16539/*"addMessage"*/,
          &value,
...
System_Int32_array *__fastcall ShopEntity__GetAnotherPayItemIds(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1CFE4 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_System_Collections_Generic_List_object__ConvertAll_int___, v4);
    ...
    sub_1BCAFF8(&Method_ShopEntity___c__GetAnotherPayItemIds_b__58_0__, v7);
    sub_1BCAFF8(&ShopEntity___c_TypeInfo, v8);
    sub_1BCAFF8(&StringLiteral_16653/*"anotherItemIds"*/, v9);
    byte_4B1CFE4 = 1;
  }
  value = 0LL;
  ...
  if ( result )
  {
    if ( System_Collections_Generic_Dictionary_object__object___TryGetValue(
           ...
           (Il2CppObject *)StringLiteral_16653/*"anotherItemIds"*/,
           &value,
           (const MethodInfo_3387584 *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
    {
      v11 = value;
      if ( value )
      {
          ...
          && (System_Collections_Generic_List_object__c *)v11->klass->_2.typeHierarchy[methodPtr_low - 1] == System_Collections_Generic_List_object__TypeInfo )
        {
          ...
          if ( !_9__58_0 )
          {
            ...
            _9__58_0 = (System_Converter_object__int__o *)sub_1BCB244(System_Converter_object__int__TypeInfo);
...
int32_t __fastcall ShopEntity__GetAnotherPayType(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BCAFF8(&Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__, method);
    sub_1BCAFF8(&PayType_Type_TypeInfo, v3);
    sub_1BCAFF8(&StringLiteral_16656/*"anotherPayType"*/, v4);
    byte_4B1CFE5 = 1;
  }
  value = 0LL;
  script = this->fields.script;
  if ( script )
  {
    if ( System_Collections_Generic_Dictionary_object__object___TryGetValue(
           (System_Collections_Generic_Dictionary_object__object__o *)script,
           (Il2CppObject *)StringLiteral_16656/*"anotherPayType"*/,
           &value,
           (const MethodInfo_3387584 *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
    {
      if ( !value )
...
int32_t __fastcall ShopEntity__GetCommonConsumeBuyableCount(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  do
  {
    if ( (unsigned int)v7 >= (unsigned int)v5 )
      sub_1BCB25C(CommonConsumeEntities, v3, v4);
    v9 = v6->m_Items[v7];
    if ( !v9 )
      sub_1BCB254(CommonConsumeEntities, v3);
    if ( v9->fields.num < 1 )
    {
      v10 = 0;
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1D005 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMaster_CommonConsumeMaster___, method);
...
int32_t __fastcall ShopEntity__GetExchangeSvtCoinType(ShopEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4B1D006 & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_19150/*"exchangeSvtCoinType"*/, method);
    byte_4B1D006 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_19150/*"exchangeSvtCoinType"*/, 0, 0LL);
}
...
int32_t __fastcall ShopEntity__GetFreeShopCondId(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1CFCB & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__, v3);
    sub_1BCAFF8(&StringLiteral_19488/*"freeShopCondId"*/, v4);
    byte_4B1CFCB = 1;
  }
  value = 0LL;
  script = this->fields.script;
...
int64_t __fastcall ShopEntity__GetFreeShopReleaseDate(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1CFCC & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_19491/*"freeShopReleaseDate"*/, v4);
    byte_4B1CFCC = 1;
  }
  value = 0LL;
  ...
  if ( result )
  {
    if ( System_Collections_Generic_Dictionary_object__object___TryGetValue(
           (System_Collections_Generic_Dictionary_object__object__o *)result,
           (Il2CppObject *)StringLiteral_19491/*"freeShopReleaseDate"*/,
           &value,
           (const MethodInfo_3387584 *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
    {
      if ( !value )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1CFEB & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_ItemMaster___, nameText);
    ...
    sub_1BCAFF8(&StringLiteral_14692/*"UNIT_INFO"*/, v15);
    sub_1BCAFF8(&StringLiteral_11903/*"SERVANT_UNIT"*/, v16);
    sub_1BCAFF8(&StringLiteral_5704/*"EXCEPT_SERVANT_UNIT"*/, v17);
    sub_1BCAFF8(&StringLiteral_11530/*"SERVANT_EQUIP_UNIT"*/, v18);
    sub_1BCAFF8(&StringLiteral_1/*""*/, v19);
    byte_4B1CFEB = 1;
  }
  name = this->fields.name;
  *nameText = name;
  sub_1BCAF9C((CGThumbnailListItem_o *)nameText, (int32_t)name, (int32_t)countText, (const MethodInfo *)isSend);
  purchaseType = this->fields.purchaseType;
  switch ( purchaseType )
  {
    case 1:
    ...
    case 5:
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v24 = &StringLiteral_14692/*"UNIT_INFO"*/;
      goto LABEL_32;
    case 4:
      goto LABEL_9;
    case 6:
...
LABEL_41:
            ...
            || ServantEntity__get_IsServantMaterialTd(v36, 0LL) )
          {
            if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
            v24 = &StringLiteral_11903/*"SERVANT_UNIT"*/;
          }
          else
          {
            ...
            if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
            if ( IsServantEquip )
              v24 = &StringLiteral_11530/*"SERVANT_EQUIP_UNIT"*/;
            else
              v24 = &StringLiteral_5704/*"EXCEPT_SERVANT_UNIT"*/;
          }
LABEL_32:
          ...
          *countText = v42;
          sub_1BCAF9C((CGThumbnailListItem_o *)countText, (int32_t)v42, v43, v44);
          return;
        }
LABEL_10:
        v25 = (_DWORD)this + 64;
...
LABEL_16:
      v28 = countText;
LABEL_17:
      sub_1BCAF9C((CGThumbnailListItem_o *)v28, (int32_t)v27, v21, v22);
      return;
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1CFDB & 1) == 0 )
  {
    sub_1BCAFF8(&Method_System_Array_FindAll_UserPresentBoxEntity___, isWithoutPresents);
    ...
    sub_1BCAFF8(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, v9);
    sub_1BCAFF8(&System_Predicate_UserPresentBoxEntity__TypeInfo, v10);
    sub_1BCAFF8(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v11);
    sub_1BCAFF8(&Method_ShopEntity___c__GetIsAlreadyInPossession_b__49_0__, v12);
    sub_1BCAFF8(&ShopEntity___c_TypeInfo, v13);
    byte_4B1CFDB = 1;
  }
  Instance = (DataManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38F8AD8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
  ...
  if ( !_9__49_0 )
  {
    ...
    _9__49_0 = (System_Predicate_object__o *)sub_1BCB244(System_Predicate_UserPresentBoxEntity__TypeInfo);
    ...
    sub_1BCAF9C((CGThumbnailListItem_o *)&static_fields->__9__49_0, (int32_t)_9__49_0, v25, v26);
  }
  Instance = (DataManager_o *)System_Array__FindAll_object_(
                                v21,
                                (System_Predicate_T__o *)_9__49_0,
                                (const MethodInfo_311762C *)Method_System_Array_FindAll_UserPresentBoxEntity___);
  if ( !v17
    || (v27 = Instance,
    ...
    if ( v39 >= 1 )
    {
      ...
      while ( v40 < v39 )
      {
        ...
        *(_QWORD *)&v50.fields.fakeValue = v42;
        Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48125176(v50, 0LL);
    ...
    if ( v44 >= 1 )
    {
      ...
      while ( v45 < v44 )
      {
        ...
        *(_QWORD *)&v51.fields.fakeValue = v47;
        Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48125176(v51, 0LL);
        if ( v35 == (_DWORD)Instance )
          return 1;
        v44 = (int)v32->fields.m_CancellationTokenSource;
        if ( (int)++v45 >= v44 )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1CFED & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_ServantMaster___, buyItemNum);
    sub_1BCAFF8(&Method_DataManager_GetMasterData_SetItemMaster___, v13);
        ...
        const MethodInfo *method)
{
  if ( (byte_4B1D001 & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_22362/*"overwriteName"*/, defaultValue);
    byte_4B1D001 = 1;
  }
  return EntityScriptUtil__GetStringValue(
           this->fields.script,
           (System_String_o *)StringLiteral_22362/*"overwriteName"*/,
           defaultValue,
           0LL);
}
...
int32_t __fastcall ShopEntity__GetPurchaseShop(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1CFE9 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_ShopReleaseMaster___, method);
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_301AAA4 *)Method_DataManager_GetMasterData_ShopReleaseMaster___)) == 0LL )
  {
...
ServantEntity_o *__fastcall ShopEntity__GetRelateServantEntity(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1CFF9 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_DataManager_GetMasterData_ShopReleaseMaster___, v3);
  ...
  if ( this->fields.purchaseType != 4 )
    return 0LL;
  Instance = (ShopReleaseEntity_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38F8AD8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_17;
...
int32_t __fastcall ShopEntity__GetRemainDays(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BCAFF8(&Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__, method);
    sub_1BCAFF8(&StringLiteral_8196/*"LIMITED_SHOP_REMAIN_DAYS"*/, v3);
    sub_1BCAFF8(&StringLiteral_8668/*"MONTHLY_SHOP_REMAIN_DAYS"*/, v4);
    sub_1BCAFF8(&StringLiteral_22821/*"remainDays"*/, v5);
    byte_4B1CFE6 = 1;
  }
  value = 0LL;
  script = this->fields.script;
  if ( !script
    || !System_Collections_Generic_Dictionary_object__object___TryGetValue(
          (System_Collections_Generic_Dictionary_object__object__o *)script,
          (Il2CppObject *)StringLiteral_22821/*"remainDays"*/,
          &value,
          (const MethodInfo_3387584 *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
  {
    ...
    if ( (flag & 0x800) != 0 )
    {
      v11 = &StringLiteral_8196/*"LIMITED_SHOP_REMAIN_DAYS"*/;
    }
    else
    {
      if ( (flag & 0x1000) == 0 )
      ...
      v11 = &StringLiteral_8668/*"MONTHLY_SHOP_REMAIN_DAYS"*/;
    }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_ServantMaster___, buyItemNum);
    sub_1BCAFF8(&Method_DataManager_GetMasterData_SetItemMaster___, v15);
    sub_1BCAFF8(&Method_DataManager_GetMasterData_ShopGroupMaster___, v16);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1CFE2 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMaster_UserItemMaster___, possessionAnotherItemId);
  ...
  *possessionAnotherItemId = 0LL;
  sub_1BCAF9C((CGThumbnailListItem_o *)possessionAnotherItemId, 0, (int32_t)method, v3);
  ...
  do
  {
    if ( v22 >= (unsigned int)monitor )
      sub_1BCB25C(Master_object, itemId, v18);
    v23 = *((_DWORD *)&AnotherPayItemIds[2].klass + v22);
    if ( !NetworkManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
    if ( !byte_4B165D1 )
    {
      sub_1BCAFF8(&NetworkManager_TypeInfo, itemId);
      byte_4B165D1 = 1;
    }
  ...
  *possessionAnotherItemId = v27;
  sub_1BCAF9C((CGThumbnailListItem_o *)possessionAnotherItemId, (int32_t)v27, v28, v29);
  if ( !ShopEntity__IsAnotherPayCommonReleaseOpen(this, v30) )
    return 0;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  v31 = DataManager__GetMaster_object_((const MethodInfo_301AA50 *)Method_DataManager_GetMaster_UserShopMaster___);
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  if ( !byte_4B165D1 )
  {
  ...
  if ( !v35 )
LABEL_45:
    sub_1BCB254(Master_object, itemId);
...
bool __fastcall ShopEntity__IsAnotherPayCommonReleaseOpen(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BCAFF8(&System_Convert_TypeInfo, method);
    sub_1BCAFF8(&Method_DataManager_GetMasterData_CommonReleaseMaster___, v3);
    sub_1BCAFF8(&Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__, v4);
    sub_1BCAFF8(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v5);
    sub_1BCAFF8(&StringLiteral_24261/*"useAnotherPayCommonReleaseId"*/, v6);
    byte_4B1CFE3 = 1;
  }
  value = 0LL;
  script = this->fields.script;
  if ( script
    && System_Collections_Generic_Dictionary_object__object___TryGetValue(
         (System_Collections_Generic_Dictionary_object__object__o *)script,
         (Il2CppObject *)StringLiteral_24261/*"useAnotherPayCommonReleaseId"*/,
         &value,
         (const MethodInfo_3387584 *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
  {
    v8 = value;
...
bool __fastcall ShopEntity__IsCondType_41984132(ShopEntity_o *this, int64_t userId, const MethodInfo *method)
{
  __int64 v5; // x1
  DataManager_o *Instance; // x0
  __int64 v7; // x1
  ...
  if ( (byte_4B1CFE8 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_UserShopMaster___, userId);
    sub_1BCAFF8(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v5);
    byte_4B1CFE8 = 1;
  }
  Instance = (DataManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38F8AD8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance
    || (Instance = (DataManager_o *)DataManager__GetMasterData_object_(
                                      Instance,
                                      (const MethodInfo_301AAA4 *)Method_DataManager_GetMasterData_UserShopMaster___)) == 0LL
    || (Instance = (DataManager_o *)UserShopMaster__GetEntityDefinitely(
...
bool __fastcall ShopEntity__IsEligibleForFreeFeaturesTheCostumeRelease(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1CFD1 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_ServantCostumeReleaseMaster___, method);
    sub_1BCAFF8(&Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__, v3);
    sub_1BCAFF8(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v4);
    sub_1BCAFF8(&StringLiteral_19488/*"freeShopCondId"*/, v5);
    byte_4B1CFD1 = 1;
  }
  value = 0LL;
  *(_QWORD *)costumeId = 0LL;
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_301AAA4 *)Method_DataManager_GetMasterData_ServantCostumeReleaseMaster___)) == 0LL )
  {
...
bool __fastcall ShopEntity__IsEnable(ShopEntity_o *this, int64_t nowTime, const MethodInfo *method)
{
  ...
  if ( (byte_4B1CFD2 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_EventDetailMaster___, nowTime);
    sub_1BCAFF8(&Method_DataManager_GetMasterData_ShopReleaseMaster___, v5);
    sub_1BCAFF8(&Method_DataManager_GetMasterData_UserEventMaster___, v6);
...
bool __fastcall ShopEntity__IsEventQuest(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1D004 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_System_Collections_ObjectModel_Collection_WarEntity__GetEnumerator__, method);
    ...
    sub_1BCAFF8(&Method_DataMasterBase_WarMaster__WarEntity__int__getEntityList__, v5);
    sub_1BCAFF8(&System_IDisposable_TypeInfo, v6);
    sub_1BCAFF8(&System_Collections_Generic_IEnumerator_WarEntity__TypeInfo, v7);
  ...
  Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                 ...
                 (const MethodInfo_3263BC0 *)Method_System_Collections_ObjectModel_Collection_WarEntity__GetEnumerator__);
  v18 = Enumerator;
  v19 = 0;
  while ( 1 )
  {
    if ( !v18 )
      sub_1BCB254(Enumerator, v17);
    klass = v18->klass;
    ...
    {
LABEL_14:
      p_method = sub_1C1B560(v18, System_Collections_IEnumerator_TypeInfo, 0LL);
    }
    ...
    {
LABEL_21:
      v27 = sub_1C1B560(v18, System_Collections_Generic_IEnumerator_WarEntity__TypeInfo, 0LL);
    }
  ...
  {
LABEL_30:
    v31 = sub_1C1B560(v18, System_IDisposable_TypeInfo, 0LL);
  }
...
bool __fastcall ShopEntity__IsExchangeServantIconDisplayTarget(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BCAFF8(&Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__, method);
    sub_1BCAFF8(&StringLiteral_22821/*"remainDays"*/, v3);
    byte_4B1CFE1 = 1;
  }
  value = 0LL;
  script = this->fields.script;
...
bool __fastcall ShopEntity__IsFulFilledFreeExchangeCondition(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !System_Collections_Generic_Dictionary_object__object___ContainsKey(
    ...
    return 0;
  script = (System_Collections_Generic_Dictionary_object__object__o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38F8AD8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !script
    || (MasterData_object = DataManager__GetMasterData_object_(
...
bool __fastcall ShopEntity__IsNotClearNotShopPurchase(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_ShopReleaseMaster___, method);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_Enumerator_ShopReleaseEntity__Dispose__, v3);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_Enumerator_ShopReleaseEntity__MoveNext__, v4);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_Enumerator_ShopReleaseEntity__get_Current__, v5);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_ShopReleaseEntity__GetEnumerator__, v6);
...
bool __fastcall ShopEntity__IsPaidExchange(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  const MethodInfo_37D95B4 *v85; // x3
  bool v86; // w20
  ...
  if ( (byte_4B1CFD0 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_BasicHelper_Any_UserQuestEntity___, method);
    sub_1BCAFF8(&Method_DataManager_GetMasterData_CommonReleaseMaster___, v3);
    sub_1BCAFF8(&Method_DataManager_GetMasterData_UserQuestMaster___, v4);
    ...
    sub_1BCAFF8(&Method_System_Linq_Enumerable_Min_UserQuestEntity___, v7);
    sub_1BCAFF8(&Method_System_Linq_Enumerable_ToArray_CommonReleaseEntity___, v8);
    sub_1BCAFF8(&Method_System_Linq_Enumerable_Where_CommonReleaseEntity___, v9);
    sub_1BCAFF8(&Method_System_Linq_Enumerable_Where_UserQuestEntity___, v10);
    sub_1BCAFF8(&System_Func_UserQuestEntity__long__TypeInfo, v11);
    sub_1BCAFF8(&System_Func_UserQuestEntity__bool__TypeInfo, v12);
    sub_1BCAFF8(&System_Func_CommonReleaseEntity__bool__TypeInfo, v13);
    sub_1BCAFF8(&long_TypeInfo, v14);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_UserQuestEntity__Add__, v15);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_UserQuestEntity___ctor__, v16);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_UserQuestEntity__get_Count__, v17);
    sub_1BCAFF8(&System_Collections_Generic_List_UserQuestEntity__TypeInfo, v18);
    sub_1BCAFF8(&NetworkManager_TypeInfo, v19);
    sub_1BCAFF8(&Method_System_Nullable_long__GetValueOrDefault__, v20);
    sub_1BCAFF8(&Method_System_Nullable_long___ctor__, v21);
    sub_1BCAFF8(&Method_System_Nullable_long__get_HasValue__, v22);
    sub_1BCAFF8(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v23);
    sub_1BCAFF8(&Method_ShopEntity___c__IsPaidExchange_b__36_0__, v24);
    sub_1BCAFF8(&Method_ShopEntity___c__IsPaidExchange_b__36_1__, v25);
    sub_1BCAFF8(&Method_ShopEntity___c__IsPaidExchange_b__36_2__, v26);
    sub_1BCAFF8(&Method_ShopEntity___c__IsPaidExchange_b__36_3__, v27);
    sub_1BCAFF8(&ShopEntity___c_TypeInfo, v28);
    sub_1BCAFF8(&StringLiteral_19491/*"freeShopReleaseDate"*/, v29);
    byte_4B1CFD0 = 1;
  }
  v96 = 0LL;
  v97 = 0LL;
  ...
  if ( Instance->klass->_1.element_class == long_TypeInfo->_1.element_class )
  {
    ...
    if ( List )
    {
      ...
      if ( !_9__36_0 )
      {
        ...
        _9__36_0 = (System_Func_object__bool__o *)sub_1BCB244(System_Func_CommonReleaseEntity__bool__TypeInfo);
        ...
        sub_1BCAF9C((CGThumbnailListItem_o *)&static_fields->__9__36_0, (int32_t)_9__36_0, v50, v51);
      }
      ...
      v54 = (System_Collections_Generic_List_object__o *)sub_1BCB244(System_Collections_Generic_List_UserQuestEntity__TypeInfo);
        ...
        while ( 1 )
        {
          ...
          if ( Instance )
          {
            ...
            else
            {
              ...
              sub_1BCAF9C((CGThumbnailListItem_o *)(v64 + 4), (int32_t)v63, v55, v59);
            }
          }
          max_length = v53->max_length;
...
LABEL_49:
      ...
      if ( !_9__36_1 )
      {
        ...
        _9__36_1 = (System_Func_object__bool__o *)sub_1BCB244(System_Func_UserQuestEntity__bool__TypeInfo);
        ...
        sub_1BCAF9C((CGThumbnailListItem_o *)&v68->__9__36_1, (int32_t)_9__36_1, v69, v70);
      }
      if ( !BasicHelper__Any_object_(
              (System_Collections_Generic_List_T__o *)v54,
              (System_Func_T__bool__o *)_9__36_1,
              (const MethodInfo_3003F1C *)Method_BasicHelper_Any_UserQuestEntity___) )
        goto LABEL_72;
      ...
      if ( !_9__36_2 )
      {
        ...
        _9__36_2 = (System_Func_object__bool__o *)sub_1BCB244(System_Func_UserQuestEntity__bool__TypeInfo);
        ...
        sub_1BCAF9C((CGThumbnailListItem_o *)&v74->__9__36_2, (int32_t)_9__36_2, v75, v76);
      }
      v77 = System_Linq_Enumerable__Where_object_(
              ...
              (const MethodInfo_305DC88 *)Method_System_Linq_Enumerable_Where_UserQuestEntity___);
      ...
      if ( !_9__36_3 )
      {
        ...
        _9__36_3 = (System_Func_T__TResult__o *)sub_1BCB244(System_Func_UserQuestEntity__long__TypeInfo);
        ...
        sub_1BCAF9C((CGThumbnailListItem_o *)&v82->__9__36_3, (int32_t)_9__36_3, v83, v84);
      }
      v98.fields.value = System_Linq_Enumerable__Min_object__50617288(
                           v79,
                           (System_Func_TSource__long__o *)_9__36_3,
                           (const MethodInfo_3045BC8 *)Method_System_Linq_Enumerable_Min_UserQuestEntity___);
...
bool __fastcall ShopEntity__IsPossessionInfoDisp(ShopEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4B1D002 & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_20756/*"isPossessionInfoDisp"*/, method);
    byte_4B1D002 = 1;
  }
  return EntityScriptUtil__ScriptHasKey(this->fields.script, (System_String_o *)StringLiteral_20756/*"isPossessionInfoDisp"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1CFD6 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_ShopReleaseMaster___, message);
...
bool __fastcall ShopEntity__IsServantGet(ShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1CFDC & 1) == 0 )
  {
    sub_1BCAFF8(&Method_System_Array_FindAll_UserPresentBoxEntity___, method);
    sub_1BCAFF8(&Method_DataManager_GetMaster_UserPresentBoxMaster___, v3);
    sub_1BCAFF8(&Method_DataManager_GetMaster_UserServantCollectionMaster___, v4);
    sub_1BCAFF8(&DataManager_TypeInfo, v5);
    sub_1BCAFF8(&NetworkManager_TypeInfo, v6);
    sub_1BCAFF8(&System_Predicate_UserPresentBoxEntity__TypeInfo, v7);
    sub_1BCAFF8(&Method_ShopEntity___c__IsServantGet_b__50_0__, v8);
    sub_1BCAFF8(&ShopEntity___c_TypeInfo, v9);
    byte_4B1CFDC = 1;
  }
  entity = 0LL;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
  ...
  v12 = DataManager__GetMaster_object_((const MethodInfo_301AA50 *)Method_DataManager_GetMaster_UserPresentBoxMaster___);
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  if ( !byte_4B165D1 )
  {
  ...
  if ( !_9__50_0 )
  {
    ...
    _9__50_0 = (System_Predicate_object__o *)sub_1BCB244(System_Predicate_UserPresentBoxEntity__TypeInfo);
    ...
    sub_1BCAF9C((CGThumbnailListItem_o *)&static_fields->__9__50_0, (int32_t)_9__50_0, v20, v21);
  }
...
LABEL_42:
        sub_1BCB25C(All_object, v11, v22);
      }
    }
LABEL_38:
...
bool __fastcall ShopEntity__IsSetStrikethrough(ShopEntity_o *this, bool isInPreparation, const MethodInfo *method)
{
  ...
  if ( (byte_4B1CFCF & 1) == 0 )
  {
    sub_1BCAFF8(&Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__, isInPreparation);
    sub_1BCAFF8(&StringLiteral_19488/*"freeShopCondId"*/, v5);
    byte_4B1CFCF = 1;
  }
  value = 0LL;
        ...
        const MethodInfo *method)
{
  ...
  if ( !targetIds->max_length )
    sub_1BCB25C(this, svtId, costumeId);
  this = (ShopEntity_o *)System_Int32__ToString((int)targetIds + 32, 0LL);
  if ( !this )
LABEL_5:
    sub_1BCB254(this, svtId);
  v7 = (System_String_o *)this;
  v8 = System_String__Substring_62496348((System_String_o *)this, 0, this->fields.id - 2, 0LL);
...
bool __fastcall ShopEntity__isMaxOver(ShopEntity_o *this, int64_t buyCount, int32_t *check, const MethodInfo *method)
{
  ...
  if ( (byte_4B1CFFF & 1) == 0 )
  {
    sub_1BCAFF8(&BalanceConfig_TypeInfo, buyCount);
...
bool __fastcall ShopEntity__isNotQuestClear(ShopEntity_o *this, int32_t type, const MethodInfo *method)
{
  ...
  if ( (byte_4B1CFF5 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_ShopReleaseMaster___, *(_QWORD *)&type);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1CFF1 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_ShopReleaseMaster___, questId);
...
bool __fastcall ShopEntity__isQuestNotClearItemClosed(ShopEntity_o *this, bool checkExpired, const MethodInfo *method)
{
  ...
  if ( (byte_4B1CFF3 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_ShopReleaseMaster___, checkExpired);
    sub_1BCAFF8(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v5);
    byte_4B1CFF3 = 1;
  }
  questId = 0;
...
void __fastcall ShopEntity___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B1D008 & 1) == 0 )
  {
    sub_1BCAFF8(&ShopEntity___c_TypeInfo, v1);
    byte_4B1D008 = 1;
  }
  v2 = (Il2CppObject *)sub_1BCB244(ShopEntity___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  ShopEntity___c_TypeInfo->static_fields->__9 = (struct ShopEntity___c_o *)v2;
  sub_1BCAF9C((CGThumbnailListItem_o *)ShopEntity___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
