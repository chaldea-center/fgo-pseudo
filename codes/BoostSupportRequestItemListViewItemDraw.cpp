void __fastcall BoostSupportRequestItemListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A28F63 & 1) == 0 )
  {
    sub_1B761C0(&BoostSupportRequestItemListViewItemDraw_TypeInfo, v1);
    sub_1B761C0(&StringLiteral_16935/*"assist_icon_"*/, v2);
    sub_1B761C0(&StringLiteral_16936/*"assist_icon_0"*/, v3);
    byte_4A28F63 = 1;
  }
  static_fields = BoostSupportRequestItemListViewItemDraw_TypeInfo->static_fields;
  *(_OWORD *)&static_fields->TITLE_FONT_SIZE = xmmword_BAD130;
  *(_OWORD *)&static_fields->TITLE_X_POS = xmmword_BAE3F0;
  *(_QWORD *)&static_fields->NAME_LABEL_WIDTH = 0x1A4000000D8LL;
  ...
  sub_1B76164(&static_fields->ASSIST_ICON_SPRITE_NAME);
  v5 = BoostSupportRequestItemListViewItemDraw_TypeInfo->static_fields;
  v5->ASSIST_ICON_SPRITE_NAME_NO_OPEN = (struct System_String_o *)StringLiteral_16936/*"assist_icon_0"*/;
  sub_1B76164(&v5->ASSIST_ICON_SPRITE_NAME_NO_OPEN);
}
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_18:
    sub_1B7641C(consumptionLabel, method);
  }
  v5 = 4LL;
  while ( 1 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A28F60 & 1) == 0 )
  {
    ...
    sub_1B761C0(&BoostSupportRequestItemListViewItemDraw_TypeInfo, v7);
    ...
    sub_1B761C0(&StringLiteral_3079/*"BOOST_SUPPORT_REQUEST_USE_RECOMMENDATION"*/, v12);
    sub_1B761C0(&StringLiteral_3080/*"BOOST_SUPPORT_REQUEST_USE_RECONFIRMATION_MENU_CONSUMPTION"*/, v13);
    sub_1B761C0(&StringLiteral_3077/*"BOOST_SUPPORT_REQUEST_USE_INVALID_TITLE"*/, v14);
    byte_4A28F60 = 1;
  }
  v74 = 0;
  if ( !mode )
  ...
  switch ( v20 )
  {
    ...
    case 1:
      ...
      v40 = System_String__Concat_61535060(ASSIST_ICON_SPRITE_NAME, v39, 0LL);
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    ...
    case 2:
      ...
      v52 = System_String__Concat_61535060(v50, v51, 0LL);
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
...
LABEL_53:
    ...
    case 3:
      ...
      v65 = System_String__Concat_61535060(v63, v64, 0LL);
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B761C0(&AtlasManager_TypeInfo, item);
    sub_1B761C0(&Method_SingletonTemplate_BoostFunctionUtility__get_Instance__, v5);
...
LABEL_56:
        ...
        consumptionLabel = (UnityEngine_Component_o *)SingletonTemplate_object___get_Instance((const MethodInfo_371299C *)Method_SingletonTemplate_BoostFunctionUtility__get_Instance__);
...
LABEL_55:
      sub_1B7641C(consumptionLabel, item);
    }
LABEL_38:
