void BoostSupportRequestItemListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4D262B3 & 1) == 0 )
  {
    sub_1C94098(&BoostSupportRequestItemListViewItemDraw_TypeInfo);
    sub_1C94098(&StringLiteral_16998/*"assist_icon_"*/);
    sub_1C94098(&StringLiteral_16999/*"assist_icon_0"*/);
    byte_4D262B3 = 1;
  }
  static_fields = BoostSupportRequestItemListViewItemDraw_TypeInfo->static_fields;
  *(_OWORD *)&static_fields->TITLE_FONT_SIZE = xmmword_CFEE20;
  *(_OWORD *)&static_fields->TITLE_X_POS = xmmword_D00210;
  *(_QWORD *)&static_fields->NAME_LABEL_WIDTH = 0x1A4000000D8LL;
  v2 = StringLiteral_16998/*"assist_icon_"*/;
  static_fields->ASSIST_ICON_SPRITE_NAME = (struct System_String_o *)StringLiteral_16998/*"assist_icon_"*/;
  sub_1C9403C(&static_fields->ASSIST_ICON_SPRITE_NAME, v2);
  v3 = StringLiteral_16999/*"assist_icon_0"*/;
  v4 = BoostSupportRequestItemListViewItemDraw_TypeInfo->static_fields;
  v4->ASSIST_ICON_SPRITE_NAME_NO_OPEN = (struct System_String_o *)StringLiteral_16999/*"assist_icon_0"*/;
  sub_1C9403C(&v4->ASSIST_ICON_SPRITE_NAME_NO_OPEN, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_18:
    sub_1C942F0(consumptionLabel, method);
  }
  v5 = 4;
  while ( 1 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D262B0 & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_2978/*"BOOST_SUPPORT_REQUEST_USE_RECOMMENDATION"*/);
    sub_1C94098(&StringLiteral_2979/*"BOOST_SUPPORT_REQUEST_USE_RECONFIRMATION_MENU_CONSUMPTION"*/);
    sub_1C94098(&StringLiteral_2976/*"BOOST_SUPPORT_REQUEST_USE_INVALID_TITLE"*/);
    byte_4D262B0 = 1;
  }
  v66 = 0;
  if ( !mode )
  ...
  switch ( v12 )
  {
    ...
    case 1:
      ...
      v32 = System_String__Concat_64417744(ASSIST_ICON_SPRITE_NAME, v31, 0);
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
...
LABEL_56:
        ...
        consumptionLabel = (UnityEngine_Component_o *)SingletonTemplate_object___get_Instance((const MethodInfo_3ABAA64 *)Method_SingletonTemplate_BoostFunctionUtility__get_Instance__);
...
LABEL_55:
      sub_1C942F0(consumptionLabel, item);
    }
LABEL_38:
