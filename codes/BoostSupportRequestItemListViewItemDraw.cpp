void BoostSupportRequestItemListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4DFE443 & 1) == 0 )
  {
    sub_1CE6700(&BoostSupportRequestItemListViewItemDraw_TypeInfo);
    sub_1CE6700(&StringLiteral_17093/*"assist_icon_"*/);
    sub_1CE6700(&StringLiteral_17094/*"assist_icon_0"*/);
    byte_4DFE443 = 1;
  }
  static_fields = BoostSupportRequestItemListViewItemDraw_TypeInfo->static_fields;
  *(_OWORD *)&static_fields->TITLE_FONT_SIZE = xmmword_D24EE0;
  *(_OWORD *)&static_fields->TITLE_X_POS = xmmword_D26340;
  *(_QWORD *)&static_fields->NAME_LABEL_WIDTH = 0x1A4000000D8LL;
  v2 = StringLiteral_17093/*"assist_icon_"*/;
  static_fields->ASSIST_ICON_SPRITE_NAME = (struct System_String_o *)StringLiteral_17093/*"assist_icon_"*/;
  sub_1CE66A4(&static_fields->ASSIST_ICON_SPRITE_NAME, v2);
  v3 = StringLiteral_17094/*"assist_icon_0"*/;
  v4 = BoostSupportRequestItemListViewItemDraw_TypeInfo->static_fields;
  v4->ASSIST_ICON_SPRITE_NAME_NO_OPEN = (struct System_String_o *)StringLiteral_17094/*"assist_icon_0"*/;
  sub_1CE66A4(&v4->ASSIST_ICON_SPRITE_NAME_NO_OPEN, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_18:
    sub_1CE6958(consumptionLabel, method);
  }
  v5 = 4;
  while ( 1 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFE440 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_2996/*"BOOST_SUPPORT_REQUEST_USE_RECOMMENDATION"*/);
    sub_1CE6700(&StringLiteral_2997/*"BOOST_SUPPORT_REQUEST_USE_RECONFIRMATION_MENU_CONSUMPTION"*/);
    sub_1CE6700(&StringLiteral_2994/*"BOOST_SUPPORT_REQUEST_USE_INVALID_TITLE"*/);
    byte_4DFE440 = 1;
  }
  v66 = 0;
  if ( !mode )
  ...
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_2997/*"BOOST_SUPPORT_REQUEST_USE_RECONFIRMATION_MENU_CONSUMPTION"*/, 0);
  if ( !consumptionLabel )
    goto LABEL_95;
  ...
  switch ( v12 )
  {
    case 0:
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      Instance = LocalizationManager__Get((System_String_o *)StringLiteral_2994/*"BOOST_SUPPORT_REQUEST_USE_INVALID_TITLE"*/, 0);
      if ( !v15 )
        goto LABEL_95;
    ...
    case 1:
      ...
      v32 = System_String__Concat_65122828(ASSIST_ICON_SPRITE_NAME, v31, 0);
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
...
LABEL_78:
  ...
  if ( isRecommended )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    Instance = LocalizationManager__Get((System_String_o *)StringLiteral_2996/*"BOOST_SUPPORT_REQUEST_USE_RECOMMENDATION"*/, 0);
...
LABEL_56:
        ...
        consumptionLabel = (UnityEngine_Component_o *)SingletonTemplate_object___get_Instance((const MethodInfo_3B55234 *)Method_SingletonTemplate_BoostFunctionUtility__get_Instance__);
...
LABEL_55:
      sub_1CE6958(consumptionLabel, item);
    }
LABEL_38:
