        ...
        const MethodInfo *method)
{
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.animation, (int32_t)animation, v7, v8);
  this->fields.animationName = animationName;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.animationName, (int32_t)animationName, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA344 & 1) == 0 )
  {
    sub_1B640C8(&WarBoardSimpleAnimationPerformance__Execute_d__5_TypeInfo, method);
    byte_49FA344 = 1;
  }
  v4 = sub_1B64314(WarBoardSimpleAnimationPerformance__Execute_d__5_TypeInfo, method, v2);
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(animation, 0LL, 0LL) )
  {
    ...
    if ( !v5 || (SimpleAnimation__Rewind(v5, 0LL), (v5 = this->fields.animation) == 0LL) )
      sub_1B64324(v5);
    if ( SimpleAnimation__Play_63513060(v5, this->fields.animationName, 0LL) )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA345 & 1) == 0 )
  {
    ...
    this = (WarBoardSimpleAnimationPerformance__Execute_d__5_o *)sub_1B640C8(
  ...
  else
  {
    ...
    else
    {
      ...
      sub_1B6406C(p__2__current, (int32_t)v11, v13, v14);
      result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v6 = sub_1B640DC(&Method_WarBoardSimpleAnimationPerformance__Execute_d__5_System_Collections_IEnumerator_Reset__);
  sub_1B641F0(v5, v6);
}
