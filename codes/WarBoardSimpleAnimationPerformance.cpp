        ...
        const MethodInfo *method)
{
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.animation, (int32_t)animation, v7, v8);
  this->fields.animationName = animationName;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.animationName, (int32_t)animationName, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4C1AF & 1) == 0 )
  {
    sub_1B863B8(&WarBoardSimpleAnimationPerformance__Execute_d__5_TypeInfo, method);
    byte_4A4C1AF = 1;
  }
  v3 = sub_1B86604(WarBoardSimpleAnimationPerformance__Execute_d__5_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(animation, 0LL, 0LL) )
  {
    ...
    if ( !v6 || (SimpleAnimation__Rewind(v6, 0LL), (v6 = this->fields.animation) == 0LL) )
      sub_1B86614(v6, v5);
    if ( SimpleAnimation__Play_64595412(v6, this->fields.animationName, 0LL) )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4C1B0 & 1) == 0 )
  {
    ...
    this = (WarBoardSimpleAnimationPerformance__Execute_d__5_o *)sub_1B863B8(
  ...
  else
  {
    ...
    else
    {
      ...
      sub_1B8635C(p__2__current, (int32_t)v8, v10, v11);
      result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B863CC(&Method_WarBoardSimpleAnimationPerformance__Execute_d__5_System_Collections_IEnumerator_Reset__);
  sub_1B864E0(v3, v4);
}
