        ...
        const MethodInfo *method)
{
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.animation, (int32_t)animation, v7, v8, v9, v10, v11, v12);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E02664 & 1) == 0 )
  {
    sub_1CE6700(&WarBoardSimpleAnimationPerformance__Execute_d__5_TypeInfo);
    byte_4E02664 = 1;
  }
  v3 = sub_1CE694C(WarBoardSimpleAnimationPerformance__Execute_d__5_TypeInfo);
...
void WarBoardSimpleAnimationPerformance__OnStart(WarBoardSimpleAnimationPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(animation, 0, 0) )
  {
    ...
    if ( !v6 || (SimpleAnimation__Rewind(v6, 0), (v6 = this->fields.animation) == 0) )
      sub_1CE6958(v6, v5);
    if ( SimpleAnimation__Play_68069172(v6, this->fields.animationName, 0) )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E02665 & 1) == 0 )
  {
    ...
    this = (WarBoardSimpleAnimationPerformance__Execute_d__5_o *)sub_1CE6700(&Method_WarBoardSimpleAnimationPerformance__Execute_b__5_0__);
    byte_4E02665 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1CE6714(&Method_WarBoardSimpleAnimationPerformance__Execute_d__5_System_Collections_IEnumerator_Reset__);
  sub_1CE6828(v3, v4);
}
