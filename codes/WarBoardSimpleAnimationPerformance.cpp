        ...
        const MethodInfo *method)
{
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.animation, (int32_t)animation, v7, v8);
  this->fields.animationName = animationName;
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.animationName, (int32_t)animationName, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB3F45 & 1) == 0 )
  {
    sub_1C6BA08(&WarBoardSimpleAnimationPerformance__Execute_d__5_TypeInfo);
    byte_4CB3F45 = 1;
  }
  v3 = sub_1C6BC54(WarBoardSimpleAnimationPerformance__Execute_d__5_TypeInfo);
...
void WarBoardSimpleAnimationPerformance__OnStart(WarBoardSimpleAnimationPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(animation, 0, 0) )
  {
    ...
    if ( !v6 || (SimpleAnimation__Rewind(v6, 0), (v6 = this->fields.animation) == 0) )
      sub_1C6BC60(v6, v5);
    if ( SimpleAnimation__Play_66911856(v6, this->fields.animationName, 0) )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB3F46 & 1) == 0 )
  {
    ...
    this = (WarBoardSimpleAnimationPerformance__Execute_d__5_o *)sub_1C6BA08(&Method_WarBoardSimpleAnimationPerformance__Execute_b__5_0__);
    byte_4CB3F46 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C6BA1C(&Method_WarBoardSimpleAnimationPerformance__Execute_d__5_System_Collections_IEnumerator_Reset__);
  sub_1C6BB30(v3, v4);
}
