        ...
        const MethodInfo *method)
{
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.animation, (int64_t)animation, v7, v8, v9, v10, v11, v12);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDA37F & 1) == 0 )
  {
    sub_1C21E38(&WarBoardSimpleAnimationPerformance__Execute_d__5_TypeInfo);
    byte_4BDA37F = 1;
  }
  v3 = sub_1C22084(WarBoardSimpleAnimationPerformance__Execute_d__5_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(animation, 0LL, 0LL) )
  {
    ...
    if ( !v6 || (SimpleAnimation__Rewind(v6, 0LL), (v6 = this->fields.animation) == 0LL) )
      sub_1C22094(v6, v5);
    if ( SimpleAnimation__Play_65253852(v6, this->fields.animationName, 0LL) )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDA380 & 1) == 0 )
  {
    ...
    this = (WarBoardSimpleAnimationPerformance__Execute_d__5_o *)sub_1C21E38(&Method_WarBoardSimpleAnimationPerformance__Execute_b__5_0__);
    byte_4BDA380 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C21E4C(&Method_WarBoardSimpleAnimationPerformance__Execute_d__5_System_Collections_IEnumerator_Reset__);
  sub_1C21F60(v3, v4);
}
