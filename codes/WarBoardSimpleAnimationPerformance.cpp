        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_438D25E & 1) == 0 )
  {
    sub_B775C4(&WarBoardSimpleAnimationPerformance__Execute_d__5_TypeInfo);
    byte_438D25E = 1;
  }
  v3 = sub_B77694(WarBoardSimpleAnimationPerformance__Execute_d__5_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(animation, 0LL, 0LL) )
  {
    ...
    if ( !v6 || (SimpleAnimation__Rewind(v6, 0LL), (v6 = this->fields.animation) == 0LL) )
      sub_B7769C(v6, v5);
    if ( SimpleAnimation__Play_16815192(v6, this->fields.animationName, 0LL) )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4389283 & 1) == 0 )
  {
    ...
    this = (WarBoardSimpleAnimationPerformance__Execute_d__5_o *)sub_B775C4(&Method_WarBoardSimpleAnimationPerformance__Execute_b__5_0__);
    byte_4389283 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_B775C8(&Method_WarBoardSimpleAnimationPerformance__Execute_d__5_System_Collections_IEnumerator_Reset__);
  sub_B77668(v3, v4);
}
