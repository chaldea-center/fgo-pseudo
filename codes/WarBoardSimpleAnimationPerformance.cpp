        ...
        const MethodInfo *method)
{
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.animation, (int32_t)animation, v7, v8);
  this->fields.animationName = animationName;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.animationName, (int32_t)animationName, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FCA59 & 1) == 0 )
  {
    sub_1B64A00(&WarBoardSimpleAnimationPerformance__Execute_d__5_TypeInfo, method);
    byte_49FCA59 = 1;
  }
  v3 = sub_1B64C4C(WarBoardSimpleAnimationPerformance__Execute_d__5_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(animation, 0LL, 0LL) )
  {
    ...
    if ( !v6 || (SimpleAnimation__Rewind(v6, 0LL), (v6 = this->fields.animation) == 0LL) )
      sub_1B64C5C(v6, v5);
    if ( SimpleAnimation__Play_63522800(v6, this->fields.animationName, 0LL) )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FCA5A & 1) == 0 )
  {
    ...
    this = (WarBoardSimpleAnimationPerformance__Execute_d__5_o *)sub_1B64A00(
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B64A14(&Method_WarBoardSimpleAnimationPerformance__Execute_d__5_System_Collections_IEnumerator_Reset__);
  sub_1B64B28(v3, v4);
}
