        ...
        const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.animation, (int32_t)animation, v7, v8);
  this->fields.animationName = animationName;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.animationName, (int32_t)animationName, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C35667 & 1) == 0 )
  {
    sub_1C32C20(&WarBoardSimpleAnimationPerformance__Execute_d__5_TypeInfo);
    byte_4C35667 = 1;
  }
  v3 = sub_1C32E6C(WarBoardSimpleAnimationPerformance__Execute_d__5_TypeInfo);
...
void WarBoardSimpleAnimationPerformance__OnStart(WarBoardSimpleAnimationPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(animation, 0, 0) )
  {
    ...
    if ( !v5 || (SimpleAnimation__Rewind(v5, 0), (v5 = this->fields.animation) == 0) )
      sub_1C32E7C(v5);
    if ( SimpleAnimation__Play_66464300(v5, this->fields.animationName, 0) )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C35668 & 1) == 0 )
  {
    ...
    this = (WarBoardSimpleAnimationPerformance__Execute_d__5_o *)sub_1C32C20(&Method_WarBoardSimpleAnimationPerformance__Execute_b__5_0__);
    byte_4C35668 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C32C34(&Method_WarBoardSimpleAnimationPerformance__Execute_d__5_System_Collections_IEnumerator_Reset__);
  sub_1C32D48(v3, v4);
}
