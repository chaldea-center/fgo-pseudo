        ...
        const MethodInfo *method)
{
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.animation, (int32_t)animation, v7, v8);
  this->fields.animationName = animationName;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.animationName, (int32_t)animationName, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A06B81 & 1) == 0 )
  {
    sub_1B686D4(&WarBoardSimpleAnimationPerformance__Execute_d__5_TypeInfo, method);
    byte_4A06B81 = 1;
  }
  v3 = sub_1B68920(WarBoardSimpleAnimationPerformance__Execute_d__5_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(animation, 0LL, 0LL) )
  {
    ...
    if ( !v6 || (SimpleAnimation__Rewind(v6, 0LL), (v6 = this->fields.animation) == 0LL) )
      sub_1B68930(v6, v5);
    if ( SimpleAnimation__Play_63557140(v6, this->fields.animationName, 0LL) )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A06B82 & 1) == 0 )
  {
    ...
    this = (WarBoardSimpleAnimationPerformance__Execute_d__5_o *)sub_1B686D4(
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B686E8(&Method_WarBoardSimpleAnimationPerformance__Execute_d__5_System_Collections_IEnumerator_Reset__);
  sub_1B687FC(v3, v4);
}
