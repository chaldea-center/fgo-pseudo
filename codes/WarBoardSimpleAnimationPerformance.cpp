        ...
        const MethodInfo *method)
{
  ...
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.animation, (int32_t)animation, v7, v8, v9, v10, v11, v12);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEC26D & 1) == 0 )
  {
    sub_1C7BAE8(&WarBoardSimpleAnimationPerformance__Execute_d__5_TypeInfo);
    byte_4CEC26D = 1;
  }
  v3 = sub_1C7BD34(WarBoardSimpleAnimationPerformance__Execute_d__5_TypeInfo);
...
void WarBoardSimpleAnimationPerformance__OnStart(WarBoardSimpleAnimationPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(animation, 0, 0) )
  {
    ...
    if ( !v6 || (SimpleAnimation__Rewind(v6, 0), (v6 = this->fields.animation) == 0) )
      sub_1C7BD40(v6, v5);
    if ( SimpleAnimation__Play_67121960(v6, this->fields.animationName, 0) )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEC26E & 1) == 0 )
  {
    ...
    this = (WarBoardSimpleAnimationPerformance__Execute_d__5_o *)sub_1C7BAE8(&Method_WarBoardSimpleAnimationPerformance__Execute_b__5_0__);
    byte_4CEC26E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C7BAFC(&Method_WarBoardSimpleAnimationPerformance__Execute_d__5_System_Collections_IEnumerator_Reset__);
  sub_1C7BC10(v3, v4);
}
