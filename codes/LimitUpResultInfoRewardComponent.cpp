void __fastcall LimitUpResultInfoRewardComponent___cctor(const MethodInfo *method)
{
  if ( (byte_4BE002C & 1) == 0 )
  {
    sub_1C21E38(&LimitUpResultInfoRewardComponent_TypeInfo);
    byte_4BE002C = 1;
  }
  *LimitUpResultInfoRewardComponent_TypeInfo->static_fields = (struct LimitUpResultInfoRewardComponent_StaticFields)xmmword_BFE760;
}
        ...
        const MethodInfo *method)
{
  ...
  AtlasManager__SetEventUI(rewardInfoGetIcon, (System_String_o *)StringLiteral_20525/*"icon_reward_get"*/, 0LL);
    ...
    if ( rewardInfoIcon )
    {
      ...
      if ( rewardInfoIcon )
      {
        ...
        if ( rewardInfoIcon )
        {
          ...
          v21.fields.b = 0.0;
          v21.fields.a = 1.0;
          UILabel__set_effectColor((UILabel_o *)rewardInfoIcon, v21, 0LL);
...
LABEL_22:
    sub_1C22094(rewardInfoIcon, v12);
  }
  if ( !rewardInfoIcon )
    goto LABEL_22;
  v17.fields.r = 0.5;
  ...
  v17.fields.b = 0.5;
  v17.fields.a = 1.0;
  ItemIconComponent__SetColor((ItemIconComponent_o *)rewardInfoIcon, v17, 0LL);
  rewardInfoIcon = this->fields.detailLabel;
  if ( !rewardInfoIcon )
    goto LABEL_22;
  v18.fields.r = 0.5;
  ...
  v18.fields.b = 0.5;
  v18.fields.a = 1.0;
  UIWidget__set_color((UIWidget_o *)rewardInfoIcon, v18, 0LL);
  ...
  v15 = 1;
LABEL_21:
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)rewardInfoIcon, v15, 0LL);
