void LimitUpResultInfoRewardComponent___cctor(const MethodInfo *method)
{
  if ( (byte_4C2B330 & 1) == 0 )
  {
    sub_1C2D490(&LimitUpResultInfoRewardComponent_TypeInfo);
    byte_4C2B330 = 1;
  }
  *LimitUpResultInfoRewardComponent_TypeInfo->static_fields = (struct LimitUpResultInfoRewardComponent_StaticFields)xmmword_C09CC0;
}
        ...
        const MethodInfo *method)
{
  ...
  AtlasManager__SetEventUI(rewardInfoGetIcon, (System_String_o *)StringLiteral_20207/*"icon_reward_get"*/, 0);
...
LABEL_22:
    sub_1C2D6EC(rewardInfoIcon, v12);
  }
  if ( !rewardInfoIcon )
    goto LABEL_22;
  v17.fields.r = 0.5;
