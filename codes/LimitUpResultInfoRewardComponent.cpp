void LimitUpResultInfoRewardComponent___cctor(const MethodInfo *method)
{
  if ( (byte_4CBA430 & 1) == 0 )
  {
    sub_1C6BA08(&LimitUpResultInfoRewardComponent_TypeInfo);
    byte_4CBA430 = 1;
  }
  *LimitUpResultInfoRewardComponent_TypeInfo->static_fields = (struct LimitUpResultInfoRewardComponent_StaticFields)xmmword_CEC950;
}
        ...
        const MethodInfo *method)
{
  ...
  AtlasManager__SetEventUI(rewardInfoGetIcon, (System_String_o *)StringLiteral_20286/*"icon_reward_get"*/, 0);
...
LABEL_22:
    sub_1C6BC60(rewardInfoIcon, v12);
  }
  if ( !rewardInfoIcon )
    goto LABEL_22;
  v17.fields.r = 0.5;
