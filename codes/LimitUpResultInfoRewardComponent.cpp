void LimitUpResultInfoRewardComponent___cctor(const MethodInfo *method)
{
  if ( (byte_4CCB588 & 1) == 0 )
  {
    sub_1C713B0(&LimitUpResultInfoRewardComponent_TypeInfo);
    byte_4CCB588 = 1;
  }
  *LimitUpResultInfoRewardComponent_TypeInfo->static_fields = (struct LimitUpResultInfoRewardComponent_StaticFields)xmmword_CEF590;
}
        ...
        const MethodInfo *method)
{
  ...
  AtlasManager__SetEventUI(rewardInfoGetIcon, (System_String_o *)StringLiteral_20298/*"icon_reward_get"*/, 0);
  ...
  if ( !isHaving )
  {
    if ( rewardInfoIcon )
    {
      ...
      v19.fields.b = 1.0;
      v19.fields.a = 1.0;
      ItemIconComponent__SetColor((ItemIconComponent_o *)rewardInfoIcon, v19, 0);
      ...
      if ( rewardInfoIcon )
      {
        ...
        v20.fields.b = 1.0;
        v20.fields.a = 1.0;
        UIWidget__set_color((UIWidget_o *)rewardInfoIcon, v20, 0);
        rewardInfoIcon = this->fields.detailLabel;
        if ( rewardInfoIcon )
        {
          v21.fields.r = 0.0;
          ...
          v21.fields.b = 0.0;
          v21.fields.a = 1.0;
          UILabel__set_effectColor((UILabel_o *)rewardInfoIcon, v21, 0);
...
LABEL_22:
    sub_1C71608(rewardInfoIcon, v12);
  }
  if ( !rewardInfoIcon )
    goto LABEL_22;
  v17.fields.r = 0.5;
  ...
  v17.fields.b = 0.5;
  v17.fields.a = 1.0;
  ItemIconComponent__SetColor((ItemIconComponent_o *)rewardInfoIcon, v17, 0);
  rewardInfoIcon = this->fields.detailLabel;
  if ( !rewardInfoIcon )
    goto LABEL_22;
  v18.fields.r = 0.5;
  ...
  v18.fields.b = 0.5;
  v18.fields.a = 1.0;
  UIWidget__set_color((UIWidget_o *)rewardInfoIcon, v18, 0);
  ...
  v15 = 1;
LABEL_21:
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)rewardInfoIcon, v15, 0);
