void LimitUpResultInfoRewardComponent___cctor(const MethodInfo *method)
{
  if ( (byte_4C5AE5B & 1) == 0 )
  {
    sub_1C3E564(&LimitUpResultInfoRewardComponent_TypeInfo);
    byte_4C5AE5B = 1;
  }
  *LimitUpResultInfoRewardComponent_TypeInfo->static_fields = (struct LimitUpResultInfoRewardComponent_StaticFields)xmmword_C12690;
}
        ...
        const MethodInfo *method)
{
  ...
  AtlasManager__SetEventUI(rewardInfoGetIcon, (System_String_o *)StringLiteral_20240/*"icon_reward_get"*/, 0);
...
LABEL_22:
    sub_1C3E7C0(rewardInfoIcon, v12);
  }
  if ( !rewardInfoIcon )
    goto LABEL_22;
  v17.fields.r = 0.5;
