void __fastcall LimitUpResultInfoRewardComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A31820 & 1) == 0 )
  {
    sub_1B761C0(&LimitUpResultInfoRewardComponent_TypeInfo, v1);
    byte_4A31820 = 1;
  }
  *LimitUpResultInfoRewardComponent_TypeInfo->static_fields = (struct LimitUpResultInfoRewardComponent_StaticFields)xmmword_BAD4C0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A3181F & 1) == 0 )
  {
    ...
    sub_1B761C0(&LimitUpResultInfoRewardComponent_TypeInfo, v11);
    sub_1B761C0(&StringLiteral_20164/*"icon_reward_get"*/, v12);
    byte_4A3181F = 1;
  }
  rewardInfoGetIcon = this->fields.rewardInfoGetIcon;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetEventUI(rewardInfoGetIcon, (System_String_o *)StringLiteral_20164/*"icon_reward_get"*/, 0LL);
...
LABEL_22:
    sub_1B7641C(rewardInfoIcon, v14);
  }
  if ( !rewardInfoIcon )
    goto LABEL_22;
  v19.fields.r = 0.5;
