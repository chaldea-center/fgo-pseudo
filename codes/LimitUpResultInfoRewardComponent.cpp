void __fastcall LimitUpResultInfoRewardComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C25AF9 & 1) == 0 )
  {
    sub_1C3B764(&LimitUpResultInfoRewardComponent_TypeInfo, v1);
    byte_4C25AF9 = 1;
  }
  *LimitUpResultInfoRewardComponent_TypeInfo->static_fields = (struct LimitUpResultInfoRewardComponent_StaticFields)xmmword_C0DB50;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C25AF8 & 1) == 0 )
  {
    ...
    sub_1C3B764(&LimitUpResultInfoRewardComponent_TypeInfo, v11);
    sub_1C3B764(&StringLiteral_20571/*"ivc"*/, v12);
    byte_4C25AF8 = 1;
  }
  rewardInfoGetIcon = this->fields.rewardInfoGetIcon;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetEventUI(rewardInfoGetIcon, (System_String_o *)StringLiteral_20571/*"ivc"*/, 0LL);
...
LABEL_22:
    sub_1C3B9C0(rewardInfoIcon, v14);
  }
  if ( !rewardInfoIcon )
    goto LABEL_22;
  v19.fields.r = 0.5;
