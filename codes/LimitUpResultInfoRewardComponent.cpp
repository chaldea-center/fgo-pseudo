void __fastcall LimitUpResultInfoRewardComponent___cctor(const MethodInfo *method)
{
  if ( (byte_4A5EA7B & 1) == 0 )
  {
    sub_1B885B0(&LimitUpResultInfoRewardComponent_TypeInfo);
    byte_4A5EA7B = 1;
  }
  *LimitUpResultInfoRewardComponent_TypeInfo->static_fields = (struct LimitUpResultInfoRewardComponent_StaticFields)xmmword_BB4C30;
}
        ...
        const MethodInfo *method)
{
  ...
  AtlasManager__SetEventUI(rewardInfoGetIcon, (System_String_o *)StringLiteral_20171/*"icon_reward_get"*/, 0LL);
...
LABEL_22:
    sub_1B8880C(rewardInfoIcon, v12);
  }
  if ( !rewardInfoIcon )
    goto LABEL_22;
  v17.fields.r = 0.5;
