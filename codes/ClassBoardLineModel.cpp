        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCB0F0 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_System_Collections_Generic_List_IClassBoardSquareModel___ctor__, lineEntity);
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.squareList, (int64_t)v6, v7, v8, v9, v10, v11, v12);
  System_Object___ctor((Il2CppObject *)this, 0LL);
  this->fields.entity = lineEntity;
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields, (int64_t)lineEntity, v13, v14, v15, v16, v17, v18);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCB0F1 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_System_Collections_Generic_List_IClassBoardSquareModel__Add__, square);
    byte_4BCB0F1 = 1;
  }
  ...
  else
  {
    ...
    sub_1C1AB78((PartyOrganizationUtility_o *)(v14 + 4), (int64_t)square, (int64_t)method, v3, v4, v5, v6, v7);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCB0F3 & 1) == 0 )
  {
    this = (ClassBoardLineModel_o *)sub_1C1ABD4(&IClassBoardSquareModel_TypeInfo, x);
    byte_4BCB0F3 = 1;
  }
  if ( !x )
    goto LABEL_12;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCB0EF & 1) == 0 )
  {
    sub_1C1ABD4(&Method_ClassBoardLineModel__get_Next_b__6_0__, method);
    sub_1C1ABD4(&Method_System_Linq_Enumerable_FirstOrDefault_IClassBoardSquareModel___, v3);
    sub_1C1ABD4(&System_Func_IClassBoardSquareModel__bool__TypeInfo, v4);
    byte_4BCB0EF = 1;
  }
  squareList = this->fields.squareList;
  v6 = (System_Func_object__bool__o *)sub_1C1AE20(System_Func_IClassBoardSquareModel__bool__TypeInfo);
  System_Func_object__bool____ctor(v6, (Il2CppObject *)this, Method_ClassBoardLineModel__get_Next_b__6_0__, 0LL);
  return (IClassBoardSquareModel_o *)System_Linq_Enumerable__FirstOrDefault_object__50081164(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCB0EE & 1) == 0 )
  {
    sub_1C1ABD4(&Method_ClassBoardLineModel__get_Prev_b__4_0__, method);
    sub_1C1ABD4(&Method_System_Linq_Enumerable_FirstOrDefault_IClassBoardSquareModel___, v3);
    sub_1C1ABD4(&System_Func_IClassBoardSquareModel__bool__TypeInfo, v4);
    byte_4BCB0EE = 1;
  }
