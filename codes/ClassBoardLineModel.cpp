        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A51CB8 & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Collections_Generic_List_IClassBoardSquareModel___ctor__, lineEntity);
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.squareList, (int32_t)v6, v7, v8);
  System_Object___ctor((Il2CppObject *)this, 0LL);
  this->fields.entity = lineEntity;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields, (int32_t)lineEntity, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A51CB9 & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Collections_Generic_List_IClassBoardSquareModel__Add__, square);
    byte_4A51CB9 = 1;
  }
  ...
  else
  {
    ...
    sub_1B8635C((CGThumbnailListItem_o *)(v10 + 4), (int32_t)square, (int32_t)method, v3);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A51CBB & 1) == 0 )
  {
    this = (ClassBoardLineModel_o *)sub_1B863B8(&IClassBoardSquareModel_TypeInfo, x);
    byte_4A51CBB = 1;
  }
  if ( !x )
    goto LABEL_12;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A51CB7 & 1) == 0 )
  {
    sub_1B863B8(&Method_ClassBoardLineModel__get_Next_b__6_0__, method);
    sub_1B863B8(&Method_System_Linq_Enumerable_FirstOrDefault_IClassBoardSquareModel___, v3);
    sub_1B863B8(&System_Func_IClassBoardSquareModel__bool__TypeInfo, v4);
    byte_4A51CB7 = 1;
  }
  squareList = this->fields.squareList;
  v6 = (System_Func_object__bool__o *)sub_1B86604(System_Func_IClassBoardSquareModel__bool__TypeInfo);
  System_Func_object__bool____ctor(v6, (Il2CppObject *)this, Method_ClassBoardLineModel__get_Next_b__6_0__, 0LL);
  return (IClassBoardSquareModel_o *)System_Linq_Enumerable__FirstOrDefault_object__49893388(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A51CB6 & 1) == 0 )
  {
    sub_1B863B8(&Method_ClassBoardLineModel__get_Prev_b__4_0__, method);
    sub_1B863B8(&Method_System_Linq_Enumerable_FirstOrDefault_IClassBoardSquareModel___, v3);
    sub_1B863B8(&System_Func_IClassBoardSquareModel__bool__TypeInfo, v4);
    byte_4A51CB6 = 1;
  }
