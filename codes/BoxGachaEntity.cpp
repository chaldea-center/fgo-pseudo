...
System_String_o *__fastcall BoxGachaEntity__GetMessagePrizeName(BoxGachaEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FE213 & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_21333/*"message_prize_name"*/, v4);
    byte_49FE213 = 1;
  }
  value = 0LL;
...
bool __fastcall BoxGachaEntity__IsResetTarget(BoxGachaEntity_o *this, int32_t idx, const MethodInfo *method)
{
  ...
  if ( (byte_49FE212 & 1) == 0 )
  {
    sub_1B64870(&Method_DataManager_GetMasterData_BoxGachaBaseMaster___, *(_QWORD *)&idx);
  ...
  Instance = DataManager__GetMasterData_object_(
               ...
               (const MethodInfo_2E3B6C8 *)Method_DataManager_GetMasterData_BoxGachaBaseMaster___);
