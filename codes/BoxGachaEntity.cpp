...
System_String_o *__fastcall BoxGachaEntity__GetMessagePrizeName(BoxGachaEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B01CF7 & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_21346/*"message_prize_name"*/, v4);
    byte_4B01CF7 = 1;
  }
  value = 0LL;
  ...
  if ( result )
  {
    if ( !System_Collections_Generic_Dictionary_object__object___TryGetValue(
            ...
            (Il2CppObject *)StringLiteral_21346/*"message_prize_name"*/,
            &value,
...
bool __fastcall BoxGachaEntity__IsResetTarget(BoxGachaEntity_o *this, int32_t idx, const MethodInfo *method)
{
  ...
  if ( (byte_4B01CF6 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMasterData_BoxGachaBaseMaster___, *(_QWORD *)&idx);
  ...
  Instance = DataManager__GetMasterData_object_(
               ...
               (const MethodInfo_3001E64 *)Method_DataManager_GetMasterData_BoxGachaBaseMaster___);
