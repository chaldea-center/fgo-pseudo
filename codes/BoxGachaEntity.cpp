...
System_String_o *__fastcall BoxGachaEntity__GetMessagePrizeName(BoxGachaEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB43CB & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_21766/*"message-type"*/, v4);
    byte_4BB43CB = 1;
  }
  value = 0LL;
  ...
  if ( result )
  {
    if ( !System_Collections_Generic_Dictionary_object__object___TryGetValue(
            ...
            (Il2CppObject *)StringLiteral_21766/*"message-type"*/,
            &value,
...
bool __fastcall BoxGachaEntity__IsResetTarget(BoxGachaEntity_o *this, int32_t idx, const MethodInfo *method)
{
  ...
  if ( (byte_4BB43CA & 1) == 0 )
  {
    sub_1C13D24(&Method_DataManager_GetMasterData_BoxGachaBaseMaster___, *(_QWORD *)&idx);
  ...
  Instance = DataManager__GetMasterData_object_(
               ...
               (const MethodInfo_2F8F46C *)Method_DataManager_GetMasterData_BoxGachaBaseMaster___);
