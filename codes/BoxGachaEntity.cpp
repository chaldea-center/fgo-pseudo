...
System_String_o *__fastcall BoxGachaEntity__GetMessagePrizeName(BoxGachaEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42EA568 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&StringLiteral_20749/*"message_prize_name"*/, v8, v9, v10);
    byte_42EA568 = 1;
  }
  value = 0LL;
  ...
  if ( result )
  {
    if ( !System_Collections_Generic_Dictionary_XmlQualifiedName__XmlSchemaObject___TryGetValue(
            ...
            (System_Xml_XmlQualifiedName_o *)StringLiteral_20749/*"message_prize_name"*/,
            &value,
...
bool __fastcall BoxGachaEntity__IsResetTarget(BoxGachaEntity_o *this, int32_t idx, const MethodInfo *method)
{
  ...
  if ( (byte_42EA567 & 1) == 0 )
  {
    sub_B5D5C4(&Method_DataManager_GetMasterData_BoxGachaBaseMaster___, idx, (_DWORD)method, v3);
  ...
  Instance = (DataManager_o *)DataManager__GetMasterData_WarQuestSelectionMaster_(
                                Instance,
                                (const MethodInfo_1AE424C *)Method_DataManager_GetMasterData_BoxGachaBaseMaster___);
...
LABEL_10:
  ...
  return BoxGachaBaseMaster__checkIsResetTarget((BoxGachaBaseMaster_o *)Instance, baseIds->m_Items[v14 + 1], v11);
}