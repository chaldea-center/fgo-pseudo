...
System_String_o *BoxGachaEntity__GetMessagePrizeName(BoxGachaEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D306C7 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_21824/*"message_prize_name"*/);
    byte_4D306C7 = 1;
  }
  value = 0;
  ...
  if ( result )
  {
    if ( !System_Collections_Generic_Dictionary_object__object___TryGetValue(
            ...
            (Il2CppObject *)StringLiteral_21824/*"message_prize_name"*/,
            &value,
...
bool BoxGachaEntity__IsResetTarget(BoxGachaEntity_o *this, int32_t idx, const MethodInfo *method)
{
  ...
  if ( (byte_4D306C6 & 1) == 0 )
  {
    sub_1C93AD4(&Method_DataManager_GetMasterData_BoxGachaBaseMaster___);
  ...
  Instance = DataManager__GetMasterData_object_(
               ...
               (const MethodInfo_31A4A3C *)Method_DataManager_GetMasterData_BoxGachaBaseMaster___);
