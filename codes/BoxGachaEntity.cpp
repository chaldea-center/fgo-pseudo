...
System_String_o *BoxGachaEntity__GetMessagePrizeName(BoxGachaEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C56A2A & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_21577/*"message_prize_name"*/);
    byte_4C56A2A = 1;
  }
  value = 0;
  ...
  if ( result )
  {
    if ( !System_Collections_Generic_Dictionary_object__object___TryGetValue(
            ...
            (Il2CppObject *)StringLiteral_21577/*"message_prize_name"*/,
            &value,
...
bool BoxGachaEntity__IsResetTarget(BoxGachaEntity_o *this, int32_t idx, const MethodInfo *method)
{
  ...
  if ( (byte_4C56A29 & 1) == 0 )
  {
    sub_1C3E564(&Method_DataManager_GetMasterData_BoxGachaBaseMaster___);
  ...
  Instance = DataManager__GetMasterData_object_(
               ...
               (const MethodInfo_30F9A70 *)Method_DataManager_GetMasterData_BoxGachaBaseMaster___);
