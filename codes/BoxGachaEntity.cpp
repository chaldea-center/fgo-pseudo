...
System_String_o *BoxGachaEntity__GetMessagePrizeName(BoxGachaEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC70B0 & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_21660/*"message_prize_name"*/);
    byte_4CC70B0 = 1;
  }
  value = 0;
  ...
  if ( result )
  {
    if ( !System_Collections_Generic_Dictionary_object__object___TryGetValue(
            ...
            (Il2CppObject *)StringLiteral_21660/*"message_prize_name"*/,
            &value,
...
bool BoxGachaEntity__IsResetTarget(BoxGachaEntity_o *this, int32_t idx, const MethodInfo *method)
{
  ...
  if ( (byte_4CC70AF & 1) == 0 )
  {
    sub_1C713B0(&Method_DataManager_GetMasterData_BoxGachaBaseMaster___);
  ...
  Instance = DataManager__GetMasterData_object_(
               ...
               (const MethodInfo_314B10C *)Method_DataManager_GetMasterData_BoxGachaBaseMaster___);
