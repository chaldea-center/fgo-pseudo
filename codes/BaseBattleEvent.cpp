        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A723DA & 1) == 0 )
  {
    sub_1B90010(&BuffList_TypeInfo, buffEnt);
    byte_4A723DA = 1;
  }
  ...
  if ( !IsBattleEndReduceBuffTurn )
  {
    if ( buffEnt )
      goto LABEL_8;
LABEL_11:
    sub_1B9026C(IsBattleEndReduceBuffTurn, v6);
  }
  if ( !buffEnt )
    goto LABEL_11;
        ...
        const MethodInfo *method)
{
  ...
  v2 = (Il2CppObject *)sub_1B9025C(BaseBattleServantEvent_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( !data || (logic = data->fields.logic) == 0LL )
    sub_1B9026C(this, isPrecedingPlayer);
  v6 = BattleAttackManager__Make(isPrecedingPlayer, logic->fields.logiclist, 0LL);
  data->fields.battleAtkManager = v6;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&data->fields.battleAtkManager, (int32_t)v6, v7, v8);
}
...
BaseBattleEvent_o *__fastcall BaseBattleEvent__MakeBattleEvent(BattleData_o *data, const MethodInfo *method)
{
  ...
  if ( (byte_4A723D7 & 1) == 0 )
  {
    sub_1B90010(&BaseBattleEvent_TypeInfo, method);
    data = (BattleData_o *)sub_1B90010(&WarBoardBattleEvent_TypeInfo, v3);
    byte_4A723D7 = 1;
  }
  if ( !v2
    || (quest_ent = v2->fields.quest_ent,
        v5 = sub_1B9025C(BaseBattleEvent_TypeInfo),
        *(_DWORD *)(v5 + 24) = -1,
        System_Object___ctor((Il2CppObject *)v5, 0LL),
        !quest_ent)
    || quest_ent->fields.type == 7
    && (v5 = sub_1B9025C(WarBoardBattleEvent_TypeInfo), WarBoardBattleEvent___ctor((WarBoardBattleEvent_o *)v5, v6), !v5) )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A723DB & 1) == 0 )
  {
    sub_1B90010(&System_Action_BattleServantData__TypeInfo, execUniqueIds);
    sub_1B90010(&Method_BasicHelper_ForEach_BattleServantData___, v7);
    sub_1B90010(&Method_System_Linq_Enumerable_Concat_BattleServantData___, v8);
    ...
    sub_1B90010(&Method_BaseBattleEvent___c__DisplayClass44_0__ProgressNoExecJoinServantsBuff_b__0__, v11);
    sub_1B90010(&Method_BaseBattleEvent___c__DisplayClass44_0__ProgressNoExecJoinServantsBuff_b__1__, v12);
    sub_1B90010(&BaseBattleEvent___c__DisplayClass44_0_TypeInfo, v13);
    byte_4A723DB = 1;
  }
  v14 = sub_1B9025C(BaseBattleEvent___c__DisplayClass44_0_TypeInfo);
  ...
  *(_QWORD *)(v14 + 24) = execUniqueIds;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v14 + 24), (int32_t)execUniqueIds, v19, v20);
  *(_BYTE *)(v14 + 32) = isEndEnemyTurn;
  ...
  {
LABEL_7:
    sub_1B9026C(Data_k__BackingField, v16);
  }
  ...
  v24 = System_Linq_Enumerable__Concat_object_(
          v22,
          SubServantArray,
          (const MethodInfo_2EA7E08 *)Method_System_Linq_Enumerable_Concat_BattleServantData___);
  ...
  v27 = (System_Action_object__o *)sub_1B9025C(System_Action_BattleServantData__TypeInfo);
...
bool __fastcall BaseBattleEvent__get_IsBattleEndReduceBuffTurn(BaseBattleEvent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A723D8 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_15505/*"WAR_BOARD_BATTLE_END_REDUCE_BUFF_TURN_FLAG"*/, method);
    byte_4A723D8 = 1;
  }
  battleEndReduceBuffTurnFlag = this->fields.battleEndReduceBuffTurnFlag;
  if ( (battleEndReduceBuffTurnFlag & 0x80000000) != 0 )
  {
    Value = ConstantMaster__getValue((System_String_o *)StringLiteral_15505/*"WAR_BOARD_BATTLE_END_REDUCE_BUFF_TURN_FLAG"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A723DD & 1) == 0 )
  {
    this = (BaseBattleEvent___c__DisplayClass44_0_o *)sub_1B90010(&Method_System_Array_IndexOf_int___, x);
    byte_4A723DD = 1;
  }
