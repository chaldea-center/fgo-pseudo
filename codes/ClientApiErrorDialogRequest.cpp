        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C39469 & 1) == 0 )
  {
    sub_1C32C20(&StringLiteral_19070/*"errorMessage"*/);
    sub_1C32C20(&StringLiteral_21336/*"logDetail"*/);
    sub_1C32C20(&StringLiteral_19071/*"errorTitle"*/);
    sub_1C32C20(&StringLiteral_1/*""*/);
    byte_4C39469 = 1;
  }
  RequestBase__addField_44145196((RequestBase_o *)this, (System_String_o *)StringLiteral_19071/*"errorTitle"*/, errorTitle, 0);
  RequestBase__addField_44145196((RequestBase_o *)this, (System_String_o *)StringLiteral_19070/*"errorMessage"*/, errorMessage, 0);
  if ( !this )
    sub_1C32E7C(v11);
  if ( isSendLogDetail )
    v12 = logDetail;
  ...
  RequestBase__addField_44145196((RequestBase_o *)this, (System_String_o *)StringLiteral_21336/*"logDetail"*/, v12, 0);
...
System_String_o *ClientApiErrorDialogRequest__getURL(ClientApiErrorDialogRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C39467 & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_4500/*"ClientApi/ErrorDialog"*/);
    byte_4C39467 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63518544(BaseUrl, (System_String_o *)StringLiteral_4500/*"ClientApi/ErrorDialog"*/, 0);
}
