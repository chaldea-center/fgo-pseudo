        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4FE65 & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_18835/*"errorMessage"*/, errorTitle);
    sub_1B863B8(&StringLiteral_21015/*"logDetail"*/, v11);
    sub_1B863B8(&StringLiteral_18836/*"errorTitle"*/, v12);
    sub_1B863B8(&StringLiteral_1/*""*/, v13);
    byte_4A4FE65 = 1;
  }
  RequestBase__addField_42282000((RequestBase_o *)this, (System_String_o *)StringLiteral_18836/*"errorTitle"*/, errorTitle, 0LL);
  RequestBase__addField_42282000((RequestBase_o *)this, (System_String_o *)StringLiteral_18835/*"errorMessage"*/, errorMessage, 0LL);
  if ( !this )
    sub_1B86614(v14, v15);
  if ( isSendLogDetail )
    v16 = logDetail;
  ...
  RequestBase__addField_42282000((RequestBase_o *)this, (System_String_o *)StringLiteral_21015/*"logDetail"*/, v16, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4FE63 & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_4473/*"ClientApi/ErrorDialog"*/, v2);
    byte_4A4FE63 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61645176(BaseUrl, (System_String_o *)StringLiteral_4473/*"ClientApi/ErrorDialog"*/, 0LL);
}
