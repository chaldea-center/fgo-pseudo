        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB7DA8 & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_19122/*"errorMessage"*/);
    sub_1C6BA08(&StringLiteral_21423/*"logDetail"*/);
    sub_1C6BA08(&StringLiteral_19123/*"errorTitle"*/);
    sub_1C6BA08(&StringLiteral_1/*""*/);
    byte_4CB7DA8 = 1;
  }
  RequestBase__addField_44471996((RequestBase_o *)this, (System_String_o *)StringLiteral_19123/*"errorTitle"*/, errorTitle, 0);
  RequestBase__addField_44471996((RequestBase_o *)this, (System_String_o *)StringLiteral_19122/*"errorMessage"*/, errorMessage, 0);
  if ( !this )
    sub_1C6BC60(v11, v12);
  if ( isSendLogDetail )
    v13 = logDetail;
  ...
  RequestBase__addField_44471996((RequestBase_o *)this, (System_String_o *)StringLiteral_21423/*"logDetail"*/, v13, 0);
...
System_String_o *ClientApiErrorDialogRequest__getURL(ClientApiErrorDialogRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB7DA6 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_4490/*"ClientApi/ErrorDialog"*/);
    byte_4CB7DA6 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63966792(BaseUrl, (System_String_o *)StringLiteral_4490/*"ClientApi/ErrorDialog"*/, 0);
}
