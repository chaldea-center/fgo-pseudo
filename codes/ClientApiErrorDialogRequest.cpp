        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B46494 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_19079/*"errorMessage"*/, errorTitle);
    sub_1BDB878(&StringLiteral_21352/*"logDetail"*/, v11);
    sub_1BDB878(&StringLiteral_19080/*"errorTitle"*/, v12);
    sub_1BDB878(&StringLiteral_1/*""*/, v13);
    byte_4B46494 = 1;
  }
  RequestBase__addField_43151112((RequestBase_o *)this, (System_String_o *)StringLiteral_19080/*"errorTitle"*/, errorTitle, 0LL);
  RequestBase__addField_43151112((RequestBase_o *)this, (System_String_o *)StringLiteral_19079/*"errorMessage"*/, errorMessage, 0LL);
  if ( !this )
    sub_1BDBAD4(v14, v15);
  if ( isSendLogDetail )
    v16 = logDetail;
  ...
  RequestBase__addField_43151112((RequestBase_o *)this, (System_String_o *)StringLiteral_21352/*"logDetail"*/, v16, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B46492 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_4539/*"ClientApi/ErrorDialog"*/, v2);
    byte_4B46492 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62572260(BaseUrl, (System_String_o *)StringLiteral_4539/*"ClientApi/ErrorDialog"*/, 0LL);
}
