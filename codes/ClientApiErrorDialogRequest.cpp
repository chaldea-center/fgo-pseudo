        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B07B8 & 1) == 0 )
  {
    sub_B52984(&StringLiteral_18534/*"errorMessage"*/);
    sub_B52984(&StringLiteral_20463/*"logDetail"*/);
    sub_B52984(&StringLiteral_18535/*"errorTitle"*/);
    sub_B52984(&StringLiteral_1/*""*/);
    byte_42B07B8 = 1;
  }
  RequestBase__addField_32020920((RequestBase_o *)this, (System_String_o *)StringLiteral_18535/*"errorTitle"*/, errorTitle, 0LL);
  RequestBase__addField_32020920((RequestBase_o *)this, (System_String_o *)StringLiteral_18534/*"errorMessage"*/, errorMessage, 0LL);
  if ( !this )
    sub_B52A5C(v11, v12);
  if ( isSendLogDetail )
    v13 = logDetail;
  ...
  RequestBase__addField_32020920((RequestBase_o *)this, (System_String_o *)StringLiteral_20463/*"logDetail"*/, v13, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B07B6 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_4069/*"ClientApi/ErrorDialog"*/);
    byte_42B07B6 = 1;
  }
  ...
  return System_String__Concat_44568316(BaseUrl, (System_String_o *)StringLiteral_4069/*"ClientApi/ErrorDialog"*/, 0LL);
}
