...
void __fastcall BattleSetupInfo___ctor_40195792(
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.followerClassId = *(_QWORD *)&saveInfo->fields.followerClassId;
  ...
  sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.demoInfo, (int64_t)demoInfo, v7, v8, v9, v10, v11, v12);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21A3A & 1) == 0 )
  {
    sub_1C3B764(&BattleSetupInfo_TypeInfo, *(_QWORD *)&warId);
  ...
  v18 = sub_1C3B9B0(BattleSetupInfo_TypeInfo);
  *(_BYTE *)(v18 + 189) = 1;
...
LABEL_10:
  ...
  *(_QWORD *)(v18 + 144) = StringLiteral_1/*""*/;
  sub_1C3B708((PartyOrganizationUtility_o *)(v18 + 144), (int64_t)v27, v28, v29, v30, v31, v32, v33);
  *(_DWORD *)(v18 + 152) = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21A36 & 1) == 0 )
  {
    sub_1C3B764(&BattleSetupInfo_BattleSetupSaveInfo_TypeInfo, method);
    byte_4C21A36 = 1;
  }
  v3 = sub_1C3B9B0(BattleSetupInfo_BattleSetupSaveInfo_TypeInfo);
  ...
  *(_QWORD *)(v3 + 88) = demoInfo;
  sub_1C3B708((PartyOrganizationUtility_o *)(v3 + 88), (int64_t)demoInfo, v6, v7, v8, v9, v10, v11);
  ...
  *(_QWORD *)(v3 + 112) = choiceRandomLimitCounts;
  sub_1C3B708((PartyOrganizationUtility_o *)(v3 + 112), (int64_t)choiceRandomLimitCounts, v14, v15, v16, v17, v18, v19);
  ...
  *(_QWORD *)(v3 + 144) = useRewardAddItemIds;
  sub_1C3B708((PartyOrganizationUtility_o *)(v3 + 144), (int64_t)useRewardAddItemIds, v21, v22, v23, v24, v25, v26);
...
void __fastcall BattleSetupInfo__SetEventUpValues(BattleSetupInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C21A37 & 1) == 0 )
  {
    ...
    sub_1C3B764(&EventUpValSetupInfo_TypeInfo, v4);
  ...
  if ( this->fields.eventId >= 1 )
  {
    ...
    if ( Entity )
    {
      if ( EventDetailEntity__IsBonusSkill((EventDetailEntity_o *)Entity, 0LL) )
      {
        ...
        v13 = v10;
        v14 = (EventUpValSetupInfo_o *)sub_1C3B9B0(EventUpValSetupInfo_TypeInfo);
...
void __fastcall BattleSetupInfo__SetRestriction(BattleSetupInfo_o *this, bool isResetDeck, const MethodInfo *method)
{
  ...
  if ( (byte_4C21A38 & 1) == 0 )
  {
    sub_1C3B764(&QuestRestrictionInfo_TypeInfo, isResetDeck);
    byte_4C21A38 = 1;
  }
  eventId = this->fields.eventId;
  ...
  questPhase = this->fields.questPhase;
  v8 = v6;
  v9 = (QuestRestrictionInfo_o *)sub_1C3B9B0(QuestRestrictionInfo_TypeInfo);
  QuestRestrictionInfo___ctor_41899336(v9, eventId, v8, questPhase, 0LL);
...
void __fastcall BattleSetupInfo__SetSelectableQuests(BattleSetupInfo_o *this, const MethodInfo *method)
{
  ...
  sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.selectableQuestIds, 0LL, v2, v3, v4, v5, v6, v7);
