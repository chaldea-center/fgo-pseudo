...
void BattleSetupInfo___ctor_41811448(
        ...
        const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.followerClassId = *(_OWORD *)&saveInfo->fields.followerClassId;
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.demoInfo, (int32_t)demoInfo, v7, v8);
  *(_QWORD *)&this->fields.selectedBranchIdx = *(_QWORD *)&saveInfo->fields.selectedBranchIdx;
  ...
  BattleSetupInfo__SetSelectableQuests(this, 0, v12);
  ...
  *(_QWORD *)&this->fields.recommendSupportIdx = *(_QWORD *)&saveInfo->fields.recommendSupportIdx;
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)p_useRewardAddItemIds, (int32_t)useRewardAddItemIds, v18, v19);
        ...
        const MethodInfo *method)
{
  ...
  v14 = sub_1C6BC54(BattleSetupInfo_TypeInfo);
  *(_BYTE *)(v14 + 189) = 1;
...
LABEL_10:
  ...
  *(_QWORD *)(v14 + 144) = StringLiteral_1/*""*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)(v14 + 144), v23, v24, v25);
  *(_DWORD *)(v14 + 152) = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB5D2D & 1) == 0 )
  {
    sub_1C6BA08(&BattleSetupInfo_BattleSetupSaveInfo_TypeInfo);
    byte_4CB5D2D = 1;
  }
  v3 = sub_1C6BC54(BattleSetupInfo_BattleSetupSaveInfo_TypeInfo);
  ...
  *(_QWORD *)(v3 + 88) = demoInfo;
  sub_1C6B9AC((CGThumbnailListItem_o *)(v3 + 88), (int32_t)demoInfo, v6, v7);
  ...
  *(_QWORD *)(v3 + 112) = choiceRandomLimitCounts;
  sub_1C6B9AC((CGThumbnailListItem_o *)(v3 + 112), (int32_t)choiceRandomLimitCounts, v10, v11);
  ...
  *(_QWORD *)(v3 + 144) = useRewardAddItemIds;
  sub_1C6B9AC((CGThumbnailListItem_o *)(v3 + 144), (int32_t)useRewardAddItemIds, v13, v14);
  ...
  if ( this->fields.eventId >= 1 )
  {
    ...
    if ( Entity )
    {
      if ( EventDetailEntity__IsBonusSkill((EventDetailEntity_o *)Entity, 0) )
      {
        ...
        sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.eventUpValSetupInfo, (int32_t)v11, v12, v13);
      }
    }
  }
}
...
void BattleSetupInfo__SetRestriction(BattleSetupInfo_o *this, bool isResetDeck, const MethodInfo *method)
{
  ...
  questPhase = this->fields.questPhase;
  v8 = v6;
  v9 = (QuestRestrictionInfo_o *)sub_1C6BC54(QuestRestrictionInfo_TypeInfo);
  QuestRestrictionInfo___ctor_43646264(v9, eventId, v8, questPhase, 0);
  this->fields.questRestrictionInfo = v9;
  p_questRestrictionInfo = &this->fields.questRestrictionInfo;
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.questRestrictionInfo, (int32_t)v9, v11, v12);
  if ( isResetDeck )
  {
...
void BattleSetupInfo__SetSelectableQuests(BattleSetupInfo_o *this, bool isIncludeTempData, const MethodInfo *method)
{
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.selectableQuestIds, 0, (int32_t)method, v3);
  ...
  if ( !entity
    || (SelectableQuests = QuestPhaseEntity__GetSelectableQuests(entity, 0),
        ...
        sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.selectableQuestIds, (int32_t)SelectableQuests, v9, v10),
