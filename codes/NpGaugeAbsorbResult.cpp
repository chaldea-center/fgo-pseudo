void NpGaugeAbsorbResult___ctor(NpGaugeAbsorbResult_o *this, BaseNpGaugeConvert_o *convert, const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields._Convert_k__BackingField, (int32_t)convert, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields._Convert_k__BackingField, (int32_t)value, (int32_t)method, v3);
}
