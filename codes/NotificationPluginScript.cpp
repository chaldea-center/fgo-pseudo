...
LocalNotificationService_o *__fastcall NotificationPluginScript__Setup(const MethodInfo *method)
{
  ...
  if ( (byte_4C2380E & 1) == 0 )
  {
    sub_1C3B764(&LocalNotificationServiceAndroid_TypeInfo, v1);
    sub_1C3B764(&NotificationPluginScript_TypeInfo, v2);
    byte_4C2380E = 1;
  }
  result = NotificationPluginScript_TypeInfo->static_fields->_service;
  if ( !result )
  {
    v4 = (LocalNotificationServiceAndroid_o *)sub_1C3B9B0(LocalNotificationServiceAndroid_TypeInfo);
