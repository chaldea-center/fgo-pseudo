...
LocalNotificationService_o *__fastcall NotificationPluginScript__Setup(const MethodInfo *method)
{
  ...
  if ( (byte_49FDAB2 & 1) == 0 )
  {
    sub_1B640C8(&LocalNotificationServiceAndroid_TypeInfo, v1);
    sub_1B640C8(&NotificationPluginScript_TypeInfo, v3);
    byte_49FDAB2 = 1;
  }
  result = NotificationPluginScript_TypeInfo->static_fields->_service;
  if ( !result )
  {
    v5 = (LocalNotificationServiceAndroid_o *)sub_1B64314(LocalNotificationServiceAndroid_TypeInfo, v1, v2);
    LocalNotificationServiceAndroid___ctor(v5, v6);
    NotificationPluginScript_TypeInfo->static_fields->_service = (struct LocalNotificationService_o *)v5;
    sub_1B6406C(
