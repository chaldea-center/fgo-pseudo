...
LocalNotificationService_o *__fastcall NotificationPluginScript__Setup(const MethodInfo *method)
{
  ...
  if ( (byte_4B683DB & 1) == 0 )
  {
    sub_1BE4ACC(&LocalNotificationServiceAndroid_TypeInfo, v1);
    sub_1BE4ACC(&NotificationPluginScript_TypeInfo, v2);
    byte_4B683DB = 1;
  }
  result = NotificationPluginScript_TypeInfo->static_fields->_service;
  if ( !result )
  {
    v4 = (LocalNotificationServiceAndroid_o *)sub_1BE4D18(LocalNotificationServiceAndroid_TypeInfo);
