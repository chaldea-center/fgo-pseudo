...
LocalNotificationService_o *__fastcall NotificationPluginScript__Setup(const MethodInfo *method)
{
  ...
  if ( (byte_4AB74F8 & 1) == 0 )
  {
    sub_1BAB41C(&LocalNotificationServiceAndroid_TypeInfo, v1);
    sub_1BAB41C(&NotificationPluginScript_TypeInfo, v2);
    byte_4AB74F8 = 1;
  }
  result = NotificationPluginScript_TypeInfo->static_fields->_service;
  if ( !result )
  {
    v4 = (LocalNotificationServiceAndroid_o *)sub_1BAB668(LocalNotificationServiceAndroid_TypeInfo);
