...
LocalNotificationService_o *NotificationPluginScript__Setup(const MethodInfo *method)
{
  ...
  if ( (byte_59722FE & 1) == 0 )
  {
    sub_2213A60(&LocalNotificationServiceAndroid_TypeInfo);
    sub_2213A60(&NotificationPluginScript_TypeInfo);
    byte_59722FE = 1;
  }
  result = NotificationPluginScript_TypeInfo->static_fields->_service;
  if ( !result )
  {
    v2 = (LocalNotificationServiceAndroid_o *)sub_2213CCC(LocalNotificationServiceAndroid_TypeInfo);
