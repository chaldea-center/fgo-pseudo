...
LocalNotificationService_o *NotificationPluginScript__Setup(const MethodInfo *method)
{
  ...
  if ( (byte_4E06426 & 1) == 0 )
  {
    sub_1CE6700(&LocalNotificationServiceAndroid_TypeInfo);
    sub_1CE6700(&NotificationPluginScript_TypeInfo);
    byte_4E06426 = 1;
  }
  result = NotificationPluginScript_TypeInfo->static_fields->_service;
  if ( !result )
  {
    v2 = (LocalNotificationServiceAndroid_o *)sub_1CE694C(LocalNotificationServiceAndroid_TypeInfo);
