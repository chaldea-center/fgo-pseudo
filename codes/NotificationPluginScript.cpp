...
LocalNotificationService_o *__fastcall NotificationPluginScript__Setup(const MethodInfo *method)
{
  ...
  if ( (byte_4A2F6CE & 1) == 0 )
  {
    sub_1B761C0(&LocalNotificationServiceAndroid_TypeInfo, v1);
    sub_1B761C0(&NotificationPluginScript_TypeInfo, v2);
    byte_4A2F6CE = 1;
  }
  result = NotificationPluginScript_TypeInfo->static_fields->_service;
  if ( !result )
  {
    v4 = (LocalNotificationServiceAndroid_o *)sub_1B7640C(LocalNotificationServiceAndroid_TypeInfo);
