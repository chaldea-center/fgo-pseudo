...
LocalNotificationService_o *__fastcall NotificationPluginScript__Setup(const MethodInfo *method)
{
  ...
  if ( (byte_4A001CE & 1) == 0 )
  {
    sub_1B64A00(&LocalNotificationServiceAndroid_TypeInfo, v1);
    sub_1B64A00(&NotificationPluginScript_TypeInfo, v2);
    byte_4A001CE = 1;
  }
  result = NotificationPluginScript_TypeInfo->static_fields->_service;
  if ( !result )
  {
    v4 = (LocalNotificationServiceAndroid_o *)sub_1B64C4C(LocalNotificationServiceAndroid_TypeInfo);
