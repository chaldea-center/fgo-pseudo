...
LocalNotificationService_o *__fastcall NotificationPluginScript__Setup(const MethodInfo *method)
{
  ...
  if ( (byte_4B4640A & 1) == 0 )
  {
    sub_1BDB878(&LocalNotificationServiceAndroid_TypeInfo, v1);
    sub_1BDB878(&NotificationPluginScript_TypeInfo, v2);
    byte_4B4640A = 1;
  }
  result = NotificationPluginScript_TypeInfo->static_fields->_service;
  if ( !result )
  {
    v4 = (LocalNotificationServiceAndroid_o *)sub_1BDBAC4(LocalNotificationServiceAndroid_TypeInfo);
    ...
    sub_1BDB81C((CGThumbnailListItem_o *)NotificationPluginScript_TypeInfo->static_fields, (int32_t)v4, v6, v7);
