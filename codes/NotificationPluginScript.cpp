...
LocalNotificationService_o *NotificationPluginScript__Setup(const MethodInfo *method)
{
  ...
  if ( (byte_4CC8E46 & 1) == 0 )
  {
    sub_1C713B0(&LocalNotificationServiceAndroid_TypeInfo);
    sub_1C713B0(&NotificationPluginScript_TypeInfo);
    byte_4CC8E46 = 1;
  }
  result = NotificationPluginScript_TypeInfo->static_fields->_service;
  if ( !result )
  {
    v2 = (LocalNotificationServiceAndroid_o *)sub_1C715FC(LocalNotificationServiceAndroid_TypeInfo);
