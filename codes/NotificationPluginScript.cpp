...
LocalNotificationService_o *__fastcall NotificationPluginScript__Setup(const MethodInfo *method)
{
  ...
  if ( (byte_49BC73D & 1) == 0 )
  {
    sub_1B4CF90(&LocalNotificationServiceAndroid_TypeInfo, v1);
    sub_1B4CF90(&NotificationPluginScript_TypeInfo, v2);
    byte_49BC73D = 1;
  }
  result = NotificationPluginScript_TypeInfo->static_fields->_service;
  if ( !result )
  {
    v4 = (LocalNotificationServiceAndroid_o *)sub_1B4D1DC(LocalNotificationServiceAndroid_TypeInfo);
    ...
    sub_1B4CF34((CGThumbnailListItem_o *)NotificationPluginScript_TypeInfo->static_fields, (int32_t)v4, v6, v7);
