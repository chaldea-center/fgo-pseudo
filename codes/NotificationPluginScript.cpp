...
LocalNotificationService_o *__fastcall NotificationPluginScript__Setup(const MethodInfo *method)
{
  ...
  if ( (byte_49FFBAD & 1) == 0 )
  {
    sub_1B64870(&LocalNotificationServiceAndroid_TypeInfo, v1);
    sub_1B64870(&NotificationPluginScript_TypeInfo, v2);
    byte_49FFBAD = 1;
  }
  result = NotificationPluginScript_TypeInfo->static_fields->_service;
  if ( !result )
  {
    v4 = (LocalNotificationServiceAndroid_o *)sub_1B64ABC(LocalNotificationServiceAndroid_TypeInfo);
