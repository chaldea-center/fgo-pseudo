...
LocalNotificationService_o *__fastcall NotificationPluginScript__Setup(const MethodInfo *method)
{
  ...
  if ( (byte_4BFEFE4 & 1) == 0 )
  {
    sub_1C2E12C(&LocalNotificationServiceAndroid_TypeInfo, v1);
    sub_1C2E12C(&NotificationPluginScript_TypeInfo, v2);
    byte_4BFEFE4 = 1;
  }
  result = NotificationPluginScript_TypeInfo->static_fields->_service;
  if ( !result )
  {
    v4 = (LocalNotificationServiceAndroid_o *)sub_1C2E378(LocalNotificationServiceAndroid_TypeInfo);
