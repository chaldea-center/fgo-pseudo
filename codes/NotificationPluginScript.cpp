...
LocalNotificationService_o *__fastcall NotificationPluginScript__Setup(const MethodInfo *method)
{
  ...
  if ( (byte_4B3898C & 1) == 0 )
  {
    sub_1BD3458(&LocalNotificationServiceAndroid_TypeInfo, v1);
    sub_1BD3458(&NotificationPluginScript_TypeInfo, v2);
    byte_4B3898C = 1;
  }
  result = NotificationPluginScript_TypeInfo->static_fields->_service;
  if ( !result )
  {
    v4 = (LocalNotificationServiceAndroid_o *)sub_1BD36A4(LocalNotificationServiceAndroid_TypeInfo);
