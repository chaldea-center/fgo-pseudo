...
LocalNotificationService_o *NotificationPluginScript__Setup(const MethodInfo *method)
{
  ...
  if ( (byte_4D323E0 & 1) == 0 )
  {
    sub_1C93AD4(&LocalNotificationServiceAndroid_TypeInfo);
    sub_1C93AD4(&NotificationPluginScript_TypeInfo);
    byte_4D323E0 = 1;
  }
  result = NotificationPluginScript_TypeInfo->static_fields->_service;
  if ( !result )
  {
    v2 = (LocalNotificationServiceAndroid_o *)sub_1C93D20(LocalNotificationServiceAndroid_TypeInfo);
