...
LocalNotificationService_o *__fastcall NotificationPluginScript__Setup(const MethodInfo *method)
{
  ...
  if ( (byte_4BB5F14 & 1) == 0 )
  {
    sub_1C13D24(&LocalNotificationServiceAndroid_TypeInfo, v1);
    sub_1C13D24(&NotificationPluginScript_TypeInfo, v2);
    byte_4BB5F14 = 1;
  }
  result = NotificationPluginScript_TypeInfo->static_fields->_service;
  if ( !result )
  {
    v4 = (LocalNotificationServiceAndroid_o *)sub_1C13F70(LocalNotificationServiceAndroid_TypeInfo);
