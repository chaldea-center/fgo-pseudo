        ...
        const MethodInfo *method)
{
  ...
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.sortLogic, (int32_t)SortLogic, v17, v18, v19, v20, v21, v22);
  ...
  if ( !v6
    || (*((_QWORD *)v6 + 3) = this,
        sub_1D0F058((GrandQuestFolderBoardItem_o *)(v6 + 24), (int32_t)this, v38, v39, v40, v41, v42, v43),
...
LABEL_5:
  ...
  *((_QWORD *)v6 + 3) = this;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)(v6 + 24), (int32_t)this, v44, v45, v46, v47, v48, v49);
}
        ...
        const MethodInfo *method)
{
  ...
  v4 = (TreasureDvcInfo_o *)sub_1D0F300(TreasureDvcInfo_TypeInfo);
  TreasureDvcInfo___ctor(v4, 0);
  *tdInfo = v4;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)tdInfo, (int32_t)v4, v5, v6, v7, v8, v9, v10);
  return 0;
}
  ...
  if ( (v13 & 1) != 0 )
  {
    ...
    if ( !sortLogic
      || (sortLogic->fields.sort = sort,
          sub_1D0F058((GrandQuestFolderBoardItem_o *)&sortLogic->fields, (int32_t)sort, v7, v8, v9, v10, v11, v12),
          (v15 = this->fields.sortLogic) == 0) )
    {
      sub_1D0F30C(sortLogic, v6);
    }
