        ...
        const MethodInfo *method)
{
  ...
  sub_1BCA784((PartyOrganizationUtility_o *)&this->fields.sortLogic, (int64_t)SortLogic, v17, v18, v19, v20, v21, v22);
  ...
  if ( !v6
    || (*((_QWORD *)v6 + 3) = this,
        sub_1BCA784((PartyOrganizationUtility_o *)(v6 + 24), (int64_t)this, v38, v39, v40, v41, v42, v43),
...
LABEL_5:
  ...
  *((_QWORD *)v6 + 3) = this;
  sub_1BCA784((PartyOrganizationUtility_o *)(v6 + 24), (int64_t)this, v44, v45, v46, v47, v48, v49);
}
        ...
        const MethodInfo *method)
{
  ...
  v5 = (TreasureDvcInfo_o *)sub_1BCAA2C(TreasureDvcInfo_TypeInfo, tdInfo, method, v3);
  TreasureDvcInfo___ctor(v5, 0LL);
  *tdInfo = v5;
  sub_1BCA784((PartyOrganizationUtility_o *)tdInfo, (int64_t)v5, v6, v7, v8, v9, v10, v11);
  return 0;
}
  ...
  if ( (v13 & 1) != 0 )
  {
    ...
    if ( !sortLogic
      || (sortLogic->fields.sort = sort,
          sub_1BCA784((PartyOrganizationUtility_o *)&sortLogic->fields, (int64_t)sort, v7, v8, v9, v10, v11, v12),
          (sortLogic = this->fields.sortLogic) == 0LL) )
    {
      sub_1BCAA3C(sortLogic, v6);
    }
