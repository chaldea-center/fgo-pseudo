        ...
        const MethodInfo *method)
{
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.filterLogic, (int32_t)FilterLogic, v9, v10);
  SortLogic = CharaGraphListViewPatternBase__CreateSortLogic(listViewPattern, v11);
  this->fields.sortLogic = SortLogic;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.sortLogic, (int32_t)SortLogic, v13, v14);
  ...
  if ( !v6
    || (*((_QWORD *)v6 + 3) = this,
        sub_1B64814((ServantStatusBattleListViewItem_o *)(v6 + 24), (int32_t)this, v22, v23),
...
LABEL_5:
  ...
  *((_QWORD *)v6 + 3) = this;
  sub_1B64814((ServantStatusBattleListViewItem_o *)(v6 + 24), (int32_t)this, v24, v25);
}
...
LABEL_4:
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields._IconInfo2_k__BackingField, (int32_t)v11, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  *tdInfo = v4;
  sub_1B64814((ServantStatusBattleListViewItem_o *)tdInfo, (int32_t)v4, v5, v6);
  return 0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !filterLogic
    || (filterLogic->fields.sort = sort,
        sub_1B64814((ServantStatusBattleListViewItem_o *)&filterLogic->fields, (int32_t)sort, (int32_t)method, v3),
        (filterLogic = this->fields.filterLogic) == 0LL) )
  {
    sub_1B64ACC(filterLogic, sort);
  }
  ...
  if ( (v9 & 1) != 0 )
  {
    ...
    if ( !sortLogic
      || (sortLogic->fields.sort = sort,
          sub_1B64814((ServantStatusBattleListViewItem_o *)&sortLogic->fields, (int32_t)sort, v7, v8),
          (v11 = this->fields.sortLogic) == 0LL) )
    {
      sub_1B64ACC(sortLogic, v6);
    }
