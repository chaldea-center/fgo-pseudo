...
void __fastcall FGO_color0anim__Start(FGO_color0anim_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6ED3E & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_16560/*"_customColor0"*/, v3);
    byte_4A6ED3E = 1;
  }
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields._renderer, (int32_t)Component_object, v6, v7);
  ...
  if ( !renderer
    ...
    || (UnityEngine_Material__EnableKeyword(
          ...
          (System_String_o *)StringLiteral_16560/*"_customColor0"*/,
          0LL),
        (renderer = *p_renderer) == 0LL)
    || (renderer = (UnityEngine_Renderer_o *)UnityEngine_Renderer__get_material(renderer, 0LL)) == 0LL )
  {
    sub_1B9026C(renderer, v8);
  }
...
void __fastcall FGO_color0anim__Update(FGO_color0anim_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6ED3F & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_16560/*"_customColor0"*/, method);
    byte_4A6ED3F = 1;
  }
  renderer = this->fields._renderer;
