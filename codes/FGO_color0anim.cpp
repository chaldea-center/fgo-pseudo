...
void __fastcall FGO_color0anim__Start(FGO_color0anim_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B15094 & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&StringLiteral_16704/*"_customColor0"*/, v4, v5);
    byte_4B15094 = 1;
  }
  ...
  if ( !renderer
    ...
    || (UnityEngine_Material__EnableKeyword(
          ...
          (System_String_o *)StringLiteral_16704/*"_customColor0"*/,
          0LL),
...
void __fastcall FGO_color0anim__Update(FGO_color0anim_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B15095 & 1) == 0 )
  {
    sub_1BCA7E0(&StringLiteral_16704/*"_customColor0"*/, method, v2);
    byte_4B15095 = 1;
  }
  renderer = this->fields._renderer;
