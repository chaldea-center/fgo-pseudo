void BattleSkillSelectAddFuncBtnComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C466E8 & 1) == 0 )
  {
    sub_1C37058(&BattleSkillSelectAddFuncBtnComponent_TypeInfo);
    byte_4C466E8 = 1;
  }
  ...
  *(_OWORD *)&static_fields->THREE_ALTERNATIVES_GRID_WIDTH = xmmword_C0E380;
        ...
        const MethodInfo *method)
{
  ...
  v5 = StringLiteral_17435/*"btn_bg_01"*/;
  this->fields.spriteName = (struct System_String_o *)StringLiteral_17435/*"btn_bg_01"*/;
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.spriteName, v5, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C37058(&BattleSkillSelectAddFuncBtnComponent_TypeInfo);
    sub_1C37058(&Method_UnityEngine_Component_GetComponent_BattleValueButtonComponent___);
    ...
    sub_1C37058(&Method_UnityEngine_GameObject_GetComponentInChildren_CondensedScaleLabel___);
    ...
    sub_1C37058(&Method_System_Collections_Generic_List_UISprite__RemoveAt__);
        ...
        if ( btnTop )
        {
          ...
          if ( btnTop )
          {
            System_Collections_Generic_List_object___RemoveAt(
              (System_Collections_Generic_List_object__o *)btnTop,
              btnTop[6] - 1,
              (const MethodInfo_37A47F8 *)Method_System_Collections_Generic_List_UISprite__RemoveAt__);
                ...
                if ( btnTop )
                {
                            ...
                            (const MethodInfo_352D810 *)Method_System_Collections_Generic_List_Enumerator_UISprite__MoveNext__) )
                  {
                    ...
                    ComponentInChildren_object = (CondensedScaleLabel_o *)UnityEngine_GameObject__GetComponentInChildren_object_(
                                                                            v29,
                                                                            (const MethodInfo_313F43C *)Method_UnityEngine_GameObject_GetComponentInChildren_CondensedScaleLabel___);
                    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
                      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
...
LABEL_65:
  ...
  else
  {
    ...
    *(_QWORD *)(v14 + 32) = Component_object;
    sub_1C36FFC((CGThumbnailListItem_o *)(v14 + 32), (int32_t)Component_object, v9, v10);
  }
  if ( !Component_object )
    goto LABEL_65;
  ...
  btnTop = (int *)UnityEngine_Component__GetComponent_object_(
                    ...
                    (const MethodInfo_30DE428 *)Method_UnityEngine_Component_GetComponent_BattleValueButtonComponent___);
  if ( !btnTop )
    goto LABEL_65;
  btnTop[12] = 2;
  btnTop = (int *)UnityEngine_Component__GetComponent_object_(
  ...
  *((_QWORD *)btnTop + 4) = btnTarget;
  sub_1C36FFC((CGThumbnailListItem_o *)(btnTop + 8), (int32_t)btnTarget, v16, v17);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C466E6 & 1) == 0 )
  {
    ...
    this = (BattleSkillSelectAddFuncBtnComponent_o *)sub_1C37058(&StringLiteral_1/*""*/);
    byte_4C466E6 = 1;
  }
  if ( !selBtnInfo )
    goto LABEL_14;
        ...
        const MethodInfo *method)
{
  ...
  if ( isThreeAlternatives )
  {
    ...
    sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.spriteName, (int32_t)addBtnSpriteName, v17, v18);
  }
