void __fastcall BattleSkillSelectAddFuncBtnComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48E574A & 1) == 0 )
  {
    sub_1B00CCC(&BattleSkillSelectAddFuncBtnComponent_TypeInfo, v1);
    byte_48E574A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E5748 & 1) == 0 )
  {
    sub_1B00CCC(&BattleSkillSelectAddFuncBtnComponent_TypeInfo, *(_QWORD *)&btnNum);
    sub_1B00CCC(&Method_UnityEngine_Component_GetComponent_BattleValueButtonComponent___, v5);
    sub_1B00CCC(&Method_UnityEngine_GameObject_GetComponent_UISprite___, v6);
    sub_1B00CCC(&Method_System_Collections_Generic_List_UISprite__Add__, v7);
    sub_1B00CCC(&Method_System_Collections_Generic_List_UISprite__RemoveAt__, v8);
    sub_1B00CCC(&Method_System_Collections_Generic_List_UISprite__get_Count__, v9);
    sub_1B00CCC(&Method_System_Collections_Generic_List_UISprite__get_Item__, v10);
  ...
  if ( v14 >= btnNum )
  {
    ...
    System_Collections_Generic_List_object___RemoveAt(
      (System_Collections_Generic_List_object__o *)btnTop,
      btnTop[6] - 1,
      (const MethodInfo_33C31A4 *)Method_System_Collections_Generic_List_UISprite__RemoveAt__);
...
LABEL_38:
    sub_1B00F28(btnTop, *(_QWORD *)&btnNum);
  }
  ...
  if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)Component_object, 0LL, 0LL) )
  {
    ...
    else
    {
      ...
      *(_QWORD *)(v34 + 32) = Component_object;
      sub_1B00C70((ServantStatusBattleListViewItem_o *)(v34 + 32), (int32_t)Component_object, v18, v19);
    }
    if ( !Component_object )
      goto LABEL_38;
    ...
    btnTop = (int *)UnityEngine_Component__GetComponent_object_(
                      ...
                      (const MethodInfo_2D596B4 *)Method_UnityEngine_Component_GetComponent_BattleValueButtonComponent___);
    if ( !btnTop )
      goto LABEL_38;
    btnTop[12] = 2;
    btnTop = (int *)UnityEngine_Component__GetComponent_object_(
    ...
    *((_QWORD *)btnTop + 4) = btnTarget;
    sub_1B00C70((ServantStatusBattleListViewItem_o *)(btnTop + 8), (int32_t)btnTarget, v36, v37);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E5749 & 1) == 0 )
  {
    sub_1B00CCC(&Method_System_Collections_Generic_List_Enumerator_UISprite__Dispose__, *(_QWORD *)&rootPosX);
    sub_1B00CCC(&Method_System_Collections_Generic_List_Enumerator_UISprite__MoveNext__, v13);
    sub_1B00CCC(&Method_System_Collections_Generic_List_Enumerator_UISprite__get_Current__, v14);
    sub_1B00CCC(&Method_System_Collections_Generic_List_UISprite__GetEnumerator__, v15);
    sub_1B00CCC(&StringLiteral_17229/*"btn_bg_01"*/, v16);
    byte_48E5749 = 1;
  }
  ...
  if ( !isThreeAlternatives )
    p_addBtnSpriteName = (struct System_String_o **)&StringLiteral_17229/*"btn_bg_01"*/;
  if ( !btnRoot )
    goto LABEL_18;
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    (const MethodInfo_33C24C8 *)Method_System_Collections_Generic_List_UISprite__GetEnumerator__);
  v27 = v26;
  while ( 1 )
  {
    v23 = System_Collections_Generic_List_Enumerator_object___MoveNext(
            &v27,
            (const MethodInfo_313E218 *)Method_System_Collections_Generic_List_Enumerator_UISprite__MoveNext__);
    if ( !v23 )
      break;
  ...
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v27,
    (const MethodInfo_313E214 *)Method_System_Collections_Generic_List_Enumerator_UISprite__Dispose__);
  btnRoot = (UnityEngine_Component_o *)this->fields.btnCancel;
  if ( !btnRoot
  ...
  {
LABEL_18:
    sub_1B00F28(btnRoot, *(_QWORD *)&rootPosX);
  }
