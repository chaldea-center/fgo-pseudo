void __fastcall BattleSkillSelectAddFuncBtnComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B69DA8 & 1) == 0 )
  {
    sub_1BE4ACC(&BattleSkillSelectAddFuncBtnComponent_TypeInfo, v1);
    byte_4B69DA8 = 1;
  }
  ...
  *(_OWORD *)&static_fields->THREE_ALTERNATIVES_GRID_WIDTH = xmmword_BE17C0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69DA6 & 1) == 0 )
  {
    sub_1BE4ACC(&BattleSkillSelectAddFuncBtnComponent_TypeInfo, *(_QWORD *)&btnNum);
    sub_1BE4ACC(&Method_UnityEngine_Component_GetComponent_BattleValueButtonComponent___, v5);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Enumerator_UISprite__Dispose__, v6);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Enumerator_UISprite__MoveNext__, v7);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Enumerator_UISprite__get_Current__, v8);
    sub_1BE4ACC(&Method_UnityEngine_GameObject_GetComponentInChildren_CondensedScaleLabel___, v9);
    sub_1BE4ACC(&Method_UnityEngine_GameObject_GetComponent_UISprite___, v10);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_UISprite__Add__, v11);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_UISprite__GetEnumerator__, v12);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_UISprite__RemoveAt__, v13);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_UISprite__get_Count__, v14);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_UISprite__get_Item__, v15);
        ...
        if ( btnTop )
        {
          ...
          if ( btnTop )
          {
            System_Collections_Generic_List_object___RemoveAt(
              (System_Collections_Generic_List_object__o *)btnTop,
              btnTop[6] - 1,
              (const MethodInfo_35ED9F8 *)Method_System_Collections_Generic_List_UISprite__RemoveAt__);
                ...
                if ( btnTop )
                {
                            ...
                            (const MethodInfo_3361CE0 *)Method_System_Collections_Generic_List_Enumerator_UISprite__MoveNext__) )
                  {
                    ...
                    ComponentInChildren_object = (CondensedScaleLabel_o *)UnityEngine_GameObject__GetComponentInChildren_object_(
                                                                            v54,
                                                                            (const MethodInfo_2FA9A00 *)Method_UnityEngine_GameObject_GetComponentInChildren_CondensedScaleLabel___);
                    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
                      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
...
LABEL_65:
    sub_1BE4D28(btnTop, *(_QWORD *)&btnNum);
  }
  ...
  else
  {
    ...
    *(_QWORD *)(v31 + 32) = Component_object;
    sub_1BE4A70((PartyOrganizationUtility_o *)(v31 + 32), (int64_t)Component_object, v22, v23, v24, v25, v26, v27);
  }
  if ( !Component_object )
    goto LABEL_65;
  ...
  btnTop = (int *)UnityEngine_Component__GetComponent_object_(
                    ...
                    (const MethodInfo_2F4FBB4 *)Method_UnityEngine_Component_GetComponent_BattleValueButtonComponent___);
  if ( !btnTop )
    goto LABEL_65;
  btnTop[12] = 2;
  btnTop = (int *)UnityEngine_Component__GetComponent_object_(
  ...
  *((_QWORD *)btnTop + 4) = btnTarget;
  sub_1BE4A70((PartyOrganizationUtility_o *)(btnTop + 8), (int64_t)btnTarget, v33, v34, v35, v36, v37, v38);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69DA7 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Enumerator_UISprite__Dispose__, *(_QWORD *)&rootPosX);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Enumerator_UISprite__MoveNext__, v13);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Enumerator_UISprite__get_Current__, v14);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_UISprite__GetEnumerator__, v15);
    sub_1BE4ACC(&StringLiteral_17687/*"btn_bg_01"*/, v16);
    byte_4B69DA7 = 1;
  }
  ...
  if ( !isThreeAlternatives )
    p_addBtnSpriteName = (struct System_String_o **)&StringLiteral_17687/*"btn_bg_01"*/;
  if ( !btnRoot )
    goto LABEL_18;
  ...
  {
LABEL_18:
    sub_1BE4D28(btnRoot, *(_QWORD *)&rootPosX);
  }
