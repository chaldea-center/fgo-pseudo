        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF025A & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_17821/*"cancelTradeFlag"*/);
    sub_1C7BAE8(&StringLiteral_23202/*"receiveNum"*/);
    sub_1C7BAE8(&StringLiteral_24408/*"tradeStoreIdxs"*/);
    byte_4CF025A = 1;
  }
  ...
  RequestBase__addField_44746712(
    (RequestBase_o *)this,
    (System_String_o *)StringLiteral_24408/*"tradeStoreIdxs"*/,
    &tradeStoreIdxs->obj,
    v11);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23202/*"receiveNum"*/, receiveNum, v12);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_17821/*"cancelTradeFlag"*/, cancelTradeFlag, v13);
...
System_String_o *TradeReceiveRequest__getURL(TradeReceiveRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CF0259 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_19280/*"event/tradeReceive"*/);
    byte_4CF0259 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64176912(BaseUrl, (System_String_o *)StringLiteral_19280/*"event/tradeReceive"*/, 0);
}
