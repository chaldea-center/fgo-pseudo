        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D325EA & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_17869/*"cancelTradeFlag"*/);
    sub_1C93AD4(&StringLiteral_23267/*"receiveNum"*/);
    sub_1C93AD4(&StringLiteral_24476/*"tradeStoreIdxs"*/);
    byte_4D325EA = 1;
  }
  ...
  RequestBase__addField_44913028(
    (RequestBase_o *)this,
    (System_String_o *)StringLiteral_24476/*"tradeStoreIdxs"*/,
    &tradeStoreIdxs->obj,
    v11);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23267/*"receiveNum"*/, receiveNum, v12);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_17869/*"cancelTradeFlag"*/, cancelTradeFlag, v13);
...
System_String_o *TradeReceiveRequest__getURL(TradeReceiveRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D325E9 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_19332/*"event/tradeReceive"*/);
    byte_4D325E9 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64425724(BaseUrl, (System_String_o *)StringLiteral_19332/*"event/tradeReceive"*/, 0);
}
