bool __fastcall TopHomeRequest__IsExpirationDateUpdateEventMap(const MethodInfo *method)
{
  ...
  if ( (byte_4B465F5 & 1) == 0 )
  {
    ...
    sub_1BDB878(&TopHomeRequest_TypeInfo, v2);
    byte_4B465F5 = 1;
  }
...
void __fastcall TopHomeRequest__UpdateAccessTime(const MethodInfo *method)
{
  ...
  if ( (byte_4B465F7 & 1) == 0 )
  {
    ...
    sub_1BDB878(&TopHomeRequest_TypeInfo, v3);
    byte_4B465F7 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
...
void __fastcall TopHomeRequest__clearExpirationDate(const MethodInfo *method)
{
  ...
  if ( (byte_4B465EF & 1) == 0 )
  {
    sub_1BDB878(&TopHomeRequest_TypeInfo, v1);
    byte_4B465EF = 1;
  }
...
System_String_o *__fastcall TopHomeRequest__getMockData(TopHomeRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&NetworkManager_TypeInfo, method);
    sub_1BDB878(&StringLiteral_9139/*"MockTopLoginRequest"*/, v2);
    byte_4B465F1 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  return NetworkManager__getMockFile((System_String_o *)StringLiteral_9139/*"MockTopLoginRequest"*/, 0LL);
}
...
System_String_o *__fastcall TopHomeRequest__getURL(TopHomeRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&NetworkManager_TypeInfo, method);
    sub_1BDB878(&StringLiteral_20008/*"home/top"*/, v2);
    byte_4B465F0 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62572260(BaseUrl, (System_String_o *)StringLiteral_20008/*"home/top"*/, 0LL);
}
...
bool __fastcall TopHomeRequest__isBackgroundRequest(TopHomeRequest_o *this, const MethodInfo *method)
{
  if ( (byte_4B465F3 & 1) == 0 )
  {
    sub_1BDB878(&TopHomeRequest_TypeInfo, method);
    byte_4B465F3 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B465F8 & 1) == 0 )
  {
    ...
    sub_1BDB878(&TopHomeRequest_TypeInfo, v6);
...
void __fastcall TopHomeRequest__setBackgroundRequest(TopHomeRequest_o *this, bool isEnabled, const MethodInfo *method)
{
  if ( (byte_4B465F4 & 1) == 0 )
  {
    sub_1BDB878(&TopHomeRequest_TypeInfo, isEnabled);
    byte_4B465F4 = 1;
  }
