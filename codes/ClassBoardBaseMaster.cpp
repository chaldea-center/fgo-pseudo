void ClassBoardBaseMaster___ctor(ClassBoardBaseMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4D2C5B8 & 1) == 0 )
  {
    sub_1C94098(&Method_DataMasterBase_ClassBoardBaseMaster__ClassBoardBaseEntity__int___ctor__);
    byte_4D2C5B8 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    432,
    (const MethodInfo_345919C *)Method_DataMasterBase_ClassBoardBaseMaster__ClassBoardBaseEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2C5B6 & 1) == 0 )
  {
    sub_1C94098(&Method_System_Linq_Enumerable_FirstOrDefault_ClassBoardBaseEntity___);
    sub_1C94098(&System_Func_ClassBoardBaseEntity__bool__TypeInfo);
    sub_1C94098(&Method_ClassBoardBaseMaster___c__DisplayClass0_0__GetGrandClassBoardBaseEntity_b__0__);
    sub_1C94098(&ClassBoardBaseMaster___c__DisplayClass0_0_TypeInfo);
    byte_4D2C5B6 = 1;
  }
  v5 = sub_1C942E4(ClassBoardBaseMaster___c__DisplayClass0_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v5, 0);
  if ( !v5 )
    sub_1C942F0(v6, v7);
  *(_DWORD *)(v5 + 16) = parentClassBoardBaseId;
  list = this->fields.list;
  v9 = (System_Func_object__bool__o *)sub_1C942E4(System_Func_ClassBoardBaseEntity__bool__TypeInfo);
  System_Func_object__bool____ctor(
    v9,
    (Il2CppObject *)v5,
    Method_ClassBoardBaseMaster___c__DisplayClass0_0__GetGrandClassBoardBaseEntity_b__0__,
    0);
  return (ClassBoardBaseEntity_o *)System_Linq_Enumerable__FirstOrDefault_object__52191056(
                                     (System_Collections_Generic_IEnumerable_TSource__o *)list,
                                     (System_Func_TSource__bool__o *)v9,
                                     (const MethodInfo_31C5F50 *)Method_System_Linq_Enumerable_FirstOrDefault_ClassBoardBaseEntity___);
}
