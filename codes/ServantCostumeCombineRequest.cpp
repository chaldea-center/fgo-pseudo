        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5CAAE & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_18277/*"costumeId"*/);
    byte_4A5CAAE = 1;
  }
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19132/*"eventId"*/, eventId, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5CAAD & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_17746/*"card/combineCostume"*/);
    byte_4A5CAAD = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61707032(BaseUrl, (System_String_o *)StringLiteral_17746/*"card/combineCostume"*/, 0LL);
}
