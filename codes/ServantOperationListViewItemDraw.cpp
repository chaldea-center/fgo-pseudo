        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEA5ED & 1) == 0 )
  {
    ...
    this = (ServantOperationListViewItemDraw_o *)sub_1C7BAE8(&StringLiteral_7016/*"GRAND_MEMBER"*/);
    byte_4CEA5ED = 1;
  }
  if ( !item )
    goto LABEL_64;
  if ( item->fields._IsGrandServant_k__BackingField )
  {
    ...
    v6 = (System_String_o *)StringLiteral_7016/*"GRAND_MEMBER"*/;
  ...
  if ( item->fields._IsPush_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v7 = &StringLiteral_11602/*"SELECT_PUSH"*/;
LABEL_53:
...
LABEL_18:
  ...
  if ( item->fields._IsChoice_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v7 = &StringLiteral_11572/*"SELECT_CHOICE"*/;
    goto LABEL_53;
  }
  if ( item->fields._IsNotSelection_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v7 = &StringLiteral_9308/*"NONSELECT_MATERIAL"*/;
    goto LABEL_53;
  }
  if ( item->fields._IsLock_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v7 = &StringLiteral_11589/*"SELECT_LOCK"*/;
    goto LABEL_53;
  }
  if ( item->fields._IsFavorite_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v7 = &StringLiteral_11578/*"SELECT_FAVORITE"*/;
    goto LABEL_53;
  }
  if ( item->fields._IsParty_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v7 = &StringLiteral_11599/*"SELECT_PARTY"*/;
    goto LABEL_53;
  }
  if ( item->fields._IsUseRecommendSupportServant_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v7 = &StringLiteral_11082/*"RECOMMEND_SUPPORT_MEMBER"*/;
    goto LABEL_53;
  }
  if ( item->fields._IsUseSupportServant_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v7 = &StringLiteral_12570/*"SUPPORT_MEMBER"*/;
    goto LABEL_53;
  }
  if ( item->fields._IsCommandCodeEquiped_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v7 = &StringLiteral_9343/*"NOT_SELECT_EQUIPED"*/;
    goto LABEL_53;
  }
    ...
    if ( this )
    {
      ...
      if ( this )
      {
        if ( !UserServantEntity__IsNotSaleServant((UserServantEntity_o *)this, 0) )
        {
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          v7 = &StringLiteral_11601/*"SELECT_PROTECTED_EVENT_SVT"*/;
          goto LABEL_53;
        }
        goto LABEL_18;
      }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEA5EF & 1) == 0 )
  {
    ...
    this = (ServantOperationListViewItemDraw_o *)sub_1C7BAE8(&StringLiteral_23336/*"ribbon_noblephantasmup_01"*/);
    byte_4CEA5EF = 1;
  }
  if ( !item )
    goto LABEL_20;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEA5EC & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_11571/*"SELECT_CANNOT"*/);
    sub_1C7BAE8(&StringLiteral_11603/*"SELECT_SERVANT_EVENT_JOIN"*/);
    this = (ServantOperationListViewItemDraw_o *)sub_1C7BAE8(&StringLiteral_1/*""*/);
    byte_4CEA5EC = 1;
  }
  if ( (unsigned int)(modeKind - 1) < 2 )
  {
    ...
    this = (ServantOperationListViewItemDraw_o *)TutorialFlag__Get_40989036(126, 0);
        ...
        if ( this )
        {
          ...
          if ( this )
          {
            ...
            this = (ServantOperationListViewItemDraw_o *)LocalizationManager__Get(
                                                           (System_String_o *)StringLiteral_6486/*"FORTIFICATION_APPOINTMENT"*/,
                                                           0);
