        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C233CD & 1) == 0 )
  {
    ...
    this = (ServantOperationListViewItemDraw_o *)sub_1C2D490(&StringLiteral_6996/*"GRAND_MEMBER"*/);
    byte_4C233CD = 1;
  }
  if ( !item )
    goto LABEL_63;
  if ( item->fields._IsGrandServant_k__BackingField )
  {
    ...
    v6 = (System_String_o *)StringLiteral_6996/*"GRAND_MEMBER"*/;
  ...
  if ( item->fields._IsPush_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v7 = &StringLiteral_11545/*"SELECT_PUSH"*/;
    goto LABEL_53;
  }
  ...
  if ( item->fields._IsChoice_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v7 = &StringLiteral_11515/*"SELECT_CHOICE"*/;
    goto LABEL_53;
  }
  if ( item->fields._IsNotSelection_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v7 = &StringLiteral_9275/*"NONSELECT_MATERIAL"*/;
    goto LABEL_53;
  }
  if ( item->fields._IsLock_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v7 = &StringLiteral_11532/*"SELECT_LOCK"*/;
    goto LABEL_53;
  }
  if ( item->fields._IsFavorite_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v7 = &StringLiteral_11521/*"SELECT_FAVORITE"*/;
    goto LABEL_53;
  }
  if ( item->fields._IsParty_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v7 = &StringLiteral_11542/*"SELECT_PARTY"*/;
    goto LABEL_53;
  }
  if ( item->fields._IsUseRecommendSupportServant_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v7 = &StringLiteral_11032/*"RECOMMEND_SUPPORT_MEMBER"*/;
    goto LABEL_53;
  }
  if ( item->fields._IsUseSupportServant_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v7 = &StringLiteral_12508/*"SUPPORT_MEMBER"*/;
    goto LABEL_53;
  }
  if ( item->fields._IsCommandCodeEquiped_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v7 = &StringLiteral_9310/*"NOT_SELECT_EQUIPED"*/;
    goto LABEL_53;
  }
  ...
  if ( v10 && UserServantEntity__IsProtectedEventServant(v10, 0) )
  {
    ...
    if ( this )
    {
      ...
      {
        v7 = &StringLiteral_11544/*"SELECT_PROTECTED_EVENT_SVT"*/;
        goto LABEL_53;
      }
LABEL_20:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C233CF & 1) == 0 )
  {
    ...
    this = (ServantOperationListViewItemDraw_o *)sub_1C2D490(&StringLiteral_23090/*"ribbon_noblephantasmup_01"*/);
    byte_4C233CF = 1;
  }
  if ( !item )
    goto LABEL_20;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C233CC & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_11514/*"SELECT_CANNOT"*/);
    sub_1C2D490(&StringLiteral_11546/*"SELECT_SERVANT_EVENT_JOIN"*/);
    this = (ServantOperationListViewItemDraw_o *)sub_1C2D490(&StringLiteral_1/*""*/);
    byte_4C233CC = 1;
  }
  if ( (unsigned int)(modeKind - 1) < 2 )
  {
    ...
    this = (ServantOperationListViewItemDraw_o *)TutorialFlag__Get_40206092(126, 0);
        ...
        if ( this )
        {
          ...
          if ( this )
          {
            ...
            this = (ServantOperationListViewItemDraw_o *)LocalizationManager__Get(
                                                           (System_String_o *)StringLiteral_6472/*"FORTIFICATION_APPOINTMENT"*/,
                                                           0);
