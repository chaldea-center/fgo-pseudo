        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C33A9D & 1) == 0 )
  {
    ...
    this = (ServantOperationListViewItemDraw_o *)sub_1C32C20(&StringLiteral_7001/*"GRAND_MEMBER"*/);
    byte_4C33A9D = 1;
  }
  if ( !item )
    goto LABEL_63;
  if ( item->fields._IsGrandServant_k__BackingField )
  {
    ...
    v6 = (System_String_o *)StringLiteral_7001/*"GRAND_MEMBER"*/;
  ...
  if ( item->fields._IsNotSelection_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v7 = &StringLiteral_9281/*"NONSELECT_MATERIAL"*/;
    goto LABEL_53;
  }
  ...
  if ( item->fields._IsUseRecommendSupportServant_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v7 = &StringLiteral_11038/*"RECOMMEND_SUPPORT_MEMBER"*/;
    goto LABEL_53;
  }
  if ( item->fields._IsUseSupportServant_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v7 = &StringLiteral_12511/*"SUPPORT_MEMBER"*/;
    goto LABEL_53;
  }
  if ( item->fields._IsCommandCodeEquiped_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v7 = &StringLiteral_9316/*"NOT_SELECT_EQUIPED"*/;
    goto LABEL_53;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C33A9F & 1) == 0 )
  {
    ...
    this = (ServantOperationListViewItemDraw_o *)sub_1C32C20(&StringLiteral_23108/*"ribbon_noblephantasmup_01"*/);
    byte_4C33A9F = 1;
  }
  if ( !item )
    goto LABEL_20;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C33A9C & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_11520/*"SELECT_CANNOT"*/);
    sub_1C32C20(&StringLiteral_11552/*"SELECT_SERVANT_EVENT_JOIN"*/);
    this = (ServantOperationListViewItemDraw_o *)sub_1C32C20(&StringLiteral_1/*""*/);
    byte_4C33A9C = 1;
  }
  if ( (unsigned int)(modeKind - 1) < 2 )
  {
    ...
    this = (ServantOperationListViewItemDraw_o *)TutorialFlag__Get_40328320(126, 0);
        ...
        if ( this )
        {
          ...
          if ( this )
          {
            ...
            this = (ServantOperationListViewItemDraw_o *)LocalizationManager__Get(
                                                           (System_String_o *)StringLiteral_6477/*"FORTIFICATION_APPOINTMENT"*/,
                                                           0);
