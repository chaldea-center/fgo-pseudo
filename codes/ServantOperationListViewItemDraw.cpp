        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596C6A8 & 1) == 0 )
  {
    ...
    this = (ServantOperationListViewItemDraw_o *)sub_2213A60(&StringLiteral_7297/*"GRAND_MEMBER"*/);
    byte_596C6A8 = 1;
  }
  if ( !item )
    goto LABEL_64;
  if ( item->fields._IsGrandServant_k__BackingField )
  {
    ...
    v6 = (System_String_o *)StringLiteral_7297/*"GRAND_MEMBER"*/;
  ...
  if ( item->fields._IsPush_k__BackingField )
  {
    if ( !*(&LocalizationManager_TypeInfo->_2.cctor_finished + 1) )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, item, isServant);
    v7 = &StringLiteral_12060/*"SELECT_PUSH"*/;
LABEL_53:
  ...
  if ( UserServantEntity_k__BackingField && UserServantEntity__IsEventJoin(UserServantEntity_k__BackingField, 0) )
  {
    if ( !*(&LocalizationManager_TypeInfo->_2.cctor_finished + 1) )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, item, isServant);
    v7 = &StringLiteral_12061/*"SELECT_SERVANT_EVENT_JOIN"*/;
    goto LABEL_53;
  }
...
LABEL_18:
    if ( !*(&LocalizationManager_TypeInfo->_2.cctor_finished + 1) )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, item, isServant);
    v7 = &StringLiteral_12029/*"SELECT_CANNOT"*/;
    goto LABEL_53;
  }
  if ( item->fields._IsChoice_k__BackingField )
  {
    if ( !*(&LocalizationManager_TypeInfo->_2.cctor_finished + 1) )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, item, isServant);
    v7 = &StringLiteral_12030/*"SELECT_CHOICE"*/;
    goto LABEL_53;
  }
  if ( item->fields._IsNotSelection_k__BackingField )
  {
    if ( !*(&LocalizationManager_TypeInfo->_2.cctor_finished + 1) )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, item, isServant);
    v7 = &StringLiteral_9667/*"NONSELECT_MATERIAL"*/;
    goto LABEL_53;
  }
  if ( item->fields._IsLock_k__BackingField )
  {
    if ( !*(&LocalizationManager_TypeInfo->_2.cctor_finished + 1) )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, item, isServant);
    v7 = &StringLiteral_12047/*"SELECT_LOCK"*/;
    goto LABEL_53;
  }
  if ( item->fields._IsFavorite_k__BackingField )
  {
    if ( !*(&LocalizationManager_TypeInfo->_2.cctor_finished + 1) )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, item, isServant);
    v7 = &StringLiteral_12036/*"SELECT_FAVORITE"*/;
    goto LABEL_53;
  }
  if ( item->fields._IsParty_k__BackingField )
  {
    if ( !*(&LocalizationManager_TypeInfo->_2.cctor_finished + 1) )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, item, isServant);
    v7 = &StringLiteral_12057/*"SELECT_PARTY"*/;
    goto LABEL_53;
  }
  if ( item->fields._IsUseRecommendSupportServant_k__BackingField )
  {
    if ( !*(&LocalizationManager_TypeInfo->_2.cctor_finished + 1) )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, item, isServant);
    v7 = &StringLiteral_11517/*"RECOMMEND_SUPPORT_MEMBER"*/;
    goto LABEL_53;
  }
  if ( item->fields._IsUseSupportServant_k__BackingField )
  {
    if ( !*(&LocalizationManager_TypeInfo->_2.cctor_finished + 1) )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, item, isServant);
    v7 = &StringLiteral_13039/*"SUPPORT_MEMBER"*/;
    goto LABEL_53;
  }
  if ( item->fields._IsCommandCodeEquiped_k__BackingField )
  {
    if ( !*(&LocalizationManager_TypeInfo->_2.cctor_finished + 1) )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, item, isServant);
    v7 = &StringLiteral_9703/*"NOT_SELECT_EQUIPED"*/;
    goto LABEL_53;
  }
    ...
    if ( this )
    {
      ...
      if ( this )
      {
        if ( !UserServantEntity__IsNotSaleServant((UserServantEntity_o *)this, 0) )
        {
          if ( !*(&LocalizationManager_TypeInfo->_2.cctor_finished + 1) )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, item, isServant);
          v7 = &StringLiteral_12059/*"SELECT_PROTECTED_EVENT_SVT"*/;
          goto LABEL_53;
        }
        goto LABEL_18;
      }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596C6AA & 1) == 0 )
  {
    ...
    this = (ServantOperationListViewItemDraw_o *)sub_2213A60(&StringLiteral_24320/*"ribbon_noblephantasmup_01"*/);
    byte_596C6AA = 1;
  }
  if ( !item )
    goto LABEL_26;
  ...
  if ( v24 )
  {
    ...
    if ( item->fields._IsMaterialTdSvt_k__BackingField )
    {
      ...
      AtlasManager__SetEventSprite(v27, (System_String_o *)StringLiteral_24320/*"ribbon_noblephantasmup_01"*/, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596C6A7 & 1) == 0 )
  {
    ...
    sub_2213A60(&StringLiteral_12029/*"SELECT_CANNOT"*/);
    sub_2213A60(&StringLiteral_12061/*"SELECT_SERVANT_EVENT_JOIN"*/);
    this = (ServantOperationListViewItemDraw_o *)sub_2213A60(&StringLiteral_1/*""*/);
    byte_596C6A7 = 1;
  }
  if ( (unsigned int)(modeKind - 3) > 0xFFFFFFFD )
  {
    ...
    this = (ServantOperationListViewItemDraw_o *)TutorialFlag__Get_47388504(126, 0);
        ...
        if ( this )
        {
          ...
          if ( this )
          {
            ...
            this = (ServantOperationListViewItemDraw_o *)LocalizationManager__Get(
                                                           (System_String_o *)StringLiteral_6763/*"FORTIFICATION_APPOINTMENT"*/,
                                                           0);
