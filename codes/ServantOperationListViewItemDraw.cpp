        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18677 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_9211/*"NONSELECT_MATERIAL"*/, v6);
    sub_1BCAFF8(&StringLiteral_11434/*"SELECT_LOCK"*/, v7);
    sub_1BCAFF8(&StringLiteral_11425/*"SELECT_FAVORITE"*/, v8);
    sub_1BCAFF8(&StringLiteral_12405/*"SUPPORT_MEMBER"*/, v9);
    ...
    sub_1BCAFF8(&StringLiteral_10942/*"RECOMMEND_SUPPORT_MEMBER"*/, v16);
    sub_1BCAFF8(&StringLiteral_1/*""*/, v17);
    sub_1BCAFF8(&StringLiteral_11446/*"SELECT_PROTECTED_EVENT_SVT"*/, v18);
    this = (ServantOperationListViewItemDraw_o *)sub_1BCAFF8(&StringLiteral_6945/*"GRAND_MEMBER"*/, v19);
    byte_4B18677 = 1;
  }
  if ( !item )
    goto LABEL_61;
  if ( item->fields._IsGrandServant_k__BackingField )
  {
    ...
    v20 = (System_String_o *)StringLiteral_6945/*"GRAND_MEMBER"*/;
  ...
  if ( item->fields._IsPush_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v21 = &StringLiteral_11447/*"SELECT_PUSH"*/;
    goto LABEL_24;
  }
  if ( ServantOperationListViewItem__get_IsEventJoin(item, 0LL) )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v21 = &StringLiteral_11448/*"SELECT_SERVANT_EVENT_JOIN"*/;
    goto LABEL_24;
  }
  ...
  if ( item->fields._IsChoice_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v21 = &StringLiteral_11418/*"SELECT_CHOICE"*/;
    goto LABEL_24;
  }
  if ( item->fields._IsNotSelection_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v21 = &StringLiteral_9211/*"NONSELECT_MATERIAL"*/;
    goto LABEL_24;
  }
  if ( item->fields._IsLock_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v21 = &StringLiteral_11434/*"SELECT_LOCK"*/;
    goto LABEL_24;
  }
  if ( item->fields._IsFavorite_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v21 = &StringLiteral_11425/*"SELECT_FAVORITE"*/;
    goto LABEL_24;
  }
  if ( item->fields._IsParty_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v21 = &StringLiteral_11444/*"SELECT_PARTY"*/;
    goto LABEL_24;
  }
  if ( item->fields._IsUseRecommendSupportServant_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v21 = &StringLiteral_10942/*"RECOMMEND_SUPPORT_MEMBER"*/;
    goto LABEL_24;
  }
  ...
  if ( item->fields._IsCommandCodeEquiped_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v21 = &StringLiteral_9245/*"NOT_SELECT_EQUIPED"*/;
    goto LABEL_24;
  }
  if ( ServantOperationListViewItem__get_IsProtected(item, 0LL) )
  {
    ...
    if ( this )
    {
      ...
      {
        v21 = &StringLiteral_11446/*"SELECT_PROTECTED_EVENT_SVT"*/;
        goto LABEL_24;
      }
LABEL_23:
      v21 = &StringLiteral_11417/*"SELECT_CANNOT"*/;
LABEL_24:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18679 & 1) == 0 )
  {
    ...
    this = (ServantOperationListViewItemDraw_o *)sub_1BCAFF8(&StringLiteral_22902/*"ribbon_noblephantasmup_01"*/, v8);
    byte_4B18679 = 1;
  }
  if ( !item )
    goto LABEL_20;
    ...
    if ( mode )
    {
      ...
      if ( UserServantEntity_k__BackingField || UserCommandCodeEntity_k__BackingField )
      {
        ...
        if ( v15 )
        {
          ...
          FlashingIconComponent__Set_40087648(fortificationRootObj, IsParty_k__BackingField, 0LL);
        }
        ServantOperationListViewItemDraw__SetSpriteActive(
...
LABEL_31:
        sub_1BCB254(fortificationRootObj, IsParty_k__BackingField);
      }
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18676 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_6429/*"FORTIFICATION_APPOINTMENT"*/, v10);
    sub_1BCAFF8(&StringLiteral_11417/*"SELECT_CANNOT"*/, v11);
    sub_1BCAFF8(&StringLiteral_11448/*"SELECT_SERVANT_EVENT_JOIN"*/, v12);
    this = (ServantOperationListViewItemDraw_o *)sub_1BCAFF8(&StringLiteral_1/*""*/, v13);
    byte_4B18676 = 1;
  }
  if ( (unsigned int)(modeKind - 1) < 2 )
  {
    ...
    this = (ServantOperationListViewItemDraw_o *)TutorialFlag__Get_39617644(126, 0LL);
    ...
    if ( ServantOperationListViewItem__get_IsEventJoin(item, 0LL) )
    {
      ...
      if ( this )
      {
        ...
        if ( this )
        {
          ...
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          v15 = &StringLiteral_11448/*"SELECT_SERVANT_EVENT_JOIN"*/;
LABEL_46:
...
LABEL_41:
      ...
      if ( this )
      {
        ...
        if ( this )
        {
          ...
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          v15 = &StringLiteral_11417/*"SELECT_CANNOT"*/;
          goto LABEL_46;
        }
      }
LABEL_51:
        ...
        if ( this )
        {
          ...
          if ( this )
          {
            ...
            this = (ServantOperationListViewItemDraw_o *)LocalizationManager__Get(
                                                           (System_String_o *)StringLiteral_6429/*"FORTIFICATION_APPOINTMENT"*/,
                                                           0LL);
