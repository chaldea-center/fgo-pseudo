...
void EventItemListComponent__GoToEventShop(int32_t eventId, const MethodInfo *method)
{
  ...
  SceneJumpInfo___ctor_41713068(v3, (System_String_o *)StringLiteral_9538/*"NormalEventShop"*/, eventId, 0);
  if ( !v3
...
void EventItemListComponent__GoToShopEventItemExchange(int32_t eventId, const MethodInfo *method)
{
  ...
  v3 = (SceneJumpInfo_o *)sub_1C6BC54(SceneJumpInfo_TypeInfo);
  SceneJumpInfo___ctor_41713068(v3, (System_String_o *)StringLiteral_6219/*"EventItem"*/, eventId, 0);
  if ( !v3
    || (SceneJumpInfo__SetReturnNowScene(v3, 0),
        (Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A4F3B4 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__)) == 0) )
  {
  ...
  else
  {
    ...
    if ( !gameObject
      || (UnityEngine_GameObject__SetActive(gameObject, 1, 0),
          (gameObject = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A4F3B4 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0)
