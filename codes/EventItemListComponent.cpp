...
void EventItemListComponent__GoToEventShop(int32_t eventId, const MethodInfo *method)
{
  ...
  v3 = (SceneJumpInfo_o *)sub_1D0F300(SceneJumpInfo_TypeInfo);
  SceneJumpInfo___ctor_42856684(v3, (System_String_o *)StringLiteral_9656/*"NormalEventShop"*/, eventId, 0);
  if ( !v3
...
void EventItemListComponent__GoToShopEventItemExchange(int32_t eventId, const MethodInfo *method)
{
  ...
  v3 = (SceneJumpInfo_o *)sub_1D0F300(SceneJumpInfo_TypeInfo);
  SceneJumpInfo___ctor_42856684(v3, (System_String_o *)StringLiteral_6294/*"EventItem"*/, eventId, 0);
  if ( !v3
    || (SceneJumpInfo__SetReturnNowScene(v3, 0),
        (Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3BAC684 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__)) == 0) )
  {
  ...
  else
  {
    ...
    if ( !gameObject
      || (UnityEngine_GameObject__SetActive(gameObject, 1, 0),
          (gameObject = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3BAC684 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0)
