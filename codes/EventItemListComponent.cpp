...
void __fastcall EventItemListComponent__GoToEventShop(int32_t eventId, const MethodInfo *method)
{
  ...
  if ( (byte_4A6F301 & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_9532/*"NormalEventShop"*/, v4);
    byte_4A6F301 = 1;
  }
  v5 = (SceneJumpInfo_o *)sub_1B9025C(SceneJumpInfo_TypeInfo);
  SceneJumpInfo___ctor_38717336(v5, (System_String_o *)StringLiteral_9532/*"NormalEventShop"*/, eventId, 0LL);
  if ( !v5
...
void __fastcall EventItemListComponent__GoToShopEventItemExchange(int32_t eventId, const MethodInfo *method)
{
  ...
  if ( (byte_4A6F300 & 1) == 0 )
  {
    sub_1B90010(&SceneJumpInfo_TypeInfo, method);
    sub_1B90010(&Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__, v3);
    sub_1B90010(&StringLiteral_6189/*"EventItem"*/, v4);
    byte_4A6F300 = 1;
  }
  v5 = (SceneJumpInfo_o *)sub_1B9025C(SceneJumpInfo_TypeInfo);
  SceneJumpInfo___ctor_38717336(v5, (System_String_o *)StringLiteral_6189/*"EventItem"*/, eventId, 0LL);
  if ( !v5
    || (SceneJumpInfo__SetReturnNowScene(v5, 0LL),
        (Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_374C890 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__)) == 0LL) )
  {
  ...
  else
  {
    ...
    if ( !gameObject
      || (UnityEngine_GameObject__SetActive(gameObject, 1, 0LL),
          (gameObject = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_374C890 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0LL)
