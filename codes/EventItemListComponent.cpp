...
void __fastcall EventItemListComponent__GoToEventShop(int32_t eventId, const MethodInfo *method)
{
  ...
  if ( (byte_4BFCBA2 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&StringLiteral_9717/*"NormalEventShop"*/, v4);
    byte_4BFCBA2 = 1;
  }
  v5 = (SceneJumpInfo_o *)sub_1C2E378(SceneJumpInfo_TypeInfo);
  SceneJumpInfo___ctor_39988936(v5, (System_String_o *)StringLiteral_9717/*"NormalEventShop"*/, eventId, 0LL);
  if ( !v5
...
void __fastcall EventItemListComponent__GoToShopEventItemExchange(int32_t eventId, const MethodInfo *method)
{
  ...
  if ( (byte_4BFCBA1 & 1) == 0 )
  {
    sub_1C2E12C(&SceneJumpInfo_TypeInfo, method);
    sub_1C2E12C(&Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__, v3);
    sub_1C2E12C(&StringLiteral_6347/*"EventItem"*/, v4);
    byte_4BFCBA1 = 1;
  }
  v5 = (SceneJumpInfo_o *)sub_1C2E378(SceneJumpInfo_TypeInfo);
  SceneJumpInfo___ctor_39988936(v5, (System_String_o *)StringLiteral_6347/*"EventItem"*/, eventId, 0LL);
  if ( !v5
    || (SceneJumpInfo__SetReturnNowScene(v5, 0LL),
        (Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38A7F90 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__)) == 0LL) )
  {
  ...
  else
  {
    ...
    if ( !gameObject
      || (UnityEngine_GameObject__SetActive(gameObject, 1, 0LL),
          (gameObject = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38A7F90 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0LL)
