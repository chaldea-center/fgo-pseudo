...
void __fastcall EventItemListComponent__GoToEventShop(int32_t eventId, const MethodInfo *method)
{
  ...
  if ( (byte_4C213B0 & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_9719/*"OnRequestFileChooserPermissionsResult"*/, v4);
    byte_4C213B0 = 1;
  }
  v5 = (SceneJumpInfo_o *)sub_1C3B9B0(SceneJumpInfo_TypeInfo);
  SceneJumpInfo___ctor_40098300(v5, (System_String_o *)StringLiteral_9719/*"OnRequestFileChooserPermissionsResult"*/, eventId, 0LL);
  if ( !v5
...
void __fastcall EventItemListComponent__GoToShopEventItemExchange(int32_t eventId, const MethodInfo *method)
{
  ...
  if ( (byte_4C213AF & 1) == 0 )
  {
    sub_1C3B764(&SceneJumpInfo_TypeInfo, method);
    sub_1C3B764(&Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__, v3);
    sub_1C3B764(&StringLiteral_6350/*"FOLLOW_FRIEND_POINT"*/, v4);
    byte_4C213AF = 1;
  }
  v5 = (SceneJumpInfo_o *)sub_1C3B9B0(SceneJumpInfo_TypeInfo);
  SceneJumpInfo___ctor_40098300(v5, (System_String_o *)StringLiteral_6350/*"FOLLOW_FRIEND_POINT"*/, eventId, 0LL);
  if ( !v5
    || (SceneJumpInfo__SetReturnNowScene(v5, 0LL),
        (Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__)) == 0LL) )
  {
  ...
  else
  {
    ...
    if ( !gameObject
      || (UnityEngine_GameObject__SetActive(gameObject, 1, 0LL),
          (gameObject = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0LL)
