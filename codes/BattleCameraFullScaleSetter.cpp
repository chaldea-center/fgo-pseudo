void BattleCameraFullScaleSetter___cctor(const MethodInfo *method)
{
  if ( (byte_4E7A0BB & 1) == 0 )
  {
    sub_1D0F0B4(&BattleCameraFullScaleSetter_TypeInfo);
    byte_4E7A0BB = 1;
  }
...
void BattleCameraFullScaleSetter__CalcScale(BattleCameraFullScaleSetter_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1D0F0B4(&BattleCameraFullScaleSetter_TypeInfo);
    this = (BattleCameraFullScaleSetter_o *)sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    byte_4E7A0BA = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7A0B9 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_UnityEngine_GameObject_GetComponent_BattlePerformance___);
  ...
  {
    transform = (UnityEngine_Transform_o *)UnityEngine_GameObject__Find((System_String_o *)StringLiteral_10749/*"Performance"*/, 0);
    if ( !transform )
      goto LABEL_37;
    Component_object = UnityEngine_GameObject__GetComponent_object_(
                         (UnityEngine_GameObject_o *)transform,
                         (const MethodInfo_32A8444 *)Method_UnityEngine_GameObject_GetComponent_BattlePerformance___);
    v22 = (int)Component_object;
    this->fields.perf = (struct BattlePerformance_o *)Component_object;
    p_perf = &this->fields.perf;
  }
  sub_1D0F058((GrandQuestFolderBoardItem_o *)p_perf, v22, v15, v16, v17, v18, v19, v20);
...
LABEL_23:
    ...
    {
      v36 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3BAC684 *)Method_SingletonMonoBehaviour_FGOSequenceManager__get_Instance__);
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)v36, 0, 0) && this->fields.parentCameraType == 1 )
      {
        transform = (UnityEngine_Transform_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3BAC684 *)Method_SingletonMonoBehaviour_FGOSequenceManager__get_Instance__);
        if ( transform )
        {
