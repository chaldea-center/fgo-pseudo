        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D26BC3 & 1) == 0 )
  {
    sub_1C94098(&StringLiteral_6121/*"Error"*/);
  ...
  sub_1C9403C(&this->fields.eventRewardEnt, rewardData);
  this->fields.giftEnt = giftEntity;
  sub_1C9403C(&this->fields.giftEnt, giftEntity);
  this->fields.rewardObjectId = 0;
  v9 = StringLiteral_6121/*"Error"*/;
  this->fields.nameTxt = (struct System_String_o *)StringLiteral_6121/*"Error"*/;
  sub_1C9403C(&this->fields.nameTxt, v9);
  this->fields.needPoint = 0;
  this->fields.iconId = 0;
  v10 = StringLiteral_1/*""*/;
  this->fields.rewardDetailTxt = (struct System_String_o *)StringLiteral_1/*""*/;
  v11 = sub_1C9403C(&this->fields.rewardDetailTxt, v10);
  if ( !rewardData )
    goto LABEL_15;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D26BC5 & 1) == 0 )
  {
    ...
    this = (EventPointItemListViewItem_o *)sub_1C94098(&StringLiteral_5648/*"EVENT_POINT_ITEM_REQUIRED_POINT"*/);
    byte_4D26BC5 = 1;
  }
  ...
  v5 = System_String__Concat_64417744((System_String_o *)StringLiteral_5648/*"EVENT_POINT_ITEM_REQUIRED_POINT"*/, v4, 0);
  ...
  if ( System_String__op_Equality(v6, v5, 0) )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v6 = LocalizationManager__Get((System_String_o *)StringLiteral_5648/*"EVENT_POINT_ITEM_REQUIRED_POINT"*/, 0);
  }
...
void EventPointItemListViewItem__setGiftData(EventPointItemListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( giftEnt )
  {
    ...
    Instance = (Il2CppObject *)sub_1C9403C(p_svtEnt, Entity);
    v6 = this->fields.giftEnt;
    if ( !v6 )
LABEL_27:
