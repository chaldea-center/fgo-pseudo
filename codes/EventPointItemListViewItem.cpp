        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFED20 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_6161/*"Error"*/);
  ...
  sub_1CE66A4(&this->fields.eventRewardEnt, rewardData);
  this->fields.giftEnt = giftEntity;
  sub_1CE66A4(&this->fields.giftEnt, giftEntity);
  this->fields.rewardObjectId = 0;
  v9 = StringLiteral_6161/*"Error"*/;
  this->fields.nameTxt = (struct System_String_o *)StringLiteral_6161/*"Error"*/;
  sub_1CE66A4(&this->fields.nameTxt, v9);
  this->fields.needPoint = 0;
  this->fields.iconId = 0;
  v10 = StringLiteral_1/*""*/;
  this->fields.rewardDetailTxt = (struct System_String_o *)StringLiteral_1/*""*/;
  v11 = sub_1CE66A4(&this->fields.rewardDetailTxt, v10);
  if ( !rewardData )
    goto LABEL_15;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFED22 & 1) == 0 )
  {
    ...
    this = (EventPointItemListViewItem_o *)sub_1CE6700(&StringLiteral_5684/*"EVENT_POINT_ITEM_REQUIRED_POINT"*/);
    byte_4DFED22 = 1;
  }
  ...
  v5 = System_String__Concat_65122828((System_String_o *)StringLiteral_5684/*"EVENT_POINT_ITEM_REQUIRED_POINT"*/, v4, 0);
  ...
  if ( System_String__op_Equality(v6, v5, 0) )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v6 = LocalizationManager__Get((System_String_o *)StringLiteral_5684/*"EVENT_POINT_ITEM_REQUIRED_POINT"*/, 0);
  }
  needPoint = v2->fields.needPoint;
  v7 = (Il2CppObject *)j_il2cpp_value_box_0(long_TypeInfo, &needPoint);
...
void EventPointItemListViewItem__setGiftData(EventPointItemListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( giftEnt )
  {
    ...
    Instance = (Il2CppObject *)sub_1CE66A4(p_svtEnt, Entity);
    v6 = this->fields.giftEnt;
    if ( !v6 )
LABEL_27:
