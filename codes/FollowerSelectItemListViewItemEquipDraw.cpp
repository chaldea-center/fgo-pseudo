  ...
  *(_QWORD *)&v17.fields.fakeValue = v11;
  if ( CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49621544(v17, 0) > 0 )
  {
    ...
    *(_QWORD *)&v18.fields.fakeValue = v13;
    v15 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49621544(v18, 0);
    FollowerSelectItemListViewItemEquipDraw__SetEquip_33292148(
      this,
      v15,
...
void FollowerSelectItemListViewItemEquipDraw__SetEquip_33292148(
        FollowerSelectItemListViewItemEquipDraw_o *this,
        int32_t svtId,
        int32_t limitCount,
  ...
  if ( UnityEngine_Object__op_Inequality(friendShipSvtEquipSkillIcon, 0, 0) )
  {
    ...
    if ( isDisplayFriendShipSkillIcon )
    {
      ...
      if ( AtlasManager_TypeInfo->_2.cctor_finished )
      {
        ...
        {
LABEL_24:
          AtlasManager__SetEventUI(v19, (System_String_o *)StringLiteral_19878/*"func_group_icon_385"*/, 0);
          goto LABEL_28;
        }
      }
      else
...
LABEL_28:
  ...
  if ( UnityEngine_Object__op_Inequality(equipLimitCountSprite, 0, 0) )
  {
    ...
    gameObject = (UnityEngine_Component_o *)DataManager__GetMaster_object_((const MethodInfo_319C0E0 *)Method_DataManager_GetMaster_ServantMaster___);
    if ( gameObject )
    {
