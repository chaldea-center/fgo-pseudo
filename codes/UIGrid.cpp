...
void UIGrid__AddChild(UIGrid_o *this, UnityEngine_Transform_o *trans, const MethodInfo *method)
{
  ...
  UIGrid__AddChild_56239664(this, trans, 0, v3);
}


void UIGrid__AddChild_56239664(UIGrid_o *this, UnityEngine_Transform_o *trans, bool sort, const MethodInfo *method)
{
...
void UIGrid__ConstrainWithinPanel(UIGrid_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(mPanel, 0, 0) )
  {
    ...
    if ( !v4 )
      goto LABEL_14;
    UIPanel__ConstrainTargetToBounds_56185392(v4, transform, 1, 0);
...
int32_t UIGrid__GetIndex(UIGrid_o *this, UnityEngine_Transform_o *trans, const MethodInfo *method)
{
  ...
  if ( (byte_5974FED & 1) == 0 )
  {
    sub_2213A60(&Method_System_Collections_Generic_List_Transform__IndexOf__);
    byte_5974FED = 1;
  }
  ...
  return System_Collections_Generic_List_object___IndexOf(
           ...
           (Il2CppObject *)trans,
           (const MethodInfo_44848E8 *)Method_System_Collections_Generic_List_Transform__IndexOf__);
}
...
bool UIGrid__RemoveChild(UIGrid_o *this, UnityEngine_Transform_o *t, const MethodInfo *method)
{
  ...
  if ( (byte_5974FEF & 1) == 0 )
  {
    sub_2213A60(&Method_System_Collections_Generic_List_Transform__Remove__);
    byte_5974FEF = 1;
  }
  ...
  v8 = System_Collections_Generic_List_object___Remove(
         (System_Collections_Generic_List_object__o *)ChildList,
         (Il2CppObject *)t,
         (const MethodInfo_4485154 *)Method_System_Collections_Generic_List_Transform__Remove__);
  if ( v8 )
    ((void (__fastcall *)(UIGrid_o *, System_Collections_Generic_List_Transform__o *, const MethodInfo *))this->klass->vtable._9_ResetPosition.methodPtr)(
      this,
      v7,
        ...
        const MethodInfo *method)
{
  ...
  float32x2_t v55; // [xsp+10h] [xbp-C0h]
...
LABEL_15:
        x = cellWidth * v25;
        y = -(float)(this->fields.cellHeight * v26);
        goto LABEL_16;
      }
      if ( arrangement != 2 )
      {
...
LABEL_40:
      ...
      if ( cellHeight <= 0.0 )
        goto LABEL_16;
      v30 = localPosition.fields.y / cellHeight;
      v31 = modf((float)(localPosition.fields.y / cellHeight), &iptr);
...
LABEL_22:
        v60.fields.x = x;
        v60.fields.y = y;
        v60.fields.z = localPosition.fields.z;
      ...
      if ( v12 <= v10 )
        v12 = v10;
      v28 = v9 + 1 >= this->fields.maxPerLine && this->fields.maxPerLine > 0;
    ...
    v20 = localPosition.fields.x / cellWidth;
    v21 = modf((float)(localPosition.fields.x / cellWidth), &iptr);
...
LABEL_53:
  ...
  if ( pivot )
  {
    ...
    if ( !v8 )
      goto LABEL_72;
    v40 = this->fields.cellWidth;
    v41 = this->fields.cellHeight;
    if ( UnityEngine_Transform__get_childCount(v8, 0) >= 1 )
    {
      v42 = 0;
      __asm { FMOV            V1.2S, #1.0 }
      v48.n64_f32[0] = v40 * (float)v38;
      v48.n64_f32[1] = 0.0 - (float)(v41 * (float)-v39);
      v49.n64_u32[0] = 0;
      v49.n64_f32[1] = v41 * (float)-v39;
      v50 = vadd_f32(
              vmul_f32(
                vbic_s8(
      ...
      while ( 1 )
      {
        transform = UnityEngine_Transform__GetChild(v8, v42, 0);
        if ( !transform )
          break;
        ...
        if ( ((unsigned __int8)transform & 1) != 0 )
        {
          if ( !Component_object )
            break;
          Component_object[2].klass = (Il2CppClass *)vsub_f32((float32x2_t)Component_object[2].klass, v55).n64_u64[0];
        }
        else
        {
          v58 = UnityEngine_Transform__get_localPosition(v52, 0);
          v61.fields.z = v58.fields.z;
          v61.fields.y = v58.fields.y - v51;
          v61.fields.x = v58.fields.x - v55.n64_f32[0];
          UnityEngine_Transform__set_localPosition(v52, v61, 0);
        }
        if ( ++v42 >= UnityEngine_Transform__get_childCount(v8, 0) )
          return;
      }
LABEL_72:
      sub_2213CDC(transform, v6);
...
int32_t UIGrid__SortHorizontal(UnityEngine_Transform_o *a, UnityEngine_Transform_o *b, const MethodInfo *method)
{
  ...
  *(_QWORD *)&localPosition.fields.x = 0;
  ...
  return System_Single__CompareTo_77225624(*(float *)&v5, *((float *)&v5 + 1), (const MethodInfo *)&localPosition);
}
...
{
  float y; // s1
  UnityEngine_Vector3_o localPosition; // [xsp+0h] [xbp-30h] BYREF

  localPosition.fields.z = 0.0;
  localPosition.fields.y = 0.0;
  if ( !b || (localPosition = UnityEngine_Transform__get_localPosition(b, 0), !a) )
    sub_2213CDC(a, b);
  y = UnityEngine_Transform__get_localPosition(a, 0).fields.y;
  return System_Single__CompareTo_77225624(y, y, (const MethodInfo *)&localPosition.fields.y);
}
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_2016D18;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_2016CD8;
}
