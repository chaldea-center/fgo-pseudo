void __fastcall SummonInfoControl___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A57A3B & 1) == 0 )
  {
    sub_1B885B0(&SummonInfoControl_TypeInfo);
    byte_4A57A3B = 1;
  }
  static_fields = SummonInfoControl_TypeInfo->static_fields;
  *(_OWORD *)&static_fields->OPEN_TIME = xmmword_BB5A80;
...
void __fastcall SummonInfoControl__Awake(SummonInfoControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A57A1C & 1) == 0 )
  {
    sub_1B885B0(&Method_System_Collections_Generic_List_SummonInfoControl_SummonObjInfo__Add__);
    sub_1B885B0(&Method_System_Collections_Generic_List_SummonInfoControl_SummonObjInfo___ctor__);
    sub_1B885B0(&System_Collections_Generic_List_SummonInfoControl_SummonObjInfo__TypeInfo);
    byte_4A57A1C = 1;
  }
  v3 = (System_Collections_Generic_List_object__o *)sub_1B887FC(System_Collections_Generic_List_SummonInfoControl_SummonObjInfo__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v3,
    (const MethodInfo_34FD000 *)Method_System_Collections_Generic_List_SummonInfoControl_SummonObjInfo___ctor__);
  if ( !v3 )
    goto LABEL_29;
  ...
  else
  {
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)(v11 + 4), (int32_t)freeSummon, v6, v7);
  }
  ...
  else
  {
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)(v17 + 4), (int32_t)freeSummon, v12, v13);
  }
  ...
  else
  {
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)(v23 + 4), (int32_t)freeSummon, v18, v19);
  }
  ...
  else
  {
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)(v29 + 4), (int32_t)freeSummon, v24, v25);
  }
  ...
  else
  {
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)(v35 + 4), (int32_t)freeSummon, v30, v31);
  }
...
LABEL_29:
  ...
  else
  {
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)(v41 + 4), (int32_t)freeSummon, v36, v37);
  }
  this->fields.summonObjInfos = (struct System_Collections_Generic_List_SummonInfoControl_SummonObjInfo__o *)v3;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.summonObjInfos, (int32_t)v3, v42, v43);
  SummonInfoControl__InitMasterData(this, v44);
}
...
void __fastcall SummonInfoControl__ClickBase(SummonInfoControl_o *this, int32_t seKind, const MethodInfo *method)
{
  ...
  if ( (byte_4A57A37 & 1) == 0 )
  {
    sub_1B885B0(&Method_SummonInfoControl_ClickBase__);
    byte_4A57A37 = 1;
  }
  v5 = Method_SummonInfoControl_ClickBase__;
  if ( (*((_BYTE *)Method_SummonInfoControl_ClickBase__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1B885C8(Method_SummonInfoControl_ClickBase__);
...
void __fastcall SummonInfoControl__EndAnimation(SummonInfoControl_o *this, const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.animationCallback, 0, v2, v3);
...
int32_t __fastcall SummonInfoControl__GetBonusSelectLineupCount(SummonInfoControl_o *this, const MethodInfo *method)
{
  ...
  Master_object = (System_Int32_array *)DataManager__GetMaster_object_((const MethodInfo_2E7F8B4 *)Method_DataManager_GetMaster_GachaBonusSelectMaster___);
  ...
  if ( ((unsigned __int8)Master_object & 1) != 0 )
  {
    ...
    if ( max_length >= 1 )
    {
      ...
      {
        if ( v9 >= max_length )
          sub_1B88814(Master_object, gachaBonusSelectLineupId);
        v10 = v7->m_Items[v9];
        if ( !v10 )
          break;
        if ( !v3 )
...
LABEL_68:
      sub_1B8880C(Master_object, gachaBonusSelectLineupId);
    }
  }
LABEL_19:
            ...
            (const MethodInfo_3274238 *)Method_System_Collections_Generic_List_Enumerator_int__MoveNext__) )
  {
    ...
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    v16 = DataManager__GetMaster_object_((const MethodInfo_2E7F8B4 *)Method_DataManager_GetMaster_GachaBonusSelectLineupMaster___);
    if ( !v16 )
      sub_1B8880C(0LL, v17);
            ...
            (const MethodInfo_3274238 *)Method_System_Collections_Generic_List_Enumerator_int__MoveNext__) )
  {
    ...
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    v29 = DataManager__GetMaster_object_((const MethodInfo_2E7F8B4 *)Method_DataManager_GetMaster_GiftMaster___);
    if ( !v29 )
      sub_1B8880C(0LL, v30);
    GiftListById = GiftMaster__GetGiftListById((GiftMaster_o *)v29, v28, 0LL);
    v33 = GiftListById;
    if ( !GiftListById )
      sub_1B8880C(0LL, objectId);
    ...
    if ( v34 && (int)v34 >= 1 )
    {
      ...
      do
      {
        if ( (unsigned int)v35 >= (unsigned int)v34 )
          sub_1B88814(GiftListById, objectId);
        v36 = v33->m_Items[v35];
        if ( !v36 )
          sub_1B8880C(GiftListById, objectId);
        ...
        const MethodInfo *method)
{
  if ( (byte_4A57A2F & 1) == 0 )
  {
    this = (SummonInfoControl_o *)sub_1B885B0(&Method_UnityEngine_GameObject_GetComponent_UISprite___);
    byte_4A57A2F = 1;
  }
  if ( !obj
...
void __fastcall SummonInfoControl__InitMasterData(SummonInfoControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A57A1D & 1) == 0 )
  {
    ...
    sub_1B885B0(&DataManager_TypeInfo);
    sub_1B885B0(&StringLiteral_14833/*"USER_FREE_STONE"*/);
    sub_1B885B0(&StringLiteral_13445/*"TUTORIAL_GACHA_ID"*/);
    byte_4A57A1D = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.gachaMaster, (int32_t)Master_object, v4, v5);
  v6 = DataManager__GetMaster_object_((const MethodInfo_2E7F8B4 *)Method_DataManager_GetMaster_ConstantMaster___);
  if ( !v6 )
    sub_1B8880C(0LL, v7);
  v8 = (ConstantMaster_o *)v6;
  this->fields.tutorialGachaId = ConstantMaster__GetValue(
                                   (ConstantMaster_o *)v6,
                                   (System_String_o *)StringLiteral_13445/*"TUTORIAL_GACHA_ID"*/,
                                   0LL);
  this->fields.userFreeStone = ConstantMaster__GetValue(v8, (System_String_o *)StringLiteral_14833/*"USER_FREE_STONE"*/, 0LL);
  v9 = DataManager__GetMaster_object_((const MethodInfo_2E7F8B4 *)Method_DataManager_GetMaster_ViewGachaFeaturedServantMaster___);
  this->fields.viewGachaFeaturedServantMaster = (struct ViewGachaFeaturedServantMaster_o *)v9;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.viewGachaFeaturedServantMaster, (int32_t)v9, v10, v11);
}
...
void __fastcall SummonInfoControl__InitSummonBtnDisp(SummonInfoControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A57A20 & 1) == 0 )
  {
    sub_1B885B0(&System_Action_SummonInfoControl_SummonObjInfo__TypeInfo);
    sub_1B885B0(&Method_System_Collections_Generic_List_SummonInfoControl_SummonObjInfo__ForEach__);
    sub_1B885B0(&Method_SummonInfoControl___c__InitSummonBtnDisp_b__132_0__);
    sub_1B885B0(&SummonInfoControl___c_TypeInfo);
    byte_4A57A20 = 1;
  }
  ...
  _9__132_0 = (System_Action_object__o *)v3->static_fields->__9__132_0;
  if ( !_9__132_0 )
  {
    ...
    _9__132_0 = (System_Action_object__o *)sub_1B887FC(System_Action_SummonInfoControl_SummonObjInfo__TypeInfo);
    System_Action_object____ctor(_9__132_0, v6, Method_SummonInfoControl___c__InitSummonBtnDisp_b__132_0__, 0LL);
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)&static_fields->__9__132_0, (int32_t)_9__132_0, v8, v9);
  }
  if ( !summonObjInfos )
  ...
  System_Collections_Generic_List_object___ForEach(
    ...
    (const MethodInfo_34FE274 *)Method_System_Collections_Generic_List_SummonInfoControl_SummonObjInfo__ForEach__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57A34 & 1) == 0 )
  {
    ...
    sub_1B885B0(&SummonInfoControl_TypeInfo);
    this = (SummonInfoControl_o *)sub_1B885B0(&StringLiteral_5945/*"EndAnimation"*/);
    byte_4A57A34 = 1;
  }
  if ( !target )
    goto LABEL_15;
  ...
  if ( ((unsigned __int8)this & 1) != 0 )
  {
    if ( v6 )
    {
      ...
      v10 = StringLiteral_5945/*"EndAnimation"*/;
      v6->fields.callWhenFinished = (struct System_String_o *)StringLiteral_5945/*"EndAnimation"*/;
      sub_1B88554((ServantStatusBattleListViewItem_o *)&v6->fields.callWhenFinished, v10, v11, v12);
      return;
    }
LABEL_15:
...
void __fastcall SummonInfoControl__OffSetInfoBtn(SummonInfoControl_o *this, const MethodInfo *method)
{
  ...
  gameObject = (UnityEngine_Component_o *)sub_1B88658(UnityEngine_GameObject___TypeInfo, 4LL);
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v5[1].monitor, (int32_t)gameObject, v6, v7);
  ...
  *(_QWORD *)&v5[1].fields.m_CachedPtr = gameObject;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v5[1].fields, (int32_t)gameObject, v8, v9);
  if ( LODWORD(v5[1].klass) <= 2 )
    goto LABEL_26;
  summonDetailInfo = this->fields.summonDetailInfo;
  v5[2].klass = (UnityEngine_Component_c *)summonDetailInfo;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v5[2], (int32_t)summonDetailInfo, v10, v11);
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v5[2].monitor, (int32_t)gameObject, v13, v14);
  klass = v5[1].klass;
  if ( (int)klass >= 1 )
  {
    v16 = 0LL;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57A38 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_SummonInfoControl_OnClickDetail__);
  ...
  if ( (*((_BYTE *)Method_SummonInfoControl_OnClickDetail__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1B885C8(Method_SummonInfoControl_OnClickDetail__);
  v6 = (System_Reflection_MethodBase_o *)sub_1B88594(v5, v5[4]);
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.closeCallbackFunc, (int32_t)callback, v12, v13);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v14 = LocalizationManager__Get((System_String_o *)StringLiteral_15553/*"WEB_VIEW_TITLE_SUMMON"*/, 0LL);
  closeCallbackFunc = this->fields.closeCallbackFunc;
  v16 = v14;
  if ( !WebViewManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(WebViewManager_TypeInfo);
  WebViewManager__OpenView(v16, SummonDetailUrl, closeCallbackFunc, 0LL);
}
...
void __fastcall SummonInfoControl__OnClickMultiPayGacha(SummonInfoControl_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B8880C(CurrentGachaEntity, v4);
  }
  SummonInfoControl__SetRequestData(
    this,
    -1,
...
void __fastcall SummonInfoControl__OnClickSinglePayExGacha(SummonInfoControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A57A36 & 1) == 0 )
  {
    this = (SummonInfoControl_o *)sub_1B885B0(&Method_SummonInfoControl_OnClickSinglePayExGacha__);
    byte_4A57A36 = 1;
  }
  ...
  else
  {
    ...
    if ( (*((_BYTE *)Method_SummonInfoControl_OnClickSinglePayExGacha__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B885C8(Method_SummonInfoControl_OnClickSinglePayExGacha__);
    v6 = (System_Reflection_MethodBase_o *)sub_1B88594(v5, v5[4]);
        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    sub_1B88554(p_animationCallback, 0, (int32_t)v6, v7);
...
void __fastcall SummonInfoControl__SetChargeSummonInfo(SummonInfoControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A57A2A & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_3049/*"BONUS_SELECT_BUTTON_MAIN_LABEL"*/);
    sub_1B885B0(&StringLiteral_3050/*"BONUS_SELECT_BUTTON_SUB_LABEL"*/);
  ...
  SummonInfoControl__SetSummonInfo_33167168(this, v4);
  ...
  if ( !multiPay )
    goto LABEL_42;
  SummonInfoControl__SetPriceText(this, multiPay->fields.needLabel, -1, (System_String_o *)StringLiteral_24983/*"{0}"*/, v7);
  ...
  if ( (v18 & 1) != 0 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v20 = LocalizationManager__Get((System_String_o *)StringLiteral_3050/*"BONUS_SELECT_BUTTON_SUB_LABEL"*/, 0LL);
    BonusSelectLineupCount = SummonInfoControl__GetBonusSelectLineupCount(this, v21);
    v22 = (Il2CppObject *)System_Int32__ToString_62512312(
...
LABEL_42:
    sub_1B8880C(CurrentGachaEntity, Empty);
  }
  if ( !bonusSelectLabel )
    goto LABEL_42;
...
LABEL_24:
  ...
  GameObjectExtensions__SetLocalScale_33726300(v32, 1.0, 1.0, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57A30 & 1) == 0 )
  {
    this = (SummonInfoControl_o *)sub_1B885B0(&UnityEngine_Object_TypeInfo);
    byte_4A57A30 = 1;
  }
  if ( !summonObjInfo )
    goto LABEL_19;
  ...
  if ( !v6 )
LABEL_19:
    sub_1B8880C(this, summonObjInfo);
  v15 = *v14;
  v6->fields.currentBtnInfo = *v14;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v6->fields.currentBtnInfo, (int32_t)v15, v12, v13);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57A27 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_17559/*"btn_txt_bonus_10times_plus1"*/);
    sub_1B885B0(&StringLiteral_17543/*"btn_summon_bg2"*/);
    sub_1B885B0(&StringLiteral_17542/*"btn_summon_bg1"*/);
    sub_1B885B0(&StringLiteral_17560/*"btn_txt_bonus_1plus1"*/);
    sub_1B885B0(&StringLiteral_17563/*"btn_txt_bonus_{0}_glow"*/);
    sub_1B885B0(&StringLiteral_17624/*"btn_txt_summon{0:00}"*/);
    sub_1B885B0(&StringLiteral_17561/*"btn_txt_bonus_count_{0}"*/);
    sub_1B885B0(&StringLiteral_22179/*"num1"*/);
    sub_1B885B0(&StringLiteral_17544/*"btn_summon_bg3"*/);
    sub_1B885B0(&StringLiteral_22180/*"num1_glow"*/);
    this = (SummonInfoControl_o *)sub_1B885B0(&StringLiteral_17562/*"btn_txt_bonus_{0}"*/);
    byte_4A57A27 = 1;
  }
  if ( !summonObjInfo )
    goto LABEL_93;
  ...
  this = (SummonInfoControl_o *)System_String__Format((System_String_o *)StringLiteral_17624/*"btn_txt_summon{0:00}"*/, v14, 0LL);
  if ( !numImg )
    goto LABEL_93;
  ...
  if ( !this )
    goto LABEL_93;
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)this, 1, 0LL);
  this = (SummonInfoControl_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this )
    goto LABEL_93;
  ...
  if ( (_DWORD)this != 9 )
  {
    ...
    GameObjectExtensions__SetLocalPosition_33724120(v27, 0.0, -34.0, 0LL);
    if ( !*p_onePay )
      goto LABEL_93;
    this = (SummonInfoControl_o *)(*p_onePay)->fields.bonusInfo;
    if ( !this )
...
LABEL_96:
        ...
        BonusSprite = SummonInfoControl__GetBonusSprite(
                        ...
                        (System_String_o *)StringLiteral_22179/*"num1"*/,
                        v36);
        v38 = 9 - v22;
        v56 = 9 - v22;
        v42 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v56, v39, v40, v41);
        this = (SummonInfoControl_o *)System_String__Format((System_String_o *)StringLiteral_17562/*"btn_txt_bonus_{0}"*/, v42, 0LL);
        if ( !BonusSprite )
          goto LABEL_93;
        ...
        v45 = SummonInfoControl__GetBonusSprite(
                ...
                (System_String_o *)StringLiteral_22180/*"num1_glow"*/,
                v44);
        v55 = v38;
        v49 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v55, v46, v47, v48);
        this = (SummonInfoControl_o *)System_String__Format((System_String_o *)StringLiteral_17563/*"btn_txt_bonus_{0}_glow"*/, v49, 0LL);
        if ( !v45 )
          goto LABEL_93;
    ...
    this = (SummonInfoControl_o *)System_String__Format((System_String_o *)StringLiteral_17561/*"btn_txt_bonus_count_{0}"*/, v33, 0LL);
    if ( !bonusCount )
      goto LABEL_93;
...
LABEL_79:
    if ( *p_onePay )
    {
      ...
      v52 = (System_String_o **)(ticket ? &StringLiteral_17544/*"btn_summon_bg3"*/ : &StringLiteral_17542/*"btn_summon_bg1"*/);
      if ( this )
      {
...
LABEL_93:
  ...
  this = (SummonInfoControl_o *)System_String__Format((System_String_o *)StringLiteral_17624/*"btn_txt_summon{0:00}"*/, v24, 0LL);
  if ( !v23 )
    goto LABEL_93;
  ...
  GameObjectExtensions__SetLocalPosition_33724120(v25, 0.0, -35.0, 0LL);
  if ( !*p_onePay )
    goto LABEL_93;
  this = (SummonInfoControl_o *)(*p_onePay)->fields.bonusInfo;
  if ( !this )
  ...
  if ( !this )
    goto LABEL_93;
  UISprite__set_spriteName((UISprite_o *)this, (System_String_o *)StringLiteral_17543/*"btn_summon_bg2"*/, 0LL);
  if ( !*p_onePay )
    goto LABEL_93;
  this = (SummonInfoControl_o *)(*p_onePay)->fields.button;
  if ( !this )
    goto LABEL_93;
  UIButton__set_normalSprite((UIButton_o *)this, (System_String_o *)StringLiteral_17543/*"btn_summon_bg2"*/, 0LL);
  if ( !ticket )
  {
LABEL_42:
    if ( *p_onePay )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57A28 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_17558/*"btn_txt_bonus_10plus1"*/);
    sub_1B885B0(&StringLiteral_17624/*"btn_txt_summon{0:00}"*/);
    byte_4A57A28 = 1;
  }
  if ( !System_Math_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
  v8 = System_Math__Min_62526008(multiCount, 11, 0LL);
  v15 = v8;
  v12 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v15, v9, v10, v11);
  gameObject = System_String__Format((System_String_o *)StringLiteral_17624/*"btn_txt_summon{0:00}"*/, v12, 0LL);
  if ( !multiNumImg
...
void __fastcall SummonInfoControl__SetFreeSummonInfo(SummonInfoControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A57A21 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_6520/*"FRIEND_POINT_SUMMON_MULTIPLE_FREE_CAMPAIGN_BUTTON_MSG"*/);
  ...
  *(_QWORD *)maxNum = 0LL;
  ...
  if ( (v7 & 1) != 0 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v9 = LocalizationManager__Get((System_String_o *)StringLiteral_6520/*"FRIEND_POINT_SUMMON_MULTIPLE_FREE_CAMPAIGN_BUTTON_MSG"*/, 0LL);
    v24 = maxNum[1];
    ...
    gameObject = (UnityEngine_GameObject_o *)System_String__Format_61721404(v9, v13, v17, 0LL);
...
void __fastcall SummonInfoControl__SetHelpBtnDisp(SummonInfoControl_o *this, bool isDisp, const MethodInfo *method)
{
  ...
  {
    sub_1B8880C(summonHelpInfo, isDisp);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57A29 & 1) == 0 )
  {
    ...
    sub_1B885B0(&DataManager_TypeInfo);
    sub_1B885B0(&SummonInfoControl_TypeInfo);
    sub_1B885B0(&StringLiteral_17545/*"btn_summon_bg5"*/);
    sub_1B885B0(&StringLiteral_17606/*"btn_txt_reset"*/);
    sub_1B885B0(&StringLiteral_20263/*"img_bg_saintquartzuse3"*/);
    sub_1B885B0(&StringLiteral_23674/*"summon_txt_done"*/);
    sub_1B885B0(&StringLiteral_17623/*"btn_txt_summon01"*/);
    sub_1B885B0(&StringLiteral_17597/*"btn_txt_only_1"*/);
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (GachaAppendMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2E7F8B4 *)Method_DataManager_GetMaster_GachaAppendMaster___);
  if ( !Master_object )
    goto LABEL_78;
  ...
  summonInfoLayout = (float *)v17->fields.summonInfoLayout;
  if ( !v10 )
  {
    SummonInfoControl__SetButtonLocalPosX(v17, v19, summonInfoLayout[1], summonInfoLayout[2], v16);
    return;
  }
  SummonInfoControl__SetButtonLocalPosX(v17, v19, summonInfoLayout[4], summonInfoLayout[5], v16);
  ...
  GameObjectExtensions__SetLocalPosition_33724224(v27, 0.0, 34.0, 0.0, 0LL);
  ...
  Master_object = (GachaAppendMaster_o *)AtlasManager__SetEventSprite(
                                           buttonImg,
                                           (System_String_o *)StringLiteral_17545/*"btn_summon_bg5"*/,
                                           0LL);
  ...
  if ( !v43 )
    goto LABEL_78;
  AtlasManager__SetEventSprite(v43->fields.bonusInfo, (System_String_o *)StringLiteral_17597/*"btn_txt_only_1"*/, 0LL);
  Master_object = (GachaAppendMaster_o *)AtlasManager__SetEventSprite(
                                           this->fields.oneExSummonSingleInfoSprite,
                                           (System_String_o *)StringLiteral_20263/*"img_bg_saintquartzuse3"*/,
                                           0LL);
  ...
  {
    SummonInfoControl__SetGachaSprite(this, numImg, (System_String_o *)StringLiteral_17623/*"btn_txt_summon01"*/, v46);
  }
  else
  {
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    ...
    Master_object = (GachaAppendMaster_o *)AtlasManager__SetEventSprite(
                                             numImg,
                                             (System_String_o *)StringLiteral_23674/*"summon_txt_done"*/,
                                             0LL);
  }
...
void __fastcall SummonInfoControl__SetPaySummonInfo(SummonInfoControl_o *this, const MethodInfo *method)
{
  ...
  currentSummonData = this->fields.currentSummonData;
  if ( !currentSummonData )
    sub_1B8880C(CurrentGachaEntity, v5);
...
void __fastcall SummonInfoControl__SetPointSummonInfo(SummonInfoControl_o *this, const MethodInfo *method)
{
  ...
  if ( (*(_BYTE *)(v4 + 309) & 1) == 0 )
    v4 = sub_1BDA48C(v4);
  MasterData_object = **(DataManager_o ***)(v4 + 184);
  ...
  if ( !System_Math_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
  v10 = System_Math__Min_62526008(m_CancellationTokenSource / v9, 10, 0LL);
  ...
  if ( v10 < 2 )
  {
    ...
    if ( v14 )
    {
      ...
      if ( single )
      {
        SummonInfoControl__SetPriceText(this, single->fields.infoLabel, -1, (System_String_o *)StringLiteral_24983/*"{0}"*/, v13);
        return;
      }
    }
LABEL_26:
  ...
  v19 = this->fields.friendPointSummon;
  if ( !v19 )
    goto LABEL_26;
  multiPay = v19->fields.multiPay;
  if ( !multiPay )
    goto LABEL_26;
  numImg = multiPay->fields.numImg;
  gachaTime = this->fields.gachaTime;
  v22 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &gachaTime, v16, v17, v18);
  MasterData_object = (DataManager_o *)System_String__Format((System_String_o *)StringLiteral_17624/*"btn_txt_summon{0:00}"*/, v22, 0LL);
  if ( !numImg )
    goto LABEL_26;
        ...
        const MethodInfo *method)
{
  ...
  {
    this = (SummonInfoControl_o *)sub_1B885B0(&GachaRqParamData_TypeInfo);
    byte_4A57A31 = 1;
...
LABEL_20:
  ...
  if ( !v26 )
LABEL_25:
    sub_1B8880C(this, *(_QWORD *)&gachaType);
  adjustStoryGachaIds = v26->fields.adjustStoryGachaIds;
LABEL_22:
  v27 = ticketItemId & ~(ticketItemId >> 31);
  if ( shopIdIdx < 0 )
    shopIdIdx = 1;
  v28 = (GachaRqParamData_o *)sub_1B887FC(GachaRqParamData_TypeInfo);
  GachaRqParamData___ctor_33029532(
    v28,
    summonType,
    gachaId,
    warId,
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v22->fields.requestData, (int32_t)v28, v29, v30);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57A32 & 1) == 0 )
  {
    sub_1B885B0(&System_Action_SummonInfoControl_SummonObjInfo__TypeInfo);
    sub_1B885B0(&Method_System_Collections_Generic_List_SummonInfoControl_SummonObjInfo__ForEach__);
    sub_1B885B0(&Method_SummonInfoControl___c__DisplayClass157_0__SetSummonButtonsCollider_b__0__);
    sub_1B885B0(&SummonInfoControl___c__DisplayClass157_0_TypeInfo);
    byte_4A57A32 = 1;
  }
  v5 = sub_1B887FC(SummonInfoControl___c__DisplayClass157_0_TypeInfo);
  ...
  if ( !v5
    || (*(_QWORD *)(v5 + 16) = this,
        ...
        *(_BYTE *)(v5 + 24) = onOff,
        summonObjInfos = (System_Collections_Generic_List_object__o *)this->fields.summonObjInfos,
        v11 = (System_Action_object__o *)sub_1B887FC(System_Action_SummonInfoControl_SummonObjInfo__TypeInfo),
...
void __fastcall SummonInfoControl__SetSummonDispInfo(SummonInfoControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A57A1E & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_SummonInfoControl__SetSummonDispInfo_b__129_0__);
    byte_4A57A1E = 1;
  }
  SelfUserGame = UserGameMaster__getSelfUserGame(0LL);
  this->fields.usrData = SelfUserGame;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.usrData, (int32_t)SelfUserGame, v4, v5);
  ...
  if ( !summonDetailInfo
    ...
    || (gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)summonDetailInfo, 0LL),
        ...
        !gameObject) )
  {
    sub_1B8880C(summonDetailInfo, v7);
  }
  ...
  *(_WORD *)&this->fields.isPayExUsePossible = 0;
  ...
  System_Action_int____ctor(v12, (Il2CppObject *)this, Method_SummonInfoControl__SetSummonDispInfo_b__129_0__, 0LL);
  StoneCountRefreshComponent__AttachToGameObject(v11, v12, 0, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57A2E & 1) == 0 )
  {
    ...
    sub_1B885B0(&UnityEngine_Object_TypeInfo);
    sub_1B885B0(&Method_SummonInfoControl___c__SetSummonGiftDisp_b__151_0__);
    sub_1B885B0(&Method_SummonInfoControl___c__SetSummonGiftDisp_b__151_1__);
    sub_1B885B0(&Method_SummonInfoControl___c__SetSummonGiftDisp_b__151_2__);
    sub_1B885B0(&Method_SummonInfoControl___c__SetSummonGiftDisp_b__151_3__);
    sub_1B885B0(&SummonInfoControl___c_TypeInfo);
    sub_1B885B0(&StringLiteral_17563/*"btn_txt_bonus_{0}_glow"*/);
    sub_1B885B0(&StringLiteral_22181/*"num2"*/);
    sub_1B885B0(&StringLiteral_22179/*"num1"*/);
    sub_1B885B0(&StringLiteral_8103/*"Item"*/);
    sub_1B885B0(&StringLiteral_22180/*"num1_glow"*/);
    sub_1B885B0(&StringLiteral_22182/*"num2_glow"*/);
    this = (SummonInfoControl_o *)sub_1B885B0(&StringLiteral_17562/*"btn_txt_bonus_{0}"*/);
    byte_4A57A2E = 1;
  }
  if ( isOnePay && v12->fields.shopId1GiftNum )
  {
    v13 = System_Int32__ToString((int)v12 + 360, 0LL);
    ...
    _9__151_0 = (System_Func_T__TResult__o *)v14->static_fields->__9__151_0;
    if ( !_9__151_0 )
    {
      ...
      _9__151_0 = (System_Func_T__TResult__o *)sub_1B887FC(System_Func_char__string__TypeInfo);
      System_Func_char__object____ctor(_9__151_0, v16, Method_SummonInfoControl___c__SetSummonGiftDisp_b__151_0__, 0LL);
      static_fields = SummonInfoControl___c_TypeInfo->static_fields;
      static_fields->__9__151_0 = (struct System_Func_char__string__o *)_9__151_0;
      sub_1B88554((ServantStatusBattleListViewItem_o *)&static_fields->__9__151_0, (int32_t)_9__151_0, v18, v19);
    }
  ...
  {
    v22 = System_Int32__ToString((int)v12 + 364, 0LL);
    ...
    _9__151_1 = (System_Func_T__TResult__o *)v23->static_fields->__9__151_1;
    if ( !_9__151_1 )
    {
      ...
      _9__151_1 = (System_Func_T__TResult__o *)sub_1B887FC(System_Func_char__string__TypeInfo);
      System_Func_char__object____ctor(_9__151_1, v25, Method_SummonInfoControl___c__SetSummonGiftDisp_b__151_1__, 0LL);
      v26 = SummonInfoControl___c_TypeInfo->static_fields;
      v26->__9__151_1 = (struct System_Func_char__string__o *)_9__151_1;
      sub_1B88554((ServantStatusBattleListViewItem_o *)&v26->__9__151_1, (int32_t)_9__151_1, v27, v28);
    }
  ...
  {
    v77 = System_Int32__ToString((int)v12 + 360, 0LL);
    ...
    _9__151_2 = (System_Func_T__TResult__o *)v78->static_fields->__9__151_2;
    if ( !_9__151_2 )
    {
      ...
      _9__151_2 = (System_Func_T__TResult__o *)sub_1B887FC(System_Func_char__string__TypeInfo);
      System_Func_char__object____ctor(_9__151_2, v80, Method_SummonInfoControl___c__SetSummonGiftDisp_b__151_2__, 0LL);
      v81 = SummonInfoControl___c_TypeInfo->static_fields;
      v81->__9__151_2 = (struct System_Func_char__string__o *)_9__151_2;
      sub_1B88554((ServantStatusBattleListViewItem_o *)&v81->__9__151_2, (int32_t)_9__151_2, v82, v83);
    }
    ...
    if ( ((unsigned __int8)this & 1) != 0 )
    {
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        ...
        GameObjectExtensions__SetLocalPositionY(v87, -6.0, 0LL);
        ...
        GameObjectExtensions__SetLocalPositionY(v88, 45.0, 0LL);
      }
    }
  }
LABEL_22:
  ...
  {
    v30 = System_Int32__ToString((int)v12 + 368, 0LL);
    ...
    _9__151_3 = (System_Func_T__TResult__o *)v31->static_fields->__9__151_3;
    if ( !_9__151_3 )
    {
      ...
      _9__151_3 = (System_Func_T__TResult__o *)sub_1B887FC(System_Func_char__string__TypeInfo);
      System_Func_char__object____ctor(_9__151_3, v33, Method_SummonInfoControl___c__SetSummonGiftDisp_b__151_3__, 0LL);
      v34 = SummonInfoControl___c_TypeInfo->static_fields;
      v34->__9__151_3 = (struct System_Func_char__string__o *)_9__151_3;
      sub_1B88554((ServantStatusBattleListViewItem_o *)&v34->__9__151_3, (int32_t)_9__151_3, v35, v36);
    }
    ...
    if ( UnityEngine_Object__op_Inequality(bonusCount, 0LL, 0LL) )
    {
      ...
      if ( UnityEngine_GameObject__get_activeSelf((UnityEngine_GameObject_o *)this, 0LL) )
      {
        ...
        GameObjectExtensions__SetLocalPositionX(v39, 42.0, 0LL);
        this = (SummonInfoControl_o *)summonObjParts->fields.bonusCount;
        if ( !this )
          goto LABEL_131;
        v40 = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
        GameObjectExtensions__SetLocalPositionY(v40, -34.0, 0LL);
        this = (SummonInfoControl_o *)summonObjParts->fields.bonusCount;
        if ( !this )
          goto LABEL_131;
        v41 = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
        GameObjectExtensions__SetLocalScaleX(v41, 0.9, 0LL);
      }
    }
    ...
    if ( ((unsigned __int8)this & 1) != 0 )
    {
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        ...
        GameObjectExtensions__SetLocalPositionX(v43, -60.0, 0LL);
        this = (SummonInfoControl_o *)summonObjParts->fields.bonusInfo;
        if ( !this )
          goto LABEL_131;
        v44 = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
        GameObjectExtensions__SetLocalScaleX(v44, 0.9, 0LL);
      }
    }
  }
  if ( !v21 || (m_CancellationTokenSource = v21->fields.m_CancellationTokenSource) == 0LL )
  {
    if ( !summonObjParts )
      goto LABEL_131;
    goto LABEL_71;
  ...
  if ( (_DWORD)m_CancellationTokenSource != 1 )
  {
    ...
    this = (SummonInfoControl_o *)SummonInfoControl__GetBonusSprite(
                                    ...
                                    (System_String_o *)StringLiteral_22181/*"num2"*/,
                                    v65);
    if ( !v63 )
      goto LABEL_131;
    v66 = (UnityEngine_Component_o *)this;
    v67 = (SummonInfoControl_o *)UnityEngine_Component__get_gameObject(v63, 0LL);
    this = (SummonInfoControl_o *)SummonInfoControl__GetBonusSprite(
                                    v67,
    ...
    if ( !v66 )
      goto LABEL_131;
    v69 = (UISprite_o *)this;
    v70 = (SummonInfoControl_o *)UnityEngine_Component__get_gameObject(v66, 0LL);
    this = (SummonInfoControl_o *)SummonInfoControl__GetBonusSprite(
                                    v70,
                                    (UnityEngine_GameObject_o *)v70,
                                    (System_String_o *)StringLiteral_22182/*"num2_glow"*/,
                                    v71);
    if ( !summonObjParts->fields.doubleDigits )
      goto LABEL_131;
    ...
    BonusSprite = SummonInfoControl__GetBonusSprite(
                    ...
                    (System_String_o *)StringLiteral_8103/*"Item"*/,
                    v73);
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    ...
    if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)v63, 0LL, 0LL) )
    {
      ...
      if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)v66, 0LL, 0LL) )
      {
        ...
        if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)v69, 0LL, 0LL) )
        {
          if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
          v55 = UnityEngine_Object__op_Inequality(v51, 0LL, 0LL);
          if ( v55 )
          {
            if ( LODWORD(v21->fields.m_CancellationTokenSource) )
            {
              v75 = System_String__Format(
                      ...
                      0LL);
              UISprite__set_spriteName((UISprite_o *)v63, v75, 0LL);
              if ( LODWORD(v21->fields.m_CancellationTokenSource) > 1 )
              {
                v76 = System_String__Format(
                        ...
                        0LL);
                UISprite__set_spriteName((UISprite_o *)v66, v76, 0LL);
                if ( LODWORD(v21->fields.m_CancellationTokenSource) )
                {
                  ...
                  if ( !v69 )
                    goto LABEL_131;
                  UISprite__set_spriteName(v69, (System_String_o *)this, 0LL);
                  if ( LODWORD(v21->fields.m_CancellationTokenSource) > 1 )
                  {
                    friendPointSummon = (Il2CppObject *)v21->fields.friendPointSummon;
                    v58 = (System_String_o *)StringLiteral_17563/*"btn_txt_bonus_{0}_glow"*/;
                    goto LABEL_68;
                  }
                }
              }
...
LABEL_132:
            sub_1B88814(v55, summonObjParts);
          }
        }
      }
    }
LABEL_71:
  ...
  if ( !this )
    goto LABEL_131;
  v46 = (SummonInfoControl_o *)UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  this = (SummonInfoControl_o *)SummonInfoControl__GetBonusSprite(
                                  v46,
  ...
  v49 = (SummonInfoControl_o *)UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  this = (SummonInfoControl_o *)SummonInfoControl__GetBonusSprite(
                                  v49,
  ...
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetItem(v54, 7, 0LL);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  ...
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  v55 = UnityEngine_Object__op_Inequality(v48, 0LL, 0LL);
  if ( !v55 )
    goto LABEL_71;
  if ( !LODWORD(v21->fields.m_CancellationTokenSource) )
    goto LABEL_132;
  v56 = System_String__Format((System_String_o *)StringLiteral_17562/*"btn_txt_bonus_{0}"*/, (Il2CppObject *)v21->fields.freeSummon, 0LL);
  UISprite__set_spriteName((UISprite_o *)v48, v56, 0LL);
  if ( !LODWORD(v21->fields.m_CancellationTokenSource) )
    goto LABEL_132;
  friendPointSummon = (Il2CppObject *)v21->fields.freeSummon;
  v58 = (System_String_o *)StringLiteral_17563/*"btn_txt_bonus_{0}_glow"*/;
LABEL_68:
  this = (SummonInfoControl_o *)System_String__Format(v58, friendPointSummon, 0LL);
  if ( !v51 )
    goto LABEL_131;
  UISprite__set_spriteName((UISprite_o *)v51, (System_String_o *)this, 0LL);
  v59 = 1;
LABEL_72:
  this = (SummonInfoControl_o *)summonObjParts->fields.singleDigit;
  if ( !this )
...
LABEL_131:
    sub_1B8880C(this, summonObjParts);
  }
  if ( !v21 )
    goto LABEL_131;
  if ( !this )
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.shopId1GiftNum = 0LL;
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.currentSummonData, (int32_t)gachaData, v6, v7);
  SummonInfoControl__SetSummonGiftInfo(this, v8);
  SummonInfoControl__SetSummonDispInfo(this, v9);
}


void __fastcall SummonInfoControl__SetSummonInfo_33167168(SummonInfoControl_o *this, const MethodInfo *method)
{
  Il2CppObject *Master_object; // x0
  __int64 v4; // x1
  struct VaildGachaInfo_o *currentSummonData; // x8
  ...
  if ( (byte_4A57A2C & 1) == 0 )
  {
    ...
    sub_1B885B0(&SummonInfoControl_SummonInfo_TypeInfo);
    byte_4A57A2C = 1;
  }
  entity = 0LL;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
  ...
  if ( SHIDWORD(entity[3].klass) >= 1 )
  {
    ...
    v8 = sub_1B887FC(SummonInfoControl_SummonInfo_TypeInfo);
...
LABEL_15:
      sub_1B8880C(possessionInfoButton, method);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57A26 & 1) == 0 )
  {
    sub_1B885B0(&int_TypeInfo);
    sub_1B885B0(&StringLiteral_24983/*"{0}"*/);
    this = (SummonInfoControl_o *)sub_1B885B0(&StringLiteral_17624/*"btn_txt_summon{0:00}"*/);
    byte_4A57A26 = 1;
  }
  if ( !v4 )
    goto LABEL_21;
  if ( v4->fields.shopId1 >= 1 && v4->fields.shopId2 > 0 )
  {
    ...
    if ( stoneSummon )
    {
      ...
      if ( onePay )
      {
        SummonInfoControl__SetPriceText(v5, onePay->fields.infoLabel, -1, (System_String_o *)StringLiteral_24983/*"{0}"*/, v6);
...
LABEL_21:
    sub_1B8880C(this, payGachaEnt);
  }
  SummonInfoControl__SetCurrentSummonInfo(v5, v5->fields.stoneSummon, 1, v3);
  SummonInfoControl__SetSummonInfo_33167168(v5, v19);
  gachaTime = v5->fields.gachaTime;
  v24 = (System_String_o *)StringLiteral_17624/*"btn_txt_summon{0:00}"*/;
  if ( gachaTime >= 11 )
    gachaTime = 11;
  v31 = gachaTime;
  ...
  if ( !v30 )
    goto LABEL_21;
  SummonInfoControl__SetPriceText(v5, v30->fields.infoLabel, -1, (System_String_o *)StringLiteral_24983/*"{0}"*/, v28);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !onePay )
    goto LABEL_12;
  SummonInfoControl__SetPriceText(this, onePay->fields.needLabel, 1, (System_String_o *)StringLiteral_24983/*"{0}"*/, v9);
  ...
  if ( !v14
    ...
    || (infoLabel = multiPay->fields.infoLabel,
        ...
        SummonInfoControl__SetPriceText(this, infoLabel, PayMultiTimePrice, (System_String_o *)StringLiteral_24983/*"{0}"*/, v19),
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)servantEquipSum = 0LL;
  ...
  if ( !v14
    ...
    || (SummonInfoControl__SetPriceText(this, single->fields.infoLabel, -1, (System_String_o *)StringLiteral_24983/*"{0}"*/, v15),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57A1B & 1) == 0 )
  {
    this = (SummonInfoControl_o *)sub_1B885B0(&Method_DataMasterBase_GachaMaster__GachaEntity__int__GetEntity__);
    byte_4A57A1B = 1;
  }
  ...
  else
  {
    if ( !v8 )
    {
      if ( LOBYTE(this[1].fields.method_ptr) )
      {
        ...
        {
          if ( (v12 & 1) != 0 )
            v9 = (Il2CppObject *)sub_19CAC2C;
          else
            v9 = (Il2CppObject *)sub_19CABF0;
        }
        else if ( (v12 & 1) != 0 )
        {
          v9 = (Il2CppObject *)sub_19CAB6C;
        }
        else
        {
          v9 = (Il2CppObject *)sub_19CAB40;
        }
      }
      else
      {
        v9 = (Il2CppObject *)sub_19CAB10;
      }
      goto LABEL_16;
    }
    if ( !object )
...
LABEL_17:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19CAAC8;
}
        ...
        const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.Top.fields.x = xmmword_BB4190;
...
void __fastcall SummonInfoControl___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1B887FC(SummonInfoControl___c_TypeInfo);
  System_Object___ctor(v1, 0LL);
  SummonInfoControl___c_TypeInfo->static_fields->__9 = (struct SummonInfoControl___c_o *)v1;
  sub_1B88554((ServantStatusBattleListViewItem_o *)SummonInfoControl___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57A3D & 1) == 0 )
  {
    this = (SummonInfoControl___c_o *)sub_1B885B0(&UnityEngine_Object_TypeInfo);
    byte_4A57A3D = 1;
  }
  if ( !x )
    goto LABEL_15;
