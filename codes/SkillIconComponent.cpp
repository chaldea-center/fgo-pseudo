...
void SkillIconComponent__AdjustUI(SkillIconComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(strengthStatusSprite, 0, 0) )
  {
    ...
    GameObjectExtensions__SetLocalPosition_36798812(gameObject, 21.0, -21.0, 0);
    v5 = (UnityEngine_Component_o *)this->fields.strengthStatusSprite;
    if ( !v5 )
      goto LABEL_36;
    v7 = UnityEngine_Component__get_gameObject(v5, 0);
    GameObjectExtensions__SetLocalScale_36800880(v7, 1.0, 1.0, 0);
    v5 = (UnityEngine_Component_o *)this->fields.strengthStatusSprite;
    if ( !v5 )
      goto LABEL_36;
...
LABEL_33:
    sub_1C942F0(skillIconSprite, method);
  }
}
...
void SkillIconComponent__Set(SkillIconComponent_o *this, int32_t skillId, const MethodInfo *method)
{
  ...
  SkillIconComponent__Set_41862196(this, skillId, 0, 0, 0, v3);
}
      ...
      if ( gameObject )
      {
        ...
        if ( this->fields.strengthStatusSprite )
        {
          ...
          if ( gameObject )
          {
            ...
            gameObject = BaseMonoBehaviour__createObject_41943128((BaseMonoBehaviour_o *)this, v13, parent, 0, 0);
            if ( gameObject )
            {
...
// local variable allocation has failed, the output may be wrong!
void SkillIconComponent__Set_41862196(
        SkillIconComponent_o *this,
        int32_t skillId,
        int32_t skillLv,
        int32_t strengthStatus,
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(iconLabel, 0, 0) )
  {
    ...
    if ( skillLv < 1 )
      ...
      UIIconLabel__Set_41867060((UIIconLabel_o *)gameObject, 2, skillLv, 0, 0, 0, 0, 0, 0, 0, 0);
  }
  strengthStatusSprite = (UnityEngine_Object_o *)this->fields.strengthStatusSprite;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  if ( UnityEngine_Object__op_Inequality(strengthStatusSprite, 0, 0) )
  {
    ...
    if ( !gameObject
      || (parent = UnityEngine_Transform__get_parent((UnityEngine_Transform_o *)gameObject, 0),
          (gameObject = (UISprite_o *)BaseMonoBehaviour__createObject_41943128(
...
void SkillIconComponent__Set_41863008(
        SkillIconComponent_o *this,
        int32_t skillId,
        int32_t skillLv,
        const MethodInfo *method)
{
  ...
  SkillIconComponent__Set_41862196(this, skillId, skillLv, 0, 0, v4);
}


void SkillIconComponent__Set_41863020(
        SkillIconComponent_o *this,
        int32_t skillId,
        int32_t skillLv,
        ...
        const MethodInfo *method)
{
  ...
  SkillIconComponent__Set_41863036(this, skillId, skillLv, 0, 0, info, v5);
}


// local variable allocation has failed, the output may be wrong!
void SkillIconComponent__Set_41863036(
        SkillIconComponent_o *this,
        int32_t skillId,
        int32_t skillLv,
        int32_t strengthStatus,
