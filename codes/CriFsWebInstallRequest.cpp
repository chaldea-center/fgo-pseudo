        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E70855 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&CriFsWebInstaller_TypeInfo);
    byte_4E70855 = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0);
  this->fields.guid = System_Guid__NewGuid(0);
  this->fields._sourcePath_k__BackingField = srcPath;
  sub_1D0F058(&this->fields._sourcePath_k__BackingField, srcPath);
  this->fields._destinationPath_k__BackingField = dstPath;
  sub_1D0F058(&this->fields._destinationPath_k__BackingField, dstPath);
  ...
  v9 = (CriFsWebInstaller_o *)sub_1D0F300(CriFsWebInstaller_TypeInfo);
  CriFsWebInstaller___ctor(v9, v10);
  this->fields.installer = v9;
  sub_1D0F058(&this->fields.installer, v9);
...
void CriFsWebInstallRequest__Update(CriFsWebInstallRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E70856 & 1) == 0 )
  {
    sub_1D0F0B4(&CriFsWebInstaller_Error_TypeInfo);
    sub_1D0F0B4(&StringLiteral_16117/*"[CriFsWebInstallerError]"*/);
    byte_4E70856 = 1;
  }
  p_installer = &this->fields.installer;
  installer = this->fields.installer;
    ...
    if ( status != 1 )
    {
      if ( status == 3 )
      {
        ...
        *(_QWORD *)&v14.fields.httpStatusCode = -1;
        ...
        v12 = System_String__Concat_65562772((System_String_o *)StringLiteral_16117/*"[CriFsWebInstallerError]"*/, v11, 0);
        this->fields._error_k__BackingField = v12;
        StatusInfo = sub_1D0F058(&this->fields._error_k__BackingField, v12);
      }
      if ( !byte_4E70B72 )
      {
        StatusInfo = sub_1D0F0B4(&CriFsWebInstaller_TypeInfo);
        byte_4E70B72 = 1;
      }
      ...
      if ( *p_installer )
      {
        ...
        sub_1D0F058(&this->fields.installer, 0);
