        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC08C5 & 1) == 0 )
  {
    ...
    sub_1C713B0(&CriFsWebInstaller_TypeInfo);
    byte_4CC08C5 = 1;
  }
  ...
  v9 = (CriFsWebInstaller_o *)sub_1C715FC(CriFsWebInstaller_TypeInfo);
  CriFsWebInstaller___ctor(v9, v10);
  this->fields.installer = v9;
  sub_1C71354(&this->fields.installer, v9);
...
void CriFsWebInstallRequest__Update(CriFsWebInstallRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC08C6 & 1) == 0 )
  {
    sub_1C713B0(&CriFsWebInstaller_Error_TypeInfo);
    sub_1C713B0(&StringLiteral_15914/*"[CriFsWebInstallerError]"*/);
    byte_4CC08C6 = 1;
  }
  p_installer = &this->fields.installer;
  installer = this->fields.installer;
    ...
    if ( status != 1 )
    {
      if ( status == 3 )
      {
        ...
        *(_QWORD *)&v14.fields.httpStatusCode = -1;
        ...
        v12 = System_String__Concat_64031724((System_String_o *)StringLiteral_15914/*"[CriFsWebInstallerError]"*/, v11, 0);
        this->fields._error_k__BackingField = v12;
        StatusInfo = sub_1C71354(&this->fields._error_k__BackingField, v12);
      }
      if ( !byte_4CC0BE2 )
      {
        StatusInfo = sub_1C713B0(&CriFsWebInstaller_TypeInfo);
        byte_4CC0BE2 = 1;
      }
