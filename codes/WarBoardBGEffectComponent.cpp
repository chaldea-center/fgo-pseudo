        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6450B & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_16762/*"_loop"*/, v4);
    sub_1BE4ACC(&StringLiteral_16747/*"_end"*/, v5);
    byte_4B6450B = 1;
  }
  simpleAnimationComponent = (UnityEngine_Object_o *)this->fields.simpleAnimationComponent;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
...
LABEL_42:
      ...
      v16 = System_String__Concat_62698808(this->fields.animationName, (System_String_o *)StringLiteral_16762/*"_loop"*/, 0LL);
      if ( v15 )
      {
...
LABEL_35:
        ...
        {
LABEL_39:
          p_method = sub_1C36AAC(Item, SimpleAnimation_State_TypeInfo, 9LL);
        }
    ...
    else
    {
      ...
      v16 = System_String__Concat_62698808(this->fields.animationName, (System_String_o *)StringLiteral_16747/*"_end"*/, 0LL);
      if ( v20 )
      {
        ...
        {
LABEL_22:
          v25 = sub_1C36AAC(v16, SimpleAnimation_State_TypeInfo, 9LL);
        }
...
LABEL_45:
  ...
  v17 = 0LL;
LABEL_43:
  sub_1BE4A70((PartyOrganizationUtility_o *)p_requestAnimation, (int64_t)v17, v8, v9, v10, v11, v12, v13);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B64509 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_UnityEngine_GameObject_GetComponent_WarBoardBGEffectComponent___, eventStr);
    sub_1BE4ACC(&UnityEngine_Object_TypeInfo, v5);
    this = (WarBoardBGEffectComponent_o *)sub_1BE4ACC(&StringLiteral_24418/*"true"*/, v6);
    byte_4B64509 = 1;
  }
    ...
    if ( SLODWORD(this->fields.m_CancellationTokenSource) >= 3 )
    {
      ...
      v9 = System_String__op_Equality(
             *(System_String_o **)&this->fields.totaltime,
             (System_String_o *)StringLiteral_24418/*"true"*/,
             0LL);
...
void __fastcall WarBoardBGEffectComponent__PauseAnimation(WarBoardBGEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(simpleAnimationComponent, 0LL, 0LL) )
  {
    ...
    if ( !v5 )
      sub_1BE4D28(0LL, v4);
    SimpleAnimation__Stop_64834608(v5, this->fields.currentAnimationName, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6450A & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_16783/*"_start"*/, v8);
  ...
  if ( UnityEngine_Object__op_Inequality(simpleAnimationComponent, 0LL, 0LL) )
  {
    ...
    v20 = this->fields.simpleAnimationComponent;
    v19 = (SimpleAnimation_o *)System_String__Concat_62698808(v5, (System_String_o *)StringLiteral_16783/*"_start"*/, 0LL);
    if ( !v20 )
LABEL_37:
      sub_1BE4D28(v19, v11);
...
LABEL_26:
        ...
        {
LABEL_30:
          v39 = sub_1C36AAC(v23, SimpleAnimation_State_TypeInfo, 9LL);
        }
...
LABEL_24:
    p_method = sub_1C36AAC(v23, v25, 13LL);
    goto LABEL_26;
  }
...
LABEL_35:
  sub_1BE4A70((PartyOrganizationUtility_o *)p_animationName, (int64_t)v5, v12, v13, v14, v15, v16, v17);
  this->fields.totaltime = 0.0;
  this->fields.loop = 1;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B64508 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_16762/*"_loop"*/, v7);
  ...
  {
    this->fields.status = 4;
    State = System_String__Concat_62698808(animName, (System_String_o *)StringLiteral_16762/*"_loop"*/, 0LL);
    ...
    *(float *)&v3 = this->fields.totaltime;
    ...
    {
LABEL_16:
      v19 = sub_1C36AAC(State, SimpleAnimation_State_TypeInfo, 4LL);
    }
    (*(void (__fastcall **)(System_String_o *, _QWORD, long double))v19)(v16, *(_QWORD *)(v19 + 8), v3);
    State = (System_String_o *)this->fields.simpleAnimationComponent;
    if ( !State )
LABEL_21:
      sub_1BE4D28(State, v11);
    SimpleAnimation__Play_64837092((SimpleAnimation_o *)State, currentAnimationName, 0LL);
...
void __fastcall WarBoardBGEffectComponent__Stop(WarBoardBGEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(simpleAnimationComponent, 0LL, 0LL) )
  {
    ...
    if ( Item )
    {
      ...
      {
LABEL_12:
        p_method = sub_1C36AAC(Item, SimpleAnimation_State_TypeInfo, 18LL);
      }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B64505 & 1) == 0 )
  {
    sub_1BE4ACC(&UnityEngine_Object_TypeInfo, playAfterCurrentAnim);
    byte_4B64505 = 1;
  }
  this->fields.status = 5;
  this->fields.loop = 0;
...
void __fastcall WarBoardBGEffectComponent__Update(WarBoardBGEffectComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BE4ACC(&UnityEngine_Object_TypeInfo, method);
    sub_1BE4ACC(&SimpleAnimation_State_TypeInfo, v4);
  ...
  if ( (status | 2) != 2 )
  {
    ...
    if ( !this->fields.requestAnimation )
    {
      ...
      if ( UnityEngine_Object__op_Inequality(simpleAnimationComponent, 0LL, 0LL) && this->fields.playAnimation )
      {
        ...
        if ( this->fields.status == 5 )
        {
          ...
          sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.playAnimation, 0LL, v12, v13, v14, v15, v16, v17);
        }
      }
    ...
    if ( !System_String__op_Inequality(*p_requestAnimation, (System_String_o *)StringLiteral_1/*""*/, 0LL) )
    {
      ...
      v38 = 0LL;
LABEL_40:
      sub_1BE4A70((PartyOrganizationUtility_o *)p_playAnimation, (int64_t)v38, v19, v20, v21, v22, v23, v24);
      goto LABEL_41;
    }
...
LABEL_41:
        ...
        *p_requestAnimation = 0LL;
        sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.requestAnimation, 0LL, v26, v27, v28, v29, v30, v31);
        return;
      }
      State = this->fields.simpleAnimationComponent;
      if ( State )
      {
        ...
        if ( State )
        {
          ...
          *(float *)&v2 = this->fields.totaltime;
          ...
          {
LABEL_34:
            v36 = sub_1C36AAC(State, SimpleAnimation_State_TypeInfo, 4LL);
          }
          (*(void (__fastcall **)(SimpleAnimation_o *, _QWORD, long double))v36)(v33, *(_QWORD *)(v36 + 8), v2);
          State = this->fields.simpleAnimationComponent;
          if ( State )
          {
            SimpleAnimation__Rewind_64839352(State, this->fields.requestAnimation, 0LL);
            State = this->fields.simpleAnimationComponent;
            if ( State )
            {
              SimpleAnimation__Play_64837092(State, this->fields.requestAnimation, 0LL);
