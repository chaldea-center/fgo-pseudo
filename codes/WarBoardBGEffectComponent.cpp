...
LABEL_42:
      ...
      v13 = System_String__Concat_64425724(this->fields.animationName, (System_String_o *)StringLiteral_16667/*"_loop"*/, 0);
      if ( v12 )
      {
...
LABEL_35:
        ...
        {
LABEL_39:
          v31 = sub_1C69E5C(Item, SimpleAnimation_State_TypeInfo, 9);
        }
    ...
    else
    {
      ...
      v13 = System_String__Concat_64425724(this->fields.animationName, (System_String_o *)StringLiteral_16651/*"_end"*/, 0);
      if ( v17 )
      {
        ...
        {
LABEL_22:
          v22 = sub_1C69E5C(v13, SimpleAnimation_State_TypeInfo, 9);
        }
...
LABEL_45:
  ...
  LODWORD(v14) = 0;
LABEL_43:
  sub_1C93A78((GrandQuestFolderBoardItem_o *)p_requestAnimation, (int32_t)v14, v5, v6, v7, v8, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2E16B & 1) == 0 )
  {
    ...
    sub_1C93AD4(&UnityEngine_Object_TypeInfo);
    this = (WarBoardBGEffectComponent_o *)sub_1C93AD4(&StringLiteral_24523/*"true"*/);
    byte_4D2E16B = 1;
  }
    ...
    if ( SLODWORD(this->fields.m_CancellationTokenSource) >= 3 )
    {
      ...
      v7 = System_String__op_Equality(
             *(System_String_o **)&this->fields.totaltime,
             (System_String_o *)StringLiteral_24523/*"true"*/,
             0);
...
void WarBoardBGEffectComponent__PauseAnimation(WarBoardBGEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(simpleAnimationComponent, 0, 0) )
  {
    ...
    if ( !v5 )
      sub_1C93D2C(0, v4);
    SimpleAnimation__Stop_67368280(v5, this->fields.currentAnimationName, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(simpleAnimationComponent, 0, 0) )
  {
    ...
    v17 = this->fields.simpleAnimationComponent;
    v16 = (SimpleAnimation_o *)System_String__Concat_64425724(animName, (System_String_o *)StringLiteral_16686/*"_start"*/, 0);
    if ( !v17 )
LABEL_37:
      sub_1C93D2C(v16, v8);
...
LABEL_26:
        ...
        {
LABEL_30:
          v36 = sub_1C69E5C(v20, SimpleAnimation_State_TypeInfo, 9);
        }
...
LABEL_35:
  sub_1C93A78((GrandQuestFolderBoardItem_o *)p_animationName, (int32_t)animName, v9, v10, v11, v12, v13, v14);
  this->fields.totaltime = 0.0;
  this->fields.loop = 1;
        ...
        const MethodInfo *method)
{
  ...
  {
    this->fields.status = 4;
    State = System_String__Concat_64425724(animName, (System_String_o *)StringLiteral_16667/*"_loop"*/, 0);
    ...
    *(float *)&v3 = this->fields.totaltime;
    ...
    {
LABEL_16:
      v16 = sub_1C69E5C(State, SimpleAnimation_State_TypeInfo, 4);
    }
    (*(void (__fastcall **)(System_String_o *, _QWORD, long double))v16)(v13, *(_QWORD *)(v16 + 8), v3);
    State = (System_String_o *)this->fields.simpleAnimationComponent;
    if ( !State )
LABEL_21:
      sub_1C93D2C(State, v8);
    SimpleAnimation__Play_67370764((SimpleAnimation_o *)State, currentAnimationName, 0);
...
void WarBoardBGEffectComponent__Stop(WarBoardBGEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(simpleAnimationComponent, 0, 0) )
  {
    ...
    if ( Item )
    {
      ...
      {
LABEL_12:
        v11 = sub_1C69E5C(Item, SimpleAnimation_State_TypeInfo, 18);
      }
...
void WarBoardBGEffectComponent__Update(WarBoardBGEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (status | 2) != 2 )
  {
    ...
    if ( !this->fields.requestAnimation )
    {
      ...
      if ( UnityEngine_Object__op_Inequality(simpleAnimationComponent, 0, 0) && this->fields.playAnimation )
      {
        ...
        if ( this->fields.status == 5 )
        {
          ...
          sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.playAnimation, 0, v10, v11, v12, v13, v14, v15);
        }
      }
    ...
    if ( !System_String__op_Inequality(*p_requestAnimation, (System_String_o *)StringLiteral_1/*""*/, 0) )
    {
      ...
      LODWORD(v36) = 0;
LABEL_40:
      sub_1C93A78((GrandQuestFolderBoardItem_o *)p_playAnimation, (int32_t)v36, v17, v18, v19, v20, v21, v22);
      goto LABEL_41;
    }
...
LABEL_41:
        ...
        *p_requestAnimation = 0;
        sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.requestAnimation, 0, v24, v25, v26, v27, v28, v29);
        return;
      }
      State = this->fields.simpleAnimationComponent;
      if ( State )
      {
        ...
        if ( State )
        {
          ...
          *(float *)&v2 = this->fields.totaltime;
          ...
          {
LABEL_34:
            v34 = sub_1C69E5C(State, SimpleAnimation_State_TypeInfo, 4);
          }
          (*(void (__fastcall **)(SimpleAnimation_o *, _QWORD, long double))v34)(v31, *(_QWORD *)(v34 + 8), v2);
          State = this->fields.simpleAnimationComponent;
          if ( State )
          {
            SimpleAnimation__Rewind_67373088(State, this->fields.requestAnimation, 0);
            State = this->fields.simpleAnimationComponent;
            if ( State )
            {
              SimpleAnimation__Play_67370764(State, this->fields.requestAnimation, 0);
