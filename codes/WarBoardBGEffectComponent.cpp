...
void __fastcall WarBoardBGEffectComponent__Awake(WarBoardBGEffectComponent_o *this, const MethodInfo *method)
{
  ...
  v8 = (UnityEngine_Object_o *)UnityEngine_Object__op_Inequality(simpleAnimationComponent, 0LL, 0LL);
  if ( ((unsigned __int8)v8 & 1) != 0 )
  {
    ...
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    v8 = (UnityEngine_Object_o *)UnityEngine_Object__op_Inequality(monitor, 0LL, 0LL);
    if ( ((unsigned __int8)v8 & 1) != 0 )
    {
      if ( *p_simpleAnimationComponent )
      {
        v8 = (UnityEngine_Object_o *)(*p_simpleAnimationComponent)[1].monitor;
        if ( v8 )
        {
          name = UnityEngine_Object__get_name(v8, 0LL);
          this->fields.currentAnimationName = name;
          sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.currentAnimationName, (int32_t)name, v12, v13);
          return;
        }
      }
LABEL_14:
...
LABEL_42:
      ...
      v9 = System_String__Concat_61707032(this->fields.animationName, (System_String_o *)StringLiteral_16552/*"_loop"*/, 0LL);
      if ( v8 )
      {
        Item = SimpleAnimation__get_Item(v8, v9, 0LL);
        if ( !Item )
          goto LABEL_10;
LABEL_35:
        klass = Item->klass;
...
LABEL_39:
        ...
        v9 = (System_String_o *)(*(__int64 (__fastcall **)(SimpleAnimation_State_o *, _QWORD))p_method)(
                                  Item,
                                  *(_QWORD *)(p_method + 8));
        v10 = v9;
        if ( this )
    ...
    else
    {
      ...
      v9 = System_String__Concat_61707032(this->fields.animationName, (System_String_o *)StringLiteral_16537/*"_end"*/, 0LL);
      if ( v13 )
      {
        v9 = (System_String_o *)SimpleAnimation__get_Item(v13, v9, 0LL);
        ...
        if ( *(_WORD *)(&v9->klass->_2.bitflags2 + 3) )
        {
          ...
          v18 = (__int64)(&v14->vtable._9_GetTypeCode.method + 2 * *(_DWORD *)v17);
        }
        else
        {
LABEL_22:
          v18 = sub_1BDA590(v9, SimpleAnimation_State_TypeInfo, 9LL);
        }
        v19 = (System_String_o *)(*(__int64 (__fastcall **)(SimpleAnimation_State_o *, _QWORD))v18)(
                                   Item,
                                   *(_QWORD *)(v18 + 8));
        v9 = (System_String_o *)System_String__op_Equality(currentAnimationName, v19, 0LL);
...
LABEL_26:
          ...
          if ( !v20 )
            goto LABEL_45;
          monitor = (UnityEngine_Object_o *)v20[1].monitor;
          if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
          v9 = (System_String_o *)UnityEngine_Object__op_Inequality(monitor, 0LL, 0LL);
          if ( ((unsigned __int8)v9 & 1) != 0 )
          {
            v22 = this->fields.simpleAnimationComponent;
            if ( !v22 )
              goto LABEL_45;
            v9 = (System_String_o *)v22[1].monitor;
            if ( !v9 )
              goto LABEL_45;
            name = UnityEngine_Object__get_name((UnityEngine_Object_o *)v9, 0LL);
            v9 = (System_String_o *)SimpleAnimation__get_Item(v22, name, 0LL);
            Item = (SimpleAnimation_State_o *)v9;
...
LABEL_45:
  ...
  LODWORD(v10) = 0;
LABEL_43:
  sub_1B88554((ServantStatusBattleListViewItem_o *)p_requestAnimation, (int32_t)v10, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A58C1B & 1) == 0 )
  {
    ...
    sub_1B885B0(&UnityEngine_Object_TypeInfo);
    this = (WarBoardBGEffectComponent_o *)sub_1B885B0(&StringLiteral_24079/*"true"*/);
    byte_4A58C1B = 1;
  }
    ...
    if ( SLODWORD(this->fields.m_CancellationTokenSource) >= 3 )
    {
      ...
      v7 = System_String__op_Equality(
             *(System_String_o **)&this->fields.totaltime,
             (System_String_o *)StringLiteral_24079/*"true"*/,
             0LL);
...
void __fastcall WarBoardBGEffectComponent__PauseAnimation(WarBoardBGEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(simpleAnimationComponent, 0LL, 0LL) )
  {
    ...
    if ( !v5 )
      sub_1B8880C(0LL, v4);
    SimpleAnimation__Stop_63842220(v5, this->fields.currentAnimationName, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(simpleAnimationComponent, 0LL, 0LL) )
  {
    ...
    v13 = this->fields.simpleAnimationComponent;
    v12 = (SimpleAnimation_o *)System_String__Concat_61707032(animName, (System_String_o *)StringLiteral_16573/*"_start"*/, 0LL);
    if ( !v13 )
LABEL_37:
      sub_1B8880C(v12, v8);
    Item = SimpleAnimation__get_Item(v13, (System_String_o *)v12, 0LL);
    if ( Item )
    {
      klass = Item->klass;
      v16 = Item;
...
LABEL_26:
        this->fields.endtime = (*(float (__fastcall **)(SimpleAnimation_State_o *, _QWORD))p_method)(
                                 ...
                                 *(_QWORD *)(p_method + 8));
        v25 = v16->klass;
        v26 = *(unsigned __int16 *)(&v16->klass->_2.bitflags2 + 3);
        if ( *(_WORD *)(&v16->klass->_2.bitflags2 + 3) )
        {
          ...
          v28 = (__int64)&v25->vtable[*(_DWORD *)v27 + 9].method;
        }
        else
        {
LABEL_30:
          v28 = sub_1BDA590(v16, SimpleAnimation_State_TypeInfo, 9LL);
        }
...
LABEL_34:
          ...
          sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.requestAnimation, (int32_t)v29, v21, v22);
    ...
    else
    {
      ...
      if ( !v12 )
        goto LABEL_37;
      v20 = SimpleAnimation__get_Item(v12, animName, 0LL);
      if ( !v20 )
      {
...
LABEL_24:
    p_method = sub_1BDA590(v16, v18, 13LL);
    goto LABEL_26;
  }
  LODWORD(animName) = (_DWORD)StringLiteral_1/*""*/;
  this->fields.requestAnimation = (struct System_String_o *)StringLiteral_1/*""*/;
  p_animationName = &this->fields.requestAnimation;
LABEL_35:
  sub_1B88554((ServantStatusBattleListViewItem_o *)p_animationName, (int32_t)animName, v9, v10);
  this->fields.totaltime = 0.0;
  this->fields.loop = 1;
        ...
        const MethodInfo *method)
{
  ...
  {
    this->fields.status = 4;
    State = System_String__Concat_61707032(animName, (System_String_o *)StringLiteral_16552/*"_loop"*/, 0LL);
    ...
    *(float *)&v3 = this->fields.totaltime;
    ...
    {
LABEL_16:
      v16 = sub_1BDA590(State, SimpleAnimation_State_TypeInfo, 4LL);
    }
    (*(void (__fastcall **)(System_String_o *, _QWORD, long double))v16)(v13, *(_QWORD *)(v16 + 8), v3);
    State = (System_String_o *)this->fields.simpleAnimationComponent;
    if ( !State )
LABEL_21:
      sub_1B8880C(State, v8);
    SimpleAnimation__Play_63844704((SimpleAnimation_o *)State, currentAnimationName, 0LL);
...
void __fastcall WarBoardBGEffectComponent__Update(WarBoardBGEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (status | 2) != 2 )
  {
    ...
    if ( !this->fields.requestAnimation )
    {
      ...
      if ( UnityEngine_Object__op_Inequality(simpleAnimationComponent, 0LL, 0LL) && this->fields.playAnimation )
      {
        ...
        if ( this->fields.status == 5 )
        {
          ...
          sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.playAnimation, 0, v10, v11);
        }
      }
    ...
    if ( !System_String__op_Inequality(*p_requestAnimation, (System_String_o *)StringLiteral_1/*""*/, 0LL) )
    {
      ...
      LODWORD(v24) = 0;
LABEL_40:
      sub_1B88554((ServantStatusBattleListViewItem_o *)p_playAnimation, (int32_t)v24, v13, v14);
      goto LABEL_41;
    }
...
LABEL_41:
        ...
        *p_requestAnimation = 0LL;
        sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.requestAnimation, 0, v16, v17);
        return;
      }
      State = this->fields.simpleAnimationComponent;
      if ( State )
        ...
        if ( State )
        {
          ...
          *(float *)&v2 = this->fields.totaltime;
          ...
          if ( *(_WORD *)(&State->klass->_2.bitflags2 + 3) )
          {
            ...
            v22 = (__int64)(&klass->vtable._4_OnEnable.method + 2 * *(_DWORD *)p_offset);
          }
          else
          {
LABEL_34:
            v22 = sub_1BDA590(State, SimpleAnimation_State_TypeInfo, 4LL);
          }
          (*(void (__fastcall **)(SimpleAnimation_o *, _QWORD, long double))v22)(v19, *(_QWORD *)(v22 + 8), v2);
          State = this->fields.simpleAnimationComponent;
          if ( State )
          {
            SimpleAnimation__Rewind_63846964(State, this->fields.requestAnimation, 0LL);
            State = this->fields.simpleAnimationComponent;
            if ( State )
            {
              SimpleAnimation__Play_63844704(State, this->fields.requestAnimation, 0LL);
