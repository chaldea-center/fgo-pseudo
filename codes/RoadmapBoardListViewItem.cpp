        ...
        const MethodInfo *method)
{
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&v13->fields._Atlas_k__BackingField, (int32_t)atlas, v14, v15);
  v13->fields._SpriteName_k__BackingField = spriteName;
  v13 = (RoadmapBoardListViewItem_o *)((char *)v13 + 136);
  sub_1B6406C((ServantStatusBattleListViewItem_o *)v13, (int32_t)spriteName, v16, v17);
  LOBYTE(v13->monitor) = 0;
}


void __fastcall RoadmapBoardListViewItem___ctor_45015164(
        RoadmapBoardListViewItem_o *this,
        int32_t index,
        const MethodInfo *method)
{
