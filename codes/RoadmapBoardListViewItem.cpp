        ...
        const MethodInfo *method)
{
  ...
  sub_1C13CC8(&this->fields._Atlas_k__BackingField);
  ...
  sub_1C13CC8(&this->fields._BoardPrefab_k__BackingField);
}


void __fastcall RoadmapBoardListViewItem___ctor_31228012(
        RoadmapBoardListViewItem_o *this,
        int32_t index,
        int32_t tabGroup,
        int32_t groupIndex,
