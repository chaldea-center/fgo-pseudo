        ...
        const MethodInfo *method)
{
  ...
  sub_1C36FFC(&this->fields._Atlas_k__BackingField, atlas);
  this->fields._SpriteName_k__BackingField = spriteName;
  sub_1C36FFC(&this->fields._SpriteName_k__BackingField, spriteName);
  this->fields._BoardPrefab_k__BackingField = 0;
  sub_1C36FFC(&this->fields._BoardPrefab_k__BackingField, 0);
}


void RoadmapBoardListViewItem___ctor_31380608(
        RoadmapBoardListViewItem_o *this,
        int32_t index,
        int32_t tabGroup,
        int32_t groupIndex,
        ...
        const MethodInfo *method)
{
  ...
  sub_1C36FFC(&this->fields._BoardPrefab_k__BackingField, boardPrefab);
  this->fields._Atlas_k__BackingField = 0;
  sub_1C36FFC(&this->fields._Atlas_k__BackingField, 0);
}
...
void RoadmapBoardListViewItem__set_Atlas(RoadmapBoardListViewItem_o *this, UIAtlas_o *value, const MethodInfo *method)
{
  ...
  sub_1C36FFC(&this->fields._Atlas_k__BackingField, value);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C36FFC(&this->fields._BoardPrefab_k__BackingField, value);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C36FFC(&this->fields._SpriteName_k__BackingField, value);
}
