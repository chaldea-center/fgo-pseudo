        ...
        const MethodInfo *method)
{
  ...
  sub_1BD33FC(&this->fields._Atlas_k__BackingField);
  this->fields._SpriteName_k__BackingField = spriteName;
  sub_1BD33FC(&this->fields._SpriteName_k__BackingField);
  this->fields._BoardPrefab_k__BackingField = 0LL;
  sub_1BD33FC(&this->fields._BoardPrefab_k__BackingField);
}


void __fastcall RoadmapBoardListViewItem___ctor_30936456(
        RoadmapBoardListViewItem_o *this,
        int32_t index,
        int32_t tabGroup,
        int32_t groupIndex,
