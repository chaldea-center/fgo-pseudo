        ...
        const MethodInfo *method)
{
  ...
  sub_1BE4A70(&this->fields._Atlas_k__BackingField);
  ...
  sub_1BE4A70(&this->fields._BoardPrefab_k__BackingField);
}


void __fastcall RoadmapBoardListViewItem___ctor_31007880(
        RoadmapBoardListViewItem_o *this,
        int32_t index,
        int32_t tabGroup,
        int32_t groupIndex,
