        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A511CB & 1) == 0 )
  {
    sub_1B863B8(&BattleDataDefine_TypeInfo, baseSvtData);
    sub_1B863B8(&BattleServantSnapShot_TypeInfo, v11);
    sub_1B863B8(&BattleBuffData_CheckIndividualitiesData_TypeInfo, v12);
    sub_1B863B8(&Method_System_Collections_Generic_LinkedList_BattleServantSnapShot__AddLast__, v13);
    byte_4A511CB = 1;
  }
  if ( opponentSvtData )
  {
    ConcatSvtIndividualities = BattleServantData__getConcatSvtIndividualities(
                                 ...
                                 0LL,
                                 0LL);
    v15 = (BattleBuffData_CheckIndividualitiesData_o *)sub_1B86604(BattleBuffData_CheckIndividualitiesData_TypeInfo);
    v16 = v15;
    v17 = baseSvtData;
    v18 = opponentSvtData;
  ...
  BattleBuffData_CheckIndividualitiesData___ctor_43790008(v15, v17, v18, 0LL, v19, 0LL, 0LL, 0LL);
  ...
  v23 = sub_1B86604(BattleServantSnapShot_TypeInfo);
  System_Object___ctor((Il2CppObject *)v23, 0LL);
  if ( !baseSvtData
    || (uniqueId = baseSvtData->fields.uniqueId,
        *(_QWORD *)(v23 + 16) = v16,
        *(_DWORD *)(v23 + 24) = uniqueId,
        sub_1B8635C((CGThumbnailListItem_o *)(v23 + 16), (int32_t)v16, v26, v27),
  ...
  System_Collections_Generic_LinkedList_object___AddLast(
    SnapShotLinkedList_k__BackingField,
    (Il2CppObject *)v23,
    (const MethodInfo_3548B94 *)Method_System_Collections_Generic_LinkedList_BattleServantSnapShot__AddLast__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A511CC & 1) == 0 )
  {
    sub_1B863B8(
      ...
      method);
    sub_1B863B8(&Method_System_Linq_Enumerable_ToArray_BattleBuffData_CheckIndividualitiesData___, v3);
    sub_1B863B8(&System_Func_BattleServantSnapShot__BattleBuffData_CheckIndividualitiesData__TypeInfo, v4);
    sub_1B863B8(&Method_BattleServantSnapShotGroupDefault___c__get_CheckIndividualitiesDataArray_b__2_0__, v5);
    sub_1B863B8(&BattleServantSnapShotGroupDefault___c_TypeInfo, v6);
    byte_4A511CC = 1;
  }
  ...
  if ( !_9__2_0 )
  {
    ...
    _9__2_0 = (System_Func_object__object__o *)sub_1B86604(System_Func_BattleServantSnapShot__BattleBuffData_CheckIndividualitiesData__TypeInfo);
  ...
  v14 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_object__object_(
                                                               ...
                                                               (const MethodInfo_2FA1274 *)Method_System_Linq_Enumerable_Select_BattleServantSnapShot__BattleBuffData_CheckIndividualitiesData___);
  return (BattleBuffData_CheckIndividualitiesData_array *)System_Linq_Enumerable__ToArray_object_(
                                                            v14,
                                                            (const MethodInfo_2FA98D8 *)Method_System_Linq_Enumerable_ToArray_BattleBuffData_CheckIndividualitiesData___);
}
...
void __fastcall BattleServantSnapShotGroupDefault___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A511CD & 1) == 0 )
  {
    sub_1B863B8(&BattleServantSnapShotGroupDefault___c_TypeInfo, v1);
    byte_4A511CD = 1;
  }
  v2 = (Il2CppObject *)sub_1B86604(BattleServantSnapShotGroupDefault___c_TypeInfo);
