void __fastcall BattleLogicClassRelation___ctor(BattleLogicClassRelation_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5DCDB & 1) == 0 )
  {
    sub_1B885B0(&BattleLogicClassRelation_AttackOverwriteProcess_TypeInfo);
    sub_1B885B0(&BattleLogicClassRelation_DefenseOverwriteProcess_TypeInfo);
    sub_1B885B0(&BattleLogicClassRelation_OldAttackOverwriteProcess_TypeInfo);
    sub_1B885B0(&BattleLogicClassRelation_OldDefenseOverwriteProcess_TypeInfo);
    sub_1B885B0(&BattleLogicClassRelation_Process___TypeInfo);
    byte_4A5DCDB = 1;
  }
  v3 = (struct BattleLogicClassRelation_Process_array *)sub_1B88658(BattleLogicClassRelation_Process___TypeInfo, 4LL);
  v4 = (Il2CppObject *)sub_1B887FC(BattleLogicClassRelation_OldAttackOverwriteProcess_TypeInfo);
  System_Object___ctor(v4, 0LL);
  if ( !v3 )
    sub_1B8880C(v5, v6);
  if ( v4 )
  {
    v5 = sub_1B886EC(v4, v3->obj.klass->_1.element_class);
    if ( !v5 )
      goto LABEL_18;
  }
  if ( !v3->max_length )
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)v3->m_Items, (int32_t)v4, v7, v8);
  v9 = (Il2CppObject *)sub_1B887FC(BattleLogicClassRelation_OldDefenseOverwriteProcess_TypeInfo);
  System_Object___ctor(v9, 0LL);
  if ( v9 )
  {
    v5 = sub_1B886EC(v9, v3->obj.klass->_1.element_class);
    if ( !v5 )
      goto LABEL_18;
  }
  if ( v3->max_length <= 1 )
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v3->m_Items[1], (int32_t)v9, v10, v11);
  v12 = (Il2CppObject *)sub_1B887FC(BattleLogicClassRelation_AttackOverwriteProcess_TypeInfo);
  System_Object___ctor(v12, 0LL);
  if ( v12 )
  {
    v5 = sub_1B886EC(v12, v3->obj.klass->_1.element_class);
    if ( !v5 )
      goto LABEL_18;
  }
  if ( v3->max_length <= 2 )
    goto LABEL_17;
  v3->m_Items[2] = (BattleLogicClassRelation_Process_o *)v12;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v3->m_Items[2], (int32_t)v12, v13, v14);
  v15 = (Il2CppObject *)sub_1B887FC(BattleLogicClassRelation_DefenseOverwriteProcess_TypeInfo);
  System_Object___ctor(v15, 0LL);
  if ( v15 )
  {
    v5 = sub_1B886EC(v15, v3->obj.klass->_1.element_class);
    if ( !v5 )
    {
LABEL_18:
      v20 = sub_1B88830(v5);
...
LABEL_17:
    sub_1B88814(v5, v6);
  v3->m_Items[3] = (BattleLogicClassRelation_Process_o *)v15;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v3->m_Items[3], (int32_t)v15, v16, v17);
  this->fields._procArray = v3;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)v3, v18, v19);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5DCDA & 1) == 0 )
  {
    sub_1B885B0(&Method_DataManager_GetMasterData_ClassRelationOverwriteMaster___);
  ...
  if ( !overwriteMst )
  {
    ...
    MasterData_object = DataManager__GetMasterData_object_(
                          ...
                          (const MethodInfo_2E7F908 *)Method_DataManager_GetMasterData_ClassRelationOverwriteMaster___);
    p_overwriteMst->klass = (ServantStatusBattleListViewItem_c *)MasterData_object;
    sub_1B88554(p_overwriteMst, (int32_t)MasterData_object, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)command, v11, v12);
  this->fields.atkSvt = attackSvt;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.atkSvt, (int32_t)attackSvt, v13, v14);
  this->fields.defSvt = defenseSvt;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.defSvt, (int32_t)defenseSvt, v15, v16);
  ...
  if ( !atkSvt
    ...
    || (this->fields.defClassId = BattleServantData__getBattleClassId(
                                    ...
                                    0,
                                    0LL),
        (atkSvt = (BattleServantData_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0LL)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5DCDD & 1) == 0 )
  {
    sub_1B885B0(&BattleLogicClassRelation_ResultData_TypeInfo);
    byte_4A5DCDD = 1;
  }
  v3 = (BattleLogicClassRelation_ResultData_o *)sub_1B887FC(BattleLogicClassRelation_ResultData_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)v4, (int32_t)result, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( Priority_k__BackingField < priority )
  {
    ...
    *((_DWORD *)p_proc - 2) = type;
    sub_1B88554((ServantStatusBattleListViewItem_o *)p_proc, (int32_t)proc, type, (int32_t)proc);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5DCE1 & 1) == 0 )
  {
    this = (BattleLogicClassRelation_OldAttackOverwriteProcess_o *)sub_1B885B0(&BattleDataDefine_TypeInfo);
    byte_4A5DCE1 = 1;
  }
  val = 0.0;
  if ( !arg )
...
LABEL_13:
  ...
  if ( AtkRateData_k__BackingField->fields._Priority_k__BackingField < v11 )
  {
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)&AtkRateData_k__BackingField->fields._proc, (int32_t)v7, v8, v9);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5DCE2 & 1) == 0 )
  {
    this = (BattleLogicClassRelation_OldDefenseOverwriteProcess_o *)sub_1B885B0(&BattleDataDefine_TypeInfo);
    byte_4A5DCE2 = 1;
  }
  val = 0.0;
  if ( !arg )
...
LABEL_13:
  ...
  if ( DefRateData_k__BackingField->fields._Priority_k__BackingField < v11 )
  {
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)&DefRateData_k__BackingField->fields._proc, (int32_t)v7, v8, v9);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5DCE0 & 1) == 0 )
  {
    sub_1B885B0(&Method_System_Array_Sort_BattleBuffData_BuffData___);
    sub_1B885B0(&System_Comparison_BattleBuffData_BuffData__TypeInfo);
    sub_1B885B0(&Method_BattleLogicClassRelation_OverwriteProcess__overwriteDamageRate_b__4_0__);
    byte_4A5DCE0 = 1;
  }
  v11 = (System_Comparison_T__o *)sub_1B887FC(System_Comparison_BattleBuffData_BuffData__TypeInfo);
  ...
  System_Array__Sort_object__48551928(
    ...
    v11,
    (const MethodInfo_2E4D7F8 *)Method_System_Array_Sort_BattleBuffData_BuffData___);
  outEnt = 0LL;
  if ( !buffArray )
    goto LABEL_26;
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        v20 = ((__int64 (__fastcall *)(BattleLogicClassRelation_OverwriteProcess_o *, const char *))this->klass[1]._1.gc_desc)(
                this,
                this->klass[1]._1.name);
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)&damageRate->fields._proc, (int32_t)this, v22, v23);
    if ( arg->fields.isAction )
    {
      ...
      if ( v27 )
      {
        OverwriteMst = *(ClassRelationOverwriteMaster_o **)(v27 + 792);
        if ( OverwriteMst )
        {
          BattleBuffData__checkBuffSuccessful((BattleBuffData_o *)OverwriteMst, v16, arg->fields.isAction, 0LL);
          return;
        }
      }
LABEL_26:
      sub_1B8880C(OverwriteMst, v13);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5DCDE & 1) == 0 )
  {
    sub_1B885B0(&BattleLogicClassRelation_DamageRateData_TypeInfo);
    byte_4A5DCDE = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
  if ( !arg )
  ...
  this->fields._BaseRate_k__BackingField = ClassRelationMaster__getRate(
                                             ...
                                             arg->fields.defRelationId,
                                             0LL);
  v7 = sub_1B887FC(BattleLogicClassRelation_DamageRateData_TypeInfo);
  System_Object___ctor((Il2CppObject *)v7, 0LL);
  *(_QWORD *)(v7 + 16) = this;
  sub_1B88554((ServantStatusBattleListViewItem_o *)(v7 + 16), (int32_t)this, v8, v9);
  *(_BYTE *)(v7 + 36) = 0;
  *(_QWORD *)(v7 + 24) = 0xFFFFFFFFLL;
  *(_DWORD *)(v7 + 32) = -1;
  this->fields._AtkRateData_k__BackingField = (struct BattleLogicClassRelation_DamageRateData_o *)v7;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields._AtkRateData_k__BackingField, v7, v10, v11);
  v12 = sub_1B887FC(BattleLogicClassRelation_DamageRateData_TypeInfo);
  System_Object___ctor((Il2CppObject *)v12, 0LL);
  *(_QWORD *)(v12 + 16) = this;
  sub_1B88554((ServantStatusBattleListViewItem_o *)(v12 + 16), (int32_t)this, v13, v14);
  ...
  *(_BYTE *)(v12 + 36) = 0;
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)p_DefRateData_k__BackingField, v12, v16, v17);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5DCDF & 1) == 0 )
  {
    sub_1B885B0(&BattleLogicClassRelation_DamageRateData___TypeInfo);
    byte_4A5DCDF = 1;
  }
  IsPriorAttack = BattleLogicClassRelation_ResultData__get_IsPriorAttack(this, method);
  v4 = sub_1B88658(BattleLogicClassRelation_DamageRateData___TypeInfo, 2LL);
  ...
  if ( !IsPriorAttack )
  {
    if ( v4 )
    {
      ...
      if ( AtkRateData_k__BackingField )
      {
        v4 = sub_1B886EC(this->fields._AtkRateData_k__BackingField, *(_QWORD *)(*(_QWORD *)v4 + 64LL));
        if ( !v4 )
          goto LABEL_19;
      }
      if ( !v8->max_length )
      ...
      sub_1B88554((ServantStatusBattleListViewItem_o *)v8->m_Items, (int32_t)AtkRateData_k__BackingField, v6, v7);
      DefRateData_k__BackingField = this->fields._DefRateData_k__BackingField;
      if ( !DefRateData_k__BackingField )
        goto LABEL_16;
LABEL_15:
      v4 = sub_1B886EC(DefRateData_k__BackingField, v8->obj.klass->_1.element_class);
      if ( v4 )
        goto LABEL_16;
LABEL_19:
      v15 = sub_1B88830(v4);
...
LABEL_20:
  ...
  if ( v9 )
  {
    v4 = sub_1B886EC(this->fields._DefRateData_k__BackingField, *(_QWORD *)(*(_QWORD *)v4 + 64LL));
    if ( !v4 )
      goto LABEL_19;
  }
  if ( !v8->max_length )
    goto LABEL_18;
  v8->m_Items[0] = v9;
  sub_1B88554((ServantStatusBattleListViewItem_o *)v8->m_Items, (int32_t)v9, v6, v7);
...
LABEL_18:
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v8->m_Items[1], (int32_t)DefRateData_k__BackingField, v10, v11);
        ...
        const MethodInfo *method)
{
  ...
  *(float *)&v3 = this->fields._BaseRate_k__BackingField;
  if ( max_length >= 1 )
  {
    ...
    {
      if ( v6 >= max_length )
        sub_1B88814(this, damageRateArray);
...
LABEL_11:
    sub_1B8880C(this, damageRateArray);
  }
  return *(float *)&v3;
}
