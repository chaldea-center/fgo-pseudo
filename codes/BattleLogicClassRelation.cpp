void __fastcall BattleLogicClassRelation___ctor(BattleLogicClassRelation_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B47948 & 1) == 0 )
  {
    sub_1BDB878(&BattleLogicClassRelation_AttackOverwriteProcess_TypeInfo, method);
    sub_1BDB878(&BattleLogicClassRelation_DefenseOverwriteProcess_TypeInfo, v3);
    sub_1BDB878(&BattleLogicClassRelation_OldAttackOverwriteProcess_TypeInfo, v4);
    sub_1BDB878(&BattleLogicClassRelation_OldDefenseOverwriteProcess_TypeInfo, v5);
    sub_1BDB878(&BattleLogicClassRelation_Process___TypeInfo, v6);
    byte_4B47948 = 1;
  }
  v7 = (struct BattleLogicClassRelation_Process_array *)sub_1BDB920(BattleLogicClassRelation_Process___TypeInfo, 4LL);
  v8 = (Il2CppObject *)sub_1BDBAC4(BattleLogicClassRelation_OldAttackOverwriteProcess_TypeInfo);
  System_Object___ctor(v8, 0LL);
  if ( !v7 )
    sub_1BDBAD4(v9, v10);
  if ( v8 )
  {
    v9 = sub_1BDB9B4(v8, v7->obj.klass->_1.element_class);
    if ( !v9 )
      goto LABEL_18;
  }
  if ( !v7->max_length )
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)v7->m_Items, (int32_t)v8, v11, v12);
  v13 = (Il2CppObject *)sub_1BDBAC4(BattleLogicClassRelation_OldDefenseOverwriteProcess_TypeInfo);
  System_Object___ctor(v13, 0LL);
  if ( v13 )
  {
    v9 = sub_1BDB9B4(v13, v7->obj.klass->_1.element_class);
    if ( !v9 )
      goto LABEL_18;
  }
  if ( v7->max_length <= 1 )
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&v7->m_Items[1], (int32_t)v13, v11, v14);
  v15 = (Il2CppObject *)sub_1BDBAC4(BattleLogicClassRelation_AttackOverwriteProcess_TypeInfo);
  System_Object___ctor(v15, 0LL);
  if ( v15 )
  {
    v9 = sub_1BDB9B4(v15, v7->obj.klass->_1.element_class);
    if ( !v9 )
      goto LABEL_18;
  }
  if ( v7->max_length <= 2 )
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&v7->m_Items[2], (int32_t)v15, v11, v16);
  v17 = (Il2CppObject *)sub_1BDBAC4(BattleLogicClassRelation_DefenseOverwriteProcess_TypeInfo);
  System_Object___ctor(v17, 0LL);
  if ( v17 )
  {
    v9 = sub_1BDB9B4(v17, v7->obj.klass->_1.element_class);
    if ( !v9 )
    {
LABEL_18:
      v21 = sub_1BDBAF8(v9);
...
LABEL_17:
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&v7->m_Items[3], (int32_t)v17, v11, v18);
  this->fields._procArray = v7;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields, (int32_t)v7, v19, v20);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47947 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMasterData_ClassRelationOverwriteMaster___, method);
  ...
  if ( !overwriteMst )
  {
    ...
    MasterData_object = DataManager__GetMasterData_object_(
                          ...
                          (const MethodInfo_303395C *)Method_DataManager_GetMasterData_ClassRelationOverwriteMaster___);
    p_overwriteMst->klass = (CGThumbnailListItem_c *)MasterData_object;
    sub_1BDB81C(p_overwriteMst, (int32_t)MasterData_object, v10, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47949 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMasterData_ServantClassMaster___, command);
    sub_1BDB878(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v11);
    byte_4B47949 = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
  this->fields.command = command;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields, (int32_t)command, v12, v13);
  this->fields.atkSvt = attackSvt;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.atkSvt, (int32_t)attackSvt, v14, v15);
  this->fields.defSvt = defenseSvt;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.defSvt, (int32_t)defenseSvt, v16, v17);
  ...
  if ( !atkSvt
    ...
    || (this->fields.defClassId = BattleServantData__getBattleClassId(
                                    ...
                                    0,
                                    0LL),
        (atkSvt = (BattleServantData_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0LL)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4794A & 1) == 0 )
  {
    sub_1BDB878(&BattleLogicClassRelation_ResultData_TypeInfo, method);
    byte_4B4794A = 1;
  }
  v3 = (BattleLogicClassRelation_ResultData_o *)sub_1BDBAC4(BattleLogicClassRelation_ResultData_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)v4, (int32_t)result, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( Priority_k__BackingField < priority )
  {
    ...
    *((_DWORD *)p_proc - 2) = type;
    sub_1BDB81C((CGThumbnailListItem_o *)p_proc, (int32_t)proc, type, (const MethodInfo *)proc);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4794E & 1) == 0 )
  {
    this = (BattleLogicClassRelation_OldAttackOverwriteProcess_o *)sub_1BDB878(&BattleDataDefine_TypeInfo, logic);
    byte_4B4794E = 1;
  }
  val = 0.0;
  if ( !arg )
...
LABEL_13:
  ...
  if ( AtkRateData_k__BackingField->fields._Priority_k__BackingField < v11 )
  {
    ...
    sub_1BDB81C((CGThumbnailListItem_o *)&AtkRateData_k__BackingField->fields._proc, (int32_t)v7, v8, v9);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4794F & 1) == 0 )
  {
    this = (BattleLogicClassRelation_OldDefenseOverwriteProcess_o *)sub_1BDB878(&BattleDataDefine_TypeInfo, logic);
    byte_4B4794F = 1;
  }
  val = 0.0;
  if ( !arg )
...
LABEL_13:
  ...
  if ( DefRateData_k__BackingField->fields._Priority_k__BackingField < v11 )
  {
    ...
    sub_1BDB81C((CGThumbnailListItem_o *)&DefRateData_k__BackingField->fields._proc, (int32_t)v7, v8, v9);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4794D & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Array_Sort_BattleBuffData_BuffData___, logic);
    sub_1BDB878(&System_Comparison_BattleBuffData_BuffData__TypeInfo, v11);
    sub_1BDB878(&Method_BattleLogicClassRelation_OverwriteProcess__overwriteDamageRate_b__4_0__, v12);
    byte_4B4794D = 1;
  }
  v13 = (System_Comparison_T__o *)sub_1BDBAC4(System_Comparison_BattleBuffData_BuffData__TypeInfo);
  ...
  System_Array__Sort_object__50334236(
    ...
    v13,
    (const MethodInfo_3000A1C *)Method_System_Array_Sort_BattleBuffData_BuffData___);
  outEnt = 0LL;
  if ( !buffArray )
    goto LABEL_26;
  ...
  if ( max_length >= 1 )
  {
    ...
    {
      if ( v18 >= max_length )
        sub_1BDBADC(OverwriteMst, v15, v16);
    ...
    sub_1BDB81C((CGThumbnailListItem_o *)&damageRate->fields._proc, (int32_t)this, v16, v25);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4794B & 1) == 0 )
  {
    sub_1BDB878(&BattleLogicClassRelation_DamageRateData_TypeInfo, arg);
    byte_4B4794B = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
  if ( !arg )
  ...
  this->fields._BaseRate_k__BackingField = ClassRelationMaster__getRate(
                                             ...
                                             arg->fields.defRelationId,
                                             0LL);
  v7 = sub_1BDBAC4(BattleLogicClassRelation_DamageRateData_TypeInfo);
  System_Object___ctor((Il2CppObject *)v7, 0LL);
  *(_QWORD *)(v7 + 16) = this;
  sub_1BDB81C((CGThumbnailListItem_o *)(v7 + 16), (int32_t)this, v8, v9);
  *(_BYTE *)(v7 + 36) = 0;
  *(_QWORD *)(v7 + 24) = 0xFFFFFFFFLL;
  *(_DWORD *)(v7 + 32) = -1;
  this->fields._AtkRateData_k__BackingField = (struct BattleLogicClassRelation_DamageRateData_o *)v7;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields._AtkRateData_k__BackingField, v7, v10, v11);
  v12 = sub_1BDBAC4(BattleLogicClassRelation_DamageRateData_TypeInfo);
  System_Object___ctor((Il2CppObject *)v12, 0LL);
  *(_QWORD *)(v12 + 16) = this;
  sub_1BDB81C((CGThumbnailListItem_o *)(v12 + 16), (int32_t)this, v13, v14);
  ...
  *(_BYTE *)(v12 + 36) = 0;
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)p_DefRateData_k__BackingField, v12, v16, v17);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4794C & 1) == 0 )
  {
    sub_1BDB878(&BattleLogicClassRelation_DamageRateData___TypeInfo, method);
    byte_4B4794C = 1;
  }
  IsPriorAttack = BattleLogicClassRelation_ResultData__get_IsPriorAttack(this, method);
  v4 = sub_1BDB920(BattleLogicClassRelation_DamageRateData___TypeInfo, 2LL);
  ...
  if ( !IsPriorAttack )
  {
    if ( v4 )
    {
      ...
      if ( AtkRateData_k__BackingField )
      {
        v4 = sub_1BDB9B4(this->fields._AtkRateData_k__BackingField, *(_QWORD *)(*(_QWORD *)v4 + 64LL));
        if ( !v4 )
          goto LABEL_19;
      }
      if ( !v8->max_length )
      ...
      sub_1BDB81C((CGThumbnailListItem_o *)v8->m_Items, (int32_t)AtkRateData_k__BackingField, v6, v7);
      DefRateData_k__BackingField = this->fields._DefRateData_k__BackingField;
      if ( !DefRateData_k__BackingField )
        goto LABEL_16;
LABEL_15:
      v4 = sub_1BDB9B4(DefRateData_k__BackingField, v8->obj.klass->_1.element_class);
      if ( v4 )
        goto LABEL_16;
LABEL_19:
      v14 = sub_1BDBAF8(v4);
...
LABEL_20:
  ...
  if ( v9 )
  {
    v4 = sub_1BDB9B4(this->fields._DefRateData_k__BackingField, *(_QWORD *)(*(_QWORD *)v4 + 64LL));
    if ( !v4 )
      goto LABEL_19;
  }
  if ( !v8->max_length )
    goto LABEL_18;
  v8->m_Items[0] = v9;
  sub_1BDB81C((CGThumbnailListItem_o *)v8->m_Items, (int32_t)v9, v6, v7);
...
LABEL_18:
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&v8->m_Items[1], (int32_t)DefRateData_k__BackingField, v6, v10);
        ...
        const MethodInfo *method)
{
  ...
  *(float *)&v3 = this->fields._BaseRate_k__BackingField;
  if ( max_length >= 1 )
  {
    ...
    {
      if ( v6 >= max_length )
        sub_1BDBADC(this, damageRateArray, method);
...
LABEL_11:
    sub_1BDBAD4(this, damageRateArray);
  }
  return *(float *)&v3;
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields._AtkRateData_k__BackingField, (int32_t)value, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields._DefRateData_k__BackingField, (int32_t)value, (int32_t)method, v3);
}
