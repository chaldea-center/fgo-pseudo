void QuestResetConfirmDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CB0219 & 1) == 0 )
  {
    sub_1C6BA08(&QuestResetConfirmDialog_TypeInfo);
    byte_4CB0219 = 1;
  }
...
void QuestResetConfirmDialog__Close(QuestResetConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  QuestResetConfirmDialog__Close_31561600(this, 0, v2);
}


void QuestResetConfirmDialog__Close_31561600(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB0214 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_QuestResetConfirmDialog_EndClose__);
    byte_4CB0214 = 1;
  }
...
void QuestResetConfirmDialog__OnClickCancel(QuestResetConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB0216 & 1) == 0 )
  {
    sub_1C6BA08(&Method_QuestResetConfirmDialog_OnClickCancel__);
    byte_4CB0216 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_QuestResetConfirmDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C6BA20(Method_QuestResetConfirmDialog_OnClickCancel__);
...
void QuestResetConfirmDialog__OnClickDecide(QuestResetConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB0215 & 1) == 0 )
  {
    sub_1C6BA08(&Method_QuestResetConfirmDialog_OnClickDecide__);
    byte_4CB0215 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_QuestResetConfirmDialog_OnClickDecide__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1C6BA20(Method_QuestResetConfirmDialog_OnClickDecide__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB0213 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_System_Collections_Generic_List_UserEventAlloutBattleMaster_ClearSvtEquipInfo__get_Count__);
    sub_1C6BA08(&Method_System_Collections_Generic_List_ServantFaceIconComponent__get_Item__);
    sub_1C6BA08(&Method_System_Collections_Generic_List_UserEventAlloutBattleMaster_ClearSvtEquipInfo__get_Item__);
    sub_1C6BA08(&LocalizationManager_TypeInfo);
    sub_1C6BA08(&UnityEngine_Object_TypeInfo);
    sub_1C6BA08(&Method_QuestResetConfirmDialog_EndOpen__);
    sub_1C6BA08(&QuestResetConfirmDialog_TypeInfo);
    sub_1C6BA08(&ServantOverwriteStatus_TypeInfo);
    sub_1C6BA08(&StringLiteral_10892/*"QUEST_MESSAGE_DLG_QUEST_RESET_CANCEL"*/);
    sub_1C6BA08(&StringLiteral_10894/*"QUEST_MESSAGE_DLG_QUEST_RESET_MSG"*/);
    sub_1C6BA08(&StringLiteral_10893/*"QUEST_MESSAGE_DLG_QUEST_RESET_DECIDE"*/);
    sub_1C6BA08(&StringLiteral_10897/*"QUEST_MESSAGE_DLG_QUEST_RESET_TITLE"*/);
    sub_1C6BA08(&StringLiteral_10896/*"QUEST_MESSAGE_DLG_QUEST_RESET_NAME"*/);
    sub_1C6BA08(&StringLiteral_10895/*"QUEST_MESSAGE_DLG_QUEST_RESET_MSG_COND"*/);
    byte_4CB0213 = 1;
  }
  ...
  if ( Master_object )
  {
    ...
    if ( v14 )
    {
      ...
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      ClearDeckInfo = DataManager__GetMaster_object_((const MethodInfo_313B314 *)Method_DataManager_GetMaster_ServantLimitImageMaster___);
      ...
      while ( v17 < servantFaceIconList->fields._size )
      {
        ...
        else
        {
          ...
          if ( !v21 || !v22 )
            goto LABEL_39;
          IconLabelInfo__Set_41149608(v22, 2, (int32_t)v21[1].monitor, (int32_t)v21[1].monitor, 0, 0, 1, 0, 0, 0);
          ...
          v30 = (ServantOverwriteStatus_o *)sub_1C6BC54(ServantOverwriteStatus_TypeInfo);
          ServantOverwriteStatus___ctor_33625480(v30, klass_high, v29, ServantLimitCountSealAfter, 0);
          if ( !v30 || !v20 )
            goto LABEL_39;
          ...
          if ( monitor )
          {
            ...
            else
            {
              ClearDeckInfo = System_Collections_Generic_List_object___get_Item(
                                monitor,
                                0,
                                (const MethodInfo_38006A4 *)Method_System_Collections_Generic_List_UserEventAlloutBattleMaster_ClearSvtEquipInfo__get_Item__);
              if ( !ClearDeckInfo )
                goto LABEL_39;
              v32 = ClearDeckInfo;
          ...
          ServantFaceIconComponent__SetEquip_41230724(v20, HIDWORD(v21[1].klass), v33, v34, 0, 0);
        }
        servantFaceIconList = (System_Collections_Generic_List_object__o *)this->fields.servantFaceIconList;
        ++v17;
        if ( !servantFaceIconList )
      ...
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      v35 = DataManager__GetMaster_object_((const MethodInfo_313B314 *)Method_DataManager_GetMaster_QuestGroupMaster___);
      ClearDeckInfo = DataManager__GetMaster_object_((const MethodInfo_313B314 *)Method_DataManager_GetMaster_QuestReleaseMaster___);
      if ( !v35 )
        goto LABEL_39;
      ...
      if ( UnityEngine_Object__op_Inequality(titleLabel, 0, 0) )
      {
        ...
        ClearDeckInfo = LocalizationManager__Get((System_String_o *)StringLiteral_10897/*"QUEST_MESSAGE_DLG_QUEST_RESET_TITLE"*/, 0);
        if ( !v45 )
          goto LABEL_39;
      ...
      if ( UnityEngine_Object__op_Inequality(nameLabel, 0, 0) )
      {
        if ( !DataManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
        ClearDeckInfo = DataManager__GetMaster_object_((const MethodInfo_313B314 *)Method_DataManager_GetMaster_QuestMaster___);
        if ( !ClearDeckInfo )
          goto LABEL_39;
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        ClearDeckInfo = LocalizationManager__Get((System_String_o *)StringLiteral_10896/*"QUEST_MESSAGE_DLG_QUEST_RESET_NAME"*/, 0);
        if ( !v49 )
          goto LABEL_39;
...
LABEL_84:
        ...
        if ( UnityEngine_Object__op_Inequality(buttonDecideLabel, 0, 0) )
        {
          ...
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          ClearDeckInfo = LocalizationManager__Get((System_String_o *)StringLiteral_10893/*"QUEST_MESSAGE_DLG_QUEST_RESET_DECIDE"*/, 0);
          if ( !v57 )
            goto LABEL_39;
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        ClearDeckInfo = LocalizationManager__Get((System_String_o *)StringLiteral_10892/*"QUEST_MESSAGE_DLG_QUEST_RESET_CANCEL"*/, 0);
        if ( v59 )
        {
...
LABEL_39:
      ...
      if ( LocalizationManager_TypeInfo->_2.cctor_finished )
      {
        ...
        {
LABEL_79:
          v55 = &StringLiteral_10895/*"QUEST_MESSAGE_DLG_QUEST_RESET_MSG_COND"*/;
LABEL_82:
      ...
      v55 = &StringLiteral_10894/*"QUEST_MESSAGE_DLG_QUEST_RESET_MSG"*/;
      goto LABEL_82;
    }
  }
}
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1A983F4;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A983AC;
}
