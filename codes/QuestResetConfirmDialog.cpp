void __fastcall QuestResetConfirmDialog___cctor(const MethodInfo *method)
{
  if ( (byte_42B4901 & 1) == 0 )
  {
    sub_B52984(&QuestResetConfirmDialog_TypeInfo);
    byte_42B4901 = 1;
  }
...
void __fastcall QuestResetConfirmDialog__Close(QuestResetConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  QuestResetConfirmDialog__Close_34131100(this, 0LL, v2);
}


void __fastcall QuestResetConfirmDialog__Close_34131100(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B48FC & 1) == 0 )
  {
    ...
    sub_B52984(&Method_QuestResetConfirmDialog_EndClose__);
    byte_42B48FC = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B48FB & 1) == 0 )
  {
    ...
    sub_B52984(&Method_System_Collections_Generic_List_UserEventAlloutBattleMaster_ClearSvtEquipInfo__get_Count__);
    sub_B52984(&Method_System_Collections_Generic_List_ServantFaceIconComponent__get_Count__);
    sub_B52984(&Method_System_Collections_Generic_List_UserEventAlloutBattleMaster_ClearSvtEquipInfo__get_Item__);
    sub_B52984(&Method_System_Collections_Generic_List_ServantFaceIconComponent__get_Item__);
    sub_B52984(&LocalizationManager_TypeInfo);
    sub_B52984(&UnityEngine_Object_TypeInfo);
    sub_B52984(&Method_QuestResetConfirmDialog_EndOpen__);
    sub_B52984(&QuestResetConfirmDialog_TypeInfo);
    sub_B52984(&StringLiteral_11040/*"QUEST_MESSAGE_DLG_QUEST_RESET_CANCEL"*/);
    sub_B52984(&StringLiteral_11042/*"QUEST_MESSAGE_DLG_QUEST_RESET_MSG"*/);
    sub_B52984(&StringLiteral_11041/*"QUEST_MESSAGE_DLG_QUEST_RESET_DECIDE"*/);
    sub_B52984(&StringLiteral_11045/*"QUEST_MESSAGE_DLG_QUEST_RESET_TITLE"*/);
    sub_B52984(&StringLiteral_11044/*"QUEST_MESSAGE_DLG_QUEST_RESET_NAME"*/);
    sub_B52984(&StringLiteral_11043/*"QUEST_MESSAGE_DLG_QUEST_RESET_MSG_COND"*/);
    byte_42B48FB = 1;
  }
      ...
      if ( servantFaceIconList )
      {
        ...
        while ( 1 )
        {
          ...
          else
          {
            ...
            if ( !v29 )
              goto LABEL_32;
            IconLabelInfo__Set_28274368(v29, 2, *(_DWORD *)(v28 + 24), *(_DWORD *)(v28 + 24), 0, 0, 1, 0, 0LL);
            if ( !v23 )
              goto LABEL_32;
            ...
            ServantFaceIconComponent__SetEquip_30471720(v27, *(_DWORD *)(v28 + 20), v32, v33, 0LL);
          }
          servantFaceIconList = this->fields.servantFaceIconList;
          ++v24;
          if ( !servantFaceIconList )
        ...
        v34 = (QuestGroupMaster_o *)DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1A4F124 *)Method_DataManager_GetMaster_QuestGroupMaster___);
        ClearDeckInfo = (System_Collections_Generic_List_WarBoardUiData_SaveData__o *)DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1A4F124 *)Method_DataManager_GetMaster_QuestReleaseMaster___);
        if ( v34 )
        {
          ...
          if ( v35 )
          {
            ...
            if ( UnityEngine_Object__op_Inequality(titleLabel, 0LL, 0LL) )
            {
              ...
              ClearDeckInfo = (System_Collections_Generic_List_WarBoardUiData_SaveData__o *)LocalizationManager__Get(
                                                                                              (System_String_o *)StringLiteral_11045/*"QUEST_MESSAGE_DLG_QUEST_RESET_TITLE"*/,
                                                                                              0LL);
              if ( !v45 )
                goto LABEL_32;
            ...
            if ( UnityEngine_Object__op_Inequality(nameLabel, 0LL, 0LL) )
            {
              ...
              ClearDeckInfo = (System_Collections_Generic_List_WarBoardUiData_SaveData__o *)DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1A4F124 *)Method_DataManager_GetMaster_QuestMaster___);
              if ( !ClearDeckInfo )
                goto LABEL_32;
              ...
              ClearDeckInfo = (System_Collections_Generic_List_WarBoardUiData_SaveData__o *)LocalizationManager__Get(
                                                                                              (System_String_o *)StringLiteral_11044/*"QUEST_MESSAGE_DLG_QUEST_RESET_NAME"*/,
                                                                                              0LL);
              if ( !v49 )
                goto LABEL_32;
            ...
            if ( UnityEngine_Object__op_Inequality(main1Label, 0LL, 0LL) )
            {
              ...
              if ( v40 )
              {
                ...
                v55 = &StringLiteral_11043/*"QUEST_MESSAGE_DLG_QUEST_RESET_MSG_COND"*/;
              }
              else
              {
                if ( (WORD1(LocalizationManager_TypeInfo->vtable._0_Equals.methodPtr) & 0x400) != 0
                ...
                v55 = &StringLiteral_11042/*"QUEST_MESSAGE_DLG_QUEST_RESET_MSG"*/;
              }
              ClearDeckInfo = (System_Collections_Generic_List_WarBoardUiData_SaveData__o *)LocalizationManager__Get(
                                                                                              (System_String_o *)*v55,
                                                                                              0LL);
            ...
            if ( UnityEngine_Object__op_Inequality(buttonDecideLabel, 0LL, 0LL) )
            {
              ...
              ClearDeckInfo = (System_Collections_Generic_List_WarBoardUiData_SaveData__o *)LocalizationManager__Get(
                                                                                              (System_String_o *)StringLiteral_11041/*"QUEST_MESSAGE_DLG_QUEST_RESET_DECIDE"*/,
                                                                                              0LL);
              if ( !v57 )
                goto LABEL_32;
            ...
            ClearDeckInfo = (System_Collections_Generic_List_WarBoardUiData_SaveData__o *)LocalizationManager__Get(
                                                                                            (System_String_o *)StringLiteral_11040/*"QUEST_MESSAGE_DLG_QUEST_RESET_CANCEL"*/,
                                                                                            0LL);
            if ( v59 )
            {
