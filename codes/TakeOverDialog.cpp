void TakeOverDialog___cctor(const MethodInfo *method)
{
  if ( (byte_4DFE406 & 1) == 0 )
  {
    sub_1CE6700(&TakeOverDialog_TypeInfo);
  ...
  sub_1CE66A4(TakeOverDialog_TypeInfo->static_fields, StringLiteral_414/*"#787878"*/);
}
...
void TakeOverDialog__Close(TakeOverDialog_o *this, const MethodInfo *method)
{
  ...
  TakeOverDialog__Close_31835752(this, 0, v2);
}


void TakeOverDialog__Close_31835752(TakeOverDialog_o *this, System_Action_o *callback, const MethodInfo *method)
{
  ...
  if ( (byte_4DFE401 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_TakeOverDialog_EndClose__);
    byte_4DFE401 = 1;
  }
...
void TakeOverDialog__OnClickCancel(TakeOverDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFE403 & 1) == 0 )
  {
    sub_1CE6700(&Method_TakeOverDialog_OnClickCancel__);
    byte_4DFE403 = 1;
  }
  ...
  {
    TakeOverDialog__Close_31835752(this, 0, v5);
...
void TakeOverDialog__OnClickDecide(TakeOverDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFE402 & 1) == 0 )
  {
    sub_1CE6700(&Method_TakeOverDialog_OnClickDecide__);
    byte_4DFE402 = 1;
  }
  ...
  if ( this->fields.clickFunc )
  {
    TakeOverDialog__Close_31835752(this, 0, v8);
    clickFunc = this->fields.clickFunc;
    if ( clickFunc )
    {
...
void TakeOverDialog__Open(TakeOverDialog_o *this, TakeOverDialog_ClickDelegate_o *func, const MethodInfo *method)
{
  ...
  if ( (byte_4DFE3FF & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_TakeOverDialog_OnSliderDragFinished__);
    byte_4DFE3FF = 1;
  }
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1B0DC64;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1B0DC1C;
}
