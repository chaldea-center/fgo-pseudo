        ...
        const MethodInfo *method)
{
  if ( (byte_4A2A5B0 & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_1/*""*/, imageName);
    byte_4A2A5B0 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A5AF & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_20484/*"img_tutorial_txtbg_sq"*/, v8);
    sub_1B761C0(&StringLiteral_20436/*"img_shop_0"*/, v9);
    sub_1B761C0(&StringLiteral_20483/*"img_tutorial_txtbg"*/, v10);
    byte_4A2A5AF = 1;
  }
  if ( item )
  {
          ...
          if ( v16 )
          {
            ...
            if ( gameObject )
            {
              v17 = (System_String_o **)(v16->fields._Kind_k__BackingField == 6
                                       ? &StringLiteral_20484/*"img_tutorial_txtbg_sq"*/
                                       : &StringLiteral_20483/*"img_tutorial_txtbg"*/);
                ...
                switch ( Kind_k__BackingField )
                {
                  ...
                  default:
                    ...
                    if ( Kind_k__BackingField == 21 )
                    {
                      ...
                      v23 = v25;
LABEL_24:
                      AtlasManager__SetShopBanner_37681048(v22, v23, 0LL);
                      return;
                    }
                    if ( !v24 )
                      break;
                    ...
                    {
                      p_ImageName_k__BackingField = (System_String_o **)&StringLiteral_20436/*"img_shop_0"*/;
                    }
                    else
                    {
