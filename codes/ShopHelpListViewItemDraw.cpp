        ...
        const MethodInfo *method)
{
  if ( (byte_4B63094 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_1/*""*/, imageName);
    byte_4B63094 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B63093 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_20780/*"img_tutorial_txtbg_sq"*/, v8);
    sub_1BE4ACC(&StringLiteral_20732/*"img_shop_0"*/, v9);
    sub_1BE4ACC(&StringLiteral_20779/*"img_tutorial_txtbg"*/, v10);
    byte_4B63093 = 1;
  }
  if ( item )
  {
                ...
                switch ( Kind_k__BackingField )
                {
                  ...
                  default:
                    ...
                    if ( Kind_k__BackingField == 21 )
                    {
                      ...
                      v23 = v25;
LABEL_24:
                      AtlasManager__SetShopBanner_38768432(v22, v23, 0LL);
                      return;
                    }
                    if ( !v24 )
                      break;
                    ...
                    {
                      p_ImageName_k__BackingField = (System_String_o **)&StringLiteral_20732/*"img_shop_0"*/;
                    }
                    else
                    {
