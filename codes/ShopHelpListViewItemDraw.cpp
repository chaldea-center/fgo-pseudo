void ShopHelpListViewItemDraw___cctor(const MethodInfo *method)
{
  if ( (byte_4D289FD & 1) == 0 )
  {
    sub_1C94098(&ShopHelpListViewItemDraw_TypeInfo);
    byte_4D289FD = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( isStone )
    v6 = 344.0;
  if ( v5 < 3 )
    LODWORD(position.fields.y) = dword_D3246C[v5];
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D289FB & 1) == 0 )
  {
    this = (ShopHelpListViewItemDraw_o *)sub_1C94098(&ShopHelpListViewItemDraw_TypeInfo);
    byte_4D289FB = 1;
  }
  if ( !item )
    goto LABEL_27;
  ...
  if ( (unsigned int)v16 <= 2 )
    LODWORD(localPosition.fields.y) = dword_D3246C[v16];
  if ( !v12 )
    goto LABEL_27;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D289FA & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_20786/*"img_tutorial_txtbg_sq"*/);
          ...
          if ( v12 )
          {
            ...
            if ( gameObject )
            {
              v13 = (System_String_o **)(v12->fields._Kind_k__BackingField == 6
                                       ? &StringLiteral_20786/*"img_tutorial_txtbg_sq"*/
                                       : &StringLiteral_20785/*"img_tutorial_txtbg"*/);
                ...
                switch ( Kind_k__BackingField )
                {
                  ...
                  default:
                    ...
                    if ( Kind_k__BackingField == 22 )
                    {
                      ...
                      v19 = v21;
LABEL_24:
                      AtlasManager__SetShopBanner_41359164(v18, v19, 0);
                      return;
                    }
                    if ( !v20 )
                      break;
