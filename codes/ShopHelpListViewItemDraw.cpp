void ShopHelpListViewItemDraw___cctor(const MethodInfo *method)
{
  if ( (byte_4C3F23D & 1) == 0 )
  {
    sub_1C37058(&ShopHelpListViewItemDraw_TypeInfo);
    byte_4C3F23D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( isStone )
    v6 = 344.0;
  if ( v5 < 3 )
    LODWORD(position.fields.y) = dword_C47670[v5];
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3F23B & 1) == 0 )
  {
    this = (ShopHelpListViewItemDraw_o *)sub_1C37058(&ShopHelpListViewItemDraw_TypeInfo);
    byte_4C3F23B = 1;
  }
  if ( !item )
    goto LABEL_27;
  ...
  if ( (unsigned int)v16 <= 2 )
    LODWORD(localPosition.fields.y) = dword_C47670[v16];
  if ( !v12 )
    goto LABEL_27;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3F23A & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_20609/*"img_tutorial_txtbg_sq"*/);
    sub_1C37058(&StringLiteral_20553/*"img_shop_0"*/);
    sub_1C37058(&StringLiteral_20608/*"img_tutorial_txtbg"*/);
    byte_4C3F23A = 1;
  }
  if ( item )
  {
    ...
    if ( !mode )
      return;
    ShopHelpListViewItemDraw__SetInfoTextLabel(this, item, v8);
      ...
      if ( info )
      {
        if ( gameObject )
        {
          ...
          if ( v11 )
          {
            ...
            if ( gameObject )
            {
              v12 = (System_String_o **)(v11->fields._Kind_k__BackingField == 6
                                       ? &StringLiteral_20609/*"img_tutorial_txtbg_sq"*/
                                       : &StringLiteral_20608/*"img_tutorial_txtbg"*/);
              UISprite__set_spriteName((UISprite_o *)gameObject, *v12, 0);
              v13 = item->fields.info;
              if ( v13 )
              {
                Kind_k__BackingField = v13->fields._Kind_k__BackingField;
                switch ( Kind_k__BackingField )
                {
                  ...
                  case 21:
                    ...
                    v17 = baseImageSprite;
                    v18 = ImageName_k__BackingField;
                    goto LABEL_24;
                  case 17:
                    v21 = this->fields.baseImageSprite;
                    v22 = v13->fields._ImageName_k__BackingField;
                    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
                      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
                    AtlasManager__SetEventSprite(v21, v22, 0);
                    return;
                  default:
                    v19 = this->fields.baseImageSprite;
                    if ( Kind_k__BackingField == 22 )
                    {
                      v20 = v13->fields._ImageName_k__BackingField;
                      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
                        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
                      v17 = v19;
                      v18 = v20;
LABEL_24:
                      AtlasManager__SetShopBanner_40608536(v17, v18, 0);
                      return;
                    }
                    if ( !v19 )
                      break;
                    ...
                    gameObject = (UnityEngine_Component_o *)System_String__IsNullOrEmpty(
                                                              v23->fields._ImageName_k__BackingField,
                                                              0);
                    if ( ((unsigned __int8)gameObject & 1) != 0 )
                    {
                      p_ImageName_k__BackingField = (System_String_o **)&StringLiteral_20553/*"img_shop_0"*/;
                    }
                    else
                    {
                      ...
                      if ( !v26 )
                        break;
                      p_ImageName_k__BackingField = &v26->fields._ImageName_k__BackingField;
                    }
                    if ( v24 )
                    {
                      UISprite__set_spriteName(v24, *p_ImageName_k__BackingField, 0);
                      return;
                    }
                    break;
                }
