...
void EventPointRewardDialog__OnClickClose(EventPointRewardDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2B0E9 & 1) == 0 )
  {
    sub_1C93AD4(&Method_EventPointRewardDialog_OnClickClose__);
    byte_4D2B0E9 = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_EventPointRewardDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C93AEC(Method_EventPointRewardDialog_OnClickClose__);
...
void EventPointRewardDialog__Open(EventPointRewardDialog_o *this, System_Action_o *callback, const MethodInfo *method)
{
  ...
  if ( (byte_4D2B0E8 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_EventPointRewardDialog_EndOpen__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2B0E7 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_EventPointRewardDialog_OnItemClick__);
    sub_1C93AD4(&int_TypeInfo);
    sub_1C93AD4(&long_TypeInfo);
    sub_1C93AD4(&LocalizationManager_TypeInfo);
    sub_1C93AD4(&StringLiteral_14921/*"UNIT_REST_NONE"*/);
    sub_1C93AD4(&StringLiteral_5672/*"EVENT_POINT_NEXT_NUM"*/);
    sub_1C93AD4(&StringLiteral_5677/*"EVENT_POINT_REWARD_GET"*/);
    sub_1C93AD4(&StringLiteral_5673/*"EVENT_POINT_NEXT_TITLE"*/);
    sub_1C93AD4(&StringLiteral_5678/*"EVENT_POINT_TOTAL_NUM"*/);
    sub_1C93AD4(&StringLiteral_5679/*"EVENT_POINT_TOTAL_TITLE"*/);
    byte_4D2B0E7 = 1;
  }
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v14 = LocalizationManager__Get((System_String_o *)StringLiteral_5677/*"EVENT_POINT_REWARD_GET"*/, 0);
  v15 = System_String__Format(v14, (Il2CppObject *)itemName, 0);
  if ( !titleLabel )
    goto LABEL_17;
  UILabel__set_text(titleLabel, v15, 0);
  totalTitleLabel = this->fields.totalTitleLabel;
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_5679/*"EVENT_POINT_TOTAL_TITLE"*/, 0);
  if ( !totalTitleLabel )
    goto LABEL_17;
  UILabel__set_text(totalTitleLabel, v15, 0);
  totalNumLabel = this->fields.totalNumLabel;
  v19 = LocalizationManager__Get((System_String_o *)StringLiteral_5678/*"EVENT_POINT_TOTAL_NUM"*/, 0);
  v29 = totalCount;
  v20 = (Il2CppObject *)j_il2cpp_value_box_0(long_TypeInfo, &v29);
  v28 = addCount;
  v21 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v28);
  v15 = System_String__Format_64467032(v19, v20, v21, 0);
  if ( !totalNumLabel )
    goto LABEL_17;
  UILabel__set_text(totalNumLabel, v15, 0);
  nextTitleLabel = this->fields.nextTitleLabel;
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_5673/*"EVENT_POINT_NEXT_TITLE"*/, 0);
  if ( !nextTitleLabel )
    goto LABEL_17;
  ...
  if ( nextCount <= 0 )
  {
    v15 = LocalizationManager__Get((System_String_o *)StringLiteral_14921/*"UNIT_REST_NONE"*/, 0);
  }
  else
  {
    v24 = LocalizationManager__Get((System_String_o *)StringLiteral_5672/*"EVENT_POINT_NEXT_NUM"*/, 0);
    v29 = nextCount;
  ...
  if ( !nextNumLabel
    || (UILabel__set_text(nextNumLabel, v15, 0),
        ...
        v27 = (BattleDropItemComponent_ClickDelegate_o *)sub_1C93D20(BattleDropItemComponent_ClickDelegate_TypeInfo),
