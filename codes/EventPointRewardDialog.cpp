        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B03D0 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_EventPointRewardDialog_EndOpen__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B03CF & 1) == 0 )
  {
    ...
    sub_B52984(&Method_EventPointRewardDialog_OnItemClick__);
    sub_B52984(&int_TypeInfo);
    sub_B52984(&long_TypeInfo);
    sub_B52984(&LocalizationManager_TypeInfo);
    sub_B52984(&StringLiteral_14814/*"UNIT_REST_NONE"*/);
    sub_B52984(&StringLiteral_5700/*"EVENT_POINT_NEXT_NUM"*/);
    sub_B52984(&StringLiteral_5705/*"EVENT_POINT_REWARD_GET"*/);
    sub_B52984(&StringLiteral_5701/*"EVENT_POINT_NEXT_TITLE"*/);
    sub_B52984(&StringLiteral_5706/*"EVENT_POINT_TOTAL_NUM"*/);
    sub_B52984(&StringLiteral_5707/*"EVENT_POINT_TOTAL_TITLE"*/);
    byte_42B03CF = 1;
  }
  titleLabel = this->fields.titleLabel;
  if ( (BYTE3(LocalizationManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
  ...
  v14 = LocalizationManager__Get((System_String_o *)StringLiteral_5705/*"EVENT_POINT_REWARD_GET"*/, 0LL);
  v15 = System_String__Format(v14, (Il2CppObject *)itemName, 0LL);
  if ( !titleLabel )
    goto LABEL_22;
  UILabel__set_text(titleLabel, v15, 0LL);
  totalTitleLabel = this->fields.totalTitleLabel;
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_5707/*"EVENT_POINT_TOTAL_TITLE"*/, 0LL);
  if ( !totalTitleLabel )
    goto LABEL_22;
  UILabel__set_text(totalTitleLabel, v15, 0LL);
  totalNumLabel = this->fields.totalNumLabel;
  v19 = LocalizationManager__Get((System_String_o *)StringLiteral_5706/*"EVENT_POINT_TOTAL_NUM"*/, 0LL);
  v29 = totalCount;
  v20 = (Il2CppObject *)j_il2cpp_value_box_0(long_TypeInfo, &v29);
  v28 = addCount;
  v21 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v28);
  v15 = System_String__Format_44563852(v19, v20, v21, 0LL);
  if ( !totalNumLabel )
    goto LABEL_22;
  UILabel__set_text(totalNumLabel, v15, 0LL);
  nextTitleLabel = this->fields.nextTitleLabel;
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_5701/*"EVENT_POINT_NEXT_TITLE"*/, 0LL);
  if ( !nextTitleLabel )
    goto LABEL_22;
  ...
  if ( nextCount <= 0 )
  {
    ...
    v15 = LocalizationManager__Get((System_String_o *)StringLiteral_14814/*"UNIT_REST_NONE"*/, 0LL);
  }
  else
  {
    if ( (WORD1(LocalizationManager_TypeInfo->vtable._0_Equals.methodPtr) & 0x400) != 0
    ...
    v24 = LocalizationManager__Get((System_String_o *)StringLiteral_5700/*"EVENT_POINT_NEXT_NUM"*/, 0LL);
    v29 = nextCount;
    v25 = (Il2CppObject *)j_il2cpp_value_box_0(long_TypeInfo, &v29);
    v15 = System_String__Format(v24, v25, 0LL);
  }
  v16 = v15;
  if ( !nextNumLabel
    || (UILabel__set_text(nextNumLabel, v15, 0LL),
        itemWindow = this->fields.itemWindow,
        v27 = (BattleDropItemComponent_ClickDelegate_o *)sub_B52A54(BattleDropItemComponent_ClickDelegate_TypeInfo),
...
LABEL_22:
  ...
  BattleViewItemlistComponent__setListDataCustomColumn(itemWindow, itemArray, v27, 0, 0LL);
}