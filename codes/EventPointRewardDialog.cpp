...
void __fastcall EventPointRewardDialog__OnClickClose(EventPointRewardDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BAF55C & 1) == 0 )
  {
    sub_1C13D24(&Method_EventPointRewardDialog_OnClickClose__, method);
    byte_4BAF55C = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_EventPointRewardDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C13D3C(Method_EventPointRewardDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAF55B & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_EventPointRewardDialog_EndOpen__, v5);
...
LABEL_11:
    ...
    System_Action___ctor(v11, (Il2CppObject *)this, Method_EventPointRewardDialog_EndOpen__, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAF55A & 1) == 0 )
  {
    sub_1C13D24(&BattleDropItemComponent_ClickDelegate_TypeInfo, itemArray);
    sub_1C13D24(&Method_EventPointRewardDialog_OnItemClick__, v13);
    sub_1C13D24(&int_TypeInfo, v14);
    sub_1C13D24(&long_TypeInfo, v15);
    sub_1C13D24(&LocalizationManager_TypeInfo, v16);
    sub_1C13D24(&StringLiteral_15039/*"UInt32"*/, v17);
    sub_1C13D24(&StringLiteral_5764/*"EVENT_POINT_GIFT_ADD_COMMAND_CODE"*/, v18);
    sub_1C13D24(&StringLiteral_5769/*"EVENT_POINT_NEXT_TITLE"*/, v19);
    sub_1C13D24(&StringLiteral_5765/*"EVENT_POINT_GIFT_ADD_COUNT"*/, v20);
    sub_1C13D24(&StringLiteral_5770/*"EVENT_POINT_NONE_INFO"*/, v21);
    sub_1C13D24(&StringLiteral_5771/*"EVENT_POINT_OPEN_REPLASE_REWARD_"*/, v22);
    byte_4BAF55A = 1;
  }
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v24 = LocalizationManager__Get((System_String_o *)StringLiteral_5769/*"EVENT_POINT_NEXT_TITLE"*/, 0LL);
  v25 = System_String__Format(v24, (Il2CppObject *)itemName, 0LL);
  if ( !titleLabel )
    goto LABEL_17;
  UILabel__set_text(titleLabel, v25, 0LL);
  totalTitleLabel = this->fields.totalTitleLabel;
  v25 = LocalizationManager__Get((System_String_o *)StringLiteral_5771/*"EVENT_POINT_OPEN_REPLASE_REWARD_"*/, 0LL);
  if ( !totalTitleLabel )
    goto LABEL_17;
  UILabel__set_text(totalTitleLabel, v25, 0LL);
  totalNumLabel = this->fields.totalNumLabel;
  v29 = LocalizationManager__Get((System_String_o *)StringLiteral_5770/*"EVENT_POINT_NONE_INFO"*/, 0LL);
  v48 = totalCount;
  ...
  v25 = System_String__Format_62982316(v29, v33, v37, 0LL);
  if ( !totalNumLabel )
    goto LABEL_17;
  UILabel__set_text(totalNumLabel, v25, 0LL);
  nextTitleLabel = this->fields.nextTitleLabel;
  v25 = LocalizationManager__Get((System_String_o *)StringLiteral_5765/*"EVENT_POINT_GIFT_ADD_COUNT"*/, 0LL);
  if ( !nextTitleLabel )
    goto LABEL_17;
  ...
  if ( nextCount <= 0 )
  {
    v25 = LocalizationManager__Get((System_String_o *)StringLiteral_15039/*"UInt32"*/, 0LL);
  }
  else
  {
    v40 = LocalizationManager__Get((System_String_o *)StringLiteral_5764/*"EVENT_POINT_GIFT_ADD_COMMAND_CODE"*/, 0LL);
    v48 = nextCount;
  ...
  if ( !nextNumLabel
    || (UILabel__set_text(nextNumLabel, v25, 0LL),
        ...
        v46 = (BattleDropItemComponent_ClickDelegate_o *)sub_1C13F70(BattleDropItemComponent_ClickDelegate_TypeInfo),
