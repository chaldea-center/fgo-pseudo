...
void __fastcall EventPointRewardDialog__OnClickClose(EventPointRewardDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BF855B & 1) == 0 )
  {
    sub_1C2E12C(&Method_EventPointRewardDialog_OnClickClose__, method);
    byte_4BF855B = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_EventPointRewardDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2E144(Method_EventPointRewardDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF855A & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_EventPointRewardDialog_EndOpen__, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF8559 & 1) == 0 )
  {
    sub_1C2E12C(&BattleDropItemComponent_ClickDelegate_TypeInfo, itemArray);
    sub_1C2E12C(&Method_EventPointRewardDialog_OnItemClick__, v13);
    sub_1C2E12C(&int_TypeInfo, v14);
    sub_1C2E12C(&long_TypeInfo, v15);
    sub_1C2E12C(&LocalizationManager_TypeInfo, v16);
    sub_1C2E12C(&StringLiteral_15072/*"UNIT_REST_NONE"*/, v17);
    sub_1C2E12C(&StringLiteral_5769/*"EVENT_POINT_NEXT_NUM"*/, v18);
    sub_1C2E12C(&StringLiteral_5774/*"EVENT_POINT_REWARD_GET"*/, v19);
    sub_1C2E12C(&StringLiteral_5770/*"EVENT_POINT_NEXT_TITLE"*/, v20);
    sub_1C2E12C(&StringLiteral_5775/*"EVENT_POINT_TOTAL_NUM"*/, v21);
    sub_1C2E12C(&StringLiteral_5776/*"EVENT_POINT_TOTAL_TITLE"*/, v22);
    byte_4BF8559 = 1;
  }
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v24 = LocalizationManager__Get((System_String_o *)StringLiteral_5774/*"EVENT_POINT_REWARD_GET"*/, 0LL);
  v25 = System_String__Format(v24, (Il2CppObject *)itemName, 0LL);
  if ( !titleLabel )
    goto LABEL_17;
  UILabel__set_text(titleLabel, v25, 0LL);
  totalTitleLabel = this->fields.totalTitleLabel;
  v25 = LocalizationManager__Get((System_String_o *)StringLiteral_5776/*"EVENT_POINT_TOTAL_TITLE"*/, 0LL);
  if ( !totalTitleLabel )
    goto LABEL_17;
  UILabel__set_text(totalTitleLabel, v25, 0LL);
  totalNumLabel = this->fields.totalNumLabel;
  v29 = LocalizationManager__Get((System_String_o *)StringLiteral_5775/*"EVENT_POINT_TOTAL_NUM"*/, 0LL);
  v48 = totalCount;
  ...
  v25 = System_String__Format_63249956(v29, v33, v37, 0LL);
  if ( !totalNumLabel )
    goto LABEL_17;
  UILabel__set_text(totalNumLabel, v25, 0LL);
  nextTitleLabel = this->fields.nextTitleLabel;
  v25 = LocalizationManager__Get((System_String_o *)StringLiteral_5770/*"EVENT_POINT_NEXT_TITLE"*/, 0LL);
  if ( !nextTitleLabel )
    goto LABEL_17;
  ...
  if ( nextCount <= 0 )
  {
    v25 = LocalizationManager__Get((System_String_o *)StringLiteral_15072/*"UNIT_REST_NONE"*/, 0LL);
  }
  else
  {
    v40 = LocalizationManager__Get((System_String_o *)StringLiteral_5769/*"EVENT_POINT_NEXT_NUM"*/, 0LL);
    v48 = nextCount;
  ...
  if ( !nextNumLabel
    || (UILabel__set_text(nextNumLabel, v25, 0LL),
        ...
        v46 = (BattleDropItemComponent_ClickDelegate_o *)sub_1C2E378(BattleDropItemComponent_ClickDelegate_TypeInfo),
