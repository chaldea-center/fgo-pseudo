...
void __fastcall EventPointRewardDialog__OnClickClose(EventPointRewardDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1CCDB & 1) == 0 )
  {
    sub_1C3B764(&Method_EventPointRewardDialog_OnClickClose__, method);
    byte_4C1CCDB = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_EventPointRewardDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3B77C(Method_EventPointRewardDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1CCDA & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_EventPointRewardDialog_EndOpen__, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1CCD9 & 1) == 0 )
  {
    sub_1C3B764(&BattleDropItemComponent_ClickDelegate_TypeInfo, itemArray);
    sub_1C3B764(&Method_EventPointRewardDialog_OnItemClick__, v13);
    sub_1C3B764(&int_TypeInfo, v14);
    sub_1C3B764(&long_TypeInfo, v15);
    sub_1C3B764(&LocalizationManager_TypeInfo, v16);
    sub_1C3B764(&StringLiteral_15100/*"WARBOARD_SORTIE_CONFIRMATION_NO"*/, v17);
    sub_1C3B764(&StringLiteral_5770/*"Effect/EventShop"*/, v18);
    sub_1C3B764(&StringLiteral_5775/*"Effect/SideEffect/"*/, v19);
    sub_1C3B764(&StringLiteral_5771/*"Effect/Race"*/, v20);
    sub_1C3B764(&StringLiteral_5776/*"Effect/Skin/{0:D2}"*/, v21);
    sub_1C3B764(&StringLiteral_5777/*"Effect/Soundplayer"*/, v22);
    byte_4C1CCD9 = 1;
  }
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v24 = LocalizationManager__Get((System_String_o *)StringLiteral_5775/*"Effect/SideEffect/"*/, 0LL);
  v25 = System_String__Format(v24, (Il2CppObject *)itemName, 0LL);
  if ( !titleLabel )
    goto LABEL_17;
  UILabel__set_text(titleLabel, v25, 0LL);
  totalTitleLabel = this->fields.totalTitleLabel;
  v25 = LocalizationManager__Get((System_String_o *)StringLiteral_5777/*"Effect/Soundplayer"*/, 0LL);
  if ( !totalTitleLabel )
    goto LABEL_17;
  UILabel__set_text(totalTitleLabel, v25, 0LL);
  totalNumLabel = this->fields.totalNumLabel;
  v29 = LocalizationManager__Get((System_String_o *)StringLiteral_5776/*"Effect/Skin/{0:D2}"*/, 0LL);
  v48 = totalCount;
  ...
  v25 = System_String__Format_63382984(v29, v33, v37, 0LL);
  if ( !totalNumLabel )
    goto LABEL_17;
  UILabel__set_text(totalNumLabel, v25, 0LL);
  nextTitleLabel = this->fields.nextTitleLabel;
  v25 = LocalizationManager__Get((System_String_o *)StringLiteral_5771/*"Effect/Race"*/, 0LL);
  if ( !nextTitleLabel )
    goto LABEL_17;
  ...
  if ( nextCount <= 0 )
  {
    v25 = LocalizationManager__Get((System_String_o *)StringLiteral_15100/*"WARBOARD_SORTIE_CONFIRMATION_NO"*/, 0LL);
  }
  else
  {
    v40 = LocalizationManager__Get((System_String_o *)StringLiteral_5770/*"Effect/EventShop"*/, 0LL);
    v48 = nextCount;
  ...
  if ( !nextNumLabel
    || (UILabel__set_text(nextNumLabel, v25, 0LL),
        ...
        v46 = (BattleDropItemComponent_ClickDelegate_o *)sub_1C3B9B0(BattleDropItemComponent_ClickDelegate_TypeInfo),
