...
void __fastcall EventPointRewardDialog__OnClickClose(EventPointRewardDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A23C7A & 1) == 0 )
  {
    sub_1B715CC(&Method_EventPointRewardDialog_OnClickClose__, method);
    byte_4A23C7A = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_EventPointRewardDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B715E4(Method_EventPointRewardDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A23C79 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_EventPointRewardDialog_EndOpen__, v6);
    sub_1B715CC(&LocalizationManager_TypeInfo, v7);
    sub_1B715CC(&StringLiteral_3738/*"COMMON_CONFIRM_CLOSE"*/, v8);
    byte_4A23C79 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A23C78 & 1) == 0 )
  {
    sub_1B715CC(&BattleDropItemComponent_ClickDelegate_TypeInfo, itemArray);
    sub_1B715CC(&Method_EventPointRewardDialog_OnItemClick__, v13);
    sub_1B715CC(&int_TypeInfo, v14);
    sub_1B715CC(&long_TypeInfo, v15);
    sub_1B715CC(&LocalizationManager_TypeInfo, v16);
    sub_1B715CC(&StringLiteral_14752/*"UNIT_REST_NONE"*/, v17);
    sub_1B715CC(&StringLiteral_5631/*"EVENT_POINT_NEXT_NUM"*/, v18);
    sub_1B715CC(&StringLiteral_5636/*"EVENT_POINT_REWARD_GET"*/, v19);
    sub_1B715CC(&StringLiteral_5632/*"EVENT_POINT_NEXT_TITLE"*/, v20);
    sub_1B715CC(&StringLiteral_5637/*"EVENT_POINT_TOTAL_NUM"*/, v21);
    sub_1B715CC(&StringLiteral_5638/*"EVENT_POINT_TOTAL_TITLE"*/, v22);
    byte_4A23C78 = 1;
  }
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v24 = LocalizationManager__Get((System_String_o *)StringLiteral_5636/*"EVENT_POINT_REWARD_GET"*/, 0LL);
  v25 = System_String__Format(v24, (Il2CppObject *)itemName, 0LL);
  if ( !titleLabel )
    goto LABEL_17;
  UILabel__set_text(titleLabel, v25, 0LL);
  totalTitleLabel = this->fields.totalTitleLabel;
  v25 = LocalizationManager__Get((System_String_o *)StringLiteral_5638/*"EVENT_POINT_TOTAL_TITLE"*/, 0LL);
  if ( !totalTitleLabel )
    goto LABEL_17;
  UILabel__set_text(totalTitleLabel, v25, 0LL);
  totalNumLabel = this->fields.totalNumLabel;
  v29 = LocalizationManager__Get((System_String_o *)StringLiteral_5637/*"EVENT_POINT_TOTAL_NUM"*/, 0LL);
  v48 = totalCount;
  ...
  v25 = System_String__Format_61519876(v29, v33, v37, 0LL);
  if ( !totalNumLabel )
    goto LABEL_17;
  UILabel__set_text(totalNumLabel, v25, 0LL);
  nextTitleLabel = this->fields.nextTitleLabel;
  v25 = LocalizationManager__Get((System_String_o *)StringLiteral_5632/*"EVENT_POINT_NEXT_TITLE"*/, 0LL);
  if ( !nextTitleLabel )
    goto LABEL_17;
  ...
  if ( nextCount <= 0 )
  {
    v25 = LocalizationManager__Get((System_String_o *)StringLiteral_14752/*"UNIT_REST_NONE"*/, 0LL);
  }
  else
  {
    v40 = LocalizationManager__Get((System_String_o *)StringLiteral_5631/*"EVENT_POINT_NEXT_NUM"*/, 0LL);
    v48 = nextCount;
  ...
  if ( !nextNumLabel
    || (UILabel__set_text(nextNumLabel, v25, 0LL),
        ...
        v46 = (BattleDropItemComponent_ClickDelegate_o *)sub_1B71818(BattleDropItemComponent_ClickDelegate_TypeInfo),
