...
void __fastcall EventPointRewardDialog__OnClickClose(EventPointRewardDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A02664 & 1) == 0 )
  {
    sub_1B64870(&Method_EventPointRewardDialog_OnClickClose__, method);
    byte_4A02664 = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_EventPointRewardDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B64888(Method_EventPointRewardDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02663 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_EventPointRewardDialog_EndOpen__, v6);
    sub_1B64870(&LocalizationManager_TypeInfo, v7);
    sub_1B64870(&StringLiteral_3733/*"COMMON_CONFIRM_CLOSE"*/, v8);
    byte_4A02663 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02662 & 1) == 0 )
  {
    sub_1B64870(&BattleDropItemComponent_ClickDelegate_TypeInfo, itemArray);
    sub_1B64870(&Method_EventPointRewardDialog_OnItemClick__, v13);
    sub_1B64870(&int_TypeInfo, v14);
    sub_1B64870(&long_TypeInfo, v15);
    sub_1B64870(&LocalizationManager_TypeInfo, v16);
    sub_1B64870(&StringLiteral_14734/*"UNIT_REST_NONE"*/, v17);
    sub_1B64870(&StringLiteral_5625/*"EVENT_POINT_NEXT_NUM"*/, v18);
    sub_1B64870(&StringLiteral_5630/*"EVENT_POINT_REWARD_GET"*/, v19);
    sub_1B64870(&StringLiteral_5626/*"EVENT_POINT_NEXT_TITLE"*/, v20);
    sub_1B64870(&StringLiteral_5631/*"EVENT_POINT_TOTAL_NUM"*/, v21);
    sub_1B64870(&StringLiteral_5632/*"EVENT_POINT_TOTAL_TITLE"*/, v22);
    byte_4A02662 = 1;
  }
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
  ...
  v29 = LocalizationManager__Get((System_String_o *)StringLiteral_5631/*"EVENT_POINT_TOTAL_NUM"*/, 0LL);
  v48 = totalCount;
  ...
  v25 = System_String__Format_61397948(v29, v33, v37, 0LL);
  if ( !totalNumLabel )
    goto LABEL_17;
  ...
  if ( nextCount <= 0 )
  {
    v25 = LocalizationManager__Get((System_String_o *)StringLiteral_14734/*"UNIT_REST_NONE"*/, 0LL);
  }
  else
  {
    v40 = LocalizationManager__Get((System_String_o *)StringLiteral_5625/*"EVENT_POINT_NEXT_NUM"*/, 0LL);
    v48 = nextCount;
  ...
  if ( !nextNumLabel
    || (UILabel__set_text(nextNumLabel, v25, 0LL),
        ...
        v46 = (BattleDropItemComponent_ClickDelegate_o *)sub_1B64ABC(BattleDropItemComponent_ClickDelegate_TypeInfo),
