...
void __fastcall EventPointRewardDialog__OnClickClose(EventPointRewardDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A02C85 & 1) == 0 )
  {
    sub_1B64A00(&Method_EventPointRewardDialog_OnClickClose__, method);
    byte_4A02C85 = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_EventPointRewardDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B64A18(Method_EventPointRewardDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02C84 & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_EventPointRewardDialog_EndOpen__, v6);
    sub_1B64A00(&LocalizationManager_TypeInfo, v7);
    sub_1B64A00(&StringLiteral_3734/*"COMMON_CONFIRM_CLOSE"*/, v8);
    byte_4A02C84 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02C83 & 1) == 0 )
  {
    sub_1B64A00(&BattleDropItemComponent_ClickDelegate_TypeInfo, itemArray);
    sub_1B64A00(&Method_EventPointRewardDialog_OnItemClick__, v13);
    sub_1B64A00(&int_TypeInfo, v14);
    sub_1B64A00(&long_TypeInfo, v15);
    sub_1B64A00(&LocalizationManager_TypeInfo, v16);
    sub_1B64A00(&StringLiteral_14735/*"UNIT_REST_NONE"*/, v17);
    sub_1B64A00(&StringLiteral_5626/*"EVENT_POINT_NEXT_NUM"*/, v18);
    sub_1B64A00(&StringLiteral_5631/*"EVENT_POINT_REWARD_GET"*/, v19);
    sub_1B64A00(&StringLiteral_5627/*"EVENT_POINT_NEXT_TITLE"*/, v20);
    sub_1B64A00(&StringLiteral_5632/*"EVENT_POINT_TOTAL_NUM"*/, v21);
    sub_1B64A00(&StringLiteral_5633/*"EVENT_POINT_TOTAL_TITLE"*/, v22);
    byte_4A02C83 = 1;
  }
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
  ...
  v25 = System_String__Format_61399508(v29, v33, v37, 0LL);
  if ( !totalNumLabel )
    goto LABEL_17;
  ...
  if ( nextCount <= 0 )
  {
    v25 = LocalizationManager__Get((System_String_o *)StringLiteral_14735/*"UNIT_REST_NONE"*/, 0LL);
  }
  else
  {
  ...
  if ( !nextNumLabel
    || (UILabel__set_text(nextNumLabel, v25, 0LL),
        ...
        v46 = (BattleDropItemComponent_ClickDelegate_o *)sub_1B64C4C(BattleDropItemComponent_ClickDelegate_TypeInfo),
