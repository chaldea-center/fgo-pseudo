...
void EventPointRewardDialog__OnClickClose(EventPointRewardDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_59329B9 & 1) == 0 )
  {
    sub_21FFC50(&Method_EventPointRewardDialog_OnClickClose__);
    byte_59329B9 = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_EventPointRewardDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_21FFC68(Method_EventPointRewardDialog_OnClickClose__);
...
void EventPointRewardDialog__Open(EventPointRewardDialog_o *this, System_Action_o *callback, const MethodInfo *method)
{
  ...
  if ( (byte_59329B8 & 1) == 0 )
  {
    ...
    sub_21FFC50(&Method_EventPointRewardDialog_EndOpen__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_59329B7 & 1) == 0 )
  {
    ...
    sub_21FFC50(&Method_EventPointRewardDialog_OnItemClick__);
    sub_21FFC50(&LocalizationManager_TypeInfo);
    sub_21FFC50(&StringLiteral_15386/*"UNIT_REST_NONE"*/);
    sub_21FFC50(&StringLiteral_5865/*"EVENT_POINT_NEXT_NUM"*/);
    sub_21FFC50(&StringLiteral_5870/*"EVENT_POINT_REWARD_GET"*/);
    sub_21FFC50(&StringLiteral_5866/*"EVENT_POINT_NEXT_TITLE"*/);
    sub_21FFC50(&StringLiteral_5871/*"EVENT_POINT_TOTAL_NUM"*/);
    sub_21FFC50(&StringLiteral_5872/*"EVENT_POINT_TOTAL_TITLE"*/);
    byte_59329B7 = 1;
  }
  titleLabel = this->fields.titleLabel;
  if ( !*(&LocalizationManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, itemArray, itemName);
  v14 = LocalizationManager__Get((System_String_o *)StringLiteral_5870/*"EVENT_POINT_REWARD_GET"*/, 0);
  v15 = System_String__Format(v14, (Il2CppObject *)itemName, 0);
  if ( !titleLabel )
    goto LABEL_19;
  UILabel__set_text(titleLabel, v15, 0);
  totalTitleLabel = this->fields.totalTitleLabel;
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_5872/*"EVENT_POINT_TOTAL_TITLE"*/, 0);
  if ( !totalTitleLabel )
    goto LABEL_19;
  UILabel__set_text(totalTitleLabel, v15, 0);
  totalNumLabel = this->fields.totalNumLabel;
  v19 = LocalizationManager__Get((System_String_o *)StringLiteral_5871/*"EVENT_POINT_TOTAL_NUM"*/, 0);
  v32 = totalCount;
  v20 = (Il2CppObject *)j_il2cpp_value_box_0(qword_594C090, &v32);
  v31 = addCount;
  v21 = (Il2CppObject *)j_il2cpp_value_box_0(qword_594C070, &v31);
  v15 = System_String__Format_75484576(v19, v20, v21, 0);
  if ( !totalNumLabel )
    goto LABEL_19;
  UILabel__set_text(totalNumLabel, v15, 0);
  nextTitleLabel = this->fields.nextTitleLabel;
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_5866/*"EVENT_POINT_NEXT_TITLE"*/, 0);
  if ( !nextTitleLabel )
    goto LABEL_19;
  ...
  if ( nextCount <= 0 )
  {
    ...
    v15 = LocalizationManager__Get((System_String_o *)StringLiteral_15386/*"UNIT_REST_NONE"*/, 0);
  }
  else
  {
    if ( !v26 )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, v23, v24);
    v27 = LocalizationManager__Get((System_String_o *)StringLiteral_5865/*"EVENT_POINT_NEXT_NUM"*/, 0);
    v32 = nextCount;
    v28 = (Il2CppObject *)j_il2cpp_value_box_0(qword_594C090, &v32);
  ...
  if ( !nextNumLabel
    || (UILabel__set_text(nextNumLabel, v15, 0),
        ...
        v30 = (BattleDropItemComponent_ClickDelegate_o *)sub_21FFEBC(BattleDropItemComponent_ClickDelegate_TypeInfo),
