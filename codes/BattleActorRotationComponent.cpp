        ...
        const MethodInfo *method)
{
  ...
  v5 = transform;
  *(UnityEngine_Quaternion_o *)&v7 = UnityEngine_Quaternion__Euler(0.0, v4, 0.0, 0LL);
  if ( !v5 )
    sub_B0D97C(v6);
  UnityEngine_Transform__set_localRotation(v5, *(UnityEngine_Quaternion_o *)&v7, 0LL);
}
...
void __fastcall BattleActorRotationComponent__Update(BattleActorRotationComponent_o *this, const MethodInfo *method)
{
  ...
  if ( RotationSpeed_Y_low )
  {
    ...
    v9 = transform;
    *(UnityEngine_Quaternion_o *)&v11 = UnityEngine_Quaternion__Euler(0.0, v8, 0.0, 0LL);
    if ( !v9 )
      sub_B0D97C(v10);
    UnityEngine_Transform__set_localRotation(v9, *(UnityEngine_Quaternion_o *)&v11, 0LL);
  }
}
