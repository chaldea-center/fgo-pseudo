        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B673E8 & 1) == 0 )
  {
    sub_1BE4ACC(&AtlasManager_TypeInfo, *(_QWORD *)&itemId);
    byte_4B673E8 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B673E9 & 1) == 0 )
  {
    sub_1BE4ACC(&int_TypeInfo, *(_QWORD *)&itemNum);
    sub_1BE4ACC(&LocalizationManager_TypeInfo, v9);
    sub_1BE4ACC(&StringLiteral_5681/*"EVENT_CONQUEST_ITEM_FORMAT"*/, v10);
    sub_1BE4ACC(&StringLiteral_5684/*"EVENT_CONQUEST_PRODUCT_FORMAT"*/, v11);
    byte_4B673E9 = 1;
  }
  itemNumLabel = this->fields.itemNumLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v13 = LocalizationManager__Get((System_String_o *)StringLiteral_5681/*"EVENT_CONQUEST_ITEM_FORMAT"*/, 0LL);
  v27 = itemNum;
  ...
  v21 = LocalizationManager__Get((System_String_o *)StringLiteral_5684/*"EVENT_CONQUEST_PRODUCT_FORMAT"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B673E7 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_5685/*"EVENT_CONQUEST_PRODUCT_NUM"*/, v4);
    sub_1BE4ACC(&StringLiteral_5682/*"EVENT_CONQUEST_ITEM_NUM"*/, v5);
    byte_4B673E7 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(itemNumTitleLabel, 0LL, 0LL) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v8 = LocalizationManager__Get((System_String_o *)StringLiteral_5682/*"EVENT_CONQUEST_ITEM_NUM"*/, 0LL);
    if ( !v7 )
      goto LABEL_20;
  ...
  if ( UnityEngine_Object__op_Inequality(productNumTitleLabel, 0LL, 0LL) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v8 = LocalizationManager__Get((System_String_o *)StringLiteral_5685/*"EVENT_CONQUEST_PRODUCT_NUM"*/, 0LL);
    if ( v11 )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B673EA & 1) == 0 )
  {
    sub_1BE4ACC(&EventInfoConquestItemCounterComponent__anim_d__21_TypeInfo, method);
    byte_4B673EA = 1;
  }
  v3 = sub_1BE4D18(EventInfoConquestItemCounterComponent__anim_d__21_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B673EB & 1) == 0 )
  {
    this = (EventInfoConquestItemCounterComponent__anim_d__21_o *)sub_1BE4ACC(&UnityEngine_Application_TypeInfo, method);
    byte_4B673EB = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BE4AE0(&Method_EventInfoConquestItemCounterComponent__anim_d__21_System_Collections_IEnumerator_Reset__);
  sub_1BE4BF4(v3, v4);
}
