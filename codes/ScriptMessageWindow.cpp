...
{
  *(_OWORD *)&this->fields.talkNameBackBaseWidth = xmmword_BA2AC0;
        ...
        const MethodInfo *method)
{
  ...
  if ( !child
    || (v4 = this,
        UnityEngine_Transform__SetParent_69158724(child, this->fields.messageScroll, 0, 0LL),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0073B & 1) == 0 )
  {
    sub_1B64A00(&Method_UnityEngine_GameObject_AddComponent_ScriptMessageGestureReciver___, src);
    sub_1B64A00(&Method_UnityEngine_GameObject_AddComponent_UITouchPressMarge___, v5);
    sub_1B64A00(&Method_UnityEngine_GameObject_GetComponent_ScriptMessageGestureReciver___, v6);
    sub_1B64A00(&Method_UnityEngine_GameObject_GetComponent_UITouchPressMarge___, v7);
    byte_4A0073B = 1;
  }
  ...
  messageBackBase = (UnityEngine_Component_o *)UnityEngine_GameObject__AddComponent_object_(
                                                 ...
                                                 (const MethodInfo_2E8A6E4 *)Method_UnityEngine_GameObject_AddComponent_ScriptMessageGestureReciver___);
  if ( !src )
    goto LABEL_17;
  v9 = messageBackBase;
  ...
  messageBackBase = (UnityEngine_Component_o *)UnityEngine_GameObject__GetComponent_object_(
                                                 (UnityEngine_GameObject_o *)messageBackBase,
                                                 (const MethodInfo_2E8A7CC *)Method_UnityEngine_GameObject_GetComponent_ScriptMessageGestureReciver___);
  if ( !messageBackBase )
    goto LABEL_17;
  if ( !v9 )
    goto LABEL_17;
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&v9[1].monitor, (int32_t)monitor, v10, v11);
  messageBackBase = (UnityEngine_Component_o *)this->fields.messageBackBase;
  if ( !messageBackBase
    || (messageBackBase = (UnityEngine_Component_o *)UnityEngine_Component__get_gameObject(messageBackBase, 0LL)) == 0LL
    || (messageBackBase = (UnityEngine_Component_o *)UnityEngine_GameObject__AddComponent_object_(
                                                       (UnityEngine_GameObject_o *)messageBackBase,
                                                       (const MethodInfo_2E8A6E4 *)Method_UnityEngine_GameObject_AddComponent_UITouchPressMarge___),
    ...
    || (messageBackBase = (UnityEngine_Component_o *)UnityEngine_GameObject__GetComponent_object_(
                                                       (UnityEngine_GameObject_o *)messageBackBase,
                                                       (const MethodInfo_2E8A7CC *)Method_UnityEngine_GameObject_GetComponent_UITouchPressMarge___)) == 0LL
    || !v14 )
  {
LABEL_17:
    sub_1B64C5C(messageBackBase, src);
  }
  v17 = messageBackBase[1].monitor;
  v14[1].monitor = v17;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&v14[1].monitor, (int32_t)v17, v15, v16);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0073C & 1) == 0 )
  {
    sub_1B64A00(&Method_UnityEngine_Component_GetComponent_BoxCollider___, isEnable);
...
LABEL_9:
    sub_1B64C5C(messageBackBase, isEnable);
  }
}
