...
{
  *(_OWORD *)&this->fields.talkNameBackBaseWidth = xmmword_C11860;
        ...
        const MethodInfo *method)
{
  ...
  if ( !child
    || (v4 = this,
        UnityEngine_Transform__SetParent_71364824(child, this->fields.messageScroll, 0, 0),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C58D8E & 1) == 0 )
  {
    sub_1C3E564(&Method_UnityEngine_GameObject_AddComponent_ScriptMessageGestureReciver___);
    sub_1C3E564(&Method_UnityEngine_GameObject_AddComponent_UITouchPressMarge___);
    sub_1C3E564(&Method_UnityEngine_GameObject_GetComponent_ScriptMessageGestureReciver___);
    sub_1C3E564(&Method_UnityEngine_GameObject_GetComponent_UITouchPressMarge___);
    byte_4C58D8E = 1;
  }
  ...
  messageBackBase = (UnityEngine_Component_o *)UnityEngine_GameObject__AddComponent_object_(
                                                 ...
                                                 (const MethodInfo_3150FE4 *)Method_UnityEngine_GameObject_AddComponent_ScriptMessageGestureReciver___);
  if ( !src )
    goto LABEL_17;
  v6 = messageBackBase;
  ...
  messageBackBase = (UnityEngine_Component_o *)UnityEngine_GameObject__GetComponent_object_(
                                                 (UnityEngine_GameObject_o *)messageBackBase,
                                                 (const MethodInfo_31510CC *)Method_UnityEngine_GameObject_GetComponent_ScriptMessageGestureReciver___);
  if ( !messageBackBase )
    goto LABEL_17;
  if ( !v6 )
    goto LABEL_17;
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&v6[1].monitor, (int32_t)monitor, v7, v8);
  messageBackBase = (UnityEngine_Component_o *)this->fields.messageBackBase;
  if ( !messageBackBase
    || (messageBackBase = (UnityEngine_Component_o *)UnityEngine_Component__get_gameObject(messageBackBase, 0)) == 0
    || (messageBackBase = (UnityEngine_Component_o *)UnityEngine_GameObject__AddComponent_object_(
                                                       (UnityEngine_GameObject_o *)messageBackBase,
                                                       (const MethodInfo_3150FE4 *)Method_UnityEngine_GameObject_AddComponent_UITouchPressMarge___),
    ...
    || (messageBackBase = (UnityEngine_Component_o *)UnityEngine_GameObject__GetComponent_object_(
                                                       (UnityEngine_GameObject_o *)messageBackBase,
                                                       (const MethodInfo_31510CC *)Method_UnityEngine_GameObject_GetComponent_UITouchPressMarge___)) == 0
    || !v11 )
  {
LABEL_17:
    sub_1C3E7C0(messageBackBase, src);
  }
  v14 = messageBackBase[1].monitor;
  v11[1].monitor = v14;
  sub_1C3E508((CGThumbnailListItem_o *)&v11[1].monitor, (int32_t)v14, v12, v13);
}
...
LABEL_9:
    sub_1C3E7C0(messageBackBase, isEnable);
  }
}
