...
{
  *(_OWORD *)&this->fields.talkNameBackBaseWidth = xmmword_BE1660;
        ...
        const MethodInfo *method)
{
  ...
  if ( !child
    || (v4 = this,
        UnityEngine_Transform__SetParent_70473248(child, this->fields.messageScroll, 0, 0LL),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B688A2 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_UnityEngine_GameObject_AddComponent_ScriptMessageGestureReciver___, src);
    sub_1BE4ACC(&Method_UnityEngine_GameObject_AddComponent_UITouchPressMarge___, v5);
    sub_1BE4ACC(&Method_UnityEngine_GameObject_GetComponent_ScriptMessageGestureReciver___, v6);
    sub_1BE4ACC(&Method_UnityEngine_GameObject_GetComponent_UITouchPressMarge___, v7);
    byte_4B688A2 = 1;
  }
  ...
  messageBackBase = (UnityEngine_Component_o *)UnityEngine_GameObject__AddComponent_object_(
                                                 ...
                                                 (const MethodInfo_2FA96B4 *)Method_UnityEngine_GameObject_AddComponent_ScriptMessageGestureReciver___);
  if ( !src )
    goto LABEL_17;
  v9 = messageBackBase;
  ...
  messageBackBase = (UnityEngine_Component_o *)UnityEngine_GameObject__GetComponent_object_(
                                                 (UnityEngine_GameObject_o *)messageBackBase,
                                                 (const MethodInfo_2FA979C *)Method_UnityEngine_GameObject_GetComponent_ScriptMessageGestureReciver___);
  if ( !messageBackBase )
    goto LABEL_17;
  if ( !v9 )
    goto LABEL_17;
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&v9[1].monitor, monitor, v10, v11, v12, v13, v14, v15);
  messageBackBase = (UnityEngine_Component_o *)this->fields.messageBackBase;
  if ( !messageBackBase
    || (messageBackBase = (UnityEngine_Component_o *)UnityEngine_Component__get_gameObject(messageBackBase, 0LL)) == 0LL
    || (messageBackBase = (UnityEngine_Component_o *)UnityEngine_GameObject__AddComponent_object_(
                                                       (UnityEngine_GameObject_o *)messageBackBase,
                                                       (const MethodInfo_2FA96B4 *)Method_UnityEngine_GameObject_AddComponent_UITouchPressMarge___),
    ...
    || (messageBackBase = (UnityEngine_Component_o *)UnityEngine_GameObject__GetComponent_object_(
                                                       (UnityEngine_GameObject_o *)messageBackBase,
                                                       (const MethodInfo_2FA979C *)Method_UnityEngine_GameObject_GetComponent_UITouchPressMarge___)) == 0LL
    || !v18 )
  {
LABEL_17:
    sub_1BE4D28(messageBackBase, src);
  }
  v25 = (int64_t)messageBackBase[1].monitor;
  v18[1].monitor = (void *)v25;
  sub_1BE4A70((PartyOrganizationUtility_o *)&v18[1].monitor, v25, v19, v20, v21, v22, v23, v24);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B688A3 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_UnityEngine_Component_GetComponent_BoxCollider___, isEnable);
...
LABEL_9:
    sub_1BE4D28(messageBackBase, isEnable);
  }
}
