        ...
        const MethodInfo *method)
{
  ...
  const MethodInfo_3997FCC *v38; // x2
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)effetctPrefab, 0, 0) )
  {
    if ( doInstantiate )
    {
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      v20 = UnityEngine_Object__Instantiate_object__52598548(
    ...
    sub_1C9403C((GrandQuestFolderBoardItem_o *)p_effectObject, v21, v14, v15, v16, v17, v18, v19);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2A3E3 & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_WarBoardCommonEffectPerformance_AnimantionEndCallback__);
    byte_4D2A3E3 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2A3E4 & 1) == 0 )
  {
    sub_1C94098(&WarBoardCommonEffectPerformance__Execute_d__12_TypeInfo);
    byte_4D2A3E4 = 1;
  }
  v3 = sub_1C942E4(WarBoardCommonEffectPerformance__Execute_d__12_TypeInfo);
...
void WarBoardCommonEffectPerformance__OnEnd(WarBoardCommonEffectPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(effectObject, 0, 0) )
  {
    ...
    if ( this->fields.destroyOnEnd )
    {
      ...
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      UnityEngine_Object__Destroy_72110972((UnityEngine_Object_o *)v12, 0);
    }
    *p_effectObject = 0;
...
void WarBoardCommonEffectPerformance__OnStart(WarBoardCommonEffectPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2A3E2 & 1) == 0 )
  {
    sub_1C94098(&System_Action_TypeInfo);
    sub_1C94098(&UnityEngine_Object_TypeInfo);
    sub_1C94098(&Method_WarBoardCommonEffectPerformance_AnimantionEndStartCallback__);
    byte_4D2A3E2 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2A3E6 & 1) == 0 )
  {
    ...
    this = (WarBoardCommonEffectPerformance__Execute_d__12_o *)sub_1C94098(&Method_WarBoardCommonEffectPerformance__Execute_b__12_0__);
    byte_4D2A3E6 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C940AC(&Method_WarBoardCommonEffectPerformance__Execute_d__12_System_Collections_IEnumerator_Reset__);
  sub_1C941C0(v3, v4);
}
