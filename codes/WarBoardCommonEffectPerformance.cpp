        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)effetctPrefab, 0, 0) )
  {
    ...
    sub_1C32BC4((CGThumbnailListItem_o *)p_effectObject, v17, v14, v15);
    ...
    sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.commonEffect, (int32_t)Component_object, v22, v23);
    ...
    if ( hasValue )
    {
      ...
      *(_QWORD *)&v33.fields.hasValue = &v32;
      *(_QWORD *)&v33.fields.value.fields.y = Method_System_Nullable_Vector3__get_Value__;
      Value = System_Nullable_Vector3___get_Value(v33, v25);
      if ( !transform )
        goto LABEL_33;
      if ( isLocal )
    ...
    if ( v31.fields.hasValue )
    {
      ...
      *(_QWORD *)&v34.fields.hasValue = &v31;
      *(_QWORD *)&v34.fields.value.fields.y = Method_System_Nullable_Vector3__get_Value__;
      v37 = System_Nullable_Vector3___get_Value(v34, v27);
      if ( !v26 )
        goto LABEL_33;
      if ( !isLocal )
      {
        UnityEngine_Transform__set_eulerAngles(v26, v37, 0);
LABEL_30:
        effectObject = this->fields.effectObject;
...
LABEL_33:
      ...
      UnityEngine_Transform__set_localEulerAngles(v26, v37, 0);
    }
    if ( v30.fields.hasValue && isLocal )
    {
      effectObject = (UnityEngine_GameObject_o *)*p_commonEffect;
      if ( !*p_commonEffect )
        goto LABEL_33;
      v28 = UnityEngine_Component__get_transform((UnityEngine_Component_o *)effectObject, 0);
      *(_QWORD *)&v35.fields.hasValue = &v30;
      *(_QWORD *)&v35.fields.value.fields.y = Method_System_Nullable_Vector3__get_Value__;
      v38 = System_Nullable_Vector3___get_Value(v35, v29);
      if ( !v28 )
        goto LABEL_33;
      UnityEngine_Transform__set_localScale(v28, v38, 0);
    }
    goto LABEL_30;
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3563F & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_WarBoardCommonEffectPerformance_AnimantionEndCallback__);
    byte_4C3563F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C35640 & 1) == 0 )
  {
    sub_1C32C20(&WarBoardCommonEffectPerformance__Execute_d__12_TypeInfo);
    byte_4C35640 = 1;
  }
  v3 = sub_1C32E6C(WarBoardCommonEffectPerformance__Execute_d__12_TypeInfo);
...
void WarBoardCommonEffectPerformance__OnEnd(WarBoardCommonEffectPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(effectObject, 0, 0) )
  {
    ...
    *p_effectObject = 0;
    sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.effectObject, 0, v5, v6);
  }
...
void WarBoardCommonEffectPerformance__OnStart(WarBoardCommonEffectPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3563E & 1) == 0 )
  {
    sub_1C32C20(&System_Action_TypeInfo);
    sub_1C32C20(&UnityEngine_Object_TypeInfo);
    sub_1C32C20(&Method_WarBoardCommonEffectPerformance_AnimantionEndStartCallback__);
    byte_4C3563E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.animantionEndCallback, (int32_t)callback, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.animantionStartEndCallback, (int32_t)callback, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C35642 & 1) == 0 )
  {
    ...
    this = (WarBoardCommonEffectPerformance__Execute_d__12_o *)sub_1C32C20(&Method_WarBoardCommonEffectPerformance__Execute_b__12_0__);
    byte_4C35642 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C32C34(&Method_WarBoardCommonEffectPerformance__Execute_d__12_System_Collections_IEnumerator_Reset__);
  sub_1C32D48(v3, v4);
}
