        ...
        const MethodInfo *method)
{
  ...
  const MethodInfo_34E29B0 *v30; // x2
  int v31; // s0
  UnityEngine_Transform_o *v34; // x20
  const MethodInfo_34E29B0 *v35; // x2
  int v36; // s0
  UnityEngine_Transform_o *v39; // x20
  const MethodInfo_34E29B0 *v40; // x2
  int v41; // s0
  ...
  if ( (byte_48E07B1 & 1) == 0 )
  {
    sub_1B00CCC(&Method_UnityEngine_GameObject_GetComponent_CommonEffectComponent___, parent);
    sub_1B00CCC(&Method_System_Nullable_Vector3__get_HasValue__, v14);
    sub_1B00CCC(&Method_System_Nullable_Vector3__get_Value__, v15);
    sub_1B00CCC(&Method_UnityEngine_Object_Instantiate_GameObject____74661872, v16);
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)effetctPrefab, 0LL, 0LL) )
  {
    if ( doInstantiate )
    {
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      v20 = UnityEngine_Object__Instantiate_object__48061572(
    ...
    sub_1B00C70((ServantStatusBattleListViewItem_o *)p_effectObject, v21, v18, v19);
    ...
    sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.commonEffect, (int32_t)Component_object, v27, v28);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E07B3 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_WarBoardCommonEffectPerformance_AnimantionEndCallback__, v3);
    byte_48E07B3 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E07B4 & 1) == 0 )
  {
    sub_1B00CCC(&WarBoardCommonEffectPerformance__Execute_d__12_TypeInfo, method);
    byte_48E07B4 = 1;
  }
  v3 = sub_1B00F18(WarBoardCommonEffectPerformance__Execute_d__12_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(effectObject, 0LL, 0LL) )
  {
    ...
    if ( this->fields.destroyOnEnd )
    {
      ...
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      UnityEngine_Object__Destroy_68077656((UnityEngine_Object_o *)v8, 0LL);
    }
    *p_effectObject = 0LL;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E07B2 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_WarBoardCommonEffectPerformance_AnimantionEndStartCallback__, v4);
    byte_48E07B2 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E07B6 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&UnityEngine_Object_TypeInfo, v3);
    sub_1B00CCC(&UnityEngine_WaitWhile_TypeInfo, v4);
    this = (WarBoardCommonEffectPerformance__Execute_d__12_o *)sub_1B00CCC(
  ...
  else
  {
    ...
    else
    {
      ...
      v10 = (UnityEngine_WaitWhile_o *)sub_1B00F18(UnityEngine_WaitWhile_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B00CE0(&Method_WarBoardCommonEffectPerformance__Execute_d__12_System_Collections_IEnumerator_Reset__);
  sub_1B00DF4(v3, v4);
}
