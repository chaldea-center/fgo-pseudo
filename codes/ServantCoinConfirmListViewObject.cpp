void __fastcall ServantCoinConfirmListViewObject___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A309B5 & 1) == 0 )
  {
    sub_1B761C0(&ServantCoinConfirmListViewObject_TypeInfo, v1);
    byte_4A309B5 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A309B1 & 1) == 0 )
  {
    sub_1B761C0(&Method_UnityEngine_GameObject_GetComponent_ServantCoinConfirmListViewItemDraw___, method);
    byte_4A309B1 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2EB19B8 *)Method_UnityEngine_GameObject_GetComponent_ServantCoinConfirmListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A309B2 & 1) == 0 )
  {
    this = (ServantCoinConfirmListViewObject_o *)sub_1B761C0(&ServantCoinConfirmListViewObject_TypeInfo, item);
    byte_4A309B2 = 1;
  }
  if ( !item )
    goto LABEL_16;
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&v6->fields.linkItem, (int32_t)item, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A309B3 & 1) == 0 )
  {
    ...
    sub_1B761C0(&ServantCoinConfirmListViewItem_TypeInfo, v3);
    byte_4A309B3 = 1;
  }
