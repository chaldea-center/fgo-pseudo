void __fastcall ServantCoinConfirmListViewObject___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A2253F & 1) == 0 )
  {
    sub_1B715CC(&ServantCoinConfirmListViewObject_TypeInfo, v1);
    byte_4A2253F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2253B & 1) == 0 )
  {
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponent_ServantCoinConfirmListViewItemDraw___, method);
    byte_4A2253B = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2EAA998 *)Method_UnityEngine_GameObject_GetComponent_ServantCoinConfirmListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2253C & 1) == 0 )
  {
    this = (ServantCoinConfirmListViewObject_o *)sub_1B715CC(&ServantCoinConfirmListViewObject_TypeInfo, item);
    byte_4A2253C = 1;
  }
  if ( !item )
    goto LABEL_16;
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&v6->fields.linkItem, (int32_t)item, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2253D & 1) == 0 )
  {
    ...
    sub_1B715CC(&ServantCoinConfirmListViewItem_TypeInfo, v3);
    byte_4A2253D = 1;
  }
