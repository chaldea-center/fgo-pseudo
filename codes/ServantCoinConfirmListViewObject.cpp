void __fastcall ServantCoinConfirmListViewObject___cctor(const MethodInfo *method)
{
  if ( (byte_4A5DBAB & 1) == 0 )
  {
    sub_1B885B0(&ServantCoinConfirmListViewObject_TypeInfo);
    byte_4A5DBAB = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5DBA7 & 1) == 0 )
  {
    sub_1B885B0(&Method_UnityEngine_GameObject_GetComponent_ServantCoinConfirmListViewItemDraw___);
    byte_4A5DBA7 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2ECEEB8 *)Method_UnityEngine_GameObject_GetComponent_ServantCoinConfirmListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5DBA8 & 1) == 0 )
  {
    this = (ServantCoinConfirmListViewObject_o *)sub_1B885B0(&ServantCoinConfirmListViewObject_TypeInfo);
    byte_4A5DBA8 = 1;
  }
  if ( !item )
    goto LABEL_16;
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v6->fields.linkItem, (int32_t)item, v7, v8);
