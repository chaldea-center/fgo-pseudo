void ServantCoinConfirmListViewObject___cctor(const MethodInfo *method)
{
  if ( (byte_4CF0F20 & 1) == 0 )
  {
    sub_1C7BAE8(&ServantCoinConfirmListViewObject_TypeInfo);
    byte_4CF0F20 = 1;
  }
...
void ServantCoinConfirmListViewObject__Awake(ServantCoinConfirmListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CF0F1C & 1) == 0 )
  {
    sub_1C7BAE8(&Method_UnityEngine_GameObject_GetComponent_ServantCoinConfirmListViewItemDraw___);
    byte_4CF0F1C = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_31C70C8 *)Method_UnityEngine_GameObject_GetComponent_ServantCoinConfirmListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF0F1D & 1) == 0 )
  {
    this = (ServantCoinConfirmListViewObject_o *)sub_1C7BAE8(&ServantCoinConfirmListViewObject_TypeInfo);
    byte_4CF0F1D = 1;
  }
  if ( !item )
    goto LABEL_16;
