void __fastcall ServantCoinConfirmListViewObject___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A50F3D & 1) == 0 )
  {
    sub_1B863B8(&ServantCoinConfirmListViewObject_TypeInfo, v1);
    byte_4A50F3D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A50F39 & 1) == 0 )
  {
    sub_1B863B8(&Method_UnityEngine_GameObject_GetComponent_ServantCoinConfirmListViewItemDraw___, method);
    byte_4A50F39 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2FC0DF0 *)Method_UnityEngine_GameObject_GetComponent_ServantCoinConfirmListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A50F3A & 1) == 0 )
  {
    this = (ServantCoinConfirmListViewObject_o *)sub_1B863B8(&ServantCoinConfirmListViewObject_TypeInfo, item);
    byte_4A50F3A = 1;
  }
  if ( !item )
    goto LABEL_16;
  item->fields.viewObject = (struct ListViewObject_o *)v6;
  sub_1B8635C((CGThumbnailListItem_o *)&item->fields.viewObject, (int32_t)v6, (int32_t)seed, method);
  v6->fields.linkItem = item;
  sub_1B8635C((CGThumbnailListItem_o *)&v6->fields.linkItem, (int32_t)item, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A50F3B & 1) == 0 )
  {
    ...
    sub_1B863B8(&ServantCoinConfirmListViewItem_TypeInfo, v3);
    byte_4A50F3B = 1;
  }
