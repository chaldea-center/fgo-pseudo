void __fastcall ServantCoinConfirmListViewObject___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FEE3D & 1) == 0 )
  {
    sub_1B640C8(&ServantCoinConfirmListViewObject_TypeInfo, v1);
    byte_49FEE3D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FEE39 & 1) == 0 )
  {
    sub_1B640C8(&Method_UnityEngine_GameObject_GetComponent_ServantCoinConfirmListViewItemDraw___, method);
    byte_49FEE39 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2E87ED8 *)Method_UnityEngine_GameObject_GetComponent_ServantCoinConfirmListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FEE3A & 1) == 0 )
  {
    this = (ServantCoinConfirmListViewObject_o *)sub_1B640C8(&ServantCoinConfirmListViewObject_TypeInfo, item);
    byte_49FEE3A = 1;
  }
  if ( !item )
    goto LABEL_16;
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&v6->fields.linkItem, (int32_t)item, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FEE3B & 1) == 0 )
  {
    ...
    sub_1B640C8(&ServantCoinConfirmListViewItem_TypeInfo, v3);
    byte_49FEE3B = 1;
  }
