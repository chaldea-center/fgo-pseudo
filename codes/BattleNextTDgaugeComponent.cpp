        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2A720 & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_20163/*"icon_count_01"*/);
    sub_1C2D490(&StringLiteral_20165/*"icon_count_bg"*/);
    this = (BattleNextTDgaugeComponent_o *)sub_1C2D490(&StringLiteral_20164/*"icon_count_02"*/);
    byte_4C2A720 = 1;
  }
      ...
      if ( type == 1 )
      {
        if ( max_length > index )
        {
          ...
          if ( Component_object )
          {
            ...
            if ( Component_object )
            {
              v10 = &StringLiteral_20163/*"icon_count_01"*/;
              goto LABEL_20;
            }
          }
LABEL_21:
          sub_1C2D6EC(Component_object, *(_QWORD *)&index);
        }
      }
      else if ( type == 2 )
      {
        if ( max_length > index )
        {
          ...
          if ( Component_object )
          {
            ...
            if ( Component_object )
            {
              v10 = &StringLiteral_20164/*"icon_count_02"*/;
LABEL_20:
      ...
      else if ( max_length > index )
      {
        ...
        if ( Component_object )
        {
          ...
          if ( Component_object )
          {
            v10 = &StringLiteral_20165/*"icon_count_bg"*/;
            goto LABEL_20;
          }
        }
        goto LABEL_21;
      }
      sub_1C2D6F4(this, *(_QWORD *)&index, *(_QWORD *)&type);
    }
  }
}
...
void BattleNextTDgaugeComponent__setHide(BattleNextTDgaugeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( !gaugeFrontRoot
    ...
    || (gaugeFrontRoot = (UnityEngine_Component_o *)UnityEngine_Component__get_gameObject(gaugeFrontRoot, 0)) == 0 )
  {
    sub_1C2D6EC(gaugeFrontRoot, method);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)gaugeFrontRoot, 0, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2A71E & 1) == 0 )
  {
    ...
    this = (BattleNextTDgaugeComponent_o *)sub_1C2D490(&UnityEngine_Object_TypeInfo);
    byte_4C2A71E = 1;
  }
...
LABEL_17:
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&v8->fields.gaugeList, 0, max, (const MethodInfo *)isTDSeraled);
  v8->fields.gaugebackList = 0;
  sub_1C2D434((CGThumbnailListItem_o *)&v8->fields.gaugebackList, 0, v17, v18);
...
LABEL_48:
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&v8->fields.gaugeList, (int32_t)v40, v41, v42);
  if ( !v24 )
LABEL_53:
    sub_1C2D6EC(gaugeFrontRoot, v19);
  if ( isTDSeraled )
    v43 = 0;
  else
    v43 = now;
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&v8->fields.gaugebackList, (int32_t)v44, v45, v46);
...
LABEL_32:
        sub_1C2D6EC(gaugeFrontRoot, *(_QWORD *)&nextVal);
      }
LABEL_12:
      gaugeFrontRoot = (UnityEngine_Component_o *)this->fields.gaugeFrontRoot;
      if ( !gaugeFrontRoot )
