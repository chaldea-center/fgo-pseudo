...
void FlipEffectUpdater__OnLateUpdate(FlipEffectUpdater_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(ConnectTarget, 0, 0) )
  {
    ...
    if ( UnityEngine_Object__op_Equality(mTrans, 0, 0) )
    {
      ...
      sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.mTrans, (int32_t)transform, v8, v9, v10, v11, v12, v13);
    }
    parent = *p_mTrans;
    if ( !*p_mTrans )
      goto LABEL_24;
    ...
    if ( !byte_4CE7E59 )
    {
      parent = (UnityEngine_Transform_o *)sub_1C7BAE8(&UnityEngine_Vector3_TypeInfo);
      byte_4CE7E59 = 1;
    }
    if ( !v16 )
      goto LABEL_24;
