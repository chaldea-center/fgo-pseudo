...
void __fastcall FlipEffectUpdater__OnLateUpdate(FlipEffectUpdater_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(ConnectTarget, 0LL, 0LL) )
  {
    ...
    if ( UnityEngine_Object__op_Equality(mTrans, 0LL, 0LL) )
    {
      ...
      sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.mTrans, (int64_t)transform, v8, v9, v10, v11, v12, v13);
    }
    parent = *p_mTrans;
    if ( !*p_mTrans )
      goto LABEL_24;
    ...
    if ( !byte_4B612E1 )
    {
      parent = (UnityEngine_Transform_o *)sub_1BE4ACC(&UnityEngine_Vector3_TypeInfo, v6);
      byte_4B612E1 = 1;
    }
    if ( !v16 )
      goto LABEL_24;
...
void __fastcall FlipEffectUpdater__Start(FlipEffectUpdater_o *this, const MethodInfo *method)
{
  ...
  transform = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0LL);
  this->fields.mTrans = transform;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.mTrans, (int64_t)transform, v4, v5, v6, v7, v8, v9);
}