...
void MainMenuBarButton__SetMode(MainMenuBarButton_o *this, int32_t mode, const MethodInfo *method)
{
  ...
  if ( (byte_4E78E4A & 1) == 0 )
  {
    sub_1D0F0B4(&Method_UnityEngine_Component_GetComponent_UIButtonScale___);
    sub_1D0F0B4(&Method_UnityEngine_Component_GetComponent_UIButton___);
  ...
  if ( this->fields.mode != mode )
  {
    ...
    if ( v6 )
    {
      ...
      v9 = UnityEngine_Component__GetComponent_object_(
             (UnityEngine_Component_o *)Component_object,
             (const MethodInfo_3245988 *)Method_UnityEngine_Component_GetComponent_UIButtonScale___);
