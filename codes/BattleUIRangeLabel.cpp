void __fastcall BattleUIRangeLabel___ctor(BattleUIRangeLabel_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.adjustmentX = xmmword_BB5790;
  *(_OWORD *)&this->fields.recoverX = xmmword_BB41F0;
        ...
        const MethodInfo *method)
{
  ...
  if ( !byte_4A55CE6 )
  {
    textLabel = (UnityEngine_Component_o *)sub_1B885B0(&UnityEngine_Vector3_TypeInfo);
    byte_4A55CE6 = 1;
  }
  if ( !v8 )
LABEL_13:
    sub_1B8880C(textLabel, *(_QWORD *)&width);
...
void __fastcall BattleUIRangeLabel__OnDisable(BattleUIRangeLabel_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5D984 & 1) == 0 )
  {
    ...
    this = (BattleUIRangeLabel_o *)sub_1B885B0(&Method_System_Nullable_Color__get_Value__);
    byte_4A5D984 = 1;
  }
  ...
  if ( v2->fields.saveColor.fields.hasValue )
  {
    ...
    if ( vadd_f32(vdup_lane_s32(v8, 1), vadd_f32(v8, vadd_f32(vdup_lane_s32(v6, 1), v6))).n64_f32[0] >= 1.0e-10 )
    {
      Value = System_Nullable_Color___get_Value(
                &v2->fields.saveColor,
                (const MethodInfo_361741C *)Method_System_Nullable_Color__get_Value__);
  ...
  if ( v2->fields.saveEffectColor.fields.hasValue )
  {
    ...
    if ( vadd_f32(vdup_lane_s32(v13, 1), vadd_f32(v13, vadd_f32(vdup_lane_s32(v11, 1), v11))).n64_f32[0] >= 1.0e-10 )
    {
      v16 = System_Nullable_Color___get_Value(
              ...
              (const MethodInfo_361741C *)Method_System_Nullable_Color__get_Value__);
      UILabel__set_effectColor(textLabel, v16, 0LL);
    }
  }
...
LABEL_27:
  ...
  iconSprite = (UnityEngine_Component_o *)System_String__Equals_61715348(text, (System_String_o *)StringLiteral_1/*""*/, 0LL);
  if ( !v24 )
    goto LABEL_35;
        ...
        const MethodInfo *method)
{
  ...
  if ( !v4->fields.saveColor.fields.hasValue )
  {
    ...
    System_Nullable_Color____ctor(&v21, mColor, (const MethodInfo_3617400 *)Method_System_Nullable_Color___ctor__);
  ...
  if ( !v4->fields.saveEffectColor.fields.hasValue )
  {
    ...
    memset(&v21, 0, sizeof(v21));
    System_Nullable_Color____ctor(&v21, mEffectColor, (const MethodInfo_3617400 *)Method_System_Nullable_Color___ctor__);
