void BattleUIRangeLabel___ctor(BattleUIRangeLabel_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.adjustmentX = xmmword_CED520;
  *(_OWORD *)&this->fields.recoverX = xmmword_CEBE50;
        ...
        const MethodInfo *method)
{
  ...
  if ( !byte_4CAFC0E )
  {
    textLabel = (UnityEngine_Component_o *)sub_1C6BA08(&UnityEngine_Vector3_TypeInfo);
    byte_4CAFC0E = 1;
  }
  if ( !v8 )
LABEL_13:
    sub_1C6BC60(textLabel, *(_QWORD *)&width);
...
void BattleUIRangeLabel__OnDisable(BattleUIRangeLabel_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB90BB & 1) == 0 )
  {
    ...
    this = (BattleUIRangeLabel_o *)sub_1C6BA08(&Method_System_Nullable_Color__get_Value__);
    byte_4CB90BB = 1;
  }
...
LABEL_16:
      sub_1C6BC60(textLabel, isUpdateIconParent);
    }
  }
}
...
LABEL_27:
  ...
  iconSprite = (UnityEngine_Component_o *)System_String__Equals_64002112(text, (System_String_o *)StringLiteral_1/*""*/, 0);
  if ( !v24 )
    goto LABEL_35;
        ...
        const MethodInfo *method)
{
  ...
  if ( !v4->fields.saveColor.fields.hasValue )
  {
    ...
    System_Nullable_Color____ctor(&v21, mColor, (const MethodInfo_3925FF8 *)Method_System_Nullable_Color___ctor__);
  ...
  if ( !v4->fields.saveEffectColor.fields.hasValue )
  {
    ...
    memset(&v21, 0, sizeof(v21));
    System_Nullable_Color____ctor(&v21, mEffectColor, (const MethodInfo_3925FF8 *)Method_System_Nullable_Color___ctor__);
