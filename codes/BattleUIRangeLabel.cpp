void BattleUIRangeLabel___ctor(BattleUIRangeLabel_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.adjustmentX = xmmword_CF0160;
  *(_OWORD *)&this->fields.recoverX = xmmword_CEEA90;
        ...
        const MethodInfo *method)
{
  ...
  if ( !byte_4CC0D0E )
  {
    textLabel = (UnityEngine_Component_o *)sub_1C713B0(&UnityEngine_Vector3_TypeInfo);
    byte_4CC0D0E = 1;
  }
  if ( !v8 )
LABEL_13:
    sub_1C71608(textLabel, *(_QWORD *)&width);
...
void BattleUIRangeLabel__OnDisable(BattleUIRangeLabel_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CCA1F8 & 1) == 0 )
  {
    ...
    this = (BattleUIRangeLabel_o *)sub_1C713B0(&Method_System_Nullable_Color__get_Value__);
    byte_4CCA1F8 = 1;
  }
...
LABEL_16:
      sub_1C71608(textLabel, isUpdateIconParent);
    }
  }
}
...
LABEL_27:
  ...
  iconSprite = (UnityEngine_Component_o *)System_String__Equals_64067044(text, (System_String_o *)StringLiteral_1/*""*/, 0);
  if ( !v24 )
    goto LABEL_35;
        ...
        const MethodInfo *method)
{
  ...
  if ( !v4->fields.saveColor.fields.hasValue )
  {
    ...
    System_Nullable_Color____ctor(&v21, mColor, (const MethodInfo_3935D9C *)Method_System_Nullable_Color___ctor__);
  ...
  if ( !v4->fields.saveEffectColor.fields.hasValue )
  {
    ...
    memset(&v21, 0, sizeof(v21));
    System_Nullable_Color____ctor(&v21, mEffectColor, (const MethodInfo_3935D9C *)Method_System_Nullable_Color___ctor__);
