void __fastcall BattleUIRangeLabel___ctor(BattleUIRangeLabel_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.adjustmentX = xmmword_BDF6B0;
  *(_OWORD *)&this->fields.recoverX = xmmword_BDE0B0;
        ...
        const MethodInfo *method)
{
  ...
  if ( !byte_4AFBDB6 )
  {
    textLabel = (UnityEngine_Component_o *)sub_1BC3008(&UnityEngine_Vector3_TypeInfo, *(_QWORD *)&width);
    byte_4AFBDB6 = 1;
  }
  if ( !v8 )
LABEL_13:
    sub_1BC3264(textLabel, *(_QWORD *)&width);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B04C45 & 1) == 0 )
  {
    sub_1BC3008(&UnityEngine_Object_TypeInfo, isDisplay);
    byte_4B04C45 = 1;
  }
  resetLineSprite = (UnityEngine_Object_o *)this->fields.resetLineSprite;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
...
void __fastcall BattleUIRangeLabel__OnDisable(BattleUIRangeLabel_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B04C47 & 1) == 0 )
  {
    ...
    this = (BattleUIRangeLabel_o *)sub_1BC3008(&Method_System_Nullable_Color__get_Value__, v4);
    byte_4B04C47 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B04C42 & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_1/*""*/, text);
    byte_4B04C42 = 1;
  }
...
LABEL_27:
  ...
  iconSprite = (UnityEngine_Component_o *)System_String__Equals_62383952(text, (System_String_o *)StringLiteral_1/*""*/, 0LL);
  if ( !v24 )
    goto LABEL_35;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B04C46 & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Nullable_Color___ctor__, buffData);
    sub_1BC3008(&Method_System_Nullable_Color__get_HasValue__, v5);
    this = (BattleUIRangeLabel_o *)sub_1BC3008(&Method_System_Nullable_Color__get_Value__, v6);
    byte_4B04C46 = 1;
  }
  if ( !v4->fields.saveColor.fields.hasValue )
  {
    ...
    System_Nullable_Color____ctor(&v23, mColor, (const MethodInfo_37BD5D4 *)Method_System_Nullable_Color___ctor__);
  ...
  if ( !v4->fields.saveEffectColor.fields.hasValue )
  {
    ...
    memset(&v23, 0, sizeof(v23));
    System_Nullable_Color____ctor(&v23, mEffectColor, (const MethodInfo_37BD5D4 *)Method_System_Nullable_Color___ctor__);
