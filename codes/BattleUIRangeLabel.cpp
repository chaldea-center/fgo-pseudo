void __fastcall BattleUIRangeLabel___ctor(BattleUIRangeLabel_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.adjustmentX = xmmword_BAE020;
  *(_OWORD *)&this->fields.recoverX = xmmword_BACA70;
        ...
        const MethodInfo *method)
{
  ...
  if ( !byte_4A28BB6 )
  {
    textLabel = (UnityEngine_Component_o *)sub_1B761C0(&UnityEngine_Vector3_TypeInfo, *(_QWORD *)&width);
    byte_4A28BB6 = 1;
  }
  if ( !v8 )
LABEL_13:
    sub_1B7641C(textLabel, *(_QWORD *)&width);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A30742 & 1) == 0 )
  {
    sub_1B761C0(&UnityEngine_Object_TypeInfo, isDisplay);
    byte_4A30742 = 1;
  }
  resetLineSprite = (UnityEngine_Object_o *)this->fields.resetLineSprite;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
...
void __fastcall BattleUIRangeLabel__OnDisable(BattleUIRangeLabel_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A30744 & 1) == 0 )
  {
    sub_1B761C0(&Method_System_Nullable_Color__GetValueOrDefault__, method);
    sub_1B761C0(&Method_System_Nullable_Color__get_HasValue__, v3);
    this = (BattleUIRangeLabel_o *)sub_1B761C0(&Method_System_Nullable_Color__get_Value__, v4);
    byte_4A30744 = 1;
  }
  ...
  if ( v2->fields.saveColor.fields.hasValue )
  {
    ...
    if ( vadd_f32(vdup_lane_s32(v10, 1), vadd_f32(v10, vadd_f32(vdup_lane_s32(v8, 1), v8))).n64_f32[0] >= 1.0e-10 )
    {
      Value = System_Nullable_Color___get_Value(
                &v2->fields.saveColor,
                (const MethodInfo_35F144C *)Method_System_Nullable_Color__get_Value__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A3073F & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_1/*""*/, text);
    byte_4A3073F = 1;
  }
...
LABEL_27:
  ...
  iconSprite = (UnityEngine_Component_o *)System_String__Equals_61543376(text, (System_String_o *)StringLiteral_1/*""*/, 0LL);
  if ( !v24 )
    goto LABEL_35;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A30743 & 1) == 0 )
  {
    sub_1B761C0(&Method_System_Nullable_Color___ctor__, buffData);
    sub_1B761C0(&Method_System_Nullable_Color__get_HasValue__, v5);
    this = (BattleUIRangeLabel_o *)sub_1B761C0(&Method_System_Nullable_Color__get_Value__, v6);
    byte_4A30743 = 1;
  }
  if ( !v4->fields.saveColor.fields.hasValue )
  {
    ...
    System_Nullable_Color____ctor(&v23, mColor, (const MethodInfo_35F1430 *)Method_System_Nullable_Color___ctor__);
  ...
  if ( !v4->fields.saveEffectColor.fields.hasValue )
  {
    ...
    memset(&v23, 0, sizeof(v23));
    System_Nullable_Color____ctor(&v23, mEffectColor, (const MethodInfo_35F1430 *)Method_System_Nullable_Color___ctor__);
