void __fastcall BattleUIRangeLabel___ctor(BattleUIRangeLabel_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.adjustmentX = xmmword_BC3C90;
  *(_OWORD *)&this->fields.recoverX = xmmword_BC2730;
        ...
        const MethodInfo *method)
{
  ...
  if ( !byte_4A487E6 )
  {
    textLabel = (UnityEngine_Component_o *)sub_1B863B8(&UnityEngine_Vector3_TypeInfo, *(_QWORD *)&width);
    byte_4A487E6 = 1;
  }
  if ( !v8 )
LABEL_13:
    sub_1B86614(textLabel, *(_QWORD *)&width);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A51021 & 1) == 0 )
  {
    sub_1B863B8(&UnityEngine_Object_TypeInfo, isDisplay);
    byte_4A51021 = 1;
  }
  resetLineSprite = (UnityEngine_Object_o *)this->fields.resetLineSprite;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
...
void __fastcall BattleUIRangeLabel__OnDisable(BattleUIRangeLabel_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A51023 & 1) == 0 )
  {
    ...
    this = (BattleUIRangeLabel_o *)sub_1B863B8(&Method_System_Nullable_Color__get_Value__, v4);
    byte_4A51023 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5101E & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_1/*""*/, text);
    byte_4A5101E = 1;
  }
...
LABEL_27:
  ...
  iconSprite = (UnityEngine_Component_o *)System_String__Equals_61680480(text, (System_String_o *)StringLiteral_1/*""*/, 0LL);
  if ( !v24 )
    goto LABEL_35;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A51022 & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Nullable_Color___ctor__, buffData);
    sub_1B863B8(&Method_System_Nullable_Color__get_HasValue__, v5);
    this = (BattleUIRangeLabel_o *)sub_1B863B8(&Method_System_Nullable_Color__get_Value__, v6);
    byte_4A51022 = 1;
  }
  if ( !v4->fields.saveColor.fields.hasValue )
  {
    ...
    System_Nullable_Color____ctor(&v23, mColor, (const MethodInfo_3719954 *)Method_System_Nullable_Color___ctor__);
  ...
  if ( !v4->fields.saveEffectColor.fields.hasValue )
  {
    ...
    memset(&v23, 0, sizeof(v23));
    System_Nullable_Color____ctor(&v23, mEffectColor, (const MethodInfo_3719954 *)Method_System_Nullable_Color___ctor__);
