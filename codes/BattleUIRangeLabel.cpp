void BattleUIRangeLabel___ctor(BattleUIRangeLabel_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.adjustmentX = xmmword_E9C7B0;
  *(_OWORD *)&this->fields.recoverX = xmmword_E9D050;
        ...
        const MethodInfo *method)
{
  ...
  if ( !byte_5969AE5 )
  {
    textLabel = (UnityEngine_Component_o *)sub_2213A60(&UnityEngine_Vector3_TypeInfo);
    byte_5969AE5 = 1;
  }
  if ( !v8 )
    goto LABEL_14;
...
LABEL_14:
    sub_2213CDC(textLabel, *(_QWORD *)&width);
  }
}
...
void BattleUIRangeLabel__OnDisable(BattleUIRangeLabel_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_59737AF & 1) == 0 )
  {
    ...
    this = (BattleUIRangeLabel_o *)sub_2213A60(&Method_System_Nullable_Color__get_Value__);
    byte_59737AF = 1;
  }
...
LABEL_16:
      sub_2213CDC(textLabel, isUpdateIconParent);
    }
  }
}
...
LABEL_24:
    ...
    if ( iconSprite )
    {
      ...
      if ( iconSprite )
      {
        ...
        v29.fields.x = v19 + v27.fields.x;
        v29.fields.y = v20 + v27.fields.y;
...
LABEL_27:
  ...
  iconSprite = (UnityEngine_Component_o *)System_String__Equals_75686512(text, (System_String_o *)StringLiteral_1/*""*/, 0);
  if ( !v24 )
    goto LABEL_35;
        ...
        const MethodInfo *method)
{
  ...
  if ( !v4->fields.saveColor.fields.hasValue )
  {
    ...
    System_Nullable_Color____ctor(&v19, mColor, (const MethodInfo_45E1964 *)Method_System_Nullable_Color___ctor__);
    a = v19.fields.value.fields.a;
    *(_OWORD *)&v4->fields.saveColor.fields.hasValue = *(_OWORD *)&v19.fields.hasValue;
  ...
  if ( !v4->fields.saveEffectColor.fields.hasValue )
  {
    ...
    memset(&v19, 0, sizeof(v19));
    System_Nullable_Color____ctor(&v19, mEffectColor, (const MethodInfo_45E1964 *)Method_System_Nullable_Color___ctor__);
    v8 = v19.fields.value.fields.a;
    *(_OWORD *)&v4->fields.saveEffectColor.fields.hasValue = *(_OWORD *)&v19.fields.hasValue;
