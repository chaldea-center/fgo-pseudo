        ...
        const MethodInfo *method)
{
  if ( (byte_4B36F41 & 1) == 0 )
  {
    sub_1BD3458(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int___, *(_QWORD *)&atkSide);
    byte_4B36F41 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B36F42 & 1) == 0 )
  {
    ...
    sub_1BD3458(&ClassRelationOverwriteEntity_TYPE_TypeInfo, v4);
    sub_1BD3458(&StringLiteral_20449/*"id:{0} side:{1} atk:{2} def:{3} rate:{4} type:{5}"*/, v5);
    byte_4B36F42 = 1;
  }
  v6 = (System_Object_array *)sub_1BD3500(object___TypeInfo, 6LL);
  id = this->fields.id;
  ...
  if ( v10 )
  {
    v10 = (System_String_o *)sub_1BD3594(v10, v6->obj.klass->_1.element_class);
    if ( !v10 )
      goto LABEL_24;
  }
  if ( !v6->max_length )
  ...
  sub_1BD33FC((PartyOrganizationUtility_o *)v6->m_Items, v18, v12, v13, v14, v15, v16, v17);
  ...
  sub_1BD33FC((PartyOrganizationUtility_o *)&v6->m_Items[1], v28, v22, v23, v24, v25, v26, v27);
  ...
  sub_1BD33FC((PartyOrganizationUtility_o *)&v6->m_Items[2], v38, v32, v33, v34, v35, v36, v37);
  ...
  sub_1BD33FC((PartyOrganizationUtility_o *)&v6->m_Items[3], v48, v42, v43, v44, v45, v46, v47);
  ...
  sub_1BD33FC((PartyOrganizationUtility_o *)&v6->m_Items[4], v58, v52, v53, v54, v55, v56, v57);
...
LABEL_23:
  ...
  sub_1BD33FC((PartyOrganizationUtility_o *)&v6->m_Items[5], v66, v60, v61, v62, v63, v64, v65);
  return System_String__Format_62539756((System_String_o *)StringLiteral_20449/*"id:{0} side:{1} atk:{2} def:{3} rate:{4} type:{5}"*/, v6, 0LL);
}
