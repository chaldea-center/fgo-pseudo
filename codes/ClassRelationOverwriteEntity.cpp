        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C42D42 & 1) == 0 )
  {
    ...
    sub_1C37058(&ClassRelationOverwriteEntity_TYPE_TypeInfo);
    sub_1C37058(&StringLiteral_20259/*"id:{0} side:{1} atk:{2} def:{3} rate:{4} type:{5}"*/);
    byte_4C42D42 = 1;
  }
  v3 = (System_Object_array *)sub_1C37100(object___TypeInfo, 6);
  id = this->fields.id;
...
LABEL_23:
    sub_1C372BC(v10);
  v3->m_Items[5] = v53;
  sub_1C36FFC((CGThumbnailListItem_o *)&v3->m_Items[5], (int32_t)v53, v51, v52);
  return System_String__Format_63603084((System_String_o *)StringLiteral_20259/*"id:{0} side:{1} atk:{2} def:{3} rate:{4} type:{5}"*/, v3, 0);
}
