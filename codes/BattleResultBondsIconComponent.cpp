void __fastcall BattleResultBondsIconComponent___ctor(BattleResultBondsIconComponent_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.friendshipLabelArea = xmmword_C07810;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C00B94 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&IFriendshipGauge_TypeInfo, v5);
    sub_1C2E12C(&UnityEngine_Object_TypeInfo, v6);
    sub_1C2E12C(&StringLiteral_25804/*"ーーー"*/, v7);
    sub_1C2E12C(&StringLiteral_25936/*"＋ "*/, v8);
    this = (BattleResultBondsIconComponent_o *)sub_1C2E12C(&StringLiteral_9393/*"N0"*/, v9);
    byte_4C00B94 = 1;
  }
  v25 = 0;
  v24[0] = 0;
  ...
  {
LABEL_9:
    p_method = sub_1C8010C(v4->fields.gaugeComponent, IFriendshipGauge_TypeInfo, 3LL);
  }
  ...
  {
    v19 = System_Int32__ToString_64041192((int32_t)&v25, (System_String_o *)StringLiteral_9393/*"N0"*/, 0LL);
    this = (BattleResultBondsIconComponent_o *)System_String__Concat_63235584(
                                                 (System_String_o *)StringLiteral_25936/*"＋ "*/,
                                                 v19,
                                                 0LL);
    if ( v18 )
    {
...
LABEL_32:
  ...
  if ( !v18 )
    goto LABEL_32;
  UILabel__set_text(v4->fields.atlabel, (System_String_o *)StringLiteral_25804/*"ーーー"*/, 0LL);
  return v23[0] != 0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C00B95 & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_25933/*"（＋"*/, method);
    sub_1C2E12C(&StringLiteral_25936/*"＋ "*/, v3);
    sub_1C2E12C(&StringLiteral_25934/*"）"*/, v4);
    sub_1C2E12C(&StringLiteral_9393/*"N0"*/, v5);
    sub_1C2E12C(&StringLiteral_25932/*"（"*/, v6);
    byte_4C00B95 = 1;
  }
  if ( !this->fields.isMax )
  {
    ...
    if ( v41 > 0 )
    {
      v9 = System_Int32__ToString_64041192((int32_t)p_baseFriendshipExp, (System_String_o *)StringLiteral_9393/*"N0"*/, 0LL);
      p_baseFriendshipExp = System_String__Concat_63235584((System_String_o *)StringLiteral_25936/*"＋ "*/, v9, 0LL);
      if ( atlabel )
      {
        ...
        if ( p_baseFriendshipExp )
        {
          ...
          if ( p_baseFriendshipExp )
          {
            ...
            if ( p_baseFriendshipExp )
            {
              UILabel__set_text((UILabel_o *)p_baseFriendshipExp, (System_String_o *)StringLiteral_25932/*"（"*/, 0LL);
              p_baseFriendshipExp = (System_String_o *)this->fields.bonuslabel;
              if ( p_baseFriendshipExp )
              {
                ...
                if ( v11 )
                {
                  ...
                  v14 = v10;
                  v15 = System_Int32__ToString_64041192((int32_t)&v41, (System_String_o *)StringLiteral_9393/*"N0"*/, 0LL);
                  p_baseFriendshipExp = System_String__Concat_63248848(
                                          mText,
                                          (System_String_o *)StringLiteral_25933/*"（＋"*/,
                                          v15,
                                          (System_String_o *)StringLiteral_25934/*"）"*/,
                                          0LL);
                  if ( this->fields.bonuslabel )
                  {
                    ...
                    if ( p_baseFriendshipExp )
                    {
                      ...
                      v21 = System_Int32__ToString_64041192((int32_t)&v41, (System_String_o *)StringLiteral_9393/*"N0"*/, 0LL);
                      p_baseFriendshipExp = System_String__Concat_63246844(
                                              (System_String_o *)StringLiteral_25933/*"（＋"*/,
                                              v21,
                                              (System_String_o *)StringLiteral_25934/*"）"*/,
                                              0LL);
...
LABEL_39:
      sub_1C2E388(p_baseFriendshipExp, method);
    }
    if ( !atlabel )
      goto LABEL_39;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C00B92 & 1) == 0 )
  {
    sub_1C2E12C(&UnityEngine_Object_TypeInfo, pointInfo);
    byte_4C00B92 = 1;
  }
  buddyPointInfo = (UnityEngine_Object_o *)this->fields.buddyPointInfo;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C00B96 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&StringLiteral_11294/*"RESULT_BOUNDS_NEXT_FRIENDSHIP"*/, v5);
    byte_4C00B96 = 1;
  }
  if ( !this->fields.isMax && !this->fields.isNoFriendship )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(remainingFriendshipLabel, 0LL, 0LL) )
    {
      ...
      v8 = LocalizationManager__Get((System_String_o *)StringLiteral_11294/*"RESULT_BOUNDS_NEXT_FRIENDSHIP"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C00B93 & 1) == 0 )
  {
    sub_1C2E12C(&IFriendshipGauge_TypeInfo, userSvtCol);
    this = (BattleResultBondsIconComponent_o *)sub_1C2E12C(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, v5);
    byte_4C00B93 = 1;
  }
  if ( !v4->fields.isUse )
    return 0;
  ...
  *(_QWORD *)&v21.fields.fakeValue = v8;
  v9 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47758816(v21, 0LL);
  this = (BattleResultBondsIconComponent_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47758816(
  ...
  {
LABEL_12:
    p_method = sub_1C8010C(gaugeComponent, IFriendshipGauge_TypeInfo, 1LL);
  }
  (*(void (__fastcall **)(struct IFriendshipGauge_o *, _QWORD, _QWORD, _QWORD))p_method)(
    ...
    v11,
    *(_QWORD *)(p_method + 8));
  v4->fields.nextFriendShipRank = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47758816(
                                    userSvtCol->fields.friendshipRank,
                                    0LL);
  this = (BattleResultBondsIconComponent_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47758816(
...
LABEL_23:
  ...
  {
LABEL_20:
    v20 = sub_1C8010C(v16, IFriendshipGauge_TypeInfo, 2LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C00B91 & 1) == 0 )
  {
    sub_1C2E12C(&Method_BasicHelper_GetOrAddComponent_CondensedScaleLabel___, userSvtCol);
    ...
    sub_1C2E12C(&IFriendshipGauge_TypeInfo, v17);
  ...
  *(_QWORD *)&v65.fields.fakeValue = v23;
  v25 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47758816(v65, 0LL);
  faceIcon = this->fields.faceIcon;
  ...
  *(_QWORD *)&v66.fields.fakeValue = v27;
  v30 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47758816(v66, 0LL);
  ...
  *(_QWORD *)&v67.fields.fakeValue = v34;
  root = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47758816(v67, 0LL);
  if ( !v36 )
    goto LABEL_55;
  ...
  *(_QWORD *)&v68.fields.fakeValue = v38;
  this->fields.svtId = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47758816(v68, 0LL);
  ...
  *(_OWORD *)&v64.fields.fakeValue = v40;
  ...
  v63 = v64;
  this->fields.userSvtId = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_47762340(&v63, 0LL);
  this->fields.svtLimit = afterLimitCnt;
  this->fields.svtLv = userSvtEnt->fields.lv;
  this->fields.friendshipId = *(_DWORD *)(v37 + 96);
  this->fields.friendship = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47758816(
                              userSvtCol->fields.friendship,
                              0LL);
  this->fields.friendshipRank = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47758816(
                                  userSvtCol->fields.friendshipRank,
                                  0LL);
  ...
  sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.gaugeComponent, (int64_t)Gauge, v42, v43, v44, v45, v46, v47);
  ...
  {
LABEL_35:
    p_method = sub_1C8010C(gaugeComponent, IFriendshipGauge_TypeInfo, 0LL);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(remainingFriendshipLabel, 0LL, 0LL) )
  {
    root = (__int64)BasicHelper__GetOrAddComponent_object_(
                      ...
                      (const MethodInfo_2FBF308 *)Method_BasicHelper_GetOrAddComponent_CondensedScaleLabel___);
    if ( !root )
      goto LABEL_55;
    friendshipLabelArea = this->fields.friendshipLabelArea;
