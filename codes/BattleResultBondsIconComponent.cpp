void BattleResultBondsIconComponent___ctor(BattleResultBondsIconComponent_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.friendshipLabelArea = xmmword_C10110;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C467AB & 1) == 0 )
  {
    ...
    sub_1C37058(&IFriendshipGauge_TypeInfo);
    sub_1C37058(&UnityEngine_Object_TypeInfo);
    sub_1C37058(&StringLiteral_25442/*"ーーー"*/);
    sub_1C37058(&StringLiteral_25577/*"＋ "*/);
    this = (BattleResultBondsIconComponent_o *)sub_1C37058(&StringLiteral_9232/*"N0"*/);
    byte_4C467AB = 1;
  }
  v20 = 0;
  v19[0] = 0;
  ...
  {
LABEL_9:
    v9 = sub_1C87870(v4->fields.gaugeComponent, IFriendshipGauge_TypeInfo, 3);
  }
  ...
  {
    v14 = System_Int32__ToString_65071764((int32_t)&v20, (System_String_o *)StringLiteral_9232/*"N0"*/, 0);
    this = (BattleResultBondsIconComponent_o *)System_String__Concat_63561656(
                                                 (System_String_o *)StringLiteral_25577/*"＋ "*/,
                                                 v14,
                                                 0);
    if ( v13 )
    {
...
LABEL_32:
  ...
  if ( !v13 )
    goto LABEL_32;
  UILabel__set_text(v4->fields.atlabel, (System_String_o *)StringLiteral_25442/*"ーーー"*/, 0);
  return v18[0] != 0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C467AC & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_25574/*"（＋"*/);
    sub_1C37058(&StringLiteral_25577/*"＋ "*/);
    sub_1C37058(&StringLiteral_25575/*"）"*/);
    sub_1C37058(&StringLiteral_9232/*"N0"*/);
    sub_1C37058(&StringLiteral_25573/*"（"*/);
    byte_4C467AC = 1;
  }
  if ( !this->fields.isMax )
  {
    ...
    if ( v33 > 0 )
    {
      v5 = System_Int32__ToString_65071764((int32_t)p_baseFriendshipExp, (System_String_o *)StringLiteral_9232/*"N0"*/, 0);
      p_baseFriendshipExp = System_String__Concat_63561656((System_String_o *)StringLiteral_25577/*"＋ "*/, v5, 0);
      if ( atlabel )
      {
        ...
        if ( p_baseFriendshipExp )
        {
          ...
          if ( p_baseFriendshipExp )
          {
            ...
            if ( p_baseFriendshipExp )
            {
              UILabel__set_text((UILabel_o *)p_baseFriendshipExp, (System_String_o *)StringLiteral_25573/*"（"*/, 0);
              p_baseFriendshipExp = (System_String_o *)this->fields.bonuslabel;
              if ( p_baseFriendshipExp )
              {
                ...
                if ( v7 )
                {
                  ...
                  v10 = v6;
                  v11 = System_Int32__ToString_65071764((int32_t)&v33, (System_String_o *)StringLiteral_9232/*"N0"*/, 0);
                  p_baseFriendshipExp = System_String__Concat_63601908(
                                          mText,
                                          (System_String_o *)StringLiteral_25574/*"（＋"*/,
                                          v11,
                                          (System_String_o *)StringLiteral_25575/*"）"*/,
                                          0);
                  if ( this->fields.bonuslabel )
                  {
                    ...
                    if ( p_baseFriendshipExp )
                    {
                      ...
                      v17 = System_Int32__ToString_65071764((int32_t)&v33, (System_String_o *)StringLiteral_9232/*"N0"*/, 0);
                      p_baseFriendshipExp = System_String__Concat_63599904(
                                              (System_String_o *)StringLiteral_25574/*"（＋"*/,
                                              v17,
                                              (System_String_o *)StringLiteral_25575/*"）"*/,
                                              0);
...
LABEL_39:
      sub_1C372B4(p_baseFriendshipExp);
    }
    if ( !atlabel )
      goto LABEL_39;
        ...
        const MethodInfo *method)
{
  ...
  if ( !UnityEngine_Object__op_Equality(buddyPointInfo, 0, 0) )
  {
    ...
    if ( !v9 )
      sub_1C372B4(0);
    BattleResultBuddyPointInfoComponent__SetBuddyPointInfo(v9, pointInfo, eventId, v8);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C467AD & 1) == 0 )
  {
    ...
    sub_1C37058(&UnityEngine_Object_TypeInfo);
    sub_1C37058(&StringLiteral_11111/*"RESULT_BOUNDS_NEXT_FRIENDSHIP"*/);
    byte_4C467AD = 1;
  }
  if ( !this->fields.isMax && !this->fields.isNoFriendship )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(remainingFriendshipLabel, 0, 0) )
    {
      ...
      v5 = LocalizationManager__Get((System_String_o *)StringLiteral_11111/*"RESULT_BOUNDS_NEXT_FRIENDSHIP"*/, 0);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C37058(&IFriendshipGauge_TypeInfo);
    this = (BattleResultBondsIconComponent_o *)sub_1C37058(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    byte_4C467AA = 1;
  }
  if ( !v4->fields.isUse )
    return 0;
  ...
  *(_QWORD *)&v20.fields.fakeValue = v7;
  v8 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48930896(v20, 0);
  this = (BattleResultBondsIconComponent_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48930896(
  ...
  {
LABEL_12:
    v13 = sub_1C87870(gaugeComponent, IFriendshipGauge_TypeInfo, 1);
  }
  (*(void (__fastcall **)(struct IFriendshipGauge_o *, _QWORD, _QWORD, _QWORD))v13)(
    ...
    v10,
    *(_QWORD *)(v13 + 8));
  v4->fields.nextFriendShipRank = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48930896(
                                    userSvtCol->fields.friendshipRank,
                                    0);
  this = (BattleResultBondsIconComponent_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48930896(
...
LABEL_23:
  ...
  {
LABEL_20:
    v19 = sub_1C87870(v15, IFriendshipGauge_TypeInfo, 2);
  }
        ...
        const MethodInfo *method)
{
  ...
  int v59; // w8
  bool v60; // [xsp+64h] [xbp-ACh]
  int32_t v61; // [xsp+68h] [xbp-A8h]
  int32_t v62; // [xsp+6Ch] [xbp-A4h]
  CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_o v63; // [xsp+70h] [xbp-A0h] BYREF
  CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_o v64; // [xsp+90h] [xbp-80h]
  ...
  if ( (byte_4C467A8 & 1) == 0 )
  {
    sub_1C37058(&Method_BasicHelper_GetOrAddComponent_CondensedScaleLabel___);
  ...
  *(_QWORD *)&v65.fields.fakeValue = v18;
  v20 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48930896(v65, 0);
  v21 = v20 == afterLimitCnt || afterLimitCnt < 0;
  v22 = v21 ? v20 : afterLimitCnt;
  root = (__int64)UserServantEntity__GetOverwriteStatus_43187584(userSvtEnt, dispLimitCnt, 0);
  if ( !root )
    goto LABEL_57;
  ...
  *(_QWORD *)&v66.fields.fakeValue = v25;
  v62 = v22;
  v60 = isNoFollower;
  v27 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48930896(v66, 0);
  if ( iconLimitCnt < 0 )
  ...
  ServantFaceIconComponent__SetIcon(
    ...
    root & 1,
    0);
  root = (__int64)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39ED16C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !root )
    goto LABEL_57;
  ...
  *(_QWORD *)&v67.fields.fakeValue = v35;
  root = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48930896(v67, 0);
  if ( !v37 )
    goto LABEL_57;
  ...
  *(_QWORD *)&v68.fields.fakeValue = v39;
  this->fields.svtId = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48930896(v68, 0);
  ...
  *(_OWORD *)&v64.fields.fakeValue = v41;
  ...
  v63 = v64;
  this->fields.userSvtId = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_48934420(&v63, 0);
  this->fields.svtLimit = v62;
  this->fields.svtLv = userSvtEnt->fields.lv;
  this->fields.friendshipId = *(_DWORD *)(v38 + 96);
  this->fields.friendship = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48930896(
                              userSvtCol->fields.friendship,
                              0);
  this->fields.friendshipRank = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48930896(
                                  userSvtCol->fields.friendshipRank,
                                  0);
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.gaugeComponent, (int32_t)Gauge, v43, v44);
  ...
  v52 = *(unsigned __int16 *)&gaugeComponent->klass->_2.rank;
  if ( *(_WORD *)&gaugeComponent->klass->_2.rank )
  {
  ...
  {
LABEL_37:
    v54 = sub_1C87870(this->fields.gaugeComponent, IFriendshipGauge_TypeInfo, 0);
  }
  ...
  if ( v60 )
    v55 = 208;
  this->fields.friendshipLabelArea = *(float *)((char *)&this->klass + v55);
  ...
  if ( UnityEngine_Object__op_Inequality(remainingFriendshipLabel, 0, 0) )
  {
    root = (__int64)BasicHelper__GetOrAddComponent_object_(
                      ...
                      (const MethodInfo_30D535C *)Method_BasicHelper_GetOrAddComponent_CondensedScaleLabel___);
    if ( !root )
      goto LABEL_57;
    friendshipLabelArea = this->fields.friendshipLabelArea;
    v59 = (int)friendshipLabelArea;
