void __fastcall BattleResultBondsIconComponent___ctor(BattleResultBondsIconComponent_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.friendshipLabelArea = xmmword_BE3390;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69F2B & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&IFriendshipGauge_TypeInfo, v5);
    sub_1BE4ACC(&UnityEngine_Object_TypeInfo, v6);
    sub_1BE4ACC(&StringLiteral_25676/*"ーーー"*/, v7);
    sub_1BE4ACC(&StringLiteral_25808/*"＋ "*/, v8);
    this = (BattleResultBondsIconComponent_o *)sub_1BE4ACC(&StringLiteral_9359/*"N0"*/, v9);
    byte_4B69F2B = 1;
  }
  v25 = 0;
  v24[0] = 0;
  ...
  {
LABEL_9:
    p_method = sub_1C36AAC(v4->fields.gaugeComponent, IFriendshipGauge_TypeInfo, 3LL);
  }
  ...
  {
    v19 = System_Int32__ToString_63504416((int32_t)&v25, (System_String_o *)StringLiteral_9359/*"N0"*/, 0LL);
    this = (BattleResultBondsIconComponent_o *)System_String__Concat_62698808(
                                                 (System_String_o *)StringLiteral_25808/*"＋ "*/,
                                                 v19,
                                                 0LL);
    if ( v18 )
    {
...
LABEL_32:
  ...
  if ( !v18 )
    goto LABEL_32;
  UILabel__set_text(v4->fields.atlabel, (System_String_o *)StringLiteral_25676/*"ーーー"*/, 0LL);
  return v23[0] != 0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69F2C & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_25805/*"（＋"*/, method);
    sub_1BE4ACC(&StringLiteral_25808/*"＋ "*/, v3);
    sub_1BE4ACC(&StringLiteral_25806/*"）"*/, v4);
    sub_1BE4ACC(&StringLiteral_9359/*"N0"*/, v5);
    sub_1BE4ACC(&StringLiteral_25804/*"（"*/, v6);
    byte_4B69F2C = 1;
  }
  if ( !this->fields.isMax )
  {
    ...
    if ( v41 > 0 )
    {
      v9 = System_Int32__ToString_63504416((int32_t)p_baseFriendshipExp, (System_String_o *)StringLiteral_9359/*"N0"*/, 0LL);
      p_baseFriendshipExp = System_String__Concat_62698808((System_String_o *)StringLiteral_25808/*"＋ "*/, v9, 0LL);
      if ( atlabel )
      {
        ...
        if ( p_baseFriendshipExp )
        {
          ...
          if ( p_baseFriendshipExp )
          {
            ...
            if ( p_baseFriendshipExp )
            {
              UILabel__set_text((UILabel_o *)p_baseFriendshipExp, (System_String_o *)StringLiteral_25804/*"（"*/, 0LL);
              p_baseFriendshipExp = (System_String_o *)this->fields.bonuslabel;
              if ( p_baseFriendshipExp )
              {
                ...
                if ( v11 )
                {
                  ...
                  v14 = v10;
                  v15 = System_Int32__ToString_63504416((int32_t)&v41, (System_String_o *)StringLiteral_9359/*"N0"*/, 0LL);
                  p_baseFriendshipExp = System_String__Concat_62712072(
                                          mText,
                                          (System_String_o *)StringLiteral_25805/*"（＋"*/,
                                          v15,
                                          (System_String_o *)StringLiteral_25806/*"）"*/,
                                          0LL);
                  if ( this->fields.bonuslabel )
                  {
                    ...
                    if ( p_baseFriendshipExp )
                    {
                      ...
                      v21 = System_Int32__ToString_63504416((int32_t)&v41, (System_String_o *)StringLiteral_9359/*"N0"*/, 0LL);
                      p_baseFriendshipExp = System_String__Concat_62710068(
                                              (System_String_o *)StringLiteral_25805/*"（＋"*/,
                                              v21,
                                              (System_String_o *)StringLiteral_25806/*"）"*/,
                                              0LL);
...
LABEL_39:
      sub_1BE4D28(p_baseFriendshipExp, method);
    }
    if ( !atlabel )
      goto LABEL_39;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69F29 & 1) == 0 )
  {
    sub_1BE4ACC(&UnityEngine_Object_TypeInfo, pointInfo);
    byte_4B69F29 = 1;
  }
  buddyPointInfo = (UnityEngine_Object_o *)this->fields.buddyPointInfo;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69F2D & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_11253/*"RESULT_BOUNDS_NEXT_FRIENDSHIP"*/, v5);
    byte_4B69F2D = 1;
  }
  if ( !this->fields.isMax && !this->fields.isNoFriendship )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(remainingFriendshipLabel, 0LL, 0LL) )
    {
      ...
      v8 = LocalizationManager__Get((System_String_o *)StringLiteral_11253/*"RESULT_BOUNDS_NEXT_FRIENDSHIP"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69F2A & 1) == 0 )
  {
    sub_1BE4ACC(&IFriendshipGauge_TypeInfo, userSvtCol);
    this = (BattleResultBondsIconComponent_o *)sub_1BE4ACC(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, v5);
    byte_4B69F2A = 1;
  }
  if ( !v4->fields.isUse )
    return 0;
  ...
  *(_QWORD *)&v21.fields.fakeValue = v8;
  v9 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47299060(v21, 0LL);
  this = (BattleResultBondsIconComponent_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47299060(
  ...
  {
LABEL_12:
    p_method = sub_1C36AAC(gaugeComponent, IFriendshipGauge_TypeInfo, 1LL);
  }
  (*(void (__fastcall **)(struct IFriendshipGauge_o *, _QWORD, _QWORD, _QWORD))p_method)(
    ...
    v11,
    *(_QWORD *)(p_method + 8));
  v4->fields.nextFriendShipRank = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47299060(
                                    userSvtCol->fields.friendshipRank,
                                    0LL);
  this = (BattleResultBondsIconComponent_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47299060(
...
LABEL_23:
  ...
  {
LABEL_20:
    v20 = sub_1C36AAC(v16, IFriendshipGauge_TypeInfo, 2LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69F28 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_BasicHelper_GetOrAddComponent_CondensedScaleLabel___, userSvtCol);
    ...
    sub_1BE4ACC(&IFriendshipGauge_TypeInfo, v17);
  ...
  *(_QWORD *)&v65.fields.fakeValue = v23;
  v25 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47299060(v65, 0LL);
  faceIcon = this->fields.faceIcon;
  ...
  *(_QWORD *)&v66.fields.fakeValue = v27;
  v30 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47299060(v66, 0LL);
  ...
  *(_QWORD *)&v67.fields.fakeValue = v34;
  root = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47299060(v67, 0LL);
  if ( !v36 )
    goto LABEL_55;
  ...
  *(_QWORD *)&v68.fields.fakeValue = v38;
  this->fields.svtId = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47299060(v68, 0LL);
  ...
  *(_OWORD *)&v64.fields.fakeValue = v40;
  ...
  v63 = v64;
  this->fields.userSvtId = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_47302584(&v63, 0LL);
  this->fields.svtLimit = afterLimitCnt;
  this->fields.svtLv = userSvtEnt->fields.lv;
  this->fields.friendshipId = *(_DWORD *)(v37 + 96);
  this->fields.friendship = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47299060(
                              userSvtCol->fields.friendship,
                              0LL);
  this->fields.friendshipRank = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47299060(
                                  userSvtCol->fields.friendshipRank,
                                  0LL);
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.gaugeComponent, (int64_t)Gauge, v42, v43, v44, v45, v46, v47);
  ...
  {
LABEL_35:
    p_method = sub_1C36AAC(gaugeComponent, IFriendshipGauge_TypeInfo, 0LL);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(remainingFriendshipLabel, 0LL, 0LL) )
  {
    root = (__int64)BasicHelper__GetOrAddComponent_object_(
                      ...
                      (const MethodInfo_2F46E3C *)Method_BasicHelper_GetOrAddComponent_CondensedScaleLabel___);
    if ( !root )
      goto LABEL_55;
    friendshipLabelArea = this->fields.friendshipLabelArea;
