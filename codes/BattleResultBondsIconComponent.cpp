void __fastcall BattleResultBondsIconComponent___ctor(BattleResultBondsIconComponent_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.friendshipLabelArea = xmmword_BAE4D0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A3105C & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_25443/*"（＋"*/, method);
    sub_1B761C0(&StringLiteral_25446/*"＋ "*/, v3);
    sub_1B761C0(&StringLiteral_25444/*"）"*/, v4);
    sub_1B761C0(&StringLiteral_9203/*"N0"*/, v5);
    sub_1B761C0(&StringLiteral_25442/*"（"*/, v6);
    byte_4A3105C = 1;
  }
  if ( !this->fields.isMax )
  {
    ...
    if ( v41 > 0 )
    {
      v9 = System_Int32__ToString_62340340((int32_t)p_baseFriendshipExp, (System_String_o *)StringLiteral_9203/*"N0"*/, 0LL);
      p_baseFriendshipExp = System_String__Concat_61535060((System_String_o *)StringLiteral_25446/*"＋ "*/, v9, 0LL);
      if ( atlabel )
      {
        ...
        if ( p_baseFriendshipExp )
        {
          ...
          if ( p_baseFriendshipExp )
          {
            ...
            if ( p_baseFriendshipExp )
            {
              UILabel__set_text((UILabel_o *)p_baseFriendshipExp, (System_String_o *)StringLiteral_25442/*"（"*/, 0LL);
              p_baseFriendshipExp = (System_String_o *)this->fields.bonuslabel;
              if ( p_baseFriendshipExp )
              {
                ...
                if ( v11 )
                {
                  ...
                  v14 = v10;
                  v15 = System_Int32__ToString_62340340((int32_t)&v41, (System_String_o *)StringLiteral_9203/*"N0"*/, 0LL);
                  p_baseFriendshipExp = System_String__Concat_61548324(
                                          mText,
                                          (System_String_o *)StringLiteral_25443/*"（＋"*/,
                                          v15,
                                          (System_String_o *)StringLiteral_25444/*"）"*/,
                                          0LL);
                  if ( this->fields.bonuslabel )
                  {
                    ...
                    if ( p_baseFriendshipExp )
                    {
                      ...
                      v21 = System_Int32__ToString_62340340((int32_t)&v41, (System_String_o *)StringLiteral_9203/*"N0"*/, 0LL);
                      p_baseFriendshipExp = System_String__Concat_61546320(
                                              (System_String_o *)StringLiteral_25443/*"（＋"*/,
                                              v21,
                                              (System_String_o *)StringLiteral_25444/*"）"*/,
                                              0LL);
...
LABEL_39:
      sub_1B7641C(p_baseFriendshipExp, method);
    }
    if ( !atlabel )
      goto LABEL_39;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31059 & 1) == 0 )
  {
    sub_1B761C0(&UnityEngine_Object_TypeInfo, pointInfo);
    byte_4A31059 = 1;
  }
  buddyPointInfo = (UnityEngine_Object_o *)this->fields.buddyPointInfo;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A3105B & 1) == 0 )
  {
    ...
    sub_1B761C0(&IFriendshipGauge_TypeInfo, v5);
    sub_1B761C0(&UnityEngine_Object_TypeInfo, v6);
    sub_1B761C0(&StringLiteral_25314/*"ーーー"*/, v7);
    sub_1B761C0(&StringLiteral_25446/*"＋ "*/, v8);
    this = (BattleResultBondsIconComponent_o *)sub_1B761C0(&StringLiteral_9203/*"N0"*/, v9);
    byte_4A3105B = 1;
  }
  v26[0] = 0;
  v25[0] = 0;
  ...
  {
LABEL_9:
    p_method = sub_1BC81A0(v4->fields.gaugeComponent, IFriendshipGauge_TypeInfo, 4LL);
  }
  ...
  else
  {
    ...
    if ( UnityEngine_Object__op_Inequality(v17, 0LL, 0LL) )
    {
      ...
      if ( v4->fields.isHeroine )
      {
        if ( !v18 )
          goto LABEL_44;
        UILabel__set_text(v4->fields.atlabel, (System_String_o *)StringLiteral_25314/*"ーーー"*/, 0LL);
      }
      else
      {
        v19 = System_Int32__ToString_62340340((int32_t)&v24, (System_String_o *)StringLiteral_9203/*"N0"*/, 0LL);
        this = (BattleResultBondsIconComponent_o *)System_String__Concat_61535060(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A3105A & 1) == 0 )
  {
    sub_1B761C0(&IFriendshipGauge_TypeInfo, userSvtCol);
    this = (BattleResultBondsIconComponent_o *)sub_1B761C0(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, v5);
    byte_4A3105A = 1;
  }
  if ( !v4->fields.isUse )
    return 0;
  ...
  *(_QWORD *)&v21.fields.fakeValue = v8;
  v9 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(v21, 0LL);
  this = (BattleResultBondsIconComponent_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(
  ...
  {
LABEL_12:
    p_method = sub_1BC81A0(gaugeComponent, IFriendshipGauge_TypeInfo, 1LL);
  }
  (*(void (__fastcall **)(struct IFriendshipGauge_o *, _QWORD, _QWORD, _QWORD))p_method)(
    ...
    v11,
    *(_QWORD *)(p_method + 8));
  v4->fields.nextFriendShipRank = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(
                                    userSvtCol->fields.friendshipRank,
                                    0LL);
  this = (BattleResultBondsIconComponent_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(
...
LABEL_23:
  ...
  {
LABEL_20:
    v20 = sub_1BC81A0(v16, IFriendshipGauge_TypeInfo, 2LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31058 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMasterData_ServantMaster___, userSvtCol);
    sub_1B761C0(&Method_DataMasterBase_ServantMaster__ServantEntity__int__GetEntity__, v15);
    sub_1B761C0(&IFriendshipGauge_TypeInfo, v16);
  ...
  *(_QWORD *)&v55.fields.fakeValue = v21;
  v23 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(v55, 0LL);
  faceIcon = this->fields.faceIcon;
  ...
  *(_QWORD *)&v56.fields.fakeValue = v25;
  v28 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(v56, 0LL);
  ...
  ServantFaceIconComponent__Set_38036872(
    ...
    0,
    0LL);
  root = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_371257C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !root )
    goto LABEL_48;
  ...
  *(_QWORD *)&v57.fields.fakeValue = v32;
  root = (UnityEngine_GameObject_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(v57, 0LL);
  if ( !v34 )
    goto LABEL_48;
  ...
  *(_QWORD *)&v58.fields.fakeValue = v36;
  this->fields.svtId = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(v58, 0LL);
  ...
  *(_OWORD *)&v54.fields.fakeValue = v38;
  ...
  v53 = v54;
  this->fields.userSvtId = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_46340496(&v53, 0LL);
  this->fields.svtLimit = afterLimitCnt;
  this->fields.svtLv = userSvtEnt->fields.lv;
  this->fields.friendshipId = (int32_t)v35[4].klass;
  this->fields.friendship = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(
                              userSvtCol->fields.friendship,
                              0LL);
  this->fields.friendshipRank = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(
                                  userSvtCol->fields.friendshipRank,
                                  0LL);
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.gaugeComponent, (int32_t)Gauge, v40, v41);
  ...
  {
LABEL_35:
    p_method = sub_1BC81A0(gaugeComponent, IFriendshipGauge_TypeInfo, 0LL);
  }
