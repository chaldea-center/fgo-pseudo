void __fastcall BattleResultBondsIconComponent___ctor(BattleResultBondsIconComponent_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.friendshipLabelArea = xmmword_BAC0F0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22BE6 & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_25397/*"（＋"*/, method);
    sub_1B715CC(&StringLiteral_25400/*"＋ "*/, v3);
    sub_1B715CC(&StringLiteral_25398/*"）"*/, v4);
    sub_1B715CC(&StringLiteral_9174/*"N0"*/, v5);
    sub_1B715CC(&StringLiteral_25396/*"（"*/, v6);
    byte_4A22BE6 = 1;
  }
  if ( !this->fields.isMax )
  {
    ...
    if ( v41 > 0 )
    {
      v9 = System_Int32__ToString_62310784((int32_t)p_baseFriendshipExp, (System_String_o *)StringLiteral_9174/*"N0"*/, 0LL);
      p_baseFriendshipExp = System_String__Concat_61505504((System_String_o *)StringLiteral_25400/*"＋ "*/, v9, 0LL);
      if ( atlabel )
      {
        ...
        if ( p_baseFriendshipExp )
        {
          ...
          if ( p_baseFriendshipExp )
          {
            ...
            if ( p_baseFriendshipExp )
            {
              UILabel__set_text((UILabel_o *)p_baseFriendshipExp, (System_String_o *)StringLiteral_25396/*"（"*/, 0LL);
              p_baseFriendshipExp = (System_String_o *)this->fields.bonuslabel;
              if ( p_baseFriendshipExp )
              {
                ...
                if ( v11 )
                {
                  ...
                  v14 = v10;
                  v15 = System_Int32__ToString_62310784((int32_t)&v41, (System_String_o *)StringLiteral_9174/*"N0"*/, 0LL);
                  p_baseFriendshipExp = System_String__Concat_61518768(
                                          mText,
                                          (System_String_o *)StringLiteral_25397/*"（＋"*/,
                                          v15,
                                          (System_String_o *)StringLiteral_25398/*"）"*/,
                                          0LL);
                  if ( this->fields.bonuslabel )
                  {
                    ...
                    if ( p_baseFriendshipExp )
                    {
                      ...
                      v21 = System_Int32__ToString_62310784((int32_t)&v41, (System_String_o *)StringLiteral_9174/*"N0"*/, 0LL);
                      p_baseFriendshipExp = System_String__Concat_61516764(
                                              (System_String_o *)StringLiteral_25397/*"（＋"*/,
                                              v21,
                                              (System_String_o *)StringLiteral_25398/*"）"*/,
                                              0LL);
...
LABEL_39:
      sub_1B71828(p_baseFriendshipExp, method);
    }
    if ( !atlabel )
      goto LABEL_39;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22BE3 & 1) == 0 )
  {
    sub_1B715CC(&UnityEngine_Object_TypeInfo, pointInfo);
    byte_4A22BE3 = 1;
  }
  buddyPointInfo = (UnityEngine_Object_o *)this->fields.buddyPointInfo;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22BE5 & 1) == 0 )
  {
    ...
    sub_1B715CC(&IFriendshipGauge_TypeInfo, v5);
    sub_1B715CC(&UnityEngine_Object_TypeInfo, v6);
    sub_1B715CC(&StringLiteral_25268/*"ーーー"*/, v7);
    sub_1B715CC(&StringLiteral_25400/*"＋ "*/, v8);
    this = (BattleResultBondsIconComponent_o *)sub_1B715CC(&StringLiteral_9174/*"N0"*/, v9);
    byte_4A22BE5 = 1;
  }
  v26[0] = 0;
  v25[0] = 0;
  ...
  {
LABEL_9:
    p_method = sub_1BC35AC(v4->fields.gaugeComponent, IFriendshipGauge_TypeInfo, 4LL);
  }
  ...
  else
  {
    ...
    if ( UnityEngine_Object__op_Inequality(v17, 0LL, 0LL) )
    {
      ...
      if ( v4->fields.isHeroine )
      {
        if ( !v18 )
          goto LABEL_44;
        UILabel__set_text(v4->fields.atlabel, (System_String_o *)StringLiteral_25268/*"ーーー"*/, 0LL);
      }
      else
      {
        v19 = System_Int32__ToString_62310784((int32_t)&v24, (System_String_o *)StringLiteral_9174/*"N0"*/, 0LL);
        this = (BattleResultBondsIconComponent_o *)System_String__Concat_61505504(
                                                     (System_String_o *)StringLiteral_25400/*"＋ "*/,
                                                     v19,
                                                     0LL);
        if ( !v18 )
          goto LABEL_44;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22BE4 & 1) == 0 )
  {
    sub_1B715CC(&IFriendshipGauge_TypeInfo, userSvtCol);
    this = (BattleResultBondsIconComponent_o *)sub_1B715CC(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, v5);
    byte_4A22BE4 = 1;
  }
  if ( !v4->fields.isUse )
    return 0;
  ...
  *(_QWORD *)&v21.fields.fakeValue = v8;
  v9 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46308268(v21, 0LL);
  this = (BattleResultBondsIconComponent_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46308268(
  ...
  {
LABEL_12:
    p_method = sub_1BC35AC(gaugeComponent, IFriendshipGauge_TypeInfo, 1LL);
  }
  (*(void (__fastcall **)(struct IFriendshipGauge_o *, _QWORD, _QWORD, _QWORD))p_method)(
    ...
    v11,
    *(_QWORD *)(p_method + 8));
  v4->fields.nextFriendShipRank = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46308268(
                                    userSvtCol->fields.friendshipRank,
                                    0LL);
  this = (BattleResultBondsIconComponent_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46308268(
...
LABEL_23:
  ...
  {
LABEL_20:
    v20 = sub_1BC35AC(v16, IFriendshipGauge_TypeInfo, 2LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22BE2 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataManager_GetMasterData_ServantMaster___, userSvtCol);
    sub_1B715CC(&Method_DataMasterBase_ServantMaster__ServantEntity__int__GetEntity__, v15);
    sub_1B715CC(&IFriendshipGauge_TypeInfo, v16);
  ...
  *(_QWORD *)&v55.fields.fakeValue = v21;
  v23 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46308268(v55, 0LL);
  faceIcon = this->fields.faceIcon;
  ...
  *(_QWORD *)&v56.fields.fakeValue = v25;
  v28 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46308268(v56, 0LL);
  ...
  ServantFaceIconComponent__Set_38011932(
    ...
    0,
    0LL);
  root = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !root )
    goto LABEL_48;
  ...
  *(_QWORD *)&v57.fields.fakeValue = v32;
  root = (UnityEngine_GameObject_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46308268(v57, 0LL);
  if ( !v34 )
    goto LABEL_48;
  ...
  *(_QWORD *)&v58.fields.fakeValue = v36;
  this->fields.svtId = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46308268(v58, 0LL);
  ...
  *(_OWORD *)&v54.fields.fakeValue = v38;
  ...
  v53 = v54;
  this->fields.userSvtId = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_46311792(&v53, 0LL);
  this->fields.svtLimit = afterLimitCnt;
  this->fields.svtLv = userSvtEnt->fields.lv;
  this->fields.friendshipId = (int32_t)v35[4].klass;
  this->fields.friendship = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46308268(
                              userSvtCol->fields.friendship,
                              0LL);
  this->fields.friendshipRank = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46308268(
                                  userSvtCol->fields.friendshipRank,
                                  0LL);
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.gaugeComponent, (int32_t)Gauge, v40, v41);
  ...
  {
LABEL_35:
    p_method = sub_1BC35AC(gaugeComponent, IFriendshipGauge_TypeInfo, 0LL);
  }
