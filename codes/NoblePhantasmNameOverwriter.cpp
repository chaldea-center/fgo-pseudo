        ...
        const MethodInfo *method)
{
  ...
  if ( !entity )
    sub_1C2E388(0LL, npNameLabel);
  SvtId = UserServantEntity__getSvtId(entity, 0LL);
  DispSelectLimitCount = UserServantEntity__getDispSelectLimitCount(entity, 0, 0LL);
  NoblePhantasmNameOverwriter__SetOverwriteNpLabel_46461120(SvtId, DispSelectLimitCount, npNameLabel, npRubyLabel, v9);
}


// local variable allocation has failed, the output may be wrong!
void __fastcall NoblePhantasmNameOverwriter__SetOverwriteNpLabel_46461120(
        int32_t servantId,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C01219 & 1) == 0 )
  {
    sub_1C2E12C(&Method_DataManager_GetMasterData_ServantLimitAddMaster___, *(_QWORD *)&dispLimitCount);
  ...
  ServantLimitCountSealAfter = ServantLimitImageMaster__GetServantLimitCountSealAfter(
                                 ...
                                 dispLimitCount,
                                 0LL);
  Master_object = (ServantLimitImageMaster_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38A7F90 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Master_object )
    goto LABEL_17;
