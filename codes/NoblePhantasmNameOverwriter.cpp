        ...
        const MethodInfo *method)
{
  ...
  if ( !entity )
    sub_1B00F28(0LL, npNameLabel);
  SvtId = UserServantEntity__getSvtId(entity, 0LL);
  DispSelectLimitCount = UserServantEntity__getDispSelectLimitCount(entity, 0, 0LL);
  NoblePhantasmNameOverwriter__SetOverwriteNpLabel_43521248(SvtId, DispSelectLimitCount, npNameLabel, npRubyLabel, v9);
}


// local variable allocation has failed, the output may be wrong!
void __fastcall NoblePhantasmNameOverwriter__SetOverwriteNpLabel_43521248(
        int32_t servantId,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E5ED1 & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataManager_GetMasterData_ServantLimitAddMaster___, *(_QWORD *)&dispLimitCount);
  ...
  Master_object = (ServantLimitImageMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2D62BBC *)Method_DataManager_GetMaster_ServantLimitImageMaster___);
  if ( !Master_object )
    goto LABEL_17;
  ServantLimitCountSealAfter = ServantLimitImageMaster__GetServantLimitCountSealAfter(
                                 ...
                                 dispLimitCount,
                                 0LL);
  Master_object = (ServantLimitImageMaster_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_35FBBF0 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Master_object )
    goto LABEL_17;
