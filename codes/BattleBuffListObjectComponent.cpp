void BattleBuffListObjectComponent___cctor(const MethodInfo *method)
{
  if ( (byte_4E07F7B & 1) == 0 )
  {
    sub_1CE6700(&BattleBuffListObjectComponent_TypeInfo);
    byte_4E07F7B = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E07F79 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_2720/*"BATTLE_BUFF_TURN"*/);
    sub_1CE6700(&StringLiteral_1/*""*/);
    sub_1CE6700(&StringLiteral_2714/*"BATTLE_BUFF_COUNT"*/);
    sub_1CE6700(&StringLiteral_2713/*"BATTLE_BUFF_BOOST"*/);
    byte_4E07F79 = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataManager__GetMaster_object_((const MethodInfo_3204354 *)Method_DataManager_GetMaster_BuffMaster___);
  if ( !buffData )
    goto LABEL_39;
  if ( !Master_object )
    goto LABEL_39;
  ...
  if ( !this->fields.buffIcon )
    goto LABEL_39;
  v7 = Master_object;
  BattleServantBuffIconComponent__setIcon_48740488(this->fields.buffIcon, buffData, 0);
  if ( !v7 )
    goto LABEL_39;
  ...
  if ( !buffData->fields.isHideParam )
  {
    if ( buffData->fields.turn >= 1 )
    {
      ...
      v15 = LocalizationManager__Get((System_String_o *)StringLiteral_2720/*"BATTLE_BUFF_TURN"*/, 0);
    ...
    if ( buffData->fields.count >= 1 )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v21 = LocalizationManager__Get((System_String_o *)StringLiteral_2714/*"BATTLE_BUFF_COUNT"*/, 0);
  ...
  if ( buffData->fields.turn <= 0 && buffData->fields.isBoost )
  {
    ...
    Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)LocalizationManager__Get(
                                                                    (System_String_o *)StringLiteral_2713/*"BATTLE_BUFF_BOOST"*/,
                                                                    0);
    if ( v24 )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E07F7A & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_2718/*"BATTLE_BUFF_INTERVAL_REMAIN"*/);
    sub_1CE6700(&StringLiteral_2719/*"BATTLE_BUFF_INTERVAL_TURN"*/);
    sub_1CE6700(&StringLiteral_1/*""*/);
    sub_1CE6700(&StringLiteral_2717/*"BATTLE_BUFF_INTERVAL_COUNT"*/);
    byte_4E07F7A = 1;
  }
      ...
      if ( interval )
      {
        ...
        if ( IntervalVal >= 1 )
        {
          ...
          if ( BattleBuffData_IntervalData__get_HasIntervalTurn(interval, 0) )
            v11 = (System_String_o **)&StringLiteral_2719/*"BATTLE_BUFF_INTERVAL_TURN"*/;
          else
            v11 = (System_String_o **)&StringLiteral_2717/*"BATTLE_BUFF_INTERVAL_COUNT"*/;
          v12 = *v11;
          v13 = this->fields.remainLabel;
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          v8 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2718/*"BATTLE_BUFF_INTERVAL_REMAIN"*/, 0);
          if ( v13 )
          {
