void BattleBuffListObjectComponent___cctor(const MethodInfo *method)
{
  if ( (byte_4D33F00 & 1) == 0 )
  {
    sub_1C93AD4(&BattleBuffListObjectComponent_TypeInfo);
    byte_4D33F00 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D33EFE & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_2715/*"BATTLE_BUFF_TURN"*/);
    sub_1C93AD4(&StringLiteral_1/*""*/);
    sub_1C93AD4(&StringLiteral_2709/*"BATTLE_BUFF_COUNT"*/);
    sub_1C93AD4(&StringLiteral_2708/*"BATTLE_BUFF_BOOST"*/);
    byte_4D33EFE = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataManager__GetMaster_object_((const MethodInfo_31A49E8 *)Method_DataManager_GetMaster_BuffMaster___);
  if ( !buffData )
    goto LABEL_39;
  if ( !Master_object )
    goto LABEL_39;
  ...
  if ( !this->fields.buffIcon )
    goto LABEL_39;
  v7 = Master_object;
  BattleServantBuffIconComponent__setIcon_48278892(this->fields.buffIcon, buffData, 0);
  if ( !v7 )
    goto LABEL_39;
  ...
  if ( !buffData->fields.isHideParam )
  {
    if ( buffData->fields.turn >= 1 )
    {
      ...
      v15 = LocalizationManager__Get((System_String_o *)StringLiteral_2715/*"BATTLE_BUFF_TURN"*/, 0);
    ...
    if ( buffData->fields.count >= 1 )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v21 = LocalizationManager__Get((System_String_o *)StringLiteral_2709/*"BATTLE_BUFF_COUNT"*/, 0);
  ...
  if ( buffData->fields.turn <= 0 && buffData->fields.isBoost )
  {
    ...
    Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)LocalizationManager__Get(
                                                                    (System_String_o *)StringLiteral_2708/*"BATTLE_BUFF_BOOST"*/,
                                                                    0);
    if ( v24 )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D33EFF & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_2713/*"BATTLE_BUFF_INTERVAL_REMAIN"*/);
    sub_1C93AD4(&StringLiteral_2714/*"BATTLE_BUFF_INTERVAL_TURN"*/);
    sub_1C93AD4(&StringLiteral_1/*""*/);
    sub_1C93AD4(&StringLiteral_2712/*"BATTLE_BUFF_INTERVAL_COUNT"*/);
    byte_4D33EFF = 1;
  }
      ...
      if ( interval )
      {
        ...
        if ( IntervalVal >= 1 )
        {
          ...
          if ( BattleBuffData_IntervalData__get_HasIntervalTurn(interval, 0) )
            v11 = (System_String_o **)&StringLiteral_2714/*"BATTLE_BUFF_INTERVAL_TURN"*/;
          else
            v11 = (System_String_o **)&StringLiteral_2712/*"BATTLE_BUFF_INTERVAL_COUNT"*/;
          v12 = *v11;
          v13 = this->fields.remainLabel;
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          v8 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2713/*"BATTLE_BUFF_INTERVAL_REMAIN"*/, 0);
          if ( v13 )
          {
