void BattleBuffListObjectComponent___cctor(const MethodInfo *method)
{
  if ( (byte_4CF1B1C & 1) == 0 )
  {
    sub_1C7BAE8(&BattleBuffListObjectComponent_TypeInfo);
    byte_4CF1B1C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF1B1A & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_2703/*"BATTLE_BUFF_TURN"*/);
    sub_1C7BAE8(&StringLiteral_1/*""*/);
    sub_1C7BAE8(&StringLiteral_2697/*"BATTLE_BUFF_COUNT"*/);
    sub_1C7BAE8(&StringLiteral_2696/*"BATTLE_BUFF_BOOST"*/);
    byte_4CF1B1A = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataManager__GetMaster_object_((const MethodInfo_31703A0 *)Method_DataManager_GetMaster_BuffMaster___);
  if ( !buffData )
    goto LABEL_39;
  if ( !Master_object )
    goto LABEL_39;
  ...
  if ( !this->fields.buffIcon )
    goto LABEL_39;
  v7 = Master_object;
  BattleServantBuffIconComponent__setIcon_48077640(this->fields.buffIcon, buffData, 0);
  if ( !v7 )
    goto LABEL_39;
  ...
  if ( !buffData->fields.isHideParam )
  {
    ...
    if ( buffData->fields.count >= 1 )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v21 = LocalizationManager__Get((System_String_o *)StringLiteral_2697/*"BATTLE_BUFF_COUNT"*/, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF1B1B & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_2701/*"BATTLE_BUFF_INTERVAL_REMAIN"*/);
    sub_1C7BAE8(&StringLiteral_2702/*"BATTLE_BUFF_INTERVAL_TURN"*/);
    sub_1C7BAE8(&StringLiteral_1/*""*/);
    sub_1C7BAE8(&StringLiteral_2700/*"BATTLE_BUFF_INTERVAL_COUNT"*/);
    byte_4CF1B1B = 1;
  }
