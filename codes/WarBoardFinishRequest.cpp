        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F8FB & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_24687/*"winCondId"*/, v11);
    sub_1B761C0(&StringLiteral_24686/*"winCondGroup"*/, v12);
    sub_1B761C0(&StringLiteral_20805/*"isResult"*/, v13);
    byte_4A2F8FB = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23465/*"stageId"*/, stageId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_20805/*"isResult"*/, isResult, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_24687/*"winCondId"*/, winCondId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_24686/*"winCondGroup"*/, winCondGroup, 0LL);
...
System_String_o *__fastcall WarBoardFinishRequest__getURL(WarBoardFinishRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2F8FA & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_24603/*"warBoard/finish"*/, v2);
    byte_4A2F8FA = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61535060(BaseUrl, (System_String_o *)StringLiteral_24603/*"warBoard/finish"*/, 0LL);
}
