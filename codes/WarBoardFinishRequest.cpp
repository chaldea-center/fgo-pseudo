        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E79319 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_25344/*"winCondId"*/);
    sub_1D0F0B4(&StringLiteral_25343/*"winCondGroup"*/);
    sub_1D0F0B4(&StringLiteral_21357/*"isResult"*/);
    byte_4E79319 = 1;
  }
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21357/*"isResult"*/, isResult, v11);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_25344/*"winCondId"*/, winCondId, v12);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_25343/*"winCondGroup"*/, winCondGroup, v13);
...
System_String_o *WarBoardFinishRequest__getURL(WarBoardFinishRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E79318 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_25254/*"warBoard/finish"*/);
    byte_4E79318 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_65562772(BaseUrl, (System_String_o *)StringLiteral_25254/*"warBoard/finish"*/, 0);
}
