        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4210DBE & 1) == 0 )
  {
    ...
    sub_B0D8A4(&StringLiteral_23359/*"winCondId"*/, v11);
    sub_B0D8A4(&StringLiteral_23358/*"winCondGroup"*/, v12);
    sub_B0D8A4(&StringLiteral_20013/*"isResult"*/, v13);
    byte_4210DBE = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22338/*"stageId"*/, stageId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_20013/*"isResult"*/, isResult, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23359/*"winCondId"*/, winCondId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23358/*"winCondGroup"*/, winCondGroup, 0LL);
...
System_String_o *__fastcall WarBoardFinishRequest__getURL(WarBoardFinishRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4210DBD & 1) == 0 )
  {
    ...
    sub_B0D8A4(&StringLiteral_23283/*"warBoard/finish"*/, v2);
    byte_4210DBD = 1;
  }
  ...
  return System_String__Concat_43849904(BaseUrl, (System_String_o *)StringLiteral_23283/*"warBoard/finish"*/, 0LL);
}
