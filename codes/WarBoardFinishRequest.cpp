        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40F640D & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_23187/*"winCondId"*/, v11);
    sub_B16FFC(&StringLiteral_23186/*"winCondGroup"*/, v12);
    sub_B16FFC(&StringLiteral_19868/*"isResult"*/, v13);
    byte_40F640D = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22171/*"stageId"*/, stageId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19868/*"isResult"*/, isResult, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23187/*"winCondId"*/, winCondId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23186/*"winCondGroup"*/, winCondGroup, 0LL);
...
System_String_o *__fastcall WarBoardFinishRequest__getURL(WarBoardFinishRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_40F640C & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_23111/*"warBoard/finish"*/, v2);
    byte_40F640C = 1;
  }
  ...
  return System_String__Concat_43743732(BaseUrl, (System_String_o *)StringLiteral_23111/*"warBoard/finish"*/, 0LL);
}
