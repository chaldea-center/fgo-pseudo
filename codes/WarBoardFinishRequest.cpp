        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42E5243 & 1) == 0 )
  {
    sub_B5D5C4(&StringLiteral_22565/*"stageId"*/, stageId, isResult, *(_QWORD *)&winCondId);
    sub_B5D5C4(&StringLiteral_23592/*"winCondId"*/, v11, v12, v13);
    sub_B5D5C4(&StringLiteral_23591/*"winCondGroup"*/, v14, v15, v16);
    sub_B5D5C4(&StringLiteral_20204/*"isResult"*/, v17, v18, v19);
    byte_42E5243 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22565/*"stageId"*/, stageId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_20204/*"isResult"*/, isResult, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23592/*"winCondId"*/, winCondId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23591/*"winCondGroup"*/, winCondGroup, 0LL);
...
System_String_o *__fastcall WarBoardFinishRequest__getURL(WarBoardFinishRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42E5242 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&StringLiteral_23514/*"warBoard/finish"*/, v4, v5, v6);
    byte_42E5242 = 1;
  }
  ...
  return System_String__Concat_44577788(BaseUrl, (System_String_o *)StringLiteral_23514/*"warBoard/finish"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v12 = ResponseCommandKind__SearchData(100, responseList, 0LL);
  if ( v12
