        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B38BC3 & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_24989/*"winCondId"*/, v11);
    sub_1BD3458(&StringLiteral_24988/*"winCondGroup"*/, v12);
    sub_1BD3458(&StringLiteral_21072/*"isResult"*/, v13);
    byte_4B38BC3 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23760/*"stageId"*/, stageId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21072/*"isResult"*/, isResult, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_24989/*"winCondId"*/, winCondId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_24988/*"winCondGroup"*/, winCondGroup, 0LL);
...
System_String_o *__fastcall WarBoardFinishRequest__getURL(WarBoardFinishRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B38BC2 & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_24905/*"warBoard/finish"*/, v2);
    byte_4B38BC2 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62525248(BaseUrl, (System_String_o *)StringLiteral_24905/*"warBoard/finish"*/, 0LL);
}
