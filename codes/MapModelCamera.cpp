        ...
        const MethodInfo *method)
{
  ...
  return MapModelCamera__RayCast_35433704(
...
// local variable allocation has failed, the output may be wrong!
UnityEngine_GameObject_o *__fastcall MapModelCamera__RayCast_35433704(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B190D1 & 1) == 0 )
  {
    renderTextureCamera = (UnityEngine_Camera_o *)sub_1BCAFF8(&UnityEngine_Physics_TypeInfo, renderTextureUI);
    byte_4B190D1 = 1;
  }
  ...
  *(UnityEngine_Vector3_o *)&v13 = UnityEngine_Transform__InverseTransformPoint(
  ...
  UnityEngine_Camera__ScreenPointToRay_69942832(&v27, v12, v31, 0LL);
  v28 = v27;
  if ( !UnityEngine_Physics_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Physics_TypeInfo);
  v26 = v28;
  renderTextureCamera = (UnityEngine_Camera_o *)UnityEngine_Physics__RaycastAll_70455008(&v26, 0LL);
  if ( !renderTextureCamera )
    goto LABEL_19;
  ...
  for ( i = &renderTextureCamera[1].monitor; ; i = (void **)((char *)i + 44) )
  {
    if ( v19 >= (unsigned int)klass )
      sub_1BCB25C(renderTextureCamera, renderTextureUI, v16);
  ...
  if ( !renderTextureCamera )
LABEL_19:
    sub_1BCB254(renderTextureCamera, renderTextureUI);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B190D0 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_UnityEngine_GameObject_GetComponent_UITexture___, screen);
    sub_1BCAFF8(&UnityEngine_Object_TypeInfo, v6);
    sub_1BCAFF8(&UnityEngine_RenderTexture_TypeInfo, v7);
    byte_4B190D0 = 1;
  }
  this->fields.screenUI = screen;
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.screenUI, (int32_t)screen, (int32_t)method, v3);
