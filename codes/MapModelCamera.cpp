        ...
        const MethodInfo *method)
{
  ...
  return MapModelCamera__RayCast_42957592(
...
UnityEngine_GameObject_o *MapModelCamera__RayCast_42957592(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5934FEF & 1) == 0 )
  {
    renderTextureCamera = (UnityEngine_Camera_o *)sub_21FFC50(&UnityEngine_Physics_TypeInfo);
    byte_5934FEF = 1;
  }
  ...
  UnityEngine_Camera__ScreenPointToRay_82985504(&v25, v12, v29, 0);
  if ( !*(&UnityEngine_Physics_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(UnityEngine_Physics_TypeInfo, v13, v14);
  v24 = v25;
  renderTextureCamera = (UnityEngine_Camera_o *)UnityEngine_Physics__RaycastAll_83676432(&v24, 0);
  if ( !renderTextureCamera )
    goto LABEL_19;
  ...
  for ( i = renderTextureCamera + 1; ; i = (UnityEngine_Camera_o *)((char *)i + 44) )
  {
    if ( v17 >= (unsigned int)v15 )
      sub_21FFED4(renderTextureCamera);
    v19 = *(_OWORD *)&i->klass;
    fields = i->fields;
  ...
  if ( !renderTextureCamera )
LABEL_19:
    sub_21FFECC(renderTextureCamera, renderTextureUI);
