        ...
        const MethodInfo *method)
{
  ...
  return MapModelCamera__RayCast_33799048(
...
// local variable allocation has failed, the output may be wrong!
UnityEngine_GameObject_o *__fastcall MapModelCamera__RayCast_33799048(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57FE0 & 1) == 0 )
  {
    renderTextureCamera = (UnityEngine_Camera_o *)sub_1B885B0(&UnityEngine_Physics_TypeInfo);
    byte_4A57FE0 = 1;
  }
  ...
  *(UnityEngine_Vector3_o *)&v13 = UnityEngine_Transform__InverseTransformPoint(
  ...
  UnityEngine_Camera__ScreenPointToRay_69266160(&v26, v12, v30, 0LL);
  v27 = v26;
  if ( !UnityEngine_Physics_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Physics_TypeInfo);
  v25 = v27;
  renderTextureCamera = (UnityEngine_Camera_o *)UnityEngine_Physics__RaycastAll_69774880(&v25, 0LL);
  if ( !renderTextureCamera )
    goto LABEL_19;
  ...
  for ( i = &renderTextureCamera[1].monitor; ; i = (void **)((char *)i + 44) )
  {
    if ( v18 >= (unsigned int)klass )
      sub_1B88814(renderTextureCamera, renderTextureUI);
  ...
  if ( !renderTextureCamera )
LABEL_19:
    sub_1B8880C(renderTextureCamera, renderTextureUI);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.screenUI, (int32_t)screen, (int32_t)method, v3);
  ...
  if ( (screenUI & 1) == 0 )
  {
    if ( Component_object )
    {
      ...
      if ( cameraInstance )
      {
        ...
        {
          v11 = *(UnityEngine_RenderTexture_c **)(*(_QWORD *)(*(_QWORD *)screenUI + 200LL) + 8 * methodPtr_low - 8) == UnityEngine_RenderTexture_TypeInfo
        ...
        UnityEngine_Camera__set_targetTexture(cameraInstance, v11, 0LL);
