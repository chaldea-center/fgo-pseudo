        ...
        const MethodInfo *method)
{
  ...
  return MapModelCamera__RayCast_34787264(
...
// local variable allocation has failed, the output may be wrong!
UnityEngine_GameObject_o *__fastcall MapModelCamera__RayCast_34787264(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB141C & 1) == 0 )
  {
    renderTextureCamera = (UnityEngine_Camera_o *)sub_1C13D24(&UnityEngine_Physics_TypeInfo, renderTextureUI);
    byte_4BB141C = 1;
  }
  ...
  *(UnityEngine_Vector3_o *)&v13 = UnityEngine_Transform__InverseTransformPoint(
  ...
  UnityEngine_Camera__ScreenPointToRay_70528448(&v26, v12, v30, 0LL);
  v27 = v26;
  if ( !UnityEngine_Physics_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Physics_TypeInfo);
  v25 = v27;
  renderTextureCamera = (UnityEngine_Camera_o *)UnityEngine_Physics__RaycastAll_71037616(&v25, 0LL);
  if ( !renderTextureCamera )
    goto LABEL_19;
  ...
  for ( i = &renderTextureCamera[1].monitor; ; i = (void **)((char *)i + 44) )
  {
    if ( v18 >= (unsigned int)klass )
      sub_1C13F88(renderTextureCamera, renderTextureUI);
  ...
  if ( !renderTextureCamera )
LABEL_19:
    sub_1C13F80(renderTextureCamera, renderTextureUI);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB141B & 1) == 0 )
  {
    sub_1C13D24(&Method_UnityEngine_GameObject_GetComponent_UITexture___, screen);
    sub_1C13D24(&UnityEngine_Object_TypeInfo, v10);
    sub_1C13D24(&UnityEngine_RenderTexture_TypeInfo, v11);
    byte_4BB141B = 1;
  }
  ...
  if ( (screenUI & 1) == 0 )
  {
    if ( Component_object )
    {
      ...
      if ( cameraInstance )
      {
        ...
        {
          v17 = *(UnityEngine_RenderTexture_c **)(*(_QWORD *)(*(_QWORD *)screenUI + 200LL) + 8 * methodPtr_low - 8) == UnityEngine_RenderTexture_TypeInfo
