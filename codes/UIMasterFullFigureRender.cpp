void UIMasterFullFigureRender___cctor(const MethodInfo *method)
{
  ...
  *(_OWORD *)&UIMasterFullFigureRender_TypeInfo->static_fields->MAIN_SIZE_X = xmmword_E9D6F0;
  v2 = sub_2213B20(v1, 1);
  if ( !v2 )
    goto LABEL_10;
  if ( !*(_DWORD *)(v2 + 24) )
  ...
  *(_QWORD *)(v2 + 32) = 0;
  ...
  sub_2213A04(
    ...
    v10,
    v11);
  v2 = sub_2213B20(UnityEngine_Vector2___TypeInfo, 1);
  if ( !v2 )
    goto LABEL_10;
  if ( !*(_DWORD *)(v2 + 24) )
    goto LABEL_11;
...
LABEL_11:
  ...
  *(int32x2_t *)(v2 + 32) = vdup_n_s32(0x447F8000u);
  ...
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&v21->bodySizeTable, (int32_t)v20, v22, v23, v24, v25, v26, v27);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_597218F & 1) == 0 )
  {
    ...
    sub_2213A60(&StringLiteral_9316/*"MasterFullFigure/equip{0:D5}"*/);
    byte_597218F = 1;
  }
  ...
  *(_QWORD *)&v35.fields.fakeValue = v12;
  ...
  if ( v14 < 1 )
    goto LABEL_19;
  v34 = v14;
  v15 = (Il2CppObject *)j_il2cpp_value_box_0(qword_5984348, &v34);
  Instance = (DataManager_o *)System_String__Format((System_String_o *)StringLiteral_9316/*"MasterFullFigure/equip{0:D5}"*/, v15, 0);
  if ( !v5 )
    goto LABEL_26;
  if ( !*(_DWORD *)(v5 + 24) )
    goto LABEL_27;
  *(_QWORD *)(v5 + 32) = Instance;
  sub_2213A04((MissionNaviTransitionBoardItem_o *)(v5 + 32), (int32_t)Instance, v16, v17, v18, v19, v20, v21);
  if ( !*(_DWORD *)(v5 + 24) )
    goto LABEL_27;
...
LABEL_19:
    if ( genderType == 2 )
      ...
      v24 = 1;
    v33 = v24;
    v25 = (Il2CppObject *)j_il2cpp_value_box_0(qword_5984348, &v33);
    Instance = (DataManager_o *)System_String__Format((System_String_o *)StringLiteral_9316/*"MasterFullFigure/equip{0:D5}"*/, v25, 0);
    if ( v5 )
    {
      if ( *(_DWORD *)(v5 + 24) )
      {
        *(_QWORD *)(v5 + 32) = Instance;
        sub_2213A04((MissionNaviTransitionBoardItem_o *)(v5 + 32), (int32_t)Instance, v26, v27, v28, v29, v30, v31);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5972194 & 1) == 0 )
  {
    ...
    this = (UIMasterFullFigureRender_o *)sub_2213A60(&StringLiteral_17306/*"a"*/);
    byte_5972194 = 1;
  }
  if ( !dataList )
    goto LABEL_9;
...
LABEL_10:
  ...
  this = (UIMasterFullFigureRender_o *)System_String__Concat_75651716(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5972193 & 1) == 0 )
  {
    this = (UIMasterFullFigureRender_o *)sub_2213A60(&Method_AssetData_GetObject_Texture2D____91708360);
    byte_5972193 = 1;
  }
  if ( !v3 )
    goto LABEL_9;
...
void UIMasterFullFigureRender__MoveAlpha_51024496(
        UIMasterFullFigureRender_o *this,
        float duration,
        float alpha,
...
LABEL_23:
  ...
  *(_QWORD *)&v23.fields.fakeValue = v15;
  ...
  v21 = System_String__Format((System_String_o *)StringLiteral_9316/*"MasterFullFigure/equip{0:D5}"*/, v19, 0);
  if ( !*(&AssetManager_TypeInfo->_2.cctor_finished + 1) )
...
void UIMasterFullFigureRender__SetLayer(UIMasterFullFigureRender_o *this, int32_t layer, const MethodInfo *method)
{
  ...
  if ( UnityEngine_GameObject__get_layer(gameObject, 0) != layer )
  {
    ...
    UIMasterFullFigureRender__SetLayer_51025020(this, transform, layer, v8);
  }
}


void UIMasterFullFigureRender__SetLayer_51025020(
        UIMasterFullFigureRender_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5972196 & 1) == 0 )
  {
    ...
    this = (UIMasterFullFigureRender_o *)sub_2213A60(&UnityEngine_Transform_TypeInfo);
    byte_5972196 = 1;
  }
  if ( !tf
...
LABEL_34:
    ...
    UIMasterFullFigureRender__SetLayer_51025020(v6, v17, layer, v19);
  }
