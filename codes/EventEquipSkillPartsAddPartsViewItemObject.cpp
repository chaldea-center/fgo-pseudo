        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC161F & 1) == 0 )
  {
    sub_1C713B0(&Method_UnityEngine_GameObject_GetComponent_EventEquipSkillPartsAddPartsListViewItemDraw___);
    byte_4CC161F = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_31A2ED0 *)Method_UnityEngine_GameObject_GetComponent_EventEquipSkillPartsAddPartsListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC1620 & 1) == 0 )
  {
    sub_1C713B0(&EventEquipSkillPartsAddPartsListViewItem_TypeInfo);
    byte_4CC1620 = 1;
  }
...
LABEL_9:
  ...
  if ( item )
  {
    ...
    {
      itemDraw = (EventEquipSkillPartsAddPartsListViewItemDraw_o *)sub_1C719A4(item);
      goto LABEL_9;
    }
  }
