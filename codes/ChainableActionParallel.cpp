        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A7463F & 1) == 0 )
  {
    sub_1B90010(&Method_System_Collections_Generic_List_ChainableActionBase___ctor__, actionArray);
    sub_1B90010(&System_Collections_Generic_List_ChainableActionBase__TypeInfo, v5);
    byte_4A7463F = 1;
  }
  ChainableActionBase___ctor((ChainableActionBase_o *)this, (const MethodInfo *)actionArray);
  v6 = (System_Collections_Generic_List_object__o *)sub_1B9025C(System_Collections_Generic_List_ChainableActionBase__TypeInfo);
  System_Collections_Generic_List_object____ctor_55640756(
    v6,
    (System_Collections_Generic_IEnumerable_T__o *)actionArray,
    (const MethodInfo_35102B4 *)Method_System_Collections_Generic_List_ChainableActionBase___ctor__);
  this->fields.sysChainAction = (struct System_Collections_Generic_List_ChainableActionBase__o *)v6;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.sysChainAction, (int32_t)v6, v7, v8);
}


void __fastcall ChainableActionParallel___ctor_46613960(
        ChainableActionParallel_o *this,
...
void __fastcall ChainableActionParallel__ExecuteOnDetail(ChainableActionParallel_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A74640 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_ChainableActionParallel_OnOneActionEnded__, v4);
    sub_1B90010(&Method_System_Collections_Generic_List_Enumerator_ChainableActionBase__Dispose__, v5);
    sub_1B90010(&Method_System_Collections_Generic_List_Enumerator_ChainableActionBase__MoveNext__, v6);
    sub_1B90010(&Method_System_Collections_Generic_List_Enumerator_ChainableActionBase__get_Current__, v7);
    sub_1B90010(&Method_System_Collections_Generic_List_ChainableActionBase__GetEnumerator__, v8);
    byte_4A74640 = 1;
  }
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    sysChainAction,
    (const MethodInfo_35114B8 *)Method_System_Collections_Generic_List_ChainableActionBase__GetEnumerator__);
  v22 = v21;
  while ( System_Collections_Generic_List_Enumerator_object___MoveNext(
            &v22,
            (const MethodInfo_328A150 *)Method_System_Collections_Generic_List_Enumerator_ChainableActionBase__MoveNext__) )
  {
    current = (ChainableActionBase_o *)v22.fields._current;
    v11 = sub_1B900B8(System_Action___TypeInfo, 1LL);
    ...
    if ( !*(_DWORD *)(v11 + 24) )
      sub_1B90274(v13, v14);
    *(_QWORD *)(v11 + 32) = v12;
    sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v11 + 32), (int32_t)v12, v15, v16);
    if ( !current )
      sub_1B9026C(v17, v18);
  ...
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v22,
    (const MethodInfo_328A14C *)Method_System_Collections_Generic_List_Enumerator_ChainableActionBase__Dispose__);
}
...
void __fastcall ChainableActionParallel__OnOneActionEnded(ChainableActionParallel_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A74641 & 1) == 0 )
  {
    this = (ChainableActionParallel_o *)sub_1B90010(
