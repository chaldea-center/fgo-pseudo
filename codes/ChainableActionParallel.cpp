        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3BF07 & 1) == 0 )
  {
    sub_1C32C20(&Method_System_Collections_Generic_List_ChainableActionBase___ctor__);
    sub_1C32C20(&System_Collections_Generic_List_ChainableActionBase__TypeInfo);
    byte_4C3BF07 = 1;
  }
  ChainableActionBase___ctor((ChainableActionBase_o *)this, (const MethodInfo *)actionArray);
  v5 = (System_Collections_Generic_List_object__o *)sub_1C32E6C(System_Collections_Generic_List_ChainableActionBase__TypeInfo);
  System_Collections_Generic_List_object____ctor_58294448(
    v5,
    (System_Collections_Generic_IEnumerable_T__o *)actionArray,
    (const MethodInfo_37980B0 *)Method_System_Collections_Generic_List_ChainableActionBase___ctor__);
  this->fields.sysChainAction = (struct System_Collections_Generic_List_ChainableActionBase__o *)v5;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.sysChainAction, (int32_t)v5, v6, v7);
}


void ChainableActionParallel___ctor_48998960(
        ChainableActionParallel_o *this,
...
void ChainableActionParallel__ExecuteOnDetail(ChainableActionParallel_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3BF08 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_ChainableActionParallel_OnOneActionEnded__);
    sub_1C32C20(&Method_System_Collections_Generic_List_Enumerator_ChainableActionBase__Dispose__);
    sub_1C32C20(&Method_System_Collections_Generic_List_Enumerator_ChainableActionBase__MoveNext__);
    sub_1C32C20(&Method_System_Collections_Generic_List_Enumerator_ChainableActionBase__get_Current__);
    sub_1C32C20(&Method_System_Collections_Generic_List_ChainableActionBase__GetEnumerator__);
    byte_4C3BF08 = 1;
  }
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    sysChainAction,
    (const MethodInfo_37992B4 *)Method_System_Collections_Generic_List_ChainableActionBase__GetEnumerator__);
  v14 = v13;
  while ( System_Collections_Generic_List_Enumerator_object___MoveNext(
            &v14,
            (const MethodInfo_3522FA8 *)Method_System_Collections_Generic_List_Enumerator_ChainableActionBase__MoveNext__) )
  {
    current = (ChainableActionBase_o *)v14.fields._current;
    v5 = sub_1C32CC8(System_Action___TypeInfo, 1);
    ...
    if ( !*(_DWORD *)(v5 + 24) )
      sub_1C32E84(v7);
    *(_QWORD *)(v5 + 32) = v6;
    sub_1C32BC4((CGThumbnailListItem_o *)(v5 + 32), (int32_t)v6, v8, v9);
    if ( !current )
      sub_1C32E7C(v10);
  ...
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v14,
    (const MethodInfo_3522FA4 *)Method_System_Collections_Generic_List_Enumerator_ChainableActionBase__Dispose__);
}
...
void ChainableActionParallel__OnOneActionEnded(ChainableActionParallel_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3BF09 & 1) == 0 )
  {
    this = (ChainableActionParallel_o *)sub_1C32C20(&Method_System_Collections_Generic_List_ChainableActionBase__get_Count__);
    byte_4C3BF09 = 1;
  }
