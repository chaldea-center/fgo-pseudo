        ...
        const MethodInfo *method)
{
  if ( (byte_4A4FE99 & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_18018/*"continuePass"*/, continuePass);
    byte_4A4FE99 = 1;
  }
...
System_String_o *__fastcall ContinuePrepareRequest__getURL(ContinuePrepareRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4FE97 & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_18015/*"continue/prepare"*/, v2);
    byte_4A4FE97 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61645176(BaseUrl, (System_String_o *)StringLiteral_18015/*"continue/prepare"*/, 0LL);
}
