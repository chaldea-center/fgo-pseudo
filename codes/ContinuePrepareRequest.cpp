        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3EC3 & 1) == 0 )
  {
    sub_1B00CCC(&StringLiteral_17998/*"continuePass"*/, continuePass);
    byte_48E3EC3 = 1;
  }
  RequestBase__addField_39752868((RequestBase_o *)this, (System_String_o *)StringLiteral_17998/*"continuePass"*/, continuePass, v3);
...
System_String_o *__fastcall ContinuePrepareRequest__getURL(ContinuePrepareRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E3EC1 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_17995/*"continue/prepare"*/, v2);
    byte_48E3EC1 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_60325748(BaseUrl, (System_String_o *)StringLiteral_17995/*"continue/prepare"*/, 0LL);
}
