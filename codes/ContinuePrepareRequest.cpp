        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EA796 & 1) == 0 )
  {
    sub_B5D5C4(&StringLiteral_17902/*"continuePass"*/, (_DWORD)continuePass, (_DWORD)method, v3);
    byte_42EA796 = 1;
  }
...
System_String_o *__fastcall ContinuePrepareRequest__getURL(ContinuePrepareRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42EA794 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&StringLiteral_17899/*"continue/prepare"*/, v4, v5, v6);
    byte_42EA794 = 1;
  }
  ...
  return System_String__Concat_44577788(BaseUrl, (System_String_o *)StringLiteral_17899/*"continue/prepare"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v12 = ResponseCommandKind__SearchData(31, responseList, 0LL);
