        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFF0A1 & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_18566/*"continuePass"*/, continuePass);
    byte_4BFF0A1 = 1;
  }
  RequestBase__addField_42503872((RequestBase_o *)this, (System_String_o *)StringLiteral_18566/*"continuePass"*/, continuePass, v3);
...
System_String_o *__fastcall ContinuePrepareRequest__getURL(ContinuePrepareRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFF09F & 1) == 0 )
  {
    ...
    sub_1C2E12C(&StringLiteral_18563/*"continue/prepare"*/, v2);
    byte_4BFF09F = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63235584(BaseUrl, (System_String_o *)StringLiteral_18563/*"continue/prepare"*/, 0LL);
}
