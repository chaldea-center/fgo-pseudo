        ...
        const MethodInfo *method)
{
  if ( (byte_4B1DF82 & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_18097/*"continuePass"*/, continuePass);
    byte_4B1DF82 = 1;
  }
...
System_String_o *__fastcall ContinuePrepareRequest__getURL(ContinuePrepareRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1DF80 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_18094/*"continue/prepare"*/, v2);
    byte_4B1DF80 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62450424(BaseUrl, (System_String_o *)StringLiteral_18094/*"continue/prepare"*/, 0LL);
}
