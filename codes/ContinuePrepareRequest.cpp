        ...
        const MethodInfo *method)
{
  if ( (byte_40FBDA3 & 1) == 0 )
  {
    sub_B16FFC(&StringLiteral_17616, continuePass);
    byte_40FBDA3 = 1;
  }
...
System_String_o *__fastcall ContinuePrepareRequest__getURL(ContinuePrepareRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_40FBDA1 & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_17613, v2);
    byte_40FBDA1 = 1;
  }
  ...
  return System_String__Concat_43743732(BaseUrl, (System_String_o *)StringLiteral_17613, 0LL);
}
