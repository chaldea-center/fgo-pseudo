        ...
        const MethodInfo *method)
{
  if ( (byte_4A00288 & 1) == 0 )
  {
    sub_1B64A00(&StringLiteral_18177/*"continuePass"*/, continuePass);
    byte_4A00288 = 1;
  }
...
System_String_o *__fastcall ContinuePrepareRequest__getURL(ContinuePrepareRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A00286 & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_18174/*"continue/prepare"*/, v2);
    byte_4A00286 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61385136(BaseUrl, (System_String_o *)StringLiteral_18174/*"continue/prepare"*/, 0LL);
}
