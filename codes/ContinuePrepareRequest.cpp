        ...
        const MethodInfo *method)
{
  if ( (byte_4A0A3D7 & 1) == 0 )
  {
    sub_1B686D4(&StringLiteral_18179/*"continuePass"*/, continuePass);
    byte_4A0A3D7 = 1;
  }
...
System_String_o *__fastcall ContinuePrepareRequest__getURL(ContinuePrepareRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0A3D5 & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_18176/*"continue/prepare"*/, v2);
    byte_4A0A3D5 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61419468(BaseUrl, (System_String_o *)StringLiteral_18176/*"continue/prepare"*/, 0LL);
}
