        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FBD9F & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_17616/*"continuePass"*/, v7);
    byte_40FBD9F = 1;
  }
...
System_String_o *__fastcall ContinueInputRequest__getURL(ContinueInputRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_40FBD9D & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_17612/*"continue/input"*/, v2);
    byte_40FBD9D = 1;
  }
  ...
  return System_String__Concat_43743732(BaseUrl, (System_String_o *)StringLiteral_17612/*"continue/input"*/, 0LL);
}
