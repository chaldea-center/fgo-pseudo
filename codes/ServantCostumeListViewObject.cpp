...
void __fastcall ServantCostumeListViewObject__Awake(ServantCostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6A913 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_UnityEngine_GameObject_GetComponent_ServantCostumeListViewItemDraw___, method);
    byte_4B6A913 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2FA979C *)Method_UnityEngine_GameObject_GetComponent_ServantCostumeListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A914 & 1) == 0 )
  {
    sub_1BE4ACC(&ServantCostumeListViewItem_TypeInfo, method);
    byte_4B6A914 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A916 & 1) == 0 )
  {
    sub_1BE4ACC(&ServantCostumeListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4B6A916 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantCostumeListViewObject__Init_46473292(
        ServantCostumeListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantCostumeListViewObject__Init_46474096(
        ServantCostumeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantCostumeListViewObject__Init_46479468(
        ServantCostumeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BE4ACC(&ServantCostumeListViewItem_TypeInfo, method);
    sub_1BE4ACC(&Method_ServantCostumeListViewObject_OnClickSelect__, v3);
    sub_1BE4ACC(&StringLiteral_10019/*"OnClickSelectBase"*/, v4);
    byte_4B6A919 = 1;
  }
      ...
      && (ServantCostumeListViewItem_c *)linkItem->klass->_2.typeHierarchy[methodPtr_low - 1] == ServantCostumeListViewItem_TypeInfo )
    {
      if ( ServantCostumeListViewItem__get_IsCanNotSelect(linkItem, method) )
      {
        ...
        if ( (*((_BYTE *)Method_ServantCostumeListViewObject_OnClickSelect__ + 83) & 2) != 0 )
          v7 = (_QWORD *)sub_1BE4AE4(Method_ServantCostumeListViewObject_OnClickSelect__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A91A & 1) == 0 )
  {
    ...
    this = (ServantCostumeListViewObject_o *)sub_1BE4ACC(&StringLiteral_10096/*"OnPressCancel"*/, v4);
    byte_4B6A91A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A915 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&ServantCostumeListViewItem_TypeInfo, v5);
    byte_4B6A915 = 1;
  }
...
void __fastcall ServantCostumeListViewObject__SetItem_46478528(
        ServantCostumeListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall ServantCostumeListViewObject__SetupDisp(ServantCostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6A917 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&ServantCostumeListViewItem_TypeInfo, v3);
    byte_4B6A917 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
...
void __fastcall ServantCostumeListViewObject__Start(ServantCostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    ServantCostumeListViewObject__Init_46473292(this, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A918 & 1) == 0 )
  {
    sub_1BE4ACC(&ServantCostumeListViewItemDraw_DispMode_TypeInfo, method);
