...
void __fastcall ServantCostumeListViewObject__Awake(ServantCostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C01575 & 1) == 0 )
  {
    sub_1C2E12C(&Method_UnityEngine_GameObject_GetComponent_ServantCostumeListViewItemDraw___, method);
    byte_4C01575 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_3022B0C *)Method_UnityEngine_GameObject_GetComponent_ServantCostumeListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C01576 & 1) == 0 )
  {
    sub_1C2E12C(&ServantCostumeListViewItem_TypeInfo, method);
    byte_4C01576 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C01578 & 1) == 0 )
  {
    sub_1C2E12C(&ServantCostumeListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4C01578 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantCostumeListViewObject__Init_46932372(
        ServantCostumeListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantCostumeListViewObject__Init_46933176(
        ServantCostumeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantCostumeListViewObject__Init_46938576(
        ServantCostumeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C2E12C(&ServantCostumeListViewItem_TypeInfo, method);
    sub_1C2E12C(&Method_ServantCostumeListViewObject_OnClickSelect__, v3);
    sub_1C2E12C(&StringLiteral_10054/*"OnClickSelectBase"*/, v4);
    byte_4C0157B = 1;
  }
      ...
      && (ServantCostumeListViewItem_c *)linkItem->klass->_2.typeHierarchy[methodPtr_low - 1] == ServantCostumeListViewItem_TypeInfo )
    {
      if ( ServantCostumeListViewItem__get_IsCanNotSelect(linkItem, method) )
      {
        ...
        if ( (*((_BYTE *)Method_ServantCostumeListViewObject_OnClickSelect__ + 83) & 2) != 0 )
          v7 = (_QWORD *)sub_1C2E144(Method_ServantCostumeListViewObject_OnClickSelect__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C0157C & 1) == 0 )
  {
    ...
    this = (ServantCostumeListViewObject_o *)sub_1C2E12C(&StringLiteral_10131/*"OnPressCancel"*/, v4);
    byte_4C0157C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C01577 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&ServantCostumeListViewItem_TypeInfo, v5);
    byte_4C01577 = 1;
  }
...
void __fastcall ServantCostumeListViewObject__SetItem_46937636(
        ServantCostumeListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall ServantCostumeListViewObject__SetupDisp(ServantCostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C01579 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&ServantCostumeListViewItem_TypeInfo, v3);
    byte_4C01579 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
...
void __fastcall ServantCostumeListViewObject__Start(ServantCostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    ServantCostumeListViewObject__Init_46932372(this, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C0157A & 1) == 0 )
  {
    sub_1C2E12C(&ServantCostumeListViewItemDraw_DispMode_TypeInfo, method);
