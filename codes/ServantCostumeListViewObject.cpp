...
void __fastcall ServantCostumeListViewObject__Awake(ServantCostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A23592 & 1) == 0 )
  {
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponent_ServantCostumeListViewItemDraw___, method);
    byte_4A23592 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2EAA998 *)Method_UnityEngine_GameObject_GetComponent_ServantCostumeListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A23593 & 1) == 0 )
  {
    sub_1B715CC(&ServantCostumeListViewItem_TypeInfo, method);
    byte_4A23593 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A23595 & 1) == 0 )
  {
    sub_1B715CC(&ServantCostumeListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4A23595 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantCostumeListViewObject__Init_45071088(
        ServantCostumeListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantCostumeListViewObject__Init_45071892(
        ServantCostumeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantCostumeListViewObject__Init_45077012(
        ServantCostumeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B715CC(&ServantCostumeListViewItem_TypeInfo, method);
    sub_1B715CC(&Method_ServantCostumeListViewObject_OnClickSelect__, v3);
    sub_1B715CC(&StringLiteral_9829/*"OnClickSelectBase"*/, v4);
    byte_4A23598 = 1;
  }
      ...
      && (ServantCostumeListViewItem_c *)linkItem->klass->_2.typeHierarchy[methodPtr_low - 1] == ServantCostumeListViewItem_TypeInfo )
    {
      if ( ServantCostumeListViewItem__get_IsCanNotSelect(linkItem, method) )
      {
        ...
        if ( (*((_BYTE *)Method_ServantCostumeListViewObject_OnClickSelect__ + 83) & 2) != 0 )
          v7 = (_QWORD *)sub_1B715E4(Method_ServantCostumeListViewObject_OnClickSelect__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A23599 & 1) == 0 )
  {
    ...
    this = (ServantCostumeListViewObject_o *)sub_1B715CC(&StringLiteral_9906/*"OnPressCancel"*/, v4);
    byte_4A23599 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A23594 & 1) == 0 )
  {
    ...
    sub_1B715CC(&ServantCostumeListViewItem_TypeInfo, v5);
    byte_4A23594 = 1;
  }
...
void __fastcall ServantCostumeListViewObject__SetItem_45076072(
        ServantCostumeListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall ServantCostumeListViewObject__SetupDisp(ServantCostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A23596 & 1) == 0 )
  {
    ...
    sub_1B715CC(&ServantCostumeListViewItem_TypeInfo, v3);
    byte_4A23596 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
...
void __fastcall ServantCostumeListViewObject__Start(ServantCostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    ServantCostumeListViewObject__Init_45071088(this, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A23597 & 1) == 0 )
  {
    sub_1B715CC(&ServantCostumeListViewItemDraw_DispMode_TypeInfo, method);
