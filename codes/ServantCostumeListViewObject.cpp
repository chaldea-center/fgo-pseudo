...
void __fastcall ServantCostumeListViewObject__Awake(ServantCostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C25DA3 & 1) == 0 )
  {
    sub_1C3B764(&Method_UnityEngine_GameObject_GetComponent_ServantCostumeListViewItemDraw___, method);
    byte_4C25DA3 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_3041A18 *)Method_UnityEngine_GameObject_GetComponent_ServantCostumeListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C25DA4 & 1) == 0 )
  {
    sub_1C3B764(&ServantCostumeListViewItem_TypeInfo, method);
    byte_4C25DA4 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C25DA6 & 1) == 0 )
  {
    sub_1C3B764(&ServantCostumeListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4C25DA6 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantCostumeListViewObject__Init_47056116(
        ServantCostumeListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantCostumeListViewObject__Init_47056920(
        ServantCostumeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantCostumeListViewObject__Init_47062320(
        ServantCostumeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C3B764(&ServantCostumeListViewItem_TypeInfo, method);
    sub_1C3B764(&Method_ServantCostumeListViewObject_OnClickSelect__, v3);
    sub_1C3B764(&StringLiteral_10056/*"PARTY_ORGANIZATION_SERVANT_POINT_RANK_"*/, v4);
    byte_4C25DA9 = 1;
  }
      ...
      && (ServantCostumeListViewItem_c *)linkItem->klass->_2.typeHierarchy[methodPtr_low - 1] == ServantCostumeListViewItem_TypeInfo )
    {
      if ( ServantCostumeListViewItem__get_IsCanNotSelect(linkItem, method) )
      {
        ...
        if ( (*((_BYTE *)Method_ServantCostumeListViewObject_OnClickSelect__ + 83) & 2) != 0 )
          v7 = (_QWORD *)sub_1C3B77C(Method_ServantCostumeListViewObject_OnClickSelect__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C25DAA & 1) == 0 )
  {
    ...
    this = (ServantCostumeListViewObject_o *)sub_1C3B764(&StringLiteral_10133/*"PHOTO_TARGET_SELECT_DIALOG_MESSAGE_RIGHT"*/, v4);
    byte_4C25DAA = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C25DA5 & 1) == 0 )
  {
    ...
    sub_1C3B764(&ServantCostumeListViewItem_TypeInfo, v5);
    byte_4C25DA5 = 1;
  }
...
void __fastcall ServantCostumeListViewObject__SetItem_47061380(
        ServantCostumeListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall ServantCostumeListViewObject__SetupDisp(ServantCostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C25DA7 & 1) == 0 )
  {
    ...
    sub_1C3B764(&ServantCostumeListViewItem_TypeInfo, v3);
    byte_4C25DA7 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
...
void __fastcall ServantCostumeListViewObject__Start(ServantCostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    ServantCostumeListViewObject__Init_47056116(this, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C25DA8 & 1) == 0 )
  {
    sub_1C3B764(&ServantCostumeListViewItemDraw_DispMode_TypeInfo, method);
