...
void __fastcall ServantCostumeListViewObject__Awake(ServantCostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B48B02 & 1) == 0 )
  {
    sub_1BDB878(&Method_UnityEngine_GameObject_GetComponent_ServantCostumeListViewItemDraw___, method);
    byte_4B48B02 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_3088520 *)Method_UnityEngine_GameObject_GetComponent_ServantCostumeListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48B03 & 1) == 0 )
  {
    sub_1BDB878(&ServantCostumeListViewItem_TypeInfo, method);
    byte_4B48B03 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48B05 & 1) == 0 )
  {
    sub_1BDB878(&ServantCostumeListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4B48B05 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantCostumeListViewObject__Init_47685120(
        ServantCostumeListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantCostumeListViewObject__Init_47685924(
        ServantCostumeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantCostumeListViewObject__Init_47691324(
        ServantCostumeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&ServantCostumeListViewItem_TypeInfo, method);
    sub_1BDB878(&Method_ServantCostumeListViewObject_OnClickSelect__, v3);
    sub_1BDB878(&StringLiteral_9866/*"OnClickSelectBase"*/, v4);
    byte_4B48B08 = 1;
  }
      ...
      && (ServantCostumeListViewItem_c *)linkItem->klass->_2.typeHierarchy[methodPtr_low - 1] == ServantCostumeListViewItem_TypeInfo )
    {
      if ( ServantCostumeListViewItem__get_IsCanNotSelect(linkItem, method) )
      {
        ...
        if ( (*((_BYTE *)Method_ServantCostumeListViewObject_OnClickSelect__ + 83) & 2) != 0 )
          v7 = (_QWORD *)sub_1BDB890(Method_ServantCostumeListViewObject_OnClickSelect__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48B09 & 1) == 0 )
  {
    ...
    this = (ServantCostumeListViewObject_o *)sub_1BDB878(&StringLiteral_9945/*"OnPressCancel"*/, v4);
    byte_4B48B09 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48B04 & 1) == 0 )
  {
    ...
    sub_1BDB878(&ServantCostumeListViewItem_TypeInfo, v5);
    byte_4B48B04 = 1;
  }
...
void __fastcall ServantCostumeListViewObject__SetItem_47690384(
        ServantCostumeListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall ServantCostumeListViewObject__SetupDisp(ServantCostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B48B06 & 1) == 0 )
  {
    ...
    sub_1BDB878(&ServantCostumeListViewItem_TypeInfo, v3);
    byte_4B48B06 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
...
void __fastcall ServantCostumeListViewObject__Start(ServantCostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    ServantCostumeListViewObject__Init_47685120(this, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48B07 & 1) == 0 )
  {
    sub_1BDB878(&ServantCostumeListViewItemDraw_DispMode_TypeInfo, method);
