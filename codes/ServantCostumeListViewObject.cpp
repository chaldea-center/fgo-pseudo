...
void ServantCostumeListViewObject__Awake(ServantCostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB032F & 1) == 0 )
  {
    sub_1C6BA08(&Method_UnityEngine_GameObject_GetComponent_ServantCostumeListViewItemDraw___);
    byte_4CB032F = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_319312C *)Method_UnityEngine_GameObject_GetComponent_ServantCostumeListViewItemDraw___);
...
void ServantCostumeListViewObject__Init_31687664(
        ServantCostumeListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void ServantCostumeListViewObject__Init_31688468(
        ServantCostumeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void ServantCostumeListViewObject__Init_31693868(
        ServantCostumeListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
void ServantCostumeListViewObject__OnClickSelect(ServantCostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C6BA08(&ServantCostumeListViewItem_TypeInfo);
    sub_1C6BA08(&Method_ServantCostumeListViewObject_OnClickSelect__);
      ...
      && (ServantCostumeListViewItem_c *)linkItem->klass->_2.typeHierarchy[naturalAligment - 1] == ServantCostumeListViewItem_TypeInfo )
    {
      if ( ServantCostumeListViewItem__get_IsCanNotSelect(linkItem, method) )
      {
        ...
        if ( (*((_BYTE *)Method_ServantCostumeListViewObject_OnClickSelect__ + 83) & 2) != 0 )
          v5 = (_QWORD *)sub_1C6BA20(Method_ServantCostumeListViewObject_OnClickSelect__);
...
void ServantCostumeListViewObject__OnLongPush(ServantCostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB0336 & 1) == 0 )
  {
    ...
    this = (ServantCostumeListViewObject_o *)sub_1C6BA08(&StringLiteral_9942/*"OnPressCancel"*/);
    byte_4CB0336 = 1;
  }
...
void ServantCostumeListViewObject__SetItem_31692928(
        ServantCostumeListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void ServantCostumeListViewObject__Start(ServantCostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    ServantCostumeListViewObject__Init_31687664(this, 2, v2);
}
...
System_String_o *ServantCostumeListViewObject__ToString(ServantCostumeListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB0334 & 1) == 0 )
  {
    sub_1C6BA08(&ServantCostumeListViewItemDraw_DispMode_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v11 = (ServantCostumeListViewObject_o *)sub_1C6BFFC(v8);
