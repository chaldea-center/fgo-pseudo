void __fastcall BattleItemData___ctor(BattleItemData_o *this, const MethodInfo *method)
{
  if ( (byte_4A5D780 & 1) == 0 )
  {
    sub_1B885B0(&Method_SingletonTemplate_BattleItemData___ctor__);
    byte_4A5D780 = 1;
  }
  SingletonTemplate_object____ctor(
    (SingletonTemplate_CLASS__o *)this,
    (const MethodInfo_3739C30 *)Method_SingletonTemplate_BattleItemData___ctor__);
}
...
BattleItemData_SaveData_o *__fastcall BattleItemData__GetSaveData(BattleItemData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5D77F & 1) == 0 )
  {
    sub_1B885B0(&BattleItemData_SaveData_TypeInfo);
    byte_4A5D77F = 1;
  }
  v3 = (Il2CppObject *)sub_1B887FC(BattleItemData_SaveData_TypeInfo);
