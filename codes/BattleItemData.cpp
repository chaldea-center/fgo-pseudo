void __fastcall BattleItemData___ctor(BattleItemData_o *this, const MethodInfo *method)
{
  if ( (byte_4A010F9 & 1) == 0 )
  {
    sub_1B64A00(&Method_SingletonTemplate_BattleItemData___ctor__, method);
    byte_4A010F9 = 1;
  }
  SingletonTemplate_object____ctor(
    (SingletonTemplate_CLASS__o *)this,
    (const MethodInfo_36EEE48 *)Method_SingletonTemplate_BattleItemData___ctor__);
}
...
BattleItemData_SaveData_o *__fastcall BattleItemData__GetSaveData(BattleItemData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A010F8 & 1) == 0 )
  {
    sub_1B64A00(&BattleItemData_SaveData_TypeInfo, method);
    byte_4A010F8 = 1;
  }
  v3 = (Il2CppObject *)sub_1B64C4C(BattleItemData_SaveData_TypeInfo);
