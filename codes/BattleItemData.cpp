void BattleItemData___ctor(BattleItemData_o *this, const MethodInfo *method)
{
  if ( (byte_4D2F44B & 1) == 0 )
  {
    sub_1C94098(&Method_SingletonTemplate_BattleItemData___ctor__);
    byte_4D2F44B = 1;
  }
  SingletonTemplate_object____ctor(
    (SingletonTemplate_CLASS__o *)this,
    (const MethodInfo_3ABAB5C *)Method_SingletonTemplate_BattleItemData___ctor__);
}
...
BattleItemData_SaveData_o *BattleItemData__GetSaveData(BattleItemData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2F44A & 1) == 0 )
  {
    sub_1C94098(&BattleItemData_SaveData_TypeInfo);
    byte_4D2F44A = 1;
  }
  v3 = (Il2CppObject *)sub_1C942E4(BattleItemData_SaveData_TypeInfo);
