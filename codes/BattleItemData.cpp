void __fastcall BattleItemData___ctor(BattleItemData_o *this, const MethodInfo *method)
{
  if ( (byte_4A0B24E & 1) == 0 )
  {
    sub_1B686D4(&Method_SingletonTemplate_BattleItemData___ctor__, method);
    byte_4A0B24E = 1;
  }
  SingletonTemplate_object____ctor(
    (SingletonTemplate_CLASS__o *)this,
    (const MethodInfo_36F7BB4 *)Method_SingletonTemplate_BattleItemData___ctor__);
}
...
BattleItemData_SaveData_o *__fastcall BattleItemData__GetSaveData(BattleItemData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0B24D & 1) == 0 )
  {
    sub_1B686D4(&BattleItemData_SaveData_TypeInfo, method);
    byte_4A0B24D = 1;
  }
  v3 = (Il2CppObject *)sub_1B68920(BattleItemData_SaveData_TypeInfo);
