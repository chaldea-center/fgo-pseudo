...
{
  System_Object_array *ComponentsInChildren_object__49449880; // x0
  ...
  if ( (byte_4B3A5B8 & 1) == 0 )
  {
    sub_1BD3458(&Method_UnityEngine_Component_GetComponentsInChildren_ParticleSystem___, method);
    byte_4B3A5B8 = 1;
  }
  ...
  this->fields.particleArray = (struct UnityEngine_ParticleSystem_array *)ComponentsInChildren_object__49449880;
  p_particleArray = &this->fields.particleArray;
  sub_1BD33FC(
    (PartyOrganizationUtility_o *)p_particleArray,
    (int64_t)ComponentsInChildren_object__49449880,
    v5,
    v6,
    v7,
    v8,
