...
{
  System_Object_array *ComponentsInChildren_object__50105668; // x0
  ...
  if ( (byte_4C00CC7 & 1) == 0 )
  {
    sub_1C2E12C(&Method_UnityEngine_Component_GetComponentsInChildren_ParticleSystem___, method);
    byte_4C00CC7 = 1;
  }
  ...
  this->fields.particleArray = (struct UnityEngine_ParticleSystem_array *)ComponentsInChildren_object__50105668;
  p_particleArray = &this->fields.particleArray;
  sub_1C2E0D0(
    (PartyOrganizationUtility_o *)p_particleArray,
    (int64_t)ComponentsInChildren_object__50105668,
    v5,
    v6,
    v7,
    v8,
