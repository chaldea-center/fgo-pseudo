...
int32_t __fastcall GachaEntity__getPayMultiTimePrice(GachaEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2E1C3 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMasterData_StoneShopMaster___, method);
    sub_1B761C0(&Method_DataMasterBase_StoneShopMaster__StoneShopEntity__int__GetEntity__, v3);
  ...
  if ( !MasterData_object
    || (MasterData_object = DataManager__GetMasterData_object_(
                              ...
                              (const MethodInfo_2E62408 *)Method_DataManager_GetMasterData_StoneShopMaster___)) == 0LL )
  {
