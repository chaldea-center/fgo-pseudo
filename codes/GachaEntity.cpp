...
int32_t __fastcall GachaEntity__getPayMultiTimePrice(GachaEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B44D15 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMasterData_StoneShopMaster___, method);
    sub_1BDB878(&Method_DataMasterBase_StoneShopMaster__StoneShopEntity__int__GetEntity__, v4);
  ...
  if ( !MasterData_object
    || (MasterData_object = DataManager__GetMasterData_object_(
                              ...
                              (const MethodInfo_303395C *)Method_DataManager_GetMasterData_StoneShopMaster___)) == 0LL )
  {
