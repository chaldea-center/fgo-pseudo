...
int32_t __fastcall GachaEntity__getPayMultiTimePrice(GachaEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB5FD2 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMasterData_StoneShopMaster___, method);
    sub_1BAB41C(&Method_DataMasterBase_StoneShopMaster__StoneShopEntity__int__GetEntity__, v4);
  ...
  if ( !MasterData_object
    || (MasterData_object = DataManager__GetMasterData_object_(
                              ...
                              (const MethodInfo_2EC55C8 *)Method_DataManager_GetMasterData_StoneShopMaster___)) == 0LL )
  {
