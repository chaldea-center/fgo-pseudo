...
int32_t __fastcall GachaEntity__getPayMultiTimePrice(GachaEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB496B & 1) == 0 )
  {
    sub_1C13D24(&Method_DataManager_GetMasterData_StoneShopMaster___, method);
    sub_1C13D24(&Method_DataMasterBase_StoneShopMaster__StoneShopEntity__int__GetEntity__, v4);
  ...
  if ( !MasterData_object
    || (MasterData_object = DataManager__GetMasterData_object_(
                              ...
                              (const MethodInfo_2F8F46C *)Method_DataManager_GetMasterData_StoneShopMaster___)) == 0LL )
  {
