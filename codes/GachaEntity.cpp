...
int32_t __fastcall GachaEntity__getPayMultiTimePrice(GachaEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A700EE & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMasterData_StoneShopMaster___, method);
    sub_1B90010(&Method_DataMasterBase_StoneShopMaster__StoneShopEntity__int__GetEntity__, v3);
  ...
  if ( !MasterData_object
    || (MasterData_object = DataManager__GetMasterData_object_(
                              ...
                              (const MethodInfo_2E8E21C *)Method_DataManager_GetMasterData_StoneShopMaster___)) == 0LL )
  {
