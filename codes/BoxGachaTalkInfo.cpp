void __fastcall BoxGachaTalkInfo___ctor(BoxGachaTalkInfo_o *this, const MethodInfo *method)
{
  ...
  sub_1BC2FAC(&this->fields.beforeTalkMessageList);
  ...
  sub_1BC2FAC(&this->fields.afterVoiceIdList);
  ...
  sub_1BC2FAC(&this->fields.afterTalkMessageList);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFC560 & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Collections_Generic_List_string__Add__, voiceId);
    byte_4AFC560 = 1;
  }
  ...
  {
LABEL_13:
    sub_1BC3264(afterVoiceIdList, voiceId);
  }
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_13:
    sub_1BC3264(beforeVoiceIdList, voiceId);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFC564 & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Collections_Generic_List_string__get_Item__, *(_QWORD *)&idx);
    byte_4AFC564 = 1;
  }
