...
void __fastcall SetMaterialFloatComponent__Finish(SetMaterialFloatComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.targetRenderer, 0, v2, v3);
        ...
        if ( this->fields.materialIndex < SLODWORD(materials[1].klass) )
        {
          ...
          if ( materials )
          {
            ...
            if ( materials )
            {
              ...
              if ( materials )
              {
                UnityEngine_Material__SetFloat_69225860(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A51B20 & 1) == 0 )
  {
    sub_1B863B8(&UnityEngine_Object_TypeInfo, propertyName);
    byte_4A51B20 = 1;
  }
  UnityEngine_Behaviour__set_enabled((UnityEngine_Behaviour_o *)this, 1, 0LL);
  this->fields.propertyName = propertyName;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.propertyName, (int32_t)propertyName, v19, v20);
  ...
  SetMaterialFloatComponent__Setup_45621188(this, v21);
  targetRenderer = (UnityEngine_Object_o *)this->fields.targetRenderer;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
...
void __fastcall SetMaterialFloatComponent__Setup_45621188(SetMaterialFloatComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1B8635C((CGThumbnailListItem_o *)p_targetRenderer, (int32_t)Component_object, v5, v6);
...
{
  SetMaterialFloatComponent__Setup_45621188(this, method);
}
