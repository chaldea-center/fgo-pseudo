...
void SetMaterialFloatComponent__Finish(SetMaterialFloatComponent_o *this, const MethodInfo *method)
{
  ...
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields.targetRenderer, 0, v2, v3, v4, v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  SetMaterialFloatComponent__Setup_55181708(this, v25);
  targetRenderer = (UnityEngine_Object_o *)this->fields.targetRenderer;
  if ( !*(&UnityEngine_Object_TypeInfo->_2.cctor_finished + 1) )
...
void SetMaterialFloatComponent__Setup_55181708(SetMaterialFloatComponent_o *this, const MethodInfo *method)
{
  ...
  sub_2213A04((MissionNaviTransitionBoardItem_o *)p_targetRenderer, (int32_t)Component_object, v5, v6, v7, v8, v9, v10);
...
{
  SetMaterialFloatComponent__Setup_55181708(this, method);
}
