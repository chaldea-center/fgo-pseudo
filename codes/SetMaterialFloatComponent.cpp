...
void __fastcall SetMaterialFloatComponent__Finish(SetMaterialFloatComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.targetRenderer, 0, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.propertyName, (int32_t)propertyName, v19, v20);
  ...
  SetMaterialFloatComponent__Setup_44344048(this, v21);
  targetRenderer = (UnityEngine_Object_o *)this->fields.targetRenderer;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
...
void __fastcall SetMaterialFloatComponent__Setup_44344048(SetMaterialFloatComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)p_targetRenderer, (int32_t)Component_object, v5, v6);
...
{
  SetMaterialFloatComponent__Setup_44344048(this, method);
}
