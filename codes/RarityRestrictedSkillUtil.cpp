        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFC84 & 1) == 0 )
  {
    skillLvEntity = (SkillLvEntity_o *)sub_1B64A00(&Method_System_Array_IndexOf_int___, servantEntity);
    byte_49FFC84 = 1;
  }
  if ( !v6
    ...
    || ((v7 = skillLvEntity,
      ...
      : (servantEntity = (ServantEntity_o *)(&dword_0 + 3)),
        !v7) )
  {
    sub_1B64C5C(skillLvEntity, servantEntity);
  }
