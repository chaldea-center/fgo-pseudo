        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F0BD & 1) == 0 )
  {
    skillLvEntity = (SkillLvEntity_o *)sub_1B761C0(&Method_System_Array_IndexOf_int___, servantEntity);
    byte_4A2F0BD = 1;
  }
  if ( !v6
    ...
    || ((v7 = skillLvEntity,
      ...
      : (servantEntity = (ServantEntity_o *)(&dword_0 + 3)),
        !v7) )
  {
    sub_1B7641C(skillLvEntity, servantEntity);
  }
