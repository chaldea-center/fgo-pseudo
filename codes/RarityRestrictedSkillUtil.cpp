        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB6EF9 & 1) == 0 )
  {
    skillLvEntity = (SkillLvEntity_o *)sub_1BAB41C(&Method_System_Array_IndexOf_int___, servantEntity);
    byte_4AB6EF9 = 1;
  }
  if ( !v6
    ...
    || ((v7 = skillLvEntity,
      ...
      : (servantEntity = (ServantEntity_o *)(&dword_0 + 3)),
        !v7) )
  {
    sub_1BAB678(skillLvEntity, servantEntity);
  }
