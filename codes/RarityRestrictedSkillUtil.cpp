        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67DCC & 1) == 0 )
  {
    skillLvEntity = (SkillLvEntity_o *)sub_1BE4ACC(&Method_System_Array_IndexOf_int___, servantEntity);
    byte_4B67DCC = 1;
  }
  if ( !v6
    ...
    || ((v7 = skillLvEntity,
      ...
      : (servantEntity = (ServantEntity_o *)(&dword_0 + 3)),
        !v7) )
  {
    sub_1BE4D28(skillLvEntity, servantEntity);
  }
