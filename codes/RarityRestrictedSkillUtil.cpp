        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E38CF & 1) == 0 )
  {
    skillLvEntity = (SkillLvEntity_o *)sub_1B00CCC(&Method_System_Array_IndexOf_int___, servantEntity);
    byte_48E38CF = 1;
  }
  if ( !v6
    ...
    || ((v7 = skillLvEntity,
      ...
      : (servantEntity = (ServantEntity_o *)(&dword_0 + 3)),
        !v7) )
  {
    sub_1B00F28(skillLvEntity, servantEntity);
  }
