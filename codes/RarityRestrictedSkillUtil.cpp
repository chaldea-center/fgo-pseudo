        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B03355 & 1) == 0 )
  {
    skillLvEntity = (SkillLvEntity_o *)sub_1BC3008(&Method_System_Array_IndexOf_int___, servantEntity);
    byte_4B03355 = 1;
  }
  if ( !v6
    ...
    || ((v7 = skillLvEntity,
      ...
      : (servantEntity = (ServantEntity_o *)(&dword_0 + 3)),
        !v7) )
  {
    sub_1BC3264(skillLvEntity, servantEntity);
  }
