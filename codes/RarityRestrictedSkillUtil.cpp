        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFE9B5 & 1) == 0 )
  {
    skillLvEntity = (SkillLvEntity_o *)sub_1C2E12C(&Method_System_Array_IndexOf_int___, servantEntity);
    byte_4BFE9B5 = 1;
  }
  if ( !v6
    ...
    || ((v7 = skillLvEntity,
      ...
      : (servantEntity = (ServantEntity_o *)(&dword_0 + 3)),
        !v7) )
  {
    sub_1C2E388(skillLvEntity, servantEntity);
  }
