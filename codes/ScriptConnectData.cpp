        ...
        const MethodInfo *method)
{
  ...
  sub_1B8635C((CGThumbnailListItem_o *)this, (int32_t)connectPath, (int32_t)objectPath, (const MethodInfo *)endCallback);
  v12->fields.ObjectPath = objectPath;
  sub_1B8635C((CGThumbnailListItem_o *)&v12->fields.ObjectPath, (int32_t)objectPath, v14, v15);
  v12->fields.EndCallback = endCallback;
  sub_1B8635C((CGThumbnailListItem_o *)&v12->fields.EndCallback, (int32_t)endCallback, v16, v17);
  v12->fields.ErrorCallback = errorCallback;
  v12 = (ScriptConnectData_o *)((char *)v12 + 24);
  sub_1B8635C((CGThumbnailListItem_o *)v12, (int32_t)errorCallback, v18, v19);
