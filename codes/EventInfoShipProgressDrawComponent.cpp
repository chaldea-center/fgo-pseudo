void __fastcall EventInfoShipProgressDrawComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48E4042 & 1) == 0 )
  {
    sub_1B00CCC(&EventInfoShipProgressDrawComponent_TypeInfo, v1);
    sub_1B00CCC(&StringLiteral_10627/*"ProgressShipData_"*/, v4);
    byte_48E4042 = 1;
  }
  EventInfoShipProgressDrawComponent_TypeInfo->static_fields->SAVE_KEY_PREFIX_PROGRESS_SHIP_DATA = (struct System_String_o *)StringLiteral_10627/*"ProgressShipData_"*/;
  sub_1B00C70(
    (ServantStatusBattleListViewItem_o *)EventInfoShipProgressDrawComponent_TypeInfo->static_fields,
    StringLiteral_10627/*"ProgressShipData_"*/,
    v2,
    v3);
}
...
void __fastcall EventInfoShipProgressDrawComponent__DeleteContinueData(const MethodInfo *method)
{
  ...
  if ( (byte_48E403F & 1) == 0 )
  {
    ...
    sub_1B00CCC(&EventInfoShipProgressDrawComponent_TypeInfo, v7);
        ...
        && *(EventEntity_c **)(*(_QWORD *)(*(_QWORD *)v25 + 200LL) + 8 * methodPtr_low - 8) == EventEntity_TypeInfo )
      {
               ...
               (const MethodInfo_2FE6AA0 *)Method_DataMasterBase_EventDetailMaster__EventDetailEntity__int__TryGetEntity__) )
        {
          ...
          if ( EventDetailEntity__IsEventRiverProgress(v38, 0LL) )
          {
            ...
            v33 = System_String__Concat_60325748(SAVE_KEY_PREFIX_PROGRESS_SHIP_DATA, v32, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E403B & 1) == 0 )
  {
    sub_1B00CCC(&EventInfoShipProgressDrawComponent__EasingMove_d__13_TypeInfo, endAction);
    byte_48E403B = 1;
  }
  v9 = sub_1B00F18(EventInfoShipProgressDrawComponent__EasingMove_d__13_TypeInfo);
  System_Object___ctor((Il2CppObject *)v9, 0LL);
  *(_DWORD *)(v9 + 16) = 0;
  *(_QWORD *)(v9 + 32) = this;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)(v9 + 32), (int32_t)this, v10, v11);
  *(_QWORD *)(v9 + 48) = endAction;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)(v9 + 48), (int32_t)endAction, v12, v13);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E4040 & 1) == 0 )
  {
    sub_1B00CCC(&EventInfoShipProgressDrawComponent_TypeInfo, method);
    byte_48E4040 = 1;
  }
  ...
  v6 = System_String__Concat_60325748(SAVE_KEY_PREFIX_PROGRESS_SHIP_DATA, v5, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  v7 = System_String__Concat_60325748(SAVE_KEY_PREFIX_PROGRESS_SHIP_DATA, v6, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.progressPathMesh, 0, v2, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E403C & 1) == 0 )
  {
    this = (EventInfoShipProgressDrawComponent_o *)sub_1B00CCC(&UnityEngine_Object_TypeInfo, method);
    byte_48E403C = 1;
  }
  ...
  if ( ((unsigned __int8)this & 1) != 0 )
  {
    ...
    if ( v5 )
    {
      ...
      if ( this )
      {
        ...
        SimpleAnimation__Play_62462980(v5, name, 0LL);
        return;
      }
    }
LABEL_11:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E403A & 1) == 0 )
  {
    sub_1B00CCC(&UnityEngine_Application_TypeInfo, endAction);
    sub_1B00CCC(&System_Math_TypeInfo, v5);
    this = (EventInfoShipProgressDrawComponent_o *)sub_1B00CCC(&UnityEngine_Object_TypeInfo, v6);
    byte_48E403A = 1;
  }
  if ( v4->fields.progressData )
  {
    ...
    if ( progressData )
    {
      ...
      v14 = System_Math__Min_61144624((float)TotalPoint / (float)NextPoint, 1.0, 0LL);
...
LABEL_22:
          v21 = EventInfoShipProgressDrawComponent__EasingMove(
                  ...
                  v17);
          UnityEngine_MonoBehaviour__StartCoroutine_68062928((UnityEngine_MonoBehaviour_o *)v4, v21, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E403D & 1) == 0 )
  {
    sub_1B00CCC(&EventInfoShipProgressDrawComponent__PlayProgressShipResetAnim_d__15_TypeInfo, isFadeIn);
    byte_48E403D = 1;
  }
  v7 = isWait;
  v8 = sub_1B00F18(EventInfoShipProgressDrawComponent__PlayProgressShipResetAnim_d__15_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B00CCC(&EventInfoShipProgressDrawComponent_TypeInfo, method);
    sub_1B00CCC(&System_Text_StringBuilder_TypeInfo, v3);
  ...
  System_Text_StringBuilder__Append_59487644(v5, (System_String_o *)transform, 0LL);
  System_Text_StringBuilder__Append_59487644(v5, (System_String_o *)StringLiteral_1540/*":"*/, 0LL);
  v9 = System_Single__ToString(v8, (const MethodInfo *)v18);
  System_Text_StringBuilder__Append_59487644(v5, v9, 0LL);
  System_Text_StringBuilder__Append_59487644(v5, (System_String_o *)StringLiteral_1540/*":"*/, 0LL);
  startRate = this->fields.startRate;
  v10 = System_Single__ToString(startRate, (const MethodInfo *)&startRate);
  System_Text_StringBuilder__Append_59487644(v5, v10, 0LL);
  ...
  v14 = System_String__Concat_60325748(SAVE_KEY_PREFIX_PROGRESS_SHIP_DATA, v13, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E4039 & 1) == 0 )
  {
    sub_1B00CCC(&System_Math_TypeInfo, inputPointRiverProgressCtr);
  ...
  p_progressData = &this->fields.progressData;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.progressData, (int32_t)progressData, v15, v16);
...
LABEL_25:
  ...
  if ( !*(_BYTE *)(*(_QWORD *)&v13->fields.vtxIdx + 466LL) )
  {
    v21 = *p_progressData;
    if ( !*p_progressData )
      goto LABEL_40;
    ...
    if ( !System_Math_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
    this->fields.startRate = System_Math__Min_61144624((float)TotalPoint / (float)NextPoint, 1.0, 0LL);
  }
LABEL_27:
        ...
        const MethodInfo *method)
{
  ...
  if ( !_4__this )
LABEL_26:
    sub_1B00F28(targetFrameRate, v9);
  ...
  if ( (unsigned int)ReleaseScenarioIndex >= progressPathMesh->max_length )
    sub_1B00F30(targetFrameRate, v9);
  ...
  *(float *)&targetFrameRate[2].monitor = UnityEngine_Time__get_deltaTime(0LL);
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)p__2__current, 0, v26, v27);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B00CE0(&Method_EventInfoShipProgressDrawComponent__EasingMove_d__13_System_Collections_IEnumerator_Reset__);
  sub_1B00DF4(v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E4044 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_22939/*"ship_fade_out"*/, v4);
    this = (EventInfoShipProgressDrawComponent__PlayProgressShipResetAnim_d__15_o *)sub_1B00CCC(
                                                                                      &StringLiteral_22938/*"ship_fade_in"*/,
                                                                                      v5);
    byte_48E4044 = 1;
  }
  ...
  if ( !_1__state )
  {
    ...
    if ( ((unsigned __int8)this & 1) != 0 )
    {
      ...
      *(UnityEngine_Vector3_o *)(&v12 - 1) = UnityEngine_Transform__get_localPosition(
      ...
      v25.fields.y = v16;
      v25.fields.z = z;
      EventInfoUISlideAnimation__StartSlideAnim_41095068(
...
LABEL_22:
    if ( v2->fields.isFadeIn )
      v23 = (System_String_o **)&StringLiteral_22938/*"ship_fade_in"*/;
    else
      v23 = (System_String_o **)&StringLiteral_22939/*"ship_fade_out"*/;
    if ( _4__this )
    {
      this = (EventInfoShipProgressDrawComponent__PlayProgressShipResetAnim_d__15_o *)_4__this->fields.progressShipAnim;
      if ( this )
        ...
        const MethodInfo *method)
{
  ...
  v3 = (System_NotSupportedException_o *)sub_1B00F18(v2);
  System_NotSupportedException___ctor(v3, 0LL);
  v4 = sub_1B00CE0(&Method_EventInfoShipProgressDrawComponent__PlayProgressShipResetAnim_d__15_System_Collections_IEnumerator_Reset__);
  sub_1B00DF4(v3, v4);
}
