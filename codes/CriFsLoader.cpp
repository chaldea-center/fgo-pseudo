...
LABEL_12:
    ...
    v11 = sub_1C940AC(&Method_CriFsLoader__ctor__);
    sub_1C941C0(v7, v11);
  }
        ...
        const MethodInfo *method)
{
  ...
  v7 = this;
  this->fields.srcGch = System_Runtime_InteropServices_GCHandle__Alloc_65097584(&srcBuffer->obj, 3, 0);
  p_srcGch = (intptr_t)&v7->fields.srcGch;
  v7->fields.dstGch = System_Runtime_InteropServices_GCHandle__Alloc_65097584(&dstBuffer->obj, 3, 0);
...
void CriFsLoader__Dispose(CriFsLoader_o *this, const MethodInfo *method)
{
  ...
  CriFsLoader__Dispose_31192644(this, 1, v2);
...
void CriFsLoader__Dispose_31192644(CriFsLoader_o *this, bool disposing, const MethodInfo *method)
{
...
void CriFsLoader__Finalize(CriFsLoader_o *this, const MethodInfo *method)
{
  ...
  CriFsLoader__Dispose_31192644(this, 0, v2);
        ...
        const MethodInfo *method)
{
  ...
  this->fields.dstGch = System_Runtime_InteropServices_GCHandle__Alloc_65097584(&buffer->obj, 3, 0);
  if ( binder )
        ...
        const MethodInfo *method)
{
  ...
  if ( !off_4D259C0 )
  {
    ...
    *(_QWORD *)v20 = "criFsLoader_Load";
    ...
    v22 = 0x200000000LL;
    v24 = 0;
    off_4D259C0 = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD))sub_1C94748(
                                                                                                    v18,
                                                                                                    binder);
  }
  v15 = sub_1C94728(
          ...
          v20[0],
          v21);
  v16 = off_4D259C0(loader, binder, v15, offset, load_size, buffer, buffer_size);
  sub_1C94740(v15);
  return v16;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !off_4D259C8 )
  {
    ...
    v17[4] = 0x200000000LL;
    v19 = 0;
    v8 = (void *)sub_1C94748(v17, binder);
    off_4D259C8 = v8;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !off_4D259E8 )
  {
    ...
    *(_QWORD *)v20 = "criFsLoader_LoadWithoutDecompression";
    ...
    v22 = 0x200000000LL;
    v24 = 0;
    off_4D259E8 = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD))sub_1C94748(
                                                                                                    v18,
                                                                                                    binder);
  }
  v15 = sub_1C94728(
          ...
          v20[0],
          v21);
  v16 = off_4D259E8(loader, binder, v15, offset, load_size, buffer, buffer_size);
  sub_1C94740(v15);
  return v16;
}
...
int32_t CriFsLoader__criFsLoader_SetReadUnitSize(intptr_t loader, int64_t unit_size, const MethodInfo *method)
{
  ...
  if ( !off_4D259E0 )
  {
    ...
    v7[4] = 0x200000000LL;
    v9 = 0;
    v3 = (void *)sub_1C94748(v7, unit_size);
    off_4D259E0 = v3;
  }
