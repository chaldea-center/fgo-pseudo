void __fastcall TreasureBoxTalkMaster___ctor(TreasureBoxTalkMaster_o *this, const MethodInfo *method)
{
  if ( (byte_41899AB & 1) == 0 )
  {
    sub_B2C35C(&Method_DataMasterBase_TreasureBoxTalkMaster__TreasureBoxTalkEntity__string___ctor__, method);
    byte_41899AB = 1;
  }
  DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string____ctor(
    (DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string__o *)this,
    376,
    (const MethodInfo_24E4484 *)Method_DataMasterBase_TreasureBoxTalkMaster__TreasureBoxTalkEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (TreasureBoxTalkEntity_o *)DataMasterBase_WarGroupMaster__WarGroupEntity__string___GetEntity(
                                      ...
                                      PK,
                                      (const MethodInfo_24E4520 *)Method_DataMasterBase_TreasureBoxTalkMaster__TreasureBoxTalkEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_41899AC & 1) == 0 )
  {
    sub_B2C35C(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__, *(_QWORD *)&treasureBoxId);
    ...
    sub_B2C35C(&TreasureBoxTalkEntity_TypeInfo, v9);
    byte_41899AC = 1;
  }
  ...
  if ( (int)list >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( list )
      {
        v15 = *(&TreasureBoxTalkEntity_TypeInfo->_2.bitflags2 + 1);
        if ( *(&list->klass->_2.bitflags2 + 1) >= (unsigned int)v15
          && (TreasureBoxTalkEntity_c *)list->klass->_2.typeHierarchy[v15 - 1] == TreasureBoxTalkEntity_TypeInfo
...
LABEL_17:
    ...
    while ( 1 )
    {
      ...
      System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData___Add(
        v10,
        *((EventMissionProgressRequest_Argument_ProgressData_o **)&syncRoot[2].klass + v18),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_41899AA & 1) == 0 )
  {
    sub_B2C35C(&Method_DataMasterBase_TreasureBoxTalkMaster__TreasureBoxTalkEntity__string__TryGetEntity__, entity);
    byte_41899AA = 1;
  }
  ...
  return DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string___TryGetEntity(
           ...
           PK,
           (const MethodInfo_24E4578 *)Method_DataMasterBase_TreasureBoxTalkMaster__TreasureBoxTalkEntity__string__TryGetEntity__);
}