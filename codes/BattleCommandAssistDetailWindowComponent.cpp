        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CCA8E6 & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_3613/*"COMMAND_ASSIST_NAME"*/);
            ...
            if ( Master_object )
            {
              ...
              if ( v15 )
              {
                ...
                if ( MaxLevelEntity )
                {
                  ...
                  v19 = LocalizationManager__Get((System_String_o *)StringLiteral_3613/*"COMMAND_ASSIST_NAME"*/, 0);
                  ...
                  Master_object = (EventCommandAssistMaster_o *)System_String__Format_64073100(v21, name, v22, v23, 0);
                  if ( !v18 )
                    goto LABEL_45;
              ...
              if ( v15 )
              {
                if ( !DataManager_TypeInfo->_2.cctor_finished )
                  j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
                Master_object = (EventCommandAssistMaster_o *)DataManager__GetMaster_object_((const MethodInfo_314B0B8 *)Method_DataManager_GetMaster_SkillLvMaster___);
                if ( !Master_object )
                  goto LABEL_45;
                ...
                if ( Entity )
                {
                  ...
                  Master_object = (EventCommandAssistMaster_o *)SkillLvEntity__getDetail_43166404(
                                                                  Entity,
                                                                  v15->fields.skillLv,
                                                                  0,
                                                                  0);
        ...
        const MethodInfo *method)
{
  if ( (byte_4CCA8E7 & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_18046/*"closeBtn"*/);
    byte_4CCA8E7 = 1;
  }
  return (System_String_o *)StringLiteral_18046/*"closeBtn"*/;
}