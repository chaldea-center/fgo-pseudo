        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB7609 & 1) == 0 )
  {
    sub_1C13D24(&BattleData_TypeInfo, commandData);
    ...
    sub_1C13D24(&StringLiteral_3738/*"COMBINE_SCENE_VOICE_WELCOME"*/, v11);
            ...
            if ( Master_object )
            {
              ...
              if ( v23 )
              {
                ...
                if ( MaxLevelEntity )
                {
                  ...
                  v27 = LocalizationManager__Get((System_String_o *)StringLiteral_3738/*"COMBINE_SCENE_VOICE_WELCOME"*/, 0LL);
                  ...
                  Master_object = (EventCommandAssistMaster_o *)System_String__Format_62982384(v29, name, v33, v37, 0LL);
                  if ( !v26 )
                    goto LABEL_45;
              ...
              if ( v23 )
              {
                if ( !DataManager_TypeInfo->_2.cctor_finished )
                  j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
                Master_object = (EventCommandAssistMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2F8F418 *)Method_DataManager_GetMaster_SkillLvMaster___);
                if ( !Master_object )
                  goto LABEL_45;
                ...
                if ( Entity )
                {
                  ...
                  Master_object = (EventCommandAssistMaster_o *)SkillLvEntity__getDetail_41099888(
                                                                  Entity,
                                                                  v23->fields.skillLv,
                                                                  0,
                                                                  0LL);
        ...
        const MethodInfo *method)
{
  if ( (byte_4BB760A & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_18297/*"clear_marker"*/, method);
    byte_4BB760A = 1;
  }
  return (System_String_o *)StringLiteral_18297/*"clear_marker"*/;
}