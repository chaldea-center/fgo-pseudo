        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A30CFE & 1) == 0 )
  {
    sub_1B761C0(&BattleData_TypeInfo, commandData);
    ...
    sub_1B761C0(&StringLiteral_3694/*"COMMAND_ASSIST_NAME"*/, v11);
            ...
            if ( Master_object )
            {
              ...
              if ( v23 )
              {
                ...
                if ( MaxLevelEntity )
                {
                  ...
                  v27 = LocalizationManager__Get((System_String_o *)StringLiteral_3694/*"COMMAND_ASSIST_NAME"*/, 0LL);
                  ...
                  Master_object = (EventCommandAssistMaster_o *)System_String__Format_61549500(v29, name, v33, v37, 0LL);
                  if ( !v26 )
                    goto LABEL_45;
              ...
              if ( v23 )
              {
                if ( !DataManager_TypeInfo->_2.cctor_finished )
                  j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
                Master_object = (EventCommandAssistMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2E623B4 *)Method_DataManager_GetMaster_SkillLvMaster___);
                if ( !Master_object )
                  goto LABEL_45;
                ...
                if ( Entity )
                {
                  ...
                  Master_object = (EventCommandAssistMaster_o *)SkillLvEntity__getDetail_39665812(
                                                                  Entity,
                                                                  v23->fields.skillLv,
                                                                  0,
                                                                  0LL);
        ...
        const MethodInfo *method)
{
  if ( (byte_4A30CFF & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_18015/*"closeBtn"*/, method);
    byte_4A30CFF = 1;
  }
  return (System_String_o *)StringLiteral_18015/*"closeBtn"*/;
}