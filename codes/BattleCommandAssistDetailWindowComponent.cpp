        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24F6A & 1) == 0 )
  {
    sub_1C3B764(&BattleData_TypeInfo, commandData);
    ...
    sub_1C3B764(&StringLiteral_3738/*"CONNECT "*/, v11);
            ...
            if ( Master_object )
            {
              ...
              if ( v23 )
              {
                ...
                if ( MaxLevelEntity )
                {
                  ...
                  v27 = LocalizationManager__Get((System_String_o *)StringLiteral_3738/*"CONNECT "*/, 0LL);
                  ...
                  Master_object = (EventCommandAssistMaster_o *)System_String__Format_63383052(v29, name, v33, v37, 0LL);
                  if ( !v26 )
                    goto LABEL_45;
                  ...
                  if ( !Master_object )
                    goto LABEL_45;
                  UILabel__SetCondensedScale((UILabel_o *)Master_object, 750, 0, 0LL);
                }
              }
              if ( v23 )
              {
                if ( !DataManager_TypeInfo->_2.cctor_finished )
                  j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
                Master_object = (EventCommandAssistMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2FF01B0 *)Method_DataManager_GetMaster_SkillLvMaster___);
                if ( !Master_object )
                  goto LABEL_45;
                ...
                if ( Entity )
                {
                  ...
                  Master_object = (EventCommandAssistMaster_o *)SkillLvEntity__getDetail_41399620(
                                                                  Entity,
                                                                  v23->fields.skillLv,
                                                                  0,
                                                                  0LL);
                  ...
                  if ( !Master_object )
                    goto LABEL_45;
                  UILabel__SetCondensedScale((UILabel_o *)Master_object, 656, 0, 0LL);
                }
              }
        ...
        const MethodInfo *method)
{
  if ( (byte_4C24F6B & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_18371/*"ease-out-bounce"*/, method);
    byte_4C24F6B = 1;
  }
  return (System_String_o *)StringLiteral_18371/*"ease-out-bounce"*/;
}