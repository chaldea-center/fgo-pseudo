void TutorialSetRequest__beginRequest(TutorialSetRequest_o *this, int32_t flagId, const MethodInfo *method)
{
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19638/*"flagId"*/, flagId, v3);
...
System_String_o *TutorialSetRequest__getURL(TutorialSetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2E4FA & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_24476/*"tutorial/set"*/);
    byte_4D2E4FA = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64417744(BaseUrl, (System_String_o *)StringLiteral_24476/*"tutorial/set"*/, 0);
}
