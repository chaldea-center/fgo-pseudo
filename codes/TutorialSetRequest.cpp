...
void __fastcall TutorialSetRequest__beginRequest(TutorialSetRequest_o *this, int32_t flagId, const MethodInfo *method)
{
  ...
  if ( (byte_4B4661B & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_19485/*"flagId"*/, *(_QWORD *)&flagId);
    byte_4B4661B = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19485/*"flagId"*/, flagId, v3);
...
System_String_o *__fastcall TutorialSetRequest__getURL(TutorialSetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B46619 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_24287/*"tutorial/set"*/, v2);
    byte_4B46619 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62572260(BaseUrl, (System_String_o *)StringLiteral_24287/*"tutorial/set"*/, 0LL);
}
