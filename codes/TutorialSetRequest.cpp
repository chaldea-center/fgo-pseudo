...
void __fastcall TutorialSetRequest__beginRequest(TutorialSetRequest_o *this, int32_t flagId, const MethodInfo *method)
{
  if ( (byte_4C23A18 & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_19844/*"icon_spot_free"*/, *(_QWORD *)&flagId);
    byte_4C23A18 = 1;
  }
...
System_String_o *__fastcall TutorialSetRequest__getURL(TutorialSetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C23A16 & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_24600/*"{0:00.000}"*/, v2);
    byte_4C23A16 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63368612(BaseUrl, (System_String_o *)StringLiteral_24600/*"{0:00.000}"*/, 0LL);
}
