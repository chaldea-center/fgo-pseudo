...
void DebugServerTimeRequest__beginRequest(DebugServerTimeRequest_o *this, int64_t time, const MethodInfo *method)
{
  if ( (byte_4D2E3B2 & 1) == 0 )
  {
    sub_1C94098(&StringLiteral_23535/*"serverTime"*/);
    byte_4D2E3B2 = 1;
  }
  RequestBase__addField_45013228((RequestBase_o *)this, (System_String_o *)StringLiteral_23535/*"serverTime"*/, time, 0);
...
System_String_o *DebugServerTimeRequest__getURL(DebugServerTimeRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2E3B0 & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_4506/*"ClientDebug/ServerTime"*/);
    byte_4D2E3B0 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64417744(BaseUrl, (System_String_o *)StringLiteral_4506/*"ClientDebug/ServerTime"*/, 0);
}
