...
void DebugServerTimeRequest__beginRequest(DebugServerTimeRequest_o *this, int64_t time, const MethodInfo *method)
{
  if ( (byte_4CB7DE8 & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_23401/*"serverTime"*/);
    byte_4CB7DE8 = 1;
  }
  RequestBase__addField_44468288((RequestBase_o *)this, (System_String_o *)StringLiteral_23401/*"serverTime"*/, time, 0);
...
System_String_o *DebugServerTimeRequest__getURL(DebugServerTimeRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB7DE6 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_4493/*"ClientDebug/ServerTime"*/);
    byte_4CB7DE6 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63966792(BaseUrl, (System_String_o *)StringLiteral_4493/*"ClientDebug/ServerTime"*/, 0);
}
