...
void DebugServerTimeRequest__beginRequest(DebugServerTimeRequest_o *this, int64_t time, const MethodInfo *method)
{
  if ( (byte_4C394A9 & 1) == 0 )
  {
    sub_1C32C20(&StringLiteral_23294/*"serverTime"*/);
    byte_4C394A9 = 1;
  }
  RequestBase__addField_44144740((RequestBase_o *)this, (System_String_o *)StringLiteral_23294/*"serverTime"*/, time, 0);
...
System_String_o *DebugServerTimeRequest__getURL(DebugServerTimeRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C394A7 & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_4503/*"ClientDebug/ServerTime"*/);
    byte_4C394A7 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63518544(BaseUrl, (System_String_o *)StringLiteral_4503/*"ClientDebug/ServerTime"*/, 0);
}
