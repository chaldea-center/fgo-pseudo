void MasterFigureManagerOld___ctor(MasterFigureManagerOld_o *this, const MethodInfo *method)
{
  if ( (byte_4CC6540 & 1) == 0 )
  {
    sub_1C713B0(&Method_SingletonMonoBehaviour_MasterFigureManagerOld___ctor__);
    byte_4CC6540 = 1;
  }
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_3A5F640 *)Method_SingletonMonoBehaviour_MasterFigureManagerOld___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC653F & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_14754/*"UIMasterFigureOld-Enemy("*/);
  ...
  *(_QWORD *)&v19.fields.value.fields.y = 0;
  ...
  if ( !Local
    || (v14 = (UIMasterFigureTextureOld_o *)Local,
        ...
        Local = (UnityEngine_Component_o *)System_String__Concat_64069988(
                                             (System_String_o *)StringLiteral_14754/*"UIMasterFigureOld-Enemy("*/,
                                             v16,
                                             (System_String_o *)StringLiteral_756/*")"*/,
                                             0),
        !gameObject) )
  {
    sub_1C71608(Local, v13);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC653C & 1) == 0 )
  {
    sub_1C713B0(&Method_SingletonMonoBehaviour_MasterFigureManagerOld__get_Instance__);
    byte_4CC653C = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A5F158 *)Method_SingletonMonoBehaviour_MasterFigureManagerOld__get_Instance__);
  if ( !Instance )
    sub_1C71608(0, v12);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC653D & 1) == 0 )
  {
    sub_1C713B0(&Method_UnityEngine_GameObject_GetComponent_UIMasterFigureTextureOld___);
    ...
    sub_1C713B0(&StringLiteral_14752/*"UIMasterFigureOld"*/);
    byte_4CC653D = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       gameObject,
                       (const MethodInfo_31A2ED0 *)Method_UnityEngine_GameObject_GetComponent_UIMasterFigureTextureOld___);
  ...
  UnityEngine_Object__set_name((UnityEngine_Object_o *)v11, (System_String_o *)StringLiteral_14752/*"UIMasterFigureOld"*/, 0);
  if ( !parent )
    goto LABEL_19;
...
// local variable allocation has failed, the output may be wrong!
UIMasterFigureTextureOld_o *MasterFigureManagerOld__CreateLocal_40946004(
        MasterFigureManagerOld_o *this,
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC653E & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_756/*")"*/);
    sub_1C713B0(&StringLiteral_14753/*"UIMasterFigureOld("*/);
    byte_4CC653E = 1;
  }
  ...
  if ( !*((_DWORD *)Local + 6) )
    goto LABEL_12;
  v28 = StringLiteral_14753/*"UIMasterFigureOld("*/;
  *((_QWORD *)Local + 4) = StringLiteral_14753/*"UIMasterFigureOld("*/;
  sub_1C71354((GrandQuestFolderBoardItem_o *)(Local + 32), v28, v21, v22, v23, v24, v25, v26);
  Local = (char *)System_Int32__ToString((int32_t)&v57, 0);
  if ( *((_DWORD *)v27 + 6) <= 1u )
    goto LABEL_12;
  *((_QWORD *)v27 + 5) = Local;
  sub_1C71354((GrandQuestFolderBoardItem_o *)(v27 + 40), (int32_t)Local, v29, v30, v31, v32, v33, v34);
  if ( *((_DWORD *)v27 + 6) <= 2u
    || (v41 = (int)StringLiteral_858/*"-"*/,
        *((_QWORD *)v27 + 6) = StringLiteral_858/*"-"*/,
        sub_1C71354((GrandQuestFolderBoardItem_o *)(v27 + 48), v41, v35, v36, v37, v38, v39, v40),
        Local = (char *)System_Int32__ToString((int32_t)&v56, 0),
        *((_DWORD *)v27 + 6) <= 3u)
    || (*((_QWORD *)v27 + 7) = Local,
        sub_1C71354((GrandQuestFolderBoardItem_o *)(v27 + 56), (int32_t)Local, v42, v43, v44, v45, v46, v47),
        *((_DWORD *)v27 + 6) <= 4u) )
  {
LABEL_12:
    sub_1C71610(Local);
  ...
  *((_QWORD *)v27 + 8) = StringLiteral_756/*")"*/;
  sub_1C71354((GrandQuestFolderBoardItem_o *)(v27 + 64), v54, v48, v49, v50, v51, v52, v53);
  Local = (char *)System_String__Concat_64072256((System_String_array *)v27, 0);
  if ( !gameObject )
LABEL_13:
    sub_1C71608(Local, v18);
  UnityEngine_Object__set_name(gameObject, (System_String_o *)Local, 0);
...
UIMasterFigureTextureOld_o *MasterFigureManagerOld__CreatePrefab_40945812(
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        int32_t equipId,
        ...
        const MethodInfo *method)
{
  ...
  if ( !Instance )
    sub_1C71608(0, v18);
  return MasterFigureManagerOld__CreateLocal_40946004(
           (MasterFigureManagerOld_o *)Instance,
           parent,
           dispType,
           genderType,
