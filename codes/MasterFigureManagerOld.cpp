void __fastcall MasterFigureManagerOld___ctor(MasterFigureManagerOld_o *this, const MethodInfo *method)
{
  if ( (byte_4BC6CC8 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_SingletonMonoBehaviour_MasterFigureManagerOld___ctor__, method);
    byte_4BC6CC8 = 1;
  }
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_387ACC0 *)Method_SingletonMonoBehaviour_MasterFigureManagerOld___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6CC7 & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_14981/*"UIMasterFigureOld-Enemy("*/, parent);
    sub_1C1ABD4(&StringLiteral_812/*")"*/, v12);
    byte_4BC6CC7 = 1;
  }
  ...
  *(_QWORD *)&v20.fields.value.fields.y = 0LL;
  ...
  if ( !Local
    || (v15 = (UIMasterFigureTextureOld_o *)Local,
        ...
        Local = (UnityEngine_Component_o *)System_String__Concat_63051628(
                                             (System_String_o *)StringLiteral_14981/*"UIMasterFigureOld-Enemy("*/,
                                             v17,
                                             (System_String_o *)StringLiteral_812/*")"*/,
                                             0LL),
        !gameObject) )
  {
    sub_1C1AE30(Local, v14);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6CC4 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_SingletonMonoBehaviour_MasterFigureManagerOld__get_Instance__, *(_QWORD *)&enemyFaceId);
    byte_4BC6CC4 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_387A8A8 *)Method_SingletonMonoBehaviour_MasterFigureManagerOld__get_Instance__);
  if ( !Instance )
    sub_1C1AE30(0LL, v12);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6CC5 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_UnityEngine_GameObject_GetComponent_UIMasterFigureTextureOld___, parent);
    ...
    sub_1C1ABD4(&StringLiteral_14979/*"UIMasterFigureOld"*/, v12);
    byte_4BC6CC5 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       gameObject,
                       (const MethodInfo_2FEFBC0 *)Method_UnityEngine_GameObject_GetComponent_UIMasterFigureTextureOld___);
  ...
  UnityEngine_Object__set_name((UnityEngine_Object_o *)v16, (System_String_o *)StringLiteral_14979/*"UIMasterFigureOld"*/, 0LL);
  if ( !parent )
    goto LABEL_19;
...
// local variable allocation has failed, the output may be wrong!
UIMasterFigureTextureOld_o *__fastcall MasterFigureManagerOld__CreateLocal_39118416(
        MasterFigureManagerOld_o *this,
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6CC6 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_918/*"-"*/, v17);
    sub_1C1ABD4(&StringLiteral_812/*")"*/, v18);
    sub_1C1ABD4(&StringLiteral_14980/*"UIMasterFigureOld("*/, v19);
    byte_4BC6CC6 = 1;
  }
  ...
  if ( !*((_DWORD *)Local + 6) )
    goto LABEL_12;
  v31 = StringLiteral_14980/*"UIMasterFigureOld("*/;
  *((_QWORD *)Local + 4) = StringLiteral_14980/*"UIMasterFigureOld("*/;
  sub_1C1AB78((PartyOrganizationUtility_o *)(Local + 32), v31, v24, v25, v26, v27, v28, v29);
  Local = (char *)System_Int32__ToString((int32_t)&v60, 0LL);
  if ( *((_DWORD *)v30 + 6) <= 1u )
    goto LABEL_12;
  *((_QWORD *)v30 + 5) = Local;
  sub_1C1AB78((PartyOrganizationUtility_o *)(v30 + 40), (int64_t)Local, v32, v33, v34, v35, v36, v37);
  if ( *((_DWORD *)v30 + 6) <= 2u
    || (v44 = StringLiteral_918/*"-"*/,
        *((_QWORD *)v30 + 6) = StringLiteral_918/*"-"*/,
        sub_1C1AB78((PartyOrganizationUtility_o *)(v30 + 48), (int64_t)v44, v38, v39, v40, v41, v42, v43),
        Local = (char *)System_Int32__ToString((int32_t)&v59, 0LL),
        *((_DWORD *)v30 + 6) <= 3u)
    || (*((_QWORD *)v30 + 7) = Local,
        sub_1C1AB78((PartyOrganizationUtility_o *)(v30 + 56), (int64_t)Local, v45, v46, v47, v48, v49, v50),
        *((_DWORD *)v30 + 6) <= 4u) )
  {
LABEL_12:
    sub_1C1AE38(Local, v21);
  }
  v57 = StringLiteral_812/*")"*/;
  *((_QWORD *)v30 + 8) = StringLiteral_812/*")"*/;
  sub_1C1AB78((PartyOrganizationUtility_o *)(v30 + 64), v57, v51, v52, v53, v54, v55, v56);
  Local = (char *)System_String__Concat_63053896((System_String_array *)v30, 0LL);
  if ( !gameObject )
LABEL_13:
    sub_1C1AE30(Local, v21);
  UnityEngine_Object__set_name(gameObject, (System_String_o *)Local, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6CC2 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_SingletonMonoBehaviour_MasterFigureManagerOld__get_Instance__, method);
    byte_4BC6CC2 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_387A8A8 *)Method_SingletonMonoBehaviour_MasterFigureManagerOld__get_Instance__);
  if ( !Instance )
...
// local variable allocation has failed, the output may be wrong!
UIMasterFigureTextureOld_o *__fastcall MasterFigureManagerOld__CreatePrefab_39118224(
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        int32_t equipId,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6CC3 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_SingletonMonoBehaviour_MasterFigureManagerOld__get_Instance__, *(_QWORD *)&dispType);
    byte_4BC6CC3 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_387A8A8 *)Method_SingletonMonoBehaviour_MasterFigureManagerOld__get_Instance__);
  if ( !Instance )
    sub_1C1AE30(0LL, v18);
  return MasterFigureManagerOld__CreateLocal_39118416(
           (MasterFigureManagerOld_o *)Instance,
           parent,
           dispType,
           genderType,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6CBF & 1) == 0 )
  {
    sub_1C1ABD4(&AssetManager_TypeInfo, *(_QWORD *)&equipId);
    byte_4BC6CBF = 1;
  }
        ...
        const MethodInfo *method)
{
  if ( (byte_4BC6CBE & 1) == 0 )
  {
    sub_1C1ABD4(&UIMasterFigureRenderOld_TypeInfo, *(_QWORD *)&equipId);
    byte_4BC6CBE = 1;
  }
