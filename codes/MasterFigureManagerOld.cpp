void MasterFigureManagerOld___ctor(MasterFigureManagerOld_o *this, const MethodInfo *method)
{
  if ( (byte_4CB5420 & 1) == 0 )
  {
    sub_1C6BA08(&Method_SingletonMonoBehaviour_MasterFigureManagerOld___ctor__);
    byte_4CB5420 = 1;
  }
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_3A4F89C *)Method_SingletonMonoBehaviour_MasterFigureManagerOld___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB541F & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_14748/*"UIMasterFigureOld-Enemy("*/);
  ...
  *(_QWORD *)&v19.fields.value.fields.y = 0;
  ...
  if ( !Local
    || (v14 = (UIMasterFigureTextureOld_o *)Local,
        ...
        Local = (UnityEngine_Component_o *)System_String__Concat_64005056(
                                             (System_String_o *)StringLiteral_14748/*"UIMasterFigureOld-Enemy("*/,
                                             v16,
                                             (System_String_o *)StringLiteral_756/*")"*/,
                                             0),
        !gameObject) )
  {
    sub_1C6BC60(Local, v13);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB541C & 1) == 0 )
  {
    sub_1C6BA08(&Method_SingletonMonoBehaviour_MasterFigureManagerOld__get_Instance__);
    byte_4CB541C = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A4F3B4 *)Method_SingletonMonoBehaviour_MasterFigureManagerOld__get_Instance__);
  if ( !Instance )
    sub_1C6BC60(0, v12);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB541D & 1) == 0 )
  {
    sub_1C6BA08(&Method_UnityEngine_GameObject_GetComponent_UIMasterFigureTextureOld___);
    ...
    sub_1C6BA08(&StringLiteral_14746/*"UIMasterFigureOld"*/);
    byte_4CB541D = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       gameObject,
                       (const MethodInfo_319312C *)Method_UnityEngine_GameObject_GetComponent_UIMasterFigureTextureOld___);
  ...
  UnityEngine_Object__set_name((UnityEngine_Object_o *)v11, (System_String_o *)StringLiteral_14746/*"UIMasterFigureOld"*/, 0);
  if ( !parent )
    goto LABEL_19;
...
// local variable allocation has failed, the output may be wrong!
UIMasterFigureTextureOld_o *MasterFigureManagerOld__CreateLocal_40903464(
        MasterFigureManagerOld_o *this,
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB541E & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_756/*")"*/);
    sub_1C6BA08(&StringLiteral_14747/*"UIMasterFigureOld("*/);
    byte_4CB541E = 1;
  }
  ...
  if ( !*((_DWORD *)Local + 6) )
    goto LABEL_12;
  v24 = StringLiteral_14747/*"UIMasterFigureOld("*/;
  *((_QWORD *)Local + 4) = StringLiteral_14747/*"UIMasterFigureOld("*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)(Local + 32), v24, v21, v22);
  Local = (char *)System_Int32__ToString((int32_t)&v37, 0);
  if ( *((_DWORD *)v23 + 6) <= 1u )
    goto LABEL_12;
  *((_QWORD *)v23 + 5) = Local;
  sub_1C6B9AC((CGThumbnailListItem_o *)(v23 + 40), (int32_t)Local, v25, v26);
  if ( *((_DWORD *)v23 + 6) <= 2u
    || (v29 = (int)StringLiteral_858/*"-"*/,
        *((_QWORD *)v23 + 6) = StringLiteral_858/*"-"*/,
        sub_1C6B9AC((CGThumbnailListItem_o *)(v23 + 48), v29, v27, v28),
        Local = (char *)System_Int32__ToString((int32_t)&v36, 0),
        *((_DWORD *)v23 + 6) <= 3u)
    || (*((_QWORD *)v23 + 7) = Local,
        sub_1C6B9AC((CGThumbnailListItem_o *)(v23 + 56), (int32_t)Local, v30, v31),
        *((_DWORD *)v23 + 6) <= 4u) )
  {
LABEL_12:
    sub_1C6BC68(Local);
  ...
  *((_QWORD *)v23 + 8) = StringLiteral_756/*")"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)(v23 + 64), v34, v32, v33);
  Local = (char *)System_String__Concat_64007324((System_String_array *)v23, 0);
  if ( !gameObject )
LABEL_13:
    sub_1C6BC60(Local, v18);
  UnityEngine_Object__set_name(gameObject, (System_String_o *)Local, 0);
...
UIMasterFigureTextureOld_o *MasterFigureManagerOld__CreatePrefab_40903272(
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        int32_t equipId,
        ...
        const MethodInfo *method)
{
  ...
  if ( !Instance )
    sub_1C6BC60(0, v18);
  return MasterFigureManagerOld__CreateLocal_40903464(
           (MasterFigureManagerOld_o *)Instance,
           parent,
           dispType,
           genderType,
