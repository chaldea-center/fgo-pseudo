void __fastcall MasterFigureManagerOld___ctor(MasterFigureManagerOld_o *this, const MethodInfo *method)
{
  if ( (byte_4A1ED33 & 1) == 0 )
  {
    sub_1B715CC(&Method_SingletonMonoBehaviour_MasterFigureManagerOld___ctor__, method);
    byte_4A1ED33 = 1;
  }
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_370B620 *)Method_SingletonMonoBehaviour_MasterFigureManagerOld___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1ED32 & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_14682/*"UIMasterFigureOld-Enemy("*/, parent);
    sub_1B715CC(&StringLiteral_814/*")"*/, v12);
    byte_4A1ED32 = 1;
  }
  ...
  *(_QWORD *)&v20.fields.value.fields.y = 0LL;
  ...
  if ( !Local
    || (v15 = (UIMasterFigureTextureOld_o *)Local,
        ...
        Local = (UnityEngine_Component_o *)System_String__Concat_61516764(
                                             (System_String_o *)StringLiteral_14682/*"UIMasterFigureOld-Enemy("*/,
                                             v17,
                                             (System_String_o *)StringLiteral_814/*")"*/,
                                             0LL),
        !gameObject) )
  {
    sub_1B71828(Local, v14);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1ED2F & 1) == 0 )
  {
    sub_1B715CC(&Method_SingletonMonoBehaviour_MasterFigureManagerOld__get_Instance__, *(_QWORD *)&enemyFaceId);
    byte_4A1ED2F = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_MasterFigureManagerOld__get_Instance__);
  if ( !Instance )
    sub_1B71828(0LL, v12);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1ED30 & 1) == 0 )
  {
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponent_UIMasterFigureTextureOld___, parent);
    ...
    sub_1B715CC(&StringLiteral_14680/*"UIMasterFigureOld"*/, v12);
    byte_4A1ED30 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       gameObject,
                       (const MethodInfo_2EAA998 *)Method_UnityEngine_GameObject_GetComponent_UIMasterFigureTextureOld___);
  ...
  UnityEngine_Object__set_name((UnityEngine_Object_o *)v16, (System_String_o *)StringLiteral_14680/*"UIMasterFigureOld"*/, 0LL);
  if ( !parent )
    goto LABEL_19;
...
// local variable allocation has failed, the output may be wrong!
UIMasterFigureTextureOld_o *__fastcall MasterFigureManagerOld__CreateLocal_37714040(
        MasterFigureManagerOld_o *this,
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1ED31 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_919/*"-"*/, v16);
    sub_1B715CC(&StringLiteral_814/*")"*/, v17);
    sub_1B715CC(&StringLiteral_14681/*"UIMasterFigureOld("*/, v18);
    byte_4A1ED31 = 1;
  }
  ...
  if ( !*((_DWORD *)Local + 6) )
    goto LABEL_12;
  v26 = StringLiteral_14681/*"UIMasterFigureOld("*/;
  *((_QWORD *)Local + 4) = StringLiteral_14681/*"UIMasterFigureOld("*/;
  sub_1B71570((ServantStatusBattleListViewItem_o *)(Local + 32), v26, v23, v24);
  Local = (char *)System_Int32__ToString((int32_t)&v39, 0LL);
  if ( *((_DWORD *)v25 + 6) <= 1u )
    goto LABEL_12;
  *((_QWORD *)v25 + 5) = Local;
  sub_1B71570((ServantStatusBattleListViewItem_o *)(v25 + 40), (int32_t)Local, v27, v28);
  if ( *((_DWORD *)v25 + 6) <= 2u
    || (v31 = (int)StringLiteral_919/*"-"*/,
        *((_QWORD *)v25 + 6) = StringLiteral_919/*"-"*/,
        sub_1B71570((ServantStatusBattleListViewItem_o *)(v25 + 48), v31, v29, v30),
        Local = (char *)System_Int32__ToString((int32_t)&v38, 0LL),
        *((_DWORD *)v25 + 6) <= 3u)
    || (*((_QWORD *)v25 + 7) = Local,
        sub_1B71570((ServantStatusBattleListViewItem_o *)(v25 + 56), (int32_t)Local, v32, v33),
        *((_DWORD *)v25 + 6) <= 4u) )
  {
LABEL_12:
    sub_1B71830(Local, v20);
  }
  v36 = StringLiteral_814/*")"*/;
  *((_QWORD *)v25 + 8) = StringLiteral_814/*")"*/;
  sub_1B71570((ServantStatusBattleListViewItem_o *)(v25 + 64), v36, v34, v35);
  Local = (char *)System_String__Concat_61519032((System_String_array *)v25, 0LL);
  if ( !gameObject )
LABEL_13:
    sub_1B71828(Local, v20);
  UnityEngine_Object__set_name(gameObject, (System_String_o *)Local, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1ED2D & 1) == 0 )
  {
    sub_1B715CC(&Method_SingletonMonoBehaviour_MasterFigureManagerOld__get_Instance__, method);
    byte_4A1ED2D = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_MasterFigureManagerOld__get_Instance__);
  if ( !Instance )
...
// local variable allocation has failed, the output may be wrong!
UIMasterFigureTextureOld_o *__fastcall MasterFigureManagerOld__CreatePrefab_37713868(
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        int32_t equipId,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1ED2E & 1) == 0 )
  {
    sub_1B715CC(&Method_SingletonMonoBehaviour_MasterFigureManagerOld__get_Instance__, *(_QWORD *)&dispType);
    byte_4A1ED2E = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_MasterFigureManagerOld__get_Instance__);
  if ( !Instance )
    sub_1B71828(0LL, v17);
  return MasterFigureManagerOld__CreateLocal_37714040(
           (MasterFigureManagerOld_o *)Instance,
           parent,
           dispType,
           genderType,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1ED2A & 1) == 0 )
  {
    sub_1B715CC(&AssetManager_TypeInfo, *(_QWORD *)&equipId);
    byte_4A1ED2A = 1;
  }
        ...
        const MethodInfo *method)
{
  if ( (byte_4A1ED29 & 1) == 0 )
  {
    sub_1B715CC(&UIMasterFigureRenderOld_TypeInfo, *(_QWORD *)&equipId);
    byte_4A1ED29 = 1;
  }
