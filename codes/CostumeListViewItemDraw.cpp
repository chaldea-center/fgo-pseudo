void __fastcall CostumeListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A5EB31 & 1) == 0 )
  {
    sub_1B885B0(&CostumeListViewItemDraw_TypeInfo);
    sub_1B885B0(&StringLiteral_20131/*"icon_costume_01"*/);
    sub_1B885B0(&StringLiteral_20133/*"icon_costume_03"*/);
    sub_1B885B0(&StringLiteral_20132/*"icon_costume_02"*/);
    byte_4A5EB31 = 1;
  }
  CostumeListViewItemDraw_TypeInfo->static_fields->RELEASE_OK_MARK = (struct System_String_o *)StringLiteral_20131/*"icon_costume_01"*/;
  sub_1B88554(
    (ServantStatusBattleListViewItem_o *)CostumeListViewItemDraw_TypeInfo->static_fields,
    StringLiteral_20131/*"icon_costume_01"*/,
    v1,
    v2);
  v3 = StringLiteral_20132/*"icon_costume_02"*/;
  static_fields = CostumeListViewItemDraw_TypeInfo->static_fields;
  static_fields->RELEASE_NG_MARK = (struct System_String_o *)StringLiteral_20132/*"icon_costume_02"*/;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&static_fields->RELEASE_NG_MARK, v3, v5, v6);
  v7 = StringLiteral_20133/*"icon_costume_03"*/;
  v8 = CostumeListViewItemDraw_TypeInfo->static_fields;
  v8->RELEASE_ALREADY_GET_MARK = (struct System_String_o *)StringLiteral_20133/*"icon_costume_03"*/;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v8->RELEASE_ALREADY_GET_MARK, v7, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5EB2E & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_452/*"#E6FF00"*/);
    sub_1B885B0(&StringLiteral_455/*"#FF8E00"*/);
    sub_1B885B0(&StringLiteral_454/*"#FEEF99"*/);
    sub_1B885B0(&StringLiteral_3891/*"COSTUME_CAN_RELEASE"*/);
    sub_1B885B0(&StringLiteral_5566/*"EVENT_COMBINE_COSTUME"*/);
    sub_1B885B0(&StringLiteral_1/*""*/);
                              ...
                              switch ( item->fields.releaseType )
                              {
                                case 0:
                                  ...
                                  costumeNameLb = (UILabel_o *)LocalizationManager__Get(
                                                                 (System_String_o *)StringLiteral_3891/*"COSTUME_CAN_RELEASE"*/,
                                                                 0LL);
                                  if ( !canReleaseMark )
                                    goto LABEL_83;
                                ...
                                case 4:
                                  ...
                                  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                                    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                                  v19 = LocalizationManager__Get((System_String_o *)StringLiteral_5566/*"EVENT_COMBINE_COSTUME"*/, 0LL);
...
LABEL_74:
                            ...
                            *(_QWORD *)&v35.fields.fakeValue = v25;
                            costumeNameLb = (UILabel_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46449800(
                                                           v35,
                                                           0LL);
...
LABEL_83:
    sub_1B8880C(costumeNameLb, item);
  }
}