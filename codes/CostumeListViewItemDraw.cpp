void __fastcall CostumeListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  int64_t v15; // x1
  struct CostumeListViewItemDraw_StaticFields *v16; // x0
  int64_t v17; // x2
  int32_t v18; // w3
  ...
  if ( (byte_4BE01A0 & 1) == 0 )
  {
    sub_1C21E38(&CostumeListViewItemDraw_TypeInfo);
    sub_1C21E38(&StringLiteral_20480/*"icon_costume_01"*/);
    sub_1C21E38(&StringLiteral_20482/*"icon_costume_03"*/);
    sub_1C21E38(&StringLiteral_20481/*"icon_costume_02"*/);
    byte_4BE01A0 = 1;
  }
  CostumeListViewItemDraw_TypeInfo->static_fields->RELEASE_OK_MARK = (struct System_String_o *)StringLiteral_20480/*"icon_costume_01"*/;
  sub_1C21DDC(
    (PartyOrganizationUtility_o *)CostumeListViewItemDraw_TypeInfo->static_fields,
    StringLiteral_20480/*"icon_costume_01"*/,
    v1,
    v2,
    v3,
    v4,
    v5,
    v6);
  v7 = StringLiteral_20481/*"icon_costume_02"*/;
  static_fields = CostumeListViewItemDraw_TypeInfo->static_fields;
  static_fields->RELEASE_NG_MARK = (struct System_String_o *)StringLiteral_20481/*"icon_costume_02"*/;
  sub_1C21DDC((PartyOrganizationUtility_o *)&static_fields->RELEASE_NG_MARK, v7, v9, v10, v11, v12, v13, v14);
  v15 = StringLiteral_20482/*"icon_costume_03"*/;
  v16 = CostumeListViewItemDraw_TypeInfo->static_fields;
  v16->RELEASE_ALREADY_GET_MARK = (struct System_String_o *)StringLiteral_20482/*"icon_costume_03"*/;
  sub_1C21DDC((PartyOrganizationUtility_o *)&v16->RELEASE_ALREADY_GET_MARK, v15, v17, v18, v19, v20, v21, v22);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BE019D & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_449/*"#E6FF00"*/);
    sub_1C21E38(&StringLiteral_452/*"#FF8E00"*/);
    sub_1C21E38(&StringLiteral_451/*"#FEEF99"*/);
    sub_1C21E38(&StringLiteral_3949/*"COSTUME_CAN_RELEASE"*/);
    sub_1C21E38(&StringLiteral_5682/*"EVENT_COMBINE_COSTUME"*/);
    sub_1C21E38(&StringLiteral_1/*""*/);
                    ...
                    if ( costumeNameLb )
                    {
                      ...
                      if ( costumeEntity )
                      {
                        ...
                        if ( costumeNameLb )
                        {
                          ...
                          if ( v10 )
                          {
                            WrapControlText__textAdjust(this->fields.costumeDetailLb, v10->fields.detail, 19, 0, 0LL);
                            if ( item->fields.isNotHaveReleaseItem )
                            {
                              ...
                              switch ( item->fields.releaseType )
                              {
                                case 0:
                                  ...
                                  costumeNameLb = (UILabel_o *)LocalizationManager__Get(
                                                                 (System_String_o *)StringLiteral_3949/*"COSTUME_CAN_RELEASE"*/,
                                                                 0LL);
                                  if ( !canReleaseMark )
                                    goto LABEL_83;
                                ...
                                case 4:
                                  ...
                                  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                                    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                                  v19 = LocalizationManager__Get((System_String_o *)StringLiteral_5682/*"EVENT_COMBINE_COSTUME"*/, 0LL);
                                  v20 = (Il2CppObject *)LocalizationManager__Get(
                                                          (System_String_o *)StringLiteral_5683/*"EVENT_COMBINE_COSTUME_ITEM"*/,
                                                          0LL);
...
LABEL_74:
                            ...
                            *(_QWORD *)&v35.fields.fakeValue = v25;
                            costumeNameLb = (UILabel_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47621364(
                                                           v35,
                                                           0LL);
                            ...
                            if ( v27 )
                            {
                              ...
                              if ( !AtlasManager_TypeInfo->_2.cctor_finished )
                                j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
                              AtlasManager__SetFaceImage(faceIcon, v28, id, 1, 0LL, 0LL);
...
LABEL_83:
    sub_1C22094(costumeNameLb, item);
  }
}