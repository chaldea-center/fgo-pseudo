    ...
    && (p_fields = &this->fields, this->fields._StartTouchInfo_k__BackingField) )
  {
    ...
    if ( v14 )
    {
                                   ...
                                   v18) )
      {
        ...
        sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)v16, v19, v20);
        this->fields._CurrentTouchInfo_k__BackingField = 0LL;
        sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields._CurrentTouchInfo_k__BackingField, 0, v21, v22);
      }
        ...
        const MethodInfo *method)
{
  ...
  __int64 size; // x9
  const MethodInfo_34EEEAC *v16; // x22
  ...
  if ( (byte_49FB0FD & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_System_Collections_Generic_List_Touch__Add__, v2);
    sub_1B64870(&Method_System_Collections_Generic_List_int__Contains__, v3);
    sub_1B64870(&Method_System_Collections_Generic_List_Touch___ctor__, v4);
    sub_1B64870(&System_Collections_Generic_List_Touch__TypeInfo, v5);
    byte_49FB0FD = 1;
  }
  memset(&dest, 0, sizeof(dest));
  v6 = (System_Collections_Generic_List_Touch__o *)sub_1B64ABC(System_Collections_Generic_List_Touch__TypeInfo);
  System_Collections_Generic_List_Touch____ctor(
    v6,
    (const MethodInfo_34EE590 *)Method_System_Collections_Generic_List_Touch___ctor__);
  if ( UnityEngine_Input__get_touchCount(0LL) >= 1 )
  {
    ...
    while ( 1 )
    {
              ...
              (const MethodInfo_3492530 *)Method_System_Collections_Generic_List_int__Contains__) )
      {
        ...
        {
          v16 = *(const MethodInfo_34EEEAC **)(*(_QWORD *)(v13[4] + 192LL) + 112LL);
        ...
        const MethodInfo *method)
{
  ...
  UnityEngine_Vector2_o ScreenPosition_46296316; // kr08_8
  ...
  {
    sub_1B64870(&CTouch_TypeInfo, method);
    sub_1B64870(&Method_System_Collections_Generic_List_Enumerator_Touch__Dispose__, v2);
    sub_1B64870(&Method_System_Collections_Generic_List_Enumerator_Touch__MoveNext__, v3);
    sub_1B64870(&Method_System_Collections_Generic_List_Enumerator_Touch__get_Current__, v4);
    sub_1B64870(&Method_System_Collections_Generic_List_Vector2__Add__, v5);
    sub_1B64870(&Method_System_Collections_Generic_List_Touch__GetEnumerator__, v6);
    sub_1B64870(&Method_System_Collections_Generic_List_Touch__RemoveAt__, v7);
    sub_1B64870(&Method_System_Collections_Generic_List_Vector2__ToArray__, v8);
    sub_1B64870(&Method_System_Collections_Generic_List_Vector2___ctor__, v9);
    sub_1B64870(&Method_System_Collections_Generic_List_Touch__get_Count__, v10);
    sub_1B64870(&Method_System_Collections_Generic_List_Touch__get_Item__, v11);
    sub_1B64870(&System_Collections_Generic_List_Vector2__TypeInfo, v12);
    this = (MapTouchDetector_o *)sub_1B64870(&TouchDetectorBase_TouchInfo_TypeInfo, v13);
    byte_49FB0FC = 1;
  }
  v34 = 0LL;
  memset(&dest, 0, sizeof(dest));
  ...
  System_Collections_Generic_List_Touch___get_Item(
    ...
    AvaliableTouchList,
    0,
    (const MethodInfo_34EEAF4 *)Method_System_Collections_Generic_List_Touch__get_Item__);
  memcpy(&dest, &src, sizeof(dest));
  position = UnityEngine_Touch__get_position(&dest, 0LL);
  if ( !CTouch_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(CTouch_TypeInfo);
  ScreenPosition_46296316 = CTouch__getScreenPosition_46296316(position, 0LL);
  System_Collections_Generic_List_Touch___RemoveAt(
    v16,
    0,
    (const MethodInfo_34F0CA0 *)Method_System_Collections_Generic_List_Touch__RemoveAt__);
  v19 = (System_Collections_Generic_List_Vector2__o *)sub_1B64ABC(System_Collections_Generic_List_Vector2__TypeInfo);
  ...
  System_Collections_Generic_List_Touch___GetEnumerator(
    ...
    v16,
    (const MethodInfo_34EFDC0 *)Method_System_Collections_Generic_List_Touch__GetEnumerator__);
  memcpy(v33, &src, 0x58u);
  while ( System_Collections_Generic_List_Enumerator_Touch___MoveNext(
            (System_Collections_Generic_List_Enumerator_T__o *)v33,
            (const MethodInfo_3231258 *)Method_System_Collections_Generic_List_Enumerator_Touch__MoveNext__) )
  {
    memcpy(&v32, &v33[16], sizeof(v32));
    v20 = UnityEngine_Touch__get_position(&v32, 0LL);
    if ( !CTouch_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(CTouch_TypeInfo);
    v23 = CTouch__getScreenPosition_46296316(v20, 0LL);
    if ( !v19 )
      ((void (__fastcall __noreturn *)(_QWORD, _QWORD))sub_1B64ACC)(v21, v22);
    ...
    if ( (unsigned int)size >= items->max_length )
    {
      System_Collections_Generic_List_Vector2___AddWithResize(
        v19,
        v23,
        *(const MethodInfo_3504B88 **)(*(_QWORD *)(v25[4] + 192LL) + 112LL));
    }
    else
    {
  ...
  System_Collections_Generic_List_Enumerator_Touch___Dispose(
    (System_Collections_Generic_List_Enumerator_T__o *)v33,
    (const MethodInfo_3231254 *)Method_System_Collections_Generic_List_Enumerator_Touch__Dispose__);
  if ( !v19 )
LABEL_22:
    sub_1B64ACC(AvaliableTouchList, v15);
  v27 = System_Collections_Generic_List_Vector2___ToArray(
          v19,
          (const MethodInfo_3506748 *)Method_System_Collections_Generic_List_Vector2__ToArray__);
  v28 = (TouchDetectorBase_TouchInfo_o *)sub_1B64ABC(TouchDetectorBase_TouchInfo_TypeInfo);
  TouchDetectorBase_TouchInfo___ctor(v28, ScreenPosition_46296316, v27, v29);
  return v28;
}
...
bool __fastcall MapTouchDetector__IsTouchKeep(MapTouchDetector_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FB0FB & 1) == 0 )
  {
    sub_1B64870(&Method_System_Collections_Generic_List_Enumerator_Touch__Dispose__, method);
    sub_1B64870(&Method_System_Collections_Generic_List_Enumerator_Touch__MoveNext__, v2);
    sub_1B64870(&Method_System_Collections_Generic_List_Enumerator_Touch__get_Current__, v3);
    this = (MapTouchDetector_o *)sub_1B64870(&Method_System_Collections_Generic_List_Touch__GetEnumerator__, v4);
    byte_49FB0FB = 1;
  }
  v13 = 0LL;
  memset(dest, 0, sizeof(dest));
...
bool __fastcall MapTouchDetector__IsTouchStart(MapTouchDetector_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FB0FA & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_System_Collections_Generic_List_Enumerator_Touch__MoveNext__, v3);
    sub_1B64870(&Method_System_Collections_Generic_List_Enumerator_Touch__get_Current__, v4);
    sub_1B64870(&Method_System_Collections_Generic_List_Touch__GetEnumerator__, v5);
    byte_49FB0FA = 1;
  }
  v16 = 0LL;
  memset(dest, 0, sizeof(dest));
