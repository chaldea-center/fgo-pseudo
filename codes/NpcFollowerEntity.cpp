        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B66F9A & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_18889/*"dispLimitCount"*/, *(_QWORD *)&defValue);
    byte_4B66F9A = 1;
  }
  return NpcFollowerEntity__GetScriptInt(this, (System_String_o *)StringLiteral_18889/*"dispLimitCount"*/, defValue, v3);
}
...
int32_t __fastcall NpcFollowerEntity__GetEventDeckIndex(NpcFollowerEntity_o *this, const MethodInfo *method)
{
  ...
  return NpcFollowerEntity__GetScriptInt(this, (System_String_o *)StringLiteral_19385/*"eventDeckIndex"*/, 0, v2);
}
...
int32_t __fastcall NpcFollowerEntity__GetImageSvtId(NpcFollowerEntity_o *this, const MethodInfo *method)
{
  ...
  return NpcFollowerEntity__GetScriptInt(this, (System_String_o *)StringLiteral_20520/*"imageSvtId"*/, 0, v2);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4B66FA6 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_24024/*"supportName"*/, method);
    byte_4B66FA6 = 1;
  }
  return EntityScriptUtil__GetStringValue(this->fields.npcScript, (System_String_o *)StringLiteral_24024/*"supportName"*/, 0LL, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B66FA0 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_22297/*"name"*/, *(_QWORD *)&priority);
    byte_4B66FA0 = 1;
  }
  if ( NpcFollowerEntity__IsExistSvtChangeParam(this, *(const MethodInfo **)&priority) )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B66FA1 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_24201/*"td"*/, *(_QWORD *)&priority);
    byte_4B66FA1 = 1;
  }
  if ( NpcFollowerEntity__IsExistSvtChangeParam(this, *(const MethodInfo **)&priority) )
    return NpcFollowerEntity__GetSvtChangeValueInt(
             this,
             (System_String_o *)StringLiteral_24201/*"td"*/,
             priority,
             defaultValue,
             v7);
  else
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B66FA3 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_24053/*"svt_voice_id"*/, *(_QWORD *)&priority);
    byte_4B66FA3 = 1;
  }
  if ( NpcFollowerEntity__IsExistSvtChangeParam(this, *(const MethodInfo **)&priority) )
    return NpcFollowerEntity__GetSvtChangeValueInt(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B66F9C & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_24049/*"svt_change"*/, v4);
    byte_4B66F9C = 1;
  }
  value = 0LL;
  ...
  if ( v5 )
  {
    ...
    if ( result )
    {
      if ( System_Collections_Generic_Dictionary_object__object___TryGetValue(
             ...
             (Il2CppObject *)StringLiteral_24049/*"svt_change"*/,
             &value,
             (const MethodInfo_32B1A30 *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__)
        && value
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B66F9D & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Enumerator_object__Dispose__, v6);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Enumerator_object__MoveNext__, v7);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Enumerator_object__get_Current__, v8);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Dictionary_string__object___Add__, v9);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_object__GetEnumerator__, v10);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Dictionary_string__object___ToArray__, v11);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Dictionary_string__object____ctor__, v12);
    sub_1BE4ACC(&System_Collections_Generic_List_object__TypeInfo, v13);
    sub_1BE4ACC(&System_Collections_Generic_List_Dictionary_string__object___TypeInfo, v14);
    byte_4B66F9D = 1;
  }
  value = 0LL;
  memset(&v35, 0, sizeof(v35));
  v15 = (System_Collections_Generic_List_object__o *)sub_1BE4D18(System_Collections_Generic_List_Dictionary_string__object___TypeInfo);
        ...
        && (System_Collections_Generic_List_object__c *)value->klass->_2.typeHierarchy[methodPtr_low - 1] == System_Collections_Generic_List_object__TypeInfo )
      {
        ...
        while ( 1 )
        {
          ...
          if ( v35.fields._current )
          {
            ...
            {
              if ( !v15 )
                sub_1BE4D28(v21, v35.fields._current);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B66F9F & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_22922/*"priority"*/, v9);
    sub_1BE4ACC(&StringLiteral_24843/*"value"*/, v10);
    byte_4B66F9F = 1;
  }
...
bool __fastcall NpcFollowerEntity__IsExistSvtChangeParam(NpcFollowerEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B66F9B & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_24049/*"svt_change"*/, v3);
    byte_4B66F9B = 1;
  }
  npcScript = this->fields.npcScript;
  if ( npcScript )
...
bool __fastcall NpcFollowerEntity__IsOverwriteTreasureDevice(NpcFollowerEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4B66FA7 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_24045/*"svtOverwriteTreasureDevice"*/, method);
    byte_4B66FA7 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.npcScript, (System_String_o *)StringLiteral_24045/*"svtOverwriteTreasureDevice"*/, 0, 0LL) != 0;
}
