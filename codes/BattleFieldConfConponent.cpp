...
void __fastcall BattleFieldConfConponent__OnClick(BattleFieldConfConponent_o *this, const MethodInfo *method)
{
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.fieldData, 0LL, v3, v4, v5, v6, v7, v8);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4BB7621 & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_18296/*"clearRandomMissions"*/, method);
    byte_4BB7621 = 1;
  }
  return (System_String_o *)StringLiteral_18296/*"clearRandomMissions"*/;
}
