        ...
        const MethodInfo *method)
{
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.callbackClose, (int32_t)callback, v11, v12);
...
void __fastcall BattleFieldConfConponent__OnClick(BattleFieldConfConponent_o *this, const MethodInfo *method)
{
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.fieldData, 0, v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.fieldData, (int32_t)inFieldData, (int32_t)method, v3);
  if ( *p_fieldData )
  {
    buffListView = this->fields.buffListView;
        ...
        const MethodInfo *method)
{
  if ( (byte_4A228A0 & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_17970/*"close"*/, method);
    byte_4A228A0 = 1;
  }
  return (System_String_o *)StringLiteral_17970/*"close"*/;
}
        ...
        const MethodInfo *method)
{
  ...
  this->fields.callbackClose = callback;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.callbackClose, (int32_t)callback, (int32_t)method, v3);
}