...
void __fastcall BattleFieldConfConponent__OnClick(BattleFieldConfConponent_o *this, const MethodInfo *method)
{
  ...
  if ( !BattleWindowComponent__isOpening((BattleWindowComponent_o *)this, 0LL) )
  {
    ...
    sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.fieldData, 0LL, v3, v4, v5, v6, v7, v8);
  }
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4C00754 & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_18336/*"close"*/, method);
    byte_4C00754 = 1;
  }
  return (System_String_o *)StringLiteral_18336/*"close"*/;
}
