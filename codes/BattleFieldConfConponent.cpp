...
void __fastcall BattleFieldConfConponent__OnClick(BattleFieldConfConponent_o *this, const MethodInfo *method)
{
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.fieldData, 0LL, v3, v4, v5, v6, v7, v8);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4B69AED & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_18253/*"close"*/, method);
    byte_4B69AED = 1;
  }
  return (System_String_o *)StringLiteral_18253/*"close"*/;
}
