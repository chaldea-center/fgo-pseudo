        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB5713 & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_15822/*"WaitTimeSetting"*/, method);
    byte_4BB5713 = 1;
  }
  return WarBoardOnboardSkillEntity__GetIntFromScript(this, (System_String_o *)StringLiteral_15822/*"WaitTimeSetting"*/, 0, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB5714 & 1) == 0 )
  {
    sub_1C13D24(&Method_DataManager_GetMaster_WarBoardSquareIndexGroupMaster___, *(_QWORD *)&stageId);
    sub_1C13D24(&DataManager_TypeInfo, v6);
    sub_1C13D24(&Method_System_Collections_Generic_List_int__ToArray__, v7);
    sub_1C13D24(&StringLiteral_23843/*"spot_info_gauge_l"*/, v8);
    byte_4BB5714 = 1;
  }
  IntFromScript = WarBoardOnboardSkillEntity__GetIntFromScript(this, (System_String_o *)StringLiteral_23843/*"spot_info_gauge_l"*/, -1, v3);
  if ( IntFromScript == -1 )
    return this->fields.targetSquareIndex;
  v10 = IntFromScript;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (WarBoardSquareIndexGroupMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2F8F418 *)Method_DataManager_GetMaster_WarBoardSquareIndexGroupMaster___);
  if ( !Master_object
