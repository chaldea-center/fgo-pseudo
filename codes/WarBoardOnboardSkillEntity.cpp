        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3730 & 1) == 0 )
  {
    sub_1B00CCC(&StringLiteral_15348/*"WarBoardBreakPointDamageType"*/, method);
    byte_48E3730 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3731 & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataManager_GetMaster_WarBoardSquareIndexGroupMaster___, *(_QWORD *)&stageId);
    sub_1B00CCC(&DataManager_TypeInfo, v6);
    sub_1B00CCC(&Method_System_Collections_Generic_List_int__ToArray__, v7);
    sub_1B00CCC(&StringLiteral_23108/*"squareIndexGroup"*/, v8);
    byte_48E3731 = 1;
  }
  IntFromScript = WarBoardOnboardSkillEntity__GetIntFromScript(this, (System_String_o *)StringLiteral_23108/*"squareIndexGroup"*/, -1, v3);
  if ( IntFromScript == -1 )
    return this->fields.targetSquareIndex;
  v10 = IntFromScript;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (WarBoardSquareIndexGroupMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2D62BBC *)Method_DataManager_GetMaster_WarBoardSquareIndexGroupMaster___);
  if ( !Master_object
