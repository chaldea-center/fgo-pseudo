        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2846E & 1) == 0 )
  {
    sub_1C2D490(&StringLiteral_15577/*"WarBoardBreakPointDamageType"*/);
    byte_4C2846E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  IntFromScript = WarBoardOnboardSkillEntity__GetIntFromScript(this, (System_String_o *)StringLiteral_23605/*"squareIndexGroup"*/, -1, v3);
  if ( IntFromScript == -1 )
    return this->fields.targetSquareIndex;
  v7 = IntFromScript;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (WarBoardSquareIndexGroupMaster_o *)DataManager__GetMaster_object_((const MethodInfo_30CE8FC *)Method_DataManager_GetMaster_WarBoardSquareIndexGroupMaster___);
  if ( !Master_object
