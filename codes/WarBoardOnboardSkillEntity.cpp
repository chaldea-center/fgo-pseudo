        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB6D34 & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_15610/*"WarBoardBreakPointDamageType"*/, method);
    byte_4AB6D34 = 1;
  }
  return WarBoardOnboardSkillEntity__GetIntFromScript(this, (System_String_o *)StringLiteral_15610/*"WarBoardBreakPointDamageType"*/, 0, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB6D35 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMaster_WarBoardSquareIndexGroupMaster___, *(_QWORD *)&stageId);
    sub_1BAB41C(&DataManager_TypeInfo, v6);
    sub_1BAB41C(&Method_System_Collections_Generic_List_int__ToArray__, v7);
    sub_1BAB41C(&StringLiteral_23494/*"squareIndexGroup"*/, v8);
    byte_4AB6D35 = 1;
  }
  IntFromScript = WarBoardOnboardSkillEntity__GetIntFromScript(this, (System_String_o *)StringLiteral_23494/*"squareIndexGroup"*/, -1, v3);
  if ( IntFromScript == -1 )
    return this->fields.targetSquareIndex;
  v10 = IntFromScript;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (WarBoardSquareIndexGroupMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2EC5574 *)Method_DataManager_GetMaster_WarBoardSquareIndexGroupMaster___);
  if ( !Master_object
