        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A70E40 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_15604/*"WarBoardBreakPointDamageType"*/, method);
    byte_4A70E40 = 1;
  }
  return WarBoardOnboardSkillEntity__GetIntFromScript(this, (System_String_o *)StringLiteral_15604/*"WarBoardBreakPointDamageType"*/, 0, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A70E41 & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMaster_WarBoardSquareIndexGroupMaster___, *(_QWORD *)&stageId);
    sub_1B90010(&DataManager_TypeInfo, v6);
    sub_1B90010(&Method_System_Collections_Generic_List_int__ToArray__, v7);
    sub_1B90010(&StringLiteral_23492/*"squareIndexGroup"*/, v8);
    byte_4A70E41 = 1;
  }
  IntFromScript = WarBoardOnboardSkillEntity__GetIntFromScript(this, (System_String_o *)StringLiteral_23492/*"squareIndexGroup"*/, -1, v3);
  if ( IntFromScript == -1 )
    return this->fields.targetSquareIndex;
  v10 = IntFromScript;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (WarBoardSquareIndexGroupMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2E8E1C8 *)Method_DataManager_GetMaster_WarBoardSquareIndexGroupMaster___);
  if ( !Master_object
