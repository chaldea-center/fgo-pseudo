        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF15F4 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_DataManager_GetMaster_TreasureDeviceSequenceWeightMaster___);
    ...
    sub_1C7BAE8(&ExecutingTdInfo_TypeInfo);
    sub_1C7BAE8(&Method_System_TupleExtensions_Deconstruct_int__int___);
    byte_4CF15F4 = 1;
  }
  *(_QWORD *)item1 = 0;
  entity = 0;
  ...
  Master_object = DataManager__GetMaster_object_((const MethodInfo_31703A0 *)Method_DataManager_GetMaster_TreasureDeviceSequenceWeightMaster___);
  if ( !Master_object )
    goto LABEL_21;
  ...
  if ( EntityByDescendingPriority )
  {
    ...
    System_TupleExtensions__Deconstruct_int__int_(
      ...
      item1,
      &item2,
      (const MethodInfo_3242250 *)Method_System_TupleExtensions_Deconstruct_int__int___);
    v17 = item2;
    item1[1] = item2;
    if ( item1[0] > 0 )
    {
...
LABEL_20:
  v19 = sub_1C7BD34(ExecutingTdInfo_TypeInfo);
...
ExecutingTdInfo_o *ExecutingTdInfo__GetDefault(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C7BD34(ExecutingTdInfo_TypeInfo);
