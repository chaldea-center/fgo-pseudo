void AppendBitmapFont___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CF2BCB & 1) == 0 )
  {
    sub_1C7BAE8(&AppendBitmapFont_TypeInfo);
    sub_1C7BAE8(&StringLiteral_6811/*"Fonts/BitmapFontProperties"*/);
    byte_4CF2BCB = 1;
  }
...
void AppendBitmapFont__Setup(AppendBitmapFont_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C7BAE8(&AppendBitmapFont_TypeInfo);
    sub_1C7BAE8(&Method_UnityEngine_Resources_Load_BitmapFontProperties___);
    byte_4CF2BC7 = 1;
  }
  ...
  object = UnityEngine_Resources__Load_object_(
             ...
             (const MethodInfo_320C160 *)Method_UnityEngine_Resources_Load_BitmapFontProperties___);
