void AppendBitmapFont___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4D34FBB & 1) == 0 )
  {
    sub_1C93AD4(&AppendBitmapFont_TypeInfo);
    sub_1C93AD4(&StringLiteral_6833/*"Fonts/BitmapFontProperties"*/);
    byte_4D34FBB = 1;
  }
  AppendBitmapFont_TypeInfo->static_fields->BitmapFontPropertiesPath = (struct System_String_o *)StringLiteral_6833/*"Fonts/BitmapFontProperties"*/;
  sub_1C93A78(
    (GrandQuestFolderBoardItem_o *)AppendBitmapFont_TypeInfo->static_fields,
    StringLiteral_6833/*"Fonts/BitmapFontProperties"*/,
    v1,
    v2,
    v3,
    v4,
...
void AppendBitmapFont__Setup(AppendBitmapFont_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C93AD4(&AppendBitmapFont_TypeInfo);
    sub_1C93AD4(&Method_UnityEngine_Resources_Load_BitmapFontProperties___);
    byte_4D34FB7 = 1;
  }
  ...
  object = UnityEngine_Resources__Load_object_(
             ...
             (const MethodInfo_324111C *)Method_UnityEngine_Resources_Load_BitmapFontProperties___);
