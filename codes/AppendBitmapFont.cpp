void AppendBitmapFont___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_593CC22 & 1) == 0 )
  {
    sub_21FFC50(&AppendBitmapFont_TypeInfo);
    sub_21FFC50(&StringLiteral_7076/*"Fonts/BitmapFontProperties"*/);
    byte_593CC22 = 1;
  }
  v7 = StringLiteral_7076/*"Fonts/BitmapFontProperties"*/;
  AppendBitmapFont_TypeInfo->static_fields->BitmapFontPropertiesPath = (struct System_String_o *)StringLiteral_7076/*"Fonts/BitmapFontProperties"*/;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)AppendBitmapFont_TypeInfo->static_fields, v7, v1, v2, v3, v4, v5, v6);
}
...
void AppendBitmapFont__Setup(AppendBitmapFont_o *this, const MethodInfo *method)
{
  ...
  {
    sub_21FFC50(&AppendBitmapFont_TypeInfo);
    sub_21FFC50(&Method_UnityEngine_Resources_Load_BitmapFontProperties___);
    byte_593CC1E = 1;
  }
  ...
  object = UnityEngine_Resources__Load_object_(
             ...
             (const MethodInfo_3945260 *)Method_UnityEngine_Resources_Load_BitmapFontProperties___);
