...
LABEL_16:
    sub_1B71828(titleLabel, v7);
  }
LABEL_15:
  this->fields.closeAction = 0LL;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.closeAction, 0, v11, v12);
  this->fields.decideAction = 0LL;
  p_decideAction = (ServantStatusBattleListViewItem_o *)&this->fields.decideAction;
  sub_1B71570(p_decideAction, 0, v15, v16);
...
void __fastcall TextLabelScrollDialog__OnClickCloseButton(TextLabelScrollDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1E80C & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_TextLabelScrollDialog_OnClickCloseButton__, v3);
    sub_1B715CC(&Method_TextLabelScrollDialog__OnClickCloseButton_b__14_0__, v4);
    byte_4A1E80C = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( (*((_BYTE *)Method_TextLabelScrollDialog_OnClickCloseButton__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B715E4(Method_TextLabelScrollDialog_OnClickCloseButton__);
...
void __fastcall TextLabelScrollDialog__OnClickDecideButton(TextLabelScrollDialog_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B715CC(&System_Action_TypeInfo, method);
    sub_1B715CC(&Method_TextLabelScrollDialog_OnClickDecideButton__, v3);
    sub_1B715CC(&Method_TextLabelScrollDialog__OnClickDecideButton_b__15_0__, v4);
    byte_4A1E80D = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( (*((_BYTE *)Method_TextLabelScrollDialog_OnClickDecideButton__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B715E4(Method_TextLabelScrollDialog_OnClickDecideButton__);
    v6 = (System_Reflection_MethodBase_o *)sub_1B715B0(v5, v5[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( !titleLabel || (UILabel__set_text(titleLabel, title, 0LL), (titleLabel = this->fields.messageLabel) == 0LL) )
    sub_1B71828(titleLabel, v11);
  UILabel__set_text(titleLabel, message, 0LL);
  this->fields.closeAction = closeAction;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.closeAction, (int32_t)closeAction, v13, v14);
  this->fields.decideAction = decideAction;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.decideAction, (int32_t)decideAction, v15, v16);
