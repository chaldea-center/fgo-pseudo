        ...
        const MethodInfo *method)
{
  ...
  this->fields.QUESTION_MARK_COLOR = (struct UnityEngine_Color_o)xmmword_BAC9A0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2ACD9 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_DataManager_GetMasterData_ServantLimitSpoilerProtectionMaster___, v6);
    ...
    this = (ServantStatusListViewItemDrawPortrait_o *)sub_1B761C0(
  ...
  if ( !v3
    || (ConvertOverwritePortraitLimitCount = ServantStatusListViewItem__get_ConvertOverwritePortraitLimitCount(v3, 0LL),
        ...
        (this = (ServantStatusListViewItemDrawPortrait_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_371257C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0LL) )
  {
LABEL_96:
...
LABEL_101:
      ...
      {
LABEL_39:
        this = (ServantStatusListViewItemDrawPortrait_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_371257C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
        if ( !this )
          goto LABEL_96;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2ACD8 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMaster_ServantLimitImageMaster___, item);
    ...
    sub_1B761C0(&StringLiteral_11867/*"SERVANT_STATUS_EXPLANATION_PORTRAIT3"*/, v11);
    sub_1B761C0(&StringLiteral_11866/*"SERVANT_STATUS_EXPLANATION_PORTRAIT2"*/, v12);
    sub_1B761C0(&StringLiteral_11865/*"SERVANT_STATUS_EXPLANATION_PORTRAIT"*/, v13);
    sub_1B761C0(&StringLiteral_11868/*"SERVANT_STATUS_EXPLANATION_PORTRAIT_LIMIT_COUNT_SEALED_MSG"*/, v14);
    byte_4A2ACD8 = 1;
  }
  ...
  if ( item && mode )
  {
    ...
    if ( item->fields.userSvtEntity )
    {
      ...
      IsServantLimitCountSeal = LocalizationManager__Get((System_String_o *)StringLiteral_11865/*"SERVANT_STATUS_EXPLANATION_PORTRAIT"*/, 0LL);
      if ( !explanationLabel )
        goto LABEL_72;
    ...
    else if ( item->fields.userSvtCollectionEntity )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      IsServantLimitCountSeal = LocalizationManager__Get((System_String_o *)StringLiteral_11866/*"SERVANT_STATUS_EXPLANATION_PORTRAIT2"*/, 0LL);
      if ( !v22 )
        goto LABEL_72;
    ...
    else
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      IsServantLimitCountSeal = LocalizationManager__Get((System_String_o *)StringLiteral_11867/*"SERVANT_STATUS_EXPLANATION_PORTRAIT3"*/, 0LL);
      if ( !v25 )
        goto LABEL_72;
    ...
    *(_QWORD *)&v62.fields.fakeValue = v20;
    IsServantLimitCountSeal = (System_String_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(
                                                   v62,
                                                   0LL);
    ...
    if ( ((unsigned __int8)IsServantLimitCountSeal & 1) != 0 )
    {
      IsServantLimitCountSeal = ServantLimitImageMaster__GetServantStatusExplanationText(
                                  (ServantLimitImageMaster_o *)Master_object,
                                  (System_String_o *)StringLiteral_11868/*"SERVANT_STATUS_EXPLANATION_PORTRAIT_LIMIT_COUNT_SEALED_MSG"*/,
                                  v27,
                                  0LL);
...
LABEL_72:
    sub_1B7641C(IsServantLimitCountSeal, v18);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2ACDB & 1) == 0 )
  {
    ...
    this = (ServantStatusListViewItemDrawPortrait_o *)sub_1B761C0(&StringLiteral_11904/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_INFO_OWN_SETTING_STATUS_ICON"*/, v6);
    byte_4A2ACDB = 1;
  }
  if ( !item )
LABEL_24:
...
LABEL_18:
  ...
  if ( item->fields.isEnableOwnRandomSetting )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    Empty = LocalizationManager__Get((System_String_o *)StringLiteral_11904/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_INFO_OWN_SETTING_STATUS_ICON"*/, 0LL);
  }
  else
  {
