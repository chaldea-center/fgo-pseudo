        ...
        const MethodInfo *method)
{
  ...
  this->fields.QUESTION_MARK_COLOR = (struct UnityEngine_Color_o)xmmword_CFE620;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D29C4D & 1) == 0 )
  {
    ...
    this = (ServantStatusListViewItemDrawPortrait_o *)sub_1C94098(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4D29C4D = 1;
  }
  if ( !v3
    || (ConvertOverwritePortraitLimitCount = ServantStatusListViewItem__get_ConvertOverwritePortraitLimitCount(v3, 0),
        ...
        (this = (ServantStatusListViewItemDrawPortrait_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3ABA574 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0) )
  {
LABEL_96:
...
LABEL_101:
      ...
      {
LABEL_39:
        this = (ServantStatusListViewItemDrawPortrait_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3ABA574 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
        if ( !this )
          goto LABEL_96;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D29C4C & 1) == 0 )
  {
    ...
    sub_1C94098(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    sub_1C94098(&StringLiteral_11972/*"SERVANT_STATUS_EXPLANATION_PORTRAIT3"*/);
    sub_1C94098(&StringLiteral_11971/*"SERVANT_STATUS_EXPLANATION_PORTRAIT2"*/);
    sub_1C94098(&StringLiteral_11970/*"SERVANT_STATUS_EXPLANATION_PORTRAIT"*/);
    sub_1C94098(&StringLiteral_11973/*"SERVANT_STATUS_EXPLANATION_PORTRAIT_LIMIT_COUNT_SEALED_MSG"*/);
    byte_4D29C4C = 1;
  }
  ...
  if ( item && mode )
  {
    ...
    if ( item->fields.userSvtEntity )
    {
      ...
      IsServantLimitCountSeal = LocalizationManager__Get((System_String_o *)StringLiteral_11970/*"SERVANT_STATUS_EXPLANATION_PORTRAIT"*/, 0);
      if ( !explanationLabel )
        goto LABEL_72;
    ...
    else if ( item->fields.userSvtCollectionEntity )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      IsServantLimitCountSeal = LocalizationManager__Get((System_String_o *)StringLiteral_11971/*"SERVANT_STATUS_EXPLANATION_PORTRAIT2"*/, 0);
      if ( !v14 )
        goto LABEL_72;
    ...
    else
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      IsServantLimitCountSeal = LocalizationManager__Get((System_String_o *)StringLiteral_11972/*"SERVANT_STATUS_EXPLANATION_PORTRAIT3"*/, 0);
      if ( !v17 )
        goto LABEL_72;
    ...
    *(_QWORD *)&v54.fields.fakeValue = v12;
    IsServantLimitCountSeal = (System_String_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49621544(
                                                   v54,
                                                   0);
    ...
    if ( ((unsigned __int8)IsServantLimitCountSeal & 1) != 0 )
    {
      IsServantLimitCountSeal = ServantLimitImageMaster__GetServantStatusExplanationText(
                                  (ServantLimitImageMaster_o *)Master_object,
                                  (System_String_o *)StringLiteral_11973/*"SERVANT_STATUS_EXPLANATION_PORTRAIT_LIMIT_COUNT_SEALED_MSG"*/,
                                  v19,
                                  0);
      ...
      v25 = System_String__Concat_64417744(mText, v24, 0);
...
LABEL_72:
    sub_1C942F0(IsServantLimitCountSeal, v10);
  }
}
  ...
  do
  {
    if ( v24 <= maxPortraitLimitCount )
    {
      ...
      if ( (unsigned int)v24 >= LODWORD(portraitSelectList->max_length) )
        goto LABEL_148;
      v25 = portraitSelectList->m_Items[v24] == v72;
    }
    else
    {
      v25 = 0;
  ...
  while ( v50 < SLODWORD(v49->max_length) )
  {
    ...
    else
    {
      if ( v50 >= (unsigned int)max_length )
        goto LABEL_148;
      v52 = portraitSelectList->m_Items[v50] == v72;
    }
    ...
    {
      Instance = (UICommonButton_o *)ServantStatusListViewItem__get_SvtId(item, 0);
      if ( (unsigned int)v50 >= LODWORD(portraitSelectList->max_length) )
        goto LABEL_148;
      v7 = (unsigned int)Instance;
      Instance = (UICommonButton_o *)v71;
      if ( !v71 )
        goto LABEL_146;
      Entity = ServantCostumeMaster__GetEntity(v71, v7, portraitSelectList->m_Items[v50], 0);
      if ( Entity )
      {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D29C4F & 1) == 0 )
  {
    ...
    this = (ServantStatusListViewItemDrawPortrait_o *)sub_1C94098(&StringLiteral_12011/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_INFO_OWN_SETTING_STATUS_ICON"*/);
    byte_4D29C4F = 1;
  }
  if ( !item )
LABEL_24:
...
LABEL_18:
  ...
  if ( item->fields.isEnableOwnRandomSetting )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    Empty = LocalizationManager__Get((System_String_o *)StringLiteral_12011/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_INFO_OWN_SETTING_STATUS_ICON"*/, 0);
  }
  else
  {
