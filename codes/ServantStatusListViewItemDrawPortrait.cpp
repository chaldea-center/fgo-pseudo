        ...
        const MethodInfo *method)
{
  ...
  this->fields.QUESTION_MARK_COLOR = (struct UnityEngine_Color_o)xmmword_BFDCB0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD94E4 & 1) == 0 )
  {
    ...
    this = (ServantStatusListViewItemDrawPortrait_o *)sub_1C21E38(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4BD94E4 = 1;
  }
  if ( !v3
    || (ConvertOverwritePortraitLimitCount = ServantStatusListViewItem__get_ConvertOverwritePortraitLimitCount(v3, 0LL),
        ...
        (this = (ServantStatusListViewItemDrawPortrait_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_388D058 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0LL) )
  {
LABEL_96:
    sub_1C22094(this, item);
  }
  v9 = 0LL;
  v10 = &portraitSelectList->m_Items[1];
  ...
  do
  {
    ...
    if ( !portraitSelectList )
      goto LABEL_96;
    if ( v9 >= portraitSelectList->max_length )
      goto LABEL_98;
    if ( v10[v9] <= v8 )
    {
LABEL_101:
      ...
      v21 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit(SvtId, 0LL);
      ...
      {
LABEL_39:
        this = (ServantStatusListViewItemDrawPortrait_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_388D058 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
        if ( !this )
          goto LABEL_96;
        ...
        if ( !servantTextureList )
          goto LABEL_96;
        if ( v9 >= servantTextureList->max_length )
          goto LABEL_98;
        v24 = servantTextureList->m_Items[v9];
        v25 = (int)this;
        v26 = ServantStatusListViewItem__get_SvtId(v3, 0LL);
        if ( !ImageLimitCount_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(ImageLimitCount_TypeInfo);
        LimitCountByImageLimitCostumeIn = ImageLimitCount__GetLimitCountByImageLimitCostumeIn(v25, 0LL);
        ...
        if ( !servantMaskSpriteList )
          goto LABEL_96;
        if ( v9 >= servantMaskSpriteList->max_length )
          goto LABEL_98;
...
LABEL_7:
    ...
    this = (ServantStatusListViewItemDrawPortrait_o *)AtlasManager__SetNotOpenFace(v16, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD94E3 & 1) == 0 )
  {
    ...
    sub_1C21E38(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    sub_1C21E38(&StringLiteral_12090/*"SERVANT_STATUS_EXPLANATION_PORTRAIT3"*/);
    sub_1C21E38(&StringLiteral_12089/*"SERVANT_STATUS_EXPLANATION_PORTRAIT2"*/);
    sub_1C21E38(&StringLiteral_12088/*"SERVANT_STATUS_EXPLANATION_PORTRAIT"*/);
    sub_1C21E38(&StringLiteral_12091/*"SERVANT_STATUS_EXPLANATION_PORTRAIT_LIMIT_COUNT_SEALED_MSG"*/);
    byte_4BD94E3 = 1;
  }
  ...
  if ( item && mode )
  {
    ...
    if ( item->fields.userSvtEntity )
    {
      ...
      IsServantLimitCountSeal = LocalizationManager__Get((System_String_o *)StringLiteral_12088/*"SERVANT_STATUS_EXPLANATION_PORTRAIT"*/, 0LL);
      if ( !explanationLabel )
        goto LABEL_72;
    ...
    else if ( item->fields.userSvtCollectionEntity )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      IsServantLimitCountSeal = LocalizationManager__Get((System_String_o *)StringLiteral_12089/*"SERVANT_STATUS_EXPLANATION_PORTRAIT2"*/, 0LL);
      if ( !v14 )
        goto LABEL_72;
    ...
    else
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      IsServantLimitCountSeal = LocalizationManager__Get((System_String_o *)StringLiteral_12090/*"SERVANT_STATUS_EXPLANATION_PORTRAIT3"*/, 0LL);
      if ( !v17 )
        goto LABEL_72;
      UILabel__set_text(v17, IsServantLimitCountSeal, 0LL);
    ...
    *(_QWORD *)&v54.fields.fakeValue = v12;
    IsServantLimitCountSeal = (System_String_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47621364(
                                                   v54,
                                                   0LL);
    ...
    if ( ((unsigned __int8)IsServantLimitCountSeal & 1) != 0 )
    {
      IsServantLimitCountSeal = ServantLimitImageMaster__GetServantStatusExplanationText(
                                  (ServantLimitImageMaster_o *)Master_object,
                                  (System_String_o *)StringLiteral_12091/*"SERVANT_STATUS_EXPLANATION_PORTRAIT_LIMIT_COUNT_SEALED_MSG"*/,
                                  v19,
                                  0LL);
      ...
      LimitCountSealedServantName = (Il2CppObject *)ServantLimitImageMaster__GetLimitCountSealedServantName(
                                                      ...
                                                      0,
                                                      0LL);
      v24 = System_String__Format(v22, LimitCountSealedServantName, 0LL);
      v25 = System_String__Concat_63115476(mText, v24, 0LL);
      UILabel__set_text(v20, v25, 0LL);
      v19 = 1;
      goto LABEL_34;
    }
LABEL_33:
...
LABEL_34:
    ...
    if ( UnityEngine_Object__op_Inequality(baseCollider, 0LL, 0LL) )
    {
      ...
      v55.fields.y = v38;
      v55.fields.z = z;
      UnityEngine_BoxCollider__set_size((UnityEngine_BoxCollider_o *)IsServantLimitCountSeal, v55, 0LL);
    }
    IsServantLimitCountSeal = (System_String_o *)this->fields.baseSprite;
    if ( IsServantLimitCountSeal )
    {
      v39 = x == INFINITY ? 0x80000000 : (int)x;
      UIWidget__set_width((UIWidget_o *)IsServantLimitCountSeal, v39, 0LL);
      IsServantLimitCountSeal = (System_String_o *)this->fields.baseSprite;
      if ( IsServantLimitCountSeal )
      {
        v40 = v38 == INFINITY ? 0x80000000 : (int)v38;
        UIWidget__set_height((UIWidget_o *)IsServantLimitCountSeal, v40, 0LL);
          ...
          if ( IsServantLimitCountSeal )
          {
            ...
            if ( IsServantLimitCountSeal )
            {
              ...
              if ( IsServantLimitCountSeal )
              {
                ...
                v57.fields.x = v46;
                v57.fields.z = v48;
                UnityEngine_Transform__set_localPosition((UnityEngine_Transform_o *)IsServantLimitCountSeal, v57, 0LL);
...
LABEL_72:
    sub_1C22094(IsServantLimitCountSeal, v10);
  }
}
...
LABEL_146:
  ...
  do
  {
    if ( v24 <= maxPortraitLimitCount )
    {
      if ( !portraitSelectList )
        goto LABEL_146;
      if ( v24 >= portraitSelectList->max_length )
        goto LABEL_148;
      v25 = portraitSelectList->m_Items[v24 + 1] == v72;
    }
    else
    {
      v25 = 0;
...
LABEL_148:
    ...
    if ( !servantButtonList )
      goto LABEL_146;
    if ( v74 >= servantButtonList->max_length )
      goto LABEL_148;
    ...
    if ( !portraitSelectList )
      goto LABEL_146;
    if ( v74 >= portraitSelectList->max_length )
      goto LABEL_148;
    if ( !v23 )
      goto LABEL_146;
    IsServantLimitCountSeal = ServantLimitImageMaster__IsServantLimitCountSeal(
                                v23,
                                (int32_t)Instance,
                                portraitSelectList->m_Items[v74 + 1] + 1,
                                0LL);
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  ...
  while ( v50 < (signed int)v49->max_length )
  {
    ...
    else
    {
      if ( v50 >= (unsigned int)max_length )
        goto LABEL_148;
      v52 = portraitSelectList->m_Items[v50 + 1] == v72;
    }
    ...
    else
    {
      ...
      if ( !v71 )
        goto LABEL_146;
      Entity = ServantCostumeMaster__GetEntity(v71, v7, portraitSelectList->m_Items[v50 + 1], 0LL);
      if ( Entity )
      {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD94E6 & 1) == 0 )
  {
    ...
    this = (ServantStatusListViewItemDrawPortrait_o *)sub_1C21E38(&StringLiteral_12127/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_INFO_OWN_SETTING_STATUS_ICON"*/);
    byte_4BD94E6 = 1;
  }
  if ( !item )
LABEL_24:
...
LABEL_18:
  ...
  if ( item->fields.isEnableOwnRandomSetting )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    Empty = LocalizationManager__Get((System_String_o *)StringLiteral_12127/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_INFO_OWN_SETTING_STATUS_ICON"*/, 0LL);
  }
  else
  {
