...
void __fastcall TutorialNotificationMessage__Close(TutorialNotificationMessage_o *this, const MethodInfo *method)
{
  ...
  TutorialNotificationMessage__Close_37359560(this, 0LL, v2);
}


void __fastcall TutorialNotificationMessage__Close_37359560(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A59E46 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_TutorialNotificationMessage_EndClose__);
    byte_4A59E46 = 1;
  }
  ...
  System_Action___ctor(v6, (Il2CppObject *)this, Method_TutorialNotificationMessage_EndClose__, 0LL);
...
void __fastcall TutorialNotificationMessage__EndOpen(TutorialNotificationMessage_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(touchObject, 0LL, 0LL) )
  {
    ...
    {
LABEL_17:
      sub_1B8880C(touchBase, v6);
    }
    UnityEngine_Transform__set_parent(transform, (UnityEngine_Transform_o *)touchBase, 0LL);
    v21.fields.x = x + this->fields.touchObjPos.fields.x;
    v21.fields.y = y + this->fields.touchObjPos.fields.y;
    v21.fields.z = z + this->fields.touchObjPos.fields.z;
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.touchObject, (int32_t)v7, v18, v19);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( selectCallbackFunc )
  {
    ...
    sub_1B88554(p_selectCallbackFunc, 0, (int32_t)method, v3);
...
void __fastcall TutorialNotificationMessage__Init(TutorialNotificationMessage_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(touchObject, 0LL, 0LL) )
  {
    ...
    *p_touchObject = 0LL;
    sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.touchObject, 0, v9, v10);
    if ( !byte_4A55CE1 )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A59E47 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_TutorialNotificationMessage_EndTurorialRequest__);
    sub_1B885B0(&Method_TutorialNotificationMessage_OnClickClose__);
  ...
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_TutorialNotificationMessage_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B885C8(Method_TutorialNotificationMessage_OnClickClose__);
    ...
    if ( UnityEngine_Object__op_Inequality(touchObject, 0LL, 0LL) )
    {
      ...
      *p_touchObject = 0LL;
      sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.touchObject, 0, v10, v11);
      if ( !byte_4A55CE1 )
      {
        sub_1B885B0(&UnityEngine_Vector3_TypeInfo);
        byte_4A55CE1 = 1;
    ...
    if ( this->fields.flagId == -1 )
    {
      ...
      {
        p_selectCallbackFunc->klass = 0LL;
        sub_1B88554(p_selectCallbackFunc, 0, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A59E42 & 1) == 0 )
  {
    sub_1B885B0(&System_Action_TypeInfo);
    sub_1B885B0(&UnityEngine_Object_TypeInfo);
    sub_1B885B0(&Method_TutorialNotificationMessage_EndOpen__);
    sub_1B885B0(&Method_TutorialNotificationMessage__Open_b__13_0__);
    sub_1B885B0(&StringLiteral_1/*""*/);
    byte_4A59E42 = 1;
  }
...
LABEL_26:
  ...
  if ( dispTouchSprite )
    ...
    v26 = (__int64 *)&Method_TutorialNotificationMessage__Open_b__13_0__;
  v27 = v25;
  System_Action___ctor(v25, (Il2CppObject *)this, *v26, 0LL);
  BaseDialog__Open((BaseDialog_o *)this, v27, maskType, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.selectCallbackFunc, 0, fontSize, (int32_t)method);
  ...
  *(_QWORD *)&this->fields.touchObjPos.fields.x = *(_QWORD *)&static_fields->zeroVector.fields.x;
  ...
  UILabel__set_text((UILabel_o *)transform, v16, 0LL);
  transform = (UnityEngine_Component_o *)this->fields.messageLabel;
  if ( !transform
...
// local variable allocation has failed, the output may be wrong!
void __fastcall TutorialNotificationMessage__Open_37357520(
        TutorialNotificationMessage_o *this,
        System_String_o *message,
        UnityEngine_Vector2_o messagePos,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A59E43 & 1) == 0 )
  {
    ...
    sub_1B885B0(&UnityEngine_Object_TypeInfo);
    sub_1B885B0(&Method_TutorialNotificationMessage_EndOpen__);
    sub_1B885B0(&Method_TutorialNotificationMessage__Open_b__14_0__);
    sub_1B885B0(&StringLiteral_1/*""*/);
  ...
  if ( dlgBgId )
  {
    ...
    if ( !transform )
      goto LABEL_50;
    v40.fields.g = 0.2902;
    v40.fields.b = 0.031373;
    v40.fields.a = 1.0;
    v40.fields.r = 0.32941;
    UILabel__set_gradientTop(transform, v40, 0LL);
    transform = this->fields.messageLabel;
    if ( !transform )
      goto LABEL_50;
    v41.fields.r = 0.1098;
    ...
    v41.fields.b = 0.0;
    v41.fields.a = 1.0;
    UILabel__set_gradientBottom(transform, v41, 0LL);
    transform = this->fields.messageLabel;
    if ( !transform )
      goto LABEL_50;
    ...
    if ( !transform )
      goto LABEL_50;
    v42.fields.r = 0.47059;
    v42.fields.b = 0.15294;
    v42.fields.a = 0.058824;
    v42.fields.g = 0.32941;
    UILabel__set_effectColor(transform, v42, 0LL);
    transform = this->fields.messageLabel;
    if ( !transform )
      goto LABEL_50;
    v37.fields.x = 3.0;
    v37.fields.y = 3.0;
    UILabel__set_effectDistance(transform, v37, 0LL);
    transform = this->fields.messageLabel;
    if ( !transform )
      goto LABEL_50;
  ...
  UILabel__set_alignment(transform, v26, 0LL);
  transform = this->fields.messageLabel;
  if ( (this->fields.messageDefaultFontSize & 0x80000000) != 0 )
  {
    if ( !transform )
...
LABEL_50:
  ...
  v39.fields.y = v18 + this->fields.messageDefaultPosition.fields.y;
  v39.fields.x = v19 + this->fields.messageDefaultPosition.fields.x;
  v39.fields.z = 0.0;
...
LABEL_43:
  ...
  v36 = dlgBgId;
  v32 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v36, v28, v29, v30);
  v33 = System_String__Format((System_String_o *)StringLiteral_3133/*"Back/back{0}"*/, v32, 0LL);
  v34 = (System_Action_o *)sub_1B887FC(System_Action_TypeInfo);
  System_Action___ctor(v34, (Il2CppObject *)this, Method_TutorialNotificationMessage__Open_b__14_0__, 0LL);
  if ( !backTexture )
    goto LABEL_50;
  if ( !ExUITexture__SetAssetImage(backTexture, v33, v34, 0LL) )
  {
LABEL_47:
    ...
    System_Action___ctor(v35, (Il2CppObject *)this, Method_TutorialNotificationMessage_EndOpen__, 0LL);
