...
void TutorialNotificationMessage__Close(TutorialNotificationMessage_o *this, const MethodInfo *method)
{
  ...
  TutorialNotificationMessage__Close_41290816(this, 0, v2);
}


void TutorialNotificationMessage__Close_41290816(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E0369E & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_TutorialNotificationMessage_EndClose__);
    byte_4E0369E = 1;
  }
...
void TutorialNotificationMessage__EndOpen(TutorialNotificationMessage_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(touchObject, 0, 0) )
  {
    ...
    {
LABEL_17:
      sub_1CE6958(touchBase, v6);
    }
    UnityEngine_Transform__set_parent(transform, (UnityEngine_Transform_o *)touchBase, 0);
    v23.fields.x = x + this->fields.touchObjPos.fields.x;
    v23.fields.y = y + this->fields.touchObjPos.fields.y;
    v23.fields.z = z + this->fields.touchObjPos.fields.z;
    ...
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.touchObject, (int32_t)v7, v15, v16, v17, v18, v19, v20);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( selectCallbackFunc )
  {
    ...
    sub_1CE66A4(p_selectCallbackFunc, 0, (int32_t)method, v3, v4, v5, v6, v7);
...
void TutorialNotificationMessage__Init(TutorialNotificationMessage_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(touchObject, 0, 0) )
  {
    ...
    *p_touchObject = 0;
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.touchObject, 0, v9, v10, v11, v12, v13, v14);
    if ( !byte_4DFE0A9 )
    {
...
void TutorialNotificationMessage__OnClickClose(TutorialNotificationMessage_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E0369F & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_TutorialNotificationMessage_EndTurorialRequest__);
    sub_1CE6700(&Method_TutorialNotificationMessage_OnClickClose__);
  ...
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_TutorialNotificationMessage_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_TutorialNotificationMessage_OnClickClose__);
    ...
    if ( UnityEngine_Object__op_Inequality(touchObject, 0, 0) )
    {
      ...
      *p_touchObject = 0;
      sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.touchObject, 0, v14, v15, v16, v17, v18, v19);
      if ( !byte_4DFE0A9 )
      {
        sub_1CE6700(&UnityEngine_Vector3_TypeInfo);
        byte_4DFE0A9 = 1;
    ...
    if ( this->fields.flagId == -1 )
    {
      ...
      {
        p_selectCallbackFunc->klass = 0;
        sub_1CE66A4(p_selectCallbackFunc, 0, v7, v8, v9, v10, v11, v12);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E0369A & 1) == 0 )
  {
    sub_1CE6700(&System_Action_TypeInfo);
    sub_1CE6700(&UnityEngine_Object_TypeInfo);
    sub_1CE6700(&Method_TutorialNotificationMessage_EndOpen__);
    sub_1CE6700(&Method_TutorialNotificationMessage__Open_b__13_0__);
    sub_1CE6700(&StringLiteral_1/*""*/);
    byte_4E0369A = 1;
  }
...
// local variable allocation has failed, the output may be wrong!
void TutorialNotificationMessage__Open_41288768(
        TutorialNotificationMessage_o *this,
        System_String_o *message,
        UnityEngine_Vector2_o messagePos,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E0369B & 1) == 0 )
  {
    ...
    sub_1CE6700(&UnityEngine_Object_TypeInfo);
    sub_1CE6700(&Method_TutorialNotificationMessage_EndOpen__);
    sub_1CE6700(&Method_TutorialNotificationMessage__Open_b__14_0__);
    sub_1CE6700(&StringLiteral_1/*""*/);
  ...
  if ( dlgBgId )
  {
    ...
    v34.fields.x = 3.0;
    v34.fields.y = 3.0;
    UILabel__set_effectDistance(transform, v34, 0);
    transform = this->fields.messageLabel;
    if ( !transform )
      goto LABEL_50;
...
LABEL_43:
  ...
  v30 = System_String__Format((System_String_o *)StringLiteral_3051/*"Back/back{0}"*/, v29, 0);
