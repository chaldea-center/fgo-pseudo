        ...
        const MethodInfo *method)
{
  ...
  PartyOrganizationRemoveSelectMenu__Close_19960936(this, 0LL, v2);
}


void __fastcall PartyOrganizationRemoveSelectMenu__Close_19960936(
        PartyOrganizationRemoveSelectMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AD4CF & 1) == 0 )
  {
    ...
    sub_B52984(&Method_PartyOrganizationRemoveSelectMenu_EndClose__);
    byte_42AD4CF = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AD4D5 & 1) == 0 )
  {
    sub_B52984(&Method_PartyOrganizationRemoveSelectMenu_OnClickCancel__);
    byte_42AD4D5 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationRemoveSelectMenu_OnClickCancel__ + 75) & 2) != 0 )
      v3 = (_QWORD *)sub_B5298C(Method_PartyOrganizationRemoveSelectMenu_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AD4CE & 1) == 0 )
  {
    ...
    sub_B52984(&Method_PartyOrganizationRemoveSelectMenu_EndOpen__);
    sub_B52984(&StringLiteral_10432/*"PARTY_ORGANIZATION_REMOVE_SELECT_CANCEL"*/);
    sub_B52984(&StringLiteral_10435/*"PARTY_ORGANIZATION_REMOVE_SELECT_INIT_ALL"*/);
    sub_B52984(&StringLiteral_10438/*"PARTY_ORGANIZATION_REMOVE_SELECT_REMOVE_ALL"*/);
    sub_B52984(&StringLiteral_10440/*"PARTY_ORGANIZATION_REMOVE_SELECT_TITLE"*/);
    sub_B52984(&StringLiteral_10433/*"PARTY_ORGANIZATION_REMOVE_SELECT_CHANGE_NAME"*/);
    sub_B52984(&StringLiteral_1/*""*/);
    sub_B52984(&StringLiteral_10436/*"PARTY_ORGANIZATION_REMOVE_SELECT_MESSAGE"*/);
    sub_B52984(&StringLiteral_10439/*"PARTY_ORGANIZATION_REMOVE_SELECT_REMOVE_EQUIP"*/);
    sub_B52984(&StringLiteral_10434/*"PARTY_ORGANIZATION_REMOVE_SELECT_COPY"*/);
    sub_B52984(&StringLiteral_10437/*"PARTY_ORGANIZATION_REMOVE_SELECT_NAME"*/);
    byte_42AD4CE = 1;
  }
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10440/*"PARTY_ORGANIZATION_REMOVE_SELECT_TITLE"*/, 0LL);
  if ( !titleLabel )
    goto LABEL_62;
  v18 = menuKind | 8;
  ...
  if ( v18 == 8 )
  {
    ...
    v20 = LocalizationManager__Get((System_String_o *)StringLiteral_10437/*"PARTY_ORGANIZATION_REMOVE_SELECT_NAME"*/, 0LL);
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10436/*"PARTY_ORGANIZATION_REMOVE_SELECT_MESSAGE"*/, 0LL);
  if ( !messageLabel )
    goto LABEL_62;
  ...
  GameObjectExtensions__SetLocalPositionY(v23, flt_3278D80[v18 == 8], 0LL);
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10434/*"PARTY_ORGANIZATION_REMOVE_SELECT_COPY"*/, 0LL);
  if ( !copyLabel )
    goto LABEL_62;
  UILabel__set_text(copyLabel, (System_String_o *)gameObject, 0LL);
  removeAllLabel = this->fields.removeAllLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10438/*"PARTY_ORGANIZATION_REMOVE_SELECT_REMOVE_ALL"*/, 0LL);
  if ( !removeAllLabel )
    goto LABEL_62;
  UILabel__set_text(removeAllLabel, (System_String_o *)gameObject, 0LL);
  initAllLabel = this->fields.initAllLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10435/*"PARTY_ORGANIZATION_REMOVE_SELECT_INIT_ALL"*/, 0LL);
  if ( !initAllLabel )
    goto LABEL_62;
  UILabel__set_text(initAllLabel, (System_String_o *)gameObject, 0LL);
  removeEquipLabel = this->fields.removeEquipLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10439/*"PARTY_ORGANIZATION_REMOVE_SELECT_REMOVE_EQUIP"*/, 0LL);
  if ( !removeEquipLabel )
    goto LABEL_62;
  UILabel__set_text(removeEquipLabel, (System_String_o *)gameObject, 0LL);
  changeNameLabel = this->fields.changeNameLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10433/*"PARTY_ORGANIZATION_REMOVE_SELECT_CHANGE_NAME"*/, 0LL);
  if ( !changeNameLabel )
    goto LABEL_62;
  UILabel__set_text(changeNameLabel, (System_String_o *)gameObject, 0LL);
  cancelLabel = this->fields.cancelLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10432/*"PARTY_ORGANIZATION_REMOVE_SELECT_CANCEL"*/, 0LL);
  if ( !cancelLabel )
    goto LABEL_62;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AD4CB & 1) == 0 )
  {
    sub_B52984(&PartyOrganizationRemoveSelectMenu_CallbackFunc_TypeInfo);
    byte_42AD4CB = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (PartyOrganizationRemoveSelectMenu_o *)sub_B52D50(v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AD41A & 1) == 0 )
  {
    sub_B52984(&PartyOrganizationRemoveSelectMenu_ResultKind_TypeInfo);
    byte_42AD41A = 1;
  }
  v9[1] = 0LL;
