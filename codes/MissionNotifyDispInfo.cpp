        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0BFE5 & 1) == 0 )
  {
    sub_1B686D4(&Method_DataManager_GetMasterData_EventMissionCondDetailMaster___, missionCondTypeHashSet);
    ...
    sub_1B686D4(
      ...
      v6);
    sub_1B686D4(&Method_System_Collections_Generic_HashSet_EventMissionCondDetailEntity_MissionCondType__Contains__, v7);
  ...
  while ( 1 )
  {
    ...
    if ( ((unsigned __int8)Instance & 1) != 0 )
    {
      ...
      Instance = (Il2CppObject *)System_Collections_Generic_HashSet_Int32Enum___Contains(
                                   ...
                                   (const MethodInfo_3377364 *)Method_System_Collections_Generic_HashSet_EventMissionCondDetailEntity_MissionCondType__Contains__);
      if ( ((unsigned __int8)Instance & 1) != 0 )
        return 1;
    }
