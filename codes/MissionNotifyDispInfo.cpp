        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CCAF49 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_System_Collections_Generic_HashSet_EventMissionCondDetailEntity_MissionCondType__Contains__);
  ...
  while ( 1 )
  {
    ...
    if ( ((unsigned __int8)Instance & 1) != 0 )
    {
      ...
      Instance = (Il2CppObject *)System_Collections_Generic_HashSet_Int32Enum___Contains(
                                   ...
                                   (const MethodInfo_36C35D8 *)Method_System_Collections_Generic_HashSet_EventMissionCondDetailEntity_MissionCondType__Contains__);
      if ( ((unsigned __int8)Instance & 1) != 0 )
        return 1;
    }
