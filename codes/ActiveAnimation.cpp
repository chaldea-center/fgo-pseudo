void ActiveAnimation___ctor(ActiveAnimation_o *this, const MethodInfo *method)
{
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.onFinished, (int32_t)v3, v4, v5, v6, v7, v8, v9);
  v10 = StringLiteral_1/*""*/;
  this->fields.mClip = (struct System_String_o *)StringLiteral_1/*""*/;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.mClip, v10, v11, v12, v13, v14, v15, v16);
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(mAnim, 0, 0) )
  {
    ...
    else if ( !UnityEngine_Animation__IsPlaying(this->fields.mAnim, clipName, 0) )
    {
      ...
      if ( !IsNullOrEmpty )
        goto LABEL_72;
      UnityEngine_Animation__Play_72661460(IsNullOrEmpty, clipName, 0);
    }
    IsNullOrEmpty = this->fields.mAnim;
    if ( !IsNullOrEmpty )
LABEL_72:
...
LABEL_32:
      ...
      if ( ((*(__int64 (__fastcall **)(System_Collections_IEnumerator_o *, _QWORD))v17)(
          ...
          & 1) == 0 )
      {
        v30 = sub_1CE683C(Enumerator, System_IDisposable_TypeInfo);
        if ( v30 )
        {
          v31 = *(_QWORD *)v30;
          v32 = v30;
          ...
          {
LABEL_59:
            v35 = sub_1CBCA7C(v30, System_IDisposable_TypeInfo, 0);
          }
      ...
      {
LABEL_39:
        v21 = sub_1CBCA7C(Enumerator, System_Collections_IEnumerator_TypeInfo, 1);
      }
...
LABEL_48:
  ...
  if ( UnityEngine_Object__op_Inequality(mAnimator, 0, 0) )
  {
    ...
    *((_DWORD *)p_mClip - 6) = playDirection;
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)p_mClip, (int32_t)clipName, v37, v38, v39, v40, v41, v42);
    ...
    if ( playDirection == 1 )
      v43 = 0.0;
    UnityEngine_Animator__Play((UnityEngine_Animator_o *)IsNullOrEmpty, *p_mClip, 0, v43, 0);
  }
}


ActiveAnimation_o *ActiveAnimation__Play_50356412(
        ...
        const MethodInfo *method)
{
  ...
  UnityEngine_Animation_o **v19; // x24
  ...
  if ( (byte_4E09149 & 1) == 0 )
  {
    sub_1CE6700(&Method_UnityEngine_Component_GetComponent_ActiveAnimation___);
    sub_1CE6700(&Method_UnityEngine_GameObject_AddComponent_ActiveAnimation___);
    sub_1CE6700(&Method_UnityEngine_GameObject_GetComponentsInChildren_UIPanel___);
    sub_1CE6700(&Method_System_Collections_Generic_List_EventDelegate__Clear__);
    sub_1CE6700(&NGUITools_TypeInfo);
    anim = (UnityEngine_Animation_o *)sub_1CE6700(&UnityEngine_Object_TypeInfo);
    byte_4E09149 = 1;
  }
  if ( !v10 )
    goto LABEL_39;
  ...
  if ( !NGUITools__GetActive_50455396(gameObject, 0) )
  {
    if ( enableBeforePlay != 1 )
      return 0;
    v25 = UnityEngine_Component__get_gameObject(v10, 0);
    if ( !NGUITools_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(NGUITools_TypeInfo);
    NGUITools__SetActive(v25, 1, 0);
    anim = (UnityEngine_Animation_o *)UnityEngine_Component__get_gameObject(v10, 0);
    if ( !anim )
      goto LABEL_39;
    anim = (UnityEngine_Animation_o *)UnityEngine_GameObject__GetComponentsInChildren_object__52808288(
                                        (UnityEngine_GameObject_o *)anim,
                                        (const MethodInfo_325CA60 *)Method_UnityEngine_GameObject_GetComponentsInChildren_UIPanel___);
    if ( !anim )
      goto LABEL_39;
    klass = anim[1].klass;
    v27 = anim;
    ...
    if ( (int)klass >= 1 )
    {
      ...
      while ( 1 )
      {
        anim = (UnityEngine_Animation_o *)*((_QWORD *)&v27[1].monitor + v29);
        if ( !anim )
          goto LABEL_39;
        UIPanel__Refresh((UIPanel_o *)anim, 0);
        if ( v28 == v29 )
          break;
        if ( (unsigned int)++v29 >= LODWORD(v27[1].klass) )
          sub_1CE6960(v30);
      }
    }
  }
  Component_object = (char *)UnityEngine_Component__GetComponent_object_(
                               v10,
                               (const MethodInfo_31FAB78 *)Method_UnityEngine_Component_GetComponent_ActiveAnimation___);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  ...
  if ( ((unsigned __int8)anim & 1) != 0 )
  {
    ...
    anim = (UnityEngine_Animation_o *)UnityEngine_GameObject__AddComponent_object_(
                                        (UnityEngine_GameObject_o *)anim,
                                        (const MethodInfo_325BD54 *)Method_UnityEngine_GameObject_AddComponent_ActiveAnimation___);
    Component_object = (char *)anim;
  }
  if ( !Component_object
    || (*((_QWORD *)Component_object + 7) = v10,
        v19 = (UnityEngine_Animation_o **)(Component_object + 56),
        sub_1CE66A4((GrandQuestFolderBoardItem_o *)(Component_object + 56), (int32_t)v10, v13, v14, v15, v16, v17, v18),
        v21 = *((_QWORD *)Component_object + 4),
        *((_DWORD *)Component_object + 17) = disableCondition,
        !v21) )
  {
LABEL_39:
    sub_1CE6958(anim, clipName);
  }
  v22 = *(_DWORD *)(v21 + 24);
  v23 = *(_DWORD *)(v21 + 28) + 1;
  *(_DWORD *)(v21 + 24) = 0;
  *(_DWORD *)(v21 + 28) = v23;
  if ( v22 >= 1 )
    System_Array__Clear(*(System_Array_o **)(v21 + 16), 0, v22, 0);
  ActiveAnimation__Play((ActiveAnimation_o *)Component_object, clipName, playDirection, v20);
  v24 = (UnityEngine_Object_o *)*((_QWORD *)Component_object + 7);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  ...
  v31 = (UnityEngine_Object_o *)*((_QWORD *)Component_object + 10);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
...
ActiveAnimation_o *ActiveAnimation__Play_50372428(
        UnityEngine_Animation_o *anim,
        System_String_o *clipName,
        int32_t playDirection,
        const MethodInfo *method)
{
  ...
  return ActiveAnimation__Play_50356412(anim, clipName, playDirection, 0, 0, v4);
}


ActiveAnimation_o *ActiveAnimation__Play_50372440(
        UnityEngine_Animation_o *anim,
        int32_t playDirection,
        const MethodInfo *method)
{
  ...
  return ActiveAnimation__Play_50356412(anim, 0, playDirection, 0, 0, v3);
}


ActiveAnimation_o *ActiveAnimation__Play_50372460(
        ...
        const MethodInfo *method)
{
  ...
  int64_t v17; // x6
  System_String_o *v18; // x7
  UnityEngine_Animator_o **v19; // x24
  const MethodInfo *v20; // x3
  __int64 v21; // x8
  int32_t v22; // w2
  int v23; // w9
  UnityEngine_Object_o *v24; // x19
  UnityEngine_Animator_o *v25; // x19
  UnityEngine_GameObject_o *v26; // x23
  UnityEngine_Animator_c *klass; // x8
  UnityEngine_Animator_o *v28; // x23
  int v29; // w24
  int v30; // w25
  ...
  if ( (byte_4E0914A & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_System_Collections_Generic_List_EventDelegate__Clear__);
    sub_1CE6700(&NGUITools_TypeInfo);
    anim = (UnityEngine_Animator_o *)sub_1CE6700(&UnityEngine_Object_TypeInfo);
    byte_4E0914A = 1;
  }
...
LABEL_4:
  ...
  else
  {
    ...
    if ( !NGUITools__GetActive_50455396(gameObject, 0) )
    {
      if ( enableBeforePlay != 1 )
        return 0;
      v26 = UnityEngine_Component__get_gameObject(v10, 0);
      if ( !NGUITools_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(NGUITools_TypeInfo);
      NGUITools__SetActive(v26, 1, 0);
      anim = (UnityEngine_Animator_o *)UnityEngine_Component__get_gameObject(v10, 0);
      if ( !anim
        || (anim = (UnityEngine_Animator_o *)UnityEngine_GameObject__GetComponentsInChildren_object__52808288(
                                               (UnityEngine_GameObject_o *)anim,
                                               (const MethodInfo_325CA60 *)Method_UnityEngine_GameObject_GetComponentsInChildren_UIPanel___)) == 0 )
      {
LABEL_42:
        sub_1CE6958(anim, clipName);
      }
      ...
      if ( (int)klass >= 1 )
      {
        ...
        while ( 1 )
        {
          anim = (UnityEngine_Animator_o *)*((_QWORD *)&v28[1].monitor + v30);
          if ( !anim )
            goto LABEL_42;
          UIPanel__Refresh((UIPanel_o *)anim, 0);
          if ( v29 == v30 )
  ...
  *((_QWORD *)Component_object + 10) = v10;
  v19 = (UnityEngine_Animator_o **)(Component_object + 80);
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)(Component_object + 80), (int32_t)v10, v13, v14, v15, v16, v17, v18);
  v21 = *((_QWORD *)Component_object + 4);
  *((_DWORD *)Component_object + 17) = disableCondition;
  if ( !v21 )
    goto LABEL_42;
...
void ActiveAnimation__Start(ActiveAnimation_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(eventReceiver, 0, 0) )
  {
    ...
    if ( EventDelegate__IsValid_50356184(onFinished, v4) )
    {
      this->fields.eventReceiver = 0;
      sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.eventReceiver, 0, v6, v7, v8, v9, v10, v11);
      this->fields.callWhenFinished = 0;
      sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.callWhenFinished, 0, v12, v13, v14, v15, v16, v17);
    }
  }
}
...
void ActiveAnimation__Update(ActiveAnimation_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E09147 & 1) == 0 )
  {
    sub_1CE6700(&ActiveAnimation_TypeInfo);
    sub_1CE6700(&UnityEngine_AnimationState_TypeInfo);
    sub_1CE6700(&EventDelegate_TypeInfo);
    sub_1CE6700(&System_IDisposable_TypeInfo);
    sub_1CE6700(&System_Collections_IEnumerator_TypeInfo);
...
LABEL_41:
  ...
  v31 = sub_1CE683C(Enumerator, System_IDisposable_TypeInfo);
  if ( v31 )
  {
    v32 = *(_QWORD *)v31;
    v33 = v31;
    ...
    {
LABEL_48:
      v36 = sub_1CBCA7C(v31, System_IDisposable_TypeInfo, 0);
    }
...
LABEL_53:
    ...
    if ( this->fields.mNotify )
    {
      ...
      if ( UnityEngine_Object__op_Equality(current, 0, 0) )
      {
        ...
        sub_1CE66A4(
          (GrandQuestFolderBoardItem_o *)ActiveAnimation_TypeInfo->static_fields,
          (int32_t)this,
          v38,
          v39,
          v40,
        ...
        if ( !EventDelegate_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(EventDelegate_TypeInfo);
        EventDelegate__Execute_50327612(onFinished, v44);
        eventReceiver = (UnityEngine_Object_o *)this->fields.eventReceiver;
        if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
        if ( UnityEngine_Object__op_Inequality(eventReceiver, 0, 0)
...
LABEL_18:
    ...
    {
LABEL_25:
      v20 = sub_1CBCA7C(Enumerator, System_Collections_IEnumerator_TypeInfo, 1);
    }
...
LABEL_36:
  ...
  v9 = 0;
LABEL_38:
  v28 = sub_1CE683C(Enumerator, System_IDisposable_TypeInfo);
  if ( v28 )
  {
    v29 = *(_QWORD *)v28;
    v30 = v28;
    ...
    {
LABEL_43:
      v33 = sub_1CBCA7C(v28, System_IDisposable_TypeInfo, 0);
    }
