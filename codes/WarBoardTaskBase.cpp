...
System_Collections_IEnumerator_o *WarBoardTaskBase__Execute(WarBoardTaskBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C35671 & 1) == 0 )
  {
    sub_1C32C20(&WarBoardTaskBase__Execute_d__15_TypeInfo);
    byte_4C35671 = 1;
  }
  v2 = sub_1C32E6C(WarBoardTaskBase__Execute_d__15_TypeInfo);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1A75924;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A758E4;
}
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C32C34(&Method_WarBoardTaskBase__Execute_d__15_System_Collections_IEnumerator_Reset__);
  sub_1C32D48(v3, v4);
}
