        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDA389 & 1) == 0 )
  {
    sub_1C21E38(&WarBoardTaskBase__Execute_d__15_TypeInfo);
    byte_4BDA389 = 1;
  }
  v2 = sub_1C22084(WarBoardTaskBase__Execute_d__15_TypeInfo);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A6167C;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A6163C;
}
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C21E4C(&Method_WarBoardTaskBase__Execute_d__15_System_Collections_IEnumerator_Reset__);
  sub_1C21F60(v3, v4);
}
