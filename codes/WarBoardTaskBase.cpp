...
System_Collections_IEnumerator_o *WarBoardTaskBase__Execute(WarBoardTaskBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEC277 & 1) == 0 )
  {
    sub_1C7BAE8(&WarBoardTaskBase__Execute_d__15_TypeInfo);
    byte_4CEC277 = 1;
  }
  v2 = sub_1C7BD34(WarBoardTaskBase__Execute_d__15_TypeInfo);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1AAF934;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1AAF8F4;
}
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C7BAFC(&Method_WarBoardTaskBase__Execute_d__15_System_Collections_IEnumerator_Reset__);
  sub_1C7BC10(v3, v4);
}
