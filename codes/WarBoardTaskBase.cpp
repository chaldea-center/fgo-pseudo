...
System_Collections_IEnumerator_o *WarBoardTaskBase__Execute(WarBoardTaskBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C24F9C & 1) == 0 )
  {
    sub_1C2D490(&WarBoardTaskBase__Execute_d__15_TypeInfo);
    byte_4C24F9C = 1;
  }
  v2 = sub_1C2D6DC(WarBoardTaskBase__Execute_d__15_TypeInfo);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1A701FC;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A701BC;
}
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C2D4A4(&Method_WarBoardTaskBase__Execute_d__15_System_Collections_IEnumerator_Reset__);
  sub_1C2D5B8(v3, v4);
}
