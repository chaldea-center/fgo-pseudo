...
void __fastcall EventBoardGameTokenManager__Awake(EventBoardGameTokenManager_o *this, const MethodInfo *method)
{
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.eventUILoadCallbackFunc, 0LL, v2, v3, v4, v5, v6, v7);
  this->fields.eventUIAssetData = 0LL;
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.eventUIAssetData, 0LL, v9, v10, v11, v12, v13, v14);
  this->fields.eventUIDownloadAtlas = 0LL;
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.eventUIDownloadAtlas, 0LL, v15, v16, v17, v18, v19, v20);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCB92F & 1) == 0 )
  {
    sub_1C1ABD4(&Method_UnityEngine_Object_Instantiate_GameObject___, prefab);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCB933 & 1) == 0 )
  {
    ...
    this = (EventBoardGameTokenManager_o *)sub_1C1ABD4(&Method_UnityEngine_GameObject_GetComponent_UIAtlas___, v7);
    byte_4BCB933 = 1;
  }
  if ( !assetData )
    goto LABEL_9;
  ...
  {
    this = (EventBoardGameTokenManager_o *)AssetData__GetObject_object__49812820(
                                             assetData,
                                             name,
...
void __fastcall EventBoardGameTokenManager__DestoryList(EventBoardGameTokenManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BCB930 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_System_Collections_Generic_List_EventBoardGameTokenItem__get_Item__, method);
  ...
  if ( tokenList )
  {
    ...
    while ( 1 )
    {
      Item = System_Collections_Generic_List_object___get_Item(
               tokenList,
               v6,
               (const MethodInfo_363C5C0 *)Method_System_Collections_Generic_List_EventBoardGameTokenItem__get_Item__);
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)Item, 0LL, 0LL) )
      {
        ...
        if ( !*p_tokenList
          || (tokenList = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___get_Item(
                                                                         tokenList,
                                                                         v6,
                                                                         (const MethodInfo_363C5C0 *)Method_System_Collections_Generic_List_EventBoardGameTokenItem__get_Item__)) == 0LL )
        {
LABEL_13:
          sub_1C1AE30(tokenList, v8);
        }
    ...
    sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.tokenList, 0LL, v9, v10, v11, v12, v13, v14);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCB92B & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_EventBoardGameTokenManager___c__DisplayClass18_0__Init_b__0__, v5);
    sub_1C1ABD4(&EventBoardGameTokenManager___c__DisplayClass18_0_TypeInfo, v6);
    byte_4BCB92B = 1;
  }
  v7 = sub_1C1AE20(EventBoardGameTokenManager___c__DisplayClass18_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCB931 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_EventBoardGameTokenManager_LoadEventUIEnd__, v8);
    sub_1C1ABD4(&AssetLoader_LoadEndDataHandler_TypeInfo, v9);
    sub_1C1ABD4(&StringLiteral_6387/*"EventUI/Prefabs/80285"*/, v10);
    byte_4BCB931 = 1;
  }
...
LABEL_9:
  ...
  if ( !this->fields.isEventUILoad )
  {
    ...
    if ( !AssetManager__loadAssetStorage((System_String_o *)StringLiteral_6387/*"EventUI/Prefabs/80285"*/, v22, loadParallelMax, 0LL) )
    {
      this->fields.isEventUILoad = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCB932 & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_5481/*"DownloadEventUIAtlas8028500"*/, assetData);
    byte_4BCB932 = 1;
  }
  if ( this->fields.isEventUILoad )
  {
    ...
    UIAtlasFromAssetData = EventBoardGameTokenManager__CreateUIAtlasFromAssetData(
                             v10,
                             assetData,
                             (System_String_o *)StringLiteral_5481/*"DownloadEventUIAtlas8028500"*/,
                             v11);
  ...
  if ( eventUILoadCallbackFunc )
  {
    ...
    sub_1C1AB78(p_eventUILoadCallbackFunc, 0LL, (int64_t)method, v3, v4, v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCB934 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_6387/*"EventUI/Prefabs/80285"*/, v9);
    byte_4BCB934 = 1;
  }
  if ( this->fields.isEventUILoad )
  {
    ...
    if ( !AssetManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
    AssetManager__releaseAssetStorage((System_String_o *)StringLiteral_6387/*"EventUI/Prefabs/80285"*/, 0LL);
  }
  else
  {
    eventUIAssetData = this->fields.eventUIAssetData;
  ...
  this->fields.eventUIDownloadAtlas = 0LL;
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.eventUIDownloadAtlas, 0LL, v2, v3, v4, v5, v6, v7);
  this->fields.eventUIAssetData = 0LL;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCB92C & 1) == 0 )
  {
    sub_1C1ABD4(&System_Action_int__TypeInfo, *(_QWORD *)&eventId);
    sub_1C1ABD4(&Method_DataManager_GetMasterData_EventBoardGameTokenMaster___, v4);
    sub_1C1ABD4(&Method_DataManager_GetMasterData_UserEventBoardGameTokenMaster___, v5);
    sub_1C1ABD4(&Method_EventBoardGameTokenManager_checkTokenInfo__, v6);
    sub_1C1ABD4(&Method_UnityEngine_GameObject_GetComponent_EventBoardGameTokenItem___, v7);
    sub_1C1ABD4(&Method_System_Collections_Generic_List_EventBoardGameTokenItem__Add__, v8);
    sub_1C1ABD4(&Method_System_Collections_Generic_List_EventBoardGameTokenItem___ctor__, v9);
    sub_1C1ABD4(&System_Collections_Generic_List_EventBoardGameTokenItem__TypeInfo, v10);
...
LABEL_37:
  ...
  MasterData_object = DataManager__GetMasterData_object_(
                        ...
                        (const MethodInfo_2F9F490 *)Method_DataManager_GetMasterData_EventBoardGameTokenMaster___);
  v17 = (System_Collections_Generic_List_object__o *)sub_1C1AE20(System_Collections_Generic_List_EventBoardGameTokenItem__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v17,
    (const MethodInfo_363C05C *)Method_System_Collections_Generic_List_EventBoardGameTokenItem___ctor__);
  this->fields.tokenList = (struct System_Collections_Generic_List_EventBoardGameTokenItem__o *)v17;
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.tokenList, (int64_t)v17, v18, v19, v20, v21, v22, v23);
  v24 = 0;
  v25 = 11;
  v26 = 1;
  v27 = 1;
  ...
  do
  {
    ...
    Instance = (__int64)UnityEngine_GameObject__GetComponent_object_(
                          ...
                          (const MethodInfo_2FEFBC0 *)Method_UnityEngine_GameObject_GetComponent_EventBoardGameTokenItem___);
    ...
    v43 = DataManager__GetMasterData_object_(
            (DataManager_o *)Instance,
            (const MethodInfo_2F9F490 *)Method_DataManager_GetMasterData_UserEventBoardGameTokenMaster___);
    if ( v43 )
...
LABEL_23:
    ...
    *(_QWORD *)(v36 + 80) = eventUIDownloadAtlas;
    sub_1C1AB78((PartyOrganizationUtility_o *)(v36 + 80), (int64_t)eventUIDownloadAtlas, v37, v38, v39, v40, v41, v42);
    v46 = entity;
    v47 = (System_Action_int__o *)sub_1C1AE20(System_Action_int__TypeInfo);
    ...
    else
    {
      ...
      *(_QWORD *)(v58 + 32) = v36;
      sub_1C1AB78((PartyOrganizationUtility_o *)(v58 + 32), v36, v49, v50, v51, v52, v53, v54);
    }
    ...
    if ( !byte_4BC2146 )
    {
      Instance = sub_1C1ABD4(&UnityEngine_Vector3_TypeInfo, v15);
      byte_4BC2146 = 1;
    }
    if ( !v60 )
      goto LABEL_37;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCB92D & 1) == 0 )
  {
    sub_1C1ABD4(&Method_UnityEngine_GameObject_GetComponent_EventBoardGameTokenInfoDialog___, *(_QWORD *)&tokenId);
    sub_1C1ABD4(&Method_System_Collections_Generic_List_EventBoardGameTokenItem__get_Item__, v5);
  ...
  if ( UnityEngine_Object__op_Equality(tokenInfoDialog, 0LL, 0LL) )
  {
    ...
    if ( !Menu
      || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                               ...
                               (const MethodInfo_2FEFBC0 *)Method_UnityEngine_GameObject_GetComponent_EventBoardGameTokenInfoDialog___),
...
LABEL_12:
    ...
    *((_QWORD *)Menu + 16) = eventUIDownloadAtlas;
    sub_1C1AB78((PartyOrganizationUtility_o *)(Menu + 128), (int64_t)eventUIDownloadAtlas, v18, v19, v20, v21, v22, v23);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(v4, 0LL, 0LL) )
  {
    ...
    *p_tokenInfoDialog = 0LL;
    sub_1C1AB78((PartyOrganizationUtility_o *)p_tokenInfoDialog, 0LL, v8, v9, v10, v11, v12, v13);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCB936 & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_24389/*"token_bg"*/, method);
    byte_4BCB936 = 1;
  }
  ...
  if ( !_4__this
    || (EventBoardGameTokenManager__SetEventUI(
          ...
          (System_String_o *)StringLiteral_24389/*"token_bg"*/,
          v2),
