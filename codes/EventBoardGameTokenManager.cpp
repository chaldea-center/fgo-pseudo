...
void __fastcall EventBoardGameTokenManager__Awake(EventBoardGameTokenManager_o *this, const MethodInfo *method)
{
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.eventUILoadCallbackFunc, 0, v2, v3);
  this->fields.eventUIAssetData = 0LL;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.eventUIAssetData, 0, v5, v6);
  this->fields.eventUIDownloadAtlas = 0LL;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.eventUIDownloadAtlas, 0, v7, v8);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73B4E & 1) == 0 )
  {
    sub_1B90010(&Method_UnityEngine_Object_Instantiate_GameObject___, prefab);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73B52 & 1) == 0 )
  {
    ...
    this = (EventBoardGameTokenManager_o *)sub_1B90010(&Method_UnityEngine_GameObject_GetComponent_UIAtlas___, v7);
    byte_4A73B52 = 1;
  }
  if ( !assetData )
    goto LABEL_9;
  ...
  {
    this = (EventBoardGameTokenManager_o *)AssetData__GetObject_object__48695184(
                                             assetData,
                                             name,
...
void __fastcall EventBoardGameTokenManager__DestoryList(EventBoardGameTokenManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A73B4F & 1) == 0 )
  {
    sub_1B90010(&Method_System_Collections_Generic_List_EventBoardGameTokenItem__get_Item__, method);
  ...
  if ( tokenList )
  {
    ...
    while ( 1 )
    {
      Item = System_Collections_Generic_List_object___get_Item(
               tokenList,
               v6,
               (const MethodInfo_35106F0 *)Method_System_Collections_Generic_List_EventBoardGameTokenItem__get_Item__);
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)Item, 0LL, 0LL) )
      {
        ...
        if ( !*p_tokenList
          || (tokenList = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___get_Item(
                                                                         tokenList,
                                                                         v6,
                                                                         (const MethodInfo_35106F0 *)Method_System_Collections_Generic_List_EventBoardGameTokenItem__get_Item__)) == 0LL )
        {
LABEL_13:
          sub_1B9026C(tokenList, v8);
        }
    ...
    sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.tokenList, 0, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73B4A & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_EventBoardGameTokenManager___c__DisplayClass18_0__Init_b__0__, v5);
    sub_1B90010(&EventBoardGameTokenManager___c__DisplayClass18_0_TypeInfo, v6);
    byte_4A73B4A = 1;
  }
  v7 = sub_1B9025C(EventBoardGameTokenManager___c__DisplayClass18_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73B50 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_EventBoardGameTokenManager_LoadEventUIEnd__, v8);
    sub_1B90010(&AssetLoader_LoadEndDataHandler_TypeInfo, v9);
    sub_1B90010(&StringLiteral_6230/*"EventUI/Prefabs/80285"*/, v10);
    byte_4A73B50 = 1;
  }
...
LABEL_9:
  ...
  if ( !this->fields.isEventUILoad )
  {
    ...
    if ( !AssetManager__loadAssetStorage((System_String_o *)StringLiteral_6230/*"EventUI/Prefabs/80285"*/, v18, loadParallelMax, 0LL) )
    {
      this->fields.isEventUILoad = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73B51 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_5379/*"DownloadEventUIAtlas8028500"*/, assetData);
    byte_4A73B51 = 1;
  }
  if ( this->fields.isEventUILoad )
  {
    ...
    UIAtlasFromAssetData = EventBoardGameTokenManager__CreateUIAtlasFromAssetData(
                             v6,
                             assetData,
                             (System_String_o *)StringLiteral_5379/*"DownloadEventUIAtlas8028500"*/,
                             v7);
  ...
  if ( eventUILoadCallbackFunc )
  {
    ...
    sub_1B8FFB4(p_eventUILoadCallbackFunc, 0, (int32_t)method, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73B53 & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_6230/*"EventUI/Prefabs/80285"*/, v5);
    byte_4A73B53 = 1;
  }
  if ( this->fields.isEventUILoad )
  {
    ...
    if ( !AssetManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
    AssetManager__releaseAssetStorage((System_String_o *)StringLiteral_6230/*"EventUI/Prefabs/80285"*/, 0LL);
  }
  else
  {
    eventUIAssetData = this->fields.eventUIAssetData;
  ...
  this->fields.eventUIDownloadAtlas = 0LL;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.eventUIDownloadAtlas, 0, v2, v3);
  this->fields.eventUIAssetData = 0LL;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73B4B & 1) == 0 )
  {
    sub_1B90010(&System_Action_int__TypeInfo, *(_QWORD *)&eventId);
    sub_1B90010(&Method_DataManager_GetMasterData_EventBoardGameTokenMaster___, v4);
    sub_1B90010(&Method_DataManager_GetMasterData_UserEventBoardGameTokenMaster___, v5);
    sub_1B90010(&Method_EventBoardGameTokenManager_checkTokenInfo__, v6);
    sub_1B90010(&Method_UnityEngine_GameObject_GetComponent_EventBoardGameTokenItem___, v7);
    sub_1B90010(&Method_System_Collections_Generic_List_EventBoardGameTokenItem__Add__, v8);
    sub_1B90010(&Method_System_Collections_Generic_List_EventBoardGameTokenItem___ctor__, v9);
    sub_1B90010(&System_Collections_Generic_List_EventBoardGameTokenItem__TypeInfo, v10);
...
LABEL_37:
  ...
  MasterData_object = DataManager__GetMasterData_object_(
                        ...
                        (const MethodInfo_2E8E21C *)Method_DataManager_GetMasterData_EventBoardGameTokenMaster___);
  v17 = (System_Collections_Generic_List_object__o *)sub_1B9025C(System_Collections_Generic_List_EventBoardGameTokenItem__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v17,
    (const MethodInfo_351018C *)Method_System_Collections_Generic_List_EventBoardGameTokenItem___ctor__);
  this->fields.tokenList = (struct System_Collections_Generic_List_EventBoardGameTokenItem__o *)v17;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.tokenList, (int32_t)v17, v18, v19);
  v20 = 0;
  v21 = 11;
  v22 = 1;
  v23 = 1;
  ...
  do
  {
    ...
    Instance = (__int64)UnityEngine_GameObject__GetComponent_object_(
                          ...
                          (const MethodInfo_2EDD768 *)Method_UnityEngine_GameObject_GetComponent_EventBoardGameTokenItem___);
    ...
    v35 = DataManager__GetMasterData_object_(
            (DataManager_o *)Instance,
            (const MethodInfo_2E8E21C *)Method_DataManager_GetMasterData_UserEventBoardGameTokenMaster___);
    if ( v35 )
...
LABEL_23:
    ...
    *(_QWORD *)(v32 + 80) = eventUIDownloadAtlas;
    sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v32 + 80), (int32_t)eventUIDownloadAtlas, v33, v34);
    v38 = entity;
    v39 = (System_Action_int__o *)sub_1B9025C(System_Action_int__TypeInfo);
    ...
    else
    {
      ...
      *(_QWORD *)(v46 + 32) = v32;
      sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v46 + 32), v32, v41, v42);
    }
    ...
    if ( !byte_4A6A9C6 )
    {
      Instance = sub_1B90010(&UnityEngine_Vector3_TypeInfo, v15);
      byte_4A6A9C6 = 1;
    }
    if ( !v48 )
      goto LABEL_37;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73B4C & 1) == 0 )
  {
    sub_1B90010(&Method_UnityEngine_GameObject_GetComponent_EventBoardGameTokenInfoDialog___, *(_QWORD *)&tokenId);
    sub_1B90010(&Method_System_Collections_Generic_List_EventBoardGameTokenItem__get_Item__, v5);
  ...
  if ( UnityEngine_Object__op_Equality(tokenInfoDialog, 0LL, 0LL) )
  {
    ...
    if ( !Menu
      || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                               ...
                               (const MethodInfo_2EDD768 *)Method_UnityEngine_GameObject_GetComponent_EventBoardGameTokenInfoDialog___),
...
LABEL_12:
    ...
    *((_QWORD *)Menu + 16) = eventUIDownloadAtlas;
    sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(Menu + 128), (int32_t)eventUIDownloadAtlas, v14, v15);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(v4, 0LL, 0LL) )
  {
    ...
    *p_tokenInfoDialog = 0LL;
    sub_1B8FFB4((ServantStatusBattleListViewItem_o *)p_tokenInfoDialog, 0, v8, v9);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73B55 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_24016/*"token_bg"*/, method);
    byte_4A73B55 = 1;
  }
  ...
  if ( !_4__this
    || (EventBoardGameTokenManager__SetEventUI(
          ...
          (System_String_o *)StringLiteral_24016/*"token_bg"*/,
          v2),
