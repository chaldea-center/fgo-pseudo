...
void __fastcall EventBoardGameTokenManager__Awake(EventBoardGameTokenManager_o *this, const MethodInfo *method)
{
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.eventUILoadCallbackFunc, 0, v2, v3);
  this->fields.eventUIAssetData = 0LL;
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.eventUIAssetData, 0, v5, v6);
  this->fields.eventUIDownloadAtlas = 0LL;
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.eventUIDownloadAtlas, 0, v7, v8);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B06201 & 1) == 0 )
  {
    sub_1BC3008(&Method_AssetData_GetObjectList_GameObject___, assetData);
    sub_1BC3008(&Method_AssetData_GetObject_GameObject____76809672, v6);
    this = (EventBoardGameTokenManager_o *)sub_1BC3008(&Method_UnityEngine_GameObject_GetComponent_UIAtlas___, v7);
    byte_4B06201 = 1;
  }
  if ( !assetData )
    goto LABEL_9;
  ...
  {
    this = (EventBoardGameTokenManager_o *)AssetData__GetObject_object__50213776(
                                             assetData,
                                             name,
...
void __fastcall EventBoardGameTokenManager__DestoryList(EventBoardGameTokenManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B061FE & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Collections_Generic_List_EventBoardGameTokenItem__get_Item__, method);
  ...
  if ( tokenList )
  {
    ...
    while ( 1 )
    {
      Item = System_Collections_Generic_List_object___get_Item(
               tokenList,
               v6,
               (const MethodInfo_36A0B70 *)Method_System_Collections_Generic_List_EventBoardGameTokenItem__get_Item__);
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)Item, 0LL, 0LL) )
      {
        ...
        if ( !*p_tokenList
          || (tokenList = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___get_Item(
                                                                         tokenList,
                                                                         v6,
                                                                         (const MethodInfo_36A0B70 *)Method_System_Collections_Generic_List_EventBoardGameTokenItem__get_Item__)) == 0LL )
        {
LABEL_13:
          sub_1BC3264(tokenList, v8);
        }
    ...
    sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.tokenList, 0, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B061F9 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_EventBoardGameTokenManager___c__DisplayClass18_0__Init_b__0__, v5);
    sub_1BC3008(&EventBoardGameTokenManager___c__DisplayClass18_0_TypeInfo, v6);
    byte_4B061F9 = 1;
  }
  v7 = sub_1BC3254(EventBoardGameTokenManager___c__DisplayClass18_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B061FF & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_EventBoardGameTokenManager_LoadEventUIEnd__, v8);
    sub_1BC3008(&AssetLoader_LoadEndDataHandler_TypeInfo, v9);
    sub_1BC3008(&StringLiteral_6214/*"EventUI/Prefabs/80285"*/, v10);
    byte_4B061FF = 1;
  }
...
LABEL_9:
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.eventUILoadCallbackFunc, (int32_t)v14, v15, v16);
  if ( !this->fields.isEventUILoad )
  {
    ...
    if ( !AssetManager__loadAssetStorage((System_String_o *)StringLiteral_6214/*"EventUI/Prefabs/80285"*/, v18, loadParallelMax, 0LL) )
    {
      this->fields.isEventUILoad = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B06200 & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_5298/*"DownloadEventUIAtlas8028500"*/, assetData);
    byte_4B06200 = 1;
  }
  if ( this->fields.isEventUILoad )
  {
    ...
    sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.eventUIAssetData, (int32_t)assetData, (int32_t)method, v3);
    UIAtlasFromAssetData = EventBoardGameTokenManager__CreateUIAtlasFromAssetData(
                             v6,
                             assetData,
                             (System_String_o *)StringLiteral_5298/*"DownloadEventUIAtlas8028500"*/,
                             v7);
    this->fields.eventUIDownloadAtlas = UIAtlasFromAssetData;
    sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.eventUIDownloadAtlas, (int32_t)UIAtlasFromAssetData, v9, v10);
  }
  ...
  if ( eventUILoadCallbackFunc )
  {
    ...
    sub_1BC2FAC(p_eventUILoadCallbackFunc, 0, (int32_t)method, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B06202 & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_6214/*"EventUI/Prefabs/80285"*/, v5);
    byte_4B06202 = 1;
  }
  if ( this->fields.isEventUILoad )
  {
    ...
    if ( !AssetManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
    AssetManager__releaseAssetStorage((System_String_o *)StringLiteral_6214/*"EventUI/Prefabs/80285"*/, 0LL);
  }
  else
  {
    eventUIAssetData = this->fields.eventUIAssetData;
    if ( eventUIAssetData )
    {
      if ( !AssetManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
      AssetManager__releaseAsset_39571344(eventUIAssetData, 0LL);
    }
  }
  this->fields.eventUIDownloadAtlas = 0LL;
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.eventUIDownloadAtlas, 0, v2, v3);
  this->fields.eventUIAssetData = 0LL;
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.eventUIAssetData, 0, v7, v8);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B061FA & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_DataManager_GetMasterData_EventBoardGameTokenMaster___, v4);
    sub_1BC3008(&Method_DataManager_GetMasterData_UserEventBoardGameTokenMaster___, v5);
    sub_1BC3008(&Method_EventBoardGameTokenManager_checkTokenInfo__, v6);
    sub_1BC3008(&Method_UnityEngine_GameObject_GetComponent_EventBoardGameTokenItem___, v7);
    sub_1BC3008(&Method_System_Collections_Generic_List_EventBoardGameTokenItem__Add__, v8);
    sub_1BC3008(&Method_System_Collections_Generic_List_EventBoardGameTokenItem___ctor__, v9);
    sub_1BC3008(&System_Collections_Generic_List_EventBoardGameTokenItem__TypeInfo, v10);
...
LABEL_37:
  ...
  MasterData_object = DataManager__GetMasterData_object_(
                        ...
                        (const MethodInfo_3001E64 *)Method_DataManager_GetMasterData_EventBoardGameTokenMaster___);
  v17 = (System_Collections_Generic_List_object__o *)sub_1BC3254(System_Collections_Generic_List_EventBoardGameTokenItem__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v17,
    (const MethodInfo_36A060C *)Method_System_Collections_Generic_List_EventBoardGameTokenItem___ctor__);
  this->fields.tokenList = (struct System_Collections_Generic_List_EventBoardGameTokenItem__o *)v17;
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.tokenList, (int32_t)v17, v18, v19);
  v20 = 0;
  v21 = 11;
  v22 = 1;
  v23 = 1;
  ...
  do
  {
    ...
    Instance = (__int64)UnityEngine_GameObject__GetComponent_object_(
                          ...
                          (const MethodInfo_3055998 *)Method_UnityEngine_GameObject_GetComponent_EventBoardGameTokenItem___);
    ...
    v35 = DataManager__GetMasterData_object_(
            (DataManager_o *)Instance,
            (const MethodInfo_3001E64 *)Method_DataManager_GetMasterData_UserEventBoardGameTokenMaster___);
    if ( v35 )
...
LABEL_23:
    ...
    *(_QWORD *)(v32 + 80) = eventUIDownloadAtlas;
    sub_1BC2FAC((CGThumbnailListItem_o *)(v32 + 80), (int32_t)eventUIDownloadAtlas, v33, v34);
    v38 = entity;
    ...
    else
    {
      ...
      *(_QWORD *)(v46 + 32) = v32;
      sub_1BC2FAC((CGThumbnailListItem_o *)(v46 + 32), v32, v41, v42);
    }
    ...
    if ( !byte_4AFBDB6 )
    {
      Instance = sub_1BC3008(&UnityEngine_Vector3_TypeInfo, v15);
      byte_4AFBDB6 = 1;
    }
    if ( !v48 )
      goto LABEL_37;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B061FB & 1) == 0 )
  {
    sub_1BC3008(&Method_UnityEngine_GameObject_GetComponent_EventBoardGameTokenInfoDialog___, *(_QWORD *)&tokenId);
    sub_1BC3008(&Method_System_Collections_Generic_List_EventBoardGameTokenItem__get_Item__, v5);
  ...
  if ( UnityEngine_Object__op_Equality(tokenInfoDialog, 0LL, 0LL) )
  {
    ...
    if ( !Menu
      || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                               ...
                               (const MethodInfo_3055998 *)Method_UnityEngine_GameObject_GetComponent_EventBoardGameTokenInfoDialog___),
          this->fields.tokenInfoDialog = (struct EventBoardGameTokenInfoDialog_o *)Component_object,
          sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.tokenInfoDialog, (int32_t)Component_object, v12, v13),
...
LABEL_12:
    ...
    *((_QWORD *)Menu + 17) = eventUIDownloadAtlas;
    sub_1BC2FAC((CGThumbnailListItem_o *)Menu + 1, (int32_t)eventUIDownloadAtlas, v14, v15);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(v4, 0LL, 0LL) )
  {
    ...
    *p_tokenInfoDialog = 0LL;
    sub_1BC2FAC((CGThumbnailListItem_o *)p_tokenInfoDialog, 0, v8, v9);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B06204 & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_23877/*"token_bg"*/, method);
    byte_4B06204 = 1;
  }
  ...
  if ( !_4__this
    || (EventBoardGameTokenManager__SetEventUI(
          ...
          (System_String_o *)StringLiteral_23877/*"token_bg"*/,
          v2),
