...
void __fastcall EventBoardGameTokenManager__Awake(EventBoardGameTokenManager_o *this, const MethodInfo *method)
{
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.eventUILoadCallbackFunc, 0, v2, v3);
  this->fields.eventUIAssetData = 0LL;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.eventUIAssetData, 0, v5, v6);
  this->fields.eventUIDownloadAtlas = 0LL;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.eventUIDownloadAtlas, 0, v7, v8);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5253E & 1) == 0 )
  {
    sub_1B863B8(&Method_UnityEngine_Object_Instantiate_GameObject___, prefab);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A52542 & 1) == 0 )
  {
    ...
    this = (EventBoardGameTokenManager_o *)sub_1B863B8(&Method_UnityEngine_GameObject_GetComponent_UIAtlas___, v7);
    byte_4A52542 = 1;
  }
  if ( !assetData )
    goto LABEL_9;
  ...
  {
    this = (EventBoardGameTokenManager_o *)AssetData__GetObject_object__49610244(
                                             assetData,
                                             name,
...
void __fastcall EventBoardGameTokenManager__DestoryList(EventBoardGameTokenManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5253F & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Collections_Generic_List_EventBoardGameTokenItem__get_Item__, method);
  ...
  if ( tokenList )
  {
    ...
    while ( 1 )
    {
      Item = System_Collections_Generic_List_object___get_Item(
               tokenList,
               v6,
               (const MethodInfo_35FC688 *)Method_System_Collections_Generic_List_EventBoardGameTokenItem__get_Item__);
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)Item, 0LL, 0LL) )
      {
        ...
        if ( !*p_tokenList
          || (tokenList = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___get_Item(
                                                                         tokenList,
                                                                         v6,
                                                                         (const MethodInfo_35FC688 *)Method_System_Collections_Generic_List_EventBoardGameTokenItem__get_Item__)) == 0LL )
        {
LABEL_13:
          sub_1B86614(tokenList, v8);
        }
    ...
    sub_1B8635C((CGThumbnailListItem_o *)&this->fields.tokenList, 0, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5253A & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_EventBoardGameTokenManager___c__DisplayClass18_0__Init_b__0__, v5);
    sub_1B863B8(&EventBoardGameTokenManager___c__DisplayClass18_0_TypeInfo, v6);
    byte_4A5253A = 1;
  }
  v7 = sub_1B86604(EventBoardGameTokenManager___c__DisplayClass18_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A52540 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_EventBoardGameTokenManager_LoadEventUIEnd__, v8);
    sub_1B863B8(&AssetLoader_LoadEndDataHandler_TypeInfo, v9);
    sub_1B863B8(&StringLiteral_6198/*"EventUI/Prefabs/80285"*/, v10);
    byte_4A52540 = 1;
  }
...
LABEL_9:
  ...
  if ( !this->fields.isEventUILoad )
  {
    ...
    if ( !AssetManager__loadAssetStorage((System_String_o *)StringLiteral_6198/*"EventUI/Prefabs/80285"*/, v18, loadParallelMax, 0LL) )
    {
      this->fields.isEventUILoad = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A52541 & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_5311/*"DownloadEventUIAtlas8028500"*/, assetData);
    byte_4A52541 = 1;
  }
  if ( this->fields.isEventUILoad )
  {
    ...
    UIAtlasFromAssetData = EventBoardGameTokenManager__CreateUIAtlasFromAssetData(
                             v6,
                             assetData,
                             (System_String_o *)StringLiteral_5311/*"DownloadEventUIAtlas8028500"*/,
                             v7);
    this->fields.eventUIDownloadAtlas = UIAtlasFromAssetData;
    sub_1B8635C((CGThumbnailListItem_o *)&this->fields.eventUIDownloadAtlas, (int32_t)UIAtlasFromAssetData, v9, v10);
  }
  ...
  if ( eventUILoadCallbackFunc )
  {
    ...
    sub_1B8635C(p_eventUILoadCallbackFunc, 0, (int32_t)method, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A52543 & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_6198/*"EventUI/Prefabs/80285"*/, v5);
    byte_4A52543 = 1;
  }
  if ( this->fields.isEventUILoad )
  {
    ...
    if ( !AssetManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
    AssetManager__releaseAssetStorage((System_String_o *)StringLiteral_6198/*"EventUI/Prefabs/80285"*/, 0LL);
  }
  else
  {
    eventUIAssetData = this->fields.eventUIAssetData;
  ...
  this->fields.eventUIDownloadAtlas = 0LL;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.eventUIDownloadAtlas, 0, v2, v3);
  this->fields.eventUIAssetData = 0LL;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5253B & 1) == 0 )
  {
    sub_1B863B8(&System_Action_int__TypeInfo, *(_QWORD *)&eventId);
    sub_1B863B8(&Method_DataManager_GetMasterData_EventBoardGameTokenMaster___, v4);
    sub_1B863B8(&Method_DataManager_GetMasterData_UserEventBoardGameTokenMaster___, v5);
    sub_1B863B8(&Method_EventBoardGameTokenManager_checkTokenInfo__, v6);
    sub_1B863B8(&Method_UnityEngine_GameObject_GetComponent_EventBoardGameTokenItem___, v7);
    sub_1B863B8(&Method_System_Collections_Generic_List_EventBoardGameTokenItem__Add__, v8);
    sub_1B863B8(&Method_System_Collections_Generic_List_EventBoardGameTokenItem___ctor__, v9);
    sub_1B863B8(&System_Collections_Generic_List_EventBoardGameTokenItem__TypeInfo, v10);
...
LABEL_37:
  ...
  MasterData_object = DataManager__GetMasterData_object_(
                        ...
                        (const MethodInfo_2F6DCB8 *)Method_DataManager_GetMasterData_EventBoardGameTokenMaster___);
  v17 = (System_Collections_Generic_List_object__o *)sub_1B86604(System_Collections_Generic_List_EventBoardGameTokenItem__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v17,
    (const MethodInfo_35FC124 *)Method_System_Collections_Generic_List_EventBoardGameTokenItem___ctor__);
  this->fields.tokenList = (struct System_Collections_Generic_List_EventBoardGameTokenItem__o *)v17;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.tokenList, (int32_t)v17, v18, v19);
  v20 = 0;
  v21 = 11;
  v22 = 1;
  v23 = 1;
  ...
  do
  {
    ...
    Instance = (__int64)UnityEngine_GameObject__GetComponent_object_(
                          ...
                          (const MethodInfo_2FC0DF0 *)Method_UnityEngine_GameObject_GetComponent_EventBoardGameTokenItem___);
    ...
    v35 = DataManager__GetMasterData_object_(
            (DataManager_o *)Instance,
            (const MethodInfo_2F6DCB8 *)Method_DataManager_GetMasterData_UserEventBoardGameTokenMaster___);
    if ( v35 )
...
LABEL_23:
    ...
    *(_QWORD *)(v32 + 80) = eventUIDownloadAtlas;
    sub_1B8635C((CGThumbnailListItem_o *)(v32 + 80), (int32_t)eventUIDownloadAtlas, v33, v34);
    v38 = entity;
    v39 = (System_Action_int__o *)sub_1B86604(System_Action_int__TypeInfo);
    ...
    else
    {
      ...
      *(_QWORD *)(v46 + 32) = v32;
      sub_1B8635C((CGThumbnailListItem_o *)(v46 + 32), v32, v41, v42);
    }
    ...
    if ( !byte_4A487E6 )
    {
      Instance = sub_1B863B8(&UnityEngine_Vector3_TypeInfo, v15);
      byte_4A487E6 = 1;
    }
    if ( !v48 )
      goto LABEL_37;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5253C & 1) == 0 )
  {
    sub_1B863B8(&Method_UnityEngine_GameObject_GetComponent_EventBoardGameTokenInfoDialog___, *(_QWORD *)&tokenId);
    sub_1B863B8(&Method_System_Collections_Generic_List_EventBoardGameTokenItem__get_Item__, v5);
  ...
  if ( UnityEngine_Object__op_Equality(tokenInfoDialog, 0LL, 0LL) )
  {
    ...
    if ( !Menu
      || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                               ...
                               (const MethodInfo_2FC0DF0 *)Method_UnityEngine_GameObject_GetComponent_EventBoardGameTokenInfoDialog___),
          this->fields.tokenInfoDialog = (struct EventBoardGameTokenInfoDialog_o *)Component_object,
          sub_1B8635C((CGThumbnailListItem_o *)&this->fields.tokenInfoDialog, (int32_t)Component_object, v12, v13),
...
LABEL_12:
    ...
    *((_QWORD *)Menu + 17) = eventUIDownloadAtlas;
    sub_1B8635C((CGThumbnailListItem_o *)Menu + 1, (int32_t)eventUIDownloadAtlas, v14, v15);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(v4, 0LL, 0LL) )
  {
    ...
    *p_tokenInfoDialog = 0LL;
    sub_1B8635C((CGThumbnailListItem_o *)p_tokenInfoDialog, 0, v8, v9);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A52545 & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_23815/*"token_bg"*/, method);
    byte_4A52545 = 1;
  }
  ...
  if ( !_4__this
    || (EventBoardGameTokenManager__SetEventUI(
          ...
          (System_String_o *)StringLiteral_23815/*"token_bg"*/,
          v2),
