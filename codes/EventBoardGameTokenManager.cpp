...
void __fastcall EventBoardGameTokenManager__Awake(EventBoardGameTokenManager_o *this, const MethodInfo *method)
{
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.eventUILoadCallbackFunc, 0, v2, v3);
  this->fields.eventUIAssetData = 0LL;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.eventUIAssetData, 0, v5, v6);
  this->fields.eventUIDownloadAtlas = 0LL;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.eventUIDownloadAtlas, 0, v7, v8);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02150 & 1) == 0 )
  {
    ...
    this = (EventBoardGameTokenManager_o *)sub_1B64870(&Method_UnityEngine_GameObject_GetComponent_UIAtlas___, v7);
    byte_4A02150 = 1;
  }
  if ( !assetData )
    goto LABEL_9;
  ...
  {
    this = (EventBoardGameTokenManager_o *)AssetData__GetObject_object__48356600(
                                             assetData,
                                             name,
...
void __fastcall EventBoardGameTokenManager__DestoryList(EventBoardGameTokenManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0214D & 1) == 0 )
  {
    sub_1B64870(&Method_System_Collections_Generic_List_EventBoardGameTokenItem__get_Item__, method);
  ...
  if ( tokenList )
  {
    ...
    while ( 1 )
    {
      Item = System_Collections_Generic_List_object___get_Item(
               tokenList,
               v6,
               (const MethodInfo_34AF6E0 *)Method_System_Collections_Generic_List_EventBoardGameTokenItem__get_Item__);
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)Item, 0LL, 0LL) )
      {
        ...
        if ( !*p_tokenList
          || (tokenList = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___get_Item(
                                                                         tokenList,
                                                                         v6,
                                                                         (const MethodInfo_34AF6E0 *)Method_System_Collections_Generic_List_EventBoardGameTokenItem__get_Item__)) == 0LL )
        {
LABEL_13:
          sub_1B64ACC(tokenList, v8);
        }
    ...
    sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.tokenList, 0, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02148 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_EventBoardGameTokenManager___c__DisplayClass18_0__Init_b__0__, v5);
    sub_1B64870(&EventBoardGameTokenManager___c__DisplayClass18_0_TypeInfo, v6);
    byte_4A02148 = 1;
  }
  v7 = sub_1B64ABC(EventBoardGameTokenManager___c__DisplayClass18_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0214E & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_EventBoardGameTokenManager_LoadEventUIEnd__, v8);
    sub_1B64870(&AssetLoader_LoadEndDataHandler_TypeInfo, v9);
    sub_1B64870(&StringLiteral_6202/*"EventUI/Prefabs/80285"*/, v10);
    byte_4A0214E = 1;
  }
...
LABEL_9:
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.eventUILoadCallbackFunc, (int32_t)v14, v15, v16);
  if ( !this->fields.isEventUILoad )
  {
    ...
    if ( !AssetManager__loadAssetStorage((System_String_o *)StringLiteral_6202/*"EventUI/Prefabs/80285"*/, v18, loadParallelMax, 0LL) )
    {
      this->fields.isEventUILoad = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0214F & 1) == 0 )
  {
    sub_1B64870(&StringLiteral_5353/*"DownloadEventUIAtlas8028500"*/, assetData);
    byte_4A0214F = 1;
  }
  if ( this->fields.isEventUILoad )
  {
  ...
  if ( eventUILoadCallbackFunc )
  {
    ...
    sub_1B64814(p_eventUILoadCallbackFunc, 0, (int32_t)method, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02151 & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_6202/*"EventUI/Prefabs/80285"*/, v5);
    byte_4A02151 = 1;
  }
  if ( this->fields.isEventUILoad )
  {
  ...
  else
  {
    ...
    if ( eventUIAssetData )
    {
      if ( !AssetManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
      AssetManager__releaseAsset_37481844(eventUIAssetData, 0LL);
    }
  }
  this->fields.eventUIDownloadAtlas = 0LL;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.eventUIDownloadAtlas, 0, v2, v3);
  this->fields.eventUIAssetData = 0LL;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02149 & 1) == 0 )
  {
    sub_1B64870(&System_Action_int__TypeInfo, *(_QWORD *)&eventId);
    sub_1B64870(&Method_DataManager_GetMasterData_EventBoardGameTokenMaster___, v4);
    sub_1B64870(&Method_DataManager_GetMasterData_UserEventBoardGameTokenMaster___, v5);
    sub_1B64870(&Method_EventBoardGameTokenManager_checkTokenInfo__, v6);
    sub_1B64870(&Method_UnityEngine_GameObject_GetComponent_EventBoardGameTokenItem___, v7);
    sub_1B64870(&Method_System_Collections_Generic_List_EventBoardGameTokenItem__Add__, v8);
    sub_1B64870(&Method_System_Collections_Generic_List_EventBoardGameTokenItem___ctor__, v9);
    sub_1B64870(&System_Collections_Generic_List_EventBoardGameTokenItem__TypeInfo, v10);
...
LABEL_37:
  ...
  MasterData_object = DataManager__GetMasterData_object_(
                        ...
                        (const MethodInfo_2E3B6C8 *)Method_DataManager_GetMasterData_EventBoardGameTokenMaster___);
  v17 = (System_Collections_Generic_List_object__o *)sub_1B64ABC(System_Collections_Generic_List_EventBoardGameTokenItem__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v17,
    (const MethodInfo_34AF17C *)Method_System_Collections_Generic_List_EventBoardGameTokenItem___ctor__);
  this->fields.tokenList = (struct System_Collections_Generic_List_EventBoardGameTokenItem__o *)v17;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.tokenList, (int32_t)v17, v18, v19);
  v20 = 0;
  v21 = 11;
  v22 = 1;
  v23 = 1;
  ...
  do
  {
    ...
    Instance = (__int64)UnityEngine_GameObject__GetComponent_object_(
                          ...
                          (const MethodInfo_2E8A1B4 *)Method_UnityEngine_GameObject_GetComponent_EventBoardGameTokenItem___);
    ...
    v35 = DataManager__GetMasterData_object_(
            (DataManager_o *)Instance,
            (const MethodInfo_2E3B6C8 *)Method_DataManager_GetMasterData_UserEventBoardGameTokenMaster___);
    if ( v35 )
...
LABEL_23:
    ...
    *(_QWORD *)(v32 + 80) = eventUIDownloadAtlas;
    sub_1B64814((ServantStatusBattleListViewItem_o *)(v32 + 80), (int32_t)eventUIDownloadAtlas, v33, v34);
    v38 = entity;
    v39 = (System_Action_int__o *)sub_1B64ABC(System_Action_int__TypeInfo);
    ...
    else
    {
      ...
      *(_QWORD *)(v46 + 32) = v32;
      sub_1B64814((ServantStatusBattleListViewItem_o *)(v46 + 32), v32, v41, v42);
    }
    ...
    if ( !byte_49F9206 )
    {
      Instance = sub_1B64870(&UnityEngine_Vector3_TypeInfo, v15);
      byte_49F9206 = 1;
    }
    if ( !v48 )
      goto LABEL_37;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0214A & 1) == 0 )
  {
    sub_1B64870(&Method_UnityEngine_GameObject_GetComponent_EventBoardGameTokenInfoDialog___, *(_QWORD *)&tokenId);
    sub_1B64870(&Method_System_Collections_Generic_List_EventBoardGameTokenItem__get_Item__, v5);
  ...
  if ( UnityEngine_Object__op_Equality(tokenInfoDialog, 0LL, 0LL) )
  {
    ...
    if ( !Menu
      || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                               ...
                               (const MethodInfo_2E8A1B4 *)Method_UnityEngine_GameObject_GetComponent_EventBoardGameTokenInfoDialog___),
...
LABEL_12:
    ...
    *((_QWORD *)Menu + 16) = eventUIDownloadAtlas;
    sub_1B64814((ServantStatusBattleListViewItem_o *)(Menu + 128), (int32_t)eventUIDownloadAtlas, v14, v15);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(v4, 0LL, 0LL) )
  {
    ...
    *p_tokenInfoDialog = 0LL;
    sub_1B64814((ServantStatusBattleListViewItem_o *)p_tokenInfoDialog, 0, v8, v9);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02153 & 1) == 0 )
  {
    sub_1B64870(&StringLiteral_23882/*"token_bg"*/, method);
    byte_4A02153 = 1;
  }
  ...
  if ( !_4__this
    || (EventBoardGameTokenManager__SetEventUI(
          ...
          (System_String_o *)StringLiteral_23882/*"token_bg"*/,
          v2),
