...
void BattleSelectServantWindow__OnClickClassBoardWindow(BattleSelectServantWindow_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2FFCB & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_BattleSelectServantWindow_EndCloseClassBoardEffectListDialog__);
    sub_1C94098(&Method_BattleSelectServantWindow_OnClickClassBoardWindow__);
  ...
  if ( !this->fields.isOpenClassBoardEffectListDialog )
  {
    ...
    if ( (*((_BYTE *)Method_BattleSelectServantWindow_OnClickClassBoardWindow__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1C940B0(Method_BattleSelectServantWindow_OnClickClassBoardWindow__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2FFC5 & 1) == 0 )
  {
    sub_1C94098(&Method_BattleSelectServantWindow_onCloseButton__);
  ...
  v7 = (BattleWindowOuterClickComponent_OuterClickCall_o *)sub_1C942E4(BattleWindowOuterClickComponent_OuterClickCall_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2FFC9 & 1) == 0 )
  {
    sub_1C94098(&Method_BattleSelectServantWindow_SelectServant__);
    byte_4D2FFC9 = 1;
  }
  if ( !this->fields.isSelected )
  {
    ...
    if ( (*((_BYTE *)Method_BattleSelectServantWindow_SelectServant__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1C940B0(Method_BattleSelectServantWindow_SelectServant__);
        ...
        const MethodInfo *method)
{
  ...
  bool IsQuestClear_41072884; // [xsp+20h] [xbp-70h]
  ...
  if ( (byte_4D2FFC7 & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_2747/*"BATTLE_DIALOG_SELECT_SERVANT"*/);
    sub_1C94098(&StringLiteral_2740/*"BATTLE_DIALOG_NOT_SELECT_TARGET"*/);
    byte_4D2FFC7 = 1;
  }
  ...
  gameObject = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_2747/*"BATTLE_DIALOG_SELECT_SERVANT"*/, 0);
  if ( !title_label )
    goto LABEL_108;
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( v22 < max_length )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      gameObject = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_2740/*"BATTLE_DIALOG_NOT_SELECT_TARGET"*/, 0);
      if ( !v23 )
        goto LABEL_108;
...
LABEL_28:
  ...
  if ( !gameObject )
    goto LABEL_108;
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)gameObject, IsQuestClear_41072884, 0);
  if ( v8 )
  {
  ...
  while ( 1 )
  {
    ...
    if ( (gameObject & 1) == 0 )
    {
      ...
      else
      {
        ...
        if ( gameObject )
        {
          gameObject = sub_1C941D4(gameObject, *(_QWORD *)(*(_QWORD *)v41 + 64LL));
          if ( !gameObject )
          {
            v64 = sub_1C94314(0);
            sub_1C941C0(v64, 0);
        ...
        if ( v33 >= v41[6] )
          goto LABEL_111;
        *((_QWORD *)v43 + 4) = v54;
        sub_1C9403C((GrandQuestFolderBoardItem_o *)&v41[v34], v54, v48, v49, v50, v51, v52, v53);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1ACC740;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1ACC6F8;
}
