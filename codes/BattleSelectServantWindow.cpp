        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A30EF6 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_BattleSelectServantWindow_EndCloseClassBoardEffectListDialog__, v3);
    sub_1B761C0(&Method_BattleSelectServantWindow_OnClickClassBoardWindow__, v4);
  ...
  if ( !this->fields.isOpenClassBoardEffectListDialog )
  {
    ...
    if ( (*((_BYTE *)Method_BattleSelectServantWindow_OnClickClassBoardWindow__ + 83) & 2) != 0 )
      v7 = (_QWORD *)sub_1B761D8(Method_BattleSelectServantWindow_OnClickClassBoardWindow__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A30EF0 & 1) == 0 )
  {
    sub_1B761C0(&Method_BattleSelectServantWindow_onCloseButton__, call);
  ...
  v8 = (BattleWindowOuterClickComponent_OuterClickCall_o *)sub_1B7640C(BattleWindowOuterClickComponent_OuterClickCall_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A30EF4 & 1) == 0 )
  {
    sub_1B761C0(&Method_BattleSelectServantWindow_SelectServant__, *(_QWORD *)&uniqeId);
    byte_4A30EF4 = 1;
  }
  if ( !this->fields.isSelected )
  {
    ...
    if ( (*((_BYTE *)Method_BattleSelectServantWindow_SelectServant__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B761D8(Method_BattleSelectServantWindow_SelectServant__);
        ...
        const MethodInfo *method)
{
  ...
  bool IsQuestClear_37418488; // [xsp+2Ch] [xbp-64h]
  ...
  if ( (byte_4A30EF2 & 1) == 0 )
  {
    sub_1B761C0(&BalanceConfig_TypeInfo, svtList);
    sub_1B761C0(&Method_UnityEngine_Component_GetComponent_UIButton___, v8);
    ...
    sub_1B761C0(&StringLiteral_2868/*"BATTLE_DIALOG_SELECT_SERVANT"*/, v13);
    sub_1B761C0(&StringLiteral_2861/*"BATTLE_DIALOG_NOT_SELECT_TARGET"*/, v14);
    byte_4A30EF2 = 1;
  }
  this->fields.svtList = v6;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.svtList, (int32_t)v6, skillId, commandSpellId);
...
LABEL_22:
  ...
  if ( !gameObject )
    goto LABEL_90;
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)gameObject, IsQuestClear_37418488, 0LL);
  ...
  while ( 1 )
  {
    ...
    if ( (gameObject & 1) == 0 )
    {
      ...
      else
      {
        ...
        if ( gameObject )
        {
          gameObject = sub_1B762FC(gameObject, v38->obj.klass->_1.element_class);
          if ( !gameObject )
          {
            v56 = sub_1B76440(0LL);
            sub_1B762E8(v56, 0LL);
        ...
        sub_1B76164((ServantStatusBattleListViewItem_o *)((char *)v38 + v30), v47, v45, v46);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19C0DF0;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19C0DA8;
}
