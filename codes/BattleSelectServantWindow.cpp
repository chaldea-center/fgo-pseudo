        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B054C7 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_BattleSelectServantWindow_EndCloseClassBoardEffectListDialog__, v3);
    sub_1BC3008(&Method_BattleSelectServantWindow_OnClickClassBoardWindow__, v4);
  ...
  if ( !this->fields.isOpenClassBoardEffectListDialog )
  {
    ...
    v9 = Method_BattleSelectServantWindow_OnClickClassBoardWindow__;
    if ( (*((_BYTE *)Method_BattleSelectServantWindow_OnClickClassBoardWindow__ + 83) & 2) != 0 )
      v9 = (_QWORD *)sub_1BC3020(Method_BattleSelectServantWindow_OnClickClassBoardWindow__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B054C1 & 1) == 0 )
  {
    sub_1BC3008(&Method_BattleSelectServantWindow_onCloseButton__, call);
  ...
  v8 = (BattleWindowOuterClickComponent_OuterClickCall_o *)sub_1BC3254(BattleWindowOuterClickComponent_OuterClickCall_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B054C5 & 1) == 0 )
  {
    sub_1BC3008(&Method_BattleSelectServantWindow_SelectServant__, *(_QWORD *)&uniqeId);
    byte_4B054C5 = 1;
  }
  if ( !this->fields.isSelected )
  {
    ...
    if ( (*((_BYTE *)Method_BattleSelectServantWindow_SelectServant__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1BC3020(Method_BattleSelectServantWindow_SelectServant__);
        ...
        const MethodInfo *method)
{
  ...
  UIButtonColor_o *v36; // x26
  struct UITexture_array *v37; // x8
  signed __int64 v38; // x19
  struct UITexture_array *v39; // x25
  BattleServantData_o *v40; // x27
  UnityEngine_Object_c **v41; // x23
  Il2CppClass **v42; // x21
  UITexture_o *v43; // x28
  ...
  bool IsQuestClear_39366056; // [xsp+2Ch] [xbp-64h]
  ...
  if ( (byte_4B054C3 & 1) == 0 )
  {
    sub_1BC3008(&BalanceConfig_TypeInfo, svtList);
    sub_1BC3008(&Method_UnityEngine_Component_GetComponent_UIButton___, v8);
    ...
    sub_1BC3008(&StringLiteral_2733/*"BATTLE_DIALOG_SELECT_SERVANT"*/, v13);
    sub_1BC3008(&StringLiteral_2726/*"BATTLE_DIALOG_NOT_SELECT_TARGET"*/, v14);
    byte_4B054C3 = 1;
  }
  ...
  gameObject = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_2733/*"BATTLE_DIALOG_SELECT_SERVANT"*/, 0LL);
  if ( !title_label )
    goto LABEL_90;
  ...
  if ( max_length >= 1 )
  {
    ...
    {
      v22 = notTargetLabelList->m_Items[v21];
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      gameObject = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_2726/*"BATTLE_DIALOG_NOT_SELECT_TARGET"*/, 0LL);
      if ( !v22 )
        goto LABEL_90;
      UILabel__set_text(v22, (System_String_o *)gameObject, 0LL);
      gameObject = (__int64)UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)v22, 0LL);
      if ( !gameObject )
        goto LABEL_90;
...
LABEL_93:
    sub_1BC326C(gameObject, v17, v18);
  }
LABEL_15:
  commandSpellAddFunctionLabels = this->fields.commandSpellAddFunctionLabels;
  if ( !commandSpellAddFunctionLabels )
    goto LABEL_90;
  v24 = commandSpellAddFunctionLabels->max_length;
  if ( v24 >= 1 )
  {
    v25 = 0;
    while ( v25 < v24 )
    {
      gameObject = (__int64)commandSpellAddFunctionLabels->m_Items[v25];
      if ( !gameObject )
        goto LABEL_90;
...
LABEL_22:
  ...
  if ( !gameObject )
    goto LABEL_90;
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)gameObject, IsQuestClear_39366056, 0LL);
  ...
  while ( 1 )
  {
    v33 = servantTop->max_length;
    if ( (__int64)v30 >= (int)v33 )
      break;
    if ( v30 >= v33 )
      goto LABEL_93;
    v34 = (UnityEngine_Object_o *)servantTop->m_Items[v30];
    if ( !(*v29)->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(*v29);
    gameObject = UnityEngine_Object__op_Equality(v34, 0LL, 0LL);
    if ( (gameObject & 1) == 0 )
    {
      v35 = this->fields.servantTop;
      if ( !v35 )
        goto LABEL_90;
      if ( v30 >= v35->max_length )
        goto LABEL_93;
      gameObject = (__int64)v35->m_Items[v30];
      if ( !gameObject )
        goto LABEL_90;
      ...
      v63.fields.b = 1.0;
      v63.fields.a = 1.0;
      v36 = (UIButtonColor_o *)gameObject;
      ...
      if ( v30 >= v37->max_length )
        goto LABEL_93;
      gameObject = (__int64)v37->m_Items[v30];
      if ( !gameObject )
        goto LABEL_90;
      ...
      if ( (__int64)v30 >= v38 )
      {
        ...
        if ( v30 >= v52->max_length )
          goto LABEL_93;
        gameObject = (__int64)v52->m_Items[v30];
        if ( !gameObject )
          goto LABEL_90;
        gameObject = (__int64)UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)gameObject, 0LL);
        if ( !gameObject )
      ...
      else
      {
        ...
        if ( !v40 )
          goto LABEL_90;
        v41 = v29;
        v42 = &v39->obj.klass + v30;
        v43 = (UITexture_o *)v42[4];
        DispImageSvtId = BattleServantData__GetDispImageSvtId(m_Items[v30], 0LL);
        DispLimitCount = BattleServantData__getDispLimitCount(v40, 1, 0LL);
        if ( !ServantAssetLoadManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(ServantAssetLoadManager_TypeInfo);
        gameObject = (__int64)ServantAssetLoadManager__loadStatusFace(v43, DispImageSvtId, DispLimitCount, 0LL);
        v47 = gameObject;
        if ( gameObject )
        {
          gameObject = sub_1BC3144(gameObject, v39->obj.klass->_1.element_class);
          if ( !gameObject )
          {
            v56 = sub_1BC3288(0LL);
            sub_1BC3130(v56, 0LL);
        ...
        if ( v30 >= v39->max_length )
          goto LABEL_93;
        v42[4] = (Il2CppClass *)v47;
        sub_1BC2FAC((CGThumbnailListItem_o *)((char *)v39 + v31), v47, v18, v46);
        v48 = this->fields.servantTop;
        if ( !v48 )
          goto LABEL_90;
        if ( v30 >= v48->max_length )
          goto LABEL_93;
        gameObject = (__int64)v48->m_Items[v30];
        if ( !gameObject )
          goto LABEL_90;
        gameObject = (__int64)UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)gameObject, 0LL);
        if ( !gameObject )
        ...
        gameObject = BattleServantData__CheckNotTargetSkill(v40, skillId, 0LL);
        v29 = v41;
        v6 = v59;
        v32 = &qword_4AFB000;
        if ( (gameObject & 1) != 0 )
        {
          ...
          v64.fields.b = 0.5;
          v64.fields.a = 1.0;
          UIButtonColor__set_defaultColor(v36, v64, 0LL);
          v50 = this->fields.notTargetLabelList;
          if ( !v50 )
            goto LABEL_90;
          if ( v30 >= v50->max_length )
            goto LABEL_93;
          gameObject = (__int64)v50->m_Items[v30];
          if ( !gameObject )
            goto LABEL_90;
          gameObject = (__int64)UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)gameObject, 0LL);
          if ( !gameObject )
        ...
        if ( IsQuestClear_39366056 )
        {
          ...
          if ( v30 >= v51->max_length )
            goto LABEL_93;
          gameObject = (__int64)v51->m_Items[v30];
          if ( !gameObject )
            goto LABEL_90;
      ...
      if ( v30 >= v54->max_length )
        goto LABEL_93;
      gameObject = (__int64)v54->m_Items[v30];
      if ( !gameObject )
        goto LABEL_90;
      gameObject = (__int64)UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)gameObject, 0LL);
      if ( !gameObject )
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A11028;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A10FE0;
}
