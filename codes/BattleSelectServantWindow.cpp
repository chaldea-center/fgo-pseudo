...
void BattleSelectServantWindow__OnClickClassBoardWindow(BattleSelectServantWindow_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CF1D51 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_BattleSelectServantWindow_EndCloseClassBoardEffectListDialog__);
    sub_1C7BAE8(&Method_BattleSelectServantWindow_OnClickClassBoardWindow__);
  ...
  if ( !this->fields.isOpenClassBoardEffectListDialog )
  {
    ...
    if ( (*((_BYTE *)Method_BattleSelectServantWindow_OnClickClassBoardWindow__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1C7BB00(Method_BattleSelectServantWindow_OnClickClassBoardWindow__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF1D4B & 1) == 0 )
  {
    sub_1C7BAE8(&Method_BattleSelectServantWindow_onCloseButton__);
  ...
  v7 = (BattleWindowOuterClickComponent_OuterClickCall_o *)sub_1C7BD34(BattleWindowOuterClickComponent_OuterClickCall_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF1D4F & 1) == 0 )
  {
    sub_1C7BAE8(&Method_BattleSelectServantWindow_SelectServant__);
    byte_4CF1D4F = 1;
  }
  if ( !this->fields.isSelected )
  {
    ...
    if ( (*((_BYTE *)Method_BattleSelectServantWindow_SelectServant__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1C7BB00(Method_BattleSelectServantWindow_SelectServant__);
        ...
        const MethodInfo *method)
{
  ...
  bool IsQuestClear_40887944; // [xsp+20h] [xbp-70h]
  ...
  if ( (byte_4CF1D4D & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_2748/*"BATTLE_DIALOG_SELECT_SERVANT"*/);
    sub_1C7BAE8(&StringLiteral_2741/*"BATTLE_DIALOG_NOT_SELECT_TARGET"*/);
    byte_4CF1D4D = 1;
  }
...
LABEL_28:
  ...
  if ( !gameObject )
    goto LABEL_108;
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)gameObject, IsQuestClear_40887944, 0);
  if ( v8 )
  {
  ...
  while ( 1 )
  {
    ...
    if ( (gameObject & 1) == 0 )
    {
      ...
      else
      {
        ...
        if ( gameObject )
        {
          gameObject = sub_1C7BC24(gameObject, *(_QWORD *)(*(_QWORD *)v41 + 64LL));
          if ( !gameObject )
          {
            v64 = sub_1C7BD64(0);
            sub_1C7BC10(v64, 0);
        ...
        if ( v33 >= v41[6] )
          goto LABEL_111;
        *((_QWORD *)v43 + 4) = v54;
        sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&v41[v34], v54, v48, v49, v50, v51, v52, v53);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1AB566C;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1AB5624;
}
