        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2C5E3 & 1) == 0 )
  {
    this = (RestrictionNotSatisfySlotIcons_o *)sub_1C93AD4(&AtlasManager_TypeInfo);
    byte_4D2C5E3 = 1;
  }
  ...
  if ( classIcons )
  {
    if ( !classImageIds )
LABEL_26:
      sub_1C93D2C(this, classImageIds);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2C5E2 & 1) == 0 )
  {
    ...
    this = (RestrictionNotSatisfySlotIcons_o *)sub_1C93AD4(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4D2C5E2 = 1;
  }
  v33 = 0;
  entity = 0;
  ...
  if ( m_CachedPtr )
  {
    if ( servantIds )
    {
      ...
      do
      {
        ...
        this = (RestrictionNotSatisfySlotIcons_o *)DataManager__GetMaster_object_((const MethodInfo_31A49E8 *)Method_DataManager_GetMaster_ServantMaster___);
        ...
        if ( ((unsigned __int8)this & 1) != 0 )
        {
          this = (RestrictionNotSatisfySlotIcons_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3AC52FC *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
          if ( !this )
            break;
          ...
          this = (RestrictionNotSatisfySlotIcons_o *)QuestRestrictionInfo__ConvertOverwriteImageLimitCount_44133520(
