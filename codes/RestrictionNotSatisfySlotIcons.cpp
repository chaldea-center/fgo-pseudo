        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1BC34 & 1) == 0 )
  {
    this = (RestrictionNotSatisfySlotIcons_o *)sub_1B715CC(&AtlasManager_TypeInfo, classImageIds);
    byte_4A1BC34 = 1;
  }
  ...
  if ( classIcons )
  {
    if ( !classImageIds )
LABEL_26:
      sub_1B71828(this, classImageIds);
...
LABEL_42:
      sub_1B71830(this, classImageIds);
    }
  }
LABEL_34:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1BC33 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataManager_GetMasterData_UserServantMaster___, servantIds);
    ...
    this = (RestrictionNotSatisfySlotIcons_o *)sub_1B715CC(
      ...
      else
      {
        ...
        if ( v22 )
        {
          ...
          if ( questRestrictionInfo )
          {
            ...
            this = (RestrictionNotSatisfySlotIcons_o *)DataManager__GetMaster_object_((const MethodInfo_2E5B394 *)Method_DataManager_GetMaster_ServantMaster___);
            ...
            if ( ((unsigned __int8)this & 1) != 0 )
            {
              this = (RestrictionNotSatisfySlotIcons_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
              if ( !this )
                goto LABEL_82;
              ...
              this = (RestrictionNotSatisfySlotIcons_o *)QuestRestrictionInfo__ConvertOverwriteImageLimitCount_40238488(
