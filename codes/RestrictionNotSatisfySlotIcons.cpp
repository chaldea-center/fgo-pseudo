        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2309B & 1) == 0 )
  {
    this = (RestrictionNotSatisfySlotIcons_o *)sub_1C2D490(&AtlasManager_TypeInfo);
    byte_4C2309B = 1;
  }
  ...
  if ( classIcons )
  {
    if ( !classImageIds )
LABEL_26:
      sub_1C2D6EC(this, classImageIds);
...
LABEL_42:
      sub_1C2D6F4(this, classImageIds, method);
    }
  }
LABEL_34:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2309A & 1) == 0 )
  {
    ...
    this = (RestrictionNotSatisfySlotIcons_o *)sub_1C2D490(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4C2309A = 1;
  }
  v33 = 0;
  entity = 0;
  ...
  if ( m_CachedPtr )
  {
    if ( servantIds )
    {
      ...
      do
      {
        ...
        this = (RestrictionNotSatisfySlotIcons_o *)DataManager__GetMaster_object_((const MethodInfo_30CE8FC *)Method_DataManager_GetMaster_ServantMaster___);
        ...
        if ( ((unsigned __int8)this & 1) != 0 )
        {
          this = (RestrictionNotSatisfySlotIcons_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39D3CCC *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
          if ( !this )
            break;
          ...
          this = (RestrictionNotSatisfySlotIcons_o *)QuestRestrictionInfo__ConvertOverwriteImageLimitCount_43203860(
...
LABEL_90:
      sub_1C2D6F4(this, servantIds, limitCounts);
    }
  }
LABEL_87:
