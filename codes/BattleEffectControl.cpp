        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AECFE & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_21351/*"obj_treasure_item_bound"*/);
    sub_B52984(&StringLiteral_18393/*"effect/obj_treasure_item01"*/);
    sub_B52984(&StringLiteral_2788/*"Battle/DropEffect/1"*/);
    byte_42AECFE = 1;
  }
  if ( dropEffectType == 1 )
  {
    ...
    AssetStorage = AssetManager__getAssetStorage((System_String_o *)StringLiteral_2788/*"Battle/DropEffect/1"*/, 0LL);
    if ( !AssetStorage )
      sub_B52A5C(0LL, v9);
    Object_WarBoardWaitTimeSetting = (UnityEngine_GameObject_o *)AssetData__GetObject_WarBoardWaitTimeSetting_(
                                                                   AssetStorage,
                                                                   (System_String_o *)StringLiteral_21351/*"obj_treasure_item_bound"*/,
  ...
  {
    return BaseMonoBehaviour__createObject_19346208(
             (BaseMonoBehaviour_o *)this,
             (System_String_o *)StringLiteral_18393/*"effect/obj_treasure_item01"*/,
             rootTr,
             0LL,
             0LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AECFF & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_18396/*"effect/obj_treasure{0:D2}"*/);
    sub_B52984(&StringLiteral_2788/*"Battle/DropEffect/1"*/);
    sub_B52984(&StringLiteral_21352/*"obj_treasure{0:D2}_bound"*/);
    byte_42AECFF = 1;
  }
  if ( dropEffectType == 1 )
  {
    ...
    v14 = System_String__Format((System_String_o *)StringLiteral_21352/*"obj_treasure{0:D2}_bound"*/, v13, 0LL);
    if ( !AssetStorage )
      sub_B52A5C(v14, v15);
    Object_WarBoardWaitTimeSetting = (UnityEngine_GameObject_o *)AssetData__GetObject_WarBoardWaitTimeSetting_(
                                                                   AssetStorage,
  ...
  else
  {
    ...
    v10 = System_String__Format((System_String_o *)StringLiteral_18396/*"effect/obj_treasure{0:D2}"*/, v9, 0LL);
    return BaseMonoBehaviour__createObject_19346208((BaseMonoBehaviour_o *)this, v10, rootTr, 0LL, 0LL);
  }
}
...
void __fastcall BattleEffectControl__Start(BattleEffectControl_o *this, const MethodInfo *method)
{
  ...
  if ( !v12 )
    goto LABEL_60;
  Spawner__Precache_26148020(v12, (UnityEngine_Object_o *)EffectList->m_Items[2], 5, 0LL);
  ...
  if ( !v12 )
    goto LABEL_60;
  Spawner__Precache_26148020(v12, (UnityEngine_Object_o *)v15->m_Items[3], 5, 0LL);
  ...
  if ( !v12 )
    goto LABEL_60;
  Spawner__Precache_26148020(v12, (UnityEngine_Object_o *)v16->m_Items[4], 50, 0LL);
  ...
  if ( !v12 )
    goto LABEL_60;
  Spawner__Precache_26148020(v12, (UnityEngine_Object_o *)v17->m_Items[6], 3, 0LL);
  ...
  if ( !v12 )
    goto LABEL_60;
  Spawner__Precache_26148020(v12, (UnityEngine_Object_o *)v18->m_Items[7], 5, 0LL);
  ...
  if ( !v12 )
    goto LABEL_60;
  Spawner__Precache_26148020(v12, (UnityEngine_Object_o *)v19->m_Items[9], 50, 0LL);
  ...
  if ( !v12 )
    goto LABEL_60;
  Spawner__Precache_26148020(v12, (UnityEngine_Object_o *)damageObjectlist->m_Items[0], 5, 0LL);
  ...
  if ( !v12 )
    goto LABEL_60;
  Spawner__Precache_26148020(v12, (UnityEngine_Object_o *)v21->m_Items[1], 5, 0LL);
  ...
  if ( !v12 )
    goto LABEL_60;
  Spawner__Precache_26148020(v12, (UnityEngine_Object_o *)v22->m_Items[2], 5, 0LL);
...
LABEL_62:
  ...
  if ( !v12 )
    goto LABEL_60;
  Spawner__Precache_26148020(v12, (UnityEngine_Object_o *)v23->m_Items[3], 5, 0LL);
  ...
  while ( 1 )
  {
    ...
    if ( ((unsigned __int8)v12 & 1) == 0 )
    {
      ...
      if ( !*p_spawner )
        goto LABEL_60;
      Spawner__Precache_26148020(v12, v27, 5, 0LL);
    }
    buffTextObjectlist = this->fields.buffTextObjectlist;
    ++v25;
    if ( !buffTextObjectlist )
...
LABEL_60:
  ...
  while ( 1 )
  {
    ...
    if ( ((unsigned __int8)v12 & 1) == 0 )
    {
      ...
      if ( !*p_spawner )
        goto LABEL_60;
      Spawner__Precache_26148020(v12, v31, 5, 0LL);
    }
    buffTextClassIconObjectList = this->fields.buffTextClassIconObjectList;
    ++v29;
    if ( !buffTextClassIconObjectList )
    ...
    if ( (int)v5 < max_length )
    {
      ...
      if ( spawner )
      {
        buffTextClassIconObjectList = (struct UnityEngine_GameObject_array *)((char *)buffTextClassIconObjectList
                                                                            + 8 * v5);
        return Spawner__Spawn_26148380(spawner, (UnityEngine_Object_o *)buffTextClassIconObjectList->m_Items[0], 0LL);
      }
LABEL_10:
      sub_B52A5C(spawner, color);
    }
    if ( max_length >= 1 )
    {
      spawner = this->fields.spawner;
  ...
  if ( buffTextObjectlist )
  {
    ...
    if ( (int)v5 < max_length )
    {
      ...
      if ( spawner )
      {
        ...
        return Spawner__Spawn_26148380(spawner, (UnityEngine_Object_o *)buffTextObjectlist->m_Items[0], 0LL);
      }
LABEL_10:
      sub_B52A5C(spawner, color);
    }
    ...
    if ( week )
    {
      if ( damageObjectlist )
      {
        ...
        if ( spawner )
        {
          ...
          return Spawner__Spawn_26148380(spawner, *m_Items, 0LL);
        }
      }
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( max_length > id )
  {
    ...
    if ( this )
      return Spawner__Spawn_26148380((Spawner_o *)this, (UnityEngine_Object_o *)EffectList->m_Items[id], 0LL);
LABEL_8:
    sub_B52A5C(this, id);
  }
  return 0LL;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AECFD & 1) == 0 )
  {
    sub_B52984(&StringLiteral_18394/*"effect/obj_treasure_p"*/);
    sub_B52984(&StringLiteral_22969/*"treasure"*/);
    this = (BattleEffectControl_o *)sub_B52984(&StringLiteral_18395/*"effect/obj_treasure_pp"*/);
    byte_42AECFD = 1;
  }
  if ( !dropInfo )
    goto LABEL_16;
  ...
  if ( rarity < 1000 )
  {
    ...
    if ( this )
    {
      ...
      NodeFromName = TransformHelper__getNodeFromName(transform, (System_String_o *)StringLiteral_22969/*"treasure"*/, 0, 0LL);
...
LABEL_16:
  ...
  NodeFromName = TransformHelper__getNodeFromName(v13, (System_String_o *)StringLiteral_22969/*"treasure"*/, 0, 0LL);
  if ( rarity == 1002 )
  {
LABEL_13:
    v14 = &StringLiteral_18395/*"effect/obj_treasure_pp"*/;
    goto LABEL_14;
  }
  if ( rarity == 1001 )
  {
LABEL_12:
    v14 = &StringLiteral_18394/*"effect/obj_treasure_p"*/;
LABEL_14:
    BaseMonoBehaviour__createObject_19346208((BaseMonoBehaviour_o *)v8, (System_String_o *)*v14, NodeFromName, 0LL, 0LL);
  }
  return v10;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AECFC & 1) == 0 )
  {
    sub_B52984(&Method_UnityEngine_GameObject_GetComponent_BattleServantBuffIconComponent___);
    sub_B52984(&UnityEngine_GameObject_TypeInfo);
    byte_42AECFC = 1;
  }
  if ( !bufflist || !*(_QWORD *)&bufflist->max_length )
    return 0LL;
  v5 = (UnityEngine_GameObject_o *)sub_B52A54(UnityEngine_GameObject_TypeInfo);
  UnityEngine_GameObject___ctor_41491372(v5, 0LL);
      ...
      if ( !Object
        || (v14 = Object,
            (Object = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                    Object,
                                                    (const MethodInfo_1B7B1B8 *)Method_UnityEngine_GameObject_GetComponent_BattleServantBuffIconComponent___)) == 0LL)
        || (BattleServantBuffIconComponent__setIcon_21059808((BattleServantBuffIconComponent_o *)Object, v11, 0LL),
