void __fastcall ServantStatusFriendshipGauge___cctor(const MethodInfo *method)
{
  if ( (byte_42B586C & 1) == 0 )
  {
    sub_B52984(&ServantStatusFriendshipGauge_TypeInfo);
    byte_42B586C = 1;
  }
...
void __fastcall ServantStatusFriendshipGauge___ctor(ServantStatusFriendshipGauge_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B586B & 1) == 0 )
  {
    sub_B52984(&UISlider___TypeInfo);
    byte_42B586B = 1;
  }
  v3 = (struct UISlider_array *)sub_B5299C(UISlider___TypeInfo, 10LL);
  ...
  sub_B52920(
    ...
    v8,
    v9);
  v10 = (struct UISlider_array *)sub_B5299C(UISlider___TypeInfo, 10LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( !gaugeSliderList )
LABEL_22:
    sub_B52A5C(this, *(_QWORD *)&currentRank);
  v8 = this;
  v10 = 0LL;
  while ( 1 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B586A & 1) == 0 )
  {
    this = (ServantStatusFriendshipGauge_o *)sub_B52984(&ServantStatusFriendshipGauge_TypeInfo);
    byte_42B586A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B5867 & 1) == 0 )
  {
    ...
    sub_B52984(&BalanceConfig_TypeInfo);
    this = (ServantStatusFriendshipGauge_o *)sub_B52984(&StringLiteral_19597/*"img_bondsgage_11"*/);
    byte_42B5867 = 1;
  }
...
LABEL_18:
  ...
  if ( v12->static_fields->DisableFriendshipExceed <= 0 )
  {
    ...
    AtlasManager__SetBondAtlasImage(overLimitGaugeSprite, (System_String_o *)StringLiteral_19597/*"img_bondsgage_11"*/, 0LL);
  }
}
...
LABEL_24:
  ...
  NumberFormat = LocalizationManager__Get((System_String_o *)StringLiteral_14814/*"UNIT_REST_NONE"*/, 0LL);
LABEL_20:
  v15 = NumberFormat;
  if ( !latePointLabel )
    goto LABEL_24;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B52A5C(nomalGaugeContainer, isOverLimit);
  }
  UnityEngine_GameObject__SetActive(nomalGaugeContainer, isOverLimit, 0LL);
}