void __fastcall ServantStatusFriendshipGauge___cctor(const MethodInfo *method)
{
  if ( (byte_4A5756C & 1) == 0 )
  {
    sub_1B885B0(&ServantStatusFriendshipGauge_TypeInfo);
    byte_4A5756C = 1;
  }
...
void __fastcall ServantStatusFriendshipGauge___ctor(ServantStatusFriendshipGauge_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5756B & 1) == 0 )
  {
    sub_1B885B0(&UISlider___TypeInfo);
    byte_4A5756B = 1;
  }
  v3 = (struct UISlider_array *)sub_1B88658(UISlider___TypeInfo, 10LL);
  this->fields.gaugeSliderList = v3;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.gaugeSliderList, (int32_t)v3, v4, v5);
  v6 = (struct UISlider_array *)sub_1B88658(UISlider___TypeInfo, 10LL);
  this->fields.overLimitGaugeSliderList = v6;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.overLimitGaugeSliderList, (int32_t)v6, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( !gaugeSliderList )
LABEL_22:
    sub_1B8880C(this, *(_QWORD *)&currentRank);
  v8 = this;
  v10 = 0LL;
  while ( 1 )
  {
    ...
    if ( (unsigned int)v10 >= max_length )
      sub_1B88814(this, *(_QWORD *)&currentRank);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5756A & 1) == 0 )
  {
    this = (ServantStatusFriendshipGauge_o *)sub_1B885B0(&ServantStatusFriendshipGauge_TypeInfo);
    byte_4A5756A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57567 & 1) == 0 )
  {
    ...
    sub_1B885B0(&BalanceConfig_TypeInfo);
    this = (ServantStatusFriendshipGauge_o *)sub_1B885B0(&StringLiteral_20271/*"img_bondsgage_11"*/);
    byte_4A57567 = 1;
  }
...
LABEL_18:
  ...
  if ( v12->static_fields->DisableFriendshipExceed <= 0 )
  {
    ...
    AtlasManager__SetBondAtlasImage(overLimitGaugeSprite, (System_String_o *)StringLiteral_20271/*"img_bondsgage_11"*/, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (late & 0x80000000) == 0 )
  {
    ...
    if ( latePointLabel )
      goto LABEL_19;
LABEL_22:
    sub_1B8880C(NumberFormat, v15);
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  NumberFormat = LocalizationManager__Get((System_String_o *)StringLiteral_14801/*"UNIT_REST_NONE"*/, 0LL);
LABEL_18:
  v15 = NumberFormat;
  if ( !latePointLabel )
    goto LABEL_22;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B8880C(nomalGaugeContainer, isOverLimit);
  }
  UnityEngine_GameObject__SetActive(nomalGaugeContainer, isOverLimit, 0LL);
}