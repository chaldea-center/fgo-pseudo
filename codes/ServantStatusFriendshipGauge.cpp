void ServantStatusFriendshipGauge___cctor(const MethodInfo *method)
{
  if ( (byte_4D2914B & 1) == 0 )
  {
    sub_1C94098(&ServantStatusFriendshipGauge_TypeInfo);
    byte_4D2914B = 1;
  }
...
void ServantStatusFriendshipGauge___ctor(ServantStatusFriendshipGauge_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2914A & 1) == 0 )
  {
    sub_1C94098(&UISlider___TypeInfo);
    byte_4D2914A = 1;
  }
  v3 = (struct UISlider_array *)sub_1C94140(UISlider___TypeInfo, 10);
  this->fields.gaugeSliderList = v3;
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.gaugeSliderList, (int32_t)v3, v4, v5, v6, v7, v8, v9);
  v10 = (struct UISlider_array *)sub_1C94140(UISlider___TypeInfo, 10);
        ...
        const MethodInfo *method)
{
  ...
  if ( !gaugeSliderList )
LABEL_22:
    sub_1C942F0(this, *(_QWORD *)&currentRank);
  v8 = this;
  v10 = 0;
  while ( 1 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D29149 & 1) == 0 )
  {
    this = (ServantStatusFriendshipGauge_o *)sub_1C94098(&ServantStatusFriendshipGauge_TypeInfo);
    byte_4D29149 = 1;
  }
...
void ServantStatusFriendshipGauge__Initialize(ServantStatusFriendshipGauge_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D29146 & 1) == 0 )
  {
    ...
    sub_1C94098(&BalanceConfig_TypeInfo);
    this = (ServantStatusFriendshipGauge_o *)sub_1C94098(&StringLiteral_20514/*"img_bondsgage_11"*/);
    byte_4D29146 = 1;
  }
...
LABEL_18:
  ...
  if ( v11->static_fields->DisableFriendshipExceed <= 0 )
  {
    ...
    AtlasManager__SetBondAtlasImage(overLimitGaugeSprite, (System_String_o *)StringLiteral_20514/*"img_bondsgage_11"*/, 0);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (late & 0x80000000) == 0 )
  {
    ...
    if ( latePointLabel )
      goto LABEL_17;
LABEL_20:
    sub_1C942F0(NumberFormat, v14);
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  NumberFormat = LocalizationManager__Get((System_String_o *)StringLiteral_14877/*"UNIT_REST_NONE"*/, 0);
LABEL_16:
  v14 = NumberFormat;
  if ( !latePointLabel )
    goto LABEL_20;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C942F0(nomalGaugeContainer, isOverLimit);
  }
  UnityEngine_GameObject__SetActive(nomalGaugeContainer, isOverLimit, 0);
}