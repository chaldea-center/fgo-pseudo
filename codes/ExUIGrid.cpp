        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4FA02 & 1) == 0 )
  {
    sub_1B863B8(&UnityEngine_Application_TypeInfo, list);
    sub_1B863B8(&Method_System_Collections_Generic_List_Transform__GetRange__, v5);
      ...
      if ( v15 >= 1 )
      {
        ...
        while ( 1 )
        {
          ...
          IsNullOrEmpty = (__int64)System_Collections_Generic_List_object___GetRange(
                                     ...
                                     v20 * v18,
                                     v21,
                                     (const MethodInfo_35FD528 *)Method_System_Collections_Generic_List_Transform__GetRange__);
          v22 = (System_Collections_Generic_List_object__o *)IsNullOrEmpty;
          if ( !byte_4A487E1 )
          {
            IsNullOrEmpty = sub_1B863B8(&UnityEngine_Vector3_TypeInfo, v9);
            byte_4A487E1 = 1;
          }
