void __fastcall UserServantCommandCodeMaster___ctor(UserServantCommandCodeMaster_o *this, const MethodInfo *method)
{
  ...
  DataMasterBase_object__object__object____ctor(
    ...
    260,
    (const MethodInfo_32E45D0 *)Method_DataMasterBase_UserServantCommandCodeMaster__UserServantCommandCodeEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (UserServantCommandCodeEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                             (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                             PK,
                                             (const MethodInfo_32E68F4 *)Method_DataMasterBase_UserServantCommandCodeMaster__UserServantCommandCodeEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B459B4 & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Collections_ObjectModel_Collection_UserServantCommandCodeEntity__get_Count__, method);
    sub_1BDB878(&Method_System_Collections_ObjectModel_Collection_UserServantCommandCodeEntity__get_Item__, v3);
  ...
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            list,
            (const MethodInfo_327D624 *)Method_System_Collections_ObjectModel_Collection_UserServantCommandCodeEntity__get_Count__);
  if ( Count >= 1 )
  {
    v11 = Count;
    v12 = 0;
    while ( 1 )
    {
      ...
      list = (System_Collections_ObjectModel_Collection_T__o *)System_Collections_ObjectModel_Collection_object___get_Item(
                                                                 list,
                                                                 v12,
                                                                 (const MethodInfo_327D6B4 *)Method_System_Collections_ObjectModel_Collection_UserServantCommandCodeEntity__get_Item__);
      if ( !list )
        break;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B459B5 & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Collections_ObjectModel_Collection_UserServantCommandCodeEntity__get_Count__, method);
    sub_1BDB878(&Method_System_Collections_ObjectModel_Collection_UserServantCommandCodeEntity__get_Item__, v3);
    sub_1BDB878(&Method_System_Collections_Generic_Dictionary_long__long__Add__, v4);
    sub_1BDB878(&Method_System_Collections_Generic_Dictionary_long__long___ctor__, v5);
    sub_1BDB878(&System_Collections_Generic_Dictionary_long__long__TypeInfo, v6);
    sub_1BDB878(&CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo, v7);
    byte_4B459B5 = 1;
  }
  v8 = (System_Collections_Generic_Dictionary_long__long__o *)sub_1BDBAC4(System_Collections_Generic_Dictionary_long__long__TypeInfo);
  System_Collections_Generic_Dictionary_long__long____ctor(
    v8,
    (const MethodInfo_337B714 *)Method_System_Collections_Generic_Dictionary_long__long___ctor__);
  ...
  if ( Count >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      *(_OWORD *)&v22.fields.fakeValue = v14;
      ...
      v21 = v22;
      list = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_48231240(&v21, 0LL);
      if ( !v15 )
        break;
        ...
        while ( 1 )
        {
          ...
          if ( v9 >= 1 )
          {
            ...
            System_Collections_Generic_Dictionary_long__long___Add(
              ...
              v9,
              v17,
              (const MethodInfo_337C0E4 *)Method_System_Collections_Generic_Dictionary_long__long__Add__);
          }
          if ( v19 == v18 )
            break;
          if ( ++v18 >= (unsigned __int64)*(unsigned int *)(v15 + 24) )
            sub_1BDBADC(list, v9, v16);
        }
      }
      if ( ++v13 == v12 )
        return v8;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B459B9 & 1) == 0 )
  {
    sub_1BDB878(
      ...
      userCommandCodeId);
    sub_1BDB878(&Method_System_Collections_ObjectModel_Collection_UserServantCommandCodeEntity__get_Item__, v5);
  ...
  if ( !list )
LABEL_17:
    sub_1BDBAD4(list, userCommandCodeId);
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            list,
            (const MethodInfo_327D624 *)Method_System_Collections_ObjectModel_Collection_UserServantCommandCodeEntity__get_Count__);
        ...
        const MethodInfo *method)
{
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_32E6940 *)Method_DataMasterBase_UserServantCommandCodeMaster__UserServantCommandCodeEntity__string__TryGetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B459B6 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_System_Collections_ObjectModel_Collection_UserServantCommandCodeEntity__get_Item__, v7);
    ...
    sub_1BDB878(&System_Collections_Generic_List_long__TypeInfo, v10);
      ...
      if ( list )
      {
        ...
        *(_OWORD *)&v23.fields.fakeValue = v16;
        if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
        v22 = v23;
        list = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_48231240(&v22, 0LL);
        if ( list == userId )
...
LABEL_15:
    sub_1BDBAD4(list, userCommandCodeIdList);
  }
LABEL_13:
  if ( !v14 )
    goto LABEL_15;
  ...
  *userCommandCodeIdList = v19;
  sub_1BDB81C((CGThumbnailListItem_o *)userCommandCodeIdList, (int32_t)v19, v20, v21);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B459B7 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_DataManager_GetMasterData_UserCommandCodeMaster___, v6);
    sub_1BDB878(&Method_DataManager_GetMasterData_UserServantCommandCodeMaster___, v7);
    sub_1BDB878(&Method_DataMasterBase_UserCommandCodeMaster__UserCommandCodeEntity__long__TryGetEntity__, v8);
  ...
  Instance = (Il2CppObject *)sub_1BDB920(int___TypeInfo, (unsigned int)v18->static_fields->SvtCommandCardMax);
      ...
      if ( v19 >= 1 )
      {
        ...
        if ( ((unsigned __int8)Instance & 1) != 0 )
        {
          ...
          *(_QWORD *)&v29.fields.fakeValue = monitor;
          Instance = (Il2CppObject *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48227716(v29, 0LL);
          if ( !v20 )
            break;
