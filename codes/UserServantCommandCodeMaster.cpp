void UserServantCommandCodeMaster___ctor(UserServantCommandCodeMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4E059D4 & 1) == 0 )
  {
    sub_1CE6700(&Method_DataMasterBase_UserServantCommandCodeMaster__UserServantCommandCodeEntity__string___ctor__);
    byte_4E059D4 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    260,
    (const MethodInfo_34EBC44 *)Method_DataMasterBase_UserServantCommandCodeMaster__UserServantCommandCodeEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E059D2 & 1) == 0 )
  {
    sub_1CE6700(&Method_DataMasterBase_UserServantCommandCodeMaster__UserServantCommandCodeEntity__string__GetEntity__);
    byte_4E059D2 = 1;
  }
  ...
  return (UserServantCommandCodeEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                             (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                             PK,
                                             (const MethodInfo_34EE1BC *)Method_DataMasterBase_UserServantCommandCodeMaster__UserServantCommandCodeEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E059D5 & 1) == 0 )
  {
    sub_1CE6700(&Method_System_Collections_ObjectModel_Collection_UserServantCommandCodeEntity__get_Count__);
    sub_1CE6700(&Method_System_Collections_ObjectModel_Collection_UserServantCommandCodeEntity__get_Item__);
  ...
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            list,
            (const MethodInfo_3480AB0 *)Method_System_Collections_ObjectModel_Collection_UserServantCommandCodeEntity__get_Count__);
  if ( Count >= 1 )
  {
    v7 = Count;
    v8 = 0;
    while ( 1 )
    {
      ...
      list = (System_Collections_ObjectModel_Collection_T__o *)System_Collections_ObjectModel_Collection_object___get_Item(
                                                                 list,
                                                                 v8,
                                                                 (const MethodInfo_3480B40 *)Method_System_Collections_ObjectModel_Collection_UserServantCommandCodeEntity__get_Item__);
      if ( !list )
        break;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E059D6 & 1) == 0 )
  {
    sub_1CE6700(&Method_System_Collections_ObjectModel_Collection_UserServantCommandCodeEntity__get_Count__);
    sub_1CE6700(&Method_System_Collections_ObjectModel_Collection_UserServantCommandCodeEntity__get_Item__);
    sub_1CE6700(&Method_System_Collections_Generic_Dictionary_long__long__Add__);
    sub_1CE6700(&Method_System_Collections_Generic_Dictionary_long__long___ctor__);
    sub_1CE6700(&System_Collections_Generic_Dictionary_long__long__TypeInfo);
    sub_1CE6700(&CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
    byte_4E059D6 = 1;
  }
  v3 = (System_Collections_Generic_Dictionary_long__long__o *)sub_1CE694C(System_Collections_Generic_Dictionary_long__long__TypeInfo);
  System_Collections_Generic_Dictionary_long__long____ctor(
    v3,
    (const MethodInfo_358A180 *)Method_System_Collections_Generic_Dictionary_long__long___ctor__);
  ...
  if ( Count >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      *(_OWORD *)&v16.fields.fakeValue = v9;
      ...
      v15 = v16;
      list = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_50041532(&v15, 0);
      if ( !v10 )
        break;
        ...
        while ( 1 )
        {
          ...
          if ( v4 >= 1 )
          {
            ...
            System_Collections_Generic_Dictionary_long__long___Add(
              ...
              v4,
              v11,
              (const MethodInfo_358AB50 *)Method_System_Collections_Generic_Dictionary_long__long__Add__);
          }
          if ( v13 == v12 )
            break;
        ...
        const MethodInfo *method)
{
  ...
  if ( !list )
LABEL_17:
    sub_1CE6958(list, userCommandCodeId);
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            list,
            (const MethodInfo_3480AB0 *)Method_System_Collections_ObjectModel_Collection_UserServantCommandCodeEntity__get_Count__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E059D3 & 1) == 0 )
  {
    sub_1CE6700(&Method_DataMasterBase_UserServantCommandCodeMaster__UserServantCommandCodeEntity__string__TryGetEntity__);
    byte_4E059D3 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_34EE208 *)Method_DataMasterBase_UserServantCommandCodeMaster__UserServantCommandCodeEntity__string__TryGetEntity__);
}
      ...
      if ( list )
      {
        ...
        *(_OWORD *)&v22.fields.fakeValue = v11;
        if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
        v21 = v22;
        list = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_50041532(&v21, 0);
        if ( list == userId )
...
LABEL_15:
    sub_1CE6958(list, userCommandCodeIdList);
  }
LABEL_13:
  if ( !v9 )
    goto LABEL_15;
  ...
  *userCommandCodeIdList = v14;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)userCommandCodeIdList, (int32_t)v14, v15, v16, v17, v18, v19, v20);
}
        ...
        const MethodInfo *method)
{
  ...
  Instance = (Il2CppObject *)sub_1CE67A8(int___TypeInfo, (unsigned int)v12->static_fields->SvtCommandCardMax);
  v13 = Instance;
      ...
      if ( v17 >= 1 )
      {
        ...
        if ( ((unsigned __int8)Instance & 1) != 0 )
        {
          ...
          *(_QWORD *)&v23.fields.fakeValue = monitor;
          Instance = (Il2CppObject *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_50038008(v23, 0);
          if ( !v13 )
            break;
      ...
      if ( v7 >= 1 )
      {
        ...
        if ( (unsigned int)size >= LODWORD(items->max_length) )
        {
          System_Collections_Generic_List_long___AddWithResize(
            v11,
            v7,
            *(const MethodInfo_38EDF9C **)(*(_QWORD *)(v15[4] + 192LL) + 112LL));
        }
        else
        {
