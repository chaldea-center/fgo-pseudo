void __fastcall UserServantCommandCodeMaster___ctor(UserServantCommandCodeMaster_o *this, const MethodInfo *method)
{
  ...
  DataMasterBase_object__object__object____ctor(
    ...
    254,
    (const MethodInfo_30E47D8 *)Method_DataMasterBase_UserServantCommandCodeMaster__UserServantCommandCodeEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (UserServantCommandCodeEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                             (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                             PK,
                                             (const MethodInfo_30E4818 *)Method_DataMasterBase_UserServantCommandCodeMaster__UserServantCommandCodeEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A09A3F & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_System_Collections_Generic_List_long___ctor__, v5);
    sub_1B686D4(&System_Collections_Generic_List_long__TypeInfo, v6);
    sub_1B686D4(&UserServantCommandCodeEntity_TypeInfo, v7);
    byte_4A09A3F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A09A40 & 1) == 0 )
  {
    sub_1B686D4(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__, method);
    sub_1B686D4(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Item__, v3);
    sub_1B686D4(&Method_System_Collections_Generic_Dictionary_long__long__Add__, v4);
    sub_1B686D4(&Method_System_Collections_Generic_Dictionary_long__long___ctor__, v5);
    sub_1B686D4(&System_Collections_Generic_Dictionary_long__long__TypeInfo, v6);
    sub_1B686D4(&CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo, v7);
    sub_1B686D4(&UserServantCommandCodeEntity_TypeInfo, v8);
    byte_4A09A40 = 1;
  }
  v9 = (System_Collections_Generic_Dictionary_long__long__o *)sub_1B68920(System_Collections_Generic_Dictionary_long__long__TypeInfo);
  System_Collections_Generic_Dictionary_long__long____ctor(
    v9,
    (const MethodInfo_316E69C *)Method_System_Collections_Generic_Dictionary_long__long___ctor__);
      ...
      while ( 1 )
      {
        ...
        if ( v10 >= 1 )
        {
          ...
          System_Collections_Generic_Dictionary_long__long___Add(
            ...
            v10,
            v18,
            (const MethodInfo_316F06C *)Method_System_Collections_Generic_Dictionary_long__long__Add__);
        }
        if ( v20 == v19 )
          break;
        if ( ++v19 >= (unsigned __int64)*(unsigned int *)(v17 + 24) )
          sub_1B68938(list, v10);
      }
    }
    if ( ++v14 == v13 )
      return v9;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A09A44 & 1) == 0 )
  {
    sub_1B686D4(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__, userCommandCodeId);
  ...
  if ( !list )
LABEL_20:
    sub_1B68930(list, userCommandCodeId);
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            list,
            (const MethodInfo_3081124 *)Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__);
        ...
        const MethodInfo *method)
{
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_30E4868 *)Method_DataMasterBase_UserServantCommandCodeMaster__UserServantCommandCodeEntity__string__TryGetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A09A41 & 1) == 0 )
  {
    sub_1B686D4(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__, userCommandCodeIdList);
    ...
    sub_1B686D4(&UserServantCommandCodeEntity_TypeInfo, v12);
    byte_4A09A41 = 1;
  }
  list = (int64_t)this->fields.list;
  if ( !list )
LABEL_18:
    sub_1B68930(list, userCommandCodeIdList);
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            (System_Collections_ObjectModel_Collection_T__o *)list,
            (const MethodInfo_3081124 *)Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__);
      ...
      if ( list )
      {
        ...
        *(_OWORD *)&v25.fields.fakeValue = v19;
        if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
        v24 = v25;
        list = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_46242940(&v24, 0LL);
        if ( list == userId )
  ...
  *userCommandCodeIdList = v21;
  sub_1B68678((ServantStatusBattleListViewItem_o *)userCommandCodeIdList, (int32_t)v21, v22, v23);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A09A42 & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_DataManager_GetMasterData_UserCommandCodeMaster___, v6);
    sub_1B686D4(&Method_DataManager_GetMasterData_UserServantCommandCodeMaster___, v7);
    sub_1B686D4(&Method_DataMasterBase_UserCommandCodeMaster__UserCommandCodeEntity__long__TryGetEntity__, v8);
  ...
  Instance = (Il2CppObject *)sub_1B6877C(int___TypeInfo, (unsigned int)v18->static_fields->SvtCommandCardMax);
      ...
      if ( v23 >= 1 )
      {
        ...
        if ( ((unsigned __int8)Instance & 1) != 0 )
        {
          ...
          *(_QWORD *)&v29.fields.fakeValue = monitor;
          Instance = (Il2CppObject *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46239416(v29, 0LL);
          if ( !v19 )
            break;
