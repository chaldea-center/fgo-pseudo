        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C52899 & 1) == 0 )
  {
    ...
    this = (ServantStatusCharaGraphViewerListViewManager_o *)sub_1C3E564(&ServantStatusCharaGraphListViewItem_TypeInfo);
    byte_4C52899 = 1;
  }
  if ( !items )
    goto LABEL_15;
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      if ( (unsigned int)v8 >= max_length )
        sub_1C3E7C8(this, *(_QWORD *)&currentIndex);
      v9 = items->m_Items[v8];
      if ( !v9 )
        break;
      ...
      v13 = sub_1C3E7B0(ServantStatusCharaGraphListViewItem_TypeInfo);
      ListViewItem___ctor_43860152((ListViewItem_o *)v13, index, 0);
      *(_QWORD *)(v13 + 120) = mainInfo;
      sub_1C3E508((CGThumbnailListItem_o *)(v13 + 120), (int32_t)mainInfo, v14, v15);
      *(_DWORD *)(v13 + 128) = imageLimitCount;
      ...
      else
      {
        ...
        *(_QWORD *)(v21 + 32) = v13;
        sub_1C3E508((CGThumbnailListItem_o *)(v21 + 32), v13, v16, v17);
      }
      max_length = items->max_length;
...
LABEL_15:
    sub_1C3E7C0(this, *(_QWORD *)&currentIndex);
  }
LABEL_14:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C5289C & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_ServantStatusCharaGraphViewerListViewManager_OnMoveEnd__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C3E564(&UnityEngine_Object_TypeInfo);
    sub_1C3E564(&ServantStatusCharaGraphViewerListViewIndicator_TypeInfo);
    byte_4C5289A = 1;
  }
  ...
  if ( v8 )
  {
    ...
    sub_1C3E508((CGThumbnailListItem_o *)&v7[1], (int32_t)onModifyScrollViewCenter, v10, v11);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C5289B & 1) == 0 )
  {
    this = (ServantStatusCharaGraphViewerListViewManager_o *)sub_1C3E564(&ServantStatusCharaGraphListViewObject_TypeInfo);
    byte_4C5289B = 1;
  }
  if ( !obj
  ...
  if ( v5->fields.currentPhase == 1 )
    ...
    v8 = 7;
  ServantStatusCharaGraphListViewObject__Init_34388328((ServantStatusCharaGraphListViewObject_o *)obj, v8, v7);
}
