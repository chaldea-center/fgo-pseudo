        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BB415 & 1) == 0 )
  {
    sub_1B4CF90(&Method_System_Linq_Enumerable_Distinct_int___, baseIndividuality);
    ...
    sub_1B4CF90(&Method_System_Collections_Generic_List_int__RemoveAll__, v7);
    ...
    sub_1B4CF90(&Method_QuestPhaseIndividualityEntity___c__DisplayClass0_0__GetAddAndDelAfterIndividuality_b__0__, v11);
    sub_1B4CF90(&QuestPhaseIndividualityEntity___c__DisplayClass0_0_TypeInfo, v12);
    byte_49BB415 = 1;
  }
  addIndividuality = 0LL;
  v13 = sub_1B4D1DC(QuestPhaseIndividualityEntity___c__DisplayClass0_0_TypeInfo);
...
LABEL_14:
    ...
    v18 = (System_Predicate_int__o *)sub_1B4D1DC(System_Predicate_int__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BB416 & 1) == 0 )
  {
    sub_1B4CF90(&Method_System_Array_Empty_int___, addIndividuality);
    sub_1B4CF90(&Method_System_Linq_Enumerable_Select_int__int___, v8);
    sub_1B4CF90(&Method_System_Linq_Enumerable_ToArray_int___, v9);
    sub_1B4CF90(&Method_System_Linq_Enumerable_Where_int___, v10);
    sub_1B4CF90(&System_Func_int__int__TypeInfo, v11);
    sub_1B4CF90(&System_Func_int__bool__TypeInfo, v12);
    sub_1B4CF90(&Method_System_Math_Abs__, v13);
    sub_1B4CF90(&Method_QuestPhaseIndividualityEntity___c__GetAddDelIndividuality_b__1_0__, v14);
    sub_1B4CF90(&Method_QuestPhaseIndividualityEntity___c__GetAddDelIndividuality_b__1_1__, v15);
    sub_1B4CF90(&QuestPhaseIndividualityEntity___c_TypeInfo, v16);
    byte_49BB416 = 1;
  }
  ...
  *delIndividuality = *v21;
  sub_1B4CF34((CGThumbnailListItem_o *)delIndividuality, (int32_t)v23, (int32_t)delIndividuality, method);
  *addIndividuality = v22;
  sub_1B4CF34((CGThumbnailListItem_o *)addIndividuality, (int32_t)v22, v24, v25);
  ...
  if ( !IsNullOrEmpty )
  {
    ...
    if ( !_9__1_0 )
    {
      ...
      _9__1_0 = (System_Func_int__bool__o *)sub_1B4D1DC(System_Func_int__bool__TypeInfo);
    ...
    *addIndividuality = v35;
    sub_1B4CF34((CGThumbnailListItem_o *)addIndividuality, (int32_t)v35, v36, v37);
    ...
    if ( !_9__1_1 )
    {
      ...
      _9__1_1 = (System_Func_int__bool__o *)sub_1B4D1DC(System_Func_int__bool__TypeInfo);
      System_Func_int__bool____ctor(
        _9__1_1,
        v41,
      ...
      sub_1B4CF34((CGThumbnailListItem_o *)&v42->__9__1_1, (int32_t)_9__1_1, v43, v44);
    }
    v45 = System_Linq_Enumerable__Where_int_(
            v39,
            (System_Func_TSource__bool__o *)_9__1_1,
            (const MethodInfo_2F42364 *)Method_System_Linq_Enumerable_Where_int___);
    v46 = (System_Func_int__int__o *)sub_1B4D1DC(System_Func_int__int__TypeInfo);
    ...
    *delIndividuality = v48;
    sub_1B4CF34((CGThumbnailListItem_o *)delIndividuality, (int32_t)v48, v49, v50);
  }
...
void __fastcall QuestPhaseIndividualityEntity___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49BB419 & 1) == 0 )
  {
    sub_1B4CF90(&QuestPhaseIndividualityEntity___c_TypeInfo, v1);
    byte_49BB419 = 1;
  }
  v2 = (Il2CppObject *)sub_1B4D1DC(QuestPhaseIndividualityEntity___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  QuestPhaseIndividualityEntity___c_TypeInfo->static_fields->__9 = (struct QuestPhaseIndividualityEntity___c_o *)v2;
  sub_1B4CF34((CGThumbnailListItem_o *)QuestPhaseIndividualityEntity___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
