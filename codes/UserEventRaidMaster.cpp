void __fastcall UserEventRaidMaster___ctor(UserEventRaidMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4186F6C & 1) == 0 )
  {
    sub_B2C35C(&Method_DataMasterBase_UserEventRaidMaster__UserEventRaidEntity__string___ctor__, method);
    byte_4186F6C = 1;
  }
  DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string____ctor(
    (DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string__o *)this,
    148,
    (const MethodInfo_24E4484 *)Method_DataMasterBase_UserEventRaidMaster__UserEventRaidEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4186F6A & 1) == 0 )
  {
    sub_B2C35C(&Method_DataMasterBase_UserEventRaidMaster__UserEventRaidEntity__string__GetEntity__, userId);
    byte_4186F6A = 1;
  }
  ...
  return (UserEventRaidEntity_o *)DataMasterBase_WarGroupMaster__WarGroupEntity__string___GetEntity(
                                    ...
                                    PK,
                                    (const MethodInfo_24E4520 *)Method_DataMasterBase_UserEventRaidMaster__UserEventRaidEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4186F6B & 1) == 0 )
  {
    sub_B2C35C(&Method_DataMasterBase_UserEventRaidMaster__UserEventRaidEntity__string__TryGetEntity__, entity);
    byte_4186F6B = 1;
  }
  ...
  return DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string___TryGetEntity(
           ...
           PK,
           (const MethodInfo_24E4578 *)Method_DataMasterBase_UserEventRaidMaster__UserEventRaidEntity__string__TryGetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( result )
  {
    ...
    return System_Math__Min_45012816(v12, UserRaidDamagePointMax, 0LL);
  }
  return result;
}
        ...
        const MethodInfo *method)
{
  ...
  int32_t *v21; // x11
  __int64 v22; // x0
  UserEventRaidEntity_o *v23; // x0
  UserEventRaidEntity_o *v24; // x22
  __int64 v25; // x9
  int v26; // w8
  ...
  if ( (byte_4186F6F & 1) == 0 )
  {
    ...
    sub_B2C35C(&UserEventRaidEntity_TypeInfo, v10);
    byte_4186F6F = 1;
  }
...
LABEL_16:
    ...
    v23 = (UserEventRaidEntity_o *)(*(__int64 (__fastcall **)(System_Collections_Generic_IEnumerator_T__o *, _QWORD))v22)(
                                     Enumerator,
                                     *(_QWORD *)(v22 + 8));
    v24 = v23;
    if ( v23 )
    {
      v25 = *(&UserEventRaidEntity_TypeInfo->_2.bitflags2 + 1);
      if ( *(&v23->klass->_2.bitflags2 + 1) < (unsigned int)v25
        || (UserEventRaidEntity_c *)v23->klass->_2.typeHierarchy[v25 - 1] != UserEventRaidEntity_TypeInfo )
      {
        list = (System_Collections_ObjectModel_Collection_UnicastIPAddressInformation__o *)sub_B2C728(v23);
        goto LABEL_35;
      }
      if ( v23->fields.eventId == eventId && v23->fields.day == day )
      {
        v26 = 73;
        goto LABEL_25;
      }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4186F6D & 1) == 0 )
  {
    ...
    sub_B2C35C(&UserEventRaidEntity_TypeInfo, v11);
    byte_4186F6D = 1;
  }
  if ( (BYTE3(NetworkManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !NetworkManager_TypeInfo->_2.cctor_finished )
...
LABEL_13:
    ...
    if ( v23 )
    {
      v24 = *(&UserEventRaidEntity_TypeInfo->_2.bitflags2 + 1);
      if ( *(unsigned __int8 *)(*(_QWORD *)v23 + 300LL) < (unsigned int)v24
        || *(UserEventRaidEntity_c **)(*(_QWORD *)(*(_QWORD *)v23 + 200LL) + 8 * v24 - 8) != UserEventRaidEntity_TypeInfo )
      {
        UserId = sub_B2C728(v23);
        goto LABEL_42;
      }
...
LABEL_32:
  ...
  UserRaidDamagePointMax = v34->static_fields->UserRaidDamagePointMax;
  if ( (BYTE3(System_Math_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0 && !System_Math_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
  return System_Math__Min_45012816(v18, UserRaidDamagePointMax, 0LL);
}