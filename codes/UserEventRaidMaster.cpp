void __fastcall UserEventRaidMaster___ctor(UserEventRaidMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4AB6A05 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataMasterBase_UserEventRaidMaster__UserEventRaidEntity__string___ctor__, method);
    byte_4AB6A05 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    150,
    (const MethodInfo_31640A8 *)Method_DataMasterBase_UserEventRaidMaster__UserEventRaidEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB6A03 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataMasterBase_UserEventRaidMaster__UserEventRaidEntity__string__GetEntity__, userId);
    byte_4AB6A03 = 1;
  }
  ...
  return (UserEventRaidEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                    PK,
                                    (const MethodInfo_31640E8 *)Method_DataMasterBase_UserEventRaidMaster__UserEventRaidEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB6A04 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataMasterBase_UserEventRaidMaster__UserEventRaidEntity__string__TryGetEntity__, entity);
    byte_4AB6A04 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_3164138 *)Method_DataMasterBase_UserEventRaidMaster__UserEventRaidEntity__string__TryGetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( result )
  {
    ...
    return System_Math__Min_62867116(v12, UserRaidDamagePointMax, 0LL);
  }
  return result;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB6A08 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&UserEventRaidEntity_TypeInfo, v10);
    byte_4AB6A08 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB6A06 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&UserEventRaidEntity_TypeInfo, v11);
    byte_4AB6A06 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
...
LABEL_31:
  ...
  if ( !System_Math_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
  return System_Math__Min_62867116(v17, UserRaidDamagePointMax, 0LL);
}