        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FA05B & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_19307, v7);
    byte_40FA05B = 1;
  }
  this->fields.id = id;
  this->fields.num = num;
...
System_String_o *__fastcall PurchaseByStoneRequest__getURL(PurchaseByStoneRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_40FA05A & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_22015, v2);
    byte_40FA05A = 1;
  }
  ...
  return System_String__Concat_43743732(BaseUrl, (System_String_o *)StringLiteral_22015, 0LL);
}
