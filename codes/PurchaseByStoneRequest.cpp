...
System_String_o *__fastcall PurchaseByStoneRequest__getURL(PurchaseByStoneRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4351F5A & 1) == 0 )
  {
    ...
    sub_B70694(&StringLiteral_22479/*"shop/purchaseByStone"*/);
    byte_4351F5A = 1;
  }
  ...
  return System_String__Concat_44758168(BaseUrl, (System_String_o *)StringLiteral_22479/*"shop/purchaseByStone"*/, 0LL);
}
