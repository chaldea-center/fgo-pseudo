        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC946C & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_20540/*"id"*/, v7);
    byte_4BC946C = 1;
  }
  this->fields.id = id;
  this->fields.num = num;
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_20540/*"id"*/, id, method);
...
System_String_o *__fastcall PurchaseByStoneRequest__getURL(PurchaseByStoneRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC946B & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_23675/*"shop/purchaseByStone"*/, v2);
    byte_4BC946B = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63040368(BaseUrl, (System_String_o *)StringLiteral_23675/*"shop/purchaseByStone"*/, 0LL);
}
