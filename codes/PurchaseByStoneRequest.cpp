        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A213CB & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_20148/*"id"*/, v7);
    byte_4A213CB = 1;
  }
  this->fields.id = id;
  this->fields.num = num;
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_20148/*"id"*/, id, method);
...
System_String_o *__fastcall PurchaseByStoneRequest__getURL(PurchaseByStoneRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A213CA & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_23213/*"shop/purchaseByStone"*/, v2);
    byte_4A213CA = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61505504(BaseUrl, (System_String_o *)StringLiteral_23213/*"shop/purchaseByStone"*/, 0LL);
}
