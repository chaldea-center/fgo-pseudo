        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B38B02 & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_20444/*"id"*/, v7);
    byte_4B38B02 = 1;
  }
  this->fields.id = id;
  this->fields.num = num;
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_20444/*"id"*/, id, method);
...
System_String_o *__fastcall PurchaseByStoneRequest__getURL(PurchaseByStoneRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B38B01 & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_23551/*"shop/purchaseByStone"*/, v2);
    byte_4B38B01 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62525248(BaseUrl, (System_String_o *)StringLiteral_23551/*"shop/purchaseByStone"*/, 0LL);
}
