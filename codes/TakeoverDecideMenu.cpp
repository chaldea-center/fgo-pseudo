  ...
  if ( !this->fields.state )
  {
    ...
    if ( !closeLabel
      || (UILabel__set_text(closeLabel, (System_String_o *)gameObject, 0),
          ...
          v10 = LocalizationManager__Get((System_String_o *)StringLiteral_3819/*"CONTINUE_DEVICE_TAKEOVER_DECIDE_MESSAGE"*/, 0),
          gameObject = (UnityEngine_GameObject_o *)System_String__Format(v10, (Il2CppObject *)userName, 0),
          !messageLabel)
