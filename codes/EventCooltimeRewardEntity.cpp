        ...
        const MethodInfo *method)
{
  if ( (byte_4A08BA0 & 1) == 0 )
  {
    sub_1B686D4(&Method_DataEntityBase_CreateMultiplePK_int__int__int___, *(_QWORD *)&spotId);
    byte_4A08BA0 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A08BA1 & 1) == 0 )
  {
    sub_1B686D4(&EventCooltimeRewardEntity_GiftMakingVelocityInfo_TypeInfo, method);
    byte_4A08BA1 = 1;
  }
  cooltime = this->fields.cooltime;
  upperLimitGiftNum = this->fields.upperLimitGiftNum;
  v5 = sub_1B68920(EventCooltimeRewardEntity_GiftMakingVelocityInfo_TypeInfo);
