        ...
        const MethodInfo *method)
{
  if ( (byte_4A4E3C8 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataEntityBase_CreateMultiplePK_int__int__int___, *(_QWORD *)&spotId);
    byte_4A4E3C8 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4E3C9 & 1) == 0 )
  {
    sub_1B863B8(&EventCooltimeRewardEntity_GiftMakingVelocityInfo_TypeInfo, method);
    byte_4A4E3C9 = 1;
  }
  cooltime = this->fields.cooltime;
  upperLimitGiftNum = this->fields.upperLimitGiftNum;
  v5 = sub_1B86604(EventCooltimeRewardEntity_GiftMakingVelocityInfo_TypeInfo);
