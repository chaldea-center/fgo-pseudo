        ...
        const MethodInfo *method)
{
  if ( (byte_40FC5E7 & 1) == 0 )
  {
    sub_B16FFC(&Method_DataEntityBase_CreateMultiplePK_int__int__int___, *(_QWORD *)&spotId);
    byte_40FC5E7 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  EventCooltimeRewardEntity_GiftMakingVelocityInfo_o *v8; // x21

  if ( (byte_40FC5E8 & 1) == 0 )
  {
    sub_B16FFC(&EventCooltimeRewardEntity_GiftMakingVelocityInfo_TypeInfo, method);
    byte_40FC5E8 = 1;
  }
  cooltime = this->fields.cooltime;
  upperLimitGiftNum = this->fields.upperLimitGiftNum;
  v8 = (EventCooltimeRewardEntity_GiftMakingVelocityInfo_o *)sub_B170CC(
                                                               EventCooltimeRewardEntity_GiftMakingVelocityInfo_TypeInfo,
                                                               method,
                                                               v2,
                                                               v3,
                                                               v4);
  EventCooltimeRewardEntity_GiftMakingVelocityInfo___ctor(v8, cooltime, upperLimitGiftNum, 0LL);
  return v8;
}
...
bool __fastcall EventCooltimeRewardEntity__IsOpen(EventCooltimeRewardEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_40FC5E9 & 1) == 0 )
  {
    sub_B16FFC(&Method_DataManager_GetMaster_CommonReleaseMaster___, method);
    sub_B16FFC(&DataManager_TypeInfo, v3);
    byte_40FC5E9 = 1;
  }
  if ( (BYTE3(DataManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0 && !DataManager_TypeInfo->_2.cctor_finished )
