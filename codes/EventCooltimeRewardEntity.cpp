        ...
        const MethodInfo *method)
{
  if ( (byte_4A1FA0C & 1) == 0 )
  {
    sub_1B715CC(&Method_DataEntityBase_CreateMultiplePK_int__int__int___, *(_QWORD *)&spotId);
    byte_4A1FA0C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1FA0D & 1) == 0 )
  {
    sub_1B715CC(&EventCooltimeRewardEntity_GiftMakingVelocityInfo_TypeInfo, method);
    byte_4A1FA0D = 1;
  }
  cooltime = this->fields.cooltime;
  upperLimitGiftNum = this->fields.upperLimitGiftNum;
  v5 = sub_1B71818(EventCooltimeRewardEntity_GiftMakingVelocityInfo_TypeInfo);
