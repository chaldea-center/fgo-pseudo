void __fastcall UserPresentDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B659C8 & 1) == 0 )
  {
    sub_1BE4ACC(&UserPresentDialog_TypeInfo, v1);
    byte_4B659C8 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B659C6 & 1) == 0 )
  {
    sub_1BE4ACC(&BalanceConfig_TypeInfo, message);
    sub_1BE4ACC(&int_TypeInfo, v9);
    sub_1BE4ACC(&LocalizationManager_TypeInfo, v10);
    sub_1BE4ACC(&UserPresentDialog_TypeInfo, v11);
    sub_1BE4ACC(&StringLiteral_10620/*"PRESENT_RECIEVE_DIALOG_DECIDE"*/, v12);
    sub_1BE4ACC(&StringLiteral_10623/*"PRESENT_RECIEVE_DIALOG_TITLE"*/, v13);
    sub_1BE4ACC(&StringLiteral_10622/*"PRESENT_RECIEVE_DIALOG_SUBTITLE_SMALL"*/, v14);
    sub_1BE4ACC(&StringLiteral_10621/*"PRESENT_RECIEVE_DIALOG_SUBTITLE"*/, v15);
    sub_1BE4ACC(&StringLiteral_10619/*"PRESENT_RECIEVE_DIALOG_CANCEL"*/, v16);
    byte_4B659C6 = 1;
  }
  ...
  decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_10621/*"PRESENT_RECIEVE_DIALOG_SUBTITLE"*/, 0LL);
  if ( !subtitle )
    goto LABEL_16;
  ...
  v24 = LocalizationManager__Get((System_String_o *)StringLiteral_10622/*"PRESENT_RECIEVE_DIALOG_SUBTITLE_SMALL"*/, 0LL);
  ...
  v31 = LocalizationManager__Get((System_String_o *)StringLiteral_10623/*"PRESENT_RECIEVE_DIALOG_TITLE"*/, 0LL);
  TextLabelScrollDialog__Open((TextLabelScrollDialog_o *)this, v31, message, closeAction, decideAction, v32);
  closeLabel = this->fields.closeLabel;
  decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_10619/*"PRESENT_RECIEVE_DIALOG_CANCEL"*/, 0LL);
  if ( !closeLabel
    || (UILabel__set_text(closeLabel, decideButton, 0LL),
        decideLabel = this->fields.decideLabel,
        decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_10620/*"PRESENT_RECIEVE_DIALOG_DECIDE"*/, 0LL),
        !decideLabel) )
  {
LABEL_16:
    sub_1BE4D28(decideButton, v21);
  }
