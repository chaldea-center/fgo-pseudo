void UserPresentDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CB4FDA & 1) == 0 )
  {
    sub_1C6BA08(&UserPresentDialog_TypeInfo);
    byte_4CB4FDA = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB4FD8 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&UserPresentDialog_TypeInfo);
    sub_1C6BA08(&StringLiteral_10458/*"PRESENT_RECIEVE_DIALOG_DECIDE"*/);
    sub_1C6BA08(&StringLiteral_10461/*"PRESENT_RECIEVE_DIALOG_TITLE"*/);
    sub_1C6BA08(&StringLiteral_10460/*"PRESENT_RECIEVE_DIALOG_SUBTITLE_SMALL"*/);
    sub_1C6BA08(&StringLiteral_10459/*"PRESENT_RECIEVE_DIALOG_SUBTITLE"*/);
    sub_1C6BA08(&StringLiteral_10457/*"PRESENT_RECIEVE_DIALOG_CANCEL"*/);
    byte_4CB4FD8 = 1;
  }
  ...
  decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_10459/*"PRESENT_RECIEVE_DIALOG_SUBTITLE"*/, 0);
  if ( !subtitle )
    goto LABEL_16;
  ...
  v16 = LocalizationManager__Get((System_String_o *)StringLiteral_10460/*"PRESENT_RECIEVE_DIALOG_SUBTITLE_SMALL"*/, 0);
  ...
  v20 = LocalizationManager__Get((System_String_o *)StringLiteral_10461/*"PRESENT_RECIEVE_DIALOG_TITLE"*/, 0);
  TextLabelScrollDialog__Open((TextLabelScrollDialog_o *)this, v20, message, closeAction, decideAction, 0);
  closeLabel = this->fields.closeLabel;
  decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_10457/*"PRESENT_RECIEVE_DIALOG_CANCEL"*/, 0);
  if ( !closeLabel
    || (UILabel__set_text(closeLabel, decideButton, 0),
        decideLabel = this->fields.decideLabel,
        decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_10458/*"PRESENT_RECIEVE_DIALOG_DECIDE"*/, 0),
        !decideLabel) )
  {
LABEL_16:
    sub_1C6BC60(decideButton, v13);
  }
