void __fastcall UserPresentDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FD2B5 & 1) == 0 )
  {
    sub_1B64870(&UserPresentDialog_TypeInfo, v1);
    byte_49FD2B5 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD2B3 & 1) == 0 )
  {
    sub_1B64870(&BalanceConfig_TypeInfo, message);
    sub_1B64870(&int_TypeInfo, v9);
    sub_1B64870(&LocalizationManager_TypeInfo, v10);
    sub_1B64870(&UserPresentDialog_TypeInfo, v11);
    sub_1B64870(&StringLiteral_10411/*"PRESENT_RECIEVE_DIALOG_DECIDE"*/, v12);
    sub_1B64870(&StringLiteral_10414/*"PRESENT_RECIEVE_DIALOG_TITLE"*/, v13);
    sub_1B64870(&StringLiteral_10413/*"PRESENT_RECIEVE_DIALOG_SUBTITLE_SMALL"*/, v14);
    sub_1B64870(&StringLiteral_10412/*"PRESENT_RECIEVE_DIALOG_SUBTITLE"*/, v15);
    sub_1B64870(&StringLiteral_10410/*"PRESENT_RECIEVE_DIALOG_CANCEL"*/, v16);
    byte_49FD2B3 = 1;
  }
  ...
  decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_10412/*"PRESENT_RECIEVE_DIALOG_SUBTITLE"*/, 0LL);
  if ( !subtitle )
    goto LABEL_16;
  ...
  v24 = LocalizationManager__Get((System_String_o *)StringLiteral_10413/*"PRESENT_RECIEVE_DIALOG_SUBTITLE_SMALL"*/, 0LL);
  ...
  v31 = LocalizationManager__Get((System_String_o *)StringLiteral_10414/*"PRESENT_RECIEVE_DIALOG_TITLE"*/, 0LL);
  TextLabelScrollDialog__Open((TextLabelScrollDialog_o *)this, v31, message, closeAction, decideAction, v32);
  closeLabel = this->fields.closeLabel;
  decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_10410/*"PRESENT_RECIEVE_DIALOG_CANCEL"*/, 0LL);
  if ( !closeLabel
    || (UILabel__set_text(closeLabel, decideButton, 0LL),
        decideLabel = this->fields.decideLabel,
        decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_10411/*"PRESENT_RECIEVE_DIALOG_DECIDE"*/, 0LL),
        !decideLabel) )
  {
LABEL_16:
    sub_1B64ACC(decideButton, v21);
  }
