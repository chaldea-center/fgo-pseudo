void __fastcall UserPresentDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B35FBA & 1) == 0 )
  {
    sub_1BD3458(&UserPresentDialog_TypeInfo, v1);
    byte_4B35FBA = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B35FB8 & 1) == 0 )
  {
    sub_1BD3458(&BalanceConfig_TypeInfo, message);
    sub_1BD3458(&int_TypeInfo, v9);
    sub_1BD3458(&LocalizationManager_TypeInfo, v10);
    sub_1BD3458(&UserPresentDialog_TypeInfo, v11);
    sub_1BD3458(&StringLiteral_10608/*"PRESENT_RECIEVE_DIALOG_DECIDE"*/, v12);
    sub_1BD3458(&StringLiteral_10611/*"PRESENT_RECIEVE_DIALOG_TITLE"*/, v13);
    sub_1BD3458(&StringLiteral_10610/*"PRESENT_RECIEVE_DIALOG_SUBTITLE_SMALL"*/, v14);
    sub_1BD3458(&StringLiteral_10609/*"PRESENT_RECIEVE_DIALOG_SUBTITLE"*/, v15);
    sub_1BD3458(&StringLiteral_10607/*"PRESENT_RECIEVE_DIALOG_CANCEL"*/, v16);
    byte_4B35FB8 = 1;
  }
  ...
  decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_10609/*"PRESENT_RECIEVE_DIALOG_SUBTITLE"*/, 0LL);
  if ( !subtitle )
    goto LABEL_16;
  ...
  v24 = LocalizationManager__Get((System_String_o *)StringLiteral_10610/*"PRESENT_RECIEVE_DIALOG_SUBTITLE_SMALL"*/, 0LL);
  ...
  v31 = LocalizationManager__Get((System_String_o *)StringLiteral_10611/*"PRESENT_RECIEVE_DIALOG_TITLE"*/, 0LL);
  TextLabelScrollDialog__Open((TextLabelScrollDialog_o *)this, v31, message, closeAction, decideAction, v32);
  closeLabel = this->fields.closeLabel;
  decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_10607/*"PRESENT_RECIEVE_DIALOG_CANCEL"*/, 0LL);
  if ( !closeLabel
    || (UILabel__set_text(closeLabel, decideButton, 0LL),
        decideLabel = this->fields.decideLabel,
        decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_10608/*"PRESENT_RECIEVE_DIALOG_DECIDE"*/, 0LL),
        !decideLabel) )
  {
LABEL_16:
    sub_1BD36B4(decideButton, v21);
  }
