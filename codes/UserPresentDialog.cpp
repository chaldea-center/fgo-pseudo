void __fastcall UserPresentDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BB34EB & 1) == 0 )
  {
    sub_1C13D24(&UserPresentDialog_TypeInfo, v1);
    byte_4BB34EB = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB34E9 & 1) == 0 )
  {
    sub_1C13D24(&BalanceConfig_TypeInfo, message);
    sub_1C13D24(&int_TypeInfo, v9);
    sub_1C13D24(&LocalizationManager_TypeInfo, v10);
    sub_1C13D24(&UserPresentDialog_TypeInfo, v11);
    sub_1C13D24(&StringLiteral_10645/*"PRESENT_EXPIRED_ERROR_MESSAGE"*/, v12);
    sub_1C13D24(&StringLiteral_10648/*"PRESENT_HISTORY_DIALOG_TITLE"*/, v13);
    sub_1C13D24(&StringLiteral_10647/*"PRESENT_HISTORY_DIALOG_SUBTITLE"*/, v14);
    sub_1C13D24(&StringLiteral_10646/*"PRESENT_HISTORY_DATE_TIME_FORMAT"*/, v15);
    sub_1C13D24(&StringLiteral_10644/*"PRESENT_BOX_SUMMON_NOTIFICATION_MESSAGE_"*/, v16);
    byte_4BB34E9 = 1;
  }
  ...
  decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_10646/*"PRESENT_HISTORY_DATE_TIME_FORMAT"*/, 0LL);
  if ( !subtitle )
    goto LABEL_16;
  ...
  v24 = LocalizationManager__Get((System_String_o *)StringLiteral_10647/*"PRESENT_HISTORY_DIALOG_SUBTITLE"*/, 0LL);
  ...
  v31 = LocalizationManager__Get((System_String_o *)StringLiteral_10648/*"PRESENT_HISTORY_DIALOG_TITLE"*/, 0LL);
  TextLabelScrollDialog__Open((TextLabelScrollDialog_o *)this, v31, message, closeAction, decideAction, v32);
  closeLabel = this->fields.closeLabel;
  decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_10644/*"PRESENT_BOX_SUMMON_NOTIFICATION_MESSAGE_"*/, 0LL);
  if ( !closeLabel
    || (UILabel__set_text(closeLabel, decideButton, 0LL),
        decideLabel = this->fields.decideLabel,
        decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_10645/*"PRESENT_EXPIRED_ERROR_MESSAGE"*/, 0LL),
        !decideLabel) )
  {
LABEL_16:
    sub_1C13F80(decideButton, v21);
  }
