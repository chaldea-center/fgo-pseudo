void UserPresentDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CED3B9 & 1) == 0 )
  {
    sub_1C7BAE8(&UserPresentDialog_TypeInfo);
    byte_4CED3B9 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CED3B7 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&UserPresentDialog_TypeInfo);
    sub_1C7BAE8(&StringLiteral_10496/*"PRESENT_RECIEVE_DIALOG_DECIDE"*/);
    sub_1C7BAE8(&StringLiteral_10499/*"PRESENT_RECIEVE_DIALOG_TITLE"*/);
    sub_1C7BAE8(&StringLiteral_10498/*"PRESENT_RECIEVE_DIALOG_SUBTITLE_SMALL"*/);
    sub_1C7BAE8(&StringLiteral_10497/*"PRESENT_RECIEVE_DIALOG_SUBTITLE"*/);
    sub_1C7BAE8(&StringLiteral_10495/*"PRESENT_RECIEVE_DIALOG_CANCEL"*/);
    byte_4CED3B7 = 1;
  }
  ...
  decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_10497/*"PRESENT_RECIEVE_DIALOG_SUBTITLE"*/, 0);
  if ( !subtitle )
    goto LABEL_16;
  ...
  v16 = LocalizationManager__Get((System_String_o *)StringLiteral_10498/*"PRESENT_RECIEVE_DIALOG_SUBTITLE_SMALL"*/, 0);
  ...
  v19 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &PresentBoxCheckMax);
  decideButton = System_String__Format(v18, v19, 0);
  if ( !subtitleSmall )
    goto LABEL_16;
  ...
  v20 = LocalizationManager__Get((System_String_o *)StringLiteral_10499/*"PRESENT_RECIEVE_DIALOG_TITLE"*/, 0);
  TextLabelScrollDialog__Open((TextLabelScrollDialog_o *)this, v20, message, closeAction, decideAction, 0);
  closeLabel = this->fields.closeLabel;
  decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_10495/*"PRESENT_RECIEVE_DIALOG_CANCEL"*/, 0);
  if ( !closeLabel
    || (UILabel__set_text(closeLabel, decideButton, 0),
        decideLabel = this->fields.decideLabel,
        decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_10496/*"PRESENT_RECIEVE_DIALOG_DECIDE"*/, 0),
        !decideLabel) )
  {
LABEL_16:
    sub_1C7BD40(decideButton, v13);
  }
