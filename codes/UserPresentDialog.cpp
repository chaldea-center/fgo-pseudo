void __fastcall UserPresentDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BDB34D & 1) == 0 )
  {
    sub_1C21E38(&UserPresentDialog_TypeInfo);
    byte_4BDB34D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDB34B & 1) == 0 )
  {
    ...
    sub_1C21E38(&UserPresentDialog_TypeInfo);
    sub_1C21E38(&StringLiteral_10664/*"PRESENT_RECIEVE_DIALOG_DECIDE"*/);
    sub_1C21E38(&StringLiteral_10667/*"PRESENT_RECIEVE_DIALOG_TITLE"*/);
    sub_1C21E38(&StringLiteral_10666/*"PRESENT_RECIEVE_DIALOG_SUBTITLE_SMALL"*/);
    sub_1C21E38(&StringLiteral_10665/*"PRESENT_RECIEVE_DIALOG_SUBTITLE"*/);
    sub_1C21E38(&StringLiteral_10663/*"PRESENT_RECIEVE_DIALOG_CANCEL"*/);
    byte_4BDB34B = 1;
  }
  ...
  decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_10665/*"PRESENT_RECIEVE_DIALOG_SUBTITLE"*/, 0LL);
  if ( !subtitle )
    goto LABEL_16;
  ...
  v16 = LocalizationManager__Get((System_String_o *)StringLiteral_10666/*"PRESENT_RECIEVE_DIALOG_SUBTITLE_SMALL"*/, 0LL);
  ...
  v23 = LocalizationManager__Get((System_String_o *)StringLiteral_10667/*"PRESENT_RECIEVE_DIALOG_TITLE"*/, 0LL);
  TextLabelScrollDialog__Open((TextLabelScrollDialog_o *)this, v23, message, closeAction, decideAction, v24);
  closeLabel = this->fields.closeLabel;
  decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_10663/*"PRESENT_RECIEVE_DIALOG_CANCEL"*/, 0LL);
  if ( !closeLabel
    || (UILabel__set_text(closeLabel, decideButton, 0LL),
        decideLabel = this->fields.decideLabel,
        decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_10664/*"PRESENT_RECIEVE_DIALOG_DECIDE"*/, 0LL),
        !decideLabel) )
  {
LABEL_16:
    sub_1C22094(decideButton, v13);
  }
