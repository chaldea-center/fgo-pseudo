        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BDE02 & 1) == 0 )
  {
    sub_1B4CF90(&BattleEndNotRelatedSurvivalStatusInstantlyData_TypeInfo, logic);
    byte_49BDE02 = 1;
  }
  v3 = (BattleEndNotRelatedSurvivalStatusInstantlyData_o *)sub_1B4D1DC(BattleEndNotRelatedSurvivalStatusInstantlyData_TypeInfo);
