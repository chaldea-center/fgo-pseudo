        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24EC7 & 1) == 0 )
  {
    sub_1C3B764(&BattleEndNotRelatedSurvivalStatusInstantlyData_TypeInfo, logic);
    byte_4C24EC7 = 1;
  }
  v3 = (BattleEndNotRelatedSurvivalStatusInstantlyData_o *)sub_1C3B9B0(BattleEndNotRelatedSurvivalStatusInstantlyData_TypeInfo);
