        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7233C & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_ContinueDeviceComponent_onNextDispOpen__);
    sub_1D0F0B4(&Method_DataManager_GetMaster_UserContinueMaster___);
    sub_1D0F0B4(&DataManager_TypeInfo);
    sub_1D0F0B4(&Method_DataMasterBase_UserContinueMaster__UserContinueEntity__long__TryGetSingleEntity__);
  ...
  Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataManager__GetMaster_object_((const MethodInfo_324F164 *)Method_DataManager_GetMaster_UserContinueMaster___);
  if ( !Master_object )
    goto LABEL_15;
  Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataMasterBase_object__object__long___TryGetSingleEntity(
                                                                  Master_object,
                                                                  &entity,
                                                                  (const MethodInfo_3538458 *)Method_DataMasterBase_UserContinueMaster__UserContinueEntity__long__TryGetSingleEntity__);
...
LABEL_15:
  ...
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.continueCode, (int32_t)klass, v7, v8, v9, v10, v11, v12);
  ...
  *(_QWORD *)&this->fields.state = 0x100000000LL;
  ...
  if ( !continueDeviceInputMenu )
    goto LABEL_15;
  ContinueDeviceInputMenu__Close_34150132(continueDeviceInputMenu, v15, v16);
}
...
bool ContinueDeviceComponent__closeMenu(ContinueDeviceComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1D0F0B4(&System_Action_TypeInfo);
    sub_1D0F0B4(&Method_ContinueDeviceComponent_onClose__);
    byte_4E72338 = 1;
  }
  switch ( this->fields.state )
  {
    case 1:
      ...
      if ( !continueDeviceInputMenu )
        goto LABEL_16;
      ContinueDeviceInputMenu__Close_34150132(continueDeviceInputMenu, v4, v7);
      return 1;
    case 2:
      ...
      if ( !v8 )
        goto LABEL_16;
      ContinueDeviceInputMenu__Close_34150132(v8, v9, v10);
      goto LABEL_13;
    case 4:
      this->fields.closeCount = 1;
      ...
      if ( !continueDeviceDispMenu )
        goto LABEL_16;
      ContinueDeviceDispMenu__Close_34150448(continueDeviceDispMenu, v12, v13);
      return 1;
    case 5:
      this->fields.closeCount = 2;
      ...
      if ( !v14 )
        goto LABEL_16;
      ContinueDeviceDispMenu__Close_34150448(v14, v15, v16);
LABEL_13:
...
LABEL_16:
        sub_1D0F30C(v5, v6);
      CommonConfirmDialog__Close_32063960(continueDeviceConfirmDialog, v18, 0);
      return 1;
    default:
  ...
  if ( !continueDeviceInputMenu
    ...
    || (CommonConfirmDialog__Init((CommonConfirmDialog_o *)continueDeviceInputMenu, 0),
        (continueDeviceInputMenu = (ContinueDeviceInputMenu_o *)UnityEngine_Component__get_gameObject(
                                                                  ...
                                                                  0)) == 0) )
  {
    sub_1D0F30C(continueDeviceInputMenu, method);
  }
...
void ContinueDeviceComponent__onCloseDialog(ContinueDeviceComponent_o *this, bool result, const MethodInfo *method)
{
  ...
  if ( (byte_4E72341 & 1) == 0 )
  {
    sub_1D0F0B4(&StringLiteral_3556/*"CLOSE_SERIAL_CODE"*/);
    byte_4E72341 = 1;
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    sub_1D0F30C(0, result);
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_3556/*"CLOSE_SERIAL_CODE"*/, 0);
}
...
void ContinueDeviceComponent__onConfirmCode(ContinueDeviceComponent_o *this, bool isDecide, const MethodInfo *method)
{
  ...
  if ( (byte_4E7233B & 1) == 0 )
  {
    sub_1D0F0B4(&ContinueDeviceInputMenu_CallbackFunc_TypeInfo);
    sub_1D0F0B4(&Method_ContinueDeviceComponent_callbackCodeInput__);
    sub_1D0F0B4(&Method_ContinueDeviceComponent_onInputCode__);
    sub_1D0F0B4(&Method_NetworkManager_getRequest_ContinuePrepareRequest___);
  ...
  if ( isDecide )
  {
    ...
    Request_object = (ContinuePrepareRequest_o *)NetworkManager__getRequest_object_(
                                                   v5,
                                                   (const MethodInfo_32DC000 *)Method_NetworkManager_getRequest_ContinuePrepareRequest___);
    if ( Request_object )
    {
...
LABEL_11:
    sub_1D0F30C(Request_object, isDecide);
  }
  ...
  continueDeviceInputMenu = this->fields.continueDeviceInputMenu;
  v8 = (ContinueDeviceInputMenu_CallbackFunc_o *)sub_1D0F300(ContinueDeviceInputMenu_CallbackFunc_TypeInfo);
...
void ContinueDeviceComponent__onConfirmRetry(ContinueDeviceComponent_o *this, bool isDecide, const MethodInfo *method)
{
  ...
  {
    sub_1D0F0B4(&System_Action_TypeInfo);
    sub_1D0F0B4(&ContinueDeviceDispMenu_CallbackFunc_TypeInfo);
    sub_1D0F0B4(&Method_ContinueDeviceComponent_onDispCode__);
    sub_1D0F0B4(&Method_ContinueDeviceComponent_onNextRetryOpen__);
    byte_4E7233F = 1;
  }
  if ( isDecide )
  {
    *(_QWORD *)&this->fields.state = 0x200000000LL;
    ...
    if ( continueDeviceDispMenu )
    {
      ContinueDeviceDispMenu__Close_34150448(continueDeviceDispMenu, v6, v8);
      continueDeviceConfirmDialog = this->fields.continueDeviceConfirmDialog;
      ...
      if ( continueDeviceConfirmDialog )
      {
        CommonConfirmDialog__Close_32063960(continueDeviceConfirmDialog, v10, 0);
        return;
      }
    }
LABEL_10:
    sub_1D0F30C(v7, isDecide);
  }
  ...
  v13 = (ContinueDeviceDispMenu_CallbackFunc_o *)sub_1D0F300(ContinueDeviceDispMenu_CallbackFunc_TypeInfo);
...
void ContinueDeviceComponent__onDispCode(ContinueDeviceComponent_o *this, bool isDecide, const MethodInfo *method)
{
  ...
  if ( (byte_4E7233E & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_ContinueDeviceComponent_onConfirmRetry__);
    sub_1D0F0B4(&LocalizationManager_TypeInfo);
    sub_1D0F0B4(&StringLiteral_3843/*"CONTINUE_DEVICE_CONFIRM_MESSAGE2"*/);
    sub_1D0F0B4(&StringLiteral_3542/*"CLOSE_CONTINUE_DEVICE"*/);
    byte_4E7233E = 1;
  }
  if ( isDecide )
  {
    ...
    v6 = LocalizationManager__Get((System_String_o *)StringLiteral_3843/*"CONTINUE_DEVICE_CONFIRM_MESSAGE2"*/, 0);
    v7 = (CommonConfirmDialog_ClickDelegate_o *)sub_1D0F300(CommonConfirmDialog_ClickDelegate_TypeInfo);
...
LABEL_10:
    sub_1D0F30C(myRoomFsm, isDecide);
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    goto LABEL_10;
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_3542/*"CLOSE_CONTINUE_DEVICE"*/, 0);
}
...
LABEL_11:
    sub_1D0F30C(Request_object, code);
  }
  Request_object = (ContinuePrepareRequest_o *)this->fields.myRoomFsm;
  if ( !Request_object )
    goto LABEL_11;
  PlayMakerFSM__SendEvent((PlayMakerFSM_o *)Request_object, (System_String_o *)StringLiteral_3542/*"CLOSE_CONTINUE_DEVICE"*/, 0);
}
...
void ContinueDeviceComponent__onNextDispOpen(ContinueDeviceComponent_o *this, const MethodInfo *method)
{
  ...
  if ( !v3 )
  {
    ...
    continueDeviceDispMenu = this->fields.continueDeviceDispMenu;
    continueCode = this->fields.continueCode;
    v6 = (ContinueDeviceDispMenu_CallbackFunc_o *)sub_1D0F300(ContinueDeviceDispMenu_CallbackFunc_TypeInfo);
    ContinueDeviceDispMenu_CallbackFunc___ctor(
      v6,
      (Il2CppObject *)this,
      Method_ContinueDeviceComponent_onDispCode__,
...
void ContinueDeviceComponent__onNextRetryOpen(ContinueDeviceComponent_o *this, const MethodInfo *method)
{
  ...
  if ( !v9 )
  {
    ...
    sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.passwardCode, v10, v2, v3, v4, v5, v6, v7);
    v11 = StringLiteral_1/*""*/;
    this->fields.continueCode = (struct System_String_o *)StringLiteral_1/*""*/;
    sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.continueCode, v11, v12, v13, v14, v15, v16, v17);
    continueDeviceInputMenu = this->fields.continueDeviceInputMenu;
    v19 = (ContinueDeviceInputMenu_CallbackFunc_o *)sub_1D0F300(ContinueDeviceInputMenu_CallbackFunc_TypeInfo);
    ContinueDeviceInputMenu_CallbackFunc___ctor(
      v19,
      (Il2CppObject *)this,
      Method_ContinueDeviceComponent_onInputCode__,
...
bool ContinueDeviceComponent__openMenu(ContinueDeviceComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E72337 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_ContinueDeviceComponent_onDispCode__);
    sub_1D0F0B4(&Method_ContinueDeviceComponent_onInputCode__);
    sub_1D0F0B4(&Method_DataManager_GetMasterData_UserContinueMaster___);
    sub_1D0F0B4(&Method_DataMasterBase_UserContinueMaster__UserContinueEntity__long__TryGetEntity__);
    sub_1D0F0B4(&NetworkManager_TypeInfo);
  ...
  MasterData_object = DataManager__GetMasterData_object_(
                        ...
                        (const MethodInfo_324F1B8 *)Method_DataManager_GetMasterData_UserContinueMaster___);
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  if ( !byte_4E710BF )
  {
  ...
  gameObject = (UnityEngine_GameObject_o *)DataMasterBase_object__object__long___TryGetEntity(
                                             ...
                                             *(_QWORD *)(gameObject[7].fields.m_CachedPtr + 64),
                                             (const MethodInfo_3538378 *)Method_DataMasterBase_UserContinueMaster__UserContinueEntity__long__TryGetEntity__);
  if ( ((unsigned __int8)gameObject & 1) != 0 )
  {
    ...
    if ( !LODWORD(entity[1].monitor) )
    {
      ...
      v25 = StringLiteral_1/*""*/;
      this->fields.passwardCode = (struct System_String_o *)StringLiteral_1/*""*/;
      sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.passwardCode, v25, v6, v7, v8, v9, v10, v11);
      if ( entity )
      {
        klass = entity[2].klass;
        this->fields.continueCode = (struct System_String_o *)klass;
        ...
        continueDeviceDispMenu = this->fields.continueDeviceDispMenu;
        continueCode = this->fields.continueCode;
        v35 = (ContinueDeviceDispMenu_CallbackFunc_o *)sub_1D0F300(ContinueDeviceDispMenu_CallbackFunc_TypeInfo);
        ContinueDeviceDispMenu_CallbackFunc___ctor(
          v35,
          (Il2CppObject *)this,
          Method_ContinueDeviceComponent_onDispCode__,
...
LABEL_21:
  ...
  v12 = StringLiteral_1/*""*/;
  this->fields.passwardCode = (struct System_String_o *)StringLiteral_1/*""*/;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.passwardCode, v12, v6, v7, v8, v9, v10, v11);
  v13 = StringLiteral_1/*""*/;
  this->fields.continueCode = (struct System_String_o *)StringLiteral_1/*""*/;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.continueCode, v13, v14, v15, v16, v17, v18, v19);
  continueDeviceInputMenu = this->fields.continueDeviceInputMenu;
  v21 = (ContinueDeviceInputMenu_CallbackFunc_o *)sub_1D0F300(ContinueDeviceInputMenu_CallbackFunc_TypeInfo);
  ContinueDeviceInputMenu_CallbackFunc___ctor(
    v21,
    (Il2CppObject *)this,
    Method_ContinueDeviceComponent_onInputCode__,
