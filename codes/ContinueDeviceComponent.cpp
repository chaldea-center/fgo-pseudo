        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596B43B & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_ContinueDeviceComponent_onNextDispOpen__);
    sub_2213A60(&Method_DataManager_GetMaster_UserContinueMaster___);
    sub_2213A60(&DataManager_TypeInfo);
    sub_2213A60(&Method_DataMasterBase_UserContinueMaster__UserContinueEntity__long__TryGetSingleEntity__);
  ...
  Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataManager__GetMaster_object_((const MethodInfo_3856318 *)Method_DataManager_GetMaster_UserContinueMaster___);
  if ( !Master_object )
    goto LABEL_15;
  Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataMasterBase_object__object__long___TryGetSingleEntity(
                                                                  Master_object,
                                                                  &entity,
                                                                  (const MethodInfo_3F132BC *)Method_DataMasterBase_UserContinueMaster__UserContinueEntity__long__TryGetSingleEntity__);
...
LABEL_15:
  ...
  *(_QWORD *)&this->fields.state = 0x100000000LL;
  ...
  if ( !continueDeviceInputMenu )
    goto LABEL_15;
  ContinueDeviceInputMenu__Close_39758288(continueDeviceInputMenu, v17, v18);
}
...
bool ContinueDeviceComponent__closeMenu(ContinueDeviceComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_2213A60(&System_Action_TypeInfo);
    sub_2213A60(&Method_ContinueDeviceComponent_onClose__);
    byte_596B437 = 1;
  }
  ...
  if ( state <= 3 )
  {
    if ( state != 1 )
    {
      if ( state == 2 )
      {
        ...
        if ( !continueDeviceInputMenu )
          goto LABEL_20;
        ContinueDeviceInputMenu__Close_39758288(continueDeviceInputMenu, v5, v8);
        goto LABEL_12;
      }
LABEL_14:
    ...
    if ( v14 )
    {
      ContinueDeviceInputMenu__Close_39758288(v14, v15, v16);
      return 1;
    }
LABEL_20:
    sub_2213CDC(v6, v7);
  ...
  if ( state == 4 )
  {
    ...
    {
      ContinueDeviceDispMenu__Close_39758604(continueDeviceDispMenu, v18, v19);
      return 1;
    }
    goto LABEL_20;
  }
  ...
  if ( !v9 )
    goto LABEL_20;
  ContinueDeviceDispMenu__Close_39758604(v9, v10, v11);
LABEL_12:
  ...
  if ( !continueDeviceConfirmDialog )
    goto LABEL_20;
  CommonConfirmDialog__Close_37350844(continueDeviceConfirmDialog, v13, 0);
  return 1;
}
  ...
  if ( !continueDeviceInputMenu
    ...
    || (CommonConfirmDialog__Init((CommonConfirmDialog_o *)continueDeviceInputMenu, 0),
        (continueDeviceInputMenu = (ContinueDeviceInputMenu_o *)UnityEngine_Component__get_gameObject(
                                                                  ...
                                                                  0)) == 0) )
  {
    sub_2213CDC(continueDeviceInputMenu, method);
  }
...
void ContinueDeviceComponent__onCloseDialog(ContinueDeviceComponent_o *this, bool result, const MethodInfo *method)
{
  ...
  if ( (byte_596B440 & 1) == 0 )
  {
    sub_2213A60(&StringLiteral_3660/*"CLOSE_SERIAL_CODE"*/);
    byte_596B440 = 1;
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    sub_2213CDC(0, result);
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_3660/*"CLOSE_SERIAL_CODE"*/, 0);
}
...
void ContinueDeviceComponent__onConfirmCode(ContinueDeviceComponent_o *this, bool isDecide, const MethodInfo *method)
{
  ...
  if ( (byte_596B43A & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_ContinueDeviceComponent_callbackCodeInput__);
    sub_2213A60(&Method_ContinueDeviceComponent_onInputCode__);
    sub_2213A60(&Method_NetworkManager_getRequest_ContinuePrepareRequest___);
  ...
  if ( isDecide )
  {
    ...
    Request_object = (ContinuePrepareRequest_o *)NetworkManager__getRequest_object_(
                                                   v6,
                                                   (const MethodInfo_38F1B78 *)Method_NetworkManager_getRequest_ContinuePrepareRequest___);
    if ( Request_object )
    {
...
LABEL_11:
    sub_2213CDC(Request_object, isDecide);
  }
  ...
  continueDeviceInputMenu = this->fields.continueDeviceInputMenu;
  v11 = (ContinueDeviceInputMenu_CallbackFunc_o *)sub_2213CCC(ContinueDeviceInputMenu_CallbackFunc_TypeInfo);
...
void ContinueDeviceComponent__onConfirmRetry(ContinueDeviceComponent_o *this, bool isDecide, const MethodInfo *method)
{
  ...
  {
    sub_2213A60(&System_Action_TypeInfo);
    sub_2213A60(&ContinueDeviceDispMenu_CallbackFunc_TypeInfo);
    sub_2213A60(&Method_ContinueDeviceComponent_onDispCode__);
    sub_2213A60(&Method_ContinueDeviceComponent_onNextRetryOpen__);
    byte_596B43E = 1;
  }
  if ( isDecide )
  {
    ...
    *(_QWORD *)&this->fields.state = 0x200000000LL;
    v7 = (System_Action_o *)sub_2213CCC(v6);
    System_Action___ctor(v7, (Il2CppObject *)this, Method_ContinueDeviceComponent_onNextRetryOpen__, 0);
    if ( continueDeviceDispMenu )
    {
      ContinueDeviceDispMenu__Close_39758604(continueDeviceDispMenu, v7, v9);
      continueDeviceConfirmDialog = this->fields.continueDeviceConfirmDialog;
      ...
      if ( continueDeviceConfirmDialog )
      {
        CommonConfirmDialog__Close_37350844(continueDeviceConfirmDialog, v11, 0);
        return;
      }
    }
LABEL_10:
    sub_2213CDC(v8, isDecide);
  }
  ...
  v14 = (ContinueDeviceDispMenu_CallbackFunc_o *)sub_2213CCC(ContinueDeviceDispMenu_CallbackFunc_TypeInfo);
...
void ContinueDeviceComponent__onDispCode(ContinueDeviceComponent_o *this, bool isDecide, const MethodInfo *method)
{
  ...
  if ( (byte_596B43D & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_ContinueDeviceComponent_onConfirmRetry__);
    sub_2213A60(&LocalizationManager_TypeInfo);
    sub_2213A60(&StringLiteral_3948/*"CONTINUE_DEVICE_CONFIRM_MESSAGE2"*/);
    sub_2213A60(&StringLiteral_3646/*"CLOSE_CONTINUE_DEVICE"*/);
    byte_596B43D = 1;
  }
  if ( isDecide )
  {
    ...
    v7 = LocalizationManager__Get((System_String_o *)StringLiteral_3948/*"CONTINUE_DEVICE_CONFIRM_MESSAGE2"*/, 0);
...
LABEL_10:
    sub_2213CDC(myRoomFsm, isDecide);
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    goto LABEL_10;
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_3646/*"CLOSE_CONTINUE_DEVICE"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( code )
  {
    ...
    this->fields.state = 3;
    v11 = (NetworkManager_ResultCallbackFunc_o *)sub_2213CCC(v10);
    NetworkManager_ResultCallbackFunc___ctor(
      v11,
      (Il2CppObject *)this,
      Method_ContinueDeviceComponent_callbackCodeInput__,
...
LABEL_11:
    sub_2213CDC(Request_object, code);
  }
  Request_object = (ContinuePrepareRequest_o *)this->fields.myRoomFsm;
  if ( !Request_object )
    goto LABEL_11;
  PlayMakerFSM__SendEvent((PlayMakerFSM_o *)Request_object, (System_String_o *)StringLiteral_3646/*"CLOSE_CONTINUE_DEVICE"*/, 0);
}
...
void ContinueDeviceComponent__onNextDispOpen(ContinueDeviceComponent_o *this, const MethodInfo *method)
{
  ...
  if ( !v3 )
  {
    ...
    continueCode = this->fields.continueCode;
    this->fields.state = 4;
    v6 = (ContinueDeviceDispMenu_CallbackFunc_o *)sub_2213CCC(ContinueDeviceDispMenu_CallbackFunc_TypeInfo);
    ContinueDeviceDispMenu_CallbackFunc___ctor(
      v6,
      (Il2CppObject *)this,
      Method_ContinueDeviceComponent_onDispCode__,
...
void ContinueDeviceComponent__onNextRetryOpen(ContinueDeviceComponent_o *this, const MethodInfo *method)
{
  ...
  if ( !v9 )
  {
    ...
    sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields.passwardCode, v10, v2, v3, v4, v5, v6, v7);
    v11 = (int)StringLiteral_1/*""*/;
    this->fields.continueCode = (struct System_String_o *)StringLiteral_1/*""*/;
    sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields.continueCode, v11, v12, v13, v14, v15, v16, v17);
    continueDeviceInputMenu = this->fields.continueDeviceInputMenu;
    v19 = (ContinueDeviceInputMenu_CallbackFunc_o *)sub_2213CCC(ContinueDeviceInputMenu_CallbackFunc_TypeInfo);
    ContinueDeviceInputMenu_CallbackFunc___ctor(
      v19,
      (Il2CppObject *)this,
      Method_ContinueDeviceComponent_onInputCode__,
...
bool ContinueDeviceComponent__openMenu(ContinueDeviceComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596B436 & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_ContinueDeviceComponent_onDispCode__);
    sub_2213A60(&Method_ContinueDeviceComponent_onInputCode__);
    sub_2213A60(&Method_DataManager_GetMasterData_UserContinueMaster___);
    sub_2213A60(&Method_DataMasterBase_UserContinueMaster__UserContinueEntity__long__TryGetEntity__);
    sub_2213A60(&NetworkManager_TypeInfo);
  ...
  MasterData_object = DataManager__GetMasterData_object_(
                        ...
                        (const MethodInfo_385636C *)Method_DataManager_GetMasterData_UserContinueMaster___);
  if ( !*(&NetworkManager_TypeInfo->_2.cctor_finished + 1) )
  ...
  gameObject = (UnityEngine_GameObject_o *)DataMasterBase_object__object__long___TryGetEntity(
                                             ...
                                             *(_QWORD *)(gameObject[7].fields.m_CachedPtr + 64),
                                             (const MethodInfo_3F131DC *)Method_DataMasterBase_UserContinueMaster__UserContinueEntity__long__TryGetEntity__);
  if ( ((unsigned __int8)gameObject & 1) != 0 )
  {
    ...
    if ( !LODWORD(entity[1].monitor) )
    {
      ...
      this->fields.passwardCode = (struct System_String_o *)StringLiteral_1/*""*/;
      this->fields.state = 4;
      sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields.passwardCode, v26, v7, v8, v9, v10, v11, v12);
      if ( entity )
      {
        klass = entity[2].klass;
        this->fields.continueCode = (struct System_String_o *)klass;
        ...
        continueDeviceDispMenu = this->fields.continueDeviceDispMenu;
        continueCode = this->fields.continueCode;
        v36 = (ContinueDeviceDispMenu_CallbackFunc_o *)sub_2213CCC(ContinueDeviceDispMenu_CallbackFunc_TypeInfo);
        ContinueDeviceDispMenu_CallbackFunc___ctor(
          v36,
          (Il2CppObject *)this,
          Method_ContinueDeviceComponent_onDispCode__,
...
LABEL_21:
  ...
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields.passwardCode, (int32_t)v13, v7, v8, v9, v10, v11, v12);
  v14 = (int)StringLiteral_1/*""*/;
  this->fields.continueCode = (struct System_String_o *)StringLiteral_1/*""*/;
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields.continueCode, v14, v15, v16, v17, v18, v19, v20);
  continueDeviceInputMenu = this->fields.continueDeviceInputMenu;
  v22 = (ContinueDeviceInputMenu_CallbackFunc_o *)sub_2213CCC(ContinueDeviceInputMenu_CallbackFunc_TypeInfo);
  ContinueDeviceInputMenu_CallbackFunc___ctor(
    v22,
    (Il2CppObject *)this,
    Method_ContinueDeviceComponent_onInputCode__,
