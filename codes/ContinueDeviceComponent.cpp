        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC2D43 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_ContinueDeviceComponent_onNextDispOpen__, v5);
    sub_1C1ABD4(&Method_DataManager_GetMaster_UserContinueMaster___, v6);
    sub_1C1ABD4(&DataManager_TypeInfo, v7);
    sub_1C1ABD4(&Method_DataMasterBase_UserContinueMaster__UserContinueEntity__long__TryGetSingleEntity__, v8);
  ...
  Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataManager__GetMaster_object_((const MethodInfo_2F9F43C *)Method_DataManager_GetMaster_UserContinueMaster___);
  if ( !Master_object )
    goto LABEL_15;
  Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataMasterBase_object__object__long___TryGetSingleEntity(
                                                                  Master_object,
                                                                  &entity,
                                                                  (const MethodInfo_324AD00 *)Method_DataMasterBase_UserContinueMaster__UserContinueEntity__long__TryGetSingleEntity__);
...
LABEL_15:
  ...
  sub_1C1AB78(&this->fields.continueCode);
  ...
  *(_QWORD *)&this->fields.state = 0x100000000LL;
  ...
  if ( !continueDeviceInputMenu )
    goto LABEL_15;
  ContinueDeviceInputMenu__Close_31917328(continueDeviceInputMenu, v13, v14);
}
...
bool __fastcall ContinueDeviceComponent__closeMenu(ContinueDeviceComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC2D3F & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_ContinueDeviceComponent_onClose__, v3);
    byte_4BC2D3F = 1;
  }
  switch ( this->fields.state )
  {
    case 1:
      ...
      if ( !continueDeviceInputMenu )
        goto LABEL_16;
      ContinueDeviceInputMenu__Close_31917328(continueDeviceInputMenu, v5, v8);
      return 1;
    case 2:
      ...
      if ( !v9 )
        goto LABEL_16;
      ContinueDeviceInputMenu__Close_31917328(v9, v10, v11);
      goto LABEL_13;
    case 4:
      this->fields.closeCount = 1;
      ...
      if ( !continueDeviceDispMenu )
        goto LABEL_16;
      ContinueDeviceDispMenu__Close_31917644(continueDeviceDispMenu, v13, v14);
      return 1;
    case 5:
      this->fields.closeCount = 2;
      ...
      if ( !v15 )
        goto LABEL_16;
      ContinueDeviceDispMenu__Close_31917644(v15, v16, v17);
LABEL_13:
...
LABEL_16:
        sub_1C1AE30(v6, v7);
      CommonConfirmDialog__Close_31075196(continueDeviceConfirmDialog, v19, 0LL);
      return 1;
    default:
  ...
  if ( !continueDeviceInputMenu
    ...
    || (CommonConfirmDialog__Init((CommonConfirmDialog_o *)continueDeviceInputMenu, 0LL),
        (continueDeviceInputMenu = (ContinueDeviceInputMenu_o *)UnityEngine_Component__get_gameObject(
                                                                  ...
                                                                  0LL)) == 0LL) )
  {
    sub_1C1AE30(continueDeviceInputMenu, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC2D48 & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_3644/*"CLOSE_SERIAL_CODE"*/, result);
    byte_4BC2D48 = 1;
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    sub_1C1AE30(0LL, result);
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_3644/*"CLOSE_SERIAL_CODE"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC2D49 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_3644/*"CLOSE_SERIAL_CODE"*/, v4);
    byte_4BC2D49 = 1;
  }
  ...
  PlayMakerFSM__SendEvent((PlayMakerFSM_o *)Instance, (System_String_o *)StringLiteral_3644/*"CLOSE_SERIAL_CODE"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC2D42 & 1) == 0 )
  {
    sub_1C1ABD4(&ContinueDeviceInputMenu_CallbackFunc_TypeInfo, isDecide);
    sub_1C1ABD4(&Method_ContinueDeviceComponent_callbackCodeInput__, v5);
    sub_1C1ABD4(&Method_ContinueDeviceComponent_onInputCode__, v6);
    sub_1C1ABD4(&Method_NetworkManager_getRequest_ContinuePrepareRequest___, v7);
  ...
  if ( isDecide )
  {
    ...
    Request_object = (ContinuePrepareRequest_o *)NetworkManager__getRequest_object_(
                                                   v10,
                                                   (const MethodInfo_3023C78 *)Method_NetworkManager_getRequest_ContinuePrepareRequest___);
    if ( Request_object )
    {
...
LABEL_11:
    sub_1C1AE30(Request_object, isDecide);
  }
  ...
  continueDeviceInputMenu = this->fields.continueDeviceInputMenu;
  v13 = (ContinueDeviceInputMenu_CallbackFunc_o *)sub_1C1AE20(ContinueDeviceInputMenu_CallbackFunc_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC2D46 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&ContinueDeviceDispMenu_CallbackFunc_TypeInfo, v5);
    sub_1C1ABD4(&Method_ContinueDeviceComponent_onDispCode__, v6);
    sub_1C1ABD4(&Method_ContinueDeviceComponent_onNextRetryOpen__, v7);
    byte_4BC2D46 = 1;
  }
  if ( isDecide )
  {
    *(_QWORD *)&this->fields.state = 0x200000000LL;
    ...
    if ( continueDeviceDispMenu )
    {
      ContinueDeviceDispMenu__Close_31917644(continueDeviceDispMenu, v9, v11);
      continueDeviceConfirmDialog = this->fields.continueDeviceConfirmDialog;
      v13 = (System_Action_o *)sub_1C1AE20(System_Action_TypeInfo);
      System_Action___ctor(v13, (Il2CppObject *)this, Method_ContinueDeviceComponent_onNextRetryOpen__, 0LL);
      if ( continueDeviceConfirmDialog )
      {
        CommonConfirmDialog__Close_31075196(continueDeviceConfirmDialog, v13, 0LL);
        return;
      }
    }
LABEL_10:
    sub_1C1AE30(v10, isDecide);
  }
  ...
  v16 = (ContinueDeviceDispMenu_CallbackFunc_o *)sub_1C1AE20(ContinueDeviceDispMenu_CallbackFunc_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC2D45 & 1) == 0 )
  {
    sub_1C1ABD4(&CommonConfirmDialog_ClickDelegate_TypeInfo, isDecide);
    sub_1C1ABD4(&Method_ContinueDeviceComponent_onConfirmRetry__, v5);
    sub_1C1ABD4(&LocalizationManager_TypeInfo, v6);
    sub_1C1ABD4(&StringLiteral_3910/*"CONTINUE_DEVICE_CONFIRM_MESSAGE2"*/, v7);
    sub_1C1ABD4(&StringLiteral_3630/*"CLOSE_CONTINUE_DEVICE"*/, v8);
    byte_4BC2D45 = 1;
  }
  if ( isDecide )
  {
    ...
    v10 = LocalizationManager__Get((System_String_o *)StringLiteral_3910/*"CONTINUE_DEVICE_CONFIRM_MESSAGE2"*/, 0LL);
    v11 = (CommonConfirmDialog_ClickDelegate_o *)sub_1C1AE20(CommonConfirmDialog_ClickDelegate_TypeInfo);
...
LABEL_10:
    sub_1C1AE30(myRoomFsm, isDecide);
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    goto LABEL_10;
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_3630/*"CLOSE_CONTINUE_DEVICE"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC2D41 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_ContinueDeviceComponent_callbackCodeInput__, code);
    sub_1C1ABD4(&Method_NetworkManager_getRequest_ContinuePrepareRequest___, v5);
  ...
  if ( code )
  {
    ...
    sub_1C1AB78(&this->fields.passwardCode);
    this->fields.state = 3;
...
LABEL_11:
    sub_1C1AE30(Request_object, code);
  }
  Request_object = (ContinuePrepareRequest_o *)this->fields.myRoomFsm;
  if ( !Request_object )
    goto LABEL_11;
  PlayMakerFSM__SendEvent((PlayMakerFSM_o *)Request_object, (System_String_o *)StringLiteral_3630/*"CLOSE_CONTINUE_DEVICE"*/, 0LL);
}
...
void __fastcall ContinueDeviceComponent__onNextDispOpen(ContinueDeviceComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC2D44 & 1) == 0 )
  {
    sub_1C1ABD4(&ContinueDeviceDispMenu_CallbackFunc_TypeInfo, method);
    sub_1C1ABD4(&Method_ContinueDeviceComponent_onDispCode__, v3);
    byte_4BC2D44 = 1;
  }
  ...
  if ( !v4 )
  {
    ...
    continueDeviceDispMenu = this->fields.continueDeviceDispMenu;
    continueCode = this->fields.continueCode;
    v7 = (ContinueDeviceDispMenu_CallbackFunc_o *)sub_1C1AE20(ContinueDeviceDispMenu_CallbackFunc_TypeInfo);
    ContinueDeviceDispMenu_CallbackFunc___ctor(
      v7,
      (Il2CppObject *)this,
      Method_ContinueDeviceComponent_onDispCode__,
...
void __fastcall ContinueDeviceComponent__onNextRetryOpen(ContinueDeviceComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC2D47 & 1) == 0 )
  {
    sub_1C1ABD4(&ContinueDeviceInputMenu_CallbackFunc_TypeInfo, method);
    sub_1C1ABD4(&Method_ContinueDeviceComponent_onInputCode__, v3);
  ...
  if ( !v5 )
  {
    ...
    sub_1C1AB78(&this->fields.continueCode);
    continueDeviceInputMenu = this->fields.continueDeviceInputMenu;
    v7 = (ContinueDeviceInputMenu_CallbackFunc_o *)sub_1C1AE20(ContinueDeviceInputMenu_CallbackFunc_TypeInfo);
    ContinueDeviceInputMenu_CallbackFunc___ctor(
      v7,
      (Il2CppObject *)this,
      Method_ContinueDeviceComponent_onInputCode__,
...
bool __fastcall ContinueDeviceComponent__openMenu(ContinueDeviceComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C1ABD4(&ContinueDeviceInputMenu_CallbackFunc_TypeInfo, method);
    sub_1C1ABD4(&ContinueDeviceDispMenu_CallbackFunc_TypeInfo, v3);
    sub_1C1ABD4(&Method_ContinueDeviceComponent_onDispCode__, v4);
    sub_1C1ABD4(&Method_ContinueDeviceComponent_onInputCode__, v5);
    sub_1C1ABD4(&Method_DataManager_GetMasterData_UserContinueMaster___, v6);
    sub_1C1ABD4(&Method_DataMasterBase_UserContinueMaster__UserContinueEntity__long__TryGetEntity__, v7);
    sub_1C1ABD4(&NetworkManager_TypeInfo, v8);
  ...
  MasterData_object = DataManager__GetMasterData_object_(
                        ...
                        (const MethodInfo_2F9F490 *)Method_DataManager_GetMasterData_UserContinueMaster___);
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  if ( !byte_4BC2585 )
  {
  ...
  gameObject = DataMasterBase_object__object__long___TryGetEntity(
                 ...
                 *(_QWORD *)(*(_QWORD *)(gameObject + 184) + 64LL),
                 (const MethodInfo_324AC20 *)Method_DataMasterBase_UserContinueMaster__UserContinueEntity__long__TryGetEntity__);
  if ( (gameObject & 1) != 0 )
  {
    if ( !entity )
      goto LABEL_21;
    if ( !LODWORD(entity[1].monitor) )
    {
      this->fields.state = 4;
      this->fields.passwardCode = (struct System_String_o *)StringLiteral_1/*""*/;
      gameObject = sub_1C1AB78(&this->fields.passwardCode);
      if ( entity )
      {
        this->fields.continueCode = (struct System_String_o *)entity[2].klass;
        sub_1C1AB78(&this->fields.continueCode);
        continueDeviceDispMenu = this->fields.continueDeviceDispMenu;
        continueCode = this->fields.continueCode;
        v21 = (ContinueDeviceDispMenu_CallbackFunc_o *)sub_1C1AE20(ContinueDeviceDispMenu_CallbackFunc_TypeInfo);
        ContinueDeviceDispMenu_CallbackFunc___ctor(
          v21,
          (Il2CppObject *)this,
          Method_ContinueDeviceComponent_onDispCode__,
...
LABEL_21:
  ...
  sub_1C1AB78(&this->fields.continueCode);
  continueDeviceInputMenu = this->fields.continueDeviceInputMenu;
  v15 = (ContinueDeviceInputMenu_CallbackFunc_o *)sub_1C1AE20(ContinueDeviceInputMenu_CallbackFunc_TypeInfo);
  ContinueDeviceInputMenu_CallbackFunc___ctor(
    v15,
    (Il2CppObject *)this,
    Method_ContinueDeviceComponent_onInputCode__,
