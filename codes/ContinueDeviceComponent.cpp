        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD77C4 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_ContinueDeviceComponent_onNextDispOpen__);
    sub_1C21E38(&Method_DataManager_GetMaster_UserContinueMaster___);
    sub_1C21E38(&DataManager_TypeInfo);
    sub_1C21E38(&Method_DataMasterBase_UserContinueMaster__UserContinueEntity__long__TryGetSingleEntity__);
  ...
  Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataManager__GetMaster_object_((const MethodInfo_2FAFDB0 *)Method_DataManager_GetMaster_UserContinueMaster___);
  if ( !Master_object )
    goto LABEL_15;
  Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataMasterBase_object__object__long___TryGetSingleEntity(
                                                                  Master_object,
                                                                  &entity,
                                                                  (const MethodInfo_325E450 *)Method_DataMasterBase_UserContinueMaster__UserContinueEntity__long__TryGetSingleEntity__);
...
LABEL_15:
  ...
  sub_1C21DDC(&this->fields.continueCode, klass);
  ...
  *(_QWORD *)&this->fields.state = 0x100000000LL;
  ...
  if ( !continueDeviceInputMenu )
    goto LABEL_15;
  ContinueDeviceInputMenu__Close_31952104(continueDeviceInputMenu, v9, v10);
}
...
bool __fastcall ContinueDeviceComponent__closeMenu(ContinueDeviceComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C21E38(&System_Action_TypeInfo);
    sub_1C21E38(&Method_ContinueDeviceComponent_onClose__);
    byte_4BD77C0 = 1;
  }
  switch ( this->fields.state )
  {
    case 1:
      ...
      if ( !continueDeviceInputMenu )
        goto LABEL_16;
      ContinueDeviceInputMenu__Close_31952104(continueDeviceInputMenu, v4, v7);
      return 1;
    case 2:
      ...
      if ( !v8 )
        goto LABEL_16;
      ContinueDeviceInputMenu__Close_31952104(v8, v9, v10);
      goto LABEL_13;
    case 4:
      this->fields.closeCount = 1;
      ...
      if ( !continueDeviceDispMenu )
        goto LABEL_16;
      ContinueDeviceDispMenu__Close_31952420(continueDeviceDispMenu, v12, v13);
      return 1;
    case 5:
      this->fields.closeCount = 2;
      ...
      if ( !v14 )
        goto LABEL_16;
      ContinueDeviceDispMenu__Close_31952420(v14, v15, v16);
LABEL_13:
...
LABEL_16:
        sub_1C22094(v5, v6);
      CommonConfirmDialog__Close_31104488(continueDeviceConfirmDialog, v18, 0LL);
      return 1;
    default:
  ...
  if ( !continueDeviceInputMenu
    ...
    || (CommonConfirmDialog__Init((CommonConfirmDialog_o *)continueDeviceInputMenu, 0LL),
        (continueDeviceInputMenu = (ContinueDeviceInputMenu_o *)UnityEngine_Component__get_gameObject(
                                                                  ...
                                                                  0LL)) == 0LL) )
  {
    sub_1C22094(continueDeviceInputMenu, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  PlayMakerFSM__SendEvent((PlayMakerFSM_o *)Instance, (System_String_o *)StringLiteral_3653/*"CLOSE_SERIAL_CODE"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD77C3 & 1) == 0 )
  {
    sub_1C21E38(&ContinueDeviceInputMenu_CallbackFunc_TypeInfo);
    sub_1C21E38(&Method_ContinueDeviceComponent_callbackCodeInput__);
    sub_1C21E38(&Method_ContinueDeviceComponent_onInputCode__);
    sub_1C21E38(&Method_NetworkManager_getRequest_ContinuePrepareRequest___);
  ...
  if ( isDecide )
  {
    ...
    Request_object = (ContinuePrepareRequest_o *)NetworkManager__getRequest_object_(
                                                   v5,
                                                   (const MethodInfo_30345EC *)Method_NetworkManager_getRequest_ContinuePrepareRequest___);
    if ( Request_object )
    {
...
LABEL_11:
    sub_1C22094(Request_object, isDecide);
  }
  ...
  continueDeviceInputMenu = this->fields.continueDeviceInputMenu;
  v8 = (ContinueDeviceInputMenu_CallbackFunc_o *)sub_1C22084(ContinueDeviceInputMenu_CallbackFunc_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C21E38(&System_Action_TypeInfo);
    sub_1C21E38(&ContinueDeviceDispMenu_CallbackFunc_TypeInfo);
    sub_1C21E38(&Method_ContinueDeviceComponent_onDispCode__);
    sub_1C21E38(&Method_ContinueDeviceComponent_onNextRetryOpen__);
    byte_4BD77C7 = 1;
  }
  if ( isDecide )
  {
    *(_QWORD *)&this->fields.state = 0x200000000LL;
    ...
    if ( continueDeviceDispMenu )
    {
      ContinueDeviceDispMenu__Close_31952420(continueDeviceDispMenu, v6, v8);
      continueDeviceConfirmDialog = this->fields.continueDeviceConfirmDialog;
      ...
      if ( continueDeviceConfirmDialog )
      {
        CommonConfirmDialog__Close_31104488(continueDeviceConfirmDialog, v10, 0LL);
        return;
      }
    }
LABEL_10:
    sub_1C22094(v7, isDecide);
  }
  ...
  v13 = (ContinueDeviceDispMenu_CallbackFunc_o *)sub_1C22084(ContinueDeviceDispMenu_CallbackFunc_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD77C6 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_ContinueDeviceComponent_onConfirmRetry__);
    sub_1C21E38(&LocalizationManager_TypeInfo);
    sub_1C21E38(&StringLiteral_3919/*"CONTINUE_DEVICE_CONFIRM_MESSAGE2"*/);
  ...
  if ( isDecide )
  {
    ...
    v6 = LocalizationManager__Get((System_String_o *)StringLiteral_3919/*"CONTINUE_DEVICE_CONFIRM_MESSAGE2"*/, 0LL);
...
LABEL_10:
    sub_1C22094(myRoomFsm, isDecide);
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    goto LABEL_10;
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_3639/*"CLOSE_CONTINUE_DEVICE"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( code )
  {
    ...
    sub_1C21DDC(&this->fields.passwardCode, code);
    this->fields.state = 3;
    v5 = (NetworkManager_ResultCallbackFunc_o *)sub_1C22084(NetworkManager_ResultCallbackFunc_TypeInfo);
    NetworkManager_ResultCallbackFunc___ctor(
      v5,
...
LABEL_11:
    sub_1C22094(Request_object, code);
  }
  Request_object = (ContinuePrepareRequest_o *)this->fields.myRoomFsm;
  if ( !Request_object )
    goto LABEL_11;
  PlayMakerFSM__SendEvent((PlayMakerFSM_o *)Request_object, (System_String_o *)StringLiteral_3639/*"CLOSE_CONTINUE_DEVICE"*/, 0LL);
}
...
void __fastcall ContinueDeviceComponent__onNextDispOpen(ContinueDeviceComponent_o *this, const MethodInfo *method)
{
  ...
  if ( !v3 )
  {
    ...
    continueDeviceDispMenu = this->fields.continueDeviceDispMenu;
    continueCode = this->fields.continueCode;
    v6 = (ContinueDeviceDispMenu_CallbackFunc_o *)sub_1C22084(ContinueDeviceDispMenu_CallbackFunc_TypeInfo);
    ContinueDeviceDispMenu_CallbackFunc___ctor(
      v6,
      (Il2CppObject *)this,
      Method_ContinueDeviceComponent_onDispCode__,
...
void __fastcall ContinueDeviceComponent__onNextRetryOpen(ContinueDeviceComponent_o *this, const MethodInfo *method)
{
  ...
  if ( !v3 )
  {
    ...
    sub_1C21DDC(&this->fields.passwardCode, v4);
    v5 = StringLiteral_1/*""*/;
    this->fields.continueCode = (struct System_String_o *)StringLiteral_1/*""*/;
    sub_1C21DDC(&this->fields.continueCode, v5);
    continueDeviceInputMenu = this->fields.continueDeviceInputMenu;
    v7 = (ContinueDeviceInputMenu_CallbackFunc_o *)sub_1C22084(ContinueDeviceInputMenu_CallbackFunc_TypeInfo);
    ContinueDeviceInputMenu_CallbackFunc___ctor(
      v7,
      (Il2CppObject *)this,
      Method_ContinueDeviceComponent_onInputCode__,
...
bool __fastcall ContinueDeviceComponent__openMenu(ContinueDeviceComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD77BF & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_ContinueDeviceComponent_onDispCode__);
    sub_1C21E38(&Method_ContinueDeviceComponent_onInputCode__);
    sub_1C21E38(&Method_DataManager_GetMasterData_UserContinueMaster___);
    sub_1C21E38(&Method_DataMasterBase_UserContinueMaster__UserContinueEntity__long__TryGetEntity__);
    sub_1C21E38(&NetworkManager_TypeInfo);
  ...
  MasterData_object = DataManager__GetMasterData_object_(
                        ...
                        (const MethodInfo_2FAFE04 *)Method_DataManager_GetMasterData_UserContinueMaster___);
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  if ( !byte_4BD6FF5 )
  {
  ...
  gameObject = DataMasterBase_object__object__long___TryGetEntity(
                 ...
                 *(_QWORD *)(*(_QWORD *)(gameObject + 184) + 64LL),
                 (const MethodInfo_325E370 *)Method_DataMasterBase_UserContinueMaster__UserContinueEntity__long__TryGetEntity__);
  if ( (gameObject & 1) != 0 )
  {
    if ( !entity )
      goto LABEL_21;
    if ( !LODWORD(entity[1].monitor) )
    {
      ...
      v13 = StringLiteral_1/*""*/;
      this->fields.passwardCode = (struct System_String_o *)StringLiteral_1/*""*/;
      gameObject = sub_1C21DDC(&this->fields.passwardCode, v13);
      if ( entity )
      {
        klass = entity[2].klass;
        this->fields.continueCode = (struct System_String_o *)klass;
        ...
        continueDeviceDispMenu = this->fields.continueDeviceDispMenu;
        continueCode = this->fields.continueCode;
        v17 = (ContinueDeviceDispMenu_CallbackFunc_o *)sub_1C22084(ContinueDeviceDispMenu_CallbackFunc_TypeInfo);
        ContinueDeviceDispMenu_CallbackFunc___ctor(
          v17,
          (Il2CppObject *)this,
          Method_ContinueDeviceComponent_onDispCode__,
...
LABEL_21:
  ...
  v6 = StringLiteral_1/*""*/;
  this->fields.passwardCode = (struct System_String_o *)StringLiteral_1/*""*/;
  sub_1C21DDC(&this->fields.passwardCode, v6);
  v7 = StringLiteral_1/*""*/;
  this->fields.continueCode = (struct System_String_o *)StringLiteral_1/*""*/;
  sub_1C21DDC(&this->fields.continueCode, v7);
  continueDeviceInputMenu = this->fields.continueDeviceInputMenu;
  v9 = (ContinueDeviceInputMenu_CallbackFunc_o *)sub_1C22084(ContinueDeviceInputMenu_CallbackFunc_TypeInfo);
  ContinueDeviceInputMenu_CallbackFunc___ctor(
    v9,
    (Il2CppObject *)this,
    Method_ContinueDeviceComponent_onInputCode__,
