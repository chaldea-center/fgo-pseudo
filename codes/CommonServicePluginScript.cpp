void CommonServicePluginScript___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4D28D0C & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_21347/*"jp.delightworks.unityplugin.CommonServicePlugin"*/);
    byte_4D28D0C = 1;
  }
  v1 = (UnityEngine_AndroidJavaClass_o *)sub_1C93D20(UnityEngine_AndroidJavaClass_TypeInfo);
  UnityEngine_AndroidJavaClass___ctor(v1, (System_String_o *)StringLiteral_21347/*"jp.delightworks.unityplugin.CommonServicePlugin"*/, 0);
  CommonServicePluginScript_TypeInfo->static_fields->classPlugin = v1;
  sub_1C93A78(CommonServicePluginScript_TypeInfo->static_fields, v1);
}
...
int64_t CommonServicePluginScript__GetFreeSize(System_String_o *path, const MethodInfo *method)
{
  ...
  if ( (byte_4D28D0D & 1) == 0 )
  {
    sub_1C93AD4(&Method_UnityEngine_AndroidJavaObject_CallStatic_long___);
    sub_1C93AD4(&CommonServicePluginScript_TypeInfo);
    sub_1C93AD4(&object___TypeInfo);
    sub_1C93AD4(&StringLiteral_7119/*"GetFreeSize"*/);
    byte_4D28D0D = 1;
  }
  ...
  if ( path )
  {
    v5 = sub_1C93C10(path, *(_QWORD *)(*(_QWORD *)v5 + 64LL));
    if ( !v5 )
    {
      v11 = sub_1C93D50();
      sub_1C93BFC(v11, 0);
  ...
  if ( !*(_DWORD *)(v7 + 24) )
    sub_1C93D34(v5);
  *(_QWORD *)(v7 + 32) = path;
  v8 = sub_1C93A78(v7 + 32, path);
  if ( !classPlugin )
    sub_1C93D2C(v8, v9);
  return UnityEngine_AndroidJavaObject__CallStatic_long_(
           classPlugin,
           (System_String_o *)StringLiteral_7119/*"GetFreeSize"*/,
           (System_Object_array *)v7,
           (const MethodInfo_30EFE3C *)Method_UnityEngine_AndroidJavaObject_CallStatic_long___);
}