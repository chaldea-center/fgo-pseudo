void __fastcall BlankEarthShortcutButtonListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48DF490 & 1) == 0 )
  {
    sub_1B00CCC(&BlankEarthShortcutButtonListViewItemDraw_TypeInfo, v1);
    byte_48DF490 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DF48D & 1) == 0 )
  {
    sub_1B00CCC(&BlankEarthShortcutButtonListViewItemDraw_TypeInfo, item);
    sub_1B00CCC(&Method_UnityEngine_Component_GetComponentInParent_BlankEarthShortcutUIButton___, v6);
    sub_1B00CCC(&Method_System_Linq_Enumerable_ToList_string___, v7);
    sub_1B00CCC(&Method_GameObjectExtensions_SafeGetComponent_UISprite___, v8);
    sub_1B00CCC(&Method_System_Collections_Generic_List_GameObject__Add__, v9);
    sub_1B00CCC(&Method_System_Collections_Generic_List_GameObject__ToArray__, v10);
    sub_1B00CCC(&Method_System_Collections_Generic_List_GameObject___ctor__, v11);
    sub_1B00CCC(&Method_System_Collections_Generic_List_string__get_Item__, v12);
    sub_1B00CCC(&System_Collections_Generic_List_GameObject__TypeInfo, v13);
    sub_1B00CCC(&UnityEngine_Object_TypeInfo, v14);
    sub_1B00CCC(&UICommonButtonColor_TypeInfo, v15);
    sub_1B00CCC(&StringLiteral_43/*"\n"*/, v16);
    sub_1B00CCC(&StringLiteral_87/*"\r\n"*/, v17);
    sub_1B00CCC(&StringLiteral_17293/*"btn_shortcut"*/, v18);
    this = (BlankEarthShortcutButtonListViewItemDraw_o *)sub_1B00CCC(&StringLiteral_18941/*"event_logo_shortcut_"*/, v19);
    byte_48DF48D = 1;
  }
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&v5->fields.bgSprite, (int32_t)Component_object, v24, v25);
  ...
  if ( !*p_bgSprite )
    goto LABEL_71;
  UISprite__set_spriteName((UISprite_o *)this, (System_String_o *)StringLiteral_17293/*"btn_shortcut"*/, 0LL);
  this = *p_bgSprite;
  if ( !*p_bgSprite )
    goto LABEL_71;
  ...
  ComponentInParent_object = UnityEngine_Component__GetComponentInParent_object_(
                               ...
                               (const MethodInfo_2D59D70 *)Method_UnityEngine_Component_GetComponentInParent_BlankEarthShortcutUIButton___);
  ...
  sub_1B00C70(
    ...
    v30,
    v31);
  v33 = (System_Collections_Generic_List_object__o *)sub_1B00F18(System_Collections_Generic_List_GameObject__TypeInfo);
  ...
  else
  {
    ...
    sub_1B00C70((ServantStatusBattleListViewItem_o *)(v47 + 4), (int32_t)v46, v41, v42);
  }
  ...
  else
  {
    ...
    sub_1B00C70((ServantStatusBattleListViewItem_o *)(v61 + 4), (int32_t)v60, v55, v56);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(v69, 0LL, 0LL) )
  {
    ...
    if ( !v70 )
      goto LABEL_71;
    v70[1].monitor = this;
    sub_1B00C70((ServantStatusBattleListViewItem_o *)&v70[1].monitor, (int32_t)this, v71, v72);
...
LABEL_71:
  ...
  if ( !this )
    goto LABEL_71;
  this = (BlankEarthShortcutButtonListViewItemDraw_o *)System_String__Replace_60345368(
...
LABEL_61:
  ...
  v81 = System_String__Concat_60325748((System_String_o *)StringLiteral_18941/*"event_logo_shortcut_"*/, v80, 0LL);
