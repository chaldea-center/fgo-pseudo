...
void __fastcall MaterialCollectionMenu__Close(MaterialCollectionMenu_o *this, const MethodInfo *method)
{
  ...
  MaterialCollectionMenu__Close_32056128(this, 0LL, v2);
}


void __fastcall MaterialCollectionMenu__Close_32056128(
        MaterialCollectionMenu_o *this,
...
void __fastcall MaterialCollectionMenu__EndCloseShowServant(MaterialCollectionMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC2F11 & 1) == 0 )
  {
    sub_1C1ABD4(&MaterialCollectionServantListViewManager_CallbackFunc_TypeInfo, method);
    sub_1C1ABD4(&Method_MaterialCollectionMenu_OnSelectServant__, v3);
    byte_4BC2F11 = 1;
  }
  ...
  if ( !materialCollectionServantListViewManager
    || (MaterialCollectionServantListViewManager__ModifyItem(
        ...
        v6 = (MaterialCollectionServantListViewManager_CallbackFunc_o *)sub_1C1AE20(MaterialCollectionServantListViewManager_CallbackFunc_TypeInfo),
        ...
        !v5) )
  {
    sub_1C1AE30(materialCollectionServantListViewManager, method);
  }
...
void __fastcall MaterialCollectionMenu__EndOpen(MaterialCollectionMenu_o *this, const MethodInfo *method)
{
  ...
  this->fields.state = 2;
  materialCollectionServantListViewManager = this->fields.materialCollectionServantListViewManager;
  v5 = (MaterialCollectionServantListViewManager_CallbackFunc_o *)sub_1C1AE20(MaterialCollectionServantListViewManager_CallbackFunc_TypeInfo);
  MaterialCollectionServantListViewManager_CallbackFunc___ctor(
    v5,
    (Il2CppObject *)this,
    Method_MaterialCollectionMenu_OnSelectServant__,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC2F0F & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_MaterialCollectionMenu_EndCloseShowServant__, v8);
    sub_1C1ABD4(&Method_MaterialCollectionMenu_EndCloseShowServantuestQuestJump__, v9);
  ...
  if ( !Instance )
LABEL_11:
    sub_1C1AE30(materialCollectionServantListViewManager, isDecide);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C1ABD4(&System_Action_TypeInfo, isDecide);
    sub_1C1ABD4(&Method_MaterialCollectionMenu_EndCloseShowServant__, v4);
...
void __fastcall MaterialCollectionMenu__OnClickCancel(MaterialCollectionMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC2F0A & 1) == 0 )
  {
    sub_1C1ABD4(&Method_MaterialCollectionMenu_OnClickCancel__, method);
    byte_4BC2F0A = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_MaterialCollectionMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C1ABEC(Method_MaterialCollectionMenu_OnClickCancel__);
...
void __fastcall MaterialCollectionMenu__OnClickDecide(MaterialCollectionMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC2F09 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_MaterialCollectionMenu_OnClickDecide__, method);
    byte_4BC2F09 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_MaterialCollectionMenu_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C1ABEC(Method_MaterialCollectionMenu_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C1ABB8(v3, v3[4]);
...
void __fastcall MaterialCollectionMenu__OnClickTabCommandCode(MaterialCollectionMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC2F0D & 1) == 0 )
  {
    sub_1C1ABD4(&Method_MaterialCollectionMenu_OnClickTabCommandCode__, method);
    byte_4BC2F0D = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_MaterialCollectionMenu_OnClickTabCommandCode__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C1ABEC(Method_MaterialCollectionMenu_OnClickTabCommandCode__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C1ABB8(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
...
void __fastcall MaterialCollectionMenu__OnClickTabServant(MaterialCollectionMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC2F0B & 1) == 0 )
  {
    sub_1C1ABD4(&Method_MaterialCollectionMenu_OnClickTabServant__, method);
    byte_4BC2F0B = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_MaterialCollectionMenu_OnClickTabServant__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C1ABEC(Method_MaterialCollectionMenu_OnClickTabServant__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C1ABB8(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC2F0C & 1) == 0 )
  {
    sub_1C1ABD4(&Method_MaterialCollectionMenu_OnClickTabServantEquip__, method);
    byte_4BC2F0C = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_MaterialCollectionMenu_OnClickTabServantEquip__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C1ABEC(Method_MaterialCollectionMenu_OnClickTabServantEquip__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C1ABB8(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC2F0E & 1) == 0 )
  {
    sub_1C1ABD4(&ServantStatusDialog_EndDelegate_TypeInfo, *(_QWORD *)&kind);
    sub_1C1ABD4(&Method_MaterialCollectionMenu_EndShowServantEquip__, v7);
    sub_1C1ABD4(&Method_MaterialCollectionMenu_EndShowServant__, v8);
    sub_1C1ABD4(&ServantStatusDialog_ResultDelegate_TypeInfo, v9);
    sub_1C1ABD4(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v10);
    byte_4BC2F0E = 1;
  }
  if ( this->fields.state == 2 )
    ...
    if ( kind == 1 )
    {
      ...
      if ( materialCollectionServantListViewManager->fields.clipRange )
      {
        ...
        if ( IsServantEquip )
        {
          ...
          if ( v16 )
          {
            CommonUI__OpenServantStatusDialog_31110608(v16, 2, clipRange, v17, 0LL);
            return;
          }
LABEL_17:
          sub_1C1AE30(materialCollectionServantListViewManager, *(_QWORD *)&kind);
        }
        v22 = (ServantStatusDialog_ResultDelegate_o *)sub_1C1AE20(ServantStatusDialog_ResultDelegate_TypeInfo);
        ...
        if ( !v16 )
          goto LABEL_17;
        CommonUI__OpenServantStatusDialog_31111072(v16, 2, clipRange, v22, 0LL);
      }
      else if ( materialCollectionServantListViewManager->fields.dropList )
      {
        ...
        if ( !v20 )
          goto LABEL_17;
        CommonUI__OpenServantStatusDialog_31111992(v20, 2, dropList, v21, 0LL, 0LL);
      }
    }
  }
}
...
void __fastcall MaterialCollectionMenu__OnStartClose(MaterialCollectionMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC2F07 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_MaterialCollectionMenu_EndClose__, v3);
    byte_4BC2F07 = 1;
  }
...
void __fastcall MaterialCollectionMenu__OnStartOpen(MaterialCollectionMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C1ABD4(&System_Action_TypeInfo, method);
    sub_1C1ABD4(&Method_MaterialCollectionMenu_EndOpen__, v3);
    byte_4BC2F04 = 1;
  }
  v4 = (System_Action_o *)sub_1C1AE20(System_Action_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC2F03 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataManager_GetMasterData_UserServantCollectionMaster___, opened_act);
    sub_1C1ABD4(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v7);
    sub_1C1ABD4(&StringLiteral_10146/*"OnStartOpen"*/, v8);
    byte_4BC2F03 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    sub_1C1AB78(&this->fields.newSvtIdList);
...
LABEL_16:
    ...
    MaterialCollectionServantListViewManager__SetMode_32077392(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC2F08 & 1) == 0 )
  {
    sub_1C1ABD4(&MaterialCollectionServantListViewManager_CallbackFunc_TypeInfo, *(_QWORD *)&kind);
    sub_1C1ABD4(&Method_DataManager_GetMasterData_UserCommandCodeCollectionMaster___, v7);
    ...
    sub_1C1ABD4(&Method_MaterialCollectionMenu_OnSelectServant__, v11);
    sub_1C1ABD4(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v12);
    sub_1C1ABD4(&StringLiteral_17851/*"btn_txt_craftessence_off"*/, v13);
    sub_1C1ABD4(&StringLiteral_17891/*"btn_txt_servant_off"*/, v14);
    sub_1C1ABD4(&StringLiteral_17847/*"btn_txt_cc_off"*/, v15);
    sub_1C1ABD4(&StringLiteral_17752/*"btn_bg_12"*/, v16);
    sub_1C1ABD4(&StringLiteral_17848/*"btn_txt_cc_on"*/, v17);
    sub_1C1ABD4(&StringLiteral_17892/*"btn_txt_servant_on"*/, v18);
    sub_1C1ABD4(&StringLiteral_17754/*"btn_bg_19"*/, v19);
    sub_1C1ABD4(&StringLiteral_3492/*"CHARA_GRAPH_TAB_COMMAND_CODE"*/, v20);
    sub_1C1ABD4(&StringLiteral_17852/*"btn_txt_craftessence_on"*/, v21);
    sub_1C1ABD4(&StringLiteral_3493/*"CHARA_GRAPH_TAB_SERVANT"*/, v22);
    sub_1C1ABD4(&StringLiteral_3494/*"CHARA_GRAPH_TAB_SERVANT_EQUIP"*/, v23);
    byte_4BC2F08 = 1;
  }
  *(_QWORD *)findSum = 0LL;
  ...
  if ( !Instance )
    goto LABEL_88;
  v40 = &StringLiteral_17754/*"btn_bg_19"*/;
  if ( kind )
    v40 = &StringLiteral_17752/*"btn_bg_12"*/;
  UISprite__set_spriteName((UISprite_o *)Instance, (System_String_o *)*v40, 0LL);
  Instance = (DataManager_o *)this->fields.servantTabStrSp;
  if ( !Instance )
    goto LABEL_88;
  v41 = &StringLiteral_17892/*"btn_txt_servant_on"*/;
  v42 = isInit;
  if ( kind )
    v41 = &StringLiteral_17891/*"btn_txt_servant_off"*/;
  ...
  v47 = LocalizationManager__Get((System_String_o *)StringLiteral_3493/*"CHARA_GRAPH_TAB_SERVANT"*/, 0LL);
  v98 = findSum[0];
  ...
  Instance = (DataManager_o *)System_String__Format_63054740(v47, v54, v55, 0LL);
  if ( !servantTabLabel )
    goto LABEL_88;
  ...
  if ( !Instance )
    goto LABEL_88;
  v61 = (System_String_o **)(kind == 1 ? &StringLiteral_17754/*"btn_bg_19"*/ : &StringLiteral_17752/*"btn_bg_12"*/);
  UISprite__set_spriteName((UISprite_o *)Instance, *v61, 0LL);
  Instance = (DataManager_o *)this->fields.servantEquipTabStrSp;
  if ( !Instance )
    goto LABEL_88;
  v62 = &StringLiteral_17852/*"btn_txt_craftessence_on"*/;
  if ( kind != 1 )
    v62 = &StringLiteral_17851/*"btn_txt_craftessence_off"*/;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v66 = LocalizationManager__Get((System_String_o *)StringLiteral_3494/*"CHARA_GRAPH_TAB_SERVANT_EQUIP"*/, 0LL);
  v98 = findSum[0];
  ...
  Instance = (DataManager_o *)System_String__Format_63054740(v66, v73, v74, 0LL);
  ...
  if ( !Instance )
    goto LABEL_88;
  v79 = (System_String_o **)(kind == 2 ? &StringLiteral_17754/*"btn_bg_19"*/ : &StringLiteral_17752/*"btn_bg_12"*/);
  UISprite__set_spriteName((UISprite_o *)Instance, *v79, 0LL);
  Instance = (DataManager_o *)this->fields.commandCodeTabStrSp;
  if ( !Instance )
    goto LABEL_88;
  v80 = &StringLiteral_17848/*"btn_txt_cc_on"*/;
  if ( kind != 2 )
    v80 = &StringLiteral_17847/*"btn_txt_cc_off"*/;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v84 = LocalizationManager__Get((System_String_o *)StringLiteral_3492/*"CHARA_GRAPH_TAB_COMMAND_CODE"*/, 0LL);
  v98 = findSum[0];
  ...
  Instance = (DataManager_o *)System_String__Format_63054740(v84, v91, v92, 0LL);
...
LABEL_88:
  ...
  v95 = (MaterialCollectionServantListViewManager_CallbackFunc_o *)sub_1C1AE20(MaterialCollectionServantListViewManager_CallbackFunc_TypeInfo);
  MaterialCollectionServantListViewManager_CallbackFunc___ctor(
    v95,
    (Il2CppObject *)this,
    Method_MaterialCollectionMenu_OnSelectServant__,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC2F01 & 1) == 0 )
  {
    sub_1C1ABD4(&MaterialCollectionMenu_CallbackFunc_TypeInfo, value);
    byte_4BC2F01 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (MaterialCollectionMenu_o *)sub_1C1B0F0(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A55280;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A55238;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC2F1C & 1) == 0 )
  {
    sub_1C1ABD4(&MaterialCollectionMenu_ResultKind_TypeInfo, *(_QWORD *)&result);
    byte_4BC2F1C = 1;
  }
  v9[1] = 0LL;
