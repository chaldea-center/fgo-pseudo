...
void __fastcall MasterFormationRootComponent__Init(MasterFormationRootComponent_o *this, const MethodInfo *method)
{
  ...
  PlayMakerFSM__SendEvent(myFSM, (System_String_o *)StringLiteral_6926/*"GO_NEXT"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BCB254(mstFormationComp, method);
  }
  PlayMakerFSM__SendEvent((PlayMakerFSM_o *)mstFormationComp, (System_String_o *)StringLiteral_6926/*"GO_NEXT"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17457 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_DataMasterBase_UserDeckMaster__UserDeckEntity__long__GetEntity__, v7);
    sub_1BCAFF8(&Method_MasterFormationRootComponent__beginStartUp_b__9_0__, v8);
    sub_1BCAFF8(&SceneJumpInfo_TypeInfo, v9);
    sub_1BCAFF8(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v10);
    sub_1BCAFF8(&StringLiteral_5151/*"DeckId"*/, v11);
    sub_1BCAFF8(&StringLiteral_6157/*"EventDeckId"*/, v12);
    sub_1BCAFF8(&StringLiteral_15105/*"UserEquipId"*/, v13);
    byte_4B17457 = 1;
  }
  ...
  sub_1BCAF9C(&this->fields.usrGameEnt);
  ...
  *p_jumpInfo = (struct SceneJumpInfo_o *)data;
  bgTxtSprite = (UnityEngine_Component_o *)sub_1BCAF9C(&this->fields.jumpInfo);
  if ( !*p_jumpInfo )
    goto LABEL_31;
  name = (*p_jumpInfo)->fields.name;
  bgTxtSprite = (UnityEngine_Component_o *)System_String__op_Equality(name, (System_String_o *)StringLiteral_5151/*"DeckId"*/, 0LL);
  if ( ((unsigned __int8)bgTxtSprite & 1) != 0
    || (bgTxtSprite = (UnityEngine_Component_o *)System_String__op_Equality(
                                                   name,
                                                   (System_String_o *)StringLiteral_6157/*"EventDeckId"*/,
                                                   0LL),
  ...
  else
  {
    bgTxtSprite = (UnityEngine_Component_o *)System_String__op_Equality(
                                               name,
                                               (System_String_o *)StringLiteral_15105/*"UserEquipId"*/,
                                               0LL);
    if ( ((unsigned __int8)bgTxtSprite & 1) == 0 )
    {
LABEL_8:
...
LABEL_16:
  ...
  if ( !bgTxtSprite )
    goto LABEL_31;
  TitleInfoControl__setBackBtnSprite_39034208((TitleInfoControl_o *)bgTxtSprite, 1, 0, 0, 0LL);
  bgTxtSprite = (UnityEngine_Component_o *)this->fields.titleInfo;
  if ( !bgTxtSprite )
    goto LABEL_31;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1745C & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_MasterFormationRootComponent__closeMasterFormation_b__17_0__, v4);
...
void __fastcall MasterFormationRootComponent__gotoBack(MasterFormationRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1745E & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_5151/*"DeckId"*/, v4);
    sub_1BCAFF8(&StringLiteral_6157/*"EventDeckId"*/, v5);
    this = (MasterFormationRootComponent_o *)sub_1BCAFF8(&StringLiteral_15105/*"UserEquipId"*/, v6);
    byte_4B1745E = 1;
  }
  ...
  this = (MasterFormationRootComponent_o *)System_String__op_Equality(name, (System_String_o *)StringLiteral_15105/*"UserEquipId"*/, 0LL);
  ...
  else
  {
    this = (MasterFormationRootComponent_o *)System_String__op_Equality(
                                               name,
                                               (System_String_o *)StringLiteral_5151/*"DeckId"*/,
                                               0LL);
    if ( ((unsigned __int8)this & 1) != 0
      || (this = (MasterFormationRootComponent_o *)System_String__op_Equality(
                                                     name,
  ...
  this = (MasterFormationRootComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38F8AD8 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
  if ( !this
    || (IsStackScene = AvalonSceneManager__IsStackScene((AvalonSceneManager_o *)this, 0LL),
        (this = (MasterFormationRootComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38F8AD8 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__)) == 0LL) )
  {
LABEL_30:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1745A & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_9252/*"NO_CHANGE_EQUIP"*/, method);
    this = (MasterFormationRootComponent_o *)sub_1BCAFF8(&StringLiteral_10987/*"REQUEST_OK"*/, v3);
    byte_4B1745A = 1;
  }
    ...
    || (currentUsrEquipId = mstFormationComp->fields.currentUsrEquipId, v2->fields.userEquipId == currentUsrEquipId) )
  {
    ...
    if ( this )
    {
      v6 = &StringLiteral_9252/*"NO_CHANGE_EQUIP"*/;
      goto LABEL_10;
    }
LABEL_11:
    sub_1BCB254(this, method);
  ...
  if ( !this )
    goto LABEL_11;
  v6 = &StringLiteral_10987/*"REQUEST_OK"*/;
LABEL_10:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17459 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_MasterFormationRootComponent_SetBackBtnEnabled__, v3);
    sub_1BCAFF8(&MasterFormationComponent_NotificationDragState_TypeInfo, v4);
    sub_1BCAFF8(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v5);
    byte_4B17459 = 1;
  }
  mstFormationComp = this->fields.mstFormationComp;
  ...
  v10 = (MasterFormationComponent_NotificationDragState_o *)sub_1BCB244(MasterFormationComponent_NotificationDragState_TypeInfo);
  ...
  mstFormationComp = (MasterFormationComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38F8AD8 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
