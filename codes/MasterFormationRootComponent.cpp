...
void __fastcall MasterFormationRootComponent__Init(MasterFormationRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B2E5 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_6941/*"GO_NEXT"*/, method);
    byte_4A6B2E5 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B9026C(mstFormationComp, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B2E4 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_DataMasterBase_UserDeckMaster__UserDeckEntity__long__GetEntity__, v7);
    sub_1B90010(&Method_MasterFormationRootComponent__beginStartUp_b__9_0__, v8);
    sub_1B90010(&SceneJumpInfo_TypeInfo, v9);
    sub_1B90010(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v10);
    sub_1B90010(&StringLiteral_5228/*"DeckId"*/, v11);
    sub_1B90010(&StringLiteral_6173/*"EventDeckId"*/, v12);
    sub_1B90010(&StringLiteral_15245/*"UserEquipId"*/, v13);
    byte_4A6B2E4 = 1;
  }
  ...
  sub_1B8FFB4(&this->fields.usrGameEnt);
  ...
  *p_jumpInfo = (struct SceneJumpInfo_o *)data;
  bgTxtSprite = (UnityEngine_Component_o *)sub_1B8FFB4(&this->fields.jumpInfo);
  if ( !*p_jumpInfo )
    goto LABEL_31;
  ...
  if ( ((unsigned __int8)bgTxtSprite & 1) != 0
    || (bgTxtSprite = (UnityEngine_Component_o *)System_String__op_Equality(
                                                   name,
                                                   (System_String_o *)StringLiteral_6173/*"EventDeckId"*/,
                                                   0LL),
  ...
  else
  {
    bgTxtSprite = (UnityEngine_Component_o *)System_String__op_Equality(
                                               name,
                                               (System_String_o *)StringLiteral_15245/*"UserEquipId"*/,
                                               0LL);
    if ( ((unsigned __int8)bgTxtSprite & 1) == 0 )
    {
LABEL_8:
...
LABEL_16:
  ...
  if ( !bgTxtSprite )
    goto LABEL_31;
  TitleInfoControl__setBackBtnSprite_37236924((TitleInfoControl_o *)bgTxtSprite, 1, 0, 0, 0LL);
  bgTxtSprite = (UnityEngine_Component_o *)this->fields.titleInfo;
  if ( !bgTxtSprite )
    goto LABEL_31;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B2E9 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_MasterFormationRootComponent__closeMasterFormation_b__17_0__, v4);
...
void __fastcall MasterFormationRootComponent__gotoBack(MasterFormationRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B2EB & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_5228/*"DeckId"*/, v4);
    sub_1B90010(&StringLiteral_6173/*"EventDeckId"*/, v5);
    this = (MasterFormationRootComponent_o *)sub_1B90010(&StringLiteral_15245/*"UserEquipId"*/, v6);
    byte_4A6B2EB = 1;
  }
  ...
  this = (MasterFormationRootComponent_o *)System_String__op_Equality(name, (System_String_o *)StringLiteral_15245/*"UserEquipId"*/, 0LL);
  ...
  this = (MasterFormationRootComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_374C890 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
  if ( !this
    || (IsStackScene = AvalonSceneManager__IsStackScene((AvalonSceneManager_o *)this, 0LL),
        (this = (MasterFormationRootComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_374C890 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__)) == 0LL) )
  {
LABEL_30:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B2E7 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_9301/*"NO_CHANGE_EQUIP"*/, method);
    this = (MasterFormationRootComponent_o *)sub_1B90010(&StringLiteral_11067/*"REQUEST_OK"*/, v3);
    byte_4A6B2E7 = 1;
  }
    ...
    || (currentUsrEquipId = mstFormationComp->fields.currentUsrEquipId, v2->fields.userEquipId == currentUsrEquipId) )
  {
    ...
    if ( this )
    {
      v6 = &StringLiteral_9301/*"NO_CHANGE_EQUIP"*/;
      goto LABEL_10;
    }
LABEL_11:
    sub_1B9026C(this, method);
  ...
  if ( !this )
    goto LABEL_11;
  v6 = &StringLiteral_11067/*"REQUEST_OK"*/;
LABEL_10:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B2E6 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_MasterFormationRootComponent_SetBackBtnEnabled__, v3);
    sub_1B90010(&MasterFormationComponent_NotificationDragState_TypeInfo, v4);
    sub_1B90010(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v5);
    byte_4A6B2E6 = 1;
  }
  mstFormationComp = this->fields.mstFormationComp;
  ...
  v10 = (MasterFormationComponent_NotificationDragState_o *)sub_1B9025C(MasterFormationComponent_NotificationDragState_TypeInfo);
  ...
  mstFormationComp = (MasterFormationComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_374C890 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
