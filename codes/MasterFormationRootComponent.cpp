...
void __fastcall MasterFormationRootComponent__Init(MasterFormationRootComponent_o *this, const MethodInfo *method)
{
  ...
  PlayMakerFSM__SendEvent(myFSM, (System_String_o *)StringLiteral_6941/*"GO_NEXT"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BAB678(mstFormationComp, method);
  }
  PlayMakerFSM__SendEvent((PlayMakerFSM_o *)mstFormationComp, (System_String_o *)StringLiteral_6941/*"GO_NEXT"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB1138 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_DataMasterBase_UserDeckMaster__UserDeckEntity__long__GetEntity__, v7);
    sub_1BAB41C(&Method_MasterFormationRootComponent__beginStartUp_b__9_0__, v8);
    sub_1BAB41C(&SceneJumpInfo_TypeInfo, v9);
    sub_1BAB41C(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v10);
    sub_1BAB41C(&StringLiteral_5228/*"DeckId"*/, v11);
    sub_1BAB41C(&StringLiteral_6176/*"EventDeckId"*/, v12);
    sub_1BAB41C(&StringLiteral_15251/*"UserEquipId"*/, v13);
    byte_4AB1138 = 1;
  }
  ...
  sub_1BAB3C0(&this->fields.usrGameEnt);
  ...
  *p_jumpInfo = (struct SceneJumpInfo_o *)data;
  bgTxtSprite = (UnityEngine_Component_o *)sub_1BAB3C0(&this->fields.jumpInfo);
  if ( !*p_jumpInfo )
    goto LABEL_31;
  name = (*p_jumpInfo)->fields.name;
  bgTxtSprite = (UnityEngine_Component_o *)System_String__op_Equality(name, (System_String_o *)StringLiteral_5228/*"DeckId"*/, 0LL);
  if ( ((unsigned __int8)bgTxtSprite & 1) != 0
    || (bgTxtSprite = (UnityEngine_Component_o *)System_String__op_Equality(
                                                   name,
                                                   (System_String_o *)StringLiteral_6176/*"EventDeckId"*/,
                                                   0LL),
  ...
  else
  {
    bgTxtSprite = (UnityEngine_Component_o *)System_String__op_Equality(
                                               name,
                                               (System_String_o *)StringLiteral_15251/*"UserEquipId"*/,
                                               0LL);
    if ( ((unsigned __int8)bgTxtSprite & 1) == 0 )
    {
LABEL_8:
...
LABEL_16:
  ...
  if ( !bgTxtSprite )
    goto LABEL_31;
  TitleInfoControl__setBackBtnSprite_37565572((TitleInfoControl_o *)bgTxtSprite, 1, 0, 0, 0LL);
  bgTxtSprite = (UnityEngine_Component_o *)this->fields.titleInfo;
  if ( !bgTxtSprite )
    goto LABEL_31;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB113D & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_MasterFormationRootComponent__closeMasterFormation_b__17_0__, v4);
...
void __fastcall MasterFormationRootComponent__gotoBack(MasterFormationRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB113F & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_5228/*"DeckId"*/, v4);
    sub_1BAB41C(&StringLiteral_6176/*"EventDeckId"*/, v5);
    this = (MasterFormationRootComponent_o *)sub_1BAB41C(&StringLiteral_15251/*"UserEquipId"*/, v6);
    byte_4AB113F = 1;
  }
  ...
  this = (MasterFormationRootComponent_o *)System_String__op_Equality(name, (System_String_o *)StringLiteral_15251/*"UserEquipId"*/, 0LL);
  ...
  else
  {
    this = (MasterFormationRootComponent_o *)System_String__op_Equality(
                                               name,
                                               (System_String_o *)StringLiteral_5228/*"DeckId"*/,
                                               0LL);
    if ( ((unsigned __int8)this & 1) != 0
      || (this = (MasterFormationRootComponent_o *)System_String__op_Equality(
                                                     name,
  ...
  this = (MasterFormationRootComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_378A22C *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
  if ( !this
    || (IsStackScene = AvalonSceneManager__IsStackScene((AvalonSceneManager_o *)this, 0LL),
        (this = (MasterFormationRootComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_378A22C *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__)) == 0LL) )
  {
LABEL_30:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB113B & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_9302/*"NO_CHANGE_EQUIP"*/, method);
    this = (MasterFormationRootComponent_o *)sub_1BAB41C(&StringLiteral_11069/*"REQUEST_OK"*/, v3);
    byte_4AB113B = 1;
  }
    ...
    || (currentUsrEquipId = mstFormationComp->fields.currentUsrEquipId, v2->fields.userEquipId == currentUsrEquipId) )
  {
    ...
    if ( this )
    {
      v6 = &StringLiteral_9302/*"NO_CHANGE_EQUIP"*/;
      goto LABEL_10;
    }
LABEL_11:
    sub_1BAB678(this, method);
  ...
  if ( !this )
    goto LABEL_11;
  v6 = &StringLiteral_11069/*"REQUEST_OK"*/;
LABEL_10:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB113A & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_MasterFormationRootComponent_SetBackBtnEnabled__, v3);
    sub_1BAB41C(&MasterFormationComponent_NotificationDragState_TypeInfo, v4);
    sub_1BAB41C(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v5);
    byte_4AB113A = 1;
  }
  mstFormationComp = this->fields.mstFormationComp;
  ...
  v10 = (MasterFormationComponent_NotificationDragState_o *)sub_1BAB668(MasterFormationComponent_NotificationDragState_TypeInfo);
  ...
  if ( !v7 )
    goto LABEL_10;
  MasterFormationComponent__setMasterFormation(v7, usrGameEnt, userEquipId, v10, v12);
  ...
  mstFormationComp = (MasterFormationComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_378A22C *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  v13 = (CommonUI_o *)mstFormationComp;
  if ( !AvalonSceneManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AvalonSceneManager_TypeInfo);
  if ( !v13 )
LABEL_10:
