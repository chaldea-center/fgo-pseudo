...
void MasterFormationRootComponent__Init(MasterFormationRootComponent_o *this, const MethodInfo *method)
{
  ...
  PlayMakerFSM__SendEvent(myFSM, (System_String_o *)StringLiteral_6979/*"GO_NEXT"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C3E7C0(mstFormationComp, method);
  }
  PlayMakerFSM__SendEvent((PlayMakerFSM_o *)mstFormationComp, (System_String_o *)StringLiteral_6979/*"GO_NEXT"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C51BBF & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_DataMasterBase_UserDeckMaster__UserDeckEntity__long__GetEntity__);
    sub_1C3E564(&Method_MasterFormationRootComponent__beginStartUp_b__9_0__);
    sub_1C3E564(&SceneJumpInfo_TypeInfo);
    sub_1C3E564(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    sub_1C3E564(&StringLiteral_5195/*"DeckId"*/);
    sub_1C3E564(&StringLiteral_6209/*"EventDeckId"*/);
    sub_1C3E564(&StringLiteral_15237/*"UserEquipId"*/);
    byte_4C51BBF = 1;
  }
  ...
  *p_jumpInfo = (struct SceneJumpInfo_o *)data;
  ...
  bgTxtSprite = (UnityEngine_Component_o *)sub_1C3E508(&this->fields.jumpInfo, v16);
  if ( !*p_jumpInfo )
    goto LABEL_36;
  name = (*p_jumpInfo)->fields.name;
  bgTxtSprite = (UnityEngine_Component_o *)System_String__op_Equality(name, (System_String_o *)StringLiteral_5195/*"DeckId"*/, 0);
  if ( ((unsigned __int8)bgTxtSprite & 1) != 0
    || (bgTxtSprite = (UnityEngine_Component_o *)System_String__op_Equality(
                                                   name,
                                                   (System_String_o *)StringLiteral_6209/*"EventDeckId"*/,
                                                   0),
  ...
  {
    bgTxtSprite = (UnityEngine_Component_o *)System_String__op_Equality(name, (System_String_o *)StringLiteral_15237/*"UserEquipId"*/, 0);
    if ( ((unsigned __int8)bgTxtSprite & 1) == 0 )
    {
LABEL_8:
...
LABEL_16:
  ...
  if ( !bgTxtSprite )
    goto LABEL_36;
  TitleInfoControl__setBackBtnSprite_39887836((TitleInfoControl_o *)bgTxtSprite, 1, 0, 0, 0);
  bgTxtSprite = (UnityEngine_Component_o *)this->fields.titleInfo;
  if ( !bgTxtSprite )
    goto LABEL_36;
...
void MasterFormationRootComponent__closeMasterFormation(MasterFormationRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C51BC4 & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_MasterFormationRootComponent__closeMasterFormation_b__17_0__);
...
void MasterFormationRootComponent__gotoBack(MasterFormationRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C51BC6 & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_5195/*"DeckId"*/);
    sub_1C3E564(&StringLiteral_6209/*"EventDeckId"*/);
    this = (MasterFormationRootComponent_o *)sub_1C3E564(&StringLiteral_15237/*"UserEquipId"*/);
    byte_4C51BC6 = 1;
  }
  ...
  this = (MasterFormationRootComponent_o *)System_String__op_Equality(name, (System_String_o *)StringLiteral_15237/*"UserEquipId"*/, 0);
  ...
  {
    this = (MasterFormationRootComponent_o *)System_String__op_Equality(name, (System_String_o *)StringLiteral_5195/*"DeckId"*/, 0);
    if ( ((unsigned __int8)this & 1) != 0
  ...
  this = (MasterFormationRootComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39FF5A8 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
  if ( !this
    || (IsStackScene = AvalonSceneManager__IsStackScene((AvalonSceneManager_o *)this, 0),
        (this = (MasterFormationRootComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39FF5A8 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__)) == 0) )
  {
LABEL_30:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C51BC2 & 1) == 0 )
  {
    sub_1C3E564(&StringLiteral_9324/*"NO_CHANGE_EQUIP"*/);
    this = (MasterFormationRootComponent_o *)sub_1C3E564(&StringLiteral_11086/*"REQUEST_OK"*/);
    byte_4C51BC2 = 1;
  }
    ...
    || (currentUsrEquipId = mstFormationComp->fields.currentUsrEquipId, v2->fields.userEquipId == currentUsrEquipId) )
  {
    ...
    if ( this )
    {
      v5 = &StringLiteral_9324/*"NO_CHANGE_EQUIP"*/;
      goto LABEL_10;
    }
LABEL_11:
    sub_1C3E7C0(this, method);
...
void MasterFormationRootComponent__showMasterFormation(MasterFormationRootComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C3E564(&AvalonSceneManager_TypeInfo);
    sub_1C3E564(&Method_MasterFormationRootComponent_SetBackBtnEnabled__);
  ...
  v7 = (MasterFormationComponent_NotificationDragState_o *)sub_1C3E7B0(MasterFormationComponent_NotificationDragState_TypeInfo);
  ...
  mstFormationComp = (MasterFormationComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39FF5A8 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
