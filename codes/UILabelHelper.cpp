        ...
        const MethodInfo *method)
{
  ...
  if ( !v7 )
  {
    ...
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    v7 = UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)ComponentInParent_object__51650456, 0, 0);
    if ( v7 )
    {
      if ( ComponentInParent_object__51650456 )
      {
        v11 = v9 > lineThreshold;
        UIScrollView__ResetPosition((UIScrollView_o *)ComponentInParent_object__51650456, 0);
        BasicHelper__SetActiveSafely((UnityEngine_Component_o *)ComponentInParent_object__51650456[4].klass, v11, v12);
        UnityEngine_Behaviour__set_enabled((UnityEngine_Behaviour_o *)ComponentInParent_object__51650456, v11, 0);
        return;
      }
LABEL_13:
      sub_1C71608(v7, v8);
...
void UILabelHelper__SetTextSafely_44453924(
        UILabel_o *self,
        ...
        const MethodInfo *method)
{
  ...
  {
    v7 = System_String__Format_64073168(format, args, 0);
    if ( !self )
      sub_1C71608(v7, v8);
