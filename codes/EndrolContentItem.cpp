        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A524E4 & 1) == 0 )
  {
    this = (EndrolContentItem_o *)sub_1B863B8(&StringLiteral_5970/*"Endrol"*/, coll);
    byte_4A524E4 = 1;
  }
  if ( !coll )
    goto LABEL_9;
  ...
  if ( System_String__op_Equality(tag, (System_String_o *)StringLiteral_5970/*"Endrol"*/, 0LL) )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A524E7 & 1) == 0 )
  {
    sub_1B863B8(&UnityEngine_Object_TypeInfo, *(_QWORD *)&posY);
    byte_4A524E7 = 1;
  }
...
LABEL_17:
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)rootComp, 0LL, 0LL) )
  {
    ...
    sub_1B8635C((CGThumbnailListItem_o *)&this->fields.rootComponent, (int32_t)rootComp, v19, v20);
  }
}
...
LABEL_20:
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)root, 0LL, 0LL) )
  {
    ...
    sub_1B8635C((CGThumbnailListItem_o *)&this->fields.rootComponent, (int32_t)root, v17, v18);
  }
}
...
LABEL_17:
  ...
  {
    this->fields.rootComponent = rootComp;
    sub_1B8635C((CGThumbnailListItem_o *)&this->fields.rootComponent, (int32_t)rootComp, v16, v17);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  EndrolContentItem__ChangeDisplayItems(this, *(const MethodInfo **)&posY);
  textLabel = (char *)sub_1B86460(string___TypeInfo, 2LL);
  if ( !txt )
    goto LABEL_36;
  if ( !txt->max_length )
    goto LABEL_37;
  ...
  *((_QWORD *)textLabel + 4) = v17;
  sub_1B8635C((CGThumbnailListItem_o *)(textLabel + 32), (int32_t)v17, v14, v15);
  if ( txt->max_length <= 2 || *((_DWORD *)v16 + 6) <= 1u )
    goto LABEL_37;
  v20 = txt->m_Items[2];
  *((_QWORD *)v16 + 5) = v20;
  sub_1B8635C((CGThumbnailListItem_o *)(v16 + 40), (int32_t)v20, v18, v19);
  v21 = *((_QWORD *)v16 + 3);
  if ( (int)v21 >= 1 )
  {
    v22 = 4LL;
...
LABEL_37:
  ...
  {
    this->fields.rootComponent = rootComp;
    sub_1B8635C((CGThumbnailListItem_o *)&this->fields.rootComponent, (int32_t)rootComp, v28, v29);
  }
}
