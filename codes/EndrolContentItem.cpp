        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC1532 & 1) == 0 )
  {
    this = (EndrolContentItem_o *)sub_1C713B0(&StringLiteral_6031/*"Endrol"*/);
    byte_4CC1532 = 1;
  }
  if ( !coll )
    goto LABEL_9;
  ...
  if ( System_String__op_Equality(tag, (System_String_o *)StringLiteral_6031/*"Endrol"*/, 0) )
  {
...
LABEL_20:
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)root, 0, 0) )
  {
    ...
    sub_1C71354(&this->fields.rootComponent, root);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  EndrolContentItem__ChangeDisplayItems(this, *(const MethodInfo **)&posY);
  textLabel = (_DWORD *)sub_1C71458(string___TypeInfo, 2);
  if ( !txt )
    goto LABEL_36;
  ...
  *((_QWORD *)textLabel + 4) = v14;
  textLabel = (_DWORD *)sub_1C71354(textLabel + 8, v14);
  if ( LODWORD(txt->max_length) <= 2 || v13[6] <= 1u )
    goto LABEL_37;
  v15 = txt->m_Items[2];
  *((_QWORD *)v13 + 5) = v15;
  textLabel = (_DWORD *)sub_1C71354(v13 + 10, v15);
  v16 = *((_QWORD *)v13 + 3);
  if ( (int)v16 >= 1 )
  {
    v17 = 4;
...
LABEL_36:
    sub_1C71608(textLabel, v12);
  }
LABEL_22:
  if ( LODWORD(txt->max_length) <= 1 )
LABEL_37:
    sub_1C71610(textLabel);
  textLabel = this->fields.textLabel;
  if ( !textLabel )
    goto LABEL_36;
