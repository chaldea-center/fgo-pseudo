        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C01636 & 1) == 0 )
  {
    this = (EndrolContentItem_o *)sub_1C2E12C(&StringLiteral_6153/*"Endrol"*/, coll);
    byte_4C01636 = 1;
  }
  if ( !coll )
    goto LABEL_9;
  ...
  if ( System_String__op_Equality(tag, (System_String_o *)StringLiteral_6153/*"Endrol"*/, 0LL) )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C01639 & 1) == 0 )
  {
    sub_1C2E12C(&UnityEngine_Object_TypeInfo, *(_QWORD *)&posY);
    byte_4C01639 = 1;
  }
...
LABEL_20:
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)root, 0LL, 0LL) )
  {
    ...
    sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.rootComponent, (int64_t)root, v17, v18, v19, v20, v21, v22);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  EndrolContentItem__ChangeDisplayItems(this, *(const MethodInfo **)&posY);
  textLabel = (char *)sub_1C2E1D4(string___TypeInfo, 2LL);
  if ( !txt )
    goto LABEL_36;
  if ( !txt->max_length )
    goto LABEL_37;
  ...
  if ( !*((_DWORD *)textLabel + 6) )
    goto LABEL_37;
  v21 = txt->m_Items[0];
  *((_QWORD *)textLabel + 4) = v21;
  sub_1C2E0D0((PartyOrganizationUtility_o *)(textLabel + 32), (int64_t)v21, v14, v15, v16, v17, v18, v19);
  if ( txt->max_length <= 2 || *((_DWORD *)v20 + 6) <= 1u )
    goto LABEL_37;
  v28 = txt->m_Items[2];
  *((_QWORD *)v20 + 5) = v28;
  sub_1C2E0D0((PartyOrganizationUtility_o *)(v20 + 40), (int64_t)v28, v22, v23, v24, v25, v26, v27);
  v29 = *((_QWORD *)v20 + 3);
  if ( (int)v29 >= 1 )
  {
    v30 = 4LL;
    while ( 1 )
    {
      ...
      if ( (unsigned int)(v30 - 4) >= columnTextLabel->max_length || v32 >= (unsigned int)v29 )
        goto LABEL_37;
      textLabel = (char *)*((_QWORD *)&columnTextLabel->obj.klass + v30);
      if ( !textLabel )
        break;
      UILabel__set_text((UILabel_o *)textLabel, *(System_String_o **)&v20[8 * v30], 0LL);
      v33 = this->fields.columnTextLabel;
      if ( !v33 )
        break;
      if ( v32 >= v33->max_length )
        goto LABEL_37;
      textLabel = (char *)*((_QWORD *)&v33->obj.klass + v30);
      if ( !textLabel )
        break;
      UIWidget__set_height((UIWidget_o *)textLabel, fontSize, 0LL);
      ...
      if ( v32 >= v34->max_length )
        goto LABEL_37;
      textLabel = (char *)*((_QWORD *)&v34->obj.klass + v30);
      if ( !textLabel )
        break;
...
LABEL_37:
  ...
  v42.fields.y = (float)(posY - (v35 >> 1));
  v42.fields.x = 0.0;
  v42.fields.z = 0.0;
  UnityEngine_Transform__set_localPosition((UnityEngine_Transform_o *)textLabel, v42, 0LL);
