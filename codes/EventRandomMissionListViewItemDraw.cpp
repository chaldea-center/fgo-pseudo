void __fastcall EventRandomMissionListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BCBC89 & 1) == 0 )
  {
    sub_1C1ABD4(&EventRandomMissionListViewItemDraw_TypeInfo, v1);
    byte_4BCBC89 = 1;
  }
  static_fields = EventRandomMissionListViewItemDraw_TypeInfo->static_fields;
  *(_OWORD *)&static_fields->MISSION_COND_FONT_SIZE = xmmword_BFA650;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCBC84 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_13570/*"TIME_REST_ACHIVE"*/, v4);
    byte_4BCBC84 = 1;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v5 = LocalizationManager__Get((System_String_o *)StringLiteral_13570/*"TIME_REST_ACHIVE"*/, 0LL);
  RestTime = LocalizationManager__GetRestTime(closeTime, 0LL);
  return System_String__Concat_63051628(v5, (System_String_o *)StringLiteral_117/*" "*/, RestTime, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C1ABD4(&LocalizationManager_TypeInfo, method);
    sub_1C1ABD4(&StringLiteral_13582/*"TIME_REST_QUEST"*/, v3);
    byte_4BCBC83 = 1;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_13582/*"TIME_REST_QUEST"*/, 0LL);
  RestTime = LocalizationManager__GetRestTime(endTime, 0LL);
  return System_String__Concat_63040368(v4, RestTime, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCBC80 & 1) == 0 )
  {
    sub_1C1ABD4(&EventRandomMissionListViewItemDraw_TypeInfo, missionListviewItem);
    ...
    sub_1C1ABD4(&StringLiteral_8854/*"MISSION_PERIOD_END"*/, v8);
    byte_4BCBC80 = 1;
  }
  ...
  if ( v11 >= *(_QWORD *)(Time + 56) )
  {
    ...
    if ( v11 < v13 )
    {
      ...
      if ( !Time )
LABEL_45:
        sub_1C1AE30(Time, AchiveTimeText);
      goto LABEL_28;
    }
  }
  else
...
LABEL_29:
  ...
  if ( v18 )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    Time = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_8854/*"MISSION_PERIOD_END"*/, 0LL);
    if ( !timeOverLb )
      goto LABEL_45;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCBC87 & 1) == 0 )
  {
    sub_1C1ABD4(&AtlasManager_TypeInfo, *(_QWORD *)&bannerGroupId);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCBC7F & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataManager_GetMaster_EventRandomMissionMaster___, missionListViewItem);
    sub_1C1ABD4(&DataManager_TypeInfo, v9);
    sub_1C1ABD4(&EventRandomMissionListViewItemDraw_TypeInfo, v10);
    sub_1C1ABD4(&EventRandomMissionListViewItem_TypeInfo, v11);
    sub_1C1ABD4(&EventRandomMissionListViewManager_TypeInfo, v12);
    sub_1C1ABD4(&EventRewardRootComponent_TypeInfo, v13);
    sub_1C1ABD4(&int_TypeInfo, v14);
    sub_1C1ABD4(&UnityEngine_Object_TypeInfo, v15);
    sub_1C1ABD4(&StringLiteral_17803/*"btn_mission_cancel"*/, v16);
    sub_1C1ABD4(&StringLiteral_21846/*"mission_board_{0}01"*/, v17);
    sub_1C1ABD4(&StringLiteral_21843/*"mission_board_rank_{0}{1:D2}"*/, v18);
    sub_1C1ABD4(&StringLiteral_21842/*"mission_board_mask_{0}01"*/, v19);
    byte_4BCBC7F = 1;
  }
  progTxt = 0LL;
  barExp = 0.0;
...
LABEL_18:
  ...
  if ( mode )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(baseSprite, 0LL, 0LL) )
    {
      ...
      v44 = System_String__Format((System_String_o *)StringLiteral_21846/*"mission_board_{0}01"*/, v43, 0LL);
    ...
    if ( UnityEngine_Object__op_Inequality(timeOverSprite, 0LL, 0LL) )
    {
      ...
      v51 = System_String__Format((System_String_o *)StringLiteral_21842/*"mission_board_mask_{0}01"*/, v50, 0LL);
      if ( !EventRewardRootComponent_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(EventRewardRootComponent_TypeInfo);
    ...
    if ( UnityEngine_Object__op_Inequality(rejectSprite, 0LL, 0LL) )
    {
      ...
      if ( !EventRewardRootComponent_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(EventRewardRootComponent_TypeInfo);
      EventRewardRootComponent__setRewardInfoImg(v53, (System_String_o *)StringLiteral_17803/*"btn_mission_cancel"*/, 0LL);
    ...
    if ( UnityEngine_Object__op_Inequality(rankSprite, 0LL, 0LL) )
    {
      ...
      rewardImg = (UnityEngine_GameObject_o *)DataManager__GetMaster_object_((const MethodInfo_2F9F43C *)Method_DataManager_GetMaster_EventRandomMissionMaster___);
      if ( !rewardImg )
        goto LABEL_97;
      ...
      v67 = System_String__Format_63054740((System_String_o *)StringLiteral_21843/*"mission_board_rank_{0}{1:D2}"*/, v62, v66, 0LL);
      if ( !EventRewardRootComponent_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(EventRewardRootComponent_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( !lockImgInfo )
    sub_1C1AE30(0LL, missionListViewItem);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCBC81 & 1) == 0 )
  {
    ...
    this = (EventRandomMissionListViewItemDraw_o *)sub_1C1ABD4(&UnityEngine_Object_TypeInfo, v8);
    byte_4BCBC81 = 1;
  }
  if ( !v5 )
    goto LABEL_53;
      ...
      if ( (_DWORD)v19 )
      {
        ...
        else
        {
          ...
          if ( num <= 1 )
            ...
            v27 = num;
          ItemIconComponent__SetItemImage_39342608(v6->fields.itemIcon, (int32_t)item, v27, 0LL);
        }
        this = (EventRandomMissionListViewItemDraw_o *)v6->fields.itemIcon;
        if ( !this )
LABEL_53:
      ...
      if ( (unsigned int)this < v20->max_length )
      {
        ...
        else
        {
          ...
          if ( v22 <= 1 )
            ...
            v23 = v21->fields.num;
          ItemIconComponent__SetItemImage_39342608((ItemIconComponent_o *)this, (int32_t)item, v23, 0LL);
        }
        goto LABEL_40;
      }
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCBC82 & 1) == 0 )
  {
    sub_1C1ABD4(&LocalizationManager_TypeInfo, *(_QWORD *)&status);
    sub_1C1ABD4(&StringLiteral_8854/*"MISSION_PERIOD_END"*/, v5);
    byte_4BCBC82 = 1;
  }
  ...
  if ( status == 5 )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    lockImgInfo = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8854/*"MISSION_PERIOD_END"*/, 0LL);
    if ( !timeOverLb )
LABEL_11:
      sub_1C1AE30(lockImgInfo, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCBC85 & 1) == 0 )
  {
    sub_1C1ABD4(&EventRandomMissionListViewItemDraw_TypeInfo, item);
    sub_1C1ABD4(&LocalizationManager_TypeInfo, v9);
    sub_1C1ABD4(&MissionListViewItemDraw_TypeInfo, v10);
    sub_1C1ABD4(&NetworkManager_TypeInfo, v11);
    sub_1C1ABD4(&UnityEngine_Object_TypeInfo, v12);
    sub_1C1ABD4(&StringLiteral_13594/*"TIME_REST_TIMEOVER"*/, v13);
    byte_4BCBC85 = 1;
  }
        ...
        if ( UnityEngine_GameObject__get_activeSelf(gameObject, 0LL) )
        {
          ...
          if ( v18 - oldTime >= v19->static_fields->TIME_UPDATE_ITVL_SEC )
          {
            ...
            gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                       (System_String_o *)StringLiteral_13594/*"TIME_REST_TIMEOVER"*/,
                                                       0LL);
            if ( !RestTime )
              goto LABEL_42;
            if ( System_String__Equals_63048684(RestTime, (System_String_o *)gameObject, 0LL) )
            {
