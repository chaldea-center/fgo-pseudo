void __fastcall EventRandomMissionListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C26218 & 1) == 0 )
  {
    sub_1C3B764(&EventRandomMissionListViewItemDraw_TypeInfo, v1);
    byte_4C26218 = 1;
  }
  static_fields = EventRandomMissionListViewItemDraw_TypeInfo->static_fields;
  *(_OWORD *)&static_fields->MISSION_COND_FONT_SIZE = xmmword_C0D980;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C26213 & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_13619/*"The constraint name {0} is already used in the schema."*/, v4);
    byte_4C26213 = 1;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v5 = LocalizationManager__Get((System_String_o *)StringLiteral_13619/*"The constraint name {0} is already used in the schema."*/, 0LL);
  RestTime = LocalizationManager__GetRestTime(closeTime, 0LL);
  return System_String__Concat_63379872(v5, (System_String_o *)StringLiteral_117/*"   "*/, RestTime, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C3B764(&LocalizationManager_TypeInfo, method);
    sub_1C3B764(&StringLiteral_13631/*"The current position on the Reader is neither an element nor an attribute."*/, v3);
    byte_4C26212 = 1;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_13631/*"The current position on the Reader is neither an element nor an attribute."*/, 0LL);
  RestTime = LocalizationManager__GetRestTime(endTime, 0LL);
  return System_String__Concat_63368612(v4, RestTime, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2620F & 1) == 0 )
  {
    sub_1C3B764(&EventRandomMissionListViewItemDraw_TypeInfo, missionListviewItem);
    sub_1C3B764(&EventRandomMissionListViewItem_TypeInfo, v5);
    sub_1C3B764(&LocalizationManager_TypeInfo, v6);
    sub_1C3B764(&NetworkManager_TypeInfo, v7);
    sub_1C3B764(&StringLiteral_8857/*"MinimumCapacity must be non-negative."*/, v8);
    byte_4C2620F = 1;
  }
  ...
  if ( v11 >= *(_QWORD *)(Time + 56) )
  {
    ...
    if ( v11 < v13 )
    {
      ...
      if ( !Time )
LABEL_45:
        sub_1C3B9C0(Time, AchiveTimeText);
      goto LABEL_28;
    }
  }
  else
...
LABEL_29:
  ...
  if ( v18 )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    Time = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_8857/*"MinimumCapacity must be non-negative."*/, 0LL);
    if ( !timeOverLb )
      goto LABEL_45;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C26216 & 1) == 0 )
  {
    sub_1C3B764(&AtlasManager_TypeInfo, *(_QWORD *)&bannerGroupId);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2620E & 1) == 0 )
  {
    sub_1C3B764(&Method_DataManager_GetMaster_EventRandomMissionMaster___, missionListViewItem);
    sub_1C3B764(&DataManager_TypeInfo, v9);
    sub_1C3B764(&EventRandomMissionListViewItemDraw_TypeInfo, v10);
    sub_1C3B764(&EventRandomMissionListViewItem_TypeInfo, v11);
    sub_1C3B764(&EventRandomMissionListViewManager_TypeInfo, v12);
    sub_1C3B764(&EventRewardRootComponent_TypeInfo, v13);
    sub_1C3B764(&int_TypeInfo, v14);
    sub_1C3B764(&UnityEngine_Object_TypeInfo, v15);
    sub_1C3B764(&StringLiteral_17861/*"condType"*/, v16);
    sub_1C3B764(&StringLiteral_21911/*"onAppReceiptRefreshFailed"*/, v17);
    sub_1C3B764(&StringLiteral_21908/*"omikuzi_{0}"*/, v18);
    sub_1C3B764(&StringLiteral_21907/*"olivedrab"*/, v19);
    byte_4C2620E = 1;
  }
  progTxt = 0LL;
  barExp = 0.0;
...
LABEL_18:
  ...
  if ( mode )
  {
    ...
    WrapControlText__textAdjust(missionCondLb, condMsg, v36->static_fields->MISSION_COND_FONT_SIZE, 0, 0LL);
    ...
    if ( UnityEngine_Object__op_Inequality(baseSprite, 0LL, 0LL) )
    {
      ...
      v44 = System_String__Format((System_String_o *)StringLiteral_21911/*"onAppReceiptRefreshFailed"*/, v43, 0LL);
    ...
    {
      v49 = this->fields.timeOverSprite;
      currentEventId = v21->fields.currentEventId;
      v50 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &currentEventId, v46, v47, v48);
      v51 = System_String__Format((System_String_o *)StringLiteral_21907/*"olivedrab"*/, v50, 0LL);
      if ( !EventRewardRootComponent_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(EventRewardRootComponent_TypeInfo);
      EventRewardRootComponent__setRewardInfoImg(v49, v51, 0LL);
    }
    ...
    {
      v53 = this->fields.rejectSprite;
      if ( !EventRewardRootComponent_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(EventRewardRootComponent_TypeInfo);
      EventRewardRootComponent__setRewardInfoImg(v53, (System_String_o *)StringLiteral_17861/*"condType"*/, 0LL);
      rewardImg = (UnityEngine_GameObject_o *)EventRandomMissionListViewItemDraw_TypeInfo;
      v54 = (UIWidget_o *)this->fields.rejectSprite;
      if ( !EventRandomMissionListViewItemDraw_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(EventRandomMissionListViewItemDraw_TypeInfo);
      if ( !v54 )
        goto LABEL_97;
      UIWidget__set_width(v54, EventRandomMissionListViewItemDraw_TypeInfo->static_fields->REJECT_SPRITE_WIDTH, 0LL);
    ...
    if ( UnityEngine_Object__op_Inequality(rankSprite, 0LL, 0LL) )
    {
      ...
      rewardImg = (UnityEngine_GameObject_o *)DataManager__GetMaster_object_((const MethodInfo_2FF01B0 *)Method_DataManager_GetMaster_EventRandomMissionMaster___);
      if ( !rewardImg )
        goto LABEL_97;
      ...
      if ( ((unsigned __int8)rewardImg & 1) != 0 )
      {
        if ( !entity )
          goto LABEL_97;
        v60 = (entity->fields.missionRank & ~(entity->fields.missionRank >> 31)) + 1;
      }
      else
      {
        v60 = 1;
      }
      v61 = this->fields.rankSprite;
      currentEventId = v21->fields.currentEventId;
      v62 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &currentEventId, v57, v58, v59);
      v75 = v60;
      v66 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v75, v63, v64, v65);
      v67 = System_String__Format_63382984((System_String_o *)StringLiteral_21908/*"omikuzi_{0}"*/, v62, v66, 0LL);
      if ( !EventRewardRootComponent_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(EventRewardRootComponent_TypeInfo);
      EventRewardRootComponent__setRewardInfoImg(v61, v67, 0LL);
      rewardImg = (UnityEngine_GameObject_o *)EventRandomMissionListViewItemDraw_TypeInfo;
      v68 = (UIWidget_o *)this->fields.rankSprite;
      if ( !EventRandomMissionListViewItemDraw_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(EventRandomMissionListViewItemDraw_TypeInfo);
      if ( !v68
        || (UIWidget__set_width(v68, EventRandomMissionListViewItemDraw_TypeInfo->static_fields->RANK_SPRITE_WIDTH, 0LL),
            (rewardImg = (UnityEngine_GameObject_o *)this->fields.rankSprite) == 0LL) )
      {
LABEL_97:
        sub_1C3B9C0(rewardImg, v23);
      }
      UIWidget__set_height(
        (UIWidget_o *)rewardImg,
    ...
    {
      v70 = this->fields.rewardBackSprite;
      ...
      if ( !EventRewardRootComponent_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(EventRewardRootComponent_TypeInfo);
      EventRewardRootComponent__SetRewardRaritySprite(v70, v74, rewardObjectId, rewardRarityId, 0LL);
    }
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !lockImgInfo )
    sub_1C3B9C0(0LL, missionListViewItem);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C26210 & 1) == 0 )
  {
    ...
    this = (EventRandomMissionListViewItemDraw_o *)sub_1C3B764(&UnityEngine_Object_TypeInfo, v8);
    byte_4C26210 = 1;
  }
  if ( !v5 )
    goto LABEL_53;
      ...
      if ( (_DWORD)v19 )
      {
        ...
        else
        {
          ...
          if ( num <= 1 )
            ...
            v27 = num;
          ItemIconComponent__SetItemImage_39568612(v6->fields.itemIcon, (int32_t)item, v27, 0LL);
        }
        this = (EventRandomMissionListViewItemDraw_o *)v6->fields.itemIcon;
        if ( !this )
LABEL_53:
      ...
      if ( (unsigned int)this < v20->max_length )
      {
        ...
        else
        {
          ...
          if ( v22 <= 1 )
            ...
            v23 = v21->fields.num;
          ItemIconComponent__SetItemImage_39568612((ItemIconComponent_o *)this, (int32_t)item, v23, 0LL);
        }
        goto LABEL_40;
      }
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C26211 & 1) == 0 )
  {
    sub_1C3B764(&LocalizationManager_TypeInfo, *(_QWORD *)&status);
    sub_1C3B764(&StringLiteral_8857/*"MinimumCapacity must be non-negative."*/, v5);
    byte_4C26211 = 1;
  }
  ...
  if ( status == 5 )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    lockImgInfo = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8857/*"MinimumCapacity must be non-negative."*/, 0LL);
    if ( !timeOverLb )
LABEL_11:
      sub_1C3B9C0(lockImgInfo, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C26214 & 1) == 0 )
  {
    sub_1C3B764(&EventRandomMissionListViewItemDraw_TypeInfo, item);
    sub_1C3B764(&LocalizationManager_TypeInfo, v9);
    sub_1C3B764(&MissionListViewItemDraw_TypeInfo, v10);
    sub_1C3B764(&NetworkManager_TypeInfo, v11);
    sub_1C3B764(&UnityEngine_Object_TypeInfo, v12);
    sub_1C3B764(&StringLiteral_13643/*"The derived sequence particle at ({0}, {1}) is not a valid restriction of the base all particle at ({2}, {3}) according to Sequence:All -- RecurseUnordered."*/, v13);
    byte_4C26214 = 1;
  }
      ...
      if ( UnityEngine_GameObject__get_activeSelf(gameObject, 0LL) )
      {
        ...
        if ( UnityEngine_GameObject__get_activeSelf(gameObject, 0LL) )
        {
          ...
          if ( v18 - oldTime >= v19->static_fields->TIME_UPDATE_ITVL_SEC )
          {
            ...
            if ( !RestTime )
              goto LABEL_42;
            if ( System_String__Equals_63376928(RestTime, (System_String_o *)gameObject, 0LL) )
            {
