void __fastcall EventRandomMissionListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  int v2; // w2
  __int64 v3; // x3
  EventRandomMissionListViewItemDraw_c *v4; // x8

  if ( (byte_42E8E75 & 1) == 0 )
  {
    sub_B5D5C4(&EventRandomMissionListViewItemDraw_TypeInfo, v1, v2, v3);
    byte_42E8E75 = 1;
  }
  ...
  v4 = EventRandomMissionListViewItemDraw_TypeInfo;
  EventRandomMissionListViewItemDraw_TypeInfo->static_fields->REJECT_SPRITE_HEIGHT = 36;
  v4->static_fields->RANK_SPRITE_WIDTH = 64;
  v4->static_fields->RANK_SPRITE_HEIGHT = 64;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42E8E6C & 1) == 0 )
  {
    sub_B5D5C4(&EventRandomMissionListViewItemDraw_TypeInfo, (_DWORD)missionListviewItem, (_DWORD)method, v3);
    sub_B5D5C4(&EventRandomMissionListViewItem_TypeInfo, v6, v7, v8);
    sub_B5D5C4(&LocalizationManager_TypeInfo, v9, v10, v11);
    sub_B5D5C4(&NetworkManager_TypeInfo, v12, v13, v14);
    sub_B5D5C4(&StringLiteral_8844/*"MISSION_PERIOD_END"*/, v15, v16, v17);
    byte_42E8E6C = 1;
  }
  ...
  if ( !Time )
    goto LABEL_51;
  if ( v20 >= *(_QWORD *)(Time + 56) )
  {
    Time = (int64_t)MissionListViewItem__get_EventMissionEntity(missionListviewItem, 0LL);
    if ( !Time )
      goto LABEL_51;
    v22 = *(_QWORD *)(Time + 64);
    this->fields.isDispTime = v20 < v22;
    ...
    if ( v20 < v22 )
    {
      ...
      RestTimeText = EventRandomMissionListViewItemDraw__GetRestTimeText(v23, AchiveTimeText);
      if ( missionListviewItem->fields.progStatus == 3 )
      {
        ...
        AchiveTimeText = (MethodInfo *)EventRandomMissionListViewItemDraw__GetAchiveTimeText(v25, AchiveTimeText);
...
LABEL_51:
  ...
  Time = (int64_t)EventRandomMissionListViewItemDraw__GetAchiveTimeText(v28, AchiveTimeText);
...
LABEL_34:
  ...
  if ( v27 )
  {
    ...
    v30 = *(&EventRandomMissionListViewItem_TypeInfo->_2.bitflags2 + 1);
    if ( *(&missionListviewItem->klass->_2.bitflags2 + 1) >= (unsigned int)v30
      && (EventRandomMissionListViewItem_c *)missionListviewItem->klass->_2.typeHierarchy[v30 - 1] == EventRandomMissionListViewItem_TypeInfo )
    {
        ...
        const MethodInfo *method)
{
  ...
  EventRandomMissionListViewItemDraw_c *v16; // x0
  ...
  if ( missionListViewItem
    && (v12 = *(&EventRandomMissionListViewItem_TypeInfo->_2.bitflags2 + 1),
        *(&missionListViewItem->klass->_2.bitflags2 + 1) >= (unsigned int)v12)
    && (EventRandomMissionListViewItem_c *)missionListViewItem->klass->_2.typeHierarchy[v12 - 1] == EventRandomMissionListViewItem_TypeInfo )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(baseButton, 0LL, 0LL) )
    {
      ...
      v16 = EventRandomMissionListViewItemDraw_TypeInfo;
      if ( (BYTE3(EventRandomMissionListViewItemDraw_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
        && !EventRandomMissionListViewItemDraw_TypeInfo->_2.cctor_finished )
      {
        j_il2cpp_runtime_class_init_0(EventRandomMissionListViewItemDraw_TypeInfo);
      ...
      WrapControlText__textAdjust(missionCondLb, condMsg, v16->static_fields->MISSION_COND_FONT_SIZE, 0, 0, 0LL);
    }
  }
  else
  {
        ...
        const MethodInfo *method)
{
  ...
  __int64 v41; // x3
  __int64 v42; // x10
  EventRandomMissionListViewItem_o *v43; // x20
  __int64 v44; // x10
  __int64 v45; // x1
  ...
  EventRandomMissionListViewItemDraw_c *v58; // x0
  ...
  v5 = (UnityEngine_Object_o *)listViewManager;
  if ( (byte_42E8E6B & 1) == 0 )
  {
    sub_B5D5C4(
      &Method_DataManager_GetMaster_EventRandomMissionMaster___,
      (_DWORD)missionListViewItem,
      mode,
      listViewManager);
    sub_B5D5C4(&DataManager_TypeInfo, v9, v10, v11);
    sub_B5D5C4(&EventRandomMissionListViewItemDraw_TypeInfo, v12, v13, v14);
    sub_B5D5C4(&EventRandomMissionListViewItem_TypeInfo, v15, v16, v17);
    sub_B5D5C4(&EventRandomMissionListViewManager_TypeInfo, v18, v19, v20);
    sub_B5D5C4(&EventRewardRootComponent_TypeInfo, v21, v22, v23);
    sub_B5D5C4(&int_TypeInfo, v24, v25, v26);
    sub_B5D5C4(&UnityEngine_Object_TypeInfo, v27, v28, v29);
    sub_B5D5C4(&StringLiteral_17213/*"btn_mission_cancel"*/, v30, v31, v32);
    sub_B5D5C4(&StringLiteral_20805/*"mission_board_{0}01"*/, v33, v34, v35);
    sub_B5D5C4(&StringLiteral_20802/*"mission_board_rank_{0}{1:D2}"*/, v36, v37, v38);
    sub_B5D5C4(&StringLiteral_20801/*"mission_board_mask_{0}01"*/, v39, v40, v41);
    byte_42E8E6B = 1;
  }
  progTxt = 0LL;
  barExp = 0.0;
  entity = 0LL;
  if ( !missionListViewItem
    || (v42 = *(&EventRandomMissionListViewItem_TypeInfo->_2.bitflags2 + 1),
        *(&missionListViewItem->klass->_2.bitflags2 + 1) < (unsigned int)v42) )
  {
    v43 = 0LL;
    if ( !v5 )
      goto LABEL_6;
LABEL_12:
    v44 = *(&EventRandomMissionListViewManager_TypeInfo->_2.bitflags2 + 1);
    if ( *(&v5->klass->_2.bitflags2 + 1) >= (unsigned int)v44 )
    {
      if ( (EventRandomMissionListViewManager_c *)v5->klass->_2.typeHierarchy[v44 - 1] != EventRandomMissionListViewManager_TypeInfo )
        v5 = 0LL;
      if ( !v43 )
        return 0;
    }
  ...
  if ( (EventRandomMissionListViewItem_c *)missionListViewItem->klass->_2.typeHierarchy[v42 - 1] == EventRandomMissionListViewItem_TypeInfo )
    v43 = (EventRandomMissionListViewItem_o *)missionListViewItem;
  else
    v43 = 0LL;
  if ( v5 )
    goto LABEL_12;
...
LABEL_18:
  ...
  if ( mode )
  {
    ...
    missionCondLb = this->fields.missionCondLb;
    condMsg = v43->fields.condMsg;
    v58 = EventRandomMissionListViewItemDraw_TypeInfo;
    if ( (BYTE3(EventRandomMissionListViewItemDraw_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
      && !EventRandomMissionListViewItemDraw_TypeInfo->_2.cctor_finished )
    {
      j_il2cpp_runtime_class_init_0(EventRandomMissionListViewItemDraw_TypeInfo);
    ...
    WrapControlText__textAdjust(missionCondLb, condMsg, v58->static_fields->MISSION_COND_FONT_SIZE, 0, 0, 0LL);
    ...
    {
      v61 = this->fields.baseSprite;
      currentEventId = v43->fields.currentEventId;
      v62 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &currentEventId);
      v63 = System_String__Format((System_String_o *)StringLiteral_20805/*"mission_board_{0}01"*/, v62, 0LL);
      if ( (BYTE3(EventRewardRootComponent_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
        && !EventRewardRootComponent_TypeInfo->_2.cctor_finished )
      {
        j_il2cpp_runtime_class_init_0(EventRewardRootComponent_TypeInfo);
      }
      EventRewardRootComponent__setRewardInfoImg(v61, v63, 0LL);
    }
    ...
    {
      v65 = this->fields.timeOverSprite;
      currentEventId = v43->fields.currentEventId;
      v66 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &currentEventId);
      v67 = System_String__Format((System_String_o *)StringLiteral_20801/*"mission_board_mask_{0}01"*/, v66, 0LL);
      if ( (BYTE3(EventRewardRootComponent_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
        && !EventRewardRootComponent_TypeInfo->_2.cctor_finished )
      {
        j_il2cpp_runtime_class_init_0(EventRewardRootComponent_TypeInfo);
      }
      EventRewardRootComponent__setRewardInfoImg(v65, v67, 0LL);
    }
    ...
    {
      v69 = this->fields.rejectSprite;
      if ( (BYTE3(EventRewardRootComponent_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
        && !EventRewardRootComponent_TypeInfo->_2.cctor_finished )
      {
        j_il2cpp_runtime_class_init_0(EventRewardRootComponent_TypeInfo);
      }
      EventRewardRootComponent__setRewardInfoImg(v69, (System_String_o *)StringLiteral_17213/*"btn_mission_cancel"*/, 0LL);
      rewardImg = (UnityEngine_GameObject_o *)EventRandomMissionListViewItemDraw_TypeInfo;
      v70 = (UIWidget_o *)this->fields.rejectSprite;
      if ( (BYTE3(EventRandomMissionListViewItemDraw_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
        && !EventRandomMissionListViewItemDraw_TypeInfo->_2.cctor_finished )
      {
        j_il2cpp_runtime_class_init_0(EventRandomMissionListViewItemDraw_TypeInfo);
      ...
      if ( !v70 )
        goto LABEL_113;
      UIWidget__set_width(v70, EventRandomMissionListViewItemDraw_TypeInfo->static_fields->REJECT_SPRITE_WIDTH, 0LL);
    ...
    if ( UnityEngine_Object__op_Inequality(rankSprite, 0LL, 0LL) )
    {
      ...
      rewardImg = (UnityEngine_GameObject_o *)DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1AE41EC *)Method_DataManager_GetMaster_EventRandomMissionMaster___);
      if ( !rewardImg )
        goto LABEL_113;
      rewardImg = (UnityEngine_GameObject_o *)EventRandomMissionMaster__TryGetEntity(
                                                (EventRandomMissionMaster_o *)rewardImg,
                                                &entity,
                                                v43->fields.currentMissionId,
                                                v73);
      if ( ((unsigned __int8)rewardImg & 1) != 0 )
      {
        if ( !entity )
          goto LABEL_113;
        v74 = (entity->fields.missionRank & ~(entity->fields.missionRank >> 31)) + 1;
      }
      else
      {
        v74 = 1;
      }
      v75 = this->fields.rankSprite;
      currentEventId = v43->fields.currentEventId;
      v76 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &currentEventId);
      v86 = v74;
      v77 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v86);
      v78 = System_String__Format_44573324((System_String_o *)StringLiteral_20802/*"mission_board_rank_{0}{1:D2}"*/, v76, v77, 0LL);
      if ( (BYTE3(EventRewardRootComponent_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
        && !EventRewardRootComponent_TypeInfo->_2.cctor_finished )
      {
        j_il2cpp_runtime_class_init_0(EventRewardRootComponent_TypeInfo);
      }
      EventRewardRootComponent__setRewardInfoImg(v75, v78, 0LL);
      rewardImg = (UnityEngine_GameObject_o *)EventRandomMissionListViewItemDraw_TypeInfo;
      v79 = (UIWidget_o *)this->fields.rankSprite;
      if ( (BYTE3(EventRandomMissionListViewItemDraw_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
        && !EventRandomMissionListViewItemDraw_TypeInfo->_2.cctor_finished )
      {
        j_il2cpp_runtime_class_init_0(EventRandomMissionListViewItemDraw_TypeInfo);
      ...
      if ( !v79
        || (UIWidget__set_width(v79, EventRandomMissionListViewItemDraw_TypeInfo->static_fields->RANK_SPRITE_WIDTH, 0LL),
            (rewardImg = (UnityEngine_GameObject_o *)this->fields.rankSprite) == 0LL) )
      {
LABEL_113:
        sub_B5D69C(rewardImg, v45);
      }
      UIWidget__set_height(
        (UIWidget_o *)rewardImg,
    ...
    EventRandomMissionListViewItemDraw__SetRewardItemIcon(this, v43, (EventRandomMissionListViewManager_o *)v5, v72);
    ...
    {
      v81 = this->fields.rewardBackSprite;
      Type = MissionListViewItem__get_Type((MissionListViewItem_o *)v43, 0LL);
      rewardObjectId = v43->fields.rewardObjectId;
      rewardRarityId = v43->fields.rewardRarityId;
      v85 = Type;
      if ( (BYTE3(EventRewardRootComponent_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
        && !EventRewardRootComponent_TypeInfo->_2.cctor_finished )
      {
      ...
      EventRewardRootComponent__SetRewardRaritySprite(v81, v85, rewardObjectId, rewardRarityId, 0LL);
    }
  }
  if ( v43->fields._IsDummy_k__BackingField )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42E8E6D & 1) == 0 )
  {
    sub_B5D5C4(&Method_DataManager_GetMaster_GiftMaster___, (_DWORD)item, (_DWORD)manager, method);
    sub_B5D5C4(&DataManager_TypeInfo, v7, v8, v9);
    this = (EventRandomMissionListViewItemDraw_o *)sub_B5D5C4(&UnityEngine_Object_TypeInfo, v10, v11, v12);
    byte_42E8E6D = 1;
  }
  if ( !v5 )
    goto LABEL_55;
  ...
  {
    if ( EventRandomMissionListViewItem__get_IsHideReward(v5, v13) )
    {
    ...
    sub_B5D560((BattleServantConfConponent_o *)&v6->fields.giftEntityList, GiftListById, v16, v17, v18, v19, v20, v21);
    giftEntityList = v6->fields.giftEntityList;
    if ( !giftEntityList )
      goto LABEL_55;
    v23 = *(_QWORD *)&giftEntityList->max_length;
    if ( !v23 )
      return;
    ...
    if ( (int)v23 < 2 )
    {
      ...
      {
        v28 = giftEntityList->m_Items[0];
        if ( !v28 )
          goto LABEL_55;
        item = (EventRandomMissionListViewItem_o *)(unsigned int)v28->fields.prioredIconId;
        ...
        if ( (int)item < 1 )
        {
          ...
          if ( !itemIcon )
            goto LABEL_55;
          ItemIconComponent__SetGiftDesignSize(itemIcon, v34, rewardObjectId, (int32_t)this, 0LL);
        }
        else
        {
          if ( !itemIcon )
          ...
          if ( num <= 1 )
            ...
            v31 = num;
          ItemIconComponent__SetItemImage_28499576(v6->fields.itemIcon, (int32_t)item, v31, 0LL);
        }
        this = (EventRandomMissionListViewItemDraw_o *)v6->fields.itemIcon;
        if ( !this )
LABEL_55:
    ...
    else
    {
      ...
      if ( (unsigned int)this < v24->max_length )
      {
        ...
        if ( !v25 )
          goto LABEL_55;
        item = (EventRandomMissionListViewItem_o *)(unsigned int)v25->fields.prioredIconId;
        this = (EventRandomMissionListViewItemDraw_o *)v6->fields.itemIcon;
        v26 = v25->fields.num;
        if ( (int)item < 1 )
        {
        ...
        else
        {
          ...
          if ( v26 <= 1 )
            ...
            v27 = v25->fields.num;
          ItemIconComponent__SetItemImage_28499576((ItemIconComponent_o *)this, (int32_t)item, v27, 0LL);
        }
        goto LABEL_42;
      }
    }
...
LABEL_42:
  ...
  {
    if ( EventRandomMissionListViewItem__get_IsHideReward(v5, v35) )
    {
      this = (EventRandomMissionListViewItemDraw_o *)v6->fields.itemIcon;
      v6->fields.isMultipleReward = 0;
      if ( this )
        ...
        const MethodInfo *method)
{
  ...
  int64_t oldTime; // x23
  int64_t v28; // x22
  MissionListViewItemDraw_c *v29; // x8
  ...
  if ( (byte_42E8E71 & 1) == 0 )
  {
    sub_B5D5C4(&EventRandomMissionListViewItemDraw_TypeInfo, (_DWORD)item, mode, method);
    sub_B5D5C4(&LocalizationManager_TypeInfo, v9, v10, v11);
    sub_B5D5C4(&MissionListViewItemDraw_TypeInfo, v12, v13, v14);
    sub_B5D5C4(&NetworkManager_TypeInfo, v15, v16, v17);
    sub_B5D5C4(&UnityEngine_Object_TypeInfo, v18, v19, v20);
    sub_B5D5C4(&StringLiteral_13567/*"TIME_REST_TIMEOVER"*/, v21, v22, v23);
    byte_42E8E71 = 1;
  }
    ...
    if ( mode )
    {
      ...
      if ( UnityEngine_GameObject__get_activeSelf(gameObject, 0LL) )
      {
        ...
        if ( UnityEngine_GameObject__get_activeSelf(gameObject, 0LL) )
        {
          ...
          v28 = (int64_t)gameObject;
          v29 = MissionListViewItemDraw_TypeInfo;
          if ( (BYTE3(MissionListViewItemDraw_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
            && !MissionListViewItemDraw_TypeInfo->_2.cctor_finished )
          {
            j_il2cpp_runtime_class_init_0(MissionListViewItemDraw_TypeInfo);
          ...
          if ( v28 - oldTime >= v29->static_fields->TIME_UPDATE_ITVL_SEC )
          {
            if ( !v26 )
              goto LABEL_48;
            ...
            {
              klass = (int64_t)v26[3].klass;
              if ( (BYTE3(EventRandomMissionListViewItemDraw_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
                && !EventRandomMissionListViewItemDraw_TypeInfo->_2.cctor_finished )
              {
                j_il2cpp_runtime_class_init_0(EventRandomMissionListViewItemDraw_TypeInfo);
              }
              gameObject = (UnityEngine_GameObject_o *)EventRandomMissionListViewItemDraw__GetAchiveTimeText(klass, v24);
            }
            else
            {
              v32 = *(_QWORD *)&v26[2].fields.m_CachedPtr;
              if ( (BYTE3(EventRandomMissionListViewItemDraw_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
                && !EventRandomMissionListViewItemDraw_TypeInfo->_2.cctor_finished )
              {
                j_il2cpp_runtime_class_init_0(EventRandomMissionListViewItemDraw_TypeInfo);
              }
              gameObject = (UnityEngine_GameObject_o *)EventRandomMissionListViewItemDraw__GetRestTimeText(v32, v24);
            }
            v24 = (const MethodInfo *)gameObject;
            if ( !resTimeLb )
              goto LABEL_48;
            UILabel__set_text(resTimeLb, (System_String_o *)gameObject, 0LL);
            this->fields.oldTime = v28;
            v33 = *(_QWORD *)&v26[2].fields.m_CachedPtr;
            if ( (BYTE3(LocalizationManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
              && !LocalizationManager_TypeInfo->_2.cctor_finished )
            {
              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
            ...
            if ( !RestTime )
              goto LABEL_48;
            if ( System_String__Equals_44565128(RestTime, (System_String_o *)gameObject, 0LL) )
            {
