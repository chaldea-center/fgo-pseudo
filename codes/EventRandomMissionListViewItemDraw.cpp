void __fastcall EventRandomMissionListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A23A2B & 1) == 0 )
  {
    sub_1B715CC(&EventRandomMissionListViewItemDraw_TypeInfo, v1);
    byte_4A23A2B = 1;
  }
  static_fields = EventRandomMissionListViewItemDraw_TypeInfo->static_fields;
  *(_OWORD *)&static_fields->MISSION_COND_FONT_SIZE = xmmword_BAAF20;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A23A22 & 1) == 0 )
  {
    sub_1B715CC(&EventRandomMissionListViewItemDraw_TypeInfo, missionListviewItem);
    sub_1B715CC(&EventRandomMissionListViewItem_TypeInfo, v5);
    sub_1B715CC(&LocalizationManager_TypeInfo, v6);
    sub_1B715CC(&NetworkManager_TypeInfo, v7);
    sub_1B715CC(&StringLiteral_8648/*"MISSION_PERIOD_END"*/, v8);
    byte_4A23A22 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A23A21 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataManager_GetMaster_EventRandomMissionMaster___, missionListViewItem);
    sub_1B715CC(&DataManager_TypeInfo, v9);
    sub_1B715CC(&EventRandomMissionListViewItemDraw_TypeInfo, v10);
    sub_1B715CC(&EventRandomMissionListViewItem_TypeInfo, v11);
    sub_1B715CC(&EventRandomMissionListViewManager_TypeInfo, v12);
    sub_1B715CC(&EventRewardRootComponent_TypeInfo, v13);
    sub_1B715CC(&int_TypeInfo, v14);
    sub_1B715CC(&UnityEngine_Object_TypeInfo, v15);
    sub_1B715CC(&StringLiteral_17473/*"btn_mission_cancel"*/, v16);
    sub_1B715CC(&StringLiteral_21426/*"mission_board_{0}01"*/, v17);
    sub_1B715CC(&StringLiteral_21423/*"mission_board_rank_{0}{1:D2}"*/, v18);
    sub_1B715CC(&StringLiteral_21422/*"mission_board_mask_{0}01"*/, v19);
    byte_4A23A21 = 1;
  }
  progTxt = 0LL;
  barExp = 0.0;
...
LABEL_18:
  ...
  if ( mode )
  {
    ...
    sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.giftEntityList, (int32_t)giftEnts, v26, v27);
    giftEntityList = this->fields.giftEntityList;
    if ( !giftEntityList )
      goto LABEL_97;
    ...
    if ( UnityEngine_Object__op_Inequality(baseSprite, 0LL, 0LL) )
    {
      ...
      v40 = System_String__Format((System_String_o *)StringLiteral_21426/*"mission_board_{0}01"*/, v39, 0LL);
    ...
    if ( UnityEngine_Object__op_Inequality(timeOverSprite, 0LL, 0LL) )
    {
      ...
      v47 = System_String__Format((System_String_o *)StringLiteral_21422/*"mission_board_mask_{0}01"*/, v46, 0LL);
      if ( !EventRewardRootComponent_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(EventRewardRootComponent_TypeInfo);
    ...
    if ( UnityEngine_Object__op_Inequality(rejectSprite, 0LL, 0LL) )
    {
      ...
      if ( !EventRewardRootComponent_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(EventRewardRootComponent_TypeInfo);
      EventRewardRootComponent__setRewardInfoImg(v49, (System_String_o *)StringLiteral_17473/*"btn_mission_cancel"*/, 0LL);
    ...
    if ( UnityEngine_Object__op_Inequality(rankSprite, 0LL, 0LL) )
    {
      ...
      rewardImg = (UnityEngine_GameObject_o *)DataManager__GetMaster_object_((const MethodInfo_2E5B394 *)Method_DataManager_GetMaster_EventRandomMissionMaster___);
      if ( !rewardImg )
        goto LABEL_97;
      ...
      v63 = System_String__Format_61519876((System_String_o *)StringLiteral_21423/*"mission_board_rank_{0}{1:D2}"*/, v58, v62, 0LL);
      if ( !EventRewardRootComponent_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(EventRewardRootComponent_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A23A23 & 1) == 0 )
  {
    ...
    this = (EventRandomMissionListViewItemDraw_o *)sub_1B715CC(&UnityEngine_Object_TypeInfo, v8);
    byte_4A23A23 = 1;
  }
  if ( !v5 )
    goto LABEL_53;
  if ( MissionListViewItem__get_EventRewardType((MissionListViewItem_o *)v5, 0LL) == 1 )
  {
    ...
    sub_1B71570((ServantStatusBattleListViewItem_o *)&v6->fields.giftEntityList, (int32_t)GiftListById, v12, v13);
      ...
      if ( (_DWORD)v15 )
      {
        ...
        else
        {
          ...
          if ( num <= 1 )
            ...
            v23 = num;
          ItemIconComponent__SetItemImage_37941556(v6->fields.itemIcon, (int32_t)item, v23, 0LL);
        }
        this = (EventRandomMissionListViewItemDraw_o *)v6->fields.itemIcon;
        if ( !this )
LABEL_53:
      ...
      if ( (unsigned int)this < v16->max_length )
      {
        ...
        else
        {
          ...
          if ( v18 <= 1 )
            ...
            v19 = v17->fields.num;
          ItemIconComponent__SetItemImage_37941556((ItemIconComponent_o *)this, (int32_t)item, v19, 0LL);
        }
        goto LABEL_40;
      }
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A23A27 & 1) == 0 )
  {
    sub_1B715CC(&EventRandomMissionListViewItemDraw_TypeInfo, item);
    sub_1B715CC(&LocalizationManager_TypeInfo, v9);
    sub_1B715CC(&MissionListViewItemDraw_TypeInfo, v10);
    sub_1B715CC(&NetworkManager_TypeInfo, v11);
    sub_1B715CC(&UnityEngine_Object_TypeInfo, v12);
    sub_1B715CC(&StringLiteral_13301/*"TIME_REST_TIMEOVER"*/, v13);
    byte_4A23A27 = 1;
  }
      ...
      if ( UnityEngine_GameObject__get_activeSelf(gameObject, 0LL) )
      {
        ...
        if ( UnityEngine_GameObject__get_activeSelf(gameObject, 0LL) )
        {
          ...
          if ( v18 - oldTime >= v19->static_fields->TIME_UPDATE_ITVL_SEC )
          {
            ...
            if ( !RestTime )
              goto LABEL_42;
            if ( System_String__Equals_61513820(RestTime, (System_String_o *)gameObject, 0LL) )
            {
