        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B68BB7 & 1) == 0 )
  {
    sub_1BE4ACC(&EventInfoUISpriteControl__CoWaitWhilePlayingAfterAction_d__8_TypeInfo, method);
    byte_4B68BB7 = 1;
  }
  v3 = sub_1BE4D18(EventInfoUISpriteControl__CoWaitWhilePlayingAfterAction_d__8_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B68BB5 & 1) == 0 )
  {
    sub_1BE4ACC(&System_Action_TypeInfo, eventUiEntity);
    sub_1BE4ACC(&AtlasManager_TypeInfo, v5);
    sub_1BE4ACC(&Method_EventInfoUISpriteControl__Initialization_b__5_0__, v6);
    byte_4B68BB5 = 1;
  }
  ...
  if ( ((unsigned __int8)IsNullOrWhiteSpace & 1) != 0 )
  {
    ...
    sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.spriteName, (int64_t)v9, v10, v11, v12, v13, v14, v15);
  }
...
LABEL_18:
    sub_1BE4D28(IsNullOrWhiteSpace, v8);
  ...
  if ( this->fields.isHideWhileAfterAction && EventInfoUISpriteControl__IsPlayingAfterAction(v21, v22) )
  {
    ...
    if ( IsNullOrWhiteSpace )
    {
      ...
      UnityEngine_MonoBehaviour__StartCoroutine_70437272((UnityEngine_MonoBehaviour_o *)this, v24, 0LL);
      return;
    }
    goto LABEL_18;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B68BB6 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_SingletonMonoBehaviour_QuestAfterAction__get_Instance__, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B68BB9 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_EventInfoUISpriteControl_IsPlayingAfterAction__, method);
    sub_1BE4ACC(&System_Func_bool__TypeInfo, v3);
    this = (EventInfoUISpriteControl__CoWaitWhilePlayingAfterAction_d__8_o *)sub_1BE4ACC(
  ...
  else if ( !_1__state )
  {
    ...
    v8 = (UnityEngine_WaitWhile_o *)sub_1BE4D18(UnityEngine_WaitWhile_TypeInfo);
    UnityEngine_WaitWhile___ctor(v8, v7, 0LL);
    v2->fields.__2__current = (Il2CppObject *)v8;
    sub_1BE4A70((PartyOrganizationUtility_o *)&v2->fields.__2__current, (int64_t)v8, v9, v10, v11, v12, v13, v14);
    result = 1;
    v2->fields.__1__state = 1;
    return result;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BE4AE0(&Method_EventInfoUISpriteControl__CoWaitWhilePlayingAfterAction_d__8_System_Collections_IEnumerator_Reset__);
  sub_1BE4BF4(v3, v4);
}
