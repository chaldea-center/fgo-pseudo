        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E79472 & 1) == 0 )
  {
    sub_1D0F0B4(&EventInfoUISpriteControl__CoWaitWhilePlayingAfterAction_d__8_TypeInfo);
    byte_4E79472 = 1;
  }
  v3 = sub_1D0F300(EventInfoUISpriteControl__CoWaitWhilePlayingAfterAction_d__8_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E79470 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_EventInfoUISpriteControl__Initialization_b__5_0__);
    byte_4E79470 = 1;
  }
  ...
  if ( ((unsigned __int8)IsNullOrWhiteSpace & 1) != 0 )
  {
    ...
    sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.spriteName, (int32_t)v7, v8, v9, v10, v11, v12, v13);
  }
...
LABEL_18:
    sub_1D0F30C(IsNullOrWhiteSpace, v6);
  ...
  if ( this->fields.isHideWhileAfterAction && EventInfoUISpriteControl__IsPlayingAfterAction(v19, v20) )
  {
    ...
    if ( IsNullOrWhiteSpace )
    {
      ...
      UnityEngine_MonoBehaviour__StartCoroutine_73344676((UnityEngine_MonoBehaviour_o *)this, v22, 0);
      return;
    }
    goto LABEL_18;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E79474 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_EventInfoUISpriteControl_IsPlayingAfterAction__);
    sub_1D0F0B4(&System_Func_bool__TypeInfo);
    this = (EventInfoUISpriteControl__CoWaitWhilePlayingAfterAction_d__8_o *)sub_1D0F0B4(&UnityEngine_WaitWhile_TypeInfo);
    byte_4E79474 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1D0F0C8(&Method_EventInfoUISpriteControl__CoWaitWhilePlayingAfterAction_d__8_System_Collections_IEnumerator_Reset__);
  sub_1D0F1DC(v3, v4);
}
