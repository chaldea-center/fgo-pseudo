void BattleActionLogManager___ctor(BattleActionLogManager_o *this, const MethodInfo *method)
{
  ...
  v3 = (System_IO_MemoryStream_o *)sub_1CE694C(System_IO_MemoryStream_TypeInfo);
  ...
  v18 = (System_IO_BinaryWriter_o *)sub_1CE694C(System_IO_BinaryWriter_TypeInfo);
  System_IO_BinaryWriter___ctor_66032156(v18, header, 0);
  this->fields.headerWriter = v18;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.headerWriter, (int32_t)v18, v19, v20, v21, v22, v23, v24);
  data = (System_IO_Stream_o *)this->fields.data;
  v26 = (System_IO_BinaryWriter_o *)sub_1CE694C(System_IO_BinaryWriter_TypeInfo);
  System_IO_BinaryWriter___ctor_66032156(v26, data, 0);
  this->fields.dataWriter = v26;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.dataWriter, (int32_t)v26, v27, v28, v29, v30, v31, v32);
}
...
void BattleActionLogManager__addHeader(BattleActionLogManager_o *this, int32_t logType, const MethodInfo *method)
{
  ...
  if ( !headerWriter
    ...
    || (v5 = this->fields.headerWriter,
        ...
        !v5) )
  {
    sub_1CE6958(headerWriter, *(_QWORD *)&logType);
  }
  ...
  if ( (int)max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      if ( v10 >= (unsigned int)max_length )
        sub_1CE6960(dataWriter);
      dataWriter = this->fields.dataWriter;
      if ( !dataWriter )
        break;
      dataWriter = (void *)(*(__int64 (__fastcall **)(void *, _QWORD, _QWORD))(*(_QWORD *)dataWriter + 584LL))(
                             dataWriter,
                             (unsigned int)v8->m_Items[v10],
                             *(_QWORD *)(*(_QWORD *)dataWriter + 592LL));
...
LABEL_10:
  ...
  if ( !v11 )
    goto LABEL_13;
  ((void (__fastcall *)(struct System_IO_BinaryWriter_o *, _QWORD, const MethodInfo *))v11->klass->vtable._17_Write.methodPtr)(
    v11,
    (unsigned int)dataWriter,
    v11->klass->vtable._17_Write.method);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !v8 )
    goto LABEL_17;
  ActorId = ((__int64 (__fastcall *)(struct System_IO_BinaryWriter_o *, _QWORD, const MethodInfo *))v8->klass->vtable._17_Write.methodPtr)(
              v8,
              (unsigned int)ActorId,
...
LABEL_12:
  ...
  if ( !v13 )
    goto LABEL_17;
  ActorId = ((__int64 (__fastcall *)(struct System_IO_BinaryWriter_o *, _QWORD, const MethodInfo *))v13->klass->vtable._17_Write.methodPtr)(
              v13,
              (unsigned int)ActorId,
...
void BattleActionLogManager__close(BattleActionLogManager_o *this, const MethodInfo *method)
{
  ...
  if ( headerWriter )
  {
    ...
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.headerWriter, 0, v5, v6, v7, v8, v9, v10);
  }
  dataWriter = this->fields.dataWriter;
  ...
  if ( dataWriter )
  {
    ...
    sub_1CE66A4(p_dataWriter, 0, v14, v15, v16, v17, v18, v19);
  }
}
