void __fastcall UserCommandCodeNewManager___cctor(const MethodInfo *method)
{
  ...
  UserCommandCodeNewManager_c *v19; // x8
  System_Collections_Generic_List_long__o *v20; // x19
  struct UserCommandCodeNewManager_StaticFields *v21; // x0
  ...
  if ( (byte_42EA1A7 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&UserCommandCodeNewManager_TypeInfo, v11, v12, v13);
  ...
  v21 = UserCommandCodeNewManager_TypeInfo->static_fields;
  v21->oldList = v20;
...
void __fastcall UserCommandCodeNewManager__ClearSaveDataList(const MethodInfo *method)
{
  ...
  if ( (byte_42EA1A1 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&UserCommandCodeNewManager_TypeInfo, v7, v8, v9);
    byte_42EA1A1 = 1;
  }
...
void __fastcall UserCommandCodeNewManager__CreateContinueDeviceSaveData(const MethodInfo *method)
{
  ...
  UserCommandCodeNewManager_c *v6; // x8
  const MethodInfo *v7; // x0

  if ( (byte_42EA19F & 1) == 0 )
  {
    sub_B5D5C4(&UserCommandCodeNewManager_TypeInfo, v1, v2, v3);
    byte_42EA19F = 1;
  }
  ...
  UserCommandCodeNewManager__DeleteSaveData((const MethodInfo *)v4);
  UserCommandCodeNewManager__ClearSaveDataList(v5);
...
void __fastcall UserCommandCodeNewManager__Initialize(const MethodInfo *method)
{
  ...
  UserCommandCodeNewManager__ReadData((const MethodInfo *)v4);
}
...
LABEL_20:
  ...
  for ( i = 0LL; ; ++i )
  {
    ...
    if ( v15->fields._items->m_Items[i] == userCmdCodeId )
      break;
    if ( (int)i + 1 >= size )
      return 1;
    v11 = UserCommandCodeNewManager_TypeInfo;
...
void __fastcall UserCommandCodeNewManager__LoginProcess(const MethodInfo *method)
{
  ...
  if ( (byte_42EA1A2 & 1) == 0 )
  {
    sub_B5D5C4(&Method_DataManager_GetMasterData_UserCommandCodeMaster___, v1, v2, v3);
  ...
  if ( v10->static_fields->isContinueDevice )
  {
    ...
    UserCommandCodeMaster__continueDeviceUserCommandCode((UserCommandCodeMaster_o *)Instance, v12);
    v13 = (const MethodInfo *)UserCommandCodeNewManager_TypeInfo;
    if ( (BYTE3(UserCommandCodeNewManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
      && !UserCommandCodeNewManager_TypeInfo->_2.cctor_finished )
    {
      j_il2cpp_runtime_class_init_0(UserCommandCodeNewManager_TypeInfo);
    ...
    UserCommandCodeNewManager__WriteData(v13);
  }
}
...
bool __fastcall UserCommandCodeNewManager__ReadData(const MethodInfo *method)
{
  ...
  __int64 v40; // x0
  UserCommandCodeNewManager_c *v41; // x0
  ...
  if ( (byte_42EA1A5 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&UserCommandCodeNewManager_TypeInfo, v13, v14, v15);
    byte_42EA1A5 = 1;
  }
  ...
  SaveFileName = UserCommandCodeNewManager__getSaveFileName((const MethodInfo *)v19);
  if ( System_IO_File__Exists(SaveFileName, 0LL) )
  {
    ...
    UserCommandCodeNewManager__ClearSaveDataList((const MethodInfo *)v21);
...
LABEL_39:
  ...
  {
    v41 = UserCommandCodeNewManager_TypeInfo;
    if ( (BYTE3(UserCommandCodeNewManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
      && !UserCommandCodeNewManager_TypeInfo->_2.cctor_finished )
    {
      j_il2cpp_runtime_class_init_0(UserCommandCodeNewManager_TypeInfo);
    }
    UserCommandCodeNewManager__ClearSaveDataList((const MethodInfo *)v41);
    return 0;
  }
}
  ...
  if ( size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v19->fields._size <= (unsigned int)v18 )
        System_ThrowHelper__ThrowArgumentOutOfRangeException_42302284(0LL);
      if ( v19->fields._items->m_Items[v18] == userCmdCodeId )
        return;
      v14 = UserCommandCodeNewManager_TypeInfo;
      ++v18;
      v17 = (BYTE3(UserCommandCodeNewManager_TypeInfo->vtable._0_Equals.methodPtr) >> 2) & 1;
      if ( (int)v18 >= size )
        goto LABEL_17;
    }
LABEL_23:
...
LABEL_17:
  ...
  v14 = (UserCommandCodeNewManager_c *)v14->static_fields->oldList;
  if ( !v14 )
    goto LABEL_23;
  System_Collections_Generic_List_long___Add(
...
bool __fastcall UserCommandCodeNewManager__WriteData(const MethodInfo *method)
{
  ...
  __int64 v29; // x1
  UserCommandCodeNewManager_c *v30; // x0
  struct UserCommandCodeNewManager_StaticFields *v31; // x8
  struct System_Collections_Generic_List_long__o *oldList; // x9
  signed __int64 size; // x20
  __int64 v34; // x1
  __int64 v35; // x3
  unsigned __int64 i; // x22
  UserCommandCodeNewManager_c *v37; // x0
  ...
  if ( (byte_42EA1A6 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&UserCommandCodeNewManager_TypeInfo, v16, v17, v18);
    byte_42EA1A6 = 1;
  }
  v19 = UserCommandCodeNewManager_TypeInfo;
  if ( (BYTE3(UserCommandCodeNewManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
  ...
  *p_isModfiy = 0;
  ...
  if ( !v23->static_fields->UseMock )
  {
    ...
    SaveFileName = UserCommandCodeNewManager__getSaveFileName((const MethodInfo *)v25);
    ...
    if ( (int)size >= 1 )
    {
      ...
      {
        v37 = UserCommandCodeNewManager_TypeInfo;
        if ( (BYTE3(UserCommandCodeNewManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
          && !UserCommandCodeNewManager_TypeInfo->_2.cctor_finished )
        {
          j_il2cpp_runtime_class_init_0(UserCommandCodeNewManager_TypeInfo);
