void __fastcall UserCommandCodeNewManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A2F175 & 1) == 0 )
  {
    ...
    sub_1B761C0(&UserCommandCodeNewManager_TypeInfo, v5);
    sub_1B761C0(&StringLiteral_6638/*"Fgo_20180629_1"*/, v6);
    byte_4A2F175 = 1;
  }
  UserCommandCodeNewManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6638/*"Fgo_20180629_1"*/;
  sub_1B76164(
...
void __fastcall UserCommandCodeNewManager__CreateContinueDeviceSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4A2F16D & 1) == 0 )
  {
    sub_1B761C0(&UserCommandCodeNewManager_TypeInfo, v1);
    byte_4A2F16D = 1;
  }
  ...
  if ( size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( System_Collections_Generic_List_long___get_Item(
             ...
             v8 - 1,
             (const MethodInfo_34BF318 *)Method_System_Collections_Generic_List_long__get_Item__) == userCmdCodeId )
        return !v9;
      v9 = v8 < size;
      if ( size == v8 )
        return !v9;
...
void __fastcall UserCommandCodeNewManager__LoginProcess(const MethodInfo *method)
{
  ...
  if ( (byte_4A2F170 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMasterData_UserCommandCodeMaster___, v1);
