void __fastcall UserCommandCodeNewManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B38437 & 1) == 0 )
  {
    ...
    sub_1BD3458(&UserCommandCodeNewManager_TypeInfo, v9);
    sub_1BD3458(&StringLiteral_6772/*"Fgo_20180629_1"*/, v10);
    byte_4B38437 = 1;
  }
  UserCommandCodeNewManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6772/*"Fgo_20180629_1"*/;
  sub_1BD33FC(
...
void __fastcall UserCommandCodeNewManager__CreateContinueDeviceSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4B3842F & 1) == 0 )
  {
    sub_1BD3458(&UserCommandCodeNewManager_TypeInfo, v1);
    byte_4B3842F = 1;
  }
  ...
  if ( size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( System_Collections_Generic_List_long___get_Item(
             ...
             v8 - 1,
             (const MethodInfo_35A8AD4 *)Method_System_Collections_Generic_List_long__get_Item__) == userCmdCodeId )
        return !v9;
      v9 = v8 < size;
      if ( size == v8 )
        return !v9;
...
void __fastcall UserCommandCodeNewManager__LoginProcess(const MethodInfo *method)
{
  ...
  if ( (byte_4B38432 & 1) == 0 )
  {
    sub_1BD3458(&Method_DataManager_GetMasterData_UserCommandCodeMaster___, v1);
...
bool __fastcall UserCommandCodeNewManager__ReadData(const MethodInfo *method)
{
  ...
  if ( (byte_4B38435 & 1) == 0 )
  {
    ...
    sub_1BD3458(&UserCommandCodeNewManager_TypeInfo, v5);
    byte_4B38435 = 1;
  }
