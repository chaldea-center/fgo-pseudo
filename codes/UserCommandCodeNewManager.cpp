void __fastcall UserCommandCodeNewManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A09E8C & 1) == 0 )
  {
    ...
    sub_1B686D4(&UserCommandCodeNewManager_TypeInfo, v5);
...
void __fastcall UserCommandCodeNewManager__CreateContinueDeviceSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4A09E84 & 1) == 0 )
  {
    sub_1B686D4(&UserCommandCodeNewManager_TypeInfo, v1);
    byte_4A09E84 = 1;
  }
  ...
  if ( size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( System_Collections_Generic_List_long___get_Item(
             ...
             v8 - 1,
             (const MethodInfo_34A3FBC *)Method_System_Collections_Generic_List_long__get_Item__) == userCmdCodeId )
        return !v9;
      v9 = v8 < size;
      if ( size == v8 )
        return !v9;
...
void __fastcall UserCommandCodeNewManager__LoginProcess(const MethodInfo *method)
{
  ...
  if ( (byte_4A09E87 & 1) == 0 )
  {
    sub_1B686D4(&Method_DataManager_GetMasterData_UserCommandCodeMaster___, v1);
