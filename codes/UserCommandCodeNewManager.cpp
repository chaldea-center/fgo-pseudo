void __fastcall UserCommandCodeNewManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB6FB1 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&UserCommandCodeNewManager_TypeInfo, v5);
    sub_1BAB41C(&StringLiteral_6640/*"Fgo_20180629_1"*/, v6);
    byte_4AB6FB1 = 1;
  }
  UserCommandCodeNewManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6640/*"Fgo_20180629_1"*/;
  sub_1BAB3C0(
    (ServantStatusBattleListViewItem_o *)UserCommandCodeNewManager_TypeInfo->static_fields,
...
void __fastcall UserCommandCodeNewManager__CreateContinueDeviceSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4AB6FA9 & 1) == 0 )
  {
    sub_1BAB41C(&UserCommandCodeNewManager_TypeInfo, v1);
    byte_4AB6FA9 = 1;
  }
  ...
  if ( size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( System_Collections_Generic_List_long___get_Item(
             ...
             v8 - 1,
             (const MethodInfo_3535600 *)Method_System_Collections_Generic_List_long__get_Item__) == userCmdCodeId )
        return !v9;
      v9 = v8 < size;
      if ( size == v8 )
        return !v9;
...
void __fastcall UserCommandCodeNewManager__LoginProcess(const MethodInfo *method)
{
  ...
  if ( (byte_4AB6FAC & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMasterData_UserCommandCodeMaster___, v1);
