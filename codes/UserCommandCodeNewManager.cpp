void __fastcall UserCommandCodeNewManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BB59AF & 1) == 0 )
  {
    ...
    sub_1C13D24(&UserCommandCodeNewManager_TypeInfo, v9);
    sub_1C13D24(&StringLiteral_6796/*"Fgo_20160211_1"*/, v10);
    byte_4BB59AF = 1;
  }
  UserCommandCodeNewManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6796/*"Fgo_20160211_1"*/;
  sub_1C13CC8(
...
void __fastcall UserCommandCodeNewManager__CreateContinueDeviceSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4BB59A7 & 1) == 0 )
  {
    sub_1C13D24(&UserCommandCodeNewManager_TypeInfo, v1);
    byte_4BB59A7 = 1;
  }
  ...
  if ( size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( System_Collections_Generic_List_long___get_Item(
             ...
             v8 - 1,
             (const MethodInfo_3614F10 *)Method_System_Collections_Generic_List_long__get_Item__) == userCmdCodeId )
        return !v9;
      v9 = v8 < size;
      if ( size == v8 )
        return !v9;
...
void __fastcall UserCommandCodeNewManager__LoginProcess(const MethodInfo *method)
{
  ...
  if ( (byte_4BB59AA & 1) == 0 )
  {
    sub_1C13D24(&Method_DataManager_GetMasterData_UserCommandCodeMaster___, v1);
...
bool __fastcall UserCommandCodeNewManager__WriteData(const MethodInfo *method)
{
  ...
  if ( (byte_4BB59AE & 1) == 0 )
  {
    ...
    sub_1C13D24(&UserCommandCodeNewManager_TypeInfo, v6);
    byte_4BB59AE = 1;
  }
