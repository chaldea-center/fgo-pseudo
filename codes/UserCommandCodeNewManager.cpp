void __fastcall UserCommandCodeNewManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A20D01 & 1) == 0 )
  {
    ...
    sub_1B715CC(&UserCommandCodeNewManager_TypeInfo, v5);
...
void __fastcall UserCommandCodeNewManager__CreateContinueDeviceSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4A20CF9 & 1) == 0 )
  {
    sub_1B715CC(&UserCommandCodeNewManager_TypeInfo, v1);
    byte_4A20CF9 = 1;
  }
  ...
  if ( size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( System_Collections_Generic_List_long___get_Item(
             ...
             v8 - 1,
             (const MethodInfo_34B7FA4 *)Method_System_Collections_Generic_List_long__get_Item__) == userCmdCodeId )
        return !v9;
      v9 = v8 < size;
      if ( size == v8 )
        return !v9;
...
void __fastcall UserCommandCodeNewManager__LoginProcess(const MethodInfo *method)
{
  ...
  if ( (byte_4A20CFC & 1) == 0 )
  {
    sub_1B715CC(&Method_DataManager_GetMasterData_UserCommandCodeMaster___, v1);
