void __fastcall UserCommandCodeNewManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FD622 & 1) == 0 )
  {
    ...
    sub_1B640C8(&UserCommandCodeNewManager_TypeInfo, v5);
...
void __fastcall UserCommandCodeNewManager__CreateContinueDeviceSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_49FD61A & 1) == 0 )
  {
    sub_1B640C8(&UserCommandCodeNewManager_TypeInfo, v1);
    byte_49FD61A = 1;
  }
  ...
  if ( size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( System_Collections_Generic_List_long___get_Item(
             ...
             v8 - 1,
             (const MethodInfo_3494D84 *)Method_System_Collections_Generic_List_long__get_Item__) == userCmdCodeId )
        return !v9;
      v9 = v8 < size;
      if ( size == v8 )
        return !v9;
...
void __fastcall UserCommandCodeNewManager__LoginProcess(const MethodInfo *method)
{
  ...
  if ( (byte_49FD61D & 1) == 0 )
  {
    sub_1B640C8(&Method_DataManager_GetMasterData_UserCommandCodeMaster___, v1);
...
bool __fastcall UserCommandCodeNewManager__WriteData(const MethodInfo *method)
{
  ...
  struct UserCommandCodeNewManager_StaticFields *v17; // x8
