void __fastcall UserCommandCodeNewManager___cctor(const MethodInfo *method)
{
  ...
  UserCommandCodeNewManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6759/*"Fgo_20180629_1"*/;
  sub_1BCA784(
    (PartyOrganizationUtility_o *)UserCommandCodeNewManager_TypeInfo->static_fields,
...
void __fastcall UserCommandCodeNewManager__ClearSaveDataList(const MethodInfo *method)
{
  ...
  if ( (byte_4B1746B & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&UserCommandCodeNewManager_TypeInfo, v5, v6);
    byte_4B1746B = 1;
  }
...
void __fastcall UserCommandCodeNewManager__CreateContinueDeviceSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4B17469 & 1) == 0 )
  {
    sub_1BCA7E0(&UserCommandCodeNewManager_TypeInfo, v1, v2);
    byte_4B17469 = 1;
  }
  v3 = UserCommandCodeNewManager_TypeInfo;
  if ( !UserCommandCodeNewManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UserCommandCodeNewManager_TypeInfo, v1);
  UserCommandCodeNewManager__DeleteSaveData((const MethodInfo *)v3);
  UserCommandCodeNewManager__ClearSaveDataList(v4);
...
void __fastcall UserCommandCodeNewManager__DeleteSaveData(const MethodInfo *method)
{
  ...
  if ( !UserCommandCodeNewManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UserCommandCodeNewManager_TypeInfo, v1);
  SaveFileName = UserCommandCodeNewManager__getSaveFileName((const MethodInfo *)v3);
...
void __fastcall UserCommandCodeNewManager__Initialize(const MethodInfo *method)
{
  ...
  if ( !UserCommandCodeNewManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UserCommandCodeNewManager_TypeInfo, v1);
  UserCommandCodeNewManager__ReadData((const MethodInfo *)v3);
}
...
bool __fastcall UserCommandCodeNewManager__IsNew(int64_t userCmdCodeId, const MethodInfo *method)
{
  ...
  if ( size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      v8 = (UserCommandCodeNewManager_c *)v8->static_fields->oldList;
      if ( !v8 )
        break;
      if ( System_Collections_Generic_List_long___get_Item(
             (System_Collections_Generic_List_long__o *)v8,
             v11 - 1,
             (const MethodInfo_35899A0 *)Method_System_Collections_Generic_List_long__get_Item__) == userCmdCodeId )
        return !v12;
      v12 = v11 < size;
      if ( size == v11 )
        return !v12;
...
void __fastcall UserCommandCodeNewManager__LoginProcess(const MethodInfo *method)
{
  ...
  if ( (byte_4B1746C & 1) == 0 )
  {
    sub_1BCA7E0(&Method_DataManager_GetMasterData_UserCommandCodeMaster___, v1, v2);
  ...
  if ( v7->static_fields->isContinueDevice )
  {
    ...
    UserCommandCodeMaster__continueDeviceUserCommandCode((UserCommandCodeMaster_o *)Instance, 0LL);
    v11 = (const MethodInfo *)UserCommandCodeNewManager_TypeInfo;
    if ( !UserCommandCodeNewManager_TypeInfo->_2.cctor_finished )
    {
    ...
    *((_WORD *)v11[2].virtualMethodPointer + 4) = 1;
    UserCommandCodeNewManager__WriteData(v11);
  }
}
...
bool __fastcall UserCommandCodeNewManager__ReadData(const MethodInfo *method)
{
  ...
  UserCommandCodeNewManager_c *v14; // x0
  System_String_o *SaveFileName; // x19
  __int64 v16; // x1
  ...
  UserCommandCodeNewManager_c *v27; // x0
  int v28; // w21
  __int64 v29; // x1
  char v30; // w20
  ...
  __int64 v33; // x1
  int64_t v34; // x21
  UserCommandCodeNewManager_c *v35; // x0
  ...
  __int64 v43; // x0
  UserCommandCodeNewManager_c *v44; // x0
  ...
  if ( (byte_4B1746F & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&UserCommandCodeNewManager_TypeInfo, v9, v10);
    byte_4B1746F = 1;
  }
  ...
  {
    v14 = UserCommandCodeNewManager_TypeInfo;
    if ( !UserCommandCodeNewManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UserCommandCodeNewManager_TypeInfo, v1);
    SaveFileName = UserCommandCodeNewManager__getSaveFileName((const MethodInfo *)v14);
    if ( System_IO_File__Exists(SaveFileName, 0LL) )
    {
      v17 = UserCommandCodeNewManager_TypeInfo;
      if ( !UserCommandCodeNewManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UserCommandCodeNewManager_TypeInfo, v16);
      UserCommandCodeNewManager__ClearSaveDataList((const MethodInfo *)v17);
      ...
      v27 = UserCommandCodeNewManager_TypeInfo;
      if ( !UserCommandCodeNewManager_TypeInfo->_2.cctor_finished )
      {
        j_il2cpp_runtime_class_init_0(UserCommandCodeNewManager_TypeInfo, v25);
        v27 = UserCommandCodeNewManager_TypeInfo;
      }
      ...
      else
      {
        ...
        if ( !UserCommandCodeNewManager_TypeInfo->_2.cctor_finished )
        {
          j_il2cpp_runtime_class_init_0(UserCommandCodeNewManager_TypeInfo, v29);
          v31 = UserCommandCodeNewManager_TypeInfo;
        }
        ...
        if ( v32 >= 1 )
        {
          do
          {
            ...
            v35 = UserCommandCodeNewManager_TypeInfo;
            if ( !UserCommandCodeNewManager_TypeInfo->_2.cctor_finished )
            {
              j_il2cpp_runtime_class_init_0(UserCommandCodeNewManager_TypeInfo, v33);
              v35 = UserCommandCodeNewManager_TypeInfo;
            }
...
LABEL_35:
    ...
    {
      v44 = UserCommandCodeNewManager_TypeInfo;
      if ( !UserCommandCodeNewManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UserCommandCodeNewManager_TypeInfo, v16);
      UserCommandCodeNewManager__ClearSaveDataList((const MethodInfo *)v44);
    }
    return 0;
  }
  return 1;
...
void __fastcall UserCommandCodeNewManager__SetOld(int64_t userCmdCodeId, const MethodInfo *method)
{
  ...
  if ( (byte_4B1746E & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&UserCommandCodeNewManager_TypeInfo, v8, v9);
    byte_4B1746E = 1;
  }
  ...
  while ( 1 )
  {
    ...
    v10 = (UserCommandCodeNewManager_c *)static_fields->oldList;
    if ( !v10 )
      goto LABEL_19;
    if ( v13 == v12 )
      break;
...
bool __fastcall UserCommandCodeNewManager__WriteData(const MethodInfo *method)
{
  ...
  struct UserCommandCodeNewManager_StaticFields *v25; // x8
  ...
  if ( (byte_4B17470 & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&UserCommandCodeNewManager_TypeInfo, v11, v12);
    byte_4B17470 = 1;
  }
  ...
  if ( !v15->static_fields->UseMock )
  {
    ...
    if ( !UserCommandCodeNewManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UserCommandCodeNewManager_TypeInfo, v1);
    SaveFileName = UserCommandCodeNewManager__getSaveFileName((const MethodInfo *)v16);
    ...
    if ( !UserCommandCodeNewManager_TypeInfo->_2.cctor_finished )
    {
      j_il2cpp_runtime_class_init_0(UserCommandCodeNewManager_TypeInfo, v23);
      v24 = UserCommandCodeNewManager_TypeInfo;
    }
    ...
    if ( size >= 1 )
    {
      for ( i = 0; i != size; ++i )
      {
        ...
        if ( !UserCommandCodeNewManager_TypeInfo->_2.cctor_finished )
        {
          j_il2cpp_runtime_class_init_0(UserCommandCodeNewManager_TypeInfo, v28);
          v30 = UserCommandCodeNewManager_TypeInfo;
        }
