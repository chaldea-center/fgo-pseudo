void __fastcall UserCommandCodeNewManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BC8D8F & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&UserCommandCodeNewManager_TypeInfo, v9);
    sub_1C1ABD4(&StringLiteral_6799/*"Fgo_20180629_1"*/, v10);
    byte_4BC8D8F = 1;
  }
  UserCommandCodeNewManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6799/*"Fgo_20180629_1"*/;
  sub_1C1AB78(
...
void __fastcall UserCommandCodeNewManager__CreateContinueDeviceSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4BC8D87 & 1) == 0 )
  {
    sub_1C1ABD4(&UserCommandCodeNewManager_TypeInfo, v1);
    byte_4BC8D87 = 1;
  }
  ...
  if ( size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( System_Collections_Generic_List_long___get_Item(
             ...
             v8 - 1,
             (const MethodInfo_36245D4 *)Method_System_Collections_Generic_List_long__get_Item__) == userCmdCodeId )
        return !v9;
      v9 = v8 < size;
      if ( size == v8 )
        return !v9;
...
void __fastcall UserCommandCodeNewManager__LoginProcess(const MethodInfo *method)
{
  ...
  if ( (byte_4BC8D8A & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataManager_GetMasterData_UserCommandCodeMaster___, v1);
...
bool __fastcall UserCommandCodeNewManager__WriteData(const MethodInfo *method)
{
  ...
  if ( (byte_4BC8D8E & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&UserCommandCodeNewManager_TypeInfo, v6);
    byte_4BC8D8E = 1;
  }
