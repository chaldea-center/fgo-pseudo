void __fastcall UserCommandCodeNewManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FFD3C & 1) == 0 )
  {
    ...
    sub_1B64A00(&UserCommandCodeNewManager_TypeInfo, v5);
    sub_1B64A00(&StringLiteral_6614/*"Fgo_20180629_1"*/, v6);
    byte_49FFD3C = 1;
  }
  UserCommandCodeNewManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6614/*"Fgo_20180629_1"*/;
  sub_1B649A4(
...
void __fastcall UserCommandCodeNewManager__CreateContinueDeviceSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_49FFD34 & 1) == 0 )
  {
    sub_1B64A00(&UserCommandCodeNewManager_TypeInfo, v1);
    byte_49FFD34 = 1;
  }
  ...
  if ( size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( System_Collections_Generic_List_long___get_Item(
             ...
             v8 - 1,
             (const MethodInfo_3497678 *)Method_System_Collections_Generic_List_long__get_Item__) == userCmdCodeId )
        return !v9;
      v9 = v8 < size;
      if ( size == v8 )
        return !v9;
...
void __fastcall UserCommandCodeNewManager__LoginProcess(const MethodInfo *method)
{
  ...
  if ( (byte_49FFD37 & 1) == 0 )
  {
    sub_1B64A00(&Method_DataManager_GetMasterData_UserCommandCodeMaster___, v1);
