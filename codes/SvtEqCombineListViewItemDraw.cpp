        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3AEB2 & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_9402/*"NONSELECT_MATERIAL"*/, v7);
    sub_1BD3458(&StringLiteral_9403/*"NONSELECT_MATERIAL_BASE_LVMAX"*/, v8);
      ...
      if ( item->fields.isMaxNextLv )
      {
        ...
        if ( !isLock )
        {
          ...
          if ( !isChoice && !item->fields.isNotSelection )
          {
            ...
            v20 = &StringLiteral_9403/*"NONSELECT_MATERIAL_BASE_LVMAX"*/;
LABEL_52:
    ...
    if ( item )
    {
      ...
      if ( item->fields.isMaxSelect )
      {
        ...
        if ( UnityEngine_Object__op_Inequality(v21, 0LL, 0LL) )
        {
          ...
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          v20 = &StringLiteral_9402/*"NONSELECT_MATERIAL"*/;
          goto LABEL_52;
        }
      }
      else
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3AEB1 & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_9402/*"NONSELECT_MATERIAL"*/, v11);
    sub_1BD3458(&StringLiteral_9403/*"NONSELECT_MATERIAL_BASE_LVMAX"*/, v12);
    sub_1BD3458(&StringLiteral_8896/*"MSG_ABLED_SVTEP_LIMITUP"*/, v13);
    sub_1BD3458(&StringLiteral_8430/*"LOCKMODE_SELECTED_SERVANT"*/, v14);
    sub_1BD3458(&StringLiteral_3498/*"CHOICE_SERVANT"*/, v15);
    sub_1BD3458(&StringLiteral_1/*""*/, v16);
    this = (SvtEqCombineListViewItemDraw_o *)sub_1BD3458(&StringLiteral_8431/*"LOCK_SERVANT"*/, v17);
    byte_4B3AEB1 = 1;
  }
  if ( v7 && mode )
  {
    ...
    if ( v7->fields.type )
    {
      ...
      *(_OWORD *)&v54.fields.fakeValue = v20;
      ...
      v52 = v54;
      this = (SvtEqCombineListViewItemDraw_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_47140144(
                                                 &v52,
                                                 0LL);
      if ( !servantface )
        goto LABEL_197;
    ...
    else
    {
      ...
      *(_OWORD *)&v54.fields.fakeValue = v22;
      ...
      if ( !servantface )
        goto LABEL_197;
      ServantFaceIconComponent__Set_39001096(servantface, (int64_t)this, v7->fields.iconLabelInfo1, 0LL, 0LL);
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        ...
        if ( !v24 || !subIconLabel )
          goto LABEL_197;
        UIIconLabel__Set_39017476(subIconLabel, 36, v7->fields.rarity, v24->fields.exceedCount, 0, 0LL, 0, 0, 0, 0LL);
      }
      else
      {
        if ( !subIconLabel )
...
LABEL_89:
      ...
      if ( v7->fields.isLimitCntTarget )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        this = (SvtEqCombineListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8896/*"MSG_ABLED_SVTEP_LIMITUP"*/, 0LL);
        if ( !statusTextLabel )
          goto LABEL_197;
      ...
      if ( isLock )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        this = (SvtEqCombineListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8431/*"LOCK_SERVANT"*/, 0LL);
        if ( !maskLabel )
          goto LABEL_197;
      ...
      if ( v7->fields.isNotSelection )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        this = (SvtEqCombineListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_9402/*"NONSELECT_MATERIAL"*/, 0LL);
        if ( !v37 )
          goto LABEL_197;
      ...
      if ( isChoice )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        this = (SvtEqCombineListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3498/*"CHOICE_SERVANT"*/, 0LL);
        if ( !v39 )
          goto LABEL_197;
      ...
      if ( v43 )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        v48 = &StringLiteral_9403/*"NONSELECT_MATERIAL_BASE_LVMAX"*/;
        goto LABEL_172;
      }
      if ( v44 )
      {
      ...
      if ( v7->fields.isMaxSelect )
      {
        ...
        if ( UnityEngine_Object__op_Inequality(v49, 0LL, 0LL) )
        {
          ...
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          v48 = &StringLiteral_9402/*"NONSELECT_MATERIAL"*/;
LABEL_172:
      ...
      if ( this )
      {
        ...
        if ( this )
        {
          ...
          if ( v7->fields.isCanNotLock )
          {
            if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
            item = (SvtEqCombineListViewItem_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8430/*"LOCKMODE_SELECTED_SERVANT"*/, 0LL);
          }
          else
          {
...
LABEL_197:
    ...
    if ( v28 )
    {
      if ( v30 )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        this = (SvtEqCombineListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_9403/*"NONSELECT_MATERIAL_BASE_LVMAX"*/, 0LL);
        if ( !v31 )
          goto LABEL_197;
        v32 = this;
        this = v31;
