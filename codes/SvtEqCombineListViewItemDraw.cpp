      ...
      if ( item->fields.isMaxNextLv )
      {
        ...
        if ( !isLock )
        {
          ...
          if ( !isChoice && !item->fields.isNotSelection )
          {
            ...
            v16 = &StringLiteral_9396/*"NONSELECT_MATERIAL_BASE_LVMAX"*/;
LABEL_52:
    ...
    if ( item )
    {
      ...
      if ( item->fields.isMaxSelect )
      {
        ...
        if ( UnityEngine_Object__op_Inequality(v17, 0, 0) )
        {
          ...
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          v16 = &StringLiteral_9395/*"NONSELECT_MATERIAL"*/;
          goto LABEL_52;
        }
      }
      else
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7150A & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_9395/*"NONSELECT_MATERIAL"*/);
    sub_1D0F0B4(&StringLiteral_9396/*"NONSELECT_MATERIAL_BASE_LVMAX"*/);
    sub_1D0F0B4(&StringLiteral_8897/*"MSG_ABLED_SVTEP_LIMITUP"*/);
    sub_1D0F0B4(&StringLiteral_8417/*"LOCKMODE_SELECTED_SERVANT"*/);
    sub_1D0F0B4(&StringLiteral_3390/*"CHOICE_SERVANT"*/);
    sub_1D0F0B4(&StringLiteral_1/*""*/);
    this = (SvtEqCombineListViewItemDraw_o *)sub_1D0F0B4(&StringLiteral_8418/*"LOCK_SERVANT"*/);
    byte_4E7150A = 1;
  }
  if ( v7 && mode )
  {
    ...
    if ( v7->fields.type )
    {
      ...
      *(_OWORD *)&v45.fields.fakeValue = v11;
      ...
      v43 = v45;
      this = (SvtEqCombineListViewItemDraw_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_50334724(
                                                 &v43,
                                                 0);
      if ( !servantface )
        goto LABEL_198;
    ...
    else
    {
      ...
      *(_OWORD *)&v45.fields.fakeValue = v13;
      ...
      if ( !servantface )
        goto LABEL_198;
      ServantFaceIconComponent__Set_42454776(servantface, (int64_t)this, v7->fields.iconLabelInfo1, 0, 0);
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        ...
        if ( !v15 || !subIconLabel )
          goto LABEL_198;
        UIIconLabel__Set_42477084(subIconLabel, 36, v7->fields.rarity, v15->fields.exceedCount, 0, 0, 0, 0, 0, 0, 0);
      }
      else
      {
        if ( !subIconLabel )
...
LABEL_89:
      ...
      if ( v7->fields.isLimitCntTarget )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        this = (SvtEqCombineListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8897/*"MSG_ABLED_SVTEP_LIMITUP"*/, 0);
        if ( !statusTextLabel )
          goto LABEL_198;
      ...
      if ( isLock )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        this = (SvtEqCombineListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8418/*"LOCK_SERVANT"*/, 0);
        if ( !maskLabel )
          goto LABEL_198;
      ...
      if ( v7->fields.isNotSelection )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        this = (SvtEqCombineListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_9395/*"NONSELECT_MATERIAL"*/, 0);
        if ( !v28 )
          goto LABEL_198;
      ...
      if ( isChoice )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        this = (SvtEqCombineListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3390/*"CHOICE_SERVANT"*/, 0);
        if ( !v30 )
          goto LABEL_198;
      ...
      if ( v34 )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        v39 = &StringLiteral_9396/*"NONSELECT_MATERIAL_BASE_LVMAX"*/;
        goto LABEL_173;
      }
      if ( v35 )
      {
      ...
      if ( v7->fields.isMaxSelect )
      {
        ...
        if ( UnityEngine_Object__op_Inequality(v40, 0, 0) )
        {
          ...
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          v39 = &StringLiteral_9395/*"NONSELECT_MATERIAL"*/;
LABEL_173:
      ...
      if ( this )
      {
        ...
        if ( this )
        {
          ...
          if ( v7->fields.isCanNotLock )
          {
            if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
            item = (SvtEqCombineListViewItem_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8417/*"LOCKMODE_SELECTED_SERVANT"*/, 0);
          }
          else
          {
...
LABEL_198:
    ...
    if ( v19 )
    {
      if ( v21 )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        this = (SvtEqCombineListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_9396/*"NONSELECT_MATERIAL_BASE_LVMAX"*/, 0);
        if ( !v22 )
          goto LABEL_198;
        v23 = this;
        this = v22;
