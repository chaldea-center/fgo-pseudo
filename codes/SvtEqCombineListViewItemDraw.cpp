  ...
  if ( CanNotSelect )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(baseButton, 0LL, 0LL) )
    {
        ...
        && !item->fields.isNotSelection )
      {
        ...
        v13 = &StringLiteral_9374/*"NONSELECT_MATERIAL_BASE_LVMAX"*/;
LABEL_55:
    ...
    if ( item )
    {
      ...
      if ( item->fields.isMaxSelect )
      {
        ...
        if ( UnityEngine_Object__op_Inequality(v14, 0LL, 0LL) )
        {
          ...
          v13 = &StringLiteral_9373/*"NONSELECT_MATERIAL"*/;
          goto LABEL_55;
        }
      }
      else
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B5B3A & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_9373/*"NONSELECT_MATERIAL"*/);
    sub_B52984(&StringLiteral_9374/*"NONSELECT_MATERIAL_BASE_LVMAX"*/);
    sub_B52984(&StringLiteral_8884/*"MSG_ABLED_SVTEP_LIMITUP"*/);
    sub_B52984(&StringLiteral_8478/*"LOCKMODE_SELECTED_SERVANT"*/);
    sub_B52984(&StringLiteral_3013/*"CHOICE_SERVANT"*/);
    sub_B52984(&StringLiteral_1/*""*/);
    this = (SvtEqCombineListViewItemDraw_o *)sub_B52984(&StringLiteral_8479/*"LOCK_SERVANT"*/);
    byte_42B5B3A = 1;
  }
  if ( v7 && mode )
  {
    ...
    if ( v7->fields.type )
    {
      ...
      *(_OWORD *)&v35.fields.fakeValue = v11;
      ...
      v33 = v35;
      this = (SvtEqCombineListViewItemDraw_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_44789576(
                                                 &v33,
                                                 0LL);
      if ( !servantface )
        goto LABEL_203;
    ...
    else
    {
      ...
      *(_OWORD *)&v35.fields.fakeValue = v13;
      ...
      if ( !servantface )
        goto LABEL_203;
      ServantFaceIconComponent__Set_30470152(servantface, (int64_t)this, v7->fields.iconLabelInfo1, 0LL, 0LL);
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        ...
        if ( !v15 || !subIconLabel )
          goto LABEL_203;
        UIIconLabel__Set_41786400(subIconLabel, 36, v7->fields.rarity, v15->fields.exceedCount, 0, 0LL, 0, 0, 0, 0LL);
      }
      else
      {
        if ( !subIconLabel )
...
LABEL_91:
      ...
      if ( v7->fields.isLimitCntTarget )
      {
        ...
        this = (SvtEqCombineListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8884/*"MSG_ABLED_SVTEP_LIMITUP"*/, 0LL);
        if ( !statusTextLabel )
          goto LABEL_203;
      ...
      if ( v7->fields.isSwapLock != v7->fields.isLock )
      {
        ...
        this = (SvtEqCombineListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8479/*"LOCK_SERVANT"*/, 0LL);
        if ( !maskLabel )
          goto LABEL_203;
      ...
      if ( v7->fields.isNotSelection )
      {
        ...
        this = (SvtEqCombineListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_9373/*"NONSELECT_MATERIAL"*/, 0LL);
        if ( !v24 )
          goto LABEL_203;
      ...
      if ( v7->fields.isSwapChoice != v7->fields.isChoice )
      {
        ...
        this = (SvtEqCombineListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3013/*"CHOICE_SERVANT"*/, 0LL);
        if ( !v25 )
          goto LABEL_203;
      ...
      if ( CanNotSelect )
      {
        ...
        v30 = &StringLiteral_9374/*"NONSELECT_MATERIAL_BASE_LVMAX"*/;
        goto LABEL_176;
      }
      if ( (WORD1(UnityEngine_Object_TypeInfo->vtable._0_Equals.methodPtr) & 0x400) != 0
        && !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      ...
      if ( v7->fields.isMaxSelect )
      {
        ...
        if ( UnityEngine_Object__op_Inequality(v31, 0LL, 0LL) )
        {
          ...
          v30 = &StringLiteral_9373/*"NONSELECT_MATERIAL"*/;
LABEL_176:
      ...
      if ( this )
      {
        ...
        if ( this )
        {
          ...
          if ( v7->fields.isCanNotLock )
          {
            ...
            item = (SvtEqCombineListViewItem_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8478/*"LOCKMODE_SELECTED_SERVANT"*/, 0LL);
          }
          else
          {
...
LABEL_203:
    ...
    if ( v17 )
    {
      ...
      this = (SvtEqCombineListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_9374/*"NONSELECT_MATERIAL_BASE_LVMAX"*/, 0LL);
      if ( !v19 )
        goto LABEL_203;
