...
void ReceiptListViewMenu__OnClickItem(ReceiptListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2DF11 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_ReceiptListViewMenu_OnEndCheckReceipt__);
    byte_4D2DF11 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (callbackIndex & 0x80000000) == 0 )
    {
      ...
      if ( History )
      {
        ...
        v16 = History;
        v17 = (ReceiptViewMenu_CallbackFunc_o *)sub_1C93D20(ReceiptViewMenu_CallbackFunc_TypeInfo);
...
void ReceiptListViewMenu__OnEndCheckReceipt(ReceiptListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2DF12 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_ReceiptListViewMenu_OnClickItem__);
    byte_4D2DF12 = 1;
  }
  if ( this->fields.state == 3 )
  {
    ...
    if ( !receiptViewMenu
      || (ReceiptViewMenu__Close(receiptViewMenu, method),
          ...
          !listViewManager)
      || (ReceiptListViewManager__SetMode_38087156(listViewManager, 2, v5, v6),
          (receiptViewMenu = (ReceiptViewMenu_o *)this->fields.scriptTestAssetCancelButton) == 0) )
    {
      sub_1C93D2C(receiptViewMenu, method);
    }
...
void ReceiptListViewMenu__OnMoveEnd(ReceiptListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.state == 1 )
  {
    ...
    if ( !listViewManager
      || (ReceiptListViewManager__SetMode_38087156(listViewManager, 2, v4, v7),
          (scriptTestAssetCancelButton = (UnityEngine_Behaviour_o *)this->fields.scriptTestAssetCancelButton) == 0) )
    {
      sub_1C93D2C(scriptTestAssetCancelButton, v6);
    }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C93AD4(&System_Action_TypeInfo);
    sub_1C93AD4(&Method_ReceiptListViewMenu_OnMoveEnd__);
    byte_4D2DF0F = 1;
  }
  if ( !this->fields.state )
  {
    ...
    {
LABEL_11:
      sub_1C93D2C(scriptTestAssetRootObject, v10);
    }
  ...
  if ( !listViewManager )
    goto LABEL_11;
  ReceiptListViewManager__SetMode_38087156(listViewManager, 1, v13, v14);
}
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1AC5A50;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1AC5A08;
}
