void __fastcall ServantEquipEffectFilterItem___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49F9E6D & 1) == 0 )
  {
    sub_1B64A00(&ServantEquipEffectFilterItem_TypeInfo, v1);
    byte_49F9E6D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F9E6C & 1) == 0 )
  {
    sub_1B64A00(&ServantEquipEffectFilterItem_TypeInfo, entity);
    byte_49F9E6C = 1;
  }
  this->fields.entity = entity;
  titleLabel = (UILabel_o *)sub_1B649A4(&this->fields.entity);
        ...
        const MethodInfo *method)
{
  ...
  if ( !entity || (sort = this->fields.sort) == 0LL )
    sub_1B64C5C(sort, v5);
  ListViewSort__SetSvtEquipEffectFilter_40460516(sort, entity->fields.id, this->fields.isSelected, 0LL);
}