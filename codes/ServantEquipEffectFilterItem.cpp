void __fastcall ServantEquipEffectFilterItem___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A03F4D & 1) == 0 )
  {
    sub_1B686D4(&ServantEquipEffectFilterItem_TypeInfo, v1);
    byte_4A03F4D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A03F4C & 1) == 0 )
  {
    sub_1B686D4(&ServantEquipEffectFilterItem_TypeInfo, entity);
    byte_4A03F4C = 1;
  }
  this->fields.entity = entity;
  titleLabel = (UILabel_o *)sub_1B68678(&this->fields.entity);
        ...
        const MethodInfo *method)
{
  ...
  if ( !entity || (sort = this->fields.sort) == 0LL )
    sub_1B68930(sort, v5);
  ListViewSort__SetSvtEquipEffectFilter_40524800(sort, entity->fields.id, this->fields.isSelected, 0LL);
}