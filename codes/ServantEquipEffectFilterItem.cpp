void ServantEquipEffectFilterItem___cctor(const MethodInfo *method)
{
  if ( (byte_4D2B8F2 & 1) == 0 )
  {
    sub_1C93AD4(&ServantEquipEffectFilterItem_TypeInfo);
    byte_4D2B8F2 = 1;
  }
...
LABEL_9:
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.sort, (int32_t)sort, v17, v18, v19, v20, v21, v22);
        ...
        const MethodInfo *method)
{
  ...
  if ( !entity || (sort = this->fields.sort) == 0 )
    sub_1C93D2C(sort, v5);
  ListViewSort__SetSvtEquipEffectFilter_44548224(sort, entity->fields.id, this->fields.isSelected, 0);
}