void __fastcall ServantEquipEffectFilterItem___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A1AD9D & 1) == 0 )
  {
    sub_1B715CC(&ServantEquipEffectFilterItem_TypeInfo, v1);
    byte_4A1AD9D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1AD9C & 1) == 0 )
  {
    sub_1B715CC(&ServantEquipEffectFilterItem_TypeInfo, entity);
    byte_4A1AD9C = 1;
  }
  this->fields.entity = entity;
  titleLabel = (UILabel_o *)sub_1B71570(&this->fields.entity);
        ...
        const MethodInfo *method)
{
  ...
  if ( !entity || (sort = this->fields.sort) == 0LL )
    sub_1B71828(sort, v5);
  ListViewSort__SetSvtEquipEffectFilter_40576184(sort, entity->fields.id, this->fields.isSelected, 0LL);
}