void __fastcall ServantEquipEffectFilterItem___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_40FD06E & 1) == 0 )
  {
    sub_B16FFC(&ServantEquipEffectFilterItem_TypeInfo, v1);
    byte_40FD06E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FD06D & 1) == 0 )
  {
    sub_B16FFC(&ServantEquipEffectFilterItem_TypeInfo, entity);
    byte_40FD06D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !checkMarkSprite || (gameObject = UnityEngine_Component__get_gameObject(checkMarkSprite, 0LL)) == 0LL )
    sub_B170D4();
  UnityEngine_GameObject__SetActive(gameObject, this->fields.isSelected, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !entity || (sort = this->fields.sort) == 0LL )
    sub_B170D4();
  ListViewSort__SetSvtEquipEffectFilter_30230916(sort, entity->fields.id, this->fields.isSelected, 0LL);
}