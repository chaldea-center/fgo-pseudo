void __fastcall ServantEquipEffectFilterItem___cctor(const MethodInfo *method)
{
  if ( (byte_42B2EB0 & 1) == 0 )
  {
    sub_B52984(&ServantEquipEffectFilterItem_TypeInfo);
    byte_42B2EB0 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !entity || (sort = this->fields.sort) == 0LL )
    sub_B52A5C(sort, v5);
  ListViewSort__SetSvtEquipEffectFilter_34022172(sort, entity->fields.id, this->fields.isSelected, 0LL);
}