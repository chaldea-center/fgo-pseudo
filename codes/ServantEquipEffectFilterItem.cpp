void __fastcall ServantEquipEffectFilterItem___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A291FD & 1) == 0 )
  {
    sub_1B761C0(&ServantEquipEffectFilterItem_TypeInfo, v1);
    byte_4A291FD = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A291FC & 1) == 0 )
  {
    sub_1B761C0(&ServantEquipEffectFilterItem_TypeInfo, entity);
    byte_4A291FC = 1;
  }
  this->fields.entity = entity;
  titleLabel = (UILabel_o *)sub_1B76164(&this->fields.entity);
        ...
        const MethodInfo *method)
{
  ...
  if ( !entity || (sort = this->fields.sort) == 0LL )
    sub_1B7641C(sort, v5);
  ListViewSort__SetSvtEquipEffectFilter_40600924(sort, entity->fields.id, this->fields.isSelected, 0LL);
}