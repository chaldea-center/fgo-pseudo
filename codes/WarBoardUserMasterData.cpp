...
WarBoardUserMasterData_o *__fastcall WarBoardUserMasterData__FromJson(System_String_o *json, const MethodInfo *method)
{
  ...
  if ( (byte_4A58F82 & 1) == 0 )
  {
    sub_1B885B0(&Method_JsonManager_DeserializeArray_WarBoardUserMasterData___);
  ...
  result = (WarBoardUserMasterData_o *)JsonManager__DeserializeArray_object_(
                                         v3,
                                         (const MethodInfo_2EE5F40 *)Method_JsonManager_DeserializeArray_WarBoardUserMasterData___);
  if ( result )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A58F80 & 1) == 0 )
  {
    ...
    this = (WarBoardUserMasterData_o *)sub_1B885B0(&Method_System_Collections_Generic_List_BattleSkillInfoData__get_Item__);
    byte_4A58F80 = 1;
  }
