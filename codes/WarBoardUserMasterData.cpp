...
WarBoardUserMasterData_o *__fastcall WarBoardUserMasterData__FromJson(System_String_o *json, const MethodInfo *method)
{
  ...
  if ( (byte_42B0BDC & 1) == 0 )
  {
    sub_B52984(&Method_JsonManager_DeserializeArray_WarBoardUserMasterData___);
  ...
  result = (WarBoardUserMasterData_o *)JsonManager__DeserializeArray_UserPresentBoxWindow_resData_(
                                         v3,
                                         (const MethodInfo_1F690B0 *)Method_JsonManager_DeserializeArray_WarBoardUserMasterData___);
  if ( result )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0BDA & 1) == 0 )
  {
    ...
    this = (WarBoardUserMasterData_o *)sub_B52984(&Method_System_Collections_Generic_List_BattleSkillInfoData__get_Item__);
    byte_42B0BDA = 1;
  }
