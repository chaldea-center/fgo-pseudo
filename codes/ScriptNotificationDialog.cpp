...
void ScriptNotificationDialog__Close(ScriptNotificationDialog_o *this, const MethodInfo *method)
{
  ...
  ScriptNotificationDialog__Close_44772712(this, 0, v2);
}


void ScriptNotificationDialog__Close_44772712(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C399CF & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_ScriptNotificationDialog_EndClose__);
    byte_4C399CF = 1;
  }
...
void ScriptNotificationDialog__OnClickClose(ScriptNotificationDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C399D0 & 1) == 0 )
  {
    sub_1C32C20(&Method_ScriptNotificationDialog_OnClickClose__);
    byte_4C399D0 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ScriptNotificationDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C32C38(Method_ScriptNotificationDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C399CD & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_ScriptNotificationDialog_EndOpen__);
  ...
  if ( !this->fields.state )
  {
    ...
    if ( !closeLabel )
LABEL_10:
      sub_1C32E7C(titledMessageLabel);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C399CA & 1) == 0 )
  {
    sub_1C32C20(&ScriptNotificationDialog_CallbackFunc_TypeInfo);
    byte_4C399CA = 1;
  }
  callbackFunc = this->fields.callbackFunc;
