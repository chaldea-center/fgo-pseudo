...
void PossessionInfo__OnClickIcon(PossessionInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C33DDA & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_PossessionInfo_OnClickIcon__);
    sub_1C32C20(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1C32C20(&Method_PossessionInfo___c__OnClickIcon_b__11_0__);
    sub_1C32C20(&PossessionInfo___c_TypeInfo);
    byte_4C33DDA = 1;
  }
  entity = 0;
  if ( this->fields.isServantHaving )
  {
    ...
    if ( (*((_BYTE *)Method_PossessionInfo_OnClickIcon__ + 83) & 2) != 0 )
      v6 = (_QWORD *)sub_1C32C38(Method_PossessionInfo_OnClickIcon__);
    ...
    if ( v7 )
    {
      ...
      if ( !_9__11_0 )
      {
        ...
        _9__11_0 = (ServantStatusDialog_EndDelegate_o *)sub_1C32E6C(ServantStatusDialog_EndDelegate_TypeInfo);
      ...
      if ( v10 )
      {
        CommonUI__OpenServantStatusDialog_31202452(v10, 37, v9, _9__11_0, 0);
        return;
      }
LABEL_29:
  ...
  else
  {
    ...
    if ( (*((_BYTE *)Method_PossessionInfo_OnClickIcon__ + 83) & 2) != 0 )
      v17 = (_QWORD *)sub_1C32C38(Method_PossessionInfo_OnClickIcon__);
    v8 = (System_Reflection_MethodBase_o *)sub_1C32C04(v17, v17[4]);
  }
...
void PossessionInfo__SetInfo(PossessionInfo_o *this, int32_t svtId, const MethodInfo *method)
{
  ...
  if ( (byte_4C33DD9 & 1) == 0 )
  {
    ...
    sub_1C32C20(&NetworkManager_TypeInfo);
    sub_1C32C20(&StringLiteral_8616/*"MAX_NP_LEVEL"*/);
    sub_1C32C20(&StringLiteral_8817/*"MULTIPLE_INFO"*/);
    sub_1C32C20(&StringLiteral_20415/*"img_icon_summoned"*/);
    sub_1C32C20(&StringLiteral_10404/*"POSSESSION_NUM"*/);
    sub_1C32C20(&StringLiteral_20414/*"img_icon_not_summoned"*/);
    sub_1C32C20(&StringLiteral_11843/*"SERVANT_SORT_FILTER_SERVANT_NOT_HAVE"*/);
    byte_4C33DD9 = 1;
  }
  entity = 0;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
  ...
  v6 = DataManager__GetMaster_object_((const MethodInfo_30DD39C *)Method_DataManager_GetMaster_UserServantMaster___);
  servantFaceIcon = DataManager__GetMaster_object_((const MethodInfo_30DD39C *)Method_DataManager_GetMaster_UserServantCollectionMaster___);
  if ( !servantFaceIcon )
    goto LABEL_49;
  ...
  if ( !v9 )
    goto LABEL_49;
  IconLabelInfo__Set_40818388(v9, 57, v8, 0, 0, 0, 0, 0, 0, 0);
  ...
  v10 = DataManager__GetMaster_object_((const MethodInfo_30DD39C *)Method_DataManager_GetMaster_ItemMaster___);
  v11 = DataManager__GetMaster_object_((const MethodInfo_30DD39C *)Method_DataManager_GetMaster_UserSvtCoinMaster___);
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  if ( !byte_4C31812 )
  {
...
LABEL_49:
  ...
  if ( LocalizationManager_TypeInfo->_2.cctor_finished )
  {
    ...
    {
LABEL_32:
      v22 = LocalizationManager__Get((System_String_o *)StringLiteral_10404/*"POSSESSION_NUM"*/, 0);
  ...
  servantFaceIcon = LocalizationManager__Get((System_String_o *)StringLiteral_11843/*"SERVANT_SORT_FILTER_SERVANT_NOT_HAVE"*/, 0);
LABEL_35:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v28 = LocalizationManager__Get((System_String_o *)StringLiteral_8616/*"MAX_NP_LEVEL"*/, 0);
  v41 = v27;
  ...
  v38 = StringLiteral_20414/*"img_icon_not_summoned"*/;
  v39 = StringLiteral_20415/*"img_icon_summoned"*/;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  if ( v37 )
...
void PossessionInfo___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C32E6C(PossessionInfo___c_TypeInfo);
  System_Object___ctor(v1, 0);
  PossessionInfo___c_TypeInfo->static_fields->__9 = (struct PossessionInfo___c_o *)v1;
  sub_1C32BC4((CGThumbnailListItem_o *)PossessionInfo___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
