...
void PossessionInfo__OnClickIcon(PossessionInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E73962 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_PossessionInfo_OnClickIcon__);
    sub_1D0F0B4(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1D0F0B4(&Method_PossessionInfo___c__OnClickIcon_b__11_0__);
    sub_1D0F0B4(&PossessionInfo___c_TypeInfo);
    byte_4E73962 = 1;
  }
  entity = 0;
  if ( this->fields.isServantHaving )
  {
    ...
    if ( (*((_BYTE *)Method_PossessionInfo_OnClickIcon__ + 83) & 2) != 0 )
      v7 = (_QWORD *)sub_1D0F0CC(Method_PossessionInfo_OnClickIcon__);
    ...
    if ( v8 )
    {
      ...
      if ( !_9__11_0 )
      {
        ...
        _9__11_0 = (ServantStatusDialog_EndDelegate_o *)sub_1D0F300(ServantStatusDialog_EndDelegate_TypeInfo);
      ...
      if ( v11 )
      {
        CommonUI__OpenServantStatusDialog_32098360(v11, 37, v10, _9__11_0, 0);
        return;
      }
LABEL_29:
  ...
  else
  {
    ...
    if ( (*((_BYTE *)Method_PossessionInfo_OnClickIcon__ + 83) & 2) != 0 )
      v22 = (_QWORD *)sub_1D0F0CC(Method_PossessionInfo_OnClickIcon__);
    v9 = (System_Reflection_MethodBase_o *)sub_1D0F098(v22, v22[4]);
  }
...
void PossessionInfo__SetInfo(PossessionInfo_o *this, int32_t svtId, const MethodInfo *method)
{
  ...
  if ( (byte_4E73961 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&NetworkManager_TypeInfo);
    sub_1D0F0B4(&StringLiteral_8719/*"MAX_NP_LEVEL"*/);
    sub_1D0F0B4(&StringLiteral_8920/*"MULTIPLE_INFO"*/);
    sub_1D0F0B4(&StringLiteral_20804/*"img_icon_summoned"*/);
    sub_1D0F0B4(&StringLiteral_10549/*"POSSESSION_NUM"*/);
    sub_1D0F0B4(&StringLiteral_20803/*"img_icon_not_summoned"*/);
    sub_1D0F0B4(&StringLiteral_12014/*"SERVANT_SORT_FILTER_SERVANT_NOT_HAVE"*/);
    byte_4E73961 = 1;
  }
  entity = 0;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
  ...
  servantFaceIcon = DataManager__GetMaster_object_((const MethodInfo_324F164 *)Method_DataManager_GetMaster_UserServantCollectionMaster___);
  if ( !servantFaceIcon )
    goto LABEL_49;
  ...
  v10 = (IconLabelInfo_o *)sub_1D0F300(IconLabelInfo_TypeInfo);
  IconLabelInfo___ctor(v10, 0);
  if ( !v10 )
    goto LABEL_49;
  IconLabelInfo__Set_42279788(v10, 57, v9, 0, 0, 0, 0, 0, 0, 0);
  ...
  v11 = DataManager__GetMaster_object_((const MethodInfo_324F164 *)Method_DataManager_GetMaster_ItemMaster___);
  v12 = DataManager__GetMaster_object_((const MethodInfo_324F164 *)Method_DataManager_GetMaster_UserSvtCoinMaster___);
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  if ( !byte_4E710BF )
  {
  ...
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_8920/*"MULTIPLE_INFO"*/, 0);
  ...
  if ( !v6 )
LABEL_49:
    sub_1D0F30C(servantFaceIcon, v8);
  ...
  if ( LocalizationManager_TypeInfo->_2.cctor_finished )
  {
    ...
    {
LABEL_32:
      v23 = LocalizationManager__Get((System_String_o *)StringLiteral_10549/*"POSSESSION_NUM"*/, 0);
  ...
  servantFaceIcon = LocalizationManager__Get((System_String_o *)StringLiteral_12014/*"SERVANT_SORT_FILTER_SERVANT_NOT_HAVE"*/, 0);
LABEL_35:
  v8 = servantFaceIcon;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v29 = LocalizationManager__Get((System_String_o *)StringLiteral_8719/*"MAX_NP_LEVEL"*/, 0);
  v36 = v28;
  ...
  v33 = StringLiteral_20803/*"img_icon_not_summoned"*/;
  v34 = StringLiteral_20804/*"img_icon_summoned"*/;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  if ( v32 )
...
void PossessionInfo___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1D0F300(PossessionInfo___c_TypeInfo);
