...
void PossessionInfo__OnClickIcon(PossessionInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C531EA & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_PossessionInfo_OnClickIcon__);
    sub_1C3E564(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1C3E564(&Method_PossessionInfo___c__OnClickIcon_b__11_0__);
    sub_1C3E564(&PossessionInfo___c_TypeInfo);
    byte_4C531EA = 1;
  }
  entity = 0;
  if ( this->fields.isServantHaving )
  {
    ...
    if ( (*((_BYTE *)Method_PossessionInfo_OnClickIcon__ + 83) & 2) != 0 )
      v7 = (_QWORD *)sub_1C3E57C(Method_PossessionInfo_OnClickIcon__);
    ...
    if ( v8 )
    {
      ...
      if ( !_9__11_0 )
      {
        ...
        _9__11_0 = (ServantStatusDialog_EndDelegate_o *)sub_1C3E7B0(ServantStatusDialog_EndDelegate_TypeInfo);
        ...
        sub_1C3E508((CGThumbnailListItem_o *)&static_fields->__9__11_0, (int32_t)_9__11_0, v16, v17);
      }
      if ( v11 )
      {
        CommonUI__OpenServantStatusDialog_31249888(v11, 37, v10, _9__11_0, 0);
        return;
      }
LABEL_29:
  ...
  else
  {
    ...
    if ( (*((_BYTE *)Method_PossessionInfo_OnClickIcon__ + 83) & 2) != 0 )
      v18 = (_QWORD *)sub_1C3E57C(Method_PossessionInfo_OnClickIcon__);
    v9 = (System_Reflection_MethodBase_o *)sub_1C3E548(v18, v18[4]);
  }
...
void PossessionInfo__SetInfo(PossessionInfo_o *this, int32_t svtId, const MethodInfo *method)
{
  ...
  int32_t v42; // [xsp+54h] [xbp-4Ch] BYREF
  ...
  if ( (byte_4C531E9 & 1) == 0 )
  {
    ...
    sub_1C3E564(&NetworkManager_TypeInfo);
    sub_1C3E564(&StringLiteral_8617/*"MAX_NP_LEVEL"*/);
    sub_1C3E564(&StringLiteral_8818/*"MULTIPLE_INFO"*/);
    sub_1C3E564(&StringLiteral_20436/*"img_icon_summoned"*/);
    sub_1C3E564(&StringLiteral_10407/*"POSSESSION_NUM"*/);
    sub_1C3E564(&StringLiteral_20435/*"img_icon_not_summoned"*/);
    sub_1C3E564(&StringLiteral_11846/*"SERVANT_SORT_FILTER_SERVANT_NOT_HAVE"*/);
    byte_4C531E9 = 1;
  }
  entity = 0;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
  ...
  servantFaceIcon = DataManager__GetMaster_object_((const MethodInfo_30F9A1C *)Method_DataManager_GetMaster_UserServantCollectionMaster___);
  if ( !servantFaceIcon )
    goto LABEL_49;
  ...
  v10 = (IconLabelInfo_o *)sub_1C3E7B0(IconLabelInfo_TypeInfo);
  IconLabelInfo___ctor(v10, 0);
  if ( !v10 )
    goto LABEL_49;
  IconLabelInfo__Set_40964356(v10, 57, v9, 0, 0, 0, 0, 0, 0, 0);
  ...
  v11 = DataManager__GetMaster_object_((const MethodInfo_30F9A1C *)Method_DataManager_GetMaster_ItemMaster___);
  v12 = DataManager__GetMaster_object_((const MethodInfo_30F9A1C *)Method_DataManager_GetMaster_UserSvtCoinMaster___);
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  if ( !byte_4C50AE2 )
  {
  ...
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_8818/*"MULTIPLE_INFO"*/, 0);
  ...
  if ( !v6 )
LABEL_49:
    sub_1C3E7C0(servantFaceIcon, v8);
  ...
  if ( LocalizationManager_TypeInfo->_2.cctor_finished )
  {
    ...
    {
LABEL_32:
      v23 = LocalizationManager__Get((System_String_o *)StringLiteral_10407/*"POSSESSION_NUM"*/, 0);
  ...
  servantFaceIcon = LocalizationManager__Get((System_String_o *)StringLiteral_11846/*"SERVANT_SORT_FILTER_SERVANT_NOT_HAVE"*/, 0);
LABEL_35:
  v8 = servantFaceIcon;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v29 = LocalizationManager__Get((System_String_o *)StringLiteral_8617/*"MAX_NP_LEVEL"*/, 0);
  v42 = v28;
  v36 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v42, v30, v31, v32, v33, v34, v35);
  servantFaceIcon = System_String__Format(v29, v36, 0);
  ...
  v38 = this->fields.isServantHaving;
  v39 = StringLiteral_20435/*"img_icon_not_summoned"*/;
  v40 = StringLiteral_20436/*"img_icon_summoned"*/;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  if ( v38 )
  ...
  AtlasManager__SetEventSprite(summonedSprite, v41, 0);
}
...
void PossessionInfo___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C3E7B0(PossessionInfo___c_TypeInfo);
  System_Object___ctor(v1, 0);
  PossessionInfo___c_TypeInfo->static_fields->__9 = (struct PossessionInfo___c_o *)v1;
  sub_1C3E508((CGThumbnailListItem_o *)PossessionInfo___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
