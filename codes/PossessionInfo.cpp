...
void __fastcall PossessionInfo__OnClickIcon(PossessionInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFE4C9 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_PossessionInfo_OnClickIcon__, v6);
    sub_1BC3008(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v7);
    sub_1BC3008(&Method_PossessionInfo___c__OnClickIcon_b__11_0__, v8);
    sub_1BC3008(&PossessionInfo___c_TypeInfo, v9);
    byte_4AFE4C9 = 1;
  }
  entity = 0LL;
  if ( this->fields.isServantHaving )
  {
    ...
    if ( (*((_BYTE *)Method_PossessionInfo_OnClickIcon__ + 83) & 2) != 0 )
      v14 = (_QWORD *)sub_1BC3020(Method_PossessionInfo_OnClickIcon__);
    v16 = (System_Reflection_MethodBase_o *)sub_1BC2FEC(v14, v14[4]);
    if ( v15 )
    {
      ...
      if ( !_9__11_0 )
      {
        ...
        _9__11_0 = (ServantStatusDialog_EndDelegate_o *)sub_1BC3254(ServantStatusDialog_EndDelegate_TypeInfo);
        ...
        sub_1BC2FAC((CGThumbnailListItem_o *)&static_fields->__9__11_0, (int32_t)_9__11_0, v23, v24);
      }
      if ( v18 )
      {
        CommonUI__OpenServantStatusDialog_30742692(v18, 37, v17, _9__11_0, 0LL);
        return;
      }
LABEL_29:
  ...
  else
  {
    ...
    if ( (*((_BYTE *)Method_PossessionInfo_OnClickIcon__ + 83) & 2) != 0 )
      v25 = (_QWORD *)sub_1BC3020(Method_PossessionInfo_OnClickIcon__);
    v16 = (System_Reflection_MethodBase_o *)sub_1BC2FEC(v25, v25[4]);
  }
...
void __fastcall PossessionInfo__SetInfo(PossessionInfo_o *this, int32_t svtId, const MethodInfo *method)
{
  ...
  if ( (byte_4AFE4C8 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_DataManager_GetMaster_UserSvtCoinMaster___, v9);
    sub_1BC3008(&DataManager_TypeInfo, v10);
    sub_1BC3008(&Method_DataMasterBase_ServantMaster__ServantEntity__int__GetEntity__, v11);
    sub_1BC3008(&IconLabelInfo_TypeInfo, v12);
    sub_1BC3008(&int_TypeInfo, v13);
    sub_1BC3008(&LocalizationManager_TypeInfo, v14);
    sub_1BC3008(&NetworkManager_TypeInfo, v15);
    sub_1BC3008(&StringLiteral_8536/*"MAX_NP_LEVEL"*/, v16);
    sub_1BC3008(&StringLiteral_8736/*"MULTIPLE_INFO"*/, v17);
    sub_1BC3008(&StringLiteral_20217/*"img_icon_summoned"*/, v18);
    sub_1BC3008(&StringLiteral_10313/*"POSSESSION_NUM"*/, v19);
    sub_1BC3008(&StringLiteral_20216/*"img_icon_not_summoned"*/, v20);
    sub_1BC3008(&StringLiteral_11728/*"SERVANT_SORT_FILTER_SERVANT_NOT_HAVE"*/, v21);
    byte_4AFE4C8 = 1;
  }
  entity = 0LL;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
  ...
  v23 = DataManager__GetMaster_object_((const MethodInfo_3001E10 *)Method_DataManager_GetMaster_UserServantMaster___);
  servantFaceIcon = DataManager__GetMaster_object_((const MethodInfo_3001E10 *)Method_DataManager_GetMaster_UserServantCollectionMaster___);
  if ( !servantFaceIcon )
    goto LABEL_49;
  ...
  if ( !v27 )
    goto LABEL_49;
  IconLabelInfo__Set_39947860(v27, 57, v26, 0, 0, 0, 0, 0, 0, 0LL);
  ...
  v28 = DataManager__GetMaster_object_((const MethodInfo_3001E10 *)Method_DataManager_GetMaster_ItemMaster___);
  v29 = DataManager__GetMaster_object_((const MethodInfo_3001E10 *)Method_DataManager_GetMaster_UserSvtCoinMaster___);
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  if ( !byte_4AFC1F1 )
  {
  ...
  v32 = LocalizationManager__Get((System_String_o *)StringLiteral_8736/*"MULTIPLE_INFO"*/, 0LL);
  ...
  if ( !v23 )
LABEL_49:
    sub_1BC3264(servantFaceIcon, v25);
  ...
  if ( LocalizationManager_TypeInfo->_2.cctor_finished )
  {
    ...
    {
LABEL_32:
      v40 = LocalizationManager__Get((System_String_o *)StringLiteral_10313/*"POSSESSION_NUM"*/, 0LL);
  ...
  servantFaceIcon = LocalizationManager__Get((System_String_o *)StringLiteral_11728/*"SERVANT_SORT_FILTER_SERVANT_NOT_HAVE"*/, 0LL);
LABEL_35:
  v25 = servantFaceIcon;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v46 = LocalizationManager__Get((System_String_o *)StringLiteral_8536/*"MAX_NP_LEVEL"*/, 0LL);
  v56 = v45;
  ...
  v53 = StringLiteral_20216/*"img_icon_not_summoned"*/;
  v54 = StringLiteral_20217/*"img_icon_summoned"*/;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  if ( v52 )
...
void __fastcall PossessionInfo___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AFE4CA & 1) == 0 )
  {
    sub_1BC3008(&PossessionInfo___c_TypeInfo, v1);
    byte_4AFE4CA = 1;
  }
  v2 = (Il2CppObject *)sub_1BC3254(PossessionInfo___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  PossessionInfo___c_TypeInfo->static_fields->__9 = (struct PossessionInfo___c_o *)v2;
  sub_1BC2FAC((CGThumbnailListItem_o *)PossessionInfo___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
...
void __fastcall PossessionInfo___c___OnClickIcon_b__11_0(PossessionInfo___c_o *this, bool _, const MethodInfo *method)
{
  ...
  if ( (byte_4AFE4CB & 1) == 0 )
  {
    sub_1BC3008(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, _);
    byte_4AFE4CB = 1;
  }
