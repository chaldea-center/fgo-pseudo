        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3214E & 1) == 0 )
  {
    sub_1BD3458(&IconLabelInfo_TypeInfo, userServantEntity);
    sub_1BD3458(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, v5);
    byte_4B3214E = 1;
  }
  v6 = (IconLabelInfo_o *)sub_1BD36A4(IconLabelInfo_TypeInfo);
  ...
  if ( !v6 )
    goto LABEL_11;
  IconLabelInfo__Set_38919304(v6, 2, lv, (int32_t)LevelMax, 0, 0, 0, 0, 0LL);
  LevelMax = this->fields.servantFaceIconComponent;
  if ( !LevelMax )
    goto LABEL_11;
  ServantFaceIconComponent__Set_39001304(LevelMax, userServantEntity, v6, 0LL, 0LL);
