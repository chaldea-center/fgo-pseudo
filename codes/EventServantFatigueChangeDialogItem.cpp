        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAF5DE & 1) == 0 )
  {
    sub_1C13D24(&IconLabelInfo_TypeInfo, userServantEntity);
    sub_1C13D24(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, v5);
    byte_4BAF5DE = 1;
  }
  v6 = (IconLabelInfo_o *)sub_1C13F70(IconLabelInfo_TypeInfo);
  ...
  if ( !v6 )
    goto LABEL_11;
  IconLabelInfo__Set_39281744(v6, 2, lv, (int32_t)LevelMax, 0, 0, 0, 0, 0LL);
  LevelMax = this->fields.servantFaceIconComponent;
  if ( !LevelMax )
    goto LABEL_11;
  ServantFaceIconComponent__Set_39363980(LevelMax, userServantEntity, v6, 0LL, 0LL);
