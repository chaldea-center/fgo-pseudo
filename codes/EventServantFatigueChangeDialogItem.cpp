        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB0DDA & 1) == 0 )
  {
    sub_1BAB41C(&IconLabelInfo_TypeInfo, userServantEntity);
    sub_1BAB41C(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, v5);
    byte_4AB0DDA = 1;
  }
  v6 = (IconLabelInfo_o *)sub_1BAB668(IconLabelInfo_TypeInfo);
  ...
  if ( !v6 )
    goto LABEL_11;
  IconLabelInfo__Set_38519944(v6, 2, lv, (int32_t)LevelMax, 0, 0, 0, 0, 0LL);
  LevelMax = this->fields.servantFaceIconComponent;
  if ( !LevelMax )
    goto LABEL_11;
  ServantFaceIconComponent__Set_38600628(LevelMax, userServantEntity, v6, 0LL, 0LL);
