        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A32174 & 1) == 0 )
  {
    sub_1B761C0(&IconLabelInfo_TypeInfo, userServantEntity);
    sub_1B761C0(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, v5);
    byte_4A32174 = 1;
  }
  v6 = (IconLabelInfo_o *)sub_1B7640C(IconLabelInfo_TypeInfo);
  ...
  if ( !v6 )
    goto LABEL_11;
  IconLabelInfo__Set_37960168(v6, 2, lv, (int32_t)LevelMax, 0, 0, 0, 0, 0LL);
  LevelMax = this->fields.servantFaceIconComponent;
  if ( !LevelMax )
    goto LABEL_11;
  ServantFaceIconComponent__Set_38039708(LevelMax, userServantEntity, v6, 0LL, 0LL);
