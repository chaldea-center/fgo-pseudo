        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E68DA & 1) == 0 )
  {
    sub_1B00CCC(&IconLabelInfo_TypeInfo, userServantEntity);
    sub_1B00CCC(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, v5);
    byte_48E68DA = 1;
  }
  v6 = (IconLabelInfo_o *)sub_1B00F18(IconLabelInfo_TypeInfo);
  ...
  if ( !v6 )
    goto LABEL_11;
  IconLabelInfo__Set_36930772(v6, 2, lv, (int32_t)LevelMax, 0, 0, 0, 0, 0LL);
  LevelMax = this->fields.servantFaceIconComponent;
  if ( !LevelMax )
    goto LABEL_11;
  ServantFaceIconComponent__Set_37007740(LevelMax, userServantEntity, v6, 0LL, 0LL);
