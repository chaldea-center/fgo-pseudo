        ...
        const MethodInfo *method)
{
  ...
  v5 = (IconLabelInfo_o *)sub_1CE694C(IconLabelInfo_TypeInfo);
  ...
  if ( !v5 )
    goto LABEL_11;
  IconLabelInfo__Set_42060700(v5, 2, lv, (int32_t)LevelMax, 0, 0, 0, 0, 0, 0);
  LevelMax = this->fields.servantFaceIconComponent;
  if ( !LevelMax )
    goto LABEL_11;
  ServantFaceIconComponent__Set_42235656(LevelMax, userServantEntity, v5, 0, 1, 0);
