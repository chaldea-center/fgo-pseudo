        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C23618 & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_EventInfoRaidResetButton___c__CallbackResetDataLostBattle_b__9_0__, v5);
    this = (EventInfoRaidResetButton_o *)sub_1C3B764(&EventInfoRaidResetButton___c_TypeInfo, v6);
    byte_4C23618 = 1;
  }
  ...
  if ( !_9__9_0 )
  {
    ...
    _9__9_0 = (System_Action_o *)sub_1C3B9B0(System_Action_TypeInfo);
    ...
    sub_1C3B708((PartyOrganizationUtility_o *)&static_fields->__9__9_0, (int64_t)_9__9_0, v14, v15, v16, v17, v18, v19);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C23616 & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_5720/*"EXTRA_CRITICAL_RATE"*/, v12);
    sub_1C3B764(&StringLiteral_17860/*"condTitle"*/, v13);
    byte_4C23616 = 1;
  }
  ...
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_5720/*"EXTRA_CRITICAL_RATE"*/, 0LL);
  if ( !buttonLabel
  ...
  if ( UnityEngine_Object__op_Inequality(buttonSprite, 0LL, 0LL) )
  {
    ...
    AtlasManager__SetEventUI(v18, (System_String_o *)StringLiteral_17860/*"condTitle"*/, 0LL);
  }
}
...
void __fastcall EventInfoRaidResetButton__OnClick(EventInfoRaidResetButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C23617 & 1) == 0 )
  {
    sub_1C3B764(&DataLostResetManager_ClickDelegate_TypeInfo, method);
    sub_1C3B764(&DataLostResetManager_TypeInfo, v3);
    sub_1C3B764(&Method_EventInfoRaidResetButton_OnClick__, v4);
    sub_1C3B764(&Method_EventInfoRaidResetButton__OnClick_b__8_0__, v5);
    byte_4C23617 = 1;
  }
  v6 = Method_EventInfoRaidResetButton_OnClick__;
  if ( (*((_BYTE *)Method_EventInfoRaidResetButton_OnClick__ + 83) & 2) != 0 )
    v6 = (_QWORD *)sub_1C3B77C(Method_EventInfoRaidResetButton_OnClick__);
  ...
  eventId = uiEntity->fields.eventId;
  warId = uiEntity->fields.warId;
  v13 = (DataLostResetManager_ClickDelegate_o *)sub_1C3B9B0(DataLostResetManager_ClickDelegate_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C23619 & 1) == 0 )
  {
    sub_1C3B764(&DataLostResetManager_TypeInfo, *(_QWORD *)&resetIdx);
    sub_1C3B764(&Method_EventInfoRaidResetButton_CallbackResetDataLostBattle__, v5);
...
void __fastcall EventInfoRaidResetButton___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C2361A & 1) == 0 )
  {
    sub_1C3B764(&EventInfoRaidResetButton___c_TypeInfo, v1);
    byte_4C2361A = 1;
  }
  v2 = (Il2CppObject *)sub_1C3B9B0(EventInfoRaidResetButton___c_TypeInfo);
        ...
        const MethodInfo *method)
{
  if ( (byte_4C2361B & 1) == 0 )
  {
    sub_1C3B764(&DataLostResetManager_TypeInfo, method);
    byte_4C2361B = 1;
  }
  if ( !DataLostResetManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataLostResetManager_TypeInfo);
