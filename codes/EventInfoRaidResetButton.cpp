        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0E3D & 1) == 0 )
  {
    ...
    sub_B52984(&Method_EventInfoRaidResetButton___c__CallbackResetDataLostBattle_b__9_0__);
    this = (EventInfoRaidResetButton_o *)sub_B52984(&EventInfoRaidResetButton___c_TypeInfo);
    byte_42B0E3D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0E3B & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_5655/*"EVENT_DATA_LOST_BATTLE_RESET_BUTTON"*/);
    sub_B52984(&StringLiteral_17121/*"btn_mission_bg"*/);
    byte_42B0E3B = 1;
  }
  ...
  v11 = LocalizationManager__Get((System_String_o *)StringLiteral_5655/*"EVENT_DATA_LOST_BATTLE_RESET_BUTTON"*/, 0LL);
  if ( !buttonLabel
  ...
  if ( UnityEngine_Object__op_Inequality(buttonSprite, 0LL, 0LL) )
  {
    ...
    AtlasManager__SetEventUI(v14, (System_String_o *)StringLiteral_17121/*"btn_mission_bg"*/, 0LL);
  }
}
...
void __fastcall EventInfoRaidResetButton__OnClick(EventInfoRaidResetButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B0E3C & 1) == 0 )
  {
    sub_B52984(&DataLostResetManager_ClickDelegate_TypeInfo);
    sub_B52984(&DataLostResetManager_TypeInfo);
    sub_B52984(&Method_EventInfoRaidResetButton_OnClick__);
    sub_B52984(&Method_EventInfoRaidResetButton__OnClick_b__8_0__);
    byte_42B0E3C = 1;
  }
  v3 = Method_EventInfoRaidResetButton_OnClick__;
  if ( (*((_BYTE *)Method_EventInfoRaidResetButton_OnClick__ + 75) & 2) != 0 )
    v3 = (_QWORD *)sub_B5298C(Method_EventInfoRaidResetButton_OnClick__);
  ...
  v10 = (DataLostResetManager_ClickDelegate_o *)sub_B52A54(DataLostResetManager_ClickDelegate_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B52984(&DataLostResetManager_TypeInfo);
    sub_B52984(&Method_EventInfoRaidResetButton_CallbackResetDataLostBattle__);
...
void __fastcall EventInfoRaidResetButton___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_42AD906 & 1) == 0 )
  {
    sub_B52984(&EventInfoRaidResetButton___c_TypeInfo);
    byte_42AD906 = 1;
  }
  v1 = (Il2CppObject *)sub_B52A54(EventInfoRaidResetButton___c_TypeInfo);
