        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B681EF & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_EventInfoRaidResetButton___c__CallbackResetDataLostBattle_b__9_0__, v5);
    this = (EventInfoRaidResetButton_o *)sub_1BE4ACC(&EventInfoRaidResetButton___c_TypeInfo, v6);
    byte_4B681EF = 1;
  }
  ...
  if ( !_9__9_0 )
  {
    ...
    _9__9_0 = (System_Action_o *)sub_1BE4D18(System_Action_TypeInfo);
    ...
    sub_1BE4A70((PartyOrganizationUtility_o *)&static_fields->__9__9_0, (int64_t)_9__9_0, v14, v15, v16, v17, v18, v19);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B681ED & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_5701/*"EVENT_DATA_LOST_BATTLE_RESET_BUTTON"*/, v12);
    sub_1BE4ACC(&StringLiteral_17746/*"btn_mission_bg"*/, v13);
    byte_4B681ED = 1;
  }
  ...
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_5701/*"EVENT_DATA_LOST_BATTLE_RESET_BUTTON"*/, 0LL);
  if ( !buttonLabel
  ...
  if ( UnityEngine_Object__op_Inequality(buttonSprite, 0LL, 0LL) )
  {
    ...
    AtlasManager__SetEventUI(v18, (System_String_o *)StringLiteral_17746/*"btn_mission_bg"*/, 0LL);
  }
}
...
void __fastcall EventInfoRaidResetButton__OnClick(EventInfoRaidResetButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B681EE & 1) == 0 )
  {
    sub_1BE4ACC(&DataLostResetManager_ClickDelegate_TypeInfo, method);
    sub_1BE4ACC(&DataLostResetManager_TypeInfo, v3);
    sub_1BE4ACC(&Method_EventInfoRaidResetButton_OnClick__, v4);
    sub_1BE4ACC(&Method_EventInfoRaidResetButton__OnClick_b__8_0__, v5);
    byte_4B681EE = 1;
  }
  v6 = Method_EventInfoRaidResetButton_OnClick__;
  if ( (*((_BYTE *)Method_EventInfoRaidResetButton_OnClick__ + 83) & 2) != 0 )
    v6 = (_QWORD *)sub_1BE4AE4(Method_EventInfoRaidResetButton_OnClick__);
  ...
  eventId = uiEntity->fields.eventId;
  warId = uiEntity->fields.warId;
  v13 = (DataLostResetManager_ClickDelegate_o *)sub_1BE4D18(DataLostResetManager_ClickDelegate_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B681F0 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_EventInfoRaidResetButton_CallbackResetDataLostBattle__, v5);
...
void __fastcall EventInfoRaidResetButton___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B681F1 & 1) == 0 )
  {
    sub_1BE4ACC(&EventInfoRaidResetButton___c_TypeInfo, v1);
    byte_4B681F1 = 1;
  }
  v2 = (Il2CppObject *)sub_1BE4D18(EventInfoRaidResetButton___c_TypeInfo);
