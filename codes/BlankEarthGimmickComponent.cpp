...
void BlankEarthGimmickComponent__Awake(BlankEarthGimmickComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEAD8A & 1) == 0 )
  {
    sub_1C7BAE8(&Method_CStateManager_BlankEarthGimmickComponent___ctor__);
    sub_1C7BAE8(&Method_CStateManager_BlankEarthGimmickComponent__add__);
    sub_1C7BAE8(&CStateManager_BlankEarthGimmickComponent__TypeInfo);
    sub_1C7BAE8(&BlankEarthGimmickComponent_StateDispAnim_TypeInfo);
    sub_1C7BAE8(&BlankEarthGimmickComponent_StateHideAnim_TypeInfo);
    sub_1C7BAE8(&BlankEarthGimmickComponent_StateMapMain_TypeInfo);
    sub_1C7BAE8(&BlankEarthGimmickComponent_StateNone_TypeInfo);
    byte_4CEAD8A = 1;
  }
  p_mFSM = &this->fields.mFSM;
  if ( !this->fields.mFSM )
  {
    v4 = (CStateManager_T__o *)sub_1C7BD34(CStateManager_BlankEarthGimmickComponent__TypeInfo);
    CStateManager_object____ctor(
      v4,
      (Il2CppObject *)this,
      4,
      (const MethodInfo_33B93F0 *)Method_CStateManager_BlankEarthGimmickComponent___ctor__);
    ...
    v12 = (Il2CppObject *)sub_1C7BD34(BlankEarthGimmickComponent_StateNone_TypeInfo);
    ...
    CStateManager_object___add(
      ...
      0,
      (IState_T__o *)v12,
      (const MethodInfo_33B9498 *)Method_CStateManager_BlankEarthGimmickComponent__add__);
    v15 = (CStateManager_T__o *)*p_mFSM;
    v16 = (Il2CppObject *)sub_1C7BD34(BlankEarthGimmickComponent_StateMapMain_TypeInfo);
    ...
    v18 = (Il2CppObject *)sub_1C7BD34(BlankEarthGimmickComponent_StateHideAnim_TypeInfo);
    ...
    if ( !v17
      || (CStateManager_object___add(
          ...
          v20 = (Il2CppObject *)sub_1C7BD34(BlankEarthGimmickComponent_StateDispAnim_TypeInfo),
...
int32_t BlankEarthGimmickComponent__GetState(BlankEarthGimmickComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEAD8D & 1) == 0 )
  {
    this = (BlankEarthGimmickComponent_o *)sub_1C7BAE8(&Method_CStateManager_BlankEarthGimmickComponent__getState__);
    byte_4CEAD8D = 1;
  }
  mFSM = v2->fields.mFSM;
  if ( !mFSM )
...
{
  BlankEarthGimmickComponent__SetDispAnim_36295628(this, isDisp, this->fields.animTime, method);
}
...
{
  BlankEarthGimmickComponent__SetDispAnim_36295628(this, isDisp, 0.0, method);
}


void BlankEarthGimmickComponent__SetDispAnim_36295628(
        BlankEarthGimmickComponent_o *this,
        bool isDisp,
        float time,
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEAD8F & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_BlankEarthGimmickComponent_StateDispAnimEnd__);
    sub_1C7BAE8(&Method_BlankEarthGimmickComponent_StateHideAnimEnd__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEAD8E & 1) == 0 )
  {
    sub_1C7BAE8(&Method_CStateManager_BlankEarthGimmickComponent__setState__);
    byte_4CEAD8E = 1;
  }
  ...
  CStateManager_object___setState(
    v13,
    state,
    (const MethodInfo_33B9524 *)Method_CStateManager_BlankEarthGimmickComponent__setState__);
}
...
void BlankEarthGimmickComponent__Update(BlankEarthGimmickComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEAD8B & 1) == 0 )
  {
    sub_1C7BAE8(&Method_CStateManager_BlankEarthGimmickComponent__update__);
    byte_4CEAD8B = 1;
  }
  mFSM = (CStateManager_T__o *)this->fields.mFSM;
  if ( mFSM )
    CStateManager_object___update(
      mFSM,
      (const MethodInfo_33B9500 *)Method_CStateManager_BlankEarthGimmickComponent__update__);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    BlankEarthGimmickComponent__SetDispAnim_36295628(that, 1, that->fields.animTime, method);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( dispType == 1 )
  {
    BlankEarthGimmickComponent__SetDispAnim_36295628(that, 0, that->fields.animTime, method);
  }
  else if ( !dispType )
  {
