        ...
        const MethodInfo *method)
{
  ...
  if ( onDecide )
  {
    ...
    v4 = sub_1B88554(&this->fields.onDecide, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A563D2 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_EventTradeSweetsNumConfirmDialogComponent__Close_b__48_0__);
    byte_4A563D2 = 1;
  }
  this->fields.state = 4;
        ...
        const MethodInfo *method)
{
  ...
  Master_object = (int64_t)DataManager__GetMaster_object_((const MethodInfo_2E7F8B4 *)Method_DataManager_GetMaster_UserItemMaster___);
  exchangeOriginItemList = this->fields.exchangeOriginItemList;
  if ( !exchangeOriginItemList )
LABEL_28:
    sub_1B8880C(Master_object, v4);
  max = this->fields.max;
  v7 = (UserItemMaster_o *)Master_object;
  v8 = 0LL;
  while ( (int)v8 < (signed int)exchangeOriginItemList->max_length )
  {
    ...
    if ( !v10 || !v7 )
      goto LABEL_28;
    Master_object = UserItemMaster__TryGetEntity(v7, &entity, Master_object, v10->fields.objectId, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A563D1 & 1) == 0 )
  {
    sub_1B885B0(&Method_EventTradeSweetsNumConfirmDialogComponent_OnClickCancel__);
    byte_4A563D1 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A563D0 & 1) == 0 )
  {
    sub_1B885B0(&Method_EventTradeSweetsNumConfirmDialogComponent_OnClickDecide__);
    byte_4A563D0 = 1;
  }
  if ( this->fields.state == 2 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A563CB & 1) == 0 )
  {
    ...
    sub_1B885B0(&DataManager_TypeInfo);
    sub_1B885B0(&Method_EventTradeSweetsNumConfirmDialogComponent_EndOpen__);
    sub_1B885B0(&EventTradeTimeCalculation_TypeInfo);
    sub_1B885B0(&int_TypeInfo);
    sub_1B885B0(&LocalizationManager_TypeInfo);
    sub_1B885B0(&System_Math_TypeInfo);
    sub_1B885B0(&NetworkManager_TypeInfo);
    sub_1B885B0(&StringLiteral_13380/*"TRADE_EVENT_CONFIRM_DIALOG_TITLE"*/);
    sub_1B885B0(&StringLiteral_20198/*"icon_{0}"*/);
    sub_1B885B0(&StringLiteral_13377/*"TRADE_EVENT_CONFIRM_DIALOG_EXECUTE"*/);
    sub_1B885B0(&StringLiteral_8776/*"MULTIPLE_INFO"*/);
    sub_1B885B0(&StringLiteral_13396/*"TRADE_EVENT_REPLENISHMENT_CONFIRM_DIALOG_DESCRIPTION"*/);
    sub_1B885B0(&StringLiteral_3755/*"COMMON_CONFIRM_CANCEL"*/);
    sub_1B885B0(&StringLiteral_13398/*"TRADE_EVENT_REPLENISHMENT_CONFIRM_DIALOG_TITLE"*/);
    this = (EventTradeSweetsNumConfirmDialogComponent_o *)sub_1B885B0(&StringLiteral_13375/*"TRADE_EVENT_CONFIRM_DIALOG_DESCRIPTION"*/);
    byte_4A563CB = 1;
  }
  if ( !v10->fields.state )
  {
    if ( item )
    {
      ...
      sub_1B88554(&v10->fields.tradeGoodsEntity, TradeGoodsEntity_k__BackingField);
      v10->fields.onDecide = onDecide;
      sub_1B88554(&v10->fields.onDecide, onDecide);
      ...
      sub_1B88554(&v10->fields.eventTradeInfo, v13);
      ...
      if ( this )
      {
        ...
        v16 = (System_String_o **)&StringLiteral_13398/*"TRADE_EVENT_REPLENISHMENT_CONFIRM_DIALOG_TITLE"*/;
        if ( !isReplenishment )
          v16 = (System_String_o **)&StringLiteral_13380/*"TRADE_EVENT_CONFIRM_DIALOG_TITLE"*/;
        ...
        if ( titleLabel )
        {
          ...
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          v18 = (System_String_o **)&StringLiteral_13396/*"TRADE_EVENT_REPLENISHMENT_CONFIRM_DIALOG_DESCRIPTION"*/;
          if ( !isReplenishment )
            v18 = (System_String_o **)&StringLiteral_13375/*"TRADE_EVENT_CONFIRM_DIALOG_DESCRIPTION"*/;
          ...
          if ( detailLabel )
          {
            ...
            if ( cancelButtonLb )
            {
              ...
              this = (EventTradeSweetsNumConfirmDialogComponent_o *)LocalizationManager__Get(
                                                                      (System_String_o *)StringLiteral_13377/*"TRADE_EVENT_CONFIRM_DIALOG_EXECUTE"*/,
                                                                      0LL);
              if ( decideButtonLb )
              {
                ...
                if ( tradeGoodsEntity )
                {
                  ...
                  if ( this )
                  {
                    ...
                    if ( !DataManager_TypeInfo->_2.cctor_finished )
                      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
                    this = (EventTradeSweetsNumConfirmDialogComponent_o *)DataManager__GetMaster_object_((const MethodInfo_2E7F8B4 *)Method_DataManager_GetMaster_CommonConsumeMaster___);
                    if ( *p_tradeGoodsEntity )
                    {
                      if ( this )
                      {
                        ...
                        this = (EventTradeSweetsNumConfirmDialogComponent_o *)sub_1B88554(
                                                                                &v10->fields.exchangeOriginItemList,
                                                                                SortedEntityList);
                        exchangeOriginItemList = v10->fields.exchangeOriginItemList;
                        if ( exchangeOriginItemList )
                        {
                          v24 = sub_1B88658(bool___TypeInfo, exchangeOriginItemList->max_length);
                          ...
                          if ( isReplenishment )
                          {
                            ...
                            v33 = EventTradeTimeCalculation__GetCompleteNum_30740228(
                                    v27,
                                    startedAt,
                                    (int64_t)v31,
                                    v32,
                          ...
                          v38 = System_Math__Min_62526008(v35, ItemSliderMax, 0LL);
                          v10->fields.max = v38;
                          ...
                          if ( v43 )
                          {
                            ...
                            v47 = System_String__Format((System_String_o *)StringLiteral_20198/*"icon_{0}"*/, v46, 0LL);
                            if ( !AtlasManager_TypeInfo->_2.cctor_finished )
                              j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
                            AtlasManager__SetEventUI_37859364(eventId, eventItemIcon, v47, 0LL);
                            eventItemMakeNum = v10->fields.eventItemMakeNum;
                            if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                            v49 = LocalizationManager__Get((System_String_o *)StringLiteral_8776/*"MULTIPLE_INFO"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A563CF & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_13379/*"TRADE_EVENT_CONFIRM_DIALOG_ORIGIN_LABEL"*/);
    sub_1B885B0(&StringLiteral_13378/*"TRADE_EVENT_CONFIRM_DIALOG_KIND"*/);
    sub_1B885B0(&StringLiteral_13376/*"TRADE_EVENT_CONFIRM_DIALOG_DESTINATION_LABEL"*/);
    byte_4A563CF = 1;
  }
  exchangeOriginLb = this->fields.exchangeOriginLb;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  NumberFormat = (CommonConsumeEntity_o *)LocalizationManager__Get((System_String_o *)StringLiteral_13379/*"TRADE_EVENT_CONFIRM_DIALOG_ORIGIN_LABEL"*/, 0LL);
  if ( !exchangeOriginLb )
    goto LABEL_93;
  ...
  if ( (_DWORD)v7 == 3 )
  {
    ...
    do
    {
      ...
      v23 = LocalizationManager__Get((System_String_o *)StringLiteral_13378/*"TRADE_EVENT_CONFIRM_DIALOG_KIND"*/, 0LL);
      NumberFormat = (CommonConsumeEntity_o *)System_String__Format_61721404(v23, v18, v21, 0LL);
      if ( !v22 )
        goto LABEL_93;
  ...
  else
  {
    if ( (int)v7 >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        v45 = LocalizationManager__Get((System_String_o *)StringLiteral_13378/*"TRADE_EVENT_CONFIRM_DIALOG_KIND"*/, 0LL);
        NumberFormat = (CommonConsumeEntity_o *)System_String__Format_61721404(v45, v40, v43, 0LL);
        if ( !v44 )
          break;
...
LABEL_74:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  NumberFormat = (CommonConsumeEntity_o *)LocalizationManager__Get((System_String_o *)StringLiteral_13376/*"TRADE_EVENT_CONFIRM_DIALOG_DESTINATION_LABEL"*/, 0LL);
  if ( !exchangeDestinationLb )
    goto LABEL_93;
  UILabel__set_text(exchangeDestinationLb, (System_String_o *)NumberFormat, 0LL);
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  NumberFormat = (CommonConsumeEntity_o *)DataManager__GetMaster_object_((const MethodInfo_2E7F8B4 *)Method_DataManager_GetMaster_GiftMaster___);
  tradeGoodsEntity = this->fields.tradeGoodsEntity;
  if ( !tradeGoodsEntity )
    goto LABEL_93;
  if ( !NumberFormat )
  ...
  NumberFormat = (CommonConsumeEntity_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !NumberFormat )
    goto LABEL_93;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A563D5 & 1) == 0 )
  {
    sub_1B885B0(&LocalizationManager_TypeInfo);
    sub_1B885B0(&StringLiteral_8776/*"MULTIPLE_INFO"*/);
    sub_1B885B0(&StringLiteral_13397/*"TRADE_EVENT_REPLENISHMENT_CONFIRM_DIALOG_INFO"*/);
    byte_4A563D5 = 1;
  }
  isReplenishment = this->fields.isReplenishment;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_8776/*"MULTIPLE_INFO"*/, 0LL);
  if ( isReplenishment )
  {
    exchangeDestinationPointCount = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_13397/*"TRADE_EVENT_REPLENISHMENT_CONFIRM_DIALOG_INFO"*/, 0LL);
    ...
    if ( eventTradeInfo )
    {
      ...
      v12 = (Il2CppObject *)System_String__Format_61721404(v8, NumberFormat, v11, 0LL);
      v13 = System_String__Format(v4, v12, 0LL);
      v14 = LocalizationManager__Get((System_String_o *)StringLiteral_8776/*"MULTIPLE_INFO"*/, 0LL);
      exchangeDestinationPointCount = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_13397/*"TRADE_EVENT_REPLENISHMENT_CONFIRM_DIALOG_INFO"*/, 0LL);
      tradeGoodsEntity = this->fields.tradeGoodsEntity;
      if ( tradeGoodsEntity )
      {
        ...
        if ( v16 )
        {
          ...
          if ( v18 )
          {
            ...
            v23 = (Il2CppObject *)System_String__Format_61721404(v17, v21, v22, 0LL);
            goto LABEL_23;
          }
        }
      }
...
LABEL_26:
    sub_1B8880C(exchangeDestinationPointCount, v6);
  }
  if ( this->fields.makeCount <= 1 )
    v24 = 1;
  else
  ...
  exchangeDestinationPointCount = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8776/*"MULTIPLE_INFO"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A563CC & 1) == 0 )
  {
    ...
    sub_1B885B0(&System_Math_TypeInfo);
    sub_1B885B0(&NetworkManager_TypeInfo);
    sub_1B885B0(&StringLiteral_13368/*"TRADE_EVENT_ADD_TIME_LABEL"*/);
    sub_1B885B0(&StringLiteral_13374/*"TRADE_EVENT_COMPLETION_TIME_LABEL"*/);
    this = (EventTradeSweetsNumConfirmDialogComponent_o *)sub_1B885B0(&StringLiteral_24926/*"{0,2}:{1:D2}:{2:D2}"*/);
    byte_4A563CC = 1;
  }
  if ( !v3->fields.isReplenishment )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v25 = LocalizationManager__Get((System_String_o *)StringLiteral_13374/*"TRADE_EVENT_COMPLETION_TIME_LABEL"*/, 0LL);
    ...
    RestTimeInFormat = (Il2CppObject *)LocalizationManager__GetRestTimeInFormat(
                                         TradeFinishTime,
                                         0LL,
                                         (System_String_o *)StringLiteral_24926/*"{0,2}:{1:D2}:{2:D2}"*/,
                                         0LL);
...
LABEL_23:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v14 = LocalizationManager__Get((System_String_o *)StringLiteral_13374/*"TRADE_EVENT_COMPLETION_TIME_LABEL"*/, 0LL);
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  Time = NetworkManager__getTime(0LL);
  if ( !System_Math_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
  v16 = System_Math__Max_62525692((int64_t)&v10[-Time], 0LL, 0LL);
  v17 = LocalizationManager__GetRestTimeInFormat(v16 + v13, 0LL, (System_String_o *)StringLiteral_24926/*"{0,2}:{1:D2}:{2:D2}"*/, 0LL);
  v18 = LocalizationManager__Get((System_String_o *)StringLiteral_13368/*"TRADE_EVENT_ADD_TIME_LABEL"*/, 0LL);
  v19 = (Il2CppObject *)LocalizationManager__GetRestTimeInFormat(v13, 0LL, (System_String_o *)StringLiteral_24926/*"{0,2}:{1:D2}:{2:D2}"*/, 0LL);
  v20 = System_String__Format(v18, v19, 0LL);
  v21 = (Il2CppObject *)System_String__Concat_61707032(v17, v20, 0LL);
...
LABEL_41:
  ...
  if ( (_DWORD)v5 == 3 )
  {
    ...
    while ( v6 < (unsigned int)v5 )
    {
      ...
      v17 = LocalizationManager__Get((System_String_o *)StringLiteral_13378/*"TRADE_EVENT_CONFIRM_DIALOG_KIND"*/, 0LL);
      itemSlider = (CommonConsumeEntity_o *)System_String__Format_61721404(v17, v12, v15, 0LL);
      if ( !v16 )
        goto LABEL_41;
  ...
  if ( (int)v5 >= 1 )
  {
    ...
    while ( v18 < (unsigned int)v5 )
    {
      ...
      v29 = LocalizationManager__Get((System_String_o *)StringLiteral_13378/*"TRADE_EVENT_CONFIRM_DIALOG_KIND"*/, 0LL);
      itemSlider = (CommonConsumeEntity_o *)System_String__Format_61721404(v29, v24, v27, 0LL);
      if ( !v28 )
        goto LABEL_41;
        ...
        const MethodInfo *method)
{
  ...
  if ( this->fields.isReplenishment )
  {
    ...
    if ( !EventTradeTimeCalculation_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(EventTradeTimeCalculation_TypeInfo);
    v16 = EventTradeTimeCalculation__GetCompleteNum_30740228(tradeGoodsEntity, startedAt, v14, v15, 0, v12) - tradeNum;
  }
  else
  {
    v16 = 0;
  ...
  if ( !System_Math_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
  v21 = System_Math__Min_62526008(TradeMaxNum + v16, ItemSliderMax, 0LL);
  if ( this->fields.max != v21 )
  {
    ...
    if ( !System_Math_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
    Time = System_Math__Min_62526008(v22, makeCount, 0LL);
    itemSlider = this->fields.itemSlider;
