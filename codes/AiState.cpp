...
AiState_o *__fastcall AiState__MakeAiState(int32_t groupId, const MethodInfo *method)
{
  ...
  if ( (byte_4BCA6A9 & 1) == 0 )
  {
    sub_1C1ABD4(&AiState_TypeInfo, method);
    byte_4BCA6A9 = 1;
  }
  v3 = sub_1C1AE20(AiState_TypeInfo);
  *(_DWORD *)(v3 + 44) = -1;
...
AiState_o *__fastcall AiState__MakeAiState_44642580(AiState_SaveData_o *sv, const MethodInfo *method)
{
  __int64 v3; // x20
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCA6AB & 1) == 0 )
  {
    sub_1C1ABD4(&BattleWarBoardInfo_TakeOverAiStateData_TypeInfo, method);
    byte_4BCA6AB = 1;
  }
  v3 = (BattleWarBoardInfo_TakeOverAiStateData_o *)sub_1C1AE20(BattleWarBoardInfo_TakeOverAiStateData_TypeInfo);
...
AiState_SaveData_o *__fastcall AiState__getSaveData(AiState_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BCA6A8 & 1) == 0 )
  {
    sub_1C1ABD4(&AiState_SaveData_TypeInfo, method);
    byte_4BCA6A8 = 1;
  }
  v3 = sub_1C1AE20(AiState_SaveData_TypeInfo);
  System_Object___ctor((Il2CppObject *)v3, 0LL);
  if ( !v3 )
    sub_1C1AE30(v4, v5);
