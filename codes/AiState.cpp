...
AiState_o *__fastcall AiState__MakeAiState(int32_t groupId, const MethodInfo *method)
{
  ...
  if ( (byte_4B4788A & 1) == 0 )
  {
    sub_1BDB878(&AiState_TypeInfo, method);
    byte_4B4788A = 1;
  }
  v3 = sub_1BDBAC4(AiState_TypeInfo);
  *(_DWORD *)(v3 + 44) = -1;
...
AiState_o *__fastcall AiState__MakeAiState_45462324(AiState_SaveData_o *sv, const MethodInfo *method)
{
  __int64 v3; // x20
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4788C & 1) == 0 )
  {
    sub_1BDB878(&BattleWarBoardInfo_TakeOverAiStateData_TypeInfo, method);
    byte_4B4788C = 1;
  }
  v3 = (BattleWarBoardInfo_TakeOverAiStateData_o *)sub_1BDBAC4(BattleWarBoardInfo_TakeOverAiStateData_TypeInfo);
...
AiState_SaveData_o *__fastcall AiState__getSaveData(AiState_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B47889 & 1) == 0 )
  {
    sub_1BDB878(&AiState_SaveData_TypeInfo, method);
    byte_4B47889 = 1;
  }
  v3 = sub_1BDBAC4(AiState_SaveData_TypeInfo);
  System_Object___ctor((Il2CppObject *)v3, 0LL);
  if ( !v3 )
    sub_1BDBAD4(v4, v5);
