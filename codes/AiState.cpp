...
AiState_o *__fastcall AiState__MakeAiState(int32_t groupId, const MethodInfo *method)
{
  ...
  if ( (byte_4A3092C & 1) == 0 )
  {
    sub_1B761C0(&AiState_TypeInfo, method);
    byte_4A3092C = 1;
  }
  v3 = sub_1B7640C(AiState_TypeInfo);
  *(_DWORD *)(v3 + 44) = -1;
...
AiState_o *__fastcall AiState__MakeAiState_43073232(AiState_SaveData_o *sv, const MethodInfo *method)
{
  __int64 v3; // x20
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A3092E & 1) == 0 )
  {
    sub_1B761C0(&BattleWarBoardInfo_TakeOverAiStateData_TypeInfo, method);
    byte_4A3092E = 1;
  }
  v3 = (BattleWarBoardInfo_TakeOverAiStateData_o *)sub_1B7640C(BattleWarBoardInfo_TakeOverAiStateData_TypeInfo);
...
AiState_SaveData_o *__fastcall AiState__getSaveData(AiState_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A3092B & 1) == 0 )
  {
    sub_1B761C0(&AiState_SaveData_TypeInfo, method);
    byte_4A3092B = 1;
  }
  v3 = sub_1B7640C(AiState_SaveData_TypeInfo);
  System_Object___ctor((Il2CppObject *)v3, 0LL);
  if ( !v3 )
    sub_1B7641C(v4, v5);
