...
AiState_o *__fastcall AiState__MakeAiState(int32_t groupId, const MethodInfo *method)
{
  ...
  if ( (byte_4A72888 & 1) == 0 )
  {
    sub_1B90010(&AiState_TypeInfo, method);
    byte_4A72888 = 1;
  }
  v3 = sub_1B9025C(AiState_TypeInfo);
  *(_DWORD *)(v3 + 44) = -1;
...
AiState_o *__fastcall AiState__MakeAiState_43320732(AiState_SaveData_o *sv, const MethodInfo *method)
{
  __int64 v3; // x20
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A7288A & 1) == 0 )
  {
    sub_1B90010(&BattleWarBoardInfo_TakeOverAiStateData_TypeInfo, method);
    byte_4A7288A = 1;
  }
  v3 = (BattleWarBoardInfo_TakeOverAiStateData_o *)sub_1B9025C(BattleWarBoardInfo_TakeOverAiStateData_TypeInfo);
...
AiState_SaveData_o *__fastcall AiState__getSaveData(AiState_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A72887 & 1) == 0 )
  {
    sub_1B90010(&AiState_SaveData_TypeInfo, method);
    byte_4A72887 = 1;
  }
  v3 = sub_1B9025C(AiState_SaveData_TypeInfo);
  System_Object___ctor((Il2CppObject *)v3, 0LL);
  if ( !v3 )
    sub_1B9026C(v4, v5);
