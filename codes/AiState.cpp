...
AiState_o *AiState__MakeAiState(int32_t groupId, const MethodInfo *method)
{
  ...
  v3 = sub_1C7BD34(AiState_TypeInfo);
  *(_DWORD *)(v3 + 44) = -1;
...
AiState_o *AiState__MakeAiState_47246944(AiState_SaveData_o *sv, const MethodInfo *method)
{
  __int64 v3; // x20
...
BattleWarBoardInfo_TakeOverAiStateData_o *AiState__MakeTakeOverAiState(AiState_o *aiState, const MethodInfo *method)
{
  ...
  if ( (byte_4CF166E & 1) == 0 )
  {
    sub_1C7BAE8(&BattleWarBoardInfo_TakeOverAiStateData_TypeInfo);
    byte_4CF166E = 1;
  }
  v3 = (BattleWarBoardInfo_TakeOverAiStateData_o *)sub_1C7BD34(BattleWarBoardInfo_TakeOverAiStateData_TypeInfo);
...
AiState_SaveData_o *AiState__getSaveData(AiState_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CF166B & 1) == 0 )
  {
    sub_1C7BAE8(&AiState_SaveData_TypeInfo);
    byte_4CF166B = 1;
  }
  v3 = sub_1C7BD34(AiState_SaveData_TypeInfo);
  System_Object___ctor((Il2CppObject *)v3, 0);
  if ( !v3 )
    sub_1C7BD40(v4, v5);
