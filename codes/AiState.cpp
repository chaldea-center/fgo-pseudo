...
AiState_o *__fastcall AiState__MakeAiState(int32_t groupId, const MethodInfo *method)
{
  ...
  v3 = sub_1C22084(AiState_TypeInfo);
  *(_DWORD *)(v3 + 44) = -1;
...
AiState_o *__fastcall AiState__MakeAiState_44699348(AiState_SaveData_o *sv, const MethodInfo *method)
{
  __int64 v3; // x20
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDF15C & 1) == 0 )
  {
    sub_1C21E38(&BattleWarBoardInfo_TakeOverAiStateData_TypeInfo);
    byte_4BDF15C = 1;
  }
  v3 = (BattleWarBoardInfo_TakeOverAiStateData_o *)sub_1C22084(BattleWarBoardInfo_TakeOverAiStateData_TypeInfo);
...
AiState_SaveData_o *__fastcall AiState__getSaveData(AiState_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDF159 & 1) == 0 )
  {
    sub_1C21E38(&AiState_SaveData_TypeInfo);
    byte_4BDF159 = 1;
  }
  v3 = sub_1C22084(AiState_SaveData_TypeInfo);
  System_Object___ctor((Il2CppObject *)v3, 0LL);
  if ( !v3 )
    sub_1C22094(v4, v5);
