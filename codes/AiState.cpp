...
AiState_o *AiState__MakeAiState(int32_t groupId, const MethodInfo *method)
{
  ...
  v3 = sub_2213CCC(AiState_TypeInfo);
  *(_DWORD *)(v3 + 44) = -1;
...
AiState_o *AiState__MakeAiState_53709168(AiState_SaveData_o *sv, const MethodInfo *method)
{
  __int64 v3; // x20
...
BattleWarBoardInfo_TakeOverAiStateData_o *AiState__MakeTakeOverAiState(AiState_o *aiState, const MethodInfo *method)
{
  ...
  if ( (byte_597390B & 1) == 0 )
  {
    sub_2213A60(&BattleWarBoardInfo_TakeOverAiStateData_TypeInfo);
    byte_597390B = 1;
  }
  v3 = (BattleWarBoardInfo_TakeOverAiStateData_o *)sub_2213CCC(BattleWarBoardInfo_TakeOverAiStateData_TypeInfo);
...
AiState_SaveData_o *AiState__getSaveData(AiState_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_5973908 & 1) == 0 )
  {
    sub_2213A60(&AiState_SaveData_TypeInfo);
    byte_5973908 = 1;
  }
  v3 = sub_2213CCC(AiState_SaveData_TypeInfo);
  System_Object___ctor((Il2CppObject *)v3, 0);
  if ( !v3 )
    sub_2213CDC(v4, v5);
