...
AiState_o *__fastcall AiState__MakeAiState(int32_t groupId, const MethodInfo *method)
{
  ...
  if ( (byte_4BB72C7 & 1) == 0 )
  {
    sub_1C13D24(&AiState_TypeInfo, method);
    byte_4BB72C7 = 1;
  }
  v3 = sub_1C13F70(AiState_TypeInfo);
  *(_DWORD *)(v3 + 44) = -1;
...
AiState_o *__fastcall AiState__MakeAiState_44583208(AiState_SaveData_o *sv, const MethodInfo *method)
{
  __int64 v3; // x20
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB72C9 & 1) == 0 )
  {
    sub_1C13D24(&BattleWarBoardInfo_TakeOverAiStateData_TypeInfo, method);
    byte_4BB72C9 = 1;
  }
  v3 = (BattleWarBoardInfo_TakeOverAiStateData_o *)sub_1C13F70(BattleWarBoardInfo_TakeOverAiStateData_TypeInfo);
...
AiState_SaveData_o *__fastcall AiState__getSaveData(AiState_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB72C6 & 1) == 0 )
  {
    sub_1C13D24(&AiState_SaveData_TypeInfo, method);
    byte_4BB72C6 = 1;
  }
  v3 = sub_1C13F70(AiState_SaveData_TypeInfo);
  System_Object___ctor((Il2CppObject *)v3, 0LL);
  if ( !v3 )
    sub_1C13F80(v4, v5);
