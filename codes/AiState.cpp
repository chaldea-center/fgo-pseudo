...
AiState_o *__fastcall AiState__MakeAiState(int32_t groupId, const MethodInfo *method)
{
  ...
  if ( (byte_4B04E58 & 1) == 0 )
  {
    sub_1BC3008(&AiState_TypeInfo, method);
    byte_4B04E58 = 1;
  }
  v3 = sub_1BC3254(AiState_TypeInfo);
  *(_DWORD *)(v3 + 44) = -1;
...
AiState_o *__fastcall AiState__MakeAiState_45511036(AiState_SaveData_o *sv, const MethodInfo *method)
{
  __int64 v3; // x20
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B04E5A & 1) == 0 )
  {
    sub_1BC3008(&BattleWarBoardInfo_TakeOverAiStateData_TypeInfo, method);
    byte_4B04E5A = 1;
  }
  v3 = (BattleWarBoardInfo_TakeOverAiStateData_o *)sub_1BC3254(BattleWarBoardInfo_TakeOverAiStateData_TypeInfo);
...
AiState_SaveData_o *__fastcall AiState__getSaveData(AiState_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B04E57 & 1) == 0 )
  {
    sub_1BC3008(&AiState_SaveData_TypeInfo, method);
    byte_4B04E57 = 1;
  }
  v3 = sub_1BC3254(AiState_SaveData_TypeInfo);
  System_Object___ctor((Il2CppObject *)v3, 0LL);
  if ( !v3 )
    sub_1BC3264(v4, v5);
