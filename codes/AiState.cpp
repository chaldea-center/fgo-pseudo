...
AiState_o *__fastcall AiState__MakeAiState(int32_t groupId, const MethodInfo *method)
{
  ...
  if ( (byte_4B69795 & 1) == 0 )
  {
    sub_1BE4ACC(&AiState_TypeInfo, method);
    byte_4B69795 = 1;
  }
  v3 = sub_1BE4D18(AiState_TypeInfo);
  *(_DWORD *)(v3 + 44) = -1;
...
AiState_o *__fastcall AiState__MakeAiState_44386236(AiState_SaveData_o *sv, const MethodInfo *method)
{
  __int64 v3; // x20
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69797 & 1) == 0 )
  {
    sub_1BE4ACC(&BattleWarBoardInfo_TakeOverAiStateData_TypeInfo, method);
    byte_4B69797 = 1;
  }
  v3 = (BattleWarBoardInfo_TakeOverAiStateData_o *)sub_1BE4D18(BattleWarBoardInfo_TakeOverAiStateData_TypeInfo);
...
AiState_SaveData_o *__fastcall AiState__getSaveData(AiState_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B69794 & 1) == 0 )
  {
    sub_1BE4ACC(&AiState_SaveData_TypeInfo, method);
    byte_4B69794 = 1;
  }
  v3 = sub_1BE4D18(AiState_SaveData_TypeInfo);
  System_Object___ctor((Il2CppObject *)v3, 0LL);
  if ( !v3 )
    sub_1BE4D28(v4, v5);
