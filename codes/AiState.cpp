...
AiState_o *__fastcall AiState__MakeAiState(int32_t groupId, const MethodInfo *method)
{
  ...
  if ( (byte_4AB886B & 1) == 0 )
  {
    sub_1BAB41C(&AiState_TypeInfo, method);
    byte_4AB886B = 1;
  }
  v3 = sub_1BAB668(AiState_TypeInfo);
  *(_DWORD *)(v3 + 44) = -1;
...
AiState_o *__fastcall AiState__MakeAiState_43770368(AiState_SaveData_o *sv, const MethodInfo *method)
{
  __int64 v3; // x20
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB886D & 1) == 0 )
  {
    sub_1BAB41C(&BattleWarBoardInfo_TakeOverAiStateData_TypeInfo, method);
    byte_4AB886D = 1;
  }
  v3 = (BattleWarBoardInfo_TakeOverAiStateData_o *)sub_1BAB668(BattleWarBoardInfo_TakeOverAiStateData_TypeInfo);
...
AiState_SaveData_o *__fastcall AiState__getSaveData(AiState_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB886A & 1) == 0 )
  {
    sub_1BAB41C(&AiState_SaveData_TypeInfo, method);
    byte_4AB886A = 1;
  }
  v3 = sub_1BAB668(AiState_SaveData_TypeInfo);
  System_Object___ctor((Il2CppObject *)v3, 0LL);
  if ( !v3 )
    sub_1BAB678(v4, v5);
