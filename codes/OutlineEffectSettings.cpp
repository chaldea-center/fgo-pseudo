void __fastcall OutlineEffectSettings___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A6BB51 & 1) == 0 )
  {
    sub_1B90010(&OutlineEffectSettings_TypeInfo, v1);
    byte_4A6BB51 = 1;
  }
  if ( !byte_4A6A9C1 )
  {
...
void __fastcall OutlineEffectSettings___ctor(OutlineEffectSettings_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6BB50 & 1) == 0 )
  {
    sub_1B90010(&OutlineEffectSettings_TypeInfo, method);
    byte_4A6BB50 = 1;
  }
  *(_OWORD *)&this->fields.thickness = xmmword_BB6D00;
  ...
  *(_OWORD *)&this->fields.fullscreenUVScaleX = xmmword_BB8680;
  this->fields.gaussianSilhouetteR = (struct UnityEngine_Color_o)xmmword_BB88F0;
  this->fields.gaussianSilhouetteG = (struct UnityEngine_Color_o)xmmword_BB8820;
  this->fields.gaussianSilhouetteB = (struct UnityEngine_Color_o)xmmword_BB70E0;
  ...
  *(_OWORD *)&this->fields.gaussianBloomIntensity = xmmword_BB7860;
...
OutlineEffectSettings_o *__fastcall OutlineEffectSettings__get_Default(const MethodInfo *method)
{
  ...
  if ( (byte_4A6BB4F & 1) == 0 )
  {
    sub_1B90010(&UnityEngine_Gradient_TypeInfo, v1);
    sub_1B90010(&OutlineEffectSettings_TypeInfo, v2);
    sub_1B90010(&Method_UnityEngine_ScriptableObject_CreateInstance_OutlineEffectSettings___, v3);
    byte_4A6BB4F = 1;
  }
  Instance_object = UnityEngine_ScriptableObject__CreateInstance_object_((const MethodInfo_2F2BCBC *)Method_UnityEngine_ScriptableObject_CreateInstance_OutlineEffectSettings___);
  v5 = (UnityEngine_Gradient_o *)sub_1B9025C(UnityEngine_Gradient_TypeInfo);
  UnityEngine_Gradient___ctor(v5, 0LL);
  if ( !Instance_object )
    sub_1B9026C(v6, v7);
  Instance_object[1].monitor = v5;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&Instance_object[1].monitor, (int32_t)v5, v8, v9);
  Instance_object[2] = (Il2CppObject)xmmword_BB6D00;
  if ( !OutlineEffectSettings_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(OutlineEffectSettings_TypeInfo);
  if ( !byte_4A6BB74 )
  {
    sub_1B90010(&OutlineEffectSettings_TypeInfo, v10);
    byte_4A6BB74 = 1;
  }
  ...
  *(_OWORD *)&Instance_object[4].monitor = xmmword_BB8680;
  ...
  *(_OWORD *)&Instance_object[5].monitor = xmmword_BB88F0;
  *(_OWORD *)&Instance_object[6].monitor = xmmword_BB8820;
  *(_OWORD *)&Instance_object[7].monitor = xmmword_BB70E0;
  *(_OWORD *)&Instance_object[13].monitor = xmmword_BB7860;
...
UnityEngine_Gradient_o *__fastcall OutlineEffectSettings__get_DefaultGradient(const MethodInfo *method)
{
  ...
  if ( (byte_4A6BB4E & 1) == 0 )
  {
    sub_1B90010(&UnityEngine_GradientAlphaKey___TypeInfo, v1);
    sub_1B90010(&UnityEngine_GradientColorKey___TypeInfo, v2);
    sub_1B90010(&UnityEngine_Gradient_TypeInfo, v3);
  ...
  {
    v6 = (UnityEngine_Gradient_o *)sub_1B9025C(UnityEngine_Gradient_TypeInfo);
    ...
    sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&static_fields->defaultGradient, (int32_t)v6, v7, v8);
    v11 = sub_1B900B8(UnityEngine_GradientColorKey___TypeInfo, 2LL);
    v30.fields.r = 1.0;
    v30.fields.g = 1.0;
    v30.fields.b = 1.0;
    v30.fields.a = 1.0;
    ...
    if ( v11 )
    {
      ...
      *(struct UnityEngine_Color_o *)(v11 + 52) = color;
      v16 = sub_1B900B8(UnityEngine_GradientAlphaKey___TypeInfo, 2LL);
      ...
      {
LABEL_20:
        sub_1B90274(defaultGradient, v13);
      }
      *(_QWORD *)(v16 + 40) = v22;
...
LABEL_21:
    sub_1B9026C(defaultGradient, v13);
  }
LABEL_17:
