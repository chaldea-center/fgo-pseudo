void __fastcall OutlineEffectSettings___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BC3537 & 1) == 0 )
  {
    sub_1C1ABD4(&OutlineEffectSettings_TypeInfo, v1);
    byte_4BC3537 = 1;
  }
  if ( !byte_4BC2141 )
  {
...
void __fastcall OutlineEffectSettings___ctor(OutlineEffectSettings_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC3536 & 1) == 0 )
  {
    sub_1C1ABD4(&OutlineEffectSettings_TypeInfo, method);
    byte_4BC3536 = 1;
  }
  *(_OWORD *)&this->fields.thickness = xmmword_BF9AA0;
  ...
  *(_OWORD *)&this->fields.fullscreenUVScaleX = xmmword_BFB3D0;
  this->fields.gaussianSilhouetteR = (struct UnityEngine_Color_o)xmmword_BFB660;
  this->fields.gaussianSilhouetteG = (struct UnityEngine_Color_o)xmmword_BFB580;
  this->fields.gaussianSilhouetteB = (struct UnityEngine_Color_o)xmmword_BF9E70;
  ...
  *(_OWORD *)&this->fields.gaussianBloomIntensity = xmmword_BFA5D0;
...
OutlineEffectSettings_o *__fastcall OutlineEffectSettings__get_Default(const MethodInfo *method)
{
  ...
  if ( (byte_4BC3535 & 1) == 0 )
  {
    sub_1C1ABD4(&UnityEngine_Gradient_TypeInfo, v1);
    sub_1C1ABD4(&OutlineEffectSettings_TypeInfo, v2);
    sub_1C1ABD4(&Method_UnityEngine_ScriptableObject_CreateInstance_OutlineEffectSettings___, v3);
    byte_4BC3535 = 1;
  }
  Instance_object = UnityEngine_ScriptableObject__CreateInstance_object_((const MethodInfo_303EC28 *)Method_UnityEngine_ScriptableObject_CreateInstance_OutlineEffectSettings___);
  v5 = (UnityEngine_Gradient_o *)sub_1C1AE20(UnityEngine_Gradient_TypeInfo);
  UnityEngine_Gradient___ctor(v5, 0LL);
  if ( !Instance_object )
    sub_1C1AE30(v6, v7);
  Instance_object[1].monitor = v5;
  sub_1C1AB78(&Instance_object[1].monitor);
  Instance_object[2] = (Il2CppObject)xmmword_BF9AA0;
  if ( !OutlineEffectSettings_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(OutlineEffectSettings_TypeInfo);
  if ( !byte_4BC355A )
  {
    sub_1C1ABD4(&OutlineEffectSettings_TypeInfo, v8);
    byte_4BC355A = 1;
  }
  ...
  *(_OWORD *)&Instance_object[4].monitor = xmmword_BFB3D0;
  ...
  *(_OWORD *)&Instance_object[5].monitor = xmmword_BFB660;
  *(_OWORD *)&Instance_object[6].monitor = xmmword_BFB580;
  *(_OWORD *)&Instance_object[7].monitor = xmmword_BF9E70;
  *(_OWORD *)&Instance_object[13].monitor = xmmword_BFA5D0;
...
UnityEngine_Gradient_o *__fastcall OutlineEffectSettings__get_DefaultGradient(const MethodInfo *method)
{
  ...
  if ( (byte_4BC3534 & 1) == 0 )
  {
    sub_1C1ABD4(&UnityEngine_GradientAlphaKey___TypeInfo, v1);
    sub_1C1ABD4(&UnityEngine_GradientColorKey___TypeInfo, v2);
    sub_1C1ABD4(&UnityEngine_Gradient_TypeInfo, v3);
  ...
  {
    v6 = (UnityEngine_Gradient_o *)sub_1C1AE20(UnityEngine_Gradient_TypeInfo);
    ...
    sub_1C1AB78(&static_fields->defaultGradient);
    v9 = sub_1C1AC7C(UnityEngine_GradientColorKey___TypeInfo, 2LL);
    v28.fields.r = 1.0;
    v28.fields.g = 1.0;
    v28.fields.b = 1.0;
    v28.fields.a = 1.0;
    ...
    if ( v9 )
    {
      ...
      *(struct UnityEngine_Color_o *)(v9 + 52) = color;
      v14 = sub_1C1AC7C(UnityEngine_GradientAlphaKey___TypeInfo, 2LL);
      ...
      {
LABEL_20:
        sub_1C1AE38(defaultGradient, v11);
      }
      *(_QWORD *)(v14 + 40) = v20;
...
LABEL_21:
    sub_1C1AE30(defaultGradient, v11);
  }
LABEL_17:
