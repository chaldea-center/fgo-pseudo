void __fastcall OutlineEffectSettings___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A1B6BC & 1) == 0 )
  {
    sub_1B715CC(&OutlineEffectSettings_TypeInfo, v1);
    byte_4A1B6BC = 1;
  }
  if ( !byte_4A1A751 )
  {
...
void __fastcall OutlineEffectSettings___ctor(OutlineEffectSettings_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1B6BB & 1) == 0 )
  {
    sub_1B715CC(&OutlineEffectSettings_TypeInfo, method);
    byte_4A1B6BB = 1;
  }
  *(_OWORD *)&this->fields.thickness = xmmword_BAA340;
  ...
  *(_OWORD *)&this->fields.fullscreenUVScaleX = xmmword_BABCB0;
  this->fields.gaussianSilhouetteR = (struct UnityEngine_Color_o)xmmword_BABF10;
  this->fields.gaussianSilhouetteG = (struct UnityEngine_Color_o)xmmword_BABE40;
  this->fields.gaussianSilhouetteB = (struct UnityEngine_Color_o)xmmword_BAA720;
  ...
  *(_OWORD *)&this->fields.gaussianBloomIntensity = xmmword_BAAEA0;
...
OutlineEffectSettings_o *__fastcall OutlineEffectSettings__get_Default(const MethodInfo *method)
{
  ...
  if ( (byte_4A1B6BA & 1) == 0 )
  {
    sub_1B715CC(&UnityEngine_Gradient_TypeInfo, v1);
    sub_1B715CC(&OutlineEffectSettings_TypeInfo, v2);
    sub_1B715CC(&Method_UnityEngine_ScriptableObject_CreateInstance_OutlineEffectSettings___, v3);
    byte_4A1B6BA = 1;
  }
  Instance_object = UnityEngine_ScriptableObject__CreateInstance_object_((const MethodInfo_2EF8D04 *)Method_UnityEngine_ScriptableObject_CreateInstance_OutlineEffectSettings___);
  v5 = (UnityEngine_Gradient_o *)sub_1B71818(UnityEngine_Gradient_TypeInfo);
  UnityEngine_Gradient___ctor(v5, 0LL);
  if ( !Instance_object )
    sub_1B71828(v6, v7);
  Instance_object[1].monitor = v5;
  sub_1B71570(&Instance_object[1].monitor);
  Instance_object[2] = (Il2CppObject)xmmword_BAA340;
  if ( !OutlineEffectSettings_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(OutlineEffectSettings_TypeInfo);
  if ( !byte_4A1B6DF )
  {
    sub_1B715CC(&OutlineEffectSettings_TypeInfo, v8);
    byte_4A1B6DF = 1;
  }
  ...
  *(_OWORD *)&Instance_object[4].monitor = xmmword_BABCB0;
  ...
  *(_OWORD *)&Instance_object[5].monitor = xmmword_BABF10;
  *(_OWORD *)&Instance_object[6].monitor = xmmword_BABE40;
  *(_OWORD *)&Instance_object[7].monitor = xmmword_BAA720;
  *(_OWORD *)&Instance_object[13].monitor = xmmword_BAAEA0;
...
UnityEngine_Gradient_o *__fastcall OutlineEffectSettings__get_DefaultGradient(const MethodInfo *method)
{
  ...
  if ( (byte_4A1B6B9 & 1) == 0 )
  {
    sub_1B715CC(&UnityEngine_GradientAlphaKey___TypeInfo, v1);
    sub_1B715CC(&UnityEngine_GradientColorKey___TypeInfo, v2);
    sub_1B715CC(&UnityEngine_Gradient_TypeInfo, v3);
  ...
  {
    v6 = (UnityEngine_Gradient_o *)sub_1B71818(UnityEngine_Gradient_TypeInfo);
    ...
    sub_1B71570(&static_fields->defaultGradient);
    v9 = sub_1B71674(UnityEngine_GradientColorKey___TypeInfo, 2LL);
    v28.fields.r = 1.0;
    v28.fields.g = 1.0;
    v28.fields.b = 1.0;
    v28.fields.a = 1.0;
    ...
    if ( v9 )
    {
      ...
      *(struct UnityEngine_Color_o *)(v9 + 52) = color;
      v14 = sub_1B71674(UnityEngine_GradientAlphaKey___TypeInfo, 2LL);
      ...
      {
LABEL_20:
        sub_1B71830(defaultGradient, v11);
      }
      *(_QWORD *)(v14 + 40) = v20;
...
LABEL_21:
    sub_1B71828(defaultGradient, v11);
  }
LABEL_17:
