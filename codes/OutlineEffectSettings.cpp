void __fastcall OutlineEffectSettings___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BB0181 & 1) == 0 )
  {
    sub_1C13D24(&OutlineEffectSettings_TypeInfo, v1);
    byte_4BB0181 = 1;
  }
  if ( !byte_4BAEDA1 )
  {
...
void __fastcall OutlineEffectSettings___ctor(OutlineEffectSettings_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB0180 & 1) == 0 )
  {
    sub_1C13D24(&OutlineEffectSettings_TypeInfo, method);
    byte_4BB0180 = 1;
  }
  *(_OWORD *)&this->fields.thickness = xmmword_BF5E00;
  ...
  *(_OWORD *)&this->fields.fullscreenUVScaleX = xmmword_BF7740;
  this->fields.gaussianSilhouetteR = (struct UnityEngine_Color_o)xmmword_BF79D0;
  this->fields.gaussianSilhouetteG = (struct UnityEngine_Color_o)xmmword_BF78F0;
  this->fields.gaussianSilhouetteB = (struct UnityEngine_Color_o)xmmword_BF61D0;
  ...
  *(_OWORD *)&this->fields.gaussianBloomIntensity = xmmword_BF6940;
...
OutlineEffectSettings_o *__fastcall OutlineEffectSettings__get_Default(const MethodInfo *method)
{
  ...
  if ( (byte_4BB017F & 1) == 0 )
  {
    sub_1C13D24(&UnityEngine_Gradient_TypeInfo, v1);
    sub_1C13D24(&OutlineEffectSettings_TypeInfo, v2);
    sub_1C13D24(&Method_UnityEngine_ScriptableObject_CreateInstance_OutlineEffectSettings___, v3);
    byte_4BB017F = 1;
  }
  Instance_object = UnityEngine_ScriptableObject__CreateInstance_object_((const MethodInfo_302EA64 *)Method_UnityEngine_ScriptableObject_CreateInstance_OutlineEffectSettings___);
  v5 = (UnityEngine_Gradient_o *)sub_1C13F70(UnityEngine_Gradient_TypeInfo);
  UnityEngine_Gradient___ctor(v5, 0LL);
  if ( !Instance_object )
    sub_1C13F80(v6, v7);
  Instance_object[1].monitor = v5;
  sub_1C13CC8(&Instance_object[1].monitor);
  Instance_object[2] = (Il2CppObject)xmmword_BF5E00;
  if ( !OutlineEffectSettings_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(OutlineEffectSettings_TypeInfo);
  if ( !byte_4BB01A4 )
  {
    sub_1C13D24(&OutlineEffectSettings_TypeInfo, v8);
    byte_4BB01A4 = 1;
  }
  ...
  *(_OWORD *)&Instance_object[4].monitor = xmmword_BF7740;
  ...
  *(_OWORD *)&Instance_object[5].monitor = xmmword_BF79D0;
  *(_OWORD *)&Instance_object[6].monitor = xmmword_BF78F0;
  *(_OWORD *)&Instance_object[7].monitor = xmmword_BF61D0;
  *(_OWORD *)&Instance_object[13].monitor = xmmword_BF6940;
...
UnityEngine_Gradient_o *__fastcall OutlineEffectSettings__get_DefaultGradient(const MethodInfo *method)
{
  ...
  if ( (byte_4BB017E & 1) == 0 )
  {
    sub_1C13D24(&UnityEngine_GradientAlphaKey___TypeInfo, v1);
    sub_1C13D24(&UnityEngine_GradientColorKey___TypeInfo, v2);
    sub_1C13D24(&UnityEngine_Gradient_TypeInfo, v3);
  ...
  {
    v6 = (UnityEngine_Gradient_o *)sub_1C13F70(UnityEngine_Gradient_TypeInfo);
    ...
    sub_1C13CC8(&static_fields->defaultGradient);
    v9 = sub_1C13DCC(UnityEngine_GradientColorKey___TypeInfo, 2LL);
    v28.fields.r = 1.0;
    v28.fields.g = 1.0;
    v28.fields.b = 1.0;
    v28.fields.a = 1.0;
    ...
    if ( v9 )
    {
      ...
      *(struct UnityEngine_Color_o *)(v9 + 52) = color;
      v14 = sub_1C13DCC(UnityEngine_GradientAlphaKey___TypeInfo, 2LL);
      ...
      {
LABEL_20:
        sub_1C13F88(defaultGradient, v11);
      }
      *(_QWORD *)(v14 + 40) = v20;
...
LABEL_21:
    sub_1C13F80(defaultGradient, v11);
  }
LABEL_17:
