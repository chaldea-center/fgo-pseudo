...
void OutlineEffectSettings___ctor(OutlineEffectSettings_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.thickness = xmmword_C08E30;
  ...
  *(_OWORD *)&this->fields.fullscreenUVScaleX = xmmword_C0A920;
  this->fields.gaussianSilhouetteR = (struct UnityEngine_Color_o)xmmword_C0ABD0;
  this->fields.gaussianSilhouetteG = (struct UnityEngine_Color_o)xmmword_C0AAE0;
  this->fields.gaussianSilhouetteB = (struct UnityEngine_Color_o)xmmword_C09250;
  ...
  *(_OWORD *)&this->fields.gaussianBloomIntensity = xmmword_C09A40;
...
OutlineEffectSettings_o *OutlineEffectSettings__get_Default(const MethodInfo *method)
{
  ...
  if ( (byte_4C22ADB & 1) == 0 )
  {
    sub_1C2D490(&UnityEngine_Gradient_TypeInfo);
    sub_1C2D490(&OutlineEffectSettings_TypeInfo);
    sub_1C2D490(&Method_UnityEngine_ScriptableObject_CreateInstance_OutlineEffectSettings___);
    byte_4C22ADB = 1;
  }
  Instance_object = UnityEngine_ScriptableObject__CreateInstance_object_((const MethodInfo_317589C *)Method_UnityEngine_ScriptableObject_CreateInstance_OutlineEffectSettings___);
  v2 = (UnityEngine_Gradient_o *)sub_1C2D6DC(UnityEngine_Gradient_TypeInfo);
  UnityEngine_Gradient___ctor(v2, 0);
  if ( !Instance_object )
    sub_1C2D6EC(v3, v4);
  Instance_object[1].monitor = v2;
  sub_1C2D434((CGThumbnailListItem_o *)&Instance_object[1].monitor, (int32_t)v2, v5, v6);
  Instance_object[2] = (Il2CppObject)xmmword_C08E30;
  if ( !OutlineEffectSettings_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(OutlineEffectSettings_TypeInfo);
  if ( !byte_4C22BA8 )
  {
  ...
  *(_OWORD *)&Instance_object[4].monitor = xmmword_C0A920;
  ...
  *(_OWORD *)&Instance_object[5].monitor = xmmword_C0ABD0;
  *(_OWORD *)&Instance_object[6].monitor = xmmword_C0AAE0;
  *(_OWORD *)&Instance_object[7].monitor = xmmword_C09250;
  *(_OWORD *)&Instance_object[13].monitor = xmmword_C09A40;
...
UnityEngine_Gradient_o *OutlineEffectSettings__get_DefaultGradient(const MethodInfo *method)
{
  ...
  if ( (byte_4C22ADA & 1) == 0 )
  {
    sub_1C2D490(&UnityEngine_GradientAlphaKey___TypeInfo);
    sub_1C2D490(&UnityEngine_GradientColorKey___TypeInfo);
    sub_1C2D490(&UnityEngine_Gradient_TypeInfo);
    sub_1C2D490(&OutlineEffectSettings_TypeInfo);
    byte_4C22ADA = 1;
  }
  ...
  if ( !v1->static_fields->defaultGradient )
  {
    ...
    sub_1C2D434((CGThumbnailListItem_o *)&static_fields->defaultGradient, (int32_t)v2, v3, v4);
    v7 = sub_1C2D538(UnityEngine_GradientColorKey___TypeInfo, 2);
    v27.fields.r = 1.0;
    v27.fields.g = 1.0;
    v27.fields.b = 1.0;
    v27.fields.a = 1.0;
    memset(&method_80, 0, sizeof(method_80));
    UnityEngine_GradientColorKey___ctor(&method_80, v27, 0.0, 0);
    if ( v7 )
    {
      method_56 = method_80;
      if ( !*(_DWORD *)(v7 + 24) )
      ...
      *(float *)(v7 + 48) = time;
      ...
      UnityEngine_GradientColorKey___ctor(&method_32, v28, 1.0, 0);
      method_8 = method_32;
      if ( *(_DWORD *)(v7 + 24) <= 1u )
        goto LABEL_20;
      ...
      *(struct UnityEngine_Color_o *)(v7 + 52) = color;
      v13 = sub_1C2D538(UnityEngine_GradientAlphaKey___TypeInfo, 2);
      v25.fields.alpha = 1.0;
      v25.fields.time = 0.0;
      methoda = 0;
      UnityEngine_GradientAlphaKey___ctor(v25, v14, v15, (const MethodInfo *)&methoda);
      if ( !v13 )
        goto LABEL_21;
      if ( !*(_DWORD *)(v13 + 24)
        || (v26.fields.time = 1.0,
            *(_QWORD *)(v13 + 32) = methoda,
            v26.fields.alpha = 1.0,
            v19 = 0,
            UnityEngine_GradientAlphaKey___ctor(v26, v16, v17, (const MethodInfo *)&v19),
            *(_DWORD *)(v13 + 24) <= 1u) )
      {
LABEL_20:
        sub_1C2D6F4(defaultGradient, v9, v10);
      }
      *(_QWORD *)(v13 + 40) = v19;
      ...
      if ( defaultGradient )
      {
        ...
        if ( defaultGradient )
        {
          UnityEngine_Gradient__set_alphaKeys(defaultGradient, (UnityEngine_GradientAlphaKey_array *)v13, 0);
          v1 = OutlineEffectSettings_TypeInfo;
          goto LABEL_17;
        }
      }
...
LABEL_21:
    sub_1C2D6EC(defaultGradient, v9);
  }
LABEL_17:
