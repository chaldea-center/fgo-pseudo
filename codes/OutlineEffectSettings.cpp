void __fastcall OutlineEffectSettings___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B32CDB & 1) == 0 )
  {
    sub_1BD3458(&OutlineEffectSettings_TypeInfo, v1);
    byte_4B32CDB = 1;
  }
  if ( !byte_4B31941 )
  {
...
void __fastcall OutlineEffectSettings___ctor(OutlineEffectSettings_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B32CDA & 1) == 0 )
  {
    sub_1BD3458(&OutlineEffectSettings_TypeInfo, method);
    byte_4B32CDA = 1;
  }
  *(_OWORD *)&this->fields.thickness = xmmword_BD74B0;
  ...
  *(_OWORD *)&this->fields.fullscreenUVScaleX = xmmword_BD8DF0;
  this->fields.gaussianSilhouetteR = (struct UnityEngine_Color_o)xmmword_BD9080;
  this->fields.gaussianSilhouetteG = (struct UnityEngine_Color_o)xmmword_BD8FA0;
  this->fields.gaussianSilhouetteB = (struct UnityEngine_Color_o)xmmword_BD7880;
  ...
  *(_OWORD *)&this->fields.gaussianBloomIntensity = xmmword_BD7FF0;
...
OutlineEffectSettings_o *__fastcall OutlineEffectSettings__get_Default(const MethodInfo *method)
{
  ...
  if ( (byte_4B32CD9 & 1) == 0 )
  {
    sub_1BD3458(&UnityEngine_Gradient_TypeInfo, v1);
    sub_1BD3458(&OutlineEffectSettings_TypeInfo, v2);
    sub_1BD3458(&Method_UnityEngine_ScriptableObject_CreateInstance_OutlineEffectSettings___, v3);
    byte_4B32CD9 = 1;
  }
  Instance_object = UnityEngine_ScriptableObject__CreateInstance_object_((const MethodInfo_2FD0904 *)Method_UnityEngine_ScriptableObject_CreateInstance_OutlineEffectSettings___);
  v5 = (UnityEngine_Gradient_o *)sub_1BD36A4(UnityEngine_Gradient_TypeInfo);
  UnityEngine_Gradient___ctor(v5, 0LL);
  if ( !Instance_object )
    sub_1BD36B4(v6, v7);
  Instance_object[1].monitor = v5;
  sub_1BD33FC(&Instance_object[1].monitor);
  Instance_object[2] = (Il2CppObject)xmmword_BD74B0;
  if ( !OutlineEffectSettings_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(OutlineEffectSettings_TypeInfo);
  if ( !byte_4B32CFE )
  {
    sub_1BD3458(&OutlineEffectSettings_TypeInfo, v8);
    byte_4B32CFE = 1;
  }
  ...
  *(_OWORD *)&Instance_object[4].monitor = xmmword_BD8DF0;
  ...
  *(_OWORD *)&Instance_object[5].monitor = xmmword_BD9080;
  *(_OWORD *)&Instance_object[6].monitor = xmmword_BD8FA0;
  *(_OWORD *)&Instance_object[7].monitor = xmmword_BD7880;
  *(_OWORD *)&Instance_object[13].monitor = xmmword_BD7FF0;
...
UnityEngine_Gradient_o *__fastcall OutlineEffectSettings__get_DefaultGradient(const MethodInfo *method)
{
  ...
  if ( (byte_4B32CD8 & 1) == 0 )
  {
    sub_1BD3458(&UnityEngine_GradientAlphaKey___TypeInfo, v1);
    sub_1BD3458(&UnityEngine_GradientColorKey___TypeInfo, v2);
    sub_1BD3458(&UnityEngine_Gradient_TypeInfo, v3);
  ...
  {
    v6 = (UnityEngine_Gradient_o *)sub_1BD36A4(UnityEngine_Gradient_TypeInfo);
    ...
    sub_1BD33FC(&static_fields->defaultGradient);
    v9 = sub_1BD3500(UnityEngine_GradientColorKey___TypeInfo, 2LL);
    v28.fields.r = 1.0;
    v28.fields.g = 1.0;
    v28.fields.b = 1.0;
    v28.fields.a = 1.0;
    ...
    if ( v9 )
    {
      ...
      *(struct UnityEngine_Color_o *)(v9 + 52) = color;
      v14 = sub_1BD3500(UnityEngine_GradientAlphaKey___TypeInfo, 2LL);
      ...
      {
LABEL_20:
        sub_1BD36BC(defaultGradient, v11);
      }
      *(_QWORD *)(v14 + 40) = v20;
...
LABEL_21:
    sub_1BD36B4(defaultGradient, v11);
  }
LABEL_17:
