...
void __fastcall OutlineEffectSettings___ctor(OutlineEffectSettings_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.thickness = xmmword_BB3E80;
  ...
  *(_OWORD *)&this->fields.fullscreenUVScaleX = xmmword_BB57F0;
  this->fields.gaussianSilhouetteR = (struct UnityEngine_Color_o)xmmword_BB5A60;
  this->fields.gaussianSilhouetteG = (struct UnityEngine_Color_o)xmmword_BB5990;
  this->fields.gaussianSilhouetteB = (struct UnityEngine_Color_o)xmmword_BB4260;
  ...
  *(_OWORD *)&this->fields.gaussianBloomIntensity = xmmword_BB49E0;
...
OutlineEffectSettings_o *__fastcall OutlineEffectSettings__get_Default(const MethodInfo *method)
{
  ...
  if ( (byte_4A56E6F & 1) == 0 )
  {
    sub_1B885B0(&UnityEngine_Gradient_TypeInfo);
    sub_1B885B0(&OutlineEffectSettings_TypeInfo);
    sub_1B885B0(&Method_UnityEngine_ScriptableObject_CreateInstance_OutlineEffectSettings___);
    byte_4A56E6F = 1;
  }
  Instance_object = UnityEngine_ScriptableObject__CreateInstance_object_((const MethodInfo_2F1D33C *)Method_UnityEngine_ScriptableObject_CreateInstance_OutlineEffectSettings___);
  v2 = (UnityEngine_Gradient_o *)sub_1B887FC(UnityEngine_Gradient_TypeInfo);
  UnityEngine_Gradient___ctor(v2, 0LL);
  if ( !Instance_object )
    sub_1B8880C(v3, v4);
  Instance_object[1].monitor = v2;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&Instance_object[1].monitor, (int32_t)v2, v5, v6);
  Instance_object[2] = (Il2CppObject)xmmword_BB3E80;
  if ( !OutlineEffectSettings_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(OutlineEffectSettings_TypeInfo);
  if ( !byte_4A56E94 )
  {
  ...
  *(_OWORD *)&Instance_object[4].monitor = xmmword_BB57F0;
  ...
  *(_OWORD *)&Instance_object[5].monitor = xmmword_BB5A60;
  *(_OWORD *)&Instance_object[6].monitor = xmmword_BB5990;
  *(_OWORD *)&Instance_object[7].monitor = xmmword_BB4260;
  *(_OWORD *)&Instance_object[13].monitor = xmmword_BB49E0;
...
UnityEngine_Gradient_o *__fastcall OutlineEffectSettings__get_DefaultGradient(const MethodInfo *method)
{
  ...
  if ( (byte_4A56E6E & 1) == 0 )
  {
    sub_1B885B0(&UnityEngine_GradientAlphaKey___TypeInfo);
    sub_1B885B0(&UnityEngine_GradientColorKey___TypeInfo);
    sub_1B885B0(&UnityEngine_Gradient_TypeInfo);
    sub_1B885B0(&OutlineEffectSettings_TypeInfo);
    byte_4A56E6E = 1;
  }
  ...
  if ( !v1->static_fields->defaultGradient )
  {
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)&static_fields->defaultGradient, (int32_t)v2, v3, v4);
    v7 = sub_1B88658(UnityEngine_GradientColorKey___TypeInfo, 2LL);
    v26.fields.r = 1.0;
    v26.fields.g = 1.0;
    v26.fields.b = 1.0;
    v26.fields.a = 1.0;
    memset(&method_80, 0, sizeof(method_80));
    UnityEngine_GradientColorKey___ctor(&method_80, v26, 0.0, 0LL);
    if ( v7 )
    {
      method_56 = method_80;
      if ( !*(_DWORD *)(v7 + 24) )
      ...
      *(float *)(v7 + 48) = time;
      ...
      UnityEngine_GradientColorKey___ctor(&method_32, v27, 1.0, 0LL);
      method_8 = method_32;
      if ( *(_DWORD *)(v7 + 24) <= 1u )
        goto LABEL_20;
      ...
      *(struct UnityEngine_Color_o *)(v7 + 52) = color;
      v12 = sub_1B88658(UnityEngine_GradientAlphaKey___TypeInfo, 2LL);
      ...
      {
LABEL_20:
        sub_1B88814(defaultGradient, v9);
      }
      *(_QWORD *)(v12 + 40) = v18;
      defaultGradient = OutlineEffectSettings_TypeInfo->static_fields->defaultGradient;
      if ( defaultGradient )
      {
        UnityEngine_Gradient__set_colorKeys(defaultGradient, (UnityEngine_GradientColorKey_array *)v7, 0LL);
        defaultGradient = OutlineEffectSettings_TypeInfo->static_fields->defaultGradient;
        if ( defaultGradient )
        {
          UnityEngine_Gradient__set_alphaKeys(defaultGradient, (UnityEngine_GradientAlphaKey_array *)v12, 0LL);
          v1 = OutlineEffectSettings_TypeInfo;
          goto LABEL_17;
        }
      }
...
LABEL_21:
    sub_1B8880C(defaultGradient, v9);
  }
LABEL_17:
