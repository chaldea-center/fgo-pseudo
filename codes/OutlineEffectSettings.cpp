void __fastcall OutlineEffectSettings___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB1937 & 1) == 0 )
  {
    sub_1BAB41C(&OutlineEffectSettings_TypeInfo, v1);
    byte_4AB1937 = 1;
  }
  if ( !byte_4AB0691 )
  {
...
void __fastcall OutlineEffectSettings___ctor(OutlineEffectSettings_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB1936 & 1) == 0 )
  {
    sub_1BAB41C(&OutlineEffectSettings_TypeInfo, method);
    byte_4AB1936 = 1;
  }
  *(_OWORD *)&this->fields.thickness = xmmword_BC2990;
  ...
  *(_OWORD *)&this->fields.fullscreenUVScaleX = xmmword_BC4320;
  this->fields.gaussianSilhouetteR = (struct UnityEngine_Color_o)xmmword_BC4590;
  this->fields.gaussianSilhouetteG = (struct UnityEngine_Color_o)xmmword_BC44C0;
  this->fields.gaussianSilhouetteB = (struct UnityEngine_Color_o)xmmword_BC2D70;
  ...
  *(_OWORD *)&this->fields.gaussianBloomIntensity = xmmword_BC3500;
...
OutlineEffectSettings_o *__fastcall OutlineEffectSettings__get_Default(const MethodInfo *method)
{
  ...
  if ( (byte_4AB1935 & 1) == 0 )
  {
    sub_1BAB41C(&UnityEngine_Gradient_TypeInfo, v1);
    sub_1BAB41C(&OutlineEffectSettings_TypeInfo, v2);
    sub_1BAB41C(&Method_UnityEngine_ScriptableObject_CreateInstance_OutlineEffectSettings___, v3);
    byte_4AB1935 = 1;
  }
  Instance_object = UnityEngine_ScriptableObject__CreateInstance_object_((const MethodInfo_2F61FB8 *)Method_UnityEngine_ScriptableObject_CreateInstance_OutlineEffectSettings___);
  v5 = (UnityEngine_Gradient_o *)sub_1BAB668(UnityEngine_Gradient_TypeInfo);
  UnityEngine_Gradient___ctor(v5, 0LL);
  if ( !Instance_object )
    sub_1BAB678(v6, v7);
  Instance_object[1].monitor = v5;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&Instance_object[1].monitor, (int32_t)v5, v8, v9);
  Instance_object[2] = (Il2CppObject)xmmword_BC2990;
  if ( !OutlineEffectSettings_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(OutlineEffectSettings_TypeInfo);
  if ( !byte_4AB195A )
  {
    sub_1BAB41C(&OutlineEffectSettings_TypeInfo, v10);
    byte_4AB195A = 1;
  }
  ...
  *(_OWORD *)&Instance_object[4].monitor = xmmword_BC4320;
  ...
  *(_OWORD *)&Instance_object[5].monitor = xmmword_BC4590;
  *(_OWORD *)&Instance_object[6].monitor = xmmword_BC44C0;
  *(_OWORD *)&Instance_object[7].monitor = xmmword_BC2D70;
  *(_OWORD *)&Instance_object[13].monitor = xmmword_BC3500;
...
UnityEngine_Gradient_o *__fastcall OutlineEffectSettings__get_DefaultGradient(const MethodInfo *method)
{
  ...
  if ( (byte_4AB1934 & 1) == 0 )
  {
    sub_1BAB41C(&UnityEngine_GradientAlphaKey___TypeInfo, v1);
    sub_1BAB41C(&UnityEngine_GradientColorKey___TypeInfo, v2);
    sub_1BAB41C(&UnityEngine_Gradient_TypeInfo, v3);
  ...
  {
    v6 = (UnityEngine_Gradient_o *)sub_1BAB668(UnityEngine_Gradient_TypeInfo);
    ...
    sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&static_fields->defaultGradient, (int32_t)v6, v7, v8);
    v11 = sub_1BAB4C4(UnityEngine_GradientColorKey___TypeInfo, 2LL);
    v30.fields.r = 1.0;
    v30.fields.g = 1.0;
    v30.fields.b = 1.0;
    v30.fields.a = 1.0;
    ...
    if ( v11 )
    {
      ...
      *(struct UnityEngine_Color_o *)(v11 + 52) = color;
      v16 = sub_1BAB4C4(UnityEngine_GradientAlphaKey___TypeInfo, 2LL);
      ...
      {
LABEL_20:
        sub_1BAB680(defaultGradient, v13);
      }
      *(_QWORD *)(v16 + 40) = v22;
...
LABEL_21:
    sub_1BAB678(defaultGradient, v13);
  }
LABEL_17:
