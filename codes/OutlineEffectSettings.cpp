void __fastcall OutlineEffectSettings___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B6267D & 1) == 0 )
  {
    sub_1BE4ACC(&OutlineEffectSettings_TypeInfo, v1);
    byte_4B6267D = 1;
  }
  if ( !byte_4B612E1 )
  {
...
void __fastcall OutlineEffectSettings___ctor(OutlineEffectSettings_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6267C & 1) == 0 )
  {
    sub_1BE4ACC(&OutlineEffectSettings_TypeInfo, method);
    byte_4B6267C = 1;
  }
  *(_OWORD *)&this->fields.thickness = xmmword_BE15E0;
  ...
  *(_OWORD *)&this->fields.fullscreenUVScaleX = xmmword_BE2F20;
  this->fields.gaussianSilhouetteR = (struct UnityEngine_Color_o)xmmword_BE31B0;
  this->fields.gaussianSilhouetteG = (struct UnityEngine_Color_o)xmmword_BE30D0;
  this->fields.gaussianSilhouetteB = (struct UnityEngine_Color_o)xmmword_BE19B0;
  ...
  *(_OWORD *)&this->fields.gaussianBloomIntensity = xmmword_BE2120;
...
OutlineEffectSettings_o *__fastcall OutlineEffectSettings__get_Default(const MethodInfo *method)
{
  ...
  if ( (byte_4B6267B & 1) == 0 )
  {
    sub_1BE4ACC(&UnityEngine_Gradient_TypeInfo, v1);
    sub_1BE4ACC(&OutlineEffectSettings_TypeInfo, v2);
    sub_1BE4ACC(&Method_UnityEngine_ScriptableObject_CreateInstance_OutlineEffectSettings___, v3);
    byte_4B6267B = 1;
  }
  Instance_object = UnityEngine_ScriptableObject__CreateInstance_object_((const MethodInfo_2FF86C4 *)Method_UnityEngine_ScriptableObject_CreateInstance_OutlineEffectSettings___);
  v5 = (UnityEngine_Gradient_o *)sub_1BE4D18(UnityEngine_Gradient_TypeInfo);
  UnityEngine_Gradient___ctor(v5, 0LL);
  if ( !Instance_object )
    sub_1BE4D28(v6, v7);
  Instance_object[1].monitor = v5;
  sub_1BE4A70(&Instance_object[1].monitor);
  Instance_object[2] = (Il2CppObject)xmmword_BE15E0;
  if ( !OutlineEffectSettings_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(OutlineEffectSettings_TypeInfo);
  if ( !byte_4B626A0 )
  {
    sub_1BE4ACC(&OutlineEffectSettings_TypeInfo, v8);
    byte_4B626A0 = 1;
  }
  ...
  *(_OWORD *)&Instance_object[4].monitor = xmmword_BE2F20;
  ...
  *(_OWORD *)&Instance_object[5].monitor = xmmword_BE31B0;
  *(_OWORD *)&Instance_object[6].monitor = xmmword_BE30D0;
  *(_OWORD *)&Instance_object[7].monitor = xmmword_BE19B0;
  *(_OWORD *)&Instance_object[13].monitor = xmmword_BE2120;
...
UnityEngine_Gradient_o *__fastcall OutlineEffectSettings__get_DefaultGradient(const MethodInfo *method)
{
  ...
  if ( (byte_4B6267A & 1) == 0 )
  {
    sub_1BE4ACC(&UnityEngine_GradientAlphaKey___TypeInfo, v1);
    sub_1BE4ACC(&UnityEngine_GradientColorKey___TypeInfo, v2);
    sub_1BE4ACC(&UnityEngine_Gradient_TypeInfo, v3);
  ...
  {
    v6 = (UnityEngine_Gradient_o *)sub_1BE4D18(UnityEngine_Gradient_TypeInfo);
    ...
    sub_1BE4A70(&static_fields->defaultGradient);
    v9 = sub_1BE4B74(UnityEngine_GradientColorKey___TypeInfo, 2LL);
    v28.fields.r = 1.0;
    v28.fields.g = 1.0;
    v28.fields.b = 1.0;
    v28.fields.a = 1.0;
    ...
    if ( v9 )
    {
      ...
      *(struct UnityEngine_Color_o *)(v9 + 52) = color;
      v14 = sub_1BE4B74(UnityEngine_GradientAlphaKey___TypeInfo, 2LL);
      ...
      {
LABEL_20:
        sub_1BE4D30(defaultGradient, v11);
      }
      *(_QWORD *)(v14 + 40) = v20;
...
LABEL_21:
    sub_1BE4D28(defaultGradient, v11);
  }
LABEL_17:
