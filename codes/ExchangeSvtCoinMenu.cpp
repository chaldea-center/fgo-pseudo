...
void ExchangeSvtCoinMenu__CloseFolder(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C328E2 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_ExchangeSvtCoinMenu__CloseFolder_b__33_0__);
    byte_4C328E2 = 1;
  }
  ...
  {
    sub_1C32E7C(filterButton);
  }
  ShopBuyItemListViewManager__SetMode_35110032(buyItemListViewManager, 4, v6, 0.1, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Behaviour__get_isActiveAndEnabled((UnityEngine_Behaviour_o *)selectMenu, 0) )
  {
    ...
    if ( !selectMenu )
      goto LABEL_10;
    ShopBuyItemConfirmMenu__Close_35062804(selectMenu, callback, 0);
  }
  selectMenu = (ShopBuyItemConfirmMenu_o *)this->fields.bulkSelectMenu;
  if ( !selectMenu )
LABEL_10:
    sub_1C32E7C(selectMenu);
  if ( UnityEngine_Behaviour__get_isActiveAndEnabled((UnityEngine_Behaviour_o *)selectMenu, 0) )
  {
    selectMenu = (ShopBuyItemConfirmMenu_o *)this->fields.bulkSelectMenu;
    if ( selectMenu )
    {
      ShopBuyBulkItemConfirmMenu__Close_45182660((ShopBuyBulkItemConfirmMenu_o *)selectMenu, callback, 0);
      goto LABEL_9;
    }
    goto LABEL_10;
  }
...
void ExchangeSvtCoinMenu__CreateFolderList(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C328F2 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_ExchangeSvtCoinMenu_OnClickFolder__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C328EC & 1) == 0 )
  {
    sub_1C32C20(&Method_DataManager_GetMaster_UserItemMaster___);
    sub_1C32C20(&DataManager_TypeInfo);
    this = (ExchangeSvtCoinMenu_o *)sub_1C32C20(&NetworkManager_TypeInfo);
    byte_4C328EC = 1;
  }
  if ( !item )
    goto LABEL_22;
...
void ExchangeSvtCoinMenu__Init(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  {
LABEL_9:
    sub_1C32E7C(svtCoinFolderListScrollBar);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)svtCoinFolderListScrollBar, 0, 0);
...
void ExchangeSvtCoinMenu__InitFolderList(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C328F1 & 1) == 0 )
  {
    this = (ExchangeSvtCoinMenu_o *)sub_1C32C20(&UnityEngine_Object_TypeInfo);
    byte_4C328F1 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C328ED & 1) == 0 )
  {
    ...
    this = (ExchangeSvtCoinMenu_o *)sub_1C32C20(&StringLiteral_5774/*"EXCHANGE_SVT_COIN_RESULT_DIALOG_MSG"*/);
    byte_4C328ED = 1;
  }
  if ( !item )
    goto LABEL_8;
...
LABEL_8:
  ...
  v11 = LocalizationManager__Get((System_String_o *)StringLiteral_5774/*"EXCHANGE_SVT_COIN_RESULT_DIALOG_MSG"*/, 0);
  return System_String__Format_63559836(v11, v9, NumberFormat, 0);
}
...
void ExchangeSvtCoinMenu__OnAlertDecide(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C32C20(&System_Action_TypeInfo);
    sub_1C32C20(&Method_ExchangeSvtCoinMenu_OnConfirmCancel__);
    sub_1C32C20(&Method_ExchangeSvtCoinMenu_OnConfirmDecide__);
    byte_4C328E8 = 1;
  }
  buyItemListViewManager = this->fields.buyItemListViewManager;
...
void ExchangeSvtCoinMenu__OnClickFolder(ExchangeSvtCoinMenu_o *this, int32_t svtCoinType, const MethodInfo *method)
{
  ...
  {
    sub_1C32C20(&Method_ExchangeSvtCoinMenu_OnClickFolder__);
    sub_1C32C20(&StringLiteral_13189/*"SvtCoinType"*/);
    sub_1C32C20(&StringLiteral_3456/*"CLICK_EXCHANGE_SVT_COIN_LIST"*/);
    byte_4C328E0 = 1;
  }
  v5 = Method_ExchangeSvtCoinMenu_OnClickFolder__;
  if ( (*((_BYTE *)Method_ExchangeSvtCoinMenu_OnClickFolder__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1C32C38(Method_ExchangeSvtCoinMenu_OnClickFolder__);
  ...
  if ( !myRoomFsm
    ...
    || (myRoomFsm = (PlayMakerFSM_o *)HutongGames_PlayMaker_FsmVariables__GetFsmInt(
                                        ...
                                        (System_String_o *)StringLiteral_13189/*"SvtCoinType"*/,
                                        0)) == 0
...
void ExchangeSvtCoinMenu__OnConfirmCancel(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C32C20(&System_Action_int__TypeInfo);
    sub_1C32C20(&Method_ExchangeSvtCoinMenu_OnPreConfirm__);
    byte_4C328E9 = 1;
  }
...
void ExchangeSvtCoinMenu__OnPreConfirm(ExchangeSvtCoinMenu_o *this, int32_t cnt, const MethodInfo *method)
{
  ...
  {
    sub_1C32C20(&System_Action_TypeInfo);
    sub_1C32C20(&Method_ExchangeSvtCoinMenu_OnAlertDecide__);
    sub_1C32C20(&Method_ExchangeSvtCoinMenu_OnConfirmCancel__);
    sub_1C32C20(&Method_ExchangeSvtCoinMenu_OnConfirmDecide__);
    byte_4C328E7 = 1;
  }
...
void ExchangeSvtCoinMenu__OnResultDecide(ExchangeSvtCoinMenu_o *this, bool isOk, const MethodInfo *method)
{
  ...
  if ( (byte_4C328EA & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_DataManager_GetMaster_UserItemMaster___);
    sub_1C32C20(&DataManager_TypeInfo);
    sub_1C32C20(&Method_ExchangeSvtCoinMenu__OnResultDecide_b__42_0__);
    sub_1C32C20(&LocalizationManager_TypeInfo);
    sub_1C32C20(&NetworkManager_TypeInfo);
    sub_1C32C20(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1C32C20(&string_TypeInfo);
    sub_1C32C20(&StringLiteral_5754/*"EXCHANGE_SVT_COIN_COMPLETE_DIALOG_MSG"*/);
    byte_4C328EA = 1;
  }
  ...
  for ( i = 0; ; ++i )
  {
    ...
    if ( i >= LODWORD(ExchangeSvtCoinItemIds->max_length) )
      sub_1C32E84(requestResultDialog);
    if ( !Master_object )
      goto LABEL_29;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v12 = LocalizationManager__Get((System_String_o *)StringLiteral_5754/*"EXCHANGE_SVT_COIN_COMPLETE_DIALOG_MSG"*/, 0);
...
void ExchangeSvtCoinMenu__OnSelectBuyItem(ExchangeSvtCoinMenu_o *this, int32_t selectItemNum, const MethodInfo *method)
{
  ...
  if ( (byte_4C328E5 & 1) == 0 )
  {
    sub_1C32C20(&Method_ExchangeSvtCoinMenu_OnSelectBuyItem__);
    ...
    sub_1C32C20(&Method_ExchangeSvtCoinMenu___c__DisplayClass36_0__OnSelectBuyItem_b__0__);
    sub_1C32C20(&ExchangeSvtCoinMenu___c__DisplayClass36_0_TypeInfo);
    byte_4C328E5 = 1;
  }
  v5 = sub_1C32E6C(ExchangeSvtCoinMenu___c__DisplayClass36_0_TypeInfo);
  ...
  *(_DWORD *)(v5 + 24) = selectItemNum;
  ...
  if ( (*((_BYTE *)Method_ExchangeSvtCoinMenu_OnSelectBuyItem__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1C32C38(Method_ExchangeSvtCoinMenu_OnSelectBuyItem__);
...
void ExchangeSvtCoinMenu__Open(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C32C20(&System_Action_TypeInfo);
    sub_1C32C20(&Method_ExchangeSvtCoinMenu__Open_b__30_0__);
    sub_1C32C20(&Method_UnityEngine_GameObject_GetComponent_TweenPosition___);
    sub_1C32C20(&LocalizationManager_TypeInfo);
    sub_1C32C20(&UnityEngine_Object_TypeInfo);
    sub_1C32C20(&StringLiteral_5758/*"EXCHANGE_SVT_COIN_CURRENCY_TITLE_SR"*/);
    sub_1C32C20(&StringLiteral_5759/*"EXCHANGE_SVT_COIN_CURRENCY_TITLE_SSR"*/);
    byte_4C328DF = 1;
  }
  filterButton = this->fields.filterButton;
  if ( !filterButton )
  ...
  if ( UnityEngine_Object__op_Inequality(currencyTitleLabel, 0, 0) )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(currencyTitleLabel2, 0, 0) )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      filterButton = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5759/*"EXCHANGE_SVT_COIN_CURRENCY_TITLE_SSR"*/, 0);
      if ( !v8 )
        goto LABEL_27;
      UILabel__set_text(v8, (System_String_o *)filterButton, 0);
      v9 = this->fields.currencyTitleLabel2;
      filterButton = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5758/*"EXCHANGE_SVT_COIN_CURRENCY_TITLE_SR"*/, 0);
      if ( !v9 )
        goto LABEL_27;
...
void ExchangeSvtCoinMenu__OpenFolder(ExchangeSvtCoinMenu_o *this, int32_t svtCoinType, const MethodInfo *method)
{
  ...
  {
    sub_1C32C20(&System_Action_TypeInfo);
    sub_1C32C20(&Method_ExchangeSvtCoinMenu__OpenFolder_b__32_0__);
    byte_4C328E1 = 1;
  }
...
LABEL_9:
  ...
  ShopBuyItemListViewManager__SetMode_35110032(v6, 1, v7, 0.1, 0);
}
...
void ExchangeSvtCoinMenu__OpenRequestResultDialog(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C328EE & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_ExchangeSvtCoinMenu_OnResultDecide__);
    byte_4C328EE = 1;
  }
  buyItemListViewManager = this->fields.buyItemListViewManager;
  if ( !buyItemListViewManager )
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  buyItemListViewManager = (ShopBuyItemListViewManager_o *)DataManager__GetMaster_object_((const MethodInfo_30DD39C *)Method_DataManager_GetMaster_ItemMaster___);
  if ( !dragParentObject )
    goto LABEL_13;
...
void ExchangeSvtCoinMenu__OpenSelectMenu(ExchangeSvtCoinMenu_o *this, int32_t selectItemNum, const MethodInfo *method)
{
  ...
  if ( (byte_4C328E6 & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_15925/*"[FFFF00]{0}"*/);
    sub_1C32C20(&StringLiteral_5773/*"EXCHANGE_SVT_COIN_NOTICE_TEXT"*/);
    byte_4C328E6 = 1;
  }
  buyItemListViewManager = this->fields.buyItemListViewManager;
  if ( !buyItemListViewManager )
  ...
  if ( v9 <= 0 )
  {
    ...
    v17 = (System_String_o *)StringLiteral_15925/*"[FFFF00]{0}"*/;
  }
  else
  {
    v30 = v9;
    v16 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v30, v10, v11, v12, v13, v14, v15);
    v17 = (System_String_o *)StringLiteral_25096/*"{0}"*/;
  }
  v18 = (Il2CppObject *)System_String__Format(v17, v16, 0);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v19 = LocalizationManager__Get((System_String_o *)StringLiteral_5773/*"EXCHANGE_SVT_COIN_NOTICE_TEXT"*/, 0);
...
void ExchangeSvtCoinMenu__RefreshInfo(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( !buyItemListViewManager
    ...
    || (ShopBuyItemListViewManager__SetMode_35108752((ShopBuyItemListViewManager_o *)buyItemListViewManager, 5, 0),
...
void ExchangeSvtCoinMenu__RequestShop(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C328EF & 1) == 0 )
  {
    sub_1C32C20(&Method_ExchangeSvtCoinMenu_EndRequestShop__);
...
void ExchangeSvtCoinMenu__SetCurrencyInfo(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  v4 = DataManager__GetMaster_object_((const MethodInfo_30DD39C *)Method_DataManager_GetMaster_UserItemMaster___);
  for ( i = 0; ; ++i )
  {
...
void ExchangeSvtCoinMenu___CloseFolder_b__33_0(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  PlayMakerFSM__SendEvent((PlayMakerFSM_o *)buyItemListViewManager, (System_String_o *)StringLiteral_6978/*"GO_NEXT"*/, 0);
}
...
void ExchangeSvtCoinMenu___OnResultDecide_b__42_0(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C328F6 & 1) == 0 )
  {
    sub_1C32C20(&StringLiteral_4986/*"DESTROY_EXCHANGE_SVT_COIN"*/);
    byte_4C328F6 = 1;
  }
  ExchangeSvtCoinMenu__SetDispCurrencyInfo(this, 0, v2);
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    sub_1C32E7C(0);
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_4986/*"DESTROY_EXCHANGE_SVT_COIN"*/, 0);
}
