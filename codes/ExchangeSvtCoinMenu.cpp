...
void __fastcall ExchangeSvtCoinMenu__CloseFolder(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (qword_4AFD000 & 0x100000000LL) == 0 )
  {
    sub_1BC3008(&System_Action_TypeInfo, method);
    sub_1BC3008(&Method_ExchangeSvtCoinMenu__CloseFolder_b__33_0__, v3);
    BYTE4(qword_4AFD000) = 1;
  }
  ...
  {
    sub_1BC3264(filterButton, method);
  }
  ShopBuyItemListViewManager__SetMode_34293348(buyItemListViewManager, 4, v7, 0.1, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Behaviour__get_isActiveAndEnabled((UnityEngine_Behaviour_o *)selectMenu, 0LL) )
  {
    ...
    if ( !selectMenu )
      goto LABEL_10;
    ShopBuyItemConfirmMenu__Close_34251196(selectMenu, callback, 0LL);
  }
  selectMenu = (ShopBuyItemConfirmMenu_o *)this->fields.bulkSelectMenu;
  if ( !selectMenu )
LABEL_10:
    sub_1BC3264(selectMenu, callback);
  if ( UnityEngine_Behaviour__get_isActiveAndEnabled((UnityEngine_Behaviour_o *)selectMenu, 0LL) )
  {
    selectMenu = (ShopBuyItemConfirmMenu_o *)this->fields.bulkSelectMenu;
    if ( selectMenu )
    {
      ShopBuyBulkItemConfirmMenu__Close_44225920((ShopBuyBulkItemConfirmMenu_o *)selectMenu, callback, 0LL);
      goto LABEL_9;
    }
    goto LABEL_10;
  }
...
void __fastcall ExchangeSvtCoinMenu__CreateFolderList(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  struct ExchangeSvtCoinFolderControl_array *v22; // x8
  ExchangeSvtCoinFolderControl_o *v23; // x22
  System_Action_int__o *v24; // x23
  const MethodInfo *v25; // x3
  struct ExchangeSvtCoinFolderControl_array *v26; // x21
  __int64 v27; // x8
  ...
  if ( (byte_4AFD014 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_ExchangeSvtCoinMenu_OnClickFolder__, v6);
  ...
  if ( this->fields.svtCoinFolderList )
  {
    ...
    if ( (int)namespaze >= 1 )
    {
      v16 = 0;
      v17 = 0LL;
      while ( v17 < (unsigned int)namespaze )
      {
        ...
        if ( v16 < max_length )
        {
          if ( v16 >= (unsigned int)max_length )
            break;
          v20 = *((_DWORD *)&klass->_1.byval_arg.data + v17);
          v21 = (UnityEngine_Object_o *)svtCoinFolderList->m_Items[v16];
          if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
          EntityDefinitely = (UIProgressBar_o *)UnityEngine_Object__op_Inequality(v21, 0LL, 0LL);
          if ( ((unsigned __int8)EntityDefinitely & 1) != 0 )
          {
            ...
            if ( SHIDWORD(EntityDefinitely->fields.m_CancellationTokenSource) >= 1 )
            {
              ...
              if ( !v23 )
                goto LABEL_48;
              ExchangeSvtCoinFolderControl__SetFolder(v23, v17 + 1, v24, v25);
              ++v16;
            }
          }
        }
...
LABEL_47:
      sub_1BC326C(EntityDefinitely, v11, v12);
    }
    v16 = 0;
LABEL_35:
    v26 = this->fields.svtCoinFolderList;
    if ( !v26 )
      goto LABEL_48;
    ...
    if ( (int)v27 >= 1 )
    {
      ...
      while ( v28 < (unsigned int)v27 )
      {
        ...
        if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
        EntityDefinitely = (UIProgressBar_o *)UnityEngine_Object__op_Inequality(v29, 0LL, 0LL);
        if ( ((unsigned __int8)EntityDefinitely & 1) != 0 )
        {
          if ( !v29 )
            goto LABEL_48;
          ExchangeSvtCoinFolderControl__SetActive((ExchangeSvtCoinFolderControl_o *)v29, v11);
        }
...
LABEL_45:
    GameObjectExtensions__SetLocalPositionY(this->fields.dummyFolderObject, (float)v16 * -120.0, 0LL);
    EntityDefinitely = (UIProgressBar_o *)this->fields.svtCoinFolderListScrollBar;
    if ( !EntityDefinitely )
LABEL_48:
      sub_1BC3264(EntityDefinitely, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFD00E & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMaster_UserItemMaster___, item);
    sub_1BC3008(&DataManager_TypeInfo, v4);
    this = (ExchangeSvtCoinMenu_o *)sub_1BC3008(&NetworkManager_TypeInfo, v5);
    byte_4AFD00E = 1;
  }
  if ( !item )
    goto LABEL_22;
...
void __fastcall ExchangeSvtCoinMenu__Init(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  {
LABEL_9:
    sub_1BC3264(svtCoinFolderListScrollBar, v4);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)svtCoinFolderListScrollBar, 0, 0LL);
...
void __fastcall ExchangeSvtCoinMenu__InitFolderList(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFD013 & 1) == 0 )
  {
    this = (ExchangeSvtCoinMenu_o *)sub_1BC3008(&UnityEngine_Object_TypeInfo, method);
    byte_4AFD013 = 1;
  }
  ...
  if ( svtCoinFolderList )
  {
    ...
    if ( (int)v5 >= 1 )
    {
      ...
      do
      {
        ...
        if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
        this = (ExchangeSvtCoinMenu_o *)UnityEngine_Object__op_Inequality(v7, 0LL, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFD00F & 1) == 0 )
  {
    ...
    this = (ExchangeSvtCoinMenu_o *)sub_1BC3008(&StringLiteral_5725/*"EXCHANGE_SVT_COIN_RESULT_DIALOG_MSG"*/, v8);
    byte_4AFD00F = 1;
  }
  if ( !item )
    goto LABEL_8;
...
LABEL_8:
  ...
  v12 = LocalizationManager__Get((System_String_o *)StringLiteral_5725/*"EXCHANGE_SVT_COIN_RESULT_DIALOG_MSG"*/, 0LL);
  return System_String__Format_62389940(v12, v10, NumberFormat, 0LL);
}
...
void __fastcall ExchangeSvtCoinMenu__OnAlertDecide(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BC3008(&System_Action_TypeInfo, method);
    sub_1BC3008(&Method_ExchangeSvtCoinMenu_OnConfirmCancel__, v3);
    sub_1BC3008(&Method_ExchangeSvtCoinMenu_OnConfirmDecide__, v4);
    byte_4AFD00A = 1;
  }
  buyItemListViewManager = this->fields.buyItemListViewManager;
  ...
  {
LABEL_7:
    sub_1BC3264(buyItemListViewManager, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (qword_4AFD000 & 0x10000) == 0 )
  {
    sub_1BC3008(&Method_ExchangeSvtCoinMenu_OnClickFolder__, *(_QWORD *)&svtCoinType);
    sub_1BC3008(&StringLiteral_13062/*"SvtCoinType"*/, v5);
    sub_1BC3008(&StringLiteral_3421/*"CLICK_EXCHANGE_SVT_COIN_LIST"*/, v6);
    BYTE2(qword_4AFD000) = 1;
  }
  v7 = Method_ExchangeSvtCoinMenu_OnClickFolder__;
  if ( (*((_BYTE *)Method_ExchangeSvtCoinMenu_OnClickFolder__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1BC3020(Method_ExchangeSvtCoinMenu_OnClickFolder__);
  ...
  if ( !myRoomFsm
    ...
    || (myRoomFsm = (PlayMakerFSM_o *)HutongGames_PlayMaker_FsmVariables__GetFsmInt(
                                        ...
                                        (System_String_o *)StringLiteral_13062/*"SvtCoinType"*/,
                                        0LL)) == 0LL
    || (LODWORD(myRoomFsm->fields.addEventHandlers) = svtCoinType, (myRoomFsm = this->fields.myRoomFsm) == 0LL) )
  {
    sub_1BC3264(myRoomFsm, v9);
  }
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_3421/*"CLICK_EXCHANGE_SVT_COIN_LIST"*/, 0LL);
}
...
void __fastcall ExchangeSvtCoinMenu__OnConfirmCancel(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BC3008(&System_Action_int__TypeInfo, method);
    sub_1BC3008(&Method_ExchangeSvtCoinMenu_OnPreConfirm__, v3);
    byte_4AFD00B = 1;
  }
...
void __fastcall ExchangeSvtCoinMenu__OnPreConfirm(ExchangeSvtCoinMenu_o *this, int32_t cnt, const MethodInfo *method)
{
  ...
  if ( (byte_4AFD009 & 1) == 0 )
  {
    sub_1BC3008(&System_Action_TypeInfo, *(_QWORD *)&cnt);
    sub_1BC3008(&Method_ExchangeSvtCoinMenu_OnAlertDecide__, v5);
    sub_1BC3008(&Method_ExchangeSvtCoinMenu_OnConfirmCancel__, v6);
    sub_1BC3008(&Method_ExchangeSvtCoinMenu_OnConfirmDecide__, v7);
    byte_4AFD009 = 1;
  }
...
LABEL_13:
      sub_1BC3264(buyItemListViewManager, *(_QWORD *)&cnt);
    }
    if ( !buyItemListViewManager )
      goto LABEL_13;
    confirmDialog = this->fields.confirmDialog;
...
void __fastcall ExchangeSvtCoinMenu__OnResultDecide(ExchangeSvtCoinMenu_o *this, bool isOk, const MethodInfo *method)
{
  ...
  if ( (byte_4AFD00C & 1) == 0 )
  {
    sub_1BC3008(&System_Action_TypeInfo, isOk);
    ...
    sub_1BC3008(&Method_ExchangeSvtCoinMenu__OnResultDecide_b__42_0__, v7);
    ...
    sub_1BC3008(&StringLiteral_5705/*"EXCHANGE_SVT_COIN_COMPLETE_DIALOG_MSG"*/, v12);
    byte_4AFD00C = 1;
  }
  ...
  for ( i = 0LL; ; ++i )
  {
    ...
    if ( !byte_4AFC1F1 )
    {
      sub_1BC3008(&NetworkManager_TypeInfo, isOk);
      byte_4AFC1F1 = 1;
    }
    ...
    v20 = *(_QWORD *)&requestResultDialog->fields.numMessage2Label->fields.updateAnchors;
    if ( !BalanceConfig_TypeInfo->_2.cctor_finished )
    {
      j_il2cpp_runtime_class_init_0(BalanceConfig_TypeInfo);
      v19 = BalanceConfig_TypeInfo;
    }
    ExchangeSvtCoinItemIds = v19->static_fields->ExchangeSvtCoinItemIds;
    if ( !ExchangeSvtCoinItemIds )
      goto LABEL_29;
    if ( i >= ExchangeSvtCoinItemIds->max_length )
      sub_1BC326C(requestResultDialog, isOk, v15);
    if ( !Master_object )
      goto LABEL_29;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v22 = LocalizationManager__Get((System_String_o *)StringLiteral_5705/*"EXCHANGE_SVT_COIN_COMPLETE_DIALOG_MSG"*/, 0LL);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38DFD48 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  Empty = string_TypeInfo->static_fields->Empty;
  v25 = (System_Action_o *)sub_1BC3254(System_Action_TypeInfo);
  System_Action___ctor(v25, (Il2CppObject *)this, Method_ExchangeSvtCoinMenu__OnResultDecide_b__42_0__, 0LL);
  if ( !Instance )
LABEL_29:
    sub_1BC3264(requestResultDialog, isOk);
  CommonUI__OpenNotificationDialog((CommonUI_o *)Instance, Empty, v22, v25, -1, 0, 0, 0, 0, 0, 0, 0, 0LL, -2.0, 0, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (qword_4AFD000 & 0x100000000000000LL) == 0 )
  {
    sub_1BC3008(&Method_ExchangeSvtCoinMenu_OnSelectBuyItem__, *(_QWORD *)&selectItemNum);
    sub_1BC3008(&Method_NetworkManager_getRequest_UserPresentListRequest___, v5);
    sub_1BC3008(&NetworkManager_TypeInfo, v6);
    sub_1BC3008(&NetworkManager_ResultCallbackFunc_TypeInfo, v7);
    sub_1BC3008(&Method_ExchangeSvtCoinMenu___c__DisplayClass36_0__OnSelectBuyItem_b__0__, v8);
    sub_1BC3008(&ExchangeSvtCoinMenu___c__DisplayClass36_0_TypeInfo, v9);
    HIBYTE(qword_4AFD000) = 1;
  }
  v10 = sub_1BC3254(ExchangeSvtCoinMenu___c__DisplayClass36_0_TypeInfo);
  ...
  *(_DWORD *)(v10 + 24) = selectItemNum;
  ...
  if ( (*((_BYTE *)Method_ExchangeSvtCoinMenu_OnSelectBuyItem__ + 83) & 2) != 0 )
    v13 = (_QWORD *)sub_1BC3020(Method_ExchangeSvtCoinMenu_OnSelectBuyItem__);
  ...
  Request_object = NetworkManager__getRequest_object_(
                     v15,
                     (const MethodInfo_3089B54 *)Method_NetworkManager_getRequest_UserPresentListRequest___);
  if ( !Request_object )
LABEL_10:
...
void __fastcall ExchangeSvtCoinMenu__Open(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (qword_4AFD000 & 0x100) == 0 )
  {
    sub_1BC3008(&System_Action_TypeInfo, method);
    sub_1BC3008(&Method_ExchangeSvtCoinMenu__Open_b__30_0__, v3);
    ...
    sub_1BC3008(&StringLiteral_5709/*"EXCHANGE_SVT_COIN_CURRENCY_TITLE_SR"*/, v7);
    sub_1BC3008(&StringLiteral_5710/*"EXCHANGE_SVT_COIN_CURRENCY_TITLE_SSR"*/, v8);
    BYTE1(qword_4AFD000) = 1;
  }
  filterButton = this->fields.filterButton;
  if ( !filterButton )
    goto LABEL_27;
  ...
  if ( UnityEngine_Object__op_Inequality(currencyTitleLabel, 0LL, 0LL) )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(currencyTitleLabel2, 0LL, 0LL) )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      filterButton = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5710/*"EXCHANGE_SVT_COIN_CURRENCY_TITLE_SSR"*/, 0LL);
      if ( !v14 )
        goto LABEL_27;
      UILabel__set_text(v14, (System_String_o *)filterButton, 0LL);
      v15 = this->fields.currencyTitleLabel2;
      filterButton = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5709/*"EXCHANGE_SVT_COIN_CURRENCY_TITLE_SR"*/, 0LL);
      if ( !v15 )
        goto LABEL_27;
        ...
        const MethodInfo *method)
{
  ...
  if ( (qword_4AFD000 & 0x1000000) == 0 )
  {
    sub_1BC3008(&System_Action_TypeInfo, *(_QWORD *)&svtCoinType);
    sub_1BC3008(&Method_ExchangeSvtCoinMenu__OpenFolder_b__32_0__, v5);
    BYTE3(qword_4AFD000) = 1;
  }
  ...
  if ( !buyItemListViewManager
    ...
    || (ShopBuyItemListViewManager__FocusTopItem((ShopBuyItemListViewManager_o *)buyItemListViewManager, 0, 0LL),
  ...
  {
LABEL_9:
    sub_1BC3264(buyItemListViewManager, *(_QWORD *)&svtCoinType);
  }
  ShopBuyItemListViewManager__SetMode_34293348(v7, 1, v8, 0.1, 0LL);
}
...
void __fastcall ExchangeSvtCoinMenu__OpenRequestResultDialog(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFD010 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_ExchangeSvtCoinMenu_OnResultDecide__, v6);
    byte_4AFD010 = 1;
  }
  buyItemListViewManager = this->fields.buyItemListViewManager;
  if ( !buyItemListViewManager )
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  buyItemListViewManager = DataManager__GetMaster_object_((const MethodInfo_3001E10 *)Method_DataManager_GetMaster_ItemMaster___);
  if ( !v9 )
    goto LABEL_13;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFD008 & 1) == 0 )
  {
    sub_1BC3008(&System_Action_int__TypeInfo, *(_QWORD *)&selectItemNum);
    sub_1BC3008(&Method_ExchangeSvtCoinMenu_OnPreConfirm__, v5);
    sub_1BC3008(&int_TypeInfo, v6);
    sub_1BC3008(&LocalizationManager_TypeInfo, v7);
    sub_1BC3008(&StringLiteral_24860/*"{0}"*/, v8);
    sub_1BC3008(&StringLiteral_15781/*"[FFFF00]{0}"*/, v9);
    sub_1BC3008(&StringLiteral_5724/*"EXCHANGE_SVT_COIN_NOTICE_TEXT"*/, v10);
    byte_4AFD008 = 1;
  }
  buyItemListViewManager = this->fields.buyItemListViewManager;
  if ( !buyItemListViewManager )
  ...
  if ( v15 <= 0 )
  {
    ...
    v20 = (System_String_o *)StringLiteral_15781/*"[FFFF00]{0}"*/;
  }
  else
  {
    v33 = v15;
    v19 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v33, v16, v17, v18);
    v20 = (System_String_o *)StringLiteral_24860/*"{0}"*/;
  }
  v21 = (Il2CppObject *)System_String__Format(v20, v19, 0LL);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v22 = LocalizationManager__Get((System_String_o *)StringLiteral_5724/*"EXCHANGE_SVT_COIN_NOTICE_TEXT"*/, 0LL);
  ...
  if ( IsBulk )
  {
    ...
    if ( buyItemListViewManager )
    {
      ...
      v28 = (System_Action_int__o *)sub_1BC3254(System_Action_int__TypeInfo);
...
LABEL_19:
    sub_1BC3264(buyItemListViewManager, *(_QWORD *)&selectItemNum);
  }
  ...
  v32 = (System_Action_int__o *)sub_1BC3254(System_Action_int__TypeInfo);
...
void __fastcall ExchangeSvtCoinMenu__RefreshInfo(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (qword_4AFD000 & 0x1000000000000LL) == 0 )
  {
    sub_1BC3008(&System_Action_int__TypeInfo, method);
    sub_1BC3008(&Method_ExchangeSvtCoinMenu_OnSelectBuyItem__, v3);
    BYTE6(qword_4AFD000) = 1;
  }
  buyItemListViewManager = this->fields.buyItemListViewManager;
  if ( !buyItemListViewManager
    || (buyItemListViewManager = ShopBuyItemListViewManager__GetItem(
    ...
    || (ShopBuyItemListViewManager__SetMode_34292448((ShopBuyItemListViewManager_o *)buyItemListViewManager, 5, 0LL),
        v5 = this->fields.buyItemListViewManager,
        v6 = (System_Action_int__o *)sub_1BC3254(System_Action_int__TypeInfo),
...
void __fastcall ExchangeSvtCoinMenu__RequestShop(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFD011 & 1) == 0 )
  {
    sub_1BC3008(&Method_ExchangeSvtCoinMenu_EndRequestShop__, method);
    sub_1BC3008(&Method_NetworkManager_getRequest_PurchaseRequest___, v3);
...
void __fastcall ExchangeSvtCoinMenu__SetCurrencyInfo(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  struct ExchangeSvtCoinMenu_CurrencyInfo_array *v19; // x9
  int32_t v20; // w23
  ExchangeSvtCoinMenu_CurrencyInfo_o *v21; // x29
  ...
  v13 = DataManager__GetMaster_object_((const MethodInfo_3001E10 *)Method_DataManager_GetMaster_UserItemMaster___);
  for ( i = 0; ; ++i )
  {
...
LABEL_39:
    ...
    if ( i >= ExchangeSvtCoinItemIds->max_length )
      goto LABEL_40;
    v19 = this->fields.currencyInfoList;
    if ( !v19 )
      goto LABEL_39;
    if ( i >= v19->max_length )
LABEL_40:
    ...
    if ( !Master_object )
      goto LABEL_39;
    v20 = ExchangeSvtCoinItemIds->m_Items[i + 1];
    v21 = v19->m_Items[i];
    ...
    if ( ((unsigned __int8)EntityDefinitely & 1) != 0 )
    {
      if ( !v21 || !entity )
        goto LABEL_39;
      currencySprite = v21->fields.currencySprite;
      ...
      if ( !EntityDefinitely )
        goto LABEL_39;
      currencyLabel = v21->fields.currencyLabel;
      v25 = *((_DWORD *)EntityDefinitely + 7);
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      EntityDefinitely = LocalizationManager__GetNumberFormat(v25, 0LL);
      if ( !currencyLabel )
        goto LABEL_39;
        ...
        const MethodInfo *method)
{
  ...
  if ( (qword_4AFD000 & 0x10000000000LL) == 0 )
  {
    sub_1BC3008(&UnityEngine_Object_TypeInfo, isDisp);
    BYTE5(qword_4AFD000) = 1;
  }
...
void __fastcall ExchangeSvtCoinMenu___CloseFolder_b__33_0(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  PlayMakerFSM__SendEvent((PlayMakerFSM_o *)buyItemListViewManager, (System_String_o *)StringLiteral_6921/*"GO_NEXT"*/, 0LL);
}
...
void __fastcall ExchangeSvtCoinMenu___OnResultDecide_b__42_0(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFD018 & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_4942/*"DESTROY_EXCHANGE_SVT_COIN"*/, method);
    byte_4AFD018 = 1;
  }
  ExchangeSvtCoinMenu__SetDispCurrencyInfo(this, 0, v2);
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    sub_1BC3264(0LL, v4);
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_4942/*"DESTROY_EXCHANGE_SVT_COIN"*/, 0LL);
}
...
void __fastcall ExchangeSvtCoinMenu___OpenFolder_b__32_0(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFD016 & 1) == 0 )
  {
    sub_1BC3008(&System_Action_int__TypeInfo, method);
    sub_1BC3008(&Method_ExchangeSvtCoinMenu_OnSelectBuyItem__, v3);
    sub_1BC3008(&StringLiteral_13062/*"SvtCoinType"*/, v4);
    byte_4AFD016 = 1;
  }
  ...
  buyItemListViewManager = this->fields.buyItemListViewManager;
  v7 = (System_Action_int__o *)sub_1BC3254(System_Action_int__TypeInfo);
