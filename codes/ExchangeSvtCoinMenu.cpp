...
void __fastcall ExchangeSvtCoinMenu__CloseFolder(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3FA94 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_ExchangeSvtCoinMenu__CloseFolder_b__33_0__, v3);
    byte_4B3FA94 = 1;
  }
  ...
  {
    sub_1BDBAD4(filterButton, method);
  }
  ShopBuyItemListViewManager__SetMode_34294268(buyItemListViewManager, 4, v7, 0.1, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Behaviour__get_isActiveAndEnabled((UnityEngine_Behaviour_o *)selectMenu, 0LL) )
  {
    ...
    if ( !selectMenu )
      goto LABEL_10;
    ShopBuyItemConfirmMenu__Close_34256476(selectMenu, callback, 0LL);
  }
  selectMenu = (ShopBuyItemConfirmMenu_o *)this->fields.bulkSelectMenu;
  if ( !selectMenu )
LABEL_10:
    sub_1BDBAD4(selectMenu, callback);
  if ( UnityEngine_Behaviour__get_isActiveAndEnabled((UnityEngine_Behaviour_o *)selectMenu, 0LL) )
  {
    selectMenu = (ShopBuyItemConfirmMenu_o *)this->fields.bulkSelectMenu;
    if ( selectMenu )
    {
      ShopBuyBulkItemConfirmMenu__Close_44185744((ShopBuyBulkItemConfirmMenu_o *)selectMenu, callback, 0LL);
      goto LABEL_9;
    }
    goto LABEL_10;
  }
...
void __fastcall ExchangeSvtCoinMenu__CreateFolderList(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3FAA4 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_ExchangeSvtCoinMenu_OnClickFolder__, v6);
...
LABEL_47:
      sub_1BDBADC(EntityDefinitely, v11, v12);
    }
    v16 = 0;
LABEL_35:
...
LABEL_45:
    ...
    if ( !EntityDefinitely )
LABEL_48:
      sub_1BDBAD4(EntityDefinitely, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3FA9E & 1) == 0 )
  {
    ...
    this = (ExchangeSvtCoinMenu_o *)sub_1BDB878(&NetworkManager_TypeInfo, v5);
    byte_4B3FA9E = 1;
  }
  if ( !item )
    goto LABEL_22;
...
void __fastcall ExchangeSvtCoinMenu__Init(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  {
LABEL_9:
    sub_1BDBAD4(svtCoinFolderListScrollBar, v4);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)svtCoinFolderListScrollBar, 0, 0LL);
...
void __fastcall ExchangeSvtCoinMenu__InitFolderList(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3FAA3 & 1) == 0 )
  {
    this = (ExchangeSvtCoinMenu_o *)sub_1BDB878(&UnityEngine_Object_TypeInfo, method);
    byte_4B3FAA3 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3FA9F & 1) == 0 )
  {
    ...
    this = (ExchangeSvtCoinMenu_o *)sub_1BDB878(&StringLiteral_5789/*"EXCHANGE_SVT_COIN_RESULT_DIALOG_MSG"*/, v8);
    byte_4B3FA9F = 1;
  }
  if ( !item )
    goto LABEL_8;
...
LABEL_8:
  ...
  v12 = LocalizationManager__Get((System_String_o *)StringLiteral_5789/*"EXCHANGE_SVT_COIN_RESULT_DIALOG_MSG"*/, 0LL);
  return System_String__Format_62613552(v12, v10, NumberFormat, 0LL);
}
...
void __fastcall ExchangeSvtCoinMenu__OnAlertDecide(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&System_Action_TypeInfo, method);
    sub_1BDB878(&Method_ExchangeSvtCoinMenu_OnConfirmCancel__, v3);
    sub_1BDB878(&Method_ExchangeSvtCoinMenu_OnConfirmDecide__, v4);
    byte_4B3FA9A = 1;
  }
  buyItemListViewManager = this->fields.buyItemListViewManager;
  ...
  {
LABEL_7:
    sub_1BDBAD4(buyItemListViewManager, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3FA92 & 1) == 0 )
  {
    sub_1BDB878(&Method_ExchangeSvtCoinMenu_OnClickFolder__, *(_QWORD *)&svtCoinType);
    sub_1BDB878(&StringLiteral_13158/*"SvtCoinType"*/, v5);
    sub_1BDB878(&StringLiteral_3490/*"CLICK_EXCHANGE_SVT_COIN_LIST"*/, v6);
    byte_4B3FA92 = 1;
  }
  v7 = Method_ExchangeSvtCoinMenu_OnClickFolder__;
  if ( (*((_BYTE *)Method_ExchangeSvtCoinMenu_OnClickFolder__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1BDB890(Method_ExchangeSvtCoinMenu_OnClickFolder__);
  ...
  if ( !myRoomFsm
    ...
    || (myRoomFsm = (PlayMakerFSM_o *)HutongGames_PlayMaker_FsmVariables__GetFsmInt(
                                        ...
                                        (System_String_o *)StringLiteral_13158/*"SvtCoinType"*/,
                                        0LL)) == 0LL
    || (LODWORD(myRoomFsm->fields.addEventHandlers) = svtCoinType, (myRoomFsm = this->fields.myRoomFsm) == 0LL) )
  {
    sub_1BDBAD4(myRoomFsm, v9);
  }
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_3490/*"CLICK_EXCHANGE_SVT_COIN_LIST"*/, 0LL);
}
...
void __fastcall ExchangeSvtCoinMenu__OnConfirmCancel(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&System_Action_int__TypeInfo, method);
    sub_1BDB878(&Method_ExchangeSvtCoinMenu_OnPreConfirm__, v3);
    byte_4B3FA9B = 1;
  }
...
void __fastcall ExchangeSvtCoinMenu__OnPreConfirm(ExchangeSvtCoinMenu_o *this, int32_t cnt, const MethodInfo *method)
{
  ...
  if ( (byte_4B3FA99 & 1) == 0 )
  {
    sub_1BDB878(&System_Action_TypeInfo, *(_QWORD *)&cnt);
    sub_1BDB878(&Method_ExchangeSvtCoinMenu_OnAlertDecide__, v5);
    sub_1BDB878(&Method_ExchangeSvtCoinMenu_OnConfirmCancel__, v6);
    sub_1BDB878(&Method_ExchangeSvtCoinMenu_OnConfirmDecide__, v7);
    byte_4B3FA99 = 1;
  }
...
LABEL_13:
      sub_1BDBAD4(buyItemListViewManager, *(_QWORD *)&cnt);
    }
    if ( !buyItemListViewManager )
      goto LABEL_13;
    confirmDialog = this->fields.confirmDialog;
...
void __fastcall ExchangeSvtCoinMenu__OnResultDecide(ExchangeSvtCoinMenu_o *this, bool isOk, const MethodInfo *method)
{
  ...
  if ( (byte_4B3FA9C & 1) == 0 )
  {
    sub_1BDB878(&System_Action_TypeInfo, isOk);
    ...
    sub_1BDB878(&Method_ExchangeSvtCoinMenu__OnResultDecide_b__42_0__, v7);
    ...
    sub_1BDB878(&StringLiteral_5769/*"EXCHANGE_SVT_COIN_COMPLETE_DIALOG_MSG"*/, v12);
    byte_4B3FA9C = 1;
  }
  ...
  for ( i = 0LL; ; ++i )
  {
    ...
    if ( !byte_4B3ED56 )
    {
      sub_1BDB878(&NetworkManager_TypeInfo, isOk);
      byte_4B3ED56 = 1;
    }
    ...
    if ( i >= ExchangeSvtCoinItemIds->max_length )
      sub_1BDBADC(requestResultDialog, isOk, v15);
    if ( !Master_object )
      goto LABEL_29;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v22 = LocalizationManager__Get((System_String_o *)StringLiteral_5769/*"EXCHANGE_SVT_COIN_COMPLETE_DIALOG_MSG"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3FA97 & 1) == 0 )
  {
    sub_1BDB878(&Method_ExchangeSvtCoinMenu_OnSelectBuyItem__, *(_QWORD *)&selectItemNum);
    sub_1BDB878(&Method_NetworkManager_getRequest_UserPresentListRequest___, v5);
    sub_1BDB878(&NetworkManager_TypeInfo, v6);
    sub_1BDB878(&NetworkManager_ResultCallbackFunc_TypeInfo, v7);
    sub_1BDB878(&Method_ExchangeSvtCoinMenu___c__DisplayClass36_0__OnSelectBuyItem_b__0__, v8);
    sub_1BDB878(&ExchangeSvtCoinMenu___c__DisplayClass36_0_TypeInfo, v9);
    byte_4B3FA97 = 1;
  }
  v10 = sub_1BDBAC4(ExchangeSvtCoinMenu___c__DisplayClass36_0_TypeInfo);
  ...
  *(_DWORD *)(v10 + 24) = selectItemNum;
  ...
  if ( (*((_BYTE *)Method_ExchangeSvtCoinMenu_OnSelectBuyItem__ + 83) & 2) != 0 )
    v13 = (_QWORD *)sub_1BDB890(Method_ExchangeSvtCoinMenu_OnSelectBuyItem__);
  v14 = (System_Reflection_MethodBase_o *)sub_1BDB85C(v13, v13[4]);
  OverwriteAssetSoundName__PlaySystemSe(v14, 0, 0, 0LL);
  v15 = (NetworkManager_ResultCallbackFunc_o *)sub_1BDBAC4(NetworkManager_ResultCallbackFunc_TypeInfo);
  ...
  Request_object = NetworkManager__getRequest_object_(
                     v15,
                     (const MethodInfo_30BC7D4 *)Method_NetworkManager_getRequest_UserPresentListRequest___);
  if ( !Request_object )
LABEL_10:
...
void __fastcall ExchangeSvtCoinMenu__Open(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&System_Action_TypeInfo, method);
    sub_1BDB878(&Method_ExchangeSvtCoinMenu__Open_b__30_0__, v3);
    ...
    sub_1BDB878(&StringLiteral_5773/*"EXCHANGE_SVT_COIN_CURRENCY_TITLE_SR"*/, v7);
    sub_1BDB878(&StringLiteral_5774/*"EXCHANGE_SVT_COIN_CURRENCY_TITLE_SSR"*/, v8);
    byte_4B3FA91 = 1;
  }
  filterButton = this->fields.filterButton;
  if ( !filterButton )
  ...
  if ( UnityEngine_Object__op_Inequality(currencyTitleLabel, 0LL, 0LL) )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(currencyTitleLabel2, 0LL, 0LL) )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      filterButton = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5774/*"EXCHANGE_SVT_COIN_CURRENCY_TITLE_SSR"*/, 0LL);
      if ( !v14 )
        goto LABEL_27;
      UILabel__set_text(v14, (System_String_o *)filterButton, 0LL);
      v15 = this->fields.currencyTitleLabel2;
      filterButton = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5773/*"EXCHANGE_SVT_COIN_CURRENCY_TITLE_SR"*/, 0LL);
      if ( !v15 )
        goto LABEL_27;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3FA93 & 1) == 0 )
  {
    sub_1BDB878(&System_Action_TypeInfo, *(_QWORD *)&svtCoinType);
    sub_1BDB878(&Method_ExchangeSvtCoinMenu__OpenFolder_b__32_0__, v5);
    byte_4B3FA93 = 1;
  }
  ...
  {
LABEL_9:
    sub_1BDBAD4(buyItemListViewManager, *(_QWORD *)&svtCoinType);
  }
  ShopBuyItemListViewManager__SetMode_34294268(v7, 1, v8, 0.1, 0LL);
}
...
void __fastcall ExchangeSvtCoinMenu__OpenRequestResultDialog(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3FAA0 & 1) == 0 )
  {
    ...
    sub_1BDB878(&DataManager_TypeInfo, v4);
    sub_1BDB878(&Method_DataMasterBase_ItemMaster__ItemEntity__int__GetEntity__, v5);
    sub_1BDB878(&Method_ExchangeSvtCoinMenu_OnResultDecide__, v6);
    byte_4B3FAA0 = 1;
  }
  buyItemListViewManager = this->fields.buyItemListViewManager;
  if ( !buyItemListViewManager )
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  buyItemListViewManager = DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_ItemMaster___);
  if ( !v9 )
    goto LABEL_13;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3FA98 & 1) == 0 )
  {
    sub_1BDB878(&System_Action_int__TypeInfo, *(_QWORD *)&selectItemNum);
    sub_1BDB878(&Method_ExchangeSvtCoinMenu_OnPreConfirm__, v5);
    sub_1BDB878(&int_TypeInfo, v6);
    sub_1BDB878(&LocalizationManager_TypeInfo, v7);
    sub_1BDB878(&StringLiteral_25175/*"{0}"*/, v8);
    sub_1BDB878(&StringLiteral_15906/*"[FFFF00]{0}"*/, v9);
    sub_1BDB878(&StringLiteral_5788/*"EXCHANGE_SVT_COIN_NOTICE_TEXT"*/, v10);
    byte_4B3FA98 = 1;
  }
  buyItemListViewManager = this->fields.buyItemListViewManager;
  if ( !buyItemListViewManager )
  ...
  if ( v15 <= 0 )
  {
    ...
    v20 = (System_String_o *)StringLiteral_15906/*"[FFFF00]{0}"*/;
  }
  else
  {
    v33 = v15;
    v19 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v33, v16, v17, v18);
    v20 = (System_String_o *)StringLiteral_25175/*"{0}"*/;
  }
  v21 = (Il2CppObject *)System_String__Format(v20, v19, 0LL);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v22 = LocalizationManager__Get((System_String_o *)StringLiteral_5788/*"EXCHANGE_SVT_COIN_NOTICE_TEXT"*/, 0LL);
  ...
  if ( IsBulk )
  {
    ...
    if ( buyItemListViewManager )
    {
      ...
      v28 = (System_Action_int__o *)sub_1BDBAC4(System_Action_int__TypeInfo);
...
LABEL_19:
    sub_1BDBAD4(buyItemListViewManager, *(_QWORD *)&selectItemNum);
  }
  ...
  v32 = (System_Action_int__o *)sub_1BDBAC4(System_Action_int__TypeInfo);
...
void __fastcall ExchangeSvtCoinMenu__RefreshInfo(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&System_Action_int__TypeInfo, method);
    sub_1BDB878(&Method_ExchangeSvtCoinMenu_OnSelectBuyItem__, v3);
    byte_4B3FA96 = 1;
  }
  buyItemListViewManager = this->fields.buyItemListViewManager;
  if ( !buyItemListViewManager
    ...
    || (ShopBuyItemListViewManager__SetMode_34293368((ShopBuyItemListViewManager_o *)buyItemListViewManager, 5, 0LL),
        v5 = this->fields.buyItemListViewManager,
        v6 = (System_Action_int__o *)sub_1BDBAC4(System_Action_int__TypeInfo),
...
void __fastcall ExchangeSvtCoinMenu__RequestShop(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3FAA1 & 1) == 0 )
  {
    sub_1BDB878(&Method_ExchangeSvtCoinMenu_EndRequestShop__, method);
    sub_1BDB878(&Method_NetworkManager_getRequest_PurchaseRequest___, v3);
...
void __fastcall ExchangeSvtCoinMenu__SetCurrencyInfo(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3FA9D & 1) == 0 )
  {
    ...
    sub_1BDB878(&BalanceConfig_TypeInfo, v3);
    sub_1BDB878(&Method_DataManager_GetMaster_ItemMaster___, v4);
    sub_1BDB878(&Method_DataManager_GetMaster_UserItemMaster___, v5);
    sub_1BDB878(&DataManager_TypeInfo, v6);
  ...
  v13 = DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_UserItemMaster___);
  for ( i = 0; ; ++i )
  {
...
void __fastcall ExchangeSvtCoinMenu___CloseFolder_b__33_0(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  PlayMakerFSM__SendEvent((PlayMakerFSM_o *)buyItemListViewManager, (System_String_o *)StringLiteral_6989/*"GO_NEXT"*/, 0LL);
}
...
void __fastcall ExchangeSvtCoinMenu___OnResultDecide_b__42_0(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3FAA8 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_5022/*"DESTROY_EXCHANGE_SVT_COIN"*/, method);
    byte_4B3FAA8 = 1;
  }
  ExchangeSvtCoinMenu__SetDispCurrencyInfo(this, 0, v2);
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    sub_1BDBAD4(0LL, v4);
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_5022/*"DESTROY_EXCHANGE_SVT_COIN"*/, 0LL);
}
...
void __fastcall ExchangeSvtCoinMenu___OpenFolder_b__32_0(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3FAA6 & 1) == 0 )
  {
    sub_1BDB878(&System_Action_int__TypeInfo, method);
    sub_1BDB878(&Method_ExchangeSvtCoinMenu_OnSelectBuyItem__, v3);
    sub_1BDB878(&StringLiteral_13158/*"SvtCoinType"*/, v4);
    byte_4B3FAA6 = 1;
  }
  ...
  buyItemListViewManager = this->fields.buyItemListViewManager;
  v7 = (System_Action_int__o *)sub_1BDBAC4(System_Action_int__TypeInfo);
