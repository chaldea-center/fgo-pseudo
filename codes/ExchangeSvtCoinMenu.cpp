...
void ExchangeSvtCoinMenu__CloseFolder(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFF76B & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_ExchangeSvtCoinMenu__CloseFolder_b__33_0__);
    byte_4DFF76B = 1;
  }
  ...
  {
    sub_1CE6958(filterButton, method);
  }
  ShopBuyItemListViewManager__SetMode_36228064(buyItemListViewManager, 4, v6, 0.1, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Behaviour__get_isActiveAndEnabled((UnityEngine_Behaviour_o *)selectMenu, 0) )
  {
    ...
    if ( !selectMenu )
      goto LABEL_10;
    ShopBuyItemConfirmMenu__Close_36180916(selectMenu, callback, 0);
  }
  selectMenu = (ShopBuyItemConfirmMenu_o *)this->fields.bulkSelectMenu;
  if ( !selectMenu )
LABEL_10:
    sub_1CE6958(selectMenu, callback);
  if ( UnityEngine_Behaviour__get_isActiveAndEnabled((UnityEngine_Behaviour_o *)selectMenu, 0) )
  {
    selectMenu = (ShopBuyItemConfirmMenu_o *)this->fields.bulkSelectMenu;
    if ( selectMenu )
    {
      ShopBuyBulkItemConfirmMenu__Close_46440736((ShopBuyBulkItemConfirmMenu_o *)selectMenu, callback, 0);
      goto LABEL_9;
    }
    goto LABEL_10;
  }
...
void ExchangeSvtCoinMenu__CreateFolderList(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFF77B & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_ExchangeSvtCoinMenu_OnClickFolder__);
      ...
      while ( v10 < (unsigned int)v8 )
      {
        ...
        if ( v9 < max_length )
        {
          if ( v9 >= (unsigned int)max_length )
            break;
          v13 = *(_DWORD *)(m_CachedPtr + 32 + 4 * v10);
        ...
        LODWORD(v8) = *(_DWORD *)(m_CachedPtr + 24);
...
LABEL_45:
    ...
    if ( !EntityDefinitely )
LABEL_48:
      sub_1CE6958(EntityDefinitely, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFF775 & 1) == 0 )
  {
    sub_1CE6700(&Method_DataManager_GetMaster_UserItemMaster___);
    sub_1CE6700(&DataManager_TypeInfo);
    this = (ExchangeSvtCoinMenu_o *)sub_1CE6700(&NetworkManager_TypeInfo);
    byte_4DFF775 = 1;
  }
  if ( !item )
    goto LABEL_22;
...
void ExchangeSvtCoinMenu__Init(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  {
LABEL_9:
    sub_1CE6958(svtCoinFolderListScrollBar, v4);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)svtCoinFolderListScrollBar, 0, 0);
...
void ExchangeSvtCoinMenu__InitFolderList(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFF77A & 1) == 0 )
  {
    this = (ExchangeSvtCoinMenu_o *)sub_1CE6700(&UnityEngine_Object_TypeInfo);
    byte_4DFF77A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFF776 & 1) == 0 )
  {
    ...
    this = (ExchangeSvtCoinMenu_o *)sub_1CE6700(&StringLiteral_5815/*"EXCHANGE_SVT_COIN_RESULT_DIALOG_MSG"*/);
    byte_4DFF776 = 1;
  }
  if ( !item )
    goto LABEL_8;
...
LABEL_8:
  ...
  v11 = LocalizationManager__Get((System_String_o *)StringLiteral_5815/*"EXCHANGE_SVT_COIN_RESULT_DIALOG_MSG"*/, 0);
  return System_String__Format_65164136(v11, v9, NumberFormat, 0);
}
...
void ExchangeSvtCoinMenu__OnAlertDecide(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&System_Action_TypeInfo);
    sub_1CE6700(&Method_ExchangeSvtCoinMenu_OnConfirmCancel__);
    sub_1CE6700(&Method_ExchangeSvtCoinMenu_OnConfirmDecide__);
    byte_4DFF771 = 1;
  }
  buyItemListViewManager = this->fields.buyItemListViewManager;
  ...
  {
LABEL_7:
    sub_1CE6958(buyItemListViewManager, method);
  }
...
void ExchangeSvtCoinMenu__OnClickFolder(ExchangeSvtCoinMenu_o *this, int32_t svtCoinType, const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&Method_ExchangeSvtCoinMenu_OnClickFolder__);
    sub_1CE6700(&StringLiteral_13325/*"SvtCoinType"*/);
    sub_1CE6700(&StringLiteral_3482/*"CLICK_EXCHANGE_SVT_COIN_LIST"*/);
    byte_4DFF769 = 1;
  }
  v5 = Method_ExchangeSvtCoinMenu_OnClickFolder__;
  if ( (*((_BYTE *)Method_ExchangeSvtCoinMenu_OnClickFolder__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1CE6718(Method_ExchangeSvtCoinMenu_OnClickFolder__);
  ...
  if ( !myRoomFsm
    ...
    || (myRoomFsm = (PlayMakerFSM_o *)HutongGames_PlayMaker_FsmVariables__GetFsmInt(
                                        ...
                                        (System_String_o *)StringLiteral_13325/*"SvtCoinType"*/,
                                        0)) == 0
    || (LODWORD(myRoomFsm->fields.addEventHandlers) = svtCoinType, (myRoomFsm = this->fields.myRoomFsm) == 0) )
  {
    sub_1CE6958(myRoomFsm, v7);
  }
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_3482/*"CLICK_EXCHANGE_SVT_COIN_LIST"*/, 0);
}
...
void ExchangeSvtCoinMenu__OnConfirmCancel(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&System_Action_int__TypeInfo);
    sub_1CE6700(&Method_ExchangeSvtCoinMenu_OnPreConfirm__);
    byte_4DFF772 = 1;
  }
...
void ExchangeSvtCoinMenu__OnPreConfirm(ExchangeSvtCoinMenu_o *this, int32_t cnt, const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&System_Action_TypeInfo);
    sub_1CE6700(&Method_ExchangeSvtCoinMenu_OnAlertDecide__);
    sub_1CE6700(&Method_ExchangeSvtCoinMenu_OnConfirmCancel__);
    sub_1CE6700(&Method_ExchangeSvtCoinMenu_OnConfirmDecide__);
    byte_4DFF770 = 1;
  }
...
LABEL_13:
      sub_1CE6958(buyItemListViewManager, *(_QWORD *)&cnt);
    }
    if ( !buyItemListViewManager )
      goto LABEL_13;
    confirmDialog = this->fields.confirmDialog;
...
void ExchangeSvtCoinMenu__OnResultDecide(ExchangeSvtCoinMenu_o *this, bool isOk, const MethodInfo *method)
{
  ...
  if ( (byte_4DFF773 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_DataManager_GetMaster_UserItemMaster___);
    sub_1CE6700(&DataManager_TypeInfo);
    sub_1CE6700(&Method_ExchangeSvtCoinMenu__OnResultDecide_b__42_0__);
    sub_1CE6700(&LocalizationManager_TypeInfo);
    sub_1CE6700(&NetworkManager_TypeInfo);
    sub_1CE6700(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1CE6700(&string_TypeInfo);
    sub_1CE6700(&StringLiteral_5795/*"EXCHANGE_SVT_COIN_COMPLETE_DIALOG_MSG"*/);
    byte_4DFF773 = 1;
  }
  ...
  for ( i = 0; ; ++i )
  {
    ...
    v8 = *(_QWORD *)&requestResultDialog->fields.numMessage2Label->fields.mEffectDistance.fields.y;
    if ( !v8 )
      goto LABEL_29;
    ...
    if ( i >= LODWORD(ExchangeSvtCoinItemIds->max_length) )
      sub_1CE6960(requestResultDialog);
    if ( !Master_object )
      goto LABEL_29;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v12 = LocalizationManager__Get((System_String_o *)StringLiteral_5795/*"EXCHANGE_SVT_COIN_COMPLETE_DIALOG_MSG"*/, 0);
...
void ExchangeSvtCoinMenu__OnSelectBuyItem(ExchangeSvtCoinMenu_o *this, int32_t selectItemNum, const MethodInfo *method)
{
  ...
  if ( (byte_4DFF76E & 1) == 0 )
  {
    sub_1CE6700(&Method_ExchangeSvtCoinMenu_OnSelectBuyItem__);
    sub_1CE6700(&Method_NetworkManager_getRequest_UserPresentListRequest___);
    sub_1CE6700(&NetworkManager_TypeInfo);
    sub_1CE6700(&NetworkManager_ResultCallbackFunc_TypeInfo);
    sub_1CE6700(&Method_ExchangeSvtCoinMenu___c__DisplayClass36_0__OnSelectBuyItem_b__0__);
    sub_1CE6700(&ExchangeSvtCoinMenu___c__DisplayClass36_0_TypeInfo);
    byte_4DFF76E = 1;
  }
  v5 = sub_1CE694C(ExchangeSvtCoinMenu___c__DisplayClass36_0_TypeInfo);
  ...
  *(_DWORD *)(v5 + 24) = selectItemNum;
  ...
  if ( (*((_BYTE *)Method_ExchangeSvtCoinMenu_OnSelectBuyItem__ + 83) & 2) != 0 )
    v14 = (_QWORD *)sub_1CE6718(Method_ExchangeSvtCoinMenu_OnSelectBuyItem__);
  ...
  Request_object = NetworkManager__getRequest_object_(
                     v16,
                     (const MethodInfo_328F954 *)Method_NetworkManager_getRequest_UserPresentListRequest___);
  if ( !Request_object )
LABEL_10:
...
void ExchangeSvtCoinMenu__Open(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&System_Action_TypeInfo);
    sub_1CE6700(&Method_ExchangeSvtCoinMenu__Open_b__30_0__);
    sub_1CE6700(&Method_UnityEngine_GameObject_GetComponent_TweenPosition___);
    sub_1CE6700(&LocalizationManager_TypeInfo);
    sub_1CE6700(&UnityEngine_Object_TypeInfo);
    sub_1CE6700(&StringLiteral_5799/*"EXCHANGE_SVT_COIN_CURRENCY_TITLE_SR"*/);
    sub_1CE6700(&StringLiteral_5800/*"EXCHANGE_SVT_COIN_CURRENCY_TITLE_SSR"*/);
    byte_4DFF768 = 1;
  }
  filterButton = this->fields.filterButton;
  if ( !filterButton )
  ...
  if ( UnityEngine_Object__op_Inequality(currencyTitleLabel, 0, 0) )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(currencyTitleLabel2, 0, 0) )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      filterButton = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5800/*"EXCHANGE_SVT_COIN_CURRENCY_TITLE_SSR"*/, 0);
      if ( !v8 )
        goto LABEL_27;
      UILabel__set_text(v8, (System_String_o *)filterButton, 0);
      v9 = this->fields.currencyTitleLabel2;
      filterButton = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5799/*"EXCHANGE_SVT_COIN_CURRENCY_TITLE_SR"*/, 0);
      if ( !v9 )
        goto LABEL_27;
...
void ExchangeSvtCoinMenu__OpenFolder(ExchangeSvtCoinMenu_o *this, int32_t svtCoinType, const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&System_Action_TypeInfo);
    sub_1CE6700(&Method_ExchangeSvtCoinMenu__OpenFolder_b__32_0__);
    byte_4DFF76A = 1;
  }
  ...
  {
LABEL_9:
    sub_1CE6958(buyItemListViewManager, *(_QWORD *)&svtCoinType);
  }
  ShopBuyItemListViewManager__SetMode_36228064(v6, 1, v7, 0.1, 0);
}
...
void ExchangeSvtCoinMenu__OpenRequestResultDialog(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFF777 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_ExchangeSvtCoinMenu_OnResultDecide__);
    byte_4DFF777 = 1;
  }
  buyItemListViewManager = this->fields.buyItemListViewManager;
  if ( !buyItemListViewManager )
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  buyItemListViewManager = (ShopBuyItemListViewManager_o *)DataManager__GetMaster_object_((const MethodInfo_3204354 *)Method_DataManager_GetMaster_ItemMaster___);
  if ( !dragParentObject )
    goto LABEL_13;
...
void ExchangeSvtCoinMenu__OpenSelectMenu(ExchangeSvtCoinMenu_o *this, int32_t selectItemNum, const MethodInfo *method)
{
  ...
  if ( (byte_4DFF76F & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_16076/*"[FFFF00]{0}"*/);
    sub_1CE6700(&StringLiteral_5814/*"EXCHANGE_SVT_COIN_NOTICE_TEXT"*/);
    byte_4DFF76F = 1;
  }
  buyItemListViewManager = this->fields.buyItemListViewManager;
  if ( !buyItemListViewManager )
  ...
  if ( v9 <= 0 )
  {
    ...
    v11 = (System_String_o *)StringLiteral_16076/*"[FFFF00]{0}"*/;
  }
  else
  {
    v24 = v9;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v13 = LocalizationManager__Get((System_String_o *)StringLiteral_5814/*"EXCHANGE_SVT_COIN_NOTICE_TEXT"*/, 0);
...
LABEL_19:
    sub_1CE6958(buyItemListViewManager, *(_QWORD *)&selectItemNum);
  }
...
void ExchangeSvtCoinMenu__RefreshInfo(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( !buyItemListViewManager
    ...
    || (ShopBuyItemListViewManager__SetMode_36226784((ShopBuyItemListViewManager_o *)buyItemListViewManager, 5, 0),
        v4 = this->fields.buyItemListViewManager,
        v5 = (System_Action_int__o *)sub_1CE694C(System_Action_int__TypeInfo),
...
void ExchangeSvtCoinMenu__RequestShop(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFF778 & 1) == 0 )
  {
    sub_1CE6700(&Method_ExchangeSvtCoinMenu_EndRequestShop__);
...
void ExchangeSvtCoinMenu__SetCurrencyInfo(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  v5 = DataManager__GetMaster_object_((const MethodInfo_3204354 *)Method_DataManager_GetMaster_UserItemMaster___);
  for ( i = 0; ; ++i )
  {
    ...
    if ( !ExchangeSvtCoinItemIds )
LABEL_39:
      sub_1CE6958(EntityDefinitely, v4);
...
void ExchangeSvtCoinMenu___CloseFolder_b__33_0(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  PlayMakerFSM__SendEvent((PlayMakerFSM_o *)buyItemListViewManager, (System_String_o *)StringLiteral_7030/*"GO_NEXT"*/, 0);
}
...
void ExchangeSvtCoinMenu___OnResultDecide_b__42_0(ExchangeSvtCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFF77F & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_5019/*"DESTROY_EXCHANGE_SVT_COIN"*/);
    byte_4DFF77F = 1;
  }
  ExchangeSvtCoinMenu__SetDispCurrencyInfo(this, 0, v2);
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    sub_1CE6958(0, v4);
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_5019/*"DESTROY_EXCHANGE_SVT_COIN"*/, 0);
}
