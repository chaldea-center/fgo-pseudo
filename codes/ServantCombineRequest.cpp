        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_593A2DF & 1) == 0 )
  {
    ...
    sub_21FFC50(&StringLiteral_20678/*"getExp"*/);
    sub_21FFC50(&StringLiteral_25785/*"useQp"*/);
  ...
  RequestBase__addField_51187332((RequestBase_o *)this, (System_String_o *)StringLiteral_22537/*"materialUserSvtIds"*/, materialSvtIds, v11);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_25785/*"useQp"*/, useQp, v12);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_20678/*"getExp"*/, getExp, v13);
...
System_String_o *ServantCombineRequest__getMockData(ServantCombineRequest_o *this, const MethodInfo *method)
{
  if ( (byte_593A2DE & 1) == 0 )
  {
    ...
    sub_21FFC50(&StringLiteral_9505/*"MockSvtCombineResponse"*/);
    byte_593A2DE = 1;
  }
  if ( !*(&NetworkManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  return NetworkManager__getMockFile((System_String_o *)StringLiteral_9505/*"MockSvtCombineResponse"*/, 0);
}
...
System_String_o *ServantCombineRequest__getURL(ServantCombineRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_21FFC50(&NetworkManager_TypeInfo);
    sub_21FFC50(&StringLiteral_18491/*"card/combine"*/);
    byte_593A2DD = 1;
  }
  if ( !*(&NetworkManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_75438412(BaseUrl, (System_String_o *)StringLiteral_18491/*"card/combine"*/, 0);
}
