        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FCE58 & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_18917/*"getExp"*/, v11);
    sub_B16FFC(&StringLiteral_22890/*"useQp"*/, v12);
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22890/*"useQp"*/, useQp, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18917/*"getExp"*/, getExp, 0LL);
...
System_String_o *__fastcall ServantCombineRequest__getMockData(ServantCombineRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_40FCE57 & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_9135/*"MockSvtCombineResponse"*/, v2);
    byte_40FCE57 = 1;
  }
  ...
  return NetworkManager__getMockFile((System_String_o *)StringLiteral_9135/*"MockSvtCombineResponse"*/, 0LL);
}
...
System_String_o *__fastcall ServantCombineRequest__getURL(ServantCombineRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_B16FFC(&NetworkManager_TypeInfo, method);
    sub_B16FFC(&StringLiteral_17147/*"card/combine"*/, v2);
    byte_40FCE56 = 1;
  }
  if ( (BYTE3(NetworkManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !NetworkManager_TypeInfo->_2.cctor_finished )
  ...
  return System_String__Concat_43743732(BaseUrl, (System_String_o *)StringLiteral_17147/*"card/combine"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FCE59 & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_22334/*"successResult"*/, v6);
    ...
    && (success = (System_Collections_Generic_Dictionary_Type__IStoreExtension__o *)v9->fields.success) != 0LL )
  {
    Item = System_Collections_Generic_Dictionary_Type__IStoreExtension___get_Item(
             success,
             (System_Type_o *)StringLiteral_22334/*"successResult"*/,
