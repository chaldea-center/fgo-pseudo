void SpecialAscensionControl___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C5AD4E & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_3606/*"COMBINE_LIMIT_SPECIAL_PRIVILEGE_ID"*/);
    byte_4C5AD4E = 1;
  }
  ...
  sub_1C3E508((CGThumbnailListItem_o *)SpecialAscensionControl_TypeInfo->static_fields, StringLiteral_3606/*"COMBINE_LIMIT_SPECIAL_PRIVILEGE_ID"*/, v1, v2);
...
int32_t SpecialAscensionControl__GetEffectLimitCount(SpecialAscensionControl_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&v7.fields.fakeValue = v4;
  return this->fields.effectCnt + CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49004136(v7, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v18.fields.fakeValue = v12;
  v14 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49004136(v18, 0);
        ...
        const MethodInfo *method)
{
  ...
  System_Collections_Generic_List_Enumerator_object__o v56; // [xsp+90h] [xbp-80h] BYREF
  ...
  if ( (int)v9 >= 1 )
  {
    ...
    do
    {
      ...
      if ( v15 )
      {
        v16 = *(_OWORD *)(v15 + 64);
        v17 = *v12;
        *(_OWORD *)&v55.fields.currentCryptoKey = *(_OWORD *)(v15 + 48);
        ...
        if ( Instance == userIdNumber )
        {
          ...
          if ( (Instance & 1) == 0 )
          {
            ...
            *(_OWORD *)&v55.fields.fakeValue = v18;
            ...
            v53 = v55;
            v20 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_49007660(&v53, 0);
            v21 = *(_OWORD *)(v15 + 32);
            v22 = v20;
            *(_OWORD *)&v52.fields.currentCryptoKey = *(_OWORD *)(v15 + 16);
            *(_OWORD *)&v52.fields.fakeValue = v21;
            ...
            if ( v22 != Instance )
            {
              ...
              *(_QWORD *)&v57.fields.fakeValue = v29;
              v31 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49004136(v57, 0);
              ...
              if ( v31 == (_DWORD)Instance )
              {
                ...
                else
                {
                  ...
                  sub_1C3E508((CGThumbnailListItem_o *)(v37 + 4), v15, v32, v33);
                }
              }
            }
          }
...
LABEL_62:
  ...
  v56 = *(System_Collections_Generic_List_Enumerator_object__o *)&v55.fields.currentCryptoKey;
  while ( 1 )
  {
    ...
    if ( !v56.fields._current )
      sub_1C3E7C0(v38, v39);
    if ( SHIDWORD(v56.fields._current[16].klass) >= 2
      || SLODWORD(v56.fields._current[17].monitor) > 1
      || SHIDWORD(v56.fields._current[17].monitor) > 1
      || SLODWORD(v56.fields._current[18].klass) > 1 )
    {
      goto LABEL_55;
    }
    AppendSkillInfo = UserServantEntity__getAppendSkillInfo((UserServantEntity_o *)v56.fields._current, 0);
    if ( !AppendSkillInfo )
      sub_1C3E7C0(0, v42);
    svtSkillLvList = AppendSkillInfo->fields.svtSkillLvList;
    if ( !svtSkillLvList )
      sub_1C3E7C0(AppendSkillInfo, v42);
    ...
    if ( max_length >= 1 )
    {
      ...
      {
        if ( max_length == v45 )
          sub_1C3E7C8(AppendSkillInfo, v42);
        if ( svtSkillLvList->m_Items[v45] >= 2 )
          break;
        if ( max_length == ++v45 )
          goto LABEL_49;
      }
...
LABEL_49:
    ...
    *(_QWORD *)&v58.fields.fakeValue = monitor;
    if ( CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49004136(v58, 0) >= 1
...
LABEL_28:
  ...
  *(_OWORD *)&v43.fields._dictionary = *(_OWORD *)&v41.fields._dictionary;
            ...
            (const MethodInfo_3561EB8 *)Method_System_Collections_Generic_Dictionary_Enumerator_int__int__MoveNext__) )
  {
    ...
    if ( !v36 )
      sub_1C3E7C0(MasterData_object, v28);
    ...
    *(struct System_Collections_Generic_KeyValuePair_TKey__TValue__o *)&v40.fields.fakeValue = v41.fields._current;
    v31 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_49007660(&v40, 0);
    if ( !v30 )
      sub_1C3E7C0(v31, v32);
...
void SpecialAscensionControl__OnClickHelp(SpecialAscensionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C5AD4C & 1) == 0 )
  {
    sub_1C3E564(&Method_SpecialAscensionControl_OnClickHelp__);
    byte_4C5AD4C = 1;
  }
  if ( !this->fields.helpSeSilent )
  {
    ...
    if ( (*((_BYTE *)Method_SpecialAscensionControl_OnClickHelp__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3E57C(Method_SpecialAscensionControl_OnClickHelp__);
...
void SpecialAscensionControl__OnClickSpecialAscension(SpecialAscensionControl_o *this, const MethodInfo *method)
{
  ...
  if ( CanExeSpecialAscension )
  {
    ...
    if ( !exeCombineDlg )
      sub_1C3E7C0(HaveRequestItemAndQp, v10);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.baseUserServantEntity, (int32_t)selectBaseSvt, (int32_t)method, v3);
...
void SpecialAscensionControl__SetBaseSvtCardImg(SpecialAscensionControl_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(charaGraph, 0, 0) )
  {
    ...
    *p_charaGraph = 0;
    sub_1C3E508((CGThumbnailListItem_o *)&this->fields.charaGraph, 0, v7, v8);
  }
  baseUserServantEntity = this->fields.baseUserServantEntity;
  if ( baseUserServantEntity )
  {
    ...
    sub_1C3E508((CGThumbnailListItem_o *)&this->fields.charaGraph, (int32_t)v10, v11, v12);
  }
}
...
void SpecialAscensionControl__SetCombineInfo(SpecialAscensionControl_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)afterAtk = 0;
  ...
  v6 = sub_1C3E7B0(CombineSvtData_TypeInfo);
  System_Object___ctor((Il2CppObject *)v6, 0);
  if ( !v6 )
    goto LABEL_23;
  baseUserServantEntity = this->fields.baseUserServantEntity;
  *(_QWORD *)(v6 + 16) = baseUserServantEntity;
  sub_1C3E508((CGThumbnailListItem_o *)(v6 + 16), (int32_t)baseUserServantEntity, v7, v8);
  combineInfoComp = (CombineInfoComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39FF5A8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !combineInfoComp )
    goto LABEL_23;
  ...
  *(_QWORD *)&v24.fields.fakeValue = v12;
  combineInfoComp = (CombineInfoComponent_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49004136(
                                                v24,
                                                0);
  ...
  if ( !v11 )
    goto LABEL_23;
  combineInfoComp = (CombineInfoComponent_o *)ServantLimitMaster__GetEntity(v11, v14, (int)combineInfoComp - 1, 0);
  if ( !combineInfoComp )
    goto LABEL_23;
  ...
  *(_DWORD *)(v6 + 28) = (_DWORD)combineInfoComp;
  ...
  combineInfoComp = (CombineInfoComponent_o *)ServantLimitMaster__GetEntity(v11, v16, LimitCntMax, 0);
  if ( !combineInfoComp )
    goto LABEL_23;
  ...
  *(_DWORD *)(v6 + 44) = afterAtk[1];
  ...
  {
LABEL_23:
    sub_1C3E7C0(combineInfoComp, method);
  }
...
void SpecialAscensionControl__SetStateInfoMsg(SpecialAscensionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C5AD44 & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_7453/*"INFO_MSG_SPECIAL_ASCENSION"*/);
  ...
  if ( baseUserServantEntity )
  {
    if ( UserServantEntity__isLimitCountMax(baseUserServantEntity, 0) )
    {
      ...
      v6 = &StringLiteral_8800/*"MSG_LIMITUP_MAX"*/;
    }
    else
    {
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v6 = &StringLiteral_5790/*"EXE_SUMMON_COMBINE_TXT"*/;
    }
  }
  else
  {
...
void SpecialAscensionControl__SetUp(SpecialAscensionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C5AD42 & 1) == 0 )
  {
    sub_1C3E564(&LocalizationManager_TypeInfo);
    sub_1C3E564(&SpecialAscensionControl_TypeInfo);
    sub_1C3E564(&StringLiteral_8805/*"MSG_PRESELECT_BASE_SPECIAL_ASCENSION"*/);
  ...
  if ( !baseSelectInfoLb )
    goto LABEL_18;
  baseSelectInfoLb = (UnityEngine_GameObject_o *)System_Int64__ToString_65151752(
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  baseSelectInfoLb = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8805/*"MSG_PRESELECT_BASE_SPECIAL_ASCENSION"*/, 0);
  if ( !preSelectBaseLb )
LABEL_18:
    sub_1C3E7C0(baseSelectInfoLb, v4);
...
void SpecialAscensionControl__Start(SpecialAscensionControl_o *this, const MethodInfo *method)
{
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.combineResStatus, (int32_t)Component_object, v6, v7);
}