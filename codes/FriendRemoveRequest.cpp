void FriendRemoveRequest__beginRequest(FriendRemoveRequest_o *this, int64_t targetUserId, const MethodInfo *method)
{
  ...
  if ( (byte_4D3252F & 1) == 0 )
  {
    sub_1C93AD4(&StringLiteral_24304/*"targetUserId"*/);
    byte_4D3252F = 1;
  }
  RequestBase__addField_44911784((RequestBase_o *)this, (System_String_o *)StringLiteral_24304/*"targetUserId"*/, targetUserId, v3);
...
System_String_o *FriendRemoveRequest__getURL(FriendRemoveRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D3252E & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_19886/*"friend/remove"*/);
    byte_4D3252E = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64425724(BaseUrl, (System_String_o *)StringLiteral_19886/*"friend/remove"*/, 0);
}
