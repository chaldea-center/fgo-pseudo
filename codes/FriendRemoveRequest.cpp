...
System_String_o *__fastcall FriendRemoveRequest__getURL(FriendRemoveRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42EB45B & 1) == 0 )
  {
    ...
    sub_B5D5C4(&StringLiteral_19137/*"friend/remove"*/, v4, v5, v6);
    byte_42EB45B = 1;
  }
  ...
  return System_String__Concat_44577788(BaseUrl, (System_String_o *)StringLiteral_19137/*"friend/remove"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v12 = ResponseCommandKind__SearchData(17, responseList, 0LL);
