        ...
        const MethodInfo *method)
{
  ...
  *(_DWORD *)&v6[-1].fields.isInvalid = eventId;
  sub_1C71354((GrandQuestFolderBoardItem_o *)v6, (int32_t)funcEntity, v7, v8, v9, v10, v11, v12);
  LODWORD(v6->monitor) = 0;
}


void EventDropUpValInfo___ctor_41995024(
        EventDropUpValInfo_o *this,
        int32_t eventId,
        FunctionEntity_o *funcEntity,
        ...
        const MethodInfo *method)
{
  ...
  *(_DWORD *)&v8[-1].fields.isInvalid = eventId;
  sub_1C71354((GrandQuestFolderBoardItem_o *)v8, (int32_t)funcEntity, v9, v10, v11, v12, v13, v14);
