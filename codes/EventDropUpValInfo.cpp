        ...
        const MethodInfo *method)
{
  ...
  *(_DWORD *)&v6[-1].fields.isInvalid = eventId;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)v6, (int32_t)funcEntity, v7, v8);
  LODWORD(v6->monitor) = 0;
}


void __fastcall EventDropUpValInfo___ctor_37663892(
        EventDropUpValInfo_o *this,
        int32_t eventId,
        FunctionEntity_o *funcEntity,
        ...
        const MethodInfo *method)
{
  ...
  *(_DWORD *)&v8[-1].fields.isInvalid = eventId;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)v8, (int32_t)funcEntity, v9, v10);
