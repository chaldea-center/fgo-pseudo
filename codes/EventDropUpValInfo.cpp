        ...
        const MethodInfo *method)
{
  ...
  *(_DWORD *)&v6[-1].fields.isInvalid = eventId;
  sub_B0D840((BattleServantConfConponent_o *)v6, (System_Int32_array **)funcEntity, v7, v8, v9, v10, v11, v12);
  LODWORD(v6->monitor) = 0;
}


void __fastcall EventDropUpValInfo___ctor_28902740(
        EventDropUpValInfo_o *this,
        int32_t eventId,
        FunctionEntity_o *funcEntity,
        ...
        const MethodInfo *method)
{
  ...
  *(_DWORD *)&v8[-1].fields.isInvalid = eventId;
  sub_B0D840((BattleServantConfConponent_o *)v8, (System_Int32_array **)funcEntity, v9, v10, v11, v12, v13, v14);
