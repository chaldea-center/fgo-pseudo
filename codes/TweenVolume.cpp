        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7BFE0 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_UITweener_Begin_TweenVolume___);
    byte_4E7BFE0 = 1;
  }
  v7 = (TweenVolume_o *)UITweener__Begin_object_(
                          go,
                          duration,
                          (const MethodInfo_332666C *)Method_UITweener_Begin_TweenVolume___);
  if ( !v7 )
    sub_1D0F30C(0, v8);
  v9 = v7;
...
UnityEngine_AudioSource_o *TweenVolume__get_audioSource(TweenVolume_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E7BFDD & 1) == 0 )
  {
    sub_1D0F0B4(&Method_UnityEngine_Component_GetComponent_AudioSource___);
    sub_1D0F0B4(&UnityEngine_Debug_TypeInfo);
    sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    sub_1D0F0B4(&StringLiteral_14821/*"TweenVolume needs an AudioSource to work with"*/);
    byte_4E7BFDD = 1;
  }
  ...
  if ( UnityEngine_Object__op_Equality(mSource, 0, 0) )
  {
    Component_object = UnityEngine_Component__GetComponent_object_(
                         ...
                         (const MethodInfo_3245988 *)Method_UnityEngine_Component_GetComponent_AudioSource___);
    ...
    if ( UnityEngine_Object__op_Equality(v11, 0, 0) )
    {
      ...
      sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.mSource, (int32_t)v12, v13, v14, v15, v16, v17, v18);
      ...
      if ( UnityEngine_Object__op_Equality(v19, 0, 0) )
      {
        ...
        UnityEngine_Debug__LogError_73169928((Il2CppObject *)StringLiteral_14821/*"TweenVolume needs an AudioSource to work with"*/, (UnityEngine_Object_o *)this, 0);
