        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D310AC & 1) == 0 )
  {
    sub_1C94098(&Method_UITweener_Begin_TweenVolume___);
    byte_4D310AC = 1;
  }
  v7 = (TweenVolume_o *)UITweener__Begin_object_(
                          go,
                          duration,
                          (const MethodInfo_3272360 *)Method_UITweener_Begin_TweenVolume___);
  if ( !v7 )
    sub_1C942F0(0, v8);
  v9 = v7;
...
UnityEngine_AudioSource_o *TweenVolume__get_audioSource(TweenVolume_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D310A9 & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_14679/*"TweenVolume needs an AudioSource to work with"*/);
    byte_4D310A9 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Equality(mSource, 0, 0) )
  {
    ...
    if ( UnityEngine_Object__op_Equality(v11, 0, 0) )
    {
      ...
      sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.mSource, (int32_t)v12, v13, v14, v15, v16, v17, v18);
      ...
      if ( UnityEngine_Object__op_Equality(v19, 0, 0) )
      {
        ...
        UnityEngine_Debug__LogError_71922664((Il2CppObject *)StringLiteral_14679/*"TweenVolume needs an AudioSource to work with"*/, (UnityEngine_Object_o *)this, 0);
