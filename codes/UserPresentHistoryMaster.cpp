void __fastcall UserPresentHistoryMaster___ctor(UserPresentHistoryMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A2EC9A & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_UserPresentHistoryMaster__UserPresentHistoryEntity__long___ctor__, method);
    byte_4A2EC9A = 1;
  }
  DataMasterBase_object__object__long____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    155,
    (const MethodInfo_30FF8EC *)Method_DataMasterBase_UserPresentHistoryMaster__UserPresentHistoryEntity__long___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EC9B & 1) == 0 )
  {
    sub_1B761C0(&System_Converter_DataEntityBase__UserPresentHistoryEntity__TypeInfo, method);
    sub_1B761C0(&Method_System_Collections_Generic_List_UserPresentHistoryEntity__Sort__, v3);
    sub_1B761C0(&Method_ObservableCollectionExtensions_ConvertAll_DataEntityBase__UserPresentHistoryEntity___, v4);
    sub_1B761C0(&Method_UserPresentHistoryMaster___c__GetEntityList_b__1_0__, v5);
    sub_1B761C0(&UserPresentHistoryMaster___c_TypeInfo, v6);
    byte_4A2EC9B = 1;
  }
  ...
  if ( !_9__1_0 )
  {
    ...
    _9__1_0 = (System_Converter_TInput__TOutput__o *)sub_1B7640C(System_Converter_DataEntityBase__UserPresentHistoryEntity__TypeInfo);
  ...
  v14 = (System_Collections_Generic_List_object__o *)ObservableCollectionExtensions__ConvertAll_object__object_(
                                                       ...
                                                       (const MethodInfo_2EE622C *)Method_ObservableCollectionExtensions_ConvertAll_DataEntityBase__UserPresentHistoryEntity___);
  if ( !v14 )
    sub_1B7641C(0LL, v15);
  v16 = (System_Collections_Generic_List_UserPresentHistoryEntity__o *)v14;
  System_Collections_Generic_List_object___Sort(
    v14,
    (const MethodInfo_34D8FB8 *)Method_System_Collections_Generic_List_UserPresentHistoryEntity__Sort__);
  return v16;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EC9C & 1) == 0 )
  {
    sub_1B761C0(&System_Collections_Generic_List_Enumerator_UserPresentHistoryEntity__TypeInfo, method);
    sub_1B761C0(&Method_System_Collections_Generic_List_UserPresentHistoryEntity__GetEnumerator__, v3);
    byte_4A2EC9C = 1;
  }
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    &v11,
    EntityList,
    (const MethodInfo_34D80CC *)Method_System_Collections_Generic_List_UserPresentHistoryEntity__GetEnumerator__);
  v10 = v11;
...
void __fastcall UserPresentHistoryMaster___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A2EC9D & 1) == 0 )
  {
    sub_1B761C0(&UserPresentHistoryMaster___c_TypeInfo, v1);
    byte_4A2EC9D = 1;
  }
  v2 = (Il2CppObject *)sub_1B7640C(UserPresentHistoryMaster___c_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EC9E & 1) == 0 )
  {
    sub_1B761C0(&UserPresentHistoryEntity_TypeInfo, entity);
    byte_4A2EC9E = 1;
  }
  if ( !entity )
    return 0LL;
