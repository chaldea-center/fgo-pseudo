...
LABEL_15:
    ...
    else if ( (unsigned int)value1 <= 0x1A )
    {
      ...
      if ( value1 == 23 )
      {
        if ( !DataManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
        v22 = DataManager__GetMaster_object_((const MethodInfo_2F9F43C *)Method_DataManager_GetMaster_ServantLimitImageMaster___);
        FixSvtId = (UserServantCollectionEntity_o *)ServantVoicePatternEntity__GetFixSvtId(this, limitCount, v23);
        if ( v22 )
        {
          if ( limitCount >= 11 )
            v25 = limitCount;
          ...
          ServantLimitCountSealAfter = ServantLimitImageMaster__GetServantLimitCountSealAfter(
                                         ...
                                         v25,
                                         v24);
          if ( ServantLimitCountSealAfter != v25 )
          {
        ...
        const MethodInfo *method)
{
  if ( (byte_4BC8473 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataEntityBase_CreateMultiplePK_int__int__string___, *(_QWORD *)&svtId);
    byte_4BC8473 = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__object_(
           ...
           (const MethodInfo_2F9DC6C *)Method_DataEntityBase_CreateMultiplePK_int__int__string___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC8475 & 1) == 0 )
  {
    sub_1C1ABD4(&BalanceConfig_TypeInfo, *(_QWORD *)&dispLimitCount);
    sub_1C1ABD4(&Method_DataManager_GetMaster_ServantTransformMaster___, v5);
