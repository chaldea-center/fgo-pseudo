...
LABEL_22:
      ...
      if ( value1 == 23 )
      {
        if ( !DataManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
        v21 = DataManager__GetMaster_object_((const MethodInfo_2E8E1C8 *)Method_DataManager_GetMaster_ServantLimitImageMaster___);
        ...
        const MethodInfo *method)
{
  if ( (byte_4A706FA & 1) == 0 )
  {
    sub_1B90010(&Method_DataEntityBase_CreateMultiplePK_int__int__string___, *(_QWORD *)&svtId);
    byte_4A706FA = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__object_(
           ...
           (const MethodInfo_2E8C9F8 *)Method_DataEntityBase_CreateMultiplePK_int__int__string___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A706FC & 1) == 0 )
  {
    sub_1B90010(&BalanceConfig_TypeInfo, *(_QWORD *)&dispLimitCount);
    sub_1B90010(&Method_DataManager_GetMaster_ServantTransformMaster___, v5);
