...
LABEL_26:
      ...
      if ( value1 == 23 )
      {
        if ( !DataManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
        v23 = DataManager__GetMaster_object_((const MethodInfo_2F01AD0 *)Method_DataManager_GetMaster_ServantLimitImageMaster___);
        ...
        const MethodInfo *method)
{
  if ( (byte_49BB882 & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataEntityBase_CreateMultiplePK_int__int__string___, *(_QWORD *)&svtId);
    byte_49BB882 = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__object_(
           ...
           (const MethodInfo_2F00264 *)Method_DataEntityBase_CreateMultiplePK_int__int__string___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BB884 & 1) == 0 )
  {
    sub_1B4CF90(&BalanceConfig_TypeInfo, *(_QWORD *)&dispLimitCount);
    sub_1B4CF90(&Method_DataManager_GetMaster_ServantTransformMaster___, v5);
