        ...
        const MethodInfo *method)
{
  if ( (byte_4B37B31 & 1) == 0 )
  {
    sub_1BD3458(&Method_DataEntityBase_CreateMultiplePK_int__int__string___, *(_QWORD *)&svtId);
    byte_4B37B31 = 1;
  }
  return DataEntityBase__CreateMultiplePK_int__int__object_(
           ...
           (const MethodInfo_2F2FE60 *)Method_DataEntityBase_CreateMultiplePK_int__int__string___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B37B33 & 1) == 0 )
  {
    sub_1BD3458(&BalanceConfig_TypeInfo, *(_QWORD *)&dispLimitCount);
    sub_1BD3458(&Method_DataManager_GetMaster_ServantTransformMaster___, v5);
