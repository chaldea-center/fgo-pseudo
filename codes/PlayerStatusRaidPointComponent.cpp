void PlayerStatusRaidPointComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4D2D489 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&PlayerStatusRaidPointComponent_TypeInfo);
    sub_1C93AD4(&string___TypeInfo);
    sub_1C93AD4(&StringLiteral_23234/*"raid_point_old"*/);
    sub_1C93AD4(&StringLiteral_23231/*"raid_point"*/);
    sub_1C93AD4(&StringLiteral_23235/*"raid_point_over"*/);
    sub_1C93AD4(&StringLiteral_23988/*"status_raid_point_frame"*/);
    sub_1C93AD4(&StringLiteral_23233/*"raid_point_frame_old"*/);
    sub_1C93AD4(&StringLiteral_23236/*"raid_point_over_old"*/);
    byte_4D2D489 = 1;
  }
  ...
  if ( !*(_DWORD *)(v1 + 24) )
    goto LABEL_15;
  v10 = StringLiteral_23233/*"raid_point_frame_old"*/;
  *(_QWORD *)(v1 + 32) = StringLiteral_23233/*"raid_point_frame_old"*/;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)(v1 + 32), v10, v3, v4, v5, v6, v7, v8);
  if ( *(_DWORD *)(v9 + 24) <= 1u )
    goto LABEL_15;
  v17 = StringLiteral_23988/*"status_raid_point_frame"*/;
  *(_QWORD *)(v9 + 40) = StringLiteral_23988/*"status_raid_point_frame"*/;
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&static_fields->RP_SPNAME_FRAME, v9, v19, v20, v21, v22, v23, v24);
  v1 = sub_1C93B7C(string___TypeInfo, 2);
  if ( !v1 )
    goto LABEL_16;
  v31 = v1;
  if ( !*(_DWORD *)(v1 + 24) )
    goto LABEL_15;
  v32 = StringLiteral_23234/*"raid_point_old"*/;
  *(_QWORD *)(v1 + 32) = StringLiteral_23234/*"raid_point_old"*/;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)(v1 + 32), v32, v25, v26, v27, v28, v29, v30);
  if ( *(_DWORD *)(v31 + 24) <= 1u )
    goto LABEL_15;
  v39 = StringLiteral_23231/*"raid_point"*/;
  *(_QWORD *)(v31 + 40) = StringLiteral_23231/*"raid_point"*/;
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&v40->RP_SPNAME_NORMAL, v31, v41, v42, v43, v44, v45, v46);
  v1 = sub_1C93B7C(string___TypeInfo, 2);
  if ( !v1 )
    goto LABEL_16;
  v53 = v1;
  if ( !*(_DWORD *)(v1 + 24)
    || (v54 = StringLiteral_23236/*"raid_point_over_old"*/,
        *(_QWORD *)(v1 + 32) = StringLiteral_23236/*"raid_point_over_old"*/,
        sub_1C93A78((GrandQuestFolderBoardItem_o *)(v1 + 32), v54, v47, v48, v49, v50, v51, v52),
        *(_DWORD *)(v53 + 24) <= 1u) )
  {
LABEL_15:
    sub_1C93D34(v1);
  }
  v61 = StringLiteral_23235/*"raid_point_over"*/;
  *(_QWORD *)(v53 + 40) = StringLiteral_23235/*"raid_point_over"*/;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)(v53 + 40), v61, v55, v56, v57, v58, v59, v60);
  v62 = PlayerStatusRaidPointComponent_TypeInfo->static_fields;
  v62->RP_SPNAME_OVER = (struct System_String_array *)v53;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&v62->RP_SPNAME_OVER, v53, v63, v64, v65, v66, v67, v68);
...
LABEL_16:
  ...
  *(_DWORD *)(v1 + 32) = 5;
  ...
  v76->RP_OFFSET = v75;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&v76->RP_OFFSET, (int32_t)v75, v69, v70, v71, v72, v73, v74);
}
...
LABEL_25:
      sub_1C93D2C(raidPointSp, *(_QWORD *)&dispType);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C93AD4(&PlayerStatusRaidPointComponent_TypeInfo);
    sub_1C93AD4(&StringLiteral_11030/*"RAID_MARKDISP_STEP"*/);
    byte_4D2D487 = 1;
  }
  ...
  v11 = System_String__Concat_64425724(name, v10, 0);
  UnityEngine_Object__set_name(v8, v11, 0);
  v12 = v21 - 1;
  Value = ConstantMaster__getValue((System_String_o *)StringLiteral_11030/*"RAID_MARKDISP_STEP"*/, 0);
  if ( Value <= 0 )
  {
