void __fastcall PlayerStatusRaidPointComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AFEC16 & 1) == 0 )
  {
    ...
    sub_1BC3008(&PlayerStatusRaidPointComponent_TypeInfo, v2);
    sub_1BC3008(&string___TypeInfo, v3);
    sub_1BC3008(&StringLiteral_22723/*"raid_point_old"*/, v4);
    sub_1BC3008(&StringLiteral_22720/*"raid_point"*/, v5);
    sub_1BC3008(&StringLiteral_22724/*"raid_point_over"*/, v6);
    sub_1BC3008(&StringLiteral_23461/*"status_raid_point_frame"*/, v7);
    sub_1BC3008(&StringLiteral_22722/*"raid_point_frame_old"*/, v8);
    sub_1BC3008(&StringLiteral_22725/*"raid_point_over_old"*/, v9);
    byte_4AFEC16 = 1;
  }
  PlayerStatusRaidPointComponent_TypeInfo->static_fields->RAID_MARKDISP_STEP_DEFAULT = 5;
  v10 = sub_1BC30B0(string___TypeInfo, 2LL);
  if ( !v10 )
    goto LABEL_16;
  v14 = v10;
  if ( !*(_DWORD *)(v10 + 24) )
    goto LABEL_15;
  v15 = StringLiteral_22722/*"raid_point_frame_old"*/;
  *(_QWORD *)(v10 + 32) = StringLiteral_22722/*"raid_point_frame_old"*/;
  sub_1BC2FAC((CGThumbnailListItem_o *)(v10 + 32), v15, v12, v13);
  if ( *(_DWORD *)(v14 + 24) <= 1u )
    goto LABEL_15;
  v17 = StringLiteral_23461/*"status_raid_point_frame"*/;
  *(_QWORD *)(v14 + 40) = StringLiteral_23461/*"status_raid_point_frame"*/;
  sub_1BC2FAC((CGThumbnailListItem_o *)(v14 + 40), v17, v12, v16);
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&static_fields->RP_SPNAME_FRAME, v14, v19, v20);
  v10 = sub_1BC30B0(string___TypeInfo, 2LL);
  if ( !v10 )
    goto LABEL_16;
  v22 = v10;
  if ( !*(_DWORD *)(v10 + 24) )
    goto LABEL_15;
  v23 = StringLiteral_22723/*"raid_point_old"*/;
  *(_QWORD *)(v10 + 32) = StringLiteral_22723/*"raid_point_old"*/;
  sub_1BC2FAC((CGThumbnailListItem_o *)(v10 + 32), v23, v12, v21);
  if ( *(_DWORD *)(v22 + 24) <= 1u )
    goto LABEL_15;
  v25 = StringLiteral_22720/*"raid_point"*/;
  *(_QWORD *)(v22 + 40) = StringLiteral_22720/*"raid_point"*/;
  sub_1BC2FAC((CGThumbnailListItem_o *)(v22 + 40), v25, v12, v24);
  v26 = PlayerStatusRaidPointComponent_TypeInfo->static_fields;
  v26->RP_SPNAME_NORMAL = (struct System_String_array *)v22;
  sub_1BC2FAC((CGThumbnailListItem_o *)&v26->RP_SPNAME_NORMAL, v22, v27, v28);
  v10 = sub_1BC30B0(string___TypeInfo, 2LL);
  if ( !v10 )
    goto LABEL_16;
  v30 = v10;
  if ( !*(_DWORD *)(v10 + 24)
    || (v31 = StringLiteral_22725/*"raid_point_over_old"*/,
        *(_QWORD *)(v10 + 32) = StringLiteral_22725/*"raid_point_over_old"*/,
        sub_1BC2FAC((CGThumbnailListItem_o *)(v10 + 32), v31, v12, v29),
        *(_DWORD *)(v30 + 24) <= 1u) )
  {
LABEL_15:
    sub_1BC326C(v10, v11, v12);
  }
  v33 = StringLiteral_22724/*"raid_point_over"*/;
  *(_QWORD *)(v30 + 40) = StringLiteral_22724/*"raid_point_over"*/;
  sub_1BC2FAC((CGThumbnailListItem_o *)(v30 + 40), v33, v12, v32);
  v34 = PlayerStatusRaidPointComponent_TypeInfo->static_fields;
  v34->RP_SPNAME_OVER = (struct System_String_array *)v30;
  sub_1BC2FAC((CGThumbnailListItem_o *)&v34->RP_SPNAME_OVER, v30, v35, v36);
  v10 = sub_1BC30B0(int___TypeInfo, 2LL);
  if ( !v10 )
LABEL_16:
    sub_1BC3264(v10, v11);
  ...
  *(_DWORD *)(v10 + 32) = 5;
  ...
  v38->RP_OFFSET = v11;
  sub_1BC2FAC((CGThumbnailListItem_o *)&v38->RP_OFFSET, (int32_t)v11, v12, v37);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFEC15 & 1) == 0 )
  {
    sub_1BC3008(&PlayerStatusRaidPointComponent_TypeInfo, *(_QWORD *)&dispType);
    byte_4AFEC15 = 1;
  }
  switch ( dispType )
  {
...
LABEL_20:
      ...
      if ( (unsigned int)BpType >= *(_DWORD *)(v8 + 24) )
        sub_1BC326C(raidPointSp, *(_QWORD *)&dispType, v6);
      if ( !v7 )
        goto LABEL_25;
...
LABEL_25:
      sub_1BC3264(raidPointSp, *(_QWORD *)&dispType);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFEC14 & 1) == 0 )
  {
    sub_1BC3008(&PlayerStatusRaidPointComponent_TypeInfo, *(_QWORD *)&index);
    sub_1BC3008(&StringLiteral_10858/*"RAID_MARKDISP_STEP"*/, v6);
    byte_4AFEC14 = 1;
  }
  ...
  v12 = System_String__Concat_62348648(name, v11, 0LL);
  UnityEngine_Object__set_name(v9, v12, 0LL);
  v13 = v23 - 1;
  Value = ConstantMaster__getValue((System_String_o *)StringLiteral_10858/*"RAID_MARKDISP_STEP"*/, 0LL);
  if ( Value <= 0 )
  {
