...
void __fastcall RequestResultDialog__Close(RequestResultDialog_o *this, const MethodInfo *method)
{
  ...
  RequestResultDialog__Close_34264824(this, 0LL, v2);
}


void __fastcall RequestResultDialog__Close_34264824(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18656 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_RequestResultDialog_EndClose__, v6);
    byte_4B18656 = 1;
  }
...
void __fastcall RequestResultDialog__Init(RequestResultDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B18650 & 1) == 0 )
  {
    this = (RequestResultDialog_o *)sub_1BCAFF8(&StringLiteral_1/*""*/, method);
    byte_4B18650 = 1;
  }
...
void __fastcall RequestResultDialog__OnClickCancel(RequestResultDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B18659 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_RequestResultDialog_OnClickCancel__, method);
    byte_4B18659 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_RequestResultDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BCB010(Method_RequestResultDialog_OnClickCancel__);
...
void __fastcall RequestResultDialog__OnClickDecide(RequestResultDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B18658 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_RequestResultDialog_OnClickDecide__, method);
    byte_4B18658 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_RequestResultDialog_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BCB010(Method_RequestResultDialog_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BCAFDC(v3, v3[4]);
...
void __fastcall RequestResultDialog__OnClickOk(RequestResultDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B18657 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_RequestResultDialog_OnClickOk__, method);
    byte_4B18657 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_RequestResultDialog_OnClickOk__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BCB010(Method_RequestResultDialog_OnClickOk__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BCAFDC(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
    RequestResultDialog__CallOnDecide(this, 1, v5);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18651 & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_1/*""*/, message);
    byte_4B18651 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18652 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_RequestResultDialog_EndOpen__, v14);
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.onDecide, (int32_t)onDecide, v19, v20);
  ...
  v40 = (RequestResultDialog_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3650/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
  ...
  if ( !KeepPanelDepth )
LABEL_20:
    sub_1BCB254(KeepPanelDepth, v17);
  UnityEngine_GameObject__SetActive(KeepPanelDepth, 1, 0LL);
  this->fields.isButtonEnable = 0;
...
void __fastcall RequestResultDialog__OpenAddMsg_34263808(
        RequestResultDialog_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18654 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_RequestResultDialog_EndOpen__, v21);
    sub_1BCAFF8(&StringLiteral_3650/*"COMMON_CONFIRM_CLOSE"*/, v22);
  ...
  UnityEngine_GameObject__SetActive(KeepPanelDepth, 0, 0LL);
  this->fields.onDecide = onDecide;
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.onDecide, (int32_t)onDecide, v28, v29);
  KeepPanelDepth = (UnityEngine_GameObject_o *)System_String__IsNullOrEmpty(addMessage, 0LL);
...
LABEL_27:
    sub_1BCB254(KeepPanelDepth, v26);
  }
  UnityEngine_GameObject__SetActive(KeepPanelDepth, 1, 0LL);
  KeepPanelDepth = this->fields.cancelButtonObj;
  if ( !KeepPanelDepth )
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v52 = (RequestResultDialog_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3650/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
...
void __fastcall RequestResultDialog__Open_34263656(
        RequestResultDialog_o *this,
        System_String_o *title,
        System_String_o *message,
        System_Action_bool__o *onDecide,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18653 & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_1/*""*/, title);
    byte_4B18653 = 1;
  }
  RequestResultDialog__OpenAddMsg_34263808(
    this,
    title,
    message,
    (System_String_o *)StringLiteral_1/*""*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1865C & 1) == 0 )
  {
    sub_1BCAFF8(&UnityEngine_Object_TypeInfo, panel);
    byte_4B1865C = 1;
  }
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1865E & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_15518/*"Window/OkBtn"*/, v3);
    byte_4B1865E = 1;
  }
  ...
  if ( UnityEngine_GameObject__get_activeInHierarchy(cancelButtonObj, 0LL) )
    v5 = &StringLiteral_15507/*"Window/CancelButton"*/;
  else
    v5 = &StringLiteral_15518/*"Window/OkBtn"*/;
