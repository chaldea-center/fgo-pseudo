...
void __fastcall RequestResultDialog__Close(RequestResultDialog_o *this, const MethodInfo *method)
{
  ...
  RequestResultDialog__Close_33441264(this, 0LL, v2);
}


void __fastcall RequestResultDialog__Close_33441264(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62ED2 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_RequestResultDialog_EndClose__, v10);
    byte_4B62ED2 = 1;
  }
...
void __fastcall RequestResultDialog__Init(RequestResultDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B62ECC & 1) == 0 )
  {
    this = (RequestResultDialog_o *)sub_1BE4ACC(&StringLiteral_1/*""*/, method);
    byte_4B62ECC = 1;
  }
...
void __fastcall RequestResultDialog__OnClickCancel(RequestResultDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B62ED5 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_RequestResultDialog_OnClickCancel__, method);
    byte_4B62ED5 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_RequestResultDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BE4AE4(Method_RequestResultDialog_OnClickCancel__);
...
void __fastcall RequestResultDialog__OnClickDecide(RequestResultDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B62ED4 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_RequestResultDialog_OnClickDecide__, method);
    byte_4B62ED4 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_RequestResultDialog_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BE4AE4(Method_RequestResultDialog_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BE4AB0(v3, v3[4]);
...
void __fastcall RequestResultDialog__OnClickOk(RequestResultDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B62ED3 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_RequestResultDialog_OnClickOk__, method);
    byte_4B62ED3 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_RequestResultDialog_OnClickOk__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BE4AE4(Method_RequestResultDialog_OnClickOk__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BE4AB0(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
    RequestResultDialog__CallOnDecide(this, 1, v5);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62ECD & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_1/*""*/, message);
    byte_4B62ECD = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62ECE & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_RequestResultDialog_EndOpen__, v14);
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.onDecide, (int64_t)onDecide, v19, v20, v21, v22, v23, v24);
  ...
  v44 = (RequestResultDialog_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3796/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
  ...
  if ( !KeepPanelDepth )
LABEL_20:
    sub_1BE4D28(KeepPanelDepth, v17);
  UnityEngine_GameObject__SetActive(KeepPanelDepth, 1, 0LL);
  this->fields.isButtonEnable = 0;
...
void __fastcall RequestResultDialog__OpenAddMsg_33440248(
        RequestResultDialog_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62ED0 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_RequestResultDialog_EndOpen__, v21);
    sub_1BE4ACC(&StringLiteral_3796/*"COMMON_CONFIRM_CLOSE"*/, v22);
  ...
  UnityEngine_GameObject__SetActive(KeepPanelDepth, 0, 0LL);
  this->fields.onDecide = onDecide;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.onDecide, (int64_t)onDecide, v28, v29, v30, v31, v32, v33);
  KeepPanelDepth = (UnityEngine_GameObject_o *)System_String__IsNullOrEmpty(addMessage, 0LL);
...
LABEL_27:
    sub_1BE4D28(KeepPanelDepth, v26);
  }
  UnityEngine_GameObject__SetActive(KeepPanelDepth, 1, 0LL);
  KeepPanelDepth = this->fields.cancelButtonObj;
  if ( !KeepPanelDepth )
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v56 = (RequestResultDialog_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3796/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
...
void __fastcall RequestResultDialog__Open_33440096(
        RequestResultDialog_o *this,
        System_String_o *title,
        System_String_o *message,
        System_Action_bool__o *onDecide,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62ECF & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_1/*""*/, title);
    byte_4B62ECF = 1;
  }
  RequestResultDialog__OpenAddMsg_33440248(
    this,
    title,
    message,
    (System_String_o *)StringLiteral_1/*""*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62ED8 & 1) == 0 )
  {
    sub_1BE4ACC(&UnityEngine_Object_TypeInfo, panel);
    byte_4B62ED8 = 1;
  }
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62EDA & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_15859/*"Window/OkBtn"*/, v3);
    byte_4B62EDA = 1;
  }
  ...
  if ( UnityEngine_GameObject__get_activeInHierarchy(cancelButtonObj, 0LL) )
    v5 = &StringLiteral_15848/*"Window/CancelButton"*/;
  else
    v5 = &StringLiteral_15859/*"Window/OkBtn"*/;
