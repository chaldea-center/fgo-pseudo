void __fastcall UserExchangeSvtMaster___ctor(UserExchangeSvtMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A2EC0B & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_UserExchangeSvtMaster__UserExchangeSvtEntity__int___ctor__, method);
    byte_4A2EC0B = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    464,
    (const MethodInfo_30FF740 *)Method_DataMasterBase_UserExchangeSvtMaster__UserExchangeSvtEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EC0C & 1) == 0 )
  {
    ...
    sub_1B761C0(&UserExchangeSvtEntity_TypeInfo, v12);
    byte_4A2EC0C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EC13 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMasterData_UserServantCollectionMaster___, *(_QWORD *)&eventId);
           ...
           0LL) )
    {
      ...
      if ( UserServantCollectionEntity__IsFinded(entity, 0LL) )
      {
        ...
        if ( max_length << 32 >= 1 )
        {
          ...
          {
            if ( !max_length )
              sub_1B76424(SkillLevelList, v22);
            v27 = *v25++;
            v26 = v27;
            --v24;
            --max_length;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EC0D & 1) == 0 )
  {
    ...
    sub_1B761C0(&UserExchangeSvtEntity_TypeInfo, v6);
    byte_4A2EC0D = 1;
  }
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
        ...
        const MethodInfo *method)
{
  ...
  v8 = DataMasterBase_object__object__int___TryGetEntity(
         ...
         &entity,
         eventId,
         (const MethodInfo_30FF7D4 *)Method_DataMasterBase_UserExchangeSvtMaster__UserExchangeSvtEntity__int__TryGetEntity__);
  if ( v8 )
  {
    if ( !entity )
      sub_1B7641C(v8, v9);
