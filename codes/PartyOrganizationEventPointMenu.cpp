...
void PartyOrganizationEventPointMenu__Close(PartyOrganizationEventPointMenu_o *this, const MethodInfo *method)
{
  ...
  PartyOrganizationEventPointMenu__Close_34254660(this, 0, v2);
}


void PartyOrganizationEventPointMenu__Close_34254660(
        PartyOrganizationEventPointMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C5276D & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_PartyOrganizationEventPointMenu_EndClose__);
    byte_4C5276D = 1;
  }
...
LABEL_9:
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&eventPointListViewManager->fields.eventMargeUpValInfoList, 0, v5, v6);
  this->fields.state = 0;
...
void PartyOrganizationEventPointMenu__OnClickCancel(PartyOrganizationEventPointMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C5276E & 1) == 0 )
  {
    sub_1C3E564(&Method_PartyOrganizationEventPointMenu_OnClickCancel__);
    byte_4C5276E = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationEventPointMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3E57C(Method_PartyOrganizationEventPointMenu_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C5276C & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_PartyOrganizationEventPointMenu_EndOpen__);
    sub_1C3E564(&StringLiteral_10230/*"PARTY_ORGANIZATION_EVENT_MEMBER_ANNOTATION"*/);
    sub_1C3E564(&StringLiteral_10231/*"PARTY_ORGANIZATION_EVENT_MEMBER_CLOSE"*/);
    sub_1C3E564(&StringLiteral_10237/*"PARTY_ORGANIZATION_EVENT_MEMBER_TITLE"*/);
    byte_4C5276C = 1;
  }
  if ( !this->fields.state )
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10237/*"PARTY_ORGANIZATION_EVENT_MEMBER_TITLE"*/, 0);
    if ( !titleLabel )
      goto LABEL_17;
    UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0);
    annotationLabel = this->fields.annotationLabel;
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10230/*"PARTY_ORGANIZATION_EVENT_MEMBER_ANNOTATION"*/, 0);
    if ( !annotationLabel )
      goto LABEL_17;
    UILabel__set_text(annotationLabel, (System_String_o *)gameObject, 0);
    closeLabel = this->fields.closeLabel;
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10231/*"PARTY_ORGANIZATION_EVENT_MEMBER_CLOSE"*/, 0);
    if ( !closeLabel )
      goto LABEL_17;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C52769 & 1) == 0 )
  {
    sub_1C3E564(&PartyOrganizationEventPointMenu_CallbackFunc_TypeInfo);
    byte_4C52769 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  ...
  v11 = (PartyOrganizationEventPointMenu_o *)sub_1C3EA80(v8);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1A7D2B0;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A7D268;
}
