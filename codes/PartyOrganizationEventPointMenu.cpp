...
void PartyOrganizationEventPointMenu__Close(PartyOrganizationEventPointMenu_o *this, const MethodInfo *method)
{
  ...
  PartyOrganizationEventPointMenu__Close_34830768(this, 0, v2);
}


void PartyOrganizationEventPointMenu__Close_34830768(
        PartyOrganizationEventPointMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2C34F & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_PartyOrganizationEventPointMenu_EndClose__);
    byte_4D2C34F = 1;
  }
...
void PartyOrganizationEventPointMenu__OnClickCancel(PartyOrganizationEventPointMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2C350 & 1) == 0 )
  {
    sub_1C93AD4(&Method_PartyOrganizationEventPointMenu_OnClickCancel__);
    byte_4D2C350 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationEventPointMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C93AEC(Method_PartyOrganizationEventPointMenu_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2C34E & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_PartyOrganizationEventPointMenu_EndOpen__);
    sub_1C93AD4(&StringLiteral_10289/*"PARTY_ORGANIZATION_EVENT_MEMBER_ANNOTATION"*/);
    sub_1C93AD4(&StringLiteral_10290/*"PARTY_ORGANIZATION_EVENT_MEMBER_CLOSE"*/);
    sub_1C93AD4(&StringLiteral_10296/*"PARTY_ORGANIZATION_EVENT_MEMBER_TITLE"*/);
    byte_4D2C34E = 1;
  }
  if ( !this->fields.state )
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10296/*"PARTY_ORGANIZATION_EVENT_MEMBER_TITLE"*/, 0);
    if ( !titleLabel )
      goto LABEL_17;
    UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0);
    annotationLabel = this->fields.annotationLabel;
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10289/*"PARTY_ORGANIZATION_EVENT_MEMBER_ANNOTATION"*/, 0);
    if ( !annotationLabel )
      goto LABEL_17;
    UILabel__set_text(annotationLabel, (System_String_o *)gameObject, 0);
    closeLabel = this->fields.closeLabel;
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10290/*"PARTY_ORGANIZATION_EVENT_MEMBER_CLOSE"*/, 0);
    if ( !closeLabel )
      goto LABEL_17;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2C34B & 1) == 0 )
  {
    sub_1C93AD4(&PartyOrganizationEventPointMenu_CallbackFunc_TypeInfo);
    byte_4D2C34B = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  ...
  v11 = (PartyOrganizationEventPointMenu_o *)sub_1C940C8(v8);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1AC2FDC;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1AC2F94;
}
