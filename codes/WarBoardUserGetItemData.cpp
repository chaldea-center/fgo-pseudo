        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC35C & 1) == 0 )
  {
    sub_1B64870(&Method_JsonManager_DeserializeArray_WarBoardUserGetItemData___, method);
    sub_1B64870(&JsonManager_TypeInfo, v3);
    sub_1B64870(&StringLiteral_15958/*"[{0}]"*/, v4);
    byte_49FC35C = 1;
  }
  ...
  result = (WarBoardUserGetItemData_o *)JsonManager__DeserializeArray_object_(
                                          v5,
                                          (const MethodInfo_2EA119C *)Method_JsonManager_DeserializeArray_WarBoardUserGetItemData___);
  if ( result )
  {
