        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFFC83 & 1) == 0 )
  {
    sub_1BC3008(&Method_JsonManager_DeserializeArray_WarBoardUserGetItemData___, method);
  ...
  result = (WarBoardUserGetItemData_o *)JsonManager__DeserializeArray_object_(
                                          v5,
                                          (const MethodInfo_306D91C *)Method_JsonManager_DeserializeArray_WarBoardUserGetItemData___);
  if ( result )
  {
