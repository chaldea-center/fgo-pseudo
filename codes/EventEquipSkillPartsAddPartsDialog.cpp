        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC161A & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_EventEquipSkillPartsAddPartsDialog_OnClickCloseButton__);
    sub_1C713B0(&Method_EventEquipSkillPartsAddPartsDialog__OnClickCloseButton_b__9_0__);
    byte_4CC161A = 1;
  }
  if ( this->fields.baseState == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_EventEquipSkillPartsAddPartsDialog_OnClickCloseButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C713C8(Method_EventEquipSkillPartsAddPartsDialog_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC1619 & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_1913/*"ADD_PARTS_DIALOG_TITLE"*/);
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_1913/*"ADD_PARTS_DIALOG_TITLE"*/, 0);
  if ( !titleLabel )
    goto LABEL_18;
