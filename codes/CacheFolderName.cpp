void __fastcall CacheFolderName___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FD432 & 1) == 0 )
  {
    sub_1B64870(&CacheFolderName_TypeInfo, v1);
    sub_1B64870(&Method_System_Collections_Generic_Dictionary_CacheFolderName_FOLDER_NAME__string__Add__, v2);
    sub_1B64870(&Method_System_Collections_Generic_Dictionary_CacheFolderName_FOLDER_NAME__string___ctor__, v3);
    sub_1B64870(&System_Collections_Generic_Dictionary_CacheFolderName_FOLDER_NAME__string__TypeInfo, v4);
    sub_1B64870(&StringLiteral_8858/*"MasterDataCaches"*/, v5);
    sub_1B64870(&StringLiteral_17097/*"bfaa"*/, v6);
    sub_1B64870(&StringLiteral_16555/*"a77d"*/, v7);
    sub_1B64870(&StringLiteral_10540/*"PaymentHistorys"*/, v8);
    sub_1B64870(&StringLiteral_18365/*"d713"*/, v9);
    sub_1B64870(&StringLiteral_2488/*"AssetCaches"*/, v10);
    byte_49FD432 = 1;
  }
  v11 = (System_Collections_Generic_Dictionary_TKey__TValue__o *)sub_1B64ABC(System_Collections_Generic_Dictionary_CacheFolderName_FOLDER_NAME__string__TypeInfo);
  System_Collections_Generic_Dictionary_Int32Enum__object____ctor(
    v11,
    (const MethodInfo_3154148 *)Method_System_Collections_Generic_Dictionary_CacheFolderName_FOLDER_NAME__string___ctor__);
  if ( !v11
    || (System_Collections_Generic_Dictionary_Int32Enum__object___Add(
          v11,
          0,
          (Il2CppObject *)StringLiteral_2488/*"AssetCaches"*/,
          (const MethodInfo_3154B1C *)Method_System_Collections_Generic_Dictionary_CacheFolderName_FOLDER_NAME__string__Add__),
        System_Collections_Generic_Dictionary_Int32Enum__object___Add(
          v11,
          1,
          (Il2CppObject *)StringLiteral_8858/*"MasterDataCaches"*/,
          (const MethodInfo_3154B1C *)Method_System_Collections_Generic_Dictionary_CacheFolderName_FOLDER_NAME__string__Add__),
        System_Collections_Generic_Dictionary_Int32Enum__object___Add(
          v11,
          2,
          (Il2CppObject *)StringLiteral_10540/*"PaymentHistorys"*/,
          (const MethodInfo_3154B1C *)Method_System_Collections_Generic_Dictionary_CacheFolderName_FOLDER_NAME__string__Add__),
        ...
        sub_1B64814(
          ...
          v14,
          v15),
        v16 = (System_Collections_Generic_Dictionary_TKey__TValue__o *)sub_1B64ABC(System_Collections_Generic_Dictionary_CacheFolderName_FOLDER_NAME__string__TypeInfo),
        System_Collections_Generic_Dictionary_Int32Enum__object____ctor(
          v16,
          (const MethodInfo_3154148 *)Method_System_Collections_Generic_Dictionary_CacheFolderName_FOLDER_NAME__string___ctor__),
        !v16) )
  ...
  System_Collections_Generic_Dictionary_Int32Enum__object___Add(
    v16,
    0,
    (Il2CppObject *)StringLiteral_18365/*"d713"*/,
    (const MethodInfo_3154B1C *)Method_System_Collections_Generic_Dictionary_CacheFolderName_FOLDER_NAME__string__Add__);
  System_Collections_Generic_Dictionary_Int32Enum__object___Add(
    v16,
    1,
    (Il2CppObject *)StringLiteral_17097/*"bfaa"*/,
    (const MethodInfo_3154B1C *)Method_System_Collections_Generic_Dictionary_CacheFolderName_FOLDER_NAME__string__Add__);
  System_Collections_Generic_Dictionary_Int32Enum__object___Add(
    v16,
    2,
    (Il2CppObject *)StringLiteral_16555/*"a77d"*/,
    (const MethodInfo_3154B1C *)Method_System_Collections_Generic_Dictionary_CacheFolderName_FOLDER_NAME__string__Add__);
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&static_fields->convertedFolderList, (int32_t)v16, v18, v19);
}
...
System_String_o *__fastcall CacheFolderName__convertFolderName(System_String_o *name, const MethodInfo *method)
{
  ...
  if ( (byte_49FD431 & 1) == 0 )
  {
    sub_1B64870(&CacheFolderName_TypeInfo, method);
    sub_1B64870(&Method_System_Collections_Generic_Dictionary_CacheFolderName_FOLDER_NAME__string__ContainsKey__, v3);
    sub_1B64870(&Method_System_Collections_Generic_Dictionary_CacheFolderName_FOLDER_NAME__string__ContainsValue__, v4);
    sub_1B64870(&Method_System_Collections_Generic_Dictionary_CacheFolderName_FOLDER_NAME__string__GetEnumerator__, v5);
    sub_1B64870(&Method_System_Collections_Generic_Dictionary_CacheFolderName_FOLDER_NAME__string__get_Item__, v6);
    sub_1B64870(
    ...
    sub_1B64870(
      ...
      v9);
    sub_1B64870(&Method_System_Collections_Generic_KeyValuePair_CacheFolderName_FOLDER_NAME__string__get_Key__, v10);
    sub_1B64870(&Method_System_Collections_Generic_KeyValuePair_CacheFolderName_FOLDER_NAME__string__get_Value__, v11);
  ...
  if ( !System_Collections_Generic_Dictionary_Int32Enum__object___ContainsValue(
          folderList,
          (Il2CppObject *)name,
          (const MethodInfo_3154D34 *)Method_System_Collections_Generic_Dictionary_CacheFolderName_FOLDER_NAME__string__ContainsValue__) )
  ...
  if ( !folderList )
LABEL_26:
    sub_1B64ACC(folderList, method);
  System_Collections_Generic_Dictionary_Int32Enum__object___GetEnumerator(
    &v25,
    folderList,
    (const MethodInfo_3154F54 *)Method_System_Collections_Generic_Dictionary_CacheFolderName_FOLDER_NAME__string__GetEnumerator__);
  v26 = v25;
  do
  {
    if ( !System_Collections_Generic_Dictionary_Enumerator_Int32Enum__object___MoveNext(
            &v26,
            (const MethodInfo_3271340 *)Method_System_Collections_Generic_Dictionary_Enumerator_CacheFolderName_FOLDER_NAME__string__MoveNext__) )
    {
      System_Collections_Generic_Dictionary_Enumerator_Int32Enum__object___Dispose(
        &v26,
        (const MethodInfo_3271464 *)Method_System_Collections_Generic_Dictionary_Enumerator_CacheFolderName_FOLDER_NAME__string__Dispose__);
      return (System_String_o *)StringLiteral_1/*""*/;
    }
  ...
  if ( System_Collections_Generic_Dictionary_Int32Enum__object___ContainsKey(
         convertedFolderList,
         key,
         (const MethodInfo_3154D10 *)Method_System_Collections_Generic_Dictionary_CacheFolderName_FOLDER_NAME__string__ContainsKey__) )
  {
    ...
    Item = System_Collections_Generic_Dictionary_Int32Enum__object___get_Item(
             v22,
             key,
             (const MethodInfo_3154A7C *)Method_System_Collections_Generic_Dictionary_CacheFolderName_FOLDER_NAME__string__get_Item__);
  }
  else
  {
...
System_String_o *__fastcall CacheFolderName__getFolderName(int32_t name, const MethodInfo *method)
{
  ...
  if ( (byte_49FD42F & 1) == 0 )
  {
    sub_1B64870(&CacheFolderName_TypeInfo, method);
    sub_1B64870(&Method_System_Collections_Generic_Dictionary_CacheFolderName_FOLDER_NAME__string__ContainsKey__, v3);
    sub_1B64870(&Method_System_Collections_Generic_Dictionary_CacheFolderName_FOLDER_NAME__string__get_Item__, v4);
         ...
         (const MethodInfo_3154D10 *)Method_System_Collections_Generic_Dictionary_CacheFolderName_FOLDER_NAME__string__ContainsKey__) )
  {
    ...
    if ( convertedFolderList )
      return (System_String_o *)System_Collections_Generic_Dictionary_Int32Enum__object___get_Item(
                                  ...
                                  (const MethodInfo_3154A7C *)Method_System_Collections_Generic_Dictionary_CacheFolderName_FOLDER_NAME__string__get_Item__);
LABEL_12:
    sub_1B64ACC(convertedFolderList, method);
  }
  return (System_String_o *)StringLiteral_1/*""*/;
}
