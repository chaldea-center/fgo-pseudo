        ...
        const MethodInfo *method)
{
  ...
  v12 = sub_1C32BC4(&this->fields._path_k__BackingField, path);
  if ( type == 2 )
  {
    if ( !targetBinder )
      goto LABEL_15;
  ...
  else
  {
    if ( type != 1 )
    {
      if ( type )
      {
        ...
        v18 = (System_String_o *)sub_1C32C34(&StringLiteral_7843/*"Invalid bind type."*/);
        System_Exception___ctor_65266192(v17, v18, 0);
        v19 = sub_1C32C34(&Method_CriFsBindRequest__ctor__);
        sub_1C32D48(v17, v19);
      }
      if ( targetBinder )
      {
