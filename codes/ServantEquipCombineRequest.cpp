        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EB961 & 1) == 0 )
  {
    sub_B5D5C4(&StringLiteral_16823/*"baseUserSvtId"*/, baseUsrSvtId, (_DWORD)materialSvtIds, method);
    sub_B5D5C4(&StringLiteral_20688/*"materialUserSvtIds"*/, v7, v8, v9);
    byte_42EB961 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EB960 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&StringLiteral_22770/*"svtEquip/combine"*/, v4, v5, v6);
    byte_42EB960 = 1;
  }
  ...
  return System_String__Concat_44577788(BaseUrl, (System_String_o *)StringLiteral_22770/*"svtEquip/combine"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v12 = ResponseCommandKind__SearchData(41, responseList, 0LL);
  if ( v12
