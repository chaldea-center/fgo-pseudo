        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C239C4 & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_21769/*"noTargetSkipSkill"*/, v7);
    byte_4C239C4 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C239C3 & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_24199/*"verticalDown"*/, v2);
    byte_4C239C3 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63368612(BaseUrl, (System_String_o *)StringLiteral_24199/*"verticalDown"*/, 0LL);
}
