        ...
        const MethodInfo *method)
{
  ...
  Master_object = (EventCooltimeRewardMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2E3B674 *)Method_DataManager_GetMaster_EventCooltimeRewardMaster___);
  if ( !Master_object )
    goto LABEL_12;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF005 & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_8199/*"LEVEL_INFO"*/, v3);
    byte_49FF005 = 1;
  }
  levelLabel = this->fields.levelLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v5 = LocalizationManager__Get((System_String_o *)StringLiteral_8199/*"LEVEL_INFO"*/, 0LL);
