void __fastcall FollowerListRequest___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BC9413 & 1) == 0 )
  {
    sub_1C1ABD4(&FollowerListRequest_TypeInfo, v1);
    byte_4BC9413 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC9411 & 1) == 0 )
  {
    sub_1C1ABD4(&BalanceConfig_TypeInfo, isEnfoceRefresh);
    sub_1C1ABD4(&FollowerListRequest_TypeInfo, v9);
  ...
  if ( !this )
    sub_1C1AE30(v14, v15);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23227/*"refresh"*/, isEnfoceRefresh, v16);
  if ( !isEnfoceRefresh )
    goto LABEL_11;
...
bool __fastcall FollowerListRequest__checkExpirationDate(FollowerListRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC9410 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataManager_GetMaster_UserFollowerMaster___, method);
    sub_1C1ABD4(&DataManager_TypeInfo, v2);
    sub_1C1ABD4(&Method_DataMasterBase_UserFollowerMaster__UserFollowerEntity__long__TryGetSingleEntity__, v3);
    sub_1C1ABD4(&FollowerListRequest_TypeInfo, v4);
    byte_4BC9410 = 1;
  }
  ...
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2F9F43C *)Method_DataManager_GetMaster_UserFollowerMaster___);
  if ( !Master_object )
LABEL_14:
...
bool __fastcall FollowerListRequest__checkRefreshRate(const MethodInfo *method)
{
  ...
  if ( (byte_4BC940C & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&FollowerListRequest_TypeInfo, v2);
...
System_String_o *__fastcall FollowerListRequest__getURL(FollowerListRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC940E & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_19819/*"follower/list"*/, v2);
    byte_4BC940E = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63040368(BaseUrl, (System_String_o *)StringLiteral_19819/*"follower/list"*/, 0LL);
}
