...
bool FollowerListRequest__IsNeedRequestList(FollowerListRequest_o *this, int32_t questId, const MethodInfo *method)
{
  ...
  if ( (byte_4D32504 & 1) == 0 )
  {
    this = (FollowerListRequest_o *)sub_1C93AD4(&FollowerListRequest_TypeInfo);
    byte_4D32504 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !this )
    sub_1C93D2C(v10, v11);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23291/*"refresh"*/, isEnfoceRefresh, v12);
  if ( !isEnfoceRefresh )
    goto LABEL_11;
...
bool FollowerListRequest__checkExpirationDate(FollowerListRequest_o *this, const MethodInfo *method)
{
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_31A49E8 *)Method_DataManager_GetMaster_UserFollowerMaster___);
  if ( !Master_object )
LABEL_14:
...
System_String_o *FollowerListRequest__getURL(FollowerListRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C93AD4(&NetworkManager_TypeInfo);
    sub_1C93AD4(&StringLiteral_19731/*"follower/list"*/);
    byte_4D32501 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64425724(BaseUrl, (System_String_o *)StringLiteral_19731/*"follower/list"*/, 0);
}
