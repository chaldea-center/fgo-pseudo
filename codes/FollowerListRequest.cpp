void __fastcall FollowerListRequest___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A003AD & 1) == 0 )
  {
    sub_1B64A00(&FollowerListRequest_TypeInfo, v1);
    byte_4A003AD = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A003AB & 1) == 0 )
  {
    sub_1B64A00(&BalanceConfig_TypeInfo, isEnfoceRefresh);
    sub_1B64A00(&FollowerListRequest_TypeInfo, v9);
...
bool __fastcall FollowerListRequest__checkExpirationDate(FollowerListRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A003AA & 1) == 0 )
  {
    sub_1B64A00(&Method_DataManager_GetMaster_UserFollowerMaster___, method);
    sub_1B64A00(&DataManager_TypeInfo, v2);
    sub_1B64A00(&Method_DataMasterBase_UserFollowerMaster__UserFollowerEntity__long__TryGetSingleEntity__, v3);
    sub_1B64A00(&FollowerListRequest_TypeInfo, v4);
    byte_4A003AA = 1;
  }
  ...
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2E3BC8C *)Method_DataManager_GetMaster_UserFollowerMaster___);
  if ( !Master_object )
LABEL_14:
...
bool __fastcall FollowerListRequest__checkRefreshRate(const MethodInfo *method)
{
  ...
  if ( (byte_4A003A6 & 1) == 0 )
  {
    ...
    sub_1B64A00(&FollowerListRequest_TypeInfo, v2);
...
System_String_o *__fastcall FollowerListRequest__getURL(FollowerListRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A003A8 & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_19425/*"follower/list"*/, v2);
    byte_4A003A8 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61385136(BaseUrl, (System_String_o *)StringLiteral_19425/*"follower/list"*/, 0LL);
}
