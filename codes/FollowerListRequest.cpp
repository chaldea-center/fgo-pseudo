void __fastcall FollowerListRequest___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48E3F1E & 1) == 0 )
  {
    sub_1B00CCC(&FollowerListRequest_TypeInfo, v1);
    byte_48E3F1E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3F1C & 1) == 0 )
  {
    sub_1B00CCC(&BalanceConfig_TypeInfo, isEnfoceRefresh);
    sub_1B00CCC(&FollowerListRequest_TypeInfo, v9);
    sub_1B00CCC(&StringLiteral_22517/*"refresh"*/, v10);
    sub_1B00CCC(&StringLiteral_22382/*"questPhase"*/, v11);
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22382/*"questPhase"*/, questPhase, v13);
  if ( !this )
    sub_1B00F28(v14, v15);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22517/*"refresh"*/, isEnfoceRefresh, v16);
  if ( !isEnfoceRefresh )
    goto LABEL_11;
...
bool __fastcall FollowerListRequest__checkExpirationDate(FollowerListRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E3F1B & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataManager_GetMaster_UserFollowerMaster___, method);
    sub_1B00CCC(&DataManager_TypeInfo, v2);
    sub_1B00CCC(&Method_DataMasterBase_UserFollowerMaster__UserFollowerEntity__long__TryGetSingleEntity__, v3);
    sub_1B00CCC(&FollowerListRequest_TypeInfo, v4);
    byte_48E3F1B = 1;
  }
  ...
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2D62BBC *)Method_DataManager_GetMaster_UserFollowerMaster___);
  if ( !Master_object )
LABEL_14:
...
bool __fastcall FollowerListRequest__checkRefreshRate(const MethodInfo *method)
{
  ...
  if ( (byte_48E3F17 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&FollowerListRequest_TypeInfo, v2);
...
System_String_o *__fastcall FollowerListRequest__getURL(FollowerListRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E3F19 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_19240/*"follower/list"*/, v2);
    byte_48E3F19 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_60325748(BaseUrl, (System_String_o *)StringLiteral_19240/*"follower/list"*/, 0LL);
}
