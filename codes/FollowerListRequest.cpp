        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AEA09 & 1) == 0 )
  {
    ...
    sub_B52984(&FollowerListRequest_TypeInfo);
    sub_B52984(&StringLiteral_21920/*"refresh"*/);
  ...
  if ( !this )
    sub_B52A5C(v9, v10);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21920/*"refresh"*/, isEnfoceRefresh, 0LL);
  if ( !isEnfoceRefresh )
    goto LABEL_13;
...
bool __fastcall FollowerListRequest__checkExpirationDate(FollowerListRequest_o *this, const MethodInfo *method)
{
  ...
  Master_WarQuestSelectionMaster = (DataMasterBase_UserGameMaster__UserGameEntity__long__o *)DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1A4F124 *)Method_DataManager_GetMaster_UserFollowerMaster___);
...
System_String_o *__fastcall FollowerListRequest__getURL(FollowerListRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_B52984(&NetworkManager_TypeInfo);
    sub_B52984(&StringLiteral_18926/*"follower/list"*/);
    byte_42AEA06 = 1;
  }
  if ( (BYTE3(NetworkManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !NetworkManager_TypeInfo->_2.cctor_finished )
  ...
  return System_String__Concat_44568316(BaseUrl, (System_String_o *)StringLiteral_18926/*"follower/list"*/, 0LL);
}
