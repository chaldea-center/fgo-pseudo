void __fastcall FollowerListRequest___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49BC85A & 1) == 0 )
  {
    sub_1B4CF90(&FollowerListRequest_TypeInfo, v1);
    byte_49BC85A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BC858 & 1) == 0 )
  {
    sub_1B4CF90(&BalanceConfig_TypeInfo, isEnfoceRefresh);
    sub_1B4CF90(&FollowerListRequest_TypeInfo, v9);
  ...
  if ( !this )
    sub_1B4D1EC(v14, v15);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22557/*"refresh"*/, isEnfoceRefresh, v16);
  if ( !isEnfoceRefresh )
    goto LABEL_11;
...
bool __fastcall FollowerListRequest__checkExpirationDate(FollowerListRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BC857 & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataManager_GetMaster_UserFollowerMaster___, method);
    sub_1B4CF90(&DataManager_TypeInfo, v2);
    sub_1B4CF90(&Method_DataMasterBase_UserFollowerMaster__UserFollowerEntity__long__TryGetSingleEntity__, v3);
    sub_1B4CF90(&FollowerListRequest_TypeInfo, v4);
    byte_49BC857 = 1;
  }
  ...
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2F01AD0 *)Method_DataManager_GetMaster_UserFollowerMaster___);
  if ( !Master_object )
LABEL_14:
...
bool __fastcall FollowerListRequest__checkRefreshRate(const MethodInfo *method)
{
  ...
  if ( (byte_49BC853 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&FollowerListRequest_TypeInfo, v2);
...
System_String_o *__fastcall FollowerListRequest__getURL(FollowerListRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BC855 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_19198/*"follower/list"*/, v2);
    byte_49BC855 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61093468(BaseUrl, (System_String_o *)StringLiteral_19198/*"follower/list"*/, 0LL);
}
