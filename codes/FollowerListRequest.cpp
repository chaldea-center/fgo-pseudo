void __fastcall FollowerListRequest___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A2F7E5 & 1) == 0 )
  {
    sub_1B761C0(&FollowerListRequest_TypeInfo, v1);
    byte_4A2F7E5 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F7E3 & 1) == 0 )
  {
    sub_1B761C0(&BalanceConfig_TypeInfo, isEnfoceRefresh);
    sub_1B761C0(&FollowerListRequest_TypeInfo, v9);
  ...
  if ( !this )
    sub_1B7641C(v14, v15);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22821/*"refresh"*/, isEnfoceRefresh, v16);
  if ( !isEnfoceRefresh )
    goto LABEL_11;
...
bool __fastcall FollowerListRequest__checkExpirationDate(FollowerListRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2F7E2 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMaster_UserFollowerMaster___, method);
    sub_1B761C0(&DataManager_TypeInfo, v2);
    sub_1B761C0(&Method_DataMasterBase_UserFollowerMaster__UserFollowerEntity__long__TryGetSingleEntity__, v3);
    sub_1B761C0(&FollowerListRequest_TypeInfo, v4);
    byte_4A2F7E2 = 1;
  }
  ...
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2E623B4 *)Method_DataManager_GetMaster_UserFollowerMaster___);
  if ( !Master_object )
LABEL_14:
...
bool __fastcall FollowerListRequest__checkRefreshRate(const MethodInfo *method)
{
  ...
  if ( (byte_4A2F7DE & 1) == 0 )
  {
    ...
    sub_1B761C0(&FollowerListRequest_TypeInfo, v2);
...
System_String_o *__fastcall FollowerListRequest__getURL(FollowerListRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2F7E0 & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_19494/*"follower/list"*/, v2);
    byte_4A2F7E0 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61535060(BaseUrl, (System_String_o *)StringLiteral_19494/*"follower/list"*/, 0LL);
}
