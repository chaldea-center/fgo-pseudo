        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFD5EF & 1) == 0 )
  {
    ...
    this = (MasterEquipSettingListViewItemDraw_o *)sub_1BC3008(&StringLiteral_17297/*"btn_bg_21"*/, v6);
    byte_4AFD5EF = 1;
  }
  if ( !item )
    goto LABEL_24;
  ...
  if ( !this )
    goto LABEL_24;
  UIRangeLabel__Set((UIRangeLabel_o *)this, item->fields._ShortName_k__BackingField, 0LL, 1, 0, 0, 0LL);
