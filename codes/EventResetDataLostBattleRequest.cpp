        ...
        const MethodInfo *method)
{
  if ( (byte_593A225 & 1) == 0 )
  {
    sub_21FFC50(&StringLiteral_19264/*"dataLostBattleId"*/);
    sub_21FFC50(&StringLiteral_21205/*"idx"*/);
    byte_593A225 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19264/*"dataLostBattleId"*/, dataLostBattleId, 0);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21205/*"idx"*/, resetIdx, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_593A224 & 1) == 0 )
  {
    ...
    sub_21FFC50(&StringLiteral_19984/*"event/resetDataLostBattle"*/);
    byte_593A224 = 1;
  }
  if ( !*(&NetworkManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_75438412(BaseUrl, (System_String_o *)StringLiteral_19984/*"event/resetDataLostBattle"*/, 0);
}
