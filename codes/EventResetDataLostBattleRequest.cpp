        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40F6127 & 1) == 0 )
  {
    sub_B16FFC(&StringLiteral_17805/*"dataLostBattleId"*/, *(_QWORD *)&dataLostBattleId);
    sub_B16FFC(&StringLiteral_19319/*"idx"*/, v7);
    byte_40F6127 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_17805/*"dataLostBattleId"*/, dataLostBattleId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19319/*"idx"*/, resetIdx, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40F6126 & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_18394/*"event/resetDataLostBattle"*/, v2);
    byte_40F6126 = 1;
  }
  ...
  return System_String__Concat_43743732(BaseUrl, (System_String_o *)StringLiteral_18394/*"event/resetDataLostBattle"*/, 0LL);
}
