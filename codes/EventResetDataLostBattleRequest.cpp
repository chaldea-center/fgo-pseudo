        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40F6127 & 1) == 0 )
  {
    sub_B16FFC(&StringLiteral_17805, *(_QWORD *)&dataLostBattleId);
    sub_B16FFC(&StringLiteral_19319, v7);
    byte_40F6127 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_17805, dataLostBattleId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19319, resetIdx, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40F6126 & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_18394, v2);
    byte_40F6126 = 1;
  }
  ...
  return System_String__Concat_43743732(BaseUrl, (System_String_o *)StringLiteral_18394, 0LL);
}
