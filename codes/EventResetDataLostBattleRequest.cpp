        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42E5505 & 1) == 0 )
  {
    sub_B5D5C4(&StringLiteral_18092/*"dataLostBattleId"*/, dataLostBattleId, resetIdx, method);
    sub_B5D5C4(&StringLiteral_19638/*"idx"*/, v7, v8, v9);
    byte_42E5505 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18092/*"dataLostBattleId"*/, dataLostBattleId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19638/*"idx"*/, resetIdx, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42E5504 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&StringLiteral_18692/*"event/resetDataLostBattle"*/, v4, v5, v6);
    byte_42E5504 = 1;
  }
  ...
  return System_String__Concat_44577788(BaseUrl, (System_String_o *)StringLiteral_18692/*"event/resetDataLostBattle"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v12 = ResponseCommandKind__SearchData(124, responseList, 0LL);
