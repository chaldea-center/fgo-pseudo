        ...
        const MethodInfo *method)
{
  if ( (byte_42ACAEB & 1) == 0 )
  {
    sub_B52984(&StringLiteral_17998/*"dataLostBattleId"*/);
    sub_B52984(&StringLiteral_19540/*"idx"*/);
    byte_42ACAEB = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_17998/*"dataLostBattleId"*/, dataLostBattleId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19540/*"idx"*/, resetIdx, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42ACAEA & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_18597/*"event/resetDataLostBattle"*/);
    byte_42ACAEA = 1;
  }
  ...
  return System_String__Concat_44568316(BaseUrl, (System_String_o *)StringLiteral_18597/*"event/resetDataLostBattle"*/, 0LL);
}
