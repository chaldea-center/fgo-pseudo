        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB75EE & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_18496/*"dataLostBattleId"*/, *(_QWORD *)&dataLostBattleId);
    sub_1BAB41C(&StringLiteral_20244/*"idx"*/, v7);
    byte_4AB75EE = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18496/*"dataLostBattleId"*/, dataLostBattleId, method);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_20244/*"idx"*/, resetIdx, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB75ED & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_19151/*"event/resetDataLostBattle"*/, v2);
    byte_4AB75ED = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62048128(BaseUrl, (System_String_o *)StringLiteral_19151/*"event/resetDataLostBattle"*/, 0LL);
}
