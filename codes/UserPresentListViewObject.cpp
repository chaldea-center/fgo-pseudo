...
void __fastcall UserPresentListViewObject__Awake(UserPresentListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42AE128 & 1) == 0 )
  {
    sub_B52984(&Method_UnityEngine_GameObject_GetComponent_UserPresentListViewItemDraw___);
    byte_42AE128 = 1;
  }
  ...
  Component_srcLineSprite = (struct UserPresentListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                                      dispObject,
                                                                      (const MethodInfo_1B7B1B8 *)Method_UnityEngine_GameObject_GetComponent_UserPresentListViewItemDraw___);
...
void __fastcall UserPresentListViewObject__Init_21410368(
        UserPresentListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UserPresentListViewObject__Init_21411664(
        UserPresentListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UserPresentListViewObject__Init_21411728(
        UserPresentListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall UserPresentListViewObject__OnClickCheck(UserPresentListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_B52984(&UserPresentListViewItem_TypeInfo);
    sub_B52984(&StringLiteral_10013/*"OnClickListCheck"*/);
    byte_42AE12E = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem )
  {
      ...
      && (UserPresentListViewItem_c *)linkItem->klass->_2.typeHierarchy[v5 - 1] == UserPresentListViewItem_TypeInfo )
    {
      ...
      if ( manager )
      {
        UnityEngine_Component__SendMessage(manager, (System_String_o *)StringLiteral_10013/*"OnClickListCheck"*/, (Il2CppObject *)this, 0LL);
        return;
      }
    }
    else
    {
      manager = (UnityEngine_Component_o *)sub_B52D50(linkItem);
    }
...
void __fastcall UserPresentListViewObject__SetupDisp(UserPresentListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( linkItem )
  {
    v4 = *(&UserPresentListViewItem_TypeInfo->_2.bitflags2 + 1);
    if ( *(&linkItem->klass->_2.bitflags2 + 1) >= (unsigned int)v4
      && (UserPresentListViewItem_c *)linkItem->klass->_2.typeHierarchy[v4 - 1] == UserPresentListViewItem_TypeInfo )
    {
        ...
        const MethodInfo *method)
{
  ...
  v11 = (UserPresentListViewObject_o *)sub_B52D50(v8);
