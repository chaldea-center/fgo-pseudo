...
void __fastcall UserPresentListViewObject__Awake(UserPresentListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E1657 & 1) == 0 )
  {
    sub_1B00CCC(&Method_UnityEngine_GameObject_GetComponent_UserPresentListViewItemDraw___, method);
    byte_48E1657 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2DADE08 *)Method_UnityEngine_GameObject_GetComponent_UserPresentListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E1658 & 1) == 0 )
  {
    sub_1B00CCC(&UserPresentListViewItem_TypeInfo, method);
    byte_48E1658 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E165A & 1) == 0 )
  {
    sub_1B00CCC(&UserPresentListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_48E165A = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UserPresentListViewObject__Init_36244868(
        UserPresentListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UserPresentListViewObject__Init_36246072(
        UserPresentListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UserPresentListViewObject__Init_36246156(
        UserPresentListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall UserPresentListViewObject__OnClickCheck(UserPresentListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B00CCC(&UserPresentListViewItem_TypeInfo, method);
    sub_1B00CCC(&StringLiteral_9734/*"OnClickListCheck"*/, v3);
    byte_48E165D = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem )
  {
      ...
      && (UserPresentListViewItem_c *)linkItem->klass->_2.typeHierarchy[methodPtr_low - 1] == UserPresentListViewItem_TypeInfo )
    {
      ...
      if ( manager )
      {
        UnityEngine_Component__SendMessage(manager, (System_String_o *)StringLiteral_9734/*"OnClickListCheck"*/, (Il2CppObject *)this, 0LL);
        return;
      }
    }
    else
...
void __fastcall UserPresentListViewObject__OnClickSelect(UserPresentListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E165C & 1) == 0 )
  {
    sub_1B00CCC(&Method_UserPresentListViewObject_OnClickSelect__, method);
    sub_1B00CCC(&StringLiteral_9739/*"OnClickListView"*/, v3);
    byte_48E165C = 1;
  }
  if ( this->fields.linkItem )
  {
    ...
    if ( (*((_BYTE *)Method_UserPresentListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1B00CE4(Method_UserPresentListViewObject_OnClickSelect__);
...
void __fastcall UserPresentListViewObject__SetupDisp(UserPresentListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E165B & 1) == 0 )
  {
    ...
    sub_1B00CCC(&UserPresentListViewItem_TypeInfo, v3);
    byte_48E165B = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
