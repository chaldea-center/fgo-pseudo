...
void __fastcall UserPresentListViewObject__Awake(UserPresentListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49B9CAE & 1) == 0 )
  {
    sub_1B4CF90(&Method_UnityEngine_GameObject_GetComponent_UserPresentListViewItemDraw___, method);
    byte_49B9CAE = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2F53444 *)Method_UnityEngine_GameObject_GetComponent_UserPresentListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B9CAF & 1) == 0 )
  {
    sub_1B4CF90(&UserPresentListViewItem_TypeInfo, method);
    byte_49B9CAF = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B9CB1 & 1) == 0 )
  {
    sub_1B4CF90(&UserPresentListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_49B9CB1 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UserPresentListViewObject__Init_38056140(
        UserPresentListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UserPresentListViewObject__Init_38056224(
        UserPresentListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UserPresentListViewObject__Init_38056308(
        UserPresentListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
void __fastcall UserPresentListViewObject__OnClickCheck(UserPresentListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B4CF90(&UserPresentListViewItem_TypeInfo, method);
    sub_1B4CF90(&StringLiteral_9642/*"OnClickListCheck"*/, v3);
    byte_49B9CB4 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem )
  {
      ...
      && (UserPresentListViewItem_c *)linkItem->klass->_2.typeHierarchy[methodPtr_low - 1] == UserPresentListViewItem_TypeInfo )
    {
      ...
      if ( manager )
      {
        UnityEngine_Component__SendMessage(manager, (System_String_o *)StringLiteral_9642/*"OnClickListCheck"*/, (Il2CppObject *)this, 0LL);
        return;
      }
    }
    else
...
void __fastcall UserPresentListViewObject__OnClickSelect(UserPresentListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49B9CB3 & 1) == 0 )
  {
    sub_1B4CF90(&Method_UserPresentListViewObject_OnClickSelect__, method);
    sub_1B4CF90(&StringLiteral_9647/*"OnClickListView"*/, v3);
    byte_49B9CB3 = 1;
  }
  if ( this->fields.linkItem )
  {
    ...
    if ( (*((_BYTE *)Method_UserPresentListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1B4CFA8(Method_UserPresentListViewObject_OnClickSelect__);
...
void __fastcall UserPresentListViewObject__SetupDisp(UserPresentListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49B9CB2 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&UserPresentListViewItem_TypeInfo, v3);
    byte_49B9CB2 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B4D1EC(itemDraw, checkBoxed);
  }
