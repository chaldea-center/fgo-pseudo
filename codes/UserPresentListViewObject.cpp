...
void __fastcall UserPresentListViewObject__Awake(UserPresentListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FD2F8 & 1) == 0 )
  {
    sub_1B64870(&Method_UnityEngine_GameObject_GetComponent_UserPresentListViewItemDraw___, method);
    byte_49FD2F8 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2E8A1B4 *)Method_UnityEngine_GameObject_GetComponent_UserPresentListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD2F9 & 1) == 0 )
  {
    sub_1B64870(&UserPresentListViewItem_TypeInfo, method);
    byte_49FD2F9 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD2FB & 1) == 0 )
  {
    sub_1B64870(&UserPresentListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_49FD2FB = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UserPresentListViewObject__Init_37135940(
        UserPresentListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UserPresentListViewObject__Init_37137144(
        UserPresentListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UserPresentListViewObject__Init_37137228(
        UserPresentListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall UserPresentListViewObject__OnClickCheck(UserPresentListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B64870(&UserPresentListViewItem_TypeInfo, method);
    sub_1B64870(&StringLiteral_9798/*"OnClickListCheck"*/, v3);
    byte_49FD2FE = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem )
  {
      ...
      && (UserPresentListViewItem_c *)linkItem->klass->_2.typeHierarchy[methodPtr_low - 1] == UserPresentListViewItem_TypeInfo )
    {
      ...
      if ( manager )
      {
        UnityEngine_Component__SendMessage(manager, (System_String_o *)StringLiteral_9798/*"OnClickListCheck"*/, (Il2CppObject *)this, 0LL);
        return;
      }
    }
    else
...
void __fastcall UserPresentListViewObject__OnClickSelect(UserPresentListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FD2FD & 1) == 0 )
  {
    sub_1B64870(&Method_UserPresentListViewObject_OnClickSelect__, method);
    sub_1B64870(&StringLiteral_9803/*"OnClickListView"*/, v3);
    byte_49FD2FD = 1;
  }
  if ( this->fields.linkItem )
  {
    ...
    if ( (*((_BYTE *)Method_UserPresentListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1B64888(Method_UserPresentListViewObject_OnClickSelect__);
...
void __fastcall UserPresentListViewObject__SetupDisp(UserPresentListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FD2FC & 1) == 0 )
  {
    ...
    sub_1B64870(&UserPresentListViewItem_TypeInfo, v3);
    byte_49FD2FC = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
