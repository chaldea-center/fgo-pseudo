...
void __fastcall UserPresentListViewObject__Awake(UserPresentListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B35FFD & 1) == 0 )
  {
    sub_1BD3458(&Method_UnityEngine_GameObject_GetComponent_UserPresentListViewItemDraw___, method);
    byte_4B35FFD = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2F81A7C *)Method_UnityEngine_GameObject_GetComponent_UserPresentListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B35FFE & 1) == 0 )
  {
    sub_1BD3458(&UserPresentListViewItem_TypeInfo, method);
    byte_4B35FFE = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B36000 & 1) == 0 )
  {
    sub_1BD3458(&UserPresentListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4B36000 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UserPresentListViewObject__Init_38297116(
        UserPresentListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UserPresentListViewObject__Init_38298320(
        UserPresentListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UserPresentListViewObject__Init_38298404(
        UserPresentListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall UserPresentListViewObject__OnClickCheck(UserPresentListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BD3458(&UserPresentListViewItem_TypeInfo, method);
    sub_1BD3458(&StringLiteral_9989/*"OnClickListCheck"*/, v3);
    byte_4B36003 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem )
  {
      ...
      && (UserPresentListViewItem_c *)linkItem->klass->_2.typeHierarchy[methodPtr_low - 1] == UserPresentListViewItem_TypeInfo )
    {
      ...
      if ( manager )
      {
        UnityEngine_Component__SendMessage(manager, (System_String_o *)StringLiteral_9989/*"OnClickListCheck"*/, (Il2CppObject *)this, 0LL);
        return;
      }
    }
    else
...
void __fastcall UserPresentListViewObject__OnClickSelect(UserPresentListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B36002 & 1) == 0 )
  {
    sub_1BD3458(&Method_UserPresentListViewObject_OnClickSelect__, method);
    sub_1BD3458(&StringLiteral_9994/*"OnClickListView"*/, v3);
    byte_4B36002 = 1;
  }
  if ( this->fields.linkItem )
  {
    ...
    if ( (*((_BYTE *)Method_UserPresentListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1BD3470(Method_UserPresentListViewObject_OnClickSelect__);
...
void __fastcall UserPresentListViewObject__SetupDisp(UserPresentListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B36001 & 1) == 0 )
  {
    ...
    sub_1BD3458(&UserPresentListViewItem_TypeInfo, v3);
    byte_4B36001 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
