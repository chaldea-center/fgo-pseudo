        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C220D8 & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_19560/*"formation_blank_grand_{0:D2}"*/);
    byte_4C220D8 = 1;
  }
  noneSprite = this->fields.noneSprite;
  v10 = index + 2;
  v8 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v10, method, v3, v4);
  v9 = System_String__Format((System_String_o *)StringLiteral_19560/*"formation_blank_grand_{0:D2}"*/, v8, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( equipUserServantEntity )
  {
    ...
    *(_QWORD *)&v17.fields.currentCryptoKey = v12;
    ...
    GrandServantListItemEquipDraw__Setup_32759840(
      this,
      v13,
      v14,
...
void GrandServantListItemEquipDraw__Setup_32754988(
        GrandServantListItemEquipDraw_o *this,
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v15.fields.fakeValue = v9;
  if ( CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v15, 0) > 0 )
  {
...
void GrandServantListItemEquipDraw__Setup_32759840(
        GrandServantListItemEquipDraw_o *this,
        int32_t svtId,
        int32_t limitCount,
        bool isFriendShipSvtEquip,
...
LABEL_22:
    ...
    if ( isFriendShipSvtEquip )
    {
      ...
      if ( AtlasManager_TypeInfo->_2.cctor_finished )
      {
        ...
        {
LABEL_11:
          AtlasManager__SetEventUI(v16, (System_String_o *)StringLiteral_19702/*"func_group_icon_385"*/, 0);
          goto LABEL_15;
        }
      }
      else
