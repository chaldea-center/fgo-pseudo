void __fastcall ShopActionMaster___ctor(ShopActionMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A2036C & 1) == 0 )
  {
    sub_1B715CC(&Method_DataMasterBase_ShopActionMaster__ShopActionEntity__string___ctor__, method);
    byte_4A2036C = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    195,
    (const MethodInfo_30F8A78 *)Method_DataMasterBase_ShopActionMaster__ShopActionEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2036A & 1) == 0 )
  {
    sub_1B715CC(&Method_DataMasterBase_ShopActionMaster__ShopActionEntity__string__GetEntity__, *(_QWORD *)&shopId);
    byte_4A2036A = 1;
  }
  ...
  return (ShopActionEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                 (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                 PK,
                                 (const MethodInfo_30F8AB8 *)Method_DataMasterBase_ShopActionMaster__ShopActionEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2036D & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_System_Collections_Generic_List_ShopActionEntity__Add__, v6);
    sub_1B715CC(&Method_System_Collections_Generic_List_ShopActionEntity___ctor__, v7);
    sub_1B715CC(&System_Collections_Generic_List_ShopActionEntity__TypeInfo, v8);
    sub_1B715CC(&ShopActionEntity_TypeInfo, v9);
    byte_4A2036D = 1;
  }
  v10 = (System_Collections_Generic_List_object__o *)sub_1B71818(System_Collections_Generic_List_ShopActionEntity__TypeInfo);
      ...
      if ( LODWORD(list->fields.items) == purchaseShopId )
      {
        ...
        if ( klass == 8 || klass == 5 )
        {
          ...
          else
          {
            ...
            sub_1B71570((ServantStatusBattleListViewItem_o *)(v23 + 4), (int32_t)v11, v16, v17);
          }
        }
      }
      if ( v14 == ++v15 )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2036B & 1) == 0 )
  {
    sub_1B715CC(&Method_DataMasterBase_ShopActionMaster__ShopActionEntity__string__TryGetEntity__, entity);
    byte_4A2036B = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_30F8B08 *)Method_DataMasterBase_ShopActionMaster__ShopActionEntity__string__TryGetEntity__);
}