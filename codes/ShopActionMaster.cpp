void __fastcall ShopActionMaster___ctor(ShopActionMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A2E7DE & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_ShopActionMaster__ShopActionEntity__string___ctor__, method);
    byte_4A2E7DE = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    195,
    (const MethodInfo_30FFA98 *)Method_DataMasterBase_ShopActionMaster__ShopActionEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E7DC & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_ShopActionMaster__ShopActionEntity__string__GetEntity__, *(_QWORD *)&shopId);
    byte_4A2E7DC = 1;
  }
  ...
  return (ShopActionEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                 (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                 PK,
                                 (const MethodInfo_30FFAD8 *)Method_DataMasterBase_ShopActionMaster__ShopActionEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E7DF & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_System_Collections_Generic_List_ShopActionEntity__Add__, v6);
    sub_1B761C0(&Method_System_Collections_Generic_List_ShopActionEntity___ctor__, v7);
    sub_1B761C0(&System_Collections_Generic_List_ShopActionEntity__TypeInfo, v8);
    sub_1B761C0(&ShopActionEntity_TypeInfo, v9);
    byte_4A2E7DF = 1;
  }
  v10 = (System_Collections_Generic_List_object__o *)sub_1B7640C(System_Collections_Generic_List_ShopActionEntity__TypeInfo);
      ...
      if ( LODWORD(list->fields.items) == purchaseShopId )
      {
        ...
        if ( klass == 8 || klass == 5 )
        {
          ...
          else
          {
            ...
            sub_1B76164((ServantStatusBattleListViewItem_o *)(v23 + 4), (int32_t)v11, v16, v17);
          }
        }
      }
      if ( v14 == ++v15 )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E7DD & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_ShopActionMaster__ShopActionEntity__string__TryGetEntity__, entity);
    byte_4A2E7DD = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_30FFB28 *)Method_DataMasterBase_ShopActionMaster__ShopActionEntity__string__TryGetEntity__);
}