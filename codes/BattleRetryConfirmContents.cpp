void BattleRetryConfirmContents___ctor(BattleRetryConfirmContents_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E7B272 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_System_Collections_Generic_List_RetryConfirmItem___ctor__);
    sub_1D0F0B4(&System_Collections_Generic_List_RetryConfirmItem__TypeInfo);
    byte_4E7B272 = 1;
  }
  v3 = (System_Collections_Generic_List_object__o *)sub_1D0F300(System_Collections_Generic_List_RetryConfirmItem__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v3,
    (const MethodInfo_395BBDC *)Method_System_Collections_Generic_List_RetryConfirmItem___ctor__);
...
void BattleRetryConfirmContents__CostPointLabelCentering(BattleRetryConfirmContents_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E7B271 & 1) == 0 )
  {
    sub_1D0F0B4(&System_Action_RetryConfirmItem__TypeInfo);
    sub_1D0F0B4(&Method_BasicHelper_ForEach_RetryConfirmItem___);
    sub_1D0F0B4(&Method_BattleRetryConfirmContents___c__CostPointLabelCentering_b__7_0__);
    this = (BattleRetryConfirmContents_o *)sub_1D0F0B4(&BattleRetryConfirmContents___c_TypeInfo);
    byte_4E7B271 = 1;
  }
  ...
  if ( SLODWORD(items->max_length) <= 2 )
  {
    ...
    if ( !_9__7_0 )
    {
      ...
      _9__7_0 = (System_Action_object__o *)sub_1D0F300(System_Action_RetryConfirmItem__TypeInfo);
    ...
    BasicHelper__ForEach_object_(
      ...
      (const MethodInfo_323AF0C *)Method_BasicHelper_ForEach_RetryConfirmItem___);
  }
}
...
void BattleRetryConfirmContents__Initialized(BattleRetryConfirmContents_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E7B26E & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_2873/*"BATTLE_RETRYABLE_CONFIRM_DIALOG_MESSAGE_SUB"*/);
    byte_4E7B26E = 1;
  }
  mainText = this->fields.mainText;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_2873/*"BATTLE_RETRYABLE_CONFIRM_DIALOG_MESSAGE_SUB"*/, 0);
  if ( !mainText )
    sub_1D0F30C(v4, v5);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1D0F0B4(&System_Action_RetryConfirmItem__TypeInfo);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_RetryConfirmItem__ForEach__);
    sub_1D0F0B4(&Method_BattleRetryConfirmContents___c__DisplayClass6_0__SetCondensedScalePossessionAmount_b__0__);
    sub_1D0F0B4(&BattleRetryConfirmContents___c__DisplayClass6_0_TypeInfo);
    byte_4E7B270 = 1;
  }
  v5 = sub_1D0F300(BattleRetryConfirmContents___c__DisplayClass6_0_TypeInfo);
  ...
  if ( !v5
    || (*(_BYTE *)(v5 + 16) = isDispUseItemUI,
        ...
        v9 = (System_Action_object__o *)sub_1D0F300(System_Action_RetryConfirmItem__TypeInfo),
        System_Action_object____ctor(
          v9,
          (Il2CppObject *)v5,
  ...
  System_Collections_Generic_List_object___ForEach(
    ...
    (const MethodInfo_395CE50 *)Method_System_Collections_Generic_List_RetryConfirmItem__ForEach__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7B26F & 1) == 0 )
  {
    this = (BattleRetryConfirmContents_o *)sub_1D0F0B4(&Method_System_Collections_Generic_List_RetryConfirmItem__Add__);
    byte_4E7B26F = 1;
  }
  items = v5->fields.items;
  if ( !items )
LABEL_17:
    sub_1D0F30C(this, costItems);
  v7 = 0;
  ...
  while ( 1 )
  {
    ...
    *(_DWORD *)(&v24.fields.isIndividualLimit + 1) = *(_DWORD *)v27;
    BattleRetryConfirmContents__SetCostValues_49442100(this, &v24, v14, v3);
    if ( v13 )
    {
      ...
      else
      {
        ...
        *(_QWORD *)(v23 + 32) = v14;
        sub_1D0F058((GrandQuestFolderBoardItem_o *)(v23 + 32), (int32_t)v14, v15, (int32_t)v3, v16, v17, v18, v19);
      }
    }
    items = v5->fields.items;
    ++v7;
...
void BattleRetryConfirmContents__SetCostValues_49442100(
        BattleRetryConfirmContents_o *this,
...
void BattleRetryConfirmContents___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E7B273 & 1) == 0 )
  {
    sub_1D0F0B4(&BattleRetryConfirmContents___c_TypeInfo);
    byte_4E7B273 = 1;
  }
  v1 = (Il2CppObject *)sub_1D0F300(BattleRetryConfirmContents___c_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  UnityEngine_MonoBehaviour__StartCoroutine_73344676((UnityEngine_MonoBehaviour_o *)item, v4, 0);
}