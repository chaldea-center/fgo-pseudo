void BattleRetryConfirmContents___ctor(BattleRetryConfirmContents_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E08540 & 1) == 0 )
  {
    sub_1CE6700(&Method_System_Collections_Generic_List_RetryConfirmItem___ctor__);
    sub_1CE6700(&System_Collections_Generic_List_RetryConfirmItem__TypeInfo);
    byte_4E08540 = 1;
  }
  v3 = (System_Collections_Generic_List_object__o *)sub_1CE694C(System_Collections_Generic_List_RetryConfirmItem__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v3,
    (const MethodInfo_3905734 *)Method_System_Collections_Generic_List_RetryConfirmItem___ctor__);
...
void BattleRetryConfirmContents__CostPointLabelCentering(BattleRetryConfirmContents_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E0853F & 1) == 0 )
  {
    sub_1CE6700(&System_Action_RetryConfirmItem__TypeInfo);
    sub_1CE6700(&Method_BasicHelper_ForEach_RetryConfirmItem___);
    sub_1CE6700(&Method_BattleRetryConfirmContents___c__CostPointLabelCentering_b__7_0__);
    this = (BattleRetryConfirmContents_o *)sub_1CE6700(&BattleRetryConfirmContents___c_TypeInfo);
    byte_4E0853F = 1;
  }
  ...
  if ( SLODWORD(items->max_length) <= 2 )
  {
    ...
    if ( !_9__7_0 )
    {
      ...
      _9__7_0 = (System_Action_object__o *)sub_1CE694C(System_Action_RetryConfirmItem__TypeInfo);
    ...
    BasicHelper__ForEach_object_(
      ...
      (const MethodInfo_31F00FC *)Method_BasicHelper_ForEach_RetryConfirmItem___);
  }
}
...
void BattleRetryConfirmContents__Initialized(BattleRetryConfirmContents_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E0853C & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_2869/*"BATTLE_RETRYABLE_CONFIRM_DIALOG_MESSAGE_SUB"*/);
    byte_4E0853C = 1;
  }
  mainText = this->fields.mainText;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_2869/*"BATTLE_RETRYABLE_CONFIRM_DIALOG_MESSAGE_SUB"*/, 0);
  if ( !mainText )
    sub_1CE6958(v4, v5);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&System_Action_RetryConfirmItem__TypeInfo);
    sub_1CE6700(&Method_System_Collections_Generic_List_RetryConfirmItem__ForEach__);
    sub_1CE6700(&Method_BattleRetryConfirmContents___c__DisplayClass6_0__SetCondensedScalePossessionAmount_b__0__);
    sub_1CE6700(&BattleRetryConfirmContents___c__DisplayClass6_0_TypeInfo);
    byte_4E0853E = 1;
  }
  v5 = sub_1CE694C(BattleRetryConfirmContents___c__DisplayClass6_0_TypeInfo);
  ...
  if ( !v5
    || (*(_BYTE *)(v5 + 16) = isDispUseItemUI,
        ...
        v9 = (System_Action_object__o *)sub_1CE694C(System_Action_RetryConfirmItem__TypeInfo),
        System_Action_object____ctor(
          v9,
          (Il2CppObject *)v5,
  ...
  System_Collections_Generic_List_object___ForEach(
    ...
    (const MethodInfo_39069A8 *)Method_System_Collections_Generic_List_RetryConfirmItem__ForEach__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E0853D & 1) == 0 )
  {
    this = (BattleRetryConfirmContents_o *)sub_1CE6700(&Method_System_Collections_Generic_List_RetryConfirmItem__Add__);
    byte_4E0853D = 1;
  }
  items = v5->fields.items;
  if ( !items )
LABEL_17:
    sub_1CE6958(this, costItems);
  v7 = 0;
  ...
  while ( 1 )
  {
    ...
    *(_DWORD *)(&v24.fields.isIndividualLimit + 1) = *(_DWORD *)v27;
    BattleRetryConfirmContents__SetCostValues_49148964(this, &v24, v14, v3);
    if ( v13 )
    {
      ...
      else
      {
        ...
        *(_QWORD *)(v23 + 32) = v14;
        sub_1CE66A4((GrandQuestFolderBoardItem_o *)(v23 + 32), (int32_t)v14, v15, (int32_t)v3, v16, v17, v18, v19);
      }
    }
    items = v5->fields.items;
    ++v7;
...
void BattleRetryConfirmContents__SetCostValues_49148964(
        BattleRetryConfirmContents_o *this,
...
void BattleRetryConfirmContents___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E08541 & 1) == 0 )
  {
    sub_1CE6700(&BattleRetryConfirmContents___c_TypeInfo);
    byte_4E08541 = 1;
  }
  v1 = (Il2CppObject *)sub_1CE694C(BattleRetryConfirmContents___c_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  UnityEngine_MonoBehaviour__StartCoroutine_72903732((UnityEngine_MonoBehaviour_o *)item, v4, 0);
}