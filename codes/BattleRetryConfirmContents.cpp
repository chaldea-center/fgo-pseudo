void __fastcall BattleRetryConfirmContents___ctor(BattleRetryConfirmContents_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A51AFA & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Collections_Generic_List_RetryConfirmItem___ctor__, method);
    sub_1B863B8(&System_Collections_Generic_List_RetryConfirmItem__TypeInfo, v3);
    byte_4A51AFA = 1;
  }
  v4 = (System_Collections_Generic_List_object__o *)sub_1B86604(System_Collections_Generic_List_RetryConfirmItem__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v4,
    (const MethodInfo_35FC124 *)Method_System_Collections_Generic_List_RetryConfirmItem___ctor__);
  this->fields.needSetCondensedScaleList = (struct System_Collections_Generic_List_RetryConfirmItem__o *)v4;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.needSetCondensedScaleList, (int32_t)v4, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A51AF9 & 1) == 0 )
  {
    sub_1B863B8(&System_Action_RetryConfirmItem__TypeInfo, method);
    sub_1B863B8(&Method_BasicHelper_ForEach_RetryConfirmItem___, v3);
    sub_1B863B8(&Method_BattleRetryConfirmContents___c__CostPointLabelCentering_b__9_0__, v4);
    this = (BattleRetryConfirmContents_o *)sub_1B863B8(&BattleRetryConfirmContents___c_TypeInfo, v5);
    byte_4A51AF9 = 1;
  }
  if ( v2->fields.isDispUseItemUI || !v2->fields.isPointOnly )
  {
    ...
    if ( (int)items->max_length <= 2 )
    {
      ...
      if ( !_9__9_0 )
      {
        ...
        _9__9_0 = (System_Action_object__o *)sub_1B86604(System_Action_RetryConfirmItem__TypeInfo);
      ...
      BasicHelper__ForEach_object_(
        ...
        (const MethodInfo_2F59FB0 *)Method_BasicHelper_ForEach_RetryConfirmItem___);
    }
  }
}
...
void __fastcall BattleRetryConfirmContents__Initialized(BattleRetryConfirmContents_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A51AF6 & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_2869/*"BATTLE_RETRYABLE_CONFIRM_DIALOG_MESSAGE_SUB"*/, v3);
    byte_4A51AF6 = 1;
  }
  mainText = this->fields.mainText;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v5 = LocalizationManager__Get((System_String_o *)StringLiteral_2869/*"BATTLE_RETRYABLE_CONFIRM_DIALOG_MESSAGE_SUB"*/, 0LL);
  if ( !mainText )
    sub_1B86614(v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B863B8(&System_Action_RetryConfirmItem__TypeInfo, method);
    sub_1B863B8(&Method_BattleRetryConfirmContents__SetCondensedScalePossessionAmount_b__8_0__, v3);
    sub_1B863B8(&Method_System_Collections_Generic_List_RetryConfirmItem__ForEach__, v4);
    byte_4A51AF8 = 1;
  }
  needSetCondensedScaleList = (System_Collections_Generic_List_object__o *)this->fields.needSetCondensedScaleList;
  v6 = (System_Action_object__o *)sub_1B86604(System_Action_RetryConfirmItem__TypeInfo);
  System_Action_object____ctor(
    v6,
    (Il2CppObject *)this,
  ...
  System_Collections_Generic_List_object___ForEach(
    ...
    (const MethodInfo_35FD398 *)Method_System_Collections_Generic_List_RetryConfirmItem__ForEach__);
}
        ...
        const MethodInfo *method)
{
  ...
  BattleRetryConfirmContents_o *v11; // x21
  float v12; // s8
  int32_t v13; // w22
  ...
  if ( (byte_4A51AF7 & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Collections_Generic_List_RetryConfirmItem__Add__, costItems);
    this = (BattleRetryConfirmContents_o *)sub_1B863B8(&float___TypeInfo, v9);
    byte_4A51AF7 = 1;
  }
  ...
  if ( !costItems )
    goto LABEL_42;
  this = (BattleRetryConfirmContents_o *)sub_1B86460(float___TypeInfo, costItems->max_length);
  v11 = this;
  v12 = 0.0;
...
LABEL_5:
  ...
  switch ( max_length )
  {
    case 3u:
      ...
      if ( !v11 )
        goto LABEL_42;
      m_CancellationTokenSource = (unsigned int)v11->fields.m_CancellationTokenSource;
      if ( !m_CancellationTokenSource )
        goto LABEL_43;
      LODWORD(v11->fields.mainText) = 1105199104;
      if ( m_CancellationTokenSource == 1 )
        goto LABEL_43;
      HIDWORD(v11->fields.mainText) = -1041235968;
      if ( m_CancellationTokenSource <= 2 )
        goto LABEL_43;
      v13 = 22;
      v12 = -8.0;
      LODWORD(v11->fields.items) = -1028653056;
      break;
    case 2u:
      ...
      if ( !v11 )
        goto LABEL_42;
      v31 = (int)v11->fields.m_CancellationTokenSource;
      if ( !v31 )
        goto LABEL_43;
      LODWORD(v11->fields.mainText) = 0;
      if ( v31 == 1 )
        goto LABEL_43;
      v13 = 24;
      HIDWORD(v11->fields.mainText) = -1031274496;
      v12 = -12.0;
      break;
    case 1u:
      ComponentHelper__SetLocalPositionY((UnityEngine_Component_o *)v6->fields.mainText, 142.0, 0LL);
      if ( v11 )
      {
        ...
        {
          v13 = 0;
          LODWORD(v11->fields.mainText) = -1040711680;
          break;
        }
LABEL_43:
        sub_1B8661C(this, costItems);
      }
LABEL_42:
      sub_1B86614(this, costItems);
    default:
      goto LABEL_5;
  }
LABEL_6:
  ...
  if ( !items )
    goto LABEL_42;
  v15 = 0LL;
  v16 = &costItems->m_Items[0].fields.isIndividualLimit + 1;
  while ( 1 )
  {
    v17 = items->max_length;
    if ( (__int64)v15 >= (int)v17 )
      break;
    v18 = costItems->max_length;
    ...
    v20 = *(_DWORD *)v16;
    v21 = *(v16 - 1);
    *(_DWORD *)&v35[3] = *(_DWORD *)(v16 + 3);
    *(_DWORD *)v35 = v20;
    if ( v15 >= v17 )
      goto LABEL_43;
    v22 = (UnityEngine_Component_o *)items->m_Items[v15];
    if ( !v6->fields.isDispUseItemUI )
    {
      if ( !v11 )
        goto LABEL_42;
      if ( v15 >= LODWORD(v11->fields.m_CancellationTokenSource) )
        goto LABEL_43;
      ComponentHelper__SetLocalPositionY(v22, *((float *)&v11->fields.mainText + v15), 0LL);
    }
    *(_OWORD *)&v32.fields.useName = v33;
    *(_OWORD *)&v32.fields.possessionName = v34;
    v32.fields.isIndividualLimit = v21;
    *((_DWORD *)&v32.fields.isIndividualLimit + 1) = *(_DWORD *)&v35[3];
    *(_DWORD *)(&v32.fields.isIndividualLimit + 1) = *(_DWORD *)v35;
    BattleRetryConfirmContents__SetCostValues_45609220(v6, &v32, (RetryConfirmItem_o *)v22, v13, v12, v10);
    if ( v21 )
    {
...
void __fastcall BattleRetryConfirmContents__SetCostValues_45609220(
        BattleRetryConfirmContents_o *this,
        ...
        const MethodInfo *method)
{
  ...
  UnityEngine_MonoBehaviour__StartCoroutine_69341456((UnityEngine_MonoBehaviour_o *)item, v4, 0LL);
}
...
void __fastcall BattleRetryConfirmContents___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A51AFB & 1) == 0 )
  {
    sub_1B863B8(&BattleRetryConfirmContents___c_TypeInfo, v1);
    byte_4A51AFB = 1;
  }
  v2 = (Il2CppObject *)sub_1B86604(BattleRetryConfirmContents___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  BattleRetryConfirmContents___c_TypeInfo->static_fields->__9 = (struct BattleRetryConfirmContents___c_o *)v2;
  sub_1B8635C((CGThumbnailListItem_o *)BattleRetryConfirmContents___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
