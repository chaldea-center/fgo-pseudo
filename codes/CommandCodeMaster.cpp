void CommandCodeMaster___ctor(CommandCodeMaster_o *this, const MethodInfo *method)
{
  if ( (byte_59705FE & 1) == 0 )
  {
    sub_2213A60(&Method_DataMasterBase_CommandCodeMaster__CommandCodeEntity__int___ctor__);
    byte_59705FE = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    258,
    (const MethodInfo_3F0E6E0 *)Method_DataMasterBase_CommandCodeMaster__CommandCodeEntity__int___ctor__);
}
...
System_Int32_array *CommandCodeMaster__GetCollectionList(CommandCodeMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_59705FF & 1) == 0 )
  {
    sub_2213A60(&Method_System_Collections_ObjectModel_Collection_CommandCodeEntity__get_Count__);
    sub_2213A60(&Method_System_Collections_ObjectModel_Collection_CommandCodeEntity__get_Item__);
  ...
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            list,
            (const MethodInfo_3E94214 *)Method_System_Collections_ObjectModel_Collection_CommandCodeEntity__get_Count__);
  ...
  if ( Count >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      list = (System_Collections_ObjectModel_Collection_T__o *)System_Collections_ObjectModel_Collection_object___get_Item(
                                                                 list,
                                                                 v6,
                                                                 (const MethodInfo_3E942A8 *)Method_System_Collections_ObjectModel_Collection_CommandCodeEntity__get_Item__);
      if ( !list )
        break;
      v7 = list;
