void __fastcall CommandCodeMaster___ctor(CommandCodeMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4354697 & 1) == 0 )
  {
    sub_B70694(&Method_DataMasterBase_CommandCodeMaster__CommandCodeEntity__int___ctor__);
    byte_4354697 = 1;
  }
  DataMasterBase_WarMaster__WarEntity__int____ctor(
    (DataMasterBase_WarMaster__WarEntity__int__o *)this,
    249,
    (const MethodInfo_21C03A4 *)Method_DataMasterBase_CommandCodeMaster__CommandCodeEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4354698 & 1) == 0 )
  {
    ...
    sub_B70694(&CommandCodeEntity_TypeInfo);
