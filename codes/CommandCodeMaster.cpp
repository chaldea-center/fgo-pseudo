void __fastcall CommandCodeMaster___ctor(CommandCodeMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4B669A8 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_DataMasterBase_CommandCodeMaster__CommandCodeEntity__int___ctor__, method);
    byte_4B669A8 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    254,
    (const MethodInfo_31FD784 *)Method_DataMasterBase_CommandCodeMaster__CommandCodeEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B669A9 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&CommandCodeEntity_TypeInfo, v4);
