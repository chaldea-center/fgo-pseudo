...
void __fastcall WarehouseListViewObject__Awake(WarehouseListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42AF91A & 1) == 0 )
  {
    ...
    sub_B52984(&Method_UnityEngine_GameObject_GetComponent_WarehouseListViewItemDraw___);
    byte_42AF91A = 1;
  }
  ...
  Component_srcLineSprite = UnityEngine_GameObject__GetComponent_srcLineSprite_(
                              dispObject,
                              (const MethodInfo_1B7B1B8 *)Method_UnityEngine_GameObject_GetComponent_WarehouseListViewItemDraw___);
  ...
  if ( ((unsigned __int8)Component_srcLineSprite & 1) != 0 )
  {
    if ( !DragObject
      || (Component_srcLineSprite = UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                      ...
                                      (const MethodInfo_1B7B1B8 *)Method_UnityEngine_GameObject_GetComponent_WarehouseListViewObject___)) == 0LL )
    {
        ...
        const MethodInfo *method)
{
  ...
  {
    v33 = (WarehouseListViewObject_o *)sub_B52D50(linkItem);
    WarehouseListViewObject__Init_24368252(v33, v34, v35, v37, v36);
  }
  else
  {
    if ( linkItem )
...
// local variable allocation has failed, the output may be wrong!
void __fastcall WarehouseListViewObject__Init_24367348(
        WarehouseListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall WarehouseListViewObject__Init_24368252(
        WarehouseListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall WarehouseListViewObject__Init_24368316(
        WarehouseListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
bool __fastcall WarehouseListViewObject__IsCanDrag(WarehouseListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42AF91E & 1) == 0 )
  {
    sub_B52984(&UnityEngine_Object_TypeInfo);
    sub_B52984(&WarehouseListViewItem_TypeInfo);
    this = (WarehouseListViewObject_o *)sub_B52984(&WarehouseListViewManager_TypeInfo);
    byte_42AF91E = 1;
  }
  ...
  {
    this = (WarehouseListViewObject_o *)sub_B52D50(v2->fields.manager);
    goto LABEL_20;
  }
...
LABEL_20:
  ...
  v9 = (WarehouseListViewObject_o *)sub_B52D50(v2->fields.linkItem);
...
void __fastcall WarehouseListViewObject__OnClickSelect(WarehouseListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( linkItem )
  {
    ...
    UnityEngine_Component__SendMessage(manager, (System_String_o *)StringLiteral_10034/*"OnClickSelectListView"*/, linkItem, 0LL);
  }
}
...
LABEL_15:
    ...
    this = (WarehouseListViewObject_o *)sub_B52D50(manager);
    goto LABEL_15;
  }
}
  ...
  if ( (v6 & 1) != 0 )
  {
      ...
      && (WarehouseListViewItem_c *)linkItem->klass->_2.typeHierarchy[v9 - 1] == WarehouseListViewItem_TypeInfo )
    {
      ...
      if ( manager )
      {
        ...
        {
          v6 = sub_B52D50(this->fields.manager);
        }
      }
      sub_B52A5C(v6, v7);
    }
    v13 = (WarehouseListViewObject_o *)sub_B52D50(this->fields.linkItem);
...
void __fastcall WarehouseListViewObject__SetItem_24366348(
        WarehouseListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall WarehouseListViewObject__SetupDisp(WarehouseListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
LABEL_20:
    IsSelectEnable = sub_B52D50(linkItem);
    goto LABEL_21;
  }
        ...
        const MethodInfo *method)
{
  ...
  v11 = (WarehouseListViewObject_o *)sub_B52D50(v8);
