...
void __fastcall WarehouseListViewObject__Awake(WarehouseListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA542 & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_UnityEngine_GameObject_GetComponent_WarehouseListViewItemDraw___, v3);
    byte_49FA542 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2E87ED8 *)Method_UnityEngine_GameObject_GetComponent_WarehouseListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA547 & 1) == 0 )
  {
    sub_1B640C8(&Method_UnityEngine_GameObject_GetComponent_WarehouseListViewObject___, method);
  ...
  if ( ((unsigned __int8)Component_object & 1) != 0 )
  {
    if ( !DragObject
      || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                               ...
                               (const MethodInfo_2E87ED8 *)Method_UnityEngine_GameObject_GetComponent_WarehouseListViewObject___)) == 0LL )
    {
      sub_1B64324(Component_object);
    }
    v7 = (WarehouseListViewObject_o *)Component_object;
    WarehouseListViewObject__Init_35621528((WarehouseListViewObject_o *)Component_object, 2, v6);
...
void __fastcall WarehouseListViewObject__EventMoveEnd(WarehouseListViewObject_o *this, const MethodInfo *method)
{
  ...
  v5 = callbackFunc;
  p_callbackFunc[-1].fields.isEnabled = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA544 & 1) == 0 )
  {
    sub_1B640C8(&WarehouseListViewItem_TypeInfo, method);
    byte_49FA544 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA548 & 1) == 0 )
  {
    sub_1B640C8(&WarehouseListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_49FA548 = 1;
  }
  linkItem = this->fields.linkItem;
...
LABEL_19:
      ...
      {
        p_callbackFunc->klass = 0LL;
        sub_1B6406C(p_callbackFunc, 0, v18, v19);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall WarehouseListViewObject__Init_35621528(
        WarehouseListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall WarehouseListViewObject__Init_35622440(
        WarehouseListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall WarehouseListViewObject__Init_35622524(
        WarehouseListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
bool __fastcall WarehouseListViewObject__IsCanDrag(WarehouseListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA546 & 1) == 0 )
  {
    ...
    sub_1B640C8(&WarehouseListViewItem_TypeInfo, v3);
    this = (WarehouseListViewObject_o *)sub_1B640C8(&WarehouseListViewManager_TypeInfo, v4);
    byte_49FA546 = 1;
  }
...
LABEL_19:
  ...
  sub_1B645E4(v2->fields.linkItem);
...
void __fastcall WarehouseListViewObject__OnClickSelect(WarehouseListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( linkItem )
  {
    ...
    if ( !manager )
      sub_1B64324(0LL);
    UnityEngine_Component__SendMessage(manager, (System_String_o *)StringLiteral_9819/*"OnClickSelectListView"*/, linkItem, 0LL);
  }
}
...
void __fastcall WarehouseListViewObject__OnLongPush(WarehouseListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B640C8(&WarehouseListViewItem_TypeInfo, method);
    this = (WarehouseListViewObject_o *)sub_1B640C8(&WarehouseListViewManager_TypeInfo, v3);
    byte_49FA54B = 1;
  }
...
void __fastcall WarehouseListViewObject__OnLongRelease(WarehouseListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA54D & 1) == 0 )
  {
    ...
    sub_1B640C8(&StringLiteral_4032/*"CancelDragEnd"*/, v4);
    byte_49FA54D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA545 & 1) == 0 )
  {
    ...
    sub_1B640C8(&WarehouseListViewManager_TypeInfo, v6);
    byte_49FA545 = 1;
  }
      ...
      && (WarehouseListViewItem_c *)linkItem->klass->_2.typeHierarchy[v10 - 1] == WarehouseListViewItem_TypeInfo )
    {
      ...
      if ( manager )
      {
          ...
          && (WarehouseListViewManager_c *)manager->klass->_2.typeHierarchy[methodPtr_low - 1] == WarehouseListViewManager_TypeInfo )
        {
          ...
          if ( v13 )
          {
            WarehouseListViewItemDraw__SetInput(v13, (WarehouseListViewItem_o *)linkItem, v8, 0LL);
            return;
          }
        }
        else
...
void __fastcall WarehouseListViewObject__SetItem_35620592(
        WarehouseListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall WarehouseListViewObject__SetupDisp(WarehouseListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B640C8(&UnityEngine_Object_TypeInfo, method);
    sub_1B640C8(&WarehouseListViewItem_TypeInfo, v4);
    sub_1B640C8(&WarehouseListViewManager_TypeInfo, v5);
    byte_49FA549 = 1;
  }
  manager = this->fields.manager;
  if ( manager )
...
LABEL_11:
  ...
  if ( IsSelectEnable )
  {
    if ( manager )
    {
      ...
      if ( v12 )
      {
        WarehouseListViewItemDraw__SetItem(v12, (WarehouseListViewItem_o *)linkItem, dispMode, IsSelectEnable, 0LL);
        return;
      }
    }
LABEL_20:
