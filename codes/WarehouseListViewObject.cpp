...
void WarehouseListViewObject__Awake(WarehouseListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2E79A & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_UnityEngine_GameObject_GetComponent_WarehouseListViewItemDraw___);
    byte_4D2E79A = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_31FC084 *)Method_UnityEngine_GameObject_GetComponent_WarehouseListViewItemDraw___);
  ...
  if ( ((unsigned __int8)Component_object & 1) != 0 )
  {
    if ( !DragObject
      || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                               ...
                               (const MethodInfo_31FC084 *)Method_UnityEngine_GameObject_GetComponent_WarehouseListViewObject___)) == 0 )
    {
      sub_1C93D2C(Component_object, v5);
    }
    v7 = (WarehouseListViewObject_o *)Component_object;
    WarehouseListViewObject__Init_39109764((WarehouseListViewObject_o *)Component_object, 2, v6);
...
void WarehouseListViewObject__EventMoveEnd(WarehouseListViewObject_o *this, const MethodInfo *method)
{
  ...
  v9 = callbackFunc;
  LOBYTE(p_callbackFunc[-1].fields._IconId_k__BackingField) = 0;
...
void WarehouseListViewObject__Init_39109764(
        WarehouseListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
  ...
  v10.fields.y = v6;
  v10.fields.z = v7;
  WarehouseListViewObject__Init(this, initMode, 0, v4, v10, v3);
}


void WarehouseListViewObject__Init_39110676(
        WarehouseListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        const MethodInfo *method)
{
  ...
  v11.fields.y = v6;
  v11.fields.z = v7;
  WarehouseListViewObject__Init(this, initMode, callbackFunc, delay, v11, method);
}


void WarehouseListViewObject__Init_39110760(
        WarehouseListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
{
  ...
  v11.fields.y = v6;
  v11.fields.z = v7;
  WarehouseListViewObject__Init(this, initMode, callbackFunc, v4, v11, method);
}
...
bool WarehouseListViewObject__IsCanDrag(WarehouseListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2E79E & 1) == 0 )
  {
    sub_1C93AD4(&UnityEngine_Object_TypeInfo);
    sub_1C93AD4(&WarehouseListViewItem_TypeInfo);
    this = (WarehouseListViewObject_o *)sub_1C93AD4(&WarehouseListViewManager_TypeInfo);
    byte_4D2E79E = 1;
  }
...
LABEL_19:
  ...
  sub_1C940C8(v2->fields.linkItem);
...
void WarehouseListViewObject__OnClickSelect(WarehouseListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( linkItem )
  {
    ...
    UnityEngine_Component__SendMessage(manager, (System_String_o *)StringLiteral_9923/*"OnClickSelectListView"*/, linkItem, 0);
  }
}
        ...
        && (WarehouseListViewItem_c *)linkItem->klass->_2.typeHierarchy[naturalAligment - 1] == WarehouseListViewItem_TypeInfo )
      {
        if ( manager )
        {
          if ( WarehouseListViewManager__IsDragEnable(manager, (WarehouseListViewItem_o *)linkItem, 0) )
          {
            ...
            v9 = ~ListViewItem__get_IsSelect(linkItem, 0);
            WarehouseListViewManager__SetDragStart(manager, sortIndex, v9 & 1, 0);
          }
          return;
        }
LABEL_15:
...
void WarehouseListViewObject__SetInput(WarehouseListViewObject_o *this, bool isInput, const MethodInfo *method)
{
  ...
  if ( v6 )
  {
      ...
      && (WarehouseListViewItem_c *)linkItem->klass->_2.typeHierarchy[v9 - 1] == WarehouseListViewItem_TypeInfo )
    {
      ...
      if ( manager )
      {
          ...
          && (WarehouseListViewManager_c *)manager->klass->_2.typeHierarchy[naturalAligment - 1] == WarehouseListViewManager_TypeInfo )
        {
          ...
          if ( v12 )
          {
            WarehouseListViewItemDraw__SetInput(v12, (WarehouseListViewItem_o *)linkItem, v6, 0);
            return;
          }
        }
        else
    ...
    sub_1C940C8(this->fields.linkItem);
...
void WarehouseListViewObject__SetItem_39108828(
        WarehouseListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
LABEL_11:
  ...
  if ( IsSelectEnable )
  {
    if ( manager )
    {
      ...
      if ( v11 )
      {
        WarehouseListViewItemDraw__SetItem(v11, (WarehouseListViewItem_o *)linkItem, dispMode, IsSelectEnable, 0);
        return;
      }
    }
LABEL_20:
