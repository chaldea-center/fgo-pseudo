        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7220C & 1) == 0 )
  {
    sub_1D0F0B4(&Method_CharaGraphListViewPatternGrandEquipRewardUp__Filter_b__3_0__);
    ...
    this = (CharaGraphListViewPatternGrandEquipRewardUp_o *)sub_1D0F0B4(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    byte_4E7220C = 1;
  }
  if ( !userEquipEntity )
    goto LABEL_16;
  ...
  *(_QWORD *)&v17.fields.fakeValue = v6;
  this = (CharaGraphListViewPatternGrandEquipRewardUp_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_50331200(
                                                            v17,
                                                            0);
  if ( !klass )
    goto LABEL_16;
