...
void ScriptSelectListViewItemDraw__EndSelectDecideMove1(ScriptSelectListViewItemDraw_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D32A05 & 1) == 0 )
  {
    sub_1C93AD4(&StringLiteral_6057/*"EndSelectDecideMove2"*/);
    byte_4D32A05 = 1;
  }
  ...
  UnityEngine_MonoBehaviour__Invoke((UnityEngine_MonoBehaviour_o *)this, (System_String_o *)StringLiteral_6057/*"EndSelectDecideMove2"*/, 0.5, 0);
}
...
void ScriptSelectListViewItemDraw__EndSelectDecideMove2(ScriptSelectListViewItemDraw_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D32A06 & 1) == 0 )
  {
    sub_1C93AD4(&StringLiteral_6036/*"EndMove"*/);
    byte_4D32A06 = 1;
  }
  ...
  UnityEngine_MonoBehaviour__Invoke((UnityEngine_MonoBehaviour_o *)this, (System_String_o *)StringLiteral_6036/*"EndMove"*/, 0.6, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_10:
    sub_1C93D2C(baseButton, v10);
  }
  UIMessageButton__Fadeout(baseButton, 0.5, 0);
  UnityEngine_MonoBehaviour__Invoke((UnityEngine_MonoBehaviour_o *)this, (System_String_o *)StringLiteral_6036/*"EndMove"*/, 0.5, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D32A04 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_6056/*"EndSelectDecideMove1"*/);
    sub_1C93AD4(&StringLiteral_11589/*"SCRIPT_ACTION_SELECT_COLOR"*/);
    byte_4D32A04 = 1;
  }
  this->fields.callbackFunc = callback;
  sub_1C93A78(
  ...
  if ( this->fields.message )
  {
    ...
    v12 = LocalizationManager__Get((System_String_o *)StringLiteral_11589/*"SCRIPT_ACTION_SELECT_COLOR"*/, 0);
    effectMessageManager = this->fields.effectMessageManager;
...
LABEL_17:
  UnityEngine_MonoBehaviour__Invoke((UnityEngine_MonoBehaviour_o *)this, (System_String_o *)StringLiteral_6056/*"EndSelectDecideMove1"*/, 0.1, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !item )
  {
    ...
    if ( messageManager )
    {
      ...
      if ( messageManager )
      {
        ...
        sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.message, 0, v25, v26, v27, v28, v29, v30);
        this->fields.font = 0;
        sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.font, 0, v31, v32, v33, v34, v35, v36);
        return;
      }
    }
    goto LABEL_23;
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.font, (int32_t)fontType, v13, v14, v15, v16, v17, v18);
  if ( mode )
  {
    if ( this->fields.message )
    {
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v19 = LocalizationManager__Get((System_String_o *)StringLiteral_11589/*"SCRIPT_ACTION_SELECT_COLOR"*/, 0);
...
LABEL_23:
    sub_1C93D2C(messageManager, item);
  }
}