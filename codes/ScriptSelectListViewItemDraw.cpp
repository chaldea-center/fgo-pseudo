        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B03EAD & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_5974/*"EndSelectDecideMove2"*/, method);
    byte_4B03EAD = 1;
  }
  ...
  UnityEngine_MonoBehaviour__Invoke(
    ...
    (System_String_o *)StringLiteral_5974/*"EndSelectDecideMove2"*/,
    0.5,
    0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B03EAE & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_5956/*"EndMove"*/, method);
    byte_4B03EAE = 1;
  }
  ...
  UnityEngine_MonoBehaviour__Invoke(
    (UnityEngine_MonoBehaviour_o *)this,
    (System_String_o *)StringLiteral_5956/*"EndMove"*/,
    0.6,
    0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B03EAB & 1) == 0 )
  {
    sub_1BC3008(&Method_UnityEngine_Component_GetComponent_Collider___, callback);
    sub_1BC3008(&StringLiteral_5956/*"EndMove"*/, v6);
    byte_4B03EAB = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B03EAC & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_5973/*"EndSelectDecideMove1"*/, v8);
    sub_1BC3008(&StringLiteral_11387/*"SCRIPT_ACTION_SELECT_COLOR"*/, v9);
    byte_4B03EAC = 1;
  }
  this->fields.callbackFunc = callback;
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.callbackFunc, (int32_t)callback, (int32_t)method, v3);
  ...
  if ( this->fields.message )
  {
    ...
    v12 = LocalizationManager__Get((System_String_o *)StringLiteral_11387/*"SCRIPT_ACTION_SELECT_COLOR"*/, 0LL);
    effectMessageManager = this->fields.effectMessageManager;
...
LABEL_18:
    sub_1BC3264(baseButton, v10);
  }
LABEL_17:
  UnityEngine_MonoBehaviour__Invoke(
    (UnityEngine_MonoBehaviour_o *)this,
    (System_String_o *)StringLiteral_5973/*"EndSelectDecideMove1"*/,
    0.1,
    0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B03EAA & 1) == 0 )
  {
    ...
    sub_1BC3008(&ScriptMessageLabel_TypeInfo, v7);
    sub_1BC3008(&StringLiteral_11387/*"SCRIPT_ACTION_SELECT_COLOR"*/, v8);
    byte_4B03EAA = 1;
  }
  if ( !item )
  {
    ...
    if ( messageManager )
    {
      ...
      if ( messageManager )
      {
        ...
        sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.message, 0, v19, v20);
        this->fields.font = 0LL;
        sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.font, 0, v21, v22);
        return;
      }
    }
    goto LABEL_23;
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.message, (int32_t)message, mode, method);
  fontType = item->fields.fontType;
  this->fields.font = fontType;
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.font, (int32_t)fontType, v11, v12);
  if ( mode )
  {
    if ( this->fields.message )
    {
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v13 = LocalizationManager__Get((System_String_o *)StringLiteral_11387/*"SCRIPT_ACTION_SELECT_COLOR"*/, 0LL);
...
LABEL_23:
    sub_1BC3264(messageManager, item);
  }
}