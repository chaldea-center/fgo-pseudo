...
bool MapScroll__BrakeMv(MapScroll_o *this, float spd_rate, const MethodInfo *method)
{
  ...
  return MapScroll__BrakeMv_36831460(this, CameraRect, spd_rate, v6);
}


bool MapScroll__BrakeMv_36831460(
        MapScroll_o *this,
...
void MapScroll__Init(MapScroll_o *this, MapCamera_o *mc, MapTouchDetector_o *touchDetector, const MethodInfo *method)
{
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields, (int32_t)mc, v8, v9, v10, v11, v12, v13);
  if ( !mc )
    sub_1C93D2C(v20, v21);
  mCamera = mc->fields.mCamera;
  this->fields.mCamera = mCamera;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.mCamera, (int32_t)mCamera, v22, v23, v24, v25, v26, v27);
...
void MapScroll__LimitMv(MapScroll_o *this, const MethodInfo *method)
{
  ...
  v10 = MapScroll__LimitMv_36831808(
          v3,
...
UnityEngine_Vector2_o MapScroll__LimitMv_36831808(
        MapScroll_o *this,
...
void MapScroll__Process(MapScroll_o *this, const MethodInfo *method)
{
  ...
  unsigned __int64 ScrlPosVec3; // kr00_8
  float32x2_t v49; // [xsp+0h] [xbp-60h]
  unsigned __int32 v50; // [xsp+0h] [xbp-60h]
  ...
  if ( this->fields.mAutoMvDuration > 0.0 )
  {
    ...
    {
      v54.fields.x = this->fields.mAutoMvStPos.fields.x;
      v54.fields.y = this->fields.mAutoMvStPos.fields.y;
      v55.fields.x = this->fields.mAutoMvEdPos.fields.x;
      v55.fields.y = this->fields.mAutoMvEdPos.fields.y;
      v8 = v7 / mAutoMvDuration;
      v54.fields.z = 0.0;
      v55.fields.z = 0.0;
      v53 = (UnityEngine_Vector2_o)Easing__Func(v54, v55, v8, this->fields.mAutoMvEaseType, 0);
      MapScroll__SetScrlPos(this, v53, v9);
    }
    return;
  }
  ...
  if ( !(_DWORD)touchDetector )
  {
    ...
    v28 = this->fields.mTchDifOld.fields.x;
    v27 = this->fields.mTchDifOld.fields.y;
    if ( !System_Math_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
    if ( sqrtf((float)(v28 * v28) + (float)(v27 * v27)) > 0.0 )
    {
LABEL_34:
      v29 = this->fields.mTchDif.fields.x;
      v30 = this->fields.mTchDif.fields.y;
      mPlaySEAction_Flick = this->fields.mPlaySEAction_Flick;
      v32 = this->fields.mInertiaSpd.fields.y;
      if ( (float)((float)(v29 * v29) + (float)(v30 * v30)) < (float)((float)(this->fields.mTchDifOld.fields.x
                                                                            ...
                                                                            * this->fields.mTchDifOld.fields.y)) )
      {
        ...
        v29 = this->fields.mTchDifOld.fields.x;
      }
      this->fields.mInertiaSpd.fields.x = this->fields.mInertiaSpd.fields.x + v29;
      this->fields.mInertiaSpd.fields.y = v32 + v30;
      ...
      v33 = UnityEngine_Vector2_TypeInfo;
      this->fields.mTchDif = UnityEngine_Vector2_TypeInfo->static_fields->zeroVector;
      this->fields.mTchDifOld = v33->static_fields->zeroVector;
    }
    ...
    v49.n64_u64[0] = (unsigned __int64)mInertiaSpd;
    v35 = ChangedFPSUtil__CalcAccelForCurrentFPS(0.88, 0);
    v36 = vmuls_n_f32(v35, v49.n64_f32[0]);
    this->fields.mInertiaSpd.fields.x = v36;
    this->fields.mInertiaSpd.fields.y = vmuls_lane_f32(v35, v49, 1);
    ...
    {
      touchDetector = (__int64)System_Math_TypeInfo;
      v37 = this->fields.mInertiaSpd.fields.y;
      if ( !System_Math_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
      if ( fabsf(v37) < 0.01 )
      {
        if ( !byte_4D2A019 )
        {
          touchDetector = sub_1C93AD4(&UnityEngine_Vector2_TypeInfo);
          byte_4D2A019 = 1;
        }
    ...
    if ( mMapCamera )
    {
      ...
      {
        if ( !mZoom->fields._IsZoomMaxFitPosFix_k__BackingField )
          MapScroll__BrakeMv(this, 0.45, v47);
        v13 = 0;
        goto LABEL_57;
      }
    }
  ...
  if ( !v12 )
    goto LABEL_68;
  v13 = 0;
  if ( (unsigned int)(v11 - 1) <= 1 && v12->fields._PrevTouchInfo_k__BackingField )
  {
    ...
    if ( touchDetector )
    {
      ...
      if ( v15 )
      {
        touchDetector = (__int64)v15->fields._CurrentTouchInfo_k__BackingField;
        if ( touchDetector )
        {
          v16 = TouchDetectorBase_TouchInfo__get_TouchCenter((TouchDetectorBase_TouchInfo_o *)touchDetector, 0);
          v17 = this->fields.mMapCamera;
          this->fields.mTchDif.fields.x = TouchCenter.fields.x - v16.fields.x;
          this->fields.mTchDif.fields.y = TouchCenter.fields.y - v16.fields.y;
          if ( v17 )
          {
            v18 = v17->fields.mZoom;
            if ( v18 )
            {
              touchDetector = (__int64)v18->fields.mCamera;
              if ( touchDetector )
              {
                orthographicSize = UnityEngine_Camera__get_orthographicSize((UnityEngine_Camera_o *)touchDetector, 0);
                this->fields.mTchDif.fields.x = (float)(TouchCenter.fields.x - v16.fields.x) * orthographicSize;
                this->fields.mTchDif.fields.y = (float)(TouchCenter.fields.y - v16.fields.y) * orthographicSize;
                v21 = MapScroll__BrakeMv(this, 0.0, v20);
                v22.n64_u64[0] = (unsigned __int64)this->fields.mTchDif;
                if ( v21 )
                {
                  v22.n64_u64[0] = vmul_f32(v22, (float32x2_t)0x3F0000003F000000LL).n64_u64[0];
                  this->fields.mTchDif = (struct UnityEngine_Vector2_o)v22.n64_u64[0];
                }
                UserTotalScrollAmount = this->fields.UserTotalScrollAmount;
                this->fields.mTgt = (struct UnityEngine_Vector2_o)vadd_f32((float32x2_t)this->fields.mTgt, v22).n64_u64[0];
                if ( byte_4D2A13A )
                {
                  v24 = v22.n64_f32[1];
                }
                else
                {
                  sub_1C93AD4(&System_Math_TypeInfo);
                  byte_4D2A13A = 1;
                  v22.n64_u32[0] = LODWORD(this->fields.mTchDif.fields.x);
                  v24 = this->fields.mTchDif.fields.y;
                }
                if ( !System_Math_TypeInfo->_2.cctor_finished )
                {
                  v50 = v22.n64_u32[0];
                ...
                this->fields.UserTotalScrollAmount = UserTotalScrollAmount
                                                   + fabsf(sqrtf((float)(v22.n64_f32[0] * v22.n64_f32[0]) + (float)(v24 * v24)));
                goto LABEL_57;
              }
            }
          }
...
LABEL_68:
    sub_1C93D2C(touchDetector, v47);
  }
LABEL_57:
  v40 = this->fields.mTgt.fields.x - *(float *)&ScrlPosVec3;
  v41 = this->fields.mTgt.fields.y - *((float *)&ScrlPosVec3 + 1);
  this->fields.mSpd.fields.x = v40;
  this->fields.mSpd.fields.y = v41;
  if ( (v13 & 1) == 0 )
  {
    v40 = v40 * 0.75;
    v41 = v41 * 0.75;
  ...
  v52.fields.x = *(float *)&ScrlPosVec3 + v40;
  v52.fields.y = *((float *)&ScrlPosVec3 + 1) + v41;
  MapScroll__SetScrlPos(this, v52, v47);
  if ( !MapScroll__IsStop(this, v42) )
  {
    v45 = this->fields.mSpd.fields.x;
    if ( !System_Math_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
    if ( fabsf(v45) < 0.01 )
    {
      v46 = this->fields.mSpd.fields.y;
      if ( !System_Math_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
      if ( fabsf(v46) < 0.01 )
        MapScroll__Stop(this, 1, v44);
    }
  }
  MapScroll__LimitMv(this, v43);
}
...
void MapScroll__SetScrlPos(MapScroll_o *this, UnityEngine_Vector2_o pos, const MethodInfo *method)
{
  ...
  v7.fields.x = x;
  v7.fields.y = y;
  GameObjectExtensions__SetLocalPosition_36745064(gameObject, v7, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  *(p_mAutoMvEndAct - 3) = v13;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)p_mAutoMvEndAct, (int32_t)endAct, v14, v15, v16, v17, v18, v19);
}
