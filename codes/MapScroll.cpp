...
bool __fastcall MapScroll__BrakeMv(MapScroll_o *this, float spd_rate, const MethodInfo *method)
{
  ...
  return MapScroll__BrakeMv_34881460(this, CameraRect, spd_rate, v6);
}


// local variable allocation has failed, the output may be wrong!
bool __fastcall MapScroll__BrakeMv_34881460(
        MapScroll_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(mMapCamera, 0LL, 0LL) )
  {
    ...
    sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.touchDetector, 0LL, v14, v15, v16, v17, v18, v19);
  }
  this->fields.mMapCamera = mc;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields, (int64_t)mc, v8, v9, v10, v11, v12, v13);
  if ( !mc )
    sub_1C22094(v20, v21);
  mCamera = mc->fields.mCamera;
  this->fields.mCamera = mCamera;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.mCamera, (int64_t)mCamera, v22, v23, v24, v25, v26, v27);
...
void __fastcall MapScroll__LimitMv(MapScroll_o *this, const MethodInfo *method)
{
  ...
  v14 = m_Width;
  v15 = m_Height;
  v18 = MapScroll__LimitMv_34881808(
          v3,
...
// local variable allocation has failed, the output may be wrong!
UnityEngine_Vector2_o __fastcall MapScroll__LimitMv_34881808(
        MapScroll_o *this,
...
void __fastcall MapScroll__Process(MapScroll_o *this, const MethodInfo *method)
{
  ...
  float v51; // s9
  float v52; // s9
  float32x2_t v53; // [xsp+0h] [xbp-60h]
  unsigned __int32 v54; // [xsp+0h] [xbp-60h]
  ...
  *(UnityEngine_Vector3_o *)(&v4 - 1) = MapScroll__GetScrlPosVec3(this, method);
  ...
  if ( this->fields.mAutoMvDuration > 0.0 )
  {
    ...
    {
      v57.fields.x = this->fields.mAutoMvStPos.fields.x;
      v57.fields.y = this->fields.mAutoMvStPos.fields.y;
      v59.fields.x = this->fields.mAutoMvEdPos.fields.x;
      v59.fields.y = this->fields.mAutoMvEdPos.fields.y;
      v12 = v11 / mAutoMvDuration;
      v57.fields.z = 0.0;
      v59.fields.z = 0.0;
      v58 = Easing__Func(v57, v59, v12, this->fields.mAutoMvEaseType, 0LL);
      MapScroll__SetScrlPos(this, *(UnityEngine_Vector2_o *)&v58.fields.x, v13);
    }
    return;
  }
  ...
  if ( !touchDetector )
    goto LABEL_70;
  v15 = v4;
  touchDetector = (TouchDetectorBase_o *)TouchDetectorBase__get_CurrentTouchCount(touchDetector, 0LL);
...
LABEL_34:
      ...
      v39 = UnityEngine_Vector2_TypeInfo;
      this->fields.mTchDif = UnityEngine_Vector2_TypeInfo->static_fields->zeroVector;
      this->fields.mTchDifOld = v39->static_fields->zeroVector;
    }
    ...
    v53.n64_u64[0] = (unsigned __int64)mInertiaSpd;
    v41 = ChangedFPSUtil__CalcAccelForCurrentFPS(0.88, 0LL);
    v42 = vmuls_n_f32(v41, v53.n64_f32[0]);
    this->fields.mInertiaSpd.fields.x = v42;
    this->fields.mInertiaSpd.fields.y = vmuls_lane_f32(v41, v53, 1);
    ...
    if ( fabsf(v42) < 0.01 )
    {
      ...
      if ( fabsf(v43) < 0.01 )
      {
        if ( !byte_4BD6AAA )
        {
          touchDetector = (TouchDetectorBase_o *)sub_1C21E38(&UnityEngine_Vector2_TypeInfo);
          byte_4BD6AAA = 1;
        }
  ...
  if ( (unsigned int)(v16 - 1) <= 1 && v17->fields._PrevTouchInfo_k__BackingField )
  {
    ...
    touchDetector = (TouchDetectorBase_o *)v17->fields._PrevTouchInfo_k__BackingField;
    if ( touchDetector )
    {
      ...
      if ( v20 )
      {
        touchDetector = (TouchDetectorBase_o *)v20->fields._CurrentTouchInfo_k__BackingField;
        if ( touchDetector )
        {
          ...
          if ( v22 )
          {
            ...
            if ( v23 )
            {
              touchDetector = (TouchDetectorBase_o *)v23->fields.mCamera;
              if ( touchDetector )
              {
...
LABEL_59:
  ...
  v56.fields.x = v6 + v46;
  v56.fields.y = v15 + v47;
  MapScroll__SetScrlPos(this, v56, v3);
  if ( !MapScroll__IsStop(this, v48) )
  {
    v51 = this->fields.mSpd.fields.x;
    if ( !System_Math_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
    if ( fabsf(v51) < 0.01 )
    {
      ...
      if ( !System_Math_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
      if ( fabsf(v52) < 0.01 )
        MapScroll__Stop(this, 1, v50);
    }
  }
  MapScroll__LimitMv(this, v49);
}
...
void __fastcall MapScroll__SetScrlPos(MapScroll_o *this, UnityEngine_Vector2_o pos, const MethodInfo *method)
{
  ...
  v7.fields.x = x;
  v7.fields.y = y;
  GameObjectExtensions__SetLocalPosition_34797564(gameObject, v7, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  *(p_mAutoMvEndAct - 3) = v13;
  sub_1C21DDC((PartyOrganizationUtility_o *)p_mAutoMvEndAct, (int64_t)endAct, v14, v15, v16, v17, v18, v19);
}
...
void __fastcall MapScroll__UnInit(MapScroll_o *this, const MethodInfo *method)
{
  ...
  this->fields.touchDetector = 0LL;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.touchDetector, 0LL, v9, v10, v11, v12, v13, v14);
}