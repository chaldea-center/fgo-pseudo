        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_593A080 & 1) == 0 )
  {
    ...
    sub_21FFC50(&AssetManager_TypeInfo);
    sub_21FFC50(&Method_UIVerticalImageM_EndLoadAsset__);
    sub_21FFC50(&UIVerticalImageRender_TypeInfo);
    byte_593A080 = 1;
  }
  if ( !*(&UIVerticalImageRender_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(UIVerticalImageRender_TypeInfo, imageName);
...
LABEL_27:
  ...
  else
  {
    ...
    if ( assetDataList )
    {
      ...
      {
        UIVerticalImageM__SetTextureStatus(this, v31);
        if ( callbackFunc )
          ((void (__fastcall *)(intptr_t, intptr_t))callbackFunc->fields.invoke_impl)(
            callbackFunc->fields.method_code,
            callbackFunc->fields.method);
...
void UIVerticalImageM__SetTexture(UIVerticalImageM_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_593A082 & 1) == 0 )
  {
    ...
    this = (UIVerticalImageM_o *)sub_21FFC50(&StringLiteral_17270/*"a"*/);
    byte_593A082 = 1;
  }
  ...
  this = (UIVerticalImageM_o *)AssetData__GetObject_object__58323140(
                                 v4,
                                 LastName,
