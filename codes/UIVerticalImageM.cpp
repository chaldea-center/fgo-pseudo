        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEFFBB & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&AssetManager_TypeInfo);
    sub_1C7BAE8(&Method_UIVerticalImageM_EndLoadAsset__);
    sub_1C7BAE8(&UIVerticalImageRender_TypeInfo);
    byte_4CEFFBB = 1;
  }
  if ( !UIVerticalImageRender_TypeInfo->_2.cctor_finished )
...
void UIVerticalImageM__SetTexture(UIVerticalImageM_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEFFBD & 1) == 0 )
  {
    ...
    this = (UIVerticalImageM_o *)sub_1C7BAE8(&StringLiteral_16692/*"a"*/);
    byte_4CEFFBD = 1;
  }
  ...
  this = (UIVerticalImageM_o *)AssetData__GetObject_object__51713432(
                                 v4,
                                 LastName,
