        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E79031 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&AssetManager_TypeInfo);
    sub_1D0F0B4(&Method_UIVerticalImageM_EndLoadAsset__);
    sub_1D0F0B4(&UIVerticalImageRender_TypeInfo);
    byte_4E79031 = 1;
  }
  if ( !UIVerticalImageRender_TypeInfo->_2.cctor_finished )
...
LABEL_27:
      ...
      sub_1D0F058(p_callbackFunc, (int32_t)v19, v20, v21, v22, v23, v24, v25);
      return;
    }
    v30 = this->fields.loadNameList;
    if ( !AssetManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
    AssetManager__releaseAssetStorage_41903356(v30, 0);
  }
  else
  {
    assetDataList = this->fields.assetDataList;
    if ( assetDataList )
    {
      if ( !AssetManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
      if ( AssetManager__compAssetStorageList_41892096(assetDataList, v16, 0) )
      {
  ...
  if ( callbackFunc )
  {
    ...
    sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.callbackFunc, (int32_t)v32, v33, v34, v35, v36, v37, v38);
  }
  this->fields.loadNameList = v16;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.loadNameList, (int32_t)v16, v9, v10, v11, v12, v13, v14);
  ...
  if ( !AssetManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
  AssetManager__loadAssetStorage_41901004(v40, v41, 1, 0);
}
...
void UIVerticalImageM__SetTexture(UIVerticalImageM_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E79033 & 1) == 0 )
  {
    ...
    this = (UIVerticalImageM_o *)sub_1D0F0B4(&StringLiteral_16857/*"a"*/);
    byte_4E79033 = 1;
  }
  ...
  this = (UIVerticalImageM_o *)AssetData__GetObject_object__52624444(
                                 v4,
                                 LastName,
  ...
  v21 = System_String__Concat_65562772(LastName, (System_String_o *)StringLiteral_16857/*"a"*/, 0);
  this = (UIVerticalImageM_o *)AssetData__GetObject_object__52624444(
                                 v4,
                                 v21,
                                 (const MethodInfo_322FC3C *)Method_AssetData_GetObject_Texture2D____80369832);
...
LABEL_12:
  ...
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&v20->m_Items[1], (int32_t)this, v22, v23, v24, v25, v26, v27);
