        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5972258 & 1) == 0 )
  {
    ...
    sub_2213A60(&AssetManager_TypeInfo);
    sub_2213A60(&Method_UIVerticalImageM_EndLoadAsset__);
    sub_2213A60(&UIVerticalImageRender_TypeInfo);
    byte_5972258 = 1;
  }
  if ( !*(&UIVerticalImageRender_TypeInfo->_2.cctor_finished + 1) )
...
void UIVerticalImageM__SetTexture(UIVerticalImageM_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_597225A & 1) == 0 )
  {
    ...
    this = (UIVerticalImageM_o *)sub_2213A60(&StringLiteral_17306/*"a"*/);
    byte_597225A = 1;
  }
  ...
  this = (UIVerticalImageM_o *)AssetData__GetObject_object__58532980(
                                 v4,
                                 LastName,
