        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB7C89 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&AssetManager_TypeInfo);
    sub_1C6BA08(&Method_UIVerticalImageM_EndLoadAsset__);
    sub_1C6BA08(&UIVerticalImageRender_TypeInfo);
    byte_4CB7C89 = 1;
  }
  if ( !UIVerticalImageRender_TypeInfo->_2.cctor_finished )
...
void UIVerticalImageM__SetTexture(UIVerticalImageM_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB7C8B & 1) == 0 )
  {
    ...
    this = (UIVerticalImageM_o *)sub_1C6BA08(&StringLiteral_16625/*"a"*/);
    byte_4CB7C8B = 1;
  }
  ...
  this = (UIVerticalImageM_o *)AssetData__GetObject_object__51495936(
                                 v4,
                                 LastName,
