void UIVerticalImageM___ctor(UIVerticalImageM_o *this, const MethodInfo *method)
{
  if ( (byte_4E0638F & 1) == 0 )
  {
    sub_1CE6700(&UIVerticalImageRender_TypeInfo);
    byte_4E0638F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E0638A & 1) == 0 )
  {
    ...
    sub_1CE6700(&AssetManager_TypeInfo);
    sub_1CE6700(&Method_UIVerticalImageM_EndLoadAsset__);
    sub_1CE6700(&UIVerticalImageRender_TypeInfo);
    byte_4E0638A = 1;
  }
  if ( !UIVerticalImageRender_TypeInfo->_2.cctor_finished )
...
LABEL_27:
      ...
      sub_1CE66A4(p_callbackFunc, (int32_t)v19, v20, v21, v22, v23, v24, v25);
      return;
    }
    v30 = this->fields.loadNameList;
    if ( !AssetManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
    AssetManager__releaseAssetStorage_41685964(v30, 0);
  }
  else
  {
    assetDataList = this->fields.assetDataList;
    if ( assetDataList )
    {
      if ( !AssetManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
      if ( AssetManager__compAssetStorageList_41674704(assetDataList, v16, 0) )
      {
  ...
  if ( callbackFunc )
  {
    ...
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.callbackFunc, (int32_t)v32, v33, v34, v35, v36, v37, v38);
  }
  this->fields.loadNameList = v16;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.loadNameList, (int32_t)v16, v9, v10, v11, v12, v13, v14);
  ...
  if ( !AssetManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
  AssetManager__loadAssetStorage_41683612(v40, v41, 1, 0);
}
...
void UIVerticalImageM__SetTexture(UIVerticalImageM_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E0638C & 1) == 0 )
  {
    ...
    this = (UIVerticalImageM_o *)sub_1CE6700(&StringLiteral_16786/*"a"*/);
    byte_4E0638C = 1;
  }
  ...
  this = (UIVerticalImageM_o *)AssetData__GetObject_object__52317288(
                                 v4,
                                 LastName,
  ...
  v21 = System_String__Concat_65122828(LastName, (System_String_o *)StringLiteral_16786/*"a"*/, 0);
  this = (UIVerticalImageM_o *)AssetData__GetObject_object__52317288(
                                 v4,
                                 v21,
                                 (const MethodInfo_31E4C68 *)Method_AssetData_GetObject_Texture2D____79905048);
...
LABEL_12:
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&v20->m_Items[1], (int32_t)this, v22, v23, v24, v25, v26, v27);
