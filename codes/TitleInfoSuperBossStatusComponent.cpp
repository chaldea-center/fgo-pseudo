void __fastcall TitleInfoSuperBossStatusComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FAF99 & 1) == 0 )
  {
    sub_1B640C8(&TitleInfoSuperBossStatusComponent_TypeInfo, v1);
    sub_1B640C8(&StringLiteral_19191/*"event_superboss_status_win_"*/, v4);
    sub_1B640C8(&StringLiteral_19190/*"event_superboss_status_battle_"*/, v5);
    byte_49FAF99 = 1;
  }
  TitleInfoSuperBossStatusComponent_TypeInfo->static_fields->SUPERBOSS_ICON_SPNAME_PREFIX_BATTLE = (struct System_String_o *)StringLiteral_19190/*"event_superboss_status_battle_"*/;
  sub_1B6406C(
    (ServantStatusBattleListViewItem_o *)TitleInfoSuperBossStatusComponent_TypeInfo->static_fields,
    StringLiteral_19190/*"event_superboss_status_battle_"*/,
    v2,
    v3);
  v6 = StringLiteral_19191/*"event_superboss_status_win_"*/;
  static_fields = TitleInfoSuperBossStatusComponent_TypeInfo->static_fields;
  static_fields->SUPERBOSS_ICON_SPNAME_PREFIX_WIN = (struct System_String_o *)StringLiteral_19191/*"event_superboss_status_win_"*/;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&static_fields->SUPERBOSS_ICON_SPNAME_PREFIX_WIN, v6, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FAF96 & 1) == 0 )
  {
    sub_1B640C8(&TitleInfoSuperBossStatusComponent_TypeInfo, method);
    byte_49FAF96 = 1;
  }
  ...
  v7 = System_String__Concat_61375396(SUPERBOSS_ICON_SPNAME_PREFIX_WIN, v6, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FAF97 & 1) == 0 )
  {
    sub_1B640C8(&TitleInfoSuperBossStatusComponent_TypeInfo, callFinished);
  ...
  *((_QWORD *)v11 + 11) = callFinished;
  ...
  if ( !superBossIconSp
    || (v19 = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)superBossIconSp, 0LL),
        (superBossIconSp = (char *)UITweener__Begin_object_(
                                     v19,
...
LABEL_8:
  ...
  v6 = System_Int32__ToString((int)superBossEntity + 56, 0LL);
  v7 = System_String__Concat_61375396(SUPERBOSS_ICON_SPNAME_PREFIX_BATTLE, v6, 0LL);
  TitleInfoSuperBossStatusComponent__SetBossIcon(this, v7, v8);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.clickCallBack, (int32_t)callback, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  *(UnityEngine_Vector3_o *)(&v5 - 1) = UnityEngine_Transform__get_localPosition(transform, 0LL);
  ...
  v7 = v5 + offsetY;
  this->fields.inPos.fields.y = v5 + offsetY;
  v8 = TitleInfoSuperBossStatusComponent_TypeInfo;
  if ( !TitleInfoSuperBossStatusComponent_TypeInfo->_2.cctor_finished )
  {
    v12 = v5 + offsetY;
        ...
        const MethodInfo *method)
{
  ...
  if ( !gameObject
    || (v9 = gameObject,
        ...
        (v10 = *p_superBossEntity) == 0LL) )
  {
    sub_1B64324(gameObject);
  }
  v11 = (System_String_o *)gameObject;
  v12 = System_Int32__ToString((int)v10 + 20, 0LL);
  v13 = System_String__Concat_61375396(v11, v12, 0LL);
  UnityEngine_Object__set_name(v9, v13, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B640C8(&TitleInfoSuperBossStatusComponent_TypeInfo, method);
    sub_1B640C8(&StringLiteral_2370/*"AnimFrameOutEnd"*/, v3);
    byte_49FAF95 = 1;
  }
  transform = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0LL);
  if ( !transform )
  ...
  *(float32x2_t *)&this->fields.outPos.fields.x = vadd_f32(static_fields[2], v11);
  ...
  TitleInfoSuperBossStatusComponent__FrameOut(this, (System_String_o *)StringLiteral_2370/*"AnimFrameOutEnd"*/, v5);
}
    ...
    if ( IsEncounted )
    {
      ...
      if ( gameObject )
      {
        ...
        if ( v8 )
        {
          ...
          v11 = System_Int32__ToString((int)v8 + 56, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FAF92 & 1) == 0 )
  {
    sub_1B640C8(&Method_TitleInfoSuperBossStatusComponent_onClick__, method);
    byte_49FAF92 = 1;
  }
...
LABEL_6:
    ...
    if ( (*((_BYTE *)Method_TitleInfoSuperBossStatusComponent_onClick__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1B640E0(Method_TitleInfoSuperBossStatusComponent_onClick__);
