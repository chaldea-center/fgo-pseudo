void __fastcall TitleInfoSuperBossStatusComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B00C26 & 1) == 0 )
  {
    sub_1BC3008(&TitleInfoSuperBossStatusComponent_TypeInfo, v1);
    sub_1BC3008(&StringLiteral_19103/*"event_superboss_status_win_"*/, v4);
    sub_1BC3008(&StringLiteral_19102/*"event_superboss_status_battle_"*/, v5);
    byte_4B00C26 = 1;
  }
  TitleInfoSuperBossStatusComponent_TypeInfo->static_fields->SUPERBOSS_ICON_SPNAME_PREFIX_BATTLE = (struct System_String_o *)StringLiteral_19102/*"event_superboss_status_battle_"*/;
  sub_1BC2FAC(
    (CGThumbnailListItem_o *)TitleInfoSuperBossStatusComponent_TypeInfo->static_fields,
    StringLiteral_19102/*"event_superboss_status_battle_"*/,
    v2,
    v3);
  v6 = StringLiteral_19103/*"event_superboss_status_win_"*/;
  static_fields = TitleInfoSuperBossStatusComponent_TypeInfo->static_fields;
  static_fields->SUPERBOSS_ICON_SPNAME_PREFIX_WIN = (struct System_String_o *)StringLiteral_19103/*"event_superboss_status_win_"*/;
  sub_1BC2FAC((CGThumbnailListItem_o *)&static_fields->SUPERBOSS_ICON_SPNAME_PREFIX_WIN, v6, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B00C23 & 1) == 0 )
  {
    sub_1BC3008(&TitleInfoSuperBossStatusComponent_TypeInfo, method);
    byte_4B00C23 = 1;
  }
  ...
  v7 = System_String__Concat_62348648(SUPERBOSS_ICON_SPNAME_PREFIX_WIN, v6, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B00C24 & 1) == 0 )
  {
    sub_1BC3008(&TitleInfoSuperBossStatusComponent_TypeInfo, callFinished);
  ...
  *((_QWORD *)v12 + 11) = callFinished;
  ...
  {
LABEL_9:
    sub_1BC3264(superBossIconSp, v11);
  }
...
LABEL_8:
  ...
  v8 = System_String__Concat_62348648(SUPERBOSS_ICON_SPNAME_PREFIX_BATTLE, v7, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.clickCallBack, (int32_t)callback, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  v14 = System_String__Concat_62348648(v12, v13, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BC3008(&TitleInfoSuperBossStatusComponent_TypeInfo, method);
    sub_1BC3008(&StringLiteral_2256/*"AnimFrameOutEnd"*/, v3);
    byte_4B00C22 = 1;
  }
  transform = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0LL);
  if ( !transform )
  ...
  *(float32x2_t *)&this->fields.outPos.fields.x = vadd_f32(static_fields[2], v12);
  ...
  TitleInfoSuperBossStatusComponent__FrameOut(this, (System_String_o *)StringLiteral_2256/*"AnimFrameOutEnd"*/, v6);
}
    ...
    if ( IsEncounted )
    {
      ...
      if ( gameObject )
      {
        ...
        if ( v9 )
        {
          ...
          v13 = System_String__Concat_62348648(v11, v12, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B00C1F & 1) == 0 )
  {
    sub_1BC3008(&Method_TitleInfoSuperBossStatusComponent_onClick__, method);
    byte_4B00C1F = 1;
  }
...
LABEL_6:
    ...
    if ( (*((_BYTE *)Method_TitleInfoSuperBossStatusComponent_onClick__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1BC3020(Method_TitleInfoSuperBossStatusComponent_onClick__);
