void __fastcall TitleInfoSuperBossStatusComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A59CB2 & 1) == 0 )
  {
    sub_1B885B0(&TitleInfoSuperBossStatusComponent_TypeInfo);
    sub_1B885B0(&StringLiteral_19268/*"event_superboss_status_win_"*/);
    sub_1B885B0(&StringLiteral_19267/*"event_superboss_status_battle_"*/);
    byte_4A59CB2 = 1;
  }
  TitleInfoSuperBossStatusComponent_TypeInfo->static_fields->SUPERBOSS_ICON_SPNAME_PREFIX_BATTLE = (struct System_String_o *)StringLiteral_19267/*"event_superboss_status_battle_"*/;
  sub_1B88554(
    (ServantStatusBattleListViewItem_o *)TitleInfoSuperBossStatusComponent_TypeInfo->static_fields,
    StringLiteral_19267/*"event_superboss_status_battle_"*/,
    v1,
    v2);
  v3 = StringLiteral_19268/*"event_superboss_status_win_"*/;
  static_fields = TitleInfoSuperBossStatusComponent_TypeInfo->static_fields;
  static_fields->SUPERBOSS_ICON_SPNAME_PREFIX_WIN = (struct System_String_o *)StringLiteral_19268/*"event_superboss_status_win_"*/;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&static_fields->SUPERBOSS_ICON_SPNAME_PREFIX_WIN, v3, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  v7 = System_String__Concat_61707032(SUPERBOSS_ICON_SPNAME_PREFIX_WIN, v6, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  *((_QWORD *)v10 + 11) = callFinished;
  ...
  if ( !superBossIconSp
    || (v18 = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)superBossIconSp, 0LL),
        (superBossIconSp = (char *)UITweener__Begin_object_(
                                     v18,
  ...
  {
LABEL_9:
    sub_1B8880C(superBossIconSp, v9);
  }
...
LABEL_8:
  ...
  v8 = System_String__Concat_61707032(SUPERBOSS_ICON_SPNAME_PREFIX_BATTLE, v7, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.clickCallBack, (int32_t)callback, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  *(float32x2_t *)&this->fields.outPos.fields.x = vadd_f32(static_fields[2], v11);
  ...
  TitleInfoSuperBossStatusComponent__FrameOut(this, (System_String_o *)StringLiteral_2372/*"AnimFrameOutEnd"*/, v5);
}
    ...
    if ( IsEncounted )
    {
      ...
      if ( gameObject )
      {
        ...
        if ( v9 )
        {
          ...
          v13 = System_String__Concat_61707032(v11, v12, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A59CAB & 1) == 0 )
  {
    sub_1B885B0(&Method_TitleInfoSuperBossStatusComponent_onClick__);
    byte_4A59CAB = 1;
  }
...
LABEL_6:
    ...
    if ( (*((_BYTE *)Method_TitleInfoSuperBossStatusComponent_onClick__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1B885C8(Method_TitleInfoSuperBossStatusComponent_onClick__);
