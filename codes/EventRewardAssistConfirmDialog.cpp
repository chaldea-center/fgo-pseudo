void EventRewardAssistConfirmDialog___cctor(const MethodInfo *method)
{
  if ( (byte_4DFF13C & 1) == 0 )
  {
    sub_1CE6700(&EventRewardAssistConfirmDialog_TypeInfo);
    sub_1CE6700(&StringLiteral_19530/*"event_skill_icon_{0}{1:D2}"*/);
    byte_4DFF13C = 1;
  }
  EventRewardAssistConfirmDialog_TypeInfo->static_fields->ASSIST_SKILL_ICON = (struct System_String_o *)StringLiteral_19530/*"event_skill_icon_{0}{1:D2}"*/;
  sub_1CE66A4(EventRewardAssistConfirmDialog_TypeInfo->static_fields, StringLiteral_19530/*"event_skill_icon_{0}{1:D2}"*/);
...
void EventRewardAssistConfirmDialog__Init(EventRewardAssistConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  sub_1CE66A4(&this->fields.onDecide, 0);
  this->fields.state = 0;
...
void EventRewardAssistConfirmDialog__OnClickCancel(EventRewardAssistConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFF139 & 1) == 0 )
  {
    sub_1CE6700(&Method_EventRewardAssistConfirmDialog_OnClickCancel__);
    byte_4DFF139 = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_EventRewardAssistConfirmDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_EventRewardAssistConfirmDialog_OnClickCancel__);
...
void EventRewardAssistConfirmDialog__OnClickDecide(EventRewardAssistConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFF138 & 1) == 0 )
  {
    sub_1CE6700(&Method_EventRewardAssistConfirmDialog_OnClickDecide__);
    byte_4DFF138 = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_EventRewardAssistConfirmDialog_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_EventRewardAssistConfirmDialog_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1CE66E4(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFF137 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_EventRewardAssistConfirmDialog_EndOpen__);
    sub_1CE6700(&EventRewardAssistConfirmDialog_TypeInfo);
    sub_1CE6700(&int_TypeInfo);
    sub_1CE6700(&LocalizationManager_TypeInfo);
    sub_1CE6700(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    sub_1CE6700(&Method_EventRewardAssistConfirmDialog___c__DisplayClass22_0__Open_b__0__);
    sub_1CE6700(&EventRewardAssistConfirmDialog___c__DisplayClass22_0_TypeInfo);
    sub_1CE6700(&StringLiteral_8327/*"LEVEL_INFO"*/);
    sub_1CE6700(&StringLiteral_5724/*"EVENT_REWARD_ASSIST_SKILL_MSG"*/);
    sub_1CE6700(&StringLiteral_5723/*"EVENT_REWARD_ASSIST_SKILL_LV"*/);
    sub_1CE6700(&StringLiteral_5726/*"EVENT_REWARD_ASSIST_SKILL_TITLE"*/);
    sub_1CE6700(&StringLiteral_3717/*"COMMON_CONFIRM_NO"*/);
    sub_1CE6700(&StringLiteral_3722/*"COMMON_CONFIRM_YES"*/);
    sub_1CE6700(&StringLiteral_5722/*"EVENT_REWARD_ASSIST_SKILL_CONFIRM"*/);
    byte_4DFF137 = 1;
  }
  v7 = (Il2CppObject *)sub_1CE694C(EventRewardAssistConfirmDialog___c__DisplayClass22_0_TypeInfo);
  ...
  Instance = (DataManager_o *)sub_1CE66A4(&v7[1].monitor, shopEnt);
  ...
  Instance = (DataManager_o *)sub_1CE66A4(&v7[2], CurrentLevelEntity);
  if ( !v7[2].klass )
    goto LABEL_46;
  ...
  sub_1CE66A4(&v7[2].monitor, AssistEntity);
  this->fields.onDecide = onDecide;
  p_onDecide = &this->fields.onDecide;
  Instance = (DataManager_o *)sub_1CE66A4(&this->fields.onDecide, onDecide);
  klass = v7[2].klass;
  if ( klass && *p_monitor )
  {
                    ...
                    if ( combineSkillNameLabel )
                    {
                      ...
                      if ( v30 )
                      {
                        ...
                        if ( Instance )
                        {
                          ...
                          v33 = LocalizationManager__Get((System_String_o *)StringLiteral_8327/*"LEVEL_INFO"*/, 0);
                          v51 = v22;
                          ...
                          if ( skillLvLabel )
                          {
                            ...
                            v36 = LocalizationManager__Get((System_String_o *)StringLiteral_5723/*"EVENT_REWARD_ASSIST_SKILL_LV"*/, 0);
                            v50 = datalist_high;
                                ...
                                if ( v39 )
                                {
                                  ...
                                  if ( *p_monitor )
                                  {
                                    ...
                                    if ( v41 )
                                    {
                                      ...
                                      v43 = LocalizationManager__Get((System_String_o *)StringLiteral_5726/*"EVENT_REWARD_ASSIST_SKILL_TITLE"*/, 0);
                                      ...
                                      if ( titleLabel )
                                      {
                                        ...
                                        if ( Instance )
                                        {
                                          ...
                                          Instance = (DataManager_o *)LocalizationManager__Get(
                                                                        (System_String_o *)StringLiteral_5724/*"EVENT_REWARD_ASSIST_SKILL_MSG"*/,
                                                                        0);
                                          ...
                                          if ( v45 )
                                          {
                                            ...
                                            if ( detailMsgLabel )
                                            {
                                              ...
                                              Instance = (DataManager_o *)LocalizationManager__Get(
                                                                            (System_String_o *)StringLiteral_5722/*"EVENT_REWARD_ASSIST_SKILL_CONFIRM"*/,
                                                                            0);
                                              if ( confirmMsgLabel )
                                              {
                                                ...
                                                Instance = (DataManager_o *)LocalizationManager__Get(
                                                                              (System_String_o *)StringLiteral_3722/*"COMMON_CONFIRM_YES"*/,
                                                                              0);
                                                if ( decideLabel )
                                                {
                                                  ...
                                                  Instance = (DataManager_o *)LocalizationManager__Get(
                                                                                (System_String_o *)StringLiteral_3717/*"COMMON_CONFIRM_NO"*/,
                                                                                0);
                                                  if ( cancelLabel )
                                                  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFF13D & 1) == 0 )
  {
    sub_1CE6700(&AtlasManager_TypeInfo);
    sub_1CE6700(&EventRewardAssistConfirmDialog_TypeInfo);
    this = (EventRewardAssistConfirmDialog___c__DisplayClass22_0_o *)sub_1CE6700(&int_TypeInfo);
    byte_4DFF13D = 1;
  }
  ...
  v10 = System_String__Format_65164136((System_String_o *)klass, v8, v9, 0);
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
...
LABEL_14:
  ...
  v18 = System_String__Format_65164136(ASSIST_SKILL_ICON, v16, v17, 0);
