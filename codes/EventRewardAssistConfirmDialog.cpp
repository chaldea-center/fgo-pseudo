void __fastcall EventRewardAssistConfirmDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A7407F & 1) == 0 )
  {
    sub_1B90010(&EventRewardAssistConfirmDialog_TypeInfo, v1);
    sub_1B90010(&StringLiteral_19281/*"event_skill_icon_{0}{1:D2}"*/, v4);
    byte_4A7407F = 1;
  }
  EventRewardAssistConfirmDialog_TypeInfo->static_fields->ASSIST_SKILL_ICON = (struct System_String_o *)StringLiteral_19281/*"event_skill_icon_{0}{1:D2}"*/;
  sub_1B8FFB4(
    (ServantStatusBattleListViewItem_o *)EventRewardAssistConfirmDialog_TypeInfo->static_fields,
    StringLiteral_19281/*"event_skill_icon_{0}{1:D2}"*/,
    v2,
    v3);
...
void __fastcall EventRewardAssistConfirmDialog__Init(EventRewardAssistConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.onDecide, 0, v5, v6);
  this->fields.state = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A7407C & 1) == 0 )
  {
    sub_1B90010(&Method_EventRewardAssistConfirmDialog_OnClickCancel__, method);
    byte_4A7407C = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_EventRewardAssistConfirmDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B90028(Method_EventRewardAssistConfirmDialog_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A7407B & 1) == 0 )
  {
    sub_1B90010(&Method_EventRewardAssistConfirmDialog_OnClickDecide__, method);
    byte_4A7407B = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_EventRewardAssistConfirmDialog_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B90028(Method_EventRewardAssistConfirmDialog_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B8FFF4(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A7407A & 1) == 0 )
  {
    sub_1B90010(&System_Action_TypeInfo, shopEnt);
    sub_1B90010(&AtlasManager_TypeInfo, v7);
    sub_1B90010(&Method_DataManager_GetMasterData_AssistMaster___, v8);
    ...
    sub_1B90010(&Method_EventRewardAssistConfirmDialog_EndOpen__, v11);
    sub_1B90010(&EventRewardAssistConfirmDialog_TypeInfo, v12);
    ...
    sub_1B90010(&Method_EventRewardAssistConfirmDialog___c__DisplayClass22_0__Open_b__0__, v16);
    sub_1B90010(&EventRewardAssistConfirmDialog___c__DisplayClass22_0_TypeInfo, v17);
    sub_1B90010(&StringLiteral_8240/*"LEVEL_INFO"*/, v18);
    sub_1B90010(&StringLiteral_5690/*"EVENT_REWARD_ASSIST_SKILL_MSG"*/, v19);
    sub_1B90010(&StringLiteral_5689/*"EVENT_REWARD_ASSIST_SKILL_LV"*/, v20);
    sub_1B90010(&StringLiteral_5692/*"EVENT_REWARD_ASSIST_SKILL_TITLE"*/, v21);
    sub_1B90010(&StringLiteral_3760/*"COMMON_CONFIRM_NO"*/, v22);
    sub_1B90010(&StringLiteral_3764/*"COMMON_CONFIRM_YES"*/, v23);
    sub_1B90010(&StringLiteral_5688/*"EVENT_REWARD_ASSIST_SKILL_CONFIRM"*/, v24);
    byte_4A7407A = 1;
  }
  v25 = sub_1B9025C(EventRewardAssistConfirmDialog___c__DisplayClass22_0_TypeInfo);
  ...
  *(_QWORD *)(v25 + 24) = shopEnt;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v25 + 24), (int32_t)shopEnt, v30, v31);
  v32 = *(_QWORD *)(v25 + 24);
  if ( !v32 )
    goto LABEL_46;
  v33 = *(_QWORD *)(v32 + 56);
  ...
  *(_QWORD *)(v25 + 32) = CurrentLevelEntity;
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v25 + 32), (int32_t)CurrentLevelEntity, v39, v40);
  if ( !*(_QWORD *)(v25 + 32) )
    goto LABEL_46;
  ...
  *(_QWORD *)(v25 + 40) = AssistEntity;
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v25 + 40), (int32_t)AssistEntity, v43, v44);
  this->fields.onDecide = onDecide;
  p_onDecide = &this->fields.onDecide;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.onDecide, (int32_t)onDecide, v46, v47);
  v48 = *(_QWORD *)(v25 + 32);
  if ( v48 && *v42 )
  {
    v49 = *(_DWORD *)(v48 + 40);
                    ...
                    if ( combineSkillNameLabel )
                    {
                      ...
                      if ( v58 )
                      {
                        ...
                        if ( Instance )
                        {
                          ...
                          v61 = LocalizationManager__Get((System_String_o *)StringLiteral_8240/*"LEVEL_INFO"*/, 0LL);
                          v85 = v50;
                          ...
                          if ( skillLvLabel )
                          {
                            ...
                            v67 = LocalizationManager__Get((System_String_o *)StringLiteral_5689/*"EVENT_REWARD_ASSIST_SKILL_LV"*/, 0LL);
                            v84 = datalist_high;
                                ...
                                if ( v73 )
                                {
                                  ...
                                  if ( *v42 )
                                  {
                                    ...
                                    if ( v75 )
                                    {
                                      ...
                                      v77 = LocalizationManager__Get((System_String_o *)StringLiteral_5692/*"EVENT_REWARD_ASSIST_SKILL_TITLE"*/, 0LL);
                                      ...
                                      if ( titleLabel )
                                      {
                                        ...
                                        if ( Instance )
                                        {
                                          ...
                                          Instance = (DataManager_o *)LocalizationManager__Get(
                                                                        (System_String_o *)StringLiteral_5690/*"EVENT_REWARD_ASSIST_SKILL_MSG"*/,
                                                                        0LL);
                                          ...
                                          if ( v79 )
                                          {
                                            ...
                                            if ( detailMsgLabel )
                                            {
                                              ...
                                              Instance = (DataManager_o *)LocalizationManager__Get(
                                                                            (System_String_o *)StringLiteral_5688/*"EVENT_REWARD_ASSIST_SKILL_CONFIRM"*/,
                                                                            0LL);
                                              if ( confirmMsgLabel )
                                              {
                                                ...
                                                Instance = (DataManager_o *)LocalizationManager__Get(
                                                                              (System_String_o *)StringLiteral_3764/*"COMMON_CONFIRM_YES"*/,
                                                                              0LL);
                                                if ( decideLabel )
                                                {
                                                  ...
                                                  Instance = (DataManager_o *)LocalizationManager__Get(
                                                                                (System_String_o *)StringLiteral_3760/*"COMMON_CONFIRM_NO"*/,
                                                                                0LL);
                                                  if ( cancelLabel )
                                                  {
                                                    ...
                                                    if ( Instance )
                                                    {
                                                      UnityEngine_GameObject__SetActive(
                                                        ...
                                                        0LL);
                                                      this->fields.state = 2;
                                                      v83 = (System_Action_o *)sub_1B9025C(System_Action_TypeInfo);
                                                      System_Action___ctor(
                                                        v83,
                                                        (Il2CppObject *)this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A74080 & 1) == 0 )
  {
    ...
    sub_1B90010(&EventRewardAssistConfirmDialog_TypeInfo, v6);
    this = (EventRewardAssistConfirmDialog___c__DisplayClass22_0_o *)sub_1B90010(&int_TypeInfo, v7);
    byte_4A74080 = 1;
  }
  ...
  v18 = System_String__Format_61801464((System_String_o *)klass, v16, v17, 0LL);
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
...
LABEL_14:
  ...
  v32 = System_String__Format_61801464(ASSIST_SKILL_ICON, v30, v31, 0LL);
