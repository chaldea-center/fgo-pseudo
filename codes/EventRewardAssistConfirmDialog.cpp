void __fastcall EventRewardAssistConfirmDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB0D73 & 1) == 0 )
  {
    sub_1BAB41C(&EventRewardAssistConfirmDialog_TypeInfo, v1);
    sub_1BAB41C(&StringLiteral_19284/*"event_skill_icon_{0}{1:D2}"*/, v2);
    byte_4AB0D73 = 1;
  }
  EventRewardAssistConfirmDialog_TypeInfo->static_fields->ASSIST_SKILL_ICON = (struct System_String_o *)StringLiteral_19284/*"event_skill_icon_{0}{1:D2}"*/;
  sub_1BAB3C0(EventRewardAssistConfirmDialog_TypeInfo->static_fields);
...
void __fastcall EventRewardAssistConfirmDialog__Init(EventRewardAssistConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  sub_1BAB3C0(&this->fields.onDecide);
  this->fields.state = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB0D70 & 1) == 0 )
  {
    sub_1BAB41C(&Method_EventRewardAssistConfirmDialog_OnClickCancel__, method);
    byte_4AB0D70 = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_EventRewardAssistConfirmDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BAB434(Method_EventRewardAssistConfirmDialog_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB0D6F & 1) == 0 )
  {
    sub_1BAB41C(&Method_EventRewardAssistConfirmDialog_OnClickDecide__, method);
    byte_4AB0D6F = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_EventRewardAssistConfirmDialog_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BAB434(Method_EventRewardAssistConfirmDialog_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BAB400(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  struct UICrossNarrowLabel_o *v67; // x8
  UILabel_o *confirmMsgLabel; // x20
  UILabel_o *decideLabel; // x20
  UILabel_o *cancelLabel; // x20
  System_Action_o *v71; // x20
  int v72; // [xsp+8h] [xbp-68h] BYREF
  int v73; // [xsp+Ch] [xbp-64h] BYREF

  if ( (byte_4AB0D6E & 1) == 0 )
  {
    sub_1BAB41C(&System_Action_TypeInfo, shopEnt);
    sub_1BAB41C(&AtlasManager_TypeInfo, v7);
    sub_1BAB41C(&Method_DataManager_GetMasterData_AssistMaster___, v8);
    ...
    sub_1BAB41C(&Method_EventRewardAssistConfirmDialog_EndOpen__, v11);
    sub_1BAB41C(&EventRewardAssistConfirmDialog_TypeInfo, v12);
    ...
    sub_1BAB41C(&Method_EventRewardAssistConfirmDialog___c__DisplayClass22_0__Open_b__0__, v16);
    sub_1BAB41C(&EventRewardAssistConfirmDialog___c__DisplayClass22_0_TypeInfo, v17);
    sub_1BAB41C(&StringLiteral_8241/*"LEVEL_INFO"*/, v18);
    sub_1BAB41C(&StringLiteral_5691/*"EVENT_REWARD_ASSIST_SKILL_MSG"*/, v19);
    sub_1BAB41C(&StringLiteral_5690/*"EVENT_REWARD_ASSIST_SKILL_LV"*/, v20);
    sub_1BAB41C(&StringLiteral_5693/*"EVENT_REWARD_ASSIST_SKILL_TITLE"*/, v21);
    sub_1BAB41C(&StringLiteral_3757/*"COMMON_CONFIRM_NO"*/, v22);
    sub_1BAB41C(&StringLiteral_3761/*"COMMON_CONFIRM_YES"*/, v23);
    sub_1BAB41C(&StringLiteral_5689/*"EVENT_REWARD_ASSIST_SKILL_CONFIRM"*/, v24);
    byte_4AB0D6E = 1;
  }
  v25 = (Il2CppObject *)sub_1BAB668(EventRewardAssistConfirmDialog___c__DisplayClass22_0_TypeInfo);
  ...
  Instance = (DataManager_o *)sub_1BAB3C0(&v25[1].monitor);
  ...
  v30 = (Il2CppObject *)*((_QWORD *)monitor + 13);
  v31 = *(_DWORD *)(v29 + 32);
  ...
  v25[2].klass = (Il2CppClass *)AssistMaster__GetCurrentLevelEntity((AssistMaster_o *)Instance, v31, 0LL);
  v33 = (DataManager_o **)&v25[2];
  Instance = (DataManager_o *)sub_1BAB3C0(&v25[2]);
  if ( !v25[2].klass )
    goto LABEL_46;
  v25[2].monitor = AssistMaster__GetAssistEntity(v32, v31, LODWORD(v25[2].klass->_1.byval_arg.data) + 1, 0LL);
  p_monitor = (DataManager_o **)&v25[2].monitor;
  sub_1BAB3C0(&v25[2].monitor);
  this->fields.onDecide = onDecide;
  p_onDecide = &this->fields.onDecide;
  Instance = (DataManager_o *)sub_1BAB3C0(&this->fields.onDecide);
  klass = v25[2].klass;
  if ( klass && *p_monitor )
  {
    bits = klass->_1.byval_arg.bits;
    v38 = *(&klass->_1.byval_arg.bits + 1);
    Instance = (DataManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_378A22C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( Instance )
    {
      Instance = (DataManager_o *)DataManager__GetMasterData_object_(
      ...
      if ( Instance )
      {
        ...
        if ( *p_monitor )
        {
          v40 = (SkillEntity_o *)Instance;
          datalist = (int32_t)v39->fields.datalist;
          datalist_high = HIDWORD(v39->fields.datalist);
          Instance = (DataManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_378A22C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
          if ( Instance )
          {
            Instance = (DataManager_o *)DataManager__GetMasterData_object_(
            ...
            if ( Instance )
            {
              ...
              if ( v40 )
              {
                ...
                v44 = (SkillEntity_o *)Instance;
                Instance = (DataManager_o *)SkillEntity__getName(v40, 0LL);
                if ( skillNameLabel )
                {
                  ...
                  if ( v44 )
                  {
                    ...
                    if ( combineSkillNameLabel )
                    {
                      ...
                      if ( !EventRewardAssistConfirmDialog_TypeInfo->_2.cctor_finished )
                        Instance = (DataManager_o *)j_il2cpp_runtime_class_init_0(EventRewardAssistConfirmDialog_TypeInfo);
                      if ( v46 )
                      {
                        ...
                        if ( Instance )
                        {
                          ...
                          v49 = LocalizationManager__Get((System_String_o *)StringLiteral_8241/*"LEVEL_INFO"*/, 0LL);
                          v73 = v38;
                          ...
                          if ( skillLvLabel )
                          {
                            ...
                            v55 = LocalizationManager__Get((System_String_o *)StringLiteral_5690/*"EVENT_REWARD_ASSIST_SKILL_LV"*/, 0LL);
                            v72 = datalist_high;
                            v59 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v72, v56, v57, v58);
                            Instance = (DataManager_o *)System_String__Format(v55, v59, 0LL);
                            if ( combineSkillLvLabel )
                            {
                              ...
                              if ( *v33 )
                              {
                                ...
                                v61 = this->fields.skillInfoLabel;
                                if ( v61 )
                                {
                                  WrapControlText__textAdjust(
                                    skillInfoLabel,
                                    (System_String_o *)Instance,
                                    v61->fields.mFontSize,
                                    0,
                                    0,
                                    0LL);
                                  Instance = *p_monitor;
                                  if ( *p_monitor )
                                  {
                                    ...
                                    Instance = (DataManager_o *)AssistEntity__GetDetail(
                                                                  ...
                                                                  0,
                                                                  0LL);
                                    v63 = this->fields.combineSkillInfoLabel;
                                    if ( v63 )
                                    {
                                      WrapControlText__textAdjust(
                                        combineSkillInfoLabel,
                                        (System_String_o *)Instance,
                                        v63->fields.mFontSize,
                                        0,
                                        0,
                                        0LL);
                                      titleLabel = this->fields.titleLabel;
                                      v65 = LocalizationManager__Get((System_String_o *)StringLiteral_5693/*"EVENT_REWARD_ASSIST_SKILL_TITLE"*/, 0LL);
                                      Instance = (DataManager_o *)System_String__Format(v65, v30, 0LL);
                                      if ( titleLabel )
                                      {
                                        ...
                                        if ( Instance )
                                        {
                                          ...
                                          Instance = (DataManager_o *)LocalizationManager__Get(
                                                                        (System_String_o *)StringLiteral_5691/*"EVENT_REWARD_ASSIST_SKILL_MSG"*/,
                                                                        0LL);
                                          v67 = this->fields.skillNameLabel;
                                          if ( v67 )
                                          {
                                            Instance = (DataManager_o *)System_String__Format(
                                                                          (System_String_o *)Instance,
                                                                          (Il2CppObject *)v67->fields.mText,
                                                                          0LL);
                                            if ( detailMsgLabel )
                                            {
                                              ...
                                              Instance = (DataManager_o *)LocalizationManager__Get(
                                                                            (System_String_o *)StringLiteral_5689/*"EVENT_REWARD_ASSIST_SKILL_CONFIRM"*/,
                                                                            0LL);
                                              if ( confirmMsgLabel )
                                              {
                                                ...
                                                Instance = (DataManager_o *)LocalizationManager__Get(
                                                                              (System_String_o *)StringLiteral_3761/*"COMMON_CONFIRM_YES"*/,
                                                                              0LL);
                                                if ( decideLabel )
                                                {
                                                  ...
                                                  Instance = (DataManager_o *)LocalizationManager__Get(
                                                                                (System_String_o *)StringLiteral_3757/*"COMMON_CONFIRM_NO"*/,
                                                                                0LL);
                                                  if ( cancelLabel )
                                                  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB0D74 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&EventRewardAssistConfirmDialog_TypeInfo, v6);
    this = (EventRewardAssistConfirmDialog___c__DisplayClass22_0_o *)sub_1BAB41C(&int_TypeInfo, v7);
    byte_4AB0D74 = 1;
  }
  ...
  v18 = System_String__Format_62062500((System_String_o *)klass, v16, v17, 0LL);
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
...
LABEL_14:
  ...
  v32 = System_String__Format_62062500(ASSIST_SKILL_ICON, v30, v31, 0LL);
