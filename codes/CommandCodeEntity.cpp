        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FA5B3 & 1) == 0 )
  {
    sub_B16FFC(&Method_DataManager_GetMasterData_CommandCodeSkillMaster___, idList);
...
LABEL_12:
    sub_B170D4();
  CommandCodeSkillMaster__getSkillInfo(v16, idList, titleList, explanationList, v17, UserId, -1, v19);
}