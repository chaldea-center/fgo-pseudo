void __fastcall FollowerRecommendSupportListRequest___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BC941B & 1) == 0 )
  {
    sub_1C1ABD4(&FollowerRecommendSupportListRequest_TypeInfo, v1);
    byte_4BC941B = 1;
  }
...
bool __fastcall FollowerRecommendSupportListRequest__CheckRefreshRate(const MethodInfo *method)
{
  ...
  if ( (byte_4BC9415 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&FollowerRecommendSupportListRequest_TypeInfo, v2);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC9419 & 1) == 0 )
  {
    sub_1C1ABD4(&BalanceConfig_TypeInfo, isEnforceRefresh);
    sub_1C1ABD4(&FollowerRecommendSupportListRequest_TypeInfo, v9);
    sub_1C1ABD4(&StringLiteral_23227/*"refresh"*/, v10);
    sub_1C1ABD4(&StringLiteral_23083/*"questPhase"*/, v11);
    sub_1C1ABD4(&StringLiteral_23081/*"questId"*/, v12);
    byte_4BC9419 = 1;
  }
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23083/*"questPhase"*/, questPhase, v13);
  if ( !this )
    sub_1C1AE30(v14, v15);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23227/*"refresh"*/, isEnforceRefresh, v16);
  if ( !isEnforceRefresh )
    goto LABEL_11;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC9416 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataManager_GetMaster_UserRecommendFollowerMaster___, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC9418 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_19820/*"follower/recommendSupportList"*/, v2);
    byte_4BC9418 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63040368(BaseUrl, (System_String_o *)StringLiteral_19820/*"follower/recommendSupportList"*/, 0LL);
}
