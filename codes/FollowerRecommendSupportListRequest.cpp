        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2E40F & 1) == 0 )
  {
    sub_1C94098(&BalanceConfig_TypeInfo);
    sub_1C94098(&FollowerRecommendSupportListRequest_TypeInfo);
    sub_1C94098(&StringLiteral_23231/*"refresh"*/);
  ...
  RequestBase__addField(
    (RequestBase_o *)this,
    (System_String_o *)StringLiteral_23086/*"questId"*/,
    questId,
    *(const MethodInfo **)&questPhase);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23090/*"questPhase"*/, questPhase, v9);
  if ( !this )
    sub_1C942F0(v10, v11);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23231/*"refresh"*/, isEnforceRefresh, v12);
  if ( !isEnforceRefresh )
    goto LABEL_11;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C94098(&NetworkManager_TypeInfo);
    sub_1C94098(&StringLiteral_19684/*"follower/recommendSupportList"*/);
    byte_4D2E40E = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64417744(BaseUrl, (System_String_o *)StringLiteral_19684/*"follower/recommendSupportList"*/, 0);
}
