        ...
        const MethodInfo *method)
{
  ...
  if ( !this )
    sub_1C2D6EC(v9, v10);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22985/*"refresh"*/, isEnforceRefresh, 0);
  if ( !isEnforceRefresh )
    goto LABEL_11;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C2D490(&NetworkManager_TypeInfo);
    sub_1C2D490(&StringLiteral_19508/*"follower/recommendSupportList"*/);
    byte_4C28DF9 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63457864(BaseUrl, (System_String_o *)StringLiteral_19508/*"follower/recommendSupportList"*/, 0);
}
