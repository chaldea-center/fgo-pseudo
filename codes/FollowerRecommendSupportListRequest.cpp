        ...
        const MethodInfo *method)
{
  ...
  if ( !this )
    sub_1C22094(v10, v11);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23247/*"refresh"*/, isEnforceRefresh, v12);
  if ( !isEnforceRefresh )
    goto LABEL_11;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C21E38(&NetworkManager_TypeInfo);
    sub_1C21E38(&StringLiteral_19835/*"follower/recommendSupportList"*/);
    byte_4BDDEC2 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63115476(BaseUrl, (System_String_o *)StringLiteral_19835/*"follower/recommendSupportList"*/, 0LL);
}
