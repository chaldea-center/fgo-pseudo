        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF017E & 1) == 0 )
  {
    sub_1C7BAE8(&BalanceConfig_TypeInfo);
    sub_1C7BAE8(&FollowerRecommendSupportListRequest_TypeInfo);
    sub_1C7BAE8(&StringLiteral_23226/*"refresh"*/);
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23085/*"questPhase"*/, questPhase, v9);
  if ( !this )
    sub_1C7BD40(v10, v11);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23226/*"refresh"*/, isEnforceRefresh, v12);
  if ( !isEnforceRefresh )
    goto LABEL_11;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C7BAE8(&NetworkManager_TypeInfo);
    sub_1C7BAE8(&StringLiteral_19679/*"follower/recommendSupportList"*/);
    byte_4CF017D = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64176912(BaseUrl, (System_String_o *)StringLiteral_19679/*"follower/recommendSupportList"*/, 0);
}
