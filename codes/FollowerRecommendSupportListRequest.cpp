        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC8F6E & 1) == 0 )
  {
    sub_1C713B0(&BalanceConfig_TypeInfo);
    sub_1C713B0(&FollowerRecommendSupportListRequest_TypeInfo);
    sub_1C713B0(&StringLiteral_23117/*"refresh"*/);
  ...
  RequestBase__addField(
    (RequestBase_o *)this,
    (System_String_o *)StringLiteral_22972/*"questId"*/,
    questId,
    *(const MethodInfo **)&questPhase);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22976/*"questPhase"*/, questPhase, v9);
  if ( !this )
    sub_1C71608(v10, v11);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23117/*"refresh"*/, isEnforceRefresh, v12);
  if ( !isEnforceRefresh )
    goto LABEL_11;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C713B0(&NetworkManager_TypeInfo);
    sub_1C713B0(&StringLiteral_19597/*"follower/recommendSupportList"*/);
    byte_4CC8F6D = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64031724(BaseUrl, (System_String_o *)StringLiteral_19597/*"follower/recommendSupportList"*/, 0);
}
