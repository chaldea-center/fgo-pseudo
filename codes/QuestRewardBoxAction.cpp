...
void QuestRewardBoxAction__Awake(QuestRewardBoxAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E742E9 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_CStateManager_QuestRewardBoxAction___ctor__);
    sub_1D0F0B4(&Method_CStateManager_QuestRewardBoxAction__add__);
    sub_1D0F0B4(&CStateManager_QuestRewardBoxAction__TypeInfo);
    ...
    sub_1D0F0B4(&QuestRewardBoxAction_StateNone_TypeInfo);
    sub_1D0F0B4(&QuestRewardBoxAction_StatePlay_TypeInfo);
    byte_4E742E9 = 1;
  }
  if ( !this->fields.mFSM )
  {
    v3 = (CStateManager_T__o *)sub_1D0F300(CStateManager_QuestRewardBoxAction__TypeInfo);
    CStateManager_object____ctor(
      v3,
      (Il2CppObject *)this,
      2,
      (const MethodInfo_34BF700 *)Method_CStateManager_QuestRewardBoxAction___ctor__);
    ...
    v11 = (Il2CppObject *)sub_1D0F300(QuestRewardBoxAction_StateNone_TypeInfo);
    ...
    CStateManager_object___add(
      ...
      0,
      (IState_T__o *)v11,
      (const MethodInfo_34BF7A8 *)Method_CStateManager_QuestRewardBoxAction__add__);
    v14 = (CStateManager_T__o *)this->fields.mFSM;
    v15 = (Il2CppObject *)sub_1D0F300(QuestRewardBoxAction_StatePlay_TypeInfo);
      ...
      if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)v21, 0, 0) )
      {
        ...
        if ( v21 )
        {
          ...
          if ( ComponentInChildren_object )
          {
            ...
            sub_1D0F058(p_particleObj, (int32_t)v21, v22, v23, v24, v25, v26, v27);
            return;
          }
        }
LABEL_22:
        sub_1D0F30C(ComponentInChildren_object, v13);
      }
    }
  }
}
...
int32_t QuestRewardBoxAction__GetState(QuestRewardBoxAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E742ED & 1) == 0 )
  {
    this = (QuestRewardBoxAction_o *)sub_1D0F0B4(&Method_CStateManager_QuestRewardBoxAction__getState__);
    byte_4E742ED = 1;
  }
  mFSM = v2->fields.mFSM;
  if ( !mFSM )
...
void QuestRewardBoxAction__Play(QuestRewardBoxAction_o *this, System_Action_o *end_act, const MethodInfo *method)
{
  ...
  if ( (byte_4E742EC & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    sub_1D0F0B4(&Method_QuestRewardBoxAction__Play_b__19_0__);
  ...
  if ( ((unsigned __int8)gameObject & 1) != 0 )
  {
    ...
    {
LABEL_14:
      v19 = sub_1CE5430(gameObject, SimpleAnimation_State_TypeInfo, 8);
    }
...
void QuestRewardBoxAction__SetState(QuestRewardBoxAction_o *this, int32_t state, const MethodInfo *method)
{
  ...
  if ( (byte_4E742EE & 1) == 0 )
  {
    sub_1D0F0B4(&Method_CStateManager_QuestRewardBoxAction__setState__);
    byte_4E742EE = 1;
  }
  mFSM = (CStateManager_T__o *)this->fields.mFSM;
  if ( !mFSM )
  ...
  CStateManager_object___setState(
    mFSM,
    state,
    (const MethodInfo_34BF834 *)Method_CStateManager_QuestRewardBoxAction__setState__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E742EB & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_17634/*"box_s_open"*/);
    sub_1D0F0B4(&StringLiteral_17625/*"box_g_lock"*/);
    sub_1D0F0B4(&StringLiteral_17630/*"box_n_lock"*/);
    sub_1D0F0B4(&StringLiteral_17633/*"box_s_lock"*/);
    sub_1D0F0B4(&StringLiteral_17629/*"box_n_base"*/);
    sub_1D0F0B4(&StringLiteral_17626/*"box_g_open"*/);
    sub_1D0F0B4(&StringLiteral_17632/*"box_s_base"*/);
    sub_1D0F0B4(&StringLiteral_17624/*"box_g_base"*/);
    sub_1D0F0B4(&StringLiteral_17631/*"box_n_open"*/);
    byte_4E742EB = 1;
  }
  ...
  switch ( box_type )
  {
    case 2:
      ...
      if ( transform )
      {
        ...
        if ( transform )
        {
          UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17624/*"box_g_base"*/, 0);
          ...
          if ( transform )
          {
            ...
            if ( transform )
            {
              UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17625/*"box_g_lock"*/, 0);
              ...
              if ( transform )
              {
                ...
                if ( transform )
                {
                  v23 = &StringLiteral_17626/*"box_g_open"*/;
                  goto LABEL_34;
                }
              }
            }
...
LABEL_35:
    ...
    case 1:
      ...
      if ( transform )
      {
        ...
        if ( transform )
        {
          UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17632/*"box_s_base"*/, 0);
          transform = (UnityEngine_Component_o *)this->fields.mBoxLockSp;
          if ( transform )
          {
            UISprite__set_atlas((UISprite_o *)transform, this->fields.mSilverAtlas, 0);
            ...
            if ( transform )
            {
              UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17633/*"box_s_lock"*/, 0);
              transform = (UnityEngine_Component_o *)this->fields.mBoxOpenSp;
              if ( transform )
              {
                UISprite__set_atlas((UISprite_o *)transform, this->fields.mSilverAtlas, 0);
                ...
                if ( transform )
                {
                  v23 = &StringLiteral_17634/*"box_s_open"*/;
                  goto LABEL_34;
                }
              }
            }
    ...
    case 0:
      ...
      if ( transform )
      {
        ...
        if ( transform )
        {
          UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17629/*"box_n_base"*/, 0);
          transform = (UnityEngine_Component_o *)this->fields.mBoxLockSp;
          if ( transform )
          {
            UISprite__set_atlas((UISprite_o *)transform, this->fields.mNormalAtlas, 0);
            ...
            if ( transform )
            {
              UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17630/*"box_n_lock"*/, 0);
              transform = (UnityEngine_Component_o *)this->fields.mBoxOpenSp;
              if ( transform )
              {
                UISprite__set_atlas((UISprite_o *)transform, this->fields.mNormalAtlas, 0);
                ...
                if ( transform )
                {
                  v23 = &StringLiteral_17631/*"box_n_open"*/;
LABEL_34:
...
void QuestRewardBoxAction__Update(QuestRewardBoxAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E742EA & 1) == 0 )
  {
    sub_1D0F0B4(&Method_CStateManager_QuestRewardBoxAction__update__);
    byte_4E742EA = 1;
  }
  mFSM = (CStateManager_T__o *)this->fields.mFSM;
  if ( mFSM )
    CStateManager_object___update(mFSM, (const MethodInfo_34BF810 *)Method_CStateManager_QuestRewardBoxAction__update__);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    this = (QuestRewardBoxAction_StatePlay_o *)sub_1D0F0B4(&SimpleAnimation_State_TypeInfo);
    byte_4E742EF = 1;
  }
  if ( !that )
    goto LABEL_29;
  ...
  if ( ((unsigned __int8)this & 1) == 0 )
  {
    ...
    if ( v15 )
    {
      ...
      if ( this )
      {
        ...
        this = (QuestRewardBoxAction_StatePlay_o *)UnityEngine_Animation__Play_73101556(v15, name, 0);
...
LABEL_29:
  ...
  this = (QuestRewardBoxAction_StatePlay_o *)SimpleAnimation__Play_68509268(v5, v6, 0);
  ...
  {
LABEL_16:
    v13 = sub_1CE5430(this, SimpleAnimation_State_TypeInfo, 8);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E742F0 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    sub_1D0F0B4(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1D0F0B4(&Method_QuestRewardBoxAction_StatePlay___c__DisplayClass1_0__update_b__0__);
    sub_1D0F0B4(&Method_QuestRewardBoxAction_StatePlay___c__DisplayClass1_0__update_b__1__);
    sub_1D0F0B4(&QuestRewardBoxAction_StatePlay___c__DisplayClass1_0_TypeInfo);
    byte_4E742F0 = 1;
  }
  v4 = sub_1D0F300(QuestRewardBoxAction_StatePlay___c__DisplayClass1_0_TypeInfo);
