...
void QuestRewardBoxAction__Awake(QuestRewardBoxAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C24076 & 1) == 0 )
  {
    sub_1C2D490(&Method_CStateManager_QuestRewardBoxAction___ctor__);
    sub_1C2D490(&Method_CStateManager_QuestRewardBoxAction__add__);
    sub_1C2D490(&CStateManager_QuestRewardBoxAction__TypeInfo);
    sub_1C2D490(&Method_UnityEngine_GameObject_GetComponentInChildren_UIUnityRenderer___);
    sub_1C2D490(&Method_UnityEngine_Object_Instantiate_GameObject___);
    sub_1C2D490(&UnityEngine_Object_TypeInfo);
    sub_1C2D490(&QuestRewardBoxAction_StateNone_TypeInfo);
    sub_1C2D490(&QuestRewardBoxAction_StatePlay_TypeInfo);
    byte_4C24076 = 1;
  }
  if ( !this->fields.mFSM )
  {
    v3 = (CStateManager_T__o *)sub_1C2D6DC(CStateManager_QuestRewardBoxAction__TypeInfo);
    CStateManager_object____ctor(
      v3,
      (Il2CppObject *)this,
      2,
      (const MethodInfo_3313C68 *)Method_CStateManager_QuestRewardBoxAction___ctor__);
    ...
    v7 = (Il2CppObject *)sub_1C2D6DC(QuestRewardBoxAction_StateNone_TypeInfo);
    ...
    CStateManager_object___add(
      ...
      0,
      (IState_T__o *)v7,
      (const MethodInfo_3313D10 *)Method_CStateManager_QuestRewardBoxAction__add__);
    v10 = (CStateManager_T__o *)this->fields.mFSM;
    v11 = (Il2CppObject *)sub_1C2D6DC(QuestRewardBoxAction_StatePlay_TypeInfo);
      ...
      if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)v17, 0, 0) )
      {
        ...
        if ( v17 )
        {
          ...
          if ( ComponentInChildren_object )
          {
            ...
            sub_1C2D434(p_particleObj, (int32_t)v17, v18, v19);
            return;
          }
        }
LABEL_22:
        sub_1C2D6EC(ComponentInChildren_object, v9);
      }
    }
  }
}
...
int32_t QuestRewardBoxAction__GetState(QuestRewardBoxAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2407A & 1) == 0 )
  {
    this = (QuestRewardBoxAction_o *)sub_1C2D490(&Method_CStateManager_QuestRewardBoxAction__getState__);
    byte_4C2407A = 1;
  }
  mFSM = v2->fields.mFSM;
  if ( !mFSM )
...
void QuestRewardBoxAction__Play(QuestRewardBoxAction_o *this, System_Action_o *end_act, const MethodInfo *method)
{
  ...
  if ( (byte_4C24079 & 1) == 0 )
  {
    ...
    sub_1C2D490(&UnityEngine_Object_TypeInfo);
    sub_1C2D490(&Method_QuestRewardBoxAction__Play_b__19_0__);
  ...
  if ( ((unsigned __int8)gameObject & 1) != 0 )
  {
    ...
    {
LABEL_14:
      v15 = sub_1C7DCA8(gameObject, SimpleAnimation_State_TypeInfo, 8);
    }
...
void QuestRewardBoxAction__SetState(QuestRewardBoxAction_o *this, int32_t state, const MethodInfo *method)
{
  ...
  if ( (byte_4C2407B & 1) == 0 )
  {
    sub_1C2D490(&Method_CStateManager_QuestRewardBoxAction__setState__);
    byte_4C2407B = 1;
  }
  mFSM = (CStateManager_T__o *)this->fields.mFSM;
  if ( !mFSM )
  ...
  CStateManager_object___setState(
    mFSM,
    state,
    (const MethodInfo_3313D9C *)Method_CStateManager_QuestRewardBoxAction__setState__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24078 & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_17371/*"box_s_open"*/);
    sub_1C2D490(&StringLiteral_17362/*"box_g_lock"*/);
    sub_1C2D490(&StringLiteral_17367/*"box_n_lock"*/);
    sub_1C2D490(&StringLiteral_17370/*"box_s_lock"*/);
    sub_1C2D490(&StringLiteral_17366/*"box_n_base"*/);
    sub_1C2D490(&StringLiteral_17363/*"box_g_open"*/);
    sub_1C2D490(&StringLiteral_17369/*"box_s_base"*/);
    sub_1C2D490(&StringLiteral_17361/*"box_g_base"*/);
    sub_1C2D490(&StringLiteral_17368/*"box_n_open"*/);
    byte_4C24078 = 1;
  }
  ...
  switch ( box_type )
  {
    case 2:
      ...
      if ( transform )
      {
        ...
        if ( transform )
        {
          UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17361/*"box_g_base"*/, 0);
          ...
          if ( transform )
          {
            ...
            if ( transform )
            {
              UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17362/*"box_g_lock"*/, 0);
              ...
              if ( transform )
              {
                ...
                if ( transform )
                {
                  v15 = &StringLiteral_17363/*"box_g_open"*/;
                  goto LABEL_34;
                }
              }
            }
...
LABEL_35:
    ...
    case 1:
      ...
      if ( transform )
      {
        ...
        if ( transform )
        {
          UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17369/*"box_s_base"*/, 0);
          transform = (UnityEngine_Component_o *)this->fields.mBoxLockSp;
          if ( transform )
          {
            UISprite__set_atlas((UISprite_o *)transform, this->fields.mSilverAtlas, 0);
            ...
            if ( transform )
            {
              UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17370/*"box_s_lock"*/, 0);
              transform = (UnityEngine_Component_o *)this->fields.mBoxOpenSp;
              if ( transform )
              {
                UISprite__set_atlas((UISprite_o *)transform, this->fields.mSilverAtlas, 0);
                ...
                if ( transform )
                {
                  v15 = &StringLiteral_17371/*"box_s_open"*/;
                  goto LABEL_34;
                }
              }
            }
    ...
    case 0:
      ...
      if ( transform )
      {
        ...
        if ( transform )
        {
          UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17366/*"box_n_base"*/, 0);
          transform = (UnityEngine_Component_o *)this->fields.mBoxLockSp;
          if ( transform )
          {
            UISprite__set_atlas((UISprite_o *)transform, this->fields.mNormalAtlas, 0);
            ...
            if ( transform )
            {
              UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17367/*"box_n_lock"*/, 0);
              transform = (UnityEngine_Component_o *)this->fields.mBoxOpenSp;
              if ( transform )
              {
                UISprite__set_atlas((UISprite_o *)transform, this->fields.mNormalAtlas, 0);
                ...
                if ( transform )
                {
                  v15 = &StringLiteral_17368/*"box_n_open"*/;
LABEL_34:
...
void QuestRewardBoxAction__Update(QuestRewardBoxAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C24077 & 1) == 0 )
  {
    sub_1C2D490(&Method_CStateManager_QuestRewardBoxAction__update__);
    byte_4C24077 = 1;
  }
  mFSM = (CStateManager_T__o *)this->fields.mFSM;
  if ( mFSM )
    CStateManager_object___update(mFSM, (const MethodInfo_3313D78 *)Method_CStateManager_QuestRewardBoxAction__update__);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C2D490(&UnityEngine_Object_TypeInfo);
    this = (QuestRewardBoxAction_StatePlay_o *)sub_1C2D490(&SimpleAnimation_State_TypeInfo);
    byte_4C2407C = 1;
  }
  if ( !that )
    goto LABEL_29;
  ...
  if ( ((unsigned __int8)this & 1) == 0 )
  {
    ...
    if ( v15 )
    {
      ...
      if ( this )
      {
        ...
        this = (QuestRewardBoxAction_StatePlay_o *)UnityEngine_Animation__Play_70908988(v15, name, 0);
...
LABEL_29:
  ...
  this = (QuestRewardBoxAction_StatePlay_o *)SimpleAnimation__Play_66404364(v5, v6, 0);
  ...
  {
LABEL_16:
    v13 = sub_1C7DCA8(this, SimpleAnimation_State_TypeInfo, 8);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2407D & 1) == 0 )
  {
    ...
    sub_1C2D490(&UnityEngine_Object_TypeInfo);
    sub_1C2D490(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1C2D490(&Method_QuestRewardBoxAction_StatePlay___c__DisplayClass1_0__update_b__0__);
    sub_1C2D490(&Method_QuestRewardBoxAction_StatePlay___c__DisplayClass1_0__update_b__1__);
    sub_1C2D490(&QuestRewardBoxAction_StatePlay___c__DisplayClass1_0_TypeInfo);
    byte_4C2407D = 1;
  }
  v4 = sub_1C2D6DC(QuestRewardBoxAction_StatePlay___c__DisplayClass1_0_TypeInfo);
