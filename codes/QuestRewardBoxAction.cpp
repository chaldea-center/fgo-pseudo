...
void __fastcall QuestRewardBoxAction__Awake(QuestRewardBoxAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B340FB & 1) == 0 )
  {
    sub_1BD3458(&Method_CStateManager_QuestRewardBoxAction___ctor__, method);
    sub_1BD3458(&Method_CStateManager_QuestRewardBoxAction__add__, v3);
    sub_1BD3458(&CStateManager_QuestRewardBoxAction__TypeInfo, v4);
    ...
    sub_1BD3458(&QuestRewardBoxAction_StateNone_TypeInfo, v8);
    sub_1BD3458(&QuestRewardBoxAction_StatePlay_TypeInfo, v9);
    byte_4B340FB = 1;
  }
  if ( !this->fields.mFSM )
  {
    v10 = (CStateManager_T__o *)sub_1BD36A4(CStateManager_QuestRewardBoxAction__TypeInfo);
    CStateManager_object____ctor(
      v10,
      (Il2CppObject *)this,
      2,
      (const MethodInfo_315EC74 *)Method_CStateManager_QuestRewardBoxAction___ctor__);
    ...
    v18 = (Il2CppObject *)sub_1BD36A4(QuestRewardBoxAction_StateNone_TypeInfo);
    ...
    CStateManager_object___add(
      ...
      0,
      (IState_T__o *)v18,
      (const MethodInfo_315ED1C *)Method_CStateManager_QuestRewardBoxAction__add__);
    v21 = (CStateManager_T__o *)this->fields.mFSM;
    v22 = (Il2CppObject *)sub_1BD36A4(QuestRewardBoxAction_StatePlay_TypeInfo);
...
LABEL_22:
        sub_1BD36B4(ComponentInChildren_object, v20);
      }
    }
  }
}
...
int32_t __fastcall QuestRewardBoxAction__GetState(QuestRewardBoxAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B340FF & 1) == 0 )
  {
    this = (QuestRewardBoxAction_o *)sub_1BD3458(&Method_CStateManager_QuestRewardBoxAction__getState__, method);
    byte_4B340FF = 1;
  }
  mFSM = v2->fields.mFSM;
  if ( !mFSM )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B340FE & 1) == 0 )
  {
    ...
    sub_1BD3458(&Method_QuestRewardBoxAction__Play_b__19_0__, v12);
    sub_1BD3458(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v13);
    sub_1BD3458(&SimpleAnimation_State_TypeInfo, v14);
    byte_4B340FE = 1;
  }
  ...
  if ( ((unsigned __int8)gameObject & 1) != 0 )
  {
    ...
    {
LABEL_14:
      v24 = sub_1C25438(gameObject, SimpleAnimation_State_TypeInfo, 8LL);
    }
...
void __fastcall QuestRewardBoxAction__SetState(QuestRewardBoxAction_o *this, int32_t state, const MethodInfo *method)
{
  ...
  if ( (byte_4B34100 & 1) == 0 )
  {
    sub_1BD3458(&Method_CStateManager_QuestRewardBoxAction__setState__, *(_QWORD *)&state);
    byte_4B34100 = 1;
  }
  mFSM = (CStateManager_T__o *)this->fields.mFSM;
  if ( !mFSM )
  ...
  CStateManager_object___setState(
    mFSM,
    state,
    (const MethodInfo_315EDA8 *)Method_CStateManager_QuestRewardBoxAction__setState__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B340FD & 1) == 0 )
  {
    sub_1BD3458(&Method_UnityEngine_Component_GetComponentInChildren_Animation___, *(_QWORD *)&box_type);
    ...
    sub_1BD3458(&StringLiteral_17605/*"box_s_open"*/, v9);
    sub_1BD3458(&StringLiteral_17596/*"box_g_lock"*/, v10);
    sub_1BD3458(&StringLiteral_17601/*"box_n_lock"*/, v11);
    sub_1BD3458(&StringLiteral_17604/*"box_s_lock"*/, v12);
    sub_1BD3458(&StringLiteral_17600/*"box_n_base"*/, v13);
    sub_1BD3458(&StringLiteral_17597/*"box_g_open"*/, v14);
    sub_1BD3458(&StringLiteral_17603/*"box_s_base"*/, v15);
    sub_1BD3458(&StringLiteral_17595/*"box_g_base"*/, v16);
    sub_1BD3458(&StringLiteral_17602/*"box_n_open"*/, v17);
    byte_4B340FD = 1;
  }
  ...
  if ( !transform )
    goto LABEL_35;
  v27 = UnityEngine_Component__GetComponentInChildren_object__49447820(
          transform,
  ...
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.mSimpleAnimation, (int64_t)v27, v28, v29, v30, v31, v32, v33);
  transform = (UnityEngine_Component_o *)UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0LL);
  if ( !transform )
    goto LABEL_35;
  ...
  switch ( box_type )
  {
    case 2:
      ...
      if ( transform )
      {
        ...
        if ( transform )
        {
          UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17595/*"box_g_base"*/, 0LL);
          ...
          if ( transform )
          {
            ...
            if ( transform )
            {
              UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17596/*"box_g_lock"*/, 0LL);
              ...
              if ( transform )
              {
                ...
                if ( transform )
                {
                  v34 = &StringLiteral_17597/*"box_g_open"*/;
                  goto LABEL_34;
                }
              }
            }
...
LABEL_35:
    ...
    case 1:
      ...
      if ( transform )
      {
        ...
        if ( transform )
        {
          UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17603/*"box_s_base"*/, 0LL);
          transform = (UnityEngine_Component_o *)this->fields.mBoxLockSp;
          if ( transform )
          {
            UISprite__set_atlas((UISprite_o *)transform, this->fields.mSilverAtlas, 0LL);
            ...
            if ( transform )
            {
              UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17604/*"box_s_lock"*/, 0LL);
              transform = (UnityEngine_Component_o *)this->fields.mBoxOpenSp;
              if ( transform )
              {
                UISprite__set_atlas((UISprite_o *)transform, this->fields.mSilverAtlas, 0LL);
                ...
                if ( transform )
                {
                  v34 = &StringLiteral_17605/*"box_s_open"*/;
                  goto LABEL_34;
                }
              }
            }
    ...
    case 0:
      ...
      if ( transform )
      {
        ...
        if ( transform )
        {
          UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17600/*"box_n_base"*/, 0LL);
          transform = (UnityEngine_Component_o *)this->fields.mBoxLockSp;
          if ( transform )
          {
            UISprite__set_atlas((UISprite_o *)transform, this->fields.mNormalAtlas, 0LL);
            ...
            if ( transform )
            {
              UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17601/*"box_n_lock"*/, 0LL);
              transform = (UnityEngine_Component_o *)this->fields.mBoxOpenSp;
              if ( transform )
              {
                UISprite__set_atlas((UISprite_o *)transform, this->fields.mNormalAtlas, 0LL);
                ...
                if ( transform )
                {
                  v34 = &StringLiteral_17602/*"box_n_open"*/;
LABEL_34:
...
void __fastcall QuestRewardBoxAction__Update(QuestRewardBoxAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B340FC & 1) == 0 )
  {
    sub_1BD3458(&Method_CStateManager_QuestRewardBoxAction__update__, method);
    byte_4B340FC = 1;
  }
  mFSM = (CStateManager_T__o *)this->fields.mFSM;
  if ( mFSM )
    CStateManager_object___update(mFSM, (const MethodInfo_315ED84 *)Method_CStateManager_QuestRewardBoxAction__update__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B34101 & 1) == 0 )
  {
    ...
    this = (QuestRewardBoxAction_StatePlay_o *)sub_1BD3458(&SimpleAnimation_State_TypeInfo, v4);
    byte_4B34101 = 1;
  }
  if ( !that )
    goto LABEL_29;
  ...
  if ( ((unsigned __int8)this & 1) == 0 )
  {
    ...
    if ( v16 )
    {
      ...
      if ( this )
      {
        ...
        this = (QuestRewardBoxAction_StatePlay_o *)UnityEngine_Animation__Play_70023276(v16, name, 0LL);
...
LABEL_29:
  ...
  this = (QuestRewardBoxAction_StatePlay_o *)SimpleAnimation__Play_64663364(v6, v7, 0LL);
  ...
  {
LABEL_16:
    v14 = sub_1C25438(this, SimpleAnimation_State_TypeInfo, 8LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B34102 & 1) == 0 )
  {
    ...
    sub_1BD3458(&Method_QuestRewardBoxAction_StatePlay___c__DisplayClass1_0__update_b__0__, v6);
    sub_1BD3458(&Method_QuestRewardBoxAction_StatePlay___c__DisplayClass1_0__update_b__1__, v7);
    sub_1BD3458(&QuestRewardBoxAction_StatePlay___c__DisplayClass1_0_TypeInfo, v8);
    byte_4B34102 = 1;
  }
  v9 = sub_1BD36A4(QuestRewardBoxAction_StatePlay___c__DisplayClass1_0_TypeInfo);
