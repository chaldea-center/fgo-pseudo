...
void QuestRewardBoxAction__Awake(QuestRewardBoxAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E016A6 & 1) == 0 )
  {
    sub_1CE6700(&Method_CStateManager_QuestRewardBoxAction___ctor__);
    sub_1CE6700(&Method_CStateManager_QuestRewardBoxAction__add__);
    sub_1CE6700(&CStateManager_QuestRewardBoxAction__TypeInfo);
    ...
    sub_1CE6700(&QuestRewardBoxAction_StateNone_TypeInfo);
    sub_1CE6700(&QuestRewardBoxAction_StatePlay_TypeInfo);
    byte_4E016A6 = 1;
  }
  if ( !this->fields.mFSM )
  {
    v3 = (CStateManager_T__o *)sub_1CE694C(CStateManager_QuestRewardBoxAction__TypeInfo);
    CStateManager_object____ctor(
      v3,
      (Il2CppObject *)this,
      2,
      (const MethodInfo_3473510 *)Method_CStateManager_QuestRewardBoxAction___ctor__);
    ...
    v11 = (Il2CppObject *)sub_1CE694C(QuestRewardBoxAction_StateNone_TypeInfo);
    ...
    CStateManager_object___add(
      ...
      0,
      (IState_T__o *)v11,
      (const MethodInfo_34735B8 *)Method_CStateManager_QuestRewardBoxAction__add__);
    v14 = (CStateManager_T__o *)this->fields.mFSM;
    v15 = (Il2CppObject *)sub_1CE694C(QuestRewardBoxAction_StatePlay_TypeInfo);
      ...
      if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)v21, 0, 0) )
      {
        ...
        if ( v21 )
        {
          ...
          if ( ComponentInChildren_object )
          {
            ...
            sub_1CE66A4(p_particleObj, (int32_t)v21, v22, v23, v24, v25, v26, v27);
            return;
          }
        }
LABEL_22:
        sub_1CE6958(ComponentInChildren_object, v13);
      }
    }
  }
}
...
int32_t QuestRewardBoxAction__GetState(QuestRewardBoxAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E016AA & 1) == 0 )
  {
    this = (QuestRewardBoxAction_o *)sub_1CE6700(&Method_CStateManager_QuestRewardBoxAction__getState__);
    byte_4E016AA = 1;
  }
  mFSM = v2->fields.mFSM;
  if ( !mFSM )
...
void QuestRewardBoxAction__Play(QuestRewardBoxAction_o *this, System_Action_o *end_act, const MethodInfo *method)
{
  ...
  if ( (byte_4E016A9 & 1) == 0 )
  {
    ...
    sub_1CE6700(&UnityEngine_Object_TypeInfo);
    sub_1CE6700(&Method_QuestRewardBoxAction__Play_b__19_0__);
  ...
  if ( ((unsigned __int8)gameObject & 1) != 0 )
  {
    ...
    {
LABEL_14:
      v19 = sub_1CBCA7C(gameObject, SimpleAnimation_State_TypeInfo, 8);
    }
...
void QuestRewardBoxAction__SetState(QuestRewardBoxAction_o *this, int32_t state, const MethodInfo *method)
{
  ...
  if ( (byte_4E016AB & 1) == 0 )
  {
    sub_1CE6700(&Method_CStateManager_QuestRewardBoxAction__setState__);
    byte_4E016AB = 1;
  }
  mFSM = (CStateManager_T__o *)this->fields.mFSM;
  if ( !mFSM )
  ...
  CStateManager_object___setState(
    mFSM,
    state,
    (const MethodInfo_3473644 *)Method_CStateManager_QuestRewardBoxAction__setState__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E016A8 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_17560/*"box_s_open"*/);
    sub_1CE6700(&StringLiteral_17551/*"box_g_lock"*/);
    sub_1CE6700(&StringLiteral_17556/*"box_n_lock"*/);
    sub_1CE6700(&StringLiteral_17559/*"box_s_lock"*/);
    sub_1CE6700(&StringLiteral_17555/*"box_n_base"*/);
    sub_1CE6700(&StringLiteral_17552/*"box_g_open"*/);
    sub_1CE6700(&StringLiteral_17558/*"box_s_base"*/);
    sub_1CE6700(&StringLiteral_17550/*"box_g_base"*/);
    sub_1CE6700(&StringLiteral_17557/*"box_n_open"*/);
    byte_4E016A8 = 1;
  }
  ...
  switch ( box_type )
  {
    case 2:
      ...
      if ( transform )
      {
        ...
        if ( transform )
        {
          UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17550/*"box_g_base"*/, 0);
          ...
          if ( transform )
          {
            ...
            if ( transform )
            {
              UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17551/*"box_g_lock"*/, 0);
              ...
              if ( transform )
              {
                ...
                if ( transform )
                {
                  v23 = &StringLiteral_17552/*"box_g_open"*/;
                  goto LABEL_34;
                }
              }
            }
...
LABEL_35:
    ...
    case 1:
      ...
      if ( transform )
      {
        ...
        if ( transform )
        {
          UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17558/*"box_s_base"*/, 0);
          transform = (UnityEngine_Component_o *)this->fields.mBoxLockSp;
          if ( transform )
          {
            UISprite__set_atlas((UISprite_o *)transform, this->fields.mSilverAtlas, 0);
            ...
            if ( transform )
            {
              UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17559/*"box_s_lock"*/, 0);
              transform = (UnityEngine_Component_o *)this->fields.mBoxOpenSp;
              if ( transform )
              {
                UISprite__set_atlas((UISprite_o *)transform, this->fields.mSilverAtlas, 0);
                ...
                if ( transform )
                {
                  v23 = &StringLiteral_17560/*"box_s_open"*/;
                  goto LABEL_34;
                }
              }
            }
    ...
    case 0:
      ...
      if ( transform )
      {
        ...
        if ( transform )
        {
          UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17555/*"box_n_base"*/, 0);
          transform = (UnityEngine_Component_o *)this->fields.mBoxLockSp;
          if ( transform )
          {
            UISprite__set_atlas((UISprite_o *)transform, this->fields.mNormalAtlas, 0);
            ...
            if ( transform )
            {
              UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17556/*"box_n_lock"*/, 0);
              transform = (UnityEngine_Component_o *)this->fields.mBoxOpenSp;
              if ( transform )
              {
                UISprite__set_atlas((UISprite_o *)transform, this->fields.mNormalAtlas, 0);
                ...
                if ( transform )
                {
                  v23 = &StringLiteral_17557/*"box_n_open"*/;
LABEL_34:
...
void QuestRewardBoxAction__Update(QuestRewardBoxAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E016A7 & 1) == 0 )
  {
    sub_1CE6700(&Method_CStateManager_QuestRewardBoxAction__update__);
    byte_4E016A7 = 1;
  }
  mFSM = (CStateManager_T__o *)this->fields.mFSM;
  if ( mFSM )
    CStateManager_object___update(mFSM, (const MethodInfo_3473620 *)Method_CStateManager_QuestRewardBoxAction__update__);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&UnityEngine_Object_TypeInfo);
    this = (QuestRewardBoxAction_StatePlay_o *)sub_1CE6700(&SimpleAnimation_State_TypeInfo);
    byte_4E016AC = 1;
  }
  if ( !that )
    goto LABEL_29;
  ...
  if ( ((unsigned __int8)this & 1) == 0 )
  {
    ...
    if ( v15 )
    {
      ...
      if ( this )
      {
        ...
        this = (QuestRewardBoxAction_StatePlay_o *)UnityEngine_Animation__Play_72661460(v15, name, 0);
...
LABEL_29:
  ...
  this = (QuestRewardBoxAction_StatePlay_o *)SimpleAnimation__Play_68069172(v5, v6, 0);
  ...
  {
LABEL_16:
    v13 = sub_1CBCA7C(this, SimpleAnimation_State_TypeInfo, 8);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E016AD & 1) == 0 )
  {
    ...
    sub_1CE6700(&UnityEngine_Object_TypeInfo);
    sub_1CE6700(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1CE6700(&Method_QuestRewardBoxAction_StatePlay___c__DisplayClass1_0__update_b__0__);
    sub_1CE6700(&Method_QuestRewardBoxAction_StatePlay___c__DisplayClass1_0__update_b__1__);
    sub_1CE6700(&QuestRewardBoxAction_StatePlay___c__DisplayClass1_0_TypeInfo);
    byte_4E016AD = 1;
  }
  v4 = sub_1CE694C(QuestRewardBoxAction_StatePlay___c__DisplayClass1_0_TypeInfo);
