...
void __fastcall QuestRewardBoxAction__Awake(QuestRewardBoxAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1EE87 & 1) == 0 )
  {
    sub_1C3B764(&Method_CStateManager_QuestRewardBoxAction___ctor__, method);
    sub_1C3B764(&Method_CStateManager_QuestRewardBoxAction__add__, v3);
    sub_1C3B764(&CStateManager_QuestRewardBoxAction__TypeInfo, v4);
    ...
    sub_1C3B764(&QuestRewardBoxAction_StateNone_TypeInfo, v8);
    sub_1C3B764(&QuestRewardBoxAction_StatePlay_TypeInfo, v9);
    byte_4C1EE87 = 1;
  }
  if ( !this->fields.mFSM )
  {
    v10 = (CStateManager_T__o *)sub_1C3B9B0(CStateManager_QuestRewardBoxAction__TypeInfo);
    CStateManager_object____ctor(
      v10,
      (Il2CppObject *)this,
      2,
      (const MethodInfo_3225B48 *)Method_CStateManager_QuestRewardBoxAction___ctor__);
    ...
    v18 = (Il2CppObject *)sub_1C3B9B0(QuestRewardBoxAction_StateNone_TypeInfo);
    ...
    CStateManager_object___add(
      ...
      0,
      (IState_T__o *)v18,
      (const MethodInfo_3225BF0 *)Method_CStateManager_QuestRewardBoxAction__add__);
    v21 = (CStateManager_T__o *)this->fields.mFSM;
    v22 = (Il2CppObject *)sub_1C3B9B0(QuestRewardBoxAction_StatePlay_TypeInfo);
...
LABEL_22:
        sub_1C3B9C0(ComponentInChildren_object, v20);
      }
    }
  }
}
...
int32_t __fastcall QuestRewardBoxAction__GetState(QuestRewardBoxAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1EE8B & 1) == 0 )
  {
    this = (QuestRewardBoxAction_o *)sub_1C3B764(&Method_CStateManager_QuestRewardBoxAction__getState__, method);
    byte_4C1EE8B = 1;
  }
  mFSM = v2->fields.mFSM;
  if ( !mFSM )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1EE8A & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_QuestRewardBoxAction__Play_b__19_0__, v12);
    sub_1C3B764(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v13);
    sub_1C3B764(&SimpleAnimation_State_TypeInfo, v14);
    byte_4C1EE8A = 1;
  }
  ...
  if ( ((unsigned __int8)gameObject & 1) != 0 )
  {
    ...
    {
LABEL_14:
      v24 = sub_1C8D744(gameObject, SimpleAnimation_State_TypeInfo, 8LL);
    }
...
void __fastcall QuestRewardBoxAction__SetState(QuestRewardBoxAction_o *this, int32_t state, const MethodInfo *method)
{
  ...
  if ( (byte_4C1EE8C & 1) == 0 )
  {
    sub_1C3B764(&Method_CStateManager_QuestRewardBoxAction__setState__, *(_QWORD *)&state);
    byte_4C1EE8C = 1;
  }
  mFSM = (CStateManager_T__o *)this->fields.mFSM;
  if ( !mFSM )
  ...
  CStateManager_object___setState(
    mFSM,
    state,
    (const MethodInfo_3225C7C *)Method_CStateManager_QuestRewardBoxAction__setState__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1EE89 & 1) == 0 )
  {
    sub_1C3B764(&Method_UnityEngine_Component_GetComponentInChildren_Animation___, *(_QWORD *)&box_type);
    ...
    sub_1C3B764(&StringLiteral_17740/*"com.adjust.sdk.OnSessionTrackingSucceededListener"*/, v9);
    sub_1C3B764(&StringLiteral_17731/*"com.adjust.sdk.LogLevel"*/, v10);
    sub_1C3B764(&StringLiteral_17736/*"com.adjust.sdk.OnEventTrackingFailedListener"*/, v11);
    sub_1C3B764(&StringLiteral_17739/*"com.adjust.sdk.OnSessionTrackingFailedListener"*/, v12);
    sub_1C3B764(&StringLiteral_17735/*"com.adjust.sdk.OnDeviceIdsRead"*/, v13);
    sub_1C3B764(&StringLiteral_17732/*"com.adjust.sdk.OnAttributionChangedListener"*/, v14);
    sub_1C3B764(&StringLiteral_17738/*"com.adjust.sdk.OnPurchaseVerificationFinishedListener"*/, v15);
    sub_1C3B764(&StringLiteral_17730/*"com.adjust.sdk.AdjustThirdPartySharing"*/, v16);
    sub_1C3B764(&StringLiteral_17737/*"com.adjust.sdk.OnEventTrackingSucceededListener"*/, v17);
    byte_4C1EE89 = 1;
  }
  ...
  if ( !transform )
    goto LABEL_35;
  v27 = UnityEngine_Component__GetComponentInChildren_object__50228848(
          transform,
  ...
  sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.mSimpleAnimation, (int64_t)v27, v28, v29, v30, v31, v32, v33);
  transform = (UnityEngine_Component_o *)UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0LL);
  if ( !transform )
    goto LABEL_35;
  ...
  switch ( box_type )
  {
    case 2:
      ...
      if ( transform )
      {
        ...
        if ( transform )
        {
          UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17730/*"com.adjust.sdk.AdjustThirdPartySharing"*/, 0LL);
          ...
          if ( transform )
          {
            ...
            if ( transform )
            {
              UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17731/*"com.adjust.sdk.LogLevel"*/, 0LL);
              ...
              if ( transform )
              {
                ...
                if ( transform )
                {
                  v34 = &StringLiteral_17732/*"com.adjust.sdk.OnAttributionChangedListener"*/;
                  goto LABEL_34;
                }
              }
            }
...
LABEL_35:
    ...
    case 1:
      ...
      if ( transform )
      {
        ...
        if ( transform )
        {
          UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17738/*"com.adjust.sdk.OnPurchaseVerificationFinishedListener"*/, 0LL);
          transform = (UnityEngine_Component_o *)this->fields.mBoxLockSp;
          if ( transform )
          {
            UISprite__set_atlas((UISprite_o *)transform, this->fields.mSilverAtlas, 0LL);
            ...
            if ( transform )
            {
              UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17739/*"com.adjust.sdk.OnSessionTrackingFailedListener"*/, 0LL);
              transform = (UnityEngine_Component_o *)this->fields.mBoxOpenSp;
              if ( transform )
              {
                UISprite__set_atlas((UISprite_o *)transform, this->fields.mSilverAtlas, 0LL);
                ...
                if ( transform )
                {
                  v34 = &StringLiteral_17740/*"com.adjust.sdk.OnSessionTrackingSucceededListener"*/;
                  goto LABEL_34;
                }
              }
            }
    ...
    case 0:
      ...
      if ( transform )
      {
        ...
        if ( transform )
        {
          UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17735/*"com.adjust.sdk.OnDeviceIdsRead"*/, 0LL);
          transform = (UnityEngine_Component_o *)this->fields.mBoxLockSp;
          if ( transform )
          {
            UISprite__set_atlas((UISprite_o *)transform, this->fields.mNormalAtlas, 0LL);
            ...
            if ( transform )
            {
              UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17736/*"com.adjust.sdk.OnEventTrackingFailedListener"*/, 0LL);
              transform = (UnityEngine_Component_o *)this->fields.mBoxOpenSp;
              if ( transform )
              {
                UISprite__set_atlas((UISprite_o *)transform, this->fields.mNormalAtlas, 0LL);
                ...
                if ( transform )
                {
                  v34 = &StringLiteral_17737/*"com.adjust.sdk.OnEventTrackingSucceededListener"*/;
LABEL_34:
...
void __fastcall QuestRewardBoxAction__Update(QuestRewardBoxAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1EE88 & 1) == 0 )
  {
    sub_1C3B764(&Method_CStateManager_QuestRewardBoxAction__update__, method);
    byte_4C1EE88 = 1;
  }
  mFSM = (CStateManager_T__o *)this->fields.mFSM;
  if ( mFSM )
    CStateManager_object___update(mFSM, (const MethodInfo_3225C58 *)Method_CStateManager_QuestRewardBoxAction__update__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1EE8D & 1) == 0 )
  {
    ...
    this = (QuestRewardBoxAction_StatePlay_o *)sub_1C3B764(&SimpleAnimation_State_TypeInfo, v4);
    byte_4C1EE8D = 1;
  }
  if ( !that )
    goto LABEL_29;
  ...
  if ( ((unsigned __int8)this & 1) == 0 )
  {
    ...
    if ( v16 )
    {
      ...
      if ( this )
      {
        ...
        this = (QuestRewardBoxAction_StatePlay_o *)UnityEngine_Animation__Play_70867156(v16, name, 0LL);
...
LABEL_29:
  ...
  this = (QuestRewardBoxAction_StatePlay_o *)SimpleAnimation__Play_65506988(v6, v7, 0LL);
  ...
  {
LABEL_16:
    v14 = sub_1C8D744(this, SimpleAnimation_State_TypeInfo, 8LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1EE8E & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_QuestRewardBoxAction_StatePlay___c__DisplayClass1_0__update_b__0__, v6);
    sub_1C3B764(&Method_QuestRewardBoxAction_StatePlay___c__DisplayClass1_0__update_b__1__, v7);
    sub_1C3B764(&QuestRewardBoxAction_StatePlay___c__DisplayClass1_0_TypeInfo, v8);
    byte_4C1EE8E = 1;
  }
  v9 = sub_1C3B9B0(QuestRewardBoxAction_StatePlay___c__DisplayClass1_0_TypeInfo);
