...
void __fastcall QuestRewardBoxAction__Awake(QuestRewardBoxAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B41861 & 1) == 0 )
  {
    sub_1BDB878(&Method_CStateManager_QuestRewardBoxAction___ctor__, method);
    sub_1BDB878(&Method_CStateManager_QuestRewardBoxAction__add__, v3);
    sub_1BDB878(&CStateManager_QuestRewardBoxAction__TypeInfo, v4);
    ...
    sub_1BDB878(&QuestRewardBoxAction_StateNone_TypeInfo, v8);
    sub_1BDB878(&QuestRewardBoxAction_StatePlay_TypeInfo, v9);
    byte_4B41861 = 1;
  }
  if ( !this->fields.mFSM )
  {
    v10 = (CStateManager_T__o *)sub_1BDBAC4(CStateManager_QuestRewardBoxAction__TypeInfo);
    CStateManager_object____ctor(
      v10,
      (Il2CppObject *)this,
      2,
      (const MethodInfo_3270084 *)Method_CStateManager_QuestRewardBoxAction___ctor__);
    ...
    v14 = (Il2CppObject *)sub_1BDBAC4(QuestRewardBoxAction_StateNone_TypeInfo);
    ...
    CStateManager_object___add(
      ...
      0,
      (IState_T__o *)v14,
      (const MethodInfo_327012C *)Method_CStateManager_QuestRewardBoxAction__add__);
    v17 = (CStateManager_T__o *)this->fields.mFSM;
    v18 = (Il2CppObject *)sub_1BDBAC4(QuestRewardBoxAction_StatePlay_TypeInfo);
      ...
      if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)v23, 0LL, 0LL) )
      {
        ...
        if ( v23 )
        {
          ...
          if ( ComponentInChildren_object )
          {
            ...
            sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.particleObj, (int32_t)v23, v25, v26);
            return;
          }
        }
LABEL_22:
        sub_1BDBAD4(ComponentInChildren_object, v16);
      }
    }
  }
}
...
int32_t __fastcall QuestRewardBoxAction__GetState(QuestRewardBoxAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B41865 & 1) == 0 )
  {
    this = (QuestRewardBoxAction_o *)sub_1BDB878(&Method_CStateManager_QuestRewardBoxAction__getState__, method);
    byte_4B41865 = 1;
  }
  mFSM = v2->fields.mFSM;
  if ( !mFSM )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B41864 & 1) == 0 )
  {
    ...
    sub_1BDB878(&UnityEngine_Object_TypeInfo, v7);
    sub_1BDB878(&Method_QuestRewardBoxAction__Play_b__19_0__, v8);
  ...
  if ( ((unsigned __int8)gameObject & 1) != 0 )
  {
    ...
    {
LABEL_14:
      v20 = sub_1C2C00C(gameObject, SimpleAnimation_State_TypeInfo, 8LL);
    }
...
void __fastcall QuestRewardBoxAction__SetState(QuestRewardBoxAction_o *this, int32_t state, const MethodInfo *method)
{
  ...
  if ( (byte_4B41866 & 1) == 0 )
  {
    sub_1BDB878(&Method_CStateManager_QuestRewardBoxAction__setState__, *(_QWORD *)&state);
    byte_4B41866 = 1;
  }
  mFSM = (CStateManager_T__o *)this->fields.mFSM;
  if ( !mFSM )
  ...
  CStateManager_object___setState(
    mFSM,
    state,
    (const MethodInfo_32701B8 *)Method_CStateManager_QuestRewardBoxAction__setState__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B41863 & 1) == 0 )
  {
    sub_1BDB878(&Method_UnityEngine_Component_GetComponentInChildren_Animation___, *(_QWORD *)&box_type);
    ...
    sub_1BDB878(&StringLiteral_17391/*"box_s_open"*/, v9);
    sub_1BDB878(&StringLiteral_17382/*"box_g_lock"*/, v10);
    sub_1BDB878(&StringLiteral_17387/*"box_n_lock"*/, v11);
    sub_1BDB878(&StringLiteral_17390/*"box_s_lock"*/, v12);
    sub_1BDB878(&StringLiteral_17386/*"box_n_base"*/, v13);
    sub_1BDB878(&StringLiteral_17383/*"box_g_open"*/, v14);
    sub_1BDB878(&StringLiteral_17389/*"box_s_base"*/, v15);
    sub_1BDB878(&StringLiteral_17381/*"box_g_base"*/, v16);
    sub_1BDB878(&StringLiteral_17388/*"box_n_open"*/, v17);
    byte_4B41863 = 1;
  }
  ...
  if ( !transform )
    goto LABEL_35;
  v23 = UnityEngine_Component__GetComponentInChildren_object__50504592(
          transform,
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.mSimpleAnimation, (int32_t)v23, v24, v25);
  transform = (UnityEngine_Component_o *)UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0LL);
  if ( !transform )
    goto LABEL_35;
  ...
  switch ( box_type )
  {
    case 2:
      ...
      if ( transform )
      {
        ...
        if ( transform )
        {
          UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17381/*"box_g_base"*/, 0LL);
          ...
          if ( transform )
          {
            ...
            if ( transform )
            {
              UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17382/*"box_g_lock"*/, 0LL);
              ...
              if ( transform )
              {
                ...
                if ( transform )
                {
                  v26 = &StringLiteral_17383/*"box_g_open"*/;
                  goto LABEL_34;
                }
              }
            }
...
LABEL_35:
    ...
    case 1:
      ...
      if ( transform )
      {
        ...
        if ( transform )
        {
          UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17389/*"box_s_base"*/, 0LL);
          transform = (UnityEngine_Component_o *)this->fields.mBoxLockSp;
          if ( transform )
          {
            UISprite__set_atlas((UISprite_o *)transform, this->fields.mSilverAtlas, 0LL);
            ...
            if ( transform )
            {
              UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17390/*"box_s_lock"*/, 0LL);
              transform = (UnityEngine_Component_o *)this->fields.mBoxOpenSp;
              if ( transform )
              {
                UISprite__set_atlas((UISprite_o *)transform, this->fields.mSilverAtlas, 0LL);
                ...
                if ( transform )
                {
                  v26 = &StringLiteral_17391/*"box_s_open"*/;
                  goto LABEL_34;
                }
              }
            }
    ...
    case 0:
      ...
      if ( transform )
      {
        ...
        if ( transform )
        {
          UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17386/*"box_n_base"*/, 0LL);
          transform = (UnityEngine_Component_o *)this->fields.mBoxLockSp;
          if ( transform )
          {
            UISprite__set_atlas((UISprite_o *)transform, this->fields.mNormalAtlas, 0LL);
            ...
            if ( transform )
            {
              UISprite__set_spriteName((UISprite_o *)transform, (System_String_o *)StringLiteral_17387/*"box_n_lock"*/, 0LL);
              transform = (UnityEngine_Component_o *)this->fields.mBoxOpenSp;
              if ( transform )
              {
                UISprite__set_atlas((UISprite_o *)transform, this->fields.mNormalAtlas, 0LL);
                ...
                if ( transform )
                {
                  v26 = &StringLiteral_17388/*"box_n_open"*/;
LABEL_34:
...
void __fastcall QuestRewardBoxAction__Update(QuestRewardBoxAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B41862 & 1) == 0 )
  {
    sub_1BDB878(&Method_CStateManager_QuestRewardBoxAction__update__, method);
    byte_4B41862 = 1;
  }
  mFSM = (CStateManager_T__o *)this->fields.mFSM;
  if ( mFSM )
    CStateManager_object___update(mFSM, (const MethodInfo_3270194 *)Method_CStateManager_QuestRewardBoxAction__update__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B41867 & 1) == 0 )
  {
    ...
    this = (QuestRewardBoxAction_StatePlay_o *)sub_1BDB878(&SimpleAnimation_State_TypeInfo, v4);
    byte_4B41867 = 1;
  }
  if ( !that )
    goto LABEL_29;
  ...
  if ( ((unsigned __int8)this & 1) == 0 )
  {
    ...
    if ( v16 )
    {
      ...
      if ( this )
      {
        ...
        this = (QuestRewardBoxAction_StatePlay_o *)UnityEngine_Animation__Play_70027660(v16, name, 0LL);
...
LABEL_29:
  ...
  this = (QuestRewardBoxAction_StatePlay_o *)SimpleAnimation__Play_65523240(v6, v7, 0LL);
  ...
  {
LABEL_16:
    v14 = sub_1C2C00C(this, SimpleAnimation_State_TypeInfo, 8LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B41868 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_QuestRewardBoxAction_StatePlay___c__DisplayClass1_0__update_b__0__, v6);
    sub_1BDB878(&Method_QuestRewardBoxAction_StatePlay___c__DisplayClass1_0__update_b__1__, v7);
    sub_1BDB878(&QuestRewardBoxAction_StatePlay___c__DisplayClass1_0_TypeInfo, v8);
    byte_4B41868 = 1;
  }
  v9 = sub_1BDBAC4(QuestRewardBoxAction_StatePlay___c__DisplayClass1_0_TypeInfo);
