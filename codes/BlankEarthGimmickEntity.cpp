...
bool __fastcall BlankEarthGimmickEntity__CheckGimmickCond(BlankEarthGimmickEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !Instance
    || (v5 = QuestTree__CheckMapGimmickCond(
               ...
               0LL),
        (Instance = SingletonTemplate_object___get_Instance((const MethodInfo_371299C *)Method_SingletonTemplate_QuestTree__get_Instance__)) == 0LL) )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2DC0A & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_17333/*"blankEarthOtherObject"*/, method);
    byte_4A2DC0A = 1;
  }
  return BlankEarthGimmickEntity__GetStrFromScript(this, (System_String_o *)StringLiteral_17333/*"blankEarthOtherObject"*/, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  return BlankEarthGimmickEntity__GetIntFromScript(this, (System_String_o *)StringLiteral_24340/*"useAnim"*/, v2);
}
