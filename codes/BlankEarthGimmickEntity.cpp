...
bool BlankEarthGimmickEntity__CheckGimmickCond(BlankEarthGimmickEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !Instance
    || (v5 = QuestTree__CheckMapGimmickCond(
               ...
               0),
        (Instance = SingletonTemplate_object___get_Instance((const MethodInfo_3A4F8A4 *)Method_SingletonTemplate_QuestTree__get_Instance__)) == 0) )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB5F43 & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_17322/*"blankEarthOtherObject"*/);
    byte_4CB5F43 = 1;
  }
...
int32_t BlankEarthGimmickEntity__GetUseAnimFromScript(BlankEarthGimmickEntity_o *this, const MethodInfo *method)
{
  ...
  return BlankEarthGimmickEntity__GetIntFromScript(this, (System_String_o *)StringLiteral_24579/*"useAnim"*/, v2);
}
