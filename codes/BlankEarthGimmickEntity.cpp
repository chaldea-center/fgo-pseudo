        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E77339 & 1) == 0 )
  {
    sub_1D0F0B4(&StringLiteral_17564/*"blankEarthOtherObject"*/);
    byte_4E77339 = 1;
  }
  return BlankEarthGimmickEntity__GetStrFromScript(this, (System_String_o *)StringLiteral_17564/*"blankEarthOtherObject"*/, v2);
}
...
int32_t BlankEarthGimmickEntity__GetUseAnimFromScript(BlankEarthGimmickEntity_o *this, const MethodInfo *method)
{
  ...
  return BlankEarthGimmickEntity__GetIntFromScript(this, (System_String_o *)StringLiteral_24985/*"useAnim"*/, v2);
}
