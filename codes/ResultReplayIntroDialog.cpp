...
void ResultReplayIntroDialog__Close(ResultReplayIntroDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB08E0 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_ResultReplayIntroDialog_EndClose__);
    byte_4CB08E0 = 1;
  }
...
void ResultReplayIntroDialog__EndClose(ResultReplayIntroDialog_o *this, const MethodInfo *method)
{
  ...
  {
    *p_onCloseCallback = 0;
    sub_1C6B9AC(p_onCloseCallback, 0);
...
void ResultReplayIntroDialog__OnClickClose(ResultReplayIntroDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB08DF & 1) == 0 )
  {
    sub_1C6BA08(&Method_ResultReplayIntroDialog_OnClickClose__);
    byte_4CB08DF = 1;
  }
  v3 = Method_ResultReplayIntroDialog_OnClickClose__;
  if ( (*((_BYTE *)Method_ResultReplayIntroDialog_OnClickClose__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C6BA20(Method_ResultReplayIntroDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C6BA08(&System_Action_TypeInfo);
    sub_1C6BA08(&Method_ResultReplayIntroDialog___c__Open_b__7_0__);
    sub_1C6BA08(&ResultReplayIntroDialog___c_TypeInfo);
    byte_4CB08DE = 1;
  }
  this->fields.onCloseCallback = onCloseCallback;
  sub_1C6B9AC(&this->fields.onCloseCallback, onCloseCallback);
  ...
  if ( !_9__7_0 )
  {
    ...
    _9__7_0 = (System_Action_o *)sub_1C6BC54(System_Action_TypeInfo);
    ...
    sub_1C6B9AC(&static_fields->__9__7_0, _9__7_0);
  }
...
void ResultReplayIntroDialog___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C6BC54(ResultReplayIntroDialog___c_TypeInfo);
  System_Object___ctor(v1, 0);
  ResultReplayIntroDialog___c_TypeInfo->static_fields->__9 = (struct ResultReplayIntroDialog___c_o *)v1;
  sub_1C6B9AC(ResultReplayIntroDialog___c_TypeInfo->static_fields, v1);
}
