...
void __fastcall ResultReplayIntroDialog__Close(ResultReplayIntroDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B16C60 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_ResultReplayIntroDialog_EndClose__, v3);
    byte_4B16C60 = 1;
  }
...
void __fastcall ResultReplayIntroDialog__OnClickClose(ResultReplayIntroDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B16C5F & 1) == 0 )
  {
    sub_1BCAFF8(&Method_ResultReplayIntroDialog_OnClickClose__, method);
    byte_4B16C5F = 1;
  }
  v3 = Method_ResultReplayIntroDialog_OnClickClose__;
  if ( (*((_BYTE *)Method_ResultReplayIntroDialog_OnClickClose__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1BCB010(Method_ResultReplayIntroDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B16C5E & 1) == 0 )
  {
    sub_1BCAFF8(&System_Action_TypeInfo, onCloseCallback);
    sub_1BCAFF8(&Method_ResultReplayIntroDialog___c__Open_b__7_0__, v5);
    sub_1BCAFF8(&ResultReplayIntroDialog___c_TypeInfo, v6);
    byte_4B16C5E = 1;
  }
  this->fields.onCloseCallback = onCloseCallback;
  sub_1BCAF9C(&this->fields.onCloseCallback);
  ...
  if ( !_9__7_0 )
  {
    ...
    _9__7_0 = (System_Action_o *)sub_1BCB244(System_Action_TypeInfo);
    ...
    sub_1BCAF9C(&static_fields->__9__7_0);
  }
...
void __fastcall ResultReplayIntroDialog___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B16C63 & 1) == 0 )
  {
    sub_1BCAFF8(&ResultReplayIntroDialog___c_TypeInfo, v1);
    byte_4B16C63 = 1;
  }
  v2 = (Il2CppObject *)sub_1BCB244(ResultReplayIntroDialog___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  ResultReplayIntroDialog___c_TypeInfo->static_fields->__9 = (struct ResultReplayIntroDialog___c_o *)v2;
  sub_1BCAF9C(ResultReplayIntroDialog___c_TypeInfo->static_fields);
}
