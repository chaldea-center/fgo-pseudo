...
void __fastcall ResultReplayIntroDialog__Close(ResultReplayIntroDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0CC49 & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_ResultReplayIntroDialog_EndClose__, v3);
    byte_4A0CC49 = 1;
  }
...
void __fastcall ResultReplayIntroDialog__EndClose(ResultReplayIntroDialog_o *this, const MethodInfo *method)
{
  ...
  if ( onCloseCallback )
  {
    ...
    sub_1B68678(p_onCloseCallback, 0, v5, v6);
...
void __fastcall ResultReplayIntroDialog__OnClickClose(ResultReplayIntroDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0CC48 & 1) == 0 )
  {
    sub_1B686D4(&Method_ResultReplayIntroDialog_OnClickClose__, method);
    byte_4A0CC48 = 1;
  }
  v3 = Method_ResultReplayIntroDialog_OnClickClose__;
  if ( (*((_BYTE *)Method_ResultReplayIntroDialog_OnClickClose__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B686EC(Method_ResultReplayIntroDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0CC47 & 1) == 0 )
  {
    sub_1B686D4(&System_Action_TypeInfo, onCloseCallback);
    sub_1B686D4(&Method_ResultReplayIntroDialog___c__Open_b__7_0__, v6);
    sub_1B686D4(&ResultReplayIntroDialog___c_TypeInfo, v7);
    byte_4A0CC47 = 1;
  }
  ...
  if ( !_9__7_0 )
  {
    ...
    _9__7_0 = (System_Action_o *)sub_1B68920(System_Action_TypeInfo);
    ...
    sub_1B68678((ServantStatusBattleListViewItem_o *)&static_fields->__9__7_0, (int32_t)_9__7_0, v12, v13);
  }
...
void __fastcall ResultReplayIntroDialog___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A0CC4C & 1) == 0 )
  {
    sub_1B686D4(&ResultReplayIntroDialog___c_TypeInfo, v1);
    byte_4A0CC4C = 1;
  }
  v2 = (Il2CppObject *)sub_1B68920(ResultReplayIntroDialog___c_TypeInfo);
