...
void __fastcall ResultReplayIntroDialog__Close(ResultReplayIntroDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFC7A3 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_ResultReplayIntroDialog_EndClose__, v3);
    byte_4AFC7A3 = 1;
  }
...
void __fastcall ResultReplayIntroDialog__OnClickClose(ResultReplayIntroDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFC7A2 & 1) == 0 )
  {
    sub_1BC3008(&Method_ResultReplayIntroDialog_OnClickClose__, method);
    byte_4AFC7A2 = 1;
  }
  v3 = Method_ResultReplayIntroDialog_OnClickClose__;
  if ( (*((_BYTE *)Method_ResultReplayIntroDialog_OnClickClose__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1BC3020(Method_ResultReplayIntroDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFC7A1 & 1) == 0 )
  {
    sub_1BC3008(&System_Action_TypeInfo, onCloseCallback);
    sub_1BC3008(&Method_ResultReplayIntroDialog___c__Open_b__7_0__, v5);
    sub_1BC3008(&ResultReplayIntroDialog___c_TypeInfo, v6);
    byte_4AFC7A1 = 1;
  }
  this->fields.onCloseCallback = onCloseCallback;
  sub_1BC2FAC(&this->fields.onCloseCallback);
  ...
  if ( !_9__7_0 )
  {
    ...
    _9__7_0 = (System_Action_o *)sub_1BC3254(System_Action_TypeInfo);
    ...
    sub_1BC2FAC(&static_fields->__9__7_0);
  }
...
void __fastcall ResultReplayIntroDialog___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AFC7A6 & 1) == 0 )
  {
    sub_1BC3008(&ResultReplayIntroDialog___c_TypeInfo, v1);
    byte_4AFC7A6 = 1;
  }
  v2 = (Il2CppObject *)sub_1BC3254(ResultReplayIntroDialog___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  ResultReplayIntroDialog___c_TypeInfo->static_fields->__9 = (struct ResultReplayIntroDialog___c_o *)v2;
  sub_1BC2FAC(ResultReplayIntroDialog___c_TypeInfo->static_fields);
}
