...
void __fastcall ResultReplayIntroDialog__Close(ResultReplayIntroDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A48F06 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_ResultReplayIntroDialog_EndClose__, v3);
    byte_4A48F06 = 1;
  }
...
void __fastcall ResultReplayIntroDialog__OnClickClose(ResultReplayIntroDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A48F05 & 1) == 0 )
  {
    sub_1B863B8(&Method_ResultReplayIntroDialog_OnClickClose__, method);
    byte_4A48F05 = 1;
  }
  v3 = Method_ResultReplayIntroDialog_OnClickClose__;
  if ( (*((_BYTE *)Method_ResultReplayIntroDialog_OnClickClose__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B863D0(Method_ResultReplayIntroDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A48F04 & 1) == 0 )
  {
    sub_1B863B8(&System_Action_TypeInfo, onCloseCallback);
    sub_1B863B8(&Method_ResultReplayIntroDialog___c__Open_b__7_0__, v5);
    sub_1B863B8(&ResultReplayIntroDialog___c_TypeInfo, v6);
    byte_4A48F04 = 1;
  }
  this->fields.onCloseCallback = onCloseCallback;
  sub_1B8635C(&this->fields.onCloseCallback);
  ...
  if ( !_9__7_0 )
  {
    ...
    _9__7_0 = (System_Action_o *)sub_1B86604(System_Action_TypeInfo);
    ...
    sub_1B8635C(&static_fields->__9__7_0);
  }
...
void __fastcall ResultReplayIntroDialog___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A48F09 & 1) == 0 )
  {
    sub_1B863B8(&ResultReplayIntroDialog___c_TypeInfo, v1);
    byte_4A48F09 = 1;
  }
  v2 = (Il2CppObject *)sub_1B86604(ResultReplayIntroDialog___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  ResultReplayIntroDialog___c_TypeInfo->static_fields->__9 = (struct ResultReplayIntroDialog___c_o *)v2;
  sub_1B8635C(ResultReplayIntroDialog___c_TypeInfo->static_fields);
}
