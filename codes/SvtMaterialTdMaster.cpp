void __fastcall SvtMaterialTdMaster___ctor(SvtMaterialTdMaster_o *this, const MethodInfo *method)
{
  if ( (byte_48E31B5 & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataMasterBase_SvtMaterialTdMaster__SvtMaterialTdEntity__string___ctor__, method);
    byte_48E31B5 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    389,
    (const MethodInfo_2FE6D64 *)Method_DataMasterBase_SvtMaterialTdMaster__SvtMaterialTdEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E31B6 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_System_Collections_Generic_List_SvtMaterialTdEntity__Add__, v8);
    sub_1B00CCC(&Method_System_Collections_Generic_List_SvtMaterialTdEntity__ToArray__, v9);
    sub_1B00CCC(&Method_System_Collections_Generic_List_SvtMaterialTdEntity___ctor__, v10);
    sub_1B00CCC(&System_Collections_Generic_List_SvtMaterialTdEntity__TypeInfo, v11);
    sub_1B00CCC(&SvtMaterialTdEntity_TypeInfo, v12);
    byte_48E31B6 = 1;
  }
  v13 = (System_Collections_Generic_List_object__o *)sub_1B00F18(System_Collections_Generic_List_SvtMaterialTdEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v13,
    (const MethodInfo_33C119C *)Method_System_Collections_Generic_List_SvtMaterialTdEntity___ctor__);
...
LABEL_38:
  ...
  return (SvtMaterialTdEntity_array *)System_Collections_Generic_List_object___ToArray(
                                        v13,
                                        (const MethodInfo_33C3528 *)Method_System_Collections_Generic_List_SvtMaterialTdEntity__ToArray__);
}