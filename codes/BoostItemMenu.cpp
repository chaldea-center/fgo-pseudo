...
void __fastcall BoostItemMenu__Callback(BoostItemMenu_o *this, int32_t result, int32_t index, const MethodInfo *method)
{
  ...
  if ( (byte_49FA90B & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_BoostItemMenu___c__DisplayClass25_0__Callback_b__0__, v8);
    sub_1B64A00(&BoostItemMenu___c__DisplayClass25_0_TypeInfo, v9);
    byte_49FA90B = 1;
  }
  v10 = sub_1B64C4C(BoostItemMenu___c__DisplayClass25_0_TypeInfo);
...
void __fastcall BoostItemMenu__Close(BoostItemMenu_o *this, const MethodInfo *method)
{
  ...
  BoostItemMenu__Close_31590036(this, 0LL, v2);
}


void __fastcall BoostItemMenu__Close_31590036(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA90A & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_BoostItemMenu_EndClose__, v5);
    byte_49FA90A = 1;
  }
  itemListViewManager = this->fields.itemListViewManager;
  if ( !itemListViewManager )
    sub_1B64C5C(0LL, callback);
  BoostItemListViewManager__SetMode_31584264(itemListViewManager, 1, method);
...
void __fastcall BoostItemMenu__EndOpen(BoostItemMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA909 & 1) == 0 )
  {
    sub_1B64A00(&Method_BoostItemMenu_OnSelectItem__, method);
    sub_1B64A00(&BoostItemListViewManager_CallbackFunc_TypeInfo, v3);
    byte_49FA909 = 1;
  }
  this->fields.state = 2;
  itemListViewManager = this->fields.itemListViewManager;
  v5 = (BoostItemListViewManager_CallbackFunc_o *)sub_1B64C4C(BoostItemListViewManager_CallbackFunc_TypeInfo);
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&itemListViewManager->fields.callbackFunc, (int32_t)v5, v9, v10);
  BoostItemListViewManager__SetMode_31584264(itemListViewManager, 2, v11);
  ...
  if ( openCallbackFunc )
  {
    ...
    sub_1B649A4(p_openCallbackFunc, 0, v12, v13);
...
void __fastcall BoostItemMenu__OnClickSetupConfirm(BoostItemMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA90D & 1) == 0 )
  {
    sub_1B64A00(&Method_BoostItemMenu_OnClickSetupConfirm__, method);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_BoostItemMenu_OnClickSetupConfirm__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B64A18(Method_BoostItemMenu_OnClickSetupConfirm__);
...
void __fastcall BoostItemMenu__OnSelectItem(BoostItemMenu_o *this, int32_t kind, int32_t n, const MethodInfo *method)
{
  ...
  if ( (byte_49FA90C & 1) == 0 )
  {
    sub_1B64A00(&Method_BoostItemMenu_OnSelectItem__, *(_QWORD *)&kind);
    this = (BoostItemMenu_o *)sub_1B64A00(&BoostItemListViewManager_CallbackFunc_TypeInfo, v7);
    byte_49FA90C = 1;
  }
      ...
      if ( kind == 1 )
      {
        ...
        if ( LOBYTE(this->fields.itemListViewManager) )
        {
          ...
          if ( (*((_BYTE *)Method_BoostItemMenu_OnSelectItem__ + 83) & 2) != 0 )
            v8 = (_QWORD *)sub_1B64A18(Method_BoostItemMenu_OnSelectItem__);
          ...
          v11 = (BoostItemListViewManager_CallbackFunc_o *)sub_1B64C4C(BoostItemListViewManager_CallbackFunc_TypeInfo);
          BoostItemListViewManager_CallbackFunc___ctor(
            v11,
            (Il2CppObject *)v6,
            (intptr_t)Method_BoostItemMenu_OnSelectItem__,
          ...
          if ( itemListViewManager )
          {
            ...
            sub_1B649A4(
              ...
              v13,
              v14);
            BoostItemListViewManager__SetMode_31584264(itemListViewManager, 2, v15);
            return;
          }
LABEL_18:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA908 & 1) == 0 )
  {
    sub_1B64A00(&System_Action_TypeInfo, setupInfo);
    sub_1B64A00(&Method_BoostItemMenu_EndOpen__, v13);
    sub_1B64A00(&Method_BoostItemMenu_Open__, v14);
    sub_1B64A00(&Method_DataManager_GetMasterData_ItemMaster___, v15);
    ...
    sub_1B64A00(&StringLiteral_3052/*"BOOST_ITEM_USE_OPTION_FRIEND_CHOCOLATE"*/, v19);
    sub_1B64A00(&StringLiteral_17459/*"btn_on"*/, v20);
    sub_1B64A00(&StringLiteral_3054/*"BOOST_ITEM_USE_TITLE_FRIEND_CHOCOLATE"*/, v21);
    sub_1B64A00(&StringLiteral_3049/*"BOOST_ITEM_USE_DETAIL"*/, v22);
    sub_1B64A00(&StringLiteral_3042/*"BOOST_ITEM_USE_CANCEL"*/, v23);
    sub_1B64A00(&StringLiteral_3048/*"BOOST_ITEM_USE_DECIDE"*/, v24);
    sub_1B64A00(&StringLiteral_3051/*"BOOST_ITEM_USE_OPTION"*/, v25);
    sub_1B64A00(&StringLiteral_3053/*"BOOST_ITEM_USE_TITILE"*/, v26);
    sub_1B64A00(&StringLiteral_17458/*"btn_off"*/, v27);
    sub_1B64A00(&StringLiteral_3050/*"BOOST_ITEM_USE_DETAIL_FRIEND_CHOCOLATE"*/, v28);
    byte_49FA908 = 1;
  }
  ...
  if ( (unsigned int)(state - 2) < 2 )
  {
    ...
    sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.openCallbackFunc, (int32_t)openCallback, v43, v44);
  ...
  if ( state == 4 || !state )
  {
    ...
    sub_1B649A4(
      ...
      (int32_t)openCallback);
    this->fields.openCallbackFunc = openCallback;
    sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.openCallbackFunc, (int32_t)openCallback, v30, v31);
    if ( !OptionManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(OptionManager_TypeInfo);
      ...
      || (v36 = (System_Int32_array *)Instance, !Instance->fields.m_CancellationTokenSource) )
    {
      ...
      if ( openCallbackFunc )
      {
        ...
        sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.openCallbackFunc, 0, v34, (int32_t)v35);
        if ( !openCallback )
          goto LABEL_49;
    ...
    if ( (*((_BYTE *)Method_BoostItemMenu_Open__ + 83) & 2) != 0 )
      v37 = (_QWORD *)sub_1B64A18(Method_BoostItemMenu_Open__);
          ...
          if ( cancelLabel )
          {
            ...
            if ( setupInfo )
            {
              ...
              if ( Instance )
              {
                ...
                if ( Instance )
                {
                  BoostItemListViewManager__SetMode_31584264((BoostItemListViewManager_o *)Instance, 1, v52);
                  Instance = (DataManager_o *)this->fields.setupConfirmSprite;
                  if ( Instance )
                  {
                    if ( this->fields.isBoostItemUseConfirm )
                      v53 = &StringLiteral_17459/*"btn_on"*/;
                    else
                      v53 = &StringLiteral_17458/*"btn_off"*/;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA906 & 1) == 0 )
  {
    sub_1B64A00(&BoostItemMenu_CallbackFunc_TypeInfo, value);
    byte_49FA906 = 1;
  }
  ...
  v11 = (BoostItemMenu_o *)sub_1B64F1C(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19A6A68;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19A6A10;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA90F & 1) == 0 )
  {
    ...
    sub_1B64A00(&BoostItemMenu_ResultKind_TypeInfo, v9);
    byte_49FA90F = 1;
  }
  v14[2] = 0LL;
