...
void BoostItemMenu__Callback(BoostItemMenu_o *this, int32_t result, int32_t index, const MethodInfo *method)
{
  ...
  if ( (byte_4E72CEE & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_BoostItemMenu___c__DisplayClass25_0__Callback_b__0__);
    sub_1D0F0B4(&BoostItemMenu___c__DisplayClass25_0_TypeInfo);
    byte_4E72CEE = 1;
  }
  v7 = sub_1D0F300(BoostItemMenu___c__DisplayClass25_0_TypeInfo);
...
void BoostItemMenu__Close(BoostItemMenu_o *this, const MethodInfo *method)
{
  ...
  BoostItemMenu__Close_35137236(this, 0, v2);
}


void BoostItemMenu__Close_35137236(BoostItemMenu_o *this, System_Action_o *callback, const MethodInfo *method)
{
  ...
  {
    sub_1D0F0B4(&System_Action_TypeInfo);
    sub_1D0F0B4(&Method_BoostItemMenu_EndClose__);
    byte_4E72CED = 1;
  }
  itemListViewManager = this->fields.itemListViewManager;
  if ( !itemListViewManager )
    sub_1D0F30C(0, callback);
  BoostItemListViewManager__SetMode_35131456(itemListViewManager, 1, method);
...
void BoostItemMenu__EndOpen(BoostItemMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E72CEC & 1) == 0 )
  {
    sub_1D0F0B4(&Method_BoostItemMenu_OnSelectItem__);
    sub_1D0F0B4(&BoostItemListViewManager_CallbackFunc_TypeInfo);
    byte_4E72CEC = 1;
  }
  this->fields.state = 2;
  itemListViewManager = this->fields.itemListViewManager;
  v4 = (BoostItemListViewManager_CallbackFunc_o *)sub_1D0F300(BoostItemListViewManager_CallbackFunc_TypeInfo);
  ...
  sub_1D0F058(
    ...
    v12,
    v13);
  BoostItemListViewManager__SetMode_35131456(itemListViewManager, 2, v14);
  ...
  if ( openCallbackFunc )
  {
    ...
    sub_1D0F058(p_openCallbackFunc, 0, v15, v16, v17, v18, v19, v20);
...
void BoostItemMenu__OnClickSetupConfirm(BoostItemMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E72CF0 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_BoostItemMenu_OnClickSetupConfirm__);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_BoostItemMenu_OnClickSetupConfirm__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1D0F0CC(Method_BoostItemMenu_OnClickSetupConfirm__);
...
void BoostItemMenu__OnSelectItem(BoostItemMenu_o *this, int32_t kind, int32_t n, const MethodInfo *method)
{
  ...
  {
    sub_1D0F0B4(&Method_BoostItemMenu_OnSelectItem__);
    this = (BoostItemMenu_o *)sub_1D0F0B4(&BoostItemListViewManager_CallbackFunc_TypeInfo);
    byte_4E72CEF = 1;
  }
      ...
      if ( kind == 1 )
      {
        ...
        if ( LOBYTE(this->fields.itemListViewManager) )
        {
          ...
          if ( (*((_BYTE *)Method_BoostItemMenu_OnSelectItem__ + 83) & 2) != 0 )
            v7 = (_QWORD *)sub_1D0F0CC(Method_BoostItemMenu_OnSelectItem__);
          ...
          v10 = (BoostItemListViewManager_CallbackFunc_o *)sub_1D0F300(BoostItemListViewManager_CallbackFunc_TypeInfo);
          BoostItemListViewManager_CallbackFunc___ctor(
            v10,
            (Il2CppObject *)v6,
            (intptr_t)Method_BoostItemMenu_OnSelectItem__,
          ...
          if ( itemListViewManager )
          {
            ...
            sub_1D0F058(
              ...
              v16,
              v17);
            BoostItemListViewManager__SetMode_35131456(itemListViewManager, 2, v18);
            return;
          }
LABEL_18:
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1D0F0B4(&System_Action_TypeInfo);
    sub_1D0F0B4(&Method_BoostItemMenu_EndOpen__);
    sub_1D0F0B4(&Method_BoostItemMenu_Open__);
    sub_1D0F0B4(&Method_DataManager_GetMasterData_ItemMaster___);
    sub_1D0F0B4(&LocalizationManager_TypeInfo);
    sub_1D0F0B4(&OptionManager_TypeInfo);
    sub_1D0F0B4(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    sub_1D0F0B4(&StringLiteral_2994/*"BOOST_ITEM_USE_OPTION_FRIEND_CHOCOLATE"*/);
    sub_1D0F0B4(&StringLiteral_17768/*"btn_on"*/);
    sub_1D0F0B4(&StringLiteral_2996/*"BOOST_ITEM_USE_TITLE_FRIEND_CHOCOLATE"*/);
    sub_1D0F0B4(&StringLiteral_2991/*"BOOST_ITEM_USE_DETAIL"*/);
    sub_1D0F0B4(&StringLiteral_2984/*"BOOST_ITEM_USE_CANCEL"*/);
    sub_1D0F0B4(&StringLiteral_2990/*"BOOST_ITEM_USE_DECIDE"*/);
    sub_1D0F0B4(&StringLiteral_2993/*"BOOST_ITEM_USE_OPTION"*/);
    sub_1D0F0B4(&StringLiteral_2995/*"BOOST_ITEM_USE_TITILE"*/);
    sub_1D0F0B4(&StringLiteral_17767/*"btn_off"*/);
    sub_1D0F0B4(&StringLiteral_2992/*"BOOST_ITEM_USE_DETAIL_FRIEND_CHOCOLATE"*/);
    byte_4E72CEB = 1;
  }
  ...
  if ( state == 4 || !state )
  {
    ...
    if ( (*((_BYTE *)Method_BoostItemMenu_Open__ + 83) & 2) != 0 )
      v30 = (_QWORD *)sub_1D0F0CC(Method_BoostItemMenu_Open__);
...
LABEL_49:
    ...
    else
    {
      ...
      {
LABEL_18:
        Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2996/*"BOOST_ITEM_USE_TITLE_FRIEND_CHOCOLATE"*/, 0);
        if ( !titleLabel )
          goto LABEL_49;
        UILabel__set_text(titleLabel, (System_String_o *)Instance, 0);
        titleDetailLabel = this->fields.titleDetailLabel;
        Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2992/*"BOOST_ITEM_USE_DETAIL_FRIEND_CHOCOLATE"*/, 0);
        if ( !titleDetailLabel )
          goto LABEL_49;
        UILabel__set_text(titleDetailLabel, (System_String_o *)Instance, 0);
        useConfirmOptionLabel = this->fields.useConfirmOptionLabel;
        Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2994/*"BOOST_ITEM_USE_OPTION_FRIEND_CHOCOLATE"*/, 0);
...
LABEL_37:
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2990/*"BOOST_ITEM_USE_DECIDE"*/, 0);
        if ( decideLabel )
        {
          UILabel__set_text(decideLabel, (System_String_o *)Instance, 0);
          cancelLabel = this->fields.cancelLabel;
          Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2984/*"BOOST_ITEM_USE_CANCEL"*/, 0);
          if ( cancelLabel )
          {
            ...
            if ( setupInfo )
            {
              ...
              if ( Instance )
              {
                ...
                if ( Instance )
                {
                  BoostItemListViewManager__SetMode_35131456((BoostItemListViewManager_o *)Instance, 1, v49);
                  Instance = (DataManager_o *)this->fields.setupConfirmSprite;
                  if ( Instance )
                  {
                    if ( this->fields.isBoostItemUseConfirm )
                      v50 = &StringLiteral_17768/*"btn_on"*/;
                    else
                      v50 = &StringLiteral_17767/*"btn_off"*/;
    ...
    Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2995/*"BOOST_ITEM_USE_TITILE"*/, 0);
    if ( !titleLabel )
      goto LABEL_49;
    UILabel__set_text(titleLabel, (System_String_o *)Instance, 0);
    v44 = this->fields.titleDetailLabel;
    Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2991/*"BOOST_ITEM_USE_DETAIL"*/, 0);
    if ( !v44 )
      goto LABEL_49;
    UILabel__set_text(v44, (System_String_o *)Instance, 0);
    v45 = this->fields.useConfirmOptionLabel;
    Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2993/*"BOOST_ITEM_USE_OPTION"*/, 0);
    if ( !v45 )
      goto LABEL_49;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E72CE9 & 1) == 0 )
  {
    sub_1D0F0B4(&BoostItemMenu_CallbackFunc_TypeInfo);
    byte_4E72CE9 = 1;
  }
  ...
  v11 = (BoostItemMenu_o *)sub_1D0F6A8(v8);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1B36AFC;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1B36AA4;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E72CF2 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&BoostItemMenu_ResultKind_TypeInfo);
    byte_4E72CF2 = 1;
  }
  v10[2] = 0;
