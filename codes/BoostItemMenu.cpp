...
void __fastcall BoostItemMenu__Callback(BoostItemMenu_o *this, int32_t result, int32_t index, const MethodInfo *method)
{
  ...
  if ( (byte_4AFD910 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_BoostItemMenu___c__DisplayClass25_0__Callback_b__0__, v8);
    sub_1BC3008(&BoostItemMenu___c__DisplayClass25_0_TypeInfo, v9);
    byte_4AFD910 = 1;
  }
  v10 = sub_1BC3254(BoostItemMenu___c__DisplayClass25_0_TypeInfo);
...
void __fastcall BoostItemMenu__Close(BoostItemMenu_o *this, const MethodInfo *method)
{
  ...
  BoostItemMenu__Close_33118664(this, 0LL, v2);
}


void __fastcall BoostItemMenu__Close_33118664(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFD90F & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_BoostItemMenu_EndClose__, v5);
    byte_4AFD90F = 1;
  }
  itemListViewManager = this->fields.itemListViewManager;
  if ( !itemListViewManager )
    sub_1BC3264(0LL, callback);
  BoostItemListViewManager__SetMode_33112888(itemListViewManager, 1, method);
...
void __fastcall BoostItemMenu__EndOpen(BoostItemMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFD90E & 1) == 0 )
  {
    sub_1BC3008(&Method_BoostItemMenu_OnSelectItem__, method);
    sub_1BC3008(&BoostItemListViewManager_CallbackFunc_TypeInfo, v3);
    byte_4AFD90E = 1;
  }
  this->fields.state = 2;
  itemListViewManager = this->fields.itemListViewManager;
  v5 = (BoostItemListViewManager_CallbackFunc_o *)sub_1BC3254(BoostItemListViewManager_CallbackFunc_TypeInfo);
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&itemListViewManager->fields.callbackFunc, (int32_t)v5, v9, v10);
  BoostItemListViewManager__SetMode_33112888(itemListViewManager, 2, v11);
...
void __fastcall BoostItemMenu__OnClickSetupConfirm(BoostItemMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFD912 & 1) == 0 )
  {
    sub_1BC3008(&Method_BoostItemMenu_OnClickSetupConfirm__, method);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_BoostItemMenu_OnClickSetupConfirm__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1BC3020(Method_BoostItemMenu_OnClickSetupConfirm__);
...
void __fastcall BoostItemMenu__OnSelectItem(BoostItemMenu_o *this, int32_t kind, int32_t n, const MethodInfo *method)
{
  ...
  if ( (byte_4AFD911 & 1) == 0 )
  {
    sub_1BC3008(&Method_BoostItemMenu_OnSelectItem__, *(_QWORD *)&kind);
    this = (BoostItemMenu_o *)sub_1BC3008(&BoostItemListViewManager_CallbackFunc_TypeInfo, v7);
    byte_4AFD911 = 1;
  }
      ...
      if ( kind == 1 )
      {
        ...
        if ( LOBYTE(this->fields.useConfirmOptionLabel) )
        {
          ...
          if ( (*((_BYTE *)Method_BoostItemMenu_OnSelectItem__ + 83) & 2) != 0 )
            v8 = (_QWORD *)sub_1BC3020(Method_BoostItemMenu_OnSelectItem__);
          ...
          v11 = (BoostItemListViewManager_CallbackFunc_o *)sub_1BC3254(BoostItemListViewManager_CallbackFunc_TypeInfo);
          BoostItemListViewManager_CallbackFunc___ctor(
            v11,
            (Il2CppObject *)v6,
            (intptr_t)Method_BoostItemMenu_OnSelectItem__,
          ...
          if ( itemListViewManager )
          {
            ...
            sub_1BC2FAC((CGThumbnailListItem_o *)&itemListViewManager->fields.callbackFunc, (int32_t)v11, v13, v14);
            BoostItemListViewManager__SetMode_33112888(itemListViewManager, 2, v15);
            return;
          }
LABEL_18:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFD90D & 1) == 0 )
  {
    sub_1BC3008(&System_Action_TypeInfo, setupInfo);
    sub_1BC3008(&Method_BoostItemMenu_EndOpen__, v13);
    sub_1BC3008(&Method_BoostItemMenu_Open__, v14);
    sub_1BC3008(&Method_DataManager_GetMasterData_ItemMaster___, v15);
    ...
    sub_1BC3008(&StringLiteral_2948/*"BOOST_ITEM_USE_OPTION_FRIEND_CHOCOLATE"*/, v19);
    sub_1BC3008(&StringLiteral_17352/*"btn_on"*/, v20);
    sub_1BC3008(&StringLiteral_2950/*"BOOST_ITEM_USE_TITLE_FRIEND_CHOCOLATE"*/, v21);
    sub_1BC3008(&StringLiteral_2945/*"BOOST_ITEM_USE_DETAIL"*/, v22);
    sub_1BC3008(&StringLiteral_2938/*"BOOST_ITEM_USE_CANCEL"*/, v23);
    sub_1BC3008(&StringLiteral_2944/*"BOOST_ITEM_USE_DECIDE"*/, v24);
    sub_1BC3008(&StringLiteral_2947/*"BOOST_ITEM_USE_OPTION"*/, v25);
    sub_1BC3008(&StringLiteral_2949/*"BOOST_ITEM_USE_TITILE"*/, v26);
    sub_1BC3008(&StringLiteral_17351/*"btn_off"*/, v27);
    sub_1BC3008(&StringLiteral_2946/*"BOOST_ITEM_USE_DETAIL_FRIEND_CHOCOLATE"*/, v28);
    byte_4AFD90D = 1;
  }
  ...
  if ( state == 4 || !state )
  {
    ...
    sub_1BC2FAC(
      ...
      (const MethodInfo *)openCallback);
    this->fields.openCallbackFunc = openCallback;
    sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.openCallbackFunc, (int32_t)openCallback, v30, v31);
    if ( !OptionManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(OptionManager_TypeInfo);
      ...
      || (v36 = (System_Int32_array *)Instance, !Instance->fields.m_CancellationTokenSource) )
    {
      ...
      if ( openCallbackFunc )
      {
        ...
        sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.openCallbackFunc, 0, v34, v35);
        if ( !openCallback )
          goto LABEL_49;
    ...
    if ( (*((_BYTE *)Method_BoostItemMenu_Open__ + 83) & 2) != 0 )
      v37 = (_QWORD *)sub_1BC3020(Method_BoostItemMenu_Open__);
...
LABEL_49:
    ...
    else
    {
      ...
      {
LABEL_18:
        Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2950/*"BOOST_ITEM_USE_TITLE_FRIEND_CHOCOLATE"*/, 0LL);
        if ( !titleLabel )
          goto LABEL_49;
        UILabel__set_text(titleLabel, (System_String_o *)Instance, 0LL);
        titleDetailLabel = this->fields.titleDetailLabel;
        Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2946/*"BOOST_ITEM_USE_DETAIL_FRIEND_CHOCOLATE"*/, 0LL);
        if ( !titleDetailLabel )
          goto LABEL_49;
        UILabel__set_text(titleDetailLabel, (System_String_o *)Instance, 0LL);
        useConfirmOptionLabel = this->fields.useConfirmOptionLabel;
        Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2948/*"BOOST_ITEM_USE_OPTION_FRIEND_CHOCOLATE"*/, 0LL);
...
LABEL_37:
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2944/*"BOOST_ITEM_USE_DECIDE"*/, 0LL);
        if ( decideLabel )
        {
          UILabel__set_text(decideLabel, (System_String_o *)Instance, 0LL);
          cancelLabel = this->fields.cancelLabel;
          Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2938/*"BOOST_ITEM_USE_CANCEL"*/, 0LL);
          if ( cancelLabel )
          {
            ...
            if ( setupInfo )
            {
              ...
              if ( Instance )
              {
                ...
                if ( Instance )
                {
                  BoostItemListViewManager__SetMode_33112888((BoostItemListViewManager_o *)Instance, 1, v52);
                  Instance = (DataManager_o *)this->fields.setupConfirmSprite;
                  if ( Instance )
                  {
                    if ( this->fields.isBoostItemUseConfirm )
                      v53 = &StringLiteral_17352/*"btn_on"*/;
                    else
                      v53 = &StringLiteral_17351/*"btn_off"*/;
    ...
    Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2949/*"BOOST_ITEM_USE_TITILE"*/, 0LL);
    if ( !titleLabel )
      goto LABEL_49;
    UILabel__set_text(titleLabel, (System_String_o *)Instance, 0LL);
    v47 = this->fields.titleDetailLabel;
    Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2945/*"BOOST_ITEM_USE_DETAIL"*/, 0LL);
    if ( !v47 )
      goto LABEL_49;
    UILabel__set_text(v47, (System_String_o *)Instance, 0LL);
    v48 = this->fields.useConfirmOptionLabel;
    Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2947/*"BOOST_ITEM_USE_OPTION"*/, 0LL);
    if ( !v48 )
      goto LABEL_49;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFD90B & 1) == 0 )
  {
    sub_1BC3008(&BoostItemMenu_CallbackFunc_TypeInfo, value);
    byte_4AFD90B = 1;
  }
  ...
  v11 = (BoostItemMenu_o *)sub_1BC3524(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A073F4;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A0739C;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFD914 & 1) == 0 )
  {
    ...
    sub_1BC3008(&BoostItemMenu_ResultKind_TypeInfo, v9);
    byte_4AFD914 = 1;
  }
  v14[2] = 0LL;
