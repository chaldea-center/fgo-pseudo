...
void BoostItemMenu__Callback(BoostItemMenu_o *this, int32_t result, int32_t index, const MethodInfo *method)
{
  ...
  if ( (byte_596BDFF & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_BoostItemMenu___c__DisplayClass25_0__Callback_b__0__);
    sub_2213A60(&BoostItemMenu___c__DisplayClass25_0_TypeInfo);
    byte_596BDFF = 1;
  }
  v7 = sub_2213CCC(BoostItemMenu___c__DisplayClass25_0_TypeInfo);
...
void BoostItemMenu__Close(BoostItemMenu_o *this, const MethodInfo *method)
{
  ...
  BoostItemMenu__Close_40734944(this, 0, v2);
}


void BoostItemMenu__Close_40734944(BoostItemMenu_o *this, System_Action_o *callback, const MethodInfo *method)
{
  ...
  {
    sub_2213A60(&System_Action_TypeInfo);
    sub_2213A60(&Method_BoostItemMenu_EndClose__);
    byte_596BDFE = 1;
  }
  itemListViewManager = this->fields.itemListViewManager;
  if ( !itemListViewManager )
    sub_2213CDC(0, callback);
  BoostItemListViewManager__SetMode_40729212(itemListViewManager, 1, method);
...
void BoostItemMenu__EndOpen(BoostItemMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596BDFD & 1) == 0 )
  {
    sub_2213A60(&Method_BoostItemMenu_OnSelectItem__);
  ...
  itemListViewManager = this->fields.itemListViewManager;
  this->fields.state = 2;
  v5 = (BoostItemListViewManager_CallbackFunc_o *)sub_2213CCC(v3);
  ...
  sub_2213A04(
    ...
    v13,
    v14);
  BoostItemListViewManager__SetMode_40729212(itemListViewManager, 2, v15);
...
void BoostItemMenu__OnClickSetupConfirm(BoostItemMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596BE01 & 1) == 0 )
  {
    sub_2213A60(&Method_BoostItemMenu_OnClickSetupConfirm__);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_BoostItemMenu_OnClickSetupConfirm__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_2213A78(Method_BoostItemMenu_OnClickSetupConfirm__);
...
void BoostItemMenu__OnSelectItem(BoostItemMenu_o *this, int32_t kind, int32_t n, const MethodInfo *method)
{
  ...
  {
    sub_2213A60(&Method_BoostItemMenu_OnSelectItem__);
    this = (BoostItemMenu_o *)sub_2213A60(&BoostItemListViewManager_CallbackFunc_TypeInfo);
    byte_596BE00 = 1;
  }
      ...
      if ( kind == 1 )
      {
        ...
        if ( LOBYTE(this->fields.itemListViewManager) )
        {
          ...
          if ( (*((_BYTE *)Method_BoostItemMenu_OnSelectItem__ + 83) & 2) != 0 )
            v7 = (_QWORD *)sub_2213A78(Method_BoostItemMenu_OnSelectItem__);
          ...
          v10 = (BoostItemListViewManager_CallbackFunc_o *)sub_2213CCC(BoostItemListViewManager_CallbackFunc_TypeInfo);
          BoostItemListViewManager_CallbackFunc___ctor(
            v10,
            (Il2CppObject *)v6,
            (intptr_t)Method_BoostItemMenu_OnSelectItem__,
          ...
          if ( itemListViewManager )
          {
            ...
            sub_2213A04(
              ...
              v16,
              v17);
            BoostItemListViewManager__SetMode_40729212(itemListViewManager, 2, v18);
            return;
          }
LABEL_18:
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_2213A60(&System_Action_TypeInfo);
    sub_2213A60(&Method_BoostItemMenu_EndOpen__);
    sub_2213A60(&Method_BoostItemMenu_Open__);
    sub_2213A60(&Method_DataManager_GetMasterData_ItemMaster___);
    sub_2213A60(&LocalizationManager_TypeInfo);
    sub_2213A60(&OptionManager_TypeInfo);
    sub_2213A60(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    sub_2213A60(&StringLiteral_3091/*"BOOST_ITEM_USE_OPTION_FRIEND_CHOCOLATE"*/);
    sub_2213A60(&StringLiteral_18275/*"btn_on"*/);
    sub_2213A60(&StringLiteral_3093/*"BOOST_ITEM_USE_TITLE_FRIEND_CHOCOLATE"*/);
    sub_2213A60(&StringLiteral_3088/*"BOOST_ITEM_USE_DETAIL"*/);
    sub_2213A60(&StringLiteral_3081/*"BOOST_ITEM_USE_CANCEL"*/);
    sub_2213A60(&StringLiteral_3087/*"BOOST_ITEM_USE_DECIDE"*/);
    sub_2213A60(&StringLiteral_3090/*"BOOST_ITEM_USE_OPTION"*/);
    sub_2213A60(&StringLiteral_3092/*"BOOST_ITEM_USE_TITILE"*/);
    sub_2213A60(&StringLiteral_18274/*"btn_off"*/);
    sub_2213A60(&StringLiteral_3089/*"BOOST_ITEM_USE_DETAIL_FRIEND_CHOCOLATE"*/);
    byte_596BDFC = 1;
  }
      ...
      if ( Instance )
      {
        ...
        if ( Instance )
        {
          ...
          if ( (*((_BYTE *)Method_BoostItemMenu_Open__ + 83) & 2) != 0 )
            v32 = (_QWORD *)sub_2213A78(Method_BoostItemMenu_Open__);
          ...
          if ( Instance )
          {
            ...
            if ( IsFriendChocolate )
            {
              ...
              Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3093/*"BOOST_ITEM_USE_TITLE_FRIEND_CHOCOLATE"*/, 0);
              if ( !titleLabel )
                goto LABEL_51;
              UILabel__set_text(titleLabel, (System_String_o *)Instance, 0);
              titleDetailLabel = this->fields.titleDetailLabel;
              Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3089/*"BOOST_ITEM_USE_DETAIL_FRIEND_CHOCOLATE"*/, 0);
              if ( !titleDetailLabel )
                goto LABEL_51;
              UILabel__set_text(titleDetailLabel, (System_String_o *)Instance, 0);
              useConfirmOptionLabel = this->fields.useConfirmOptionLabel;
              Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3091/*"BOOST_ITEM_USE_OPTION_FRIEND_CHOCOLATE"*/, 0);
            ...
            else
            {
              if ( !v37 )
                j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, v34, v35);
              Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3092/*"BOOST_ITEM_USE_TITILE"*/, 0);
              if ( !titleLabel )
                goto LABEL_51;
              UILabel__set_text(titleLabel, (System_String_o *)Instance, 0);
              v49 = this->fields.titleDetailLabel;
              Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3088/*"BOOST_ITEM_USE_DETAIL"*/, 0);
              if ( !v49 )
                goto LABEL_51;
              UILabel__set_text(v49, (System_String_o *)Instance, 0);
              v50 = this->fields.useConfirmOptionLabel;
              Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3090/*"BOOST_ITEM_USE_OPTION"*/, 0);
              if ( !v50 )
                goto LABEL_51;
            ...
            Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3087/*"BOOST_ITEM_USE_DECIDE"*/, 0);
            if ( decideLabel )
            {
              UILabel__set_text(decideLabel, (System_String_o *)Instance, 0);
              cancelLabel = this->fields.cancelLabel;
              Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3081/*"BOOST_ITEM_USE_CANCEL"*/, 0);
              if ( cancelLabel )
              {
                ...
                if ( setupInfo )
                {
                  ...
                  if ( Instance )
                  {
                    ...
                    if ( Instance )
                    {
                      BoostItemListViewManager__SetMode_40729212((BoostItemListViewManager_o *)Instance, 1, v56);
                      Instance = (DataManager_o *)this->fields.setupConfirmSprite;
                      if ( Instance )
                      {
                        if ( this->fields.isBoostItemUseConfirm )
                          v57 = &StringLiteral_18275/*"btn_on"*/;
                        else
                          v57 = &StringLiteral_18274/*"btn_off"*/;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596BDFA & 1) == 0 )
  {
    sub_2213A60(&BoostItemMenu_CallbackFunc_TypeInfo);
    byte_596BDFA = 1;
  }
  ...
  v13 = (BoostItemMenu_o *)sub_221405C(v8, BoostItemMenu_CallbackFunc_TypeInfo, v9, v10);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_2003CFC;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_2003CA4;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596BE03 & 1) == 0 )
  {
    sub_2213A60(&BoostItemMenu_ResultKind_TypeInfo);
    byte_596BE03 = 1;
  }
  v10[2] = 0;
