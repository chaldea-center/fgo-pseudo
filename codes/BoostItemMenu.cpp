...
void BoostItemMenu__Callback(BoostItemMenu_o *this, int32_t result, int32_t index, const MethodInfo *method)
{
  ...
  if ( (byte_4C22B26 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_BoostItemMenu___c__DisplayClass25_0__Callback_b__0__);
    sub_1C2D490(&BoostItemMenu___c__DisplayClass25_0_TypeInfo);
    byte_4C22B26 = 1;
  }
  v7 = sub_1C2D6DC(BoostItemMenu___c__DisplayClass25_0_TypeInfo);
...
void BoostItemMenu__Close(BoostItemMenu_o *this, const MethodInfo *method)
{
  ...
  BoostItemMenu__Close_33783000(this, 0, v2);
}


void BoostItemMenu__Close_33783000(BoostItemMenu_o *this, System_Action_o *callback, const MethodInfo *method)
{
  ...
  {
    sub_1C2D490(&System_Action_TypeInfo);
    sub_1C2D490(&Method_BoostItemMenu_EndClose__);
    byte_4C22B25 = 1;
  }
  itemListViewManager = this->fields.itemListViewManager;
  if ( !itemListViewManager )
    sub_1C2D6EC(0, callback);
  BoostItemListViewManager__SetMode_33777224(itemListViewManager, 1, method);
...
void BoostItemMenu__EndOpen(BoostItemMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C22B24 & 1) == 0 )
  {
    sub_1C2D490(&Method_BoostItemMenu_OnSelectItem__);
    sub_1C2D490(&BoostItemListViewManager_CallbackFunc_TypeInfo);
    byte_4C22B24 = 1;
  }
  this->fields.state = 2;
  itemListViewManager = this->fields.itemListViewManager;
  v4 = (BoostItemListViewManager_CallbackFunc_o *)sub_1C2D6DC(BoostItemListViewManager_CallbackFunc_TypeInfo);
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&itemListViewManager->fields.callbackFunc, (int32_t)v4, v8, v9);
  BoostItemListViewManager__SetMode_33777224(itemListViewManager, 2, v10);
...
void BoostItemMenu__OnClickSetupConfirm(BoostItemMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C22B28 & 1) == 0 )
  {
    sub_1C2D490(&Method_BoostItemMenu_OnClickSetupConfirm__);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_BoostItemMenu_OnClickSetupConfirm__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2D4A8(Method_BoostItemMenu_OnClickSetupConfirm__);
...
void BoostItemMenu__OnSelectItem(BoostItemMenu_o *this, int32_t kind, int32_t n, const MethodInfo *method)
{
  ...
  {
    sub_1C2D490(&Method_BoostItemMenu_OnSelectItem__);
    this = (BoostItemMenu_o *)sub_1C2D490(&BoostItemListViewManager_CallbackFunc_TypeInfo);
    byte_4C22B27 = 1;
  }
      ...
      if ( kind == 1 )
      {
        ...
        if ( LOBYTE(this->fields.itemListViewManager) )
        {
          ...
          if ( (*((_BYTE *)Method_BoostItemMenu_OnSelectItem__ + 83) & 2) != 0 )
            v7 = (_QWORD *)sub_1C2D4A8(Method_BoostItemMenu_OnSelectItem__);
          ...
          v10 = (BoostItemListViewManager_CallbackFunc_o *)sub_1C2D6DC(BoostItemListViewManager_CallbackFunc_TypeInfo);
          BoostItemListViewManager_CallbackFunc___ctor(
            v10,
            (Il2CppObject *)v6,
            (intptr_t)Method_BoostItemMenu_OnSelectItem__,
          ...
          if ( itemListViewManager )
          {
            ...
            sub_1C2D434((CGThumbnailListItem_o *)&itemListViewManager->fields.callbackFunc, (int32_t)v10, v12, v13);
            BoostItemListViewManager__SetMode_33777224(itemListViewManager, 2, v14);
            return;
          }
LABEL_18:
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C2D490(&System_Action_TypeInfo);
    sub_1C2D490(&Method_BoostItemMenu_EndOpen__);
    sub_1C2D490(&Method_BoostItemMenu_Open__);
    sub_1C2D490(&Method_DataManager_GetMasterData_ItemMaster___);
    sub_1C2D490(&LocalizationManager_TypeInfo);
    sub_1C2D490(&OptionManager_TypeInfo);
    sub_1C2D490(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    sub_1C2D490(&StringLiteral_2966/*"BOOST_ITEM_USE_OPTION_FRIEND_CHOCOLATE"*/);
    sub_1C2D490(&StringLiteral_17501/*"btn_on"*/);
    sub_1C2D490(&StringLiteral_2968/*"BOOST_ITEM_USE_TITLE_FRIEND_CHOCOLATE"*/);
    sub_1C2D490(&StringLiteral_2963/*"BOOST_ITEM_USE_DETAIL"*/);
    sub_1C2D490(&StringLiteral_2956/*"BOOST_ITEM_USE_CANCEL"*/);
    sub_1C2D490(&StringLiteral_2962/*"BOOST_ITEM_USE_DECIDE"*/);
    sub_1C2D490(&StringLiteral_2965/*"BOOST_ITEM_USE_OPTION"*/);
    sub_1C2D490(&StringLiteral_2967/*"BOOST_ITEM_USE_TITILE"*/);
    sub_1C2D490(&StringLiteral_17500/*"btn_off"*/);
    sub_1C2D490(&StringLiteral_2964/*"BOOST_ITEM_USE_DETAIL_FRIEND_CHOCOLATE"*/);
    byte_4C22B23 = 1;
  }
  ...
  if ( (unsigned int)(state - 2) < 2 )
  {
    ...
    sub_1C2D434((CGThumbnailListItem_o *)&this->fields.openCallbackFunc, (int32_t)openCallback, v27, v28);
  ...
  if ( state == 4 || !state )
  {
    ...
    sub_1C2D434(
      ...
      (const MethodInfo *)openCallback);
    this->fields.openCallbackFunc = openCallback;
    sub_1C2D434((CGThumbnailListItem_o *)&this->fields.openCallbackFunc, (int32_t)openCallback, v14, v15);
    if ( !OptionManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(OptionManager_TypeInfo);
      ...
      || (v20 = (System_Int32_array *)Instance, !Instance->fields.m_CancellationTokenSource) )
    {
      ...
      if ( openCallbackFunc )
      {
        ...
        sub_1C2D434((CGThumbnailListItem_o *)&this->fields.openCallbackFunc, 0, v18, v19);
        if ( !openCallback )
          goto LABEL_49;
    ...
    if ( (*((_BYTE *)Method_BoostItemMenu_Open__ + 83) & 2) != 0 )
      v21 = (_QWORD *)sub_1C2D4A8(Method_BoostItemMenu_Open__);
...
LABEL_49:
    ...
    else
    {
      ...
      {
LABEL_18:
        Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2968/*"BOOST_ITEM_USE_TITLE_FRIEND_CHOCOLATE"*/, 0);
        if ( !titleLabel )
          goto LABEL_49;
        UILabel__set_text(titleLabel, (System_String_o *)Instance, 0);
        titleDetailLabel = this->fields.titleDetailLabel;
        Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2964/*"BOOST_ITEM_USE_DETAIL_FRIEND_CHOCOLATE"*/, 0);
        if ( !titleDetailLabel )
          goto LABEL_49;
        UILabel__set_text(titleDetailLabel, (System_String_o *)Instance, 0);
        useConfirmOptionLabel = this->fields.useConfirmOptionLabel;
        Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2966/*"BOOST_ITEM_USE_OPTION_FRIEND_CHOCOLATE"*/, 0);
...
LABEL_37:
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2962/*"BOOST_ITEM_USE_DECIDE"*/, 0);
        if ( decideLabel )
        {
          UILabel__set_text(decideLabel, (System_String_o *)Instance, 0);
          cancelLabel = this->fields.cancelLabel;
          Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2956/*"BOOST_ITEM_USE_CANCEL"*/, 0);
          if ( cancelLabel )
          {
            ...
            if ( setupInfo )
            {
              ...
              if ( Instance )
              {
                ...
                if ( Instance )
                {
                  BoostItemListViewManager__SetMode_33777224((BoostItemListViewManager_o *)Instance, 1, v36);
                  Instance = (DataManager_o *)this->fields.setupConfirmSprite;
                  if ( Instance )
                  {
                    if ( this->fields.isBoostItemUseConfirm )
                      v37 = &StringLiteral_17501/*"btn_on"*/;
                    else
                      v37 = &StringLiteral_17500/*"btn_off"*/;
    ...
    Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2967/*"BOOST_ITEM_USE_TITILE"*/, 0);
    if ( !titleLabel )
      goto LABEL_49;
    UILabel__set_text(titleLabel, (System_String_o *)Instance, 0);
    v31 = this->fields.titleDetailLabel;
    Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2963/*"BOOST_ITEM_USE_DETAIL"*/, 0);
    if ( !v31 )
      goto LABEL_49;
    UILabel__set_text(v31, (System_String_o *)Instance, 0);
    v32 = this->fields.useConfirmOptionLabel;
    Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2965/*"BOOST_ITEM_USE_OPTION"*/, 0);
    if ( !v32 )
      goto LABEL_49;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C22B21 & 1) == 0 )
  {
    sub_1C2D490(&BoostItemMenu_CallbackFunc_TypeInfo);
    byte_4C22B21 = 1;
  }
  ...
  v11 = (BoostItemMenu_o *)sub_1C2D9AC(v8);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1A6BB7C;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A6BB24;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C22B2A & 1) == 0 )
  {
    ...
    sub_1C2D490(&BoostItemMenu_ResultKind_TypeInfo);
    byte_4C22B2A = 1;
  }
  v13[2] = 0;
