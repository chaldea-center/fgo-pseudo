void __fastcall BattleAttackManager___ctor(BattleAttackManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A21D45 & 1) == 0 )
  {
    sub_1B715CC(&Method_System_Collections_Generic_List_BattleAttack___ctor__, method);
    sub_1B715CC(&System_Collections_Generic_List_BattleAttack__TypeInfo, v3);
    byte_4A21D45 = 1;
  }
  v4 = (System_Collections_Generic_List_object__o *)sub_1B71818(System_Collections_Generic_List_BattleAttack__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v4,
    (const MethodInfo_34CFA2C *)Method_System_Collections_Generic_List_BattleAttack___ctor__);
  this->fields.attackList = (struct System_Collections_Generic_List_BattleAttack__o *)v4;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.attackList, (int32_t)v4, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A21D47 & 1) == 0 )
  {
    sub_1B715CC(&Method_BasicHelper_IndexValue_BattleLogic_LOGICTYPE___, *(_QWORD *)&index);
    byte_4A21D47 = 1;
  }
  ...
  return BasicHelper__IndexValue_Int32Enum_(
           ...
           index,
           77,
           (const MethodInfo_2E4A184 *)Method_BasicHelper_IndexValue_BattleLogic_LOGICTYPE___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A21D46 & 1) == 0 )
  {
    sub_1B715CC(&BattleAttackPlayer_TypeInfo, allLogicArray);
    sub_1B715CC(&Method_System_Collections_Generic_List_BattleAttack__Add__, v5);
    byte_4A21D46 = 1;
  }
  attackList = (System_Collections_Generic_List_object__o *)this->fields.attackList;
  v7 = (BattleAttack_o *)sub_1B71818(BattleAttackPlayer_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A21D42 & 1) == 0 )
  {
    sub_1B715CC(&EnemyFirstAttackManager_TypeInfo, allLogicArray);
    sub_1B715CC(&PlayerFirstAttackManager_TypeInfo, v5);
    byte_4A21D42 = 1;
  }
  ...
  v7 = (BattleAttackManager_o *)sub_1B71818(*v6);
...
int32_t __fastcall BattleAttackManager__PrevIndex(BattleAttackManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A21D48 & 1) == 0 )
  {
    sub_1B715CC(&Method_System_Collections_Generic_List_BattleAttack__get_Count__, method);
    byte_4A21D48 = 1;
  }
...
BattleAttack_o *__fastcall BattleAttackManager__get_Current(BattleAttackManager_o *this, const MethodInfo *method)
{
  if ( (byte_4A21D43 & 1) == 0 )
  {
    sub_1B715CC(&Method_BasicHelper_IndexValue_BattleAttack___, method);
    byte_4A21D43 = 1;
  }
  return (BattleAttack_o *)BasicHelper__IndexValue_object__48538040(
                             (System_Collections_Generic_List_T__o *)this->fields.attackList,
                             this->fields.attackIndex,
                             0LL,
                             (const MethodInfo_2E4A1B8 *)Method_BasicHelper_IndexValue_BattleAttack___);
}
