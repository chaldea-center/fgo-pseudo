void __fastcall BattleAttackManager___ctor(BattleAttackManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A00D72 & 1) == 0 )
  {
    sub_1B64A00(&Method_System_Collections_Generic_List_BattleAttack___ctor__, method);
    sub_1B64A00(&System_Collections_Generic_List_BattleAttack__TypeInfo, v3);
    byte_4A00D72 = 1;
  }
  v4 = (System_Collections_Generic_List_object__o *)sub_1B64C4C(System_Collections_Generic_List_BattleAttack__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v4,
    (const MethodInfo_34AF794 *)Method_System_Collections_Generic_List_BattleAttack___ctor__);
  this->fields.attackList = (struct System_Collections_Generic_List_BattleAttack__o *)v4;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.attackList, (int32_t)v4, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A00D74 & 1) == 0 )
  {
    sub_1B64A00(&Method_BasicHelper_IndexValue_BattleLogic_LOGICTYPE___, *(_QWORD *)&index);
    byte_4A00D74 = 1;
  }
  ...
  return BasicHelper__IndexValue_Int32Enum_(
           ...
           index,
           77,
           (const MethodInfo_2E2AA7C *)Method_BasicHelper_IndexValue_BattleLogic_LOGICTYPE___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A00D73 & 1) == 0 )
  {
    sub_1B64A00(&BattleAttackPlayer_TypeInfo, allLogicArray);
    sub_1B64A00(&Method_System_Collections_Generic_List_BattleAttack__Add__, v5);
    byte_4A00D73 = 1;
  }
  attackList = (System_Collections_Generic_List_object__o *)this->fields.attackList;
  v7 = (BattleAttack_o *)sub_1B64C4C(BattleAttackPlayer_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A00D6F & 1) == 0 )
  {
    sub_1B64A00(&EnemyFirstAttackManager_TypeInfo, allLogicArray);
    sub_1B64A00(&PlayerFirstAttackManager_TypeInfo, v5);
    byte_4A00D6F = 1;
  }
  ...
  v7 = (BattleAttackManager_o *)sub_1B64C4C(*v6);
...
int32_t __fastcall BattleAttackManager__PrevIndex(BattleAttackManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A00D75 & 1) == 0 )
  {
    sub_1B64A00(&Method_System_Collections_Generic_List_BattleAttack__get_Count__, method);
    byte_4A00D75 = 1;
  }
...
BattleAttack_o *__fastcall BattleAttackManager__get_Current(BattleAttackManager_o *this, const MethodInfo *method)
{
  if ( (byte_4A00D70 & 1) == 0 )
  {
    sub_1B64A00(&Method_BasicHelper_IndexValue_BattleAttack___, method);
    byte_4A00D70 = 1;
  }
  return (BattleAttack_o *)BasicHelper__IndexValue_object__48409264(
                             (System_Collections_Generic_List_T__o *)this->fields.attackList,
                             this->fields.attackIndex,
                             0LL,
                             (const MethodInfo_2E2AAB0 *)Method_BasicHelper_IndexValue_BattleAttack___);
}
