void __fastcall BattleAttackManager___ctor(BattleAttackManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C24356 & 1) == 0 )
  {
    sub_1C3B764(&Method_System_Collections_Generic_List_BattleAttack___ctor__, method);
    sub_1C3B764(&System_Collections_Generic_List_BattleAttack__TypeInfo, v3);
    byte_4C24356 = 1;
  }
  v4 = (System_Collections_Generic_List_object__o *)sub_1C3B9B0(System_Collections_Generic_List_BattleAttack__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v4,
    (const MethodInfo_368B438 *)Method_System_Collections_Generic_List_BattleAttack___ctor__);
  this->fields.attackList = (struct System_Collections_Generic_List_BattleAttack__o *)v4;
  sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.attackList, (int64_t)v4, v5, v6, v7, v8, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24358 & 1) == 0 )
  {
    sub_1C3B764(&Method_BasicHelper_IndexValue_BattleLogic_LOGICTYPE___, *(_QWORD *)&index);
    byte_4C24358 = 1;
  }
  ...
  return BasicHelper__IndexValue_Int32Enum_(
           ...
           index,
           78,
           (const MethodInfo_2FDEA2C *)Method_BasicHelper_IndexValue_BattleLogic_LOGICTYPE___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24357 & 1) == 0 )
  {
    sub_1C3B764(&BattleAttackPlayer_TypeInfo, allLogicArray);
    sub_1C3B764(&Method_System_Collections_Generic_List_BattleAttack__Add__, v5);
    byte_4C24357 = 1;
  }
  attackList = (System_Collections_Generic_List_object__o *)this->fields.attackList;
  v7 = (BattleAttack_o *)sub_1C3B9B0(BattleAttackPlayer_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2435A & 1) == 0 )
  {
    sub_1C3B764(&Method_System_Array_IndexOf_BattleLogic_LOGICTYPE___, *(_QWORD *)&logicIndex);
    byte_4C2435A = 1;
  }
  ...
  if ( !v11
    || (v13 = System_Array__IndexOf_Int32Enum_(
                ...
                startType,
                (const MethodInfo_30EE568 *)Method_System_Array_IndexOf_BattleLogic_LOGICTYPE___),
  ...
  return (v13 <= logicIndex) & (System_Array__IndexOf_Int32Enum_(
                                  (System_Int32Enum_array *)v11->fields._LogicArray_k__BackingField,
                                  endType,
                                  (const MethodInfo_30EE568 *)Method_System_Array_IndexOf_BattleLogic_LOGICTYPE___) > logicIndex);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24353 & 1) == 0 )
  {
    sub_1C3B764(&EnemyFirstAttackManager_TypeInfo, allLogicArray);
    sub_1C3B764(&PlayerFirstAttackManager_TypeInfo, v5);
    byte_4C24353 = 1;
  }
  ...
  v7 = (BattleAttackManager_o *)sub_1C3B9B0(*v6);
...
int32_t __fastcall BattleAttackManager__PrevIndex(BattleAttackManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C24359 & 1) == 0 )
  {
    sub_1C3B764(&Method_System_Collections_Generic_List_BattleAttack__get_Count__, method);
    byte_4C24359 = 1;
  }
...
BattleAttack_o *__fastcall BattleAttackManager__get_Current(BattleAttackManager_o *this, const MethodInfo *method)
{
  if ( (byte_4C24354 & 1) == 0 )
  {
    sub_1C3B764(&Method_BasicHelper_IndexValue_BattleAttack___, method);
    byte_4C24354 = 1;
  }
  return (BattleAttack_o *)BasicHelper__IndexValue_object__50195040(
                             (System_Collections_Generic_List_T__o *)this->fields.attackList,
                             this->fields.attackIndex,
                             0LL,
                             (const MethodInfo_2FDEA60 *)Method_BasicHelper_IndexValue_BattleAttack___);
}
