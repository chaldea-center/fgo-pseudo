void __fastcall BattleAttackManager___ctor(BattleAttackManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0AEC6 & 1) == 0 )
  {
    sub_1B686D4(&Method_System_Collections_Generic_List_BattleAttack___ctor__, method);
    sub_1B686D4(&System_Collections_Generic_List_BattleAttack__TypeInfo, v3);
    byte_4A0AEC6 = 1;
  }
  v4 = (System_Collections_Generic_List_object__o *)sub_1B68920(System_Collections_Generic_List_BattleAttack__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v4,
    (const MethodInfo_34BBA44 *)Method_System_Collections_Generic_List_BattleAttack___ctor__);
  this->fields.attackList = (struct System_Collections_Generic_List_BattleAttack__o *)v4;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.attackList, (int32_t)v4, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0AEC8 & 1) == 0 )
  {
    sub_1B686D4(&Method_BasicHelper_IndexValue_BattleLogic_LOGICTYPE___, *(_QWORD *)&index);
    byte_4A0AEC8 = 1;
  }
  ...
  return BasicHelper__IndexValue_Int32Enum_(
           ...
           index,
           77,
           (const MethodInfo_2E38AEC *)Method_BasicHelper_IndexValue_BattleLogic_LOGICTYPE___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0AEC7 & 1) == 0 )
  {
    sub_1B686D4(&BattleAttackPlayer_TypeInfo, allLogicArray);
    sub_1B686D4(&Method_System_Collections_Generic_List_BattleAttack__Add__, v5);
    byte_4A0AEC7 = 1;
  }
  attackList = (System_Collections_Generic_List_object__o *)this->fields.attackList;
  v7 = (BattleAttack_o *)sub_1B68920(BattleAttackPlayer_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0AEC3 & 1) == 0 )
  {
    sub_1B686D4(&EnemyFirstAttackManager_TypeInfo, allLogicArray);
    sub_1B686D4(&PlayerFirstAttackManager_TypeInfo, v5);
    byte_4A0AEC3 = 1;
  }
  ...
  v7 = (BattleAttackManager_o *)sub_1B68920(*v6);
...
int32_t __fastcall BattleAttackManager__PrevIndex(BattleAttackManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0AEC9 & 1) == 0 )
  {
    sub_1B686D4(&Method_System_Collections_Generic_List_BattleAttack__get_Count__, method);
    byte_4A0AEC9 = 1;
  }
...
BattleAttack_o *__fastcall BattleAttackManager__get_Current(BattleAttackManager_o *this, const MethodInfo *method)
{
  if ( (byte_4A0AEC4 & 1) == 0 )
  {
    sub_1B686D4(&Method_BasicHelper_IndexValue_BattleAttack___, method);
    byte_4A0AEC4 = 1;
  }
  return (BattleAttack_o *)BasicHelper__IndexValue_object__48466720(
                             (System_Collections_Generic_List_T__o *)this->fields.attackList,
                             this->fields.attackIndex,
                             0LL,
                             (const MethodInfo_2E38B20 *)Method_BasicHelper_IndexValue_BattleAttack___);
}
