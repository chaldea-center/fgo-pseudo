void __fastcall BattleAttackManager___ctor(BattleAttackManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A00751 & 1) == 0 )
  {
    sub_1B64870(&Method_System_Collections_Generic_List_BattleAttack___ctor__, method);
    sub_1B64870(&System_Collections_Generic_List_BattleAttack__TypeInfo, v3);
    byte_4A00751 = 1;
  }
  v4 = (System_Collections_Generic_List_object__o *)sub_1B64ABC(System_Collections_Generic_List_BattleAttack__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v4,
    (const MethodInfo_34AF17C *)Method_System_Collections_Generic_List_BattleAttack___ctor__);
  this->fields.attackList = (struct System_Collections_Generic_List_BattleAttack__o *)v4;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.attackList, (int32_t)v4, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A00753 & 1) == 0 )
  {
    sub_1B64870(&Method_BasicHelper_IndexValue_BattleLogic_LOGICTYPE___, *(_QWORD *)&index);
    byte_4A00753 = 1;
  }
  ...
  return BasicHelper__IndexValue_Int32Enum_(
           ...
           index,
           77,
           (const MethodInfo_2E2A464 *)Method_BasicHelper_IndexValue_BattleLogic_LOGICTYPE___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A00752 & 1) == 0 )
  {
    sub_1B64870(&BattleAttackPlayer_TypeInfo, allLogicArray);
    sub_1B64870(&Method_System_Collections_Generic_List_BattleAttack__Add__, v5);
    byte_4A00752 = 1;
  }
  attackList = (System_Collections_Generic_List_object__o *)this->fields.attackList;
  v7 = (BattleAttack_o *)sub_1B64ABC(BattleAttackPlayer_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0074E & 1) == 0 )
  {
    sub_1B64870(&EnemyFirstAttackManager_TypeInfo, allLogicArray);
    sub_1B64870(&PlayerFirstAttackManager_TypeInfo, v5);
    byte_4A0074E = 1;
  }
  ...
  v7 = (BattleAttackManager_o *)sub_1B64ABC(*v6);
...
int32_t __fastcall BattleAttackManager__PrevIndex(BattleAttackManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A00754 & 1) == 0 )
  {
    sub_1B64870(&Method_System_Collections_Generic_List_BattleAttack__get_Count__, method);
    byte_4A00754 = 1;
  }
...
BattleAttack_o *__fastcall BattleAttackManager__get_Current(BattleAttackManager_o *this, const MethodInfo *method)
{
  if ( (byte_4A0074F & 1) == 0 )
  {
    sub_1B64870(&Method_BasicHelper_IndexValue_BattleAttack___, method);
    byte_4A0074F = 1;
  }
  return (BattleAttack_o *)BasicHelper__IndexValue_object__48407704(
                             (System_Collections_Generic_List_T__o *)this->fields.attackList,
                             this->fields.attackIndex,
                             0LL,
                             (const MethodInfo_2E2A498 *)Method_BasicHelper_IndexValue_BattleAttack___);
}
