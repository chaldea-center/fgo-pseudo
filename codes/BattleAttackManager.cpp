void BattleAttackManager___ctor(BattleAttackManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E07364 & 1) == 0 )
  {
    sub_1CE6700(&Method_System_Collections_Generic_List_BattleAttack___ctor__);
    sub_1CE6700(&System_Collections_Generic_List_BattleAttack__TypeInfo);
    byte_4E07364 = 1;
  }
  v3 = (System_Collections_Generic_List_object__o *)sub_1CE694C(System_Collections_Generic_List_BattleAttack__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v3,
    (const MethodInfo_3905734 *)Method_System_Collections_Generic_List_BattleAttack___ctor__);
  this->fields.attackList = (struct System_Collections_Generic_List_BattleAttack__o *)v3;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.attackList, (int32_t)v3, v4, v5, v6, v7, v8, v9);
...
int32_t BattleAttackManager__GetLogicType(BattleAttackManager_o *this, int32_t index, const MethodInfo *method)
{
  ...
  if ( (byte_4E07366 & 1) == 0 )
  {
    sub_1CE6700(&Method_BasicHelper_IndexValue_BattleLogic_LOGICTYPE___);
    byte_4E07366 = 1;
  }
  ...
  return BasicHelper__IndexValue_Int32Enum_(
           ...
           index,
           75,
           (const MethodInfo_31F262C *)Method_BasicHelper_IndexValue_BattleLogic_LOGICTYPE___);
}
        ...
        const MethodInfo *method)
{
  ...
  v6 = (BattleAttack_o *)sub_1CE694C(BattleAttackPlayer_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E07368 & 1) == 0 )
  {
    sub_1CE6700(&Method_System_Array_IndexOf_BattleLogic_LOGICTYPE___);
    byte_4E07368 = 1;
  }
  ...
  if ( !v11
    || (v13 = System_Array__IndexOf_Int32Enum_(
                ...
                startType,
                (const MethodInfo_330B698 *)Method_System_Array_IndexOf_BattleLogic_LOGICTYPE___),
  ...
  return (v13 <= logicIndex)
       & (System_Array__IndexOf_Int32Enum_(
            (System_Int32Enum_array *)v11->fields._LogicArray_k__BackingField,
            endType,
            (const MethodInfo_330B698 *)Method_System_Array_IndexOf_BattleLogic_LOGICTYPE___) > logicIndex);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E07361 & 1) == 0 )
  {
    sub_1CE6700(&EnemyFirstAttackManager_TypeInfo);
    sub_1CE6700(&PlayerFirstAttackManager_TypeInfo);
    byte_4E07361 = 1;
  }
  ...
  v6 = (BattleAttackManager_o *)sub_1CE694C(*v5);
...
int32_t BattleAttackManager__PrevIndex(BattleAttackManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E07367 & 1) == 0 )
  {
    sub_1CE6700(&Method_System_Collections_Generic_List_BattleAttack__get_Count__);
    byte_4E07367 = 1;
  }
...
BattleAttack_o *BattleAttackManager__get_Current(BattleAttackManager_o *this, const MethodInfo *method)
{
  if ( (byte_4E07362 & 1) == 0 )
  {
    sub_1CE6700(&Method_BasicHelper_IndexValue_BattleAttack___);
    byte_4E07362 = 1;
  }
  return (BattleAttack_o *)BasicHelper__IndexValue_object__52373088(
                             (System_Collections_Generic_List_T__o *)this->fields.attackList,
                             this->fields.attackIndex,
                             0,
                             (const MethodInfo_31F2660 *)Method_BasicHelper_IndexValue_BattleAttack___);
}
