void BattleAttackManager___ctor(BattleAttackManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D332FC & 1) == 0 )
  {
    sub_1C93AD4(&Method_System_Collections_Generic_List_BattleAttack___ctor__);
    sub_1C93AD4(&System_Collections_Generic_List_BattleAttack__TypeInfo);
    byte_4D332FC = 1;
  }
  v3 = (System_Collections_Generic_List_object__o *)sub_1C93D20(System_Collections_Generic_List_BattleAttack__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v3,
    (const MethodInfo_3879168 *)Method_System_Collections_Generic_List_BattleAttack___ctor__);
  this->fields.attackList = (struct System_Collections_Generic_List_BattleAttack__o *)v3;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.attackList, (int32_t)v3, v4, v5, v6, v7, v8, v9);
...
int32_t BattleAttackManager__GetLogicType(BattleAttackManager_o *this, int32_t index, const MethodInfo *method)
{
  ...
  if ( (byte_4D332FE & 1) == 0 )
  {
    sub_1C93AD4(&Method_BasicHelper_IndexValue_BattleLogic_LOGICTYPE___);
    byte_4D332FE = 1;
  }
  ...
  return BasicHelper__IndexValue_Int32Enum_(
           ...
           index,
           75,
           (const MethodInfo_3192CC8 *)Method_BasicHelper_IndexValue_BattleLogic_LOGICTYPE___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D332FD & 1) == 0 )
  {
    sub_1C93AD4(&BattleAttackPlayer_TypeInfo);
    sub_1C93AD4(&Method_System_Collections_Generic_List_BattleAttack__Add__);
    byte_4D332FD = 1;
  }
  attackList = (System_Collections_Generic_List_object__o *)this->fields.attackList;
  v6 = (BattleAttack_o *)sub_1C93D20(BattleAttackPlayer_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D33300 & 1) == 0 )
  {
    sub_1C93AD4(&Method_System_Array_IndexOf_BattleLogic_LOGICTYPE___);
    byte_4D33300 = 1;
  }
  ...
  if ( !v11
    || (v13 = System_Array__IndexOf_Int32Enum_(
                ...
                startType,
                (const MethodInfo_32AB1DC *)Method_System_Array_IndexOf_BattleLogic_LOGICTYPE___),
  ...
  return (v13 <= logicIndex)
       & (System_Array__IndexOf_Int32Enum_(
            (System_Int32Enum_array *)v11->fields._LogicArray_k__BackingField,
            endType,
            (const MethodInfo_32AB1DC *)Method_System_Array_IndexOf_BattleLogic_LOGICTYPE___) > logicIndex);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D332F9 & 1) == 0 )
  {
    sub_1C93AD4(&EnemyFirstAttackManager_TypeInfo);
    sub_1C93AD4(&PlayerFirstAttackManager_TypeInfo);
    byte_4D332F9 = 1;
  }
  ...
  v6 = (BattleAttackManager_o *)sub_1C93D20(*v5);
...
int32_t BattleAttackManager__PrevIndex(BattleAttackManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D332FF & 1) == 0 )
  {
    sub_1C93AD4(&Method_System_Collections_Generic_List_BattleAttack__get_Count__);
    byte_4D332FF = 1;
  }
...
BattleAttack_o *BattleAttackManager__get_Current(BattleAttackManager_o *this, const MethodInfo *method)
{
  if ( (byte_4D332FA & 1) == 0 )
  {
    sub_1C93AD4(&Method_BasicHelper_IndexValue_BattleAttack___);
    byte_4D332FA = 1;
  }
  return (BattleAttack_o *)BasicHelper__IndexValue_object__51981564(
                             (System_Collections_Generic_List_T__o *)this->fields.attackList,
                             this->fields.attackIndex,
                             0,
                             (const MethodInfo_3192CFC *)Method_BasicHelper_IndexValue_BattleAttack___);
}
