void __fastcall BattleAttackManager___ctor(BattleAttackManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFFB28 & 1) == 0 )
  {
    sub_1C2E12C(&Method_System_Collections_Generic_List_BattleAttack___ctor__, method);
    sub_1C2E12C(&System_Collections_Generic_List_BattleAttack__TypeInfo, v3);
    byte_4BFFB28 = 1;
  }
  v4 = (System_Collections_Generic_List_object__o *)sub_1C2E378(System_Collections_Generic_List_BattleAttack__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v4,
    (const MethodInfo_366B078 *)Method_System_Collections_Generic_List_BattleAttack___ctor__);
  this->fields.attackList = (struct System_Collections_Generic_List_BattleAttack__o *)v4;
  sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.attackList, (int64_t)v4, v5, v6, v7, v8, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFFB2A & 1) == 0 )
  {
    sub_1C2E12C(&Method_BasicHelper_IndexValue_BattleLogic_LOGICTYPE___, *(_QWORD *)&index);
    byte_4BFFB2A = 1;
  }
  ...
  return BasicHelper__IndexValue_Int32Enum_(
           ...
           index,
           78,
           (const MethodInfo_2FC00F4 *)Method_BasicHelper_IndexValue_BattleLogic_LOGICTYPE___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFFB29 & 1) == 0 )
  {
    sub_1C2E12C(&BattleAttackPlayer_TypeInfo, allLogicArray);
    sub_1C2E12C(&Method_System_Collections_Generic_List_BattleAttack__Add__, v5);
    byte_4BFFB29 = 1;
  }
  attackList = (System_Collections_Generic_List_object__o *)this->fields.attackList;
  v7 = (BattleAttack_o *)sub_1C2E378(BattleAttackPlayer_TypeInfo);
...
bool __fastcall BattleAttackManager__IsEnemyTurnAfterBuffTurnProgress(
        BattleAttackManager_o *this,
        int32_t logicIndex,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
bool __fastcall BattleAttackManager__IsLogicIndexBetweenAndNotIncludeEnd(
        BattleAttackManager_o *this,
        int32_t logicIndex,
        int32_t startType,
        int32_t endType,
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFFB2C & 1) == 0 )
  {
    sub_1C2E12C(&Method_System_Array_IndexOf_BattleLogic_LOGICTYPE___, *(_QWORD *)&logicIndex);
    byte_4BFFB2C = 1;
  }
  ...
  if ( !v11
    || (v13 = System_Array__IndexOf_Int32Enum_(
                ...
                startType,
                (const MethodInfo_30CF114 *)Method_System_Array_IndexOf_BattleLogic_LOGICTYPE___),
        (v11 = BattleAttackManager__get_Current(this, v14)) == 0LL) )
  {
    sub_1C2E388(v11, v12);
  }
  return (v13 <= logicIndex) & (System_Array__IndexOf_Int32Enum_(
                                  (System_Int32Enum_array *)v11->fields._LogicArray_k__BackingField,
                                  endType,
                                  (const MethodInfo_30CF114 *)Method_System_Array_IndexOf_BattleLogic_LOGICTYPE___) > logicIndex);
}
...
bool __fastcall BattleAttackManager__IsPlayerTurnAfterBuffTurnProgress(
        BattleAttackManager_o *this,
        int32_t logicIndex,
        const MethodInfo *method)
{
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFFB25 & 1) == 0 )
  {
    sub_1C2E12C(&EnemyFirstAttackManager_TypeInfo, allLogicArray);
    sub_1C2E12C(&PlayerFirstAttackManager_TypeInfo, v5);
    byte_4BFFB25 = 1;
  }
  ...
  v7 = (BattleAttackManager_o *)sub_1C2E378(*v6);
...
int32_t __fastcall BattleAttackManager__PrevIndex(BattleAttackManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFFB2B & 1) == 0 )
  {
    sub_1C2E12C(&Method_System_Collections_Generic_List_BattleAttack__get_Count__, method);
    byte_4BFFB2B = 1;
  }
...
BattleAttack_o *__fastcall BattleAttackManager__get_Current(BattleAttackManager_o *this, const MethodInfo *method)
{
  if ( (byte_4BFFB26 & 1) == 0 )
  {
    sub_1C2E12C(&Method_BasicHelper_IndexValue_BattleAttack___, method);
    byte_4BFFB26 = 1;
  }
  return (BattleAttack_o *)BasicHelper__IndexValue_object__50069800(
                             (System_Collections_Generic_List_T__o *)this->fields.attackList,
                             this->fields.attackIndex,
                             0LL,
                             (const MethodInfo_2FC0128 *)Method_BasicHelper_IndexValue_BattleAttack___);
}
