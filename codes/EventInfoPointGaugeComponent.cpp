...
void EventInfoPointGaugeComponent__Awake(EventInfoPointGaugeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E05E53 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_19480/*"event_point_bar"*/);
    sub_1CE6700(&StringLiteral_19416/*"event_bg_bar"*/);
    byte_4E05E53 = 1;
  }
  ...
  *(_QWORD *)&this->fields.maxPoint = (unsigned int)UserEventActivityPointMax;
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.gaugeTweenHeight, 0, v2, v3, v4, v5, v6, v7);
  gaugeBgSprite = this->fields.gaugeBgSprite;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetEventSprite(gaugeBgSprite, (System_String_o *)StringLiteral_19416/*"event_bg_bar"*/, 0);
  ...
  if ( !gaugeBarSprite
    || (((void (__fastcall *)(struct UISprite_o *, const MethodInfo *))gaugeBarSprite->klass->vtable._33_MakePixelPerfect.methodPtr)(
        ...
        AtlasManager__SetEventSprite(this->fields.gaugeBarSprite, (System_String_o *)StringLiteral_19480/*"event_point_bar"*/, 0),
  ...
  {
    sub_1CE6958(gaugeBarSprite, v12);
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&AtlasManager_TypeInfo);
    sub_1CE6700(&StringLiteral_19449/*"event_frame_"*/);
    sub_1CE6700(&StringLiteral_19443/*"event_emblem_icon_"*/);
    byte_4E05E56 = 1;
  }
  ...
  if ( gaugeState )
  {
    ...
    if ( gaugeBaseObj )
    {
      ...
      v8 = System_String__Concat_65122828((System_String_o *)StringLiteral_19443/*"event_emblem_icon_"*/, v7, 0);
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
      ...
      if ( gaugeBaseObj )
      {
        ...
        v11 = System_String__Concat_65122828((System_String_o *)StringLiteral_19449/*"event_frame_"*/, v10, 0);
...
LABEL_14:
    sub_1CE6958(gaugeBaseObj, *(_QWORD *)&gaugeState);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E05E54 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_UnityEngine_GameObject_AddComponent_TweenHeight___);
    sub_1CE6700(&Method_System_Collections_Generic_List_EventDelegate__Add__);
    sub_1CE6700(&StringLiteral_6047/*"EndGaugeAnime"*/);
    byte_4E05E54 = 1;
  }
  ...
  gaugeBarSprite = UnityEngine_GameObject__AddComponent_object_(
                     ...
                     (const MethodInfo_325BD54 *)Method_UnityEngine_GameObject_AddComponent_TweenHeight___);
  if ( !gaugeBarSprite )
    goto LABEL_12;
  ...
  *((_DWORD *)gaugeBarSprite + 14) = LODWORD(this->fields.gaugeAnimationTime);
  ...
  v10 = (EventDelegate_o *)sub_1CE694C(EventDelegate_TypeInfo);
  EventDelegate___ctor_50381648(v10, (UnityEngine_MonoBehaviour_o *)this, (System_String_o *)StringLiteral_6047/*"EndGaugeAnime"*/, 0);
  if ( !v9
  ...
  {
LABEL_12:
    sub_1CE6958(gaugeBarSprite, *(_QWORD *)&startHeight);
  }
...
void EventInfoPointGaugeComponent__EndGaugeAnime(EventInfoPointGaugeComponent_o *this, const MethodInfo *method)
{
  ...
  UnityEngine_Object__Destroy_72918540(gaugeTweenHeight, 0);
  this->fields.gaugeTweenHeight = 0;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.gaugeTweenHeight, 0, v8, v9, v10, v11, v12, v13);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1CE6958(gaugeBarSprite, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !byte_4DFE0A9 )
  {
    rootFSOffset = sub_1CE6700(&UnityEngine_Vector3_TypeInfo);
    byte_4DFE0A9 = 1;
  }
  if ( !v6
  ...
  {
LABEL_7:
    sub_1CE6958(rootFSOffset, method);
  }
