...
void __fastcall EventInfoPointGaugeComponent__Awake(EventInfoPointGaugeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4FAC5 & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_18984/*"event_point_bar"*/, v6);
    sub_1B863B8(&StringLiteral_18923/*"event_bg_bar"*/, v7);
    byte_4A4FAC5 = 1;
  }
  ...
  *(_QWORD *)&this->fields.maxPoint = (unsigned int)UserEventActivityPointMax;
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.gaugeTweenHeight, 0, v2, v3);
  gaugeBgSprite = this->fields.gaugeBgSprite;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetEventSprite(gaugeBgSprite, (System_String_o *)StringLiteral_18923/*"event_bg_bar"*/, 0LL);
  ...
  if ( !gaugeBarSprite
    || (((void (__fastcall *)(struct UISprite_o *, Il2CppMethodPointer))gaugeBarSprite->klass->vtable._33_MakePixelPerfect.method)(
        ...
        AtlasManager__SetEventSprite(this->fields.gaugeBarSprite, (System_String_o *)StringLiteral_18984/*"event_point_bar"*/, 0LL),
  ...
  {
    sub_1B86614(gaugeBarSprite, v11);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4FAC8 & 1) == 0 )
  {
    sub_1B863B8(&AtlasManager_TypeInfo, *(_QWORD *)&gaugeState);
    sub_1B863B8(&StringLiteral_18953/*"event_frame_"*/, v5);
    sub_1B863B8(&StringLiteral_18949/*"event_emblem_icon_"*/, v6);
    byte_4A4FAC8 = 1;
  }
  ...
  if ( gaugeState )
  {
    ...
    if ( gaugeBaseObj )
    {
      ...
      v10 = System_String__Concat_61645176((System_String_o *)StringLiteral_18949/*"event_emblem_icon_"*/, v9, 0LL);
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
      ...
      if ( gaugeBaseObj )
      {
        ...
        v13 = System_String__Concat_61645176((System_String_o *)StringLiteral_18953/*"event_frame_"*/, v12, 0LL);
...
LABEL_14:
    sub_1B86614(gaugeBaseObj, *(_QWORD *)&gaugeState);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4FAC6 & 1) == 0 )
  {
    sub_1B863B8(&EventDelegate_TypeInfo, *(_QWORD *)&startHeight);
    sub_1B863B8(&Method_UnityEngine_GameObject_AddComponent_TweenHeight___, v7);
    sub_1B863B8(&Method_System_Collections_Generic_List_EventDelegate__Add__, v8);
    sub_1B863B8(&StringLiteral_5938/*"EndGaugeAnime"*/, v9);
    byte_4A4FAC6 = 1;
  }
  ...
  gaugeBarSprite = UnityEngine_GameObject__AddComponent_object_(
                     ...
                     (const MethodInfo_2FC0D08 *)Method_UnityEngine_GameObject_AddComponent_TweenHeight___);
  if ( !gaugeBarSprite )
    goto LABEL_12;
  ...
  *((_DWORD *)gaugeBarSprite + 14) = LODWORD(this->fields.gaugeAnimationTime);
  ...
  v13 = (EventDelegate_o *)sub_1B86604(EventDelegate_TypeInfo);
  EventDelegate___ctor_47774748(v13, (UnityEngine_MonoBehaviour_o *)this, (System_String_o *)StringLiteral_5938/*"EndGaugeAnime"*/, 0LL);
  if ( !v12
  ...
  {
LABEL_12:
    sub_1B86614(gaugeBarSprite, *(_QWORD *)&startHeight);
  }
        ...
        const MethodInfo *method)
{
  ...
  UnityEngine_Object__Destroy_69356292(gaugeTweenHeight, 0LL);
  this->fields.gaugeTweenHeight = 0LL;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.gaugeTweenHeight, 0, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B86614(gaugeBarSprite, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( this->fields._BufferPoint_k__BackingField )
  {
    ...
    sub_1B8635C((CGThumbnailListItem_o *)&this->fields.endCallback, (int32_t)callback, (int32_t)method, v3);
    MainPoint_k__BackingField = this->fields._MainPoint_k__BackingField;
    ...
    sub_1B8635C((CGThumbnailListItem_o *)&this->fields.gaugeTweenHeight, (int32_t)GaugeAnime, v14, v15);
  }
  else
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( !byte_4A487E1 )
  {
    rootFSOffset = sub_1B863B8(&UnityEngine_Vector3_TypeInfo, method);
    byte_4A487E1 = 1;
  }
  if ( !v6
  ...
  {
LABEL_7:
    sub_1B86614(rootFSOffset, method);
  }
