...
void EventInfoPointGaugeComponent__Awake(EventInfoPointGaugeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C444EA & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_19225/*"event_point_bar"*/);
    sub_1C37058(&StringLiteral_19162/*"event_bg_bar"*/);
    byte_4C444EA = 1;
  }
  ...
  *(_QWORD *)&this->fields.maxPoint = (unsigned int)UserEventActivityPointMax;
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.gaugeTweenHeight, 0, v2, v3);
  gaugeBgSprite = this->fields.gaugeBgSprite;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetEventSprite(gaugeBgSprite, (System_String_o *)StringLiteral_19162/*"event_bg_bar"*/, 0);
  ...
  if ( !gaugeBarSprite
    || (((void (__fastcall *)(struct UISprite_o *, const MethodInfo *))gaugeBarSprite->klass->vtable._33_MakePixelPerfect.methodPtr)(
        ...
        AtlasManager__SetEventSprite(this->fields.gaugeBarSprite, (System_String_o *)StringLiteral_19225/*"event_point_bar"*/, 0),
        (gaugeBarSprite = this->fields.gaugeBarSprite) == 0)
    || (((void (__fastcall *)(struct UISprite_o *, const MethodInfo *))gaugeBarSprite->klass->vtable._33_MakePixelPerfect.methodPtr)(
          gaugeBarSprite,
          gaugeBarSprite->klass->vtable._33_MakePixelPerfect.method),
        EventInfoPointGaugeComponent__ChangeDispGauge(this, this->fields._GaugeStateId_k__BackingField, v9),
        (v11 = this->fields.gaugeBarSprite) == 0) )
  {
    sub_1C372B4(gaugeBarSprite);
  }
  this->fields.gaugeHeight = (float)v11->fields.mHeight;
  EventInfoPointGaugeComponent__UpdateGaugeBarHeight(this, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C37058(&AtlasManager_TypeInfo);
    sub_1C37058(&StringLiteral_19194/*"event_frame_"*/);
    sub_1C37058(&StringLiteral_19188/*"event_emblem_icon_"*/);
    byte_4C444ED = 1;
  }
  ...
  if ( gaugeState )
  {
    ...
    if ( gaugeBaseObj )
    {
      ...
      v8 = System_String__Concat_63561656((System_String_o *)StringLiteral_19188/*"event_emblem_icon_"*/, v7, 0);
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
      ...
      if ( gaugeBaseObj )
      {
        ...
        v11 = System_String__Concat_63561656((System_String_o *)StringLiteral_19194/*"event_frame_"*/, v10, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C444EB & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_UnityEngine_GameObject_AddComponent_TweenHeight___);
    sub_1C37058(&Method_System_Collections_Generic_List_EventDelegate__Add__);
    sub_1C37058(&StringLiteral_6006/*"EndGaugeAnime"*/);
    byte_4C444EB = 1;
  }
  ...
  gaugeBarSprite = UnityEngine_GameObject__AddComponent_object_(
                     ...
                     (const MethodInfo_313F0F0 *)Method_UnityEngine_GameObject_AddComponent_TweenHeight___);
  if ( !gaugeBarSprite )
    goto LABEL_12;
  ...
  *((_DWORD *)gaugeBarSprite + 14) = LODWORD(this->fields.gaugeAnimationTime);
  ...
  EventDelegate___ctor_49274436(v10, (UnityEngine_MonoBehaviour_o *)this, (System_String_o *)StringLiteral_6006/*"EndGaugeAnime"*/, 0);
  if ( !v9
...
void EventInfoPointGaugeComponent__EndGaugeAnime(EventInfoPointGaugeComponent_o *this, const MethodInfo *method)
{
  ...
  UnityEngine_Object__Destroy_71266752(gaugeTweenHeight, 0);
  this->fields.gaugeTweenHeight = 0;
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.gaugeTweenHeight, 0, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( this->fields._BufferPoint_k__BackingField )
  {
    ...
    sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.endCallback, (int32_t)callback, (int32_t)method, v3);
    MainPoint_k__BackingField = this->fields._MainPoint_k__BackingField;
    ...
    sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.gaugeTweenHeight, (int32_t)GaugeAnime, v14, v15);
  }
  else
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( !byte_4C3C921 )
  {
    rootFSOffset = (UnityEngine_Component_o *)sub_1C37058(&UnityEngine_Vector3_TypeInfo);
    byte_4C3C921 = 1;
  }
  if ( !v6
