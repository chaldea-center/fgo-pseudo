void __fastcall ReprintStageMaster___ctor(ReprintStageMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4BFDDB3 & 1) == 0 )
  {
    sub_1C2E12C(&Method_DataMasterBase_ReprintStageMaster__ReprintStageEntity__string___ctor__, method);
    byte_4BFDDB3 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    308,
    (const MethodInfo_327D914 *)Method_DataMasterBase_ReprintStageMaster__ReprintStageEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFDDB1 & 1) == 0 )
  {
    sub_1C2E12C(&Method_DataMasterBase_ReprintStageMaster__ReprintStageEntity__string__GetEntity__, *(_QWORD *)&questId);
    byte_4BFDDB1 = 1;
  }
  ...
  return (ReprintStageEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                   (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                   PK,
                                   (const MethodInfo_327FC38 *)Method_DataMasterBase_ReprintStageMaster__ReprintStageEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFDDB4 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&System_Collections_Generic_IEnumerator_ReprintStageEntity__TypeInfo, v8);
    sub_1C2E12C(&System_Collections_IEnumerator_TypeInfo, v9);
    sub_1C2E12C(&Method_System_Collections_Generic_List_ReprintStageEntity__Add__, v10);
    sub_1C2E12C(&Method_System_Collections_Generic_List_ReprintStageEntity___ctor__, v11);
    sub_1C2E12C(&System_Collections_Generic_List_ReprintStageEntity__TypeInfo, v12);
    byte_4BFDDB4 = 1;
  }
  v13 = (System_Collections_Generic_List_object__o *)sub_1C2E378(System_Collections_Generic_List_ReprintStageEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v13,
    (const MethodInfo_366B078 *)Method_System_Collections_Generic_List_ReprintStageEntity___ctor__);
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
    sub_1C2E388(0LL, v14);
  Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                 list,
                 (const MethodInfo_3216144 *)Method_System_Collections_ObjectModel_Collection_ReprintStageEntity__GetEnumerator__);
  if ( !Enumerator )
    sub_1C2E388(0LL, v16);
  while ( 1 )
  {
...
LABEL_9:
    ...
    {
LABEL_16:
      v25 = sub_1C8010C(Enumerator, System_Collections_Generic_IEnumerator_ReprintStageEntity__TypeInfo, 0LL);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFDDB2 & 1) == 0 )
  {
    sub_1C2E12C(&Method_DataMasterBase_ReprintStageMaster__ReprintStageEntity__string__TryGetEntity__, entity);
    byte_4BFDDB2 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_327FC84 *)Method_DataMasterBase_ReprintStageMaster__ReprintStageEntity__string__TryGetEntity__);
}