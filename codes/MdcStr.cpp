        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2D6DC & 1) == 0 )
  {
    sub_1B761C0(&ICSharpCode_SharpZipLib_BZip2_BZip2InputStream_TypeInfo, *(_QWORD *)&eorData);
    sub_1B761C0(&byte___TypeInfo, v7);
    sub_1B761C0(&System_Convert_TypeInfo, v8);
    sub_1B761C0(&Crc32_TypeInfo, v9);
    sub_1B761C0(&System_Security_Cryptography_CryptoStream_TypeInfo, v10);
    sub_1B761C0(&System_IDisposable_TypeInfo, v11);
    sub_1B761C0(&System_IO_MemoryStream_TypeInfo, v12);
    sub_1B761C0(&NetworkManager_TypeInfo, v13);
    sub_1B761C0(&Method_System_Nullable_uint__get_HasValue__, v14);
    sub_1B761C0(&Method_System_Nullable_uint__get_Value__, v15);
    sub_1B761C0(&System_Security_Cryptography_TripleDESCryptoServiceProvider_TypeInfo, v16);
    byte_4A2D6DC = 1;
  }
  ...
  if ( !v19 )
  {
    ...
    if ( v21 != System_Nullable_uint___get_Value(
                  v82,
                  (const MethodInfo_35F7A08 *)Method_System_Nullable_uint__get_Value__) )
    {
      v77 = sub_1B761D4(&System_IO_IOException_TypeInfo);
      v78 = (System_IO_IOException_o *)sub_1B7640C(v77);
      v79 = (System_String_o *)sub_1B761D4(&StringLiteral_8941/*"MdcStr:Dc Crc Error"*/);
      System_IO_IOException___ctor_61675304(v78, v79, 0LL);
      v80 = sub_1B761D4(&Method_MdcStr_Dc__);
      sub_1B762E8(v78, v80);
    }
  }
  if ( eorData )
  {
    Mk = (_DWORD *)sub_1B76268(byte___TypeInfo, 4LL);
    if ( !Mk )
      goto LABEL_70;
    v24 = Mk[6];
    if ( !v24 )
...
LABEL_21:
  ...
  v32 = (System_Security_Cryptography_TripleDESCryptoServiceProvider_o *)sub_1B7640C(System_Security_Cryptography_TripleDESCryptoServiceProvider_TypeInfo);
  System_Security_Cryptography_TripleDESCryptoServiceProvider___ctor(v32, 0LL);
  v33 = (System_IO_MemoryStream_o *)sub_1B7640C(System_IO_MemoryStream_TypeInfo);
  ...
  v37 = (System_Security_Cryptography_CryptoStream_o *)sub_1B7640C(System_Security_Cryptography_CryptoStream_TypeInfo);
  ...
  {
LABEL_32:
    v43 = sub_1BC81A0(v37, System_IDisposable_TypeInfo, 0LL);
  }
...
LABEL_39:
  ...
  v51 = (System_IO_MemoryStream_o *)sub_1B7640C(System_IO_MemoryStream_TypeInfo);
  System_IO_MemoryStream___ctor(v51, 0LL);
  v52 = (System_IO_MemoryStream_o *)sub_1B7640C(System_IO_MemoryStream_TypeInfo);
  System_IO_MemoryStream___ctor_61679072(v52, v46, 0LL);
  v53 = (ICSharpCode_SharpZipLib_BZip2_BZip2InputStream_o *)sub_1B7640C(ICSharpCode_SharpZipLib_BZip2_BZip2InputStream_TypeInfo);
  ICSharpCode_SharpZipLib_BZip2_BZip2InputStream___ctor(v53, (System_IO_Stream_o *)v52, 0LL);
  v54 = sub_1B76268(byte___TypeInfo, 0x4000LL);
  v56 = v54;
  if ( !v54 )
    sub_1B7641C(0LL, v55);
  if ( !v53 )
  ...
  {
LABEL_50:
    v62 = sub_1BC81A0(v53, System_IDisposable_TypeInfo, 0LL);
  }
  ...
  {
LABEL_57:
    v68 = sub_1BC81A0(v52, System_IDisposable_TypeInfo, 0LL);
  }
  ...
  {
LABEL_64:
    v75 = sub_1BC81A0(v51, System_IDisposable_TypeInfo, 0LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2D6DB & 1) == 0 )
  {
    sub_1B761C0(&ICSharpCode_SharpZipLib_BZip2_BZip2OutputStream_TypeInfo, str);
    sub_1B761C0(&byte___TypeInfo, v7);
    sub_1B761C0(&System_Convert_TypeInfo, v8);
    sub_1B761C0(&Crc32_TypeInfo, v9);
    sub_1B761C0(&System_Security_Cryptography_CryptoStream_TypeInfo, v10);
    ...
    sub_1B761C0(&System_IO_MemoryStream_TypeInfo, v12);
    sub_1B761C0(&NetworkManager_TypeInfo, v13);
    sub_1B761C0(&Method_System_Nullable_uint___ctor__, v14);
    sub_1B761C0(&Method_System_Nullable_uint__get_HasValue__, v15);
    sub_1B761C0(&System_Security_Cryptography_TripleDESCryptoServiceProvider_TypeInfo, v16);
    byte_4A2D6DB = 1;
  }
  ...
  v25 = (System_Security_Cryptography_TripleDESCryptoServiceProvider_o *)sub_1B7640C(System_Security_Cryptography_TripleDESCryptoServiceProvider_TypeInfo);
  System_Security_Cryptography_TripleDESCryptoServiceProvider___ctor(v25, 0LL);
  v26 = (System_IO_MemoryStream_o *)sub_1B7640C(System_IO_MemoryStream_TypeInfo);
  ...
  v30 = (System_Security_Cryptography_CryptoStream_o *)sub_1B7640C(System_Security_Cryptography_CryptoStream_TypeInfo);
  System_Security_Cryptography_CryptoStream___ctor(v30, (System_IO_Stream_o *)v26, v29, 1, 0LL);
  v31 = (ICSharpCode_SharpZipLib_BZip2_BZip2OutputStream_o *)sub_1B7640C(ICSharpCode_SharpZipLib_BZip2_BZip2OutputStream_TypeInfo);
  ...
  {
LABEL_15:
    v37 = sub_1BC81A0(v31, System_IDisposable_TypeInfo, 0LL);
  }
  ...
  {
LABEL_22:
    v43 = sub_1BC81A0(v30, System_IDisposable_TypeInfo, 0LL);
  }
  v44 = (*(__int64 (__fastcall **)(System_Security_Cryptography_CryptoStream_o *, _QWORD))v43)(
          v30,
          *(_QWORD *)(v43 + 8));
  ...
  {
LABEL_29:
    v50 = sub_1BC81A0(v26, System_IDisposable_TypeInfo, 0LL);
  }
  (*(void (__fastcall **)(System_IO_MemoryStream_o *, _QWORD))v50)(v26, *(_QWORD *)(v50 + 8));
  if ( !eorData )
    goto LABEL_43;
  UTF8 = (unsigned int *)sub_1B76268(byte___TypeInfo, 4LL);
  if ( !UTF8 )
    goto LABEL_51;
  v51 = UTF8[6];
  if ( !v51 )
...
LABEL_43:
  if ( crc->fields.hasValue )
  {
    ...
    v56 = 0LL;
    System_Nullable_uint____ctor(v57, v54, (const MethodInfo_35F79F0 *)Method_System_Nullable_uint___ctor__);
    *crc = v56;
  }
  if ( !System_Convert_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Convert_TypeInfo);
