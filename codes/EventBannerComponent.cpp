void __fastcall EventBannerComponent___ctor(EventBannerComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.bannerList, (int32_t)v4, v5, v6);
...
void __fastcall EventBannerComponent__SetBanner(EventBannerComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1EF61 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponent_BannerComponent___, v3);
    ...
    if ( max_length >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( v12->fields.bannerId >= 1 )
        {
          ...
          if ( !byte_4A1A756 )
          {
            Instance = sub_1B715CC(&UnityEngine_Vector3_TypeInfo, v7);
            byte_4A1A756 = 1;
          }
          if ( !v16 )
            break;
