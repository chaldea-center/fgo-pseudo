void __fastcall EventBannerComponent___ctor(EventBannerComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.bannerList, (int32_t)v4, v5, v6);
...
void __fastcall EventBannerComponent__SetBanner(EventBannerComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FD9AA & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_UnityEngine_GameObject_GetComponent_BannerComponent___, v3);
    ...
    if ( max_length >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( v12->fields.bannerId >= 1 )
        {
          ...
          if ( !byte_49F9206 )
          {
            Instance = sub_1B64870(&UnityEngine_Vector3_TypeInfo, v7);
            byte_49F9206 = 1;
          }
          if ( !v16 )
            break;
