...
{
  EasingObject__Play_47611676(this, 0.0, 1.0, sec, procAct, endAct, delay, easingType, method);
}


void __fastcall EasingObject__Play_47611676(
        EasingObject_o *this,
        float from,
        float to,
        float sec,
        ...
        const MethodInfo *method)
{
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.mEndAct, (int64_t)endAct, v16, v17, v18, v19, v20, v21);
  this->fields.mProcessAct = procAct;
  p_mProcessAct = &this->fields.mProcessAct;
  *((float *)p_mProcessAct - 6) = from;
  sub_1C13CC8((PartyOrganizationUtility_o *)p_mProcessAct, (int64_t)procAct, v23, v24, v25, v26, v27, v28);
  v29 = *p_mProcessAct;
  ...
  if ( this->fields._IsMoving_k__BackingField && !this->fields._IsPause_k__BackingField )
  {
          ...
          (float)(mStartTime + mDelay) <= UnityEngine_Time__get_time(0LL)) )
    {
      ...
      if ( this->fields.mIsSkip )
        ...
        v10 = v7;
      v11 = Easing__Func_47610500(this->fields.mFrom, this->fields.mTo, v10, this->fields.mEasingType, v5);
