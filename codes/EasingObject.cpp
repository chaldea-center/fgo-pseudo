...
{
  EasingObject__Play_33961128(this, 0.0, 1.0, sec, procAct, endAct, delay, easingType, method);
}


void __fastcall EasingObject__Play_33961128(
        EasingObject_o *this,
        float from,
        float to,
        float sec,
        ...
        const MethodInfo *method)
{
  ...
  *((float *)p_mEndAct - 5) = from;
  sub_B5D560((BattleServantConfConponent_o *)p_mEndAct, (System_Int32_array **)procAct, v23, v24, v25, v26, v27, v28);
    ...
    if ( !LOBYTE(this->fields.mEasingType) )
    {
            ...
            (float)(mTime + v4) <= UnityEngine_Time__get_time(0LL)) )
      {
        ...
        if ( BYTE4(this[1].klass) )
          ...
          v8 = v7;
        v9 = Easing__Func_33951568(this->fields.mTo, this->fields.mNow, v8, (int32_t)this[1].klass, v6);
