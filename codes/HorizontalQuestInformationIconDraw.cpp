void __fastcall HorizontalQuestInformationIconDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C1EDE2 & 1) == 0 )
  {
    sub_1C3B764(&HorizontalQuestInformationIconDraw_TypeInfo, v1);
    sub_1C3B764(&LocalizationManager_TypeInfo, v8);
    sub_1C3B764(&StringLiteral_19402/*"getDeviceID"*/, v9);
    sub_1C3B764(&StringLiteral_23195/*"status_last_color"*/, v10);
    sub_1C3B764(&StringLiteral_15432/*"XmlResolver"*/, v11);
    sub_1C3B764(&StringLiteral_6168/*"Exception properties"*/, v12);
    sub_1C3B764(&StringLiteral_13666/*"The element name '{0}' does not match the name '{1}' of the 'XmlSchemaElement' set as a partial validation type."*/, v13);
    byte_4C1EDE2 = 1;
  }
  HorizontalQuestInformationIconDraw_TypeInfo->static_fields->ENEMY_UNKNOWN_SP = (struct System_String_o *)StringLiteral_23195/*"status_last_color"*/;
  sub_1C3B708(
    (PartyOrganizationUtility_o *)HorizontalQuestInformationIconDraw_TypeInfo->static_fields,
    StringLiteral_23195/*"status_last_color"*/,
    v2,
    v3,
    v4,
    v5,
  ...
  v14 = LocalizationManager__Get((System_String_o *)StringLiteral_13666/*"The element name '{0}' does not match the name '{1}' of the 'XmlSchemaElement' set as a partial validation type."*/, 0LL);
  ...
  HorizontalQuestInformationIconDraw_TypeInfo->static_fields->SHADOW_COLOR = (struct UnityEngine_Color_o)xmmword_C0CBC0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1EDDF & 1) == 0 )
  {
    sub_1C3B764(&AssetManager_TypeInfo, item);
    sub_1C3B764(&HorizontalQuestInformationIconDraw_TypeInfo, v7);
    ...
    sub_1C3B764(&Method_HorizontalQuestInformationIconDraw___c__DisplayClass22_0__LoadEnemyTexture_b__0__, v11);
    sub_1C3B764(&HorizontalQuestInformationIconDraw___c__DisplayClass22_0_TypeInfo, v12);
    byte_4C1EDDF = 1;
  }
  v13 = sub_1C3B9B0(HorizontalQuestInformationIconDraw___c__DisplayClass22_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1EDE0 & 1) == 0 )
  {
    ...
    sub_1C3B764(&HorizontalQuestInformationIconDraw_TypeInfo, v3);
    byte_4C1EDE0 = 1;
  }
  p_enemyIconName = &this->fields.enemyIconName;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1EDDC & 1) == 0 )
  {
    sub_1C3B764(&HorizontalQuestInformationIconDraw_TypeInfo, *(_QWORD *)&dispTp);
    this = (HorizontalQuestInformationIconDraw_o *)sub_1C3B764(&UnityEngine_Material_TypeInfo, v8);
    byte_4C1EDDC = 1;
  }
  switch ( dispTp )
  {
    case 3:
      if ( sp )
      {
        ...
        if ( iconListComponent )
        {
          ...
          v14 = (UnityEngine_Material_o *)sub_1C3B9B0(UnityEngine_Material_TypeInfo);
          UnityEngine_Material___ctor_70986020(v14, v13, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1EDDE & 1) == 0 )
  {
    this = (HorizontalQuestInformationIconDraw_o *)sub_1C3B764(
...
// local variable allocation has failed, the output may be wrong!
void __fastcall HorizontalQuestInformationIconDraw__SetDispType_35277396(
        HorizontalQuestInformationIconDraw_o *this,
        int32_t dispTp,
        UITexture_o *texture,
        HorizontalQuestInformationIconListComponent_o *iconListComponent,
        const MethodInfo *method)
{
  ...
  {
    sub_1C3B764(&HorizontalQuestInformationIconDraw_TypeInfo, *(_QWORD *)&dispTp);
    this = (HorizontalQuestInformationIconDraw_o *)sub_1C3B764(&StringLiteral_16579/*"aspectRatio"*/, v8);
    byte_4C1EDDD = 1;
  }
  if ( dispTp == 3 )
  {
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C3B764(&AssetManager_TypeInfo, item);
    sub_1C3B764(&Method_HorizontalQuestInformationIconDraw__SetEnemyName_b__24_0__, v5);
    sub_1C3B764(&AssetLoader_LoadEndDataHandler_TypeInfo, v6);
    this = (HorizontalQuestInformationIconDraw_o *)sub_1C3B764(&ServantAssetLoadManager_TypeInfo, v7);
    byte_4C1EDE1 = 1;
  }
  if ( !item )
    goto LABEL_12;
  ...
  if ( enemyNameEffectId )
  {
    ...
    v10 = (AssetLoader_LoadEndDataHandler_o *)sub_1C3B9B0(AssetLoader_LoadEndDataHandler_TypeInfo);
    AssetLoader_LoadEndDataHandler___ctor(
      v10,
      (Il2CppObject *)v4,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1EDDB & 1) == 0 )
  {
    ...
    sub_1C3B764(&HorizontalQuestInformationIconDraw_TypeInfo, v12);
    ...
    sub_1C3B764(&ServantAssetLoadManager_TypeInfo, v16);
    sub_1C3B764(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v17);
    sub_1C3B764(&TerminalSceneComponent_TypeInfo, v18);
    sub_1C3B764(&Method_HorizontalQuestInformationIconDraw___c__DisplayClass18_0__SetItem_b__0__, v19);
    sub_1C3B764(&HorizontalQuestInformationIconDraw___c__DisplayClass18_0_TypeInfo, v20);
    sub_1C3B764(&StringLiteral_12265/*"Sami, Skolt (Finland)"*/, v21);
    byte_4C1EDDB = 1;
  }
  v22 = sub_1C3B9B0(HorizontalQuestInformationIconDraw___c__DisplayClass18_0_TypeInfo);
  ...
  *(_QWORD *)(v22 + 24) = item;
  ...
  sub_1C3B708((PartyOrganizationUtility_o *)(v22 + 24), (int64_t)item, v32, v33, v34, v35, v36, v37);
  if ( mode )
  {
    v38 = *v31;
    if ( *v31 )
    {
      ...
      if ( infoType == 1 )
      {
        if ( QuestInformationListViewItem__isEnemyUnknown(v38, 0LL) )
        {
          ...
          if ( !byte_4C1CAE3 )
          {
            sub_1C3B764(&TerminalSceneComponent_TypeInfo, v41);
            byte_4C1CAE3 = 1;
          }
          ...
          if ( UnityEngine_Object__op_Inequality(mInstance, 0LL, 0LL) )
          {
            ...
            if ( !byte_4C1CAE3 )
            {
              sub_1C3B764(&TerminalSceneComponent_TypeInfo, v24);
              byte_4C1CAE3 = 1;
            }
...
LABEL_119:
        ...
        if ( (v53 & 1) != 0 )
        {
          ...
          *p_SvtImg = Manager__loadCommandCard;
          ...
          if ( !*v31 )
            goto LABEL_119;
          HorizontalQuestInformationIconDraw__SetDispType_35277396(
      ...
      else if ( !infoType )
      {
        ...
        else
        {
          ...
          if ( !itemIcon )
            goto LABEL_119;
          ItemIconComponent__SetGift_39566180(itemIcon, (int32_t)SvtImg, (*v31)->fields.targetId, -1, 0, 0LL);
          SvtImg = (UnityEngine_Component_o *)this->fields.itemIcon;
          if ( !SvtImg )
            goto LABEL_119;
          SvtImg = (UnityEngine_Component_o *)UnityEngine_Component__get_gameObject(SvtImg, 0LL);
        ...
        if ( !QuestInformationListViewItem__isRewardItem((QuestInformationListViewItem_o *)SvtImg, 0LL) )
          goto LABEL_58;
        SvtImg = (UnityEngine_Component_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
        if ( !SvtImg )
          goto LABEL_119;
...
LABEL_63:
        ...
        else
        {
          ...
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          SvtImg = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12265/*"Sami, Skolt (Finland)"*/, 0LL);
          if ( holdNumTitleLb )
          {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1EDE3 & 1) == 0 )
  {
    ...
    this = (HorizontalQuestInformationIconDraw_o *)sub_1C3B764(&StringLiteral_23174/*"startSession"*/, v7);
    byte_4C1EDE3 = 1;
  }
  if ( !assetData
    || (this = (HorizontalQuestInformationIconDraw_o *)AssetData__GetObject_object__50142412(
                                                         assetData,
        ...
        const MethodInfo *method)
{
  ...
  sub_1C3B708((PartyOrganizationUtility_o *)&_4__this[1], (int64_t)assetData, (int64_t)method, v3, v4, v5, v6, v7);
  ...
  if ( !v17
    ...
    || (Object_object__50142412 = AssetData__GetObject_object__50142412(
        ...
        UnityEngine_Material__SetTexture(
          ...
          0LL),
        (_4__this = (AssetData_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__)) == 0LL) )
  {
LABEL_13:
