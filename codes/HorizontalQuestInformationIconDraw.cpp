void __fastcall HorizontalQuestInformationIconDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BFA5DB & 1) == 0 )
  {
    sub_1C2E12C(&HorizontalQuestInformationIconDraw_TypeInfo, v1);
    sub_1C2E12C(&LocalizationManager_TypeInfo, v8);
    sub_1C2E12C(&StringLiteral_19367/*"enemy_icon_"*/, v9);
    sub_1C2E12C(&StringLiteral_23153/*"questinfo_enemy_brank"*/, v10);
    sub_1C2E12C(&StringLiteral_15404/*"Unlit/Transparent Colored"*/, v11);
    sub_1C2E12C(&StringLiteral_6165/*"Enemys/Icon/"*/, v12);
    sub_1C2E12C(&StringLiteral_13638/*"TRADE_EVENT_BOARD_UNRELEASED_NAME"*/, v13);
    byte_4BFA5DB = 1;
  }
  HorizontalQuestInformationIconDraw_TypeInfo->static_fields->ENEMY_UNKNOWN_SP = (struct System_String_o *)StringLiteral_23153/*"questinfo_enemy_brank"*/;
  sub_1C2E0D0(
    (PartyOrganizationUtility_o *)HorizontalQuestInformationIconDraw_TypeInfo->static_fields,
    StringLiteral_23153/*"questinfo_enemy_brank"*/,
    v2,
    v3,
    v4,
    v5,
  ...
  v14 = LocalizationManager__Get((System_String_o *)StringLiteral_13638/*"TRADE_EVENT_BOARD_UNRELEASED_NAME"*/, 0LL);
  ...
  sub_1C2E0D0(
    ...
    v20,
    v21);
  v22 = StringLiteral_6165/*"Enemys/Icon/"*/;
  v23 = HorizontalQuestInformationIconDraw_TypeInfo->static_fields;
  v23->ENEMY_ICON_TEXTURE_PATH = (struct System_String_o *)StringLiteral_6165/*"Enemys/Icon/"*/;
  sub_1C2E0D0((PartyOrganizationUtility_o *)&v23->ENEMY_ICON_TEXTURE_PATH, v22, v24, v25, v26, v27, v28, v29);
  v30 = StringLiteral_19367/*"enemy_icon_"*/;
  v31 = HorizontalQuestInformationIconDraw_TypeInfo->static_fields;
  v31->ENEMY_ICON_TEXTURE_PREFIX = (struct System_String_o *)StringLiteral_19367/*"enemy_icon_"*/;
  sub_1C2E0D0((PartyOrganizationUtility_o *)&v31->ENEMY_ICON_TEXTURE_PREFIX, v30, v32, v33, v34, v35, v36, v37);
  v38 = HorizontalQuestInformationIconDraw_TypeInfo;
  HorizontalQuestInformationIconDraw_TypeInfo->static_fields->SHADOW_COLOR = (struct UnityEngine_Color_o)xmmword_C05840;
  v39 = StringLiteral_15404/*"Unlit/Transparent Colored"*/;
  v40 = v38->static_fields;
  v40->DEFAULT_SHADER = (struct System_String_o *)StringLiteral_15404/*"Unlit/Transparent Colored"*/;
  sub_1C2E0D0((PartyOrganizationUtility_o *)&v40->DEFAULT_SHADER, v39, v41, v42, v43, v44, v45, v46);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFA5D8 & 1) == 0 )
  {
    sub_1C2E12C(&AssetManager_TypeInfo, item);
    sub_1C2E12C(&HorizontalQuestInformationIconDraw_TypeInfo, v7);
    ...
    sub_1C2E12C(&Method_HorizontalQuestInformationIconDraw___c__DisplayClass22_0__LoadEnemyTexture_b__0__, v11);
    sub_1C2E12C(&HorizontalQuestInformationIconDraw___c__DisplayClass22_0_TypeInfo, v12);
    byte_4BFA5D8 = 1;
  }
  v13 = sub_1C2E378(HorizontalQuestInformationIconDraw___c__DisplayClass22_0_TypeInfo);
  ...
  *(_QWORD *)(v13 + 24) = callback;
  sub_1C2E0D0((PartyOrganizationUtility_o *)(v13 + 24), (int64_t)callback, v22, v23, v24, v25, v26, v27);
  ...
  sub_1C2E0D0((PartyOrganizationUtility_o *)p_enemyIconName, (int64_t)v35, v37, v38, v39, v40, v41, v42);
  v43 = System_String__Concat_63235584(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFA5D9 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&HorizontalQuestInformationIconDraw_TypeInfo, v3);
    byte_4BFA5D9 = 1;
  }
  p_enemyIconName = &this->fields.enemyIconName;
  if ( !System_String__IsNullOrEmpty(this->fields.enemyIconName, 0LL) )
  {
    ...
    v6 = System_String__Concat_63235584(v5->static_fields->ENEMY_ICON_TEXTURE_PATH, *p_enemyIconName, 0LL);
    if ( !AssetManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
    ...
    sub_1C2E0D0(p_enemyIconAssetData, 0LL, v8, v9, v10, v11, v12, v13);
    p_enemyIconAssetData->monitor = 0LL;
    sub_1C2E0D0((PartyOrganizationUtility_o *)p_enemyIconName, 0LL, v14, v15, v16, v17, v18, v19);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFA5D5 & 1) == 0 )
  {
    sub_1C2E12C(&HorizontalQuestInformationIconDraw_TypeInfo, *(_QWORD *)&dispTp);
    this = (HorizontalQuestInformationIconDraw_o *)sub_1C2E12C(&UnityEngine_Material_TypeInfo, v8);
    byte_4BFA5D5 = 1;
  }
  switch ( dispTp )
  {
    case 3:
      if ( sp )
      {
        ...
        if ( iconListComponent )
        {
          ...
          v14 = (UnityEngine_Material_o *)sub_1C2E378(UnityEngine_Material_TypeInfo);
          UnityEngine_Material___ctor_70852992(v14, v13, 0LL);
...
LABEL_17:
      sub_1C2E388(this, *(_QWORD *)&dispTp);
    case 1:
      if ( sp )
      {
        v9 = 1.0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFA5D7 & 1) == 0 )
  {
    this = (HorizontalQuestInformationIconDraw_o *)sub_1C2E12C(
...
// local variable allocation has failed, the output may be wrong!
void __fastcall HorizontalQuestInformationIconDraw__SetDispType_35171724(
        HorizontalQuestInformationIconDraw_o *this,
        int32_t dispTp,
        UITexture_o *texture,
        HorizontalQuestInformationIconListComponent_o *iconListComponent,
        const MethodInfo *method)
{
  ...
  {
    sub_1C2E12C(&HorizontalQuestInformationIconDraw_TypeInfo, *(_QWORD *)&dispTp);
    this = (HorizontalQuestInformationIconDraw_o *)sub_1C2E12C(&StringLiteral_16551/*"_MainTex"*/, v8);
    byte_4BFA5D6 = 1;
  }
  if ( dispTp == 3 )
  {
  ...
  if ( dispTp != 2 )
  {
    ...
    if ( texture )
    {
      ...
      if ( this )
      {
        ...
        if ( v9 )
        {
          if ( !System_String__Equals_63243900(
                  (System_String_o *)v9,
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C2E12C(&AssetManager_TypeInfo, item);
    sub_1C2E12C(&Method_HorizontalQuestInformationIconDraw__SetEnemyName_b__24_0__, v5);
    sub_1C2E12C(&AssetLoader_LoadEndDataHandler_TypeInfo, v6);
    this = (HorizontalQuestInformationIconDraw_o *)sub_1C2E12C(&ServantAssetLoadManager_TypeInfo, v7);
    byte_4BFA5DA = 1;
  }
  if ( !item )
    goto LABEL_12;
  ...
  if ( enemyNameEffectId )
  {
    ...
    v10 = (AssetLoader_LoadEndDataHandler_o *)sub_1C2E378(AssetLoader_LoadEndDataHandler_TypeInfo);
    AssetLoader_LoadEndDataHandler___ctor(
      v10,
      (Il2CppObject *)v4,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFA5D4 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_DataManager_GetMasterData_ItemMaster___, v10);
    sub_1C2E12C(&Method_DataManager_GetMasterData_UserItemMaster___, v11);
    sub_1C2E12C(&HorizontalQuestInformationIconDraw_TypeInfo, v12);
    ...
    sub_1C2E12C(&ServantAssetLoadManager_TypeInfo, v16);
    sub_1C2E12C(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v17);
    sub_1C2E12C(&TerminalSceneComponent_TypeInfo, v18);
    sub_1C2E12C(&Method_HorizontalQuestInformationIconDraw___c__DisplayClass18_0__SetItem_b__0__, v19);
    sub_1C2E12C(&HorizontalQuestInformationIconDraw___c__DisplayClass18_0_TypeInfo, v20);
    sub_1C2E12C(&StringLiteral_12242/*"SHOP_BUY_ITEM_HOLD"*/, v21);
    byte_4BFA5D4 = 1;
  }
  v22 = sub_1C2E378(HorizontalQuestInformationIconDraw___c__DisplayClass18_0_TypeInfo);
  ...
  *(_QWORD *)(v22 + 24) = item;
  ...
  sub_1C2E0D0((PartyOrganizationUtility_o *)(v22 + 24), (int64_t)item, v32, v33, v34, v35, v36, v37);
  if ( mode )
  {
    v38 = *v31;
    if ( *v31 )
    {
      ...
      if ( infoType == 1 )
      {
        if ( QuestInformationListViewItem__isEnemyUnknown(v38, 0LL) )
        {
          ...
          if ( !byte_4BF8363 )
          {
            sub_1C2E12C(&TerminalSceneComponent_TypeInfo, v41);
            byte_4BF8363 = 1;
          }
...
LABEL_119:
        ...
        if ( (v53 & 1) != 0 )
        {
          ...
          *p_SvtImg = Manager__loadCommandCard;
          ...
          if ( !*v31 )
            goto LABEL_119;
          HorizontalQuestInformationIconDraw__SetDispType_35171724(
      ...
      else if ( !infoType )
      {
        ...
        else
        {
          ...
          if ( !itemIcon )
            goto LABEL_119;
          ItemIconComponent__SetGift_39457192(itemIcon, (int32_t)SvtImg, (*v31)->fields.targetId, -1, 0, 0LL);
          SvtImg = (UnityEngine_Component_o *)this->fields.itemIcon;
          if ( !SvtImg )
            goto LABEL_119;
          SvtImg = (UnityEngine_Component_o *)UnityEngine_Component__get_gameObject(SvtImg, 0LL);
        ...
        if ( !QuestInformationListViewItem__isRewardItem((QuestInformationListViewItem_o *)SvtImg, 0LL) )
          goto LABEL_58;
        SvtImg = (UnityEngine_Component_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38A7F90 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
        if ( !SvtImg )
          goto LABEL_119;
...
LABEL_63:
        ...
        else
        {
          ...
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          SvtImg = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12242/*"SHOP_BUY_ITEM_HOLD"*/, 0LL);
          if ( holdNumTitleLb )
          {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFA5DC & 1) == 0 )
  {
    ...
    this = (HorizontalQuestInformationIconDraw_o *)sub_1C2E12C(&StringLiteral_23132/*"quest_info"*/, v7);
    byte_4BFA5DC = 1;
  }
  if ( !assetData
    || (this = (HorizontalQuestInformationIconDraw_o *)AssetData__GetObject_object__50017172(
                                                         assetData,
                                                         (System_String_o *)StringLiteral_23132/*"quest_info"*/,
  ...
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  UnityEngine_Object__Instantiate_object__50692032(
    v9,
    transform,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFA5DD & 1) == 0 )
  {
    ...
    sub_1C2E12C(&StringLiteral_16817/*"_alpha"*/, v12);
  ...
  sub_1C2E0D0((PartyOrganizationUtility_o *)&_4__this[1], (int64_t)assetData, (int64_t)method, v3, v4, v5, v6, v7);
  ...
  if ( !_4__this )
    goto LABEL_13;
  _4__this = (AssetData_o *)AssetData__GetObject_object__50017172(
                              _4__this,
  ...
  if ( !v17
    ...
    || (enemyIconAssetData = v20->fields.enemyIconAssetData,
        _4__this = (AssetData_o *)System_String__Concat_63235584(
    ...
    || (Object_object__50017172 = AssetData__GetObject_object__50017172(
        ...
        UnityEngine_Material__SetTexture(
          ...
          0LL),
        (_4__this = (AssetData_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38A7F90 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__)) == 0LL) )
  {
LABEL_13:
