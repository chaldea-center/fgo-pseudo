void __fastcall HorizontalQuestInformationIconDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48DF8CD & 1) == 0 )
  {
    sub_1B00CCC(&HorizontalQuestInformationIconDraw_TypeInfo, v1);
    sub_1B00CCC(&LocalizationManager_TypeInfo, v4);
    sub_1B00CCC(&StringLiteral_18775/*"enemy_icon_"*/, v5);
    sub_1B00CCC(&StringLiteral_22412/*"questinfo_enemy_brank"*/, v6);
    sub_1B00CCC(&StringLiteral_14904/*"Unlit/Transparent Colored"*/, v7);
    sub_1B00CCC(&StringLiteral_5950/*"Enemys/Icon/"*/, v8);
    sub_1B00CCC(&StringLiteral_13150/*"TRADE_EVENT_BOARD_UNRELEASED_NAME"*/, v9);
    byte_48DF8CD = 1;
  }
  HorizontalQuestInformationIconDraw_TypeInfo->static_fields->ENEMY_UNKNOWN_SP = (struct System_String_o *)StringLiteral_22412/*"questinfo_enemy_brank"*/;
  sub_1B00C70(
    (ServantStatusBattleListViewItem_o *)HorizontalQuestInformationIconDraw_TypeInfo->static_fields,
    StringLiteral_22412/*"questinfo_enemy_brank"*/,
    v2,
    v3);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v10 = LocalizationManager__Get((System_String_o *)StringLiteral_13150/*"TRADE_EVENT_BOARD_UNRELEASED_NAME"*/, 0LL);
  static_fields = HorizontalQuestInformationIconDraw_TypeInfo->static_fields;
  static_fields->ENEMY_UNKNOWN_NAME = v10;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&static_fields->ENEMY_UNKNOWN_NAME, (int32_t)v10, v12, v13);
  v14 = StringLiteral_5950/*"Enemys/Icon/"*/;
  v15 = HorizontalQuestInformationIconDraw_TypeInfo->static_fields;
  v15->ENEMY_ICON_TEXTURE_PATH = (struct System_String_o *)StringLiteral_5950/*"Enemys/Icon/"*/;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&v15->ENEMY_ICON_TEXTURE_PATH, v14, v16, v17);
  v18 = StringLiteral_18775/*"enemy_icon_"*/;
  v19 = HorizontalQuestInformationIconDraw_TypeInfo->static_fields;
  v19->ENEMY_ICON_TEXTURE_PREFIX = (struct System_String_o *)StringLiteral_18775/*"enemy_icon_"*/;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&v19->ENEMY_ICON_TEXTURE_PREFIX, v18, v20, v21);
  v22 = HorizontalQuestInformationIconDraw_TypeInfo;
  HorizontalQuestInformationIconDraw_TypeInfo->static_fields->SHADOW_COLOR = (struct UnityEngine_Color_o)xmmword_B70090;
  v23 = StringLiteral_14904/*"Unlit/Transparent Colored"*/;
  v24 = v22->static_fields;
  v24->DEFAULT_SHADER = (struct System_String_o *)StringLiteral_14904/*"Unlit/Transparent Colored"*/;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&v24->DEFAULT_SHADER, v23, v25, v26);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DF8CA & 1) == 0 )
  {
    sub_1B00CCC(&AssetManager_TypeInfo, item);
    sub_1B00CCC(&HorizontalQuestInformationIconDraw_TypeInfo, v7);
    ...
    sub_1B00CCC(&Method_HorizontalQuestInformationIconDraw___c__DisplayClass22_0__LoadEnemyTexture_b__0__, v11);
    sub_1B00CCC(&HorizontalQuestInformationIconDraw___c__DisplayClass22_0_TypeInfo, v12);
    byte_48DF8CA = 1;
  }
  v13 = sub_1B00F18(HorizontalQuestInformationIconDraw___c__DisplayClass22_0_TypeInfo);
  ...
  *(_QWORD *)(v13 + 24) = callback;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)(v13 + 24), (int32_t)callback, v18, v19);
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)p_enemyIconName, (int32_t)v27, v29, v30);
  v31 = System_String__Concat_60325748(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DF8CB & 1) == 0 )
  {
    ...
    sub_1B00CCC(&HorizontalQuestInformationIconDraw_TypeInfo, v3);
    byte_48DF8CB = 1;
  }
  p_enemyIconName = &this->fields.enemyIconName;
  if ( !System_String__IsNullOrEmpty(this->fields.enemyIconName, 0LL) )
  {
    ...
    v6 = System_String__Concat_60325748(v5->static_fields->ENEMY_ICON_TEXTURE_PATH, *p_enemyIconName, 0LL);
    if ( !AssetManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
    ...
    sub_1B00C70(p_enemyIconAssetData, 0, v8, v9);
    p_enemyIconAssetData->monitor = 0LL;
    sub_1B00C70((ServantStatusBattleListViewItem_o *)p_enemyIconName, 0, v10, v11);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DF8C7 & 1) == 0 )
  {
    sub_1B00CCC(&HorizontalQuestInformationIconDraw_TypeInfo, *(_QWORD *)&dispTp);
    this = (HorizontalQuestInformationIconDraw_o *)sub_1B00CCC(&UnityEngine_Material_TypeInfo, v8);
    byte_48DF8C7 = 1;
  }
  switch ( dispTp )
  {
    case 3:
      if ( sp )
      {
        ...
        if ( iconListComponent )
        {
          ...
          v14 = (UnityEngine_Material_o *)sub_1B00F18(UnityEngine_Material_TypeInfo);
          UnityEngine_Material___ctor_67941016(v14, v13, 0LL);
...
LABEL_17:
      sub_1B00F28(this, *(_QWORD *)&dispTp);
    case 1:
      if ( sp )
      {
        v9 = 1.0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DF8C9 & 1) == 0 )
  {
    this = (HorizontalQuestInformationIconDraw_o *)sub_1B00CCC(
...
// local variable allocation has failed, the output may be wrong!
void __fastcall HorizontalQuestInformationIconDraw__SetDispType_32825012(
        HorizontalQuestInformationIconDraw_o *this,
        int32_t dispTp,
        UITexture_o *texture,
        HorizontalQuestInformationIconListComponent_o *iconListComponent,
        const MethodInfo *method)
{
  ...
  {
    sub_1B00CCC(&HorizontalQuestInformationIconDraw_TypeInfo, *(_QWORD *)&dispTp);
    this = (HorizontalQuestInformationIconDraw_o *)sub_1B00CCC(&StringLiteral_16030/*"_MainTex"*/, v8);
    byte_48DF8C8 = 1;
  }
  if ( dispTp == 3 )
  {
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B00CCC(&AssetManager_TypeInfo, item);
    sub_1B00CCC(&Method_HorizontalQuestInformationIconDraw__SetEnemyName_b__24_0__, v5);
    sub_1B00CCC(&AssetLoader_LoadEndDataHandler_TypeInfo, v6);
    this = (HorizontalQuestInformationIconDraw_o *)sub_1B00CCC(&ServantAssetLoadManager_TypeInfo, v7);
    byte_48DF8CC = 1;
  }
  if ( !item )
    goto LABEL_12;
  ...
  if ( enemyNameEffectId )
  {
    ...
    v10 = (AssetLoader_LoadEndDataHandler_o *)sub_1B00F18(AssetLoader_LoadEndDataHandler_TypeInfo);
    AssetLoader_LoadEndDataHandler___ctor(
      v10,
      (Il2CppObject *)v4,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DF8C6 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&HorizontalQuestInformationIconDraw_TypeInfo, v12);
    ...
    sub_1B00CCC(&ServantAssetLoadManager_TypeInfo, v16);
    sub_1B00CCC(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v17);
    sub_1B00CCC(&TerminalSceneComponent_TypeInfo, v18);
    sub_1B00CCC(&Method_HorizontalQuestInformationIconDraw___c__DisplayClass18_0__SetItem_b__0__, v19);
    sub_1B00CCC(&HorizontalQuestInformationIconDraw___c__DisplayClass18_0_TypeInfo, v20);
    sub_1B00CCC(&StringLiteral_11821/*"SHOP_BUY_ITEM_HOLD"*/, v21);
    byte_48DF8C6 = 1;
  }
  v22 = sub_1B00F18(HorizontalQuestInformationIconDraw___c__DisplayClass18_0_TypeInfo);
  ...
  *(_QWORD *)(v22 + 24) = item;
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)(v22 + 24), (int32_t)item, v28, v29);
  if ( mode )
  {
    v30 = *v27;
    if ( *v27 )
    {
      ...
      if ( infoType == 1 )
      {
        if ( QuestInformationListViewItem__isEnemyUnknown(v30, 0LL) )
        {
          ...
          if ( !byte_48DDF7C )
          {
            sub_1B00CCC(&TerminalSceneComponent_TypeInfo, v33);
            byte_48DDF7C = 1;
          }
          ...
          if ( UnityEngine_Object__op_Inequality(mInstance, 0LL, 0LL) )
          {
            ...
            if ( !byte_48DDF7C )
            {
              sub_1B00CCC(&TerminalSceneComponent_TypeInfo, v24);
              byte_48DDF7C = 1;
            }
...
LABEL_115:
        ...
        if ( (v45 & 1) != 0 )
        {
          ...
          *p_SvtImg = Manager__loadCommandCard;
          ...
          if ( !*v27 )
            goto LABEL_115;
          HorizontalQuestInformationIconDraw__SetDispType_32825012(
      ...
      else if ( !infoType )
      {
        ...
        else
        {
          ...
          if ( !itemIcon )
            goto LABEL_115;
          ItemIconComponent__SetGift(itemIcon, SvtImg, (*v27)->fields.targetId, -1, 0, 0LL);
          SvtImg = (int64_t)this->fields.itemIcon;
          if ( !SvtImg )
            goto LABEL_115;
          SvtImg = (int64_t)UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)SvtImg, 0LL);
        ...
        if ( !QuestInformationListViewItem__isRewardItem((QuestInformationListViewItem_o *)SvtImg, 0LL) )
          goto LABEL_58;
        SvtImg = (int64_t)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_35FBBF0 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
        if ( !SvtImg )
          goto LABEL_115;
...
LABEL_63:
        ...
        else
        {
          ...
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          SvtImg = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_11821/*"SHOP_BUY_ITEM_HOLD"*/, 0LL);
          if ( holdNumTitleLb )
          {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DF8CE & 1) == 0 )
  {
    ...
    this = (HorizontalQuestInformationIconDraw_o *)sub_1B00CCC(&StringLiteral_22392/*"quest_info"*/, v7);
    byte_48DF8CE = 1;
  }
  if ( !assetData
    || (this = (HorizontalQuestInformationIconDraw_o *)AssetData__GetObject_object__47470892(
                                                         assetData,
                                                         (System_String_o *)StringLiteral_22392/*"quest_info"*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DF8D4 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&UnityEngine_Material_TypeInfo, v6);
    sub_1B00CCC(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v7);
    sub_1B00CCC(&StringLiteral_16292/*"_alpha"*/, v8);
    sub_1B00CCC(&StringLiteral_4921/*"Custom/SpriteWithMask"*/, v9);
    sub_1B00CCC(&StringLiteral_16035/*"_MaskTex"*/, v10);
    byte_48DF8D4 = 1;
  }
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&_4__this[1], (int32_t)assetData, (int32_t)method, v3);
  ...
  if ( !_4__this )
    goto LABEL_13;
  _4__this = (AssetData_o *)AssetData__GetObject_object__47470892(
                              _4__this,
  ...
  if ( !v13
    ...
    || (enemyIconAssetData = v16->fields.enemyIconAssetData,
        _4__this = (AssetData_o *)System_String__Concat_60325748(
                                    v16->fields.enemyIconName,
                                    (System_String_o *)StringLiteral_16292/*"_alpha"*/,
                                    0LL),
        !enemyIconAssetData)
    || (Object_object__47470892 = AssetData__GetObject_object__47470892(
        ...
        UnityEngine_Material__SetTexture(
          ...
          0LL),
        (_4__this = (AssetData_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_35FBBF0 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__)) == 0LL) )
  {
LABEL_13:
