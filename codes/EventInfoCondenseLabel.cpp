void __fastcall EventInfoCondenseLabel___ctor(EventInfoCondenseLabel_o *this, const MethodInfo *method)
{
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.beforeText, v5, v2, v3);
  ...
  if ( ((unsigned __int8)v4 & 1) != 0 && this->fields.condensedWidth >= 1 )
  {
    ...
    if ( !v7
      || (mText = v7->fields.mText,
          ...
          sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.beforeText, (int32_t)mText, v5, v6),
...
void __fastcall EventInfoCondenseLabel__Start(EventInfoCondenseLabel_o *this, const MethodInfo *method)
{
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.label, (int32_t)Component_object, v5, v6);
...
void __fastcall EventInfoCondenseLabel__Update(EventInfoCondenseLabel_o *this, const MethodInfo *method)
{
  ...
  if ( v4 )
  {
    ...
    if ( !v5 )
      sub_1B64324(v4);
    if ( System_String__op_Inequality(this->fields.beforeText, v5->fields.mText, 0LL) )
