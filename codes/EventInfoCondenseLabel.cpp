void __fastcall EventInfoCondenseLabel___ctor(EventInfoCondenseLabel_o *this, const MethodInfo *method)
{
  ...
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.beforeText, (int64_t)v9, v2, v3, v4, v5, v6, v7);
  ...
  if ( ((unsigned __int8)v4 & 1) != 0 && this->fields.condensedWidth >= 1 )
  {
    ...
    if ( !v12
      || (mText = v12->fields.mText,
          ...
          sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.beforeText, (int64_t)mText, v6, v7, v8, v9, v10, v11),
...
void __fastcall EventInfoCondenseLabel__Start(EventInfoCondenseLabel_o *this, const MethodInfo *method)
{
  ...
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.label, (int64_t)Component_object, v6, v7, v8, v9, v10, v11);
