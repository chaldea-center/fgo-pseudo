...
int64_t __fastcall MyRoomAddEntity__GetScheduleUpdateAt(MyRoomAddEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4B0243B & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_22975/*"scheduleUpdateAt"*/, method);
    byte_4B0243B = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_22975/*"scheduleUpdateAt"*/, 0, 0LL);
}