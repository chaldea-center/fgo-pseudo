        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2E7BE & 1) == 0 )
  {
    sub_1C94098(&System_Action_ScriptActionAdvPrefabActorGoNextState__TypeInfo);
    sub_1C94098(&Method_UnityEngine_Animator_GetBehaviours_ScriptActionAdvPrefabActorGoNextState___);
    sub_1C94098(&Method_System_Array_ForEach_ScriptActionAdvPrefabActorGoNextState___);
    sub_1C94098(&Method_UnityEngine_Component_GetComponent_Animator___);
    sub_1C94098(&UnityEngine_Object_TypeInfo);
    sub_1C94098(&Method_ScriptActionAdvPrefabActorController__Awake_b__10_0__);
    byte_4D2E7BE = 1;
  }
  ...
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.animator, (int32_t)Component_object, v5, v6, v7, v8, v9, v10);
  ...
  if ( UnityEngine_Object__op_Inequality(animator, 0, 0) )
  {
    ...
    Behaviours_object = UnityEngine_Animator__GetBehaviours_object_(
                          *p_animator,
                          (const MethodInfo_32657F0 *)Method_UnityEngine_Animator_GetBehaviours_ScriptActionAdvPrefabActorGoNextState___);
    v14 = (System_Action_object__o *)sub_1C942E4(System_Action_ScriptActionAdvPrefabActorGoNextState__TypeInfo);
    ...
    System_Array__ForEach_object_(
      ...
      (const MethodInfo_32A4778 *)Method_System_Array_ForEach_ScriptActionAdvPrefabActorGoNextState___);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2E7C5 & 1) == 0 )
  {
    sub_1C94098(&Method_UnityEngine_Component_GetComponentInParent_ScriptActionAdvPrefabController___);
    sub_1C94098(&UnityEngine_Object_TypeInfo);
    byte_4D2E7C5 = 1;
  }
  ComponentInParent_object__51982272 = UnityEngine_Component__GetComponentInParent_object__51982272(
                                         (UnityEngine_Component_o *)this,
                                         (const MethodInfo_3192FC0 *)Method_UnityEngine_Component_GetComponentInParent_ScriptActionAdvPrefabController___);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  v6 = UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)ComponentInParent_object__51982272, 0, 0);
  if ( v6 )
  {
    if ( !ComponentInParent_object__51982272 )
      sub_1C942F0(v6, v7);
    ScriptActionAdvPrefabController__SetHide(
      (ScriptActionAdvPrefabController_o *)ComponentInParent_object__51982272,
      actorName,
      v8);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2E7C2 & 1) == 0 )
  {
    sub_1C94098(&Method_ScriptActionAdvPrefabActorController_PlaySE__);
    byte_4D2E7C2 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_ScriptActionAdvPrefabActorController_PlaySE__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1C940B0(Method_ScriptActionAdvPrefabActorController_PlaySE__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C94098(&UnityEngine_Object_TypeInfo);
    sub_1C94098(&StringLiteral_19921/*"gender"*/);
    byte_4D2E7BF = 1;
  }
  animator = (UnityEngine_Object_o *)this->fields.animator;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  if ( UnityEngine_Object__op_Inequality(animator, 0, 0) )
  {
    ...
    if ( !v7 )
      sub_1C942F0(0, v6);
    UnityEngine_Animator__SetInteger(v7, (System_String_o *)StringLiteral_19921/*"gender"*/, genderType, 0);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !x )
    sub_1C942F0(this, 0);
  x->fields.owner = this;
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&x->fields.owner, (int32_t)this, (int32_t)method, v3, v4, v5, v6, v7);
}
