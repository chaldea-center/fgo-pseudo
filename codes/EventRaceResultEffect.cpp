void __fastcall EventRaceResultEffect___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A1C82B & 1) == 0 )
  {
    sub_1B715CC(&EventRaceResultEffect_TypeInfo, v1);
    sub_1B715CC(&StringLiteral_22697/*"raceresults_team_{0}"*/, v4);
    byte_4A1C82B = 1;
  }
  EventRaceResultEffect_TypeInfo->static_fields->TEAM_NAME_SP_NAME = (struct System_String_o *)StringLiteral_22697/*"raceresults_team_{0}"*/;
  sub_1B71570(
    (ServantStatusBattleListViewItem_o *)EventRaceResultEffect_TypeInfo->static_fields,
    StringLiteral_22697/*"raceresults_team_{0}"*/,
    v2,
    v3);
...
void __fastcall EventRaceResultEffect__Awake(EventRaceResultEffect_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1C823 & 1) == 0 )
  {
    sub_1B715CC(&Method_CStateManager_EventRaceResultEffect___ctor__, method);
    sub_1B715CC(&Method_CStateManager_EventRaceResultEffect__add__, v3);
    sub_1B715CC(&CStateManager_EventRaceResultEffect__TypeInfo, v4);
    sub_1B715CC(&EventRaceResultEffect_StateNone_TypeInfo, v5);
    sub_1B715CC(&EventRaceResultEffect_StatePlay_TypeInfo, v6);
    sub_1B715CC(&EventRaceResultEffect_StateTouchWait_TypeInfo, v7);
    byte_4A1C823 = 1;
  }
  p_mFSM = &this->fields.mFSM;
  if ( !this->fields.mFSM )
  {
    v9 = (CStateManager_T__o *)sub_1B71818(CStateManager_EventRaceResultEffect__TypeInfo);
    CStateManager_object____ctor(
      v9,
      (Il2CppObject *)this,
      3,
      (const MethodInfo_308625C *)Method_CStateManager_EventRaceResultEffect___ctor__);
    this->fields.mFSM = (struct CStateManager_EventRaceResultEffect__o *)v9;
    sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.mFSM, (int32_t)v9, v10, v11);
    mFSM = (CStateManager_T__o *)this->fields.mFSM;
    v13 = (Il2CppObject *)sub_1B71818(EventRaceResultEffect_StateNone_TypeInfo);
    ...
    CStateManager_object___add(
      ...
      0,
      (IState_T__o *)v13,
      (const MethodInfo_3086304 *)Method_CStateManager_EventRaceResultEffect__add__);
    v16 = (CStateManager_T__o *)*p_mFSM;
    v17 = (Il2CppObject *)sub_1B71818(EventRaceResultEffect_StatePlay_TypeInfo);
    ...
    if ( !v16
      || (CStateManager_object___add(
          ...
          v19 = (Il2CppObject *)sub_1B71818(EventRaceResultEffect_StateTouchWait_TypeInfo),
...
int32_t __fastcall EventRaceResultEffect__GetState(EventRaceResultEffect_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1C829 & 1) == 0 )
  {
    this = (EventRaceResultEffect_o *)sub_1B715CC(&Method_CStateManager_EventRaceResultEffect__getState__, method);
    byte_4A1C829 = 1;
  }
  mFSM = v2->fields.mFSM;
  if ( !mFSM )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C827 & 1) == 0 )
  {
    sub_1B715CC(&long_TypeInfo, restDistance);
    sub_1B715CC(&LocalizationManager_TypeInfo, v4);
    sub_1B715CC(&StringLiteral_5652/*"EVENT_RACE_RESULT_PATH_LENGTH"*/, v5);
    byte_4A1C827 = 1;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v6 = LocalizationManager__Get((System_String_o *)StringLiteral_5652/*"EVENT_RACE_RESULT_PATH_LENGTH"*/, 0LL);
  v12 = restDistance;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C826 & 1) == 0 )
  {
    sub_1B715CC(&int_TypeInfo, utime);
    sub_1B715CC(&LocalizationManager_TypeInfo, v4);
    sub_1B715CC(&StringLiteral_5657/*"EVENT_RACE_RESULT_TIME_STR"*/, v5);
    byte_4A1C826 = 1;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  ...
  v7 = (int)utime % 60;
  v8 = utime % 3600 / 60;
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_5657/*"EVENT_RACE_RESULT_TIME_STR"*/, 0LL);
  v25 = v6;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C828 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_EventRaceResultEffect__Play_b__17_0__, v7);
    sub_1B715CC(&Method_EventRaceResultEffect__Play_b__17_1__, v8);
...
void __fastcall EventRaceResultEffect__SetState(EventRaceResultEffect_o *this, int32_t state, const MethodInfo *method)
{
  ...
  if ( (byte_4A1C82A & 1) == 0 )
  {
    sub_1B715CC(&Method_CStateManager_EventRaceResultEffect__setState__, *(_QWORD *)&state);
    byte_4A1C82A = 1;
  }
  mFSM = (CStateManager_T__o *)this->fields.mFSM;
  if ( !mFSM )
  ...
  CStateManager_object___setState(
    mFSM,
    state,
    (const MethodInfo_3086390 *)Method_CStateManager_EventRaceResultEffect__setState__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C825 & 1) == 0 )
  {
    sub_1B715CC(&Method_UnityEngine_Component_GetComponentInChildren_Animation___, *(_QWORD *)&eventId);
    sub_1B715CC(&Method_UnityEngine_Component_GetComponentInChildren_SimpleAnimation___, v11);
    sub_1B715CC(&EventRaceResultEffect_TypeInfo, v12);
    sub_1B715CC(&int_TypeInfo, v13);
    sub_1B715CC(&TerminalSceneComponent_TypeInfo, v14);
    sub_1B715CC(&StringLiteral_10902/*"RACE_TARGET_GOAL_RANK"*/, v15);
    sub_1B715CC(&StringLiteral_3118/*"Back/back{0}"*/, v16);
    byte_4A1C825 = 1;
  }
  ...
  if ( !byte_4A1ACFD )
  {
    sub_1B715CC(&TerminalSceneComponent_TypeInfo, *(_QWORD *)&eventId);
    byte_4A1ACFD = 1;
  }
  ...
  while ( (int)v22 < (signed int)teams->max_length )
  {
    ...
    UIAtlasBySpriteName = (UISprite_o *)ConstantMaster__getValue((System_String_o *)StringLiteral_10902/*"RACE_TARGET_GOAL_RANK"*/, 0LL);
...
LABEL_49:
        sub_1B71830(UIAtlasBySpriteName, *(_QWORD *)&eventId);
  ...
  this->fields.mSimpleAnimation = (struct SimpleAnimation_o *)ComponentInChildren_object__48570608;
  sub_1B71570(
  ...
  if ( !UIAtlasBySpriteName )
    goto LABEL_48;
  v38 = UnityEngine_Component__GetComponentInChildren_object__48570608(
          (UnityEngine_Component_o *)UIAtlasBySpriteName,
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)p_mAnimation, (int32_t)v38, v40, v41);
  ...
  UIAtlasBySpriteName = (UISprite_o *)System_String__Format((System_String_o *)StringLiteral_3118/*"Back/back{0}"*/, v46, 0LL);
  if ( !v42 )
LABEL_48:
    sub_1B71828(UIAtlasBySpriteName, *(_QWORD *)&eventId);
...
void __fastcall EventRaceResultEffect__Update(EventRaceResultEffect_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1C824 & 1) == 0 )
  {
    sub_1B715CC(&Method_CStateManager_EventRaceResultEffect__update__, method);
    byte_4A1C824 = 1;
  }
  mFSM = (CStateManager_T__o *)this->fields.mFSM;
  if ( mFSM )
    CStateManager_object___update(
      mFSM,
      (const MethodInfo_308636C *)Method_CStateManager_EventRaceResultEffect__update__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C82C & 1) == 0 )
  {
    ...
    this = (EventRaceResultEffect_StatePlay_o *)sub_1B715CC(&SimpleAnimation_State_TypeInfo, v5);
    byte_4A1C82C = 1;
  }
  if ( !that )
    goto LABEL_35;
  ...
  if ( ((unsigned __int8)this & 1) == 0 )
  {
    ...
    if ( v19 )
    {
      ...
      if ( this )
      {
        ...
        sub_1B71570(p_mAnimState, (int32_t)Item, v23, v24);
...
LABEL_35:
  ...
  sub_1B71570(p_fields, (int32_t)v9, v11, v12);
  ...
  {
LABEL_15:
    v17 = sub_1BC35AC(p_fields->klass, SimpleAnimation_State_TypeInfo, 6LL);
  }
  ...
  {
LABEL_32:
    v29 = sub_1BC35AC(v25, SimpleAnimation_State_TypeInfo, 8LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C82D & 1) == 0 )
  {
    this = (EventRaceResultEffect_StatePlay_o *)sub_1B715CC(
  ...
  if ( ((unsigned __int8)this & 1) == 0 )
  {
    this = (EventRaceResultEffect_StatePlay_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    if ( !this )
      goto LABEL_16;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C82E & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_EventRaceResultEffect_StateTouchWait_update__, v7);
    sub_1B715CC(&Method_EventRaceResultEffect_StateTouchWait___c__DisplayClass1_0__update_b__0__, v8);
    sub_1B715CC(&EventRaceResultEffect_StateTouchWait___c__DisplayClass1_0_TypeInfo, v9);
    byte_4A1C82E = 1;
  }
  v10 = sub_1B71818(EventRaceResultEffect_StateTouchWait___c__DisplayClass1_0_TypeInfo);
      ...
      if ( isTouchPush )
      {
        ...
        if ( isTouchPush )
        {
          ...
          if ( (*((_BYTE *)Method_EventRaceResultEffect_StateTouchWait_update__ + 83) & 2) != 0 )
            v16 = (_QWORD *)sub_1B715E4(Method_EventRaceResultEffect_StateTouchWait_update__);
