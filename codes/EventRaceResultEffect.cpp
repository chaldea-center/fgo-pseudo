void EventRaceResultEffect___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E01387 & 1) == 0 )
  {
    sub_1CE6700(&EventRaceResultEffect_TypeInfo);
    sub_1CE6700(&StringLiteral_23294/*"raceresults_team_{0}"*/);
    byte_4E01387 = 1;
  }
  EventRaceResultEffect_TypeInfo->static_fields->TEAM_NAME_SP_NAME = (struct System_String_o *)StringLiteral_23294/*"raceresults_team_{0}"*/;
  sub_1CE66A4(
    (GrandQuestFolderBoardItem_o *)EventRaceResultEffect_TypeInfo->static_fields,
    StringLiteral_23294/*"raceresults_team_{0}"*/,
    v1,
    v2,
    v3,
    v4,
...
void EventRaceResultEffect__Awake(EventRaceResultEffect_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E0137F & 1) == 0 )
  {
    sub_1CE6700(&Method_CStateManager_EventRaceResultEffect___ctor__);
    sub_1CE6700(&Method_CStateManager_EventRaceResultEffect__add__);
    sub_1CE6700(&CStateManager_EventRaceResultEffect__TypeInfo);
    sub_1CE6700(&EventRaceResultEffect_StateNone_TypeInfo);
    sub_1CE6700(&EventRaceResultEffect_StatePlay_TypeInfo);
    sub_1CE6700(&EventRaceResultEffect_StateTouchWait_TypeInfo);
    byte_4E0137F = 1;
  }
  p_mFSM = &this->fields.mFSM;
  if ( !this->fields.mFSM )
  {
    v4 = (CStateManager_T__o *)sub_1CE694C(CStateManager_EventRaceResultEffect__TypeInfo);
    CStateManager_object____ctor(
      v4,
      (Il2CppObject *)this,
      3,
      (const MethodInfo_3473510 *)Method_CStateManager_EventRaceResultEffect___ctor__);
    ...
    v12 = (Il2CppObject *)sub_1CE694C(EventRaceResultEffect_StateNone_TypeInfo);
    ...
    CStateManager_object___add(
      ...
      0,
      (IState_T__o *)v12,
      (const MethodInfo_34735B8 *)Method_CStateManager_EventRaceResultEffect__add__);
    v15 = (CStateManager_T__o *)*p_mFSM;
    v16 = (Il2CppObject *)sub_1CE694C(EventRaceResultEffect_StatePlay_TypeInfo);
    ...
    if ( !v15
      || (CStateManager_object___add(
          ...
          v18 = (Il2CppObject *)sub_1CE694C(EventRaceResultEffect_StateTouchWait_TypeInfo),
...
int32_t EventRaceResultEffect__GetState(EventRaceResultEffect_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E01385 & 1) == 0 )
  {
    this = (EventRaceResultEffect_o *)sub_1CE6700(&Method_CStateManager_EventRaceResultEffect__getState__);
    byte_4E01385 = 1;
  }
  mFSM = v2->fields.mFSM;
  if ( !mFSM )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E01383 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_5707/*"EVENT_RACE_RESULT_PATH_LENGTH"*/);
    byte_4E01383 = 1;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_5707/*"EVENT_RACE_RESULT_PATH_LENGTH"*/, 0);
  v7 = restDistance;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E01382 & 1) == 0 )
  {
    ...
    sub_1CE6700(&LocalizationManager_TypeInfo);
    sub_1CE6700(&StringLiteral_5712/*"EVENT_RACE_RESULT_TIME_STR"*/);
    byte_4E01382 = 1;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  ...
  v5 = (int)utime % 60;
  v6 = utime % 3600 / 60;
  v7 = LocalizationManager__Get((System_String_o *)StringLiteral_5712/*"EVENT_RACE_RESULT_TIME_STR"*/, 0);
  v14 = v4;
  ...
  return System_String__Format_65164204(v7, v8, v9, v10, 0);
}
...
void EventRaceResultEffect__Play(EventRaceResultEffect_o *this, System_Action_o *end_act, const MethodInfo *method)
{
  ...
  if ( (byte_4E01384 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_EventRaceResultEffect__Play_b__17_0__);
    sub_1CE6700(&Method_EventRaceResultEffect__Play_b__17_1__);
...
LABEL_33:
  ...
  {
LABEL_15:
    v20 = sub_1CBCA7C(gameObject, SimpleAnimation_State_TypeInfo, 8);
  }
...
void EventRaceResultEffect__SetState(EventRaceResultEffect_o *this, int32_t state, const MethodInfo *method)
{
  ...
  if ( (byte_4E01386 & 1) == 0 )
  {
    sub_1CE6700(&Method_CStateManager_EventRaceResultEffect__setState__);
    byte_4E01386 = 1;
  }
  mFSM = (CStateManager_T__o *)this->fields.mFSM;
  if ( !mFSM )
  ...
  CStateManager_object___setState(
    mFSM,
    state,
    (const MethodInfo_3473644 *)Method_CStateManager_EventRaceResultEffect__setState__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E01381 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_11061/*"RACE_TARGET_GOAL_RANK"*/);
  ...
  while ( (int)v16 < SLODWORD(teams->max_length) )
  {
    ...
    UIAtlasBySpriteName = (UISprite_o *)ConstantMaster__getValue((System_String_o *)StringLiteral_11061/*"RACE_TARGET_GOAL_RANK"*/, 0);
...
LABEL_49:
        sub_1CE6960(UIAtlasBySpriteName);
  ...
  this->fields.mSimpleAnimation = (struct SimpleAnimation_o *)ComponentInChildren_object__52407772;
  sub_1CE66A4(
  ...
  if ( !UIAtlasBySpriteName )
    goto LABEL_48;
  v36 = UnityEngine_Component__GetComponentInChildren_object__52407772(
          (UnityEngine_Component_o *)UIAtlasBySpriteName,
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)p_mAnimation, (int32_t)v36, v38, v39, v40, v41, v42, v43);
  v44 = (ExUITexture_o *)*(p_mAnimation - 7);
  v47 = *((_DWORD *)p_mAnimation - 8);
  v45 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v47);
  UIAtlasBySpriteName = (UISprite_o *)System_String__Format((System_String_o *)StringLiteral_3051/*"Back/back{0}"*/, v45, 0);
  if ( !v44 )
LABEL_48:
    sub_1CE6958(UIAtlasBySpriteName, *(_QWORD *)&eventId);
...
void EventRaceResultEffect__Update(EventRaceResultEffect_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E01380 & 1) == 0 )
  {
    sub_1CE6700(&Method_CStateManager_EventRaceResultEffect__update__);
    byte_4E01380 = 1;
  }
  mFSM = (CStateManager_T__o *)this->fields.mFSM;
  if ( mFSM )
    CStateManager_object___update(
      mFSM,
      (const MethodInfo_3473620 *)Method_CStateManager_EventRaceResultEffect__update__);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&UnityEngine_Object_TypeInfo);
    this = (EventRaceResultEffect_StatePlay_o *)sub_1CE6700(&SimpleAnimation_State_TypeInfo);
    byte_4E01388 = 1;
  }
  if ( !that )
    goto LABEL_35;
  ...
  if ( ((unsigned __int8)this & 1) == 0 )
  {
    ...
    if ( v22 )
    {
      ...
      if ( this )
      {
        ...
        sub_1CE66A4(p_mAnimState, (int32_t)Item, v26, v27, v28, v29, v30, v31);
...
LABEL_35:
  ...
  sub_1CE66A4(p_fields, (int32_t)v8, v10, v11, v12, v13, v14, v15);
  ...
  {
LABEL_15:
    v20 = sub_1CBCA7C(p_fields->klass, SimpleAnimation_State_TypeInfo, 6);
  }
  ...
  {
LABEL_32:
    v36 = sub_1CBCA7C(v32, SimpleAnimation_State_TypeInfo, 8);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E01389 & 1) == 0 )
  {
    this = (EventRaceResultEffect_StatePlay_o *)sub_1CE6700(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4E01389 = 1;
  }
  if ( !that )
    goto LABEL_16;
  ...
  if ( ((unsigned __int8)this & 1) == 0 )
  {
    this = (EventRaceResultEffect_StatePlay_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    if ( !this )
      goto LABEL_16;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E0138A & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1CE6700(&Method_EventRaceResultEffect_StateTouchWait_update__);
    sub_1CE6700(&Method_EventRaceResultEffect_StateTouchWait___c__DisplayClass1_0__update_b__0__);
    sub_1CE6700(&EventRaceResultEffect_StateTouchWait___c__DisplayClass1_0_TypeInfo);
    byte_4E0138A = 1;
  }
  v4 = sub_1CE694C(EventRaceResultEffect_StateTouchWait___c__DisplayClass1_0_TypeInfo);
      ...
      if ( isTouchPush )
      {
        ...
        if ( isTouchPush )
        {
          ...
          if ( (*((_BYTE *)Method_EventRaceResultEffect_StateTouchWait_update__ + 83) & 2) != 0 )
            v14 = (_QWORD *)sub_1CE6718(Method_EventRaceResultEffect_StateTouchWait_update__);
