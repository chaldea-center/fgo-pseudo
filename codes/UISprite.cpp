...
UISpriteData_o *UISprite__GetAtlasSprite(UISprite_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C47888 & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_298/*" seems to have a null sprite!"*/);
    byte_4C47888 = 1;
  }
  if ( !this->fields.mSpriteSet )
  {
    this->fields.mSprite = 0;
    sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.mSprite, 0, v2, v3);
  }
  ...
  if ( mSprite )
  {
    ...
    *p_mSpriteName = name;
    sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.mSpriteName, (int32_t)name, v14, v15);
    return this->fields.mSprite;
  }
  spriteList = this->fields.mAtlas;
  if ( !spriteList )
LABEL_28:
  ...
  v19 = (Il2CppObject *)System_String__Concat_63561656(v18, (System_String_o *)StringLiteral_298/*" seems to have a null sprite!"*/, 0);
...
void UISprite__OnDestroy(UISprite_o *this, const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.mAtlas, 0, v2, v3);
  this->fields.mSprite = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( ((unsigned __int8)mAtlas & 1) == 0 )
  {
    ...
    if ( !mSprite )
    {
      ...
      sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.mSprite, (int32_t)Sprite, v14, v15);
      mSprite = this->fields.mSprite;
      if ( !mSprite )
        return;
    }
...
void UISprite__OnUpdate(UISprite_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.mChanged || !this->fields.mSpriteSet )
  {
    ...
    this->fields.mSprite = 0;
    sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.mSprite, 0, v3, v4);
...
void UISprite__SetAtlasSprite(UISprite_o *this, UISpriteData_o *sp, const MethodInfo *method)
{
  ...
  {
    *p_mSprite = sp;
    sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.mSprite, (int32_t)sp, (int32_t)method, v3);
    if ( !*p_mSprite )
      sub_1C372B4(v7);
  ...
  else
  {
    ...
    sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.mSpriteName, (int32_t)v14, (int32_t)method, v3);
    this->fields.mSprite = 0;
    p_mSpriteName = (CGThumbnailListItem_o *)&this->fields.mSprite;
    LODWORD(name) = 0;
  }
  sub_1C36FFC(p_mSpriteName, (int32_t)name, v8, v9);
}
...
void UISprite__set_atlas(UISprite_o *this, UIAtlas_o *value, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(mAtlas, (UnityEngine_Object_o *)value, 0) )
  {
    ...
    sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.mAtlas, (int32_t)value, v7, v8);
    this->fields.mSpriteSet = 0;
    this->fields.mSprite = 0;
    sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.mSprite, 0, v9, v10);
    p_mSpriteName = &this->fields.mSpriteName;
    if ( !System_String__IsNullOrEmpty(this->fields.mSpriteName, 0) )
      goto LABEL_17;
        ...
        if ( *p_mAtlas )
        {
          ...
          if ( spriteList )
          {
            ...
            if ( mSprite )
            {
              name = mSprite->fields.name;
              *p_mSpriteName = name;
              sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.mSpriteName, (int32_t)name, v18, v19);
LABEL_17:
              if ( !System_String__IsNullOrEmpty(*p_mSpriteName, 0) )
              {
                ...
                sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.mSpriteName, v25, v22, v23);
...
void UISprite__set_spriteName(UISprite_o *this, System_String_o *value, const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)p_mSpriteName, v10, v7, v8);
  this->fields.mSprite = 0;
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.mSprite, 0, v11, v12);
  this->fields.mChanged = 1;
  this->fields.mSpriteSet = 0;
}