...
UISpriteData_o *UISprite__GetAtlasSprite(UISprite_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3C30D & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_298/*" seems to have a null sprite!"*/);
    byte_4C3C30D = 1;
  }
  if ( !this->fields.mSpriteSet )
  {
    this->fields.mSprite = 0;
    sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.mSprite, 0, v2, v3);
  }
  ...
  if ( !spriteList )
    goto LABEL_28;
  spriteList = (UIAtlas_o *)UIAtlas__get_spriteList(spriteList, v12);
  if ( !spriteList )
    goto LABEL_28;
  ...
  if ( !result )
    return result;
  UISprite__SetAtlasSprite(this, result, v13);
  mSprite = this->fields.mSprite;
  if ( mSprite )
  {
    name = mSprite->fields.name;
    *p_mSpriteName = name;
    sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.mSpriteName, (int32_t)name, v14, v15);
    return this->fields.mSprite;
  }
  spriteList = this->fields.mAtlas;
  if ( !spriteList )
LABEL_28:
    sub_1C32E7C(spriteList);
  v18 = UnityEngine_Object__get_name((UnityEngine_Object_o *)spriteList, 0);
  v19 = (Il2CppObject *)System_String__Concat_63518544(v18, (System_String_o *)StringLiteral_298/*" seems to have a null sprite!"*/, 0);
...
void UISprite__OnDestroy(UISprite_o *this, const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.mAtlas, 0, v2, v3);
  this->fields.mSprite = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( ((unsigned __int8)mAtlas & 1) == 0 )
  {
    ...
    if ( !mSprite )
    {
      ...
      if ( !mAtlas )
        goto LABEL_14;
      Sprite = UIAtlas__GetSprite(mAtlas, this->fields.mSpriteName, v11);
      this->fields.mSprite = Sprite;
      sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.mSprite, (int32_t)Sprite, v14, v15);
      mSprite = this->fields.mSprite;
      if ( !mSprite )
        return;
    }
    if ( v9 )
    {
      ...
      v40.fields.m_XMin = v29;
      v40.fields.m_YMin = v28;
      v40.fields.m_Width = v23;
      v40.fields.m_Height = v22;
      v41 = NGUIMath__ConvertToTexCoords(v40, v30, v31, 0);
      m_XMin = v41.fields.m_XMin;
      m_YMin = v41.fields.m_YMin;
      m_Width = v41.fields.m_Width;
      m_Height = v41.fields.m_Height;
      ...
      v37 = ((__int64 (__fastcall *)(UnityEngine_Object_o *, _QWORD))v9->klass[1]._1.byval_arg.data)(
              v9,
              *(_QWORD *)&v9->klass[1]._1.byval_arg.bits);
      v42.fields.m_XMin = v25;
      v42.fields.m_YMin = v24;
      v42.fields.m_Width = v27;
      v42.fields.m_Height = v26;
      v43 = NGUIMath__ConvertToTexCoords(v42, v36, v37, 0);
      if ( verts )
      {
...
void UISprite__OnUpdate(UISprite_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.mChanged || !this->fields.mSpriteSet )
  {
    ...
    this->fields.mSprite = 0;
    sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.mSprite, 0, v3, v4);
...
void UISprite__SetAtlasSprite(UISprite_o *this, UISpriteData_o *sp, const MethodInfo *method)
{
  ...
  {
    *p_mSprite = sp;
    sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.mSprite, (int32_t)sp, (int32_t)method, v3);
    if ( !*p_mSprite )
      sub_1C32E7C(v7);
  ...
  else
  {
    ...
    sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.mSpriteName, (int32_t)v14, (int32_t)method, v3);
    this->fields.mSprite = 0;
    p_mSpriteName = (CGThumbnailListItem_o *)&this->fields.mSprite;
    LODWORD(name) = 0;
  }
  sub_1C32BC4(p_mSpriteName, (int32_t)name, v8, v9);
}
...
UnityEngine_Vector4_o UISprite__get_drawingDimensions(UISprite_o *this, const MethodInfo *method)
{
  ...
  if ( AtlasSprite )
  {
    ...
    if ( mType != 2 )
    {
      ...
      v18 = 1.0;
      v19 = paddingRight + paddingLeft + mSprite->fields.width;
      if ( v19 < 1 || (v20 = paddingTop + paddingBottom + mSprite->fields.height, v20 < 1) )
      {
        v21 = 1.0;
      }
      else if ( mType == 3 || (v21 = 1.0, !mType) )
      {
        paddingRight += v19 & 1;
        paddingTop += v20 & 1;
        v21 = (float)(1.0 / (float)v19) * (float)this->fields.mWidth;
        v18 = (float)(1.0 / (float)v20) * (float)this->fields.mHeight;
      }
      ...
      v6 = v6 + (float)(v21 * (float)paddingLeft);
      v8 = v8 - (float)(v21 * (float)v23);
      if ( (mFlip & 0xFFFFFFFE) == 2 )
      {
        v24 = (float)paddingTop;
  ...
  if ( UnityEngine_Object__op_Inequality(mAtlas, 0, 0) )
  {
    ...
    v31 = v30;
    v33 = v32;
    v34 = ((float (__fastcall *)(UISprite_o *, const MethodInfo *))this->klass->vtable._42_get_pixelSize.methodPtr)(
            this,
            this->klass->vtable._42_get_pixelSize.method);
    x = v27 * v34;
    y = v29 * v34;
  ...
  v40 = y + w;
  v41 = this->fields.mDrawRegion.fields.x;
  v42 = this->fields.mDrawRegion.fields.y;
  v43 = x + z;
  v44 = v41 < 0.0;
  v45 = fminf(v41, 1.0);
  v46 = this->fields.mDrawRegion.fields.z;
  if ( v44 )
    v45 = 0.0;
  v47 = (float)((float)(v8 - v43) - v6) * v45;
  v48 = this->fields.mDrawRegion.fields.w;
  v49 = v6 + v43;
  v44 = v42 < 0.0;
  v50 = fminf(v42, 1.0);
  if ( v44 )
  ...
  if ( v48 < 0.0 )
    v55 = 0.0;
  v58 = v6 + v47;
  v59 = v49 + (float)((float)(v8 - v49) * v56);
  v60 = v51 + (float)(v54 * v55);
  result.fields.w = v60;
  result.fields.z = v59;
  result.fields.y = v57;
  result.fields.x = v58;
...
void UISprite__set_atlas(UISprite_o *this, UIAtlas_o *value, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(mAtlas, (UnityEngine_Object_o *)value, 0) )
  {
    ...
    sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.mAtlas, (int32_t)value, v7, v8);
    this->fields.mSpriteSet = 0;
    this->fields.mSprite = 0;
    sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.mSprite, 0, v9, v10);
    p_mSpriteName = &this->fields.mSpriteName;
    if ( !System_String__IsNullOrEmpty(this->fields.mSpriteName, 0) )
      goto LABEL_17;
    ...
    if ( *p_mAtlas )
    {
      ...
      if ( spriteList )
      {
        ...
        if ( *p_mAtlas )
        {
          spriteList = UIAtlas__get_spriteList((UIAtlas_o *)spriteList, v15);
          if ( spriteList )
          {
            Item = System_Collections_Generic_List_object___get_Item(
                     ...
                     0,
                     (const MethodInfo_37984EC *)Method_System_Collections_Generic_List_UISpriteData__get_Item__);
            UISprite__SetAtlasSprite(this, (UISpriteData_o *)Item, v17);
            mSprite = this->fields.mSprite;
            if ( mSprite )
            {
              name = mSprite->fields.name;
              *p_mSpriteName = name;
              sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.mSpriteName, (int32_t)name, v18, v19);
LABEL_17:
              if ( !System_String__IsNullOrEmpty(*p_mSpriteName, 0) )
              {
                ...
                sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.mSpriteName, v25, v22, v23);
                UISprite__set_spriteName(this, mSpriteName, v26);
...
void UISprite__set_spriteName(UISprite_o *this, System_String_o *value, const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)p_mSpriteName, v10, v7, v8);
  this->fields.mSprite = 0;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.mSprite, 0, v11, v12);
  this->fields.mChanged = 1;
  this->fields.mSpriteSet = 0;
}