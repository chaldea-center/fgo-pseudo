...
UISpriteData_o *UISprite__GetAtlasSprite(UISprite_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E09369 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_299/*" seems to have a null sprite!"*/);
    byte_4E09369 = 1;
  }
  if ( !this->fields.mSpriteSet )
  {
    this->fields.mSprite = 0;
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.mSprite, 0, v2, v3, v4, v5, v6, v7);
  }
  ...
  if ( mSprite )
  {
    ...
    *p_mSpriteName = name;
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.mSpriteName, (int32_t)name, v17, v18, v19, v20, v21, v22);
    return this->fields.mSprite;
  }
  spriteList = this->fields.mAtlas;
  if ( !spriteList )
LABEL_28:
    sub_1CE6958(spriteList, v11);
  v25 = UnityEngine_Object__get_name((UnityEngine_Object_o *)spriteList, 0);
  v26 = (Il2CppObject *)System_String__Concat_65122828(v25, (System_String_o *)StringLiteral_299/*" seems to have a null sprite!"*/, 0);
...
void UISprite__OnDestroy(UISprite_o *this, const MethodInfo *method)
{
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.mAtlas, 0, v2, v3, v4, v5, v6, v7);
  this->fields.mSprite = 0;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.mSprite, 0, v9, v10, v11, v12, v13, v14);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( ((unsigned __int8)mAtlas & 1) == 0 )
  {
    ...
    if ( !mSprite )
    {
      ...
      sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.mSprite, (int32_t)Sprite, v15, v16, v17, v18, v19, v20);
      mSprite = this->fields.mSprite;
      if ( !mSprite )
        return;
    }
...
void UISprite__OnUpdate(UISprite_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.mChanged || !this->fields.mSpriteSet )
  {
    ...
    this->fields.mSprite = 0;
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.mSprite, 0, v3, v4, v5, v6, v7, v8);
...
void UISprite__SetAtlasSprite(UISprite_o *this, UISpriteData_o *sp, const MethodInfo *method)
{
  ...
  {
    *p_mSprite = sp;
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.mSprite, (int32_t)sp, (int32_t)method, v3, v4, v5, v6, v7);
    if ( !*p_mSprite )
      sub_1CE6958(v11, v12);
  ...
  sub_1CE66A4(p_mSpriteName, (int32_t)name, v13, v14, v15, v16, v17, v18);
}
...
void UISprite__set_atlas(UISprite_o *this, UIAtlas_o *value, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(mAtlas, (UnityEngine_Object_o *)value, 0) )
  {
    ...
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.mAtlas, (int32_t)value, v7, v8, v9, v10, v11, v12);
    this->fields.mSpriteSet = 0;
    this->fields.mSprite = 0;
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.mSprite, 0, v13, v14, v15, v16, v17, v18);
    p_mSpriteName = &this->fields.mSpriteName;
    if ( !System_String__IsNullOrEmpty(this->fields.mSpriteName, 0) )
      goto LABEL_17;
...
LABEL_17:
              if ( !System_String__IsNullOrEmpty(*p_mSpriteName, 0) )
              {
                ...
                sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.mSpriteName, v40, v33, v34, v35, v36, v37, v38);
...
void UISprite__set_spriteName(UISprite_o *this, System_String_o *value, const MethodInfo *method)
{
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)p_mSpriteName, v14, v7, v8, v9, v10, v11, v12);
  this->fields.mSprite = 0;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.mSprite, 0, v15, v16, v17, v18, v19, v20);
  this->fields.mChanged = 1;
  this->fields.mSpriteSet = 0;
}