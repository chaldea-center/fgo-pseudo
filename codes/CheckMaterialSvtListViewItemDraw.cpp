        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B19C20 & 1) == 0 )
  {
    ...
    this = (CheckMaterialSvtListViewItemDraw_o *)sub_1BCA7E0(&StringLiteral_1/*""*/, v24, v25);
    byte_4B19C20 = 1;
  }
  if ( !isServant )
  {
  ...
  if ( item )
  {
    if ( dispMode )
    {
      ...
      if ( UserServantEntity_k__BackingField || UserCommandCodeEntity_k__BackingField )
      {
        ...
        CheckMaterialSvtListViewItemDraw__SetSpriteActive(
          (CheckMaterialSvtListViewItemDraw_o *)v15,
...
LABEL_24:
        ...
        CheckMaterialSvtListViewItemDraw__SetDisp(this, item, isSelectEnable, v21);
        ...
        const MethodInfo *method)
{
  ...
  CheckMaterialSvtListViewItemDraw_o *v16; // x2

  v10 = this;
  if ( (byte_4B19C1F & 1) == 0 )
  {
    sub_1BCA7E0(&TutorialFlag_TypeInfo, item, *(_QWORD *)&modeKind);
    this = (CheckMaterialSvtListViewItemDraw_o *)sub_1BCA7E0(&StringLiteral_1/*""*/, v11, v12);
    byte_4B19C1F = 1;
  }
  if ( !item )
    goto LABEL_17;
...
LABEL_15:
    ...
    v16 = (CheckMaterialSvtListViewItemDraw_o *)StringLiteral_1/*""*/;
    goto LABEL_16;
  }
  if ( (unsigned int)(modeKind - 1) <= 1 )
  {
    ...
    this = (CheckMaterialSvtListViewItemDraw_o *)TutorialFlag__Get_38402052(126, 0LL);
