...
int32_t __fastcall CheckMaterialSvtListViewItemDraw__GetDispMode(int32_t initMode, const MethodInfo *method)
{
  if ( (unsigned int)(initMode - 1) > 2 )
    ...
    return dword_327BF44[initMode - 1];
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AFE46 & 1) == 0 )
  {
    ...
    this = (CheckMaterialSvtListViewItemDraw_o *)sub_B52984(&StringLiteral_1/*""*/);
    byte_42AFE46 = 1;
  }
  if ( !isServant )
  {
...
LABEL_16:
  ...
  if ( (unsigned int)(modeKind - 1) <= 1 )
  {
    ...
    this = (CheckMaterialSvtListViewItemDraw_o *)TutorialFlag__Get_29217932(126, 0LL);
...
LABEL_17:
  CheckMaterialSvtListViewItemDraw__SetLabelText(this, warningLabel, v14, (const MethodInfo *)isServant);
}