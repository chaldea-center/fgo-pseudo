        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFE73C & 1) == 0 )
  {
    ...
    this = (CheckMaterialSvtListViewItemDraw_o *)sub_1CE6700(&StringLiteral_1/*""*/);
    byte_4DFE73C = 1;
  }
  if ( !isServant )
  {
...
LABEL_12:
  if ( item->fields._IsChoice_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v8 = &StringLiteral_11644/*"SELECT_CHOICE"*/;
    return LocalizationManager__Get((System_String_o *)*v8, 0);
  }
  if ( item->fields._IsLock_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v8 = &StringLiteral_11661/*"SELECT_LOCK"*/;
    return LocalizationManager__Get((System_String_o *)*v8, 0);
  }
  if ( isServant )
  {
  ...
  if ( isCommandCode && item->fields._IsCommandCodeEquipped_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v8 = &StringLiteral_9389/*"NOT_SELECT_EQUIPED"*/;
    return LocalizationManager__Get((System_String_o *)*v8, 0);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !item->fields._IsCommandCode_k__BackingField )
  {
    ...
    if ( CheckMaterialSvtListViewItem__get_IsHeroine(item, 0) )
    {
      ...
      this = (CheckMaterialSvtListViewItemDraw_o *)TutorialFlag__Get_41569468(126, 0);
