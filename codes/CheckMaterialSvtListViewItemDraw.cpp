        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A6A8 & 1) == 0 )
  {
    ...
    this = (CheckMaterialSvtListViewItemDraw_o *)sub_1BE4ACC(&StringLiteral_1/*""*/, v16);
    byte_4B6A6A8 = 1;
  }
  if ( !isServant )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A6A7 & 1) == 0 )
  {
    ...
    this = (CheckMaterialSvtListViewItemDraw_o *)sub_1BE4ACC(&StringLiteral_1/*""*/, v11);
    byte_4B6A6A7 = 1;
  }
  if ( !item )
    goto LABEL_17;
...
LABEL_15:
  ...
  if ( (unsigned int)(modeKind - 1) <= 1 )
  {
    ...
    this = (CheckMaterialSvtListViewItemDraw_o *)TutorialFlag__Get_38593888(126, 0LL);
