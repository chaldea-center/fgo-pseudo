void __fastcall ScriptLineMessage___ctor(ScriptLineMessage_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B03E01 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_System_Collections_Generic_List_ScriptMessageLabel___ctor__, v5);
    sub_1BC3008(&System_Collections_Generic_List_ScriptMessageLabel__TypeInfo, v6);
    sub_1BC3008(&StringLiteral_856/*"-"*/, v7);
    sub_1BC3008(&StringLiteral_21306/*"medium"*/, v8);
    sub_1BC3008(&StringLiteral_23319/*"small"*/, v9);
    sub_1BC3008(&StringLiteral_1/*""*/, v10);
    sub_1BC3008(&StringLiteral_20961/*"large"*/, v11);
    sub_1BC3008(&StringLiteral_24660/*"x-large"*/, v12);
    byte_4B03E01 = 1;
  }
  this->fields.fontScale = 1.0;
  this->fields.defaultBetweenLineHeight = 5.0;
  v13 = (System_Collections_Generic_Dictionary_object__int__o *)sub_1BC3254(System_Collections_Generic_Dictionary_string__int__TypeInfo);
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.fontSizes, (int32_t)v13, v16, v17);
  v18 = (int)StringLiteral_1/*""*/;
  this->fields.defaultColorTag = (struct System_String_o *)StringLiteral_1/*""*/;
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.defaultColorTag, v18, v19, v20);
  v21 = (System_Collections_Generic_List_object__o *)sub_1BC3254(System_Collections_Generic_List_ScriptMessageLabel__TypeInfo);
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.dispLabelList, (int32_t)v21, v22, v23);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B03DFA & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_System_Collections_Generic_List_ScriptMessageLabel__Add__, v10);
    sub_1BC3008(&UnityEngine_Object_TypeInfo, v11);
    sub_1BC3008(&StringLiteral_21031/*"line"*/, v12);
    byte_4B03DFA = 1;
  }
  ...
  *(_QWORD *)(Label + 112) = colorTag;
  v18 = Label + 112;
  *(_DWORD *)(v18 + 52) = 0;
  sub_1BC2FAC((CGThumbnailListItem_o *)v18, (int32_t)colorTag, v15, v16);
  if ( !text )
    goto LABEL_64;
  ...
  if ( System_String__get_Chars(text, 1, 0LL) == 35 )
  {
    ...
    *(_QWORD *)(v17 + 16) = MainLabel;
    sub_1BC2FAC((CGThumbnailListItem_o *)(v17 + 16), (int32_t)MainLabel, v22, v23);
    RubyLabel = ScriptLineMessage__FetchRubyLabel(this, v24);
    *(_QWORD *)(v17 + 24) = RubyLabel;
    sub_1BC2FAC((CGThumbnailListItem_o *)(v17 + 24), (int32_t)RubyLabel, v26, v27);
    v28 = System_String__Substring_62394572(text, 2, text->fields._stringLength - 3, 0LL);
    ...
    if ( *(_DWORD *)(Label + 24) )
    {
      *(_WORD *)(Label + 32) = 58;
      if ( !v28 )
        goto LABEL_64;
      Label = (__int64)System_String__Split_62397724(v28, (System_Char_array *)Label, 0LL);
      if ( !Label )
        goto LABEL_64;
      v30 = Label;
      if ( *(_DWORD *)(Label + 24) )
  ...
  if ( System_String__get_Chars(text, 1, 0LL) != 94 )
  {
    if ( System_String__get_Chars(text, 1, 0LL) == 126 )
    {
      ...
      *(_QWORD *)(v17 + 32) = ImageSprite;
      sub_1BC2FAC((CGThumbnailListItem_o *)(v17 + 32), (int32_t)ImageSprite, v47, v48);
      v49 = System_String__Substring_62394572(text, 2, text->fields._stringLength - 3, 0LL);
      ...
      ScriptMessageLabel__UpdateLine(
        ...
        v50,
        v51,
        (System_String_o *)StringLiteral_21031/*"line"*/,
        0LL);
      goto LABEL_27;
    }
LABEL_26:
    ...
    *(_QWORD *)(v17 + 16) = v52;
    sub_1BC2FAC((CGThumbnailListItem_o *)(v17 + 16), (int32_t)v52, v53, v54);
  ...
  *(_QWORD *)(v17 + 32) = v36;
  sub_1BC2FAC((CGThumbnailListItem_o *)(v17 + 32), (int32_t)v36, v37, v38);
  v39 = System_String__Substring_62394572(text, 2, text->fields._stringLength - 3, 0LL);
  Label = sub_1BC30B0(char___TypeInfo, 1LL);
  if ( !Label )
    goto LABEL_64;
  v14 = (const MethodInfo *)Label;
  ...
  *(_WORD *)(Label + 32) = 32;
  if ( !v39 )
    goto LABEL_64;
  Label = (__int64)System_String__Split_62397724(v39, (System_Char_array *)Label, 0LL);
  if ( !Label )
    goto LABEL_64;
  v40 = *(_DWORD *)(Label + 24);
  v41 = Label;
  ...
  if ( v40 <= 1 )
  {
    ...
    *(_WORD *)(Label + 32) = 58;
    if ( !v42 )
      goto LABEL_64;
    Label = (__int64)System_String__Split_62397724(v42, (System_Char_array *)Label, 0LL);
    if ( !Label )
      goto LABEL_64;
    v66 = *(_DWORD *)(Label + 24);
    v67 = Label;
    ...
    else
    {
      ...
      *(_QWORD *)(v17 + 24) = v68;
      sub_1BC2FAC((CGThumbnailListItem_o *)(v17 + 24), (int32_t)v68, v69, v70);
      if ( *(_DWORD *)(v67 + 24) < 2u )
        goto LABEL_65;
  ...
  else
  {
    ...
    else if ( v44 <= 3 )
    {
      ...
      *(_WORD *)(Label + 32) = 44;
      if ( !v71 )
        goto LABEL_64;
      Label = (__int64)System_String__Split_62397724(v71, (System_Char_array *)Label, 0LL);
      if ( !Label )
        goto LABEL_64;
      v72 = Label;
      if ( !*(_DWORD *)(Label + 24) )
...
LABEL_27:
  ...
  if ( UnityEngine_Object__op_Inequality(messageOffset, 0LL, 0LL) )
  {
    ...
    if ( !byte_4AFBDB6 )
    {
      Label = sub_1BC3008(&UnityEngine_Vector3_TypeInfo, v14);
      byte_4AFBDB6 = 1;
    }
    if ( !v58 )
      goto LABEL_64;
...
LABEL_40:
  ...
  else
  {
    ...
    *(_QWORD *)(v65 + 32) = v17;
    sub_1BC2FAC((CGThumbnailListItem_o *)(v65 + 32), v17, v56, v57);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.mainPrefab, (int32_t)prefab, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.messageRoot, (int32_t)root, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.rubyPrefab, (int32_t)prefab, (int32_t)method, v3);
}
...
LABEL_8:
    sub_1BC3264(messageRoot, method);
  }
}
...
UISprite_o *__fastcall ScriptLineMessage__FetchImageSprite(ScriptLineMessage_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B03DF7 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_UnityEngine_GameObject_GetComponentsInChildren_UIWidget___, v3);
    sub_1BC3008(&Method_UnityEngine_Object_Instantiate_GameObject___, v4);
    sub_1BC3008(&UnityEngine_Object_TypeInfo, v5);
    sub_1BC3008(&Method_System_Collections_Generic_Stack_UISprite__Pop__, v6);
    sub_1BC3008(&Method_System_Collections_Generic_Stack_UISprite__get_Count__, v7);
    byte_4B03DF7 = 1;
  }
          ...
          if ( this->fields.messageRoot )
          {
            ...
            if ( Component_object )
            {
              ...
              if ( v14 )
              {
                ...
                Component_object = (__int64)UnityEngine_GameObject__GetComponentsInChildren_object__50685372(
                                              v13,
                ...
                if ( Component_object )
                {
                  ...
                  {
                    if ( v18 >= v16 )
                      sub_1BC326C(Component_object, v10, v15);
...
LABEL_20:
  ...
  if ( !byte_4AFBDB1 )
  {
    Component_object = sub_1BC3008(&UnityEngine_Vector3_TypeInfo, v10);
    byte_4AFBDB1 = 1;
  }
  if ( !v19 )
    goto LABEL_28;
...
UILabel_o *__fastcall ScriptLineMessage__FetchMainLabel(ScriptLineMessage_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B03DF5 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_UnityEngine_Object_Instantiate_GameObject___, v4);
    sub_1BC3008(&UnityEngine_Object_TypeInfo, v5);
    sub_1BC3008(&Method_System_Collections_Generic_Stack_UILabel__Pop__, v6);
    sub_1BC3008(&Method_System_Collections_Generic_Stack_UILabel__get_Count__, v7);
    byte_4B03DF5 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B03DF3 & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Collections_Generic_List_ScriptMessageLabel__ToArray__, method);
    byte_4B03DF3 = 1;
  }
  dispLabelList = (System_Collections_Generic_List_object__o *)this->fields.dispLabelList;
  if ( !dispLabelList )
  ...
  return (ScriptMessageLabel_array *)System_Collections_Generic_List_object___ToArray(
                                       dispLabelList,
                                       (const MethodInfo_36A2998 *)Method_System_Collections_Generic_List_ScriptMessageLabel__ToArray__);
}
...
bool __fastcall ScriptLineMessage__HasRubyFormat(System_String_o *text, const MethodInfo *method)
{
  ...
  if ( (byte_4B03E00 & 1) == 0 )
  {
    sub_1BC3008(&System_Text_RegularExpressions_Regex_TypeInfo, method);
    sub_1BC3008(&StringLiteral_15888/*"\\[#[^:]+:[^:]+\\]"*/, v3);
    byte_4B03E00 = 1;
  }
  if ( !System_Text_RegularExpressions_Regex_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Text_RegularExpressions_Regex_TypeInfo);
  return System_Text_RegularExpressions_Regex__IsMatch(text, (System_String_o *)StringLiteral_15888/*"\\[#[^:]+:[^:]+\\]"*/, 0LL);
}
...
void __fastcall ScriptLineMessage__Init(ScriptLineMessage_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B03DF1 & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Collections_Generic_Dictionary_string__int__get_Item__, method);
    sub_1BC3008(&Method_System_Collections_Generic_Dictionary_string__int__set_Item__, v3);
    sub_1BC3008(&Method_UnityEngine_GameObject_GetComponent_UILabel___, v4);
    sub_1BC3008(&Method_UnityEngine_Object_Instantiate_GameObject___, v5);
    sub_1BC3008(&UnityEngine_Object_TypeInfo, v6);
    sub_1BC3008(&Method_System_Collections_Generic_Stack_UILabel___ctor__, v7);
    sub_1BC3008(&Method_System_Collections_Generic_Stack_UISprite___ctor__, v8);
    sub_1BC3008(&Method_System_Collections_Generic_Stack_ScriptMessageLabel___ctor__, v9);
    sub_1BC3008(&System_Collections_Generic_Stack_UILabel__TypeInfo, v10);
    sub_1BC3008(&System_Collections_Generic_Stack_UISprite__TypeInfo, v11);
    sub_1BC3008(&System_Collections_Generic_Stack_ScriptMessageLabel__TypeInfo, v12);
    sub_1BC3008(&StringLiteral_856/*"-"*/, v13);
    sub_1BC3008(&StringLiteral_25114/*"■"*/, v14);
    byte_4B03DF1 = 1;
  }
  if ( !this->fields.isInit )
  {
    ...
    if ( isRecycle )
    {
      v16 = (System_Collections_Generic_Stack_T__o *)sub_1BC3254(System_Collections_Generic_Stack_UILabel__TypeInfo);
      ...
      sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.mainStock, (int32_t)v16, v17, v18);
      ...
      sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.rubyStock, (int32_t)v19, v20, v21);
      v22 = (System_Collections_Generic_Stack_T__o *)sub_1BC3254(System_Collections_Generic_Stack_UISprite__TypeInfo);
      System_Collections_Generic_Stack_object____ctor(
        v22,
      ...
      sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.imageStock, (int32_t)v22, v23, v24);
      v25 = (System_Collections_Generic_Stack_T__o *)sub_1BC3254(System_Collections_Generic_Stack_ScriptMessageLabel__TypeInfo);
      System_Collections_Generic_Stack_object____ctor(
        v25,
      ...
      sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.labelStock, (int32_t)v25, v26, v27);
    }
    mainPrefab = (Il2CppObject *)this->fields.mainPrefab;
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    ...
    {
LABEL_37:
      sub_1BC3264(fontSizes, v30);
    }
    UILabel__set_fontSize((UILabel_o *)Component_object, v30, 0LL);
    UILabel__set_text((UILabel_o *)Component_object, (System_String_o *)StringLiteral_25114/*"■"*/, 0LL);
    ...
    UILabel__set_text(v34, (System_String_o *)StringLiteral_25114/*"■"*/, 0LL);
    ...
    UnityEngine_Object__Destroy_70034300(v42, 0LL);
    messageOffset = (UnityEngine_Object_o *)this->fields.messageOffset;
    ...
    if ( (fontSizes & 1) != 0 )
    {
      ...
      if ( !byte_4AFBDB1 )
      {
        fontSizes = sub_1BC3008(&UnityEngine_Vector3_TypeInfo, v30);
        byte_4AFBDB1 = 1;
      }
      if ( !v45 )
        goto LABEL_37;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B03DF9 & 1) == 0 )
  {
    ...
    this = (ScriptLineMessage_o *)sub_1BC3008(&StringLiteral_1/*""*/, v8);
    byte_4B03DF9 = 1;
  }
  if ( !v3 )
    goto LABEL_40;
  ...
  if ( UnityEngine_Object__op_Inequality(main, 0LL, 0LL) )
  {
    ...
    *p_fields = 0LL;
    sub_1BC2FAC((CGThumbnailListItem_o *)&v3->fields, 0, v11, v12);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(ruby, 0LL, 0LL) )
  {
    ...
    *p_ruby = 0LL;
    sub_1BC2FAC((CGThumbnailListItem_o *)&v3->fields.ruby, 0, v16, v17);
  }
...
LABEL_36:
        *p_image = 0LL;
        sub_1BC2FAC((CGThumbnailListItem_o *)&v3->fields.image, 0, v21, v22);
        goto LABEL_37;
      }
      if ( label )
      {
        ...
        if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
        UnityEngine_Object__Destroy_70034300(v23, 0LL);
        goto LABEL_36;
      }
    }
LABEL_40:
...
void __fastcall ScriptLineMessage__ReturnText(ScriptLineMessage_o *this, const MethodInfo *method)
{
  ...
  this->fields.defaultColorTag = (struct System_String_o *)StringLiteral_1/*""*/;
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.defaultColorTag, v10, v2, v3);
...
void __fastcall ScriptLineMessage__SetDefaultState(ScriptLineMessage_o *this, const MethodInfo *method)
{
  ...
  this->fields.defaultColorTag = (struct System_String_o *)StringLiteral_1/*""*/;
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.defaultColorTag, v8, v2, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B03DFE & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Collections_Generic_Dictionary_string__int__get_Item__, sizeName);
    byte_4B03DFE = 1;
  }
  fontSizes = this->fields.fontSizes;
  if ( !fontSizes )
    sub_1BC3264(0LL, sizeName);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B03DFB & 1) == 0 )
  {
    sub_1BC3008(&ScriptLineMessage_ProcAddLabel2_TypeInfo, txt);
    sub_1BC3008(&ScriptLineMessage_ProcAddLabel_TypeInfo, v12);
    sub_1BC3008(&ScriptMessageLabel_TypeInfo, v13);
    sub_1BC3008(&ScriptReplaceString_TypeInfo, v14);
    sub_1BC3008(&System_Text_StringBuilder_TypeInfo, v15);
    sub_1BC3008(&Method_ScriptLineMessage___c__DisplayClass55_0__UpdateLabels_b__0__, v16);
    sub_1BC3008(&Method_ScriptLineMessage___c__DisplayClass55_0__UpdateLabels_b__1__, v17);
    sub_1BC3008(&ScriptLineMessage___c__DisplayClass55_0_TypeInfo, v18);
    sub_1BC3008(&StringLiteral_23052/*"servantName"*/, v19);
    sub_1BC3008(&StringLiteral_15677/*"[-]"*/, v20);
    sub_1BC3008(&StringLiteral_19897/*"i"*/, v21);
    sub_1BC3008(&StringLiteral_15876/*"[~1]"*/, v22);
    sub_1BC3008(&StringLiteral_15812/*"[^"*/, v23);
    sub_1BC3008(&StringLiteral_22693/*"r"*/, v24);
  ...
  text = 0LL;
  v30 = sub_1BC3254(ScriptLineMessage___c__DisplayClass55_0_TypeInfo);
  ...
  *(_QWORD *)(v30 + 40) = font;
  sub_1BC2FAC((CGThumbnailListItem_o *)(v30 + 40), (int32_t)font, v35, v36);
  ...
  *(_QWORD *)(v30 + 16) = v37;
  ...
  if ( enforceColor )
  {
    ...
    sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.defaultColorTag, (int32_t)enforceColor, v41, v42);
  }
  p_defaultColorTag = &this->fields.defaultColorTag;
  defaultColorTag = this->fields.defaultColorTag;
  *(_QWORD *)(v30 + 48) = defaultColorTag;
  sub_1BC2FAC((CGThumbnailListItem_o *)(v30 + 48), (int32_t)defaultColorTag, v41, v42);
  v45 = sub_1BC3254(ScriptLineMessage_ProcAddLabel_TypeInfo);
  ScriptLineMessage_ProcAddLabel___ctor(
    ...
    v46);
  v91 = (ScriptLineMessage_ProcAddLabel2_o *)sub_1BC3254(ScriptLineMessage_ProcAddLabel2_TypeInfo);
  ...
  while ( 1 )
  {
    if ( System_String__get_Chars(txt, v48, 0LL) != 91 )
    {
      ...
      if ( !v61 )
        goto LABEL_89;
      System_Text_StringBuilder__Append_62434920(v61, Chars, 0LL);
      v52 = v48;
      goto LABEL_42;
    }
    ...
    if ( BraceIndex == -1 )
    {
      ...
      if ( !*v38 )
        goto LABEL_89;
      Chars = (__int64)System_Text_StringBuilder__Append_62432592(
    ...
    if ( (unsigned __int16)Chars == 37 )
    {
      ...
      v53 = System_String__Substring_62394572(txt, v48 + 2, v49 + v52 - 2, 0LL);
...
LABEL_39:
      ...
      sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.defaultColorTag, (int32_t)v65, v59, v60);
      v68 = *(_BYTE *)(v30 + 32);
...
LABEL_40:
      ...
      *(_QWORD *)(v30 + 48) = v74;
LABEL_41:
      sub_1BC2FAC((CGThumbnailListItem_o *)(v30 + 48), (int32_t)v74, v72, v73);
      goto LABEL_42;
    }
    Chars = System_String__get_Chars(txt, v50, 0LL);
    if ( (unsigned __int16)Chars == 38 )
    {
      ...
      if ( !byte_4B03C57 )
      {
        sub_1BC3008(&ScriptReplaceString_TypeInfo, v62);
        byte_4B03C57 = 1;
      }
    ...
    if ( (unsigned __int16)Chars == 35 )
    {
      if ( !v45 )
        goto LABEL_89;
      (*(void (__fastcall **)(_QWORD, _QWORD))(v45 + 24))(*(_QWORD *)(v45 + 64), *(_QWORD *)(v45 + 40));
      Chars = (__int64)System_String__Substring_62394572(txt, v48, v49 + v52 + 1, 0LL);
      goto LABEL_60;
    }
...
LABEL_43:
  ...
  Chars = System_String__Equals_62383952((System_String_o *)Chars, (System_String_o *)StringLiteral_20089/*"image"*/, 0LL);
  if ( (Chars & 1) != 0 )
  {
    if ( !v45 )
      goto LABEL_89;
  ...
  Chars = System_String__Equals_62383952(v75, (System_String_o *)StringLiteral_19897/*"i"*/, 0LL);
  if ( (Chars & 1) != 0 )
  {
    if ( !v45 )
      goto LABEL_89;
    ...
    v77 = v49 + v52 - 3;
LABEL_58:
    v32 = System_String__Substring_62394572(txt, v76, v77, 0LL);
    v78 = (System_String_o *)StringLiteral_15812/*"[^"*/;
    v79 = (System_String_o *)StringLiteral_15911/*"]"*/;
LABEL_59:
    Chars = (__int64)System_String__Concat_62386896(v78, v32, v79, 0LL);
LABEL_60:
    v80 = v91;
    if ( !v91 )
      goto LABEL_89;
...
LABEL_62:
  ...
  Chars = System_String__Equals_62383952(v75, (System_String_o *)StringLiteral_22693/*"r"*/, 0LL);
  if ( (Chars & 1) != 0 )
  {
    if ( !v45 )
      goto LABEL_89;
    ...
    if ( enforceColor )
    {
      *p_defaultColorTag = enforceColor;
      sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.defaultColorTag, (int32_t)enforceColor, v72, v73);
    }
    v74 = *p_defaultColorTag;
    *(_QWORD *)(v30 + 48) = *p_defaultColorTag;
    goto LABEL_41;
  }
  Chars = System_String__Equals_62383952(v75, (System_String_o *)StringLiteral_23052/*"servantName"*/, 0LL);
  if ( (Chars & 1) != 0 )
  {
    if ( !v45 )
      goto LABEL_89;
    (*(void (__fastcall **)(_QWORD, _QWORD))(v45 + 24))(*(_QWORD *)(v45 + 64), *(_QWORD *)(v45 + 40));
    v83 = System_String__Substring_62394572(txt, v48 + 12, v49 + v52 - 12, 0LL);
    if ( !ScriptMessageLabel_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(ScriptMessageLabel_TypeInfo);
    ...
    sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.defaultColorTag, (int32_t)v85, v87, v88);
  ...
  Chars = System_String__StartsWith(v75, (System_String_o *)StringLiteral_21031/*"line"*/, 0LL);
  if ( (Chars & 1) != 0 )
  {
    if ( !v45 )
      goto LABEL_89;
    (*(void (__fastcall **)(_QWORD, _QWORD))(v45 + 24))(*(_QWORD *)(v45 + 64), *(_QWORD *)(v45 + 40));
    Chars = (__int64)System_String__Substring_62394572(txt, v48 + 5, v49 + v52 - 5, 0LL);
    if ( !Chars )
      goto LABEL_89;
    v32 = (System_String_o *)Chars;
    if ( *(int *)(Chars + 16) >= 1 )
    {
      v78 = (System_String_o *)StringLiteral_15875/*"[~"*/;
      v79 = (System_String_o *)StringLiteral_15911/*"]"*/;
      goto LABEL_59;
    }
    v80 = v91;
    if ( !v91 )
      goto LABEL_89;
    v81 = StringLiteral_15876/*"[~1]"*/;
    goto LABEL_62;
  }
  if ( v52 < txt->fields._stringLength )
  {
    text = System_String__Substring_62394572(txt, v48, v49 + v52 + 1, 0LL);
    if ( !ScriptMessageLabel_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(ScriptMessageLabel_TypeInfo);
    ...
    if ( !*v38 )
      goto LABEL_89;
    System_Text_StringBuilder__Append_62432592((System_Text_StringBuilder_o *)Chars, text, 0LL);
    goto LABEL_42;
  }
  v90 = *v38;
  ...
  if ( !v90 )
    goto LABEL_89;
  Chars = (__int64)System_Text_StringBuilder__Append_62432592(v90, (System_String_o *)Chars, 0LL);
LABEL_87:
  if ( !v45 )
LABEL_89:
    sub_1BC3264(Chars, v32);
  (*(void (__fastcall **)(_QWORD, _QWORD))(v45 + 24))(*(_QWORD *)(v45 + 64), *(_QWORD *)(v45 + 40));
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A0EA5C;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A0EA1C;
}
...
LABEL_9:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A0EA70;
}
...
LABEL_8:
  ...
  *((_QWORD *)tmpTxt + 17) = tmpColorTag;
  sub_1BC2FAC((CGThumbnailListItem_o *)tmpTxt + 1, (int32_t)tmpColorTag, v4, v5);
}
...
LABEL_7:
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this[2].fields.__4__this, (int32_t)tmpColorTag, (int32_t)method, v3);
}