...
void __fastcall UserMessageInputDlg__OnChangeInput(UserMessageInputDlg_o *this, const MethodInfo *method)
{
  ...
  sub_1BD33FC(&this->fields.changeName);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B326BA & 1) == 0 )
  {
    ...
    sub_1BD3458(&Method_EmojiUtility_ValidateNameText__, v8);
    sub_1BD3458(&LocalizationManager_TypeInfo, v9);
    sub_1BD3458(&UIInput_OnValidate_TypeInfo, v10);
    sub_1BD3458(&Method_SupportDeckNameInputMenu_EndOpen__, v11);
    sub_1BD3458(&StringLiteral_8778/*"MESSAGE_CHANGE_TITLE"*/, v12);
    sub_1BD3458(&StringLiteral_3795/*"COMMON_CONFIRM_DECIDE"*/, v13);
    sub_1BD3458(&StringLiteral_3793/*"COMMON_CONFIRM_CANCEL"*/, v14);
    sub_1BD3458(&StringLiteral_8776/*"MESSAGE_CHANGE_EXPLANATION"*/, v15);
    byte_4B326BA = 1;
  }
  ...
  sub_1BD33FC(&this->fields.baseName);
  this->fields.callbackFunc = callback;
  sub_1BD33FC(&this->fields.callbackFunc);
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8778/*"MESSAGE_CHANGE_TITLE"*/, 0LL);
  if ( !titleLabel )
    goto LABEL_15;
  UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL);
  explanationLabel = this->fields.explanationLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8776/*"MESSAGE_CHANGE_EXPLANATION"*/, 0LL);
  if ( !explanationLabel )
    goto LABEL_15;
        ...
        const MethodInfo *method)
{
  if ( (byte_4B326BE & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_3227/*"BaseWindow/CancleButton"*/, method);
    byte_4B326BE = 1;
  }
  return (System_String_o *)StringLiteral_3227/*"BaseWindow/CancleButton"*/;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B326BD & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_8777/*"MESSAGE_CHANGE_NO_INPUT"*/, v5);
    byte_4B326BD = 1;
  }
  ...
  if ( ((unsigned __int8)IsNullOrEmpty & 1) != 0 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    IsNullOrEmpty = LocalizationManager__Get((System_String_o *)StringLiteral_8777/*"MESSAGE_CHANGE_NO_INPUT"*/, 0LL);
    if ( inputTarget )
    {
