...
void __fastcall UserMessageInputDlg__OnChangeInput(UserMessageInputDlg_o *this, const MethodInfo *method)
{
  ...
  sub_1B64814(&this->fields.changeName);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F9C0F & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_EmojiUtility_ValidateNameText__, v8);
    sub_1B64870(&LocalizationManager_TypeInfo, v9);
    sub_1B64870(&UIInput_OnValidate_TypeInfo, v10);
    sub_1B64870(&Method_SupportDeckNameInputMenu_EndOpen__, v11);
    sub_1B64870(&StringLiteral_8600/*"MESSAGE_CHANGE_TITLE"*/, v12);
    sub_1B64870(&StringLiteral_3734/*"COMMON_CONFIRM_DECIDE"*/, v13);
    sub_1B64870(&StringLiteral_3732/*"COMMON_CONFIRM_CANCEL"*/, v14);
    sub_1B64870(&StringLiteral_8598/*"MESSAGE_CHANGE_EXPLANATION"*/, v15);
    byte_49F9C0F = 1;
  }
  ...
  sub_1B64814(&this->fields.baseName);
  this->fields.callbackFunc = callback;
  sub_1B64814(&this->fields.callbackFunc);
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8600/*"MESSAGE_CHANGE_TITLE"*/, 0LL);
  if ( !titleLabel )
    goto LABEL_15;
  UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL);
  explanationLabel = this->fields.explanationLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8598/*"MESSAGE_CHANGE_EXPLANATION"*/, 0LL);
  if ( !explanationLabel )
    goto LABEL_15;
        ...
        const MethodInfo *method)
{
  if ( (byte_49F9C13 & 1) == 0 )
  {
    sub_1B64870(&StringLiteral_3175/*"BaseWindow/CancleButton"*/, method);
    byte_49F9C13 = 1;
  }
  return (System_String_o *)StringLiteral_3175/*"BaseWindow/CancleButton"*/;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F9C12 & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_8599/*"MESSAGE_CHANGE_NO_INPUT"*/, v5);
    byte_49F9C12 = 1;
  }
  ...
  if ( ((unsigned __int8)IsNullOrEmpty & 1) != 0 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    IsNullOrEmpty = LocalizationManager__Get((System_String_o *)StringLiteral_8599/*"MESSAGE_CHANGE_NO_INPUT"*/, 0LL);
    if ( inputTarget )
    {
