...
void __fastcall UserMessageInputDlg__OnChangeInput(UserMessageInputDlg_o *this, const MethodInfo *method)
{
  ...
  sub_1BAB3C0(&this->fields.changeName);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB131C & 1) == 0 )
  {
    sub_1BAB41C(&System_Action_TypeInfo, message);
    sub_1BAB41C(&Method_UnityEngine_Component_GetComponent_Collider___, v7);
    sub_1BAB41C(&Method_EmojiUtility_ValidateNameText__, v8);
    sub_1BAB41C(&LocalizationManager_TypeInfo, v9);
    sub_1BAB41C(&UIInput_OnValidate_TypeInfo, v10);
    sub_1BAB41C(&Method_SupportDeckNameInputMenu_EndOpen__, v11);
    sub_1BAB41C(&StringLiteral_8642/*"MESSAGE_CHANGE_TITLE"*/, v12);
    sub_1BAB41C(&StringLiteral_3755/*"COMMON_CONFIRM_DECIDE"*/, v13);
    sub_1BAB41C(&StringLiteral_3753/*"COMMON_CONFIRM_CANCEL"*/, v14);
    sub_1BAB41C(&StringLiteral_8640/*"MESSAGE_CHANGE_EXPLANATION"*/, v15);
    byte_4AB131C = 1;
  }
  ...
  sub_1BAB3C0(&this->fields.baseName);
  this->fields.callbackFunc = callback;
  sub_1BAB3C0(&this->fields.callbackFunc);
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8642/*"MESSAGE_CHANGE_TITLE"*/, 0LL);
  if ( !titleLabel )
    goto LABEL_15;
  UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL);
  explanationLabel = this->fields.explanationLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8640/*"MESSAGE_CHANGE_EXPLANATION"*/, 0LL);
  if ( !explanationLabel )
    goto LABEL_15;
        ...
        const MethodInfo *method)
{
  if ( (byte_4AB1320 & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_3192/*"BaseWindow/CancleButton"*/, method);
    byte_4AB1320 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB131F & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_8641/*"MESSAGE_CHANGE_NO_INPUT"*/, v5);
    byte_4AB131F = 1;
  }
  ...
  if ( ((unsigned __int8)IsNullOrEmpty & 1) != 0 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    IsNullOrEmpty = LocalizationManager__Get((System_String_o *)StringLiteral_8641/*"MESSAGE_CHANGE_NO_INPUT"*/, 0LL);
    if ( inputTarget )
    {
