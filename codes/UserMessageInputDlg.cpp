...
void __fastcall UserMessageInputDlg__OnChangeInput(UserMessageInputDlg_o *this, const MethodInfo *method)
{
  ...
  sub_1B88554(&this->fields.changeName, Text);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A567E8 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_8638/*"MESSAGE_CHANGE_TITLE"*/);
    sub_1B885B0(&StringLiteral_3757/*"COMMON_CONFIRM_DECIDE"*/);
    sub_1B885B0(&StringLiteral_3755/*"COMMON_CONFIRM_CANCEL"*/);
    sub_1B885B0(&StringLiteral_8636/*"MESSAGE_CHANGE_EXPLANATION"*/);
    byte_4A567E8 = 1;
  }
  ...
  sub_1B88554(&this->fields.changeName, message);
  this->fields.baseName = message;
  sub_1B88554(&this->fields.baseName, message);
  this->fields.callbackFunc = callback;
  sub_1B88554(&this->fields.callbackFunc, callback);
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8638/*"MESSAGE_CHANGE_TITLE"*/, 0LL);
  if ( !titleLabel )
    goto LABEL_15;
  UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL);
  explanationLabel = this->fields.explanationLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8636/*"MESSAGE_CHANGE_EXPLANATION"*/, 0LL);
  if ( !explanationLabel )
    goto LABEL_15;
  ...
  v13 = (UIInput_OnValidate_o *)sub_1B887FC(UIInput_OnValidate_TypeInfo);
  UIInput_OnValidate___ctor(v13, 0LL, Method_EmojiUtility_ValidateNameText__, 0LL);
  if ( !inputTarget )
    goto LABEL_15;
  inputTarget->fields.onValidate = v13;
  sub_1B88554(&inputTarget->fields.onValidate, v13);
        ...
        const MethodInfo *method)
{
  ...
  if ( ((unsigned __int8)IsNullOrEmpty & 1) != 0 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    IsNullOrEmpty = LocalizationManager__Get((System_String_o *)StringLiteral_8637/*"MESSAGE_CHANGE_NO_INPUT"*/, 0LL);
    if ( inputTarget )
    {
