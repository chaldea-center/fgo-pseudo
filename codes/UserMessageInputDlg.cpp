...
void __fastcall UserMessageInputDlg__OnChangeInput(UserMessageInputDlg_o *this, const MethodInfo *method)
{
  ...
  sub_1B8FFB4(&this->fields.changeName);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B4C8 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_UnityEngine_Component_GetComponent_Collider___, v7);
    sub_1B90010(&Method_EmojiUtility_ValidateNameText__, v8);
    sub_1B90010(&LocalizationManager_TypeInfo, v9);
    sub_1B90010(&UIInput_OnValidate_TypeInfo, v10);
    sub_1B90010(&Method_SupportDeckNameInputMenu_EndOpen__, v11);
    sub_1B90010(&StringLiteral_8642/*"MESSAGE_CHANGE_TITLE"*/, v12);
    sub_1B90010(&StringLiteral_3758/*"COMMON_CONFIRM_DECIDE"*/, v13);
    sub_1B90010(&StringLiteral_3756/*"COMMON_CONFIRM_CANCEL"*/, v14);
    sub_1B90010(&StringLiteral_8640/*"MESSAGE_CHANGE_EXPLANATION"*/, v15);
    byte_4A6B4C8 = 1;
  }
  ...
  sub_1B8FFB4(&this->fields.baseName);
        ...
        const MethodInfo *method)
{
  if ( (byte_4A6B4CC & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_3197/*"BaseWindow/CancleButton"*/, method);
    byte_4A6B4CC = 1;
  }
  return (System_String_o *)StringLiteral_3197/*"BaseWindow/CancleButton"*/;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B4CB & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_8641/*"MESSAGE_CHANGE_NO_INPUT"*/, v5);
    byte_4A6B4CB = 1;
  }
