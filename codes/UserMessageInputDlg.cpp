...
void UserMessageInputDlg__OnChangeInput(UserMessageInputDlg_o *this, const MethodInfo *method)
{
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.changeName, (int32_t)Text, v6, v7, v8, v9, v10, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFFA46 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_8734/*"MESSAGE_CHANGE_TITLE"*/);
    sub_1CE6700(&StringLiteral_3715/*"COMMON_CONFIRM_DECIDE"*/);
    sub_1CE6700(&StringLiteral_3713/*"COMMON_CONFIRM_CANCEL"*/);
    sub_1CE6700(&StringLiteral_8732/*"MESSAGE_CHANGE_EXPLANATION"*/);
    byte_4DFFA46 = 1;
  }
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.changeName, (int32_t)message, v9, v10, v11, v12, v13, v14);
  this->fields.baseName = message;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.baseName, (int32_t)message, v15, v16, v17, v18, v19, v20);
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8734/*"MESSAGE_CHANGE_TITLE"*/, 0);
  if ( !titleLabel )
    goto LABEL_15;
  UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0);
  explanationLabel = this->fields.explanationLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8732/*"MESSAGE_CHANGE_EXPLANATION"*/, 0);
  if ( !explanationLabel )
    goto LABEL_15;
  ...
  v31 = (UIInput_OnValidate_o *)sub_1CE694C(UIInput_OnValidate_TypeInfo);
...
System_String_o *UserMessageInputDlg__get_closeBtnPath(UserMessageInputDlg_o *this, const MethodInfo *method)
{
  if ( (byte_4DFFA4A & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_3093/*"BaseWindow/CancleButton"*/);
    byte_4DFFA4A = 1;
  }
  return (System_String_o *)StringLiteral_3093/*"BaseWindow/CancleButton"*/;
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&LocalizationManager_TypeInfo);
    sub_1CE6700(&StringLiteral_8733/*"MESSAGE_CHANGE_NO_INPUT"*/);
    byte_4DFFA49 = 1;
  }
  ...
  if ( ((unsigned __int8)IsNullOrEmpty & 1) != 0 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    IsNullOrEmpty = LocalizationManager__Get((System_String_o *)StringLiteral_8733/*"MESSAGE_CHANGE_NO_INPUT"*/, 0);
    if ( inputTarget )
    {
