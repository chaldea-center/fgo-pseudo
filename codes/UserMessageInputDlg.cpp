        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1D2D7 & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_EmojiUtility_ValidateNameText__, v8);
    sub_1C3B764(&LocalizationManager_TypeInfo, v9);
    sub_1C3B764(&UIInput_OnValidate_TypeInfo, v10);
    sub_1C3B764(&Method_SupportDeckNameInputMenu_EndOpen__, v11);
    sub_1C3B764(&StringLiteral_8816/*"MetadataClassType"*/, v12);
    sub_1C3B764(&StringLiteral_3800/*"COSTUME_SELECT_SERVANT_EVENT_ITEM_COSTUME_MSG"*/, v13);
    sub_1C3B764(&StringLiteral_3798/*"COSTUME_OPEN_WARNING"*/, v14);
    sub_1C3B764(&StringLiteral_8814/*"MessageShake/LogMark/BackLogButton"*/, v15);
    byte_4C1D2D7 = 1;
  }
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8816/*"MetadataClassType"*/, 0LL);
  if ( !titleLabel )
    goto LABEL_15;
  UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL);
  explanationLabel = this->fields.explanationLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8814/*"MessageShake/LogMark/BackLogButton"*/, 0LL);
  if ( !explanationLabel )
    goto LABEL_15;
  ...
  v22 = (UIInput_OnValidate_o *)sub_1C3B9B0(UIInput_OnValidate_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1D2DA & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_8815/*"MessageType"*/, v5);
    byte_4C1D2DA = 1;
  }
  ...
  if ( ((unsigned __int8)IsNullOrEmpty & 1) != 0 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    IsNullOrEmpty = LocalizationManager__Get((System_String_o *)StringLiteral_8815/*"MessageType"*/, 0LL);
    if ( inputTarget )
    {
