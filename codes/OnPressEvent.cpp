void __fastcall OnPressEvent___ctor(OnPressEvent_o *this, const MethodInfo *method)
{
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.onPressDown, (int64_t)v4, v5, v6, v7, v8, v9, v10);
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.onPressUp, (int64_t)v11, v12, v13, v14, v15, v16, v17);
...
void __fastcall OnPressEvent__OnPress(OnPressEvent_o *this, bool isPressed, const MethodInfo *method)
{
  ...
  if ( (byte_4BB84DF & 1) == 0 )
  {
    sub_1C13D24(&EventDelegate_TypeInfo, isPressed);
    byte_4BB84DF = 1;
  }
  if ( isPressed )
  ...
  EventDelegate__Execute_47802740(onPressDown, 0LL);
}