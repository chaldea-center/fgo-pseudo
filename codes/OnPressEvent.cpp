void __fastcall OnPressEvent___ctor(OnPressEvent_o *this, const MethodInfo *method)
{
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.onPressDown, (int32_t)v4, v5, v6);
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.onPressUp, (int32_t)v7, v8, v9);
...
void __fastcall OnPressEvent__OnPress(OnPressEvent_o *this, bool isPressed, const MethodInfo *method)
{
  ...
  if ( (byte_4A73AF2 & 1) == 0 )
  {
    sub_1B90010(&EventDelegate_TypeInfo, isPressed);
    byte_4A73AF2 = 1;
  }
  if ( isPressed )
  ...
  EventDelegate__Execute_46818200(onPressDown, 0LL);
}