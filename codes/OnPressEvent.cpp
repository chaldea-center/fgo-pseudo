void __fastcall OnPressEvent___ctor(OnPressEvent_o *this, const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.onPressDown, (int32_t)v4, v5, v6);
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.onPressUp, (int32_t)v7, v8, v9);
...
void __fastcall OnPressEvent__OnPress(OnPressEvent_o *this, bool isPressed, const MethodInfo *method)
{
  ...
  if ( (byte_4B48BC7 & 1) == 0 )
  {
    sub_1BDB878(&EventDelegate_TypeInfo, isPressed);
    byte_4B48BC7 = 1;
  }
  if ( isPressed )
  ...
  EventDelegate__Execute_48515104(onPressDown, 0LL);
}