void AiFieldEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CB5E72 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_19084/*"enemyMasterEffectType"*/);
    sub_1C6BA08(&StringLiteral_24819/*"voicePlay"*/);
    byte_4CB5E72 = 1;
  }
  AiFieldEntity_TypeInfo->static_fields->KEY_VOICE_NAME = (struct System_String_o *)StringLiteral_24819/*"voicePlay"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)AiFieldEntity_TypeInfo->static_fields, StringLiteral_24819/*"voicePlay"*/, v1, v2);
  v3 = StringLiteral_19084/*"enemyMasterEffectType"*/;
  static_fields = AiFieldEntity_TypeInfo->static_fields;
  static_fields->KEY_EFFECT_TYPE = (struct System_String_o *)StringLiteral_19084/*"enemyMasterEffectType"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)&static_fields->KEY_EFFECT_TYPE, v3, v5, v6);
}
...
float AiFieldEntity__GetCutinAdditionalTime(AiFieldEntity_o *this, float def, const MethodInfo *method)
{
  ...
  return EntityScriptUtil__GetFloatValue(this->fields.script, (System_String_o *)StringLiteral_18455/*"cutinAdditionalTime"*/, def, 0);
}
...
int32_t AiFieldEntity__GetFieldHp(AiFieldEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB5E6F & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_19477/*"fieldHp"*/);
    byte_4CB5E6F = 1;
  }
  return AiBaseEntity__getScriptIntParam((AiBaseEntity_o *)this, (System_String_o *)StringLiteral_19477/*"fieldHp"*/, -1, v2);
}
...
int32_t AiFieldEntity__GetFieldUIId(AiFieldEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB5E70 & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_19484/*"fieldHpUiId"*/);
    byte_4CB5E70 = 1;
  }
  return AiBaseEntity__getScriptIntParam((AiBaseEntity_o *)this, (System_String_o *)StringLiteral_19484/*"fieldHpUiId"*/, -1, v2);
}
...
bool AiFieldEntity__isForcedSkillSpeedOne(AiFieldEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB5E6E & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_19624/*"forcedSkillSpeed"*/);
    byte_4CB5E6E = 1;
  }
  return AiBaseEntity__getScriptIntParam((AiBaseEntity_o *)this, (System_String_o *)StringLiteral_19624/*"forcedSkillSpeed"*/, 0, v2) == 1;
}
        ...
        const MethodInfo *method)
{
  ...
  v5 = state - 2;
  return (unsigned int)(state - 2) <= 0x17 && ((0xBA2F15u >> v5) & 1) != 0 && this->fields.timing == dword_D20FC4[v5];
}