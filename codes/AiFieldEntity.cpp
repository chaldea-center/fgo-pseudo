void AiFieldEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C42B69 & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_19035/*"enemyMasterEffectType"*/);
    sub_1C37058(&StringLiteral_24709/*"voicePlay"*/);
    byte_4C42B69 = 1;
  }
  AiFieldEntity_TypeInfo->static_fields->KEY_VOICE_NAME = (struct System_String_o *)StringLiteral_24709/*"voicePlay"*/;
  sub_1C36FFC((CGThumbnailListItem_o *)AiFieldEntity_TypeInfo->static_fields, StringLiteral_24709/*"voicePlay"*/, v1, v2);
  v3 = StringLiteral_19035/*"enemyMasterEffectType"*/;
  static_fields = AiFieldEntity_TypeInfo->static_fields;
  static_fields->KEY_EFFECT_TYPE = (struct System_String_o *)StringLiteral_19035/*"enemyMasterEffectType"*/;
  sub_1C36FFC((CGThumbnailListItem_o *)&static_fields->KEY_EFFECT_TYPE, v3, v5, v6);
}
...
float AiFieldEntity__GetCutinAdditionalTime(AiFieldEntity_o *this, float def, const MethodInfo *method)
{
  ...
  return EntityScriptUtil__GetFloatValue(this->fields.script, (System_String_o *)StringLiteral_18424/*"cutinAdditionalTime"*/, def, 0);
}
...
int32_t AiFieldEntity__GetFieldHp(AiFieldEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C42B66 & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_19416/*"fieldHp"*/);
    byte_4C42B66 = 1;
  }
  return AiBaseEntity__getScriptIntParam((AiBaseEntity_o *)this, (System_String_o *)StringLiteral_19416/*"fieldHp"*/, -1, v2);
}
...
int32_t AiFieldEntity__GetFieldUIId(AiFieldEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C42B67 & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_19423/*"fieldHpUiId"*/);
    byte_4C42B67 = 1;
  }
  return AiBaseEntity__getScriptIntParam((AiBaseEntity_o *)this, (System_String_o *)StringLiteral_19423/*"fieldHpUiId"*/, -1, v2);
}
...
bool AiFieldEntity__isForcedSkillSpeedOne(AiFieldEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C42B65 & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_19561/*"forcedSkillSpeed"*/);
    byte_4C42B65 = 1;
  }
  return AiBaseEntity__getScriptIntParam((AiBaseEntity_o *)this, (System_String_o *)StringLiteral_19561/*"forcedSkillSpeed"*/, 0, v2) == 1;
}
        ...
        const MethodInfo *method)
{
  ...
  v5 = state - 2;
  return (unsigned int)(state - 2) <= 0x17 && ((0xBA2F15u >> v5) & 1) != 0 && this->fields.timing == dword_C48B30[v5];
}