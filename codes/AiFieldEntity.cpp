void AiFieldEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E045ED & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_19287/*"enemyMasterEffectType"*/);
    sub_1CE6700(&StringLiteral_25119/*"voicePlay"*/);
    byte_4E045ED = 1;
  }
  AiFieldEntity_TypeInfo->static_fields->KEY_VOICE_NAME = (struct System_String_o *)StringLiteral_25119/*"voicePlay"*/;
  sub_1CE66A4(
    (GrandQuestFolderBoardItem_o *)AiFieldEntity_TypeInfo->static_fields,
    StringLiteral_25119/*"voicePlay"*/,
    v1,
    v2,
    v3,
    v4,
    v5,
    v6);
  v7 = StringLiteral_19287/*"enemyMasterEffectType"*/;
  static_fields = AiFieldEntity_TypeInfo->static_fields;
  static_fields->KEY_EFFECT_TYPE = (struct System_String_o *)StringLiteral_19287/*"enemyMasterEffectType"*/;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&static_fields->KEY_EFFECT_TYPE, v7, v9, v10, v11, v12, v13, v14);
}
...
float AiFieldEntity__GetCutinAdditionalTime(AiFieldEntity_o *this, float def, const MethodInfo *method)
{
  ...
  return EntityScriptUtil__GetFloatValue(this->fields.script, (System_String_o *)StringLiteral_18643/*"cutinAdditionalTime"*/, def, 0);
}
...
int32_t AiFieldEntity__GetFieldHp(AiFieldEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E045E9 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_19686/*"fieldHp"*/);
    byte_4E045E9 = 1;
  }
  return AiBaseEntity__getScriptIntParam((AiBaseEntity_o *)this, (System_String_o *)StringLiteral_19686/*"fieldHp"*/, -1, v2);
}
...
int32_t AiFieldEntity__GetFieldUIId(AiFieldEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E045EA & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_19692/*"fieldHpUiId"*/);
    byte_4E045EA = 1;
  }
  return AiBaseEntity__getScriptIntParam((AiBaseEntity_o *)this, (System_String_o *)StringLiteral_19692/*"fieldHpUiId"*/, -1, v2);
}
...
System_String_o *AiFieldEntity__get_FirstTimeSaveKey(AiFieldEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E045EC & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_6743/*"FieldAi_{0}_{1}"*/);
    byte_4E045EC = 1;
  }
  id = this->fields.id;
  ...
  return System_String__Format_65164136((System_String_o *)StringLiteral_6743/*"FieldAi_{0}_{1}"*/, v3, v4, 0);
}
...
bool AiFieldEntity__isForcedSkillSpeedOne(AiFieldEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E045E8 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_19837/*"forcedSkillSpeed"*/);
    byte_4E045E8 = 1;
  }
  return AiBaseEntity__getScriptIntParam((AiBaseEntity_o *)this, (System_String_o *)StringLiteral_19837/*"forcedSkillSpeed"*/, 0, v2) == 1;
}
        ...
        const MethodInfo *method)
{
  ...
  v5 = state - 2;
  return (unsigned int)(state - 2) <= 0x17 && ((0xBA2F15u >> v5) & 1) != 0 && this->fields.timing == dword_D59BB0[v5];
}