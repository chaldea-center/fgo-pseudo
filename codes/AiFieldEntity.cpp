void __fastcall AiFieldEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A4E0A7 & 1) == 0 )
  {
    sub_1B863B8(&AiFieldEntity_TypeInfo, v1);
    sub_1B863B8(&StringLiteral_18797/*"enemyMasterEffectType"*/, v4);
    sub_1B863B8(&StringLiteral_24427/*"voicePlay"*/, v5);
    byte_4A4E0A7 = 1;
  }
  AiFieldEntity_TypeInfo->static_fields->KEY_VOICE_NAME = (struct System_String_o *)StringLiteral_24427/*"voicePlay"*/;
  sub_1B8635C((CGThumbnailListItem_o *)AiFieldEntity_TypeInfo->static_fields, StringLiteral_24427/*"voicePlay"*/, v2, v3);
  v6 = StringLiteral_18797/*"enemyMasterEffectType"*/;
  static_fields = AiFieldEntity_TypeInfo->static_fields;
  static_fields->KEY_EFFECT_TYPE = (struct System_String_o *)StringLiteral_18797/*"enemyMasterEffectType"*/;
  sub_1B8635C((CGThumbnailListItem_o *)&static_fields->KEY_EFFECT_TYPE, v6, v8, v9);
}
...
float __fastcall AiFieldEntity__GetCutinAdditionalTime(AiFieldEntity_o *this, float def, const MethodInfo *method)
{
  ...
  return EntityScriptUtil__GetFloatValue(this->fields.script, (System_String_o *)StringLiteral_18191/*"cutinAdditionalTime"*/, def, 0LL);
}
...
int32_t __fastcall AiFieldEntity__GetFieldHp(AiFieldEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4E0A4 & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_19177/*"fieldHp"*/, method);
    byte_4A4E0A4 = 1;
  }
  return AiBaseEntity__getScriptIntParam((AiBaseEntity_o *)this, (System_String_o *)StringLiteral_19177/*"fieldHp"*/, -1, v2);
}
...
int32_t __fastcall AiFieldEntity__GetFieldUIId(AiFieldEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4E0A5 & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_19184/*"fieldHpUiId"*/, method);
    byte_4A4E0A5 = 1;
  }
  return AiBaseEntity__getScriptIntParam((AiBaseEntity_o *)this, (System_String_o *)StringLiteral_19184/*"fieldHpUiId"*/, -1, v2);
}
...
bool __fastcall AiFieldEntity__isForcedSkillSpeedOne(AiFieldEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4E0A3 & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_19323/*"forcedSkillSpeed"*/, method);
    byte_4A4E0A3 = 1;
  }
  return AiBaseEntity__getScriptIntParam((AiBaseEntity_o *)this, (System_String_o *)StringLiteral_19323/*"forcedSkillSpeed"*/, 0, v2) == 1;
}
        ...
        const MethodInfo *method)
{
  ...
  v5 = state - 2;
  return (unsigned int)(state - 2) <= 0x17 && ((0xBA2F15u >> v5) & 1) != 0 && this->fields.timing == dword_BFCBD8[v5];
}