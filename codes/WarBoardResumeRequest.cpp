        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFEAC & 1) == 0 )
  {
    this = (WarBoardResumeRequest_o *)sub_1B64870(&StringLiteral_23384/*"stageId"*/, warBoardData);
    byte_49FFEAC = 1;
  }
  if ( !warBoardData )
...
System_String_o *__fastcall WarBoardResumeRequest__getURL(WarBoardResumeRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FFEAB & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_24524/*"warBoard/resume"*/, v2);
    byte_49FFEAB = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61383576(BaseUrl, (System_String_o *)StringLiteral_24524/*"warBoard/resume"*/, 0LL);
}
