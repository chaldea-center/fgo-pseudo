        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A004CD & 1) == 0 )
  {
    this = (WarBoardResumeRequest_o *)sub_1B64A00(&StringLiteral_23384/*"stageId"*/, warBoardData);
    byte_4A004CD = 1;
  }
  if ( !warBoardData )
    sub_1B64C5C(this, warBoardData);
  id = WarBoardData__get_id(warBoardData, 0LL);
  RequestBase__addField(v4, (System_String_o *)StringLiteral_23384/*"stageId"*/, id, v6);
...
System_String_o *__fastcall WarBoardResumeRequest__getURL(WarBoardResumeRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A004CC & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_24524/*"warBoard/resume"*/, v2);
    byte_4A004CC = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61385136(BaseUrl, (System_String_o *)StringLiteral_24524/*"warBoard/resume"*/, 0LL);
}
