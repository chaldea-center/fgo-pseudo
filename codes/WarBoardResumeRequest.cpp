        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_438D219 & 1) == 0 )
  {
    this = (WarBoardResumeRequest_o *)sub_B775C4(&StringLiteral_22736/*"stageId"*/);
    byte_438D219 = 1;
  }
  if ( !warBoardData )
    sub_B7769C(this, warBoardData);
  id = WarBoardData__get_id(warBoardData, 0LL);
  RequestBase__addField(v4, (System_String_o *)StringLiteral_22736/*"stageId"*/, id, 0LL);
...
System_String_o *__fastcall WarBoardResumeRequest__getURL(WarBoardResumeRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_438D218 & 1) == 0 )
  {
    ...
    sub_B775C4(&StringLiteral_23691/*"warBoard/resume"*/);
    byte_438D218 = 1;
  }
  ...
  return System_String__Concat_44901936(BaseUrl, (System_String_o *)StringLiteral_23691/*"warBoard/resume"*/, 0LL);
}
