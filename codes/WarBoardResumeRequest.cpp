        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C44C22 & 1) == 0 )
  {
    this = (WarBoardResumeRequest_o *)sub_1C37058(&StringLiteral_23648/*"stageId"*/);
    byte_4C44C22 = 1;
  }
  if ( !warBoardData )
    sub_1C372B4(this);
  id = WarBoardData__get_id(warBoardData, 0);
  RequestBase__addField(v4, (System_String_o *)StringLiteral_23648/*"stageId"*/, id, v6);
...
System_String_o *WarBoardResumeRequest__getURL(WarBoardResumeRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C44C21 & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_24738/*"warBoard/resume"*/);
    byte_4C44C21 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63561656(BaseUrl, (System_String_o *)StringLiteral_24738/*"warBoard/resume"*/, 0);
}
