        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDDB1 & 1) == 0 )
  {
    this = (WarBoardResumeRequest_o *)sub_1B640C8(&StringLiteral_23380/*"stageId"*/, warBoardData);
    byte_49FDDB1 = 1;
  }
  if ( !warBoardData )
    sub_1B64324(this);
  id = WarBoardData__get_id(warBoardData, 0LL);
  RequestBase__addField(v4, (System_String_o *)StringLiteral_23380/*"stageId"*/, id, v6);
...
System_String_o *__fastcall WarBoardResumeRequest__getURL(WarBoardResumeRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FDDB0 & 1) == 0 )
  {
    ...
    sub_1B640C8(&StringLiteral_24520/*"warBoard/resume"*/, v2);
    byte_49FDDB0 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61375396(BaseUrl, (System_String_o *)StringLiteral_24520/*"warBoard/resume"*/, 0LL);
}
