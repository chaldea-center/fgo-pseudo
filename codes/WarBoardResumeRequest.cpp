        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB6156 & 1) == 0 )
  {
    this = (WarBoardResumeRequest_o *)sub_1C13D24(&StringLiteral_23865/*"squareIndexes"*/, warBoardData);
    byte_4BB6156 = 1;
  }
  if ( !warBoardData )
    sub_1C13F80(this, warBoardData);
  id = WarBoardData__get_id(warBoardData, 0LL);
  RequestBase__addField(v4, (System_String_o *)StringLiteral_23865/*"squareIndexes"*/, id, 0LL);
...
System_String_o *__fastcall WarBoardResumeRequest__getURL(WarBoardResumeRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB6155 & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_25017/*"voluntary_ctxt_switches"*/, v2);
    byte_4BB6155 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62967944(BaseUrl, (System_String_o *)StringLiteral_25017/*"voluntary_ctxt_switches"*/, 0LL);
}
