        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B21D8 & 1) == 0 )
  {
    this = (WarBoardResumeRequest_o *)sub_B52984(&StringLiteral_22450/*"stageId"*/);
    byte_42B21D8 = 1;
  }
  if ( !warBoardData )
    sub_B52A5C(this, warBoardData);
  id = WarBoardData__get_id(warBoardData, 0LL);
  RequestBase__addField(v4, (System_String_o *)StringLiteral_22450/*"stageId"*/, id, 0LL);
...
System_String_o *__fastcall WarBoardResumeRequest__getURL(WarBoardResumeRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B21D7 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_23400/*"warBoard/resume"*/);
    byte_42B21D7 = 1;
  }
  ...
  return System_String__Concat_44568316(BaseUrl, (System_String_o *)StringLiteral_23400/*"warBoard/resume"*/, 0LL);
}
