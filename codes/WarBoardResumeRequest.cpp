        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A71850 & 1) == 0 )
  {
    this = (WarBoardResumeRequest_o *)sub_1B90010(&StringLiteral_23514/*"stageId"*/, warBoardData);
    byte_4A71850 = 1;
  }
  if ( !warBoardData )
    sub_1B9026C(this, warBoardData);
  id = WarBoardData__get_id(warBoardData, 0LL);
  RequestBase__addField(v4, (System_String_o *)StringLiteral_23514/*"stageId"*/, id, 0LL);
...
System_String_o *__fastcall WarBoardResumeRequest__getURL(WarBoardResumeRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A7184F & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_24658/*"warBoard/resume"*/, v2);
    byte_4A7184F = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61787092(BaseUrl, (System_String_o *)StringLiteral_24658/*"warBoard/resume"*/, 0LL);
}
