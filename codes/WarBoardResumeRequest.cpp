        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C39628 & 1) == 0 )
  {
    this = (WarBoardResumeRequest_o *)sub_1C32C20(&StringLiteral_23644/*"stageId"*/);
    byte_4C39628 = 1;
  }
  if ( !warBoardData )
    sub_1C32E7C(this);
  id = WarBoardData__get_id(warBoardData, 0);
  RequestBase__addField(v4, (System_String_o *)StringLiteral_23644/*"stageId"*/, id, v6);
...
System_String_o *WarBoardResumeRequest__getURL(WarBoardResumeRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C39627 & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_24733/*"warBoard/resume"*/);
    byte_4C39627 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63518544(BaseUrl, (System_String_o *)StringLiteral_24733/*"warBoard/resume"*/, 0);
}
