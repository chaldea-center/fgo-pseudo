...
void __fastcall FortuneBonusBoxAction__Awake(FortuneBonusBoxAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB132F & 1) == 0 )
  {
    sub_1C13D24(&Method_CStateManager_FortuneBonusBoxAction___ctor__, method);
    sub_1C13D24(&Method_CStateManager_FortuneBonusBoxAction__add__, v3);
    sub_1C13D24(&CStateManager_FortuneBonusBoxAction__TypeInfo, v4);
    sub_1C13D24(&FortuneBonusBoxAction_StateNone_TypeInfo, v5);
    sub_1C13D24(&FortuneBonusBoxAction_StatePlay_TypeInfo, v6);
    byte_4BB132F = 1;
  }
  if ( !this->fields.fsm )
  {
    v7 = (CStateManager_T__o *)sub_1C13F70(CStateManager_FortuneBonusBoxAction__TypeInfo);
    CStateManager_object____ctor(
      v7,
      (Il2CppObject *)this,
      2,
      (const MethodInfo_31C327C *)Method_CStateManager_FortuneBonusBoxAction___ctor__);
    ...
    v15 = (Il2CppObject *)sub_1C13F70(FortuneBonusBoxAction_StateNone_TypeInfo);
    ...
    if ( !fsm
      || (CStateManager_object___add(
            ...
            0,
            (IState_T__o *)v15,
            (const MethodInfo_31C3324 *)Method_CStateManager_FortuneBonusBoxAction__add__),
          v18 = (CStateManager_T__o *)this->fields.fsm,
          v19 = (Il2CppObject *)sub_1C13F70(FortuneBonusBoxAction_StatePlay_TypeInfo),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB1331 & 1) == 0 )
  {
    sub_1C13D24(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, endAct);
    byte_4BB1331 = 1;
  }
...
void __fastcall FortuneBonusBoxAction__SetState(FortuneBonusBoxAction_o *this, int32_t state, const MethodInfo *method)
{
  ...
  if ( (byte_4BB1335 & 1) == 0 )
  {
    sub_1C13D24(&Method_CStateManager_FortuneBonusBoxAction__setState__, *(_QWORD *)&state);
    byte_4BB1335 = 1;
  }
  fsm = (CStateManager_T__o *)this->fields.fsm;
  if ( !fsm )
  ...
  CStateManager_object___setState(
    fsm,
    state,
    (const MethodInfo_31C33B0 *)Method_CStateManager_FortuneBonusBoxAction__setState__);
}
...
void __fastcall FortuneBonusBoxAction__Update(FortuneBonusBoxAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB1330 & 1) == 0 )
  {
    sub_1C13D24(&Method_CStateManager_FortuneBonusBoxAction__update__, method);
    byte_4BB1330 = 1;
  }
  fsm = (CStateManager_T__o *)this->fields.fsm;
  if ( fsm )
    CStateManager_object___update(fsm, (const MethodInfo_31C338C *)Method_CStateManager_FortuneBonusBoxAction__update__);
}
