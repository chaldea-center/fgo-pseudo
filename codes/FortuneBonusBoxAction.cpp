...
void FortuneBonusBoxAction__Awake(FortuneBonusBoxAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEAF9F & 1) == 0 )
  {
    sub_1C7BAE8(&Method_CStateManager_FortuneBonusBoxAction___ctor__);
    sub_1C7BAE8(&Method_CStateManager_FortuneBonusBoxAction__add__);
    sub_1C7BAE8(&CStateManager_FortuneBonusBoxAction__TypeInfo);
    sub_1C7BAE8(&FortuneBonusBoxAction_StateNone_TypeInfo);
    sub_1C7BAE8(&FortuneBonusBoxAction_StatePlay_TypeInfo);
    byte_4CEAF9F = 1;
  }
  if ( !this->fields.fsm )
  {
    v3 = (CStateManager_T__o *)sub_1C7BD34(CStateManager_FortuneBonusBoxAction__TypeInfo);
    CStateManager_object____ctor(
      v3,
      (Il2CppObject *)this,
      2,
      (const MethodInfo_33B93F0 *)Method_CStateManager_FortuneBonusBoxAction___ctor__);
    ...
    v11 = (Il2CppObject *)sub_1C7BD34(FortuneBonusBoxAction_StateNone_TypeInfo);
    ...
    if ( !fsm
      || (CStateManager_object___add(
            ...
            0,
            (IState_T__o *)v11,
            (const MethodInfo_33B9498 *)Method_CStateManager_FortuneBonusBoxAction__add__),
          v14 = (CStateManager_T__o *)this->fields.fsm,
          v15 = (Il2CppObject *)sub_1C7BD34(FortuneBonusBoxAction_StatePlay_TypeInfo),
...
void FortuneBonusBoxAction__SetState(FortuneBonusBoxAction_o *this, int32_t state, const MethodInfo *method)
{
  ...
  if ( (byte_4CEAFA5 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_CStateManager_FortuneBonusBoxAction__setState__);
    byte_4CEAFA5 = 1;
  }
  fsm = (CStateManager_T__o *)this->fields.fsm;
  if ( !fsm )
  ...
  CStateManager_object___setState(
    fsm,
    state,
    (const MethodInfo_33B9524 *)Method_CStateManager_FortuneBonusBoxAction__setState__);
}
...
void FortuneBonusBoxAction__Update(FortuneBonusBoxAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEAFA0 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_CStateManager_FortuneBonusBoxAction__update__);
    byte_4CEAFA0 = 1;
  }
  fsm = (CStateManager_T__o *)this->fields.fsm;
  if ( fsm )
    CStateManager_object___update(fsm, (const MethodInfo_33B9500 *)Method_CStateManager_FortuneBonusBoxAction__update__);
}
