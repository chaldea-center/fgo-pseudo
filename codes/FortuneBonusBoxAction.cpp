...
void __fastcall FortuneBonusBoxAction__Awake(FortuneBonusBoxAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48DF676 & 1) == 0 )
  {
    sub_1B00CCC(&Method_CStateManager_FortuneBonusBoxAction___ctor__, method);
    sub_1B00CCC(&Method_CStateManager_FortuneBonusBoxAction__add__, v3);
    sub_1B00CCC(&CStateManager_FortuneBonusBoxAction__TypeInfo, v4);
    sub_1B00CCC(&FortuneBonusBoxAction_StateNone_TypeInfo, v5);
    sub_1B00CCC(&FortuneBonusBoxAction_StatePlay_TypeInfo, v6);
    byte_48DF676 = 1;
  }
  if ( !this->fields.fsm )
  {
    v7 = (CStateManager_T__o *)sub_1B00F18(CStateManager_FortuneBonusBoxAction__TypeInfo);
    CStateManager_object____ctor(
      v7,
      (Il2CppObject *)this,
      2,
      (const MethodInfo_2F73E64 *)Method_CStateManager_FortuneBonusBoxAction___ctor__);
    ...
    v11 = (Il2CppObject *)sub_1B00F18(FortuneBonusBoxAction_StateNone_TypeInfo);
    ...
    if ( !fsm
      || (CStateManager_object___add(
            ...
            0,
            (IState_T__o *)v11,
            (const MethodInfo_2F73F0C *)Method_CStateManager_FortuneBonusBoxAction__add__),
          v14 = (CStateManager_T__o *)this->fields.fsm,
          v15 = (Il2CppObject *)sub_1B00F18(FortuneBonusBoxAction_StatePlay_TypeInfo),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DF678 & 1) == 0 )
  {
    sub_1B00CCC(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, endAct);
    byte_48DF678 = 1;
  }
...
void __fastcall FortuneBonusBoxAction__SetState(FortuneBonusBoxAction_o *this, int32_t state, const MethodInfo *method)
{
  ...
  if ( (byte_48DF67C & 1) == 0 )
  {
    sub_1B00CCC(&Method_CStateManager_FortuneBonusBoxAction__setState__, *(_QWORD *)&state);
    byte_48DF67C = 1;
  }
  fsm = (CStateManager_T__o *)this->fields.fsm;
  if ( !fsm )
  ...
  CStateManager_object___setState(
    fsm,
    state,
    (const MethodInfo_2F73F98 *)Method_CStateManager_FortuneBonusBoxAction__setState__);
}
...
void __fastcall FortuneBonusBoxAction__Update(FortuneBonusBoxAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48DF677 & 1) == 0 )
  {
    sub_1B00CCC(&Method_CStateManager_FortuneBonusBoxAction__update__, method);
    byte_48DF677 = 1;
  }
  fsm = (CStateManager_T__o *)this->fields.fsm;
  if ( fsm )
    CStateManager_object___update(fsm, (const MethodInfo_2F73F74 *)Method_CStateManager_FortuneBonusBoxAction__update__);
}
