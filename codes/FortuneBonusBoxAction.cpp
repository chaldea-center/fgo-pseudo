...
void __fastcall FortuneBonusBoxAction__Awake(FortuneBonusBoxAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B4157F & 1) == 0 )
  {
    sub_1BDB878(&Method_CStateManager_FortuneBonusBoxAction___ctor__, method);
    sub_1BDB878(&Method_CStateManager_FortuneBonusBoxAction__add__, v3);
    sub_1BDB878(&CStateManager_FortuneBonusBoxAction__TypeInfo, v4);
    sub_1BDB878(&FortuneBonusBoxAction_StateNone_TypeInfo, v5);
    sub_1BDB878(&FortuneBonusBoxAction_StatePlay_TypeInfo, v6);
    byte_4B4157F = 1;
  }
  if ( !this->fields.fsm )
  {
    v7 = (CStateManager_T__o *)sub_1BDBAC4(CStateManager_FortuneBonusBoxAction__TypeInfo);
    CStateManager_object____ctor(
      v7,
      (Il2CppObject *)this,
      2,
      (const MethodInfo_3270084 *)Method_CStateManager_FortuneBonusBoxAction___ctor__);
    ...
    v11 = (Il2CppObject *)sub_1BDBAC4(FortuneBonusBoxAction_StateNone_TypeInfo);
    ...
    if ( !fsm
      || (CStateManager_object___add(
            ...
            0,
            (IState_T__o *)v11,
            (const MethodInfo_327012C *)Method_CStateManager_FortuneBonusBoxAction__add__),
          v14 = (CStateManager_T__o *)this->fields.fsm,
          v15 = (Il2CppObject *)sub_1BDBAC4(FortuneBonusBoxAction_StatePlay_TypeInfo),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B41581 & 1) == 0 )
  {
    sub_1BDB878(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, endAct);
    byte_4B41581 = 1;
  }
...
void __fastcall FortuneBonusBoxAction__SetState(FortuneBonusBoxAction_o *this, int32_t state, const MethodInfo *method)
{
  ...
  if ( (byte_4B41585 & 1) == 0 )
  {
    sub_1BDB878(&Method_CStateManager_FortuneBonusBoxAction__setState__, *(_QWORD *)&state);
    byte_4B41585 = 1;
  }
  fsm = (CStateManager_T__o *)this->fields.fsm;
  if ( !fsm )
  ...
  CStateManager_object___setState(
    fsm,
    state,
    (const MethodInfo_32701B8 *)Method_CStateManager_FortuneBonusBoxAction__setState__);
}
...
void __fastcall FortuneBonusBoxAction__Update(FortuneBonusBoxAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B41580 & 1) == 0 )
  {
    sub_1BDB878(&Method_CStateManager_FortuneBonusBoxAction__update__, method);
    byte_4B41580 = 1;
  }
  fsm = (CStateManager_T__o *)this->fields.fsm;
  if ( fsm )
    CStateManager_object___update(fsm, (const MethodInfo_3270194 *)Method_CStateManager_FortuneBonusBoxAction__update__);
}
