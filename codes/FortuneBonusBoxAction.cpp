...
void __fastcall FortuneBonusBoxAction__Awake(FortuneBonusBoxAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B319B & 1) == 0 )
  {
    sub_B52984(&Method_CStateManager_FortuneBonusBoxAction___ctor__);
    sub_B52984(&Method_CStateManager_FortuneBonusBoxAction__add__);
    sub_B52984(&CStateManager_FortuneBonusBoxAction__TypeInfo);
    sub_B52984(&FortuneBonusBoxAction_StateNone_TypeInfo);
    sub_B52984(&FortuneBonusBoxAction_StatePlay_TypeInfo);
    byte_42B319B = 1;
  }
  if ( !this->fields.fsm )
  {
    v3 = (CStateManager_QAASpotStateController_IMapSpot__o *)sub_B52A54(CStateManager_FortuneBonusBoxAction__TypeInfo);
    CStateManager_QAASpotStateController_IMapSpot____ctor(
      v3,
      (QAASpotStateController_IMapSpot_o *)this,
      2,
      (const MethodInfo_2B925C4 *)Method_CStateManager_FortuneBonusBoxAction___ctor__);
    ...
    fsm = this->fields.fsm;
    v11 = (FortuneBonusBoxAction_StateNone_o *)sub_B52A54(FortuneBonusBoxAction_StateNone_TypeInfo);
    ...
    if ( !fsm
      || (CStateManager_QAASpotStateController_IMapSpot___add(
            ...
            0,
            (IState_T__o *)v11,
            (const MethodInfo_2B92690 *)Method_CStateManager_FortuneBonusBoxAction__add__),
          v14 = this->fields.fsm,
          v15 = (FortuneBonusBoxAction_StatePlay_o *)sub_B52A54(FortuneBonusBoxAction_StatePlay_TypeInfo),
...
void __fastcall FortuneBonusBoxAction__SetState(FortuneBonusBoxAction_o *this, int32_t state, const MethodInfo *method)
{
  ...
  if ( (byte_42B31A1 & 1) == 0 )
  {
    sub_B52984(&Method_CStateManager_FortuneBonusBoxAction__setState__);
    byte_42B31A1 = 1;
  }
  fsm = this->fields.fsm;
  if ( !fsm )
  ...
  CStateManager_QAASpotStateController_IMapSpot___setState(
    (CStateManager_QAASpotStateController_IMapSpot__o *)fsm,
    state,
    (const MethodInfo_2B92734 *)Method_CStateManager_FortuneBonusBoxAction__setState__);
}
...
void __fastcall FortuneBonusBoxAction__Update(FortuneBonusBoxAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B319C & 1) == 0 )
  {
    sub_B52984(&Method_CStateManager_FortuneBonusBoxAction__update__);
    byte_42B319C = 1;
  }
  fsm = this->fields.fsm;
  if ( fsm )
    CStateManager_QAASpotStateController_IMapSpot___update(
      (CStateManager_QAASpotStateController_IMapSpot__o *)fsm,
      (const MethodInfo_2B9270C *)Method_CStateManager_FortuneBonusBoxAction__update__);
}
