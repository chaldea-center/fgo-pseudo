...
void __fastcall FortuneBonusBoxAction__Awake(FortuneBonusBoxAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1C82F & 1) == 0 )
  {
    sub_1B715CC(&Method_CStateManager_FortuneBonusBoxAction___ctor__, method);
    sub_1B715CC(&Method_CStateManager_FortuneBonusBoxAction__add__, v3);
    sub_1B715CC(&CStateManager_FortuneBonusBoxAction__TypeInfo, v4);
    sub_1B715CC(&FortuneBonusBoxAction_StateNone_TypeInfo, v5);
    sub_1B715CC(&FortuneBonusBoxAction_StatePlay_TypeInfo, v6);
    byte_4A1C82F = 1;
  }
  if ( !this->fields.fsm )
  {
    v7 = (CStateManager_T__o *)sub_1B71818(CStateManager_FortuneBonusBoxAction__TypeInfo);
    CStateManager_object____ctor(
      v7,
      (Il2CppObject *)this,
      2,
      (const MethodInfo_308625C *)Method_CStateManager_FortuneBonusBoxAction___ctor__);
    ...
    v11 = (Il2CppObject *)sub_1B71818(FortuneBonusBoxAction_StateNone_TypeInfo);
    ...
    if ( !fsm
      || (CStateManager_object___add(
            ...
            0,
            (IState_T__o *)v11,
            (const MethodInfo_3086304 *)Method_CStateManager_FortuneBonusBoxAction__add__),
          v14 = (CStateManager_T__o *)this->fields.fsm,
          v15 = (Il2CppObject *)sub_1B71818(FortuneBonusBoxAction_StatePlay_TypeInfo),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C831 & 1) == 0 )
  {
    sub_1B715CC(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, endAct);
    byte_4A1C831 = 1;
  }
...
void __fastcall FortuneBonusBoxAction__SetState(FortuneBonusBoxAction_o *this, int32_t state, const MethodInfo *method)
{
  ...
  if ( (byte_4A1C835 & 1) == 0 )
  {
    sub_1B715CC(&Method_CStateManager_FortuneBonusBoxAction__setState__, *(_QWORD *)&state);
    byte_4A1C835 = 1;
  }
  fsm = (CStateManager_T__o *)this->fields.fsm;
  if ( !fsm )
  ...
  CStateManager_object___setState(
    fsm,
    state,
    (const MethodInfo_3086390 *)Method_CStateManager_FortuneBonusBoxAction__setState__);
}
...
void __fastcall FortuneBonusBoxAction__Update(FortuneBonusBoxAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1C830 & 1) == 0 )
  {
    sub_1B715CC(&Method_CStateManager_FortuneBonusBoxAction__update__, method);
    byte_4A1C830 = 1;
  }
  fsm = (CStateManager_T__o *)this->fields.fsm;
  if ( fsm )
    CStateManager_object___update(fsm, (const MethodInfo_308636C *)Method_CStateManager_FortuneBonusBoxAction__update__);
}
