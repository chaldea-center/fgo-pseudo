...
void __fastcall FortuneBonusBoxAction__Awake(FortuneBonusBoxAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1EB67 & 1) == 0 )
  {
    sub_1C3B764(&Method_CStateManager_FortuneBonusBoxAction___ctor__, method);
    sub_1C3B764(&Method_CStateManager_FortuneBonusBoxAction__add__, v3);
    sub_1C3B764(&CStateManager_FortuneBonusBoxAction__TypeInfo, v4);
    sub_1C3B764(&FortuneBonusBoxAction_StateNone_TypeInfo, v5);
    sub_1C3B764(&FortuneBonusBoxAction_StatePlay_TypeInfo, v6);
    byte_4C1EB67 = 1;
  }
  if ( !this->fields.fsm )
  {
    v7 = (CStateManager_T__o *)sub_1C3B9B0(CStateManager_FortuneBonusBoxAction__TypeInfo);
    CStateManager_object____ctor(
      v7,
      (Il2CppObject *)this,
      2,
      (const MethodInfo_3225B48 *)Method_CStateManager_FortuneBonusBoxAction___ctor__);
    ...
    v15 = (Il2CppObject *)sub_1C3B9B0(FortuneBonusBoxAction_StateNone_TypeInfo);
    ...
    if ( !fsm
      || (CStateManager_object___add(
            ...
            0,
            (IState_T__o *)v15,
            (const MethodInfo_3225BF0 *)Method_CStateManager_FortuneBonusBoxAction__add__),
          v18 = (CStateManager_T__o *)this->fields.fsm,
          v19 = (Il2CppObject *)sub_1C3B9B0(FortuneBonusBoxAction_StatePlay_TypeInfo),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1EB69 & 1) == 0 )
  {
    sub_1C3B764(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, endAct);
    byte_4C1EB69 = 1;
  }
...
void __fastcall FortuneBonusBoxAction__SetState(FortuneBonusBoxAction_o *this, int32_t state, const MethodInfo *method)
{
  ...
  if ( (byte_4C1EB6D & 1) == 0 )
  {
    sub_1C3B764(&Method_CStateManager_FortuneBonusBoxAction__setState__, *(_QWORD *)&state);
    byte_4C1EB6D = 1;
  }
  fsm = (CStateManager_T__o *)this->fields.fsm;
  if ( !fsm )
  ...
  CStateManager_object___setState(
    fsm,
    state,
    (const MethodInfo_3225C7C *)Method_CStateManager_FortuneBonusBoxAction__setState__);
}
...
void __fastcall FortuneBonusBoxAction__Update(FortuneBonusBoxAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1EB68 & 1) == 0 )
  {
    sub_1C3B764(&Method_CStateManager_FortuneBonusBoxAction__update__, method);
    byte_4C1EB68 = 1;
  }
  fsm = (CStateManager_T__o *)this->fields.fsm;
  if ( fsm )
    CStateManager_object___update(fsm, (const MethodInfo_3225C58 *)Method_CStateManager_FortuneBonusBoxAction__update__);
}
