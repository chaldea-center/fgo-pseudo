void __fastcall EventItemWindowMaker___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AFE141 & 1) == 0 )
  {
    sub_1BC3008(&EventItemWindowMaker_TypeInfo, v1);
  ...
  *(_OWORD *)&static_fields->LIMIT_OVER_WINDOW_BASE_HEIGHT = xmmword_BDDE90;
  *(_OWORD *)&static_fields->LIMIT_OVER_WINDOW_ADD_HEIGHT = xmmword_BDDB10;
  *(_OWORD *)&static_fields->NORMAL_DEFAULT_COUNT = xmmword_BDF2E0;
  *(_QWORD *)&static_fields->MAX_ROWS_NORMAL = 0x300000003LL;
  static_fields->MAX_ROWS_LIMIT_OVER = 4;
  v10 = (struct System_Single_array *)sub_1BC30B0(float___TypeInfo, 2LL);
  if ( !v10 )
    goto LABEL_11;
...
LABEL_10:
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&v16->X_NORMAL_POSITIONS, (int32_t)v15, v12, v13);
  v17 = (System_Array_o *)sub_1BC30B0(float___TypeInfo, 3LL);
  v47.fields.value = Field__PrivateImplementationDetails__71D1A658FF2FA50F7694FC8A7C287C2CD9B92497C646C79707C0C81D99C20327;
  v18 = v17;
  System_Runtime_CompilerServices_RuntimeHelpers__InitializeArray_63047724(v17, v47, 0LL);
  v19 = EventItemWindowMaker_TypeInfo->static_fields;
  v19->Y_NORMAL_POSITIONS = (struct System_Single_array *)v18;
  sub_1BC2FAC((CGThumbnailListItem_o *)&v19->Y_NORMAL_POSITIONS, (int32_t)v18, v20, v21);
...
LABEL_11:
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&v35->X_LIMIT_OVER_TWO_POSITIONS, (int32_t)v15, v12, v33);
  EventItemWindowMaker_TypeInfo->static_fields->Y_LIMIT_OVER_ONE = 51.0;
  v36 = (System_Array_o *)sub_1BC30B0(int___TypeInfo, 4LL);
  ...
  System_Runtime_CompilerServices_RuntimeHelpers__InitializeArray_63047724(v36, v50, 0LL);
  v38 = (CGThumbnailListItem_o *)EventItemWindowMaker_TypeInfo->static_fields;
  v38[1].klass = v37;
  sub_1BC2FAC(v38 + 1, (int32_t)v37, v39, v40);
  v41 = (System_Array_o *)sub_1BC30B0(int___TypeInfo, 5LL);
  v51.fields.value = Field__PrivateImplementationDetails__3FB54EFF0CF17DC7FF006FA7182D1C99659ED820E3E1B626643EC55951FE13BD;
  v42 = v41;
  System_Runtime_CompilerServices_RuntimeHelpers__InitializeArray_63047724(v41, v51, 0LL);
  v43 = EventItemWindowMaker_TypeInfo->static_fields;
  v43->LIMIT_OVER_ITEM_BASE_WINDOW_HEIGHT = (struct System_Int32_array *)v42;
  sub_1BC2FAC((CGThumbnailListItem_o *)&v43->LIMIT_OVER_ITEM_BASE_WINDOW_HEIGHT, (int32_t)v42, v44, v45);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFE13D & 1) == 0 )
  {
    sub_1BC3008(&EventItemWindowMaker_TypeInfo, *(_QWORD *)&index);
    byte_4AFE13D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFE138 & 1) == 0 )
  {
    sub_1BC3008(&EventItemWindowMaker_TypeInfo, *(_QWORD *)&count);
    byte_4AFE138 = 1;
  }
  if ( !EventItemWindowMaker_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(EventItemWindowMaker_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFE13E & 1) == 0 )
  {
    sub_1BC3008(&EventItemWindowMaker_TypeInfo, isForcedAdjustment);
    byte_4AFE13E = 1;
  }
...
float __fastcall EventItemWindowMaker__GetItemBaseWindowX(const MethodInfo *method)
{
  ...
  {
    sub_1BC3008(&EventItemWindowMaker_TypeInfo, v1);
    sub_1BC3008(&FSUtility_TypeInfo, v2);
    byte_4AFE139 = 1;
  }
...
int32_t __fastcall EventItemWindowMaker__GetMaxColumns(bool isLimitOverWindow, const MethodInfo *method)
{
  ...
  if ( (byte_4AFE13F & 1) == 0 )
  {
    sub_1BC3008(&EventItemWindowMaker_TypeInfo, method);
    byte_4AFE13F = 1;
  }
  v3 = EventItemWindowMaker_TypeInfo;
  if ( !EventItemWindowMaker_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFE137 & 1) == 0 )
  {
    sub_1BC3008(&EventItemWindowMaker_TypeInfo, v2);
...
int32_t __fastcall EventItemWindowMaker__GetRowCount(int32_t count, int32_t maxColumns, const MethodInfo *method)
{
  ...
  if ( !byte_4AFC46F )
  {
    sub_1BC3008(&System_Math_TypeInfo, *(_QWORD *)&maxColumns);
    byte_4AFC46F = 1;
  }
  if ( !System_Math_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
