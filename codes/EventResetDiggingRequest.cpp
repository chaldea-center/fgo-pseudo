        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_434E8C7 & 1) == 0 )
  {
    ...
    sub_B70694(&StringLiteral_18743/*"event/resetDigging"*/);
    byte_434E8C7 = 1;
  }
  ...
  return System_String__Concat_44758168(BaseUrl, (System_String_o *)StringLiteral_18743/*"event/resetDigging"*/, 0LL);
}
