        ...
        const MethodInfo *method)
{
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_17172/*"areaNum"*/, areaNum, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDDE9B & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_19450/*"event/resetDigging"*/);
    byte_4BDDE9B = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63115476(BaseUrl, (System_String_o *)StringLiteral_19450/*"event/resetDigging"*/, 0LL);
}
