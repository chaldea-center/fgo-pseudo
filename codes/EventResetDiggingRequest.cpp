        ...
        const MethodInfo *method)
{
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_16887/*"areaNum"*/, areaNum, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5C9FA & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_19122/*"event/resetDigging"*/);
    byte_4A5C9FA = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61707032(BaseUrl, (System_String_o *)StringLiteral_19122/*"event/resetDigging"*/, 0LL);
}
