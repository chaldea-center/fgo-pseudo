void __fastcall MstMissionMaster___ctor(MstMissionMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4BDC914 & 1) == 0 )
  {
    sub_1C21E38(&Method_DataMasterBase_MstMissionMaster__MstMissionEntity__int___ctor__);
    byte_4BDC914 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    160,
    (const MethodInfo_3259AA4 *)Method_DataMasterBase_MstMissionMaster__MstMissionEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDC916 & 1) == 0 )
  {
    sub_1C21E38(&Method_System_Collections_ObjectModel_Collection_MstMissionEntity__get_Count__);
    sub_1C21E38(&Method_System_Collections_ObjectModel_Collection_MstMissionEntity__get_Item__);
    sub_1C21E38(&Method_System_Collections_Generic_List_MstMissionEntity__Add__);
    sub_1C21E38(&Method_System_Collections_Generic_List_MstMissionEntity__ToArray__);
  ...
  v3 = (System_Collections_Generic_List_object__o *)sub_1C22084(System_Collections_Generic_List_MstMissionEntity__TypeInfo);
  ...
  Time = System_Collections_ObjectModel_Collection_object___get_Count(
           ...
           (const MethodInfo_31F60CC *)Method_System_Collections_ObjectModel_Collection_MstMissionEntity__get_Count__);
  if ( (int)Time >= 1 )
  {
    v7 = Time;
    v8 = 0;
    while ( 1 )
    {
      ...
      Time = (int64_t)System_Collections_ObjectModel_Collection_object___get_Item(
                        ...
                        v8,
                        (const MethodInfo_31F615C *)Method_System_Collections_ObjectModel_Collection_MstMissionEntity__get_Item__);
      if ( Time )
      {
        v5 = Time;
...
LABEL_18:
  ...
  return (MstMissionEntity_array *)System_Collections_Generic_List_object___ToArray(
                                     v3,
                                     (const MethodInfo_3650C0C *)Method_System_Collections_Generic_List_MstMissionEntity__ToArray__);
}
        ...
        const MethodInfo *method)
{
  ...
  v7 = (System_Collections_Generic_List_object__o *)sub_1C22084(System_Collections_Generic_List_MstMissionEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v7,
    (const MethodInfo_364E880 *)Method_System_Collections_Generic_List_MstMissionEntity___ctor__);
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
      ...
      if ( Time )
      {
        ...
        if ( v10 >= v20 && v10 < *(_QWORD *)(Time + 48) )
        {
          ...
          else
          {
            ...
            sub_1C21DDC((PartyOrganizationUtility_o *)(v25 + 4), v9, v14, v15, v16, v17, v18, v19);
          }
        }
      }
      if ( v12 == ++v13 )
