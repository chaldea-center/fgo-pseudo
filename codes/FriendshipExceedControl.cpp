void __fastcall FriendshipExceedControl___ctor(FriendshipExceedControl_o *this, const MethodInfo *method)
{
  ...
  this->fields.NORMAL_COLOR = (struct UnityEngine_Color_o)xmmword_BF7A60;
...
void __fastcall FriendshipExceedControl__InitButtons(FriendshipExceedControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB804F & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_FriendshipExceedControl_OnClickExecute__, v5);
    this = (FriendshipExceedControl_o *)sub_1C13D24(&Method_System_Collections_Generic_List_EventDelegate__Add__, v6);
    byte_4BB804F = 1;
  }
  if ( !v2->fields.isButtonInitialized )
  {
    ...
    EventDelegate___ctor_47827852(v10, v9, 0LL);
    if ( !onClick )
      goto LABEL_24;
    ...
    else
    {
      ...
      sub_1C13CC8((PartyOrganizationUtility_o *)(v20 + 4), (int64_t)v10, v11, v12, v13, v14, v15, v16);
    }
    ...
    v23 = (EventDelegate_Callback_o *)sub_1C13F70(EventDelegate_Callback_TypeInfo);
    EventDelegate_Callback___ctor(v23, (Il2CppObject *)v2, (intptr_t)v2->klass->vtable._5_OnClickHelp.methodPtr, 0LL);
    v24 = (EventDelegate_o *)sub_1C13F70(EventDelegate_TypeInfo);
    EventDelegate___ctor_47827852(v24, v23, 0LL);
    if ( !v22 )
      goto LABEL_24;
    ...
    v37 = (EventDelegate_Callback_o *)sub_1C13F70(EventDelegate_Callback_TypeInfo);
    EventDelegate_Callback___ctor(
      v37,
      (Il2CppObject *)v2,
      (intptr_t)Method_CombineMenuControl_OnLongPushListView__,
      0LL);
    v38 = (EventDelegate_o *)sub_1C13F70(EventDelegate_TypeInfo);
    EventDelegate___ctor_47827852(v38, v37, 0LL);
    if ( !onLongPress
...
LABEL_24:
    ...
    else
    {
      ...
      sub_1C13CC8((PartyOrganizationUtility_o *)(v48 + 4), (int64_t)v38, v39, v40, v41, v42, v43, v44);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB804D & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_8934/*"MSG_CAMPAIGN_COMBINE_EXP"*/, v4);
    byte_4BB804D = 1;
  }
  ...
  if ( v5->static_fields->DisableFriendshipExceed <= 0 )
  {
    ...
    gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_8934/*"MSG_CAMPAIGN_COMBINE_EXP"*/, 0LL);
...
void __fastcall FriendshipExceedControl__InitInfo(FriendshipExceedControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB804E & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_System_Collections_Generic_List_LimitCntUpItemComponent__get_Item__, v9);
...
void __fastcall FriendshipExceedControl__OnClickExecute(FriendshipExceedControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB8058 & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_3875/*"CONFIRM_TICKETSUMMON_MSG2"*/, v3);
    byte_4BB8058 = 1;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_3875/*"CONFIRM_TICKETSUMMON_MSG2"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(characterGraphic, 0LL, 0LL) )
  {
    ...
    *p_characterGraphic = 0LL;
    sub_1C13CC8((PartyOrganizationUtility_o *)p_characterGraphic, 0LL, v7, v8, v9, v10, v11, v12);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB8056 & 1) == 0 )
  {
    sub_1C13D24(&Method_DataManager_GetMasterData_ServantLimitImageMaster___, entity);
  ...
  baseUserServantEntity = (UserServantEntity_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3869BD8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !baseUserServantEntity )
    goto LABEL_15;
  ...
  *(_QWORD *)&v32.fields.fakeValue = v19;
  baseUserServantEntity = (UserServantEntity_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47490608(
                                                   v32,
                                                   0LL);
  if ( !v18 )
    goto LABEL_15;
  ...
  if ( UnityEngine_Object__op_Equality(characterGraphic, 0LL, 0LL) )
  {
    TexturePrefab_39052248 = CharaGraphManager__CreateTexturePrefab_39052248(
                               ...
                               0,
                               0LL);
    this->fields.characterGraphic = TexturePrefab_39052248;
    sub_1C13CC8(
  ...
  if ( !*p_characterGraphic )
LABEL_15:
    sub_1C13F80(baseUserServantEntity, v14);
...
void __fastcall FriendshipExceedControl__SetEntities(FriendshipExceedControl_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&v45.fields.fakeValue = v13;
  Instance = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47490608(v45, 0LL);
  if ( !v12 )
    goto LABEL_24;
  ...
  *(_OWORD *)&v43.fields.fakeValue = v17;
  ...
  v42 = v43;
  Instance = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_47494132(&v42, 0LL);
  v19 = this->fields.baseUserServantEntity;
  if ( !v19 )
    goto LABEL_24;
  v20 = Instance;
  Instance = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47490608(v19->fields.svtId, 0LL);
  if ( !v18 )
    goto LABEL_24;
...
LABEL_24:
  ...
  *(_QWORD *)&v46.fields.fakeValue = v41;
  this->fields.isFriendshipRankMax = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47490608(v46, 0LL) == HIDWORD(v15[6].klass) + friendshipExceedCount;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !combineTextImage )
LABEL_38:
    sub_1C13F80(combineTextImage, method);
  v11 = v10;
  v12 = v10;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB8059 & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_7522/*"INFO"*/, v5);
    sub_1C13D24(&StringLiteral_8929/*"MSG_ABLED_FRIENDSHIP_EXCEED"*/, v6);
    sub_1C13D24(&StringLiteral_5895/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_TITLE"*/, v7);
    ...
    if ( this->fields.isFriendshipRankMax )
    {
      if ( this->fields.isItemEnough )
      {
        ...
        if ( LocalizationManager_TypeInfo->_2.cctor_finished )
        {
          ...
          {
LABEL_15:
            v11 = &StringLiteral_5895/*"EXCHANGE_SVT_COIN_SLIDER_ALERT_DIALOG_TITLE"*/;
            goto LABEL_8;
          }
        }
        else
        ...
        v19 = &StringLiteral_12325/*"SHOP_SELL_SERVANT_QP_WILL_BE_MAX_ALERT_MESSAGE"*/;
      }
      else
      {
        detailInfoLabel = this->fields.detailInfoLabel;
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        v19 = &StringLiteral_12324/*"SHOP_SELL_SERVANT_QP_WILL_BE_MAX_ALERT_GETABLE"*/;
      }
    }
    else
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v19 = &StringLiteral_8929/*"MSG_ABLED_FRIENDSHIP_EXCEED"*/;
    }
...
LABEL_36:
      sub_1C13F80(limitCntUpItemComponentList, method);
    v7 = 8LL;
    while ( 1 )
    {
      v8 = v7 - 8;
      ...
      if ( (__int64)v8 < (int)max_length )
      {
        ...
        *(_OWORD *)&v25.fields.fakeValue = v18;
        if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
        v24 = v25;
        limitCntUpItemComponentList = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_47494132(&v24, 0LL);
...
LABEL_38:
          sub_1C13F88(limitCntUpItemComponentList, method);
        if ( !v19 )
          goto LABEL_36;
...
void __fastcall FriendshipExceedControl__SetRequiredQpInfo(FriendshipExceedControl_o *this, const MethodInfo *method)
{
  ...
  v5 = System_Int32__ToString_63773552((int)this + 324, (System_String_o *)StringLiteral_9383/*"MyRoomFrontObj"*/, 0LL);
  if ( !requiredQpLabel )
    goto LABEL_11;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB8052 & 1) == 0 )
  {
    sub_1C13D24(&CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo, selectData);
    byte_4BB8052 = 1;
  }
  if ( selectData )
  {
...
void __fastcall FriendshipExceedControl__SetUserQpInfo(FriendshipExceedControl_o *this, const MethodInfo *method)
{
  ...
  if ( !SelfUserGame
    || (userQpLabel = this->fields.userQpLabel,
        ...
        SelfUserGame = System_Int32__ToString_63773552((int)this + 320, (System_String_o *)StringLiteral_9383/*"MyRoomFrontObj"*/, 0LL),
        !userQpLabel) )
  {
...
void __fastcall FriendshipExceedControl__ShowItemListInfo(FriendshipExceedControl_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C13F80(preSelectBaseLabel, method);
  }
