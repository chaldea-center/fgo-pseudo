...
void __fastcall FriendshipExceedControl__InitButtons(FriendshipExceedControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_418A4A0 & 1) == 0 )
  {
    ...
    sub_B2C35C(&Method_FriendshipExceedControl_OnClickExecute__, v5);
    this = (FriendshipExceedControl_o *)sub_B2C35C(&Method_System_Collections_Generic_List_EventDelegate__Add__, v6);
    byte_418A4A0 = 1;
  }
  if ( !v2->fields.isButtonInitialized )
  {
    ...
    v10 = (EventDelegate_o *)sub_B2C42C(EventDelegate_TypeInfo);
    EventDelegate___ctor_29723424(v10, v9, 0LL);
    if ( !onClick )
      goto LABEL_12;
    ...
    if ( !baseServantTouchPress )
      goto LABEL_12;
    v12 = (System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData__o *)baseServantTouchPress->fields.onClick;
    v13 = (EventDelegate_Callback_o *)sub_B2C42C(EventDelegate_Callback_TypeInfo);
    EventDelegate_Callback___ctor(v13, (Il2CppObject *)v2, (intptr_t)v2->klass->vtable._5_OnClickHelp.methodPtr, 0LL);
    v14 = (EventDelegate_o *)sub_B2C42C(EventDelegate_TypeInfo);
    EventDelegate___ctor_29723424(v14, v13, 0LL);
    if ( !v12
      || (System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData___Add(
            v12,
            (EventMissionProgressRequest_Argument_ProgressData_o *)v14,
            (const MethodInfo_2EF4460 *)Method_System_Collections_Generic_List_EventDelegate__Add__),
          (v15 = v2->fields.baseServantTouchPress) == 0LL)
      || (onLongPress = (System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData__o *)v15->fields.onLongPress,
          v17 = (EventDelegate_Callback_o *)sub_B2C42C(EventDelegate_Callback_TypeInfo),
          EventDelegate_Callback___ctor(v17, (Il2CppObject *)v2, Method_CombineMenuControl_OnLongPushListView__, 0LL),
          v18 = (EventDelegate_o *)sub_B2C42C(EventDelegate_TypeInfo),
          EventDelegate___ctor_29723424(v18, v17, 0LL),
          !onLongPress) )
    {
LABEL_12:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_418A49E & 1) == 0 )
  {
    ...
    sub_B2C35C(&StringLiteral_8838/*"MSG_PRESELECT_BASE_FRIENDSHIP_EXCEED"*/, v4);
    byte_418A49E = 1;
  }
  ...
  if ( v5->static_fields->DisableFriendshipExceed <= 0 )
  {
    ...
    gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_8838/*"MSG_PRESELECT_BASE_FRIENDSHIP_EXCEED"*/, 0LL);
...
LABEL_29:
  ...
  while ( 1 )
  {
    ...
    splitImage = (UnityEngine_GameObject_o *)*((_QWORD *)&limitCntUpItemComponentList->fields._items->obj.klass + v25);
    if ( splitImage )
    {
      ...
      if ( v28 )
      {
        if ( v28->fields._size <= v27 )
          System_ThrowHelper__ThrowArgumentOutOfRangeException_41710740(0LL);
        splitImage = (UnityEngine_GameObject_o *)*((_QWORD *)&v28->fields._items->obj.klass + v25);
        if ( splitImage )
        {
          ...
          if ( splitImage )
          {
            ...
            if ( materialImages )
            {
              if ( materialImages->fields._size <= v27 )
                System_ThrowHelper__ThrowArgumentOutOfRangeException_41710740(0LL);
              splitImage = (UnityEngine_GameObject_o *)*((_QWORD *)&materialImages->fields._items->obj.klass + v25);
              if ( splitImage )
              {
...
void __fastcall FriendshipExceedControl__OnClickExecute(FriendshipExceedControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_418A4A9 & 1) == 0 )
  {
    ...
    sub_B2C35C(&StringLiteral_3332/*"CONFIRM_TITLE_FRIENDSHIP_EXCEED_COMBINE"*/, v3);
    byte_418A4A9 = 1;
  }
  if ( (BYTE3(LocalizationManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !LocalizationManager_TypeInfo->_2.cctor_finished )
  ...
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_3332/*"CONFIRM_TITLE_FRIENDSHIP_EXCEED_COMBINE"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(characterGraphic, 0LL, 0LL) )
  {
    ...
    *p_characterGraphic = 0LL;
    sub_B2C2F8((BattleServantConfConponent_o *)p_characterGraphic, 0LL, v7, v8, v9, v10, v11, v12);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_418A4A7 & 1) == 0 )
  {
    sub_B2C35C(&Method_DataManager_GetMasterData_ServantLimitImageMaster___, entity);
  ...
  *(_QWORD *)&v32.fields.fakeValue = v19;
  ...
  if ( UnityEngine_Object__op_Equality(characterGraphic, 0LL, 0LL) )
  {
    TexturePrefab_25402508 = CharaGraphManager__CreateTexturePrefab_25402508(
                               ...
                               0,
                               0LL);
    this->fields.characterGraphic = TexturePrefab_25402508;
    sub_B2C2F8(
  ...
  if ( !*p_characterGraphic )
LABEL_17:
    sub_B2C434(baseUserServantEntity, v14);
...
void __fastcall FriendshipExceedControl__SetEntities(FriendshipExceedControl_o *this, const MethodInfo *method)
{
  ...
  struct FriendshipEntity_o *v32; // x0
  ...
  *(_QWORD *)&v42.fields.fakeValue = v13;
  Instance = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_44758064(v42, 0LL);
  if ( !v12 )
    goto LABEL_22;
  ...
  *(_OWORD *)&v41.fields.currentCryptoKey = *(_OWORD *)&v16->fields.userId.fields.currentCryptoKey;
  *(_OWORD *)&v41.fields.fakeValue = v17;
  ...
  if ( !v19 )
    goto LABEL_22;
  v20 = Instance;
  Instance = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_44758064(v19->fields.svtId, 0LL);
  if ( !v18 )
    goto LABEL_22;
  ...
  if ( !Instance
    || (Instance = (int64_t)DataManager__GetMasterData_WarQuestSelectionMaster_(
                              (DataManager_o *)Instance,
                              (const MethodInfo_17339EC *)Method_DataManager_GetMasterData_FriendshipMaster___)) == 0
    || (v32 = FriendshipMaster__GetEntity(
                (FriendshipMaster_o *)Instance,
                Entity->fields.eventId,
                friendshipExceedCount + lastQuestId + 1,
                v31),
        this->fields._FriendshipEntity_k__BackingField = v32,
        sub_B2C2F8(
          (BattleServantConfConponent_o *)&this->fields._FriendshipEntity_k__BackingField,
          ...
          v37,
          v38),
        (v39 = this->fields.baseUserServantCollectionEntity) == 0LL) )
  {
LABEL_22:
    sub_B2C434(Instance, v10);
  }
  this->fields.isFriendshipRankMax = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_44758064(
                                       v39->fields.friendshipRank,
        ...
        const MethodInfo *method)
{
  ...
  if ( !combineTextImage )
LABEL_36:
    sub_B2C434(combineTextImage, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_418A4AA & 1) == 0 )
  {
    ...
    sub_B2C35C(&StringLiteral_7278/*"INFO_MSG_FRIENDSHIP_EXCEED"*/, v5);
    sub_B2C35C(&StringLiteral_8833/*"MSG_FRIENDSHIP_EXCEED_BASE"*/, v6);
    sub_B2C35C(&StringLiteral_5760/*"EXE_FRIENDSHIP_EXCEED_COMBINE_TXT"*/, v7);
    ...
    if ( this->fields.isFriendshipRankMax )
    {
      if ( this->fields.isItemEnough )
      {
        ...
        if ( this->fields.isQpEnough )
        {
          ...
          v11 = &StringLiteral_5760/*"EXE_FRIENDSHIP_EXCEED_COMBINE_TXT"*/;
LABEL_9:
...
LABEL_35:
    ...
    else
    {
      ...
      v18 = &StringLiteral_8833/*"MSG_FRIENDSHIP_EXCEED_BASE"*/;
    }
    v12 = LocalizationManager__Get((System_String_o *)*v18, 0LL);
    if ( detailInfoLabel )
    {
      UILabel__set_text(detailInfoLabel, v12, 0LL);
      v19 = this->fields.detailInfoLabel;
      *(UnityEngine_Color_o *)&r = UnityEngine_Color__get_white(0LL);
      if ( v19 )
      {
        v12 = (System_String_o *)v19;
        goto LABEL_35;
      }
    }
LABEL_36:
  ...
  if ( !state )
  {
    ...
    v11 = &StringLiteral_7278/*"INFO_MSG_FRIENDSHIP_EXCEED"*/;
    goto LABEL_9;
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_418A4A4 & 1) == 0 )
  {
    ...
    sub_B2C35C(&Method_System_Collections_Generic_List_LimitCntUpItemComponent__get_Item__, v4);
    this = (FriendshipExceedControl_o *)sub_B2C35C(&CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo, v5);
    byte_418A4A4 = 1;
  }
    ...
    while ( 1 )
    {
      ...
      if ( (int)v7 < (signed int)v15->max_length )
      {
        ...
        *(_OWORD *)&v27.fields.fakeValue = v18;
        ...
        v26 = v27;
        this = (FriendshipExceedControl_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_44761220(
                                              &v26,
                                              0LL);
...
void __fastcall FriendshipExceedControl__SetRequiredQpInfo(FriendshipExceedControl_o *this, const MethodInfo *method)
{
  ...
  v6 = System_Int32__ToString_38381416(v4, (System_String_o *)StringLiteral_9266/*"N0"*/, 0LL);
  if ( !requiredQpLabel )
LABEL_13:
    sub_B2C434(v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_418A4A3 & 1) == 0 )
  {
    sub_B2C35C(&CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo, selectData);
    byte_418A4A3 = 1;
  }
  if ( selectData )
  {
...
void __fastcall FriendshipExceedControl__SetUserQpInfo(FriendshipExceedControl_o *this, const MethodInfo *method)
{
  ...
  if ( !SelfUserGame
    || (userQpLabel = this->fields.userQpLabel,
        ...
        SelfUserGame = System_Int32__ToString_38381416((int)this + 256, (System_String_o *)StringLiteral_9266/*"N0"*/, 0LL),
        !userQpLabel) )
  {
...
void __fastcall FriendshipExceedControl__ShowItemListInfo(FriendshipExceedControl_o *this, const MethodInfo *method)
{
  ...
  {
    sub_B2C434(preSelectBaseLabel, method);
  }
