void __fastcall GachaPickupCollateralMaster___ctor(GachaPickupCollateralMaster_o *this, const MethodInfo *method)
{
  ...
  DataMasterBase_object__object__object____ctor(
    ...
    502,
    (const MethodInfo_30FFA98 *)Method_DataMasterBase_GachaPickupCollateralMaster__GachaPickupCollateralEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (GachaPickupCollateralEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                            (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                            PK,
                                            (const MethodInfo_30FFAD8 *)Method_DataMasterBase_GachaPickupCollateralMaster__GachaPickupCollateralEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_30FFB28 *)Method_DataMasterBase_GachaPickupCollateralMaster__GachaPickupCollateralEntity__string__TryGetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E1E0 & 1) == 0 )
  {
    ...
    sub_1B761C0(&GachaPickupCollateralEntity_TypeInfo, v7);
  ...
  *gachaPickupCollateralEntity = 0LL;
  sub_1B76164((ServantStatusBattleListViewItem_o *)gachaPickupCollateralEntity, 0, groupId, (int32_t)method);
    ...
    if ( v23 )
    {
        ...
        && v23->fields.gachaPickupCollateralGroupId == groupId )
      {
        *gachaPickupCollateralEntity = v23;
        sub_1B76164((ServantStatusBattleListViewItem_o *)gachaPickupCollateralEntity, (int32_t)v23, v24, v25);
        v27 = 1;
        goto LABEL_24;
      }
    }
