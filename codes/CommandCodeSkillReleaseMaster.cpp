void __fastcall CommandCodeSkillReleaseMaster___ctor(CommandCodeSkillReleaseMaster_o *this, const MethodInfo *method)
{
  if ( (byte_42B012B & 1) == 0 )
  {
    sub_B52984(&Method_DataMasterBase_CommandCodeSkillReleaseMaster__CommandCodeSkillReleaseEntity__string___ctor__);
    byte_42B012B = 1;
  }
  DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string____ctor(
    (DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string__o *)this,
    255,
    (const MethodInfo_23E268C *)Method_DataMasterBase_CommandCodeSkillReleaseMaster__CommandCodeSkillReleaseEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0129 & 1) == 0 )
  {
    sub_B52984(&Method_DataMasterBase_CommandCodeSkillReleaseMaster__CommandCodeSkillReleaseEntity__string__GetEntity__);
    byte_42B0129 = 1;
  }
  ...
  return (CommandCodeSkillReleaseEntity_o *)DataMasterBase_WarMessageMaster__WarMessageEntity__string___GetEntity(
                                              ...
                                              PK,
                                              (const MethodInfo_23E2728 *)Method_DataMasterBase_CommandCodeSkillReleaseMaster__CommandCodeSkillReleaseEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B012A & 1) == 0 )
  {
    sub_B52984(&Method_DataMasterBase_CommandCodeSkillReleaseMaster__CommandCodeSkillReleaseEntity__string__TryGetEntity__);
    byte_42B012A = 1;
  }
  ...
  return DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string___TryGetEntity(
           ...
           PK,
           (const MethodInfo_23E2780 *)Method_DataMasterBase_CommandCodeSkillReleaseMaster__CommandCodeSkillReleaseEntity__string__TryGetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  CommandCodeSkillReleaseEntity_o *v27; // [xsp+8h] [xbp-58h] BYREF

  if ( (byte_42B012C & 1) == 0 )
  {
    sub_B52984(&CommandCodeSkillReleaseEntity_TypeInfo);
  ...
  while ( 1 )
  {
    ...
    if ( *(_WORD *)(*lookup + 298) )
    {
      ...
      while ( *(v22 - 1) != System_Collections_Generic_IReadOnlyDictionary_string__DataEntityBase__TypeInfo )
      {
        ++v21;
        v22 += 2;
        if ( v21 >= *(unsigned __int16 *)(*lookup + 298) )
          goto LABEL_17;
      }
...
LABEL_17:
    ...
    if ( *(&v27->klass->_2.bitflags2 + 1) < (unsigned int)v14
      || (CommandCodeSkillReleaseEntity_c *)v27->klass->_2.typeHierarchy[v14 - 1] != CommandCodeSkillReleaseEntity_TypeInfo )
    {
      lookup = (__int64 *)sub_B52D50(v27);
LABEL_22:
      sub_B52A5C(lookup, v17);
    }
    ++v12;
    ...
    else
    {
      ...
      if ( v15 )
        return v15;
LABEL_11:
      isUse = CommandCodeSkillReleaseEntity__isUse(v27, beforeClearQuestId, v24);
    }
  }
}