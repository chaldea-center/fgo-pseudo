void __fastcall ClassBoardFigureController___ctor(ClassBoardFigureController_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B482C7 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_17547/*"btn_to_grand_servant_select"*/, v4);
    sub_1BDB878(&StringLiteral_20499/*"img_plus"*/, v5);
    sub_1BDB878(&StringLiteral_20602/*"img_text_base"*/, v6);
    byte_4B482C7 = 1;
  }
  this->fields.svtScale = 10.0;
  v7 = (System_Collections_Generic_List_object__o *)sub_1BDBAC4(System_Collections_Generic_List_StandFigureCollect__TypeInfo);
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.figureCollectList, (int32_t)v7, v8, v9);
  v10 = StringLiteral_17547/*"btn_to_grand_servant_select"*/;
  this->fields.selectServantSpriteName = (struct System_String_o *)StringLiteral_17547/*"btn_to_grand_servant_select"*/;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.selectServantSpriteName, v10, v11, v12);
  v13 = StringLiteral_20499/*"img_plus"*/;
  this->fields.selectServantPlusSpriteName = (struct System_String_o *)StringLiteral_20499/*"img_plus"*/;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.selectServantPlusSpriteName, v13, v14, v15);
  v16 = StringLiteral_20602/*"img_text_base"*/;
  this->fields.selectServantTxtBaseSpriteName = (struct System_String_o *)StringLiteral_20602/*"img_text_base"*/;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.selectServantTxtBaseSpriteName, v16, v17, v18);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B482C6 & 1) == 0 )
  {
    sub_1BDB878(&Method_ClassBoardFigureController_OnClickToGrandServantList__, method);
    byte_4B482C6 = 1;
  }
  classBoardController = this->fields.classBoardController;
  if ( !classBoardController )
    sub_1BDBAD4(0LL, method);
  if ( ClassBoardController__IsTouchEnableUi(classBoardController, 0LL) )
  {
    ...
    if ( (*((_BYTE *)Method_ClassBoardFigureController_OnClickToGrandServantList__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1BDB890(Method_ClassBoardFigureController_OnClickToGrandServantList__);
        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.onClickToGrandServantList, (int32_t)action, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B482C5 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMaster_GrandGraphMaster___, *(_QWORD *)&baseId);
    sub_1BDB878(&DataManager_TypeInfo, v7);
    sub_1BDB878(&LocalizationManager_TypeInfo, v8);
    sub_1BDB878(&StringLiteral_3411/*"CLASS_BOARD_CHOICE_GRAND_SERVANT_MSG"*/, v9);
    byte_4B482C5 = 1;
  }
  ...
  svtBase = (UnityEngine_GameObject_o *)DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_GrandGraphMaster___);
  if ( !svtBase )
    goto LABEL_17;
  ...
  if ( EntityByClassBoardBaseId )
  {
    ...
    v14 = LocalizationManager__Get((System_String_o *)StringLiteral_3411/*"CLASS_BOARD_CHOICE_GRAND_SERVANT_MSG"*/, 0LL);
...
LABEL_17:
    sub_1BDBAD4(svtBase, *(_QWORD *)&baseId);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BDBAD4(this, atlasManagerUnit);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B482C4 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_DataManager_GetMaster_UserServantMaster___, v9);
    ...
    sub_1BDB878(&Method_System_Linq_Enumerable_Any_SvtMultiPortraitEntity___, v13);
    ...
    sub_1BDB878(&Method_System_Collections_Generic_List_StandFigureCollect__Add__, v18);
    sub_1BDB878(&Method_System_Collections_Generic_List_SvtMultiPortraitEntity__GetEnumerator__, v19);
    sub_1BDB878(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, v20);
    sub_1BDB878(&StandFigureCollect_TypeInfo, v21);
    byte_4B482C4 = 1;
  }
  entity = 0LL;
  *(_QWORD *)value = 0LL;
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  svtBase = (UnityEngine_GameObject_o *)DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_UserServantMaster___);
  if ( !svtBase )
    goto LABEL_78;
  ...
  svtBase = (UnityEngine_GameObject_o *)DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_SvtMultiPortraitMaster___);
  if ( !entity )
    goto LABEL_78;
  ...
  *(_QWORD *)&v85.fields.fakeValue = monitor;
  svtBase = (UnityEngine_GameObject_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48227716(v85, 0LL);
  if ( !entity )
    goto LABEL_78;
  v27 = (int)svtBase;
  ...
  if ( !entity )
    goto LABEL_78;
  v28 = (int)svtBase;
  svtBase = (UnityEngine_GameObject_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48227716(
  ...
  if ( v31 == v32->static_fields->ServantLimitMax )
  {
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    svtBase = (UnityEngine_GameObject_o *)DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_ServantMaster___);
    if ( !entity )
      goto LABEL_78;
    ...
    *(_QWORD *)&v86.fields.fakeValue = v34;
    svtBase = (UnityEngine_GameObject_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48227716(v86, 0LL);
    if ( !v33 )
      goto LABEL_78;
    ...
    if ( ((unsigned __int8)svtBase & 1) != 0 )
    {
      ...
      if ( ((unsigned __int8)svtBase & 1) != 0 )
      {
        ...
        *(_QWORD *)&v87.fields.fakeValue = v36;
        v38 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48227716(v87, 0LL);
        v39 = value[1];
        v40 = v38;
  ...
  *(_QWORD *)&v88.fields.fakeValue = v41;
  svtBase = (UnityEngine_GameObject_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48227716(v88, 0LL);
  if ( !v24 )
    goto LABEL_78;
  ...
  {
    svtBase = (UnityEngine_GameObject_o *)StandFigureManager__CreateRenderPrefab_39764192(
                                            this->fields.svtBase,
                                            SvtId,
                                            v28,
                                            9,
    ...
    if ( svtBase )
    {
      ...
      if ( svtBase )
      {
        ...
        v73 = (StandFigureCollect_o *)sub_1BDBAC4(StandFigureCollect_TypeInfo);
...
LABEL_78:
  ...
  while ( 1 )
  {
    ...
    sub_1BDB81C(PrefabForImageId + 1, (int32_t)current, v50, v51);
    ...
    if ( commonPosition && (int)commonPosition->max_length >= 2 )
    {
      ...
      if ( !v57 )
        sub_1BDBAD4(gameObject, v55);
      max_length = v57->max_length;
      if ( max_length == 1 )
        sub_1BDBADC(gameObject, v55, v56);
      if ( !max_length )
        sub_1BDBADC(gameObject, v55, v56);
      GameObjectExtensions__AddLocalPosition_35212040(gameObject, (float)v57->m_Items[1], (float)v57->m_Items[2], 0LL);
    }
    ...
    v62 = (StandFigureCollect_o *)sub_1BDBAC4(StandFigureCollect_TypeInfo);
    ...
    else
    {
      ...
      sub_1BDB81C((CGThumbnailListItem_o *)(v70 + 4), (int32_t)v62, v65, v66);
    }
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.classBoardController, (int32_t)controller, (int32_t)method, v3);
}