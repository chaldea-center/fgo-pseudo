        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E79E31 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_7069/*"GRAND_BOND_EQUIP_TARGET_CONFIRM_DIALOG_MESSAGE_SERVANT_NAME"*/);
  ...
  if ( LocalizationManager__TryGet(
         &resultText,
         (System_String_o *)StringLiteral_7069/*"GRAND_BOND_EQUIP_TARGET_CONFIRM_DIALOG_MESSAGE_SERVANT_NAME"*/,
         ...
         0) )
  {
    ...
    v16 = System_String__Format_65604148(v14, RarityType, (Il2CppObject *)servantName, (Il2CppObject *)className, 0);
    if ( !messageLabel )
      sub_1D0F30C(v16, v17);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E79E2E & 1) == 0 )
  {
    sub_1D0F0B4(&GrandBondEquipTargetConfirmDialog_CallbackFunc_TypeInfo);
    byte_4E79E2E = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1B3FF50;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1B3FF08;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E79E33 & 1) == 0 )
  {
    sub_1D0F0B4(&GrandBondEquipTargetConfirmDialog_Result_TypeInfo);
    byte_4E79E33 = 1;
  }
  v9[1] = 0;
