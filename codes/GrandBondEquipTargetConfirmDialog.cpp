        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E07184 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_7042/*"GRAND_BOND_EQUIP_TARGET_CONFIRM_DIALOG_MESSAGE_SERVANT_NAME"*/);
  ...
  if ( LocalizationManager__TryGet(
         &resultText,
         (System_String_o *)StringLiteral_7042/*"GRAND_BOND_EQUIP_TARGET_CONFIRM_DIALOG_MESSAGE_SERVANT_NAME"*/,
         ...
         0) )
  {
    ...
    v16 = System_String__Format_65164204(v14, RarityType, (Il2CppObject *)servantName, (Il2CppObject *)className, 0);
    if ( !messageLabel )
      sub_1CE6958(v16, v17);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E07181 & 1) == 0 )
  {
    sub_1CE6700(&GrandBondEquipTargetConfirmDialog_CallbackFunc_TypeInfo);
    byte_4E07181 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1B1A0E8;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1B1A0A0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E07186 & 1) == 0 )
  {
    sub_1CE6700(&GrandBondEquipTargetConfirmDialog_Result_TypeInfo);
    byte_4E07186 = 1;
  }
  v9[1] = 0;
