        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C29BF2 & 1) == 0 )
  {
    sub_1C2D490(&GrandBondEquipTargetConfirmDialog_CallbackFunc_TypeInfo);
    byte_4C29BF2 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1A74480;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A74438;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C29BF6 & 1) == 0 )
  {
    sub_1C2D490(&GrandBondEquipTargetConfirmDialog_Result_TypeInfo);
    byte_4C29BF6 = 1;
  }
  v9[1] = 0;
  v9[0] = j_il2cpp_value_box_0(GrandBondEquipTargetConfirmDialog_Result_TypeInfo, &v10, callback, object, method);
