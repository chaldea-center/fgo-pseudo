        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB5B05 & 1) == 0 )
  {
    this = (CommonParticleControlComponent_o *)sub_1C13D24(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB5B09 & 1) == 0 )
  {
    sub_1C13D24(&Method_System_Collections_Generic_List_ParticleSystem__get_Count__, *(_QWORD *)&idx);
    sub_1C13D24(&Method_System_Collections_Generic_List_ParticleSystem__get_Item__, v7);
    byte_4BB5B09 = 1;
  }
  ...
  if ( particleParent->fields._size > idx )
  {
    particleParent = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___get_Item(
                                                                    particleParent,
                                                                    idx,
                                                                    (const MethodInfo_362CEFC *)Method_System_Collections_Generic_List_ParticleSystem__get_Item__);
    if ( particleParent )
      return UnityEngine_ParticleSystem__IsAlive((UnityEngine_ParticleSystem_o *)particleParent, withChildren, 0LL);
LABEL_8:
    sub_1C13F80(particleParent, *(_QWORD *)&idx);
  }
  return 0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB5B07 & 1) == 0 )
  {
    sub_1C13D24(&Method_System_Collections_Generic_List_ParticleSystem__get_Count__, withChildren);
    sub_1C13D24(&Method_System_Collections_Generic_List_ParticleSystem__get_Item__, v5);
    byte_4BB5B07 = 1;
  }
  particleParent = (System_Collections_Generic_List_object__o *)this->fields.particleParent;
  if ( !particleParent )
  ...
  while ( v7 < particleParent->fields._size )
  {
    ...
    if ( particleParent )
    {
      UnityEngine_ParticleSystem__Stop_71002532((UnityEngine_ParticleSystem_o *)particleParent, v8, 0LL);
      particleParent = (System_Collections_Generic_List_object__o *)this->fields.particleParent;
      ++v7;
      if ( particleParent )
        continue;
  ...
  if ( !particleParent )
LABEL_11:
    sub_1C13F80(particleParent, withChildren);
        ...
        const MethodInfo *method)
{
  ...
  if ( particleParent->fields._size > idx )
  {
    ...
    if ( particleParent )
    {
      UnityEngine_ParticleSystem__Stop_71002532((UnityEngine_ParticleSystem_o *)particleParent, withChildren, 0LL);
      return;
    }
LABEL_8:
    sub_1C13F80(particleParent, *(_QWORD *)&idx);
