        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDD98D & 1) == 0 )
  {
    this = (CommonParticleControlComponent_o *)sub_1C21E38(&Method_System_Collections_Generic_List_ParticleSystem__get_Count__);
    byte_4BDD98D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDD991 & 1) == 0 )
  {
    sub_1C21E38(&Method_System_Collections_Generic_List_ParticleSystem__get_Count__);
    sub_1C21E38(&Method_System_Collections_Generic_List_ParticleSystem__get_Item__);
    byte_4BDD991 = 1;
  }
  ...
  if ( particleParent->fields._size > idx )
  {
    particleParent = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___get_Item(
                                                                    particleParent,
                                                                    idx,
                                                                    (const MethodInfo_364EDE4 *)Method_System_Collections_Generic_List_ParticleSystem__get_Item__);
    if ( particleParent )
      return UnityEngine_ParticleSystem__IsAlive((UnityEngine_ParticleSystem_o *)particleParent, withChildren, 0LL);
LABEL_8:
    sub_1C22094(particleParent, *(_QWORD *)&idx);
  }
  return 0;
}
        ...
        const MethodInfo *method)
{
  ...
  while ( v6 < particleParent->fields._size )
  {
    ...
    if ( particleParent )
    {
      UnityEngine_ParticleSystem__Stop_71150156((UnityEngine_ParticleSystem_o *)particleParent, v7, 0LL);
      particleParent = (System_Collections_Generic_List_object__o *)this->fields.particleParent;
      ++v6;
      if ( particleParent )
        continue;
  ...
  if ( !particleParent )
LABEL_11:
    sub_1C22094(particleParent, withChildren);
        ...
        const MethodInfo *method)
{
  ...
  if ( particleParent->fields._size > idx )
  {
    ...
    if ( particleParent )
    {
      UnityEngine_ParticleSystem__Stop_71150156((UnityEngine_ParticleSystem_o *)particleParent, withChildren, 0LL);
      return;
    }
LABEL_8:
    sub_1C22094(particleParent, *(_QWORD *)&idx);
