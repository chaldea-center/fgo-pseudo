        ...
        const MethodInfo *method)
{
  ...
  v9 = (System_Collections_Generic_List_object__o *)sub_1C93D20(System_Collections_Generic_List_BattleLogicBattleScript_BattleScriptData__TypeInfo);
  ...
  if ( !logic
    ...
    || (items = ListBattleScriptData_k__BackingField->fields._items,
        ...
        !items) )
  {
    sub_1C93D2C(BattleScriptSystemData, v17);
  }
