        ...
        const MethodInfo *method)
{
  ...
  v9 = (System_Collections_Generic_List_object__o *)sub_1D0F300(System_Collections_Generic_List_BattleLogicBattleScript_BattleScriptData__TypeInfo);
  ...
  if ( !logic
    ...
    || (items = ListBattleScriptData_k__BackingField->fields._items,
        ...
        !items) )
  {
    sub_1D0F30C(BattleScriptSystemData, v17);
  }
