        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E4CD4 & 1) == 0 )
  {
    sub_1B00CCC(&Method_System_Linq_Enumerable_FirstOrDefault_ControlOtherBgmPriorityAtOverStageBgm___, fieldEnv);
    sub_1B00CCC(&Method_System_Linq_Enumerable_Where_BattleFieldEnvironmentData_BGMData___, v7);
    sub_1B00CCC(&System_Func_ControlOtherBgmPriorityAtOverStageBgm__bool__TypeInfo, v8);
    sub_1B00CCC(&System_Func_BattleFieldEnvironmentData_BGMData__bool__TypeInfo, v9);
    sub_1B00CCC(&System_IDisposable_TypeInfo, v10);
    sub_1B00CCC(&System_Collections_Generic_IEnumerable_BattleFieldEnvironmentData_BGMData__TypeInfo, v11);
    sub_1B00CCC(&System_Collections_Generic_IEnumerator_BattleFieldEnvironmentData_BGMData__TypeInfo, v12);
    sub_1B00CCC(&System_Collections_IEnumerator_TypeInfo, v13);
    sub_1B00CCC(&Method_AddBgmArgument___c__ControlOtherBgmPriorityAtOverStageBgm_b__3_0__, v14);
    sub_1B00CCC(&Method_AddBgmArgument___c__DisplayClass3_0__ControlOtherBgmPriorityAtOverStageBgm_b__1__, v15);
    sub_1B00CCC(&AddBgmArgument___c__DisplayClass3_0_TypeInfo, v16);
    sub_1B00CCC(&AddBgmArgument___c_TypeInfo, v17);
    byte_48E4CD4 = 1;
  }
  ...
  if ( !IsNullOrEmpty )
  {
    ...
    if ( ((unsigned __int8)IsHighPriorityThanBaseStageBgm & 1) != 0 )
    {
      ...
      if ( !_9__3_0 )
      {
        ...
        _9__3_0 = (System_Func_object__bool__o *)sub_1B00F18(System_Func_BattleFieldEnvironmentData_BGMData__bool__TypeInfo);
...
LABEL_47:
        sub_1B00F28(IsHighPriorityThanBaseStageBgm, v21);
...
LABEL_31:
        ...
        v44 = (BattleFieldEnvironmentData_BGMData_o *)(*(__int64 (__fastcall **)(__int64, _QWORD))v43)(
                                                        v35,
                                                        *(_QWORD *)(v43 + 8));
        v45 = sub_1B00F18(AddBgmArgument___c__DisplayClass3_0_TypeInfo);
        ...
        if ( !v45 )
          sub_1B00F28(BuffIndividuality, BuffIndividuality);
        *(_QWORD *)(v45 + 16) = BuffIndividuality;
        sub_1B00C70((ServantStatusBattleListViewItem_o *)(v45 + 16), (int32_t)BuffIndividuality, v50, v51);
        ...
        v53 = (System_Func_object__bool__o *)sub_1B00F18(System_Func_ControlOtherBgmPriorityAtOverStageBgm__bool__TypeInfo);
        System_Func_object__bool____ctor(
          v53,
          (Il2CppObject *)v45,
          Method_AddBgmArgument___c__DisplayClass3_0__ControlOtherBgmPriorityAtOverStageBgm_b__1__,
          0LL);
        v54 = System_Linq_Enumerable__FirstOrDefault_object__47729964(
                controlOtherBgmPriorityAtOverStageBgmArray,
                (System_Func_TSource__bool__o *)v53,
                (const MethodInfo_2D84D2C *)Method_System_Linq_Enumerable_FirstOrDefault_ControlOtherBgmPriorityAtOverStageBgm___);
        if ( v54 )
      ...
      {
LABEL_41:
        v59 = sub_1B52CAC(v35, System_IDisposable_TypeInfo, 0LL);
      }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E4CD5 & 1) == 0 )
  {
    sub_1B00CCC(&Method_System_Collections_Generic_List_BattleFieldEnvironmentData_BGMData__Add__, fieldEnv);
    this = (AddBgmArgument_o *)sub_1B00CCC(
  ...
  else
  {
    ...
    sub_1B00C70((ServantStatusBattleListViewItem_o *)(v13 + 4), (int32_t)addBgm, v7, v8);
  }
  BattleFieldEnvironmentData__SortBGM_41438344(fieldEnv, v10, v14);
...
void __fastcall AddBgmArgument___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48E4CD6 & 1) == 0 )
  {
    sub_1B00CCC(&AddBgmArgument___c_TypeInfo, v1);
    byte_48E4CD6 = 1;
  }
  v2 = (Il2CppObject *)sub_1B00F18(AddBgmArgument___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  AddBgmArgument___c_TypeInfo->static_fields->__9 = (struct AddBgmArgument___c_o *)v2;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)AddBgmArgument___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
