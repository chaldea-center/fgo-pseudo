        ...
        const MethodInfo *method)
{
  ...
  if ( onClickCallback )
  {
    ...
    sub_1BCA784(p_onClickCallback, 0LL, v4, v5, v6, v7, v8, v9);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Behaviour__get_isActiveAndEnabled((UnityEngine_Behaviour_o *)this, 0LL) )
  {
    ...
    {
      p_onClickCallback->klass = 0LL;
      sub_1BCA784(p_onClickCallback, 0LL, v3, v4, v5, v6, v7, v8);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Behaviour__get_isActiveAndEnabled((UnityEngine_Behaviour_o *)this, 0LL) )
  {
    ...
    if ( !onClickCallback )
    {
      ...
      sub_1BCA784(p_onClickCallback, (int64_t)callback, v5, v6, v7, v8, v9, v10);
    }
  }
}