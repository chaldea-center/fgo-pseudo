        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_438D46B & 1) == 0 )
  {
    sub_B775C4(&Method_System_Action_IClassBoardSquareUser__Invoke__);
    sub_B775C4(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    this = (ClassBoardSquareUser_o *)sub_B775C4(&StringLiteral_21504/*"ng"*/);
    byte_438D46B = 1;
  }
  if ( !result )
    goto LABEL_9;
  ...
  if ( releaseResponseCallback )
    System_Action_Uri___Invoke(
      ...
      (System_Uri_o *)v4,
      (const MethodInfo_26A087C *)Method_System_Action_IClassBoardSquareUser__Invoke__);
  v4->fields.releaseResponseCallback = 0LL;
  sub_B77560((BattleServantConfConponent_o *)&v4->fields.releaseResponseCallback, 0LL, v6, v7, v8, v9, v10, v11);
  this = (ClassBoardSquareUser_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2D1653C *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !this )
LABEL_9:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_438D46A & 1) == 0 )
  {
    ...
    sub_B775C4(&Method_NetworkManager_getRequest_ClassBoardReleaseSquareRequest___);
  ...
  Request_WarBoardWallAttackRequest = (ClassBoardReleaseSquareRequest_o *)NetworkManager__getRequest_WarBoardWallAttackRequest_(
                                                                            v5,
                                                                            (const MethodInfo_1DF8BE8 *)Method_NetworkManager_getRequest_ClassBoardReleaseSquareRequest___);
