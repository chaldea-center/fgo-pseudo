        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CCB0DF & 1) == 0 )
  {
    ...
    this = (ClassBoardSquareUser_o *)sub_1C713B0(&StringLiteral_22316/*"ng"*/);
    byte_4CCB0DF = 1;
  }
  if ( !result )
    goto LABEL_11;
  ...
  sub_1C71354((GrandQuestFolderBoardItem_o *)&v4->fields.releaseResponseCallback, 0, v5, v6, v7, v8, v9, v10);
  this = (ClassBoardSquareUser_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A5F158 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !this )
LABEL_11:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CCB0DE & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_NetworkManager_getRequest_ClassBoardReleaseSquareRequest___);
  ...
  Request_object = NetworkManager__getRequest_object_(
                     v5,
                     (const MethodInfo_31D69E8 *)Method_NetworkManager_getRequest_ClassBoardReleaseSquareRequest___);
        ...
        const MethodInfo *method)
{
  ...
  while ( 1 )
  {
    ...
    v9 = v8;
    v10 = sub_1C714EC(v8, System_Action_IClassBoardSquareUser__TypeInfo);
    if ( !v10 )
      break;
LABEL_8:
    v11 = sub_1CCD184(p_fields, v10, v6);
