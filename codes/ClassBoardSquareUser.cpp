        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22F73 & 1) == 0 )
  {
    ...
    this = (ClassBoardSquareUser_o *)sub_1B715CC(&StringLiteral_22000/*"ng"*/, v5);
    byte_4A22F73 = 1;
  }
  if ( !result )
    goto LABEL_11;
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&v4->fields.releaseResponseCallback, 0, v6, v7);
  this = (ClassBoardSquareUser_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !this )
LABEL_11:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22F72 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_NetworkManager_getRequest_ClassBoardReleaseSquareRequest___, v5);
  ...
  Request_object = NetworkManager__getRequest_object_(
                     v9,
                     (const MethodInfo_2EDD4A0 *)Method_NetworkManager_getRequest_ClassBoardReleaseSquareRequest___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22F6F & 1) == 0 )
  {
    sub_1B715CC(&System_Action_IClassBoardSquareUser__TypeInfo, value);
    byte_4A22F6F = 1;
  }
  userUpdateEvent = this->fields.userUpdateEvent;
  ...
  while ( 1 )
  {
    ...
    v9 = v8;
    v10 = sub_1B71708(v8, System_Action_IClassBoardSquareUser__TypeInfo);
    if ( !v10 )
      break;
LABEL_8:
    v11 = sub_1BACABC(p_fields, v10, v6);
