        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A51CCC & 1) == 0 )
  {
    ...
    this = (ClassBoardSquareUser_o *)sub_1B863B8(&StringLiteral_21893/*"ng"*/, v5);
    byte_4A51CCC = 1;
  }
  if ( !result )
    goto LABEL_11;
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&v4->fields.releaseResponseCallback, 0, v6, v7);
  this = (ClassBoardSquareUser_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3839680 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !this )
LABEL_11:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A51CCB & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_NetworkManager_getRequest_ClassBoardReleaseSquareRequest___, v5);
  ...
  Request_object = NetworkManager__getRequest_object_(
                     v9,
                     (const MethodInfo_2FF4AF4 *)Method_NetworkManager_getRequest_ClassBoardReleaseSquareRequest___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A51CC8 & 1) == 0 )
  {
    sub_1B863B8(&System_Action_IClassBoardSquareUser__TypeInfo, value);
    byte_4A51CC8 = 1;
  }
  userUpdateEvent = this->fields.userUpdateEvent;
  ...
  while ( 1 )
  {
    ...
    v9 = v8;
    v10 = sub_1B864F4(v8, System_Action_IClassBoardSquareUser__TypeInfo);
    if ( !v10 )
      break;
LABEL_8:
    v11 = sub_1BC0674(p_fields, v10, v6);
