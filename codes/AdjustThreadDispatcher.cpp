void AdjustThreadDispatcher___cctor(const MethodInfo *method)
{
  ...
  v1 = (System_Collections_Generic_Queue_T__o *)sub_1CE694C(System_Collections_Generic_Queue_Action__TypeInfo);
  ...
  sub_1CE66A4(AdjustThreadDispatcher_TypeInfo->static_fields, v1);
}
...
void AdjustThreadDispatcher__Initialize(const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&AdjustThreadDispatcher_TypeInfo);
    sub_1CE6700(&Method_UnityEngine_GameObject_AddComponent_AdjustThreadDispatcher___);
    sub_1CE6700(&UnityEngine_GameObject_TypeInfo);
    sub_1CE6700(&UnityEngine_Object_TypeInfo);
    sub_1CE6700(&StringLiteral_2181/*"AdjustThreadDispatcher"*/);
    byte_4DFCB62 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Equality(instance, 0, 0) )
  {
    ...
    UnityEngine_GameObject___ctor(v3, (System_String_o *)StringLiteral_2181/*"AdjustThreadDispatcher"*/, 0);
    if ( !v3 )
      sub_1CE6958();
    v4 = UnityEngine_GameObject__AddComponent_object_(
           v3,
           (const MethodInfo_325BD54 *)Method_UnityEngine_GameObject_AddComponent_AdjustThreadDispatcher___);
    ...
    sub_1CE66A4(&static_fields->instance, v6);
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
...
void AdjustThreadDispatcher__RunOnMainThread(System_Action_o *action, const MethodInfo *method)
{
  ...
  if ( (byte_4DFCB60 & 1) == 0 )
  {
    sub_1CE6700(&AdjustThreadDispatcher_TypeInfo, method);
    sub_1CE6700(&Method_System_Collections_Generic_Queue_Action__Enqueue__, v3);
    byte_4DFCB60 = 1;
  }
  if ( action )
  {
    ...
    lockTaken = 0;
    System_Threading_Monitor__Enter_67050676(executionQueue, &lockTaken, 0);
...
void AdjustThreadDispatcher__Update(AdjustThreadDispatcher_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&AdjustThreadDispatcher_TypeInfo, method);
    sub_1CE6700(&Method_System_Collections_Generic_Queue_Action__Dequeue__, v2);
    sub_1CE6700(&Method_System_Collections_Generic_Queue_Action__get_Count__, v3);
    byte_4DFCB61 = 1;
  }
  lockTaken = 0;
  while ( 1 )
  {
    ...
    lockTaken = 0;
    System_Threading_Monitor__Enter_67050676(v6, &lockTaken, 0);
    ...
    v9 = System_Collections_Generic_Queue_object___Dequeue(
           v8,
           (const MethodInfo_3AB0E54 *)Method_System_Collections_Generic_Queue_Action__Dequeue__);
    if ( lockTaken )
