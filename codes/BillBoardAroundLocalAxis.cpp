...
void BillBoardAroundLocalAxis__UpdateAngles(BillBoardAroundLocalAxis_o *this, const MethodInfo *method)
{
  ...
  v23.fields.w = localRotation.fields.w;
  v4 = (float)((float)((float)(position.fields.z - v9.fields.z) * v10.fields.z)
     ...
     ? -z
     : z;
  v23.fields.x = localRotation.fields.x;
  v23.fields.y = localRotation.fields.y;
  v23.fields.z = localRotation.fields.z;
  v12 = UnityEngine_Quaternion__Internal_ToEulerRad(v23, 0);
