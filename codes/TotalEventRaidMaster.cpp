void __fastcall TotalEventRaidMaster___ctor(TotalEventRaidMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A2E999 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_TotalEventRaidMaster__TotalEventRaidEntity__string___ctor__, method);
    byte_4A2E999 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    149,
    (const MethodInfo_30FFA98 *)Method_DataMasterBase_TotalEventRaidMaster__TotalEventRaidEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (TotalEventRaidEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                     (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                     PK,
                                     (const MethodInfo_30FFAD8 *)Method_DataMasterBase_TotalEventRaidMaster__TotalEventRaidEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E998 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_TotalEventRaidMaster__TotalEventRaidEntity__string__TryGetEntity__, entity);
    byte_4A2E998 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_30FFB28 *)Method_DataMasterBase_TotalEventRaidMaster__TotalEventRaidEntity__string__TryGetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E99A & 1) == 0 )
  {
    sub_1B761C0(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__GetEnumerator__, *(_QWORD *)&day);
    ...
    sub_1B761C0(&Method_System_Collections_Generic_List_TotalEventRaidEntity__Add__, v11);
    sub_1B761C0(&Method_System_Collections_Generic_List_TotalEventRaidEntity___ctor__, v12);
    sub_1B761C0(&System_Collections_Generic_List_TotalEventRaidEntity__TypeInfo, v13);
    sub_1B761C0(&NetworkManager_TypeInfo, v14);
    sub_1B761C0(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v15);
    sub_1B761C0(&TotalEventRaidEntity_TypeInfo, v16);
    byte_4A2E99A = 1;
  }
  entity = 0LL;
  *maxHpSum = 0LL;
  v17 = (System_Collections_Generic_List_object__o *)sub_1B7640C(System_Collections_Generic_List_TotalEventRaidEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v17,
    (const MethodInfo_34D6DA0 *)Method_System_Collections_Generic_List_TotalEventRaidEntity___ctor__);
...
LABEL_44:
    ...
    if ( v32[5] == day )
    {
      if ( !MasterData_object )
        sub_1B7641C(v32, TotalEventRaidEntity_TypeInfo);
      if ( EventRaidMaster__TryGetEntity((EventRaidMaster_o *)MasterData_object, &entity, v32[4], day, 0LL) )
      {
        ...
        if ( IsOpenTime )
        {
          ...
          else
          {
            ...
            sub_1B76164((ServantStatusBattleListViewItem_o *)(v44 + 4), (int32_t)v34, v39, v40);
          }
          if ( !entity )
            sub_1B7641C(v45, v46);
