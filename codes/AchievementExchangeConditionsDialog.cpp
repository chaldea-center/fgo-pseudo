void AchievementExchangeConditionsDialog___ctor(AchievementExchangeConditionsDialog_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.scrollViewPosShopListNum1.fields.x = xmmword_C0D100;
  *(_OWORD *)&this->fields.scrollViewPosShopListNum2.fields.y = xmmword_C0C340;
  *(_OWORD *)&this->fields.scrollViewPosShopListNum3.fields.z = xmmword_C0CB00;
  *(_OWORD *)&this->fields.scrollViewPosShopListNum5.fields.x = xmmword_C0C0E0;
  *(_QWORD *)&this->fields.scrollViewPosDefault.fields.y = 1118306304;
  ...
  sub_1C32BC4(&this->fields.shopNameList, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C31755 & 1) == 0 )
  {
    sub_1C32C20(&Method_AchievementExchangeConditionsDialog_EndClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C31756 & 1) == 0 )
  {
    sub_1C32C20(&Method_AchievementExchangeConditionsDialog_Callback__);
    sub_1C32C20(&Method_AchievementExchangeConditionsDialog_OnClickCancel__);
    sub_1C32C20(&System_Action_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C31754 & 1) == 0 )
  {
    sub_1C32C20(&Method_AchievementExchangeConditionsDialog_EndOpen__);
    sub_1C32C20(&System_Action_TypeInfo);
    ...
    sub_1C32C20(&StringLiteral_1911/*"ACHIEVEMENT_EXCHANGE_CONDITIONS_SHOP_NAME"*/);
    byte_4C31754 = 1;
  }
  ...
  if ( (int)max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      v19 = NGUITools__AddChild_49306416(grid, shopListLabel, 0);
      titleLabel = (UILabel_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39E2904 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( !titleLabel )
        break;
        ...
        const MethodInfo *method)
{
  ...
  v11 = (AchievementExchangeConditionsDialog_o *)sub_1C3313C(v8);
