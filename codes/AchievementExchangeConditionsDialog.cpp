void AchievementExchangeConditionsDialog___ctor(AchievementExchangeConditionsDialog_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.scrollViewPosShopListNum1.fields.x = xmmword_CFF260;
  *(_OWORD *)&this->fields.scrollViewPosShopListNum2.fields.y = xmmword_CFE4A0;
  *(_OWORD *)&this->fields.scrollViewPosShopListNum3.fields.z = xmmword_CFEC50;
  *(_OWORD *)&this->fields.scrollViewPosShopListNum5.fields.x = xmmword_CFE240;
  *(_QWORD *)&this->fields.scrollViewPosDefault.fields.y = 1118306304;
  ...
  sub_1C9403C(&this->fields.shopNameList, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2627D & 1) == 0 )
  {
    sub_1C94098(&Method_AchievementExchangeConditionsDialog_EndClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2627E & 1) == 0 )
  {
    sub_1C94098(&Method_AchievementExchangeConditionsDialog_Callback__);
    sub_1C94098(&Method_AchievementExchangeConditionsDialog_OnClickCancel__);
    sub_1C94098(&System_Action_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2627C & 1) == 0 )
  {
    sub_1C94098(&Method_AchievementExchangeConditionsDialog_EndOpen__);
    sub_1C94098(&System_Action_TypeInfo);
    ...
    sub_1C94098(&StringLiteral_1905/*"ACHIEVEMENT_EXCHANGE_CONDITIONS_SHOP_NAME"*/);
    byte_4D2627C = 1;
  }
  ...
  if ( (int)max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      v20 = NGUITools__AddChild_50043264(grid, shopListLabel, 0);
      titleLabel = (UILabel_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3ABA574 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( !titleLabel )
        break;
        ...
        const MethodInfo *method)
{
  ...
  v11 = (AchievementExchangeConditionsDialog_o *)sub_1C9468C(v8);
