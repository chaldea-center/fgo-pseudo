        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0B0D1 & 1) == 0 )
  {
    sub_1B686D4(&int___TypeInfo, actObj);
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.attachNodeName, v18, funcIndex, (int32_t)actData);
  if ( !byte_4A03901 )
  {
  ...
  *(_QWORD *)&this->fields.popupOffset.fields.x = *(_QWORD *)&v24->zeroVector.fields.x;
  ...
  v26 = (struct System_Int32_array *)sub_1B6877C(int___TypeInfo, 0LL);
  this->fields.fieldIndiv = v26;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.fieldIndiv, (int32_t)v26, v27, v28);
  System_Object___ctor((Il2CppObject *)this, 0LL);
  this->fields.actObj = actObj;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)actObj, v29, v30);
  this->fields.actData = actData;
  p_actData = &this->fields.actData;
  *((_DWORD *)p_actData - 2) = funcIndex;
  sub_1B68678((ServantStatusBattleListViewItem_o *)p_actData, (int32_t)actData, v32, v33);
  *((_BYTE *)p_actData + 8) = isCommandAfter;
  *((_BYTE *)p_actData + 9) = isTreasureDevice;
  p_actData[2] = (struct BattleActionData_o *)attachNodeName;
  sub_1B68678((ServantStatusBattleListViewItem_o *)p_attachNodeName, (int32_t)attachNodeName, v34, v35);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0B0D3 & 1) == 0 )
  {
    sub_1B686D4(&UnityEngine_Object_TypeInfo, targetObj);
    byte_4A0B0D3 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0B0D2 & 1) == 0 )
  {
    sub_1B686D4(&int___TypeInfo, overwriteEffectIds);
    byte_4A0B0D2 = 1;
  }
  ...
  sub_1B68678(
    ...
    (int32_t)method);
  if ( !v6 )
    v6 = (struct System_Int32_array *)sub_1B6877C(int___TypeInfo, 0LL);
  this->fields.fieldIndiv = v6;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.fieldIndiv, (int32_t)v6, v15, v16);
  return this;
}