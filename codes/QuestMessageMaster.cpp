void __fastcall QuestMessageMaster___ctor(QuestMessageMaster_o *this, const MethodInfo *method)
{
  if ( (byte_48E2C5B & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataMasterBase_QuestMessageMaster__QuestMessageEntity__string___ctor__, method);
    byte_48E2C5B = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    75,
    (const MethodInfo_2FE6D64 *)Method_DataMasterBase_QuestMessageMaster__QuestMessageEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E2C59 & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataMasterBase_QuestMessageMaster__QuestMessageEntity__string__GetEntity__, *(_QWORD *)&questId);
    byte_48E2C59 = 1;
  }
  ...
  return (QuestMessageEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                   (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                   PK,
                                   (const MethodInfo_2FE6DA4 *)Method_DataMasterBase_QuestMessageMaster__QuestMessageEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E2C5C & 1) == 0 )
  {
    sub_1B00CCC(&Method_System_Collections_Generic_List_QuestMessageEntity__get_Count__, *(_QWORD *)&questId);
    sub_1B00CCC(&Method_System_Collections_Generic_List_QuestMessageEntity__get_Item__, v9);
    byte_48E2C5C = 1;
  }
  ...
  if ( *((int *)ValidMessageList + 6) >= 1 )
  {
    ValidMessageList = System_Collections_Generic_List_object___get_Item(
                         ...
                         0,
                         (const MethodInfo_33C1700 *)Method_System_Collections_Generic_List_QuestMessageEntity__get_Item__);
    if ( ValidMessageList )
      return (System_String_o *)*((_QWORD *)ValidMessageList + 4);
LABEL_8:
    sub_1B00F28(ValidMessageList, v11);
  }
  return 0LL;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E2C5D & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_System_Collections_Generic_List_QuestMessageEntity__Add__, v13);
    sub_1B00CCC(&Method_System_Collections_Generic_List_QuestMessageEntity___ctor__, v14);
    sub_1B00CCC(&System_Collections_Generic_List_QuestMessageEntity__TypeInfo, v15);
    sub_1B00CCC(&QuestMessageEntity_TypeInfo, v16);
    byte_48E2C5D = 1;
  }
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  v18 = (System_Collections_Generic_List_object__o *)sub_1B00F18(System_Collections_Generic_List_QuestMessageEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v18,
    (const MethodInfo_33C119C *)Method_System_Collections_Generic_List_QuestMessageEntity___ctor__);
  if ( !list )
    sub_1B00F28(v19, v20);
      ...
      if ( v35 == phase || !v35 )
      {
        ...
        if ( v36 )
        {
          if ( v33->fields.frequencyType == 1 )
          {
            ...
            {
              if ( !v18 )
                sub_1B00F28(IsQuestClear_36399468, v41);
...
LABEL_33:
            ...
            sub_1B00C70((ServantStatusBattleListViewItem_o *)(v45 + 4), (int32_t)v33, v38, v39);
          }
        }
      }
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E2C5A & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataMasterBase_QuestMessageMaster__QuestMessageEntity__string__TryGetEntity__, entity);
    byte_48E2C5A = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_2FE6DF4 *)Method_DataMasterBase_QuestMessageMaster__QuestMessageEntity__string__TryGetEntity__);
}