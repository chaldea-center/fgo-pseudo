void __fastcall QuestMessageMaster___ctor(QuestMessageMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A1FF56 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataMasterBase_QuestMessageMaster__QuestMessageEntity__string___ctor__, method);
    byte_4A1FF56 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    76,
    (const MethodInfo_30F8A78 *)Method_DataMasterBase_QuestMessageMaster__QuestMessageEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1FF54 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataMasterBase_QuestMessageMaster__QuestMessageEntity__string__GetEntity__, *(_QWORD *)&questId);
    byte_4A1FF54 = 1;
  }
  ...
  return (QuestMessageEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                   (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                   PK,
                                   (const MethodInfo_30F8AB8 *)Method_DataMasterBase_QuestMessageMaster__QuestMessageEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1FF57 & 1) == 0 )
  {
    sub_1B715CC(&Method_System_Collections_Generic_List_QuestMessageEntity__get_Count__, *(_QWORD *)&questId);
    sub_1B715CC(&Method_System_Collections_Generic_List_QuestMessageEntity__get_Item__, v9);
    byte_4A1FF57 = 1;
  }
  ...
  if ( *((int *)ValidMessageList + 6) >= 1 )
  {
    ValidMessageList = System_Collections_Generic_List_object___get_Item(
                         ...
                         0,
                         (const MethodInfo_34CFF90 *)Method_System_Collections_Generic_List_QuestMessageEntity__get_Item__);
    if ( ValidMessageList )
      return (System_String_o *)*((_QWORD *)ValidMessageList + 4);
LABEL_8:
    sub_1B71828(ValidMessageList, v11);
  }
  return 0LL;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1FF58 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_System_Collections_Generic_List_QuestMessageEntity__Add__, v13);
    sub_1B715CC(&Method_System_Collections_Generic_List_QuestMessageEntity___ctor__, v14);
    sub_1B715CC(&System_Collections_Generic_List_QuestMessageEntity__TypeInfo, v15);
    sub_1B715CC(&QuestMessageEntity_TypeInfo, v16);
    byte_4A1FF58 = 1;
  }
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  v18 = (System_Collections_Generic_List_object__o *)sub_1B71818(System_Collections_Generic_List_QuestMessageEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v18,
    (const MethodInfo_34CFA2C *)Method_System_Collections_Generic_List_QuestMessageEntity___ctor__);
  if ( !list )
    sub_1B71828(v19, v20);
      ...
      if ( v35 == phase || !v35 )
      {
        ...
        if ( v36 )
        {
          if ( v33->fields.frequencyType == 1 )
          {
            ...
            {
              if ( !v18 )
                sub_1B71828(IsQuestClear_37394868, v41);
...
LABEL_33:
            ...
            sub_1B71570((ServantStatusBattleListViewItem_o *)(v45 + 4), (int32_t)v33, v38, v39);
          }
        }
      }
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1FF55 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataMasterBase_QuestMessageMaster__QuestMessageEntity__string__TryGetEntity__, entity);
    byte_4A1FF55 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_30F8B08 *)Method_DataMasterBase_QuestMessageMaster__QuestMessageEntity__string__TryGetEntity__);
}