void __fastcall QuestMessageMaster___ctor(QuestMessageMaster_o *this, const MethodInfo *method)
{
  if ( (byte_49FE982 & 1) == 0 )
  {
    sub_1B64870(&Method_DataMasterBase_QuestMessageMaster__QuestMessageEntity__string___ctor__, method);
    byte_49FE982 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    76,
    (const MethodInfo_30D6498 *)Method_DataMasterBase_QuestMessageMaster__QuestMessageEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE980 & 1) == 0 )
  {
    sub_1B64870(&Method_DataMasterBase_QuestMessageMaster__QuestMessageEntity__string__GetEntity__, *(_QWORD *)&questId);
    byte_49FE980 = 1;
  }
  ...
  return (QuestMessageEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                   (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                   PK,
                                   (const MethodInfo_30D64D8 *)Method_DataMasterBase_QuestMessageMaster__QuestMessageEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE983 & 1) == 0 )
  {
    sub_1B64870(&Method_System_Collections_Generic_List_QuestMessageEntity__get_Count__, *(_QWORD *)&questId);
    sub_1B64870(&Method_System_Collections_Generic_List_QuestMessageEntity__get_Item__, v9);
    byte_49FE983 = 1;
  }
  ...
  if ( *((int *)ValidMessageList + 6) >= 1 )
  {
    ValidMessageList = System_Collections_Generic_List_object___get_Item(
                         ...
                         0,
                         (const MethodInfo_34AF6E0 *)Method_System_Collections_Generic_List_QuestMessageEntity__get_Item__);
    if ( ValidMessageList )
      return (System_String_o *)*((_QWORD *)ValidMessageList + 4);
LABEL_8:
    sub_1B64ACC(ValidMessageList, v11);
  }
  return 0LL;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE984 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_System_Collections_Generic_List_QuestMessageEntity__Add__, v13);
    sub_1B64870(&Method_System_Collections_Generic_List_QuestMessageEntity___ctor__, v14);
    sub_1B64870(&System_Collections_Generic_List_QuestMessageEntity__TypeInfo, v15);
    sub_1B64870(&QuestMessageEntity_TypeInfo, v16);
    byte_49FE984 = 1;
  }
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  v18 = (System_Collections_Generic_List_object__o *)sub_1B64ABC(System_Collections_Generic_List_QuestMessageEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v18,
    (const MethodInfo_34AF17C *)Method_System_Collections_Generic_List_QuestMessageEntity___ctor__);
  if ( !list )
    sub_1B64ACC(v19, v20);
      ...
      if ( v35 == phase || !v35 )
      {
        ...
        if ( v36 )
        {
          if ( v33->fields.frequencyType == 1 )
          {
            ...
            {
              if ( !v18 )
                sub_1B64ACC(IsQuestClear_37290360, v41);
...
LABEL_33:
            ...
            sub_1B64814((ServantStatusBattleListViewItem_o *)(v45 + 4), (int32_t)v33, v38, v39);
          }
        }
      }
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE981 & 1) == 0 )
  {
    sub_1B64870(&Method_DataMasterBase_QuestMessageMaster__QuestMessageEntity__string__TryGetEntity__, entity);
    byte_49FE981 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_30D6528 *)Method_DataMasterBase_QuestMessageMaster__QuestMessageEntity__string__TryGetEntity__);
}