void __fastcall RewardMiniPopupExecutor___ctor(RewardMiniPopupExecutor_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3EF70 & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Collections_Generic_Queue_Action___ctor__, method);
    sub_1BDB878(&System_Collections_Generic_Queue_Action__TypeInfo, v3);
    sub_1BDB878(&Method_SingletonTemplate_RewardMiniPopupExecutor___ctor__, v4);
    byte_4B3EF70 = 1;
  }
  v5 = (System_Collections_Generic_Queue_T__o *)sub_1BDBAC4(System_Collections_Generic_Queue_Action__TypeInfo);
  System_Collections_Generic_Queue_object____ctor(
    v5,
    (const MethodInfo_384B9DC *)Method_System_Collections_Generic_Queue_Action___ctor__);
  this->fields.playerActionQueue = (struct System_Collections_Generic_Queue_Action__o *)v5;
  sub_1BDB81C(&this->fields);
  SingletonTemplate_object____ctor(
    (SingletonTemplate_CLASS__o *)this,
    (const MethodInfo_39167A0 *)Method_SingletonTemplate_RewardMiniPopupExecutor___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3EF64 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_RewardMiniPopupExecutor__AddTaskOnBattleToTerminal_g__Action_2_0__, v3);
    byte_4B3EF64 = 1;
  }
...
void __fastcall RewardMiniPopupExecutor__AddTaskOnReBattle(RewardMiniPopupExecutor_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&System_Action_TypeInfo, method);
    sub_1BDB878(&Method_RewardMiniPopupExecutor__AddTaskOnReBattle_g__Action_5_0__, v3);
    byte_4B3EF67 = 1;
  }
  v4 = (System_Action_o *)sub_1BDBAC4(System_Action_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&System_Action_TypeInfo, method);
    sub_1BDB878(&Method_RewardMiniPopupExecutor__AddTaskOnReBattleOrdealCallFreeQuest_g__Action_4_0__, v3);
    byte_4B3EF66 = 1;
  }
  v4 = (System_Action_o *)sub_1BDBAC4(System_Action_TypeInfo);
  System_Action___ctor(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3EF6F & 1) == 0 )
  {
    sub_1BDB878(&System_Action_TypeInfo, v1);
    sub_1BDB878(&RewardMiniPopup_PopupInfoByUseAddRewardItem_TypeInfo, v2);
    sub_1BDB878(&TerminalPramsManager_TypeInfo, v3);
    sub_1BDB878(&Method_RewardMiniPopupExecutor___c__CreatePopupInfoByUseAddRewardItem_b__14_0__, v4);
    sub_1BDB878(&RewardMiniPopupExecutor___c_TypeInfo, v5);
    byte_4B3EF6F = 1;
  }
  ...
  if ( !_9__14_0 )
  {
    ...
    sub_1BDB81C(&static_fields->__9__14_0);
  }
  v13 = (RewardMiniPopup_PopupInfoByUseAddRewardItem_o *)sub_1BDBAC4(RewardMiniPopup_PopupInfoByUseAddRewardItem_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&System_Action_TypeInfo, v1);
    sub_1BDB878(&RewardMiniPopup_PopupInfoQuestPhaseClear_TypeInfo, v2);
    sub_1BDB878(&TerminalPramsManager_TypeInfo, v3);
    sub_1BDB878(&Method_RewardMiniPopupExecutor___c__CreatePopupInfoQuestPhaseReward_b__12_0__, v4);
    sub_1BDB878(&RewardMiniPopupExecutor___c_TypeInfo, v5);
    byte_4B3EF6D = 1;
  }
  v6 = TerminalPramsManager_TypeInfo;
  ...
  if ( !_9__12_0 )
  {
    ...
    _9__12_0 = (System_Action_o *)sub_1BDBAC4(System_Action_TypeInfo);
    System_Action___ctor(
      _9__12_0,
      v10,
    ...
    sub_1BDB81C(&static_fields->__9__12_0);
  }
  v12 = (RewardMiniPopup_PopupInfoQuestPhaseClear_o *)sub_1BDBAC4(RewardMiniPopup_PopupInfoQuestPhaseClear_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&System_Action_TypeInfo, v1);
    sub_1BDB878(&RewardMiniPopup_PopupInfoQuestClear_TypeInfo, v2);
    sub_1BDB878(&TerminalPramsManager_TypeInfo, v3);
    sub_1BDB878(&Method_RewardMiniPopupExecutor___c__CreatePopupInfoQuestReward_b__13_0__, v4);
    sub_1BDB878(&RewardMiniPopupExecutor___c_TypeInfo, v5);
    byte_4B3EF6E = 1;
  }
  v6 = TerminalPramsManager_TypeInfo;
  ...
  if ( !_9__13_0 )
  {
    ...
    v10 = (Il2CppObject *)v8->static_fields->__9;
    _9__13_0 = (System_Action_o *)sub_1BDBAC4(System_Action_TypeInfo);
    ...
    sub_1BDB81C(&static_fields->__9__13_0);
  }
  v12 = (RewardMiniPopup_PopupInfoQuestClear_o *)sub_1BDBAC4(RewardMiniPopup_PopupInfoQuestClear_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3EF6C & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Collections_Generic_Queue_Action__TryDequeue__, method);
    sub_1BDB878(&Method_System_Collections_Generic_Queue_Action__TryPeek__, v3);
    byte_4B3EF6C = 1;
  }
  v7 = 0LL;
  result = 0LL;
  ...
  if ( !playerActionQueue
    || (System_Collections_Generic_Queue_object___TryDequeue(
          playerActionQueue,
          &result,
          (const MethodInfo_384C1D0 *)Method_System_Collections_Generic_Queue_Action__TryDequeue__),
        this->fields.currentPlayer = 0LL,
        p_currentPlayer = &this->fields.currentPlayer,
        sub_1BDB81C(p_currentPlayer),
        (playerActionQueue = (System_Collections_Generic_Queue_T__o *)*(p_currentPlayer - 1)) == 0LL) )
  {
    sub_1BDBAD4(playerActionQueue, method);
  }
  System_Collections_Generic_Queue_object___TryPeek(
    playerActionQueue,
    &v7,
    (const MethodInfo_384C2DC *)Method_System_Collections_Generic_Queue_Action__TryPeek__);
  if ( v7 )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3EF6B & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Linq_Enumerable_Any_Action___, action);
    sub_1BDB878(&Method_System_Collections_Generic_Queue_Action__Enqueue__, v5);
    byte_4B3EF6B = 1;
  }
  v6 = System_Linq_Enumerable__Any_object_(
         (System_Collections_Generic_IEnumerable_TSource__o *)this->fields.playerActionQueue,
         (const MethodInfo_303F5F0 *)Method_System_Linq_Enumerable_Any_Action___);
  playerActionQueue = (System_Collections_Generic_Queue_T__o *)this->fields.playerActionQueue;
  if ( !playerActionQueue )
    goto LABEL_7;
  v9 = v6;
  System_Collections_Generic_Queue_object___Enqueue(
    playerActionQueue,
    (Il2CppObject *)action,
    (const MethodInfo_384BFA4 *)Method_System_Collections_Generic_Queue_Action__Enqueue__);
  if ( v9 )
    return;
  if ( !action )
LABEL_7:
...
void __fastcall RewardMiniPopupExecutor__Kill(RewardMiniPopupExecutor_o *this, bool strong, const MethodInfo *method)
{
  ...
  if ( (byte_4B3EF68 & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Collections_Generic_Queue_Action__Clear__, strong);
  ...
  System_Collections_Generic_Queue_object___Clear(
    playerActionQueue,
    (const MethodInfo_384BC64 *)Method_System_Collections_Generic_Queue_Action__Clear__);
  if ( strong )
  {
    playerActionQueue = (System_Collections_Generic_Queue_T__o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    if ( playerActionQueue )
    {
...
LABEL_8:
    sub_1BDBAD4(playerActionQueue, strong);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3EF6A & 1) == 0 )
  {
    sub_1BDB878(&System_Action_TypeInfo, newPlayer);
    sub_1BDB878(&Method_RewardMiniPopupExecutor_DequeueCurrentAndInvokeNext__, v5);
    byte_4B3EF6A = 1;
  }
  this->fields.currentPlayer = newPlayer;
  v6 = sub_1BDB81C(&this->fields.currentPlayer);
  if ( !newPlayer )
    sub_1BDBAD4(v6, v7);
  ...
  {
    v11 = (RewardMiniPopupExecutor_o *)sub_1BDBD94(v10);
  ...
  else
  {
    ...
    sub_1BDB81C(&newPlayer->fields._FinishCallback_k__BackingField);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3EF69 & 1) == 0 )
  {
    sub_1BDB878(&RewardMiniPopup_RewardMiniPopupPlayerSimultaneous_TypeInfo, popupInfoArray);
    byte_4B3EF69 = 1;
  }
  v5 = (RewardMiniPopup_RewardMiniPopupPlayerSimultaneous_o *)sub_1BDBAC4(RewardMiniPopup_RewardMiniPopupPlayerSimultaneous_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3EF71 & 1) == 0 )
  {
    sub_1BDB878(&Method_BasicHelper_ExcludeNull_PopupInfoBase___, method);
    sub_1BDB878(&Method_System_Linq_Enumerable_ToArray_PopupInfoBase___, v3);
    sub_1BDB878(&RewardMiniPopup_PopupInfoBase___TypeInfo, v4);
    byte_4B3EF71 = 1;
  }
  v5 = sub_1BDB920(RewardMiniPopup_PopupInfoBase___TypeInfo, 2LL);
  PopupInfoQuestPhaseReward = RewardMiniPopupExecutor__CreatePopupInfoQuestPhaseReward((const MethodInfo *)v5);
  if ( !v5 )
    sub_1BDBAD4(PopupInfoQuestPhaseReward, v7);
  v10 = PopupInfoQuestPhaseReward;
  if ( PopupInfoQuestPhaseReward )
  {
    PopupInfoQuestPhaseReward = (RewardMiniPopup_PopupInfoBase_o *)sub_1BDB9B4(
  ...
  if ( !*(_DWORD *)(v5 + 24) )
    goto LABEL_11;
  *(_QWORD *)(v5 + 32) = v10;
  v11 = (const MethodInfo *)sub_1BDB81C(v5 + 32);
...
LABEL_12:
  ...
  if ( *(_DWORD *)(v5 + 24) <= 1u )
LABEL_11:
    sub_1BDBADC(PopupInfoQuestPhaseReward, v7, v8, v9);
  *(_QWORD *)(v5 + 40) = v12;
  sub_1BDB81C(v5 + 40);
        ...
        const MethodInfo *method)
{
  ...
  if ( !v5 )
    sub_1BDBAD4(PopupInfoQuestReward, v7);
  v10 = PopupInfoQuestReward;
  if ( PopupInfoQuestReward )
  {
    PopupInfoQuestReward = (RewardMiniPopup_PopupInfoBase_o *)sub_1BDB9B4(
...
LABEL_12:
  ...
  if ( *(_DWORD *)(v5 + 24) <= 1u )
LABEL_11:
    sub_1BDBADC(PopupInfoQuestReward, v7, v8, v9);
  *(_QWORD *)(v5 + 40) = v12;
  sub_1BDB81C(v5 + 40);
  v13 = BasicHelper__ExcludeNull_object_(
          (System_Collections_Generic_IEnumerable_T__o *)v5,
        ...
        const MethodInfo *method)
{
  ...
  v5 = sub_1BDB920(RewardMiniPopup_PopupInfoBase___TypeInfo, 1LL);
  PopupInfoByUseAddRewardItem = RewardMiniPopupExecutor__CreatePopupInfoByUseAddRewardItem((const MethodInfo *)v5);
  if ( !v5 )
    sub_1BDBAD4(PopupInfoByUseAddRewardItem, v7);
  v10 = PopupInfoByUseAddRewardItem;
  if ( PopupInfoByUseAddRewardItem )
  {
    PopupInfoByUseAddRewardItem = (RewardMiniPopup_PopupInfoBase_o *)sub_1BDB9B4(
  ...
  if ( !*(_DWORD *)(v5 + 24) )
    sub_1BDBADC(PopupInfoByUseAddRewardItem, v7, v8, v9);
  *(_QWORD *)(v5 + 32) = v10;
  sub_1BDB81C(v5 + 32);
...
void __fastcall RewardMiniPopupExecutor___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B3EF74 & 1) == 0 )
  {
    sub_1BDB878(&RewardMiniPopupExecutor___c_TypeInfo, v1);
    byte_4B3EF74 = 1;
  }
  v2 = (Il2CppObject *)sub_1BDBAC4(RewardMiniPopupExecutor___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  RewardMiniPopupExecutor___c_TypeInfo->static_fields->__9 = (struct RewardMiniPopupExecutor___c_o *)v2;
  sub_1BDB81C(RewardMiniPopupExecutor___c_TypeInfo->static_fields);
}
        ...
        const MethodInfo *method)
{
  ...
  *p_UseAddRewardItemRewardInfos_k__BackingField = 0LL;
  sub_1BDB81C(p_UseAddRewardItemRewardInfos_k__BackingField);
}
        ...
        const MethodInfo *method)
{
  ...
  *p_mQuestPhaseRewardInfos = 0LL;
  sub_1BDB81C(p_mQuestPhaseRewardInfos);
}
        ...
        const MethodInfo *method)
{
  ...
  *p_mQuestRewardInfos = 0LL;
  sub_1BDB81C(p_mQuestRewardInfos);
}