        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1DFED & 1) == 0 )
  {
    sub_1BCAFF8(&System_Convert_TypeInfo, updateDeckData);
    sub_1BCAFF8(&MiniMessagePack_MiniMessagePacker_TypeInfo, v5);
    sub_1BCAFF8(&StringLiteral_22777/*"recommendDeckData"*/, v6);
    byte_4B1DFED = 1;
  }
  ...
  RequestBase__addField_43348616((RequestBase_o *)this, (System_String_o *)StringLiteral_22777/*"recommendDeckData"*/, v11, v12);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1DFEC & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_19352/*"follower/setupRecommendSupport"*/, v2);
    byte_4B1DFEC = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62450424(BaseUrl, (System_String_o *)StringLiteral_19352/*"follower/setupRecommendSupport"*/, 0LL);
}
