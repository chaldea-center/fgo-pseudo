void __fastcall BattlePerformanceEnemyMst___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B47E06 & 1) == 0 )
  {
    sub_1BDB878(&BattlePerformanceEnemyMst_TypeInfo, v1);
    sub_1BDB878(&StringLiteral_4464/*"ChrVoice_{0}"*/, v4);
    sub_1BDB878(&StringLiteral_19041/*"enemyMstFace{0:d5}"*/, v5);
    sub_1BDB878(&StringLiteral_6055/*"EnemyMasterFace/enemyMstFace{0:d5}"*/, v6);
    byte_4B47E06 = 1;
  }
  BattlePerformanceEnemyMst_TypeInfo->static_fields->MASTER_FACE_ASSET_NAME = (struct System_String_o *)StringLiteral_6055/*"EnemyMasterFace/enemyMstFace{0:d5}"*/;
  sub_1BDB81C((CGThumbnailListItem_o *)BattlePerformanceEnemyMst_TypeInfo->static_fields, StringLiteral_6055/*"EnemyMasterFace/enemyMstFace{0:d5}"*/, v2, v3);
  v7 = StringLiteral_19041/*"enemyMstFace{0:d5}"*/;
  static_fields = BattlePerformanceEnemyMst_TypeInfo->static_fields;
  static_fields->MASTER_FACE_TEXTURE_NAME = (struct System_String_o *)StringLiteral_19041/*"enemyMstFace{0:d5}"*/;
  sub_1BDB81C((CGThumbnailListItem_o *)&static_fields->MASTER_FACE_TEXTURE_NAME, v7, v9, v10);
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&v12->MASTER_VOICE_ASSET_NAME, v11, v13, v14);
        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.data, (int32_t)indata, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47E00 & 1) == 0 )
  {
    sub_1BDB878(&BattlePerformanceEnemyMst__LoadAssetCoroutine_d__26_TypeInfo, *(_QWORD *)&mstFaceId);
    byte_4B47E00 = 1;
  }
  v5 = sub_1BDBAC4(BattlePerformanceEnemyMst__LoadAssetCoroutine_d__26_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47DFC & 1) == 0 )
  {
    ...
    sub_1BDB878(&BattleDataDefine_TypeInfo, v3);
    sub_1BDB878(&Method_DataManager_GetMaster_EnemyMstBattleMaster___, v4);
    sub_1BDB878(&DataManager_TypeInfo, v5);
    sub_1BDB878(&Method_DataMasterBase_EnemyMstBattleMaster__EnemyMstBattleEntity__int__GetEntity__, v6);
    sub_1BDB878(&int_TypeInfo, v7);
    sub_1BDB878(&UnityEngine_Object_TypeInfo, v8);
    sub_1BDB878(&StringLiteral_19668/*"frame_enemymaster_bg"*/, v9);
    sub_1BDB878(&StringLiteral_3150/*"BattleAssetUIAtlas"*/, v10);
    sub_1BDB878(&StringLiteral_19669/*"frame_enemymaster_bg_{0}"*/, v11);
    byte_4B47DFC = 1;
  }
  ...
  if ( ((unsigned __int8)enemyMasterFrame & 1) != 0 )
  {
    ...
    if ( !enemyMasterFrame )
      goto LABEL_27;
    UISprite__set_spriteName(enemyMasterFrame, (System_String_o *)StringLiteral_19668/*"frame_enemymaster_bg"*/, 0LL);
  }
  ...
  enemyMasterFrame = (UISprite_o *)DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_EnemyMstBattleMaster___);
  ...
  if ( !v16
    ...
    || (enemyMasterFrame = (UISprite_o *)DataMasterBase_object__object__int___GetEntity(
                                           ...
                                           (const MethodInfo_32E1E3C *)Method_DataMasterBase_EnemyMstBattleMaster__EnemyMstBattleEntity__int__GetEntity__)) == 0LL )
  {
LABEL_27:
    sub_1BDBAD4(enemyMasterFrame, v14);
  }
  ...
  if ( OverwriteFrame )
  {
    ...
    if ( AssetManager__TryGetUIAtlas(&atlas, ASSET_BATTLE_COMMON, (System_String_o *)StringLiteral_3150/*"BattleAssetUIAtlas"*/, 0LL) )
    {
      ...
      if ( enemyMasterFrame )
      {
        ...
        enemyMasterFrame = (UISprite_o *)System_String__Format((System_String_o *)StringLiteral_19669/*"frame_enemymaster_bg_{0}"*/, v26, 0LL);
        if ( v22 )
        {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47DFF & 1) == 0 )
  {
    sub_1BDB878(&AssetLoader_LoadEndDataHandler_TypeInfo, *(_QWORD *)&nextMstFaceId);
    sub_1BDB878(&Method_SingletonMonoBehaviour_AssetManager__get_Instance__, v5);
    sub_1BDB878(&Method_BattlePerformanceEnemyMst___c__DisplayClass25_0__changeMasterFace_b__0__, v6);
    sub_1BDB878(&BattlePerformanceEnemyMst___c__DisplayClass25_0_TypeInfo, v7);
    byte_4B47DFF = 1;
  }
  v8 = sub_1BDBAC4(BattlePerformanceEnemyMst___c__DisplayClass25_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47E03 & 1) == 0 )
  {
    sub_1BDB878(&BattlePerformanceEnemyMst_TypeInfo, *(_QWORD *)&id);
...
void __fastcall BattlePerformanceEnemyMst__loadData(BattlePerformanceEnemyMst_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B47DFB & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_BattlePerformanceEnemyMst__loadData_b__20_0__, v3);
    this = (BattlePerformanceEnemyMst_o *)sub_1BDB878(&SoundManager_TypeInfo, v4);
    byte_4B47DFB = 1;
  }
  data = v2->fields.data;
  if ( !data )
...
LABEL_15:
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&v2->fields.loadVoiceAsset, (int32_t)VoiceAssetName, v10, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47DFE & 1) == 0 )
  {
    sub_1BDB878(&UnityEngine_Object_TypeInfo, *(_QWORD *)&mstFaceId);
    byte_4B47DFE = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(faceText, 0LL, 0LL) )
  {
    ...
    UnityEngine_MonoBehaviour__StartCoroutine_70269772((UnityEngine_MonoBehaviour_o *)this, AssetCoroutine, 0LL);
  }
}
...
LABEL_21:
        ...
        if ( mstFaceAssets )
        {
          ...
          sub_1BDB81C(p_mstFaceAssets, 0, v14, v15);
        }
        return;
      }
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( loadVoiceAsset )
  {
    ...
    sub_1BDB81C(p_loadVoiceAsset, 0, v6, v7);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47DFD & 1) == 0 )
  {
    this = (BattlePerformanceEnemyMst_o *)sub_1BDB878(&BattlePerformanceEnemyMst_TypeInfo, method);
    byte_4B47DFD = 1;
  }
  data = v2->fields.data;
  if ( !data )
...
LABEL_25:
  ...
  v21.fields.x = v18;
  v21.fields.y = v19;
  GameObjectExtensions__SetLocalPosition_35211000(gameObject, v21, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47E09 & 1) == 0 )
  {
    sub_1BDB878(&AssetLoader_LoadEndDataHandler_TypeInfo, method);
    sub_1BDB878(&Method_SingletonMonoBehaviour_AssetManager__get_Instance__, v3);
    sub_1BDB878(&Method_BattlePerformanceEnemyMst___c__DisplayClass26_0__LoadAssetCoroutine_b__0__, v4);
    sub_1BDB878(&BattlePerformanceEnemyMst___c__DisplayClass26_0_TypeInfo, v5);
    byte_4B47E09 = 1;
  }
  ...
  if ( _1__state != 1 )
  {
    if ( !_1__state )
    {
      ...
      v7 = (Il2CppObject *)sub_1BDBAC4(BattlePerformanceEnemyMst___c__DisplayClass26_0_TypeInfo);
      System_Object___ctor(v7, 0LL);
      this->fields.__8__1 = (struct BattlePerformanceEnemyMst___c__DisplayClass26_0_o *)v7;
      p__8__1 = &this->fields.__8__1;
      sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.__8__1, (int32_t)v7, v9, v10);
      _8__1 = (char *)this->fields.__8__1;
      if ( _8__1 )
      {
        _4__this = this->fields.__4__this;
        *((_QWORD *)_8__1 + 2) = _4__this;
        sub_1BDB81C((CGThumbnailListItem_o *)(_8__1 + 16), (int32_t)_4__this, v12, v13);
        if ( *p__8__1 )
        {
          (*p__8__1)->fields.mstFaceId = this->fields.mstFaceId;
          this->fields.__2__current = 0LL;
          p__2__current = &this->fields.__2__current;
          sub_1BDB81C((CGThumbnailListItem_o *)p__2__current, 0, v16, v17);
          result = 1;
...
LABEL_14:
      sub_1BDBAD4(_8__1, v11);
    }
    return 0;
  }
  this->fields.__1__state = -1;
  v20 = this->fields.__4__this;
  _8__1 = (char *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_AssetManager__get_Instance__);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BDB88C(&Method_BattlePerformanceEnemyMst__LoadAssetCoroutine_d__26_System_Collections_IEnumerator_Reset__);
  sub_1BDB9A0(v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47E07 & 1) == 0 )
  {
    ...
    this = (BattlePerformanceEnemyMst___c__DisplayClass25_0_o *)sub_1BDB878(&AssetManager_TypeInfo, v5);
    byte_4B47E07 = 1;
  }
  ...
  if ( !v3 )
    goto LABEL_13;
  this = (BattlePerformanceEnemyMst___c__DisplayClass25_0_o *)AssetData__GetObject_object__50417328(
                                                                v3,
...
LABEL_13:
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this[2].fields, (int32_t)v3, v7, v8);
}
        ...
        const MethodInfo *method)
{
  ...
  *((_QWORD *)_4__this + 10) = data;
  sub_1BDB81C((CGThumbnailListItem_o *)(_4__this + 80), (int32_t)data, (int32_t)method, v3);
  v9 = this->fields.__4__this;
  if ( !v9 )
    goto LABEL_10;
  v9->fields.loadStat = 0;
  faceText = v9->fields.faceText;
  v11 = UnityEngine_Shader__Find((System_String_o *)StringLiteral_4979/*"Custom/SpriteWithMask"*/, 0LL);
  v12 = (UnityEngine_Material_o *)sub_1BDBAC4(UnityEngine_Material_TypeInfo);
  ...
  if ( !faceText
    ...
    || (v15 = v14->fields.faceText,
        ...
        _4__this = (char *)BattlePerformanceEnemyMst__getTextureName(
                             ...
                             v13),
        !mstFaceAssets)
    || (_4__this = (char *)AssetData__GetObject_object__50417328(
                             mstFaceAssets,
