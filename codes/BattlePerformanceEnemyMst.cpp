void __fastcall BattlePerformanceEnemyMst___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB8C9D & 1) == 0 )
  {
    sub_1BAB41C(&BattlePerformanceEnemyMst_TypeInfo, v1);
    sub_1BAB41C(&StringLiteral_4464/*"ChrVoice_{0}"*/, v4);
    sub_1BAB41C(&StringLiteral_19054/*"enemyMstFace{0:d5}"*/, v5);
    sub_1BAB41C(&StringLiteral_6013/*"EnemyMasterFace/enemyMstFace{0:d5}"*/, v6);
    byte_4AB8C9D = 1;
  }
  BattlePerformanceEnemyMst_TypeInfo->static_fields->MASTER_FACE_ASSET_NAME = (struct System_String_o *)StringLiteral_6013/*"EnemyMasterFace/enemyMstFace{0:d5}"*/;
  sub_1BAB3C0(
    ...
    v2,
    v3);
  v7 = StringLiteral_19054/*"enemyMstFace{0:d5}"*/;
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&static_fields->MASTER_FACE_TEXTURE_NAME, v7, v9, v10);
  v11 = StringLiteral_4464/*"ChrVoice_{0}"*/;
  v12 = BattlePerformanceEnemyMst_TypeInfo->static_fields;
  v12->MASTER_VOICE_ASSET_NAME = (struct System_String_o *)StringLiteral_4464/*"ChrVoice_{0}"*/;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&v12->MASTER_VOICE_ASSET_NAME, v11, v13, v14);
        ...
        const MethodInfo *method)
{
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.data, (int32_t)indata, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB8C97 & 1) == 0 )
  {
    sub_1BAB41C(&BattlePerformanceEnemyMst__LoadAssetCoroutine_d__26_TypeInfo, *(_QWORD *)&mstFaceId);
    byte_4AB8C97 = 1;
  }
  v5 = sub_1BAB668(BattlePerformanceEnemyMst__LoadAssetCoroutine_d__26_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB8C93 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&BattleDataDefine_TypeInfo, v3);
    sub_1BAB41C(&Method_DataManager_GetMaster_EnemyMstBattleMaster___, v4);
    sub_1BAB41C(&DataManager_TypeInfo, v5);
    sub_1BAB41C(&Method_DataMasterBase_EnemyMstBattleMaster__EnemyMstBattleEntity__int__GetEntity__, v6);
    sub_1BAB41C(&int_TypeInfo, v7);
    sub_1BAB41C(&UnityEngine_Object_TypeInfo, v8);
    sub_1BAB41C(&StringLiteral_19648/*"frame_enemymaster_bg"*/, v9);
    sub_1BAB41C(&StringLiteral_3223/*"BattleAssetUIAtlas"*/, v10);
    sub_1BAB41C(&StringLiteral_19649/*"frame_enemymaster_bg_{0}"*/, v11);
    byte_4AB8C93 = 1;
  }
  ...
  if ( ((unsigned __int8)enemyMasterFrame & 1) != 0 )
  {
    ...
    if ( !enemyMasterFrame )
      goto LABEL_27;
    UISprite__set_spriteName(enemyMasterFrame, (System_String_o *)StringLiteral_19648/*"frame_enemymaster_bg"*/, 0LL);
  }
  ...
  enemyMasterFrame = (UISprite_o *)DataManager__GetMaster_object_((const MethodInfo_2EC5574 *)Method_DataManager_GetMaster_EnemyMstBattleMaster___);
  ...
  if ( !v16
    ...
    || (enemyMasterFrame = (UISprite_o *)DataMasterBase_object__object__int___GetEntity(
                                           ...
                                           (const MethodInfo_3163D90 *)Method_DataMasterBase_EnemyMstBattleMaster__EnemyMstBattleEntity__int__GetEntity__)) == 0LL )
  {
LABEL_27:
    sub_1BAB678(enemyMasterFrame, v14);
  }
  ...
  if ( OverwriteFrame )
  {
    ...
    if ( AssetManager__TryGetUIAtlas(&atlas, ASSET_BATTLE_COMMON, (System_String_o *)StringLiteral_3223/*"BattleAssetUIAtlas"*/, 0LL) )
    {
      ...
      if ( enemyMasterFrame )
      {
        ...
        enemyMasterFrame = (UISprite_o *)System_String__Format((System_String_o *)StringLiteral_19649/*"frame_enemymaster_bg_{0}"*/, v26, 0LL);
        if ( v22 )
        {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB8C96 & 1) == 0 )
  {
    sub_1BAB41C(&AssetLoader_LoadEndDataHandler_TypeInfo, *(_QWORD *)&nextMstFaceId);
    sub_1BAB41C(&Method_SingletonMonoBehaviour_AssetManager__get_Instance__, v5);
    sub_1BAB41C(&Method_BattlePerformanceEnemyMst___c__DisplayClass25_0__changeMasterFace_b__0__, v6);
    sub_1BAB41C(&BattlePerformanceEnemyMst___c__DisplayClass25_0_TypeInfo, v7);
    byte_4AB8C96 = 1;
  }
  v8 = sub_1BAB668(BattlePerformanceEnemyMst___c__DisplayClass25_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB8C9A & 1) == 0 )
  {
    sub_1BAB41C(&BattlePerformanceEnemyMst_TypeInfo, *(_QWORD *)&id);
...
void __fastcall BattlePerformanceEnemyMst__loadData(BattlePerformanceEnemyMst_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB8C92 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_BattlePerformanceEnemyMst__loadData_b__20_0__, v3);
    this = (BattlePerformanceEnemyMst_o *)sub_1BAB41C(&SoundManager_TypeInfo, v4);
    byte_4AB8C92 = 1;
  }
  data = v2->fields.data;
  if ( !data )
...
LABEL_12:
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&v2->fields.loadVoiceAsset, (int32_t)VoiceAssetName, v10, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB8C95 & 1) == 0 )
  {
    sub_1BAB41C(&UnityEngine_Object_TypeInfo, *(_QWORD *)&mstFaceId);
    byte_4AB8C95 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(faceText, 0LL, 0LL) )
  {
    ...
    UnityEngine_MonoBehaviour__StartCoroutine_69785892((UnityEngine_MonoBehaviour_o *)this, AssetCoroutine, 0LL);
  }
}
...
LABEL_21:
        ...
        if ( mstFaceAssets )
        {
          ...
          sub_1BAB3C0(p_mstFaceAssets, 0, v14, v15);
        }
        return;
      }
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( loadVoiceAsset )
  {
    ...
    sub_1BAB3C0(p_loadVoiceAsset, 0, v6, v7);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB8C94 & 1) == 0 )
  {
    this = (BattlePerformanceEnemyMst_o *)sub_1BAB41C(&BattlePerformanceEnemyMst_TypeInfo, method);
    byte_4AB8C94 = 1;
  }
  data = v2->fields.data;
  if ( !data )
...
LABEL_25:
  ...
  v20.fields.x = v17;
  v20.fields.y = v18;
  GameObjectExtensions__SetLocalPosition_34019596(gameObject, v20, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB8CA0 & 1) == 0 )
  {
    sub_1BAB41C(&AssetLoader_LoadEndDataHandler_TypeInfo, method);
    sub_1BAB41C(&Method_SingletonMonoBehaviour_AssetManager__get_Instance__, v3);
    sub_1BAB41C(&Method_BattlePerformanceEnemyMst___c__DisplayClass26_0__LoadAssetCoroutine_b__0__, v4);
    sub_1BAB41C(&BattlePerformanceEnemyMst___c__DisplayClass26_0_TypeInfo, v5);
    byte_4AB8CA0 = 1;
  }
  ...
  if ( _1__state != 1 )
  {
    if ( !_1__state )
    {
      ...
      v7 = (Il2CppObject *)sub_1BAB668(BattlePerformanceEnemyMst___c__DisplayClass26_0_TypeInfo);
      System_Object___ctor(v7, 0LL);
      this->fields.__8__1 = (struct BattlePerformanceEnemyMst___c__DisplayClass26_0_o *)v7;
      p__8__1 = &this->fields.__8__1;
      sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.__8__1, (int32_t)v7, v9, v10);
      _8__1 = (char *)this->fields.__8__1;
      if ( _8__1 )
      {
        _4__this = this->fields.__4__this;
        *((_QWORD *)_8__1 + 2) = _4__this;
        sub_1BAB3C0((ServantStatusBattleListViewItem_o *)(_8__1 + 16), (int32_t)_4__this, v12, v13);
        if ( *p__8__1 )
        {
          (*p__8__1)->fields.mstFaceId = this->fields.mstFaceId;
          this->fields.__2__current = 0LL;
          p__2__current = &this->fields.__2__current;
          sub_1BAB3C0((ServantStatusBattleListViewItem_o *)p__2__current, 0, v16, v17);
          result = 1;
...
LABEL_14:
      sub_1BAB678(_8__1, v11);
    }
    return 0;
  }
  this->fields.__1__state = -1;
  v20 = this->fields.__4__this;
  _8__1 = (char *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_378A22C *)Method_SingletonMonoBehaviour_AssetManager__get_Instance__);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BAB430(&Method_BattlePerformanceEnemyMst__LoadAssetCoroutine_d__26_System_Collections_IEnumerator_Reset__);
  sub_1BAB544(v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB8C9E & 1) == 0 )
  {
    ...
    this = (BattlePerformanceEnemyMst___c__DisplayClass25_0_o *)sub_1BAB41C(&AssetManager_TypeInfo, v5);
    byte_4AB8C9E = 1;
  }
  ...
  if ( !v3 )
    goto LABEL_13;
  this = (BattlePerformanceEnemyMst___c__DisplayClass25_0_o *)AssetData__GetObject_object__48916712(
                                                                v3,
...
LABEL_13:
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this[2].fields, (int32_t)v3, v7, v8);
}
        ...
        const MethodInfo *method)
{
  ...
  *((_QWORD *)_4__this + 10) = data;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)(_4__this + 80), (int32_t)data, (int32_t)method, v3);
  ...
  v12 = (UnityEngine_Material_o *)sub_1BAB668(UnityEngine_Material_TypeInfo);
  ...
  if ( !faceText
    ...
    || (v15 = v14->fields.faceText,
        ...
        _4__this = (char *)BattlePerformanceEnemyMst__getTextureName(
                             ...
                             v13),
        !mstFaceAssets)
    || (_4__this = (char *)AssetData__GetObject_object__48916712(
                             mstFaceAssets,
