void __fastcall BattlePerformanceEnemyMst___cctor(const MethodInfo *method)
{
  ...
  int64_t v19; // x1
  struct BattlePerformanceEnemyMst_StaticFields *v20; // x0
  int64_t v21; // x2
  int32_t v22; // w3
  ...
  BattlePerformanceEnemyMst_c *v27; // x8

  if ( (byte_4BCAB0B & 1) == 0 )
  {
    sub_1C1ABD4(&BattlePerformanceEnemyMst_TypeInfo, v1);
    sub_1C1ABD4(&StringLiteral_4550/*"ChrVoice_{0}"*/, v8);
    sub_1C1ABD4(&StringLiteral_19337/*"enemyMstFace{0:d5}"*/, v9);
    sub_1C1ABD4(&StringLiteral_6158/*"EnemyMasterFace/enemyMstFace{0:d5}"*/, v10);
    byte_4BCAB0B = 1;
  }
  BattlePerformanceEnemyMst_TypeInfo->static_fields->MASTER_FACE_ASSET_NAME = (struct System_String_o *)StringLiteral_6158/*"EnemyMasterFace/enemyMstFace{0:d5}"*/;
  sub_1C1AB78(
    ...
    v6,
    v7);
  v11 = StringLiteral_19337/*"enemyMstFace{0:d5}"*/;
  static_fields = BattlePerformanceEnemyMst_TypeInfo->static_fields;
  static_fields->MASTER_FACE_TEXTURE_NAME = (struct System_String_o *)StringLiteral_19337/*"enemyMstFace{0:d5}"*/;
  sub_1C1AB78((PartyOrganizationUtility_o *)&static_fields->MASTER_FACE_TEXTURE_NAME, v11, v13, v14, v15, v16, v17, v18);
  v19 = StringLiteral_4550/*"ChrVoice_{0}"*/;
  v20 = BattlePerformanceEnemyMst_TypeInfo->static_fields;
  v20->MASTER_VOICE_ASSET_NAME = (struct System_String_o *)StringLiteral_4550/*"ChrVoice_{0}"*/;
  sub_1C1AB78((PartyOrganizationUtility_o *)&v20->MASTER_VOICE_ASSET_NAME, v19, v21, v22, v23, v24, v25, v26);
  v27 = BattlePerformanceEnemyMst_TypeInfo;
  ...
  v27->static_fields->DEFAULT_COMMAND_SPELL_ICON_POSITION = (struct UnityEngine_Vector2_o)0x4184DA5142500000LL;
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.data, (int64_t)indata, (int64_t)method, v3, v4, v5, v6, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCAB05 & 1) == 0 )
  {
    sub_1C1ABD4(&BattlePerformanceEnemyMst__LoadAssetCoroutine_d__26_TypeInfo, *(_QWORD *)&mstFaceId);
    byte_4BCAB05 = 1;
  }
  v5 = sub_1C1AE20(BattlePerformanceEnemyMst__LoadAssetCoroutine_d__26_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCAB01 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&BattleDataDefine_TypeInfo, v3);
    sub_1C1ABD4(&Method_DataManager_GetMaster_EnemyMstBattleMaster___, v4);
    sub_1C1ABD4(&DataManager_TypeInfo, v5);
    sub_1C1ABD4(&Method_DataMasterBase_EnemyMstBattleMaster__EnemyMstBattleEntity__int__GetEntity__, v6);
    sub_1C1ABD4(&int_TypeInfo, v7);
    sub_1C1ABD4(&UnityEngine_Object_TypeInfo, v8);
    sub_1C1ABD4(&StringLiteral_19937/*"frame_enemymaster_bg"*/, v9);
    sub_1C1ABD4(&StringLiteral_3265/*"BattleAssetUIAtlas"*/, v10);
    sub_1C1ABD4(&StringLiteral_19938/*"frame_enemymaster_bg_{0}"*/, v11);
    byte_4BCAB01 = 1;
  }
  ...
  if ( ((unsigned __int8)enemyMasterFrame & 1) != 0 )
  {
    ...
    if ( !enemyMasterFrame )
      goto LABEL_27;
    UISprite__set_spriteName(enemyMasterFrame, (System_String_o *)StringLiteral_19937/*"frame_enemymaster_bg"*/, 0LL);
  }
  ...
  enemyMasterFrame = (UISprite_o *)DataManager__GetMaster_object_((const MethodInfo_2F9F43C *)Method_DataManager_GetMaster_EnemyMstBattleMaster___);
  ...
  if ( !v16
    ...
    || (enemyMasterFrame = (UISprite_o *)DataMasterBase_object__object__int___GetEntity(
                                           ...
                                           (const MethodInfo_3248678 *)Method_DataMasterBase_EnemyMstBattleMaster__EnemyMstBattleEntity__int__GetEntity__)) == 0LL )
  {
LABEL_27:
    sub_1C1AE30(enemyMasterFrame, v14);
  }
  ...
  if ( OverwriteFrame )
  {
    ...
    if ( AssetManager__TryGetUIAtlas(&atlas, ASSET_BATTLE_COMMON, (System_String_o *)StringLiteral_3265/*"BattleAssetUIAtlas"*/, 0LL) )
    {
      ...
      if ( enemyMasterFrame )
      {
        ...
        enemyMasterFrame = (UISprite_o *)System_String__Format((System_String_o *)StringLiteral_19938/*"frame_enemymaster_bg_{0}"*/, v26, 0LL);
        if ( v22 )
        {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCAB04 & 1) == 0 )
  {
    sub_1C1ABD4(&AssetLoader_LoadEndDataHandler_TypeInfo, *(_QWORD *)&nextMstFaceId);
    sub_1C1ABD4(&Method_SingletonMonoBehaviour_AssetManager__get_Instance__, v5);
    sub_1C1ABD4(&Method_BattlePerformanceEnemyMst___c__DisplayClass25_0__changeMasterFace_b__0__, v6);
    sub_1C1ABD4(&BattlePerformanceEnemyMst___c__DisplayClass25_0_TypeInfo, v7);
    byte_4BCAB04 = 1;
  }
  v8 = sub_1C1AE20(BattlePerformanceEnemyMst___c__DisplayClass25_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCAB08 & 1) == 0 )
  {
    sub_1C1ABD4(&BattlePerformanceEnemyMst_TypeInfo, *(_QWORD *)&id);
...
void __fastcall BattlePerformanceEnemyMst__loadData(BattlePerformanceEnemyMst_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BCAB00 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_BattlePerformanceEnemyMst__loadData_b__20_0__, v3);
    this = (BattlePerformanceEnemyMst_o *)sub_1C1ABD4(&SoundManager_TypeInfo, v4);
    byte_4BCAB00 = 1;
  }
  data = v2->fields.data;
  if ( !data )
...
LABEL_12:
  ...
  sub_1C1AB78(
    (PartyOrganizationUtility_o *)&v2->fields.loadVoiceAsset,
  ...
  System_Action___ctor(v17, (Il2CppObject *)v2, Method_BattlePerformanceEnemyMst__loadData_b__20_0__, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCAB03 & 1) == 0 )
  {
    sub_1C1ABD4(&UnityEngine_Object_TypeInfo, *(_QWORD *)&mstFaceId);
    byte_4BCAB03 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(faceText, 0LL, 0LL) )
  {
    ...
    UnityEngine_MonoBehaviour__StartCoroutine_70779684((UnityEngine_MonoBehaviour_o *)this, AssetCoroutine, 0LL);
  }
}
...
LABEL_21:
        ...
        if ( mstFaceAssets )
        {
          ...
          sub_1C1AB78(p_mstFaceAssets, 0LL, v14, v15, v16, v17, v18, v19);
        }
        return;
      }
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( loadVoiceAsset )
  {
    ...
    sub_1C1AB78(p_loadVoiceAsset, 0LL, v6, v7, v8, v9, v10, v11);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCAB02 & 1) == 0 )
  {
    this = (BattlePerformanceEnemyMst_o *)sub_1C1ABD4(&BattlePerformanceEnemyMst_TypeInfo, method);
    byte_4BCAB02 = 1;
  }
  data = v2->fields.data;
  if ( !data )
...
LABEL_25:
  ...
  v20.fields.x = v17;
  v20.fields.y = v18;
  GameObjectExtensions__SetLocalPosition_34756204(gameObject, v20, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCAB0E & 1) == 0 )
  {
    sub_1C1ABD4(&AssetLoader_LoadEndDataHandler_TypeInfo, method);
    sub_1C1ABD4(&Method_SingletonMonoBehaviour_AssetManager__get_Instance__, v3);
    sub_1C1ABD4(&Method_BattlePerformanceEnemyMst___c__DisplayClass26_0__LoadAssetCoroutine_b__0__, v4);
    sub_1C1ABD4(&BattlePerformanceEnemyMst___c__DisplayClass26_0_TypeInfo, v5);
    byte_4BCAB0E = 1;
  }
  ...
  if ( _1__state != 1 )
  {
    if ( !_1__state )
    {
      ...
      v7 = (Il2CppObject *)sub_1C1AE20(BattlePerformanceEnemyMst___c__DisplayClass26_0_TypeInfo);
      System_Object___ctor(v7, 0LL);
      this->fields.__8__1 = (struct BattlePerformanceEnemyMst___c__DisplayClass26_0_o *)v7;
      p__8__1 = &this->fields.__8__1;
      sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.__8__1, (int64_t)v7, v9, v10, v11, v12, v13, v14);
      _8__1 = (char *)this->fields.__8__1;
      if ( _8__1 )
      {
        _4__this = this->fields.__4__this;
        *((_QWORD *)_8__1 + 2) = _4__this;
        sub_1C1AB78((PartyOrganizationUtility_o *)(_8__1 + 16), (int64_t)_4__this, v16, v17, v18, v19, v20, v21);
        if ( *p__8__1 )
        {
          (*p__8__1)->fields.mstFaceId = this->fields.mstFaceId;
          this->fields.__2__current = 0LL;
          p__2__current = &this->fields.__2__current;
          sub_1C1AB78((PartyOrganizationUtility_o *)p__2__current, 0LL, v24, v25, v26, v27, v28, v29);
          result = 1;
...
LABEL_14:
      sub_1C1AE30(_8__1, v15);
    }
    return 0;
  }
  this->fields.__1__state = -1;
  v32 = this->fields.__4__this;
  _8__1 = (char *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_387A8A8 *)Method_SingletonMonoBehaviour_AssetManager__get_Instance__);
  v34 = this->fields.__8__1;
  if ( !v34 )
    goto LABEL_14;
  if ( !v32 )
    goto LABEL_14;
  v35 = (AssetManager_o *)_8__1;
  AssetName = BattlePerformanceEnemyMst__getAssetName((BattlePerformanceEnemyMst_o *)_8__1, v34->fields.mstFaceId, v33);
  v37 = (Il2CppObject *)this->fields.__8__1;
  v38 = AssetName;
  v39 = (AssetLoader_LoadEndDataHandler_o *)sub_1C1AE20(AssetLoader_LoadEndDataHandler_TypeInfo);
  AssetLoader_LoadEndDataHandler___ctor(
    v39,
    v37,
  ...
  if ( !v35 )
    goto LABEL_14;
  if ( AssetManager__LoadAssetStorage(v35, v38, v39, 1, 0LL) )
    return 0;
  result = 0;
  v32->fields.loadStat = 0;
  return result;
}
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C1ABE8(&Method_BattlePerformanceEnemyMst__LoadAssetCoroutine_d__26_System_Collections_IEnumerator_Reset__);
  sub_1C1ACFC(v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCAB0C & 1) == 0 )
  {
    ...
    this = (BattlePerformanceEnemyMst___c__DisplayClass25_0_o *)sub_1C1ABD4(&AssetManager_TypeInfo, v5);
    byte_4BCAB0C = 1;
  }
  ...
  if ( !v3 )
    goto LABEL_13;
  this = (BattlePerformanceEnemyMst___c__DisplayClass25_0_o *)AssetData__GetObject_object__49812820(
                                                                v3,
  ...
  if ( !this )
    goto LABEL_13;
  v13 = this[2].fields.__4__this;
  if ( v13 )
  {
    m_CancellationTokenSource = (System_String_o *)v13->fields.m_CancellationTokenSource;
    if ( !AssetManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
...
LABEL_13:
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&this[2].fields, (int64_t)v3, v7, v8, v9, v10, v11, v12);
}
        ...
        const MethodInfo *method)
{
  ...
  struct BattlePerformanceEnemyMst_o *v18; // x8
  ...
  if ( (byte_4BCAB0D & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_5071/*"Custom/SpriteWithMask"*/, v11);
    byte_4BCAB0D = 1;
  }
  ...
  *((_QWORD *)_4__this + 10) = data;
  sub_1C1AB78((PartyOrganizationUtility_o *)(_4__this + 80), (int64_t)data, (int64_t)method, v3, v4, v5, v6, v7);
  v13 = this->fields.__4__this;
  if ( !v13 )
    goto LABEL_10;
  v13->fields.loadStat = 0;
  faceText = v13->fields.faceText;
  v15 = UnityEngine_Shader__Find((System_String_o *)StringLiteral_5071/*"Custom/SpriteWithMask"*/, 0LL);
  ...
  if ( !faceText
    ...
    || (v19 = v18->fields.faceText,
        mstFaceAssets = v18->fields.mstFaceAssets,
        _4__this = (char *)BattlePerformanceEnemyMst__getTextureName(
                             (BattlePerformanceEnemyMst_o *)_4__this,
                             this->fields.mstFaceId,
                             v17),
        !mstFaceAssets)
    || (_4__this = (char *)AssetData__GetObject_object__49812820(
                             mstFaceAssets,
  ...
  {
LABEL_10:
    sub_1C1AE30(_4__this, data);
  }
  ((void (__fastcall *)(struct UITexture_o *, char *, Il2CppMethodPointer))v19->klass->vtable._27_set_mainTexture.method)(
    v19,
    _4__this,
