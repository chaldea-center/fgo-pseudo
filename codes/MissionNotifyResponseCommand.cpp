        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2E441 & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_JsonManager_DeserializeArray_ClearRandomMissionInfo___);
    sub_1C94098(&Method_JsonManager_DeserializeArray_MissionNotifyDispInfo___);
    sub_1C94098(&JsonManager_TypeInfo);
    sub_1C94098(&Method_SingletonTemplate_MissionNotifyManager__get_Instance__);
    sub_1C94098(&StringLiteral_18097/*"clearRandomMissions"*/);
    this = (MissionNotifyResponseCommand_o *)sub_1C94098(&StringLiteral_19296/*"eventMissionAnnounce"*/);
    byte_4D2E441 = 1;
  }
  if ( !data )
    goto LABEL_29;
  ...
  if ( System_Collections_Generic_Dictionary_object__object___ContainsKey(
         ...
         (Il2CppObject *)StringLiteral_19296/*"eventMissionAnnounce"*/,
         (const MethodInfo_3520DE8 *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
  {
    ...
    this = (MissionNotifyResponseCommand_o *)JsonManager__DeserializeArray_object_(
                                               Item,
                                               (const MethodInfo_320C67C *)Method_JsonManager_DeserializeArray_MissionNotifyDispInfo___);
    if ( !this )
      goto LABEL_29;
    nid = this->fields.nid;
    v7 = this;
    if ( (int)nid >= 1 )
    {
      ...
      while ( v8 < (unsigned int)nid )
      {
        ...
        this = (MissionNotifyResponseCommand_o *)SingletonTemplate_object___get_Instance((const MethodInfo_3ABAA64 *)Method_SingletonTemplate_MissionNotifyManager__get_Instance__);
        if ( !this )
          goto LABEL_29;
...
LABEL_14:
  ...
  this = (MissionNotifyResponseCommand_o *)JsonManager__DeserializeArray_object_(
                                             v10,
                                             (const MethodInfo_320C67C *)Method_JsonManager_DeserializeArray_ClearRandomMissionInfo___);
  if ( !this )
LABEL_29:
