...
void DebugUserServerTimeMenu__SetupUserServerTimeNow(DebugUserServerTimeMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E01EF8 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_21969/*"mm"*/);
    sub_1CE6700(&StringLiteral_8787/*"MM"*/);
    sub_1CE6700(&StringLiteral_7273/*"HH"*/);
    sub_1CE6700(&StringLiteral_25392/*"yyyy"*/);
    sub_1CE6700(&StringLiteral_18715/*"dd"*/);
    byte_4E01EF8 = 1;
  }
  ...
  inputYear = (UnityEngine_Component_o *)System_DateTime__ToString_66521012(
                                           v6,
                                           (System_String_o *)StringLiteral_25392/*"yyyy"*/,
                                           0);
  if ( !Component_object )
    goto LABEL_16;
  ...
  inputYear = (UnityEngine_Component_o *)System_DateTime__ToString_66521012(
                                           v8,
                                           (System_String_o *)StringLiteral_8787/*"MM"*/,
                                           0);
  if ( !v7 )
    goto LABEL_16;
  ...
  inputYear = (UnityEngine_Component_o *)System_DateTime__ToString_66521012(
                                           v10,
                                           (System_String_o *)StringLiteral_18715/*"dd"*/,
                                           0);
  if ( !v9 )
    goto LABEL_16;
  ...
  inputYear = (UnityEngine_Component_o *)System_DateTime__ToString_66521012(
                                           v12,
                                           (System_String_o *)StringLiteral_7273/*"HH"*/,
                                           0);
  if ( !v11
    ...
    || (v13 = UnityEngine_Component__GetComponent_object_(
        ...
        inputYear = (UnityEngine_Component_o *)System_DateTime__ToString_66521012(
                                                 v14,
                                                 (System_String_o *)StringLiteral_21969/*"mm"*/,
                                                 0),
        !v13) )
  {
LABEL_16:
    sub_1CE6958(inputYear, v3.fields._dateData);
  }
...
void DebugUserServerTimeMenu__StartMenu(DebugUserServerTimeMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E01EF6 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_DebugUserServerTimeMenu__StartMenu_b__7_0__);
    byte_4E01EF6 = 1;
  }
...
void DebugUserServerTimeMenu__endCallback(DebugUserServerTimeMenu_o *this, const MethodInfo *method)
{
  ...
  if ( endCallbackFunc )
  {
    ...
    sub_1CE66A4(p_endCallbackFunc, 0, v2, v3, v4, v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E01EF7 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_8787/*"MM"*/);
    sub_1CE6700(&StringLiteral_7273/*"HH"*/);
    sub_1CE6700(&StringLiteral_25849/*"ユーザーIDが存在しないため設定できません"*/);
...
LABEL_29:
    sub_1CE6958(inputYear, v6.fields._dateData);
  }
  inputYear = (UnityEngine_Component_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !inputYear )
    goto LABEL_29;
  CommonUI__OpenNotificationDialog(
    (CommonUI_o *)inputYear,
    (System_String_o *)StringLiteral_1/*""*/,
    (System_String_o *)StringLiteral_25849/*"ユーザーIDが存在しないため設定できません"*/,
    endCallback,
    -1,
    0,
    0,
