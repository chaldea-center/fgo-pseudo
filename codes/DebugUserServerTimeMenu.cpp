...
void DebugUserServerTimeMenu__StartMenu(DebugUserServerTimeMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB37AA & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_DebugUserServerTimeMenu__StartMenu_b__7_0__);
    byte_4CB37AA = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB37AB & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_21719/*"mm"*/);
    sub_1C6BA08(&StringLiteral_8718/*"MM"*/);
    sub_1C6BA08(&StringLiteral_7212/*"HH"*/);
    sub_1C6BA08(&StringLiteral_25546/*"ユーザーIDが存在しないため設定できません"*/);
    sub_1C6BA08(&StringLiteral_1/*""*/);
    sub_1C6BA08(&StringLiteral_25090/*"yyyy"*/);
    sub_1C6BA08(&StringLiteral_18527/*"dd"*/);
    byte_4CB37AB = 1;
  }
  ...
  if ( v5->static_fields->userIdNumber != -1 )
  {
    ...
    if ( inputYear )
    {
      ...
      inputYear = (UnityEngine_Component_o *)System_DateTime__ToString_65364976(
                                               v9,
                                               (System_String_o *)StringLiteral_25090/*"yyyy"*/,
                                               0);
      if ( Component_object )
      {
        ...
        if ( inputYear )
        {
          ...
          inputYear = (UnityEngine_Component_o *)System_DateTime__ToString_65364976(
                                                   v11,
                                                   (System_String_o *)StringLiteral_8718/*"MM"*/,
                                                   0);
          if ( v10 )
          {
            ...
            if ( inputYear )
            {
              ...
              inputYear = (UnityEngine_Component_o *)System_DateTime__ToString_65364976(
                                                       v13,
                                                       (System_String_o *)StringLiteral_18527/*"dd"*/,
                                                       0);
              if ( v12 )
              {
                ...
                if ( inputYear )
                {
                  ...
                  inputYear = (UnityEngine_Component_o *)System_DateTime__ToString_65364976(
                                                           v15,
                                                           (System_String_o *)StringLiteral_7212/*"HH"*/,
                                                           0);
                  if ( v14 )
                  {
                    ...
                    if ( inputYear )
                    {
                      ...
                      inputYear = (UnityEngine_Component_o *)System_DateTime__ToString_65364976(
                                                               v17,
                                                               (System_String_o *)StringLiteral_21719/*"mm"*/,
                                                               0);
                      if ( v16 )
                      {
                        ...
                        sub_1C6B9AC((CGThumbnailListItem_o *)p_endCallbackFunc, (int32_t)endCallback, v19, v20);
...
LABEL_29:
    sub_1C6BC60(inputYear, v6.fields._dateData);
  }
  inputYear = (UnityEngine_Component_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A4F3B4 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !inputYear )
    goto LABEL_29;
  CommonUI__OpenNotificationDialog(
    (CommonUI_o *)inputYear,
    (System_String_o *)StringLiteral_1/*""*/,
    (System_String_o *)StringLiteral_25546/*"ユーザーIDが存在しないため設定できません"*/,
    endCallback,
    -1,
    0,
    0,
