void __fastcall VoiceCondType___cctor(const MethodInfo *method)
{
  ...
  v1 = (struct GameEventType_TYPE_array *)sub_1B88658(GameEventType_TYPE___TypeInfo, 2LL);
  if ( !v1 )
    sub_1B8880C(0LL, v2);
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)VoiceCondType_TypeInfo->static_fields, (int32_t)v1, v3, v4);
}
...
bool __fastcall VoiceCondType__IsSatisfyBirthdayCondition(const MethodInfo *method)
{
  ...
  v9 = NetworkManager__getDateTime_38478840(birthDay, 0LL).fields._dateData;
  ...
  if ( System_DateTime__get_Month(v11, 0LL) == 2 )
  {
    ...
    if ( System_DateTime__get_Day(v12, 0LL) == 29 )
    {
      ...
      System_DateTime___ctor_62384912(v14, Year, 2, 29, 0LL);
      v9 = v8;
    }
  }
  if ( !System_DateTime_TypeInfo->_2.cctor_finished )
...
bool __fastcall VoiceCondType__IsSatisfyEventCondition(const MethodInfo *method)
{
  ...
  if ( (byte_4A5A1B5 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_System_Collections_Generic_List_Enumerator_EventEntity____Dispose__);
    sub_1B885B0(&Method_System_Collections_Generic_List_Enumerator_EventEntity____MoveNext__);
    sub_1B885B0(&Method_System_Collections_Generic_List_Enumerator_EventEntity____get_Current__);
    sub_1B885B0(&Method_System_Collections_Generic_List_EventEntity____GetEnumerator__);
...
LABEL_29:
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    EnableEntityLists,
    (const MethodInfo_34FE32C *)Method_System_Collections_Generic_List_EventEntity____GetEnumerator__);
  v20 = v19;
  while ( 1 )
  {
LABEL_10:
    isEventVoicePlay = System_Collections_Generic_List_Enumerator_object___MoveNext(
                         &v20,
                         (const MethodInfo_3278304 *)Method_System_Collections_Generic_List_Enumerator_EventEntity____MoveNext__);
    v8 = isEventVoicePlay;
    if ( !isEventVoicePlay )
    {
      v17 = 8;
  ...
  if ( !(_DWORD)monitor )
LABEL_22:
    sub_1B88814(isEventVoicePlay, v7);
  v12 = 0;
  while ( 1 )
  {
    v13 = *((_QWORD *)&current[2].klass + (int)v12);
    if ( !v13 )
      sub_1B8880C(isEventVoicePlay, v7);
    if ( !v5 )
      sub_1B8880C(isEventVoicePlay, v7);
...
LABEL_25:
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v20,
    (const MethodInfo_3278300 *)Method_System_Collections_Generic_List_Enumerator_EventEntity____Dispose__);
  return v8 && v17 == 7;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A1B8 & 1) == 0 )
  {
    *(_QWORD *)&condValue = sub_1B885B0(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    byte_4A5A1B8 = 1;
  }
  if ( !usrSvtList )
LABEL_17:
    sub_1B8880C(*(_QWORD *)&condValue, usrSvtList);
  ...
  if ( max_length >= 1 )
  {
    for ( i = 0; (int)i < max_length; v5 = (int)++i < max_length )
    {
      if ( i >= max_length )
LABEL_16:
        sub_1B88814(*(_QWORD *)&condValue, usrSvtList);
      ...
      *(_QWORD *)&condValue = System_Int32__Equals_62512140((int32_t)&v15, v13, 0LL);
      if ( (condValue & 1) != 0 )
      {
        ...
        const MethodInfo *method)
{
  ...
  Instance = (ServantGroupEntity_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance
    || (Instance = (ServantGroupEntity_array *)DataManager__GetMasterData_object_(
                                                 (DataManager_o *)Instance,
                                                 (const MethodInfo_2E7F908 *)Method_DataManager_GetMasterData_ServantGroupMaster___)) == 0LL
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      *(_QWORD *)&v24.fields.fakeValue = parent;
      Instance = (ServantGroupEntity_array *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46449800(
                                               v24,
                                               0LL);
