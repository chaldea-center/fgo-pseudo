        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5E047 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_2853/*"BATTLE_DEFENCE_TARGET_NAME_{0}"*/);
    byte_4A5E047 = 1;
  }
  if ( maxHp < 1 || uiId <= 0 )
  {
  ...
  else
  {
    ...
    v15 = System_String__Format((System_String_o *)StringLiteral_2853/*"BATTLE_DEFENCE_TARGET_NAME_{0}"*/, v14, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5E048 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_20199/*"icon{0}"*/);
    byte_4A5E048 = 1;
  }
  ...
  if ( !this->fields.icon
    || (UISprite__set_atlas(this->fields.icon, (UIAtlas_o *)AssetStorage, 0LL),
        ...
        AssetStorage = (AssetData_o *)System_String__Format((System_String_o *)StringLiteral_20199/*"icon{0}"*/, v11, 0LL),
        !icon)
  ...
  if ( this->fields.isInitialized )
  {
    ...
    if ( UnityEngine_Object__op_Equality(animation, 0LL, 0LL) )
    {
      ...
      *p_animation = (struct UnityEngine_Animation_o *)Component_object;
      sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.animation, (int32_t)Component_object, v12, v13);
    }
...
LABEL_30:
    ...
    if ( UnityEngine_TrackedReference__op_Inequality(Item, 0LL, 0LL) )
    {
      ...
      UnityEngine_AnimationState__set_time(v15, length, 0LL);
      gameObject = (UnityEngine_GameObject_o *)*p_animation;
      if ( !*p_animation )
        goto LABEL_30;
      UnityEngine_Animation__Play_69204472((UnityEngine_Animation_o *)gameObject, Empty, 0LL);
    }
    if ( this->fields.isContinue )
    {
      gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
