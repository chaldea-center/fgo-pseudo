        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2A7AB & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_2733/*"BATTLE_DEFENCE_TARGET_NAME_{0}"*/);
    byte_4C2A7AB = 1;
  }
  if ( maxHp < 1 || uiId <= 0 )
  {
  ...
  else
  {
    ...
    v15 = System_String__Format((System_String_o *)StringLiteral_2733/*"BATTLE_DEFENCE_TARGET_NAME_{0}"*/, v14, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2A7AC & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_20238/*"icon{0}"*/);
    byte_4C2A7AC = 1;
  }
  ...
  if ( !this->fields.icon
    || (UISprite__set_atlas(this->fields.icon, (UIAtlas_o *)AssetStorage, 0),
        ...
        AssetStorage = (AssetData_o *)System_String__Format((System_String_o *)StringLiteral_20238/*"icon{0}"*/, v11, 0),
        !icon)
  ...
  if ( this->fields.isInitialized )
  {
    ...
    if ( UnityEngine_Object__op_Equality(animation, 0, 0) )
    {
      ...
      *p_animation = (struct UnityEngine_Animation_o *)Component_object;
      sub_1C2D434((CGThumbnailListItem_o *)&this->fields.animation, (int32_t)Component_object, v12, v13);
    }
...
LABEL_30:
    ...
    if ( UnityEngine_TrackedReference__op_Inequality(Item, 0, 0) )
    {
      ...
      if ( !*p_animation )
        goto LABEL_30;
      UnityEngine_Animation__Play_70908988((UnityEngine_Animation_o *)gameObject, Empty, 0);
    }
    if ( this->fields.isContinue )
    {
      gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0);
