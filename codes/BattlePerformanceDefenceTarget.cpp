        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E0808B & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_2750/*"BATTLE_DEFENCE_TARGET_NAME_{0}"*/);
    byte_4E0808B = 1;
  }
  if ( maxHp < 1 || uiId <= 0 )
  {
  ...
  else
  {
    ...
    v12 = System_String__Format((System_String_o *)StringLiteral_2750/*"BATTLE_DEFENCE_TARGET_NAME_{0}"*/, v11, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E0808C & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_20546/*"icon{0}"*/);
    byte_4E0808C = 1;
  }
  ...
  if ( !this->fields.icon
    || (UISprite__set_atlas(this->fields.icon, (UIAtlas_o *)AssetStorage, 0),
        ...
        AssetStorage = (AssetData_o *)System_String__Format((System_String_o *)StringLiteral_20546/*"icon{0}"*/, v8, 0),
        !icon)
...
LABEL_30:
    ...
    if ( UnityEngine_TrackedReference__op_Inequality(Item, 0, 0) )
    {
      ...
      if ( !*p_animation )
        goto LABEL_30;
      UnityEngine_Animation__Play_72661460((UnityEngine_Animation_o *)gameObject, Empty, 0);
    }
    if ( this->fields.isContinue )
    {
      gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0);
