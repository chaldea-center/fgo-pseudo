        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0BAFE & 1) == 0 )
  {
    sub_1B686D4(&int_TypeInfo, *(_QWORD *)&nowHp);
    sub_1B686D4(&LocalizationManager_TypeInfo, v9);
    sub_1B686D4(&StringLiteral_2834/*"BATTLE_DEFENCE_TARGET_NAME_{0}"*/, v10);
    byte_4A0BAFE = 1;
  }
  if ( maxHp < 1 || uiId <= 0 )
  {
  ...
  else
  {
    ...
    v17 = System_String__Format((System_String_o *)StringLiteral_2834/*"BATTLE_DEFENCE_TARGET_NAME_{0}"*/, v16, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0BAFF & 1) == 0 )
  {
    sub_1B686D4(&Method_AssetData_GetObject_GameObject____75755192, *(_QWORD *)&uiId);
    ...
    sub_1B686D4(&StringLiteral_3187/*"Battle/Common"*/, v8);
    sub_1B686D4(&StringLiteral_3205/*"BattleAssetUIAtlas"*/, v9);
    sub_1B686D4(&StringLiteral_20129/*"icon{0}"*/, v10);
    byte_4A0BAFF = 1;
  }
  ...
  if ( !this->fields.icon
    || (UISprite__set_atlas(this->fields.icon, (UIAtlas_o *)AssetStorage, 0LL),
        ...
        AssetStorage = (AssetData_o *)System_String__Format((System_String_o *)StringLiteral_20129/*"icon{0}"*/, v17, 0LL),
        !icon)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0BB00 & 1) == 0 )
  {
    sub_1B686D4(&Method_UnityEngine_GameObject_GetComponent_Animation___, *(_QWORD *)&position);
  ...
  if ( this->fields.isInitialized )
  {
    ...
    if ( UnityEngine_Object__op_Equality(animation, 0LL, 0LL) )
    {
      ...
      *p_animation = (struct UnityEngine_Animation_o *)Component_object;
      sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.animation, (int32_t)Component_object, v14, v15);
    }
...
LABEL_30:
    ...
    if ( UnityEngine_TrackedReference__op_Inequality(Item, 0LL, 0LL) )
    {
      ...
      if ( !*p_animation )
        goto LABEL_30;
      UnityEngine_Animation__Play_68916908((UnityEngine_Animation_o *)gameObject, Empty, 0LL);
    }
    if ( this->fields.isContinue )
    {
      gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
