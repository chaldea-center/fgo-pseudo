...
void __fastcall ExUIMeshRenderer__ClearImage(ExUIMeshRenderer_o *this, const MethodInfo *method)
{
  ...
  if ( assetData )
  {
    ...
    sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.assetData, 0, v8, v9);
  }
  ...
  if ( loadAssetName )
  {
    ...
    sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.loadAssetName, 0, v11, v12);
    callbackFunc = this->fields.callbackFunc;
    this->fields.callbackFunc = 0LL;
    sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.callbackFunc, 0, v14, v15);
    if ( callbackFunc )
  ...
  if ( data )
  {
    ...
    if ( loadAssetName )
    {
      ...
      if ( AssetManager__compAssetStorage_39569020(data, loadAssetName, 0LL) )
      {
        ...
        sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.assetData, (int32_t)data, v7, v8);
        ...
        ExUIMeshRenderer__SetTexture(this, (UnityEngine_Texture_o *)Object_object__50213776, v11);
        if ( assetData )
        {
          if ( !AssetManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
...
void __fastcall ExUIMeshRenderer__OnStart(ExUIMeshRenderer_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B01430 & 1) == 0 )
  {
    sub_1BC3008(&Method_UnityEngine_Component_GetComponent_MeshRenderer___, method);
    sub_1BC3008(&UnityEngine_Object_TypeInfo, v3);
    byte_4B01430 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Equality(meshRenderer, 0LL, 0LL) )
  {
    Component_object = UnityEngine_Component__GetComponent_object_(
                         ...
                         (const MethodInfo_2FF8634 *)Method_UnityEngine_Component_GetComponent_MeshRenderer___);
    this->fields.meshRenderer = (struct UnityEngine_MeshRenderer_o *)Component_object;
    sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.meshRenderer, (int32_t)Component_object, v6, v7);
  }
...
void __fastcall ExUIMeshRenderer__ReScale(ExUIMeshRenderer_o *this, const MethodInfo *method)
{
  ...
  if ( v14 != this->fields.mWidth || v15 != this->fields.mHeight )
  {
    ...
    if ( meshFilter )
    {
      ...
      v19 = sub_1BC30B0(UnityEngine_Vector3___TypeInfo, 4LL);
      ...
      if ( v19 )
      {
        ...
        *(_DWORD *)(v19 + 76) = 0;
        ...
        {
LABEL_35:
          sub_1BC326C(meshFilter, v16, v21);
        }
        ...
        const MethodInfo *method)
{
  ...
  ExUIMeshRenderer__SetAssetImage_39919348(this, assetName, 0LL, callback, v4);
}


void __fastcall ExUIMeshRenderer__SetAssetImage_39919348(
        ExUIMeshRenderer_o *this,
        System_String_o *assetName,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B01435 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_AssetData_GetObject_Texture2D____76809696, v9);
    sub_1BC3008(&AssetManager_TypeInfo, v10);
    sub_1BC3008(&Method_ExUIMeshRenderer_EndLoad__, v11);
...
LABEL_26:
      ...
      sub_1BC2FAC(p_callbackFunc, (int32_t)v20, v21, v22);
      return;
    }
    v31 = *p_loadAssetName;
    if ( !AssetManager_TypeInfo->_2.cctor_finished )
    ...
    if ( assetData )
    {
      ...
      if ( AssetManager__compAssetStorage_39569020(assetData, assetName, 0LL) )
      {
        ...
        Object_object__50213776 = AssetData__GetObject_object__50213776(
                                    ...
                                    assetLabel,
                                    (const MethodInfo_2FE3390 *)Method_AssetData_GetObject_Texture2D____76809696);
        ExUIMeshRenderer__SetTexture(this, (UnityEngine_Texture_o *)Object_object__50213776, v29);
  ...
  *p_loadAssetName = assetName;
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.loadAssetName, (int32_t)assetName, v13, v14);
  if ( callback )
  {
    ...
    sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.callbackFunc, (int32_t)v33, v34, v35);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B01431 & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_16025/*"_Color"*/, v8);
    byte_4B01431 = 1;
  }
  v13.fields.r = r;
  v13.fields.g = g;
...
void __fastcall ExUIMeshRenderer__SetTweenVolume(ExUIMeshRenderer_o *this, float v, const MethodInfo *method)
{
  ...
  {
    sub_1BC3008(&UnityEngine_Object_TypeInfo, method);
    sub_1BC3008(&StringLiteral_16261/*"_Volume"*/, v5);
    byte_4B01432 = 1;
  }
  ...
  if ( v7 )
  {
    ...
    if ( UnityEngine_Material__HasProperty_69900436(
           (UnityEngine_Material_o *)material,
           (System_String_o *)StringLiteral_16261/*"_Volume"*/,
           0LL) )
    {
      UnityEngine_Material__SetFloat((UnityEngine_Material_o *)material, (System_String_o *)StringLiteral_16261/*"_Volume"*/, v, 0LL);
    }
  }
}
