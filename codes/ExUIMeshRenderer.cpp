...
{
  *(_OWORD *)&this->fields.uvSize.fields.x = xmmword_BA2C00;
...
void __fastcall ExUIMeshRenderer__ClearImage(ExUIMeshRenderer_o *this, const MethodInfo *method)
{
  ...
  if ( loadAssetName )
  {
    ...
    sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.loadAssetName, 0, v11, v12);
    callbackFunc = this->fields.callbackFunc;
    this->fields.callbackFunc = 0LL;
    sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.callbackFunc, 0, v14, v15);
    if ( callbackFunc )
  ...
  if ( data )
  {
    ...
    if ( loadAssetName )
    {
      ...
      if ( AssetManager__compAssetStorage_37479872(data, loadAssetName, 0LL) )
      {
        ...
        sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.assetData, (int32_t)data, v7, v8);
        ...
        ExUIMeshRenderer__SetTexture(this, (UnityEngine_Texture_o *)Object_object__48358160, v11);
        if ( assetData )
        {
          if ( !AssetManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
...
void __fastcall ExUIMeshRenderer__OnStart(ExUIMeshRenderer_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(meshRenderer, 0LL, 0LL) )
  {
    ...
    sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.meshRenderer, (int32_t)Component_object, v6, v7);
  }
...
void __fastcall ExUIMeshRenderer__ReScale(ExUIMeshRenderer_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FDFE9 & 1) == 0 )
  {
    ...
    sub_1B64A00(&UnityEngine_Vector2___TypeInfo, v3);
    sub_1B64A00(&UnityEngine_Vector3___TypeInfo, v4);
    byte_49FDFE9 = 1;
  }
  ...
  if ( v14 != this->fields.mWidth || v15 != this->fields.mHeight )
  {
    ...
    if ( meshFilter )
    {
      ...
      v19 = sub_1B64AA8(UnityEngine_Vector3___TypeInfo, 4LL);
      ...
      if ( v19 )
      {
        ...
        *(_DWORD *)(v19 + 76) = 0;
        ...
        meshFilter = (struct UnityEngine_MeshFilter_o *)sub_1B64AA8(UnityEngine_Vector2___TypeInfo, 4LL);
        if ( !meshFilter )
          goto LABEL_36;
        ...
        const MethodInfo *method)
{
  ...
  ExUIMeshRenderer__SetAssetImage_37804132(this, assetName, 0LL, callback, v4);
}


void __fastcall ExUIMeshRenderer__SetAssetImage_37804132(
        ExUIMeshRenderer_o *this,
        System_String_o *assetName,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDFE6 & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_AssetData_GetObject_Texture2D____75716016, v9);
    sub_1B64A00(&AssetManager_TypeInfo, v10);
    sub_1B64A00(&Method_ExUIMeshRenderer_EndLoad__, v11);
    sub_1B64A00(&AssetLoader_LoadEndDataHandler_TypeInfo, v12);
    byte_49FDFE6 = 1;
  }
...
LABEL_26:
      ...
      sub_1B649A4(p_callbackFunc, (int32_t)v20, v21, v22);
      return;
    }
    v31 = *p_loadAssetName;
    if ( !AssetManager_TypeInfo->_2.cctor_finished )
    ...
    if ( assetData )
    {
      ...
      if ( AssetManager__compAssetStorage_37479872(assetData, assetName, 0LL) )
      {
        ...
        Object_object__48358160 = AssetData__GetObject_object__48358160(
                                    ...
                                    assetLabel,
                                    (const MethodInfo_2E1E310 *)Method_AssetData_GetObject_Texture2D____75716016);
        ExUIMeshRenderer__SetTexture(this, (UnityEngine_Texture_o *)Object_object__48358160, v29);
  ...
  *p_loadAssetName = assetName;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.loadAssetName, (int32_t)assetName, v13, v14);
  if ( callback )
  {
    ...
    sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.callbackFunc, (int32_t)v33, v34, v35);
  }
  v37 = (AssetLoader_LoadEndDataHandler_o *)sub_1B64C4C(AssetLoader_LoadEndDataHandler_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDFE2 & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_16113/*"_Color"*/, v8);
    byte_49FDFE2 = 1;
  }
  v13.fields.r = r;
  v13.fields.g = g;
...
void __fastcall ExUIMeshRenderer__SetTweenVolume(ExUIMeshRenderer_o *this, float v, const MethodInfo *method)
{
  ...
  {
    sub_1B64A00(&UnityEngine_Object_TypeInfo, method);
    sub_1B64A00(&StringLiteral_16335/*"_Volume"*/, v5);
    byte_49FDFE3 = 1;
  }
