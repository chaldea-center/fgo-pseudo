...
{
  *(_OWORD *)&this->fields.uvSize.fields.x = xmmword_BA2BC0;
...
void __fastcall ExUIMeshRenderer__ClearImage(ExUIMeshRenderer_o *this, const MethodInfo *method)
{
  ...
  if ( loadAssetName )
  {
    ...
    sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.loadAssetName, 0, v11, v12);
    callbackFunc = this->fields.callbackFunc;
    this->fields.callbackFunc = 0LL;
    sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.callbackFunc, 0, v14, v15);
    if ( callbackFunc )
...
void __fastcall ExUIMeshRenderer__EndLoad(ExUIMeshRenderer_o *this, AssetData_o *data, const MethodInfo *method)
{
  ...
  if ( data )
  {
    ...
    if ( loadAssetName )
    {
      if ( !AssetManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
      if ( AssetManager__compAssetStorage_37479520(data, loadAssetName, 0LL) )
      {
        assetData = this->fields.assetData;
        this->fields.assetData = data;
        sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.assetData, (int32_t)data, v7, v8);
        ...
        ExUIMeshRenderer__SetTexture(this, (UnityEngine_Texture_o *)Object_object__48356600, v11);
        if ( assetData )
        {
          if ( !AssetManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
        ...
        callbackFunc = this->fields.callbackFunc;
        this->fields.callbackFunc = 0LL;
        sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.callbackFunc, 0, v12, v13);
        if ( callbackFunc )
          ((void (__fastcall *)(struct System_Reflection_MethodInfo_o *, _QWORD))callbackFunc->fields.m_target)(
            callbackFunc->fields.original_method_info,
            *(_QWORD *)&callbackFunc->fields.extra_arg);
...
void __fastcall ExUIMeshRenderer__OnStart(ExUIMeshRenderer_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FD9C1 & 1) == 0 )
  {
    sub_1B64870(&Method_UnityEngine_Component_GetComponent_MeshRenderer___, method);
    sub_1B64870(&UnityEngine_Object_TypeInfo, v3);
    byte_49FD9C1 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Equality(meshRenderer, 0LL, 0LL) )
  {
    Component_object = UnityEngine_Component__GetComponent_object_(
                         ...
                         (const MethodInfo_2E3216C *)Method_UnityEngine_Component_GetComponent_MeshRenderer___);
    this->fields.meshRenderer = (struct UnityEngine_MeshRenderer_o *)Component_object;
    sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.meshRenderer, (int32_t)Component_object, v6, v7);
  }
...
void __fastcall ExUIMeshRenderer__ReScale(ExUIMeshRenderer_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FD9C9 & 1) == 0 )
  {
    ...
    sub_1B64870(&UnityEngine_Vector3___TypeInfo, v4);
    byte_49FD9C9 = 1;
  }
  ...
  if ( v14 != this->fields.mWidth || v15 != this->fields.mHeight )
  {
    ...
    if ( meshFilter )
    {
      ...
      v19 = sub_1B64918(UnityEngine_Vector3___TypeInfo, 4LL);
      ...
      if ( v19 )
      {
        ...
        *(_DWORD *)(v19 + 76) = 0;
        ...
        meshFilter = (struct UnityEngine_MeshFilter_o *)sub_1B64918(UnityEngine_Vector2___TypeInfo, 4LL);
        if ( !meshFilter )
          goto LABEL_36;
        ...
        const MethodInfo *method)
{
  ...
  ExUIMeshRenderer__SetAssetImage_37803780(this, assetName, 0LL, callback, v4);
}


void __fastcall ExUIMeshRenderer__SetAssetImage_37803780(
        ExUIMeshRenderer_o *this,
        System_String_o *assetName,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD9C6 & 1) == 0 )
  {
    sub_1B64870(&System_Action_TypeInfo, assetName);
    sub_1B64870(&Method_AssetData_GetObject_Texture2D____75714464, v9);
    sub_1B64870(&AssetManager_TypeInfo, v10);
    sub_1B64870(&Method_ExUIMeshRenderer_EndLoad__, v11);
    sub_1B64870(&AssetLoader_LoadEndDataHandler_TypeInfo, v12);
    byte_49FD9C6 = 1;
  }
...
LABEL_26:
      ...
      sub_1B64814(p_callbackFunc, (int32_t)v20, v21, v22);
      return;
    }
    v31 = *p_loadAssetName;
    if ( !AssetManager_TypeInfo->_2.cctor_finished )
  ...
  else
  {
    ...
    if ( assetData )
    {
      if ( !AssetManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
      if ( AssetManager__compAssetStorage_37479520(assetData, assetName, 0LL) )
      {
        ...
        Object_object__48356600 = AssetData__GetObject_object__48356600(
                                    ...
                                    assetLabel,
                                    (const MethodInfo_2E1DCF8 *)Method_AssetData_GetObject_Texture2D____75714464);
        ExUIMeshRenderer__SetTexture(this, (UnityEngine_Texture_o *)Object_object__48356600, v29);
  ...
  *p_loadAssetName = assetName;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.loadAssetName, (int32_t)assetName, v13, v14);
  if ( callback )
  {
    ...
    sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.callbackFunc, (int32_t)v33, v34, v35);
  }
  v37 = (AssetLoader_LoadEndDataHandler_o *)sub_1B64ABC(AssetLoader_LoadEndDataHandler_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD9C5 & 1) == 0 )
  {
    sub_1B64870(&AssetManager_TypeInfo, tex);
    byte_49FD9C5 = 1;
  }
  ...
  if ( assetData )
  {
    ...
    AssetManager__releaseAsset_37481844(assetData, 0LL);
    this->fields.assetData = 0LL;
    sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.assetData, 0, v6, v7);
  }
  loadAssetName = this->fields.loadAssetName;
  if ( loadAssetName )
  {
    ...
    AssetManager__releaseAssetStorage(loadAssetName, 0LL);
    this->fields.loadAssetName = 0LL;
    sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.loadAssetName, 0, v9, v10);
    callbackFunc = this->fields.callbackFunc;
    this->fields.callbackFunc = 0LL;
    sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.callbackFunc, 0, v12, v13);
    if ( callbackFunc )
...
void __fastcall ExUIMeshRenderer__SetTweenVolume(ExUIMeshRenderer_o *this, float v, const MethodInfo *method)
{
  ...
  {
    sub_1B64870(&UnityEngine_Object_TypeInfo, method);
    sub_1B64870(&StringLiteral_16334/*"_Volume"*/, v5);
    byte_49FD9C3 = 1;
  }
  ...
  if ( v7 )
  {
    ...
    if ( UnityEngine_Material__HasProperty_69002184(
           (UnityEngine_Material_o *)material,
           (System_String_o *)StringLiteral_16334/*"_Volume"*/,
           0LL) )
    {
      UnityEngine_Material__SetFloat((UnityEngine_Material_o *)material, (System_String_o *)StringLiteral_16334/*"_Volume"*/, v, 0LL);
    }
  }
}
