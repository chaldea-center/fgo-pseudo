...
void __fastcall ExUIMeshRenderer__ClearImage(ExUIMeshRenderer_o *this, const MethodInfo *method)
{
  ...
  if ( assetData )
  {
    ...
    sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.assetData, 0LL, v7, v8, v9, v10, v11, v12);
  }
  ...
  if ( loadAssetName )
  {
    ...
    sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.loadAssetName, 0LL, v14, v15, v16, v17, v18, v19);
  ...
  if ( data )
  {
    ...
    if ( loadAssetName )
    {
      ...
      if ( AssetManager__compAssetStorage_39032548(data, loadAssetName, 0LL) )
      {
        ...
        sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.assetData, (int64_t)data, v6, v7, v8, v9, v10, v11);
        ...
        ExUIMeshRenderer__SetTexture(this, (UnityEngine_Texture_o *)Object_object__49880776, v14);
        if ( assetData )
        {
          if ( !AssetManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
        ...
        callbackFunc = this->fields.callbackFunc;
        this->fields.callbackFunc = 0LL;
        sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.callbackFunc, 0LL, v15, v16, v17, v18, v19, v20);
        if ( callbackFunc )
          ((void (__fastcall *)(struct System_Reflection_MethodInfo_o *, _QWORD))callbackFunc->fields.m_target)(
            callbackFunc->fields.original_method_info,
            *(_QWORD *)&callbackFunc->fields.extra_arg);
...
void __fastcall ExUIMeshRenderer__ReScale(ExUIMeshRenderer_o *this, const MethodInfo *method)
{
  ...
  if ( v12 != this->fields.mWidth || v13 != this->fields.mHeight )
  {
    ...
    if ( meshFilter )
    {
      ...
      v17 = sub_1C21EE0(UnityEngine_Vector3___TypeInfo, 4LL);
      LODWORD(v18) = *(_QWORD *)&UIWidget__get_pivotOffset((UIWidget_o *)this, 0LL);
      ...
      if ( v17 )
      {
        ...
        *(_DWORD *)(v17 + 76) = 0;
        if ( !mesh )
          goto LABEL_36;
        UnityEngine_Mesh__set_vertices(mesh, (UnityEngine_Vector3_array *)v17, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  ExUIMeshRenderer__SetAssetImage_39355724(this, assetName, 0LL, callback, v4);
}


void __fastcall ExUIMeshRenderer__SetAssetImage_39355724(
        ExUIMeshRenderer_o *this,
        System_String_o *assetName,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDB9AA & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_AssetData_GetObject_Texture2D____77626312);
    sub_1C21E38(&AssetManager_TypeInfo);
    sub_1C21E38(&Method_ExUIMeshRenderer_EndLoad__);
  ...
  if ( loadAssetName )
  {
    ...
    if ( AssetManager__compAssetStorage(loadAssetName, assetName, 0LL) )
    {
      ...
      v23 = System_Delegate__Combine(callbackFunc, v21, 0LL);
      v30 = v23;
      if ( v23 )
      {
        v31 = System_Action_TypeInfo;
        if ( (System_Action_c *)v23->klass != System_Action_TypeInfo
          || (p_callbackFunc->klass = (PartyOrganizationUtility_c *)v23, (System_Action_c *)v23->klass != v31) )
        {
LABEL_26:
          sub_1C22354(v30);
          return;
      ...
      sub_1C21DDC(p_callbackFunc, (int64_t)v23, v24, v25, v26, v27, v28, v29);
      return;
    }
    v38 = *p_loadAssetName;
    if ( !AssetManager_TypeInfo->_2.cctor_finished )
    ...
    if ( assetData )
    {
      ...
      if ( AssetManager__compAssetStorage_39032548(assetData, assetName, 0LL) )
      {
        ...
        Object_object__49880776 = AssetData__GetObject_object__49880776(
                                    ...
                                    assetLabel,
                                    (const MethodInfo_2F91EC8 *)Method_AssetData_GetObject_Texture2D____77626312);
        ExUIMeshRenderer__SetTexture(this, (UnityEngine_Texture_o *)Object_object__49880776, v36);
  ...
  *p_loadAssetName = assetName;
  ...
  if ( callback )
  {
    ...
    sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.callbackFunc, (int64_t)v40, v41, v42, v43, v44, v45, v46);
  }
  v48 = (AssetLoader_LoadEndDataHandler_o *)sub_1C22084(AssetLoader_LoadEndDataHandler_TypeInfo);
...
void __fastcall ExUIMeshRenderer__SetTweenVolume(ExUIMeshRenderer_o *this, float v, const MethodInfo *method)
{
  ...
  {
    sub_1C21E38(&UnityEngine_Object_TypeInfo);
    sub_1C21E38(&StringLiteral_16680/*"_Volume"*/);
    byte_4BDB9A7 = 1;
  }
  ...
  if ( v6 )
  {
    ...
    if ( UnityEngine_Material__HasProperty_70735792(
           (UnityEngine_Material_o *)material,
           (System_String_o *)StringLiteral_16680/*"_Volume"*/,
           0LL) )
    {
      UnityEngine_Material__SetFloat((UnityEngine_Material_o *)material, (System_String_o *)StringLiteral_16680/*"_Volume"*/, v, 0LL);
    }
  }
}
