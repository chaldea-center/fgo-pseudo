...
void __fastcall ExUIMeshRenderer__ClearImage(ExUIMeshRenderer_o *this, const MethodInfo *method)
{
  ...
  if ( assetData )
  {
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.assetData, 0, v7, v8);
  }
  ...
  if ( loadAssetName )
  {
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.loadAssetName, 0, v10, v11);
  ...
  if ( data )
  {
    ...
    if ( loadAssetName )
    {
      ...
      if ( AssetManager__compAssetStorage_37788332(data, loadAssetName, 0LL) )
      {
        ...
        sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.assetData, (int32_t)data, v6, v7);
        ...
        ExUIMeshRenderer__SetTexture(this, (UnityEngine_Texture_o *)Object_object__48635516, v10);
        if ( assetData )
        {
          if ( !AssetManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
...
void __fastcall ExUIMeshRenderer__OnStart(ExUIMeshRenderer_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(meshRenderer, 0LL, 0LL) )
  {
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.meshRenderer, (int32_t)Component_object, v5, v6);
  }
...
void __fastcall ExUIMeshRenderer__ReScale(ExUIMeshRenderer_o *this, const MethodInfo *method)
{
  ...
  if ( v12 != this->fields.mWidth || v13 != this->fields.mHeight )
  {
    ...
    if ( meshFilter )
    {
      ...
      v17 = sub_1B88658(UnityEngine_Vector3___TypeInfo, 4LL);
        ...
        const MethodInfo *method)
{
  ...
  ExUIMeshRenderer__SetAssetImage_38112816(this, assetName, 0LL, callback, v4);
}


void __fastcall ExUIMeshRenderer__SetAssetImage_38112816(
        ExUIMeshRenderer_o *this,
        System_String_o *assetName,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A606 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_AssetData_GetObject_Texture2D____76085376);
    sub_1B885B0(&AssetManager_TypeInfo);
    sub_1B885B0(&Method_ExUIMeshRenderer_EndLoad__);
  ...
  if ( loadAssetName )
  {
    ...
    if ( AssetManager__compAssetStorage(loadAssetName, assetName, 0LL) )
    {
      ...
      v16 = System_Delegate__Combine(callbackFunc, v14, 0LL);
      v19 = v16;
      if ( v16 )
      {
        v20 = System_Action_TypeInfo;
        if ( (System_Action_c *)v16->klass != System_Action_TypeInfo
          || (p_callbackFunc->klass = (ServantStatusBattleListViewItem_c *)v16, (System_Action_c *)v16->klass != v20) )
        {
LABEL_26:
          sub_1B88ACC(v19);
          return;
      ...
      sub_1B88554(p_callbackFunc, (int32_t)v16, v17, v18);
      return;
    }
    v27 = *p_loadAssetName;
    if ( !AssetManager_TypeInfo->_2.cctor_finished )
    ...
    if ( assetData )
    {
      ...
      if ( AssetManager__compAssetStorage_37788332(assetData, assetName, 0LL) )
      {
        ...
        Object_object__48635516 = AssetData__GetObject_object__48635516(
                                    ...
                                    assetLabel,
                                    (const MethodInfo_2E61E7C *)Method_AssetData_GetObject_Texture2D____76085376);
        ExUIMeshRenderer__SetTexture(this, (UnityEngine_Texture_o *)Object_object__48635516, v25);
  ...
  *p_loadAssetName = assetName;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.loadAssetName, (int32_t)assetName, v9, v10);
  if ( callback )
  {
    v28 = &this->fields.callbackFunc;
    v29 = System_Delegate__Combine((System_Delegate_o *)this->fields.callbackFunc, (System_Delegate_o *)callback, 0LL);
    v19 = v29;
    if ( v29 )
    {
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.callbackFunc, (int32_t)v29, v30, v31);
  }
  v33 = (AssetLoader_LoadEndDataHandler_o *)sub_1B887FC(AssetLoader_LoadEndDataHandler_TypeInfo);
  AssetLoader_LoadEndDataHandler___ctor(v33, (Il2CppObject *)this, Method_ExUIMeshRenderer_EndLoad__, 0LL);
  if ( !AssetManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
  AssetManager__loadAssetStorage(assetName, v33, 1, 0LL);
}
...
void __fastcall ExUIMeshRenderer__SetTweenVolume(ExUIMeshRenderer_o *this, float v, const MethodInfo *method)
{
  ...
  {
    sub_1B885B0(&UnityEngine_Object_TypeInfo);
    sub_1B885B0(&StringLiteral_16401/*"_Volume"*/);
    byte_4A5A603 = 1;
  }
  ...
  if ( v6 )
  {
    ...
    if ( UnityEngine_Material__HasProperty_69325648(
           (UnityEngine_Material_o *)material,
           (System_String_o *)StringLiteral_16401/*"_Volume"*/,
           0LL) )
    {
      UnityEngine_Material__SetFloat((UnityEngine_Material_o *)material, (System_String_o *)StringLiteral_16401/*"_Volume"*/, v, 0LL);
    }
  }
}
