...
{
  *(_OWORD *)&this->fields.uvSize.fields.x = xmmword_D003F0;
...
void ExUIMeshRenderer__ClearImage(ExUIMeshRenderer_o *this, const MethodInfo *method)
{
  ...
  if ( assetData )
  {
    ...
    sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.assetData, 0, v7, v8, v9, v10, v11, v12);
  }
  ...
  if ( loadAssetName )
  {
    ...
    sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.loadAssetName, 0, v14, v15, v16, v17, v18, v19);
  ...
  if ( data )
  {
    ...
    if ( loadAssetName )
    {
      ...
      if ( AssetManager__compAssetStorage_41245620(data, loadAssetName, 0) )
      {
        ...
        ExUIMeshRenderer__SetTexture(this, (UnityEngine_Texture_o *)Object_object__51927708, v14);
        if ( assetData )
        {
          if ( !AssetManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
        ...
        callbackFunc = this->fields.callbackFunc;
        this->fields.callbackFunc = 0;
        sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.callbackFunc, 0, v15, v16, v17, v18, v19, v20);
        if ( callbackFunc )
          ((void (__fastcall *)(intptr_t, intptr_t))callbackFunc->fields.invoke_impl)(
            callbackFunc->fields.method_code,
            callbackFunc->fields.method);
...
void ExUIMeshRenderer__ReScale(ExUIMeshRenderer_o *this, const MethodInfo *method)
{
  ...
  if ( v12 != this->fields.mWidth || v13 != this->fields.mHeight )
  {
    ...
    if ( meshFilter )
    {
      ...
      v17 = sub_1C93B7C(UnityEngine_Vector3___TypeInfo, 4);
      ...
      if ( v17 )
      {
        ...
        *(_DWORD *)(v17 + 76) = 0;
        ...
        meshFilter = (struct UnityEngine_MeshFilter_o *)sub_1C93B7C(UnityEngine_Vector2___TypeInfo, 4);
        if ( !meshFilter )
          goto LABEL_36;
        ...
        const MethodInfo *method)
{
  ...
  ExUIMeshRenderer__SetAssetImage_41607764(this, assetName, 0, callback, v4);
}


void ExUIMeshRenderer__SetAssetImage_41607764(
        ExUIMeshRenderer_o *this,
        System_String_o *assetName,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2FDD1 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_AssetData_GetObject_Texture2D____79057928);
    sub_1C93AD4(&AssetManager_TypeInfo);
    sub_1C93AD4(&Method_ExUIMeshRenderer_EndLoad__);
...
LABEL_26:
      ...
      sub_1C93A78(p_callbackFunc, (int32_t)v23, v24, v25, v26, v27, v28, v29);
      return;
    }
    v38 = *p_loadAssetName;
    if ( !AssetManager_TypeInfo->_2.cctor_finished )
    ...
    if ( assetData )
    {
      ...
      if ( AssetManager__compAssetStorage_41245620(assetData, assetName, 0) )
      {
        ...
        Object_object__51927708 = AssetData__GetObject_object__51927708(
                                    ...
                                    assetLabel,
                                    (const MethodInfo_3185A9C *)Method_AssetData_GetObject_Texture2D____79057928);
        ExUIMeshRenderer__SetTexture(this, (UnityEngine_Texture_o *)Object_object__51927708, v36);
  ...
  *p_loadAssetName = assetName;
  ...
  if ( callback )
  {
    ...
    sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.callbackFunc, (int32_t)v40, v41, v42, v43, v44, v45, v46);
  }
  v48 = (AssetLoader_LoadEndDataHandler_o *)sub_1C93D20(AssetLoader_LoadEndDataHandler_TypeInfo);
...
void ExUIMeshRenderer__SetTweenColor(ExUIMeshRenderer_o *this, UnityEngine_Color_o c, const MethodInfo *method)
{
  ...
  if ( ((unsigned __int8)meshRenderer & 1) != 0 )
  {
           ...
           0) )
    {
      ...
      v13.fields.b = b;
      v13.fields.a = a;
      UnityEngine_Material__SetColor((UnityEngine_Material_o *)material, (System_String_o *)StringLiteral_16273/*"_Color"*/, v13, 0);
    }
  }
  meshRenderer = this->fields.meshRenderer;
  if ( !meshRenderer )
LABEL_11:
    sub_1C93D2C(meshRenderer, v11);
...
void ExUIMeshRenderer__SetTweenVolume(ExUIMeshRenderer_o *this, float v, const MethodInfo *method)
{
  ...
  if ( v6 )
  {
    ...
    if ( UnityEngine_Material__HasProperty_71985380(
           ...
           0) )
    {
      UnityEngine_Material__SetFloat((UnityEngine_Material_o *)material, (System_String_o *)StringLiteral_16512/*"_Volume"*/, v, 0);
    }
  }
}
