...
{
  *(_OWORD *)&this->fields.uvSize.fields.x = xmmword_BEA5C0;
...
void __fastcall ExUIMeshRenderer__ClearImage(ExUIMeshRenderer_o *this, const MethodInfo *method)
{
  ...
  if ( assetData )
  {
    ...
    sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.assetData, 0, v8, v9);
  }
  ...
  if ( loadAssetName )
  {
    ...
    sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.loadAssetName, 0, v11, v12);
    callbackFunc = this->fields.callbackFunc;
    this->fields.callbackFunc = 0LL;
    sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.callbackFunc, 0, v14, v15);
    if ( callbackFunc )
  ...
  if ( data )
  {
    ...
    if ( loadAssetName )
    {
      ...
      if ( AssetManager__compAssetStorage_39551848(data, loadAssetName, 0LL) )
      {
        ...
        sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.assetData, (int32_t)data, v7, v8);
        ...
        ExUIMeshRenderer__SetTexture(this, (UnityEngine_Texture_o *)Object_object__50417328, v11);
        if ( assetData )
        {
          if ( !AssetManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
...
void __fastcall ExUIMeshRenderer__OnStart(ExUIMeshRenderer_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B43EA1 & 1) == 0 )
  {
    sub_1BDB878(&Method_UnityEngine_Component_GetComponent_MeshRenderer___, method);
    sub_1BDB878(&UnityEngine_Object_TypeInfo, v3);
    byte_4B43EA1 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Equality(meshRenderer, 0LL, 0LL) )
  {
    ...
    sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.meshRenderer, (int32_t)Component_object, v6, v7);
  }
...
void __fastcall ExUIMeshRenderer__ReScale(ExUIMeshRenderer_o *this, const MethodInfo *method)
{
  ...
  if ( v14 != this->fields.mWidth || v15 != this->fields.mHeight )
  {
    ...
    if ( meshFilter )
    {
      ...
      v19 = sub_1BDB920(UnityEngine_Vector3___TypeInfo, 4LL);
      ...
      if ( v19 )
      {
        ...
        if ( !v23 )
          goto LABEL_35;
        v24 = (float)v14 * (float)-v20;
        v25 = (float)v15 * (float)-pivotOffset.fields.y;
        v26 = v24 + 0.0;
        *(float *)(v19 + 32) = v24 + 0.0;
        *(float *)(v19 + 36) = v25 + 0.0;
        *(_DWORD *)(v19 + 40) = 0;
        if ( v23 == 1 )
          goto LABEL_35;
        v27 = (float)(v24 + (float)v14) + 0.0;
        *(float *)(v19 + 44) = v27;
        *(float *)(v19 + 48) = v25 + 0.0;
        *(_DWORD *)(v19 + 52) = 0;
        if ( v23 <= 2 )
          goto LABEL_35;
        v28 = (float)(v25 + (float)v15) + 0.0;
        *(float *)(v19 + 56) = v26;
        *(float *)(v19 + 60) = v28;
        *(_DWORD *)(v19 + 64) = 0;
        if ( v23 == 3 )
        ...
        *(_DWORD *)(v19 + 76) = 0;
        ...
        meshFilter = (struct UnityEngine_MeshFilter_o *)sub_1BDB920(UnityEngine_Vector2___TypeInfo, 4LL);
        if ( !meshFilter )
          goto LABEL_36;
        ...
        {
LABEL_35:
          sub_1BDBADC(meshFilter, v16, v21);
        }
        ...
        const MethodInfo *method)
{
  ...
  ExUIMeshRenderer__SetAssetImage_39901720(this, assetName, 0LL, callback, v4);
}


void __fastcall ExUIMeshRenderer__SetAssetImage_39901720(
        ExUIMeshRenderer_o *this,
        System_String_o *assetName,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43EA6 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_AssetData_GetObject_Texture2D____77074040, v9);
    sub_1BDB878(&AssetManager_TypeInfo, v10);
    sub_1BDB878(&Method_ExUIMeshRenderer_EndLoad__, v11);
    ...
    if ( AssetManager__compAssetStorage(loadAssetName, assetName, 0LL) )
    {
      ...
      if ( v20 )
      {
        ...
        if ( (System_Action_c *)v20->klass != System_Action_TypeInfo
          || (p_callbackFunc->klass = (CGThumbnailListItem_c *)v20, (System_Action_c *)v20->klass != v24) )
        {
LABEL_26:
          sub_1BDBD94(v23);
          return;
      ...
      sub_1BDB81C(p_callbackFunc, (int32_t)v20, v21, v22);
      return;
    }
    v31 = *p_loadAssetName;
    if ( !AssetManager_TypeInfo->_2.cctor_finished )
    ...
    if ( assetData )
    {
      ...
      if ( AssetManager__compAssetStorage_39551848(assetData, assetName, 0LL) )
      {
        ...
        Object_object__50417328 = AssetData__GetObject_object__50417328(
                                    ...
                                    assetLabel,
                                    (const MethodInfo_3014EB0 *)Method_AssetData_GetObject_Texture2D____77074040);
        ExUIMeshRenderer__SetTexture(this, (UnityEngine_Texture_o *)Object_object__50417328, v29);
  ...
  *p_loadAssetName = assetName;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.loadAssetName, (int32_t)assetName, v13, v14);
  if ( callback )
  {
    ...
    sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.callbackFunc, (int32_t)v33, v34, v35);
  }
  v37 = (AssetLoader_LoadEndDataHandler_o *)sub_1BDBAC4(AssetLoader_LoadEndDataHandler_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43EA2 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_16152/*"_Color"*/, v8);
    byte_4B43EA2 = 1;
  }
  v13.fields.r = r;
  v13.fields.g = g;
...
void __fastcall ExUIMeshRenderer__SetTweenVolume(ExUIMeshRenderer_o *this, float v, const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&UnityEngine_Object_TypeInfo, method);
    sub_1BDB878(&StringLiteral_16388/*"_Volume"*/, v5);
    byte_4B43EA3 = 1;
  }
  ...
  if ( v7 )
  {
    ...
    if ( UnityEngine_Material__HasProperty_70150152(
           (UnityEngine_Material_o *)material,
           (System_String_o *)StringLiteral_16388/*"_Volume"*/,
           0LL) )
    {
      UnityEngine_Material__SetFloat((UnityEngine_Material_o *)material, (System_String_o *)StringLiteral_16388/*"_Volume"*/, v, 0LL);
    }
  }
}
