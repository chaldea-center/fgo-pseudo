void __fastcall EventServantEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B1C66F & 1) == 0 )
  {
    sub_1BCAFF8(&EventServantEntity_TypeInfo, v1);
    sub_1BCAFF8(&StringLiteral_21954/*"nameReleaseCond"*/, v4);
    byte_4B1C66F = 1;
  }
  EventServantEntity_TypeInfo->static_fields->NAME_RELEASE_COND = (struct System_String_o *)StringLiteral_21954/*"nameReleaseCond"*/;
  sub_1BCAF9C((CGThumbnailListItem_o *)EventServantEntity_TypeInfo->static_fields, StringLiteral_21954/*"nameReleaseCond"*/, v2, v3);
}
...
System_String_o *__fastcall EventServantEntity__CreatePrimaryKey(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1C661 & 1) == 0 )
  {
    sub_1BCAFF8(&EventServantEntity_TypeInfo, method);
    byte_4B1C661 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1C669 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_CommonReleaseMaster___, key);
    ...
    sub_1BCAFF8(&StringLiteral_16540/*"addMessageCommonReleaseId"*/, v9);
    byte_4B1C669 = 1;
  }
  value = 0LL;
  v14 = 0LL;
         ...
         (const MethodInfo_3387584 *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
  {
    ...
    if ( System_Collections_Generic_Dictionary_object__object___TryGetValue(
           (System_Collections_Generic_Dictionary_object__object__o *)script,
           (Il2CppObject *)StringLiteral_16540/*"addMessageCommonReleaseId"*/,
           &v14,
           (const MethodInfo_3387584 *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
    {
      script = (DataManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38F8AD8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( !script )
        goto LABEL_14;
...
System_String_o *__fastcall EventServantEntity__GetGetMessage(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1C66B & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_16534/*"addGetMessage"*/, method);
    byte_4B1C66B = 1;
  }
  return EventServantEntity__GetAddMessage(this, (System_String_o *)StringLiteral_16534/*"addGetMessage"*/, this->fields.getMessage, v2);
}
...
System_String_o *__fastcall EventServantEntity__GetJoinMessage(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1C66A & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_16537/*"addJoinMessage"*/, method);
    byte_4B1C66A = 1;
  }
  return EventServantEntity__GetAddMessage(this, (System_String_o *)StringLiteral_16537/*"addJoinMessage"*/, this->fields.joinMessage, v2);
}
...
System_String_o *__fastcall EventServantEntity__GetLeaveMessage(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1C66C & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_16538/*"addLeaveMessage"*/, method);
    byte_4B1C66C = 1;
  }
  return EventServantEntity__GetAddMessage(this, (System_String_o *)StringLiteral_16538/*"addLeaveMessage"*/, this->fields.leaveMessage, v2);
}
...
System_String_o *__fastcall EventServantEntity__GetRuby(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1C66D & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_22957/*"ruby"*/, v3);
    byte_4B1C66D = 1;
  }
  return EntityScriptUtil__GetStringValue(
           this->fields.script,
           (System_String_o *)StringLiteral_22957/*"ruby"*/,
...
bool __fastcall EventServantEntity__IsProtectedDuringEvent(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1C666 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_20758/*"isProtectedDuringEvent"*/, v4);
    byte_4B1C666 = 1;
  }
  value = 0LL;
  script = this->fields.script;
  if ( script )
  {
    if ( System_Collections_Generic_Dictionary_object__object___TryGetValue(
           (System_Collections_Generic_Dictionary_object__object__o *)script,
           (Il2CppObject *)StringLiteral_20758/*"isProtectedDuringEvent"*/,
           &value,
           (const MethodInfo_3387584 *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
    {
      v6 = value;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1C664 & 1) == 0 )
  {
    sub_1BCAFF8(&EventServantEntity_TypeInfo, battleName);
...
LABEL_7:
    *battleName = (System_String_o *)StringLiteral_1/*""*/;
    sub_1BCAF9C((CGThumbnailListItem_o *)battleName, (int32_t)StringLiteral_1/*""*/, (int32_t)v6, v7);
    return 0;
  }
  else
  {
    ...
    *battleName = v10;
    sub_1BCAF9C((CGThumbnailListItem_o *)battleName, (int32_t)v10, (int32_t)v6, v7);
    return 1;
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1C663 & 1) == 0 )
  {
    sub_1BCAFF8(&EventServantEntity_TypeInfo, name);
    sub_1BCAFF8(&StringLiteral_1/*""*/, v5);
    byte_4B1C663 = 1;
  }
...
LABEL_7:
    *name = (System_String_o *)StringLiteral_1/*""*/;
    sub_1BCAF9C((CGThumbnailListItem_o *)name, (int32_t)StringLiteral_1/*""*/, (int32_t)v6, v7);
    return 0;
  }
  else
  {
    ...
    *name = v10;
    sub_1BCAF9C((CGThumbnailListItem_o *)name, (int32_t)v10, (int32_t)v6, v7);
    return 1;
  }
}
...
System_DateTime_o __fastcall EventServantEntity__getEndTime(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  return NetworkManager__getServerDateTime_40543292(endedAt, 0LL);
}
...
System_String_o *__fastcall EventServantEntity__getEndTimeStr(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1C668 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_24935/*"{0}/{1:D2}/{2:D2} {3:D2}:{4:D2}"*/, v6);
    byte_4B1C668 = 1;
  }
  endedAt = this->fields.endedAt;
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  dateData = NetworkManager__getServerDateTime_40543292(endedAt, 0LL).fields._dateData;
  v8 = (System_Object_array *)sub_1BCB0A0(object___TypeInfo, 5LL);
  ...
  if ( v12 )
  {
    v12 = sub_1BCB134(v12, v8->obj.klass->_1.element_class);
    if ( !v12 )
      goto LABEL_25;
  }
  if ( !v8->max_length )
    goto LABEL_24;
  v8->m_Items[0] = v16;
  sub_1BCAF9C((CGThumbnailListItem_o *)v8->m_Items, (int32_t)v16, v14, v15);
  ...
  if ( v8->max_length <= 1 )
    goto LABEL_24;
  v8->m_Items[1] = v21;
  sub_1BCAF9C((CGThumbnailListItem_o *)&v8->m_Items[1], (int32_t)v21, v14, v20);
  ...
  if ( v8->max_length <= 2 )
    goto LABEL_24;
  v8->m_Items[2] = v26;
  sub_1BCAF9C((CGThumbnailListItem_o *)&v8->m_Items[2], (int32_t)v26, v14, v25);
  ...
  if ( v8->max_length <= 3 )
    goto LABEL_24;
  v8->m_Items[3] = v31;
  sub_1BCAF9C((CGThumbnailListItem_o *)&v8->m_Items[3], (int32_t)v31, v14, v30);
...
LABEL_24:
  ...
  v8->m_Items[4] = v36;
  sub_1BCAF9C((CGThumbnailListItem_o *)&v8->m_Items[4], (int32_t)v36, v14, v35);
  return System_String__Format_62491852((System_String_o *)StringLiteral_24935/*"{0}/{1:D2}/{2:D2} {3:D2}:{4:D2}"*/, v8, 0LL);
}
