void __fastcall EventServantEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BC7BEE & 1) == 0 )
  {
    sub_1C1ABD4(&EventServantEntity_TypeInfo, v1);
    sub_1C1ABD4(&StringLiteral_22368/*"nameReleaseCond"*/, v8);
    byte_4BC7BEE = 1;
  }
  EventServantEntity_TypeInfo->static_fields->NAME_RELEASE_COND = (struct System_String_o *)StringLiteral_22368/*"nameReleaseCond"*/;
  sub_1C1AB78(
    (PartyOrganizationUtility_o *)EventServantEntity_TypeInfo->static_fields,
    StringLiteral_22368/*"nameReleaseCond"*/,
    v2,
    v3,
    v4,
    v5,
...
System_String_o *__fastcall EventServantEntity__CreatePrimaryKey(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC7BE0 & 1) == 0 )
  {
    sub_1C1ABD4(&EventServantEntity_TypeInfo, method);
    byte_4BC7BE0 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC7BE8 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataManager_GetMasterData_CommonReleaseMaster___, key);
    ...
    sub_1C1ABD4(&StringLiteral_16940/*"addMessageCommonReleaseId"*/, v9);
    byte_4BC7BE8 = 1;
  }
  value = 0LL;
  v14 = 0LL;
         ...
         (const MethodInfo_33044FC *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
  {
    ...
    if ( System_Collections_Generic_Dictionary_object__object___TryGetValue(
           (System_Collections_Generic_Dictionary_object__object__o *)script,
           (Il2CppObject *)StringLiteral_16940/*"addMessageCommonReleaseId"*/,
           &v14,
           (const MethodInfo_33044FC *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
    {
      script = (DataManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_387A8A8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( !script )
        goto LABEL_14;
...
System_String_o *__fastcall EventServantEntity__GetGetMessage(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC7BEA & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_16934/*"addGetMessage"*/, method);
    byte_4BC7BEA = 1;
  }
  return EventServantEntity__GetAddMessage(this, (System_String_o *)StringLiteral_16934/*"addGetMessage"*/, this->fields.getMessage, v2);
}
...
System_String_o *__fastcall EventServantEntity__GetJoinMessage(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC7BE9 & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_16937/*"addJoinMessage"*/, method);
    byte_4BC7BE9 = 1;
  }
  return EventServantEntity__GetAddMessage(this, (System_String_o *)StringLiteral_16937/*"addJoinMessage"*/, this->fields.joinMessage, v2);
}
...
System_String_o *__fastcall EventServantEntity__GetLeaveMessage(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC7BEB & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_16938/*"addLeaveMessage"*/, method);
    byte_4BC7BEB = 1;
  }
  return EventServantEntity__GetAddMessage(this, (System_String_o *)StringLiteral_16938/*"addLeaveMessage"*/, this->fields.leaveMessage, v2);
}
...
System_String_o *__fastcall EventServantEntity__GetRuby(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC7BEC & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_23386/*"ruby"*/, v3);
    byte_4BC7BEC = 1;
  }
  return EntityScriptUtil__GetStringValue(
           this->fields.script,
           (System_String_o *)StringLiteral_23386/*"ruby"*/,
...
bool __fastcall EventServantEntity__IsProtectedDuringEvent(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC7BE5 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_21170/*"isProtectedDuringEvent"*/, v4);
    byte_4BC7BE5 = 1;
  }
  value = 0LL;
  script = this->fields.script;
  if ( script )
  {
    if ( System_Collections_Generic_Dictionary_object__object___TryGetValue(
           (System_Collections_Generic_Dictionary_object__object__o *)script,
           (Il2CppObject *)StringLiteral_21170/*"isProtectedDuringEvent"*/,
           &value,
           (const MethodInfo_33044FC *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
    {
      v6 = value;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC7BE3 & 1) == 0 )
  {
    sub_1C1ABD4(&EventServantEntity_TypeInfo, battleName);
...
LABEL_7:
    *battleName = (System_String_o *)StringLiteral_1/*""*/;
    sub_1C1AB78((PartyOrganizationUtility_o *)battleName, (int64_t)StringLiteral_1/*""*/, (int64_t)v6, v7, v8, v9, v10, v11);
    return 0;
  }
  else
  {
    ...
    *battleName = v14;
    sub_1C1AB78((PartyOrganizationUtility_o *)battleName, (int64_t)v14, (int64_t)v6, v7, v8, v9, v10, v11);
    return 1;
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC7BE2 & 1) == 0 )
  {
    sub_1C1ABD4(&EventServantEntity_TypeInfo, name);
    sub_1C1ABD4(&StringLiteral_1/*""*/, v5);
    byte_4BC7BE2 = 1;
  }
...
LABEL_7:
    *name = (System_String_o *)StringLiteral_1/*""*/;
    sub_1C1AB78((PartyOrganizationUtility_o *)name, (int64_t)StringLiteral_1/*""*/, (int64_t)v6, v7, v8, v9, v10, v11);
    return 0;
  }
  else
  {
    ...
    *name = v14;
    sub_1C1AB78((PartyOrganizationUtility_o *)name, (int64_t)v14, (int64_t)v6, v7, v8, v9, v10, v11);
    return 1;
  }
}
...
System_DateTime_o __fastcall EventServantEntity__getEndTime(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  return NetworkManager__getServerDateTime_39760980(endedAt, 0LL);
}
...
System_String_o *__fastcall EventServantEntity__getEndTimeStr(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC7BE7 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_25474/*"{0}/{1:D2}/{2:D2} {3:D2}:{4:D2}"*/, v6);
    byte_4BC7BE7 = 1;
  }
  endedAt = this->fields.endedAt;
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  dateData = NetworkManager__getServerDateTime_39760980(endedAt, 0LL).fields._dateData;
  v8 = (System_Object_array *)sub_1C1AC7C(object___TypeInfo, 5LL);
  ...
  if ( v12 )
  {
    v12 = sub_1C1AD10(v12, v8->obj.klass->_1.element_class);
    if ( !v12 )
      goto LABEL_25;
  }
  if ( !v8->max_length )
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)v8->m_Items, v20, v14, v15, v16, v17, v18, v19);
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&v8->m_Items[1], v30, v24, v25, v26, v27, v28, v29);
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&v8->m_Items[2], v40, v34, v35, v36, v37, v38, v39);
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&v8->m_Items[3], v50, v44, v45, v46, v47, v48, v49);
...
LABEL_24:
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&v8->m_Items[4], v60, v54, v55, v56, v57, v58, v59);
  return System_String__Format_63054876((System_String_o *)StringLiteral_25474/*"{0}/{1:D2}/{2:D2} {3:D2}:{4:D2}"*/, v8, 0LL);
}
