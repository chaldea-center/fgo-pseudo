void __fastcall EventServantEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB5E9D & 1) == 0 )
  {
    sub_1BAB41C(&EventServantEntity_TypeInfo, v1);
    sub_1BAB41C(&StringLiteral_22021/*"nameReleaseCond"*/, v4);
    byte_4AB5E9D = 1;
  }
  EventServantEntity_TypeInfo->static_fields->NAME_RELEASE_COND = (struct System_String_o *)StringLiteral_22021/*"nameReleaseCond"*/;
  sub_1BAB3C0(
    (ServantStatusBattleListViewItem_o *)EventServantEntity_TypeInfo->static_fields,
    StringLiteral_22021/*"nameReleaseCond"*/,
    v2,
    v3);
}
...
System_String_o *__fastcall EventServantEntity__CreatePrimaryKey(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB5E8F & 1) == 0 )
  {
    sub_1BAB41C(&EventServantEntity_TypeInfo, method);
    byte_4AB5E8F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB5E97 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMasterData_CommonReleaseMaster___, key);
    ...
    sub_1BAB41C(&StringLiteral_16701/*"addMessageCommonReleaseId"*/, v9);
    byte_4AB5E97 = 1;
  }
  value = 0LL;
  v14 = 0LL;
         ...
         (const MethodInfo_3214D58 *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
  {
    ...
    if ( System_Collections_Generic_Dictionary_object__object___TryGetValue(
           (System_Collections_Generic_Dictionary_object__object__o *)script,
           (Il2CppObject *)StringLiteral_16701/*"addMessageCommonReleaseId"*/,
           &v14,
           (const MethodInfo_3214D58 *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
    {
      script = (DataManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_378A22C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( !script )
        goto LABEL_14;
...
System_String_o *__fastcall EventServantEntity__GetGetMessage(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB5E99 & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_16696/*"addGetMessage"*/, method);
    byte_4AB5E99 = 1;
  }
  return EventServantEntity__GetAddMessage(this, (System_String_o *)StringLiteral_16696/*"addGetMessage"*/, this->fields.getMessage, v2);
}
...
System_String_o *__fastcall EventServantEntity__GetJoinMessage(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB5E98 & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_16698/*"addJoinMessage"*/, method);
    byte_4AB5E98 = 1;
  }
  return EventServantEntity__GetAddMessage(this, (System_String_o *)StringLiteral_16698/*"addJoinMessage"*/, this->fields.joinMessage, v2);
}
...
System_String_o *__fastcall EventServantEntity__GetLeaveMessage(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB5E9A & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_16699/*"addLeaveMessage"*/, method);
    byte_4AB5E9A = 1;
  }
  return EventServantEntity__GetAddMessage(this, (System_String_o *)StringLiteral_16699/*"addLeaveMessage"*/, this->fields.leaveMessage, v2);
}
...
System_String_o *__fastcall EventServantEntity__GetRuby(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB5E9B & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_23022/*"ruby"*/, v3);
    byte_4AB5E9B = 1;
  }
  return EntityScriptUtil__GetStringValue(
           this->fields.script,
           (System_String_o *)StringLiteral_23022/*"ruby"*/,
...
bool __fastcall EventServantEntity__IsProtectedDuringEvent(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB5E94 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_20843/*"isProtectedDuringEvent"*/, v4);
    byte_4AB5E94 = 1;
  }
  value = 0LL;
  script = this->fields.script;
  if ( script )
  {
    if ( System_Collections_Generic_Dictionary_object__object___TryGetValue(
           (System_Collections_Generic_Dictionary_object__object__o *)script,
           (Il2CppObject *)StringLiteral_20843/*"isProtectedDuringEvent"*/,
           &value,
           (const MethodInfo_3214D58 *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
    {
      v6 = value;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB5E92 & 1) == 0 )
  {
    sub_1BAB41C(&EventServantEntity_TypeInfo, battleName);
...
LABEL_7:
    *battleName = (System_String_o *)StringLiteral_1/*""*/;
    sub_1BAB3C0((ServantStatusBattleListViewItem_o *)battleName, (int32_t)StringLiteral_1/*""*/, (int32_t)v6, v7);
    return 0;
  }
  else
  {
    ...
    *battleName = v10;
    sub_1BAB3C0((ServantStatusBattleListViewItem_o *)battleName, (int32_t)v10, (int32_t)v6, v7);
    return 1;
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB5E91 & 1) == 0 )
  {
    sub_1BAB41C(&EventServantEntity_TypeInfo, name);
    sub_1BAB41C(&StringLiteral_1/*""*/, v5);
    byte_4AB5E91 = 1;
  }
...
LABEL_7:
    *name = (System_String_o *)StringLiteral_1/*""*/;
    sub_1BAB3C0((ServantStatusBattleListViewItem_o *)name, (int32_t)StringLiteral_1/*""*/, (int32_t)v6, v7);
    return 0;
  }
  else
  {
    ...
    *name = v10;
    sub_1BAB3C0((ServantStatusBattleListViewItem_o *)name, (int32_t)v10, (int32_t)v6, v7);
    return 1;
  }
}
...
System_DateTime_o __fastcall EventServantEntity__getEndTime(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  return NetworkManager__getServerDateTime_38939020(endedAt, 0LL);
}
...
System_String_o *__fastcall EventServantEntity__getEndTimeStr(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB5E96 & 1) == 0 )
  {
    sub_1BAB41C(&System_DateTime_TypeInfo, method);
    sub_1BAB41C(&int_TypeInfo, v3);
    sub_1BAB41C(&NetworkManager_TypeInfo, v4);
    sub_1BAB41C(&object___TypeInfo, v5);
    sub_1BAB41C(&StringLiteral_25095/*"{0}/{1:D2}/{2:D2} {3:D2}:{4:D2}"*/, v6);
    byte_4AB5E96 = 1;
  }
  endedAt = this->fields.endedAt;
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  dateData = NetworkManager__getServerDateTime_38939020(endedAt, 0LL).fields._dateData;
  v8 = (System_Object_array *)sub_1BAB4C4(object___TypeInfo, 5LL);
  ...
  if ( v12 )
  {
    v12 = sub_1BAB558(v12, v8->obj.klass->_1.element_class);
    if ( !v12 )
      goto LABEL_25;
  }
  if ( !v8->max_length )
    goto LABEL_24;
  v8->m_Items[0] = v16;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)v8->m_Items, (int32_t)v16, v14, v15);
  ...
  if ( v8->max_length <= 1 )
    goto LABEL_24;
  v8->m_Items[1] = v22;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&v8->m_Items[1], (int32_t)v22, v20, v21);
  ...
  if ( v8->max_length <= 2 )
    goto LABEL_24;
  v8->m_Items[2] = v28;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&v8->m_Items[2], (int32_t)v28, v26, v27);
  ...
  if ( v8->max_length <= 3 )
    goto LABEL_24;
  v8->m_Items[3] = v34;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&v8->m_Items[3], (int32_t)v34, v32, v33);
...
LABEL_24:
    sub_1BAB680(v12, v13);
  v8->m_Items[4] = v40;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&v8->m_Items[4], (int32_t)v40, v38, v39);
  return System_String__Format_62062636((System_String_o *)StringLiteral_25095/*"{0}/{1:D2}/{2:D2} {3:D2}:{4:D2}"*/, v8, 0LL);
}
