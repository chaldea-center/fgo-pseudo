void __fastcall EventServantEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A2E091 & 1) == 0 )
  {
    sub_1B761C0(&EventServantEntity_TypeInfo, v1);
    sub_1B761C0(&StringLiteral_21977/*"nameReleaseCond"*/, v4);
    byte_4A2E091 = 1;
  }
  EventServantEntity_TypeInfo->static_fields->NAME_RELEASE_COND = (struct System_String_o *)StringLiteral_21977/*"nameReleaseCond"*/;
  sub_1B76164(
    (ServantStatusBattleListViewItem_o *)EventServantEntity_TypeInfo->static_fields,
    StringLiteral_21977/*"nameReleaseCond"*/,
    v2,
    v3);
}
...
System_String_o *__fastcall EventServantEntity__CreatePrimaryKey(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2E083 & 1) == 0 )
  {
    sub_1B761C0(&EventServantEntity_TypeInfo, method);
    byte_4A2E083 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E08B & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMasterData_CommonReleaseMaster___, key);
    ...
    sub_1B761C0(&StringLiteral_16664/*"addMessageCommonReleaseId"*/, v9);
    byte_4A2E08B = 1;
  }
  value = 0LL;
  v14 = 0LL;
         ...
         (const MethodInfo_31A753C *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
  {
    ...
    if ( System_Collections_Generic_Dictionary_object__object___TryGetValue(
           (System_Collections_Generic_Dictionary_object__object__o *)script,
           (Il2CppObject *)StringLiteral_16664/*"addMessageCommonReleaseId"*/,
           &v14,
           (const MethodInfo_31A753C *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
    {
      script = (DataManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_371257C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( !script )
        goto LABEL_14;
...
System_String_o *__fastcall EventServantEntity__GetGetMessage(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2E08D & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_16659/*"addGetMessage"*/, method);
    byte_4A2E08D = 1;
  }
  return EventServantEntity__GetAddMessage(this, (System_String_o *)StringLiteral_16659/*"addGetMessage"*/, this->fields.getMessage, v2);
}
...
System_String_o *__fastcall EventServantEntity__GetJoinMessage(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2E08C & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_16661/*"addJoinMessage"*/, method);
    byte_4A2E08C = 1;
  }
  return EventServantEntity__GetAddMessage(this, (System_String_o *)StringLiteral_16661/*"addJoinMessage"*/, this->fields.joinMessage, v2);
}
...
System_String_o *__fastcall EventServantEntity__GetLeaveMessage(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2E08E & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_16662/*"addLeaveMessage"*/, method);
    byte_4A2E08E = 1;
  }
  return EventServantEntity__GetAddMessage(this, (System_String_o *)StringLiteral_16662/*"addLeaveMessage"*/, this->fields.leaveMessage, v2);
}
...
System_String_o *__fastcall EventServantEntity__GetRuby(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2E08F & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_22971/*"ruby"*/, v3);
    byte_4A2E08F = 1;
  }
  return EntityScriptUtil__GetStringValue(
           this->fields.script,
           (System_String_o *)StringLiteral_22971/*"ruby"*/,
...
bool __fastcall EventServantEntity__IsProtectedDuringEvent(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2E088 & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_20802/*"isProtectedDuringEvent"*/, v4);
    byte_4A2E088 = 1;
  }
  value = 0LL;
  script = this->fields.script;
  if ( script )
  {
    if ( System_Collections_Generic_Dictionary_object__object___TryGetValue(
           (System_Collections_Generic_Dictionary_object__object__o *)script,
           (Il2CppObject *)StringLiteral_20802/*"isProtectedDuringEvent"*/,
           &value,
           (const MethodInfo_31A753C *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
    {
      v6 = value;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E086 & 1) == 0 )
  {
    sub_1B761C0(&EventServantEntity_TypeInfo, battleName);
...
LABEL_7:
    *battleName = (System_String_o *)StringLiteral_1/*""*/;
    sub_1B76164((ServantStatusBattleListViewItem_o *)battleName, (int32_t)StringLiteral_1/*""*/, (int32_t)v6, v7);
    return 0;
  }
  else
  {
    ...
    *battleName = v10;
    sub_1B76164((ServantStatusBattleListViewItem_o *)battleName, (int32_t)v10, (int32_t)v6, v7);
    return 1;
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E085 & 1) == 0 )
  {
    sub_1B761C0(&EventServantEntity_TypeInfo, name);
    sub_1B761C0(&StringLiteral_1/*""*/, v5);
    byte_4A2E085 = 1;
  }
...
LABEL_7:
    *name = (System_String_o *)StringLiteral_1/*""*/;
    sub_1B76164((ServantStatusBattleListViewItem_o *)name, (int32_t)StringLiteral_1/*""*/, (int32_t)v6, v7);
    return 0;
  }
  else
  {
    ...
    *name = v10;
    sub_1B76164((ServantStatusBattleListViewItem_o *)name, (int32_t)v10, (int32_t)v6, v7);
    return 1;
  }
}
...
System_DateTime_o __fastcall EventServantEntity__getEndTime(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  return NetworkManager__getServerDateTime_38212880(endedAt, 0LL);
}
...
System_String_o *__fastcall EventServantEntity__getEndTimeStr(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2E08A & 1) == 0 )
  {
    sub_1B761C0(&System_DateTime_TypeInfo, method);
    sub_1B761C0(&int_TypeInfo, v3);
    sub_1B761C0(&NetworkManager_TypeInfo, v4);
    sub_1B761C0(&object___TypeInfo, v5);
    sub_1B761C0(&StringLiteral_25039/*"{0}/{1:D2}/{2:D2} {3:D2}:{4:D2}"*/, v6);
    byte_4A2E08A = 1;
  }
  endedAt = this->fields.endedAt;
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
  ...
  v8 = (System_Object_array *)sub_1B76268(object___TypeInfo, 5LL);
  ...
  if ( v12 )
  {
    v12 = sub_1B762FC(v12, v8->obj.klass->_1.element_class);
    if ( !v12 )
      goto LABEL_25;
  }
  if ( !v8->max_length )
    goto LABEL_24;
  v8->m_Items[0] = v16;
  sub_1B76164((ServantStatusBattleListViewItem_o *)v8->m_Items, (int32_t)v16, v14, v15);
  ...
  if ( v8->max_length <= 1 )
    goto LABEL_24;
  v8->m_Items[1] = v22;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&v8->m_Items[1], (int32_t)v22, v20, v21);
  ...
  if ( v8->max_length <= 2 )
    goto LABEL_24;
  v8->m_Items[2] = v28;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&v8->m_Items[2], (int32_t)v28, v26, v27);
  ...
  if ( v8->max_length <= 3 )
    goto LABEL_24;
  v8->m_Items[3] = v34;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&v8->m_Items[3], (int32_t)v34, v32, v33);
...
LABEL_24:
    sub_1B76424(v12, v13);
  v8->m_Items[4] = v40;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&v8->m_Items[4], (int32_t)v40, v38, v39);
  return System_String__Format_61549568((System_String_o *)StringLiteral_25039/*"{0}/{1:D2}/{2:D2} {3:D2}:{4:D2}"*/, v8, 0LL);
}
