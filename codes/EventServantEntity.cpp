void __fastcall EventServantEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B02170 & 1) == 0 )
  {
    sub_1BC3008(&EventServantEntity_TypeInfo, v1);
    sub_1BC3008(&StringLiteral_21936/*"nameReleaseCond"*/, v4);
    byte_4B02170 = 1;
  }
  EventServantEntity_TypeInfo->static_fields->NAME_RELEASE_COND = (struct System_String_o *)StringLiteral_21936/*"nameReleaseCond"*/;
  sub_1BC2FAC((CGThumbnailListItem_o *)EventServantEntity_TypeInfo->static_fields, StringLiteral_21936/*"nameReleaseCond"*/, v2, v3);
}
...
System_String_o *__fastcall EventServantEntity__CreatePrimaryKey(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B02162 & 1) == 0 )
  {
    sub_1BC3008(&EventServantEntity_TypeInfo, method);
    byte_4B02162 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B0216A & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMasterData_CommonReleaseMaster___, key);
    ...
    sub_1BC3008(&StringLiteral_16528/*"addMessageCommonReleaseId"*/, v9);
    byte_4B0216A = 1;
  }
  value = 0LL;
  v14 = 0LL;
         ...
         (const MethodInfo_336E7F4 *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
  {
    ...
    if ( System_Collections_Generic_Dictionary_object__object___TryGetValue(
           (System_Collections_Generic_Dictionary_object__object__o *)script,
           (Il2CppObject *)StringLiteral_16528/*"addMessageCommonReleaseId"*/,
           &v14,
           (const MethodInfo_336E7F4 *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
    {
      script = (DataManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38DFD48 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( !script )
        goto LABEL_14;
...
System_String_o *__fastcall EventServantEntity__GetGetMessage(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B0216C & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_16522/*"addGetMessage"*/, method);
    byte_4B0216C = 1;
  }
  return EventServantEntity__GetAddMessage(this, (System_String_o *)StringLiteral_16522/*"addGetMessage"*/, this->fields.getMessage, v2);
}
...
System_String_o *__fastcall EventServantEntity__GetJoinMessage(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B0216B & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_16525/*"addJoinMessage"*/, method);
    byte_4B0216B = 1;
  }
  return EventServantEntity__GetAddMessage(this, (System_String_o *)StringLiteral_16525/*"addJoinMessage"*/, this->fields.joinMessage, v2);
}
...
System_String_o *__fastcall EventServantEntity__GetLeaveMessage(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B0216D & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_16526/*"addLeaveMessage"*/, method);
    byte_4B0216D = 1;
  }
  return EventServantEntity__GetAddMessage(this, (System_String_o *)StringLiteral_16526/*"addLeaveMessage"*/, this->fields.leaveMessage, v2);
}
...
System_String_o *__fastcall EventServantEntity__GetRuby(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B0216E & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_22938/*"ruby"*/, v3);
    byte_4B0216E = 1;
  }
  return EntityScriptUtil__GetStringValue(
           this->fields.script,
           (System_String_o *)StringLiteral_22938/*"ruby"*/,
...
bool __fastcall EventServantEntity__IsProtectedDuringEvent(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B02167 & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_20742/*"isProtectedDuringEvent"*/, v4);
    byte_4B02167 = 1;
  }
  value = 0LL;
  script = this->fields.script;
  if ( script )
  {
    if ( System_Collections_Generic_Dictionary_object__object___TryGetValue(
           (System_Collections_Generic_Dictionary_object__object__o *)script,
           (Il2CppObject *)StringLiteral_20742/*"isProtectedDuringEvent"*/,
           &value,
           (const MethodInfo_336E7F4 *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
    {
      v6 = value;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B02165 & 1) == 0 )
  {
    sub_1BC3008(&EventServantEntity_TypeInfo, battleName);
...
LABEL_7:
    *battleName = (System_String_o *)StringLiteral_1/*""*/;
    sub_1BC2FAC((CGThumbnailListItem_o *)battleName, (int32_t)StringLiteral_1/*""*/, (int32_t)v6, v7);
    return 0;
  }
  else
  {
    ...
    *battleName = v10;
    sub_1BC2FAC((CGThumbnailListItem_o *)battleName, (int32_t)v10, (int32_t)v6, v7);
    return 1;
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B02164 & 1) == 0 )
  {
    sub_1BC3008(&EventServantEntity_TypeInfo, name);
    sub_1BC3008(&StringLiteral_1/*""*/, v5);
    byte_4B02164 = 1;
  }
...
LABEL_7:
    *name = (System_String_o *)StringLiteral_1/*""*/;
    sub_1BC2FAC((CGThumbnailListItem_o *)name, (int32_t)StringLiteral_1/*""*/, (int32_t)v6, v7);
    return 0;
  }
  else
  {
    ...
    *name = v10;
    sub_1BC2FAC((CGThumbnailListItem_o *)name, (int32_t)v10, (int32_t)v6, v7);
    return 1;
  }
}
...
System_DateTime_o __fastcall EventServantEntity__getEndTime(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  return NetworkManager__getServerDateTime_40297788(endedAt, 0LL);
}
...
System_String_o *__fastcall EventServantEntity__getEndTimeStr(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B02169 & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_24913/*"{0}/{1:D2}/{2:D2} {3:D2}:{4:D2}"*/, v6);
    byte_4B02169 = 1;
  }
  endedAt = this->fields.endedAt;
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  dateData = NetworkManager__getServerDateTime_40297788(endedAt, 0LL).fields._dateData;
  v8 = (System_Object_array *)sub_1BC30B0(object___TypeInfo, 5LL);
  ...
  if ( v12 )
  {
    v12 = sub_1BC3144(v12, v8->obj.klass->_1.element_class);
    if ( !v12 )
      goto LABEL_25;
  }
  if ( !v8->max_length )
    goto LABEL_24;
  v8->m_Items[0] = v16;
  sub_1BC2FAC((CGThumbnailListItem_o *)v8->m_Items, (int32_t)v16, v14, v15);
  ...
  if ( v8->max_length <= 1 )
    goto LABEL_24;
  v8->m_Items[1] = v21;
  sub_1BC2FAC((CGThumbnailListItem_o *)&v8->m_Items[1], (int32_t)v21, v14, v20);
  ...
  if ( v8->max_length <= 2 )
    goto LABEL_24;
  v8->m_Items[2] = v26;
  sub_1BC2FAC((CGThumbnailListItem_o *)&v8->m_Items[2], (int32_t)v26, v14, v25);
  ...
  if ( v8->max_length <= 3 )
    goto LABEL_24;
  v8->m_Items[3] = v31;
  sub_1BC2FAC((CGThumbnailListItem_o *)&v8->m_Items[3], (int32_t)v31, v14, v30);
...
LABEL_24:
  ...
  v8->m_Items[4] = v36;
  sub_1BC2FAC((CGThumbnailListItem_o *)&v8->m_Items[4], (int32_t)v36, v14, v35);
  return System_String__Format_62390076((System_String_o *)StringLiteral_24913/*"{0}/{1:D2}/{2:D2} {3:D2}:{4:D2}"*/, v8, 0LL);
}
