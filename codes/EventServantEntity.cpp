void __fastcall EventServantEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A1FC24 & 1) == 0 )
  {
    sub_1B715CC(&EventServantEntity_TypeInfo, v1);
    sub_1B715CC(&StringLiteral_21931/*"nameReleaseCond"*/, v4);
    byte_4A1FC24 = 1;
  }
  EventServantEntity_TypeInfo->static_fields->NAME_RELEASE_COND = (struct System_String_o *)StringLiteral_21931/*"nameReleaseCond"*/;
  sub_1B71570(
    (ServantStatusBattleListViewItem_o *)EventServantEntity_TypeInfo->static_fields,
    StringLiteral_21931/*"nameReleaseCond"*/,
    v2,
    v3);
}
...
System_String_o *__fastcall EventServantEntity__CreatePK(int32_t eventId, int32_t svtId, const MethodInfo *method)
{
  if ( (byte_4A1FC17 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&svtId);
    byte_4A1FC17 = 1;
  }
...
System_String_o *__fastcall EventServantEntity__CreatePrimaryKey(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1FC16 & 1) == 0 )
  {
    sub_1B715CC(&EventServantEntity_TypeInfo, method);
    byte_4A1FC16 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1FC1E & 1) == 0 )
  {
    sub_1B715CC(&Method_DataManager_GetMasterData_CommonReleaseMaster___, key);
    ...
    sub_1B715CC(&StringLiteral_16620/*"addMessageCommonReleaseId"*/, v9);
    byte_4A1FC1E = 1;
  }
  value = 0LL;
  v14 = 0LL;
         ...
         (const MethodInfo_31A051C *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
  {
    ...
    if ( System_Collections_Generic_Dictionary_object__object___TryGetValue(
           (System_Collections_Generic_Dictionary_object__object__o *)script,
           (Il2CppObject *)StringLiteral_16620/*"addMessageCommonReleaseId"*/,
           &v14,
           (const MethodInfo_31A051C *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
    {
      script = (DataManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( !script )
        goto LABEL_14;
...
System_String_o *__fastcall EventServantEntity__GetGetMessage(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1FC20 & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_16615/*"addGetMessage"*/, method);
    byte_4A1FC20 = 1;
  }
  return EventServantEntity__GetAddMessage(this, (System_String_o *)StringLiteral_16615/*"addGetMessage"*/, this->fields.getMessage, v2);
}
...
System_String_o *__fastcall EventServantEntity__GetJoinMessage(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1FC1F & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_16617/*"addJoinMessage"*/, method);
    byte_4A1FC1F = 1;
  }
  return EventServantEntity__GetAddMessage(this, (System_String_o *)StringLiteral_16617/*"addJoinMessage"*/, this->fields.joinMessage, v2);
}
...
System_String_o *__fastcall EventServantEntity__GetLeaveMessage(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1FC21 & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_16618/*"addLeaveMessage"*/, method);
    byte_4A1FC21 = 1;
  }
  return EventServantEntity__GetAddMessage(this, (System_String_o *)StringLiteral_16618/*"addLeaveMessage"*/, this->fields.leaveMessage, v2);
}
...
System_String_o *__fastcall EventServantEntity__GetRuby(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1FC22 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_22925/*"ruby"*/, v3);
    byte_4A1FC22 = 1;
  }
  return EntityScriptUtil__GetStringValue(
           this->fields.script,
           (System_String_o *)StringLiteral_22925/*"ruby"*/,
...
bool __fastcall EventServantEntity__IsProtectedDuringEvent(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1FC1B & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_20757/*"isProtectedDuringEvent"*/, v4);
    byte_4A1FC1B = 1;
  }
  value = 0LL;
  script = this->fields.script;
  if ( script )
  {
    if ( System_Collections_Generic_Dictionary_object__object___TryGetValue(
           (System_Collections_Generic_Dictionary_object__object__o *)script,
           (Il2CppObject *)StringLiteral_20757/*"isProtectedDuringEvent"*/,
           &value,
           (const MethodInfo_31A051C *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
    {
      v6 = value;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1FC19 & 1) == 0 )
  {
    sub_1B715CC(&EventServantEntity_TypeInfo, battleName);
...
LABEL_7:
    *battleName = (System_String_o *)StringLiteral_1/*""*/;
    sub_1B71570((ServantStatusBattleListViewItem_o *)battleName, (int32_t)StringLiteral_1/*""*/, (int32_t)v6, v7);
    return 0;
  }
  else
  {
    ...
    *battleName = v10;
    sub_1B71570((ServantStatusBattleListViewItem_o *)battleName, (int32_t)v10, (int32_t)v6, v7);
    return 1;
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1FC18 & 1) == 0 )
  {
    sub_1B715CC(&EventServantEntity_TypeInfo, name);
    sub_1B715CC(&StringLiteral_1/*""*/, v5);
    byte_4A1FC18 = 1;
  }
...
LABEL_7:
    *name = (System_String_o *)StringLiteral_1/*""*/;
    sub_1B71570((ServantStatusBattleListViewItem_o *)name, (int32_t)StringLiteral_1/*""*/, (int32_t)v6, v7);
    return 0;
  }
  else
  {
    ...
    *name = v10;
    sub_1B71570((ServantStatusBattleListViewItem_o *)name, (int32_t)v10, (int32_t)v6, v7);
    return 1;
  }
}
...
System_DateTime_o __fastcall EventServantEntity__getEndTime(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  return NetworkManager__getServerDateTime_38187940(endedAt, 0LL);
}
...
System_String_o *__fastcall EventServantEntity__getEndTimeStr(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1FC1D & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_24993/*"{0}/{1:D2}/{2:D2} {3:D2}:{4:D2}"*/, v6);
    byte_4A1FC1D = 1;
  }
  endedAt = this->fields.endedAt;
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
  ...
  v8 = (System_Object_array *)sub_1B71674(object___TypeInfo, 5LL);
  ...
  if ( v12 )
  {
    v12 = sub_1B71708(v12, v8->obj.klass->_1.element_class);
    if ( !v12 )
      goto LABEL_25;
  }
  if ( !v8->max_length )
    goto LABEL_24;
  v8->m_Items[0] = v16;
  sub_1B71570((ServantStatusBattleListViewItem_o *)v8->m_Items, (int32_t)v16, v14, v15);
  ...
  if ( v8->max_length <= 1 )
    goto LABEL_24;
  v8->m_Items[1] = v22;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&v8->m_Items[1], (int32_t)v22, v20, v21);
  ...
  if ( v8->max_length <= 2 )
    goto LABEL_24;
  v8->m_Items[2] = v28;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&v8->m_Items[2], (int32_t)v28, v26, v27);
  ...
  if ( v8->max_length <= 3 )
    goto LABEL_24;
  v8->m_Items[3] = v34;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&v8->m_Items[3], (int32_t)v34, v32, v33);
...
LABEL_24:
    sub_1B71830(v12, v13);
  v8->m_Items[4] = v40;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&v8->m_Items[4], (int32_t)v40, v38, v39);
  return System_String__Format_61520012((System_String_o *)StringLiteral_24993/*"{0}/{1:D2}/{2:D2} {3:D2}:{4:D2}"*/, v8, 0LL);
}
