void __fastcall EventServantEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FEC78 & 1) == 0 )
  {
    sub_1B64A00(&EventServantEntity_TypeInfo, v1);
    sub_1B64A00(&StringLiteral_21902/*"nameReleaseCond"*/, v4);
    byte_49FEC78 = 1;
  }
...
System_String_o *__fastcall EventServantEntity__CreatePrimaryKey(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FEC6A & 1) == 0 )
  {
    sub_1B64A00(&EventServantEntity_TypeInfo, method);
    byte_49FEC6A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FEC72 & 1) == 0 )
  {
    sub_1B64A00(&Method_DataManager_GetMasterData_CommonReleaseMaster___, key);
    ...
    sub_1B64A00(&StringLiteral_16604/*"addMessageCommonReleaseId"*/, v9);
    byte_49FEC72 = 1;
  }
  value = 0LL;
  v14 = 0LL;
         ...
         (const MethodInfo_317D4F8 *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
  {
    ...
    if ( System_Collections_Generic_Dictionary_object__object___TryGetValue(
           ...
           (const MethodInfo_317D4F8 *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
    {
      script = (DataManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE930 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( !script )
        goto LABEL_14;
...
System_String_o *__fastcall EventServantEntity__GetGetMessage(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FEC74 & 1) == 0 )
  {
    sub_1B64A00(&StringLiteral_16599/*"addGetMessage"*/, method);
    byte_49FEC74 = 1;
  }
...
System_String_o *__fastcall EventServantEntity__GetJoinMessage(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FEC73 & 1) == 0 )
  {
    sub_1B64A00(&StringLiteral_16601/*"addJoinMessage"*/, method);
    byte_49FEC73 = 1;
  }
...
System_String_o *__fastcall EventServantEntity__GetLeaveMessage(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FEC75 & 1) == 0 )
  {
    sub_1B64A00(&StringLiteral_16602/*"addLeaveMessage"*/, method);
    byte_49FEC75 = 1;
  }
...
System_String_o *__fastcall EventServantEntity__GetRuby(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FEC76 & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_22890/*"ruby"*/, v3);
    byte_49FEC76 = 1;
  }
...
bool __fastcall EventServantEntity__IsProtectedDuringEvent(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FEC6F & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__, v3);
    sub_1B64A00(&StringLiteral_20730/*"isProtectedDuringEvent"*/, v4);
    byte_49FEC6F = 1;
  }
  value = 0LL;
  script = this->fields.script;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FEC6D & 1) == 0 )
  {
    sub_1B64A00(&EventServantEntity_TypeInfo, battleName);
...
LABEL_7:
    *battleName = (System_String_o *)StringLiteral_1/*""*/;
    sub_1B649A4((ServantStatusBattleListViewItem_o *)battleName, (int32_t)StringLiteral_1/*""*/, (int32_t)v6, v7);
    return 0;
  }
  else
  {
    ...
    *battleName = v10;
    sub_1B649A4((ServantStatusBattleListViewItem_o *)battleName, (int32_t)v10, (int32_t)v6, v7);
    return 1;
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FEC6C & 1) == 0 )
  {
    sub_1B64A00(&EventServantEntity_TypeInfo, name);
    sub_1B64A00(&StringLiteral_1/*""*/, v5);
    byte_49FEC6C = 1;
  }
...
LABEL_7:
    *name = (System_String_o *)StringLiteral_1/*""*/;
    sub_1B649A4((ServantStatusBattleListViewItem_o *)name, (int32_t)StringLiteral_1/*""*/, (int32_t)v6, v7);
    return 0;
  }
  else
  {
    ...
    *name = v10;
    sub_1B649A4((ServantStatusBattleListViewItem_o *)name, (int32_t)v10, (int32_t)v6, v7);
    return 1;
  }
}
...
System_DateTime_o __fastcall EventServantEntity__getEndTime(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  return NetworkManager__getServerDateTime_38082816(endedAt, 0LL);
}
...
System_String_o *__fastcall EventServantEntity__getEndTimeStr(EventServantEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FEC71 & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_24956/*"{0}/{1:D2}/{2:D2} {3:D2}:{4:D2}"*/, v6);
    byte_49FEC71 = 1;
  }
  endedAt = this->fields.endedAt;
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  dateData = NetworkManager__getServerDateTime_38082816(endedAt, 0LL).fields._dateData;
  v8 = (System_Object_array *)sub_1B64AA8(object___TypeInfo, 5LL);
  ...
  if ( v12 )
  {
    v12 = sub_1B64B3C(v12, v8->obj.klass->_1.element_class);
    if ( !v12 )
      goto LABEL_25;
  }
  if ( !v8->max_length )
    goto LABEL_24;
  v8->m_Items[0] = v16;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)v8->m_Items, (int32_t)v16, v14, v15);
  ...
  if ( v8->max_length <= 1 )
    goto LABEL_24;
  v8->m_Items[1] = v22;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&v8->m_Items[1], (int32_t)v22, v20, v21);
  ...
  if ( v8->max_length <= 2 )
    goto LABEL_24;
  v8->m_Items[2] = v28;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&v8->m_Items[2], (int32_t)v28, v26, v27);
  ...
  if ( v8->max_length <= 3 )
    goto LABEL_24;
  v8->m_Items[3] = v34;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&v8->m_Items[3], (int32_t)v34, v32, v33);
...
LABEL_24:
    sub_1B64C64(v12, v13);
  v8->m_Items[4] = v40;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&v8->m_Items[4], (int32_t)v40, v38, v39);
  return System_String__Format_61399644((System_String_o *)StringLiteral_24956/*"{0}/{1:D2}/{2:D2} {3:D2}:{4:D2}"*/, v8, 0LL);
}
