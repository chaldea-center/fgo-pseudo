        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01F2A & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_11370/*"SAME_SVTEQUIP_COMBINE"*/, v9);
    this = (MaterialSvtInfo_o *)sub_1B64870(&StringLiteral_1/*""*/, v10);
    byte_4A01F2A = 1;
  }
  if ( !baseData )
    goto LABEL_18;
  ...
  *(_QWORD *)&v16.fields.fakeValue = v11;
  this = (MaterialSvtInfo_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46180532(v16, 0LL);
  selectUsrSvtEnt = (CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_o *)v7->fields.selectUsrSvtEnt;
  if ( !selectUsrSvtEnt )
    goto LABEL_18;
  if ( (_DWORD)this == CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46180532(selectUsrSvtEnt[5], 0LL) )
  {
...
LABEL_17:
      ...
      else
      {
        ...
        this = (MaterialSvtInfo_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11370/*"SAME_SVTEQUIP_COMBINE"*/, 0LL);
        if ( statusLb )
        {
          v15 = this;
          goto LABEL_17;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01F29 & 1) == 0 )
  {
    sub_1B64870(&Method_DataManager_GetMasterData_UserServantMaster___, *(_QWORD *)&idx);
  ...
  *(_OWORD *)&this->fields.selectUsrSvtId.fields.fakeValue = v19;
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.selectUsrSvtEnt, (int32_t)Entity, v23, v24);
...
LABEL_16:
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.callbackFunc, (int32_t)callback, v29, v30);
}


void __fastcall MaterialSvtInfo__setMaterialSvtInfo_44883528(
        MaterialSvtInfo_o *this,
        int32_t idx,
        UserServantEntity_o *baseData,
        int64_t selectUsrSvtId,
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19B1010;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19B0FB8;
}
