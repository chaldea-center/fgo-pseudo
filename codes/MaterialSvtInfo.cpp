        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A8BF & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_11590/*"SAME_SVTEQUIP_COMBINE"*/, v9);
    this = (MaterialSvtInfo_o *)sub_1BE4ACC(&StringLiteral_1/*""*/, v10);
    byte_4B6A8BF = 1;
  }
  if ( !baseData )
    goto LABEL_18;
  ...
  *(_QWORD *)&v16.fields.fakeValue = v11;
  this = (MaterialSvtInfo_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47299060(v16, 0LL);
  selectUsrSvtEnt = (CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_o *)v7->fields.selectUsrSvtEnt;
  if ( !selectUsrSvtEnt )
    goto LABEL_18;
  if ( (_DWORD)this == CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47299060(selectUsrSvtEnt[5], 0LL) )
  {
...
LABEL_17:
      ...
      else
      {
        ...
        this = (MaterialSvtInfo_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11590/*"SAME_SVTEQUIP_COMBINE"*/, 0LL);
        if ( statusLb )
        {
          v15 = this;
          goto LABEL_17;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A8BE & 1) == 0 )
  {
    sub_1BE4ACC(&Method_DataManager_GetMasterData_UserServantMaster___, *(_QWORD *)&idx);
...
LABEL_16:
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.callbackFunc, (int64_t)callback, v33, v34, v35, v36, v37, v38);
}


void __fastcall MaterialSvtInfo__setMaterialSvtInfo_46425756(
        MaterialSvtInfo_o *this,
        int32_t idx,
        UserServantEntity_o *baseData,
        int64_t selectUsrSvtId,
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A2B744;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A2B6EC;
}
