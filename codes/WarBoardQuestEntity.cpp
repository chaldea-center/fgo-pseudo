...
bool __fastcall WarBoardQuestEntity__IsUseEventUI(WarBoardQuestEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4B45BC9 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_20970/*"isUseEventUI"*/, method);
    byte_4B45BC9 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_20970/*"isUseEventUI"*/, 0, 0LL) > 0;
}