...
bool __fastcall WarBoardQuestEntity__IsUseEventUI(WarBoardQuestEntity_o *this, const MethodInfo *method)
{
  if ( (byte_49BBF37 & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_20538/*"isUseEventUI"*/, method);
    byte_49BBF37 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_20538/*"isUseEventUI"*/, 0, 0LL) > 0;
}