...
bool __fastcall WarBoardQuestEntity__IsUseEventUI(WarBoardQuestEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4B67BFE & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_21122/*"isUseEventUI"*/, method);
    byte_4B67BFE = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_21122/*"isUseEventUI"*/, 0, 0LL) > 0;
}