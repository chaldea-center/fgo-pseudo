...
bool WarBoardQuestEntity__IsUseEventUI(WarBoardQuestEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4C4417F & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_20964/*"isUseEventUI"*/);
    byte_4C4417F = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_20964/*"isUseEventUI"*/, 0, 0) > 0;
}