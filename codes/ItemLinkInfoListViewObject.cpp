...
void __fastcall ItemLinkInfoListViewObject__Awake(ItemLinkInfoListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6955F & 1) == 0 )
  {
    sub_1BE4ACC(&Method_UnityEngine_GameObject_GetComponent_ItemLinkInfoListViewItemDraw___, method);
    byte_4B6955F = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2FA979C *)Method_UnityEngine_GameObject_GetComponent_ItemLinkInfoListViewItemDraw___);
...
float __fastcall ItemLinkInfoListViewObject__GetHeight(ItemLinkInfoListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B69562 & 1) == 0 )
  {
    sub_1BE4ACC(&ItemLinkInfoListViewItemDraw_TypeInfo, method);
        ...
        const MethodInfo *method)
{
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.linkItem, (int64_t)item, (int64_t)method, v3, v4, v5, v6, v7);
