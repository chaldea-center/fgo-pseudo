...
void ItemLinkInfoListViewObject__Awake(ItemLinkInfoListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D332A4 & 1) == 0 )
  {
    sub_1C93AD4(&Method_UnityEngine_GameObject_GetComponent_ItemLinkInfoListViewItemDraw___);
    byte_4D332A4 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_31FC084 *)Method_UnityEngine_GameObject_GetComponent_ItemLinkInfoListViewItemDraw___);
...
float ItemLinkInfoListViewObject__GetHeight(ItemLinkInfoListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D332A7 & 1) == 0 )
  {
    sub_1C93AD4(&ItemLinkInfoListViewItemDraw_TypeInfo);
    sub_1C93AD4(&UnityEngine_Object_TypeInfo);
    byte_4D332A7 = 1;
  }
  itemDraw = (UnityEngine_Object_o *)this->fields.itemDraw;
