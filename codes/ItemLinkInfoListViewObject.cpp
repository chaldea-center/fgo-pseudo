...
void __fastcall ItemLinkInfoListViewObject__Awake(ItemLinkInfoListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A71F10 & 1) == 0 )
  {
    sub_1B90010(&Method_UnityEngine_GameObject_GetComponent_ItemLinkInfoListViewItemDraw___, method);
    byte_4A71F10 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2EDD768 *)Method_UnityEngine_GameObject_GetComponent_ItemLinkInfoListViewItemDraw___);
...
float __fastcall ItemLinkInfoListViewObject__GetHeight(ItemLinkInfoListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A71F13 & 1) == 0 )
  {
    sub_1B90010(&ItemLinkInfoListViewItemDraw_TypeInfo, method);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.linkItem, (int32_t)item, (int32_t)method, v3);
