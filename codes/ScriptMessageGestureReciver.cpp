        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5CD81 & 1) == 0 )
  {
    ...
    sub_1B885B0(&SwipeGesture_TypeInfo);
    sub_1B885B0(&UICamera_TypeInfo);
    sub_1B885B0(&StringLiteral_9963/*"OnSwipeBlockPanel"*/);
    byte_4A5CD81 = 1;
  }
  if ( gesture )
  {
      ...
      if ( UnityEngine_Object__op_Inequality(swipCallback, 0LL, 0LL) )
      {
        ...
        if ( UnityEngine_Object__op_Inequality(startSelection, 0LL, 0LL) )
        {
          ...
          if ( UICamera__Raycast(v12, 0LL) )
          {
            ...
            if ( !v11 )
              sub_1B8880C(0LL, v10);
            UnityEngine_Component__SendMessage(v11, (System_String_o *)StringLiteral_9963/*"OnSwipeBlockPanel"*/, (Il2CppObject *)gesture, 0LL);
          }
        }
      }
    }
...
void __fastcall ScriptMessageGestureReciver__OnDestroy(ScriptMessageGestureReciver_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5CD80 & 1) == 0 )
  {
    sub_1B885B0(&Gesture_EventHandler_TypeInfo);
    sub_1B885B0(&FingerGestures_TypeInfo);
    sub_1B885B0(&Method_ScriptMessageGestureReciver_FingerGestures_OnGestureEvent__);
    byte_4A5CD80 = 1;
  }
  v3 = (Gesture_EventHandler_o *)sub_1B887FC(Gesture_EventHandler_TypeInfo);
