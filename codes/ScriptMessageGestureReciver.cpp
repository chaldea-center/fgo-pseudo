        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A00711 & 1) == 0 )
  {
    sub_1B64A00(&UnityEngine_Object_TypeInfo, gesture);
    sub_1B64A00(&SwipeGesture_TypeInfo, v5);
    sub_1B64A00(&UICamera_TypeInfo, v6);
    sub_1B64A00(&StringLiteral_9920/*"OnSwipeBlockPanel"*/, v7);
    byte_4A00711 = 1;
  }
  if ( gesture )
  {
      ...
      if ( UnityEngine_Object__op_Inequality(swipCallback, 0LL, 0LL) )
      {
        ...
        if ( UnityEngine_Object__op_Inequality(startSelection, 0LL, 0LL) )
        {
          ...
          if ( UICamera__Raycast(v15, 0LL) )
          {
            ...
            if ( !v14 )
              sub_1B64C5C(0LL, v13);
            UnityEngine_Component__SendMessage(v14, (System_String_o *)StringLiteral_9920/*"OnSwipeBlockPanel"*/, (Il2CppObject *)gesture, 0LL);
          }
        }
      }
    }
...
void __fastcall ScriptMessageGestureReciver__OnDestroy(ScriptMessageGestureReciver_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A00710 & 1) == 0 )
  {
    sub_1B64A00(&Gesture_EventHandler_TypeInfo, method);
    sub_1B64A00(&FingerGestures_TypeInfo, v3);
    sub_1B64A00(&Method_ScriptMessageGestureReciver_FingerGestures_OnGestureEvent__, v4);
    byte_4A00710 = 1;
  }
  v5 = (Gesture_EventHandler_o *)sub_1B64C4C(Gesture_EventHandler_TypeInfo);
