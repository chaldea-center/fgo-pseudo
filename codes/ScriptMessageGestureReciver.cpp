        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2E8B5 & 1) == 0 )
  {
    ...
    sub_1C94098(&SwipeGesture_TypeInfo);
    sub_1C94098(&UICamera_TypeInfo);
    sub_1C94098(&StringLiteral_9992/*"OnSwipeBlockPanel"*/);
    byte_4D2E8B5 = 1;
  }
  if ( gesture )
  {
      ...
      if ( UnityEngine_Object__op_Inequality(swipCallback, 0, 0) )
      {
        ...
        if ( UnityEngine_Object__op_Inequality(startSelection, 0, 0) )
        {
          ...
          if ( UICamera__Raycast(v12, 0) )
          {
            ...
            if ( !v11 )
              sub_1C942F0(0, v10);
            UnityEngine_Component__SendMessage(v11, (System_String_o *)StringLiteral_9992/*"OnSwipeBlockPanel"*/, (Il2CppObject *)gesture, 0);
          }
        }
      }
    }
...
void ScriptMessageGestureReciver__OnDestroy(ScriptMessageGestureReciver_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2E8B4 & 1) == 0 )
  {
    sub_1C94098(&Gesture_EventHandler_TypeInfo);
    sub_1C94098(&FingerGestures_TypeInfo);
    sub_1C94098(&Method_ScriptMessageGestureReciver_FingerGestures_OnGestureEvent__);
    byte_4D2E8B4 = 1;
  }
  v3 = (Gesture_EventHandler_o *)sub_1C942E4(Gesture_EventHandler_TypeInfo);
