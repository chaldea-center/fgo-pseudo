        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B5A9A & 1) == 0 )
  {
    ...
    sub_B52984(&SwipeGesture_TypeInfo);
    sub_B52984(&UICamera_TypeInfo);
    sub_B52984(&StringLiteral_10127/*"OnSwipeBlockPanel"*/);
    byte_42B5A9A = 1;
  }
  if ( gesture )
  {
        ...
        if ( UnityEngine_Object__op_Inequality(startSelection, 0LL, 0LL) )
        {
          ...
          if ( UICamera__Raycast(v12, 0LL) )
          {
            ...
            UnityEngine_Component__SendMessage(
              v11,
              (System_String_o *)StringLiteral_10127/*"OnSwipeBlockPanel"*/,
...
void __fastcall ScriptMessageGestureReciver__OnDestroy(ScriptMessageGestureReciver_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B5A99 & 1) == 0 )
  {
    sub_B52984(&Gesture_EventHandler_TypeInfo);
    sub_B52984(&FingerGestures_TypeInfo);
    sub_B52984(&Method_ScriptMessageGestureReciver_FingerGestures_OnGestureEvent__);
    byte_42B5A99 = 1;
  }
  v3 = (Gesture_EventHandler_o *)sub_B52A54(Gesture_EventHandler_TypeInfo);
