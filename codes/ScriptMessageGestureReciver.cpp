        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF0625 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&SwipeGesture_TypeInfo);
    sub_1C7BAE8(&UICamera_TypeInfo);
    sub_1C7BAE8(&StringLiteral_9996/*"OnSwipeBlockPanel"*/);
    byte_4CF0625 = 1;
  }
  if ( gesture )
  {
      ...
      if ( UnityEngine_Object__op_Inequality(swipCallback, 0, 0) )
      {
        ...
        if ( UnityEngine_Object__op_Inequality(startSelection, 0, 0) )
        {
          ...
          if ( UICamera__Raycast(v12, 0) )
          {
            ...
            if ( !v11 )
              sub_1C7BD40(0, v10);
            UnityEngine_Component__SendMessage(v11, (System_String_o *)StringLiteral_9996/*"OnSwipeBlockPanel"*/, (Il2CppObject *)gesture, 0);
          }
        }
      }
    }
...
void ScriptMessageGestureReciver__OnDestroy(ScriptMessageGestureReciver_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CF0624 & 1) == 0 )
  {
    sub_1C7BAE8(&Gesture_EventHandler_TypeInfo);
    sub_1C7BAE8(&FingerGestures_TypeInfo);
    sub_1C7BAE8(&Method_ScriptMessageGestureReciver_FingerGestures_OnGestureEvent__);
    byte_4CF0624 = 1;
  }
  v3 = (Gesture_EventHandler_o *)sub_1C7BD34(Gesture_EventHandler_TypeInfo);
