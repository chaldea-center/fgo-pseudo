        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C23CAD & 1) == 0 )
  {
    ...
    sub_1C3B764(&SwipeGesture_TypeInfo, v5);
    sub_1C3B764(&UICamera_TypeInfo, v6);
    sub_1C3B764(&StringLiteral_10156/*"PLAY_VOICE"*/, v7);
    byte_4C23CAD = 1;
  }
  if ( gesture )
  {
        ...
        if ( UnityEngine_Object__op_Inequality(startSelection, 0LL, 0LL) )
        {
          ...
          if ( UICamera__Raycast(v15, 0LL) )
          {
            ...
            UnityEngine_Component__SendMessage(
              v14,
              (System_String_o *)StringLiteral_10156/*"PLAY_VOICE"*/,
...
void __fastcall ScriptMessageGestureReciver__OnDestroy(ScriptMessageGestureReciver_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C23CAC & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_ScriptMessageGestureReciver_FingerGestures_OnGestureEvent__, v4);
    byte_4C23CAC = 1;
  }
