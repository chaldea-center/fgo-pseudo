        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B468B3 & 1) == 0 )
  {
    sub_1BDB878(&UnityEngine_Object_TypeInfo, gesture);
    sub_1BDB878(&SwipeGesture_TypeInfo, v5);
    sub_1BDB878(&UICamera_TypeInfo, v6);
    sub_1BDB878(&StringLiteral_9969/*"OnSwipeBlockPanel"*/, v7);
    byte_4B468B3 = 1;
  }
  if ( gesture )
  {
...
void __fastcall ScriptMessageGestureReciver__OnDestroy(ScriptMessageGestureReciver_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B468B2 & 1) == 0 )
  {
    sub_1BDB878(&Gesture_EventHandler_TypeInfo, method);
    sub_1BDB878(&FingerGestures_TypeInfo, v3);
    sub_1BDB878(&Method_ScriptMessageGestureReciver_FingerGestures_OnGestureEvent__, v4);
    byte_4B468B2 = 1;
  }
  v5 = (Gesture_EventHandler_o *)sub_1BDBAC4(Gesture_EventHandler_TypeInfo);
