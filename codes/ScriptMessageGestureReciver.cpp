        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0A861 & 1) == 0 )
  {
    ...
    sub_1B686D4(&SwipeGesture_TypeInfo, v5);
    sub_1B686D4(&UICamera_TypeInfo, v6);
    sub_1B686D4(&StringLiteral_9922/*"OnSwipeBlockPanel"*/, v7);
    byte_4A0A861 = 1;
  }
  if ( gesture )
  {
      ...
      if ( UnityEngine_Object__op_Inequality(swipCallback, 0LL, 0LL) )
      {
        ...
        if ( UnityEngine_Object__op_Inequality(startSelection, 0LL, 0LL) )
        {
          ...
          if ( UICamera__Raycast(v15, 0LL) )
          {
            ...
            if ( !v14 )
              sub_1B68930(0LL, v13);
            UnityEngine_Component__SendMessage(v14, (System_String_o *)StringLiteral_9922/*"OnSwipeBlockPanel"*/, (Il2CppObject *)gesture, 0LL);
          }
        }
      }
    }
...
void __fastcall ScriptMessageGestureReciver__OnDestroy(ScriptMessageGestureReciver_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0A860 & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_ScriptMessageGestureReciver_FingerGestures_OnGestureEvent__, v4);
    byte_4A0A860 = 1;
  }
