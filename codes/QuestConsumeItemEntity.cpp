    ...
    while ( 1 )
    {
      ...
      if ( ItemEntity__IsEnable((ItemEntity_o *)Instance, 0LL) )
      {
        ...
        *(_QWORD *)(Instance + 32) = v12;
        sub_1B76164((ServantStatusBattleListViewItem_o *)(Instance + 32), (int32_t)v12, v19, v20);
        if ( *(_DWORD *)(v21 + 24) <= 1u )
          goto LABEL_23;
        v24 = StringLiteral_43/*"\n"*/;
        *(_QWORD *)(v21 + 40) = StringLiteral_43/*"\n"*/;
        sub_1B76164((ServantStatusBattleListViewItem_o *)(v21 + 40), v24, v22, v23);
        if ( *(_DWORD *)(v21 + 24) <= 2u )
          goto LABEL_23;
        name = v17->fields.name;
        *(_QWORD *)(v21 + 48) = name;
        sub_1B76164((ServantStatusBattleListViewItem_o *)(v21 + 48), (int32_t)name, v25, v26);
        if ( *(_DWORD *)(v21 + 24) <= 3u )
          goto LABEL_23;
        v30 = (int)StringLiteral_117/*" "*/;
        *(_QWORD *)(v21 + 56) = StringLiteral_117/*" "*/;
        sub_1B76164((ServantStatusBattleListViewItem_o *)(v21 + 56), v30, v28, v29);
...
LABEL_23:
        ...
        *(_QWORD *)(v21 + 64) = Instance;
        sub_1B76164((ServantStatusBattleListViewItem_o *)(v21 + 64), Instance, v32, v33);
        v12 = System_String__Concat_61548588((System_String_array *)v21, 0LL);
      }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E37F & 1) == 0 )
  {
    ...
    sub_1B761C0(&QuestConsumeItemEntity_TypeInfo, v3);
    byte_4A2E37F = 1;
  }
  v4 = sub_1B7640C(QuestConsumeItemEntity_TypeInfo);
  QuestConsumeItemEntity___ctor((QuestConsumeItemEntity_o *)v4, v5);
  if ( !v4
    || (*(_DWORD *)(v4 + 16) = this->fields.questId,
        itemIds = this->fields.itemIds,
        *(_QWORD *)(v4 + 24) = itemIds,
        sub_1B76164((ServantStatusBattleListViewItem_o *)(v4 + 24), (int32_t)itemIds, v8, v9),
        (v11 = *(_QWORD *)(v4 + 24)) == 0) )
  {
    sub_1B7641C(v6, v7);
  }
  v12 = sub_1B76268(int___TypeInfo, *(unsigned int *)(v11 + 24));
  *(_QWORD *)(v4 + 32) = v12;
  sub_1B76164((ServantStatusBattleListViewItem_o *)(v4 + 32), v12, v13, v14);
