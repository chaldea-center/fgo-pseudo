    ...
    while ( 1 )
    {
      ...
      if ( ItemEntity__IsEnable((ItemEntity_o *)Instance, 0) )
      {
        ...
        *(_QWORD *)(Instance + 32) = v6;
        sub_2213A04((MissionNaviTransitionBoardItem_o *)(Instance + 32), (int32_t)v6, v13, v14, v15, v16, v17, v18);
        ...
        *(_QWORD *)(v19 + 48) = name;
        sub_2213A04((MissionNaviTransitionBoardItem_o *)(v19 + 48), (int32_t)name, v27, v28, v29, v30, v31, v32);
        if ( (*(_DWORD *)(v19 + 24) & 0xFFFFFFFC) == 0 )
          goto LABEL_23;
        v40 = (int)StringLiteral_113/*" "*/;
        *(_QWORD *)(v19 + 56) = StringLiteral_113/*" "*/;
        sub_2213A04((MissionNaviTransitionBoardItem_o *)(v19 + 56), v40, v34, v35, v36, v37, v38, v39);
...
LABEL_23:
        ...
        *(_QWORD *)(v19 + 64) = Instance;
        sub_2213A04((MissionNaviTransitionBoardItem_o *)(v19 + 64), Instance, v42, v43, v44, v45, v46, v47);
        v6 = System_String__Concat_75697120((System_String_array *)v19, 0);
      }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5970E8F & 1) == 0 )
  {
    ...
    sub_2213A60(&QuestConsumeItemEntity_TypeInfo);
    byte_5970E8F = 1;
  }
  v3 = sub_2213CCC(QuestConsumeItemEntity_TypeInfo);
  ...
  if ( !v3
    || (itemIds = this->fields.itemIds,
        ...
        *(_DWORD *)(v3 + 16) = questId,
        sub_2213A04((MissionNaviTransitionBoardItem_o *)(v3 + 24), (int32_t)itemIds, v7, v8, v9, v10, v11, v12),
        (v15 = *(_QWORD *)(v3 + 24)) == 0) )
  {
    sub_2213CDC(v5, v6);
  }
  v16 = sub_2213B20(int___TypeInfo, *(unsigned int *)(v15 + 24));
  *(_QWORD *)(v3 + 32) = v16;
  sub_2213A04((MissionNaviTransitionBoardItem_o *)(v3 + 32), v16, v17, v18, v19, v20, v21, v22);
