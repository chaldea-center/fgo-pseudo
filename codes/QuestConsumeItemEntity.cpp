        ...
        const MethodInfo *method)
{
  ...
  if ( (Instance & 1) != 0 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !itemIds )
        break;
      if ( v9 >= itemIds->max_length )
        goto LABEL_23;
      if ( !v7 )
        break;
      Instance = (int64_t)DataMasterBase_object__object__int___GetEntity(
                            v7,
                            itemIds->m_Items[v9 + 1],
      ...
      if ( ItemEntity__IsEnable((ItemEntity_o *)Instance, 0LL) )
      {
        ...
        *(_QWORD *)(Instance + 32) = v6;
        sub_1C21DDC((PartyOrganizationUtility_o *)(Instance + 32), (int64_t)v6, v13, v14, v15, v16, v17, v18);
        if ( *(_DWORD *)(v19 + 24) <= 1u )
          goto LABEL_23;
        v26 = StringLiteral_43/*"\n"*/;
        *(_QWORD *)(v19 + 40) = StringLiteral_43/*"\n"*/;
        sub_1C21DDC((PartyOrganizationUtility_o *)(v19 + 40), v26, v20, v21, v22, v23, v24, v25);
        if ( *(_DWORD *)(v19 + 24) <= 2u )
          goto LABEL_23;
        name = (int64_t)v11->fields.name;
        *(_QWORD *)(v19 + 48) = name;
        sub_1C21DDC((PartyOrganizationUtility_o *)(v19 + 48), name, v27, v28, v29, v30, v31, v32);
        if ( *(_DWORD *)(v19 + 24) <= 3u )
          goto LABEL_23;
        v40 = StringLiteral_117/*" "*/;
        *(_QWORD *)(v19 + 56) = StringLiteral_117/*" "*/;
        sub_1C21DDC((PartyOrganizationUtility_o *)(v19 + 56), (int64_t)v40, v34, v35, v36, v37, v38, v39);
        nums = this->fields.nums;
        if ( !nums )
          break;
        if ( v9 >= nums->max_length
          || (Instance = (int64_t)ItemEntity__GetCountText(v11, nums->m_Items[v9 + 1], 0LL), *(_DWORD *)(v19 + 24) <= 4u) )
        {
LABEL_23:
          sub_1C2209C(Instance, v4);
        }
        *(_QWORD *)(v19 + 64) = Instance;
        sub_1C21DDC((PartyOrganizationUtility_o *)(v19 + 64), Instance, v42, v43, v44, v45, v46, v47);
        v6 = System_String__Concat_63129004((System_String_array *)v19, 0LL);
      }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDC9C4 & 1) == 0 )
  {
    ...
    sub_1C21E38(&QuestConsumeItemEntity_TypeInfo);
    byte_4BDC9C4 = 1;
  }
  v3 = sub_1C22084(QuestConsumeItemEntity_TypeInfo);
  QuestConsumeItemEntity___ctor((QuestConsumeItemEntity_o *)v3, v4);
  if ( !v3
    || (*(_DWORD *)(v3 + 16) = this->fields.questId,
        itemIds = this->fields.itemIds,
        *(_QWORD *)(v3 + 24) = itemIds,
        sub_1C21DDC((PartyOrganizationUtility_o *)(v3 + 24), (int64_t)itemIds, v7, v8, v9, v10, v11, v12),
        (v14 = *(_QWORD *)(v3 + 24)) == 0) )
  {
    sub_1C22094(v5, v6);
  }
  v15 = sub_1C21EE0(int___TypeInfo, *(unsigned int *)(v14 + 24));
  *(_QWORD *)(v3 + 32) = v15;
  sub_1C21DDC((PartyOrganizationUtility_o *)(v3 + 32), v15, v16, v17, v18, v19, v20, v21);
