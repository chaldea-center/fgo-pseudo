    ...
    while ( 1 )
    {
      ...
      if ( ItemEntity__IsEnable((ItemEntity_o *)Instance, 0LL) )
      {
        ...
        *(_QWORD *)(Instance + 32) = v12;
        sub_1BC2FAC((CGThumbnailListItem_o *)(Instance + 32), (int32_t)v12, v15, v20);
        if ( *(_DWORD *)(v21 + 24) <= 1u )
          goto LABEL_23;
        v23 = StringLiteral_43/*"\n"*/;
        *(_QWORD *)(v21 + 40) = StringLiteral_43/*"\n"*/;
        sub_1BC2FAC((CGThumbnailListItem_o *)(v21 + 40), v23, v15, v22);
        if ( *(_DWORD *)(v21 + 24) <= 2u )
          goto LABEL_23;
        name = v18->fields.name;
        *(_QWORD *)(v21 + 48) = name;
        sub_1BC2FAC((CGThumbnailListItem_o *)(v21 + 48), (int32_t)name, v15, v24);
        if ( *(_DWORD *)(v21 + 24) <= 3u )
          goto LABEL_23;
        v27 = (int)StringLiteral_113/*" "*/;
        *(_QWORD *)(v21 + 56) = StringLiteral_113/*" "*/;
        sub_1BC2FAC((CGThumbnailListItem_o *)(v21 + 56), v27, v15, v26);
...
LABEL_23:
        ...
        *(_QWORD *)(v21 + 64) = Instance;
        sub_1BC2FAC((CGThumbnailListItem_o *)(v21 + 64), Instance, v15, v29);
        v12 = System_String__Concat_62389164((System_String_array *)v21, 0LL);
      }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B024F2 & 1) == 0 )
  {
    ...
    sub_1BC3008(&QuestConsumeItemEntity_TypeInfo, v3);
    byte_4B024F2 = 1;
  }
  v4 = sub_1BC3254(QuestConsumeItemEntity_TypeInfo);
  QuestConsumeItemEntity___ctor((QuestConsumeItemEntity_o *)v4, v5);
  if ( !v4
    || (*(_DWORD *)(v4 + 16) = this->fields.questId,
        itemIds = this->fields.itemIds,
        *(_QWORD *)(v4 + 24) = itemIds,
        sub_1BC2FAC((CGThumbnailListItem_o *)(v4 + 24), (int32_t)itemIds, v8, v9),
        (v11 = *(_QWORD *)(v4 + 24)) == 0) )
  {
    sub_1BC3264(v6, v7);
  }
  v12 = sub_1BC30B0(int___TypeInfo, *(unsigned int *)(v11 + 24));
  *(_QWORD *)(v4 + 32) = v12;
  sub_1BC2FAC((CGThumbnailListItem_o *)(v4 + 32), v12, v13, v14);
