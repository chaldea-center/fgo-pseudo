        ...
        const MethodInfo *method)
{
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.conditionCheck, (int32_t)conditionCheck, v9, v10);
  this->fields.trueCase = trueCase;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.trueCase, (int32_t)trueCase, v11, v12);
  this->fields.falseCase = falseCase;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.falseCase, (int32_t)falseCase, v13, v14);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA320 & 1) == 0 )
  {
    sub_1B640C8(&WarBoardConditionalJumpTask__Execute_d__6_TypeInfo, method);
    byte_49FA320 = 1;
  }
  v4 = sub_1B64314(WarBoardConditionalJumpTask__Execute_d__6_TypeInfo, method, v2);
...
void __fastcall WarBoardConditionalJumpTask__OnStart(WarBoardConditionalJumpTask_o *this, const MethodInfo *method)
{
  ...
  sub_1B6406C(p_runningTask, (int32_t)v9, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    if ( runningTask )
    {
      ...
      sub_1B6406C((ServantStatusBattleListViewItem_o *)p__2__current, (int32_t)v6, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  v6 = sub_1B640DC(&Method_WarBoardConditionalJumpTask__Execute_d__6_System_Collections_IEnumerator_Reset__);
  sub_1B641F0(v5, v6);
}
