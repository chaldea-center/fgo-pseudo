        ...
        const MethodInfo *method)
{
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.conditionCheck, (int32_t)conditionCheck, v9, v10);
  this->fields.trueCase = trueCase;
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.trueCase, (int32_t)trueCase, v11, v12);
  this->fields.falseCase = falseCase;
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.falseCase, (int32_t)falseCase, v13, v14);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFFD3B & 1) == 0 )
  {
    sub_1BC3008(&WarBoardConditionalJumpTask__Execute_d__6_TypeInfo, method);
    byte_4AFFD3B = 1;
  }
  v3 = sub_1BC3254(WarBoardConditionalJumpTask__Execute_d__6_TypeInfo);
...
void __fastcall WarBoardConditionalJumpTask__OnStart(WarBoardConditionalJumpTask_o *this, const MethodInfo *method)
{
  ...
  sub_1BC2FAC(p_runningTask, (int32_t)v9, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BC301C(&Method_WarBoardConditionalJumpTask__Execute_d__6_System_Collections_IEnumerator_Reset__);
  sub_1BC3130(v3, v4);
}
