...
int32_t __fastcall MyRoomData__getSvtFriendshipLv(MyRoomData_o *this, int32_t hSvtId, const MethodInfo *method)
{
  ...
  if ( (byte_4BF8E89 & 1) == 0 )
  {
    sub_1C2E12C(&Method_DataManager_GetMasterData_UserServantCollectionMaster___, *(_QWORD *)&hSvtId);
...
int32_t __fastcall MyRoomData__getUserFriendSum(MyRoomData_o *this, const MethodInfo *method)
{
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_2FD1830 *)Method_DataManager_GetMasterData_TblFriendMaster___)) == 0LL )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF8E84 & 1) == 0 )
  {
    sub_1C2E12C(&Method_DataManager_GetMasterData_UserExpMaster___, *(_QWORD *)&currentLv);
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_2FD1830 *)Method_DataManager_GetMasterData_UserExpMaster___)) == 0LL )
  {
...
System_Int32_array *__fastcall MyRoomData__getUsrSvtNum(MyRoomData_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)servantEquipSum = 0LL;
  v4 = (System_Int32_array *)sub_1C2E1D4(int___TypeInfo, 2LL);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38A7F90 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
...
void __fastcall MyRoomData__setUserInfoData(MyRoomData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BF8E83 & 1) == 0 )
  {
    sub_1C2E12C(&MstProfileData_TypeInfo, method);
    byte_4BF8E83 = 1;
  }
  lateExp = 0LL;
  exp = 0LL;
...
LABEL_25:
    sub_1C2E388(ExpInfo, v7);
  v14->fields.maxSvtNum = v15->fields.svtKeep;
  if ( v13 <= 1 )
LABEL_26:
    sub_1C2E390(ExpInfo, v7);
  ...
  ExpInfo = sub_1C2E0D0(&v14->fields.friendCode);
  v16 = *p_usrData;
  if ( !*p_usrData )
    goto LABEL_25;
  v17 = *p_mstInfoData;
