...
int32_t __fastcall MyRoomData__getSvtFriendshipLv(MyRoomData_o *this, int32_t hSvtId, const MethodInfo *method)
{
  ...
  if ( (byte_4A49A79 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataManager_GetMasterData_UserServantCollectionMaster___, *(_QWORD *)&hSvtId);
...
int32_t __fastcall MyRoomData__getUserFriendSum(MyRoomData_o *this, const MethodInfo *method)
{
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_2F6DCB8 *)Method_DataManager_GetMasterData_TblFriendMaster___)) == 0LL )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A49A74 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataManager_GetMasterData_UserExpMaster___, *(_QWORD *)&currentLv);
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_2F6DCB8 *)Method_DataManager_GetMasterData_UserExpMaster___)) == 0LL )
  {
...
System_Int32_array *__fastcall MyRoomData__getUsrSvtNum(MyRoomData_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)servantEquipSum = 0LL;
  v4 = (System_Int32_array *)sub_1B86460(int___TypeInfo, 2LL);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3839680 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
...
void __fastcall MyRoomData__setUserInfoData(MyRoomData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A49A73 & 1) == 0 )
  {
    sub_1B863B8(&MstProfileData_TypeInfo, method);
    byte_4A49A73 = 1;
  }
  lateExp = 0LL;
  exp = 0LL;
  ...
  v7 = (MstProfileData_o *)sub_1B86604(MstProfileData_TypeInfo);
  MstProfileData___ctor(v7, 0LL);
  this->fields.mstInfoData = v7;
  p_mstInfoData = &this->fields.mstInfoData;
  sub_1B8635C((CGThumbnailListItem_o *)p_mstInfoData, (int32_t)v7, v9, v10);
  if ( !*p_usrData )
    goto LABEL_25;
  ...
  *((_QWORD *)ExpInfo + 2) = name;
  sub_1B8635C((CGThumbnailListItem_o *)((char *)ExpInfo + 16), (int32_t)name, v13, v14);
  ExpInfo = *p_usrData;
  if ( !*p_usrData )
    goto LABEL_25;
  v16 = *p_mstInfoData;
...
LABEL_25:
    sub_1B86614(ExpInfo, v12);
  v24->fields.maxSvtNum = v25->fields.svtKeep;
  if ( v23 <= 1 )
LABEL_26:
    sub_1B8661C(ExpInfo, v12);
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&v24->fields.friendCode, (int32_t)friendCode, v21, v22);
  v27 = *p_usrData;
  if ( !*p_usrData )
    goto LABEL_25;
  v28 = *p_mstInfoData;
...
void __fastcall MyRoomData__setUsrData(MyRoomData_o *this, const MethodInfo *method)
{
  ...
  SelfUserGame = UserGameMaster__getSelfUserGame(0LL);
  this->fields.usrData = SelfUserGame;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.usrData, (int32_t)SelfUserGame, v4, v5);
}