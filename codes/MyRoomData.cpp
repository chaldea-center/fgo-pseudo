...
int32_t MyRoomData__getUserFriendSum(MyRoomData_o *this, const MethodInfo *method)
{
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_385636C *)Method_DataManager_GetMasterData_TblFriendMaster___)) == 0 )
  {
...
UserExpEntity_o *MyRoomData__getUsrNextExpData(MyRoomData_o *this, int32_t currentLv, const MethodInfo *method)
{
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_385636C *)Method_DataManager_GetMasterData_UserExpMaster___)) == 0 )
  {
...
void MyRoomData__setUserInfoData(MyRoomData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596B938 & 1) == 0 )
  {
    sub_2213A60(&MstProfileData_TypeInfo);
    byte_596B938 = 1;
  }
  exp = 0;
  lateExp = 0;
  ...
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields.usrData, (int32_t)SelfUserGame, v5, v6, v7, v8, v9, v10);
  v11 = (MstProfileData_o *)sub_2213CCC(MstProfileData_TypeInfo);
  MstProfileData___ctor(v11, 0);
  this->fields.mstInfoData = v11;
  p_mstInfoData = &this->fields.mstInfoData;
  sub_2213A04((MissionNaviTransitionBoardItem_o *)p_mstInfoData, (int32_t)v11, v13, v14, v15, v16, v17, v18);
  if ( !*p_usrData )
    goto LABEL_25;
  ...
  *(_QWORD *)(ActiveUserEquipId + 16) = name;
  sub_2213A04((MissionNaviTransitionBoardItem_o *)(ActiveUserEquipId + 16), (int32_t)name, v21, v22, v23, v24, v25, v26);
...
LABEL_25:
    sub_2213CDC(ActiveUserEquipId, v20);
  v44->fields.maxSvtNum = v45->fields.svtKeep;
  if ( v43 == 1 )
LABEL_26:
    sub_2213CE4(ActiveUserEquipId);
