...
int32_t MyRoomData__getUserFriendSum(MyRoomData_o *this, const MethodInfo *method)
{
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_313B368 *)Method_DataManager_GetMasterData_TblFriendMaster___)) == 0 )
  {
...
UserExpEntity_o *MyRoomData__getUsrNextExpData(MyRoomData_o *this, int32_t currentLv, const MethodInfo *method)
{
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_313B368 *)Method_DataManager_GetMasterData_UserExpMaster___)) == 0 )
  {
...
void MyRoomData__setUserInfoData(MyRoomData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB170E & 1) == 0 )
  {
    sub_1C6BA08(&MstProfileData_TypeInfo);
    byte_4CB170E = 1;
  }
  lateExp = 0;
  exp = 0;
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.usrData, (int32_t)SelfUserGame, v5, v6);
  v7 = (MstProfileData_o *)sub_1C6BC54(MstProfileData_TypeInfo);
  MstProfileData___ctor(v7, 0);
  this->fields.mstInfoData = v7;
  p_mstInfoData = &this->fields.mstInfoData;
  sub_1C6B9AC((CGThumbnailListItem_o *)p_mstInfoData, (int32_t)v7, v9, v10);
  if ( !*p_usrData )
    goto LABEL_25;
  ...
  *((_QWORD *)ExpInfo + 2) = name;
  sub_1C6B9AC((CGThumbnailListItem_o *)((char *)ExpInfo + 16), (int32_t)name, v13, v14);
  ExpInfo = *p_usrData;
  if ( !*p_usrData )
    goto LABEL_25;
  v16 = *p_mstInfoData;
...
LABEL_26:
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&v24->fields.friendCode, (int32_t)friendCode, v21, v22);
  v27 = *p_usrData;
  if ( !*p_usrData )
    goto LABEL_25;
  v28 = *p_mstInfoData;
