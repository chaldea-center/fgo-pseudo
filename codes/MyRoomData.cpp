...
int32_t MyRoomData__getUserFriendSum(MyRoomData_o *this, const MethodInfo *method)
{
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_314B10C *)Method_DataManager_GetMasterData_TblFriendMaster___)) == 0 )
  {
...
UserExpEntity_o *MyRoomData__getUsrNextExpData(MyRoomData_o *this, int32_t currentLv, const MethodInfo *method)
{
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_314B10C *)Method_DataManager_GetMasterData_UserExpMaster___)) == 0 )
  {
...
void MyRoomData__setUserInfoData(MyRoomData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC281B & 1) == 0 )
  {
    sub_1C713B0(&MstProfileData_TypeInfo);
    byte_4CC281B = 1;
  }
  lateExp = 0;
  exp = 0;
  ...
  sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.usrData, (int32_t)SelfUserGame, v5, v6, v7, v8, v9, v10);
  v11 = (MstProfileData_o *)sub_1C715FC(MstProfileData_TypeInfo);
  MstProfileData___ctor(v11, 0);
  this->fields.mstInfoData = v11;
  p_mstInfoData = &this->fields.mstInfoData;
  sub_1C71354((GrandQuestFolderBoardItem_o *)p_mstInfoData, (int32_t)v11, v13, v14, v15, v16, v17, v18);
  if ( !*p_usrData )
    goto LABEL_25;
  ...
  *((_QWORD *)ExpInfo + 2) = name;
  sub_1C71354((GrandQuestFolderBoardItem_o *)((char *)ExpInfo + 16), (int32_t)name, v21, v22, v23, v24, v25, v26);
  ExpInfo = *p_usrData;
  if ( !*p_usrData )
    goto LABEL_25;
  v28 = *p_mstInfoData;
...
LABEL_26:
  ...
  sub_1C71354((GrandQuestFolderBoardItem_o *)&v40->fields.friendCode, (int32_t)friendCode, v33, v34, v35, v36, v37, v38);
  v43 = *p_usrData;
  if ( !*p_usrData )
    goto LABEL_25;
  v44 = *p_mstInfoData;
