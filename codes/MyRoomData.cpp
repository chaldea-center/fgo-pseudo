...
int32_t __fastcall MyRoomData__getSvtFriendshipLv(MyRoomData_o *this, int32_t hSvtId, const MethodInfo *method)
{
  ...
  if ( (byte_4A1B3E2 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataManager_GetMasterData_UserServantCollectionMaster___, *(_QWORD *)&hSvtId);
...
int32_t __fastcall MyRoomData__getUserFriendSum(MyRoomData_o *this, const MethodInfo *method)
{
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_2E5B3E8 *)Method_DataManager_GetMasterData_TblFriendMaster___)) == 0LL )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1B3DD & 1) == 0 )
  {
    sub_1B715CC(&Method_DataManager_GetMasterData_UserExpMaster___, *(_QWORD *)&currentLv);
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_2E5B3E8 *)Method_DataManager_GetMasterData_UserExpMaster___)) == 0LL )
  {
...
System_Int32_array *__fastcall MyRoomData__getUsrSvtNum(MyRoomData_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)servantEquipSum = 0LL;
  v4 = (System_Int32_array *)sub_1B71674(int___TypeInfo, 2LL);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
...
void __fastcall MyRoomData__setUserInfoData(MyRoomData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1B3DC & 1) == 0 )
  {
    sub_1B715CC(&MstProfileData_TypeInfo, method);
    byte_4A1B3DC = 1;
  }
  lateExp = 0LL;
  exp = 0LL;
...
LABEL_25:
    sub_1B71828(ExpInfo, v7);
  v14->fields.maxSvtNum = v15->fields.svtKeep;
  if ( v13 <= 1 )
LABEL_26:
    sub_1B71830(ExpInfo, v7);
  ...
  ExpInfo = sub_1B71570(&v14->fields.friendCode);
  v16 = *p_usrData;
  if ( !*p_usrData )
    goto LABEL_25;
  v17 = *p_mstInfoData;
