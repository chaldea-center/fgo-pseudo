...
int32_t __fastcall MyRoomData__getUserFriendSum(MyRoomData_o *this, const MethodInfo *method)
{
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_2FAFE04 *)Method_DataManager_GetMasterData_TblFriendMaster___)) == 0LL )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_2FAFE04 *)Method_DataManager_GetMasterData_UserExpMaster___)) == 0LL )
  {
...
System_Int32_array *__fastcall MyRoomData__getUsrSvtNum(MyRoomData_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)servantEquipSum = 0LL;
  v2 = (System_Int32_array *)sub_1C21EE0(int___TypeInfo, 2LL);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_388D058 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
...
void __fastcall MyRoomData__setUserInfoData(MyRoomData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD7CD7 & 1) == 0 )
  {
    sub_1C21E38(&MstProfileData_TypeInfo);
    byte_4BD7CD7 = 1;
  }
  lateExp = 0LL;
  exp = 0LL;
  ...
  v5 = (MstProfileData_o *)sub_1C22084(MstProfileData_TypeInfo);
  MstProfileData___ctor(v5, 0LL);
  this->fields.mstInfoData = v5;
  p_mstInfoData = &this->fields.mstInfoData;
  ExpInfo = sub_1C21DDC(p_mstInfoData, v5);
  if ( !*p_usrData )
    goto LABEL_25;
...
LABEL_25:
    sub_1C22094(ExpInfo, v8);
  v16->fields.maxSvtNum = v17->fields.svtKeep;
  if ( v15 <= 1 )
LABEL_26:
    sub_1C2209C(ExpInfo, v8);
  ...
  ExpInfo = sub_1C21DDC(&v16->fields.friendCode, friendCode);
  v19 = *p_usrData;
  if ( !*p_usrData )
    goto LABEL_25;
  v20 = *p_mstInfoData;
