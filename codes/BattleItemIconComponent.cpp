void __fastcall BattleItemIconComponent___ctor(BattleItemIconComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B692AC & 1) == 0 )
  {
    sub_1BE4ACC(&ItemIconComponent_TypeInfo, method);
    sub_1BE4ACC(&StringLiteral_855/*"+"*/, v3);
    byte_4B692AC = 1;
  }
  this->fields.addCountColor.fields.rgba = sub_2380040(0LL, 1.0, 0.92157, 0.015686, 1.0);
  v4 = StringLiteral_855/*"+"*/;
  this->fields.addCountStr = (struct System_String_o *)StringLiteral_855/*"+"*/;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.addCountStr, v4, v5, v6, v7, v8, v9, v10);
  this->fields.nowAddCountColor.fields.rgba = sub_2380040(0LL, 1.0, 0.92157, 0.015686, 1.0);
        ...
        const MethodInfo *method)
{
  ...
  this->fields.nowAddCountColor.fields.rgba = sub_2380040(
                                                0LL,
                                                r
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B692AB & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_25450/*"{0}{1:#,0}\n[{2}]({3}{4:#,0})[-]"*/, v11);
    sub_1BE4ACC(&StringLiteral_16233/*"[{0}]({1}{2:#,0})[-]"*/, v12);
    sub_1BE4ACC(&StringLiteral_25449/*"{0}{1:#,0}"*/, v13);
  ...
  if ( count > 99 || addCount >= 100 )
  {
    ...
    v29 = (int64_t)v27;
    v17 = (UILabel_o *)sub_1BE4B74(object___TypeInfo, 5LL);
    if ( !v17 )
      goto LABEL_36;
    v36 = v17;
    if ( !v26 || (v17 = (UILabel_o *)sub_1BE4C08(v26, v17->klass->_1.element_class)) != 0LL )
    {
      if ( !LODWORD(v36->fields.m_CancellationTokenSource) )
        goto LABEL_37;
      v36->fields.leftAnchor = (struct UIRect_AnchorPoint_o *)v26;
      sub_1BE4A70((PartyOrganizationUtility_o *)&v36->fields.leftAnchor, v26, v30, v31, v32, v33, v34, v35);
      v85 = count;
      v17 = (UILabel_o *)j_il2cpp_value_box_0(int_TypeInfo, &v85, v37, v38, v39);
      v46 = (int64_t)v17;
      if ( !v17 || (v17 = (UILabel_o *)sub_1BE4C08(v17, v36->klass->_1.element_class)) != 0LL )
      {
        if ( LODWORD(v36->fields.m_CancellationTokenSource) <= 1 )
          goto LABEL_37;
        v36->fields.rightAnchor = (struct UIRect_AnchorPoint_o *)v46;
        sub_1BE4A70((PartyOrganizationUtility_o *)&v36->fields.rightAnchor, v46, v40, v41, v42, v43, v44, v45);
        if ( !v29 || (v17 = (UILabel_o *)sub_1BE4C08(v29, v36->klass->_1.element_class)) != 0LL )
        {
          if ( LODWORD(v36->fields.m_CancellationTokenSource) <= 2 )
            goto LABEL_37;
          v36->fields.bottomAnchor = (struct UIRect_AnchorPoint_o *)v29;
          sub_1BE4A70((PartyOrganizationUtility_o *)&v36->fields.bottomAnchor, v29, v47, v48, v49, v50, v51, v52);
          addCountStr = this->fields.addCountStr;
          if ( !addCountStr || (v17 = (UILabel_o *)sub_1BE4C08(addCountStr, v36->klass->_1.element_class)) != 0LL )
          {
            ...
            if ( !v17 || (v17 = (UILabel_o *)sub_1BE4C08(v17, v36->klass->_1.element_class)) != 0LL )
            {
              if ( LODWORD(v36->fields.m_CancellationTokenSource) > 4 )
              {
                *(_QWORD *)&v36->fields.updateAnchors = v69;
                sub_1BE4A70((PartyOrganizationUtility_o *)&v36->fields.updateAnchors, v69, v63, v64, v65, v66, v67, v68);
                v17 = (UILabel_o *)System_String__Format_62713316(
                                     (System_String_o *)StringLiteral_25450/*"{0}{1:#,0}\n[{2}]({3}{4:#,0})[-]"*/,
...
LABEL_37:
  ...
  else
  {
    ...
    v17 = (UILabel_o *)System_String__Format_62713180((System_String_o *)StringLiteral_25449/*"{0}{1:#,0}"*/, v22, v23, 0LL);
...
LABEL_36:
  ...
  if ( addCount >= 1 )
  {
    ...
    v82 = System_String__Format_62713248((System_String_o *)StringLiteral_16233/*"[{0}]({1}{2:#,0})[-]"*/, v77, v76, v81, 0LL);
    v70 = System_String__Concat_62698808(mText, v82, 0LL);
    v71 = v72;
    goto LABEL_34;
  }
}