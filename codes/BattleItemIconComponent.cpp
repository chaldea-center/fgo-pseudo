void BattleItemIconComponent___ctor(BattleItemIconComponent_o *this, const MethodInfo *method)
{
  ...
  LODWORD(v2) = 1.0;
  LODWORD(v3) = 1.0;
  this->fields.addCountColor.fields.rgba = sub_2531AB4(0, v2, v4, v5, v3);
  v7 = StringLiteral_803/*"+"*/;
  this->fields.addCountStr = (struct System_String_o *)StringLiteral_803/*"+"*/;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.addCountStr, v7, v8, v9);
  LODWORD(v10) = 1.0;
  LODWORD(v11) = 1.0;
  this->fields.nowAddCountColor.fields.rgba = sub_2531AB4(0, v10, v4, v5, v11);
        ...
        const MethodInfo *method)
{
  ...
  *(float *)&v12 = a * (float)((float)HIBYTE(rgba) / 255.0);
  this->fields.nowAddCountColor.fields.rgba = sub_2531AB4(0, v9, v10, v11, v12);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C598B2 & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_25226/*"{0}{1:#,0}\n[{2}]({3}{4:#,0})[-]"*/);
    sub_1C3E564(&StringLiteral_16027/*"[{0}]({1}{2:#,0})[-]"*/);
  ...
  if ( count > 99 || addCount >= 100 )
  {
    ...
    v26 = v24;
    v11 = (UILabel_o *)sub_1C3E60C(object___TypeInfo, 5);
    if ( !v11 )
      goto LABEL_36;
    v29 = v11;
    if ( !v23 || (v11 = (UILabel_o *)sub_1C3E6A0(v23, v11->klass->_1.element_class)) != 0 )
    {
      if ( !LODWORD(v29->fields.m_CancellationTokenSource) )
        goto LABEL_37;
      v29->fields.leftAnchor = (struct UIRect_AnchorPoint_o *)v23;
      sub_1C3E508((CGThumbnailListItem_o *)&v29->fields.leftAnchor, (int32_t)v23, v27, v28);
      v71 = count;
      v11 = (UILabel_o *)j_il2cpp_value_box_0(int_TypeInfo, &v71, v30, v31, v32, v33, v34, v35);
      v38 = v11;
      if ( !v11 || (v11 = (UILabel_o *)sub_1C3E6A0(v11, v29->klass->_1.element_class)) != 0 )
      {
        if ( LODWORD(v29->fields.m_CancellationTokenSource) <= 1 )
          goto LABEL_37;
        v29->fields.rightAnchor = (struct UIRect_AnchorPoint_o *)v38;
        sub_1C3E508((CGThumbnailListItem_o *)&v29->fields.rightAnchor, (int32_t)v38, v36, v37);
        if ( !v26 || (v11 = (UILabel_o *)sub_1C3E6A0(v26, v29->klass->_1.element_class)) != 0 )
        {
          if ( LODWORD(v29->fields.m_CancellationTokenSource) <= 2 )
            goto LABEL_37;
          v29->fields.bottomAnchor = (struct UIRect_AnchorPoint_o *)v26;
          sub_1C3E508((CGThumbnailListItem_o *)&v29->fields.bottomAnchor, (int32_t)v26, v39, v40);
          addCountStr = this->fields.addCountStr;
          if ( !addCountStr || (v11 = (UILabel_o *)sub_1C3E6A0(addCountStr, v29->klass->_1.element_class)) != 0 )
          {
            if ( LODWORD(v29->fields.m_CancellationTokenSource) <= 3 )
              goto LABEL_37;
            v29->fields.topAnchor = (struct UIRect_AnchorPoint_o *)addCountStr;
            sub_1C3E508((CGThumbnailListItem_o *)&v29->fields.topAnchor, (int32_t)addCountStr, v41, v42);
            v70 = addCount;
            v11 = (UILabel_o *)j_il2cpp_value_box_0(int_TypeInfo, &v70, v44, v45, v46, v47, v48, v49);
            v52 = v11;
            if ( !v11 || (v11 = (UILabel_o *)sub_1C3E6A0(v11, v29->klass->_1.element_class)) != 0 )
            {
              if ( LODWORD(v29->fields.m_CancellationTokenSource) > 4 )
              {
                *(_QWORD *)&v29->fields.updateAnchors = v52;
                sub_1C3E508((CGThumbnailListItem_o *)&v29->fields.updateAnchors, (int32_t)v52, v50, v51);
                v11 = (UILabel_o *)System_String__Format_63677896(
                                     (System_String_o *)StringLiteral_25226/*"{0}{1:#,0}\n[{2}]({3}{4:#,0})[-]"*/,
                                     (System_Object_array *)v29,
                                     0);
                if ( !v25 )
                  goto LABEL_36;
                v53 = (System_String_o *)v11;
                v54 = v25;
LABEL_34:
...
LABEL_37:
  ...
  else
  {
    ...
    v71 = count;
    v20 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v71, v12, v13, v14, v15, v16, v17);
    v11 = (UILabel_o *)System_String__Format_63677760((System_String_o *)StringLiteral_25225/*"{0}{1:#,0}"*/, v19, v20, 0);
    v10 = (System_String_o *)v11;
    if ( !v18 )
LABEL_36:
      sub_1C3E7C0(v11, v10);
  }
  UILabel__set_text(v18, v10, 0);
  if ( addCount >= 1 )
  {
    ...
    v68 = System_String__Format_63677828((System_String_o *)StringLiteral_16027/*"[{0}]({1}{2:#,0})[-]"*/, v60, v59, v67, 0);
    v53 = System_String__Concat_63636468(mText, v68, 0);
    v54 = v55;
    goto LABEL_34;
  }
}