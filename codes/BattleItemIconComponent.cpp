void __fastcall BattleItemIconComponent___ctor(BattleItemIconComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0B250 & 1) == 0 )
  {
    sub_1B686D4(&ItemIconComponent_TypeInfo, method);
    sub_1B686D4(&StringLiteral_860/*"+"*/, v3);
    byte_4A0B250 = 1;
  }
  this->fields.addCountColor.fields.rgba = sub_226FAA8(0LL, 1.0, 0.92157, 0.015686, 1.0);
  v4 = StringLiteral_860/*"+"*/;
  this->fields.addCountStr = (struct System_String_o *)StringLiteral_860/*"+"*/;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.addCountStr, v4, v5, v6);
  this->fields.nowAddCountColor.fields.rgba = sub_226FAA8(0LL, 1.0, 0.92157, 0.015686, 1.0);
        ...
        const MethodInfo *method)
{
  ...
  this->fields.nowAddCountColor.fields.rgba = sub_226FAA8(
                                                0LL,
                                                r
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0B24F & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_25022/*"{0}{1:#,0}\n[{2}]({3}{4:#,0})[-]"*/, v11);
    sub_1B686D4(&StringLiteral_15960/*"[{0}]({1}{2:#,0})[-]"*/, v12);
    sub_1B686D4(&StringLiteral_25021/*"{0}{1:#,0}"*/, v13);
  ...
  if ( count > 99 || addCount >= 100 )
  {
    ...
    v29 = v27;
    v17 = (UILabel_o *)sub_1B6877C(object___TypeInfo, 5LL);
    if ( !v17 )
      goto LABEL_36;
    v32 = v17;
    if ( !v26 || (v17 = (UILabel_o *)sub_1B68810(v26, v17->klass->_1.element_class)) != 0LL )
    {
      if ( !LODWORD(v32->fields.m_CancellationTokenSource) )
        goto LABEL_37;
      v32->fields.leftAnchor = (struct UIRect_AnchorPoint_o *)v26;
      sub_1B68678((ServantStatusBattleListViewItem_o *)&v32->fields.leftAnchor, (int32_t)v26, v30, v31);
      v65 = count;
      v17 = (UILabel_o *)j_il2cpp_value_box_0(int_TypeInfo, &v65, v33, v34, v35);
      v38 = v17;
      if ( !v17 || (v17 = (UILabel_o *)sub_1B68810(v17, v32->klass->_1.element_class)) != 0LL )
      {
        if ( LODWORD(v32->fields.m_CancellationTokenSource) <= 1 )
          goto LABEL_37;
        v32->fields.rightAnchor = (struct UIRect_AnchorPoint_o *)v38;
        sub_1B68678((ServantStatusBattleListViewItem_o *)&v32->fields.rightAnchor, (int32_t)v38, v36, v37);
        if ( !v29 || (v17 = (UILabel_o *)sub_1B68810(v29, v32->klass->_1.element_class)) != 0LL )
        {
          if ( LODWORD(v32->fields.m_CancellationTokenSource) <= 2 )
            goto LABEL_37;
          v32->fields.bottomAnchor = (struct UIRect_AnchorPoint_o *)v29;
          sub_1B68678((ServantStatusBattleListViewItem_o *)&v32->fields.bottomAnchor, (int32_t)v29, v39, v40);
          addCountStr = this->fields.addCountStr;
          if ( !addCountStr || (v17 = (UILabel_o *)sub_1B68810(addCountStr, v32->klass->_1.element_class)) != 0LL )
          {
            if ( LODWORD(v32->fields.m_CancellationTokenSource) <= 3 )
              goto LABEL_37;
            v32->fields.topAnchor = (struct UIRect_AnchorPoint_o *)addCountStr;
            sub_1B68678((ServantStatusBattleListViewItem_o *)&v32->fields.topAnchor, (int32_t)addCountStr, v41, v42);
            v64 = addCount;
            ...
            if ( !v17 || (v17 = (UILabel_o *)sub_1B68810(v17, v32->klass->_1.element_class)) != 0LL )
            {
              if ( LODWORD(v32->fields.m_CancellationTokenSource) > 4 )
              {
                *(_QWORD *)&v32->fields.updateAnchors = v49;
                sub_1B68678((ServantStatusBattleListViewItem_o *)&v32->fields.updateAnchors, (int32_t)v49, v47, v48);
                v17 = (UILabel_o *)System_String__Format_61433976(
                                     (System_String_o *)StringLiteral_25022/*"{0}{1:#,0}\n[{2}]({3}{4:#,0})[-]"*/,
...
LABEL_37:
  ...
  else
  {
    ...
    v17 = (UILabel_o *)System_String__Format_61433840((System_String_o *)StringLiteral_25021/*"{0}{1:#,0}"*/, v22, v23, 0LL);
...
LABEL_36:
  ...
  if ( addCount >= 1 )
  {
    ...
    v62 = System_String__Format_61433908((System_String_o *)StringLiteral_15960/*"[{0}]({1}{2:#,0})[-]"*/, v57, v56, v61, 0LL);
    v50 = System_String__Concat_61419468(mText, v62, 0LL);
    v51 = v52;
    goto LABEL_34;
  }
}