        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48323 & 1) == 0 )
  {
    ...
    sub_1BDB878(&ClassBoardResourceContents_TypeInfo, v3);
    byte_4B48323 = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
  v4 = (Il2CppObject *)sub_1BDBAC4(ClassBoardResourceContents_TypeInfo);
  System_Object___ctor(v4, 0LL);
  this->fields._Contents_k__BackingField = (struct ClassBoardResourceContents_o *)v4;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields._Contents_k__BackingField, (int32_t)v4, v5, v6);
  v7 = (AssetStorageLoadWrapper_o *)sub_1BDBAC4(AssetStorageLoadWrapper_TypeInfo);
...
Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_o __fastcall ClassBoardResourceCatalogAssetBundle__GetObject___Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_302754C *method)
{
  __int64 v4; // x4
  __int64 v5; // x20
  __int64 v8; // x8
...
Il2CppObject *__fastcall ClassBoardResourceCatalogAssetBundle__GetObject_object_(
        ...
        AssetData_o *assetData,
        System_String_o *name,
        const MethodInfo_3027488 *method)
{
  __int64 v7; // x1
  ...
  {
    sub_1BDB878(&Method_AssetData_GetObject_GameObject____77074016, assetData);
    this = (ClassBoardResourceCatalogAssetBundle_o *)sub_1BDB878(&UnityEngine_Object_TypeInfo, v7);
    if ( !method->rgctx_data )
      this = (ClassBoardResourceCatalogAssetBundle_o *)sub_1C2BF64();
  }
  if ( !assetData )
    goto LABEL_11;
  Object_object__50417328 = AssetData__GetObject_object__50417328(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48328 & 1) == 0 )
  {
    sub_1BDB878(&Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardBlank___, *(_QWORD *)&assetId);
    sub_1BDB878(&StringLiteral_4505/*"ClassBoardBlank"*/, v4);
    byte_4B48328 = 1;
  }
  mainAssetData = this->fields.mainAssetData;
  v6 = System_Int32__ToString((int32_t)&v9, 0LL);
  v7 = System_String__Concat_62572260((System_String_o *)StringLiteral_4505/*"ClassBoardBlank"*/, v6, 0LL);
  return (ClassBoardBlank_o *)ClassBoardResourceCatalogAssetBundle__GetObject_object_(
                                this,
                                mainAssetData,
                                v7,
                                (const MethodInfo_3027488 *)Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardBlank___);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardBlank___, *(_QWORD *)&assetId);
    sub_1BDB878(&StringLiteral_7139/*"GrandClassBoardBlank"*/, v4);
    byte_4B4832B = 1;
  }
  mainAssetData = this->fields.mainAssetData;
  v6 = System_Int32__ToString((int32_t)&v9, 0LL);
  v7 = System_String__Concat_62572260((System_String_o *)StringLiteral_7139/*"GrandClassBoardBlank"*/, v6, 0LL);
  return (ClassBoardBlank_o *)ClassBoardResourceCatalogAssetBundle__GetObject_object_(
                                this,
                                mainAssetData,
                                v7,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4832C & 1) == 0 )
  {
    sub_1BDB878(&Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardLock___, *(_QWORD *)&assetId);
    sub_1BDB878(&StringLiteral_7141/*"GrandClassBoardLock"*/, v4);
    byte_4B4832C = 1;
  }
  mainAssetData = this->fields.mainAssetData;
  v6 = System_Int32__ToString((int32_t)&v9, 0LL);
  v7 = System_String__Concat_62572260((System_String_o *)StringLiteral_7141/*"GrandClassBoardLock"*/, v6, 0LL);
  return (ClassBoardLock_o *)ClassBoardResourceCatalogAssetBundle__GetObject_object_(
                               this,
                               mainAssetData,
                               v7,
                               (const MethodInfo_3027488 *)Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardLock___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4832A & 1) == 0 )
  {
    sub_1BDB878(&Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardSquare___, *(_QWORD *)&assetId);
    sub_1BDB878(&StringLiteral_7142/*"GrandClassBoardSquare"*/, v4);
    byte_4B4832A = 1;
  }
  mainAssetData = this->fields.mainAssetData;
  v6 = System_Int32__ToString((int32_t)&v9, 0LL);
  v7 = System_String__Concat_62572260((System_String_o *)StringLiteral_7142/*"GrandClassBoardSquare"*/, v6, 0LL);
  return (ClassBoardSquare_o *)ClassBoardResourceCatalogAssetBundle__GetObject_object_(
                                 this,
                                 mainAssetData,
                                 v7,
                                 (const MethodInfo_3027488 *)Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardSquare___);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardLock___, *(_QWORD *)&assetId);
    sub_1BDB878(&StringLiteral_4509/*"ClassBoardLock"*/, v4);
    byte_4B48329 = 1;
  }
  mainAssetData = this->fields.mainAssetData;
  v6 = System_Int32__ToString((int32_t)&v9, 0LL);
  v7 = System_String__Concat_62572260((System_String_o *)StringLiteral_4509/*"ClassBoardLock"*/, v6, 0LL);
  return (ClassBoardLock_o *)ClassBoardResourceCatalogAssetBundle__GetObject_object_(
                               this,
                               mainAssetData,
                               v7,
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardSquare___, *(_QWORD *)&assetId);
    sub_1BDB878(&StringLiteral_4516/*"ClassBoardSquare"*/, v4);
    byte_4B48327 = 1;
  }
  mainAssetData = this->fields.mainAssetData;
  v6 = System_Int32__ToString((int32_t)&v9, 0LL);
  v7 = System_String__Concat_62572260((System_String_o *)StringLiteral_4516/*"ClassBoardSquare"*/, v6, 0LL);
  return (ClassBoardSquare_o *)ClassBoardResourceCatalogAssetBundle__GetObject_object_(
                                 this,
                                 mainAssetData,
                                 v7,
        ...
        const MethodInfo *method)
{
  ...
  char *Object_object__50417328; // x0
  ...
  if ( (byte_4B48325 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardBackground___, v3);
    sub_1BDB878(&Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardBlank___, v4);
    sub_1BDB878(&Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardDisableOpenDialog___, v5);
    sub_1BDB878(&Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardFigureController___, v6);
    sub_1BDB878(&Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardFullReleaseEffectComponent___, v7);
    sub_1BDB878(&Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardLine___, v8);
    sub_1BDB878(&Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardLockOpenConfirmDialog___, v9);
    sub_1BDB878(&Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardLockReleaseConditionDialog___, v10);
    sub_1BDB878(&Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardLock___, v11);
    sub_1BDB878(&Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardQuestOpenConfirmDialog___, v12);
    sub_1BDB878(&Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardSquareDetailDialog___, v13);
    sub_1BDB878(&Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardSquareOpenConfirmDialog___, v14);
    sub_1BDB878(&Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardSquare___, v15);
    sub_1BDB878(&Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardUIController___, v16);
    sub_1BDB878(&StringLiteral_4504/*"ClassBoardBg"*/, v17);
    sub_1BDB878(&StringLiteral_4511/*"ClassBoardLockReleaseConditionDialog"*/, v18);
    sub_1BDB878(&StringLiteral_4508/*"ClassBoardLine"*/, v19);
    sub_1BDB878(&StringLiteral_6900/*"FullReleaseEffectClassScore"*/, v20);
    sub_1BDB878(&StringLiteral_4517/*"ClassBoardSquareDetailDialog"*/, v21);
    sub_1BDB878(&StringLiteral_4509/*"ClassBoardLock"*/, v22);
    sub_1BDB878(&StringLiteral_4515/*"ClassBoardSelectView"*/, v23);
    sub_1BDB878(&StringLiteral_7141/*"GrandClassBoardLock"*/, v24);
    sub_1BDB878(&StringLiteral_6855/*"ForwardIconAnimObject"*/, v25);
    sub_1BDB878(&StringLiteral_6901/*"FullReleaseEffectGrandScore"*/, v26);
    sub_1BDB878(&StringLiteral_7139/*"GrandClassBoardBlank"*/, v27);
    sub_1BDB878(&StringLiteral_4505/*"ClassBoardBlank"*/, v28);
    sub_1BDB878(&StringLiteral_4506/*"ClassBoardDisableOpenDialog"*/, v29);
    sub_1BDB878(&StringLiteral_4510/*"ClassBoardLockOpenConfirmDialog"*/, v30);
    sub_1BDB878(&StringLiteral_4516/*"ClassBoardSquare"*/, v31);
    sub_1BDB878(&StringLiteral_4507/*"ClassBoardFigure"*/, v32);
    sub_1BDB878(&StringLiteral_4518/*"ClassBoardSquareOpenConfirmDialog"*/, v33);
    sub_1BDB878(&StringLiteral_7142/*"GrandClassBoardSquare"*/, v34);
    sub_1BDB878(&StringLiteral_7140/*"GrandClassBoardLine"*/, v35);
    sub_1BDB878(&StringLiteral_4519/*"ClassBoardUI"*/, v36);
    sub_1BDB878(&StringLiteral_4512/*"ClassBoardQuestOpenConfirmDialog"*/, v37);
    byte_4B48325 = 1;
  }
  Object_object = ClassBoardResourceCatalogAssetBundle__GetObject_object_(
                    this,
                    this->fields.mainAssetData,
                    (System_String_o *)StringLiteral_4516/*"ClassBoardSquare"*/,
                    (const MethodInfo_3027488 *)Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardSquare___);
  v39 = ClassBoardResourceCatalogAssetBundle__GetObject_object_(
          this,
          this->fields.mainAssetData,
          (System_String_o *)StringLiteral_4508/*"ClassBoardLine"*/,
          (const MethodInfo_3027488 *)Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardLine___);
  v40 = ClassBoardResourceCatalogAssetBundle__GetObject_object_(
          this,
          this->fields.mainAssetData,
          (System_String_o *)StringLiteral_4509/*"ClassBoardLock"*/,
          (const MethodInfo_3027488 *)Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardLock___);
  v41 = ClassBoardResourceCatalogAssetBundle__GetObject_object_(
          this,
          this->fields.mainAssetData,
          (System_String_o *)StringLiteral_4505/*"ClassBoardBlank"*/,
          (const MethodInfo_3027488 *)Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardBlank___);
  v42 = ClassBoardResourceCatalogAssetBundle__GetObject_object_(
          this,
          this->fields.mainAssetData,
          (System_String_o *)StringLiteral_7142/*"GrandClassBoardSquare"*/,
          (const MethodInfo_3027488 *)Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardSquare___);
  v43 = ClassBoardResourceCatalogAssetBundle__GetObject_object_(
          this,
          this->fields.mainAssetData,
          (System_String_o *)StringLiteral_7140/*"GrandClassBoardLine"*/,
          (const MethodInfo_3027488 *)Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardLine___);
  v44 = ClassBoardResourceCatalogAssetBundle__GetObject_object_(
          this,
          this->fields.mainAssetData,
          (System_String_o *)StringLiteral_7141/*"GrandClassBoardLock"*/,
          (const MethodInfo_3027488 *)Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardLock___);
  v45 = ClassBoardResourceCatalogAssetBundle__GetObject_object_(
          this,
          this->fields.mainAssetData,
          (System_String_o *)StringLiteral_7139/*"GrandClassBoardBlank"*/,
          (const MethodInfo_3027488 *)Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardBlank___);
  v46 = ClassBoardResourceCatalogAssetBundle__GetObject_object_(
          this,
          this->fields.mainAssetData,
          (System_String_o *)StringLiteral_4506/*"ClassBoardDisableOpenDialog"*/,
          (const MethodInfo_3027488 *)Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardDisableOpenDialog___);
  v47 = ClassBoardResourceCatalogAssetBundle__GetObject_object_(
          this,
          this->fields.mainAssetData,
          (System_String_o *)StringLiteral_4518/*"ClassBoardSquareOpenConfirmDialog"*/,
          (const MethodInfo_3027488 *)Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardSquareOpenConfirmDialog___);
  v87 = ClassBoardResourceCatalogAssetBundle__GetObject_object_(
          this,
          this->fields.mainAssetData,
          (System_String_o *)StringLiteral_4510/*"ClassBoardLockOpenConfirmDialog"*/,
          (const MethodInfo_3027488 *)Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardLockOpenConfirmDialog___);
  v86 = ClassBoardResourceCatalogAssetBundle__GetObject_object_(
          this,
          this->fields.mainAssetData,
          (System_String_o *)StringLiteral_4511/*"ClassBoardLockReleaseConditionDialog"*/,
          (const MethodInfo_3027488 *)Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardLockReleaseConditionDialog___);
  classBoardSquareDetailDialog = (ClassBoardSquareDetailDialog_o *)ClassBoardResourceCatalogAssetBundle__GetObject_object_(
                                                                     this,
                                                                     this->fields.mainAssetData,
                                                                     (System_String_o *)StringLiteral_4517/*"ClassBoardSquareDetailDialog"*/,
                                                                     (const MethodInfo_3027488 *)Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardSquareDetailDialog___);
  uiController = (ClassBoardUIController_o *)ClassBoardResourceCatalogAssetBundle__GetObject_object_(
                                               this,
                                               this->fields.mainAssetData,
                                               (System_String_o *)StringLiteral_4519/*"ClassBoardUI"*/,
                                               (const MethodInfo_3027488 *)Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardUIController___);
  Object_object__50417328 = (char *)ClassBoardResourceCatalogAssetBundle__GetObject_object_(
                                      this,
                                      this->fields.modelAssetData,
                                      (System_String_o *)StringLiteral_4504/*"ClassBoardBg"*/,
                                      (const MethodInfo_3027488 *)Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardBackground___);
  boardSelectViewAssetData = this->fields.boardSelectViewAssetData;
  v81 = Object_object__50417328;
  ...
  Object_object__50417328 = (char *)AssetData__GetObject_object__50417328(
                                      boardSelectViewAssetData,
                                      (System_String_o *)StringLiteral_4515/*"ClassBoardSelectView"*/,
                                      (const MethodInfo_3014EB0 *)Method_AssetData_GetObject_GameObject____77074016);
  v52 = this->fields.boardSelectViewAssetData;
  v80 = Object_object__50417328;
  if ( !v52 )
    goto LABEL_20;
  v53 = AssetData__GetObject_object__50417328(
          v52,
          (System_String_o *)StringLiteral_6855/*"ForwardIconAnimObject"*/,
          (const MethodInfo_3014EB0 *)Method_AssetData_GetObject_GameObject____77074016);
  v54 = ClassBoardResourceCatalogAssetBundle__GetObject_object_(
          this,
          this->fields.mainAssetData,
          (System_String_o *)StringLiteral_4507/*"ClassBoardFigure"*/,
          (const MethodInfo_3027488 *)Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardFigureController___);
  v55 = ClassBoardResourceCatalogAssetBundle__GetObject_object_(
          this,
          this->fields.mainAssetData,
          (System_String_o *)StringLiteral_4512/*"ClassBoardQuestOpenConfirmDialog"*/,
          (const MethodInfo_3027488 *)Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardQuestOpenConfirmDialog___);
  v56 = ClassBoardResourceCatalogAssetBundle__GetObject_object_(
          this,
          this->fields.mainAssetData,
          (System_String_o *)StringLiteral_6900/*"FullReleaseEffectClassScore"*/,
          (const MethodInfo_3027488 *)Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardFullReleaseEffectComponent___);
  Object_object__50417328 = (char *)ClassBoardResourceCatalogAssetBundle__GetObject_object_(
                                      this,
                                      this->fields.mainAssetData,
                                      (System_String_o *)StringLiteral_6901/*"FullReleaseEffectGrandScore"*/,
                                      (const MethodInfo_3027488 *)Method_ClassBoardResourceCatalogAssetBundle_GetObject_ClassBoardFullReleaseEffectComponent___);
  if ( !this->fields._Contents_k__BackingField )
    goto LABEL_20;
  v58 = (struct ClassBoardFullReleaseEffectComponent_o *)Object_object__50417328;
  ClassBoardResourceContents__SetContents(
    ...
    v57);
  Object_object__50417328 = (char *)this->fields._Contents_k__BackingField;
  if ( !Object_object__50417328 )
    goto LABEL_20;
  ClassBoardResourceContents__SetGrandContents(
    (ClassBoardResourceContents_o *)Object_object__50417328,
    v90,
    v89,
  ...
  if ( !Object_object__50417328 )
    goto LABEL_20;
  *((_QWORD *)Object_object__50417328 + 20) = v81;
  sub_1BDB81C((CGThumbnailListItem_o *)(Object_object__50417328 + 160), (int32_t)v81, v62, v63);
  Object_object__50417328 = (char *)this->fields._Contents_k__BackingField;
  if ( !Object_object__50417328 )
    goto LABEL_20;
  *((_QWORD *)Object_object__50417328 + 22) = v80;
  sub_1BDB81C((CGThumbnailListItem_o *)(Object_object__50417328 + 176), (int32_t)v80, v64, v65);
  Object_object__50417328 = (char *)this->fields._Contents_k__BackingField;
  if ( !Object_object__50417328 )
    goto LABEL_20;
  *((_QWORD *)Object_object__50417328 + 23) = v53;
  sub_1BDB81C((CGThumbnailListItem_o *)(Object_object__50417328 + 184), (int32_t)v53, v66, v67);
  Object_object__50417328 = (char *)this->fields._Contents_k__BackingField;
  if ( !Object_object__50417328 )
    goto LABEL_20;
  *((_QWORD *)Object_object__50417328 + 16) = v54;
  sub_1BDB81C((CGThumbnailListItem_o *)(Object_object__50417328 + 128), (int32_t)v54, v68, v69);
  Object_object__50417328 = (char *)this->fields._Contents_k__BackingField;
  if ( !Object_object__50417328 )
    goto LABEL_20;
  *((_QWORD *)Object_object__50417328 + 17) = v55;
  sub_1BDB81C((CGThumbnailListItem_o *)Object_object__50417328 + 1, (int32_t)v55, v70, v71);
  ...
  if ( grandGraphAtlas )
  {
    ...
    if ( !Object_object__50417328 )
      goto LABEL_20;
    *((_QWORD *)Object_object__50417328 + 27) = grandGraphAtlas;
    sub_1BDB81C((CGThumbnailListItem_o *)(Object_object__50417328 + 216), (int32_t)grandGraphAtlas, v77, v78);
  }
  loadEndCallback = this->fields.loadEndCallback;
  if ( !loadEndCallback )
LABEL_20:
    sub_1BDBAD4(Object_object__50417328, grandGraphAtlas);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48324 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_ClassBoardResourceCatalogAssetBundle_LoadEnd__, v11);
    sub_1BDB878(&Method_ClassBoardResourceCatalogAssetBundle__LoadSystemAsset_b__44_0__, v12);
    sub_1BDB878(&Method_ClassBoardResourceCatalogAssetBundle__LoadSystemAsset_b__44_1__, v13);
    sub_1BDB878(&Method_ClassBoardResourceCatalogAssetBundle__LoadSystemAsset_b__44_2__, v14);
    sub_1BDB878(&Method_ClassBoardResourceCatalogAssetBundle__LoadSystemAsset_b__44_3__, v15);
    sub_1BDB878(&Method_ClassBoardResourceCatalogAssetBundle__LoadSystemAsset_b__44_4__, v16);
    sub_1BDB878(&Method_ClassBoardResourceCatalogAssetBundle__LoadSystemAsset_b__44_5__, v17);
    sub_1BDB878(&Method_ClassBoardResourceCatalogAssetBundle__LoadSystemAsset_b__44_6__, v18);
    sub_1BDB878(&StringLiteral_4503/*"ClassBoard/UI/DownloadClassBoardUIAtlas"*/, v19);
    sub_1BDB878(&StringLiteral_7146/*"GrandGraphSystem/DownloadGrandGraphSystemAtlas"*/, v20);
    sub_1BDB878(&StringLiteral_4502/*"ClassBoard/UI/DownloadClassBoardClassUIAtlas"*/, v21);
    sub_1BDB878(&StringLiteral_4499/*"ClassBoard/Icon/DownloadClassBoardIconAtlas"*/, v22);
    byte_4B48324 = 1;
  }
  ...
  assetStorageLoadWrapper = this->fields.assetStorageLoadWrapper;
  v24 = (AtlasManagerUnit_o *)sub_1BDBAC4(AtlasManagerUnit_TypeInfo);
  AtlasManagerUnit___ctor(v24, (System_String_o *)StringLiteral_4503/*"ClassBoard/UI/DownloadClassBoardUIAtlas"*/, assetStorageLoadWrapper, 0LL);
  this->fields.boardUiAtlasManagerUnit = v24;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.boardUiAtlasManagerUnit, (int32_t)v24, v25, v26);
  v27 = this->fields.assetStorageLoadWrapper;
  v28 = (AtlasManagerUnit_o *)sub_1BDBAC4(AtlasManagerUnit_TypeInfo);
  AtlasManagerUnit___ctor(v28, (System_String_o *)StringLiteral_4502/*"ClassBoard/UI/DownloadClassBoardClassUIAtlas"*/, v27, 0LL);
  this->fields.classUiAtlasManagerUnit = v28;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.classUiAtlasManagerUnit, (int32_t)v28, v29, v30);
  v31 = this->fields.assetStorageLoadWrapper;
  v32 = (AtlasManagerUnit_o *)sub_1BDBAC4(AtlasManagerUnit_TypeInfo);
  AtlasManagerUnit___ctor(v32, (System_String_o *)StringLiteral_4499/*"ClassBoard/Icon/DownloadClassBoardIconAtlas"*/, v31, 0LL);
  this->fields.iconAtlasManagerUnit = v32;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.iconAtlasManagerUnit, (int32_t)v32, v33, v34);
  v35 = this->fields.assetStorageLoadWrapper;
  v36 = (AtlasManagerUnit_o *)sub_1BDBAC4(AtlasManagerUnit_TypeInfo);
  AtlasManagerUnit___ctor(v36, (System_String_o *)StringLiteral_7146/*"GrandGraphSystem/DownloadGrandGraphSystemAtlas"*/, v35, 0LL);
  this->fields.grandGraphAtlas = v36;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.grandGraphAtlas, (int32_t)v36, v37, v38);
  v39 = sub_1BDB920(System_Action_Action____TypeInfo, 7LL);
  ...
  if ( !*(_DWORD *)(v39 + 24) )
    goto LABEL_16;
  *(_QWORD *)(v39 + 32) = v40;
  sub_1BDB81C((CGThumbnailListItem_o *)(v39 + 32), (int32_t)v40, v43, v44);
  ...
  if ( *(_DWORD *)(v39 + 24) <= 1u )
    goto LABEL_16;
  *(_QWORD *)(v39 + 40) = v45;
  sub_1BDB81C((CGThumbnailListItem_o *)(v39 + 40), (int32_t)v45, v43, v46);
  ...
  if ( *(_DWORD *)(v39 + 24) <= 2u )
    goto LABEL_16;
  *(_QWORD *)(v39 + 48) = v47;
  sub_1BDB81C((CGThumbnailListItem_o *)(v39 + 48), (int32_t)v47, v43, v48);
  ...
  if ( *(_DWORD *)(v39 + 24) <= 3u )
    goto LABEL_16;
  *(_QWORD *)(v39 + 56) = v49;
  sub_1BDB81C((CGThumbnailListItem_o *)(v39 + 56), (int32_t)v49, v43, v50);
  ...
  if ( *(_DWORD *)(v39 + 24) <= 4u )
    goto LABEL_16;
  *(_QWORD *)(v39 + 64) = v51;
  sub_1BDB81C((CGThumbnailListItem_o *)(v39 + 64), (int32_t)v51, v43, v52);
  ...
  if ( *(_DWORD *)(v39 + 24) <= 5u )
    goto LABEL_16;
  *(_QWORD *)(v39 + 72) = v53;
  sub_1BDB81C((CGThumbnailListItem_o *)(v39 + 72), (int32_t)v53, v43, v54);
  ...
  if ( *(_DWORD *)(v39 + 24) <= 6u )
    goto LABEL_16;
  *(_QWORD *)(v39 + 80) = v55;
  sub_1BDB81C((CGThumbnailListItem_o *)(v39 + 80), (int32_t)v55, v43, v56);
  v57 = (ChainableActionParallel_o *)sub_1BDBAC4(ChainableActionParallel_TypeInfo);
  ChainableActionParallel___ctor_48338324(v57, (System_Action_Action__array *)v39, 0LL);
  ...
  if ( !*(_DWORD *)(v58 + 24) )
LABEL_16:
    sub_1BDBADC(v41, v42, v43);
  *(_QWORD *)(v58 + 32) = v59;
  sub_1BDB81C((CGThumbnailListItem_o *)(v58 + 32), (int32_t)v59, v43, v60);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48326 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_ClassBoardResourceCatalogAssetBundle___c__DisplayClass47_0__ReloadBoardUIAtlas_b__0__, v6);
    sub_1BDB878(&ClassBoardResourceCatalogAssetBundle___c__DisplayClass47_0_TypeInfo, v7);
    sub_1BDB878(&StringLiteral_4503/*"ClassBoard/UI/DownloadClassBoardUIAtlas"*/, v8);
    byte_4B48326 = 1;
  }
  v9 = sub_1BDBAC4(ClassBoardResourceCatalogAssetBundle___c__DisplayClass47_0_TypeInfo);
  ...
  *(_QWORD *)(v9 + 24) = callback;
  ...
  assetStorageLoadWrapper = this->fields.assetStorageLoadWrapper;
  v18 = (AtlasManagerUnit_o *)sub_1BDBAC4(AtlasManagerUnit_TypeInfo);
  AtlasManagerUnit___ctor(v18, (System_String_o *)StringLiteral_4503/*"ClassBoard/UI/DownloadClassBoardUIAtlas"*/, assetStorageLoadWrapper, 0LL);
  this->fields.boardUiAtlasManagerUnit = v18;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.boardUiAtlasManagerUnit, (int32_t)v18, v19, v20);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4832E & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_ClassBoardResourceCatalogAssetBundle___c__DisplayClass44_0__LoadSystemAsset_b__7__, v5);
    sub_1BDB878(&ClassBoardResourceCatalogAssetBundle___c__DisplayClass44_0_TypeInfo, v6);
    sub_1BDB878(&StringLiteral_4500/*"ClassBoard/Main"*/, v7);
    byte_4B4832E = 1;
  }
  v8 = sub_1BDBAC4(ClassBoardResourceCatalogAssetBundle___c__DisplayClass44_0_TypeInfo);
  ...
  *(_QWORD *)(v8 + 16) = f;
  sub_1BDB81C((CGThumbnailListItem_o *)(v8 + 16), (int32_t)f, v13, v14);
  ...
  AssetLoader_LoadEndDataHandler___ctor(
    ...
    0LL);
  ClassBoardResourceCatalogAssetBundle__LoadAssetStorage(this, (System_String_o *)StringLiteral_4500/*"ClassBoard/Main"*/, v15, v16);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&AssetLoader_LoadEndDataHandler_TypeInfo, f);
    sub_1BDB878(&Method_ClassBoardResourceCatalogAssetBundle___c__DisplayClass44_1__LoadSystemAsset_b__8__, v5);
    sub_1BDB878(&ClassBoardResourceCatalogAssetBundle___c__DisplayClass44_1_TypeInfo, v6);
    sub_1BDB878(&StringLiteral_4479/*"ClassBoard/Bg"*/, v7);
    byte_4B4832F = 1;
  }
  v8 = sub_1BDBAC4(ClassBoardResourceCatalogAssetBundle___c__DisplayClass44_1_TypeInfo);
  System_Object___ctor((Il2CppObject *)v8, 0LL);
  if ( !v8 )
    sub_1BDBAD4(v9, v10);
  *(_QWORD *)(v8 + 24) = this;
  ...
  *(_QWORD *)(v8 + 16) = f;
  ...
  AssetLoader_LoadEndDataHandler___ctor(
    ...
    0LL);
  ClassBoardResourceCatalogAssetBundle__LoadAssetStorage(this, (System_String_o *)StringLiteral_4479/*"ClassBoard/Bg"*/, v15, v16);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&AssetLoader_LoadEndDataHandler_TypeInfo, f);
    sub_1BDB878(&Method_ClassBoardResourceCatalogAssetBundle___c__DisplayClass44_2__LoadSystemAsset_b__9__, v5);
    sub_1BDB878(&ClassBoardResourceCatalogAssetBundle___c__DisplayClass44_2_TypeInfo, v6);
    sub_1BDB878(&StringLiteral_4501/*"ClassBoard/Select"*/, v7);
    byte_4B48330 = 1;
  }
  v8 = sub_1BDBAC4(ClassBoardResourceCatalogAssetBundle___c__DisplayClass44_2_TypeInfo);
  System_Object___ctor((Il2CppObject *)v8, 0LL);
  if ( !v8 )
    sub_1BDBAD4(v9, v10);
  *(_QWORD *)(v8 + 24) = this;
  ...
  *(_QWORD *)(v8 + 16) = f;
  ...
  AssetLoader_LoadEndDataHandler___ctor(
    ...
    0LL);
  ClassBoardResourceCatalogAssetBundle__LoadAssetStorage(this, (System_String_o *)StringLiteral_4501/*"ClassBoard/Select"*/, v15, v16);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !_4__this
    || (_4__this->fields.mainAssetData = asset,
        sub_1BDB81C((CGThumbnailListItem_o *)&_4__this->fields.mainAssetData, (int32_t)asset, (int32_t)method, v3),
        (f = this->fields.f) == 0LL) )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( !_4__this
    || (_4__this->fields.modelAssetData = asset,
        sub_1BDB81C((CGThumbnailListItem_o *)&_4__this->fields.modelAssetData, (int32_t)asset, (int32_t)method, v3),
        (f = this->fields.f) == 0LL) )
  {
    sub_1BDBAD4(_4__this, asset);
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this[6], (int32_t)boardUiAtlasManagerUnit, v2, v3);
