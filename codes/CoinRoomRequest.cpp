        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A212EC & 1) == 0 )
  {
    sub_1B715CC(&Method_System_Collections_Generic_Dictionary_int__SelectedUserSvtCoin__get_Values__, requestValuse);
    sub_1B715CC(
    ...
    sub_1B715CC(
      ...
      v9);
    sub_1B715CC(&StringLiteral_25095/*"}"*/, v10);
    sub_1B715CC(&StringLiteral_907/*",\"num\":"*/, v11);
    sub_1B715CC(&StringLiteral_24861/*"{\"id\":"*/, v12);
    sub_1B715CC(&StringLiteral_20828/*"itemData"*/, v13);
    sub_1B715CC(&StringLiteral_868/*","*/, v14);
    sub_1B715CC(&StringLiteral_15762/*"["*/, v15);
    sub_1B715CC(&StringLiteral_1/*""*/, v16);
    this = (CoinRoomRequest_o *)sub_1B715CC(&StringLiteral_16019/*"]"*/, v17);
    byte_4A212EC = 1;
  }
  ...
  if ( !requestValuse
    || (v18 = (System_String_o *)StringLiteral_1/*""*/,
        (this = (CoinRoomRequest_o *)System_Collections_Generic_Dictionary_int__object___get_Values(
                                       ...
                                       (const MethodInfo_3148664 *)Method_System_Collections_Generic_Dictionary_int__SelectedUserSvtCoin__get_Values__)) == 0LL) )
  {
    sub_1B71828(this, requestValuse);
  }
  System_Collections_Generic_Dictionary_ValueCollection_int__object___GetEnumerator(
    &v52,
    (System_Collections_Generic_Dictionary_ValueCollection_TKey__TValue__o *)this,
    (const MethodInfo_37D52EC *)Method_System_Collections_Generic_Dictionary_ValueCollection_int__SelectedUserSvtCoin__GetEnumerator__);
  v19 = 0;
  v54 = v52;
  while ( System_Collections_Generic_Dictionary_ValueCollection_Enumerator_int__object___MoveNext(
            &v54,
            (const MethodInfo_328F640 *)Method_System_Collections_Generic_Dictionary_ValueCollection_Enumerator_int__SelectedUserSvtCoin__MoveNext__) )
  {
    currentValue = v54.fields._currentValue;
    if ( v19 >= 1 )
      v18 = System_String__Concat_61505504(v18, (System_String_o *)StringLiteral_868/*","*/, 0LL);
    v21 = sub_1B71674(string___TypeInfo, 6LL);
    v25 = v21;
    if ( !v21 )
      sub_1B71828(0LL, v22);
    if ( !*(_DWORD *)(v21 + 24) )
      sub_1B71830(v21, v22);
    *(_QWORD *)(v21 + 32) = v18;
    sub_1B71570((ServantStatusBattleListViewItem_o *)(v21 + 32), (int32_t)v18, v23, v24);
    if ( *(_DWORD *)(v25 + 24) <= 1u )
      sub_1B71830(v26, v27);
    v30 = StringLiteral_24861/*"{\"id\":"*/;
    *(_QWORD *)(v25 + 40) = StringLiteral_24861/*"{\"id\":"*/;
    sub_1B71570((ServantStatusBattleListViewItem_o *)(v25 + 40), v30, v28, v29);
    if ( !currentValue )
      sub_1B71828(v31, v32);
    ...
    if ( *(_DWORD *)(v25 + 24) <= 2u )
      sub_1B71830(v33, v33);
    *(_QWORD *)(v25 + 48) = v33;
    sub_1B71570((ServantStatusBattleListViewItem_o *)(v25 + 48), (int32_t)v33, v34, v35);
    if ( *(_DWORD *)(v25 + 24) <= 3u )
      sub_1B71830(v36, v37);
    v40 = StringLiteral_907/*",\"num\":"*/;
    *(_QWORD *)(v25 + 56) = StringLiteral_907/*",\"num\":"*/;
    sub_1B71570((ServantStatusBattleListViewItem_o *)(v25 + 56), v40, v38, v39);
    monitor = HIDWORD(currentValue[1].monitor);
    v41 = System_Int32__ToString((int32_t)&monitor, 0LL);
    if ( *(_DWORD *)(v25 + 24) <= 4u )
      sub_1B71830(v41, v41);
    *(_QWORD *)(v25 + 64) = v41;
    sub_1B71570((ServantStatusBattleListViewItem_o *)(v25 + 64), (int32_t)v41, v42, v43);
    if ( *(_DWORD *)(v25 + 24) <= 5u )
      sub_1B71830(v44, v45);
    v48 = StringLiteral_25095/*"}"*/;
    *(_QWORD *)(v25 + 72) = StringLiteral_25095/*"}"*/;
    sub_1B71570((ServantStatusBattleListViewItem_o *)(v25 + 72), v48, v46, v47);
    ++v19;
    v18 = System_String__Concat_61519032((System_String_array *)v25, 0LL);
  }
  System_Collections_Generic_Dictionary_ValueCollection_Enumerator_int__object___Dispose(
    &v54,
    (const MethodInfo_328F63C *)Method_System_Collections_Generic_Dictionary_ValueCollection_Enumerator_int__SelectedUserSvtCoin__Dispose__);
  v49 = System_String__Concat_61516764(
          (System_String_o *)StringLiteral_15762/*"["*/,
          v18,
          (System_String_o *)StringLiteral_16019/*"]"*/,
          0LL);
  RequestBase__addField_40916388(v4, (System_String_o *)StringLiteral_20828/*"itemData"*/, v49, v50);
...
System_String_o *__fastcall CoinRoomRequest__getURL(CoinRoomRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A212EB & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_17993/*"coinRoom/put"*/, v2);
    byte_4A212EB = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61505504(BaseUrl, (System_String_o *)StringLiteral_17993/*"coinRoom/put"*/, 0LL);
}
