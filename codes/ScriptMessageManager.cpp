...
void __fastcall ScriptMessageManager__Start(ScriptMessageManager_o *this, const MethodInfo *method)
{
  ...
  rootObject = (UnityEngine_GameObject_o *)ScriptMessageLabel__GetFontSize((System_String_o *)StringLiteral_757/*"-"*/, 0, v11);
...
LABEL_18:
  ...
  UILabel__set_text(v16, (System_String_o *)StringLiteral_23972/*"■"*/, 0LL);
