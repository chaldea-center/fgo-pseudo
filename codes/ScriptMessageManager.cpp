void __fastcall ScriptMessageManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A71AC1 & 1) == 0 )
  {
    sub_1B90010(&ScriptMessageManager_TypeInfo, v1);
    byte_4A71AC1 = 1;
  }
...
void __fastcall ScriptMessageManager__Start(ScriptMessageManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A71AC0 & 1) == 0 )
  {
    ...
    sub_1B90010(&ScriptMessageManager_TypeInfo, v6);
    sub_1B90010(&StringLiteral_919/*"-"*/, v7);
    sub_1B90010(&StringLiteral_25292/*"■"*/, v8);
    byte_4A71AC0 = 1;
  }
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.rootPanel, (int32_t)Component_object, v11, v12);
