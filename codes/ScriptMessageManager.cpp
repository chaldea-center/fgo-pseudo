void __fastcall ScriptMessageManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A2FB76 & 1) == 0 )
  {
    sub_1B761C0(&ScriptMessageManager_TypeInfo, v1);
    byte_4A2FB76 = 1;
  }
...
void __fastcall ScriptMessageManager__Start(ScriptMessageManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2FB75 & 1) == 0 )
  {
    ...
    sub_1B761C0(&ScriptMessageManager_TypeInfo, v6);
    sub_1B761C0(&StringLiteral_919/*"-"*/, v7);
    sub_1B761C0(&StringLiteral_25239/*"■"*/, v8);
    byte_4A2FB75 = 1;
  }
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.rootPanel, (int32_t)Component_object, v11, v12);
