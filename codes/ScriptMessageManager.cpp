void __fastcall ScriptMessageManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_418D353 & 1) == 0 )
  {
    sub_B2C35C(&ScriptMessageManager_TypeInfo, v1);
    byte_418D353 = 1;
  }
...
void __fastcall ScriptMessageManager__Start(ScriptMessageManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_418D352 & 1) == 0 )
  {
    ...
    sub_B2C35C(&ScriptMessageManager_TypeInfo, v7);
  ...
  this->fields.defaultFontSize = ScriptMessageLabel__GetFontSize((System_String_o *)StringLiteral_747/*"-"*/, 0, v18);
...
LABEL_18:
  ...
  UILabel__set_text(v21, (System_String_o *)StringLiteral_23777/*"■"*/, 0LL);
