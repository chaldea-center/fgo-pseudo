...
void ServantStatusVoiceListViewObject__Awake(ServantStatusVoiceListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596DFD1 & 1) == 0 )
  {
    sub_2213A60(&Method_UnityEngine_GameObject_GetComponent_ServantStatusVoiceListViewItemDraw___);
    byte_596DFD1 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_38B6F40 *)Method_UnityEngine_GameObject_GetComponent_ServantStatusVoiceListViewItemDraw___);
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_38B6F40 *)Method_UnityEngine_GameObject_GetComponent_ServantStatusVoiceListViewObject___)) == 0) )
  {
    sub_2213CDC(DragObject, v4);
  }
  ServantStatusVoiceListViewObject__Init_44652888((ServantStatusVoiceListViewObject_o *)DragObject, 2, v6);
  return v5;
}
...
void ServantStatusVoiceListViewObject__SetItem_44656604(
        ServantStatusVoiceListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
