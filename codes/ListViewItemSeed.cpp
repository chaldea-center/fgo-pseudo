        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB7A13 & 1) == 0 )
  {
    this = (ListViewItemSeed_o *)sub_1C6BA08(&Method_UnityEngine_GameObject_GetComponent_BoxCollider___);
    byte_4CB7A13 = 1;
  }
  if ( !obj )
    goto LABEL_9;
        ...
        const MethodInfo *method)
{
  ...
  if ( !parent
    || (transform = UnityEngine_GameObject__get_transform(parent, 0),
        ...
        !transform) )
  {
    sub_1C6BC60(parent, *(_QWORD *)&index);
  }
...
UnityEngine_Vector3_o ListViewItemSeed__GetPosition(ListViewItemSeed_o *this, int32_t index, const MethodInfo *method)
{
  ...
  if ( !transform )
    sub_1C6BC60(0, v11);
  return UnityEngine_Transform__TransformPoint_71686456(
           transform,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB7A14 & 1) == 0 )
  {
    this = (ListViewItemSeed_o *)sub_1C6BA08(&StringLiteral_12790/*"SetBaseTransform"*/);
    byte_4CB7A14 = 1;
  }
  if ( !obj )
    goto LABEL_10;
...
LABEL_10:
  ...
  UnityEngine_GameObject__SendMessage_71641044(obj, (System_String_o *)StringLiteral_12790/*"SetBaseTransform"*/, 0);
}