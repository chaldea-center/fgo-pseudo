        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C390DE & 1) == 0 )
  {
    this = (ListViewItemSeed_o *)sub_1C32C20(&Method_UnityEngine_GameObject_GetComponent_BoxCollider___);
    byte_4C390DE = 1;
  }
  if ( !obj )
    goto LABEL_9;
...
UnityEngine_Vector3_o ListViewItemSeed__GetPosition(ListViewItemSeed_o *this, int32_t index, const MethodInfo *method)
{
  ...
  if ( !transform )
    sub_1C32E7C(0);
  return UnityEngine_Transform__TransformPoint_71250240(
           transform,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C390DF & 1) == 0 )
  {
    this = (ListViewItemSeed_o *)sub_1C32C20(&StringLiteral_12785/*"SetBaseTransform"*/);
    byte_4C390DF = 1;
  }
  if ( !obj )
    goto LABEL_10;
...
LABEL_10:
  ...
  UnityEngine_GameObject__SendMessage_71205516(obj, (System_String_o *)StringLiteral_12785/*"SetBaseTransform"*/, 0);
}