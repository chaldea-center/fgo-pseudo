        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC8B3C & 1) == 0 )
  {
    this = (ListViewItemSeed_o *)sub_1C713B0(&Method_UnityEngine_GameObject_GetComponent_BoxCollider___);
    byte_4CC8B3C = 1;
  }
  if ( !obj )
    goto LABEL_9;
        ...
        const MethodInfo *method)
{
  ...
  if ( !parent
    || (transform = UnityEngine_GameObject__get_transform(parent, 0),
        ...
        !transform) )
  {
    sub_1C71608(parent, *(_QWORD *)&index);
  }
...
UnityEngine_Vector3_o ListViewItemSeed__GetPosition(ListViewItemSeed_o *this, int32_t index, const MethodInfo *method)
{
  ...
  if ( !transform )
    sub_1C71608(0, v11);
  return UnityEngine_Transform__TransformPoint_71751388(
           transform,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC8B3D & 1) == 0 )
  {
    this = (ListViewItemSeed_o *)sub_1C713B0(&StringLiteral_12796/*"SetBaseTransform"*/);
    byte_4CC8B3D = 1;
  }
  if ( !obj )
    goto LABEL_10;
