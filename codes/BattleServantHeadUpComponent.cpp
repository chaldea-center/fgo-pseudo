        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22ABA & 1) == 0 )
  {
    sub_1B715CC(&Method_UnityEngine_Component_GetComponent_UISprite___, enable);
    sub_1B715CC(&Method_UnityEngine_Component_GetComponent_UITexture___, v5);
    sub_1B715CC(&UnityEngine_Object_TypeInfo, v6);
    sub_1B715CC(&StringLiteral_23680/*"symbol_adjust/mapsymbol_001"*/, v7);
    sub_1B715CC(&StringLiteral_23681/*"symbol_adjust/target"*/, v8);
    byte_4A22ABA = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(targetMark, 0LL, 0LL) )
  {
    ...
    v12 = (UnityEngine_Object_o *)UnityEngine_Transform__Find(
                                    ...
                                    (System_String_o *)StringLiteral_23681/*"symbol_adjust/target"*/,
                                    0LL);
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
...
LABEL_36:
    ...
    v15 = (UnityEngine_Object_o *)UnityEngine_Transform__Find(
                                    (UnityEngine_Transform_o *)transform,
                                    (System_String_o *)StringLiteral_23680/*"symbol_adjust/mapsymbol_001"*/,
                                    0LL);
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22AB8 & 1) == 0 )
  {
    sub_1B715CC(&UnityEngine_Object_TypeInfo, svtData);
    byte_4A22AB8 = 1;
  }
  this->fields.tmp_svtData = svtData;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.tmp_svtData, (int32_t)svtData, (int32_t)method, v3);
...
LABEL_32:
    sub_1B71828(targetMark, *(_QWORD *)&uniqueId);
  }
}
