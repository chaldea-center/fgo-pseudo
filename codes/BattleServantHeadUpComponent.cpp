        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A014B6 & 1) == 0 )
  {
    sub_1B64870(&Method_UnityEngine_Component_GetComponent_UISprite___, enable);
    sub_1B64870(&Method_UnityEngine_Component_GetComponent_UITexture___, v5);
    sub_1B64870(&UnityEngine_Object_TypeInfo, v6);
    sub_1B64870(&StringLiteral_23645/*"symbol_adjust/mapsymbol_001"*/, v7);
    sub_1B64870(&StringLiteral_23646/*"symbol_adjust/target"*/, v8);
    byte_4A014B6 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.tmp_svtData, (int32_t)svtData, (int32_t)method, v3);
...
LABEL_32:
    sub_1B64ACC(targetMark, *(_QWORD *)&uniqueId);
  }
}
