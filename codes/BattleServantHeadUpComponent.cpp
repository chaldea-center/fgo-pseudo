        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47F2D & 1) == 0 )
  {
    sub_1BDB878(&Method_UnityEngine_Component_GetComponent_UISprite___, enable);
    sub_1BDB878(&Method_UnityEngine_Component_GetComponent_UITexture___, v5);
    sub_1BDB878(&UnityEngine_Object_TypeInfo, v6);
    sub_1BDB878(&StringLiteral_23931/*"symbol_adjust/mapsymbol_001"*/, v7);
    sub_1BDB878(&StringLiteral_23932/*"symbol_adjust/target"*/, v8);
    byte_4B47F2D = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(targetMark, 0LL, 0LL) )
  {
    ...
    v12 = (UnityEngine_Object_o *)UnityEngine_Transform__Find(
                                    ...
                                    (System_String_o *)StringLiteral_23932/*"symbol_adjust/target"*/,
                                    0LL);
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
...
LABEL_36:
    ...
    v15 = (UnityEngine_Object_o *)UnityEngine_Transform__Find(
                                    (UnityEngine_Transform_o *)transform,
                                    (System_String_o *)StringLiteral_23931/*"symbol_adjust/mapsymbol_001"*/,
                                    0LL);
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47F2B & 1) == 0 )
  {
    sub_1BDB878(&UnityEngine_Object_TypeInfo, svtData);
    byte_4B47F2B = 1;
  }
  this->fields.tmp_svtData = svtData;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.tmp_svtData, (int32_t)svtData, (int32_t)method, v3);
...
LABEL_32:
    sub_1BDBAD4(targetMark, *(_QWORD *)&uniqueId);
  }
}
