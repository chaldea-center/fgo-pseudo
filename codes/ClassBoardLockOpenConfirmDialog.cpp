        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_418950A & 1) == 0 )
  {
    ...
    sub_B2C35C(&Method_ClassBoardLockOpenConfirmDialog_EndClose__, v3);
    byte_418950A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4189509 & 1) == 0 )
  {
    sub_B2C35C(&Method_ClassBoardLockOpenConfirmDialog_OnClickCancel__, method);
    byte_4189509 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_ClassBoardLockOpenConfirmDialog_OnClickCancel__ + 75) & 2) != 0 )
      v3 = (_QWORD *)sub_B2C364(Method_ClassBoardLockOpenConfirmDialog_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_418950C & 1) == 0 )
  {
    sub_B2C35C(&System_Action_TypeInfo, method);
    sub_B2C35C(&Method_ClassBoardLockOpenConfirmDialog_EndClose__, v3);
    sub_B2C35C(&Method_ClassBoardLockOpenConfirmDialog_OnClickDecide__, v4);
    byte_418950C = 1;
  }
  if ( this->fields.isDecideButtonEnable )
  {
    if ( this->fields.isButtonEnable )
    {
      ...
      if ( (*((_BYTE *)Method_ClassBoardLockOpenConfirmDialog_OnClickDecide__ + 75) & 2) != 0 )
        v5 = (_QWORD *)sub_B2C364(Method_ClassBoardLockOpenConfirmDialog_OnClickDecide__);
  ...
  else
  {
    ...
    if ( (*((_BYTE *)Method_ClassBoardLockOpenConfirmDialog_OnClickDecide__ + 75) & 2) != 0 )
      v15 = (_QWORD *)sub_B2C364(Method_ClassBoardLockOpenConfirmDialog_OnClickDecide__);
        ...
        const MethodInfo *method)
{
  ...
  ClassBoardCondData_o v70; // 0:x0.12
  ClassBoardCondData_o v71; // 0:x1.12

  if ( (byte_4189508 & 1) == 0 )
  {
    sub_B2C35C(&System_Action_TypeInfo, square);
    sub_B2C35C(&Method_ClassBoardLockOpenConfirmDialog_EndOpen__, v13);
    sub_B2C35C(&ClassBoardLock_TypeInfo, v14);
    sub_B2C35C(&IClassBoardLockModel_TypeInfo, v15);
    sub_B2C35C(&IClassBoardSquareModel_TypeInfo, v16);
    sub_B2C35C(&LocalizationManager_TypeInfo, v17);
    sub_B2C35C(&StringLiteral_3019/*"CLASS_BOARD_LOCK_OPEN_CONFIRM_DIALOG_TITLE"*/, v18);
    sub_B2C35C(&StringLiteral_3017/*"CLASS_BOARD_LOCK_OPEN_CONFIRM_DIALOG_ITEM_DETAIL"*/, v19);
    sub_B2C35C(&StringLiteral_3015/*"CLASS_BOARD_LOCK_OPEN_CONFIRM_DIALOG_CANCEL"*/, v20);
    sub_B2C35C(&StringLiteral_3016/*"CLASS_BOARD_LOCK_OPEN_CONFIRM_DIALOG_DECIDE"*/, v21);
    sub_B2C35C(&StringLiteral_3018/*"CLASS_BOARD_LOCK_OPEN_CONFIRM_DIALOG_ITEM_DETAIL_WARNING"*/, v22);
    byte_4189508 = 1;
  }
  v69 = 0;
  v68 = 0LL;
  ...
  LockModel = LocalizationManager__Get((System_String_o *)StringLiteral_3019/*"CLASS_BOARD_LOCK_OPEN_CONFIRM_DIALOG_TITLE"*/, 0LL);
  if ( !titleLabel )
    goto LABEL_51;
  UILabel__set_text(titleLabel, LockModel, 0LL);
  if ( !square )
    goto LABEL_51;
  v39 = *(&ClassBoardLock_TypeInfo->_2.bitflags2 + 1);
  if ( *(&square->klass->_2.bitflags2 + 1) >= (unsigned int)v39
    && (ClassBoardLock_c *)square->klass->_2.typeHierarchy[v39 - 1] == ClassBoardLock_TypeInfo )
  {
    LockModel = (System_String_o *)ClassBoardLock__get_LockModel((ClassBoardLock_o *)square, v37);
    if ( !LockModel )
      goto LABEL_51;
    ...
    if ( *(_WORD *)&LockModel->klass->_2.bitflags1 )
    {
      ...
      while ( *((IClassBoardLockModel_c **)p_offset - 1) != IClassBoardLockModel_TypeInfo )
      {
        ++v43;
        p_offset += 4;
        if ( v43 >= *(unsigned __int16 *)&LockModel->klass->_2.bitflags1 )
          goto LABEL_15;
      }
    ...
    {
LABEL_15:
      v45 = sub_AC5258(LockModel, IClassBoardLockModel_TypeInfo, 0LL, v40);
    }
    v68 = (*(__int64 (__fastcall **)(System_String_o *, _QWORD))v45)(v42, *(_QWORD *)(v45 + 8));
    v69 = v46;
    *(_QWORD *)&v70.fields.Type = &v68;
    v70.fields.Num = 0;
    LockModel = (System_String_o *)ClassBoardCondData__get_HasCond(v70, v47);
    if ( ((unsigned __int8)LockModel & 1) != 0 )
    {
      ...
      if ( *(_WORD *)&LockModel->klass->_2.bitflags1 )
      {
        ...
        while ( *((IClassBoardLockModel_c **)v52 - 1) != IClassBoardLockModel_TypeInfo )
        {
          ++v51;
          v52 += 4;
          if ( v51 >= *(unsigned __int16 *)&LockModel->klass->_2.bitflags1 )
            goto LABEL_23;
        }
        v53 = (__int64)(&v49->vtable._0_Equals.method + 2 * *v52);
      }
      else
      {
LABEL_23:
        v53 = sub_AC5258(LockModel, IClassBoardLockModel_TypeInfo, 0LL, v48);
      }
      v54 = (*(__int64 (__fastcall **)(System_String_o *, _QWORD))v53)(v50, *(_QWORD *)(v53 + 8));
      v71.fields.Num = v55;
      *(_QWORD *)&v71.fields.Type = v54;
      ClassBoardBaseDialog__SetUpLockReleaseCondition((ClassBoardBaseDialog_o *)this, v71, 0LL);
    }
  }
  ...
  if ( *(_WORD *)&SquareModel_k__BackingField->klass->_2.bitflags1 )
  {
    ...
    p_method = (__int64)&v57->vtable[*(_DWORD *)v59 + 6].method;
  }
  else
  {
LABEL_31:
    p_method = sub_AC5258(SquareModel_k__BackingField, IClassBoardSquareModel_TypeInfo, 6LL, v38);
  }
  v61 = (System_Collections_Generic_IReadOnlyCollection_IClassBoardItemModel__o *)(*(__int64 (__fastcall **)(struct IClassBoardSquareModel_o *, _QWORD))p_method)(
  ...
  if ( !isEnableOpen )
  {
    ...
    LockModel = LocalizationManager__Get((System_String_o *)StringLiteral_3018/*"CLASS_BOARD_LOCK_OPEN_CONFIRM_DIALOG_ITEM_DETAIL_WARNING"*/, 0LL);
    if ( itemDetailLabel )
    {
...
LABEL_51:
  ...
  LockModel = LocalizationManager__Get((System_String_o *)StringLiteral_3017/*"CLASS_BOARD_LOCK_OPEN_CONFIRM_DIALOG_ITEM_DETAIL"*/, 0LL);
  if ( !itemDetailLabel )
    goto LABEL_51;
  UILabel__set_text(itemDetailLabel, LockModel, 0LL);
LABEL_45:
  ...
  LockModel = LocalizationManager__Get((System_String_o *)StringLiteral_3015/*"CLASS_BOARD_LOCK_OPEN_CONFIRM_DIALOG_CANCEL"*/, 0LL);
  if ( !cancelBtnLabel )
    goto LABEL_51;
  UILabel__set_text(cancelBtnLabel, LockModel, 0LL);
  decideBtnLabel = this->fields.decideBtnLabel;
  LockModel = LocalizationManager__Get((System_String_o *)StringLiteral_3016/*"CLASS_BOARD_LOCK_OPEN_CONFIRM_DIALOG_DECIDE"*/, 0LL);
  if ( !decideBtnLabel )
    goto LABEL_51;
  UILabel__set_text(decideBtnLabel, LockModel, 0LL);
  ClassBoardLockOpenConfirmDialog__SetDecideButton(this, this->fields.isDecideButtonEnable, v66);
  this->fields.isButtonEnable = 0;
  BaseDialog__SetMaskTouchCloseEnabled((BaseDialog_o *)this, 0, 0LL);
  v67 = (System_Action_o *)sub_B2C42C(System_Action_TypeInfo);
  System_Action___ctor(v67, (Il2CppObject *)this, Method_ClassBoardLockOpenConfirmDialog_EndOpen__, 0LL);
