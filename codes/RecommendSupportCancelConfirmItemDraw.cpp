        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FAD86 & 1) == 0 )
  {
    sub_1B64A00(&Method_DataManager_GetMasterData_UserServantMaster___, userServantEntity);
    ...
    sub_1B64A00(&StringLiteral_11456/*"SELECT_NO_SORTIE"*/, v12);
    sub_1B64A00(&StringLiteral_19479/*"formation_blank_small"*/, v13);
  ...
  if ( !userServantEntity )
  {
    ...
    if ( !equipIdList->m_Items[0] )
      goto LABEL_36;
    maskSprite = (UnityEngine_Component_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE930 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !maskSprite )
      goto LABEL_38;
    ...
    if ( !equipIdList->max_length )
LABEL_39:
      sub_1B64C64(maskSprite, userServantEntity);
    if ( maskSprite )
    {
...
LABEL_38:
    sub_1B64C5C(maskSprite, userServantEntity);
  }
  ...
  if ( UserServantEntity__IsHeroine(userServantEntity, 0LL) )
  {
    ...
    if ( TutorialFlag__Get_37381564(126, 0LL) )
    {
      ...
      maskSprite = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11456/*"SELECT_NO_SORTIE"*/, 0LL);
      if ( !warningText )
        goto LABEL_38;
  ...
  *(_OWORD *)&v23.fields.fakeValue = v18;
  ...
  v22 = v23;
  v20 = klass == (UnityEngine_Component_c *)CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_46185616(
                                              &v22,
                                              0LL);
  v21 = 0LL;
  if ( v20 )
