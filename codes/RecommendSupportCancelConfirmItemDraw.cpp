        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1DFBE & 1) == 0 )
  {
    sub_1C3B764(&Method_DataManager_GetMasterData_UserServantMaster___, userServantEntity);
    ...
    sub_1C3B764(&StringLiteral_19942/*"img_combine_12"*/, v13);
  ...
  if ( !userServantEntity )
  {
    ...
    if ( !equipIdList->max_length )
      goto LABEL_39;
    v21 = (System_String_o *)StringLiteral_19942/*"img_combine_12"*/;
    if ( !equipIdList->m_Items[0] )
      goto LABEL_36;
    maskSprite = (UnityEngine_Component_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !maskSprite )
      goto LABEL_38;
    ...
    if ( !equipIdList->max_length )
LABEL_39:
      sub_1C3B9C8(maskSprite, userServantEntity);
    if ( maskSprite )
    {
...
LABEL_38:
    sub_1C3B9C0(maskSprite, userServantEntity);
  }
  ...
  if ( UserServantEntity__IsHeroine(userServantEntity, 0LL) )
  {
    ...
    if ( TutorialFlag__Get_39109112(126, 0LL) )
    {
      ...
      maskSprite = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11742/*"SHOP_BULK_WINDOW_DESTINATION_KIND"*/, 0LL);
      if ( !warningText )
        goto LABEL_38;
  ...
  *(_OWORD *)&v23.fields.fakeValue = v18;
  ...
  v22 = v23;
  v20 = klass == (UnityEngine_Component_c *)CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_47886084(
                                              &v22,
                                              0LL);
  v21 = 0LL;
  if ( v20 )
