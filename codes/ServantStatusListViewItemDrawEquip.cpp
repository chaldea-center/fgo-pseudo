void ServantStatusListViewItemDrawEquip___cctor(const MethodInfo *method)
{
  if ( (byte_4E74608 & 1) == 0 )
  {
    sub_1D0F0B4(&ServantStatusListViewItemDrawEquip_TypeInfo);
    byte_4E74608 = 1;
  }
...
void ServantStatusListViewItemDrawEquip___ctor(ServantStatusListViewItemDrawEquip_o *this, const MethodInfo *method)
{
  ...
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.equipSkillBaseList, (int32_t)v4, v5, v6, v7, v8, v9, v10);
  ...
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.equipSkillIcon, (int32_t)v11, v12, v13, v14, v15, v16, v17);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E74606 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_12088/*"SERVANT_STATUS_EXPLANATION_EQUIP_ICON"*/);
  ...
  equipIcon = (SkillIconComponent_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12088/*"SERVANT_STATUS_EXPLANATION_EQUIP_ICON"*/, 0);
  if ( !explanationLabel )
    goto LABEL_186;
  ...
  if ( item->fields.userSvtEntity )
  {
    ...
    if ( (__int64)equipTargetId1 >= 1 )
    {
      if ( !equipIcon )
        goto LABEL_186;
      ServantFaceIconComponent__Set_42454776((ServantFaceIconComponent_o *)equipIcon, (int64_t)equipTargetId1, 0, 0, 0);
      goto LABEL_24;
    }
    if ( !equipIcon )
      goto LABEL_186;
LABEL_23:
  ...
  *(_QWORD *)&v103.fields.fakeValue = v12;
  equipIcon = (SkillIconComponent_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_50331200(v103, 0);
  ...
  if ( !v15 || !v14 )
    goto LABEL_186;
  ServantFaceIconComponent__Set_42461092(this->fields.equipIcon, v15->fields.equipTarget1, 0, 0, 0);
LABEL_24:
  ...
  if ( !attackIconLabel )
    goto LABEL_186;
  UIIconLabel__Set_42477084(attackIconLabel, 5, (int32_t)equipIcon, 0, 0, 0, 0, 0, 0, 0, 0);
  hpIconLabel = this->fields.hpIconLabel;
  equipIcon = (SkillIconComponent_o *)ServantStatusListViewItem__get_EquipHp(item, 0);
  if ( !hpIconLabel )
    goto LABEL_186;
  UIIconLabel__Set_42477084(hpIconLabel, 3, (int32_t)equipIcon, 0, 0, 0, 0, 0, 0, 0, 0);
...
LABEL_96:
  ...
  {
LABEL_186:
    sub_1D0F30C(equipIcon, equipTargetId1);
  }
...
LABEL_145:
    ...
    if ( userSvtEntity )
    {
      ...
      *(_QWORD *)&v104.fields.fakeValue = v82;
      equipIcon = (SkillIconComponent_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_50331200(v104, 0);
      if ( !item->fields.userSvtEntity )
        goto LABEL_186;
      v84 = (int)equipIcon;
    ...
    else
    {
      ...
      *(_QWORD *)&v105.fields.fakeValue = v92;
      equipIcon = (SkillIconComponent_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_50331200(v105, 0);
    ...
    v94 = Rarity;
LABEL_164:
    equipIcon = (SkillIconComponent_o *)SingletonTemplate_object___get_Instance((const MethodInfo_3BACB74 *)Method_SingletonTemplate_PartyOrganizationUtility__get_Instance__);
    if ( !equipIcon )
      goto LABEL_186;
    equipIcon = (SkillIconComponent_o *)PartyOrganizationUtility__IsRarityRestriction_35731404(
