void ServantStatusListViewItemDrawEquip___cctor(const MethodInfo *method)
{
  if ( (byte_4C23FC6 & 1) == 0 )
  {
    sub_1C2D490(&ServantStatusListViewItemDrawEquip_TypeInfo);
    byte_4C23FC6 = 1;
  }
...
void ServantStatusListViewItemDrawEquip___ctor(ServantStatusListViewItemDrawEquip_o *this, const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.equipSkillBaseList, (int32_t)v4, v5, v6);
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.equipSkillIcon, (int32_t)v7, v8, v9);
...
void ServantStatusListViewItemDrawEquip__Awake(ServantStatusListViewItemDrawEquip_o *this, const MethodInfo *method)
{
  ...
  v9 = v3->fields.skillPitch * LODWORD(equipSkillBaseList->max_length);
  ...
  v11 = v9 >= 0 ? v9 : v9 + 1;
  v12 = v3->fields.equipSkillBaseList;
  v13 = (float)(v11 >> 1);
...
LABEL_25:
  ...
  this = (ServantStatusListViewItemDrawEquip_o *)v12->m_Items[0];
  if ( !this )
    goto LABEL_24;
  this = (ServantStatusListViewItemDrawEquip_o *)UnityEngine_GameObject__get_transform(
                                                   (UnityEngine_GameObject_o *)this,
        ...
        const MethodInfo *method)
{
  ...
  struct UIRangeLabel_array *v97; // x8
  ...
  equipIcon = (SkillIconComponent_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11910/*"SERVANT_STATUS_EXPLANATION_EQUIP_ICON"*/, 0);
  if ( !explanationLabel )
    goto LABEL_189;
  ...
  if ( item->fields.userSvtEntity )
  {
    ...
    if ( (__int64)equipTargetId1 >= 1 )
    {
      if ( !equipIcon )
        goto LABEL_189;
      ServantFaceIconComponent__Set_40783536((ServantFaceIconComponent_o *)equipIcon, (int64_t)equipTargetId1, 0, 0, 0);
      goto LABEL_24;
    }
    if ( !equipIcon )
      goto LABEL_189;
LABEL_23:
  ...
  *(_QWORD *)&v104.fields.fakeValue = v12;
  equipIcon = (SkillIconComponent_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v104, 0);
  ...
  if ( !v15 || !v14 )
    goto LABEL_189;
  ServantFaceIconComponent__Set_40789832(this->fields.equipIcon, v15->fields.equipTarget1, 0, 0, 0);
LABEL_24:
  ...
  if ( !attackIconLabel )
    goto LABEL_189;
  UIIconLabel__Set_40889008(attackIconLabel, 5, (int32_t)equipIcon, 0, 0, 0, 0, 0, 0, 0, 0);
  hpIconLabel = this->fields.hpIconLabel;
  equipIcon = (SkillIconComponent_o *)ServantStatusListViewItem__get_EquipHp(item, 0);
  if ( !hpIconLabel )
    goto LABEL_189;
  UIIconLabel__Set_40889008(hpIconLabel, 3, (int32_t)equipIcon, 0, 0, 0, 0, 0, 0, 0, 0);
...
LABEL_190:
          sub_1C2D6F4(equipIcon, equipTargetId1, v29);
...
LABEL_96:
  ...
  if ( UnityEngine_Object__op_Inequality(baseCollider, 0, 0) )
  {
    ...
    v107.fields.y = v64;
    v107.fields.z = z;
    UnityEngine_BoxCollider__set_size((UnityEngine_BoxCollider_o *)equipIcon, v107, 0);
  }
  ...
  {
LABEL_189:
    sub_1C2D6EC(equipIcon, equipTargetId1);
  }
...
LABEL_145:
    ...
    if ( userSvtEntity )
    {
      ...
      *(_QWORD *)&v105.fields.fakeValue = v83;
      equipIcon = (SkillIconComponent_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v105, 0);
      if ( !item->fields.userSvtEntity )
        goto LABEL_189;
      v85 = (int)equipIcon;
    ...
    else
    {
      ...
      if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
      *(_QWORD *)&v106.fields.currentCryptoKey = v94;
      *(_QWORD *)&v106.fields.fakeValue = v93;
      equipIcon = (SkillIconComponent_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v106, 0);
    ...
    v95 = Rarity;
LABEL_164:
    equipIcon = (SkillIconComponent_o *)SingletonTemplate_object___get_Instance((const MethodInfo_39D40EC *)Method_SingletonTemplate_PartyOrganizationUtility__get_Instance__);
    if ( !equipIcon )
      goto LABEL_189;
    equipIcon = (SkillIconComponent_o *)PartyOrganizationUtility__IsRarityRestriction_34293952(
    ...
    if ( ((unsigned __int8)equipIcon & 1) != 0 )
    {
      ...
      if ( !v96 )
        goto LABEL_189;
      if ( v75 >= LODWORD(v96->max_length) )
        goto LABEL_190;
      equipIcon = v96->m_Items[v75];
      if ( !equipIcon )
        goto LABEL_189;
      SkillIconComponent__SetInvalidColor(equipIcon, this->fields.COLOR_INVALID, 0);
      v97 = this->fields.equipSkillTitleRangeLabelList;
      if ( !v97 )
        goto LABEL_189;
      if ( v75 >= LODWORD(v97->max_length) )
        goto LABEL_190;
      equipIcon = (SkillIconComponent_o *)v97->m_Items[v75];
      if ( !equipIcon )
        goto LABEL_189;
...
LABEL_146:
    v87 = this->fields.equipSkillBaseList;
    if ( !v87 )
      goto LABEL_189;
    if ( v75 >= LODWORD(v87->max_length) )
      goto LABEL_190;
    equipIcon = (SkillIconComponent_o *)v87->m_Items[v75];
    if ( equipIcon )
    {
      UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)equipIcon, (bool)equipTargetId1, 0);
      v88 = this->fields.equipSkillExplanationLabelList;
      if ( v88 )
      {
        ...
        if ( v89 )
        {
          ...
          v91 = *((_DWORD *)equipIcon[2].monitor + 1) + mHeight;
