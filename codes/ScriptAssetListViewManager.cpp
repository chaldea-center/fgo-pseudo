...
void ScriptAssetListViewManager__CreateList(ScriptAssetListViewManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E74BE0 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&ScriptAssetListViewItem_TypeInfo);
  ...
  AssetStorageList = (System_Collections_Generic_List_object__o *)AssetManager__getAssetStorageList(
                                                                    (System_String_o *)StringLiteral_12812/*"ScriptActionEncrypt"*/,
                                                                    0);
  if ( !AssetStorageList )
    goto LABEL_16;
  ...
  if ( (int)v5 >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      v11 = sub_1D0F300(ScriptAssetListViewItem_TypeInfo);
...
LABEL_16:
    sub_1D0F30C(AssetStorageList, v4);
  }
LABEL_15:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E74BE3 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_System_Collections_Generic_List_Enumerator_ScriptAssetListViewObject__Dispose__);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_Enumerator_ScriptAssetListViewObject__MoveNext__);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_Enumerator_ScriptAssetListViewObject__get_Current__);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_ScriptAssetListViewObject__GetEnumerator__);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_ScriptAssetListViewObject__get_Count__);
    sub_1D0F0B4(&Method_ScriptAssetListViewManager_OnMoveEnd__);
  ...
  else
  {
    ...
    System_Collections_Generic_List_object___GetEnumerator(
      ...
      ObjectList,
      (const MethodInfo_395CF08 *)Method_System_Collections_Generic_List_ScriptAssetListViewObject__GetEnumerator__);
    while ( System_Collections_Generic_List_Enumerator_object___MoveNext(
              &v15,
              (const MethodInfo_36CDF88 *)Method_System_Collections_Generic_List_Enumerator_ScriptAssetListViewObject__MoveNext__) )
    {
      ...
      if ( !current )
        sub_1D0F30C(v12, v13);
      ScriptAssetListViewObject__Init_38732280((ScriptAssetListViewObject_o *)current, mode, v11, delay, v14);
    }
    System_Collections_Generic_List_Enumerator_object___Dispose(
      &v15,
      (const MethodInfo_36CDF84 *)Method_System_Collections_Generic_List_Enumerator_ScriptAssetListViewObject__Dispose__);
  }
}


// local variable allocation has failed, the output may be wrong!
void ScriptAssetListViewManager__RequestListObject_38731252(
        ScriptAssetListViewManager_o *this,
        int32_t mode,
        const MethodInfo *method)
{
  ...
  else
  {
              ...
              (const MethodInfo_36CDF88 *)Method_System_Collections_Generic_List_Enumerator_ScriptAssetListViewObject__MoveNext__) )
    {
      ...
      if ( !current )
        sub_1D0F30C(v10, v11);
      ScriptAssetListViewObject__Init_38732364((ScriptAssetListViewObject_o *)current, mode, v9, v12);
    }
    System_Collections_Generic_List_Enumerator_object___Dispose(
      &v13,
      (const MethodInfo_36CDF84 *)Method_System_Collections_Generic_List_Enumerator_ScriptAssetListViewObject__Dispose__);
...
void ScriptAssetListViewManager__SetMode(ScriptAssetListViewManager_o *this, int32_t mode, const MethodInfo *method)
{
  ...
  ScriptAssetListViewManager__SetMode_38731132(this, mode, 0, v3);
}


void ScriptAssetListViewManager__SetMode_38731132(
        ScriptAssetListViewManager_o *this,
        int32_t mode,
        ...
        const MethodInfo *method)
{
  ...
  if ( mode == 1 )
  {
    ...
    ScriptAssetListViewManager__RequestListObject_38731252(this, 3, v10);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E74BE2 & 1) == 0 )
  {
    this = (ScriptAssetListViewManager_o *)sub_1D0F0B4(&ScriptAssetListViewObject_TypeInfo);
    byte_4E74BE2 = 1;
  }
  if ( !obj
  ...
  if ( v5->fields.initMode == 1 )
    ...
    v7 = 2;
  ScriptAssetListViewObject__Init_38731052((ScriptAssetListViewObject_o *)obj, v7, (const MethodInfo *)item);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E74BDF & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_UnityEngine_GameObject_GetComponent_ScriptAssetListViewObject___);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_ScriptAssetListViewObject__Add__);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_GameObject__GetEnumerator__);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_ScriptAssetListViewObject___ctor__);
    sub_1D0F0B4(&System_Collections_Generic_List_ScriptAssetListViewObject__TypeInfo);
    sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    byte_4E74BDF = 1;
  }
  memset(&v23, 0, sizeof(v23));
  v3 = (System_Collections_Generic_List_object__o *)sub_1D0F300(System_Collections_Generic_List_ScriptAssetListViewObject__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v3,
    (const MethodInfo_395BBDC *)Method_System_Collections_Generic_List_ScriptAssetListViewObject___ctor__);
            ...
            (const MethodInfo_36CDF88 *)Method_System_Collections_Generic_List_Enumerator_GameObject__MoveNext__) )
  {
    ...
    if ( v7 )
    {
      ...
      Component_object = UnityEngine_GameObject__GetComponent_object_(
                           ...
                           (const MethodInfo_32A8444 *)Method_UnityEngine_GameObject_GetComponent_ScriptAssetListViewObject___);
