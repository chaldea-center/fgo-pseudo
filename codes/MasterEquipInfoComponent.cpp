...
int32_t __fastcall MasterEquipInfoComponent__getEquipId(MasterEquipInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B30A0 & 1) == 0 )
  {
    this = (MasterEquipInfoComponent_o *)sub_B52984(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    byte_42B30A0 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B309D & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_8686/*"MASTER_EQUIP_SKILL_INFO_TXT"*/);
    sub_B52984(&StringLiteral_8683/*"MASTER_EQUIP_EXPLANATION_TXT"*/);
    byte_42B309D = 1;
  }
  condUsrLv = 0;
  maxLv = 0;
  ...
  *(_QWORD *)lateExp = 0LL;
  ...
  {
LABEL_46:
    sub_B52A5C(equipStatusInfo, usrEquipData);
  }
...
LABEL_19:
  ...
  equipStatusInfo = (UnityEngine_GameObject_o *)System_Int32__ToString_39387012(
                                                  (int32_t)&lateExp[1],
  ...
  equipStatusInfo = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8686/*"MASTER_EQUIP_SKILL_INFO_TXT"*/, 0LL);
  if ( !skillCheckHelpLb )
    goto LABEL_46;
  UILabel__set_text(skillCheckHelpLb, (System_String_o *)equipStatusInfo, 0LL);
  equipChangeHelpLb = this->fields.equipChangeHelpLb;
  equipStatusInfo = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8683/*"MASTER_EQUIP_EXPLANATION_TXT"*/, 0LL);
...
void __fastcall MasterEquipInfoComponent__setEquipSkillInfo(MasterEquipInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B309E & 1) == 0 )
  {
    sub_B52984(&EquipSkillInfoComponent_ClickDelegate_TypeInfo);
    ...
    sub_B52984(&Method_UnityEngine_GameObject_GetComponent_EquipSkillInfoComponent___);
    sub_B52984(&Method_MasterEquipInfoComponent_setSkillCallBack__);
  ...
  if ( (int)userId >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      usrEquipEnt = (UserEquipEntity_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( !usrEquipEnt )
        break;
      ...
      *(UnityEngine_Vector3_o *)&v19 = UnityEngine_Transform__get_localPosition(
      ...
      Component_srcLineSprite = (EquipSkillInfoComponent_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                               v13,
                                                               (const MethodInfo_1B7B1B8 *)Method_UnityEngine_GameObject_GetComponent_EquipSkillInfoComponent___);
      v23 = (EquipSkillInfoComponent_ClickDelegate_o *)sub_B52A54(EquipSkillInfoComponent_ClickDelegate_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v11 = LocalizationManager__Get((System_String_o *)StringLiteral_8682/*"MASTER_EQSKILL_LV_TXT"*/, 0LL);
  v18 = skillLv;
  v12 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v18);
  v13 = System_String__Format(v11, v12, 0LL);
  name = System_String__Concat_44570600(v10, (System_String_o *)StringLiteral_81/*" "*/, v13, 0LL);
  ...
  if ( !v9
    || (v14 = (System_String_o *)Instance,
        ...
        v15 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &datalist),
...
LABEL_14:
  ...
  CommonUI__OpenDetailLongInfoDialog((CommonUI_o *)Instance, name, v16, detail, 0, 0, 0LL);
}