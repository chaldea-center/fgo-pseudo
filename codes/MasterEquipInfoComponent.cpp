...
int32_t __fastcall MasterEquipInfoComponent__getEquipId(MasterEquipInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1D09C & 1) == 0 )
  {
    this = (MasterEquipInfoComponent_o *)sub_1C3B764(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, method);
    byte_4C1D09C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1D099 & 1) == 0 )
  {
    sub_1C3B764(&AtlasManager_TypeInfo, usrEquipData);
    sub_1C3B764(&Grade_TypeInfo, v10);
    ...
    sub_1C3B764(&StringLiteral_405/*"#0039E2"*/, v14);
    sub_1C3B764(&StringLiteral_8703/*"Marathi (India)"*/, v15);
    sub_1C3B764(&StringLiteral_8700/*"Mapudungun (Chile)"*/, v16);
    byte_4C1D099 = 1;
  }
  equipName = 0LL;
  maxLv = 0LL;
  ...
  *(_QWORD *)barExp = 0LL;
  ...
  sub_1C3B708(&this->fields.effectObj);
  ...
  if ( !byte_4C1C511 )
  {
    equipStatusInfo = (UnityEngine_GameObject_o *)sub_1C3B764(&UnityEngine_Vector3_TypeInfo, usrEquipData);
    byte_4C1C511 = 1;
  }
  if ( !v21 )
    goto LABEL_44;
  ...
  if ( !v22 )
LABEL_44:
    sub_1C3B9C0(equipStatusInfo, usrEquipData);
...
LABEL_22:
  ...
  equipStatusInfo = (UnityEngine_GameObject_o *)System_Int32__ToString_64174220(
                                                  (int32_t)&barExp[1],
  ...
  sub_1C3B708(&this->fields.usrEquipEnt);
  ...
  equipStatusInfo = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8703/*"Marathi (India)"*/, 0LL);
  if ( !skillCheckHelpLb )
    goto LABEL_44;
  UILabel__set_text(skillCheckHelpLb, (System_String_o *)equipStatusInfo, 0LL);
  equipChangeHelpLb = this->fields.equipChangeHelpLb;
  equipStatusInfo = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8700/*"Mapudungun (Chile)"*/, 0LL);
...
void __fastcall MasterEquipInfoComponent__setEquipSkillInfo(MasterEquipInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1D09A & 1) == 0 )
  {
    sub_1C3B764(&EquipSkillInfoComponent_ClickDelegate_TypeInfo, method);
    sub_1C3B764(&Method_DataManager_GetMasterData_SkillMaster___, v3);
    sub_1C3B764(&Method_DataMasterBase_SkillMaster__SkillEntity__int__GetEntity__, v4);
    sub_1C3B764(&Method_UnityEngine_GameObject_GetComponent_EquipSkillInfoComponent___, v5);
    sub_1C3B764(&Method_MasterEquipInfoComponent_setSkillCallBack__, v6);
  ...
  if ( (int)v9 >= 1 )
  {
    ...
    while ( 1 )
    {
      if ( v11 >= (unsigned int)v9 )
        sub_1C3B9C8(usrEquipEnt, method);
      usrEquipEnt = (__int64)this->fields.usrEquipEnt;
      if ( !usrEquipEnt )
        break;
      ...
      usrEquipEnt = (__int64)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( !usrEquipEnt )
        break;
      ...
      if ( !byte_4C1C516 )
      {
        usrEquipEnt = sub_1C3B764(&UnityEngine_Vector3_TypeInfo, method);
        byte_4C1C516 = 1;
      }
      if ( !v18 )
        break;
      ...
      *(UnityEngine_Vector3_o *)&v20 = UnityEngine_Transform__get_localPosition(
      ...
      Component_object = UnityEngine_GameObject__GetComponent_object_(
                           v17,
                           (const MethodInfo_3041A18 *)Method_UnityEngine_GameObject_GetComponent_EquipSkillInfoComponent___);
      v24 = (EquipSkillInfoComponent_ClickDelegate_o *)sub_1C3B9B0(EquipSkillInfoComponent_ClickDelegate_TypeInfo);
...
LABEL_24:
    sub_1C3B9C0(usrEquipEnt, method);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1D09B & 1) == 0 )
  {
    sub_1C3B764(&Method_DataManager_GetMasterData_SkillLvMaster___, *(_QWORD *)&skillId);
    sub_1C3B764(&Method_DataManager_GetMasterData_SkillMaster___, v6);
    sub_1C3B764(&Method_DataMasterBase_SkillMaster__SkillEntity__int__GetEntity__, v7);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v20 = LocalizationManager__Get((System_String_o *)StringLiteral_8699/*"Mapping for neutral culture "*/, 0LL);
  v33 = skillLv;
  v24 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v33, v21, v22, v23);
  v25 = System_String__Format(v20, v24, 0LL);
  name = System_String__Concat_63379872(v19, (System_String_o *)StringLiteral_117/*"   "*/, v25, 0LL);
