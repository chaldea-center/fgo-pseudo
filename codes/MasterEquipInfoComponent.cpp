...
int32_t MasterEquipInfoComponent__getEquipId(MasterEquipInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C51B9A & 1) == 0 )
  {
    this = (MasterEquipInfoComponent_o *)sub_1C3E564(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    byte_4C51B9A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C51B97 & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_8554/*"MASTER_EQUIP_SKILL_INFO_TXT"*/);
    sub_1C3E564(&StringLiteral_8551/*"MASTER_EQUIP_EXPLANATION_TXT"*/);
    byte_4C51B97 = 1;
  }
  equipName = 0;
  *(_QWORD *)maxLv = 0;
  *(_QWORD *)genderImageId = 0;
  ...
  sub_1C3E508(&this->fields.effectObj, v12);
  ...
  if ( !byte_4C506A1 )
  {
    equipStatusInfo = (UnityEngine_GameObject_o *)sub_1C3E564(&UnityEngine_Vector3_TypeInfo);
    byte_4C506A1 = 1;
  }
  if ( !v15 )
    goto LABEL_44;
  ...
  if ( !v16 )
LABEL_44:
    sub_1C3E7C0(equipStatusInfo, usrEquipData);
...
LABEL_22:
  ...
  equipStatusInfo = (UnityEngine_GameObject_o *)System_Int32__ToString_65146576(
                                                  (int32_t)&barExp + 4,
  ...
  sub_1C3E508(&this->fields.usrEquipEnt, usrEquipData);
  ...
  equipStatusInfo = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8554/*"MASTER_EQUIP_SKILL_INFO_TXT"*/, 0);
  if ( !skillCheckHelpLb )
    goto LABEL_44;
  UILabel__set_text(skillCheckHelpLb, (System_String_o *)equipStatusInfo, 0);
  equipChangeHelpLb = this->fields.equipChangeHelpLb;
  equipStatusInfo = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8551/*"MASTER_EQUIP_EXPLANATION_TXT"*/, 0);
...
void MasterEquipInfoComponent__setEquipSkillInfo(MasterEquipInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C51B98 & 1) == 0 )
  {
    sub_1C3E564(&EquipSkillInfoComponent_ClickDelegate_TypeInfo);
    ...
    sub_1C3E564(&Method_UnityEngine_GameObject_GetComponent_EquipSkillInfoComponent___);
    sub_1C3E564(&Method_MasterEquipInfoComponent_setSkillCallBack__);
  ...
  if ( (int)v4 >= 1 )
  {
    ...
    while ( 1 )
    {
      if ( v6 >= (unsigned int)v4 )
        sub_1C3E7C8(usrEquipEnt, method);
      usrEquipEnt = (__int64)this->fields.usrEquipEnt;
      if ( !usrEquipEnt )
        break;
      ...
      usrEquipEnt = (__int64)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39FF5A8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( !usrEquipEnt )
        break;
      ...
      if ( !byte_4C506A6 )
      {
        usrEquipEnt = sub_1C3E564(&UnityEngine_Vector3_TypeInfo);
        byte_4C506A6 = 1;
      }
      if ( !v13 )
        break;
      ...
      Component_object = UnityEngine_GameObject__GetComponent_object_(
                           v12,
                           (const MethodInfo_31510CC *)Method_UnityEngine_GameObject_GetComponent_EquipSkillInfoComponent___);
      v16 = (EquipSkillInfoComponent_ClickDelegate_o *)sub_1C3E7B0(EquipSkillInfoComponent_ClickDelegate_TypeInfo);
...
LABEL_24:
    sub_1C3E7C0(usrEquipEnt, method);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v11 = LocalizationManager__Get((System_String_o *)StringLiteral_8550/*"MASTER_EQSKILL_LV_TXT"*/, 0);
  v30 = skillLv;
  v18 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v30, v12, v13, v14, v15, v16, v17);
  v19 = System_String__Format(v11, v18, 0);
  name = System_String__Concat_63674716(v10, (System_String_o *)StringLiteral_113/*" "*/, v19, 0);
  ...
  if ( !v9
    || (v26 = (System_String_o *)Instance,
        ...
        (Instance = (DataManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39FF5A8 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__)) == 0) )
  {
LABEL_13:
    sub_1C3E7C0(Instance, v7);
  }
  CommonUI__OpenDetailLongInfoDialog((CommonUI_o *)Instance, name, v28, detail, 0, 0, 0);
}