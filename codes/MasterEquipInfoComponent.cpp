...
int32_t __fastcall MasterEquipInfoComponent__getEquipId(MasterEquipInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB1113 & 1) == 0 )
  {
    this = (MasterEquipInfoComponent_o *)sub_1BAB41C(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, method);
    byte_4AB1113 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB1110 & 1) == 0 )
  {
    sub_1BAB41C(&AtlasManager_TypeInfo, usrEquipData);
    sub_1BAB41C(&Grade_TypeInfo, v10);
    ...
    sub_1BAB41C(&StringLiteral_424/*"#,0"*/, v14);
    sub_1BAB41C(&StringLiteral_8530/*"MASTER_EQUIP_SKILL_INFO_TXT"*/, v15);
    sub_1BAB41C(&StringLiteral_8527/*"MASTER_EQUIP_EXPLANATION_TXT"*/, v16);
    byte_4AB1110 = 1;
  }
  equipName = 0LL;
  maxLv = 0LL;
  ...
  *(_QWORD *)barExp = 0LL;
  ...
  sub_1BAB3C0(&this->fields.effectObj);
  ...
  if ( !byte_4AB0691 )
  {
    equipStatusInfo = (UnityEngine_GameObject_o *)sub_1BAB41C(&UnityEngine_Vector3_TypeInfo, usrEquipData);
    byte_4AB0691 = 1;
  }
  if ( !v21 )
    goto LABEL_44;
  ...
  if ( !v22 )
LABEL_44:
    sub_1BAB678(equipStatusInfo, usrEquipData);
...
LABEL_22:
  ...
  equipStatusInfo = (UnityEngine_GameObject_o *)System_Int32__ToString_62853408(
                                                  (int32_t)&barExp[1],
  ...
  sub_1BAB3C0(&this->fields.usrEquipEnt);
  ...
  equipStatusInfo = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8530/*"MASTER_EQUIP_SKILL_INFO_TXT"*/, 0LL);
  if ( !skillCheckHelpLb )
    goto LABEL_44;
  UILabel__set_text(skillCheckHelpLb, (System_String_o *)equipStatusInfo, 0LL);
  equipChangeHelpLb = this->fields.equipChangeHelpLb;
  equipStatusInfo = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8527/*"MASTER_EQUIP_EXPLANATION_TXT"*/, 0LL);
...
void __fastcall MasterEquipInfoComponent__setEquipSkillInfo(MasterEquipInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB1111 & 1) == 0 )
  {
    sub_1BAB41C(&EquipSkillInfoComponent_ClickDelegate_TypeInfo, method);
    ...
    sub_1BAB41C(&Method_UnityEngine_GameObject_GetComponent_EquipSkillInfoComponent___, v5);
    sub_1BAB41C(&Method_MasterEquipInfoComponent_setSkillCallBack__, v6);
  ...
  if ( (int)v9 >= 1 )
  {
    ...
    while ( 1 )
    {
      if ( v11 >= (unsigned int)v9 )
        sub_1BAB680(usrEquipEnt, method);
      usrEquipEnt = (__int64)this->fields.usrEquipEnt;
      if ( !usrEquipEnt )
        break;
      ...
      usrEquipEnt = (__int64)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_378A22C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( !usrEquipEnt )
        break;
      ...
      if ( !byte_4AB0696 )
      {
        usrEquipEnt = sub_1BAB41C(&UnityEngine_Vector3_TypeInfo, method);
        byte_4AB0696 = 1;
      }
      if ( !v18 )
        break;
      ...
      *(UnityEngine_Vector3_o *)&v20 = UnityEngine_Transform__get_localPosition(
      ...
      Component_object = UnityEngine_GameObject__GetComponent_object_(
                           v17,
                           (const MethodInfo_2F13970 *)Method_UnityEngine_GameObject_GetComponent_EquipSkillInfoComponent___);
      v24 = (EquipSkillInfoComponent_ClickDelegate_o *)sub_1BAB668(EquipSkillInfoComponent_ClickDelegate_TypeInfo);
...
LABEL_24:
    sub_1BAB678(usrEquipEnt, method);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB1112 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMasterData_SkillLvMaster___, *(_QWORD *)&skillId);
    sub_1BAB41C(&Method_DataManager_GetMasterData_SkillMaster___, v6);
    sub_1BAB41C(&Method_DataMasterBase_SkillMaster__SkillEntity__int__GetEntity__, v7);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v20 = LocalizationManager__Get((System_String_o *)StringLiteral_8526/*"MASTER_EQSKILL_LV_TXT"*/, 0LL);
  v33 = skillLv;
  v24 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v33, v21, v22, v23);
  v25 = System_String__Format(v20, v24, 0LL);
  name = System_String__Concat_62059388(v19, (System_String_o *)StringLiteral_116/*" "*/, v25, 0LL);
