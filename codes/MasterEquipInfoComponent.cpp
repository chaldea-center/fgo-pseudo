...
int32_t MasterEquipInfoComponent__getEquipId(MasterEquipInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E722B3 & 1) == 0 )
  {
    this = (MasterEquipInfoComponent_o *)sub_1D0F0B4(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    byte_4E722B3 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E722B0 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_8656/*"MASTER_EQUIP_SKILL_INFO_TXT"*/);
    sub_1D0F0B4(&StringLiteral_8653/*"MASTER_EQUIP_EXPLANATION_TXT"*/);
    byte_4E722B0 = 1;
  }
  equipName = 0;
  *(_QWORD *)maxLv = 0;
  *(_QWORD *)genderImageId = 0;
  ...
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.effectObj, (int32_t)v12, v14, v15, v16, v17, v18, v19);
  ...
  if ( !byte_4E70C99 )
  {
    equipStatusInfo = (UnityEngine_GameObject_o *)sub_1D0F0B4(&UnityEngine_Vector3_TypeInfo);
    byte_4E70C99 = 1;
  }
  if ( !v21 )
    goto LABEL_44;
  ...
  if ( !v22 )
LABEL_44:
    sub_1D0F30C(equipStatusInfo, usrEquipData);
...
LABEL_22:
  ...
  equipStatusInfo = (UnityEngine_GameObject_o *)System_Int32__ToString_67071420(
                                                  (int32_t)&barExp + 4,
  ...
  equipStatusInfo = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8656/*"MASTER_EQUIP_SKILL_INFO_TXT"*/, 0);
  if ( !skillCheckHelpLb )
    goto LABEL_44;
  UILabel__set_text(skillCheckHelpLb, (System_String_o *)equipStatusInfo, 0);
  equipChangeHelpLb = this->fields.equipChangeHelpLb;
  equipStatusInfo = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8653/*"MASTER_EQUIP_EXPLANATION_TXT"*/, 0);
...
void MasterEquipInfoComponent__setEquipSkillInfo(MasterEquipInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E722B1 & 1) == 0 )
  {
    sub_1D0F0B4(&EquipSkillInfoComponent_ClickDelegate_TypeInfo);
    ...
    sub_1D0F0B4(&Method_UnityEngine_GameObject_GetComponent_EquipSkillInfoComponent___);
    sub_1D0F0B4(&Method_MasterEquipInfoComponent_setSkillCallBack__);
  ...
  if ( (int)v4 >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      usrEquipEnt = (__int64)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3BAC684 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( !usrEquipEnt )
        break;
      ...
      if ( !byte_4E70C9E )
      {
        usrEquipEnt = sub_1D0F0B4(&UnityEngine_Vector3_TypeInfo);
        byte_4E70C9E = 1;
      }
      if ( !v13 )
        break;
      ...
      Component_object = UnityEngine_GameObject__GetComponent_object_(
                           v12,
                           (const MethodInfo_32A8444 *)Method_UnityEngine_GameObject_GetComponent_EquipSkillInfoComponent___);
      v16 = (EquipSkillInfoComponent_ClickDelegate_o *)sub_1D0F300(EquipSkillInfoComponent_ClickDelegate_TypeInfo);
...
LABEL_24:
    sub_1D0F30C(usrEquipEnt, method);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v11 = LocalizationManager__Get((System_String_o *)StringLiteral_8652/*"MASTER_EQSKILL_LV_TXT"*/, 0);
  v18 = skillLv;
  v12 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v18);
  v13 = System_String__Format(v11, v12, 0);
  name = System_String__Concat_65601036(v10, (System_String_o *)StringLiteral_113/*" "*/, v13, 0);
  ...
  if ( !v9
    || (v14 = (System_String_o *)Instance,
        ...
        (Instance = (DataManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3BAC684 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__)) == 0) )
  {
LABEL_13:
