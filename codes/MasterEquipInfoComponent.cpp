...
int32_t MasterEquipInfoComponent__getEquipId(MasterEquipInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2B694 & 1) == 0 )
  {
    this = (MasterEquipInfoComponent_o *)sub_1C93AD4(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    byte_4D2B694 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2B691 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_8603/*"MASTER_EQUIP_SKILL_INFO_TXT"*/);
    sub_1C93AD4(&StringLiteral_8600/*"MASTER_EQUIP_EXPLANATION_TXT"*/);
    byte_4D2B691 = 1;
  }
  equipName = 0;
  maxLv = 0;
  *(_QWORD *)genderImageId = 0;
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.effectObj, (int32_t)v12, v14, v15, v16, v17, v18, v19);
  ...
  if ( !byte_4D2A139 )
  {
    equipStatusInfo = (UnityEngine_GameObject_o *)sub_1C93AD4(&UnityEngine_Vector3_TypeInfo);
    byte_4D2A139 = 1;
  }
  if ( !v21 )
    goto LABEL_44;
  ...
  if ( !v22 )
LABEL_44:
    sub_1C93D2C(equipStatusInfo, usrEquipData);
...
LABEL_22:
  ...
  equipStatusInfo = (UnityEngine_GameObject_o *)System_Int32__ToString_65934220(
                                                  (int32_t)&barExp + 4,
  ...
  equipStatusInfo = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8603/*"MASTER_EQUIP_SKILL_INFO_TXT"*/, 0);
  if ( !skillCheckHelpLb )
    goto LABEL_44;
  UILabel__set_text(skillCheckHelpLb, (System_String_o *)equipStatusInfo, 0);
  equipChangeHelpLb = this->fields.equipChangeHelpLb;
  equipStatusInfo = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8600/*"MASTER_EQUIP_EXPLANATION_TXT"*/, 0);
...
void MasterEquipInfoComponent__setEquipSkillInfo(MasterEquipInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2B692 & 1) == 0 )
  {
    sub_1C93AD4(&EquipSkillInfoComponent_ClickDelegate_TypeInfo);
    ...
    sub_1C93AD4(&Method_UnityEngine_GameObject_GetComponent_EquipSkillInfoComponent___);
    sub_1C93AD4(&Method_MasterEquipInfoComponent_setSkillCallBack__);
  ...
  if ( (int)v4 >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      usrEquipEnt = (__int64)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3AC52FC *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( !usrEquipEnt )
        break;
      ...
      if ( !byte_4D2A13E )
      {
        usrEquipEnt = sub_1C93AD4(&UnityEngine_Vector3_TypeInfo);
        byte_4D2A13E = 1;
      }
      if ( !v13 )
        break;
      ...
      Component_object = UnityEngine_GameObject__GetComponent_object_(
                           v12,
                           (const MethodInfo_31FC084 *)Method_UnityEngine_GameObject_GetComponent_EquipSkillInfoComponent___);
      v16 = (EquipSkillInfoComponent_ClickDelegate_o *)sub_1C93D20(EquipSkillInfoComponent_ClickDelegate_TypeInfo);
...
LABEL_24:
    sub_1C93D2C(usrEquipEnt, method);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v11 = LocalizationManager__Get((System_String_o *)StringLiteral_8599/*"MASTER_EQSKILL_LV_TXT"*/, 0);
  v18 = skillLv;
  v12 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v18);
  v13 = System_String__Format(v11, v12, 0);
  name = System_String__Concat_64463988(v10, (System_String_o *)StringLiteral_113/*" "*/, v13, 0);
  ...
  if ( !v9
    || (v14 = (System_String_o *)Instance,
        ...
        (Instance = (DataManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3AC52FC *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__)) == 0) )
  {
LABEL_13:
