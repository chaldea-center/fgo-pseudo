...
int32_t MasterEquipInfoComponent__getEquipId(MasterEquipInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_59332AD & 1) == 0 )
  {
    this = (MasterEquipInfoComponent_o *)sub_21FFC50(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    byte_59332AD = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_59332AA & 1) == 0 )
  {
    ...
    sub_21FFC50(&StringLiteral_8904/*"MASTER_EQUIP_SKILL_INFO_TXT"*/);
    sub_21FFC50(&StringLiteral_8901/*"MASTER_EQUIP_EXPLANATION_TXT"*/);
    byte_59332AA = 1;
  }
  ...
  *(_QWORD *)genderImageId = 0;
  ...
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&this->fields.effectObj, (int32_t)v14, v16, v17, v18, v19, v20, v21);
  ...
  if ( !byte_5931940 )
  {
    equipStatusInfo = (UnityEngine_GameObject_o *)sub_21FFC50(&UnityEngine_Vector3_TypeInfo);
    byte_5931940 = 1;
  }
  if ( !v23 )
    goto LABEL_44;
  ...
  if ( !v24 )
LABEL_44:
    sub_21FFECC(equipStatusInfo, usrEquipData);
...
LABEL_22:
  ...
  equipStatusInfo = (UnityEngine_GameObject_o *)System_Int32__ToString_76925352(
                                                  (int32_t)&barExp + 4,
  ...
  equipStatusInfo = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8904/*"MASTER_EQUIP_SKILL_INFO_TXT"*/, 0);
  if ( !skillCheckHelpLb )
    goto LABEL_44;
  UILabel__set_text(skillCheckHelpLb, (System_String_o *)equipStatusInfo, 0);
  equipChangeHelpLb = this->fields.equipChangeHelpLb;
  equipStatusInfo = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8901/*"MASTER_EQUIP_EXPLANATION_TXT"*/, 0);
...
void MasterEquipInfoComponent__setEquipSkillInfo(MasterEquipInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_59332AB & 1) == 0 )
  {
    sub_21FFC50(&EquipSkillInfoComponent_ClickDelegate_TypeInfo);
    ...
    sub_21FFC50(&Method_UnityEngine_GameObject_GetComponent_EquipSkillInfoComponent___);
    sub_21FFC50(&Method_MasterEquipInfoComponent_setSkillCallBack__);
  ...
  if ( (int)v4 >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      usrEquipEnt = (__int64)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_476E8C0 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( !usrEquipEnt )
        break;
      ...
      if ( !byte_5931945 )
      {
        usrEquipEnt = sub_21FFC50(&UnityEngine_Vector3_TypeInfo);
        byte_5931945 = 1;
      }
      if ( !v13 )
        break;
      ...
      Component_object = UnityEngine_GameObject__GetComponent_object_(
                           v12,
                           (const MethodInfo_3883A78 *)Method_UnityEngine_GameObject_GetComponent_EquipSkillInfoComponent___);
      v16 = (EquipSkillInfoComponent_ClickDelegate_o *)sub_21FFEBC(EquipSkillInfoComponent_ClickDelegate_TypeInfo);
...
LABEL_24:
    sub_21FFECC(usrEquipEnt, method);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  v13 = LocalizationManager__Get((System_String_o *)StringLiteral_8900/*"MASTER_EQSKILL_LV_TXT"*/, 0);
  v20 = skillLv;
  v14 = (Il2CppObject *)j_il2cpp_value_box_0(qword_594C070, &v20);
  v15 = System_String__Format(v13, v14, 0);
  name = System_String__Concat_75481624(v12, (System_String_o *)StringLiteral_113/*" "*/, v15, 0);
  ...
  if ( !v9
    || (v16 = (System_String_o *)Instance,
        ...
        v17 = (Il2CppObject *)j_il2cpp_value_box_0(qword_594C070, &m_CancellationTokenSource),
