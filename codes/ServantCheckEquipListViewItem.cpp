        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E14A & 1) == 0 )
  {
    sub_1C3B764(&Method_DataManager_GetMasterData_ServantLimitMaster___, materialUserSvtEntity);
  ...
  *(_QWORD *)&v44.fields.fakeValue = v37;
  Instance = (void *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47882560(v44, 0LL);
  v39 = (CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_o *)*p_materialUserServantEntity;
  if ( !*p_materialUserServantEntity )
    goto LABEL_13;
  v40 = (int)Instance;
  Instance = (void *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47882560(v39[6], 0LL);
  if ( !v36 )
    goto LABEL_13;
...
LABEL_13:
  ...
  IconLabelInfo__Set_39561332(materialIconLabelInfo, 2, v43, (int32_t)Instance, 0, 0, 0, 0, 0LL);
  this->fields.warningTextType = warningType;
}


// local variable allocation has failed, the output may be wrong!
void __fastcall ServantCheckEquipListViewItem___ctor_33831860(
        ServantCheckEquipListViewItem_o *this,
        bool isParty,
        bool isSupport,
        int32_t partyIndex,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E14B & 1) == 0 )
  {
    sub_1C3B764(&Method_DataManager_GetMasterData_UserServantMaster___, isParty);
  ...
  if ( !materialIconLabelInfo )
    goto LABEL_11;
  IconLabelInfo__Set_39561332(materialIconLabelInfo, 2, nowLoadCount, (int32_t)Instance, 0, 0, 0, 0, 0LL);
  ...
  if ( *p_equipUserServantEntity )
  {
    ...
    {
      IconLabelInfo__Set_39561332(equipSvtIconLabelInfo, 2, lv, (int32_t)Instance, 0, 0, 0, 0, 0LL);
      goto LABEL_10;
    }
LABEL_11:
