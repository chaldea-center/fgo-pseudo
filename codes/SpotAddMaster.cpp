void SpotAddMaster___ctor(SpotAddMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4E782D1 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_DataMasterBase_SpotAddMaster__SpotAddEntity__string___ctor__);
    byte_4E782D1 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    224,
    (const MethodInfo_3538564 *)Method_DataMasterBase_SpotAddMaster__SpotAddEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E782CF & 1) == 0 )
  {
    sub_1D0F0B4(&Method_DataMasterBase_SpotAddMaster__SpotAddEntity__string__GetEntity__);
    byte_4E782CF = 1;
  }
  ...
  return (SpotAddEntity_o *)DataMasterBase_object__object__object___GetEntity(
                              (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                              PK,
                              (const MethodInfo_353AADC *)Method_DataMasterBase_SpotAddMaster__SpotAddEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E782D2 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_System_Collections_ObjectModel_Collection_SpotAddEntity__get_Count__);
    sub_1D0F0B4(&Method_System_Collections_ObjectModel_Collection_SpotAddEntity__get_Item__);
  ...
  *data = -1;
  ...
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            ...
            (const MethodInfo_34CCE40 *)Method_System_Collections_ObjectModel_Collection_SpotAddEntity__get_Count__);
  if ( Count >= 1 )
  {
    v20 = data;
    v21 = 0;
    ...
    while ( 1 )
    {
      ...
      Item = System_Collections_ObjectModel_Collection_object___get_Item(
               (System_Collections_ObjectModel_Collection_T__o *)list,
               v12,
               (const MethodInfo_34CCED0 *)Method_System_Collections_ObjectModel_Collection_SpotAddEntity__get_Item__);
      if ( Item )
      {
        v15 = Item;
        ...
        const MethodInfo *method)
{
  ...
  if ( !list )
LABEL_24:
    sub_1D0F30C(list, *(_QWORD *)&spotId);
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            list,
            (const MethodInfo_34CCE40 *)Method_System_Collections_ObjectModel_Collection_SpotAddEntity__get_Count__);
  if ( Count >= 1 )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E782D0 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_DataMasterBase_SpotAddMaster__SpotAddEntity__string__TryGetEntity__);
    byte_4E782D0 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_353AB28 *)Method_DataMasterBase_SpotAddMaster__SpotAddEntity__string__TryGetEntity__);
}
...
LABEL_19:
    sub_1D0F30C(list, spotName);
  }
  klass_high = -1;
LABEL_18:
  v25->klass = (GrandQuestFolderBoardItem_c *)klass;
  sub_1D0F058(v25, klass, v9, v10, v11, v12, v13, v14);
  return klass_high >= 0;
}