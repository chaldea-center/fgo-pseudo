        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3758B & 1) == 0 )
  {
    sub_1BD3458(&Method_System_Nullable_Color___ctor__, method);
    colorCode = (System_String_o *)sub_1BD3458(&StringLiteral_396/*"#"*/, v5);
    byte_4B3758B = 1;
  }
  *(_QWORD *)&v7.fields.r = 0LL;
  *(_QWORD *)&v7.fields.b = 0LL;
  if ( !v3 )
    sub_1BD36B4(colorCode, method);
  if ( !System_String__StartsWith(v3, (System_String_o *)StringLiteral_396/*"#"*/, 0LL) )
    v3 = System_String__Concat_62525248((System_String_o *)StringLiteral_396/*"#"*/, v3, 0LL);
  ...
  if ( ((unsigned __int8)result & 1) != 0 )
  {
    ...
    *(_QWORD *)&retstr->fields.value.fields.g = 0LL;
    ...
    System_Nullable_Color____ctor(retstr, v8, (const MethodInfo_36DAD14 *)Method_System_Nullable_Color___ctor__);
  }
  else
  {
    *(_QWORD *)&retstr->fields.hasValue = 0LL;
        ...
        const MethodInfo *method)
{
  if ( (byte_4B3758C & 1) == 0 )
  {
    sub_1BD3458(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&colorType);
    byte_4B3758C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3758A & 1) == 0 )
  {
    ...
    sub_1BD3458(
      ...
      v3);
    sub_1BD3458(&System_Func_KeyValuePair_string__object___Nullable_Color___TypeInfo, v4);
    sub_1BD3458(&System_Func_KeyValuePair_string__object___string__TypeInfo, v5);
    sub_1BD3458(&JsonManager_TypeInfo, v6);
    sub_1BD3458(&Method_NpcServantDisplayTypeDetailEntity___c__GetEffectColorDetailDict_b__8_0__, v7);
    sub_1BD3458(&Method_NpcServantDisplayTypeDetailEntity___c__GetEffectColorDetailDict_b__8_1__, v8);
    sub_1BD3458(&NpcServantDisplayTypeDetailEntity___c_TypeInfo, v9);
    sub_1BD3458(&StringLiteral_19134/*"effectColorDetail"*/, v10);
    byte_4B3758A = 1;
  }
  result = (System_Collections_Generic_Dictionary_string__Nullable_Color___o *)BasicHelper__GetValue_object__object_(
                                                                                 ...
                                                                                 (Il2CppObject *)StringLiteral_19134/*"effectColorDetail"*/,
                                                                                 0LL,
  ...
  if ( result )
  {
    ...
    Dictionary_38937896 = JsonManager__getDictionary_38937896(v12, 0LL);
    v14 = NpcServantDisplayTypeDetailEntity___c_TypeInfo;
    v15 = (System_Collections_Generic_IEnumerable_TSource__o *)Dictionary_38937896;
    ...
    if ( !_9__8_0 )
    {
      ...
      _9__8_0 = (System_Func_T__TResult__o *)sub_1BD36A4(System_Func_KeyValuePair_string__object___string__TypeInfo);
    ...
    if ( !_9__8_1 )
    {
      ...
      _9__8_1 = (System_Func_T__TResult__o *)sub_1BD36A4(System_Func_KeyValuePair_string__object___Nullable_Color___TypeInfo);
      ...
      sub_1BD33FC((PartyOrganizationUtility_o *)&v27->__9__8_1, (int64_t)_9__8_1, v28, v29, v30, v31, v32, v33);
    }
    return (System_Collections_Generic_Dictionary_string__Nullable_Color___o *)System_Linq_Enumerable__ToDictionary_KeyValuePair_object__object___object__Nullable_Color__(
                                                                                 ...
                                                                                 (const MethodInfo_2F6B2E8 *)Method_System_Linq_Enumerable_ToDictionary_KeyValuePair_string__object___string__Nullable_Color____);
  }
  return result;
}
...
void __fastcall NpcServantDisplayTypeDetailEntity___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B3758E & 1) == 0 )
  {
    sub_1BD3458(&NpcServantDisplayTypeDetailEntity___c_TypeInfo, v1);
    byte_4B3758E = 1;
  }
  v2 = (Il2CppObject *)sub_1BD36A4(NpcServantDisplayTypeDetailEntity___c_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3758F & 1) == 0 )
  {
    sub_1BD3458(&Method_System_Collections_Generic_KeyValuePair_string__object__get_Key__, x.fields.key);
    byte_4B3758F = 1;
  }
  return key;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B37590 & 1) == 0 )
  {
    this = (NpcServantDisplayTypeDetailEntity___c_o *)sub_1BD3458(
