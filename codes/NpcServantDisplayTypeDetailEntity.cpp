        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E04FB0 & 1) == 0 )
  {
    ...
    colorCode = (System_String_o *)sub_1CE6700(&StringLiteral_370/*"#"*/);
    byte_4E04FB0 = 1;
  }
  *(_QWORD *)&v6.fields.r = 0;
  *(_QWORD *)&v6.fields.b = 0;
  if ( !v3 )
    sub_1CE6958(colorCode, method);
  if ( !System_String__StartsWith(v3, (System_String_o *)StringLiteral_370/*"#"*/, 0) )
    v3 = System_String__Concat_65122828((System_String_o *)StringLiteral_370/*"#"*/, v3, 0);
  ...
  if ( ((unsigned __int8)result & 1) != 0 )
  {
    ...
    *(_QWORD *)&retstr->fields.value.fields.g = 0;
    ...
    System_Nullable_Color____ctor(retstr, v7, (const MethodInfo_3A2AED4 *)Method_System_Nullable_Color___ctor__);
  }
  else
  {
    *(_QWORD *)&retstr->fields.hasValue = 0;
        ...
        const MethodInfo *method)
{
  ...
  Il2CppObject *v4; // x19
  System_Collections_Generic_Dictionary_string__object__o *Dictionary_42164432; // x0
  ...
  if ( (byte_4E04FAF & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_System_Linq_Enumerable_ToDictionary_KeyValuePair_string__object___string__Nullable_Color____);
    sub_1CE6700(&System_Func_KeyValuePair_string__object___Nullable_Color___TypeInfo);
    sub_1CE6700(&System_Func_KeyValuePair_string__object___string__TypeInfo);
    sub_1CE6700(&JsonManager_TypeInfo);
    sub_1CE6700(&Method_NpcServantDisplayTypeDetailEntity___c__GetEffectColorDetailDict_b__8_0__);
    sub_1CE6700(&Method_NpcServantDisplayTypeDetailEntity___c__GetEffectColorDetailDict_b__8_1__);
    sub_1CE6700(&NpcServantDisplayTypeDetailEntity___c_TypeInfo);
    sub_1CE6700(&StringLiteral_19155/*"effectColorDetail"*/);
    byte_4E04FAF = 1;
  }
  result = (System_Collections_Generic_Dictionary_string__Nullable_Color___o *)BasicHelper__GetValue_object__object_(
                                                                                 ...
                                                                                 (Il2CppObject *)StringLiteral_19155/*"effectColorDetail"*/,
                                                                                 0,
  ...
  if ( result )
  {
    ...
    Dictionary_42164432 = JsonManager__getDictionary_42164432(v4, 0);
    v6 = NpcServantDisplayTypeDetailEntity___c_TypeInfo;
    v7 = (System_Collections_Generic_IEnumerable_TSource__o *)Dictionary_42164432;
    ...
    if ( !_9__8_0 )
    {
      ...
      _9__8_0 = (System_Func_T__TResult__o *)sub_1CE694C(System_Func_KeyValuePair_string__object___string__TypeInfo);
    ...
    if ( !_9__8_1 )
    {
      ...
      _9__8_1 = (System_Func_T__TResult__o *)sub_1CE694C(System_Func_KeyValuePair_string__object___Nullable_Color___TypeInfo);
      ...
      sub_1CE66A4((GrandQuestFolderBoardItem_o *)&v19->__9__8_1, (int32_t)_9__8_1, v20, v21, v22, v23, v24, v25);
    }
    return (System_Collections_Generic_Dictionary_string__Nullable_Color___o *)System_Linq_Enumerable__ToDictionary_KeyValuePair_object__object___object__Nullable_Color__(
                                                                                 ...
                                                                                 (const MethodInfo_3244050 *)Method_System_Linq_Enumerable_ToDictionary_KeyValuePair_string__object___string__Nullable_Color____);
  }
  return result;
}
...
void NpcServantDisplayTypeDetailEntity___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1CE694C(NpcServantDisplayTypeDetailEntity___c_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E04FB7 & 1) == 0 )
  {
    this = (NpcServantDisplayTypeDetailEntity___c_o *)sub_1CE6700(&Method_System_Collections_Generic_KeyValuePair_string__object__get_Value__);
    byte_4E04FB7 = 1;
  }
  if ( !value )
