        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01B7D & 1) == 0 )
  {
    sub_1B64A00(&UnityEngine_Object_TypeInfo, isHideAttribute);
    byte_4A01B7D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01B7A & 1) == 0 )
  {
    sub_1B64A00(&Method_UnityEngine_GameObject_GetComponent_BattleBuffListObjectComponent___, buffList);
    ...
    sub_1B64A00(&StringLiteral_2908/*"BATTLE_NOBUFFLIST"*/, v8);
    byte_4A01B7A = 1;
  }
  ...
  if ( buffList )
  {
    ...
    if ( (int)v11 >= 1 )
    {
      ...
      do
      {
        if ( v12 >= (unsigned int)v11 )
          sub_1B64C64(prefabBuffObject, buffList);
        ...
        if ( ((unsigned __int8)prefabBuffObject & 1) == 0 )
        {
          ...
          prefabBuffObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                           (UnityEngine_GameObject_o *)Object,
                                                           (const MethodInfo_2E8A7CC *)Method_UnityEngine_GameObject_GetComponent_BattleBuffListObjectComponent___);
          if ( !prefabBuffObject )
            goto LABEL_34;
          ...
          else
          {
            ...
            *(_QWORD *)(v24 + 32) = Object;
            sub_1B649A4((ServantStatusBattleListViewItem_o *)(v24 + 32), (int32_t)Object, v18, v19);
          }
        }
    ...
    if ( !UnityEngine_Object__op_Inequality(nothingLabel, 0LL, 0LL) )
      goto LABEL_32;
    v27 = (System_String_o *)StringLiteral_2908/*"BATTLE_NOBUFFLIST"*/;
    ...
    if ( prefabBuffObject )
    {
      ...
      if ( !System_String__Equals_61393452((System_String_o *)prefabBuffObject, v27, 0LL) )
      {
...
LABEL_34:
    sub_1B64C5C(prefabBuffObject, buffList);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B64C5C(uiScrollView, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01B7C & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_18543/*"dialog_title"*/, v9);
    byte_4A01B7C = 1;
  }
    ...
    if ( v16 )
    {
      ...
      if ( AssetStorage )
        Object_object__48358160 = AssetData__GetObject_object__48358160(
                                    AssetStorage,
                                    (System_String_o *)StringLiteral_18543/*"dialog_title"*/,
      ...
      *p_enemyNameEffectPrefab = (struct UnityEngine_GameObject_o *)v22;
      sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.enemyNameEffectPrefab, (int32_t)v22, v23, v24);
    }
