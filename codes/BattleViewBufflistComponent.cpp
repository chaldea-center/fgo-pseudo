        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69EA3 & 1) == 0 )
  {
    sub_1BE4ACC(&UnityEngine_Object_TypeInfo, isHideAttribute);
    byte_4B69EA3 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69EA0 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_UnityEngine_GameObject_GetComponent_BattleBuffListObjectComponent___, buffList);
    ...
    sub_1BE4ACC(&StringLiteral_2955/*"BATTLE_NOBUFFLIST"*/, v8);
    byte_4B69EA0 = 1;
  }
  ...
  if ( buffList )
  {
    ...
    if ( (int)v11 >= 1 )
    {
      ...
      do
      {
        if ( v12 >= (unsigned int)v11 )
          sub_1BE4D30(prefabBuffObject, buffList);
        ...
        if ( ((unsigned __int8)prefabBuffObject & 1) == 0 )
        {
          ...
          prefabBuffObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                           (UnityEngine_GameObject_o *)Object,
                                                           (const MethodInfo_2FA979C *)Method_UnityEngine_GameObject_GetComponent_BattleBuffListObjectComponent___);
          if ( !prefabBuffObject )
            goto LABEL_34;
          ...
          else
          {
            ...
            *(_QWORD *)(v28 + 32) = Object;
            sub_1BE4A70((PartyOrganizationUtility_o *)(v28 + 32), (int64_t)Object, v18, v19, v20, v21, v22, v23);
          }
        }
    ...
    if ( !UnityEngine_Object__op_Inequality(nothingLabel, 0LL, 0LL) )
      goto LABEL_32;
    v31 = (System_String_o *)StringLiteral_2955/*"BATTLE_NOBUFFLIST"*/;
    ...
    if ( prefabBuffObject )
    {
      ...
      if ( !System_String__Equals_62707124((System_String_o *)prefabBuffObject, v31, 0LL) )
      {
...
LABEL_34:
    sub_1BE4D28(prefabBuffObject, buffList);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BE4D28(uiScrollView, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69EA2 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_18860/*"dialog_title"*/, v9);
    byte_4B69EA2 = 1;
  }
    ...
    if ( v16 )
    {
      ...
      if ( AssetStorage )
        Object_object__49525204 = AssetData__GetObject_object__49525204(
                                    AssetStorage,
                                    (System_String_o *)StringLiteral_18860/*"dialog_title"*/,
