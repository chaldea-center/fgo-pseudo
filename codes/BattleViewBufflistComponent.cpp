        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1FB06 & 1) == 0 )
  {
    sub_1BCAFF8(&UnityEngine_Object_TypeInfo, isHideAttribute);
    byte_4B1FB06 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1FB03 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_UnityEngine_GameObject_GetComponent_BattleBuffListObjectComponent___, buffList);
    ...
    sub_1BCAFF8(&StringLiteral_2795/*"BATTLE_NOBUFFLIST"*/, v8);
    byte_4B1FB03 = 1;
  }
  ...
  if ( buffList )
  {
    ...
    if ( (int)v12 >= 1 )
    {
      ...
      do
      {
        if ( v13 >= (unsigned int)v12 )
          sub_1BCB25C(prefabBuffObject, buffList, v11);
        ...
        if ( ((unsigned __int8)prefabBuffObject & 1) == 0 )
        {
          ...
          prefabBuffObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                           (UnityEngine_GameObject_o *)Object,
                                                           (const MethodInfo_306E710 *)Method_UnityEngine_GameObject_GetComponent_BattleBuffListObjectComponent___);
          if ( !prefabBuffObject )
            goto LABEL_34;
          ...
          else
          {
            ...
            *(_QWORD *)(v25 + 32) = Object;
            sub_1BCAF9C((CGThumbnailListItem_o *)(v25 + 32), (int32_t)Object, v19, v20);
          }
        }
    ...
    if ( !UnityEngine_Object__op_Inequality(nothingLabel, 0LL, 0LL) )
      goto LABEL_32;
    v28 = (System_String_o *)StringLiteral_2795/*"BATTLE_NOBUFFLIST"*/;
    ...
    if ( prefabBuffObject )
    {
      ...
      if ( !System_String__Equals_62485728((System_String_o *)prefabBuffObject, v28, 0LL) )
      {
...
LABEL_34:
    sub_1BCB254(prefabBuffObject, buffList);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BCB254(uiScrollView, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1FB05 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_18456/*"dialog_title"*/, v9);
    byte_4B1FB05 = 1;
  }
    ...
    if ( v16 )
    {
      ...
      if ( AssetStorage )
        Object_object__50315216 = AssetData__GetObject_object__50315216(
                                    AssetStorage,
                                    (System_String_o *)StringLiteral_18456/*"dialog_title"*/,
      ...
      *p_enemyNameEffectPrefab = (struct UnityEngine_GameObject_o *)v22;
      sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.enemyNameEffectPrefab, (int32_t)v22, v23, v24);
    }
