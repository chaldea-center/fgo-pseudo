        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3B0FD & 1) == 0 )
  {
    sub_1C32C20(&Method_UnityEngine_GameObject_GetComponent_BattleBuffListObjectComponent___);
    sub_1C32C20(&Method_System_Collections_Generic_List_GameObject__Add__);
    sub_1C32C20(&LocalizationManager_TypeInfo);
    sub_1C32C20(&UnityEngine_Object_TypeInfo);
    sub_1C32C20(&StringLiteral_2811/*"BATTLE_NOBUFFLIST"*/);
    byte_4C3B0FD = 1;
  }
  ...
  if ( buffList )
  {
      ...
      do
      {
        ...
        if ( ((unsigned __int8)prefabBuffObject & 1) == 0 )
        {
          ...
          prefabBuffObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                           (UnityEngine_GameObject_o *)Object,
                                                           (const MethodInfo_3134970 *)Method_UnityEngine_GameObject_GetComponent_BattleBuffListObjectComponent___);
          if ( !prefabBuffObject )
            goto LABEL_34;
          ...
          else
          {
            ...
            *(_QWORD *)(v20 + 32) = Object;
            sub_1C32BC4((CGThumbnailListItem_o *)(v20 + 32), (int32_t)Object, v14, v15);
          }
        }
    ...
    if ( prefabBuffObject )
    {
      ...
      if ( !System_String__Equals_63553848((System_String_o *)prefabBuffObject, v23, 0) )
      {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3B0FF & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_18613/*"dialog_title"*/);
    byte_4C3B0FF = 1;
  }
    ...
    if ( v10 )
    {
      ...
      if ( AssetStorage )
        Object_object__51111776 = AssetData__GetObject_object__51111776(
                                    AssetStorage,
                                    (System_String_o *)StringLiteral_18613/*"dialog_title"*/,
      ...
      *p_enemyNameEffectPrefab = (struct UnityEngine_GameObject_o *)v16;
      sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.enemyNameEffectPrefab, (int32_t)v16, v17, v18);
    }
