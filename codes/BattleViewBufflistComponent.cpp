        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D300F6 & 1) == 0 )
  {
    sub_1C94098(&Method_UnityEngine_GameObject_GetComponent_BattleBuffListObjectComponent___);
    sub_1C94098(&Method_System_Collections_Generic_List_GameObject__Add__);
    sub_1C94098(&LocalizationManager_TypeInfo);
    sub_1C94098(&UnityEngine_Object_TypeInfo);
    sub_1C94098(&StringLiteral_2807/*"BATTLE_NOBUFFLIST"*/);
    byte_4D300F6 = 1;
  }
  ...
  if ( buffList )
  {
      ...
      do
      {
        ...
        if ( ((unsigned __int8)prefabBuffObject & 1) == 0 )
        {
          ...
          prefabBuffObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                           (UnityEngine_GameObject_o *)Object,
                                                           (const MethodInfo_31F4790 *)Method_UnityEngine_GameObject_GetComponent_BattleBuffListObjectComponent___);
          if ( !prefabBuffObject )
            goto LABEL_34;
          ...
          else
          {
            ...
            *(_QWORD *)(v24 + 32) = Object;
            sub_1C9403C((GrandQuestFolderBoardItem_o *)(v24 + 32), (int32_t)Object, v14, v15, v16, v17, v18, v19);
          }
        }
    ...
    if ( !UnityEngine_Object__op_Inequality(nothingLabel, 0, 0) )
      goto LABEL_32;
    v27 = (System_String_o *)StringLiteral_2807/*"BATTLE_NOBUFFLIST"*/;
    ...
    if ( prefabBuffObject )
    {
      ...
      if ( !System_String__Equals_64453064((System_String_o *)prefabBuffObject, v27, 0) )
      {
...
LABEL_34:
    sub_1C942F0(prefabBuffObject, buffList);
  }
}
...
void BattleViewBufflistComponent__setBuffListScrollView(BattleViewBufflistComponent_o *this, const MethodInfo *method)
{
  ...
  if ( !uiScrollView || (UIScrollView__ResetPosition(uiScrollView, 0), (uiScrollView = this->fields.uiScrollView) == 0) )
    sub_1C942F0(uiScrollView, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D300F8 & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_18722/*"dialog_title"*/);
    byte_4D300F8 = 1;
  }
    ...
    if ( v11 )
    {
      ...
      if ( AssetStorage )
        Object_object__51893132 = AssetData__GetObject_object__51893132(
                                    AssetStorage,
                                    (System_String_o *)StringLiteral_18722/*"dialog_title"*/,
