        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4AED8 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataMasterBase_EventPanelScanMaster__EventPanelScanEntity__int__GetEntity__, basePanel);
    sub_1B863B8(&Method_System_Collections_Generic_List_SubmarineScanEvent__Add__, v7);
    sub_1B863B8(&Method_System_Collections_Generic_List_SubmarineScanEvent___ctor__, v8);
    sub_1B863B8(&Method_System_Collections_Generic_List_SubmarineMapPanelData___ctor__, v9);
    sub_1B863B8(&System_Collections_Generic_List_SubmarineMapPanelData__TypeInfo, v10);
    sub_1B863B8(&System_Collections_Generic_List_SubmarineScanEvent__TypeInfo, v11);
    sub_1B863B8(&SubmarineScanEvent_TypeInfo, v12);
    byte_4A4AED8 = 1;
  }
  v13 = (System_Collections_Generic_List_object__o *)sub_1B86604(System_Collections_Generic_List_SubmarineScanEvent__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v13,
    (const MethodInfo_35FC124 *)Method_System_Collections_Generic_List_SubmarineScanEvent___ctor__);
  ...
  item = (Il2CppObject *)sub_1B86604(v18);
  ...
  else
  {
    ...
    sub_1B8635C((CGThumbnailListItem_o *)(v26 + 4), (int32_t)item, v21, v22);
  }
  monitor = Entity[2].monitor;
  if ( !monitor )
LABEL_36:
    sub_1B86614(eventPanelScanMaster, v16);
  v28 = 0;
  v54 = submarineData;
  while ( 1 )
  {
    ...
    v31 = (System_Collections_Generic_List_object__o *)sub_1B86604(System_Collections_Generic_List_SubmarineMapPanelData__TypeInfo);
    System_Collections_Generic_List_object____ctor(
      v31,
    ...
    if ( v30 )
    {
      ...
      if ( (v33 << 32) + 0x100000000LL >= 0x100000001LL )
      {
        ...
        while ( v35 < (unsigned int)v33 )
        {
          ...
          v38 = v34->fields._IsStopped_k__BackingField ? 0 : LOBYTE(eventPanelScanMaster->fields.seriazlier) ^ 1;
          v39 = *v17;
          v40 = v17;
          IsStopped_k__BackingField = v34->fields._IsStopped_k__BackingField;
          v42 = v38 != 0;
          v34 = (SubmarineScanEvent_o *)sub_1B86604(v39);
          ...
          else
          {
            ...
            sub_1B8635C((CGThumbnailListItem_o *)(v49 + 4), (int32_t)v34, v44, v45);
          }
          v17 = v40;
          submarineData = v54;
          v50 = v35 + 2;
...
LABEL_38:
        sub_1B8661C(eventPanelScanMaster, v16);
      }
LABEL_35:
      ++v28;
      monitor = Entity[2].monitor;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4AED9 & 1) == 0 )
  {
    sub_1B863B8(&CommonConsumeDetailInfo___TypeInfo, method);
    *(_QWORD *)&scanId = sub_1B863B8(
  ...
  if ( Entity )
    ...
    return (CommonConsumeDetailInfo_array *)sub_1B86460(CommonConsumeDetailInfo___TypeInfo, 0LL);
}
...
System_Int32_array *__fastcall SubmarineDataHelperScan__GetReleasedScanIds(int32_t eventId, const MethodInfo *method)
{
  ...
  if ( (byte_4A4AEDB & 1) == 0 )
  {
    ...
    *(_QWORD *)&eventId = sub_1B863B8(&System_Collections_Generic_List_int__TypeInfo, v5);
    byte_4A4AEDB = 1;
  }
  ...
  if ( (int)v10 >= 1 )
  {
    ...
    while ( 1 )
    {
      if ( v11 >= (unsigned int)v10 )
        sub_1B8661C(eventPanelScanMaster, id);
...
LABEL_19:
    sub_1B86614(eventPanelScanMaster, id);
  }
LABEL_17:
  if ( !v9 )
    goto LABEL_19;
  ...
  if ( !*(_BYTE *)(*(_QWORD *)&hIndex + 56LL) )
  {
    *(_QWORD *)&hIndex = SubmarineMapDataManager__GetNeighborPanels(submarineData, v5, vIndex, 0, v7);
    if ( *(_QWORD *)&hIndex )
    {
      ...
      {
        if ( v9 == v11 )
          sub_1B8661C(*(_QWORD *)&hIndex, *(_QWORD *)&vIndex);
...
EventPanelScanMaster_o *__fastcall SubmarineDataHelperScan__get_eventPanelScanMaster(const MethodInfo *method)
{
  ...
  if ( (byte_4A4AED4 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataManager_GetMasterData_EventPanelScanMaster___, v1);
    sub_1B863B8(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v2);
    byte_4A4AED4 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3839680 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
