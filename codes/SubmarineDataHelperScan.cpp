        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6CAE9 & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_EventPanelScanMaster__EventPanelScanEntity__int__GetEntity__, basePanel);
    sub_1B90010(&Method_System_Collections_Generic_List_SubmarineScanEvent__Add__, v7);
    sub_1B90010(&Method_System_Collections_Generic_List_SubmarineScanEvent___ctor__, v8);
    sub_1B90010(&Method_System_Collections_Generic_List_SubmarineMapPanelData___ctor__, v9);
    sub_1B90010(&System_Collections_Generic_List_SubmarineMapPanelData__TypeInfo, v10);
    sub_1B90010(&System_Collections_Generic_List_SubmarineScanEvent__TypeInfo, v11);
    sub_1B90010(&SubmarineScanEvent_TypeInfo, v12);
    byte_4A6CAE9 = 1;
  }
  v13 = (System_Collections_Generic_List_object__o *)sub_1B9025C(System_Collections_Generic_List_SubmarineScanEvent__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v13,
    (const MethodInfo_351018C *)Method_System_Collections_Generic_List_SubmarineScanEvent___ctor__);
  ...
  item = (Il2CppObject *)sub_1B9025C(v18);
  ...
  else
  {
    ...
    sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v25 + 4), (int32_t)item, v20, v21);
  }
  monitor = Entity[2].monitor;
  if ( !monitor )
LABEL_36:
    sub_1B9026C(eventPanelScanMaster, v16);
  v27 = 0;
  v52 = submarineData;
  while ( 1 )
  {
    ...
    v30 = (System_Collections_Generic_List_object__o *)sub_1B9025C(System_Collections_Generic_List_SubmarineMapPanelData__TypeInfo);
    System_Collections_Generic_List_object____ctor(
      v30,
    ...
    if ( v29 )
    {
      ...
      if ( (v32 << 32) + 0x100000000LL >= 0x100000001LL )
      {
        ...
        while ( v34 < (unsigned int)v32 )
        {
          ...
          v41 = v37 != 0;
          v33 = (SubmarineScanEvent_o *)sub_1B9025C(v38);
          ...
          else
          {
            ...
            sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v47 + 4), (int32_t)v33, v42, v43);
          }
          v17 = v39;
          submarineData = v52;
          v48 = v34 + 2;
...
LABEL_38:
        sub_1B90274(eventPanelScanMaster, v16);
      }
LABEL_35:
      ++v27;
      monitor = Entity[2].monitor;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6CAEA & 1) == 0 )
  {
    sub_1B90010(&CommonConsumeDetailInfo___TypeInfo, method);
    *(_QWORD *)&scanId = sub_1B90010(
  ...
  if ( Entity )
    ...
    return (CommonConsumeDetailInfo_array *)sub_1B900B8(CommonConsumeDetailInfo___TypeInfo, 0LL);
}
...
System_Int32_array *__fastcall SubmarineDataHelperScan__GetReleasedScanIds(int32_t eventId, const MethodInfo *method)
{
  ...
  if ( (byte_4A6CAEC & 1) == 0 )
  {
    ...
    *(_QWORD *)&eventId = sub_1B90010(&System_Collections_Generic_List_int__TypeInfo, v5);
    byte_4A6CAEC = 1;
  }
  ...
  if ( (int)v10 >= 1 )
  {
    ...
    while ( 1 )
    {
      if ( v11 >= (unsigned int)v10 )
        sub_1B90274(eventPanelScanMaster, id);
...
LABEL_19:
    sub_1B9026C(eventPanelScanMaster, id);
  }
LABEL_17:
  if ( !v9 )
    goto LABEL_19;
  ...
  if ( !*(_BYTE *)(*(_QWORD *)&hIndex + 56LL) )
  {
    *(_QWORD *)&hIndex = SubmarineMapDataManager__GetNeighborPanels(submarineData, v5, vIndex, 0, v7);
    if ( *(_QWORD *)&hIndex )
    {
      ...
      {
        if ( v9 == v11 )
          sub_1B90274(*(_QWORD *)&hIndex, *(_QWORD *)&vIndex);
...
EventPanelScanMaster_o *__fastcall SubmarineDataHelperScan__get_eventPanelScanMaster(const MethodInfo *method)
{
  ...
  if ( (byte_4A6CAE5 & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMasterData_EventPanelScanMaster___, v1);
    sub_1B90010(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v2);
    byte_4A6CAE5 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_374C890 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
