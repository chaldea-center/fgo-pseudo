        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B41486 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataMasterBase_EventPanelScanMaster__EventPanelScanEntity__int__GetEntity__, basePanel);
    sub_1BDB878(&Method_System_Collections_Generic_List_SubmarineScanEvent__Add__, v7);
    sub_1BDB878(&Method_System_Collections_Generic_List_SubmarineScanEvent___ctor__, v8);
    sub_1BDB878(&Method_System_Collections_Generic_List_SubmarineMapPanelData___ctor__, v9);
    sub_1BDB878(&System_Collections_Generic_List_SubmarineMapPanelData__TypeInfo, v10);
    sub_1BDB878(&System_Collections_Generic_List_SubmarineScanEvent__TypeInfo, v11);
    sub_1BDB878(&SubmarineScanEvent_TypeInfo, v12);
    byte_4B41486 = 1;
  }
  v13 = (System_Collections_Generic_List_object__o *)sub_1BDBAC4(System_Collections_Generic_List_SubmarineScanEvent__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v13,
    (const MethodInfo_36D5590 *)Method_System_Collections_Generic_List_SubmarineScanEvent___ctor__);
  ...
  item = (Il2CppObject *)sub_1BDBAC4(v18);
  ...
  else
  {
    ...
    sub_1BDB81C((CGThumbnailListItem_o *)(v26 + 4), (int32_t)item, v21, v22);
  }
  monitor = Entity[2].monitor;
  if ( !monitor )
LABEL_36:
    sub_1BDBAD4(eventPanelScanMaster, v16);
  v29 = 0;
  v55 = submarineData;
  while ( 1 )
  {
    ...
    v32 = (System_Collections_Generic_List_object__o *)sub_1BDBAC4(System_Collections_Generic_List_SubmarineMapPanelData__TypeInfo);
    System_Collections_Generic_List_object____ctor(
      v32,
    ...
    if ( v31 )
    {
      ...
      if ( (v34 << 32) + 0x100000000LL >= 0x100000001LL )
      {
        ...
        while ( v36 < (unsigned int)v34 )
        {
          ...
          v43 = v39 != 0;
          v35 = (SubmarineScanEvent_o *)sub_1BDBAC4(v40);
          ...
          else
          {
            ...
            sub_1BDB81C((CGThumbnailListItem_o *)(v50 + 4), (int32_t)v35, v45, v46);
          }
          v17 = v41;
          submarineData = v55;
          v51 = v36 + 2;
...
LABEL_38:
        sub_1BDBADC(eventPanelScanMaster, v16, v27);
      }
LABEL_35:
      ++v29;
      monitor = Entity[2].monitor;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B41487 & 1) == 0 )
  {
    sub_1BDB878(&CommonConsumeDetailInfo___TypeInfo, method);
    *(_QWORD *)&scanId = sub_1BDB878(
  ...
  if ( Entity )
    ...
    return (CommonConsumeDetailInfo_array *)sub_1BDB920(CommonConsumeDetailInfo___TypeInfo, 0LL);
}
...
System_Int32_array *__fastcall SubmarineDataHelperScan__GetReleasedScanIds(int32_t eventId, const MethodInfo *method)
{
  ...
  if ( (byte_4B41489 & 1) == 0 )
  {
    ...
    *(_QWORD *)&eventId = sub_1BDB878(&System_Collections_Generic_List_int__TypeInfo, v5);
    byte_4B41489 = 1;
  }
  ...
  if ( (int)v11 >= 1 )
  {
    ...
    while ( 1 )
    {
      if ( v12 >= (unsigned int)v11 )
        sub_1BDBADC(eventPanelScanMaster, id, v10);
...
LABEL_19:
    sub_1BDBAD4(eventPanelScanMaster, id);
  }
LABEL_17:
  if ( !v9 )
    goto LABEL_19;
  ...
  if ( !*(_BYTE *)(*(_QWORD *)&hIndex + 56LL) )
  {
    *(_QWORD *)&hIndex = SubmarineMapDataManager__GetNeighborPanels(submarineData, v5, vIndex, 0, v7);
    if ( *(_QWORD *)&hIndex )
    {
      ...
      {
        if ( v10 == v12 )
          sub_1BDBADC(*(_QWORD *)&hIndex, *(_QWORD *)&vIndex, v9);
...
EventPanelScanMaster_o *__fastcall SubmarineDataHelperScan__get_eventPanelScanMaster(const MethodInfo *method)
{
  ...
  if ( (byte_4B41482 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMasterData_EventPanelScanMaster___, v1);
    sub_1BDB878(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v2);
    byte_4B41482 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
