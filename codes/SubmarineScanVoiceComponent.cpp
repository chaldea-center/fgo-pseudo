...
void SubmarineScanVoiceComponent__Awake(SubmarineScanVoiceComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.assetName, 0, v2, v3);
  this->fields.vcName = 0;
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.vcName, 0, v5, v6);
  ...
  if ( this->fields.svtId )
  {
    ...
    v10 = System_String__Concat_63561656((System_String_o *)StringLiteral_4424/*"ChrVoice_"*/, v9, 0);
    this->fields.assetName = v10;
    sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.assetName, (int32_t)v10, v11, v12);
    v13 = this->fields.vcNameList;
    if ( !v13
      || (p_svtId = (int32_t *)UnityEngine_Random__Range_71226972(0, v13->max_length, 0),
...
LABEL_11:
    ...
    sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.vcName, (int32_t)v17, v14, v15);
  }
}
...
void SubmarineScanVoiceComponent__PlayScanVoice(SubmarineScanVoiceComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3F8F9 & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_SubmarineScanVoiceComponent_StopVoice__);
    byte_4C3F8F9 = 1;
  }
  ...
  if ( assetName )
  {
    ...
    if ( vcName )
    {
      ...
      v8 = SoundManager__playVoice_41518412(assetName, vcName, DEFAULT_VOLUME, v7, 0, 0);
      this->fields.sePlayer = v8;
      sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.sePlayer, (int32_t)v8, v9, v10);
    }
  }
}
...
void SubmarineScanVoiceComponent__StopVoice(SubmarineScanVoiceComponent_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.sePlayer )
  {
    ...
    p_sePlayer->klass = 0;
    sub_1C36FFC(p_sePlayer, 0, v7, v8);
  }
}