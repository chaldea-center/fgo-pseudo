...
void __fastcall SubmarineScanVoiceComponent__Awake(SubmarineScanVoiceComponent_o *this, const MethodInfo *method)
{
  ...
  sub_B52920((BattleServantConfConponent_o *)&this->fields.assetName, 0LL, v2, v3, v4, v5, v6, v7);
  this->fields.vcName = 0LL;
  sub_B52920((BattleServantConfConponent_o *)&this->fields.vcName, 0LL, v9, v10, v11, v12, v13, v14);
  ...
  if ( *(&this->fields.svtId + 1) )
  {
    ...
    v19 = System_String__Concat_44568316((System_String_o *)StringLiteral_3997/*"ChrVoice_"*/, v18, 0LL);
    ...
    if ( !v26
      || (v16 = (int32_t *)UnityEngine_Random__Range_35650740(0, v26->max_length, 0LL),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AEE8C & 1) == 0 )
  {
    ...
    sub_B52984(&Method_SubmarineScanVoiceComponent_StopVoice__);
    byte_42AEE8C = 1;
  }
  ...
  if ( assetName )
  {
    ...
    if ( vcName )
    {
      ...
      v8 = SoundManager__playVoice_23788136(assetName, vcName, DEFAULT_VOLUME, v7, 0LL);
...
void __fastcall SubmarineScanVoiceComponent__StopVoice(SubmarineScanVoiceComponent_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.sePlayer )
  {
    ...
    sub_B52920(p_sePlayer, 0LL, v6, v7, v8, v9, v10, v11);
  }
}