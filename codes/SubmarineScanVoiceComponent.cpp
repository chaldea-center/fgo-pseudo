...
void __fastcall SubmarineScanVoiceComponent__Awake(SubmarineScanVoiceComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.assetName, 0, v2, v3);
  this->fields.vcName = 0LL;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.vcName, 0, v5, v6);
  ...
  if ( this->fields.svtId )
  {
    ...
    v11 = System_String__Concat_61707032((System_String_o *)StringLiteral_4464/*"ChrVoice_"*/, v10, 0LL);
    this->fields.assetName = v11;
    sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.assetName, (int32_t)v11, v12, v13);
    v14 = this->fields.vcNameList;
    if ( !v14
      || (p_svtId = (int32_t *)UnityEngine_Random__Range_69419120(0, v14->max_length, 0LL),
          (v17 = this->fields.vcNameList) == 0LL) )
    {
LABEL_11:
      sub_1B8880C(p_svtId, v7);
    }
    if ( (unsigned int)p_svtId >= v17->max_length )
      sub_1B88814(p_svtId, v7);
    v18 = v17->m_Items[(int)p_svtId];
    this->fields.vcName = v18;
    sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.vcName, (int32_t)v18, v15, v16);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57D93 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_SubmarineScanVoiceComponent_StopVoice__);
    byte_4A57D93 = 1;
  }
  ...
  if ( assetName )
  {
    ...
    if ( vcName )
    {
      ...
      v8 = SoundManager__playVoice_38702940(assetName, vcName, DEFAULT_VOLUME, v7, 0LL);
      this->fields.sePlayer = v8;
      sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.sePlayer, (int32_t)v8, v9, v10);
    }
  }
}
...
void __fastcall SubmarineScanVoiceComponent__StopVoice(SubmarineScanVoiceComponent_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.sePlayer )
  {
    ...
    sub_1B88554(p_sePlayer, 0, v7, v8);
  }
}