...
void __fastcall SubmarineScanVoiceComponent__Awake(SubmarineScanVoiceComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.assetName, 0LL, v2, v3, v4, v5, v6, v7);
  this->fields.vcName = 0LL;
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.vcName, 0LL, v9, v10, v11, v12, v13, v14);
  ...
  if ( this->fields.svtId )
  {
    ...
    v19 = System_String__Concat_62967944((System_String_o *)StringLiteral_4546/*"ChoiceSortOrder-"*/, v18, 0LL);
    this->fields.assetName = v19;
    sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.assetName, (int64_t)v19, v20, v21, v22, v23, v24, v25);
    v26 = this->fields.vcNameList;
    if ( !v26
      || (p_svtId = (int32_t *)UnityEngine_Random__Range_70681728(0, v26->max_length, 0LL),
          (v33 = this->fields.vcNameList) == 0LL) )
    {
LABEL_11:
      sub_1C13F80(p_svtId, v15);
    }
    if ( (unsigned int)p_svtId >= v33->max_length )
      sub_1C13F88(p_svtId, v15);
    v34 = v33->m_Items[(int)p_svtId];
    this->fields.vcName = v34;
    sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.vcName, (int64_t)v34, v27, v28, v29, v30, v31, v32);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB1221 & 1) == 0 )
  {
    ...
    sub_1C13D24(&SeManager_TypeInfo, v3);
    sub_1C13D24(&SoundManager_TypeInfo, v4);
    sub_1C13D24(&Method_SubmarineScanVoiceComponent_StopVoice__, v5);
    byte_4BB1221 = 1;
  }
  ...
  if ( assetName )
  {
    ...
    if ( vcName )
    {
      ...
      v11 = SoundManager__playVoice_39857168(assetName, vcName, DEFAULT_VOLUME, v10, 0, 0LL);
      this->fields.sePlayer = v11;
      sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.sePlayer, (int64_t)v11, v12, v13, v14, v15, v16, v17);
    }
  }
}
...
void __fastcall SubmarineScanVoiceComponent__StopVoice(SubmarineScanVoiceComponent_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.sePlayer )
  {
    ...
    sub_1C13CC8(p_sePlayer, 0LL, v7, v8, v9, v10, v11, v12);
  }
}