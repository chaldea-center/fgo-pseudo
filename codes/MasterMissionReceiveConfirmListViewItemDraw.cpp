void __fastcall MasterMissionReceiveConfirmListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48E524D & 1) == 0 )
  {
    sub_1B00CCC(&MasterMissionReceiveConfirmListViewItemDraw_TypeInfo, v1);
    byte_48E524D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E524C & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataManager_GetMasterData_GiftMaster___, message);
    ...
    sub_1B00CCC(&MasterMissionReceiveConfirmListViewItemDraw_TypeInfo, v15);
    sub_1B00CCC(&UnityEngine_Object_TypeInfo, v16);
    sub_1B00CCC(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v17);
    this = (MasterMissionReceiveConfirmListViewItemDraw_o *)sub_1B00CCC(&StringLiteral_8441/*"MASTER_MISSION_RECEIVE_CONFIRM_REWARD_FMT"*/, v18);
    byte_48E524C = 1;
  }
  countText = 0LL;
  nameText = 0LL;
  ...
  if ( mode && !v10->fields.isInit )
  {
    ...
    this = (MasterMissionReceiveConfirmListViewItemDraw_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_35FBBF0 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !this )
      goto LABEL_71;
    ...
    this = (MasterMissionReceiveConfirmListViewItemDraw_o *)LocalizationManager__Get(
                                                              (System_String_o *)StringLiteral_8441/*"MASTER_MISSION_RECEIVE_CONFIRM_REWARD_FMT"*/,
                                                              0LL);
...
LABEL_57:
      ...
      while ( 1 )
      {
        ...
        this = (MasterMissionReceiveConfirmListViewItemDraw_o *)Gift__IsItem_36488892(v31->fields.type, 0LL);
        ...
        this = (MasterMissionReceiveConfirmListViewItemDraw_o *)System_String__Format_60340188(
                                                                  format,
                                                                  v43,
                                                                  v34,
                                                                  v44,
