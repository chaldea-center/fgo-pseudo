void __fastcall MasterMissionReceiveConfirmListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B3A33F & 1) == 0 )
  {
    sub_1BD3458(&MasterMissionReceiveConfirmListViewItemDraw_TypeInfo, v1);
    byte_4B3A33F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3A33E & 1) == 0 )
  {
    sub_1BD3458(&Method_DataManager_GetMasterData_GiftMaster___, message);
    ...
    sub_1BD3458(&MasterMissionReceiveConfirmListViewItemDraw_TypeInfo, v15);
    sub_1BD3458(&UnityEngine_Object_TypeInfo, v16);
    sub_1BD3458(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v17);
    this = (MasterMissionReceiveConfirmListViewItemDraw_o *)sub_1BD3458(&StringLiteral_8675/*"MASTER_MISSION_RECEIVE_CONFIRM_REWARD_FMT"*/, v18);
    byte_4B3A33E = 1;
  }
  countText = 0LL;
  nameText = 0LL;
  ...
  if ( mode && !v10->fields.isInit )
  {
    ...
    this = (MasterMissionReceiveConfirmListViewItemDraw_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37FDC48 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !this )
      goto LABEL_71;
    ...
    this = (MasterMissionReceiveConfirmListViewItemDraw_o *)LocalizationManager__Get(
                                                              (System_String_o *)StringLiteral_8675/*"MASTER_MISSION_RECEIVE_CONFIRM_REWARD_FMT"*/,
                                                              0LL);
...
LABEL_57:
      ...
      while ( 1 )
      {
        ...
        this = (MasterMissionReceiveConfirmListViewItemDraw_o *)Gift__IsItem_38469552(v31->fields.type, 0LL);
        ...
        this = (MasterMissionReceiveConfirmListViewItemDraw_o *)System_String__Format_62539688(
                                                                  format,
                                                                  v43,
                                                                  v34,
                                                                  v44,
