void __fastcall MasterMissionReceiveConfirmListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB8701 & 1) == 0 )
  {
    sub_1BAB41C(&MasterMissionReceiveConfirmListViewItemDraw_TypeInfo, v1);
    byte_4AB8701 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB8700 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMasterData_GiftMaster___, message);
    ...
    sub_1BAB41C(&MasterMissionReceiveConfirmListViewItemDraw_TypeInfo, v15);
    sub_1BAB41C(&UnityEngine_Object_TypeInfo, v16);
    sub_1BAB41C(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v17);
    this = (MasterMissionReceiveConfirmListViewItemDraw_o *)sub_1BAB41C(&StringLiteral_8539/*"MASTER_MISSION_RECEIVE_CONFIRM_REWARD_FMT"*/, v18);
    byte_4AB8700 = 1;
  }
  countText = 0LL;
  nameText = 0LL;
  ...
  if ( mode && !v10->fields.isInit )
  {
    ...
    this = (MasterMissionReceiveConfirmListViewItemDraw_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_378A22C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !this )
      goto LABEL_71;
...
LABEL_57:
      ...
      while ( 1 )
      {
        ...
        this = (MasterMissionReceiveConfirmListViewItemDraw_o *)Gift__IsItem_38071756(v31->fields.type, 0LL);
        ...
        this = (MasterMissionReceiveConfirmListViewItemDraw_o *)System_String__Format_62062568(
                                                                  format,
                                                                  v43,
                                                                  v34,
                                                                  v44,
