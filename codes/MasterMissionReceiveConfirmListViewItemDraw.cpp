void MasterMissionReceiveConfirmListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CCA61A & 1) == 0 )
  {
    sub_1C713B0(&MasterMissionReceiveConfirmListViewItemDraw_TypeInfo);
    byte_4CCA61A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CCA619 & 1) == 0 )
  {
    ...
    this = (MasterMissionReceiveConfirmListViewItemDraw_o *)sub_1C713B0(&StringLiteral_8564/*"MASTER_MISSION_RECEIVE_CONFIRM_REWARD_FMT"*/);
    byte_4CCA619 = 1;
  }
  countText = 0;
  nameText = 0;
  ...
  if ( mode && !v10->fields.isInit )
  {
    ...
    this = (MasterMissionReceiveConfirmListViewItemDraw_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A5F158 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !this )
      goto LABEL_71;
    ...
    this = (MasterMissionReceiveConfirmListViewItemDraw_o *)LocalizationManager__Get(
                                                              (System_String_o *)StringLiteral_8564/*"MASTER_MISSION_RECEIVE_CONFIRM_REWARD_FMT"*/,
                                                              0);
...
LABEL_57:
      ...
      while ( 1 )
      {
        ...
        this = (MasterMissionReceiveConfirmListViewItemDraw_o *)Gift__IsItem_40699044(v23->fields.type, 0);
        ...
        this = (MasterMissionReceiveConfirmListViewItemDraw_o *)System_String__Format_64073100(format, v32, v26, v33, 0);
        if ( !v31 )
          goto LABEL_71;
