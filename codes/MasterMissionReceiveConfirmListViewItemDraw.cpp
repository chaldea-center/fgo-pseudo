void __fastcall MasterMissionReceiveConfirmListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BB791B & 1) == 0 )
  {
    sub_1C13D24(&MasterMissionReceiveConfirmListViewItemDraw_TypeInfo, v1);
    byte_4BB791B = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB791A & 1) == 0 )
  {
    sub_1C13D24(&Method_DataManager_GetMasterData_GiftMaster___, message);
    ...
    sub_1C13D24(&MasterMissionReceiveConfirmListViewItemDraw_TypeInfo, v15);
    sub_1C13D24(&UnityEngine_Object_TypeInfo, v16);
    sub_1C13D24(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v17);
    this = (MasterMissionReceiveConfirmListViewItemDraw_o *)sub_1C13D24(&StringLiteral_8705/*"MASTER_MISSION_RECEIVE_CONFIRM_DECIDE"*/, v18);
    byte_4BB791A = 1;
  }
  countText = 0LL;
  nameText = 0LL;
  ...
  if ( mode && !v10->fields.isInit )
  {
    ...
    this = (MasterMissionReceiveConfirmListViewItemDraw_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3869BD8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !this )
      goto LABEL_71;
...
LABEL_57:
      ...
      while ( 1 )
      {
        ...
        this = (MasterMissionReceiveConfirmListViewItemDraw_o *)Gift__IsItem_38830856(v31->fields.type, 0LL);
        ...
        this = (MasterMissionReceiveConfirmListViewItemDraw_o *)System_String__Format_62982384(
                                                                  format,
                                                                  v43,
                                                                  v34,
                                                                  v44,
