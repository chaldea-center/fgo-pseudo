        ...
        const MethodInfo *method)
{
  ...
  if ( this->fields.rotate >= 1 )
  {
    if ( !trEffect )
      goto LABEL_13;
    UnityEngine_Transform__Rotate_69194480(trEffect, 0.0, 180.0, 0.0, 0LL);
  }
  if ( this->fields.scaleX <= 0 && this->fields.scaleZ < 1 )
    return;
  if ( !trEffect )
LABEL_13:
    sub_1B68930(this, trEffect);
        ...
        const MethodInfo *method)
{
  ...
  if ( !System_String__IsNullOrEmpty(this->fields.parentNodeName, 0LL) )
  {
    ...
    *baseNodeName = parentNodeName;
    sub_1B68678((ServantStatusBattleListViewItem_o *)baseNodeName, (int32_t)parentNodeName, v5, v6);
  }
}