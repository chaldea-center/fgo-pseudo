void FollowerSelectItemListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C21E22 & 1) == 0 )
  {
    sub_1C2D490(&FollowerSelectItemListViewItemDraw_TypeInfo);
    byte_4C21E22 = 1;
  }
  FollowerSelectItemListViewItemDraw_TypeInfo->static_fields->CAMPAIGN_TOP_COLOR = (struct UnityEngine_Color_o)xmmword_C09100;
  v1 = FollowerSelectItemListViewItemDraw_TypeInfo;
  FollowerSelectItemListViewItemDraw_TypeInfo->static_fields->CAMPAIGN_BOT_COLOR = (struct UnityEngine_Color_o)xmmword_C09420;
  ...
  *(_OWORD *)&v1->static_fields->GrandMaskWidth01 = xmmword_C094F0;
}
...
void FollowerSelectItemListViewItemDraw__Awake(FollowerSelectItemListViewItemDraw_o *this, const MethodInfo *method)
{
  ...
  AtlasManager__SetEventSprite(skillIconSprite, (System_String_o *)StringLiteral_20215/*"icon_skill_mini"*/, 0);
  AtlasManager__SetEventSprite(this->fields.skillTitleSprite, (System_String_o *)StringLiteral_20397/*"img_friend_skill"*/, 0);
  AtlasManager__SetEventSprite(this->fields.appendSkillIconSprite, (System_String_o *)StringLiteral_20111/*"icon_append_mini"*/, 0);
  AtlasManager__SetEventSprite(this->fields.appendSkillTitleSprite, (System_String_o *)StringLiteral_20396/*"img_friend_appendskill"*/, 0);
  ...
  if ( ((unsigned __int8)transform & 1) != 0 )
  {
    ...
    if ( !v8 )
      goto LABEL_14;
    this->fields.defaultMaskAtlas = v8->fields.mAtlas;
    transform = (UnityEngine_Component_o *)sub_1C2D434(&this->fields.defaultMaskAtlas);
    v9 = this->fields.maskSprite;
    if ( !v9
      || (this->fields.defaultMaskName = v9->fields.mSpriteName,
          sub_1C2D434(&this->fields.defaultMaskName),
        ...
        const MethodInfo *method)
{
  ...
  if ( ServantLeader )
  {
    ...
    *(_QWORD *)&v25.fields.fakeValue = v12;
    v14 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v25, 0) > 0;
  }
  else
  {
    v14 = 0;
...
LABEL_52:
    sub_1C2D6EC(switchSkillInfo, *(_QWORD *)&targetDisplaySkill);
  }
  if ( displaySkill != 1 )
  {
    if ( displaySkill )
...
LABEL_49:
  ...
  if ( (int)max_length >= 1 )
  {
    ...
    do
    {
      ...
      else
      {
        ...
        else
        {
          ...
          if ( !this )
            goto LABEL_48;
          SkillIconComponent__Set_40800888((SkillIconComponent_o *)this, v20[4], v20[5], v20[12], v20[13], 0);
          ...
          if ( !this )
            goto LABEL_48;
          UIIconLabel__Set_40889008((UIIconLabel_o *)this, 48, v20[5], 0, 0, 0, 0, 0, 0, 0, 0);
        }
      }
    ...
    while ( v27 < SLODWORD(v26->max_length) );
  }
}
        ...
        const MethodInfo *method)
{
  ...
  FollowerSelectItemListViewItemDraw_o *v37; // x1
  bool activeSelf; // w8
  float v39; // s8
  bool v40; // w8
  float v41; // s9
  ...
  if ( (byte_4C21E1C & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_6459/*"FOLLOWER_SELECT_TYPE_POINT_UP"*/);
    this = (FollowerSelectItemListViewItemDraw_o *)sub_1C2D490(&StringLiteral_1/*""*/);
    byte_4C21E1C = 1;
  }
  if ( !item )
    goto LABEL_78;
    ...
    switch ( followerInfo->fields.type )
    {
      case 1:
        ...
        if ( !questRestrictionInfo )
          goto LABEL_20;
        this = (FollowerSelectItemListViewItemDraw_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39D3CCC *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
        if ( !this )
          goto LABEL_78;
        ...
        if ( !this )
          goto LABEL_78;
        LOBYTE(questRestrictionInfo) = QuestEntity__HasFlag_42234640(
                                         (QuestEntity_o *)this,
                                         0x8000000,
...
LABEL_41:
  ...
  if ( !this )
    goto LABEL_78;
  UIIconLabel__Set_40889008((UIIconLabel_o *)this, 55, FollowerPointNpc, 0, 0, 0, 0, 0, 0, 0, 0);
  if ( v23 > 0 || value >= 1 )
  {
    if ( value <= 0 )
      v26 = 1000;
    ...
    this = (FollowerSelectItemListViewItemDraw_o *)System_String__Format(v30, v34, 0);
...
LABEL_78:
  ...
  if ( !campaignLabel )
    goto LABEL_78;
  v37 = (FollowerSelectItemListViewItemDraw_o *)StringLiteral_1/*""*/;
LABEL_65:
  UILabel__set_text(campaignLabel, (System_String_o *)v37, 0);
  ...
  if ( !this )
    goto LABEL_78;
  v40 = UnityEngine_GameObject__get_activeSelf((UnityEngine_GameObject_o *)this, 0);
  this = (FollowerSelectItemListViewItemDraw_o *)v6->fields.friendPointIconLabel;
  v41 = v40 ? -22.0 : 20.0;
  if ( !this )
    goto LABEL_78;
  ...
  GameObjectExtensions__SetLocalPositionY(v43, v41, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21E19 & 1) == 0 )
  {
    ...
    this = (FollowerSelectItemListViewItemDraw_o *)sub_1C2D490(&StringLiteral_20324/*"img_blankbg_03"*/);
    byte_4C21E19 = 1;
  }
  if ( !item )
    goto LABEL_13;
  if ( item->fields._IsGrandSupport_k__BackingField )
  {
    ...
    this = (FollowerSelectItemListViewItemDraw_o *)AtlasManager__SetPartyOrganizationImage(
                                                     ...
                                                     (System_String_o *)StringLiteral_20371/*"img_equipface_grand"*/,
                                                     0);
    if ( servantLeader )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( skillButtonList )
  {
    ...
    if ( max_length >= 1 )
    {
      ...
      do
      {
        if ( v13 >= LODWORD(skillButtonList->max_length) )
          sub_1C2D6F4(supportInfoButton, v9, v10);
...
LABEL_18:
      sub_1C2D6EC(supportInfoButton, v9);
    }
  }
LABEL_19:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21E16 & 1) == 0 )
  {
    sub_1C2D490(&AtlasManager_TypeInfo);
    sub_1C2D490(&BalanceConfig_TypeInfo);
    sub_1C2D490(&Method_DataManager_GetMasterData_EventBoostItemUsedMaster___);
    ...
    sub_1C2D490(&StringLiteral_6438/*"FOLLOWER_SELECT_FRIEND_CHOCO_REMAINING_COUNT_PREFIX_TEXT"*/);
    sub_1C2D490(&StringLiteral_6439/*"FOLLOWER_SELECT_FRIEND_CHOCO_REMAINING_COUNT_SUFFIX_TEXT"*/);
    sub_1C2D490(&StringLiteral_6452/*"FOLLOWER_SELECT_QUEST_RESTRICTION_WARNING2"*/);
    sub_1C2D490(&StringLiteral_6437/*"FOLLOWER_SELECT_FRIEND_CHOCO_DEFAULT_COLOR"*/);
    sub_1C2D490(&StringLiteral_6451/*"FOLLOWER_SELECT_QUEST_RESTRICTION_WARNING"*/);
    sub_1C2D490(&StringLiteral_6436/*"FOLLOWER_SELECT_FRIEND_CHOCO_AVAILABLE_COLOR"*/);
    sub_1C2D490(&StringLiteral_1/*""*/);
    sub_1C2D490(&StringLiteral_6440/*"FOLLOWER_SELECT_FRIEND_CHOCO_UNAVAILABLE_COLOR"*/);
    sub_1C2D490(&StringLiteral_20429/*"img_listbg_02"*/);
    byte_4C21E16 = 1;
  }
  entity = 0;
  v91 = 0;
  ...
  *(_QWORD *)&color.fields.b = 0;
  ...
  {
    FollowerBgImage = (System_String_o *)StringLiteral_20429/*"img_listbg_02"*/;
  }
  else
  {
    if ( !Grade_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(Grade_TypeInfo);
    Kind_40206588 = Grade__GetKind_40206588(followerInfo, 0);
    FollowerBgImage = Grade__GetFollowerBgImage(Kind_40206588, 0);
  }
  ...
  if ( ServantLeader )
  {
    ...
    *(_QWORD *)&v93.fields.fakeValue = v28;
    v30 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v93, 0) > 0;
  }
  else
  {
    v30 = 0;
...
LABEL_78:
  ...
  if ( v7->fields.isUniqueSvtRestriction || v7->fields.isUniqueIndividualityRestriction )
  {
    ...
    if ( v67 <= warningMessageWidth )
    {
      if ( !byte_4C20DA6 )
      {
        switchSkillInfo = sub_1C2D490(&UnityEngine_Vector3_TypeInfo);
        byte_4C20DA6 = 1;
      }
...
LABEL_79:
  ...
  if ( UnityEngine_Object__op_Inequality(classCompatibilityIcon, 0, 0) )
  {
    ...
    *(_QWORD *)&v94.fields.fakeValue = v44;
    if ( CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v94, 0) < 1
      || (v42 & 1) != 0
    ...
    switchSkillInfo = (__int64)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39D3CCC *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    if ( !switchSkillInfo )
      goto LABEL_188;
    ...
    {
      v86 = (FollowerSelectItemListViewItemDraw_o *)sub_1C2D9AC(switchSkillInfo);
    ...
    if ( !v49 )
      goto LABEL_108;
    v50 = v48;
    switchSkillInfo = (__int64)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39D3CCC *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !switchSkillInfo )
      goto LABEL_188;
    ...
    if ( v51 )
    {
      ...
      *(_QWORD *)&v95.fields.fakeValue = v54;
      switchSkillInfo = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v95, 0);
      if ( !v56 )
        goto LABEL_188;
...
LABEL_108:
  ...
  if ( (switchSkillInfo & 1) != 0 )
  {
    ...
    if ( questRestrictionInfo )
    {
      ...
      if ( TitleInfoControl__IsEnableEventShopButton_39691620((EventDetailEntity_o *)v62, 0) )
      {
...
LABEL_123:
    ...
    switchSkillInfo = (__int64)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39D3CCC *)Method_SingletonMonoBehaviour_ServantAssetLoadManager__get_Instance__);
    if ( !switchSkillInfo )
      goto LABEL_188;
...
LABEL_151:
      ...
      switchSkillInfo = (__int64)DataManager__GetMasterData_object_(
                                   (DataManager_o *)switchSkillInfo,
                                   (const MethodInfo_30CE950 *)Method_DataManager_GetMasterData_EventBoostItemUsedMaster___);
      ...
      {
LABEL_188:
        sub_1C2D6EC(switchSkillInfo, item);
      }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21E18 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    sub_1C2D490(&StringLiteral_9348/*"NP_DISABLE_COLOR_NAME"*/);
    sub_1C2D490(&StringLiteral_9349/*"NP_HIDE_NAME"*/);
    sub_1C2D490(&StringLiteral_9350/*"NP_HIDE_NAME_LEVEL"*/);
  ...
  else
  {
    ...
    *(_QWORD *)&v41.fields.fakeValue = v18;
    this = (FollowerSelectItemListViewItemDraw_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(
                                                     v41,
                                                     0);
    if ( !v20 )
LABEL_68:
  ...
  if ( followerInfo && followerInfo->fields.type == 4 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v23 = LocalizationManager__Get((System_String_o *)StringLiteral_9348/*"NP_DISABLE_COLOR_NAME"*/, 0);
    v24 = (Il2CppObject *)LocalizationManager__Get((System_String_o *)StringLiteral_9349/*"NP_HIDE_NAME"*/, 0);
    v25 = v23;
LABEL_57:
  ...
  if ( !isHideSupport )
  {
    ...
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    v31 = DataManager__GetMaster_object_((const MethodInfo_30CE8FC *)Method_DataManager_GetMaster_ServantLimitAddMaster___);
    ...
    *(_QWORD *)&v43.fields.fakeValue = v32;
    ...
    if ( FollowerSelectItemListViewItem__GetTreasureDeviceLevelIcon(item, v36) <= 1 )
      v37 = (System_String_o **)&StringLiteral_9347/*"NP_COLOR_NAME"*/;
    else
      v37 = (System_String_o **)&StringLiteral_9354/*"NP_MAX_COLOR_NAME"*/;
    v38 = *v37;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v26 = LocalizationManager__Get((System_String_o *)StringLiteral_9350/*"NP_HIDE_NAME_LEVEL"*/, 0);
LABEL_58:
  v39 = v26;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21E1A & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_6453/*"FOLLOWER_SELECT_RECOMMENDED_TEXT"*/);
    sub_1C2D490(&StringLiteral_1/*""*/);
    sub_1C2D490(&StringLiteral_20432/*"img_listbg_line_grand"*/);
    sub_1C2D490(&StringLiteral_20188/*"icon_friend"*/);
    this = (FollowerSelectItemListViewItemDraw_o *)sub_1C2D490(&StringLiteral_20187/*"icon_follow"*/);
    byte_4C21E1A = 1;
  }
  if ( !v3 )
    goto LABEL_84;
  ...
  if ( v3->fields._IsGrandSupport_k__BackingField )
  {
    ...
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetPartyOrganizationImage(grandPlayerBaseLineSprite, (System_String_o *)StringLiteral_20432/*"img_listbg_line_grand"*/, 0);
    AtlasManager__SetPartyOrganizationImage(
      v4->fields.grandSvtProfileBackSpr,
      (System_String_o *)StringLiteral_20433/*"img_listbg_svtprof_grand"*/,
      0);
  }
  else
  {
  ...
  else
  {
    if ( (byte_4C21E0C & 1) == 0 )
    {
      this = (FollowerSelectItemListViewItemDraw_o *)sub_1C2D490(&StringLiteral_19056/*"error"*/);
      byte_4C21E0C = 1;
      v11 = v3->fields.followerInfo;
    }
    if ( !grandPlayerNameLabel )
      goto LABEL_84;
    v12 = v11 ? &v11->fields.userName : (System_String_o **)&StringLiteral_19056/*"error"*/;
    ...
    UIIconLabel__Set_40889008(grandPlayerLevelIconLabel, 2, userLv, 0, 0, 0, 0, 0, 0, 0, 0);
    loginDataLabel = v4->fields.loginDataLabel;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v16 = LocalizationManager__Get((System_String_o *)StringLiteral_13389/*"TIME_BEFORE_TITLE_COLOR"*/, 0);
  ...
  if ( !Grade_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(Grade_TypeInfo);
  Kind_40206588 = Grade__GetKind_40206588(v27, 0);
  UserGradeComponent__Set(grandGradeIcon, Kind_40206588, 0);
  ...
  {
    v31 = &StringLiteral_20229/*"icon_support_01"*/;
    goto LABEL_58;
  }
  if ( type == 5 )
  {
    v31 = &StringLiteral_20187/*"icon_follow"*/;
    goto LABEL_58;
  }
  if ( type != 1 )
  {
LABEL_55:
  ...
  v31 = &StringLiteral_20188/*"icon_friend"*/;
LABEL_58:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21E1B & 1) == 0 )
  {
    ...
    sub_1C2D490(&DataManager_TypeInfo);
    sub_1C2D490(&OptionManager_TypeInfo);
    this = (FollowerSelectItemListViewItemDraw_o *)sub_1C2D490(&StringLiteral_113/*" "*/);
    byte_4C21E1B = 1;
  }
  if ( !item )
    goto LABEL_54;
  ...
  if ( item->fields._IsRecommendFollower_k__BackingField )
  {
    ...
    if ( LODWORD(userRecommendSupportHash->max_length) )
    {
      ...
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      this = (FollowerSelectItemListViewItemDraw_o *)DataManager__GetMaster_object_((const MethodInfo_30CE8FC *)Method_DataManager_GetMaster_RecommendAdviceMessageMaster___);
        ...
        const MethodInfo *method)
{
  ...
  FollowerSelectItemListViewItemDraw_o *v25; // x2
  struct SkillIconComponent_array *v26; // x8
  __int64 v27; // x21
  ...
  FollowerSelectItemListViewItemDraw___c_c *v46; // x8
  ...
  ServantCommandCardListComponent_o *v54; // x21
  int32_t SvtId; // w0
  ...
  if ( (byte_4C21E17 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_FollowerSelectItemListViewItemDraw___c__SetServantInfo_b__103_0__);
    sub_1C2D490(&FollowerSelectItemListViewItemDraw___c_TypeInfo);
    sub_1C2D490(&StringLiteral_3696/*"COMMON_NO_ENTRY"*/);
    sub_1C2D490(&StringLiteral_11644/*"SERVANT_HIDE_NAME"*/);
    ...
    this = (FollowerSelectItemListViewItemDraw_o *)sub_1C2D490(&StringLiteral_9318/*"NO_ENTRY_NAME"*/);
    byte_4C21E17 = 1;
  }
  if ( !v5 )
    goto LABEL_132;
  ...
  if ( ServantLeader )
  {
    ...
    if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    *(_QWORD *)&v75.fields.currentCryptoKey = v11;
    *(_QWORD *)&v75.fields.fakeValue = v10;
    if ( CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v75, 0) >= 1 )
    {
      ...
      if ( (v18 & 1) != 0 )
      {
        ...
        this = (FollowerSelectItemListViewItemDraw_o *)LocalizationManager__Get(
                                                         (System_String_o *)StringLiteral_11644/*"SERVANT_HIDE_NAME"*/,
                                                         0);
      }
      else
      {
        this = (FollowerSelectItemListViewItemDraw_o *)FollowerSelectItemListViewItem__get_SvtNameText(v5, v35);
      }
      item = (FollowerSelectItemListViewItem_o *)this;
      if ( !v17 )
        goto LABEL_132;
      UIRangeLabel__Set(v17, (System_String_o *)this, 0, 1, 0, 0, 0);
      FollowerSelectItemListViewItemDraw__SetNPInfo(v6, v5, v9, IsNpc, v18 & 1, v36);
      eventUpValIcon = (UnityEngine_Object_o *)v6->fields.eventUpValIcon;
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      if ( UnityEngine_Object__op_Inequality(eventUpValIcon, 0, 0) )
      {
        if ( FollowerSelectItemListViewItem__get_ServantLeader(v5, v38) )
        {
          this = (FollowerSelectItemListViewItemDraw_o *)FollowerSelectItemListViewItem__get_ServantLeader(v5, v40);
          if ( !this )
            goto LABEL_132;
          ...
          if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
          *(_QWORD *)&v76.fields.currentCryptoKey = baseButton;
          *(_QWORD *)&v76.fields.fakeValue = servantFaceIcon;
          v43 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v76, 0);
          this = (FollowerSelectItemListViewItemDraw_o *)FollowerSelectItemListViewItem__get_ServantLeader(v5, v44);
          if ( !this )
            goto LABEL_132;
        ...
        v46 = FollowerSelectItemListViewItemDraw___c_TypeInfo;
        ...
        _9__103_0 = (System_Func_object__int__o *)v46->static_fields->__9__103_0;
        if ( !_9__103_0 )
        {
          ...
          _9__103_0 = (System_Func_object__int__o *)sub_1C2D6DC(System_Func_EquipTargetInfo__int__TypeInfo);
          ...
          sub_1C2D434(&static_fields->__9__103_0);
        }
        ...
        {
          this = (FollowerSelectItemListViewItemDraw_o *)sub_1C2D538(int___TypeInfo, 1);
          if ( !this )
            goto LABEL_132;
          v25 = this;
          if ( !LODWORD(this->fields.m_CancellationTokenSource) )
LABEL_133:
            sub_1C2D6F4(this, item, v25);
...
LABEL_132:
      ...
      FollowerSelectItemListViewItemDraw__SetSkillIconInfo(v6, v5, v9, v39);
      FollowerSelectItemListViewItemDraw__SetAppendSkillIconInfo(v6, v5, v9, v51);
      FollowerSelectItemListViewItemDraw__ChangeDisplaySkill(v6, targetDisplaySkill, v5, v52);
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        v54 = v6->fields.svtCommandCardList;
        if ( (v18 & 1) != 0 )
        {
          if ( !v54 )
            goto LABEL_132;
        ...
        else
        {
          ...
          if ( !v54 )
            goto LABEL_132;
          ServantCommandCardListComponent__Set_40772840(v54, v57, commandCardParam, (System_Int32_array *)this, 2, 1, 0);
        }
      }
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        ...
        v61 = pushUserSvtId && pushUserSvtId == v9->fields.userSvtId;
      ...
      if ( v5->fields._IsDataLost_k__BackingField )
      {
        ...
        if ( !AtlasManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
        AtlasManager__SetPartyOrganizationImage(v65, (System_String_o *)StringLiteral_18474/*"datalost_svt_select"*/, 0);
...
LABEL_130:
      ...
      if ( this )
      {
        UISprite__set_spriteName((UISprite_o *)this, (System_String_o *)StringLiteral_20380/*"img_frames_mask01"*/, 0);
        this = (FollowerSelectItemListViewItemDraw_o *)v6->fields.dataLostMaskSprite;
        if ( this )
        {
          v78.fields.a = 0.62353;
          v78.fields.r = 0.0;
          v78.fields.g = 0.0;
          v78.fields.b = 0.0;
          UIWidget__set_color((UIWidget_o *)this, v78, 0);
          v67 = v6->fields.dataLostMaskMessageLabel;
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          v68 = LocalizationManager__Get((System_String_o *)StringLiteral_11540/*"SELECT_NO_SORTIE_TIMES_TO_RESTART"*/, 0);
          TimesToRestart_k__BackingField = v5->fields._TimesToRestart_k__BackingField;
          v72 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &TimesToRestart_k__BackingField, v69, v70, v71);
          this = (FollowerSelectItemListViewItemDraw_o *)System_String__Format(v68, v72, 0);
          if ( v67 )
          {
...
LABEL_128:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  this = (FollowerSelectItemListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3696/*"COMMON_NO_ENTRY"*/, 0);
  ...
  this = (FollowerSelectItemListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_9318/*"NO_ENTRY_NAME"*/, 0);
  if ( !svtNpRangeLabel )
    goto LABEL_132;
  ...
  if ( !skillIconList )
    goto LABEL_132;
  v6->fields.skillInfoList = (struct SkillInfo_array *)sub_1C2D538(
                                                         SkillInfo___TypeInfo,
                                                         LODWORD(skillIconList->max_length));
  this = (FollowerSelectItemListViewItemDraw_o *)sub_1C2D434(&v6->fields.skillInfoList);
  ...
  if ( !appendSkillIconList )
    goto LABEL_132;
  v6->fields.appendSkillInfoList = (struct SkillInfo_array *)sub_1C2D538(
                                                               SkillInfo___TypeInfo,
                                                               LODWORD(appendSkillIconList->max_length));
  this = (FollowerSelectItemListViewItemDraw_o *)sub_1C2D434(&v6->fields.appendSkillInfoList);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21E20 & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_12481/*"SUPPORT_CLASS_BOARD_EFFECT_DISP_BUTTON"*/);
    sub_1C2D490(&StringLiteral_12482/*"SUPPORT_CLASS_BOARD_EFFECT_NOT_BUTTON"*/);
  ...
  if ( UnityEngine_Object__op_Inequality(v9, 0, 0) )
  {
    ...
    else
    {
      ...
      {
LABEL_16:
        gameObject = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12481/*"SUPPORT_CLASS_BOARD_EFFECT_DISP_BUTTON"*/, 0);
...
LABEL_28:
    ...
    gameObject = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12482/*"SUPPORT_CLASS_BOARD_EFFECT_NOT_BUTTON"*/, 0);
    if ( !classBoardOpenButtonLabel )
      goto LABEL_57;
    UILabel__set_text(classBoardOpenButtonLabel, (System_String_o *)gameObject, 0);
    gameObject = (UnityEngine_Component_o *)this->fields.classBoardOpenButtonLabel;
...
LABEL_33:
  ...
  if ( ((unsigned __int8)gameObject & 1) != 0 )
  {
    ...
    if ( item->fields.isMaxOpenClassBoard )
      v20 = (Il2CppObject **)&StringLiteral_6393/*"FFFF00"*/;
    else
      v20 = (Il2CppObject **)&StringLiteral_6394/*"FFFFFF"*/;
    v21 = *v20;
    v35 = item->fields.openClassBoardNum;
    v22 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v35, v17, v18, v19);
    gameObject = (UnityEngine_Component_o *)System_String__Format_63499156(
    ...
    if ( openGrandClassBoardNum < 0 )
      return;
    v28 = (Il2CppObject **)(item->fields.isMaxOpenGrandClassBoard ? &StringLiteral_6393/*"FFFF00"*/ : &StringLiteral_6394/*"FFFFFF"*/);
    v29 = *v28;
    v34 = openGrandClassBoardNum;
    v30 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v34, v24, v25, v26);
    gameObject = (UnityEngine_Component_o *)System_String__Format_63499156(
                                              (System_String_o *)StringLiteral_16015/*"[{0}]+{1}[-]"*/,
                                              v29,
                                              v30,
...
void FollowerSelectItemListViewItemDraw___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C2D6DC(FollowerSelectItemListViewItemDraw___c_TypeInfo);
  ...
  sub_1C2D434(FollowerSelectItemListViewItemDraw___c_TypeInfo->static_fields);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21E24 & 1) == 0 )
  {
    this = (FollowerSelectItemListViewItemDraw___c_o *)sub_1C2D490(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    byte_4C21E24 = 1;
  }
  if ( !x )
    sub_1C2D6EC(this, x);
