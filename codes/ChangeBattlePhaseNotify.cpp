void __fastcall ChangeBattlePhaseNotify___ctor(ChangeBattlePhaseNotify_o *this, const MethodInfo *method)
{
  ...
  v5 = (System_Collections_Generic_Dictionary_TKey__TValue__o *)sub_1BE4D18(System_Collections_Generic_Dictionary_ServantAnimationOverwriteEntity_PhaseType__ServantAnimationOverwriteEntity_PhaseType__TypeInfo);
  System_Collections_Generic_Dictionary_Int32Enum__Int32Enum____ctor(
    v5,
    (const MethodInfo_327C800 *)Method_System_Collections_Generic_Dictionary_ServantAnimationOverwriteEntity_PhaseType__ServantAnimationOverwriteEntity_PhaseType___ctor__);
  if ( !v5 )
    sub_1BE4D28(v6, v7);
  System_Collections_Generic_Dictionary_Int32Enum__Int32Enum___Add(
    ...
    4,
    3,
    (const MethodInfo_327D1C4 *)Method_System_Collections_Generic_Dictionary_ServantAnimationOverwriteEntity_PhaseType__ServantAnimationOverwriteEntity_PhaseType__Add__);
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.dicDetailToPhase, (int64_t)v5, v8, v9, v10, v11, v12, v13);
...
int32_t __fastcall ChangeBattlePhaseNotify__get_Phase(ChangeBattlePhaseNotify_o *this, const MethodInfo *method)
{
  ...
  return BasicHelper__GetValue_Int32Enum__Int32Enum_(
           ...
           this->fields._DetailPhase_k__BackingField,
           (const MethodInfo_2F4758C *)Method_BasicHelper_GetValue_ServantAnimationOverwriteEntity_PhaseType__ServantAnimationOverwriteEntity_PhaseType___);
}
