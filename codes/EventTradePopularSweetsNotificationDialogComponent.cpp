        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A027EF & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_EventTradePopularSweetsNotificationDialogComponent_EndClose__, v3);
    sub_1B64870(&Method_EventTradePopularSweetsNotificationDialogComponent_OnClickCloseButton__, v4);
    byte_4A027EF = 1;
  }
  ...
  if ( (*((_BYTE *)Method_EventTradePopularSweetsNotificationDialogComponent_OnClickCloseButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1B64888(Method_EventTradePopularSweetsNotificationDialogComponent_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  AndroidBackKeyManager__AddBackBtn_41451800(transform, (System_String_o *)StringLiteral_15577/*"Window/CloseButton"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A027EE & 1) == 0 )
  {
    sub_1B64870(&System_Action_UISprite__TypeInfo, itemList);
    sub_1B64870(&AtlasManager_TypeInfo, v9);
    sub_1B64870(&Method_BasicHelper_ForEach_UISprite___, v10);
    sub_1B64870(&System_DateTime_TypeInfo, v11);
    sub_1B64870(&EventTradeTimeCalculation_TypeInfo, v12);
    ...
    sub_1B64870(&Method_EventTradePopularSweetsNotificationDialogComponent___c__Open_b__8_0__, v17);
    sub_1B64870(&EventTradePopularSweetsNotificationDialogComponent___c_TypeInfo, v18);
    sub_1B64870(&StringLiteral_13327/*"TRADE_EVENT_POPULAR_NOTIFICATION_DIALOG_PICKUP_LIST_TITLE"*/, v19);
    sub_1B64870(&StringLiteral_13328/*"TRADE_EVENT_POPULAR_NOTIFICATION_DIALOG_TITLE"*/, v20);
    sub_1B64870(&StringLiteral_13326/*"TRADE_EVENT_POPULAR_NOTIFICATION_DIALOG_MESSAGE"*/, v21);
    sub_1B64870(&StringLiteral_20318/*"img_popularitem_{0}"*/, v22);
    sub_1B64870(&StringLiteral_3733/*"COMMON_CONFIRM_CLOSE"*/, v23);
    sub_1B64870(&StringLiteral_18426/*"ddd"*/, v24);
    sub_1B64870(&StringLiteral_20089/*"icon_popularitem_unknown"*/, v25);
    sub_1B64870(&StringLiteral_25369/*"？？？"*/, v26);
    byte_4A027EE = 1;
  }
  v90 = 0LL;
  Month = 0;
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_13328/*"TRADE_EVENT_POPULAR_NOTIFICATION_DIALOG_TITLE"*/, 0LL);
  if ( !titleLabel )
    goto LABEL_69;
  UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL);
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  v30.fields._dateData = NetworkManager__getLocalDateTime_38166792(updateTime, 0LL).fields._dateData;
  ...
  v34 = LocalizationManager__Get((System_String_o *)StringLiteral_13326/*"TRADE_EVENT_POPULAR_NOTIFICATION_DIALOG_MESSAGE"*/, 0LL);
  v35 = (System_Object_array *)sub_1B64918(object___TypeInfo, 6LL);
  ...
  if ( gameObject )
  {
    gameObject = (UnityEngine_GameObject_o *)sub_1B649AC(gameObject, v35->obj.klass->_1.element_class);
    if ( !gameObject )
      goto LABEL_71;
  }
  if ( !v35->max_length )
    goto LABEL_70;
  v35->m_Items[0] = v38;
  sub_1B64814((ServantStatusBattleListViewItem_o *)v35->m_Items, (int32_t)v38, v36, v37);
  ...
  if ( v35->max_length <= 1 )
    goto LABEL_70;
  v35->m_Items[1] = v41;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v35->m_Items[1], (int32_t)v41, v39, v40);
  v95.fields._dateData = (uint64_t)&dateData;
  gameObject = (UnityEngine_GameObject_o *)System_DateTime__ToString_62074212(
                                             v95,
                                             (System_String_o *)StringLiteral_18426/*"ddd"*/,
                                             0LL);
  ...
  if ( v35->max_length <= 2 )
    goto LABEL_70;
  v35->m_Items[2] = v44;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v35->m_Items[2], (int32_t)v44, v42, v43);
  ...
  if ( v35->max_length <= 3 )
    goto LABEL_70;
  v35->m_Items[3] = v47;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v35->m_Items[3], (int32_t)v47, v45, v46);
  ...
  if ( v35->max_length <= 4 )
    goto LABEL_70;
  v35->m_Items[4] = v50;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v35->m_Items[4], (int32_t)v50, v48, v49);
  ...
  if ( gameObject )
  {
    ...
    {
LABEL_71:
      v86 = sub_1B64AF0(gameObject);
      sub_1B64998(v86, 0LL);
    }
  }
  if ( v35->max_length <= 5 )
LABEL_70:
    sub_1B64AD4(gameObject, v28);
  v35->m_Items[5] = v53;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v35->m_Items[5], (int32_t)v53, v51, v52);
  gameObject = (UnityEngine_GameObject_o *)System_String__Format_61398084(v34, v35, 0LL);
  if ( !detailLabel )
    goto LABEL_69;
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_13327/*"TRADE_EVENT_POPULAR_NOTIFICATION_DIALOG_PICKUP_LIST_TITLE"*/, 0LL);
  if ( !pickupListLabel )
    goto LABEL_69;
  ...
  if ( !_9__8_0 )
  {
    ...
    _9__8_0 = (System_Action_object__o *)sub_1B64ABC(System_Action_UISprite__TypeInfo);
    ...
    sub_1B64814((ServantStatusBattleListViewItem_o *)&static_fields->__9__8_0, (int32_t)_9__8_0, v61, v62);
  }
  ...
  if ( (int)itemList->max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( BYTE4(v72->_1.properties) )
      {
        ...
        gameObject = (UnityEngine_GameObject_o *)System_String__Format((System_String_o *)StringLiteral_20318/*"img_popularitem_{0}"*/, v76, 0LL);
        max_length = itemList->max_length;
        v77 = (System_String_o *)gameObject;
      }
      else
      {
        v77 = (System_String_o *)StringLiteral_20089/*"icon_popularitem_unknown"*/;
      }
      if ( v65 >= max_length )
        goto LABEL_70;
      v78 = *v73;
      ...
      {
        v80 = (System_String_o **)&StringLiteral_25369/*"？？？"*/;
      }
      ...
      gameObject = (UnityEngine_GameObject_o *)AtlasManager__SetEventUI_37549072(v82, v84, v77, 0LL);
...
LABEL_68:
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.closeCallbackFunc, (int32_t)v87, v63, v64);
...
void __fastcall EventTradePopularSweetsNotificationDialogComponent___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A027F2 & 1) == 0 )
  {
    sub_1B64870(&EventTradePopularSweetsNotificationDialogComponent___c_TypeInfo, v1);
    byte_4A027F2 = 1;
  }
  v2 = (Il2CppObject *)sub_1B64ABC(EventTradePopularSweetsNotificationDialogComponent___c_TypeInfo);
