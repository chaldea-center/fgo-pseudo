        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB8A49 & 1) == 0 )
  {
    sub_1BAB41C(&BattleActionData_TypeInfo, msgEnt);
    byte_4AB8A49 = 1;
  }
  v5 = (BattleActionData_o *)sub_1BAB668(BattleActionData_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB8A48 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMaster_BattleMessageMaster___, logic);
    this = (MessageBattleLogicTask_o *)sub_1BAB41C(&DataManager_TypeInfo, v5);
    byte_4AB8A48 = 1;
  }
  ...
  this = (MessageBattleLogicTask_o *)DataManager__GetMaster_object_((const MethodInfo_2EC5574 *)Method_DataManager_GetMaster_BattleMessageMaster___);
  if ( !this )
LABEL_31:
...
LABEL_27:
          ...
          if ( !this )
            goto LABEL_31;
          BattlePerformance__addActionData_42294328((BattlePerformance_o *)this, InitActionData, 0LL);
