        ...
        const MethodInfo *method)
{
  ...
  v5 = (BattleActionData_o *)sub_1C22084(BattleActionData_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDF352 & 1) == 0 )
  {
    ...
    this = (MessageBattleLogicTask_o *)sub_1C21E38(&DataManager_TypeInfo);
    byte_4BDF352 = 1;
  }
  ...
  this = (MessageBattleLogicTask_o *)DataManager__GetMaster_object_((const MethodInfo_2FAFDB0 *)Method_DataManager_GetMaster_BattleMessageMaster___);
  if ( !this )
LABEL_31:
...
LABEL_27:
          ...
          if ( !this )
            goto LABEL_31;
          BattlePerformance__addActionData_43202092((BattlePerformance_o *)this, InitActionData, 0LL);
