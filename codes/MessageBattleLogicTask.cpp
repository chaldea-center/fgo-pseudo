        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCA8A1 & 1) == 0 )
  {
    sub_1C1ABD4(&BattleActionData_TypeInfo, msgEnt);
    byte_4BCA8A1 = 1;
  }
  v5 = (BattleActionData_o *)sub_1C1AE20(BattleActionData_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCA8A0 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataManager_GetMaster_BattleMessageMaster___, logic);
    this = (MessageBattleLogicTask_o *)sub_1C1ABD4(&DataManager_TypeInfo, v5);
    byte_4BCA8A0 = 1;
  }
  ...
  this = (MessageBattleLogicTask_o *)DataManager__GetMaster_object_((const MethodInfo_2F9F43C *)Method_DataManager_GetMaster_BattleMessageMaster___);
  if ( !this )
LABEL_31:
...
LABEL_27:
          ...
          if ( !this )
            goto LABEL_31;
          BattlePerformance__addActionData_43146736((BattlePerformance_o *)this, InitActionData, 0LL);
