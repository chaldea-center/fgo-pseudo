        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1F5AA & 1) == 0 )
  {
    sub_1BCAFF8(&BattleActionData_TypeInfo, msgEnt);
    byte_4B1F5AA = 1;
  }
  v5 = (BattleActionData_o *)sub_1BCB244(BattleActionData_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1F5A9 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMaster_BattleMessageMaster___, logic);
    this = (MessageBattleLogicTask_o *)sub_1BCAFF8(&DataManager_TypeInfo, v5);
    byte_4B1F5A9 = 1;
  }
  ...
  this = (MessageBattleLogicTask_o *)DataManager__GetMaster_object_((const MethodInfo_301AA50 *)Method_DataManager_GetMaster_BattleMessageMaster___);
  if ( !this )
LABEL_31:
...
LABEL_27:
          ...
          if ( !this )
            goto LABEL_31;
          BattlePerformance__addActionData_44188008((BattlePerformance_o *)this, InitActionData, 0LL);
