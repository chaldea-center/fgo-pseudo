        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24EC6 & 1) == 0 )
  {
    sub_1C3B764(&BattleActionData_TypeInfo, msgEnt);
    byte_4C24EC6 = 1;
  }
  v5 = (BattleActionData_o *)sub_1C3B9B0(BattleActionData_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24EC5 & 1) == 0 )
  {
    sub_1C3B764(&Method_DataManager_GetMaster_BattleMessageMaster___, logic);
    this = (MessageBattleLogicTask_o *)sub_1C3B764(&DataManager_TypeInfo, v5);
    byte_4C24EC5 = 1;
  }
  ...
  this = (MessageBattleLogicTask_o *)DataManager__GetMaster_object_((const MethodInfo_2FF01B0 *)Method_DataManager_GetMaster_BattleMessageMaster___);
  if ( !this )
LABEL_31:
...
LABEL_27:
          ...
          if ( !this )
            goto LABEL_31;
          BattlePerformance__addActionData_43414772((BattlePerformance_o *)this, InitActionData, 0LL);
