        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AFA11 & 1) == 0 )
  {
    sub_B52984(&Method_DataManager_GetMaster_BattleMessageMaster___);
    this = (MessageBattleLogicTask_o *)sub_B52984(&DataManager_TypeInfo);
    byte_42AFA11 = 1;
  }
  ...
  this = (MessageBattleLogicTask_o *)DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1A4F124 *)Method_DataManager_GetMaster_BattleMessageMaster___);
  if ( !this )
LABEL_32:
...
LABEL_28:
          ...
          if ( !this )
            goto LABEL_32;
          BattlePerformance__addActionData_18700740((BattlePerformance_o *)this, InitActionData, 0LL);
