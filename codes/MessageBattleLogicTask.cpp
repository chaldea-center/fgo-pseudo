        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E07DFB & 1) == 0 )
  {
    ...
    this = (MessageBattleLogicTask_o *)sub_1CE6700(&DataManager_TypeInfo);
    byte_4E07DFB = 1;
  }
  ...
  this = (MessageBattleLogicTask_o *)DataManager__GetMaster_object_((const MethodInfo_3204354 *)Method_DataManager_GetMaster_BattleMessageMaster___);
  if ( !this )
LABEL_31:
...
LABEL_27:
          ...
          if ( !this )
            goto LABEL_31;
          BattlePerformance__addActionData_46208436((BattlePerformance_o *)this, InitActionData, 0);
