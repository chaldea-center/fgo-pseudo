void AnimationList___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C3677D & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_System_Linq_Enumerable_Cast_AnimationList_NAME___);
    sub_1C32C20(&Method_System_Linq_Enumerable_ToDictionary_AnimationList_NAME__string__int___);
    sub_1C32C20(&System_Func_AnimationList_NAME__int__TypeInfo);
    sub_1C32C20(&System_Func_AnimationList_NAME__string__TypeInfo);
    sub_1C32C20(&AnimationList_NAME_var);
    sub_1C32C20(&System_Type_TypeInfo);
    sub_1C32C20(&Method_AnimationList___c___cctor_b__2_0__);
    sub_1C32C20(&Method_AnimationList___c___cctor_b__2_1__);
    sub_1C32C20(&AnimationList___c_TypeInfo);
    byte_4C3677D = 1;
  }
  ...
  v5 = System_Linq_Enumerable__Cast_Int32Enum_(
         ...
         (const MethodInfo_30EBA3C *)Method_System_Linq_Enumerable_Cast_AnimationList_NAME___);
  ...
  v9 = (System_Func_T__TResult__o *)sub_1C32E6C(System_Func_AnimationList_NAME__string__TypeInfo);
  ...
  v11 = (System_Func_T__TResult__o *)sub_1C32E6C(System_Func_AnimationList_NAME__int__TypeInfo);
  ...
  v12 = (struct System_Collections_Generic_Dictionary_string__int__o *)System_Linq_Enumerable__ToDictionary_Int32Enum__object__int_(
                                                                         ...
                                                                         (const MethodInfo_311D2A8 *)Method_System_Linq_Enumerable_ToDictionary_AnimationList_NAME__string__int___);
  AnimationList_TypeInfo->static_fields->_dictionary = v12;
  sub_1C32BC4((CGThumbnailListItem_o *)AnimationList_TypeInfo->static_fields, (int32_t)v12, v13, v14);
}
...
void AnimationList___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C32E6C(AnimationList___c_TypeInfo);
  System_Object___ctor(v1, 0);
  AnimationList___c_TypeInfo->static_fields->__9 = (struct AnimationList___c_o *)v1;
  sub_1C32BC4((CGThumbnailListItem_o *)AnimationList___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
...
System_String_o *AnimationList___c____cctor_b__2_0(AnimationList___c_o *this, int32_t x, const MethodInfo *method)
{
  ...
  if ( (byte_4C36780 & 1) == 0 )
  {
    sub_1C32C20(&AnimationList_NAME_TypeInfo);
    byte_4C36780 = 1;
  }
