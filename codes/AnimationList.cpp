void __fastcall AnimationList___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B4389D & 1) == 0 )
  {
    sub_1BDB878(&AnimationList_TypeInfo, v1);
    sub_1BDB878(&System_Enum_TypeInfo, v2);
    sub_1BDB878(&Method_System_Linq_Enumerable_Cast_AnimationList_NAME___, v3);
    sub_1BDB878(&Method_System_Linq_Enumerable_ToDictionary_AnimationList_NAME__string__int___, v4);
    sub_1BDB878(&System_Func_AnimationList_NAME__int__TypeInfo, v5);
    sub_1BDB878(&System_Func_AnimationList_NAME__string__TypeInfo, v6);
    sub_1BDB878(&AnimationList_NAME_var, v7);
    sub_1BDB878(&System_Type_TypeInfo, v8);
    sub_1BDB878(&Method_AnimationList___c___cctor_b__2_0__, v9);
    sub_1BDB878(&Method_AnimationList___c___cctor_b__2_1__, v10);
    sub_1BDB878(&AnimationList___c_TypeInfo, v11);
    byte_4B4389D = 1;
  }
  ...
  v15 = System_Linq_Enumerable__Cast_Int32Enum_(
          ...
          (const MethodInfo_30420C4 *)Method_System_Linq_Enumerable_Cast_AnimationList_NAME___);
  ...
  v19 = (System_Func_T__TResult__o *)sub_1BDBAC4(System_Func_AnimationList_NAME__string__TypeInfo);
  ...
  v21 = (System_Func_T__TResult__o *)sub_1BDBAC4(System_Func_AnimationList_NAME__int__TypeInfo);
  ...
  v22 = (struct System_Collections_Generic_Dictionary_string__int__o *)System_Linq_Enumerable__ToDictionary_Int32Enum__object__int_(
                                                                         ...
                                                                         (const MethodInfo_3070FC4 *)Method_System_Linq_Enumerable_ToDictionary_AnimationList_NAME__string__int___);
  AnimationList_TypeInfo->static_fields->_dictionary = v22;
  sub_1BDB81C((CGThumbnailListItem_o *)AnimationList_TypeInfo->static_fields, (int32_t)v22, v23, v24);
}
...
void __fastcall AnimationList___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B4389F & 1) == 0 )
  {
    sub_1BDB878(&AnimationList___c_TypeInfo, v1);
    byte_4B4389F = 1;
  }
  v2 = (Il2CppObject *)sub_1BDBAC4(AnimationList___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  AnimationList___c_TypeInfo->static_fields->__9 = (struct AnimationList___c_o *)v2;
  sub_1BDB81C((CGThumbnailListItem_o *)AnimationList___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B438A0 & 1) == 0 )
  {
    sub_1BDB878(&AnimationList_NAME_TypeInfo, *(_QWORD *)&x);
    byte_4B438A0 = 1;
  }
