void AnimationList___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_5937406 & 1) == 0 )
  {
    ...
    sub_21FFC50(&Method_System_Linq_Enumerable_Cast_AnimationList_NAME___);
    sub_21FFC50(&Method_System_Linq_Enumerable_ToDictionary_AnimationList_NAME__string__int___);
    sub_21FFC50(&System_Func_AnimationList_NAME__int__TypeInfo);
    sub_21FFC50(&System_Func_AnimationList_NAME__string__TypeInfo);
    sub_21FFC50(&AnimationList_NAME_var);
    sub_21FFC50(&Method_AnimationList___c___cctor_b__2_0__);
    sub_21FFC50(&Method_AnimationList___c___cctor_b__2_1__);
    sub_21FFC50(&AnimationList___c_TypeInfo);
    byte_5937406 = 1;
  }
  v3 = AnimationList_NAME_var;
  if ( !*(_DWORD *)(qword_594C108 + 228) )
    j_il2cpp_runtime_class_init_0(qword_594C108, v1, v2);
  v4.fields.value = (intptr_t)v3;
  TypeFromHandle = System_Type__GetTypeFromHandle(v4, 0);
  if ( !*(_DWORD *)(qword_594C0C0 + 228) )
    j_il2cpp_runtime_class_init_0(qword_594C0C0, v5, v6);
  ...
  v9 = System_Linq_Enumerable__Cast_Int32Enum_(
         ...
         (const MethodInfo_3835558 *)Method_System_Linq_Enumerable_Cast_AnimationList_NAME___);
  ...
  v15 = (System_Func_T__TResult__o *)sub_21FFEBC(System_Func_AnimationList_NAME__string__TypeInfo);
  ...
  v17 = (System_Func_T__TResult__o *)sub_21FFEBC(System_Func_AnimationList_NAME__int__TypeInfo);
  ...
  v18 = (struct System_Collections_Generic_Dictionary_string__int__o *)System_Linq_Enumerable__ToDictionary_Int32Enum__object__int_(
                                                                         ...
                                                                         (const MethodInfo_3868F08 *)Method_System_Linq_Enumerable_ToDictionary_AnimationList_NAME__string__int___);
...
void AnimationList___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_21FFEBC(AnimationList___c_TypeInfo);
...
System_String_o *AnimationList___c____cctor_b__2_0(AnimationList___c_o *this, int32_t x, const MethodInfo *method)
{
  ...
  if ( (byte_5937409 & 1) == 0 )
  {
    sub_21FFC50(&AnimationList_NAME_TypeInfo);
    byte_5937409 = 1;
  }
  v6 = x;
