...
void SelectBonusConfirmDialog__Close(SelectBonusConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  SelectBonusConfirmDialog__Close_32822672(this, 0, v2);
}


void SelectBonusConfirmDialog__Close_32822672(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2B049 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_SelectBonusConfirmDialog_EndClose__);
    byte_4D2B049 = 1;
  }
...
void SelectBonusConfirmDialog__OnClickBackToChoice(SelectBonusConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2B04B & 1) == 0 )
  {
    sub_1C93AD4(&Method_SelectBonusConfirmDialog_OnClickBackToChoice__);
    byte_4D2B04B = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SelectBonusConfirmDialog_OnClickBackToChoice__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C93AEC(Method_SelectBonusConfirmDialog_OnClickBackToChoice__);
...
void SelectBonusConfirmDialog__OnClickOk(SelectBonusConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2B04A & 1) == 0 )
  {
    sub_1C93AD4(&Method_SelectBonusConfirmDialog_OnClickOk__);
    byte_4D2B04A = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SelectBonusConfirmDialog_OnClickOk__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C93AEC(Method_SelectBonusConfirmDialog_OnClickOk__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C93AB8(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C93AD4(&System_Action_TypeInfo);
    sub_1C93AD4(&Method_SelectBonusConfirmDialog_EndOpen__);
    byte_4D2B048 = 1;
  }
  ...
  gameObject = (UnityEngine_GameObject_o *)sub_1C93A78(&this->fields.clickedFunc, func);
...
LABEL_19:
  ...
  ItemIconComponent__SetGift_41640856((ItemIconComponent_o *)gameObject, type, objectId, -1, 0, 0);
        ...
        const MethodInfo *method)
{
  ...
  v11 = (SelectBonusConfirmDialog_o *)sub_1C940C8(v8);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1AC0034;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1ABFFEC;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2B04D & 1) == 0 )
  {
    sub_1C93AD4(&SelectBonusConfirmDialog_ResultClicked_TypeInfo);
    byte_4D2B04D = 1;
  }
  v9[1] = 0;
