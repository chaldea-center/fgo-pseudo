...
void SelectBonusConfirmDialog__Close(SelectBonusConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  SelectBonusConfirmDialog__Close_33207872(this, 0, v2);
}


void SelectBonusConfirmDialog__Close_33207872(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E71AE9 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_SelectBonusConfirmDialog_EndClose__);
    byte_4E71AE9 = 1;
  }
...
void SelectBonusConfirmDialog__OnClickBackToChoice(SelectBonusConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E71AEB & 1) == 0 )
  {
    sub_1D0F0B4(&Method_SelectBonusConfirmDialog_OnClickBackToChoice__);
    byte_4E71AEB = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SelectBonusConfirmDialog_OnClickBackToChoice__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1D0F0CC(Method_SelectBonusConfirmDialog_OnClickBackToChoice__);
...
void SelectBonusConfirmDialog__OnClickOk(SelectBonusConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E71AEA & 1) == 0 )
  {
    sub_1D0F0B4(&Method_SelectBonusConfirmDialog_OnClickOk__);
    byte_4E71AEA = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SelectBonusConfirmDialog_OnClickOk__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1D0F0CC(Method_SelectBonusConfirmDialog_OnClickOk__);
    v4 = (System_Reflection_MethodBase_o *)sub_1D0F098(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1D0F0B4(&System_Action_TypeInfo);
    sub_1D0F0B4(&Method_SelectBonusConfirmDialog_EndOpen__);
    byte_4E71AE8 = 1;
  }
  ...
  gameObject = (UnityEngine_GameObject_o *)sub_1D0F058(&this->fields.clickedFunc, func);
...
LABEL_19:
  ...
  ItemIconComponent__SetGift_42283820((ItemIconComponent_o *)gameObject, type, objectId, -1, 0, 0);
        ...
        const MethodInfo *method)
{
  ...
  v11 = (SelectBonusConfirmDialog_o *)sub_1D0F6A8(v8);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1B34AE0;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1B34A98;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E71AED & 1) == 0 )
  {
    sub_1D0F0B4(&SelectBonusConfirmDialog_ResultClicked_TypeInfo);
    byte_4E71AED = 1;
  }
  v9[1] = 0;
