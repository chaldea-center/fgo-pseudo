void __fastcall TitleInfoEventTowerBase___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FD02C & 1) == 0 )
  {
    sub_1B64870(&TitleInfoEventTowerBase_TypeInfo, v1);
    sub_1B64870(&StringLiteral_23907/*"tower_img_base{0:00}"*/, v4);
    byte_49FD02C = 1;
  }
