void __fastcall TitleInfoEventTowerBase___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BC6535 & 1) == 0 )
  {
    sub_1C1ABD4(&TitleInfoEventTowerBase_TypeInfo, v1);
    sub_1C1ABD4(&StringLiteral_24414/*"tower_img_base{0:00}"*/, v8);
    byte_4BC6535 = 1;
  }
  TitleInfoEventTowerBase_TypeInfo->static_fields->SPRITE_NAME_TOWER_BASE = (struct System_String_o *)StringLiteral_24414/*"tower_img_base{0:00}"*/;
  sub_1C1AB78(
    (PartyOrganizationUtility_o *)TitleInfoEventTowerBase_TypeInfo->static_fields,
    StringLiteral_24414/*"tower_img_base{0:00}"*/,
    v2,
    v3,
    v4,
    v5,
