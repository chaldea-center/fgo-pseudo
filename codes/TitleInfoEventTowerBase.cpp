void __fastcall TitleInfoEventTowerBase___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FAF34 & 1) == 0 )
  {
    sub_1B640C8(&TitleInfoEventTowerBase_TypeInfo, v1);
    sub_1B640C8(&StringLiteral_23903/*"tower_img_base{0:00}"*/, v4);
    byte_49FAF34 = 1;
  }
  TitleInfoEventTowerBase_TypeInfo->static_fields->SPRITE_NAME_TOWER_BASE = (struct System_String_o *)StringLiteral_23903/*"tower_img_base{0:00}"*/;
  sub_1B6406C(
    (ServantStatusBattleListViewItem_o *)TitleInfoEventTowerBase_TypeInfo->static_fields,
    StringLiteral_23903/*"tower_img_base{0:00}"*/,
    v2,
    v3);
}
...
LABEL_9:
  UIWidget__set_height(v11, *p_towerBaseHeight, 0LL);
