void __fastcall TitleInfoEventTowerBase___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A59C4D & 1) == 0 )
  {
    sub_1B885B0(&TitleInfoEventTowerBase_TypeInfo);
    sub_1B885B0(&StringLiteral_24002/*"tower_img_base{0:00}"*/);
    byte_4A59C4D = 1;
  }
  TitleInfoEventTowerBase_TypeInfo->static_fields->SPRITE_NAME_TOWER_BASE = (struct System_String_o *)StringLiteral_24002/*"tower_img_base{0:00}"*/;
  sub_1B88554(
    (ServantStatusBattleListViewItem_o *)TitleInfoEventTowerBase_TypeInfo->static_fields,
    StringLiteral_24002/*"tower_img_base{0:00}"*/,
    v1,
    v2);
}
