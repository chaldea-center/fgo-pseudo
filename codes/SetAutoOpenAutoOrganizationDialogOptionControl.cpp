        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B3D0 & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_9658/*"OPTION_AUTO_OPEN_AUTO_ORGANIZATION_DIALOG"*/, v4);
    sub_1B90010(&StringLiteral_9659/*"OPTION_AUTO_OPEN_AUTO_ORGANIZATION_DIALOG_INFO"*/, v5);
    byte_4A6B3D0 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B3D3 & 1) == 0 )
  {
    sub_1B90010(&Method_SetAutoOpenAutoOrganizationDialogOptionControl_OnClickButton__, method);
    byte_4A6B3D3 = 1;
  }
  klass = this->klass;
  this->fields.flag ^= 1u;
  ...
  if ( (*((_BYTE *)Method_SetAutoOpenAutoOrganizationDialogOptionControl_OnClickButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1B90028(Method_SetAutoOpenAutoOrganizationDialogOptionControl_OnClickButton__);
