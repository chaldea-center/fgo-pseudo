        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5933475 & 1) == 0 )
  {
    ...
    sub_21FFC50(&StringLiteral_10043/*"OPTION_AUTO_OPEN_AUTO_ORGANIZATION_DIALOG"*/);
    sub_21FFC50(&StringLiteral_10044/*"OPTION_AUTO_OPEN_AUTO_ORGANIZATION_DIALOG_INFO"*/);
    byte_5933475 = 1;
  }
  titleLabel = this->fields.titleLabel;
  if ( !*(&LocalizationManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, method, v2);
  v5 = LocalizationManager__Get((System_String_o *)StringLiteral_10043/*"OPTION_AUTO_OPEN_AUTO_ORGANIZATION_DIALOG"*/, 0);
  if ( !titleLabel
    || (UILabel__set_text(titleLabel, v5, 0),
        infoLabel = this->fields.infoLabel,
        v5 = LocalizationManager__Get((System_String_o *)StringLiteral_10044/*"OPTION_AUTO_OPEN_AUTO_ORGANIZATION_DIALOG_INFO"*/, 0),
        !infoLabel) )
  {
    sub_21FFECC(v5, v6);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5933478 & 1) == 0 )
  {
    sub_21FFC50(&Method_SetAutoOpenAutoOrganizationDialogOptionControl_OnClickButton__);
    byte_5933478 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetAutoOpenAutoOrganizationDialogOptionControl_OnClickButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_21FFC68(Method_SetAutoOpenAutoOrganizationDialogOptionControl_OnClickButton__);
