        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFD11D & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_9572/*"OPTION_AUTO_OPEN_AUTO_ORGANIZATION_DIALOG"*/, v4);
    sub_1BC3008(&StringLiteral_9573/*"OPTION_AUTO_OPEN_AUTO_ORGANIZATION_DIALOG_INFO"*/, v5);
    byte_4AFD11D = 1;
  }
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v7 = LocalizationManager__Get((System_String_o *)StringLiteral_9572/*"OPTION_AUTO_OPEN_AUTO_ORGANIZATION_DIALOG"*/, 0LL);
  if ( !titleLabel
    || (UILabel__set_text(titleLabel, v7, 0LL),
        infoLabel = this->fields.infoLabel,
        v7 = LocalizationManager__Get((System_String_o *)StringLiteral_9573/*"OPTION_AUTO_OPEN_AUTO_ORGANIZATION_DIALOG_INFO"*/, 0LL),
        !infoLabel) )
  {
    sub_1BC3264(v7, v8);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFD120 & 1) == 0 )
  {
    sub_1BC3008(&Method_SetAutoOpenAutoOrganizationDialogOptionControl_OnClickButton__, method);
    byte_4AFD120 = 1;
  }
  klass = this->klass;
  this->fields.flag ^= 1u;
  ...
  if ( (*((_BYTE *)Method_SetAutoOpenAutoOrganizationDialogOptionControl_OnClickButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1BC3020(Method_SetAutoOpenAutoOrganizationDialogOptionControl_OnClickButton__);
