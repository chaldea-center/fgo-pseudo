        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C51D66 & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_9658/*"OPTION_AUTO_OPEN_AUTO_ORGANIZATION_DIALOG"*/);
    sub_1C3E564(&StringLiteral_9659/*"OPTION_AUTO_OPEN_AUTO_ORGANIZATION_DIALOG_INFO"*/);
    byte_4C51D66 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C51D69 & 1) == 0 )
  {
    sub_1C3E564(&Method_SetAutoOpenAutoOrganizationDialogOptionControl_OnClickButton__);
    byte_4C51D69 = 1;
  }
  klass = this->klass;
  this->fields.flag ^= 1u;
  ...
  if ( (*((_BYTE *)Method_SetAutoOpenAutoOrganizationDialogOptionControl_OnClickButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1C3E57C(Method_SetAutoOpenAutoOrganizationDialogOptionControl_OnClickButton__);
