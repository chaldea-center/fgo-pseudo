...
void UITooltip__Awake(UITooltip_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CF2FBE & 1) == 0 )
  {
    sub_1C7BAE8(&UITooltip_TypeInfo);
    byte_4CF2FBE = 1;
  }
  UITooltip_TypeInfo->static_fields->mInstance = this;
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)UITooltip_TypeInfo->static_fields, (int32_t)this, v2, v3, v4, v5, v6, v7);
}
...
void UITooltip__Hide(const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(mInstance, 0, 0) )
  {
    ...
    if ( !v9
      || (v9->fields.mHover = 0,
          sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&v9->fields.mHover, 0, v3, v4, v5, v6, v7, v8),
...
void UITooltip__OnDestroy(UITooltip_o *this, const MethodInfo *method)
{
  ...
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)UITooltip_TypeInfo->static_fields, 0, v2, v3, v4, v5, v6, v7);
}
...
void UITooltip__SetText(UITooltip_o *this, System_String_o *tooltipText, const MethodInfo *method)
{
  ...
  if ( !UnityEngine_Object__op_Inequality(text, 0, 0) || System_String__IsNullOrEmpty(tooltipText, 0) )
  {
    ...
    sub_1C7BA8C(p_mHover, 0, v6, v7, v8, v9, v10, v11);
  ...
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.mHover, (int32_t)hoveredObject, v6, v7, v8, v9, v10, v11);
...
LABEL_50:
  ...
  if ( v46 )
  {
    ...
    v97 = UnityEngine_Camera__ViewportToWorldPoint_71674736(
...
void UITooltip__Start(UITooltip_o *this, const MethodInfo *method)
{
  ...
  this->fields.mWidgets = (struct UIWidget_array *)ComponentsInChildren_object__51804268;
  sub_1C7BA8C(
    (GrandQuestFolderBoardItem_o *)&this->fields.mWidgets,
    (int32_t)ComponentsInChildren_object__51804268,
    v11,
    v12,
    v13,
    v14,
...
void UITooltip__Update(UITooltip_o *this, const MethodInfo *method)
{
  ...
  {
    this->fields.mHover = 0;
    sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.mHover, 0, v6, v7, v8, v9, v10, v11);
    mTarget = 0.0;
