        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0BE8 & 1) == 0 )
  {
    sub_B52984(&WarBoardWaitNonBlockingTaskEnd__Execute_d__0_TypeInfo);
    byte_42B0BE8 = 1;
  }
  v2 = (WarBoardWaitNonBlockingTaskEnd__Execute_d__0_o *)sub_B52A54(WarBoardWaitNonBlockingTaskEnd__Execute_d__0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AD76E & 1) == 0 )
  {
    ...
    sub_B52984(&Method_WarBoardWaitNonBlockingTaskEnd___c__Execute_b__0_0__);
    sub_B52984(&WarBoardWaitNonBlockingTaskEnd___c_TypeInfo);
  ...
  else
  {
    ...
    if ( !_9__0_0 )
    {
      ...
      _9__0_0 = (System_Func_bool__o *)sub_B52A54(System_Func_bool__TypeInfo);
    ...
    UnityEngine_WaitUntil___ctor(v10, _9__0_0, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_B52988(&Method_WarBoardWaitNonBlockingTaskEnd__Execute_d__0_System_Collections_IEnumerator_Reset__);
  sub_B52A28(v3, v4);
}
...
void __fastcall WarBoardWaitNonBlockingTaskEnd___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_B52A54(WarBoardWaitNonBlockingTaskEnd___c_TypeInfo);
  System_Object___ctor(v1, 0LL);
  static_fields = WarBoardWaitNonBlockingTaskEnd___c_TypeInfo->static_fields;
  static_fields->__9 = (struct WarBoardWaitNonBlockingTaskEnd___c_o *)v1;
