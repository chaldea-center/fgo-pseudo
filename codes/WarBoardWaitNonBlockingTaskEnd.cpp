        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A06B94 & 1) == 0 )
  {
    sub_1B686D4(&WarBoardWaitNonBlockingTaskEnd__Execute_d__0_TypeInfo, method);
    byte_4A06B94 = 1;
  }
  v2 = sub_1B68920(WarBoardWaitNonBlockingTaskEnd__Execute_d__0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A06B97 & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_WarBoardWaitNonBlockingTaskEnd___c__Execute_b__0_0__, v3);
    sub_1B686D4(&WarBoardWaitNonBlockingTaskEnd___c_TypeInfo, v4);
  ...
  else
  {
    ...
    if ( !_9__0_0 )
    {
      ...
      _9__0_0 = (System_Func_bool__o *)sub_1B68920(System_Func_bool__TypeInfo);
      ...
      sub_1B68678((ServantStatusBattleListViewItem_o *)&static_fields->__9__0_0, (int32_t)_9__0_0, v12, v13);
    }
    ...
    sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.__2__current, (int32_t)v14, v15, v16);
    v17 = 1;
    result = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B686E8(&Method_WarBoardWaitNonBlockingTaskEnd__Execute_d__0_System_Collections_IEnumerator_Reset__);
  sub_1B687FC(v3, v4);
}
...
void __fastcall WarBoardWaitNonBlockingTaskEnd___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A06B95 & 1) == 0 )
  {
    sub_1B686D4(&WarBoardWaitNonBlockingTaskEnd___c_TypeInfo, v1);
    byte_4A06B95 = 1;
  }
  v2 = (Il2CppObject *)sub_1B68920(WarBoardWaitNonBlockingTaskEnd___c_TypeInfo);
