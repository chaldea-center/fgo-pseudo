void __fastcall ServantStatusQuestBoardManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB3938 & 1) == 0 )
  {
    sub_1BAB41C(&ServantStatusQuestBoardManager_TypeInfo, v1);
    byte_4AB3938 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB3937 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&ServantStatusQuestBoardManager_TypeInfo, v2);
    byte_4AB3937 = 1;
  }
  ...
  v5 = ExtraEasing__AsymptoticSeriesFloat(
         ...
         0LL);
  v6 = (AlphaTransitionCalculator_o *)sub_1BAB668(AlphaTransitionCalculator_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB3936 & 1) == 0 )
  {
    sub_1BAB41C(&ServantStatusQuestBoardManager_TypeInfo, method);
    sub_1BAB41C(&Method_TransitionCalculator_float__Update__, v3);
    sub_1BAB41C(&Method_TransitionCalculator_float__get_Current__, v4);
    byte_4AB3936 = 1;
  }
  ...
  if ( !*p_fadeUIAlphaCalculator )
LABEL_26:
    sub_1BAB678(fadeUIAlphaCalculator, v10);
