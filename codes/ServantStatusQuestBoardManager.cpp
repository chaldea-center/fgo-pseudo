void __fastcall ServantStatusQuestBoardManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A2B651 & 1) == 0 )
  {
    sub_1B761C0(&ServantStatusQuestBoardManager_TypeInfo, v1);
    byte_4A2B651 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2B650 & 1) == 0 )
  {
    ...
    sub_1B761C0(&ServantStatusQuestBoardManager_TypeInfo, v2);
    byte_4A2B650 = 1;
  }
  ...
  v5 = ExtraEasing__AsymptoticSeriesFloat(
         ...
         0LL);
  v6 = (AlphaTransitionCalculator_o *)sub_1B7640C(AlphaTransitionCalculator_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2B64F & 1) == 0 )
  {
    sub_1B761C0(&ServantStatusQuestBoardManager_TypeInfo, method);
    sub_1B761C0(&Method_TransitionCalculator_float__Update__, v3);
    sub_1B761C0(&Method_TransitionCalculator_float__get_Current__, v4);
    byte_4A2B64F = 1;
  }
  ...
  if ( !*p_fadeUIAlphaCalculator )
LABEL_26:
    sub_1B7641C(fadeUIAlphaCalculator, v10);
