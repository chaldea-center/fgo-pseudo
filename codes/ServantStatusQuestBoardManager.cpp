void __fastcall ServantStatusQuestBoardManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_40FCA90 & 1) == 0 )
  {
    sub_B16FFC(&ServantStatusQuestBoardManager_TypeInfo, v1);
    byte_40FCA90 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FCA8F & 1) == 0 )
  {
    ...
    sub_B16FFC(&ServantStatusQuestBoardManager_TypeInfo, v2);
    byte_40FCA8F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FCA8E & 1) == 0 )
  {
    sub_B16FFC(&ServantStatusQuestBoardManager_TypeInfo, method);
