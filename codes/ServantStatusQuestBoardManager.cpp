void __fastcall ServantStatusQuestBoardManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A1D1E8 & 1) == 0 )
  {
    sub_1B715CC(&ServantStatusQuestBoardManager_TypeInfo, v1);
    byte_4A1D1E8 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1D1E7 & 1) == 0 )
  {
    ...
    sub_1B715CC(&ServantStatusQuestBoardManager_TypeInfo, v2);
    byte_4A1D1E7 = 1;
  }
  ...
  v5 = ExtraEasing__AsymptoticSeriesFloat(
         ...
         0LL);
  v6 = (AlphaTransitionCalculator_o *)sub_1B71818(AlphaTransitionCalculator_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1D1E6 & 1) == 0 )
  {
    sub_1B715CC(&ServantStatusQuestBoardManager_TypeInfo, method);
    sub_1B715CC(&Method_TransitionCalculator_float__Update__, v3);
    sub_1B715CC(&Method_TransitionCalculator_float__get_Current__, v4);
    byte_4A1D1E6 = 1;
  }
  ...
  if ( !*p_fadeUIAlphaCalculator )
LABEL_26:
    sub_1B71828(fadeUIAlphaCalculator, v10);
