void __fastcall ServantStatusQuestBoardManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AFFB9F & 1) == 0 )
  {
    sub_1BC3008(&ServantStatusQuestBoardManager_TypeInfo, v1);
    byte_4AFFB9F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFFB9E & 1) == 0 )
  {
    ...
    sub_1BC3008(&ServantStatusQuestBoardManager_TypeInfo, v2);
    byte_4AFFB9E = 1;
  }
  ...
  v5 = ExtraEasing__AsymptoticSeriesFloat(
         ...
         0LL);
  v6 = (AlphaTransitionCalculator_o *)sub_1BC3254(AlphaTransitionCalculator_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFFB9D & 1) == 0 )
  {
    sub_1BC3008(&ServantStatusQuestBoardManager_TypeInfo, method);
    sub_1BC3008(&Method_TransitionCalculator_float__Update__, v3);
    sub_1BC3008(&Method_TransitionCalculator_float__get_Current__, v4);
    byte_4AFFB9D = 1;
  }
  ...
  if ( !fadeUIAlphaCalculator )
  {
    ...
    *p_fadeUIAlphaCalculator = AlphaCalculator;
    sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.fadeUIAlphaCalculator, (int32_t)AlphaCalculator, v8, v9);
  ...
  if ( !*p_fadeUIAlphaCalculator )
LABEL_26:
    sub_1BC3264(fadeUIAlphaCalculator, v10);
