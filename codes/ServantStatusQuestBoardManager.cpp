void __fastcall ServantStatusQuestBoardManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B19F86 & 1) == 0 )
  {
    sub_1BCAFF8(&ServantStatusQuestBoardManager_TypeInfo, v1);
    byte_4B19F86 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B19F85 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&ServantStatusQuestBoardManager_TypeInfo, v2);
    byte_4B19F85 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B19F84 & 1) == 0 )
  {
    sub_1BCAFF8(&ServantStatusQuestBoardManager_TypeInfo, method);
    sub_1BCAFF8(&Method_TransitionCalculator_float__Update__, v3);
    sub_1BCAFF8(&Method_TransitionCalculator_float__get_Current__, v4);
    byte_4B19F84 = 1;
  }
  ...
  if ( !fadeUIAlphaCalculator )
  {
    ...
    *p_fadeUIAlphaCalculator = AlphaCalculator;
    sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.fadeUIAlphaCalculator, (int32_t)AlphaCalculator, v8, v9);
  ...
  if ( !*p_fadeUIAlphaCalculator )
LABEL_26:
    sub_1BCB254(fadeUIAlphaCalculator, v10);
