void __fastcall ServantStatusQuestBoardManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FBD38 & 1) == 0 )
  {
    sub_1B64870(&ServantStatusQuestBoardManager_TypeInfo, v1);
    byte_49FBD38 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FBD37 & 1) == 0 )
  {
    ...
    sub_1B64870(&ServantStatusQuestBoardManager_TypeInfo, v2);
    byte_49FBD37 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FBD36 & 1) == 0 )
  {
    sub_1B64870(&ServantStatusQuestBoardManager_TypeInfo, method);
    sub_1B64870(&Method_TransitionCalculator_float__Update__, v3);
    sub_1B64870(&Method_TransitionCalculator_float__get_Current__, v4);
    byte_49FBD36 = 1;
  }
  ...
  if ( !*p_fadeUIAlphaCalculator )
LABEL_26:
    sub_1B64ACC(fadeUIAlphaCalculator, v10);
