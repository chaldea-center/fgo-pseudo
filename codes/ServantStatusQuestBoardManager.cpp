void __fastcall ServantStatusQuestBoardManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FC358 & 1) == 0 )
  {
    sub_1B64A00(&ServantStatusQuestBoardManager_TypeInfo, v1);
    byte_49FC358 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC357 & 1) == 0 )
  {
    ...
    sub_1B64A00(&ServantStatusQuestBoardManager_TypeInfo, v2);
    byte_49FC357 = 1;
  }
  ...
  v5 = ExtraEasing__AsymptoticSeriesFloat(
         ...
         0LL);
  v6 = (AlphaTransitionCalculator_o *)sub_1B64C4C(AlphaTransitionCalculator_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC356 & 1) == 0 )
  {
    sub_1B64A00(&ServantStatusQuestBoardManager_TypeInfo, method);
    sub_1B64A00(&Method_TransitionCalculator_float__Update__, v3);
    sub_1B64A00(&Method_TransitionCalculator_float__get_Current__, v4);
    byte_49FC356 = 1;
  }
  ...
  if ( !*p_fadeUIAlphaCalculator )
LABEL_26:
    sub_1B64C5C(fadeUIAlphaCalculator, v10);
