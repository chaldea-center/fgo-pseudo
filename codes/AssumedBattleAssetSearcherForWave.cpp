AssumedBattleAssetSearcherForWave_o *__fastcall AssumedBattleAssetSearcherForWave__Create(const MethodInfo *method)
{
  ...
  if ( (byte_48E47B1 & 1) == 0 )
  {
    sub_1B00CCC(&AssumedBattleAssetSearcherForWave_TypeInfo, v1);
    byte_48E47B1 = 1;
  }
  v2 = (AssumedBattleAssetSearcherBase_o *)sub_1B00F18(AssumedBattleAssetSearcherForWave_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E47B0 & 1) == 0 )
  {
    this = (AssumedBattleAssetSearcherForWave_o *)sub_1B00CCC(
  ...
  v6 = (AssumedBattleAssetLoadManager_AnalyzedResultParam_o *)sub_1B00F18(AssumedBattleAssetLoadManager_AnalyzedResultParam_TypeInfo);
