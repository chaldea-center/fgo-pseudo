AssumedBattleAssetSearcherForWave_o *__fastcall AssumedBattleAssetSearcherForWave__Create(const MethodInfo *method)
{
  ...
  if ( (byte_4A5D2ED & 1) == 0 )
  {
    sub_1B885B0(&AssumedBattleAssetSearcherForWave_TypeInfo);
    byte_4A5D2ED = 1;
  }
  v1 = (AssumedBattleAssetSearcherBase_o *)sub_1B887FC(AssumedBattleAssetSearcherForWave_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5D2EC & 1) == 0 )
  {
    this = (AssumedBattleAssetSearcherForWave_o *)sub_1B885B0(&AssumedBattleAssetLoadManager_AnalyzedResultParam_TypeInfo);
    byte_4A5D2EC = 1;
  }
  ...
  v6 = (AssumedBattleAssetLoadManager_AnalyzedResultParam_o *)sub_1B887FC(AssumedBattleAssetLoadManager_AnalyzedResultParam_TypeInfo);
