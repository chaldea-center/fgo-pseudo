AssumedBattleAssetSearcherForWave_o *AssumedBattleAssetSearcherForWave__Create(const MethodInfo *method)
{
  ...
  if ( (byte_5972E15 & 1) == 0 )
  {
    sub_2213A60(&AssumedBattleAssetSearcherForWave_TypeInfo);
    byte_5972E15 = 1;
  }
  v1 = (AssumedBattleAssetSearcherBase_o *)sub_2213CCC(AssumedBattleAssetSearcherForWave_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5972E14 & 1) == 0 )
  {
    this = (AssumedBattleAssetSearcherForWave_o *)sub_2213A60(&AssumedBattleAssetLoadManager_AnalyzedResultParam_TypeInfo);
    byte_5972E14 = 1;
  }
  ...
  v6 = (AssumedBattleAssetLoadManager_AnalyzedResultParam_o *)sub_2213CCC(AssumedBattleAssetLoadManager_AnalyzedResultParam_TypeInfo);
