AssumedBattleAssetSearcherForWave_o *__fastcall AssumedBattleAssetSearcherForWave__Create(const MethodInfo *method)
{
  ...
  if ( (byte_4A72004 & 1) == 0 )
  {
    sub_1B90010(&AssumedBattleAssetSearcherForWave_TypeInfo, v1);
    byte_4A72004 = 1;
  }
  v2 = (AssumedBattleAssetSearcherBase_o *)sub_1B9025C(AssumedBattleAssetSearcherForWave_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A72003 & 1) == 0 )
  {
    this = (AssumedBattleAssetSearcherForWave_o *)sub_1B90010(
  ...
  v6 = (AssumedBattleAssetLoadManager_AnalyzedResultParam_o *)sub_1B9025C(AssumedBattleAssetLoadManager_AnalyzedResultParam_TypeInfo);
