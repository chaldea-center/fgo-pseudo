AssumedBattleAssetSearcherForWave_o *AssumedBattleAssetSearcherForWave__Create(const MethodInfo *method)
{
  ...
  if ( (byte_4C45482 & 1) == 0 )
  {
    sub_1C37058(&AssumedBattleAssetSearcherForWave_TypeInfo);
    byte_4C45482 = 1;
  }
  v1 = (AssumedBattleAssetSearcherBase_o *)sub_1C372A4(AssumedBattleAssetSearcherForWave_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C45481 & 1) == 0 )
  {
    this = (AssumedBattleAssetSearcherForWave_o *)sub_1C37058(&AssumedBattleAssetLoadManager_AnalyzedResultParam_TypeInfo);
    byte_4C45481 = 1;
  }
  ...
  v6 = (AssumedBattleAssetLoadManager_AnalyzedResultParam_o *)sub_1C372A4(AssumedBattleAssetLoadManager_AnalyzedResultParam_TypeInfo);
