AssumedBattleAssetSearcherForWave_o *AssumedBattleAssetSearcherForWave__Create(const MethodInfo *method)
{
  ...
  if ( (byte_593AC35 & 1) == 0 )
  {
    sub_21FFC50(&AssumedBattleAssetSearcherForWave_TypeInfo);
    byte_593AC35 = 1;
  }
  v1 = (AssumedBattleAssetSearcherBase_o *)sub_21FFEBC(AssumedBattleAssetSearcherForWave_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_593AC34 & 1) == 0 )
  {
    this = (AssumedBattleAssetSearcherForWave_o *)sub_21FFC50(&AssumedBattleAssetLoadManager_AnalyzedResultParam_TypeInfo);
    byte_593AC34 = 1;
  }
  ...
  v6 = (AssumedBattleAssetLoadManager_AnalyzedResultParam_o *)sub_21FFEBC(AssumedBattleAssetLoadManager_AnalyzedResultParam_TypeInfo);
