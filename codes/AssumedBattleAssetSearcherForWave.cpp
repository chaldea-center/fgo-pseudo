AssumedBattleAssetSearcherForWave_o *__fastcall AssumedBattleAssetSearcherForWave__Create(const MethodInfo *method)
{
  ...
  if ( (byte_4B39395 & 1) == 0 )
  {
    sub_1BD3458(&AssumedBattleAssetSearcherForWave_TypeInfo, v1);
    byte_4B39395 = 1;
  }
  v2 = (AssumedBattleAssetSearcherBase_o *)sub_1BD36A4(AssumedBattleAssetSearcherForWave_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B39394 & 1) == 0 )
  {
    this = (AssumedBattleAssetSearcherForWave_o *)sub_1BD3458(
  ...
  v6 = (AssumedBattleAssetLoadManager_AnalyzedResultParam_o *)sub_1BD36A4(AssumedBattleAssetLoadManager_AnalyzedResultParam_TypeInfo);
