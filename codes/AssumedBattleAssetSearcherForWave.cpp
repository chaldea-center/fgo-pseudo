AssumedBattleAssetSearcherForWave_o *__fastcall AssumedBattleAssetSearcherForWave__Create(const MethodInfo *method)
{
  ...
  if ( (byte_42B1C4B & 1) == 0 )
  {
    sub_B52984(&AssumedBattleAssetSearcherForWave_TypeInfo);
    byte_42B1C4B = 1;
  }
  v1 = (AssumedBattleAssetSearcherBase_o *)sub_B52A54(AssumedBattleAssetSearcherForWave_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B1C4A & 1) == 0 )
  {
    this = (AssumedBattleAssetSearcherForWave_o *)sub_B52984(&AssumedBattleAssetLoadManager_AnalyzedResultParam_TypeInfo);
    byte_42B1C4A = 1;
  }
  ...
  v6 = (AssumedBattleAssetLoadManager_AnalyzedResultParam_o *)sub_B52A54(AssumedBattleAssetLoadManager_AnalyzedResultParam_TypeInfo);
