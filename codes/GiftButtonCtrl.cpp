void __fastcall GiftButtonCtrl___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A71EF5 & 1) == 0 )
  {
    sub_1B90010(&GiftButtonCtrl_TypeInfo, v1);
    byte_4A71EF5 = 1;
  }
...
void __fastcall GiftButtonCtrl__InvalidateGiftInfo(GiftButtonCtrl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A71EEE & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMasterData_UserPresentBoxMaster___, method);
...
void __fastcall GiftButtonCtrl__OnBtnTouched(GiftButtonCtrl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A71EF0 & 1) == 0 )
  {
    sub_1B90010(&Method_GiftButtonCtrl_OnBtnTouched__, method);
    sub_1B90010(&StringLiteral_3111/*"BTN_GIFT"*/, v3);
    byte_4A71EF0 = 1;
  }
  v4 = Method_GiftButtonCtrl_OnBtnTouched__;
  if ( (*((_BYTE *)Method_GiftButtonCtrl_OnBtnTouched__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1B90028(Method_GiftButtonCtrl_OnBtnTouched__);
  v5 = (System_Reflection_MethodBase_o *)sub_1B8FFF4(v4, v4[4]);
  OverwriteAssetSoundName__PlaySystemSe(v5, 0, 0LL);
  stateMachine = this->fields.stateMachine;
  if ( !stateMachine )
    sub_1B9026C(0LL, v6);
  PlayMakerFSM__SendEvent(stateMachine, (System_String_o *)StringLiteral_3111/*"BTN_GIFT"*/, 0LL);
...
void __fastcall GiftButtonCtrl__OnButtonTouched(GiftButtonCtrl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A71EF3 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_3111/*"BTN_GIFT"*/, method);
    byte_4A71EF3 = 1;
  }
  stateMachine = this->fields.stateMachine;
  if ( !stateMachine )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A71EF2 & 1) == 0 )
  {
    sub_1B90010(&UnityEngine_Object_TypeInfo, retrievedNewServant);
    ...
    sub_1B90010(&StringLiteral_5740/*"EV_GIFT_EXIT"*/, v8);
    byte_4A71EF2 = 1;
  }
          ...
          *(_QWORD *)&OnGiftCloseAdditionalAction->fields.extra_arg) & 1) != 0 )
  {
    ...
    if ( Instance )
    {
      PlayMakerFSM__SendEvent((PlayMakerFSM_o *)Instance, (System_String_o *)StringLiteral_5740/*"EV_GIFT_EXIT"*/, 0LL);
      if ( v14 )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A71EF4 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_7063/*"GotNewServantTrigger"*/, retrievedNewServant);
    sub_1B90010(&StringLiteral_5741/*"EV_GIFT_PROC_FIN"*/, v5);
    byte_4A71EF4 = 1;
  }
  stateMachine = this->fields.stateMachine;
  if ( !stateMachine
    || (PlayMakerFSM__SendEvent(stateMachine, (System_String_o *)StringLiteral_5741/*"EV_GIFT_PROC_FIN"*/, 0LL),
    ...
    || (stateMachine = (PlayMakerFSM_o *)HutongGames_PlayMaker_FsmVariables__GetFsmBool(
                                           ...
                                           0LL)) == 0LL )
  {
    sub_1B9026C(stateMachine, retrievedNewServant);
  }
...
void __fastcall GiftButtonCtrl__OnGiftInterfaceOpenFadedOut(GiftButtonCtrl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A71EF1 & 1) == 0 )
  {
    ...
    sub_1B90010(&UserPresentBoxWindow_ClickDelegate_TypeInfo, v3);
    sub_1B90010(&Method_GiftButtonCtrl_InvalidateGiftInfo__, v4);
    sub_1B90010(&Method_GiftButtonCtrl_OnGiftInterfaceClosed__, v5);
    sub_1B90010(&GiftButtonCtrl_TypeInfo, v6);
  ...
  v11 = (UserPresentBoxWindow_ClickDelegate_o *)sub_1B9025C(UserPresentBoxWindow_ClickDelegate_TypeInfo);
  ...
  v13 = (ScrTerminalListTop_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_374C890 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
  if ( !v13 )
    goto LABEL_37;
  if ( AvalonSceneManager__checkNowScene((AvalonSceneManager_o *)v13, 34, 0LL) )
  {
    ...
    if ( klass )
    {
      ...
      if ( v13 )
      {
        ...
        {
          v13 = (ScrTerminalListTop_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_374C890 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
          v16 = (CommonUI_o *)v13;
...
void __fastcall GiftButtonCtrl__SetGiftCount(GiftButtonCtrl_o *this, int32_t giftCount, const MethodInfo *method)
{
  ...
  if ( (byte_4A71EEF & 1) == 0 )
  {
    sub_1B90010(&BalanceConfig_TypeInfo, *(_QWORD *)&giftCount);
...
LABEL_43:
    sub_1B90274(giftNumberCounter, *(_QWORD *)&giftCount);
  }
LABEL_16:
  ...
  if ( UnityEngine_Object__op_Inequality(giftSimpleAnimation, 0LL, 0LL) )
  {
    ...
    if ( SimpleAnimation__GetClipCount(giftNumberCounter, 0LL) >= v12 && !System_String__IsNullOrEmpty(v15, 0LL) )
    {
      ...
      if ( !giftNumberCounter )
        goto LABEL_42;
      SimpleAnimation__Play_63924764(giftNumberCounter, v15, 0LL);
    }
  }
  else
  {
    ...
    if ( UnityEngine_Object__op_Inequality(giftAnimation, 0LL, 0LL) )
    {
        ...
        && !System_String__IsNullOrEmpty(v15, 0LL) )
      {
        ...
        if ( !giftNumberCounter )
          goto LABEL_42;
        UnityEngine_Animation__Play_69284532((UnityEngine_Animation_o *)giftNumberCounter, v15, 0LL);
      }
    }
  }
  ...
  if ( !giftNumberCounter )
LABEL_42:
    sub_1B9026C(giftNumberCounter, *(_QWORD *)&giftCount);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B9026C(limitedPeriodSprite, hasLimited);
  }
