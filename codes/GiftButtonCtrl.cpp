void GiftButtonCtrl___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_59730B1 & 1) == 0 )
  {
    sub_2213A60(&GiftButtonCtrl_TypeInfo);
    byte_59730B1 = 1;
  }
...
void GiftButtonCtrl__OnBtnTouched(GiftButtonCtrl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_59730AB & 1) == 0 )
  {
    sub_2213A60(&Method_GiftButtonCtrl_OnBtnTouched__);
    sub_2213A60(&UnityEngine_Object_TypeInfo);
    sub_2213A60(&TerminalSceneComponent_TypeInfo);
    sub_2213A60(&StringLiteral_3130/*"BTN_GIFT"*/);
    byte_59730AB = 1;
  }
...
LABEL_31:
  ...
  if ( !stateMachine )
    goto LABEL_35;
  PlayMakerFSM__SendEvent((PlayMakerFSM_o *)stateMachine, (System_String_o *)StringLiteral_3130/*"BTN_GIFT"*/, 0);
...
void GiftButtonCtrl__OnButtonTouched(GiftButtonCtrl_o *this, const MethodInfo *method)
{
  ...
  PlayMakerFSM__SendEvent(stateMachine, (System_String_o *)StringLiteral_3130/*"BTN_GIFT"*/, 0);
}
...
LABEL_31:
  ...
  if ( !stateMachine )
    goto LABEL_33;
  PlayMakerFSM__SendEvent((PlayMakerFSM_o *)stateMachine, (System_String_o *)StringLiteral_6703/*"FINISHED"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_59730AD & 1) == 0 )
  {
    ...
    sub_2213A60(&TerminalSceneComponent_TypeInfo);
    sub_2213A60(&StringLiteral_5975/*"EV_GIFT_EXIT"*/);
    byte_59730AD = 1;
  }
      ...
      & 1) != 0 )
  {
    ...
    if ( Instance )
    {
      PlayMakerFSM__SendEvent((PlayMakerFSM_o *)Instance, (System_String_o *)StringLiteral_5975/*"EV_GIFT_EXIT"*/, 0);
      if ( v10 )
...
void GiftButtonCtrl__OnGiftInterfaceClosed(GiftButtonCtrl_o *this, bool retrievedNewServant, const MethodInfo *method)
{
  ...
  if ( (byte_59730B0 & 1) == 0 )
  {
    sub_2213A60(&StringLiteral_7428/*"GotNewServantTrigger"*/);
    sub_2213A60(&StringLiteral_5976/*"EV_GIFT_PROC_FIN"*/);
    byte_59730B0 = 1;
  }
  stateMachine = this->fields.stateMachine;
  if ( !stateMachine
    || (PlayMakerFSM__SendEvent(stateMachine, (System_String_o *)StringLiteral_5976/*"EV_GIFT_PROC_FIN"*/, 0),
    ...
    || (stateMachine = (PlayMakerFSM_o *)HutongGames_PlayMaker_FsmVariables__GetFsmBool(
                                           ...
                                           (System_String_o *)StringLiteral_7428/*"GotNewServantTrigger"*/,
                                           0)) == 0 )
  {
    sub_2213CDC(stateMachine, retrievedNewServant);
  }
...
void GiftButtonCtrl__OnGiftInterfaceOpenFadedOut(GiftButtonCtrl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_59730AC & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_GiftButtonCtrl_InvalidateGiftInfo__);
    sub_2213A60(&Method_GiftButtonCtrl_OnGiftInterfaceClosed__);
    sub_2213A60(&GiftButtonCtrl_TypeInfo);
    sub_2213A60(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_2213A60(&Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    sub_2213A60(&TerminalSceneComponent_TypeInfo);
  ...
  genericContainerHandle = (ScrTerminalListTop_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_47A29F8 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
  ...
  if ( AvalonSceneManager__checkNowScene((AvalonSceneManager_o *)genericContainerHandle, 34, 0) )
  {
    ...
    {
      genericContainerHandle = (ScrTerminalListTop_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_47A29F8 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
...
LABEL_16:
  ...
  if ( UnityEngine_Object__op_Inequality(giftSimpleAnimation, 0, 0) )
  {
    ...
    if ( SimpleAnimation__GetClipCount(giftNumberCounter, 0) >= v7 && !System_String__IsNullOrEmpty(v10, 0) )
    {
      ...
      if ( !giftNumberCounter )
        goto LABEL_42;
      SimpleAnimation__Play_78552168(giftNumberCounter, v10, 0);
    }
  }
  else
  {
    ...
    if ( UnityEngine_Object__op_Inequality(giftAnimation, 0, 0) )
    {
        ...
        && !System_String__IsNullOrEmpty(v10, 0) )
      {
        ...
        if ( !giftNumberCounter )
          goto LABEL_42;
        UnityEngine_Animation__Play_83078544((UnityEngine_Animation_o *)giftNumberCounter, v10, 0);
      }
    }
  }
  ...
  if ( !giftNumberCounter )
LABEL_42:
    sub_2213CDC(giftNumberCounter, *(_QWORD *)&giftCount);
...
void GiftButtonCtrl__SetLimitedItemNotification(GiftButtonCtrl_o *this, bool hasLimited, const MethodInfo *method)
{
  ...
  {
    sub_2213CDC(limitedPeriodSprite, hasLimited);
  }
