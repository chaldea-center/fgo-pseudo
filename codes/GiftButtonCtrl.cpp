void __fastcall GiftButtonCtrl___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_42B1B33 & 1) == 0 )
  {
    sub_B52984(&GiftButtonCtrl_TypeInfo);
    byte_42B1B33 = 1;
  }
...
void __fastcall GiftButtonCtrl__OnBtnTouched(GiftButtonCtrl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B1B2E & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_2663/*"BTN_GIFT"*/);
    byte_42B1B2E = 1;
  }
  ...
  if ( !stateMachine )
    sub_B52A5C(0LL, v3);
  PlayMakerFSM__SendEvent(stateMachine, (System_String_o *)StringLiteral_2663/*"BTN_GIFT"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B1B30 & 1) == 0 )
  {
    sub_B52984(&Method_System_Func_bool__bool__Invoke__);
    ...
    sub_B52984(&StringLiteral_5788/*"EV_GIFT_EXIT"*/);
    byte_42B1B30 = 1;
  }
  ...
  if ( !OnGiftCloseAdditionalAction
    || System_Func_bool__bool___Invoke(
         ...
         retrievedNewServant,
         (const MethodInfo_2782250 *)Method_System_Func_bool__bool__Invoke__) )
  {
    Instance = (CommonUI_o *)this->fields.stateMachine;
    if ( Instance )
    {
      PlayMakerFSM__SendEvent((PlayMakerFSM_o *)Instance, (System_String_o *)StringLiteral_5788/*"EV_GIFT_EXIT"*/, 0LL);
      return;
    }
LABEL_33:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B1B32 & 1) == 0 )
  {
    sub_B52984(&StringLiteral_7042/*"GotNewServantTrigger"*/);
    sub_B52984(&StringLiteral_5789/*"EV_GIFT_PROC_FIN"*/);
    byte_42B1B32 = 1;
  }
  stateMachine = this->fields.stateMachine;
  if ( !stateMachine
    || (PlayMakerFSM__SendEvent(stateMachine, (System_String_o *)StringLiteral_5789/*"EV_GIFT_PROC_FIN"*/, 0LL),
    ...
    || (stateMachine = (PlayMakerFSM_o *)HutongGames_PlayMaker_FsmVariables__GetFsmBool(
                                           ...
                                           (System_String_o *)StringLiteral_7042/*"GotNewServantTrigger"*/,
                                           0LL)) == 0LL )
  {
    sub_B52A5C(stateMachine, retrievedNewServant);
  }
...
void __fastcall GiftButtonCtrl__OnGiftInterfaceOpenFadedOut(GiftButtonCtrl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B1B2F & 1) == 0 )
  {
    ...
    sub_B52984(&UserPresentBoxWindow_ClickDelegate_TypeInfo);
    sub_B52984(&Method_GiftButtonCtrl_InvalidateGiftInfo__);
    sub_B52984(&Method_GiftButtonCtrl_OnGiftInterfaceClosed__);
    sub_B52984(&GiftButtonCtrl_TypeInfo);
    sub_B52984(&Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    sub_B52984(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_B52984(&TerminalSceneComponent_TypeInfo);
  ...
  Instance = (CommonUI_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  v4 = (UserPresentBoxWindow_ClickDelegate_o *)sub_B52A54(UserPresentBoxWindow_ClickDelegate_TypeInfo);
  ...
  genericContainerHandle = (CommonUI_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
  ...
  if ( AvalonSceneManager__checkNowScene((AvalonSceneManager_o *)genericContainerHandle, 34, 0LL) )
  {
    ...
    if ( klass )
    {
      ...
      if ( genericContainerHandle )
      {
        ...
        {
          genericContainerHandle = (CommonUI_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
...
LABEL_44:
    sub_B52A5C(genericContainerHandle, v7);
  }
}
...
LABEL_47:
    v19 = sub_B52A88(giftNumberCounter);
    sub_B52A28(v19, 0LL);
  }
LABEL_17:
  ...
  if ( UnityEngine_Object__op_Inequality(giftSimpleAnimation, 0LL, 0LL) )
  {
    ...
    if ( SimpleAnimation__GetClipCount(giftNumberCounter, 0LL) >= v10 && !System_String__IsNullOrEmpty(v13, 0LL) )
    {
      ...
      if ( !giftNumberCounter )
        goto LABEL_46;
      SimpleAnimation__Play_16625408(giftNumberCounter, v13, 0LL);
    }
  }
  else
  {
    ...
    if ( UnityEngine_Object__op_Inequality(giftAnimation, 0LL, 0LL) )
    {
        ...
        && !System_String__IsNullOrEmpty(v13, 0LL) )
      {
        ...
        if ( !giftNumberCounter )
          goto LABEL_46;
        UnityEngine_Animation__Play_51067744((UnityEngine_Animation_o *)giftNumberCounter, v13, 0LL);
      }
    }
  }
  ...
  if ( !giftNumberCounter )
LABEL_46:
    sub_B52A5C(giftNumberCounter, *(_QWORD *)&giftCount);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B52A5C(limitedPeriodSprite, hasLimited);
  }
