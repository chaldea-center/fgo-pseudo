void __fastcall GiftButtonCtrl___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B1EE6A & 1) == 0 )
  {
    sub_1BCAFF8(&GiftButtonCtrl_TypeInfo, v1);
    byte_4B1EE6A = 1;
  }
...
void __fastcall GiftButtonCtrl__OnBtnTouched(GiftButtonCtrl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1EE65 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_GiftButtonCtrl_OnBtnTouched__, method);
    sub_1BCAFF8(&StringLiteral_2989/*"BTN_GIFT"*/, v3);
    byte_4B1EE65 = 1;
  }
  v4 = Method_GiftButtonCtrl_OnBtnTouched__;
  if ( (*((_BYTE *)Method_GiftButtonCtrl_OnBtnTouched__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1BCB010(Method_GiftButtonCtrl_OnBtnTouched__);
  v5 = (System_Reflection_MethodBase_o *)sub_1BCAFDC(v4, v4[4]);
  OverwriteAssetSoundName__PlaySystemSe(v5, 0, 0, 0LL);
  stateMachine = this->fields.stateMachine;
  if ( !stateMachine )
    sub_1BCB254(0LL, v6);
  PlayMakerFSM__SendEvent(stateMachine, (System_String_o *)StringLiteral_2989/*"BTN_GIFT"*/, 0LL);
...
void __fastcall GiftButtonCtrl__OnButtonTouched(GiftButtonCtrl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1EE68 & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_2989/*"BTN_GIFT"*/, method);
    byte_4B1EE68 = 1;
  }
  stateMachine = this->fields.stateMachine;
  if ( !stateMachine )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1EE67 & 1) == 0 )
  {
    sub_1BCAFF8(&UnityEngine_Object_TypeInfo, retrievedNewServant);
    ...
    sub_1BCAFF8(&StringLiteral_5698/*"EV_GIFT_EXIT"*/, v8);
    byte_4B1EE67 = 1;
  }
          ...
          *(_QWORD *)&OnGiftCloseAdditionalAction->fields.extra_arg) & 1) != 0 )
  {
    ...
    if ( Instance )
    {
      PlayMakerFSM__SendEvent((PlayMakerFSM_o *)Instance, (System_String_o *)StringLiteral_5698/*"EV_GIFT_EXIT"*/, 0LL);
      if ( v14 )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1EE69 & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_7070/*"GotNewServantTrigger"*/, retrievedNewServant);
    sub_1BCAFF8(&StringLiteral_5699/*"EV_GIFT_PROC_FIN"*/, v5);
    byte_4B1EE69 = 1;
  }
  stateMachine = this->fields.stateMachine;
  if ( !stateMachine
    || (PlayMakerFSM__SendEvent(stateMachine, (System_String_o *)StringLiteral_5699/*"EV_GIFT_PROC_FIN"*/, 0LL),
    ...
    || (stateMachine = (PlayMakerFSM_o *)HutongGames_PlayMaker_FsmVariables__GetFsmBool(
                                           ...
                                           (System_String_o *)StringLiteral_7070/*"GotNewServantTrigger"*/,
                                           0LL)) == 0LL )
  {
    sub_1BCB254(stateMachine, retrievedNewServant);
  }
...
void __fastcall GiftButtonCtrl__OnGiftInterfaceOpenFadedOut(GiftButtonCtrl_o *this, const MethodInfo *method)
{
  ...
  QuestRewardItemAction_c *v19; // x8

  if ( (byte_4B1EE66 & 1) == 0 )
  {
    sub_1BCAFF8(&System_Action_TypeInfo, method);
    sub_1BCAFF8(&UserPresentBoxWindow_ClickDelegate_TypeInfo, v3);
    sub_1BCAFF8(&Method_GiftButtonCtrl_InvalidateGiftInfo__, v4);
    sub_1BCAFF8(&Method_GiftButtonCtrl_OnGiftInterfaceClosed__, v5);
    sub_1BCAFF8(&GiftButtonCtrl_TypeInfo, v6);
  ...
  v11 = (UserPresentBoxWindow_ClickDelegate_o *)sub_1BCB244(UserPresentBoxWindow_ClickDelegate_TypeInfo);
  ...
  v13 = (ScrTerminalListTop_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38F8AD8 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
  if ( !v13 )
    goto LABEL_37;
  if ( AvalonSceneManager__checkNowScene((AvalonSceneManager_o *)v13, 34, 0LL) )
  {
    ...
    klass = v13->fields.friendPointBoostItemAction->klass;
    if ( klass )
    {
      ...
      if ( v13 )
      {
        ...
        {
          v13 = (ScrTerminalListTop_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38F8AD8 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
          v16 = (CommonUI_o *)v13;
          ...
          v18 = v13->fields.friendPointBoostItemAction->klass;
          if ( !v18 )
            goto LABEL_37;
        ...
        v19 = v13->fields.friendPointBoostItemAction->klass;
        if ( v19 )
        {
...
void __fastcall GiftButtonCtrl__SetGiftCount(GiftButtonCtrl_o *this, int32_t giftCount, const MethodInfo *method)
{
  ...
  if ( (byte_4B1EE64 & 1) == 0 )
  {
    sub_1BCAFF8(&BalanceConfig_TypeInfo, *(_QWORD *)&giftCount);
  ...
  onDone = (int)m_Playable[1].fields.onDone;
  v10 = *(&m_Playable[1].fields.m_StatesVersion + 1);
  animFiles = this->fields.animFiles;
  if ( onDone - v10 <= giftCount )
    v12 = 2;
  else
    v12 = giftCount > 0;
  if ( !animFiles )
...
LABEL_43:
    sub_1BCB25C(giftNumberCounter, *(_QWORD *)&giftCount, method);
  }
LABEL_16:
  ...
  if ( UnityEngine_Object__op_Inequality(giftSimpleAnimation, 0LL, 0LL) )
  {
    ...
    if ( SimpleAnimation__GetClipCount(giftNumberCounter, 0LL) >= v12 && !System_String__IsNullOrEmpty(v15, 0LL) )
    {
      ...
      if ( !giftNumberCounter )
        goto LABEL_42;
      SimpleAnimation__Play_65395744(giftNumberCounter, v15, 0LL);
    }
  }
  else
  {
    ...
    if ( UnityEngine_Object__op_Inequality(giftAnimation, 0LL, 0LL) )
    {
        ...
        && !System_String__IsNullOrEmpty(v15, 0LL) )
      {
        ...
        if ( !giftNumberCounter )
          goto LABEL_42;
        UnityEngine_Animation__Play_69881360((UnityEngine_Animation_o *)giftNumberCounter, v15, 0LL);
      }
    }
  }
  ...
  if ( !giftNumberCounter )
LABEL_42:
    sub_1BCB254(giftNumberCounter, *(_QWORD *)&giftCount);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BCB254(limitedPeriodSprite, hasLimited);
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.OnGiftCloseAdditionalAction, (int32_t)value, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.OnGiftOpenAdditionalAction, (int32_t)value, (int32_t)method, v3);
}
