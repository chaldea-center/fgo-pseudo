        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A7282A & 1) == 0 )
  {
    sub_1B90010(&AtlasManager_TypeInfo, svtData);
    ...
    sub_1B90010(&StringLiteral_3749/*"COMMAND_SPELL_CAN_NOT_ADD_FUNCTION"*/, v12);
    sub_1B90010(&StringLiteral_3748/*"COMMAND_SPELL_CAN_ADD_FUNCTION"*/, v13);
    byte_4A7282A = 1;
  }
  entity = 0LL;
...
LABEL_32:
    Master_object = (ClassBoardCommandSpellMaster_o *)LocalizationManager__Get(
                                                        (System_String_o *)StringLiteral_3748/*"COMMAND_SPELL_CAN_ADD_FUNCTION"*/,
                                                        0LL);
    if ( addFunctionLabel )
    {
...
LABEL_28:
  Master_object = (ClassBoardCommandSpellMaster_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3749/*"COMMAND_SPELL_CAN_NOT_ADD_FUNCTION"*/, 0LL);
  if ( !addFunctionLabel )
    goto LABEL_37;
  UILabel__set_text(addFunctionLabel, (System_String_o *)Master_object, 0LL);
  Master_object = (ClassBoardCommandSpellMaster_o *)this->fields.commandSpellIcon;
