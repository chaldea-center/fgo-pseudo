        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5DB13 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_3748/*"COMMAND_SPELL_CAN_NOT_ADD_FUNCTION"*/);
    sub_1B885B0(&StringLiteral_3747/*"COMMAND_SPELL_CAN_ADD_FUNCTION"*/);
    byte_4A5DB13 = 1;
  }
  entity = 0LL;
  ...
  Master_object = (ClassBoardCommandSpellMaster_o *)AtlasManager__SetSBuffIconByIconId(commandSpellIcon, v15, 0LL);
  if ( !svtData )
    goto LABEL_37;
...
LABEL_32:
    Master_object = (ClassBoardCommandSpellMaster_o *)LocalizationManager__Get(
                                                        (System_String_o *)StringLiteral_3747/*"COMMAND_SPELL_CAN_ADD_FUNCTION"*/,
                                                        0LL);
    if ( addFunctionLabel )
    {
...
LABEL_28:
  Master_object = (ClassBoardCommandSpellMaster_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3748/*"COMMAND_SPELL_CAN_NOT_ADD_FUNCTION"*/, 0LL);
  if ( !addFunctionLabel )
    goto LABEL_37;
  UILabel__set_text(addFunctionLabel, (System_String_o *)Master_object, 0LL);
  Master_object = (ClassBoardCommandSpellMaster_o *)this->fields.commandSpellIcon;
...
LABEL_35:
  v28 = 1.0;
  UIWidget__set_color((UIWidget_o *)Master_object, *(UnityEngine_Color_o *)&v25, 0LL);
}