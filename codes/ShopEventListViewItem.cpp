        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18806 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_DataManager_GetMasterData_ShopMaster___, v8);
    sub_1BCAFF8(&Method_DataMasterBase_EventMaster__EventEntity__int__GetEntity__, v9);
    sub_1BCAFF8(&Method_DataMasterBase_EventDetailMaster__EventDetailEntity__int__TryGetEntity__, v10);
    sub_1BCAFF8(&Method_System_Linq_Enumerable_All_ShopEntity___, v11);
    sub_1BCAFF8(&System_Func_ShopEntity__bool__TypeInfo, v12);
    sub_1BCAFF8(&NetworkManager_TypeInfo, v13);
    sub_1BCAFF8(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v14);
    sub_1BCAFF8(&TitleInfoControl_TypeInfo, v15);
    sub_1BCAFF8(&Method_ShopEventListViewItem___c__DisplayClass8_0___ctor_b__0__, v16);
    sub_1BCAFF8(&ShopEventListViewItem___c__DisplayClass8_0_TypeInfo, v17);
    byte_4B18806 = 1;
  }
  entity = 0LL;
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.eventEntity, (int32_t)v20, v22, v23);
  Instance = (DataManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38F8AD8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_37;
  Instance = (DataManager_o *)DataManager__GetMasterData_object_(
...
LABEL_10:
  ...
  {
    v24 = (Il2CppObject *)sub_1BCB244(ShopEventListViewItem___c__DisplayClass8_0_TypeInfo);
    ...
    {
      v27 = (System_Func_object__bool__o *)sub_1BCB244(System_Func_ShopEntity__bool__TypeInfo);
         ...
         (const MethodInfo_32C7E4C *)Method_DataMasterBase_EventDetailMaster__EventDetailEntity__int__TryGetEntity__) )
  {
    ...
    if ( EventDetailEntity__IsExchangeShop((EventDetailEntity_o *)entity, 0LL) )
    {
      ...
      if ( !TitleInfoControl__IsEnableEventShopButton_39104492((EventDetailEntity_o *)v28, 0LL) )
...
System_String_o *__fastcall ShopEventListViewItem__ToString(ShopEventListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B18809 & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_8062/*"Item "*/, method);
    byte_4B18809 = 1;
  }
  NameText = ShopEventListViewItem__get_NameText(this, method);
  return System_String__Concat_62450424((System_String_o *)StringLiteral_8062/*"Item "*/, NameText, 0LL);
}
