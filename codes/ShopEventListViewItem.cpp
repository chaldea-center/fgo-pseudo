        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57795 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_System_Linq_Enumerable_All_ShopEntity___);
    sub_1B885B0(&System_Func_ShopEntity__bool__TypeInfo);
    sub_1B885B0(&NetworkManager_TypeInfo);
    sub_1B885B0(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    sub_1B885B0(&TitleInfoControl_TypeInfo);
    sub_1B885B0(&Method_ShopEventListViewItem___c__DisplayClass8_0___ctor_b__0__);
    sub_1B885B0(&ShopEventListViewItem___c__DisplayClass8_0_TypeInfo);
    byte_4A57795 = 1;
  }
  entity = 0LL;
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.eventEntity, (int32_t)v9, v11, v12);
  Instance = (DataManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_37;
  Instance = (DataManager_o *)DataManager__GetMasterData_object_(
...
LABEL_10:
  ...
  {
    v13 = (Il2CppObject *)sub_1B887FC(ShopEventListViewItem___c__DisplayClass8_0_TypeInfo);
    ...
    {
      v16 = (System_Func_object__bool__o *)sub_1B887FC(System_Func_ShopEntity__bool__TypeInfo);
      System_Func_object__bool____ctor(v16, v13, Method_ShopEventListViewItem___c__DisplayClass8_0___ctor_b__0__, 0LL);
      v15 = System_Linq_Enumerable__All_object_(
              EventEntitiyList,
              (System_Func_TSource__bool__o *)v16,
              (const MethodInfo_2E8BEAC *)Method_System_Linq_Enumerable_All_ShopEntity___);
    }
    else
    {
      v15 = 1;
         ...
         (const MethodInfo_311D988 *)Method_DataMasterBase_EventDetailMaster__EventDetailEntity__int__TryGetEntity__) )
  {
    ...
    if ( EventDetailEntity__IsExchangeShop((EventDetailEntity_o *)entity, 0LL) )
    {
      ...
      if ( !TitleInfoControl__IsEnableEventShopButton_37252256((EventDetailEntity_o *)v17, 0LL) )
...
System_String_o *__fastcall ShopEventListViewItem__ToString(ShopEventListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A57798 & 1) == 0 )
  {
    sub_1B885B0(&StringLiteral_8104/*"Item "*/);
    byte_4A57798 = 1;
  }
  NameText = ShopEventListViewItem__get_NameText(this, method);
  return System_String__Concat_61707032((System_String_o *)StringLiteral_8104/*"Item "*/, NameText, 0LL);
}
