        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEA77B & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_ShopEventListViewItem___c__DisplayClass8_0___ctor_b__0__);
    sub_1C7BAE8(&ShopEventListViewItem___c__DisplayClass8_0_TypeInfo);
    byte_4CEA77B = 1;
  }
  entity = 0;
  ...
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.eventEntity, (int32_t)v9, v11, v12, v13, v14, v15, v16);
  Instance = (DataManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A8C5A8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_37;
  Instance = (DataManager_o *)DataManager__GetMasterData_object_(
...
LABEL_10:
  ...
  {
    v17 = (Il2CppObject *)sub_1C7BD34(ShopEventListViewItem___c__DisplayClass8_0_TypeInfo);
    ...
    {
      v20 = (System_Func_object__bool__o *)sub_1C7BD34(System_Func_ShopEntity__bool__TypeInfo);
         ...
         (const MethodInfo_342E348 *)Method_DataMasterBase_EventDetailMaster__EventDetailEntity__int__TryGetEntity__) )
  {
    ...
    if ( EventDetailEntity__IsExchangeShop((EventDetailEntity_o *)entity, 0) )
    {
      ...
      if ( !TitleInfoControl__IsEnableEventShopButton_40550396((EventDetailEntity_o *)v21, 0) )
