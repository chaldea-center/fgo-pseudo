void BlankEarthShortcutButtonListViewObject___cctor(const MethodInfo *method)
{
  ...
  BlankEarthShortcutButtonListViewObject_TypeInfo->static_fields->FUNC_ENTRY_ANIM = (struct System_String_o *)StringLiteral_6114/*"EntryAnim"*/;
  sub_1C93A78(
    (GrandQuestFolderBoardItem_o *)BlankEarthShortcutButtonListViewObject_TypeInfo->static_fields,
    StringLiteral_6114/*"EntryAnim"*/,
    v1,
    v2,
    v3,
    v4,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2D0B0 & 1) == 0 )
  {
    sub_1C93AD4(&Method_UnityEngine_GameObject_GetComponent_BlankEarthShortcutButtonListViewItemDraw___);
    byte_4D2D0B0 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_31FC084 *)Method_UnityEngine_GameObject_GetComponent_BlankEarthShortcutButtonListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2D0B3 & 1) == 0 )
  {
    sub_1C93AD4(&Method_BlankEarthShortcutButtonListViewObject__FrameIn_b__15_0__);
    sub_1C93AD4(&BlankEarthShortcutButtonListViewObject_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2D0B4 & 1) == 0 )
  {
    sub_1C93AD4(&Method_BlankEarthShortcutButtonListViewObject__FrameOut_b__16_0__);
    sub_1C93AD4(&BlankEarthShortcutButtonListViewObject_TypeInfo);
    sub_1C93AD4(&EventDelegate_Callback_TypeInfo);
    sub_1C93AD4(&Method_UITweener_Begin_TweenPosition___);
    byte_4D2D0B4 = 1;
        ...
        const MethodInfo *method)
{
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.animEndAction, (int32_t)endAction, v7, v8, v9, v10, v11, v12);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&v8->fields.linkItem, (int32_t)item, v11, v12, v13, v14, v15, v16);
...
LABEL_18:
    ...
    v12 = COERCE_FLOAT(LODWORD(UnityEngine_Transform__get_localPosition((UnityEngine_Transform_o *)transform, 0).fields.y));
