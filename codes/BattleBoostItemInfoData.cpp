void BattleBoostItemInfoData___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E7A047 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_2982/*"BOOST_EFFECT_ICON"*/);
    sub_1D0F0B4(&StringLiteral_2983/*"BOOST_EFFECT_TIMING"*/);
    byte_4E7A047 = 1;
  }
  BattleBoostItemInfoData_TypeInfo->static_fields->KEY_SCRIPT_BOOST_EFFECT_ICON = (struct System_String_o *)StringLiteral_2982/*"BOOST_EFFECT_ICON"*/;
  sub_1D0F058(
    (GrandQuestFolderBoardItem_o *)BattleBoostItemInfoData_TypeInfo->static_fields,
    StringLiteral_2982/*"BOOST_EFFECT_ICON"*/,
    v1,
    v2,
    v3,
    v4,
    v5,
    v6);
  v7 = StringLiteral_2983/*"BOOST_EFFECT_TIMING"*/;
  static_fields = BattleBoostItemInfoData_TypeInfo->static_fields;
  static_fields->KEY_SCRIPT_BOOST_EFFECT_TIMING = (struct System_String_o *)StringLiteral_2983/*"BOOST_EFFECT_TIMING"*/;
  sub_1D0F058(
