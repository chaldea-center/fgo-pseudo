void __fastcall BattleBoostItemInfoData___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BFFB3B & 1) == 0 )
  {
    sub_1C2E12C(&BattleBoostItemInfoData_TypeInfo, v1);
    sub_1C2E12C(&StringLiteral_3092/*"BOOST_EFFECT_ICON"*/, v8);
    sub_1C2E12C(&StringLiteral_3093/*"BOOST_EFFECT_TIMING"*/, v9);
    byte_4BFFB3B = 1;
  }
  BattleBoostItemInfoData_TypeInfo->static_fields->KEY_SCRIPT_BOOST_EFFECT_ICON = (struct System_String_o *)StringLiteral_3092/*"BOOST_EFFECT_ICON"*/;
  sub_1C2E0D0(
    (PartyOrganizationUtility_o *)BattleBoostItemInfoData_TypeInfo->static_fields,
    StringLiteral_3092/*"BOOST_EFFECT_ICON"*/,
    v2,
    v3,
    v4,
    v5,
    v6,
    v7);
  v10 = StringLiteral_3093/*"BOOST_EFFECT_TIMING"*/;
  static_fields = BattleBoostItemInfoData_TypeInfo->static_fields;
  static_fields->KEY_SCRIPT_BOOST_EFFECT_TIMING = (struct System_String_o *)StringLiteral_3093/*"BOOST_EFFECT_TIMING"*/;
  sub_1C2E0D0(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFFB39 & 1) == 0 )
  {
    sub_1C2E12C(&BattleBoostItemInfoData_TypeInfo, method);
    byte_4BFFB39 = 1;
  }
