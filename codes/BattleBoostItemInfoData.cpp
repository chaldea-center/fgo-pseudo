void __fastcall BattleBoostItemInfoData___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B1EA71 & 1) == 0 )
  {
    sub_1BCAFF8(&BattleBoostItemInfoData_TypeInfo, v1);
    sub_1BCAFF8(&StringLiteral_2938/*"BOOST_EFFECT_ICON"*/, v4);
    sub_1BCAFF8(&StringLiteral_2939/*"BOOST_EFFECT_TIMING"*/, v5);
    byte_4B1EA71 = 1;
  }
  BattleBoostItemInfoData_TypeInfo->static_fields->KEY_SCRIPT_BOOST_EFFECT_ICON = (struct System_String_o *)StringLiteral_2938/*"BOOST_EFFECT_ICON"*/;
  sub_1BCAF9C((CGThumbnailListItem_o *)BattleBoostItemInfoData_TypeInfo->static_fields, StringLiteral_2938/*"BOOST_EFFECT_ICON"*/, v2, v3);
  v6 = StringLiteral_2939/*"BOOST_EFFECT_TIMING"*/;
  static_fields = BattleBoostItemInfoData_TypeInfo->static_fields;
  static_fields->KEY_SCRIPT_BOOST_EFFECT_TIMING = (struct System_String_o *)StringLiteral_2939/*"BOOST_EFFECT_TIMING"*/;
  sub_1BCAF9C((CGThumbnailListItem_o *)&static_fields->KEY_SCRIPT_BOOST_EFFECT_TIMING, v6, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1EA6D & 1) == 0 )
  {
    sub_1BCAFF8(&BattleBoostItemInfoData_TypeInfo, *(_QWORD *)&timing);
    byte_4B1EA6D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1EA6F & 1) == 0 )
  {
    sub_1BCAFF8(&BattleBoostItemInfoData_TypeInfo, method);
    byte_4B1EA6F = 1;
  }
