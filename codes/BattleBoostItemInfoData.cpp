void BattleBoostItemInfoData___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CC9B0F & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_2951/*"BOOST_EFFECT_ICON"*/);
    sub_1C713B0(&StringLiteral_2952/*"BOOST_EFFECT_TIMING"*/);
    byte_4CC9B0F = 1;
  }
  BattleBoostItemInfoData_TypeInfo->static_fields->KEY_SCRIPT_BOOST_EFFECT_ICON = (struct System_String_o *)StringLiteral_2951/*"BOOST_EFFECT_ICON"*/;
  sub_1C71354(
    (GrandQuestFolderBoardItem_o *)BattleBoostItemInfoData_TypeInfo->static_fields,
    StringLiteral_2951/*"BOOST_EFFECT_ICON"*/,
    v1,
    v2,
    v3,
    v4,
    v5,
    v6);
  v7 = StringLiteral_2952/*"BOOST_EFFECT_TIMING"*/;
  static_fields = BattleBoostItemInfoData_TypeInfo->static_fields;
  static_fields->KEY_SCRIPT_BOOST_EFFECT_TIMING = (struct System_String_o *)StringLiteral_2952/*"BOOST_EFFECT_TIMING"*/;
  sub_1C71354(
