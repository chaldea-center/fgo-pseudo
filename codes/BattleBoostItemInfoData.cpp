void BattleBoostItemInfoData___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CB89DB & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_2949/*"BOOST_EFFECT_ICON"*/);
    sub_1C6BA08(&StringLiteral_2950/*"BOOST_EFFECT_TIMING"*/);
    byte_4CB89DB = 1;
  }
  BattleBoostItemInfoData_TypeInfo->static_fields->KEY_SCRIPT_BOOST_EFFECT_ICON = (struct System_String_o *)StringLiteral_2949/*"BOOST_EFFECT_ICON"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)BattleBoostItemInfoData_TypeInfo->static_fields, StringLiteral_2949/*"BOOST_EFFECT_ICON"*/, v1, v2);
  v3 = StringLiteral_2950/*"BOOST_EFFECT_TIMING"*/;
  static_fields = BattleBoostItemInfoData_TypeInfo->static_fields;
  static_fields->KEY_SCRIPT_BOOST_EFFECT_TIMING = (struct System_String_o *)StringLiteral_2950/*"BOOST_EFFECT_TIMING"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)&static_fields->KEY_SCRIPT_BOOST_EFFECT_TIMING, v3, v5, v6);
}
