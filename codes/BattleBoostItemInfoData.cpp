void BattleBoostItemInfoData___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E07377 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_2976/*"BOOST_EFFECT_ICON"*/);
    sub_1CE6700(&StringLiteral_2977/*"BOOST_EFFECT_TIMING"*/);
    byte_4E07377 = 1;
  }
  BattleBoostItemInfoData_TypeInfo->static_fields->KEY_SCRIPT_BOOST_EFFECT_ICON = (struct System_String_o *)StringLiteral_2976/*"BOOST_EFFECT_ICON"*/;
  sub_1CE66A4(
    (GrandQuestFolderBoardItem_o *)BattleBoostItemInfoData_TypeInfo->static_fields,
    StringLiteral_2976/*"BOOST_EFFECT_ICON"*/,
    v1,
    v2,
    v3,
    v4,
    v5,
    v6);
  v7 = StringLiteral_2977/*"BOOST_EFFECT_TIMING"*/;
  static_fields = BattleBoostItemInfoData_TypeInfo->static_fields;
  static_fields->KEY_SCRIPT_BOOST_EFFECT_TIMING = (struct System_String_o *)StringLiteral_2977/*"BOOST_EFFECT_TIMING"*/;
  sub_1CE66A4(
