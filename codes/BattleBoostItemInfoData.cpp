void BattleBoostItemInfoData___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C59458 & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_2957/*"BOOST_EFFECT_ICON"*/);
    sub_1C3E564(&StringLiteral_2958/*"BOOST_EFFECT_TIMING"*/);
    byte_4C59458 = 1;
  }
  ...
  sub_1C3E508((CGThumbnailListItem_o *)BattleBoostItemInfoData_TypeInfo->static_fields, StringLiteral_2957/*"BOOST_EFFECT_ICON"*/, v1, v2);
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&static_fields->KEY_SCRIPT_BOOST_EFFECT_TIMING, v3, v5, v6);
}
