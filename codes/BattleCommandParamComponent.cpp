        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47817 & 1) == 0 )
  {
    this = (BattleCommandParamComponent_o *)sub_1BDB878(&UnityEngine_Object_TypeInfo, method);
    byte_4B47817 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  __int64 v9; // x1
  __int64 v10; // x1
  UnityEngine_GameObject_o *Object_40191676; // x0
  __int64 v12; // x1
  __int64 v13; // x2
  ...
  if ( (byte_4B47818 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_18901/*"effect/ef_cardcombo_u2"*/, *(_QWORD *)&index);
    sub_1BDB878(&StringLiteral_18902/*"effect/ef_cardcombo_u3"*/, v7);
    sub_1BDB878(&StringLiteral_18900/*"effect/ef_cardcombo_3a"*/, v8);
    sub_1BDB878(&StringLiteral_18903/*"effect/ef_cardcombo_ua"*/, v9);
    sub_1BDB878(&StringLiteral_18899/*"effect/ef_cardcombo_2a"*/, v10);
    byte_4B47818 = 1;
  }
  ...
  if ( combo->fields.flash )
  {
    ...
    if ( sameflg->m_Items[6] )
    {
      ...
      if ( samecount == 2 )
      {
        v17 = &StringLiteral_18901/*"effect/ef_cardcombo_u2"*/;
      }
      else
      {
        if ( samecount != 3 )
          return;
        v17 = &StringLiteral_18902/*"effect/ef_cardcombo_u3"*/;
      }
    }
    else
    {
      v17 = &StringLiteral_18903/*"effect/ef_cardcombo_ua"*/;
    }
  }
  else
  {
    ...
    if ( v18 == 2 )
    {
      v17 = &StringLiteral_18899/*"effect/ef_cardcombo_2a"*/;
    }
    else
    {
      if ( v18 != 3 )
        return;
      v17 = &StringLiteral_18900/*"effect/ef_cardcombo_3a"*/;
    }
  }
  if ( *v17 )
  {
    yakuobj = this->fields.yakuobj;
    Object_40191676 = BaseMonoBehaviour__createObject_40191676(
    ...
    if ( yakuobj )
    {
      ...
      {
        yakuobj->m_Items[0] = Object_40191676;
        sub_1BDB81C((CGThumbnailListItem_o *)yakuobj->m_Items, (int32_t)Object_40191676, v13, v20);
        return;
      }
LABEL_25:
      sub_1BDBADC(Object_40191676, v12, v13);
    }
LABEL_24:
    sub_1BDBAD4(Object_40191676, v12);
  }
}
...
void __fastcall BattleCommandParamComponent__setInit(BattleCommandParamComponent_o *this, const MethodInfo *method)
{
  ...
  v15 = sub_1BDB920(UnityEngine_GameObject___TypeInfo, 2LL);
  p_yakuobj->klass = (CGThumbnailListItem_c *)v15;
  sub_1BDB81C(p_yakuobj, v15, v16, v17);
}
        ...
        const MethodInfo *method)
{
  ...
  struct UnityEngine_GameObject_o *Object_40191676; // x0
  int32_t v11; // w2
  ...
  if ( (byte_4B47816 & 1) == 0 )
  {
    sub_1BDB878(&int_TypeInfo, *(_QWORD *)&count);
    sub_1BDB878(&StringLiteral_18905/*"effect/ef_command_{0:00}"*/, v7);
    byte_4B47816 = 1;
  }
  v13 = count;
  v8 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v13, method, v3, v4);
  v9 = System_String__Format((System_String_o *)StringLiteral_18905/*"effect/ef_command_{0:00}"*/, v8, 0LL);
  Object_40191676 = BaseMonoBehaviour__createObject_40191676(
                      (BaseMonoBehaviour_o *)this,
                      v9,
                      ...
                      0LL,
                      0LL);
  this->fields.numberobj = Object_40191676;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.numberobj, (int32_t)Object_40191676, v11, v12);
}