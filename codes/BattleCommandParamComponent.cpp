        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_434E7A0 & 1) == 0 )
  {
    this = (BattleCommandParamComponent_o *)sub_B70694(&UnityEngine_Object_TypeInfo);
    byte_434E7A0 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_434E7A1 & 1) == 0 )
  {
    sub_B70694(&StringLiteral_18519/*"effect/ef_cardcombo_u2"*/);
    sub_B70694(&StringLiteral_18520/*"effect/ef_cardcombo_u3"*/);
    sub_B70694(&StringLiteral_18518/*"effect/ef_cardcombo_3a"*/);
    sub_B70694(&StringLiteral_18521/*"effect/ef_cardcombo_ua"*/);
    sub_B70694(&StringLiteral_18517/*"effect/ef_cardcombo_2a"*/);
    byte_434E7A1 = 1;
  }
  ...
  if ( combo->fields.flash )
  {
    ...
    if ( sameflg->m_Items[6] )
    {
      ...
      if ( samecount == 2 )
      {
        v12 = &StringLiteral_18519/*"effect/ef_cardcombo_u2"*/;
      }
      else
      {
        if ( samecount != 3 )
          return;
        v12 = &StringLiteral_18520/*"effect/ef_cardcombo_u3"*/;
      }
    }
    else
    {
      v12 = &StringLiteral_18521/*"effect/ef_cardcombo_ua"*/;
    }
  }
  else
  {
    ...
    if ( v13 == 2 )
    {
      v12 = &StringLiteral_18517/*"effect/ef_cardcombo_2a"*/;
    }
    else
    {
      if ( v13 != 3 )
        return;
      v12 = &StringLiteral_18518/*"effect/ef_cardcombo_3a"*/;
    }
  }
  if ( *v12 )
  {
    ...
    if ( yakuobj )
    {
      ...
      if ( Object_20856580 )
      {
        Object_20856580 = (UnityEngine_GameObject_o *)sub_B70754(Object_20856580, yakuobj->obj.klass->_1.element_class);
        if ( !Object_20856580 )
        {
          v17 = sub_B7078C();
          sub_B70738(v17, 0LL);
      ...
      if ( yakuobj->max_length )
      {
        ...
        sub_B70630(yakuobj->m_Items);
        return;
      }
LABEL_27:
      v16 = sub_B70798(Object_20856580);
      sub_B70738(v16, 0LL);
    }
LABEL_26:
    sub_B7076C(Object_20856580, v8);
  }
}
...
void __fastcall BattleCommandParamComponent__setInit(BattleCommandParamComponent_o *this, const MethodInfo *method)
{
  ...
  *p_yakuobj = (struct UnityEngine_GameObject_array *)sub_B706AC(UnityEngine_GameObject___TypeInfo, 2LL);
  sub_B70630(p_yakuobj);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_434E79F & 1) == 0 )
  {
    ...
    sub_B70694(&StringLiteral_18523/*"effect/ef_command_{0:00}"*/);
    byte_434E79F = 1;
  }
  v7 = count;
  v5 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v7, method);
  v6 = System_String__Format((System_String_o *)StringLiteral_18523/*"effect/ef_command_{0:00}"*/, v5, 0LL);
  this->fields.numberobj = BaseMonoBehaviour__createObject_20856580(
                             (BaseMonoBehaviour_o *)this,
                             v6,
                             this->fields.NumberTr,
                             0LL,
                             0LL);
  sub_B70630(&this->fields.numberobj);
}