        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCA63D & 1) == 0 )
  {
    this = (BattleCommandParamComponent_o *)sub_1C1ABD4(&UnityEngine_Object_TypeInfo, method);
    byte_4BCA63D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  __int64 v9; // x1
  __int64 v10; // x1
  UnityEngine_GameObject_o *Object_39439284; // x0
  __int64 v12; // x1
  ...
  if ( (byte_4BCA63E & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_19197/*"effect/ef_cardcombo_u2"*/, *(_QWORD *)&index);
    sub_1C1ABD4(&StringLiteral_19198/*"effect/ef_cardcombo_u3"*/, v7);
    sub_1C1ABD4(&StringLiteral_19196/*"effect/ef_cardcombo_3a"*/, v8);
    sub_1C1ABD4(&StringLiteral_19199/*"effect/ef_cardcombo_ua"*/, v9);
    sub_1C1ABD4(&StringLiteral_19195/*"effect/ef_cardcombo_2a"*/, v10);
    byte_4BCA63E = 1;
  }
  ...
  if ( combo->fields.flash )
  {
    ...
    if ( sameflg->m_Items[6] )
    {
      ...
      if ( samecount == 2 )
      {
        v16 = &StringLiteral_19197/*"effect/ef_cardcombo_u2"*/;
      }
      else
      {
        if ( samecount != 3 )
          return;
        v16 = &StringLiteral_19198/*"effect/ef_cardcombo_u3"*/;
      }
    }
    else
    {
      v16 = &StringLiteral_19199/*"effect/ef_cardcombo_ua"*/;
    }
  }
  else
  {
    ...
    if ( v17 == 2 )
    {
      v16 = &StringLiteral_19195/*"effect/ef_cardcombo_2a"*/;
    }
    else
    {
      if ( v17 != 3 )
        return;
      v16 = &StringLiteral_19196/*"effect/ef_cardcombo_3a"*/;
    }
  }
  if ( *v16 )
  {
    yakuobj = this->fields.yakuobj;
    Object_39439284 = BaseMonoBehaviour__createObject_39439284(
    ...
    if ( yakuobj )
    {
      ...
      {
        yakuobj->m_Items[0] = Object_39439284;
        sub_1C1AB78(
          (PartyOrganizationUtility_o *)yakuobj->m_Items,
          (int64_t)Object_39439284,
          v19,
          v20,
          v21,
          v22,
...
LABEL_25:
      sub_1C1AE38(Object_39439284, v12);
    }
LABEL_24:
    sub_1C1AE30(Object_39439284, v12);
  }
}
...
void __fastcall BattleCommandParamComponent__setInit(BattleCommandParamComponent_o *this, const MethodInfo *method)
{
  ...
  v14 = sub_1C1AC7C(UnityEngine_GameObject___TypeInfo, 2LL);
  p_yakuobj->klass = (PartyOrganizationUtility_c *)v14;
  sub_1C1AB78(p_yakuobj, v14, v15, v16, v17, v18, v19, v20);
}
        ...
        const MethodInfo *method)
{
  ...
  struct UnityEngine_GameObject_o *Object_39439284; // x0
  int64_t v11; // x2
  int32_t v12; // w3
  ...
  if ( (byte_4BCA63C & 1) == 0 )
  {
    sub_1C1ABD4(&int_TypeInfo, *(_QWORD *)&count);
    sub_1C1ABD4(&StringLiteral_19201/*"effect/ef_command_{0:00}"*/, v7);
    byte_4BCA63C = 1;
  }
  v17 = count;
  v8 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v17, method, v3, v4);
  v9 = System_String__Format((System_String_o *)StringLiteral_19201/*"effect/ef_command_{0:00}"*/, v8, 0LL);
  Object_39439284 = BaseMonoBehaviour__createObject_39439284(
                      (BaseMonoBehaviour_o *)this,
                      v9,
                      ...
                      0LL,
                      0LL);
  this->fields.numberobj = Object_39439284;
  sub_1C1AB78(
