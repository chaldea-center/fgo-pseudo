        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2244C & 1) == 0 )
  {
    this = (BattleCommandParamComponent_o *)sub_1B715CC(&UnityEngine_Object_TypeInfo, method);
    byte_4A2244C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  __int64 v9; // x1
  __int64 v10; // x1
  UnityEngine_GameObject_o *Object_38104540; // x0
  __int64 v12; // x1
  ...
  if ( (byte_4A2244D & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_18837/*"effect/ef_cardcombo_u2"*/, *(_QWORD *)&index);
    sub_1B715CC(&StringLiteral_18838/*"effect/ef_cardcombo_u3"*/, v7);
    sub_1B715CC(&StringLiteral_18836/*"effect/ef_cardcombo_3a"*/, v8);
    sub_1B715CC(&StringLiteral_18839/*"effect/ef_cardcombo_ua"*/, v9);
    sub_1B715CC(&StringLiteral_18835/*"effect/ef_cardcombo_2a"*/, v10);
    byte_4A2244D = 1;
  }
  ...
  if ( combo->fields.flash )
  {
    ...
    if ( sameflg->m_Items[6] )
    {
      ...
      if ( samecount == 2 )
      {
        v16 = &StringLiteral_18837/*"effect/ef_cardcombo_u2"*/;
      }
      else
      {
        if ( samecount != 3 )
          return;
        v16 = &StringLiteral_18838/*"effect/ef_cardcombo_u3"*/;
      }
    }
    else
    {
      v16 = &StringLiteral_18839/*"effect/ef_cardcombo_ua"*/;
    }
  }
  else
  {
    ...
    if ( v17 == 2 )
    {
      v16 = &StringLiteral_18835/*"effect/ef_cardcombo_2a"*/;
    }
    else
    {
      if ( v17 != 3 )
        return;
      v16 = &StringLiteral_18836/*"effect/ef_cardcombo_3a"*/;
    }
  }
  if ( *v16 )
  {
    yakuobj = this->fields.yakuobj;
    Object_38104540 = BaseMonoBehaviour__createObject_38104540(
    ...
    if ( yakuobj )
    {
      ...
      {
        yakuobj->m_Items[0] = Object_38104540;
        sub_1B71570((ServantStatusBattleListViewItem_o *)yakuobj->m_Items, (int32_t)Object_38104540, v19, v20);
        return;
      }
LABEL_25:
      sub_1B71830(Object_38104540, v12);
    }
LABEL_24:
    sub_1B71828(Object_38104540, v12);
  }
}
...
void __fastcall BattleCommandParamComponent__setInit(BattleCommandParamComponent_o *this, const MethodInfo *method)
{
  ...
  v14 = sub_1B71674(UnityEngine_GameObject___TypeInfo, 2LL);
  p_yakuobj->klass = (ServantStatusBattleListViewItem_c *)v14;
  sub_1B71570(p_yakuobj, v14, v15, v16);
}
        ...
        const MethodInfo *method)
{
  ...
  struct UnityEngine_GameObject_o *Object_38104540; // x0
  int32_t v11; // w2
  int32_t v12; // w3
  ...
  if ( (byte_4A2244B & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_18841/*"effect/ef_command_{0:00}"*/, v7);
    byte_4A2244B = 1;
  }
  v13 = count;
  v8 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v13, method, v3, v4);
  v9 = System_String__Format((System_String_o *)StringLiteral_18841/*"effect/ef_command_{0:00}"*/, v8, 0LL);
  Object_38104540 = BaseMonoBehaviour__createObject_38104540(
                      (BaseMonoBehaviour_o *)this,
                      v9,
                      ...
                      0LL,
                      0LL);
  this->fields.numberobj = Object_38104540;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.numberobj, (int32_t)Object_38104540, v11, v12);
}