...
void BattleCommandParamComponent__resetComboGuid(BattleCommandParamComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2F851 & 1) == 0 )
  {
    this = (BattleCommandParamComponent_o *)sub_1C94098(&UnityEngine_Object_TypeInfo);
    byte_4D2F851 = 1;
  }
...
{
  UnityEngine_GameObject_o *Object_41943128; // x0
  __int64 v8; // x1
  ...
  if ( (byte_4D2F852 & 1) == 0 )
  {
    sub_1C94098(&StringLiteral_19023/*"effect/ef_cardcombo_u2"*/);
    sub_1C94098(&StringLiteral_19024/*"effect/ef_cardcombo_u3"*/);
    sub_1C94098(&StringLiteral_19022/*"effect/ef_cardcombo_3a"*/);
    sub_1C94098(&StringLiteral_19025/*"effect/ef_cardcombo_ua"*/);
    sub_1C94098(&StringLiteral_19021/*"effect/ef_cardcombo_2a"*/);
    byte_4D2F852 = 1;
  }
  ...
  if ( combo->fields.flash )
  {
    ...
    if ( sameflg->m_Items[2] )
    {
      ...
      if ( samecount == 2 )
      {
        v12 = &StringLiteral_19023/*"effect/ef_cardcombo_u2"*/;
      }
      else
      {
        if ( samecount != 3 )
          return;
        v12 = &StringLiteral_19024/*"effect/ef_cardcombo_u3"*/;
      }
    }
    else
    {
      v12 = &StringLiteral_19025/*"effect/ef_cardcombo_ua"*/;
    }
  }
  else
  {
    ...
    if ( v13 == 2 )
    {
      v12 = &StringLiteral_19021/*"effect/ef_cardcombo_2a"*/;
    }
    else
    {
      if ( v13 != 3 )
        return;
      v12 = &StringLiteral_19022/*"effect/ef_cardcombo_3a"*/;
    }
  }
  if ( *v12 )
  {
    yakuobj = this->fields.yakuobj;
    Object_41943128 = BaseMonoBehaviour__createObject_41943128(
    ...
    if ( yakuobj )
    {
      ...
      {
        yakuobj->m_Items[0] = Object_41943128;
        sub_1C9403C(
          (GrandQuestFolderBoardItem_o *)yakuobj->m_Items,
          (int32_t)Object_41943128,
          v15,
          v16,
          v17,
          v18,
...
LABEL_25:
      sub_1C942F8(Object_41943128);
    }
LABEL_24:
    sub_1C942F0(Object_41943128, v8);
  }
}
...
void BattleCommandParamComponent__setInit(BattleCommandParamComponent_o *this, const MethodInfo *method)
{
  ...
  v13 = sub_1C94140(UnityEngine_GameObject___TypeInfo, 2);
  p_yakuobj->klass = (GrandQuestFolderBoardItem_c *)v13;
  sub_1C9403C(p_yakuobj, v13, v14, v15, v16, v17, v18, v19);
}
...
void BattleCommandParamComponent__setNo(BattleCommandParamComponent_o *this, int32_t count, const MethodInfo *method)
{
  ...
  struct UnityEngine_GameObject_o *Object_41943128; // x0
  int32_t v8; // w2
  int32_t v9; // w3
  ...
  if ( (byte_4D2F850 & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_19027/*"effect/ef_command_{0:00}"*/);
    byte_4D2F850 = 1;
  }
  v14 = count;
  v5 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v14);
  v6 = System_String__Format((System_String_o *)StringLiteral_19027/*"effect/ef_command_{0:00}"*/, v5, 0);
  Object_41943128 = BaseMonoBehaviour__createObject_41943128(
                      (BaseMonoBehaviour_o *)this,
                      v6,
                      ...
                      0,
                      0);
  this->fields.numberobj = Object_41943128;
  sub_1C9403C(
