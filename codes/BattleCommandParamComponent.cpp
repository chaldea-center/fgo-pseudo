...
void BattleCommandParamComponent__resetComboGuid(BattleCommandParamComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3A8B4 & 1) == 0 )
  {
    this = (BattleCommandParamComponent_o *)sub_1C32C20(&UnityEngine_Object_TypeInfo);
    byte_4C3A8B4 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3A8B5 & 1) == 0 )
  {
    sub_1C32C20(&StringLiteral_18891/*"effect/ef_cardcombo_u2"*/);
    sub_1C32C20(&StringLiteral_18892/*"effect/ef_cardcombo_u3"*/);
    sub_1C32C20(&StringLiteral_18890/*"effect/ef_cardcombo_3a"*/);
    sub_1C32C20(&StringLiteral_18893/*"effect/ef_cardcombo_ua"*/);
    sub_1C32C20(&StringLiteral_18889/*"effect/ef_cardcombo_2a"*/);
    byte_4C3A8B5 = 1;
  }
  ...
  if ( combo->fields.flash )
  {
    ...
    if ( sameflg->m_Items[2] )
    {
      ...
      if ( samecount == 2 )
      {
        v11 = &StringLiteral_18891/*"effect/ef_cardcombo_u2"*/;
      }
      else
      {
        if ( samecount != 3 )
          return;
        v11 = &StringLiteral_18892/*"effect/ef_cardcombo_u3"*/;
      }
    }
    else
    {
      v11 = &StringLiteral_18893/*"effect/ef_cardcombo_ua"*/;
    }
  }
  else
  {
    ...
    if ( v12 == 2 )
    {
      v11 = &StringLiteral_18889/*"effect/ef_cardcombo_2a"*/;
    }
    else
    {
      if ( v12 != 3 )
        return;
      v11 = &StringLiteral_18890/*"effect/ef_cardcombo_3a"*/;
    }
  }
  if ( *v11 )
  {
    ...
    if ( yakuobj )
    {
      ...
      {
        yakuobj->m_Items[0] = Object_41085732;
        sub_1C32BC4((CGThumbnailListItem_o *)yakuobj->m_Items, (int32_t)Object_41085732, v14, v15);
        return;
      }
LABEL_25:
...
void BattleCommandParamComponent__setInit(BattleCommandParamComponent_o *this, const MethodInfo *method)
{
  ...
  v12 = sub_1C32CC8(UnityEngine_GameObject___TypeInfo, 2);
  p_yakuobj->klass = (CGThumbnailListItem_c *)v12;
  sub_1C32BC4(p_yakuobj, v12, v13, v14);
}
...
void BattleCommandParamComponent__setNo(BattleCommandParamComponent_o *this, int32_t count, const MethodInfo *method)
{
  ...
  struct UnityEngine_GameObject_o *Object_41085732; // x0
  int32_t v13; // w2
  const MethodInfo *v14; // x3
  ...
  if ( (byte_4C3A8B3 & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_18895/*"effect/ef_command_{0:00}"*/);
    byte_4C3A8B3 = 1;
  }
  v15 = count;
  v10 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v15, method, v3, v4, v5, v6, v7);
  v11 = System_String__Format((System_String_o *)StringLiteral_18895/*"effect/ef_command_{0:00}"*/, v10, 0);
  Object_41085732 = BaseMonoBehaviour__createObject_41085732(
                      (BaseMonoBehaviour_o *)this,
                      v11,
                      ...
                      0,
                      0);
  this->fields.numberobj = Object_41085732;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.numberobj, (int32_t)Object_41085732, v13, v14);
}