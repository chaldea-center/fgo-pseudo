        ...
        const MethodInfo *method)
{
  ...
  RequestBase__addField_41136012((RequestBase_o *)this, (System_String_o *)StringLiteral_22969/*"routeSelect"*/, &v5->obj, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5C937 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_17096/*"battle/routeSelect"*/);
    byte_4A5C937 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61707032(BaseUrl, (System_String_o *)StringLiteral_17096/*"battle/routeSelect"*/, 0LL);
}
