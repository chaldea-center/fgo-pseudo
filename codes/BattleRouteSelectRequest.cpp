        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4211D0D & 1) == 0 )
  {
    ...
    sub_B0D8A4(&StringLiteral_16684/*"battle/routeSelect"*/, v2);
    byte_4211D0D = 1;
  }
  ...
  return System_String__Concat_43849904(BaseUrl, (System_String_o *)StringLiteral_16684/*"battle/routeSelect"*/, 0LL);
}
