        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_434EC4F & 1) == 0 )
  {
    ...
    sub_B70694(&StringLiteral_16880/*"battle/routeSelect"*/);
    byte_434EC4F = 1;
  }
  ...
  return System_String__Concat_44758168(BaseUrl, (System_String_o *)StringLiteral_16880/*"battle/routeSelect"*/, 0LL);
}
