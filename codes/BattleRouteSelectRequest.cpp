        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42E575F & 1) == 0 )
  {
    ...
    sub_B5D5C4(&StringLiteral_16836/*"battle/routeSelect"*/, v4, v5, v6);
    byte_42E575F = 1;
  }
  ...
  return System_String__Concat_44577788(BaseUrl, (System_String_o *)StringLiteral_16836/*"battle/routeSelect"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v12 = ResponseCommandKind__SearchData(86, responseList, 0LL);
  if ( !v12 )
    sub_B5D69C(0LL, v13);
