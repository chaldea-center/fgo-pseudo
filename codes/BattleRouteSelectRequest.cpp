        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4184DDE & 1) == 0 )
  {
    ...
    sub_B2C35C(&StringLiteral_16635/*"battle/routeSelect"*/, v2);
    byte_4184DDE = 1;
  }
  ...
  return System_String__Concat_44305532(BaseUrl, (System_String_o *)StringLiteral_16635/*"battle/routeSelect"*/, 0LL);
}
