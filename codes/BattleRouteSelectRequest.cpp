        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4388220 & 1) == 0 )
  {
    ...
    sub_B775C4(&StringLiteral_16962/*"battle/routeSelect"*/);
    byte_4388220 = 1;
  }
  ...
  return System_String__Concat_44901936(BaseUrl, (System_String_o *)StringLiteral_16962/*"battle/routeSelect"*/, 0LL);
}
