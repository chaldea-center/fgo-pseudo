...
void SetGameOptionComponent__CreateContentsArrayIfNotYet(SetGameOptionComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E7255A & 1) == 0 )
  {
    sub_1D0F0B4(&GameOptionContentBase___TypeInfo);
    byte_4E7255A = 1;
  }
  if ( !this->fields.contentsArray )
  {
    v3 = sub_1D0F15C(GameOptionContentBase___TypeInfo, 22);
    if ( !v3 )
      sub_1D0F30C(0, v4);
    setResolutionOptionCtr = this->fields.setResolutionOptionCtr;
    v12 = v3;
    if ( !setResolutionOptionCtr
      || (v3 = sub_1D0F1F0(this->fields.setResolutionOptionCtr, *(_QWORD *)(*(_QWORD *)v3 + 64LL))) != 0 )
    {
      v13 = (_DWORD *)(v12 + 24);
      if ( !*(_DWORD *)(v12 + 24) )
        goto LABEL_72;
      *(_QWORD *)(v12 + 32) = setResolutionOptionCtr;
      sub_1D0F058((GrandQuestFolderBoardItem_o *)(v12 + 32), (int32_t)setResolutionOptionCtr, v5, v6, v7, v8, v9, v10);
      setSmoothnessCtr = this->fields.setSmoothnessCtr;
      if ( !setSmoothnessCtr
        || (v3 = sub_1D0F1F0(this->fields.setSmoothnessCtr, *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
      {
        if ( *v13 <= 1u )
          goto LABEL_72;
        *(_QWORD *)(v12 + 40) = setSmoothnessCtr;
        sub_1D0F058((GrandQuestFolderBoardItem_o *)(v12 + 40), (int32_t)setSmoothnessCtr, v14, v15, v16, v17, v18, v19);
        setVolCtr = this->fields.setVolCtr;
        if ( !setVolCtr || (v3 = sub_1D0F1F0(this->fields.setVolCtr, *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
        {
          if ( *v13 <= 2u )
            goto LABEL_72;
          *(_QWORD *)(v12 + 48) = setVolCtr;
          sub_1D0F058((GrandQuestFolderBoardItem_o *)(v12 + 48), (int32_t)setVolCtr, v21, v22, v23, v24, v25, v26);
          setScenarioTextSpeedCtr = this->fields.setScenarioTextSpeedCtr;
          if ( !setScenarioTextSpeedCtr
            || (v3 = sub_1D0F1F0(this->fields.setScenarioTextSpeedCtr, *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
          {
            if ( *v13 <= 3u )
              goto LABEL_72;
            *(_QWORD *)(v12 + 56) = setScenarioTextSpeedCtr;
            ...
            if ( !setScenarioCtr
              || (v3 = sub_1D0F1F0(this->fields.setScenarioCtr, *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
            {
              if ( *v13 <= 4u )
                goto LABEL_72;
              *(_QWORD *)(v12 + 64) = setScenarioCtr;
              ...
              if ( !setSpoilerProtectionCtr
                || (v3 = sub_1D0F1F0(this->fields.setSpoilerProtectionCtr, *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
              {
                if ( *v13 <= 5u )
                  goto LABEL_72;
                *(_QWORD *)(v12 + 72) = setSpoilerProtectionCtr;
                ...
                if ( !setSwitchCtr
                  || (v3 = sub_1D0F1F0(this->fields.setSwitchCtr, *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
                {
                  if ( *v13 <= 6u )
                    goto LABEL_72;
                  *(_QWORD *)(v12 + 80) = setSwitchCtr;
                  ...
                  if ( !setSwitch2Ctr
                    || (v3 = sub_1D0F1F0(this->fields.setSwitch2Ctr, *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
                  {
                    if ( *v13 <= 7u )
                      goto LABEL_72;
                                 ...
                                 *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
                    {
                      ...
                      *(_QWORD *)(v12 + 96) = setSupportLimitCountToDispLimitCountCtr;
                      ...
                      if ( !setPreBattleFormationCtr
                        || (v3 = sub_1D0F1F0(this->fields.setPreBattleFormationCtr, *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
                      {
                        if ( *v13 <= 9u )
                          goto LABEL_72;
                                     ...
                                     *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
                        {
                          ...
                          *(_QWORD *)(v12 + 112) = setAdvantageClassAutoCtr;
                          ...
                          if ( !setAutoSelectPartyCtr
                            || (v3 = sub_1D0F1F0(this->fields.setAutoSelectPartyCtr, *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
                          {
                            if ( *v13 <= 0xBu )
                              goto LABEL_72;
                                         ...
                                         *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
                            {
                              ...
                              *(_QWORD *)(v12 + 128) = setAutoOpenAutoOrganizationDialogCtr;
                              ...
                              if ( !setTDPlaySpeedCtr
                                || (v3 = sub_1D0F1F0(this->fields.setTDPlaySpeedCtr, *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
                              {
                                if ( *v13 <= 0xDu )
                                  goto LABEL_72;
                                                     ...
                                                     *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
                                        {
                                          ...
                                          *(_QWORD *)(v12 + 176) = setNoticeCtr;
                                                       ...
                                                       *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
                                          {
                                            if ( *v13 <= 0x13u )
                                              goto LABEL_72;
                                            *(_QWORD *)(v12 + 184) = setPlayOpeningMovieCtr;
                                            sub_1D0F058(
                                                           ...
                                                           *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
                                              {
                                                if ( *v13 > 0x15u )
                                                {
                                                  *(_QWORD *)(v12 + 200) = setBlackListCtr;
                                                  ...
                                                  sub_1D0F058(p_contentsArray, v12, v162, v163, v164, v165, v166, v167);
                                                  return;
                                                }
LABEL_72:
                                                sub_1D0F314(v3);
        ...
        const MethodInfo *method)
{
  ...
  System_Action_object__o *_9__41_1; // x21
  ...
  if ( (byte_4E7255D & 1) == 0 )
  {
    sub_1D0F0B4(&System_Action_GameOptionContentBase__TypeInfo);
    sub_1D0F0B4(&Method_BasicHelper_ForEach_GameOptionContentBase___);
    sub_1D0F0B4(&Method_System_Linq_Enumerable_Where_GameOptionContentBase___);
    sub_1D0F0B4(&System_Func_GameOptionContentBase__bool__TypeInfo);
    sub_1D0F0B4(&OptionManager_TypeInfo);
    sub_1D0F0B4(&SoundManager_TypeInfo);
    sub_1D0F0B4(&Method_SetGameOptionComponent___c__reflectionGameOption_b__41_0__);
    sub_1D0F0B4(&Method_SetGameOptionComponent___c__reflectionGameOption_b__41_1__);
    sub_1D0F0B4(&SetGameOptionComponent___c_TypeInfo);
    byte_4E7255D = 1;
  }
  ...
  _9__41_0 = (System_Func_object__bool__o *)v5->static_fields->__9__41_0;
  if ( !_9__41_0 )
  {
    ...
    _9__41_0 = (System_Func_object__bool__o *)sub_1D0F300(System_Func_GameOptionContentBase__bool__TypeInfo);
    System_Func_object__bool____ctor(_9__41_0, v8, Method_SetGameOptionComponent___c__reflectionGameOption_b__41_0__, 0);
    static_fields = SetGameOptionComponent___c_TypeInfo->static_fields;
    static_fields->__9__41_0 = (struct System_Func_GameOptionContentBase__bool__o *)_9__41_0;
    sub_1D0F058(
  ...
  v16 = System_Linq_Enumerable__Where_object_(
          ...
          (const MethodInfo_329781C *)Method_System_Linq_Enumerable_Where_GameOptionContentBase___);
  ...
  _9__41_1 = (System_Action_object__o *)v17->static_fields->__9__41_1;
  if ( !_9__41_1 )
  {
    ...
    _9__41_1 = (System_Action_object__o *)sub_1D0F300(System_Action_GameOptionContentBase__TypeInfo);
    System_Action_object____ctor(_9__41_1, v20, Method_SetGameOptionComponent___c__reflectionGameOption_b__41_1__, 0);
    v21 = SetGameOptionComponent___c_TypeInfo->static_fields;
    v21->__9__41_1 = (struct System_Action_GameOptionContentBase__o *)_9__41_1;
    sub_1D0F058((GrandQuestFolderBoardItem_o *)&v21->__9__41_1, (int32_t)_9__41_1, v22, v23, v24, v25, v26, v27);
  }
  BasicHelper__ForEach_object_(
    v18,
    (System_Action_T__o *)_9__41_1,
    (const MethodInfo_323AF0C *)Method_BasicHelper_ForEach_GameOptionContentBase___);
...
void SetGameOptionComponent__showGameOption(SetGameOptionComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E72559 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&AtlasManager_TypeInfo);
    sub_1D0F0B4(&Method_SetGameOptionComponent__showGameOption_b__37_0__);
    byte_4E72559 = 1;
  }
  ...
  System_Action___ctor(v5, (Il2CppObject *)this, Method_SetGameOptionComponent__showGameOption_b__37_0__, 0);
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
...
void SetGameOptionComponent___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1D0F300(SetGameOptionComponent___c_TypeInfo);
...
bool SetGameOptionComponent___c___reflectionGameOption_b__41_0(
...
void SetGameOptionComponent___c___reflectionGameOption_b__41_1(
        SetGameOptionComponent___c_o *this,
        GameOptionContentBase_o *x,
        const MethodInfo *method)
{
