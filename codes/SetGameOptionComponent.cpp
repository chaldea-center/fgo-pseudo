...
void SetGameOptionComponent__CreateContentsArrayIfNotYet(SetGameOptionComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CE959A & 1) == 0 )
  {
    sub_1C7BAE8(&GameOptionContentBase___TypeInfo);
    byte_4CE959A = 1;
  }
  if ( !this->fields.contentsArray )
  {
    v3 = sub_1C7BB90(GameOptionContentBase___TypeInfo, 21);
    if ( !v3 )
      sub_1C7BD40(0, v4);
    setResolutionOptionCtr = this->fields.setResolutionOptionCtr;
    v12 = v3;
    if ( !setResolutionOptionCtr
      || (v3 = sub_1C7BC24(this->fields.setResolutionOptionCtr, *(_QWORD *)(*(_QWORD *)v3 + 64LL))) != 0 )
    {
      v13 = (_DWORD *)(v12 + 24);
      if ( !*(_DWORD *)(v12 + 24) )
        goto LABEL_69;
      *(_QWORD *)(v12 + 32) = setResolutionOptionCtr;
      sub_1C7BA8C((GrandQuestFolderBoardItem_o *)(v12 + 32), (int32_t)setResolutionOptionCtr, v5, v6, v7, v8, v9, v10);
      setSmoothnessCtr = this->fields.setSmoothnessCtr;
      if ( !setSmoothnessCtr
        || (v3 = sub_1C7BC24(this->fields.setSmoothnessCtr, *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
      {
        if ( *v13 <= 1u )
          goto LABEL_69;
        *(_QWORD *)(v12 + 40) = setSmoothnessCtr;
        sub_1C7BA8C((GrandQuestFolderBoardItem_o *)(v12 + 40), (int32_t)setSmoothnessCtr, v14, v15, v16, v17, v18, v19);
        setVolCtr = this->fields.setVolCtr;
        if ( !setVolCtr || (v3 = sub_1C7BC24(this->fields.setVolCtr, *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
        {
          if ( *v13 <= 2u )
            goto LABEL_69;
          *(_QWORD *)(v12 + 48) = setVolCtr;
          sub_1C7BA8C((GrandQuestFolderBoardItem_o *)(v12 + 48), (int32_t)setVolCtr, v21, v22, v23, v24, v25, v26);
          setScenarioTextSpeedCtr = this->fields.setScenarioTextSpeedCtr;
          if ( !setScenarioTextSpeedCtr
            || (v3 = sub_1C7BC24(this->fields.setScenarioTextSpeedCtr, *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
          {
            if ( *v13 <= 3u )
              goto LABEL_69;
            *(_QWORD *)(v12 + 56) = setScenarioTextSpeedCtr;
            ...
            if ( !setScenarioCtr
              || (v3 = sub_1C7BC24(this->fields.setScenarioCtr, *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
            {
              if ( *v13 <= 4u )
                goto LABEL_69;
              *(_QWORD *)(v12 + 64) = setScenarioCtr;
              ...
              if ( !setSpoilerProtectionCtr
                || (v3 = sub_1C7BC24(this->fields.setSpoilerProtectionCtr, *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
              {
                if ( *v13 <= 5u )
                  goto LABEL_69;
                *(_QWORD *)(v12 + 72) = setSpoilerProtectionCtr;
                ...
                if ( !setSwitchCtr
                  || (v3 = sub_1C7BC24(this->fields.setSwitchCtr, *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
                {
                  if ( *v13 <= 6u )
                    goto LABEL_69;
                  *(_QWORD *)(v12 + 80) = setSwitchCtr;
                  ...
                  if ( !setSwitch2Ctr
                    || (v3 = sub_1C7BC24(this->fields.setSwitch2Ctr, *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
                  {
                    if ( *v13 <= 7u )
                      goto LABEL_69;
                    *(_QWORD *)(v12 + 88) = setSwitch2Ctr;
                    ...
                    if ( !setPreBattleFormationCtr
                      || (v3 = sub_1C7BC24(this->fields.setPreBattleFormationCtr, *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
                    {
                      if ( *v13 <= 8u )
                        goto LABEL_69;
                      *(_QWORD *)(v12 + 96) = setPreBattleFormationCtr;
                      ...
                      if ( !setAdvantageClassAutoCtr
                        || (v3 = sub_1C7BC24(this->fields.setAdvantageClassAutoCtr, *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
                      {
                        if ( *v13 <= 9u )
                          goto LABEL_69;
                        *(_QWORD *)(v12 + 104) = setAdvantageClassAutoCtr;
                        ...
                        if ( !setAutoSelectPartyCtr
                          || (v3 = sub_1C7BC24(this->fields.setAutoSelectPartyCtr, *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
                        {
                          if ( *v13 <= 0xAu )
                            goto LABEL_69;
                                       ...
                                       *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
                          {
                            ...
                            *(_QWORD *)(v12 + 120) = setAutoOpenAutoOrganizationDialogCtr;
                            ...
                            if ( !setTDPlaySpeedCtr
                              || (v3 = sub_1C7BC24(this->fields.setTDPlaySpeedCtr, *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
                            {
                              if ( *v13 <= 0xCu )
                                goto LABEL_69;
                                ...
                                *(_QWORD *)(v12 + 136) = setRandomLimitCountCtr;
                                             ...
                                             *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
                                {
                                  ...
                                  *(_QWORD *)(v12 + 144) = setRandomLimitCountResetCtr;
                                  ...
                                  if ( !setSvtRandCtr
                                    || (v3 = sub_1C7BC24(this->fields.setSvtRandCtr, *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
                                  {
                                    if ( *v13 <= 0xFu )
                                      goto LABEL_69;
                                                         ...
                                                         *(_QWORD *)(*(_QWORD *)v12 + 64LL))) != 0 )
                                            {
                                              if ( *v13 > 0x14u )
                                              {
                                                *(_QWORD *)(v12 + 192) = setBlackListCtr;
                                                ...
                                                sub_1C7BA8C(p_contentsArray, v12, v155, v156, v157, v158, v159, v160);
                                                return;
                                              }
LABEL_69:
                                              sub_1C7BD48(v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CE959D & 1) == 0 )
  {
    sub_1C7BAE8(&System_Action_GameOptionContentBase__TypeInfo);
    sub_1C7BAE8(&Method_BasicHelper_ForEach_GameOptionContentBase___);
    sub_1C7BAE8(&Method_System_Linq_Enumerable_Where_GameOptionContentBase___);
    sub_1C7BAE8(&System_Func_GameOptionContentBase__bool__TypeInfo);
    sub_1C7BAE8(&OptionManager_TypeInfo);
    sub_1C7BAE8(&SoundManager_TypeInfo);
    sub_1C7BAE8(&Method_SetGameOptionComponent___c__reflectionGameOption_b__40_0__);
    sub_1C7BAE8(&Method_SetGameOptionComponent___c__reflectionGameOption_b__40_1__);
    sub_1C7BAE8(&SetGameOptionComponent___c_TypeInfo);
    byte_4CE959D = 1;
  }
  ...
  if ( !_9__40_0 )
  {
    ...
    _9__40_0 = (System_Func_object__bool__o *)sub_1C7BD34(System_Func_GameOptionContentBase__bool__TypeInfo);
  ...
  v16 = System_Linq_Enumerable__Where_object_(
          ...
          (const MethodInfo_31B6300 *)Method_System_Linq_Enumerable_Where_GameOptionContentBase___);
  ...
  if ( !_9__40_1 )
  {
    ...
    _9__40_1 = (System_Action_object__o *)sub_1C7BD34(System_Action_GameOptionContentBase__TypeInfo);
    ...
    sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&v21->__9__40_1, (int32_t)_9__40_1, v22, v23, v24, v25, v26, v27);
  }
  BasicHelper__ForEach_object_(
    v18,
    (System_Action_T__o *)_9__40_1,
    (const MethodInfo_315C348 *)Method_BasicHelper_ForEach_GameOptionContentBase___);
...
void SetGameOptionComponent__showGameOption(SetGameOptionComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CE9599 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&AtlasManager_TypeInfo);
    sub_1C7BAE8(&Method_SetGameOptionComponent__showGameOption_b__36_0__);
    byte_4CE9599 = 1;
  }
...
void SetGameOptionComponent___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C7BD34(SetGameOptionComponent___c_TypeInfo);
