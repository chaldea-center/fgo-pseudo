        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17609 & 1) == 0 )
  {
    sub_1BCAFF8(&GameOptionContentBase___TypeInfo, method);
    byte_4B17609 = 1;
  }
  if ( !this->fields.contentsArray )
  {
    v3 = sub_1BCB0A0(GameOptionContentBase___TypeInfo, 21LL);
    if ( !v3 )
      sub_1BCB254(0LL, v4);
    setResolutionOptionCtr = this->fields.setResolutionOptionCtr;
    v8 = v3;
    if ( !setResolutionOptionCtr
      || (v3 = sub_1BCB134(this->fields.setResolutionOptionCtr, *(_QWORD *)(*(_QWORD *)v3 + 64LL))) != 0 )
    {
      v9 = (_DWORD *)(v8 + 24);
      if ( !*(_DWORD *)(v8 + 24) )
        goto LABEL_69;
      *(_QWORD *)(v8 + 32) = setResolutionOptionCtr;
      sub_1BCAF9C((CGThumbnailListItem_o *)(v8 + 32), (int32_t)setResolutionOptionCtr, v5, v6);
      setSmoothnessCtr = this->fields.setSmoothnessCtr;
      if ( !setSmoothnessCtr
        || (v3 = sub_1BCB134(this->fields.setSmoothnessCtr, *(_QWORD *)(*(_QWORD *)v8 + 64LL))) != 0 )
      {
        if ( *v9 <= 1u )
          goto LABEL_69;
        *(_QWORD *)(v8 + 40) = setSmoothnessCtr;
        sub_1BCAF9C((CGThumbnailListItem_o *)(v8 + 40), (int32_t)setSmoothnessCtr, v5, v10);
        setVolCtr = this->fields.setVolCtr;
        if ( !setVolCtr || (v3 = sub_1BCB134(this->fields.setVolCtr, *(_QWORD *)(*(_QWORD *)v8 + 64LL))) != 0 )
        {
          if ( *v9 <= 2u )
            goto LABEL_69;
          *(_QWORD *)(v8 + 48) = setVolCtr;
          sub_1BCAF9C((CGThumbnailListItem_o *)(v8 + 48), (int32_t)setVolCtr, v5, v12);
          setScenarioTextSpeedCtr = this->fields.setScenarioTextSpeedCtr;
          if ( !setScenarioTextSpeedCtr
            || (v3 = sub_1BCB134(this->fields.setScenarioTextSpeedCtr, *(_QWORD *)(*(_QWORD *)v8 + 64LL))) != 0 )
          {
            if ( *v9 <= 3u )
              goto LABEL_69;
            *(_QWORD *)(v8 + 56) = setScenarioTextSpeedCtr;
            sub_1BCAF9C((CGThumbnailListItem_o *)(v8 + 56), (int32_t)setScenarioTextSpeedCtr, v5, v14);
            setScenarioCtr = this->fields.setScenarioCtr;
            if ( !setScenarioCtr
              || (v3 = sub_1BCB134(this->fields.setScenarioCtr, *(_QWORD *)(*(_QWORD *)v8 + 64LL))) != 0 )
            {
              if ( *v9 <= 4u )
                goto LABEL_69;
              *(_QWORD *)(v8 + 64) = setScenarioCtr;
              sub_1BCAF9C((CGThumbnailListItem_o *)(v8 + 64), (int32_t)setScenarioCtr, v5, v16);
              setSpoilerProtectionCtr = this->fields.setSpoilerProtectionCtr;
              if ( !setSpoilerProtectionCtr
                || (v3 = sub_1BCB134(this->fields.setSpoilerProtectionCtr, *(_QWORD *)(*(_QWORD *)v8 + 64LL))) != 0 )
              {
                if ( *v9 <= 5u )
                  goto LABEL_69;
                *(_QWORD *)(v8 + 72) = setSpoilerProtectionCtr;
                sub_1BCAF9C((CGThumbnailListItem_o *)(v8 + 72), (int32_t)setSpoilerProtectionCtr, v5, v18);
                setSwitchCtr = this->fields.setSwitchCtr;
                if ( !setSwitchCtr
                  || (v3 = sub_1BCB134(this->fields.setSwitchCtr, *(_QWORD *)(*(_QWORD *)v8 + 64LL))) != 0 )
                {
                  if ( *v9 <= 6u )
                    goto LABEL_69;
                  *(_QWORD *)(v8 + 80) = setSwitchCtr;
                  sub_1BCAF9C((CGThumbnailListItem_o *)(v8 + 80), (int32_t)setSwitchCtr, v5, v20);
                  setSwitch2Ctr = this->fields.setSwitch2Ctr;
                  if ( !setSwitch2Ctr
                    || (v3 = sub_1BCB134(this->fields.setSwitch2Ctr, *(_QWORD *)(*(_QWORD *)v8 + 64LL))) != 0 )
                  {
                    if ( *v9 <= 7u )
                      goto LABEL_69;
                    *(_QWORD *)(v8 + 88) = setSwitch2Ctr;
                    sub_1BCAF9C((CGThumbnailListItem_o *)(v8 + 88), (int32_t)setSwitch2Ctr, v5, v22);
                    setPreBattleFormationCtr = this->fields.setPreBattleFormationCtr;
                    if ( !setPreBattleFormationCtr
                      || (v3 = sub_1BCB134(this->fields.setPreBattleFormationCtr, *(_QWORD *)(*(_QWORD *)v8 + 64LL))) != 0 )
                    {
                      if ( *v9 <= 8u )
                        goto LABEL_69;
                      *(_QWORD *)(v8 + 96) = setPreBattleFormationCtr;
                      sub_1BCAF9C((CGThumbnailListItem_o *)(v8 + 96), (int32_t)setPreBattleFormationCtr, v5, v24);
                      setAdvantageClassAutoCtr = this->fields.setAdvantageClassAutoCtr;
                      if ( !setAdvantageClassAutoCtr
                        || (v3 = sub_1BCB134(this->fields.setAdvantageClassAutoCtr, *(_QWORD *)(*(_QWORD *)v8 + 64LL))) != 0 )
                      {
                        if ( *v9 <= 9u )
                          goto LABEL_69;
                        *(_QWORD *)(v8 + 104) = setAdvantageClassAutoCtr;
                        sub_1BCAF9C((CGThumbnailListItem_o *)(v8 + 104), (int32_t)setAdvantageClassAutoCtr, v5, v26);
                        setAutoSelectPartyCtr = this->fields.setAutoSelectPartyCtr;
                        if ( !setAutoSelectPartyCtr
                          || (v3 = sub_1BCB134(this->fields.setAutoSelectPartyCtr, *(_QWORD *)(*(_QWORD *)v8 + 64LL))) != 0 )
                        {
                          if ( *v9 <= 0xAu )
                            goto LABEL_69;
                          *(_QWORD *)(v8 + 112) = setAutoSelectPartyCtr;
                          sub_1BCAF9C((CGThumbnailListItem_o *)(v8 + 112), (int32_t)setAutoSelectPartyCtr, v5, v28);
                                       ...
                                       *(_QWORD *)(*(_QWORD *)v8 + 64LL))) != 0 )
                          {
                            ...
                            *(_QWORD *)(v8 + 120) = setAutoOpenAutoOrganizationDialogCtr;
                            ...
                            if ( !setTDPlaySpeedCtr
                              || (v3 = sub_1BCB134(this->fields.setTDPlaySpeedCtr, *(_QWORD *)(*(_QWORD *)v8 + 64LL))) != 0 )
                            {
                              if ( *v9 <= 0xCu )
                                goto LABEL_69;
                              *(_QWORD *)(v8 + 128) = setTDPlaySpeedCtr;
                              sub_1BCAF9C((CGThumbnailListItem_o *)(v8 + 128), (int32_t)setTDPlaySpeedCtr, v5, v32);
                                ...
                                *(_QWORD *)(v8 + 136) = setRandomLimitCountCtr;
                                             ...
                                             *(_QWORD *)(*(_QWORD *)v8 + 64LL))) != 0 )
                                {
                                  ...
                                  *(_QWORD *)(v8 + 144) = setRandomLimitCountResetCtr;
                                  ...
                                  if ( !setSvtRandCtr
                                    || (v3 = sub_1BCB134(this->fields.setSvtRandCtr, *(_QWORD *)(*(_QWORD *)v8 + 64LL))) != 0 )
                                  {
                                    if ( *v9 <= 0xFu )
                                      goto LABEL_69;
                                    *(_QWORD *)(v8 + 152) = setSvtRandCtr;
                                    sub_1BCAF9C((CGThumbnailListItem_o *)(v8 + 152), (int32_t)setSvtRandCtr, v5, v38);
                                      ...
                                      *(_QWORD *)(v8 + 160) = setMessageDispCtr;
                                                   ...
                                                   *(_QWORD *)(*(_QWORD *)v8 + 64LL))) != 0 )
                                      {
                                        ...
                                        *(_QWORD *)(v8 + 168) = setNoticeCtr;
                                        sub_1BCAF9C((CGThumbnailListItem_o *)(v8 + 168), (int32_t)setNoticeCtr, v5, v42);
                                                         ...
                                                         *(_QWORD *)(*(_QWORD *)v8 + 64LL))) != 0 )
                                            {
                                              if ( *v9 > 0x14u )
                                              {
                                                *(_QWORD *)(v8 + 192) = setBlackListCtr;
                                                ...
                                                sub_1BCAF9C(p_contentsArray, v8, v51, v52);
                                                return;
                                              }
LABEL_69:
                                              sub_1BCB25C(v3, v4, v5);
                                            }
                                          }
                                        }
                                      }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1760C & 1) == 0 )
  {
    sub_1BCAFF8(&System_Action_GameOptionContentBase__TypeInfo, callback);
    sub_1BCAFF8(&Method_BasicHelper_ForEach_GameOptionContentBase___, v5);
    sub_1BCAFF8(&Method_System_Linq_Enumerable_Where_GameOptionContentBase___, v6);
    sub_1BCAFF8(&System_Func_GameOptionContentBase__bool__TypeInfo, v7);
    sub_1BCAFF8(&OptionManager_TypeInfo, v8);
    sub_1BCAFF8(&SoundManager_TypeInfo, v9);
    sub_1BCAFF8(&Method_SetGameOptionComponent___c__reflectionGameOption_b__40_0__, v10);
    sub_1BCAFF8(&Method_SetGameOptionComponent___c__reflectionGameOption_b__40_1__, v11);
    sub_1BCAFF8(&SetGameOptionComponent___c_TypeInfo, v12);
    byte_4B1760C = 1;
  }
  ...
  if ( !_9__40_0 )
  {
    ...
    _9__40_0 = (System_Func_object__bool__o *)sub_1BCB244(System_Func_GameOptionContentBase__bool__TypeInfo);
    ...
    sub_1BCAF9C((CGThumbnailListItem_o *)&static_fields->__9__40_0, (int32_t)_9__40_0, v18, v19);
  }
  v20 = System_Linq_Enumerable__Where_object_(
          contentsArray,
          (System_Func_TSource__bool__o *)_9__40_0,
          (const MethodInfo_305DC88 *)Method_System_Linq_Enumerable_Where_GameOptionContentBase___);
  ...
  if ( !_9__40_1 )
  {
    ...
    _9__40_1 = (System_Action_object__o *)sub_1BCB244(System_Action_GameOptionContentBase__TypeInfo);
    ...
    sub_1BCAF9C((CGThumbnailListItem_o *)&v25->__9__40_1, (int32_t)_9__40_1, v26, v27);
  }
  BasicHelper__ForEach_object_(
    v22,
    (System_Action_T__o *)_9__40_1,
    (const MethodInfo_3006B3C *)Method_BasicHelper_ForEach_GameOptionContentBase___);
...
void __fastcall SetGameOptionComponent__showGameOption(SetGameOptionComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B17608 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_SetGameOptionComponent__showGameOption_b__36_0__, v4);
    byte_4B17608 = 1;
  }
...
void __fastcall SetGameOptionComponent___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B1760D & 1) == 0 )
  {
    sub_1BCAFF8(&SetGameOptionComponent___c_TypeInfo, v1);
    byte_4B1760D = 1;
  }
  v2 = (Il2CppObject *)sub_1BCB244(SetGameOptionComponent___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  SetGameOptionComponent___c_TypeInfo->static_fields->__9 = (struct SetGameOptionComponent___c_o *)v2;
  sub_1BCAF9C((CGThumbnailListItem_o *)SetGameOptionComponent___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
