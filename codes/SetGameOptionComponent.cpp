        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B2F79 & 1) == 0 )
  {
    sub_B52984(&GameOptionContentBase___TypeInfo);
    byte_42B2F79 = 1;
  }
  p_contentsArray = (BattleServantConfConponent_o *)&this->fields.contentsArray;
  if ( !this->fields.contentsArray )
  {
    v4 = sub_B5299C(GameOptionContentBase___TypeInfo, 20LL);
    if ( !v4 )
      sub_B52A5C(0LL, v5);
    setResolutionOptionCtr = (System_Int32_array **)this->fields.setResolutionOptionCtr;
    v13 = v4;
    if ( !setResolutionOptionCtr
      || (v4 = sub_B52A44(this->fields.setResolutionOptionCtr, *(_QWORD *)(*(_QWORD *)v4 + 64LL))) != 0 )
    {
      if ( !*(_DWORD *)(v13 + 24) )
        goto LABEL_66;
      *(_QWORD *)(v13 + 32) = setResolutionOptionCtr;
      sub_B52920((BattleServantConfConponent_o *)(v13 + 32), setResolutionOptionCtr, v6, v7, v8, v9, v10, v11);
      setSmoothnessCtr = (System_Int32_array **)this->fields.setSmoothnessCtr;
      if ( !setSmoothnessCtr
        || (v4 = sub_B52A44(this->fields.setSmoothnessCtr, *(_QWORD *)(*(_QWORD *)v13 + 64LL))) != 0 )
      {
        if ( *(_DWORD *)(v13 + 24) <= 1u )
          goto LABEL_66;
        *(_QWORD *)(v13 + 40) = setSmoothnessCtr;
        sub_B52920((BattleServantConfConponent_o *)(v13 + 40), setSmoothnessCtr, v14, v15, v16, v17, v18, v19);
        setVolCtr = (System_Int32_array **)this->fields.setVolCtr;
        if ( !setVolCtr || (v4 = sub_B52A44(this->fields.setVolCtr, *(_QWORD *)(*(_QWORD *)v13 + 64LL))) != 0 )
        {
          if ( *(_DWORD *)(v13 + 24) <= 2u )
            goto LABEL_66;
          *(_QWORD *)(v13 + 48) = setVolCtr;
          sub_B52920((BattleServantConfConponent_o *)(v13 + 48), setVolCtr, v21, v22, v23, v24, v25, v26);
          setScenarioTextSpeedCtr = (System_Int32_array **)this->fields.setScenarioTextSpeedCtr;
          if ( !setScenarioTextSpeedCtr
            || (v4 = sub_B52A44(this->fields.setScenarioTextSpeedCtr, *(_QWORD *)(*(_QWORD *)v13 + 64LL))) != 0 )
          {
            if ( *(_DWORD *)(v13 + 24) <= 3u )
              goto LABEL_66;
            *(_QWORD *)(v13 + 56) = setScenarioTextSpeedCtr;
            ...
            if ( !setScenarioCtr
              || (v4 = sub_B52A44(this->fields.setScenarioCtr, *(_QWORD *)(*(_QWORD *)v13 + 64LL))) != 0 )
            {
              if ( *(_DWORD *)(v13 + 24) <= 4u )
                goto LABEL_66;
              *(_QWORD *)(v13 + 64) = setScenarioCtr;
              sub_B52920((BattleServantConfConponent_o *)(v13 + 64), setScenarioCtr, v35, v36, v37, v38, v39, v40);
              setSpoilerProtectionCtr = (System_Int32_array **)this->fields.setSpoilerProtectionCtr;
              if ( !setSpoilerProtectionCtr
                || (v4 = sub_B52A44(this->fields.setSpoilerProtectionCtr, *(_QWORD *)(*(_QWORD *)v13 + 64LL))) != 0 )
              {
                if ( *(_DWORD *)(v13 + 24) <= 5u )
                  goto LABEL_66;
                *(_QWORD *)(v13 + 72) = setSpoilerProtectionCtr;
                ...
                if ( !setSwitchCtr
                  || (v4 = sub_B52A44(this->fields.setSwitchCtr, *(_QWORD *)(*(_QWORD *)v13 + 64LL))) != 0 )
                {
                  if ( *(_DWORD *)(v13 + 24) <= 6u )
                    goto LABEL_66;
                  *(_QWORD *)(v13 + 80) = setSwitchCtr;
                  sub_B52920((BattleServantConfConponent_o *)(v13 + 80), setSwitchCtr, v49, v50, v51, v52, v53, v54);
                  setSwitch2Ctr = (System_Int32_array **)this->fields.setSwitch2Ctr;
                  if ( !setSwitch2Ctr
                    || (v4 = sub_B52A44(this->fields.setSwitch2Ctr, *(_QWORD *)(*(_QWORD *)v13 + 64LL))) != 0 )
                  {
                    if ( *(_DWORD *)(v13 + 24) <= 7u )
                      goto LABEL_66;
                    *(_QWORD *)(v13 + 88) = setSwitch2Ctr;
                    sub_B52920((BattleServantConfConponent_o *)(v13 + 88), setSwitch2Ctr, v56, v57, v58, v59, v60, v61);
                    setPreBattleFormationCtr = (System_Int32_array **)this->fields.setPreBattleFormationCtr;
                    if ( !setPreBattleFormationCtr
                      || (v4 = sub_B52A44(this->fields.setPreBattleFormationCtr, *(_QWORD *)(*(_QWORD *)v13 + 64LL))) != 0 )
                    {
                      if ( *(_DWORD *)(v13 + 24) <= 8u )
                        goto LABEL_66;
                      *(_QWORD *)(v13 + 96) = setPreBattleFormationCtr;
                      ...
                      if ( !setAdvantageClassAutoCtr
                        || (v4 = sub_B52A44(this->fields.setAdvantageClassAutoCtr, *(_QWORD *)(*(_QWORD *)v13 + 64LL))) != 0 )
                      {
                        if ( *(_DWORD *)(v13 + 24) <= 9u )
                          goto LABEL_66;
                        *(_QWORD *)(v13 + 104) = setAdvantageClassAutoCtr;
                        ...
                        if ( !setAutoSelectPartyCtr
                          || (v4 = sub_B52A44(this->fields.setAutoSelectPartyCtr, *(_QWORD *)(*(_QWORD *)v13 + 64LL))) != 0 )
                        {
                          ...
                          *(_QWORD *)(v13 + 112) = setAutoSelectPartyCtr;
                          ...
                          if ( !setTDPlaySpeedCtr
                            || (v4 = sub_B52A44(this->fields.setTDPlaySpeedCtr, *(_QWORD *)(*(_QWORD *)v13 + 64LL))) != 0 )
                          {
                              ...
                              *(_QWORD *)(v13 + 128) = setRandomLimitCountCtr;
                                           ...
                                           *(_QWORD *)(*(_QWORD *)v13 + 64LL))) != 0 )
                              {
                                if ( *(_DWORD *)(v13 + 24) <= 0xDu )
                                  goto LABEL_66;
                                *(_QWORD *)(v13 + 136) = setRandomLimitCountResetCtr;
                                sub_B52920(
                                ...
                                if ( !setSvtRandCtr
                                  || (v4 = sub_B52A44(this->fields.setSvtRandCtr, *(_QWORD *)(*(_QWORD *)v13 + 64LL))) != 0 )
                                {
                                  if ( *(_DWORD *)(v13 + 24) <= 0xEu )
                                    goto LABEL_66;
                                  *(_QWORD *)(v13 + 144) = setSvtRandCtr;
                                  sub_B52920(
                                               ...
                                               *(_QWORD *)(*(_QWORD *)v13 + 64LL))) != 0 )
                                  {
                                    if ( *(_DWORD *)(v13 + 24) <= 0xFu )
                                      goto LABEL_66;
                                    *(_QWORD *)(v13 + 152) = setMessageDispCtr;
                                    sub_B52920(
                                    ...
                                    if ( !setNoticeCtr
                                      || (v4 = sub_B52A44(this->fields.setNoticeCtr, *(_QWORD *)(*(_QWORD *)v13 + 64LL))) != 0 )
                                    {
                                      if ( *(_DWORD *)(v13 + 24) <= 0x10u )
                                        goto LABEL_66;
                                      *(_QWORD *)(v13 + 160) = setNoticeCtr;
                                      sub_B52920(
                                                   ...
                                                   *(_QWORD *)(*(_QWORD *)v13 + 64LL))) != 0 )
                                      {
                                        if ( *(_DWORD *)(v13 + 24) <= 0x11u )
                                          goto LABEL_66;
                                        *(_QWORD *)(v13 + 168) = setPlayOpeningMovieCtr;
                                        sub_B52920(
                                                     ...
                                                     *(_QWORD *)(*(_QWORD *)v13 + 64LL))) != 0 )
                                        {
                                          ...
                                          *(_QWORD *)(v13 + 176) = fullDlCtr;
                                          ...
                                          if ( !setBlackListCtr
                                            || (v4 = sub_B52A44(setBlackListCtr, *(_QWORD *)(*(_QWORD *)v13 + 64LL))) != 0 )
                                          {
                                            if ( *(_DWORD *)(v13 + 24) > 0x13u )
                                            {
                                              *(_QWORD *)(v13 + 184) = setBlackListCtr;
                                              sub_B52920(
                                                (BattleServantConfConponent_o *)(v13 + 184),
                                                setBlackListCtr,
                                                v140,
                                                v141,
                                                v142,
        ...
        const MethodInfo *method)
{
  ...
  SetGameOptionComponent___c_c *v6; // x0
  ...
  SetGameOptionComponent___c_c *v18; // x8
  System_Collections_Generic_IEnumerable_T__o *v19; // x20
  struct SetGameOptionComponent___c_StaticFields *v20; // x9
  ...
  if ( (byte_42B2F7C & 1) == 0 )
  {
    sub_B52984(&Method_System_Action_GameOptionContentBase___ctor__);
    sub_B52984(&System_Action_GameOptionContentBase__TypeInfo);
    sub_B52984(&Method_BasicHelper_ForEach_GameOptionContentBase___);
    sub_B52984(&Method_System_Linq_Enumerable_Where_GameOptionContentBase___);
    sub_B52984(&Method_System_Func_GameOptionContentBase__bool___ctor__);
    sub_B52984(&System_Func_GameOptionContentBase__bool__TypeInfo);
    sub_B52984(&OptionManager_TypeInfo);
    sub_B52984(&SoundManager_TypeInfo);
    sub_B52984(&Method_SetGameOptionComponent___c__reflectionGameOption_b__39_0__);
    sub_B52984(&Method_SetGameOptionComponent___c__reflectionGameOption_b__39_1__);
    sub_B52984(&SetGameOptionComponent___c_TypeInfo);
    byte_42B2F7C = 1;
  }
  contentsArray = (System_Collections_Generic_IEnumerable_TSource__o *)this->fields.contentsArray;
  v6 = SetGameOptionComponent___c_TypeInfo;
  ...
  if ( !_9__39_0 )
  {
    ...
    _9__39_0 = (System_Func_WarBoardManager_WarBoardOnboardSkillTarget__bool__o *)sub_B52A54(System_Func_GameOptionContentBase__bool__TypeInfo);
    System_Func_WarBoardManager_WarBoardOnboardSkillTarget__bool____ctor(
      _9__39_0,
      v9,
      Method_SetGameOptionComponent___c__reflectionGameOption_b__39_0__,
      (const MethodInfo_2BC90BC *)Method_System_Func_GameOptionContentBase__bool___ctor__);
    v10 = SetGameOptionComponent___c_TypeInfo->static_fields;
    v10->__9__39_0 = (struct System_Func_GameOptionContentBase__bool__o *)_9__39_0;
    sub_B52920(
      (BattleServantConfConponent_o *)&v10->__9__39_0,
  ...
  v17 = System_Linq_Enumerable__Where_WarBoardManager_WarBoardOnboardSkillTarget_(
          ...
          (const MethodInfo_1B72CC0 *)Method_System_Linq_Enumerable_Where_GameOptionContentBase___);
  ...
  _9__39_1 = (System_Action_DrawLotsDisplayMessage_DisplayedInGroup_SaveData__o *)v20->__9__39_1;
  if ( !_9__39_1 )
  {
    ...
    _9__39_1 = (System_Action_DrawLotsDisplayMessage_DisplayedInGroup_SaveData__o *)sub_B52A54(System_Action_GameOptionContentBase__TypeInfo);
    System_Action_DrawLotsDisplayMessage_DisplayedInGroup_SaveData____ctor(
      _9__39_1,
      v22,
      Method_SetGameOptionComponent___c__reflectionGameOption_b__39_1__,
      (const MethodInfo_2627780 *)Method_System_Action_GameOptionContentBase___ctor__);
    ...
    sub_B52920(
      (BattleServantConfConponent_o *)&v23->__9__39_1,
  ...
  BasicHelper__ForEach_DrawLotsDisplayMessage_DisplayedInGroup_SaveData_(
    ...
    (const MethodInfo_1A43210 *)Method_BasicHelper_ForEach_GameOptionContentBase___);
...
void __fastcall SetGameOptionComponent__showGameOption(SetGameOptionComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B2F78 & 1) == 0 )
  {
    ...
    sub_B52984(&AtlasManager_TypeInfo);
    sub_B52984(&Method_SetGameOptionComponent__showGameOption_b__35_0__);
    byte_42B2F78 = 1;
  }
  ...
  System_Action___ctor(v5, (Il2CppObject *)this, Method_SetGameOptionComponent__showGameOption_b__35_0__, 0LL);
  if ( (BYTE3(AtlasManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0 && !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
...
void __fastcall SetGameOptionComponent___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_B52A54(SetGameOptionComponent___c_TypeInfo);
  System_Object___ctor(v1, 0LL);
  static_fields = SetGameOptionComponent___c_TypeInfo->static_fields;
  static_fields->__9 = (struct SetGameOptionComponent___c_o *)v1;
