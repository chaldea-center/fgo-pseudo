        ...
        const MethodInfo *method)
{
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.breakPointObjList, (int32_t)v4, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5188B & 1) == 0 )
  {
    sub_1B863B8(&AtlasManager_TypeInfo, *(_QWORD *)&breakPoint);
    ...
    sub_1B863B8(&StringLiteral_17207/*"break_on_boss"*/, v15);
    sub_1B863B8(&StringLiteral_17205/*"break_off_boss"*/, v16);
    sub_1B863B8(&StringLiteral_17206/*"break_on"*/, v17);
    sub_1B863B8(&StringLiteral_17204/*"break_off"*/, v18);
    byte_4A5188B = 1;
  }
  ...
  if ( isEnemy )
    v24 = &StringLiteral_17205/*"break_off_boss"*/;
  else
    v24 = &StringLiteral_17204/*"break_off"*/;
  ...
  {
LABEL_42:
    sub_1B86614(breakPointObjList, *(_QWORD *)&breakPoint);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)breakPointObjList, 1, 0LL);
  if ( isEnemy )
    v27 = &StringLiteral_17207/*"break_on_boss"*/;
  else
    v27 = &StringLiteral_17206/*"break_on"*/;
  ...
  if ( maxbreakPoint >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      breakPointObjList = (int *)UnityEngine_Object__Instantiate_object__50290416(
                                   baseObj,
                                   transform,
      ...
      else
      {
        ...
        *(_QWORD *)(v39 + 32) = v33;
        sub_1B8635C((CGThumbnailListItem_o *)(v39 + 32), (int32_t)v33, v34, v35);
      }
