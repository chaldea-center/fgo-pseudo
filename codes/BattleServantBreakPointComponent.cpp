        ...
        const MethodInfo *method)
{
  ...
  this->fields.breakPointObjList = (struct System_Collections_Generic_List_GameObject__o *)v5;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.breakPointObjList, (int32_t)v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF381 & 1) == 0 )
  {
    sub_1B640C8(&AtlasManager_TypeInfo, *(_QWORD *)&breakPoint);
    ...
    sub_1B640C8(&Method_System_Collections_Generic_List_GameObject__get_Count__, v11);
    sub_1B640C8(&Method_System_Collections_Generic_List_GameObject__get_Item__, v12);
    sub_1B640C8(&Method_UnityEngine_Object_Instantiate_GameObject____75791864, v13);
    sub_1B640C8(&UnityEngine_Object_TypeInfo, v14);
    sub_1B640C8(&StringLiteral_17379/*"break_on_boss"*/, v15);
    sub_1B640C8(&StringLiteral_17377/*"break_off_boss"*/, v16);
    sub_1B640C8(&StringLiteral_17378/*"break_on"*/, v17);
    sub_1B640C8(&StringLiteral_17376/*"break_off"*/, v18);
    byte_49FF381 = 1;
  }
  ...
  if ( isEnemy )
    v24 = &StringLiteral_17377/*"break_off_boss"*/;
  else
    v24 = &StringLiteral_17376/*"break_off"*/;
  ...
  {
LABEL_42:
    sub_1B64324(breakPointObjList);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)breakPointObjList, 1, 0LL);
  if ( isEnemy )
    v27 = &StringLiteral_17379/*"break_on_boss"*/;
  else
    v27 = &StringLiteral_17378/*"break_on"*/;
  ...
  if ( maxbreakPoint >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      breakPointObjList = (int *)UnityEngine_Object__Instantiate_object__49003980(
                                   baseObj,
                                   transform,
      ...
      else
      {
        ...
        *(_QWORD *)(v39 + 32) = v33;
        sub_1B6406C((ServantStatusBattleListViewItem_o *)(v39 + 32), (int32_t)v33, v34, v35);
      }
