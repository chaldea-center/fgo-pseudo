void __fastcall TreasureDvcMaster___ctor(TreasureDvcMaster_o *this, const MethodInfo *method)
{
  if ( (byte_48E3246 & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataMasterBase_TreasureDvcMaster__TreasureDvcEntity__int___ctor__, method);
    byte_48E3246 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    6,
    (const MethodInfo_2FE6A0C *)Method_DataMasterBase_TreasureDvcMaster__TreasureDvcEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3247 & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataManager_GetMasterData_ServantOverwriteMaster___, *(_QWORD *)&svtId);
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_2D62C10 *)Method_DataManager_GetMasterData_ServantOverwriteMaster___)) == 0LL )
  {
