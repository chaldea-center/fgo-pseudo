void __fastcall TreasureDvcMaster___ctor(TreasureDvcMaster_o *this, const MethodInfo *method)
{
  if ( (byte_49BBAD8 & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataMasterBase_TreasureDvcMaster__TreasureDvcEntity__int___ctor__, method);
    byte_49BBAD8 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    6,
    (const MethodInfo_319B678 *)Method_DataMasterBase_TreasureDvcMaster__TreasureDvcEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BBAD9 & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataManager_GetMasterData_ServantOverwriteMaster___, *(_QWORD *)&svtId);
    sub_1B4CF90(&Method_DataMasterBase_TreasureDvcMaster__TreasureDvcEntity__int__GetEntity__, v7);
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_2F01B24 *)Method_DataManager_GetMasterData_ServantOverwriteMaster___)) == 0LL )
  {
