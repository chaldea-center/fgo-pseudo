void BillBoardVariant___ctor(BillBoardVariant_o *this, const MethodInfo *method)
{
  ...
  this->fields.searchCameraName = v9;
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields.searchCameraName, (int32_t)v9, v2, v3, v4, v5, v6, v7);
    ...
    if ( transform )
    {
      ...
      if ( transform )
      {
        ...
        if ( !this->fields.enableRotationY )
        {
          if ( !v10 )
            goto LABEL_25;
          LODWORD(x) = (unsigned int)UnityEngine_Transform__get_position(v10, 0);
        }
        if ( this->fields.enableRotationZ )
        {
          if ( !v10 )
            goto LABEL_25;
          v11 = UnityEngine_Transform__get_localEulerAngles(v10, 0).fields.z;
        }
        else
        {
          v11 = 0.0;
        ...
        if ( this->fields.rotationFlip )
        {
          if ( v10 )
          {
            v13 = UnityEngine_Transform__get_position(v10, 0);
            v14 = UnityEngine_Transform__get_position(v10, 0);
            x = v14.fields.x - (float)(x - v13.fields.x);
            y = v14.fields.y - (float)(y - v13.fields.y);
            z = v14.fields.z - (float)(position.fields.z - v13.fields.z);
            goto LABEL_22;
          }
        }
        else if ( v10 )
...
LABEL_22:
          ...
          v15.fields.y = y;
          v15.fields.z = z;
          UnityEngine_Transform__LookAt_83495412(v10, v15, 0);
          if ( this->fields.enableRotationZ )
            UnityEngine_Transform__Rotate_83494228(v10, 0.0, 0.0, v11, 0);
          return;
        }
      }
    }
