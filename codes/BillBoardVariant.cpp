void BillBoardVariant___ctor(BillBoardVariant_o *this, const MethodInfo *method)
{
  ...
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&this->fields.searchCameraName, (int32_t)v9, v2, v3, v4, v5, v6, v7);
    ...
    if ( transform )
    {
      ...
      if ( transform )
      {
        ...
        if ( this->fields.enableRotationZ )
        {
          if ( !v10 )
            goto LABEL_25;
          localEulerAngles = UnityEngine_Transform__get_localEulerAngles(v10, 0);
        ...
        if ( this->fields.rotationFlip )
        {
          if ( v10 )
          {
            v18 = UnityEngine_Transform__get_position(v10, 0);
            v12 = x - v18.fields.x;
            v13 = y - v18.fields.y;
            v14 = z - v18.fields.z;
            v19 = UnityEngine_Transform__get_position(v10, 0);
            x = v19.fields.x - v12;
            y = v19.fields.y - v13;
            z = v19.fields.z - v14;
            goto LABEL_22;
...
LABEL_22:
          ...
          v20.fields.y = y;
          v20.fields.z = z;
          UnityEngine_Transform__LookAt_83282108(v10, v20, 0);
          if ( this->fields.enableRotationZ )
            UnityEngine_Transform__Rotate_83280924(v10, 0.0, 0.0, v11, 0);
          return;
        }
      }
    }
