...
void __fastcall CoinRoomCoinIconObject__Awake(CoinRoomCoinIconObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_418883C & 1) == 0 )
  {
    sub_B2C35C(&Method_UnityEngine_GameObject_GetComponent_CoinRoomCoinIconDraw___, method);
    byte_418883C = 1;
  }
  ...
  Component_srcLineSprite = (struct CoinRoomCoinIconDraw_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                               dispObject,
                                                               (const MethodInfo_1AA78DC *)Method_UnityEngine_GameObject_GetComponent_CoinRoomCoinIconDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4188842 & 1) == 0 )
  {
    sub_B2C35C(&Method_UnityEngine_GameObject_GetComponent_CoinRoomCoinIconObject___, method);
    byte_4188842 = 1;
  }
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                    DragObject,
                                                    (const MethodInfo_1AA78DC *)Method_UnityEngine_GameObject_GetComponent_CoinRoomCoinIconObject___)) == 0LL) )
  {
        ...
        const MethodInfo *method)
{
  ...
  dragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                             ...
                                             (const MethodInfo_1AA78DC *)Method_UnityEngine_GameObject_GetComponent_CoinRoomCoinIconObject___);
  if ( !dragObject
    || (v16 = (CoinRoomCoinIconObject_o *)dragObject,
        zero = UnityEngine_Vector3__get_zero(0LL),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_418883E & 1) == 0 )
  {
    sub_B2C35C(&CoinRoomCoinIconItem_TypeInfo, *(_QWORD *)&initMode);
    byte_418883E = 1;
  }
...
// local variable allocation has failed, the output may be wrong!
void __fastcall CoinRoomCoinIconObject__Init_26749876(
        CoinRoomCoinIconObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
void __fastcall CoinRoomCoinIconObject__OnClickIcon(CoinRoomCoinIconObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4188849 & 1) == 0 )
  {
    ...
    this = (CoinRoomCoinIconObject_o *)sub_B2C35C(&StringLiteral_9948/*"OnClickIcon"*/, v4);
    byte_4188849 = 1;
  }
    ...
    if ( BYTE4(linkItem[1].fields.sortValue0B) )
    {
      ...
      if ( this )
      {
        UnityEngine_Component__SendMessage(
          (UnityEngine_Component_o *)this,
          (System_String_o *)StringLiteral_9948/*"OnClickIcon"*/,
          (Il2CppObject *)v2,
          0LL);
        return;
      }
...
void __fastcall CoinRoomCoinIconObject__OnPressIcon(CoinRoomCoinIconObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_418884A & 1) == 0 )
  {
    ...
    sub_B2C35C(&StringLiteral_10042/*"OnPressIcon"*/, v3);
    byte_418884A = 1;
  }
  if ( this->fields.linkItem )
  {
    ...
    if ( !manager )
      sub_B2C434(0LL, v4);
    UnityEngine_Component__SendMessage(manager, (System_String_o *)StringLiteral_10042/*"OnPressIcon"*/, (Il2CppObject *)this, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4188840 & 1) == 0 )
  {
    sub_B2C35C(&CoinRoomCoinIconItem_TypeInfo, isInput);
    sub_B2C35C(&UnityEngine_Object_TypeInfo, v5);
    byte_4188840 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4188841 & 1) == 0 )
  {
    sub_B2C35C(&CoinRoomCoinIconItem_TypeInfo, *(_QWORD *)&num);
        ...
        const MethodInfo *method)
{
  ...
  v11 = (CoinRoomCoinIconObject_o *)sub_B2C728(v8);
