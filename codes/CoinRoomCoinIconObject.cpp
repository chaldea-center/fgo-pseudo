...
void __fastcall CoinRoomCoinIconObject__OnClickIcon(CoinRoomCoinIconObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_40F9A2C & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_9916, v4);
    byte_40F9A2C = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem )
  {
    ...
    if ( BYTE4(linkItem[1].fields.sortValue0B) )
    {
      ...
      if ( manager )
      {
        UnityEngine_Component__SendMessage(manager, (System_String_o *)StringLiteral_9916, (Il2CppObject *)this, 0LL);
        return;
      }
LABEL_17:
      sub_B170D4();
...
void __fastcall CoinRoomCoinIconObject__OnPressIcon(CoinRoomCoinIconObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_40F9A2D & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_10010, v3);
    byte_40F9A2D = 1;
  }
  if ( this->fields.linkItem )
  {
    ...
    if ( !manager )
      sub_B170D4();
    UnityEngine_Component__SendMessage(manager, (System_String_o *)StringLiteral_10010, (Il2CppObject *)this, 0LL);
  }
}
