        ...
        const MethodInfo *method)
{
  ...
  PartyOrganizationConfirmCostumeMenu__Close_32159136(this, 0LL, v2);
}


void __fastcall PartyOrganizationConfirmCostumeMenu__Close_32159136(
        PartyOrganizationConfirmCostumeMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_418B684 & 1) == 0 )
  {
    ...
    sub_B2C35C(&Method_PartyOrganizationConfirmCostumeMenu_EndClose__, v10);
    byte_418B684 = 1;
  }
  ...
  System_Action___ctor(v11, (Il2CppObject *)this, Method_PartyOrganizationConfirmCostumeMenu_EndClose__, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_418B685 & 1) == 0 )
  {
    sub_B2C35C(&Method_PartyOrganizationConfirmCostumeMenu_OnClickClose__, method);
    byte_418B685 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationConfirmCostumeMenu_OnClickClose__ + 75) & 2) != 0 )
      v3 = (_QWORD *)sub_B2C364(Method_PartyOrganizationConfirmCostumeMenu_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_418B683 & 1) == 0 )
  {
    ...
    sub_B2C35C(&Method_DataManager_GetMasterData_NpcFollowerMaster___, v13);
    sub_B2C35C(&Method_System_Collections_Generic_List_PartyOrganizationListViewItem__Add__, v14);
    sub_B2C35C(&Method_System_Collections_Generic_List_PartyOrganizationListViewItem___ctor__, v15);
    sub_B2C35C(&System_Collections_Generic_List_PartyOrganizationListViewItem__TypeInfo, v16);
    sub_B2C35C(&LocalizationManager_TypeInfo, v17);
    sub_B2C35C(&Method_PartyOrganizationConfirmCostumeMenu_EndOpen__, v18);
    ...
    sub_B2C35C(&StringLiteral_10246/*"PARTY_ORGANIZATION_CONFIRM_FIXED_COSTUME_CLOSE"*/, v21);
    sub_B2C35C(&StringLiteral_10247/*"PARTY_ORGANIZATION_CONFIRM_FIXED_COSTUME_MESSAGE"*/, v22);
    sub_B2C35C(&StringLiteral_10248/*"PARTY_ORGANIZATION_CONFIRM_FIXED_COSTUME_TITLE"*/, v23);
    byte_418B683 = 1;
  }
  if ( (this->fields.state | 4) == 4 )
  {
    ...
    if ( gameObject )
    {
      ...
      v26 = (System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData__o *)sub_B2C42C(System_Collections_Generic_List_PartyOrganizationListViewItem__TypeInfo);
      ...
      if ( gameObject )
      {
        ...
        if ( questRestrictionInfo )
        {
          if ( gameObject )
          {
            ...
            if ( gameObject )
            {
              if ( this->fields.memberObjectList && v26 )
              {
...
LABEL_24:
                  ...
                  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                             (System_String_o *)StringLiteral_10248/*"PARTY_ORGANIZATION_CONFIRM_FIXED_COSTUME_TITLE"*/,
                                                             0LL);
                  if ( titleLabel )
                  {
                    ...
                    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                               (System_String_o *)StringLiteral_10247/*"PARTY_ORGANIZATION_CONFIRM_FIXED_COSTUME_MESSAGE"*/,
                                                               0LL);
                    if ( item )
                    {
                      v32 = (System_String_o *)gameObject;
                      SvtNameText = (Il2CppObject *)PartyOrganizationListViewItem__get_SvtNameText(item, v25);
                      CostumeName = (Il2CppObject *)PartyOrganizationListViewItem__get_CostumeName(item, v34);
                      ...
                      if ( messageLabel )
                      {
                        ...
                        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                   (System_String_o *)StringLiteral_10246/*"PARTY_ORGANIZATION_CONFIRM_FIXED_COSTUME_CLOSE"*/,
                                                                   0LL);
                        if ( closeLabel )
                        {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_418B680 & 1) == 0 )
  {
    sub_B2C35C(&PartyOrganizationConfirmCostumeMenu_CallbackFunc_TypeInfo, value);
    byte_418B680 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
        ...
        const MethodInfo *method)
{
  ...
  PartyOrganizationConfirmCostumeMenu_CallbackFunc_o *v19; // x8
  __int64 *v20; // x20
  __int64 v21; // x21
  ...
  _DWORD *v30; // x11
  PartyOrganizationConfirmCostumeMenu_CallbackFunc_o *v31; // [xsp+8h] [xbp-38h] BYREF
