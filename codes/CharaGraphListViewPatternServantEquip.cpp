        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDB8F0 & 1) == 0 )
  {
    sub_1C21E38(&Method_BasicHelper_ToIterator_CharaGraphEquipListViewItem___);
    ...
    sub_1C21E38(&System_Func_int__CharaGraphEquipListViewItem__TypeInfo);
    sub_1C21E38(&NetworkManager_TypeInfo);
    sub_1C21E38(&Method_CharaGraphListViewPatternServantEquip___c__DisplayClass2_0__GenerateListViewItem_b__0__);
    sub_1C21E38(&CharaGraphListViewPatternServantEquip___c__DisplayClass2_0_TypeInfo);
    byte_4BDB8F0 = 1;
  }
  svtIdList = 0LL;
  v3 = sub_1C22084(CharaGraphListViewPatternServantEquip___c__DisplayClass2_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v3, 0LL);
  if ( !v3 )
    goto LABEL_14;
  *(_QWORD *)(v3 + 16) = this;
  sub_1C21DDC((PartyOrganizationUtility_o *)(v3 + 16), (int64_t)this, v6, v7, v8, v9, v10, v11);
  Master_object = (UserServantMaster_o *)CharaGraphListViewPatternBase__GetMaster_object_((const MethodInfo_2FA3880 *)Method_CharaGraphListViewPatternBase_GetMaster_UserServantMaster___);
  if ( !Master_object )
    goto LABEL_14;
  ServantEquipList = UserServantMaster__getServantEquipList(Master_object, 0LL);
  *(_QWORD *)(v3 + 24) = ServantEquipList;
  v13 = (__int64 *)(v3 + 24);
  sub_1C21DDC((PartyOrganizationUtility_o *)(v3 + 24), (int64_t)ServantEquipList, v14, v15, v16, v17, v18, v19);
  v20 = CharaGraphListViewPatternBase__GetMaster_object_((const MethodInfo_2FA3880 *)Method_CharaGraphListViewPatternBase_GetMaster_UserDeckMaster___);
...
LABEL_14:
  ...
  v22 = (System_Func_T__TResult__o *)sub_1C22084(System_Func_int__CharaGraphEquipListViewItem__TypeInfo);
  ...
  return (System_Collections_Generic_IEnumerable_CharaGraphListViewItemBase__o *)BasicHelper__ToIterator_object_(
                                                                                   *(_DWORD *)(v21 + 24),
                                                                                   ...
                                                                                   (const MethodInfo_2F9FFA4 *)Method_BasicHelper_ToIterator_CharaGraphEquipListViewItem___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDB8F1 & 1) == 0 )
  {
    this = (CharaGraphListViewPatternServantEquip___c__DisplayClass2_0_o *)sub_1C21E38(&CharaGraphEquipListViewItem_TypeInfo);
    byte_4BDB8F1 = 1;
  }
  ...
  v9 = (CharaGraphEquipListViewItem_o *)sub_1C22084(CharaGraphEquipListViewItem_TypeInfo);
