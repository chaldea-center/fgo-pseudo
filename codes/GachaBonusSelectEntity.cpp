        ...
        const MethodInfo *method)
{
  if ( (byte_4A2E1A7 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataEntityBase_CreateMultiplePK_int__int__int___, *(_QWORD *)&gachaBonusId);
    byte_4A2E1A7 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E1A8 & 1) == 0 )
  {
    sub_1B761C0(&SvtClassAttri_TypeInfo, method);
    sub_1B761C0(&StringLiteral_4987/*"D3"*/, v4);
    byte_4A2E1A8 = 1;
  }
...
LABEL_11:
    ClassId = v5;
    return System_Int32__ToString_62340340((int32_t)&ClassId, (System_String_o *)StringLiteral_4987/*"D3"*/, 0LL);
  }
  if ( !SvtClassAttri_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(SvtClassAttri_TypeInfo);
        ...
        const MethodInfo *method)
{
  if ( (byte_4A2E1A9 & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_17986/*"classId"*/, *(_QWORD *)&defId);
    byte_4A2E1A9 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_17986/*"classId"*/, defId, 0LL);
}