        ...
        const MethodInfo *method)
{
  if ( (byte_4C221D3 & 1) == 0 )
  {
    sub_1C3B764(&Method_DataEntityBase_CreateMultiplePK_int__int__int___, *(_QWORD *)&gachaBonusId);
    byte_4C221D3 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C221D4 & 1) == 0 )
  {
    sub_1C3B764(&SvtClassAttri_TypeInfo, method);
    sub_1C3B764(&StringLiteral_5082/*"DataTable_{0}.NullBits"*/, v4);
    byte_4C221D4 = 1;
  }
...
LABEL_11:
    ClassId = v5;
    return System_Int32__ToString_64174220((int32_t)&ClassId, (System_String_o *)StringLiteral_5082/*"DataTable_{0}.NullBits"*/, 0LL);
  }
  if ( !SvtClassAttri_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(SvtClassAttri_TypeInfo);
        ...
        const MethodInfo *method)
{
  if ( (byte_4C221D5 & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_18341/*"duration"*/, *(_QWORD *)&defId);
    byte_4C221D5 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_18341/*"duration"*/, defId, 0LL);
}