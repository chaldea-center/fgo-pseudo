        ...
        const MethodInfo *method)
{
  if ( (byte_48E2A6F & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataEntityBase_CreateMultiplePK_int__int__int___, *(_QWORD *)&gachaBonusId);
    byte_48E2A6F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E2A70 & 1) == 0 )
  {
    sub_1B00CCC(&SvtClassAttri_TypeInfo, method);
    sub_1B00CCC(&StringLiteral_4934/*"D3"*/, v4);
    byte_48E2A70 = 1;
  }
...
LABEL_11:
    ClassId = v5;
    return System_Int32__ToString_61130888((int32_t)&ClassId, (System_String_o *)StringLiteral_4934/*"D3"*/, 0LL);
  }
  if ( !SvtClassAttri_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(SvtClassAttri_TypeInfo);
        ...
        const MethodInfo *method)
{
  if ( (byte_48E2A71 & 1) == 0 )
  {
    sub_1B00CCC(&StringLiteral_17747/*"classId"*/, *(_QWORD *)&defId);
    byte_48E2A71 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_17747/*"classId"*/, defId, 0LL);
}