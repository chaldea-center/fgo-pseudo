        ...
        const MethodInfo *method)
{
  if ( (byte_4A700D2 & 1) == 0 )
  {
    sub_1B90010(&Method_DataEntityBase_CreateMultiplePK_int__int__int___, *(_QWORD *)&gachaBonusId);
    byte_4A700D2 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A700D3 & 1) == 0 )
  {
    sub_1B90010(&SvtClassAttri_TypeInfo, method);
    sub_1B90010(&StringLiteral_4989/*"D3"*/, v4);
    byte_4A700D3 = 1;
  }
...
LABEL_11:
    ClassId = v5;
    return System_Int32__ToString_62592372((int32_t)&ClassId, (System_String_o *)StringLiteral_4989/*"D3"*/, 0LL);
  }
  if ( !SvtClassAttri_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(SvtClassAttri_TypeInfo);
        ...
        const MethodInfo *method)
{
  if ( (byte_4A700D4 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_18018/*"classId"*/, *(_QWORD *)&defId);
    byte_4A700D4 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_18018/*"classId"*/, defId, 0LL);
}