        ...
        const MethodInfo *method)
{
  if ( (byte_4AB5FB6 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataEntityBase_CreateMultiplePK_int__int__int___, *(_QWORD *)&gachaBonusId);
    byte_4AB5FB6 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB5FB7 & 1) == 0 )
  {
    sub_1BAB41C(&SvtClassAttri_TypeInfo, method);
    sub_1BAB41C(&StringLiteral_4989/*"D3"*/, v4);
    byte_4AB5FB7 = 1;
  }
...
LABEL_11:
    ClassId = v5;
    return System_Int32__ToString_62853408((int32_t)&ClassId, (System_String_o *)StringLiteral_4989/*"D3"*/, 0LL);
  }
  if ( !SvtClassAttri_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(SvtClassAttri_TypeInfo);
        ...
        const MethodInfo *method)
{
  if ( (byte_4AB5FB8 & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_18022/*"classId"*/, *(_QWORD *)&defId);
    byte_4AB5FB8 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_18022/*"classId"*/, defId, 0LL);
}