        ...
        const MethodInfo *method)
{
  if ( (byte_49FED8E & 1) == 0 )
  {
    sub_1B64A00(&Method_DataEntityBase_CreateMultiplePK_int__int__int___, *(_QWORD *)&gachaBonusId);
    byte_49FED8E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FED8F & 1) == 0 )
  {
    sub_1B64A00(&SvtClassAttri_TypeInfo, method);
    sub_1B64A00(&StringLiteral_4966/*"D3"*/, v4);
    byte_49FED8F = 1;
  }
...
LABEL_11:
    ClassId = v5;
    return System_Int32__ToString_62190408((int32_t)&ClassId, (System_String_o *)StringLiteral_4966/*"D3"*/, 0LL);
  }
  if ( !SvtClassAttri_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(SvtClassAttri_TypeInfo);
        ...
        const MethodInfo *method)
{
  if ( (byte_49FED90 & 1) == 0 )
  {
    sub_1B64A00(&StringLiteral_17925/*"classId"*/, *(_QWORD *)&defId);
    byte_49FED90 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_17925/*"classId"*/, defId, 0LL);
}