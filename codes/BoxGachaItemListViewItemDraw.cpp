        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D26AA8 & 1) == 0 )
  {
    ...
    sub_1C94098(&UnityEngine_Object_TypeInfo);
    sub_1C94098(&StringLiteral_19340/*"event_gachabanner_"*/);
    sub_1C94098(&StringLiteral_3001/*"BOX_GACHA_REWARD_NORMAL_TXT"*/);
    sub_1C94098(&StringLiteral_20362/*"icon_event_"*/);
    sub_1C94098(&StringLiteral_3000/*"BOX_GACHA_REWARD_DRAW_TXT"*/);
    sub_1C94098(&StringLiteral_19409/*"event_rewardgacha_"*/);
    byte_4D26AA8 = 1;
  }
  currentBoxGachaId = 0;
  if ( !v5 || !mode )
  ...
  if ( (rareDispImgObj & 1) != 0 && v5->fields.currentEventId >= 1 )
  {
    ...
    if ( bannerId < 1 )
    {
      ...
      v13 = &StringLiteral_19409/*"event_rewardgacha_"*/;
    }
    else
    {
      currentBoxGachaId = bannerId;
      v12 = System_Int32__ToString((int32_t)&currentBoxGachaId, 0);
      v13 = &StringLiteral_19340/*"event_gachabanner_"*/;
    }
    v14 = System_String__Concat_64417744((System_String_o *)*v13, v12, 0);
    if ( !EventRewardRootComponent_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(EventRewardRootComponent_TypeInfo);
    EventRewardRootComponent__setRewardInfoImg(v11, v14, 0);
  }
  v15 = sub_1C942E4(System_Collections_Generic_List_GameObject__TypeInfo);
  ...
  *(_DWORD *)(v15 + 28) = v17;
  ...
  if ( !v18 )
LABEL_89:
    sub_1C942F0(rareDispImgObj, item);
  if ( v18->fields.type == 1 )
  {
      ...
      else
      {
        ...
        if ( v38 && (type = v38->fields.type, type <= 7) && ((1 << type) & 0xC2) != 0 )
        {
          ...
          else
          {
            ...
            *(_DWORD *)(v15 + 24) = v44 + 1;
            *(_QWORD *)(v45 + 32) = item;
            rareDispImgObj = sub_1C9403C(v45 + 32, item);
          }
        ...
        *(_DWORD *)(v15 + 28) = v46 + 1;
        ...
        else
        {
          ...
          *(_DWORD *)(v15 + 24) = v49 + 1;
          *(_QWORD *)(v50 + 32) = item;
          rareDispImgObj = sub_1C9403C(v50 + 32, item);
        }
      }
    }
    else
    {
      ...
      if ( v20 <= 1 )
        v20 = -1;
      ItemIconComponent__SetItemImage_41676908((ItemIconComponent_o *)rareDispImgObj, (int32_t)item, v20, 0);
    }
  }
LABEL_30:
      ...
      if ( rareDispImgObj )
      {
        ...
        if ( rareDispImgObj )
        {
          ...
          if ( v32 )
          {
            ...
            v35 = System_String__Concat_64417744((System_String_o *)StringLiteral_20362/*"icon_event_"*/, v34, 0);
            if ( !EventRewardRootComponent_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(EventRewardRootComponent_TypeInfo);
