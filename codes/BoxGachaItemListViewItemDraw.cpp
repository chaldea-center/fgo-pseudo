        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9BAE & 1) == 0 )
  {
    sub_1BAB41C(&EventRewardRootComponent_TypeInfo, item);
    ...
    sub_1BAB41C(&StringLiteral_19204/*"event_gachabanner_"*/, v14);
    sub_1BAB41C(&StringLiteral_3098/*"BOX_GACHA_REWARD_NORMAL_TXT"*/, v15);
    sub_1BAB41C(&StringLiteral_20174/*"icon_event_"*/, v16);
    sub_1BAB41C(&StringLiteral_3097/*"BOX_GACHA_REWARD_DRAW_TXT"*/, v17);
    sub_1BAB41C(&StringLiteral_19273/*"event_rewardgacha_"*/, v18);
    byte_4AB9BAE = 1;
  }
  currentBoxGachaId = 0;
  if ( !v5 || !mode )
  ...
  if ( ((unsigned __int8)rareDispImgObj & 1) != 0 && v5->fields.currentEventId >= 1 )
  {
    ...
    if ( bannerId < 1 )
    {
      ...
      v25 = &StringLiteral_19273/*"event_rewardgacha_"*/;
    }
    else
    {
      currentBoxGachaId = bannerId;
      v24 = System_Int32__ToString((int32_t)&currentBoxGachaId, 0LL);
      v25 = &StringLiteral_19204/*"event_gachabanner_"*/;
    }
    v26 = System_String__Concat_62048128((System_String_o *)*v25, v24, 0LL);
    if ( !EventRewardRootComponent_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(EventRewardRootComponent_TypeInfo);
    EventRewardRootComponent__setRewardInfoImg(v23, v26, 0LL);
  }
  v27 = sub_1BAB668(System_Collections_Generic_List_GameObject__TypeInfo);
  ...
  *(_DWORD *)(v27 + 28) = v29;
  ...
  if ( !v30 )
LABEL_89:
    sub_1BAB678(rareDispImgObj, item);
  if ( v30->fields.type == 1 )
  {
      ...
      else
      {
        ...
        if ( v59 && (type = v59->fields.type, type <= 7) && ((1 << type) & 0xC2) != 0 )
        {
          ...
          else
          {
            ...
            *(_DWORD *)(v27 + 24) = v67 + 1;
            *(_QWORD *)(v68 + 32) = item;
            sub_1BAB3C0((ServantStatusBattleListViewItem_o *)(v68 + 32), (int32_t)item, v63, v64);
          }
        ...
        *(_DWORD *)(v27 + 28) = v69 + 1;
        ...
        else
        {
          ...
          *(_DWORD *)(v27 + 24) = v72 + 1;
          *(_QWORD *)(v73 + 32) = item;
          sub_1BAB3C0((ServantStatusBattleListViewItem_o *)(v73 + 32), (int32_t)item, v57, v58);
        }
      }
    }
    else
    {
      ...
      if ( v32 <= 1 )
        ...
        v33 = v32;
      ItemIconComponent__SetItemImage_38527100((ItemIconComponent_o *)rareDispImgObj, (int32_t)item, v33, 0LL);
    }
  }
LABEL_31:
  ...
  v36 = LocalizationManager__Get((System_String_o *)StringLiteral_3098/*"BOX_GACHA_REWARD_NORMAL_TXT"*/, 0LL);
  ...
  if ( v5->fields.isDraw )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v42 = LocalizationManager__Get((System_String_o *)StringLiteral_3097/*"BOX_GACHA_REWARD_DRAW_TXT"*/, 0LL);
      ...
      if ( rareDispImgObj )
      {
        ...
        if ( rareDispImgObj )
        {
          ...
          if ( v51 )
          {
            ...
            v54 = System_String__Concat_62048128((System_String_o *)StringLiteral_20174/*"icon_event_"*/, v53, 0LL);
            if ( !EventRewardRootComponent_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(EventRewardRootComponent_TypeInfo);
