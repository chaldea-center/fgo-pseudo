        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB3625 & 1) == 0 )
  {
    sub_1BAB41C(&TestBattleRequestButton__battleRequest_d__4_TypeInfo, *(_QWORD *)&questNo);
    byte_4AB3625 = 1;
  }
  v7 = sub_1BAB668(TestBattleRequestButton__battleRequest_d__4_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB3626 & 1) == 0 )
  {
    sub_1BAB41C(&Method_NetworkManager_getRequest_BattleSetupRequest___, method);
    ...
    sub_1BAB41C(&Method_TestBattleRequestButton_callbackRequest__, v6);
    sub_1BAB41C(&UnityEngine_WaitForEndOfFrame_TypeInfo, v7);
    this = (TestBattleRequestButton__battleRequest_d__4_o *)sub_1BAB41C(&StringLiteral_1/*""*/, v8);
    byte_4AB3626 = 1;
  }
...
LABEL_19:
  ...
  {
    this = (TestBattleRequestButton__battleRequest_d__4_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_378A22C *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    if ( !this )
      goto LABEL_19;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BAB430(&Method_TestBattleRequestButton__battleRequest_d__4_System_Collections_IEnumerator_Reset__);
  sub_1BAB544(v3, v4);
}
