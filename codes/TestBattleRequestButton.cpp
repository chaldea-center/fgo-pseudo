        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B869A & 1) == 0 )
  {
    sub_1B4CF90(&TestBattleRequestButton__battleRequest_d__4_TypeInfo, *(_QWORD *)&questNo);
    byte_49B869A = 1;
  }
  v7 = sub_1B4D1DC(TestBattleRequestButton__battleRequest_d__4_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B869B & 1) == 0 )
  {
    sub_1B4CF90(&Method_NetworkManager_getRequest_BattleSetupRequest___, method);
    ...
    sub_1B4CF90(&Method_TestBattleRequestButton_callbackRequest__, v6);
    sub_1B4CF90(&UnityEngine_WaitForEndOfFrame_TypeInfo, v7);
    this = (TestBattleRequestButton__battleRequest_d__4_o *)sub_1B4CF90(&StringLiteral_1/*""*/, v8);
    byte_49B869B = 1;
  }
...
LABEL_19:
  ...
  {
    this = (TestBattleRequestButton__battleRequest_d__4_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37B4410 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    if ( !this )
      goto LABEL_19;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B4CFA4(&Method_TestBattleRequestButton__battleRequest_d__4_System_Collections_IEnumerator_Reset__);
  sub_1B4D0B8(v3, v4);
}
