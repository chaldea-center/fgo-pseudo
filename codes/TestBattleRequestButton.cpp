        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E01F7 & 1) == 0 )
  {
    sub_1B00CCC(&TestBattleRequestButton__battleRequest_d__4_TypeInfo, *(_QWORD *)&questNo);
    byte_48E01F7 = 1;
  }
  v7 = sub_1B00F18(TestBattleRequestButton__battleRequest_d__4_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E01F8 & 1) == 0 )
  {
    sub_1B00CCC(&Method_NetworkManager_getRequest_BattleSetupRequest___, method);
    ...
    sub_1B00CCC(&Method_TestBattleRequestButton_callbackRequest__, v6);
    sub_1B00CCC(&UnityEngine_WaitForEndOfFrame_TypeInfo, v7);
    this = (TestBattleRequestButton__battleRequest_d__4_o *)sub_1B00CCC(&StringLiteral_1/*""*/, v8);
    byte_48E01F8 = 1;
  }
...
LABEL_19:
  ...
  {
    this = (TestBattleRequestButton__battleRequest_d__4_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_35FBBF0 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    if ( !this )
      goto LABEL_19;
...
LABEL_18:
  v15 = (UnityEngine_WaitForEndOfFrame_o *)sub_1B00F18(UnityEngine_WaitForEndOfFrame_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B00CE0(&Method_TestBattleRequestButton__battleRequest_d__4_System_Collections_IEnumerator_Reset__);
  sub_1B00DF4(v3, v4);
}
