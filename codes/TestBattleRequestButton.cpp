        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4BC44 & 1) == 0 )
  {
    sub_1B863B8(&TestBattleRequestButton__battleRequest_d__4_TypeInfo, *(_QWORD *)&questNo);
    byte_4A4BC44 = 1;
  }
  v7 = sub_1B86604(TestBattleRequestButton__battleRequest_d__4_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4BC45 & 1) == 0 )
  {
    sub_1B863B8(&Method_NetworkManager_getRequest_BattleSetupRequest___, method);
    ...
    sub_1B863B8(&Method_TestBattleRequestButton_callbackRequest__, v6);
    sub_1B863B8(&UnityEngine_WaitForEndOfFrame_TypeInfo, v7);
    this = (TestBattleRequestButton__battleRequest_d__4_o *)sub_1B863B8(&StringLiteral_1/*""*/, v8);
    byte_4A4BC45 = 1;
  }
...
LABEL_19:
  ...
  {
    this = (TestBattleRequestButton__battleRequest_d__4_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3839680 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    if ( !this )
      goto LABEL_19;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B863CC(&Method_TestBattleRequestButton__battleRequest_d__4_System_Collections_IEnumerator_Reset__);
  sub_1B864E0(v3, v4);
}
