        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B64435 & 1) == 0 )
  {
    sub_1BE4ACC(&TestBattleRequestButton__battleRequest_d__4_TypeInfo, *(_QWORD *)&questNo);
    byte_4B64435 = 1;
  }
  v7 = sub_1BE4D18(TestBattleRequestButton__battleRequest_d__4_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B64436 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_NetworkManager_getRequest_BattleSetupRequest___, method);
    ...
    sub_1BE4ACC(&Method_TestBattleRequestButton_callbackRequest__, v6);
    sub_1BE4ACC(&UnityEngine_WaitForEndOfFrame_TypeInfo, v7);
    this = (TestBattleRequestButton__battleRequest_d__4_o *)sub_1BE4ACC(&StringLiteral_1/*""*/, v8);
    byte_4B64436 = 1;
  }
...
LABEL_19:
  ...
  {
    this = (TestBattleRequestButton__battleRequest_d__4_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    if ( !this )
      goto LABEL_19;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BE4AE0(&Method_TestBattleRequestButton__battleRequest_d__4_System_Collections_IEnumerator_Reset__);
  sub_1BE4BF4(v3, v4);
}
