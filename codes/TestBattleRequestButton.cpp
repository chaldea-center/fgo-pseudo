        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFAF8B & 1) == 0 )
  {
    sub_1C2E12C(&TestBattleRequestButton__battleRequest_d__4_TypeInfo, *(_QWORD *)&questNo);
    byte_4BFAF8B = 1;
  }
  v7 = sub_1C2E378(TestBattleRequestButton__battleRequest_d__4_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFAF8C & 1) == 0 )
  {
    sub_1C2E12C(&Method_NetworkManager_getRequest_BattleSetupRequest___, method);
    ...
    sub_1C2E12C(&Method_TestBattleRequestButton_callbackRequest__, v6);
    sub_1C2E12C(&UnityEngine_WaitForEndOfFrame_TypeInfo, v7);
    this = (TestBattleRequestButton__battleRequest_d__4_o *)sub_1C2E12C(&StringLiteral_1/*""*/, v8);
    byte_4BFAF8C = 1;
  }
...
LABEL_19:
  ...
  {
    this = (TestBattleRequestButton__battleRequest_d__4_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38A7F90 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    if ( !this )
      goto LABEL_19;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C2E140(&Method_TestBattleRequestButton__battleRequest_d__4_System_Collections_IEnumerator_Reset__);
  sub_1C2E254(v3, v4);
}
