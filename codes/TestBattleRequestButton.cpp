        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC543 & 1) == 0 )
  {
    sub_1B64A00(&TestBattleRequestButton__battleRequest_d__4_TypeInfo, *(_QWORD *)&questNo);
    byte_49FC543 = 1;
  }
  v7 = sub_1B64C4C(TestBattleRequestButton__battleRequest_d__4_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC544 & 1) == 0 )
  {
    sub_1B64A00(&Method_NetworkManager_getRequest_BattleSetupRequest___, method);
    ...
    sub_1B64A00(&Method_TestBattleRequestButton_callbackRequest__, v6);
    sub_1B64A00(&UnityEngine_WaitForEndOfFrame_TypeInfo, v7);
    this = (TestBattleRequestButton__battleRequest_d__4_o *)sub_1B64A00(&StringLiteral_1/*""*/, v8);
    byte_49FC544 = 1;
  }
...
LABEL_19:
  ...
  {
    this = (TestBattleRequestButton__battleRequest_d__4_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE930 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    if ( !this )
      goto LABEL_19;
...
LABEL_18:
  v15 = (UnityEngine_WaitForEndOfFrame_o *)sub_1B64C4C(UnityEngine_WaitForEndOfFrame_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B64A14(&Method_TestBattleRequestButton__battleRequest_d__4_System_Collections_IEnumerator_Reset__);
  sub_1B64B28(v3, v4);
}
