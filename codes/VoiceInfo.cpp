void VoiceInfo___ctor(VoiceInfo_o *this, const MethodInfo *method)
{
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&v2->fields.overwriteName, 0, v3, v4);
  v2->fields.overwriteNameDefault = 0;
  sub_1C3E508((CGThumbnailListItem_o *)&v2->fields.overwriteNameDefault, 0, v5, v6);
  v2->fields.servantVoiceConds = 0;
  v2 = (VoiceInfo_o *)((char *)v2 + 56);
  v2[-1].fields.servantVoiceConds = 0;
  sub_1C3E508((CGThumbnailListItem_o *)v2, 0, v7, v8);
}