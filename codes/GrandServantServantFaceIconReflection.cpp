        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB0F22 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_16298/*"_PanelWidth"*/);
    sub_1C6BA08(&StringLiteral_16296/*"_PanelSoftnessX"*/);
    byte_4CB0F22 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(panel, 0, 0) )
  {
    ...
    if ( !v9
      ...
      || (x = v9->fields.mClipSoftness.fields.x,
          ...
          UnityEngine_Material__SetFloat(height, (System_String_o *)StringLiteral_16298/*"_PanelWidth"*/, v8 / v11, 0),
          (height = this->fields.reflectionMaterial) == 0) )
    {
LABEL_11:
      sub_1C6BC60(height, v6);
    }
    UnityEngine_Material__SetFloat(height, (System_String_o *)StringLiteral_16296/*"_PanelSoftnessX"*/, (float)(x / v11) * 4.0, 0);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(v4, 0, 0) )
  {
    ...
    *p_reflectionMaterial = 0;
    sub_1C6B9AC(p_reflectionMaterial, 0);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(reflectionMaterial, 0, 0) )
  {
    ...
    sub_1C6B9AC(&this->fields.reflectionMaterial, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB0F1F & 1) == 0 )
  {
    sub_1C6BA08(&Method_UnityEngine_Component_GetComponentInParent_UIPanel___);
  ...
  sub_1C6B9AC(&this->fields.meshRenderer, Component_object);
  ComponentInParent_object = UnityEngine_Component__GetComponentInParent_object_(
                               (UnityEngine_Component_o *)this,
                               1,
                               (const MethodInfo_3132414 *)Method_UnityEngine_Component_GetComponentInParent_UIPanel___);
  this->fields.panel = (struct UIPanel_o *)ComponentInParent_object;
  sub_1C6B9AC(&this->fields.panel, ComponentInParent_object);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C6BA08(&UnityEngine_Object_TypeInfo);
    sub_1C6BA08(&StringLiteral_16128/*"_BackSprite_Mask"*/);
    sub_1C6BA08(&StringLiteral_16126/*"_BackSpriteRect"*/);
    sub_1C6BA08(&StringLiteral_16201/*"_FaceSpriteTexSize"*/);
    sub_1C6BA08(&StringLiteral_16200/*"_FaceSpriteRect"*/);
    sub_1C6BA08(&StringLiteral_16124/*"_BackSprite"*/);
    sub_1C6BA08(&StringLiteral_16125/*"_BackSpriteNGUISize"*/);
    sub_1C6BA08(&StringLiteral_16127/*"_BackSpriteTexSize"*/);
    sub_1C6BA08(&StringLiteral_16270/*"_MySize"*/);
    sub_1C6BA08(&StringLiteral_16263/*"_MaskTex"*/);
    sub_1C6BA08(&StringLiteral_16199/*"_FaceSpriteNGUISize"*/);
    sub_1C6BA08(&StringLiteral_16198/*"_FaceSprite"*/);
    byte_4CB0F21 = 1;
  }
  reflectionMaterial = (UnityEngine_Object_o *)this->fields.reflectionMaterial;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  if ( !UnityEngine_Object__op_Equality(reflectionMaterial, 0, 0) )
  {
    ...
    if ( !UnityEngine_Object__op_Equality(meshRenderer, 0, 0) )
    {
      ...
      UnityEngine_Material__SetTexture(this->fields.reflectionMaterial, (System_String_o *)StringLiteral_16124/*"_BackSprite"*/, v23, 0);
      transform = &this->fields.reflectionMaterial->klass;
      if ( !transform )
        goto LABEL_37;
      UnityEngine_Material__SetTexture(
        (UnityEngine_Material_o *)transform,
        (System_String_o *)StringLiteral_16128/*"_BackSprite_Mask"*/,
        v25,
        0);
      transform = &this->fields.reflectionMaterial->klass;
      if ( !transform )
      ...
      UnityEngine_Material__SetTexture(
        (UnityEngine_Material_o *)transform,
        (System_String_o *)StringLiteral_16198/*"_FaceSprite"*/,
        v26,
        0);
      ...
      UnityEngine_Material__SetVector(
        v27,
        (System_String_o *)StringLiteral_16270/*"_MySize"*/,
      ...
      UnityEngine_Material__SetVector(
        (UnityEngine_Material_o *)transform,
        (System_String_o *)StringLiteral_16126/*"_BackSpriteRect"*/,
        v45,
        0);
      transform = &this->fields.reflectionMaterial->klass;
      if ( !transform )
      ...
      UnityEngine_Material__SetVector(
        (UnityEngine_Material_o *)transform,
        (System_String_o *)StringLiteral_16200/*"_FaceSpriteRect"*/,
        v46,
        0);
      if ( !v23 )
        goto LABEL_37;
      ...
      v47.fields.z = 0.0;
      v47.fields.w = 0.0;
      UnityEngine_Material__SetVector(v29, (System_String_o *)StringLiteral_16127/*"_BackSpriteTexSize"*/, v47, 0);
      if ( !v26 )
        goto LABEL_37;
      ...
      v48.fields.z = 0.0;
      v48.fields.w = 0.0;
      UnityEngine_Material__SetVector(v31, (System_String_o *)StringLiteral_16201/*"_FaceSpriteTexSize"*/, v48, 0);
      transform = &this->fields.backSprite->klass;
      if ( !transform )
        goto LABEL_37;
      ...
      v36 = 0;
      v37 = 0;
      UnityEngine_Material__SetVector(v33, (System_String_o *)StringLiteral_16125/*"_BackSpriteNGUISize"*/, *(UnityEngine_Vector4_o *)&v34, 0);
      ...
      if ( !transform
        ...
        || (v41 = 0,
            ...
            UnityEngine_Material__SetVector(
              v38,
              (System_String_o *)StringLiteral_16199/*"_FaceSpriteNGUISize"*/,
