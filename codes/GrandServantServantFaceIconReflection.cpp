        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C519DA & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_16314/*"_PanelWidth"*/);
    sub_1C3E564(&StringLiteral_16312/*"_PanelSoftnessX"*/);
    byte_4C519DA = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(panel, 0, 0) )
  {
    ...
    if ( !v9
      ...
      || (x = v9->fields.mClipSoftness.fields.x,
          ...
          UnityEngine_Material__SetFloat(height, (System_String_o *)StringLiteral_16314/*"_PanelWidth"*/, v8 / v11, 0),
          (height = this->fields.reflectionMaterial) == 0) )
    {
LABEL_11:
      sub_1C3E7C0(height, v6);
    }
    UnityEngine_Material__SetFloat(height, (System_String_o *)StringLiteral_16312/*"_PanelSoftnessX"*/, (float)(x / v11) * 4.0, 0);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(v4, 0, 0) )
  {
    ...
    *p_reflectionMaterial = 0;
    sub_1C3E508(p_reflectionMaterial, 0);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(reflectionMaterial, 0, 0) )
  {
    ...
    sub_1C3E508(&this->fields.reflectionMaterial, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C519D7 & 1) == 0 )
  {
    sub_1C3E564(&Method_UnityEngine_Component_GetComponentInParent_UIPanel___);
  ...
  sub_1C3E508(&this->fields.meshRenderer, Component_object);
  ComponentInParent_object = UnityEngine_Component__GetComponentInParent_object_(
                               (UnityEngine_Component_o *)this,
                               1,
                               (const MethodInfo_30F0B1C *)Method_UnityEngine_Component_GetComponentInParent_UIPanel___);
  this->fields.panel = (struct UIPanel_o *)ComponentInParent_object;
  sub_1C3E508(&this->fields.panel, ComponentInParent_object);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C3E564(&UnityEngine_Object_TypeInfo);
    sub_1C3E564(&StringLiteral_16145/*"_BackSprite_Mask"*/);
    sub_1C3E564(&StringLiteral_16143/*"_BackSpriteRect"*/);
    sub_1C3E564(&StringLiteral_16218/*"_FaceSpriteTexSize"*/);
    sub_1C3E564(&StringLiteral_16217/*"_FaceSpriteRect"*/);
    sub_1C3E564(&StringLiteral_16141/*"_BackSprite"*/);
    sub_1C3E564(&StringLiteral_16142/*"_BackSpriteNGUISize"*/);
    sub_1C3E564(&StringLiteral_16144/*"_BackSpriteTexSize"*/);
    sub_1C3E564(&StringLiteral_16286/*"_MySize"*/);
    sub_1C3E564(&StringLiteral_16279/*"_MaskTex"*/);
    sub_1C3E564(&StringLiteral_16216/*"_FaceSpriteNGUISize"*/);
    sub_1C3E564(&StringLiteral_16215/*"_FaceSprite"*/);
    byte_4C519D9 = 1;
  }
  reflectionMaterial = (UnityEngine_Object_o *)this->fields.reflectionMaterial;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  if ( !UnityEngine_Object__op_Equality(reflectionMaterial, 0, 0) )
  {
    ...
    if ( !UnityEngine_Object__op_Equality(meshRenderer, 0, 0) )
    {
      ...
      UnityEngine_Material__SetTexture(this->fields.reflectionMaterial, (System_String_o *)StringLiteral_16141/*"_BackSprite"*/, v23, 0);
      transform = &this->fields.reflectionMaterial->klass;
      if ( !transform )
        goto LABEL_37;
      UnityEngine_Material__SetTexture(
        (UnityEngine_Material_o *)transform,
        (System_String_o *)StringLiteral_16145/*"_BackSprite_Mask"*/,
        v25,
        0);
      transform = &this->fields.reflectionMaterial->klass;
      if ( !transform )
      ...
      UnityEngine_Material__SetTexture(
        (UnityEngine_Material_o *)transform,
        (System_String_o *)StringLiteral_16215/*"_FaceSprite"*/,
        v26,
        0);
      ...
      UnityEngine_Material__SetVector(
        v27,
        (System_String_o *)StringLiteral_16286/*"_MySize"*/,
      ...
      UnityEngine_Material__SetVector(
        (UnityEngine_Material_o *)transform,
        (System_String_o *)StringLiteral_16143/*"_BackSpriteRect"*/,
        v45,
        0);
      transform = &this->fields.reflectionMaterial->klass;
      if ( !transform )
      ...
      UnityEngine_Material__SetVector(
        (UnityEngine_Material_o *)transform,
        (System_String_o *)StringLiteral_16217/*"_FaceSpriteRect"*/,
        v46,
        0);
      if ( !v23 )
        goto LABEL_37;
      ...
      v47.fields.z = 0.0;
      v47.fields.w = 0.0;
      UnityEngine_Material__SetVector(v29, (System_String_o *)StringLiteral_16144/*"_BackSpriteTexSize"*/, v47, 0);
      if ( !v26 )
        goto LABEL_37;
      ...
      v48.fields.z = 0.0;
      v48.fields.w = 0.0;
      UnityEngine_Material__SetVector(v31, (System_String_o *)StringLiteral_16218/*"_FaceSpriteTexSize"*/, v48, 0);
      transform = &this->fields.backSprite->klass;
      if ( !transform )
        goto LABEL_37;
      ...
      v36 = 0;
      v37 = 0;
      UnityEngine_Material__SetVector(v33, (System_String_o *)StringLiteral_16142/*"_BackSpriteNGUISize"*/, *(UnityEngine_Vector4_o *)&v34, 0);
      ...
      if ( !transform
        ...
        || (v41 = 0,
            ...
            UnityEngine_Material__SetVector(
              v38,
              (System_String_o *)StringLiteral_16216/*"_FaceSpriteNGUISize"*/,
