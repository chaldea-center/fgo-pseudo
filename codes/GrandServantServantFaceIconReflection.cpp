        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFCDE4 & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_16156/*"_PanelWidth"*/, v3);
    sub_1BC3008(&StringLiteral_16154/*"_PanelSoftnessX"*/, v4);
    byte_4AFCDE4 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(panel, 0LL, 0LL) )
  {
    ...
    if ( !v11
      ...
      || (x = v11->fields.mClipSoftness.fields.x,
          ...
          UnityEngine_Material__SetFloat(height, (System_String_o *)StringLiteral_16156/*"_PanelWidth"*/, v10 / v13, 0LL),
          (height = this->fields.reflectionMaterial) == 0LL) )
    {
LABEL_11:
      sub_1BC3264(height, v8);
    }
    UnityEngine_Material__SetFloat(height, (System_String_o *)StringLiteral_16154/*"_PanelSoftnessX"*/, (float)(x / v13) * 4.0, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(v4, 0LL, 0LL) )
  {
    ...
    *p_reflectionMaterial = 0LL;
    sub_1BC2FAC(p_reflectionMaterial);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(reflectionMaterial, 0LL, 0LL) )
  {
    ...
    v6 = (UnityEngine_Material_o *)sub_1BC3254(UnityEngine_Material_TypeInfo);
    UnityEngine_Material___ctor(v6, reflectionShader, 0LL);
    this->fields.reflectionMaterial = v6;
    sub_1BC2FAC(&this->fields.reflectionMaterial);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFCDE1 & 1) == 0 )
  {
    sub_1BC3008(&Method_UnityEngine_Component_GetComponentInParent_UIPanel___, method);
    sub_1BC3008(&Method_UnityEngine_Component_GetComponent_MeshRenderer___, v3);
    byte_4AFCDE1 = 1;
  }
  ...
  sub_1BC2FAC(&this->fields.meshRenderer);
  this->fields.panel = (struct UIPanel_o *)UnityEngine_Component__GetComponentInParent_object_(
                                             (UnityEngine_Component_o *)this,
                                             1,
                                             (const MethodInfo_2FF8F10 *)Method_UnityEngine_Component_GetComponentInParent_UIPanel___);
  sub_1BC2FAC(&this->fields.panel);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BC3008(&UnityEngine_Object_TypeInfo, method);
    sub_1BC3008(&StringLiteral_15987/*"_BackSprite_Mask"*/, v3);
    sub_1BC3008(&StringLiteral_15985/*"_BackSpriteRect"*/, v4);
    sub_1BC3008(&StringLiteral_16060/*"_FaceSpriteTexSize"*/, v5);
    sub_1BC3008(&StringLiteral_16059/*"_FaceSpriteRect"*/, v6);
    sub_1BC3008(&StringLiteral_15983/*"_BackSprite"*/, v7);
    sub_1BC3008(&StringLiteral_15984/*"_BackSpriteNGUISize"*/, v8);
    sub_1BC3008(&StringLiteral_15986/*"_BackSpriteTexSize"*/, v9);
    sub_1BC3008(&StringLiteral_16128/*"_MySize"*/, v10);
    sub_1BC3008(&StringLiteral_16121/*"_MaskTex"*/, v11);
    sub_1BC3008(&StringLiteral_16058/*"_FaceSpriteNGUISize"*/, v12);
    sub_1BC3008(&StringLiteral_16057/*"_FaceSprite"*/, v13);
    byte_4AFCDE3 = 1;
  }
  reflectionMaterial = (UnityEngine_Object_o *)this->fields.reflectionMaterial;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  if ( !UnityEngine_Object__op_Equality(reflectionMaterial, 0LL, 0LL) )
  {
    ...
    if ( !UnityEngine_Object__op_Equality(meshRenderer, 0LL, 0LL) )
    {
      ...
      UnityEngine_Material__SetTexture(
        ...
        (System_String_o *)StringLiteral_15983/*"_BackSprite"*/,
        v34,
        0LL);
      ...
      UnityEngine_Material__SetTexture(
        (UnityEngine_Material_o *)transform,
        (System_String_o *)StringLiteral_15987/*"_BackSprite_Mask"*/,
        v36,
        0LL);
      transform = this->fields.reflectionMaterial;
      if ( !transform )
      ...
      UnityEngine_Material__SetTexture(
        (UnityEngine_Material_o *)transform,
        (System_String_o *)StringLiteral_16057/*"_FaceSprite"*/,
        v37,
        0LL);
      ...
      *(UnityEngine_Vector3_o *)&v39 = UnityEngine_Transform__get_localScale((UnityEngine_Transform_o *)transform, 0LL);
      if ( !v38 )
        goto LABEL_37;
      v42 = 0;
      UnityEngine_Material__SetVector(v38, (System_String_o *)StringLiteral_16128/*"_MySize"*/, *(UnityEngine_Vector4_o *)&v39, 0LL);
      transform = this->fields.reflectionMaterial;
      if ( !transform )
        goto LABEL_37;
      ...
      UnityEngine_Material__SetVector(
        (UnityEngine_Material_o *)transform,
        (System_String_o *)StringLiteral_15985/*"_BackSpriteRect"*/,
        v58,
        0LL);
      transform = this->fields.reflectionMaterial;
      if ( !transform )
      ...
      UnityEngine_Material__SetVector(
        (UnityEngine_Material_o *)transform,
        (System_String_o *)StringLiteral_16059/*"_FaceSpriteRect"*/,
        v59,
        0LL);
      if ( !v34 )
        goto LABEL_37;
      ...
      v60.fields.z = 0.0;
      v60.fields.w = 0.0;
      UnityEngine_Material__SetVector(v43, (System_String_o *)StringLiteral_15986/*"_BackSpriteTexSize"*/, v60, 0LL);
      if ( !v37 )
        goto LABEL_37;
      ...
      v61.fields.z = 0.0;
      v61.fields.w = 0.0;
      UnityEngine_Material__SetVector(v45, (System_String_o *)StringLiteral_16060/*"_FaceSpriteTexSize"*/, v61, 0LL);
      transform = this->fields.backSprite;
      if ( !transform )
        goto LABEL_37;
      ...
      v50 = 0;
      v51 = 0;
      UnityEngine_Material__SetVector(v47, (System_String_o *)StringLiteral_15984/*"_BackSpriteNGUISize"*/, *(UnityEngine_Vector4_o *)&v48, 0LL);
      ...
      if ( !transform
        ...
        || (v55 = 0,
            ...
            UnityEngine_Material__SetVector(
              v52,
              (System_String_o *)StringLiteral_16058/*"_FaceSpriteNGUISize"*/,
