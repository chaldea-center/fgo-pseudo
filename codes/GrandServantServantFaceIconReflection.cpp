        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3DC5A & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_16304/*"_PanelWidth"*/);
    sub_1C37058(&StringLiteral_16302/*"_PanelSoftnessX"*/);
    byte_4C3DC5A = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(panel, 0, 0) )
  {
    ...
    if ( !v8
      ...
      || (x = v8->fields.mClipSoftness.fields.x,
          ...
          UnityEngine_Material__SetFloat(height, (System_String_o *)StringLiteral_16304/*"_PanelWidth"*/, v7 / v10, 0),
          (height = this->fields.reflectionMaterial) == 0) )
    {
LABEL_11:
      sub_1C372B4(height);
    }
    UnityEngine_Material__SetFloat(height, (System_String_o *)StringLiteral_16302/*"_PanelSoftnessX"*/, (float)(x / v10) * 4.0, 0);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(v4, 0, 0) )
  {
    ...
    *p_reflectionMaterial = 0;
    sub_1C36FFC(p_reflectionMaterial, 0);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(reflectionMaterial, 0, 0) )
  {
    ...
    sub_1C36FFC(&this->fields.reflectionMaterial, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3DC57 & 1) == 0 )
  {
    sub_1C37058(&Method_UnityEngine_Component_GetComponentInParent_UIPanel___);
  ...
  sub_1C36FFC(&this->fields.meshRenderer, Component_object);
  ComponentInParent_object = UnityEngine_Component__GetComponentInParent_object_(
                               (UnityEngine_Component_o *)this,
                               1,
                               (const MethodInfo_30DED04 *)Method_UnityEngine_Component_GetComponentInParent_UIPanel___);
  this->fields.panel = (struct UIPanel_o *)ComponentInParent_object;
  sub_1C36FFC(&this->fields.panel, ComponentInParent_object);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C37058(&UnityEngine_Object_TypeInfo);
    sub_1C37058(&StringLiteral_16135/*"_BackSprite_Mask"*/);
    sub_1C37058(&StringLiteral_16133/*"_BackSpriteRect"*/);
    sub_1C37058(&StringLiteral_16208/*"_FaceSpriteTexSize"*/);
    sub_1C37058(&StringLiteral_16207/*"_FaceSpriteRect"*/);
    sub_1C37058(&StringLiteral_16131/*"_BackSprite"*/);
    sub_1C37058(&StringLiteral_16132/*"_BackSpriteNGUISize"*/);
    sub_1C37058(&StringLiteral_16134/*"_BackSpriteTexSize"*/);
    sub_1C37058(&StringLiteral_16276/*"_MySize"*/);
    sub_1C37058(&StringLiteral_16269/*"_MaskTex"*/);
    sub_1C37058(&StringLiteral_16206/*"_FaceSpriteNGUISize"*/);
    sub_1C37058(&StringLiteral_16205/*"_FaceSprite"*/);
    byte_4C3DC59 = 1;
  }
  reflectionMaterial = (UnityEngine_Object_o *)this->fields.reflectionMaterial;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  if ( !UnityEngine_Object__op_Equality(reflectionMaterial, 0, 0) )
  {
    ...
    if ( !UnityEngine_Object__op_Equality(meshRenderer, 0, 0) )
    {
      ...
      UnityEngine_Material__SetTexture(this->fields.reflectionMaterial, (System_String_o *)StringLiteral_16131/*"_BackSprite"*/, v22, 0);
      ...
      UnityEngine_Material__SetVector(
        v26,
        (System_String_o *)StringLiteral_16276/*"_MySize"*/,
      ...
      v46.fields.z = 0.0;
      v46.fields.w = 0.0;
      UnityEngine_Material__SetVector(v28, (System_String_o *)StringLiteral_16134/*"_BackSpriteTexSize"*/, v46, 0);
      if ( !v25 )
        goto LABEL_37;
      ...
      v47.fields.z = 0.0;
      v47.fields.w = 0.0;
      UnityEngine_Material__SetVector(v30, (System_String_o *)StringLiteral_16208/*"_FaceSpriteTexSize"*/, v47, 0);
      transform = &this->fields.backSprite->klass;
      if ( !transform )
        goto LABEL_37;
      ...
      v35 = 0;
      v36 = 0;
      UnityEngine_Material__SetVector(v32, (System_String_o *)StringLiteral_16132/*"_BackSpriteNGUISize"*/, *(UnityEngine_Vector4_o *)&v33, 0);
