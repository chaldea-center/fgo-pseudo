void __fastcall EventUpValIconComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B1B924 & 1) == 0 )
  {
    sub_1BCAFF8(&EventUpValIconComponent_TypeInfo, v1);
    byte_4B1B924 = 1;
  }
...
void __fastcall EventUpValIconComponent__Clear(EventUpValIconComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.eventUpValItemList, 0, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B922 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_System_Array_IndexOf_int___, *(_QWORD *)&equipSvtId);
  ...
  Instance = DataManager__GetMaster_object_((const MethodInfo_301AA50 *)Method_DataManager_GetMaster_SkillLvMaster___);
  if ( !Master_object
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B91E & 1) == 0 )
  {
    sub_1BCAFF8(&int___TypeInfo, eventUpValItemList);
    byte_4B1B91E = 1;
  }
  v11 = (System_Int32_array *)sub_1BCB0A0(int___TypeInfo, 1LL);
  if ( !v11 )
    sub_1BCB254(0LL, v12);
  if ( !v11->max_length )
    sub_1BCB25C(v11, v12, v11);
  v11->m_Items[1] = equipSvtId;
  EventUpValIconComponent__Set_40070448(this, eventUpValItemList, v11, servantId, servantRarity, v13);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B920 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_SingletonMonoBehaviour_SwitchParameterDisplayManager__get_Instance__, *(_QWORD *)&count);
    byte_4B1B920 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B921 & 1) == 0 )
  {
    sub_1BCAFF8(&AtlasManager_TypeInfo, *(_QWORD *)&num);
    sub_1BCAFF8(&Method_System_Linq_Enumerable_All_int___, v5);
    sub_1BCAFF8(&EventUpValIconComponent_TypeInfo, v6);
    ...
    sub_1BCAFF8(&Method_EventUpValIconComponent___c__DisplayClass24_0__SetParam_b__0__, v10);
    sub_1BCAFF8(&EventUpValIconComponent___c__DisplayClass24_0_TypeInfo, v11);
    sub_1BCAFF8(&StringLiteral_19045/*"event_logo_mini_"*/, v12);
    byte_4B1B921 = 1;
  }
  v58 = 0;
  v13 = sub_1BCB244(EventUpValIconComponent___c__DisplayClass24_0_TypeInfo);
  ...
  *(_QWORD *)(v13 + 24) = v21;
  v22 = (__int64 *)(v13 + 24);
  sub_1BCAF9C((CGThumbnailListItem_o *)(v13 + 24), (int32_t)v21, (int32_t)v18, v19);
...
LABEL_21:
  ...
  if ( !*(_BYTE *)(v25 + 165) )
  {
    ...
    if ( !byte_4B16196 )
    {
      gameObject = sub_1BCAFF8(&UnityEngine_Vector3_TypeInfo, messageMaxWidth);
      byte_4B16196 = 1;
    }
    if ( !v43 )
      goto LABEL_106;
...
LABEL_31:
  ...
  *(UnityEngine_Vector3_o *)&v29 = UnityEngine_Transform__get_localPosition((UnityEngine_Transform_o *)gameObject, 0LL);
  ...
  if ( UnityEngine_Object__op_Inequality(eventLogoSprite, 0LL, 0LL) )
  {
    ...
    v51 = System_String__Concat_62450424((System_String_o *)StringLiteral_19045/*"event_logo_mini_"*/, v50, 0LL);
  ...
  if ( !equipSvtIds )
LABEL_106:
    sub_1BCB254(gameObject, messageMaxWidth);
  max_length = equipSvtIds->max_length;
  if ( max_length >= 2 )
  {
    v57 = (System_Func_int__bool__o *)sub_1BCB244(System_Func_int__bool__TypeInfo);
  ...
  if ( !max_length )
LABEL_107:
    sub_1BCB25C(gameObject, messageMaxWidth, v18);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventUpValIconComponent__Set_40070448(
        EventUpValIconComponent_o *this,
        EventMargeItemUpValInfo_array *eventUpValItemList,
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BCAFF8(&int___TypeInfo, eventUpValItemList);
    sub_1BCAFF8(&Method_SingletonMonoBehaviour_SwitchParameterDisplayManager__get_Instance__, v11);
    byte_4B1B91F = 1;
  }
  ...
  if ( eventUpValItemList )
  {
    ...
    if ( !v8 || !*(_QWORD *)&v8->max_length )
    {
      ...
      if ( !LODWORD(Instance[1].monitor) )
        sub_1BCB25C(Instance, v16, v13);
      LODWORD(Instance[2].klass) = -1;
    }
    this->fields.equipSvtIds = v8;
    sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.equipSvtIds, (int32_t)v8, v13, v14);
    Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38F8AD8 *)Method_SingletonMonoBehaviour_SwitchParameterDisplayManager__get_Instance__);
    if ( Instance )
    {
...
LABEL_13:
  ...
  this->fields.eventUpValItemList = 0LL;
  sub_1BCAF9C((CGThumbnailListItem_o *)p_eventUpValItemList, 0, (int32_t)equipSvtIds, *(const MethodInfo **)&servantId);
