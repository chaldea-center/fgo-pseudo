void __fastcall WarAddEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A70DB3 & 1) == 0 )
  {
    sub_1B90010(&WarAddEntity_TypeInfo, v1);
    sub_1B90010(&StringLiteral_17193/*"bgChangeEffectTime"*/, v4);
    sub_1B90010(&StringLiteral_17194/*"bgChangeEffectType"*/, v5);
    sub_1B90010(&StringLiteral_19168/*"eventTowerId"*/, v6);
    byte_4A70DB3 = 1;
  }
  WarAddEntity_TypeInfo->static_fields->BG_CHANGE_TYPE_KEY = (struct System_String_o *)StringLiteral_17194/*"bgChangeEffectType"*/;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)WarAddEntity_TypeInfo->static_fields, StringLiteral_17194/*"bgChangeEffectType"*/, v2, v3);
  v7 = StringLiteral_17193/*"bgChangeEffectTime"*/;
  static_fields = WarAddEntity_TypeInfo->static_fields;
  static_fields->BG_CHANGE_TIME_KEY = (struct System_String_o *)StringLiteral_17193/*"bgChangeEffectTime"*/;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&static_fields->BG_CHANGE_TIME_KEY, v7, v9, v10);
  v11 = StringLiteral_19168/*"eventTowerId"*/;
  v12 = WarAddEntity_TypeInfo->static_fields;
  v12->EVENT_TOWER_ID = (struct System_String_o *)StringLiteral_19168/*"eventTowerId"*/;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&v12->EVENT_TOWER_ID, v11, v13, v14);
}
...
System_String_o *__fastcall WarAddEntity__CreatePrimaryKey(WarAddEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A70DAE & 1) == 0 )
  {
    sub_1B90010(&WarAddEntity_TypeInfo, method);
    byte_4A70DAE = 1;
  }
...
bool __fastcall WarAddEntity__HasBGChange(WarAddEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A70DB0 & 1) == 0 )
  {
    ...
    sub_1B90010(&WarAddEntity_TypeInfo, v3);
    byte_4A70DB0 = 1;
  }
