void __fastcall WarAddEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FFA45 & 1) == 0 )
  {
    sub_1B64A00(&WarAddEntity_TypeInfo, v1);
    sub_1B64A00(&StringLiteral_17103/*"bgChangeEffectTime"*/, v4);
    sub_1B64A00(&StringLiteral_17104/*"bgChangeEffectType"*/, v5);
    sub_1B64A00(&StringLiteral_19071/*"eventTowerId"*/, v6);
    byte_49FFA45 = 1;
  }
  WarAddEntity_TypeInfo->static_fields->BG_CHANGE_TYPE_KEY = (struct System_String_o *)StringLiteral_17104/*"bgChangeEffectType"*/;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)WarAddEntity_TypeInfo->static_fields, StringLiteral_17104/*"bgChangeEffectType"*/, v2, v3);
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&static_fields->BG_CHANGE_TIME_KEY, v7, v9, v10);
  v11 = StringLiteral_19071/*"eventTowerId"*/;
  v12 = WarAddEntity_TypeInfo->static_fields;
  v12->EVENT_TOWER_ID = (struct System_String_o *)StringLiteral_19071/*"eventTowerId"*/;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&v12->EVENT_TOWER_ID, v11, v13, v14);
}
...
System_String_o *__fastcall WarAddEntity__CreatePrimaryKey(WarAddEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FFA40 & 1) == 0 )
  {
    sub_1B64A00(&WarAddEntity_TypeInfo, method);
    byte_49FFA40 = 1;
  }
...
bool __fastcall WarAddEntity__HasBGChange(WarAddEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FFA42 & 1) == 0 )
  {
    ...
    sub_1B64A00(&WarAddEntity_TypeInfo, v3);
    byte_49FFA42 = 1;
  }
