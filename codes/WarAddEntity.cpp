void __fastcall WarAddEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB6CA7 & 1) == 0 )
  {
    sub_1BAB41C(&WarAddEntity_TypeInfo, v1);
    sub_1BAB41C(&StringLiteral_17201/*"bgChangeEffectTime"*/, v4);
    sub_1BAB41C(&StringLiteral_17202/*"bgChangeEffectType"*/, v5);
    sub_1BAB41C(&StringLiteral_19171/*"eventTowerId"*/, v6);
    byte_4AB6CA7 = 1;
  }
  WarAddEntity_TypeInfo->static_fields->BG_CHANGE_TYPE_KEY = (struct System_String_o *)StringLiteral_17202/*"bgChangeEffectType"*/;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)WarAddEntity_TypeInfo->static_fields, StringLiteral_17202/*"bgChangeEffectType"*/, v2, v3);
  v7 = StringLiteral_17201/*"bgChangeEffectTime"*/;
  static_fields = WarAddEntity_TypeInfo->static_fields;
  static_fields->BG_CHANGE_TIME_KEY = (struct System_String_o *)StringLiteral_17201/*"bgChangeEffectTime"*/;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&static_fields->BG_CHANGE_TIME_KEY, v7, v9, v10);
  v11 = StringLiteral_19171/*"eventTowerId"*/;
  v12 = WarAddEntity_TypeInfo->static_fields;
  v12->EVENT_TOWER_ID = (struct System_String_o *)StringLiteral_19171/*"eventTowerId"*/;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&v12->EVENT_TOWER_ID, v11, v13, v14);
}
...
System_String_o *__fastcall WarAddEntity__CreatePrimaryKey(WarAddEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB6CA2 & 1) == 0 )
  {
    sub_1BAB41C(&WarAddEntity_TypeInfo, method);
    byte_4AB6CA2 = 1;
  }
...
bool __fastcall WarAddEntity__HasBGChange(WarAddEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB6CA4 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&WarAddEntity_TypeInfo, v3);
    byte_4AB6CA4 = 1;
  }
