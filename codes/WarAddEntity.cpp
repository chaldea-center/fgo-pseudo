void __fastcall WarAddEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A5C0A4 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_17168/*"bgChangeEffectTime"*/);
    sub_1B885B0(&StringLiteral_17169/*"bgChangeEffectType"*/);
    sub_1B885B0(&StringLiteral_19141/*"eventTowerId"*/);
    byte_4A5C0A4 = 1;
  }
  WarAddEntity_TypeInfo->static_fields->BG_CHANGE_TYPE_KEY = (struct System_String_o *)StringLiteral_17169/*"bgChangeEffectType"*/;
  sub_1B88554((ServantStatusBattleListViewItem_o *)WarAddEntity_TypeInfo->static_fields, StringLiteral_17169/*"bgChangeEffectType"*/, v1, v2);
  v3 = StringLiteral_17168/*"bgChangeEffectTime"*/;
  static_fields = WarAddEntity_TypeInfo->static_fields;
  static_fields->BG_CHANGE_TIME_KEY = (struct System_String_o *)StringLiteral_17168/*"bgChangeEffectTime"*/;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&static_fields->BG_CHANGE_TIME_KEY, v3, v5, v6);
  v7 = StringLiteral_19141/*"eventTowerId"*/;
  v8 = WarAddEntity_TypeInfo->static_fields;
  v8->EVENT_TOWER_ID = (struct System_String_o *)StringLiteral_19141/*"eventTowerId"*/;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v8->EVENT_TOWER_ID, v7, v9, v10);
}
