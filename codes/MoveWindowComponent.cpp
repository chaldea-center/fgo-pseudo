...
void __fastcall MoveWindowComponent__closeWindow(MoveWindowComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4D982 & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_22085/*"onCloseComplete"*/, v7);
    sub_1B863B8(&StringLiteral_22416/*"position"*/, v8);
    sub_1B863B8(&StringLiteral_20613/*"isLocal"*/, v9);
  ...
  if ( !v19
    ...
    || (((void (__fastcall *)(struct System_Collections_Hashtable_o *, __int64, __int64, Il2CppMethodPointer))table->klass->vtable._22_Add.method)(
          ...
          StringLiteral_22085/*"onCloseComplete"*/,
...
LABEL_11:
  ...
  iTween__MoveTo_61282740(v29, v28, 0LL);
}
...
void __fastcall MoveWindowComponent__openWindow(MoveWindowComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4D981 & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_22097/*"onOpenComplete"*/, v5);
    sub_1B863B8(&StringLiteral_23770/*"time"*/, v6);
    sub_1B863B8(&StringLiteral_22416/*"position"*/, v7);
    sub_1B863B8(&StringLiteral_20613/*"isLocal"*/, v8);
...
LABEL_11:
  ...
  if ( !iTween_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(iTween_TypeInfo);
  iTween__MoveTo_61282740(v27, v26, 0LL);
}
