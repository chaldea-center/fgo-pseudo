...
void __fastcall MoveWindowComponent__closeWindow(MoveWindowComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2D471 & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_22240/*"onCloseComplete"*/, v7);
    sub_1B761C0(&StringLiteral_22563/*"position"*/, v8);
    sub_1B761C0(&StringLiteral_20791/*"isLocal"*/, v9);
  ...
  if ( !v19
    ...
    || (((void (__fastcall *)(struct System_Collections_Hashtable_o *, __int64, __int64, Il2CppMethodPointer))table->klass->vtable._23_Add.method)(
          ...
          StringLiteral_22240/*"onCloseComplete"*/,
...
LABEL_11:
  ...
  iTween__MoveTo_60073392(v29, v28, 0LL);
}
...
void __fastcall MoveWindowComponent__openWindow(MoveWindowComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2D470 & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_22252/*"onOpenComplete"*/, v5);
    sub_1B761C0(&StringLiteral_23916/*"time"*/, v6);
    sub_1B761C0(&StringLiteral_22563/*"position"*/, v7);
    sub_1B761C0(&StringLiteral_20791/*"isLocal"*/, v8);
...
LABEL_11:
  ...
  if ( !iTween_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(iTween_TypeInfo);
  iTween__MoveTo_60073392(v27, v26, 0LL);
}
