...
void __fastcall MoveWindowComponent__closeWindow(MoveWindowComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B43F37 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_22425/*"onCloseComplete"*/, v7);
    sub_1BDB878(&StringLiteral_22758/*"position"*/, v8);
    sub_1BDB878(&StringLiteral_20939/*"isLocal"*/, v9);
  ...
  if ( !v19
    ...
    || (((void (__fastcall *)(struct System_Collections_Hashtable_o *, __int64, __int64, Il2CppMethodPointer))table->klass->vtable._22_Add.method)(
          ...
          StringLiteral_22425/*"onCloseComplete"*/,
...
LABEL_11:
  ...
  iTween__MoveTo_62209824(v29, v28, 0LL);
}
...
void __fastcall MoveWindowComponent__openWindow(MoveWindowComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B43F36 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_22437/*"onOpenComplete"*/, v5);
    sub_1BDB878(&StringLiteral_24121/*"time"*/, v6);
    sub_1BDB878(&StringLiteral_22758/*"position"*/, v7);
    sub_1BDB878(&StringLiteral_20939/*"isLocal"*/, v8);
...
LABEL_11:
  ...
  if ( !iTween_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(iTween_TypeInfo);
  iTween__MoveTo_62209824(v27, v26, 0LL);
}
