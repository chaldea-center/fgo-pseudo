...
void __fastcall MoveWindowComponent__closeWindow(MoveWindowComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FDA4F & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_22164/*"onCloseComplete"*/, v7);
    sub_1B64870(&StringLiteral_22485/*"position"*/, v8);
    sub_1B64870(&StringLiteral_20719/*"isLocal"*/, v9);
  ...
  if ( !v19
    ...
    || (((void (__fastcall *)(struct System_Collections_Hashtable_o *, __int64, __int64, Il2CppMethodPointer))table->klass->vtable._23_Add.method)(
          ...
          StringLiteral_22164/*"onCloseComplete"*/,
...
LABEL_11:
  ...
  iTween__MoveTo_59921908(v29, v28, 0LL);
}
...
void __fastcall MoveWindowComponent__openWindow(MoveWindowComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FDA4E & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_22176/*"onOpenComplete"*/, v5);
    sub_1B64870(&StringLiteral_23834/*"time"*/, v6);
    sub_1B64870(&StringLiteral_22485/*"position"*/, v7);
    sub_1B64870(&StringLiteral_20719/*"isLocal"*/, v8);
...
LABEL_11:
  ...
  if ( !iTween_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(iTween_TypeInfo);
  iTween__MoveTo_59921908(v27, v26, 0LL);
}
