...
void __fastcall JinglePlayer__ExecuteCallback(JinglePlayer_o *this, const MethodInfo *method)
{
  int32_t v2; // w2
  int32_t v3; // w3
  ServantStatusBattleListViewItem_o *p_jingleCallbackFunc; // x0
  System_Action_o *jingleCallbackFunc; // t1

  jingleCallbackFunc = this->fields.jingleCallbackFunc;
  p_jingleCallbackFunc = (ServantStatusBattleListViewItem_o *)&this->fields.jingleCallbackFunc;
  p_jingleCallbackFunc->klass = 0LL;
  sub_1B00C70(p_jingleCallbackFunc, 0, v2, v3);
...
bool __fastcall JinglePlayer__FadeoutBgm(JinglePlayer_o *this, float fadeoutTime, const MethodInfo *method)
{
  ...
  if ( v6 )
  {
    ...
    sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.jingleCallbackFunc, 0, v4, v5);
    ActionExtensions__Call(jingleCallbackFunc, 0LL);
  }
  return v6;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( this->fields.bgmName )
  {
    ...
    this->fields.jingleCallbackFunc = 0LL;
    sub_1B00C70(
      (ServantStatusBattleListViewItem_o *)&this->fields.jingleCallbackFunc,
      0,
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)name, (int32_t)callbackFunc, (int32_t)method);
  this->fields.jingleCallbackFunc = callbackFunc;
  this->fields.bgmVolume = volume;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.jingleCallbackFunc, (int32_t)callbackFunc, v10, v11);
  if ( !BgmManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(BgmManager_TypeInfo);
  if ( !byte_48DFDAB )
  {
    sub_1B00CCC(&BgmManager_TypeInfo, v12);
    byte_48DFDAB = 1;
  }
...
void __fastcall JinglePlayer__Reset(JinglePlayer_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.bgmName )
  {
    jingleCallbackFunc = this->fields.jingleCallbackFunc;
    this->fields.jingleCallbackFunc = 0LL;
    sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.jingleCallbackFunc, 0, v2, v3);
    ActionExtensions__Call(jingleCallbackFunc, 0LL);
  }
...
void __fastcall JinglePlayer__SetMute(JinglePlayer_o *this, bool isMute, const MethodInfo *method)
{
  ...
  if ( (byte_48E1EA9 & 1) == 0 )
  {
    sub_1B00CCC(&BgmManager_TypeInfo, isMute);
    byte_48E1EA9 = 1;
  }
  if ( isMute )
  {
...
LABEL_16:
  ...
  if ( this->fields.fadeinTime == 0.0 || this->fields.fadeoutTime == 0.0 )
  {
    ...
    if ( v7 )
    {
      ...
      bgmPlayer = v7;
      v6 = bgmVolume * *(float *)&klass->_1.byval_arg.data;
      goto LABEL_16;
    }
LABEL_18:
    sub_1B00F28(bgmPlayer, isMute);
  }
}
