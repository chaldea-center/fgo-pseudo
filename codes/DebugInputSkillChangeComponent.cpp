        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)result = 0;
  ...
  if ( !System_Int32__TryParse(v5, result, 0) )
    result[0] = 1;
  skillIdInput = (UIInput_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !skillIdInput )
    goto LABEL_20;
  ...
  {
LABEL_20:
    sub_1CE6958(skillIdInput, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E05FC5 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_DataMasterBase_SkillDetailMaster__SkillDetailEntity__int__GetEntity__);
    sub_1CE6700(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4E05FC5 = 1;
  }
  result = 0;
...
LABEL_12:
    ...
    v9 = DataMasterBase_object__object__int___GetEntity(
           (DataMasterBase_TMaster__TEntity__PKType__o *)Instance,
           result,
           (const MethodInfo_34E925C *)Method_DataMasterBase_SkillDetailMaster__SkillDetailEntity__int__GetEntity__);
    if ( v9 )
    {
      v10 = result;
      v11 = v9;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E05FC4 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_25848/*"プレイヤー"*/);
    sub_1CE6700(&StringLiteral_25816/*"エネミー"*/);
    sub_1CE6700(&StringLiteral_25555/*"{0}(対象選択)"*/);
    byte_4E05FC4 = 1;
  }
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.debugMenu, (int32_t)menu, v20, v21, v22, v23, v24, v25);
  ...
  v32 = (Il2CppObject **)(v30 ? &StringLiteral_25848/*"プレイヤー"*/ : &StringLiteral_25816/*"エネミー"*/);
  gameObject = (UnityEngine_GameObject_o *)System_String__Format((System_String_o *)StringLiteral_25555/*"{0}(対象選択)"*/, *v32, 0);
        ...
        const MethodInfo *method)
{
  ...
  v5 = (System_Collections_Generic_List_object__o *)sub_1CE694C(System_Collections_Generic_List_BattleServantData__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( !targetServantDataArray || !targetServantDataArray->max_length )
    return 0;
  v5 = (System_Collections_Generic_List_object__o *)sub_1CE694C(System_Collections_Generic_List_BattleSkillInfoData__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v5,
