        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD909 & 1) == 0 )
  {
    sub_1B64870(&Method_BasicHelper_ToIterator_CharaGraphPartyServantListViewItem___, method);
    sub_1B64870(&Method_CharaGraphListViewPatternBase_GetMaster_UserDeckMaster___, v3);
    sub_1B64870(&System_Func_int__CharaGraphPartyServantListViewItem__TypeInfo, v4);
    sub_1B64870(&NetworkManager_TypeInfo, v5);
    sub_1B64870(&Method_CharaGraphListViewPatternServant___c__DisplayClass2_0__GenerateListViewItem_b__0__, v6);
    sub_1B64870(&CharaGraphListViewPatternServant___c__DisplayClass2_0_TypeInfo, v7);
    byte_49FD909 = 1;
  }
  equipIdList = 0LL;
  v8 = sub_1B64ABC(CharaGraphListViewPatternServant___c__DisplayClass2_0_TypeInfo);
  ...
  *(_QWORD *)(v8 + 24) = v13;
  v14 = (__int64 *)(v8 + 24);
  sub_1B64814((ServantStatusBattleListViewItem_o *)(v8 + 24), v13, v15, v16);
  Master_object = CharaGraphListViewPatternBase__GetMaster_object_((const MethodInfo_2E2F3C8 *)Method_CharaGraphListViewPatternBase_GetMaster_UserDeckMaster___);
...
LABEL_9:
  ...
  v19 = (System_Func_T__TResult__o *)sub_1B64ABC(System_Func_int__CharaGraphPartyServantListViewItem__TypeInfo);
  ...
  return (System_Collections_Generic_IEnumerable_CharaGraphListViewItemBase__o *)BasicHelper__ToIterator_object_(
                                                                                   *(_DWORD *)(v18 + 24),
                                                                                   ...
                                                                                   (const MethodInfo_2E2BAEC *)Method_BasicHelper_ToIterator_CharaGraphPartyServantListViewItem___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD90A & 1) == 0 )
  {
    sub_1B64870(&Method_CharaGraphListViewPatternBase_GetMaster_UserServantMaster___, method);
    byte_49FD90A = 1;
  }
  Master_object = CharaGraphListViewPatternBase__GetMaster_object_((const MethodInfo_2E2F3C8 *)Method_CharaGraphListViewPatternBase_GetMaster_UserServantMaster___);
  if ( !Master_object )
    sub_1B64ACC(0LL, v3);
        ...
        const MethodInfo *method)
{
  if ( (byte_49FD908 & 1) == 0 )
  {
    sub_1B64870(&StringLiteral_11523/*"SERVANT_EQUIP_EMPTY"*/, method);
    byte_49FD908 = 1;
  }
  return (System_String_o *)StringLiteral_11523/*"SERVANT_EQUIP_EMPTY"*/;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD90B & 1) == 0 )
  {
    this = (CharaGraphListViewPatternServant___c__DisplayClass2_0_o *)sub_1B64870(
  ...
  if ( !svtArray )
    sub_1B64ACC(this, *(_QWORD *)&i);
  if ( svtArray->max_length <= i )
    sub_1B64AD4(this, *(_QWORD *)&i);
  ...
  v9 = (CharaGraphPartyServantListViewItem_o *)sub_1B64ABC(CharaGraphPartyServantListViewItem_TypeInfo);
