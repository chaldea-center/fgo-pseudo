        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1EEC0 & 1) == 0 )
  {
    sub_1B715CC(&Method_BasicHelper_ToIterator_CharaGraphPartyServantListViewItem___, method);
    sub_1B715CC(&Method_CharaGraphListViewPatternBase_GetMaster_UserDeckMaster___, v3);
    sub_1B715CC(&System_Func_int__CharaGraphPartyServantListViewItem__TypeInfo, v4);
    sub_1B715CC(&NetworkManager_TypeInfo, v5);
    sub_1B715CC(&Method_CharaGraphListViewPatternServant___c__DisplayClass2_0__GenerateListViewItem_b__0__, v6);
    sub_1B715CC(&CharaGraphListViewPatternServant___c__DisplayClass2_0_TypeInfo, v7);
    byte_4A1EEC0 = 1;
  }
  equipIdList = 0LL;
  v8 = sub_1B71818(CharaGraphListViewPatternServant___c__DisplayClass2_0_TypeInfo);
  ...
  *(_QWORD *)(v8 + 24) = v13;
  v14 = (__int64 *)(v8 + 24);
  sub_1B71570((ServantStatusBattleListViewItem_o *)(v8 + 24), v13, v15, v16);
  Master_object = CharaGraphListViewPatternBase__GetMaster_object_((const MethodInfo_2E4F0E8 *)Method_CharaGraphListViewPatternBase_GetMaster_UserDeckMaster___);
...
LABEL_9:
  ...
  v19 = (System_Func_T__TResult__o *)sub_1B71818(System_Func_int__CharaGraphPartyServantListViewItem__TypeInfo);
  ...
  return (System_Collections_Generic_IEnumerable_CharaGraphListViewItemBase__o *)BasicHelper__ToIterator_object_(
                                                                                   *(_DWORD *)(v18 + 24),
                                                                                   ...
                                                                                   (const MethodInfo_2E4B80C *)Method_BasicHelper_ToIterator_CharaGraphPartyServantListViewItem___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1EEC1 & 1) == 0 )
  {
    sub_1B715CC(&Method_CharaGraphListViewPatternBase_GetMaster_UserServantMaster___, method);
    byte_4A1EEC1 = 1;
  }
  Master_object = CharaGraphListViewPatternBase__GetMaster_object_((const MethodInfo_2E4F0E8 *)Method_CharaGraphListViewPatternBase_GetMaster_UserServantMaster___);
  if ( !Master_object )
    sub_1B71828(0LL, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1EEC2 & 1) == 0 )
  {
    this = (CharaGraphListViewPatternServant___c__DisplayClass2_0_o *)sub_1B715CC(
  ...
  v9 = (CharaGraphPartyServantListViewItem_o *)sub_1B71818(CharaGraphPartyServantListViewItem_TypeInfo);
