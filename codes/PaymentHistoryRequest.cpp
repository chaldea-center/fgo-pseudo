void __fastcall PaymentHistoryRequest___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A0A540 & 1) == 0 )
  {
    sub_1B686D4(&PaymentHistoryRequest_TypeInfo, v1);
    byte_4A0A540 = 1;
  }
...
void __fastcall PaymentHistoryRequest__SetRemainTime(int64_t remain, const MethodInfo *method)
{
  ...
  if ( (byte_4A0A53E & 1) == 0 )
  {
    ...
    sub_1B686D4(&PaymentHistoryRequest_TypeInfo, v3);
    byte_4A0A53E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0A53A & 1) == 0 )
  {
    sub_1B686D4(&NetworkManager_TypeInfo, isFirstReflect);
    sub_1B686D4(&PaymentHistoryRequest_TypeInfo, v5);
    byte_4A0A53A = 1;
  }
...
System_String_o *__fastcall PaymentHistoryRequest__getURL(PaymentHistoryRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B686D4(&NetworkManager_TypeInfo, method);
    sub_1B686D4(&StringLiteral_23186/*"shop/paymentHistory"*/, v2);
    byte_4A0A539 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61419468(BaseUrl, (System_String_o *)StringLiteral_23186/*"shop/paymentHistory"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0A53F & 1) == 0 )
  {
    ...
    sub_1B686D4(&PaymentHistoryRequest_TypeInfo, v6);
    sub_1B686D4(&StringLiteral_22150/*"ok"*/, v7);
    this = (PaymentHistoryRequest_o *)sub_1B686D4(&StringLiteral_21981/*"ng"*/, v8);
    byte_4A0A53F = 1;
  }
  if ( !responseList )
