void __fastcall PaymentHistoryRequest___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C2396E & 1) == 0 )
  {
    sub_1C3B764(&PaymentHistoryRequest_TypeInfo, v1);
    byte_4C2396E = 1;
  }
...
void __fastcall PaymentHistoryRequest__SetRemainTime(int64_t remain, const MethodInfo *method)
{
  ...
  if ( (byte_4C2396C & 1) == 0 )
  {
    ...
    sub_1C3B764(&PaymentHistoryRequest_TypeInfo, v3);
    byte_4C2396C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C23968 & 1) == 0 )
  {
    sub_1C3B764(&NetworkManager_TypeInfo, isFirstReflect);
...
System_String_o *__fastcall PaymentHistoryRequest__getURL(PaymentHistoryRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C3B764(&NetworkManager_TypeInfo, method);
    sub_1C3B764(&StringLiteral_23755/*"turnMaxDamage"*/, v2);
    byte_4C23967 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63368612(BaseUrl, (System_String_o *)StringLiteral_23755/*"turnMaxDamage"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2396D & 1) == 0 )
  {
    ...
    sub_1C3B764(&PaymentHistoryRequest_TypeInfo, v6);
    sub_1C3B764(&StringLiteral_22683/*"sandboxSeurity"*/, v7);
    this = (PaymentHistoryRequest_o *)sub_1C3B764(&StringLiteral_22507/*"referrerMapId"*/, v8);
    byte_4C2396D = 1;
  }
  if ( !responseList )
  ...
  if ( v9 && ResponseData__checkError_42712632(v9, 0LL) )
  {
    ...
    if ( CallBack )
    {
      v17 = &StringLiteral_22683/*"sandboxSeurity"*/;
      goto LABEL_24;
    }
  }
  else
