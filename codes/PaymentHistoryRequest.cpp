void __fastcall PaymentHistoryRequest___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A213B5 & 1) == 0 )
  {
    sub_1B715CC(&PaymentHistoryRequest_TypeInfo, v1);
    byte_4A213B5 = 1;
  }
...
void __fastcall PaymentHistoryRequest__SetRemainTime(int64_t remain, const MethodInfo *method)
{
  ...
  if ( (byte_4A213B3 & 1) == 0 )
  {
    ...
    sub_1B715CC(&PaymentHistoryRequest_TypeInfo, v3);
    byte_4A213B3 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A213AF & 1) == 0 )
  {
    sub_1B715CC(&NetworkManager_TypeInfo, isFirstReflect);
    sub_1B715CC(&PaymentHistoryRequest_TypeInfo, v5);
    byte_4A213AF = 1;
  }
...
System_String_o *__fastcall PaymentHistoryRequest__getURL(PaymentHistoryRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B715CC(&NetworkManager_TypeInfo, method);
    sub_1B715CC(&StringLiteral_23209/*"shop/paymentHistory"*/, v2);
    byte_4A213AE = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61505504(BaseUrl, (System_String_o *)StringLiteral_23209/*"shop/paymentHistory"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A213B4 & 1) == 0 )
  {
    ...
    sub_1B715CC(&PaymentHistoryRequest_TypeInfo, v6);
    sub_1B715CC(&StringLiteral_22170/*"ok"*/, v7);
    this = (PaymentHistoryRequest_o *)sub_1B715CC(&StringLiteral_22000/*"ng"*/, v8);
    byte_4A213B4 = 1;
  }
  if ( !responseList )
