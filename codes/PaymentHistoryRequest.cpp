void __fastcall PaymentHistoryRequest___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49BC89D & 1) == 0 )
  {
    sub_1B4CF90(&PaymentHistoryRequest_TypeInfo, v1);
    byte_49BC89D = 1;
  }
...
void __fastcall PaymentHistoryRequest__SetRemainTime(int64_t remain, const MethodInfo *method)
{
  ...
  if ( (byte_49BC89B & 1) == 0 )
  {
    ...
    sub_1B4CF90(&PaymentHistoryRequest_TypeInfo, v3);
    byte_49BC89B = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BC897 & 1) == 0 )
  {
    sub_1B4CF90(&NetworkManager_TypeInfo, isFirstReflect);
    sub_1B4CF90(&PaymentHistoryRequest_TypeInfo, v5);
    byte_49BC897 = 1;
  }
...
System_String_o *__fastcall PaymentHistoryRequest__getURL(PaymentHistoryRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B4CF90(&NetworkManager_TypeInfo, method);
    sub_1B4CF90(&StringLiteral_22992/*"shop/paymentHistory"*/, v2);
    byte_49BC896 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61093468(BaseUrl, (System_String_o *)StringLiteral_22992/*"shop/paymentHistory"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BC89C & 1) == 0 )
  {
    ...
    sub_1B4CF90(&PaymentHistoryRequest_TypeInfo, v6);
    sub_1B4CF90(&StringLiteral_21947/*"ok"*/, v7);
    this = (PaymentHistoryRequest_o *)sub_1B4CF90(&StringLiteral_21779/*"ng"*/, v8);
    byte_49BC89C = 1;
  }
  if ( !responseList )
  ...
  if ( v9 && ResponseData__checkError_41839176(v9, 0LL) )
  {
