void __fastcall PaymentHistoryRequest___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B1E026 & 1) == 0 )
  {
    sub_1BCAFF8(&PaymentHistoryRequest_TypeInfo, v1);
    byte_4B1E026 = 1;
  }
...
void __fastcall PaymentHistoryRequest__SetRemainTime(int64_t remain, const MethodInfo *method)
{
  ...
  if ( (byte_4B1E024 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&PaymentHistoryRequest_TypeInfo, v3);
    byte_4B1E024 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1E020 & 1) == 0 )
  {
    sub_1BCAFF8(&NetworkManager_TypeInfo, isFirstReflect);
    sub_1BCAFF8(&PaymentHistoryRequest_TypeInfo, v5);
    byte_4B1E020 = 1;
  }
...
System_String_o *__fastcall PaymentHistoryRequest__getURL(PaymentHistoryRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BCAFF8(&NetworkManager_TypeInfo, method);
    sub_1BCAFF8(&StringLiteral_23228/*"shop/paymentHistory"*/, v2);
    byte_4B1E01F = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62450424(BaseUrl, (System_String_o *)StringLiteral_23228/*"shop/paymentHistory"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1E025 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&PaymentHistoryRequest_TypeInfo, v6);
    sub_1BCAFF8(&StringLiteral_22181/*"ok"*/, v7);
    this = (PaymentHistoryRequest_o *)sub_1BCAFF8(&StringLiteral_22015/*"ng"*/, v8);
    byte_4B1E025 = 1;
  }
  if ( !responseList )
