        ...
        const MethodInfo *method)
{
  if ( (byte_4BDD4D0 & 1) == 0 )
  {
    sub_1C21E38(&Method_DataEntityBase_CreateMultiplePK_long__long__string__long__long__long___);
    byte_4BDD4D0 = 1;
  }
  return DataEntityBase__CreateMultiplePK_long__long__object__long__long__long_(
           ...
           targetId,
           condGroup,
           (const MethodInfo_2FAF2BC *)Method_DataEntityBase_CreateMultiplePK_long__long__string__long__long__long___);
}
        ...
        const MethodInfo *method)
{
  ...
  return CondType__IsOpen(v11, svtId, condValue, 0, 0LL, 0LL);
}