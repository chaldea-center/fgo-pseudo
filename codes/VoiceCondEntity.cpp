        ...
        const MethodInfo *method)
{
  if ( (byte_4C57E6E & 1) == 0 )
  {
    sub_1C3E564(&Method_DataEntityBase_CreateMultiplePK_long__long__string__long__long__long___);
    byte_4C57E6E = 1;
  }
  return DataEntityBase__CreateMultiplePK_long__long__object__long__long__long_(
           ...
           targetId,
           condGroup,
           (const MethodInfo_30F8F28 *)Method_DataEntityBase_CreateMultiplePK_long__long__string__long__long__long___);
}
