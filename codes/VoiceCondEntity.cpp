        ...
        const MethodInfo *method)
{
  if ( (byte_4D2D999 & 1) == 0 )
  {
    sub_1C94098(&Method_DataEntityBase_CreateMultiplePK_long__long__string__long__long__long___);
    byte_4D2D999 = 1;
  }
  return DataEntityBase__CreateMultiplePK_long__long__object__long__long__long_(
           ...
           targetId,
           condGroup,
           (const MethodInfo_319B5EC *)Method_DataEntityBase_CreateMultiplePK_long__long__string__long__long__long___);
}
