        ...
        const MethodInfo *method)
{
  if ( (byte_4C440A6 & 1) == 0 )
  {
    sub_1C37058(&Method_DataEntityBase_CreateMultiplePK_long__long__string__long__long__long___);
    byte_4C440A6 = 1;
  }
  return DataEntityBase__CreateMultiplePK_long__long__object__long__long__long_(
           ...
           targetId,
           condGroup,
           (const MethodInfo_30E7110 *)Method_DataEntityBase_CreateMultiplePK_long__long__string__long__long__long___);
}
