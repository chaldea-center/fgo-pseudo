        ...
        const MethodInfo *method)
{
  if ( (byte_4CC8505 & 1) == 0 )
  {
    sub_1C713B0(&Method_DataEntityBase_CreateMultiplePK_long__long__string__long__long__long___);
    byte_4CC8505 = 1;
  }
  return DataEntityBase__CreateMultiplePK_long__long__object__long__long__long_(
           ...
           targetId,
           condGroup,
           (const MethodInfo_314A5C4 *)Method_DataEntityBase_CreateMultiplePK_long__long__string__long__long__long___);
}
